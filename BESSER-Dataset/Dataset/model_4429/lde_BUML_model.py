...
# Classes
arduino_Robo = Class(name="arduino_Robo")
arduino_Acao = Class(name="arduino_Acao", is_abstract=True)
arduino_Transicoes = Class(name="arduino_Transicoes")
arduino_Condicao = Class(name="arduino_Condicao", is_abstract=True)
arduino_Virar_Esquerda = Class(name="arduino_Virar_Esquerda")
Corpo = Class(name="Corpo")
arduino_Virar_Direita = Class(name="arduino_Virar_Direita")
arduino_Rodar_Esquerda_Tempo = Class(name="arduino_Rodar_Esquerda_Tempo")
Corpo_Modificavel = Class(name="Corpo_Modificavel")
arduino_Rodar_Direita_Tempo = Class(name="arduino_Rodar_Direita_Tempo")
arduino_Acoes_Predefinidas = Class(name="arduino_Acoes_Predefinidas", is_abstract=True)
Acao = Class(name="Acao")
arduino_Acoes_Modificaveis = Class(name="arduino_Acoes_Modificaveis", is_abstract=True)
arduino_Mover_Frente_Tempo = Class(name="arduino_Mover_Frente_Tempo")
arduino_Mover_Tras_Tempo = Class(name="arduino_Mover_Tras_Tempo")
arduino_Virar_para_X_Graus = Class(name="arduino_Virar_para_X_Graus")
Cabeca_Modificavel = Class(name="Cabeca_Modificavel")
arduino_Mover_Frente = Class(name="arduino_Mover_Frente")
arduino_Mover_Tras = Class(name="arduino_Mover_Tras")
arduino_Centrar = Class(name="arduino_Centrar")
arduino_Virar_45_Esq = Class(name="arduino_Virar_45_Esq")
arduino_Virar_45_Drt = Class(name="arduino_Virar_45_Drt")
arduino_Mover_Aleatoriamente = Class(name="arduino_Mover_Aleatoriamente")
arduino_LED = Class(name="arduino_LED", is_abstract=True)
Acoes_Predefinidas = Class(name="Acoes_Predefinidas")
arduino_Virar_Max_Drt = Class(name="arduino_Virar_Max_Drt")
Cabeca = Class(name="Cabeca")
arduino_Virar_Max_Esq = Class(name="arduino_Virar_Max_Esq")
arduino_Ligar_Intermitencia = Class(name="arduino_Ligar_Intermitencia")
arduino_Desligar_Intermitencia = Class(name="arduino_Desligar_Intermitencia")
arduino_Varias_Cores = Class(name="arduino_Varias_Cores", is_abstract=True)
Tricolor = Class(name="Tricolor")
arduino_Unica_Cor = Class(name="arduino_Unica_Cor", is_abstract=True)
arduino_Ligar_Cores_Policia = Class(name="arduino_Ligar_Cores_Policia")
Varias_Cores = Class(name="Varias_Cores")
arduino_Ligar_Cores_Arco_Iris = Class(name="arduino_Ligar_Cores_Arco_Iris")
arduino_Verde = Class(name="arduino_Verde", is_abstract=True)
arduino_Ligar_Azul = Class(name="arduino_Ligar_Azul")
LED = Class(name="LED")
Unica_Cor = Class(name="Unica_Cor")
arduino_Tricolor = Class(name="arduino_Tricolor", is_abstract=True)
arduino_Ligar_LED_Verde = Class(name="arduino_Ligar_LED_Verde")
Verde = Class(name="Verde")
arduino_Desligar_LED_Verde = Class(name="arduino_Desligar_LED_Verde")
arduino_Ligar_Vermelho = Class(name="arduino_Ligar_Vermelho")
arduino_Desligar_Cor = Class(name="arduino_Desligar_Cor")
arduino_Desligar_Cores = Class(name="arduino_Desligar_Cores")
arduino_Acoes_Condicionais = Class(name="arduino_Acoes_Condicionais", is_abstract=True)
arduino_While = Class(name="arduino_While")
Acoes_Condicionais = Class(name="Acoes_Condicionais")
arduino_If = Class(name="arduino_If")
arduino_Ligar_Verde = Class(name="arduino_Ligar_Verde")
arduino_Bumper_Pressionado = Class(name="arduino_Bumper_Pressionado")
Condicao = Class(name="Condicao")
arduino_Distancia_Infra_Vermelhos = Class(name="arduino_Distancia_Infra_Vermelhos")
arduino_Corpo = Class(name="arduino_Corpo", is_abstract=True)
arduino_Corpo_Modificavel = Class(name="arduino_Corpo_Modificavel", is_abstract=True)
Acoes_Modificaveis = Class(name="Acoes_Modificaveis")
arduino_Cabeca = Class(name="arduino_Cabeca", is_abstract=True)
arduino_Cabeca_Modificavel = Class(name="arduino_Cabeca_Modificavel", is_abstract=True)
arduino_Inicio = Class(name="arduino_Inicio")
arduino_Fim = Class(name="arduino_Fim")
arduino_Parar_Tempo = Class(name="arduino_Parar_Tempo")
arduino_Parar = Class(name="arduino_Parar")
...
arduino_Corpo_Modificavel.attributes={arduino_Corpo_Modificavel_tempo, arduino_Corpo_Modificavel_evitarObstaculo}
...
domain_model = DomainModel(
    name="arduino",
    types={arduino_Robo, arduino_Acao, arduino_Transicoes, arduino_Condicao, arduino_Virar_Esquerda, Corpo, arduino_Virar_Direita, arduino_Rodar_Esquerda_Tempo, Corpo_Modificavel, arduino_Rodar_Direita_Tempo, arduino_Acoes_Predefinidas, Acao, arduino_Acoes_Modificaveis, arduino_Mover_Frente_Tempo, arduino_Mover_Tras_Tempo, arduino_Virar_para_X_Graus, Cabeca_Modificavel, arduino_Mover_Frente, arduino_Mover_Tras, arduino_Centrar, arduino_Virar_45_Esq, arduino_Virar_45_Drt, arduino_Mover_Aleatoriamente, arduino_LED, Acoes_Predefinidas, arduino_Virar_Max_Drt, Cabeca, arduino_Virar_Max_Esq, arduino_Ligar_Intermitencia, arduino_Desligar_Intermitencia, arduino_Varias_Cores, Tricolor, arduino_Unica_Cor, arduino_Ligar_Cores_Policia, Varias_Cores, arduino_Ligar_Cores_Arco_Iris, arduino_Verde, arduino_Ligar_Azul, LED, Unica_Cor, arduino_Tricolor, arduino_Ligar_LED_Verde, Verde, arduino_Desligar_LED_Verde, arduino_Ligar_Vermelho, arduino_Desligar_Cor, arduino_Desligar_Cores, arduino_Acoes_Condicionais, arduino_While, Acoes_Condicionais, arduino_If, arduino_Ligar_Verde, arduino_Bumper_Pressionado, Condicao, arduino_Distancia_Infra_Vermelhos, arduino_Corpo, arduino_Corpo_Modificavel, Acoes_Modificaveis, arduino_Cabeca, arduino_Cabeca_Modificavel, arduino_Inicio, arduino_Fim, arduino_Parar_Tempo, arduino_Parar},
    ...
    generalizations={gen_arduino_Virar_Esquerda_Corpo, gen_arduino_Virar_Direita_Corpo, gen_arduino_Rodar_Esquerda_Tempo_Corpo_Modificavel, gen_arduino_Rodar_Direita_Tempo_Corpo_Modificavel, gen_arduino_Acoes_Predefinidas_Acao, gen_arduino_Acoes_Modificaveis_Acao, gen_arduino_Mover_Frente_Tempo_Corpo_Modificavel, gen_arduino_Mover_Tras_Tempo_Corpo_Modificavel, gen_arduino_Virar_para_X_Graus_Cabeca_Modificavel, gen_arduino_Mover_Frente_Corpo, gen_arduino_Mover_Tras_Corpo, gen_arduino_Centrar_Cabeca, gen_arduino_Virar_45_Esq_Cabeca, gen_arduino_Virar_45_Drt_Cabeca, gen_arduino_Mover_Aleatoriamente_Corpo, gen_arduino_LED_Acoes_Predefinidas, gen_arduino_Virar_Max_Drt_Cabeca, gen_arduino_Virar_Max_Esq_Cabeca, gen_arduino_Ligar_Intermitencia_Verde, gen_arduino_Desligar_Intermitencia_Verde, gen_arduino_Varias_Cores_Tricolor, gen_arduino_Unica_Cor_Tricolor, gen_arduino_Ligar_Cores_Policia_Varias_Cores, gen_arduino_Ligar_Cores_Arco_Iris_Varias_Cores, gen_arduino_Verde_LED, gen_arduino_Ligar_Azul_Unica_Cor, gen_arduino_Tricolor_LED, gen_arduino_Ligar_LED_Verde_Verde, gen_arduino_Desligar_LED_Verde_Verde, gen_arduino_Ligar_Vermelho_Unica_Cor, gen_arduino_Desligar_Cor_Unica_Cor, gen_arduino_Desligar_Cores_Varias_Cores, gen_arduino_Acoes_Condicionais_Acao, gen_arduino_While_Acoes_Condicionais, gen_arduino_Ligar_Verde_Unica_Cor, gen_arduino_Bumper_Pressionado_Condicao, gen_arduino_Distancia_Infra_Vermelhos_Condicao, gen_arduino_Corpo_Acoes_Predefinidas, gen_arduino_Corpo_Modificavel_Acoes_Modificaveis, gen_arduino_Cabeca_Acoes_Predefinidas, gen_arduino_Cabeca_Modificavel_Acoes_Modificaveis, gen_arduino_Inicio_Acao, gen_arduino_Fim_Acao, gen_arduino_If_Acoes_Condicionais, gen_arduino_Parar_Tempo_Corpo_Modificavel, gen_arduino_Parar_Corpo},
    metadata=None
)
