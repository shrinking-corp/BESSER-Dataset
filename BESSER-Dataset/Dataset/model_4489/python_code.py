...
class dSL_MovementAction:
    ...
    def __init__(self, actionenum: str, dSL_MovementAction15: "dSL_RightMovementAction" = None, dSL_MovementAction: "dSL_LeftMovementAction" = None):
...
class dSL_Mission:
    ...
    def __init__(self, name: str, dSL_Mission4: set["dSL_BehaviorName"] = None, dSL_Mission6: "dSL_EndCondition" = None, dSL_Mission: "dSL_MarsRoverExpedition" = None):
        self.name = name
