...
# Classes
dSL_BehaviorName = Class(name="dSL_BehaviorName")
dSL_EndCondition = Class(name="dSL_EndCondition")
dSL_EndWhen = Class(name="dSL_EndWhen")
dSL_EndAfter = Class(name="dSL_EndAfter")
EndCondition = Class(name="EndCondition")
dSL_MarsRoverExpedition = Class(name="dSL_MarsRoverExpedition")
dSL_Mission = Class(name="dSL_Mission")
dSL_Behavior = Class(name="dSL_Behavior")
dSL_RightMovementAction = Class(name="dSL_RightMovementAction")
dSL_RotateMovementAction = Class(name="dSL_RotateMovementAction")
dSL_RotatePoints = Class(name="dSL_RotatePoints")
RotateMovementAction = Class(name="RotateMovementAction")
dSL_LeftRotatePoint = Class(name="dSL_LeftRotatePoint")
RotatePoints = Class(name="RotatePoints")
dSL_RightRotatePoint = Class(name="dSL_RightRotatePoint")
dSL_MiddleRotatePoint = Class(name="dSL_MiddleRotatePoint")
dSL_Expression = Class(name="dSL_Expression")
dSL_Actions = Class(name="dSL_Actions")
dSL_MoveAction = Class(name="dSL_MoveAction")
Actions = Class(name="Actions")
dSL_MeasurementAction = Class(name="dSL_MeasurementAction")
dSL_LeftMovementAction = Class(name="dSL_LeftMovementAction")
dSL_MovementAction = Class(name="dSL_MovementAction")
dSL_TouchLiteral = Class(name="dSL_TouchLiteral")
dSL_ColorLiteral = Class(name="dSL_ColorLiteral")
dSL_DistanceLiteral = Class(name="dSL_DistanceLiteral")
dSL_EdgeLiteral = Class(name="dSL_EdgeLiteral")
dSL_TrueLiteral = Class(name="dSL_TrueLiteral")
Expression = Class(name="Expression")
dSL_ExpressionBracket = Class(name="dSL_ExpressionBracket")
dSL_DepthLiteral = Class(name="dSL_DepthLiteral")
dSL_ANDexpression = Class(name="dSL_ANDexpression")
dSL_ORexpression = Class(name="dSL_ORexpression")
...
domain_model = DomainModel(
    name="dSL",
    types={dSL_BehaviorName, dSL_EndCondition, dSL_EndWhen, dSL_EndAfter, EndCondition, dSL_MarsRoverExpedition, dSL_Mission, dSL_Behavior, dSL_RightMovementAction, dSL_RotateMovementAction, dSL_RotatePoints, RotateMovementAction, dSL_LeftRotatePoint, RotatePoints, dSL_RightRotatePoint, dSL_MiddleRotatePoint, dSL_Expression, dSL_Actions, dSL_MoveAction, Actions, dSL_MeasurementAction, dSL_LeftMovementAction, dSL_MovementAction, dSL_TouchLiteral, dSL_ColorLiteral, dSL_DistanceLiteral, dSL_EdgeLiteral, dSL_TrueLiteral, Expression, dSL_ExpressionBracket, dSL_DepthLiteral, dSL_ANDexpression, dSL_ORexpression, LREnum, MAEnum, BackEnum, EdgeEnum, TouchEnum, ColorEnum, FBEnum, ActionEnum, Tenum},
    associations={behaviorlist3, endcondition5, endwhenlist7, missionlist0, tasklist1, rightmove14, sensorExpression9, actionlist11, leftmove13, exp16, left18, right20, left23, right25},
    generalizations={gen_dSL_EndAfter_EndCondition, gen_dSL_RightMovementAction_Actions, gen_dSL_RotateMovementAction_Actions, gen_dSL_RotatePoints_RotateMovementAction, gen_dSL_LeftRotatePoint_RotatePoints, gen_dSL_RightRotatePoint_RotatePoints, gen_dSL_MiddleRotatePoint_RotatePoints, gen_dSL_MoveAction_Actions, gen_dSL_MeasurementAction_Actions, gen_dSL_LeftMovementAction_Actions, gen_dSL_TouchLiteral_Expression, gen_dSL_ColorLiteral_Expression, gen_dSL_DistanceLiteral_Expression, gen_dSL_EdgeLiteral_Expression, gen_dSL_TrueLiteral_Expression, gen_dSL_ExpressionBracket_Expression, gen_dSL_DepthLiteral_Expression, gen_dSL_ANDexpression_Expression, gen_dSL_ORexpression_Expression},
    metadata=None
)
