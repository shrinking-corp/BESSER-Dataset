...
class simpleworld101_Part(Named):
    ...
    def __init__(self, id: int, content: str, simpleworld101_Part: "simpleworld101_Thing" = None, simpleworld101_Part14: "simpleworld101_Relations" = None):
        self.id = id
