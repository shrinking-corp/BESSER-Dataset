...
class library_BorrowedItem:
    ...
    def __init__(self, borrowDate: date, lastReturnDate: date, BorrowedItem: "library_User" = None, library_BorrowedItem: "library_Book" = None, borrowedItems: "library_User" = None):
...
class library_User:
    ...
    def __init__(self, name: str, User: "library_Library" = None, user: set["library_BorrowedItem"] = None, users: "library_Library" = None, User9: "library_BorrowedItem" = None):
        self.name = name
        self.User = User
...
class library_Book:
    ...
    def __init__(self, name: str, author: str, Book: "library_Library" = None, books: "library_Library" = None, library_Book: "library_BorrowedItem" = None):
        self.name = name
        self.author = author
        self.Book = Book
        self.books = books
...
class library_Library:
    ...
    def __init__(self, name: str, library: set["library_Book"] = None, library2: set["library_User"] = None, Library: "library_Book" = None, Library6: "library_User" = None):
        self.name = name
