...
library_User = Class(name="library_User")
library_BorrowedItem = Class(name="library_BorrowedItem")
...
domain_model = DomainModel(
    ...
    associations={books0, users1, library3, borrowedItems4, library5, item7, user8},
    generalizations={},
    metadata=None
)
