...
# Classes
aS3_Annotation = Class(name="aS3_Annotation")
aS3_annotationFields = Class(name="aS3_annotationFields")
aS3_annotationField = Class(name="aS3_annotationField")
aS3_Model = Class(name="aS3_Model")
aS3_Package = Class(name="aS3_Package")
aS3_Imports = Class(name="aS3_Imports")
aS3_EObject = Class(name="aS3_EObject")
aS3_directive = Class(name="aS3_directive")
aS3_Import = Class(name="aS3_Import")
aS3_Uses = Class(name="aS3_Uses")
aS3_Member = Class(name="aS3_Member")
aS3_Expression = Class(name="aS3_Expression")
aS3_Interface = Class(name="aS3_Interface")
aS3_InterfaceMethod = Class(name="aS3_InterfaceMethod")
aS3_Modifier = Class(name="aS3_Modifier")
aS3_AccessorRole = Class(name="aS3_AccessorRole")
aS3_Parameter = Class(name="aS3_Parameter")
aS3_functionExpression = Class(name="aS3_functionExpression")
aS3_functionCommon = Class(name="aS3_functionCommon")
aS3_functionSignature = Class(name="aS3_functionSignature")
aS3_Block = Class(name="aS3_Block")
aS3_Class = Class(name="aS3_Class")
aS3_VariableDeclaration = Class(name="aS3_VariableDeclaration")
Statement = Class(name="Statement")
forInClauseDecl = Class(name="forInClauseDecl")
aS3_MemberVariableDeclaration = Class(name="aS3_MemberVariableDeclaration")
aS3_Method = Class(name="aS3_Method")
aS3_MethodBody = Class(name="aS3_MethodBody")
aS3_Statement = Class(name="aS3_Statement")
aS3_assignmentExpression = Class(name="aS3_assignmentExpression")
aS3_propOrIdent = Class(name="aS3_propOrIdent")
aS3_propertyIdentifier = Class(name="aS3_propertyIdentifier")
qualifier = Class(name="qualifier")
aS3_qualifier = Class(name="aS3_qualifier")
aS3_simpleQualifiedIdentifier = Class(name="aS3_simpleQualifiedIdentifier")
nonAttributeQualifiedIdentifier = Class(name="nonAttributeQualifiedIdentifier")
aS3_exprOrObjectLiteral = Class(name="aS3_exprOrObjectLiteral")
aS3_objectLiteral = Class(name="aS3_objectLiteral")
exprOrObjectLiteral = Class(name="exprOrObjectLiteral")
aS3_fieldList = Class(name="aS3_fieldList")
aS3_literalField = Class(name="aS3_literalField")
aS3_fieldName = Class(name="aS3_fieldName")
aS3_element = Class(name="aS3_element")
aS3_identi = Class(name="aS3_identi")
aS3_qualifiedIdent = Class(name="aS3_qualifiedIdent")
propertyIdentifier = Class(name="propertyIdentifier")
catchBlock = Class(name="catchBlock")
aS3_typeExpression = Class(name="aS3_typeExpression")
aS3_identifier = Class(name="aS3_identifier")
aS3_conditionalSubExpression = Class(name="aS3_conditionalSubExpression")
aS3_logicalOrExpression = Class(name="aS3_logicalOrExpression")
conditionalExpression = Class(name="conditionalExpression")
aS3_brackets = Class(name="aS3_brackets")
aS3_expressionQualifiedIdentifier = Class(name="aS3_expressionQualifiedIdentifier")
aS3_nonAttributeQualifiedIdentifier = Class(name="aS3_nonAttributeQualifiedIdentifier")
qualifiedIdentifier = Class(name="qualifiedIdentifier")
aS3_qualifiedIdentifier = Class(name="aS3_qualifiedIdentifier")
aS3_namespaceName = Class(name="aS3_namespaceName")
qualifiedIdent = Class(name="qualifiedIdent")
aS3_arrayLiteral = Class(name="aS3_arrayLiteral")
aS3_elementList = Class(name="aS3_elementList")
aS3_nonemptyElementList = Class(name="aS3_nonemptyElementList")
...
aS3_switchStatementList = Class(name="aS3_switchStatementList")
aS3_expressionList = Class(name="aS3_expressionList")
...
aS3_conditionalExpression = Class(name="aS3_conditionalExpression")
assignmentExpression = Class(name="assignmentExpression")
aS3_multiplicativeExpression = Class(name="aS3_multiplicativeExpression")
aS3_unaryExpression = Class(name="aS3_unaryExpression")
unaryExpressionNotPlusMinus = Class(name="unaryExpressionNotPlusMinus")
aS3_logicalAndExpression = Class(name="aS3_logicalAndExpression")
aS3_bitwiseOrExpression = Class(name="aS3_bitwiseOrExpression")
aS3_bitwiseXorExpression = Class(name="aS3_bitwiseXorExpression")
aS3_bitwiseAndExpression = Class(name="aS3_bitwiseAndExpression")
aS3_equalityExpression = Class(name="aS3_equalityExpression")
aS3_relationalExpression = Class(name="aS3_relationalExpression")
aS3_shiftExpression = Class(name="aS3_shiftExpression")
aS3_additiveExpression = Class(name="aS3_additiveExpression")
aS3_newExpression = Class(name="aS3_newExpression")
aS3_encapsulatedExpression = Class(name="aS3_encapsulatedExpression")
aS3_unaryExpressionNotPlusMinus = Class(name="aS3_unaryExpressionNotPlusMinus")
aS3_postfixExpression = Class(name="aS3_postfixExpression")
aS3_primaryExpression = Class(name="aS3_primaryExpression")
aS3_e4xAttributeIdentifier = Class(name="aS3_e4xAttributeIdentifier")
aS3_arguments = Class(name="aS3_arguments")
aS3_regexpLiteral = Class(name="aS3_regexpLiteral")
aS3_fullNewSubexpression = Class(name="aS3_fullNewSubexpression")
expressionQualifiedIdentifier = Class(name="expressionQualifiedIdentifier")
aS3_catchBlock = Class(name="aS3_catchBlock")
aS3_parameterDeclarationList = Class(name="aS3_parameterDeclarationList")
aS3_ReturnStatement = Class(name="aS3_ReturnStatement")
aS3_SwitchStatement = Class(name="aS3_SwitchStatement")
aS3_parameterDeclaration = Class(name="aS3_parameterDeclaration")
aS3_basicParameterDeclaration = Class(name="aS3_basicParameterDeclaration")
parameterDeclaration = Class(name="parameterDeclaration")
aS3_parameterDefault = Class(name="aS3_parameterDefault")
aS3_parameterRestDeclaration = Class(name="aS3_parameterRestDeclaration")
finallyBlock = Class(name="finallyBlock")
aS3_Condition = Class(name="aS3_Condition")
SwitchStatement = Class(name="SwitchStatement")
aS3_switchBlock = Class(name="aS3_switchBlock")
aS3_DefaultXMLNamespaceStatement = Class(name="aS3_DefaultXMLNamespaceStatement")
aS3_ExpressionStatement = Class(name="aS3_ExpressionStatement")
aS3_IfStatement = Class(name="aS3_IfStatement")
aS3_ThrowStatement = Class(name="aS3_ThrowStatement")
aS3_TryStatement = Class(name="aS3_TryStatement")
aS3_finallyBlock = Class(name="aS3_finallyBlock")
aS3_CaseStatement = Class(name="aS3_CaseStatement")
aS3_DefaultStatement = Class(name="aS3_DefaultStatement")
aS3_ForEachStatement = Class(name="aS3_ForEachStatement")
aS3_forInClause = Class(name="aS3_forInClause")
aS3_ForStatement = Class(name="aS3_ForStatement")
aS3_traditionalForClause = Class(name="aS3_traditionalForClause")
aS3_forInit = Class(name="aS3_forInit")
aS3_forCond = Class(name="aS3_forCond")
aS3_forIter = Class(name="aS3_forIter")
aS3_forInClauseDecl = Class(name="aS3_forInClauseDecl")
aS3_forInClauseTail = Class(name="aS3_forInClauseTail")
aS3_WhileStatement = Class(name="aS3_WhileStatement")
aS3_DoWhileStatement = Class(name="aS3_DoWhileStatement")
aS3_WithStatement = Class(name="aS3_WithStatement")
aS3_XmlConstant = Class(name="aS3_XmlConstant")
aS3_RegexpConstant = Class(name="aS3_RegexpConstant")
aS3_NumberConstant = Class(name="aS3_NumberConstant")
aS3_StringConstant = Class(name="aS3_StringConstant")
aS3_BoolConstant = Class(name="aS3_BoolConstant")
aS3_Undefined = Class(name="aS3_Undefined")
aS3_This = Class(name="aS3_This")
aS3_Null = Class(name="aS3_Null")
aS3_SymbolRef = Class(name="aS3_SymbolRef")
...
aS3_Uses.attributes={aS3_Uses_type, aS3_Uses_anytype}
...
aS3_Interface.attributes={aS3_Interface_name, aS3_Interface_access}
...
aS3_Modifier.attributes={aS3_Modifier_access, aS3_Modifier_final, aS3_Modifier_dynamic, aS3_Modifier_static, aS3_Modifier_native}
...
aS3_Parameter.attributes={aS3_Parameter_name, aS3_Parameter_anytype}
...
aS3_VariableDeclaration.attributes={aS3_VariableDeclaration_anytype, aS3_VariableDeclaration_name}
...
aS3_MemberVariableDeclaration.attributes={aS3_MemberVariableDeclaration_anytype, aS3_MemberVariableDeclaration_name}
...
aS3_fieldName.attributes={aS3_fieldName_name, aS3_fieldName_number}
...
aS3_unaryExpressionNotPlusMinus_in_: Property = Property(name="in_", type=StringType)
aS3_unaryExpressionNotPlusMinus_de: Property = Property(name="de", type=StringType)
aS3_unaryExpressionNotPlusMinus.attributes={aS3_unaryExpressionNotPlusMinus_de, aS3_unaryExpressionNotPlusMinus_in_}
...
assert_273: BinaryAssociation = BinaryAssociation(
    name="assert_273",
    ends={
...
else_281: BinaryAssociation = BinaryAssociation(
    name="else_281",
    ends={
...
finally_286: BinaryAssociation = BinaryAssociation(
    name="finally_286",
    ends={
...
def_294: BinaryAssociation = BinaryAssociation(
    name="def_294",
    ends={
...
domain_model = DomainModel(
    name="aS3",
    types={aS3_Annotation, aS3_annotationFields, aS3_annotationField, aS3_Model, aS3_Package, aS3_Imports, aS3_EObject, aS3_directive, aS3_Import, aS3_Uses, aS3_Member, aS3_Expression, aS3_Interface, aS3_InterfaceMethod, aS3_Modifier, aS3_AccessorRole, aS3_Parameter, aS3_functionExpression, aS3_functionCommon, aS3_functionSignature, aS3_Block, aS3_Class, aS3_VariableDeclaration, Statement, forInClauseDecl, aS3_MemberVariableDeclaration, aS3_Method, aS3_MethodBody, aS3_Statement, aS3_assignmentExpression, aS3_propOrIdent, aS3_propertyIdentifier, qualifier, aS3_qualifier, aS3_simpleQualifiedIdentifier, nonAttributeQualifiedIdentifier, aS3_exprOrObjectLiteral, aS3_objectLiteral, exprOrObjectLiteral, aS3_fieldList, aS3_literalField, aS3_fieldName, aS3_element, aS3_identi, aS3_qualifiedIdent, propertyIdentifier, catchBlock, aS3_typeExpression, aS3_identifier, aS3_conditionalSubExpression, aS3_logicalOrExpression, conditionalExpression, aS3_brackets, aS3_expressionQualifiedIdentifier, aS3_nonAttributeQualifiedIdentifier, qualifiedIdentifier, aS3_qualifiedIdentifier, aS3_namespaceName, qualifiedIdent, aS3_arrayLiteral, aS3_elementList, aS3_nonemptyElementList, elementList, Condition, DefaultXMLNamespaceStatement, ThrowStatement, CaseStatement, aS3_switchStatementList, aS3_expressionList, brackets, ExpressionStatement, forInClauseTail, element, nonemptyElementList, Expression, encapsulatedExpression, parameterDefault, aS3_conditionalExpression, assignmentExpression, aS3_multiplicativeExpression, aS3_unaryExpression, unaryExpressionNotPlusMinus, aS3_logicalAndExpression, aS3_bitwiseOrExpression, aS3_bitwiseXorExpression, aS3_bitwiseAndExpression, aS3_equalityExpression, aS3_relationalExpression, aS3_shiftExpression, aS3_additiveExpression, aS3_newExpression, aS3_encapsulatedExpression, aS3_unaryExpressionNotPlusMinus, aS3_postfixExpression, aS3_primaryExpression, aS3_e4xAttributeIdentifier, aS3_arguments, aS3_regexpLiteral, aS3_fullNewSubexpression, expressionQualifiedIdentifier, aS3_catchBlock, aS3_parameterDeclarationList, aS3_ReturnStatement, aS3_SwitchStatement, aS3_parameterDeclaration, aS3_basicParameterDeclaration, parameterDeclaration, aS3_parameterDefault, aS3_parameterRestDeclaration, finallyBlock, aS3_Condition, SwitchStatement, aS3_switchBlock, aS3_DefaultXMLNamespaceStatement, aS3_ExpressionStatement, aS3_IfStatement, aS3_ThrowStatement, aS3_TryStatement, aS3_finallyBlock, aS3_CaseStatement, aS3_DefaultStatement, aS3_ForEachStatement, aS3_forInClause, aS3_ForStatement, aS3_traditionalForClause, aS3_forInit, aS3_forCond, aS3_forIter, aS3_forInClauseDecl, aS3_forInClauseTail, aS3_WhileStatement, aS3_DoWhileStatement, aS3_WithStatement, aS3_XmlConstant, aS3_RegexpConstant, aS3_NumberConstant, aS3_StringConstant, aS3_BoolConstant, aS3_Undefined, aS3_This, aS3_Null, aS3_SymbolRef, AccessLevel},
    associations={annonFields23, package0, imp1, members3, classes5, imp8, directives11, members13, classes16, imports19, uses21, superclass58, types60, members63, annonFields24, expr26, annotations28, superclass31, members33, annotations35, modifier38, accessor40, params42, type44, func47, sig48, block50, annotations52, modifier54, Expression97, type99, Expression101, var65, meth67, annotations69, modifier72, accessor75, params78, type81, body84, statements87, annotations88, modifier91, type94, poi130, proId132, type104, lit107, fields109, lf110, fields112, name115, el117, identi119, ide121, type123, block125, qual128, aexpr148, expr1150, expr2152, qual133, piden135, bra138, list140, l141, expr143, expr145, expr170, expr172, cond155, expr157, expr158, expr160, expr162, expr164, expr166, expr168, fexpr216, nexpr219, encexpr221, e4x223, expr175, uaem178, uaep181, uaenpm183, peexpr185, pepoi186, expr189, pewi192, e4x194, args196, exprList198, qual201, expr204, superExpr207, con210, lit213, param252, type254, identi257, qual226, propId229, type232, args235, expr238, quali240, brack243, pden246, bra249, catch288, expr290, params260, name263, type265, param267, statements269, switch272, assert_273, cond276, statement278, else_281, block284, finally_286, decl323, expr326, expr329, case292, def_294, l296, statements299, fesfor302, fes303, forIn306, fsstate308, traditionalForClause311, a313, b315, c317, ficdecl319, fictail321, fiexpr332, cond335, statement337, state340, cond342, cond345, statement347, value350, symbol351},
    generalizations={gen_aS3_VariableDeclaration_Statement, gen_aS3_VariableDeclaration_forInClauseDecl, gen_aS3_propertyIdentifier_qualifier, gen_aS3_simpleQualifiedIdentifier_nonAttributeQualifiedIdentifier, gen_aS3_objectLiteral_exprOrObjectLiteral, gen_aS3_identi_propertyIdentifier, gen_aS3_identi_catchBlock, gen_aS3_identi_forInClauseDecl, gen_aS3_logicalOrExpression_conditionalExpression, gen_aS3_expressionQualifiedIdentifier_nonAttributeQualifiedIdentifier, gen_aS3_nonAttributeQualifiedIdentifier_qualifiedIdentifier, gen_aS3_namespaceName_qualifiedIdent, gen_aS3_nonemptyElementList_elementList, gen_aS3_Expression_exprOrObjectLiteral, gen_aS3_Expression_Condition, gen_aS3_Expression_DefaultXMLNamespaceStatement, gen_aS3_Expression_ThrowStatement, gen_aS3_Expression_CaseStatement, gen_aS3_expressionList_brackets, gen_aS3_expressionList_ExpressionStatement, gen_aS3_expressionList_forInClauseTail, gen_aS3_assignmentExpression_element, gen_aS3_assignmentExpression_nonemptyElementList, gen_aS3_assignmentExpression_Expression, gen_aS3_assignmentExpression_encapsulatedExpression, gen_aS3_assignmentExpression_parameterDefault, gen_aS3_conditionalExpression_assignmentExpression, gen_aS3_unaryExpression_unaryExpressionNotPlusMinus, gen_aS3_postfixExpression_unaryExpressionNotPlusMinus, gen_aS3_e4xAttributeIdentifier_qualifiedIdentifier, gen_aS3_encapsulatedExpression_expressionQualifiedIdentifier, gen_aS3_ReturnStatement_Statement, gen_aS3_SwitchStatement_Statement, gen_aS3_basicParameterDeclaration_parameterDeclaration, gen_aS3_parameterRestDeclaration_parameterDeclaration, gen_aS3_Block_Statement, gen_aS3_Block_finallyBlock, gen_aS3_Condition_SwitchStatement, gen_aS3_DefaultXMLNamespaceStatement_Statement, gen_aS3_ExpressionStatement_Statement, gen_aS3_IfStatement_Statement, gen_aS3_ThrowStatement_Statement, gen_aS3_TryStatement_Statement, gen_aS3_ForEachStatement_Statement, gen_aS3_ForStatement_Statement, gen_aS3_WhileStatement_Statement, gen_aS3_DoWhileStatement_Statement, gen_aS3_WithStatement_Statement, gen_aS3_XmlConstant_Expression, gen_aS3_RegexpConstant_Expression, gen_aS3_NumberConstant_Expression, gen_aS3_StringConstant_Expression, gen_aS3_BoolConstant_Expression, gen_aS3_Undefined_Expression, gen_aS3_This_Expression, gen_aS3_Null_Expression, gen_aS3_SymbolRef_Expression},
    metadata=None
)
