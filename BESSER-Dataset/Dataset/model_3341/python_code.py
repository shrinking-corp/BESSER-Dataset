...
class aS3_unaryExpressionNotPlusMinus:
    ...
    def __init__(self, in_: str, de: str, aS3_unaryExpressionNotPlusMinus: "aS3_unaryExpression" = None):
        self.in_ = in_
        self.de = de
...
class brackets:
    ...
    pass
class aS3_expressionList(ExpressionStatement, forInClauseTail, brackets):
...
class aS3_propOrIdent:
    ...
    pass
class aS3_assignmentExpression(nonemptyElementList, encapsulatedExpression, element, parameterDefault, Expression):
...
class aS3_MemberVariableDeclaration:
    ...
    def __init__(self, name: str, anytype: str, aS3_MemberVariableDeclaration98: "aS3_assignmentExpression" = None, aS3_MemberVariableDeclaration: "aS3_Member" = None, aS3_MemberVariableDeclaration89: set["aS3_Annotation"] = None, aS3_MemberVariableDeclaration92: "aS3_Modifier" = None, aS3_MemberVariableDeclaration95: "aS3_EObject" = None):
        self.name = name
        self.anytype = anytype
...
class forInClauseDecl:
    ...
    pass
class aS3_identi(catchBlock, forInClauseDecl, propertyIdentifier):
...
class aS3_Block(finallyBlock, Statement):
...
class aS3_Parameter:
    ...
    def __init__(self, name: str, anytype: str, aS3_Parameter: "aS3_InterfaceMethod" = None, aS3_Parameter108: "aS3_exprOrObjectLiteral" = None, aS3_Parameter80: "aS3_Method" = None, aS3_Parameter105: "aS3_EObject" = None, aS3_Parameter262: "aS3_parameterDeclarationList" = None):
        self.name = name
        self.anytype = anytype
...
class aS3_Expression(DefaultXMLNamespaceStatement, CaseStatement, ThrowStatement, exprOrObjectLiteral, Condition):
...
class aS3_Uses:
    ...
    def __init__(self, type: str, anytype: str, aS3_Uses: "aS3_directive" = None):
        self.type = type
        self.anytype = anytype
...
class aS3_Annotation:
    ...
    def __init__(self, name: str, aS3_Annotation: "aS3_annotationFields" = None, aS3_Annotation29: "aS3_Interface" = None, aS3_Annotation37: "aS3_InterfaceMethod" = None, aS3_Annotation53: "aS3_Class" = None, aS3_Annotation71: "aS3_Method" = None, aS3_Annotation90: "aS3_MemberVariableDeclaration" = None):
        self.name = name
