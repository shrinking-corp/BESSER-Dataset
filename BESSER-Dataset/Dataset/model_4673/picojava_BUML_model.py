...
picojava_TypeDecl_m_isSubtypeOf: Method = Method(name="isSubtypeOf", parameters={Parameter(name='picojava_typeDecl', type=StringType)})
picojava_TypeDecl_m_isSuperTypeOf: Method = Method(name="isSuperTypeOf", parameters={Parameter(name='picojava_typeDecl', type=StringType)})
picojava_TypeDecl_m_isSuperTypeOfClassDecl: Method = Method(name="isSuperTypeOfClassDecl", parameters={Parameter(name='picojava_typeDecl', type=StringType)})
...
picojava_TypeDecl.methods={picojava_TypeDecl_m_isSubtypeOf, picojava_TypeDecl_m_isSuperTypeOf, picojava_TypeDecl_m_isSuperTypeOfClassDecl, picojava_TypeDecl_m_lookup, picojava_TypeDecl_m_remoteLookup}
...
domain_model = DomainModel(
    name="picojava",
    types={picojava_Program, picojava_Block, picojava_TypeDecl, picojava_UnknownDecl, picojava_PrimitiveDecl, picojava_BlockStmt, picojava_Decl, picojava_Stmt, BlockStmt, Decl, picojava_Access, picojava_ClassDecl, TypeDecl, picojava_IdUse, picojava_VarDecl, Access, picojava_AssignStmt, Stmt, picojava_Exp, picojava_WhileStmt, Exp, picojava_TypeUse, picojava_VariableUse, picojava_Use, IdUse, picojava_Dot, picojava_BooleanLiteral},
    associations={Block0, PredefinedType1, unknownDecl3, booleanType5, BlockStmt7, unknownDecl9, type11, booleanType14, qualifier17, unknownDecl19, Superclass22, Body23, superClass27, Type29, Variable31, Value33, Condition35, Body37, booleanType39, type42, decl45, qualifier48, ObjectReference51, IdUse53, booleanType56},
    generalizations={gen_picojava_Stmt_BlockStmt, gen_picojava_Decl_BlockStmt, gen_picojava_TypeDecl_Decl, gen_picojava_ClassDecl_TypeDecl, gen_picojava_VarDecl_Decl, gen_picojava_IdUse_Access, gen_picojava_AssignStmt_Stmt, gen_picojava_WhileStmt_Stmt, gen_picojava_Access_Exp, gen_picojava_UnknownDecl_TypeDecl, gen_picojava_TypeUse_IdUse, gen_picojava_VariableUse_IdUse, gen_picojava_Use_IdUse, gen_picojava_Dot_Access, gen_picojava_BooleanLiteral_Exp, gen_picojava_PrimitiveDecl_TypeDecl},
    metadata=None
)
