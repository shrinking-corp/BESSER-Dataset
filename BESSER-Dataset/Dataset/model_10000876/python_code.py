...
class MapService:
    ...
    def __init__(self, currentVersion: float, cimVersion: str, mapName: str):
    ...
    @property
    def cimVersion(self):
        return self.__cimVersion
    @cimVersion.setter
    def cimVersion(self, cimVersion: str):
        self.__cimVersion = cimVersion

    @property
    def currentVersion(self):
        return self.__currentVersion
    @currentVersion.setter
    def currentVersion(self, currentVersion: float):
