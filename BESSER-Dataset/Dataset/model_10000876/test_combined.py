...
def test_hyp_mapservice_is_not_abstract():
    assert not inspect.isabstract(MapService)


def test_hyp_mapservice_constructor_exists():
    assert callable(MapService.__init__)


def test_hyp_mapservice_constructor_args():
...
def test_hyp_mapservice_cimVersion_setter(instance):
    original = instance.cimVersion
...
@given(instance=MapService_strategy)
def test_hyp_mapservice_currentVersion_setter(instance):
...
@given(instance=MapService_strategy)
def test_hyp_mapservice_mapName_setter(instance):
...
def test_MapService_cimVersion_value_roundtrip():
    instance = MapService(cimVersion="sample_text", currentVersion=3.14, mapName="sample_text")
    assert instance.cimVersion == "sample_text"
    instance.cimVersion = "sample_text_2"
    assert instance.cimVersion == "sample_text_2"


def test_MapService_currentVersion_value_roundtrip():
    instance = MapService(cimVersion="sample_text", currentVersion=3.14, mapName="sample_text")
    assert instance.currentVersion == 3.14
    instance.currentVersion = 9.99
    assert instance.currentVersion == 9.99


def test_MapService_mapName_value_roundtrip():
    instance = MapService(cimVersion="sample_text", currentVersion=3.14, mapName="sample_text")
...
MapService_strategy = st.builds(MapService, cimVersion=safe_text, currentVersion=st.floats(allow_nan=False, allow_infinity=False), mapName=safe_text)
@given(instance=MapService_strategy)
@settings(max_examples=25)
