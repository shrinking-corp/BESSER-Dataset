...
def test_mapservice_is_not_abstract():
    assert not inspect.isabstract(MapService)


def test_mapservice_constructor_exists():
...
def test_mapservice_has_mapName():
    assert hasattr(MapService, "mapName")
    descriptor = None
    for klass in MapService.__mro__:
...
@given(instance=MapService_strategy)
def test_mapservice_cimVersion_setter(instance):
...
@given(instance=MapService_strategy)
def test_mapservice_mapName_setter(instance):
