...
MapService = Class(name="MapService")
...
# MapService class attributes and methods
MapService_currentVersion: Property = Property(name="currentVersion", type=FloatType)
MapService_cimVersion: Property = Property(name="cimVersion", type=StringType)
MapService_mapName: Property = Property(name="mapName", type=StringType)
MapService.attributes={MapService_currentVersion, MapService_cimVersion, MapService_mapName}

# Domain Model
domain_model = DomainModel(
    name="_6b33c144_d9f4_49ce_809e_205eef7a3b8d",
    types={Value, Null, String, Bool, Number, Array, Visitor, Json, Documents, Print, ArrPrint, MapService},
    associations={},
    generalizations={},
    metadata=None
)
