...
coCoMM_AttributeTypeElement = Class(name="coCoMM_AttributeTypeElement")
coCoMM_FeatureAttributeElement = Class(name="coCoMM_FeatureAttributeElement")
...
coCoMM_HardLimitSC = Class(name="coCoMM_HardLimitSC")
coCoMM_HardLimitDRExpression = Class(name="coCoMM_HardLimitDRExpression")
...
coCoMM_SelectionStateSC = Class(name="coCoMM_SelectionStateSC")
...
coCoMM_FiniteDomainSC = Class(name="coCoMM_FiniteDomainSC")
coCoMM_FiniteDomainSCValue = Class(name="coCoMM_FiniteDomainSCValue")
...
coCoMM_Feature.attributes={coCoMM_Feature_name, coCoMM_Feature_abstract, coCoMM_Feature_id, coCoMM_Feature_mandatory}
...
domain_model = DomainModel(
    name="coCoMM",
    types={coCoMM_FeatureModel, coCoMM_AttributeTypeElement, coCoMM_FeatureAttributeElement, coCoMM_CTConstraintExpression, coCoMM_Feature, coCoMM_CrossTreeConstraint, coCoMM_TreeConstraint, coCoMM_FeatureAttribute, coCoMM_AttributeType, coCoMM_HardLimitSC, coCoMM_HardLimitDRExpression, coCoMM_CoCo, coCoMM_CrossModelConstraint, coCoMM_SolutionConstraint, coCoMM_Project, coCoMM_Stakeholder, coCoMM_CMConstraintExpression, coCoMM_SelectionStateSC, SolutionConstraint, coCoMM_OptimizationSC, coCoMM_Config, coCoMM_FiniteDomainSC, coCoMM_FiniteDomainSCValue, DataType, CTConstraintType, TreeConstraintType, SCType, SelectionStateSCType, CMConstraintType, OptimizationSCFunct, HardLimitSCOp, ConfigType, ConfigScenarioType},
    associations={independentAttrType14, elements15, featureAttributes17, attrType20, elements23, expressions25, root0, ctConstraints1, treeConstraints3, featureModel5, featureAttributes8, children10, feature44, expressions47, attrType48, featureModels27, cmConstraints29, solutionConstraints31, attributeTypes33, project36, stakeholders38, expressions40, featureModel42, features64, expressions68, features70, expressions74, attrType51, solutionConstraints53, configs56, stakeholder58, features61, featureAttributes76, feature78, values81},
    generalizations={gen_coCoMM_HardLimitSC_SolutionConstraint, gen_coCoMM_SelectionStateSC_SolutionConstraint, gen_coCoMM_OptimizationSC_SolutionConstraint, gen_coCoMM_FiniteDomainSC_SolutionConstraint},
    metadata=None
)
