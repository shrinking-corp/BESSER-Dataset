...
class coCoMM_SelectionStateSC(SolutionConstraint):
    ...
    def __init__(self, state: str, coCoMM_SelectionStateSC45: "coCoMM_Feature" = None, coCoMM_SelectionStateSC: "coCoMM_FeatureModel" = None):
        self.state = state
...
class coCoMM_AttributeType:
    ...
    def __init__(self, id: str, name: str, coCoMM_AttributeType: "coCoMM_AttributeType" = None, coCoMM_AttributeType13: "coCoMM_AttributeType" = None, coCoMM_AttributeType16: set["coCoMM_AttributeTypeElement"] = None, coCoMM_AttributeType18: set["coCoMM_FeatureAttribute"] = None, coCoMM_AttributeType22: "coCoMM_FeatureAttribute" = None, coCoMM_AttributeType50: "coCoMM_HardLimitSC" = None, coCoMM_AttributeType35: "coCoMM_CoCo" = None, coCoMM_AttributeType52: "coCoMM_OptimizationSC" = None):
        self.id = id
        self.name = name
...
class coCoMM_FeatureAttribute:
    ...
    def __init__(self, name: str, coCoMM_FeatureAttribute19: "coCoMM_AttributeType" = None, coCoMM_FeatureAttribute21: "coCoMM_AttributeType" = None, coCoMM_FeatureAttribute24: set["coCoMM_FeatureAttributeElement"] = None, coCoMM_FeatureAttribute: "coCoMM_Feature" = None, coCoMM_FeatureAttribute77: "coCoMM_FiniteDomainSC" = None):
        self.name = name
...
class coCoMM_Feature:
    ...
    def __init__(self, id: str, name: str, abstract: bool, mandatory: bool, coCoMM_Feature: "coCoMM_FeatureModel" = None, coCoMM_Feature4: set["coCoMM_TreeConstraint"] = None, coCoMM_Feature6: "coCoMM_FeatureModel" = None, coCoMM_Feature9: set["coCoMM_FeatureAttribute"] = None, coCoMM_Feature12: "coCoMM_TreeConstraint" = None, coCoMM_Feature46: "coCoMM_SelectionStateSC" = None, coCoMM_Feature66: "coCoMM_CTConstraintExpression" = None, coCoMM_Feature72: "coCoMM_CMConstraintExpression" = None, coCoMM_Feature63: "coCoMM_Config" = None, coCoMM_Feature80: "coCoMM_FiniteDomainSC" = None):
        self.id = id
        self.name = name
...
class coCoMM_FeatureModel:
    ...
    def __init__(self, name: str, isDomain: bool, coCoMM_FeatureModel: "coCoMM_Feature" = None, coCoMM_FeatureModel2: set["coCoMM_CrossTreeConstraint"] = None, coCoMM_FeatureModel7: "coCoMM_Feature" = None, coCoMM_FeatureModel28: "coCoMM_CoCo" = None, coCoMM_FeatureModel43: "coCoMM_SelectionStateSC" = None):
        self.name = name
