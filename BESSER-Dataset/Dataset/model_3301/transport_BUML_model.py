...
# Classes
transport_PipeStyleTransportSystem = Class(name="transport_PipeStyleTransportSystem")
transport_PipeTransportEdge = Class(name="transport_PipeTransportEdge")
transport_TransportSystem = Class(name="transport_TransportSystem", is_abstract=True)
Node = Class(name="Node")
transport_PacketTransportLabelValue = Class(name="transport_PacketTransportLabelValue")
LabelValue = Class(name="LabelValue")
transport_PacketStyleTransportSystemDecorator = Class(name="transport_PacketStyleTransportSystemDecorator")
EdgeDecorator = Class(name="EdgeDecorator")
PopulationEdge = Class(name="PopulationEdge")
transport_PipeTransportEdgeLabel = Class(name="transport_PipeTransportEdgeLabel")
EdgeLabel = Class(name="EdgeLabel")
transport_LoadUnloadEdge = Class(name="transport_LoadUnloadEdge")
MigrationEdge = Class(name="MigrationEdge")
transport_LoadUnloadEdgeLabel = Class(name="transport_LoadUnloadEdgeLabel")
MigrationEdgeLabel = Class(name="MigrationEdgeLabel")
DynamicLabel = Class(name="DynamicLabel")
transport_STEMTime = Class(name="transport_STEMTime")
transport_PacketStyleTransportSystem = Class(name="transport_PacketStyleTransportSystem")
TransportSystem = Class(name="TransportSystem")
transport_PacketTransportLabel = Class(name="transport_PacketTransportLabel")
NodeLabel = Class(name="NodeLabel")
transport_PipeTransportEdgeLabelValue = Class(name="transport_PipeTransportEdgeLabelValue")
...
transport_PipeTransportEdgeLabelValue.attributes={transport_PipeTransportEdgeLabelValue_timePeriod, transport_PipeTransportEdgeLabelValue_maxFlow}
...
domain_model = DomainModel(
    name="transport",
    types={transport_PipeStyleTransportSystem, transport_PipeTransportEdge, transport_TransportSystem, Node, transport_PacketTransportLabelValue, LabelValue, transport_PacketStyleTransportSystemDecorator, EdgeDecorator, PopulationEdge, transport_PipeTransportEdgeLabel, EdgeLabel, transport_LoadUnloadEdge, MigrationEdge, transport_LoadUnloadEdgeLabel, MigrationEdgeLabel, DynamicLabel, transport_STEMTime, transport_PacketStyleTransportSystem, TransportSystem, transport_PacketTransportLabel, NodeLabel, transport_PipeTransportEdgeLabelValue},
    ...
    generalizations={gen_transport_PipeStyleTransportSystem_TransportSystem, gen_transport_TransportSystem_Node, gen_transport_PacketTransportLabelValue_LabelValue, gen_transport_PacketStyleTransportSystemDecorator_EdgeDecorator, gen_transport_PipeTransportEdge_PopulationEdge, gen_transport_PipeTransportEdgeLabel_EdgeLabel, gen_transport_LoadUnloadEdge_MigrationEdge, gen_transport_LoadUnloadEdgeLabel_MigrationEdgeLabel, gen_transport_LoadUnloadEdgeLabel_DynamicLabel, gen_transport_PacketStyleTransportSystem_TransportSystem, gen_transport_PacketTransportLabel_NodeLabel, gen_transport_PipeTransportEdgeLabelValue_LabelValue},
    metadata=None
)
