...
def test_DirectedGraph_Edge_weight_value_roundtrip():
    instance = DirectedGraph_Edge(weight=7)
...
def test_assoc_incoming3_link_reassign_clear():
    ...
    b1 = DirectedGraph_Edge(weight=7)
    b2 = DirectedGraph_Edge(weight=13)
...
DirectedGraph_Edge_strategy = st.builds(DirectedGraph_Edge, weight=st.integers())
@given(instance=DirectedGraph_Edge_strategy)
