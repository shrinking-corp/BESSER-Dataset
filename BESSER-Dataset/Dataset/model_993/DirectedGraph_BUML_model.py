...
# Classes
DirectedGraph_Graph = Class(name="DirectedGraph_Graph")
DirectedGraph_GraphElement = Class(name="DirectedGraph_GraphElement", is_abstract=True)
DirectedGraph_Node = Class(name="DirectedGraph_Node")
GraphElement = Class(name="GraphElement")
DirectedGraph_Edge = Class(name="DirectedGraph_Edge")
...
domain_model = DomainModel(
    ...
    generalizations={gen_DirectedGraph_Edge_GraphElement, gen_DirectedGraph_Node_GraphElement},
    metadata=None
)
