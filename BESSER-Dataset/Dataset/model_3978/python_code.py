...
class ctmc_State(IDBase):
    ...
    def __init__(self, exitRate: float, name: str, from_: set["ctmc_Transition"] = None, state: set["ctmc_Label"] = None, State: "ctmc_Transition" = None, State10: "ctmc_Transition" = None, State12: "ctmc_Label" = None, ctmc_State: "ctmc_CTMC" = None, ctmc_State3: "ctmc_CTMC" = None, to: set["ctmc_Transition"] = None):
    ...
    def from_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_ctmc_State__from_", None)
...
class ctmc_Transition(IDBase):
    ...
    def __init__(self, prob: float, rate: float, Transition6: "ctmc_State" = None, outgoing: "ctmc_State" = None, incoming: "ctmc_State" = None, Transition: "ctmc_State" = None):
        self.prob = prob
        self.rate = rate
...
class ctmc_Label(IDBase):
    ...
    def __init__(self, name: str, Label: "ctmc_State" = None, labels: "ctmc_State" = None):
        self.name = name
        self.Label = Label
        self.labels = labels
