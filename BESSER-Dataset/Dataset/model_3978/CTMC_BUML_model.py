...
domain_model = DomainModel(
    name="ctmc",
    types={ctmc_CTMC, IDBase, ctmc_Label, ctmc_State, ctmc_Transition},
    associations={outgoing5, labels7, from_8, to9, state11, States0, initialState1, incoming4},
    generalizations={gen_ctmc_CTMC_IDBase, gen_ctmc_Transition_IDBase, gen_ctmc_Label_IDBase, gen_ctmc_State_IDBase},
    metadata=None
)
