...
class stext_NumericalAddSubtractExpression(Expression):
    ...
    def __init__(self, operator: str, stext_NumericalAddSubtractExpression85: "stext_Expression" = None, stext_NumericalAddSubtractExpression: "stext_Expression" = None):
        self.operator = operator
