...
stext_VariableDefinition.attributes={stext_VariableDefinition_initialValue, stext_VariableDefinition_external, stext_VariableDefinition_readonly, stext_VariableDefinition_type}
...
domain_model = DomainModel(
    name="stext",
    types={DefRoot, stext_StatechartDefinition, stext_StateRoot, stext_Root, stext_DefRoot, stext_StatechartRoot, stext_EntryPointSpec, stext_Entrypoint, stext_StateDeclaration, stext_TransitionRoot, stext_TransitionStatement, stext_Scope, stext_EventDerivation, stext_Expression, stext_LocalReaction, Declaration, Reaction, stext_ReactionProperties, stext_TransitionReaction, TransitionStatement, stext_ReactionProperty, stext_ReactionPriority, ReactionProperty, stext_EventRaising, stext_ExitPointSpec, stext_Exitpoint, stext_EventSpec, stext_RegularEventSpec, EventSpec, stext_Event, stext_TimeEventSpec, stext_BuiltinEventSpec, stext_EntryEvent, BuiltinEventSpec, stext_ExitEvent, stext_OnCycleEvent, stext_AlwaysEvent, stext_Assignment, Statement, stext_Variable, stext_VariableDefinition, Variable, stext_SimpleScope, Scope, stext_InterfaceScope, stext_InternalScope, stext_EventDefinition, Event, stext_LogicalNotExpression, stext_Clock, stext_Operation, stext_ReactionTrigger, Trigger, stext_ReactionEffect, Effect, stext_Statement, stext_ConditionalExpression, Expression, stext_LogicalOrExpression, stext_LogicalAndExpression, stext_NumericalMultiplyDivideExpression, stext_BitwiseXorExpression, stext_BitwiseOrExpression, stext_BitwiseAndExpression, stext_LogicalRelationExpression, stext_ShiftExpression, stext_NumericalAddSubtractExpression, stext_NumericalUnaryExpression, stext_PrimitiveValueExpression, stext_ElementReferenceExpression, stext_Declaration, stext_OperationCall, Direction, TimeEventType, AssignmentOperator, ShiftOperator, AdditiveOperator, MultiplicativeOperator, UnaryOperator, RelationalOperator, TimeUnit, Type},
    associations={def_1, roots0, def_2, def_3, definitionScopes4, scope6, condition9, value10, properties13, properties14, properties16, event25, value27, entrypoint18, exitpoint19, event20, varRef21, expression22, rightOperand52, derivation30, triggers32, guardExpression33, actions36, condition37, trueCase39, falseCase42, leftOperand45, rightOperand47, leftOperand50, rightOperand84, operand55, leftOperand57, rightOperand59, leftOperand62, rightOperand64, leftOperand67, rightOperand69, leftOperand72, rightOperand74, leftOperand77, rightOperand79, leftOperand82, leftOperand87, rightOperand89, operand92, value94, operation95, args96},
    generalizations={gen_stext_StatechartRoot_DefRoot, gen_stext_EntryPointSpec_ReactionProperty, gen_stext_StateRoot_DefRoot, gen_stext_TransitionRoot_DefRoot, gen_stext_LocalReaction_Declaration, gen_stext_LocalReaction_Reaction, gen_stext_TransitionReaction_TransitionStatement, gen_stext_TransitionReaction_Reaction, gen_stext_ReactionPriority_ReactionProperty, gen_stext_EventRaising_Statement, gen_stext_Expression_Statement, gen_stext_ExitPointSpec_ReactionProperty, gen_stext_RegularEventSpec_EventSpec, gen_stext_TimeEventSpec_EventSpec, gen_stext_BuiltinEventSpec_EventSpec, gen_stext_EntryEvent_BuiltinEventSpec, gen_stext_ExitEvent_BuiltinEventSpec, gen_stext_OnCycleEvent_BuiltinEventSpec, gen_stext_AlwaysEvent_BuiltinEventSpec, gen_stext_Assignment_Statement, gen_stext_VariableDefinition_Variable, gen_stext_SimpleScope_Scope, gen_stext_InterfaceScope_Scope, gen_stext_InternalScope_Scope, gen_stext_EventDefinition_Event, gen_stext_LogicalNotExpression_Expression, gen_stext_Clock_Declaration, gen_stext_Operation_Declaration, gen_stext_Entrypoint_Declaration, gen_stext_Exitpoint_Declaration, gen_stext_ReactionTrigger_Trigger, gen_stext_ReactionEffect_Effect, gen_stext_ConditionalExpression_Expression, gen_stext_LogicalOrExpression_Expression, gen_stext_LogicalAndExpression_Expression, gen_stext_NumericalMultiplyDivideExpression_Expression, gen_stext_BitwiseXorExpression_Expression, gen_stext_BitwiseOrExpression_Expression, gen_stext_BitwiseAndExpression_Expression, gen_stext_LogicalRelationExpression_Expression, gen_stext_ShiftExpression_Expression, gen_stext_NumericalAddSubtractExpression_Expression, gen_stext_NumericalUnaryExpression_Expression, gen_stext_PrimitiveValueExpression_Expression, gen_stext_ElementReferenceExpression_Expression, gen_stext_OperationCall_Expression},
    metadata=None
)
