...
# Classes
Household_HouseholdRoot = Class(name="Household_HouseholdRoot")
Household_Family = Class(name="Household_Family")
Household_Member = Class(name="Household_Member")
...
domain_model = DomainModel(
    ...
    associations={daughter9, have0, father1, mother3, son6},
    generalizations={},
    metadata=None
)
