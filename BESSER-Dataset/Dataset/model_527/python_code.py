...
class Household_Member:
    ...
    def __init__(self, firstName: str, Household_Member11: "Household_Family" = None, Household_Member: "Household_Family" = None, Household_Member5: "Household_Family" = None, Household_Member8: "Household_Family" = None):
...
class Household_Family:
    ...
    def __init__(self, lastName: str, Household_Family10: "Household_Member" = None, Household_Family: "Household_HouseholdRoot" = None, Household_Family2: "Household_Member" = None, Household_Family4: "Household_Member" = None, Household_Family7: "Household_Member" = None):
