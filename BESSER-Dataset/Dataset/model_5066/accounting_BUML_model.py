...
accounting_Invoice.attributes={accounting_Invoice_unitAmount, accounting_Invoice_invoiceDate, accounting_Invoice_id, accounting_Invoice_state}
...
domain_model = DomainModel(
    name="accounting",
    types={accounting_Order, accounting_Project, accounting_Deliverable, accounting_Invoice, accounting_Employee, accounting_NamedElement, accounting_Client, NamedElement, accounting_ClientDatabase, accounting_EmployeeDatabase, InvoiceState},
