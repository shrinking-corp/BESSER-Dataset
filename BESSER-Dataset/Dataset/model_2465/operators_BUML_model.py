...
# Classes
operators_EquipmentRelationship = Class(name="operators_EquipmentRelationship")
Relationship = Class(name="Relationship")
operators_Marker = Class(name="operators_Marker")
Base = Class(name="Base")
operators_Value = Class(name="operators_Value")
operators_NetXResource = Class(name="operators_NetXResource")
operators_Equipment = Class(name="operators_Equipment")
operators_FunctionRelationship = Class(name="operators_FunctionRelationship")
operators_Function = Class(name="operators_Function")
operators_MetricSource = Class(name="operators_MetricSource")
operators_Network = Class(name="operators_Network")
operators_DiagramInfo = Class(name="operators_DiagramInfo")
operators_Node = Class(name="operators_Node")
operators_NodeType = Class(name="operators_NodeType")
operators_Location = Class(name="operators_Location")
operators_Person = Class(name="operators_Person")
operators_Lifecycle = Class(name="operators_Lifecycle")
operators_Warehouse = Class(name="operators_Warehouse")
operators_Operator = Class(name="operators_Operator")
Company = Class(name="Company")
operators_Protocol = Class(name="operators_Protocol")
operators_Service = Class(name="operators_Service")
operators_ServiceUser = Class(name="operators_ServiceUser")
operators_ResourceExpansion = Class(name="operators_ResourceExpansion")
operators_Relationship = Class(name="operators_Relationship")
operators_DateTimeRange = Class(name="operators_DateTimeRange")
operators_ResourceForecast = Class(name="operators_ResourceForecast")
operators_ResourceMonitor = Class(name="operators_ResourceMonitor")
operators_ToleranceMarker = Class(name="operators_ToleranceMarker")
...
operators_Marker.attributes={operators_Marker_description, operators_Marker_kind}
...
operators_ToleranceMarker.attributes={operators_ToleranceMarker_level, operators_ToleranceMarker_direction}
...
domain_model = DomainModel(
    name="operators",
    types={operators_EquipmentRelationship, Relationship, operators_Marker, Base, operators_Value, operators_NetXResource, operators_Equipment, operators_FunctionRelationship, operators_Function, operators_MetricSource, operators_Network, operators_DiagramInfo, operators_Node, operators_NodeType, operators_Location, operators_Person, operators_Lifecycle, operators_Warehouse, operators_Operator, Company, operators_Protocol, operators_Service, operators_ServiceUser, operators_ResourceExpansion, operators_Relationship, operators_DateTimeRange, operators_ResourceForecast, operators_ResourceMonitor, operators_ToleranceMarker, Marker, MarkerKind, ToleranceMarkerDirectionKind},
    associations={valueRef8, markerResourceRef9, equipment1Ref0, equipment2Ref1, function1Ref4, function2Ref5, networks15, functionRelationships17, equipmentRelationships20, diagrams11, nodes12, nodeType29, createdByRef31, locationRef34, metricSources23, createdByRef25, lifecycle27, networks39, warehouses41, originalNodeTypeRef36, nodeID2Ref51, protocolRef54, services43, serviceUsers45, resourceExpansions47, nodeID1Ref49, markers67, nodeRef69, resourceRef72, nodeRefs56, equipmentRefs59, functionRefs62, markers65, nodes77, equipments80, period75},
    generalizations={gen_operators_EquipmentRelationship_Relationship, gen_operators_Marker_Base, gen_operators_FunctionRelationship_Relationship, gen_operators_Network_Base, gen_operators_Node_Base, gen_operators_Operator_Company, gen_operators_ResourceExpansion_Base, gen_operators_Relationship_Base, gen_operators_ResourceForecast_Base, gen_operators_ResourceMonitor_Base, gen_operators_ToleranceMarker_Marker, gen_operators_Warehouse_Base},
    metadata=None
)
