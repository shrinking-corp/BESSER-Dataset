...
public class operators_Network extends Base {
    ...
    public operators_Network(
        String description,        String name,        String createdDate        ArrayList<operators_EquipmentRelationship> operators_equipmentrelationships,        ArrayList<operators_FunctionRelationship> operators_functionrelationships,        ArrayList<operators_Network> operators_networks    ) {
        this.description = description;
        this.name = name;
        this.createdDate = createdDate;
