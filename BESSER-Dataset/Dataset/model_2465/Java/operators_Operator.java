...
public class operators_Operator extends Company {
    ...
    public operators_Operator(
        ArrayList<operators_ResourceExpansion> operators_resourceexpansions,        ArrayList<operators_Warehouse> operators_warehouses,        ArrayList<operators_Network> operators_networks    ) {
