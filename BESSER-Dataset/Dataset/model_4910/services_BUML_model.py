...
domain_model = DomainModel(
    name="services",
    types={services_CFSService, Service, services_CIID, Base, services_DerivedResource, BaseResource, services_Value, services_DistributionEntry, services_NetXResource, services_Lifecycle, services_RFSService, services_Node, services_Tolerance, services_Service, services_ServiceForecast, services_ServiceMonitor, services_ServiceUser, services_ServiceDistribution, services_ServiceForecastUsers, services_ResourceForecast, services_Expression, services_DateTimeRange, services_ResourceMonitor, services_ServiceProfile, ResourceOriginType, ServiceClassType},
    associations={trendedValues4, values0, forecastValues1, distribution8, resourceRef7, lifecycle15, nodes11, toleranceRefs12, cIID14, services18, serviceForecasts20, serviceMonitors22, serviceUserRefs24, serviceDistribution26, serviceForecastUsers35, resourceForecasts37, distributionEntries28, expressionRefs31, period33, resourceMonitors48, userValues39, serviceUserRef42, period45, serviceProfile52, expressionRef55, profileResources50},
    generalizations={gen_services_CFSService_Service, gen_services_CIID_Base, gen_services_DerivedResource_BaseResource, gen_services_DistributionEntry_Base, gen_services_RFSService_Service, gen_services_Service_Base, gen_services_ServiceDistribution_Base, gen_services_ServiceForecast_Base, gen_services_ServiceForecastUsers_Base, gen_services_ServiceMonitor_Base, gen_services_ServiceProfile_Base, gen_services_ServiceUser_Base},
    metadata=None
)
