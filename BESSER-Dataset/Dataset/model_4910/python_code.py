...
class services_DistributionEntry(Base):
    ...
    def __init__(self, resourceOrigin: str, services_DistributionEntry30: "services_ServiceDistribution" = None, services_DistributionEntry9: "services_DerivedResource" = None, services_DistributionEntry: "services_NetXResource" = None):
...
class services_ServiceForecast(Base):
    ...
    def __init__(self, name: str, revision: str, services_ServiceForecast: "services_Service" = None, services_ServiceForecast36: set["services_ServiceForecastUsers"] = None, services_ServiceForecast38: set["services_ResourceForecast"] = None, services_ServiceForecast34: "services_DateTimeRange" = None):
        self.name = name
...
class services_ServiceMonitor(Base):
    ...
    def __init__(self, name: str, revision: str, services_ServiceMonitor: "services_Service" = None, services_ServiceMonitor49: set["services_ResourceMonitor"] = None, services_ServiceMonitor46: "services_DateTimeRange" = None):
        self.name = name
        self.revision = revision
