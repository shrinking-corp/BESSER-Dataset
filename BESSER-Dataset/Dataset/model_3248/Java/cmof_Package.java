...
public class cmof_Package extends Namespace, PackageableElement {
    ...
    public cmof_Package(
        String URI        ArrayList<cmof_Package> cmof_packages,        ArrayList<cmof_PackageableElement> cmof_packageableelements    ) {
        this.URI = URI;
