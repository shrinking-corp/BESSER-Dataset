...
public class cmof_Classifier extends Type, Namespace, RedefinableElement {
    ...
    public cmof_Classifier(
        String isAbstract,        String isFinalSpecialization        ArrayList<cmof_Property> cmof_propertys,        ArrayList<cmof_Feature> cmof_features,        ArrayList<cmof_Classifier> cmof_classifiers    ) {
        this.isAbstract = isAbstract;
        this.isFinalSpecialization = isFinalSpecialization;
