...
# Classes
cmof_ReflectiveCollection = Class(name="cmof_ReflectiveCollection")
Object = Class(name="Object")
cmof_Object = Class(name="cmof_Object")
cmof_ReflectiveSequence = Class(name="cmof_ReflectiveSequence")
ReflectiveCollection = Class(name="ReflectiveCollection")
cmof_Property = Class(name="cmof_Property")
StructuralFeature = Class(name="StructuralFeature")
cmof_Class = Class(name="cmof_Class")
cmof_DataType = Class(name="cmof_DataType")
cmof_Association = Class(name="cmof_Association")
cmof_ValueSpecification = Class(name="cmof_ValueSpecification", is_abstract=True)
cmof_StructuralFeature = Class(name="cmof_StructuralFeature", is_abstract=True)
Feature = Class(name="Feature")
MultiplicityElement = Class(name="MultiplicityElement")
TypedElement = Class(name="TypedElement")
cmof_Feature = Class(name="cmof_Feature", is_abstract=True)
RedefinableElement = Class(name="RedefinableElement")
cmof_Classifier = Class(name="cmof_Classifier", is_abstract=True)
cmof_RedefinableElement = Class(name="cmof_RedefinableElement", is_abstract=True)
NamedElement = Class(name="NamedElement")
cmof_Namespace = Class(name="cmof_Namespace", is_abstract=True)
cmof_NamedElement = Class(name="cmof_NamedElement", is_abstract=True)
Element = Class(name="Element")
cmof_Comment = Class(name="cmof_Comment")
cmof_Element = Class(name="cmof_Element", is_abstract=True)
cmof_Operation = Class(name="cmof_Operation")
Namespace = Class(name="Namespace")
Type = Class(name="Type")
Classifier = Class(name="Classifier")
cmof_Type = Class(name="cmof_Type", is_abstract=True)
PackageableElement = Class(name="PackageableElement")
cmof_Package = Class(name="cmof_Package")
cmof_Generalization = Class(name="cmof_Generalization")
cmof_PackageMerge = Class(name="cmof_PackageMerge")
cmof_PackageableElement = Class(name="cmof_PackageableElement", is_abstract=True)
cmof_ElementImport = Class(name="cmof_ElementImport")
cmof_DirectedRelationship = Class(name="cmof_DirectedRelationship", is_abstract=True)
Relationship = Class(name="Relationship")
cmof_Constraint = Class(name="cmof_Constraint")
cmof_PackageImport = Class(name="cmof_PackageImport")
DirectedRelationship = Class(name="DirectedRelationship")
cmof_Relationship = Class(name="cmof_Relationship", is_abstract=True)
cmof_TypedElement = Class(name="cmof_TypedElement", is_abstract=True)
BehavioralFeature = Class(name="BehavioralFeature")
cmof_BehavioralFeature = Class(name="cmof_BehavioralFeature", is_abstract=True)
cmof_Parameter = Class(name="cmof_Parameter")
cmof_MultiplicityElement = Class(name="cmof_MultiplicityElement", is_abstract=True)
cmof_Argument = Class(name="cmof_Argument")
cmof_Enumeration = Class(name="cmof_Enumeration")
DataType = Class(name="DataType")
cmof_EnumerationLiteral = Class(name="cmof_EnumerationLiteral")
InstanceSpecification = Class(name="InstanceSpecification")
cmof_Slot = Class(name="cmof_Slot")
cmof_InstanceSpecification = Class(name="cmof_InstanceSpecification")
cmof_LiteralSpecification = Class(name="cmof_LiteralSpecification", is_abstract=True)
cmof_LiteralInteger = Class(name="cmof_LiteralInteger")
cmof_LiteralNull = Class(name="cmof_LiteralNull")
cmof_Expression = Class(name="cmof_Expression")
ValueSpecification = Class(name="ValueSpecification")
cmof_InstanceValue = Class(name="cmof_InstanceValue")
cmof_LiteralBoolean = Class(name="cmof_LiteralBoolean")
LiteralSpecification = Class(name="LiteralSpecification")
cmof_LiteralUnlimitedNatural = Class(name="cmof_LiteralUnlimitedNatural")
cmof_OpaqueExpression = Class(name="cmof_OpaqueExpression")
cmof_LiteralReal = Class(name="cmof_LiteralReal")
cmof_LiteralString = Class(name="cmof_LiteralString")
cmof_Extent = Class(name="cmof_Extent")
cmof_PrimitiveType = Class(name="cmof_PrimitiveType")
cmof_URIExtent = Class(name="cmof_URIExtent")
Extent = Class(name="Extent")
cmof_Exception = Class(name="cmof_Exception")
cmof_Tag = Class(name="cmof_Tag")
cmof_Link = Class(name="cmof_Link")
cmof_Factory = Class(name="cmof_Factory")

# cmof_ReflectiveCollection class attributes and methods
cmof_ReflectiveCollection_m_add: Method = Method(name="add", parameters={Parameter(name='cmof_object', type=StringType)}, type=StringType)
cmof_ReflectiveCollection_m_addAll: Method = Method(name="addAll", parameters={Parameter(name='cmof_objects', type=StringType)}, type=StringType)
cmof_ReflectiveCollection_m_clear: Method = Method(name="clear", parameters={})
cmof_ReflectiveCollection_m_remove: Method = Method(name="remove", parameters={Parameter(name='cmof_object', type=StringType)}, type=StringType)
cmof_ReflectiveCollection_m_size: Method = Method(name="size", parameters={}, type=StringType)
cmof_ReflectiveCollection.methods={cmof_ReflectiveCollection_m_add, cmof_ReflectiveCollection_m_size, cmof_ReflectiveCollection_m_remove, cmof_ReflectiveCollection_m_clear, cmof_ReflectiveCollection_m_addAll}

# Object class attributes and methods

# cmof_Object class attributes and methods
cmof_Object_m_get: Method = Method(name="get", parameters={Parameter(name='cmof_property', type=StringType)}, type=Object)
cmof_Object_m_equals: Method = Method(name="equals", parameters={Parameter(name='cmof_element', type=StringType)}, type=StringType)
cmof_Object_m_set: Method = Method(name="set", parameters={Parameter(name='cmof_property', type=StringType), Parameter(name='cmof_value', type=StringType)})
cmof_Object_m_isSet: Method = Method(name="isSet", parameters={Parameter(name='cmof_property', type=StringType)}, type=StringType)
cmof_Object_m_unset: Method = Method(name="unset", parameters={Parameter(name='cmof_property', type=StringType)})
cmof_Object_m_invoke: Method = Method(name="invoke", parameters={Parameter(name='cmof_arguments', type=StringType), Parameter(name='cmof_op', type=StringType)}, type=Object)
cmof_Object.methods={cmof_Object_m_invoke, cmof_Object_m_isSet, cmof_Object_m_equals, cmof_Object_m_unset, cmof_Object_m_set, cmof_Object_m_get}

# cmof_ReflectiveSequence class attributes and methods
cmof_ReflectiveSequence_m_remove: Method = Method(name="remove", parameters={Parameter(name='cmof_index', type=StringType)}, type=StringType)
cmof_ReflectiveSequence_m_set: Method = Method(name="set", parameters={Parameter(name='cmof_index', type=StringType), Parameter(name='cmof_object', type=StringType)}, type=StringType)
cmof_ReflectiveSequence_m_add: Method = Method(name="add", parameters={Parameter(name='cmof_object', type=StringType), Parameter(name='cmof_index', type=StringType)})
cmof_ReflectiveSequence_m_get: Method = Method(name="get", parameters={Parameter(name='cmof_index', type=StringType)}, type=StringType)
cmof_ReflectiveSequence.methods={cmof_ReflectiveSequence_m_add, cmof_ReflectiveSequence_m_set, cmof_ReflectiveSequence_m_get, cmof_ReflectiveSequence_m_remove}
...
cmof_Property_m_derived_union_is_read_only: Method = Method(name="derived_union_is_read_only", parameters={Parameter(name='cmof_diagnostics', type=StringType), Parameter(name='cmof_context', type=StringType)}, type=BooleanType)
cmof_Property_m_redefined_property_inherited: Method = Method(name="redefined_property_inherited", parameters={Parameter(name='cmof_context', type=StringType), Parameter(name='cmof_diagnostics', type=StringType)}, type=BooleanType)
cmof_Property_m_subsetted_property_names: Method = Method(name="subsetted_property_names", parameters={Parameter(name='cmof_diagnostics', type=StringType), Parameter(name='cmof_context', type=StringType)}, type=BooleanType)
cmof_Property_m_multiplicity_of_composite: Method = Method(name="multiplicity_of_composite", parameters={Parameter(name='cmof_context', type=StringType), Parameter(name='cmof_diagnostics', type=StringType)}, type=BooleanType)
cmof_Property_m_subsetting_context_conforms: Method = Method(name="subsetting_context_conforms", parameters={Parameter(name='cmof_context', type=StringType), Parameter(name='cmof_diagnostics', type=StringType)}, type=BooleanType)
cmof_Property_m_default: Method = Method(name="default", parameters={}, type=StringType)
cmof_Property_m_isAttribute: Method = Method(name="isAttribute", parameters={Parameter(name='cmof_p', type=StringType)}, type=StringType)
...
cmof_Property_m_derived_union_is_derived: Method = Method(name="derived_union_is_derived", parameters={Parameter(name='cmof_diagnostics', type=StringType), Parameter(name='cmof_context', type=StringType)}, type=BooleanType)
cmof_Property_m_subsetting_rules: Method = Method(name="subsetting_rules", parameters={Parameter(name='cmof_diagnostics', type=StringType), Parameter(name='cmof_context', type=StringType)}, type=BooleanType)
cmof_Property.attributes={cmof_Property_aggregation, cmof_Property_default, cmof_Property_isDerivedUnion, cmof_Property_isDerived, cmof_Property_isComposite, cmof_Property_isID}
cmof_Property.methods={cmof_Property_m_subsetting_context_conforms, cmof_Property_m_subsetted_property_names, cmof_Property_m_derived_union_is_derived, cmof_Property_m_multiplicity_of_composite, cmof_Property_m_subsetting_rules, cmof_Property_m_subsettingContext, cmof_Property_m_derived_union_is_read_only, cmof_Property_m_isNavigable, cmof_Property_m_opposite, cmof_Property_m_redefined_property_inherited, cmof_Property_m_isComposite, cmof_Property_m_default, cmof_Property_m_isAttribute}
...
cmof_Association_m_binary_associations: Method = Method(name="binary_associations", parameters={Parameter(name='cmof_context', type=StringType), Parameter(name='cmof_diagnostics', type=StringType)}, type=BooleanType)
cmof_Association_m_specialized_end_number: Method = Method(name="specialized_end_number", parameters={Parameter(name='cmof_context', type=StringType), Parameter(name='cmof_diagnostics', type=StringType)}, type=BooleanType)
cmof_Association_m_association_ends: Method = Method(name="association_ends", parameters={Parameter(name='cmof_diagnostics', type=StringType), Parameter(name='cmof_context', type=StringType)}, type=BooleanType)
cmof_Association_m_specialized_end_types: Method = Method(name="specialized_end_types", parameters={Parameter(name='cmof_diagnostics', type=StringType), Parameter(name='cmof_context', type=StringType)}, type=BooleanType)
...
cmof_Association.methods={cmof_Association_m_specialized_end_types, cmof_Association_m_association_ends, cmof_Association_m_endType, cmof_Association_m_binary_associations, cmof_Association_m_specialized_end_number}
...
cmof_ValueSpecification.methods={cmof_ValueSpecification_m_stringValue, cmof_ValueSpecification_m_isComputable, cmof_ValueSpecification_m_booleanValue, cmof_ValueSpecification_m_realValue, cmof_ValueSpecification_m_integerValue, cmof_ValueSpecification_m_unlimitedValue, cmof_ValueSpecification_m_isNull}
...
cmof_Classifier_m_non_final_parents: Method = Method(name="non_final_parents", parameters={Parameter(name='cmof_context', type=StringType), Parameter(name='cmof_diagnostics', type=StringType)}, type=BooleanType)
cmof_Classifier_m_specialize_type: Method = Method(name="specialize_type", parameters={Parameter(name='cmof_context', type=StringType), Parameter(name='cmof_diagnostics', type=StringType)}, type=BooleanType)
cmof_Classifier_m_allParents: Method = Method(name="allParents", parameters={}, type=Classifier)
cmof_Classifier_m_conformsTo: Method = Method(name="conformsTo", parameters={Parameter(name='cmof_other', type=StringType)}, type=StringType)
cmof_Classifier_m_general: Method = Method(name="general", parameters={}, type=Classifier)
cmof_Classifier_m_hasVisibilityOf: Method = Method(name="hasVisibilityOf", parameters={Parameter(name='cmof_n', type=StringType)}, type=StringType)
cmof_Classifier_m_inherit: Method = Method(name="inherit", parameters={Parameter(name='cmof_inhs', type=StringType)}, type=NamedElement)
cmof_Classifier_m_inheritableMembers: Method = Method(name="inheritableMembers", parameters={Parameter(name='cmof_c', type=StringType)}, type=NamedElement)
cmof_Classifier_m_inheritedMember: Method = Method(name="inheritedMember", parameters={}, type=NamedElement)
cmof_Classifier_m_maySpecializeType: Method = Method(name="maySpecializeType", parameters={Parameter(name='cmof_c', type=StringType)}, type=StringType)
cmof_Classifier_m_no_cycles_in_generalization: Method = Method(name="no_cycles_in_generalization", parameters={Parameter(name='cmof_context', type=StringType), Parameter(name='cmof_diagnostics', type=StringType)}, type=BooleanType)
...
cmof_Classifier.methods={cmof_Classifier_m_allParents, cmof_Classifier_m_general, cmof_Classifier_m_hasVisibilityOf, cmof_Classifier_m_inheritableMembers, cmof_Classifier_m_inheritedMember, cmof_Classifier_m_conformsTo, cmof_Classifier_m_maySpecializeType, cmof_Classifier_m_no_cycles_in_generalization, cmof_Classifier_m_inherit, cmof_Classifier_m_parents, cmof_Classifier_m_non_final_parents, cmof_Classifier_m_specialize_type, cmof_Classifier_m_allFeatures}
...
cmof_RedefinableElement_m_non_leaf_redefinition: Method = Method(name="non_leaf_redefinition", parameters={Parameter(name='cmof_diagnostics', type=StringType), Parameter(name='cmof_context', type=StringType)}, type=BooleanType)
cmof_RedefinableElement_m_redefinition_context_valid: Method = Method(name="redefinition_context_valid", parameters={Parameter(name='cmof_diagnostics', type=StringType), Parameter(name='cmof_context', type=StringType)}, type=BooleanType)
cmof_RedefinableElement_m_isConsistentWith: Method = Method(name="isConsistentWith", parameters={Parameter(name='cmof_redefinee', type=StringType)}, type=StringType)
cmof_RedefinableElement_m_isRedefinitionContextValid: Method = Method(name="isRedefinitionContextValid", parameters={Parameter(name='cmof_redefined', type=StringType)}, type=StringType)
cmof_RedefinableElement_m_redefinition_consistent: Method = Method(name="redefinition_consistent", parameters={Parameter(name='cmof_context', type=StringType), Parameter(name='cmof_diagnostics', type=StringType)}, type=BooleanType)
cmof_RedefinableElement.attributes={cmof_RedefinableElement_isLeaf}
cmof_RedefinableElement.methods={cmof_RedefinableElement_m_non_leaf_redefinition, cmof_RedefinableElement_m_redefinition_consistent, cmof_RedefinableElement_m_isRedefinitionContextValid, cmof_RedefinableElement_m_redefinition_context_valid, cmof_RedefinableElement_m_isConsistentWith}

# NamedElement class attributes and methods

# cmof_Namespace class attributes and methods
cmof_Namespace_m_importMembers: Method = Method(name="importMembers", parameters={Parameter(name='cmof_imps', type=StringType)}, type=PackageableElement)
...
cmof_Namespace_m_members_distinguishable: Method = Method(name="members_distinguishable", parameters={Parameter(name='cmof_context', type=StringType), Parameter(name='cmof_diagnostics', type=StringType)}, type=BooleanType)
cmof_Namespace_m_excludeCollisions: Method = Method(name="excludeCollisions", parameters={Parameter(name='cmof_imps', type=StringType)}, type=PackageableElement)
cmof_Namespace_m_getNamesOfMember: Method = Method(name="getNamesOfMember", parameters={Parameter(name='cmof_element', type=StringType)}, type=StringType)
cmof_Namespace.methods={cmof_Namespace_m_importMembers, cmof_Namespace_m_membersAreDistinguishable, cmof_Namespace_m_importedMember, cmof_Namespace_m_getNamesOfMember, cmof_Namespace_m_members_distinguishable, cmof_Namespace_m_excludeCollisions}
...
cmof_NamedElement_m_has_qualified_name: Method = Method(name="has_qualified_name", parameters={Parameter(name='cmof_context', type=StringType), Parameter(name='cmof_diagnostics', type=StringType)}, type=BooleanType)
cmof_NamedElement_m_allNamespaces: Method = Method(name="allNamespaces", parameters={}, type=StringType)
cmof_NamedElement_m_isDistinguishableFrom: Method = Method(name="isDistinguishableFrom", parameters={Parameter(name='cmof_n', type=StringType), Parameter(name='cmof_ns', type=StringType)}, type=StringType)
...
cmof_NamedElement_m_visibility_needs_ownership: Method = Method(name="visibility_needs_ownership", parameters={Parameter(name='cmof_context', type=StringType), Parameter(name='cmof_diagnostics', type=StringType)}, type=BooleanType)
cmof_NamedElement_m_has_no_qualified_name: Method = Method(name="has_no_qualified_name", parameters={Parameter(name='cmof_context', type=StringType), Parameter(name='cmof_diagnostics', type=StringType)}, type=BooleanType)
cmof_NamedElement.attributes={cmof_NamedElement_visibility, cmof_NamedElement_name, cmof_NamedElement_qualifiedName}
cmof_NamedElement.methods={cmof_NamedElement_m_separator, cmof_NamedElement_m_has_no_qualified_name, cmof_NamedElement_m_visibility_needs_ownership, cmof_NamedElement_m_allNamespaces, cmof_NamedElement_m_has_qualified_name, cmof_NamedElement_m_isDistinguishableFrom, cmof_NamedElement_m_qualifiedName}
...
cmof_Element_m_isInstanceOfType: Method = Method(name="isInstanceOfType", parameters={Parameter(name='cmof_includesSubtypes', type=StringType), Parameter(name='cmof_type', type=StringType)}, type=StringType)
cmof_Element_m_delete: Method = Method(name="delete", parameters={})
cmof_Element_m_has_owner: Method = Method(name="has_owner", parameters={Parameter(name='cmof_diagnostics', type=StringType), Parameter(name='cmof_context', type=StringType)}, type=BooleanType)
cmof_Element_m_not_own_self: Method = Method(name="not_own_self", parameters={Parameter(name='cmof_context', type=StringType), Parameter(name='cmof_diagnostics', type=StringType)}, type=BooleanType)
...
cmof_Element.methods={cmof_Element_m_mustBeOwned, cmof_Element_m_delete, cmof_Element_m_isInstanceOfType, cmof_Element_m_has_owner, cmof_Element_m_getMetaClass, cmof_Element_m_allOwnedElements, cmof_Element_m_container, cmof_Element_m_not_own_self}
...
cmof_Operation_m_only_body_for_query: Method = Method(name="only_body_for_query", parameters={Parameter(name='cmof_diagnostics', type=StringType), Parameter(name='cmof_context', type=StringType)}, type=BooleanType)
cmof_Operation_m_at_most_one_return: Method = Method(name="at_most_one_return", parameters={Parameter(name='cmof_diagnostics', type=StringType), Parameter(name='cmof_context', type=StringType)}, type=BooleanType)
...
cmof_Operation.attributes={cmof_Operation_upper, cmof_Operation_isQuery, cmof_Operation_isUnique, cmof_Operation_isOrdered, cmof_Operation_lower}
cmof_Operation.methods={cmof_Operation_m_only_body_for_query, cmof_Operation_m_returnResult, cmof_Operation_m_isOrdered, cmof_Operation_m_lower, cmof_Operation_m_type, cmof_Operation_m_at_most_one_return, cmof_Operation_m_isUnique, cmof_Operation_m_upper}
...
cmof_Type_m_conformsTo: Method = Method(name="conformsTo", parameters={Parameter(name='cmof_other', type=StringType)}, type=StringType)
cmof_Type_m_isInstance: Method = Method(name="isInstance", parameters={Parameter(name='cmof_object', type=StringType)}, type=StringType)
...
cmof_Package_m_makesVisible: Method = Method(name="makesVisible", parameters={Parameter(name='cmof_el', type=StringType)}, type=StringType)
...
cmof_Package_m_elements_public_or_private: Method = Method(name="elements_public_or_private", parameters={Parameter(name='cmof_diagnostics', type=StringType), Parameter(name='cmof_context', type=StringType)}, type=BooleanType)
cmof_Package.attributes={cmof_Package_URI}
cmof_Package.methods={cmof_Package_m_ownedType, cmof_Package_m_makesVisible, cmof_Package_m_visibleMembers, cmof_Package_m_elements_public_or_private, cmof_Package_m_nestedPackage}
...
cmof_ElementImport_m_visibility_public_or_private: Method = Method(name="visibility_public_or_private", parameters={Parameter(name='cmof_diagnostics', type=StringType), Parameter(name='cmof_context', type=StringType)}, type=BooleanType)
cmof_ElementImport_m_imported_element_is_public: Method = Method(name="imported_element_is_public", parameters={Parameter(name='cmof_context', type=StringType), Parameter(name='cmof_diagnostics', type=StringType)}, type=BooleanType)
...
cmof_Constraint_m_not_apply_to_self: Method = Method(name="not_apply_to_self", parameters={Parameter(name='cmof_diagnostics', type=StringType), Parameter(name='cmof_context', type=StringType)}, type=BooleanType)
cmof_Constraint_m_no_side_effects: Method = Method(name="no_side_effects", parameters={Parameter(name='cmof_context', type=StringType), Parameter(name='cmof_diagnostics', type=StringType)}, type=BooleanType)
cmof_Constraint_m_value_specification_boolean: Method = Method(name="value_specification_boolean", parameters={Parameter(name='cmof_diagnostics', type=StringType), Parameter(name='cmof_context', type=StringType)}, type=BooleanType)
cmof_Constraint_m_boolean_value: Method = Method(name="boolean_value", parameters={Parameter(name='cmof_context', type=StringType), Parameter(name='cmof_diagnostics', type=StringType)}, type=BooleanType)
cmof_Constraint.methods={cmof_Constraint_m_value_specification_boolean, cmof_Constraint_m_boolean_value, cmof_Constraint_m_not_apply_to_self, cmof_Constraint_m_no_side_effects}
...
cmof_PackageImport_m_public_or_private: Method = Method(name="public_or_private", parameters={Parameter(name='cmof_context', type=StringType), Parameter(name='cmof_diagnostics', type=StringType)}, type=BooleanType)
...
cmof_MultiplicityElement_m_includesCardinality: Method = Method(name="includesCardinality", parameters={Parameter(name='cmof_C', type=StringType)}, type=StringType)
cmof_MultiplicityElement_m_lower_ge_0: Method = Method(name="lower_ge_0", parameters={Parameter(name='cmof_context', type=StringType), Parameter(name='cmof_diagnostics', type=StringType)}, type=BooleanType)
cmof_MultiplicityElement_m_value_specification_no_side_effects: Method = Method(name="value_specification_no_side_effects", parameters={Parameter(name='cmof_context', type=StringType), Parameter(name='cmof_diagnostics', type=StringType)}, type=BooleanType)
cmof_MultiplicityElement_m_upper_ge_lower: Method = Method(name="upper_ge_lower", parameters={Parameter(name='cmof_context', type=StringType), Parameter(name='cmof_diagnostics', type=StringType)}, type=BooleanType)
cmof_MultiplicityElement_m_value_specification_constant: Method = Method(name="value_specification_constant", parameters={Parameter(name='cmof_context', type=StringType), Parameter(name='cmof_diagnostics', type=StringType)}, type=BooleanType)
cmof_MultiplicityElement_m_includesMultiplicity: Method = Method(name="includesMultiplicity", parameters={Parameter(name='cmof_M', type=StringType)}, type=StringType)
...
cmof_MultiplicityElement.attributes={cmof_MultiplicityElement_isOrdered, cmof_MultiplicityElement_upper, cmof_MultiplicityElement_isUnique, cmof_MultiplicityElement_lower}
cmof_MultiplicityElement.methods={cmof_MultiplicityElement_m_includesCardinality, cmof_MultiplicityElement_m_isMultivalued, cmof_MultiplicityElement_m_value_specification_constant, cmof_MultiplicityElement_m_upper, cmof_MultiplicityElement_m_lowerBound, cmof_MultiplicityElement_m_upperBound, cmof_MultiplicityElement_m_lower_ge_0, cmof_MultiplicityElement_m_value_specification_no_side_effects, cmof_MultiplicityElement_m_lower, cmof_MultiplicityElement_m_includesMultiplicity, cmof_MultiplicityElement_m_upper_ge_lower}
...
cmof_EnumerationLiteral_m_classifier_equals_owning_enumeration: Method = Method(name="classifier_equals_owning_enumeration", parameters={Parameter(name='cmof_diagnostics', type=StringType), Parameter(name='cmof_context', type=StringType)}, type=BooleanType)
cmof_EnumerationLiteral_m_classifier: Method = Method(name="classifier", parameters={}, type=StringType)
cmof_EnumerationLiteral.methods={cmof_EnumerationLiteral_m_classifier, cmof_EnumerationLiteral_m_classifier_equals_owning_enumeration}
...
cmof_InstanceSpecification_m_structural_feature: Method = Method(name="structural_feature", parameters={Parameter(name='cmof_diagnostics', type=StringType), Parameter(name='cmof_context', type=StringType)}, type=BooleanType)
cmof_InstanceSpecification_m_defining_feature: Method = Method(name="defining_feature", parameters={Parameter(name='cmof_diagnostics', type=StringType), Parameter(name='cmof_context', type=StringType)}, type=BooleanType)
...
cmof_OpaqueExpression_m_language_body_size: Method = Method(name="language_body_size", parameters={Parameter(name='cmof_diagnostics', type=StringType), Parameter(name='cmof_context', type=StringType)}, type=BooleanType)
...
cmof_OpaqueExpression.methods={cmof_OpaqueExpression_m_value, cmof_OpaqueExpression_m_isNonNegative, cmof_OpaqueExpression_m_isPositive, cmof_OpaqueExpression_m_isIntegral, cmof_OpaqueExpression_m_language_body_size}
...
cmof_Extent_m_elementsOfType: Method = Method(name="elementsOfType", parameters={Parameter(name='cmof_type', type=StringType), Parameter(name='cmof_includesSubtypes', type=StringType)}, type=Element)
cmof_Extent_m_linksOfType: Method = Method(name="linksOfType", parameters={Parameter(name='cmof_type', type=StringType)}, type=StringType)
cmof_Extent_m_linkedElements: Method = Method(name="linkedElements", parameters={Parameter(name='cmof_end1ToEnd2Direction', type=StringType), Parameter(name='cmof_endElement', type=StringType), Parameter(name='cmof_association', type=StringType)}, type=Element)
cmof_Extent_m_linkExists: Method = Method(name="linkExists", parameters={Parameter(name='cmof_secondElement', type=StringType), Parameter(name='cmof_firstElement', type=StringType), Parameter(name='cmof_association', type=StringType)}, type=StringType)
cmof_Extent.methods={cmof_Extent_m_linkExists, cmof_Extent_m_useContainment, cmof_Extent_m_elementsOfType, cmof_Extent_m_elements, cmof_Extent_m_linksOfType, cmof_Extent_m_linkedElements}
...
cmof_URIExtent_m_uri: Method = Method(name="uri", parameters={Parameter(name='cmof_object', type=StringType)}, type=StringType)
cmof_URIExtent_m_element: Method = Method(name="element", parameters={Parameter(name='cmof_uri', type=StringType)}, type=Element)
...
cmof_Link_m_equals: Method = Method(name="equals", parameters={Parameter(name='cmof_otherLink', type=StringType)}, type=StringType)
...
cmof_Factory_m_createLink: Method = Method(name="createLink", parameters={Parameter(name='cmof_secondElement', type=StringType), Parameter(name='cmof_association', type=StringType), Parameter(name='cmof_firstElement', type=StringType)}, type=StringType)
cmof_Factory_m_createFromString: Method = Method(name="createFromString", parameters={Parameter(name='cmof_string', type=StringType), Parameter(name='cmof_dataType', type=StringType)}, type=Object)
cmof_Factory_m_convertToString: Method = Method(name="convertToString", parameters={Parameter(name='cmof_dataType', type=StringType), Parameter(name='cmof_object', type=StringType)}, type=StringType)
cmof_Factory_m_create: Method = Method(name="create", parameters={Parameter(name='cmof_metaClass', type=StringType)}, type=Element)
cmof_Factory_m_createElement: Method = Method(name="createElement", parameters={Parameter(name='cmof_class_', type=StringType), Parameter(name='cmof_arguments', type=StringType)}, type=Element)
cmof_Factory.methods={cmof_Factory_m_convertToString, cmof_Factory_m_createLink, cmof_Factory_m_createFromString, cmof_Factory_m_create, cmof_Factory_m_createElement}
...
class_0: BinaryAssociation = BinaryAssociation(
    name="class_0",
    ends={
...
ownedOperation37: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="class_38", type=cmof_Operation, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
ownedAttribute36: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="class_", type=cmof_Property, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
class_122: BinaryAssociation = BinaryAssociation(
    name="class_122",
    ends={
...
domain_model = DomainModel(
    name="cmof",
    types={cmof_ReflectiveCollection, Object, cmof_Object, cmof_ReflectiveSequence, ReflectiveCollection, cmof_Property, StructuralFeature, cmof_Class, cmof_DataType, cmof_Association, cmof_ValueSpecification, cmof_StructuralFeature, Feature, MultiplicityElement, TypedElement, cmof_Feature, RedefinableElement, cmof_Classifier, cmof_RedefinableElement, NamedElement, cmof_Namespace, cmof_NamedElement, Element, cmof_Comment, cmof_Element, cmof_Operation, Namespace, Type, Classifier, cmof_Type, PackageableElement, cmof_Package, cmof_Generalization, cmof_PackageMerge, cmof_PackageableElement, cmof_ElementImport, cmof_DirectedRelationship, Relationship, cmof_Constraint, cmof_PackageImport, DirectedRelationship, cmof_Relationship, cmof_TypedElement, BehavioralFeature, cmof_BehavioralFeature, cmof_Parameter, cmof_MultiplicityElement, cmof_Argument, cmof_Enumeration, DataType, cmof_EnumerationLiteral, InstanceSpecification, cmof_Slot, cmof_InstanceSpecification, cmof_LiteralSpecification, cmof_LiteralInteger, cmof_LiteralNull, cmof_Expression, ValueSpecification, cmof_InstanceValue, cmof_LiteralBoolean, LiteralSpecification, cmof_LiteralUnlimitedNatural, cmof_OpaqueExpression, cmof_LiteralReal, cmof_LiteralString, cmof_Extent, cmof_PrimitiveType, cmof_URIExtent, Extent, cmof_Exception, cmof_Tag, cmof_Link, cmof_Factory, VisibilityKind, ParameterDirectionKind, AggregationKind},
    associations={defaultValue6, opposite8, class_0, redefinedProperty11, subsettedProperty14, datatype1, association3, owningAssociation4, featuringClassifier16, namespace21, redefinedElement18, redefinitionContext19, ownedComment22, ownedElement24, owner26, metaclass28, ownedOperation37, superClass40, annotatedElement30, nestedClassifier33, ownedAttribute36, redefinedClassifier53, package55, attribute42, feature45, general47, generalization49, inheritedMember50, nestedPackage57, nestingPackage60, elementImport65, importedMember66, member68, packageMerge62, packagedElement63, ownedType64, importedElement75, importingNamespace77, source79, ownedMember71, ownedRule72, packageImport73, constrainedElement86, target81, relatedElement84, type93, importedPackage94, specification88, context91, specific104, importingNamespace96, mergedPackage98, receivingPackage100, general102, datatype108, postcondition110, precondition113, bodyCondition106, raisedException126, defaultValue129, operation132, redefinedOperation117, type119, class_122, ownedParameter125, upperValue137, lowerValue135, ownedAttribute140, ownedOperation142, memberEnd152, value154, ownedLiteral155, endType145, navigableOwnedEnd147, ownedEnd150, classifier157, slot159, specification160, definingFeature163, enumeration156, value164, owningInstance167, operand168, instance170, package180, objectInError182, elementInError184, element187, tagOwner189, firstElement172, secondElement174, association177},
    generalizations={gen_cmof_ReflectiveCollection_Object, gen_cmof_ReflectiveSequence_ReflectiveCollection, gen_cmof_Property_StructuralFeature, gen_cmof_StructuralFeature_Feature, gen_cmof_StructuralFeature_MultiplicityElement, gen_cmof_StructuralFeature_TypedElement, gen_cmof_Feature_RedefinableElement, gen_cmof_RedefinableElement_NamedElement, gen_cmof_NamedElement_Element, gen_cmof_Comment_Element, gen_cmof_Element_Object, gen_cmof_Classifier_Namespace, gen_cmof_Classifier_RedefinableElement, gen_cmof_Classifier_Type, gen_cmof_Class_Classifier, gen_cmof_Type_PackageableElement, gen_cmof_PackageableElement_NamedElement, gen_cmof_Package_Namespace, gen_cmof_Package_PackageableElement, gen_cmof_Namespace_NamedElement, gen_cmof_DirectedRelationship_Relationship, gen_cmof_ElementImport_DirectedRelationship, gen_cmof_Relationship_Element, gen_cmof_Constraint_PackageableElement, gen_cmof_TypedElement_NamedElement, gen_cmof_PackageImport_DirectedRelationship, gen_cmof_ValueSpecification_TypedElement, gen_cmof_ValueSpecification_PackageableElement, gen_cmof_Operation_BehavioralFeature, gen_cmof_PackageMerge_DirectedRelationship, gen_cmof_Generalization_DirectedRelationship, gen_cmof_Parameter_MultiplicityElement, gen_cmof_Parameter_TypedElement, gen_cmof_BehavioralFeature_Namespace, gen_cmof_BehavioralFeature_Feature, gen_cmof_MultiplicityElement_Element, gen_cmof_Association_Classifier, gen_cmof_Association_Relationship, gen_cmof_DataType_Classifier, gen_cmof_Enumeration_DataType, gen_cmof_EnumerationLiteral_InstanceSpecification, gen_cmof_Slot_Element, gen_cmof_InstanceSpecification_PackageableElement, gen_cmof_LiteralSpecification_ValueSpecification, gen_cmof_LiteralInteger_LiteralSpecification, gen_cmof_LiteralNull_LiteralSpecification, gen_cmof_Expression_ValueSpecification, gen_cmof_InstanceValue_ValueSpecification, gen_cmof_LiteralBoolean_LiteralSpecification, gen_cmof_LiteralUnlimitedNatural_LiteralSpecification, gen_cmof_OpaqueExpression_ValueSpecification, gen_cmof_LiteralReal_LiteralSpecification, gen_cmof_LiteralString_LiteralSpecification, gen_cmof_Extent_Object, gen_cmof_PrimitiveType_DataType, gen_cmof_URIExtent_Extent, gen_cmof_Tag_Element, gen_cmof_Link_Object, gen_cmof_Factory_Element},
    metadata=None
)
