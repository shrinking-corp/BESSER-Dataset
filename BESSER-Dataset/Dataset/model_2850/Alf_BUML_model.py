...
# Classes
alf_ImportReference = Class(name="alf_ImportReference")
alf_UnitDefinition = Class(name="alf_UnitDefinition")
alf_NamespaceDeclaration = Class(name="alf_NamespaceDeclaration")
alf_ImportDeclaration = Class(name="alf_ImportDeclaration")
alf_StereotypeAnnotations = Class(name="alf_StereotypeAnnotations")
alf_NamespaceDefinition = Class(name="alf_NamespaceDefinition")
alf_BOOLEAN_LITERAL = Class(name="alf_BOOLEAN_LITERAL")
PRIMITIVE_LITERAL = Class(name="PRIMITIVE_LITERAL")
alf_NUMBER_LITERAL = Class(name="alf_NUMBER_LITERAL")
alf_INTEGER_LITERAL = Class(name="alf_INTEGER_LITERAL")
NUMBER_LITERAL = Class(name="NUMBER_LITERAL")
alf_UNLIMITED_NATURAL = Class(name="alf_UNLIMITED_NATURAL")
alf_STRING_LITERAL = Class(name="alf_STRING_LITERAL")
alf_StereotypeAnnotation = Class(name="alf_StereotypeAnnotation")
alf_QualifiedName = Class(name="alf_QualifiedName")
alf_TaggedValues = Class(name="alf_TaggedValues")
alf_TaggedValueList = Class(name="alf_TaggedValueList")
TaggedValues = Class(name="TaggedValues")
alf_TaggedValue = Class(name="alf_TaggedValue")
alf_PRIMITIVE_LITERAL = Class(name="alf_PRIMITIVE_LITERAL")
alf_Name = Class(name="alf_Name")
alf_ImportReferenceQualifiedNameCompletion = Class(name="alf_ImportReferenceQualifiedNameCompletion")
alf_AliasDefinition = Class(name="alf_AliasDefinition")
alf_ColonQualifiedNameCompletionOfImportReference = Class(name="alf_ColonQualifiedNameCompletionOfImportReference")
ImportReferenceQualifiedNameCompletion = Class(name="ImportReferenceQualifiedNameCompletion")
alf_VisibilityIndicator = Class(name="alf_VisibilityIndicator")
alf_PackageDeclaration = Class(name="alf_PackageDeclaration")
alf_PackageDefinition = Class(name="alf_PackageDefinition")
NamespaceDefinition = Class(name="NamespaceDefinition")
ClassMemberDefinition = Class(name="ClassMemberDefinition")
alf_ClassifierSignature = Class(name="alf_ClassifierSignature")
alf_PackageBody = Class(name="alf_PackageBody")
alf_TemplateParameters = Class(name="alf_TemplateParameters")
alf_PackageDefinitionOrStub = Class(name="alf_PackageDefinitionOrStub")
PackagedElementDefinition = Class(name="PackagedElementDefinition")
alf_SpecializationClause = Class(name="alf_SpecializationClause")
alf_ClassifierTemplateParameter = Class(name="alf_ClassifierTemplateParameter")
alf_QualifiedNameList = Class(name="alf_QualifiedNameList")
alf_ClassDeclaration = Class(name="alf_ClassDeclaration")
alf_ClassDefinition = Class(name="alf_ClassDefinition")
ClassifierDefinition = Class(name="ClassifierDefinition")
alf_ClassBody = Class(name="alf_ClassBody")
alf_ClassDefinitionOrStub = Class(name="alf_ClassDefinitionOrStub")
ClassifierDefinitionOrStub = Class(name="ClassifierDefinitionOrStub")
alf_ClassMember = Class(name="alf_ClassMember")
alf_ClassMemberDefinition = Class(name="alf_ClassMemberDefinition")
ActiveClassMemberDefinition = Class(name="ActiveClassMemberDefinition")
alf_PackagedElement = Class(name="alf_PackagedElement")
alf_ActiveClassDeclaration = Class(name="alf_ActiveClassDeclaration")
alf_PackagedElementDefinition = Class(name="alf_PackagedElementDefinition")
alf_ClassifierDefinition = Class(name="alf_ClassifierDefinition")
alf_ClassifierDefinitionOrStub = Class(name="alf_ClassifierDefinitionOrStub")
alf_ActiveClassDefinitionOrStub = Class(name="alf_ActiveClassDefinitionOrStub")
alf_ActiveClassMember = Class(name="alf_ActiveClassMember")
alf_BehaviorClause = Class(name="alf_BehaviorClause")
alf_Block = Class(name="alf_Block")
alf_ActiveClassMemberDefinition = Class(name="alf_ActiveClassMemberDefinition")
alf_DataTypeDeclaration = Class(name="alf_DataTypeDeclaration")
alf_DataTypeDefinition = Class(name="alf_DataTypeDefinition")
alf_StructuredBody = Class(name="alf_StructuredBody")
alf_DataTypeDefinitionOrStub = Class(name="alf_DataTypeDefinitionOrStub")
alf_StructuredMember = Class(name="alf_StructuredMember")
alf_ActiveClassDefinition = Class(name="alf_ActiveClassDefinition")
alf_ActiveClassBody = Class(name="alf_ActiveClassBody")
alf_AssociationDefinitionOrStub = Class(name="alf_AssociationDefinitionOrStub")
alf_EnumerationDeclaration = Class(name="alf_EnumerationDeclaration")
alf_EnumerationDefinition = Class(name="alf_EnumerationDefinition")
alf_EnumerationBody = Class(name="alf_EnumerationBody")
alf_EnumerationDefinitionOrStub = Class(name="alf_EnumerationDefinitionOrStub")
alf_EnumerationLiteralName = Class(name="alf_EnumerationLiteralName")
alf_SignalDeclaration = Class(name="alf_SignalDeclaration")
alf_SignalDefinition = Class(name="alf_SignalDefinition")
alf_SignalDefinitionOrStub = Class(name="alf_SignalDefinitionOrStub")
alf_ActivityDeclaration = Class(name="alf_ActivityDeclaration")
alf_PropertyDefinition = Class(name="alf_PropertyDefinition")
alf_AssociationDeclaration = Class(name="alf_AssociationDeclaration")
alf_AssociationDefinition = Class(name="alf_AssociationDefinition")
alf_ActivityDefinition = Class(name="alf_ActivityDefinition")
alf_ActivityDefinitionOrStub = Class(name="alf_ActivityDefinitionOrStub")
alf_FormalParameterList = Class(name="alf_FormalParameterList")
alf_FormalParameter = Class(name="alf_FormalParameter")
alf_FeatureDefinitionOrStub = Class(name="alf_FeatureDefinitionOrStub")
alf_ActiveFeatureDefinitionOrStub = Class(name="alf_ActiveFeatureDefinitionOrStub")
alf_PropertyDeclaration = Class(name="alf_PropertyDeclaration")
alf_AttributeDefinition = Class(name="alf_AttributeDefinition")
FeatureDefinitionOrStub = Class(name="FeatureDefinitionOrStub")
alf_FormalParameters = Class(name="alf_FormalParameters")
alf_TypePart = Class(name="alf_TypePart")
alf_TypeName = Class(name="alf_TypeName")
alf_Multiplicity = Class(name="alf_Multiplicity")
alf_MultiplicityRange = Class(name="alf_MultiplicityRange")
alf_UnlimitedNaturalLiteral = Class(name="alf_UnlimitedNaturalLiteral")
alf_OperationDeclaration = Class(name="alf_OperationDeclaration")
OperationDefinitionOrStub = Class(name="OperationDefinitionOrStub")
alf_RedefinitionClause = Class(name="alf_RedefinitionClause")
alf_OperationDefinitionOrStub = Class(name="alf_OperationDefinitionOrStub")
alf_AttributeInitializer = Class(name="alf_AttributeInitializer")
alf_ReceptionDefinition = Class(name="alf_ReceptionDefinition")
ActiveFeatureDefinitionOrStub = Class(name="ActiveFeatureDefinitionOrStub")
alf_InitializationExpression = Class(name="alf_InitializationExpression")
alf_SignalReceptionDefinitionOrStub = Class(name="alf_SignalReceptionDefinitionOrStub")
alf_UnqualifiedName = Class(name="alf_UnqualifiedName")
alf_ColonQualifiedNameCompletion = Class(name="alf_ColonQualifiedNameCompletion")
alf_NameBinding = Class(name="alf_NameBinding")
UnqualifiedName = Class(name="UnqualifiedName")
alf_TemplateBinding = Class(name="alf_TemplateBinding")
alf_QualifiedNameWithoutBinding = Class(name="alf_QualifiedNameWithoutBinding")
alf_ColonQualifiedNameCompletionWithoutBinding = Class(name="alf_ColonQualifiedNameCompletionWithoutBinding")
alf_PositionalTemplateBinding = Class(name="alf_PositionalTemplateBinding")
TemplateBinding = Class(name="TemplateBinding")
alf_NamedTemplateBinding = Class(name="alf_NamedTemplateBinding")
alf_TemplateParameterSubstitution = Class(name="alf_TemplateParameterSubstitution")
alf_SignalReceptionDeclaration = Class(name="alf_SignalReceptionDeclaration")
alf_NonNameExpression = Class(name="alf_NonNameExpression")
alf_NonNameUnaryExpression = Class(name="alf_NonNameUnaryExpression")
alf_NameToExpressionCompletion = Class(name="alf_NameToExpressionCompletion")
alf_NameToPrimaryExpression = Class(name="alf_NameToPrimaryExpression")
alf_PrimaryToExpressionCompletion = Class(name="alf_PrimaryToExpressionCompletion")
alf_PostfixExpressionCompletion = Class(name="alf_PostfixExpressionCompletion")
alf_PrimaryExpression = Class(name="alf_PrimaryExpression")
alf_NameOrPrimaryExpression = Class(name="alf_NameOrPrimaryExpression")
alf_BaseExpression = Class(name="alf_BaseExpression")
alf_ParenthesizedExpression = Class(name="alf_ParenthesizedExpression")
alf_PrimaryExpressionCompletion = Class(name="alf_PrimaryExpressionCompletion")
alf_LinkOperationCompletion = Class(name="alf_LinkOperationCompletion")
alf_ClassExtentExpressionCompletion = Class(name="alf_ClassExtentExpressionCompletion")
alf_SequenceConstructionExpressionCompletion = Class(name="alf_SequenceConstructionExpressionCompletion")
alf_BehaviorInvocation = Class(name="alf_BehaviorInvocation")
alf_Feature_Or_SequenceOperationOrReductionOrExpansion_Or_Index = Class(name="alf_Feature_Or_SequenceOperationOrReductionOrExpansion_Or_Index")
alf_Feature = Class(name="alf_Feature")
alf_FeatureInvocation = Class(name="alf_FeatureInvocation")
alf_SequenceOperationOrReductionOrExpansion = Class(name="alf_SequenceOperationOrReductionOrExpansion")
alf_Expression = Class(name="alf_Expression")
InitializationExpression = Class(name="InitializationExpression")
alf_UnaryExpression = Class(name="alf_UnaryExpression")
alf_ExpressionCompletion = Class(name="alf_ExpressionCompletion")
alf_ThisExpression = Class(name="alf_ThisExpression")
alf_Tuple = Class(name="alf_Tuple")
alf_NamedTupleExpressionList = Class(name="alf_NamedTupleExpressionList")
alf_PositionalTupleExpressionList = Class(name="alf_PositionalTupleExpressionList")
alf_PositionalTupleExpressionListCompletion = Class(name="alf_PositionalTupleExpressionListCompletion")
alf_NamedExpression = Class(name="alf_NamedExpression")
alf_Index = Class(name="alf_Index")
alf_LiteralExpression = Class(name="alf_LiteralExpression")
BaseExpression = Class(name="BaseExpression")
alf_LinkOperationTuple = Class(name="alf_LinkOperationTuple")
alf_IndexedNamedExpressionListCompletion = Class(name="alf_IndexedNamedExpressionListCompletion")
alf_IndexedNamedExpression = Class(name="alf_IndexedNamedExpression")
alf_SuperInvocationExpression = Class(name="alf_SuperInvocationExpression")
alf_InstanceCreationOrSequenceConstructionExpression = Class(name="alf_InstanceCreationOrSequenceConstructionExpression")
alf_MultiplicityIndicator = Class(name="alf_MultiplicityIndicator")
alf_SequenceElements = Class(name="alf_SequenceElements")
alf_SequenceElementListCompletion = Class(name="alf_SequenceElementListCompletion")
alf_SequenceInitializationExpression = Class(name="alf_SequenceInitializationExpression")
alf_SequenceElement = Class(name="alf_SequenceElement")
alf_SequenceAnyExpression = Class(name="alf_SequenceAnyExpression")
alf_EObject = Class(name="alf_EObject")
alf_PostfixOperation = Class(name="alf_PostfixOperation")
alf_PrefixExpression = Class(name="alf_PrefixExpression")
NonPostfixNonCastUnaryExpression = Class(name="NonPostfixNonCastUnaryExpression")
alf_PostfixOrCastExpression = Class(name="alf_PostfixOrCastExpression")
UnaryExpression = Class(name="UnaryExpression")
CastCompletion = Class(name="CastCompletion")
alf_NonNamePostfixOrCastExpression = Class(name="alf_NonNamePostfixOrCastExpression")
NonNameUnaryExpression = Class(name="NonNameUnaryExpression")
alf_CastCompletion = Class(name="alf_CastCompletion")
alf_BitStringComplementExpression = Class(name="alf_BitStringComplementExpression")
alf_NumericUnaryExpression = Class(name="alf_NumericUnaryExpression")
alf_IsolationExpression = Class(name="alf_IsolationExpression")
alf_MultiplicativeExpression = Class(name="alf_MultiplicativeExpression")
alf_MultiplicativeExpressionCompletion = Class(name="alf_MultiplicativeExpressionCompletion")
alf_AdditiveExpression = Class(name="alf_AdditiveExpression")
alf_AdditiveExpressionCompletion = Class(name="alf_AdditiveExpressionCompletion")
alf_NonPostfixNonCastUnaryExpression = Class(name="alf_NonPostfixNonCastUnaryExpression")
alf_BooleanNegationExpression = Class(name="alf_BooleanNegationExpression")
alf_RelationalExpression = Class(name="alf_RelationalExpression")
alf_RelationalExpressionCompletion = Class(name="alf_RelationalExpressionCompletion")
alf_ClassificationExpression = Class(name="alf_ClassificationExpression")
alf_ClassificationExpressionCompletion = Class(name="alf_ClassificationExpressionCompletion")
alf_EqualityExpression = Class(name="alf_EqualityExpression")
alf_ShiftExpression = Class(name="alf_ShiftExpression")
alf_ShiftExpressionCompletion = Class(name="alf_ShiftExpressionCompletion")
alf_AndExpressionCompletion = Class(name="alf_AndExpressionCompletion")
alf_ExclusiveOrExpression = Class(name="alf_ExclusiveOrExpression")
alf_ExclusiveOrExpressionCompletion = Class(name="alf_ExclusiveOrExpressionCompletion")
alf_InclusiveOrExpression = Class(name="alf_InclusiveOrExpression")
alf_InclusiveOrExpressionCompletion = Class(name="alf_InclusiveOrExpressionCompletion")
alf_ConditionalAndExpression = Class(name="alf_ConditionalAndExpression")
alf_ConditionalAndExpressionCompletion = Class(name="alf_ConditionalAndExpressionCompletion")
alf_EqualityExpressionCompletion = Class(name="alf_EqualityExpressionCompletion")
alf_AndExpression = Class(name="alf_AndExpression")
ExpressionCompletion = Class(name="ExpressionCompletion")
alf_AssignmentExpressionCompletion = Class(name="alf_AssignmentExpressionCompletion")
alf_StatementSequence = Class(name="alf_StatementSequence")
alf_DocumentedStatement = Class(name="alf_DocumentedStatement")
alf_Statement = Class(name="alf_Statement")
alf_AnnotatedStatement = Class(name="alf_AnnotatedStatement")
Statement = Class(name="Statement")
alf_Annotations = Class(name="alf_Annotations")
alf_ConditionalOrExpression = Class(name="alf_ConditionalOrExpression")
alf_ConditionalOrExpressionCompletion = Class(name="alf_ConditionalOrExpressionCompletion")
alf_ConditionalExpression = Class(name="alf_ConditionalExpression")
alf_ConditionalExpressionCompletion = Class(name="alf_ConditionalExpressionCompletion")
alf_Annotation = Class(name="alf_Annotation")
alf_NameList = Class(name="alf_NameList")
alf_InLineStatement = Class(name="alf_InLineStatement")
alf_BlockStatement = Class(name="alf_BlockStatement")
alf_InstanceInitializationExpression = Class(name="alf_InstanceInitializationExpression")
alf_IfStatement = Class(name="alf_IfStatement")
alf_SequentialClauses = Class(name="alf_SequentialClauses")
alf_FinalClause = Class(name="alf_FinalClause")
alf_ConcurrentClauses = Class(name="alf_ConcurrentClauses")
alf_NonFinalClause = Class(name="alf_NonFinalClause")
alf_EmptyStatement = Class(name="alf_EmptyStatement")
alf_LocalNameDeclarationOrExpressionStatement = Class(name="alf_LocalNameDeclarationOrExpressionStatement")
alf_LocalNameDeclarationStatementCompletion = Class(name="alf_LocalNameDeclarationStatementCompletion")
alf_LocalNameDeclarationStatement = Class(name="alf_LocalNameDeclarationStatement")
alf_WhileStatement = Class(name="alf_WhileStatement")
alf_DoStatement = Class(name="alf_DoStatement")
alf_ForStatement = Class(name="alf_ForStatement")
alf_ForControl = Class(name="alf_ForControl")
alf_LoopVariableDefinition = Class(name="alf_LoopVariableDefinition")
alf_SwitchStatement = Class(name="alf_SwitchStatement")
alf_SwitchClause = Class(name="alf_SwitchClause")
alf_SwitchDefaultClause = Class(name="alf_SwitchDefaultClause")
alf_SwitchCase = Class(name="alf_SwitchCase")
alf_NonEmptyStatementSequence = Class(name="alf_NonEmptyStatementSequence")
alf_SimpleAcceptStatementCompletion = Class(name="alf_SimpleAcceptStatementCompletion")
alf_CompoundAcceptStatementCompletion = Class(name="alf_CompoundAcceptStatementCompletion")
alf_AcceptBlock = Class(name="alf_AcceptBlock")
alf_ClassifyStatement = Class(name="alf_ClassifyStatement")
alf_ClassificationClause = Class(name="alf_ClassificationClause")
alf_ClassificationFromClause = Class(name="alf_ClassificationFromClause")
alf_ClassificationToClause = Class(name="alf_ClassificationToClause")
alf_ReclassifyAllClause = Class(name="alf_ReclassifyAllClause")
alf_BreakStatement = Class(name="alf_BreakStatement")
alf_ReturnStatement = Class(name="alf_ReturnStatement")
alf_AcceptStatement = Class(name="alf_AcceptStatement")
alf_AcceptClause = Class(name="alf_AcceptClause")
...
alf_VisibilityIndicator.attributes={alf_VisibilityIndicator_PUBLIC, alf_VisibilityIndicator_PROTECTED, alf_VisibilityIndicator_PRIVATE}
...
alf_StructuredMember.attributes={alf_StructuredMember_isPublic, alf_StructuredMember_comment}
...
alf_FormalParameter.attributes={alf_FormalParameter_comment, alf_FormalParameter_parameterDirection}
...
alf_Multiplicity.attributes={alf_Multiplicity_isOrdered, alf_Multiplicity_isSequence, alf_Multiplicity_isNonUnique}
...
domain_model = DomainModel(
    name="alf",
    types={alf_ImportReference, alf_UnitDefinition, alf_NamespaceDeclaration, alf_ImportDeclaration, alf_StereotypeAnnotations, alf_NamespaceDefinition, alf_BOOLEAN_LITERAL, PRIMITIVE_LITERAL, alf_NUMBER_LITERAL, alf_INTEGER_LITERAL, NUMBER_LITERAL, alf_UNLIMITED_NATURAL, alf_STRING_LITERAL, alf_StereotypeAnnotation, alf_QualifiedName, alf_TaggedValues, alf_TaggedValueList, TaggedValues, alf_TaggedValue, alf_PRIMITIVE_LITERAL, alf_Name, alf_ImportReferenceQualifiedNameCompletion, alf_AliasDefinition, alf_ColonQualifiedNameCompletionOfImportReference, ImportReferenceQualifiedNameCompletion, alf_VisibilityIndicator, alf_PackageDeclaration, alf_PackageDefinition, NamespaceDefinition, ClassMemberDefinition, alf_ClassifierSignature, alf_PackageBody, alf_TemplateParameters, alf_PackageDefinitionOrStub, PackagedElementDefinition, alf_SpecializationClause, alf_ClassifierTemplateParameter, alf_QualifiedNameList, alf_ClassDeclaration, alf_ClassDefinition, ClassifierDefinition, alf_ClassBody, alf_ClassDefinitionOrStub, ClassifierDefinitionOrStub, alf_ClassMember, alf_ClassMemberDefinition, ActiveClassMemberDefinition, alf_PackagedElement, alf_ActiveClassDeclaration, alf_PackagedElementDefinition, alf_ClassifierDefinition, alf_ClassifierDefinitionOrStub, alf_ActiveClassDefinitionOrStub, alf_ActiveClassMember, alf_BehaviorClause, alf_Block, alf_ActiveClassMemberDefinition, alf_DataTypeDeclaration, alf_DataTypeDefinition, alf_StructuredBody, alf_DataTypeDefinitionOrStub, alf_StructuredMember, alf_ActiveClassDefinition, alf_ActiveClassBody, alf_AssociationDefinitionOrStub, alf_EnumerationDeclaration, alf_EnumerationDefinition, alf_EnumerationBody, alf_EnumerationDefinitionOrStub, alf_EnumerationLiteralName, alf_SignalDeclaration, alf_SignalDefinition, alf_SignalDefinitionOrStub, alf_ActivityDeclaration, alf_PropertyDefinition, alf_AssociationDeclaration, alf_AssociationDefinition, alf_ActivityDefinition, alf_ActivityDefinitionOrStub, alf_FormalParameterList, alf_FormalParameter, alf_FeatureDefinitionOrStub, alf_ActiveFeatureDefinitionOrStub, alf_PropertyDeclaration, alf_AttributeDefinition, FeatureDefinitionOrStub, alf_FormalParameters, alf_TypePart, alf_TypeName, alf_Multiplicity, alf_MultiplicityRange, alf_UnlimitedNaturalLiteral, alf_OperationDeclaration, OperationDefinitionOrStub, alf_RedefinitionClause, alf_OperationDefinitionOrStub, alf_AttributeInitializer, alf_ReceptionDefinition, ActiveFeatureDefinitionOrStub, alf_InitializationExpression, alf_SignalReceptionDefinitionOrStub, alf_UnqualifiedName, alf_ColonQualifiedNameCompletion, alf_NameBinding, UnqualifiedName, alf_TemplateBinding, alf_QualifiedNameWithoutBinding, alf_ColonQualifiedNameCompletionWithoutBinding, alf_PositionalTemplateBinding, TemplateBinding, alf_NamedTemplateBinding, alf_TemplateParameterSubstitution, alf_SignalReceptionDeclaration, alf_NonNameExpression, alf_NonNameUnaryExpression, alf_NameToExpressionCompletion, alf_NameToPrimaryExpression, alf_PrimaryToExpressionCompletion, alf_PostfixExpressionCompletion, alf_PrimaryExpression, alf_NameOrPrimaryExpression, alf_BaseExpression, alf_ParenthesizedExpression, alf_PrimaryExpressionCompletion, alf_LinkOperationCompletion, alf_ClassExtentExpressionCompletion, alf_SequenceConstructionExpressionCompletion, alf_BehaviorInvocation, alf_Feature_Or_SequenceOperationOrReductionOrExpansion_Or_Index, alf_Feature, alf_FeatureInvocation, alf_SequenceOperationOrReductionOrExpansion, alf_Expression, InitializationExpression, alf_UnaryExpression, alf_ExpressionCompletion, alf_ThisExpression, alf_Tuple, alf_NamedTupleExpressionList, alf_PositionalTupleExpressionList, alf_PositionalTupleExpressionListCompletion, alf_NamedExpression, alf_Index, alf_LiteralExpression, BaseExpression, alf_LinkOperationTuple, alf_IndexedNamedExpressionListCompletion, alf_IndexedNamedExpression, alf_SuperInvocationExpression, alf_InstanceCreationOrSequenceConstructionExpression, alf_MultiplicityIndicator, alf_SequenceElements, alf_SequenceElementListCompletion, alf_SequenceInitializationExpression, alf_SequenceElement, alf_SequenceAnyExpression, alf_EObject, alf_PostfixOperation, alf_PrefixExpression, NonPostfixNonCastUnaryExpression, alf_PostfixOrCastExpression, UnaryExpression, CastCompletion, alf_NonNamePostfixOrCastExpression, NonNameUnaryExpression, alf_CastCompletion, alf_BitStringComplementExpression, alf_NumericUnaryExpression, alf_IsolationExpression, alf_MultiplicativeExpression, alf_MultiplicativeExpressionCompletion, alf_AdditiveExpression, alf_AdditiveExpressionCompletion, alf_NonPostfixNonCastUnaryExpression, alf_BooleanNegationExpression, alf_RelationalExpression, alf_RelationalExpressionCompletion, alf_ClassificationExpression, alf_ClassificationExpressionCompletion, alf_EqualityExpression, alf_ShiftExpression, alf_ShiftExpressionCompletion, alf_AndExpressionCompletion, alf_ExclusiveOrExpression, alf_ExclusiveOrExpressionCompletion, alf_InclusiveOrExpression, alf_InclusiveOrExpressionCompletion, alf_ConditionalAndExpression, alf_ConditionalAndExpressionCompletion, alf_EqualityExpressionCompletion, alf_AndExpression, ExpressionCompletion, alf_AssignmentExpressionCompletion, alf_StatementSequence, alf_DocumentedStatement, alf_Statement, alf_AnnotatedStatement, Statement, alf_Annotations, alf_ConditionalOrExpression, alf_ConditionalOrExpressionCompletion, alf_ConditionalExpression, alf_ConditionalExpressionCompletion, alf_Annotation, alf_NameList, alf_InLineStatement, alf_BlockStatement, alf_InstanceInitializationExpression, alf_IfStatement, alf_SequentialClauses, alf_FinalClause, alf_ConcurrentClauses, alf_NonFinalClause, alf_EmptyStatement, alf_LocalNameDeclarationOrExpressionStatement, alf_LocalNameDeclarationStatementCompletion, alf_LocalNameDeclarationStatement, alf_WhileStatement, alf_DoStatement, alf_ForStatement, alf_ForControl, alf_LoopVariableDefinition, alf_SwitchStatement, alf_SwitchClause, alf_SwitchDefaultClause, alf_SwitchCase, alf_NonEmptyStatementSequence, alf_SimpleAcceptStatementCompletion, alf_CompoundAcceptStatementCompletion, alf_AcceptBlock, alf_ClassifyStatement, alf_ClassificationClause, alf_ClassificationFromClause, alf_ClassificationToClause, alf_ReclassifyAllClause, alf_BreakStatement, alf_ReturnStatement, alf_AcceptStatement, alf_AcceptClause, ImportVisibilityIndicator, ParameterDirection, LinkOperation, AffixOperator, NumericUnaryOperator, MultiplicativeOperator, ShiftOperator, RelationalOperator, ClassificationOperator, AdditiveOperator, EqualityOperator, AssignmentOperator},
    associations={importReference21, namespaceDeclaration0, importDeclarations1, stereotypeAnnotations3, namesapceDefinition5, annotation7, stereotypeName9, taggedValues11, taggedValue13, name14, value16, qualifiedName18, name23, completion26, alias28, name30, alias32, alias35, name38, declaration40, name56, body42, templateParameters58, declaration44, specializationClause60, classifierTemplateParameter62, name64, qualifiedName67, qualifiedNameList70, classifierSignature72, classDeclaration74, classBody76, classDeclaration78, classBody80, classMember83, stereotypeAnnotations85, visibilityIndicator88, body46, classMemberDefinition90, packagedElement49, classifierSignature92, stereotypeAnnotations51, packagedElementDefinition54, activeClassDeclaration98, activeClassBody100, activeClassMember103, behaviorClasue105, block107, name109, stereotypeAnnotations112, visibilityIndicator115, activeClassMemberDefinition118, classifierSignature120, dataTypeDeclaration122, structureBody124, dataTypeDeclaration126, structureBody128, structuredMember131, streotypeAnnotations133, activeClassDeclaration94, activeClassBody96, associationDeclaration140, structuredBody142, associationDeclaration145, structuredBody147, name150, specializationClause152, enumerationClause155, enumerationBody157, enumerationDeclaration159, enumerationBody161, enumerationLiteralName164, name166, classifierSignature169, signalDeclaration171, structuredBody173, signalDeclaration176, structuredBody178, name181, propertyDefinition136, classifierSignature138, activityDeclaration190, block192, activityDeclaration195, block197, formalParameterList200, formalParameter202, stereotypeAnnotations204, name207, typePart210, propertyDeclaration213, templateParameters183, formalParameters186, typePart224, typePart188, typeName227, multiplicity229, qualifiedName231, multiplicityRange234, lower236, upper238, integer240, name243, formalParameters245, typePart248, redefinitionClause251, block253, propertyDeclaration215, qualifiedNameList256, attributeInitializer217, initializationExpression219, name221, specializationClause263, signalReceptionOrDeclaration266, structuredBody268, unqualified271, nameCompletion273, namedBindings275, name277, templateBinding280, unqualified282, nameCompletion284, names286, qualifiedName289, templateParameterSubstitution291, name292, receptionName259, signalName261, expressionCompletion299, nonNameUnaryExpression301, expressionCompletion302, nameToPrimary305, primaryToExpressionCompletion306, postFixExpressionCompletion308, expressionCompletion310, expression313, nameOrPrimaryExpression316, baseExpression317, parenthesizedExpression319, primaryExpressionCompletion321, linkOperationCompletion323, classExtentExpressionCompletion325, sequenceConstructionCompletion327, behaviorInvocation329, content331, feature333, featureInvocation335, sequenceOperationOrReductionOrExpansion337, qualifiedName295, unaryExpression298, potentiallyAmbiguousQualifiedName343, nameToPrimaryExpression346, tuple349, expression350, name353, namedTupleExpressionList356, positionalTupleExpressionList358, expression360, expression363, namedExpression365, name367, expression370, tuple373, index339, tuple389, expression341, linkOperationTuple392, name394, index397, indexNamedExpressionListCompletion400, primaryToExpressionCompletion402, positionalTupleExpressionListCompletion405, indexedNamedExpressionListCompletion408, nameToExpressionCompletion411, positionalTupleExpressionList414, expression417, indexedNamedExpression420, name422, index425, expression428, tuple376, qualifiedName379, tuple381, qualifiedName384, sequenceConstructionExpressionCompletion386, sequenceConstructionExpressionCompletion431, multiplicityIndicator433, sequenceElements435, expression1437, expression2440, sequenceElementListCompletion443, sequenceInitializationExpression445, sequenceElement447, expression449, sequenceInitializationExpression452, sequenceElements455, expression458, qualifiedName461, tuple463, templateBinding466, primaryExpressionCompletion475, postfixOperation478, primaryExpression480, nonNamePostfixOrCastExpression482, nameOrPrimaryExpression483, postFixExpressionCompletion486, castCompletion489, name469, expression472, unaryExpression509, unaryExpression511, unaryExpression513, unaryExpression515, unaryExpression517, multiplicativeExpressionCompletion519, unaryExpression521, unaryExpression524, additiveExpressionCompletion526, potentiallyAmbiguousQualifiedName491, multiplicativeExpressionCompletion528, postifixExpressionCompletion494, nameToExpressionCompletion497, postfixExpressionCompletion500, nonNameExpression503, baseExpression506, additiveExpression541, unaryExpression544, relationalExpressionCompletion546, shiftExpressionCompletion548, shiftExpression551, unaryExpression554, classificationExpressionCompletion556, relationalExpressionCompletion558, name561, unaryExpression564, multiplicativeExpression531, unaryExpression534, shiftExpressionCompletion536, additiveExpressionCompletion538, andExpressionCompletion576, equalityExpressionCompletion578, equalityExpression581, unaryExpression584, exclusiveOrExpressionCompletion586, andExpressionCompletion588, andExpression591, unaryExpression594, inclusiveOrExpressionCompletion596, exclusiveOrExpressionCompletion598, exclusiveOrExpression601, unaryExpression604, conditionalAndExpressionCompletion606, inclusiveOrExpressionCompletion608, inclusiveOrExpression611, classificationExpressionCompletion566, classificationExpressionCompletion569, classificationExpression571, unaryExpression574, conditionalExpressionCompletion626, conditionalOrExpressionCompletion628, conditionalExpression631, documentStatement634, statement635, statementSequence637, annotations640, unaryExpression614, conditionalOrExpressionCompletion616, conditionalAndExpressionCompletion618, conditionalAndExpression621, unaryExpression624, statement641, annotation644, nameList646, name648, name651, name671, typeName673, multiplicityIndicator676, localNameDeclarationCompletion679, initializationExpression682, tuple685, sequentialClauses687, finalClause688, concurrentClauses690, nonFinalClause692, expression694, block697, block653, potentiallyAmbiguousName655, multiplicaityIndicator657, name660, localNameDeclarationCompletion663, nameToExpressionCompletion665, nonNameExpression668, expression713, statementSequence716, statement719, expression722, block724, block727, expression729, forControl732, block733, loopVariableDefinition736, block700, expression703, switchClause705, defaultClause707, switchCase709, statementSequence711, simpleCompletion756, compoundCompletion758, block760, acceptBlock763, acceptClause765, block768, name771, qualifiedNameList774, expression777, classificationClause779, classificationFromClause781, classificationToClause783, name738, expression1741, expression2744, typeName747, expression3750, expression753, acceptClause755, reclassifyAllClause785, qualifiedNameList787, qualifiedNameList790, qualifiedName793},
    generalizations={gen_alf_BOOLEAN_LITERAL_PRIMITIVE_LITERAL, gen_alf_NUMBER_LITERAL_PRIMITIVE_LITERAL, gen_alf_INTEGER_LITERAL_NUMBER_LITERAL, gen_alf_UNLIMITED_NATURAL_NUMBER_LITERAL, gen_alf_STRING_LITERAL_PRIMITIVE_LITERAL, gen_alf_TaggedValueList_TaggedValues, gen_alf_ColonQualifiedNameCompletionOfImportReference_ImportReferenceQualifiedNameCompletion, gen_alf_PackageDefinition_NamespaceDefinition, gen_alf_ClassifierDefinitionOrStub_PackagedElementDefinition, gen_alf_ClassifierDefinitionOrStub_ClassMemberDefinition, gen_alf_PackageDefinitionOrStub_PackagedElementDefinition, gen_alf_ClassDefinition_ClassifierDefinition, gen_alf_ClassDefinitionOrStub_ClassifierDefinitionOrStub, gen_alf_ClassMemberDefinition_ActiveClassMemberDefinition, gen_alf_ClassifierDefinition_NamespaceDefinition, gen_alf_ActiveClassDefinitionOrStub_ClassifierDefinitionOrStub, gen_alf_DataTypeDefinition_ClassifierDefinition, gen_alf_DataTypeDefinitionOrStub_ClassifierDefinitionOrStub, gen_alf_ActiveClassDefinition_ClassifierDefinition, gen_alf_AssociationDefinitionOrStub_ClassifierDefinitionOrStub, gen_alf_EnumerationDefinition_ClassifierDefinition, gen_alf_EnumerationDefinitionOrStub_ClassifierDefinitionOrStub, gen_alf_SignalDefinition_ClassifierDefinition, gen_alf_SignalDefinitionOrStub_ClassifierDefinitionOrStub, gen_alf_AssociationDefinition_ClassifierDefinition, gen_alf_ActivityDefinition_ClassifierDefinition, gen_alf_ActivityDefinitionOrStub_ClassifierDefinitionOrStub, gen_alf_FeatureDefinitionOrStub_ClassMemberDefinition, gen_alf_ActiveFeatureDefinitionOrStub_ActiveClassMemberDefinition, gen_alf_AttributeDefinition_FeatureDefinitionOrStub, gen_alf_OperationDeclaration_OperationDefinitionOrStub, gen_alf_OperationDefinitionOrStub_FeatureDefinitionOrStub, gen_alf_ReceptionDefinition_ActiveFeatureDefinitionOrStub, gen_alf_SignalReceptionDefinitionOrStub_ActiveFeatureDefinitionOrStub, gen_alf_NameBinding_UnqualifiedName, gen_alf_PositionalTemplateBinding_TemplateBinding, gen_alf_NamedTemplateBinding_TemplateBinding, gen_alf_Expression_InitializationExpression, gen_alf_ThisExpression_BaseExpression, gen_alf_LiteralExpression_BaseExpression, gen_alf_SuperInvocationExpression_BaseExpression, gen_alf_InstanceCreationOrSequenceConstructionExpression_BaseExpression, gen_alf_SequenceAnyExpression_BaseExpression, gen_alf_SequenceInitializationExpression_InitializationExpression, gen_alf_PrefixExpression_NonPostfixNonCastUnaryExpression, gen_alf_PostfixOrCastExpression_UnaryExpression, gen_alf_PostfixOrCastExpression_CastCompletion, gen_alf_NonNamePostfixOrCastExpression_NonNameUnaryExpression, gen_alf_BitStringComplementExpression_NonPostfixNonCastUnaryExpression, gen_alf_BitStringComplementExpression_CastCompletion, gen_alf_NumericUnaryExpression_NonPostfixNonCastUnaryExpression, gen_alf_IsolationExpression_NonPostfixNonCastUnaryExpression, gen_alf_IsolationExpression_CastCompletion, gen_alf_NonPostfixNonCastUnaryExpression_UnaryExpression, gen_alf_NonPostfixNonCastUnaryExpression_NonNameUnaryExpression, gen_alf_BooleanNegationExpression_NonPostfixNonCastUnaryExpression, gen_alf_BooleanNegationExpression_CastCompletion, gen_alf_ConditionalExpressionCompletion_ExpressionCompletion, gen_alf_AssignmentExpressionCompletion_ExpressionCompletion, gen_alf_AnnotatedStatement_Statement, gen_alf_InLineStatement_Statement, gen_alf_BlockStatement_Statement, gen_alf_InstanceInitializationExpression_InitializationExpression, gen_alf_IfStatement_Statement, gen_alf_EmptyStatement_Statement, gen_alf_LocalNameDeclarationOrExpressionStatement_Statement, gen_alf_LocalNameDeclarationStatement_Statement, gen_alf_WhileStatement_Statement, gen_alf_DoStatement_Statement, gen_alf_ForStatement_Statement, gen_alf_SwitchStatement_Statement, gen_alf_ClassifyStatement_Statement, gen_alf_BreakStatement_Statement, gen_alf_ReturnStatement_Statement, gen_alf_AcceptStatement_Statement, gen_alf_QualifiedNameList_TaggedValues},
    metadata=None
)
