...
public class mypackage_Customer  {
    ...
    public mypackage_Customer(
        String address,        String name,        String emailAddress,        String phoneNumber,        LocalDate dateOfBirth    ) {
    ...
    public mypackage_Customer(
        String address,        String name,        String emailAddress,        String phoneNumber,        LocalDate dateOfBirth        ArrayList<account_Account> account_accounts    ) {
        this.address = address;
        this.name = name;
        this.emailAddress = emailAddress;
        this.phoneNumber = phoneNumber;
