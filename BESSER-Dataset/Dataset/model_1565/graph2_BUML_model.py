...
# Classes
graph2_GraphComponent = Class(name="graph2_GraphComponent", is_abstract=True)
graph2_Node = Class(name="graph2_Node")
GraphComponent = Class(name="GraphComponent")
graph2_Edge = Class(name="graph2_Edge")
graph2_Graph = Class(name="graph2_Graph")
...
domain_model = DomainModel(
    name="graph2",
    types={graph2_GraphComponent, graph2_Node, GraphComponent, graph2_Edge, graph2_Graph},
    associations={gcs4, src0, trg1},
