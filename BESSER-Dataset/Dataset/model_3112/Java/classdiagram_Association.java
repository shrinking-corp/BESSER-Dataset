...
public class classdiagram_Association  {
    ...
    private classdiagram_Diagram classdiagram_diagram;


    public classdiagram_Association(
        int targetMultiplicity,        int sourceMultiplicity,        String name    ) {
    ...
    public classdiagram_Diagram getClassdiagram_diagram() {
        return classdiagram_diagram;
    }

    public void setClassdiagram_diagram(classdiagram_Diagram classdiagram_diagram) {
        this.classdiagram_diagram = classdiagram_diagram;
    }
