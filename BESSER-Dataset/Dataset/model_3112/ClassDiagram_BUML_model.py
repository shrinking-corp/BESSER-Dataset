...
classdiagram_Method = Class(name="classdiagram_Method")
classdiagram_Aggregation = Class(name="classdiagram_Aggregation")
Association = Class(name="Association")
classdiagram_Composition = Class(name="classdiagram_Composition")
classdiagram_Dependency = Class(name="classdiagram_Dependency")
classdiagram_Diagram = Class(name="classdiagram_Diagram")
classdiagram_Class = Class(name="classdiagram_Class")
classdiagram_Association = Class(name="classdiagram_Association")
classdiagram_PrimitiveDataType = Class(name="classdiagram_PrimitiveDataType")
classdiagram_Generalization = Class(name="classdiagram_Generalization")
classdiagram_AttributeValue = Class(name="classdiagram_AttributeValue", is_abstract=True)
classdiagram_Interface = Class(name="classdiagram_Interface")
classdiagram_InterfaceRealization = Class(name="classdiagram_InterfaceRealization")
classdiagram_Realization = Class(name="classdiagram_Realization")
...
classdiagram_Class.attributes={classdiagram_Class_is_persistent, classdiagram_Class_name}
...
classdiagram_Association.attributes={classdiagram_Association_name, classdiagram_Association_targetMultiplicity, classdiagram_Association_sourceMultiplicity}
...
domain_model = DomainModel(
    name="classdiagram",
    types={AttributeValue, classdiagram_Attribute, classdiagram_Method, classdiagram_Aggregation, Association, classdiagram_Composition, classdiagram_Dependency, classdiagram_Diagram, classdiagram_Class, classdiagram_Association, classdiagram_PrimitiveDataType, classdiagram_Generalization, classdiagram_AttributeValue, classdiagram_Interface, classdiagram_InterfaceRealization, classdiagram_Realization},
    associations={target10, attribute13, method15, classes0, associations1, types3, generalizations5, source7, target35, type38, source17, target20, attribute23, method25, source28, target30, source33},
    generalizations={gen_classdiagram_Class_AttributeValue, gen_classdiagram_Aggregation_Association, gen_classdiagram_Composition_Association, gen_classdiagram_Dependency_Association, gen_classdiagram_PrimitiveDataType_AttributeValue},
    metadata=None
)
