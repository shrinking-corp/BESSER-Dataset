...
domain_model = DomainModel(
    ...
    types={simplestatechart101_Thing, NamedElement, simplestatechart101_RelatedTo, simplestatechart101_Variable, Thing, simplestatechart101_Transition, simplestatechart101_State, simplestatechart101_NamedElement},
    associations={relations0, toThing2, source3, target4, substates8, parentstate11, variables13, transitions15, fromThing1},
    generalizations={gen_simplestatechart101_Thing_NamedElement, gen_simplestatechart101_Variable_Thing, gen_simplestatechart101_Transition_NamedElement, gen_simplestatechart101_State_NamedElement, gen_simplestatechart101_RelatedTo_NamedElement},
    metadata=None
)
