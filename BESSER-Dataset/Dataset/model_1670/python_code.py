...
class simplestatechart101_RelatedTo(NamedElement):
    ...
    def __init__(self, since: str, RelatedTo: "simplestatechart101_Thing" = None, simplestatechart101_RelatedTo: "simplestatechart101_Thing" = None, relations: "simplestatechart101_Thing" = None):
        self.since = since
...
class simplestatechart101_Thing(NamedElement):
    ...
    def __init__(self, id: int, fromThing: set["simplestatechart101_RelatedTo"] = None, simplestatechart101_Thing: "simplestatechart101_RelatedTo" = None, Thing: "simplestatechart101_RelatedTo" = None):
        self.id = id
