...
HouseHolds.attributes={HouseHolds_DishWasher, HouseHolds_Coffee, HouseHolds_Alarm, HouseHolds_TimeID, HouseHolds_WashingMachine}
...
Card_face_up: Property = Property(name="face_up", type=StringType)
Card.attributes={Card_suit, Card_face_up, Card_rank}

# Player class attributes and methods
Player_name: Property = Property(name="name", type=StringType)
Player_score: Property = Property(name="score", type=IntegerType)
Player.attributes={Player_score, Player_name}
...
domain_model = DomainModel(
    name="_4987af35_dd3a_464e_b57a_47b86fc69902",
    types={System, Sensor, FireAlarm_Sensor, Motion_Sensor, PressureSensor, Home_Security_System, Alert, Door, Camera, Speakers, MicroPhone, Light, Start_Of_Day, End_Of_Day, TV, HomeTheatre, HouseHolds, Entertainment, Card, Player},
