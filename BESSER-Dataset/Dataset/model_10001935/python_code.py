...
class C(ABC):
    ...
    def __init__(self, attC1: int, attC2: bool, myClass55: "B" = None):
        self.attC1 = attC1
        self.attC2 = attC2
        self.myClass55 = myClass55
    ...
    @property
    def myClass55(self):
        return self.__myClass55
    @myClass55.setter
    def myClass55(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_C__myClass55", None)
        self.__myClass55 = value
    ...
    def c4(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "myClass55"):
                    opp_val = getattr(item, "myClass55", None)
                    
                    if opp_val == self:
                        setattr(item, "myClass55", None)
