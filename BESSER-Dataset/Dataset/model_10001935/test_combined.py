...
def test_assoc_MyClass3_MyClass4_link_reassign_clear():
...
def test_assoc_MyClass4_MyClass5_link_reassign_clear():
    a = B(attB=7)
...
def test_assoc_MyClass5_MyClass6_link_reassign_clear():
    a = C(attC1=7, attC2=True)
    b1 = B(attB=7)
    b2 = B(attB=13)
    _safe_set(a, 'myClass55', b1)
    assert _is_linked(a, 'myClass55', b1)
    if hasattr(b1, 'c4'):
        assert _is_linked(b1, 'c4', a)
    _safe_set(a, 'myClass55', b2)
    assert _is_linked(a, 'myClass55', b2)
    if hasattr(b1, 'c4'):
        assert not _is_linked(b1, 'c4', a)
    if hasattr(b2, 'c4'):
        assert _is_linked(b2, 'c4', a)
    _safe_set(a, 'myClass55', None)
    assert not _is_linked(a, 'myClass55', b2)
    if hasattr(b2, 'c4'):
