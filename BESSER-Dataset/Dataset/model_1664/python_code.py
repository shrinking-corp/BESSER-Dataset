...
class NamedElement:
    ...
    pass
class nested103_EClass5(EClass6, NamedElement):
...
class nested103_RelatedTo(NamedElement):
    ...
    def __init__(self, since: str, relations: "nested103_Thing" = None, nested103_RelatedTo: "nested103_Thing" = None, RelatedTo: "nested103_Thing" = None):
        self.since = since
...
class nested103_Thing(NamedElement):
    ...
    def __init__(self, id: int, Thing: "nested103_RelatedTo" = None, nested103_Thing8: "nested103_RelatedTo" = None, nested103_Thing: "nested103_World" = None, fromThing: set["nested103_RelatedTo"] = None, nested103_Thing5: set["nested103_EClass0"] = None):
        self.id = id
        self.Thing = Thing
...
class EClass7:
    ...
    pass
class nested103_EClass6(EClass8, EClass7):
