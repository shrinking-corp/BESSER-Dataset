...
Machine_attribute: Property = Property(name="attribute", type=StringType)
Machine_attribute2: Property = Property(name="attribute2", type=StringType)
Machine.attributes={Machine_attribute2, Machine_attribute}
...
domain_model = DomainModel(
    name="_ceOHEFPJEeqK2M3E1LfZ7Q",
    types={Vendor2Adapter, Vendor1Sound, Vendor2Sound, ExtensionBoard, FastCard, CPU, Processor, AcceleratorCard, Cache, RAM, Machine, Program, Instruction, Memory_Interface, DeviceCard, Card, Sound, GenericSound, Vendor1Adapter},
