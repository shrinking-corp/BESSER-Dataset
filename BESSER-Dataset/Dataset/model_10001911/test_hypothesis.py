...
def test_machine_has_attribute2():
    assert hasattr(Machine, "attribute2")
    descriptor = None
...
def test_machine_has_attribute():
    assert hasattr(Machine, "attribute")
    descriptor = None
    for klass in Machine.__mro__:
...
@given(instance=Machine_strategy)
def test_machine_attribute2_setter(instance):
...
@given(instance=Machine_strategy)
def test_machine_attribute_setter(instance):
