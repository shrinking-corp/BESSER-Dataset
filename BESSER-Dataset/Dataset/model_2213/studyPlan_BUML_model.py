...
# Classes
studyPlan_SemesterPlan = Class(name="studyPlan_SemesterPlan")
studyPlan_Semester = Class(name="studyPlan_Semester")
Semester = Class(name="Semester")
studyPlan_SemesterProgramme = Class(name="studyPlan_SemesterProgramme")
studyPlan_Course = Class(name="studyPlan_Course")
studyPlan_University = Class(name="studyPlan_University")
studyPlan_Student = Class(name="studyPlan_Student")
studyPlan_StudyProgramme = Class(name="studyPlan_StudyProgramme")
studyPlan_StudyPlan = Class(name="studyPlan_StudyPlan")
studyPlan_Specialization = Class(name="studyPlan_Specialization")
...
studyPlan_Semester.attributes={studyPlan_Semester_season, studyPlan_Semester_year, studyPlan_Semester_codename}
...
studyPlan_Course.attributes={studyPlan_Course_codename, studyPlan_Course_credits, studyPlan_Course_name, studyPlan_Course_level}
...
studyPlan_StudyProgramme.attributes={studyPlan_StudyProgramme_codename, studyPlan_StudyProgramme_lengthInYears, studyPlan_StudyProgramme_name}
...
studyPlan_Specialization.attributes={studyPlan_Specialization_year, studyPlan_Specialization_name}
...
domain_model = DomainModel(
    name="studyPlan",
    types={studyPlan_SemesterPlan, studyPlan_Semester, Semester, studyPlan_SemesterProgramme, studyPlan_Course, studyPlan_University, studyPlan_Student, studyPlan_StudyProgramme, studyPlan_StudyPlan, studyPlan_Specialization, SeasonEnum},
    associations={student6, semesterPlans8, studyPlan9, selectedCourses10, university0, students1, studyProgrammes2, courses4, studyProgramme25, continuations28, semesters29, specialization11, mandatoryCourses12, electiveCourses14, university17, studyplan19, university21, specializations23},
