...
def test_hyp_studyplan_studyprogramme_is_not_abstract():
    assert not inspect.isabstract(studyPlan_StudyProgramme)


def test_hyp_studyplan_studyprogramme_constructor_exists():
    assert callable(studyPlan_StudyProgramme.__init__)


def test_hyp_studyplan_studyprogramme_constructor_args():
...
def test_hyp_studyplan_student_is_not_abstract():
    assert not inspect.isabstract(studyPlan_Student)


def test_hyp_studyplan_student_constructor_exists():
    assert callable(studyPlan_Student.__init__)


def test_hyp_studyplan_student_constructor_args():
...
def test_hyp_studyplan_university_is_not_abstract():
    assert not inspect.isabstract(studyPlan_University)


def test_hyp_studyplan_university_constructor_exists():
    assert callable(studyPlan_University.__init__)


def test_hyp_studyplan_university_constructor_args():
...
def test_hyp_semester_is_not_abstract():
    assert not inspect.isabstract(Semester)


def test_hyp_semester_constructor_exists():
    assert callable(Semester.__init__)


def test_hyp_semester_constructor_args():
    sig = inspect.signature(Semester.__init__)
    params = list(sig.parameters.keys())



def test_hyp_studyplan_semesterprogramme_is_not_abstract():
    assert not inspect.isabstract(studyPlan_SemesterProgramme)


def test_hyp_studyplan_semesterprogramme_constructor_exists():
    assert callable(studyPlan_SemesterProgramme.__init__)


def test_hyp_studyplan_semesterprogramme_constructor_args():
...
def test_hyp_studyplan_semesterplan_is_not_abstract():
    assert not inspect.isabstract(studyPlan_SemesterPlan)


def test_hyp_studyplan_semesterplan_constructor_exists():
    assert callable(studyPlan_SemesterPlan.__init__)


def test_hyp_studyplan_semesterplan_constructor_args():
    sig = inspect.signature(studyPlan_SemesterPlan.__init__)
    params = list(sig.parameters.keys())

def test_hyp_seasonenum_exists():
    # Check that the Enumeration exists
    assert SeasonEnum is not None

def test_hyp_seasonenum_has_all_literals():
...
@given(instance=studyPlan_Specialization_strategy)
def test_hyp_studyplan_specialization_year_setter(instance):
...
def test_hyp_studyplan_studyprogramme_codename_setter(instance):
...
@given(instance=studyPlan_StudyProgramme_strategy)
def test_hyp_studyplan_studyprogramme_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=studyPlan_StudyProgramme_strategy)
def test_hyp_studyplan_studyprogramme_lengthInYears_setter(instance):
...
def test_hyp_studyplan_student_username_setter(instance):
...
@given(instance=studyPlan_Student_strategy)
def test_hyp_studyplan_student_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_studyplan_university_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=studyPlan_Course_strategy)
def test_hyp_studyplan_course_codename_setter(instance):
    original = instance.codename
    instance.codename = original
    assert instance.codename == original
...
@given(instance=studyPlan_Course_strategy)
def test_hyp_studyplan_course_level_setter(instance):
...
@given(instance=studyPlan_Semester_strategy)
def test_hyp_studyplan_semester_codename_setter(instance):
    original = instance.codename
    instance.codename = original
    assert instance.codename == original
