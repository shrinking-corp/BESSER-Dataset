...
class modeldraw_Enumerator:
    ...
    def __init__(self, value: str, modeldraw_Enumerator: "modeldraw_NodeEnumerator" = None, modeldraw_Enumerator38: "modeldraw_EEnumLiteral" = None):
        self.value = value
...
class modeldraw_BooleanAttribute(Item):
    ...
    def __init__(self, negation: bool, modeldraw_BooleanAttribute11: "modeldraw_Node" = None, modeldraw_BooleanAttribute: "modeldraw_EAttribute" = None):
...
class modeldraw_MutatorDraw(Item):
    ...
    def __init__(self, type: str, metamodel: str, modeldraw_MutatorDraw: set["modeldraw_Node"] = None, modeldraw_MutatorDraw3: set["modeldraw_Relation"] = None, modeldraw_MutatorDraw5: set["modeldraw_Content"] = None):
        self.type = type
...
class modeldraw_Node(NamedItem):
    ...
    def __init__(self, type: str, shape: str, color: str, style: str, modeldraw_Node10: set["modeldraw_BooleanAttribute"] = None, modeldraw_Node13: set["modeldraw_EReference"] = None, modeldraw_Node: "modeldraw_MutatorDraw" = None):
        self.type = type
        self.shape = shape
        self.color = color
        self.style = style
