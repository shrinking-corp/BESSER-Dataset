...
modeldraw_EReference = Class(name="modeldraw_EReference")
modeldraw_Item = Class(name="modeldraw_Item", is_abstract=True)
modeldraw_EClass = Class(name="modeldraw_EClass")
modeldraw_MutatorDraw = Class(name="modeldraw_MutatorDraw")
Item = Class(name="Item")
modeldraw_Node = Class(name="modeldraw_Node")
modeldraw_Relation = Class(name="modeldraw_Relation", is_abstract=True)
modeldraw_Content = Class(name="modeldraw_Content")
modeldraw_NamedItem = Class(name="modeldraw_NamedItem", is_abstract=True)
modeldraw_EAttribute = Class(name="modeldraw_EAttribute")
modeldraw_BooleanAttribute = Class(name="modeldraw_BooleanAttribute")
modeldraw_Edge = Class(name="modeldraw_Edge")
Relation = Class(name="Relation")
modeldraw_Level = Class(name="modeldraw_Level")
modeldraw_NodeEnumerator = Class(name="modeldraw_NodeEnumerator")
modeldraw_Enumerator = Class(name="modeldraw_Enumerator")
modeldraw_EEnumLiteral = Class(name="modeldraw_EEnumLiteral")
modeldraw_Information = Class(name="modeldraw_Information")
...
modeldraw_MutatorDraw.attributes={modeldraw_MutatorDraw_metamodel, modeldraw_MutatorDraw_type}
...
modeldraw_Node.attributes={modeldraw_Node_style, modeldraw_Node_shape, modeldraw_Node_color, modeldraw_Node_type}
...
domain_model = DomainModel(
    name="modeldraw",
    types={NamedItem, modeldraw_EReference, modeldraw_Item, modeldraw_EClass, modeldraw_MutatorDraw, Item, modeldraw_Node, modeldraw_Relation, modeldraw_Content, modeldraw_NamedItem, modeldraw_EAttribute, modeldraw_BooleanAttribute, modeldraw_Edge, Relation, modeldraw_Level, modeldraw_NodeEnumerator, modeldraw_Enumerator, modeldraw_EEnumLiteral, modeldraw_Information, DrawType, NodeType, NodeShape, NodeColor, Decoration, NodeStyle},
    associations={att7, attribute9, reference12, name0, nodes1, relations2, contents4, attName6, type39, att41, nodenum44, info47, reference14, label17, src_label20, tar_label23, source26, target28, upper31, att33, enumerator35, literal37},
    generalizations={gen_modeldraw_Node_NamedItem, gen_modeldraw_Relation_NamedItem, gen_modeldraw_MutatorDraw_Item, gen_modeldraw_NamedItem_Item, gen_modeldraw_BooleanAttribute_Item, gen_modeldraw_Content_NamedItem, gen_modeldraw_Edge_Relation, gen_modeldraw_Level_Relation, gen_modeldraw_NodeEnumerator_Item, gen_modeldraw_Information_Item},
    metadata=None
)
