...
class model_IServiceTypeID:
    ...
    def __init__(self, ecfNamingAuthority: str, ecfServices: str, ecfProtocols: str, ecfScopes: str, ecfServiceName: str, ecfServiceTypeID: str, model_IServiceTypeID: "model_IServiceID" = None):
