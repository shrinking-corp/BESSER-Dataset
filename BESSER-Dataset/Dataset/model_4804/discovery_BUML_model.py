...
# Classes
model_IServiceInfo = Class(name="model_IServiceInfo")
model_IServiceID = Class(name="model_IServiceID")
model_INetwork = Class(name="model_INetwork")
model_IHost = Class(name="model_IHost")
model_IServiceTypeID = Class(name="model_IServiceTypeID")
...
model_IServiceInfo.attributes={model_IServiceInfo_ecfName, model_IServiceInfo_ecfWeight, model_IServiceInfo_ecfServiceInfo, model_IServiceInfo_ecfLocation, model_IServiceInfo_ecfPriority}
...
model_IServiceID.attributes={model_IServiceID_ecfServiceName, model_IServiceID_ecfServiceID}
...
model_IHost.attributes={model_IHost_address, model_IHost_name}
...
model_IServiceTypeID.attributes={model_IServiceTypeID_ecfServices, model_IServiceTypeID_ecfServiceName, model_IServiceTypeID_ecfProtocols, model_IServiceTypeID_ecfNamingAuthority, model_IServiceTypeID_ecfServiceTypeID, model_IServiceTypeID_ecfScopes}
...
domain_model = DomainModel(
    name="model",
    types={model_IServiceInfo, model_IServiceID, model_INetwork, model_IHost, model_IServiceTypeID},
    associations={serviceID0, hosts1, services2, serviceTypeID5},
    generalizations={},
    metadata=None
)
