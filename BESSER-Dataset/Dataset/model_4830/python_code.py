...
class DiagramModelContainer:
    ...
    pass
class model_DiagramModelObject(FontAttribute, Connectable, TextAlignment, LineObject):
    ...
    def setBounds(self, model_y, model_x, model_height, model_width):
...
class Properties:
    ...
    pass
class model_DiagramModelNote(DiagramModelObject, Properties, TextPosition, BorderType, TextContent):

    pass
class Documentable:

    pass
class model_DiagramModelConnection(Properties, Documentable, LineObject, FontAttribute, Connectable):
...
class model_DiagramModelGroup(DiagramModelObject, Properties, Documentable, TextPosition, DiagramModelContainer, BorderType):

    pass
class model_DiagramModelImage(DiagramModelObject, Documentable, Properties, BorderObject, DiagramModelImageProvider):
...
class ArchimateModelObject:
    ...
    pass
class model_ArchimateConcept(Cloneable, ArchimateModelObject, Documentable, Properties):

    pass
class model_DiagramModelComponent(ArchimateModelObject, Cloneable, Nameable, Identifier, Adapter):
...
class model_DiagramModel(ArchimateModelObject, DiagramModelContainer, Properties, Documentable):
...
class model_SketchModelActor(DiagramModelObject, Properties, Documentable):
    ...
    pass
class model_SketchModelSticky(DiagramModelObject, Properties, TextPosition, DiagramModelContainer, TextContent):
