...
Meetings = Class(name="Meetings")
Bubbles = Class(name="Bubbles")
...
# Meetings class attributes and methods

# Bubbles class attributes and methods
...
User_Post: BinaryAssociation = BinaryAssociation(
    name="User_Post",
    ends={
        Property(name="post2", type=Meetings, multiplicity=Multiplicity(0, 9999)),
...
User_Group: BinaryAssociation = BinaryAssociation(
    name="User_Group",
    ends={
        Property(name="group6", type=Bubbles, multiplicity=Multiplicity(0, 9999)),
...
domain_model = DomainModel(
    name="c2361504_7810_457a_afd2_da35e2b6f891",
    types={User, Profile, Meetings, Bubbles, Message, Contacts, Login},
