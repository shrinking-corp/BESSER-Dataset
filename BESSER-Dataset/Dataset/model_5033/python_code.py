...
class customers_Customer:
    ...
    def __init__(self, firstName: str, lastName: str, comment: str, dateOfBirth: date, Customer: "customers_CreditCard" = None, holder: set["customers_CreditCard"] = None, customers_Customer: "customers_Address" = None, customers_Customer4: "customers_CustomersDB" = None):
