...
# Classes
customers_Customer = Class(name="customers_Customer")
customers_USAddress = Class(name="customers_USAddress")
Address = Class(name="Address")
customers_CanadaAddress = Class(name="customers_CanadaAddress")
customers_CreditCard = Class(name="customers_CreditCard")
customers_Address = Class(name="customers_Address")
customers_CustomersDB = Class(name="customers_CustomersDB")
...
customers_Customer.attributes={customers_Customer_firstName, customers_Customer_lastName, customers_Customer_comment, customers_Customer_dateOfBirth}
...
customers_CreditCard.attributes={customers_CreditCard_expiresDate, customers_CreditCard_type, customers_CreditCard_ccNumber}
...
customers_Address.attributes={customers_Address_town, customers_Address_zipCode, customers_Address_street}
...
domain_model = DomainModel(
    name="customers",
    types={customers_Customer, customers_USAddress, Address, customers_CanadaAddress, customers_CreditCard, customers_Address, customers_CustomersDB, USStates, CanadaProvinces},
    associations={holder2, creditCard0, address1, customers3},
