...
domain_model = DomainModel(
    name="wh",
    types={wh_Commands, wh_Wh, wh_Program, wh_Definition, wh_Input, wh_Output, wh_Command, wh_EObject, wh_Nop, wh_Affect, wh_Vars, wh_Exprs, wh_Expr, wh_ExprSimple, wh_Cons, wh_ListExpr, wh_ExprAnd, wh_ExprOr, wh_ExprNot, wh_ExprEq},
    associations={elements0, definition1, input3, exprOrX28, command5, output7, commands9, cmd11, vars13, exp14, exprs16, expr18, cons21, list22, exprs24, exprOr127, exprNot131, exprNotX33, expr36, exprSimp138, exprSimp241, expr44},
    generalizations={},
    metadata=None
)
