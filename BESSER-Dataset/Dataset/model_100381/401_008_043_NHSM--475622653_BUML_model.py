...
NHSM_Transition.attributes={NHSM_Transition_trigger, NHSM_Transition_effect}
...
domain_model = DomainModel(
    name="NHSM",
    types={NHSM_Transition, NHSM_State, NHSM_StateMachine, NHSM_InitialState, State, NHSM_FinalState},
    associations={target1, source2, owningStateMachine5, ownedState7, ownedTransition8, owningStateMachine0},
