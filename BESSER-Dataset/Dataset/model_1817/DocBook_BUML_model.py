...
domain_model = DomainModel(
    name="DocBook",
    types={DocBook_DocBook, DocBook_Book, DocBook_Article, DocBook_TitledElement, TitledElement, DocBook_Sect1, DocBook_Section, DocBook_Para, Section, DocBook_Sect2},
    associations={sections_26, books0, articles1, sections_13, paras5, section8},
    generalizations={gen_DocBook_Sect2_Section, gen_DocBook_Article_TitledElement, gen_DocBook_Section_TitledElement, gen_DocBook_Sect1_Section},
    metadata=None
)
