...
class Class_Diagram_for_Propsed_System_Event:
    ...
    def __init__(self, id: int, eventname: str, type: int, date: str):
        self.id = id
...
class Class_Diagram_for_Propsed_System_Deductions:
    ...
    def __init__(self, id: int, amount: str, empid: int, Employee_Deductions_1105: "Class_Diagram_for_Propsed_System_Employee" = None):
        self.id = id
        self.amount = amount
        self.empid = empid
...
class Class_Diagram_for_Propsed_System_Allowance:
    ...
    def __init__(self, amount: str, id: int, emp_id: int, effectivedate: str, Allowance_Employee_086: set["Class_Diagram_for_Propsed_System_Employee"] = None):
        self.amount = amount
        self.id = id
        self.emp_id = emp_id
        self.effectivedate = effectivedate
...
class Package_EPF:
    ...
    def __init__(self, id: int, effectve_date: Package_UserUpdates, precentage: int):
        self.id = id
        self.effectve_date = effectve_date
        self.precentage = precentage
...
class Package_Employee:
    ...
    def __init__(self, id: str, empid: str, depid: int, post: str, shift: str, usergroup: int, leavegroup: int, Employee_User_groups_068: "Package_User_groups" = None, advances72: set["Package_Advances"] = None, Users_Employee_145: "Package_Users" = None, Attendance_Employee_147: set["Package_Attendance"] = None, Employee_OT_Requests_048: set["Package_OT_Requests"] = None, Employee_Shifts_050: "Package_Shifts" = None, Employee_Leave_Taken_052: set["Package_Leave_Taken"] = None, Employee_EmployeeSalary_054: set["Package_EmployeeSalary"] = None, Allowance_Employee_157: "Package_Allowance" = None, Employee_Messages_058: set["Package_Messages"] = None, Employee_LeaveProfiles_060: "Package_LeaveProfiles" = None, Employee_Posts_062: "Package_Posts" = None, Departments_Employee_165: "Package_Departments" = None, Employee_EmployeeParoll_066: set["Package_EmployeeParoll"] = None):
        self.id = id
        self.empid = empid
        self.depid = depid
        self.post = post
