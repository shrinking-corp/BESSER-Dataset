...
public class Use_Case_Diagram_for_Proposed_System_View_Personal_Salary_History_UseCase  {
    ...
    public Use_Case_Diagram_for_Proposed_System_View_Personal_Salary_History_UseCase(
    ) {
    }
