...
arduino_Repeat.methods={arduino_Repeat_m_finalize, arduino_Repeat_m_evaluate}
...
condition20: BinaryAssociation = BinaryAssociation(
    name="condition20",
    ends={
        Property(name="arduino_BooleanExpression21", type=arduino_If, multiplicity=Multiplicity(1, 1)),
...
elseBlock22: BinaryAssociation = BinaryAssociation(
    name="elseBlock22",
    ends={
        Property(name="arduino_Block24", type=arduino_If, multiplicity=Multiplicity(1, 1)),
        Property(name="arduino_If23", type=arduino_Block, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
...
right16: BinaryAssociation = BinaryAssociation(
    name="right16",
    ends={
        Property(name="arduino_Expression18", type=arduino_BinaryExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="arduino_BinaryExpression17", type=arduino_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
...
operand25: BinaryAssociation = BinaryAssociation(
    name="operand25",
    ends={
        Property(name="arduino_Expression26", type=arduino_Assignment, multiplicity=Multiplicity(1, 1)),
...
operand27: BinaryAssociation = BinaryAssociation(
    name="operand27",
    ends={
        Property(name="arduino_Expression28", type=arduino_UnaryExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="arduino_UnaryExpression", type=arduino_Expression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
variable29: BinaryAssociation = BinaryAssociation(
    name="variable29",
    ends={
        Property(name="arduino_Variable30", type=arduino_VariableDeclaration, multiplicity=Multiplicity(1, 1)),
...
connectedTransceiver41: BinaryAssociation = BinaryAssociation(
    name="connectedTransceiver41",
    ends={
        Property(name="arduino_BluetoothTransceiver", type=arduino_BluetoothTransceiver, multiplicity=Multiplicity(1, 1)),
        Property(name="arduino_BluetoothTransceiver40", type=arduino_BluetoothTransceiver, multiplicity=Multiplicity(0, 9999))
    }
)
instructions32: BinaryAssociation = BinaryAssociation(
    name="instructions32",
    ends={
        Property(name="arduino_Instruction", type=arduino_Block, multiplicity=Multiplicity(1, 1)),
        Property(name="arduino_Block33", type=arduino_Instruction, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
digitalPins34: BinaryAssociation = BinaryAssociation(
    name="digitalPins34",
    ends={
        Property(name="arduino_DigitalPin35", type=arduino_ArduinoBoard, multiplicity=Multiplicity(1, 1)),
        Property(name="arduino_ArduinoBoard", type=arduino_DigitalPin, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
analogPins36: BinaryAssociation = BinaryAssociation(
    name="analogPins36",
    ends={
        Property(name="arduino_AnalogPin38", type=arduino_ArduinoBoard, multiplicity=Multiplicity(1, 1)),
        Property(name="arduino_ArduinoBoard37", type=arduino_AnalogPin, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
domain_model = DomainModel(
    name="arduino",
    types={arduino_Board, NamedElement, arduino_Project, arduino_Instruction, arduino_ModuleAssignment, ModuleInstruction, Assignment, arduino_ModuleInstruction, Instruction, arduino_Module, arduino_DigitalPin, Pin, arduino_ArduinoDigitalModule, arduino_Pin, arduino_AnalogPin, arduino_ArduinoAnalogModule, arduino_Sketch, arduino_Block, arduino_ModuleGet, Expression, arduino_While, arduino_BooleanExpression, arduino_BinaryExpression, arduino_Control, arduino_Utilities, arduino_Delay, Utilities, arduino_NamedElement, arduino_Repeat, Control, arduino_Constant, arduino_If, arduino_IntegerConstant, Constant, arduino_Expression, arduino_Variable, arduino_VariableAssignment, arduino_BinaryIntegerExpression, BinaryExpression, IntegerExpression, arduino_BinaryBooleanExpression, BooleanExpression, arduino_BooleanModuleGet, ModuleGet, arduino_IntegerModuleGet, arduino_BooleanConstant, arduino_IntegerExpression, arduino_Assignment, arduino_IntegerVariable, Variable, arduino_BooleanVariable, arduino_PushButton, arduino_Buzzer, arduino_RotationSensor, ArduinoAnalogModule, arduino_MicroServo, arduino_InfraRedSensor, arduino_AmbientLightSensor, arduino_SoundSensor, arduino_UnaryExpression, arduino_UnaryBooleanExpression, UnaryExpression, arduino_UnaryIntegerExpression, arduino_VariableDeclaration, arduino_VariableRef, arduino_IntegerVariableRef, VariableRef, arduino_LED, ArduinoDigitalModule, arduino_BluetoothTransceiver, ArduinoCommunicationModule, arduino_Fan, arduino_MusicPlayer, arduino_ArduinoModule, Module, arduino_ArduinoBoard, Board, ArduinoModule, arduino_BooleanVariableRef, arduino_ArduinoCommunicationModule, Time, BinaryIntegerOperatorKind, BinaryBooleanOperatorKind, UnaryIntegerOperatorKind, UnaryBooleanOperatorKind, Color},
    associations={boards8, sketches9, project0, module1, module2, project3, block5, board6, condition14, module11, block12, condition20, elseBlock22, left15, right16, variable19, operand25, operand27, variable29, variable31, connectedTransceiver41, instructions32, digitalPins34, analogPins36, variable39},
    generalizations={gen_arduino_Board_NamedElement, gen_arduino_ModuleAssignment_ModuleInstruction, gen_arduino_ModuleAssignment_Assignment, gen_arduino_ModuleInstruction_Instruction, gen_arduino_Module_NamedElement, gen_arduino_DigitalPin_Pin, gen_arduino_Pin_NamedElement, gen_arduino_AnalogPin_Pin, gen_arduino_Sketch_NamedElement, gen_arduino_ModuleGet_Expression, gen_arduino_ModuleGet_ModuleInstruction, gen_arduino_While_Control, gen_arduino_BinaryExpression_Expression, gen_arduino_Control_Instruction, gen_arduino_Utilities_Instruction, gen_arduino_Delay_Utilities, gen_arduino_Repeat_Control, gen_arduino_Constant_Expression, gen_arduino_If_Control, gen_arduino_IntegerConstant_Constant, gen_arduino_IntegerConstant_IntegerExpression, gen_arduino_Variable_NamedElement, gen_arduino_VariableAssignment_Instruction, gen_arduino_VariableAssignment_Assignment, gen_arduino_BinaryIntegerExpression_BinaryExpression, gen_arduino_BinaryIntegerExpression_IntegerExpression, gen_arduino_BinaryBooleanExpression_BinaryExpression, gen_arduino_BinaryBooleanExpression_BooleanExpression, gen_arduino_BooleanModuleGet_ModuleGet, gen_arduino_BooleanModuleGet_BooleanExpression, gen_arduino_IntegerModuleGet_ModuleGet, gen_arduino_IntegerModuleGet_IntegerExpression, gen_arduino_BooleanConstant_Constant, gen_arduino_BooleanConstant_BooleanExpression, gen_arduino_BooleanExpression_Expression, gen_arduino_IntegerExpression_Expression, gen_arduino_Assignment_Instruction, gen_arduino_IntegerVariable_Variable, gen_arduino_BooleanVariable_Variable, gen_arduino_PushButton_ArduinoDigitalModule, gen_arduino_Buzzer_ArduinoDigitalModule, gen_arduino_RotationSensor_ArduinoAnalogModule, gen_arduino_MicroServo_ArduinoDigitalModule, gen_arduino_InfraRedSensor_ArduinoDigitalModule, gen_arduino_AmbientLightSensor_ArduinoAnalogModule, gen_arduino_SoundSensor_ArduinoAnalogModule, gen_arduino_UnaryExpression_Expression, gen_arduino_UnaryBooleanExpression_UnaryExpression, gen_arduino_UnaryBooleanExpression_BooleanExpression, gen_arduino_UnaryIntegerExpression_UnaryExpression, gen_arduino_UnaryIntegerExpression_IntegerExpression, gen_arduino_VariableDeclaration_Instruction, gen_arduino_VariableRef_Expression, gen_arduino_IntegerVariableRef_VariableRef, gen_arduino_IntegerVariableRef_IntegerExpression, gen_arduino_LED_ArduinoDigitalModule, gen_arduino_BluetoothTransceiver_ArduinoCommunicationModule, gen_arduino_Fan_ArduinoDigitalModule, gen_arduino_MusicPlayer_ArduinoAnalogModule, gen_arduino_ArduinoModule_Module, gen_arduino_ArduinoBoard_Board, gen_arduino_ArduinoDigitalModule_ArduinoModule, gen_arduino_ArduinoAnalogModule_ArduinoModule, gen_arduino_BooleanVariableRef_VariableRef, gen_arduino_BooleanVariableRef_BooleanExpression, gen_arduino_ArduinoCommunicationModule_ArduinoAnalogModule},
    metadata=None
)
