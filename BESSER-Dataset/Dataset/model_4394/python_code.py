...
class arduino_Instruction(ABC):
    ...
    def arduino_Instruction(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "arduino_Block33"):
                opp_val = getattr(old_value, "arduino_Block33", None)
                if isinstance(opp_val, set):
                    opp_val.discard(self)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "arduino_Block33"):
                opp_val = getattr(value, "arduino_Block33", None)
                if opp_val is None:
                    setattr(value, "arduino_Block33", set([self]))
...
class arduino_Project:
    ...
    def __init__(self, project: set["arduino_Board"] = None, project10: set["arduino_Sketch"] = None, Project: "arduino_Board" = None, Project4: "arduino_Sketch" = None):
    ...
    def initializeModel(self, arduino_args):
...
class arduino_BluetoothTransceiver(ArduinoCommunicationModule):
    ...
    def __init__(self, dataToSend: str, dataReceived: str, arduino_BluetoothTransceiver: "arduino_BluetoothTransceiver" = None, arduino_BluetoothTransceiver40: set["arduino_BluetoothTransceiver"] = None):
        self.dataToSend = dataToSend
        self.dataReceived = dataReceived
        self.arduino_BluetoothTransceiver = arduino_BluetoothTransceiver
        self.arduino_BluetoothTransceiver40 = arduino_BluetoothTransceiver40 if arduino_BluetoothTransceiver40 is not None else set()
    ...
    @property
    def arduino_BluetoothTransceiver40(self):
        return self.__arduino_BluetoothTransceiver40

    @arduino_BluetoothTransceiver40.setter
    def arduino_BluetoothTransceiver40(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_arduino_BluetoothTransceiver__arduino_BluetoothTransceiver40", None)
        self.__arduino_BluetoothTransceiver40 = value if value is not None else set()
    ...
    def arduino_BluetoothTransceiver(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "arduino_BluetoothTransceiver40"):
                opp_val = getattr(old_value, "arduino_BluetoothTransceiver40", None)
                if isinstance(opp_val, set):
                    opp_val.discard(self)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "arduino_BluetoothTransceiver40"):
                opp_val = getattr(value, "arduino_BluetoothTransceiver40", None)
                if opp_val is None:
                    setattr(value, "arduino_BluetoothTransceiver40", set([self]))
                elif isinstance(opp_val, set):
                    opp_val.add(self)
...
class arduino_VariableDeclaration(Instruction):
    ...
    def arduino_VariableDeclaration(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "arduino_Variable30"):
                opp_val = getattr(old_value, "arduino_Variable30", None)
                if opp_val == self:
                    setattr(old_value, "arduino_Variable30", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "arduino_Variable30"):
                opp_val = getattr(value, "arduino_Variable30", None)
                setattr(value, "arduino_Variable30", self)
...
class arduino_Variable(NamedElement):
    ...
    def __init__(self, arduino_Variable: "arduino_VariableAssignment" = None, arduino_Variable30: "arduino_VariableDeclaration" = None):
        self.arduino_Variable = arduino_Variable
        self.arduino_Variable30 = arduino_Variable30
    ...
    @property
    def arduino_Variable30(self):
        return self.__arduino_Variable30

    @arduino_Variable30.setter
    def arduino_Variable30(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_arduino_Variable__arduino_Variable30", None)
        self.__arduino_Variable30 = value
...
class arduino_Expression(ABC):
    ...
    def __init__(self, arduino_Expression: "arduino_BinaryExpression" = None, arduino_Expression18: "arduino_BinaryExpression" = None, arduino_Expression26: "arduino_Assignment" = None, arduino_Expression28: "arduino_UnaryExpression" = None):
        self.arduino_Expression = arduino_Expression
        self.arduino_Expression18 = arduino_Expression18
        self.arduino_Expression26 = arduino_Expression26
        self.arduino_Expression28 = arduino_Expression28
        
        pass
    @property
    def arduino_Expression26(self):
        return self.__arduino_Expression26

    @arduino_Expression26.setter
    def arduino_Expression26(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_arduino_Expression__arduino_Expression26", None)
        self.__arduino_Expression26 = value
    ...
    def arduino_Expression18(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "arduino_BinaryExpression17"):
                opp_val = getattr(old_value, "arduino_BinaryExpression17", None)
                if opp_val == self:
                    setattr(old_value, "arduino_BinaryExpression17", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "arduino_BinaryExpression17"):
                opp_val = getattr(value, "arduino_BinaryExpression17", None)
                setattr(value, "arduino_BinaryExpression17", self)
...
class arduino_If(Control):
    ...
    def __init__(self, arduino_If: "arduino_BooleanExpression" = None, arduino_If23: "arduino_Block" = None):
        self.arduino_If = arduino_If
        self.arduino_If23 = arduino_If23
        
        pass
    @property
    def arduino_If23(self):
        return self.__arduino_If23

    @arduino_If23.setter
    def arduino_If23(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_arduino_If__arduino_If23", None)
        self.__arduino_If23 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "arduino_Block24"):
                opp_val = getattr(old_value, "arduino_Block24", None)
                if opp_val == self:
                    setattr(old_value, "arduino_Block24", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "arduino_Block24"):
                opp_val = getattr(value, "arduino_Block24", None)
                setattr(value, "arduino_Block24", self)
    ...
    def arduino_If(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "arduino_BooleanExpression21"):
                opp_val = getattr(old_value, "arduino_BooleanExpression21", None)
                if opp_val == self:
                    setattr(old_value, "arduino_BooleanExpression21", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "arduino_BooleanExpression21"):
                opp_val = getattr(value, "arduino_BooleanExpression21", None)
                setattr(value, "arduino_BooleanExpression21", self)
