...
domain_model = DomainModel(
    ...
    types={simpleExpressions_IfCondition, simpleExpressions_Expression, simpleExpressions_NumberLiteral, Expression, simpleExpressions_AndExpression, simpleExpressions_Comparison, simpleExpressions_NotExpression, simpleExpressions_MethodCall, simpleExpressions_OrExpression},
    associations={condition0, left1, right3, left6, right8, left11, right13, expression16},
    generalizations={gen_simpleExpressions_NumberLiteral_Expression, gen_simpleExpressions_AndExpression_Expression, gen_simpleExpressions_Comparison_Expression, gen_simpleExpressions_NotExpression_Expression, gen_simpleExpressions_MethodCall_Expression, gen_simpleExpressions_OrExpression_Expression},
    metadata=None
)
