...
Employee.attributes={Employee_password, Employee_noOfLeaves, Employee_employeeName, Employee_managerId, Employee_jobLevel, Employee_leavesTaken, Employee_employeeId}
...
LeaveApplication.attributes={LeaveApplication_applicationId, LeaveApplication_status, LeaveApplication_employeeId, LeaveApplication_approverComments, LeaveApplication_toDate, LeaveApplication_reason, LeaveApplication_fromDate}
...
domain_model = DomainModel(
    name="_41b81feb_3864_4535_9b45_a53bc585058d",
    ...
    associations={Employee_Approver_Jobs, Admin_CreateUser, User_Login, User_Query_Eligibility, User_Query_Leave_Balance, User_Query_Leave_History, Employee_Apply_Leave, Employee_Leave_Request_Status, Admin_Update_Calendar, Application_SendNotification, Credit_Leaves_Application, Application_AutoApproval, Application_GenerateSummary},
    generalizations={},
    metadata=None
)
