...
tests_TypeB = Class(name="tests_TypeB")
tests_Named = Class(name="tests_Named", is_abstract=True)
tests_Root = Class(name="tests_Root")
tests_TypeA = Class(name="tests_TypeA")
...
domain_model = DomainModel(
    name="tests",
    types={Named, tests_TypeB, tests_Named, tests_Root, tests_TypeA},
    associations={someAs0, someAs1, allAs4, allBs6},
