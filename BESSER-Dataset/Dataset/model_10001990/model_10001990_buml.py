...
Masuk_dari_Aplikasi_UseCase = Class(name="Masuk_dari_Aplikasi_UseCase")
...
Keluar_dari_Aplikasi_UseCase = Class(name="Keluar_dari_Aplikasi_UseCase")
...
Pencarian = Class(name="Pencarian")
Login1 = Class(name="Login1")

# User_Actor class attributes and methods

# Masuk_dari_Aplikasi_UseCase class attributes and methods
...
# Keluar_dari_Aplikasi_UseCase class attributes and methods
...
# Pencarian class attributes and methods

# Login1 class attributes and methods
Login1_Username: Property = Property(name="Username", type=StringType)
Login1_Password: Property = Property(name="Password", type=StringType)
Login1.attributes={Login1_Username, Login1_Password}

# Relationships
User_Melakukan_Login: BinaryAssociation = BinaryAssociation(
    name="User_Melakukan_Login",
    ends={
        Property(name="melakukan_Login0", type=Masuk_dari_Aplikasi_UseCase, multiplicity=Multiplicity(0, 1)),
...
User_Melakukan_Logout: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="melakukan_Logout6", type=Keluar_dari_Aplikasi_UseCase, multiplicity=Multiplicity(0, 1)),
...
Melakukan_Login_Melihat_Tampilan_Awal_Aplikasi: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="melakukan_Login9", type=Masuk_dari_Aplikasi_UseCase, multiplicity=Multiplicity(0, 1))
    }
)
...
Otomatis_Menginterupsi_Notifikasi_Akun_Media_Sosial_Melakukan_Logout: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="melakukan_Logout16", type=Keluar_dari_Aplikasi_UseCase, multiplicity=Multiplicity(0, 1)),
...
domain_model = DomainModel(
    name="_i5wJkLU2Eee7sYPkE4_GPA",
    types={User_Actor, Masuk_dari_Aplikasi_UseCase, Melihat_Tampilan_Awal_Aplikasi_UseCase, Memilih_Kategori_Buku_UseCase, Mulai_Membaca_UseCase, Otomatis_Menginterupsi_Notifikasi_Akun_Media_Sosial_UseCase, Keluar_dari_Aplikasi_UseCase, Buku_berbahasa_Asing_UseCase, Melakukan_Penerjemahan_Buku_Bacaan_UseCase, Login, Class_, MyClass, Menu_Utama, Buku, Keluar, Pencarian, Login1},
