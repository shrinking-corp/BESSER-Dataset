...
# Classes
kwcs_TopCS = Class(name="kwcs_TopCS")
kwcs_TreeCS = Class(name="kwcs_TreeCS", is_abstract=True)
kwcs_BinCS = Class(name="kwcs_BinCS")
TreeCS = Class(name="TreeCS")
kwcs_LeafCS = Class(name="kwcs_LeafCS")
...
domain_model = DomainModel(
    name="kwcs",
    types={kwcs_TopCS, kwcs_TreeCS, kwcs_BinCS, TreeCS, kwcs_LeafCS},
    associations={node0, left1, right3},
    generalizations={gen_kwcs_BinCS_TreeCS, gen_kwcs_LeafCS_TreeCS},
    metadata=None
)
