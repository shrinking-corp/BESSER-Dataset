...
class education_Course:
    ...
    def __init__(self, name: str, education_Course: set["education_Student"] = None, education_Course2: "education_Teacher" = None):
        self.name = name
    ...
    def start(self, education_startdate):
        # TODO: Implement start method
        pass

    def finish(self, education_finishdate):
