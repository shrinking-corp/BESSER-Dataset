...
# Classes
education_Person = Class(name="education_Person")
education_Student = Class(name="education_Student")
Person = Class(name="Person")
education_Teacher = Class(name="education_Teacher")
education_Course = Class(name="education_Course")
...
education_Person.attributes={education_Person_lastname, education_Person_firstname}
...
education_Course_m_start: Method = Method(name="start", parameters={Parameter(name='education_startdate', type=StringType)})
education_Course_m_finish: Method = Method(name="finish", parameters={Parameter(name='education_finishdate', type=StringType)})
...
domain_model = DomainModel(
    ...
    associations={student0, teacher1},
