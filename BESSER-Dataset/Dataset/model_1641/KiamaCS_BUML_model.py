...
kiamacs_PlusCS = Class(name="kiamacs_PlusCS")
NodeCS = Class(name="NodeCS")
kiamacs_NumCS = Class(name="kiamacs_NumCS")
...
domain_model = DomainModel(
    name="kiamacs",
    types={kiamacs_TopCS, kiamacs_NodeCS, kiamacs_PlusCS, NodeCS, kiamacs_NumCS},
    associations={node0, left1, right3},
    generalizations={gen_kiamacs_PlusCS_NodeCS, gen_kiamacs_NumCS_NodeCS},
    metadata=None
)
