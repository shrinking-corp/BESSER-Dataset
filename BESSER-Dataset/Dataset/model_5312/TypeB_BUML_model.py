...
# Classes
TypeB_BDoubleElement = Class(name="TypeB_BDoubleElement")
TypeB_BStringElement = Class(name="TypeB_BStringElement")
...
domain_model = DomainModel(
    name="TypeB",
    types={TypeB_BDoubleElement, TypeB_BStringElement},
    associations={},
    generalizations={},
    metadata=None
)
