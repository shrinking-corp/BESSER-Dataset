...
class expressionDSL_Dim:
    ...
    def __init__(self, arrayDimensions: int, expressionDSL_Dim5: "expressionDSL_StructDef" = None, expressionDSL_Dim9: "expressionDSL_SubFieldDef" = None, expressionDSL_Dim: "expressionDSL_VariableDef" = None, expressionDSL_Dim3: "expressionDSL_ConstDef" = None):
...
class expressionDSL_FunctionCallStatement(Statement):
    ...
    pass
class expressionDSL_ConstDef(Named, Statement):
...
class expressionDSL_StructDef(Named, SubField, Statement):

    pass
class expressionDSL_VariableDef(Named, Statement):
...
class expressionDSL_Model:
    ...
    pass
class expressionDSL_FunctionDef(Named, Statement):
...
class expressionDSL_SubFieldDef(Named, SubField):
