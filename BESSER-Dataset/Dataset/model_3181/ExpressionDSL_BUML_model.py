...
# Classes
expressionDSL_SubField = Class(name="expressionDSL_SubField")
expressionDSL_SubFieldDef = Class(name="expressionDSL_SubFieldDef")
expressionDSL_FunctionDef = Class(name="expressionDSL_FunctionDef")
expressionDSL_Model = Class(name="expressionDSL_Model")
expressionDSL_Statement = Class(name="expressionDSL_Statement")
expressionDSL_VariableDef = Class(name="expressionDSL_VariableDef")
Statement = Class(name="Statement")
Named = Class(name="Named")
expressionDSL_Dim = Class(name="expressionDSL_Dim")
expressionDSL_ConstDef = Class(name="expressionDSL_ConstDef")
expressionDSL_StructDef = Class(name="expressionDSL_StructDef")
SubField = Class(name="SubField")
expressionDSL_Comparison = Class(name="expressionDSL_Comparison")
expressionDSL_BinaryPlus = Class(name="expressionDSL_BinaryPlus")
expressionDSL_VariableAssignment = Class(name="expressionDSL_VariableAssignment")
expressionDSL_Expression = Class(name="expressionDSL_Expression")
expressionDSL_FunctionCallStatement = Class(name="expressionDSL_FunctionCallStatement")
expressionDSL_FunctionCall = Class(name="expressionDSL_FunctionCall")
expressionDSL_Named = Class(name="expressionDSL_Named")
expressionDSL_VariableArrayOrFunctionRef = Class(name="expressionDSL_VariableArrayOrFunctionRef")
Expression = Class(name="Expression")
expressionDSL_Or = Class(name="expressionDSL_Or")
expressionDSL_And = Class(name="expressionDSL_And")
expressionDSL_IntConstant = Class(name="expressionDSL_IntConstant")
expressionDSL_StringConstant = Class(name="expressionDSL_StringConstant")
expressionDSL_BooleanConstant = Class(name="expressionDSL_BooleanConstant")
expressionDSL_BinaryMinus = Class(name="expressionDSL_BinaryMinus")
expressionDSL_MulOrDiv = Class(name="expressionDSL_MulOrDiv")
expressionDSL_Exponent = Class(name="expressionDSL_Exponent")
expressionDSL_UnaryPlus = Class(name="expressionDSL_UnaryPlus")
expressionDSL_UnaryMinus = Class(name="expressionDSL_UnaryMinus")
expressionDSL_Not = Class(name="expressionDSL_Not")
expressionDSL_QualifiedRef = Class(name="expressionDSL_QualifiedRef")
...
domain_model = DomainModel(
    name="expressionDSL",
    types={expressionDSL_SubField, expressionDSL_SubFieldDef, expressionDSL_FunctionDef, expressionDSL_Model, expressionDSL_Statement, expressionDSL_VariableDef, Statement, Named, expressionDSL_Dim, expressionDSL_ConstDef, expressionDSL_StructDef, SubField, expressionDSL_Comparison, expressionDSL_BinaryPlus, expressionDSL_VariableAssignment, expressionDSL_Expression, expressionDSL_FunctionCallStatement, expressionDSL_FunctionCall, expressionDSL_Named, expressionDSL_VariableArrayOrFunctionRef, Expression, expressionDSL_Or, expressionDSL_And, expressionDSL_IntConstant, expressionDSL_StringConstant, expressionDSL_BooleanConstant, expressionDSL_BinaryMinus, expressionDSL_MulOrDiv, expressionDSL_Exponent, expressionDSL_UnaryPlus, expressionDSL_UnaryMinus, expressionDSL_Not, expressionDSL_QualifiedRef},
    associations={options4, subFields6, options8, statements0, options1, options2, left29, right31, left34, right36, left39, tgtvar10, exp12, call14, ref15, args17, ref20, args21, left24, right26, head65, tail67, right41, left44, right46, left49, right51, left54, right56, expr59, expr61, expr63},
    generalizations={gen_expressionDSL_SubFieldDef_SubField, gen_expressionDSL_SubFieldDef_Named, gen_expressionDSL_FunctionDef_Statement, gen_expressionDSL_FunctionDef_Named, gen_expressionDSL_VariableDef_Statement, gen_expressionDSL_VariableDef_Named, gen_expressionDSL_ConstDef_Statement, gen_expressionDSL_ConstDef_Named, gen_expressionDSL_StructDef_Statement, gen_expressionDSL_StructDef_SubField, gen_expressionDSL_StructDef_Named, gen_expressionDSL_Comparison_Expression, gen_expressionDSL_BinaryPlus_Expression, gen_expressionDSL_VariableAssignment_Statement, gen_expressionDSL_FunctionCallStatement_Statement, gen_expressionDSL_VariableArrayOrFunctionRef_Expression, gen_expressionDSL_Or_Expression, gen_expressionDSL_And_Expression, gen_expressionDSL_IntConstant_Expression, gen_expressionDSL_StringConstant_Expression, gen_expressionDSL_BooleanConstant_Expression, gen_expressionDSL_BinaryMinus_Expression, gen_expressionDSL_MulOrDiv_Expression, gen_expressionDSL_Exponent_Expression, gen_expressionDSL_UnaryPlus_Expression, gen_expressionDSL_UnaryMinus_Expression, gen_expressionDSL_Not_Expression, gen_expressionDSL_QualifiedRef_Expression},
    metadata=None
)
