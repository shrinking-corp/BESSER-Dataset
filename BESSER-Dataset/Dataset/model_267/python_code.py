...
class ecoreO_EEnum(EDataType):
    ...
    def __init__(self, eEnum: set["ecoreO_EEnumLiteral"] = None, EEnum: "ecoreO_EEnumLiteral" = None):
    ...
    def getEEnumLiteralByLiteral(self, ecoreO_literal) :
        # TODO: Implement getEEnumLiteralByLiteral method
        pass

    def getEEnumLiteral(self, ecoreO_value) :
        # TODO: Implement getEEnumLiteral method
        pass

class ecoreO_EOperation(ETypedElement):

    def __init__(self, ecoreO_EOperation: "ecoreO_EClass" = None, EOperation: "ecoreO_EClass" = None, ecoreO_EOperation58: set["ecoreO_EGenericType"] = None, EOperation70: "ecoreO_EParameter" = None, eOperations: "ecoreO_EClass" = None, ecoreO_EOperation51: set["ecoreO_ETypeParameter"] = None, eOperation: set["ecoreO_EParameter"] = None, ecoreO_EOperation55: set["ecoreO_EClassifier"] = None):
    ...
    def isOverrideOf(self, ecoreO_someOperation) :
...
class ecoreO_EPackage(ENamedElement):
    ...
    def getEClassifier(self, ecoreO_name) :
...
class ecoreO_ETypedElement(ENamedElement):
    ...
    def __init__(self, ordered: bool, unique: bool, lowerBound: int, upperBound: int, many: bool, required: bool, ecoreO_ETypedElement: "ecoreO_EClassifier" = None, ecoreO_ETypedElement85: "ecoreO_EGenericType" = None):
...
class ecoreO_EEnumLiteral(ENamedElement):
    ...
    def __init__(self, value: int, instance: str, literal: str, EEnumLiteral: "ecoreO_EEnum" = None, eLiterals: "ecoreO_EEnum" = None):
        self.value = value
...
class ecoreO_EClassifier(ENamedElement):
    ...
    def __init__(self, instanceTypeName: str, instanceClassName: str, instanceClass: str, defaultValue: str, eClassifiers: "ecoreO_EPackage" = None, ecoreO_EClassifier: set["ecoreO_ETypeParameter"] = None, EClassifier: "ecoreO_EPackage" = None, ecoreO_EClassifier56: "ecoreO_EOperation" = None, ecoreO_EClassifier83: "ecoreO_ETypedElement" = None, ecoreO_EClassifier95: "ecoreO_EGenericType" = None, ecoreO_EClassifier104: "ecoreO_EGenericType" = None):
    ...
    def isInstance(self, ecoreO_object) :
...
class ecoreO_EReference(EStructuralFeature):
    ...
    def __init__(self, containment: bool, container: bool, resolveProxies: bool, ecoreO_EReference: "ecoreO_EClass" = None, ecoreO_EReference18: "ecoreO_EClass" = None, ecoreO_EReference24: "ecoreO_EClass" = None, ecoreO_EReference73: "ecoreO_EReference" = None, ecoreO_EReference71: "ecoreO_EReference" = None, ecoreO_EReference75: "ecoreO_EClass" = None, ecoreO_EReference78: set["ecoreO_EAttribute"] = None):
...
class ecoreO_EAttribute(EStructuralFeature):
    ...
    def __init__(self, iD: bool, ecoreO_EAttribute34: "ecoreO_EClass" = None, ecoreO_EAttribute13: "ecoreO_EClass" = None, ecoreO_EAttribute: "ecoreO_EDataType" = None, ecoreO_EAttribute21: "ecoreO_EClass" = None, ecoreO_EAttribute79: "ecoreO_EReference" = None):
        self.iD = iD
...
class ecoreO_EClass(EClassifier):
    ...
    def __init__(self, abstract: bool, interface: bool, ecoreO_EClass26: set["ecoreO_EOperation"] = None, ecoreO_EClass28: set["ecoreO_EStructuralFeature"] = None, ecoreO_EClass31: "ecoreO_EClass" = None, ecoreO_EClass29: set["ecoreO_EClass"] = None, ecoreO_EClass33: "ecoreO_EAttribute" = None, eContainingClass36: set["ecoreO_EStructuralFeature"] = None, ecoreO_EClass38: set["ecoreO_EGenericType"] = None, ecoreO_EClass40: set["ecoreO_EGenericType"] = None, ecoreO_EClass: "ecoreO_EClass" = None, ecoreO_EClass8: set["ecoreO_EClass"] = None, eContainingClass: set["ecoreO_EOperation"] = None, ecoreO_EClass12: set["ecoreO_EAttribute"] = None, ecoreO_EClass15: set["ecoreO_EReference"] = None, ecoreO_EClass17: set["ecoreO_EReference"] = None, EClass: "ecoreO_EOperation" = None, ecoreO_EClass20: set["ecoreO_EAttribute"] = None, ecoreO_EClass23: set["ecoreO_EReference"] = None, EClass81: "ecoreO_EStructuralFeature" = None, ecoreO_EClass76: "ecoreO_EReference" = None):
    ...
    def getEOperation(self, ecoreO_operationID) :
        # TODO: Implement getEOperation method
        pass

    def getEStructuralFeature(self, ecoreO_featureName) :
        # TODO: Implement getEStructuralFeature method
        pass

    def getFeatureID(self, ecoreO_feature) :
        # TODO: Implement getFeatureID method
        pass
    ...
    def getOperationID(self, ecoreO_operation) :
        # TODO: Implement getOperationID method
        pass
    ...
    def isSuperTypeOf(self, ecoreO_someClass) :
        # TODO: Implement isSuperTypeOf method
        pass

    def getOverride(self, ecoreO_operation) :
...
class ecoreO_EObject:
    ...
    def eUnset(self, ecoreO_feature):
    ...
    def eGet(self, ecoreO_feature, ecoreO_resolve) :
        # TODO: Implement eGet method
        pass

    def eInvoke(self, ecoreO_operation, ecoreO_arguments) :
    ...
    def eSet(self, ecoreO_feature, ecoreO_newValue):
    ...
    def eIsSet(self, ecoreO_feature) :
...
class ecoreO_EModelElement(ABC):
    ...
    def __init__(self, eModelElement: set["ecoreO_EAnnotation"] = None, EModelElement: "ecoreO_EAnnotation" = None):
    ...
    def getEAnnotation(self, ecoreO_source) :
        # TODO: Implement getEAnnotation method
        pass

class ecoreO_EStringToStringMapEntry:

    def __init__(self, key: str, value: str, ecoreO_EStringToStringMapEntry: "ecoreO_EAnnotation" = None):
        self.key = key
        self.value = value
...
class ecoreO_EFactory(EModelElement):
    ...
    def convertToString(self, ecoreO_instanceValue, ecoreO_eDataType) :
        # TODO: Implement convertToString method
        pass

    def createFromString(self, ecoreO_eDataType, ecoreO_literalValue) :
        # TODO: Implement createFromString method
        pass

    def create(self, ecoreO_eClass) :
...
class ecoreO_EAnnotation(EModelElement):
    ...
    def __init__(self, source: str, EAnnotation: "ecoreO_EModelElement" = None, ecoreO_EAnnotation: set["ecoreO_EStringToStringMapEntry"] = None, eAnnotations: "ecoreO_EModelElement" = None, ecoreO_EAnnotation4: set["ecoreO_EObject"] = None, ecoreO_EAnnotation6: set["ecoreO_EObject"] = None):
        self.source = source
