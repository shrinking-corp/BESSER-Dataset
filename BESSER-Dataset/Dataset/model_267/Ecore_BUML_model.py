...
# Classes
ecoreO_EAnnotation = Class(name="ecoreO_EAnnotation")
EModelElement = Class(name="EModelElement")
ecoreO_EStringToStringMapEntry = Class(name="ecoreO_EStringToStringMapEntry")
ecoreO_EModelElement = Class(name="ecoreO_EModelElement", is_abstract=True)
ecoreO_EObject = Class(name="ecoreO_EObject")
ecoreO_EClass = Class(name="ecoreO_EClass")
EClassifier = Class(name="EClassifier")
ecoreO_EAttribute = Class(name="ecoreO_EAttribute")
EStructuralFeature = Class(name="EStructuralFeature")
ecoreO_EDataType = Class(name="ecoreO_EDataType")
ecoreO_EStructuralFeature = Class(name="ecoreO_EStructuralFeature", is_abstract=True)
ecoreO_EGenericType = Class(name="ecoreO_EGenericType")
ecoreO_EClassifier = Class(name="ecoreO_EClassifier", is_abstract=True)
ENamedElement = Class(name="ENamedElement")
ecoreO_EOperation = Class(name="ecoreO_EOperation")
ecoreO_EReference = Class(name="ecoreO_EReference")
ecoreO_EPackage = Class(name="ecoreO_EPackage")
ecoreO_ETypeParameter = Class(name="ecoreO_ETypeParameter")
ecoreO_EEnum = Class(name="ecoreO_EEnum")
EDataType = Class(name="EDataType")
ecoreO_EEnumLiteral = Class(name="ecoreO_EEnumLiteral")
ecoreO_EFactory = Class(name="ecoreO_EFactory")
ecoreO_ENamedElement = Class(name="ecoreO_ENamedElement", is_abstract=True)
ETypedElement = Class(name="ETypedElement")
ecoreO_EParameter = Class(name="ecoreO_EParameter")
ecoreO_ETypedElement = Class(name="ecoreO_ETypedElement", is_abstract=True)
...
ecoreO_EModelElement_m_getEAnnotation: Method = Method(name="getEAnnotation", parameters={Parameter(name='ecoreO_source', type=StringType)}, type=StringType)
...
ecoreO_EObject_m_eGet: Method = Method(name="eGet", parameters={Parameter(name='ecoreO_feature', type=StringType)}, type=StringType)
ecoreO_EObject_m_eGet: Method = Method(name="eGet", parameters={Parameter(name='ecoreO_feature', type=StringType), Parameter(name='ecoreO_resolve', type=StringType)}, type=StringType)
ecoreO_EObject_m_eSet: Method = Method(name="eSet", parameters={Parameter(name='ecoreO_newValue', type=StringType), Parameter(name='ecoreO_feature', type=StringType)})
ecoreO_EObject_m_eIsSet: Method = Method(name="eIsSet", parameters={Parameter(name='ecoreO_feature', type=StringType)}, type=BooleanType)
ecoreO_EObject_m_eUnset: Method = Method(name="eUnset", parameters={Parameter(name='ecoreO_feature', type=StringType)})
ecoreO_EObject_m_eInvoke: Method = Method(name="eInvoke", parameters={Parameter(name='ecoreO_operation', type=StringType), Parameter(name='ecoreO_arguments', type=StringType)}, type=StringType)
ecoreO_EObject.methods={ecoreO_EObject_m_eResource, ecoreO_EObject_m_eSet, ecoreO_EObject_m_eInvoke, ecoreO_EObject_m_eIsProxy, ecoreO_EObject_m_eContainmentFeature, ecoreO_EObject_m_eCrossReferences, ecoreO_EObject_m_eGet, ecoreO_EObject_m_eIsSet, ecoreO_EObject_m_eContainingFeature, ecoreO_EObject_m_eClass, ecoreO_EObject_m_eContainer, ecoreO_EObject_m_eUnset, ecoreO_EObject_m_eAllContents, ecoreO_EObject_m_eGet, ecoreO_EObject_m_eContents}
...
ecoreO_EClass_m_isSuperTypeOf: Method = Method(name="isSuperTypeOf", parameters={Parameter(name='ecoreO_someClass', type=StringType)}, type=BooleanType)
ecoreO_EClass_m_getFeatureCount: Method = Method(name="getFeatureCount", parameters={}, type=IntegerType)
ecoreO_EClass_m_getEStructuralFeature: Method = Method(name="getEStructuralFeature", parameters={Parameter(name='ecoreO_featureID', type=StringType)}, type=EStructuralFeature)
ecoreO_EClass_m_getFeatureID: Method = Method(name="getFeatureID", parameters={Parameter(name='ecoreO_feature', type=StringType)}, type=IntegerType)
ecoreO_EClass_m_getEStructuralFeature: Method = Method(name="getEStructuralFeature", parameters={Parameter(name='ecoreO_featureName', type=StringType)}, type=EStructuralFeature)
ecoreO_EClass_m_getOperationCount: Method = Method(name="getOperationCount", parameters={}, type=IntegerType)
ecoreO_EClass_m_getEOperation: Method = Method(name="getEOperation", parameters={Parameter(name='ecoreO_operationID', type=StringType)}, type=StringType)
ecoreO_EClass_m_getOperationID: Method = Method(name="getOperationID", parameters={Parameter(name='ecoreO_operation', type=StringType)}, type=IntegerType)
ecoreO_EClass_m_getOverride: Method = Method(name="getOverride", parameters={Parameter(name='ecoreO_operation', type=StringType)}, type=StringType)
ecoreO_EClass.attributes={ecoreO_EClass_interface, ecoreO_EClass_abstract}
ecoreO_EClass.methods={ecoreO_EClass_m_getFeatureCount, ecoreO_EClass_m_getEOperation, ecoreO_EClass_m_getFeatureID, ecoreO_EClass_m_isSuperTypeOf, ecoreO_EClass_m_getEStructuralFeature, ecoreO_EClass_m_getOverride, ecoreO_EClass_m_getOperationCount, ecoreO_EClass_m_getOperationID, ecoreO_EClass_m_getEStructuralFeature}
...
ecoreO_EStructuralFeature.attributes={ecoreO_EStructuralFeature_defaultValue, ecoreO_EStructuralFeature_derived, ecoreO_EStructuralFeature_defaultValueLiteral, ecoreO_EStructuralFeature_volatile, ecoreO_EStructuralFeature_changeable, ecoreO_EStructuralFeature_unsettable, ecoreO_EStructuralFeature_transient}
ecoreO_EStructuralFeature.methods={ecoreO_EStructuralFeature_m_getFeatureID, ecoreO_EStructuralFeature_m_getContainerClass}
...
ecoreO_EClassifier_m_isInstance: Method = Method(name="isInstance", parameters={Parameter(name='ecoreO_object', type=StringType)}, type=BooleanType)
ecoreO_EClassifier_m_getClassifierID: Method = Method(name="getClassifierID", parameters={}, type=IntegerType)
ecoreO_EClassifier.attributes={ecoreO_EClassifier_instanceClass, ecoreO_EClassifier_defaultValue, ecoreO_EClassifier_instanceTypeName, ecoreO_EClassifier_instanceClassName}
ecoreO_EClassifier.methods={ecoreO_EClassifier_m_isInstance, ecoreO_EClassifier_m_getClassifierID}
...
ecoreO_EOperation_m_isOverrideOf: Method = Method(name="isOverrideOf", parameters={Parameter(name='ecoreO_someOperation', type=StringType)}, type=BooleanType)
...
ecoreO_EReference.attributes={ecoreO_EReference_container, ecoreO_EReference_containment, ecoreO_EReference_resolveProxies}
...
ecoreO_EPackage_m_getEClassifier: Method = Method(name="getEClassifier", parameters={Parameter(name='ecoreO_name', type=StringType)}, type=EClassifier)
...
ecoreO_EEnum_m_getEEnumLiteral: Method = Method(name="getEEnumLiteral", parameters={Parameter(name='ecoreO_name', type=StringType)}, type=StringType)
ecoreO_EEnum_m_getEEnumLiteral: Method = Method(name="getEEnumLiteral", parameters={Parameter(name='ecoreO_value', type=StringType)}, type=StringType)
ecoreO_EEnum_m_getEEnumLiteralByLiteral: Method = Method(name="getEEnumLiteralByLiteral", parameters={Parameter(name='ecoreO_literal', type=StringType)}, type=StringType)
ecoreO_EEnum.methods={ecoreO_EEnum_m_getEEnumLiteralByLiteral, ecoreO_EEnum_m_getEEnumLiteral, ecoreO_EEnum_m_getEEnumLiteral}
...
ecoreO_EEnumLiteral.attributes={ecoreO_EEnumLiteral_instance, ecoreO_EEnumLiteral_literal, ecoreO_EEnumLiteral_value}

# ecoreO_EFactory class attributes and methods
ecoreO_EFactory_m_create: Method = Method(name="create", parameters={Parameter(name='ecoreO_eClass', type=StringType)}, type=StringType)
ecoreO_EFactory_m_createFromString: Method = Method(name="createFromString", parameters={Parameter(name='ecoreO_literalValue', type=StringType), Parameter(name='ecoreO_eDataType', type=StringType)}, type=StringType)
ecoreO_EFactory_m_convertToString: Method = Method(name="convertToString", parameters={Parameter(name='ecoreO_instanceValue', type=StringType), Parameter(name='ecoreO_eDataType', type=StringType)}, type=StringType)
ecoreO_EFactory.methods={ecoreO_EFactory_m_convertToString, ecoreO_EFactory_m_createFromString, ecoreO_EFactory_m_create}
...
ecoreO_ETypedElement.attributes={ecoreO_ETypedElement_lowerBound, ecoreO_ETypedElement_many, ecoreO_ETypedElement_unique, ecoreO_ETypedElement_ordered, ecoreO_ETypedElement_required, ecoreO_ETypedElement_upperBound}
...
domain_model = DomainModel(
    name="ecoreO",
    types={ecoreO_EAnnotation, EModelElement, ecoreO_EStringToStringMapEntry, ecoreO_EModelElement, ecoreO_EObject, ecoreO_EClass, EClassifier, ecoreO_EAttribute, EStructuralFeature, ecoreO_EDataType, ecoreO_EStructuralFeature, ecoreO_EGenericType, ecoreO_EClassifier, ENamedElement, ecoreO_EOperation, ecoreO_EReference, ecoreO_EPackage, ecoreO_ETypeParameter, ecoreO_EEnum, EDataType, ecoreO_EEnumLiteral, ecoreO_EFactory, ecoreO_ENamedElement, ETypedElement, ecoreO_EParameter, ecoreO_ETypedElement},
    associations={details1, eModelElement2, contents3, references5, eAttributeType0, eAttributes19, eAllContainments22, eAllOperations25, eAllStructuralFeatures27, eAllSuperTypes30, eIDAttribute32, eStructuralFeatures35, eGenericSuperTypes37, eAllGenericSuperTypes39, eSuperTypes9, eOperations10, eAllAttributes11, eAllReferences14, eReferences16, ePackage42, eTypeParameters43, eLiterals44, eEnum45, eAnnotations48, ePackage46, eGenericExceptions57, eFactoryInstance60, eClassifiers61, eSubpackages64, eSuperPackage67, eOperation69, eContainingClass49, eTypeParameters50, eParameters53, eExceptions54, eContainingClass80, eType82, eGenericType84, eOpposite72, eReferenceType74, eKeys77, eTypeArguments91, eRawType93, eLowerBound97, eTypeParameter99, eClassifier102, eBounds105, eUpperBound88},
    generalizations={gen_ecoreO_EAnnotation_EModelElement, gen_ecoreO_EClass_EClassifier, gen_ecoreO_EAttribute_EStructuralFeature, gen_ecoreO_EDataType_EClassifier, gen_ecoreO_EEnum_EDataType, gen_ecoreO_EEnumLiteral_ENamedElement, gen_ecoreO_EFactory_EModelElement, gen_ecoreO_EClassifier_ENamedElement, gen_ecoreO_ENamedElement_EModelElement, gen_ecoreO_EOperation_ETypedElement, gen_ecoreO_EPackage_ENamedElement, gen_ecoreO_EParameter_ETypedElement, gen_ecoreO_EReference_EStructuralFeature, gen_ecoreO_ETypedElement_ENamedElement, gen_ecoreO_EStructuralFeature_ETypedElement, gen_ecoreO_ETypeParameter_ENamedElement},
    metadata=None
)
