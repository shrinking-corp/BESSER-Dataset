...
class Items:
    ...
    def __init__(self, ArrayList_furniture_: str, ArrayList_appliance_: str, typeOfItems: int, ArrayList_food_: str, appliacne0: "Appliacne" = None, furniture2: set["Furniture"] = None, food4: "food" = None):
