...
pivot_Class.attributes={pivot_Class_isAbstract, pivot_Class_isInterface}
...
pivot_Property.attributes={pivot_Property_isComposite, pivot_Property_implicit, pivot_Property_isResolveProxies, pivot_Property_isReadOnly, pivot_Property_isID, pivot_Property_isDerived, pivot_Property_isUnsettable, pivot_Property_isTransient, pivot_Property_isVolatile, pivot_Property_default}
...
pivot_Operation.methods={pivot_Operation_m_LoadableImplementation, pivot_Operation_m_CompatibleReturn, pivot_Operation_m_UniquePostconditionName, pivot_Operation_m_UniquePreconditionName}
...
pivot_CollectionLiteralExp.methods={pivot_CollectionLiteralExp_m_OrderedSetKindIsOrderedSet, pivot_CollectionLiteralExp_m_BagKindIsBag, pivot_CollectionLiteralExp_m_SetKindIsSet, pivot_CollectionLiteralExp_m_CollectionKindIsConcrete, pivot_CollectionLiteralExp_m_SequenceKindIsSequence}
...
pivot_State.attributes={pivot_State_isSubmachineState, pivot_State_isSimple, pivot_State_isComposite, pivot_State_isOrthogonal}
...
pivot_Constraint_m_UniqueName: Method = Method(name="UniqueName", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_OpaqueExpression.attributes={pivot_OpaqueExpression_message, pivot_OpaqueExpression_language, pivot_OpaqueExpression_body}
...
pivot_IfExp_m_ConditionTypeIsBoolean: Method = Method(name="ConditionTypeIsBoolean", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_IterateExp_m_BodyTypeConformsToResultType: Method = Method(name="BodyTypeConformsToResultType", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_IteratorExp_m_ClosureTypeIsUniqueCollection: Method = Method(name="ClosureTypeIsUniqueCollection", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_IteratorExp_m_AnyTypeIsSourceElementType: Method = Method(name="AnyTypeIsSourceElementType", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_IteratorExp_m_CollectHasOneIterator: Method = Method(name="CollectHasOneIterator", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_IteratorExp_m_OneBodyTypeIsBoolean: Method = Method(name="OneBodyTypeIsBoolean", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_IteratorExp_m_RejectOrSelectTypeIsSourceType: Method = Method(name="RejectOrSelectTypeIsSourceType", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_IteratorExp.methods={pivot_IteratorExp_m_CollectNestedTypeIsBag, pivot_IteratorExp_m_ClosureSourceElementTypeIsBodyElementType, pivot_IteratorExp_m_OneBodyTypeIsBoolean, pivot_IteratorExp_m_AnyBodyTypeIsBoolean, pivot_IteratorExp_m_ForAllTypeIsBoolean, pivot_IteratorExp_m_AnyTypeIsSourceElementType, pivot_IteratorExp_m_RejectOrSelectHasOneIterator, pivot_IteratorExp_m_ClosureTypeIsUniqueCollection, pivot_IteratorExp_m_ClosureHasOneIterator, pivot_IteratorExp_m_CollectNestedTypeIsBodyType, pivot_IteratorExp_m_SortedByIteratorTypeIsComparable, pivot_IteratorExp_m_SortedByIsOrderedIfSourceIsOrdered, pivot_IteratorExp_m_CollectHasOneIterator, pivot_IteratorExp_m_RejectOrSelectTypeIsBoolean, pivot_IteratorExp_m_CollectElementTypeIsSourceElementType, pivot_IteratorExp_m_AnyHasOneIterator, pivot_IteratorExp_m_SortedByElementTypeIsSourceElementType, pivot_IteratorExp_m_RejectOrSelectTypeIsSourceType, pivot_IteratorExp_m_ExistsTypeIsBoolean, pivot_IteratorExp_m_CollectNestedHasOneIterator, pivot_IteratorExp_m_CollectTypeIsUnordered, pivot_IteratorExp_m_OneTypeIsBoolean, pivot_IteratorExp_m_ClosureBodyTypeIsConformanttoIteratorType, pivot_IteratorExp_m_ExistsBodyTypeIsBoolean, pivot_IteratorExp_m_ClosureElementTypeIsSourceElementType, pivot_IteratorExp_m_IteratorTypeIsSourceElementType, pivot_IteratorExp_m_SortedByHasOneIterator, pivot_IteratorExp_m_IsUniqueTypeIsBoolean, pivot_IteratorExp_m_IsUniqueHasOneIterator, pivot_IteratorExp_m_OneHasOneIterator, pivot_IteratorExp_m_ForAllBodyTypeIsBoolean}
...
pivot_MessageExp_m_OneCallOrOneSend: Method = Method(name="OneCallOrOneSend", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_MessageExp_m_TargetIsNotACollection: Method = Method(name="TargetIsNotACollection", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_OperationCallExp_m_ArgumentCount: Method = Method(name="ArgumentCount", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_PropertyCallExp.methods={pivot_PropertyCallExp_m_getSpecializedReferredPropertyOwningType, pivot_PropertyCallExp_m_getSpecializedReferredPropertyType, pivot_PropertyCallExp_m_CompatibleResultType, pivot_PropertyCallExp_m_NonStaticSourceTypeIsConformant}
...
pivot_ValueSpecification.methods={pivot_ValueSpecification_m_booleanValue, pivot_ValueSpecification_m_isNull, pivot_ValueSpecification_m_unlimitedValue, pivot_ValueSpecification_m_integerValue, pivot_ValueSpecification_m_stringValue, pivot_ValueSpecification_m_isComputable}
...
in_98: BinaryAssociation = BinaryAssociation(
    name="in_98",
    ends={
...
class_141: BinaryAssociation = BinaryAssociation(
    name="class_141",
    ends={
...
class_180: BinaryAssociation = BinaryAssociation(
    name="class_180",
    ends={
...
domain_model = DomainModel(
    name="pivot",
    types={pivot_Class, Type, Namespace, pivot_Annotation, NamedElement, pivot_Element, pivot_Detail, pivot_AnyType, Class_, pivot_AssociationClass, pivot_Property, pivot_AssociationClassCallExp, NavigationCallExp, pivot_BagType, CollectionType, pivot_Behavior, pivot_BooleanLiteralExp, PrimitiveLiteralExp, pivot_CallExp, OCLExpression, pivot_OCLExpression, pivot_CallOperationAction, pivot_Operation, pivot_CollectionLiteralPart, TypedElement, pivot_CollectionRange, pivot_CollectionItem, CollectionLiteralPart, pivot_CollectionLiteralExp, LiteralExp, pivot_CollectionType, DataType, pivot_Type, pivot_Comment, Element, pivot_ConnectionPointReference, Vertex, pivot_Pseudostate, pivot_State, pivot_Constraint, pivot_Namespace, pivot_OpaqueExpression, pivot_ConstructorExp, pivot_ConstructorPart, pivot_DataType, pivot_DynamicElement, pivot_DynamicProperty, pivot_DynamicType, DynamicElement, Visitable, pivot_ElementExtension, pivot_EnumLiteralExp, pivot_EnumerationLiteral, pivot_Enumeration, pivot_ExpressionInOCL, OpaqueExpression, pivot_Variable, pivot_Feature, TypedMultiplicityElement, pivot_FeatureCallExp, CallExp, pivot_FinalState, State, pivot_IfExp, pivot_InvalidLiteralExp, pivot_InvalidType, pivot_IterateExp, LoopExp, ReferringElement, pivot_Import, pivot_IntegerLiteralExp, NumericLiteralExp, pivot_Iteration, Operation, pivot_Parameter, pivot_IteratorExp, pivot_LetExp, pivot_LambdaType, pivot_SendSignalAction, pivot_MessageType, pivot_Signal, pivot_Library, Package, pivot_Precedence, pivot_LiteralExp, pivot_LoopExp, pivot_MessageExp, Feature, TemplateableElement, ParameterableElement, pivot_Metaclass, pivot_MorePivotable, pivot_Nameable, pivot_NamedElement, Nameable, pivot_NavigationCallExp, FeatureCallExp, pivot_NullLiteralExp, pivot_NumericLiteralExp, ValueSpecification, pivot_OperationCallExp, pivot_PackageableElement, VariableDeclaration, pivot_ParameterableElement, pivot_OperationTemplateParameter, TemplateParameter, pivot_OrderedSetType, pivot_Package, pivot_TemplateParameter, pivot_Pivotable, pivot_PrimitiveLiteralExp, pivot_PrimitiveType, pivot_Profile, pivot_StateMachine, pivot_PropertyCallExp, pivot_SelfType, pivot_SequenceType, pivot_SetType, pivot_RealLiteralExp, pivot_ReferringElement, pivot_Region, pivot_Vertex, pivot_Transition, pivot_Root, pivot_Trigger, pivot_Stereotype, pivot_StringLiteralExp, pivot_TemplateBinding, pivot_TemplateableElement, pivot_TemplateParameterSubstitution, pivot_TemplateSignature, pivot_StateExp, Behavior, pivot_TemplateParameterType, pivot_TupleLiteralExp, pivot_TupleLiteralPart, pivot_TypeExp, pivot_TypeTemplateParameter, pivot_TupleType, pivot_TypedElement, pivot_TypedMultiplicityElement, pivot_UnlimitedNaturalLiteralExp, pivot_UnspecifiedType, pivot_UnspecifiedValueExp, pivot_ValueSpecification, pivot_VariableDeclaration, pivot_VariableExp, pivot_Visitable, pivot_Visitor, pivot_VoidType, AssociativityKind, CollectionKind, PseudostateKind, TransitionKind},
    associations={ownedContent0, ownedDetail1, reference3, unownedAttribute6, referredAssociationClass7, source8, operation9, part16, nestedType11, ownedBehavior12, item14, first17, last19, elementType22, behavioralType43, annotatedElement23, entry25, exit26, state29, constrainedElement31, context33, specification35, part37, initExpression38, referredProperty41, ownedLiteral59, enumeration60, metaType45, referredProperty47, ownedProperty49, extension51, ownedComment52, base55, stereotype56, referredEnumLiteral58, bodyExpression61, contextVariable63, messageExpression65, parameterVariable68, resultVariable71, condition74, elseExpression76, thenExpression79, importedNamespace82, result84, ownedAccumulator86, ownedIterator87, resultType95, contextType90, parameterType92, calledOperation114, sentSignal117, target119, referredOperation122, referredSignal124, in_98, variable100, ownedPrecedence103, body104, iterator106, referredIteration109, argument112, instanceType126, ownedAnnotation128, ownedRule130, navigationSource133, qualifier135, precedence149, precondition152, raisedException155, redefinedOperation159, bodyExpression138, class_141, ownedParameter144, owningType145, postcondition146, nestingPackage171, ownedType173, operation175, argument161, referredOperation163, importedPackage167, nestedPackage169, association179, class_180, defaultExpression183, owningTemplateParameter176, templateParameter177, referredProperty203, state205, stateMachine208, keys187, opposite190, owningType192, redefinedProperty195, referredProperty198, subsettedProperty201, nestedPackage223, signal226, connection229, extendedRegion211, state212, stateMachine215, subvertex218, transition219, imports221, redefinedState247, region249, connectionPoint232, deferrableTrigger235, doActivity237, entry240, exit243, boundElement268, parameterSubstitution269, signature271, stateInvariant252, submachine255, referredState256, connectionPoint258, extendedStateMachine262, region264, submachineState267, templateBinding289, ownedParameter290, parameter292, template295, default272, ownedDefault273, ownedParameteredElement276, parameteredElement277, signature279, actual281, formal283, ownedActual286, source309, target311, trigger313, part316, initExpression317, ownedTemplateSignature297, templateBinding299, unspecializedElement302, container303, effect304, guard306, package328, superClass331, referredType333, ownedAttribute320, ownedInvariant322, ownedOperation325, constrainingType335, type337, lowerBound339, upperBound341, initExpression344, representedParameter347, referredVariable350, container351, incoming353, outgoing355},
    generalizations={gen_pivot_Class_Type, gen_pivot_Class_Namespace, gen_pivot_Annotation_NamedElement, gen_pivot_AnyType_Class, gen_pivot_AssociationClass_Class, gen_pivot_AssociationClassCallExp_NavigationCallExp, gen_pivot_BagType_CollectionType, gen_pivot_Behavior_Class, gen_pivot_BooleanLiteralExp_PrimitiveLiteralExp, gen_pivot_CallExp_OCLExpression, gen_pivot_CallOperationAction_NamedElement, gen_pivot_CollectionLiteralPart_TypedElement, gen_pivot_CollectionRange_CollectionLiteralPart, gen_pivot_CollectionItem_CollectionLiteralPart, gen_pivot_CollectionLiteralExp_LiteralExp, gen_pivot_CollectionType_DataType, gen_pivot_Comment_Element, gen_pivot_ConnectionPointReference_Vertex, gen_pivot_Constraint_NamedElement, gen_pivot_ConstructorExp_OCLExpression, gen_pivot_ConstructorPart_TypedElement, gen_pivot_DataType_Class, gen_pivot_EnumerationLiteral_NamedElement, gen_pivot_Detail_NamedElement, gen_pivot_DynamicElement_Element, gen_pivot_DynamicProperty_Element, gen_pivot_DynamicType_Type, gen_pivot_DynamicType_DynamicElement, gen_pivot_Element_Visitable, gen_pivot_ElementExtension_Type, gen_pivot_EnumLiteralExp_LiteralExp, gen_pivot_Enumeration_DataType, gen_pivot_ExpressionInOCL_OpaqueExpression, gen_pivot_Feature_TypedMultiplicityElement, gen_pivot_FeatureCallExp_CallExp, gen_pivot_FinalState_State, gen_pivot_IfExp_OCLExpression, gen_pivot_InvalidLiteralExp_LiteralExp, gen_pivot_InvalidType_Class, gen_pivot_IterateExp_LoopExp, gen_pivot_IterateExp_ReferringElement, gen_pivot_Import_NamedElement, gen_pivot_IntegerLiteralExp_NumericLiteralExp, gen_pivot_Iteration_Operation, gen_pivot_IteratorExp_LoopExp, gen_pivot_IteratorExp_ReferringElement, gen_pivot_LetExp_OCLExpression, gen_pivot_LambdaType_DataType, gen_pivot_MessageType_Type, gen_pivot_Library_Package, gen_pivot_LiteralExp_OCLExpression, gen_pivot_LoopExp_CallExp, gen_pivot_MessageExp_OCLExpression, gen_pivot_Operation_Feature, gen_pivot_Operation_Namespace, gen_pivot_Operation_TemplateableElement, gen_pivot_Operation_ParameterableElement, gen_pivot_Metaclass_Class, gen_pivot_NamedElement_Element, gen_pivot_NamedElement_Nameable, gen_pivot_Namespace_NamedElement, gen_pivot_NavigationCallExp_FeatureCallExp, gen_pivot_NullLiteralExp_PrimitiveLiteralExp, gen_pivot_NumericLiteralExp_PrimitiveLiteralExp, gen_pivot_OCLExpression_TypedElement, gen_pivot_OpaqueExpression_ValueSpecification, gen_pivot_OperationCallExp_FeatureCallExp, gen_pivot_OperationCallExp_ReferringElement, gen_pivot_PackageableElement_ParameterableElement, gen_pivot_Parameter_TypedMultiplicityElement, gen_pivot_Parameter_VariableDeclaration, gen_pivot_ParameterableElement_Element, gen_pivot_OperationTemplateParameter_TemplateParameter, gen_pivot_OrderedSetType_CollectionType, gen_pivot_Package_Namespace, gen_pivot_Package_TemplateableElement, gen_pivot_Precedence_NamedElement, gen_pivot_PrimitiveLiteralExp_LiteralExp, gen_pivot_PrimitiveType_DataType, gen_pivot_Profile_Package, gen_pivot_Property_Feature, gen_pivot_Property_ParameterableElement, gen_pivot_Pseudostate_Vertex, gen_pivot_PropertyCallExp_NavigationCallExp, gen_pivot_PropertyCallExp_ReferringElement, gen_pivot_SelfType_Class, gen_pivot_SendSignalAction_NamedElement, gen_pivot_SequenceType_CollectionType, gen_pivot_SetType_CollectionType, gen_pivot_Signal_NamedElement, gen_pivot_State_Vertex, gen_pivot_State_Namespace, gen_pivot_RealLiteralExp_NumericLiteralExp, gen_pivot_Region_Namespace, gen_pivot_Root_Namespace, gen_pivot_Stereotype_Class, gen_pivot_StringLiteralExp_PrimitiveLiteralExp, gen_pivot_TemplateBinding_Element, gen_pivot_TemplateParameter_Element, gen_pivot_StateExp_OCLExpression, gen_pivot_StateMachine_Behavior, gen_pivot_TemplateParameterType_Type, gen_pivot_TemplateSignature_Element, gen_pivot_TemplateParameterSubstitution_Element, gen_pivot_Trigger_NamedElement, gen_pivot_TupleLiteralExp_LiteralExp, gen_pivot_TupleLiteralPart_VariableDeclaration, gen_pivot_TemplateableElement_Element, gen_pivot_Transition_Namespace, gen_pivot_TypeExp_OCLExpression, gen_pivot_TypeExp_ReferringElement, gen_pivot_TypeTemplateParameter_TemplateParameter, gen_pivot_TupleType_DataType, gen_pivot_Type_NamedElement, gen_pivot_Type_TemplateableElement, gen_pivot_Type_ParameterableElement, gen_pivot_Variable_VariableDeclaration, gen_pivot_TypedElement_NamedElement, gen_pivot_TypedMultiplicityElement_TypedElement, gen_pivot_UnlimitedNaturalLiteralExp_NumericLiteralExp, gen_pivot_UnspecifiedType_Class, gen_pivot_UnspecifiedValueExp_OCLExpression, gen_pivot_ValueSpecification_TypedElement, gen_pivot_ValueSpecification_ParameterableElement, gen_pivot_VariableDeclaration_TypedElement, gen_pivot_VariableExp_OCLExpression, gen_pivot_VariableExp_ReferringElement, gen_pivot_Vertex_NamedElement, gen_pivot_VoidType_Class},
    metadata=None
)
