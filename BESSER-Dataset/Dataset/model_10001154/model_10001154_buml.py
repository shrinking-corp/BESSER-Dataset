...
Menu.attributes={Menu_specialCourse, Menu_desert, Menu_mainCourse, Menu_starter}
...
Drinks.attributes={Drinks_wine, Drinks_spirits, Drinks_softDrink, Drinks_cocktail, Drinks_beer}
