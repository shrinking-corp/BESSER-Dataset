...
class html_INPUT:
    ...
    def __init__(self, checked: str, src: str, inputValue: str, name: str, type: str, align: str, maxlength: str, size: str):
...
class html_TD(TABLEElement):
    ...
    def __init__(self, width: str, colspan: str, rowspan: str, valign: str, align: str, TD: "html_TR" = None, tds: "html_TR" = None):
        self.width = width
...
class html_IMG(BODYElement):
    ...
    def __init__(self, usemap: str, border: str, src: str, width: str, height: str, alt: str, align: str, vspace: str, hspace: str, ismap: str):
        self.usemap = usemap
        self.border = border
        self.src = src
        self.width = width
