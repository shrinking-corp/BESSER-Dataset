...
html_BODY.attributes={html_BODY_alink, html_BODY_bgcolor, html_BODY_link, html_BODY_vlink, html_BODY_text, html_BODY_background}
...
html_IMG.attributes={html_IMG_align, html_IMG_width, html_IMG_hspace, html_IMG_src, html_IMG_border, html_IMG_height, html_IMG_vspace, html_IMG_usemap, html_IMG_ismap, html_IMG_alt}
...
html_EMBED.attributes={html_EMBED_width, html_EMBED_height, html_EMBED_border, html_EMBED_src, html_EMBED_align, html_EMBED_hspace, html_EMBED_vspace}
...
html_TABLE.attributes={html_TABLE_cellpadding, html_TABLE_width, html_TABLE_cellspacing, html_TABLE_border}
...
html_TD.attributes={html_TD_width, html_TD_align, html_TD_colspan, html_TD_rowspan, html_TD_valign}
...
html_INPUT.attributes={html_INPUT_type, html_INPUT_maxlength, html_INPUT_align, html_INPUT_checked, html_INPUT_inputValue, html_INPUT_size, html_INPUT_src, html_INPUT_name}
...
html_OBJECT.attributes={html_OBJECT_type, html_OBJECT_standby, html_OBJECT_classid, html_OBJECT_data, html_OBJECT_id}
...
html_FRAMESET.attributes={html_FRAMESET_border, html_FRAMESET_cols, html_FRAMESET_framespacing, html_FRAMESET_frameborder, html_FRAMESET_rows}
...
html_FRAME.attributes={html_FRAME_name, html_FRAME_scrolling, html_FRAME_marginwidth, html_FRAME_marginheight, html_FRAME_noresize, html_FRAME_src}
...
html_APPLET.attributes={html_APPLET_width, html_APPLET_src, html_APPLET_class_, html_APPLET_align, html_APPLET_height, html_APPLET_applet}
...
domain_model = DomainModel(
    name="html",
    types={html_BODY, html_HTMLElement, HTMLElement, html_HEADElement, html_LINK, HEADElement, html_TITLE, html_HTML, html_HEAD, html_BODYElement, html_H1, BODYElement, html_H2, html_H3, html_H4, html_EM, html_STRONG, html_B, html_I, html_TT, html_PRE, html_BIG, html_SMALL, html_SUB, html_SUP, html_STRIKE, html_FONT, html_IMG, html_BR, html_MAP, html_AREA, html_STYLE, html_EMBED, html_NOEMBED, html_SPAN, html_A, html_TABLE, TABLEElement, html_TR, html_TD, html_DIV, html_P, html_TABLEElement, html_TEXTAREA, html_SELECT, html_OPTION, html_ListElement, html_OL, ListElement, html_UL, html_LI, html_DL, html_TH, TD, html_FORM, html_INPUT, html_OBJECT, html_FRAMESET, html_FRAME, html_NOFRAME, html_IFRAME, FRAME, html_DT, html_DD, html_APPLET, html_PARAM},
