...
# Classes
features_modeling_G = Class(name="features_modeling_G")
features_modeling_R = Class(name="features_modeling_R")
Feature = Class(name="Feature")
features_modeling_Feature = Class(name="features_modeling_Feature")
features_modeling_F = Class(name="features_modeling_F")
features_modeling_Edge = Class(name="features_modeling_Edge")
features_modeling_E = Class(name="features_modeling_E")
features_modeling_EMAND = Class(name="features_modeling_EMAND")
E = Class(name="E")
features_modeling_GXOR = Class(name="features_modeling_GXOR")
Group = Class(name="Group")
features_modeling_GOR = Class(name="features_modeling_GOR")
features_modeling_I = Class(name="features_modeling_I")
Constraint = Class(name="Constraint")
features_modeling_EX = Class(name="features_modeling_EX")
features_modeling_Constraint = Class(name="features_modeling_Constraint", is_abstract=True)
features_modeling_Group = Class(name="features_modeling_Group", is_abstract=True)
features_modeling_Constraints = Class(name="features_modeling_Constraints")
features_modeling_PropFormulaCNF = Class(name="features_modeling_PropFormulaCNF")
features_modeling_PropositionOR = Class(name="features_modeling_PropositionOR")
features_modeling_AND = Class(name="features_modeling_AND")
features_modeling_NOT = Class(name="features_modeling_NOT")
...
not_22: BinaryAssociation = BinaryAssociation(
    name="not_22",
    ends={
...
domain_model = DomainModel(
    ...
    types={features_modeling_G, features_modeling_R, Feature, features_modeling_Feature, features_modeling_F, features_modeling_Edge, features_modeling_E, features_modeling_EMAND, E, features_modeling_GXOR, Group, features_modeling_GOR, features_modeling_I, Constraint, features_modeling_EX, features_modeling_Constraint, features_modeling_Group, features_modeling_Constraints, features_modeling_PropFormulaCNF, features_modeling_PropositionOR, features_modeling_AND, features_modeling_NOT},
    associations={r0, children2, feature3, r5, feature8, edge10, feature12, feature14, constraint16, proposition18, not_22, feature24, feature19},
