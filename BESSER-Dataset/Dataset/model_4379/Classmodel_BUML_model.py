...
# Classes
classmodel_Model = Class(name="classmodel_Model")
classmodel_Import = Class(name="classmodel_Import")
classmodel_Element = Class(name="classmodel_Element")
Element = Class(name="Element")
classmodel_Datatype = Class(name="classmodel_Datatype")
Entity = Class(name="Entity")
classmodel_Package = Class(name="classmodel_Package")
classmodel_Classifier = Class(name="classmodel_Classifier")
classmodel_Type = Class(name="classmodel_Type")
classmodel_Feature = Class(name="classmodel_Feature")
classmodel_Enumeration = Class(name="classmodel_Enumeration")
classmodel_Relationship = Class(name="classmodel_Relationship")
classmodel_Annotation = Class(name="classmodel_Annotation")
classmodel_Entity = Class(name="classmodel_Entity")
classmodel_Association = Class(name="classmodel_Association")
Relationship = Class(name="Relationship")
classmodel_Multiplicity = Class(name="classmodel_Multiplicity")
classmodel_Aggregation = Class(name="classmodel_Aggregation")
classmodel_Composition = Class(name="classmodel_Composition")
classmodel_Generalization = Class(name="classmodel_Generalization")
classmodel_Dependency = Class(name="classmodel_Dependency")
classmodel_Operation = Class(name="classmodel_Operation")
classmodel_Parameter = Class(name="classmodel_Parameter")
classmodel_Reference = Class(name="classmodel_Reference")
classmodel_Attribute = Class(name="classmodel_Attribute")
classmodel_Array = Class(name="classmodel_Array")
classmodel_Realization = Class(name="classmodel_Realization")
classmodel_Constant = Class(name="classmodel_Constant")
...
classmodel_Association.attributes={classmodel_Association_headLabel, classmodel_Association_tailVisibility, classmodel_Association_headNavigable, classmodel_Association_tailNavigable, classmodel_Association_headVisibility, classmodel_Association_tailLabel}
...
classmodel_Multiplicity.attributes={classmodel_Multiplicity_upper, classmodel_Multiplicity_lower}
...
classmodel_Aggregation.attributes={classmodel_Aggregation_headNavigable, classmodel_Aggregation_tailVisibility, classmodel_Aggregation_headVisibility, classmodel_Aggregation_tailLabel, classmodel_Aggregation_headLabel, classmodel_Aggregation_tailNavigable}
...
classmodel_Composition.attributes={classmodel_Composition_tailLabel, classmodel_Composition_tailNavigable, classmodel_Composition_headNavigable, classmodel_Composition_tailVisibility, classmodel_Composition_headVisibility, classmodel_Composition_headLabel}
...
classmodel_Operation.attributes={classmodel_Operation_body, classmodel_Operation_static}
...
classmodel_Attribute.attributes={classmodel_Attribute_static, classmodel_Attribute_implicit}
...
return_40: BinaryAssociation = BinaryAssociation(
    name="return_40",
    ends={
...
domain_model = DomainModel(
    name="classmodel",
    types={classmodel_Model, classmodel_Import, classmodel_Element, Element, classmodel_Datatype, Entity, classmodel_Package, classmodel_Classifier, classmodel_Type, classmodel_Feature, classmodel_Enumeration, classmodel_Relationship, classmodel_Annotation, classmodel_Entity, classmodel_Association, Relationship, classmodel_Multiplicity, classmodel_Aggregation, classmodel_Composition, classmodel_Generalization, classmodel_Dependency, classmodel_Operation, classmodel_Parameter, classmodel_Reference, classmodel_Attribute, classmodel_Array, classmodel_Realization, classmodel_Constant, Feature, Visibility},
    associations={imports0, element5, generalization7, upperClass8, feature11, name13, upperClass15, enumerator17, head20, elements1, annotation3, headMultiplicity25, tailMultiplicity26, headMultiplicity29, tailMultiplicity31, headMultiplicity34, tailMultiplicity36, tail22, parameter39, return_40, type42, type45, type47, array50, size52},
    generalizations={gen_classmodel_Entity_Element, gen_classmodel_Datatype_Entity, gen_classmodel_Package_Element, gen_classmodel_Classifier_Entity, gen_classmodel_Enumeration_Entity, gen_classmodel_Relationship_Element, gen_classmodel_Association_Relationship, gen_classmodel_Aggregation_Relationship, gen_classmodel_Composition_Relationship, gen_classmodel_Generalization_Relationship, gen_classmodel_Operation_Feature, gen_classmodel_Attribute_Feature, gen_classmodel_Dependency_Relationship, gen_classmodel_Realization_Relationship, gen_classmodel_Constant_Feature},
    metadata=None
)
