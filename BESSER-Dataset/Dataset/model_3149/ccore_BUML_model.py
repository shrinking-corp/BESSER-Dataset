...
# Classes
ccore_TypeDefinition = Class(name="ccore_TypeDefinition", is_abstract=True)
Item = Class(name="Item")
EClass = Class(name="EClass")
ccore_Attribute = Class(name="ccore_Attribute", is_abstract=True)
ccore_Field = Class(name="ccore_Field")
ccore_Page = Class(name="ccore_Page")
ccore_UIValidator = Class(name="ccore_UIValidator")
ccore_GroupOfAttributes = Class(name="ccore_GroupOfAttributes")
ccore_EClass = Class(name="ccore_EClass")
ccore_ExtentedType = Class(name="ccore_ExtentedType")
TypeDefinition = Class(name="TypeDefinition")
ccore_ItemType = Class(name="ccore_ItemType")
ccore_WCListener = Class(name="ccore_WCListener", is_abstract=True)
ccore_EPackage = Class(name="ccore_EPackage")
ccore_BindingDesc = Class(name="ccore_BindingDesc")
ccore_Item = Class(name="ccore_Item")
ENamedElement = Class(name="ENamedElement")
DBObject = Class(name="DBObject")
ccore_KeyDefinition = Class(name="ccore_KeyDefinition")
ccore_ContentItemType = Class(name="ccore_ContentItemType", is_abstract=True)
ccore_ExporterType = Class(name="ccore_ExporterType")
ccore_ComposerType = Class(name="ccore_ComposerType")
ccore_Cadse = Class(name="ccore_Cadse")
EPackage = Class(name="EPackage")
ccore_EStructuralFeature = Class(name="ccore_EStructuralFeature")
ccore_ContentItem = Class(name="ccore_ContentItem")
ccore_Exporter = Class(name="ccore_Exporter")
ccore_Composer = Class(name="ccore_Composer")
EAttribute = Class(name="EAttribute")
ccore_DynamicActions = Class(name="ccore_DynamicActions")
ccore_ActionExtItemType = Class(name="ccore_ActionExtItemType")
ccore_Menu = Class(name="ccore_Menu")
ccore_MenuAbstract = Class(name="ccore_MenuAbstract", is_abstract=True)
ccore_RuntimeItem = Class(name="ccore_RuntimeItem")
ItemType = Class(name="ItemType")
ccore_GenInformation = Class(name="ccore_GenInformation")
ccore_ViewItemType = Class(name="ccore_ViewItemType")
ccore_ViewLinkType = Class(name="ccore_ViewLinkType")
ccore_ViewDescription = Class(name="ccore_ViewDescription")
ccore_StringAttribute = Class(name="ccore_StringAttribute")
Attribute = Class(name="Attribute")
ccore_BooleanAttribute = Class(name="ccore_BooleanAttribute")
ccore_IntegerAttribute = Class(name="ccore_IntegerAttribute")
ccore_LongAttribute = Class(name="ccore_LongAttribute")
ccore_DateAttribute = Class(name="ccore_DateAttribute")
ccore_UUIDAttribute = Class(name="ccore_UUIDAttribute")
ccore_DoubleAttribute = Class(name="ccore_DoubleAttribute")
ccore_TimeAttribute = Class(name="ccore_TimeAttribute")
LongAttribute = Class(name="LongAttribute")
ccore_UnresolvedAttributeType = Class(name="ccore_UnresolvedAttributeType", is_abstract=True)
ccore_BindExt = Class(name="ccore_BindExt")
BindingDesc = Class(name="BindingDesc")
ccore_ExportedContent = Class(name="ccore_ExportedContent")
ccore_Display = Class(name="ccore_Display")
RuntimeItem = Class(name="RuntimeItem")
ccore_InteractionController = Class(name="ccore_InteractionController")
ccore_ModelController = Class(name="ccore_ModelController")
ccore_Enum = Class(name="ccore_Enum")
ccore_EnumType = Class(name="ccore_EnumType")
ccore_LinkType = Class(name="ccore_LinkType")
EReference = Class(name="EReference")
ccore_GroupExtItem = Class(name="ccore_GroupExtItem")
EEnum = Class(name="EEnum")
ccore_EEnum = Class(name="ccore_EEnum")
ccore_ComputedString = Class(name="ccore_ComputedString", is_abstract=True)
ccore_ExtItem = Class(name="ccore_ExtItem", is_abstract=True)
ccore_ViewModel = Class(name="ccore_ViewModel")
ccore_MenuAction = Class(name="ccore_MenuAction")
ccore_MenuGroup = Class(name="ccore_MenuGroup")
ccore_ComposerLink = Class(name="ccore_ComposerLink")
ccore_View = Class(name="ccore_View")
ccore_DBObject = Class(name="ccore_DBObject")
RuntimeItemType = Class(name="RuntimeItemType")
ccore_RuntimeItemType = Class(name="ccore_RuntimeItemType")
...
ccore_Attribute.attributes={ccore_Attribute__final, ccore_Attribute_tWUpdateKind, ccore_Attribute_idRuntime, ccore_Attribute_require, ccore_Attribute_tWEvol, ccore_Attribute_isList, ccore_Attribute_tWRevSpecific, ccore_Attribute_mustBeInitialized, ccore_Attribute_tWCommitKind, ccore_Attribute_devGenerated, ccore_Attribute_cannotBeUndefined, ccore_Attribute_hiddenInComputedPages, ccore_Attribute_natif}
...
ccore_Field.attributes={ccore_Field_position, ccore_Field_label, ccore_Field_editable}
...
ccore_Page.attributes={ccore_Page_description, ccore_Page_label, ccore_Page_idRuntime, ccore_Page_title}
...
ccore_ItemType.attributes={ccore_ItemType_customManager, ccore_ItemType_packageName, ccore_ItemType_hasContent, ccore_ItemType_validateNameRe, ccore_ItemType_isInstanceAbstract, ccore_ItemType_messageErrorId, ccore_ItemType_qualifiedNameTemplate, ccore_ItemType_isInstanceHidden, ccore_ItemType_hasShortName, ccore_ItemType_hasUniqueName, ccore_ItemType_displayNameTemplate, ccore_ItemType_itemFactoryClass, ccore_ItemType_managerClass, ccore_ItemType_humanName, ccore_ItemType_isMetaItemType, ccore_ItemType_itemManagerClass, ccore_ItemType_icon, ccore_ItemType_overwriteDefaultPages, ccore_ItemType_isRootElement}
...
ccore_Item.attributes={ccore_Item_qualifiedName, ccore_Item_twRequireNewRev, ccore_Item_itemReadonly, ccore_Item_committedBy, ccore_Item_twCommittedDate, ccore_Item_twRevModified, ccore_Item_twVersion, ccore_Item_isvalid, ccore_Item_itemHidden, ccore_Item_displayName}
...
ccore_Cadse.attributes={ccore_Cadse_idDefinition, ccore_Cadse_itemRepoPasswd, ccore_Cadse_defaultContentRepoURL, ccore_Cadse_itemRepoLogin, ccore_Cadse_itemRepoURL, ccore_Cadse_executed, ccore_Cadse_description}
...
ccore_MenuAbstract.attributes={ccore_MenuAbstract_label, ccore_MenuAbstract_icon, ccore_MenuAbstract_path}
...
ccore_ViewLinkType.attributes={ccore_ViewLinkType_displayCreate, ccore_ViewLinkType_canCreateItem, ccore_ViewLinkType_canCreateLink, ccore_ViewLinkType_aggregation}
...
ccore_Display.attributes={ccore_Display_extendsIC, ccore_Display_extendsUI, ccore_Display_extendsMC}
...
ccore_EnumType.attributes={ccore_EnumType_javaClass, ccore_EnumType_mustBeGenerated, ccore_EnumType_values}
...
ccore_LinkType.attributes={ccore_LinkType_min, ccore_LinkType_aggregation, ccore_LinkType_linkManager, ccore_LinkType_twDestEvol, ccore_LinkType_composition, ccore_LinkType_selection, ccore_LinkType_annotation, ccore_LinkType_hidden, ccore_LinkType_kind, ccore_LinkType_group, ccore_LinkType_max, ccore_LinkType_twCoupled, ccore_LinkType_mapping}
...
domain_model = DomainModel(
    name="ccore",
    types={ccore_TypeDefinition, Item, EClass, ccore_Attribute, ccore_Field, ccore_Page, ccore_UIValidator, ccore_GroupOfAttributes, ccore_EClass, ccore_ExtentedType, TypeDefinition, ccore_ItemType, ccore_WCListener, ccore_EPackage, ccore_BindingDesc, ccore_Item, ENamedElement, DBObject, ccore_KeyDefinition, ccore_ContentItemType, ccore_ExporterType, ccore_ComposerType, ccore_Cadse, EPackage, ccore_EStructuralFeature, ccore_ContentItem, ccore_Exporter, ccore_Composer, EAttribute, ccore_DynamicActions, ccore_ActionExtItemType, ccore_Menu, ccore_MenuAbstract, ccore_RuntimeItem, ItemType, ccore_GenInformation, ccore_ViewItemType, ccore_ViewLinkType, ccore_ViewDescription, ccore_StringAttribute, Attribute, ccore_BooleanAttribute, ccore_IntegerAttribute, ccore_LongAttribute, ccore_DateAttribute, ccore_UUIDAttribute, ccore_DoubleAttribute, ccore_TimeAttribute, LongAttribute, ccore_UnresolvedAttributeType, ccore_BindExt, BindingDesc, ccore_ExportedContent, ccore_Display, RuntimeItem, ccore_InteractionController, ccore_ModelController, ccore_Enum, ccore_EnumType, ccore_LinkType, EReference, ccore_GroupExtItem, EEnum, ccore_EEnum, ccore_ComputedString, ccore_ExtItem, ccore_ViewModel, ccore_MenuAction, ccore_MenuGroup, ccore_ComposerLink, ccore_View, ccore_DBObject, RuntimeItemType, ccore_RuntimeItemType, TWEvol, TWUpdateKind, TWCommitKind, PositionEnum, TWDestEvol},
    associations={wcListeners18, subTypes21, attributes0, fields1, creationPages3, validators5, modificationPages7, goupsOfAttributes10, refEClass12, exendsItemTypes14, superType16, extendedTypes45, refEPackage48, binding50, itemContents52, instanceOf54, extendedBy23, keyDefinition26, contentModel28, exporterTypes30, composerTypes32, contentItemTypes34, extendsCadse38, itemTypes39, keys42, wcListens71, keys74, parent58, modifiedAttributes60, contents63, cadse64, exporters67, composers69, refItemType85, refExt87, actionsModel90, children91, parentKey77, itemType79, viewLinkTypes81, rootTypes83, source102, listenItemTypes105, listenAttributeDefinitions108, overwrite94, listenAttributes96, enumType99, destination100, attributes128, superGroup132, linkType134, attribute111, ic114, mc116, ui118, attributes120, overwrite124, refEnum126, viewItemTypes158, views160, members137, memberOf139, composerLinks142, links144, ownerItem146, ownerItem147, ownerItem149, children152, exporters153, link155, typeBinding168, mainItemType171, source162, dest165},
    generalizations={gen_ccore_TypeDefinition_Item, gen_ccore_TypeDefinition_EClass, gen_ccore_ExtentedType_TypeDefinition, gen_ccore_ItemType_TypeDefinition, gen_ccore_Item_ENamedElement, gen_ccore_Item_DBObject, gen_ccore_Cadse_Item, gen_ccore_Cadse_EPackage, gen_ccore_KeyDefinition_Item, gen_ccore_Attribute_Item, gen_ccore_Attribute_EAttribute, gen_ccore_RuntimeItem_Item, gen_ccore_ContentItemType_ItemType, gen_ccore_StringAttribute_Attribute, gen_ccore_BooleanAttribute_Attribute, gen_ccore_IntegerAttribute_Attribute, gen_ccore_LongAttribute_Attribute, gen_ccore_DateAttribute_Attribute, gen_ccore_UUIDAttribute_Attribute, gen_ccore_DoubleAttribute_Attribute, gen_ccore_TimeAttribute_LongAttribute, gen_ccore_BindExt_BindingDesc, gen_ccore_Field_Item, gen_ccore_Display_RuntimeItem, gen_ccore_InteractionController_RuntimeItem, gen_ccore_ModelController_RuntimeItem, gen_ccore_Enum_Attribute, gen_ccore_LinkType_EReference, gen_ccore_LinkType_Attribute, gen_ccore_EnumType_EEnum, gen_ccore_Composer_RuntimeItem, gen_ccore_Exporter_RuntimeItem, gen_ccore_ComposerType_RuntimeItemType, gen_ccore_ExporterType_RuntimeItemType, gen_ccore_RuntimeItemType_ItemType, gen_ccore_BindingDesc_DBObject},
    metadata=None
)
