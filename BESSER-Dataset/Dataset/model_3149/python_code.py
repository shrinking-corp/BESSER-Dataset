...
class ccore_DBObject:
    ...
    def __init__(self, objectId: int, uuid_msb: str, uuid_lsb: str, ccore_DBObject: "ccore_ItemType" = None):
...
class ccore_TimeAttribute(LongAttribute):
    ...
    def __init__(self, initWithTheCurrentTime: bool):
        ...
        pass
    @property
    def initWithTheCurrentTime(self):
...
class ccore_UUIDAttribute(Attribute):
    ...
    pass
class ccore_LinkType(Attribute, EReference):

    def __init__(self, max: int, kind: int, group: bool, annotation: bool, aggregation: bool, composition: bool, selection: str, mapping: bool, linkManager: str, twDestEvol: str, twCoupled: bool, hidden: bool, min: int, ccore_LinkType157: "ccore_ComposerLink" = None, ccore_LinkType170: "ccore_BindingDesc" = None, ccore_LinkType103: "ccore_TypeDefinition" = None, ccore_LinkType: "ccore_TypeDefinition" = None, ccore_LinkType136: "ccore_ViewLinkType" = None, ccore_LinkType143: "ccore_Composer" = None):
        self.max = max
        self.kind = kind
        self.group = group
...
class ccore_MenuAbstract(ABC):
    ...
    def __init__(self, path: str, label: str, icon: str, ccore_MenuAbstract: "ccore_Menu" = None):
        self.path = path
        self.label = label
        self.icon = icon
...
class ccore_Exporter(RuntimeItem):
    ...
    def __init__(self, types: str, ccore_Exporter: "ccore_ComposerLink" = None, Exporter: "ccore_Item" = None, exporters: "ccore_Item" = None):
        self.types = types
...
class Item:
    ...
    pass
class ccore_Cadse(EPackage, Item):

    def __init__(self, description: str, defaultContentRepoURL: str, executed: bool, itemRepoLogin: str, itemRepoPasswd: str, itemRepoURL: str, idDefinition: str, ccore_Cadse46: set["ccore_ExtentedType"] = None, ccore_Cadse49: "ccore_EPackage" = None, ccore_Cadse51: set["ccore_BindingDesc"] = None, ccore_Cadse53: set["ccore_Item"] = None, ccore_Cadse: "ccore_Cadse" = None, ccore_Cadse37: set["ccore_Cadse"] = None, ccore_Cadse40: set["ccore_ItemType"] = None, ccore_Cadse43: set["ccore_KeyDefinition"] = None, ccore_Cadse66: "ccore_Item" = None):
        ...
        pass
    @property
    def defaultContentRepoURL(self):
...
class ccore_ItemType(TypeDefinition):
    ...
    def __init__(self, isInstanceHidden: bool, overwriteDefaultPages: bool, icon: str, itemFactoryClass: str, itemManagerClass: str, packageName: str, customManager: bool, managerClass: str, qualifiedNameTemplate: str, messageErrorId: str, validateNameRe: str, hasContent: bool, isRootElement: bool, isInstanceAbstract: bool, hasShortName: bool, hasUniqueName: bool, isMetaItemType: bool, displayNameTemplate: str, humanName: str, ccore_ItemType27: "ccore_KeyDefinition" = None, ccore_ItemType29: "ccore_ContentItemType" = None, ccore_ItemType31: set["ccore_ExporterType"] = None, ccore_ItemType19: set["ccore_WCListener"] = None, ccore_ItemType22: "ccore_ItemType" = None, ccore_ItemType20: set["ccore_ItemType"] = None, ccore_ItemType: "ccore_ExtentedType" = None, ccore_ItemType17: "ccore_ItemType" = None, ccore_ItemType15: set["ccore_ItemType"] = None, ccore_ItemType56: "ccore_Item" = None, ccore_ItemType24: set["ccore_ExtentedType"] = None, ccore_ItemType33: set["ccore_ComposerType"] = None, ccore_ItemType35: set["ccore_ContentItemType"] = None, ccore_ItemType41: "ccore_Cadse" = None, ccore_ItemType86: "ccore_BindExt" = None, ccore_ItemType80: "ccore_ViewItemType" = None, ccore_ItemType107: "ccore_WCListener" = None, ccore_ItemType172: "ccore_DBObject" = None):
    ...
    @property
    def overwriteDefaultPages(self):
    ...
    @property
    def qualifiedNameTemplate(self):
...
class ccore_Attribute(EAttribute, Item):

    def __init__(self, natif: bool, _final: bool, mustBeInitialized: bool, tWRevSpecific: bool, tWEvol: str, tWUpdateKind: str, tWCommitKind: str, devGenerated: bool, idRuntime: str, hiddenInComputedPages: bool, isList: bool, require: bool, cannotBeUndefined: bool, ccore_Attribute: "ccore_TypeDefinition" = None, ccore_Attribute72: set["ccore_WCListener"] = None, ccore_Attribute62: "ccore_Item" = None, ccore_Attribute110: "ccore_WCListener" = None, ccore_Attribute98: "ccore_UIValidator" = None, ccore_Attribute130: "ccore_GroupOfAttributes" = None, ccore_Attribute113: "ccore_Field" = None, ccore_Attribute122: "ccore_Page" = None):
        self.natif = natif
        self._final = _final
        ...
        pass
    @property
    def hiddenInComputedPages(self):
