...
class core_Specification(VerifiableElement):
    ...
    def __init__(self, version: str, core_Specification38: "core_ConstraintLanguagesSpecification" = None, core_Specification40: set["core_EObject"] = None, core_Specification43: set["core_EObject"] = None, core_Specification: set["core_Actor"] = None, core_Specification31: "core_SystemOverview" = None, specification: set["core_RequirementsGroup"] = None, core_Specification34: set["core_VerificationActivity"] = None, core_Specification36: set["core_Conflict"] = None, Specification: "core_RequirementsGroup" = None, core_Specification119: "core_Trace" = None):
...
class core_SystemOverview(ContractualElement):
    ...
    def __init__(self, purpose: str, capabilities: str, core_SystemOverview46: set["core_Goal"] = None, core_SystemOverview48: "core_EObject" = None, core_SystemOverview: "core_Specification" = None, core_SystemOverview51: set["core_SystemContext"] = None, core_SystemOverview53: set["core_Variable"] = None):
...
class core_VerificationActivity(IdentifiedElement):
    ...
    def __init__(self, passed: bool, verificationMethod: str, core_VerificationActivity: "core_Specification" = None, VerificationActivity: "core_AbstractRequirement" = None, core_VerificationActivity108: set["core_EObject"] = None, core_VerificationActivity111: "core_Expression" = None, verifiedBy: "core_AbstractRequirement" = None):
        self.passed = passed
...
class core_Actor(IdentifiedElement):
    ...
    def __init__(self, address: str, email: str, phoneNumber: str, core_Actor: "core_ContractualElement" = None, core_Actor29: "core_Specification" = None, core_Actor67: set["core_EObject"] = None, core_Actor70: set["core_Interaction"] = None, core_Actor59: "core_SystemContext" = None):
...
class core_ContractualElement(IdentifiedElement):
    ...
    def __init__(self, sources: str, originDate: str, scheduleDate: str, dropped: bool, droppingReason: str, satisfactionLevel: str, timeCriticality: str, core_ContractualElement21: "core_Expression" = None, contractualElements: set["core_StakeHolder"] = None, core_ContractualElement23: "core_Expression" = None, core_ContractualElement26: set["core_EObject"] = None, core_ContractualElement8: "core_Category" = None, core_ContractualElement10: set["core_ReferencedModelElements"] = None, core_ContractualElement12: set["core_EObject"] = None, core_ContractualElement15: set["core_EObject"] = None, contract: set["core_Rationale"] = None, core_ContractualElement19: set["core_Actor"] = None, ContractualElement: "core_StakeHolder" = None, core_ContractualElement2: set["core_ContractualElement"] = None, core_ContractualElement4: "core_ContractualElement" = None, core_ContractualElement6: set["core_EObject"] = None, core_ContractualElement: "core_Uncertainty" = None, ContractualElement124: "core_Rationale" = None):
