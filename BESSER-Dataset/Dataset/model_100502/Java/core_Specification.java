...
public class core_Specification extends VerifiableElement {
    ...
    private core_ConstraintLanguagesSpecification core_constraintlanguagesspecification;
    ...
    public core_Specification(
        String version        ArrayList<core_EObject> core_eobjects,        ArrayList<core_VerificationActivity> core_verificationactivitys,        ArrayList<core_Conflict> core_conflicts,        ArrayList<core_EObject> core_eobjects,        ArrayList<core_Actor> core_actors    ) {
        this.version = version;
    ...
    public core_ConstraintLanguagesSpecification getCore_constraintlanguagesspecification() {
        return core_constraintlanguagesspecification;
    }

    public void setCore_constraintlanguagesspecification(core_ConstraintLanguagesSpecification core_constraintlanguagesspecification) {
        this.core_constraintlanguagesspecification = core_constraintlanguagesspecification;
    }
