...
core_IdentifiedElement.attributes={core_IdentifiedElement_id, core_IdentifiedElement_description, core_IdentifiedElement_name}
...
core_ContractualElement.attributes={core_ContractualElement_originDate, core_ContractualElement_timeCriticality, core_ContractualElement_satisfactionLevel, core_ContractualElement_sources, core_ContractualElement_droppingReason, core_ContractualElement_dropped, core_ContractualElement_scheduleDate}
...
core_Uncertainty.attributes={core_Uncertainty_volatility, core_Uncertainty_precedence, core_Uncertainty_maturityIndex, core_Uncertainty_scheduleImpact, core_Uncertainty_costsImpact, core_Uncertainty_propRiskIndex, core_Uncertainty_riskIndex}
...
core_Actor.attributes={core_Actor_phoneNumber, core_Actor_address, core_Actor_email}
...
core_ModelElementReference.attributes={core_ModelElementReference_reason, core_ModelElementReference_weight, core_ModelElementReference_satisfactionLevel, core_ModelElementReference_verifies}
...
domain_model = DomainModel(
    name="core",
    types={core_EObject, core_IdentifiedElement, core_ContractualElement, IdentifiedElement, core_Uncertainty, core_StakeHolder, core_Category, core_ReferencedModelElements, core_Rationale, core_Actor, core_Expression, core_ConstraintLanguagesSpecification, core_Goal, core_VerifiableElement, ContractualElement, core_Specification, VerifiableElement, core_SystemOverview, core_RequirementsGroup, core_VerificationActivity, core_Conflict, core_Interaction, core_SystemContext, core_Variable, Actor, core_Requirement, AbstractRequirement, core_Assumption, core_AbstractRequirement, core_RequirementsContainer, core_Trace, core_RefExpressionCollectedModelElements, ReferencedModelElements, core_FormalLanguageExpression, core_RefUserSelectedModelElements, core_ModelElementReference, core_RefDerivedModelElements, core_TraceModelElementReference, ModelElementReference, RequirementsCoverageData, core_RequirementsCoverageData, Direction, RiskKind, VerificationMethod, AssumptionType, AgregationType, VariableType, ContainerType},
    associations={evolvedTo3, tracedTo5, changeUncertainty0, expression20, stakeholders1, condition22, modes25, category7, satisfiedBy9, agents11, derivedFrom14, rationales17, contactInformation18, constraintLanguagesSpecification37, specifies39, primaryActors42, goals45, systemToBe47, actors28, systOverview30, requirementGroups32, verificationActivities33, conflicts35, images66, interactions69, contexts50, systemBoundary52, globalSystem54, actors57, systemBoundary60, systemModes63, rationales77, entity71, conflicts74, goals75, contractualElements76, refinedBY92, assumptions93, imageAssumption95, derivations98, requirements78, specification79, containedRequirements81, verifiedBy82, group83, assignedVariable85, conditionVariables88, externalRef107, expression110, subRequirements100, requirements102, imageRequirement103, requirement105, specifications118, queryExpression113, modelElementReferences114, modelElement115, parent117, contract123, feature120, requirement125, requirements128},
    generalizations={gen_core_ContractualElement_IdentifiedElement, gen_core_SystemOverview_ContractualElement, gen_core_Uncertainty_IdentifiedElement, gen_core_VerifiableElement_ContractualElement, gen_core_Specification_VerifiableElement, gen_core_Actor_IdentifiedElement, gen_core_SystemContext_IdentifiedElement, gen_core_RequirementsGroup_VerifiableElement, gen_core_Interaction_IdentifiedElement, gen_core_Goal_ContractualElement, gen_core_Conflict_IdentifiedElement, gen_core_StakeHolder_Actor, gen_core_Requirement_AbstractRequirement, gen_core_AbstractRequirement_VerifiableElement, gen_core_Assumption_AbstractRequirement, gen_core_VerificationActivity_IdentifiedElement, gen_core_Trace_ReferencedModelElements, gen_core_RefExpressionCollectedModelElements_ReferencedModelElements, gen_core_RefUserSelectedModelElements_ReferencedModelElements, gen_core_ReferencedModelElements_IdentifiedElement, gen_core_ModelElementReference_IdentifiedElement, gen_core_RefDerivedModelElements_ReferencedModelElements, gen_core_Rationale_IdentifiedElement, gen_core_RequirementsContainer_IdentifiedElement, gen_core_TraceModelElementReference_ModelElementReference, gen_core_TraceModelElementReference_RequirementsCoverageData, gen_core_RequirementsCoverageData_IdentifiedElement, gen_core_Variable_IdentifiedElement},
    metadata=None
)
