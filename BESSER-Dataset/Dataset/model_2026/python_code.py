...
class tP1_IDM_State:
    ...
    def __init__(self, name: str, tP1_IDM_State: "tP1_IDM_StateMachine" = None, tP1_IDM_State5: "tP1_IDM_StateMachine" = None, to: "tP1_IDM_Transition" = None, from_: "tP1_IDM_Transition" = None, State: "tP1_IDM_Transition" = None, State11: "tP1_IDM_Transition" = None):
        self.name = name
    ...
    def from_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_tP1_IDM_State__from_", None)
        self.__from_ = value
