...
# Classes
tP1_IDM_StateMachine = Class(name="tP1_IDM_StateMachine")
tP1_IDM_State = Class(name="tP1_IDM_State")
tP1_IDM_Transition = Class(name="tP1_IDM_Transition")
...
outgoing7: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_", type=tP1_IDM_Transition, multiplicity=Multiplicity(0, 1))
    }
)
...
domain_model = DomainModel(
    name="tP1_IDM",
    types={tP1_IDM_StateMachine, tP1_IDM_State, tP1_IDM_Transition},
    associations={state0, transition1, stateStart3, incomming6, outgoing7, to9, from_10},
    generalizations={},
    metadata=None
)
