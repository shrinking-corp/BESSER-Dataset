...
# Classes
umlclassdiagram_RootCS = Class(name="umlclassdiagram_RootCS")
umlclassdiagram_PackageCS = Class(name="umlclassdiagram_PackageCS")
umlclassdiagram_ConstraintCS = Class(name="umlclassdiagram_ConstraintCS")
umlclassdiagram_ClassCS = Class(name="umlclassdiagram_ClassCS")
umlclassdiagram_PathNameCS = Class(name="umlclassdiagram_PathNameCS")
umlclassdiagram_PropertyCS = Class(name="umlclassdiagram_PropertyCS")
umlclassdiagram_OperationCS = Class(name="umlclassdiagram_OperationCS")
umlclassdiagram_ParameterCS = Class(name="umlclassdiagram_ParameterCS")
umlclassdiagram_LogicExpCS = Class(name="umlclassdiagram_LogicExpCS")
ExpCS = Class(name="ExpCS")
umlclassdiagram_CallExpCS = Class(name="umlclassdiagram_CallExpCS")
LogicExpCS = Class(name="LogicExpCS")
umlclassdiagram_NavigationExpCS = Class(name="umlclassdiagram_NavigationExpCS")
umlclassdiagram_PrimaryExpCS = Class(name="umlclassdiagram_PrimaryExpCS")
CallExpCS = Class(name="CallExpCS")
PrimaryExpCS = Class(name="PrimaryExpCS")
umlclassdiagram_NameExpCS = Class(name="umlclassdiagram_NameExpCS")
NavigationExpCS = Class(name="NavigationExpCS")
umlclassdiagram_RoundedBracketClauseCS = Class(name="umlclassdiagram_RoundedBracketClauseCS")
umlclassdiagram_ExpCS = Class(name="umlclassdiagram_ExpCS")
umlclassdiagram_InvariantCS = Class(name="umlclassdiagram_InvariantCS")
umlclassdiagram_LiteralExpCS = Class(name="umlclassdiagram_LiteralExpCS")
umlclassdiagram_IntLiteralExpCS = Class(name="umlclassdiagram_IntLiteralExpCS")
LiteralExpCS = Class(name="LiteralExpCS")
umlclassdiagram_StringLiteralExpCS = Class(name="umlclassdiagram_StringLiteralExpCS")
umlclassdiagram_BooleanLiteralExpCS = Class(name="umlclassdiagram_BooleanLiteralExpCS")
umlclassdiagram_PathCS = Class(name="umlclassdiagram_PathCS")
umlclassdiagram_PathVariableCS = Class(name="umlclassdiagram_PathVariableCS")
PathCS = Class(name="PathCS")
umlclassdiagram_PathElementCS = Class(name="umlclassdiagram_PathElementCS")
umlclassdiagram_Feature = Class(name="umlclassdiagram_Feature", is_abstract=True)
umlclassdiagram_BooleanExpCS = Class(name="umlclassdiagram_BooleanExpCS")
BooleanLiteralExpCS = Class(name="BooleanLiteralExpCS")
umlclassdiagram_ExistsExpCS = Class(name="umlclassdiagram_ExistsExpCS")
umlclassdiagram_NavigationNameExpCS = Class(name="umlclassdiagram_NavigationNameExpCS")
umlclassdiagram_NavigationPathNameCS = Class(name="umlclassdiagram_NavigationPathNameCS")
umlclassdiagram_LoopExpCS = Class(name="umlclassdiagram_LoopExpCS")
umlclassdiagram_IteratorVarCS = Class(name="umlclassdiagram_IteratorVarCS")
umlclassdiagram_CollectExpCS = Class(name="umlclassdiagram_CollectExpCS")
LoopExpCS = Class(name="LoopExpCS")
umlclassdiagram_IterateExpCS = Class(name="umlclassdiagram_IterateExpCS")
umlclassdiagram_AccVarCS = Class(name="umlclassdiagram_AccVarCS")
umlclassdiagram_ClassDiagram = Class(name="umlclassdiagram_ClassDiagram")
umlclassdiagram_Classifier = Class(name="umlclassdiagram_Classifier", is_abstract=True)
umlclassdiagram_Relation = Class(name="umlclassdiagram_Relation", is_abstract=True)
umlclassdiagram_PrimitiveElement = Class(name="umlclassdiagram_PrimitiveElement")
umlclassdiagram_Constraint = Class(name="umlclassdiagram_Constraint")
umlclassdiagram_NamedElement = Class(name="umlclassdiagram_NamedElement", is_abstract=True)
NamedElement = Class(name="NamedElement")
umlclassdiagram_Parameter = Class(name="umlclassdiagram_Parameter")
umlclassdiagram_NavigationPathCS = Class(name="umlclassdiagram_NavigationPathCS")
umlclassdiagram_NavigationPathVariableCS = Class(name="umlclassdiagram_NavigationPathVariableCS")
NavigationPathCS = Class(name="NavigationPathCS")
umlclassdiagram_NavigationPathElementCS = Class(name="umlclassdiagram_NavigationPathElementCS")
umlclassdiagram_ForAllExpCS = Class(name="umlclassdiagram_ForAllExpCS")
Classifier = Class(name="Classifier")
umlclassdiagram_Attribute = Class(name="umlclassdiagram_Attribute")
Feature = Class(name="Feature")
umlclassdiagram_Operation = Class(name="umlclassdiagram_Operation")
umlclassdiagram_Operator = Class(name="umlclassdiagram_Operator")
umlclassdiagram_Modifier = Class(name="umlclassdiagram_Modifier", is_abstract=True)
Modifier = Class(name="Modifier")
umlclassdiagram_Class = Class(name="umlclassdiagram_Class")
umlclassdiagram_Dependency = Class(name="umlclassdiagram_Dependency")
Relation = Class(name="Relation")
umlclassdiagram_Association = Class(name="umlclassdiagram_Association")
umlclassdiagram_Aggregation = Class(name="umlclassdiagram_Aggregation")
umlclassdiagram_Composition = Class(name="umlclassdiagram_Composition")
umlclassdiagram_AssociationClass = Class(name="umlclassdiagram_AssociationClass")
...
umlclassdiagram_Feature.attributes={umlclassdiagram_Feature_scope, umlclassdiagram_Feature_visibility, umlclassdiagram_Feature_name}
...
umlclassdiagram_Relation.attributes={umlclassdiagram_Relation_nsrc, umlclassdiagram_Relation_derived, umlclassdiagram_Relation_ntar}
...
umlclassdiagram_Modifier.attributes={umlclassdiagram_Modifier_visibility, umlclassdiagram_Modifier_scope}
...
domain_model = DomainModel(
    ...
    types={umlclassdiagram_RootCS, umlclassdiagram_PackageCS, umlclassdiagram_ConstraintCS, umlclassdiagram_ClassCS, umlclassdiagram_PathNameCS, umlclassdiagram_PropertyCS, umlclassdiagram_OperationCS, umlclassdiagram_ParameterCS, umlclassdiagram_LogicExpCS, ExpCS, umlclassdiagram_CallExpCS, LogicExpCS, umlclassdiagram_NavigationExpCS, umlclassdiagram_PrimaryExpCS, CallExpCS, PrimaryExpCS, umlclassdiagram_NameExpCS, NavigationExpCS, umlclassdiagram_RoundedBracketClauseCS, umlclassdiagram_ExpCS, umlclassdiagram_InvariantCS, umlclassdiagram_LiteralExpCS, umlclassdiagram_IntLiteralExpCS, LiteralExpCS, umlclassdiagram_StringLiteralExpCS, umlclassdiagram_BooleanLiteralExpCS, umlclassdiagram_PathCS, umlclassdiagram_PathVariableCS, PathCS, umlclassdiagram_PathElementCS, umlclassdiagram_Feature, umlclassdiagram_BooleanExpCS, BooleanLiteralExpCS, umlclassdiagram_ExistsExpCS, umlclassdiagram_NavigationNameExpCS, umlclassdiagram_NavigationPathNameCS, umlclassdiagram_LoopExpCS, umlclassdiagram_IteratorVarCS, umlclassdiagram_CollectExpCS, LoopExpCS, umlclassdiagram_IterateExpCS, umlclassdiagram_AccVarCS, umlclassdiagram_ClassDiagram, umlclassdiagram_Classifier, umlclassdiagram_Relation, umlclassdiagram_PrimitiveElement, umlclassdiagram_Constraint, umlclassdiagram_NamedElement, NamedElement, umlclassdiagram_Parameter, umlclassdiagram_NavigationPathCS, umlclassdiagram_NavigationPathVariableCS, NavigationPathCS, umlclassdiagram_NavigationPathElementCS, umlclassdiagram_ForAllExpCS, Classifier, umlclassdiagram_Attribute, Feature, umlclassdiagram_Operation, umlclassdiagram_Operator, umlclassdiagram_Modifier, Modifier, umlclassdiagram_Class, umlclassdiagram_Dependency, Relation, umlclassdiagram_Association, umlclassdiagram_Aggregation, umlclassdiagram_Composition, umlclassdiagram_AssociationClass, PrimitiveDataType, VisbilityType, ScopeType, OperatorType},
    associations={packages0, constraints1, packages4, classes6, extends8, properties10, operations12, typeRef14, params17, left36, right37, source40, navExp42, expName44, roundedBrackets46, callExp48, resultRef19, body22, typeRef24, typeRef27, invariants30, args65, exp32, path68, pathName70, accVars71, expName73, roundedBrackets74, itVar51, exp52, itType55, accVar58, accType59, accInitExp62, accVars84, classes86, relations87, types89, constraints91, callExp77, path80, pathName82, supplier102, type105, expressions108, params111, operators113, src115, type93, type94, features97, super100, tar118, association121},
    generalizations={gen_umlclassdiagram_LogicExpCS_ExpCS, gen_umlclassdiagram_CallExpCS_LogicExpCS, gen_umlclassdiagram_PrimaryExpCS_CallExpCS, gen_umlclassdiagram_NavigationExpCS_PrimaryExpCS, gen_umlclassdiagram_NameExpCS_NavigationExpCS, gen_umlclassdiagram_LiteralExpCS_PrimaryExpCS, gen_umlclassdiagram_IntLiteralExpCS_LiteralExpCS, gen_umlclassdiagram_StringLiteralExpCS_LiteralExpCS, gen_umlclassdiagram_BooleanLiteralExpCS_LiteralExpCS, gen_umlclassdiagram_PathVariableCS_PathCS, gen_umlclassdiagram_PathElementCS_PathCS, gen_umlclassdiagram_BooleanExpCS_BooleanLiteralExpCS, gen_umlclassdiagram_ExistsExpCS_LoopExpCS, gen_umlclassdiagram_NavigationNameExpCS_NavigationExpCS, gen_umlclassdiagram_LoopExpCS_NavigationExpCS, gen_umlclassdiagram_CollectExpCS_LoopExpCS, gen_umlclassdiagram_IterateExpCS_LoopExpCS, gen_umlclassdiagram_PrimitiveElement_NamedElement, gen_umlclassdiagram_Parameter_NamedElement, gen_umlclassdiagram_NavigationPathVariableCS_NavigationPathCS, gen_umlclassdiagram_NavigationPathElementCS_NavigationPathCS, gen_umlclassdiagram_ForAllExpCS_LoopExpCS, gen_umlclassdiagram_Class_Classifier, gen_umlclassdiagram_Attribute_Feature, gen_umlclassdiagram_Operation_Feature, gen_umlclassdiagram_Relation_Modifier, gen_umlclassdiagram_Modifier_NamedElement, gen_umlclassdiagram_Classifier_Modifier, gen_umlclassdiagram_Dependency_Relation, gen_umlclassdiagram_Association_Relation, gen_umlclassdiagram_Aggregation_Relation, gen_umlclassdiagram_Composition_Relation, gen_umlclassdiagram_AssociationClass_Classifier},
    metadata=None
)
