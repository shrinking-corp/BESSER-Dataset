...
# Classes
whileCpp_Definition = Class(name="whileCpp_Definition")
whileCpp_Input = Class(name="whileCpp_Input")
whileCpp_Commands = Class(name="whileCpp_Commands")
whileCpp_Output = Class(name="whileCpp_Output")
whileCpp_Vars = Class(name="whileCpp_Vars")
whileCpp_Command = Class(name="whileCpp_Command")
whileCpp_Exprs = Class(name="whileCpp_Exprs")
whileCpp_CommandWhile = Class(name="whileCpp_CommandWhile")
whileCpp_CommandIf = Class(name="whileCpp_CommandIf")
whileCpp_CommandForEach = Class(name="whileCpp_CommandForEach")
whileCpp_Program = Class(name="whileCpp_Program")
whileCpp_Function = Class(name="whileCpp_Function")
whileCpp_ExprSimple = Class(name="whileCpp_ExprSimple")
whileCpp_ExprAnd = Class(name="whileCpp_ExprAnd")
whileCpp_Cons = Class(name="whileCpp_Cons")
whileCpp_ExprOr = Class(name="whileCpp_ExprOr")
whileCpp_Expr = Class(name="whileCpp_Expr")
whileCpp_ExprEq = Class(name="whileCpp_ExprEq")
whileCpp_ExprNot = Class(name="whileCpp_ExprNot")
...
whileCpp_ExprSimple.attributes={whileCpp_ExprSimple_nomSymb, whileCpp_ExprSimple_exprTail, whileCpp_ExprSimple_symb, whileCpp_ExprSimple_exprHead, whileCpp_ExprSimple_nil, whileCpp_ExprSimple_vari}
...
whileCpp_ExprNot_not_: Property = Property(name="not_", type=StringType)
whileCpp_ExprNot.attributes={whileCpp_ExprNot_not_}
...
domain_model = DomainModel(
    name="whileCpp",
    types={whileCpp_Definition, whileCpp_Input, whileCpp_Commands, whileCpp_Output, whileCpp_Vars, whileCpp_Command, whileCpp_Exprs, whileCpp_CommandWhile, whileCpp_CommandIf, whileCpp_CommandForEach, whileCpp_Program, whileCpp_Function, whileCpp_ExprSimple, whileCpp_ExprAnd, whileCpp_Cons, whileCpp_ExprOr, whileCpp_Expr, whileCpp_ExprEq, whileCpp_ExprNot},
    associations={fonctions0, definition1, inputs3, commandes5, outputs7, commande9, vars11, exprs13, cmdWhile15, cmdIf17, cmdForEach19, cmdsElse32, elem35, ensemb38, cmds41, expGen44, exprSimp47, exprAnd49, exprCons51, exprHeadAtt53, exprTailAtt56, symbAtt59, exprOr62, exprAndAtt65, expr21, cmds23, cond26, cmdsThen29, exprEq72, expr74, exprSim177, exprSim280, exprConsAttList83, exprNot67, exprOrAtt70},
    generalizations={},
    metadata=None
)
