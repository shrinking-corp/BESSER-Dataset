...
# Classes
entityDsl_Module = Class(name="entityDsl_Module")
Named = Class(name="Named")
entityDsl_Entity = Class(name="entityDsl_Entity")
entityDsl_Attribute = Class(name="entityDsl_Attribute")
entityDsl_AbstractType = Class(name="entityDsl_AbstractType")
entityDsl_Named = Class(name="entityDsl_Named")
entityDsl_BooleanType = Class(name="entityDsl_BooleanType")
AbstractType = Class(name="AbstractType")
entityDsl_IntType = Class(name="entityDsl_IntType")
entityDsl_StringType = Class(name="entityDsl_StringType")
entityDsl_EntityReference = Class(name="entityDsl_EntityReference")
...
domain_model = DomainModel(
    name="entityDsl",
    types={entityDsl_Module, Named, entityDsl_Entity, entityDsl_Attribute, entityDsl_AbstractType, entityDsl_Named, entityDsl_BooleanType, AbstractType, entityDsl_IntType, entityDsl_StringType, entityDsl_EntityReference},
    associations={entities0, attributes1, type3, ref5},
    generalizations={gen_entityDsl_Module_Named, gen_entityDsl_Entity_Named, gen_entityDsl_Attribute_Named, gen_entityDsl_BooleanType_AbstractType, gen_entityDsl_IntType_AbstractType, gen_entityDsl_StringType_AbstractType, gen_entityDsl_EntityReference_AbstractType},
    metadata=None
)
