...
def test_data_Item_created_value_roundtrip():
    instance = data_Item(created=date(2024, 1, 1), ident="sample_text", lastModified=date(2024, 1, 1), stringValue="sample_text", stringXML="sample_text", uri="sample_text")
    assert instance.created == date(2024, 1, 1)
    instance.created = date(2025, 6, 15)
    assert instance.created == date(2025, 6, 15)
...
def test_data_Item_stringXML_value_roundtrip():
    instance = data_Item(created=date(2024, 1, 1), ident="sample_text", lastModified=date(2024, 1, 1), stringValue="sample_text", stringXML="sample_text", uri="sample_text")
    assert instance.stringXML == "sample_text"
    instance.stringXML = "sample_text_2"
    assert instance.stringXML == "sample_text_2"
...
def test_assoc_dataSet42_link_reassign_clear():
    a = data_Item(created=date(2024, 1, 1), ident="sample_text", lastModified=date(2024, 1, 1), stringValue="sample_text", stringXML="sample_text", uri="sample_text")
...
def test_assoc_deleteOnDelete46_link_reassign_clear():
    a = data_Item(created=date(2024, 1, 1), ident="sample_text", lastModified=date(2024, 1, 1), stringValue="sample_text", stringXML="sample_text", uri="sample_text")
    b1 = data_Item(created=date(2024, 1, 1), ident="sample_text", lastModified=date(2024, 1, 1), stringValue="sample_text", stringXML="sample_text", uri="sample_text")
    b2 = data_Item(created=date(2025, 6, 15), ident="sample_text_2", lastModified=date(2025, 6, 15), stringValue="sample_text_2", stringXML="sample_text_2", uri="sample_text_2")
...
data_Item_strategy = st.builds(data_Item, created=st.dates(), ident=safe_text, lastModified=st.dates(), stringValue=safe_text, stringXML=safe_text, uri=safe_text)
