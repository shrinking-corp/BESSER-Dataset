...
class data_Person(InformationObject):
    ...
    def __init__(self, dateOfBirth: date, title: str, lastname: str, firstname: str, contributors: set["data_Content"] = None, data_Person: "data_Person" = None, data_Person6: set["data_Person"] = None, ranker: set["data_Ranking"] = None, leader: set["data_Organisation"] = None, participants: set["data_Organisation"] = None, author: set["data_Content"] = None, Person73: "data_Organisation" = None, Person75: "data_Organisation" = None, Person82: "data_Ranking" = None, Person: "data_Content" = None, Person30: "data_Content" = None):
...
class data_IndoorLocation(MetaInformation):
    ...
    def __init__(self, name: str, IndoorLocation: "data_Location" = None, IndoorLocation105: "data_IndoorLocation" = None, parentIndoorLocation: set["data_IndoorLocation"] = None, indoorLocations: "data_Location" = None, IndoorLocation102: "data_IndoorLocation" = None, indoorLocations101: "data_IndoorLocation" = None):
        self.name = name
...
class data_Location(MetaInformation):
    ...
    def __init__(self, state: str, street: str, houseNumber: str, zipCode: str, country: str, longitude: str, latitude: str, city: str, location: set["data_IndoorLocation"] = None, Location: "data_IndoorLocation" = None):
        self.state = state
        self.street = street
...
class data_Item(ABC):
    ...
    def __init__(self, ident: str, uri: str, stringValue: str, stringXML: str, lastModified: date, created: date, Item: "data_DataSet" = None, identified: set["data_Identifier"] = None, items: "data_DataSet" = None, metaTagged: set["data_MetaTag"] = None, Item56: "data_Item" = None, forcedDeleteOnDelete: set["data_Item"] = None, Item47: "data_Item" = None, deletedIfDeleted: set["data_Item"] = None, Item50: "data_Item" = None, deleteOnDelete: set["data_Item"] = None, Item53: "data_Item" = None, forcedDeletedIfDeleted: set["data_Item"] = None, Item80: "data_MetaTag" = None, Item107: "data_Identifier" = None):
        self.ident = ident
        self.uri = uri
    ...
    def log(self, data_message, data_level):
...
class data_DataSet:
    ...
    def getOrganisationWithIdentifier(self, data_value, data_key) :
    ...
    def getPersonWithIdentifier(self, data_value, data_key) :
    ...
    def getContentWithIdentifier(self, data_key, data_value) :
...
class data_InformationObject(Item):
    ...
    def __init__(self, alternativeNames: str, name: str, verifiedName: str, data_InformationObject21: set["data_Binary"] = None, mainCategorized: "data_Category" = None, informationObjects: set["data_MetaInformation"] = None, categorized: set["data_Category"] = None, tagged: set["data_Tag"] = None, data_InformationObject: set["data_Image"] = None, rankedInformationObject: set["data_StarRanking"] = None, rankedInformationObject14: set["data_ThumbRanking"] = None, rankedInformationObject16: set["data_ViewRanking"] = None, from_: set["data_Connection"] = None, to: set["data_Connection"] = None, InformationObject: "data_Category" = None, InformationObject66: "data_Category" = None, InformationObject68: "data_Tag" = None, InformationObject85: "data_StarRanking" = None, InformationObject87: "data_ViewRanking" = None, InformationObject89: "data_ThumbRanking" = None, InformationObject93: "data_Connection" = None, InformationObject95: "data_Connection" = None, InformationObject97: "data_MetaInformation" = None):
    ...
    def addWebAccountForService(self, data_service, data_username) :
        # TODO: Implement addWebAccountForService method
        pass

    def starRankWithMetaTag(self, data_metaTag, data_stars, data_ofStars) :
...
class data_Content(InformationObject):
    ...
    def __init__(self, locale: str, Content5: "data_Person" = None, Content: "data_Person" = None, data_Content37: set["data_Video"] = None, Content27: "data_Content" = None, parentContent: set["data_Content"] = None, Content91: "data_Transformation" = None, contributed: set["data_Person"] = None, authored: "data_Person" = None, data_Content: set["data_Document"] = None, Content34: "data_Content" = None, contents: "data_Content" = None, transformed: set["data_Transformation"] = None):
        self.locale = locale
    ...
    def commentWithMetaTagList(self, data_comment, data_metaTagList) :
