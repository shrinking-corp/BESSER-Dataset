...
metrics_MappingRDBMS.attributes={metrics_MappingRDBMS_password, metrics_MappingRDBMS_user, metrics_MappingRDBMS_timeFormat, metrics_MappingRDBMS_databaseType, metrics_MappingRDBMS_query, metrics_MappingRDBMS_dateTimeFormat, metrics_MappingRDBMS_dateFormat}
...
metrics_Metric.attributes={metrics_Metric_measurementKind, metrics_Metric_name, metrics_Metric_description, metrics_Metric_measurementPoint}
...
metrics_ValueDataKind.attributes={metrics_ValueDataKind_kindHint, metrics_ValueDataKind_valueKind, metrics_ValueDataKind_format}
...
domain_model = DomainModel(
    name="metrics",
    types={metrics_IdentifierDataKind, DataKind, metrics_DataKind, metrics_Mapping, Base, metrics_MappingColumn, metrics_MappingCSV, Mapping, metrics_MappingRDBMS, metrics_DateTimeRange, metrics_MappingRecord, metrics_MappingStatistic, metrics_Metric, metrics_Expression, metrics_MappingXLS, metrics_MetricRetentionRule, metrics_MetricSource, metrics_Unit, metrics_MetricRetentionRules, metrics_ValueDataKind, metrics_MetricValueRange, metrics_Value, DatabaseTypeType, KindHintType, MetricRetentionPeriod, ObjectKindType, ValueKindType},
    associations={dataType4, headerMappingColumns0, dataMappingColumns1, failedRecords6, mappingDuration7, periodEstimate9, metrics16, subStatistics13, expressionRef17, metricSourceRef19, unitRef21, statistics30, retentionExpression23, metricRetentionRules25, metricMapping27, metricRef34, metricValues33},
    generalizations={gen_metrics_IdentifierDataKind_DataKind, gen_metrics_MappingColumn_Base, gen_metrics_Mapping_Base, gen_metrics_MappingCSV_Mapping, gen_metrics_MappingRDBMS_Mapping, gen_metrics_MappingRecord_Base, gen_metrics_MappingStatistic_Base, gen_metrics_Metric_Base, gen_metrics_MappingXLS_Mapping, gen_metrics_MetricSource_Base, gen_metrics_ValueDataKind_DataKind},
    metadata=None
)
