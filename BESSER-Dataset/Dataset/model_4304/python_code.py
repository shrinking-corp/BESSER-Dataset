...
class metrics_MappingRDBMS(Mapping):
    ...
    def __init__(self, dateFormat: str, dateTimeFormat: str, password: str, query: str, databaseType: str, timeFormat: str, user: str):
...
class metrics_MappingXLS(Mapping):
    ...
    def __init__(self, sheetNumber: str, filterPattern: str):
...
class metrics_Metric(Base):
    ...
    def __init__(self, description: str, measurementKind: str, measurementPoint: str, name: str, metrics_Metric: "metrics_Metric" = None, metrics_Metric15: set["metrics_Metric"] = None, metrics_Metric18: "metrics_Expression" = None, metrics_Metric20: "metrics_MetricSource" = None, metrics_Metric22: "metrics_Unit" = None, metrics_Metric35: "metrics_ValueDataKind" = None):
...
class metrics_MetricSource(Base):
    ...
    def __init__(self, filterPattern: str, metricLocation: str, name: str, metrics_MetricSource: "metrics_Metric" = None, metrics_MetricSource31: set["metrics_MappingStatistic"] = None, metrics_MetricSource28: "metrics_Mapping" = None):
        self.filterPattern = filterPattern
...
class metrics_Mapping(Base):
    ...
    def __init__(self, headerRow: str, intervalHint: str, firstDataRow: str, metrics_Mapping: set["metrics_MappingColumn"] = None, metrics_Mapping2: set["metrics_MappingColumn"] = None, metrics_Mapping29: "metrics_MetricSource" = None):
