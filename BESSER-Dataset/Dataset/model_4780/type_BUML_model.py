...
type_TypeGroup = Class(name="type_TypeGroup")
type_TypeElement = Class(name="type_TypeElement")
type_Relationship = Class(name="type_Relationship")
type_PrimitivesGroup = Class(name="type_PrimitivesGroup")
type_Primitive = Class(name="type_Primitive")
TypePointer = Class(name="TypePointer")
type_Operation = Class(name="type_Operation")
Secured = Class(name="Secured")
type_References = Class(name="type_References")
Relationship = Class(name="Relationship")
type_Generalization = Class(name="type_Generalization")
type_TypePointer = Class(name="type_TypePointer")
type_PackagePointer = Class(name="type_PackagePointer")
type_Assosiation = Class(name="type_Assosiation")
type_Link = Class(name="type_Link")
type_Attribute = Class(name="type_Attribute")
type_TypeReference = Class(name="type_TypeReference")
type_Parameter = Class(name="type_Parameter")
type_ReturnValue = Class(name="type_ReturnValue")
TypeElement = Class(name="TypeElement")
type_Type = Class(name="type_Type")
type_Enumerator = Class(name="type_Enumerator")
type_EnumAttribute = Class(name="type_EnumAttribute")
type_MethodPointer = Class(name="type_MethodPointer")
type_AttributePointer = Class(name="type_AttributePointer")
...
type_TypeGroup.attributes={type_TypeGroup_uid, type_TypeGroup_name}
...
type_TypeElement.attributes={type_TypeElement_uid, type_TypeElement_name}
...
type_Assosiation.attributes={type_Assosiation_internal, type_Assosiation_type, type_Assosiation_sourceOperation, type_Assosiation_targetOperation, type_Assosiation_containment}
...
type_Attribute.attributes={type_Attribute_uid, type_Attribute_pk, type_Attribute_name}
...
type_Parameter.attributes={type_Parameter_name, type_Parameter_order, type_Parameter_uid}
...
type_EnumAttribute.attributes={type_EnumAttribute_value, type_EnumAttribute_uid, type_EnumAttribute_name}
...
domain_model = DomainModel(
    name="type",
    types={Categorized, type_TypeGroup, type_TypeElement, type_Relationship, type_PrimitivesGroup, type_Primitive, TypePointer, type_Operation, Secured, type_References, Relationship, type_Generalization, type_TypePointer, type_PackagePointer, type_Assosiation, type_Link, type_Attribute, type_TypeReference, type_Parameter, type_ReturnValue, TypeElement, type_Type, type_Enumerator, type_EnumAttribute, type_MethodPointer, type_AttributePointer, RelationType, Containment},
    associations={source4, target7, types0, relationships1, primitives3, detailField20, typeRef10, packageRef12, links14, many2manyHelper15, masterField18, parameters23, returnValue24, attributes26, operations28, attributeRef34, values31, methodRef32},
    generalizations={gen_type_Relationship_Categorized, gen_type_Attribute_TypePointer, gen_type_Attribute_Categorized, gen_type_Operation_Secured, gen_type_References_Relationship, gen_type_Generalization_Relationship, gen_type_Assosiation_Relationship, gen_type_TypeReference_TypeElement, gen_type_TypeReference_TypePointer, gen_type_Parameter_TypePointer, gen_type_Operation_Categorized, gen_type_Primitive_TypeElement, gen_type_Type_TypeElement, gen_type_Type_Categorized, gen_type_ReturnValue_TypePointer, gen_type_Enumerator_TypeElement, gen_type_Enumerator_Categorized, gen_type_EnumAttribute_Categorized},
    metadata=None
)
