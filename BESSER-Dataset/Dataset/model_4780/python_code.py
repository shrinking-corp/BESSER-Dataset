...
class type_Link:
    ...
    def __init__(self, uid: str, type_Link21: "type_Attribute" = None, type_Link: "type_Assosiation" = None, type_Link19: "type_Attribute" = None):
        self.uid = uid
...
class TypePointer:
    ...
    pass
class type_TypeReference(TypePointer, TypeElement):
...
class type_Enumerator(Categorized, TypeElement):

    pass
class type_Attribute(TypePointer, Categorized):

    def __init__(self, uid: str, name: str, pk: bool, type_Attribute22: "type_Link" = None, type_Attribute: "type_Link" = None, type_Attribute27: "type_Type" = None, type_Attribute35: "type_AttributePointer" = None):
        self.uid = uid
        self.name = name
        self.pk = pk
...
class type_Type(Categorized, TypeElement):
