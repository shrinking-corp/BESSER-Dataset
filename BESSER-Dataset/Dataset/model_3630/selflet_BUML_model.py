...
# Classes
selflet_Actions = Class(name="selflet_Actions")
selflet_Action = Class(name="selflet_Action")
selflet_Abilities = Class(name="selflet_Abilities")
selflet_Ability = Class(name="selflet_Ability")
selflet_Methods = Class(name="selflet_Methods")
selflet_CPUUtilization = Class(name="selflet_CPUUtilization")
selflet_Empty = Class(name="selflet_Empty")
selflet_GeneralKnowledge = Class(name="selflet_GeneralKnowledge")
selflet_Active = Class(name="selflet_Active")
selflet_Behavior = Class(name="selflet_Behavior")
selflet_Service = Class(name="selflet_Service")
selflet_Conditions = Class(name="selflet_Conditions")
selflet_Condition = Class(name="selflet_Condition")
selflet_OfferMode = Class(name="selflet_OfferMode")
selflet_SelfLetProperty = Class(name="selflet_SelfLetProperty")
selflet_Input = Class(name="selflet_Input")
selflet_Parameter = Class(name="selflet_Parameter")
selflet_Method = Class(name="selflet_Method")
selflet_Rules = Class(name="selflet_Rules")
selflet_Rule = Class(name="selflet_Rule")
selflet_Selflet = Class(name="selflet_Selflet")
selflet_SelfletProperties = Class(name="selflet_SelfletProperties")
selflet_Output = Class(name="selflet_Output")
selflet_Reds = Class(name="selflet_Reds")
selflet_TypeKnowledge = Class(name="selflet_TypeKnowledge")
selflet_SelfletResources = Class(name="selflet_SelfletResources")
selflet_Services = Class(name="selflet_Services")
selflet_ElementaryBehavior = Class(name="selflet_ElementaryBehavior")
Behavior = Class(name="Behavior")
selflet_State = Class(name="selflet_State")
selflet_ComplexBehavior = Class(name="selflet_ComplexBehavior")
selflet_InitialState = Class(name="selflet_InitialState")
State = Class(name="State")
selflet_FinalState = Class(name="selflet_FinalState")
selflet_AbilityState = Class(name="selflet_AbilityState")
selflet_IntermediateState = Class(name="selflet_IntermediateState")
...
selflet_Behavior.attributes={selflet_Behavior_isDefaultBehavior, selflet_Behavior_fileName, selflet_Behavior_name, selflet_Behavior_elementaryBehaviorCost, selflet_Behavior_elementaryBehaviorCPUTime}
...
selflet_Service.attributes={selflet_Service_revenue, selflet_Service_name, selflet_Service_maxResponseTime, selflet_Service_active}
...
selflet_SelfLetProperty.attributes={selflet_SelfLetProperty_value, selflet_SelfLetProperty_name, selflet_SelfLetProperty_type}
...
selflet_Method.attributes={selflet_Method_name, selflet_Method_paramType}
...
selflet_SelfletProperties.attributes={selflet_SelfletProperties_enableCloudOptimizationPolicy, selflet_SelfletProperties_enableOptimizationPolicy, selflet_SelfletProperties_description, selflet_SelfletProperties_author, selflet_SelfletProperties_limePort}
...
selflet_Reds.attributes={selflet_Reds_port, selflet_Reds_ipAddress}
...
domain_model = DomainModel(
    name="selflet",
    types={selflet_Actions, selflet_Action, selflet_Abilities, selflet_Ability, selflet_Methods, selflet_CPUUtilization, selflet_Empty, selflet_GeneralKnowledge, selflet_Active, selflet_Behavior, selflet_Service, selflet_Conditions, selflet_Condition, selflet_OfferMode, selflet_SelfLetProperty, selflet_Input, selflet_Parameter, selflet_Method, selflet_Rules, selflet_Rule, selflet_Selflet, selflet_SelfletProperties, selflet_Output, selflet_Reds, selflet_TypeKnowledge, selflet_SelfletResources, selflet_Services, selflet_ElementaryBehavior, Behavior, selflet_State, selflet_ComplexBehavior, selflet_InitialState, State, selflet_FinalState, selflet_AbilityState, selflet_IntermediateState, Mode, Type},
    associations={action3, ability0, methods1, implements4, condition5, method8, selfLetProperty6, parameter7, rule12, parameter10, reds20, generalknowledge22, typeKnowledge25, selfletProperties13, selfletResources14, passive16, active18, services36, rules38, service41, abilities27, actions30, conditions33, selfLetProperty55, input44, output47, offermode50, implementations52, states58, states59, next62, do64, invoke66},
