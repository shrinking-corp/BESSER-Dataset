...
class selflet_Ability:
    ...
    def __init__(self, file: str, service: str, selflet_Ability: "selflet_Abilities" = None, selflet_Ability2: "selflet_Methods" = None):
        self.file = file
...
class selflet_SelfletProperties:
    ...
    def __init__(self, limePort: str, author: str, description: str, enableOptimizationPolicy: str, enableCloudOptimizationPolicy: str, selflet_SelfletProperties21: "selflet_Reds" = None, selflet_SelfletProperties23: "selflet_GeneralKnowledge" = None, selflet_SelfletProperties26: "selflet_TypeKnowledge" = None, selflet_SelfletProperties: "selflet_Selflet" = None, selflet_SelfletProperties17: "selflet_Empty" = None, selflet_SelfletProperties19: "selflet_Active" = None):
