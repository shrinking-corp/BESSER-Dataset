...
def test_arithmetics_import_has_importedNamespace():
    assert hasattr(arithmetics_Import, "importedNamespace")
    descriptor = None
    for klass in arithmetics_Import.__mro__:
...
@given(instance=arithmetics_Import_strategy)
def test_arithmetics_import_importedNamespace_setter(instance):
