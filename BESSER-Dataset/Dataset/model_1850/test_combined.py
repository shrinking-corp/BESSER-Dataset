...
def test_hyp_style_stylepointer_is_not_abstract():
    assert not inspect.isabstract(style_StylePointer)


def test_hyp_style_stylepointer_constructor_exists():
    assert callable(style_StylePointer.__init__)


def test_hyp_style_stylepointer_constructor_args():
    sig = inspect.signature(style_StylePointer.__init__)
    params = list(sig.parameters.keys())



def test_hyp_style_styleset_is_not_abstract():
    assert not inspect.isabstract(style_StyleSet)


def test_hyp_style_styleset_constructor_exists():
    assert callable(style_StyleSet.__init__)


def test_hyp_style_styleset_constructor_args():
...
def test_hyp_style_stylelibrary_is_not_abstract():
    assert not inspect.isabstract(style_StyleLibrary)


def test_hyp_style_stylelibrary_constructor_exists():
    assert callable(style_StyleLibrary.__init__)


def test_hyp_style_stylelibrary_constructor_args():
...
def test_hyp_style_styleset_uid_setter(instance):
...
@given(instance=style_StyleSet_strategy)
def test_hyp_style_styleset_name_setter(instance):
...
def test_hyp_style_stylelibrary_uid_setter(instance):
    original = instance.uid
    instance.uid = original
    assert instance.uid == original
...
@given(instance=style_StyleLibrary_strategy)
def test_hyp_style_stylelibrary_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
