...
Order_Status.attributes={Order_Status_Paid, Order_Status_Create, Order_Status_Deliveried}
...
Customer.attributes={Customer_Address, Customer_Contact, Customer_Name}
...
domain_model = DomainModel(
    name="_8b7c06ca_94ca_49dc_94cc_8b5aff4f08f3",
    ...
    associations={Admin_Password, Login_customer, Password_customer, Payment_customer, Order_Status_Order, Order_OrderDetails, Order____Payment, customer_Order_Details, customer_cart, Registration_customer, customer_Shipping, Customer_Order},
    generalizations={},
    metadata=None
)
