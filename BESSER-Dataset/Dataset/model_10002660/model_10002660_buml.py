...
MAAS_Actor = Class(name="MAAS_Actor")
uas_broker_Interface = Class(name="uas_broker_Interface")
Interface_Interface = Class(name="Interface_Interface")
MAAS2_Interface = Class(name="MAAS2_Interface")
Interface2_Interface = Class(name="Interface2_Interface")
MAAS_cockpit_SAC_OC_Interface = Class(name="MAAS_cockpit_SAC_OC_Interface")
...
# MAAS_Actor class attributes and methods

# uas_broker_Interface class attributes and methods

# Interface_Interface class attributes and methods

# MAAS2_Interface class attributes and methods

# Interface2_Interface class attributes and methods

# MAAS_cockpit_SAC_OC_Interface class attributes and methods
...
domain_model = DomainModel(
    name="cbe2ca60_facc_41ef_aa43_3f802f697329",
    types={ShoppingCartExample_ShoppingCart, ShoppingCartExample_Order, ShoppingCartExample_LineItem, ShoppingCartExample_Account, ShoppingCartExample_Customer, MAAS_Actor, uas_broker_Interface, Interface_Interface, MAAS2_Interface, Interface2_Interface, MAAS_cockpit_SAC_OC_Interface},
