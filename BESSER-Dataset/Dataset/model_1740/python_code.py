...
class model_Book:
    ...
    def __init__(self, title: str, tags: str, data: str, model_Book: "model_Library" = None, model_Book7: "model_Library" = None, model_Book10: "model_Location" = None, model_Book15: "model_MappedLibrary" = None, Book: "model_Person" = None, books: set["model_Person"] = None, model_Book18: "model_MappedLibrary" = None):
        self.title = title
        self.tags = tags
        self.data = data
