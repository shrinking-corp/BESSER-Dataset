...
model_Book.attributes={model_Book_title, model_Book_tags, model_Book_data}
...
domain_model = DomainModel(
    name="model",
    types={model_Location, model_MappedLibrary, model_Person, model_Book, model_Library},
    associations={books2, location3, latestBook5, featuredBook8, location11, rareBooks13, books0, authors1, regularBooks16},
    generalizations={},
    metadata=None
)
