...
class XYAElt:
    ...
    pass
class DatadiagramMLTextFormat_ArcTo(XYAElt):
...
class XYElt:
    ...
    pass
class DatadiagramMLTextFormat_XYAElt(XYElt):

    pass
class DatadiagramMLTextFormat_MoveTo(XYElt):

    pass
class DatadiagramMLTextFormat_LineTo(XYElt):
...
class PolylineTo:
    ...
    pass
class DatadiagramMLTextFormat_DelElt(ABC):
...
class DatadiagramMLTextFormat_IXElt(ABC):
...
class IXElt:
    ...
    pass
class DatadiagramMLTextFormat_NamedElt(ABC):
...
class UniqueIdElt:
    ...
    pass
class DatadiagramMLTextFormat_ShapeElt(ABC):

    pass
class ShapeElt:

    pass
class DatadiagramMLTextFormat_Geom(DelElt, ShapeElt, IXElt):

    pass
class ShapesCollection:

    pass
class DatadiagramMLTextFormat_Shape:
    ...
    def sse_shapeSheet(self, value):
        ...
        old_value = getattr(self, f"_DatadiagramMLTextFormat_Shape__sse_shapeSheet", None)
    ...
    def shapes(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_Shape__shapes", None)
        self.__shapes = value
...
class DatadiagramMLTextFormat_UniqueIdElt(ABC):
...
class DatadiagramMLTextFormat_IdentifiedElt(ABC):
...
class DatadiagramMLTextFormat_VBProjectData:
    ...
    def docVBProjectData(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_VBProjectData__docVBProjectData", None)
        self.__docVBProjectData = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "VisioDocument50"):
                opp_val = getattr(old_value, "VisioDocument50", None)
                if opp_val == self:
                    setattr(old_value, "VisioDocument50", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "VisioDocument50"):
                opp_val = getattr(value, "VisioDocument50", None)
                setattr(value, "VisioDocument50", self)
...
class NamedElt:
    ...
    pass
class DatadiagramMLTextFormat_DocumentSheet(PageSheet, NamedElt):

    pass
class Shape:

    pass
class DatadiagramMLTextFormat_PageSheet(PageElt, Shape, UniqueIdElt, MasterElt):

    pass
class StyleSheet:

    pass
class DatadiagramMLTextFormat_StyleSheetsCollection:

    pass
class DatadiagramMLTextFormat_EmailRoutingData:
    ...
    def docEmailRoutingData(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_EmailRoutingData__docEmailRoutingData", None)
        self.__docEmailRoutingData = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "VisioDocument52"):
                opp_val = getattr(old_value, "VisioDocument52", None)
                if opp_val == self:
                    setattr(old_value, "VisioDocument52", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "VisioDocument52"):
                opp_val = getattr(value, "VisioDocument52", None)
                setattr(value, "VisioDocument52", self)

class FontEntry:

    pass
class DatadiagramMLTextFormat_FontsTable:

    pass
class FaceName:

    pass
class DatadiagramMLTextFormat_FaceNamesTable:

    pass
class IdentifiedElt:

    pass
class DatadiagramMLTextFormat_StyleSheet(IdentifiedElt, NamedElt, Shape):

    pass
class DatadiagramMLTextFormat_FaceName(IdentifiedElt):
    ...
    def faceNameEntries(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_FaceName__faceNameEntries", None)
        self.__faceNameEntries = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "FaceNamesTable48"):
                opp_val = getattr(old_value, "FaceNamesTable48", None)
                if opp_val == self:
                    setattr(old_value, "FaceNamesTable48", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "FaceNamesTable48"):
                opp_val = getattr(value, "FaceNamesTable48", None)
                setattr(value, "FaceNamesTable48", self)

class CustomProperty:

    pass
class DatadiagramMLTextFormat_FontEntry(IdentifiedElt):
    ...
    def fontEntries(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_FontEntry__fontEntries", None)
        self.__fontEntries = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "FontsTable43"):
                opp_val = getattr(old_value, "FontsTable43", None)
                if opp_val == self:
                    setattr(old_value, "FontsTable43", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "FontsTable43"):
                opp_val = getattr(value, "FontsTable43", None)
                setattr(value, "FontsTable43", self)

class DatadiagramMLTextFormat_CustomPropertiesCollection:

    pass
class IXrequiredElt:

    pass
class DatadiagramMLTextFormat_ColorEntry(IXrequiredElt):
    ...
    def colorEntries(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_ColorEntry__colorEntries", None)
        self.__colorEntries = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "ColorsTable38"):
                opp_val = getattr(old_value, "ColorsTable38", None)
                if opp_val == self:
                    setattr(old_value, "ColorsTable38", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "ColorsTable38"):
                opp_val = getattr(value, "ColorsTable38", None)
                setattr(value, "ColorsTable38", self)

class ColorEntry:

    pass
class DatadiagramMLTextFormat_ColorsTable:

    pass
class DatadiagramMLTextFormat_CustomProperty:
    ...
    def cps_customProps(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_CustomProperty__cps_customProps", None)
...
class VisioDocument:
    ...
    pass
class DatadiagramMLTextFormat_DocumentPropertiesCollection:

    def __init__(self, title: str, subject: str, company: str, category: str, keywords: str, description: str, hyperlinkBase_href: str, alternateNames: str, template: str, buildNumberCreated: str, buildNumberEdited: str, creator: str, manager: str, docProps: "VisioDocument" = None, cps_docProp: "CustomPropertiesCollection" = None, DatadiagramMLTextFormat_DocumentPropertiesCollection: "DateTimeType" = None, DatadiagramMLTextFormat_DocumentPropertiesCollection21: "DateTimeType" = None, DatadiagramMLTextFormat_DocumentPropertiesCollection24: "DateTimeType" = None, DatadiagramMLTextFormat_DocumentPropertiesCollection27: "DateTimeType" = None):
        self.title = title
        ...
        self.DatadiagramMLTextFormat_DocumentPropertiesCollection = DatadiagramMLTextFormat_DocumentPropertiesCollection
        self.DatadiagramMLTextFormat_DocumentPropertiesCollection21 = DatadiagramMLTextFormat_DocumentPropertiesCollection21
        self.DatadiagramMLTextFormat_DocumentPropertiesCollection24 = DatadiagramMLTextFormat_DocumentPropertiesCollection24
        self.DatadiagramMLTextFormat_DocumentPropertiesCollection27 = DatadiagramMLTextFormat_DocumentPropertiesCollection27
    ...
    @property
    def DatadiagramMLTextFormat_DocumentPropertiesCollection27(self):
        return self.__DatadiagramMLTextFormat_DocumentPropertiesCollection27

    @DatadiagramMLTextFormat_DocumentPropertiesCollection27.setter
    def DatadiagramMLTextFormat_DocumentPropertiesCollection27(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_DocumentPropertiesCollection__DatadiagramMLTextFormat_DocumentPropertiesCollection27", None)
        self.__DatadiagramMLTextFormat_DocumentPropertiesCollection27 = value
    ...
    @property
    def DatadiagramMLTextFormat_DocumentPropertiesCollection24(self):
        return self.__DatadiagramMLTextFormat_DocumentPropertiesCollection24

    @DatadiagramMLTextFormat_DocumentPropertiesCollection24.setter
    def DatadiagramMLTextFormat_DocumentPropertiesCollection24(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_DocumentPropertiesCollection__DatadiagramMLTextFormat_DocumentPropertiesCollection24", None)
        self.__DatadiagramMLTextFormat_DocumentPropertiesCollection24 = value
    ...
    @property
    def DatadiagramMLTextFormat_DocumentPropertiesCollection21(self):
        return self.__DatadiagramMLTextFormat_DocumentPropertiesCollection21

    @DatadiagramMLTextFormat_DocumentPropertiesCollection21.setter
    def DatadiagramMLTextFormat_DocumentPropertiesCollection21(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_DocumentPropertiesCollection__DatadiagramMLTextFormat_DocumentPropertiesCollection21", None)
        self.__DatadiagramMLTextFormat_DocumentPropertiesCollection21 = value
    ...
    @property
    def DatadiagramMLTextFormat_DocumentPropertiesCollection(self):
        return self.__DatadiagramMLTextFormat_DocumentPropertiesCollection

    @DatadiagramMLTextFormat_DocumentPropertiesCollection.setter
    def DatadiagramMLTextFormat_DocumentPropertiesCollection(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_DocumentPropertiesCollection__DatadiagramMLTextFormat_DocumentPropertiesCollection", None)
        self.__DatadiagramMLTextFormat_DocumentPropertiesCollection = value
    ...
    def cps_docProp(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_DocumentPropertiesCollection__cps_docProp", None)
    ...
    def docProps(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_DocumentPropertiesCollection__docProps", None)
...
class DocumentSheet:
    ...
    pass
class DatadiagramMLTextFormat_DateTimeType:
...
class DocumentPropertiesCollection:
    ...
    pass
class DatadiagramMLTextFormat_VisioDocument:

    def __init__(self, start: str, key: str, metric: str, buildnum: str, version: str, docLangId: str, dps_visioDocument: "DocumentPropertiesCollection" = None, dss_visioDocument: "DocumentSettingsElt" = None, sss_visioDocument: "StyleSheetsCollection" = None, ds_visioDocument: "DocumentSheet" = None, ms_visioDocument: "MastersCollection" = None, ps_visioDocument10: "PagesCollection" = None, ws_visioDocument: "WindowsInfo" = None, el_visioDocument: "EventList" = None, ef_visioDocument: "HeaderFooter" = None, vpd_visioDocument: "VBProjectData" = None, erd_visioDocument: "EmailRoutingData" = None, sx_visioDocument: set["SolutionXML"] = None, cs_visioDocument: "ColorsTable" = None, ps_visioDocument: "PrintSetup" = None, fs_visioDocument: "FontsTable" = None, fns_visioDocument: "FaceNamesTable" = None):
        self.start = start
        self.key = key
        self.metric = metric
    ...
    def fs_visioDocument(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_VisioDocument__fs_visioDocument", None)
    ...
    def sss_visioDocument(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_VisioDocument__sss_visioDocument", None)
    ...
    def cs_visioDocument(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_VisioDocument__cs_visioDocument", None)
    ...
    def vpd_visioDocument(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_VisioDocument__vpd_visioDocument", None)
    ...
    def dps_visioDocument(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_VisioDocument__dps_visioDocument", None)
    ...
    def ps_visioDocument10(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_VisioDocument__ps_visioDocument10", None)
    ...
    def fns_visioDocument(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_VisioDocument__fns_visioDocument", None)
    ...
    def erd_visioDocument(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_VisioDocument__erd_visioDocument", None)
    ...
    def ms_visioDocument(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_VisioDocument__ms_visioDocument", None)
    ...
    def ws_visioDocument(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_VisioDocument__ws_visioDocument", None)
    ...
    def ds_visioDocument(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_VisioDocument__ds_visioDocument", None)
    ...
    def el_visioDocument(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_VisioDocument__el_visioDocument", None)
    ...
    def ps_visioDocument(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_VisioDocument__ps_visioDocument", None)
    ...
    def ef_visioDocument(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_VisioDocument__ef_visioDocument", None)
    ...
    def sx_visioDocument(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_VisioDocument__sx_visioDocument", None)
    ...
    def dss_visioDocument(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_VisioDocument__dss_visioDocument", None)
...
class DatadiagramMLTextFormat_CellType:
...
class DatadiagramMLTextFormat_SolutionXML:

    pass
class DatadiagramMLTextFormat_HeaderFooter:

    pass
class DatadiagramMLTextFormat_EventList:

    pass
class DatadiagramMLTextFormat_WindowsInfo:

    pass
class DatadiagramMLTextFormat_DocumentSettingsElt:

    pass
class DatadiagramMLTextFormat_PageElt(ABC):

    pass
class DatadiagramMLTextFormat_Page(IdentifiedElt, NamedElt):
    ...
    def pe_page(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_Page__pe_page", None)
    ...
    def pages(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_Page__pages", None)
        self.__pages = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "PagesCollection266"):
                opp_val = getattr(old_value, "PagesCollection266", None)
                if opp_val == self:
                    setattr(old_value, "PagesCollection266", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "PagesCollection266"):
                opp_val = getattr(value, "PagesCollection266", None)
                setattr(value, "PagesCollection266", self)

class DatadiagramMLTextFormat_PrintSetup:

    pass
class DatadiagramMLTextFormat_PagesCollection:

    pass
class DatadiagramMLTextFormat_MasterElt(ABC):

    pass
class ConnectsCollection:

    pass
class DatadiagramMLTextFormat_Connect:
    ...
    def connections(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_Connect__connections", None)
...
class Connect:
    ...
    pass
class DatadiagramMLTextFormat_ConnectsCollection(PageElt, MasterElt):

    pass
class Page:

    pass
class DatadiagramMLTextFormat_ShapesCollection(PageElt, MasterElt):

    pass
class DatadiagramMLTextFormat_Master(IdentifiedElt, NamedElt, UniqueIdElt):
    ...
    def me_master(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_Master__me_master", None)
    ...
    def masters(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_Master__masters", None)
        self.__masters = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "MastersCollection254"):
                opp_val = getattr(old_value, "MastersCollection254", None)
                if opp_val == self:
                    setattr(old_value, "MastersCollection254", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "MastersCollection254"):
                opp_val = getattr(value, "MastersCollection254", None)
                setattr(value, "MastersCollection254", self)

class DatadiagramMLTextFormat_Icon(MasterElt):

    def __init__(self, value: str, icons: "MasterShortCut" = None, MasterElt: "DatadiagramMLTextFormat_Master" = None):
        self.value = value
        self.icons = icons
    ...
    def icons(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_Icon__icons", None)
        self.__icons = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "MasterShortCut252"):
                opp_val = getattr(old_value, "MasterShortCut252", None)
                if opp_val == self:
                    setattr(old_value, "MasterShortCut252", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "MasterShortCut252"):
                opp_val = getattr(value, "MasterShortCut252", None)
                setattr(value, "MasterShortCut252", self)

class Icon:

    pass
class DatadiagramMLTextFormat_MasterShortCut(NamedElt, IdentifiedElt):

    def __init__(self, shortcutHelp: str, iconSize: str, patternFlags: str, prompt: str, shortcutURL: str, alignName: str, masterShortCuts: "MastersCollection" = None, i_masterShortCut: set["Icon"] = None):
    ...
    def i_masterShortCut(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_MasterShortCut__i_masterShortCut", None)
    ...
    def masterShortCuts(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DatadiagramMLTextFormat_MasterShortCut__masterShortCuts", None)
        self.__masterShortCuts = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "MastersCollection249"):
                opp_val = getattr(old_value, "MastersCollection249", None)
                if opp_val == self:
                    setattr(old_value, "MastersCollection249", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "MastersCollection249"):
                opp_val = getattr(value, "MastersCollection249", None)
                setattr(value, "MastersCollection249", self)
...
class Master:
    ...
    pass
class DatadiagramMLTextFormat_MastersCollection:

    pass
class DatadiagramMLTextFormat_Field(DelElt, ShapeElt, IXElt):

    pass
class TabsCollection:

    pass
class DatadiagramMLTextFormat_Tab(IXElt):

    pass
class Tab:

    pass
class DatadiagramMLTextFormat_TabsCollection(DelElt, ShapeElt, IXElt):

    pass
class DatadiagramMLTextFormat_Para(DelElt, ShapeElt, IXElt):

    pass
class DatadiagramMLTextFormat_IXrequiredElt(ABC):
...
class Text:
    ...
    pass
class DatadiagramMLTextFormat_TextElt(ABC):

    pass
class DatadiagramMLTextFormat_Char(DelElt, ShapeElt, IXElt):

    pass
class XYABCDElt:

    pass
class DatadiagramMLTextFormat_EllipticalArcTo(XYABCDElt):

    pass
class DatadiagramMLTextFormat_Ellipse(XYABCDElt):

    pass
class TextElt:

    pass
class DatadiagramMLTextFormat_StringElt(TextElt):

    def __init__(self, value: str, TextElt: "DatadiagramMLTextFormat_Text" = None):
        self.value = value
...
class DatadiagramMLTextFormat_Cp(IXrequiredElt, TextElt):

    pass
class DatadiagramMLTextFormat_Pp(IXrequiredElt, TextElt):

    pass
class DatadiagramMLTextFormat_Fld(IXrequiredElt, TextElt):

    pass
class DatadiagramMLTextFormat_Tp(IXrequiredElt, TextElt):

    pass
class DatadiagramMLTextFormat_Text(ShapeElt):

    pass
class XYABCDEElt:

    pass
class DatadiagramMLTextFormat_NURBSTo(XYABCDEElt):

    pass
class DatadiagramMLTextFormat_XYABCDEElt(XYABCDElt):

    pass
class DatadiagramMLTextFormat_SplineStart(XYABCDElt):

    pass
class DatadiagramMLTextFormat_PolylineTo(XYAElt):

    pass
class DatadiagramMLTextFormat_SplineKnot(XYAElt):

    pass
class XYABElt:

    pass
class DatadiagramMLTextFormat_XYABCDElt(XYABElt):

    pass
class DatadiagramMLTextFormat_InfiniteLine(XYABElt):

    pass
class DatadiagramMLTextFormat_XYABElt(XYAElt):

    pass
class DatadiagramMLTextFormat_XYElt(DelElt, IXElt):
