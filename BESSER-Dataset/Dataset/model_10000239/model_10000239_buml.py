...
customer.attributes={customer_email_id, customer_name, customer_address, customer_product_id}
...
domain_model = DomainModel(
    name="_1e8de018_4cb4_4614_9c11_2610ef2df9d2",
    types={check_status, logout, D_B_details, login, Customer, MonitorComplaint, RegisterComplaint, Administrator, UpdateStatus, Logout, CheckStatus, DbDetails, Login, login_UseCase, client_Actor, register_complaint_UseCase, view_status_UseCase, logout_UseCase, administrator_Actor, create_user_UseCase, search_user_UseCase, technical_team_Actor, login_technical_UseCase, new_complaint_details_UseCase, find_out_fault_UseCase, send_to_admin_UseCase, logout_technician_UseCase, customer, monitor_complaint, administrator, update_status, register_complaint},
