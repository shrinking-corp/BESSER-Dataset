...
class vM_PairAttributeValue:
    ...
    def __init__(self, value: str, vM_PairAttributeValue134: "vM_Abstract_ATT_ID" = None, vM_PairAttributeValue: "vM_TableBasedValuationByFeatureAndClone" = None, vM_PairAttributeValue132: "vM_TableBasedValuationByFeature" = None):
        self.value = value
...
class vM_Configuration:
    ...
    def __init__(self, name: str, vM_Configuration100: set["vM_BooleanValuation"] = None, vM_Configuration: "vM_Configurations" = None, vM_Configuration102: set["vM_ExtendedValuation"] = None):
        self.name = name
...
class vM_AttHead:
    ...
    def __init__(self, forAllFeatures: bool, vM_AttHead155: "vM_Abstract_ATT_ID" = None, vM_AttHead: "vM_PrimitiveExpression" = None, vM_AttHead108: "vM_BasicAttrValuation" = None, vM_AttHead151: "vM_Feature" = None):
...
class vM_Constraint:
    ...
    def __init__(self, name: str, not_: bool, vM_Constraint: "vM_Constraints" = None, vM_Constraint66: "vM_ComplexExpression" = None):
        self.name = name
        self.not_ = not_
...
class vM_Abstract_ATT_ID:
    ...
    def __init__(self, name: str, vM_Abstract_ATT_ID154: "vM_AttHead" = None, vM_Abstract_ATT_ID: "vM_AttributeDescription" = None, vM_Abstract_ATT_ID75: "vM_PrimitiveExpression" = None, vM_Abstract_ATT_ID135: "vM_PairAttributeValue" = None):
        self.name = name
...
class vM_FeatureDescription:
    ...
    def __init__(self, description: str, vM_FeatureDescription57: "vM_Feature" = None, vM_FeatureDescription: "vM_Descriptions" = None):
        self.description = description
...
class vM_MetaDataDeclaration(VmBlock):
    ...
    def __init__(self, publication: str, date: str, name: str, description: str, author: str, organization: str, vM_MetaDataDeclaration: "vM_Version" = None, vM_MetaDataDeclaration5: "vM_Email" = None):
