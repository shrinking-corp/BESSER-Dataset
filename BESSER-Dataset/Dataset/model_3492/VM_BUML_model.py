...
# Classes
vM_Model = Class(name="vM_Model")
vM_VmBlock = Class(name="vM_VmBlock")
vM_Relationships = Class(name="vM_Relationships")
vM_FeatureHierarchy = Class(name="vM_FeatureHierarchy")
FeatureDefinition = Class(name="FeatureDefinition")
vM_Feature = Class(name="vM_Feature")
vM_FeatureDefinition = Class(name="vM_FeatureDefinition")
vM_PackageDeclaration = Class(name="vM_PackageDeclaration")
VmBlock = Class(name="VmBlock")
vM_ImportDeclaration = Class(name="vM_ImportDeclaration")
vM_MetaDataDeclaration = Class(name="vM_MetaDataDeclaration")
vM_Version = Class(name="vM_Version")
vM_Email = Class(name="vM_Email")
vM_RealAttrDefBounded = Class(name="vM_RealAttrDefBounded")
RealAttrDef = Class(name="RealAttrDef")
vM_RealAttrDefComplement = Class(name="vM_RealAttrDefComplement")
vM_BasicAttrDef = Class(name="vM_BasicAttrDef")
vM_FeaturesGroup = Class(name="vM_FeaturesGroup")
vM_EnumAttrDef = Class(name="vM_EnumAttrDef")
vM_BooleanAttrDef = Class(name="vM_BooleanAttrDef")
vM_Xorgroup = Class(name="vM_Xorgroup")
BasicAttrDef = Class(name="BasicAttrDef")
FeaturesGroup = Class(name="FeaturesGroup")
vM_Boolean_ATT_ID = Class(name="vM_Boolean_ATT_ID")
vM_Orgroup = Class(name="vM_Orgroup")
vM_CardinalityBased = Class(name="vM_CardinalityBased")
vM_BoolDefaultDef = Class(name="vM_BoolDefaultDef")
vM_StringAttrDef = Class(name="vM_StringAttrDef")
vM_Attributes = Class(name="vM_Attributes")
vM_String_ATT_ID = Class(name="vM_String_ATT_ID")
vM_AttrDef = Class(name="vM_AttrDef")
vM_StringDefaultDef = Class(name="vM_StringDefaultDef")
vM_BasicAttrValuation = Class(name="vM_BasicAttrValuation")
vM_IntegerAttrDef = Class(name="vM_IntegerAttrDef")
vM_Integer_ATT_ID = Class(name="vM_Integer_ATT_ID")
vM_IntegerDefaultDef = Class(name="vM_IntegerDefaultDef")
vM_IntegerAttrDefBounded = Class(name="vM_IntegerAttrDefBounded")
IntegerAttrDef = Class(name="IntegerAttrDef")
vM_IntegerAttrDefComplement = Class(name="vM_IntegerAttrDefComplement")
vM_IntegerDeltaDef = Class(name="vM_IntegerDeltaDef")
vM_IntegerAttrDefUnbounded = Class(name="vM_IntegerAttrDefUnbounded")
vM_RealAttrDef = Class(name="vM_RealAttrDef")
vM_Real_ATT_ID = Class(name="vM_Real_ATT_ID")
vM_RealDefaultDef = Class(name="vM_RealDefaultDef")
vM_RealDeltaDef = Class(name="vM_RealDeltaDef")
vM_RealAttrDefUnbounded = Class(name="vM_RealAttrDefUnbounded")
vM_EnumStringDef = Class(name="vM_EnumStringDef")
EnumAttrDef = Class(name="EnumAttrDef")
vM_Enum_String_ATT_ID = Class(name="vM_Enum_String_ATT_ID")
vM_EnumIntegerDef = Class(name="vM_EnumIntegerDef")
vM_Enum_Integer_ATT_ID = Class(name="vM_Enum_Integer_ATT_ID")
vM_EnumRealDef = Class(name="vM_EnumRealDef")
vM_Enum_Real_ATT_ID = Class(name="vM_Enum_Real_ATT_ID")
vM_Descriptions = Class(name="vM_Descriptions")
vM_FeatureDescription = Class(name="vM_FeatureDescription")
vM_AttributeDescription = Class(name="vM_AttributeDescription")
vM_BooleanExpression = Class(name="vM_BooleanExpression")
vM_Abstract_ATT_ID = Class(name="vM_Abstract_ATT_ID")
vM_Constraints = Class(name="vM_Constraints")
vM_Constraint = Class(name="vM_Constraint")
vM_ComplexExpression = Class(name="vM_ComplexExpression")
vM_Expression = Class(name="vM_Expression")
ComplexExpression = Class(name="ComplexExpression")
vM_SpecialExpression = Class(name="vM_SpecialExpression")
Expression = Class(name="Expression")
vM_StringExpression = Class(name="vM_StringExpression")
vM_PrimitiveExpression = Class(name="vM_PrimitiveExpression")
vM_AttHead = Class(name="vM_AttHead")
vM_BooleanValuation = Class(name="vM_BooleanValuation")
vM_ExtendedValuation = Class(name="vM_ExtendedValuation")
vM_BooleanExpression_List = Class(name="vM_BooleanExpression_List")
vM_BrackedExpression = Class(name="vM_BrackedExpression")
vM_NumericExpression = Class(name="vM_NumericExpression")
vM_NumericExpression_List = Class(name="vM_NumericExpression_List")
vM_Objectives = Class(name="vM_Objectives")
vM_Objective = Class(name="vM_Objective")
vM_ObjectiveExpression = Class(name="vM_ObjectiveExpression")
vM_Configurations = Class(name="vM_Configurations")
vM_Configuration = Class(name="vM_Configuration")
ExtendedValuation = Class(name="ExtendedValuation")
vM_RealAttrValuation = Class(name="vM_RealAttrValuation")
BasicAttrValuation = Class(name="BasicAttrValuation")
vM_IntegerAttrValuation = Class(name="vM_IntegerAttrValuation")
vM_BooleanAttrValuation = Class(name="vM_BooleanAttrValuation")
vM_StringAttrValuation = Class(name="vM_StringAttrValuation")
vM_AdvancedAttrValuation = Class(name="vM_AdvancedAttrValuation")
vM_TableBasedValuationByFeature = Class(name="vM_TableBasedValuationByFeature")
vM_TableBasedValuationByAttribute = Class(name="vM_TableBasedValuationByAttribute")
vM_TableBasedValuationByFeatureAndClone = Class(name="vM_TableBasedValuationByFeatureAndClone")
vM_PairAttributeValue = Class(name="vM_PairAttributeValue")
vM_TableBasedValuationByAttributeForInteger = Class(name="vM_TableBasedValuationByAttributeForInteger")
TableBasedValuationByAttribute = Class(name="TableBasedValuationByAttribute")
vM_PairFeatureInteger = Class(name="vM_PairFeatureInteger")
vM_TableBasedValuationByAttributeForReal = Class(name="vM_TableBasedValuationByAttributeForReal")
vM_PairFeatureReal = Class(name="vM_PairFeatureReal")
Abstract_ATT_ID = Class(name="Abstract_ATT_ID")
vM_If = Class(name="vM_If")
vM_LeftImplication = Class(name="vM_LeftImplication")
vM_RightImplication = Class(name="vM_RightImplication")
vM_BiImplication = Class(name="vM_BiImplication")
vM_Or = Class(name="vM_Or")
vM_And = Class(name="vM_And")
vM_Equality = Class(name="vM_Equality")
vM_Inequality = Class(name="vM_Inequality")
vM_Less = Class(name="vM_Less")
vM_Lessequal = Class(name="vM_Lessequal")
vM_Greater = Class(name="vM_Greater")
vM_Greaterequal = Class(name="vM_Greaterequal")
vM_Multiplication = Class(name="vM_Multiplication")
vM_Plus = Class(name="vM_Plus")
vM_Division = Class(name="vM_Division")
vM_Minus = Class(name="vM_Minus")
vM_Excludes = Class(name="vM_Excludes")
vM_Requires = Class(name="vM_Requires")
...
vM_Feature.attributes={vM_Feature_name, vM_Feature_runTime, vM_Feature_notTranslatable, vM_Feature_optional, vM_Feature_notDecidable, vM_Feature_min, vM_Feature_max}
...
vM_MetaDataDeclaration.attributes={vM_MetaDataDeclaration_description, vM_MetaDataDeclaration_publication, vM_MetaDataDeclaration_organization, vM_MetaDataDeclaration_name, vM_MetaDataDeclaration_author, vM_MetaDataDeclaration_date}
...
vM_Email.attributes={vM_Email_domain, vM_Email_username}
...
vM_CardinalityBased.attributes={vM_CardinalityBased_min, vM_CardinalityBased_max, vM_CardinalityBased_all}
...
vM_Constraint_not_: Property = Property(name="not_", type=BooleanType)
vM_Constraint.attributes={vM_Constraint_name, vM_Constraint_not_}
...
domain_model = DomainModel(
    name="vM",
    types={vM_Model, vM_VmBlock, vM_Relationships, vM_FeatureHierarchy, FeatureDefinition, vM_Feature, vM_FeatureDefinition, vM_PackageDeclaration, VmBlock, vM_ImportDeclaration, vM_MetaDataDeclaration, vM_Version, vM_Email, vM_RealAttrDefBounded, RealAttrDef, vM_RealAttrDefComplement, vM_BasicAttrDef, vM_FeaturesGroup, vM_EnumAttrDef, vM_BooleanAttrDef, vM_Xorgroup, BasicAttrDef, FeaturesGroup, vM_Boolean_ATT_ID, vM_Orgroup, vM_CardinalityBased, vM_BoolDefaultDef, vM_StringAttrDef, vM_Attributes, vM_String_ATT_ID, vM_AttrDef, vM_StringDefaultDef, vM_BasicAttrValuation, vM_IntegerAttrDef, vM_Integer_ATT_ID, vM_IntegerDefaultDef, vM_IntegerAttrDefBounded, IntegerAttrDef, vM_IntegerAttrDefComplement, vM_IntegerDeltaDef, vM_IntegerAttrDefUnbounded, vM_RealAttrDef, vM_Real_ATT_ID, vM_RealDefaultDef, vM_RealDeltaDef, vM_RealAttrDefUnbounded, vM_EnumStringDef, EnumAttrDef, vM_Enum_String_ATT_ID, vM_EnumIntegerDef, vM_Enum_Integer_ATT_ID, vM_EnumRealDef, vM_Enum_Real_ATT_ID, vM_Descriptions, vM_FeatureDescription, vM_AttributeDescription, vM_BooleanExpression, vM_Abstract_ATT_ID, vM_Constraints, vM_Constraint, vM_ComplexExpression, vM_Expression, ComplexExpression, vM_SpecialExpression, Expression, vM_StringExpression, vM_PrimitiveExpression, vM_AttHead, vM_BooleanValuation, vM_ExtendedValuation, vM_BooleanExpression_List, vM_BrackedExpression, vM_NumericExpression, vM_NumericExpression_List, vM_Objectives, vM_Objective, vM_ObjectiveExpression, vM_Configurations, vM_Configuration, ExtendedValuation, vM_RealAttrValuation, BasicAttrValuation, vM_IntegerAttrValuation, vM_BooleanAttrValuation, vM_StringAttrValuation, vM_AdvancedAttrValuation, vM_TableBasedValuationByFeature, vM_TableBasedValuationByAttribute, vM_TableBasedValuationByFeatureAndClone, vM_PairAttributeValue, vM_TableBasedValuationByAttributeForInteger, TableBasedValuationByAttribute, vM_PairFeatureInteger, vM_TableBasedValuationByAttributeForReal, vM_PairFeatureReal, Abstract_ATT_ID, vM_If, vM_LeftImplication, vM_RightImplication, vM_BiImplication, vM_Or, vM_And, vM_Equality, vM_Inequality, vM_Less, vM_Lessequal, vM_Greater, vM_Greaterequal, vM_Multiplication, vM_Plus, vM_Division, vM_Minus, vM_Excludes, vM_Requires},
    associations={blocks0, root6, parent7, children9, blocks1, version3, email4, basicAttrDef16, enumAttrDef18, groupedFeatures11, name20, default21, name23, attrDefs13, default24, attrValuations14, name26, default27, complements29, complement30, delta33, name35, default36, refFeat56, complement38, delta39, name41, default42, name45, default46, name49, default50, featuresDescriptions53, attributesDescriptions54, refFeat59, refAtt62, constraints64, expression65, expression67, featureID69, head71, refAtt73, booleanValuation99, expression77, expression_list78, expression80, expression83, expression_list84, ex86, ex89, objectives92, expression93, expression95, configurations98, refAtt133, extendedValuation101, feature103, head106, refAtt109, refAtt111, refAtt113, refAtt115, attVsVal117, featVsVal118, attVsValForMultiFeature120, refFeature122, pairs125, refFeature127, pairs130, refAtt136, pairs138, refFeat140, refAtt143, pairs145, refFeat147, left166, right168, ownedFeature150, head153, left156, right158, left161, right163, left201, right203, left171, right173, left176, right178, left181, right183, left186, right188, left191, right193, left196, right198, left206, right208, right223, left211, right213, left226, left216, right228, right218, left221, left231, right233, left236, right238, left240, right242},
    generalizations={gen_vM_Relationships_VmBlock, gen_vM_FeatureHierarchy_FeatureDefinition, gen_vM_Feature_FeatureDefinition, gen_vM_PackageDeclaration_VmBlock, gen_vM_ImportDeclaration_VmBlock, gen_vM_MetaDataDeclaration_VmBlock, gen_vM_RealAttrDefBounded_RealAttrDef, gen_vM_FeaturesGroup_FeatureDefinition, gen_vM_BooleanAttrDef_BasicAttrDef, gen_vM_Xorgroup_FeaturesGroup, gen_vM_Orgroup_FeaturesGroup, gen_vM_CardinalityBased_FeaturesGroup, gen_vM_StringAttrDef_BasicAttrDef, gen_vM_Attributes_VmBlock, gen_vM_IntegerAttrDef_BasicAttrDef, gen_vM_IntegerAttrDefBounded_IntegerAttrDef, gen_vM_IntegerAttrDefUnbounded_IntegerAttrDef, gen_vM_RealAttrDef_BasicAttrDef, gen_vM_RealAttrDefUnbounded_RealAttrDef, gen_vM_EnumStringDef_EnumAttrDef, gen_vM_EnumIntegerDef_EnumAttrDef, gen_vM_EnumRealDef_EnumAttrDef, gen_vM_Descriptions_VmBlock, gen_vM_BooleanExpression_Expression, gen_vM_Constraints_VmBlock, gen_vM_Expression_ComplexExpression, gen_vM_SpecialExpression_Expression, gen_vM_StringExpression_Expression, gen_vM_PrimitiveExpression_Expression, gen_vM_BrackedExpression_Expression, gen_vM_NumericExpression_Expression, gen_vM_Objectives_VmBlock, gen_vM_Configurations_VmBlock, gen_vM_BasicAttrValuation_ExtendedValuation, gen_vM_RealAttrValuation_BasicAttrValuation, gen_vM_IntegerAttrValuation_BasicAttrValuation, gen_vM_BooleanAttrValuation_BasicAttrValuation, gen_vM_StringAttrValuation_BasicAttrValuation, gen_vM_AdvancedAttrValuation_ExtendedValuation, gen_vM_Enum_Integer_ATT_ID_Abstract_ATT_ID, gen_vM_Enum_Real_ATT_ID_Abstract_ATT_ID, gen_vM_TableBasedValuationByAttributeForInteger_TableBasedValuationByAttribute, gen_vM_TableBasedValuationByAttributeForReal_TableBasedValuationByAttribute, gen_vM_Boolean_ATT_ID_Abstract_ATT_ID, gen_vM_String_ATT_ID_Abstract_ATT_ID, gen_vM_Integer_ATT_ID_Abstract_ATT_ID, gen_vM_Real_ATT_ID_Abstract_ATT_ID, gen_vM_Enum_String_ATT_ID_Abstract_ATT_ID, gen_vM_If_ComplexExpression, gen_vM_LeftImplication_ComplexExpression, gen_vM_RightImplication_ComplexExpression, gen_vM_BiImplication_ComplexExpression, gen_vM_Or_ComplexExpression, gen_vM_And_ComplexExpression, gen_vM_Equality_ComplexExpression, gen_vM_Inequality_ComplexExpression, gen_vM_Less_ComplexExpression, gen_vM_Lessequal_ComplexExpression, gen_vM_Greater_ComplexExpression, gen_vM_Greaterequal_ComplexExpression, gen_vM_Multiplication_ComplexExpression, gen_vM_Plus_ComplexExpression, gen_vM_Division_ComplexExpression, gen_vM_Minus_ComplexExpression, gen_vM_Excludes_ComplexExpression, gen_vM_Requires_ComplexExpression},
    metadata=None
)
