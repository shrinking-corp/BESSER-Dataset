...
B_Any = Class(name="B_Any")
B_SET = Class(name="B_SET")
B_Operation = Class(name="B_Operation")
B_Predicate = Class(name="B_Predicate")
B_Variable = Class(name="B_Variable")
B_Action = Class(name="B_Action")
B_Expression = Class(name="B_Expression")
B_VariableList = Class(name="B_VariableList")
...
domain_model = DomainModel(
    name="B",
    types={B_Machine, B_Any, B_SET, B_Operation, B_Predicate, B_Variable, B_Action, B_Expression, B_VariableList, Expression, B_If, B_Skip, B_Begin},
    associations={refines1, sets2, operations4, invariants6, variables8, initialisations10, statements12, inputs14, outputs16, preconditions19, preceeds23, type25, variables28, first31, variables34, var_conditions36, statements39, true_statements42, false_statements44, conditions47, statements50},
    generalizations={gen_B_Any_Expression, gen_B_Predicate_Expression, gen_B_Action_Expression, gen_B_If_Expression, gen_B_Skip_Expression, gen_B_Begin_Expression},
    metadata=None
)
