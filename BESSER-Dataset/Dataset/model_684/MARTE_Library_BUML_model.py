...
# Classes
MARTE_Library_GRM_BasicTypes_SchedParameters = Class(name="MARTE_Library_GRM_BasicTypes_SchedParameters")
EDF_Parameters = Class(name="EDF_Parameters")
FixedPriorityParameters = Class(name="FixedPriorityParameters")
MARTE_Library_GRM_BasicTypes_EDF_Parameters = Class(name="MARTE_Library_GRM_BasicTypes_EDF_Parameters")
...
MARTE_Library_GRM_BasicTypes_FixedPriorityParameters = Class(name="MARTE_Library_GRM_BasicTypes_FixedPriorityParameters")
NFP_Integer = Class(name="NFP_Integer")
MARTE_Library_GRM_BasicTypes_PoolingParameters = Class(name="MARTE_Library_GRM_BasicTypes_PoolingParameters")
MARTE_Library_GRM_BasicTypes_PeriodicServerParameters = Class(name="MARTE_Library_GRM_BasicTypes_PeriodicServerParameters")
MARTE_Library_BasicNFP_Types_NFP_Frequency = Class(name="MARTE_Library_BasicNFP_Types_NFP_Frequency")
NFP_Real = Class(name="NFP_Real")
MARTE_Library_BasicNFP_Types_NFP_Real = Class(name="MARTE_Library_BasicNFP_Types_NFP_Real")
NFP_CommonType = Class(name="NFP_CommonType")
MARTE_Library_BasicNFP_Types_NFP_CommonType = Class(name="MARTE_Library_BasicNFP_Types_NFP_CommonType")
MARTE_Library_BasicNFP_Types_NFP_Natural = Class(name="MARTE_Library_BasicNFP_Types_NFP_Natural")
MARTE_Library_BasicNFP_Types_NFP_Area = Class(name="MARTE_Library_BasicNFP_Types_NFP_Area")
MARTE_Library_BasicNFP_Types_ArrivalPattern = Class(name="MARTE_Library_BasicNFP_Types_ArrivalPattern")
...
MARTE_Library_BasicNFP_Types_NFP_Boolean = Class(name="MARTE_Library_BasicNFP_Types_NFP_Boolean")
MARTE_Library_BasicNFP_Types_NFP_String = Class(name="MARTE_Library_BasicNFP_Types_NFP_String")
MARTE_Library_BasicNFP_Types_NFP_Integer = Class(name="MARTE_Library_BasicNFP_Types_NFP_Integer")
MARTE_Library_BasicNFP_Types_NFP_DateTime = Class(name="MARTE_Library_BasicNFP_Types_NFP_DateTime")
MARTE_Library_BasicNFP_Types_NFP_DataTxRate = Class(name="MARTE_Library_BasicNFP_Types_NFP_DataTxRate")
MARTE_Library_BasicNFP_Types_NFP_Power = Class(name="MARTE_Library_BasicNFP_Types_NFP_Power")
MARTE_Library_BasicNFP_Types_NFP_DataSize = Class(name="MARTE_Library_BasicNFP_Types_NFP_DataSize")
MARTE_Library_BasicNFP_Types_NFP_Energy = Class(name="MARTE_Library_BasicNFP_Types_NFP_Energy")
MARTE_Library_BasicNFP_Types_NFP_Length = Class(name="MARTE_Library_BasicNFP_Types_NFP_Length")
MARTE_Library_BasicNFP_Types_ClosedPattern = Class(name="MARTE_Library_BasicNFP_Types_ClosedPattern")
MARTE_Library_BasicNFP_Types_SporadicPattern = Class(name="MARTE_Library_BasicNFP_Types_SporadicPattern")
MARTE_Library_BasicNFP_Types_OpenPattern = Class(name="MARTE_Library_BasicNFP_Types_OpenPattern")
NFP_Frequency = Class(name="NFP_Frequency")
OpenPattern = Class(name="OpenPattern")
MARTE_Library_BasicNFP_Types_PeriodicPattern = Class(name="MARTE_Library_BasicNFP_Types_PeriodicPattern")
MARTE_Library_BasicNFP_Types_AperiodicPattern = Class(name="MARTE_Library_BasicNFP_Types_AperiodicPattern")
MARTE_Library_BasicNFP_Types_BurstPattern = Class(name="MARTE_Library_BasicNFP_Types_BurstPattern")
MARTE_Library_BasicNFP_Types_IrregularPattern = Class(name="MARTE_Library_BasicNFP_Types_IrregularPattern")
IntegerVector = Class(name="IntegerVector")
MARTE_Library_MARTE_DataTypes_IntegerInterval = Class(name="MARTE_Library_MARTE_DataTypes_IntegerInterval")
MARTE_Library_MARTE_DataTypes_UtilityType = Class(name="MARTE_Library_MARTE_DataTypes_UtilityType")
MARTE_Library_BasicNFP_Types_NFP_Percentage = Class(name="MARTE_Library_BasicNFP_Types_NFP_Percentage")
MARTE_Library_BasicNFP_Types_NFP_Price = Class(name="MARTE_Library_BasicNFP_Types_NFP_Price")
MARTE_Library_BasicNFP_Types_NFP_Weight = Class(name="MARTE_Library_BasicNFP_Types_NFP_Weight")
MARTE_Library_BasicNFP_Types_NFP_Duration = Class(name="MARTE_Library_BasicNFP_Types_NFP_Duration")
MARTE_Library_MARTE_DataTypes_IntegerVector = Class(name="MARTE_Library_MARTE_DataTypes_IntegerVector")
MARTE_Library_MARTE_DataTypes_IntegerMatrix = Class(name="MARTE_Library_MARTE_DataTypes_IntegerMatrix")
MARTE_Library_TimeLibrary_TimedValueType = Class(name="MARTE_Library_TimeLibrary_TimedValueType")
MARTE_Library_MARTE_DataTypes_Array = Class(name="MARTE_Library_MARTE_DataTypes_Array")
MARTE_Library_MARTE_DataTypes_Interval = Class(name="MARTE_Library_MARTE_DataTypes_Interval")
MARTE_Library_MARTE_DataTypes_Realnterval = Class(name="MARTE_Library_MARTE_DataTypes_Realnterval")
MARTE_Library_MARTE_DataTypes_NFP_FrequencyInterval = Class(name="MARTE_Library_MARTE_DataTypes_NFP_FrequencyInterval")
MARTE_Library_MARTE_DataTypes_NFP_NaturalInterval = Class(name="MARTE_Library_MARTE_DataTypes_NFP_NaturalInterval")
NFP_Natural = Class(name="NFP_Natural")
MARTE_Library_MARTE_DataTypes_RealVector = Class(name="MARTE_Library_MARTE_DataTypes_RealVector")
MARTE_Library_MARTE_DataTypes_RealMatrix = Class(name="MARTE_Library_MARTE_DataTypes_RealMatrix")
MARTE_Library_TimeLibrary_IdealClock = Class(name="MARTE_Library_TimeLibrary_IdealClock")
MARTE_Library_RS_Library_TilerSpecification = Class(name="MARTE_Library_RS_Library_TilerSpecification")
IntegerMatrix = Class(name="IntegerMatrix")
MARTE_Library_RS_Library_ShapeSpecification = Class(name="MARTE_Library_RS_Library_ShapeSpecification")
...
MARTE_Library_GRM_BasicTypes_PeriodicServerParameters.attributes={MARTE_Library_GRM_BasicTypes_PeriodicServerParameters_kind, MARTE_Library_GRM_BasicTypes_PeriodicServerParameters_backgroundPriority}
...
MARTE_Library_BasicNFP_Types_NFP_CommonType_m_logarithmic: Method = Method(name="logarithmic", parameters={Parameter(name='MARTE_Library_theta', type=StringType)})
MARTE_Library_BasicNFP_Types_NFP_CommonType_m_bernoulli: Method = Method(name="bernoulli", parameters={Parameter(name='MARTE_Library_prob', type=StringType)})
MARTE_Library_BasicNFP_Types_NFP_CommonType_m_binomial: Method = Method(name="binomial", parameters={Parameter(name='MARTE_Library_trials', type=StringType), Parameter(name='MARTE_Library_prob', type=StringType)})
MARTE_Library_BasicNFP_Types_NFP_CommonType_m_exp: Method = Method(name="exp", parameters={Parameter(name='MARTE_Library_mean', type=StringType)})
MARTE_Library_BasicNFP_Types_NFP_CommonType_m_gamma: Method = Method(name="gamma", parameters={Parameter(name='MARTE_Library_k', type=StringType), Parameter(name='MARTE_Library_mean', type=StringType)})
MARTE_Library_BasicNFP_Types_NFP_CommonType_m_normal: Method = Method(name="normal", parameters={Parameter(name='MARTE_Library_mean', type=StringType), Parameter(name='MARTE_Library_standDev', type=StringType)})
MARTE_Library_BasicNFP_Types_NFP_CommonType_m_poisson: Method = Method(name="poisson", parameters={Parameter(name='MARTE_Library_mean', type=StringType)})
MARTE_Library_BasicNFP_Types_NFP_CommonType_m_uniform: Method = Method(name="uniform", parameters={Parameter(name='MARTE_Library_min', type=StringType), Parameter(name='MARTE_Library_max', type=StringType)})
MARTE_Library_BasicNFP_Types_NFP_CommonType_m_gamma: Method = Method(name="gamma", parameters={Parameter(name='MARTE_Library_mean', type=StringType), Parameter(name='MARTE_Library_k', type=StringType)})
MARTE_Library_BasicNFP_Types_NFP_CommonType_m_geometric: Method = Method(name="geometric", parameters={Parameter(name='MARTE_Library_p', type=StringType)})
MARTE_Library_BasicNFP_Types_NFP_CommonType_m_triangular: Method = Method(name="triangular", parameters={Parameter(name='MARTE_Library_max', type=StringType), Parameter(name='MARTE_Library_min', type=StringType), Parameter(name='MARTE_Library_mode', type=StringType)})
MARTE_Library_BasicNFP_Types_NFP_CommonType.attributes={MARTE_Library_BasicNFP_Types_NFP_CommonType_source, MARTE_Library_BasicNFP_Types_NFP_CommonType_statQ, MARTE_Library_BasicNFP_Types_NFP_CommonType_expr, MARTE_Library_BasicNFP_Types_NFP_CommonType_dir, MARTE_Library_BasicNFP_Types_NFP_CommonType_mode}
MARTE_Library_BasicNFP_Types_NFP_CommonType.methods={MARTE_Library_BasicNFP_Types_NFP_CommonType_m_binomial, MARTE_Library_BasicNFP_Types_NFP_CommonType_m_exp, MARTE_Library_BasicNFP_Types_NFP_CommonType_m_poisson, MARTE_Library_BasicNFP_Types_NFP_CommonType_m_logarithmic, MARTE_Library_BasicNFP_Types_NFP_CommonType_m_gamma, MARTE_Library_BasicNFP_Types_NFP_CommonType_m_gamma, MARTE_Library_BasicNFP_Types_NFP_CommonType_m_uniform, MARTE_Library_BasicNFP_Types_NFP_CommonType_m_triangular, MARTE_Library_BasicNFP_Types_NFP_CommonType_m_normal, MARTE_Library_BasicNFP_Types_NFP_CommonType_m_geometric, MARTE_Library_BasicNFP_Types_NFP_CommonType_m_bernoulli}
...
MARTE_Library_BasicNFP_Types_NFP_Energy.attributes={MARTE_Library_BasicNFP_Types_NFP_Energy_unit, MARTE_Library_BasicNFP_Types_NFP_Energy_precision}
...
MARTE_Library_MARTE_DataTypes_UtilityType_m_eq: Method = Method(name="eq", parameters={Parameter(name='MARTE_Library_u', type=StringType)}, type=StringType)
MARTE_Library_MARTE_DataTypes_UtilityType_m_lt: Method = Method(name="lt", parameters={Parameter(name='MARTE_Library_u', type=StringType)}, type=StringType)
MARTE_Library_MARTE_DataTypes_UtilityType_m_gt: Method = Method(name="gt", parameters={Parameter(name='MARTE_Library_u', type=StringType)}, type=StringType)
MARTE_Library_MARTE_DataTypes_UtilityType_m_le: Method = Method(name="le", parameters={Parameter(name='MARTE_Library_u', type=StringType)}, type=StringType)
MARTE_Library_MARTE_DataTypes_UtilityType_m_ge: Method = Method(name="ge", parameters={Parameter(name='MARTE_Library_u', type=StringType)}, type=StringType)
MARTE_Library_MARTE_DataTypes_UtilityType_m_ne: Method = Method(name="ne", parameters={Parameter(name='MARTE_Library_u', type=StringType)}, type=StringType)
MARTE_Library_MARTE_DataTypes_UtilityType.methods={MARTE_Library_MARTE_DataTypes_UtilityType_m_le, MARTE_Library_MARTE_DataTypes_UtilityType_m_eq, MARTE_Library_MARTE_DataTypes_UtilityType_m_ne, MARTE_Library_MARTE_DataTypes_UtilityType_m_gt, MARTE_Library_MARTE_DataTypes_UtilityType_m_lt, MARTE_Library_MARTE_DataTypes_UtilityType_m_ge}
...
MARTE_Library_BasicNFP_Types_NFP_Duration.attributes={MARTE_Library_BasicNFP_Types_NFP_Duration_best, MARTE_Library_BasicNFP_Types_NFP_Duration_unit, MARTE_Library_BasicNFP_Types_NFP_Duration_clock, MARTE_Library_BasicNFP_Types_NFP_Duration_precision, MARTE_Library_BasicNFP_Types_NFP_Duration_worst}
...
MARTE_Library_MARTE_DataTypes_IntegerVector_m_at: Method = Method(name="at", parameters={Parameter(name='MARTE_Library_i', type=StringType)}, type=StringType)
...
MARTE_Library_MARTE_DataTypes_IntegerMatrix_m_at: Method = Method(name="at", parameters={Parameter(name='MARTE_Library_i', type=StringType)}, type=StringType)
...
MARTE_Library_TimeLibrary_TimedValueType.attributes={MARTE_Library_TimeLibrary_TimedValueType_onClock, MARTE_Library_TimeLibrary_TimedValueType_expr, MARTE_Library_TimeLibrary_TimedValueType_unit, MARTE_Library_TimeLibrary_TimedValueType_value}

# MARTE_Library_MARTE_DataTypes_Array class attributes and methods
MARTE_Library_MARTE_DataTypes_Array_m_at: Method = Method(name="at", parameters={Parameter(name='MARTE_Library_i', type=StringType)})
...
MARTE_Library_MARTE_DataTypes_RealVector_m_at: Method = Method(name="at", parameters={Parameter(name='MARTE_Library_i', type=StringType)}, type=StringType)
...
MARTE_Library_MARTE_DataTypes_RealMatrix_m_at: Method = Method(name="at", parameters={Parameter(name='MARTE_Library_p', type=StringType), Parameter(name='MARTE_Library_i', type=StringType)})
...
domain_model = DomainModel(
    name="MARTE_Library",
    types={MARTE_Library_GRM_BasicTypes_SchedParameters, EDF_Parameters, FixedPriorityParameters, MARTE_Library_GRM_BasicTypes_EDF_Parameters, NFP_Duration, PoolingParameters, PeriodicServerParameters, MARTE_Library_GRM_BasicTypes_FixedPriorityParameters, NFP_Integer, MARTE_Library_GRM_BasicTypes_PoolingParameters, MARTE_Library_GRM_BasicTypes_PeriodicServerParameters, MARTE_Library_BasicNFP_Types_NFP_Frequency, NFP_Real, MARTE_Library_BasicNFP_Types_NFP_Real, NFP_CommonType, MARTE_Library_BasicNFP_Types_NFP_CommonType, MARTE_Library_BasicNFP_Types_NFP_Natural, MARTE_Library_BasicNFP_Types_NFP_Area, MARTE_Library_BasicNFP_Types_ArrivalPattern, PeriodicPattern, AperiodicPattern, BurstPattern, IrregularPattern, ClosedPattern, SporadicPattern, MARTE_Library_BasicNFP_Types_NFP_Boolean, MARTE_Library_BasicNFP_Types_NFP_String, MARTE_Library_BasicNFP_Types_NFP_Integer, MARTE_Library_BasicNFP_Types_NFP_DateTime, MARTE_Library_BasicNFP_Types_NFP_DataTxRate, MARTE_Library_BasicNFP_Types_NFP_Power, MARTE_Library_BasicNFP_Types_NFP_DataSize, MARTE_Library_BasicNFP_Types_NFP_Energy, MARTE_Library_BasicNFP_Types_NFP_Length, MARTE_Library_BasicNFP_Types_ClosedPattern, MARTE_Library_BasicNFP_Types_SporadicPattern, MARTE_Library_BasicNFP_Types_OpenPattern, NFP_Frequency, OpenPattern, MARTE_Library_BasicNFP_Types_PeriodicPattern, MARTE_Library_BasicNFP_Types_AperiodicPattern, MARTE_Library_BasicNFP_Types_BurstPattern, MARTE_Library_BasicNFP_Types_IrregularPattern, IntegerVector, MARTE_Library_MARTE_DataTypes_IntegerInterval, MARTE_Library_MARTE_DataTypes_UtilityType, MARTE_Library_BasicNFP_Types_NFP_Percentage, MARTE_Library_BasicNFP_Types_NFP_Price, MARTE_Library_BasicNFP_Types_NFP_Weight, MARTE_Library_BasicNFP_Types_NFP_Duration, MARTE_Library_MARTE_DataTypes_IntegerVector, MARTE_Library_MARTE_DataTypes_IntegerMatrix, MARTE_Library_TimeLibrary_TimedValueType, MARTE_Library_MARTE_DataTypes_Array, MARTE_Library_MARTE_DataTypes_Interval, MARTE_Library_MARTE_DataTypes_Realnterval, MARTE_Library_MARTE_DataTypes_NFP_FrequencyInterval, MARTE_Library_MARTE_DataTypes_NFP_NaturalInterval, NFP_Natural, MARTE_Library_MARTE_DataTypes_RealVector, MARTE_Library_MARTE_DataTypes_RealMatrix, MARTE_Library_TimeLibrary_IdealClock, MARTE_Library_RS_Library_TilerSpecification, IntegerMatrix, MARTE_Library_RS_Library_ShapeSpecification, PowerUnitKind, FrequencyUnitKind, DataSizeUnitKind, DataTxRateUnitKind, EnergyUnitKind, LengthUnitKind, AreaUnitKind, PeriodicServerKind, WeightUnitKind, SchedPolicyKind, ProtectProtocolKind, SourceKind, DirectionKind, StatisticalQualifierKind, TransmModeKind, TimeNatureKind, TimeInterpretationKind, EventKind, TimeStandardKind, TUK, TimeUnitKind, LogicalTimeUnit},
    associations={edf1, deadline0, maxPendingReplenish19, fp2, pooling4, server6, priority8, period9, overhead11, initialBudget14, replenishPeriod16, periodic22, aperiodic23, burst25, irregular27, closed29, sporadic31, interarrivals63, population66, extDelay68, minInterarrival71, maxInterarrival73, jitter76, interArrivalTime79, open33, period35, jitter37, phase40, occurrences43, distribution46, minInterarrival47, maxInterarrival49, minEventInterval52, maxEventInterval55, burstSize58, phase61, matrixElem83, arrivalRate81, bound84, bound86, origin87, paving89, fitting91},
    generalizations={gen_MARTE_Library_GRM_BasicTypes_PoolingParameters_FixedPriorityParameters, gen_MARTE_Library_GRM_BasicTypes_PeriodicServerParameters_FixedPriorityParameters, gen_MARTE_Library_BasicNFP_Types_NFP_Frequency_NFP_Real, gen_MARTE_Library_BasicNFP_Types_NFP_Real_NFP_CommonType, gen_MARTE_Library_BasicNFP_Types_NFP_Natural_NFP_CommonType, gen_MARTE_Library_BasicNFP_Types_NFP_Area_NFP_Real, gen_MARTE_Library_BasicNFP_Types_NFP_Boolean_NFP_CommonType, gen_MARTE_Library_BasicNFP_Types_NFP_String_NFP_CommonType, gen_MARTE_Library_BasicNFP_Types_NFP_Integer_NFP_CommonType, gen_MARTE_Library_BasicNFP_Types_NFP_DateTime_NFP_CommonType, gen_MARTE_Library_BasicNFP_Types_NFP_DataTxRate_NFP_Real, gen_MARTE_Library_BasicNFP_Types_NFP_Power_NFP_Real, gen_MARTE_Library_BasicNFP_Types_NFP_DataSize_NFP_Real, gen_MARTE_Library_BasicNFP_Types_NFP_Energy_NFP_Real, gen_MARTE_Library_BasicNFP_Types_NFP_Length_NFP_Real, gen_MARTE_Library_BasicNFP_Types_SporadicPattern_AperiodicPattern, gen_MARTE_Library_BasicNFP_Types_BurstPattern_AperiodicPattern, gen_MARTE_Library_BasicNFP_Types_IrregularPattern_AperiodicPattern, gen_MARTE_Library_BasicNFP_Types_NFP_Percentage_NFP_Real, gen_MARTE_Library_BasicNFP_Types_NFP_Price_NFP_Real, gen_MARTE_Library_BasicNFP_Types_NFP_Weight_NFP_Real, gen_MARTE_Library_BasicNFP_Types_NFP_Duration_NFP_Real},
    metadata=None
)
