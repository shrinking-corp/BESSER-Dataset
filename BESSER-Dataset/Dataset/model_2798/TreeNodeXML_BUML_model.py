...
# Classes
TreeNodeXML_XMLTreeNode = Class(name="TreeNodeXML_XMLTreeNode")
TreeNodeXML_TreeNodeAtom = Class(name="TreeNodeXML_TreeNodeAtom")
...
TreeNodeXML_XMLTreeNode_m_addTreeNodeAtom: Method = Method(name="addTreeNodeAtom", parameters={Parameter(name='TreeNodeXML_nodeAtom', type=StringType)})
TreeNodeXML_XMLTreeNode_m_addChild: Method = Method(name="addChild", parameters={Parameter(name='TreeNodeXML_newChild', type=StringType)})
TreeNodeXML_XMLTreeNode.attributes={TreeNodeXML_XMLTreeNode_LocalName, TreeNodeXML_XMLTreeNode_ElementText}
TreeNodeXML_XMLTreeNode.methods={TreeNodeXML_XMLTreeNode_m_addTreeNodeAtom, TreeNodeXML_XMLTreeNode_m_addChild}
...
TreeNodeXML_TreeNodeAtom.attributes={TreeNodeXML_TreeNodeAtom_AttributeValue, TreeNodeXML_TreeNodeAtom_AttributeLocalName}
