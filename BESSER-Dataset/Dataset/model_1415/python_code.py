...
class NHSM_State:
    ...
    def __init__(self, name: str, NHSM_State: "NHSM_Transition" = None, NHSM_State7: "NHSM_Transition" = None, State: "NHSM_StateMachine" = None, states: "NHSM_StateMachine" = None):
        self.name = name
...
class NHSM_StateMachine:
    ...
    def __init__(self, name: str, NHSM_StateMachine10: "NHSM_Transition" = None, machine: set["NHSM_State"] = None, NHSM_StateMachine: set["NHSM_Transition"] = None, StateMachine: "NHSM_State" = None):
        self.name = name
