...
class ResultatExamen:
    ...
    def __init__(self, infoResultat: str, numeroResultat: int, secretaire17: "Secretaire_external" = None, medecin18: "Medecin" = None, patient21: "Patient" = None):
...
class Patient:
    ...
    def __init__(self, numeroPatien: int, nomPatient: str, prenomPatien: str, agePatient: int, lieuResidence: str, profession: str, dossierPatient1: set["DossierPatient"] = None, rendez_Vous2: set["Rendez_Vous"] = None, resultatExamen20: "ResultatExamen" = None):
