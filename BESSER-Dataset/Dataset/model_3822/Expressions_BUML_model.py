...
expressions_BinaryExpression = Class(name="expressions_BinaryExpression", is_abstract=True)
Expression = Class(name="Expression")
expressions_Literal = Class(name="expressions_Literal", is_abstract=True)
expressions_BoolLiteral = Class(name="expressions_BoolLiteral")
Literal = Class(name="Literal")
expressions_IntLiteral = Class(name="expressions_IntLiteral")
expressions_DoubleLiteral = Class(name="expressions_DoubleLiteral")
expressions_FloatLiteral = Class(name="expressions_FloatLiteral")
expressions_HexLiteral = Class(name="expressions_HexLiteral")
expressions_StringLiteral = Class(name="expressions_StringLiteral")
expressions_NullLiteral = Class(name="expressions_NullLiteral")
expressions_UnaryExpression = Class(name="expressions_UnaryExpression", is_abstract=True)
expressions_ArgumentExpression = Class(name="expressions_ArgumentExpression", is_abstract=True)
...
expressions_LogicalOrExpression = Class(name="expressions_LogicalOrExpression")
BinaryExpression = Class(name="BinaryExpression")
expressions_LogicalAndExpression = Class(name="expressions_LogicalAndExpression")
expressions_LogicalNotExpression = Class(name="expressions_LogicalNotExpression")
UnaryExpression = Class(name="UnaryExpression")
expressions_BitwiseXorExpression = Class(name="expressions_BitwiseXorExpression")
expressions_BitwiseOrExpression = Class(name="expressions_BitwiseOrExpression")
expressions_BitwiseAndExpression = Class(name="expressions_BitwiseAndExpression")
expressions_LogicalRelationExpression = Class(name="expressions_LogicalRelationExpression")
expressions_EObject = Class(name="expressions_EObject")
expressions_ElementReferenceExpression = Class(name="expressions_ElementReferenceExpression")
expressions_ParenthesizedExpression = Class(name="expressions_ParenthesizedExpression")
expressions_TypeCastExpression = Class(name="expressions_TypeCastExpression")
expressions_Type = Class(name="expressions_Type")
expressions_ShiftExpression = Class(name="expressions_ShiftExpression")
expressions_NumericalAddSubtractExpression = Class(name="expressions_NumericalAddSubtractExpression")
expressions_NumericalMultiplyDivideExpression = Class(name="expressions_NumericalMultiplyDivideExpression")
expressions_NumericalUnaryExpression = Class(name="expressions_NumericalUnaryExpression")
expressions_PrimitiveValueExpression = Class(name="expressions_PrimitiveValueExpression")
expressions_FeatureCall = Class(name="expressions_FeatureCall")
...
expressions_FeatureCall.attributes={expressions_FeatureCall_arrayAccess, expressions_FeatureCall_operationCall}
...
domain_model = DomainModel(
    name="expressions",
    types={expressions_Expression, expressions_BinaryExpression, Expression, expressions_Literal, expressions_BoolLiteral, Literal, expressions_IntLiteral, expressions_DoubleLiteral, expressions_FloatLiteral, expressions_HexLiteral, expressions_StringLiteral, expressions_NullLiteral, expressions_UnaryExpression, expressions_ArgumentExpression, expressions_AssignmentExpression, expressions_ConditionalExpression, expressions_LogicalOrExpression, BinaryExpression, expressions_LogicalAndExpression, expressions_LogicalNotExpression, UnaryExpression, expressions_BitwiseXorExpression, expressions_BitwiseOrExpression, expressions_BitwiseAndExpression, expressions_LogicalRelationExpression, expressions_EObject, expressions_ElementReferenceExpression, expressions_ParenthesizedExpression, expressions_TypeCastExpression, expressions_Type, expressions_ShiftExpression, expressions_NumericalAddSubtractExpression, expressions_NumericalMultiplyDivideExpression, expressions_NumericalUnaryExpression, expressions_PrimitiveValueExpression, expressions_FeatureCall, ArgumentExpression, AssignmentOperator, ShiftOperator, LogicalOperator, BitwiseOperator, AdditiveOperator, MultiplicativeOperator, UnaryOperator, RelationalOperator},
    associations={leftOperand0, args6, rightOperand1, operand4, varRef8, expression10, condition13, trueCase15, falseCase18, owner22, feature24, arraySelector26, reference29, arraySelector31, expression34, operand36, type38, value21},
    generalizations={gen_expressions_BinaryExpression_Expression, gen_expressions_BoolLiteral_Literal, gen_expressions_IntLiteral_Literal, gen_expressions_DoubleLiteral_Literal, gen_expressions_FloatLiteral_Literal, gen_expressions_HexLiteral_Literal, gen_expressions_StringLiteral_Literal, gen_expressions_NullLiteral_Literal, gen_expressions_UnaryExpression_Expression, gen_expressions_ArgumentExpression_Expression, gen_expressions_AssignmentExpression_Expression, gen_expressions_ConditionalExpression_Expression, gen_expressions_LogicalOrExpression_BinaryExpression, gen_expressions_LogicalAndExpression_BinaryExpression, gen_expressions_LogicalNotExpression_UnaryExpression, gen_expressions_BitwiseXorExpression_BinaryExpression, gen_expressions_BitwiseOrExpression_BinaryExpression, gen_expressions_BitwiseAndExpression_BinaryExpression, gen_expressions_LogicalRelationExpression_BinaryExpression, gen_expressions_FeatureCall_ArgumentExpression, gen_expressions_ElementReferenceExpression_ArgumentExpression, gen_expressions_ParenthesizedExpression_Expression, gen_expressions_TypeCastExpression_Expression, gen_expressions_ShiftExpression_BinaryExpression, gen_expressions_NumericalAddSubtractExpression_BinaryExpression, gen_expressions_NumericalMultiplyDivideExpression_BinaryExpression, gen_expressions_NumericalUnaryExpression_UnaryExpression, gen_expressions_PrimitiveValueExpression_Expression},
    metadata=None
)
