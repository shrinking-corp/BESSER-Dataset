...
class expressions_ElementReferenceExpression(ArgumentExpression):
    ...
    def __init__(self, operationCall: bool, arrayAccess: bool, expressions_ElementReferenceExpression: "expressions_EObject" = None, expressions_ElementReferenceExpression32: set["expressions_Expression"] = None):
        self.operationCall = operationCall
        self.arrayAccess = arrayAccess
