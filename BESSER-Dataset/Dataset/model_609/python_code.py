...
class webapp_Tag(Instruction):
    ...
    def __init__(self, _property: str, webapp_Tag82: set["webapp_Attribute"] = None, webapp_Tag: "webapp_Form" = None, webapp_Tag103: "webapp_Td" = None):
...
class webapp_Field:
    ...
    def __init__(self, name: str, type: str, defaultValue: str, webapp_Field: "webapp_Input" = None, webapp_Field117: "webapp_BusinessObject" = None, webapp_Field106: "webapp_BusinessObject" = None):
        self.name = name
        self.type = type
...
class webapp_Column:
    ...
    def __init__(self, name: str, isNotNull: bool, size: int, useZeroFill: bool, type: str, defaultValue: str, webapp_Column: "webapp_Table" = None, webapp_Column62: "webapp_ForeignKey" = None, webapp_Column65: "webapp_Unique" = None, webapp_Column38: "webapp_Detail" = None, webapp_Column49: "webapp_PrimaryKey" = None, webapp_Column52: "webapp_ForeignKey" = None):
        self.name = name
...
class webapp_BusinessObject:
    ...
    def __init__(self, name: str, package: str, webapp_BusinessObject80: "webapp_Action" = None, webapp_BusinessObject114: "webapp_Model" = None, webapp_BusinessObject118: "webapp_Field" = None, webapp_BusinessObject: "webapp_Model" = None, webapp_BusinessObject105: set["webapp_Field"] = None, webapp_BusinessObject108: set["webapp_Action"] = None, webapp_BusinessObject112: "webapp_BusinessObject" = None, webapp_BusinessObject110: set["webapp_BusinessObject"] = None):
        self.name = name
...
class webapp_Table:
    ...
    def __init__(self, name: str, charset: str, webapp_Table: "webapp_Model" = None, webapp_Table34: set["webapp_Column"] = None, webapp_Table36: "webapp_Constraint" = None, webapp_Table59: "webapp_ForeignKey" = None):
        self.name = name
...
class webapp_Navigation:
    ...
    def __init__(self, message: str, webapp_Navigation: "webapp_View" = None, webapp_Navigation120: "webapp_Page" = None, webapp_Navigation123: "webapp_Page" = None):
...
class webapp_Page:
    ...
    def __init__(self, name: str, isMain: bool, webapp_Page: "webapp_View" = None, webapp_Page68: "webapp_Validator" = None, webapp_Page70: set["webapp_Properties"] = None, webapp_Page73: "webapp_Mapping" = None, webapp_Page76: set["webapp_Instruction"] = None, webapp_Page121: "webapp_Navigation" = None, webapp_Page124: "webapp_Navigation" = None):
        self.name = name
        self.isMain = isMain
...
class webapp_Mapping:
    ...
    def __init__(self, left: str, right: str, webapp_Mapping: "webapp_Properties" = None, webapp_Mapping87: "webapp_Input" = None, webapp_Mapping90: "webapp_Input" = None, webapp_Mapping74: "webapp_Page" = None):
        self.left = left
        self.right = right
...
class webapp_Properties:
    ...
    def __init__(self, name: str, package: str, webapp_Properties32: set["webapp_Mapping"] = None, webapp_Properties71: "webapp_Page" = None, webapp_Properties: "webapp_Resource" = None):
        self.name = name
        self.package = package
...
class webapp_Action:
    ...
    def __init__(self, name: str, returnType: str, webapp_Action84: "webapp_Input" = None, webapp_Action79: "webapp_BusinessObject" = None, webapp_Action: "webapp_Controller" = None, webapp_Action109: "webapp_BusinessObject" = None):
        self.name = name
...
class webapp_Validator:
    ...
    def __init__(self, name: str, package: str, webapp_Validator95: "webapp_Input" = None, webapp_Validator67: "webapp_Page" = None, webapp_Validator: "webapp_Controller" = None):
        self.name = name
        self.package = package
...
class webapp_Model:
    ...
    def __init__(self, databaseName: str, url: str, userName: str, password: str, webapp_Model18: set["webapp_Table"] = None, webapp_Model115: "webapp_BusinessObject" = None, webapp_Model: "webapp_WebApp" = None, webapp_Model20: set["webapp_BusinessObject"] = None):
