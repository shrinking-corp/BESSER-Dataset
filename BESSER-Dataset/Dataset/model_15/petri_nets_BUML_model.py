...
petri_TPArc = Class(name="petri_TPArc")
Arc = Class(name="Arc")
petri_PetriNet = Class(name="petri_PetriNet")
petri_Node = Class(name="petri_Node", is_abstract=True)
petri_Arc = Class(name="petri_Arc", is_abstract=True)
petri_Place = Class(name="petri_Place")
petri_PTArc = Class(name="petri_PTArc")
...
domain_model = DomainModel(
    name="petri",
    types={Node, petri_Transition, petri_TPArc, Arc, petri_PetriNet, petri_Node, petri_Arc, petri_Place, petri_PTArc},
    associations={input3, elems0, arcs1, output4, input6, output8},
