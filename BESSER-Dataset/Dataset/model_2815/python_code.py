...
class fxg_DropShadowFilter(Filter):
    ...
    def __init__(self, alpha: str, angle: str, blurX: str, blurY: str, hideObject: str, knockout: str, quality: str, strength: str, color: str, distance: str, inner: str):
        self.alpha = alpha
        self.angle = angle
        self.blurX = blurX
        self.blurY = blurY
...
class fxg_LinearGradient:
    ...
    def __init__(self, y: str, scaleX: str, rotation: str, spreadMethod: str, interpolationMethod: str, x: str, fxg_LinearGradient: "fxg_Matrix" = None):
        self.y = y
        self.scaleX = scaleX
        self.rotation = rotation
        self.spreadMethod = spreadMethod
...
class ParagraphAttributes:
    ...
    pass
class fxg_p(ParagraphAttributes, RichTextContentContainer, RichTextContent):
...
class fxg_RichText(ParagraphAttributes, FXGElement, ContainerAttributes, CharacterAttributes):
...
class fxg_Path(FXGElement):
    ...
    def __init__(self, data: str, x: str, y: str, rotation: str, scaleX: str, scaleY: str, blendMode: str, visible: str, alpha: str, winding: str, fxg_Path: "fxg_Fill" = None, fxg_Path22: "fxg_Stroke" = None, fxg_Path27: "fxg_Transform" = None, fxg_Path30: "fxg_Group" = None, fxg_Path24: set["fxg_Filter"] = None):
        self.data = data
        self.x = x
        self.y = y
        self.rotation = rotation
...
class fxg_BitmapImage(FXGElement):
    ...
    def __init__(self, width: str, height: str, rotation: str, scaleX: str, scaleY: str, fillMode: str, source: str, visible: str, alpha: str, blendMode: str, x: str, y: str):
        self.width = width
        self.height = height
        self.rotation = rotation
        self.scaleX = scaleX
...
class fxg_Group:
    ...
    def __init__(self, rotation: str, scaleX: str, scaleY: str, x: str, y: str, id: str, transformX: str, transformY: str, maskType: str, visible: str, scaleGridLeft: str, scaleGridRight: str, scaleGridTop: str, scaleGridBottom: str, blendMode: str, alpha: str, fxg_Group: "fxg_Graphic" = None, fxg_Group2: "fxg_Transform" = None, fxg_Group4: set["fxg_Filter"] = None, fxg_Group7: "fxg_Group" = None, fxg_Group5: "fxg_Group" = None, fxg_Group19: "fxg_PlaceObject" = None, fxg_Group31: "fxg_Path" = None, fxg_Group45: "fxg_Rect" = None, fxg_Group73: "fxg_Line" = None, fxg_Group59: "fxg_Ellipse" = None):
        self.rotation = rotation
        self.scaleX = scaleX
        self.scaleY = scaleY
        self.x = x
