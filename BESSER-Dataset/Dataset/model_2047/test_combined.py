...
def test_hyp_room_simplestate_is_not_abstract():
    assert not inspect.isabstract(room_SimpleState)


def test_hyp_room_simplestate_constructor_exists():
    assert callable(room_SimpleState.__init__)


def test_hyp_room_simplestate_constructor_args():
...
def test_hyp_room_refinedtransition_is_not_abstract():
    assert not inspect.isabstract(room_RefinedTransition)


def test_hyp_room_refinedtransition_constructor_exists():
    assert callable(room_RefinedTransition.__init__)


def test_hyp_room_refinedtransition_constructor_args():
...
def test_hyp_room_outsemanticsrule_is_not_abstract():
    assert not inspect.isabstract(room_OutSemanticsRule)


def test_hyp_room_outsemanticsrule_constructor_exists():
    assert callable(room_OutSemanticsRule.__init__)


def test_hyp_room_outsemanticsrule_constructor_args():
    sig = inspect.signature(room_OutSemanticsRule.__init__)
    params = list(sig.parameters.keys())



def test_hyp_room_insemanticsrule_is_not_abstract():
    assert not inspect.isabstract(room_InSemanticsRule)


def test_hyp_room_insemanticsrule_constructor_exists():
    assert callable(room_InSemanticsRule.__init__)


def test_hyp_room_insemanticsrule_constructor_args():
...
def test_hyp_room_outmessagehandler_is_not_abstract():
    assert not inspect.isabstract(room_OutMessageHandler)


def test_hyp_room_outmessagehandler_constructor_exists():
    assert callable(room_OutMessageHandler.__init__)


def test_hyp_room_outmessagehandler_constructor_args():
    sig = inspect.signature(room_OutMessageHandler.__init__)
    params = list(sig.parameters.keys())



def test_hyp_room_inmessagehandler_is_not_abstract():
    assert not inspect.isabstract(room_InMessageHandler)


def test_hyp_room_inmessagehandler_constructor_exists():
    assert callable(room_InMessageHandler.__init__)


def test_hyp_room_inmessagehandler_constructor_args():
...
def test_hyp_generalprotocolclass_is_not_abstract():
    assert not inspect.isabstract(GeneralProtocolClass)


def test_hyp_generalprotocolclass_constructor_exists():
    assert callable(GeneralProtocolClass.__init__)


def test_hyp_generalprotocolclass_constructor_args():
...
def test_hyp_room_subprotocol_is_not_abstract():
    assert not inspect.isabstract(room_SubProtocol)


def test_hyp_room_subprotocol_constructor_exists():
    assert callable(room_SubProtocol.__init__)


def test_hyp_room_subprotocol_constructor_args():
...
def test_hyp_room_compoundprotocolclass_is_not_abstract():
    assert not inspect.isabstract(room_CompoundProtocolClass)


def test_hyp_room_compoundprotocolclass_constructor_exists():
    assert callable(room_CompoundProtocolClass.__init__)


def test_hyp_room_compoundprotocolclass_constructor_args():
...
def test_hyp_room_generalprotocolclass_is_not_abstract():
    assert not inspect.isabstract(room_GeneralProtocolClass)


def test_hyp_room_generalprotocolclass_constructor_exists():
    assert callable(room_GeneralProtocolClass.__init__)


def test_hyp_room_generalprotocolclass_constructor_args():
...
def test_hyp_room_simplestate_name_setter(instance):
...
def test_hyp_room_subprotocol_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_room_actorref_size_setter(instance):
...
def test_hyp_room_standardoperation_destructor_setter(instance):
...
def test_hyp_room_primitivetype_type_setter(instance):
