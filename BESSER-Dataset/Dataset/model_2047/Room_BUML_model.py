...
# Classes
room_Binding = Class(name="room_Binding")
room_LayerConnection = Class(name="room_LayerConnection")
room_ActorContainerClass = Class(name="room_ActorContainerClass")
StructureClass = Class(name="StructureClass")
room_SPPRef = Class(name="room_SPPRef")
room_DetailCode = Class(name="room_DetailCode")
room_RoomModel = Class(name="room_RoomModel")
room_Documentation = Class(name="room_Documentation")
room_Import = Class(name="room_Import")
room_PrimitiveType = Class(name="room_PrimitiveType")
room_ExternalType = Class(name="room_ExternalType")
room_DataClass = Class(name="room_DataClass")
room_GeneralProtocolClass = Class(name="room_GeneralProtocolClass")
room_ActorClass = Class(name="room_ActorClass")
room_SubSystemClass = Class(name="room_SubSystemClass")
room_LogicalSystem = Class(name="room_LogicalSystem")
room_RoomClass = Class(name="room_RoomClass")
room_StructureClass = Class(name="room_StructureClass")
RoomClass = Class(name="RoomClass")
room_Annotation = Class(name="room_Annotation")
room_Attribute = Class(name="room_Attribute")
room_StandardOperation = Class(name="room_StandardOperation")
room_Operation = Class(name="room_Operation")
room_ActorRef = Class(name="room_ActorRef")
room_VarDecl = Class(name="room_VarDecl")
room_RefableType = Class(name="room_RefableType")
room_DataType = Class(name="room_DataType")
room_ComplexType = Class(name="room_ComplexType")
DataType = Class(name="DataType")
ComplexType = Class(name="ComplexType")
room_PortClass = Class(name="room_PortClass")
room_ProtocolSemantics = Class(name="room_ProtocolSemantics")
room_CompoundProtocolClass = Class(name="room_CompoundProtocolClass")
room_SubProtocol = Class(name="room_SubProtocol")
Operation = Class(name="Operation")
room_PortOperation = Class(name="room_PortOperation")
room_Message = Class(name="room_Message")
room_ProtocolClass = Class(name="room_ProtocolClass")
GeneralProtocolClass = Class(name="GeneralProtocolClass")
ActorContainerClass = Class(name="ActorContainerClass")
room_Port = Class(name="room_Port")
room_ExternalPort = Class(name="room_ExternalPort")
room_MessageHandler = Class(name="room_MessageHandler")
room_InMessageHandler = Class(name="room_InMessageHandler")
MessageHandler = Class(name="MessageHandler")
room_OutMessageHandler = Class(name="room_OutMessageHandler")
room_SemanticsRule = Class(name="room_SemanticsRule")
room_InSemanticsRule = Class(name="room_InSemanticsRule")
SemanticsRule = Class(name="SemanticsRule")
room_OutSemanticsRule = Class(name="room_OutSemanticsRule")
room_SubSystemRef = Class(name="room_SubSystemRef")
room_ActorContainerRef = Class(name="room_ActorContainerRef")
ActorContainerRef = Class(name="ActorContainerRef")
room_ServiceImplementation = Class(name="room_ServiceImplementation")
room_SAPRef = Class(name="room_SAPRef")
room_StateGraph = Class(name="room_StateGraph")
room_InterfaceItem = Class(name="room_InterfaceItem")
InterfaceItem = Class(name="InterfaceItem")
room_StateGraphNode = Class(name="room_StateGraphNode")
StateGraphItem = Class(name="StateGraphItem")
room_StateGraphItem = Class(name="room_StateGraphItem")
room_State = Class(name="room_State")
StateGraphNode = Class(name="StateGraphNode")
room_LogicalThread = Class(name="room_LogicalThread")
room_ActorInstancePath = Class(name="room_ActorInstancePath")
room_BindingEndPoint = Class(name="room_BindingEndPoint")
room_SAPoint = Class(name="room_SAPoint")
room_SPPoint = Class(name="room_SPPoint")
room_RefSAPoint = Class(name="room_RefSAPoint")
SAPoint = Class(name="SAPoint")
room_RelaySAPoint = Class(name="room_RelaySAPoint")
room_EntryPoint = Class(name="room_EntryPoint")
room_ExitPoint = Class(name="room_ExitPoint")
room_TransitionTerminal = Class(name="room_TransitionTerminal")
room_NonInitialTransition = Class(name="room_NonInitialTransition")
Transition = Class(name="Transition")
room_TrPoint = Class(name="room_TrPoint")
room_ChoicePoint = Class(name="room_ChoicePoint")
room_Transition = Class(name="room_Transition")
room_RefinedTransition = Class(name="room_RefinedTransition")
room_SimpleState = Class(name="room_SimpleState")
State = Class(name="State")
room_RefinedState = Class(name="room_RefinedState")
room_TransitionPoint = Class(name="room_TransitionPoint")
TrPoint = Class(name="TrPoint")
room_StateTerminal = Class(name="room_StateTerminal")
TransitionTerminal = Class(name="TransitionTerminal")
room_TrPointTerminal = Class(name="room_TrPointTerminal")
room_SubStateTrPointTerminal = Class(name="room_SubStateTrPointTerminal")
room_TransitionChainStartTransition = Class(name="room_TransitionChainStartTransition")
NonInitialTransition = Class(name="NonInitialTransition")
room_InitialTransition = Class(name="room_InitialTransition")
room_ContinuationTransition = Class(name="room_ContinuationTransition")
room_TriggeredTransition = Class(name="room_TriggeredTransition")
TransitionChainStartTransition = Class(name="TransitionChainStartTransition")
room_Trigger = Class(name="room_Trigger")
room_GuardedTransition = Class(name="room_GuardedTransition")
room_CPBranchTransition = Class(name="room_CPBranchTransition")
room_ChoicepointTerminal = Class(name="room_ChoicepointTerminal")
room_MessageFromIf = Class(name="room_MessageFromIf")
room_Guard = Class(name="room_Guard")
room_KeyValue = Class(name="room_KeyValue")
...
room_Import.attributes={room_Import_importedNamespace, room_Import_importURI}
...
room_PrimitiveType.attributes={room_PrimitiveType_targetName, room_PrimitiveType_type, room_PrimitiveType_castName, room_PrimitiveType_defaultValueLiteral}
...
room_ActorClass.attributes={room_ActorClass_commType, room_ActorClass_abstract}
...
room_KeyValue.attributes={room_KeyValue_key, room_KeyValue_value}
...
from_214: BinaryAssociation = BinaryAssociation(
    name="from_214",
    ends={
...
from_269: BinaryAssociation = BinaryAssociation(
    name="from_269",
    ends={
...
from_303: BinaryAssociation = BinaryAssociation(
    name="from_303",
    ends={
...
domain_model = DomainModel(
    name="room",
    types={room_Binding, room_LayerConnection, room_ActorContainerClass, StructureClass, room_SPPRef, room_DetailCode, room_RoomModel, room_Documentation, room_Import, room_PrimitiveType, room_ExternalType, room_DataClass, room_GeneralProtocolClass, room_ActorClass, room_SubSystemClass, room_LogicalSystem, room_RoomClass, room_StructureClass, RoomClass, room_Annotation, room_Attribute, room_StandardOperation, room_Operation, room_ActorRef, room_VarDecl, room_RefableType, room_DataType, room_ComplexType, DataType, ComplexType, room_PortClass, room_ProtocolSemantics, room_CompoundProtocolClass, room_SubProtocol, Operation, room_PortOperation, room_Message, room_ProtocolClass, GeneralProtocolClass, ActorContainerClass, room_Port, room_ExternalPort, room_MessageHandler, room_InMessageHandler, MessageHandler, room_OutMessageHandler, room_SemanticsRule, room_InSemanticsRule, SemanticsRule, room_OutSemanticsRule, room_SubSystemRef, room_ActorContainerRef, ActorContainerRef, room_ServiceImplementation, room_SAPRef, room_StateGraph, room_InterfaceItem, InterfaceItem, room_StateGraphNode, StateGraphItem, room_StateGraphItem, room_State, StateGraphNode, room_LogicalThread, room_ActorInstancePath, room_BindingEndPoint, room_SAPoint, room_SPPoint, room_RefSAPoint, SAPoint, room_RelaySAPoint, room_EntryPoint, room_ExitPoint, room_TransitionTerminal, room_NonInitialTransition, Transition, room_TrPoint, room_ChoicePoint, room_Transition, room_RefinedTransition, room_SimpleState, State, room_RefinedState, room_TransitionPoint, TrPoint, room_StateTerminal, TransitionTerminal, room_TrPointTerminal, room_SubStateTrPointTerminal, room_TransitionChainStartTransition, NonInitialTransition, room_InitialTransition, room_ContinuationTransition, room_TriggeredTransition, TransitionChainStartTransition, room_Trigger, room_GuardedTransition, room_CPBranchTransition, room_ChoicepointTerminal, room_MessageFromIf, room_Guard, room_KeyValue, LiteralType, CommunicationType, ActorCommunicationType},
    associations={bindings20, connections22, ifSPPs24, userCode125, userCode227, docu0, imports1, primitiveTypes3, externalTypes5, dataClasses7, protocolClasses9, actorClasses11, subSystemClasses13, systems15, docu17, annotations19, userCode350, attributes53, operations55, refType57, docu60, userCode330, arguments63, returntype65, actorRefs33, refType35, type36, base39, annotations41, userCode144, userCode247, outgoingMessages92, regular95, conjugate97, semantics100, subProtocols102, protocol103, data106, docu68, detailCode71, sendsMsg74, annotations75, base79, userCode180, userCode283, userCode386, incomingMessages89, base138, ifPorts140, structureDocu142, intPorts145, extPorts148, docu109, userCode112, attributes115, operations118, msgHandlers121, msg123, detailCode126, rules129, msg131, followUps135, protocol180, spp183, subSystems186, docu188, type190, serviceImplementations150, relayPorts193, strSAPs152, attributes154, behaviorDocu157, behaviorAnnotations160, operations163, stateMachine166, protocol168, docu171, ifport174, protocol177, ref222, service225, type228, docu231, entryCode233, threads196, instances198, endpoint1200, endpoint2202, actorRef205, port208, sub211, from_214, to216, ref218, relay220, docu258, to261, docu263, action266, from_269, exitCode236, doCode239, subgraph242, states245, trPoints248, chPoints250, transitions252, refinedTransitions254, target256, action282, state285, trPoint287, trPoint289, state291, triggers271, guard272, condition274, target276, docu279, cp294, msgFromIfPairs296, guard298, message300, from_303, guard305, attributes308},
    generalizations={gen_room_ActorContainerClass_StructureClass, gen_room_StructureClass_RoomClass, gen_room_DataType_RoomClass, gen_room_ComplexType_DataType, gen_room_PrimitiveType_DataType, gen_room_ExternalType_ComplexType, gen_room_DataClass_ComplexType, gen_room_CompoundProtocolClass_GeneralProtocolClass, gen_room_StandardOperation_Operation, gen_room_PortOperation_Operation, gen_room_GeneralProtocolClass_RoomClass, gen_room_ProtocolClass_GeneralProtocolClass, gen_room_ActorClass_ActorContainerClass, gen_room_InMessageHandler_MessageHandler, gen_room_OutMessageHandler_MessageHandler, gen_room_InSemanticsRule_SemanticsRule, gen_room_SPPRef_InterfaceItem, gen_room_OutSemanticsRule_SemanticsRule, gen_room_LogicalSystem_StructureClass, gen_room_SubSystemRef_ActorContainerRef, gen_room_SubSystemClass_ActorContainerClass, gen_room_Port_InterfaceItem, gen_room_SAPRef_InterfaceItem, gen_room_ActorRef_ActorContainerRef, gen_room_StateGraphNode_StateGraphItem, gen_room_State_StateGraphNode, gen_room_RefSAPoint_SAPoint, gen_room_RelaySAPoint_SAPoint, gen_room_EntryPoint_TrPoint, gen_room_ExitPoint_TrPoint, gen_room_ChoicePoint_StateGraphNode, gen_room_Transition_StateGraphItem, gen_room_NonInitialTransition_Transition, gen_room_SimpleState_State, gen_room_RefinedState_State, gen_room_TrPoint_StateGraphNode, gen_room_TransitionPoint_TrPoint, gen_room_StateTerminal_TransitionTerminal, gen_room_TrPointTerminal_TransitionTerminal, gen_room_SubStateTrPointTerminal_TransitionTerminal, gen_room_TransitionChainStartTransition_NonInitialTransition, gen_room_InitialTransition_Transition, gen_room_ContinuationTransition_NonInitialTransition, gen_room_TriggeredTransition_TransitionChainStartTransition, gen_room_GuardedTransition_TransitionChainStartTransition, gen_room_CPBranchTransition_NonInitialTransition, gen_room_ChoicepointTerminal_TransitionTerminal},
    metadata=None
)
