...
behavior_BehavioralFeature = Class(name="behavior_BehavioralFeature", is_abstract=True)
Feature = Class(name="Feature")
NamedElement = Class(name="NamedElement")
behavior_Behavior = Class(name="behavior_Behavior", is_abstract=True)
behavior_Operation = Class(name="behavior_Operation")
BehavioralFeature = Class(name="BehavioralFeature")
behavior_NamedElement = Class(name="behavior_NamedElement", is_abstract=True)
Element = Class(name="Element")
Class_ = Class(name="Class")
behavior_BehavioredClassifier = Class(name="behavior_BehavioredClassifier", is_abstract=True)
behavior_DestructionEvent = Class(name="behavior_DestructionEvent")
behavior_Lifeline = Class(name="behavior_Lifeline")
behavior_Classifier = Class(name="behavior_Classifier", is_abstract=True)
Namespace = Class(name="Namespace")
behavior_Feature = Class(name="behavior_Feature", is_abstract=True)
behavior_Actor = Class(name="behavior_Actor")
Object = Class(name="Object")
behavior_Class = Class(name="behavior_Class")
BehavioredClassifier = Class(name="BehavioredClassifier")
behavior_Namespace = Class(name="behavior_Namespace")
behavior_RedefinableElement = Class(name="behavior_RedefinableElement", is_abstract=True)
behavior_Element = Class(name="behavior_Element", is_abstract=True)
behavior_Comment = Class(name="behavior_Comment")
behavior_Message = Class(name="behavior_Message")
behavior_Interaction = Class(name="behavior_Interaction")
behavior_MessageEnd = Class(name="behavior_MessageEnd")
behavior_Connector = Class(name="behavior_Connector")
behavior_InteractionFragment = Class(name="behavior_InteractionFragment", is_abstract=True)
behavior_Event = Class(name="behavior_Event", is_abstract=True)
behavior_BehaviorExecutionSpecification = Class(name="behavior_BehaviorExecutionSpecification")
Behavior = Class(name="Behavior")
InteractionFragment = Class(name="InteractionFragment")
behavior_GeneralOrdering = Class(name="behavior_GeneralOrdering")
RedefinableElement = Class(name="RedefinableElement")
behavior_OccurrenceSpecification = Class(name="behavior_OccurrenceSpecification")
behavior_ExecutionSpecification = Class(name="behavior_ExecutionSpecification", is_abstract=True)
behavior_CreatEvent = Class(name="behavior_CreatEvent")
Event = Class(name="Event")
behavior_ExecutionEvent = Class(name="behavior_ExecutionEvent")
behavior_MessageOccurrenceSpecification = Class(name="behavior_MessageOccurrenceSpecification")
OccurrenceSpecification = Class(name="OccurrenceSpecification")
MessageEnd = Class(name="MessageEnd")
behavior_ExecutionOccurrenceSpecification = Class(name="behavior_ExecutionOccurrenceSpecification")
ExecutionSpecification = Class(name="ExecutionSpecification")
behavior_Object = Class(name="behavior_Object")
behavior_OptionalMessage = Class(name="behavior_OptionalMessage")
Message = Class(name="Message")
behavior_AlternativeMessage = Class(name="behavior_AlternativeMessage")
...
domain_model = DomainModel(
    name="behavior",
    types={Classifier, behavior_BehavioralFeature, Feature, NamedElement, behavior_Behavior, behavior_Operation, BehavioralFeature, behavior_NamedElement, Element, Class_, behavior_BehavioredClassifier, behavior_DestructionEvent, behavior_Lifeline, behavior_Classifier, Namespace, behavior_Feature, behavior_Actor, Object, behavior_Class, BehavioredClassifier, behavior_Namespace, behavior_RedefinableElement, behavior_Element, behavior_Comment, behavior_Message, behavior_Interaction, behavior_MessageEnd, behavior_Connector, behavior_InteractionFragment, behavior_Event, behavior_BehaviorExecutionSpecification, Behavior, InteractionFragment, behavior_GeneralOrdering, RedefinableElement, behavior_OccurrenceSpecification, behavior_ExecutionSpecification, behavior_CreatEvent, Event, behavior_ExecutionEvent, behavior_MessageOccurrenceSpecification, OccurrenceSpecification, MessageEnd, behavior_ExecutionOccurrenceSpecification, ExecutionSpecification, behavior_Object, behavior_OptionalMessage, Message, behavior_AlternativeMessage},
    associations={classifierBehavior6, method0, context1, specification2, redefinedBehavior4, endby45, ownedBehavior9, include12, inheritedMember13, redefinedClassifier15, general18, feature20, nestedClassifier21, redefinitionContext23, redefinableELement26, ownedComment28, owner30, ownedElement33, interaction35, receiveEvent36, sendEvent37, connector40, coveredBy42, interaction43, actor46, behaviorExecution47, fragment48, object50, destructionevent52, lifeline54, message57, covered59, enclosingInteraction61, generalOrdering63, annotatedElement64, featuringClassifier67, toAfter68, toBefore69, start71, finish72, message75, contract78, end81, interaction83, event85, execution86, before88, after89, messages91},
    generalizations={gen_behavior_BehavioredClassifier_Classifier, gen_behavior_BehavioralFeature_Feature, gen_behavior_BehavioralFeature_NamedElement, gen_behavior_Operation_BehavioralFeature, gen_behavior_NamedElement_Element, gen_behavior_Behavior_Class, gen_behavior_Classifier_Namespace, gen_behavior_Actor_Object, gen_behavior_Class_BehavioredClassifier, gen_behavior_Namespace_NamedElement, gen_behavior_RedefinableElement_NamedElement, gen_behavior_Message_NamedElement, gen_behavior_Lifeline_NamedElement, gen_behavior_Event_NamedElement, gen_behavior_Interaction_Behavior, gen_behavior_Interaction_InteractionFragment, gen_behavior_InteractionFragment_NamedElement, gen_behavior_Comment_Element, gen_behavior_Feature_RedefinableElement, gen_behavior_OccurrenceSpecification_InteractionFragment, gen_behavior_ExecutionSpecification_InteractionFragment, gen_behavior_MessageEnd_NamedElement, gen_behavior_Connector_Feature, gen_behavior_CreatEvent_Event, gen_behavior_DestructionEvent_Event, gen_behavior_ExecutionEvent_Event, gen_behavior_MessageOccurrenceSpecification_OccurrenceSpecification, gen_behavior_MessageOccurrenceSpecification_MessageEnd, gen_behavior_ExecutionOccurrenceSpecification_OccurrenceSpecification, gen_behavior_GeneralOrdering_NamedElement, gen_behavior_BehaviorExecutionSpecification_ExecutionSpecification, gen_behavior_Object_BehavioredClassifier, gen_behavior_OptionalMessage_Message, gen_behavior_AlternativeMessage_Message},
    metadata=None
)
