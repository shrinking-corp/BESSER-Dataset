...
class behavior_Message(NamedElement):
    ...
    def __init__(self, MessageOrder: int, message: "behavior_Interaction" = None, behavior_Message: "behavior_MessageEnd" = None, behavior_Message38: "behavior_MessageEnd" = None, behavior_Message41: "behavior_Connector" = None, Message: "behavior_Interaction" = None, behavior_Message77: "behavior_MessageEnd" = None, behavior_Message92: "behavior_AlternativeMessage" = None):
...
class behavior_Connector(Feature):
    ...
    pass
class behavior_BehavioralFeature(Feature, NamedElement):
