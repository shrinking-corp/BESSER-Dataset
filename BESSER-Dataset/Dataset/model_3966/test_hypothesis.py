...
def test_behavior_alternativemessage_is_not_abstract():
    assert not inspect.isabstract(behavior_AlternativeMessage)


def test_behavior_alternativemessage_constructor_exists():
    assert callable(behavior_AlternativeMessage.__init__)


def test_behavior_alternativemessage_constructor_args():
    sig = inspect.signature(behavior_AlternativeMessage.__init__)
    params = list(sig.parameters.keys())



def test_behavior_optionalmessage_is_not_abstract():
    assert not inspect.isabstract(behavior_OptionalMessage)


def test_behavior_optionalmessage_constructor_exists():
    assert callable(behavior_OptionalMessage.__init__)


def test_behavior_optionalmessage_constructor_args():
