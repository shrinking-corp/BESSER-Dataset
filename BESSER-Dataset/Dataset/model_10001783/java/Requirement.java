...
public class Requirement  {
    ...
    public Requirement(
        String req_description,        String requirement_type,        String requirement_location,        String user_id    ) {
    ...
    public Requirement(
        String req_description,        String requirement_type,        String requirement_location,        String user_id        ArrayList<Reg_User> reg_users    ) {
        this.req_description = req_description;
        this.requirement_type = requirement_type;
        this.requirement_location = requirement_location;
        this.user_id = user_id;
