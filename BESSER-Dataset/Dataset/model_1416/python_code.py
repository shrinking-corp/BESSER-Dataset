...
class NHSM_StateMachine:
    ...
    def __init__(self, name: str, machine: set["NHSM_State"] = None, StateMachine: "NHSM_State" = None, NHSM_StateMachine10: "NHSM_Transition" = None, NHSM_StateMachine: set["NHSM_Transition"] = None):
        self.name = name
