...
class gmfgraph_FlowLayout(Layout):
    ...
    def __init__(self, majorAlignment: str, minorAlignment: str, majorSpacing: int, minorSpacing: int, vertical: bool, matchMinorSize: bool, forceSingleLine: bool):
...
class gmfgraph_BasicFont(Font):
    ...
    def __init__(self, style: str, faceName: str, height: int):
        self.style = style
