...
class qsar_ResponseType:
    ...
    def __init__(self, value: str, arrayValues: str, structureID: str, unit: str, qsar_ResponseType: "qsar_ResponsesListType" = None):
        self.value = value
    ...
    def arrayValues(self):
        return self.__arrayValues

    @arrayValues.setter
    def arrayValues(self, arrayValues: str):
        self.__arrayValues = arrayValues
...
class qsar_StructureType:
    ...
    def __init__(self, resourceindex: str, id: str, inchi: str, resourceid: str, qsar_StructureType: "qsar_ResourceType" = None):
...
class qsar_ResourceType:
    ...
    def __init__(self, checksum: str, excluded: str, file: str, id: str, name: str, no2d: str, no3d: str, noMols: str, type: str, uRL: str, qsar_ResourceType: set["qsar_StructureType"] = None, qsar_ResourceType39: "qsar_StructurelistType" = None):
...
class qsar_MetadataType:
    ...
    def __init__(self, license: str, uRL: str, authors: str, datasetname: str, description: str, qsar_MetadataType30: "qsar_QsarType" = None, qsar_MetadataType: set["qsar_BibTeXMLEntriesClass"] = None):
...
class qsar_DocumentRoot:
    ...
    def __init__(self, mixed: str, qsar_DocumentRoot: set["qsar_EStringToStringMapEntry"] = None, qsar_DocumentRoot8: set["qsar_EStringToStringMapEntry"] = None, qsar_DocumentRoot11: set["qsar_QsarType"] = None):
        self.mixed = mixed
...
class qsar_DescriptorresultType:
    ...
    def __init__(self, descriptorid: str, structureid: str, qsar_DescriptorresultType: "qsar_DescriptorresultlistsType" = None, qsar_DescriptorresultType3: set["qsar_DescriptorvalueType"] = None):
...
class qsar_DescriptorproviderType:
    ...
    def __init__(self, name: str, uRL: str, id: str, vendor: str, version: str, qsar_DescriptorproviderType: "qsar_QsarType" = None):
        self.name = name
        self.uRL = uRL
        self.id = id
        self.vendor = vendor
