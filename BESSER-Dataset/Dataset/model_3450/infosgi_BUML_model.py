...
# Classes
org_aries_common_Attachment = Class(name="org_aries_common_Attachment")
Attachment = Class(name="Attachment")
EmailAccount = Class(name="EmailAccount")
org_aries_common_DocumentRoot = Class(name="org_aries_common_DocumentRoot")
org_aries_common_EStringToStringMapEntry = Class(name="org_aries_common_EStringToStringMapEntry")
...
org_aries_common_EmailAccount = Class(name="org_aries_common_EmailAccount")
org_aries_common_EmailAddress = Class(name="org_aries_common_EmailAddress")
org_aries_common_EmailAddressList = Class(name="org_aries_common_EmailAddressList")
org_aries_common_EmailBox = Class(name="org_aries_common_EmailBox")
org_aries_common_EmailMessage = Class(name="org_aries_common_EmailMessage")
org_aries_common_Event = Class(name="org_aries_common_Event")
org_aries_common_Note = Class(name="org_aries_common_Note")
org_aries_common_Map = Class(name="org_aries_common_Map")
org_aries_common_MapEntry = Class(name="org_aries_common_MapEntry")
org_aries_common_EObject = Class(name="org_aries_common_EObject")
org_aries_common_PersonName = Class(name="org_aries_common_PersonName")
org_aries_common_Person = Class(name="org_aries_common_Person")
org_aries_common_Properties = Class(name="org_aries_common_Properties")
org_aries_common_Property = Class(name="org_aries_common_Property")
org_aries_common_PhoneNumber = Class(name="org_aries_common_PhoneNumber")
org_aries_common_StreetAddress = Class(name="org_aries_common_StreetAddress")
org_aries_common_ZipCode = Class(name="org_aries_common_ZipCode")
org_aries_common_User = Class(name="org_aries_common_User")
EmailList = Class(name="EmailList")
FamilyMember = Class(name="FamilyMember")
GohonzonInfo = Class(name="GohonzonInfo")
org_sgiusa_model_DocumentRoot = Class(name="org_sgiusa_model_DocumentRoot")
org_sgiusa_model_EStringToStringMapEntry = Class(name="org_sgiusa_model_EStringToStringMapEntry")
...
org_sgiusa_model_EmailList = Class(name="org_sgiusa_model_EmailList")
...
org_sgiusa_model_Event = Class(name="org_sgiusa_model_Event")
org_sgiusa_model_FamilyMember = Class(name="org_sgiusa_model_FamilyMember")
org_sgiusa_model_GohonzonInfo = Class(name="org_sgiusa_model_GohonzonInfo")
org_sgiusa_model_LeadershipRole = Class(name="org_sgiusa_model_LeadershipRole")
org_sgiusa_model_LeadershipInfo = Class(name="org_sgiusa_model_LeadershipInfo")
org_sgiusa_model_Member = Class(name="org_sgiusa_model_Member")
org_sgiusa_model_MemberSearchCriteria = Class(name="org_sgiusa_model_MemberSearchCriteria")
org_sgiusa_model_Members = Class(name="org_sgiusa_model_Members")
org_sgiusa_model_Note = Class(name="org_sgiusa_model_Note")
org_sgiusa_model_MembershipInfo = Class(name="org_sgiusa_model_MembershipInfo")
org_sgiusa_model_Organization = Class(name="org_sgiusa_model_Organization")
org_sgiusa_model_Permission = Class(name="org_sgiusa_model_Permission")
org_sgiusa_model_Preferences = Class(name="org_sgiusa_model_Preferences")
org_sgiusa_model_SchoolInfo = Class(name="org_sgiusa_model_SchoolInfo")
org_sgiusa_model_Registration = Class(name="org_sgiusa_model_Registration")
org_sgiusa_model_StudyDeptExam = Class(name="org_sgiusa_model_StudyDeptExam")
org_sgiusa_model_User = Class(name="org_sgiusa_model_User")
org_sgiusa_model_StudyDeptInfo = Class(name="org_sgiusa_model_StudyDeptInfo")
org_sgiusa_model_Users = Class(name="org_sgiusa_model_Users")
org_sgiusa_model_View = Class(name="org_sgiusa_model_View")
...
org_aries_common_Attachment.attributes={org_aries_common_Attachment_name, org_aries_common_Attachment_fileData, org_aries_common_Attachment_id, org_aries_common_Attachment_fileName, org_aries_common_Attachment_contentType, org_aries_common_Attachment_size}
...
org_aries_common_EmailAccount.attributes={org_aries_common_EmailAccount_firstName, org_aries_common_EmailAccount_enabled, org_aries_common_EmailAccount_userId, org_aries_common_EmailAccount_password, org_aries_common_EmailAccount_lastName, org_aries_common_EmailAccount_id}
...
org_aries_common_EmailAddress.attributes={org_aries_common_EmailAddress_firstName, org_aries_common_EmailAddress_creationDate, org_aries_common_EmailAddress_enabled, org_aries_common_EmailAddress_url, org_aries_common_EmailAddress_userId, org_aries_common_EmailAddress_organization, org_aries_common_EmailAddress_id, org_aries_common_EmailAddress_lastUpdate, org_aries_common_EmailAddress_lastName}
...
org_aries_common_EmailBox.attributes={org_aries_common_EmailBox_name, org_aries_common_EmailBox_type, org_aries_common_EmailBox_lastUpdate, org_aries_common_EmailBox_creationDate, org_aries_common_EmailBox_id}
...
org_aries_common_EmailMessage.attributes={org_aries_common_EmailMessage_timestamp, org_aries_common_EmailMessage_sourceId, org_aries_common_EmailMessage_sendAsHtml, org_aries_common_EmailMessage_smtpHost, org_aries_common_EmailMessage_subject, org_aries_common_EmailMessage_id, org_aries_common_EmailMessage_smtpPort, org_aries_common_EmailMessage_content}
...
org_aries_common_Note.attributes={org_aries_common_Note_lastUpdate, org_aries_common_Note_id, org_aries_common_Note_text, org_aries_common_Note_creationDate}
...
org_aries_common_PersonName.attributes={org_aries_common_PersonName_firstName, org_aries_common_PersonName_middleInitial, org_aries_common_PersonName_lastName}
...
org_aries_common_Property.attributes={org_aries_common_Property_mixed, org_aries_common_Property_value, org_aries_common_Property_id, org_aries_common_Property_name}
...
org_aries_common_PhoneNumber.attributes={org_aries_common_PhoneNumber_type, org_aries_common_PhoneNumber_id, org_aries_common_PhoneNumber_extension, org_aries_common_PhoneNumber_area, org_aries_common_PhoneNumber_number, org_aries_common_PhoneNumber_country, org_aries_common_PhoneNumber_value}
...
org_aries_common_StreetAddress.attributes={org_aries_common_StreetAddress_id, org_aries_common_StreetAddress_country, org_aries_common_StreetAddress_longitude, org_aries_common_StreetAddress_street, org_aries_common_StreetAddress_state, org_aries_common_StreetAddress_latitude, org_aries_common_StreetAddress_city}
...
org_aries_common_ZipCode.attributes={org_aries_common_ZipCode_country, org_aries_common_ZipCode_extension, org_aries_common_ZipCode_number}
...
org_aries_common_User.attributes={org_aries_common_User_firstName, org_aries_common_User_id, org_aries_common_User_lastName, org_aries_common_User_userId, org_aries_common_User_password, org_aries_common_User_enabled}
...
org_sgiusa_model_EmailList.attributes={org_sgiusa_model_EmailList_subDivisions, org_sgiusa_model_EmailList_divisions, org_sgiusa_model_EmailList_id, org_sgiusa_model_EmailList_enabled, org_sgiusa_model_EmailList_activityGroups}
...
org_sgiusa_model_Event.attributes={org_sgiusa_model_Event_userId, org_sgiusa_model_Event_id, org_sgiusa_model_Event_status, org_sgiusa_model_Event_divisions, org_sgiusa_model_Event_subDivisions}
...
org_sgiusa_model_FamilyMember.attributes={org_sgiusa_model_FamilyMember_personName, org_sgiusa_model_FamilyMember_lastUpdate, org_sgiusa_model_FamilyMember_familyRelation, org_sgiusa_model_FamilyMember_id, org_sgiusa_model_FamilyMember_sgiMember}
...
org_sgiusa_model_GohonzonInfo.attributes={org_sgiusa_model_GohonzonInfo_id, org_sgiusa_model_GohonzonInfo_returned, org_sgiusa_model_GohonzonInfo_receiveDate, org_sgiusa_model_GohonzonInfo_gohonzonType, org_sgiusa_model_GohonzonInfo_returnDate, org_sgiusa_model_GohonzonInfo_lastUpdate}
...
org_sgiusa_model_LeadershipRole.attributes={org_sgiusa_model_LeadershipRole_active, org_sgiusa_model_LeadershipRole_startDate, org_sgiusa_model_LeadershipRole_position, org_sgiusa_model_LeadershipRole_level, org_sgiusa_model_LeadershipRole_endDate, org_sgiusa_model_LeadershipRole_id, org_sgiusa_model_LeadershipRole_division, org_sgiusa_model_LeadershipRole_subDivision, org_sgiusa_model_LeadershipRole_activityGroup, org_sgiusa_model_LeadershipRole_lastUpdate}
...
org_sgiusa_model_Member.attributes={org_sgiusa_model_Member_occupation, org_sgiusa_model_Member_id, org_sgiusa_model_Member_archived, org_sgiusa_model_Member_locatable, org_sgiusa_model_Member_employer, org_sgiusa_model_Member_statusProfile, org_sgiusa_model_Member_activityGroups, org_sgiusa_model_Member_lastName, org_sgiusa_model_Member_division, org_sgiusa_model_Member_interests, org_sgiusa_model_Member_extraField2, org_sgiusa_model_Member_firstName, org_sgiusa_model_Member_languages, org_sgiusa_model_Member_joinDate, org_sgiusa_model_Member_extraField1, org_sgiusa_model_Member_middleInitial, org_sgiusa_model_Member_birthDate, org_sgiusa_model_Member_subDivision, org_sgiusa_model_Member_visible}
...
org_sgiusa_model_MemberSearchCriteria.attributes={org_sgiusa_model_MemberSearchCriteria_subDivisions, org_sgiusa_model_MemberSearchCriteria_activityGroups, org_sgiusa_model_MemberSearchCriteria_divisions}
...
org_sgiusa_model_Note.attributes={org_sgiusa_model_Note_lastUpdate, org_sgiusa_model_Note_creationDate, org_sgiusa_model_Note_id, org_sgiusa_model_Note_text}
...
org_sgiusa_model_MembershipInfo.attributes={org_sgiusa_model_MembershipInfo_receivedCertificate, org_sgiusa_model_MembershipInfo_friendOfSgi, org_sgiusa_model_MembershipInfo_notLocatable, org_sgiusa_model_MembershipInfo_id, org_sgiusa_model_MembershipInfo_lastUpdate, org_sgiusa_model_MembershipInfo_notActivated}
...
org_sgiusa_model_Organization.attributes={org_sgiusa_model_Organization_creationDate, org_sgiusa_model_Organization_level, org_sgiusa_model_Organization_permissionId, org_sgiusa_model_Organization_organizationId, org_sgiusa_model_Organization_id, org_sgiusa_model_Organization_abbrv, org_sgiusa_model_Organization_name, org_sgiusa_model_Organization_zipCodes, org_sgiusa_model_Organization_type, org_sgiusa_model_Organization_lastUpdate, org_sgiusa_model_Organization_label}
...
org_sgiusa_model_Permission.attributes={org_sgiusa_model_Permission_capabilities, org_sgiusa_model_Permission_userId, org_sgiusa_model_Permission_subDivisions, org_sgiusa_model_Permission_id, org_sgiusa_model_Permission_divisions, org_sgiusa_model_Permission_activityGroups, org_sgiusa_model_Permission_enabled}
...
org_sgiusa_model_Preferences.attributes={org_sgiusa_model_Preferences_enableTooltips, org_sgiusa_model_Preferences_id, org_sgiusa_model_Preferences_openNodes, org_sgiusa_model_Preferences_openViews, org_sgiusa_model_Preferences_selectedNode, org_sgiusa_model_Preferences_themeId, org_sgiusa_model_Preferences_selectedView, org_sgiusa_model_Preferences_userId}
...
org_sgiusa_model_SchoolInfo.attributes={org_sgiusa_model_SchoolInfo_fieldOfStudy, org_sgiusa_model_SchoolInfo_startDate, org_sgiusa_model_SchoolInfo_schoolType, org_sgiusa_model_SchoolInfo_endDate, org_sgiusa_model_SchoolInfo_schoolName, org_sgiusa_model_SchoolInfo_id, org_sgiusa_model_SchoolInfo_lastUpdate}
...
org_sgiusa_model_Registration.attributes={org_sgiusa_model_Registration_date, org_sgiusa_model_Registration_id, org_sgiusa_model_Registration_cancelled, org_sgiusa_model_Registration_aborted}
...
org_sgiusa_model_StudyDeptExam.attributes={org_sgiusa_model_StudyDeptExam_lastUpdate, org_sgiusa_model_StudyDeptExam_examLanguage, org_sgiusa_model_StudyDeptExam_id, org_sgiusa_model_StudyDeptExam_examLocation, org_sgiusa_model_StudyDeptExam_examDate, org_sgiusa_model_StudyDeptExam_examLevel, org_sgiusa_model_StudyDeptExam_current}
...
org_sgiusa_model_User.attributes={org_sgiusa_model_User_lastName, org_sgiusa_model_User_password, org_sgiusa_model_User_enabled, org_sgiusa_model_User_role, org_sgiusa_model_User_firstName, org_sgiusa_model_User_id, org_sgiusa_model_User_userId}
...
org_sgiusa_model_View.attributes={org_sgiusa_model_View_id, org_sgiusa_model_View_userId, org_sgiusa_model_View_viewType}
...
domain_model = DomainModel(
    ...
    types={org_aries_common_Attachment, Attachment, EmailAccount, org_aries_common_DocumentRoot, org_aries_common_EStringToStringMapEntry, Event, Map, EmailAddress, EmailAddressList, EmailBox, EmailMessage, PhoneNumber, Properties, Property_, MapEntry, Note, Person, PersonName, StreetAddress, User, ZipCode, org_aries_common_EmailAccount, org_aries_common_EmailAddress, org_aries_common_EmailAddressList, org_aries_common_EmailBox, org_aries_common_EmailMessage, org_aries_common_Event, org_aries_common_Note, org_aries_common_Map, org_aries_common_MapEntry, org_aries_common_EObject, org_aries_common_PersonName, org_aries_common_Person, org_aries_common_Properties, org_aries_common_Property, org_aries_common_PhoneNumber, org_aries_common_StreetAddress, org_aries_common_ZipCode, org_aries_common_User, EmailList, FamilyMember, GohonzonInfo, org_sgiusa_model_DocumentRoot, org_sgiusa_model_EStringToStringMapEntry, MembershipInfo, Organization, Permission, Preferences, LeadershipInfo, LeadershipRole, Member, Members, MemberSearchCriteria, Users, View, org_sgiusa_model_EmailList, Registration, SchoolInfo, StudyDeptExam, StudyDeptInfo, org_sgiusa_model_Event, org_sgiusa_model_FamilyMember, org_sgiusa_model_GohonzonInfo, org_sgiusa_model_LeadershipRole, org_sgiusa_model_LeadershipInfo, org_sgiusa_model_Member, org_sgiusa_model_MemberSearchCriteria, org_sgiusa_model_Members, org_sgiusa_model_Note, org_sgiusa_model_MembershipInfo, org_sgiusa_model_Organization, org_sgiusa_model_Permission, org_sgiusa_model_Preferences, org_sgiusa_model_SchoolInfo, org_sgiusa_model_Registration, org_sgiusa_model_StudyDeptExam, org_sgiusa_model_User, org_sgiusa_model_StudyDeptInfo, org_sgiusa_model_Users, org_sgiusa_model_View, Country, Language, PhoneNumberType, RoleType, State, Status, Capability, ActivityGroup, ActivityGroupName, DivisionName, Division, FamilyRelation, EventStatus, GohonzonType, OrganizationLevel, Position, PositionName, Role, StudyDeptExamLevel, SchoolType, SubDivision, SubDivisionName, StudyDeptLanguage, ViewType},
    associations={xSISchemaLocation1, attachment4, emailAccount6, xMLNSPrefixMap0, event16, map18, emailAddress8, emailAddressList10, emailBox12, emailMessage14, phoneNumber28, properties30, property32, mapEntry20, note22, person24, personName26, streetAddress34, user36, zipCode38, emailBoxes40, phoneNumber42, parentBox46, messageList49, emailAccount44, fromAddress52, toAddressList54, user72, bccAddressList57, ccAddressList60, replytoAddressList63, adminAddressList66, attachments69, author80, mapEntry74, key76, value77, phoneNumber84, emailAddress87, streetAddress90, name82, property93, zip95, phoneNumber97, emailAddress99, emailList106, event108, familyMember111, gohonzonInfo113, xMLNSPrefixMap102, xSISchemaLocation103, membershipInfo125, note127, organization130, permission132, leadershipInfo115, leadershipRole117, member119, members121, memberSearchCriteria123, user144, users147, view149, preferences134, registration136, schoolInfo138, studyDeptExam140, studyDeptInfo142, organization156, organization151, emailAddressList153, leadershipRoles158, emailAddress160, organization177, leadershipInfo180, studyDeptInfo183, streetAddress162, homePhone165, cellPhone168, workPhone171, otherPhone174, familyInfo189, notes186, record192, organization194, gohonzons196, author198, parent200, children202, creator205, provider208, accessors211, organization214, user216, studyDeptExams218, emailAddress222, streetAddress225, cellPhone228, homePhone231, emailAccount220, organization242, permissions234, preferences237, record240},
    generalizations={},
    metadata=None
)
