...
class org_sgiusa_model_View:
    ...
    def __init__(self, viewType: str, id: str, userId: str, org_sgiusa_model_View: "Organization" = None):
...
class org_sgiusa_model_User:
    ...
    def __init__(self, role: str, id: str, userId: str, password: str, enabled: str, firstName: str, lastName: str, org_sgiusa_model_User: "EmailAccount" = None, org_sgiusa_model_User235: set["Permission"] = None, org_sgiusa_model_User238: "Preferences" = None, org_sgiusa_model_User223: "EmailAddress" = None, org_sgiusa_model_User226: "StreetAddress" = None, org_sgiusa_model_User229: "PhoneNumber" = None, org_sgiusa_model_User232: "PhoneNumber" = None):
        self.role = role
        self.id = id
        self.userId = userId
...
class org_sgiusa_model_StudyDeptExam:
    ...
    def __init__(self, current: str, examLevel: str, examLanguage: str, examLocation: str, examDate: str, lastUpdate: str, id: str):
...
class org_sgiusa_model_Registration:
    ...
    def __init__(self, id: str, date: str, cancelled: str, aborted: str, org_sgiusa_model_Registration: "User" = None):
        self.id = id
        self.date = date
...
class org_sgiusa_model_SchoolInfo:
    ...
    def __init__(self, id: str, schoolName: str, schoolType: str, fieldOfStudy: str, startDate: str, endDate: str, lastUpdate: str):
        self.id = id
...
class org_sgiusa_model_Preferences:
    ...
    def __init__(self, userId: str, themeId: str, openViews: str, openNodes: str, selectedView: str, id: str, selectedNode: str, enableTooltips: str):
        self.userId = userId
...
class org_sgiusa_model_Permission:
    ...
    def __init__(self, activityGroups: str, capabilities: str, id: str, userId: str, enabled: str, divisions: str, subDivisions: str, org_sgiusa_model_Permission: "Organization" = None):
...
class org_sgiusa_model_Organization:
    ...
    def __init__(self, organizationId: str, permissionId: str, type: str, level: str, name: str, abbrv: str, zipCodes: str, id: str, creationDate: str, lastUpdate: str, label: str, org_sgiusa_model_Organization: "Organization" = None, org_sgiusa_model_Organization203: set["Organization"] = None, org_sgiusa_model_Organization206: "User" = None, org_sgiusa_model_Organization209: "User" = None, org_sgiusa_model_Organization212: set["User"] = None):
...
class org_sgiusa_model_Member:
    ...
    def __init__(self, id: str, firstName: str, lastName: str, middleInitial: str, division: str, subDivision: str, activityGroups: str, birthDate: str, employer: str, occupation: str, statusProfile: str, interests: str, languages: str, joinDate: str, extraField1: str, extraField2: str, visible: str, locatable: str, archived: str, org_sgiusa_model_Member: "EmailAddress" = None, org_sgiusa_model_Member178: "Organization" = None, org_sgiusa_model_Member181: "LeadershipInfo" = None, org_sgiusa_model_Member184: "StudyDeptInfo" = None, org_sgiusa_model_Member163: "StreetAddress" = None, org_sgiusa_model_Member166: "PhoneNumber" = None, org_sgiusa_model_Member169: "PhoneNumber" = None, org_sgiusa_model_Member172: "PhoneNumber" = None, org_sgiusa_model_Member175: "PhoneNumber" = None, org_sgiusa_model_Member190: "FamilyMember" = None, org_sgiusa_model_Member187: set["Note"] = None):
        self.id = id
        self.firstName = firstName
        self.lastName = lastName
...
class org_sgiusa_model_LeadershipInfo:
    ...
    def __init__(self, lastUpdate: str, id: str, examPassed: str, examPassedDate: str, manualSigned: str, manualSignedDate: str, org_sgiusa_model_LeadershipInfo: set["LeadershipRole"] = None):
        self.lastUpdate = lastUpdate
        self.id = id
...
class org_sgiusa_model_LeadershipRole:
    ...
    def __init__(self, id: str, active: str, level: str, position: str, lastUpdate: str, division: str, subDivision: str, activityGroup: str, startDate: str, endDate: str):
        self.id = id
        self.active = active
        self.level = level
...
class org_sgiusa_model_GohonzonInfo:
    ...
    def __init__(self, receiveDate: str, returned: str, returnDate: str, lastUpdate: str, id: str, gohonzonType: str):
...
class org_sgiusa_model_FamilyMember:
    ...
    def __init__(self, sgiMember: str, familyRelation: str, personName: str, lastUpdate: str, id: str):
...
class org_aries_common_DocumentRoot:
    ...
    def __init__(self, mixed: str, org_aries_common_DocumentRoot19: set["Map"] = None, org_aries_common_DocumentRoot9: set["EmailAddress"] = None, org_aries_common_DocumentRoot11: set["EmailAddressList"] = None, org_aries_common_DocumentRoot13: set["EmailBox"] = None, org_aries_common_DocumentRoot15: set["EmailMessage"] = None, org_aries_common_DocumentRoot29: set["PhoneNumber"] = None, org_aries_common_DocumentRoot31: set["Properties"] = None, org_aries_common_DocumentRoot2: set["org_aries_common_EStringToStringMapEntry"] = None, org_aries_common_DocumentRoot5: set["Attachment"] = None, org_aries_common_DocumentRoot7: set["EmailAccount"] = None, org_aries_common_DocumentRoot: set["org_aries_common_EStringToStringMapEntry"] = None, org_aries_common_DocumentRoot17: set["Event"] = None, org_aries_common_DocumentRoot33: set["Property"] = None, org_aries_common_DocumentRoot21: set["MapEntry"] = None, org_aries_common_DocumentRoot23: set["Note"] = None, org_aries_common_DocumentRoot25: set["Person"] = None, org_aries_common_DocumentRoot27: set["PersonName"] = None, org_aries_common_DocumentRoot35: set["StreetAddress"] = None, org_aries_common_DocumentRoot37: set["User"] = None, org_aries_common_DocumentRoot39: set["ZipCode"] = None):
        self.mixed = mixed
...
class org_aries_common_Attachment:
    ...
    def __init__(self, contentType: str, id: str, name: str, size: str, fileName: str, fileData: str):
...
class org_sgiusa_model_DocumentRoot:
    ...
    def __init__(self, mixed: str, org_sgiusa_model_DocumentRoot116: set["LeadershipInfo"] = None, org_sgiusa_model_DocumentRoot118: set["LeadershipRole"] = None, org_sgiusa_model_DocumentRoot120: set["Member"] = None, org_sgiusa_model_DocumentRoot122: set["Members"] = None, org_sgiusa_model_DocumentRoot124: set["MemberSearchCriteria"] = None, org_sgiusa_model_DocumentRoot145: set["User"] = None, org_sgiusa_model_DocumentRoot148: set["Users"] = None, org_sgiusa_model_DocumentRoot107: set["EmailList"] = None, org_sgiusa_model_DocumentRoot109: set["Event"] = None, org_sgiusa_model_DocumentRoot112: set["FamilyMember"] = None, org_sgiusa_model_DocumentRoot114: set["GohonzonInfo"] = None, org_sgiusa_model_DocumentRoot: set["org_sgiusa_model_EStringToStringMapEntry"] = None, org_sgiusa_model_DocumentRoot104: set["org_sgiusa_model_EStringToStringMapEntry"] = None, org_sgiusa_model_DocumentRoot126: set["MembershipInfo"] = None, org_sgiusa_model_DocumentRoot128: set["Note"] = None, org_sgiusa_model_DocumentRoot131: set["Organization"] = None, org_sgiusa_model_DocumentRoot133: set["Permission"] = None, org_sgiusa_model_DocumentRoot150: set["View"] = None, org_sgiusa_model_DocumentRoot135: set["Preferences"] = None, org_sgiusa_model_DocumentRoot137: set["Registration"] = None, org_sgiusa_model_DocumentRoot139: set["SchoolInfo"] = None, org_sgiusa_model_DocumentRoot141: set["StudyDeptExam"] = None, org_sgiusa_model_DocumentRoot143: set["StudyDeptInfo"] = None):
        self.mixed = mixed
...
class org_aries_common_StreetAddress:
    ...
    def __init__(self, country: str, latitude: str, longitude: str, state: str, street: str, id: str, city: str, org_aries_common_StreetAddress: "ZipCode" = None):
        self.country = country
...
class org_aries_common_PhoneNumber:
    ...
    def __init__(self, value: str, id: str, type: str, area: str, country: str, extension: str, number: str):
        self.value = value
        self.id = id
        self.type = type
        self.area = area
...
class org_aries_common_Person:
    ...
    def __init__(self, id: str, userId: str, org_aries_common_Person85: "PhoneNumber" = None, org_aries_common_Person88: "EmailAddress" = None, org_aries_common_Person91: "StreetAddress" = None, org_aries_common_Person: "PersonName" = None):
        self.id = id
        self.userId = userId
...
class org_aries_common_EmailMessage:
    ...
    def __init__(self, smtpHost: str, smtpPort: str, id: str, content: str, subject: str, timestamp: str, sourceId: str, sendAsHtml: str, org_aries_common_EmailMessage: "EmailAddress" = None, org_aries_common_EmailMessage55: set["EmailAddressList"] = None, org_aries_common_EmailMessage58: set["EmailAddressList"] = None, org_aries_common_EmailMessage61: set["EmailAddressList"] = None, org_aries_common_EmailMessage64: set["EmailAddressList"] = None, org_aries_common_EmailMessage67: set["EmailAddressList"] = None, org_aries_common_EmailMessage70: set["Attachment"] = None):
...
class org_aries_common_EmailBox:
    ...
    def __init__(self, creationDate: str, lastUpdate: str, id: str, type: str, name: str, org_aries_common_EmailBox47: "EmailBox" = None, org_aries_common_EmailBox50: set["EmailMessage"] = None, org_aries_common_EmailBox: "EmailAccount" = None):
        self.creationDate = creationDate
        self.lastUpdate = lastUpdate
        self.id = id
        self.type = type
...
class org_aries_common_EmailAddress:
    ...
    def __init__(self, id: str, url: str, userId: str, lastUpdate: str, enabled: str, firstName: str, lastName: str, organization: str, creationDate: str, org_aries_common_EmailAddress: "PhoneNumber" = None):
        self.id = id
        self.url = url
        self.userId = userId
        self.lastUpdate = lastUpdate
