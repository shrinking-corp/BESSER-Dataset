...
Guestuser = Class(name="Guestuser")
Submit_information = Class(name="Submit_information")
Cancel = Class(name="Cancel")
...
Person.attributes={Person_id_, Person_password_, Person_name_, Person_phone_}

# Driver class attributes and methods
Driver_id: Property = Property(name="id", type=StringType)
Driver_name: Property = Property(name="name", type=StringType)
Driver_phone: Property = Property(name="phone", type=StringType)
Driver_password: Property = Property(name="password", type=StringType)
Driver.attributes={Driver_password, Driver_name, Driver_phone, Driver_id}

# Admin class attributes and methods
Admin_id_: Property = Property(name="id_", type=StringType)
Admin_password: Property = Property(name="password", type=StringType)
Admin.attributes={Admin_password, Admin_id_}
...
User.attributes={User_phone, User_id, User_password, User_name}
...
Book_a_ticek.attributes={Book_a_ticek_starting_city_, Book_a_ticek_ticket_id_, Book_a_ticek_date_, Book_a_ticek_destination_city, Book_a_ticek_time_}

# Guestuser class attributes and methods
...
Submit_information.attributes={Submit_information_password_, Submit_information_name_, Submit_information_username, Submit_information_phone_}

# Cancel class attributes and methods
Cancel_ticket_id_: Property = Property(name="ticket_id_", type=StringType)
Cancel_user_id_: Property = Property(name="user_id_", type=StringType)
Cancel.attributes={Cancel_user_id_, Cancel_ticket_id_}
...
Book_a_ticek_Cancle: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="cancle14", type=Cancel, multiplicity=Multiplicity(0, 1)),
...
Submit_information_Userguest: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="userguest16", type=Guestuser, multiplicity=Multiplicity(0, 1)),
...
Userguest_view_item: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="userguest19", type=Guestuser, multiplicity=Multiplicity(0, 1))
    }
)
