...
class Cancel:
    ...
    def book_a_ticek15(self, value):
        ...
        old_value = getattr(self, f"_Cancel__book_a_ticek15", None)
...
class Submit_information:
    ...
    def __init__(self, name_: str, phone_: str, password_: str, username: str, userguest16: "Guestuser" = None):
        self.name_ = name_
        self.phone_ = phone_
...
class Book_a_ticek:
    ...
    def __init__(self, date_: str, starting_city_: str, destination_city: str, time_: str, ticket_id_: str, pay12: "Pay" = None, cancle14: "Cancel" = None):
        self.date_ = date_
...
class view_item:
    ...
    def __init__(self, ticket_id_: str, userguest19: "Guestuser" = None, login21: "Login" = None):
        self.ticket_id_ = ticket_id_
...
class User:
    ...
    def __init__(self, id: str, password: str, name: str, phone: str, driver23: "Driver" = None):
        self.id = id
        self.password = password
        self.name = name
        self.phone = phone
        self.driver23 = driver23
    ...
    @property
    def driver23(self):
        return self.__driver23
    @driver23.setter
    def driver23(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_User__driver23", None)
        self.__driver23 = value
...
class Driver:
    ...
    def __init__(self, id: str, name: str, phone: str, password: str, user22: "User" = None):
        self.id = id
        self.name = name
        self.phone = phone
        self.password = password
    ...
    def user22(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Driver__user22", None)
        self.__user22 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "driver23"):
                opp_val = getattr(old_value, "driver23", None)
                if opp_val == self:
                    setattr(old_value, "driver23", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "driver23"):
                opp_val = getattr(value, "driver23", None)
                setattr(value, "driver23", self)
