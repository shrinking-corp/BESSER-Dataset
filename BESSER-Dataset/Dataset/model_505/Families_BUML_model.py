...
# Classes
Families_Company = Class(name="Families_Company")
Families_Parent = Class(name="Families_Parent")
Families_Child = Class(name="Families_Child")
Families_Neighborhood = Class(name="Families_Neighborhood")
Member = Class(name="Member")
Families_School = Class(name="Families_School")
Families_Country = Class(name="Families_Country")
NamedElement = Class(name="NamedElement")
Families_Family = Class(name="Families_Family")
Families_City = Class(name="Families_City")
Families_Member = Class(name="Families_Member", is_abstract=True)
Families_NamedElement = Class(name="Families_NamedElement", is_abstract=True)
Families_Service = Class(name="Families_Service")
...
domain_model = DomainModel(
    name="Families",
    types={Families_Company, Families_Parent, Families_Child, Families_Neighborhood, Member, Families_School, Families_Country, NamedElement, Families_Family, Families_City, Families_Member, Families_NamedElement, Families_Service},
    associations={companies3, fathers5, mothers7, daughters10, sons12, registeredIn15, worksIn16, goesTo17, contains18, schools19, companies20, neighborhoods22, families0, cities1, employees31, isIn32, family33, livesIn35, ordinary25, special27, students30},
    generalizations={gen_Families_Parent_Member, gen_Families_Child_Member, gen_Families_Neighborhood_NamedElement, gen_Families_City_NamedElement, gen_Families_Country_NamedElement, gen_Families_School_NamedElement, gen_Families_Company_NamedElement},
    metadata=None
)
