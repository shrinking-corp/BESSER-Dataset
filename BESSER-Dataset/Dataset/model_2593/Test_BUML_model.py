...
# Classes
package_subpackage_A = Class(name="package_subpackage_A")
package_subpackage_B = Class(name="package_subpackage_B")
package_subpackage_C = Class(name="package_subpackage_C")
A = Class(name="A")
