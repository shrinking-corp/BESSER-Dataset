...
domain_model = DomainModel(
    name="typeslibrary",
    types={typeslibrary_NativeTypesLibrary, TypesLibrary, typeslibrary_NativeType, typeslibrary_ComplexNamedType, UserDefinedType, typeslibrary_UserDefinedType, typeslibrary_SimpleNamedType, typeslibrary_Type, typeslibrary_UserDefinedTypeRef, typeslibrary_UserDefinedTypesLibrary, typeslibrary_TypesLibraryUser, typeslibrary_TypesLibrary, typeslibrary_TypeInstance, Type, TypesLibraryKind, NativeTypeKind},
    associations={nativeTypes0, mapsTo4, types6, type7, type9, userDefinedTypes11, usedLibraries13, nativeType1},
    generalizations={gen_typeslibrary_NativeTypesLibrary_TypesLibrary, gen_typeslibrary_ComplexNamedType_UserDefinedType, gen_typeslibrary_SimpleNamedType_UserDefinedType, gen_typeslibrary_UserDefinedTypeRef_Type, gen_typeslibrary_UserDefinedTypesLibrary_TypesLibrary, gen_typeslibrary_TypeInstance_Type},
    metadata=None
)
