...
class typeslibrary_TypeInstance(Type):
    ...
    def __init__(self, length: int, precision: int, literals: str, typeslibrary_TypeInstance8: "typeslibrary_SimpleNamedType" = None, typeslibrary_TypeInstance: "typeslibrary_NativeType" = None):
        self.length = length
...
class typeslibrary_UserDefinedType(ABC):
    ...
    def __init__(self, name: str, typeslibrary_UserDefinedType: "typeslibrary_ComplexNamedType" = None, typeslibrary_UserDefinedType10: "typeslibrary_UserDefinedTypeRef" = None, typeslibrary_UserDefinedType12: "typeslibrary_UserDefinedTypesLibrary" = None):
        self.name = name
...
class typeslibrary_NativeTypesLibrary(TypesLibrary):
    ...
    def findTypeByName(self, typeslibrary_name) :
