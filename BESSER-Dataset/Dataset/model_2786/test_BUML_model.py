...
# Classes
testModel_AClass = Class(name="testModel_AClass")
testModel_BClass = Class(name="testModel_BClass")
AClass = Class(name="AClass")
testModel_CClass = Class(name="testModel_CClass")
BClass = Class(name="BClass")
testModel_EObject = Class(name="testModel_EObject")
...
testModel_AClass.attributes={testModel_AClass_AClassAttr2, testModel_AClass_AClassAttr1}
...
testModel_CClass.attributes={testModel_CClass_CClassAttr1, testModel_CClass_CClassAttr2}
