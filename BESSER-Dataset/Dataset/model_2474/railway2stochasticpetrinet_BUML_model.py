...
# Classes
railway2stochasticpetrinet_Railway2StochasticPetriNetTrace = Class(name="railway2stochasticpetrinet_Railway2StochasticPetriNetTrace")
railway2stochasticpetrinet_TraceLink = Class(name="railway2stochasticpetrinet_TraceLink", is_abstract=True)
railway2stochasticpetrinet_RailwayContainer = Class(name="railway2stochasticpetrinet_RailwayContainer")
railway2stochasticpetrinet_PetriNetModuleTraceLink = Class(name="railway2stochasticpetrinet_PetriNetModuleTraceLink", is_abstract=True)
TraceLink = Class(name="TraceLink")
railway2stochasticpetrinet_RailwayElement = Class(name="railway2stochasticpetrinet_RailwayElement")
railway2stochasticpetrinet_RequiredElement2Connection = Class(name="railway2stochasticpetrinet_RequiredElement2Connection")
railway2stochasticpetrinet_RailwayContainer2PetriNet = Class(name="railway2stochasticpetrinet_RailwayContainer2PetriNet")
railway2stochasticpetrinet_PetriNet = Class(name="railway2stochasticpetrinet_PetriNet")
railway2stochasticpetrinet_Node = Class(name="railway2stochasticpetrinet_Node")
railway2stochasticpetrinet_Arc = Class(name="railway2stochasticpetrinet_Arc")
railway2stochasticpetrinet_Route2FailureModel = Class(name="railway2stochasticpetrinet_Route2FailureModel")
PetriNetModuleTraceLink = Class(name="PetriNetModuleTraceLink")
railway2stochasticpetrinet_Route = Class(name="railway2stochasticpetrinet_Route")
railway2stochasticpetrinet_Place = Class(name="railway2stochasticpetrinet_Place")
railway2stochasticpetrinet_ImmediateTransition = Class(name="railway2stochasticpetrinet_ImmediateTransition")
railway2stochasticpetrinet_RequiredElement2FailureModel = Class(name="railway2stochasticpetrinet_RequiredElement2FailureModel")
...
domain_model = DomainModel(
    ...
    types={railway2stochasticpetrinet_Railway2StochasticPetriNetTrace, railway2stochasticpetrinet_TraceLink, railway2stochasticpetrinet_RailwayContainer, railway2stochasticpetrinet_PetriNetModuleTraceLink, TraceLink, railway2stochasticpetrinet_RailwayElement, railway2stochasticpetrinet_RequiredElement2Connection, railway2stochasticpetrinet_RailwayContainer2PetriNet, railway2stochasticpetrinet_PetriNet, railway2stochasticpetrinet_Node, railway2stochasticpetrinet_Arc, railway2stochasticpetrinet_Route2FailureModel, PetriNetModuleTraceLink, railway2stochasticpetrinet_Route, railway2stochasticpetrinet_Place, railway2stochasticpetrinet_ImmediateTransition, railway2stochasticpetrinet_RequiredElement2FailureModel},
    associations={traceLinks0, source1, railwayElement14, operational15, failed18, route21, railwayElement23, railwayContainer26, petriNet28, nodes3, arcs4, route6, operational7, failed9, repair12},
    generalizations={gen_railway2stochasticpetrinet_PetriNetModuleTraceLink_TraceLink, gen_railway2stochasticpetrinet_RequiredElement2Connection_PetriNetModuleTraceLink, gen_railway2stochasticpetrinet_RailwayContainer2PetriNet_TraceLink, gen_railway2stochasticpetrinet_Route2FailureModel_PetriNetModuleTraceLink, gen_railway2stochasticpetrinet_RequiredElement2FailureModel_PetriNetModuleTraceLink},
    metadata=None
)
