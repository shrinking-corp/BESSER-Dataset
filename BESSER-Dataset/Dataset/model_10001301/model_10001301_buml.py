...
FireAlarm_Sensor.attributes={FireAlarm_Sensor_DispenseSprinkler, FireAlarm_Sensor_SmokeAlarm}
...
HouseHolds.attributes={HouseHolds_Alarm, HouseHolds_TimeID, HouseHolds_WashingMachine, HouseHolds_DishWasher, HouseHolds_Coffee}
...
domain_model = DomainModel(
    name="_9f7beebe_9bcf_49e0_b28f_7ae79f129e1b",
    types={System, Sensor, FireAlarm_Sensor, Motion_Sensor, PressureSensor, Home_Security_System, Alert, Door, Camera, Speakers, MicroPhone, Light, Start_Of_Day, End_Of_Day, TV, HomeTheatre, HouseHolds, Entertainment, T},
