...
# Classes
family_FNamedElement = Class(name="family_FNamedElement", is_abstract=True)
family_Person = Class(name="family_Person", is_abstract=True)
...
family_Child = Class(name="family_Child")
...
family_Person.attributes={family_Person_age, family_Person_sex}
...
domain_model = DomainModel(
    name="family",
    types={family_FNamedElement, family_Person, FNamedElement, family_Family, family_Father, family_Mother, family_Child, Person, SexType},
    associations={members0, father1, mother3, children5, children7, wife8, children9, husband11, mother12, father14},
    generalizations={gen_family_Person_FNamedElement, gen_family_Family_FNamedElement, gen_family_Father_Person, gen_family_Mother_Person, gen_family_Child_Person},
    metadata=None
)
