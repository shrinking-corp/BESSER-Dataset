...
public class mypackage_Customer  {
    ...
    public mypackage_Customer(
        String name,        LocalDate dateOfBirth,        String emailAddress,        String address,        String phoneNumber    ) {
        this.name = name;
    ...
    public mypackage_Customer(
        String name,        LocalDate dateOfBirth,        String emailAddress,        String address,        String phoneNumber        ArrayList<account_Account> account_accounts    ) {
        this.name = name;
        this.dateOfBirth = dateOfBirth;
        this.emailAddress = emailAddress;
        this.address = address;
