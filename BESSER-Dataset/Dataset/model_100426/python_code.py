...
class statemachine_DataElement:
    ...
    def __init__(self, ioType: str, port: int, name: str, statemachine_DataElement: "statemachine_Statechart" = None):
        self.ioType = ioType
        self.port = port
        self.name = name
...
class statemachine_Transition:
    ...
    def __init__(self, priority: int, expression: str, id: int, statemachine_Transition4: "statemachine_Node" = None, statemachine_Transition: "statemachine_Node" = None, statemachine_Transition14: "statemachine_Statechart" = None):
