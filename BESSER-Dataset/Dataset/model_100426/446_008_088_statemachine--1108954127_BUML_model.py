...
statemachine_Node.attributes={statemachine_Node_id, statemachine_Node_name}
...
statemachine_State.attributes={statemachine_State_exit, statemachine_State_do, statemachine_State_entry}
...
domain_model = DomainModel(
    name="statemachine",
    types={statemachine_Region, statemachine_Node, statemachine_State, Node, statemachine_Transition, statemachine_Pseudostate, statemachine_DataElement, statemachine_Statechart, statemachine_Variable, DataElement, statemachine_Event, statemachine_FinalState, State, PseudoTypes, DataTypes, IOTypes, TriggerTypes},
    associations={state0, sourceNode3, region6, targetNode1, dataElement8, region9, transition12},
    generalizations={gen_statemachine_State_Node, gen_statemachine_Pseudostate_Node, gen_statemachine_Variable_DataElement, gen_statemachine_Event_DataElement, gen_statemachine_FinalState_State},
    metadata=None
)
