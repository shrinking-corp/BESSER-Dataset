...
SimpleRDBMS_RModelElement = Class(name="SimpleRDBMS_RModelElement")
...
domain_model = DomainModel(
    name="SimpleRDBMS",
    types={SimpleRDBMS_Key, SimpleRDBMS_Table, RModelElement, SimpleRDBMS_Column, SimpleRDBMS_ForeignKey, SimpleRDBMS_Schema, SimpleRDBMS_RModelElement},
    associations={foreignKey1, column0, _key3, schema5, owner6, _key7, foreignKey10, column13, owner15, column18, refersTo20, owner21, tables24},
    generalizations={gen_SimpleRDBMS_Table_RModelElement, gen_SimpleRDBMS_Column_RModelElement, gen_SimpleRDBMS_Key_RModelElement, gen_SimpleRDBMS_ForeignKey_RModelElement, gen_SimpleRDBMS_Schema_RModelElement},
    metadata=None
)
