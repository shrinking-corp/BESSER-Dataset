...
# Classes
configDsl_Config = Class(name="configDsl_Config")
configDsl_Generator = Class(name="configDsl_Generator")
...
configDsl_Config.attributes={configDsl_Config_mainClass, configDsl_Config_outFolder, configDsl_Config_srcFolder, configDsl_Config_appName}
...
configDsl_Generator.attributes={configDsl_Generator_name, configDsl_Generator_bundle, configDsl_Generator_genClass}
