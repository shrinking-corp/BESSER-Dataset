...
# Classes
greetings_Model = Class(name="greetings_Model")
greetings_Greeting = Class(name="greetings_Greeting")
greetings_HelloGreeting = Class(name="greetings_HelloGreeting")
Greeting = Class(name="Greeting")
greetings_RefGreeting = Class(name="greetings_RefGreeting")
