...
rdb_Key = Class(name="rdb_Key", is_abstract=True)
rdb_PrimaryKey = Class(name="rdb_PrimaryKey")
Key = Class(name="Key")
rdb_ForeignKey = Class(name="rdb_ForeignKey")
...
domain_model = DomainModel(
    name="rdb",
    types={rdb_Schema, rdb_Table, rdb_Column, rdb_Key, rdb_PrimaryKey, Key, rdb_ForeignKey},
    associations={tables0, columns1, constraints3, keyColumn5, ref8},
