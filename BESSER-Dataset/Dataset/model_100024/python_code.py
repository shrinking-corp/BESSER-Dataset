...
class DBLP_Editor:
    ...
    def __init__(self, name: str, DBLP_Editor21: "DBLP_Proceedings" = None, DBLP_Editor: "DBLP_InCollection" = None, DBLP_Editor12: "DBLP_InProceedings" = None, DBLP_Editor31: "DBLP_Www" = None):
        self.name = name
...
class DBLP_Journal:
    ...
    def __init__(self, name: str, DBLP_ecoreJournal: "DBLP_Article" = None, journal: set["DBLP_Article"] = None):
        self.name = name
        self.DBLP_ecoreJournal = DBLP_ecoreJournal
    ...
    @property
    def DBLP_ecoreJournal(self):
        return self.__DBLP_ecoreJournal

    @DBLP_ecoreJournal.setter
    def DBLP_ecoreJournal(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DBLP_Journal__DBLP_ecoreJournal", None)
        self.__DBLP_ecoreJournal = value
    ...
    def journal(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "DBLP_ecoreArticle"):
                    opp_val = getattr(item, "DBLP_ecoreArticle", None)
                    
                    if opp_val == self:
                        setattr(item, "DBLP_ecoreArticle", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "DBLP_ecoreArticle"):
                    ...
                    setattr(item, "DBLP_ecoreArticle", self)
...
class DBLP_InProceedings(Record):
    ...
    def __init__(self, title: str, bootitle: str, year: int, fromPage: int, toPage: int, month: str, DBLP_InProceedings: set["DBLP_Editor"] = None, DBLP_InProceedings14: "DBLP_Organization" = None, DBLP_InProceedings17: "DBLP_Publisher" = None):
        self.title = title
...
class DBLP_MastersThesis(Record):
    ...
    def __init__(self, year: int, month: str, title: str, DBLP_MastersThesis: "DBLP_School" = None):
        self.year = year
        self.month = month
        self.title = title
...
class DBLP_Book(Record):
    ...
    def __init__(self, year: int, month: str, volume: int, series: str, edition: int, isbn: str, title: str, DBLP_Book: "DBLP_Publisher" = None):
        self.year = year
        self.month = month
        self.volume = volume
        self.series = series
...
class DBLP_Article(Record):
    ...
    def __init__(self, title: str, fromPage: int, toPage: int, number: int, volume: str, month: str, year: int, articles: "DBLP_Journal" = None, DBLP_ecoreArticle: "DBLP_Journal" = None):
        self.title = title
        self.fromPage = fromPage
        self.toPage = toPage
        self.number = number
        ...
        self.DBLP_ecoreArticle = DBLP_ecoreArticle
    ...
    @property
    def DBLP_ecoreArticle(self):
        return self.__DBLP_ecoreArticle

    @DBLP_ecoreArticle.setter
    def DBLP_ecoreArticle(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DBLP_Article__DBLP_ecoreArticle", None)
        self.__DBLP_ecoreArticle = value
    ...
    def articles(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "DBLP_ecoreJournal"):
                opp_val = getattr(old_value, "DBLP_ecoreJournal", None)
                if opp_val == self:
                    setattr(old_value, "DBLP_ecoreJournal", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "DBLP_ecoreJournal"):
                opp_val = getattr(value, "DBLP_ecoreJournal", None)
                setattr(value, "DBLP_ecoreJournal", self)

class DBLP_Author:

    def __init__(self, name: str, DBLP_ecoreAuthor: "DBLP_Record" = None, authors: set["DBLP_Record"] = None):
        self.name = name
        self.DBLP_ecoreAuthor = DBLP_ecoreAuthor
    ...
    def authors(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "DBLP_ecoreRecord"):
                    opp_val = getattr(item, "DBLP_ecoreRecord", None)
                    
                    if opp_val == self:
                        setattr(item, "DBLP_ecoreRecord", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "DBLP_ecoreRecord"):
                    ...
                    setattr(item, "DBLP_ecoreRecord", self)
                    

    @property
    def DBLP_ecoreAuthor(self):
        return self.__DBLP_ecoreAuthor

    @DBLP_ecoreAuthor.setter
    def DBLP_ecoreAuthor(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DBLP_Author__DBLP_ecoreAuthor", None)
        self.__DBLP_ecoreAuthor = value
...
class DBLP_Publisher:
    ...
    def __init__(self, name: str, address: str, DBLP_Publisher: "DBLP_Book" = None, DBLP_Publisher24: "DBLP_Proceedings" = None, DBLP_Publisher10: "DBLP_InCollection" = None, DBLP_Publisher18: "DBLP_InProceedings" = None):
        self.name = name
        self.address = address
...
class DBLP_Record(ABC):
    ...
    def __init__(self, ee: str, url: str, key: str, mdate: str, records: set["DBLP_Author"] = None, DBLP_ecoreRecord: "DBLP_Author" = None):
        self.ee = ee
        self.url = url
        self.key = key
        self.mdate = mdate
        self.records = records if records is not None else set()
        self.DBLP_ecoreRecord = DBLP_ecoreRecord
    ...
    @property
    def DBLP_ecoreRecord(self):
        return self.__DBLP_ecoreRecord

    @DBLP_ecoreRecord.setter
    def DBLP_ecoreRecord(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DBLP_Record__DBLP_ecoreRecord", None)
        self.__DBLP_ecoreRecord = value
    ...
    def records(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "DBLP_ecoreAuthor"):
                    opp_val = getattr(item, "DBLP_ecoreAuthor", None)
                    
                    if opp_val == self:
                        setattr(item, "DBLP_ecoreAuthor", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "DBLP_ecoreAuthor"):
                    ...
                    setattr(item, "DBLP_ecoreAuthor", self)
