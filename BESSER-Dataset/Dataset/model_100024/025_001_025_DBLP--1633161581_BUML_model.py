...
# Classes
DBLP_Record = Class(name="DBLP_Record", is_abstract=True)
DBLP_Publisher = Class(name="DBLP_Publisher")
DBLP_InCollection = Class(name="DBLP_InCollection")
DBLP_Author = Class(name="DBLP_Author")
DBLP_Article = Class(name="DBLP_Article")
Record = Class(name="Record")
DBLP_Journal = Class(name="DBLP_Journal")
DBLP_Book = Class(name="DBLP_Book")
DBLP_School = Class(name="DBLP_School")
DBLP_Proceedings = Class(name="DBLP_Proceedings")
DBLP_Editor = Class(name="DBLP_Editor")
DBLP_Organization = Class(name="DBLP_Organization")
DBLP_InProceedings = Class(name="DBLP_InProceedings")
DBLP_MastersThesis = Class(name="DBLP_MastersThesis")
DBLP_PhDThesis = Class(name="DBLP_PhDThesis")
DBLP_Www = Class(name="DBLP_Www")
...
DBLP_Record.attributes={DBLP_Record_ee, DBLP_Record_url, DBLP_Record_key, DBLP_Record_mdate}
...
DBLP_InCollection.attributes={DBLP_InCollection_title, DBLP_InCollection_year, DBLP_InCollection_toPage, DBLP_InCollection_month, DBLP_InCollection_fromPage, DBLP_InCollection_bookTitle}
...
DBLP_Article.attributes={DBLP_Article_month, DBLP_Article_number, DBLP_Article_title, DBLP_Article_fromPage, DBLP_Article_volume, DBLP_Article_toPage, DBLP_Article_year}
...
DBLP_Book.attributes={DBLP_Book_month, DBLP_Book_year, DBLP_Book_volume, DBLP_Book_edition, DBLP_Book_series, DBLP_Book_title, DBLP_Book_isbn}
...
DBLP_Proceedings.attributes={DBLP_Proceedings_month, DBLP_Proceedings_isbn, DBLP_Proceedings_title, DBLP_Proceedings_year}
...
DBLP_InProceedings.attributes={DBLP_InProceedings_bootitle, DBLP_InProceedings_month, DBLP_InProceedings_title, DBLP_InProceedings_toPage, DBLP_InProceedings_fromPage, DBLP_InProceedings_year}
...
DBLP_PhDThesis.attributes={DBLP_PhDThesis_title, DBLP_PhDThesis_year, DBLP_PhDThesis_month}
...
authors0: BinaryAssociation = BinaryAssociation(
    name="authors0",
    ends={
        Property(name="DBLP.ecoreAuthor", type=DBLP_Record, multiplicity=Multiplicity(1, 1)),
...
journal1: BinaryAssociation = BinaryAssociation(
    name="journal1",
    ends={
        Property(name="DBLP.ecoreJournal", type=DBLP_Article, multiplicity=Multiplicity(1, 1)),
...
records2: BinaryAssociation = BinaryAssociation(
    name="records2",
    ends={
        Property(name="DBLP.ecoreRecord", type=DBLP_Author, multiplicity=Multiplicity(1, 1)),
...
articles3: BinaryAssociation = BinaryAssociation(
    name="articles3",
    ends={
        Property(name="DBLP.ecoreArticle", type=DBLP_Journal, multiplicity=Multiplicity(1, 1)),
...
domain_model = DomainModel(
    name="DBLP",
    types={DBLP_Record, DBLP_Publisher, DBLP_InCollection, DBLP_Author, DBLP_Article, Record, DBLP_Journal, DBLP_Book, DBLP_School, DBLP_Proceedings, DBLP_Editor, DBLP_Organization, DBLP_InProceedings, DBLP_MastersThesis, DBLP_PhDThesis, DBLP_Www},
    associations={publisher4, authors0, journal1, records2, articles3, school19, editors20, publisher22, editors5, sponsoredBy6, publisher8, editors11, organization13, publisher16, sponsoredBy25, school28, editors30},
    generalizations={gen_DBLP_InCollection_Record, gen_DBLP_Article_Record, gen_DBLP_Book_Record, gen_DBLP_Proceedings_Record, gen_DBLP_InProceedings_Record, gen_DBLP_MastersThesis_Record, gen_DBLP_PhDThesis_Record, gen_DBLP_Www_Record},
    metadata=None
)
