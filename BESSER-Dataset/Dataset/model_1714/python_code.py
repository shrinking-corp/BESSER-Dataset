...
class library3Simplified_Customer:
    ...
    def __init__(self, lastName: str, borrowedBookSince: str, firstName: str, library3Simplified_Customer: "library3Simplified_Book" = None, library3Simplified_Customer7: "library3Simplified_Library" = None):
...
class library3Simplified_Book:
    ...
    def __init__(self, name: str, title: str, author: str, pages: int, dimension: str, download: str, isbn: str, library3Simplified_Book2: "library3Simplified_Customer" = None, library3Simplified_Book: "library3Simplified_BookInfo" = None, library3Simplified_Book4: "library3Simplified_Library" = None):
        self.name = name
        self.title = title
        self.author = author
        self.pages = pages
