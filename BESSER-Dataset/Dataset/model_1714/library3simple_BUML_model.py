...
library3Simplified_Book.attributes={library3Simplified_Book_name, library3Simplified_Book_isbn, library3Simplified_Book_title, library3Simplified_Book_author, library3Simplified_Book_pages, library3Simplified_Book_dimension, library3Simplified_Book_download}
...
library3Simplified_Customer.attributes={library3Simplified_Customer_lastName, library3Simplified_Customer_firstName, library3Simplified_Customer_borrowedBookSince}
...
domain_model = DomainModel(
    ...
    associations={borrowedBookId1, bookInfo0, books3, customers5},
    generalizations={},
    metadata=None
)
