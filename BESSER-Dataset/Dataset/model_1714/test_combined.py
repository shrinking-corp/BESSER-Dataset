...
@given(instance=library3Simplified_Customer_strategy)
def test_hyp_library3simplified_customer_borrowedBookSince_setter(instance):
...
@given(instance=library3Simplified_Book_strategy)
def test_hyp_library3simplified_book_dimension_setter(instance):
...
@given(instance=library3Simplified_Book_strategy)
def test_hyp_library3simplified_book_download_setter(instance):
