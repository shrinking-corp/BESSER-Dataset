...
def test_hyp_edd_leaf_is_not_abstract():
    assert not inspect.isabstract(edd_Leaf)


def test_hyp_edd_leaf_constructor_exists():
    assert callable(edd_Leaf.__init__)


def test_hyp_edd_leaf_constructor_args():
    sig = inspect.signature(edd_Leaf.__init__)
    params = list(sig.parameters.keys())



def test_hyp_edd_node_is_not_abstract():
    assert not inspect.isabstract(edd_Node)


def test_hyp_edd_node_constructor_exists():
    assert callable(edd_Node.__init__)


def test_hyp_edd_node_constructor_args():
...
def test_hyp_edd_edd_is_not_abstract():
    assert not inspect.isabstract(edd_EDD)


def test_hyp_edd_edd_constructor_exists():
    assert callable(edd_EDD.__init__)


def test_hyp_edd_edd_constructor_args():
...
def test_hyp_edd_edd_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
