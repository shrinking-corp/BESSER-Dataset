...
# Classes
dg_Bounds = Class(name="dg_Bounds")
dg_Canvas = Class(name="dg_Canvas")
Group = Class(name="Group")
dg_MoveTo = Class(name="dg_MoveTo")
PathCommand = Class(name="PathCommand")
dg_Point = Class(name="dg_Point")
dg_Group = Class(name="dg_Group")
GraphicalElement = Class(name="GraphicalElement")
dg_GraphicalElement = Class(name="dg_GraphicalElement", is_abstract=True)
Definition = Class(name="Definition")
dg_ClipPath = Class(name="dg_ClipPath")
dg_Style = Class(name="dg_Style")
dg_Transform = Class(name="dg_Transform", is_abstract=True)
dg_Definition = Class(name="dg_Definition", is_abstract=True)
dg_Paint = Class(name="dg_Paint")
dg_PathCommand = Class(name="dg_PathCommand", is_abstract=True)
dg_Definitions = Class(name="dg_Definitions")
dg_PaintServer = Class(name="dg_PaintServer", is_abstract=True)
dg_Circle = Class(name="dg_Circle")
dg_ClosePath = Class(name="dg_ClosePath")
dg_CubicCurveTo = Class(name="dg_CubicCurveTo")
dg_StyleSheet = Class(name="dg_StyleSheet")
dg_StyleRule = Class(name="dg_StyleRule")
dg_StyleSelector = Class(name="dg_StyleSelector")
dg_Ellipse = Class(name="dg_Ellipse")
dg_Dimension = Class(name="dg_Dimension")
dg_EllipticalArcTo = Class(name="dg_EllipticalArcTo")
dg_QuadraticCurveTo = Class(name="dg_QuadraticCurveTo")
dg_Gradient = Class(name="dg_Gradient", is_abstract=True)
PaintServer = Class(name="PaintServer")
dg_GradientStop = Class(name="dg_GradientStop")
dg_Image = Class(name="dg_Image")
dg_Line = Class(name="dg_Line")
MarkedElement = Class(name="MarkedElement")
dg_MarkedElement = Class(name="dg_MarkedElement", is_abstract=True)
dg_Marker = Class(name="dg_Marker")
dg_LinearGradient = Class(name="dg_LinearGradient")
Gradient = Class(name="Gradient")
dg_LineTo = Class(name="dg_LineTo")
dg_Matrix = Class(name="dg_Matrix")
Transform = Class(name="Transform")
dg_Path = Class(name="dg_Path")
dg_Pattern = Class(name="dg_Pattern")
dg_Polygon = Class(name="dg_Polygon")
dg_Polyline = Class(name="dg_Polyline")
dg_RadialGradient = Class(name="dg_RadialGradient")
dg_Rectangle = Class(name="dg_Rectangle")
dg_RootCanvas = Class(name="dg_RootCanvas")
Canvas = Class(name="Canvas")
dg_Rotate = Class(name="dg_Rotate")
dg_Scale = Class(name="dg_Scale")
dg_Skew = Class(name="dg_Skew")
dg_Text = Class(name="dg_Text")
dg_Translate = Class(name="dg_Translate")
dg_Use = Class(name="dg_Use")

# dg_Bounds class attributes and methods

# dg_Canvas class attributes and methods
dg_Canvas_m_canvasCannotHaveTransforms: Method = Method(name="canvasCannotHaveTransforms", parameters={Parameter(name='dg_diagnostics', type=StringType), Parameter(name='dg_context', type=StringType)}, type=BooleanType)
...
dg_GraphicalElement_class_: Property = Property(name="class_", type=StringType)
dg_GraphicalElement_layoutData: Property = Property(name="layoutData", type=StringType)
dg_GraphicalElement_m_referencedClippathHasId: Method = Method(name="referencedClippathHasId", parameters={Parameter(name='dg_diagnostics', type=StringType), Parameter(name='dg_context', type=StringType)}, type=BooleanType)
dg_GraphicalElement.attributes={dg_GraphicalElement_layoutData, dg_GraphicalElement_class_}
...
dg_Style_m_validFontSize: Method = Method(name="validFontSize", parameters={Parameter(name='dg_diagnostics', type=StringType), Parameter(name='dg_context', type=StringType)}, type=BooleanType)
dg_Style_m_validFillOpacity: Method = Method(name="validFillOpacity", parameters={Parameter(name='dg_context', type=StringType), Parameter(name='dg_diagnostics', type=StringType)}, type=BooleanType)
dg_Style_m_validStrokeWidth: Method = Method(name="validStrokeWidth", parameters={Parameter(name='dg_context', type=StringType), Parameter(name='dg_diagnostics', type=StringType)}, type=BooleanType)
dg_Style_m_validDashLengthSize: Method = Method(name="validDashLengthSize", parameters={Parameter(name='dg_diagnostics', type=StringType), Parameter(name='dg_context', type=StringType)}, type=BooleanType)
dg_Style_m_validStrokeOpacity: Method = Method(name="validStrokeOpacity", parameters={Parameter(name='dg_diagnostics', type=StringType), Parameter(name='dg_context', type=StringType)}, type=BooleanType)
dg_Style.attributes={dg_Style_strokeDashLength, dg_Style_fontItalic, dg_Style_fontSize, dg_Style_fontName, dg_Style_fillOpacity, dg_Style_fontDecoration, dg_Style_strokeOpacity, dg_Style_fontBold, dg_Style_strokeWidth}
dg_Style.methods={dg_Style_m_validStrokeWidth, dg_Style_m_validFontSize, dg_Style_m_validDashLengthSize, dg_Style_m_validStrokeOpacity, dg_Style_m_validFillOpacity}
...
dg_Definition_m_idCannotBeEmpty: Method = Method(name="idCannotBeEmpty", parameters={Parameter(name='dg_diagnostics', type=StringType), Parameter(name='dg_context', type=StringType)}, type=BooleanType)
...
dg_Paint_m_referencedPaintServerHasId: Method = Method(name="referencedPaintServerHasId", parameters={Parameter(name='dg_diagnostics', type=StringType), Parameter(name='dg_context', type=StringType)}, type=BooleanType)
...
dg_Circle_m_nonNegativeRadius: Method = Method(name="nonNegativeRadius", parameters={Parameter(name='dg_diagnostics', type=StringType), Parameter(name='dg_context', type=StringType)}, type=BooleanType)
...
dg_StyleSelector_class_: Property = Property(name="class_", type=StringType)
dg_StyleSelector.attributes={dg_StyleSelector_class_, dg_StyleSelector_kind}
...
dg_EllipticalArcTo.attributes={dg_EllipticalArcTo_rotation, dg_EllipticalArcTo_isLargeArc, dg_EllipticalArcTo_isSweep}
...
dg_GradientStop_m_validOffset: Method = Method(name="validOffset", parameters={Parameter(name='dg_diagnostics', type=StringType), Parameter(name='dg_context', type=StringType)}, type=BooleanType)
dg_GradientStop_m_validOpacity: Method = Method(name="validOpacity", parameters={Parameter(name='dg_diagnostics', type=StringType), Parameter(name='dg_context', type=StringType)}, type=BooleanType)
...
dg_Image_m_sourceCannotBeEmpty: Method = Method(name="sourceCannotBeEmpty", parameters={Parameter(name='dg_context', type=StringType), Parameter(name='dg_diagnostics', type=StringType)}, type=BooleanType)
...
dg_MarkedElement_m_referencedStartMarkerHasId: Method = Method(name="referencedStartMarkerHasId", parameters={Parameter(name='dg_diagnostics', type=StringType), Parameter(name='dg_context', type=StringType)}, type=BooleanType)
dg_MarkedElement_m_referencedMidMarkerHasId: Method = Method(name="referencedMidMarkerHasId", parameters={Parameter(name='dg_diagnostics', type=StringType), Parameter(name='dg_context', type=StringType)}, type=BooleanType)
dg_MarkedElement_m_referencedEndMarkerHasId: Method = Method(name="referencedEndMarkerHasId", parameters={Parameter(name='dg_context', type=StringType), Parameter(name='dg_diagnostics', type=StringType)}, type=BooleanType)
dg_MarkedElement.methods={dg_MarkedElement_m_referencedMidMarkerHasId, dg_MarkedElement_m_referencedStartMarkerHasId, dg_MarkedElement_m_referencedEndMarkerHasId}

# dg_Marker class attributes and methods

# dg_LinearGradient class attributes and methods
dg_LinearGradient_m_validGradientVector: Method = Method(name="validGradientVector", parameters={Parameter(name='dg_diagnostics', type=StringType), Parameter(name='dg_context', type=StringType)}, type=BooleanType)
...
dg_Matrix.attributes={dg_Matrix_c, dg_Matrix_e, dg_Matrix_a, dg_Matrix_f, dg_Matrix_d, dg_Matrix_b}

# Transform class attributes and methods

# dg_Path class attributes and methods
dg_Path_m_firstCommandMustBeMove: Method = Method(name="firstCommandMustBeMove", parameters={Parameter(name='dg_context', type=StringType), Parameter(name='dg_diagnostics', type=StringType)}, type=BooleanType)
...
dg_RadialGradient_m_validCenterPoint: Method = Method(name="validCenterPoint", parameters={Parameter(name='dg_diagnostics', type=StringType), Parameter(name='dg_context', type=StringType)}, type=BooleanType)
dg_RadialGradient_m_validFocusPoint: Method = Method(name="validFocusPoint", parameters={Parameter(name='dg_diagnostics', type=StringType), Parameter(name='dg_context', type=StringType)}, type=BooleanType)
dg_RadialGradient_m_validRadius: Method = Method(name="validRadius", parameters={Parameter(name='dg_context', type=StringType), Parameter(name='dg_diagnostics', type=StringType)}, type=BooleanType)
dg_RadialGradient.attributes={dg_RadialGradient_radius}
dg_RadialGradient.methods={dg_RadialGradient_m_validCenterPoint, dg_RadialGradient_m_validFocusPoint, dg_RadialGradient_m_validRadius}

# dg_Rectangle class attributes and methods
dg_Rectangle_cornerRadius: Property = Property(name="cornerRadius", type=StringType)
dg_Rectangle_m_nonNegativeCornerRadius: Method = Method(name="nonNegativeCornerRadius", parameters={Parameter(name='dg_diagnostics', type=StringType), Parameter(name='dg_context', type=StringType)}, type=BooleanType)
...
dg_RootCanvas.attributes={dg_RootCanvas_script, dg_RootCanvas_backgroundColor}
...
dg_Scale_m_nonnegativescale: Method = Method(name="nonnegativescale", parameters={Parameter(name='dg_diagnostics', type=StringType), Parameter(name='dg_context', type=StringType)}, type=BooleanType)
...
dg_Skew.attributes={dg_Skew_angleY, dg_Skew_angleX}
...
dg_Text_m_dataCannotBeEmpty: Method = Method(name="dataCannotBeEmpty", parameters={Parameter(name='dg_context', type=StringType), Parameter(name='dg_diagnostics', type=StringType)}, type=BooleanType)
...
dg_Use_m_referencedElementHasId: Method = Method(name="referencedElementHasId", parameters={Parameter(name='dg_diagnostics', type=StringType), Parameter(name='dg_context', type=StringType)}, type=BooleanType)
...
domain_model = DomainModel(
    name="dg",
    types={dg_Bounds, dg_Canvas, Group, dg_MoveTo, PathCommand, dg_Point, dg_Group, GraphicalElement, dg_GraphicalElement, Definition, dg_ClipPath, dg_Style, dg_Transform, dg_Definition, dg_Paint, dg_PathCommand, dg_Definitions, dg_PaintServer, dg_Circle, dg_ClosePath, dg_CubicCurveTo, dg_StyleSheet, dg_StyleRule, dg_StyleSelector, dg_Ellipse, dg_Dimension, dg_EllipticalArcTo, dg_QuadraticCurveTo, dg_Gradient, PaintServer, dg_GradientStop, dg_Image, dg_Line, MarkedElement, dg_MarkedElement, dg_Marker, dg_LinearGradient, Gradient, dg_LineTo, dg_Matrix, Transform, dg_Path, dg_Pattern, dg_Polygon, dg_Polyline, dg_RadialGradient, dg_Rectangle, dg_RootCanvas, Canvas, dg_Rotate, dg_Scale, dg_Skew, dg_Text, dg_Translate, dg_Use, FontDecoration, ElementKind, TextAnchor},
    associations={bounds0, point8, member1, clipPath2, group3, style4, transform6, fill9, stroke11, point26, paintServer14, transform16, center19, startControl21, endControl23, definition29, styleSheet30, rule32, selector34, style36, center39, radii41, radii43, point45, control48, point50, stop53, bounds54, start56, reference71, end58, endMarker61, midMarker62, startMarker65, size68, start74, end76, point79, command81, bounds82, tile84, point87, point89, center91, focus93, bounds96, definitions98, externalStyleSheet100, center103, bounds107, bounds105, referencedElement109},
    generalizations={gen_dg_Canvas_Group, gen_dg_MoveTo_PathCommand, gen_dg_Group_GraphicalElement, gen_dg_GraphicalElement_Definition, gen_dg_ClipPath_Group, gen_dg_PaintServer_Definition, gen_dg_Circle_GraphicalElement, gen_dg_ClosePath_PathCommand, gen_dg_CubicCurveTo_PathCommand, gen_dg_Ellipse_GraphicalElement, gen_dg_EllipticalArcTo_PathCommand, gen_dg_QuadraticCurveTo_PathCommand, gen_dg_Gradient_PaintServer, gen_dg_Image_GraphicalElement, gen_dg_Line_MarkedElement, gen_dg_MarkedElement_GraphicalElement, gen_dg_Marker_Group, gen_dg_LinearGradient_Gradient, gen_dg_LineTo_PathCommand, gen_dg_Matrix_Transform, gen_dg_Path_MarkedElement, gen_dg_Pattern_PaintServer, gen_dg_Polygon_MarkedElement, gen_dg_Polyline_MarkedElement, gen_dg_RadialGradient_Gradient, gen_dg_Rectangle_GraphicalElement, gen_dg_RootCanvas_Canvas, gen_dg_Rotate_Transform, gen_dg_Scale_Transform, gen_dg_Skew_Transform, gen_dg_Text_GraphicalElement, gen_dg_Translate_Transform, gen_dg_Use_GraphicalElement},
    metadata=None
)
