...
class dg_RootCanvas(Canvas):
    ...
    def __init__(self, backgroundColor: str, script: str, dg_RootCanvas: "dg_Definitions" = None, dg_RootCanvas101: set["dg_StyleSheet"] = None):
...
class dg_Scale(Transform):
    ...
    def nonnegativescale(self, dg_context, dg_diagnostics) :
...
class dg_RadialGradient(Gradient):
    ...
    def validCenterPoint(self, dg_diagnostics, dg_context) :
        # TODO: Implement validCenterPoint method
        pass

    def validFocusPoint(self, dg_context, dg_diagnostics) :
        # TODO: Implement validFocusPoint method
        pass

    def validRadius(self, dg_diagnostics, dg_context) :
...
class dg_LinearGradient(Gradient):
    ...
    def validGradientVector(self, dg_diagnostics, dg_context) :
...
class dg_Path(MarkedElement):
    ...
    def firstCommandMustBeMove(self, dg_diagnostics, dg_context) :
...
class dg_GradientStop:
    ...
    def __init__(self, color: str, offset: str, opacity: str, dg_GradientStop: "dg_Gradient" = None):
        self.color = color
        self.offset = offset
    ...
    def validOffset(self, dg_diagnostics, dg_context) :
        # TODO: Implement validOffset method
        pass

    def validOpacity(self, dg_context, dg_diagnostics) :
...
class dg_StyleSelector:
    ...
    def __init__(self, kind: str, class_: str, dg_StyleSelector: "dg_StyleRule" = None):
        self.kind = kind
        self.class_ = class_
...
class dg_Paint:
    ...
    def referencedPaintServerHasId(self, dg_diagnostics, dg_context) :
...
class dg_Definition(ABC):
    ...
    def idCannotBeEmpty(self, dg_diagnostics, dg_context) :
...
class dg_Style:
    ...
    def __init__(self, fillOpacity: str, strokeWidth: str, strokeOpacity: str, strokeDashLength: str, fontSize: str, fontName: str, fontItalic: str, fontBold: str, fontDecoration: str, dg_Style: "dg_GraphicalElement" = None, dg_Style10: "dg_Paint" = None, dg_Style12: "dg_Paint" = None, dg_Style38: "dg_StyleRule" = None):
    ...
    def validStrokeOpacity(self, dg_context, dg_diagnostics) :
        # TODO: Implement validStrokeOpacity method
        pass

    def validFontSize(self, dg_context, dg_diagnostics) :
        # TODO: Implement validFontSize method
        pass

    def validStrokeWidth(self, dg_context, dg_diagnostics) :
        # TODO: Implement validStrokeWidth method
        pass

    def validFillOpacity(self, dg_diagnostics, dg_context) :
        # TODO: Implement validFillOpacity method
        pass

    def validDashLengthSize(self, dg_context, dg_diagnostics) :
...
class dg_GraphicalElement(Definition):
    ...
    def __init__(self, class_: str, layoutData: str, GraphicalElement: "dg_Group" = None, dg_GraphicalElement: "dg_ClipPath" = None, member: "dg_Group" = None, dg_GraphicalElement5: "dg_Style" = None, dg_GraphicalElement7: set["dg_Transform"] = None, dg_GraphicalElement86: "dg_Pattern" = None, dg_GraphicalElement111: "dg_Use" = None):
        self.class_ = class_
    ...
    def referencedClippathHasId(self, dg_context, dg_diagnostics) :
...
class dg_Rectangle(GraphicalElement):
    ...
    def nonNegativeCornerRadius(self, dg_diagnostics, dg_context) :
...
class dg_Circle(GraphicalElement):
    ...
    def nonNegativeRadius(self, dg_diagnostics, dg_context) :
...
class dg_Image(GraphicalElement):
    ...
    def __init__(self, source: str, isAspectRatioPreserved: str, dg_Image: "dg_Bounds" = None):
        ...
        pass
    @property
    def isAspectRatioPreserved(self):
    ...
    def sourceCannotBeEmpty(self, dg_context, dg_diagnostics) :
...
class dg_Use(GraphicalElement):
    ...
    def referencedElementHasId(self, dg_context, dg_diagnostics) :
...
class dg_MarkedElement(GraphicalElement):
    ...
    def referencedStartMarkerHasId(self, dg_context, dg_diagnostics) :
        # TODO: Implement referencedStartMarkerHasId method
        pass

    def referencedMidMarkerHasId(self, dg_diagnostics, dg_context) :
        # TODO: Implement referencedMidMarkerHasId method
        pass

    def referencedEndMarkerHasId(self, dg_diagnostics, dg_context) :
...
class dg_Text(GraphicalElement):
    ...
    def dataCannotBeEmpty(self, dg_diagnostics, dg_context) :
        # TODO: Implement dataCannotBeEmpty method
        pass

class dg_Group(GraphicalElement):

    def __init__(self, layout: str, group: set["dg_GraphicalElement"] = None, Group: "dg_GraphicalElement" = None):
        self.layout = layout
...
class dg_EllipticalArcTo(PathCommand):
    ...
    def __init__(self, isLargeArc: str, isSweep: str, rotation: str, dg_EllipticalArcTo: "dg_Dimension" = None, dg_EllipticalArcTo46: "dg_Point" = None):
...
class dg_Canvas(Group):
    ...
    def canvasCannotHaveTransforms(self, dg_diagnostics, dg_context) :
