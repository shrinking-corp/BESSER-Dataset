...
domain_model = DomainModel(
    name="simplepdl",
    types={simplepdl_WorkDefinition, ProcessElement, simplepdl_WorkSequence, simplepdl_Guidance, simplepdl_Process, simplepdl_ProcessElement, WorkSequenceType},
    associations={process1, linksToPredecessors4, linksToSuccessors5, predecessor7, successor8, element10, processElements0},
