...
# Classes
ClassM_Class = Class(name="ClassM_Class")
Classifier = Class(name="Classifier")
ClassM_StructuralFeature = Class(name="ClassM_StructuralFeature")
ClassM_Classifier = Class(name="ClassM_Classifier")
ClassM_TypedElement = Class(name="ClassM_TypedElement")
TypedElement = Class(name="TypedElement")
ClassM_PrimitiveType = Class(name="ClassM_PrimitiveType")
ClassM_Operation = Class(name="ClassM_Operation")
StructuralFeature = Class(name="StructuralFeature")
ClassM_Parameter = Class(name="ClassM_Parameter")
ClassM_Attribute = Class(name="ClassM_Attribute")
ClassM_Model = Class(name="ClassM_Model")
...
ClassM_StructuralFeature.attributes={ClassM_StructuralFeature_visibility, ClassM_StructuralFeature_name}
...
domain_model = DomainModel(
    ...
    associations={features0, parents2, children4, typeOf6, owner7, type8, params9, paramOf10, classifiers11},
