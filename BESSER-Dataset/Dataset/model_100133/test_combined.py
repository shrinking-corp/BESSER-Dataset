...
def test_hyp_syntax_dbl_option_is_not_abstract():
    assert not inspect.isabstract(syntax_dbl_Option)


def test_hyp_syntax_dbl_option_constructor_exists():
    assert callable(syntax_dbl_Option.__init__)


def test_hyp_syntax_dbl_option_constructor_args():
...
def test_hyp_syntax_dbl_singlerowfetchclause_is_not_abstract():
    assert not inspect.isabstract(syntax_dbl_SingleRowFetchClause)


def test_hyp_syntax_dbl_singlerowfetchclause_constructor_exists():
    assert callable(syntax_dbl_SingleRowFetchClause.__init__)


def test_hyp_syntax_dbl_singlerowfetchclause_constructor_args():
...
def test_hyp_conditioninfoclause_is_not_abstract():
    assert not inspect.isabstract(ConditionInfoClause)


def test_hyp_conditioninfoclause_constructor_exists():
    assert callable(ConditionInfoClause.__init__)


def test_hyp_conditioninfoclause_constructor_args():
    sig = inspect.signature(ConditionInfoClause.__init__)
    params = list(sig.parameters.keys())



def test_hyp_singlerowfetchclause_is_not_abstract():
    assert not inspect.isabstract(SingleRowFetchClause)


def test_hyp_singlerowfetchclause_constructor_exists():
    assert callable(SingleRowFetchClause.__init__)


def test_hyp_singlerowfetchclause_constructor_args():
...
def test_hyp_syntax_dbl_conditioninfoclause_is_not_abstract():
    assert not inspect.isabstract(syntax_dbl_ConditionInfoClause)


def test_hyp_syntax_dbl_conditioninfoclause_constructor_exists():
    assert callable(syntax_dbl_ConditionInfoClause.__init__)


def test_hyp_syntax_dbl_conditioninfoclause_constructor_args():
...
def test_hyp_syntax_dbl_getdiagnosticsstatement_is_not_abstract():
    assert not inspect.isabstract(syntax_dbl_GetDiagnosticsStatement)


def test_hyp_syntax_dbl_getdiagnosticsstatement_constructor_exists():
    assert callable(syntax_dbl_GetDiagnosticsStatement.__init__)


def test_hyp_syntax_dbl_getdiagnosticsstatement_constructor_args():
    sig = inspect.signature(syntax_dbl_GetDiagnosticsStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_syntax_dbl_getdescriptorstatement_is_not_abstract():
    assert not inspect.isabstract(syntax_dbl_GetDescriptorStatement)


def test_hyp_syntax_dbl_getdescriptorstatement_constructor_exists():
    assert callable(syntax_dbl_GetDescriptorStatement.__init__)


def test_hyp_syntax_dbl_getdescriptorstatement_constructor_args():
...
def test_hyp_syntax_dbl_deallocatedescriptorstatement_is_not_abstract():
    assert not inspect.isabstract(syntax_dbl_DeallocateDescriptorStatement)


def test_hyp_syntax_dbl_deallocatedescriptorstatement_constructor_exists():
    assert callable(syntax_dbl_DeallocateDescriptorStatement.__init__)


def test_hyp_syntax_dbl_deallocatedescriptorstatement_constructor_args():
...
def test_hyp_syntax_dbl_setoptionstatement_is_not_abstract():
    assert not inspect.isabstract(syntax_dbl_SetOptionStatement)


def test_hyp_syntax_dbl_setoptionstatement_constructor_exists():
    assert callable(syntax_dbl_SetOptionStatement.__init__)


def test_hyp_syntax_dbl_setoptionstatement_constructor_args():
...
def test_hyp_syntax_dbl_setdescriptorstatement_is_not_abstract():
    assert not inspect.isabstract(syntax_dbl_SetDescriptorStatement)


def test_hyp_syntax_dbl_setdescriptorstatement_constructor_exists():
    assert callable(syntax_dbl_SetDescriptorStatement.__init__)


def test_hyp_syntax_dbl_setdescriptorstatement_constructor_args():
...
def test_hyp_syntax_dbl_allocatedescriptorstatement_is_not_abstract():
    assert not inspect.isabstract(syntax_dbl_AllocateDescriptorStatement)


def test_hyp_syntax_dbl_allocatedescriptorstatement_constructor_exists():
    assert callable(syntax_dbl_AllocateDescriptorStatement.__init__)


def test_hyp_syntax_dbl_allocatedescriptorstatement_constructor_args():
...
def test_hyp_syntax_aliasresolver_is_not_abstract():
    assert not inspect.isabstract(syntax_AliasResolver)


def test_hyp_syntax_aliasresolver_constructor_exists():
    assert callable(syntax_AliasResolver.__init__)


def test_hyp_syntax_aliasresolver_constructor_args():
...
def test_hyp_descriptorscope_exists():
    # Check that the Enumeration exists
    assert DescriptorScope is not None

def test_hyp_descriptorscope_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_syntax_dbl_option_value_setter(instance):
...
@given(instance=syntax_dbl_Option_strategy)
def test_hyp_syntax_dbl_option_name_setter(instance):
...
@given(instance=syntax_dbl_MultipleRowFetchClause_strategy)
def test_hyp_syntax_dbl_multiplerowfetchclause_into_setter(instance):
...
def test_hyp_syntax_dbl_singlerowfetchclause_into_setter(instance):
    original = instance.into
    instance.into = original
    assert instance.into == original
...
@given(instance=syntax_dbl_SingleRowFetchClause_strategy)
def test_hyp_syntax_dbl_singlerowfetchclause_usingDescriptor_setter(instance):
    original = instance.usingDescriptor
    instance.usingDescriptor = original
    assert instance.usingDescriptor == original
...
def test_hyp_syntax_dbl_conditioninfoclause_condition_setter(instance):
...
def test_hyp_syntax_dbl_getdescriptorstatement_descriptorScope_setter(instance):
...
@given(instance=syntax_dbl_GetDescriptorStatement_strategy)
def test_hyp_syntax_dbl_getdescriptorstatement_descriptorName_setter(instance):
    original = instance.descriptorName
    instance.descriptorName = original
    assert instance.descriptorName == original
...
@given(instance=syntax_dbl_GetDescriptorStatement_strategy)
def test_hyp_syntax_dbl_getdescriptorstatement_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_syntax_dbl_deallocatedescriptorstatement_descriptorName_setter(instance):
    original = instance.descriptorName
    instance.descriptorName = original
    assert instance.descriptorName == original
...
@given(instance=syntax_dbl_DeallocateDescriptorStatement_strategy)
def test_hyp_syntax_dbl_deallocatedescriptorstatement_descriptorScope_setter(instance):
    original = instance.descriptorScope
    instance.descriptorScope = original
    assert instance.descriptorScope == original
...
def test_hyp_syntax_dbl_setdescriptorstatement_descriptorName_setter(instance):
    original = instance.descriptorName
    instance.descriptorName = original
    assert instance.descriptorName == original
...
@given(instance=syntax_dbl_SetDescriptorStatement_strategy)
def test_hyp_syntax_dbl_setdescriptorstatement_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_syntax_dbl_allocatedescriptorstatement_descriptorScope_setter(instance):
    original = instance.descriptorScope
    instance.descriptorScope = original
    assert instance.descriptorScope == original
...
@given(instance=syntax_dbl_AllocateDescriptorStatement_strategy)
def test_hyp_syntax_dbl_allocatedescriptorstatement_withMax_setter(instance):
...
@given(instance=syntax_dbl_AllocateDescriptorStatement_strategy)
def test_hyp_syntax_dbl_allocatedescriptorstatement_descriptorName_setter(instance):
    original = instance.descriptorName
    instance.descriptorName = original
    assert instance.descriptorName == original
...
@given(instance=syntax_DefinitionWriter_strategy)
@settings(max_examples=30)
def test_hyp_syntax_definitionwriter_createlabelforfields_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
...
@given(instance=syntax_DefinitionWriter_strategy)
@settings(max_examples=30)
def test_hyp_syntax_definitionwriter_renameindex_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
...
@given(instance=syntax_DefinitionWriter_strategy)
@settings(max_examples=30)
def test_hyp_syntax_definitionwriter_renametable_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
...
@given(instance=syntax_DefinitionWriter_strategy)
@settings(max_examples=30)
def test_hyp_syntax_definitionwriter_copytabledata_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
...
@given(instance=syntax_DefinitionWriter_strategy)
@settings(max_examples=30)
def test_hyp_syntax_definitionwriter_createlabel_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
...
@given(instance=syntax_DefinitionWriter_strategy)
@settings(max_examples=30)
def test_hyp_syntax_definitionwriter_truncatetable_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
...
@given(instance=syntax_DefinitionWriter_strategy)
@settings(max_examples=30)
def test_hyp_syntax_definitionwriter_countrecords_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
...
@given(instance=syntax_DefinitionWriter_strategy)
@settings(max_examples=30)
def test_hyp_syntax_definitionwriter_haslogicals_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
...
@settings(max_examples=30)
def test_hyp_syntax_aliasresolver_resolvequery_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
...
def test_syntax_dbl_AllocateDescriptorStatement_descriptorName_value_roundtrip():
    instance = syntax_dbl_AllocateDescriptorStatement(descriptorName="sample_text", descriptorScope="sample_text", withMax="sample_text")
...
def test_syntax_dbl_AllocateDescriptorStatement_descriptorScope_value_roundtrip():
    instance = syntax_dbl_AllocateDescriptorStatement(descriptorName="sample_text", descriptorScope="sample_text", withMax="sample_text")
    assert instance.descriptorScope == "sample_text"
    instance.descriptorScope = "sample_text_2"
    assert instance.descriptorScope == "sample_text_2"


def test_syntax_dbl_AllocateDescriptorStatement_withMax_value_roundtrip():
    instance = syntax_dbl_AllocateDescriptorStatement(descriptorName="sample_text", descriptorScope="sample_text", withMax="sample_text")
    assert instance.withMax == "sample_text"
    instance.withMax = "sample_text_2"
    assert instance.withMax == "sample_text_2"
...
def test_syntax_dbl_ConditionInfoClause_condition_value_roundtrip():
    instance = syntax_dbl_ConditionInfoClause(condition="sample_text")
    assert instance.condition == "sample_text"
    instance.condition = "sample_text_2"
    assert instance.condition == "sample_text_2"


def test_syntax_dbl_DeallocateDescriptorStatement_descriptorName_value_roundtrip():
    instance = syntax_dbl_DeallocateDescriptorStatement(descriptorName="sample_text", descriptorScope="sample_text")
    assert instance.descriptorName == "sample_text"
    instance.descriptorName = "sample_text_2"
    assert instance.descriptorName == "sample_text_2"


def test_syntax_dbl_DeallocateDescriptorStatement_descriptorScope_value_roundtrip():
    instance = syntax_dbl_DeallocateDescriptorStatement(descriptorName="sample_text", descriptorScope="sample_text")
    assert instance.descriptorScope == "sample_text"
    instance.descriptorScope = "sample_text_2"
    assert instance.descriptorScope == "sample_text_2"
...
def test_syntax_dbl_FetchStatement_cursorName_value_roundtrip():
    instance = syntax_dbl_FetchStatement(cursorName="sample_text", position="sample_text", relativePosition="sample_text")
    assert instance.cursorName == "sample_text"
    instance.cursorName = "sample_text_2"
    assert instance.cursorName == "sample_text_2"
...
def test_syntax_dbl_GetDescriptorStatement_descriptorName_value_roundtrip():
    instance = syntax_dbl_GetDescriptorStatement(descriptorName="sample_text", descriptorScope="sample_text", value="sample_text")
    assert instance.descriptorName == "sample_text"
    instance.descriptorName = "sample_text_2"
    assert instance.descriptorName == "sample_text_2"


def test_syntax_dbl_GetDescriptorStatement_descriptorScope_value_roundtrip():
    instance = syntax_dbl_GetDescriptorStatement(descriptorName="sample_text", descriptorScope="sample_text", value="sample_text")
    assert instance.descriptorScope == "sample_text"
    instance.descriptorScope = "sample_text_2"
    assert instance.descriptorScope == "sample_text_2"
...
def test_syntax_dbl_GetDescriptorStatement_value_value_roundtrip():
    instance = syntax_dbl_GetDescriptorStatement(descriptorName="sample_text", descriptorScope="sample_text", value="sample_text")
...
def test_syntax_dbl_MultipleRowFetchClause_descriptor_value_roundtrip():
    instance = syntax_dbl_MultipleRowFetchClause(descriptor="sample_text", into="sample_text", rowsNumber="sample_text", usingDescriptor=True)
    assert instance.descriptor == "sample_text"
    instance.descriptor = "sample_text_2"
    assert instance.descriptor == "sample_text_2"


def test_syntax_dbl_MultipleRowFetchClause_into_value_roundtrip():
    instance = syntax_dbl_MultipleRowFetchClause(descriptor="sample_text", into="sample_text", rowsNumber="sample_text", usingDescriptor=True)
...
def test_syntax_dbl_Option_name_value_roundtrip():
    instance = syntax_dbl_Option(name="sample_text", value="sample_text")
    assert instance.name == "sample_text"
    instance.name = "sample_text_2"
    assert instance.name == "sample_text_2"


def test_syntax_dbl_Option_value_value_roundtrip():
    instance = syntax_dbl_Option(name="sample_text", value="sample_text")
    assert instance.value == "sample_text"
    instance.value = "sample_text_2"
    assert instance.value == "sample_text_2"
...
def test_syntax_dbl_SetDescriptorStatement_descriptorName_value_roundtrip():
    instance = syntax_dbl_SetDescriptorStatement(descriptorName="sample_text", value="sample_text")
    assert instance.descriptorName == "sample_text"
    instance.descriptorName = "sample_text_2"
    assert instance.descriptorName == "sample_text_2"


def test_syntax_dbl_SetDescriptorStatement_value_value_roundtrip():
    instance = syntax_dbl_SetDescriptorStatement(descriptorName="sample_text", value="sample_text")
    assert instance.value == "sample_text"
    instance.value = "sample_text_2"
    assert instance.value == "sample_text_2"
...
def test_syntax_dbl_SingleRowFetchClause_into_value_roundtrip():
    instance = syntax_dbl_SingleRowFetchClause(into="sample_text", usingDescriptor=True)
    assert instance.into == "sample_text"
    instance.into = "sample_text_2"
    assert instance.into == "sample_text_2"


def test_syntax_dbl_SingleRowFetchClause_usingDescriptor_value_roundtrip():
    instance = syntax_dbl_SingleRowFetchClause(into="sample_text", usingDescriptor=True)
    assert instance.usingDescriptor == True
    instance.usingDescriptor = False
    assert instance.usingDescriptor == False
...
def test_syntax_dbl_AllocateDescriptorStatement_isa_BindingStatement():
    instance = syntax_dbl_AllocateDescriptorStatement(descriptorName="sample_text", descriptorScope="sample_text", withMax="sample_text")
...
def test_syntax_dbl_DeallocateDescriptorStatement_isa_BindingStatement():
    instance = syntax_dbl_DeallocateDescriptorStatement(descriptorName="sample_text", descriptorScope="sample_text")
    assert isinstance(instance, BindingStatement)
...
def test_syntax_dbl_GetDescriptorStatement_isa_BindingStatement():
    instance = syntax_dbl_GetDescriptorStatement(descriptorName="sample_text", descriptorScope="sample_text", value="sample_text")
    assert isinstance(instance, BindingStatement)


def test_syntax_dbl_GetDiagnosticsStatement_isa_BindingStatement():
    instance = syntax_dbl_GetDiagnosticsStatement()
    assert isinstance(instance, BindingStatement)
...
def test_syntax_dbl_SetDescriptorStatement_isa_BindingStatement():
    instance = syntax_dbl_SetDescriptorStatement(descriptorName="sample_text", value="sample_text")
    assert isinstance(instance, BindingStatement)


def test_syntax_dbl_SetOptionStatement_isa_BindingStatement():
    instance = syntax_dbl_SetOptionStatement()
    assert isinstance(instance, BindingStatement)
...
def test_assoc_conditionItems32_link_reassign_clear():
    a = syntax_dbl_ConditionInfoClause(condition="sample_text")
    b1 = Option()
    b2 = Option()
    _safe_set(a, 'syntax_dbl_ConditionInfoClause', {b1})
    assert _is_linked(a, 'syntax_dbl_ConditionInfoClause', b1)
    if hasattr(b1, 'Option'):
        assert _is_linked(b1, 'Option', a)
    _safe_set(a, 'syntax_dbl_ConditionInfoClause', {b2})
    assert _is_linked(a, 'syntax_dbl_ConditionInfoClause', b2)
    if hasattr(b1, 'Option'):
        assert not _is_linked(b1, 'Option', a)
    if hasattr(b2, 'Option'):
        assert _is_linked(b2, 'Option', a)
    _safe_set(a, 'syntax_dbl_ConditionInfoClause', set())
    assert not _is_linked(a, 'syntax_dbl_ConditionInfoClause', b2)
    if hasattr(b2, 'Option'):
...
def test_assoc_into33_link_reassign_clear():
...
def test_assoc_into44_link_reassign_clear():
    ...
    if hasattr(b1, 'IntoClause45'):
        assert _is_linked(b1, 'IntoClause45', a)
    _safe_set(a, 'syntax_dbl_PrepareStatement', b2)
    assert _is_linked(a, 'syntax_dbl_PrepareStatement', b2)
    if hasattr(b1, 'IntoClause45'):
        assert not _is_linked(b1, 'IntoClause45', a)
    if hasattr(b2, 'IntoClause45'):
        assert _is_linked(b2, 'IntoClause45', a)
    _safe_set(a, 'syntax_dbl_PrepareStatement', None)
    assert not _is_linked(a, 'syntax_dbl_PrepareStatement', b2)
    if hasattr(b2, 'IntoClause45'):
        assert not _is_linked(b2, 'IntoClause45', a)


def test_assoc_items40_link_reassign_clear():
    a = syntax_dbl_SetDescriptorStatement(descriptorName="sample_text", value="sample_text")
    b1 = Option()
    b2 = Option()
    _safe_set(a, 'syntax_dbl_SetDescriptorStatement', {b1})
    assert _is_linked(a, 'syntax_dbl_SetDescriptorStatement', b1)
    if hasattr(b1, 'Option41'):
        assert _is_linked(b1, 'Option41', a)
    _safe_set(a, 'syntax_dbl_SetDescriptorStatement', {b2})
    assert _is_linked(a, 'syntax_dbl_SetDescriptorStatement', b2)
    if hasattr(b1, 'Option41'):
        assert not _is_linked(b1, 'Option41', a)
    if hasattr(b2, 'Option41'):
        assert _is_linked(b2, 'Option41', a)
    _safe_set(a, 'syntax_dbl_SetDescriptorStatement', set())
    assert not _is_linked(a, 'syntax_dbl_SetDescriptorStatement', b2)
    if hasattr(b2, 'Option41'):
        assert not _is_linked(b2, 'Option41', a)


def test_assoc_multipleRowClause34_link_reassign_clear():
    a = syntax_dbl_FetchStatement(cursorName="sample_text", position="sample_text", relativePosition="sample_text")
...
def test_assoc_singleRowClause35_link_reassign_clear():
    a = syntax_dbl_FetchStatement(cursorName="sample_text", position="sample_text", relativePosition="sample_text")
    b1 = SingleRowFetchClause()
    b2 = SingleRowFetchClause()
    _safe_set(a, 'syntax_dbl_FetchStatement36', b1)
    assert _is_linked(a, 'syntax_dbl_FetchStatement36', b1)
    if hasattr(b1, 'SingleRowFetchClause'):
        assert _is_linked(b1, 'SingleRowFetchClause', a)
    _safe_set(a, 'syntax_dbl_FetchStatement36', b2)
    assert _is_linked(a, 'syntax_dbl_FetchStatement36', b2)
    if hasattr(b1, 'SingleRowFetchClause'):
        assert not _is_linked(b1, 'SingleRowFetchClause', a)
    if hasattr(b2, 'SingleRowFetchClause'):
        assert _is_linked(b2, 'SingleRowFetchClause', a)
    _safe_set(a, 'syntax_dbl_FetchStatement36', None)
    assert not _is_linked(a, 'syntax_dbl_FetchStatement36', b2)
    if hasattr(b2, 'SingleRowFetchClause'):
        assert not _is_linked(b2, 'SingleRowFetchClause', a)
...
def test_assoc_variables37_link_reassign_clear():
    a = syntax_dbl_GetDescriptorStatement(descriptorName="sample_text", descriptorScope="sample_text", value="sample_text")
    b1 = Option()
    b2 = Option()
    _safe_set(a, 'syntax_dbl_GetDescriptorStatement', {b1})
    assert _is_linked(a, 'syntax_dbl_GetDescriptorStatement', b1)
    if hasattr(b1, 'Option38'):
        assert _is_linked(b1, 'Option38', a)
    _safe_set(a, 'syntax_dbl_GetDescriptorStatement', {b2})
    assert _is_linked(a, 'syntax_dbl_GetDescriptorStatement', b2)
    if hasattr(b1, 'Option38'):
        assert not _is_linked(b1, 'Option38', a)
    if hasattr(b2, 'Option38'):
        assert _is_linked(b2, 'Option38', a)
    _safe_set(a, 'syntax_dbl_GetDescriptorStatement', set())
    assert not _is_linked(a, 'syntax_dbl_GetDescriptorStatement', b2)
    if hasattr(b2, 'Option38'):
        assert not _is_linked(b2, 'Option38', a)
...
ConditionInfoClause_strategy = st.builds(ConditionInfoClause)
...
SingleRowFetchClause_strategy = st.builds(SingleRowFetchClause)
...
syntax_AliasResolver_strategy = st.builds(syntax_AliasResolver)
@given(instance=syntax_AliasResolver_strategy)
@settings(max_examples=25)
...
syntax_dbl_AllocateDescriptorStatement_strategy = st.builds(syntax_dbl_AllocateDescriptorStatement, descriptorName=safe_text, descriptorScope=safe_text, withMax=safe_text)
@given(instance=syntax_dbl_AllocateDescriptorStatement_strategy)
@settings(max_examples=25)
...
syntax_dbl_ConditionInfoClause_strategy = st.builds(syntax_dbl_ConditionInfoClause, condition=safe_text)
@given(instance=syntax_dbl_ConditionInfoClause_strategy)
@settings(max_examples=25)
...
syntax_dbl_DeallocateDescriptorStatement_strategy = st.builds(syntax_dbl_DeallocateDescriptorStatement, descriptorName=safe_text, descriptorScope=safe_text)
@given(instance=syntax_dbl_DeallocateDescriptorStatement_strategy)
@settings(max_examples=25)
...
syntax_dbl_FetchStatement_strategy = st.builds(syntax_dbl_FetchStatement, cursorName=safe_text, position=safe_text, relativePosition=safe_text)
@given(instance=syntax_dbl_FetchStatement_strategy)
@settings(max_examples=25)
...
syntax_dbl_GetDescriptorStatement_strategy = st.builds(syntax_dbl_GetDescriptorStatement, descriptorName=safe_text, descriptorScope=safe_text, value=safe_text)
@given(instance=syntax_dbl_GetDescriptorStatement_strategy)
@settings(max_examples=25)
...
syntax_dbl_GetDiagnosticsStatement_strategy = st.builds(syntax_dbl_GetDiagnosticsStatement)
...
syntax_dbl_MultipleRowFetchClause_strategy = st.builds(syntax_dbl_MultipleRowFetchClause, descriptor=safe_text, into=safe_text, rowsNumber=safe_text, usingDescriptor=st.booleans())
@given(instance=syntax_dbl_MultipleRowFetchClause_strategy)
@settings(max_examples=25)
...
syntax_dbl_Option_strategy = st.builds(syntax_dbl_Option, name=safe_text, value=safe_text)
@given(instance=syntax_dbl_Option_strategy)
@settings(max_examples=25)
...
syntax_dbl_SetDescriptorStatement_strategy = st.builds(syntax_dbl_SetDescriptorStatement, descriptorName=safe_text, value=safe_text)
@given(instance=syntax_dbl_SetDescriptorStatement_strategy)
@settings(max_examples=25)
...
syntax_dbl_SetOptionStatement_strategy = st.builds(syntax_dbl_SetOptionStatement)
...
syntax_dbl_SingleRowFetchClause_strategy = st.builds(syntax_dbl_SingleRowFetchClause, into=safe_text, usingDescriptor=st.booleans())
@given(instance=syntax_dbl_SingleRowFetchClause_strategy)
@settings(max_examples=25)
