...
# Classes
rpslPerceptionGraphMetaModel_PerceptionGraph = Class(name="rpslPerceptionGraphMetaModel_PerceptionGraph")
rpslPerceptionGraphMetaModel_Element = Class(name="rpslPerceptionGraphMetaModel_Element")
rpslPerceptionGraphMetaModel_Prototype = Class(name="rpslPerceptionGraphMetaModel_Prototype")
rpslPerceptionGraphMetaModel_Component = Class(name="rpslPerceptionGraphMetaModel_Component")
rpslPerceptionGraphMetaModel_Leaf = Class(name="rpslPerceptionGraphMetaModel_Leaf")
Element = Class(name="Element")
rpslPerceptionGraphMetaModel_OutputPort = Class(name="rpslPerceptionGraphMetaModel_OutputPort")
rpslPerceptionGraphMetaModel_Node = Class(name="rpslPerceptionGraphMetaModel_Node")
rpslPerceptionGraphMetaModel_Connection = Class(name="rpslPerceptionGraphMetaModel_Connection")
rpslPerceptionGraphMetaModel_InputPort = Class(name="rpslPerceptionGraphMetaModel_InputPort")
...
rpslPerceptionGraphMetaModel_PerceptionGraph.attributes={rpslPerceptionGraphMetaModel_PerceptionGraph_doc, rpslPerceptionGraphMetaModel_PerceptionGraph_uuid, rpslPerceptionGraphMetaModel_PerceptionGraph_name}
...
domain_model = DomainModel(
    ...
    types={rpslPerceptionGraphMetaModel_PerceptionGraph, rpslPerceptionGraphMetaModel_Element, rpslPerceptionGraphMetaModel_Prototype, rpslPerceptionGraphMetaModel_Component, rpslPerceptionGraphMetaModel_Leaf, Element, rpslPerceptionGraphMetaModel_OutputPort, rpslPerceptionGraphMetaModel_Node, rpslPerceptionGraphMetaModel_Connection, rpslPerceptionGraphMetaModel_InputPort},
    associations={element0, perception_graph_property_prototype1, component3, sink9, src11, connection5, element6},
