...
# Classes
schol_Classroom = Class(name="schol_Classroom")
schol_Student = Class(name="schol_Student")
schol_Diagram = Class(name="schol_Diagram")
schol_School = Class(name="schol_School")
