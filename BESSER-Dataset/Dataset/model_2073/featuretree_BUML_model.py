...
# Classes
featuretree_FeatureTree = Class(name="featuretree_FeatureTree")
core_AbstractModelElement = Class(name="core_AbstractModelElement")
features_IFeatureDomain = Class(name="features_IFeatureDomain")
core_ITopLevelElement = Class(name="core_ITopLevelElement")
featuretree_TreeFeature = Class(name="featuretree_TreeFeature")
