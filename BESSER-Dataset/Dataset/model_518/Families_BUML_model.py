...
Families_Male = Class(name="Families_Male")
Member = Class(name="Member")
Families_Female = Class(name="Families_Female")
...
domain_model = DomainModel(
    name="Families",
    types={Families_Families, Families_Member, Families_Male, Member, Families_Female, Families_Family},
    associations={members2, family3, families0, container1},
