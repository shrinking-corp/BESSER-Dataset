...
class Families_Family:
    ...
    def __init__(self, lastname: str, family: set["Families_Member"] = None, Family4: "Families_Member" = None, Family: "Families_Families" = None, families: "Families_Families" = None):
