...
# Classes
accounting_NamedElement = Class(name="accounting_NamedElement", is_abstract=True)
accounting_Client = Class(name="accounting_Client")
NamedElement = Class(name="NamedElement")
accounting_Project = Class(name="accounting_Project")
accounting_Order = Class(name="accounting_Order")
accounting_Employee = Class(name="accounting_Employee")
accounting_WorkPackage = Class(name="accounting_WorkPackage")
accounting_Clients = Class(name="accounting_Clients")
accounting_Deliverable = Class(name="accounting_Deliverable")
accounting_Invoice = Class(name="accounting_Invoice")
accounting_Employees = Class(name="accounting_Employees")
...
accounting_Order_m_validateUnitAmount: Method = Method(name="validateUnitAmount", parameters={Parameter(name='accounting_diagnosticChain', type=StringType), Parameter(name='accounting_context', type=StringType)}, type=BooleanType)
accounting_Order.attributes={accounting_Order_id, accounting_Order_pricePerUnit, accounting_Order_paymentOffset}
...
accounting_WorkPackage.attributes={accounting_WorkPackage_comment, accounting_WorkPackage_hours, accounting_WorkPackage_date, accounting_WorkPackage_task}
...
accounting_Invoice.attributes={accounting_Invoice_invoiceDate, accounting_Invoice_id, accounting_Invoice_state, accounting_Invoice_dueDate, accounting_Invoice_unitAmount}
...
domain_model = DomainModel(
    name="accounting",
    types={accounting_NamedElement, accounting_Client, NamedElement, accounting_Project, accounting_Order, accounting_Employee, accounting_WorkPackage, accounting_Clients, accounting_Deliverable, accounting_Invoice, accounting_Employees, InvoiceState},
    associations={projects0, client1, orders2, order8, advisor10, order11, work13, project15, clients17, project3, deliverables5, invoices6, employees18},
