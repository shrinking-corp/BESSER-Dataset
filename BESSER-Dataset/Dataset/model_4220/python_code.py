...
class CompanyModel_Department:
    ...
    def __init__(self, number: int, CompanyModel_Department4: set["CompanyModel_Product"] = None, CompanyModel_Department: "CompanyModel_Company" = None, CompanyModel_Department2: set["CompanyModel_Employee"] = None):
        self.number = number
