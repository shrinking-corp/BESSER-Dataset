...
# Classes
CompanyModel_Company = Class(name="CompanyModel_Company")
CompanyModel_Department = Class(name="CompanyModel_Department")
CompanyModel_Employee = Class(name="CompanyModel_Employee")
CompanyModel_Product = Class(name="CompanyModel_Product")
