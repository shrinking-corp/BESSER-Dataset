...
def test_fsm_abstractstate_has_genBy():
    assert hasattr(FSM_AbstractState, "genBy")
    descriptor = None
...
def test_fsm_transition_has_genBy():
    assert hasattr(FSM_Transition, "genBy")
    descriptor = None
...
def test_fsm_statemachine_has_genBy():
    assert hasattr(FSM_StateMachine, "genBy")
    descriptor = None
    for klass in FSM_StateMachine.__mro__:
        if "genBy" in klass.__dict__:
            descriptor = klass.__dict__["genBy"]
...
@given(instance=FSM_AbstractState_strategy)
def test_fsm_abstractstate_genBy_setter(instance):
...
@given(instance=FSM_Transition_strategy)
def test_fsm_transition_genBy_setter(instance):
    original = instance.genBy
    instance.genBy = original
    assert instance.genBy == original
...
@given(instance=FSM_StateMachine_strategy)
def test_fsm_statemachine_genBy_setter(instance):
    original = instance.genBy
    instance.genBy = original
    assert instance.genBy == original
