...
FSM_StateMachine.attributes={FSM_StateMachine_name, FSM_StateMachine_genBy}
...
FSM_AbstractState.attributes={FSM_AbstractState_name, FSM_AbstractState_genBy}
...
domain_model = DomainModel(
    name="FSM",
    types={FSM_CompositeState, FSM_InitialState, AbstractState, FSM_RegularState, FSM_StateMachine, FSM_Transition, FSM_AbstractState},
    associations={stateMachine8, compositeState10, states12, transitions0, states1, stateMachine3, source4, target5},
