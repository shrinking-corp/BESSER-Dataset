...
class FSM_AbstractState(ABC):
    ...
    def __init__(self, name: str, genBy: str, states: "FSM_StateMachine" = None, states11: "FSM_CompositeState" = None, AbstractState13: "FSM_CompositeState" = None, AbstractState: "FSM_StateMachine" = None, FSM_AbstractState: "FSM_Transition" = None, FSM_AbstractState7: "FSM_Transition" = None):
        self.name = name
        self.genBy = genBy
        self.states = states
...
class FSM_StateMachine:
    ...
    def __init__(self, name: str, genBy: str, StateMachine9: "FSM_AbstractState" = None, stateMachine: set["FSM_Transition"] = None, stateMachine2: set["FSM_AbstractState"] = None, StateMachine: "FSM_Transition" = None):
        self.name = name
        self.genBy = genBy
