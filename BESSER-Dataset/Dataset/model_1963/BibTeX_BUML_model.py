...
domain_model = DomainModel(
    name="bibTeX",
    types={bibTeX_TitleField, bibTeX_YearField, bibTeX_MonthField, bibTeX_NoteField, bibTeX_Model, bibTeX_BibtexEntryTypes, bibTeX_CiteKey, bibTeX_IsbnField, bibTeX_UnknownType, bibTeX_UnknownValue, bibTeX_UnknownField, bibTeX_Article, BibtexEntryTypes, bibTeX_AuthorField, bibTeX_JournalField, bibTeX_VolumeField, bibTeX_NumberField, bibTeX_PagesField, bibTeX_Book, bibTeX_EObject, bibTeX_PublisherField, bibTeX_SeriesField, bibTeX_AddressField, bibTeX_EditionField, bibTeX_Authors, AuthorField, bibTeX_Fullname, bibTeX_EditorField},
    associations={key1, title3, year5, month7, note9, BibtexEntries0, isbn34, type36, value38, unknowns11, author13, journal14, volume16, number18, pages20, author_editor22, publisher23, volume_number25, series28, address30, edition32, names40},
