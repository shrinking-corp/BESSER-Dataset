...
# Classes
parameterizedExpressionsTestLanguage_Statement = Class(name="parameterizedExpressionsTestLanguage_Statement")
parameterizedExpressionsTestLanguage_FunctionDeclaration = Class(name="parameterizedExpressionsTestLanguage_FunctionDeclaration")
Statement = Class(name="Statement")
parameterizedExpressionsTestLanguage_Block = Class(name="parameterizedExpressionsTestLanguage_Block")
parameterizedExpressionsTestLanguage_CommaExpression = Class(name="parameterizedExpressionsTestLanguage_CommaExpression")
parameterizedExpressionsTestLanguage_ExpressionStatement = Class(name="parameterizedExpressionsTestLanguage_ExpressionStatement")
parameterizedExpressionsTestLanguage_Expression = Class(name="parameterizedExpressionsTestLanguage_Expression")
parameterizedExpressionsTestLanguage_LabelledStatement = Class(name="parameterizedExpressionsTestLanguage_LabelledStatement")
parameterizedExpressionsTestLanguage_IdentifierRef = Class(name="parameterizedExpressionsTestLanguage_IdentifierRef")
Expression = Class(name="Expression")
parameterizedExpressionsTestLanguage_IndexedAccessExpression = Class(name="parameterizedExpressionsTestLanguage_IndexedAccessExpression")
parameterizedExpressionsTestLanguage_ParameterizedPropertyAccessExpression = Class(name="parameterizedExpressionsTestLanguage_ParameterizedPropertyAccessExpression")
parameterizedExpressionsTestLanguage_ShiftExpression = Class(name="parameterizedExpressionsTestLanguage_ShiftExpression")
parameterizedExpressionsTestLanguage_RelationalExpression = Class(name="parameterizedExpressionsTestLanguage_RelationalExpression")
parameterizedExpressionsTestLanguage_AssignmentExpression = Class(name="parameterizedExpressionsTestLanguage_AssignmentExpression")
parameterizedExpressionsTestLanguage_YieldExpression = Class(name="parameterizedExpressionsTestLanguage_YieldExpression")
...
parameterizedExpressionsTestLanguage_ParameterizedPropertyAccessExpression__property: Property = Property(name="_property", type=StringType)
parameterizedExpressionsTestLanguage_ParameterizedPropertyAccessExpression.attributes={parameterizedExpressionsTestLanguage_ParameterizedPropertyAccessExpression__property}
...
domain_model = DomainModel(
    ...
    types={parameterizedExpressionsTestLanguage_Statement, parameterizedExpressionsTestLanguage_FunctionDeclaration, Statement, parameterizedExpressionsTestLanguage_Block, parameterizedExpressionsTestLanguage_CommaExpression, parameterizedExpressionsTestLanguage_ExpressionStatement, parameterizedExpressionsTestLanguage_Expression, parameterizedExpressionsTestLanguage_LabelledStatement, parameterizedExpressionsTestLanguage_IdentifierRef, Expression, parameterizedExpressionsTestLanguage_IndexedAccessExpression, parameterizedExpressionsTestLanguage_ParameterizedPropertyAccessExpression, parameterizedExpressionsTestLanguage_ShiftExpression, parameterizedExpressionsTestLanguage_RelationalExpression, parameterizedExpressionsTestLanguage_AssignmentExpression, parameterizedExpressionsTestLanguage_YieldExpression},
    associations={body0, statements1, expression28, exprs30, expression3, statement4, target6, index8, target11, lhs13, rhs15, lhs18, rhs20, lhs23, rhs25},
    generalizations={gen_parameterizedExpressionsTestLanguage_FunctionDeclaration_Statement, gen_parameterizedExpressionsTestLanguage_Block_Statement, gen_parameterizedExpressionsTestLanguage_CommaExpression_Expression, gen_parameterizedExpressionsTestLanguage_ExpressionStatement_Statement, gen_parameterizedExpressionsTestLanguage_LabelledStatement_Statement, gen_parameterizedExpressionsTestLanguage_IdentifierRef_Expression, gen_parameterizedExpressionsTestLanguage_IndexedAccessExpression_Expression, gen_parameterizedExpressionsTestLanguage_ParameterizedPropertyAccessExpression_Expression, gen_parameterizedExpressionsTestLanguage_ShiftExpression_Expression, gen_parameterizedExpressionsTestLanguage_RelationalExpression_Expression, gen_parameterizedExpressionsTestLanguage_AssignmentExpression_Expression, gen_parameterizedExpressionsTestLanguage_YieldExpression_Expression},
    metadata=None
)
