...
class parameterizedExpressionsTestLanguage_ParameterizedPropertyAccessExpression(Expression):
    ...
    def __init__(self, _property: str, parameterizedExpressionsTestLanguage_ParameterizedPropertyAccessExpression: "parameterizedExpressionsTestLanguage_Expression" = None):
