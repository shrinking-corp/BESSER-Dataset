...
class dtmc_Transition(IDBase):
    ...
    def __init__(self, prob: float, Transition: "dtmc_State" = None, Transition6: "dtmc_State" = None, outgoing: "dtmc_State" = None, incoming: "dtmc_State" = None):
        self.prob = prob
...
class dtmc_State(IDBase):
    ...
    def __init__(self, name: str, dtmc_State: "dtmc_DTMC" = None, dtmc_State3: "dtmc_DTMC" = None, to: set["dtmc_Transition"] = None, from_: set["dtmc_Transition"] = None, state: set["dtmc_Label"] = None, State: "dtmc_Transition" = None, State10: "dtmc_Transition" = None, State12: "dtmc_Label" = None):
        self.name = name
    ...
    def from_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_dtmc_State__from_", None)
