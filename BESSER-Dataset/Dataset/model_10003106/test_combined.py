...
@given(instance=Customer_strategy)
def test_hyp_customer__attr_setter(instance):
...
def test_Customer__attr_value_roundtrip():
    instance = Customer(_attr="sample_text", address="sample_text", dateOfBirth=date(2024, 1, 1), emailAddress="sample_text", phoneNumber="sample_text")
...
def test_assoc_Customer_Login_link_reassign_clear():
    ...
    b1 = Customer(_attr="sample_text", address="sample_text", dateOfBirth=date(2024, 1, 1), emailAddress="sample_text", phoneNumber="sample_text")
    b2 = Customer(_attr="sample_text_2", address="sample_text_2", dateOfBirth=date(2025, 6, 15), emailAddress="sample_text_2", phoneNumber="sample_text_2")
...
Customer_strategy = st.builds(Customer, _attr=safe_text, address=safe_text, dateOfBirth=st.dates(), emailAddress=safe_text, phoneNumber=safe_text)
@given(instance=Customer_strategy)
