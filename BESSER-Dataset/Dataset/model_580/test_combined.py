...
def test_hyp_assistantmvc_multiplechoiceview_selectionWay_setter(instance):
...
@given(instance=AssistantMVC_MultipleChoiceView_strategy)
def test_hyp_assistantmvc_multiplechoiceview_numberOfChoices_setter(instance):
...
def test_hyp_assistantmvc_multiplechoicecontroller_numberOfChoices_setter(instance):
    original = instance.numberOfChoices
    instance.numberOfChoices = original
    assert instance.numberOfChoices == original
...
@given(instance=AssistantMVC_MultipleChoiceController_strategy)
def test_hyp_assistantmvc_multiplechoicecontroller_selectionWay_setter(instance):
    original = instance.selectionWay
    instance.selectionWay = original
    assert instance.selectionWay == original
...
def test_hyp_assistantmvc_multiplechoice_optional_setter(instance):
...
@given(instance=AssistantMVC_MultipleChoice_strategy)
def test_hyp_assistantmvc_multiplechoice_selectionWay_setter(instance):
    original = instance.selectionWay
    instance.selectionWay = original
    assert instance.selectionWay == original
...
@given(instance=AssistantMVC_MultipleChoice_strategy)
def test_hyp_assistantmvc_multiplechoice_numberOfChoices_setter(instance):
    original = instance.numberOfChoices
    instance.numberOfChoices = original
    assert instance.numberOfChoices == original
...
def test_AssistantMVC_MultipleChoice_numberOfChoices_value_roundtrip():
    instance = AssistantMVC_MultipleChoice(numberOfChoices=7, optional=True, selectionWay="sample_text")
    assert instance.numberOfChoices == 7
    instance.numberOfChoices = 13
    assert instance.numberOfChoices == 13


def test_AssistantMVC_MultipleChoice_optional_value_roundtrip():
    instance = AssistantMVC_MultipleChoice(numberOfChoices=7, optional=True, selectionWay="sample_text")
...
def test_AssistantMVC_MultipleChoice_selectionWay_value_roundtrip():
    instance = AssistantMVC_MultipleChoice(numberOfChoices=7, optional=True, selectionWay="sample_text")
    assert instance.selectionWay == "sample_text"
    instance.selectionWay = "sample_text_2"
    assert instance.selectionWay == "sample_text_2"


def test_AssistantMVC_MultipleChoiceController_numberOfChoices_value_roundtrip():
    instance = AssistantMVC_MultipleChoiceController(numberOfChoices=7, selectionWay="sample_text")
    assert instance.numberOfChoices == 7
    instance.numberOfChoices = 13
    assert instance.numberOfChoices == 13


def test_AssistantMVC_MultipleChoiceController_selectionWay_value_roundtrip():
    instance = AssistantMVC_MultipleChoiceController(numberOfChoices=7, selectionWay="sample_text")
    assert instance.selectionWay == "sample_text"
    instance.selectionWay = "sample_text_2"
    assert instance.selectionWay == "sample_text_2"
...
def test_AssistantMVC_MultipleChoiceView_numberOfChoices_value_roundtrip():
    instance = AssistantMVC_MultipleChoiceView(numberOfChoices=7, selectionWay="sample_text")
    assert instance.numberOfChoices == 7
    instance.numberOfChoices = 13
    assert instance.numberOfChoices == 13


def test_AssistantMVC_MultipleChoiceView_selectionWay_value_roundtrip():
    instance = AssistantMVC_MultipleChoiceView(numberOfChoices=7, selectionWay="sample_text")
    assert instance.selectionWay == "sample_text"
    instance.selectionWay = "sample_text_2"
    assert instance.selectionWay == "sample_text_2"
...
AssistantMVC_MultipleChoice_strategy = st.builds(AssistantMVC_MultipleChoice, numberOfChoices=st.integers(), optional=st.booleans(), selectionWay=safe_text)
@given(instance=AssistantMVC_MultipleChoice_strategy)
@settings(max_examples=25)
...
AssistantMVC_MultipleChoiceController_strategy = st.builds(AssistantMVC_MultipleChoiceController, numberOfChoices=st.integers(), selectionWay=safe_text)
@given(instance=AssistantMVC_MultipleChoiceController_strategy)
@settings(max_examples=25)
...
AssistantMVC_MultipleChoiceView_strategy = st.builds(AssistantMVC_MultipleChoiceView, numberOfChoices=st.integers(), selectionWay=safe_text)
@given(instance=AssistantMVC_MultipleChoiceView_strategy)
@settings(max_examples=25)
