...
def test_assistantmvc_multiplechoiceview_has_selectionWay():
    assert hasattr(AssistantMVC_MultipleChoiceView, "selectionWay")
    descriptor = None
    for klass in AssistantMVC_MultipleChoiceView.__mro__:
        if "selectionWay" in klass.__dict__:
            descriptor = klass.__dict__["selectionWay"]
            break
    assert isinstance(descriptor, property)

def test_assistantmvc_multiplechoiceview_has_numberOfChoices():
    assert hasattr(AssistantMVC_MultipleChoiceView, "numberOfChoices")
    descriptor = None
    for klass in AssistantMVC_MultipleChoiceView.__mro__:
...
def test_assistantmvc_multiplechoicecontroller_has_numberOfChoices():
    assert hasattr(AssistantMVC_MultipleChoiceController, "numberOfChoices")
    descriptor = None
    for klass in AssistantMVC_MultipleChoiceController.__mro__:
        if "numberOfChoices" in klass.__dict__:
            descriptor = klass.__dict__["numberOfChoices"]
            break
    assert isinstance(descriptor, property)

def test_assistantmvc_multiplechoicecontroller_has_selectionWay():
    assert hasattr(AssistantMVC_MultipleChoiceController, "selectionWay")
    descriptor = None
    for klass in AssistantMVC_MultipleChoiceController.__mro__:
        if "selectionWay" in klass.__dict__:
            descriptor = klass.__dict__["selectionWay"]
...
def test_assistantmvc_multiplechoice_has_optional():
    assert hasattr(AssistantMVC_MultipleChoice, "optional")
    descriptor = None
    for klass in AssistantMVC_MultipleChoice.__mro__:
        if "optional" in klass.__dict__:
            descriptor = klass.__dict__["optional"]
            break
    assert isinstance(descriptor, property)

def test_assistantmvc_multiplechoice_has_selectionWay():
    assert hasattr(AssistantMVC_MultipleChoice, "selectionWay")
    descriptor = None
    for klass in AssistantMVC_MultipleChoice.__mro__:
        if "selectionWay" in klass.__dict__:
            descriptor = klass.__dict__["selectionWay"]
...
def test_assistantmvc_multiplechoice_has_numberOfChoices():
    assert hasattr(AssistantMVC_MultipleChoice, "numberOfChoices")
    descriptor = None
    for klass in AssistantMVC_MultipleChoice.__mro__:
        if "numberOfChoices" in klass.__dict__:
            descriptor = klass.__dict__["numberOfChoices"]
...
@given(instance=AssistantMVC_MultipleChoiceView_strategy)
def test_assistantmvc_multiplechoiceview_selectionWay_setter(instance):
...
@given(instance=AssistantMVC_MultipleChoiceView_strategy)
def test_assistantmvc_multiplechoiceview_numberOfChoices_setter(instance):
...
@given(instance=AssistantMVC_MultipleChoiceController_strategy)
def test_assistantmvc_multiplechoicecontroller_numberOfChoices_setter(instance):
    original = instance.numberOfChoices
    instance.numberOfChoices = original
    assert instance.numberOfChoices == original
...
@given(instance=AssistantMVC_MultipleChoiceController_strategy)
def test_assistantmvc_multiplechoicecontroller_selectionWay_setter(instance):
    original = instance.selectionWay
    instance.selectionWay = original
    assert instance.selectionWay == original
...
@given(instance=AssistantMVC_MultipleChoice_strategy)
def test_assistantmvc_multiplechoice_optional_setter(instance):
...
@given(instance=AssistantMVC_MultipleChoice_strategy)
def test_assistantmvc_multiplechoice_selectionWay_setter(instance):
    original = instance.selectionWay
    instance.selectionWay = original
    assert instance.selectionWay == original
...
@given(instance=AssistantMVC_MultipleChoice_strategy)
def test_assistantmvc_multiplechoice_numberOfChoices_setter(instance):
    original = instance.numberOfChoices
    instance.numberOfChoices = original
    assert instance.numberOfChoices == original
