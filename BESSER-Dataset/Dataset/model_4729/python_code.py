...
class prolog_Rule(Clause):
    ...
    pass
class prolog_CompoundTerm(Clause, Term):

    def __init__(self, value: str, prolog_CompoundTerm8: "prolog_Fact" = None, prolog_CompoundTerm10: "prolog_Rule" = None, prolog_CompoundTerm: set["Expression"] = None):
        self.value = value
