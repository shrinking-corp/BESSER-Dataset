...
# Classes
prolog_Program = Class(name="prolog_Program")
prolog_Clause = Class(name="prolog_Clause", is_abstract=True)
prolog_Comment = Class(name="prolog_Comment")
Clause = Class(name="Clause")
prolog_Term = Class(name="prolog_Term", is_abstract=True)
Expression = Class(name="Expression")
prolog_CompoundTerm = Class(name="prolog_CompoundTerm")
prolog_AtomicQuotedString = Class(name="prolog_AtomicQuotedString")
prolog_List = Class(name="prolog_List")
prolog_Fact = Class(name="prolog_Fact")
prolog_Rule = Class(name="prolog_Rule")
prolog_ControlPredicate = Class(name="prolog_ControlPredicate", is_abstract=True)
prolog_True = Class(name="prolog_True")
ControlPredicate = Class(name="ControlPredicate")
prolog_False = Class(name="prolog_False")
prolog_Fail = Class(name="prolog_Fail")
prolog_Cut = Class(name="prolog_Cut")
prolog_directives_Directive = Class(name="prolog_directives_Directive", is_abstract=True)
Term = Class(name="Term")
prolog_AtomicNumber = Class(name="prolog_AtomicNumber")
Directive = Class(name="Directive")
prolog_directives_Discontiguous = Class(name="prolog_directives_Discontiguous")
prolog_directives_Multifile = Class(name="prolog_directives_Multifile")
prolog_directives_Public = Class(name="prolog_directives_Public")
prolog_directives_Volatile = Class(name="prolog_directives_Volatile")
prolog_directives_Table = Class(name="prolog_directives_Table")
prolog_expressions_Expression = Class(name="prolog_expressions_Expression", is_abstract=True)
prolog_expressions_UnaryExpression = Class(name="prolog_expressions_UnaryExpression", is_abstract=True)
prolog_expressions_BinaryExpression = Class(name="prolog_expressions_BinaryExpression", is_abstract=True)
prolog_expressions_LogicalOr = Class(name="prolog_expressions_LogicalOr")
BinaryExpression = Class(name="BinaryExpression")
prolog_expressions_Condition = Class(name="prolog_expressions_Condition", is_abstract=True)
prolog_expressions_SoftCut = Class(name="prolog_expressions_SoftCut")
prolog_expressions_LogicalAnd = Class(name="prolog_expressions_LogicalAnd")
PredicateIndicator = Class(name="PredicateIndicator")
prolog_directives_PredicateIndicator = Class(name="prolog_directives_PredicateIndicator")
prolog_directives_Dynamic = Class(name="prolog_directives_Dynamic")
prolog_expressions_StructuralEquivalenceNotProvable = Class(name="prolog_expressions_StructuralEquivalenceNotProvable")
prolog_expressions_NumberEqual = Class(name="prolog_expressions_NumberEqual")
prolog_expressions_LessOrEqual = Class(name="prolog_expressions_LessOrEqual")
prolog_expressions_Equivalence = Class(name="prolog_expressions_Equivalence")
prolog_expressions_NonEqualNumber = Class(name="prolog_expressions_NonEqualNumber")
prolog_expressions_GreaterThan = Class(name="prolog_expressions_GreaterThan")
prolog_expressions_GreaterOrEqual = Class(name="prolog_expressions_GreaterOrEqual")
prolog_expressions_StandardOrderBefore = Class(name="prolog_expressions_StandardOrderBefore")
prolog_expressions_EqualOrStandardOrderBefore = Class(name="prolog_expressions_EqualOrStandardOrderBefore")
prolog_expressions_StandardOrderAfter = Class(name="prolog_expressions_StandardOrderAfter")
prolog_expressions_EqualOrStandardOrderAfter = Class(name="prolog_expressions_EqualOrStandardOrderAfter")
prolog_expressions_NotUnifiable = Class(name="prolog_expressions_NotUnifiable")
prolog_expressions_Disequality = Class(name="prolog_expressions_Disequality")
prolog_expressions_As = Class(name="prolog_expressions_As")
prolog_expressions_Is = Class(name="prolog_expressions_Is")
prolog_expressions_ParticalUnification = Class(name="prolog_expressions_ParticalUnification")
prolog_expressions_SubDict = Class(name="prolog_expressions_SubDict")
prolog_expressions_ModuleCall = Class(name="prolog_expressions_ModuleCall")
prolog_expressions_Plus = Class(name="prolog_expressions_Plus")
prolog_expressions_Minus = Class(name="prolog_expressions_Minus")
prolog_expressions_BinaryAnd = Class(name="prolog_expressions_BinaryAnd")
prolog_expressions_BinaryOr = Class(name="prolog_expressions_BinaryOr")
prolog_expressions_Xor = Class(name="prolog_expressions_Xor")
prolog_expressions_Multiplication = Class(name="prolog_expressions_Multiplication")
prolog_expressions_Division = Class(name="prolog_expressions_Division")
prolog_expressions_NotProvable = Class(name="prolog_expressions_NotProvable")
UnaryExpression = Class(name="UnaryExpression")
prolog_expressions_LessThan = Class(name="prolog_expressions_LessThan")
prolog_expressions_Unification = Class(name="prolog_expressions_Unification")
prolog_expressions_Univ = Class(name="prolog_expressions_Univ")
prolog_expressions_StructuralEquivalence = Class(name="prolog_expressions_StructuralEquivalence")
prolog_expressions_Rem = Class(name="prolog_expressions_Rem")
prolog_expressions_Power = Class(name="prolog_expressions_Power")
prolog_expressions_PositiveNumber = Class(name="prolog_expressions_PositiveNumber")
prolog_expressions_NegativeNumber = Class(name="prolog_expressions_NegativeNumber")
prolog_expressions_BitwiseNegation = Class(name="prolog_expressions_BitwiseNegation")
prolog_expressions_IntegerDivision = Class(name="prolog_expressions_IntegerDivision")
prolog_expressions_Div = Class(name="prolog_expressions_Div")
prolog_expressions_Rdiv = Class(name="prolog_expressions_Rdiv")
prolog_expressions_BitwiseShiftLeft = Class(name="prolog_expressions_BitwiseShiftLeft")
prolog_expressions_Mod = Class(name="prolog_expressions_Mod")
...
domain_model = DomainModel(
    name="prolog",
    types={prolog_Program, prolog_Clause, prolog_Comment, Clause, prolog_Term, Expression, prolog_CompoundTerm, prolog_AtomicQuotedString, prolog_List, prolog_Fact, prolog_Rule, prolog_ControlPredicate, prolog_True, ControlPredicate, prolog_False, prolog_Fail, prolog_Cut, prolog_directives_Directive, Term, prolog_AtomicNumber, Directive, prolog_directives_Discontiguous, prolog_directives_Multifile, prolog_directives_Public, prolog_directives_Volatile, prolog_directives_Table, prolog_expressions_Expression, prolog_expressions_UnaryExpression, prolog_expressions_BinaryExpression, prolog_expressions_LogicalOr, BinaryExpression, prolog_expressions_Condition, prolog_expressions_SoftCut, prolog_expressions_LogicalAnd, PredicateIndicator, prolog_directives_PredicateIndicator, prolog_directives_Dynamic, prolog_expressions_StructuralEquivalenceNotProvable, prolog_expressions_NumberEqual, prolog_expressions_LessOrEqual, prolog_expressions_Equivalence, prolog_expressions_NonEqualNumber, prolog_expressions_GreaterThan, prolog_expressions_GreaterOrEqual, prolog_expressions_StandardOrderBefore, prolog_expressions_EqualOrStandardOrderBefore, prolog_expressions_StandardOrderAfter, prolog_expressions_EqualOrStandardOrderAfter, prolog_expressions_NotUnifiable, prolog_expressions_Disequality, prolog_expressions_As, prolog_expressions_Is, prolog_expressions_ParticalUnification, prolog_expressions_SubDict, prolog_expressions_ModuleCall, prolog_expressions_Plus, prolog_expressions_Minus, prolog_expressions_BinaryAnd, prolog_expressions_BinaryOr, prolog_expressions_Xor, prolog_expressions_Multiplication, prolog_expressions_Division, prolog_expressions_NotProvable, UnaryExpression, prolog_expressions_LessThan, prolog_expressions_Unification, prolog_expressions_Univ, prolog_expressions_StructuralEquivalence, prolog_expressions_Rem, prolog_expressions_Power, prolog_expressions_PositiveNumber, prolog_expressions_NegativeNumber, prolog_expressions_BitwiseNegation, prolog_expressions_IntegerDivision, prolog_expressions_Div, prolog_expressions_Rdiv, prolog_expressions_BitwiseShiftLeft, prolog_expressions_Mod},
    associations={clauses0, heads2, tails4, head7, head9, body11, arguments1, predicate15, expr17, left19, right21, predicates14},
    generalizations={gen_prolog_Comment_Clause, gen_prolog_Term_Expression, gen_prolog_CompoundTerm_Clause, gen_prolog_AtomicQuotedString_Term, gen_prolog_List_Term, gen_prolog_Fact_Clause, gen_prolog_Rule_Clause, gen_prolog_ControlPredicate_Term, gen_prolog_True_ControlPredicate, gen_prolog_False_ControlPredicate, gen_prolog_Fail_ControlPredicate, gen_prolog_Cut_ControlPredicate, gen_prolog_directives_Directive_Clause, gen_prolog_CompoundTerm_Term, gen_prolog_AtomicNumber_Term, gen_prolog_directives_Dynamic_Directive, gen_prolog_directives_Discontiguous_Directive, gen_prolog_directives_Multifile_Directive, gen_prolog_directives_Public_Directive, gen_prolog_directives_Volatile_Directive, gen_prolog_directives_Table_Clause, gen_prolog_expressions_UnaryExpression_Expression, gen_prolog_expressions_BinaryExpression_Expression, gen_prolog_expressions_LogicalOr_BinaryExpression, gen_prolog_expressions_Condition_BinaryExpression, gen_prolog_expressions_SoftCut_BinaryExpression, gen_prolog_expressions_LogicalAnd_BinaryExpression, gen_prolog_expressions_StructuralEquivalenceNotProvable_BinaryExpression, gen_prolog_expressions_NumberEqual_BinaryExpression, gen_prolog_expressions_LessOrEqual_BinaryExpression, gen_prolog_expressions_Equivalence_BinaryExpression, gen_prolog_expressions_NonEqualNumber_BinaryExpression, gen_prolog_expressions_GreaterThan_BinaryExpression, gen_prolog_expressions_GreaterOrEqual_BinaryExpression, gen_prolog_expressions_StandardOrderBefore_BinaryExpression, gen_prolog_expressions_EqualOrStandardOrderBefore_BinaryExpression, gen_prolog_expressions_StandardOrderAfter_BinaryExpression, gen_prolog_expressions_EqualOrStandardOrderAfter_BinaryExpression, gen_prolog_expressions_NotUnifiable_BinaryExpression, gen_prolog_expressions_Disequality_BinaryExpression, gen_prolog_expressions_As_BinaryExpression, gen_prolog_expressions_Is_BinaryExpression, gen_prolog_expressions_ParticalUnification_BinaryExpression, gen_prolog_expressions_SubDict_BinaryExpression, gen_prolog_expressions_ModuleCall_BinaryExpression, gen_prolog_expressions_Plus_BinaryExpression, gen_prolog_expressions_Minus_BinaryExpression, gen_prolog_expressions_BinaryAnd_BinaryExpression, gen_prolog_expressions_BinaryOr_BinaryExpression, gen_prolog_expressions_Xor_BinaryExpression, gen_prolog_expressions_Multiplication_BinaryExpression, gen_prolog_expressions_Division_BinaryExpression, gen_prolog_expressions_NotProvable_UnaryExpression, gen_prolog_expressions_LessThan_BinaryExpression, gen_prolog_expressions_Unification_BinaryExpression, gen_prolog_expressions_Univ_BinaryExpression, gen_prolog_expressions_StructuralEquivalence_BinaryExpression, gen_prolog_expressions_Rem_BinaryExpression, gen_prolog_expressions_Power_BinaryExpression, gen_prolog_expressions_PositiveNumber_UnaryExpression, gen_prolog_expressions_NegativeNumber_UnaryExpression, gen_prolog_expressions_BitwiseNegation_UnaryExpression, gen_prolog_expressions_IntegerDivision_BinaryExpression, gen_prolog_expressions_Div_BinaryExpression, gen_prolog_expressions_Rdiv_BinaryExpression, gen_prolog_expressions_BitwiseShiftLeft_BinaryExpression, gen_prolog_expressions_Mod_BinaryExpression},
    metadata=None
)
