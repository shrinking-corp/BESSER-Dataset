...
simpleuml_PrimitiveDataType = Class(name="simpleuml_PrimitiveDataType")
simpleuml_UMLModelElement = Class(name="simpleuml_UMLModelElement", is_abstract=True)
...
domain_model = DomainModel(
    name="simpleuml",
    types={simpleuml_Classifier, simpleuml_Class, simpleuml_Association, PackageElement, Classifier, simpleuml_Package, simpleuml_PackageElement, simpleuml_Attribute, UMLModelElement, simpleuml_PrimitiveDataType, simpleuml_UMLModelElement},
    associations={type0, owner1, source2, destination4, general7, forward9, attributes10, reverse11, generalOpposite14, typeOpposite16, elements18, namespace19},
    generalizations={gen_simpleuml_Association_PackageElement, gen_simpleuml_Class_Classifier, gen_simpleuml_Classifier_PackageElement, gen_simpleuml_Package_UMLModelElement, gen_simpleuml_Attribute_UMLModelElement, gen_simpleuml_PackageElement_UMLModelElement, gen_simpleuml_PrimitiveDataType_Classifier},
    metadata=None
)
