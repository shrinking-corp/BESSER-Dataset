...
# Classes
MainPackage_ClassInMainPackage = Class(name="MainPackage_ClassInMainPackage")
MainPackage_Model = Class(name="MainPackage_Model")
MainPackage_EObject = Class(name="MainPackage_EObject")
MainPackage_Subpackage_ClassInSubpackage = Class(name="MainPackage_Subpackage_ClassInSubpackage")
MainPackage_Subpackage_InheritingClass = Class(name="MainPackage_Subpackage_InheritingClass")
