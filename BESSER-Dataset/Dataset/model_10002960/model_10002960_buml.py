...
ShoppingCart.attributes={ShoppingCart_id, ShoppingCart_creationDate}
...
Item.attributes={Item_price, Item_id, Item_quantity}
...
Product.attributes={Product_name, Product_description, Product_id}
...
Account.attributes={Account_id, Account_openDate, Account_billingAddress}
...
Payment.attributes={Payment_total, Payment_comments, Payment_id}
...
Order.attributes={Order_status, Order_shippingAddress, Order_finalTotal, Order_id}
...
Customer.attributes={Customer_id, Customer_emailAddress, Customer_password, Customer_lastname, Customer_firstname, Customer_isBan, Customer_login}
...
domain_model = DomainModel(
    name="efbdd07c_fa55_4140_b1ba_35fdaa985be3",
    types={ShoppingCart, Item, Product, Account, Payment, Order, Customer, OrderStatus},
    associations={association2, association3, association4, association5, association8, association6, association7},
    generalizations={},
    metadata=None
)
