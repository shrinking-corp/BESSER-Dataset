...
# Classes
actions_Action = Class(name="actions_Action", is_abstract=True)
actions_ActionReference = Class(name="actions_ActionReference")
PreGenerationAction = Class(name="PreGenerationAction")
actions_StandAloneAction = Class(name="actions_StandAloneAction")
actions_PostGenerationAction = Class(name="actions_PostGenerationAction", is_abstract=True)
actions_PreGenerationSequence = Class(name="actions_PreGenerationSequence")
actions_PostGenerationSequence = Class(name="actions_PostGenerationSequence")
PostGenerationAction = Class(name="PostGenerationAction")
actions_ThrowAction = Class(name="actions_ThrowAction")
actions_TermAction = Class(name="actions_TermAction")
ReconfigurationAction = Class(name="ReconfigurationAction")
actions_Term = Class(name="actions_Term")
actions_ReconfigurationAction = Class(name="actions_ReconfigurationAction", is_abstract=True)
actions_SetDataAction = Class(name="actions_SetDataAction")
IValueFunction = Class(name="IValueFunction")
IDataNodeFunction = Class(name="IDataNodeFunction")
actions_EObject = Class(name="actions_EObject")
core_AbstractModelElement = Class(name="core_AbstractModelElement")
core_ITopLevelElement = Class(name="core_ITopLevelElement")
actions_PreGenerationAction = Class(name="actions_PreGenerationAction", is_abstract=True)
IContextVariable = Class(name="IContextVariable")
actions_TimedConditionAction = Class(name="actions_TimedConditionAction")
rules_IRealTimeConsumer = Class(name="rules_IRealTimeConsumer")
ILogicFunction = Class(name="ILogicFunction")
Action = Class(name="Action")
actions_SetPropertyAction = Class(name="actions_SetPropertyAction")
DataLeaf = Class(name="DataLeaf")
DataElement = Class(name="DataElement")
actions_FailAction = Class(name="actions_FailAction")
actions_TimeAction = Class(name="actions_TimeAction")
ITimeConsumer = Class(name="ITimeConsumer")
actions_DependentAction = Class(name="actions_DependentAction", is_abstract=True)
actions_GetPropertyAction = Class(name="actions_GetPropertyAction")
DependentAction = Class(name="DependentAction")
actions_GetRealTimeAction = Class(name="actions_GetRealTimeAction")
actions_GetFeatureStateAction = Class(name="actions_GetFeatureStateAction")
actions_GetDataAction = Class(name="actions_GetDataAction")
actions_RemoveBagAction = Class(name="actions_RemoveBagAction")
DataBag = Class(name="DataBag")
IArithmetricFunction = Class(name="IArithmetricFunction")
actions_ActivateFeatureAction = Class(name="actions_ActivateFeatureAction")
IFeature = Class(name="IFeature")
FeatureVersion = Class(name="FeatureVersion")
actions_DeactivateFeatureAction = Class(name="actions_DeactivateFeatureAction")
...
domain_model = DomainModel(
    name="actions",
    types={actions_Action, actions_ActionReference, PreGenerationAction, actions_StandAloneAction, actions_PostGenerationAction, actions_PreGenerationSequence, actions_PostGenerationSequence, PostGenerationAction, actions_ThrowAction, actions_TermAction, ReconfigurationAction, actions_Term, actions_ReconfigurationAction, actions_SetDataAction, IValueFunction, IDataNodeFunction, actions_EObject, core_AbstractModelElement, core_ITopLevelElement, actions_PreGenerationAction, IContextVariable, actions_TimedConditionAction, rules_IRealTimeConsumer, ILogicFunction, Action, actions_SetPropertyAction, DataLeaf, DataElement, actions_FailAction, actions_TimeAction, ITimeConsumer, actions_DependentAction, actions_GetPropertyAction, DependentAction, actions_GetRealTimeAction, actions_GetFeatureStateAction, actions_GetDataAction, actions_RemoveBagAction, DataBag, IArithmetricFunction, actions_ActivateFeatureAction, IFeature, FeatureVersion, actions_DeactivateFeatureAction},
    associations={action0, actions11, actions13, term14, values15, node16, parameters1, action3, parameters5, action7, condition9, property28, value29, consumer31, property32, feature34, node18, bag20, index21, feature23, version24, feature26},
    generalizations={gen_actions_ActionReference_PreGenerationAction, gen_actions_PostGenerationAction_Action, gen_actions_PreGenerationSequence_PreGenerationAction, gen_actions_PostGenerationSequence_PostGenerationAction, gen_actions_ThrowAction_PreGenerationAction, gen_actions_TermAction_PostGenerationAction, gen_actions_TermAction_PreGenerationAction, gen_actions_TermAction_ReconfigurationAction, gen_actions_ReconfigurationAction_PreGenerationAction, gen_actions_SetDataAction_ReconfigurationAction, gen_actions_StandAloneAction_core_AbstractModelElement, gen_actions_StandAloneAction_core_ITopLevelElement, gen_actions_TimedConditionAction_core_AbstractModelElement, gen_actions_TimedConditionAction_core_ITopLevelElement, gen_actions_TimedConditionAction_rules_IRealTimeConsumer, gen_actions_PreGenerationAction_Action, gen_actions_SetPropertyAction_PostGenerationAction, gen_actions_FailAction_PostGenerationAction, gen_actions_FailAction_PreGenerationAction, gen_actions_TimeAction_PreGenerationAction, gen_actions_DependentAction_PostGenerationAction, gen_actions_GetPropertyAction_DependentAction, gen_actions_GetRealTimeAction_DependentAction, gen_actions_GetRealTimeAction_PreGenerationAction, gen_actions_GetFeatureStateAction_DependentAction, gen_actions_GetFeatureStateAction_PreGenerationAction, gen_actions_GetDataAction_PreGenerationAction, gen_actions_RemoveBagAction_ReconfigurationAction, gen_actions_ActivateFeatureAction_PostGenerationAction, gen_actions_ActivateFeatureAction_ReconfigurationAction, gen_actions_DeactivateFeatureAction_PostGenerationAction, gen_actions_DeactivateFeatureAction_ReconfigurationAction},
    metadata=None
)
