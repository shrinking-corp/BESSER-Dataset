...
class actions_TermAction(ReconfigurationAction, PreGenerationAction, PostGenerationAction):
...
class core_AbstractModelElement:
    ...
    pass
class actions_TimedConditionAction(core_AbstractModelElement, core_ITopLevelElement, rules_IRealTimeConsumer):
