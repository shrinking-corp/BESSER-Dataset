...
# Classes
eol_EOLElement = Class(name="eol_EOLElement")
eol_Import = Class(name="eol_Import")
eol_ModelDeclarationStatement = Class(name="eol_ModelDeclarationStatement")
eol_OperationDefinition = Class(name="eol_OperationDefinition")
eol_EOLModule = Class(name="eol_EOLModule")
EOLLibraryModule = Class(name="EOLLibraryModule")
eol_Block = Class(name="eol_Block")
eol_Statement = Class(name="eol_Statement", is_abstract=True)
eol_AnnotationBlock = Class(name="eol_AnnotationBlock")
Block = Class(name="Block")
eol_ExpressionOrStatementBlock = Class(name="eol_ExpressionOrStatementBlock")
eol_Expression = Class(name="eol_Expression", is_abstract=True)
eol_Type = Class(name="eol_Type")
eol_TextRegion = Class(name="eol_TextRegion")
eol_TextPosition = Class(name="eol_TextPosition")
eol_EOLLibraryModule = Class(name="eol_EOLLibraryModule")
EOLElement = Class(name="EOLElement")
eol_OperatorExpression = Class(name="eol_OperatorExpression", is_abstract=True)
Expression = Class(name="Expression")
eol_UnaryOperatorExpression = Class(name="eol_UnaryOperatorExpression", is_abstract=True)
OperatorExpression = Class(name="OperatorExpression")
eol_NotOperatorExpression = Class(name="eol_NotOperatorExpression")
UnaryOperatorExpression = Class(name="UnaryOperatorExpression")
eol_NegativeOperatorExpression = Class(name="eol_NegativeOperatorExpression")
eol_BinaryOperatorExpression = Class(name="eol_BinaryOperatorExpression", is_abstract=True)
eol_LogicalOperatorExpression = Class(name="eol_LogicalOperatorExpression", is_abstract=True)
BinaryOperatorExpression = Class(name="BinaryOperatorExpression")
eol_AndOperatorExpression = Class(name="eol_AndOperatorExpression")
LogicalOperatorExpression = Class(name="LogicalOperatorExpression")
eol_XorOperatorExpression = Class(name="eol_XorOperatorExpression")
eol_OrOperatorExpression = Class(name="eol_OrOperatorExpression")
eol_ImpliesOperatorExpression = Class(name="eol_ImpliesOperatorExpression")
eol_ArithmeticOperatorExpression = Class(name="eol_ArithmeticOperatorExpression", is_abstract=True)
eol_NameExpression = Class(name="eol_NameExpression")
eol_FormalParameterExpression = Class(name="eol_FormalParameterExpression")
eol_VariableDeclarationExpression = Class(name="eol_VariableDeclarationExpression")
eol_FeatureCallExpression = Class(name="eol_FeatureCallExpression", is_abstract=True)
eol_MethodCallExpression = Class(name="eol_MethodCallExpression")
FeatureCallExpression = Class(name="FeatureCallExpression")
eol_PropertyCallExpression = Class(name="eol_PropertyCallExpression")
eol_FOLMethodCallExpression = Class(name="eol_FOLMethodCallExpression")
eol_KeyValueExpression = Class(name="eol_KeyValueExpression")
eol_DivideOperatorExpression = Class(name="eol_DivideOperatorExpression")
ArithmeticOperatorExpression = Class(name="ArithmeticOperatorExpression")
eol_MultiplyOperatorExpression = Class(name="eol_MultiplyOperatorExpression")
eol_MinusOperatorExpression = Class(name="eol_MinusOperatorExpression")
eol_PlusOperatorExpression = Class(name="eol_PlusOperatorExpression")
eol_ModelDeclarationParameter = Class(name="eol_ModelDeclarationParameter")
KeyValueExpression = Class(name="KeyValueExpression")
eol_ComparisonOperatorExpression = Class(name="eol_ComparisonOperatorExpression", is_abstract=True)
eol_GreaterThanOrEqualToOperatorExpression = Class(name="eol_GreaterThanOrEqualToOperatorExpression")
ComparisonOperatorExpression = Class(name="ComparisonOperatorExpression")
eol_GreaterThanOperatorExpression = Class(name="eol_GreaterThanOperatorExpression")
eol_LessThanOrEqualToOperatorExpression = Class(name="eol_LessThanOrEqualToOperatorExpression")
eol_LessThanOperatorExpression = Class(name="eol_LessThanOperatorExpression")
eol_NotEqualsOperatorExpression = Class(name="eol_NotEqualsOperatorExpression")
eol_EqualsOperatorExpression = Class(name="eol_EqualsOperatorExpression")
VariableDeclarationExpression = Class(name="VariableDeclarationExpression")
eol_PrimitiveExpression = Class(name="eol_PrimitiveExpression", is_abstract=True)
eol_SwitchStatement = Class(name="eol_SwitchStatement")
eol_ComparableExpression = Class(name="eol_ComparableExpression", is_abstract=True)
PrimitiveExpression = Class(name="PrimitiveExpression")
eol_SummableExpression = Class(name="eol_SummableExpression", is_abstract=True)
eol_StringExpression = Class(name="eol_StringExpression")
ComparableExpression = Class(name="ComparableExpression")
SummableExpression = Class(name="SummableExpression")
eol_SwitchCaseExpressionStatement = Class(name="eol_SwitchCaseExpressionStatement")
eol_SwitchCaseDefaultStatement = Class(name="eol_SwitchCaseDefaultStatement")
eol_BooleanExpression = Class(name="eol_BooleanExpression")
eol_SwitchCaseStatement = Class(name="eol_SwitchCaseStatement", is_abstract=True)
eol_RealExpression = Class(name="eol_RealExpression")
SwitchCaseStatement = Class(name="SwitchCaseStatement")
eol_IntegerExpression = Class(name="eol_IntegerExpression")
eol_BagExpression = Class(name="eol_BagExpression")
CollectionExpression = Class(name="CollectionExpression")
eol_SetExpression = Class(name="eol_SetExpression")
UniqueCollection = Class(name="UniqueCollection")
eol_OrderedSetExpression = Class(name="eol_OrderedSetExpression")
OrderedCollection = Class(name="OrderedCollection")
eol_SequenceExpression = Class(name="eol_SequenceExpression")
eol_OrderedCollection = Class(name="eol_OrderedCollection", is_abstract=True)
eol_UniqueCollection = Class(name="eol_UniqueCollection", is_abstract=True)
eol_EnumerationLiteralExpression = Class(name="eol_EnumerationLiteralExpression")
eol_ExpressionRange = Class(name="eol_ExpressionRange")
CollectionInitialisationExpression = Class(name="CollectionInitialisationExpression")
eol_NewExpression = Class(name="eol_NewExpression")
eol_ExpressionList = Class(name="eol_ExpressionList")
eol_MapExpression = Class(name="eol_MapExpression")
eol_TransactionStatement = Class(name="eol_TransactionStatement")
Statement = Class(name="Statement")
eol_CollectionExpression = Class(name="eol_CollectionExpression", is_abstract=True)
eol_ExpressionStatement = Class(name="eol_ExpressionStatement")
eol_CollectionInitialisationExpression = Class(name="eol_CollectionInitialisationExpression", is_abstract=True)
eol_DeleteStatement = Class(name="eol_DeleteStatement")
eol_AssignmentStatement = Class(name="eol_AssignmentStatement")
eol_SpecialAssignmentStatement = Class(name="eol_SpecialAssignmentStatement")
AssignmentStatement = Class(name="AssignmentStatement")
eol_ContinueStatement = Class(name="eol_ContinueStatement")
eol_AbortStatement = Class(name="eol_AbortStatement")
eol_BreakStatement = Class(name="eol_BreakStatement")
eol_BreakAllStatement = Class(name="eol_BreakAllStatement")
eol_AnnotationStatement = Class(name="eol_AnnotationStatement", is_abstract=True)
eol_IfStatement = Class(name="eol_IfStatement")
eol_SimpleAnnotationStatement = Class(name="eol_SimpleAnnotationStatement")
AnnotationStatement = Class(name="AnnotationStatement")
eol_ForStatement = Class(name="eol_ForStatement")
eol_WhileStatement = Class(name="eol_WhileStatement")
eol_ReturnStatement = Class(name="eol_ReturnStatement")
eol_ThrowStatement = Class(name="eol_ThrowStatement")
eol_PseudoType = Class(name="eol_PseudoType", is_abstract=True)
eol_SelfType = Class(name="eol_SelfType")
PseudoType = Class(name="PseudoType")
eol_SelfContentType = Class(name="eol_SelfContentType")
eol_MapType = Class(name="eol_MapType")
eol_NativeType = Class(name="eol_NativeType")
eol_ExecutableAnnotationStatement = Class(name="eol_ExecutableAnnotationStatement")
eol_AnyType = Class(name="eol_AnyType")
Type = Class(name="Type")
eol_ModelType = Class(name="eol_ModelType")
AnyType = Class(name="AnyType")
eol_ModelElementType = Class(name="eol_ModelElementType")
eol_StringType = Class(name="eol_StringType")
eol_VoidType = Class(name="eol_VoidType")
eol_InvalidType = Class(name="eol_InvalidType")
eol_CollectionType = Class(name="eol_CollectionType")
eol_BagType = Class(name="eol_BagType")
CollectionType = Class(name="CollectionType")
eol_OrderedCollectionType = Class(name="eol_OrderedCollectionType", is_abstract=True)
eol_UniqueCollectionType = Class(name="eol_UniqueCollectionType", is_abstract=True)
eol_SetType = Class(name="eol_SetType")
UniqueCollectionType = Class(name="UniqueCollectionType")
eol_OrderedSetType = Class(name="eol_OrderedSetType")
OrderedCollectionType = Class(name="OrderedCollectionType")
eol_SequenceType = Class(name="eol_SequenceType")
eol_PrimitiveType = Class(name="eol_PrimitiveType", is_abstract=True)
eol_ComparablePrimitiveType = Class(name="eol_ComparablePrimitiveType", is_abstract=True)
PrimitiveType = Class(name="PrimitiveType")
eol_SummablePrimitiveType = Class(name="eol_SummablePrimitiveType", is_abstract=True)
eol_BooleanType = Class(name="eol_BooleanType")
eol_RealType = Class(name="eol_RealType")
ComparablePrimitiveType = Class(name="ComparablePrimitiveType")
SummablePrimitiveType = Class(name="SummablePrimitiveType")
eol_IntegerType = Class(name="eol_IntegerType")
...
eol_NameExpression.attributes={eol_NameExpression_resolvedContent, eol_NameExpression_name, eol_NameExpression_isType}
...
eol_ModelElementType.attributes={eol_ModelElementType_modelElementType, eol_ModelElementType_resolvedIPackage, eol_ModelElementType_modelName, eol_ModelElementType_elementName, eol_ModelElementType_resolvedIMetamodel}
...
domain_model = DomainModel(
    name="eol",
    types={eol_EOLElement, eol_Import, eol_ModelDeclarationStatement, eol_OperationDefinition, eol_EOLModule, EOLLibraryModule, eol_Block, eol_Statement, eol_AnnotationBlock, Block, eol_ExpressionOrStatementBlock, eol_Expression, eol_Type, eol_TextRegion, eol_TextPosition, eol_EOLLibraryModule, EOLElement, eol_OperatorExpression, Expression, eol_UnaryOperatorExpression, OperatorExpression, eol_NotOperatorExpression, UnaryOperatorExpression, eol_NegativeOperatorExpression, eol_BinaryOperatorExpression, eol_LogicalOperatorExpression, BinaryOperatorExpression, eol_AndOperatorExpression, LogicalOperatorExpression, eol_XorOperatorExpression, eol_OrOperatorExpression, eol_ImpliesOperatorExpression, eol_ArithmeticOperatorExpression, eol_NameExpression, eol_FormalParameterExpression, eol_VariableDeclarationExpression, eol_FeatureCallExpression, eol_MethodCallExpression, FeatureCallExpression, eol_PropertyCallExpression, eol_FOLMethodCallExpression, eol_KeyValueExpression, eol_DivideOperatorExpression, ArithmeticOperatorExpression, eol_MultiplyOperatorExpression, eol_MinusOperatorExpression, eol_PlusOperatorExpression, eol_ModelDeclarationParameter, KeyValueExpression, eol_ComparisonOperatorExpression, eol_GreaterThanOrEqualToOperatorExpression, ComparisonOperatorExpression, eol_GreaterThanOperatorExpression, eol_LessThanOrEqualToOperatorExpression, eol_LessThanOperatorExpression, eol_NotEqualsOperatorExpression, eol_EqualsOperatorExpression, VariableDeclarationExpression, eol_PrimitiveExpression, eol_SwitchStatement, eol_ComparableExpression, PrimitiveExpression, eol_SummableExpression, eol_StringExpression, ComparableExpression, SummableExpression, eol_SwitchCaseExpressionStatement, eol_SwitchCaseDefaultStatement, eol_BooleanExpression, eol_SwitchCaseStatement, eol_RealExpression, SwitchCaseStatement, eol_IntegerExpression, eol_BagExpression, CollectionExpression, eol_SetExpression, UniqueCollection, eol_OrderedSetExpression, OrderedCollection, eol_SequenceExpression, eol_OrderedCollection, eol_UniqueCollection, eol_EnumerationLiteralExpression, eol_ExpressionRange, CollectionInitialisationExpression, eol_NewExpression, eol_ExpressionList, eol_MapExpression, eol_TransactionStatement, Statement, eol_CollectionExpression, eol_ExpressionStatement, eol_CollectionInitialisationExpression, eol_DeleteStatement, eol_AssignmentStatement, eol_SpecialAssignmentStatement, AssignmentStatement, eol_ContinueStatement, eol_AbortStatement, eol_BreakStatement, eol_BreakAllStatement, eol_AnnotationStatement, eol_IfStatement, eol_SimpleAnnotationStatement, AnnotationStatement, eol_ForStatement, eol_WhileStatement, eol_ReturnStatement, eol_ThrowStatement, eol_PseudoType, eol_SelfType, PseudoType, eol_SelfContentType, eol_MapType, eol_NativeType, eol_ExecutableAnnotationStatement, eol_AnyType, Type, eol_ModelType, AnyType, eol_ModelElementType, eol_StringType, eol_VoidType, eol_InvalidType, eol_CollectionType, eol_BagType, CollectionType, eol_OrderedCollectionType, eol_UniqueCollectionType, eol_SetType, UniqueCollectionType, eol_OrderedSetType, OrderedCollectionType, eol_SequenceType, eol_PrimitiveType, eol_ComparablePrimitiveType, PrimitiveType, eol_SummablePrimitiveType, eol_BooleanType, eol_RealType, ComparablePrimitiveType, SummablePrimitiveType, eol_IntegerType, RealType},
    associations={container1, imports9, modelDeclarations10, operations12, block14, importedModule15, statements18, block20, expression22, condition24, contextType27, returnType29, annotationBlock32, body34, region2, start4, end6, resolvedType49, expression52, lhs54, rhs56, name37, parameters39, self41, _result43, dependingOperationDefinitions47, target65, arguments67, method69, resolvedOperationDefinition72, property75, iterator77, conditions79, method82, resolvedFOLDefinition85, key88, value90, name59, references62, parameterList102, expression124, expression126, cases128, default130, body132, expression134, literal104, enumeration106, model109, start112, end114, typeName93, expressions117, parameters95, keyValues98, names119, body121, contents100, expression165, lhs167, rhs169, name172, condition137, ifBody139, elseIfBodies142, elseBody145, iterator148, condition150, body153, condition156, body158, expression161, expression163, resolvedModelDeclaration190, keyType192, valueType194, expression197, values174, expression175, name177, driver180, aliases183, parameters186, dynamicTypes188, contentType199},
    generalizations={gen_eol_EOLModule_EOLLibraryModule, gen_eol_Import_EOLElement, gen_eol_Block_EOLElement, gen_eol_AnnotationBlock_Block, gen_eol_ExpressionOrStatementBlock_EOLElement, gen_eol_OperationDefinition_EOLElement, gen_eol_EOLLibraryModule_EOLElement, gen_eol_Expression_EOLElement, gen_eol_OperatorExpression_Expression, gen_eol_UnaryOperatorExpression_OperatorExpression, gen_eol_NotOperatorExpression_UnaryOperatorExpression, gen_eol_NegativeOperatorExpression_UnaryOperatorExpression, gen_eol_BinaryOperatorExpression_OperatorExpression, gen_eol_LogicalOperatorExpression_BinaryOperatorExpression, gen_eol_AndOperatorExpression_LogicalOperatorExpression, gen_eol_XorOperatorExpression_LogicalOperatorExpression, gen_eol_OrOperatorExpression_LogicalOperatorExpression, gen_eol_ImpliesOperatorExpression_LogicalOperatorExpression, gen_eol_ArithmeticOperatorExpression_BinaryOperatorExpression, gen_eol_NameExpression_Expression, gen_eol_FeatureCallExpression_Expression, gen_eol_MethodCallExpression_FeatureCallExpression, gen_eol_PropertyCallExpression_FeatureCallExpression, gen_eol_FOLMethodCallExpression_FeatureCallExpression, gen_eol_KeyValueExpression_Expression, gen_eol_DivideOperatorExpression_ArithmeticOperatorExpression, gen_eol_MultiplyOperatorExpression_ArithmeticOperatorExpression, gen_eol_MinusOperatorExpression_ArithmeticOperatorExpression, gen_eol_PlusOperatorExpression_ArithmeticOperatorExpression, gen_eol_ModelDeclarationParameter_KeyValueExpression, gen_eol_ComparisonOperatorExpression_BinaryOperatorExpression, gen_eol_GreaterThanOrEqualToOperatorExpression_ComparisonOperatorExpression, gen_eol_GreaterThanOperatorExpression_ComparisonOperatorExpression, gen_eol_LessThanOrEqualToOperatorExpression_ComparisonOperatorExpression, gen_eol_LessThanOperatorExpression_ComparisonOperatorExpression, gen_eol_NotEqualsOperatorExpression_ComparisonOperatorExpression, gen_eol_EqualsOperatorExpression_ComparisonOperatorExpression, gen_eol_VariableDeclarationExpression_Expression, gen_eol_FormalParameterExpression_VariableDeclarationExpression, gen_eol_PrimitiveExpression_Expression, gen_eol_SwitchStatement_Statement, gen_eol_ComparableExpression_PrimitiveExpression, gen_eol_SummableExpression_PrimitiveExpression, gen_eol_StringExpression_ComparableExpression, gen_eol_StringExpression_SummableExpression, gen_eol_BooleanExpression_PrimitiveExpression, gen_eol_SwitchCaseStatement_Statement, gen_eol_RealExpression_ComparableExpression, gen_eol_RealExpression_SummableExpression, gen_eol_SwitchCaseDefaultStatement_SwitchCaseStatement, gen_eol_IntegerExpression_ComparableExpression, gen_eol_IntegerExpression_SummableExpression, gen_eol_SwitchCaseExpressionStatement_SwitchCaseStatement, gen_eol_BagExpression_CollectionExpression, gen_eol_SetExpression_UniqueCollection, gen_eol_OrderedSetExpression_OrderedCollection, gen_eol_OrderedSetExpression_UniqueCollection, gen_eol_SequenceExpression_OrderedCollection, gen_eol_OrderedCollection_CollectionExpression, gen_eol_UniqueCollection_CollectionExpression, gen_eol_EnumerationLiteralExpression_Expression, gen_eol_CollectionInitialisationExpression_Expression, gen_eol_ExpressionRange_CollectionInitialisationExpression, gen_eol_NewExpression_Expression, gen_eol_ExpressionList_CollectionInitialisationExpression, gen_eol_Statement_EOLElement, gen_eol_MapExpression_Expression, gen_eol_TransactionStatement_Statement, gen_eol_CollectionExpression_Expression, gen_eol_ExpressionStatement_Statement, gen_eol_DeleteStatement_Statement, gen_eol_AssignmentStatement_Statement, gen_eol_SpecialAssignmentStatement_AssignmentStatement, gen_eol_ContinueStatement_Statement, gen_eol_AbortStatement_Statement, gen_eol_BreakStatement_Statement, gen_eol_BreakAllStatement_Statement, gen_eol_AnnotationStatement_Statement, gen_eol_IfStatement_Statement, gen_eol_SimpleAnnotationStatement_AnnotationStatement, gen_eol_ForStatement_Statement, gen_eol_WhileStatement_Statement, gen_eol_ReturnStatement_Statement, gen_eol_ThrowStatement_Statement, gen_eol_PseudoType_AnyType, gen_eol_SelfType_PseudoType, gen_eol_SelfContentType_PseudoType, gen_eol_MapType_AnyType, gen_eol_NativeType_AnyType, gen_eol_ExecutableAnnotationStatement_AnnotationStatement, gen_eol_ModelDeclarationStatement_Statement, gen_eol_Type_EOLElement, gen_eol_AnyType_Type, gen_eol_ModelType_AnyType, gen_eol_ModelElementType_AnyType, gen_eol_StringType_ComparablePrimitiveType, gen_eol_StringType_SummablePrimitiveType, gen_eol_VoidType_AnyType, gen_eol_InvalidType_AnyType, gen_eol_CollectionType_AnyType, gen_eol_BagType_CollectionType, gen_eol_OrderedCollectionType_CollectionType, gen_eol_UniqueCollectionType_CollectionType, gen_eol_SetType_UniqueCollectionType, gen_eol_OrderedSetType_UniqueCollectionType, gen_eol_OrderedSetType_OrderedCollectionType, gen_eol_SequenceType_OrderedCollectionType, gen_eol_PrimitiveType_AnyType, gen_eol_ComparablePrimitiveType_PrimitiveType, gen_eol_SummablePrimitiveType_PrimitiveType, gen_eol_BooleanType_PrimitiveType, gen_eol_RealType_ComparablePrimitiveType, gen_eol_RealType_SummablePrimitiveType, gen_eol_IntegerType_RealType},
    metadata=None
)
