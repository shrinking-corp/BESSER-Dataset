...
public class eol_Block extends EOLElement {
    ...
    private eol_EOLModule eol_eolmodule;
    ...
    public eol_EOLModule getEol_eolmodule() {
        return eol_eolmodule;
    }

    public void setEol_eolmodule(eol_EOLModule eol_eolmodule) {
        this.eol_eolmodule = eol_eolmodule;
    }
