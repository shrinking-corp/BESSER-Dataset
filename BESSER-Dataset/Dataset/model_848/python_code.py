...
class occi_Configuration:
    ...
    def __init__(self, location: str, description: str, occi_Configuration: set["occi_Extension"] = None, occi_Configuration77: set["occi_Resource"] = None, occi_Configuration79: set["occi_Mixin"] = None):
...
class occi_Resource(Entity):
    ...
    def __init__(self, summary: str, occi_Resource: "occi_Configuration" = None, source57: set["occi_Link"] = None, target: set["occi_Link"] = None, Resource: "occi_Link" = None, Resource62: "occi_Link" = None):
...
class occi_Extension:
    ...
    def __init__(self, name: str, scheme: str, description: str, specification: str, occi_Extension69: set["occi_Mixin"] = None, occi_Extension72: set["occi_DataType"] = None, occi_Extension75: "occi_Configuration" = None, occi_Extension: "occi_Extension" = None, occi_Extension63: set["occi_Extension"] = None, occi_Extension66: set["occi_Kind"] = None):
        self.name = name
        self.scheme = scheme
        self.description = description
...
class occi_Link(Entity):
    ...
    def LinkSourceInvariant(self, occi_linkInstanceKind, occi_resourcekind) :
        # TODO: Implement LinkSourceInvariant method
        pass

    def LinkTargetInvariant(self, occi_resourcekind, occi_linkInstanceKind) :
        # TODO: Implement LinkTargetInvariant method
        pass

class occi_Entity(ABC):

    def __init__(self, id: str, title: str, location: str, occi_Entity40: "occi_Mixin" = None, occi_Entity42: "occi_Kind" = None, occi_Entity45: set["occi_AttributeState"] = None, occi_Entity47: set["occi_Mixin"] = None, entity: set["occi_MixinBase"] = None, Entity: "occi_MixinBase" = None, occi_Entity: "occi_Kind" = None):
        self.id = id
        self.title = title
        self.location = location
...
class occi_Kind(Type):
    ...
    def __init__(self, occi_Kind37: "occi_Mixin" = None, occi_Kind43: "occi_Entity" = None, occi_Kind: "occi_Kind" = None, occi_Kind23: "occi_Kind" = None, occi_Kind26: set["occi_Entity"] = None, occi_Kind29: "occi_Kind" = None, occi_Kind27: set["occi_Kind"] = None, occi_Kind32: "occi_Kind" = None, occi_Kind30: set["occi_Kind"] = None, occi_Kind67: "occi_Extension" = None):
    ...
    def occiIsKindOf(self, occi_kind) :
        # TODO: Implement occiIsKindOf method
        pass

class occi_DataType(ABC):

    def __init__(self, name: str, documentation: str, occi_DataType73: "occi_Extension" = None, occi_DataType: "occi_Attribute" = None, occi_DataType85: "occi_ArrayType" = None):
        self.name = name
...
class occi_State:
    ...
    def __init__(self, initial: str, final: str, source: set["occi_Transition"] = None, State15: "occi_Transition" = None, occi_State17: "occi_Transition" = None, State: "occi_FSM" = None, occi_State: "occi_EnumerationLiteral" = None, ownedState: "occi_FSM" = None):
...
class occi_Category(AnnotatedElement):
    ...
    def __init__(self, title: str, description: str, name: str, term: str, scheme: str, occi_Category: set["occi_Attribute"] = None):
        self.title = title
        self.description = description
        self.name = name
        self.term = term
