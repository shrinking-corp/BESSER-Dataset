...
# Classes
ocltutorial_Library = Class(name="ocltutorial_Library")
ocltutorial_Book = Class(name="ocltutorial_Book")
ocltutorial_Member = Class(name="ocltutorial_Member")
ocltutorial_Loans = Class(name="ocltutorial_Loans")
...
ocltutorial_Book.attributes={ocltutorial_Book_name, ocltutorial_Book_copies}
...
domain_model = DomainModel(
    name="ocltutorial",
    types={ocltutorial_Library, ocltutorial_Book, ocltutorial_Member, ocltutorial_Loans},
    associations={books0, members1, loans3, library4, member5, book7, library9},
    generalizations={},
    metadata=None
)
