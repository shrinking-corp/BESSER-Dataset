...
# Classes
benchmark_Scenario = Class(name="benchmark_Scenario")
NamedElement = Class(name="NamedElement")
benchmark_InputData = Class(name="benchmark_InputData")
benchmark_TestCase = Class(name="benchmark_TestCase")
benchmark_Variant = Class(name="benchmark_Variant")
benchmark_TimeResult = Class(name="benchmark_TimeResult")
benchmark_Property = Class(name="benchmark_Property")
benchmark_NamedElement = Class(name="benchmark_NamedElement")
...
domain_model = DomainModel(
    name="benchmark",
    types={benchmark_Scenario, NamedElement, benchmark_InputData, benchmark_TestCase, benchmark_Variant, benchmark_TimeResult, benchmark_Property, benchmark_NamedElement},
    associations={inputData0, testCases1, variants3, inputData5, results6, tests8, properties9, variant10, properties11, results14},
    generalizations={gen_benchmark_Scenario_NamedElement, gen_benchmark_TestCase_NamedElement, gen_benchmark_InputData_NamedElement, gen_benchmark_Variant_NamedElement},
    metadata=None
)
