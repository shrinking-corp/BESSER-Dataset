...
class benchmark_Property:
    ...
    def __init__(self, name: str, value: str, benchmark_Property: "benchmark_NamedElement" = None, benchmark_Property13: "benchmark_TimeResult" = None):
        self.name = name
        self.value = value
...
class benchmark_TimeResult:
    ...
    def __init__(self, elapsedTime: str, elapsedMaxTime: str, benchmark_TimeResult: "benchmark_TestCase" = None, results: "benchmark_Variant" = None, benchmark_TimeResult12: set["benchmark_Property"] = None, TimeResult: "benchmark_Variant" = None):
