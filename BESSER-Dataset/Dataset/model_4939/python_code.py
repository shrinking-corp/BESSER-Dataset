...
class ric_Tab:
    ...
    def __init__(self, title: str, ric_Tab64: set["ric_ObjectComponent"] = None, ric_Tab67: set["ric_LineBreak"] = None, ric_Tab: "ric_TabbedPanel" = None, ric_Tab58: set["ric_InlineComponent"] = None, ric_Tab61: set["ric_BlockLevelComponent"] = None, ric_Tab70: set["ric_RichWidget"] = None, ric_Tab73: set["ric_List"] = None, ric_Tab76: set["ric_Form"] = None):
        self.title = title
...
class ric_MessageDialog(RichWidget):
    ...
    def __init__(self, minHeightResize: int, maxHeightResize: int, width: int, title: str, message: str, modal: bool, autoOpen: bool, resizable: bool, height: int, minWidthResize: int, maxWidthResize: int, ric_MessageDialog: set["ric_MessageDialogButton"] = None):
...
class ric_ObjectComponent(ABC):
    ...
    def __init__(self, align: str, width: int, height: int, border: int, hspace: int, vspace: int, ric_ObjectComponent: "ric_Div" = None, ric_ObjectComponent65: "ric_Tab" = None, ric_ObjectComponent87: "ric_Section" = None, ric_ObjectComponent162: "ric_Document" = None, ric_ObjectComponent135: "ric_ContextualNavigationRegion" = None, ric_ObjectComponent183: "ric_FooterRegion" = None):
        self.align = align
        self.width = width
        self.height = height
        self.border = border
...
class ric_Document(EventComponent):
    ...
    def __init__(self, title: str, index: bool, fileName: str, ric_Document: "ric_Form" = None, ric_Document55: "ric_Link" = None, ric_Document153: "ric_ContentRegion" = None, ric_Document161: set["ric_ObjectComponent"] = None, ric_Document155: set["ric_InlineComponent"] = None, ric_Document158: set["ric_BlockLevelComponent"] = None, ric_Document164: set["ric_LineBreak"] = None, ric_Document167: set["ric_RichWidget"] = None, ric_Document170: set["ric_List"] = None, ric_Document173: set["ric_Form"] = None):
        self.title = title
        self.index = index
...
class IdentifiableComponent:
    ...
    pass
class ric_Link(IdentifiableComponent, InlineComponent, ClassifiableComponent, EventComponent):
...
class ric_Paragraph(IdentifiableComponent, InlineComponent, ClassifiableComponent, EventComponent):
...
class ric_Image(IdentifiableComponent, ObjectComponent, ClassifiableComponent, EventComponent):
...
class ric_Heading(IdentifiableComponent, InlineComponent, ClassifiableComponent, EventComponent):
...
class ric_LineBreak(IdentifiableComponent, ClassifiableComponent):
    ...
    pass
class ric_List(IdentifiableComponent, ClassifiableComponent, EventComponent):

    pass
class ric_Fieldset(IdentifiableComponent, ClassifiableComponent, EventComponent):
...
class ric_RichWidget(IdentifiableComponent, ClassifiableComponent):
    ...
    pass
class ric_Div(IdentifiableComponent, ClassifiableComponent, EventComponent, BlockLevelComponent):
...
class ric_Span(IdentifiableComponent, InlineComponent, ClassifiableComponent, EventComponent):
...
class ric_PhraseElement(IdentifiableComponent, InlineComponent, ClassifiableComponent, EventComponent):
...
class ric_FormControl(IdentifiableComponent, ClassifiableComponent, EventComponent):

    def __init__(self, name: str, value: str, ric_FormControl9: "ric_RequiredFieldConstraint" = None, ric_FormControl11: "ric_ValidDateConstraint" = None, ric_FormControl: "ric_Label" = None, ric_FormControl3: set["ric_PhraseElement"] = None, ric_FormControl5: set["ric_ValueConstraint"] = None, ric_FormControl7: "ric_NumberValueConstraint" = None, ric_FormControl27: "ric_Fieldset" = None):
        self.name = name
        self.value = value
