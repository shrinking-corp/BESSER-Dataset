...
public class ric_Tab  {
    ...
    private ric_TabbedPanel ric_tabbedpanel;
    ...
    public ric_Tab(
        String title        ArrayList<ric_BlockLevelComponent> ric_blocklevelcomponents,        ArrayList<ric_Form> ric_forms,        ArrayList<ric_List> ric_lists,        ArrayList<ric_RichWidget> ric_richwidgets,        ArrayList<ric_InlineComponent> ric_inlinecomponents,        ArrayList<ric_LineBreak> ric_linebreaks,        ArrayList<ric_ObjectComponent> ric_objectcomponents    ) {
        this.title = title;
    ...
    public ric_TabbedPanel getRic_tabbedpanel() {
        return ric_tabbedpanel;
    }

    public void setRic_tabbedpanel(ric_TabbedPanel ric_tabbedpanel) {
        this.ric_tabbedpanel = ric_tabbedpanel;
    }
