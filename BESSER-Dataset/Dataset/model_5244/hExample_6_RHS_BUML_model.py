...
# Classes
hExample_6_RHS_model = Class(name="hExample_6_RHS_model")
hExample_6_RHS_X = Class(name="hExample_6_RHS_X")
hExample_6_RHS_Y = Class(name="hExample_6_RHS_Y")
hExample_6_RHS_Z = Class(name="hExample_6_RHS_Z")
