...
class hExample_6_RHS_Z:
    ...
    def __init__(self, name: str, hExample_6_RHS_Z10: "hExample_6_RHS_X" = None, hExample_6_RHS_Z: "hExample_6_RHS_model" = None):
        self.name = name
...
class hExample_6_RHS_Y:
    ...
    def __init__(self, name: str, hExample_6_RHS_Y7: "hExample_6_RHS_X" = None, hExample_6_RHS_Y: "hExample_6_RHS_model" = None):
        self.name = name
...
class hExample_6_RHS_X:
    ...
    def __init__(self, name: str, hExample_6_RHS_X6: "hExample_6_RHS_Y" = None, hExample_6_RHS_X9: set["hExample_6_RHS_Z"] = None, hExample_6_RHS_X: "hExample_6_RHS_model" = None):
        self.name = name
