...
# Classes
systemworkbench101_Function = Class(name="systemworkbench101_Function")
systemworkbench101_Component = Class(name="systemworkbench101_Component")
systemworkbench101_Workbench = Class(name="systemworkbench101_Workbench")
systemworkbench101_FunctionProperty = Class(name="systemworkbench101_FunctionProperty")
systemworkbench101_PatternCatalog = Class(name="systemworkbench101_PatternCatalog")
systemworkbench101_Thing = Class(name="systemworkbench101_Thing")
systemworkbench101_Thoughts = Class(name="systemworkbench101_Thoughts")
systemworkbench101_Named = Class(name="systemworkbench101_Named", is_abstract=True)
systemworkbench101_System = Class(name="systemworkbench101_System")
Named = Class(name="Named")
systemworkbench101_RelatedTo = Class(name="systemworkbench101_RelatedTo")
NamedElement = Class(name="NamedElement")
systemworkbench101_NamedElement = Class(name="systemworkbench101_NamedElement")
...
domain_model = DomainModel(
    ...
    types={systemworkbench101_Function, systemworkbench101_Component, systemworkbench101_Workbench, systemworkbench101_FunctionProperty, systemworkbench101_PatternCatalog, systemworkbench101_Thing, systemworkbench101_Thoughts, systemworkbench101_Named, systemworkbench101_System, Named, systemworkbench101_RelatedTo, NamedElement, systemworkbench101_NamedElement},
    associations={functionalArchitecture0, physicalArchitecture1, systemView3, functionProperties5, catalog7, things9, thoughts11, parent14, decompositions17, property19, associations23, allocatedTo25, decompositions27, patterns33, fromThing36, toThing38, relations41, associations30, performs32, relatedTo44},
    generalizations={gen_systemworkbench101_Workbench_Named, gen_systemworkbench101_System_Named, gen_systemworkbench101_Function_Named, gen_systemworkbench101_Component_Named, gen_systemworkbench101_FunctionProperty_Named, gen_systemworkbench101_RelatedTo_NamedElement, gen_systemworkbench101_Thing_NamedElement, gen_systemworkbench101_Thoughts_NamedElement},
    metadata=None
)
