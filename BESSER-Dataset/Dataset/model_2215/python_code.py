...
class studyProgramStructure_Student:
    ...
    def __init__(self, name: str, studyProgramStructure_Student: "studyProgramStructure_University" = None, student: "studyProgramStructure_StudyPlan" = None, studyProgramStructure_Student29: "studyProgramStructure_Program" = None, studyProgramStructure_Student32: set["studyProgramStructure_Specialization"] = None, Student: "studyProgramStructure_StudyPlan" = None):
        self.name = name
...
class studyProgramStructure_Semester:
    ...
    def __init__(self, year: int, season: str, studyProgramStructure_Semester: "studyProgramStructure_StudyPlan" = None, semester: set["studyProgramStructure_CourseGroup"] = None, Semester: "studyProgramStructure_Program" = None, Semester10: "studyProgramStructure_Specialization" = None, semesters: "studyProgramStructure_Program" = None, semesters16: "studyProgramStructure_Specialization" = None, Semester19: "studyProgramStructure_CourseGroup" = None):
        self.year = year
        self.season = season
...
class studyProgramStructure_Specialization:
    ...
    def __init__(self, name: str, numOfSemesters: int, studyProgramStructure_Specialization: "studyProgramStructure_Student" = None, Specialization: "studyProgramStructure_Program" = None, Specialization5: "studyProgramStructure_Specialization" = None, baseSpecialization: set["studyProgramStructure_Specialization"] = None, Specialization8: "studyProgramStructure_Specialization" = None, furtherSpecializations: "studyProgramStructure_Specialization" = None, specialization: set["studyProgramStructure_Semester"] = None, specializations: "studyProgramStructure_Program" = None, Specialization17: "studyProgramStructure_Semester" = None):
        self.name = name
...
class studyProgramStructure_Course:
    ...
    def __init__(self, name: str, code: str, credits: float, level: int, studyProgramStructure_Course24: "studyProgramStructure_University" = None, studyProgramStructure_Course39: "studyProgramStructure_CourseAllocation" = None, studyProgramStructure_Course: "studyProgramStructure_CourseGroup" = None):
        self.name = name
        self.code = code
...
class studyProgramStructure_Program:
    ...
    def __init__(self, name: str, code: str, numOfYears: int, numOfSemestersForBaseSpecialization: int, studyProgramStructure_Program: "studyProgramStructure_University" = None, studyProgramStructure_Program30: "studyProgramStructure_Student" = None, program: set["studyProgramStructure_Specialization"] = None, program2: set["studyProgramStructure_Semester"] = None, Program: "studyProgramStructure_Specialization" = None, Program14: "studyProgramStructure_Semester" = None):
        self.name = name
        self.code = code
    ...
    @property
    def numOfSemestersForBaseSpecialization(self):
