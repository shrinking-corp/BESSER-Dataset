...
def test_visits_ecommerce_tab_usecase_is_not_abstract():
    assert not inspect.isabstract(VISITS_ECOMMERCE_TAB_UseCase)


def test_visits_ecommerce_tab_usecase_constructor_exists():
    assert callable(VISITS_ECOMMERCE_TAB_UseCase.__init__)


def test_visits_ecommerce_tab_usecase_constructor_args():
