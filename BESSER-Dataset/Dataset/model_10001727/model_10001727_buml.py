...
creditcard.attributes={creditcard_issuer, creditcard_expirationdate, creditcard_number}
...
customer.attributes={customer_name, customer_addresstoship, customer_addresstobill}
...
shoppingcart.attributes={shoppingcart_subtotal, shoppingcart_total, shoppingcart_salestax}
...
domain_model = DomainModel(
    ...
    associations={customer_checks_availability_of_item, selectsitem_customer, shoppingcart_asks_feedback, shoppingcart_requests_to_rate_the_website, shoppingcart_gives_feedback, gives_feedback_customer, shoppingcart_itemtopurchase, creditcard_customer, customer_purchase, shoppingcart_placeorder, shoppingcart_cancelorder},
    generalizations={},
    metadata=None
)
