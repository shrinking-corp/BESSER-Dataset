...
# Classes
java_System = Class(name="java_System")
java_Package = Class(name="java_Package")
Container = Class(name="Container")
java_Class = Class(name="java_Class")
Classifier = Class(name="Classifier")
java_InterfaceImplementation = Class(name="java_InterfaceImplementation")
java_Interface = Class(name="java_Interface")
java_Classifier = Class(name="java_Classifier", is_abstract=True)
java_Generalization = Class(name="java_Generalization")
Contained = Class(name="Contained")
Annotable = Class(name="Annotable")
java_GenericBinding = Class(name="java_GenericBinding")
java_Method = Class(name="java_Method")
java_Import = Class(name="java_Import")
java_Contained = Class(name="java_Contained", is_abstract=True)
java_Container = Class(name="java_Container", is_abstract=True)
java_Argument = Class(name="java_Argument")
...
java_GETExpression = Class(name="java_GETExpression")
...
java_AnnotationInstanceParameter = Class(name="java_AnnotationInstanceParameter")
java_AnnotationInstanceValue = Class(name="java_AnnotationInstanceValue")
...
java_Method.attributes={java_Method_isDefault, java_Method_isAbstract, java_Method_name, java_Method_isStatic, java_Method_concurrency, java_Method_isFinal}
...
java_Argument.attributes={java_Argument_name, java_Argument_order}
...
java_Field.attributes={java_Field_default, java_Field_isFinal, java_Field_name, java_Field_isStatic}
...
java_GETExpression.attributes={java_GETExpression_leftSide, java_GETExpression_rightSide}
...
java_AnnotationInstanceValue.attributes={java_AnnotationInstanceValue_name, java_AnnotationInstanceValue_id, java_AnnotationInstanceValue_value}
...
domain_model = DomainModel(
    name="java",
    types={java_System, java_Package, Container, java_Class, Classifier, java_InterfaceImplementation, java_Interface, java_Classifier, java_Generalization, Contained, Annotable, java_GenericBinding, java_Method, java_Import, java_Contained, java_Container, java_Argument, java_Field, java_Statement, java_AssertStatement, Statement, java_GETExpression, java_Annotable, java_AnnotationInstance, java_Annotation, java_AnnotationInstanceParameter, java_AnnotationInstanceValue},
    associations={packages0, system1, extendedClass3, extendingClasses5, interface7, implementer8, general9, generalizator10, genericBindings12, fields13, methods14, interfaceImplementations16, generalization17, imports18, type19, containingClassifier21, imported23, importing25, container27, importingClasses28, returnType29, arguments31, containingClassifier32, raisedExceptions34, body37, method38, assertion40, containerStatement41, type42, usingMethod44, containedElements46, upperBoundings47, lowerBounding49, usingClassifier52, annotationInstances54, annotation55, parameters56, annotable57, values58, instance59, parameter61},
    generalizations={gen_java_Package_Container, gen_java_Class_Classifier, gen_java_Classifier_Contained, gen_java_Classifier_Container, gen_java_Classifier_Annotable, gen_java_Field_Contained, gen_java_Field_Annotable, gen_java_Method_Contained, gen_java_Method_Annotable, gen_java_AssertStatement_Statement, gen_java_Interface_Classifier, gen_java_Interface_Contained, gen_java_Interface_Container, gen_java_Annotation_Classifier},
    metadata=None
)
