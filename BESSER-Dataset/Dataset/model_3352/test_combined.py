...
def test_hyp_java_annotationinstancevalue_is_not_abstract():
    assert not inspect.isabstract(java_AnnotationInstanceValue)


def test_hyp_java_annotationinstancevalue_constructor_exists():
    assert callable(java_AnnotationInstanceValue.__init__)


def test_hyp_java_annotationinstancevalue_constructor_args():
...
def test_hyp_java_annotationinstanceparameter_is_not_abstract():
    assert not inspect.isabstract(java_AnnotationInstanceParameter)


def test_hyp_java_annotationinstanceparameter_constructor_exists():
    assert callable(java_AnnotationInstanceParameter.__init__)


def test_hyp_java_annotationinstanceparameter_constructor_args():
...
def test_hyp_java_getexpression_is_not_abstract():
    assert not inspect.isabstract(java_GETExpression)


def test_hyp_java_getexpression_constructor_exists():
    assert callable(java_GETExpression.__init__)


def test_hyp_java_getexpression_constructor_args():
...
def test_hyp_java_argument_is_not_abstract():
    assert not inspect.isabstract(java_Argument)


def test_hyp_java_argument_constructor_exists():
    assert callable(java_Argument.__init__)


def test_hyp_java_argument_constructor_args():
...
def test_hyp_java_container_is_not_abstract():
    assert not inspect.isabstract(java_Container)


def test_hyp_java_container_constructor_exists():
    assert callable(java_Container.__init__)


def test_hyp_java_container_constructor_args():
    sig = inspect.signature(java_Container.__init__)
    params = list(sig.parameters.keys())



def test_hyp_java_contained_is_not_abstract():
    assert not inspect.isabstract(java_Contained)


def test_hyp_java_contained_constructor_exists():
    assert callable(java_Contained.__init__)


def test_hyp_java_contained_constructor_args():
...
def test_hyp_java_genericbinding_is_not_abstract():
    assert not inspect.isabstract(java_GenericBinding)


def test_hyp_java_genericbinding_constructor_exists():
    assert callable(java_GenericBinding.__init__)


def test_hyp_java_genericbinding_constructor_args():
...
def test_hyp_java_generalization_is_not_abstract():
    assert not inspect.isabstract(java_Generalization)


def test_hyp_java_generalization_constructor_exists():
    assert callable(java_Generalization.__init__)


def test_hyp_java_generalization_constructor_args():
...
def test_hyp_java_interfaceimplementation_is_not_abstract():
    assert not inspect.isabstract(java_InterfaceImplementation)


def test_hyp_java_interfaceimplementation_constructor_exists():
    assert callable(java_InterfaceImplementation.__init__)


def test_hyp_java_interfaceimplementation_constructor_args():
...
def test_hyp_java_system_is_not_abstract():
    assert not inspect.isabstract(java_System)


def test_hyp_java_system_constructor_exists():
    assert callable(java_System.__init__)


def test_hyp_java_system_constructor_args():
...
def test_hyp_java_annotationinstancevalue_value_setter(instance):
...
@given(instance=java_AnnotationInstanceValue_strategy)
def test_hyp_java_annotationinstancevalue_id_setter(instance):
...
@given(instance=java_AnnotationInstanceValue_strategy)
def test_hyp_java_annotationinstancevalue_name_setter(instance):
...
def test_hyp_java_annotationinstanceparameter_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_java_annotationinstance_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_java_getexpression_rightSide_setter(instance):
...
@given(instance=java_GETExpression_strategy)
def test_hyp_java_getexpression_leftSide_setter(instance):
...
def test_hyp_java_argument_order_setter(instance):
...
@given(instance=java_Argument_strategy)
def test_hyp_java_argument_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_java_contained_visibility_setter(instance):
...
def test_hyp_java_import_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_java_genericbinding_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_java_field_isFinal_setter(instance):
...
@given(instance=java_Field_strategy)
def test_hyp_java_field_default_setter(instance):
...
def test_hyp_java_method_isDefault_setter(instance):
...
@given(instance=java_Method_strategy)
def test_hyp_java_method_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=java_Method_strategy)
def test_hyp_java_method_isStatic_setter(instance):
    original = instance.isStatic
    instance.isStatic = original
    assert instance.isStatic == original
...
@given(instance=java_Method_strategy)
def test_hyp_java_method_isAbstract_setter(instance):
...
@given(instance=java_Method_strategy)
def test_hyp_java_method_isFinal_setter(instance):
    original = instance.isFinal
    instance.isFinal = original
    assert instance.isFinal == original
...
@given(instance=java_Method_strategy)
def test_hyp_java_method_concurrency_setter(instance):
...
def test_hyp_java_generalization_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_java_interfaceimplementation_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=java_Class_strategy)
def test_hyp_java_class_isFinal_setter(instance):
    original = instance.isFinal
    instance.isFinal = original
    assert instance.isFinal == original
...
@given(instance=java_Class_strategy)
def test_hyp_java_class_isAbstract_setter(instance):
    original = instance.isAbstract
    instance.isAbstract = original
    assert instance.isAbstract == original
...
def test_hyp_java_classifier_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_java_system_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
