...
class java_AnnotationInstanceParameter:
    ...
    def __init__(self, name: str, AnnotationInstanceParameter: "java_AnnotationInstance" = None, parameter: set["java_AnnotationInstanceValue"] = None, parameters: "java_AnnotationInstance" = None, AnnotationInstanceParameter62: "java_AnnotationInstanceValue" = None):
        self.name = name
...
class java_AnnotationInstance:
    ...
    def __init__(self, name: str, AnnotationInstance: "java_Annotable" = None, java_AnnotationInstance: "java_Annotation" = None, instance: set["java_AnnotationInstanceParameter"] = None, annotationInstances: "java_Annotable" = None, AnnotationInstance60: "java_AnnotationInstanceParameter" = None):
        self.name = name
...
class java_Import:
    ...
    def __init__(self, name: str, Import: "java_Classifier" = None, java_Import: "java_Classifier" = None, imports: "java_Classifier" = None):
        self.name = name
        self.Import = Import
...
class Contained:
    ...
    pass
class java_Field(Annotable, Contained):

    def __init__(self, name: str, default: str, isStatic: bool, isFinal: bool, Field: "java_Classifier" = None, java_Field: "java_Classifier" = None, fields: "java_Classifier" = None):
        self.name = name
...
class java_Method(Annotable, Contained):

    def __init__(self, name: str, concurrency: str, isAbstract: bool, isDefault: bool, isFinal: bool, isStatic: bool, Method: "java_Classifier" = None, java_Method: "java_Classifier" = None, usingMethod: set["java_Argument"] = None, methods: "java_Classifier" = None, java_Method35: set["java_Classifier"] = None, method: set["java_Statement"] = None, Method39: "java_Statement" = None, Method45: "java_Argument" = None):
        self.name = name
...
class java_InterfaceImplementation:
    ...
    def __init__(self, name: str, java_InterfaceImplementation: "java_Interface" = None, interfaceImplementations: "java_Classifier" = None, InterfaceImplementation: "java_Classifier" = None):
        self.name = name
...
class Container:
    ...
    pass
class java_Interface(Classifier, Container, Contained):

    pass
class java_Classifier(Annotable, Container, Contained):

    def __init__(self, name: str, Classifier: "java_InterfaceImplementation" = None, java_Classifier: "java_Generalization" = None, Classifier11: "java_Generalization" = None, usingClassifier: set["java_GenericBinding"] = None, containingClassifier: set["java_Field"] = None, containingClassifier15: set["java_Method"] = None, implementer: set["java_InterfaceImplementation"] = None, generalizator: "java_Generalization" = None, importing: set["java_Import"] = None, java_Classifier20: "java_Field" = None, Classifier22: "java_Field" = None, java_Classifier24: "java_Import" = None, java_Classifier48: "java_GenericBinding" = None, java_Classifier51: "java_GenericBinding" = None, Classifier53: "java_GenericBinding" = None, Classifier26: "java_Import" = None, java_Classifier30: "java_Method" = None, Classifier33: "java_Method" = None, java_Classifier36: "java_Method" = None, java_Classifier43: "java_Argument" = None):
        self.name = name
