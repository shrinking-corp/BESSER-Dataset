...
def test_hyp_sql_annotation_is_not_abstract():
    assert not inspect.isabstract(sql_Annotation)


def test_hyp_sql_annotation_constructor_exists():
    assert callable(sql_Annotation.__init__)


def test_hyp_sql_annotation_constructor_args():
...
def test_hyp_sql_modelelement_is_not_abstract():
    assert not inspect.isabstract(sql_ModelElement)


def test_hyp_sql_modelelement_constructor_exists():
    assert callable(sql_ModelElement.__init__)


def test_hyp_sql_modelelement_constructor_args():
...
def test_hyp_sql_schema_is_not_abstract():
    assert not inspect.isabstract(sql_Schema)


def test_hyp_sql_schema_constructor_exists():
    assert callable(sql_Schema.__init__)


def test_hyp_sql_schema_constructor_args():
...
def test_hyp_sql_event_is_not_abstract():
    assert not inspect.isabstract(sql_Event)


def test_hyp_sql_event_constructor_exists():
    assert callable(sql_Event.__init__)


def test_hyp_sql_event_constructor_args():
...
def test_hyp_sql_key_is_not_abstract():
    assert not inspect.isabstract(sql_Key)


def test_hyp_sql_key_constructor_exists():
    assert callable(sql_Key.__init__)


def test_hyp_sql_key_constructor_args():
...
def test_hyp_condition_exists():
    # Check that the Enumeration exists
    assert Condition is not None

def test_hyp_condition_has_all_literals():
...
def test_hyp_sql_annotation_annotation_setter(instance):
...
@given(instance=sql_Column_strategy)
def test_hyp_sql_column_properties_setter(instance):
...
def test_hyp_sql_event_action_setter(instance):
...
@given(instance=sql_Event_strategy)
def test_hyp_sql_event_condition_setter(instance):
