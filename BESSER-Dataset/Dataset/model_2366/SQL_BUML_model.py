...
# Classes
sql_NamedElement = Class(name="sql_NamedElement", is_abstract=True)
ModelElement = Class(name="ModelElement")
sql_PrimaryKey = Class(name="sql_PrimaryKey")
sql_ForeignKey = Class(name="sql_ForeignKey")
sql_Schema = Class(name="sql_Schema")
sql_Key = Class(name="sql_Key", is_abstract=True)
Key = Class(name="Key")
sql_Event = Class(name="sql_Event")
sql_Table = Class(name="sql_Table")
NamedElement = Class(name="NamedElement")
sql_Column = Class(name="sql_Column")
sql_ModelElement = Class(name="sql_ModelElement", is_abstract=True)
sql_Annotation = Class(name="sql_Annotation")
...
sql_Column.attributes={sql_Column_properties, sql_Column_type}
...
domain_model = DomainModel(
    name="sql",
    types={sql_NamedElement, ModelElement, sql_PrimaryKey, sql_ForeignKey, sql_Schema, sql_Key, Key, sql_Event, sql_Table, NamedElement, sql_Column, sql_ModelElement, sql_Annotation, Condition, Action, Property_},
    associations={ownedPrimaryKey1, ownedForeignKeys3, referencingForeignKeys5, owningSchema7, owningTable8, keys9, column10, owningTable12, referencedTable14, owningTable16, ownedEvents18, ownedColumns0, ownedTables21, ownedAnnotations23, owningModelElement24, owningForeignKey19},
    generalizations={gen_sql_NamedElement_ModelElement, gen_sql_Column_NamedElement, gen_sql_Column_ModelElement, gen_sql_Key_ModelElement, gen_sql_PrimaryKey_Key, gen_sql_ForeignKey_Key, gen_sql_Event_ModelElement, gen_sql_Table_NamedElement, gen_sql_Schema_NamedElement},
    metadata=None
)
