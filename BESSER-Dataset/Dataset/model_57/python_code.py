...
class java__MethodDeclaration(AbstractMethodDeclaration):
    ...
    def __init__(self, extraArrayDimensions: int, MethodDeclaration: "java__MethodDeclaration" = None, redefinitions: "java__MethodDeclaration" = None, MethodDeclaration223: "java__MethodDeclaration" = None, redefinedMethodDeclaration: set["java__MethodDeclaration"] = None, java__MethodDeclaration: "java__TypeAccess" = None):
        self.extraArrayDimensions = extraArrayDimensions
...
class java__SingleVariableDeclaration(VariableDeclaration):
    ...
    def __init__(self, varargs: bool, SingleVariableDeclaration: "java__AbstractMethodDeclaration" = None, SingleVariableDeclaration100: "java__CatchClause" = None, SingleVariableDeclaration253: "java__Modifier" = None, SingleVariableDeclaration152: "java__EnhancedForStatement" = None, exception: "java__CatchClause" = None, parameter: "java__EnhancedForStatement" = None, singleVariableDeclaration: "java__Modifier" = None, java__SingleVariableDeclaration: "java__TypeAccess" = None, java__SingleVariableDeclaration298: set["java__Annotation"] = None, parameters: "java__AbstractMethodDeclaration" = None):
        self.varargs = varargs
