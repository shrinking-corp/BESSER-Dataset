...
grapho_Node.attributes={grapho_Node_label, grapho_Node_shape, grapho_Node_color, grapho_Node_style}
...
grapho_Edge.attributes={grapho_Edge_style, grapho_Edge_color, grapho_Edge_constraintRank}
...
domain_model = DomainModel(
    name="grapho",
    types={grapho_GraphElement, grapho_Node, grapho_Edge, grapho_GraphO, GraphElement},
