...
class tfsm_Transition(NamedElement):
    ...
    def __init__(self, action: str, Transition: "tfsm_State" = None, Transition11: "tfsm_State" = None, outgoingTransitions: "tfsm_State" = None, incomingTransitions: "tfsm_State" = None, tfsm_Transition17: "tfsm_Guard" = None, tfsm_Transition19: set["tfsm_FSMEvent"] = None, tfsm_Transition: "tfsm_TFSM" = None, tfsm_Transition27: "tfsm_FSMEvent" = None):
        self.action = action
