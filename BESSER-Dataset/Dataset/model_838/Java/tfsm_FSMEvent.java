...
public class tfsm_FSMEvent extends NamedElement {
    ...
    private tfsm_EventGuard tfsm_eventguard;
    ...
    public tfsm_EventGuard getTfsm_eventguard() {
        return tfsm_eventguard;
    }

    public void setTfsm_eventguard(tfsm_EventGuard tfsm_eventguard) {
        this.tfsm_eventguard = tfsm_eventguard;
    }
