...
domain_model = DomainModel(
    name="tfsm",
    types={tfsm_Guard, tfsm_TFSM, NamedElement, tfsm_State, tfsm_FSMEvent, tfsm_FSMClock, tfsm_Transition, tfsm_NamedElement, tfsm_TemporalGuard, Guard, tfsm_EventGuard, tfsm_TimedSystem, tfsm_EvaluateGuard},
    associations={owningFSM8, outgoingTransitions9, incomingTransitions10, source12, target14, ownedGuard16, generatedEvents18, ownedStates0, initialState1, localEvents2, localClock4, ownedTransitions6, onClock21, triggeringEvent23, sollicitingTransitions25, tfsms28, globalClocks30, globalEvents33},
    generalizations={gen_tfsm_Transition_NamedElement, gen_tfsm_TFSM_NamedElement, gen_tfsm_State_NamedElement, gen_tfsm_Guard_NamedElement, gen_tfsm_TemporalGuard_Guard, gen_tfsm_EventGuard_Guard, gen_tfsm_FSMEvent_NamedElement, gen_tfsm_FSMClock_NamedElement, gen_tfsm_TimedSystem_NamedElement, gen_tfsm_EvaluateGuard_Guard},
    metadata=None
)
