...
@given(instance=persistence_EntityAttribute_strategy)
def test_hyp_persistence_entityattribute_hidden_setter(instance):
...
@given(instance=persistence_EntityAttribute_strategy)
def test_hyp_persistence_entityattribute_unique_setter(instance):
...
@given(instance=persistence_EntityAssociation_strategy)
def test_hyp_persistence_entityassociation_targetColumnName_setter(instance):
...
@given(instance=persistence_EntityAssociation_strategy)
def test_hyp_persistence_entityassociation_unique_setter(instance):
    original = instance.unique
    instance.unique = original
    assert instance.unique == original
...
@given(instance=persistence_EntityFeature_strategy)
def test_hyp_persistence_entityfeature_derived_setter(instance):
...
@given(instance=persistence_EntityFeature_strategy)
def test_hyp_persistence_entityfeature_primaryKey_setter(instance):
...
@given(instance=persistence_EntityFeature_strategy)
def test_hyp_persistence_entityfeature_customiseSet_setter(instance):
...
@given(instance=persistence_Feature_strategy)
def test_hyp_persistence_feature_placeholder_setter(instance):
...
@given(instance=persistence_EntityOrView_strategy)
def test_hyp_persistence_entityorview_allowFormTypeCustomisation_setter(instance):
...
def test_persistence_Attribute_inputClass_value_roundtrip():
    instance = persistence_Attribute(inputClass="sample_text", validationPattern="sample_text")
    assert instance.inputClass == "sample_text"
    instance.inputClass = "sample_text_2"
    assert instance.inputClass == "sample_text_2"
...
def test_persistence_EntityAssociation_bidirectional_value_roundtrip():
    instance = persistence_EntityAssociation(bidirectional=True, pivotTableName="sample_text", targetColumnName="sample_text", targetDisplayClass="sample_text", targetDisplayLabel="sample_text", targetFeatureName="sample_text", targetFooterClass="sample_text", targetHeaderClass="sample_text", targetInputClass="sample_text", targetPrimaryKey=True, unique=True)
...
def test_persistence_EntityAssociation_targetColumnName_value_roundtrip():
    instance = persistence_EntityAssociation(bidirectional=True, pivotTableName="sample_text", targetColumnName="sample_text", targetDisplayClass="sample_text", targetDisplayLabel="sample_text", targetFeatureName="sample_text", targetFooterClass="sample_text", targetHeaderClass="sample_text", targetInputClass="sample_text", targetPrimaryKey=True, unique=True)
...
def test_persistence_EntityAssociation_unique_value_roundtrip():
    instance = persistence_EntityAssociation(bidirectional=True, pivotTableName="sample_text", targetColumnName="sample_text", targetDisplayClass="sample_text", targetDisplayLabel="sample_text", targetFeatureName="sample_text", targetFooterClass="sample_text", targetHeaderClass="sample_text", targetInputClass="sample_text", targetPrimaryKey=True, unique=True)
...
def test_persistence_EntityAttribute_containerUnique_value_roundtrip():
    instance = persistence_EntityAttribute(containerUnique=True, hidden=True, interfaceType="sample_text", ormType="sample_text", persistentType="sample_text", unique=True)
    assert instance.containerUnique == True
    instance.containerUnique = False
    assert instance.containerUnique == False


def test_persistence_EntityAttribute_hidden_value_roundtrip():
    instance = persistence_EntityAttribute(containerUnique=True, hidden=True, interfaceType="sample_text", ormType="sample_text", persistentType="sample_text", unique=True)
...
def test_persistence_EntityAttribute_unique_value_roundtrip():
    instance = persistence_EntityAttribute(containerUnique=True, hidden=True, interfaceType="sample_text", ormType="sample_text", persistentType="sample_text", unique=True)
    assert instance.unique == True
    instance.unique = False
    assert instance.unique == False
...
def test_persistence_EntityFeature_booleanIsHasChoice_value_roundtrip():
    instance = persistence_EntityFeature(booleanIsHasChoice="sample_text", cardinality="sample_text", columnName="sample_text", customiseSet=True, derived=True, ordered=True, pluralisedName="sample_text", primaryKey=True, singletonName="sample_text")
...
def test_persistence_EntityFeature_customiseSet_value_roundtrip():
    instance = persistence_EntityFeature(booleanIsHasChoice="sample_text", cardinality="sample_text", columnName="sample_text", customiseSet=True, derived=True, ordered=True, pluralisedName="sample_text", primaryKey=True, singletonName="sample_text")
...
def test_persistence_EntityFeature_derived_value_roundtrip():
    instance = persistence_EntityFeature(booleanIsHasChoice="sample_text", cardinality="sample_text", columnName="sample_text", customiseSet=True, derived=True, ordered=True, pluralisedName="sample_text", primaryKey=True, singletonName="sample_text")
...
def test_persistence_EntityFeature_primaryKey_value_roundtrip():
    instance = persistence_EntityFeature(booleanIsHasChoice="sample_text", cardinality="sample_text", columnName="sample_text", customiseSet=True, derived=True, ordered=True, pluralisedName="sample_text", primaryKey=True, singletonName="sample_text")
...
def test_persistence_EntityOrView_allowFormTypeCustomisation_value_roundtrip():
    instance = persistence_EntityOrView(allowFormTypeCustomisation=True, autoKeyGenerationStrategy="sample_text", autoKeyName="sample_text", autoKeyPersistentType="sample_text", implementsUserInterface=True, pluralisedName="sample_text", singletonName="sample_text", tableName="sample_text")
...
def test_persistence_Feature_collectionOrmAllowAdd_value_roundtrip():
    instance = persistence_Feature(collectionOrmAllowAdd=True, collectionOrmAllowRemove=True, displayClass="sample_text", encodeUriKey=True, footerClass="sample_text", headerClass="sample_text", nullDisplayValue="sample_text", placeholder="sample_text", title="sample_text")
...
def test_persistence_Feature_placeholder_value_roundtrip():
    instance = persistence_Feature(collectionOrmAllowAdd=True, collectionOrmAllowRemove=True, displayClass="sample_text", encodeUriKey=True, footerClass="sample_text", headerClass="sample_text", nullDisplayValue="sample_text", placeholder="sample_text", title="sample_text")
...
def test_assoc_allAssociations24_link_reassign_clear():
    a = persistence_EntityOrView(allowFormTypeCustomisation=True, autoKeyGenerationStrategy="sample_text", autoKeyName="sample_text", autoKeyPersistentType="sample_text", implementsUserInterface=True, pluralisedName="sample_text", singletonName="sample_text", tableName="sample_text")
...
def test_assoc_allFeatures17_link_reassign_clear():
    a = persistence_Feature(collectionOrmAllowAdd=True, collectionOrmAllowRemove=True, displayClass="sample_text", encodeUriKey=True, footerClass="sample_text", headerClass="sample_text", nullDisplayValue="sample_text", placeholder="sample_text", title="sample_text")
    b1 = persistence_EntityOrView(allowFormTypeCustomisation=True, autoKeyGenerationStrategy="sample_text", autoKeyName="sample_text", autoKeyPersistentType="sample_text", implementsUserInterface=True, pluralisedName="sample_text", singletonName="sample_text", tableName="sample_text")
    b2 = persistence_EntityOrView(allowFormTypeCustomisation=False, autoKeyGenerationStrategy="sample_text_2", autoKeyName="sample_text_2", autoKeyPersistentType="sample_text_2", implementsUserInterface=False, pluralisedName="sample_text_2", singletonName="sample_text_2", tableName="sample_text_2")
...
def test_assoc_association47_link_reassign_clear():
    ...
    b1 = persistence_EntityAssociation(bidirectional=True, pivotTableName="sample_text", targetColumnName="sample_text", targetDisplayClass="sample_text", targetDisplayLabel="sample_text", targetFeatureName="sample_text", targetFooterClass="sample_text", targetHeaderClass="sample_text", targetInputClass="sample_text", targetPrimaryKey=True, unique=True)
    b2 = persistence_EntityAssociation(bidirectional=False, pivotTableName="sample_text_2", targetColumnName="sample_text_2", targetDisplayClass="sample_text_2", targetDisplayLabel="sample_text_2", targetFeatureName="sample_text_2", targetFooterClass="sample_text_2", targetHeaderClass="sample_text_2", targetInputClass="sample_text_2", targetPrimaryKey=False, unique=False)
...
def test_assoc_association76_link_reassign_clear():
...
def test_assoc_associationEnds53_link_reassign_clear():
    a = persistence_EntityAssociation(bidirectional=True, pivotTableName="sample_text", targetColumnName="sample_text", targetDisplayClass="sample_text", targetDisplayLabel="sample_text", targetFeatureName="sample_text", targetFooterClass="sample_text", targetHeaderClass="sample_text", targetInputClass="sample_text", targetPrimaryKey=True, unique=True)
...
def test_assoc_attribute45_link_reassign_clear():
    ...
    b1 = persistence_Attribute(inputClass="sample_text", validationPattern="sample_text")
    b2 = persistence_Attribute(inputClass="sample_text_2", validationPattern="sample_text_2")
...
def test_assoc_attribute74_link_reassign_clear():
    ...
    if hasattr(b1, 'persistence_Attribute75'):
        assert _is_linked(b1, 'persistence_Attribute75', a)
    _safe_set(a, 'persistence_EncapsulatedAttribute', b2)
    assert _is_linked(a, 'persistence_EncapsulatedAttribute', b2)
    if hasattr(b1, 'persistence_Attribute75'):
        assert not _is_linked(b1, 'persistence_Attribute75', a)
    if hasattr(b2, 'persistence_Attribute75'):
        assert _is_linked(b2, 'persistence_Attribute75', a)
    _safe_set(a, 'persistence_EncapsulatedAttribute', None)
    assert not _is_linked(a, 'persistence_EncapsulatedAttribute', b2)
    if hasattr(b2, 'persistence_Attribute75'):
        assert not _is_linked(b2, 'persistence_Attribute75', a)
...
def test_assoc_dataType57_link_reassign_clear():
    ...
    if hasattr(b1, 'persistence_DataType58'):
        assert _is_linked(b1, 'persistence_DataType58', a)
    _safe_set(a, 'persistence_DataTypeAttribute', b2)
    assert _is_linked(a, 'persistence_DataTypeAttribute', b2)
    if hasattr(b1, 'persistence_DataType58'):
        assert not _is_linked(b1, 'persistence_DataType58', a)
    if hasattr(b2, 'persistence_DataType58'):
        assert _is_linked(b2, 'persistence_DataType58', a)
    _safe_set(a, 'persistence_DataTypeAttribute', None)
    assert not _is_linked(a, 'persistence_DataTypeAttribute', b2)
    if hasattr(b2, 'persistence_DataType58'):
        assert not _is_linked(b2, 'persistence_DataType58', a)
...
def test_assoc_defaultValue30_link_reassign_clear():
    a = persistence_Attribute(inputClass="sample_text", validationPattern="sample_text")
...
def test_assoc_encapsulatedTarget78_link_reassign_clear():
    a = persistence_EncapsulatedAssociation(cardinality="sample_text", isSourceAssociation=True, name="sample_text")
    ...
    if hasattr(b1, 'persistence_EncapsulatedAssociation77'):
        assert _is_linked(b1, 'persistence_EncapsulatedAssociation77', a)
    _safe_set(a, 'persistence_EncapsulatedAssociation', b2)
    assert _is_linked(a, 'persistence_EncapsulatedAssociation', b2)
    if hasattr(b1, 'persistence_EncapsulatedAssociation77'):
        assert not _is_linked(b1, 'persistence_EncapsulatedAssociation77', a)
    if hasattr(b2, 'persistence_EncapsulatedAssociation77'):
        assert _is_linked(b2, 'persistence_EncapsulatedAssociation77', a)
    _safe_set(a, 'persistence_EncapsulatedAssociation', None)
    assert not _is_linked(a, 'persistence_EncapsulatedAssociation', b2)
    if hasattr(b2, 'persistence_EncapsulatedAssociation77'):
        assert not _is_linked(b2, 'persistence_EncapsulatedAssociation77', a)


def test_assoc_encapsulates69_link_reassign_clear():
    a = persistence_EntityOrView(allowFormTypeCustomisation=True, autoKeyGenerationStrategy="sample_text", autoKeyName="sample_text", autoKeyPersistentType="sample_text", implementsUserInterface=True, pluralisedName="sample_text", singletonName="sample_text", tableName="sample_text")
    b1 = persistence_View()
    b2 = persistence_View()
    _safe_set(a, 'persistence_EntityOrView70', b1)
    assert _is_linked(a, 'persistence_EntityOrView70', b1)
    if hasattr(b1, 'persistence_View'):
        assert _is_linked(b1, 'persistence_View', a)
    _safe_set(a, 'persistence_EntityOrView70', b2)
    assert _is_linked(a, 'persistence_EntityOrView70', b2)
    if hasattr(b1, 'persistence_View'):
        assert not _is_linked(b1, 'persistence_View', a)
    if hasattr(b2, 'persistence_View'):
        assert _is_linked(b2, 'persistence_View', a)
    _safe_set(a, 'persistence_EntityOrView70', None)
    assert not _is_linked(a, 'persistence_EntityOrView70', b2)
    if hasattr(b2, 'persistence_View'):
...
def test_assoc_entityFeatures51_link_reassign_clear():
    a = persistence_EntityFeature(booleanIsHasChoice="sample_text", cardinality="sample_text", columnName="sample_text", customiseSet=True, derived=True, ordered=True, pluralisedName="sample_text", primaryKey=True, singletonName="sample_text")
    b1 = persistence_Entity()
    b2 = persistence_Entity()
...
def test_assoc_keyFor63_link_reassign_clear():
    a = persistence_EntityAssociation(bidirectional=True, pivotTableName="sample_text", targetColumnName="sample_text", targetDisplayClass="sample_text", targetDisplayLabel="sample_text", targetFeatureName="sample_text", targetFooterClass="sample_text", targetHeaderClass="sample_text", targetInputClass="sample_text", targetPrimaryKey=True, unique=True)
    b1 = persistence_AssociationKey()
    b2 = persistence_AssociationKey()
    _safe_set(a, 'EntityAssociation64', b1)
    assert _is_linked(a, 'EntityAssociation64', b1)
    if hasattr(b1, 'keys'):
        assert _is_linked(b1, 'keys', a)
    _safe_set(a, 'EntityAssociation64', b2)
    assert _is_linked(a, 'EntityAssociation64', b2)
    if hasattr(b1, 'keys'):
        assert not _is_linked(b1, 'keys', a)
    if hasattr(b2, 'keys'):
        assert _is_linked(b2, 'keys', a)
    _safe_set(a, 'EntityAssociation64', None)
    assert not _is_linked(a, 'EntityAssociation64', b2)
    if hasattr(b2, 'keys'):
...
def test_assoc_keys60_link_reassign_clear():
    a = persistence_EntityAssociation(bidirectional=True, pivotTableName="sample_text", targetColumnName="sample_text", targetDisplayClass="sample_text", targetDisplayLabel="sample_text", targetFeatureName="sample_text", targetFooterClass="sample_text", targetHeaderClass="sample_text", targetInputClass="sample_text", targetPrimaryKey=True, unique=True)
    b1 = persistence_AssociationKey()
    b2 = persistence_AssociationKey()
...
def test_assoc_opposite84_link_reassign_clear():
    ...
    if hasattr(b1, 'persistence_EncapsulatedAssociation85'):
        assert _is_linked(b1, 'persistence_EncapsulatedAssociation85', a)
    _safe_set(a, 'persistence_ViewAssociation', b2)
    assert _is_linked(a, 'persistence_ViewAssociation', b2)
    if hasattr(b1, 'persistence_EncapsulatedAssociation85'):
        assert not _is_linked(b1, 'persistence_EncapsulatedAssociation85', a)
    if hasattr(b2, 'persistence_EncapsulatedAssociation85'):
        assert _is_linked(b2, 'persistence_EncapsulatedAssociation85', a)
    _safe_set(a, 'persistence_ViewAssociation', None)
    assert not _is_linked(a, 'persistence_ViewAssociation', b2)
    if hasattr(b2, 'persistence_EncapsulatedAssociation85'):
        assert not _is_linked(b2, 'persistence_EncapsulatedAssociation85', a)
...
def test_assoc_slugFields55_link_reassign_clear():
    a = persistence_EntityAttribute(containerUnique=True, hidden=True, interfaceType="sample_text", ormType="sample_text", persistentType="sample_text", unique=True)
    b1 = persistence_Attribute(inputClass="sample_text", validationPattern="sample_text")
    b2 = persistence_Attribute(inputClass="sample_text_2", validationPattern="sample_text_2")
    _safe_set(a, 'persistence_EntityAttribute', {b1})
    assert _is_linked(a, 'persistence_EntityAttribute', b1)
    if hasattr(b1, 'persistence_Attribute56'):
        assert _is_linked(b1, 'persistence_Attribute56', a)
    _safe_set(a, 'persistence_EntityAttribute', {b2})
    assert _is_linked(a, 'persistence_EntityAttribute', b2)
    if hasattr(b1, 'persistence_Attribute56'):
        assert not _is_linked(b1, 'persistence_Attribute56', a)
    if hasattr(b2, 'persistence_Attribute56'):
        assert _is_linked(b2, 'persistence_Attribute56', a)
    _safe_set(a, 'persistence_EntityAttribute', set())
    assert not _is_linked(a, 'persistence_EntityAttribute', b2)
    if hasattr(b2, 'persistence_Attribute56'):
        assert not _is_linked(b2, 'persistence_Attribute56', a)


def test_assoc_sourceEntity79_link_reassign_clear():
    a = persistence_EncapsulatedAssociation(cardinality="sample_text", isSourceAssociation=True, name="sample_text")
    b1 = persistence_Entity()
    b2 = persistence_Entity()
...
def test_assoc_sourceFeature65_link_reassign_clear():
    a = persistence_EntityFeature(booleanIsHasChoice="sample_text", cardinality="sample_text", columnName="sample_text", customiseSet=True, derived=True, ordered=True, pluralisedName="sample_text", primaryKey=True, singletonName="sample_text")
    b1 = persistence_AssociationKey()
    b2 = persistence_AssociationKey()
...
def test_assoc_targetEntity61_link_reassign_clear():
    a = persistence_EntityAssociation(bidirectional=True, pivotTableName="sample_text", targetColumnName="sample_text", targetDisplayClass="sample_text", targetDisplayLabel="sample_text", targetFeatureName="sample_text", targetFooterClass="sample_text", targetHeaderClass="sample_text", targetInputClass="sample_text", targetPrimaryKey=True, unique=True)
    b1 = persistence_Entity()
    b2 = persistence_Entity()
    _safe_set(a, 'associationEnds', b1)
    assert _is_linked(a, 'associationEnds', b1)
    if hasattr(b1, 'Entity62'):
        assert _is_linked(b1, 'Entity62', a)
    _safe_set(a, 'associationEnds', b2)
    assert _is_linked(a, 'associationEnds', b2)
    if hasattr(b1, 'Entity62'):
        assert not _is_linked(b1, 'Entity62', a)
    if hasattr(b2, 'Entity62'):
        assert _is_linked(b2, 'Entity62', a)
    _safe_set(a, 'associationEnds', None)
    assert not _is_linked(a, 'associationEnds', b2)
    if hasattr(b2, 'Entity62'):
        assert not _is_linked(b2, 'Entity62', a)


def test_assoc_targetEntity81_link_reassign_clear():
    a = persistence_EncapsulatedAssociation(cardinality="sample_text", isSourceAssociation=True, name="sample_text")
    b1 = persistence_Entity()
    b2 = persistence_Entity()
    _safe_set(a, 'persistence_EncapsulatedAssociation82', b1)
    assert _is_linked(a, 'persistence_EncapsulatedAssociation82', b1)
    if hasattr(b1, 'persistence_Entity83'):
        assert _is_linked(b1, 'persistence_Entity83', a)
    _safe_set(a, 'persistence_EncapsulatedAssociation82', b2)
    assert _is_linked(a, 'persistence_EncapsulatedAssociation82', b2)
    if hasattr(b1, 'persistence_Entity83'):
        assert not _is_linked(b1, 'persistence_Entity83', a)
    if hasattr(b2, 'persistence_Entity83'):
        assert _is_linked(b2, 'persistence_Entity83', a)
    _safe_set(a, 'persistence_EncapsulatedAssociation82', None)
    assert not _is_linked(a, 'persistence_EncapsulatedAssociation82', b2)
    if hasattr(b2, 'persistence_Entity83'):
        assert not _is_linked(b2, 'persistence_Entity83', a)
...
def test_assoc_targetFeature66_link_reassign_clear():
    a = persistence_EntityFeature(booleanIsHasChoice="sample_text", cardinality="sample_text", columnName="sample_text", customiseSet=True, derived=True, ordered=True, pluralisedName="sample_text", primaryKey=True, singletonName="sample_text")
    b1 = persistence_AssociationKey()
    b2 = persistence_AssociationKey()
    _safe_set(a, 'persistence_EntityFeature68', b1)
    assert _is_linked(a, 'persistence_EntityFeature68', b1)
    if hasattr(b1, 'persistence_AssociationKey67'):
        assert _is_linked(b1, 'persistence_AssociationKey67', a)
    _safe_set(a, 'persistence_EntityFeature68', b2)
    assert _is_linked(a, 'persistence_EntityFeature68', b2)
    if hasattr(b1, 'persistence_AssociationKey67'):
        assert not _is_linked(b1, 'persistence_AssociationKey67', a)
    if hasattr(b2, 'persistence_AssociationKey67'):
        assert _is_linked(b2, 'persistence_AssociationKey67', a)
    _safe_set(a, 'persistence_EntityFeature68', None)
    assert not _is_linked(a, 'persistence_EntityFeature68', b2)
    if hasattr(b2, 'persistence_AssociationKey67'):
        assert not _is_linked(b2, 'persistence_AssociationKey67', a)
...
def test_assoc_uploadPath59_link_reassign_clear():
...
persistence_Attribute_strategy = st.builds(persistence_Attribute, inputClass=safe_text, validationPattern=safe_text)
@given(instance=persistence_Attribute_strategy)
@settings(max_examples=25)
...
persistence_EntityAssociation_strategy = st.builds(persistence_EntityAssociation, bidirectional=st.booleans(), pivotTableName=safe_text, targetColumnName=safe_text, targetDisplayClass=safe_text, targetDisplayLabel=safe_text, targetFeatureName=safe_text, targetFooterClass=safe_text, targetHeaderClass=safe_text, targetInputClass=safe_text, targetPrimaryKey=st.booleans(), unique=st.booleans())
@given(instance=persistence_EntityAssociation_strategy)
@settings(max_examples=25)
...
persistence_EntityAttribute_strategy = st.builds(persistence_EntityAttribute, containerUnique=st.booleans(), hidden=st.booleans(), interfaceType=safe_text, ormType=safe_text, persistentType=safe_text, unique=st.booleans())
@given(instance=persistence_EntityAttribute_strategy)
@settings(max_examples=25)
...
persistence_EntityFeature_strategy = st.builds(persistence_EntityFeature, booleanIsHasChoice=safe_text, cardinality=safe_text, columnName=safe_text, customiseSet=st.booleans(), derived=st.booleans(), ordered=st.booleans(), pluralisedName=safe_text, primaryKey=st.booleans(), singletonName=safe_text)
@given(instance=persistence_EntityFeature_strategy)
@settings(max_examples=25)
...
persistence_EntityOrView_strategy = st.builds(persistence_EntityOrView, allowFormTypeCustomisation=st.booleans(), autoKeyGenerationStrategy=safe_text, autoKeyName=safe_text, autoKeyPersistentType=safe_text, implementsUserInterface=st.booleans(), pluralisedName=safe_text, singletonName=safe_text, tableName=safe_text)
@given(instance=persistence_EntityOrView_strategy)
@settings(max_examples=25)
...
persistence_Feature_strategy = st.builds(persistence_Feature, collectionOrmAllowAdd=st.booleans(), collectionOrmAllowRemove=st.booleans(), displayClass=safe_text, encodeUriKey=st.booleans(), footerClass=safe_text, headerClass=safe_text, nullDisplayValue=safe_text, placeholder=safe_text, title=safe_text)
@given(instance=persistence_Feature_strategy)
@settings(max_examples=25)
