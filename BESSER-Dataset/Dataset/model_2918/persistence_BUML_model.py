...
persistence_Persistence.attributes={persistence_Persistence_databaseTechnology, persistence_Persistence_timestampCreation, persistence_Persistence_timestampUpdates, persistence_Persistence_ormTechnology}
...
persistence_EntityOrView.attributes={persistence_EntityOrView_autoKeyName, persistence_EntityOrView_singletonName, persistence_EntityOrView_allowFormTypeCustomisation, persistence_EntityOrView_autoKeyPersistentType, persistence_EntityOrView_pluralisedName, persistence_EntityOrView_implementsUserInterface, persistence_EntityOrView_autoKeyGenerationStrategy, persistence_EntityOrView_tableName}
...
persistence_Feature.attributes={persistence_Feature_collectionOrmAllowRemove, persistence_Feature_placeholder, persistence_Feature_headerClass, persistence_Feature_footerClass, persistence_Feature_nullDisplayValue, persistence_Feature_encodeUriKey, persistence_Feature_collectionOrmAllowAdd, persistence_Feature_title, persistence_Feature_displayClass}
...
persistence_EncapsulatedAssociation.attributes={persistence_EncapsulatedAssociation_cardinality, persistence_EncapsulatedAssociation_isSourceAssociation, persistence_EncapsulatedAssociation_name}
...
persistence_EntityAssociation.attributes={persistence_EntityAssociation_pivotTableName, persistence_EntityAssociation_targetHeaderClass, persistence_EntityAssociation_targetFeatureName, persistence_EntityAssociation_targetDisplayLabel, persistence_EntityAssociation_targetDisplayClass, persistence_EntityAssociation_targetFooterClass, persistence_EntityAssociation_targetColumnName, persistence_EntityAssociation_bidirectional, persistence_EntityAssociation_targetPrimaryKey, persistence_EntityAssociation_unique, persistence_EntityAssociation_targetInputClass}
...
persistence_EntityFeature.attributes={persistence_EntityFeature_columnName, persistence_EntityFeature_customiseSet, persistence_EntityFeature_derived, persistence_EntityFeature_ordered, persistence_EntityFeature_booleanIsHasChoice, persistence_EntityFeature_cardinality, persistence_EntityFeature_singletonName, persistence_EntityFeature_pluralisedName, persistence_EntityFeature_primaryKey}
...
persistence_EntityAttribute.attributes={persistence_EntityAttribute_containerUnique, persistence_EntityAttribute_persistentType, persistence_EntityAttribute_ormType, persistence_EntityAttribute_hidden, persistence_EntityAttribute_interfaceType, persistence_EntityAttribute_unique}
...
persistence_ResourceAttribute.attributes={persistence_ResourceAttribute_validUploadExtensions, persistence_ResourceAttribute_uploadsWithinWebsite, persistence_ResourceAttribute_validUploadMimeTypes, persistence_ResourceAttribute_maximumUploadSize}
...
persistence_EncapsulatedFeature.attributes={persistence_EncapsulatedFeature_displayLabel, persistence_EncapsulatedFeature_alias, persistence_EncapsulatedFeature_columnName}
...
domain_model = DomainModel(
    name="persistence",
    types={persistence_Persistence, persistence_SerializationGroup, persistence_DataType, persistence_EntityOrView, NamedElement, Classifier, persistence_Feature, persistence_ModelLabel, persistence_Association, persistence_Attribute, Feature, Label, persistence_Expression, persistence_EncapsulatedAssociation, persistence_Label, persistence_ModelLabelFeature, persistence_ModelLabelAttribute, ModelLabelFeature, persistence_ModelLabelAssociation, persistence_EntityAssociation, persistence_Entity, EntityOrView, persistence_EntityFeature, NamedDisplayElement, persistence_EntityAttribute, EntityFeature, Attribute, persistence_DataTypeAttribute, EntityAttribute, persistence_DateAttribute, persistence_UrlAttribute, persistence_ResourceAttribute, persistence_PathElement, persistence_StaticPathElement, PathElement, persistence_DatePathElement, persistence_FileAttribute, ResourceAttribute, persistence_ImageAttribute, persistence_LocationAttribute, Association, persistence_AssociationKey, persistence_AssociationWithoutContainment, EntityAssociation, persistence_AssociationWithContainment, persistence_View, persistence_ViewFeature, persistence_EncapsulatedFeature, ViewFeature, persistence_EncapsulatedAttribute, EncapsulatedFeature, persistence_ViewAssociation, DatabaseTechnologies, OrmTechnologies, isHasChoices, Cardinality, DateDetails},
    associations={serializationGroups0, dataTypes1, entities3, keys5, unique7, containerUnique10, labels13, features14, allFeatures17, associations22, attributes20, allAssociations24, serializationGroups27, defaultValue30, encapsulatedBy32, sourceEntityX33, targetEntityX36, labelFor39, features40, serializationGroups41, partOf43, attribute45, association47, dynamicLabel48, entityFeatures51, associationEnds53, partOf54, slugFields55, dataType57, sourceFeature65, uploadPath59, keys60, targetEntity61, keyFor63, targetEntity81, targetFeature66, encapsulates69, viewFeatures71, partOf73, attribute74, association76, encapsulatedTarget78, sourceEntity79, opposite84},
