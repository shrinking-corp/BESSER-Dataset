...
public class java_Expression extends ASTNode {
    ...
    private java_ConditionalExpression java_conditionalexpression;
    ...
    private java_ArrayAccess java_arrayaccess;
    ...
    private java_Assignment java_assignment;
    ...
    private java_ArrayLengthAccess java_arraylengthaccess;
    ...
    public java_ConditionalExpression getJava_conditionalexpression() {
        return java_conditionalexpression;
    }

    public void setJava_conditionalexpression(java_ConditionalExpression java_conditionalexpression) {
        this.java_conditionalexpression = java_conditionalexpression;
    }
    public java_ConditionalExpression getJava_conditionalexpression() {
        return java_conditionalexpression;
    }
    ...
    public java_ArrayAccess getJava_arrayaccess() {
        return java_arrayaccess;
    }

    public void setJava_arrayaccess(java_ArrayAccess java_arrayaccess) {
        this.java_arrayaccess = java_arrayaccess;
    }
    ...
    public java_Assignment getJava_assignment() {
        return java_assignment;
    }

    public void setJava_assignment(java_Assignment java_assignment) {
        this.java_assignment = java_assignment;
    }
    public java_Assignment getJava_assignment() {
        return java_assignment;
    }
    ...
    public java_ArrayLengthAccess getJava_arraylengthaccess() {
        return java_arraylengthaccess;
    }

    public void setJava_arraylengthaccess(java_ArrayLengthAccess java_arraylengthaccess) {
        this.java_arraylengthaccess = java_arraylengthaccess;
    }
