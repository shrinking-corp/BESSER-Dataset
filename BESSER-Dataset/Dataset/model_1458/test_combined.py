...
def test_hyp_graph1_graph_is_not_abstract():
    assert not inspect.isabstract(graph1_Graph)


def test_hyp_graph1_graph_constructor_exists():
    assert callable(graph1_Graph.__init__)


def test_hyp_graph1_graph_constructor_args():
    sig = inspect.signature(graph1_Graph.__init__)
    params = list(sig.parameters.keys())



def test_hyp_graph1_edge_is_not_abstract():
    assert not inspect.isabstract(graph1_Edge)


def test_hyp_graph1_edge_constructor_exists():
    assert callable(graph1_Edge.__init__)


def test_hyp_graph1_edge_constructor_args():
    sig = inspect.signature(graph1_Edge.__init__)
    params = list(sig.parameters.keys())



def test_hyp_graph1_node_is_not_abstract():
    assert not inspect.isabstract(graph1_Node)


def test_hyp_graph1_node_constructor_exists():
    assert callable(graph1_Node.__init__)


def test_hyp_graph1_node_constructor_args():
...
def test_hyp_graph1_node_name_setter(instance):
