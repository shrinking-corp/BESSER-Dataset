...
# Classes
A = Class(name="A")
diamon_C = Class(name="diamon_C")
diamon_D = Class(name="diamon_D")
B = Class(name="B")
C = Class(name="C")
diamon_A = Class(name="diamon_A")
diamon_B = Class(name="diamon_B")
...
domain_model = DomainModel(
    name="diamon",
    types={A, diamon_C, diamon_D, B, C, diamon_A, diamon_B},
    associations={},
