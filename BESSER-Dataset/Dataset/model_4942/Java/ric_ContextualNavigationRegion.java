...
public class ric_ContextualNavigationRegion  {
    ...
    public ric_ContextualNavigationRegion(
        ArrayList<ric_List> ric_lists,        ArrayList<ric_Form> ric_forms,        ArrayList<ric_ObjectComponent> ric_objectcomponents,        ArrayList<ric_InlineComponent> ric_inlinecomponents,        ArrayList<ric_LineBreak> ric_linebreaks,        ArrayList<ric_RichWidget> ric_richwidgets,        ArrayList<ric_BlockLevelComponent> ric_blocklevelcomponents    ) {
