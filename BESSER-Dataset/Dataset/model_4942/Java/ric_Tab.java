...
public class ric_Tab  {
    ...
    public ric_Tab(
        String title        ArrayList<ric_InlineComponent> ric_inlinecomponents,        ArrayList<ric_ObjectComponent> ric_objectcomponents,        ArrayList<ric_Form> ric_forms,        ArrayList<ric_LineBreak> ric_linebreaks,        ArrayList<ric_List> ric_lists,        ArrayList<ric_RichWidget> ric_richwidgets,        ArrayList<ric_BlockLevelComponent> ric_blocklevelcomponents    ) {
        this.title = title;
