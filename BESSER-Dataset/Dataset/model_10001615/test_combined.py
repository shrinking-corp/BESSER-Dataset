...
@given(instance=Registrieren_strategy)
def test_hyp_registrieren_email1_setter(instance):
...
def test_Registrieren_email_value_roundtrip():
    instance = Registrieren(email="sample_text", email1="sample_text", geburtsdatum="sample_text", geschlecht="sample_text", nachname="sample_text", passwort="sample_text", vorname="sample_text")
    assert instance.email == "sample_text"
    instance.email = "sample_text_2"
    assert instance.email == "sample_text_2"


def test_Registrieren_email1_value_roundtrip():
    instance = Registrieren(email="sample_text", email1="sample_text", geburtsdatum="sample_text", geschlecht="sample_text", nachname="sample_text", passwort="sample_text", vorname="sample_text")
...
def test_assoc_User_Registeration_link_reassign_clear():
    a = Registrieren(email="sample_text", email1="sample_text", geburtsdatum="sample_text", geschlecht="sample_text", nachname="sample_text", passwort="sample_text", vorname="sample_text")
    b1 = Benutzer(Info="sample_text", Nachname="sample_text", Vorname="sample_text", profilbild="sample_text")
    b2 = Benutzer(Info="sample_text_2", Nachname="sample_text_2", Vorname="sample_text_2", profilbild="sample_text_2")
...
Registrieren_strategy = st.builds(Registrieren, email=safe_text, email1=safe_text, geburtsdatum=safe_text, geschlecht=safe_text, nachname=safe_text, passwort=safe_text, vorname=safe_text)
@given(instance=Registrieren_strategy)
@settings(max_examples=25)
