...
# Classes
uppaallite_LocationType = Class(name="uppaallite_LocationType")
uppaallite_TransitionType = Class(name="uppaallite_TransitionType")
uppaallite_UppaalDiagram = Class(name="uppaallite_UppaalDiagram")
uppaallite_TemplateType = Class(name="uppaallite_TemplateType")
...
uppaallite_LocationType.attributes={uppaallite_LocationType_id, uppaallite_LocationType_y, uppaallite_LocationType_cost, uppaallite_LocationType_name, uppaallite_LocationType_initial, uppaallite_LocationType_committed, uppaallite_LocationType_invariant, uppaallite_LocationType_urgent, uppaallite_LocationType_x}
...
uppaallite_TransitionType.attributes={uppaallite_TransitionType_sync, uppaallite_TransitionType_assignment, uppaallite_TransitionType_cost, uppaallite_TransitionType_guard}
...
domain_model = DomainModel(
    name="uppaallite",
    types={uppaallite_LocationType, uppaallite_TransitionType, uppaallite_UppaalDiagram, uppaallite_TemplateType},
    associations={location1, transition2, container4, source5, target6, container9, Template0},
    generalizations={},
    metadata=None
)
