...
class uppaallite_TemplateType:
    ...
    def __init__(self, name: str, declaration: str, container: set["uppaallite_LocationType"] = None, container3: set["uppaallite_TransitionType"] = None, TemplateType: "uppaallite_LocationType" = None, TemplateType10: "uppaallite_TransitionType" = None, uppaallite_TemplateType: "uppaallite_UppaalDiagram" = None):
        self.name = name
...
class uppaallite_UppaalDiagram:
    ...
    @property
    def resourceWeightDeclaration(self):
...
class uppaallite_TransitionType:
    ...
    def __init__(self, sync: str, assignment: str, guard: str, cost: str, TransitionType: "uppaallite_TemplateType" = None, uppaallite_TransitionType: "uppaallite_LocationType" = None, uppaallite_TransitionType7: "uppaallite_LocationType" = None, transition: "uppaallite_TemplateType" = None):
        self.sync = sync
...
class uppaallite_LocationType:
    ...
    def __init__(self, name: str, urgent: bool, committed: bool, initial: bool, id: str, invariant: str, cost: str, x: int, y: int, location: "uppaallite_TemplateType" = None, uppaallite_LocationType: "uppaallite_TransitionType" = None, uppaallite_LocationType8: "uppaallite_TransitionType" = None, LocationType: "uppaallite_TemplateType" = None):
        self.name = name
        self.urgent = urgent
