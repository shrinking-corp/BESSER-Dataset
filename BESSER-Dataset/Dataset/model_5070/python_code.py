...
class accounting_JournalStatement:
    ...
    def __init__(self, amount: str, description: str, date: str, accounting_JournalStatement24: "accounting_Vat" = None, accounting_JournalStatement: "accounting_JournalGroup" = None, accounting_JournalStatement18: "accounting_Account" = None, accounting_JournalStatement21: "accounting_Account" = None):
        self.amount = amount
...
class accounting_Report:
    ...
    def __init__(self, name: str, accounting_Report27: "accounting_ReportGroup" = None, accounting_Report29: "accounting_ReportGroup" = None, accounting_Report: "accounting_Accounting" = None):
        self.name = name
...
class accounting_ReportGroup:
    ...
    def __init__(self, name: str, accounting_ReportGroup: "accounting_Report" = None, report: set["accounting_BalanceAccount"] = None, accounting_ReportGroup30: "accounting_Report" = None, accounting_ReportGroup33: "accounting_ReportGroup" = None, accounting_ReportGroup31: set["accounting_ReportGroup"] = None, ReportGroup: "accounting_BalanceAccount" = None):
        self.name = name
...
class accounting_JournalGroup:
    ...
    def __init__(self, name: str, accounting_JournalGroup16: set["accounting_JournalStatement"] = None, accounting_JournalGroup: "accounting_Accounting" = None, accounting_JournalGroup14: "accounting_JournalGroup" = None, accounting_JournalGroup12: set["accounting_JournalGroup"] = None):
        self.name = name
...
class accounting_Accounting:
    ...
    def __init__(self, name: str, accounting_Accounting: set["accounting_AccountGroup"] = None, accounting_Accounting10: set["accounting_JournalGroup"] = None, accounting_Accounting4: set["accounting_Vat"] = None, accounting_Accounting6: "accounting_BalanceAccount" = None, accounting_Accounting8: "accounting_Report" = None):
        self.name = name
