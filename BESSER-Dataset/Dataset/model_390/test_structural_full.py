...
def test_assoc_inheritedMember2_link_reassign_clear():
    a = UML2_NamedElement(visibility="sample_text")
    b1 = UML2_Classifier()
    b2 = UML2_Classifier()
    _safe_set(a, 'UML2_NamedElement4', b1)
    assert _is_linked(a, 'UML2_NamedElement4', b1)
    if hasattr(b1, 'UML2_Classifier3'):
        assert _is_linked(b1, 'UML2_Classifier3', a)
    _safe_set(a, 'UML2_NamedElement4', b2)
    assert _is_linked(a, 'UML2_NamedElement4', b2)
    if hasattr(b1, 'UML2_Classifier3'):
        assert not _is_linked(b1, 'UML2_Classifier3', a)
    if hasattr(b2, 'UML2_Classifier3'):
        assert _is_linked(b2, 'UML2_Classifier3', a)
    _safe_set(a, 'UML2_NamedElement4', None)
    assert not _is_linked(a, 'UML2_NamedElement4', b2)
    if hasattr(b2, 'UML2_Classifier3'):
        assert not _is_linked(b2, 'UML2_Classifier3', a)
