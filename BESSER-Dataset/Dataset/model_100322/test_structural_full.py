...
pnextensions_pnutils_DataTypeUtils_strategy = st.builds(pnextensions_pnutils_DataTypeUtils)
...
pnextensions_pnutils_PnUtils_strategy = st.builds(pnextensions_pnutils_PnUtils)
...
pnextensions_pnutils_ToolInfoUtils_strategy = st.builds(pnextensions_pnutils_ToolInfoUtils)
