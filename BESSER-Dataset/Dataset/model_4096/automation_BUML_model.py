...
# Classes
automation_Automation = Class(name="automation_Automation")
automation_NamedElement = Class(name="automation_NamedElement", is_abstract=True)
automation_State = Class(name="automation_State")
NamedElement = Class(name="NamedElement")
automation_Input = Class(name="automation_Input")
automation_Output = Class(name="automation_Output")
automation_Transition = Class(name="automation_Transition")
...
domain_model = DomainModel(
    name="automation",
    types={automation_Automation, automation_NamedElement, automation_State, NamedElement, automation_Input, automation_Output, automation_Transition},
    associations={event0, actions1, origin3, disnation5, transitions8, states10, inputs13, outputs16},
    generalizations={gen_automation_Automation_NamedElement, gen_automation_State_NamedElement, gen_automation_Input_NamedElement, gen_automation_Output_NamedElement, gen_automation_Transition_NamedElement},
    metadata=None
)
