...
public class Department  {
    ...
    public Department(
        None students__,        None course,        None teachers__,        None hod    ) {
    ...
    public Department(
        None students__,        None course,        None teachers__,        None hod        ArrayList<Student> students,        ArrayList<Employee_Interface> employee_interfaces    ) {
        this.students__ = students__;
        this.course = course;
        this.teachers__ = teachers__;
        this.hod = hod;
