...
class model_overrides_Insert(Operation):
    ...
    def __init__(self, newIndex: int, model_overrides_Insert: "overrides_model_EObject" = None, Operation33: "model_overrides_WidgetContainerOverrides" = None, Operation: "model_overrides_WidgetOverrides" = None):
...
class model_overrides_WidgetOverrides(overrides_WidgetContainerOverrides, overrides_Reference):
    ...
    def __init__(self, x: str, y: str, width: str, height: str, text: str, noText: bool, link: str, noLink: bool, src: str, model_overrides_WidgetOverrides: set["StringToStringMap"] = None, model_overrides_WidgetOverrides26: "FontOverrides" = None, model_overrides_WidgetOverrides28: set["ItemOverrides"] = None, model_overrides_WidgetOverrides30: set["Operation"] = None):
        self.x = x
        self.y = y
        self.width = width
        self.height = height
...
class Widget:
    ...
    pass
class model_Tabs(ItemSupport, SelectionSupport, SkinSupport, Widget, FontSupport):

    pass
class model_ProgressBar(SkinSupport, Widget, ValueSupport, ColorBackgroundSupport):

    pass
class model_Combo(ItemSupport, SkinSupport, ColorAlphaSupport, ColorBorderSupport, Widget, ColorBackgroundSupport, LinkSupport, FontSupport, StateSupport):

    pass
class model_VideoPlayer(SkinSupport, Widget):

    pass
class model_Label(IconSupport, IconPositionSupport, RotationSupport, Widget, TextLinksSupport, TextAlignmentSupport, LinkSupport, FontSupport, StateSupport, ColorForegroundSupport):

    pass
class model_Alert(IconSupport, ItemSupport, SkinSupport, Widget, FontSupport):
...
class model_Master(Widget, LinkSupport):
    ...
    def getSourceWidget(self, model_widget) :
        # TODO: Implement getSourceWidget method
        pass

class model_Rectangle(IconSupport, IconPositionSupport, ColorAlphaSupport, Widget, ColorBackgroundSupport, BorderStyleSupport, TextAlignmentSupport, LinkSupport, FontSupport, ColorForegroundSupport):

    pass
class model_Circle(IconSupport, IconPositionSupport, ColorAlphaSupport, BorderSupport, LineStyleSupport, Widget, ColorBackgroundSupport, TextAlignmentSupport, LinkSupport, FontSupport, ColorForegroundSupport):

    pass
class model_HScrollbar(SkinSupport, Widget, ValueSupport):

    pass
class model_DateField(ColorAlphaSupport, SkinSupport, ColorBorderSupport, Widget, ColorBackgroundSupport, StateSupport):

    pass
class model_ScratchOut(ColorAlphaSupport, SkinSupport, Widget, AnnotationSupport, ColorForegroundSupport):

    pass
class model_Menu(IconSupport, ItemSupport, SelectionSupport, SkinSupport, Widget):

    pass
class model_VButtonBar(ItemSupport, SelectionSupport, SkinSupport, Widget, ColorBackgroundSupport, TextAlignmentSupport, FontSupport):

    pass
class model_CrossOut(ColorAlphaSupport, SkinSupport, Widget, AnnotationSupport, ColorForegroundSupport):

    pass
class model_ButtonBar(ItemSupport, SelectionSupport, SkinSupport, Widget, ColorBackgroundSupport, FontSupport):

    pass
class model_TextArea(ColorAlphaSupport, SkinSupport, ColorBorderSupport, Widget, LineHeightSupport, ColorBackgroundSupport, TextLinksSupport, VerticalScrollbarSupport, TextAlignmentSupport, FontSupport, StateSupport):

    pass
class model_Browser(SkinSupport, ColorAlphaSupport, Widget, ColorBackgroundSupport, VerticalScrollbarSupport, FontSupport):

    pass
class model_TabbedPane(ItemSupport, SelectionSupport, ColorAlphaSupport, SkinSupport, Widget, ColorBackgroundSupport, VerticalScrollbarSupport, FontSupport):
...
class model_LinkBar(ItemSupport, SelectionSupport, SkinSupport, Widget, FontSupport):

    pass
class model_Tree(ItemSupport, SelectionSupport, ColorAlphaSupport, BorderSupport, Widget, ColorBackgroundSupport, VerticalScrollbarSupport, FontSupport):

    pass
class model_SVGImage(FlipSupport, ColorAlphaSupport, RotationSupport, Widget, ColorBackgroundSupport, LinkSupport, ColorForegroundSupport):
...
class model_Panel(SkinSupport, ColorAlphaSupport, Widget, ColorBackgroundSupport, BorderStyleSupport, VerticalScrollbarSupport, LinkSupport, ColorForegroundSupport):

    pass
class model_Switch(BooleanSelectionSupport, SkinSupport, Widget, ColorBackgroundSupport, LinkSupport, FontSupport, StateSupport):

    pass
class model_Checkbox(BooleanSelectionSupport, SkinSupport, Widget, LinkSupport, FontSupport, StateSupport):

    pass
class model_Popup(ItemSupport, Widget, SelectionSupport):

    pass
class model_Accordion(ItemSupport, SelectionSupport, Widget, VerticalScrollbarSupport, FontSupport):

    pass
class model_Text(Widget, LineHeightSupport, TextLinksSupport, TextAlignmentSupport, LinkSupport, FontSupport, ColorForegroundSupport):
...
class model_CoverFlow(SkinSupport, Widget):
    ...
    pass
class model_Tooltip(SkinSupport, Widget, ColorBackgroundSupport, TextLinksSupport, TextAlignmentSupport, FontSupport):
...
class model_Table(ListSupport, SelectionSupport, ColorAlphaSupport, BorderSupport, Widget, ColorBackgroundSupport, TextLinksSupport, VerticalScrollbarSupport, TextAlignmentSupport, ColorAlternativeSupport, FontSupport):
...
class model_HSplitter(SkinSupport, Widget):
    ...
    pass
class model_CurlyBrace(SkinSupport, Widget, TextLinksSupport, AnnotationSupport, FontSupport, ColorForegroundSupport):
...
class model_VSlider(SkinSupport, Widget, ColorBackgroundSupport, ValueSupport, StateSupport):

    pass
class model_TextField(ColorAlphaSupport, SkinSupport, ColorBorderSupport, Widget, ColorBackgroundSupport, TextAlignmentSupport, FontSupport, StateSupport):

    pass
class model_Link(SkinSupport, Widget, LinkSupport, FontSupport, StateSupport):

    pass
class model_Image(FlipSupport, RotationSupport, BorderSupport, Widget, LinkSupport):
...
class model_Area(Widget):
    ...
    pass
class model_Window(ColorAlphaSupport, SkinSupport, Widget, ColorBackgroundSupport, VerticalScrollbarSupport):
...
class model_Arrow(LineStyleSupport, Widget, ColorForegroundSupport, AnnotationSupport):

    def __init__(self, direction: str, left: bool, right: bool):
...
class model_Map(SkinSupport, Widget):
    ...
    pass
class model_List(ItemSupport, ListSupport, SelectionSupport, ColorAlphaSupport, BorderSupport, Widget, ColorBackgroundSupport, VerticalScrollbarSupport, ColorAlternativeSupport, FontSupport):
...
class model_VLine(SkinSupport, LineStyleSupport, Widget, ColorForegroundSupport):

    pass
class model_VScrollbar(SkinSupport, Widget, ValueSupport):

    pass
class model_RadioButton(BooleanSelectionSupport, SkinSupport, Widget, LinkSupport, FontSupport, StateSupport):

    pass
class model_HSlider(SkinSupport, Widget, ColorBackgroundSupport, ValueSupport, StateSupport):
...
class model_Spinner(SkinSupport, ColorAlphaSupport, ColorBorderSupport, Widget, ColorBackgroundSupport, FontSupport, StateSupport):

    pass
class model_Hotspot(Widget, LinkSupport):

    pass
class model_SearchField(SkinSupport, ColorBorderSupport, Widget, LinkSupport, FontSupport, StateSupport):

    pass
class model_HLine(SkinSupport, LineStyleSupport, Widget, ColorForegroundSupport):

    pass
class model_VSplitter(SkinSupport, Widget):

    pass
class model_Breadcrumbs(FontSupport, SkinSupport, Widget, ItemSupport):

    pass
class model_Note(ColorAlphaSupport, SkinSupport, Widget, ColorBackgroundSupport, TextLinksSupport, TextAlignmentSupport, AnnotationSupport, LinkSupport, FontSupport):

    pass
class model_Placeholder(SkinSupport, Widget, LinkSupport):

    pass
class model_Callout(ColorAlphaSupport, SkinSupport, Widget, ColorBackgroundSupport, AnnotationSupport, LinkSupport, FontSupport):
...
class model_Icon(IconSupport, Widget, ColorForegroundSupport, LinkSupport):
    ...
    pass
class model_Group(SkinSupport, ColorAlphaSupport, Widget, ColorBackgroundSupport, VerticalScrollbarSupport, FontSupport):

    pass
class model_Shape(IconSupport, IconPositionSupport, ColorAlphaSupport, SkinSupport, RotationSupport, LineStyleSupport, Widget, BorderSupport, ColorBackgroundSupport, TextAlignmentSupport, LinkSupport, FontSupport, ColorForegroundSupport):
...
class model_Button(IconSupport, SkinSupport, Widget, ColorBackgroundSupport, TextAlignmentSupport, LinkSupport, FontSupport, StateSupport):
...
class model_Widget(NoteSupport):
    ...
    def __init__(self, id: str, locked: bool, measuredWidth: int, measuredHeight: int, customId: str, customData: str, annotation: bool, layoutParams: str, x: int, y: int, width: int, height: int, text: str, model_Widget: "model_WidgetDescriptor" = None, widgets: "model_WidgetContainer" = None, Widget: "model_WidgetContainer" = None):
        self.id = id
        self.locked = locked
...
class WidgetContainer:
    ...
    pass
class model_WidgetGroup(Widget, NameSupport, WidgetContainer, LinkSupport):
