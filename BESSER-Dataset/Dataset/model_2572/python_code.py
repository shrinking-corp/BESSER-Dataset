...
class sql_OpFunctionCast:
    ...
    def __init__(self, type: str, p: int, p2: int, sql_OpFunctionCast125: "sql_Operand" = None, sql_OpFunctionCast: "sql_LikeOperand" = None, sql_OpFunctionCast141: "sql_Operands" = None):
        self.type = type
        self.p = p
        self.p2 = p2
...
class sql_OpFunction:
    ...
    def __init__(self, fname: str, sql_OpFunction128: "sql_Operand" = None, sql_OpFunction: "sql_LikeOperand" = None, sql_OpFunction138: "sql_OpFunctionArg" = None):
        self.fname = fname
...
class sql_InOper:
    ...
    def __init__(self, op: str, sql_InOper: "sql_FullExpression" = None, sql_InOper106: "sql_OperandList" = None, sql_InOper103: "sql_SubQueryOperand" = None):
        self.op = op
...
class sql_Select(SelectQuery):
    ...
    def __init__(self, select: str, sql_Select8: "sql_OrColumn" = None, sql_Select10: "sql_OrTable" = None, sql_Select12: "sql_OrExpr" = None, sql_Select14: "sql_OrGroupByColumn" = None, sql_Select16: "sql_OrExpr" = None, sql_Select: "sql_SelectSubSet" = None, sql_Select5: set["sql_SelectSubSet"] = None):
        self.select = select
