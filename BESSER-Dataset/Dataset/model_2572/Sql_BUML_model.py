...
sql_ScalarOperand.attributes={sql_ScalarOperand_sodt, sql_ScalarOperand_soint, sql_ScalarOperand_sotime, sql_ScalarOperand_sostr, sql_ScalarOperand_sodate, sql_ScalarOperand_sodbl}
...
domain_model = DomainModel(
    name="sql",
    types={sql_Model, sql_SelectQuery, sql_OrOrderByColumn, sql_SelectSubSet, sql_Select, SelectQuery, sql_OrColumn, sql_OrTable, sql_OrExpr, sql_OrGroupByColumn, sql_ColumnOrAlias, OrTable, sql_TableOrAlias, sql_FromTableJoin, sql_TableFull, sql_SubQueryOperand, ColumnFull, TableFull, sql_OrderByColumnFull, OrOrderByColumn, OrColumn, sql_Operands, sql_DbObjectName, sql_DbObjectNameAll, sql_ColumnFull, sql_FromTable, sql_FullExpression, OrExpr, sql_ExprGroup, sql_GroupByColumnFull, OrGroupByColumn, sql_XExpr, sql_InOper, sql_Between, sql_Like, sql_Comparison, sql_Prms, sql_JRParameter, Prms, sql_LikeOperand, sql_OperandList, OpFunctionArgAgregate, sql_Operand, sql_ColumnOperand, sql_SQLCaseOperand, sql_POperand, sql_ExpOperand, sql_OpFunction, sql_OpFunctionCast, sql_OpFunctionArgOperand, OpFunctionArg, sql_OpFunctionArgAgregate, OperandList, sql_SQLCaseWhens, sql_SqlCaseWhen, SQLCaseWhens, sql_ScalarOperand, sql_OpFunctionArg, sql_Col, sql_tbls, sql_OpList, sql_Plus, Operands, sql_Minus, sql_Star, sql_Div, sql_Concat, sql_OpFList, sql_WhenList, XFunction},
    associations={query0, orderByEntry1, query3, op4, cols7, tbl9, whereExpression11, groupByEntry13, havingEntry15, entries18, table28, fjoin30, onTable32, joinExpr35, tfull38, sq40, tblAlias42, entries45, colOrder47, ce20, colAlias22, dbAllCols24, entries26, colGrBy51, entries54, efrag57, entries49, xexp64, op166, in_69, between71, like73, comp75, expr77, col80, prm83, entries85, op287, op290, expgroup59, exp62, op296, op399, subquery102, opList105, op1107, left110, right112, column115, xop118, subq120, fcast123, func126, sqlcase129, param131, eparam133, fop292, fcast94, op139, op140, cfull143, sel146, expr149, when152, expr154, texp156, scalar135, args137, entries162, entries164, entries166, eexp159, entries170, entries168},
    generalizations={gen_sql_Select_SelectQuery, gen_sql_FromTable_OrTable, gen_sql_DbObjectName_ColumnFull, gen_sql_DbObjectName_TableFull, gen_sql_OrderByColumnFull_OrOrderByColumn, gen_sql_ColumnOrAlias_OrColumn, gen_sql_FullExpression_OrExpr, gen_sql_GroupByColumnFull_OrGroupByColumn, gen_sql_JRParameter_Prms, gen_sql_Operands_OpFunctionArgAgregate, gen_sql_OpFunctionArgOperand_OpFunctionArg, gen_sql_ScalarOperand_OperandList, gen_sql_SqlCaseWhen_SQLCaseWhens, gen_sql_Col_ColumnFull, gen_sql_tbls_TableFull, gen_sql_OpList_OperandList, gen_sql_Plus_Operands, gen_sql_Minus_Operands, gen_sql_Star_Operands, gen_sql_Div_Operands, gen_sql_Concat_Operands, gen_sql_OpFList_OpFunctionArg, gen_sql_WhenList_SQLCaseWhens},
    metadata=None
)
