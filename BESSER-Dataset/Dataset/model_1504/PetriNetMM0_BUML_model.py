...
# Classes
PetriNetMM0_Transition = Class(name="PetriNetMM0_Transition")
PetriNetMM0_Net = Class(name="PetriNetMM0_Net")
PetriNetMM0_Place = Class(name="PetriNetMM0_Place")
...
domain_model = DomainModel(
    name="PetriNetMM0",
    types={PetriNetMM0_Transition, PetriNetMM0_Net, PetriNetMM0_Place},
