...
PetriNetMM0_Net_strategy = st.builds(PetriNetMM0_Net)
...
PetriNetMM0_Place_strategy = st.builds(PetriNetMM0_Place)
...
PetriNetMM0_Transition_strategy = st.builds(PetriNetMM0_Transition)
