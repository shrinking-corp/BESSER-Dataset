...
fmpl_Policy.attributes={fmpl_Policy_parserURI, fmpl_Policy_name}
...
fmpl_Write.attributes={fmpl_Write_length, fmpl_Write_initBit}
...
domain_model = DomainModel(
    name="fmpl",
    types={fmpl_Policy, fmpl_Automata, fmpl_Expression, fmpl_State, fmpl_Transition, fmpl_Exec, Expression, fmpl_Cond, fmpl_Relational, fmpl_Write, fmpl_VarReference, fmpl_Init, fmpl_Read, fmpl_ArithmeticExpression, fmpl_Literal, fmpl_IntegerLit, Literal, fmpl_StringLit, fmpl_VarDeclaration, fmpl_Field, RelationalOperator, ArithmeticOperator},
    associations={statements1, states3, transitions5, init7, automatas0, to13, transition16, if_18, from_10, var22, automata23, left25, then19, left31, right33, right28, expr36, name38},
    generalizations={gen_fmpl_Exec_Expression, gen_fmpl_Cond_Expression, gen_fmpl_Read_Expression, gen_fmpl_Write_Expression, gen_fmpl_Init_Expression, gen_fmpl_Relational_Expression, gen_fmpl_ArithmeticExpression_Expression, gen_fmpl_Literal_Expression, gen_fmpl_IntegerLit_Literal, gen_fmpl_StringLit_Literal, gen_fmpl_VarDeclaration_Expression, gen_fmpl_VarReference_Expression, gen_fmpl_Field_Literal},
    metadata=None
)
