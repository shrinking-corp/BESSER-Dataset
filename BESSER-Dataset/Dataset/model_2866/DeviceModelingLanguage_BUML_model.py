...
# Classes
deviceModelingLanguage_MemberDecl = Class(name="deviceModelingLanguage_MemberDecl")
deviceModelingLanguage_Device = Class(name="deviceModelingLanguage_Device")
deviceModelingLanguage_Assignment = Class(name="deviceModelingLanguage_Assignment")
deviceModelingLanguage_Exp = Class(name="deviceModelingLanguage_Exp")
deviceModelingLanguage_AttrDecl = Class(name="deviceModelingLanguage_AttrDecl")
deviceModelingLanguage_Model = Class(name="deviceModelingLanguage_Model")
deviceModelingLanguage_Decl = Class(name="deviceModelingLanguage_Decl")
deviceModelingLanguage_TypeDecl = Class(name="deviceModelingLanguage_TypeDecl")
Decl = Class(name="Decl")
deviceModelingLanguage_FeatureDecl = Class(name="deviceModelingLanguage_FeatureDecl")
deviceModelingLanguage_GeneralInvariant = Class(name="deviceModelingLanguage_GeneralInvariant")
FeatureDecl = Class(name="FeatureDecl")
MemberDecl = Class(name="MemberDecl")
Accessor = Class(name="Accessor")
deviceModelingLanguage_Modifier = Class(name="deviceModelingLanguage_Modifier")
deviceModelingLanguage_Type = Class(name="deviceModelingLanguage_Type")
deviceModelingLanguage_Literal = Class(name="deviceModelingLanguage_Literal")
deviceModelingLanguage_SubMemberDecl = Class(name="deviceModelingLanguage_SubMemberDecl")
deviceModelingLanguage_MModifier = Class(name="deviceModelingLanguage_MModifier")
deviceModelingLanguage_FeatureType = Class(name="deviceModelingLanguage_FeatureType")
deviceModelingLanguage_Report = Class(name="deviceModelingLanguage_Report")
deviceModelingLanguage_BaseFeatureType = Class(name="deviceModelingLanguage_BaseFeatureType")
FeatureType = Class(name="FeatureType")
deviceModelingLanguage_InvariantDecl = Class(name="deviceModelingLanguage_InvariantDecl")
deviceModelingLanguage_MultiplicityInvariant = Class(name="deviceModelingLanguage_MultiplicityInvariant")
InvariantDecl = Class(name="InvariantDecl")
deviceModelingLanguage_ConstraintNat = Class(name="deviceModelingLanguage_ConstraintNat")
deviceModelingLanguage_SubMemberMatch = Class(name="deviceModelingLanguage_SubMemberMatch")
deviceModelingLanguage_SimpleBasicLiteral = Class(name="deviceModelingLanguage_SimpleBasicLiteral")
SimpleLiteral = Class(name="SimpleLiteral")
deviceModelingLanguage_SimpleTupleLiteral = Class(name="deviceModelingLanguage_SimpleTupleLiteral")
deviceModelingLanguage_SimpleOptionLiteral = Class(name="deviceModelingLanguage_SimpleOptionLiteral")
deviceModelingLanguage_SimpleSeqLiteral = Class(name="deviceModelingLanguage_SimpleSeqLiteral")
deviceModelingLanguage_ConstraintExp = Class(name="deviceModelingLanguage_ConstraintExp")
deviceModelingLanguage_Param = Class(name="deviceModelingLanguage_Param")
deviceModelingLanguage_ReportMemberDecl = Class(name="deviceModelingLanguage_ReportMemberDecl")
deviceModelingLanguage_Accessor = Class(name="deviceModelingLanguage_Accessor")
deviceModelingLanguage_Primary = Class(name="deviceModelingLanguage_Primary")
deviceModelingLanguage_BaseType = Class(name="deviceModelingLanguage_BaseType")
Type = Class(name="Type")
deviceModelingLanguage_BasicLiteral = Class(name="deviceModelingLanguage_BasicLiteral")
Literal = Class(name="Literal")
deviceModelingLanguage_TupleLiteral = Class(name="deviceModelingLanguage_TupleLiteral")
deviceModelingLanguage_SeqLiteral = Class(name="deviceModelingLanguage_SeqLiteral")
deviceModelingLanguage_SimpleLiteral = Class(name="deviceModelingLanguage_SimpleLiteral")
deviceModelingLanguage_SetLiteral = Class(name="deviceModelingLanguage_SetLiteral")
deviceModelingLanguage_OptionLiteral = Class(name="deviceModelingLanguage_OptionLiteral")
deviceModelingLanguage_SetFeatureType = Class(name="deviceModelingLanguage_SetFeatureType")
deviceModelingLanguage_NumNatConstraint = Class(name="deviceModelingLanguage_NumNatConstraint")
ConstraintNat = Class(name="ConstraintNat")
deviceModelingLanguage_AnyNatConstraint = Class(name="deviceModelingLanguage_AnyNatConstraint")
deviceModelingLanguage_SimpleSetLiteral = Class(name="deviceModelingLanguage_SimpleSetLiteral")
deviceModelingLanguage_Feature = Class(name="deviceModelingLanguage_Feature")
deviceModelingLanguage_Data = Class(name="deviceModelingLanguage_Data")
MModifier = Class(name="MModifier")
deviceModelingLanguage_App = Class(name="deviceModelingLanguage_App")
deviceModelingLanguage_Const = Class(name="deviceModelingLanguage_Const")
Modifier = Class(name="Modifier")
deviceModelingLanguage_Val = Class(name="deviceModelingLanguage_Val")
deviceModelingLanguage_Var = Class(name="deviceModelingLanguage_Var")
deviceModelingLanguage_Override = Class(name="deviceModelingLanguage_Override")
deviceModelingLanguage_OptionFeatureType = Class(name="deviceModelingLanguage_OptionFeatureType")
deviceModelingLanguage_SomeFeatureType = Class(name="deviceModelingLanguage_SomeFeatureType")
deviceModelingLanguage_EitherFeatureType = Class(name="deviceModelingLanguage_EitherFeatureType")
deviceModelingLanguage_SeqFeatureType = Class(name="deviceModelingLanguage_SeqFeatureType")
deviceModelingLanguage_NoneType = Class(name="deviceModelingLanguage_NoneType")
deviceModelingLanguage_NoneLiteral = Class(name="deviceModelingLanguage_NoneLiteral")
OptionLiteral = Class(name="OptionLiteral")
deviceModelingLanguage_SomeLiteral = Class(name="deviceModelingLanguage_SomeLiteral")
deviceModelingLanguage_BinaryExp = Class(name="deviceModelingLanguage_BinaryExp")
Exp = Class(name="Exp")
deviceModelingLanguage_UnaryExp = Class(name="deviceModelingLanguage_UnaryExp")
deviceModelingLanguage_PrimaryExp = Class(name="deviceModelingLanguage_PrimaryExp")
deviceModelingLanguage_AccessExp = Class(name="deviceModelingLanguage_AccessExp")
deviceModelingLanguage_NameExp = Class(name="deviceModelingLanguage_NameExp")
Primary = Class(name="Primary")
deviceModelingLanguage_LiteralExp = Class(name="deviceModelingLanguage_LiteralExp")
deviceModelingLanguage_SeqType = Class(name="deviceModelingLanguage_SeqType")
deviceModelingLanguage_SetType = Class(name="deviceModelingLanguage_SetType")
deviceModelingLanguage_TupleType = Class(name="deviceModelingLanguage_TupleType")
BaseType = Class(name="BaseType")
deviceModelingLanguage_OptionType = Class(name="deviceModelingLanguage_OptionType")
deviceModelingLanguage_SomeType = Class(name="deviceModelingLanguage_SomeType")
deviceModelingLanguage_SimpleNoneLiteral = Class(name="deviceModelingLanguage_SimpleNoneLiteral")
SimpleOptionLiteral = Class(name="SimpleOptionLiteral")
deviceModelingLanguage_SimpleSomeLiteral = Class(name="deviceModelingLanguage_SimpleSomeLiteral")
...
deviceModelingLanguage_Model_class_: Property = Property(name="class_", type=BooleanType)
deviceModelingLanguage_Model_product: Property = Property(name="product", type=BooleanType)
deviceModelingLanguage_Model.attributes={deviceModelingLanguage_Model_product, deviceModelingLanguage_Model_class_, deviceModelingLanguage_Model_schema}
...
deviceModelingLanguage_SubMemberMatch.attributes={deviceModelingLanguage_SubMemberMatch_any, deviceModelingLanguage_SubMemberMatch_qNames, deviceModelingLanguage_SubMemberMatch_name}
...
deviceModelingLanguage_Feature_class_: Property = Property(name="class_", type=BooleanType)
deviceModelingLanguage_Feature_product: Property = Property(name="product", type=BooleanType)
deviceModelingLanguage_Feature.attributes={deviceModelingLanguage_Feature_product, deviceModelingLanguage_Feature_class_, deviceModelingLanguage_Feature_schema}
...
deviceModelingLanguage_Const_class_: Property = Property(name="class_", type=BooleanType)
...
deviceModelingLanguage_Const.attributes={deviceModelingLanguage_Const_product, deviceModelingLanguage_Const_instance, deviceModelingLanguage_Const_schema, deviceModelingLanguage_Const_class_}
...
domain_model = DomainModel(
    ...
    types={deviceModelingLanguage_MemberDecl, deviceModelingLanguage_Device, deviceModelingLanguage_Assignment, deviceModelingLanguage_Exp, deviceModelingLanguage_AttrDecl, deviceModelingLanguage_Model, deviceModelingLanguage_Decl, deviceModelingLanguage_TypeDecl, Decl, deviceModelingLanguage_FeatureDecl, deviceModelingLanguage_GeneralInvariant, FeatureDecl, MemberDecl, Accessor, deviceModelingLanguage_Modifier, deviceModelingLanguage_Type, deviceModelingLanguage_Literal, deviceModelingLanguage_SubMemberDecl, deviceModelingLanguage_MModifier, deviceModelingLanguage_FeatureType, deviceModelingLanguage_Report, deviceModelingLanguage_BaseFeatureType, FeatureType, deviceModelingLanguage_InvariantDecl, deviceModelingLanguage_MultiplicityInvariant, InvariantDecl, deviceModelingLanguage_ConstraintNat, deviceModelingLanguage_SubMemberMatch, deviceModelingLanguage_SimpleBasicLiteral, SimpleLiteral, deviceModelingLanguage_SimpleTupleLiteral, deviceModelingLanguage_SimpleOptionLiteral, deviceModelingLanguage_SimpleSeqLiteral, deviceModelingLanguage_ConstraintExp, deviceModelingLanguage_Param, deviceModelingLanguage_ReportMemberDecl, deviceModelingLanguage_Accessor, deviceModelingLanguage_Primary, deviceModelingLanguage_BaseType, Type, deviceModelingLanguage_BasicLiteral, Literal, deviceModelingLanguage_TupleLiteral, deviceModelingLanguage_SeqLiteral, deviceModelingLanguage_SimpleLiteral, deviceModelingLanguage_SetLiteral, deviceModelingLanguage_OptionLiteral, deviceModelingLanguage_SetFeatureType, deviceModelingLanguage_NumNatConstraint, ConstraintNat, deviceModelingLanguage_AnyNatConstraint, deviceModelingLanguage_SimpleSetLiteral, deviceModelingLanguage_Feature, deviceModelingLanguage_Data, MModifier, deviceModelingLanguage_App, deviceModelingLanguage_Const, Modifier, deviceModelingLanguage_Val, deviceModelingLanguage_Var, deviceModelingLanguage_Override, deviceModelingLanguage_OptionFeatureType, deviceModelingLanguage_SomeFeatureType, deviceModelingLanguage_EitherFeatureType, deviceModelingLanguage_SeqFeatureType, deviceModelingLanguage_NoneType, deviceModelingLanguage_NoneLiteral, OptionLiteral, deviceModelingLanguage_SomeLiteral, deviceModelingLanguage_BinaryExp, Exp, deviceModelingLanguage_UnaryExp, deviceModelingLanguage_PrimaryExp, deviceModelingLanguage_AccessExp, deviceModelingLanguage_NameExp, Primary, deviceModelingLanguage_LiteralExp, deviceModelingLanguage_SeqType, deviceModelingLanguage_SetType, deviceModelingLanguage_TupleType, BaseType, deviceModelingLanguage_OptionType, deviceModelingLanguage_SomeType, deviceModelingLanguage_SimpleNoneLiteral, SimpleOptionLiteral, deviceModelingLanguage_SimpleSomeLiteral},
    associations={members5, devices7, assigns9, exp11, decls0, supers2, supers4, type37, exp40, modifier13, type14, literal16, modifier18, type19, exp21, args24, components26, members28, lo31, hi32, match35, elems68, elems70, components42, constraint45, cond47, type50, bindingName52, type53, typeCons55, elems57, elementType59, elems61, elementType63, elems65, base91, elements93, elems72, base74, base76, members78, bases81, members83, base86, elements88, base119, base121, type123, lit125, left96, right98, arg101, primary103, base104, accessor106, lit109, base111, base113, elemTypes115, base117, lit127},
    generalizations={gen_deviceModelingLanguage_TypeDecl_Decl, gen_deviceModelingLanguage_FeatureDecl_Decl, gen_deviceModelingLanguage_GeneralInvariant_InvariantDecl, gen_deviceModelingLanguage_Device_FeatureDecl, gen_deviceModelingLanguage_AttrDecl_MemberDecl, gen_deviceModelingLanguage_AttrDecl_Accessor, gen_deviceModelingLanguage_SubMemberDecl_MemberDecl, gen_deviceModelingLanguage_SubMemberDecl_Accessor, gen_deviceModelingLanguage_BaseFeatureType_FeatureType, gen_deviceModelingLanguage_InvariantDecl_MemberDecl, gen_deviceModelingLanguage_MultiplicityInvariant_InvariantDecl, gen_deviceModelingLanguage_SimpleBasicLiteral_SimpleLiteral, gen_deviceModelingLanguage_SimpleTupleLiteral_SimpleLiteral, gen_deviceModelingLanguage_SimpleOptionLiteral_SimpleLiteral, gen_deviceModelingLanguage_SimpleSeqLiteral_SimpleLiteral, gen_deviceModelingLanguage_BaseType_Type, gen_deviceModelingLanguage_BasicLiteral_Literal, gen_deviceModelingLanguage_TupleLiteral_Literal, gen_deviceModelingLanguage_SeqLiteral_Literal, gen_deviceModelingLanguage_SetLiteral_Literal, gen_deviceModelingLanguage_OptionLiteral_Literal, gen_deviceModelingLanguage_SetFeatureType_FeatureType, gen_deviceModelingLanguage_NumNatConstraint_ConstraintNat, gen_deviceModelingLanguage_AnyNatConstraint_ConstraintNat, gen_deviceModelingLanguage_SimpleSetLiteral_SimpleLiteral, gen_deviceModelingLanguage_Feature_FeatureDecl, gen_deviceModelingLanguage_Data_FeatureDecl, gen_deviceModelingLanguage_Data_MModifier, gen_deviceModelingLanguage_App_FeatureDecl, gen_deviceModelingLanguage_Const_Modifier, gen_deviceModelingLanguage_Const_MModifier, gen_deviceModelingLanguage_Val_Modifier, gen_deviceModelingLanguage_Val_MModifier, gen_deviceModelingLanguage_Var_Modifier, gen_deviceModelingLanguage_Var_MModifier, gen_deviceModelingLanguage_Override_Modifier, gen_deviceModelingLanguage_Override_MModifier, gen_deviceModelingLanguage_OptionFeatureType_FeatureType, gen_deviceModelingLanguage_SomeFeatureType_FeatureType, gen_deviceModelingLanguage_EitherFeatureType_FeatureType, gen_deviceModelingLanguage_SeqFeatureType_FeatureType, gen_deviceModelingLanguage_NoneType_BaseType, gen_deviceModelingLanguage_NoneLiteral_OptionLiteral, gen_deviceModelingLanguage_SomeLiteral_OptionLiteral, gen_deviceModelingLanguage_BinaryExp_Exp, gen_deviceModelingLanguage_UnaryExp_Exp, gen_deviceModelingLanguage_PrimaryExp_Exp, gen_deviceModelingLanguage_AccessExp_Exp, gen_deviceModelingLanguage_NameExp_Primary, gen_deviceModelingLanguage_LiteralExp_Primary, gen_deviceModelingLanguage_SeqType_Type, gen_deviceModelingLanguage_SetType_Type, gen_deviceModelingLanguage_TupleType_BaseType, gen_deviceModelingLanguage_OptionType_BaseType, gen_deviceModelingLanguage_SomeType_BaseType, gen_deviceModelingLanguage_SimpleNoneLiteral_SimpleOptionLiteral, gen_deviceModelingLanguage_SimpleSomeLiteral_SimpleOptionLiteral},
    metadata=None
)
