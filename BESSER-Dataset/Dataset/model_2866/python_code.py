...
class MModifier:
    ...
    pass
class deviceModelingLanguage_Var(MModifier, Modifier):

    pass
class deviceModelingLanguage_Const(MModifier, Modifier):
...
class deviceModelingLanguage_Override(MModifier, Modifier):

    pass
class deviceModelingLanguage_Val(MModifier, Modifier):
...
class deviceModelingLanguage_BasicLiteral(Literal):
    ...
    def __init__(self, lit: str, deviceModelingLanguage_BasicLiteral110: "deviceModelingLanguage_LiteralExp" = None, deviceModelingLanguage_BasicLiteral: "deviceModelingLanguage_TypeDecl" = None):
        self.lit = lit
...
class deviceModelingLanguage_Model:
    ...
    def __init__(self, schema: bool, class_: bool, product: bool, deviceModelingLanguage_Model: set["deviceModelingLanguage_Decl"] = None):
        self.schema = schema
        self.class_ = class_
        self.product = product
