...
# Classes
toe_AllHolder = Class(name="toe_AllHolder")
toe_AllBase = Class(name="toe_AllBase", is_abstract=True)
toe_Employee = Class(name="toe_Employee")
AllBase = Class(name="AllBase")
toe_Project = Class(name="toe_Project")
toe_Department = Class(name="toe_Department")
toe_Contribution = Class(name="toe_Contribution")
toe_Manager = Class(name="toe_Manager")
...
domain_model = DomainModel(
    ...
    associations={all0, projects1, department2, contributions3, employee8, project9, subDepartments13, employees15, parentDepartment18, manager20, projectTeam21, lead23, contributions25, leads4, managedDepartment6},
    generalizations={gen_toe_Employee_AllBase, gen_toe_Contribution_AllBase, gen_toe_Department_AllBase, gen_toe_Project_AllBase, gen_toe_Manager_Employee},
    metadata=None
)
