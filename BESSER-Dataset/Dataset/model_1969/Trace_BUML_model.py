...
# Classes
trace_TraceBySource = Class(name="trace_TraceBySource")
trace_TraceItem = Class(name="trace_TraceItem", is_abstract=True)
trace_Trace = Class(name="trace_Trace")
trace_TraceList = Class(name="trace_TraceList")
trace_EObject = Class(name="trace_EObject")
trace_M2MTraceItem = Class(name="trace_M2MTraceItem")
TraceItem = Class(name="TraceItem")
trace_M2CTraceItem = Class(name="trace_M2CTraceItem")
...
domain_model = DomainModel(
    name="trace",
    types={trace_TraceBySource, trace_TraceItem, trace_Trace, trace_TraceList, trace_EObject, trace_M2MTraceItem, TraceItem, trace_M2CTraceItem},
    associations={traceBySource1, list0, items3, from_5, source7, items10, to13},
