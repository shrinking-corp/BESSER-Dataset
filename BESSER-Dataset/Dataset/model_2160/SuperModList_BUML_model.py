...
# Classes
list_VersionedListVertex = Class(name="list_VersionedListVertex")
list_VersionedListEdge = Class(name="list_VersionedListEdge")
list_VersionedListStartReference = Class(name="list_VersionedListStartReference")
UUIDElement = Class(name="UUIDElement")
list_ProductSpaceElement = Class(name="list_ProductSpaceElement")
list_VersionedList = Class(name="list_VersionedList")
...
list_VersionedList_m_getAllOccurrencesOf: Method = Method(name="getAllOccurrencesOf", parameters={Parameter(name='list_element', type=StringType)}, type=StringType)
list_VersionedList_m_linearize: Method = Method(name="linearize", parameters={}, type=ProductSpaceElement)
list_VersionedList_m_getEdge: Method = Method(name="getEdge", parameters={Parameter(name='list_from_', type=StringType), Parameter(name='list_to', type=StringType)}, type=StringType)
...
domain_model = DomainModel(
    ...
    associations={vertices0, edges1, startVertices3, element5, incomingEdges6, outgoingEdges8, vertex19, list21, list10, startRef11, source13, sink15, list17},
    generalizations={gen_list_VersionedList_ProductSpaceElement, gen_list_VersionedListVertex_ProductSpaceElement, gen_list_VersionedListVertex_UUIDElement, gen_list_VersionedListEdge_ProductSpaceElement, gen_list_VersionedListStartReference_ProductSpaceElement},
    metadata=None
)
