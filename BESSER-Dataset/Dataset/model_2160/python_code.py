...
class list_VersionedList(ProductSpaceElement):
    ...
    def __init__(self, list: set["list_VersionedListVertex"] = None, list2: set["list_VersionedListEdge"] = None, list4: set["list_VersionedListStartReference"] = None, VersionedList22: "list_VersionedListStartReference" = None, VersionedList: "list_VersionedListVertex" = None, VersionedList18: "list_VersionedListEdge" = None):
    ...
    def getAllOccurrencesOf(self, list_element) :
        # TODO: Implement getAllOccurrencesOf method
        pass

    def getEdge(self, list_from_, list_to) :
...
class list_VersionedListEdge(ProductSpaceElement):
    ...
    pass
class list_VersionedListVertex(UUIDElement, ProductSpaceElement):
