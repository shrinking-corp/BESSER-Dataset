...
sQL_Database = Class(name="sQL_Database")
...
sQL_Column.attributes={sQL_Column_notNull, sQL_Column_name, sQL_Column_dataType}
...
domain_model = DomainModel(
    name="sQL",
    types={sQL_ForeignKey, sQL_Database, sQL_Table, sQL_Column, sQL_PrimaryKey},
    associations={primaryKey3, foreignKeys5, columns7, columns10, refTable13, refColumns16, tables0, columns1},
    generalizations={},
    metadata=None
)
