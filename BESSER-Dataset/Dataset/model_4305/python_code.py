...
class metrics_MetricRetentionPeriods:
    ...
    def __init__(self, metricRetentionPeriods: str):
        ...
        pass
    @property
    def metricRetentionPeriods(self):
...
class metrics_MappingRDBMS(Mapping):
    ...
    def __init__(self, timeFormat: str, user: str, databaseType: str, dateFormat: str, dateTimeFormat: str, password: str, query: str):
...
class metrics_MetricSource(Base):
    ...
    def __init__(self, metricLocation: str, name: str, filterPattern: str, metrics_MetricSource: "metrics_Metric" = None, metrics_MetricSource35: "metrics_RuleSet" = None, metrics_MetricSource37: "metrics_RuleSet" = None, metrics_MetricSource29: "metrics_Mapping" = None, metrics_MetricSource32: set["metrics_MappingStatistic"] = None):
...
class metrics_Mapping(Base):
    ...
    def __init__(self, firstDataRow: str, headerRow: str, intervalHint: str, metrics_Mapping: set["metrics_MappingColumn"] = None, metrics_Mapping2: set["metrics_MappingColumn"] = None, metrics_Mapping30: "metrics_MetricSource" = None):
