...
# Classes
metrics_DataKind = Class(name="metrics_DataKind")
metrics_Mapping = Class(name="metrics_Mapping")
Base = Class(name="Base")
metrics_MappingColumn = Class(name="metrics_MappingColumn")
metrics_IdentifierDataKind = Class(name="metrics_IdentifierDataKind")
DataKind = Class(name="DataKind")
metrics_MappingCSV = Class(name="metrics_MappingCSV")
Mapping = Class(name="Mapping")
metrics_MappingExternal = Class(name="metrics_MappingExternal")
metrics_MappingRecord = Class(name="metrics_MappingRecord")
metrics_MappingStatistic = Class(name="metrics_MappingStatistic")
metrics_MappingRDBMS = Class(name="metrics_MappingRDBMS")
metrics_DateTimeRange = Class(name="metrics_DateTimeRange")
metrics_Expression = Class(name="metrics_Expression")
metrics_MappingXLS = Class(name="metrics_MappingXLS")
metrics_Metric = Class(name="metrics_Metric")
metrics_MetricAggregationRules = Class(name="metrics_MetricAggregationRules")
metrics_MetricRetentionPeriods = Class(name="metrics_MetricRetentionPeriods")
metrics_MetricRetentionRule = Class(name="metrics_MetricRetentionRule")
metrics_MetricSource = Class(name="metrics_MetricSource")
metrics_Unit = Class(name="metrics_Unit")
metrics_MetricAggregationRule = Class(name="metrics_MetricAggregationRule")
Rule = Class(name="Rule")
metrics_RuleSet = Class(name="metrics_RuleSet")
metrics_MetricValueRange = Class(name="metrics_MetricValueRange")
metrics_Value = Class(name="metrics_Value")
metrics_MetricRetentionRules = Class(name="metrics_MetricRetentionRules")
metrics_ValueDataKind = Class(name="metrics_ValueDataKind")
...
metrics_Mapping.attributes={metrics_Mapping_intervalHint, metrics_Mapping_firstDataRow, metrics_Mapping_headerRow}
...
metrics_MappingRDBMS.attributes={metrics_MappingRDBMS_user, metrics_MappingRDBMS_dateFormat, metrics_MappingRDBMS_timeFormat, metrics_MappingRDBMS_password, metrics_MappingRDBMS_dateTimeFormat, metrics_MappingRDBMS_query, metrics_MappingRDBMS_databaseType}
...
metrics_Metric.attributes={metrics_Metric_description, metrics_Metric_name, metrics_Metric_measurementPoint, metrics_Metric_measurementKind}
...
metrics_MetricSource.attributes={metrics_MetricSource_name, metrics_MetricSource_filterPattern, metrics_MetricSource_metricLocation}
...
domain_model = DomainModel(
    name="metrics",
    types={metrics_DataKind, metrics_Mapping, Base, metrics_MappingColumn, metrics_IdentifierDataKind, DataKind, metrics_MappingCSV, Mapping, metrics_MappingExternal, metrics_MappingRecord, metrics_MappingStatistic, metrics_MappingRDBMS, metrics_DateTimeRange, metrics_Expression, metrics_MappingXLS, metrics_Metric, metrics_MetricAggregationRules, metrics_MetricRetentionPeriods, metrics_MetricRetentionRule, metrics_MetricSource, metrics_Unit, metrics_MetricAggregationRule, Rule, metrics_RuleSet, metrics_MetricValueRange, metrics_Value, metrics_MetricRetentionRules, metrics_ValueDataKind, DatabaseTypeType, FixedMetricRetentionPeriod, KindHintType, ValueKindType, ObjectKindType},
    associations={headerMappingColumns0, dataMappingColumns1, dataType4, periodEstimate9, subStatistics13, failedRecords6, mappingDuration7, metrics16, expressionRef17, aggregationExpression23, metricAggregationRules25, metricSourceRef19, unitRef21, metricAggregationRules34, metricRetentionRules36, metricValues39, metricRetentionRules27, metricMapping28, statistics31, metricRef40},
    generalizations={gen_metrics_Mapping_Base, gen_metrics_IdentifierDataKind_DataKind, gen_metrics_MappingCSV_Mapping, gen_metrics_MappingExternal_Mapping, gen_metrics_MappingColumn_Base, gen_metrics_MappingRecord_Base, gen_metrics_MappingStatistic_Base, gen_metrics_MappingRDBMS_Mapping, gen_metrics_MappingXLS_Mapping, gen_metrics_Metric_Base, gen_metrics_MetricRetentionRule_Rule, gen_metrics_MetricAggregationRule_Rule, gen_metrics_MetricSource_Base, gen_metrics_ValueDataKind_DataKind},
    metadata=None
)
