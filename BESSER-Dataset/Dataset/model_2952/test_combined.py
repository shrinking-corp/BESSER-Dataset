...
def test_hyp_metamodeloarquitecturapila_other_is_not_abstract():
    assert not inspect.isabstract(metamodeloArquitecturaPila_Other)


def test_hyp_metamodeloarquitecturapila_other_constructor_exists():
    assert callable(metamodeloArquitecturaPila_Other.__init__)


def test_hyp_metamodeloarquitecturapila_other_constructor_args():
...
def test_metamodeloArquitecturaPila_Other_isa_DataType():
    instance = metamodeloArquitecturaPila_Other()
    assert isinstance(instance, DataType)
...
metamodeloArquitecturaPila_Other_strategy = st.builds(metamodeloArquitecturaPila_Other)
