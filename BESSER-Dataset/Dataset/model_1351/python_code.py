...
class statemachine_AbstractState(ABC):
    ...
    def __init__(self, name: str, statemachine_AbstractState: "statemachine_StateMachine" = None, AbstractState: "statemachine_Transition" = None, AbstractState9: "statemachine_Transition" = None, source: set["statemachine_Transition"] = None, target: set["statemachine_Transition"] = None):
        self.name = name
