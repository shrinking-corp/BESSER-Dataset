...
domain_model = DomainModel(
    ...
    associations={states0, source7, target8, transitions1, transitionsAsSource3, transitionsAsTarget4, internalActions6},
    generalizations={gen_statemachine_StateAction_FiringElement, gen_statemachine_State_AbstractState, gen_statemachine_InitialState_AbstractState, gen_statemachine_FinalState_AbstractState, gen_statemachine_Transition_FiringElement},
    metadata=None
)
