...
Account.attributes={Account_Username, Account_Password}
...
Customer.attributes={Customer_cellNo, Customer_DOB, Customer_emailAddress, Customer_name, Customer_Gender}

# Order class attributes and methods
Order_quantity: Property = Property(name="quantity", type=IntegerType)
Order_price: Property = Property(name="price", type=Item)
Order.attributes={Order_quantity, Order_price}
...
Item.attributes={Item_colour, Item_productId, Item_price}
...
domain_model = DomainModel(
    name="aa2f787d_d95e_4958_85b7_390310de920e",
    types={Account, Customer, Order, Shopping_Cart, Item},
    associations={User_Login, Orders_Friend, Shopping_Cart_Login, User_Myprofile, User_Post},
    generalizations={},
    metadata=None
)
