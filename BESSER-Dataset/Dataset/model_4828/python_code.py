...
class model_DiagramModelObject(LineObject, FontAttribute, Connectable, TextAlignment):
    ...
    def setBounds(self, model_width, model_height, model_x, model_y):
...
class DiagramModelObject:
    ...
    pass
class model_DiagramModelNote(DiagramModelObject, TextPosition, TextContent):
...
class Properties:
    ...
    pass
class model_SketchModelSticky(TextPosition, TextContent, Properties, DiagramModelContainer, DiagramModelObject):
...
class model_DiagramModelGroup(Documentable, Properties, DiagramModelContainer, DiagramModelObject):
    ...
    pass
class model_DiagramModelConnection(LineObject, Connectable, Properties, FontAttribute, Documentable):

    def __init__(self, textPosition: int, text: str, type: int, model_DiagramModelConnection: "model_Connectable" = None, model_DiagramModelConnection15: "model_Connectable" = None, model_DiagramModelConnection21: "model_Connectable" = None, model_DiagramModelConnection24: "model_Connectable" = None, model_DiagramModelConnection27: set["model_DiagramModelBendpoint"] = None):
        self.textPosition = textPosition
        self.text = text
        self.type = type
...
class ArchimateModelObject:
    ...
    pass
class model_ArchimateModel(FolderContainer, Properties, ArchimateModelObject):
...
class model_ArchimateConcept(Documentable, Properties, ArchimateModelObject, Cloneable):
    ...
    pass
class model_DiagramModel(DiagramModelContainer, Documentable, Properties, ArchimateModelObject):
...
class model_DiagramModelComponent(Cloneable, Nameable, Adapter, Identifier, ArchimateModelObject):
...
class model_Folder(FolderContainer, Documentable, Properties, ArchimateModelObject):
