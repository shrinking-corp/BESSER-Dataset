...
model_ArchimateModel.methods={model_ArchimateModel_m_getDefaultDiagramModel, model_ArchimateModel_m_getDefaultFolderForObject, model_ArchimateModel_m_getDiagramModels, model_ArchimateModel_m_getFolder, model_ArchimateModel_m_setDefaults}
...
model_DiagramModelObject_m_setBounds: Method = Method(name="setBounds", parameters={Parameter(name='model_y', type=StringType), Parameter(name='model_height', type=StringType), Parameter(name='model_x', type=StringType), Parameter(name='model_width', type=StringType)})
...
model_DiagramModelBendpoint.attributes={model_DiagramModelBendpoint_startX, model_DiagramModelBendpoint_endX, model_DiagramModelBendpoint_endY, model_DiagramModelBendpoint_startY}
...
model_DiagramModelArchimateComponent.methods={model_DiagramModelArchimateComponent_m_addArchimateConceptToModel, model_DiagramModelArchimateComponent_m_removeArchimateConceptFromModel, model_DiagramModelArchimateComponent_m_setArchimateConcept, model_DiagramModelArchimateComponent_m_getArchimateConcept}
