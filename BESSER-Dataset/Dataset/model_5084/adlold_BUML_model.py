...
# Classes
adlold_AbstractComponent = Class(name="adlold_AbstractComponent", is_abstract=True)
adlold_Content = Class(name="adlold_Content")
adlold_Required = Class(name="adlold_Required")
adlold_Provided = Class(name="adlold_Provided")
adlold_Interface = Class(name="adlold_Interface", is_abstract=True)
adlold_Binding = Class(name="adlold_Binding")
adlold_Component = Class(name="adlold_Component")
...
adlold_Interface.attributes={adlold_Interface_signature, adlold_Interface_name}
...
domain_model = DomainModel(
    name="adlold",
    types={adlold_AbstractComponent, adlold_Content, adlold_Required, adlold_Provided, adlold_Interface, adlold_Binding, adlold_Component, AbstractComponent, Interface},
    associations={content0, requiredInterfaces1, providedInterfaces3, bindings5, from_6, to9, contentParent12, subComponents16},
    generalizations={gen_adlold_Provided_Interface, gen_adlold_Component_AbstractComponent, gen_adlold_Required_Interface},
    metadata=None
)
