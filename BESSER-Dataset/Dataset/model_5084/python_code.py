...
class adlold_Content:
    ...
    def __init__(self, expression: str, language: str, adlold_Content13: "adlold_AbstractComponent" = None, adlold_Content: "adlold_AbstractComponent" = None):
...
class adlold_AbstractComponent(ABC):
    ...
    def __init__(self, name: str, adlold_AbstractComponent2: set["adlold_Required"] = None, adlold_AbstractComponent4: set["adlold_Provided"] = None, adlold_AbstractComponent14: "adlold_Content" = None, adlold_AbstractComponent: "adlold_Content" = None):
        self.name = name
