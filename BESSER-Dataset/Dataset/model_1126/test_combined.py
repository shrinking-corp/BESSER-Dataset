...
def test_hyp_rosmodel_field_is_not_abstract():
    assert not inspect.isabstract(rosmodel_Field)


def test_hyp_rosmodel_field_constructor_exists():
    assert callable(rosmodel_Field.__init__)


def test_hyp_rosmodel_field_constructor_args():
...
def test_hyp_rosmodel_state_is_not_abstract():
    assert not inspect.isabstract(rosmodel_State)


def test_hyp_rosmodel_state_constructor_exists():
    assert callable(rosmodel_State.__init__)


def test_hyp_rosmodel_state_constructor_args():
...
def test_hyp_rosmodel_actionserver_is_not_abstract():
    assert not inspect.isabstract(rosmodel_ActionServer)


def test_hyp_rosmodel_actionserver_constructor_exists():
    assert callable(rosmodel_ActionServer.__init__)


def test_hyp_rosmodel_actionserver_constructor_args():
...
def test_hyp_rosmodel_actionclient_is_not_abstract():
    assert not inspect.isabstract(rosmodel_ActionClient)


def test_hyp_rosmodel_actionclient_constructor_exists():
    assert callable(rosmodel_ActionClient.__init__)


def test_hyp_rosmodel_actionclient_constructor_args():
...
def test_hyp_rosmodel_serviceserver_is_not_abstract():
    assert not inspect.isabstract(rosmodel_ServiceServer)


def test_hyp_rosmodel_serviceserver_constructor_exists():
    assert callable(rosmodel_ServiceServer.__init__)


def test_hyp_rosmodel_serviceserver_constructor_args():
...
def test_hyp_rosmodel_serviceclient_is_not_abstract():
    assert not inspect.isabstract(rosmodel_ServiceClient)


def test_hyp_rosmodel_serviceclient_constructor_exists():
    assert callable(rosmodel_ServiceClient.__init__)


def test_hyp_rosmodel_serviceclient_constructor_args():
...
def test_hyp_rosmodel_subscriber_is_not_abstract():
    assert not inspect.isabstract(rosmodel_Subscriber)


def test_hyp_rosmodel_subscriber_constructor_exists():
    assert callable(rosmodel_Subscriber.__init__)


def test_hyp_rosmodel_subscriber_constructor_args():
...
def test_hyp_rosmodel_publisher_is_not_abstract():
    assert not inspect.isabstract(rosmodel_Publisher)


def test_hyp_rosmodel_publisher_constructor_exists():
    assert callable(rosmodel_Publisher.__init__)


def test_hyp_rosmodel_publisher_constructor_args():
...
def test_hyp_rosmodel_actionmessage_is_not_abstract():
    assert not inspect.isabstract(rosmodel_ActionMessage)


def test_hyp_rosmodel_actionmessage_constructor_exists():
    assert callable(rosmodel_ActionMessage.__init__)


def test_hyp_rosmodel_actionmessage_constructor_args():
...
def test_hyp_rosmodel_servicetype_is_not_abstract():
    assert not inspect.isabstract(rosmodel_ServiceType)


def test_hyp_rosmodel_servicetype_constructor_exists():
    assert callable(rosmodel_ServiceType.__init__)


def test_hyp_rosmodel_servicetype_constructor_args():
...
def test_hyp_rosmodel_message_is_not_abstract():
    assert not inspect.isabstract(rosmodel_Message)


def test_hyp_rosmodel_message_constructor_exists():
    assert callable(rosmodel_Message.__init__)


def test_hyp_rosmodel_message_constructor_args():
...
def test_hyp_rosmodel_event_is_not_abstract():
    assert not inspect.isabstract(rosmodel_Event)


def test_hyp_rosmodel_event_constructor_exists():
    assert callable(rosmodel_Event.__init__)


def test_hyp_rosmodel_event_constructor_args():
...
def test_hyp_rosmodel_action_is_not_abstract():
    assert not inspect.isabstract(rosmodel_Action)


def test_hyp_rosmodel_action_constructor_exists():
    assert callable(rosmodel_Action.__init__)


def test_hyp_rosmodel_action_constructor_args():
...
def test_hyp_rosmodel_transition_is_not_abstract():
    assert not inspect.isabstract(rosmodel_Transition)


def test_hyp_rosmodel_transition_constructor_exists():
    assert callable(rosmodel_Transition.__init__)


def test_hyp_rosmodel_transition_constructor_args():
...
def test_hyp_rosmodel_topic_is_not_abstract():
    assert not inspect.isabstract(rosmodel_Topic)


def test_hyp_rosmodel_topic_constructor_exists():
    assert callable(rosmodel_Topic.__init__)


def test_hyp_rosmodel_topic_constructor_args():
...
def test_hyp_rosmodel_node_is_not_abstract():
    assert not inspect.isabstract(rosmodel_Node)


def test_hyp_rosmodel_node_constructor_exists():
    assert callable(rosmodel_Node.__init__)


def test_hyp_rosmodel_node_constructor_args():
...
def test_hyp_rosmodel_package_is_not_abstract():
    assert not inspect.isabstract(rosmodel_Package)


def test_hyp_rosmodel_package_constructor_exists():
    assert callable(rosmodel_Package.__init__)


def test_hyp_rosmodel_package_constructor_args():
...
def test_hyp_rosmodel_field_type_setter(instance):
...
@given(instance=rosmodel_Field_strategy)
def test_hyp_rosmodel_field_name_setter(instance):
...
def test_hyp_rosmodel_state_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_rosmodel_actionserver_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_rosmodel_actionclient_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_rosmodel_serviceserver_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_rosmodel_serviceclient_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_rosmodel_subscriber_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=rosmodel_Subscriber_strategy)
def test_hyp_rosmodel_subscriber_queue_size_setter(instance):
...
@given(instance=rosmodel_Subscriber_strategy)
def test_hyp_rosmodel_subscriber_msg_setter(instance):
...
def test_hyp_rosmodel_publisher_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=rosmodel_Publisher_strategy)
def test_hyp_rosmodel_publisher_msg_setter(instance):
    original = instance.msg
    instance.msg = original
    assert instance.msg == original
...
@given(instance=rosmodel_Publisher_strategy)
def test_hyp_rosmodel_publisher_queue_size_setter(instance):
    original = instance.queue_size
    instance.queue_size = original
    assert instance.queue_size == original
...
def test_hyp_rosmodel_actionmessage_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_rosmodel_servicetype_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_rosmodel_message_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_rosmodel_event_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_rosmodel_action_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_rosmodel_transition_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_rosmodel_topic_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_rosmodel_node_frequency_setter(instance):
...
@given(instance=rosmodel_Node_strategy)
def test_hyp_rosmodel_node_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_rosmodel_package_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=rosmodel_Package_strategy)
def test_hyp_rosmodel_package_author_email_setter(instance):
...
@given(instance=rosmodel_Package_strategy)
def test_hyp_rosmodel_package_author_setter(instance):
...
@given(instance=rosmodel_Package_strategy)
def test_hyp_rosmodel_package_depends_setter(instance):
...
@given(instance=rosmodel_Package_strategy)
def test_hyp_rosmodel_package_description_setter(instance):
