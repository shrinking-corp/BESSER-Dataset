...
# Classes
rosmodel_Package = Class(name="rosmodel_Package")
rosmodel_Node = Class(name="rosmodel_Node")
rosmodel_Topic = Class(name="rosmodel_Topic")
rosmodel_Transition = Class(name="rosmodel_Transition")
rosmodel_Action = Class(name="rosmodel_Action")
rosmodel_Event = Class(name="rosmodel_Event")
rosmodel_Message = Class(name="rosmodel_Message")
rosmodel_ServiceType = Class(name="rosmodel_ServiceType")
rosmodel_ActionMessage = Class(name="rosmodel_ActionMessage")
rosmodel_Publisher = Class(name="rosmodel_Publisher")
rosmodel_Subscriber = Class(name="rosmodel_Subscriber")
rosmodel_ServiceClient = Class(name="rosmodel_ServiceClient")
rosmodel_ServiceServer = Class(name="rosmodel_ServiceServer")
rosmodel_ActionClient = Class(name="rosmodel_ActionClient")
rosmodel_ActionServer = Class(name="rosmodel_ActionServer")
rosmodel_State = Class(name="rosmodel_State")
rosmodel_Field = Class(name="rosmodel_Field")
...
rosmodel_Package.attributes={rosmodel_Package_name, rosmodel_Package_author, rosmodel_Package_author_email, rosmodel_Package_depends, rosmodel_Package_description}
...
rosmodel_Node.attributes={rosmodel_Node_frequency, rosmodel_Node_name}
...
rosmodel_Publisher.attributes={rosmodel_Publisher_queue_size, rosmodel_Publisher_name, rosmodel_Publisher_msg}
...
rosmodel_Subscriber.attributes={rosmodel_Subscriber_name, rosmodel_Subscriber_queue_size, rosmodel_Subscriber_msg}
...
domain_model = DomainModel(
    name="rosmodel",
    types={rosmodel_Package, rosmodel_Node, rosmodel_Topic, rosmodel_Transition, rosmodel_Action, rosmodel_Event, rosmodel_Message, rosmodel_ServiceType, rosmodel_ActionMessage, rosmodel_Publisher, rosmodel_Subscriber, rosmodel_ServiceClient, rosmodel_ServiceServer, rosmodel_ActionClient, rosmodel_ActionServer, rosmodel_State, rosmodel_Field, Datatype},
    associations={node0, state21, transition23, action25, event27, target29, source32, topic1, message3, servicetype5, actionmessage7, publisher9, subscriber11, serviceclient13, serviceserver15, actionclient17, actionserver19, servicetype46, goal49, result52, feedback55, actionmessage58, actionmessage61, transition64, field35, request37, response40, servicetype43, substate68, action70, entryaction73, exitaction76, event79, source82, target85, action88, guard91, transition94},
    generalizations={},
    metadata=None
)
