...
class turingmodel_Transition:
    ...
    def __init__(self, condition: str, write: str, dir: str, turingmodel_Transition: "turingmodel_TuringMachine" = None, Transition: "turingmodel_State" = None, turingmodel_Transition15: "turingmodel_State" = None, next: "turingmodel_State" = None, turingmodel_Transition18: "turingmodel_State" = None):
