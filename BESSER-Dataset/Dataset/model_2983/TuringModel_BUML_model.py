...
# Classes
turingmodel_TuringMachine = Class(name="turingmodel_TuringMachine")
turingmodel_State = Class(name="turingmodel_State")
turingmodel_Transition = Class(name="turingmodel_Transition")
...
turingmodel_State.attributes={turingmodel_State_isEndState, turingmodel_State_name}
...
turingmodel_Transition.attributes={turingmodel_Transition_write, turingmodel_Transition_dir, turingmodel_Transition_condition}
...
domain_model = DomainModel(
    ...
    associations={states0, transitions1, startState3, next6, substates8, startSubstate11, subtransitions13, source16, target17},
    generalizations={},
    metadata=None
)
