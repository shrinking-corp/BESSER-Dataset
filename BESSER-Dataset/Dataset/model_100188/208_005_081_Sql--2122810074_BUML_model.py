...
metamodel_Column.attributes={metamodel_Column_type, metamodel_Column_name, metamodel_Column_size, metamodel_Column_nullable}
...
metamodel_Sequence.attributes={metamodel_Sequence_maxValue, metamodel_Sequence_incrementby, metamodel_Sequence_name, metamodel_Sequence_minValue, metamodel_Sequence_startwith, metamodel_Sequence_cycle, metamodel_Sequence_currentValue}
...
domain_model = DomainModel(
    name="metamodel",
    types={metamodel_Constraint, metamodel_Column, metamodel_Row, metamodel_Database, metamodel_Table, metamodel_Sequence, metamodel_Cell, Datatype, ConstraintType},
    associations={constraints3, columns5, rows7, table0, sequences1, References9, constraints12, cells15, column17},
    generalizations={},
    metadata=None
)
