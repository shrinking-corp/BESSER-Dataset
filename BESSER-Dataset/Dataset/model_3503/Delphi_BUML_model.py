...
# Classes
delphi_mainRule = Class(name="delphi_mainRule")
CSTrace = Class(name="CSTrace")
delphi_file = Class(name="delphi_file")
delphi_ident = Class(name="delphi_ident")
delphi_program = Class(name="delphi_program")
delphi_unit = Class(name="delphi_unit")
delphi_interfaceSection = Class(name="delphi_interfaceSection")
delphi_implementationSection = Class(name="delphi_implementationSection")
delphi_initSection = Class(name="delphi_initSection")
delphi_packageDecl = Class(name="delphi_packageDecl")
delphi_requiresClause = Class(name="delphi_requiresClause")
delphi_containsClause = Class(name="delphi_containsClause")
delphi_library = Class(name="delphi_library")
delphi_usesClause = Class(name="delphi_usesClause")
delphi_block = Class(name="delphi_block")
delphi_interfaceDecl = Class(name="delphi_interfaceDecl")
file = Class(name="file")
delphi_identList = Class(name="delphi_identList")
delphi_programBlock = Class(name="delphi_programBlock")
delphi_directive = Class(name="delphi_directive")
delphi_functionHeading = Class(name="delphi_functionHeading")
delphi_declSection = Class(name="delphi_declSection")
delphi_exportsStmt = Class(name="delphi_exportsStmt")
delphi_compoundStmt = Class(name="delphi_compoundStmt")
delphi_exportsItem = Class(name="delphi_exportsItem")
delphi_constExpr = Class(name="delphi_constExpr")
delphi_labelDeclSection = Class(name="delphi_labelDeclSection")
declSection = Class(name="declSection")
delphi_constSection = Class(name="delphi_constSection")
delphi_constantDecl = Class(name="delphi_constantDecl")
delphi_exportedHeading = Class(name="delphi_exportedHeading")
interfaceDecl = Class(name="interfaceDecl")
delphi_procedureHeading = Class(name="delphi_procedureHeading")
delphi_typeId = Class(name="delphi_typeId")
delphi_typedConstant = Class(name="delphi_typedConstant")
delphi_typeSection = Class(name="delphi_typeSection")
delphi_typeDecl = Class(name="delphi_typeDecl")
delphi_type = Class(name="delphi_type")
delphi_restrictedType = Class(name="delphi_restrictedType")
delphi_arrayConstant = Class(name="delphi_arrayConstant")
delphi_recordConstant = Class(name="delphi_recordConstant")
delphi_recordFieldConstant = Class(name="delphi_recordFieldConstant")
delphi_classRefType = Class(name="delphi_classRefType")
type = Class(name="type")
delphi_simpleType = Class(name="delphi_simpleType")
delphi_realType = Class(name="delphi_realType")
simpleType = Class(name="simpleType")
delphi_ordinalType = Class(name="delphi_ordinalType")
delphi_ordIdent = Class(name="delphi_ordIdent")
ordinalType = Class(name="ordinalType")
delphi_variantType = Class(name="delphi_variantType")
delphi_subrangeType = Class(name="delphi_subrangeType")
delphi_enumeratedType = Class(name="delphi_enumeratedType")
delphi_enumeratedTypeElement = Class(name="delphi_enumeratedTypeElement")
delphi_stringType = Class(name="delphi_stringType")
delphi_strucType = Class(name="delphi_strucType")
delphi_arrayType = Class(name="delphi_arrayType")
strucType = Class(name="strucType")
delphi_recType = Class(name="delphi_recType")
delphi_fieldList = Class(name="delphi_fieldList")
delphi_fieldDecl = Class(name="delphi_fieldDecl")
delphi_variantSection = Class(name="delphi_variantSection")
delphi_recVariant = Class(name="delphi_recVariant")
delphi_setType = Class(name="delphi_setType")
delphi_fileType = Class(name="delphi_fileType")
delphi_varSection = Class(name="delphi_varSection")
delphi_varDecl = Class(name="delphi_varDecl")
delphi_expression = Class(name="delphi_expression")
delphi_simpleExpression = Class(name="delphi_simpleExpression")
expression = Class(name="expression")
delphi_term = Class(name="delphi_term")
simpleExpression = Class(name="simpleExpression")
delphi_factor = Class(name="delphi_factor")
term = Class(name="term")
delphi_designator = Class(name="delphi_designator")
delphi_exprList = Class(name="delphi_exprList")
delphi_pointerType = Class(name="delphi_pointerType")
delphi_procedureType = Class(name="delphi_procedureType")
delphi_relOp = Class(name="delphi_relOp")
delphi_addOp = Class(name="delphi_addOp")
delphi_mulOp = Class(name="delphi_mulOp")
delphi_designatorSubPart = Class(name="delphi_designatorSubPart")
delphi_designatorPart = Class(name="delphi_designatorPart")
delphi_reservedWord = Class(name="delphi_reservedWord")
delphi_setElement = Class(name="delphi_setElement")
delphi_setConstructor = Class(name="delphi_setConstructor")
delphi_statement = Class(name="delphi_statement")
delphi_unlabelledStatement = Class(name="delphi_unlabelledStatement")
delphi_simpleStatement = Class(name="delphi_simpleStatement")
unlabelledStatement = Class(name="unlabelledStatement")
delphi_structStmt = Class(name="delphi_structStmt")
structStmt = Class(name="structStmt")
delphi_conditionalStmt = Class(name="delphi_conditionalStmt")
delphi_ifStmt = Class(name="delphi_ifStmt")
conditionalStmt = Class(name="conditionalStmt")
delphi_caseStmt = Class(name="delphi_caseStmt")
delphi_caseSelector = Class(name="delphi_caseSelector")
delphi_caseLabel = Class(name="delphi_caseLabel")
delphi_stmtList = Class(name="delphi_stmtList")
delphi_loopStmt = Class(name="delphi_loopStmt")
delphi_repeatStmt = Class(name="delphi_repeatStmt")
loopStmt = Class(name="loopStmt")
delphi_whileStmt = Class(name="delphi_whileStmt")
delphi_forStmt = Class(name="delphi_forStmt")
delphi_qualId = Class(name="delphi_qualId")
delphi_withStmt = Class(name="delphi_withStmt")
delphi_tryStmt = Class(name="delphi_tryStmt")
delphi_exceptionBlock = Class(name="delphi_exceptionBlock")
delphi_raiseStmt = Class(name="delphi_raiseStmt")
delphi_assemblerStmt = Class(name="delphi_assemblerStmt")
delphi_procedureDeclSection = Class(name="delphi_procedureDeclSection")
delphi_procedureDecl = Class(name="delphi_procedureDecl")
procedureDeclSection = Class(name="procedureDeclSection")
delphi_functionDecl = Class(name="delphi_functionDecl")
methodHeading = Class(name="methodHeading")
delphi_formalParameters = Class(name="delphi_formalParameters")
delphi_formalParm = Class(name="delphi_formalParm")
delphi_parameter = Class(name="delphi_parameter")
delphi_objectType = Class(name="delphi_objectType")
restrictedType = Class(name="restrictedType")
delphi_objHeritage = Class(name="delphi_objHeritage")
delphi_objFieldList = Class(name="delphi_objFieldList")
delphi_methodList = Class(name="delphi_methodList")
delphi_methodHeading = Class(name="delphi_methodHeading")
delphi_constructorHeading = Class(name="delphi_constructorHeading")
delphi_destructorHeading = Class(name="delphi_destructorHeading")
delphi_classFieldList = Class(name="delphi_classFieldList")
delphi_classMethodList = Class(name="delphi_classMethodList")
delphi_classPropertyList = Class(name="delphi_classPropertyList")
delphi_classField = Class(name="delphi_classField")
delphi_classMethod = Class(name="delphi_classMethod")
delphi_classProperty = Class(name="delphi_classProperty")
delphi_propertyList = Class(name="delphi_propertyList")
delphi_classType = Class(name="delphi_classType")
delphi_classHeritage = Class(name="delphi_classHeritage")
delphi_propertyParameterList = Class(name="delphi_propertyParameterList")
delphi_interfaceType = Class(name="delphi_interfaceType")
delphi_interfaceHeritage = Class(name="delphi_interfaceHeritage")
delphi_propertyInterface = Class(name="delphi_propertyInterface")
delphi_propertySpecifiers = Class(name="delphi_propertySpecifiers")
objFieldList = Class(name="objFieldList")
classHeritage = Class(name="classHeritage")
delphi_unitId = Class(name="delphi_unitId")
pointerType = Class(name="pointerType")
delphi_recordConstExpr = Class(name="delphi_recordConstExpr")
delphi_relExp = Class(name="delphi_relExp")
delphi_addExp = Class(name="delphi_addExp")
delphi_multExp = Class(name="delphi_multExp")
delphi_simpleFactor = Class(name="delphi_simpleFactor")
factor = Class(name="factor")
delphi_adOp = Class(name="delphi_adOp")
addOp = Class(name="addOp")
delphi_assignmentStmnt = Class(name="delphi_assignmentStmnt")
simpleStatement = Class(name="simpleStatement")
delphi_callStmnt = Class(name="delphi_callStmnt")
delphi_gotoStmnt = Class(name="delphi_gotoStmnt")
delphi_parameterList = Class(name="delphi_parameterList")
parameter = Class(name="parameter")
delphi_parameterSimple = Class(name="delphi_parameterSimple")
delphi_MultipleId = Class(name="delphi_MultipleId")
ident = Class(name="ident")
delphi_ReservedId = Class(name="delphi_ReservedId")
delphi_MineID = Class(name="delphi_MineID")
delphi_ConstExp = Class(name="delphi_ConstExp")
constExpr = Class(name="constExpr")
delphi_MultipleConstExp = Class(name="delphi_MultipleConstExp")
delphi_RecordConstExp = Class(name="delphi_RecordConstExp")
delphi_CSTrace = Class(name="delphi_CSTrace", is_abstract=True)
delphi_Visitable = Class(name="delphi_Visitable")
delphi_inheritedStamnt = Class(name="delphi_inheritedStamnt")
...
delphi_factor.attributes={delphi_factor_number, delphi_factor_string}
...
delphi_designatorPart.attributes={delphi_designatorPart_id, delphi_designatorPart_id2}
...
delphi_raiseStmt_raise_: Property = Property(name="raise_", type=StringType)
delphi_raiseStmt_at: Property = Property(name="at", type=StringType)
delphi_raiseStmt.attributes={delphi_raiseStmt_at, delphi_raiseStmt_raise_}
...
else_212: BinaryAssociation = BinaryAssociation(
    name="else_212",
    ends={
...
if_441: BinaryAssociation = BinaryAssociation(
    name="if_441",
    ends={
...
domain_model = DomainModel(
    name="delphi",
    types={delphi_mainRule, CSTrace, delphi_file, delphi_ident, delphi_program, delphi_unit, delphi_interfaceSection, delphi_implementationSection, delphi_initSection, delphi_packageDecl, delphi_requiresClause, delphi_containsClause, delphi_library, delphi_usesClause, delphi_block, delphi_interfaceDecl, file, delphi_identList, delphi_programBlock, delphi_directive, delphi_functionHeading, delphi_declSection, delphi_exportsStmt, delphi_compoundStmt, delphi_exportsItem, delphi_constExpr, delphi_labelDeclSection, declSection, delphi_constSection, delphi_constantDecl, delphi_exportedHeading, interfaceDecl, delphi_procedureHeading, delphi_typeId, delphi_typedConstant, delphi_typeSection, delphi_typeDecl, delphi_type, delphi_restrictedType, delphi_arrayConstant, delphi_recordConstant, delphi_recordFieldConstant, delphi_classRefType, type, delphi_simpleType, delphi_realType, simpleType, delphi_ordinalType, delphi_ordIdent, ordinalType, delphi_variantType, delphi_subrangeType, delphi_enumeratedType, delphi_enumeratedTypeElement, delphi_stringType, delphi_strucType, delphi_arrayType, strucType, delphi_recType, delphi_fieldList, delphi_fieldDecl, delphi_variantSection, delphi_recVariant, delphi_setType, delphi_fileType, delphi_varSection, delphi_varDecl, delphi_expression, delphi_simpleExpression, expression, delphi_term, simpleExpression, delphi_factor, term, delphi_designator, delphi_exprList, delphi_pointerType, delphi_procedureType, delphi_relOp, delphi_addOp, delphi_mulOp, delphi_designatorSubPart, delphi_designatorPart, delphi_reservedWord, delphi_setElement, delphi_setConstructor, delphi_statement, delphi_unlabelledStatement, delphi_simpleStatement, unlabelledStatement, delphi_structStmt, structStmt, delphi_conditionalStmt, delphi_ifStmt, conditionalStmt, delphi_caseStmt, delphi_caseSelector, delphi_caseLabel, delphi_stmtList, delphi_loopStmt, delphi_repeatStmt, loopStmt, delphi_whileStmt, delphi_forStmt, delphi_qualId, delphi_withStmt, delphi_tryStmt, delphi_exceptionBlock, delphi_raiseStmt, delphi_assemblerStmt, delphi_procedureDeclSection, delphi_procedureDecl, procedureDeclSection, delphi_functionDecl, methodHeading, delphi_formalParameters, delphi_formalParm, delphi_parameter, delphi_objectType, restrictedType, delphi_objHeritage, delphi_objFieldList, delphi_methodList, delphi_methodHeading, delphi_constructorHeading, delphi_destructorHeading, delphi_classFieldList, delphi_classMethodList, delphi_classPropertyList, delphi_classField, delphi_classMethod, delphi_classProperty, delphi_propertyList, delphi_classType, delphi_classHeritage, delphi_propertyParameterList, delphi_interfaceType, delphi_interfaceHeritage, delphi_propertyInterface, delphi_propertySpecifiers, objFieldList, classHeritage, delphi_unitId, pointerType, delphi_recordConstExpr, delphi_relExp, delphi_addExp, delphi_multExp, delphi_simpleFactor, factor, delphi_adOp, addOp, delphi_assignmentStmnt, simpleStatement, delphi_callStmnt, delphi_gotoStmnt, delphi_parameterList, parameter, delphi_parameterSimple, delphi_MultipleId, ident, delphi_ReservedId, delphi_MineID, delphi_ConstExp, constExpr, delphi_MultipleConstExp, delphi_RecordConstExp, delphi_CSTrace, delphi_Visitable, delphi_inheritedStamnt},
    associations={file0, id1, interfaceSect6, implementationSect7, initSect9, requires11, contains12, pBlock14, uses16, block18, idList20, uses23, interfaceDecl26, paramsList3, block4, directive29, fHeading31, uses33, declSect36, exports38, declSect40, exports43, compound46, id48, constExp50, items52, pHeading28, const59, typeRef62, typedConstat64, typeDecl66, id67, type70, restrictedType72, const74, array77, record79, typedConstant81, recordField84, constantDecl55, id56, typeRef92, first94, last96, element99, id100, literalExp103, constExp106, ordinalType108, id86, typedConstant89, fields115, field116, variantSect118, idList120, type123, id126, typeRef129, recVariants132, constExp134, fieldList137, ordinal140, typeRef142, ordinalTyp109, type112, fHeading146, varDecls149, idList150, type153, absId156, absConst159, absIniti162, designator165, expList166, nestedExp168, exp170, pHeading144, subpart178, designator181, part183, exprList185, reservedWord188, element190, first192, last195, setConstuctor173, typeRef175, statments201, statement202, stamtList204, condition207, then209, else_212, expression215, cases217, default219, exps198, first227, last230, stmt233, condition235, varId238, varInit239, vars242, stmt244, stmtList247, exception249, final251, labels222, stmt224, doStmt260, elseStmts263, directive266, block268, heading271, heading273, type275, params278, param279, exceptionId254, type257, messageExp284, heritage287, fieldList288, methodList290, id292, heading295, directive297, id300, formalParams303, stmtList306, endStmtList309, type281, fieldList313, methodList315, propList317, field319, fieldList321, metod324, methodList326, property329, propList331, id333, heritage312, paramList340, id342, idList345, typeRef348, index351, readId354, writeId357, storeId360, storeExp363, defaulExp366, implement369, heritage372, methodList373, interface336, specifiers338, idList382, idList385, type388, ids391, unitId394, id396, unitId399, id402, id405, propList376, idList379, left410, relOp412, right414, left416, addOp418, right420, left422, multOp424, right426, designator429, exp431, designator434, constExp407, idList439, if_441, initExp443, reservedWord446, exp448, exps450, exps452, ast454, args436},
    generalizations={gen_delphi_mainRule_CSTrace, gen_delphi_file_CSTrace, gen_delphi_unit_file, gen_delphi_packageDecl_file, gen_delphi_library_file, gen_delphi_programBlock_CSTrace, gen_delphi_usesClause_CSTrace, gen_delphi_interfaceSection_CSTrace, gen_delphi_program_file, gen_delphi_interfaceDecl_CSTrace, gen_delphi_implementationSection_CSTrace, gen_delphi_block_CSTrace, gen_delphi_exportsItem_CSTrace, gen_delphi_exportsStmt_CSTrace, gen_delphi_declSection_CSTrace, gen_delphi_labelDeclSection_declSection, gen_delphi_constSection_interfaceDecl, gen_delphi_constSection_declSection, gen_delphi_exportedHeading_interfaceDecl, gen_delphi_typeSection_interfaceDecl, gen_delphi_typeSection_declSection, gen_delphi_typeDecl_CSTrace, gen_delphi_typedConstant_CSTrace, gen_delphi_arrayConstant_CSTrace, gen_delphi_recordConstant_CSTrace, gen_delphi_recordFieldConstant_CSTrace, gen_delphi_constantDecl_CSTrace, gen_delphi_type_CSTrace, gen_delphi_restrictedType_CSTrace, gen_delphi_classRefType_type, gen_delphi_simpleType_type, gen_delphi_realType_simpleType, gen_delphi_ordinalType_simpleType, gen_delphi_ordIdent_ordinalType, gen_delphi_variantType_type, gen_delphi_subrangeType_ordinalType, gen_delphi_enumeratedType_ordinalType, gen_delphi_enumeratedTypeElement_CSTrace, gen_delphi_stringType_type, gen_delphi_strucType_type, gen_delphi_arrayType_strucType, gen_delphi_recType_strucType, gen_delphi_fieldList_CSTrace, gen_delphi_fieldDecl_CSTrace, gen_delphi_variantSection_CSTrace, gen_delphi_recVariant_CSTrace, gen_delphi_setType_strucType, gen_delphi_fileType_strucType, gen_delphi_varSection_interfaceDecl, gen_delphi_varSection_declSection, gen_delphi_varDecl_CSTrace, gen_delphi_expression_CSTrace, gen_delphi_simpleExpression_expression, gen_delphi_term_simpleExpression, gen_delphi_factor_term, gen_delphi_pointerType_type, gen_delphi_procedureType_type, gen_delphi_relOp_CSTrace, gen_delphi_addOp_CSTrace, gen_delphi_mulOp_CSTrace, gen_delphi_designator_CSTrace, gen_delphi_designatorSubPart_CSTrace, gen_delphi_designatorPart_CSTrace, gen_delphi_setConstructor_CSTrace, gen_delphi_setElement_CSTrace, gen_delphi_exprList_CSTrace, gen_delphi_statement_CSTrace, gen_delphi_unlabelledStatement_CSTrace, gen_delphi_simpleStatement_unlabelledStatement, gen_delphi_structStmt_unlabelledStatement, gen_delphi_compoundStmt_structStmt, gen_delphi_conditionalStmt_structStmt, gen_delphi_ifStmt_conditionalStmt, gen_delphi_caseStmt_conditionalStmt, gen_delphi_caseSelector_CSTrace, gen_delphi_stmtList_CSTrace, gen_delphi_caseLabel_CSTrace, gen_delphi_loopStmt_structStmt, gen_delphi_repeatStmt_loopStmt, gen_delphi_whileStmt_loopStmt, gen_delphi_forStmt_loopStmt, gen_delphi_withStmt_structStmt, gen_delphi_tryStmt_structStmt, gen_delphi_exceptionBlock_CSTrace, gen_delphi_raiseStmt_structStmt, gen_delphi_assemblerStmt_structStmt, gen_delphi_procedureDeclSection_declSection, gen_delphi_procedureDecl_procedureDeclSection, gen_delphi_functionDecl_procedureDeclSection, gen_delphi_functionHeading_methodHeading, gen_delphi_procedureHeading_methodHeading, gen_delphi_formalParameters_CSTrace, gen_delphi_formalParm_CSTrace, gen_delphi_objectType_restrictedType, gen_delphi_objHeritage_CSTrace, gen_delphi_methodList_CSTrace, gen_delphi_methodHeading_CSTrace, gen_delphi_constructorHeading_methodHeading, gen_delphi_destructorHeading_methodHeading, gen_delphi_objFieldList_CSTrace, gen_delphi_initSection_CSTrace, gen_delphi_parameter_CSTrace, gen_delphi_directive_CSTrace, gen_delphi_classHeritage_CSTrace, gen_delphi_classFieldList_CSTrace, gen_delphi_classField_CSTrace, gen_delphi_classMethodList_CSTrace, gen_delphi_classMethod_CSTrace, gen_delphi_classPropertyList_CSTrace, gen_delphi_classProperty_CSTrace, gen_delphi_propertyList_CSTrace, gen_delphi_classType_restrictedType, gen_delphi_propertyInterface_CSTrace, gen_delphi_propertyParameterList_CSTrace, gen_delphi_propertySpecifiers_CSTrace, gen_delphi_interfaceType_restrictedType, gen_delphi_requiresClause_CSTrace, gen_delphi_containsClause_CSTrace, gen_delphi_identList_objFieldList, gen_delphi_identList_classHeritage, gen_delphi_qualId_CSTrace, gen_delphi_typeId_type, gen_delphi_typeId_pointerType, gen_delphi_ident_CSTrace, gen_delphi_reservedWord_CSTrace, gen_delphi_constExpr_CSTrace, gen_delphi_recordConstExpr_CSTrace, gen_delphi_interfaceHeritage_CSTrace, gen_delphi_relExp_expression, gen_delphi_addExp_simpleExpression, gen_delphi_multExp_term, gen_delphi_simpleFactor_factor, gen_delphi_adOp_addOp, gen_delphi_assignmentStmnt_simpleStatement, gen_delphi_callStmnt_simpleStatement, gen_delphi_unitId_CSTrace, gen_delphi_gotoStmnt_simpleStatement, gen_delphi_parameterList_parameter, gen_delphi_parameterSimple_parameter, gen_delphi_MultipleId_ident, gen_delphi_ReservedId_ident, gen_delphi_MineID_ident, gen_delphi_ConstExp_constExpr, gen_delphi_MultipleConstExp_constExpr, gen_delphi_RecordConstExp_constExpr, gen_delphi_inheritedStamnt_simpleStatement},
    metadata=None
)
