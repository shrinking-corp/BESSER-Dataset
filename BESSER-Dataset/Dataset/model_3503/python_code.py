...
class delphi_classType(restrictedType):
    ...
    def __init__(self, visibility: str, delphi_classType314: "delphi_classFieldList" = None, delphi_classType316: "delphi_classMethodList" = None, delphi_classType318: "delphi_classPropertyList" = None, delphi_classType: "delphi_classHeritage" = None):
        self.visibility = visibility
...
class delphi_raiseStmt(structStmt):
    ...
    def __init__(self, raise_: str, at: str):
        self.raise_ = raise_
        self.at = at
    ...
    @property
    def raise_(self):
        return self.__raise_

    @raise_.setter
    def raise_(self, raise_: str):
        self.__raise_ = raise_
...
class delphi_statement(CSTrace):
    ...
    def __init__(self, labelId: str, delphi_statement: "delphi_stmtList" = None, delphi_statement203: "delphi_unlabelledStatement" = None, delphi_statement211: "delphi_ifStmt" = None, delphi_statement214: "delphi_ifStmt" = None, delphi_statement234: "delphi_loopStmt" = None, delphi_statement226: "delphi_caseSelector" = None, delphi_statement262: "delphi_exceptionBlock" = None, delphi_statement246: "delphi_withStmt" = None):
...
class delphi_factor(term):
    ...
    def __init__(self, number: str, string: str, delphi_factor: "delphi_designator" = None, delphi_factor167: "delphi_exprList" = None, delphi_factor169: "delphi_expression" = None, delphi_factor171: "delphi_expression" = None, delphi_factor174: "delphi_setConstructor" = None, delphi_factor176: "delphi_typeId" = None, delphi_factor428: "delphi_multExp" = None):
        self.number = number
        self.string = string
...
class delphi_typedConstant(CSTrace):
    ...
    pass
class delphi_typeId(type, pointerType):
...
class delphi_constantDecl(CSTrace):
    ...
    def __init__(self, port: str, delphi_constantDecl60: "delphi_constExpr" = None, delphi_constantDecl63: "delphi_typeId" = None, delphi_constantDecl: "delphi_constSection" = None, delphi_constantDecl57: "delphi_ident" = None, delphi_constantDecl65: "delphi_typedConstant" = None):
        self.port = port
...
class declSection:
    ...
    pass
class delphi_varSection(interfaceDecl, declSection):

    pass
class delphi_constSection(interfaceDecl, declSection):
...
class delphi_typeSection(interfaceDecl, declSection):
