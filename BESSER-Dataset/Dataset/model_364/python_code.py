...
class eiqlibrary_Writer:
    ...
    def __init__(self, name: str, Writer: "eiqlibrary_Book" = None, authors: set["eiqlibrary_Book"] = None, eiqlibrary_Writer9: "eiqlibrary_Book" = None, eiqlibrary_Writer12: set["eiqlibrary_Book"] = None, eiqlibrary_Writer: "eiqlibrary_Library" = None):
        self.name = name
        self.Writer = Writer
...
class eiqlibrary_Library:
    ...
    def __init__(self, internalRequestCount: int, requestCount: int, address: str, sumOfPages: int, eiqlibrary_Library2: set["eiqlibrary_Book"] = None, eiqlibrary_Library4: set["eiqlibrary_Book"] = None, eiqlibrary_Library: set["eiqlibrary_Writer"] = None):
...
class eiqlibrary_Book:
    ...
    def __init__(self, title: str, pages: int, category: str, eiqlibrary_Book: "eiqlibrary_Library" = None, eiqlibrary_Book5: "eiqlibrary_Library" = None, books: set["eiqlibrary_Writer"] = None, Book: "eiqlibrary_Writer" = None, eiqlibrary_Book10: "eiqlibrary_Writer" = None, eiqlibrary_Book13: "eiqlibrary_Writer" = None):
        self.title = title
        self.pages = pages
