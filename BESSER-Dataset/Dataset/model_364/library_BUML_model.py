...
# Classes
eiqlibrary_Book = Class(name="eiqlibrary_Book")
eiqlibrary_Library = Class(name="eiqlibrary_Library")
eiqlibrary_Writer = Class(name="eiqlibrary_Writer")
...
eiqlibrary_Library.attributes={eiqlibrary_Library_internalRequestCount, eiqlibrary_Library_requestCount, eiqlibrary_Library_address, eiqlibrary_Library_sumOfPages}
...
domain_model = DomainModel(
    name="eiqlibrary",
    types={eiqlibrary_Book, eiqlibrary_Library, eiqlibrary_Writer, BookCategory},
    associations={books1, someBooks3, authors6, books7, firstBook8, scifiBooks11, writers0},
    generalizations={},
    metadata=None
)
