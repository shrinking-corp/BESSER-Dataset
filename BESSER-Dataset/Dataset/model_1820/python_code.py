...
class doc_map_PatternRule(NameRule):
    ...
    def __init__(self, pattern: str, NameRule: "doc_map_Feature" = None):
...
class map_MapElement:
    ...
    pass
class doc_map_ContentGenerator(map_MapElement, fragment_Content):

    pass
class map_MapContainer:

    pass
class doc_map_MapSection(map_MapContainer, map_MapElement):
...
class doc_builder_BookBuilder(Map):
    ...
    def __init__(self, copyrightMarker: str, title: str, version: str, license: str, doc_builder_BookBuilder19: set["Copyright"] = None, doc_builder_BookBuilder22: set["builder_PropertyEntry"] = None, doc_builder_BookBuilder: set["Author"] = None):
...
class doc_fragment_PlainTextContent(Content):
    ...
    def __init__(self, value: str, Content13: "doc_book_BookContainer" = None, Content: "doc_fragment_Container" = None):
        self.value = value
