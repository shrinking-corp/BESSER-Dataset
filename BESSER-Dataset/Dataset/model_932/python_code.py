...
class uma_WorkProductDescriptor(Descriptor):
    ...
    def __init__(self, activityEntryState: str, activityExitState: str, WorkProductDescriptor178: "uma_TaskDescriptor" = None, WorkProductDescriptor180: "uma_TaskDescriptor" = None, uma_WorkProductDescriptor: "uma_WorkProduct" = None, WorkProductDescriptor: "uma_RoleDescriptor" = None, WorkProductDescriptor164: "uma_RoleDescriptor" = None, WorkProductDescriptor192: "uma_WorkProductDescriptor" = None, impacts: set["uma_WorkProductDescriptor"] = None, WorkProductDescriptor195: "uma_WorkProductDescriptor" = None, impactedBy: set["uma_WorkProductDescriptor"] = None, mandatoryInput: set["uma_TaskDescriptor"] = None, WorkProductDescriptor174: "uma_TaskDescriptor" = None, WorkProductDescriptor176: "uma_TaskDescriptor" = None, externalInput: set["uma_TaskDescriptor"] = None, modifies: set["uma_RoleDescriptor"] = None, optionalInput: set["uma_TaskDescriptor"] = None, output: set["uma_TaskDescriptor"] = None, uma_WorkProductDescriptor206: "uma_WorkProductDescriptor" = None, uma_WorkProductDescriptor204: set["uma_WorkProductDescriptor"] = None, responsibleFor: "uma_RoleDescriptor" = None, uma_WorkProductDescriptor273: "uma_ProcessComponentInterface" = None):
...
class uma_WorkBreakdownElement(BreakdownElement):
    ...
    def __init__(self, isEventDriven: str, isRepeatable: str, isOngoing: str, uma_WorkBreakdownElement: set["uma_WorkOrder"] = None, uma_WorkBreakdownElement167: "uma_WorkOrder" = None):
...
class uma_Diagram(GraphNode):
    ...
    def __init__(self, zoom: str, uma_Diagram: "uma_Point" = None, diagram: set["uma_DiagramLink"] = None, diagram109: "uma_SemanticModelBridge" = None, Diagram97: "uma_SemanticModelBridge" = None, Diagram: "uma_DiagramLink" = None, uma_Diagram267: "uma_ProcessPackage" = None):
        self.zoom = zoom
...
class uma_Point:
    ...
    def __init__(self, y: str, x: str, uma_Point103: "uma_GraphEdge" = None, uma_Point105: "uma_Diagram" = None, uma_Point: "uma_GraphElement" = None, uma_Point87: "uma_DiagramLink" = None, uma_Point116: "uma_Polyline" = None, uma_Point118: "uma_Ellipse" = None):
        self.y = y
        self.x = x
...
class uma_Reference(DiagramElement):
    ...
    def __init__(self, isIndividualRepresentation: str, reference: "uma_DiagramElement" = None, Reference: "uma_DiagramElement" = None):
        ...
        pass
    @property
    def isIndividualRepresentation(self):
...
class uma_DiagramLink(DiagramElement):
    ...
    def __init__(self, zoom: str, DiagramLink107: "uma_Diagram" = None, DiagramLink: "uma_GraphElement" = None, uma_DiagramLink: "uma_Point" = None, link: "uma_GraphElement" = None, diagramLink: "uma_Diagram" = None):
        self.zoom = zoom
...
class uma_SemanticModelBridge(DiagramElement):
    ...
    def __init__(self, presentation: str, SemanticModelBridge110: "uma_Diagram" = None, namespace: "uma_Diagram" = None, SemanticModelBridge: "uma_GraphElement" = None, semanticModel: "uma_GraphElement" = None):
...
class uma_WorkProductDescription(ContentDescription):
    ...
    def __init__(self, reasonsForNotNeeding: str, externalId: str, purpose: str, impactOfNotHaving: str):
...
class uma_MethodPlugin(MethodUnit, Package):
    ...
    def __init__(self, userChangeable: str, uma_MethodPlugin305: "uma_MethodLibrary" = None, uma_MethodPlugin289: "uma_MethodConfiguration" = None, uma_MethodPlugin: set["uma_MethodPackage"] = None, uma_MethodPlugin280: "uma_MethodPlugin" = None, uma_MethodPlugin278: set["uma_MethodPlugin"] = None):
...
class uma_Activity(WorkDefinition, WorkBreakdownElement, VariabilityElement):
...
class uma_MethodPackage(MethodElement, Package):
    ...
    def __init__(self, global_: str, uma_MethodPackage: "uma_MethodPackage" = None, uma_MethodPackage67: set["uma_MethodPackage"] = None, MethodPackage: "uma_MethodPackage" = None, childPackages: "uma_MethodPackage" = None, MethodPackage73: "uma_MethodPackage" = None, parentPackage: set["uma_MethodPackage"] = None, uma_MethodPackage292: "uma_MethodConfiguration" = None, uma_MethodPackage277: "uma_MethodPlugin" = None):
...
class uma_DescribableElement(MethodElement, Classifier):
    ...
    def __init__(self, shapeicon: str, presentationName: str, nodeicon: str, uma_DescribableElement: "uma_ContentDescription" = None, uma_DescribableElement244: "uma_CustomCategory" = None):
...
class uma_DiagramElement(MethodElement):
    ...
    def __init__(self, isVisible: str, DiagramElement99: "uma_Reference" = None, DiagramElement: "uma_GraphElement" = None, contained: "uma_GraphElement" = None, referenced: set["uma_Reference"] = None, uma_DiagramElement: set["uma_Property"] = None):
...
class uma_MethodElement(PackageableElement):
    ...
    def __init__(self, briefDescription: str, guid: str, suppressed: str, orderingGuide: str, uma_MethodElement: set["uma_Constraint"] = None, uma_MethodElement113: "uma_UMASemanticModelBridge" = None):
