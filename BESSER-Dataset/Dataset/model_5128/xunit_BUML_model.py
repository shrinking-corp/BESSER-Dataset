...
# Classes
xunit_NamedElement = Class(name="xunit_NamedElement")
xunit_TestSuite = Class(name="xunit_TestSuite")
NamedElement = Class(name="NamedElement")
xunit_TestCase = Class(name="xunit_TestCase")
xunit_Assertion = Class(name="xunit_Assertion")
xunit_ExpectedValue = Class(name="xunit_ExpectedValue")
xunit_Action = Class(name="xunit_Action")
xunit_DataValue = Class(name="xunit_DataValue")
...
domain_model = DomainModel(
    name="xunit",
    types={xunit_NamedElement, xunit_TestSuite, NamedElement, xunit_TestCase, xunit_Assertion, xunit_ExpectedValue, xunit_Action, xunit_DataValue, DataValue},
    associations={testCase0, assertion1, testSuite3, expectedValue6, action8, testCase10, assertion13},
    generalizations={gen_xunit_TestSuite_NamedElement, gen_xunit_TestCase_NamedElement, gen_xunit_Assertion_NamedElement, gen_xunit_ExpectedValue_DataValue},
    metadata=None
)
