...
class tfsm_FSMEvent(NamedElement):
    ...
    def __init__(self, isTriggered: str, tfsm_FSMEvent: "tfsm_TFSM" = None, tfsm_FSMEvent23: "tfsm_Transition" = None, tfsm_FSMEvent38: "tfsm_TimedSystem" = None, tfsm_FSMEvent27: "tfsm_EventGuard" = None, tfsm_FSMEvent29: set["tfsm_Transition"] = None):
...
class tfsm_Transition(NamedElement):
    ...
    def __init__(self, action: str, tfsm_Transition: "tfsm_TFSM" = None, Transition: "tfsm_State" = None, Transition14: "tfsm_State" = None, outgoingTransitions: "tfsm_State" = None, incomingTransitions: "tfsm_State" = None, tfsm_Transition20: "tfsm_Guard" = None, tfsm_Transition22: set["tfsm_FSMEvent"] = None, tfsm_Transition30: "tfsm_FSMEvent" = None):
        self.action = action
...
class tfsm_State(NamedElement):
    ...
    def __init__(self, State: "tfsm_TFSM" = None, tfsm_State: "tfsm_TFSM" = None, tfsm_State10: "tfsm_TFSM" = None, ownedStates: "tfsm_TFSM" = None, source: set["tfsm_Transition"] = None, target: set["tfsm_Transition"] = None, State16: "tfsm_Transition" = None, State18: "tfsm_Transition" = None):
        self.State = State
...
class tfsm_TFSM(NamedElement):
    ...
    def __init__(self, stepNumber: int, lastStateChangeStepNumber: int, owningFSM: set["tfsm_State"] = None, tfsm_TFSM: "tfsm_State" = None, tfsm_TFSM3: set["tfsm_FSMEvent"] = None, tfsm_TFSM5: "tfsm_FSMClock" = None, tfsm_TFSM7: set["tfsm_Transition"] = None, tfsm_TFSM9: "tfsm_State" = None, TFSM: "tfsm_State" = None, tfsm_TFSM32: "tfsm_TimedSystem" = None):
