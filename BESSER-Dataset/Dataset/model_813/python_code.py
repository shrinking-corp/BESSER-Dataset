...
class fsm_State(NamedElement):
    ...
    def __init__(self, State: "fsm_StateMachine" = None, fsm_State: "fsm_StateMachine" = None, fsm_State6: "fsm_StateMachine" = None, ownedStates: "fsm_StateMachine" = None, source: set["fsm_Transition"] = None, target: set["fsm_Transition"] = None, State12: "fsm_Transition" = None, State14: "fsm_Transition" = None):
        self.State = State
...
class fsm_StateMachine(NamedElement):
    ...
    def __init__(self, unprocessedString: str, consummedString: str, producedString: str, owningFSM: set["fsm_State"] = None, fsm_StateMachine: "fsm_State" = None, fsm_StateMachine3: set["fsm_Transition"] = None, fsm_StateMachine5: "fsm_State" = None, StateMachine: "fsm_State" = None, fsm_StateMachine16: "fsm_FSMSystem" = None, fsm_StateMachine21: "fsm_Buffer" = None, fsm_StateMachine24: "fsm_Buffer" = None):
