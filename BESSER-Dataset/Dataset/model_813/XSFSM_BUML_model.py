...
domain_model = DomainModel(
    name="fsm",
    types={fsm_StateMachine, NamedElement, fsm_NamedElement, fsm_State, fsm_Transition, fsm_FSMSystem, fsm_Buffer},
    associations={ownedStates0, initialState1, ownedTransitions2, currentState4, owningFSM7, outgoingTransitions8, incomingTransitions9, source11, target13, ownedStateMachines15, ownedBuffer17, inputs19, outputs22},
