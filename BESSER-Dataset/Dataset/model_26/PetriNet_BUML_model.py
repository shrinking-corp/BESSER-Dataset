...
domain_model = DomainModel(
    name="PetriNet",
    types={Node, PetriNet_PetriNet, PetriNet_Node, PetriNet_Arc, PetriNet_Transition, PetriNet_Place, ArcKind},
    associations={net3, nodes0, arcs1, outgoings4, incomings6, target8, source10, net12},
