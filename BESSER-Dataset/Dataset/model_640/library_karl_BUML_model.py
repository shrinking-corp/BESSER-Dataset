...
library_Magazine = Class(name="library_Magazine")
...
domain_model = DomainModel(
    name="library",
    types={library_Library, library_Magazine, library_Borrowable, library_Customer, library_Author, library_Book, library_CD, Borrowable},
    associations={authors11, borrowables0, customers1, authors2, borrowed4, library6, writtenBooks7, library8},
    generalizations={gen_library_Magazine_Borrowable, gen_library_Book_Borrowable, gen_library_CD_Borrowable},
    metadata=None
)
