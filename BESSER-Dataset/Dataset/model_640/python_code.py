...
class library_Author:
    ...
    def __init__(self, name: str, Author12: "library_Book" = None, Author: "library_Library" = None, authors: set["library_Book"] = None, authors9: "library_Library" = None):
        self.name = name
...
class library_Library:
    ...
    def __init__(self, address: str, library: set["library_Borrowable"] = None, library_Library: set["library_Customer"] = None, library3: set["library_Author"] = None, Library: "library_Borrowable" = None, Library10: "library_Author" = None):
