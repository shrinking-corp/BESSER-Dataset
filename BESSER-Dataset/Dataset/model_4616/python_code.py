...
class viewpoint_description_EAttributeCustomization(EStructuralFeatureCustomization):
    ...
    def __init__(self, attributeName: str, value: str, EStructuralFeatureCustomization: "viewpoint_description_VSMElementCustomization" = None, EStructuralFeatureCustomization98: "viewpoint_description_VSMElementCustomizationReuse" = None):
...
class viewpoint_tool_ExternalJavaAction(tool_ContainerModelOperation, tool_MenuItemDescription):
    ...
    def __init__(self, id: str, viewpoint_tool_ExternalJavaAction: set["tool_ExternalJavaActionParameter"] = None, tool_MenuItemDescription188: "viewpoint_tool_PopupMenu" = None, tool_MenuItemDescription: "viewpoint_tool_MenuItemDescriptionReference" = None):
        self.id = id
...
class viewpoint_tool_SelectionWizardDescription(description_SelectionDescription, tool_AbstractToolDescription):
    ...
    def __init__(self, iconPath: str, windowTitle: str, windowImagePath: str, viewpoint_tool_SelectionWizardDescription145: "tool_InitialOperation" = None, viewpoint_tool_SelectionWizardDescription: "tool_ElementSelectVariable" = None, viewpoint_tool_SelectionWizardDescription140: "tool_ContainerViewVariable" = None, viewpoint_tool_SelectionWizardDescription143: "tool_SelectContainerVariable" = None):
...
class viewpoint_tool_ToolDescription(MappingBasedToolDescription):
    ...
    def __init__(self, iconPath: str, viewpoint_tool_ToolDescription123: "tool_ElementViewVariable" = None, viewpoint_tool_ToolDescription125: "tool_InitialOperation" = None, viewpoint_tool_ToolDescription: "tool_ElementVariable" = None):
        self.iconPath = iconPath
...
class viewpoint_tool_PaneBasedSelectionWizardDescription(AbstractToolDescription):
    ...
    def __init__(self, iconPath: str, choiceOfValuesMessage: str, candidatesExpression: str, tree: bool, rootExpression: str, childrenExpression: str, selectedValuesMessage: str, preSelectedCandidatesExpression: str, windowTitle: str, windowImagePath: str, message: str, viewpoint_tool_PaneBasedSelectionWizardDescription: "tool_ElementSelectVariable" = None, viewpoint_tool_PaneBasedSelectionWizardDescription150: "tool_ContainerViewVariable" = None, viewpoint_tool_PaneBasedSelectionWizardDescription153: "tool_SelectContainerVariable" = None, viewpoint_tool_PaneBasedSelectionWizardDescription156: "tool_InitialOperation" = None):
        self.iconPath = iconPath
...
class viewpoint_tool_RepresentationCreationDescription(AbstractToolDescription):
    ...
    def __init__(self, browseExpression: str, titleExpression: str, viewpoint_tool_RepresentationCreationDescription: "RepresentationDescription" = None, viewpoint_tool_RepresentationCreationDescription161: "tool_InitialOperation" = None, viewpoint_tool_RepresentationCreationDescription164: "tool_ContainerViewVariable" = None, viewpoint_tool_RepresentationCreationDescription167: "tool_NameVariable" = None):
        self.browseExpression = browseExpression
...
class viewpoint_tool_RepresentationNavigationDescription(AbstractToolDescription):
    ...
    def __init__(self, browseExpression: str, navigationNameExpression: str, viewpoint_tool_RepresentationNavigationDescription174: "tool_ElementSelectVariable" = None, viewpoint_tool_RepresentationNavigationDescription: "RepresentationDescription" = None, viewpoint_tool_RepresentationNavigationDescription171: "tool_ContainerViewVariable" = None, viewpoint_tool_RepresentationNavigationDescription177: "tool_NameVariable" = None):
        self.browseExpression = browseExpression
...
class viewpoint_description_SelectionDescription(ABC):
    ...
    def __init__(self, multiple: bool, tree: bool, rootExpression: str, childrenExpression: str, message: str, candidatesExpression: str):
...
class viewpoint_description_EReferenceCustomization(EStructuralFeatureCustomization):
    ...
    def __init__(self, referenceName: str, viewpoint_description_EReferenceCustomization: "description_viewpoint_EObject" = None, EStructuralFeatureCustomization: "viewpoint_description_VSMElementCustomization" = None, EStructuralFeatureCustomization98: "viewpoint_description_VSMElementCustomizationReuse" = None):
        self.referenceName = referenceName
...
class viewpoint_description_ComputedColor(description_ColorDescription, description_UserColor):
    ...
    def __init__(self, green: str, blue: str, red: str):
        self.green = green
        self.blue = blue
        self.red = red
...
class viewpoint_DAnalysisSessionEObject:
    ...
    def __init__(self, synchronizationStatus: str, open: bool, blocked: bool, resources: str, controlledResources: str, viewpoint_DAnalysisSessionEObject55: set["viewpoint_DAnalysis"] = None, viewpoint_DAnalysisSessionEObject58: "viewpoint_SessionManagerEObject" = None, viewpoint_DAnalysisSessionEObject: set["Viewpoint"] = None):
...
class viewpoint_DSourceFileLink(DNavigationLink):
    ...
    def __init__(self, startPosition: int, endPosition: int, filePath: str):
...
class viewpoint_description_SemanticBasedDecoration(DecorationDescription):
    ...
    def __init__(self, domainClass: str, DecorationDescription94: "viewpoint_description_DecorationDescriptionsSet" = None, DecorationDescription: "viewpoint_Decoration" = None):
        self.domainClass = domainClass
...
class viewpoint_description_Group(description_DModelElement, description_DocumentedElement):
    ...
    def __init__(self, version: str, name: str, viewpoint_description_Group66: set["UserColorsPalette"] = None, viewpoint_description_Group: set["Viewpoint"] = None, viewpoint_description_Group64: "SytemColorsPalette" = None):
...
class viewpoint_DRepresentation(description_DModelElement, description_DocumentedElement, DRefreshable):
    ...
    def __init__(self, name: str, viewpoint_DRepresentation22: set["viewpoint_DRepresentationElement"] = None, viewpoint_DRepresentation25: set["AnnotationEntry"] = None, viewpoint_DRepresentation: set["viewpoint_DRepresentationElement"] = None, viewpoint_DRepresentation39: "viewpoint_DView" = None, viewpoint_DRepresentation42: "viewpoint_DView" = None, viewpoint_DRepresentation31: "viewpoint_DView" = None, viewpoint_DRepresentation36: "viewpoint_DView" = None):
        self.name = name
...
class viewpoint_DRepresentationElement(DRefreshable, DLabelled, DMappingBased, DSemanticDecorator, DStylizable):
    ...
    def __init__(self, name: str, viewpoint_DRepresentationElement23: "viewpoint_DRepresentation" = None, viewpoint_DRepresentationElement: "viewpoint_DRepresentation" = None, viewpoint_DRepresentationElement27: set["viewpoint_EObject"] = None):
        self.name = name
...
class viewpoint_DView(DRefreshable):
    ...
    def __init__(self, initialized: bool, viewpoint_DView: "viewpoint_DAnalysis" = None, viewpoint_DView10: "viewpoint_DAnalysis" = None, viewpoint_DView38: set["viewpoint_DRepresentation"] = None, viewpoint_DView41: set["viewpoint_DRepresentation"] = None, viewpoint_DView30: set["viewpoint_DRepresentation"] = None, viewpoint_DView33: "viewpoint_MetaModelExtension" = None, viewpoint_DView35: set["viewpoint_DRepresentation"] = None, viewpoint_DView44: "Viewpoint" = None):
...
class viewpoint_DAnalysis:
    ...
    def __init__(self, version: str, viewpoint_DAnalysis7: set["viewpoint_DView"] = None, viewpoint_DAnalysis9: set["viewpoint_DView"] = None, viewpoint_DAnalysis12: set["viewpoint_DFeatureExtension"] = None, viewpoint_DAnalysis: "viewpoint_DAnalysis" = None, viewpoint_DAnalysis0: set["viewpoint_DAnalysis"] = None, viewpoint_DAnalysis3: set["viewpoint_EObject"] = None, viewpoint_DAnalysis5: set["DAnnotationEntry"] = None, viewpoint_DAnalysis56: "viewpoint_DAnalysisSessionEObject" = None):
        self.version = version
