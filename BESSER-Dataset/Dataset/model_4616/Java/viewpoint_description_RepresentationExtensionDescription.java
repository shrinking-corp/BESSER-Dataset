...
public class viewpoint_description_RepresentationExtensionDescription  {
    ...
    public viewpoint_description_RepresentationExtensionDescription(
        String name,        String representationName,        String viewpointURI    ) {
        this.name = name;
    ...
    public viewpoint_description_RepresentationExtensionDescription(
        String name,        String representationName,        String viewpointURI        ArrayList<description_viewpoint_EPackage> description_viewpoint_epackages    ) {
        this.name = name;
        this.representationName = representationName;
        this.viewpointURI = viewpointURI;
