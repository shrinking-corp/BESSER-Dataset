...
def test_hyp_viewpoint_tool_subvariable_is_not_abstract():
    assert not inspect.isabstract(viewpoint_tool_SubVariable)


def test_hyp_viewpoint_tool_subvariable_constructor_exists():
    assert callable(viewpoint_tool_SubVariable.__init__)


def test_hyp_viewpoint_tool_subvariable_constructor_args():
...
def test_hyp_tool_subvariable_is_not_abstract():
    assert not inspect.isabstract(tool_SubVariable)


def test_hyp_tool_subvariable_constructor_exists():
    assert callable(tool_SubVariable.__init__)


def test_hyp_tool_subvariable_constructor_args():
...
def test_hyp_viewpoint_tool_abstractvariable_is_not_abstract():
    assert not inspect.isabstract(viewpoint_tool_AbstractVariable)


def test_hyp_viewpoint_tool_abstractvariable_constructor_exists():
    assert callable(viewpoint_tool_AbstractVariable.__init__)


def test_hyp_viewpoint_tool_abstractvariable_constructor_args():
...
def test_hyp_viewpoint_rgbvalues_is_not_abstract():
    assert not inspect.isabstract(viewpoint_RGBValues)


def test_hyp_viewpoint_rgbvalues_constructor_exists():
    assert callable(viewpoint_RGBValues.__init__)


def test_hyp_viewpoint_rgbvalues_constructor_args():
...
def test_hyp_dnavigationlink_is_not_abstract():
    assert not inspect.isabstract(DNavigationLink)


def test_hyp_dnavigationlink_constructor_exists():
    assert callable(DNavigationLink.__init__)


def test_hyp_dnavigationlink_constructor_args():
    sig = inspect.signature(DNavigationLink.__init__)
    params = list(sig.parameters.keys())



def test_hyp_viewpoint_dsourcefilelink_is_not_abstract():
    assert not inspect.isabstract(viewpoint_DSourceFileLink)


def test_hyp_viewpoint_dsourcefilelink_constructor_exists():
    assert callable(viewpoint_DSourceFileLink.__init__)


def test_hyp_viewpoint_dsourcefilelink_constructor_args():
...
def test_hyp_viewpoint_dcontainer_is_not_abstract():
    assert not inspect.isabstract(viewpoint_DContainer)


def test_hyp_viewpoint_dcontainer_constructor_exists():
    assert callable(viewpoint_DContainer.__init__)


def test_hyp_viewpoint_dcontainer_constructor_args():
...
def test_hyp_dlabelled_is_not_abstract():
    assert not inspect.isabstract(DLabelled)


def test_hyp_dlabelled_constructor_exists():
    assert callable(DLabelled.__init__)


def test_hyp_dlabelled_constructor_args():
...
def test_hyp_viewpoint_dnavigationlink_is_not_abstract():
    assert not inspect.isabstract(viewpoint_DNavigationLink)


def test_hyp_viewpoint_dnavigationlink_constructor_exists():
    assert callable(viewpoint_DNavigationLink.__init__)


def test_hyp_viewpoint_dnavigationlink_constructor_args():
...
def test_hyp_viewpoint_dnavigable_is_not_abstract():
    assert not inspect.isabstract(viewpoint_DNavigable)


def test_hyp_viewpoint_dnavigable_constructor_exists():
    assert callable(viewpoint_DNavigable.__init__)


def test_hyp_viewpoint_dnavigable_constructor_args():
...
def test_hyp_viewpoint_dlabelled_is_not_abstract():
    assert not inspect.isabstract(viewpoint_DLabelled)


def test_hyp_viewpoint_dlabelled_constructor_exists():
    assert callable(viewpoint_DLabelled.__init__)


def test_hyp_viewpoint_dlabelled_constructor_args():
...
def test_hyp_viewpoint_dvalidable_is_not_abstract():
    assert not inspect.isabstract(viewpoint_DValidable)


def test_hyp_viewpoint_dvalidable_constructor_exists():
    assert callable(viewpoint_DValidable.__init__)


def test_hyp_viewpoint_dvalidable_constructor_args():
...
def test_hyp_navigationtargettype_exists():
    # Check that the Enumeration exists
    assert NavigationTargetType is not None

def test_hyp_navigationtargettype_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_viewpoint_tool_abstractvariable_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=viewpoint_DAnalysisSessionEObject_strategy)
def test_hyp_viewpoint_danalysissessioneobject_blocked_setter(instance):
...
def test_hyp_viewpoint_rgbvalues_red_setter(instance):
    original = instance.red
    instance.red = original
    assert instance.red == original
...
@given(instance=viewpoint_RGBValues_strategy)
def test_hyp_viewpoint_rgbvalues_blue_setter(instance):
    original = instance.blue
    instance.blue = original
    assert instance.blue == original
...
@given(instance=viewpoint_RGBValues_strategy)
def test_hyp_viewpoint_rgbvalues_green_setter(instance):
    original = instance.green
    instance.green = original
    assert instance.green == original
...
def test_hyp_viewpoint_dsourcefilelink_endPosition_setter(instance):
...
@given(instance=viewpoint_DSourceFileLink_strategy)
def test_hyp_viewpoint_dsourcefilelink_startPosition_setter(instance):
...
@given(instance=viewpoint_DSourceFileLink_strategy)
def test_hyp_viewpoint_dsourcefilelink_filePath_setter(instance):
...
def test_hyp_viewpoint_dnavigationlink_label_setter(instance):
    original = instance.label
    instance.label = original
    assert instance.label == original
...
@given(instance=viewpoint_DNavigationLink_strategy)
def test_hyp_viewpoint_dnavigationlink_targetType_setter(instance):
...
@given(instance=viewpoint_DNavigationLink_strategy)
@settings(max_examples=30)
def test_hyp_viewpoint_dnavigationlink_isavailable_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
...
def test_hyp_viewpoint_dview_initialized_setter(instance):
...
@settings(max_examples=30)
def test_hyp_viewpoint_dvalidable_validate_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
        instance.validate()
