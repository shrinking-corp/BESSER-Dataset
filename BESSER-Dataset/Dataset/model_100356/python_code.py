...
class EventAutomatonModel_SymbolicTimer:
    ...
    def __init__(self, name: str, timer: "EventAutomatonModel_SymbolicTimeoutEvent" = None, SymbolicTimer: "EventAutomatonModel_SymbolicTimeoutEvent" = None, EventAutomatonModel_SymbolicTimer31: "EventAutomatonModel_TimerAction" = None, EventAutomatonModel_SymbolicTimer: "EventAutomatonModel_Automaton" = None):
        self.name = name
        self.timer = timer
...
class EventAutomatonModel_State:
    ...
    def __init__(self, id: int, acceptor: str, EventAutomatonModel_State12: "EventAutomatonModel_Automaton" = None, on: set["EventAutomatonModel_Token"] = None, to: set["EventAutomatonModel_AbstractTransition"] = None, from_: set["EventAutomatonModel_AbstractTransition"] = None, State: "EventAutomatonModel_Token" = None, State49: "EventAutomatonModel_AbstractTransition" = None, State51: "EventAutomatonModel_AbstractTransition" = None, EventAutomatonModel_State: "EventAutomatonModel_Automaton" = None, EventAutomatonModel_State5: "EventAutomatonModel_Automaton" = None):
        self.id = id
...
class EventAutomatonModel_Automaton:
    ...
    def __init__(self, name: str, EventAutomatonModel_Automaton11: "EventAutomatonModel_State" = None, EventAutomatonModel_Automaton16: "EventAutomatonModel_ComplexEventProcessor" = None, EventAutomatonModel_Automaton: set["EventAutomatonModel_State"] = None, EventAutomatonModel_Automaton2: set["EventAutomatonModel_Token"] = None, EventAutomatonModel_Automaton4: "EventAutomatonModel_State" = None, EventAutomatonModel_Automaton7: set["EventAutomatonModel_SymbolicParameter"] = None, EventAutomatonModel_Automaton9: set["EventAutomatonModel_SymbolicTimer"] = None):
        self.name = name
