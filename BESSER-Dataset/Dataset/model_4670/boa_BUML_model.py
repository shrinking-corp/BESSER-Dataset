...
# Classes
boa_File = Class(name="boa_File")
boa_This = Class(name="boa_This")
boa_Bool = Class(name="boa_Bool")
boa_Int = Class(name="boa_Int")
boa_Skip = Class(name="boa_Skip")
boa_TopLevelCmd = Class(name="boa_TopLevelCmd", is_abstract=True)
boa_Project = Class(name="boa_Project")
boa_Expr = Class(name="boa_Expr", is_abstract=True)
TopLevelCmd = Class(name="TopLevelCmd")
boa_Def = Class(name="boa_Def")
boa_App = Class(name="boa_App")
Expr = Class(name="Expr")
boa_Var = Class(name="boa_Var")
boa_Copy = Class(name="boa_Copy")
boa_With = Class(name="boa_With")
boa_ArithOp = Class(name="boa_ArithOp", is_abstract=True)
boa_BObject = Class(name="boa_BObject")
boa_Field = Class(name="boa_Field")
boa_Let = Class(name="boa_Let")
boa_Fun = Class(name="boa_Fun")
boa_Assign = Class(name="boa_Assign")
boa_Not = Class(name="boa_Not")
boa_CmpOp = Class(name="boa_CmpOp", is_abstract=True)
boa_BoolOp = Class(name="boa_BoolOp", is_abstract=True)
boa_If = Class(name="boa_If")
boa_BoolOpOr = Class(name="boa_BoolOpOr")
boa_Seq = Class(name="boa_Seq")
boa_CmpOpEqual = Class(name="boa_CmpOpEqual")
CmpOp = Class(name="CmpOp")
boa_CmpOpUnequal = Class(name="boa_CmpOpUnequal")
boa_CmpOpLess = Class(name="boa_CmpOpLess")
boa_Ctx = Class(name="boa_Ctx")
boa_ArithOpPlus = Class(name="boa_ArithOpPlus")
ArithOp = Class(name="ArithOp")
boa_ArithOpMinus = Class(name="boa_ArithOpMinus")
boa_ArithOpTimes = Class(name="boa_ArithOpTimes")
boa_ArithOpDivide = Class(name="boa_ArithOpDivide")
boa_ArithOpRemainder = Class(name="boa_ArithOpRemainder")
boa_BoolOpAnd = Class(name="boa_BoolOpAnd")
BoolOp = Class(name="BoolOp")
boa_EvalBoundFunRes = Class(name="boa_EvalBoundFunRes")
EvalFunRes = Class(name="EvalFunRes")
boa_EvalIntRes = Class(name="boa_EvalIntRes")
boa_EvalBoolRes = Class(name="boa_EvalBoolRes")
boa_StringToEvalResMap = Class(name="boa_StringToEvalResMap")
boa_EvalRes = Class(name="boa_EvalRes", is_abstract=True)
boa_EvalMapRes = Class(name="boa_EvalMapRes")
EvalRes = Class(name="EvalRes")
boa_EvalFunRes = Class(name="boa_EvalFunRes")
...
domain_model = DomainModel(
    name="boa",
    types={boa_File, boa_This, boa_Bool, boa_Int, boa_Skip, boa_TopLevelCmd, boa_Project, boa_Expr, TopLevelCmd, boa_Def, boa_App, Expr, boa_Var, boa_Copy, boa_With, boa_ArithOp, boa_BObject, boa_Field, boa_Let, boa_Fun, boa_Assign, boa_Not, boa_CmpOp, boa_BoolOp, boa_If, boa_BoolOpOr, boa_Seq, boa_CmpOpEqual, CmpOp, boa_CmpOpUnequal, boa_CmpOpLess, boa_Ctx, boa_ArithOpPlus, ArithOp, boa_ArithOpMinus, boa_ArithOpTimes, boa_ArithOpDivide, boa_ArithOpRemainder, boa_BoolOpAnd, BoolOp, boa_EvalBoundFunRes, EvalFunRes, boa_EvalIntRes, boa_EvalBoolRes, boa_StringToEvalResMap, boa_EvalRes, boa_EvalMapRes, EvalRes, boa_EvalFunRes},
    associations={commands0, expr1, lhs2, rhs4, value10, copy13, lhs15, rhs17, lhs20, rhs22, exp7, fields9, thn34, els37, lhs40, rhs42, body45, lhs47, value25, lhs27, rhs29, cond32, lhs57, rhs59, lhs62, rhs64, rhs49, lhs52, rhs54, exp75, ctx77, th80, env67, th68, value71, values73},
    generalizations={gen_boa_This_Expr, gen_boa_Bool_Expr, gen_boa_Int_Expr, gen_boa_Skip_Expr, gen_boa_Project_Expr, gen_boa_Expr_TopLevelCmd, gen_boa_Def_TopLevelCmd, gen_boa_App_Expr, gen_boa_Var_Expr, gen_boa_Copy_Expr, gen_boa_With_Expr, gen_boa_ArithOp_Expr, gen_boa_BObject_Expr, gen_boa_Let_Expr, gen_boa_Fun_Expr, gen_boa_Assign_Expr, gen_boa_Not_Expr, gen_boa_CmpOp_Expr, gen_boa_BoolOp_Expr, gen_boa_If_Expr, gen_boa_BoolOpOr_BoolOp, gen_boa_Seq_Expr, gen_boa_CmpOpEqual_CmpOp, gen_boa_CmpOpUnequal_CmpOp, gen_boa_CmpOpLess_CmpOp, gen_boa_ArithOpPlus_ArithOp, gen_boa_ArithOpMinus_ArithOp, gen_boa_ArithOpTimes_ArithOp, gen_boa_ArithOpDivide_ArithOp, gen_boa_ArithOpRemainder_ArithOp, gen_boa_BoolOpAnd_BoolOp, gen_boa_EvalBoundFunRes_EvalFunRes, gen_boa_EvalIntRes_EvalRes, gen_boa_EvalBoolRes_EvalRes, gen_boa_EvalMapRes_EvalRes, gen_boa_EvalFunRes_EvalRes},
    metadata=None
)
