...
# Classes
skol_Classroom = Class(name="skol_Classroom")
skol_Student = Class(name="skol_Student")
skol_Diagram = Class(name="skol_Diagram")
skol_School = Class(name="skol_School")
...
domain_model = DomainModel(
    name="skol",
    types={skol_Classroom, skol_Student, skol_Diagram, skol_School},
    associations={friends6, students0, school1, classrooms2},
    generalizations={},
    metadata=None
)
