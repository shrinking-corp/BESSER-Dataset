...
# Classes
robot_Mission = Class(name="robot_Mission")
robot_Sequence = Class(name="robot_Sequence")
Operation = Class(name="Operation")
robot_Operation = Class(name="robot_Operation")
robot_Movement = Class(name="robot_Movement")
robot_TurnLeft = Class(name="robot_TurnLeft")
robot_TurnRight = Class(name="robot_TurnRight")
robot_Alternative = Class(name="robot_Alternative")
robot_Condition = Class(name="robot_Condition")
robot_Event = Class(name="robot_Event")
robot_Values = Class(name="robot_Values")
robot_Sensor = Class(name="robot_Sensor")
Values = Class(name="Values")
robot_Forward = Class(name="robot_Forward")
Movement = Class(name="Movement")
robot_Backward = Class(name="robot_Backward")
robot_Operator = Class(name="robot_Operator")
robot_Different = Class(name="robot_Different")
Operator = Class(name="Operator")
robot_Echo = Class(name="robot_Echo")
robot_TInteger = Class(name="robot_TInteger")
robot_TString = Class(name="robot_TString")
robot_TFloat = Class(name="robot_TFloat")
robot_TBoolean = Class(name="robot_TBoolean")
robot_Var = Class(name="robot_Var")
robot_Variable = Class(name="robot_Variable")
robot_Stop = Class(name="robot_Stop")
robot_Sleep = Class(name="robot_Sleep")
robot_Whenever = Class(name="robot_Whenever")
robot_Value = Class(name="robot_Value")
Condition = Class(name="Condition")
robot_Compare = Class(name="robot_Compare")
robot_Affectation = Class(name="robot_Affectation")
Var = Class(name="Var")
robot_Declaration = Class(name="robot_Declaration")
robot_While = Class(name="robot_While")
...
domain_model = DomainModel(
    name="robot",
    types={robot_Mission, robot_Sequence, Operation, robot_Operation, robot_Movement, robot_TurnLeft, robot_TurnRight, robot_Alternative, robot_Condition, robot_Event, robot_Values, robot_Sensor, Values, robot_Forward, Movement, robot_Backward, robot_Operator, robot_Different, Operator, robot_Echo, robot_TInteger, robot_TString, robot_TFloat, robot_TBoolean, robot_Var, robot_Variable, robot_Stop, robot_Sleep, robot_Whenever, robot_Value, Condition, robot_Compare, robot_Affectation, Var, robot_Declaration, robot_While, EOperator, ESensor},
    associations={Sequence0, Operations1, Consequence3, Alternative5, Condition8, At10, Onleave12, Condition15, Value18, Condition19, Whenever21, Operation27, Condition29, Variable32, Operator34, Condition235, Condition138, Else24},
    generalizations={gen_robot_Sequence_Operation, gen_robot_Movement_Operation, gen_robot_TurnLeft_Movement, gen_robot_TurnRight_Movement, gen_robot_Alternative_Operation, gen_robot_Event_Operation, gen_robot_Sensor_Values, gen_robot_Forward_Movement, gen_robot_Backward_Movement, gen_robot_Different_Operator, gen_robot_Echo_Operation, gen_robot_TInteger_Values, gen_robot_TString_Values, gen_robot_TFloat_Values, gen_robot_TBoolean_Values, gen_robot_Var_Operation, gen_robot_Variable_Values, gen_robot_Stop_Movement, gen_robot_Sleep_Movement, gen_robot_Whenever_Operation, gen_robot_Value_Condition, gen_robot_Compare_Condition, gen_robot_Affectation_Var, gen_robot_Declaration_Var, gen_robot_While_Operation},
    metadata=None
)
