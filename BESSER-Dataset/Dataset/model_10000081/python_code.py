...
class mypackage_Customer:
    ...
    def __init__(self, name: str, dateOfBirth: date, address: str, phoneNumber: str, emailAddress: str, login4: "mypackage_Login" = None, account1: set["account_Account"] = None):
        self.name = name
...
class account_Account:
    ...
    def __init__(self, accountNo: str, type: account_AccountType, balance: float, transactions2: set["transaction_Transaction"] = None, customer0: "mypackage_Customer" = None):
