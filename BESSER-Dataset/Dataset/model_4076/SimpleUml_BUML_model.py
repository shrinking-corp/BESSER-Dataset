...
# Classes
umlMM_Association = Class(name="umlMM_Association")
PackageElement = Class(name="PackageElement")
umlMM_PrimitiveDataType = Class(name="umlMM_PrimitiveDataType")
umlMM_UMLModelElement = Class(name="umlMM_UMLModelElement", is_abstract=True)
umlMM_Class = Class(name="umlMM_Class")
umlMM_Attribute = Class(name="umlMM_Attribute")
...
umlMM_PackageElement = Class(name="umlMM_PackageElement", is_abstract=True)
...
domain_model = DomainModel(
    name="umlMM",
    types={umlMM_Association, PackageElement, umlMM_PrimitiveDataType, umlMM_UMLModelElement, umlMM_Class, umlMM_Attribute, UMLModelElement, umlMM_Classifier, Classifier, umlMM_Package, umlMM_PackageElement},
    associations={namespace13, source0, destination1, owner3, type5, attribute6, general8, forward9, reverse10, elements12},
    generalizations={gen_umlMM_Association_PackageElement, gen_umlMM_PrimitiveDataType_Classifier, gen_umlMM_Attribute_UMLModelElement, gen_umlMM_Class_Classifier, gen_umlMM_Classifier_PackageElement, gen_umlMM_Package_UMLModelElement, gen_umlMM_PackageElement_UMLModelElement},
    metadata=None
)
