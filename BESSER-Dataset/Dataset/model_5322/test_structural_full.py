...
NestedTest_strategy = st.builds(NestedTest)
...
root_RootTest_strategy = st.builds(root_RootTest)
...
root_nested_NestedTest_strategy = st.builds(root_nested_NestedTest)
