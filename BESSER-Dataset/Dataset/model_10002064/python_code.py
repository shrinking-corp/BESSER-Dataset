...
class StoringStrategy_Interface:
...
class ShoppingCartExample_ShoppingCart:
    ...
    def __init__(self, creationDate: date, account5: "ShoppingCartExample_Account" = None, order2: set["ShoppingCartExample_Order"] = None):
