...
rif12_ExchangeFile_SpecElementWithUserDefinedAttributes = Class(name="rif12_ExchangeFile_SpecElementWithUserDefinedAttributes", is_abstract=True)
Identifiable = Class(name="Identifiable")
SpecType = Class(name="SpecType")
AttributeValue = Class(name="AttributeValue")
rif12_ExchangeFile_SpecHierarchyRoot = Class(name="rif12_ExchangeFile_SpecHierarchyRoot")
SpecElementWithUserDefinedAttributes = Class(name="SpecElementWithUserDefinedAttributes")
rif12_ExchangeFile_SpecGroup = Class(name="rif12_ExchangeFile_SpecGroup")
RelationGroup = Class(name="RelationGroup")
rif12_ExchangeFile_RelationGroup = Class(name="rif12_ExchangeFile_RelationGroup")
rif12_ExchangeFile_Identifiable = Class(name="rif12_ExchangeFile_Identifiable", is_abstract=True)
rif12_ExchangeFile_SpecType = Class(name="rif12_ExchangeFile_SpecType")
AttributeDefinition = Class(name="AttributeDefinition")
rif12_ExchangeFile_AttributeDefinition = Class(name="rif12_ExchangeFile_AttributeDefinition", is_abstract=True)
rif12_ExchangeFile_AttributeValue = Class(name="rif12_ExchangeFile_AttributeValue", is_abstract=True)
rif12_ExchangeFile_SpecHierarchy = Class(name="rif12_ExchangeFile_SpecHierarchy")
SpecObject = Class(name="SpecObject")
rif12_ExchangeFile_SpecObject = Class(name="rif12_ExchangeFile_SpecObject")
SpecHierarchyRoot = Class(name="SpecHierarchyRoot")
rif12_ExchangeFile_SpecGroupHierarchyRoot = Class(name="rif12_ExchangeFile_SpecGroupHierarchyRoot")
SpecGroupHierarchy = Class(name="SpecGroupHierarchy")
SpecRelation = Class(name="SpecRelation")
rif12_ExchangeFile_SpecRelation = Class(name="rif12_ExchangeFile_SpecRelation")
rif12_ExchangeFile_DatatypeDefinition = Class(name="rif12_ExchangeFile_DatatypeDefinition", is_abstract=True)
rif12_ExchangeFile_AccessPolicy = Class(name="rif12_ExchangeFile_AccessPolicy")
...
rif12_ExchangeFile_EmbeddedValue = Class(name="rif12_ExchangeFile_EmbeddedValue")
rif12_ExchangeFile_AttributeValueEnumeration = Class(name="rif12_ExchangeFile_AttributeValueEnumeration")
AttributeDefinitionEnumeration = Class(name="AttributeDefinitionEnumeration")
rif12_ExchangeFile_AttributeDefinitionSimple = Class(name="rif12_ExchangeFile_AttributeDefinitionSimple")
DatatypeDefinitionSimple = Class(name="DatatypeDefinitionSimple")
rif12_ExchangeFile_SpecGroupHierarchy = Class(name="rif12_ExchangeFile_SpecGroupHierarchy")
rif12_ExchangeFile_AttributeDefinitionComplex = Class(name="rif12_ExchangeFile_AttributeDefinitionComplex")
DatatypeDefinitionComplex = Class(name="DatatypeDefinitionComplex")
AttributeValueComplex = Class(name="AttributeValueComplex")
rif12_ExchangeFile_DatatypeDefinitionComplex = Class(name="rif12_ExchangeFile_DatatypeDefinitionComplex", is_abstract=True)
rif12_ExchangeFile_AttributeValueComplex = Class(name="rif12_ExchangeFile_AttributeValueComplex", is_abstract=True)
rif12_ExchangeFile_AttributeDefinitionEnumeration = Class(name="rif12_ExchangeFile_AttributeDefinitionEnumeration")
...
rif12_ExchangeFile_DatatypeDefinitionEnumeration = Class(name="rif12_ExchangeFile_DatatypeDefinitionEnumeration")
EnumValue = Class(name="EnumValue")
rif12_ExchangeFile_EnumValue = Class(name="rif12_ExchangeFile_EnumValue")
EmbeddedValue = Class(name="EmbeddedValue")
DataTypes_XmlContent = Class(name="DataTypes_XmlContent")
rif12_ExchangeFile_DatatypeDefinitionBinaryFile = Class(name="rif12_ExchangeFile_DatatypeDefinitionBinaryFile")
AttributeValueSimple = Class(name="AttributeValueSimple")
rif12_ExchangeFile_DatatypeDefinitionSimple = Class(name="rif12_ExchangeFile_DatatypeDefinitionSimple", is_abstract=True)
rif12_ExchangeFile_AttributeValueSimple = Class(name="rif12_ExchangeFile_AttributeValueSimple")
AttributeDefinitionSimple = Class(name="AttributeDefinitionSimple")
rif12_ExchangeFile_AttributeValueEmbeddedDocument = Class(name="rif12_ExchangeFile_AttributeValueEmbeddedDocument")
AttributeDefinitionComplex = Class(name="AttributeDefinitionComplex")
DataTypes_XhtmlContent = Class(name="DataTypes_XhtmlContent")
rif12_ExchangeFile_AttributeValueEmbeddedFile = Class(name="rif12_ExchangeFile_AttributeValueEmbeddedFile")
DataTypes_BinaryContent = Class(name="DataTypes_BinaryContent")
rif12_ExchangeFile_AttributeValueFileReference = Class(name="rif12_ExchangeFile_AttributeValueFileReference")
rif12_ExchangeFile_AttributeValueXmlData = Class(name="rif12_ExchangeFile_AttributeValueXmlData")
rif12_ExchangeFile_RIFContent = Class(name="rif12_ExchangeFile_RIFContent")
AccessPolicy = Class(name="AccessPolicy")
rif12_ExchangeFile_DatatypeDefinitionBoolean = Class(name="rif12_ExchangeFile_DatatypeDefinitionBoolean")
rif12_ExchangeFile_DatatypeDefinitionDate = Class(name="rif12_ExchangeFile_DatatypeDefinitionDate")
rif12_ExchangeFile_DatatypeDefinitionDocument = Class(name="rif12_ExchangeFile_DatatypeDefinitionDocument")
rif12_ExchangeFile_DatatypeDefinitionInteger = Class(name="rif12_ExchangeFile_DatatypeDefinitionInteger")
rif12_ExchangeFile_DatatypeDefinitionReal = Class(name="rif12_ExchangeFile_DatatypeDefinitionReal")
rif12_ExchangeFile_DatatypeDefinitionString = Class(name="rif12_ExchangeFile_DatatypeDefinitionString")
rif12_ExchangeFile_DatatypeDefinitionXmlData = Class(name="rif12_ExchangeFile_DatatypeDefinitionXmlData")
rif12_ExchangeFile_RIF = Class(name="rif12_ExchangeFile_RIF")
RIFHeader = Class(name="RIFHeader")
RIFContent = Class(name="RIFContent")
RIFToolExtension = Class(name="RIFToolExtension")
rif12_ExchangeFile_RIFHeader = Class(name="rif12_ExchangeFile_RIFHeader")
rif12_ExchangeFile_RIFToolExtension = Class(name="rif12_ExchangeFile_RIFToolExtension")
rif12_DataTypes_BinaryContent = Class(name="rif12_DataTypes_BinaryContent")
rif12_DataTypes_XhtmlContent = Class(name="rif12_DataTypes_XhtmlContent")
rif12_DataTypes_XmlContent = Class(name="rif12_DataTypes_XmlContent")
...
rif12_ExchangeFile_Identifiable.attributes={rif12_ExchangeFile_Identifiable_identifier, rif12_ExchangeFile_Identifiable_lastChange, rif12_ExchangeFile_Identifiable_desc, rif12_ExchangeFile_Identifiable_longName}
...
rif12_ExchangeFile_EmbeddedValue.attributes={rif12_ExchangeFile_EmbeddedValue_key, rif12_ExchangeFile_EmbeddedValue_otherContent}
...
rif12_ExchangeFile_DatatypeDefinitionBinaryFile.attributes={rif12_ExchangeFile_DatatypeDefinitionBinaryFile_filenameSuffix, rif12_ExchangeFile_DatatypeDefinitionBinaryFile_formatName, rif12_ExchangeFile_DatatypeDefinitionBinaryFile_mimeType, rif12_ExchangeFile_DatatypeDefinitionBinaryFile_application}
...
rif12_ExchangeFile_DatatypeDefinitionInteger.attributes={rif12_ExchangeFile_DatatypeDefinitionInteger_min, rif12_ExchangeFile_DatatypeDefinitionInteger_max}
...
rif12_ExchangeFile_RIFHeader.attributes={rif12_ExchangeFile_RIFHeader_title, rif12_ExchangeFile_RIFHeader_creationTime, rif12_ExchangeFile_RIFHeader_identifier, rif12_ExchangeFile_RIFHeader_comment, rif12_ExchangeFile_RIFHeader_author, rif12_ExchangeFile_RIFHeader_sourceToolId}
...
domain_model = DomainModel(
    name="rif12",
    types={SpecHierarchy, rif12_ExchangeFile_SpecElementWithUserDefinedAttributes, Identifiable, SpecType, AttributeValue, rif12_ExchangeFile_SpecHierarchyRoot, SpecElementWithUserDefinedAttributes, rif12_ExchangeFile_SpecGroup, RelationGroup, rif12_ExchangeFile_RelationGroup, rif12_ExchangeFile_Identifiable, rif12_ExchangeFile_SpecType, AttributeDefinition, rif12_ExchangeFile_AttributeDefinition, rif12_ExchangeFile_AttributeValue, rif12_ExchangeFile_SpecHierarchy, SpecObject, rif12_ExchangeFile_SpecObject, SpecHierarchyRoot, rif12_ExchangeFile_SpecGroupHierarchyRoot, SpecGroupHierarchy, SpecRelation, rif12_ExchangeFile_SpecRelation, rif12_ExchangeFile_DatatypeDefinition, rif12_ExchangeFile_AccessPolicy, SpecGroupHierarchyRoot, SpecGroup, DatatypeDefinition, rif12_ExchangeFile_EmbeddedValue, rif12_ExchangeFile_AttributeValueEnumeration, AttributeDefinitionEnumeration, rif12_ExchangeFile_AttributeDefinitionSimple, DatatypeDefinitionSimple, rif12_ExchangeFile_SpecGroupHierarchy, rif12_ExchangeFile_AttributeDefinitionComplex, DatatypeDefinitionComplex, AttributeValueComplex, rif12_ExchangeFile_DatatypeDefinitionComplex, rif12_ExchangeFile_AttributeValueComplex, rif12_ExchangeFile_AttributeDefinitionEnumeration, DatatypeDefinitionEnumeration, AttributeValueEnumeration, rif12_ExchangeFile_DatatypeDefinitionEnumeration, EnumValue, rif12_ExchangeFile_EnumValue, EmbeddedValue, DataTypes_XmlContent, rif12_ExchangeFile_DatatypeDefinitionBinaryFile, AttributeValueSimple, rif12_ExchangeFile_DatatypeDefinitionSimple, rif12_ExchangeFile_AttributeValueSimple, AttributeDefinitionSimple, rif12_ExchangeFile_AttributeValueEmbeddedDocument, AttributeDefinitionComplex, DataTypes_XhtmlContent, rif12_ExchangeFile_AttributeValueEmbeddedFile, DataTypes_BinaryContent, rif12_ExchangeFile_AttributeValueFileReference, rif12_ExchangeFile_AttributeValueXmlData, rif12_ExchangeFile_RIFContent, AccessPolicy, rif12_ExchangeFile_DatatypeDefinitionBoolean, rif12_ExchangeFile_DatatypeDefinitionDate, rif12_ExchangeFile_DatatypeDefinitionDocument, rif12_ExchangeFile_DatatypeDefinitionInteger, rif12_ExchangeFile_DatatypeDefinitionReal, rif12_ExchangeFile_DatatypeDefinitionString, rif12_ExchangeFile_DatatypeDefinitionXmlData, rif12_ExchangeFile_RIF, RIFHeader, RIFContent, RIFToolExtension, rif12_ExchangeFile_RIFHeader, rif12_ExchangeFile_RIFToolExtension, rif12_DataTypes_BinaryContent, rif12_DataTypes_XhtmlContent, rif12_DataTypes_XmlContent, AccessPolicyAccessModeEnum, DatatypeDefinitionDateFormatEnum},
    associations={children0, type1, values2, specObjects12, relationGroups14, specAttributes4, object5, values6, children9, specTypes42, specHierarchies45, specObjects48, specHierarchyRoots51, specRelations16, relationType17, target20, source22, specGroupHierarchyRoots25, specGroups26, attributeDefinitions28, relationGroups31, datatypeDefinitions34, specRelations36, attributeValues39, values64, definition66, children53, group54, type56, defaultValue57, type59, defaultValue60, specifiedValues62, properties63, definition81, xmlContent83, type68, defaultValue69, definition71, definition72, xhtmlContent73, definition75, binaryContent77, definition79, accessPolicies90, datatypes91, SpecHierarchyRoots94, header85, coreContent86, toolExtensions88, specObjects97, specGroups100, SpecGroupHierarchyRoots103, specTypes106, specRelations109},
    generalizations={gen_rif12_ExchangeFile_SpecElementWithUserDefinedAttributes_Identifiable, gen_rif12_ExchangeFile_SpecHierarchyRoot_SpecElementWithUserDefinedAttributes, gen_rif12_ExchangeFile_SpecGroup_SpecElementWithUserDefinedAttributes, gen_rif12_ExchangeFile_RelationGroup_Identifiable, gen_rif12_ExchangeFile_SpecType_Identifiable, gen_rif12_ExchangeFile_AttributeDefinition_Identifiable, gen_rif12_ExchangeFile_AttributeValue_Identifiable, gen_rif12_ExchangeFile_SpecHierarchy_Identifiable, gen_rif12_ExchangeFile_SpecObject_SpecElementWithUserDefinedAttributes, gen_rif12_ExchangeFile_SpecGroupHierarchyRoot_SpecElementWithUserDefinedAttributes, gen_rif12_ExchangeFile_SpecRelation_SpecElementWithUserDefinedAttributes, gen_rif12_ExchangeFile_DatatypeDefinition_Identifiable, gen_rif12_ExchangeFile_AccessPolicy_Identifiable, gen_rif12_ExchangeFile_AttributeValueEnumeration_AttributeValue, gen_rif12_ExchangeFile_AttributeDefinitionSimple_AttributeDefinition, gen_rif12_ExchangeFile_SpecGroupHierarchy_Identifiable, gen_rif12_ExchangeFile_AttributeDefinitionComplex_AttributeDefinition, gen_rif12_ExchangeFile_DatatypeDefinitionComplex_DatatypeDefinition, gen_rif12_ExchangeFile_AttributeValueComplex_AttributeValue, gen_rif12_ExchangeFile_AttributeDefinitionEnumeration_AttributeDefinition, gen_rif12_ExchangeFile_DatatypeDefinitionEnumeration_DatatypeDefinition, gen_rif12_ExchangeFile_EnumValue_Identifiable, gen_rif12_ExchangeFile_DatatypeDefinitionBinaryFile_DatatypeDefinitionComplex, gen_rif12_ExchangeFile_DatatypeDefinitionSimple_DatatypeDefinition, gen_rif12_ExchangeFile_AttributeValueSimple_AttributeValue, gen_rif12_ExchangeFile_AttributeValueEmbeddedDocument_AttributeValueComplex, gen_rif12_ExchangeFile_AttributeValueEmbeddedFile_AttributeValueComplex, gen_rif12_ExchangeFile_AttributeValueFileReference_AttributeValueComplex, gen_rif12_ExchangeFile_AttributeValueXmlData_AttributeValueComplex, gen_rif12_ExchangeFile_DatatypeDefinitionBoolean_DatatypeDefinitionSimple, gen_rif12_ExchangeFile_DatatypeDefinitionDate_DatatypeDefinitionSimple, gen_rif12_ExchangeFile_DatatypeDefinitionDocument_DatatypeDefinitionComplex, gen_rif12_ExchangeFile_DatatypeDefinitionInteger_DatatypeDefinitionSimple, gen_rif12_ExchangeFile_DatatypeDefinitionReal_DatatypeDefinitionSimple, gen_rif12_ExchangeFile_DatatypeDefinitionString_DatatypeDefinitionSimple, gen_rif12_ExchangeFile_DatatypeDefinitionXmlData_DatatypeDefinitionComplex},
    metadata=None
)
