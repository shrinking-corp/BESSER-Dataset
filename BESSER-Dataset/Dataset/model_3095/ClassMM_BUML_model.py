...
# Classes
ClassMM_Association = Class(name="ClassMM_Association")
ClassMM_Class = Class(name="ClassMM_Class")
ClassMM_Attribute = Class(name="ClassMM_Attribute")
Classifier = Class(name="Classifier")
ClassMM_Classifier = Class(name="ClassMM_Classifier", is_abstract=True)
ClassMM_PrimitiveDataType = Class(name="ClassMM_PrimitiveDataType")
ClassMM_ClassModel = Class(name="ClassMM_ClassModel")
...
domain_model = DomainModel(
    name="ClassMM",
    types={ClassMM_Association, ClassMM_Class, ClassMM_Attribute, Classifier, ClassMM_Classifier, ClassMM_PrimitiveDataType, ClassMM_ClassModel},
