...
def test_Book_Chapter_author_value_roundtrip():
    instance = Book_Chapter(author="sample_text", nbPages="sample_text", title="sample_text")
...
def test_assoc_book1_link_reassign_clear():
    a = Book_Chapter(author="sample_text", nbPages="sample_text", title="sample_text")
    b1 = Book()
    b2 = Book()
...
Book_Chapter_strategy = st.builds(Book_Chapter, author=safe_text, nbPages=safe_text, title=safe_text)
@given(instance=Book_Chapter_strategy)
@settings(max_examples=25)
