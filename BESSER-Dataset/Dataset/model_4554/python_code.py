...
class vmLogo_Point:
    ...
    def __init__(self, x: str, y: str, vmLogo_Point: "vmLogo_Turtle" = None, vmLogo_Point5: "vmLogo_Turtle" = None, vmLogo_Point8: "vmLogo_Segment" = None, vmLogo_Point11: "vmLogo_Segment" = None):
        self.x = x
        self.y = y
