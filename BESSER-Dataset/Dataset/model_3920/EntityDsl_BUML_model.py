...
# Classes
entityDsl_Model = Class(name="entityDsl_Model")
entityDsl_Type = Class(name="entityDsl_Type")
entityDsl_SimpleType = Class(name="entityDsl_SimpleType")
Type = Class(name="Type")
entityDsl_Entity = Class(name="entityDsl_Entity")
entityDsl_Property = Class(name="entityDsl_Property")
...
entityDsl_Property.attributes={entityDsl_Property_many, entityDsl_Property_name}
...
domain_model = DomainModel(
    name="entityDsl",
    types={entityDsl_Model, entityDsl_Type, entityDsl_SimpleType, Type, entityDsl_Entity, entityDsl_Property},
