...
library_BaseResource.attributes={library_BaseResource_longName, library_BaseResource_expressionName, library_BaseResource_detailDisplay, library_BaseResource_summaryDisplay, library_BaseResource_shortName}
...
library_Component.attributes={library_Component_name, library_Component_duration, library_Component_description}
...
library_Parameter.attributes={library_Parameter_description, library_Parameter_modifiable, library_Parameter_value, library_Parameter_name, library_Parameter_expressionName}
...
library_EquipmentGroup.attributes={library_EquipmentGroup_name, library_EquipmentGroup_description, library_EquipmentGroup_count}
...
library_Equipment.attributes={library_Equipment_equipmentCode, library_Equipment_redundancy, library_Equipment_state, library_Equipment_count, library_Equipment_position}
...
library_ExpressionResult.attributes={library_ExpressionResult_targetIntervalHint, library_ExpressionResult_targetKindHint, library_ExpressionResult_targetRange}
...
library_ProductInfo.attributes={library_ProductInfo_underDevelopmentDate, library_ProductInfo_productCode, library_ProductInfo_salesCode, library_ProductInfo_endOfSupportDate, library_ProductInfo_availableDate, library_ProductInfo_endOfSalesDate}
...
domain_model = DomainModel(
    name="library",
    types={library_BaseExpressionResult, library_BaseResource, Base, library_Component, library_Lifecycle, library_NetXResource, library_Metric, library_Expression, library_Unit, library_Parameter, library_DiagramInfo, library_MultiImage, library_Tolerance, library_Protocol, library_EquipmentGroup, library_EquipmentRelationship, library_Equipment, Component, library_EObject, library_FunctionRelationship, library_ExpressionResult, BaseExpressionResult, library_Value, library_Function, library_Library, library_NodeType, library_LastEvaluationExpressionResult, library_MetricSource, BaseResource, library_MetricValueRange, library_Meta, library_ProductInfo, library_Vendor, Company, LevelKind, StateType, RangeKind, RedundancyType},
    associations={lifecycle1, resourceRefs2, metricRefs3, capacityExpressionRef5, unitRef0, parameterRefs14, allResources16, diagrams18, icons20, utilizationExpressionRef7, toleranceRefs10, protocolRefs12, equipmentGroups24, equipmentRelationshipRefs26, allEquipments29, equipments23, equipmentGroupResources34, expressionRefs37, equipmentRefs40, parameterRefs43, diagrams31, evaluationObject52, allEquipmentResources46, allEquipments49, functions59, functionRelationshipRefs60, targetResource54, targetValues56, functions65, nodeTypes67, allFunctions63, metricSources75, parameters77, tolerances80, equipments69, metrics72, componentRef91, metricRef92, metricValueRanges95, expressions83, units86, version89, forecastValues106, trendedValues109, functions112, capacityValues97, utilizationValues100, forecastCapacityValues103, equipments115, equipmentRef118, licensedFunctionRef120, nodeTypeRef123, expressionRef126, products132, icons129},
