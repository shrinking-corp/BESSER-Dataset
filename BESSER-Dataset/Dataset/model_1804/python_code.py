...
class library_Library:
    ...
    def __init__(self, protocols: str, name: str, library_Library: set["library_Function"] = None, library_Library68: set["library_NodeType"] = None, library_Library76: set["library_MetricSource"] = None, library_Library78: set["library_Parameter"] = None, library_Library81: set["library_Tolerance"] = None, library_Library70: set["library_Equipment"] = None, library_Library73: set["library_Metric"] = None, library_Library84: set["library_Expression"] = None, library_Library87: set["library_Unit"] = None, library_Library90: "library_Meta" = None):
...
class library_EquipmentGroup(Base):
    ...
    def __init__(self, name: str, count: str, description: str, library_EquipmentGroup: "library_Equipment" = None, library_EquipmentGroup35: set["library_NetXResource"] = None, library_EquipmentGroup38: set["library_Expression"] = None, library_EquipmentGroup41: set["library_Equipment"] = None, library_EquipmentGroup44: set["library_Parameter"] = None, library_EquipmentGroup32: set["library_DiagramInfo"] = None, library_EquipmentGroup47: set["library_NetXResource"] = None, library_EquipmentGroup50: set["library_Equipment"] = None):
        self.name = name
        self.count = count
        self.description = description
...
class library_Unit(Base):
    ...
    def __init__(self, name: str, code: str, description: str, library_Unit: "library_BaseResource" = None, library_Unit88: "library_Library" = None, library_Unit130: "library_MultiImage" = None):
        self.name = name
        self.code = code
        self.description = description
