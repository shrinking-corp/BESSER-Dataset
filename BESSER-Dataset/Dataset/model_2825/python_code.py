...
class editormodel_VisualDiagramJump(NodeVisualModel):
    ...
    def __init__(self, to: str, editormodel_VisualDiagramJump67: "editormodel_NodeVisualModel" = None, editormodel_VisualDiagramJump: "editormodel_Diagram" = None, editormodel_VisualDiagramJump64: "editormodel_Diagram" = None):
        self.to = to
...
class editormodel_ConnectionVisualModel(NodeVisualModel):
    ...
    def __init__(self, targetTerminal: str, sourceTerminal: str, editormodel_ConnectionVisualModel: set["editormodel_ConnectionBendpoint"] = None, sourceConnections: "editormodel_NodeVisualModel" = None, targetConnections: "editormodel_NodeVisualModel" = None, ConnectionVisualModel: "editormodel_NodeVisualModel" = None, ConnectionVisualModel46: "editormodel_NodeVisualModel" = None):
...
class editormodel_FlabotFileModel(ExtensibleElement):
    ...
    def __init__(self, id: str, version: str, name: str, provider: str, editormodel_FlabotFileModel10: "editormodel_FlabotFileModel" = None, editormodel_FlabotFileModel8: set["editormodel_FlabotFileModel"] = None, editormodel_FlabotFileModel12: "editormodel_Folder" = None, editormodel_FlabotFileModel14: set["editormodel_Diagram"] = None, file: "editormodel_CoreModel" = None, editormodel_FlabotFileModel: set["editormodel_Diagram"] = None, editormodel_FlabotFileModel58: "editormodel_Folder" = None):
        self.id = id
...
class editormodel_Folder:
    ...
    def __init__(self, name: str, editormodel_Folder: "editormodel_FlabotFileModel" = None, Folder: "editormodel_Diagram" = None, Folder50: "editormodel_Folder" = None, parent49: set["editormodel_Folder"] = None, folder: set["editormodel_Diagram"] = None, Folder55: "editormodel_Folder" = None, folders: "editormodel_Folder" = None, editormodel_Folder57: "editormodel_FlabotFileModel" = None):
        self.name = name
...
class editormodel_Diagram(NamedElementModel):
    ...
    def __init__(self, gridEnabled: str, snapToGeometryEnabled: str, editormodel_Diagram15: "editormodel_FlabotFileModel" = None, editormodel_Diagram: "editormodel_CoreModel" = None, editormodel_Diagram2: set["editormodel_Note"] = None, diagram: set["editormodel_VisualModel"] = None, diagrams: "editormodel_Folder" = None, editormodel_Diagram7: "editormodel_FlabotFileModel" = None, Diagram: "editormodel_VisualModel" = None, Diagram52: "editormodel_Folder" = None, editormodel_Diagram62: "editormodel_VisualDiagramJump" = None, editormodel_Diagram65: "editormodel_VisualDiagramJump" = None):
    ...
    @property
    def snapToGeometryEnabled(self):
