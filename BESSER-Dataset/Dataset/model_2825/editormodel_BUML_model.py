...
editormodel_Diagram = Class(name="editormodel_Diagram", is_abstract=True)
NamedElementModel = Class(name="NamedElementModel")
editormodel_CoreModel = Class(name="editormodel_CoreModel")
editormodel_Note = Class(name="editormodel_Note")
editormodel_VisualModel = Class(name="editormodel_VisualModel")
editormodel_Folder = Class(name="editormodel_Folder")
editormodel_FlabotFileModel = Class(name="editormodel_FlabotFileModel")
ExtensibleElement = Class(name="ExtensibleElement")
editormodel_NodeVisualModel = Class(name="editormodel_NodeVisualModel")
VisualModel = Class(name="VisualModel")
editormodel_EObject = Class(name="editormodel_EObject")
editormodel_Point = Class(name="editormodel_Point")
editormodel_Dimension = Class(name="editormodel_Dimension")
editormodel_Color = Class(name="editormodel_Color")
editormodel_Adapter = Class(name="editormodel_Adapter", is_abstract=True)
editormodel_ConnectionBendpoint = Class(name="editormodel_ConnectionBendpoint")
editormodel_ConnectionVisualModel = Class(name="editormodel_ConnectionVisualModel")
NodeVisualModel = Class(name="NodeVisualModel")
editormodel_EStringToEObjectMapEntry = Class(name="editormodel_EStringToEObjectMapEntry")
editormodel_VisualDiagramJump = Class(name="editormodel_VisualDiagramJump")
...
editormodel_VisualModel.attributes={editormodel_VisualModel_lineWidth, editormodel_VisualModel_lineStyle, editormodel_VisualModel_detailLevel}
...
editormodel_FlabotFileModel.attributes={editormodel_FlabotFileModel_version, editormodel_FlabotFileModel_id, editormodel_FlabotFileModel_provider, editormodel_FlabotFileModel_name}
...
editormodel_Point.attributes={editormodel_Point_y, editormodel_Point_x}
...
domain_model = DomainModel(
    name="editormodel",
    types={Adapter, editormodel_Diagram, NamedElementModel, editormodel_CoreModel, editormodel_Note, editormodel_VisualModel, editormodel_Folder, editormodel_FlabotFileModel, ExtensibleElement, editormodel_NodeVisualModel, VisualModel, editormodel_EObject, editormodel_Point, editormodel_Dimension, editormodel_Color, editormodel_Adapter, editormodel_ConnectionBendpoint, editormodel_ConnectionVisualModel, NodeVisualModel, editormodel_EStringToEObjectMapEntry, editormodel_VisualDiagramJump},
    associations={importedFiles9, folder11, openDiagrams13, children17, coreModel0, notes1, children3, folder4, coreModel5, diagrams6, bendpoints39, source41, target42, sourceConnections44, targetConnections45, parent20, semanticModel22, location23, size25, diagram27, backgroundColor29, foregroundColor31, firstRelativeDimension34, secondRelativeDimension36, targetVisualNode66, folders48, diagrams51, parent54, fileModel56, value59, sourceDiagram61, targetDiagram63},
    generalizations={gen_editormodel_VisualModel_Adapter, gen_editormodel_Diagram_NamedElementModel, gen_editormodel_FlabotFileModel_ExtensibleElement, gen_editormodel_NodeVisualModel_VisualModel, gen_editormodel_ConnectionVisualModel_NodeVisualModel, gen_editormodel_VisualDiagramJump_NodeVisualModel},
    metadata=None
)
