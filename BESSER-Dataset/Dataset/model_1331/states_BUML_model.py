...
# Classes
states_EObject = Class(name="states_EObject")
states_Event = Class(name="states_Event")
states_ActionExecution = Class(name="states_ActionExecution")
states_StateSystem = Class(name="states_StateSystem")
states_State = Class(name="states_State")
states_Transition = Class(name="states_Transition")
states_Trace = Class(name="states_Trace")
...
domain_model = DomainModel(
    name="states",
    types={states_EObject, states_Event, states_ActionExecution, states_StateSystem, states_State, states_Transition, states_Trace},
    associations={objects8, source10, target11, event13, actionExecution15, states0, transitions1, trace3, outgoing5, incoming6},
    generalizations={},
    metadata=None
)
