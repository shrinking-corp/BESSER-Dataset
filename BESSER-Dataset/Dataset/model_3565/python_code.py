...
class go_Atrib(varFor):
    ...
    def __init__(self, modifier: str, name: str, type: str, go_Atrib15: "go_Atrib_Aux" = None, go_Atrib18: "go_EObject" = None, go_Atrib: "go_DecVar" = None):
...
class go_ComparisonExpression(Expression):
    ...
    pass
class go_Numbers(Expression, F, TypeValue):
...
class go_Variable(operationsOne, SwitchCase, Atrib_Aux, Greeting, Expression, OperationsOneEquals):
