...
# Classes
go_Go = Class(name="go_Go")
Atrib_Aux = Class(name="Atrib_Aux")
...
go_Cases = Class(name="go_Cases")
varFor = Class(name="varFor")
go_EObject = Class(name="go_EObject")
go_Greeting = Class(name="go_Greeting")
go_Decl = Class(name="go_Decl")
go_DecVar = Class(name="go_DecVar")
Greeting = Class(name="Greeting")
go_Atrib = Class(name="go_Atrib")
go_AtribVar = Class(name="go_AtribVar")
go_ReAtrib = Class(name="go_ReAtrib")
go_Atrib_Aux = Class(name="go_Atrib_Aux")
go_Variable = Class(name="go_Variable")
go_SwitchCase = Class(name="go_SwitchCase")
go_Expression = Class(name="go_Expression")
go_Atri = Class(name="go_Atri")
go_Params = Class(name="go_Params")
Atri = Class(name="Atri")
go_MultDecVars = Class(name="go_MultDecVars")
go_TypeValue = Class(name="go_TypeValue")
go_DecVars = Class(name="go_DecVars")
go_Operations = Class(name="go_Operations")
go_I = Class(name="go_I")
go_T = Class(name="go_T")
Operations = Class(name="Operations")
I = Class(name="I")
go_Y = Class(name="go_Y")
go_F = Class(name="go_F")
T = Class(name="T")
go_Condition = Class(name="go_Condition")
go_IfCondition = Class(name="go_IfCondition")
go_ElseIfCondition = Class(name="go_ElseIfCondition")
go_Str = Class(name="go_Str")
TypeValue = Class(name="TypeValue")
go_OperationsOneEquals = Class(name="go_OperationsOneEquals")
go_Numbers = Class(name="go_Numbers")
F = Class(name="F")
go_Intg = Class(name="go_Intg")
go_Double = Class(name="go_Double")
CallFor = Class(name="CallFor")
go_DecFunc = Class(name="go_DecFunc")
go_FunctionBody = Class(name="go_FunctionBody")
go_ElseCondition = Class(name="go_ElseCondition")
ElseIfCondition = Class(name="ElseIfCondition")
go_CallFor = Class(name="go_CallFor")
go_operationsOne = Class(name="go_operationsOne")
go_varFor = Class(name="go_varFor")
go_Multiplication = Class(name="go_Multiplication")
go_Division = Class(name="go_Division")
go_OrExpression = Class(name="go_OrExpression")
go_FunctionReturn = Class(name="go_FunctionReturn")
go_CallFunc = Class(name="go_CallFunc")
go_Bool = Class(name="go_Bool")
go_DataType = Class(name="go_DataType")
go_Addition = Class(name="go_Addition")
go_Subtration = Class(name="go_Subtration")
go_AndExpression = Class(name="go_AndExpression")
go_ComparisonExpression = Class(name="go_ComparisonExpression")
...
go_Decl.attributes={go_Decl_type, go_Decl_name}
...
go_Atrib.attributes={go_Atrib_type, go_Atrib_modifier, go_Atrib_name}
...
go_AtribVar.attributes={go_AtribVar_vars, go_AtribVar_type}
...
go_Params.attributes={go_Params_type, go_Params_params}
...
go_DecFunc.attributes={go_DecFunc_returnType, go_DecFunc_name}
...
if_40: BinaryAssociation = BinaryAssociation(
    name="if_40",
    ends={
...
else_43: BinaryAssociation = BinaryAssociation(
    name="else_43",
    ends={
...
domain_model = DomainModel(
    name="go",
    types={go_Go, Atrib_Aux, SwitchCase, OperationsOneEquals, operationsOne, Expression, go_Cases, varFor, go_EObject, go_Greeting, go_Decl, go_DecVar, Greeting, go_Atrib, go_AtribVar, go_ReAtrib, go_Atrib_Aux, go_Variable, go_SwitchCase, go_Expression, go_Atri, go_Params, Atri, go_MultDecVars, go_TypeValue, go_DecVars, go_Operations, go_I, go_T, Operations, I, go_Y, go_F, T, go_Condition, go_IfCondition, go_ElseIfCondition, go_Str, TypeValue, go_OperationsOneEquals, go_Numbers, F, go_Intg, go_Double, CallFor, go_DecFunc, go_FunctionBody, go_ElseCondition, ElseIfCondition, go_CallFor, go_operationsOne, go_varFor, go_Multiplication, go_Division, go_OrExpression, go_FunctionReturn, go_CallFunc, go_Bool, go_DataType, go_Addition, go_Subtration, go_AndExpression, go_ComparisonExpression, go_Literal},
    associations={cas10, k11, atrib14, k17, elements0, declaration1, atribuicao2, assignment4, reassignment6, atrb8, x28, v30, atrib19, k22, typw25, atrb26, o36, o38, if_40, elseif41, int33, d34, param65, body66, args68, else_43, cond45, then48, then51, boolean55, sum58, sub61, x63, right85, left88, right90, left93, right95, ret71, returnType73, param76, left78, right80, left83, left98, right100, left103, right105, left108, right110, value113},
    generalizations={gen_go_Variable_Greeting, gen_go_Variable_Atrib_Aux, gen_go_Variable_SwitchCase, gen_go_Variable_OperationsOneEquals, gen_go_Variable_operationsOne, gen_go_Variable_Expression, gen_go_Atrib_varFor, gen_go_ReAtrib_varFor, gen_go_DecVar_Greeting, gen_go_SwitchCase_Greeting, gen_go_Atri_Atrib_Aux, gen_go_TypeValue_Atri, gen_go_MultDecVars_Greeting, gen_go_Operations_Atrib_Aux, gen_go_T_Operations, gen_go_T_I, gen_go_F_T, gen_go_Condition_Greeting, gen_go_Str_TypeValue, gen_go_Numbers_TypeValue, gen_go_Numbers_F, gen_go_Numbers_Expression, gen_go_varFor_CallFor, gen_go_DecFunc_Greeting, gen_go_IfCondition_ElseIfCondition, gen_go_Expression_varFor, gen_go_CallFor_Greeting, gen_go_Multiplication_Expression, gen_go_Division_Expression, gen_go_OrExpression_Expression, gen_go_CallFunc_Greeting, gen_go_CallFunc_Atrib_Aux, gen_go_Bool_TypeValue, gen_go_DataType_Greeting, gen_go_Addition_Expression, gen_go_Subtration_Expression, gen_go_AndExpression_Expression, gen_go_ComparisonExpression_Expression, gen_go_Literal_Expression},
    metadata=None
)
