...
def test_hyp_go_functionreturn_is_not_abstract():
    assert not inspect.isabstract(go_FunctionReturn)


def test_hyp_go_functionreturn_constructor_exists():
    assert callable(go_FunctionReturn.__init__)


def test_hyp_go_functionreturn_constructor_args():
    sig = inspect.signature(go_FunctionReturn.__init__)
    params = list(sig.parameters.keys())



def test_hyp_go_operationsone_is_not_abstract():
    assert not inspect.isabstract(go_operationsOne)


def test_hyp_go_operationsone_constructor_exists():
    assert callable(go_operationsOne.__init__)


def test_hyp_go_operationsone_constructor_args():
...
def test_hyp_callfor_is_not_abstract():
    assert not inspect.isabstract(CallFor)


def test_hyp_callfor_constructor_exists():
    assert callable(CallFor.__init__)


def test_hyp_callfor_constructor_args():
    sig = inspect.signature(CallFor.__init__)
    params = list(sig.parameters.keys())



def test_hyp_go_varfor_is_not_abstract():
    assert not inspect.isabstract(go_varFor)


def test_hyp_go_varfor_constructor_exists():
    assert callable(go_varFor.__init__)


def test_hyp_go_varfor_constructor_args():
    sig = inspect.signature(go_varFor.__init__)
    params = list(sig.parameters.keys())



def test_hyp_go_double_is_not_abstract():
    assert not inspect.isabstract(go_Double)


def test_hyp_go_double_constructor_exists():
    assert callable(go_Double.__init__)


def test_hyp_go_double_constructor_args():
...
def test_hyp_go_intg_is_not_abstract():
    assert not inspect.isabstract(go_Intg)


def test_hyp_go_intg_constructor_exists():
    assert callable(go_Intg.__init__)


def test_hyp_go_intg_constructor_args():
...
def test_hyp_go_operationsoneequals_is_not_abstract():
    assert not inspect.isabstract(go_OperationsOneEquals)


def test_hyp_go_operationsoneequals_constructor_exists():
    assert callable(go_OperationsOneEquals.__init__)


def test_hyp_go_operationsoneequals_constructor_args():
    sig = inspect.signature(go_OperationsOneEquals.__init__)
    params = list(sig.parameters.keys())



def test_hyp_typevalue_is_not_abstract():
    assert not inspect.isabstract(TypeValue)


def test_hyp_typevalue_constructor_exists():
    assert callable(TypeValue.__init__)


def test_hyp_typevalue_constructor_args():
    sig = inspect.signature(TypeValue.__init__)
    params = list(sig.parameters.keys())



def test_hyp_go_bool_is_not_abstract():
    assert not inspect.isabstract(go_Bool)


def test_hyp_go_bool_constructor_exists():
    assert callable(go_Bool.__init__)


def test_hyp_go_bool_constructor_args():
...
def test_hyp_go_str_is_not_abstract():
    assert not inspect.isabstract(go_Str)


def test_hyp_go_str_constructor_exists():
    assert callable(go_Str.__init__)


def test_hyp_go_str_constructor_args():
...
def test_hyp_go_f_is_not_abstract():
    assert not inspect.isabstract(go_F)


def test_hyp_go_f_constructor_exists():
    assert callable(go_F.__init__)


def test_hyp_go_f_constructor_args():
    sig = inspect.signature(go_F.__init__)
    params = list(sig.parameters.keys())



def test_hyp_go_y_is_not_abstract():
    assert not inspect.isabstract(go_Y)


def test_hyp_go_y_constructor_exists():
    assert callable(go_Y.__init__)


def test_hyp_go_y_constructor_args():
...
def test_hyp_go_t_is_not_abstract():
    assert not inspect.isabstract(go_T)


def test_hyp_go_t_constructor_exists():
    assert callable(go_T.__init__)


def test_hyp_go_t_constructor_args():
    sig = inspect.signature(go_T.__init__)
    params = list(sig.parameters.keys())



def test_hyp_go_i_is_not_abstract():
    assert not inspect.isabstract(go_I)


def test_hyp_go_i_constructor_exists():
    assert callable(go_I.__init__)


def test_hyp_go_i_constructor_args():
    sig = inspect.signature(go_I.__init__)
    params = list(sig.parameters.keys())



def test_hyp_go_decvars_is_not_abstract():
    assert not inspect.isabstract(go_DecVars)


def test_hyp_go_decvars_constructor_exists():
    assert callable(go_DecVars.__init__)


def test_hyp_go_decvars_constructor_args():
...
def test_hyp_atri_is_not_abstract():
    assert not inspect.isabstract(Atri)


def test_hyp_atri_constructor_exists():
    assert callable(Atri.__init__)


def test_hyp_atri_constructor_args():
    sig = inspect.signature(Atri.__init__)
    params = list(sig.parameters.keys())



def test_hyp_go_typevalue_is_not_abstract():
    assert not inspect.isabstract(go_TypeValue)


def test_hyp_go_typevalue_constructor_exists():
    assert callable(go_TypeValue.__init__)


def test_hyp_go_typevalue_constructor_args():
    sig = inspect.signature(go_TypeValue.__init__)
    params = list(sig.parameters.keys())



def test_hyp_go_params_is_not_abstract():
    assert not inspect.isabstract(go_Params)


def test_hyp_go_params_constructor_exists():
    assert callable(go_Params.__init__)


def test_hyp_go_params_constructor_args():
...
def test_hyp_go_atrib_aux_is_not_abstract():
    assert not inspect.isabstract(go_Atrib_Aux)


def test_hyp_go_atrib_aux_constructor_exists():
    assert callable(go_Atrib_Aux.__init__)


def test_hyp_go_atrib_aux_constructor_args():
    sig = inspect.signature(go_Atrib_Aux.__init__)
    params = list(sig.parameters.keys())



def test_hyp_go_atribvar_is_not_abstract():
    assert not inspect.isabstract(go_AtribVar)


def test_hyp_go_atribvar_constructor_exists():
    assert callable(go_AtribVar.__init__)


def test_hyp_go_atribvar_constructor_args():
...
def test_hyp_go_switchcase_is_not_abstract():
    assert not inspect.isabstract(go_SwitchCase)


def test_hyp_go_switchcase_constructor_exists():
    assert callable(go_SwitchCase.__init__)


def test_hyp_go_switchcase_constructor_args():
    sig = inspect.signature(go_SwitchCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_go_decfunc_is_not_abstract():
    assert not inspect.isabstract(go_DecFunc)


def test_hyp_go_decfunc_constructor_exists():
    assert callable(go_DecFunc.__init__)


def test_hyp_go_decfunc_constructor_args():
...
def test_hyp_go_datatype_is_not_abstract():
    assert not inspect.isabstract(go_DataType)


def test_hyp_go_datatype_constructor_exists():
    assert callable(go_DataType.__init__)


def test_hyp_go_datatype_constructor_args():
...
def test_hyp_go_callfor_is_not_abstract():
    assert not inspect.isabstract(go_CallFor)


def test_hyp_go_callfor_constructor_exists():
    assert callable(go_CallFor.__init__)


def test_hyp_go_callfor_constructor_args():
    sig = inspect.signature(go_CallFor.__init__)
    params = list(sig.parameters.keys())



def test_hyp_go_multdecvars_is_not_abstract():
    assert not inspect.isabstract(go_MultDecVars)


def test_hyp_go_multdecvars_constructor_exists():
    assert callable(go_MultDecVars.__init__)


def test_hyp_go_multdecvars_constructor_args():
...
def test_hyp_go_decvar_is_not_abstract():
    assert not inspect.isabstract(go_DecVar)


def test_hyp_go_decvar_constructor_exists():
    assert callable(go_DecVar.__init__)


def test_hyp_go_decvar_constructor_args():
    sig = inspect.signature(go_DecVar.__init__)
    params = list(sig.parameters.keys())



def test_hyp_go_decl_is_not_abstract():
    assert not inspect.isabstract(go_Decl)


def test_hyp_go_decl_constructor_exists():
    assert callable(go_Decl.__init__)


def test_hyp_go_decl_constructor_args():
...
def test_hyp_go_greeting_is_not_abstract():
    assert not inspect.isabstract(go_Greeting)


def test_hyp_go_greeting_constructor_exists():
    assert callable(go_Greeting.__init__)


def test_hyp_go_greeting_constructor_args():
...
def test_hyp_varfor_is_not_abstract():
    assert not inspect.isabstract(varFor)


def test_hyp_varfor_constructor_exists():
    assert callable(varFor.__init__)


def test_hyp_varfor_constructor_args():
...
def test_hyp_go_atrib_is_not_abstract():
    assert not inspect.isabstract(go_Atrib)


def test_hyp_go_atrib_constructor_exists():
    assert callable(go_Atrib.__init__)


def test_hyp_go_atrib_constructor_args():
...
def test_hyp_go_reatrib_is_not_abstract():
    assert not inspect.isabstract(go_ReAtrib)


def test_hyp_go_reatrib_constructor_exists():
    assert callable(go_ReAtrib.__init__)


def test_hyp_go_reatrib_constructor_args():
...
def test_hyp_go_cases_is_not_abstract():
    assert not inspect.isabstract(go_Cases)


def test_hyp_go_cases_constructor_exists():
    assert callable(go_Cases.__init__)


def test_hyp_go_cases_constructor_args():
...
def test_hyp_go_addition_is_not_abstract():
    assert not inspect.isabstract(go_Addition)


def test_hyp_go_addition_constructor_exists():
    assert callable(go_Addition.__init__)


def test_hyp_go_addition_constructor_args():
    sig = inspect.signature(go_Addition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_go_numbers_is_not_abstract():
    assert not inspect.isabstract(go_Numbers)


def test_hyp_go_numbers_constructor_exists():
    assert callable(go_Numbers.__init__)


def test_hyp_go_numbers_constructor_args():
    sig = inspect.signature(go_Numbers.__init__)
    params = list(sig.parameters.keys())



def test_hyp_go_andexpression_is_not_abstract():
    assert not inspect.isabstract(go_AndExpression)


def test_hyp_go_andexpression_constructor_exists():
    assert callable(go_AndExpression.__init__)


def test_hyp_go_andexpression_constructor_args():
...
def test_hyp_go_comparisonexpression_is_not_abstract():
    assert not inspect.isabstract(go_ComparisonExpression)


def test_hyp_go_comparisonexpression_constructor_exists():
    assert callable(go_ComparisonExpression.__init__)


def test_hyp_go_comparisonexpression_constructor_args():
    sig = inspect.signature(go_ComparisonExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_go_subtration_is_not_abstract():
    assert not inspect.isabstract(go_Subtration)


def test_hyp_go_subtration_constructor_exists():
    assert callable(go_Subtration.__init__)


def test_hyp_go_subtration_constructor_args():
    sig = inspect.signature(go_Subtration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_go_division_is_not_abstract():
    assert not inspect.isabstract(go_Division)


def test_hyp_go_division_constructor_exists():
    assert callable(go_Division.__init__)


def test_hyp_go_division_constructor_args():
    sig = inspect.signature(go_Division.__init__)
    params = list(sig.parameters.keys())



def test_hyp_go_multiplication_is_not_abstract():
    assert not inspect.isabstract(go_Multiplication)


def test_hyp_go_multiplication_constructor_exists():
    assert callable(go_Multiplication.__init__)


def test_hyp_go_multiplication_constructor_args():
    sig = inspect.signature(go_Multiplication.__init__)
    params = list(sig.parameters.keys())



def test_hyp_go_orexpression_is_not_abstract():
    assert not inspect.isabstract(go_OrExpression)


def test_hyp_go_orexpression_constructor_exists():
    assert callable(go_OrExpression.__init__)


def test_hyp_go_orexpression_constructor_args():
    sig = inspect.signature(go_OrExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_operationsone_is_not_abstract():
    assert not inspect.isabstract(operationsOne)


def test_hyp_operationsone_constructor_exists():
    assert callable(operationsOne.__init__)


def test_hyp_operationsone_constructor_args():
    sig = inspect.signature(operationsOne.__init__)
    params = list(sig.parameters.keys())



def test_hyp_operationsoneequals_is_not_abstract():
    assert not inspect.isabstract(OperationsOneEquals)


def test_hyp_operationsoneequals_constructor_exists():
    assert callable(OperationsOneEquals.__init__)


def test_hyp_operationsoneequals_constructor_args():
...
def test_hyp_atrib_aux_is_not_abstract():
    assert not inspect.isabstract(Atrib_Aux)


def test_hyp_atrib_aux_constructor_exists():
    assert callable(Atrib_Aux.__init__)


def test_hyp_atrib_aux_constructor_args():
    sig = inspect.signature(Atrib_Aux.__init__)
    params = list(sig.parameters.keys())



def test_hyp_go_callfunc_is_not_abstract():
    assert not inspect.isabstract(go_CallFunc)


def test_hyp_go_callfunc_constructor_exists():
    assert callable(go_CallFunc.__init__)


def test_hyp_go_callfunc_constructor_args():
...
def test_hyp_go_variable_is_not_abstract():
    assert not inspect.isabstract(go_Variable)


def test_hyp_go_variable_constructor_exists():
    assert callable(go_Variable.__init__)


def test_hyp_go_variable_constructor_args():
...
def test_hyp_go_operations_is_not_abstract():
    assert not inspect.isabstract(go_Operations)


def test_hyp_go_operations_constructor_exists():
    assert callable(go_Operations.__init__)


def test_hyp_go_operations_constructor_args():
    sig = inspect.signature(go_Operations.__init__)
    params = list(sig.parameters.keys())



def test_hyp_go_atri_is_not_abstract():
    assert not inspect.isabstract(go_Atri)


def test_hyp_go_atri_constructor_exists():
    assert callable(go_Atri.__init__)


def test_hyp_go_atri_constructor_args():
    sig = inspect.signature(go_Atri.__init__)
    params = list(sig.parameters.keys())



def test_hyp_go_go_is_not_abstract():
    assert not inspect.isabstract(go_Go)


def test_hyp_go_go_constructor_exists():
    assert callable(go_Go.__init__)


def test_hyp_go_go_constructor_args():
...
def test_hyp_go_double_d_setter(instance):
    original = instance.d
    instance.d = original
...
def test_hyp_go_intg_i_setter(instance):
    original = instance.i
    instance.i = original
...
def test_hyp_go_bool_val_setter(instance):
...
def test_hyp_go_str_s_setter(instance):
    original = instance.s
    instance.s = original
...
def test_hyp_go_decvars_vars_setter(instance):
...
def test_hyp_go_params_params_setter(instance):
...
@given(instance=go_Params_strategy)
def test_hyp_go_params_type_setter(instance):
...
def test_hyp_go_atribvar_vars_setter(instance):
    original = instance.vars
    instance.vars = original
    assert instance.vars == original
...
@given(instance=go_AtribVar_strategy)
def test_hyp_go_atribvar_type_setter(instance):
    original = instance.type
    instance.type = original
    assert instance.type == original
...
def test_hyp_go_decfunc_name_setter(instance):
...
@given(instance=go_DecFunc_strategy)
def test_hyp_go_decfunc_returnType_setter(instance):
...
def test_hyp_go_datatype_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_go_multdecvars_value_setter(instance):
...
@given(instance=go_MultDecVars_strategy)
def test_hyp_go_multdecvars_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_go_decl_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=go_Decl_strategy)
def test_hyp_go_decl_type_setter(instance):
    original = instance.type
    instance.type = original
    assert instance.type == original
...
def test_hyp_go_atrib_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=go_Atrib_strategy)
def test_hyp_go_atrib_type_setter(instance):
    original = instance.type
    instance.type = original
    assert instance.type == original
...
@given(instance=go_Atrib_strategy)
def test_hyp_go_atrib_modifier_setter(instance):
...
def test_hyp_go_reatrib_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_go_callfunc_nameFunc_setter(instance):
...
def test_hyp_go_variable_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
