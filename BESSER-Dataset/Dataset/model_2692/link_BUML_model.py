...
# Classes
link_A = Class(name="link_A")
Named = Class(name="Named")
link_B = Class(name="link_B")
link_C = Class(name="link_C")
link_W = Class(name="link_W")
link_M = Class(name="link_M")
link_N99 = Class(name="link_N99")
link_X = Class(name="link_X")
link_K = Class(name="link_K")
link_Named = Class(name="link_Named", is_abstract=True)
link_D = Class(name="link_D")
...
as_14: BinaryAssociation = BinaryAssociation(
    name="as_14",
    ends={
...
domain_model = DomainModel(
    name="link",
    types={link_A, Named, link_B, link_C, link_W, link_M, link_N99, link_X, link_K, link_Named, link_D},
    associations={bs0, cs1, ws3, ms5, ns9997, as_14, ks16, wc18, mk21, ma24, nk27, b9, ds12},
    generalizations={gen_link_A_Named, gen_link_B_Named, gen_link_C_Named, gen_link_X_Named, gen_link_W_Named, gen_link_K_Named, gen_link_M_Named, gen_link_N99_Named, gen_link_D_Named},
    metadata=None
)
