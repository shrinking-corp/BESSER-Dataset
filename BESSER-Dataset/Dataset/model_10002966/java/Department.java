...
public class Department  {
    ...
    public Department(
        None hod,        None course,        None students__,        None teachers__    ) {
        this.hod = hod;
        this.course = course;
    ...
    public Department(
        None hod,        None course,        None students__,        None teachers__        ArrayList<Employee_Interface> employee_interfaces,        ArrayList<Student> students    ) {
        this.hod = hod;
        this.course = course;
        this.students__ = students__;
        this.teachers__ = teachers__;
