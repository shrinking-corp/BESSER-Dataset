...
class FormalParameterList:
    ...
    pass
class service_Filter(FormalParameterList, NamedDisplayElement):
...
class service_Selection(FormalParameterList, NamedElement):
    ...
    def __init__(self, distinct: bool, limit: int, methodName: str, selections: "service_Service" = None, service_Selection20: set["service_Feature"] = None, service_Selection22: set["service_Association"] = None, Selection: "service_Service" = None, service_Selection: "service_Service" = None, service_Selection9: "service_Service" = None, service_Selection24: "service_Predicate" = None, selection: set["service_Filter"] = None, service_Selection27: set["service_Order"] = None, service_Selection29: set["service_EntityAssociation"] = None, Selection41: "service_Filter" = None):
...
class service_BusinessOperation(FormalParameterList, NamedElement):
