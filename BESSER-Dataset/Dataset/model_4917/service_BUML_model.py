...
# Classes
service_Services = Class(name="service_Services")
service_Expression = Class(name="service_Expression")
FormalParameterList = Class(name="FormalParameterList")
service_Feature = Class(name="service_Feature")
service_Association = Class(name="service_Association")
service_Service = Class(name="service_Service")
NamedElement = Class(name="NamedElement")
service_Constant = Class(name="service_Constant")
service_EntityOrView = Class(name="service_EntityOrView")
service_Selection = Class(name="service_Selection")
service_BusinessOperation = Class(name="service_BusinessOperation")
service_ServiceFeatureReference = Class(name="service_ServiceFeatureReference")
service_Asc = Class(name="service_Asc")
Order = Class(name="Order")
service_Desc = Class(name="service_Desc")
service_Predicate = Class(name="service_Predicate")
service_Filter = Class(name="service_Filter")
service_Order = Class(name="service_Order", is_abstract=True)
service_EntityAssociation = Class(name="service_EntityAssociation")
service_Variable = Class(name="service_Variable")
service_ConstantReference = Class(name="service_ConstantReference")
...
service_Selection.attributes={service_Selection_distinct, service_Selection_methodName, service_Selection_limit}
...
domain_model = DomainModel(
    name="service",
    types={service_Services, service_Expression, FormalParameterList, service_Feature, service_Association, service_Service, NamedElement, service_Constant, service_EntityOrView, service_Selection, service_BusinessOperation, service_ServiceFeatureReference, service_Asc, Order, service_Desc, service_Predicate, service_Filter, service_Order, service_EntityAssociation, service_Variable, service_ConstantReference, Variable, NamedDisplayElement, OperationResultTypes},
    associations={uses13, definedBy15, value16, usedBy17, fields19, joins21, services0, constants1, serves2, selections4, findAll5, findOne7, operations10, value32, feature34, definedBy36, uses38, condition23, filters25, ordering26, selectPath28, path30, selection40, condition42},
    generalizations={gen_service_Constant_NamedElement, gen_service_Selection_NamedElement, gen_service_Selection_FormalParameterList, gen_service_Service_NamedElement, gen_service_ServiceFeatureReference_Variable, gen_service_Asc_Order, gen_service_Desc_Order, gen_service_BusinessOperation_NamedElement, gen_service_BusinessOperation_FormalParameterList, gen_service_ConstantReference_Variable, gen_service_Filter_NamedDisplayElement, gen_service_Filter_FormalParameterList},
    metadata=None
)
