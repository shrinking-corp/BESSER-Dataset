...
class Project:
    ...
    def __init__(self, Team___: str, PorjectID: int, Title: str, Created: str, Deadline: str, StatusID: int, PriorityID: int, Author: User, ProjectManager: User, Assignee: User, Description: str, Subscriptions___: str, Comments___: str, Attachments___: str, Activities___: str, User1: "User" = None, User3: "User" = None, User5: "User" = None, Activity8: set["Activity"] = None, Comment10: set["Comment"] = None, Attachment16: set["Attachment"] = None, User20: "User" = None):
...
class User:
    ...
    def __init__(self, Username: str, Password: str, Firstname: str, Lastname: str, Dateofbirth: str, Email: str, Phone: str, DepartmentID: int, TitleID: int, Active: bool, Settings: str, Position: str, Hiredate: str, About: str, Facebook_link: str, Google_plus_link: str, Linkedin_link: str, Roles___: str, UserID: int, Author0: "Project" = None, ProjectMan_2: set["Project"] = None, Assignee4: set["Project"] = None, Activity6: set["Activity"] = None, Comment12: set["Comment"] = None, Attachment14: set["Attachment"] = None, Role18: set["Role"] = None, Project21: "Project" = None):
