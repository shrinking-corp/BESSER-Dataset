...
User.attributes={User_Facebook_link, User_TitleID, User_Position, User_Firstname, User_Roles___, User_Active, User_Dateofbirth, User_UserID, User_Username, User_Password, User_DepartmentID, User_Linkedin_link, User_Email, User_Lastname, User_Phone, User_Hiredate, User_Google_plus_link, User_Settings, User_About}
...
Project.attributes={Project_Description, Project_Assignee, Project_StatusID, Project_Activities___, Project_Attachments___, Project_Created, Project_Team___, Project_Comments___, Project_Title, Project_Author, Project_Subscriptions___, Project_PorjectID, Project_Deadline, Project_PriorityID, Project_ProjectManager}
...
Activity.attributes={Activity_Seen, Activity_PrevValue, Activity_Project, Activity_NewValue, Activity_ActivityID, Activity_ActivityType, Activity_User, Activity_ActivitySubType}
...
Comment.attributes={Comment_CommentID, Comment_User, Comment_Project, Comment_Content, Comment_Created}
...
Attachment.attributes={Attachment_User, Attachment_Size, Attachment_Path, Attachment_Created, Attachment_Extension, Attachment_Name, Attachment_Project, Attachment_AttachmentID}
...
Role.attributes={Role_Description, Role_Name, Role_RoleID}
...
domain_model = DomainModel(
    name="e8419103_a650_4a5f_87f7_3ce138832f69",
