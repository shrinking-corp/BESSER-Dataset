...
# Classes
traces_TraceSet = Class(name="traces_TraceSet")
...
domain_model = DomainModel(
    name="traces",
    types={traces_TraceSet, traces_Trace, traces_EObject},
    associations={traces0, fromDomainElement1, toAnalyzableElement3},
    generalizations={},
    metadata=None
)
