...
class model_Transition:
    ...
    def __init__(self, name: str, trigger: str, action: str, Transition: "model_FSM" = None, Transition5: "model_State" = None, Transition7: "model_State" = None, incoming: "model_State" = None, outgoing: "model_State" = None, ownedTransitions: "model_FSM" = None):
        self.name = name
...
class model_State:
    ...
    def __init__(self, name: str, State: "model_FSM" = None, model_State: "model_FSM" = None, tgt: set["model_Transition"] = None, src: set["model_Transition"] = None, ownedStates: "model_FSM" = None, State10: "model_Transition" = None, State12: "model_Transition" = None):
        self.name = name
        self.State = State
...
class model_FSM:
    ...
    def __init__(self, name: str, fsm: set["model_State"] = None, fsm2: set["model_Transition"] = None, model_FSM: "model_State" = None, FSM: "model_State" = None, FSM14: "model_Transition" = None):
        self.name = name
