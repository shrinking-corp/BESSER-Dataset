...
class library_Unit(Base):
    ...
    def __init__(self, code: str, description: str, name: str, library_Unit88: "library_Library" = None, library_Unit: "library_BaseResource" = None, library_Unit130: "library_MultiImage" = None):
        self.code = code
...
class library_Expression(Base):
    ...
    def __init__(self, expressionLines: str, name: str, library_Expression: "library_Component" = None, library_Expression85: "library_Library" = None, library_Expression9: "library_Component" = None, library_Expression39: "library_EquipmentGroup" = None, library_Expression53: "library_EObject" = None, library_Expression128: "library_Tolerance" = None):
...
class library_Library:
    ...
    def __init__(self, protocols: str, name: str, library_Library90: "library_Meta" = None, library_Library81: set["library_Tolerance"] = None, library_Library84: set["library_Expression"] = None, library_Library87: set["library_Unit"] = None, library_Library68: set["library_NodeType"] = None, library_Library70: set["library_Equipment"] = None, library_Library73: set["library_Metric"] = None, library_Library76: set["library_MetricSource"] = None, library_Library78: set["library_Parameter"] = None, library_Library: set["library_Function"] = None):
...
class library_NodeType(Base):
    ...
    def __init__(self, leafNode: str, name: str, library_NodeType113: set["library_Function"] = None, library_NodeType116: set["library_Equipment"] = None, library_NodeType: "library_Library" = None, library_NodeType125: "library_ProductInfo" = None):
...
class library_EquipmentGroup(Base):
    ...
    def __init__(self, count: str, description: str, name: str, library_EquipmentGroup: "library_Equipment" = None, library_EquipmentGroup41: set["library_Equipment"] = None, library_EquipmentGroup44: set["library_Parameter"] = None, library_EquipmentGroup47: set["library_NetXResource"] = None, library_EquipmentGroup50: set["library_Equipment"] = None, library_EquipmentGroup32: set["library_DiagramInfo"] = None, library_EquipmentGroup35: set["library_NetXResource"] = None, library_EquipmentGroup38: set["library_Expression"] = None):
        self.count = count
        self.description = description
        self.name = name
...
class library_Tolerance(Base):
    ...
    def __init__(self, level: str, name: str, library_Tolerance82: "library_Library" = None, library_Tolerance: "library_Component" = None, library_Tolerance127: "library_Expression" = None):
        self.level = level
        self.name = name
