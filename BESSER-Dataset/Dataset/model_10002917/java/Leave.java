...
public class Leave  {
    ...
    public Leave(
        int leave_id,        LocalDate Leave_ApplyDate,        LocalDate Leave_StartDate,        String Leave_Title,        int Leave_NoOfDays,        String Leave_Status,        int Emp_Id,        LocalDate Leave_EndDate,        String Leave_detail    ) {
