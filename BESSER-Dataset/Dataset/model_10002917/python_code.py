...
class Employee:
    ...
    def __init__(self, Emp_Email: str, Emp_NIC: str, Emp_Address: str, Emp_DOB: date, Emp_Department: str, Emp_Date_Of_Joint: date, Emp_Position: str, Emp_Salary: float, Emp_Id: int, Emp_Name: str, Emp_ContactNo: str, leave0: "Leave" = None, attendance2: "Attendance" = None, salary4: "Salary" = None):
