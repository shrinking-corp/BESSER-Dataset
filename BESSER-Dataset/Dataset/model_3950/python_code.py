...
class fuzzyAutomaton_TransitionFeature:
    ...
    def __init__(self, name: str, fuzzyAutomaton_TransitionFeature: "fuzzyAutomaton_FuzzyAutomaton" = None, TransitionFeature: "fuzzyAutomaton_Transition" = None, feature: set["fuzzyAutomaton_Transition"] = None, fuzzyAutomaton_TransitionFeature19: "fuzzyAutomaton_Action" = None, fuzzyAutomaton_TransitionFeature21: "fuzzyAutomaton_FuzzyConstraint" = None, fuzzyAutomaton_TransitionFeature23: "fuzzyAutomaton_VarTransformation" = None):
        self.name = name
...
class fuzzyAutomaton_State:
    ...
    def __init__(self, isInitial: str, fuzzyAutomaton_State: "fuzzyAutomaton_FuzzyAutomaton" = None, target: set["fuzzyAutomaton_Transition"] = None, source: set["fuzzyAutomaton_Transition"] = None, State: "fuzzyAutomaton_Transition" = None, State12: "fuzzyAutomaton_Transition" = None):
