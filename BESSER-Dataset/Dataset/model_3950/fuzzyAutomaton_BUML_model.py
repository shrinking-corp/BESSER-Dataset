...
# Classes
fuzzyAutomaton_FuzzyAutomaton = Class(name="fuzzyAutomaton_FuzzyAutomaton")
fuzzyAutomaton_State = Class(name="fuzzyAutomaton_State")
fuzzyAutomaton_Transition = Class(name="fuzzyAutomaton_Transition")
fuzzyAutomaton_VariableSet = Class(name="fuzzyAutomaton_VariableSet")
fuzzyAutomaton_TransitionFeature = Class(name="fuzzyAutomaton_TransitionFeature")
fuzzyAutomaton_Variable = Class(name="fuzzyAutomaton_Variable")
fuzzyAutomaton_Action = Class(name="fuzzyAutomaton_Action", is_abstract=True)
fuzzyAutomaton_FuzzyConstraint = Class(name="fuzzyAutomaton_FuzzyConstraint")
fuzzyAutomaton_VarTransformation = Class(name="fuzzyAutomaton_VarTransformation")
fuzzyAutomaton_Input = Class(name="fuzzyAutomaton_Input")
Action = Class(name="Action")
fuzzyAutomaton_Output = Class(name="fuzzyAutomaton_Output")
fuzzyAutomaton_FuzzyRelation = Class(name="fuzzyAutomaton_FuzzyRelation")
fuzzyAutomaton_VarUpdate = Class(name="fuzzyAutomaton_VarUpdate")
...
fuzzyAutomaton_FuzzyAutomaton.attributes={fuzzyAutomaton_FuzzyAutomaton_tNorm, fuzzyAutomaton_FuzzyAutomaton_name}
...
fuzzyAutomaton_Variable.attributes={fuzzyAutomaton_Variable_name, fuzzyAutomaton_Variable_value}
...
fuzzyAutomaton_FuzzyRelation.attributes={fuzzyAutomaton_FuzzyRelation_tFRelation, fuzzyAutomaton_FuzzyRelation_expression3, fuzzyAutomaton_FuzzyRelation_expression1, fuzzyAutomaton_FuzzyRelation_expression2, fuzzyAutomaton_FuzzyRelation_delta}
...
domain_model = DomainModel(
    name="fuzzyAutomaton",
    types={fuzzyAutomaton_FuzzyAutomaton, fuzzyAutomaton_State, fuzzyAutomaton_Transition, fuzzyAutomaton_VariableSet, fuzzyAutomaton_TransitionFeature, fuzzyAutomaton_Variable, fuzzyAutomaton_Action, fuzzyAutomaton_FuzzyConstraint, fuzzyAutomaton_VarTransformation, fuzzyAutomaton_Input, Action, fuzzyAutomaton_Output, fuzzyAutomaton_FuzzyRelation, fuzzyAutomaton_VarUpdate, TNormType, FuzzyRelationType},
    associations={states0, transitions1, variableSet3, transitionFeatures5, incoming7, outgoing8, source10, target11, feature13, variables14, featureToTransition16, action18, fuzzyConstraint20, varTransformation22, parameters24, fuzzyRelations26, varUpdates28, variable30},
