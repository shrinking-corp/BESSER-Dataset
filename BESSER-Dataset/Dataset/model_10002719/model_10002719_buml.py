...
domain_model = DomainModel(
    name="d16d020f_baf0_4e9e_9f59_341b6176c48c",
    ...
    associations={Student_Course, Exam_Question, Question_Answer, Course_Exam, Admin_Login, Admin_Logout, Instructor_Logout, Student_Logout, Instructor_Login, Login_Student, Login_Add_Student, Login_Add_Instructor, Login_Add_Course, Login_Add_Evalutaions_Assignments_Exams, Login_Generate_Report, Login_Register_drop_course, Login_View_Grades, Submit_Exam_Assignment_Login, School_Admin_Course},
    generalizations={},
    metadata=None
)
