...
# Classes
research15_PublicationProcess = Class(name="research15_PublicationProcess")
Named = Class(name="Named")
research15_Phase = Class(name="research15_Phase")
research15_Researcher = Class(name="research15_Researcher")
research15_Paper = Class(name="research15_Paper")
research15_Skill = Class(name="research15_Skill")
research15_Position = Class(name="research15_Position")
research15_Collaboration = Class(name="research15_Collaboration")
research15_Paragraph = Class(name="research15_Paragraph")
research15_Progress = Class(name="research15_Progress")
research15_PaperKeyword = Class(name="research15_PaperKeyword")
Counted = Class(name="Counted")
research15_ReviewNote = Class(name="research15_ReviewNote")
research15_Write = Class(name="research15_Write")
research15_Review = Class(name="research15_Review")
research15_PublicationStructure = Class(name="research15_PublicationStructure")
research15_KnowledgeManager = Class(name="research15_KnowledgeManager")
research15_PublicationSystem = Class(name="research15_PublicationSystem")
Labelled = Class(name="Labelled")
research15_Labelled = Class(name="research15_Labelled", is_abstract=True)
research15_Keyword = Class(name="research15_Keyword")
research15_Named = Class(name="research15_Named", is_abstract=True)
research15_Counted = Class(name="research15_Counted", is_abstract=True)
...
research15_PublicationProcess.attributes={research15_PublicationProcess_maxTime, research15_PublicationProcess_minTime}
...
research15_Researcher.attributes={research15_Researcher_forName, research15_Researcher_name}
...
domain_model = DomainModel(
    name="research15",
    types={research15_PublicationProcess, Named, research15_Phase, research15_Researcher, research15_Paper, research15_Skill, research15_Position, research15_Collaboration, research15_Paragraph, research15_Progress, research15_PaperKeyword, Counted, research15_ReviewNote, research15_Write, research15_Review, research15_PublicationStructure, research15_KnowledgeManager, research15_PublicationSystem, Labelled, research15_Labelled, research15_Keyword, research15_Named, research15_Counted},
    associations={phases0, res_papers4, skills5, res_position7, collaborations9, paragraphs11, progress12, authors13, keywords14, citedBy17, reviews19, writes1, reviews2, paper23, paragraph25, reviewNote28, researchers31, papers33, knowledgeMan36, processView38, structuralView40, positions43, process21, parent47, kpapers49, allkeywords51, keyword54, col_paper57},
    generalizations={gen_research15_PublicationProcess_Named, gen_research15_Paper_Named, gen_research15_Paragraph_Counted, gen_research15_Paragraph_Named, gen_research15_ReviewNote_Named, gen_research15_Write_Labelled, gen_research15_Review_Labelled, gen_research15_PublicationStructure_Named, gen_research15_PublicationSystem_Named, gen_research15_Progress_Labelled, gen_research15_Position_Named, gen_research15_Keyword_Named, gen_research15_KnowledgeManager_Named},
    metadata=None
)
