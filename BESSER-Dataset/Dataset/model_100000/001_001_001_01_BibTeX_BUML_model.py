...
domain_model = DomainModel(
    name="BIBTEX",
    types={BIBTEX_LocatedElement, Field, BIBTEX_Article, BIBTEX_Book, BIBTEX_Inbook, BIBTEX_Booklet, BIBTEX_Inproceedings, BIBTEX_Bibtex, Entry, BIBTEX_Entry, LocatedElement, BIBTEX_Manual, BIBTEX_Misc, BIBTEX_Field, BIBTEX_Authors, BIBTEX_AuthorUrls, BIBTEX_Title, BIBTEX_Journal, BIBTEX_BookTitle, BIBTEX_Proceedings, BIBTEX_Incollection, BIBTEX_Techreport, BIBTEX_PhdThesis, BIBTEX_MastersThesis, BIBTEX_Chapter, BIBTEX_Volume, BIBTEX_Series, BIBTEX_Pages, BIBTEX_Publisher, BIBTEX_Howpublished, BIBTEX_School, BIBTEX_Editor, BIBTEX_Edition, BIBTEX_Institution, BIBTEX_Organization, BIBTEX_Type, BIBTEX_Day, BIBTEX_Number, BIBTEX_AbstractField, BIBTEX_Isbn, BIBTEX_Issn, BIBTEX_Url, BIBTEX_Doi, BIBTEX_Address, BIBTEX_Year, BIBTEX_Month, BIBTEX_Note, BIBTEX_Text},
    associations={fields1, entries0},
    generalizations={gen_BIBTEX_Article_Entry, gen_BIBTEX_Book_Entry, gen_BIBTEX_Inbook_Entry, gen_BIBTEX_Booklet_Entry, gen_BIBTEX_Inproceedings_Entry, gen_BIBTEX_Entry_LocatedElement, gen_BIBTEX_Manual_Entry, gen_BIBTEX_Misc_Entry, gen_BIBTEX_Authors_Field, gen_BIBTEX_AuthorUrls_Field, gen_BIBTEX_Title_Field, gen_BIBTEX_Journal_Field, gen_BIBTEX_BookTitle_Field, gen_BIBTEX_Proceedings_Entry, gen_BIBTEX_Incollection_Entry, gen_BIBTEX_Techreport_Entry, gen_BIBTEX_PhdThesis_Entry, gen_BIBTEX_MastersThesis_Entry, gen_BIBTEX_Chapter_Field, gen_BIBTEX_Volume_Field, gen_BIBTEX_Series_Field, gen_BIBTEX_Pages_Field, gen_BIBTEX_Publisher_Field, gen_BIBTEX_Howpublished_Field, gen_BIBTEX_School_Field, gen_BIBTEX_Editor_Field, gen_BIBTEX_Edition_Field, gen_BIBTEX_Institution_Field, gen_BIBTEX_Organization_Field, gen_BIBTEX_Type_Field, gen_BIBTEX_Day_Field, gen_BIBTEX_Number_Field, gen_BIBTEX_Text_Field, gen_BIBTEX_AbstractField_Field, gen_BIBTEX_Isbn_Field, gen_BIBTEX_Issn_Field, gen_BIBTEX_Url_Field, gen_BIBTEX_Doi_Field, gen_BIBTEX_Address_Field, gen_BIBTEX_Year_Field, gen_BIBTEX_Month_Field, gen_BIBTEX_Note_Field},
    metadata=None
)
