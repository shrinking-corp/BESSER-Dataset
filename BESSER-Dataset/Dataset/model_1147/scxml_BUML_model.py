...
# Classes
scxml_ScxmlOnexecuteType = Class(name="scxml_ScxmlOnexecuteType")
...
scxml_ScxmlOnexecuteType.attributes={scxml_ScxmlOnexecuteType_any, scxml_ScxmlOnexecuteType_scxmlExecutablecontent, scxml_ScxmlOnexecuteType_anyAttribute}
...
scxml_ScxmlScriptType.attributes={scxml_ScxmlScriptType_any, scxml_ScxmlScriptType_scxmlExtraContent, scxml_ScxmlScriptType_content, scxml_ScxmlScriptType_mixed, scxml_ScxmlScriptType_src}
...
scxml_ScxmlParamType.attributes={scxml_ScxmlParamType_scxmlExtraContent, scxml_ScxmlParamType_expr, scxml_ScxmlParamType_name, scxml_ScxmlParamType_anyAttribute, scxml_ScxmlParamType_any}
...
scxml_ScxmlScxmlType.attributes={scxml_ScxmlScxmlType_id, scxml_ScxmlScxmlType_initial, scxml_ScxmlScxmlType_version}
...
scxml_ScxmlTransitionType.attributes={scxml_ScxmlTransitionType_scxmlExecutablecontent, scxml_ScxmlTransitionType_event, scxml_ScxmlTransitionType_target, scxml_ScxmlTransitionType_cond, scxml_ScxmlTransitionType_any}
...
domain_model = DomainModel(
    name="scxml",
    types={scxml_ScxmlOnexecuteType, scxml_ScxmlSendType, scxml_ScxmlScriptType, scxml_ScxmlParamType, scxml_ScxmlScxmlType, scxml_ScxmlStateType, scxml_ScxmlTransitionType, scxml_DocumentRoot, scxml_EStringToStringMapEntry},
    associations={send0, script1, onexit12, state3, script4, param7, onentry9, transition15, state18, send20, script23, xMLNSPrefixMap26, xSISchemaLocation27, scxml30},
    generalizations={},
    metadata=None
)
