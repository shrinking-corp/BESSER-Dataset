...
class scxml_ScxmlTransitionType:
    ...
    def __init__(self, target: str, scxmlExecutablecontent: str, any: str, cond: str, event: str, scxml_ScxmlTransitionType21: set["scxml_ScxmlSendType"] = None, scxml_ScxmlTransitionType24: set["scxml_ScxmlScriptType"] = None, scxml_ScxmlTransitionType: "scxml_ScxmlStateType" = None):
        self.target = target
    ...
    @property
    def scxmlExecutablecontent(self):
...
class scxml_ScxmlStateType:
    ...
    def __init__(self, id: str, initial: str, scxml_ScxmlStateType13: set["scxml_ScxmlOnexecuteType"] = None, scxml_ScxmlStateType: "scxml_ScxmlScxmlType" = None, scxml_ScxmlStateType10: set["scxml_ScxmlOnexecuteType"] = None, scxml_ScxmlStateType16: set["scxml_ScxmlTransitionType"] = None, scxml_ScxmlStateType19: "scxml_ScxmlStateType" = None, scxml_ScxmlStateType17: set["scxml_ScxmlStateType"] = None):
        self.id = id
...
class scxml_ScxmlScxmlType:
    ...
    def __init__(self, id: str, initial: str, version: str, scxml_ScxmlScxmlType32: "scxml_DocumentRoot" = None, scxml_ScxmlScxmlType: set["scxml_ScxmlStateType"] = None, scxml_ScxmlScxmlType5: set["scxml_ScxmlScriptType"] = None):
        self.id = id
        self.initial = initial
...
class scxml_ScxmlParamType:
    ...
    def __init__(self, scxmlExtraContent: str, any: str, expr: str, name: str, anyAttribute: str, scxml_ScxmlParamType: "scxml_ScxmlSendType" = None):
...
class scxml_ScxmlScriptType:
    ...
    def __init__(self, scxmlExtraContent: str, mixed: str, any: str, src: str, content: str, scxml_ScxmlScriptType25: "scxml_ScxmlTransitionType" = None, scxml_ScxmlScriptType: "scxml_ScxmlOnexecuteType" = None, scxml_ScxmlScriptType6: "scxml_ScxmlScxmlType" = None):
        self.scxmlExtraContent = scxmlExtraContent
        self.mixed = mixed
        self.any = any
        self.src = src
...
class scxml_ScxmlSendType:
    ...
    def __init__(self, event: str, scxml_ScxmlSendType22: "scxml_ScxmlTransitionType" = None, scxml_ScxmlSendType: "scxml_ScxmlOnexecuteType" = None, scxml_ScxmlSendType8: set["scxml_ScxmlParamType"] = None):
        self.event = event
...
class scxml_ScxmlOnexecuteType:
    ...
    def __init__(self, scxmlExecutablecontent: str, any: str, anyAttribute: str, scxml_ScxmlOnexecuteType: set["scxml_ScxmlSendType"] = None, scxml_ScxmlOnexecuteType2: set["scxml_ScxmlScriptType"] = None, scxml_ScxmlOnexecuteType14: "scxml_ScxmlStateType" = None, scxml_ScxmlOnexecuteType11: "scxml_ScxmlStateType" = None):
        self.scxmlExecutablecontent = scxmlExecutablecontent
        self.any = any
        self.anyAttribute = anyAttribute
