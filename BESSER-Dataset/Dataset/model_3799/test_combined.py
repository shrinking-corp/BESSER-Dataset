...
def test_hyp_era_attribute_is_not_abstract():
    assert not inspect.isabstract(era_Attribute)


def test_hyp_era_attribute_constructor_exists():
    assert callable(era_Attribute.__init__)


def test_hyp_era_attribute_constructor_args():
...
def test_hyp_era_relationship_is_not_abstract():
    assert not inspect.isabstract(era_Relationship)


def test_hyp_era_relationship_constructor_exists():
    assert callable(era_Relationship.__init__)


def test_hyp_era_relationship_constructor_args():
...
def test_hyp_era_entity_is_not_abstract():
    assert not inspect.isabstract(era_Entity)


def test_hyp_era_entity_constructor_exists():
    assert callable(era_Entity.__init__)


def test_hyp_era_entity_constructor_args():
...
def test_hyp_era_system_is_not_abstract():
    assert not inspect.isabstract(era_System)


def test_hyp_era_system_constructor_exists():
    assert callable(era_System.__init__)


def test_hyp_era_system_constructor_args():
...
def test_hyp_era_attribute_name_setter(instance):
...
def test_hyp_era_relationship_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_era_entity_inDomain_setter(instance):
...
@given(instance=era_Entity_strategy)
def test_hyp_era_entity_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
