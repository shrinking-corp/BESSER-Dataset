...
domain_model = DomainModel(
    name="_PH6J4Hg_EeqeQcxm9hmzHw",
    types={ShoppingCartExample_ShoppingCart, ShoppingCartExample_Order, ShoppingCartExample_LineItem, ShoppingCartExample_Account, ShoppingCartExample_Customer, Actor_Actor, player_Actor, menu_state_Actor, Settings_state_Actor, Actor4_Actor, Class_},
