...
class iot_Motor:
    ...
    def __init__(self, degrees: str, pins: int, name: str, library: str, iot_Motor5: "iot_Arduino" = None, iot_Motor: "iot_Board" = None, iot_Motor8: "iot_Motor" = None, iot_Motor6: set["iot_Motor"] = None):
...
class iot_Arduino:
    ...
    def __init__(self, model: str, pins: int, iot_Arduino4: set["iot_Motor"] = None, iot_Arduino: "iot_Board" = None):
        self.model = model
        self.pins = pins
