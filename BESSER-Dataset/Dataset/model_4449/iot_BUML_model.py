...
iot_Arduino = Class(name="iot_Arduino")
iot_Motor = Class(name="iot_Motor")
...
iot_Arduino.attributes={iot_Arduino_pins, iot_Arduino_model}
...
iot_Motor.attributes={iot_Motor_name, iot_Motor_degrees, iot_Motor_library, iot_Motor_pins}
...
domain_model = DomainModel(
    ...
    associations={conector3, Arduino0, Motor1, conectorMotorMotor7},
    generalizations={},
    metadata=None
)
