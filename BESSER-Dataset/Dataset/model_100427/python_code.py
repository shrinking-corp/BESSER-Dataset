...
class SimplStateMachine_State:
    ...
    def __init__(self, name: str, isActive: bool, states: "SimplStateMachine_CompositeState" = None, SimplStateMachine_State11: "SimplStateMachine_InitialState" = None, SimplStateMachine_State: "SimplStateMachine_Operation" = None, State: "SimplStateMachine_CompositeState" = None, SimplStateMachine_State14: "SimplStateMachine_Transition" = None, SimplStateMachine_State17: "SimplStateMachine_Transition" = None):
        self.name = name
...
class SimplStateMachine_Variable(ABC):
    ...
    def __init__(self, name: str, SimplStateMachine_Variable: "SimplStateMachine_StateMachine" = None, SimplStateMachine_Variable37: "SimplStateMachine_Assignment" = None, SimplStateMachine_Variable29: "SimplStateMachine_Data" = None, SimplStateMachine_Variable39: "SimplStateMachine_VariableReference" = None):
        self.name = name
...
class SimplStateMachine_CompositeState(State):
    ...
    def __init__(self, CompositeState: "SimplStateMachine_State" = None, SimplStateMachine_CompositeState: "SimplStateMachine_InitialState" = None, container: set["SimplStateMachine_State"] = None):
