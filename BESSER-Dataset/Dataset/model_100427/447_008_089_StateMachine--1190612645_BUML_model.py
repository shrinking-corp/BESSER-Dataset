...
domain_model = DomainModel(
    ...
    types={SimplStateMachine_StateMachine, CompositeState, SimplStateMachine_CompositeState, SimplStateMachine_Transition, SimplStateMachine_Event, SimplStateMachine_Variable, SimplStateMachine_State, SimplStateMachine_InitialState, SimplStateMachine_Operation, State, SimplStateMachine_ExpressionElement, ExpressionElement, SimplStateMachine_Expression, SimplStateMachine_Data, SimplStateMachine_BooleanData, Data, SimplStateMachine_VariableReference, SimplStateMachine_IntegerData, SimplStateMachine_BooleanVariable, Variable, SimplStateMachine_IntegerVariable, SimplStateMachine_Assignment, Operator},
    associations={container5, transitions0, events1, variables3, initialState8, referencedState9, operation6, states7, source12, target15, event18, guard21, left23, right25, expression32, variable35, value28, contents30, variable38},
    generalizations={gen_SimplStateMachine_StateMachine_CompositeState, gen_SimplStateMachine_CompositeState_State, gen_SimplStateMachine_Expression_ExpressionElement, gen_SimplStateMachine_Data_ExpressionElement, gen_SimplStateMachine_BooleanData_Data, gen_SimplStateMachine_VariableReference_ExpressionElement, gen_SimplStateMachine_IntegerData_Data, gen_SimplStateMachine_BooleanVariable_Variable, gen_SimplStateMachine_IntegerVariable_Variable},
    metadata=None
)
