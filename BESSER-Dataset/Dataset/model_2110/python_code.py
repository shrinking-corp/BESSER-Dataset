...
class TestMM5_Action:
    ...
    def __init__(self, id: str, type: str, xpath: str, value: str, description: str, Action: "TestMM5_Test" = None, act: "TestMM5_Test" = None):
        self.id = id
        self.type = type
        self.xpath = xpath
        self.value = value
...
class TestMM5_Metadata:
    ...
    def __init__(self, user: str, webpage: str, date: str, taglist: str, md: "TestMM5_Test" = None, Metadata: "TestMM5_Test" = None):
        self.user = user
...
class TestMM5_Test:
    ...
    def __init__(self, id: str, Test6: "TestMM5_Metadata" = None, Test: "TestMM5_TestSet" = None, ts: "TestMM5_TestSet" = None, te: "TestMM5_Metadata" = None, te4: set["TestMM5_Action"] = None, Test8: "TestMM5_Action" = None):
        self.id = id
        self.Test6 = Test6
        self.Test = Test
        self.ts = ts
