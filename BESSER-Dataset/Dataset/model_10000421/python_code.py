...
class WebUser:
    ...
    def __init__(self, id: int, fblogin: bool, email: str, password: str, status: str, shoppingCart2: "ShoppingCart" = None, customer4: "Customer" = None):
        self.id = id
    ...
    @property
    def fblogin(self):
        return self.__fblogin
    @fblogin.setter
    def fblogin(self, fblogin: bool):
        self.__fblogin = fblogin
...
class Account:
    ...
    def __init__(self, billingAddress: str, open: date, closed: date, state: bool, p0: set["Payment"] = None, customer7: "Customer" = None, cart8: "ShoppingCart" = None, order16: set["Order"] = None):
...
class ShoppingCart:
    ...
    def __init__(self, creationDate: date, webUser3: "WebUser" = None, account9: "Account" = None, items10: set["LineItem"] = None):
    ...
    def items10(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "sc11"):
                    opp_val = getattr(item, "sc11", None)
                    
                    if opp_val == self:
                        setattr(item, "sc11", None)
...
class Customer:
    ...
    def __init__(self, firstname: str, lastname: str, birthday: date, id: int, webUser5: "WebUser" = None, account6: "Account" = None):
