...
def test_hyp_webuser_id_setter(instance):
...
@given(instance=WebUser_strategy)
def test_hyp_webuser_status_setter(instance):
    original = instance.status
    instance.status = original
    assert instance.status == original
...
@given(instance=WebUser_strategy)
def test_hyp_webuser_email_setter(instance):
...
@given(instance=WebUser_strategy)
def test_hyp_webuser_fblogin_setter(instance):
...
@given(instance=Account_strategy)
def test_hyp_account_state_setter(instance):
...
def test_hyp_customer_birthday_setter(instance):
