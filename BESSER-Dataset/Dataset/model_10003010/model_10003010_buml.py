...
Attendance.attributes={Attendance_Attend_date, Attendance_AttendTime, Attendance_Emp_id, Attendance_Leaving_Time}
...
Employee.attributes={Employee_Emp_Id, Employee_Emp_Email, Employee_Emp_Salary, Employee_Emp_Position, Employee_Emp_Date_Of_Joint, Employee_Emp_NIC, Employee_Emp_Address, Employee_Emp_Department, Employee_Emp_Name, Employee_Emp_ContactNo, Employee_Emp_DOB}
...
Salary.attributes={Salary_Sly_Decrement, Salary_Emp_Id, Salary_Sly_Increment, Salary_Sly_Basic, Salary_Sly_Netgross, Salary_OverTime}
...
Leave.attributes={Leave_Leave_NoOfDays, Leave_Leave_Title, Leave_Leave_EndDate, Leave_leave_id, Leave_Emp_Id, Leave_Leave_StartDate, Leave_Leave_ApplyDate, Leave_Leave_detail, Leave_Leave_Status}
...
domain_model = DomainModel(
    name="f4ba92cd_59e1_4c84_9c69_2e5ea69042d7",
    types={Attendance, Login, Employee_Management_System_Component, Authentication_UseCase, Salary_Management_UseCase, Administrator_Actor, Employee_Actor, Employee, Salary, Authenticate_staff, Leave, Login_external, Logout_external},
