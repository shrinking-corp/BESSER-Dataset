...
public class Leave  {
    ...
    public Leave(
        String Leave_Status,        String Leave_Title,        LocalDate Leave_StartDate,        int Emp_Id,        int leave_id,        String Leave_detail,        LocalDate Leave_ApplyDate,        LocalDate Leave_EndDate,        int Leave_NoOfDays    ) {
