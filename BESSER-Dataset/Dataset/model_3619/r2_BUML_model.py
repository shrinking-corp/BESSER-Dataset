...
# Classes
r2_ADXP = Class(name="r2_ADXP")
r2_AD = Class(name="r2_AD")
ANY = Class(name="ANY")
XP = Class(name="XP")
r2_ANY = Class(name="r2_ANY", is_abstract=True)
HXIT = Class(name="HXIT")
r2_CD = Class(name="r2_CD")
r2_BL = Class(name="r2_BL")
r2_ST = Class(name="r2_ST")
r2_CO = Class(name="r2_CO")
QTY = Class(name="QTY")
r2_ED = Class(name="r2_ED")
r2_EObject = Class(name="r2_EObject")
r2_TEL = Class(name="r2_TEL")
r2_CS = Class(name="r2_CS")
r2_EN = Class(name="r2_EN")
r2_ENXP = Class(name="r2_ENXP")
r2_II = Class(name="r2_II")
r2_INT = Class(name="r2_INT")
r2_HXIT = Class(name="r2_HXIT", is_abstract=True)
IVL = Class(name="IVL")
r2_IVL = Class(name="r2_IVL")
QSET = Class(name="QSET")
r2_IVLCO = Class(name="r2_IVLCO")
r2_IVLPQ = Class(name="r2_IVLPQ")
r2_PQ = Class(name="r2_PQ")
r2_IVLINT = Class(name="r2_IVLINT")
r2_IVLREAL = Class(name="r2_IVLREAL")
r2_REAL = Class(name="r2_REAL")
r2_IVLQTY = Class(name="r2_IVLQTY")
r2_QTY = Class(name="r2_QTY", is_abstract=True)
r2_TS = Class(name="r2_TS")
r2_IVLTS = Class(name="r2_IVLTS")
r2_PIVLTS = Class(name="r2_PIVLTS")
r2_RTO = Class(name="r2_RTO")
r2_QSET = Class(name="r2_QSET", is_abstract=True)
r2_XP = Class(name="r2_XP")
...
r2_CD.attributes={r2_CD_codeSystemName, r2_CD_valueSet, r2_CD_codeSystem, r2_CD_codeSystemVersion, r2_CD_valueSetVersion, r2_CD_code}
...
r2_ED.attributes={r2_ED_mediaType, r2_ED_integrityCheckAlgorithm, r2_ED_compression, r2_ED_data, r2_ED_charset, r2_ED_integrityCheck, r2_ED_value, r2_ED_language}
...
r2_ENXP.attributes={r2_ENXP_qualifier, r2_ENXP_type}
...
r2_II.attributes={r2_II_extension, r2_II_root, r2_II_identifierName}
...
r2_IVLCO.attributes={r2_IVLCO_lowClosed, r2_IVLCO_highClosed}
...
r2_IVLPQ.attributes={r2_IVLPQ_lowClosed, r2_IVLPQ_highClosed}
...
r2_IVLREAL.attributes={r2_IVLREAL_highClosed, r2_IVLREAL_lowClosed}
...
r2_IVLQTY.attributes={r2_IVLQTY_highClosed, r2_IVLQTY_lowClosed}
...
domain_model = DomainModel(
    name="r2",
    types={r2_ADXP, r2_AD, ANY, XP, r2_ANY, HXIT, r2_CD, r2_BL, r2_ST, r2_CO, QTY, r2_ED, r2_EObject, r2_TEL, r2_CS, r2_EN, r2_ENXP, r2_II, r2_INT, r2_HXIT, IVL, r2_IVL, QSET, r2_IVLCO, r2_IVLPQ, r2_PQ, r2_IVLINT, r2_IVLREAL, r2_REAL, r2_IVLQTY, r2_QTY, r2_TS, r2_IVLTS, r2_PIVLTS, r2_RTO, r2_QSET, r2_XP, AddressPartType, CalendarCycle, Compression, EntityNamePartType, EntityNamePartQualifier, EntityNameUse, IntegrityCheckAlgorithm, PostalAddressUse, TelecommunicationAddressUse, TelecommunicationCapability},
    associations={part0, translation6, displayName1, originalText2, code8, xml10, reference11, part16, description13, low17, high19, low26, high27, low22, high23, low34, high35, low30, high31, low38, high39, frequency47, count49, phase42, period44, numerator52, denominator55},
    generalizations={gen_r2_AD_ANY, gen_r2_ADXP_XP, gen_r2_ANY_HXIT, gen_r2_CD_ANY, gen_r2_BL_ANY, gen_r2_CO_QTY, gen_r2_ED_ANY, gen_r2_CS_ANY, gen_r2_EN_ANY, gen_r2_II_ANY, gen_r2_INT_QTY, gen_r2_ENXP_XP, gen_r2_IVLCO_IVL, gen_r2_IVL_QSET, gen_r2_IVLPQ_IVL, gen_r2_IVLINT_IVL, gen_r2_IVLREAL_IVL, gen_r2_IVLQTY_IVL, gen_r2_IVLTS_IVL, gen_r2_PIVLTS_QTY, gen_r2_PQ_QTY, gen_r2_QSET_ANY, gen_r2_QTY_ANY, gen_r2_REAL_QTY, gen_r2_RTO_QTY, gen_r2_ST_ANY, gen_r2_TEL_ANY, gen_r2_TS_QTY},
    metadata=None
)
