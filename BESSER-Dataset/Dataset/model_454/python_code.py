...
class TemplateableElement:
    ...
    pass
class UMLModel_StringExpression(TemplateableElement, Expression):
...
class UMLModel_ClassifierTemplateParameter(TemplateParameter):
    ...
    @property
    def constrainingClassifier(self):
...
class UMLModel_Property(TemplateableElement, DeploymentTarget, ConnectableElement, StructuralFeature):

    def __init__(self, associationEnd: str, class_: str, datatype: str, isDerived: str, isDerivedUnion: str, default: str, aggregation: str, isComposite: str, redefinedProperty: str, owningAssociation: str, opposite: str, subsettedProperty: str, association: str, UMLModel_Property42: "UMLModel_Association" = None, UMLModel_Property: "UMLModel_Artifact" = None, UMLModel_Property101: "UMLModel_DataType" = None, UMLModel_Property120: "UMLModel_Interface" = None, UMLModel_Property224: "UMLModel_ValueSpecification" = None, UMLModel_Property228: "UMLModel_Property" = None, UMLModel_Property226: set["UMLModel_Property"] = None, UMLModel_Property307: "UMLModel_Signal" = None, UMLModel_Property335: "UMLModel_StructuredClassifier" = None):
...
class UMLModel_BehavioredClassifier(Classifier):
    ...
    def __init__(self, classifierBehavior: str, UMLModel_BehavioredClassifier54: set["UMLModel_InterfaceRealization"] = None, UMLModel_BehavioredClassifier56: set["UMLModel_Trigger"] = None, UMLModel_BehavioredClassifier: set["UMLModel_Behavior"] = None):
...
class UMLModel_Artifact(DeployedArtifact, Classifier):
...
class BehavioredClassifier:
    ...
    pass
class UMLModel_Class(EncapsulatedClassifier, BehavioredClassifier):
...
class UMLModel_Component(Class):
    ...
    @property
    def indirectlyInstantiated(self):
...
class UMLModel_AssociationClass(Class, Association):

    pass
class Relationship:

    pass
class UMLModel_Association(Relationship, Classifier):

    def __init__(self, isDerived: str, navigableOwnedEnd: str, memberEnd: str, endType: str, UMLModel_Association: set["UMLModel_Property"] = None):
        self.isDerived = isDerived
...
class UMLModel_Slot(Element):
    ...
    def __init__(self, owningInstance: str, definingFeature: str, UMLModel_Slot: "UMLModel_InstanceSpecification" = None, UMLModel_Slot282: set["UMLModel_ValueSpecification"] = None):
...
class UMLModel_ParameterableElement(Element):
    ...
    def __init__(self, owningTemplateParameter: str, templateParameter: str, UMLModel_ParameterableElement: "UMLModel_TemplateParameter" = None, UMLModel_ParameterableElement351: "UMLModel_TemplateParameter" = None, UMLModel_ParameterableElement354: "UMLModel_TemplateParameterSubstitution" = None):
        ...
        pass
    @property
    def owningTemplateParameter(self):
...
class UMLModel_TemplateSignature(Element):
    ...
    def __init__(self, parameter: str, template: str, UMLModel_TemplateSignature346: set["UMLModel_TemplateParameter"] = None, UMLModel_TemplateSignature: "UMLModel_TemplateableElement" = None):
...
class RedefinableElement:
    ...
    pass
class UMLModel_RedefinableTemplateSignature(RedefinableElement, TemplateSignature):
...
class UMLModel_Region(RedefinableElement, Namespace):
...
class UMLModel_Classifier(TemplateableElement, RedefinableElement, Namespace, Type):

    def __init__(self, powertypeExtent: str, feature: str, inheritedMember: str, redefinedClassifier: str, general: str, representation: str, attribute: str, useCase: str, isAbstract: str, UMLModel_Classifier73: set["UMLModel_Substitution"] = None, UMLModel_Classifier75: set["UMLModel_CollaborationUse"] = None, UMLModel_Classifier77: set["UMLModel_UseCase"] = None, UMLModel_Classifier: "UMLModel_Class" = None, UMLModel_Classifier71: set["UMLModel_Generalization"] = None, UMLModel_Classifier126: "UMLModel_Interface" = None):
...
class UMLModel_Transition(RedefinableElement, Namespace):
...
class UMLModel_Message(NamedElement):
    ...
    def __init__(self, sendEvent: str, connector: str, messageKind: str, messageSort: str, receiveEvent: str, interaction: str, signature: str, UMLModel_Message184: set["UMLModel_ValueSpecification"] = None, UMLModel_Message: "UMLModel_Interaction" = None):
...
class UMLModel_Lifeline(NamedElement):
    ...
    def __init__(self, represents: str, interaction: str, decomposedAs: str, coveredBy: str, UMLModel_Lifeline170: "UMLModel_ValueSpecification" = None, UMLModel_Lifeline: "UMLModel_Interaction" = None):
...
class UMLModel_CollaborationUse(NamedElement):
    ...
    def __init__(self, type: str, UMLModel_CollaborationUse: "UMLModel_Classifier" = None, UMLModel_CollaborationUse81: set["UMLModel_Dependency"] = None):
        self.type = type
...
class UMLModel_InteractionFragment(NamedElement):
    ...
    def __init__(self, covered: str, enclosingInteraction: str, enclosingOperand: str, UMLModel_InteractionFragment150: set["UMLModel_GeneralOrdering"] = None, UMLModel_InteractionFragment160: "UMLModel_InteractionOperand" = None, UMLModel_InteractionFragment: "UMLModel_Interaction" = None):
...
class UMLModel_ActivityPartition(NamedElement, ActivityGroup):
...
class UMLModel_ActivityNode(RedefinableElement):
    ...
    def __init__(self, inInterruptibleRegion: str, outgoing: str, incoming: str, inPartition: str, inGroup: str, redefinedNode: str, activity: str, inStructuredNode: str, UMLModel_ActivityNode: "UMLModel_Activity" = None, UMLModel_ActivityNode29: "UMLModel_ActivityGroup" = None, UMLModel_ActivityNode303: "UMLModel_StructuredActivityNode" = None):
...
class UMLModel_Activity(Behavior):
    ...
    def __init__(self, isReadOnly: str, isSingleExecution: str, structuredNode: str, partition: str, UMLModel_Activity16: set["UMLModel_ActivityEdge"] = None, UMLModel_Activity18: set["UMLModel_ActivityGroup"] = None, UMLModel_Activity: set["UMLModel_Variable"] = None, UMLModel_Activity14: set["UMLModel_ActivityNode"] = None):
...
class UMLModel_ActivityEdge(RedefinableElement):
    ...
    def __init__(self, source: str, target: str, redefinedEdge: str, inPartition: str, interrupts: str, inGroup: str, activity: str, inStructuredNode: str, UMLModel_ActivityEdge: "UMLModel_Activity" = None, UMLModel_ActivityEdge26: "UMLModel_ActivityGroup" = None, UMLModel_ActivityEdge20: "UMLModel_ValueSpecification" = None, UMLModel_ActivityEdge22: "UMLModel_ValueSpecification" = None, UMLModel_ActivityEdge300: "UMLModel_StructuredActivityNode" = None):
        self.source = source
        self.target = target
...
class UMLModel_ReclassifyObjectAction(Action):
    ...
    def __init__(self, oldClassifier: str, newClassifier: str, isReplaceAll: str, UMLModel_ReclassifyObjectAction: "UMLModel_InputPin" = None):
...
class UMLModel_ReadLinkObjectEndQualifierAction(Action):
    ...
    def __init__(self, qualifier: str, UMLModel_ReadLinkObjectEndQualifierAction252: "UMLModel_OutputPin" = None, UMLModel_ReadLinkObjectEndQualifierAction: "UMLModel_InputPin" = None):
        self.qualifier = qualifier
...
class UMLModel_Deployment(Dependency):
    ...
    def __init__(self, deployedArtifact: str, location: str, UMLModel_Deployment: "UMLModel_DeploymentTarget" = None, UMLModel_Deployment107: set["UMLModel_DeploymentSpecification"] = None):
...
class MultiplicityElement:
    ...
    pass
class UMLModel_Parameter(ConnectableElement, MultiplicityElement):
...
class UMLModel_Pin(ObjectNode, MultiplicityElement):
...
class UMLModel_Variable(ConnectableElement, MultiplicityElement):
...
class UMLModel_Extend(NamedElement, DirectedRelationship):

    def __init__(self, extensionLocation: str, extendedCase: str, extension: str, UMLModel_Extend: "UMLModel_Constraint" = None, UMLModel_Extend380: "UMLModel_UseCase" = None):
...
class UMLModel_TemplateBinding(DirectedRelationship):
    ...
    def __init__(self, signature: str, boundElement: str, UMLModel_TemplateBinding344: set["UMLModel_TemplateParameterSubstitution"] = None, UMLModel_TemplateBinding: "UMLModel_TemplateableElement" = None):
        self.signature = signature
...
class UMLModel_Include(NamedElement, DirectedRelationship):
...
class ParameterableElement:
    ...
    pass
class UMLModel_PackageableElement(ParameterableElement, NamedElement):

    pass
class UMLModel_Operation(TemplateableElement, BehavioralFeature, ParameterableElement):

    def __init__(self, interface: str, class_: str, isQuery: str, isOrdered: str, isUnique: str, lower: str, upper: str, precondition: str, postcondition: str, redefinedOperation: str, datatype: str, bodyCondition: str, type: str, UMLModel_Operation67: "UMLModel_Class" = None, UMLModel_Operation: "UMLModel_Artifact" = None, UMLModel_Operation104: "UMLModel_DataType" = None, UMLModel_Operation123: "UMLModel_Interface" = None):
...
class UMLModel_FinalNode(ControlNode):
    ...
    pass
class UMLModel_ConnectableElement(ParameterableElement, TypedElement):
...
class UMLModel_Package(TemplateableElement, Namespace, PackageableElement):
...
class UMLModel_InstanceSpecification(DeployedArtifact, DeploymentTarget, PackageableElement):
...
class UMLModel_GeneralizationSet(PackageableElement):
    ...
    def __init__(self, powerType: str, isCovering: str, isDisjoint: str, generalization: str):
...
class UMLModel_InformationFlow(DirectedRelationship, PackageableElement):
    ...
    @property
    def realizingActivityEdge(self):
...
class Vertex:
    ...
    pass
class UMLModel_State(Vertex, RedefinableElement, Namespace):

    def __init__(self, redefinedState: str, isComposite: str, isOrthogonal: str, isSimple: str, isSubmachineState: str, submachine: str, UMLModel_State: set["UMLModel_ConnectionPointReference"] = None, UMLModel_State310: set["UMLModel_Pseudostate"] = None, UMLModel_State324: set["UMLModel_Trigger"] = None, UMLModel_State312: "UMLModel_Constraint" = None, UMLModel_State315: "UMLModel_Behavior" = None, UMLModel_State318: "UMLModel_Behavior" = None, UMLModel_State321: "UMLModel_Behavior" = None, UMLModel_State327: set["UMLModel_Region"] = None):
...
class UMLModel_Pseudostate(Vertex):
    ...
    def __init__(self, kind: str, stateMachine: str, state: str, UMLModel_Pseudostate: "UMLModel_State" = None, UMLModel_Pseudostate333: "UMLModel_StateMachine" = None):
        self.kind = kind
        self.stateMachine = stateMachine
        self.state = state
...
class UMLModel_Dependency(DirectedRelationship, PackageableElement):
    ...
    def __init__(self, client: str, supplier: str, UMLModel_Dependency: "UMLModel_CollaborationUse" = None):
        self.client = client
...
class UMLModel_Collaboration(StructuredClassifier, BehavioredClassifier):
