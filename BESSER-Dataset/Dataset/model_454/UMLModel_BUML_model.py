...
# Classes
UMLModel_OutputPin = Class(name="UMLModel_OutputPin")
UMLModel_AcceptEventAction = Class(name="UMLModel_AcceptEventAction")
Action = Class(name="Action")
UMLModel_Trigger = Class(name="UMLModel_Trigger")
UMLModel_Action = Class(name="UMLModel_Action", is_abstract=True)
ExecutableNode = Class(name="ExecutableNode")
UMLModel_Abstraction = Class(name="UMLModel_Abstraction")
Dependency = Class(name="Dependency")
UMLModel_OpaqueExpression = Class(name="UMLModel_OpaqueExpression")
UMLModel_AcceptCallAction = Class(name="UMLModel_AcceptCallAction")
AcceptEventAction = Class(name="AcceptEventAction")
UMLModel_ActivityEdge = Class(name="UMLModel_ActivityEdge", is_abstract=True)
UMLModel_ActivityGroup = Class(name="UMLModel_ActivityGroup", is_abstract=True)
UMLModel_Constraint = Class(name="UMLModel_Constraint")
UMLModel_ActionExecutionSpecification = Class(name="UMLModel_ActionExecutionSpecification")
ExecutionSpecification = Class(name="ExecutionSpecification")
UMLModel_ActionInputPin = Class(name="UMLModel_ActionInputPin")
InputPin = Class(name="InputPin")
UMLModel_Activity = Class(name="UMLModel_Activity")
Behavior = Class(name="Behavior")
UMLModel_Variable = Class(name="UMLModel_Variable")
UMLModel_ActivityNode = Class(name="UMLModel_ActivityNode", is_abstract=True)
UMLModel_ActivityPartition = Class(name="UMLModel_ActivityPartition")
NamedElement = Class(name="NamedElement")
ActivityGroup = Class(name="ActivityGroup")
RedefinableElement = Class(name="RedefinableElement")
UMLModel_ValueSpecification = Class(name="UMLModel_ValueSpecification", is_abstract=True)
UMLModel_ActivityParameterNode = Class(name="UMLModel_ActivityParameterNode")
ObjectNode = Class(name="ObjectNode")
UMLModel_ActivityFinalNode = Class(name="UMLModel_ActivityFinalNode")
FinalNode = Class(name="FinalNode")
Element = Class(name="Element")
UMLModel_Association = Class(name="UMLModel_Association")
Relationship = Class(name="Relationship")
UMLModel_AssociationClass = Class(name="UMLModel_AssociationClass")
Class_ = Class(name="Class")
Association = Class(name="Association")
UMLModel_Actor = Class(name="UMLModel_Actor")
BehavioredClassifier = Class(name="BehavioredClassifier")
UMLModel_AddStructuralFeatureValueAction = Class(name="UMLModel_AddStructuralFeatureValueAction")
WriteStructuralFeatureAction = Class(name="WriteStructuralFeatureAction")
UMLModel_InputPin = Class(name="UMLModel_InputPin")
UMLModel_AddVariableValueAction = Class(name="UMLModel_AddVariableValueAction")
WriteVariableAction = Class(name="WriteVariableAction")
UMLModel_AnyReceiveEvent = Class(name="UMLModel_AnyReceiveEvent")
MessageEvent = Class(name="MessageEvent")
UMLModel_Artifact = Class(name="UMLModel_Artifact")
Classifier = Class(name="Classifier")
DeployedArtifact = Class(name="DeployedArtifact")
UMLModel_Manifestation = Class(name="UMLModel_Manifestation")
UMLModel_Operation = Class(name="UMLModel_Operation")
UMLModel_BroadcastSignalAction = Class(name="UMLModel_BroadcastSignalAction")
InvocationAction = Class(name="InvocationAction")
UMLModel_Property = Class(name="UMLModel_Property")
UMLModel_CallAction = Class(name="UMLModel_CallAction", is_abstract=True)
UMLModel_CallBehaviorAction = Class(name="UMLModel_CallBehaviorAction")
CallAction = Class(name="CallAction")
UMLModel_Behavior = Class(name="UMLModel_Behavior", is_abstract=True)
UMLModel_CallEvent = Class(name="UMLModel_CallEvent")
UMLModel_Parameter = Class(name="UMLModel_Parameter")
UMLModel_ParameterSet = Class(name="UMLModel_ParameterSet")
UMLModel_BehaviorExecutionSpecification = Class(name="UMLModel_BehaviorExecutionSpecification")
UMLModel_BehavioralFeature = Class(name="UMLModel_BehavioralFeature", is_abstract=True)
Namespace = Class(name="Namespace")
Feature = Class(name="Feature")
UMLModel_BehavioredClassifier = Class(name="UMLModel_BehavioredClassifier", is_abstract=True)
UMLModel_InterfaceRealization = Class(name="UMLModel_InterfaceRealization")
UMLModel_Substitution = Class(name="UMLModel_Substitution")
UMLModel_CollaborationUse = Class(name="UMLModel_CollaborationUse")
UMLModel_UseCase = Class(name="UMLModel_UseCase")
UMLModel_ClassifierTemplateParameter = Class(name="UMLModel_ClassifierTemplateParameter")
TemplateParameter = Class(name="TemplateParameter")
UMLModel_CallOperationAction = Class(name="UMLModel_CallOperationAction")
UMLModel_ChangeEvent = Class(name="UMLModel_ChangeEvent")
Event = Class(name="Event")
UMLModel_Class = Class(name="UMLModel_Class")
EncapsulatedClassifier = Class(name="EncapsulatedClassifier")
UMLModel_Classifier = Class(name="UMLModel_Classifier", is_abstract=True)
UMLModel_Reception = Class(name="UMLModel_Reception")
Type = Class(name="Type")
TemplateableElement = Class(name="TemplateableElement")
UMLModel_Generalization = Class(name="UMLModel_Generalization")
UMLModel_CommunicationPath = Class(name="UMLModel_CommunicationPath")
UMLModel_Component = Class(name="UMLModel_Component")
UMLModel_PackageableElement = Class(name="UMLModel_PackageableElement", is_abstract=True)
UMLModel_ComponentRealization = Class(name="UMLModel_ComponentRealization")
Realization = Class(name="Realization")
UMLModel_CombinedFragment = Class(name="UMLModel_CombinedFragment")
InteractionFragment = Class(name="InteractionFragment")
UMLModel_InteractionOperand = Class(name="UMLModel_InteractionOperand")
UMLModel_Clause = Class(name="UMLModel_Clause")
UMLModel_ClearVariableAction = Class(name="UMLModel_ClearVariableAction")
VariableAction = Class(name="VariableAction")
UMLModel_ClearAssociationAction = Class(name="UMLModel_ClearAssociationAction")
UMLModel_ClearStructuralFeatureAction = Class(name="UMLModel_ClearStructuralFeatureAction")
StructuralFeatureAction = Class(name="StructuralFeatureAction")
UMLModel_Collaboration = Class(name="UMLModel_Collaboration")
StructuredClassifier = Class(name="StructuredClassifier")
UMLModel_Dependency = Class(name="UMLModel_Dependency")
UMLModel_Comment = Class(name="UMLModel_Comment")
UMLModel_ConnectionPointReference = Class(name="UMLModel_ConnectionPointReference")
Vertex = Class(name="Vertex")
UMLModel_Connector = Class(name="UMLModel_Connector")
UMLModel_ControlFlow = Class(name="UMLModel_ControlFlow")
ActivityEdge = Class(name="ActivityEdge")
UMLModel_ControlNode = Class(name="UMLModel_ControlNode", is_abstract=True)
ActivityNode = Class(name="ActivityNode")
UMLModel_CreationEvent = Class(name="UMLModel_CreationEvent")
UMLModel_Gate = Class(name="UMLModel_Gate")
UMLModel_ConditionalNode = Class(name="UMLModel_ConditionalNode")
StructuredActivityNode = Class(name="StructuredActivityNode")
UMLModel_CreateLinkObjectAction = Class(name="UMLModel_CreateLinkObjectAction")
CreateLinkAction = Class(name="CreateLinkAction")
UMLModel_CreateObjectAction = Class(name="UMLModel_CreateObjectAction")
PackageableElement = Class(name="PackageableElement")
UMLModel_CreateLinkAction = Class(name="UMLModel_CreateLinkAction")
WriteLinkAction = Class(name="WriteLinkAction")
UMLModel_CentralBufferNode = Class(name="UMLModel_CentralBufferNode")
UMLModel_DataStoreNode = Class(name="UMLModel_DataStoreNode")
CentralBufferNode = Class(name="CentralBufferNode")
UMLModel_DataType = Class(name="UMLModel_DataType")
UMLModel_ConsiderIgnoreFragment = Class(name="UMLModel_ConsiderIgnoreFragment")
CombinedFragment = Class(name="CombinedFragment")
UMLModel_Continuation = Class(name="UMLModel_Continuation")
UMLModel_DecisionNode = Class(name="UMLModel_DecisionNode")
UMLModel_ConnectableElement = Class(name="UMLModel_ConnectableElement", is_abstract=True)
ControlNode = Class(name="ControlNode")
TypedElement = Class(name="TypedElement")
ParameterableElement = Class(name="ParameterableElement")
UMLModel_ConnectableElementTemplateParameter = Class(name="UMLModel_ConnectableElementTemplateParameter")
DirectedRelationship = Class(name="DirectedRelationship")
UMLModel_ConnectorEnd = Class(name="UMLModel_ConnectorEnd")
MultiplicityElement = Class(name="MultiplicityElement")
UMLModel_DeploymentTarget = Class(name="UMLModel_DeploymentTarget", is_abstract=True)
UMLModel_Deployment = Class(name="UMLModel_Deployment")
UMLModel_DeploymentSpecification = Class(name="UMLModel_DeploymentSpecification")
UMLModel_DeployedArtifact = Class(name="UMLModel_DeployedArtifact", is_abstract=True)
Artifact = Class(name="Artifact")
UMLModel_DirectedRelationship = Class(name="UMLModel_DirectedRelationship", is_abstract=True)
UMLModel_Device = Class(name="UMLModel_Device")
Node = Class(name="Node")
UMLModel_DestroyLinkAction = Class(name="UMLModel_DestroyLinkAction")
UMLModel_DestroyObjectAction = Class(name="UMLModel_DestroyObjectAction")
UMLModel_Enumeration = Class(name="UMLModel_Enumeration")
DataType = Class(name="DataType")
UMLModel_EnumerationLiteral = Class(name="UMLModel_EnumerationLiteral")
UMLModel_DestructionEvent = Class(name="UMLModel_DestructionEvent")
UMLModel_Duration = Class(name="UMLModel_Duration")
ValueSpecification = Class(name="ValueSpecification")
UMLModel_DurationConstraint = Class(name="UMLModel_DurationConstraint")
IntervalConstraint = Class(name="IntervalConstraint")
UMLModel_DurationInterval = Class(name="UMLModel_DurationInterval")
Interval = Class(name="Interval")
UMLModel_DurationObservation = Class(name="UMLModel_DurationObservation")
Observation = Class(name="Observation")
UMLModel_Element = Class(name="UMLModel_Element", is_abstract=True)
UMLBase = Class(name="UMLBase")
UMLModel_ElementImport = Class(name="UMLModel_ElementImport")
UMLModel_EncapsulatedClassifier = Class(name="UMLModel_EncapsulatedClassifier", is_abstract=True)
InstanceSpecification = Class(name="InstanceSpecification")
UMLModel_ExceptionHandler = Class(name="UMLModel_ExceptionHandler")
UMLModel_ExecutableNode = Class(name="UMLModel_ExecutableNode", is_abstract=True)
UMLModel_ExecutionEnvironment = Class(name="UMLModel_ExecutionEnvironment")
UMLModel_ExecutionEvent = Class(name="UMLModel_ExecutionEvent")
UMLModel_ExecutionOccurrenceSpecification = Class(name="UMLModel_ExecutionOccurrenceSpecification")
OccurrenceSpecification = Class(name="OccurrenceSpecification")
UMLModel_ExecutionSpecification = Class(name="UMLModel_ExecutionSpecification", is_abstract=True)
UMLModel_ExpansionNode = Class(name="UMLModel_ExpansionNode")
UMLModel_ExpansionRegion = Class(name="UMLModel_ExpansionRegion")
UMLModel_Extend = Class(name="UMLModel_Extend")
UMLModel_Extension = Class(name="UMLModel_Extension")
UMLModel_ExtensionEnd = Class(name="UMLModel_ExtensionEnd")
Property_ = Class(name="Property")
UMLModel_ExtensionPoint = Class(name="UMLModel_ExtensionPoint")
UMLModel_Expression = Class(name="UMLModel_Expression")
UMLModel_Event = Class(name="UMLModel_Event", is_abstract=True)
UMLModel_Feature = Class(name="UMLModel_Feature", is_abstract=True)
UMLModel_FinalState = Class(name="UMLModel_FinalState")
State = Class(name="State")
UMLModel_ForkNode = Class(name="UMLModel_ForkNode")
UMLModel_FlowFinalNode = Class(name="UMLModel_FlowFinalNode")
UMLModel_FinalNode = Class(name="UMLModel_FinalNode", is_abstract=True)
UMLModel_FunctionBehavior = Class(name="UMLModel_FunctionBehavior")
OpaqueBehavior = Class(name="OpaqueBehavior")
MessageEnd = Class(name="MessageEnd")
UMLModel_GeneralOrdering = Class(name="UMLModel_GeneralOrdering")
UMLModel_GeneralizationSet = Class(name="UMLModel_GeneralizationSet")
UMLModel_InvocationAction = Class(name="UMLModel_InvocationAction", is_abstract=True)
UMLModel_Image = Class(name="UMLModel_Image")
UMLModel_Interface = Class(name="UMLModel_Interface")
UMLModel_ProtocolStateMachine = Class(name="UMLModel_ProtocolStateMachine")
UMLModel_Include = Class(name="UMLModel_Include")
UMLModel_InstanceSpecification = Class(name="UMLModel_InstanceSpecification")
DeploymentTarget = Class(name="DeploymentTarget")
UMLModel_Slot = Class(name="UMLModel_Slot")
UMLModel_InstanceValue = Class(name="UMLModel_InstanceValue")
UMLModel_InterruptibleActivityRegion = Class(name="UMLModel_InterruptibleActivityRegion")
Pin = Class(name="Pin")
UMLModel_Interval = Class(name="UMLModel_Interval")
UMLModel_InitialNode = Class(name="UMLModel_InitialNode")
UMLModel_Interaction = Class(name="UMLModel_Interaction")
UMLModel_Lifeline = Class(name="UMLModel_Lifeline")
UMLModel_InteractionFragment = Class(name="UMLModel_InteractionFragment", is_abstract=True)
UMLModel_Message = Class(name="UMLModel_Message")
UMLModel_InteractionUse = Class(name="UMLModel_InteractionUse")
UMLModel_InteractionConstraint = Class(name="UMLModel_InteractionConstraint")
Constraint = Class(name="Constraint")
UMLModel_IntervalConstraint = Class(name="UMLModel_IntervalConstraint")
UMLModel_InformationItem = Class(name="UMLModel_InformationItem")
UMLModel_InformationFlow = Class(name="UMLModel_InformationFlow")
UMLModel_JoinNode = Class(name="UMLModel_JoinNode")
UMLModel_LiteralSpecification = Class(name="UMLModel_LiteralSpecification", is_abstract=True)
UMLModel_LiteralInteger = Class(name="UMLModel_LiteralInteger")
LiteralSpecification = Class(name="LiteralSpecification")
UMLModel_LiteralString = Class(name="UMLModel_LiteralString")
UMLModel_LiteralBoolean = Class(name="UMLModel_LiteralBoolean")
UMLModel_LiteralNull = Class(name="UMLModel_LiteralNull")
UMLModel_LiteralUnlimitedNatural = Class(name="UMLModel_LiteralUnlimitedNatural")
UMLModel_LinkAction = Class(name="UMLModel_LinkAction", is_abstract=True)
UMLModel_LinkEndData = Class(name="UMLModel_LinkEndData")
UMLModel_QualifierValue = Class(name="UMLModel_QualifierValue")
UMLModel_LinkEndCreationData = Class(name="UMLModel_LinkEndCreationData")
LinkEndData = Class(name="LinkEndData")
UMLModel_LinkEndDestructionData = Class(name="UMLModel_LinkEndDestructionData")
UMLModel_LoopNode = Class(name="UMLModel_LoopNode")
Abstraction = Class(name="Abstraction")
UMLModel_Namespace = Class(name="UMLModel_Namespace", is_abstract=True)
UMLModel_MessageEnd = Class(name="UMLModel_MessageEnd", is_abstract=True)
UMLModel_MessageEvent = Class(name="UMLModel_MessageEvent", is_abstract=True)
UMLModel_MessageOccurrenceSpecification = Class(name="UMLModel_MessageOccurrenceSpecification")
UMLModel_MergeNode = Class(name="UMLModel_MergeNode")
UMLModel_Model = Class(name="UMLModel_Model")
Package = Class(name="Package")
UMLModel_MultiplicityElement = Class(name="UMLModel_MultiplicityElement", is_abstract=True)
UMLModel_NamedElement = Class(name="UMLModel_NamedElement", is_abstract=True)
UMLModel_StringExpression = Class(name="UMLModel_StringExpression")
UMLModel_PackageImport = Class(name="UMLModel_PackageImport")
UMLModel_Node = Class(name="UMLModel_Node")
BehavioralFeature = Class(name="BehavioralFeature")
UMLModel_OperationTemplateParameter = Class(name="UMLModel_OperationTemplateParameter")
UMLModel_OpaqueAction = Class(name="UMLModel_OpaqueAction")
UMLModel_OpaqueBehavior = Class(name="UMLModel_OpaqueBehavior")
UMLModel_OccurrenceSpecification = Class(name="UMLModel_OccurrenceSpecification")
UMLModel_ObjectFlow = Class(name="UMLModel_ObjectFlow")
UMLModel_Observation = Class(name="UMLModel_Observation", is_abstract=True)
UMLModel_ObjectNode = Class(name="UMLModel_ObjectNode", is_abstract=True)
ConnectableElement = Class(name="ConnectableElement")
UMLModel_PartDecomposition = Class(name="UMLModel_PartDecomposition")
InteractionUse = Class(name="InteractionUse")
UMLModel_ParameterableElement = Class(name="UMLModel_ParameterableElement", is_abstract=True)
UMLModel_Package = Class(name="UMLModel_Package")
UMLModel_PackageMerge = Class(name="UMLModel_PackageMerge")
UMLModel_ProfileApplication = Class(name="UMLModel_ProfileApplication")
StateMachine = Class(name="StateMachine")
UMLModel_Pin = Class(name="UMLModel_Pin")
UMLModel_PrimitiveType = Class(name="UMLModel_PrimitiveType")
UMLModel_ProtocolTransition = Class(name="UMLModel_ProtocolTransition")
Transition = Class(name="Transition")
UMLModel_Profile = Class(name="UMLModel_Profile")
StructuralFeature = Class(name="StructuralFeature")
UMLModel_ProtocolConformance = Class(name="UMLModel_ProtocolConformance")
UMLModel_Port = Class(name="UMLModel_Port")
UMLModel_Pseudostate = Class(name="UMLModel_Pseudostate")
UMLModel_RaiseExceptionAction = Class(name="UMLModel_RaiseExceptionAction")
UMLModel_ReceiveOperationEvent = Class(name="UMLModel_ReceiveOperationEvent")
UMLModel_ReceiveSignalEvent = Class(name="UMLModel_ReceiveSignalEvent")
UMLModel_ReclassifyObjectAction = Class(name="UMLModel_ReclassifyObjectAction")
UMLModel_ReadVariableAction = Class(name="UMLModel_ReadVariableAction")
UMLModel_ReadIsClassifiedObjectAction = Class(name="UMLModel_ReadIsClassifiedObjectAction")
UMLModel_ReadExtentAction = Class(name="UMLModel_ReadExtentAction")
UMLModel_ReadLinkAction = Class(name="UMLModel_ReadLinkAction")
LinkAction = Class(name="LinkAction")
UMLModel_ReadLinkObjectEndAction = Class(name="UMLModel_ReadLinkObjectEndAction")
UMLModel_ReadLinkObjectEndQualifierAction = Class(name="UMLModel_ReadLinkObjectEndQualifierAction")
UMLModel_ReadSelfAction = Class(name="UMLModel_ReadSelfAction")
UMLModel_ReadStructuralFeatureAction = Class(name="UMLModel_ReadStructuralFeatureAction")
UMLModel_RedefinableTemplateSignature = Class(name="UMLModel_RedefinableTemplateSignature")
TemplateSignature = Class(name="TemplateSignature")
UMLModel_ReduceAction = Class(name="UMLModel_ReduceAction")
UMLModel_ReplyAction = Class(name="UMLModel_ReplyAction")
UMLModel_RemoveVariableValueAction = Class(name="UMLModel_RemoveVariableValueAction")
UMLModel_RemoveStructuralFeatureValueAction = Class(name="UMLModel_RemoveStructuralFeatureValueAction")
UMLModel_RedefinableElement = Class(name="UMLModel_RedefinableElement", is_abstract=True)
UMLModel_Relationship = Class(name="UMLModel_Relationship", is_abstract=True)
UMLModel_Realization = Class(name="UMLModel_Realization")
UMLModel_Region = Class(name="UMLModel_Region")
UMLModel_Vertex = Class(name="UMLModel_Vertex", is_abstract=True)
UMLModel_Transition = Class(name="UMLModel_Transition")
UMLModel_SendSignalAction = Class(name="UMLModel_SendSignalAction")
UMLModel_SendSignalEvent = Class(name="UMLModel_SendSignalEvent")
UMLModel_SequenceNode = Class(name="UMLModel_SequenceNode")
UMLModel_SignalEvent = Class(name="UMLModel_SignalEvent")
UMLModel_StateInvariant = Class(name="UMLModel_StateInvariant")
UMLModel_StartClassifierBehaviorAction = Class(name="UMLModel_StartClassifierBehaviorAction")
UMLModel_SendObjectAction = Class(name="UMLModel_SendObjectAction")
Expression = Class(name="Expression")
UMLModel_StructuredActivityNode = Class(name="UMLModel_StructuredActivityNode")
UMLModel_StructuralFeature = Class(name="UMLModel_StructuralFeature", is_abstract=True)
UMLModel_StructuralFeatureAction = Class(name="UMLModel_StructuralFeatureAction", is_abstract=True)
UMLModel_Signal = Class(name="UMLModel_Signal")
UMLModel_State = Class(name="UMLModel_State")
UMLModel_TemplateParameter = Class(name="UMLModel_TemplateParameter")
UMLModel_StateMachine = Class(name="UMLModel_StateMachine")
UMLModel_StructuredClassifier = Class(name="UMLModel_StructuredClassifier", is_abstract=True)
UMLModel_Stereotype = Class(name="UMLModel_Stereotype")
UMLModel_TemplateableElement = Class(name="UMLModel_TemplateableElement", is_abstract=True)
UMLModel_TemplateBinding = Class(name="UMLModel_TemplateBinding")
UMLModel_TemplateSignature = Class(name="UMLModel_TemplateSignature")
UMLModel_TemplateParameterSubstitution = Class(name="UMLModel_TemplateParameterSubstitution")
UMLModel_TimeObservation = Class(name="UMLModel_TimeObservation")
UMLModel_TestIdentityAction = Class(name="UMLModel_TestIdentityAction")
UMLModel_TimeConstraint = Class(name="UMLModel_TimeConstraint")
UMLModel_TimeEvent = Class(name="UMLModel_TimeEvent")
UMLModel_TimeExpression = Class(name="UMLModel_TimeExpression")
UMLModel_TimeInterval = Class(name="UMLModel_TimeInterval")
UMLModel_Usage = Class(name="UMLModel_Usage")
UMLModel_TypedElement = Class(name="UMLModel_TypedElement", is_abstract=True)
UMLModel_Type = Class(name="UMLModel_Type", is_abstract=True)
UMLModel_UnmarshallAction = Class(name="UMLModel_UnmarshallAction")
UMLModel_UMLBase = Class(name="UMLModel_UMLBase", is_abstract=True)
EObject = Class(name="EObject")
UMLModel_ValuePin = Class(name="UMLModel_ValuePin")
UMLModel_ValueSpecificationAction = Class(name="UMLModel_ValueSpecificationAction")
UMLModel_VariableAction = Class(name="UMLModel_VariableAction", is_abstract=True)
UMLModel_WriteLinkAction = Class(name="UMLModel_WriteLinkAction", is_abstract=True)
UMLModel_WriteVariableAction = Class(name="UMLModel_WriteVariableAction", is_abstract=True)
UMLModel_WriteStructuralFeatureAction = Class(name="UMLModel_WriteStructuralFeatureAction", is_abstract=True)
...
UMLModel_Action.attributes={UMLModel_Action_context, UMLModel_Action_output, UMLModel_Action_input}
...
UMLModel_OpaqueExpression.attributes={UMLModel_OpaqueExpression_behavior, UMLModel_OpaqueExpression_body, UMLModel_OpaqueExpression_result, UMLModel_OpaqueExpression_language}
...
UMLModel_ActivityEdge.attributes={UMLModel_ActivityEdge_inStructuredNode, UMLModel_ActivityEdge_inGroup, UMLModel_ActivityEdge_source, UMLModel_ActivityEdge_activity, UMLModel_ActivityEdge_target, UMLModel_ActivityEdge_interrupts, UMLModel_ActivityEdge_redefinedEdge, UMLModel_ActivityEdge_inPartition}
...
UMLModel_ActivityGroup.attributes={UMLModel_ActivityGroup_superGroup, UMLModel_ActivityGroup_inActivity, UMLModel_ActivityGroup_subgroup}
...
UMLModel_Activity.attributes={UMLModel_Activity_isReadOnly, UMLModel_Activity_isSingleExecution, UMLModel_Activity_partition, UMLModel_Activity_structuredNode}
...
UMLModel_Variable.attributes={UMLModel_Variable_scope, UMLModel_Variable_activityScope}
...
UMLModel_ActivityNode.attributes={UMLModel_ActivityNode_inPartition, UMLModel_ActivityNode_inInterruptibleRegion, UMLModel_ActivityNode_inGroup, UMLModel_ActivityNode_redefinedNode, UMLModel_ActivityNode_inStructuredNode, UMLModel_ActivityNode_incoming, UMLModel_ActivityNode_activity, UMLModel_ActivityNode_outgoing}
...
UMLModel_ActivityPartition.attributes={UMLModel_ActivityPartition_isDimension, UMLModel_ActivityPartition_superPartition, UMLModel_ActivityPartition_subpartition, UMLModel_ActivityPartition_represents, UMLModel_ActivityPartition_node, UMLModel_ActivityPartition_isExternal, UMLModel_ActivityPartition_edge}
...
UMLModel_Association.attributes={UMLModel_Association_isDerived, UMLModel_Association_navigableOwnedEnd, UMLModel_Association_endType, UMLModel_Association_memberEnd}
...
UMLModel_Operation_class_: Property = Property(name="class_", type=StringType)
...
UMLModel_Operation.attributes={UMLModel_Operation_lower, UMLModel_Operation_isQuery, UMLModel_Operation_redefinedOperation, UMLModel_Operation_upper, UMLModel_Operation_bodyCondition, UMLModel_Operation_interface, UMLModel_Operation_type, UMLModel_Operation_datatype, UMLModel_Operation_class_, UMLModel_Operation_postcondition, UMLModel_Operation_precondition, UMLModel_Operation_isOrdered, UMLModel_Operation_isUnique}
...
UMLModel_Property_class_: Property = Property(name="class_", type=StringType)
...
UMLModel_Property.attributes={UMLModel_Property_default, UMLModel_Property_association, UMLModel_Property_datatype, UMLModel_Property_isDerived, UMLModel_Property_aggregation, UMLModel_Property_subsettedProperty, UMLModel_Property_owningAssociation, UMLModel_Property_associationEnd, UMLModel_Property_opposite, UMLModel_Property_class_, UMLModel_Property_redefinedProperty, UMLModel_Property_isComposite, UMLModel_Property_isDerivedUnion}
...
UMLModel_Behavior.attributes={UMLModel_Behavior_context, UMLModel_Behavior_redefinedBahavior, UMLModel_Behavior_specification, UMLModel_Behavior_isReentrant, UMLModel_Behavior_postcondition, UMLModel_Behavior_precondition}
...
UMLModel_Parameter.attributes={UMLModel_Parameter_parameterSet, UMLModel_Parameter_default, UMLModel_Parameter_operation, UMLModel_Parameter_direction, UMLModel_Parameter_effect, UMLModel_Parameter_isStream, UMLModel_Parameter_isException}
...
UMLModel_BehavioralFeature.attributes={UMLModel_BehavioralFeature_concurrency, UMLModel_BehavioralFeature_raisedException, UMLModel_BehavioralFeature_method, UMLModel_BehavioralFeature_isAbstract}
...
UMLModel_ClassifierTemplateParameter.attributes={UMLModel_ClassifierTemplateParameter_defaultClassifier, UMLModel_ClassifierTemplateParameter_allowSubstitutable, UMLModel_ClassifierTemplateParameter_constrainingClassifier}
...
UMLModel_Class.attributes={UMLModel_Class_superclass, UMLModel_Class_isActive, UMLModel_Class_extension}
...
UMLModel_Classifier.attributes={UMLModel_Classifier_representation, UMLModel_Classifier_general, UMLModel_Classifier_isAbstract, UMLModel_Classifier_powertypeExtent, UMLModel_Classifier_useCase, UMLModel_Classifier_inheritedMember, UMLModel_Classifier_redefinedClassifier, UMLModel_Classifier_attribute, UMLModel_Classifier_feature}
...
UMLModel_Generalization.attributes={UMLModel_Generalization_specific, UMLModel_Generalization_generalizationSet, UMLModel_Generalization_general, UMLModel_Generalization_isSubstitutable}
...
UMLModel_Component.attributes={UMLModel_Component_provided, UMLModel_Component_required, UMLModel_Component_indirectlyInstantiated}
...
UMLModel_ComponentRealization.attributes={UMLModel_ComponentRealization_realizingClassifier, UMLModel_ComponentRealization_abstraction}
...
UMLModel_Clause.attributes={UMLModel_Clause_predecessorClause, UMLModel_Clause_decider, UMLModel_Clause_test, UMLModel_Clause_successorClause, UMLModel_Clause_bodyOutput, UMLModel_Clause_body}
...
UMLModel_Comment.attributes={UMLModel_Comment_annotatedElement, UMLModel_Comment_body}
...
UMLModel_Connector.attributes={UMLModel_Connector_type, UMLModel_Connector_contract, UMLModel_Connector_kind, UMLModel_Connector_redefinedConnector}
...
UMLModel_ConnectorEnd.attributes={UMLModel_ConnectorEnd_partWithPort, UMLModel_ConnectorEnd_role, UMLModel_ConnectorEnd_definingEnd}
...
UMLModel_DeploymentSpecification.attributes={UMLModel_DeploymentSpecification_executionLocation, UMLModel_DeploymentSpecification_deploymentLocation, UMLModel_DeploymentSpecification_deployment}
...
UMLModel_Duration.attributes={UMLModel_Duration_observation, UMLModel_Duration_expr}
...
UMLModel_ElementImport.attributes={UMLModel_ElementImport_alias, UMLModel_ElementImport_importingNamespace, UMLModel_ElementImport_visibility}
...
UMLModel_ExceptionHandler.attributes={UMLModel_ExceptionHandler_exceptionType, UMLModel_ExceptionHandler_exceptionInput, UMLModel_ExceptionHandler_handlerBody, UMLModel_ExceptionHandler_protectedNode}
...
UMLModel_ExecutionSpecification.attributes={UMLModel_ExecutionSpecification_finish, UMLModel_ExecutionSpecification_start}
...
UMLModel_ExpansionNode.attributes={UMLModel_ExpansionNode_regionAsOutput, UMLModel_ExpansionNode_regionAsInput}
...
UMLModel_ExpansionRegion.attributes={UMLModel_ExpansionRegion_mode, UMLModel_ExpansionRegion_outputElement, UMLModel_ExpansionRegion_inputElement}
...
UMLModel_Extend.attributes={UMLModel_Extend_extensionLocation, UMLModel_Extend_extendedCase, UMLModel_Extend_extension}
...
UMLModel_Feature.attributes={UMLModel_Feature_isStatic, UMLModel_Feature_featuringClassifier}
...
UMLModel_GeneralOrdering.attributes={UMLModel_GeneralOrdering_after, UMLModel_GeneralOrdering_before}
...
UMLModel_GeneralizationSet.attributes={UMLModel_GeneralizationSet_powerType, UMLModel_GeneralizationSet_isDisjoint, UMLModel_GeneralizationSet_isCovering, UMLModel_GeneralizationSet_generalization}
...
UMLModel_Image.attributes={UMLModel_Image_location, UMLModel_Image_format, UMLModel_Image_content}
...
UMLModel_Include.attributes={UMLModel_Include_addition, UMLModel_Include_includingCase}
...
UMLModel_Slot.attributes={UMLModel_Slot_definingFeature, UMLModel_Slot_owningInstance}
...
UMLModel_Message.attributes={UMLModel_Message_connector, UMLModel_Message_signature, UMLModel_Message_messageKind, UMLModel_Message_sendEvent, UMLModel_Message_messageSort, UMLModel_Message_interaction, UMLModel_Message_receiveEvent}
...
UMLModel_InformationFlow.attributes={UMLModel_InformationFlow_realization, UMLModel_InformationFlow_informationTarget, UMLModel_InformationFlow_realizingConnector, UMLModel_InformationFlow_conveyed, UMLModel_InformationFlow_realizingActivityEdge, UMLModel_InformationFlow_informationSource, UMLModel_InformationFlow_realizingMessage}
...
UMLModel_LinkEndCreationData.attributes={UMLModel_LinkEndCreationData_isReplaceAll, UMLModel_LinkEndCreationData_insertAt}
...
UMLModel_LoopNode.attributes={UMLModel_LoopNode_setupPart, UMLModel_LoopNode_isTestedFirst, UMLModel_LoopNode_bodyOutput, UMLModel_LoopNode_test, UMLModel_LoopNode_loopVariable, UMLModel_LoopNode_decider, UMLModel_LoopNode_bodyPart}
...
UMLModel_Namespace.attributes={UMLModel_Namespace_importedMember, UMLModel_Namespace_member, UMLModel_Namespace_ownedMember}
...
UMLModel_MultiplicityElement.attributes={UMLModel_MultiplicityElement_isOrdered, UMLModel_MultiplicityElement_isUnique, UMLModel_MultiplicityElement_lower, UMLModel_MultiplicityElement_upper}
...
UMLModel_NamedElement.attributes={UMLModel_NamedElement_clientDependency, UMLModel_NamedElement_name, UMLModel_NamedElement_namespace, UMLModel_NamedElement_qualifiedName, UMLModel_NamedElement_visibility}
...
UMLModel_PackageImport.attributes={UMLModel_PackageImport_importingNamespace, UMLModel_PackageImport_visibility}
...
UMLModel_OpaqueAction.attributes={UMLModel_OpaqueAction_body, UMLModel_OpaqueAction_language}
...
UMLModel_OpaqueBehavior.attributes={UMLModel_OpaqueBehavior_language, UMLModel_OpaqueBehavior_body}
...
UMLModel_OccurrenceSpecification.attributes={UMLModel_OccurrenceSpecification_toAfter, UMLModel_OccurrenceSpecification_event, UMLModel_OccurrenceSpecification_toBefore}
...
UMLModel_ObjectFlow.attributes={UMLModel_ObjectFlow_selection, UMLModel_ObjectFlow_isMulticast, UMLModel_ObjectFlow_transformation, UMLModel_ObjectFlow_isMultireceive}
...
UMLModel_ObjectNode.attributes={UMLModel_ObjectNode_selection, UMLModel_ObjectNode_ordering, UMLModel_ObjectNode_inState, UMLModel_ObjectNode_isControlType}
...
UMLModel_ProfileApplication.attributes={UMLModel_ProfileApplication_isStrict, UMLModel_ProfileApplication_appliedProfile, UMLModel_ProfileApplication_applyingPackage}
...
UMLModel_ProtocolTransition.attributes={UMLModel_ProtocolTransition_postCondition, UMLModel_ProtocolTransition_preCondition, UMLModel_ProtocolTransition_referred}
...
UMLModel_Profile.attributes={UMLModel_Profile_metamodelReference, UMLModel_Profile_metaclassReference, UMLModel_Profile_ownedStereotype}
...
UMLModel_Port.attributes={UMLModel_Port_required, UMLModel_Port_protocol, UMLModel_Port_redefinedPort, UMLModel_Port_isBehavior, UMLModel_Port_provided, UMLModel_Port_isService}
...
UMLModel_Pseudostate.attributes={UMLModel_Pseudostate_stateMachine, UMLModel_Pseudostate_state, UMLModel_Pseudostate_kind}
...
UMLModel_ReadIsClassifiedObjectAction.attributes={UMLModel_ReadIsClassifiedObjectAction_classifier, UMLModel_ReadIsClassifiedObjectAction_isDirect}
...
UMLModel_RedefinableTemplateSignature.attributes={UMLModel_RedefinableTemplateSignature_extendedSignature, UMLModel_RedefinableTemplateSignature_inheritedParameter, UMLModel_RedefinableTemplateSignature_classifier}
...
UMLModel_RedefinableElement.attributes={UMLModel_RedefinableElement_isLeaf, UMLModel_RedefinableElement_redefinedElement, UMLModel_RedefinableElement_redefinitionContext}
...
UMLModel_Region.attributes={UMLModel_Region_state, UMLModel_Region_stateMachine, UMLModel_Region_extendedRegion}
...
UMLModel_Vertex.attributes={UMLModel_Vertex_container, UMLModel_Vertex_outgoing, UMLModel_Vertex_incoming}
...
UMLModel_Transition.attributes={UMLModel_Transition_guard, UMLModel_Transition_redefinedTransition, UMLModel_Transition_kind, UMLModel_Transition_target, UMLModel_Transition_container, UMLModel_Transition_source}
...
UMLModel_State.attributes={UMLModel_State_isOrthogonal, UMLModel_State_submachine, UMLModel_State_isSimple, UMLModel_State_isComposite, UMLModel_State_redefinedState, UMLModel_State_isSubmachineState}
...
UMLModel_TemplateParameter.attributes={UMLModel_TemplateParameter_parameteredElement, UMLModel_TemplateParameter_signature, UMLModel_TemplateParameter_default}
...
UMLModel_TemplateSignature.attributes={UMLModel_TemplateSignature_template, UMLModel_TemplateSignature_parameter}
...
UMLModel_TemplateParameterSubstitution.attributes={UMLModel_TemplateParameterSubstitution_actual, UMLModel_TemplateParameterSubstitution_formal, UMLModel_TemplateParameterSubstitution_templateBinding}
...
UMLModel_TimeObservation.attributes={UMLModel_TimeObservation_firstEvent, UMLModel_TimeObservation_event}
...
UMLModel_TimeExpression.attributes={UMLModel_TimeExpression_expr, UMLModel_TimeExpression_observation}
...
domain_model = DomainModel(
    name="UMLModel",
    types={UMLModel_OutputPin, UMLModel_AcceptEventAction, Action, UMLModel_Trigger, UMLModel_Action, ExecutableNode, UMLModel_Abstraction, Dependency, UMLModel_OpaqueExpression, UMLModel_AcceptCallAction, AcceptEventAction, UMLModel_ActivityEdge, UMLModel_ActivityGroup, UMLModel_Constraint, UMLModel_ActionExecutionSpecification, ExecutionSpecification, UMLModel_ActionInputPin, InputPin, UMLModel_Activity, Behavior, UMLModel_Variable, UMLModel_ActivityNode, UMLModel_ActivityPartition, NamedElement, ActivityGroup, RedefinableElement, UMLModel_ValueSpecification, UMLModel_ActivityParameterNode, ObjectNode, UMLModel_ActivityFinalNode, FinalNode, Element, UMLModel_Association, Relationship, UMLModel_AssociationClass, Class_, Association, UMLModel_Actor, BehavioredClassifier, UMLModel_AddStructuralFeatureValueAction, WriteStructuralFeatureAction, UMLModel_InputPin, UMLModel_AddVariableValueAction, WriteVariableAction, UMLModel_AnyReceiveEvent, MessageEvent, UMLModel_Artifact, Classifier, DeployedArtifact, UMLModel_Manifestation, UMLModel_Operation, UMLModel_BroadcastSignalAction, InvocationAction, UMLModel_Property, UMLModel_CallAction, UMLModel_CallBehaviorAction, CallAction, UMLModel_Behavior, UMLModel_CallEvent, UMLModel_Parameter, UMLModel_ParameterSet, UMLModel_BehaviorExecutionSpecification, UMLModel_BehavioralFeature, Namespace, Feature, UMLModel_BehavioredClassifier, UMLModel_InterfaceRealization, UMLModel_Substitution, UMLModel_CollaborationUse, UMLModel_UseCase, UMLModel_ClassifierTemplateParameter, TemplateParameter, UMLModel_CallOperationAction, UMLModel_ChangeEvent, Event, UMLModel_Class, EncapsulatedClassifier, UMLModel_Classifier, UMLModel_Reception, Type, TemplateableElement, UMLModel_Generalization, UMLModel_CommunicationPath, UMLModel_Component, UMLModel_PackageableElement, UMLModel_ComponentRealization, Realization, UMLModel_CombinedFragment, InteractionFragment, UMLModel_InteractionOperand, UMLModel_Clause, UMLModel_ClearVariableAction, VariableAction, UMLModel_ClearAssociationAction, UMLModel_ClearStructuralFeatureAction, StructuralFeatureAction, UMLModel_Collaboration, StructuredClassifier, UMLModel_Dependency, UMLModel_Comment, UMLModel_ConnectionPointReference, Vertex, UMLModel_Connector, UMLModel_ControlFlow, ActivityEdge, UMLModel_ControlNode, ActivityNode, UMLModel_CreationEvent, UMLModel_Gate, UMLModel_ConditionalNode, StructuredActivityNode, UMLModel_CreateLinkObjectAction, CreateLinkAction, UMLModel_CreateObjectAction, PackageableElement, UMLModel_CreateLinkAction, WriteLinkAction, UMLModel_CentralBufferNode, UMLModel_DataStoreNode, CentralBufferNode, UMLModel_DataType, UMLModel_ConsiderIgnoreFragment, CombinedFragment, UMLModel_Continuation, UMLModel_DecisionNode, UMLModel_ConnectableElement, ControlNode, TypedElement, ParameterableElement, UMLModel_ConnectableElementTemplateParameter, DirectedRelationship, UMLModel_ConnectorEnd, MultiplicityElement, UMLModel_DeploymentTarget, UMLModel_Deployment, UMLModel_DeploymentSpecification, UMLModel_DeployedArtifact, Artifact, UMLModel_DirectedRelationship, UMLModel_Device, Node, UMLModel_DestroyLinkAction, UMLModel_DestroyObjectAction, UMLModel_Enumeration, DataType, UMLModel_EnumerationLiteral, UMLModel_DestructionEvent, UMLModel_Duration, ValueSpecification, UMLModel_DurationConstraint, IntervalConstraint, UMLModel_DurationInterval, Interval, UMLModel_DurationObservation, Observation, UMLModel_Element, UMLBase, UMLModel_ElementImport, UMLModel_EncapsulatedClassifier, InstanceSpecification, UMLModel_ExceptionHandler, UMLModel_ExecutableNode, UMLModel_ExecutionEnvironment, UMLModel_ExecutionEvent, UMLModel_ExecutionOccurrenceSpecification, OccurrenceSpecification, UMLModel_ExecutionSpecification, UMLModel_ExpansionNode, UMLModel_ExpansionRegion, UMLModel_Extend, UMLModel_Extension, UMLModel_ExtensionEnd, Property_, UMLModel_ExtensionPoint, UMLModel_Expression, UMLModel_Event, UMLModel_Feature, UMLModel_FinalState, State, UMLModel_ForkNode, UMLModel_FlowFinalNode, UMLModel_FinalNode, UMLModel_FunctionBehavior, OpaqueBehavior, MessageEnd, UMLModel_GeneralOrdering, UMLModel_GeneralizationSet, UMLModel_InvocationAction, UMLModel_Image, UMLModel_Interface, UMLModel_ProtocolStateMachine, UMLModel_Include, UMLModel_InstanceSpecification, DeploymentTarget, UMLModel_Slot, UMLModel_InstanceValue, UMLModel_InterruptibleActivityRegion, Pin, UMLModel_Interval, UMLModel_InitialNode, UMLModel_Interaction, UMLModel_Lifeline, UMLModel_InteractionFragment, UMLModel_Message, UMLModel_InteractionUse, UMLModel_InteractionConstraint, Constraint, UMLModel_IntervalConstraint, UMLModel_InformationItem, UMLModel_InformationFlow, UMLModel_JoinNode, UMLModel_LiteralSpecification, UMLModel_LiteralInteger, LiteralSpecification, UMLModel_LiteralString, UMLModel_LiteralBoolean, UMLModel_LiteralNull, UMLModel_LiteralUnlimitedNatural, UMLModel_LinkAction, UMLModel_LinkEndData, UMLModel_QualifierValue, UMLModel_LinkEndCreationData, LinkEndData, UMLModel_LinkEndDestructionData, UMLModel_LoopNode, Abstraction, UMLModel_Namespace, UMLModel_MessageEnd, UMLModel_MessageEvent, UMLModel_MessageOccurrenceSpecification, UMLModel_MergeNode, UMLModel_Model, Package, UMLModel_MultiplicityElement, UMLModel_NamedElement, UMLModel_StringExpression, UMLModel_PackageImport, UMLModel_Node, BehavioralFeature, UMLModel_OperationTemplateParameter, UMLModel_OpaqueAction, UMLModel_OpaqueBehavior, UMLModel_OccurrenceSpecification, UMLModel_ObjectFlow, UMLModel_Observation, UMLModel_ObjectNode, ConnectableElement, UMLModel_PartDecomposition, InteractionUse, UMLModel_ParameterableElement, UMLModel_Package, UMLModel_PackageMerge, UMLModel_ProfileApplication, StateMachine, UMLModel_Pin, UMLModel_PrimitiveType, UMLModel_ProtocolTransition, Transition, UMLModel_Profile, StructuralFeature, UMLModel_ProtocolConformance, UMLModel_Port, UMLModel_Pseudostate, UMLModel_RaiseExceptionAction, UMLModel_ReceiveOperationEvent, UMLModel_ReceiveSignalEvent, UMLModel_ReclassifyObjectAction, UMLModel_ReadVariableAction, UMLModel_ReadIsClassifiedObjectAction, UMLModel_ReadExtentAction, UMLModel_ReadLinkAction, LinkAction, UMLModel_ReadLinkObjectEndAction, UMLModel_ReadLinkObjectEndQualifierAction, UMLModel_ReadSelfAction, UMLModel_ReadStructuralFeatureAction, UMLModel_RedefinableTemplateSignature, TemplateSignature, UMLModel_ReduceAction, UMLModel_ReplyAction, UMLModel_RemoveVariableValueAction, UMLModel_RemoveStructuralFeatureValueAction, UMLModel_RedefinableElement, UMLModel_Relationship, UMLModel_Realization, UMLModel_Region, UMLModel_Vertex, UMLModel_Transition, UMLModel_SendSignalAction, UMLModel_SendSignalEvent, UMLModel_SequenceNode, UMLModel_SignalEvent, UMLModel_StateInvariant, UMLModel_StartClassifierBehaviorAction, UMLModel_SendObjectAction, Expression, UMLModel_StructuredActivityNode, UMLModel_StructuralFeature, UMLModel_StructuralFeatureAction, UMLModel_Signal, UMLModel_State, UMLModel_TemplateParameter, UMLModel_StateMachine, UMLModel_StructuredClassifier, UMLModel_Stereotype, UMLModel_TemplateableElement, UMLModel_TemplateBinding, UMLModel_TemplateSignature, UMLModel_TemplateParameterSubstitution, UMLModel_TimeObservation, UMLModel_TestIdentityAction, UMLModel_TimeConstraint, UMLModel_TimeEvent, UMLModel_TimeExpression, UMLModel_TimeInterval, UMLModel_Usage, UMLModel_TypedElement, UMLModel_Type, UMLModel_UnmarshallAction, UMLModel_UMLBase, EObject, UMLModel_ValuePin, UMLModel_ValueSpecificationAction, UMLModel_VariableAction, UMLModel_WriteLinkAction, UMLModel_WriteVariableAction, UMLModel_WriteStructuralFeatureAction, AggregationKind, CallConcurrencyKind, ConnectorKind, ExpansionKind, InteractionOperatorKind, MessageKind, MessageSort, ObjectNodeOrderingKind, ParameterDirectionKind, ParameterEffectKind, PseudostateKind, TransitionKind, VisibilityKind},
    associations={returnInformation1, result2, trigger4, mapping0, edge15, group17, localPrecondition6, localPostcondition7, fromAction10, variable12, node13, containedEdge24, containedNode27, guard19, weight21, ownedEnd41, insertAt30, insertAt31, nestedArtifact34, manifestation35, ownedTrigger55, ownedOperation37, ownedAttribute39, result58, ownedParameter43, ownedParameterSet44, ownedParameter46, ownedParameterSet48, ownedBehavior51, interfaceRealization53, substitution72, collaborationUse74, ownedUseCase76, target60, changeExpression62, nestedClassifier64, ownedOperation65, ownedReception68, generalization70, packagedElement82, realization83, operand85, object78, roleBinding80, end95, cfragmentGate86, result96, clause88, result89, result98, specification92, ownedAttribute100, ownedOperation102, deployment105, configuration106, ownedLiteral113, target108, ownedComment110, importedElement111, condition115, handler114, operand117, ownedAttribute119, ownedOperation121, nestedClassifier124, ownedReception127, protocol130, slot132, specification133, argument136, lifeline138, fragment139, action141, formalGate144, message147, generalOrdering149, actualGate151, argument153, guard156, fragment158, minint161, maxint164, joinSpec167, selector169, endData172, inputValue173, qualifier176, result178, loopVariableInput180, argument183, upperValue186, lowerValue188, nameExpression191, elementImport192, packageImport194, ownedRule196, nestedNode200, inputValue201, defaultValue208, outputValue203, upperBound206, packageMerge211, packagedElement212, profileApplication215, importedPackage217, condition220, defaultValue223, qualifier227, conformance229, exception231, object233, result235, object237, result240, result242, object244, result246, object249, result251, result254, result256, result258, result260, collection262, returnInformation265, replyValue267, removeAt270, removeAt272, subvertex274, transition275, target277, executableNode279, value281, invariant284, object286, target288, request290, subExpression294, variable296, edge298, node301, object304, ownedAttribute306, connection308, connectionPoint309, deferrableTrigger323, stateInvariant311, entry314, exit317, doActivity320, region326, region329, connectionPoint331, ownedAttribute334, ownedConnector336, icon339, templateBinding340, ownedTemplateSignature341, parameterSubstitution343, ownedParameter345, ownedParameteredElement347, ownedDefault349, ownedActual352, first355, second357, result360, when363, effect365, trigger368, result371, object373, include376, extend378, extensionPoint381, value383, value385, result387, value390, value392},
    generalizations={gen_UMLModel_AcceptEventAction_Action, gen_UMLModel_Action_ExecutableNode, gen_UMLModel_Abstraction_Dependency, gen_UMLModel_AcceptCallAction_AcceptEventAction, gen_UMLModel_ActionExecutionSpecification_ExecutionSpecification, gen_UMLModel_ActionInputPin_InputPin, gen_UMLModel_Activity_Behavior, gen_UMLModel_ActivityPartition_NamedElement, gen_UMLModel_ActivityPartition_ActivityGroup, gen_UMLModel_ActivityEdge_RedefinableElement, gen_UMLModel_ActivityParameterNode_ObjectNode, gen_UMLModel_ActivityFinalNode_FinalNode, gen_UMLModel_ActivityNode_RedefinableElement, gen_UMLModel_ActivityGroup_Element, gen_UMLModel_Association_Classifier, gen_UMLModel_Association_Relationship, gen_UMLModel_AssociationClass_Class, gen_UMLModel_AssociationClass_Association, gen_UMLModel_Actor_BehavioredClassifier, gen_UMLModel_AddStructuralFeatureValueAction_WriteStructuralFeatureAction, gen_UMLModel_AddVariableValueAction_WriteVariableAction, gen_UMLModel_AnyReceiveEvent_MessageEvent, gen_UMLModel_Artifact_Classifier, gen_UMLModel_Artifact_DeployedArtifact, gen_UMLModel_BroadcastSignalAction_InvocationAction, gen_UMLModel_CallAction_InvocationAction, gen_UMLModel_CallBehaviorAction_CallAction, gen_UMLModel_Behavior_Class, gen_UMLModel_CallEvent_MessageEvent, gen_UMLModel_BehaviorExecutionSpecification_ExecutionSpecification, gen_UMLModel_BehavioralFeature_Namespace, gen_UMLModel_BehavioralFeature_Feature, gen_UMLModel_BehavioredClassifier_Classifier, gen_UMLModel_ClassifierTemplateParameter_TemplateParameter, gen_UMLModel_CallOperationAction_CallAction, gen_UMLModel_ChangeEvent_Event, gen_UMLModel_Class_EncapsulatedClassifier, gen_UMLModel_Class_BehavioredClassifier, gen_UMLModel_Classifier_Namespace, gen_UMLModel_Classifier_RedefinableElement, gen_UMLModel_Classifier_Type, gen_UMLModel_Classifier_TemplateableElement, gen_UMLModel_CommunicationPath_Association, gen_UMLModel_Component_Class, gen_UMLModel_ComponentRealization_Realization, gen_UMLModel_CombinedFragment_InteractionFragment, gen_UMLModel_Clause_Element, gen_UMLModel_ClearVariableAction_VariableAction, gen_UMLModel_ClearAssociationAction_Action, gen_UMLModel_ClearStructuralFeatureAction_StructuralFeatureAction, gen_UMLModel_Collaboration_BehavioredClassifier, gen_UMLModel_Collaboration_StructuredClassifier, gen_UMLModel_CollaborationUse_NamedElement, gen_UMLModel_Comment_Element, gen_UMLModel_ConnectionPointReference_Vertex, gen_UMLModel_Connector_Feature, gen_UMLModel_ControlFlow_ActivityEdge, gen_UMLModel_ControlNode_ActivityNode, gen_UMLModel_CreationEvent_Event, gen_UMLModel_ConditionalNode_StructuredActivityNode, gen_UMLModel_CreateLinkObjectAction_CreateLinkAction, gen_UMLModel_CreateObjectAction_Action, gen_UMLModel_Constraint_PackageableElement, gen_UMLModel_CreateLinkAction_WriteLinkAction, gen_UMLModel_CentralBufferNode_ObjectNode, gen_UMLModel_DataStoreNode_CentralBufferNode, gen_UMLModel_DataType_Classifier, gen_UMLModel_ConsiderIgnoreFragment_CombinedFragment, gen_UMLModel_Continuation_InteractionFragment, gen_UMLModel_DecisionNode_ControlNode, gen_UMLModel_ConnectableElement_TypedElement, gen_UMLModel_ConnectableElement_ParameterableElement, gen_UMLModel_Dependency_PackageableElement, gen_UMLModel_ConnectableElementTemplateParameter_TemplateParameter, gen_UMLModel_Dependency_DirectedRelationship, gen_UMLModel_ConnectorEnd_MultiplicityElement, gen_UMLModel_DeploymentTarget_NamedElement, gen_UMLModel_Deployment_Dependency, gen_UMLModel_DeployedArtifact_NamedElement, gen_UMLModel_DeploymentSpecification_Artifact, gen_UMLModel_DirectedRelationship_Relationship, gen_UMLModel_Device_Node, gen_UMLModel_DestroyLinkAction_WriteLinkAction, gen_UMLModel_DestroyObjectAction_Action, gen_UMLModel_Enumeration_DataType, gen_UMLModel_DestructionEvent_Event, gen_UMLModel_Duration_ValueSpecification, gen_UMLModel_DurationConstraint_IntervalConstraint, gen_UMLModel_DurationInterval_Interval, gen_UMLModel_DurationObservation_Observation, gen_UMLModel_Element_UMLBase, gen_UMLModel_ElementImport_DirectedRelationship, gen_UMLModel_EncapsulatedClassifier_StructuredClassifier, gen_UMLModel_EnumerationLiteral_InstanceSpecification, gen_UMLModel_ExceptionHandler_Element, gen_UMLModel_ExecutableNode_ActivityNode, gen_UMLModel_ExecutionEnvironment_Node, gen_UMLModel_ExecutionEvent_Event, gen_UMLModel_ExecutionOccurrenceSpecification_OccurrenceSpecification, gen_UMLModel_ExecutionSpecification_InteractionFragment, gen_UMLModel_ExpansionNode_ObjectNode, gen_UMLModel_ExpansionRegion_StructuredActivityNode, gen_UMLModel_Extend_NamedElement, gen_UMLModel_Extend_DirectedRelationship, gen_UMLModel_Extension_Association, gen_UMLModel_ExtensionEnd_Property, gen_UMLModel_ExtensionPoint_RedefinableElement, gen_UMLModel_Expression_ValueSpecification, gen_UMLModel_Event_PackageableElement, gen_UMLModel_Feature_RedefinableElement, gen_UMLModel_FinalState_State, gen_UMLModel_ForkNode_ControlNode, gen_UMLModel_FlowFinalNode_FinalNode, gen_UMLModel_FinalNode_ControlNode, gen_UMLModel_FunctionBehavior_OpaqueBehavior, gen_UMLModel_Gate_MessageEnd, gen_UMLModel_GeneralOrdering_NamedElement, gen_UMLModel_Generalization_DirectedRelationship, gen_UMLModel_GeneralizationSet_PackageableElement, gen_UMLModel_InvocationAction_Action, gen_UMLModel_Image_Element, gen_UMLModel_InterfaceRealization_Realization, gen_UMLModel_Interface_Classifier, gen_UMLModel_Include_NamedElement, gen_UMLModel_Include_DirectedRelationship, gen_UMLModel_InstanceSpecification_DeploymentTarget, gen_UMLModel_InstanceSpecification_PackageableElement, gen_UMLModel_InstanceSpecification_DeployedArtifact, gen_UMLModel_InstanceValue_ValueSpecification, gen_UMLModel_InterruptibleActivityRegion_ActivityGroup, gen_UMLModel_InputPin_Pin, gen_UMLModel_Interval_ValueSpecification, gen_UMLModel_InitialNode_ControlNode, gen_UMLModel_Interaction_Behavior, gen_UMLModel_Interaction_InteractionFragment, gen_UMLModel_InteractionFragment_NamedElement, gen_UMLModel_InteractionUse_InteractionFragment, gen_UMLModel_InteractionOperand_Namespace, gen_UMLModel_InteractionOperand_InteractionFragment, gen_UMLModel_InteractionConstraint_Constraint, gen_UMLModel_IntervalConstraint_Constraint, gen_UMLModel_InformationItem_Classifier, gen_UMLModel_InformationFlow_PackageableElement, gen_UMLModel_InformationFlow_DirectedRelationship, gen_UMLModel_JoinNode_ControlNode, gen_UMLModel_LiteralSpecification_ValueSpecification, gen_UMLModel_LiteralInteger_LiteralSpecification, gen_UMLModel_LiteralString_LiteralSpecification, gen_UMLModel_LiteralBoolean_LiteralSpecification, gen_UMLModel_LiteralNull_LiteralSpecification, gen_UMLModel_LiteralUnlimitedNatural_LiteralSpecification, gen_UMLModel_Lifeline_NamedElement, gen_UMLModel_LinkAction_Action, gen_UMLModel_LinkEndData_Element, gen_UMLModel_LinkEndCreationData_LinkEndData, gen_UMLModel_LinkEndDestructionData_LinkEndData, gen_UMLModel_LoopNode_StructuredActivityNode, gen_UMLModel_Manifestation_Abstraction, gen_UMLModel_Message_NamedElement, gen_UMLModel_Namespace_NamedElement, gen_UMLModel_MessageEnd_NamedElement, gen_UMLModel_MessageEvent_Event, gen_UMLModel_MessageOccurrenceSpecification_OccurrenceSpecification, gen_UMLModel_MessageOccurrenceSpecification_MessageEnd, gen_UMLModel_MergeNode_ControlNode, gen_UMLModel_Model_Package, gen_UMLModel_MultiplicityElement_Element, gen_UMLModel_NamedElement_Element, gen_UMLModel_Node_Class, gen_UMLModel_Node_DeploymentTarget, gen_UMLModel_Operation_BehavioralFeature, gen_UMLModel_Operation_ParameterableElement, gen_UMLModel_Operation_TemplateableElement, gen_UMLModel_OperationTemplateParameter_TemplateParameter, gen_UMLModel_OpaqueAction_Action, gen_UMLModel_OpaqueBehavior_Behavior, gen_UMLModel_OpaqueExpression_ValueSpecification, gen_UMLModel_OccurrenceSpecification_InteractionFragment, gen_UMLModel_ObjectFlow_ActivityEdge, gen_UMLModel_Observation_PackageableElement, gen_UMLModel_ObjectNode_ActivityNode, gen_UMLModel_ObjectNode_TypedElement, gen_UMLModel_OutputPin_Pin, gen_UMLModel_Parameter_ConnectableElement, gen_UMLModel_Parameter_MultiplicityElement, gen_UMLModel_ParameterableElement_Element, gen_UMLModel_Package_Namespace, gen_UMLModel_Package_PackageableElement, gen_UMLModel_Package_TemplateableElement, gen_UMLModel_PackageableElement_NamedElement, gen_UMLModel_PackageableElement_ParameterableElement, gen_UMLModel_PackageImport_DirectedRelationship, gen_UMLModel_PackageMerge_DirectedRelationship, gen_UMLModel_ParameterSet_NamedElement, gen_UMLModel_PartDecomposition_InteractionUse, gen_UMLModel_ProtocolStateMachine_StateMachine, gen_UMLModel_Pin_ObjectNode, gen_UMLModel_Pin_MultiplicityElement, gen_UMLModel_PrimitiveType_DataType, gen_UMLModel_ProtocolTransition_Transition, gen_UMLModel_Profile_Package, gen_UMLModel_ProfileApplication_DirectedRelationship, gen_UMLModel_Property_StructuralFeature, gen_UMLModel_Property_ConnectableElement, gen_UMLModel_Property_DeploymentTarget, gen_UMLModel_Property_TemplateableElement, gen_UMLModel_ProtocolConformance_DirectedRelationship, gen_UMLModel_Port_Property, gen_UMLModel_Pseudostate_Vertex, gen_UMLModel_QualifierValue_Element, gen_UMLModel_RaiseExceptionAction_Action, gen_UMLModel_ReceiveOperationEvent_MessageEvent, gen_UMLModel_ReceiveSignalEvent_MessageEvent, gen_UMLModel_ReclassifyObjectAction_Action, gen_UMLModel_ReadVariableAction_VariableAction, gen_UMLModel_ReadIsClassifiedObjectAction_Action, gen_UMLModel_ReadExtentAction_Action, gen_UMLModel_ReadLinkAction_LinkAction, gen_UMLModel_ReadLinkObjectEndAction_Action, gen_UMLModel_ReadLinkObjectEndQualifierAction_Action, gen_UMLModel_ReadSelfAction_Action, gen_UMLModel_ReadStructuralFeatureAction_StructuralFeatureAction, gen_UMLModel_Reception_BehavioralFeature, gen_UMLModel_RedefinableTemplateSignature_RedefinableElement, gen_UMLModel_RedefinableTemplateSignature_TemplateSignature, gen_UMLModel_ReduceAction_Action, gen_UMLModel_ReplyAction_Action, gen_UMLModel_RemoveVariableValueAction_WriteVariableAction, gen_UMLModel_RemoveStructuralFeatureValueAction_WriteStructuralFeatureAction, gen_UMLModel_RedefinableElement_NamedElement, gen_UMLModel_Relationship_Element, gen_UMLModel_Realization_Abstraction, gen_UMLModel_Region_Namespace, gen_UMLModel_Region_RedefinableElement, gen_UMLModel_SendSignalAction_InvocationAction, gen_UMLModel_SendSignalEvent_MessageEvent, gen_UMLModel_SequenceNode_StructuredActivityNode, gen_UMLModel_SignalEvent_MessageEvent, gen_UMLModel_Slot_Element, gen_UMLModel_StructuralFeatureAction_Action, gen_UMLModel_StateInvariant_InteractionFragment, gen_UMLModel_StartClassifierBehaviorAction_Action, gen_UMLModel_SendObjectAction_InvocationAction, gen_UMLModel_StringExpression_Expression, gen_UMLModel_StringExpression_TemplateableElement, gen_UMLModel_StructuredActivityNode_Action, gen_UMLModel_StructuredActivityNode_Namespace, gen_UMLModel_StructuredActivityNode_ActivityGroup, gen_UMLModel_StructuralFeature_Feature, gen_UMLModel_StructuralFeature_TypedElement, gen_UMLModel_StructuralFeature_MultiplicityElement, gen_UMLModel_Substitution_Realization, gen_UMLModel_Signal_Classifier, gen_UMLModel_State_Namespace, gen_UMLModel_State_RedefinableElement, gen_UMLModel_State_Vertex, gen_UMLModel_StateMachine_Behavior, gen_UMLModel_StructuredClassifier_Classifier, gen_UMLModel_Stereotype_Class, gen_UMLModel_TemplateableElement_Element, gen_UMLModel_TemplateBinding_DirectedRelationship, gen_UMLModel_TemplateSignature_Element, gen_UMLModel_TimeObservation_Observation, gen_UMLModel_TemplateParameter_Element, gen_UMLModel_TemplateParameterSubstitution_Element, gen_UMLModel_TestIdentityAction_Action, gen_UMLModel_TimeConstraint_IntervalConstraint, gen_UMLModel_TimeEvent_Event, gen_UMLModel_TimeExpression_ValueSpecification, gen_UMLModel_TimeInterval_Interval, gen_UMLModel_Usage_Dependency, gen_UMLModel_Transition_Namespace, gen_UMLModel_Transition_RedefinableElement, gen_UMLModel_Trigger_NamedElement, gen_UMLModel_TypedElement_NamedElement, gen_UMLModel_Type_PackageableElement, gen_UMLModel_UnmarshallAction_Action, gen_UMLModel_UMLBase_EObject, gen_UMLModel_UseCase_BehavioredClassifier, gen_UMLModel_ValuePin_InputPin, gen_UMLModel_ValueSpecificationAction_Action, gen_UMLModel_ValueSpecification_PackageableElement, gen_UMLModel_ValueSpecification_TypedElement, gen_UMLModel_Variable_ConnectableElement, gen_UMLModel_Variable_MultiplicityElement, gen_UMLModel_VariableAction_Action, gen_UMLModel_Vertex_NamedElement, gen_UMLModel_WriteLinkAction_LinkAction, gen_UMLModel_WriteVariableAction_VariableAction, gen_UMLModel_WriteStructuralFeatureAction_StructuralFeatureAction},
    metadata=None
)
