...
# Classes
Core_ITypeRoot = Class(name="Core_ITypeRoot", is_abstract=True)
ISourceReference = Class(name="ISourceReference")
Core_ICompilationUnit = Class(name="Core_ICompilationUnit")
ITypeRoot = Class(name="ITypeRoot")
IType = Class(name="IType")
IImportDeclaration = Class(name="IImportDeclaration")
Core_IJavaElement = Class(name="Core_IJavaElement", is_abstract=True)
Core_PhysicalElement = Class(name="Core_PhysicalElement", is_abstract=True)
Core_IJavaModel = Class(name="Core_IJavaModel")
...
Core_IJavaProject = Class(name="Core_IJavaProject")
IJavaElement = Class(name="IJavaElement")
Core_IPackageFragmentRoot = Class(name="Core_IPackageFragmentRoot", is_abstract=True)
IPackageFragment = Class(name="IPackageFragment")
Core_BinaryPackageFragmentRoot = Class(name="Core_BinaryPackageFragmentRoot")
Core_SourcePackageFragmentRoot = Class(name="Core_SourcePackageFragmentRoot")
Core_IPackageFragment = Class(name="Core_IPackageFragment")
IClassFile = Class(name="IClassFile")
ICompilationUnit = Class(name="ICompilationUnit")
ITypeParameter = Class(name="ITypeParameter")
Core_ITypeParameter = Class(name="Core_ITypeParameter")
Core_IInitializer = Class(name="Core_IInitializer")
Core_IField = Class(name="Core_IField")
CompilationUnit = Class(name="CompilationUnit")
Core_IClassFile = Class(name="Core_IClassFile")
Core_ISourceReference = Class(name="Core_ISourceReference", is_abstract=True)
ISourceRange = Class(name="ISourceRange")
Core_IImportDeclaration = Class(name="Core_IImportDeclaration")
Core_ISourceRange = Class(name="Core_ISourceRange")
Core_IMember = Class(name="Core_IMember", is_abstract=True)
Core_IType = Class(name="Core_IType")
...
Core_IMethod = Class(name="Core_IMethod")
...
PrimitiveTypes_Core_IJavaElement = Class(name="PrimitiveTypes_Core_IJavaElement", is_abstract=True)
PrimitiveTypes_Core_PhysicalElement = Class(name="PrimitiveTypes_Core_PhysicalElement", is_abstract=True)
PrimitiveTypes_Core_IJavaModel = Class(name="PrimitiveTypes_Core_IJavaModel")
PrimitiveTypes_Core_IJavaProject = Class(name="PrimitiveTypes_Core_IJavaProject")
PrimitiveTypes_Core_IPackageFragmentRoot = Class(name="PrimitiveTypes_Core_IPackageFragmentRoot", is_abstract=True)
...
PrimitiveTypes_Core_IClassFile = Class(name="PrimitiveTypes_Core_IClassFile")
PrimitiveTypes_Core_ISourceReference = Class(name="PrimitiveTypes_Core_ISourceReference", is_abstract=True)
PrimitiveTypes_Core_IImportDeclaration = Class(name="PrimitiveTypes_Core_IImportDeclaration")
PrimitiveTypes_Core_ISourceRange = Class(name="PrimitiveTypes_Core_ISourceRange")
PrimitiveTypes_Core_BinaryPackageFragmentRoot = Class(name="PrimitiveTypes_Core_BinaryPackageFragmentRoot")
PrimitiveTypes_Core_SourcePackageFragmentRoot = Class(name="PrimitiveTypes_Core_SourcePackageFragmentRoot")
PrimitiveTypes_Core_IPackageFragment = Class(name="PrimitiveTypes_Core_IPackageFragment")
PrimitiveTypes_Core_ITypeRoot = Class(name="PrimitiveTypes_Core_ITypeRoot", is_abstract=True)
PrimitiveTypes_Core_ICompilationUnit = Class(name="PrimitiveTypes_Core_ICompilationUnit")
PrimitiveTypes_Core_ITypeParameter = Class(name="PrimitiveTypes_Core_ITypeParameter")
PrimitiveTypes_Core_IInitializer = Class(name="PrimitiveTypes_Core_IInitializer")
PrimitiveTypes_Core_IField = Class(name="PrimitiveTypes_Core_IField")
PrimitiveTypes_Core_IMethod = Class(name="PrimitiveTypes_Core_IMethod")
PrimitiveTypes_Core_Parameter = Class(name="PrimitiveTypes_Core_Parameter")
PrimitiveTypes_Core_IMember = Class(name="PrimitiveTypes_Core_IMember", is_abstract=True)
PrimitiveTypes_Core_IType = Class(name="PrimitiveTypes_Core_IType")
...
Core_IField.attributes={Core_IField_typeSignature, Core_IField_isTransient, Core_IField_constant, Core_IField_isEnumConstant, Core_IField_isVolatile}
...
DOM_Modifier.attributes={DOM_Modifier_final, DOM_Modifier_protected, DOM_Modifier_abstract, DOM_Modifier_private, DOM_Modifier_transient, DOM_Modifier_synchronized, DOM_Modifier_none, DOM_Modifier_native, DOM_Modifier_static, DOM_Modifier_strictfp, DOM_Modifier_public, DOM_Modifier_volatile}
...
PrimitiveTypes_Core_IClassFile.attributes={PrimitiveTypes_Core_IClassFile_isClass, PrimitiveTypes_Core_IClassFile_isInterface}
...
PrimitiveTypes_Core_ISourceRange.attributes={PrimitiveTypes_Core_ISourceRange_offset, PrimitiveTypes_Core_ISourceRange_length}
...
PrimitiveTypes_Core_IField.attributes={PrimitiveTypes_Core_IField_isTransient, PrimitiveTypes_Core_IField_constant, PrimitiveTypes_Core_IField_isEnumConstant, PrimitiveTypes_Core_IField_isVolatile, PrimitiveTypes_Core_IField_typeSignature}
...
PrimitiveTypes_Core_IMethod.attributes={PrimitiveTypes_Core_IMethod_returnType, PrimitiveTypes_Core_IMethod_exceptionTypes, PrimitiveTypes_Core_IMethod_isConstructor, PrimitiveTypes_Core_IMethod_isMainMethod}
...
PrimitiveTypes_Core_Parameter.attributes={PrimitiveTypes_Core_Parameter_name, PrimitiveTypes_Core_Parameter_type}
...
PrimitiveTypes_Core_IType.attributes={PrimitiveTypes_Core_IType_fullyQualifiedParametrizedName, PrimitiveTypes_Core_IType_fullyQualifiedName}

# Relationships
compilationUnits15: BinaryAssociation = BinaryAssociation(
    name="compilationUnits15",
    ends={
        Property(name="Core_IPackageFragment16", type=ICompilationUnit, multiplicity=Multiplicity(0, 9999), is_composite=True),
...
imports18: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="Core_ICompilationUnit19", type=IImportDeclaration, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
types20: BinaryAssociation = BinaryAssociation(
    name="types20",
    ends={
        Property(name="IType22", type=Core_ICompilationUnit, multiplicity=Multiplicity(1, 1)),
        Property(name="Core_ICompilationUnit21", type=IType, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
primary23: BinaryAssociation = BinaryAssociation(
    name="primary23",
    ends={
        Property(name="ICompilationUnit25", type=Core_ICompilationUnit, multiplicity=Multiplicity(1, 1)),
        Property(name="Core_ICompilationUnit24", type=ICompilationUnit, multiplicity=Multiplicity(1, 1))
    }
)
...
packageFragments11: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="packageFragmentRoot", type=IPackageFragment, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
packageFragmentRoot12: BinaryAssociation = BinaryAssociation(
    name="packageFragmentRoot12",
    ends={
        Property(name="IPackageFragmentRoot13", type=Core_IPackageFragment, multiplicity=Multiplicity(1, 1)),
        Property(name="packageFragments", type=IPackageFragmentRoot, multiplicity=Multiplicity(1, 1))
    }
)
...
methods39: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="Core_IType40", type=IMethod, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
types41: BinaryAssociation = BinaryAssociation(
    name="types41",
    ends={
        Property(name="IType43", type=Core_IType, multiplicity=Multiplicity(1, 1)),
        Property(name="Core_IType42", type=IType, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
typeParameters44: BinaryAssociation = BinaryAssociation(
    name="typeParameters44",
    ends={
        Property(name="ITypeParameter", type=Core_IType, multiplicity=Multiplicity(1, 1)),
        Property(name="Core_IType45", type=ITypeParameter, multiplicity=Multiplicity(0, 9999))
    }
)
ast26: BinaryAssociation = BinaryAssociation(
    name="ast26",
    ends={
        Property(name="CompilationUnit", type=Core_ICompilationUnit, multiplicity=Multiplicity(1, 1)),
        Property(name="Core_ICompilationUnit27", type=CompilationUnit, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
type28: BinaryAssociation = BinaryAssociation(
    name="type28",
    ends={
        Property(name="IType29", type=Core_IClassFile, multiplicity=Multiplicity(1, 1)),
        Property(name="Core_IClassFile", type=IType, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
sourceRange30: BinaryAssociation = BinaryAssociation(
    name="sourceRange30",
    ends={
...
javadocRange31: BinaryAssociation = BinaryAssociation(
    name="javadocRange31",
    ends={
        Property(name="ISourceRange32", type=Core_IMember, multiplicity=Multiplicity(1, 1)),
        Property(name="Core_IMember", type=ISourceRange, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
nameRange33: BinaryAssociation = BinaryAssociation(
    name="nameRange33",
    ends={
        Property(name="ISourceRange35", type=Core_IMember, multiplicity=Multiplicity(1, 1)),
        Property(name="Core_IMember34", type=ISourceRange, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
initializers36: BinaryAssociation = BinaryAssociation(
    name="initializers36",
    ends={
...
fields37: BinaryAssociation = BinaryAssociation(
    name="fields37",
    ends={
        Property(name="IField", type=Core_IType, multiplicity=Multiplicity(1, 1)),
        Property(name="Core_IType38", type=IField, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
modifiers49: BinaryAssociation = BinaryAssociation(
    name="modifiers49",
    ends={
...
javadoc50: BinaryAssociation = BinaryAssociation(
    name="javadoc50",
    ends={
        Property(name="Javadoc", type=DOM_BodyDeclaration, multiplicity=Multiplicity(1, 1)),
        Property(name="DOM_BodyDeclaration51", type=Javadoc, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
...
exception53: BinaryAssociation = BinaryAssociation(
    name="exception53",
    ends={
        Property(name="SingleVariableDeclaration", type=DOM_CatchClause, multiplicity=Multiplicity(1, 1)),
        Property(name="DOM_CatchClause54", type=SingleVariableDeclaration, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
alternateRoot55: BinaryAssociation = BinaryAssociation(
    name="alternateRoot55",
    ends={
        Property(name="ASTNode56", type=DOM_Comment, multiplicity=Multiplicity(1, 1)),
...
compilationUnits47: BinaryAssociation = BinaryAssociation(
    name="compilationUnits47",
    ends={
...
bodyDeclarations48: BinaryAssociation = BinaryAssociation(
    name="bodyDeclarations48",
    ends={
...
qualifier77: BinaryAssociation = BinaryAssociation(
    name="qualifier77",
    ends={
        Property(name="Name79", type=DOM_MethodRef, multiplicity=Multiplicity(1, 1)),
        Property(name="DOM_MethodRef78", type=Name, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
parameters80: BinaryAssociation = BinaryAssociation(
    name="parameters80",
    ends={
        Property(name="MethodRefParameter", type=DOM_MethodRef, multiplicity=Multiplicity(1, 1)),
        Property(name="DOM_MethodRef81", type=MethodRefParameter, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
name82: BinaryAssociation = BinaryAssociation(
    name="name82",
    ends={
        Property(name="SimpleName83", type=DOM_MethodRefParameter, multiplicity=Multiplicity(1, 1)),
...
type84: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="DOM_MethodRefParameter85", type=Type, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
comments57: BinaryAssociation = BinaryAssociation(
    name="comments57",
    ends={
...
package58: BinaryAssociation = BinaryAssociation(
    name="package58",
    ends={
        Property(name="PackageDeclaration", type=DOM_CompilationUnit, multiplicity=Multiplicity(1, 1)),
        Property(name="DOM_CompilationUnit59", type=PackageDeclaration, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
imports60: BinaryAssociation = BinaryAssociation(
    name="imports60",
    ends={
        Property(name="ImportDeclaration", type=DOM_CompilationUnit, multiplicity=Multiplicity(1, 1)),
        Property(name="DOM_CompilationUnit61", type=ImportDeclaration, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
types62: BinaryAssociation = BinaryAssociation(
    name="types62",
    ends={
        Property(name="AbstractTypeDeclaration", type=DOM_CompilationUnit, multiplicity=Multiplicity(1, 1)),
        Property(name="DOM_CompilationUnit63", type=AbstractTypeDeclaration, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
typeBinding64: BinaryAssociation = BinaryAssociation(
    name="typeBinding64",
    ends={
        Property(name="IType65", type=DOM_Expression, multiplicity=Multiplicity(1, 1)),
...
qualifier68: BinaryAssociation = BinaryAssociation(
    name="qualifier68",
    ends={
        Property(name="Name70", type=DOM_MemberRef, multiplicity=Multiplicity(1, 1)),
        Property(name="DOM_MemberRef69", type=Name, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
name71: BinaryAssociation = BinaryAssociation(
    name="name71",
    ends={
        Property(name="SimpleName72", type=DOM_MemberValuePair, multiplicity=Multiplicity(1, 1)),
...
value73: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="DOM_MemberValuePair74", type=Expression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
name75: BinaryAssociation = BinaryAssociation(
    name="name75",
    ends={
        Property(name="SimpleName76", type=DOM_MethodRef, multiplicity=Multiplicity(1, 1)),
        Property(name="DOM_MethodRef", type=SimpleName, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
binding93: BinaryAssociation = BinaryAssociation(
    name="binding93",
    ends={
        Property(name="IPackageFragment95", type=DOM_PackageDeclaration, multiplicity=Multiplicity(1, 1)),
        Property(name="DOM_PackageDeclaration94", type=IPackageFragment, multiplicity=Multiplicity(1, 1))
    }
)
...
javadoc87: BinaryAssociation = BinaryAssociation(
    name="javadoc87",
    ends={
        Property(name="Javadoc89", type=DOM_PackageDeclaration, multiplicity=Multiplicity(1, 1)),
        Property(name="DOM_PackageDeclaration88", type=Javadoc, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
name90: BinaryAssociation = BinaryAssociation(
    name="name90",
    ends={
        Property(name="Name92", type=DOM_PackageDeclaration, multiplicity=Multiplicity(1, 1)),
        Property(name="DOM_PackageDeclaration91", type=Name, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
...
finally_361: BinaryAssociation = BinaryAssociation(
    name="finally_361",
    ends={
...
allType434: BinaryAssociation = BinaryAssociation(
    name="allType434",
    ends={
        Property(name="Core_IType435", type=PrimitiveTypes_Core_ICompilationUnit, multiplicity=Multiplicity(1, 1)),
        Property(name="PrimitiveTypes_Core_ICompilationUnit", type=Core_IType, multiplicity=Multiplicity(0, 9999))
    }
)
imports436: BinaryAssociation = BinaryAssociation(
    name="imports436",
    ends={
        Property(name="Core_IImportDeclaration", type=PrimitiveTypes_Core_ICompilationUnit, multiplicity=Multiplicity(1, 1)),
        Property(name="PrimitiveTypes_Core_ICompilationUnit437", type=Core_IImportDeclaration, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
types438: BinaryAssociation = BinaryAssociation(
    name="types438",
    ends={
        Property(name="Core_IType440", type=PrimitiveTypes_Core_ICompilationUnit, multiplicity=Multiplicity(1, 1)),
        Property(name="PrimitiveTypes_Core_ICompilationUnit439", type=Core_IType, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
primary441: BinaryAssociation = BinaryAssociation(
    name="primary441",
    ends={
        Property(name="Core_ICompilationUnit443", type=PrimitiveTypes_Core_ICompilationUnit, multiplicity=Multiplicity(1, 1)),
        Property(name="PrimitiveTypes_Core_ICompilationUnit442", type=Core_ICompilationUnit, multiplicity=Multiplicity(1, 1))
    }
)
ast444: BinaryAssociation = BinaryAssociation(
    name="ast444",
    ends={
        Property(name="CompilationUnit446", type=PrimitiveTypes_Core_ICompilationUnit, multiplicity=Multiplicity(1, 1)),
        Property(name="PrimitiveTypes_Core_ICompilationUnit445", type=CompilationUnit, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
type447: BinaryAssociation = BinaryAssociation(
    name="type447",
    ends={
        Property(name="Core_IType448", type=PrimitiveTypes_Core_IClassFile, multiplicity=Multiplicity(1, 1)),
        Property(name="PrimitiveTypes_Core_IClassFile", type=Core_IType, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
sourceRange449: BinaryAssociation = BinaryAssociation(
    name="sourceRange449",
    ends={
...
packageFragments423: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="IPackageFragment425", type=PrimitiveTypes_Core_IPackageFragmentRoot, multiplicity=Multiplicity(1, 1)),
        Property(name="packageFragmentRoot424", type=Core_IPackageFragment, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
packageFragmentRoot426: BinaryAssociation = BinaryAssociation(
    name="packageFragmentRoot426",
    ends={
        Property(name="IPackageFragmentRoot428", type=PrimitiveTypes_Core_IPackageFragment, multiplicity=Multiplicity(1, 1)),
        Property(name="packageFragments427", type=Core_IPackageFragmentRoot, multiplicity=Multiplicity(1, 1))
    }
)
classFiles429: BinaryAssociation = BinaryAssociation(
    name="classFiles429",
    ends={
        Property(name="Core_IClassFile430", type=PrimitiveTypes_Core_IPackageFragment, multiplicity=Multiplicity(1, 1)),
...
compilationUnits431: BinaryAssociation = BinaryAssociation(
    name="compilationUnits431",
    ends={
        Property(name="Core_ICompilationUnit433", type=PrimitiveTypes_Core_IPackageFragment, multiplicity=Multiplicity(1, 1)),
        Property(name="PrimitiveTypes_Core_IPackageFragment432", type=Core_ICompilationUnit, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
methods458: BinaryAssociation = BinaryAssociation(
    name="methods458",
    ends={
        Property(name="Core_IMethod460", type=PrimitiveTypes_Core_IType, multiplicity=Multiplicity(1, 1)),
        Property(name="PrimitiveTypes_Core_IType459", type=Core_IMethod, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
types461: BinaryAssociation = BinaryAssociation(
    name="types461",
    ends={
        Property(name="Core_IType463", type=PrimitiveTypes_Core_IType, multiplicity=Multiplicity(1, 1)),
        Property(name="PrimitiveTypes_Core_IType462", type=Core_IType, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
typeParameters464: BinaryAssociation = BinaryAssociation(
    name="typeParameters464",
    ends={
        Property(name="Core_ITypeParameter", type=PrimitiveTypes_Core_IType, multiplicity=Multiplicity(1, 1)),
        Property(name="PrimitiveTypes_Core_IType465", type=Core_ITypeParameter, multiplicity=Multiplicity(0, 9999))
    }
)
parameters466: BinaryAssociation = BinaryAssociation(
    name="parameters466",
    ends={
...
javadocRange450: BinaryAssociation = BinaryAssociation(
    name="javadocRange450",
    ends={
        Property(name="Core_ISourceRange451", type=PrimitiveTypes_Core_IMember, multiplicity=Multiplicity(1, 1)),
        Property(name="PrimitiveTypes_Core_IMember", type=Core_ISourceRange, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
nameRange452: BinaryAssociation = BinaryAssociation(
    name="nameRange452",
    ends={
        Property(name="Core_ISourceRange454", type=PrimitiveTypes_Core_IMember, multiplicity=Multiplicity(1, 1)),
        Property(name="PrimitiveTypes_Core_IMember453", type=Core_ISourceRange, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
initializers455: BinaryAssociation = BinaryAssociation(
    name="initializers455",
    ends={
...
fields456: BinaryAssociation = BinaryAssociation(
    name="fields456",
    ends={
        Property(name="Core_IField", type=PrimitiveTypes_Core_IType, multiplicity=Multiplicity(1, 1)),
        Property(name="PrimitiveTypes_Core_IType457", type=Core_IField, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={Core_ITypeRoot, ISourceReference, Core_ICompilationUnit, ITypeRoot, IType, IImportDeclaration, Core_IJavaElement, Core_PhysicalElement, Core_IJavaModel, PhysicalElement, IJavaProject, IPackageFragmentRoot, Core_IJavaProject, IJavaElement, Core_IPackageFragmentRoot, IPackageFragment, Core_BinaryPackageFragmentRoot, Core_SourcePackageFragmentRoot, Core_IPackageFragment, IClassFile, ICompilationUnit, ITypeParameter, Core_ITypeParameter, Core_IInitializer, Core_IField, CompilationUnit, Core_IClassFile, Core_ISourceReference, ISourceRange, Core_IImportDeclaration, Core_ISourceRange, Core_IMember, Core_IType, IMember, IInitializer, IField, IMethod, ExtendedModifier, Javadoc, DOM_CatchClause, Block, SingleVariableDeclaration, DOM_Comment, Core_IMethod, Parameter_, Core_Parameter, DOM_AST, ASTNode, DOM_ASTNode, DOM_AnonymousClassDeclaration, BodyDeclaration, DOM_BodyDeclaration, MethodRefParameter, DOM_MethodRefParameter, Type, DOM_ExtendedModifier, DOM_CompilationUnit, Comment, PackageDeclaration, ImportDeclaration, AbstractTypeDeclaration, DOM_Expression, DOM_ImportDeclaration, Name, DOM_MemberRef, SimpleName, DOM_MemberValuePair, Expression, DOM_MethodRef, DOM_Statement, DOM_TagElement, DOM_Modifier, DOM_PackageDeclaration, Annotation, DOM_EnumConstantDeclaration, AnonymousClassDeclaration, DOM_FieldDeclaration, DOM_TextElement, DOM_Type, DOM_TypeParameter, DOM_VariableDeclaration, DOM_AbstractTypeDeclaration, DOM_AnnotationTypeMemberDeclaration, EnumConstantDeclaration, DOM_TypeDeclaration, DOM_BlockComment, DOM_Javadoc, VariableDeclarationFragment, DOM_Initializer, DOM_MethodDeclaration, TypeParameter, DOM_AnnotationTypeDeclaration, DOM_EnumDeclaration, DOM_BooleanLiteral, TagElement, DOM_LineComment, DOM_Annotation, DOM_ArrayAccess, DOM_ArrayCreation, ArrayInitializer, ArrayType, DOM_ArrayInitializer, DOM_Assignment, DOM_FieldAccess, DOM_CastExpression, DOM_CharacterLiteral, DOM_ClassInstanceCreation, DOM_ConditionalExpression, DOM_InstanceofExpression, DOM_InfixExpression, DOM_MethodInvocation, DOM_NullLiteral, DOM_NumberLiteral, DOM_ParenthesizedExpression, DOM_PostfixExpression, DOM_PrefixExpression, DOM_Name, DOM_SuperMethodInvocation, DOM_ThisExpression, DOM_TypeLiteral, DOM_VariableDeclarationExpression, DOM_StringLiteral, DOM_SuperFieldAccess, DOM_Block, DOM_BreakStatement, DOM_ConstructorInvocation, DOM_ContinueStatement, DOM_DoStatement, DOM_AssertStatement, Statement, DOM_ForStatement, DOM_IfStatement, DOM_EmptyStatement, DOM_EnhancedForStatement, DOM_ExpressionStatement, DOM_SuperConstructorInvocation, DOM_SwitchCase, DOM_SwitchStatement, DOM_LabeledStatement, DOM_ReturnStatement, CatchClause, DOM_TypeDeclarationStatement, DOM_VariableDeclarationStatement, DOM_WhileStatement, DOM_SynchronizedStatement, DOM_ThrowStatement, DOM_TryStatement, DOM_PrimitiveType, DOM_QualifiedType, DOM_SimpleType, DOM_WildcardType, DOM_SingleVariableDeclaration, VariableDeclaration, DOM_VariableDeclarationFragment, DOM_ArrayType, DOM_ParameterizedType, DOM_SingleMemberAnnotation, PrimitiveTypes_Core_IJavaElement, PrimitiveTypes_Core_PhysicalElement, PrimitiveTypes_Core_IJavaModel, PrimitiveTypes_Core_IJavaProject, PrimitiveTypes_Core_IPackageFragmentRoot, DOM_QualifiedName, DOM_SimpleName, DOM_MarkerAnnotation, DOM_NormalAnnotation, MemberValuePair, PrimitiveTypes_Core_IClassFile, PrimitiveTypes_Core_ISourceReference, PrimitiveTypes_Core_IImportDeclaration, PrimitiveTypes_Core_ISourceRange, PrimitiveTypes_Core_BinaryPackageFragmentRoot, PrimitiveTypes_Core_SourcePackageFragmentRoot, PrimitiveTypes_Core_IPackageFragment, PrimitiveTypes_Core_ITypeRoot, PrimitiveTypes_Core_ICompilationUnit, PrimitiveTypes_Core_ITypeParameter, PrimitiveTypes_Core_IInitializer, PrimitiveTypes_Core_IField, PrimitiveTypes_Core_IMethod, PrimitiveTypes_Core_Parameter, PrimitiveTypes_Core_IMember, PrimitiveTypes_Core_IType, AssignmentOperatorKind, InfixExpressionOperatorKind, PostfixExpressionOperatorKind, PrefixExpressionOperatorKind, Modifiers},
    associations={compilationUnits15, allType17, imports18, types20, primary23, javaProjects0, externalPackageFragmentRoots1, packageFragmentRoots3, externalPackageFragmentRoots5, requiredProjects8, packageFragments11, packageFragmentRoot12, classFiles14, methods39, types41, typeParameters44, ast26, type28, sourceRange30, javadocRange31, nameRange33, initializers36, fields37, modifiers49, javadoc50, body52, exception53, alternateRoot55, parameters46, compilationUnits47, bodyDeclarations48, qualifier77, parameters80, name82, type84, comments57, package58, imports60, types62, typeBinding64, name66, name67, qualifier68, name71, value73, name75, binding93, fragments96, annotations86, javadoc87, name90, name115, type118, arguments121, anonymousClassDeclaration123, name125, name98, typeBounds100, initializer103, name105, bodyDeclarations108, name110, default113, enumConstants155, superclassType157, superInterfaceTypes159, typeParameters162, fragments128, type129, body132, body134, name136, returnType139, parameters142, thrownExceptions145, typeParameters148, binding150, superInterfaceTypes153, tags165, typeName166, array168, index170, dimensions173, initializer175, type177, expressions179, leftHandSide181, rightHandSide183, thenExpression210, expression213, name215, expression186, type188, arguments191, anonymousClassDeclaration193, expression196, type199, typeArguments202, elseExpression205, expression207, leftOperand226, extendedOperands218, rightOperand228, arguments231, leftOperand220, expression233, rightOperand223, expression245, operand247, operand249, name236, typeArguments239, methodBinding242, qualifier253, arguments256, name258, qualifier261, typeArguments264, qualifier267, type269, name251, message281, statements284, label285, arguments287, typeArguments289, label292, body294, expression296, fragments271, modifiers273, type276, expression279, body309, expression311, initializers314, updaters317, elseStatement320, expression322, body299, expression301, parameter304, expression307, arguments335, expression337, typeArguments340, expression343, expression345, statements347, thenStatement325, body328, label330, expression333, catchClauses357, body358, finally_361, declaration364, fragments366, modifiers368, type371, body374, expression376, body350, expression352, expression355, name389, qualifier391, name394, bound396, type398, modifiers400, componentType379, elementType381, type384, typeArguments386, value409, javaProjects411, externalPackageFragmentRoots413, packageFragmentRoots415, externalPackageFragmentRoots417, requiredProjects420, name403, qualifier405, values408, allType434, imports436, types438, primary441, ast444, type447, sourceRange449, packageFragments423, packageFragmentRoot426, classFiles429, compilationUnits431, methods458, types461, typeParameters464, parameters466, javadocRange450, nameRange452, initializers455, fields456},
    generalizations={gen_Core_ITypeRoot_IJavaElement, gen_Core_ITypeRoot_ISourceReference, gen_Core_ITypeRoot_PhysicalElement, gen_Core_ICompilationUnit_ITypeRoot, gen_Core_IJavaModel_PhysicalElement, gen_Core_IJavaProject_IJavaElement, gen_Core_IJavaProject_PhysicalElement, gen_Core_IPackageFragmentRoot_IJavaElement, gen_Core_IPackageFragmentRoot_PhysicalElement, gen_Core_BinaryPackageFragmentRoot_IPackageFragmentRoot, gen_Core_SourcePackageFragmentRoot_IPackageFragmentRoot, gen_Core_IPackageFragment_IJavaElement, gen_Core_IPackageFragment_PhysicalElement, gen_Core_ITypeParameter_IJavaElement, gen_Core_ITypeParameter_ISourceReference, gen_Core_IInitializer_IMember, gen_Core_IField_IMember, gen_Core_IClassFile_ITypeRoot, gen_Core_IImportDeclaration_IJavaElement, gen_Core_IImportDeclaration_ISourceReference, gen_Core_IMember_IJavaElement, gen_Core_IMember_ISourceReference, gen_Core_IType_IMember, gen_DOM_CatchClause_ASTNode, gen_DOM_Comment_ASTNode, gen_Core_IMethod_IMember, gen_DOM_AnonymousClassDeclaration_ASTNode, gen_DOM_BodyDeclaration_ASTNode, gen_DOM_MethodRefParameter_ASTNode, gen_DOM_CompilationUnit_ASTNode, gen_DOM_Expression_ASTNode, gen_DOM_ImportDeclaration_ASTNode, gen_DOM_MemberRef_ASTNode, gen_DOM_MemberValuePair_ASTNode, gen_DOM_MethodRef_ASTNode, gen_DOM_Statement_ASTNode, gen_DOM_TagElement_ASTNode, gen_DOM_Modifier_ASTNode, gen_DOM_Modifier_ExtendedModifier, gen_DOM_PackageDeclaration_ASTNode, gen_DOM_EnumConstantDeclaration_BodyDeclaration, gen_DOM_FieldDeclaration_BodyDeclaration, gen_DOM_TextElement_ASTNode, gen_DOM_Type_ASTNode, gen_DOM_TypeParameter_ASTNode, gen_DOM_VariableDeclaration_ASTNode, gen_DOM_AbstractTypeDeclaration_BodyDeclaration, gen_DOM_AnnotationTypeMemberDeclaration_BodyDeclaration, gen_DOM_TypeDeclaration_AbstractTypeDeclaration, gen_DOM_BlockComment_Comment, gen_DOM_Javadoc_Comment, gen_DOM_Initializer_BodyDeclaration, gen_DOM_MethodDeclaration_BodyDeclaration, gen_DOM_AnnotationTypeDeclaration_AbstractTypeDeclaration, gen_DOM_EnumDeclaration_AbstractTypeDeclaration, gen_DOM_BooleanLiteral_Expression, gen_DOM_LineComment_Comment, gen_DOM_Annotation_Expression, gen_DOM_Annotation_ExtendedModifier, gen_DOM_ArrayAccess_Expression, gen_DOM_ArrayCreation_Expression, gen_DOM_ArrayInitializer_Expression, gen_DOM_Assignment_Expression, gen_DOM_FieldAccess_Expression, gen_DOM_CastExpression_Expression, gen_DOM_CharacterLiteral_Expression, gen_DOM_ClassInstanceCreation_Expression, gen_DOM_ConditionalExpression_Expression, gen_DOM_InstanceofExpression_Expression, gen_DOM_InfixExpression_Expression, gen_DOM_MethodInvocation_Expression, gen_DOM_NullLiteral_Expression, gen_DOM_NumberLiteral_Expression, gen_DOM_ParenthesizedExpression_Expression, gen_DOM_PostfixExpression_Expression, gen_DOM_PrefixExpression_Expression, gen_DOM_Name_Expression, gen_DOM_SuperMethodInvocation_Expression, gen_DOM_ThisExpression_Expression, gen_DOM_TypeLiteral_Expression, gen_DOM_VariableDeclarationExpression_Expression, gen_DOM_StringLiteral_Expression, gen_DOM_SuperFieldAccess_Expression, gen_DOM_Block_Statement, gen_DOM_BreakStatement_Statement, gen_DOM_ConstructorInvocation_Statement, gen_DOM_ContinueStatement_Statement, gen_DOM_DoStatement_Statement, gen_DOM_AssertStatement_Statement, gen_DOM_ForStatement_Statement, gen_DOM_IfStatement_Statement, gen_DOM_EmptyStatement_Statement, gen_DOM_EnhancedForStatement_Statement, gen_DOM_ExpressionStatement_Statement, gen_DOM_SuperConstructorInvocation_Statement, gen_DOM_SwitchCase_Statement, gen_DOM_SwitchStatement_Statement, gen_DOM_LabeledStatement_Statement, gen_DOM_ReturnStatement_Statement, gen_DOM_TypeDeclarationStatement_Statement, gen_DOM_VariableDeclarationStatement_Statement, gen_DOM_WhileStatement_Statement, gen_DOM_SynchronizedStatement_Statement, gen_DOM_ThrowStatement_Statement, gen_DOM_TryStatement_Statement, gen_DOM_PrimitiveType_Type, gen_DOM_QualifiedType_Type, gen_DOM_SimpleType_Type, gen_DOM_WildcardType_Type, gen_DOM_SingleVariableDeclaration_VariableDeclaration, gen_DOM_ArrayType_Type, gen_DOM_ParameterizedType_Type, gen_DOM_SingleMemberAnnotation_Annotation, gen_PrimitiveTypes_Core_IJavaModel_PhysicalElement, gen_PrimitiveTypes_Core_IJavaProject_Core_IJavaElement, gen_PrimitiveTypes_Core_IJavaProject_Core_PhysicalElement, gen_PrimitiveTypes_Core_IPackageFragmentRoot_Core_IJavaElement, gen_PrimitiveTypes_Core_IPackageFragmentRoot_Core_PhysicalElement, gen_DOM_VariableDeclarationFragment_VariableDeclaration, gen_DOM_QualifiedName_Name, gen_DOM_SimpleName_Name, gen_DOM_MarkerAnnotation_Annotation, gen_DOM_NormalAnnotation_Annotation, gen_PrimitiveTypes_Core_ICompilationUnit_ITypeRoot, gen_PrimitiveTypes_Core_IClassFile_ITypeRoot, gen_PrimitiveTypes_Core_IImportDeclaration_Core_IJavaElement, gen_PrimitiveTypes_Core_IImportDeclaration_Core_ISourceReference, gen_PrimitiveTypes_Core_BinaryPackageFragmentRoot_IPackageFragmentRoot, gen_PrimitiveTypes_Core_SourcePackageFragmentRoot_IPackageFragmentRoot, gen_PrimitiveTypes_Core_IPackageFragment_Core_IJavaElement, gen_PrimitiveTypes_Core_IPackageFragment_Core_PhysicalElement, gen_PrimitiveTypes_Core_ITypeRoot_Core_IJavaElement, gen_PrimitiveTypes_Core_ITypeRoot_Core_ISourceReference, gen_PrimitiveTypes_Core_ITypeRoot_Core_PhysicalElement, gen_PrimitiveTypes_Core_ITypeParameter_Core_IJavaElement, gen_PrimitiveTypes_Core_ITypeParameter_Core_ISourceReference, gen_PrimitiveTypes_Core_IInitializer_IMember, gen_PrimitiveTypes_Core_IField_IMember, gen_PrimitiveTypes_Core_IMethod_IMember, gen_PrimitiveTypes_Core_IMember_Core_IJavaElement, gen_PrimitiveTypes_Core_IMember_Core_ISourceReference, gen_PrimitiveTypes_Core_IType_IMember},
    metadata=None
)
