...
def test_PrimitiveTypes_Core_IClassFile_isClass_value_roundtrip():
    instance = PrimitiveTypes_Core_IClassFile(isClass="sample_text", isInterface="sample_text")
    assert instance.isClass == "sample_text"
    instance.isClass = "sample_text_2"
    assert instance.isClass == "sample_text_2"


def test_PrimitiveTypes_Core_IClassFile_isInterface_value_roundtrip():
    instance = PrimitiveTypes_Core_IClassFile(isClass="sample_text", isInterface="sample_text")
    assert instance.isInterface == "sample_text"
    instance.isInterface = "sample_text_2"
    assert instance.isInterface == "sample_text_2"
...
def test_PrimitiveTypes_Core_IField_constant_value_roundtrip():
    instance = PrimitiveTypes_Core_IField(constant="sample_text", isEnumConstant="sample_text", isTransient="sample_text", isVolatile="sample_text", typeSignature="sample_text")
    assert instance.constant == "sample_text"
    instance.constant = "sample_text_2"
    assert instance.constant == "sample_text_2"


def test_PrimitiveTypes_Core_IField_isEnumConstant_value_roundtrip():
    instance = PrimitiveTypes_Core_IField(constant="sample_text", isEnumConstant="sample_text", isTransient="sample_text", isVolatile="sample_text", typeSignature="sample_text")
    assert instance.isEnumConstant == "sample_text"
    instance.isEnumConstant = "sample_text_2"
    assert instance.isEnumConstant == "sample_text_2"
...
def test_PrimitiveTypes_Core_IField_isTransient_value_roundtrip():
    instance = PrimitiveTypes_Core_IField(constant="sample_text", isEnumConstant="sample_text", isTransient="sample_text", isVolatile="sample_text", typeSignature="sample_text")
    assert instance.isTransient == "sample_text"
    instance.isTransient = "sample_text_2"
    assert instance.isTransient == "sample_text_2"
...
def test_PrimitiveTypes_Core_IField_isVolatile_value_roundtrip():
    instance = PrimitiveTypes_Core_IField(constant="sample_text", isEnumConstant="sample_text", isTransient="sample_text", isVolatile="sample_text", typeSignature="sample_text")
    assert instance.isVolatile == "sample_text"
    instance.isVolatile = "sample_text_2"
    assert instance.isVolatile == "sample_text_2"
...
def test_PrimitiveTypes_Core_IField_typeSignature_value_roundtrip():
    instance = PrimitiveTypes_Core_IField(constant="sample_text", isEnumConstant="sample_text", isTransient="sample_text", isVolatile="sample_text", typeSignature="sample_text")
    assert instance.typeSignature == "sample_text"
    instance.typeSignature = "sample_text_2"
    assert instance.typeSignature == "sample_text_2"
...
def test_PrimitiveTypes_Core_IJavaElement_elementName_value_roundtrip():
    instance = PrimitiveTypes_Core_IJavaElement(elementName="sample_text")
    assert instance.elementName == "sample_text"
    instance.elementName = "sample_text_2"
    assert instance.elementName == "sample_text_2"


def test_PrimitiveTypes_Core_IMethod_exceptionTypes_value_roundtrip():
    instance = PrimitiveTypes_Core_IMethod(exceptionTypes="sample_text", isConstructor="sample_text", isMainMethod="sample_text", returnType="sample_text")
    assert instance.exceptionTypes == "sample_text"
    instance.exceptionTypes = "sample_text_2"
    assert instance.exceptionTypes == "sample_text_2"


def test_PrimitiveTypes_Core_IMethod_isConstructor_value_roundtrip():
    instance = PrimitiveTypes_Core_IMethod(exceptionTypes="sample_text", isConstructor="sample_text", isMainMethod="sample_text", returnType="sample_text")
    assert instance.isConstructor == "sample_text"
    instance.isConstructor = "sample_text_2"
    assert instance.isConstructor == "sample_text_2"
...
def test_PrimitiveTypes_Core_IMethod_isMainMethod_value_roundtrip():
    instance = PrimitiveTypes_Core_IMethod(exceptionTypes="sample_text", isConstructor="sample_text", isMainMethod="sample_text", returnType="sample_text")
    assert instance.isMainMethod == "sample_text"
    instance.isMainMethod = "sample_text_2"
    assert instance.isMainMethod == "sample_text_2"
...
def test_PrimitiveTypes_Core_IMethod_returnType_value_roundtrip():
    instance = PrimitiveTypes_Core_IMethod(exceptionTypes="sample_text", isConstructor="sample_text", isMainMethod="sample_text", returnType="sample_text")
    assert instance.returnType == "sample_text"
    instance.returnType = "sample_text_2"
    assert instance.returnType == "sample_text_2"
...
def test_PrimitiveTypes_Core_ISourceRange_length_value_roundtrip():
    instance = PrimitiveTypes_Core_ISourceRange(length="sample_text", offset="sample_text")
    assert instance.length == "sample_text"
    instance.length = "sample_text_2"
    assert instance.length == "sample_text_2"


def test_PrimitiveTypes_Core_ISourceRange_offset_value_roundtrip():
    instance = PrimitiveTypes_Core_ISourceRange(length="sample_text", offset="sample_text")
    assert instance.offset == "sample_text"
    instance.offset = "sample_text_2"
    assert instance.offset == "sample_text_2"
...
def test_PrimitiveTypes_Core_ISourceReference_source_value_roundtrip():
    instance = PrimitiveTypes_Core_ISourceReference(source="sample_text")
    assert instance.source == "sample_text"
    instance.source = "sample_text_2"
    assert instance.source == "sample_text_2"


def test_PrimitiveTypes_Core_IType_fullyQualifiedName_value_roundtrip():
    instance = PrimitiveTypes_Core_IType(fullyQualifiedName="sample_text", fullyQualifiedParametrizedName="sample_text")
    assert instance.fullyQualifiedName == "sample_text"
    instance.fullyQualifiedName = "sample_text_2"
    assert instance.fullyQualifiedName == "sample_text_2"


def test_PrimitiveTypes_Core_IType_fullyQualifiedParametrizedName_value_roundtrip():
    instance = PrimitiveTypes_Core_IType(fullyQualifiedName="sample_text", fullyQualifiedParametrizedName="sample_text")
    assert instance.fullyQualifiedParametrizedName == "sample_text"
    instance.fullyQualifiedParametrizedName = "sample_text_2"
    assert instance.fullyQualifiedParametrizedName == "sample_text_2"
...
def test_PrimitiveTypes_Core_Parameter_name_value_roundtrip():
    instance = PrimitiveTypes_Core_Parameter(name="sample_text", type="sample_text")
    assert instance.name == "sample_text"
    instance.name = "sample_text_2"
    assert instance.name == "sample_text_2"


def test_PrimitiveTypes_Core_Parameter_type_value_roundtrip():
    instance = PrimitiveTypes_Core_Parameter(name="sample_text", type="sample_text")
    assert instance.type == "sample_text"
    instance.type = "sample_text_2"
    assert instance.type == "sample_text_2"
...
def test_PrimitiveTypes_Core_PhysicalElement_isReadOnly_value_roundtrip():
    instance = PrimitiveTypes_Core_PhysicalElement(isReadOnly="sample_text", path="sample_text")
    assert instance.isReadOnly == "sample_text"
    instance.isReadOnly = "sample_text_2"
    assert instance.isReadOnly == "sample_text_2"


def test_PrimitiveTypes_Core_PhysicalElement_path_value_roundtrip():
    instance = PrimitiveTypes_Core_PhysicalElement(isReadOnly="sample_text", path="sample_text")
    assert instance.path == "sample_text"
    instance.path = "sample_text_2"
    assert instance.path == "sample_text_2"
...
def test_PrimitiveTypes_Core_IField_isa_IMember():
    instance = PrimitiveTypes_Core_IField(constant="sample_text", isEnumConstant="sample_text", isTransient="sample_text", isVolatile="sample_text", typeSignature="sample_text")
    assert isinstance(instance, IMember)


def test_PrimitiveTypes_Core_IInitializer_isa_IMember():
    instance = PrimitiveTypes_Core_IInitializer()
    assert isinstance(instance, IMember)


def test_PrimitiveTypes_Core_IMethod_isa_IMember():
    instance = PrimitiveTypes_Core_IMethod(exceptionTypes="sample_text", isConstructor="sample_text", isMainMethod="sample_text", returnType="sample_text")
    assert isinstance(instance, IMember)


def test_PrimitiveTypes_Core_IType_isa_IMember():
    instance = PrimitiveTypes_Core_IType(fullyQualifiedName="sample_text", fullyQualifiedParametrizedName="sample_text")
    assert isinstance(instance, IMember)
...
def test_PrimitiveTypes_Core_BinaryPackageFragmentRoot_isa_IPackageFragmentRoot():
    instance = PrimitiveTypes_Core_BinaryPackageFragmentRoot()
    assert isinstance(instance, IPackageFragmentRoot)


def test_PrimitiveTypes_Core_SourcePackageFragmentRoot_isa_IPackageFragmentRoot():
    instance = PrimitiveTypes_Core_SourcePackageFragmentRoot()
    assert isinstance(instance, IPackageFragmentRoot)
...
def test_PrimitiveTypes_Core_IClassFile_isa_ITypeRoot():
    instance = PrimitiveTypes_Core_IClassFile(isClass="sample_text", isInterface="sample_text")
    assert isinstance(instance, ITypeRoot)


def test_PrimitiveTypes_Core_ICompilationUnit_isa_ITypeRoot():
    instance = PrimitiveTypes_Core_ICompilationUnit()
    assert isinstance(instance, ITypeRoot)
...
def test_PrimitiveTypes_Core_IJavaModel_isa_PhysicalElement():
    instance = PrimitiveTypes_Core_IJavaModel()
    assert isinstance(instance, PhysicalElement)
...
def test_assoc_allType434_link_reassign_clear():
    a = Core_IType(fullyQualifiedName="sample_text", fullyQualifiedParametrizedName="sample_text")
    b1 = PrimitiveTypes_Core_ICompilationUnit()
    b2 = PrimitiveTypes_Core_ICompilationUnit()
    _safe_set(a, 'Core_IType435', b1)
    assert _is_linked(a, 'Core_IType435', b1)
    if hasattr(b1, 'PrimitiveTypes_Core_ICompilationUnit'):
        assert _is_linked(b1, 'PrimitiveTypes_Core_ICompilationUnit', a)
    _safe_set(a, 'Core_IType435', b2)
    assert _is_linked(a, 'Core_IType435', b2)
    if hasattr(b1, 'PrimitiveTypes_Core_ICompilationUnit'):
        assert not _is_linked(b1, 'PrimitiveTypes_Core_ICompilationUnit', a)
    if hasattr(b2, 'PrimitiveTypes_Core_ICompilationUnit'):
        assert _is_linked(b2, 'PrimitiveTypes_Core_ICompilationUnit', a)
    _safe_set(a, 'Core_IType435', None)
    assert not _is_linked(a, 'Core_IType435', b2)
    if hasattr(b2, 'PrimitiveTypes_Core_ICompilationUnit'):
        assert not _is_linked(b2, 'PrimitiveTypes_Core_ICompilationUnit', a)
...
def test_assoc_fields456_link_reassign_clear():
    a = PrimitiveTypes_Core_IType(fullyQualifiedName="sample_text", fullyQualifiedParametrizedName="sample_text")
    ...
    _safe_set(a, 'PrimitiveTypes_Core_IType457', {b1})
    assert _is_linked(a, 'PrimitiveTypes_Core_IType457', b1)
    if hasattr(b1, 'Core_IField'):
        assert _is_linked(b1, 'Core_IField', a)
    _safe_set(a, 'PrimitiveTypes_Core_IType457', {b2})
    assert _is_linked(a, 'PrimitiveTypes_Core_IType457', b2)
    if hasattr(b1, 'Core_IField'):
        assert not _is_linked(b1, 'Core_IField', a)
    if hasattr(b2, 'Core_IField'):
        assert _is_linked(b2, 'Core_IField', a)
    _safe_set(a, 'PrimitiveTypes_Core_IType457', set())
    assert not _is_linked(a, 'PrimitiveTypes_Core_IType457', b2)
    if hasattr(b2, 'Core_IField'):
...
def test_assoc_imports436_link_reassign_clear():
    ...
    if hasattr(b1, 'PrimitiveTypes_Core_ICompilationUnit437'):
        assert _is_linked(b1, 'PrimitiveTypes_Core_ICompilationUnit437', a)
    _safe_set(a, 'Core_IImportDeclaration', b2)
    assert _is_linked(a, 'Core_IImportDeclaration', b2)
    if hasattr(b1, 'PrimitiveTypes_Core_ICompilationUnit437'):
        assert not _is_linked(b1, 'PrimitiveTypes_Core_ICompilationUnit437', a)
    if hasattr(b2, 'PrimitiveTypes_Core_ICompilationUnit437'):
        assert _is_linked(b2, 'PrimitiveTypes_Core_ICompilationUnit437', a)
    _safe_set(a, 'Core_IImportDeclaration', None)
    assert not _is_linked(a, 'Core_IImportDeclaration', b2)
    if hasattr(b2, 'PrimitiveTypes_Core_ICompilationUnit437'):
        assert not _is_linked(b2, 'PrimitiveTypes_Core_ICompilationUnit437', a)
...
def test_assoc_initializers455_link_reassign_clear():
    a = PrimitiveTypes_Core_IType(fullyQualifiedName="sample_text", fullyQualifiedParametrizedName="sample_text")
    b1 = Core_IInitializer()
    b2 = Core_IInitializer()
    _safe_set(a, 'PrimitiveTypes_Core_IType', {b1})
    assert _is_linked(a, 'PrimitiveTypes_Core_IType', b1)
    if hasattr(b1, 'Core_IInitializer'):
        assert _is_linked(b1, 'Core_IInitializer', a)
    _safe_set(a, 'PrimitiveTypes_Core_IType', {b2})
    assert _is_linked(a, 'PrimitiveTypes_Core_IType', b2)
    if hasattr(b1, 'Core_IInitializer'):
        assert not _is_linked(b1, 'Core_IInitializer', a)
    if hasattr(b2, 'Core_IInitializer'):
        assert _is_linked(b2, 'Core_IInitializer', a)
    _safe_set(a, 'PrimitiveTypes_Core_IType', set())
    assert not _is_linked(a, 'PrimitiveTypes_Core_IType', b2)
    if hasattr(b2, 'Core_IInitializer'):
...
def test_assoc_methods458_link_reassign_clear():
    a = PrimitiveTypes_Core_IType(fullyQualifiedName="sample_text", fullyQualifiedParametrizedName="sample_text")
    ...
    _safe_set(a, 'PrimitiveTypes_Core_IType459', {b1})
    assert _is_linked(a, 'PrimitiveTypes_Core_IType459', b1)
    if hasattr(b1, 'Core_IMethod460'):
        assert _is_linked(b1, 'Core_IMethod460', a)
    _safe_set(a, 'PrimitiveTypes_Core_IType459', {b2})
    assert _is_linked(a, 'PrimitiveTypes_Core_IType459', b2)
    if hasattr(b1, 'Core_IMethod460'):
        assert not _is_linked(b1, 'Core_IMethod460', a)
    if hasattr(b2, 'Core_IMethod460'):
        assert _is_linked(b2, 'Core_IMethod460', a)
    _safe_set(a, 'PrimitiveTypes_Core_IType459', set())
    assert not _is_linked(a, 'PrimitiveTypes_Core_IType459', b2)
    if hasattr(b2, 'Core_IMethod460'):
        assert not _is_linked(b2, 'Core_IMethod460', a)
...
def test_assoc_parameters466_link_reassign_clear():
    a = PrimitiveTypes_Core_IMethod(exceptionTypes="sample_text", isConstructor="sample_text", isMainMethod="sample_text", returnType="sample_text")
    b1 = Core_Parameter(name="sample_text", type="sample_text")
    b2 = Core_Parameter(name="sample_text_2", type="sample_text_2")
    _safe_set(a, 'PrimitiveTypes_Core_IMethod', {b1})
    assert _is_linked(a, 'PrimitiveTypes_Core_IMethod', b1)
    if hasattr(b1, 'Core_Parameter'):
        assert _is_linked(b1, 'Core_Parameter', a)
    _safe_set(a, 'PrimitiveTypes_Core_IMethod', {b2})
    assert _is_linked(a, 'PrimitiveTypes_Core_IMethod', b2)
    if hasattr(b1, 'Core_Parameter'):
        assert not _is_linked(b1, 'Core_Parameter', a)
    if hasattr(b2, 'Core_Parameter'):
        assert _is_linked(b2, 'Core_Parameter', a)
    _safe_set(a, 'PrimitiveTypes_Core_IMethod', set())
    assert not _is_linked(a, 'PrimitiveTypes_Core_IMethod', b2)
    if hasattr(b2, 'Core_Parameter'):
        assert not _is_linked(b2, 'Core_Parameter', a)
...
def test_assoc_sourceRange449_link_reassign_clear():
    a = PrimitiveTypes_Core_ISourceReference(source="sample_text")
    b1 = Core_ISourceRange(length="sample_text", offset="sample_text")
    b2 = Core_ISourceRange(length="sample_text_2", offset="sample_text_2")
    _safe_set(a, 'PrimitiveTypes_Core_ISourceReference', b1)
    assert _is_linked(a, 'PrimitiveTypes_Core_ISourceReference', b1)
    if hasattr(b1, 'Core_ISourceRange'):
        assert _is_linked(b1, 'Core_ISourceRange', a)
    _safe_set(a, 'PrimitiveTypes_Core_ISourceReference', b2)
    assert _is_linked(a, 'PrimitiveTypes_Core_ISourceReference', b2)
    if hasattr(b1, 'Core_ISourceRange'):
        assert not _is_linked(b1, 'Core_ISourceRange', a)
    if hasattr(b2, 'Core_ISourceRange'):
        assert _is_linked(b2, 'Core_ISourceRange', a)
    _safe_set(a, 'PrimitiveTypes_Core_ISourceReference', None)
    assert not _is_linked(a, 'PrimitiveTypes_Core_ISourceReference', b2)
    if hasattr(b2, 'Core_ISourceRange'):
...
def test_assoc_type447_link_reassign_clear():
    a = PrimitiveTypes_Core_IClassFile(isClass="sample_text", isInterface="sample_text")
    ...
    _safe_set(a, 'PrimitiveTypes_Core_IClassFile', b1)
    assert _is_linked(a, 'PrimitiveTypes_Core_IClassFile', b1)
    if hasattr(b1, 'Core_IType448'):
        assert _is_linked(b1, 'Core_IType448', a)
    _safe_set(a, 'PrimitiveTypes_Core_IClassFile', b2)
    assert _is_linked(a, 'PrimitiveTypes_Core_IClassFile', b2)
    if hasattr(b1, 'Core_IType448'):
        assert not _is_linked(b1, 'Core_IType448', a)
    if hasattr(b2, 'Core_IType448'):
        assert _is_linked(b2, 'Core_IType448', a)
    _safe_set(a, 'PrimitiveTypes_Core_IClassFile', None)
    assert not _is_linked(a, 'PrimitiveTypes_Core_IClassFile', b2)
    if hasattr(b2, 'Core_IType448'):
        assert not _is_linked(b2, 'Core_IType448', a)
...
def test_assoc_typeParameters464_link_reassign_clear():
    a = PrimitiveTypes_Core_IType(fullyQualifiedName="sample_text", fullyQualifiedParametrizedName="sample_text")
    b1 = Core_ITypeParameter(bounds="sample_text")
    b2 = Core_ITypeParameter(bounds="sample_text_2")
    _safe_set(a, 'PrimitiveTypes_Core_IType465', {b1})
    assert _is_linked(a, 'PrimitiveTypes_Core_IType465', b1)
    if hasattr(b1, 'Core_ITypeParameter'):
        assert _is_linked(b1, 'Core_ITypeParameter', a)
    _safe_set(a, 'PrimitiveTypes_Core_IType465', {b2})
    assert _is_linked(a, 'PrimitiveTypes_Core_IType465', b2)
    if hasattr(b1, 'Core_ITypeParameter'):
        assert not _is_linked(b1, 'Core_ITypeParameter', a)
    if hasattr(b2, 'Core_ITypeParameter'):
        assert _is_linked(b2, 'Core_ITypeParameter', a)
    _safe_set(a, 'PrimitiveTypes_Core_IType465', set())
    assert not _is_linked(a, 'PrimitiveTypes_Core_IType465', b2)
    if hasattr(b2, 'Core_ITypeParameter'):
        assert not _is_linked(b2, 'Core_ITypeParameter', a)
...
def test_assoc_types438_link_reassign_clear():
    a = Core_IType(fullyQualifiedName="sample_text", fullyQualifiedParametrizedName="sample_text")
    b1 = PrimitiveTypes_Core_ICompilationUnit()
    b2 = PrimitiveTypes_Core_ICompilationUnit()
    _safe_set(a, 'Core_IType440', b1)
    assert _is_linked(a, 'Core_IType440', b1)
    if hasattr(b1, 'PrimitiveTypes_Core_ICompilationUnit439'):
        assert _is_linked(b1, 'PrimitiveTypes_Core_ICompilationUnit439', a)
    _safe_set(a, 'Core_IType440', b2)
    assert _is_linked(a, 'Core_IType440', b2)
    if hasattr(b1, 'PrimitiveTypes_Core_ICompilationUnit439'):
        assert not _is_linked(b1, 'PrimitiveTypes_Core_ICompilationUnit439', a)
    if hasattr(b2, 'PrimitiveTypes_Core_ICompilationUnit439'):
        assert _is_linked(b2, 'PrimitiveTypes_Core_ICompilationUnit439', a)
    _safe_set(a, 'Core_IType440', None)
    assert not _is_linked(a, 'Core_IType440', b2)
    if hasattr(b2, 'PrimitiveTypes_Core_ICompilationUnit439'):
        assert not _is_linked(b2, 'PrimitiveTypes_Core_ICompilationUnit439', a)


def test_assoc_types461_link_reassign_clear():
    a = PrimitiveTypes_Core_IType(fullyQualifiedName="sample_text", fullyQualifiedParametrizedName="sample_text")
    b1 = Core_IType(fullyQualifiedName="sample_text", fullyQualifiedParametrizedName="sample_text")
    b2 = Core_IType(fullyQualifiedName="sample_text_2", fullyQualifiedParametrizedName="sample_text_2")
    _safe_set(a, 'PrimitiveTypes_Core_IType462', {b1})
    assert _is_linked(a, 'PrimitiveTypes_Core_IType462', b1)
    if hasattr(b1, 'Core_IType463'):
        assert _is_linked(b1, 'Core_IType463', a)
    _safe_set(a, 'PrimitiveTypes_Core_IType462', {b2})
    assert _is_linked(a, 'PrimitiveTypes_Core_IType462', b2)
    if hasattr(b1, 'Core_IType463'):
        assert not _is_linked(b1, 'Core_IType463', a)
    if hasattr(b2, 'Core_IType463'):
        assert _is_linked(b2, 'Core_IType463', a)
    _safe_set(a, 'PrimitiveTypes_Core_IType462', set())
    assert not _is_linked(a, 'PrimitiveTypes_Core_IType462', b2)
    if hasattr(b2, 'Core_IType463'):
        assert not _is_linked(b2, 'Core_IType463', a)
...
PrimitiveTypes_Core_BinaryPackageFragmentRoot_strategy = st.builds(PrimitiveTypes_Core_BinaryPackageFragmentRoot)
...
PrimitiveTypes_Core_IClassFile_strategy = st.builds(PrimitiveTypes_Core_IClassFile, isClass=safe_text, isInterface=safe_text)
...
PrimitiveTypes_Core_ICompilationUnit_strategy = st.builds(PrimitiveTypes_Core_ICompilationUnit)
...
PrimitiveTypes_Core_IField_strategy = st.builds(PrimitiveTypes_Core_IField, constant=safe_text, isEnumConstant=safe_text, isTransient=safe_text, isVolatile=safe_text, typeSignature=safe_text)
...
PrimitiveTypes_Core_IInitializer_strategy = st.builds(PrimitiveTypes_Core_IInitializer)
...
PrimitiveTypes_Core_IJavaElement_strategy = st.builds(PrimitiveTypes_Core_IJavaElement, elementName=safe_text)
...
PrimitiveTypes_Core_IJavaModel_strategy = st.builds(PrimitiveTypes_Core_IJavaModel)
...
PrimitiveTypes_Core_IMethod_strategy = st.builds(PrimitiveTypes_Core_IMethod, exceptionTypes=safe_text, isConstructor=safe_text, isMainMethod=safe_text, returnType=safe_text)
...
PrimitiveTypes_Core_ISourceRange_strategy = st.builds(PrimitiveTypes_Core_ISourceRange, length=safe_text, offset=safe_text)
...
PrimitiveTypes_Core_ISourceReference_strategy = st.builds(PrimitiveTypes_Core_ISourceReference, source=safe_text)
...
PrimitiveTypes_Core_IType_strategy = st.builds(PrimitiveTypes_Core_IType, fullyQualifiedName=safe_text, fullyQualifiedParametrizedName=safe_text)
...
PrimitiveTypes_Core_Parameter_strategy = st.builds(PrimitiveTypes_Core_Parameter, name=safe_text, type=safe_text)
...
PrimitiveTypes_Core_PhysicalElement_strategy = st.builds(PrimitiveTypes_Core_PhysicalElement, isReadOnly=safe_text, path=safe_text)
...
PrimitiveTypes_Core_SourcePackageFragmentRoot_strategy = st.builds(PrimitiveTypes_Core_SourcePackageFragmentRoot)
