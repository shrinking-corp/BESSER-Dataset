...
from python_code import (
    PrimitiveTypes_Core_Parameter,
    PrimitiveTypes_Core_ISourceRange,
    PrimitiveTypes_Core_ISourceReference,
    MemberValuePair,
    PrimitiveTypes_Core_PhysicalElement,
    PrimitiveTypes_Core_IJavaElement,
    VariableDeclaration,
    ...
    IMember,
    Core_IMethod,
    PrimitiveTypes_Core_IInitializer,
    PrimitiveTypes_Core_IField,
    PrimitiveTypes_Core_IType,
    PrimitiveTypes_Core_IMethod,
    Core_IType,
    Core_ISourceRange,
    ISourceRange,
    ...
    PrimitiveTypes_Core_SourcePackageFragmentRoot,
    ...
    PrimitiveTypes_Core_IJavaModel,
    Core_IJavaModel,
    Core_PhysicalElement,
    Core_IJavaElement,
    PrimitiveTypes_Core_IMember,
    PrimitiveTypes_Core_IImportDeclaration,
    PrimitiveTypes_Core_ITypeRoot,
    PrimitiveTypes_Core_IPackageFragmentRoot,
    PrimitiveTypes_Core_IPackageFragment,
    PrimitiveTypes_Core_ITypeParameter,
    PrimitiveTypes_Core_IJavaProject,
    IImportDeclaration,
    IType,
    ITypeRoot,
    PrimitiveTypes_Core_IClassFile,
    Core_IClassFile,
    PrimitiveTypes_Core_ICompilationUnit,
...
def test_primitivetypes_core_parameter_is_not_abstract():
    assert not inspect.isabstract(PrimitiveTypes_Core_Parameter)


def test_primitivetypes_core_parameter_constructor_exists():
    assert callable(PrimitiveTypes_Core_Parameter.__init__)


def test_primitivetypes_core_parameter_constructor_args():
    sig = inspect.signature(PrimitiveTypes_Core_Parameter.__init__)
    params = list(sig.parameters.keys())
    assert "name" in params, "Missing parameter 'name'"
    assert "type" in params, "Missing parameter 'type'"

def test_primitivetypes_core_parameter_has_name():
    assert hasattr(PrimitiveTypes_Core_Parameter, "name")
    descriptor = None
    for klass in PrimitiveTypes_Core_Parameter.__mro__:
        if "name" in klass.__dict__:
            descriptor = klass.__dict__["name"]
            break
    assert isinstance(descriptor, property)

def test_primitivetypes_core_parameter_has_type():
    assert hasattr(PrimitiveTypes_Core_Parameter, "type")
    descriptor = None
    for klass in PrimitiveTypes_Core_Parameter.__mro__:
...
def test_primitivetypes_core_isourcerange_is_not_abstract():
    assert not inspect.isabstract(PrimitiveTypes_Core_ISourceRange)


def test_primitivetypes_core_isourcerange_constructor_exists():
    assert callable(PrimitiveTypes_Core_ISourceRange.__init__)


def test_primitivetypes_core_isourcerange_constructor_args():
    sig = inspect.signature(PrimitiveTypes_Core_ISourceRange.__init__)
    params = list(sig.parameters.keys())
    assert "offset" in params, "Missing parameter 'offset'"
    assert "length" in params, "Missing parameter 'length'"

def test_primitivetypes_core_isourcerange_has_offset():
    assert hasattr(PrimitiveTypes_Core_ISourceRange, "offset")
    descriptor = None
    for klass in PrimitiveTypes_Core_ISourceRange.__mro__:
        if "offset" in klass.__dict__:
            descriptor = klass.__dict__["offset"]
            break
    assert isinstance(descriptor, property)

def test_primitivetypes_core_isourcerange_has_length():
    assert hasattr(PrimitiveTypes_Core_ISourceRange, "length")
    descriptor = None
    for klass in PrimitiveTypes_Core_ISourceRange.__mro__:
...
def test_primitivetypes_core_isourcereference_is_not_abstract():
    assert not inspect.isabstract(PrimitiveTypes_Core_ISourceReference)


def test_primitivetypes_core_isourcereference_constructor_exists():
    assert callable(PrimitiveTypes_Core_ISourceReference.__init__)


def test_primitivetypes_core_isourcereference_constructor_args():
    sig = inspect.signature(PrimitiveTypes_Core_ISourceReference.__init__)
    params = list(sig.parameters.keys())
    assert "source" in params, "Missing parameter 'source'"

def test_primitivetypes_core_isourcereference_has_source():
    assert hasattr(PrimitiveTypes_Core_ISourceReference, "source")
    descriptor = None
    for klass in PrimitiveTypes_Core_ISourceReference.__mro__:
...
def test_primitivetypes_core_physicalelement_is_not_abstract():
    assert not inspect.isabstract(PrimitiveTypes_Core_PhysicalElement)


def test_primitivetypes_core_physicalelement_constructor_exists():
    assert callable(PrimitiveTypes_Core_PhysicalElement.__init__)


def test_primitivetypes_core_physicalelement_constructor_args():
    sig = inspect.signature(PrimitiveTypes_Core_PhysicalElement.__init__)
    params = list(sig.parameters.keys())
    assert "isReadOnly" in params, "Missing parameter 'isReadOnly'"
    assert "path" in params, "Missing parameter 'path'"

def test_primitivetypes_core_physicalelement_has_isReadOnly():
    assert hasattr(PrimitiveTypes_Core_PhysicalElement, "isReadOnly")
    descriptor = None
    for klass in PrimitiveTypes_Core_PhysicalElement.__mro__:
        if "isReadOnly" in klass.__dict__:
            descriptor = klass.__dict__["isReadOnly"]
            break
    assert isinstance(descriptor, property)

def test_primitivetypes_core_physicalelement_has_path():
    assert hasattr(PrimitiveTypes_Core_PhysicalElement, "path")
    descriptor = None
    for klass in PrimitiveTypes_Core_PhysicalElement.__mro__:
...
def test_primitivetypes_core_ijavaelement_is_not_abstract():
    assert not inspect.isabstract(PrimitiveTypes_Core_IJavaElement)


def test_primitivetypes_core_ijavaelement_constructor_exists():
    assert callable(PrimitiveTypes_Core_IJavaElement.__init__)


def test_primitivetypes_core_ijavaelement_constructor_args():
    sig = inspect.signature(PrimitiveTypes_Core_IJavaElement.__init__)
    params = list(sig.parameters.keys())
    assert "elementName" in params, "Missing parameter 'elementName'"

def test_primitivetypes_core_ijavaelement_has_elementName():
    assert hasattr(PrimitiveTypes_Core_IJavaElement, "elementName")
    descriptor = None
    for klass in PrimitiveTypes_Core_IJavaElement.__mro__:
...
def test_primitivetypes_core_iinitializer_is_not_abstract():
    assert not inspect.isabstract(PrimitiveTypes_Core_IInitializer)


def test_primitivetypes_core_iinitializer_constructor_exists():
    assert callable(PrimitiveTypes_Core_IInitializer.__init__)


def test_primitivetypes_core_iinitializer_constructor_args():
    sig = inspect.signature(PrimitiveTypes_Core_IInitializer.__init__)
    params = list(sig.parameters.keys())



def test_primitivetypes_core_ifield_is_not_abstract():
    assert not inspect.isabstract(PrimitiveTypes_Core_IField)


def test_primitivetypes_core_ifield_constructor_exists():
    assert callable(PrimitiveTypes_Core_IField.__init__)


def test_primitivetypes_core_ifield_constructor_args():
    sig = inspect.signature(PrimitiveTypes_Core_IField.__init__)
    params = list(sig.parameters.keys())
...
def test_primitivetypes_core_ifield_has_typeSignature():
    assert hasattr(PrimitiveTypes_Core_IField, "typeSignature")
    descriptor = None
    for klass in PrimitiveTypes_Core_IField.__mro__:
        if "typeSignature" in klass.__dict__:
            descriptor = klass.__dict__["typeSignature"]
            break
    assert isinstance(descriptor, property)

def test_primitivetypes_core_ifield_has_isVolatile():
    assert hasattr(PrimitiveTypes_Core_IField, "isVolatile")
    descriptor = None
    for klass in PrimitiveTypes_Core_IField.__mro__:
...
def test_primitivetypes_core_ifield_has_isTransient():
    assert hasattr(PrimitiveTypes_Core_IField, "isTransient")
    descriptor = None
    for klass in PrimitiveTypes_Core_IField.__mro__:
...
def test_primitivetypes_core_ifield_has_constant():
    assert hasattr(PrimitiveTypes_Core_IField, "constant")
    descriptor = None
    for klass in PrimitiveTypes_Core_IField.__mro__:
...
def test_primitivetypes_core_ifield_has_isEnumConstant():
    assert hasattr(PrimitiveTypes_Core_IField, "isEnumConstant")
    descriptor = None
    for klass in PrimitiveTypes_Core_IField.__mro__:
...
def test_primitivetypes_core_itype_is_not_abstract():
    assert not inspect.isabstract(PrimitiveTypes_Core_IType)


def test_primitivetypes_core_itype_constructor_exists():
    assert callable(PrimitiveTypes_Core_IType.__init__)


def test_primitivetypes_core_itype_constructor_args():
    sig = inspect.signature(PrimitiveTypes_Core_IType.__init__)
    params = list(sig.parameters.keys())
    assert "fullyQualifiedParametrizedName" in params, "Missing parameter 'fullyQualifiedParametrizedName'"
    assert "fullyQualifiedName" in params, "Missing parameter 'fullyQualifiedName'"

def test_primitivetypes_core_itype_has_fullyQualifiedParametrizedName():
    assert hasattr(PrimitiveTypes_Core_IType, "fullyQualifiedParametrizedName")
    descriptor = None
    for klass in PrimitiveTypes_Core_IType.__mro__:
        if "fullyQualifiedParametrizedName" in klass.__dict__:
            descriptor = klass.__dict__["fullyQualifiedParametrizedName"]
            break
    assert isinstance(descriptor, property)

def test_primitivetypes_core_itype_has_fullyQualifiedName():
    assert hasattr(PrimitiveTypes_Core_IType, "fullyQualifiedName")
    descriptor = None
    for klass in PrimitiveTypes_Core_IType.__mro__:
        if "fullyQualifiedName" in klass.__dict__:
            descriptor = klass.__dict__["fullyQualifiedName"]
...
def test_primitivetypes_core_imethod_is_not_abstract():
    assert not inspect.isabstract(PrimitiveTypes_Core_IMethod)


def test_primitivetypes_core_imethod_constructor_exists():
    assert callable(PrimitiveTypes_Core_IMethod.__init__)


def test_primitivetypes_core_imethod_constructor_args():
    sig = inspect.signature(PrimitiveTypes_Core_IMethod.__init__)
    params = list(sig.parameters.keys())
    assert "exceptionTypes" in params, "Missing parameter 'exceptionTypes'"
    assert "isConstructor" in params, "Missing parameter 'isConstructor'"
    assert "isMainMethod" in params, "Missing parameter 'isMainMethod'"
...
def test_primitivetypes_core_imethod_has_exceptionTypes():
    assert hasattr(PrimitiveTypes_Core_IMethod, "exceptionTypes")
    descriptor = None
    for klass in PrimitiveTypes_Core_IMethod.__mro__:
        if "exceptionTypes" in klass.__dict__:
            descriptor = klass.__dict__["exceptionTypes"]
            break
    assert isinstance(descriptor, property)

def test_primitivetypes_core_imethod_has_isConstructor():
    assert hasattr(PrimitiveTypes_Core_IMethod, "isConstructor")
    descriptor = None
    for klass in PrimitiveTypes_Core_IMethod.__mro__:
        if "isConstructor" in klass.__dict__:
            descriptor = klass.__dict__["isConstructor"]
...
def test_primitivetypes_core_imethod_has_isMainMethod():
    assert hasattr(PrimitiveTypes_Core_IMethod, "isMainMethod")
    descriptor = None
    for klass in PrimitiveTypes_Core_IMethod.__mro__:
        if "isMainMethod" in klass.__dict__:
            descriptor = klass.__dict__["isMainMethod"]
...
def test_primitivetypes_core_imethod_has_returnType():
    assert hasattr(PrimitiveTypes_Core_IMethod, "returnType")
    descriptor = None
    for klass in PrimitiveTypes_Core_IMethod.__mro__:
        if "returnType" in klass.__dict__:
            descriptor = klass.__dict__["returnType"]
...
def test_primitivetypes_core_sourcepackagefragmentroot_is_not_abstract():
    assert not inspect.isabstract(PrimitiveTypes_Core_SourcePackageFragmentRoot)


def test_primitivetypes_core_sourcepackagefragmentroot_constructor_exists():
    assert callable(PrimitiveTypes_Core_SourcePackageFragmentRoot.__init__)


def test_primitivetypes_core_sourcepackagefragmentroot_constructor_args():
    sig = inspect.signature(PrimitiveTypes_Core_SourcePackageFragmentRoot.__init__)
    params = list(sig.parameters.keys())



def test_primitivetypes_core_binarypackagefragmentroot_is_not_abstract():
    assert not inspect.isabstract(PrimitiveTypes_Core_BinaryPackageFragmentRoot)


def test_primitivetypes_core_binarypackagefragmentroot_constructor_exists():
    assert callable(PrimitiveTypes_Core_BinaryPackageFragmentRoot.__init__)


def test_primitivetypes_core_binarypackagefragmentroot_constructor_args():
    sig = inspect.signature(PrimitiveTypes_Core_BinaryPackageFragmentRoot.__init__)
    params = list(sig.parameters.keys())
...
def test_primitivetypes_core_ijavamodel_is_not_abstract():
    assert not inspect.isabstract(PrimitiveTypes_Core_IJavaModel)


def test_primitivetypes_core_ijavamodel_constructor_exists():
    assert callable(PrimitiveTypes_Core_IJavaModel.__init__)


def test_primitivetypes_core_ijavamodel_constructor_args():
    sig = inspect.signature(PrimitiveTypes_Core_IJavaModel.__init__)
    params = list(sig.parameters.keys())
...
def test_primitivetypes_core_imember_is_not_abstract():
    assert not inspect.isabstract(PrimitiveTypes_Core_IMember)


def test_primitivetypes_core_imember_constructor_exists():
    assert callable(PrimitiveTypes_Core_IMember.__init__)


def test_primitivetypes_core_imember_constructor_args():
    sig = inspect.signature(PrimitiveTypes_Core_IMember.__init__)
    params = list(sig.parameters.keys())
    assert "elementName" in params, "Missing parameter 'elementName'"
    assert "source" in params, "Missing parameter 'source'"

def test_primitivetypes_core_imember_has_elementName():
    assert hasattr(PrimitiveTypes_Core_IMember, "elementName")
    descriptor = None
    for klass in PrimitiveTypes_Core_IMember.__mro__:
        if "elementName" in klass.__dict__:
            descriptor = klass.__dict__["elementName"]
            break
    assert isinstance(descriptor, property)

def test_primitivetypes_core_imember_has_source():
    assert hasattr(PrimitiveTypes_Core_IMember, "source")
    descriptor = None
    for klass in PrimitiveTypes_Core_IMember.__mro__:
        if "source" in klass.__dict__:
            descriptor = klass.__dict__["source"]
...
def test_primitivetypes_core_iimportdeclaration_is_not_abstract():
    assert not inspect.isabstract(PrimitiveTypes_Core_IImportDeclaration)


def test_primitivetypes_core_iimportdeclaration_constructor_exists():
    assert callable(PrimitiveTypes_Core_IImportDeclaration.__init__)


def test_primitivetypes_core_iimportdeclaration_constructor_args():
    sig = inspect.signature(PrimitiveTypes_Core_IImportDeclaration.__init__)
    params = list(sig.parameters.keys())
    assert "elementName" in params, "Missing parameter 'elementName'"
    assert "source" in params, "Missing parameter 'source'"
...
def test_primitivetypes_core_iimportdeclaration_has_elementName():
    assert hasattr(PrimitiveTypes_Core_IImportDeclaration, "elementName")
    descriptor = None
    for klass in PrimitiveTypes_Core_IImportDeclaration.__mro__:
        if "elementName" in klass.__dict__:
            descriptor = klass.__dict__["elementName"]
            break
    assert isinstance(descriptor, property)

def test_primitivetypes_core_iimportdeclaration_has_source():
    assert hasattr(PrimitiveTypes_Core_IImportDeclaration, "source")
    descriptor = None
    for klass in PrimitiveTypes_Core_IImportDeclaration.__mro__:
        if "source" in klass.__dict__:
            descriptor = klass.__dict__["source"]
...
def test_primitivetypes_core_iimportdeclaration_has_isOnDemand():
    assert hasattr(PrimitiveTypes_Core_IImportDeclaration, "isOnDemand")
    descriptor = None
    for klass in PrimitiveTypes_Core_IImportDeclaration.__mro__:
...
def test_primitivetypes_core_iimportdeclaration_has_isStatic():
    assert hasattr(PrimitiveTypes_Core_IImportDeclaration, "isStatic")
    descriptor = None
    for klass in PrimitiveTypes_Core_IImportDeclaration.__mro__:
...
def test_primitivetypes_core_ityperoot_is_not_abstract():
    assert not inspect.isabstract(PrimitiveTypes_Core_ITypeRoot)


def test_primitivetypes_core_ityperoot_constructor_exists():
    assert callable(PrimitiveTypes_Core_ITypeRoot.__init__)


def test_primitivetypes_core_ityperoot_constructor_args():
    sig = inspect.signature(PrimitiveTypes_Core_ITypeRoot.__init__)
    params = list(sig.parameters.keys())
    assert "elementName" in params, "Missing parameter 'elementName'"
    assert "path" in params, "Missing parameter 'path'"
    assert "isReadOnly" in params, "Missing parameter 'isReadOnly'"
...
def test_primitivetypes_core_ityperoot_has_elementName():
    assert hasattr(PrimitiveTypes_Core_ITypeRoot, "elementName")
    descriptor = None
    for klass in PrimitiveTypes_Core_ITypeRoot.__mro__:
        if "elementName" in klass.__dict__:
            descriptor = klass.__dict__["elementName"]
            break
    assert isinstance(descriptor, property)

def test_primitivetypes_core_ityperoot_has_path():
    assert hasattr(PrimitiveTypes_Core_ITypeRoot, "path")
    descriptor = None
    for klass in PrimitiveTypes_Core_ITypeRoot.__mro__:
        if "path" in klass.__dict__:
            descriptor = klass.__dict__["path"]
...
def test_primitivetypes_core_ityperoot_has_isReadOnly():
    assert hasattr(PrimitiveTypes_Core_ITypeRoot, "isReadOnly")
    descriptor = None
    for klass in PrimitiveTypes_Core_ITypeRoot.__mro__:
        if "isReadOnly" in klass.__dict__:
            descriptor = klass.__dict__["isReadOnly"]
...
def test_primitivetypes_core_ityperoot_has_source():
    assert hasattr(PrimitiveTypes_Core_ITypeRoot, "source")
    descriptor = None
    for klass in PrimitiveTypes_Core_ITypeRoot.__mro__:
        if "source" in klass.__dict__:
            descriptor = klass.__dict__["source"]
...
def test_primitivetypes_core_ipackagefragmentroot_is_not_abstract():
    assert not inspect.isabstract(PrimitiveTypes_Core_IPackageFragmentRoot)


def test_primitivetypes_core_ipackagefragmentroot_constructor_exists():
    assert callable(PrimitiveTypes_Core_IPackageFragmentRoot.__init__)


def test_primitivetypes_core_ipackagefragmentroot_constructor_args():
    sig = inspect.signature(PrimitiveTypes_Core_IPackageFragmentRoot.__init__)
    params = list(sig.parameters.keys())
    assert "path" in params, "Missing parameter 'path'"
    assert "isReadOnly" in params, "Missing parameter 'isReadOnly'"
    assert "elementName" in params, "Missing parameter 'elementName'"

def test_primitivetypes_core_ipackagefragmentroot_has_path():
    assert hasattr(PrimitiveTypes_Core_IPackageFragmentRoot, "path")
    descriptor = None
    for klass in PrimitiveTypes_Core_IPackageFragmentRoot.__mro__:
        if "path" in klass.__dict__:
            descriptor = klass.__dict__["path"]
            break
    assert isinstance(descriptor, property)

def test_primitivetypes_core_ipackagefragmentroot_has_isReadOnly():
    assert hasattr(PrimitiveTypes_Core_IPackageFragmentRoot, "isReadOnly")
    descriptor = None
    for klass in PrimitiveTypes_Core_IPackageFragmentRoot.__mro__:
        if "isReadOnly" in klass.__dict__:
            descriptor = klass.__dict__["isReadOnly"]
...
def test_primitivetypes_core_ipackagefragmentroot_has_elementName():
    assert hasattr(PrimitiveTypes_Core_IPackageFragmentRoot, "elementName")
    descriptor = None
    for klass in PrimitiveTypes_Core_IPackageFragmentRoot.__mro__:
        if "elementName" in klass.__dict__:
            descriptor = klass.__dict__["elementName"]
...
def test_primitivetypes_core_ipackagefragment_is_not_abstract():
    assert not inspect.isabstract(PrimitiveTypes_Core_IPackageFragment)


def test_primitivetypes_core_ipackagefragment_constructor_exists():
    assert callable(PrimitiveTypes_Core_IPackageFragment.__init__)


def test_primitivetypes_core_ipackagefragment_constructor_args():
    sig = inspect.signature(PrimitiveTypes_Core_IPackageFragment.__init__)
    params = list(sig.parameters.keys())
    assert "path" in params, "Missing parameter 'path'"
    assert "isDefaultPackage" in params, "Missing parameter 'isDefaultPackage'"
    assert "isReadOnly" in params, "Missing parameter 'isReadOnly'"
...
def test_primitivetypes_core_ipackagefragment_has_path():
    assert hasattr(PrimitiveTypes_Core_IPackageFragment, "path")
    descriptor = None
    for klass in PrimitiveTypes_Core_IPackageFragment.__mro__:
        if "path" in klass.__dict__:
            descriptor = klass.__dict__["path"]
            break
    assert isinstance(descriptor, property)

def test_primitivetypes_core_ipackagefragment_has_isDefaultPackage():
    assert hasattr(PrimitiveTypes_Core_IPackageFragment, "isDefaultPackage")
    descriptor = None
    for klass in PrimitiveTypes_Core_IPackageFragment.__mro__:
        if "isDefaultPackage" in klass.__dict__:
            descriptor = klass.__dict__["isDefaultPackage"]
...
def test_primitivetypes_core_ipackagefragment_has_isReadOnly():
    assert hasattr(PrimitiveTypes_Core_IPackageFragment, "isReadOnly")
    descriptor = None
    for klass in PrimitiveTypes_Core_IPackageFragment.__mro__:
        if "isReadOnly" in klass.__dict__:
            descriptor = klass.__dict__["isReadOnly"]
...
def test_primitivetypes_core_ipackagefragment_has_elementName():
    assert hasattr(PrimitiveTypes_Core_IPackageFragment, "elementName")
    descriptor = None
    for klass in PrimitiveTypes_Core_IPackageFragment.__mro__:
        if "elementName" in klass.__dict__:
            descriptor = klass.__dict__["elementName"]
...
def test_primitivetypes_core_itypeparameter_is_not_abstract():
    assert not inspect.isabstract(PrimitiveTypes_Core_ITypeParameter)


def test_primitivetypes_core_itypeparameter_constructor_exists():
    assert callable(PrimitiveTypes_Core_ITypeParameter.__init__)


def test_primitivetypes_core_itypeparameter_constructor_args():
    sig = inspect.signature(PrimitiveTypes_Core_ITypeParameter.__init__)
    params = list(sig.parameters.keys())
    assert "bounds" in params, "Missing parameter 'bounds'"
    assert "source" in params, "Missing parameter 'source'"
    assert "elementName" in params, "Missing parameter 'elementName'"

def test_primitivetypes_core_itypeparameter_has_bounds():
    assert hasattr(PrimitiveTypes_Core_ITypeParameter, "bounds")
    descriptor = None
    for klass in PrimitiveTypes_Core_ITypeParameter.__mro__:
        if "bounds" in klass.__dict__:
            descriptor = klass.__dict__["bounds"]
            break
    assert isinstance(descriptor, property)

def test_primitivetypes_core_itypeparameter_has_source():
    assert hasattr(PrimitiveTypes_Core_ITypeParameter, "source")
    descriptor = None
    for klass in PrimitiveTypes_Core_ITypeParameter.__mro__:
        if "source" in klass.__dict__:
            descriptor = klass.__dict__["source"]
...
def test_primitivetypes_core_itypeparameter_has_elementName():
    assert hasattr(PrimitiveTypes_Core_ITypeParameter, "elementName")
    descriptor = None
    for klass in PrimitiveTypes_Core_ITypeParameter.__mro__:
        if "elementName" in klass.__dict__:
            descriptor = klass.__dict__["elementName"]
...
def test_primitivetypes_core_ijavaproject_is_not_abstract():
    assert not inspect.isabstract(PrimitiveTypes_Core_IJavaProject)


def test_primitivetypes_core_ijavaproject_constructor_exists():
    assert callable(PrimitiveTypes_Core_IJavaProject.__init__)


def test_primitivetypes_core_ijavaproject_constructor_args():
    sig = inspect.signature(PrimitiveTypes_Core_IJavaProject.__init__)
    params = list(sig.parameters.keys())
    assert "path" in params, "Missing parameter 'path'"
    assert "isReadOnly" in params, "Missing parameter 'isReadOnly'"
    assert "elementName" in params, "Missing parameter 'elementName'"

def test_primitivetypes_core_ijavaproject_has_path():
    assert hasattr(PrimitiveTypes_Core_IJavaProject, "path")
    descriptor = None
    for klass in PrimitiveTypes_Core_IJavaProject.__mro__:
        if "path" in klass.__dict__:
            descriptor = klass.__dict__["path"]
            break
    assert isinstance(descriptor, property)

def test_primitivetypes_core_ijavaproject_has_isReadOnly():
    assert hasattr(PrimitiveTypes_Core_IJavaProject, "isReadOnly")
    descriptor = None
    for klass in PrimitiveTypes_Core_IJavaProject.__mro__:
        if "isReadOnly" in klass.__dict__:
            descriptor = klass.__dict__["isReadOnly"]
...
def test_primitivetypes_core_ijavaproject_has_elementName():
    assert hasattr(PrimitiveTypes_Core_IJavaProject, "elementName")
    descriptor = None
    for klass in PrimitiveTypes_Core_IJavaProject.__mro__:
        if "elementName" in klass.__dict__:
            descriptor = klass.__dict__["elementName"]
...
def test_primitivetypes_core_iclassfile_is_not_abstract():
    assert not inspect.isabstract(PrimitiveTypes_Core_IClassFile)


def test_primitivetypes_core_iclassfile_constructor_exists():
    assert callable(PrimitiveTypes_Core_IClassFile.__init__)


def test_primitivetypes_core_iclassfile_constructor_args():
    sig = inspect.signature(PrimitiveTypes_Core_IClassFile.__init__)
    params = list(sig.parameters.keys())
    assert "isClass" in params, "Missing parameter 'isClass'"
    assert "isInterface" in params, "Missing parameter 'isInterface'"

def test_primitivetypes_core_iclassfile_has_isClass():
    assert hasattr(PrimitiveTypes_Core_IClassFile, "isClass")
    descriptor = None
    for klass in PrimitiveTypes_Core_IClassFile.__mro__:
        if "isClass" in klass.__dict__:
            descriptor = klass.__dict__["isClass"]
            break
    assert isinstance(descriptor, property)

def test_primitivetypes_core_iclassfile_has_isInterface():
    assert hasattr(PrimitiveTypes_Core_IClassFile, "isInterface")
    descriptor = None
    for klass in PrimitiveTypes_Core_IClassFile.__mro__:
...
def test_primitivetypes_core_icompilationunit_is_not_abstract():
    assert not inspect.isabstract(PrimitiveTypes_Core_ICompilationUnit)


def test_primitivetypes_core_icompilationunit_constructor_exists():
    assert callable(PrimitiveTypes_Core_ICompilationUnit.__init__)


def test_primitivetypes_core_icompilationunit_constructor_args():
    sig = inspect.signature(PrimitiveTypes_Core_ICompilationUnit.__init__)
    params = list(sig.parameters.keys())
...
PrimitiveTypes_Core_Parameter_strategy = st.builds(
    PrimitiveTypes_Core_Parameter,
    name=
        safe_text,
    type=
...
PrimitiveTypes_Core_ISourceRange_strategy = st.builds(
    PrimitiveTypes_Core_ISourceRange,
    offset=
        safe_text,
    length=
...
PrimitiveTypes_Core_ISourceReference_strategy = st.builds(
    PrimitiveTypes_Core_ISourceReference,
    source=
        safe_text
)
...
PrimitiveTypes_Core_PhysicalElement_strategy = st.builds(
    PrimitiveTypes_Core_PhysicalElement,
    isReadOnly=
        safe_text,
    path=
...
PrimitiveTypes_Core_IJavaElement_strategy = st.builds(
    PrimitiveTypes_Core_IJavaElement,
    elementName=
        safe_text
)
...
PrimitiveTypes_Core_IInitializer_strategy = st.builds(
    PrimitiveTypes_Core_IInitializer,
)
PrimitiveTypes_Core_IField_strategy = st.builds(
    PrimitiveTypes_Core_IField,
    typeSignature=
        safe_text,
    isVolatile=
...
PrimitiveTypes_Core_IType_strategy = st.builds(
    PrimitiveTypes_Core_IType,
...
PrimitiveTypes_Core_IMethod_strategy = st.builds(
    PrimitiveTypes_Core_IMethod,
    exceptionTypes=
        safe_text,
    isConstructor=
...
PrimitiveTypes_Core_SourcePackageFragmentRoot_strategy = st.builds(
    PrimitiveTypes_Core_SourcePackageFragmentRoot,
)
PrimitiveTypes_Core_BinaryPackageFragmentRoot_strategy = st.builds(
    PrimitiveTypes_Core_BinaryPackageFragmentRoot,
)
...
PrimitiveTypes_Core_IJavaModel_strategy = st.builds(
    PrimitiveTypes_Core_IJavaModel,
)
...
PrimitiveTypes_Core_IMember_strategy = st.builds(
    PrimitiveTypes_Core_IMember,
    elementName=
        safe_text,
    source=
...
PrimitiveTypes_Core_IImportDeclaration_strategy = st.builds(
    PrimitiveTypes_Core_IImportDeclaration,
    elementName=
        safe_text,
    source=
...
PrimitiveTypes_Core_ITypeRoot_strategy = st.builds(
    PrimitiveTypes_Core_ITypeRoot,
    elementName=
        safe_text,
    path=
...
PrimitiveTypes_Core_IPackageFragmentRoot_strategy = st.builds(
    PrimitiveTypes_Core_IPackageFragmentRoot,
    path=
        safe_text,
    isReadOnly=
...
PrimitiveTypes_Core_IPackageFragment_strategy = st.builds(
    PrimitiveTypes_Core_IPackageFragment,
    path=
        safe_text,
    isDefaultPackage=
...
PrimitiveTypes_Core_ITypeParameter_strategy = st.builds(
    PrimitiveTypes_Core_ITypeParameter,
    bounds=
        safe_text,
    source=
...
PrimitiveTypes_Core_IJavaProject_strategy = st.builds(
    PrimitiveTypes_Core_IJavaProject,
    path=
        safe_text,
    isReadOnly=
...
PrimitiveTypes_Core_IClassFile_strategy = st.builds(
    PrimitiveTypes_Core_IClassFile,
    isClass=
        safe_text,
    isInterface=
...
PrimitiveTypes_Core_ICompilationUnit_strategy = st.builds(
    PrimitiveTypes_Core_ICompilationUnit,
)
...
@given(instance=PrimitiveTypes_Core_Parameter_strategy)
@settings(max_examples=50)
def test_primitivetypes_core_parameter_instantiation(instance):
    assert isinstance(instance, PrimitiveTypes_Core_Parameter)



@given(instance=PrimitiveTypes_Core_Parameter_strategy)
def test_primitivetypes_core_parameter_name_setter(instance):
...
@given(instance=PrimitiveTypes_Core_Parameter_strategy)
def test_primitivetypes_core_parameter_type_setter(instance):
    original = instance.type
    instance.type = original
    assert instance.type == original

@given(instance=PrimitiveTypes_Core_ISourceRange_strategy)
@settings(max_examples=50)
def test_primitivetypes_core_isourcerange_instantiation(instance):
    assert isinstance(instance, PrimitiveTypes_Core_ISourceRange)



@given(instance=PrimitiveTypes_Core_ISourceRange_strategy)
def test_primitivetypes_core_isourcerange_offset_setter(instance):
...
@given(instance=PrimitiveTypes_Core_ISourceRange_strategy)
def test_primitivetypes_core_isourcerange_length_setter(instance):
    original = instance.length
    instance.length = original
    assert instance.length == original

@given(instance=PrimitiveTypes_Core_ISourceReference_strategy)
@settings(max_examples=50)
def test_primitivetypes_core_isourcereference_instantiation(instance):
    assert isinstance(instance, PrimitiveTypes_Core_ISourceReference)



@given(instance=PrimitiveTypes_Core_ISourceReference_strategy)
def test_primitivetypes_core_isourcereference_source_setter(instance):
...
@given(instance=PrimitiveTypes_Core_PhysicalElement_strategy)
@settings(max_examples=50)
def test_primitivetypes_core_physicalelement_instantiation(instance):
    assert isinstance(instance, PrimitiveTypes_Core_PhysicalElement)



@given(instance=PrimitiveTypes_Core_PhysicalElement_strategy)
def test_primitivetypes_core_physicalelement_isReadOnly_setter(instance):
...
@given(instance=PrimitiveTypes_Core_PhysicalElement_strategy)
def test_primitivetypes_core_physicalelement_path_setter(instance):
    original = instance.path
    instance.path = original
    assert instance.path == original

@given(instance=PrimitiveTypes_Core_IJavaElement_strategy)
@settings(max_examples=50)
def test_primitivetypes_core_ijavaelement_instantiation(instance):
    assert isinstance(instance, PrimitiveTypes_Core_IJavaElement)



@given(instance=PrimitiveTypes_Core_IJavaElement_strategy)
def test_primitivetypes_core_ijavaelement_elementName_setter(instance):
...
@given(instance=PrimitiveTypes_Core_IInitializer_strategy)
@settings(max_examples=50)
def test_primitivetypes_core_iinitializer_instantiation(instance):
    assert isinstance(instance, PrimitiveTypes_Core_IInitializer)

@given(instance=PrimitiveTypes_Core_IField_strategy)
@settings(max_examples=50)
def test_primitivetypes_core_ifield_instantiation(instance):
    assert isinstance(instance, PrimitiveTypes_Core_IField)



@given(instance=PrimitiveTypes_Core_IField_strategy)
def test_primitivetypes_core_ifield_typeSignature_setter(instance):
...
@given(instance=PrimitiveTypes_Core_IField_strategy)
def test_primitivetypes_core_ifield_isVolatile_setter(instance):
...
@given(instance=PrimitiveTypes_Core_IField_strategy)
def test_primitivetypes_core_ifield_isTransient_setter(instance):
...
@given(instance=PrimitiveTypes_Core_IField_strategy)
def test_primitivetypes_core_ifield_constant_setter(instance):
...
@given(instance=PrimitiveTypes_Core_IField_strategy)
def test_primitivetypes_core_ifield_isEnumConstant_setter(instance):
    original = instance.isEnumConstant
    instance.isEnumConstant = original
    assert instance.isEnumConstant == original

@given(instance=PrimitiveTypes_Core_IType_strategy)
@settings(max_examples=50)
def test_primitivetypes_core_itype_instantiation(instance):
    assert isinstance(instance, PrimitiveTypes_Core_IType)



@given(instance=PrimitiveTypes_Core_IType_strategy)
def test_primitivetypes_core_itype_fullyQualifiedParametrizedName_setter(instance):
...
@given(instance=PrimitiveTypes_Core_IType_strategy)
def test_primitivetypes_core_itype_fullyQualifiedName_setter(instance):
    original = instance.fullyQualifiedName
    instance.fullyQualifiedName = original
    assert instance.fullyQualifiedName == original

@given(instance=PrimitiveTypes_Core_IMethod_strategy)
@settings(max_examples=50)
def test_primitivetypes_core_imethod_instantiation(instance):
    assert isinstance(instance, PrimitiveTypes_Core_IMethod)



@given(instance=PrimitiveTypes_Core_IMethod_strategy)
def test_primitivetypes_core_imethod_exceptionTypes_setter(instance):
    original = instance.exceptionTypes
    instance.exceptionTypes = original
    assert instance.exceptionTypes == original
...
@given(instance=PrimitiveTypes_Core_IMethod_strategy)
def test_primitivetypes_core_imethod_isConstructor_setter(instance):
    original = instance.isConstructor
    instance.isConstructor = original
    assert instance.isConstructor == original
...
@given(instance=PrimitiveTypes_Core_IMethod_strategy)
def test_primitivetypes_core_imethod_isMainMethod_setter(instance):
    original = instance.isMainMethod
    instance.isMainMethod = original
    assert instance.isMainMethod == original
...
@given(instance=PrimitiveTypes_Core_IMethod_strategy)
def test_primitivetypes_core_imethod_returnType_setter(instance):
    original = instance.returnType
    instance.returnType = original
    assert instance.returnType == original
...
@given(instance=PrimitiveTypes_Core_SourcePackageFragmentRoot_strategy)
@settings(max_examples=50)
def test_primitivetypes_core_sourcepackagefragmentroot_instantiation(instance):
    assert isinstance(instance, PrimitiveTypes_Core_SourcePackageFragmentRoot)

@given(instance=PrimitiveTypes_Core_BinaryPackageFragmentRoot_strategy)
@settings(max_examples=50)
def test_primitivetypes_core_binarypackagefragmentroot_instantiation(instance):
    assert isinstance(instance, PrimitiveTypes_Core_BinaryPackageFragmentRoot)
...
@given(instance=PrimitiveTypes_Core_IJavaModel_strategy)
@settings(max_examples=50)
def test_primitivetypes_core_ijavamodel_instantiation(instance):
    assert isinstance(instance, PrimitiveTypes_Core_IJavaModel)
...
@given(instance=PrimitiveTypes_Core_IMember_strategy)
@settings(max_examples=50)
def test_primitivetypes_core_imember_instantiation(instance):
    assert isinstance(instance, PrimitiveTypes_Core_IMember)



@given(instance=PrimitiveTypes_Core_IMember_strategy)
def test_primitivetypes_core_imember_elementName_setter(instance):
    original = instance.elementName
    instance.elementName = original
    assert instance.elementName == original
...
@given(instance=PrimitiveTypes_Core_IMember_strategy)
def test_primitivetypes_core_imember_source_setter(instance):
    original = instance.source
    instance.source = original
    assert instance.source == original

@given(instance=PrimitiveTypes_Core_IImportDeclaration_strategy)
@settings(max_examples=50)
def test_primitivetypes_core_iimportdeclaration_instantiation(instance):
    assert isinstance(instance, PrimitiveTypes_Core_IImportDeclaration)



@given(instance=PrimitiveTypes_Core_IImportDeclaration_strategy)
def test_primitivetypes_core_iimportdeclaration_elementName_setter(instance):
    original = instance.elementName
    instance.elementName = original
    assert instance.elementName == original
...
@given(instance=PrimitiveTypes_Core_IImportDeclaration_strategy)
def test_primitivetypes_core_iimportdeclaration_source_setter(instance):
    original = instance.source
    instance.source = original
    assert instance.source == original
...
@given(instance=PrimitiveTypes_Core_IImportDeclaration_strategy)
def test_primitivetypes_core_iimportdeclaration_isOnDemand_setter(instance):
...
@given(instance=PrimitiveTypes_Core_IImportDeclaration_strategy)
def test_primitivetypes_core_iimportdeclaration_isStatic_setter(instance):
    original = instance.isStatic
    instance.isStatic = original
    assert instance.isStatic == original

@given(instance=PrimitiveTypes_Core_ITypeRoot_strategy)
@settings(max_examples=50)
def test_primitivetypes_core_ityperoot_instantiation(instance):
    assert isinstance(instance, PrimitiveTypes_Core_ITypeRoot)



@given(instance=PrimitiveTypes_Core_ITypeRoot_strategy)
def test_primitivetypes_core_ityperoot_elementName_setter(instance):
    original = instance.elementName
    instance.elementName = original
    assert instance.elementName == original
...
@given(instance=PrimitiveTypes_Core_ITypeRoot_strategy)
def test_primitivetypes_core_ityperoot_path_setter(instance):
    original = instance.path
    instance.path = original
    assert instance.path == original
...
@given(instance=PrimitiveTypes_Core_ITypeRoot_strategy)
def test_primitivetypes_core_ityperoot_isReadOnly_setter(instance):
    original = instance.isReadOnly
    instance.isReadOnly = original
    assert instance.isReadOnly == original
...
@given(instance=PrimitiveTypes_Core_ITypeRoot_strategy)
def test_primitivetypes_core_ityperoot_source_setter(instance):
    original = instance.source
    instance.source = original
    assert instance.source == original

@given(instance=PrimitiveTypes_Core_IPackageFragmentRoot_strategy)
@settings(max_examples=50)
def test_primitivetypes_core_ipackagefragmentroot_instantiation(instance):
    assert isinstance(instance, PrimitiveTypes_Core_IPackageFragmentRoot)



@given(instance=PrimitiveTypes_Core_IPackageFragmentRoot_strategy)
def test_primitivetypes_core_ipackagefragmentroot_path_setter(instance):
    original = instance.path
    instance.path = original
    assert instance.path == original
...
@given(instance=PrimitiveTypes_Core_IPackageFragmentRoot_strategy)
def test_primitivetypes_core_ipackagefragmentroot_isReadOnly_setter(instance):
    original = instance.isReadOnly
    instance.isReadOnly = original
    assert instance.isReadOnly == original
...
@given(instance=PrimitiveTypes_Core_IPackageFragmentRoot_strategy)
def test_primitivetypes_core_ipackagefragmentroot_elementName_setter(instance):
    original = instance.elementName
    instance.elementName = original
    assert instance.elementName == original

@given(instance=PrimitiveTypes_Core_IPackageFragment_strategy)
@settings(max_examples=50)
def test_primitivetypes_core_ipackagefragment_instantiation(instance):
    assert isinstance(instance, PrimitiveTypes_Core_IPackageFragment)



@given(instance=PrimitiveTypes_Core_IPackageFragment_strategy)
def test_primitivetypes_core_ipackagefragment_path_setter(instance):
    original = instance.path
    instance.path = original
    assert instance.path == original
...
@given(instance=PrimitiveTypes_Core_IPackageFragment_strategy)
def test_primitivetypes_core_ipackagefragment_isDefaultPackage_setter(instance):
    original = instance.isDefaultPackage
    instance.isDefaultPackage = original
    assert instance.isDefaultPackage == original
...
@given(instance=PrimitiveTypes_Core_IPackageFragment_strategy)
def test_primitivetypes_core_ipackagefragment_isReadOnly_setter(instance):
    original = instance.isReadOnly
    instance.isReadOnly = original
    assert instance.isReadOnly == original
...
@given(instance=PrimitiveTypes_Core_IPackageFragment_strategy)
def test_primitivetypes_core_ipackagefragment_elementName_setter(instance):
    original = instance.elementName
    instance.elementName = original
    assert instance.elementName == original

@given(instance=PrimitiveTypes_Core_ITypeParameter_strategy)
@settings(max_examples=50)
def test_primitivetypes_core_itypeparameter_instantiation(instance):
    assert isinstance(instance, PrimitiveTypes_Core_ITypeParameter)



@given(instance=PrimitiveTypes_Core_ITypeParameter_strategy)
def test_primitivetypes_core_itypeparameter_bounds_setter(instance):
...
@given(instance=PrimitiveTypes_Core_ITypeParameter_strategy)
def test_primitivetypes_core_itypeparameter_source_setter(instance):
    original = instance.source
    instance.source = original
    assert instance.source == original
...
@given(instance=PrimitiveTypes_Core_ITypeParameter_strategy)
def test_primitivetypes_core_itypeparameter_elementName_setter(instance):
    original = instance.elementName
    instance.elementName = original
    assert instance.elementName == original

@given(instance=PrimitiveTypes_Core_IJavaProject_strategy)
@settings(max_examples=50)
def test_primitivetypes_core_ijavaproject_instantiation(instance):
    assert isinstance(instance, PrimitiveTypes_Core_IJavaProject)



@given(instance=PrimitiveTypes_Core_IJavaProject_strategy)
def test_primitivetypes_core_ijavaproject_path_setter(instance):
    original = instance.path
    instance.path = original
    assert instance.path == original
...
@given(instance=PrimitiveTypes_Core_IJavaProject_strategy)
def test_primitivetypes_core_ijavaproject_isReadOnly_setter(instance):
    original = instance.isReadOnly
    instance.isReadOnly = original
    assert instance.isReadOnly == original
...
@given(instance=PrimitiveTypes_Core_IJavaProject_strategy)
def test_primitivetypes_core_ijavaproject_elementName_setter(instance):
    original = instance.elementName
    instance.elementName = original
    assert instance.elementName == original
...
@given(instance=PrimitiveTypes_Core_IClassFile_strategy)
@settings(max_examples=50)
def test_primitivetypes_core_iclassfile_instantiation(instance):
    assert isinstance(instance, PrimitiveTypes_Core_IClassFile)



@given(instance=PrimitiveTypes_Core_IClassFile_strategy)
def test_primitivetypes_core_iclassfile_isClass_setter(instance):
...
@given(instance=PrimitiveTypes_Core_IClassFile_strategy)
def test_primitivetypes_core_iclassfile_isInterface_setter(instance):
...
@given(instance=PrimitiveTypes_Core_ICompilationUnit_strategy)
@settings(max_examples=50)
def test_primitivetypes_core_icompilationunit_instantiation(instance):
    assert isinstance(instance, PrimitiveTypes_Core_ICompilationUnit)
