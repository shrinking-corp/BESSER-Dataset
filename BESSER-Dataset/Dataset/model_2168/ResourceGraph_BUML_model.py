...
# Classes
graph_ResourceGraphs = Class(name="graph_ResourceGraphs")
graph_ResourceGraph = Class(name="graph_ResourceGraph")
graph_ResourcePlot = Class(name="graph_ResourcePlot")
...
graph_ResourcePlot.attributes={graph_ResourcePlot_min, graph_ResourcePlot_fit, graph_ResourcePlot_name, graph_ResourcePlot_max, graph_ResourcePlot_rgb}
...
domain_model = DomainModel(
    name="graph",
    types={graph_ResourceGraphs, graph_ResourceGraph, graph_ResourcePlot, FitPolicy},
