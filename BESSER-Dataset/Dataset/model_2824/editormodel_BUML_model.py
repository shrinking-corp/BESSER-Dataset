...
editormodel_Diagram.attributes={editormodel_Diagram_snapToGeometryEnabled, editormodel_Diagram_gridEnabled}
...
editormodel_FlabotFileModel.attributes={editormodel_FlabotFileModel_id, editormodel_FlabotFileModel_name, editormodel_FlabotFileModel_provider, editormodel_FlabotFileModel_version}
...
domain_model = DomainModel(
    name="editormodel",
    types={editormodel_Diagram, NamedElementModel, editormodel_CoreModel, editormodel_Note, editormodel_VisualModel, editormodel_Folder, editormodel_FlabotFileModel, ExtensibleElement, editormodel_ConnectionVisualModel, NodeVisualModel, Adapter, editormodel_EObject, editormodel_Point, editormodel_Dimension, editormodel_Color, editormodel_Adapter, editormodel_ConnectionBendpoint, editormodel_EStringToEObjectMapEntry, editormodel_VisualDiagramJump, editormodel_NodeVisualModel, VisualModel},
    associations={coreModel5, diagrams6, importedFiles9, coreModel0, notes1, children3, folder4, firstRelativeDimension34, secondRelativeDimension36, folder11, openDiagrams13, children17, parent20, semanticModel22, location23, size25, diagram27, backgroundColor29, foregroundColor31, value59, sourceDiagram61, bendpoints39, source41, target42, sourceConnections44, targetConnections45, folders48, diagrams51, parent54, fileModel56, targetDiagram63, targetVisualNode66},
    generalizations={gen_editormodel_Diagram_NamedElementModel, gen_editormodel_FlabotFileModel_ExtensibleElement, gen_editormodel_ConnectionVisualModel_NodeVisualModel, gen_editormodel_VisualModel_Adapter, gen_editormodel_VisualDiagramJump_NodeVisualModel, gen_editormodel_NodeVisualModel_VisualModel},
    metadata=None
)
