...
class editormodel_ConnectionBendpoint:
    ...
    def __init__(self, weight: float, editormodel_ConnectionBendpoint: "editormodel_Dimension" = None, editormodel_ConnectionBendpoint37: "editormodel_Dimension" = None, editormodel_ConnectionBendpoint40: "editormodel_ConnectionVisualModel" = None):
        self.weight = weight
...
class editormodel_Dimension:
    ...
    def __init__(self, width: int, height: int, editormodel_Dimension35: "editormodel_ConnectionBendpoint" = None, editormodel_Dimension38: "editormodel_ConnectionBendpoint" = None, editormodel_Dimension: "editormodel_VisualModel" = None):
        self.width = width
        self.height = height
