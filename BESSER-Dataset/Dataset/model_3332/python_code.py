...
class model_MMethodDeclarationParameter(AbstractMTypeWithNameDeclaration):
    ...
    pass
class model_CDeclarationStatement(AbstractMTypeWithNameDeclaration, AbstractCStatement):
...
class model_MConstructorParameter(AbstractMTypeWithNameDeclaration):
    ...
    def __init__(self, final: bool, MConstructorParameter: "model_MConstructor" = None, parameters68: "model_MConstructor" = None):
        self.final = final
...
class model_AbstractModifiers(ABC):
    ...
    def __init__(self, synchronized: bool, visibility: str, final: bool):
...
class AbstractMResource:
    ...
    pass
class model_MCompilationUnit(AbstractMTypeContainer, AbstractMResource):
...
class model_AbstractMResource(ABC):
    ...
    def __init__(self, name: str, derived: bool, superOf: set["model_AbstractMResource"] = None, AbstractMResource11: "model_AbstractMResource" = None, derivedFrom: set["model_AbstractMResource"] = None, resources: "model_MPackage" = None, AbstractMResource: "model_MPackage" = None, AbstractMResource8: "model_AbstractMResource" = None):
        self.name = name
...
class model_AbstractMExternalType(ABC):
    ...
    def __init__(self, fullQualifiedName: str, externalTypes: "model_MRoot" = None, model_AbstractMExternalType: "model_MExternalTypeReference" = None, AbstractMExternalType: "model_MRoot" = None):
