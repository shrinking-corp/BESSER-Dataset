...
# Classes
model_AbstractMPackageContainer = Class(name="model_AbstractMPackageContainer", is_abstract=True)
model_MPackage = Class(name="model_MPackage")
model_MRoot = Class(name="model_MRoot")
AbstractMPackageContainer = Class(name="AbstractMPackageContainer")
model_AbstractMExternalType = Class(name="model_AbstractMExternalType", is_abstract=True)
model_AbstractMResource = Class(name="model_AbstractMResource", is_abstract=True)
model_MResource = Class(name="model_MResource")
AbstractMResource = Class(name="AbstractMResource")
model_AbstractMTypeContainer = Class(name="model_AbstractMTypeContainer", is_abstract=True)
model_AbstractMDeclaredType = Class(name="model_AbstractMDeclaredType", is_abstract=True)
model_MCompilationUnit = Class(name="model_MCompilationUnit")
AbstractMTypeContainer = Class(name="AbstractMTypeContainer")
model_AbstractMType = Class(name="model_AbstractMType", is_abstract=True)
model_AbstractMTypeReference = Class(name="model_AbstractMTypeReference", is_abstract=True)
model_MDeclaredTypeReference = Class(name="model_MDeclaredTypeReference")
AbstractMTypeReference = Class(name="AbstractMTypeReference")
model_MExternalTypeReference = Class(name="model_MExternalTypeReference")
model_MPrimitiveTypeReference = Class(name="model_MPrimitiveTypeReference")
model_AbstractModifiers = Class(name="model_AbstractModifiers", is_abstract=True)
model_AbstractMMethodLike = Class(name="model_AbstractMMethodLike", is_abstract=True)
AbstractModifiers = Class(name="AbstractModifiers")
model_AbstractCStatement = Class(name="model_AbstractCStatement", is_abstract=True)
model_AbstractMTypeWithNameDeclaration = Class(name="model_AbstractMTypeWithNameDeclaration", is_abstract=True)
model_AbstractMClass = Class(name="model_AbstractMClass", is_abstract=True)
AbstractMType = Class(name="AbstractMType")
model_MDeclaredClass = Class(name="model_MDeclaredClass")
AbstractMClass = Class(name="AbstractMClass")
AbstractMDeclaredType = Class(name="AbstractMDeclaredType")
model_AbstractMInterface = Class(name="model_AbstractMInterface", is_abstract=True)
model_MStaticClassFieldDeclaration = Class(name="model_MStaticClassFieldDeclaration")
model_MInstanceClassFieldDeclaration = Class(name="model_MInstanceClassFieldDeclaration")
model_MConstructor = Class(name="model_MConstructor")
model_AbstractMMethodImplementation = Class(name="model_AbstractMMethodImplementation", is_abstract=True)
model_MNativeMethodDeclaration = Class(name="model_MNativeMethodDeclaration")
AbstractMExternalType = Class(name="AbstractMExternalType")
model_MAbstractDeclaredClass = Class(name="model_MAbstractDeclaredClass")
MDeclaredClass = Class(name="MDeclaredClass")
model_MDeclaredInterface = Class(name="model_MDeclaredInterface")
AbstractMInterface = Class(name="AbstractMInterface")
model_MConstantInterfaceFieldDeclaration = Class(name="model_MConstantInterfaceFieldDeclaration")
model_MInterfaceMethodDeclaration = Class(name="model_MInterfaceMethodDeclaration")
model_MExternalInterface = Class(name="model_MExternalInterface")
model_AbstractMFieldDeclaration = Class(name="model_AbstractMFieldDeclaration", is_abstract=True)
AbstractMTypeWithNameDeclaration = Class(name="AbstractMTypeWithNameDeclaration")
model_AbstractCExpression = Class(name="model_AbstractCExpression", is_abstract=True)
model_AbstractMClassFieldDeclaration = Class(name="model_AbstractMClassFieldDeclaration", is_abstract=True)
...
model_AbstractMMethodDeclaration = Class(name="model_AbstractMMethodDeclaration", is_abstract=True)
model_MMethodDeclarationParameter = Class(name="model_MMethodDeclarationParameter")
model_MAbstractClassMethodDeclaration = Class(name="model_MAbstractClassMethodDeclaration")
model_MImplicitMethodDeclaration = Class(name="model_MImplicitMethodDeclaration")
model_MExternalClass = Class(name="model_MExternalClass")
model_MDirectMethodImplementation = Class(name="model_MDirectMethodImplementation")
model_AbstractMImplementableMethodDeclaration = Class(name="model_AbstractMImplementableMethodDeclaration", is_abstract=True)
model_MDeclaredMethodImplementation = Class(name="model_MDeclaredMethodImplementation")
...
model_MMethodImplementationParameter = Class(name="model_MMethodImplementationParameter")
...
model_MConstructorParameter = Class(name="model_MConstructorParameter")
model_CBlockStatement = Class(name="model_CBlockStatement")
AbstractCStatement = Class(name="AbstractCStatement")
model_CDeclarationStatement = Class(name="model_CDeclarationStatement")
model_CExpressionStatement = Class(name="model_CExpressionStatement")
model_CIfStatement = Class(name="model_CIfStatement")
model_CUnparsedStatement = Class(name="model_CUnparsedStatement")
model_CConditionalExpression = Class(name="model_CConditionalExpression")
AbstractCExpression = Class(name="AbstractCExpression")
model_CUnparsedExpression = Class(name="model_CUnparsedExpression")
...
model_AbstractMResource.attributes={model_AbstractMResource_derived, model_AbstractMResource_name}
...
model_AbstractMClassFieldDeclaration.attributes={model_AbstractMClassFieldDeclaration_visibility, model_AbstractMClassFieldDeclaration_final}
...
domain_model = DomainModel(
    name="model",
    types={model_AbstractMPackageContainer, model_MPackage, model_MRoot, AbstractMPackageContainer, model_AbstractMExternalType, model_AbstractMResource, model_MResource, AbstractMResource, model_AbstractMTypeContainer, model_AbstractMDeclaredType, model_MCompilationUnit, AbstractMTypeContainer, model_AbstractMType, model_AbstractMTypeReference, model_MDeclaredTypeReference, AbstractMTypeReference, model_MExternalTypeReference, model_MPrimitiveTypeReference, model_AbstractModifiers, model_AbstractMMethodLike, AbstractModifiers, model_AbstractCStatement, model_AbstractMTypeWithNameDeclaration, model_AbstractMClass, AbstractMType, model_MDeclaredClass, AbstractMClass, AbstractMDeclaredType, model_AbstractMInterface, model_MStaticClassFieldDeclaration, model_MInstanceClassFieldDeclaration, model_MConstructor, model_AbstractMMethodImplementation, model_MNativeMethodDeclaration, AbstractMExternalType, model_MAbstractDeclaredClass, MDeclaredClass, model_MDeclaredInterface, AbstractMInterface, model_MConstantInterfaceFieldDeclaration, model_MInterfaceMethodDeclaration, model_MExternalInterface, model_AbstractMFieldDeclaration, AbstractMTypeWithNameDeclaration, model_AbstractCExpression, model_AbstractMClassFieldDeclaration, AbstractMFieldDeclaration, AbstractMClassFieldDeclaration, model_AbstractMMethodDeclaration, model_MMethodDeclarationParameter, model_MAbstractClassMethodDeclaration, model_MImplicitMethodDeclaration, model_MExternalClass, model_MDirectMethodImplementation, model_AbstractMImplementableMethodDeclaration, model_MDeclaredMethodImplementation, AbstractMImplementableMethodDeclaration, AbstractMMethodLike, model_MMethodImplementationParameter, AbstractMMethodImplementation, AbstractMMethodDeclaration, model_MConstructorParameter, model_CBlockStatement, AbstractCStatement, model_CDeclarationStatement, model_CExpressionStatement, model_CIfStatement, model_CUnparsedStatement, model_CConditionalExpression, AbstractCExpression, model_CUnparsedExpression, MPrimitiveTypes, MVisibility},
    associations={packages0, externalTypes1, packageContainer2, resources3, derivedFrom7, superOf10, types12, imports13, typeContainer14, root15, type16, type17, package4, statement18, type19, extends20, implements21, staticFields23, instanceFields24, constructors26, implementedMethods28, nativeMethods30, extends34, constants36, methods38, initialValue40, owner41, owner42, owner44, parameters45, methodDeclaration46, abstractMethods32, owner47, implementations48, owner50, owner51, owner53, owner55, parameters57, declaration58, declaration59, methodImplementation61, owner64, parameters66, constructor67, statements70, value72, expression74, condition76, trueStatement78, falseStatement81, condition84, trueExpression86, falseExpression89},
    generalizations={gen_model_MRoot_AbstractMPackageContainer, gen_model_MPackage_AbstractMPackageContainer, gen_model_MResource_AbstractMResource, gen_model_MCompilationUnit_AbstractMResource, gen_model_MCompilationUnit_AbstractMTypeContainer, gen_model_AbstractMDeclaredType_AbstractMTypeContainer, gen_model_MDeclaredTypeReference_AbstractMTypeReference, gen_model_MExternalTypeReference_AbstractMTypeReference, gen_model_MPrimitiveTypeReference_AbstractMTypeReference, gen_model_AbstractMMethodLike_AbstractModifiers, gen_model_AbstractMClass_AbstractMType, gen_model_MDeclaredClass_AbstractMClass, gen_model_MDeclaredClass_AbstractMDeclaredType, gen_model_MExternalClass_AbstractMExternalType, gen_model_MAbstractDeclaredClass_MDeclaredClass, gen_model_AbstractMInterface_AbstractMType, gen_model_MDeclaredInterface_AbstractMInterface, gen_model_MDeclaredInterface_AbstractMDeclaredType, gen_model_MExternalInterface_AbstractMInterface, gen_model_MExternalInterface_AbstractMExternalType, gen_model_AbstractMFieldDeclaration_AbstractMTypeWithNameDeclaration, gen_model_AbstractMClassFieldDeclaration_AbstractMFieldDeclaration, gen_model_MStaticClassFieldDeclaration_AbstractMClassFieldDeclaration, gen_model_MInstanceClassFieldDeclaration_AbstractMClassFieldDeclaration, gen_model_MConstantInterfaceFieldDeclaration_AbstractMFieldDeclaration, gen_model_AbstractMMethodDeclaration_AbstractMTypeWithNameDeclaration, gen_model_MMethodDeclarationParameter_AbstractMTypeWithNameDeclaration, gen_model_MExternalClass_AbstractMClass, gen_model_AbstractMImplementableMethodDeclaration_AbstractMMethodDeclaration, gen_model_MAbstractClassMethodDeclaration_AbstractMImplementableMethodDeclaration, gen_model_MInterfaceMethodDeclaration_AbstractMImplementableMethodDeclaration, gen_model_MNativeMethodDeclaration_AbstractMMethodDeclaration, gen_model_AbstractMMethodImplementation_AbstractMMethodLike, gen_model_MDeclaredMethodImplementation_AbstractMMethodImplementation, gen_model_MDirectMethodImplementation_AbstractMMethodImplementation, gen_model_MConstructor_AbstractMMethodLike, gen_model_MImplicitMethodDeclaration_AbstractMMethodDeclaration, gen_model_MConstructorParameter_AbstractMTypeWithNameDeclaration, gen_model_CBlockStatement_AbstractCStatement, gen_model_CDeclarationStatement_AbstractCStatement, gen_model_CDeclarationStatement_AbstractMTypeWithNameDeclaration, gen_model_CExpressionStatement_AbstractCStatement, gen_model_CIfStatement_AbstractCStatement, gen_model_CUnparsedStatement_AbstractCStatement, gen_model_CConditionalExpression_AbstractCExpression, gen_model_CUnparsedExpression_AbstractCExpression},
    metadata=None
)
