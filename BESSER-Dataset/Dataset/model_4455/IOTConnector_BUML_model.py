...
# Classes
iOTConnector_Webserver = Class(name="iOTConnector_Webserver")
iOTConnector_Program = Class(name="iOTConnector_Program")
iOTConnector_Function = Class(name="iOTConnector_Function")
iOTConnector_Wifi = Class(name="iOTConnector_Wifi")
iOTConnector_Config = Class(name="iOTConnector_Config")
iOTConnector_Board = Class(name="iOTConnector_Board")
iOTConnector_Sensor = Class(name="iOTConnector_Sensor")
iOTConnector_SensorConfig = Class(name="iOTConnector_SensorConfig")
iOTConnector_Output = Class(name="iOTConnector_Output")
iOTConnector_Send = Class(name="iOTConnector_Send")
iOTConnector_ReadingName = Class(name="iOTConnector_ReadingName")
iOTConnector_Sample = Class(name="iOTConnector_Sample")
Function = Class(name="Function")
iOTConnector_SampleAction = Class(name="iOTConnector_SampleAction")
iOTConnector_ReadingNameWithConfigScope = Class(name="iOTConnector_ReadingNameWithConfigScope")
iOTConnector_RelationalOperator = Class(name="iOTConnector_RelationalOperator")
iOTConnector_TimeUnit = Class(name="iOTConnector_TimeUnit")
iOTConnector_Filter = Class(name="iOTConnector_Filter")
iOTConnector_FilterAction = Class(name="iOTConnector_FilterAction")
iOTConnector_FilterType = Class(name="iOTConnector_FilterType")
iOTConnector_FilterExp = Class(name="iOTConnector_FilterExp")
iOTConnector_Plus = Class(name="iOTConnector_Plus")
Expression = Class(name="Expression")
iOTConnector_BitwiseOperator = Class(name="iOTConnector_BitwiseOperator")
iOTConnector_Process = Class(name="iOTConnector_Process")
iOTConnector_ProcessAction = Class(name="iOTConnector_ProcessAction")
iOTConnector_Expression = Class(name="iOTConnector_Expression")
iOTConnector_SendAction = Class(name="iOTConnector_SendAction")
iOTConnector_Minus = Class(name="iOTConnector_Minus")
iOTConnector_Mult = Class(name="iOTConnector_Mult")
iOTConnector_Div = Class(name="iOTConnector_Div")
iOTConnector_Num = Class(name="iOTConnector_Num")
iOTConnector_Var = Class(name="iOTConnector_Var")
...
domain_model = DomainModel(
    name="iOTConnector",
    types={iOTConnector_Webserver, iOTConnector_Program, iOTConnector_Function, iOTConnector_Wifi, iOTConnector_Config, iOTConnector_Board, iOTConnector_Sensor, iOTConnector_SensorConfig, iOTConnector_Output, iOTConnector_Send, iOTConnector_ReadingName, iOTConnector_Sample, Function, iOTConnector_SampleAction, iOTConnector_ReadingNameWithConfigScope, iOTConnector_RelationalOperator, iOTConnector_TimeUnit, iOTConnector_Filter, iOTConnector_FilterAction, iOTConnector_FilterType, iOTConnector_FilterExp, iOTConnector_Plus, Expression, iOTConnector_BitwiseOperator, iOTConnector_Process, iOTConnector_ProcessAction, iOTConnector_Expression, iOTConnector_SendAction, iOTConnector_Minus, iOTConnector_Mult, iOTConnector_Div, iOTConnector_Num, iOTConnector_Var},
    associations={functions16, webserver0, wifis1, configs3, boards5, sensors7, sensorConfigs9, configName11, output14, readingName40, send18, readingNames20, sampleActions22, readingName23, readingNameToCompare26, relationalOperator28, timeUnit30, filterActions32, readingName33, filterType36, filterExp38, relationalOperator43, bitwiseOperator46, filterExp49, processActions51, readingName52, exp55, sendActions57, readingName59, relationalOperator62, name65, left68, right70, left73, right75, left78, right80, left83, right85, readingName88},
    generalizations={gen_iOTConnector_Sample_Function, gen_iOTConnector_Filter_Function, gen_iOTConnector_Plus_Expression, gen_iOTConnector_Process_Function, gen_iOTConnector_Minus_Expression, gen_iOTConnector_Mult_Expression, gen_iOTConnector_Div_Expression, gen_iOTConnector_Num_Expression, gen_iOTConnector_Var_Expression},
    metadata=None
)
