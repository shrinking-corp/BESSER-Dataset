...
# Classes
testaccessors_EAcc = Class(name="testaccessors_EAcc")
...
testaccessors_EAcc_is_: Property = Property(name="is_", type=IntegerType)
testaccessors_EAcc.attributes={testaccessors_EAcc_b, testaccessors_EAcc_i, testaccessors_EAcc_is_, testaccessors_EAcc_bs}
