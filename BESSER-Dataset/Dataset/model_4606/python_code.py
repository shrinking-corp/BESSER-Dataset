...
class gmfgraph_SVGProperty:
    ...
    def __init__(self, setter: str, callSuper: bool, query: str, attribute: str, type: str, getter: str, gmfgraph_SVGProperty: "gmfgraph_SVGFigure" = None):
        self.setter = setter
...
class gmfgraph_Shape(RealFigure):
    ...
    def __init__(self, fill: bool, lineWidth: int, lineKind: str, xorFill: bool, xorOutline: bool, outline: bool, gmfgraph_Shape: set["gmfgraph_Figure"] = None):
        self.fill = fill
...
class gmfgraph_Point:
    ...
    def __init__(self, x: int, y: int, gmfgraph_Point60: "gmfgraph_Figure" = None, gmfgraph_Point: "gmfgraph_Figure" = None, gmfgraph_Point77: "gmfgraph_Polyline" = None, gmfgraph_Point115: "gmfgraph_XYLayoutData" = None):
        self.x = x
        self.y = y
...
class gmfgraph_FigureGallery(Identity):
    ...
    def __init__(self, implementationBundle: str, gmfgraph_FigureGallery: "gmfgraph_Canvas" = None, gmfgraph_FigureGallery10: set["gmfgraph_RealFigure"] = None, gmfgraph_FigureGallery14: set["gmfgraph_Border"] = None, gmfgraph_FigureGallery16: set["gmfgraph_Layout"] = None, gmfgraph_FigureGallery12: set["gmfgraph_FigureDescriptor"] = None):
