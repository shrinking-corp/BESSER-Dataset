...
# Classes
model_Select = Class(name="model_Select")
model_Column = Class(name="model_Column")
model_From = Class(name="model_From")
model_Where = Class(name="model_Where")
model_ComparisonOperator = Class(name="model_ComparisonOperator", is_abstract=True)
model_Equals = Class(name="model_Equals")
ComparisonOperator = Class(name="ComparisonOperator")
model_GreaterThan = Class(name="model_GreaterThan")
model_LessThan = Class(name="model_LessThan")
model_NotEquals = Class(name="model_NotEquals")
model_And = Class(name="model_And")
BooleanOperation = Class(name="BooleanOperation")
model_Or = Class(name="model_Or")
model_Comparison = Class(name="model_Comparison")
Condition = Class(name="Condition")
model_Existence = Class(name="model_Existence", is_abstract=True)
model_Union = Class(name="model_Union")
model_ColumnAlias = Class(name="model_ColumnAlias")
model_Table = Class(name="model_Table")
model_TableAlias = Class(name="model_TableAlias")
model_Condition = Class(name="model_Condition", is_abstract=True)
model_BooleanOperation = Class(name="model_BooleanOperation", is_abstract=True)
model_Exists = Class(name="model_Exists")
Existence = Class(name="Existence")
model_NotExists = Class(name="model_NotExists")
...
domain_model = DomainModel(
    name="model",
    types={model_Select, model_Column, model_From, model_Where, model_ComparisonOperator, model_Equals, ComparisonOperator, model_GreaterThan, model_LessThan, model_NotEquals, model_And, BooleanOperation, model_Or, model_Comparison, Condition, model_Existence, model_Union, model_ColumnAlias, model_Table, model_TableAlias, model_Condition, model_BooleanOperation, model_Exists, Existence, model_NotExists},
    associations={column0, from_1, where3, select17, booleanoperation20, comparisonoperator23, union5, columnalias7, table9, tablealias11, condition13, condition15, select24},
