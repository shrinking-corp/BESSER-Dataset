...
Customer.attributes={Customer_id, Customer_phoneno, Customer_mailid, Customer_name, Customer_address}
...
Order.attributes={Order_list, Order_quantity, Order_item}
...
Transaction.attributes={Transaction_debitcard, Transaction_creditcard, Transaction_cashondelivery}
...
CREATES_THE_WEBSITE_WEB_DEVELOPER: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="cREATES_THE_WEBSITE1", type=ASK_QUERIES_UseCase, multiplicity=Multiplicity(0, 1))
    }
)
...
domain_model = DomainModel(
    name="_7c199d8b_c50d_4a8f_9900_6fa18ee8b780",
    types={SELECTS_THE_MODE_OF_PAYMENT_UseCase, PAYS_THE_BILL_UseCase, DELIVERS_THE_PRODUCT_UseCase, SUPPORT_AND_FEEDBACK_UseCase, CHATBOT_Actor, ADMINISTRATOR_Actor, MAINTAINS_THE_PRODUCTS_SERVICES_UseCase, Customer, Order, Product, Warehouse, Transaction, Shipment, Customercare, Feedback, Cancelorder, CUSTOMER_Actor, VISITS_THE_WEBSITE_UseCase, ASK_QUERIES_UseCase, SELECTS_THE_ITEMS_SERVICE_UseCase, ADDS_ITEMS_SERVICE_TO_CART_UseCase},
