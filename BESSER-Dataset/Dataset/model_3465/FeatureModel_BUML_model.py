...
# Classes
featureModel_ImplyConstraint = Class(name="featureModel_ImplyConstraint")
Constraint = Class(name="Constraint")
featureModel_ExcludeConstraint = Class(name="featureModel_ExcludeConstraint")
featureModel_Proposition = Class(name="featureModel_Proposition")
featureModel_FeatureModel = Class(name="featureModel_FeatureModel")
featureModel_Feature = Class(name="featureModel_Feature")
featureModel_Constraints = Class(name="featureModel_Constraints")
featureModel_PropFormula = Class(name="featureModel_PropFormula")
...
domain_model = DomainModel(
    name="featureModel",
    types={featureModel_ImplyConstraint, Constraint, featureModel_ExcludeConstraint, featureModel_Proposition, featureModel_FeatureModel, featureModel_Feature, featureModel_Constraints, featureModel_PropFormula, Group, featureModel_Group, featureModel_Constraint},
    associations={firstProp9, rest11, rootFeature0, constraints1, propFormula3, children5, constraints7},
    generalizations={gen_featureModel_ImplyConstraint_Constraint, gen_featureModel_ExcludeConstraint_Constraint, gen_featureModel_Feature_Group},
    metadata=None
)
