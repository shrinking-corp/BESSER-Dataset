...
# Classes
website_WebGenModel = Class(name="website_WebGenModel")
website_WebsiteProperties = Class(name="website_WebsiteProperties")
website_Classifier = Class(name="website_Classifier", is_abstract=True)
website_Service = Class(name="website_Service")
website_Page = Class(name="website_Page")
website_Menu = Class(name="website_Menu", is_abstract=True)
website_EntityOrView = Class(name="website_EntityOrView", is_abstract=True)
website_ImageManipulation = Class(name="website_ImageManipulation")
website_Authentication = Class(name="website_Authentication", is_abstract=True)
website_NamedDisplayElement = Class(name="website_NamedDisplayElement", is_abstract=True)
NamedElement = Class(name="NamedElement")
NamedDisplayElement = Class(name="NamedDisplayElement")
website_DataType = Class(name="website_DataType")
Classifier = Class(name="Classifier")
website_Attribute = Class(name="website_Attribute", is_abstract=True)
website_LocalAuthenticationSystem = Class(name="website_LocalAuthenticationSystem")
Authentication = Class(name="Authentication")
website_RegistrationUnit = Class(name="website_RegistrationUnit")
website_LoginUnit = Class(name="website_LoginUnit")
website_ForgottenPasswordUnit = Class(name="website_ForgottenPasswordUnit")
website_CasAuthentication = Class(name="website_CasAuthentication")
website_NamedElement = Class(name="website_NamedElement", is_abstract=True)
website_EnumerationType = Class(name="website_EnumerationType")
DataType = Class(name="DataType")
website_EnumerationLiteral = Class(name="website_EnumerationLiteral")
website_Feature = Class(name="website_Feature", is_abstract=True)
website_ModelLabel = Class(name="website_ModelLabel")
website_EncapsulatedAssociation = Class(name="website_EncapsulatedAssociation")
website_Association = Class(name="website_Association", is_abstract=True)
Feature = Class(name="Feature")
Label = Class(name="Label")
website_Expression = Class(name="website_Expression")
website_EntityAttribute = Class(name="website_EntityAttribute", is_abstract=True)
website_Label = Class(name="website_Label", is_abstract=True)
website_ModelLabelFeature = Class(name="website_ModelLabelFeature", is_abstract=True)
website_ModelLabelAttribute = Class(name="website_ModelLabelAttribute")
ModelLabelFeature = Class(name="ModelLabelFeature")
website_ModelLabelAssociation = Class(name="website_ModelLabelAssociation")
website_EntityAssociation = Class(name="website_EntityAssociation", is_abstract=True)
website_Entity = Class(name="website_Entity")
EntityOrView = Class(name="EntityOrView")
website_EntityFeature = Class(name="website_EntityFeature", is_abstract=True)
website_FileAttribute = Class(name="website_FileAttribute")
ResourceAttribute = Class(name="ResourceAttribute")
website_ImageAttribute = Class(name="website_ImageAttribute")
website_LocationAttribute = Class(name="website_LocationAttribute")
Association = Class(name="Association")
website_AssociationKey = Class(name="website_AssociationKey")
EntityFeature = Class(name="EntityFeature")
Attribute = Class(name="Attribute")
website_DataTypeAttribute = Class(name="website_DataTypeAttribute")
EntityAttribute = Class(name="EntityAttribute")
website_DateAttribute = Class(name="website_DateAttribute")
website_UrlAttribute = Class(name="website_UrlAttribute")
website_ResourceAttribute = Class(name="website_ResourceAttribute", is_abstract=True)
website_PathElement = Class(name="website_PathElement", is_abstract=True)
website_StaticPathElement = Class(name="website_StaticPathElement")
PathElement = Class(name="PathElement")
website_DatePathElement = Class(name="website_DatePathElement")
website_ViewFeature = Class(name="website_ViewFeature", is_abstract=True)
website_EncapsulatedFeature = Class(name="website_EncapsulatedFeature")
ViewFeature = Class(name="ViewFeature")
website_EncapsulatedAttribute = Class(name="website_EncapsulatedAttribute")
EncapsulatedFeature = Class(name="EncapsulatedFeature")
website_AssociationWithoutContainment = Class(name="website_AssociationWithoutContainment")
EntityAssociation = Class(name="EntityAssociation")
website_AssociationWithContainment = Class(name="website_AssociationWithContainment")
website_View = Class(name="website_View")
website_Selection = Class(name="website_Selection")
website_BusinessOperation = Class(name="website_BusinessOperation")
website_SelectionParameter = Class(name="website_SelectionParameter")
website_ViewAssociation = Class(name="website_ViewAssociation")
website_PageLink = Class(name="website_PageLink")
website_Predicate = Class(name="website_Predicate")
website_Order = Class(name="website_Order")
website_ImageFilter = Class(name="website_ImageFilter", is_abstract=True)
website_ThumbnailFilter = Class(name="website_ThumbnailFilter")
ImageFilter = Class(name="ImageFilter")
UnitContainer = Class(name="UnitContainer")
website_FilterParameter = Class(name="website_FilterParameter")
website_QueryParameter = Class(name="website_QueryParameter")
website_MenuEntry = Class(name="website_MenuEntry", is_abstract=True)
website_StaticMenu = Class(name="website_StaticMenu")
Menu = Class(name="Menu")
website_ActionMenuEntry = Class(name="website_ActionMenuEntry")
MenuEntry = Class(name="MenuEntry")
website_ContentUnit = Class(name="website_ContentUnit", is_abstract=True)
website_Query = Class(name="website_Query")
website_EditStaticTextMenuEntry = Class(name="website_EditStaticTextMenuEntry")
website_DynamicMenu = Class(name="website_DynamicMenu")
website_MenuFeature = Class(name="website_MenuFeature")
website_Filter = Class(name="website_Filter")
website_UnitField = Class(name="website_UnitField", is_abstract=True)
website_UnitSupportAction = Class(name="website_UnitSupportAction")
website_UnitContainer = Class(name="website_UnitContainer", is_abstract=True)
website_StaticUnit = Class(name="website_StaticUnit")
ContentUnit = Class(name="ContentUnit")
website_CreateSitemapUnit = Class(name="website_CreateSitemapUnit")
website_DynamicUnit = Class(name="website_DynamicUnit", is_abstract=True)
website_UnitAssociation = Class(name="website_UnitAssociation")
AssociationReference = Class(name="AssociationReference")
website_UnitFeature = Class(name="website_UnitFeature", is_abstract=True)
UnitField = Class(name="UnitField")
InlineActionContainer = Class(name="InlineActionContainer")
website_UnitElement = Class(name="website_UnitElement")
UnitFeature = Class(name="UnitFeature")
website_CaptchaField = Class(name="website_CaptchaField")
website_SelectableUnit = Class(name="website_SelectableUnit", is_abstract=True)
website_SingletonUnit = Class(name="website_SingletonUnit", is_abstract=True)
website_CollectionUnit = Class(name="website_CollectionUnit", is_abstract=True)
SelectableUnit = Class(name="SelectableUnit")
website_AssociationReference = Class(name="website_AssociationReference", is_abstract=True)
website_ChildPath = Class(name="website_ChildPath", is_abstract=True)
website_InterfaceField = Class(name="website_InterfaceField", is_abstract=True)
website_DataTypeField = Class(name="website_DataTypeField")
InterfaceField = Class(name="InterfaceField")
website_DateField = Class(name="website_DateField")
website_CreateUnit = Class(name="website_CreateUnit")
EditUnit = Class(name="EditUnit")
website_CreateUpdateUnit = Class(name="website_CreateUpdateUnit")
website_UpdateUnit = Class(name="website_UpdateUnit")
website_EditUnit = Class(name="website_EditUnit", is_abstract=True)
DynamicUnit = Class(name="DynamicUnit")
SingletonUnit = Class(name="SingletonUnit")
website_ControlUnit = Class(name="website_ControlUnit", is_abstract=True)
website_SearchUnit = Class(name="website_SearchUnit")
ControlUnit = Class(name="ControlUnit")
website_ImageUnit = Class(name="website_ImageUnit", is_abstract=True)
website_MapUnit = Class(name="website_MapUnit")
website_DataUnit = Class(name="website_DataUnit", is_abstract=True)
website_DetailsUnit = Class(name="website_DetailsUnit")
DataUnit = Class(name="DataUnit")
website_IndexUnit = Class(name="website_IndexUnit")
CollectionUnit = Class(name="CollectionUnit")
website_ChildPathAssociation = Class(name="website_ChildPathAssociation")
website_FeaturePath = Class(name="website_FeaturePath", is_abstract=True)
website_FeaturePathAttribute = Class(name="website_FeaturePathAttribute")
FeaturePath = Class(name="FeaturePath")
website_FeaturePathAssociation = Class(name="website_FeaturePathAssociation")
website_ChildPathAttribute = Class(name="website_ChildPathAttribute")
ChildPath = Class(name="ChildPath")
website_SelectAction = Class(name="website_SelectAction")
InlineAction = Class(name="InlineAction")
website_DeleteAction = Class(name="website_DeleteAction")
website_ImageIndexUnit = Class(name="website_ImageIndexUnit")
ImageUnit = Class(name="ImageUnit")
website_SliderUnit = Class(name="website_SliderUnit")
website_GalleryUnit = Class(name="website_GalleryUnit")
website_AuthenticationUnit = Class(name="website_AuthenticationUnit", is_abstract=True)
AuthenticationUnit = Class(name="AuthenticationUnit")
website_InlineActionContainer = Class(name="website_InlineActionContainer", is_abstract=True)
website_InlineAction = Class(name="website_InlineAction", is_abstract=True)
website_ParameterReference = Class(name="website_ParameterReference")
website_FeatureSupportAction = Class(name="website_FeatureSupportAction")
website_ModelReference = Class(name="website_ModelReference")
Path = Class(name="Path")
website_FeatureReference = Class(name="website_FeatureReference")
website_RouteParameterReference = Class(name="website_RouteParameterReference")
website_CurrentUserReference = Class(name="website_CurrentUserReference")
...
website_WebsiteProperties.attributes={website_WebsiteProperties_projectName, website_WebsiteProperties_ormTechnology, website_WebsiteProperties_webmasterEmail, website_WebsiteProperties_inputTechnology, website_WebsiteProperties_captchaSecretKey, website_WebsiteProperties_databasePort, website_WebsiteProperties_databaseHost, website_WebsiteProperties_databasePrefix, website_WebsiteProperties_frameworkTechnology, website_WebsiteProperties_defaultDateFormat, website_WebsiteProperties_rewriteURLs, website_WebsiteProperties_timestampCreation, website_WebsiteProperties_siteTemplate, website_WebsiteProperties_developmentVersion, website_WebsiteProperties_databaseName, website_WebsiteProperties_copyrightText, website_WebsiteProperties_captchaSiteKey, website_WebsiteProperties_staticUnitsEditable, website_WebsiteProperties_responsiveTopMenu, website_WebsiteProperties_metaDescription, website_WebsiteProperties_topNavigationId, website_WebsiteProperties_defaultMaximumUploadSize, website_WebsiteProperties_textEditorURL, website_WebsiteProperties_defaultDateTimeFormat, website_WebsiteProperties_databaseUsername, website_WebsiteProperties_testProjectName, website_WebsiteProperties_timestampUpdates, website_WebsiteProperties_databaseTechnology, website_WebsiteProperties_databasePassword, website_WebsiteProperties_baseURL, website_WebsiteProperties_ajaxTechnology, website_WebsiteProperties_defaultTimeFormat, website_WebsiteProperties_siteTitle}
...
website_Page.attributes={website_Page_topMenuOption, website_Page_uriElement, website_Page_navigationLabel, website_Page_styleClass, website_Page_authenticated, website_Page_topMenuRank}
...
website_Menu.attributes={website_Menu_layoutClass, website_Menu_captionClass, website_Menu_omitCaption, website_Menu_styleClass}
...
website_EntityOrView.attributes={website_EntityOrView_implementsUserInterface, website_EntityOrView_autoKeyPersistentType, website_EntityOrView_autoKeyName, website_EntityOrView_singletonName, website_EntityOrView_autoKeyGenerationStrategy, website_EntityOrView_pluralisedName, website_EntityOrView_tableName, website_EntityOrView_serializationExcludeAll}
...
website_DataType.attributes={website_DataType_ormType, website_DataType_persistentType, website_DataType_interfaceType, website_DataType_validationPattern, website_DataType_placeholder}
...
website_Attribute.attributes={website_Attribute_inputClass, website_Attribute_validationPattern, website_Attribute_placeholder}
...
website_LocalAuthenticationSystem.attributes={website_LocalAuthenticationSystem_allowSelfRegistration, website_LocalAuthenticationSystem_authenticationKey, website_LocalAuthenticationSystem_trackLoginAttempts, website_LocalAuthenticationSystem_useCaptcha, website_LocalAuthenticationSystem_allowRememberMe, website_LocalAuthenticationSystem_useEmailActivation, website_LocalAuthenticationSystem_sendWelcomeEmail}
...
website_Feature.attributes={website_Feature_title, website_Feature_collectionAllowAdd, website_Feature_encodeUriKey, website_Feature_footerClass, website_Feature_nullDisplayValue, website_Feature_serializationExpose, website_Feature_collectionAllowRemove, website_Feature_headerClass, website_Feature_serializationGroups, website_Feature_displayClass}
...
website_EncapsulatedAssociation.attributes={website_EncapsulatedAssociation_isSourceAssociation, website_EncapsulatedAssociation_cardinality, website_EncapsulatedAssociation_name}
...
website_Association.attributes={website_Association_inputClass, website_Association_pseudo, website_Association_serializationMaxDepth}
...
website_EntityAttribute.attributes={website_EntityAttribute_interfaceType, website_EntityAttribute_containerUnique, website_EntityAttribute_primaryKey, website_EntityAttribute_ormType, website_EntityAttribute_persistentType}
...
website_EntityAssociation.attributes={website_EntityAssociation_targetDisplayLabel, website_EntityAssociation_targetFeatureName, website_EntityAssociation_targetHeaderClass, website_EntityAssociation_targetPrimaryKey, website_EntityAssociation_targetFooterClass, website_EntityAssociation_pivotTableName, website_EntityAssociation_targetDisplayClass, website_EntityAssociation_targetInputClass, website_EntityAssociation_bidirectional}
...
website_EntityFeature.attributes={website_EntityFeature_booleanIsHasChoice, website_EntityFeature_ordered, website_EntityFeature_unique, website_EntityFeature_pluralisedName, website_EntityFeature_singletonName, website_EntityFeature_cardinality, website_EntityFeature_columnName}
...
website_DataTypeAttribute.attributes={website_DataTypeAttribute_obfuscateFormFields, website_DataTypeAttribute_encrypt, website_DataTypeAttribute_caseInsensitive}
...
website_DateAttribute.attributes={website_DateAttribute_details, website_DateAttribute_format}
...
website_ResourceAttribute.attributes={website_ResourceAttribute_validUploadExtensions, website_ResourceAttribute_uploadsWithinWebsite, website_ResourceAttribute_maximumUploadSize, website_ResourceAttribute_validUploadMimeTypes}
...
website_EncapsulatedFeature.attributes={website_EncapsulatedFeature_alias, website_EncapsulatedFeature_columnName, website_EncapsulatedFeature_displayLabel}
...
website_Selection.attributes={website_Selection_limit, website_Selection_selected, website_Selection_distinct}
...
website_SelectionParameter.attributes={website_SelectionParameter_optional, website_SelectionParameter_defaultValue}
...
website_ThumbnailFilter.attributes={website_ThumbnailFilter_width, website_ThumbnailFilter_height}
...
website_ContentUnit.attributes={website_ContentUnit_purposeSummary, website_ContentUnit_uriElement, website_ContentUnit_omitCaption, website_ContentUnit_alternative, website_ContentUnit_requiresRole, website_ContentUnit_createDefaultUriElement, website_ContentUnit_captionClass}
...
website_UnitField.attributes={website_UnitField_collectionAllowRemove, website_UnitField_dateFormat, website_UnitField_title, website_UnitField_collectionDisplayOption, website_UnitField_maximumDisplaySize, website_UnitField_collectionAllowAdd}
...
website_UnitSupportAction.attributes={website_UnitSupportAction_disable, website_UnitSupportAction_confirmMessage}
...
website_StaticUnit.attributes={website_StaticUnit_content, website_StaticUnit_contentClass, website_StaticUnit_styleClass}
...
website_DynamicUnit.attributes={website_DynamicUnit_headerClass, website_DynamicUnit_footer, website_DynamicUnit_controlClass, website_DynamicUnit_header, website_DynamicUnit_footerClass, website_DynamicUnit_errorClass}
...
website_UnitFeature.attributes={website_UnitFeature_headerClass, website_UnitFeature_displayClass, website_UnitFeature_footer, website_UnitFeature_inputClass, website_UnitFeature_required, website_UnitFeature_footerClass, website_UnitFeature_nullDisplayValue, website_UnitFeature_autofocus, website_UnitFeature_displayLabel, website_UnitFeature_onlyDisplayWhenNotEmpty}
...
website_UnitElement.attributes={website_UnitElement_name, website_UnitElement_validationPattern, website_UnitElement_obfuscateFormFields, website_UnitElement_placeholder}
...
website_CollectionUnit.attributes={website_CollectionUnit_firstPageLabel, website_CollectionUnit_nextNpages, website_CollectionUnit_previousNpages, website_CollectionUnit_previousPageLabel, website_CollectionUnit_lastPageLabel, website_CollectionUnit_emptyMessage, website_CollectionUnit_nextPageLabel, website_CollectionUnit_useDisabledPageLinks, website_CollectionUnit_defaultPaginationSize, website_CollectionUnit_useFirstLastPageLinks}
...
website_InterfaceField.attributes={website_InterfaceField_inputClass, website_InterfaceField_required, website_InterfaceField_defaultValue, website_InterfaceField_validationPattern, website_InterfaceField_placeholder}
...
website_DataTypeField.attributes={website_DataTypeField_interfaceType, website_DataTypeField_obfuscateFormFields, website_DataTypeField_encrypt}
...
website_DateField.attributes={website_DateField_format, website_DateField_details}
...
website_CreateUpdateUnit.attributes={website_CreateUpdateUnit_clearLabel, website_CreateUpdateUnit_createUriElement, website_CreateUpdateUnit_styleClass}
...
website_EditUnit.attributes={website_EditUnit_cancelLabel, website_EditUnit_customiseValues, website_EditUnit_contentClass, website_EditUnit_confirmLabel}
...
website_ControlUnit.attributes={website_ControlUnit_contentClass, website_ControlUnit_cancelLabel, website_ControlUnit_submitLabel}
...
website_ImageUnit.attributes={website_ImageUnit_transitionTime, website_ImageUnit_showTime, website_ImageUnit_missingImagePath}
...
website_MapUnit.attributes={website_MapUnit_styleClass, website_MapUnit_readOnly, website_MapUnit_defaultZoomLevel}
...
website_IndexUnit.attributes={website_IndexUnit_rowClasses, website_IndexUnit_displayOption, website_IndexUnit_styleClass, website_IndexUnit_omitColumnLabels, website_IndexUnit_contentClass}
...
website_DeleteAction.attributes={website_DeleteAction_uriElement, website_DeleteAction_confirmMessage}
...
website_GalleryUnit.attributes={website_GalleryUnit_contentClass, website_GalleryUnit_styleClass}
...
website_InlineAction.attributes={website_InlineAction_requiresRole, website_InlineAction_headerClass, website_InlineAction_footerClass, website_InlineAction_footer, website_InlineAction_disable, website_InlineAction_header}
...
website_FeatureSupportAction.attributes={website_FeatureSupportAction_confirmMessage, website_FeatureSupportAction_fileExtension, website_FeatureSupportAction_uriElement}
...
domain_model = DomainModel(
    name="website",
    types={website_WebGenModel, website_WebsiteProperties, website_Classifier, website_Service, website_Page, website_Menu, website_EntityOrView, website_ImageManipulation, website_Authentication, website_NamedDisplayElement, NamedElement, NamedDisplayElement, website_DataType, Classifier, website_Attribute, website_LocalAuthenticationSystem, Authentication, website_RegistrationUnit, website_LoginUnit, website_ForgottenPasswordUnit, website_CasAuthentication, website_NamedElement, website_EnumerationType, DataType, website_EnumerationLiteral, website_Feature, website_ModelLabel, website_EncapsulatedAssociation, website_Association, Feature, Label, website_Expression, website_EntityAttribute, website_Label, website_ModelLabelFeature, website_ModelLabelAttribute, ModelLabelFeature, website_ModelLabelAssociation, website_EntityAssociation, website_Entity, EntityOrView, website_EntityFeature, website_FileAttribute, ResourceAttribute, website_ImageAttribute, website_LocationAttribute, Association, website_AssociationKey, EntityFeature, Attribute, website_DataTypeAttribute, EntityAttribute, website_DateAttribute, website_UrlAttribute, website_ResourceAttribute, website_PathElement, website_StaticPathElement, PathElement, website_DatePathElement, website_ViewFeature, website_EncapsulatedFeature, ViewFeature, website_EncapsulatedAttribute, EncapsulatedFeature, website_AssociationWithoutContainment, EntityAssociation, website_AssociationWithContainment, website_View, website_Selection, website_BusinessOperation, website_SelectionParameter, website_ViewAssociation, website_PageLink, website_Predicate, website_Order, website_ImageFilter, website_ThumbnailFilter, ImageFilter, UnitContainer, website_FilterParameter, website_QueryParameter, website_MenuEntry, website_StaticMenu, Menu, website_ActionMenuEntry, MenuEntry, website_ContentUnit, website_Query, website_EditStaticTextMenuEntry, website_DynamicMenu, website_MenuFeature, website_Filter, website_UnitField, website_UnitSupportAction, website_UnitContainer, website_StaticUnit, ContentUnit, website_CreateSitemapUnit, website_DynamicUnit, website_UnitAssociation, AssociationReference, website_UnitFeature, UnitField, InlineActionContainer, website_UnitElement, UnitFeature, website_CaptchaField, website_SelectableUnit, website_SingletonUnit, website_CollectionUnit, SelectableUnit, website_AssociationReference, website_ChildPath, website_InterfaceField, website_DataTypeField, InterfaceField, website_DateField, website_CreateUnit, EditUnit, website_CreateUpdateUnit, website_UpdateUnit, website_EditUnit, DynamicUnit, SingletonUnit, website_ControlUnit, website_SearchUnit, ControlUnit, website_ImageUnit, website_MapUnit, website_DataUnit, website_DetailsUnit, DataUnit, website_IndexUnit, CollectionUnit, website_ChildPathAssociation, website_FeaturePath, website_FeaturePathAttribute, FeaturePath, website_FeaturePathAssociation, website_ChildPathAttribute, ChildPath, website_SelectAction, InlineAction, website_DeleteAction, website_ImageIndexUnit, ImageUnit, website_SliderUnit, website_GalleryUnit, website_AuthenticationUnit, AuthenticationUnit, website_InlineActionContainer, website_InlineAction, website_ParameterReference, website_FeatureSupportAction, website_ModelReference, Path, website_FeatureReference, website_RouteParameterReference, website_CurrentUserReference, FrameworkTechnologies, InputTechnologies, AjaxTechnologies, DatabaseTechnologies, OrmTechnologies, AuthenticationKeyTypes, Cardinality, isHasChoices, DateDetails, OperationResultTypes, PageTopMenuOptions, CollectionDisplayOptions, IndexDisplayOption},
    associations={websiteProperties0, classifiers1, services3, pages5, menus7, allowTypeCustomisation9, imageManipulations11, sideMenu14, authenticates17, user18, authentication13, userKey20, authentication22, registrationUnit24, loginUnit26, forgottenPasswordUnit28, features41, enumerations30, keys31, unique33, containerUnique36, servedBy39, labels40, encapsulatedBy57, sourceEntityX58, allFeatures44, attributes47, associations50, allAssociations52, defaultValue55, partOf76, targetEntityX61, labelFor64, features65, partOf66, attribute68, association70, dynamicLabel71, entityFeatures73, associationEnds75, keys79, targetEntity80, dataType77, uploadPath78, viewFeatures90, partOf92, keyFor82, sourceFeature84, targetFeature85, encapsulates88, serves105, selections107, operations108, usedBy110, fields112, parameters114, joins115, attribute93, association95, encapsulatedTarget97, sourceEntity98, targetEntity100, opposite103, parentPage129, childPages131, sideMenu132, targetPage135, filter118, ordering120, formalFor122, uses124, filters127, parameters149, selection151, partOf153, formal155, dataType156, filter159, entries136, partOf138, destination139, query140, entityOrView142, selection144, title147, entities169, displayFields171, supportActions173, parameters162, formal164, units167, displayedOn168, defaultValue180, sourceEntity183, displayedOn175, forcedValue176, attribute178, selectionType201, contentType203, contentType205, targetEntity185, selection188, association191, valueDisplay193, childFeature196, mustMatch198, dataType199, cancelDestination230, containingFeature207, selection210, filters213, pagination216, defaultSelection219, title221, enableWhen224, confirmDestination227, cancelDestination242, resultsDestination244, location233, placeName234, defaultSelection237, title239, attribute263, sourceEntity265, targetEntity267, defaultSelection245, imagePathFeature247, titleFeature249, imageFilter252, attribute255, sourceEntity257, targetEntity259, partOf262, enableWhen275, displayWhen277, target280, fullSizeFilter270, actions272, usedBy274, parameter290, destination282, operation284, unit286, feature288, parameter292, userModel294},
    generalizations={gen_website_NamedDisplayElement_NamedElement, gen_website_Classifier_NamedDisplayElement, gen_website_DataType_Classifier, gen_website_LocalAuthenticationSystem_Authentication, gen_website_CasAuthentication_Authentication, gen_website_EnumerationType_DataType, gen_website_EnumerationLiteral_NamedDisplayElement, gen_website_EntityOrView_Classifier, gen_website_Attribute_Feature, gen_website_Attribute_Label, gen_website_Association_Feature, gen_website_ModelLabel_NamedElement, gen_website_ModelLabel_Label, gen_website_ModelLabelAttribute_ModelLabelFeature, gen_website_ModelLabelAssociation_ModelLabelFeature, gen_website_Entity_EntityOrView, gen_website_EntityFeature_NamedDisplayElement, gen_website_EntityFeature_Feature, gen_website_FileAttribute_ResourceAttribute, gen_website_ImageAttribute_ResourceAttribute, gen_website_LocationAttribute_EntityAttribute, gen_website_EntityAssociation_EntityFeature, gen_website_EntityAssociation_Association, gen_website_EntityAttribute_EntityFeature, gen_website_EntityAttribute_Attribute, gen_website_DataTypeAttribute_EntityAttribute, gen_website_DateAttribute_EntityAttribute, gen_website_UrlAttribute_EntityAttribute, gen_website_ResourceAttribute_EntityAttribute, gen_website_StaticPathElement_PathElement, gen_website_DatePathElement_PathElement, gen_website_ViewFeature_Feature, gen_website_EncapsulatedFeature_ViewFeature, gen_website_EncapsulatedAttribute_EncapsulatedFeature, gen_website_EncapsulatedAttribute_Attribute, gen_website_AssociationWithoutContainment_EntityAssociation, gen_website_AssociationWithContainment_EntityAssociation, gen_website_View_EntityOrView, gen_website_Selection_NamedElement, gen_website_EncapsulatedAssociation_EncapsulatedFeature, gen_website_EncapsulatedAssociation_Association, gen_website_ViewAssociation_NamedDisplayElement, gen_website_ViewAssociation_ViewFeature, gen_website_ViewAssociation_Association, gen_website_Service_NamedElement, gen_website_Menu_NamedDisplayElement, gen_website_SelectionParameter_NamedElement, gen_website_BusinessOperation_NamedElement, gen_website_ImageManipulation_NamedElement, gen_website_ThumbnailFilter_ImageFilter, gen_website_Page_NamedDisplayElement, gen_website_Page_UnitContainer, gen_website_FilterParameter_NamedElement, gen_website_StaticMenu_Menu, gen_website_ActionMenuEntry_MenuEntry, gen_website_ActionMenuEntry_NamedDisplayElement, gen_website_EditStaticTextMenuEntry_MenuEntry, gen_website_EditStaticTextMenuEntry_NamedDisplayElement, gen_website_DynamicMenu_Menu, gen_website_MenuFeature_MenuEntry, gen_website_Filter_NamedDisplayElement, gen_website_ContentUnit_NamedDisplayElement, gen_website_StaticUnit_ContentUnit, gen_website_CreateSitemapUnit_ContentUnit, gen_website_DynamicUnit_ContentUnit, gen_website_UnitAssociation_UnitFeature, gen_website_UnitAssociation_UnitContainer, gen_website_UnitAssociation_AssociationReference, gen_website_UnitFeature_UnitField, gen_website_UnitFeature_InlineActionContainer, gen_website_UnitElement_UnitFeature, gen_website_CaptchaField_InterfaceField, gen_website_UnitSupportAction_NamedDisplayElement, gen_website_CollectionUnit_SelectableUnit, gen_website_InterfaceField_NamedDisplayElement, gen_website_InterfaceField_UnitField, gen_website_DataTypeField_InterfaceField, gen_website_DateField_InterfaceField, gen_website_CreateUnit_EditUnit, gen_website_CreateUpdateUnit_EditUnit, gen_website_CreateUpdateUnit_SelectableUnit, gen_website_UpdateUnit_EditUnit, gen_website_UpdateUnit_SelectableUnit, gen_website_EditUnit_DynamicUnit, gen_website_EditUnit_SingletonUnit, gen_website_ControlUnit_DynamicUnit, gen_website_SearchUnit_ControlUnit, gen_website_ImageUnit_DynamicUnit, gen_website_ImageUnit_CollectionUnit, gen_website_MapUnit_EditUnit, gen_website_MapUnit_SelectableUnit, gen_website_DataUnit_DynamicUnit, gen_website_DetailsUnit_DataUnit, gen_website_DetailsUnit_SingletonUnit, gen_website_DetailsUnit_SelectableUnit, gen_website_IndexUnit_DataUnit, gen_website_IndexUnit_CollectionUnit, gen_website_IndexUnit_InlineActionContainer, gen_website_ChildPathAssociation_ChildPath, gen_website_ChildPathAssociation_AssociationReference, gen_website_FeaturePathAttribute_FeaturePath, gen_website_FeaturePathAssociation_FeaturePath, gen_website_FeaturePathAssociation_AssociationReference, gen_website_ChildPathAttribute_ChildPath, gen_website_SelectAction_InlineAction, gen_website_DeleteAction_InlineAction, gen_website_ImageIndexUnit_ImageUnit, gen_website_ImageIndexUnit_InlineActionContainer, gen_website_SliderUnit_ImageUnit, gen_website_GalleryUnit_ImageUnit, gen_website_RegistrationUnit_AuthenticationUnit, gen_website_RegistrationUnit_ControlUnit, gen_website_LoginUnit_AuthenticationUnit, gen_website_LoginUnit_ControlUnit, gen_website_ForgottenPasswordUnit_AuthenticationUnit, gen_website_ForgottenPasswordUnit_ControlUnit, gen_website_InlineAction_NamedDisplayElement, gen_website_RouteParameterReference_Path, gen_website_ParameterReference_Path, gen_website_FeatureSupportAction_InlineAction, gen_website_ModelReference_Path, gen_website_FeatureReference_Path, gen_website_CurrentUserReference_Path},
    metadata=None
)
