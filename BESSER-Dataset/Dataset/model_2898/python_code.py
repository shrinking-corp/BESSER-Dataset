...
class website_ControlUnit(DynamicUnit):
    ...
    def __init__(self, submitLabel: str, cancelLabel: str, contentClass: str, website_ControlUnit: "website_Page" = None):
...
class website_EditUnit(SingletonUnit, DynamicUnit):
    ...
    def __init__(self, cancelLabel: str, contentClass: str, customiseValues: bool, confirmLabel: str, website_EditUnit231: "website_Page" = None, website_EditUnit: "website_Selection" = None, website_EditUnit222: "website_Label" = None, website_EditUnit225: "website_Predicate" = None, website_EditUnit228: "website_Page" = None):
        self.cancelLabel = cancelLabel
        self.contentClass = contentClass
...
class SelectableUnit:
    ...
    pass
class website_UpdateUnit(EditUnit, SelectableUnit):
...
class website_MapUnit(EditUnit, SelectableUnit):
...
class website_DetailsUnit(SingletonUnit, DataUnit, SelectableUnit):
    ...
    @property
    def onlyDisplayWhenNotEmpty(self):
...
class website_CreateUpdateUnit(EditUnit, SelectableUnit):

    def __init__(self, createUriElement: str, clearLabel: str, styleClass: str):
...
class website_CollectionUnit(SelectableUnit):
    ...
    @property
    def defaultPaginationSize(self):
    ...
    @property
    def useFirstLastPageLinks(self):
...
class website_UnitElement(UnitFeature):
    ...
    def __init__(self, obfuscateFormFields: bool, placeholder: str, validationPattern: str, name: str, website_UnitElement181: "website_Expression" = None, website_UnitElement: "website_Attribute" = None):
        self.obfuscateFormFields = obfuscateFormFields
...
class InlineActionContainer:
    ...
    pass
class website_IndexUnit(DataUnit, InlineActionContainer, CollectionUnit):

    def __init__(self, contentClass: str, rowClasses: str, displayOption: str, omitColumnLabels: bool, styleClass: str, website_IndexUnit: "website_SearchUnit" = None):
        self.contentClass = contentClass
...
class website_ImageIndexUnit(ImageUnit, InlineActionContainer):
...
class website_ChildPathAssociation(ChildPath, AssociationReference):
...
class website_DynamicUnit(ContentUnit):
    ...
    def __init__(self, header: str, footer: str, headerClass: str, controlClass: str, footerClass: str, errorClass: str, website_DynamicUnit: set["website_EntityOrView"] = None, displayedOn172: set["website_UnitField"] = None, website_DynamicUnit174: set["website_UnitSupportAction"] = None, DynamicUnit: "website_UnitField" = None, website_DynamicUnit287: "website_ModelReference" = None):
        self.header = header
        self.footer = footer
        self.headerClass = headerClass
...
class website_UnitField(ABC):
    ...
    def __init__(self, title: str, collectionDisplayOption: str, collectionAllowAdd: bool, collectionAllowRemove: bool, maximumDisplaySize: int, dateFormat: str, website_UnitField: "website_InterfaceField" = None, UnitField: "website_DynamicUnit" = None, displayFields: "website_DynamicUnit" = None):
        self.title = title
    ...
    @property
    def collectionDisplayOption(self):
    ...
    @property
    def collectionAllowRemove(self):
...
class UnitContainer:
    ...
    pass
class website_UnitAssociation(UnitContainer, AssociationReference, UnitFeature):

    def __init__(self, isSourceAssociation: bool, website_UnitAssociation186: "website_EntityOrView" = None, website_UnitAssociation189: "website_Selection" = None, website_UnitAssociation: "website_EntityOrView" = None):
        self.isSourceAssociation = isSourceAssociation
...
class website_ResourceAttribute(EntityAttribute):
    ...
    def __init__(self, maximumUploadSize: int, validUploadMimeTypes: str, validUploadExtensions: str, uploadsWithinWebsite: bool, website_ResourceAttribute: set["website_PathElement"] = None):
        ...
        pass
    @property
    def validUploadExtensions(self):
...
class Attribute:
    ...
    pass
class website_EncapsulatedAttribute(Attribute, EncapsulatedFeature):
...
class website_AssociationKey:
    ...
    def __init__(self, targetColumnName: str, AssociationKey: "website_EntityAssociation" = None, keys: "website_EntityAssociation" = None, website_AssociationKey: "website_EntityFeature" = None, website_AssociationKey86: "website_EntityFeature" = None):
...
class website_EntityAssociation(EntityFeature, Association):
    ...
    def __init__(self, bidirectional: bool, pivotTableName: str, targetFeatureName: str, targetPrimaryKey: bool, targetDisplayLabel: str, targetHeaderClass: str, targetInputClass: str, targetDisplayClass: str, targetFooterClass: str, website_EntityAssociation: "website_ModelLabelAssociation" = None, EntityAssociation: "website_Entity" = None, keyFor: set["website_AssociationKey"] = None, associationEnds: "website_Entity" = None, EntityAssociation83: "website_AssociationKey" = None):
...
class website_Association(Feature):
    ...
    def __init__(self, pseudo: bool, inputClass: str, serializationMaxDepth: int, website_Association117: "website_Selection" = None, Association: "website_EncapsulatedAssociation" = None, association: set["website_EncapsulatedAssociation"] = None, website_Association59: "website_EntityOrView" = None, website_Association: "website_EntityOrView" = None, website_Association54: "website_EntityOrView" = None, website_Association62: "website_EntityOrView" = None, website_Association192: "website_AssociationReference" = None):
        self.pseudo = pseudo
        self.inputClass = inputClass
        ...
        pass
    @property
    def serializationMaxDepth(self):
...
class website_EncapsulatedAssociation(Association, EncapsulatedFeature):

    def __init__(self, name: str, isSourceAssociation: bool, cardinality: str, encapsulatedBy: "website_Association" = None, website_EncapsulatedAssociation: "website_EncapsulatedAssociation" = None, website_EncapsulatedAssociation96: "website_EncapsulatedAssociation" = None, website_EncapsulatedAssociation99: "website_Entity" = None, website_EncapsulatedAssociation101: "website_Entity" = None, website_EncapsulatedAssociation104: "website_ViewAssociation" = None, EncapsulatedAssociation: "website_Association" = None):
        self.name = name
        self.isSourceAssociation = isSourceAssociation
        self.cardinality = cardinality
...
class website_Feature(ABC):
    ...
    def __init__(self, title: str, collectionAllowAdd: bool, collectionAllowRemove: bool, nullDisplayValue: str, encodeUriKey: bool, serializationGroups: str, serializationExpose: bool, headerClass: str, displayClass: str, footerClass: str, website_Feature43: "website_EntityOrView" = None, website_Feature: "website_EntityOrView" = None, website_Feature113: "website_Selection" = None, website_Feature35: "website_EntityOrView" = None, website_Feature38: "website_EntityOrView" = None, website_Feature46: "website_EntityOrView" = None, website_Feature209: "website_CollectionUnit" = None, website_Feature289: "website_FeatureReference" = None):
        self.title = title
        self.collectionAllowAdd = collectionAllowAdd
        self.collectionAllowRemove = collectionAllowRemove
        self.nullDisplayValue = nullDisplayValue
...
class website_LocalAuthenticationSystem(Authentication):
    ...
    def __init__(self, useEmailActivation: bool, sendWelcomeEmail: bool, authenticationKey: str, useCaptcha: bool, allowRememberMe: bool, allowSelfRegistration: bool, trackLoginAttempts: bool, website_LocalAuthenticationSystem: "website_EntityOrView" = None, website_LocalAuthenticationSystem25: "website_RegistrationUnit" = None, website_LocalAuthenticationSystem27: "website_LoginUnit" = None, website_LocalAuthenticationSystem29: "website_ForgottenPasswordUnit" = None):
    ...
    @property
    def allowSelfRegistration(self):
...
class website_Attribute(Feature, Label):
    ...
    def __init__(self, placeholder: str, validationPattern: str, inputClass: str, website_Attribute: "website_Authentication" = None, website_Attribute94: "website_EncapsulatedAttribute" = None, website_Attribute49: "website_EntityOrView" = None, website_Attribute56: "website_Expression" = None, website_Attribute69: "website_ModelLabelAttribute" = None, website_Attribute179: "website_UnitElement" = None, website_Attribute236: "website_MapUnit" = None, website_Attribute264: "website_ChildPathAttribute" = None, website_Attribute256: "website_FeaturePathAttribute" = None, website_Attribute291: "website_RouteParameterReference" = None):
        self.placeholder = placeholder
        self.validationPattern = validationPattern
        self.inputClass = inputClass
...
class website_DataType(Classifier):
    ...
    def __init__(self, persistentType: str, ormType: str, interfaceType: str, placeholder: str, validationPattern: str, website_DataType: "website_DataTypeAttribute" = None, website_DataType200: "website_DataTypeField" = None, website_DataType158: "website_FilterParameter" = None):
        self.persistentType = persistentType
        self.ormType = ormType
        self.interfaceType = interfaceType
        self.placeholder = placeholder
...
class website_ContentUnit(NamedDisplayElement):
    ...
    @property
    def createDefaultUriElement(self):
...
class website_ViewAssociation(ViewFeature, NamedDisplayElement, Association):
...
class website_InterfaceField(UnitField, NamedDisplayElement):

    def __init__(self, required: bool, defaultValue: str, inputClass: str, placeholder: str, validationPattern: str, website_InterfaceField: "website_UnitField" = None):
        self.required = required
...
class website_EntityFeature(Feature, NamedDisplayElement):

    def __init__(self, cardinality: str, unique: bool, ordered: bool, booleanIsHasChoice: str, singletonName: str, pluralisedName: str, columnName: str, entityFeatures: "website_Entity" = None, EntityFeature: "website_Entity" = None, website_EntityFeature: "website_AssociationKey" = None, website_EntityFeature87: "website_AssociationKey" = None):
        self.cardinality = cardinality
        self.unique = unique
...
class website_InlineAction(NamedDisplayElement):
    ...
    def __init__(self, disable: bool, requiresRole: str, header: str, footer: str, headerClass: str, footerClass: str, website_InlineAction: "website_Predicate" = None, website_InlineAction278: "website_Predicate" = None, InlineAction: "website_InlineActionContainer" = None, actions: "website_InlineActionContainer" = None):
        self.disable = disable
        self.requiresRole = requiresRole
        self.header = header
        self.footer = footer
...
class website_BusinessOperation(NamedElement):
    ...
    def __init__(self, resultType: str, resultMimeType: str, website_BusinessOperation: "website_Service" = None, website_BusinessOperation125: set["website_Service"] = None, website_BusinessOperation285: "website_FeatureSupportAction" = None):
...
class website_FilterParameter(NamedElement):
    ...
    def __init__(self, defaultValue: str, placeholder: str, FilterParameter: "website_Filter" = None, parameters154: "website_Filter" = None, website_FilterParameter: "website_SelectionParameter" = None, website_FilterParameter157: "website_DataType" = None, website_FilterParameter166: "website_QueryParameter" = None):
        self.defaultValue = defaultValue
        self.placeholder = placeholder
...
class website_ModelLabel(NamedElement, Label):
...
class website_Selection(NamedElement):
    ...
    def __init__(self, distinct: bool, limit: int, selected: bool, website_Selection: set["website_Feature"] = None, formalFor: set["website_SelectionParameter"] = None, website_Selection116: set["website_Association"] = None, Selection: "website_Service" = None, selections: "website_Service" = None, website_Selection190: "website_UnitAssociation" = None, website_Selection212: "website_CollectionUnit" = None, website_Selection119: "website_Predicate" = None, website_Selection121: set["website_Order"] = None, Selection123: "website_SelectionParameter" = None, website_Selection152: "website_Filter" = None, website_Selection146: "website_DynamicMenu" = None, website_Selection220: "website_EditUnit" = None, website_Selection238: "website_DataUnit" = None, website_Selection246: "website_ImageUnit" = None):
...
class website_Authentication(ABC):
    ...
    def __init__(self, loginLabel: str, logoutLabel: str, website_Authentication21: "website_Attribute" = None, authentication: "website_WebsiteProperties" = None, website_Authentication: "website_EntityOrView" = None, Authentication: "website_WebsiteProperties" = None):
...
class website_EntityOrView(Classifier):
    ...
    def __init__(self, singletonName: str, pluralisedName: str, tableName: str, autoKeyName: str, autoKeyPersistentType: str, autoKeyGenerationStrategy: str, serializationExcludeAll: bool, implementsUserInterface: bool, website_EntityOrView23: "website_LocalAuthenticationSystem" = None, website_EntityOrView42: set["website_Feature"] = None, website_EntityOrView32: set["website_Feature"] = None, website_EntityOrView: "website_WebGenModel" = None, website_EntityOrView19: "website_Authentication" = None, website_EntityOrView34: set["website_Feature"] = None, website_EntityOrView37: set["website_Feature"] = None, serves: set["website_Service"] = None, labelFor: set["website_ModelLabel"] = None, website_EntityOrView60: "website_Association" = None, website_EntityOrView45: set["website_Feature"] = None, website_EntityOrView48: set["website_Attribute"] = None, website_EntityOrView51: set["website_Association"] = None, website_EntityOrView53: set["website_Association"] = None, website_EntityOrView63: "website_Association" = None, EntityOrView: "website_ModelLabel" = None, website_EntityOrView89: "website_View" = None, EntityOrView106: "website_Service" = None, website_EntityOrView187: "website_UnitAssociation" = None, website_EntityOrView143: "website_DynamicMenu" = None, website_EntityOrView170: "website_DynamicUnit" = None, website_EntityOrView184: "website_UnitAssociation" = None, website_EntityOrView202: "website_SelectableUnit" = None, website_EntityOrView204: "website_SingletonUnit" = None, website_EntityOrView206: "website_CollectionUnit" = None, website_EntityOrView295: "website_CurrentUserReference" = None, website_EntityOrView266: "website_ChildPathAssociation" = None, website_EntityOrView269: "website_ChildPathAssociation" = None, website_EntityOrView258: "website_FeaturePathAssociation" = None, website_EntityOrView261: "website_FeaturePathAssociation" = None):
        self.singletonName = singletonName
        self.pluralisedName = pluralisedName
        ...
        pass
    @property
    def autoKeyPersistentType(self):
    ...
    @property
    def autoKeyGenerationStrategy(self):
    ...
    @property
    def implementsUserInterface(self):
    ...
    @property
    def serializationExcludeAll(self):
...
class website_Page(NamedDisplayElement, UnitContainer):

    def __init__(self, authenticated: bool, uriElement: str, topMenuOption: str, topMenuRank: int, navigationLabel: str, styleClass: str, website_Page: "website_WebGenModel" = None, website_Page130: "website_PageLink" = None, website_Page232: "website_EditUnit" = None, targetPage: set["website_PageLink"] = None, website_Page133: "website_Menu" = None, Page: "website_PageLink" = None, website_Page229: "website_EditUnit" = None, website_Page243: "website_ControlUnit" = None, website_Page283: "website_DeleteAction" = None):
...
class website_WebsiteProperties:
    ...
    def __init__(self, siteTemplate: str, staticUnitsEditable: bool, siteTitle: str, developmentVersion: bool, baseURL: str, rewriteURLs: bool, webmasterEmail: str, copyrightText: str, metaDescription: str, projectName: str, testProjectName: str, defaultDateFormat: str, defaultTimeFormat: str, defaultDateTimeFormat: str, defaultMaximumUploadSize: int, databaseTechnology: str, databasePrefix: str, databaseHost: str, databaseName: str, databasePort: str, databaseUsername: str, databasePassword: str, ormTechnology: str, timestampCreation: bool, timestampUpdates: bool, frameworkTechnology: str, inputTechnology: str, ajaxTechnology: str, captchaSiteKey: str, captchaSecretKey: str, textEditorURL: str, responsiveTopMenu: bool, topNavigationId: str, authenticates: "website_Authentication" = None, website_WebsiteProperties: "website_WebGenModel" = None, website_WebsiteProperties15: "website_Menu" = None, WebsiteProperties: "website_Authentication" = None):
    ...
    @property
    def defaultDateTimeFormat(self):
    ...
    @property
    def defaultMaximumUploadSize(self):
