...
automata_Variable = Class(name="automata_Variable")
...
automata_Action = Class(name="automata_Action")
...
domain_model = DomainModel(
    name="automata",
    types={automata_Automaton, automata_State, automata_Transition, automata_Variable, automata_Guard, automata_BooleanGuard, Guard, automata_StringGuard, automata_NumberGuard, automata_Action, DataType, BooleanOperator, StringOperator, NumberOperator},
    associations={variables3, states0, transitions1, target16, source5, target8, guard11, source13},
