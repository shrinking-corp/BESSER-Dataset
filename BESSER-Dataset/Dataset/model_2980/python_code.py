...
class automata_Variable:
    ...
    def __init__(self, name: str, type: str, automata_Variable: "automata_Automaton" = None, automata_Variable17: "automata_Action" = None, automata_Variable15: "automata_Guard" = None):
        self.name = name
        self.type = type
...
class automata_State:
    ...
    def __init__(self, name: str, initial: bool, automata_State7: "automata_Transition" = None, automata_State10: "automata_Transition" = None, automata_State: "automata_Automaton" = None):
        self.name = name
