...
HouseHolds.attributes={HouseHolds_DishWasher, HouseHolds_Coffee, HouseHolds_TimeID, HouseHolds_WashingMachine, HouseHolds_Alarm}
...
domain_model = DomainModel(
    ...
    associations={Sensor_Door, Door_Camera, HomeTheatre_TV, HomeTheatre_Speakers, HouseHolds_Start_Of_Day, HouseHolds_End_Of_Day, MicroPhone_System, Home_Security_System_Alert, TV_Entertainment, Speakers_Entertainment, HomeTheatre_Entertainment, Sensor_System, System_HouseHolds, HomeTheatre_System, Home_Security_System_System},
    generalizations={},
    metadata=None
)
