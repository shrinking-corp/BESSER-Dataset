...
class model_BasicCode(ABC):
    ...
    def __init__(self, id: str, names: str, descriptions: str, sortHint: int, domain: int, active: bool, structure: bool, model_BasicCode: "model_BasicCode" = None, model_BasicCode3: "model_BasicCode" = None, model_BasicCode6: set["model_CodeEntry"] = None):
        self.id = id
        self.names = names
    ...
    def setParentPath(self, model_parent):
...
class model_ObjectRef:
    ...
    def __init__(self, id: str, domain: int, state: str, labels: str, appId: str, type: str, nature: str, model_ObjectRef: "model_TreeNode" = None, model_ObjectRef8: "model_NotificationParticipant" = None):
        self.id = id
        self.domain = domain
        self.state = state
        self.labels = labels
...
class model_BasicObject(ABC):
    ...
    def __init__(self, id: str, domain: int, locale: str):
        self.id = id
        self.domain = domain
        self.locale = locale
...
class model_BasicNotificationDefinition(BasicObject):
    ...
    def __init__(self, notificationEventId: str, identifier: str, active: bool, description: str, model_BasicNotificationDefinition: "model_NotificationParticipant" = None, model_BasicNotificationDefinition12: set["model_NotificationParticipant"] = None, model_BasicNotificationDefinition15: set["model_NotificationParticipant"] = None, model_BasicNotificationDefinition18: set["model_NotificationParticipant"] = None, model_BasicNotificationDefinition21: "model_Code" = None):
