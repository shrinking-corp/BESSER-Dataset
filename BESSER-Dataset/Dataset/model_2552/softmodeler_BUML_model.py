...
# Classes
model_Attachment = Class(name="model_Attachment")
BasicObject = Class(name="BasicObject")
model_BasicObject = Class(name="model_BasicObject", is_abstract=True)
model_ObjectRef = Class(name="model_ObjectRef")
model_TreeNode = Class(name="model_TreeNode")
model_TreeNodeChild = Class(name="model_TreeNodeChild")
model_CodeEntry = Class(name="model_CodeEntry")
model_Code = Class(name="model_Code")
BasicCode = Class(name="BasicCode")
model_Category = Class(name="model_Category")
model_NotificationParticipant = Class(name="model_NotificationParticipant")
model_BasicNotificationDefinition = Class(name="model_BasicNotificationDefinition", is_abstract=True)
model_BasicCode = Class(name="model_BasicCode", is_abstract=True)
model_NotificationDefinition = Class(name="model_NotificationDefinition")
...
model_Attachment.attributes={model_Attachment_objectId, model_Attachment_key, model_Attachment_data}
...
model_BasicObject.attributes={model_BasicObject_id, model_BasicObject_domain, model_BasicObject_locale}
...
model_ObjectRef.attributes={model_ObjectRef_appId, model_ObjectRef_type, model_ObjectRef_nature, model_ObjectRef_state, model_ObjectRef_id, model_ObjectRef_labels, model_ObjectRef_domain}
model_ObjectRef.methods={model_ObjectRef_m_getWorkingId, model_ObjectRef_m_toString, model_ObjectRef_m_getDefaultLocale, model_ObjectRef_m_getDefaultLabel}
...
model_CodeEntry.attributes={model_CodeEntry_value, model_CodeEntry_key, model_CodeEntry_id}
...
model_Category.attributes={model_Category_associatedClassifier, model_Category_classifier}
...
model_NotificationParticipant.attributes={model_NotificationParticipant_mailAddress, model_NotificationParticipant_id, model_NotificationParticipant_groupId}
...
model_BasicNotificationDefinition.attributes={model_BasicNotificationDefinition_notificationEventId, model_BasicNotificationDefinition_identifier, model_BasicNotificationDefinition_active, model_BasicNotificationDefinition_description}
...
model_BasicCode_m_setParentPath: Method = Method(name="setParentPath", parameters={Parameter(name='model_parent', type=StringType)})
model_BasicCode.attributes={model_BasicCode_id, model_BasicCode_domain, model_BasicCode_names, model_BasicCode_structure, model_BasicCode_sortHint, model_BasicCode_descriptions, model_BasicCode_active}
...
model_NotificationDefinition.attributes={model_NotificationDefinition_template, model_NotificationDefinition_excludeFilter, model_NotificationDefinition_includeFilter}
...
domain_model = DomainModel(
    name="model",
    types={model_Attachment, BasicObject, model_BasicObject, model_ObjectRef, model_TreeNode, model_TreeNodeChild, model_CodeEntry, model_Code, BasicCode, model_Category, model_NotificationParticipant, model_BasicNotificationDefinition, model_BasicCode, model_NotificationDefinition, BasicNotificationDefinition, ObjectState},
    associations={childs0, object1, parent2, parent4, entries5, objectRef7, sender9, receivers11, ccReceivers14, bccReceivers17, delivery20},
