...
class TableM_Column:
    ...
    def __init__(self, name: str, type: str, Column: "TableM_Table" = None, TableM_Column: "TableM_Table" = None, cols: "TableM_Table" = None, TableM_Column14: "TableM_FKey" = None):
        self.name = name
        self.type = type
        self.Column = Column
...
class TableM_Table:
    ...
    def __init__(self, name: str, owner3: set["TableM_FKey"] = None, TableM_Table5: set["TableM_FKey"] = None, owner: set["TableM_Column"] = None, TableM_Table: set["TableM_Column"] = None, Table: "TableM_Column" = None, TableM_Table9: "TableM_FKey" = None, Table11: "TableM_FKey" = None):
        self.name = name
