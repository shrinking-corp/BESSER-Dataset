...
thingml_ThingMLElement = Class(name="thingml_ThingMLElement", is_abstract=True)
thingml_TypedElement = Class(name="thingml_TypedElement", is_abstract=True)
...
thingml_StateMachine = Class(name="thingml_StateMachine")
...
thingml_Region = Class(name="thingml_Region", is_abstract=True)
thingml_ProvidedPort = Class(name="thingml_ProvidedPort")
thingml_EventReference = Class(name="thingml_EventReference")
thingml_Literal = Class(name="thingml_Literal", is_abstract=True)
...
thingml_Dictionary = Class(name="thingml_Dictionary")
...
thingml_DictionaryReference = Class(name="thingml_DictionaryReference")
...
thingml_UnaryExpression = Class(name="thingml_UnaryExpression", is_abstract=True)
...
thingml_BinaryExpression = Class(name="thingml_BinaryExpression", is_abstract=True)
...
thingml_ControlStructure = Class(name="thingml_ControlStructure", is_abstract=True)
...
thingml_ConfigInclude = Class(name="thingml_ConfigInclude")
thingml_ConfigPropertyAssign = Class(name="thingml_ConfigPropertyAssign")
thingml_FunctionCall = Class(name="thingml_FunctionCall", is_abstract=True)
...
domain_model = DomainModel(
    name="thingml",
    types={thingml_Type, thingml_Configuration, thingml_Function, AnnotatedElement, TypedElement, thingml_Parameter, thingml_Action, thingml_ThingMLModel, Variable, thingml_Variable, thingml_ThingMLElement, thingml_TypedElement, thingml_Expression, thingml_Message, thingml_Thing, Type, thingml_Property, thingml_Port, thingml_StateMachine, thingml_PropertyAssign, thingml_Event, thingml_Transition, Handler, thingml_State, thingml_InternalTransition, thingml_PlatformAnnotation, ThingMLElement, thingml_Enumeration, thingml_EnumerationLiteral, thingml_PrimitiveType, thingml_AnnotatedElement, CompositeState, thingml_Handler, thingml_ActionBlock, Action, thingml_ExternStatement, thingml_ExternExpression, Expression, thingml_SendAction, thingml_CompositeState, State, Region, thingml_ParallelRegion, thingml_Region, thingml_ProvidedPort, thingml_EventReference, thingml_Literal, thingml_EnumLiteralRef, Literal, thingml_IntegerLiteral, thingml_BooleanLiteral, thingml_VariableAssignment, thingml_ReceiveMessage, Event, thingml_Dictionary, Property_, thingml_RequiredPort, Port, thingml_LoopAction, ControlStructure, thingml_ConditionalAction, thingml_PropertyReference, thingml_ArrayIndex, thingml_DictionaryReference, PropertyReference, thingml_StringLiteral, thingml_DoubleLiteral, thingml_UnaryExpression, thingml_NotExpression, UnaryExpression, thingml_UnaryMinus, thingml_BinaryExpression, thingml_PlusExpression, BinaryExpression, thingml_MinusExpression, thingml_TimesExpression, thingml_DivExpression, thingml_ModExpression, thingml_EqualsExpression, thingml_GreaterExpression, thingml_LowerExpression, thingml_AndExpression, thingml_OrExpression, thingml_ControlStructure, thingml_InstanceRef, thingml_ExpressionGroup, thingml_ReturnAction, thingml_PrintAction, thingml_ErrorAction, thingml_Instance, thingml_Connector, thingml_ConfigInclude, thingml_ConfigPropertyAssign, thingml_FunctionCall, thingml_FunctionCallStatement, FunctionCall, thingml_FunctionCallExpression, thingml_LocalVariable},
    associations={types0, imports2, configs4, parameters6, body7, type26, cardinality28, init30, parameters9, properties11, ports12, behaviour13, includes16, assign18, messages20, functions23, event45, guard46, action49, target52, source53, after55, before57, init33, property36, index39, literals42, enum43, annotations44, actions79, segments81, segments83, parameters85, message87, outgoing60, incoming61, entry63, exit65, properties68, internal71, region73, substate74, initial76, msgRef113, paramRef115, enum118, literal119, port90, property92, expression93, index96, message99, port101, indexType104, owner106, receives107, sends110, action128, condition130, property133, array135, index137, term121, lhs123, rhs125, type158, assign161, srv164, cli166, required169, provided171, init173, index140, exp142, exp144, msg146, msg148, instances150, connectors152, configs154, propassigns156, init199, property176, instance179, index182, config185, config188, instance191, parameters194, function196},
    generalizations={gen_thingml_Function_AnnotatedElement, gen_thingml_Function_TypedElement, gen_thingml_Parameter_Variable, gen_thingml_Variable_TypedElement, gen_thingml_Variable_AnnotatedElement, gen_thingml_Type_AnnotatedElement, gen_thingml_Property_Variable, gen_thingml_Message_AnnotatedElement, gen_thingml_Thing_Type, gen_thingml_Transition_Handler, gen_thingml_InternalTransition_Handler, gen_thingml_State_AnnotatedElement, gen_thingml_PropertyAssign_AnnotatedElement, gen_thingml_PlatformAnnotation_ThingMLElement, gen_thingml_Enumeration_Type, gen_thingml_PrimitiveType_Type, gen_thingml_EnumerationLiteral_AnnotatedElement, gen_thingml_AnnotatedElement_ThingMLElement, gen_thingml_StateMachine_CompositeState, gen_thingml_Handler_AnnotatedElement, gen_thingml_ActionBlock_Action, gen_thingml_ExternStatement_Action, gen_thingml_ExternExpression_Expression, gen_thingml_SendAction_Action, gen_thingml_CompositeState_State, gen_thingml_CompositeState_Region, gen_thingml_Region_AnnotatedElement, gen_thingml_ParallelRegion_Region, gen_thingml_ProvidedPort_Port, gen_thingml_EventReference_Expression, gen_thingml_Literal_Expression, gen_thingml_EnumLiteralRef_Literal, gen_thingml_IntegerLiteral_Literal, gen_thingml_BooleanLiteral_Literal, gen_thingml_VariableAssignment_Action, gen_thingml_Event_ThingMLElement, gen_thingml_ReceiveMessage_Event, gen_thingml_Dictionary_Property, gen_thingml_Port_AnnotatedElement, gen_thingml_RequiredPort_Port, gen_thingml_LoopAction_ControlStructure, gen_thingml_ConditionalAction_ControlStructure, gen_thingml_PropertyReference_Expression, gen_thingml_ArrayIndex_Expression, gen_thingml_DictionaryReference_PropertyReference, gen_thingml_StringLiteral_Literal, gen_thingml_DoubleLiteral_Literal, gen_thingml_UnaryExpression_Expression, gen_thingml_NotExpression_UnaryExpression, gen_thingml_UnaryMinus_UnaryExpression, gen_thingml_BinaryExpression_Expression, gen_thingml_PlusExpression_BinaryExpression, gen_thingml_MinusExpression_BinaryExpression, gen_thingml_TimesExpression_BinaryExpression, gen_thingml_DivExpression_BinaryExpression, gen_thingml_ModExpression_BinaryExpression, gen_thingml_EqualsExpression_BinaryExpression, gen_thingml_GreaterExpression_BinaryExpression, gen_thingml_LowerExpression_BinaryExpression, gen_thingml_AndExpression_BinaryExpression, gen_thingml_OrExpression_BinaryExpression, gen_thingml_ControlStructure_Action, gen_thingml_Instance_AnnotatedElement, gen_thingml_Connector_AnnotatedElement, gen_thingml_ConfigPropertyAssign_AnnotatedElement, gen_thingml_ExpressionGroup_Expression, gen_thingml_ReturnAction_Action, gen_thingml_PrintAction_Action, gen_thingml_ErrorAction_Action, gen_thingml_Configuration_AnnotatedElement, gen_thingml_ConfigInclude_AnnotatedElement, gen_thingml_FunctionCallStatement_Action, gen_thingml_FunctionCallStatement_FunctionCall, gen_thingml_FunctionCallExpression_FunctionCall, gen_thingml_FunctionCallExpression_Expression, gen_thingml_LocalVariable_Variable, gen_thingml_LocalVariable_Action},
    metadata=None
)
