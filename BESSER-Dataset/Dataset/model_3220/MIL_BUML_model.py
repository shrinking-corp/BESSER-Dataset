...
mil_UnconditionalJumpInstruction = Class(name="mil_UnconditionalJumpInstruction")
JumpInstruction = Class(name="JumpInstruction")
mil_ConditionalJumpInstruction = Class(name="mil_ConditionalJumpInstruction")
mil_CompareInstruction = Class(name="mil_CompareInstruction", is_abstract=True)
mil_EqualInstruction = Class(name="mil_EqualInstruction")
CompareInstruction = Class(name="CompareInstruction")
mil_GreaterThanEqualInstruction = Class(name="mil_GreaterThanEqualInstruction")
mil_OutputInstruction = Class(name="mil_OutputInstruction", is_abstract=True)
mil_YieldInstruciton = Class(name="mil_YieldInstruciton")
OutputInstruction = Class(name="OutputInstruction")
mil_PrintInstruction = Class(name="mil_PrintInstruction")
mil_ArithmeticInstruction = Class(name="mil_ArithmeticInstruction", is_abstract=True)
...
mil_NotEqualInstruction = Class(name="mil_NotEqualInstruction")
mil_LessThanInstruction = Class(name="mil_LessThanInstruction")
mil_LessThanEqualInstruction = Class(name="mil_LessThanEqualInstruction")
mil_GreaterThanInstruction = Class(name="mil_GreaterThanInstruction")
...
domain_model = DomainModel(
    name="mil",
    types={mil_MILModel, mil_Instruction, mil_LabelInstruction, Instruction, mil_LoadInstruction, mil_Value, mil_StoreInstruction, mil_RegisterReference, mil_NegateInstruction, mil_JumpInstruction, mil_UnconditionalJumpInstruction, JumpInstruction, mil_ConditionalJumpInstruction, mil_CompareInstruction, mil_EqualInstruction, CompareInstruction, mil_GreaterThanEqualInstruction, mil_OutputInstruction, mil_YieldInstruciton, OutputInstruction, mil_PrintInstruction, mil_ArithmeticInstruction, mil_AddInstruction, ArithmeticInstruction, mil_SubInstruction, mil_MulInstruction, mil_DivInstruction, mil_CallInstruction, mil_ReturnInstruction, mil_ConstantInteger, Value, mil_NotEqualInstruction, mil_LessThanInstruction, mil_LessThanEqualInstruction, mil_GreaterThanInstruction},
    associations={instructions0, value1, registerReference2, jumpTo3, operationName4},
    generalizations={gen_mil_LabelInstruction_Instruction, gen_mil_LoadInstruction_Instruction, gen_mil_StoreInstruction_Instruction, gen_mil_NegateInstruction_Instruction, gen_mil_JumpInstruction_Instruction, gen_mil_UnconditionalJumpInstruction_JumpInstruction, gen_mil_ConditionalJumpInstruction_JumpInstruction, gen_mil_CompareInstruction_Instruction, gen_mil_EqualInstruction_CompareInstruction, gen_mil_GreaterThanEqualInstruction_CompareInstruction, gen_mil_OutputInstruction_Instruction, gen_mil_YieldInstruciton_OutputInstruction, gen_mil_PrintInstruction_OutputInstruction, gen_mil_ArithmeticInstruction_Instruction, gen_mil_AddInstruction_ArithmeticInstruction, gen_mil_SubInstruction_ArithmeticInstruction, gen_mil_MulInstruction_ArithmeticInstruction, gen_mil_DivInstruction_ArithmeticInstruction, gen_mil_CallInstruction_Instruction, gen_mil_ReturnInstruction_Instruction, gen_mil_ConstantInteger_Value, gen_mil_RegisterReference_Value, gen_mil_NotEqualInstruction_CompareInstruction, gen_mil_LessThanInstruction_CompareInstruction, gen_mil_LessThanEqualInstruction_CompareInstruction, gen_mil_GreaterThanInstruction_CompareInstruction},
    metadata=None
)
