...
# Classes
hfsm_Transition = Class(name="hfsm_Transition")
hfsm_State = Class(name="hfsm_State")
AbstractState = Class(name="AbstractState")
hfsm_Region = Class(name="hfsm_Region")
NamedElement = Class(name="NamedElement")
hfsm_AbstractState = Class(name="hfsm_AbstractState")
hfsm_NamedElement = Class(name="hfsm_NamedElement")
...
domain_model = DomainModel(
    name="hfsm",
    types={hfsm_Transition, hfsm_State, AbstractState, hfsm_Region, NamedElement, hfsm_AbstractState, hfsm_NamedElement},
    associations={incoming5, outgoing6, ownedRegions0, ownerState1, subvertex4, ownerRegion8, target9, source11},
