...
dsl_InitialState = Class(name="dsl_InitialState")
dsl_FSM = Class(name="dsl_FSM")
...
dsl_Transition.attributes={dsl_Transition_trigger, dsl_Transition_name}
...
dsl_State.attributes={dsl_State_name, dsl_State_isFinal}
...
domain_model = DomainModel(
    name="dsl",
    types={dsl_Transition, dsl_InitialState, dsl_FSM, dsl_State, State},
    associations={transition1, initialstate3, target5, state0, source8},
