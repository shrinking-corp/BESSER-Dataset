...
class dsl_State:
    ...
    def __init__(self, name: str, isFinal: bool, dsl_State7: "dsl_Transition" = None, dsl_State: "dsl_FSM" = None, dsl_State10: "dsl_Transition" = None):
        self.name = name
...
class dsl_FSM:
    ...
    def __init__(self, name: str, dsl_FSM2: set["dsl_Transition"] = None, dsl_FSM4: "dsl_InitialState" = None, dsl_FSM: set["dsl_State"] = None):
        self.name = name
