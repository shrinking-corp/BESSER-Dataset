...
def test_hyp_dsl_fsm_is_not_abstract():
    assert not inspect.isabstract(dsl_FSM)


def test_hyp_dsl_fsm_constructor_exists():
    assert callable(dsl_FSM.__init__)


def test_hyp_dsl_fsm_constructor_args():
...
def test_hyp_dsl_initialstate_is_not_abstract():
    assert not inspect.isabstract(dsl_InitialState)


def test_hyp_dsl_initialstate_constructor_exists():
    assert callable(dsl_InitialState.__init__)


def test_hyp_dsl_initialstate_constructor_args():
...
@given(instance=dsl_State_strategy)
def test_hyp_dsl_state_isFinal_setter(instance):
...
def test_hyp_dsl_fsm_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_dsl_transition_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=dsl_Transition_strategy)
def test_hyp_dsl_transition_trigger_setter(instance):
