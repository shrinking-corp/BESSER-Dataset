...
dfa_Symbol.attributes={dfa_Symbol_description, dfa_Symbol_direction, dfa_Symbol_literal}
...
domain_model = DomainModel(
    name="dfa",
    types={RegularState, State, dfa_Transition, dfa_Symbol, dfa_Dfa, NamedElement, dfa_Language, dfa_RegularState, dfa_InitialState, dfa_FinalState, dfa_NamedElement, dfa_State},
    associations={targetState7, symbols8, symbols10, language0, regularStates1, initialState3, finalStates5, transitions13},
    generalizations={gen_dfa_InitialState_RegularState, gen_dfa_FinalState_State, gen_dfa_Language_NamedElement, gen_dfa_RegularState_State, gen_dfa_Dfa_NamedElement, gen_dfa_State_NamedElement},
    metadata=None
)
