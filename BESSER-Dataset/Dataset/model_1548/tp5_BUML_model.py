...
tp5_Paragraph.attributes={tp5_Paragraph_content, tp5_Paragraph_id, tp5_Paragraph_name}
...
domain_model = DomainModel(
    name="tp5",
    types={tp5_Collaboration, tp5_Paragraph, tp5_PublicationStructure, tp5_Researcher, tp5_Paper, tp5_Skill, tp5_Position},
    associations={collaborations4, paragraphs6, authors7, citedBy9, researchers11, papers13, res_papers0, skills1, res_position2, positions16, parent20, col_paper22},
    generalizations={},
    metadata=None
)
