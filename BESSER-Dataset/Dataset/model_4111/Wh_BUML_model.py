...
wh_Function = Class(name="wh_Function")
wh_Definition = Class(name="wh_Definition")
wh_Input = Class(name="wh_Input")
wh_Commands = Class(name="wh_Commands")
wh_ExprOr = Class(name="wh_ExprOr")
wh_Command = Class(name="wh_Command")
wh_EObject = Class(name="wh_EObject")
wh_If = Class(name="wh_If")
wh_Expr = Class(name="wh_Expr")
wh_Nop = Class(name="wh_Nop")
wh_Affect = Class(name="wh_Affect")
wh_For = Class(name="wh_For")
wh_While = Class(name="wh_While")
wh_ExprSimple = Class(name="wh_ExprSimple")
Expr = Class(name="Expr")
wh_ExprAnd = Class(name="wh_ExprAnd")
wh_ExprCons = Class(name="wh_ExprCons")
wh_ExprList = Class(name="wh_ExprList")
wh_ExprHd = Class(name="wh_ExprHd")
wh_ExprTl = Class(name="wh_ExprTl")
wh_ExprSym = Class(name="wh_ExprSym")
wh_ExprNot = Class(name="wh_ExprNot")
wh_ExprEq = Class(name="wh_ExprEq")
...
wh_ExprSimple.attributes={wh_ExprSimple_str, wh_ExprSimple_sym, wh_ExprSimple_varSimple}
...
domain_model = DomainModel(
    name="wh",
    types={wh_Output, wh_Wh, wh_Program, wh_Function, wh_Definition, wh_Input, wh_Commands, wh_ExprOr, wh_Command, wh_EObject, wh_If, wh_Expr, wh_Nop, wh_Affect, wh_For, wh_While, wh_ExprSimple, Expr, wh_ExprAnd, wh_ExprCons, wh_ExprList, wh_ExprHd, wh_ExprTl, wh_ExprSym, wh_ExprNot, wh_ExprEq},
    associations={output9, elements0, functions1, definition3, input5, commands7, arg141, arg243, commands11, cmd13, expr15, commands116, commands219, exprs22, expr24, cmds26, expr29, cmds31, expr35, arg137, arg238, arg46, arg48, arg50, arg52, arg254, arg156, arg157, arg260},
    generalizations={gen_wh_ExprOr_Expr, gen_wh_ExprSimple_Expr, gen_wh_ExprAnd_Expr, gen_wh_ExprCons_Expr, gen_wh_ExprList_Expr, gen_wh_ExprHd_Expr, gen_wh_ExprTl_Expr, gen_wh_ExprSym_Expr, gen_wh_ExprNot_Expr, gen_wh_ExprEq_Expr},
    metadata=None
)
