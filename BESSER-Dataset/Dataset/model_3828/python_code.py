...
class TestPackage_TestClass(UberClass, SuperClass):
    ...
    def __init__(self, testAttr: date, testStringAttr: str, testRealAttr: str, testBooleanAttr: bool, testIntAttr: int, testAttr1: int, testAttr2: int, testAttr3: int, testAttr4: int, testAttr5: int, testUnlimitedNaturalAttr: str, testAttr6: int, testAttr7: int, testAttr8: int):
        self.testAttr = testAttr
        self.testStringAttr = testStringAttr
        self.testRealAttr = testRealAttr
        self.testBooleanAttr = testBooleanAttr
    ...
    @property
    def testUnlimitedNaturalAttr(self):
