...
Order.attributes={Order_Customer, Order_ItemList, Order_Restaurant}
...
Customer.attributes={Customer_PostCode, Customer_CreditCard, Customer_Address, Customer_Cellphone, Customer_FullName}
...
Restaurant.attributes={Restaurant_PostCode, Restaurant_Menu, Restaurant_Name, Restaurant_Address}
...
domain_model = DomainModel(
    name="_36bdc7b9_6401_400c_a4f2_0ade16fd992f",
    types={MenuItem, FoodPackage, FoodItem, Food, Order, Customer, RestaurantController, OrderController, Restaurant},
    associations={MenuItem_FoodItem, MenuItem_FoodPackage, FoodItem_Food, FoodPackage_Food, Restaurant_MenuItem, Order_MenuItem, Order_Restaurant, Order_Customer, RestaurantManager_Restaurant, OrderController_Order},
    generalizations={},
    metadata=None
)
