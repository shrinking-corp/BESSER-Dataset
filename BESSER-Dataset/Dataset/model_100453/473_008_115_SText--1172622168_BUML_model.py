...
domain_model = DomainModel(
    name="stext",
    types={stext_Root, stext_DefRoot, stext_StatechartRoot, DefRoot, stext_TransitionReaction, stext_StatechartScope, Scope, stext_InterfaceScope, StatechartScope, NamedElement, stext_InternalScope, stext_EventDefinition, Event, stext_VariableDefinition, Variable, Property_, stext_StatechartSpecification, stext_StateRoot, stext_StateSpecification, stext_TransitionRoot, stext_TransitionSpecification, ScopedElement, stext_Scope, stext_BuiltinEventSpec, stext_EntryEvent, BuiltinEventSpec, stext_ExitEvent, stext_OnCycleEvent, stext_AlwaysEvent, stext_DefaultEvent, Statement, stext_Literal, stext_BoolLiteral, Literal, stext_IntLiteral, stext_RealLiteral, stext_Expression, stext_OperationDefinition, Declaration, Operation, stext_LocalReaction, Reaction, stext_EventSpec, stext_RegularEventSpec, EventSpec, stext_TimeEventSpec, stext_HexLiteral, stext_StringLiteral, stext_ConditionalExpression, stext_LogicalOrExpression, stext_SimpleScope, stext_ReactionTrigger, Trigger, stext_ReactionEffect, Effect, stext_EventRaisingExpression, Expression, stext_AssignmentExpression, stext_BitwiseXorExpression, stext_BitwiseOrExpression, stext_BitwiseAndExpression, stext_LogicalAndExpression, stext_LogicalNotExpression, stext_NumericalAddSubtractExpression, stext_NumericalMultiplyDivideExpression, stext_LogicalRelationExpression, stext_ShiftExpression, stext_EObject, stext_ElementReferenceExpression, stext_NumericalUnaryExpression, stext_PrimitiveValueExpression, stext_FeatureCall, stext_EventValueReferenceExpression, stext_ActiveStateReferenceExpression, stext_State, stext_ParenthesizedExpression, Direction, TimeEventType, AdditiveOperator, MultiplicativeOperator, UnaryOperator, RelationalOperator, TimeUnit, AssignmentOperator, ShiftOperator},
    associations={roots0, reaction6, def_1, def_2, def_3, scope4, initialValue8, event9, value11, varRef24, expression26, condition29, trueCase31, falseCase34, leftOperand37, triggers13, guardExpression14, actions17, event19, value21, leftOperand49, rightOperand51, leftOperand54, rightOperand56, leftOperand59, rightOperand39, leftOperand42, rightOperand44, operand47, rightOperand71, leftOperand74, rightOperand76, leftOperand79, rightOperand61, leftOperand64, rightOperand66, leftOperand69, owner87, feature89, args91, reference94, args96, rightOperand81, operand84, value86, value99, value101, expression102},
    generalizations={gen_stext_StatechartRoot_DefRoot, gen_stext_StatechartScope_Scope, gen_stext_InterfaceScope_StatechartScope, gen_stext_InterfaceScope_NamedElement, gen_stext_InternalScope_StatechartScope, gen_stext_EventDefinition_Event, gen_stext_EventDefinition_Event, gen_stext_VariableDefinition_Variable, gen_stext_VariableDefinition_Property, gen_stext_StateRoot_DefRoot, gen_stext_TransitionRoot_DefRoot, gen_stext_StatechartSpecification_ScopedElement, gen_stext_BuiltinEventSpec_EventSpec, gen_stext_EntryEvent_BuiltinEventSpec, gen_stext_ExitEvent_BuiltinEventSpec, gen_stext_OnCycleEvent_BuiltinEventSpec, gen_stext_AlwaysEvent_BuiltinEventSpec, gen_stext_DefaultEvent_BuiltinEventSpec, gen_stext_Expression_Statement, gen_stext_BoolLiteral_Literal, gen_stext_IntLiteral_Literal, gen_stext_RealLiteral_Literal, gen_stext_OperationDefinition_Declaration, gen_stext_OperationDefinition_Operation, gen_stext_LocalReaction_Declaration, gen_stext_LocalReaction_Reaction, gen_stext_TransitionReaction_Reaction, gen_stext_RegularEventSpec_EventSpec, gen_stext_TimeEventSpec_EventSpec, gen_stext_HexLiteral_Literal, gen_stext_StringLiteral_Literal, gen_stext_ConditionalExpression_Expression, gen_stext_LogicalOrExpression_Expression, gen_stext_SimpleScope_Scope, gen_stext_ReactionTrigger_Trigger, gen_stext_ReactionEffect_Effect, gen_stext_EventRaisingExpression_Expression, gen_stext_AssignmentExpression_Expression, gen_stext_BitwiseXorExpression_Expression, gen_stext_BitwiseOrExpression_Expression, gen_stext_BitwiseAndExpression_Expression, gen_stext_LogicalAndExpression_Expression, gen_stext_LogicalNotExpression_Expression, gen_stext_NumericalAddSubtractExpression_Expression, gen_stext_NumericalMultiplyDivideExpression_Expression, gen_stext_LogicalRelationExpression_Expression, gen_stext_ShiftExpression_Expression, gen_stext_ElementReferenceExpression_Expression, gen_stext_NumericalUnaryExpression_Expression, gen_stext_PrimitiveValueExpression_Expression, gen_stext_FeatureCall_Expression, gen_stext_EventValueReferenceExpression_Expression, gen_stext_ActiveStateReferenceExpression_Expression, gen_stext_ParenthesizedExpression_Expression},
    metadata=None
)
