...
class stext_NumericalMultiplyDivideExpression(Expression):
    ...
    def __init__(self, operator: str, stext_NumericalMultiplyDivideExpression: "stext_Expression" = None, stext_NumericalMultiplyDivideExpression82: "stext_Expression" = None):
...
class stext_ShiftExpression(Expression):
    ...
    def __init__(self, operator: str, stext_ShiftExpression72: "stext_Expression" = None, stext_ShiftExpression: "stext_Expression" = None):
        self.operator = operator
...
class stext_FeatureCall(Expression):
    ...
    def __init__(self, operationCall: bool, stext_FeatureCall: "stext_Expression" = None, stext_FeatureCall90: "stext_EObject" = None, stext_FeatureCall92: set["stext_Expression"] = None):
        self.operationCall = operationCall
