...
# Classes
logo_ProgramUnit = Class(name="logo_ProgramUnit")
logo_Command = Class(name="logo_Command", is_abstract=True)
logo_Move = Class(name="logo_Move")
Command = Class(name="Command")
logo_Turn = Class(name="logo_Turn")
logo_WhileNoObstacle = Class(name="logo_WhileNoObstacle")
...
domain_model = DomainModel(
    name="logo",
    types={logo_ProgramUnit, logo_Command, logo_Move, Command, logo_Turn, logo_WhileNoObstacle},
