...
gaml_S_Try = Class(name="gaml_S_Try")
...
gaml_BinaryOperator = Class(name="gaml_BinaryOperator")
...
gaml_HeadlessExperiment.attributes={gaml_HeadlessExperiment_name, gaml_HeadlessExperiment_firstFacet, gaml_HeadlessExperiment_key, gaml_HeadlessExperiment_importURI}
...
else_25: BinaryAssociation = BinaryAssociation(
    name="else_25",
    ends={
...
domain_model = DomainModel(
    name="gaml",
    types={gaml_Facet, gaml_Entry, gaml_StandaloneBlock, Entry, gaml_Block, gaml_StringEvaluator, gaml_Expression, gaml_Model, VarDefinition, gaml_Pragma, gaml_Import, gaml_Statement, gaml_ExperimentFileStructure, gaml_HeadlessExperiment, gaml_S_Assignment, gaml_S_DirectAssignment, S_Assignment, gaml_S_Set, gaml_S_Equations, EquationDefinition, gaml_S_Global, Statement, gaml_S_Species, S_Declaration, TypeDefinition, gaml_S_Experiment, gaml_S_Do, gaml_S_Loop, gaml_S_If, gaml_EObject, gaml_S_Try, gaml_S_Other, gaml_S_Return, gaml_S_Declaration, gaml_S_Reflex, gaml_S_Definition, ActionDefinition, gaml_ActionArguments, gaml_GamlDefinition, gaml_EquationDefinition, GamlDefinition, gaml_TypeDefinition, gaml_ActionDefinition, gaml_UnitFakeDefinition, gaml_TypeFakeDefinition, gaml_S_Solve, gaml_S_Display, gaml_speciesOrGridDisplayStatement, gaml_ArgumentDefinition, gaml_ArgumentPair, Expression, gaml_ExpressionList, gaml_VariableRef, gaml_VarDefinition, gaml_TypeInfo, gaml_Access, gaml_Array, gaml_ActionFakeDefinition, gaml_SkillFakeDefinition, gaml_VarFakeDefinition, gaml_EquationFakeDefinition, gaml_TerminalExpression, gaml_StringLiteral, TerminalExpression, gaml_S_Action, S_Definition, gaml_S_Var, gaml_BinaryOperator, gaml_If, gaml_Unit, gaml_Unary, gaml_SkillRef, gaml_ActionRef, gaml_EquationRef, gaml_Point, gaml_Function, gaml_Parameter, gaml_UnitName, gaml_TypeRef, gaml_IntLiteral, gaml_DoubleLiteral, gaml_BooleanLiteral, gaml_ReservedLiteral},
    associations={facets11, block13, block0, expr1, pragmas2, imports3, block5, statements8, exp10, value32, equations34, expr16, facets19, block22, else_25, catch26, tkey28, args30, args36, type38, default41, expr44, block47, right50, exprs52, ref54, first55, second57, left80, right82, left60, right62, left65, right67, ifFalse70, left73, right75, right78, parameter110, ref113, ref114, exprs85, left87, right89, z92, left95, type97, right100, left103, right105, ref108, ref109, ref115},
    generalizations={gen_gaml_StandaloneBlock_Entry, gen_gaml_StringEvaluator_Entry, gen_gaml_Model_Entry, gen_gaml_Model_VarDefinition, gen_gaml_Import_VarDefinition, gen_gaml_ExperimentFileStructure_Entry, gen_gaml_S_Assignment_Statement, gen_gaml_S_DirectAssignment_S_Assignment, gen_gaml_S_Set_S_Assignment, gen_gaml_S_Equations_Statement, gen_gaml_S_Equations_EquationDefinition, gen_gaml_S_Global_Statement, gen_gaml_S_Species_Statement, gen_gaml_S_Species_S_Declaration, gen_gaml_S_Species_TypeDefinition, gen_gaml_S_Experiment_Statement, gen_gaml_S_Experiment_VarDefinition, gen_gaml_S_Do_Statement, gen_gaml_S_Loop_S_Declaration, gen_gaml_S_If_Statement, gen_gaml_S_Try_Statement, gen_gaml_S_Other_Statement, gen_gaml_S_Return_Statement, gen_gaml_S_Declaration_Statement, gen_gaml_S_Declaration_VarDefinition, gen_gaml_S_Reflex_S_Declaration, gen_gaml_S_Definition_S_Declaration, gen_gaml_S_Definition_ActionDefinition, gen_gaml_EquationDefinition_GamlDefinition, gen_gaml_TypeDefinition_GamlDefinition, gen_gaml_TypeDefinition_ActionDefinition, gen_gaml_VarDefinition_GamlDefinition, gen_gaml_ActionDefinition_GamlDefinition, gen_gaml_UnitFakeDefinition_GamlDefinition, gen_gaml_TypeFakeDefinition_TypeDefinition, gen_gaml_S_Solve_Statement, gen_gaml_S_Display_Statement, gen_gaml_speciesOrGridDisplayStatement_Statement, gen_gaml_ArgumentDefinition_VarDefinition, gen_gaml_Facet_VarDefinition, gen_gaml_ArgumentPair_Expression, gen_gaml_ExpressionList_Expression, gen_gaml_VariableRef_Expression, gen_gaml_Access_Expression, gen_gaml_Array_Expression, gen_gaml_ActionFakeDefinition_ActionDefinition, gen_gaml_SkillFakeDefinition_GamlDefinition, gen_gaml_VarFakeDefinition_VarDefinition, gen_gaml_EquationFakeDefinition_EquationDefinition, gen_gaml_TerminalExpression_Expression, gen_gaml_StringLiteral_TerminalExpression, gen_gaml_S_Action_S_Definition, gen_gaml_S_Var_S_Definition, gen_gaml_BinaryOperator_Expression, gen_gaml_If_Expression, gen_gaml_Unit_Expression, gen_gaml_Unary_Expression, gen_gaml_SkillRef_Expression, gen_gaml_ActionRef_Expression, gen_gaml_EquationRef_Expression, gen_gaml_Point_Expression, gen_gaml_Function_Expression, gen_gaml_Parameter_Expression, gen_gaml_UnitName_Expression, gen_gaml_TypeRef_Expression, gen_gaml_IntLiteral_TerminalExpression, gen_gaml_DoubleLiteral_TerminalExpression, gen_gaml_BooleanLiteral_TerminalExpression, gen_gaml_ReservedLiteral_TerminalExpression},
    metadata=None
)
