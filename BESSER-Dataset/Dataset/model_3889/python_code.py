...
class gaml_ActionFakeDefinition(ActionDefinition):
    ...
    pass
class gaml_TypeDefinition(ActionDefinition, GamlDefinition):
...
class gaml_HeadlessExperiment:
    ...
    def __init__(self, name: str, importURI: str, key: str, firstFacet: str, gaml_HeadlessExperiment12: set["gaml_Facet"] = None, gaml_HeadlessExperiment14: "gaml_Block" = None, gaml_HeadlessExperiment: "gaml_ExperimentFileStructure" = None):
        self.name = name
...
class gaml_Statement:
    ...
    def __init__(self, key: str, firstFacet: str, gaml_Statement23: "gaml_Block" = None, gaml_Statement: "gaml_Block" = None, gaml_Statement17: "gaml_Expression" = None, gaml_Statement20: set["gaml_Facet"] = None):
        self.key = key
        self.firstFacet = firstFacet
...
class gaml_Facet(VarDefinition):
    ...
    def __init__(self, key: str, gaml_Facet45: "gaml_Expression" = None, gaml_Facet48: "gaml_Block" = None, gaml_Facet: "gaml_HeadlessExperiment" = None, gaml_Facet21: "gaml_Statement" = None):
        self.key = key
