...
# Classes
emig_MyModel = Class(name="emig_MyModel")
emig_MigrationLibrary = Class(name="emig_MigrationLibrary")
emig_MigrationProgram = Class(name="emig_MigrationProgram")
emig_Rule = Class(name="emig_Rule")
emig_Artifact = Class(name="emig_Artifact")
emig_setterDef = Class(name="emig_setterDef")
emig_EPackageOpDef = Class(name="emig_EPackageOpDef")
OpDef = Class(name="OpDef")
emig_EClassOpDef = Class(name="emig_EClassOpDef")
emig_EClass = Class(name="emig_EClass")
emig_EAttributeOpDef = Class(name="emig_EAttributeOpDef")
emig_EReferenceOpDef = Class(name="emig_EReferenceOpDef")
emig_EAttribute = Class(name="emig_EAttribute")
emig_EReference = Class(name="emig_EReference")
emig_EStructuralFeature = Class(name="emig_EStructuralFeature")
emig_EPackage = Class(name="emig_EPackage")
emig_OpDef = Class(name="emig_OpDef")
emig_RewritingRule = Class(name="emig_RewritingRule")
emig_FilterMigrator = Class(name="emig_FilterMigrator")
emig_OclExpression = Class(name="emig_OclExpression")
emig_DotNavigationObjSX = Class(name="emig_DotNavigationObjSX")
emig_EObject = Class(name="emig_EObject")
emig_DotNavigationObjDX = Class(name="emig_DotNavigationObjDX")
emig_Package = Class(name="emig_Package")
EPackage = Class(name="EPackage")
emig_Class = Class(name="emig_Class")
EClass = Class(name="EClass")
emig_Attribute = Class(name="emig_Attribute")
EAttribute = Class(name="EAttribute")
emig_Reference = Class(name="emig_Reference")
EReference = Class(name="EReference")
emig_NavigationOrAttributeCallExp = Class(name="emig_NavigationOrAttributeCallExp")
OclExpression = Class(name="OclExpression")
emig_VariableExp = Class(name="emig_VariableExp")
VariableExp = Class(name="VariableExp")
emig_SuperExp = Class(name="emig_SuperExp")
emig_Parameter = Class(name="emig_Parameter")
emig_MigratorSX = Class(name="emig_MigratorSX")
emig_MigratorDX = Class(name="emig_MigratorDX")
emig_Migrator = Class(name="emig_Migrator")
Migrator = Class(name="Migrator")
emig_VariableDeclaration = Class(name="emig_VariableDeclaration")
SuperExp = Class(name="SuperExp")
emig_BagExp = Class(name="emig_BagExp")
BagExp = Class(name="BagExp")
emig_OrderedSetExp = Class(name="emig_OrderedSetExp")
OrderedSetExp = Class(name="OrderedSetExp")
emig_SequenceExp = Class(name="emig_SequenceExp")
SequenceExp = Class(name="SequenceExp")
emig_SetExp = Class(name="emig_SetExp")
SetExp = Class(name="SetExp")
emig_TupleExp = Class(name="emig_TupleExp")
TupleExp = Class(name="TupleExp")
emig_MapExp = Class(name="emig_MapExp")
MapExp = Class(name="MapExp")
emig_OclUndefinedExp = Class(name="emig_OclUndefinedExp")
...
domain_model = DomainModel(
    name="emig",
    types={emig_MyModel, emig_MigrationLibrary, emig_MigrationProgram, emig_Rule, emig_Artifact, emig_setterDef, emig_EPackageOpDef, OpDef, emig_EClassOpDef, emig_EClass, emig_EAttributeOpDef, emig_EReferenceOpDef, emig_EAttribute, emig_EReference, emig_EStructuralFeature, emig_EPackage, emig_OpDef, emig_RewritingRule, emig_FilterMigrator, emig_OclExpression, emig_DotNavigationObjSX, emig_EObject, emig_DotNavigationObjDX, emig_Package, EPackage, emig_Class, EClass, emig_Attribute, EAttribute, emig_Reference, EReference, emig_NavigationOrAttributeCallExp, OclExpression, emig_VariableExp, VariableExp, emig_SuperExp, emig_Parameter, emig_MigratorSX, emig_MigratorDX, emig_Migrator, Migrator, emig_VariableDeclaration, SuperExp, emig_BagExp, BagExp, emig_OrderedSetExp, OrderedSetExp, emig_SequenceExp, SequenceExp, emig_SetExp, SetExp, emig_TupleExp, TupleExp, emig_MapExp, MapExp, emig_OclUndefinedExp, OclUndefinedExp},
    associations={migrationLib0, MigrationProgr1, rules3, typeArt5, setters16, var18, ref20, classes23, var25, ref27, attributes30, references32, var34, ref36, var39, ref41, metafeature44, transformationPackage7, rules9, filter12, rewritingRules14, elementSX57, filterSX60, elementDX62, filterDX65, specification68, obj70, ref71, obj74, ref76, src79, par46, migratorsSX48, migratorDX50, migratorSX52, name55},
    generalizations={gen_emig_EPackageOpDef_OpDef, gen_emig_EClassOpDef_OpDef, gen_emig_EAttributeOpDef_OpDef, gen_emig_EReferenceOpDef_OpDef, gen_emig_MigratorDX_Migrator, gen_emig_Package_EPackage, gen_emig_Class_EClass, gen_emig_Attribute_EAttribute, gen_emig_Reference_EReference, gen_emig_NavigationOrAttributeCallExp_OclExpression, gen_emig_VariableExp_VariableExp, gen_emig_MigratorSX_Migrator, gen_emig_SuperExp_SuperExp, gen_emig_BagExp_BagExp, gen_emig_OrderedSetExp_OrderedSetExp, gen_emig_SequenceExp_SequenceExp, gen_emig_SetExp_SetExp, gen_emig_TupleExp_TupleExp, gen_emig_MapExp_MapExp, gen_emig_OclUndefinedExp_OclUndefinedExp},
    metadata=None
)
