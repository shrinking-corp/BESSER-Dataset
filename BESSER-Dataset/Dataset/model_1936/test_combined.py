...
def test_hyp_oclundefinedexp_is_not_abstract():
    assert not inspect.isabstract(OclUndefinedExp)


def test_hyp_oclundefinedexp_constructor_exists():
    assert callable(OclUndefinedExp.__init__)


def test_hyp_oclundefinedexp_constructor_args():
    sig = inspect.signature(OclUndefinedExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emig_oclundefinedexp_is_not_abstract():
    assert not inspect.isabstract(emig_OclUndefinedExp)


def test_hyp_emig_oclundefinedexp_constructor_exists():
    assert callable(emig_OclUndefinedExp.__init__)


def test_hyp_emig_oclundefinedexp_constructor_args():
...
def test_hyp_emig_mapexp_is_not_abstract():
    assert not inspect.isabstract(emig_MapExp)


def test_hyp_emig_mapexp_constructor_exists():
    assert callable(emig_MapExp.__init__)


def test_hyp_emig_mapexp_constructor_args():
...
def test_hyp_emig_tupleexp_is_not_abstract():
    assert not inspect.isabstract(emig_TupleExp)


def test_hyp_emig_tupleexp_constructor_exists():
    assert callable(emig_TupleExp.__init__)


def test_hyp_emig_tupleexp_constructor_args():
    sig = inspect.signature(emig_TupleExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_setexp_is_not_abstract():
    assert not inspect.isabstract(SetExp)


def test_hyp_setexp_constructor_exists():
    assert callable(SetExp.__init__)


def test_hyp_setexp_constructor_args():
    sig = inspect.signature(SetExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emig_setexp_is_not_abstract():
    assert not inspect.isabstract(emig_SetExp)


def test_hyp_emig_setexp_constructor_exists():
    assert callable(emig_SetExp.__init__)


def test_hyp_emig_setexp_constructor_args():
    sig = inspect.signature(emig_SetExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_sequenceexp_is_not_abstract():
    assert not inspect.isabstract(SequenceExp)


def test_hyp_sequenceexp_constructor_exists():
    assert callable(SequenceExp.__init__)


def test_hyp_sequenceexp_constructor_args():
    sig = inspect.signature(SequenceExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emig_sequenceexp_is_not_abstract():
    assert not inspect.isabstract(emig_SequenceExp)


def test_hyp_emig_sequenceexp_constructor_exists():
    assert callable(emig_SequenceExp.__init__)


def test_hyp_emig_sequenceexp_constructor_args():
    sig = inspect.signature(emig_SequenceExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_orderedsetexp_is_not_abstract():
    assert not inspect.isabstract(OrderedSetExp)


def test_hyp_orderedsetexp_constructor_exists():
    assert callable(OrderedSetExp.__init__)


def test_hyp_orderedsetexp_constructor_args():
    sig = inspect.signature(OrderedSetExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emig_orderedsetexp_is_not_abstract():
    assert not inspect.isabstract(emig_OrderedSetExp)


def test_hyp_emig_orderedsetexp_constructor_exists():
    assert callable(emig_OrderedSetExp.__init__)


def test_hyp_emig_orderedsetexp_constructor_args():
    sig = inspect.signature(emig_OrderedSetExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_bagexp_is_not_abstract():
    assert not inspect.isabstract(BagExp)


def test_hyp_bagexp_constructor_exists():
    assert callable(BagExp.__init__)


def test_hyp_bagexp_constructor_args():
    sig = inspect.signature(BagExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emig_bagexp_is_not_abstract():
    assert not inspect.isabstract(emig_BagExp)


def test_hyp_emig_bagexp_constructor_exists():
    assert callable(emig_BagExp.__init__)


def test_hyp_emig_bagexp_constructor_args():
    sig = inspect.signature(emig_BagExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_superexp_is_not_abstract():
    assert not inspect.isabstract(SuperExp)


def test_hyp_superexp_constructor_exists():
    assert callable(SuperExp.__init__)


def test_hyp_superexp_constructor_args():
    sig = inspect.signature(SuperExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emig_variabledeclaration_is_not_abstract():
    assert not inspect.isabstract(emig_VariableDeclaration)


def test_hyp_emig_variabledeclaration_constructor_exists():
    assert callable(emig_VariableDeclaration.__init__)


def test_hyp_emig_variabledeclaration_constructor_args():
...
def test_hyp_emig_superexp_is_not_abstract():
    assert not inspect.isabstract(emig_SuperExp)


def test_hyp_emig_superexp_constructor_exists():
    assert callable(emig_SuperExp.__init__)


def test_hyp_emig_superexp_constructor_args():
...
def test_hyp_emig_variableexp_is_not_abstract():
    assert not inspect.isabstract(emig_VariableExp)


def test_hyp_emig_variableexp_constructor_exists():
    assert callable(emig_VariableExp.__init__)


def test_hyp_emig_variableexp_constructor_args():
...
def test_hyp_emig_navigationorattributecallexp_is_not_abstract():
    assert not inspect.isabstract(emig_NavigationOrAttributeCallExp)


def test_hyp_emig_navigationorattributecallexp_constructor_exists():
    assert callable(emig_NavigationOrAttributeCallExp.__init__)


def test_hyp_emig_navigationorattributecallexp_constructor_args():
...
def test_hyp_emig_oclexpression_is_not_abstract():
    assert not inspect.isabstract(emig_OclExpression)


def test_hyp_emig_oclexpression_constructor_exists():
    assert callable(emig_OclExpression.__init__)


def test_hyp_emig_oclexpression_constructor_args():
...
def test_hyp_emig_migratordx_name_setter(instance):
...
def test_hyp_emig_migrationlibrary_title_setter(instance):
...
def test_emig_MigrationLibrary_title_value_roundtrip():
    instance = emig_MigrationLibrary(title="sample_text")
...
def test_emig_MigrationProgram_delta_value_roundtrip():
    instance = emig_MigrationProgram(delta="sample_text", libs="sample_text", migr="sample_text", name="sample_text")
...
def test_emig_MigratorDX_name_value_roundtrip():
    instance = emig_MigratorDX(name="sample_text")
    assert instance.name == "sample_text"
    instance.name = "sample_text_2"
    assert instance.name == "sample_text_2"
...
def test_emig_BagExp_isa_BagExp():
    instance = emig_BagExp()
...
def test_emig_MapExp_isa_MapExp():
    instance = emig_MapExp()
...
def test_emig_NavigationOrAttributeCallExp_isa_OclExpression():
    instance = emig_NavigationOrAttributeCallExp()
    assert isinstance(instance, OclExpression)


def test_emig_OclUndefinedExp_isa_OclUndefinedExp():
    instance = emig_OclUndefinedExp()
...
def test_emig_OrderedSetExp_isa_OrderedSetExp():
    instance = emig_OrderedSetExp()
    assert isinstance(instance, OrderedSetExp)


def test_emig_SequenceExp_isa_SequenceExp():
    instance = emig_SequenceExp()
    assert isinstance(instance, SequenceExp)


def test_emig_SetExp_isa_SetExp():
    instance = emig_SetExp()
    assert isinstance(instance, SetExp)


def test_emig_SuperExp_isa_SuperExp():
    instance = emig_SuperExp()
    assert isinstance(instance, SuperExp)


def test_emig_TupleExp_isa_TupleExp():
    instance = emig_TupleExp()
    assert isinstance(instance, TupleExp)


def test_emig_VariableExp_isa_VariableExp():
    instance = emig_VariableExp()
    assert isinstance(instance, VariableExp)


def test_assoc_MigrationProgr1_link_reassign_clear():
    a = emig_MigrationProgram(delta="sample_text", libs="sample_text", migr="sample_text", name="sample_text")
    b1 = emig_MyModel()
    b2 = emig_MyModel()
...
def test_assoc_elementDX62_link_reassign_clear():
    a = emig_MigratorDX(name="sample_text")
    b1 = emig_EClass()
    b2 = emig_EClass()
    _safe_set(a, 'emig_MigratorDX63', b1)
    assert _is_linked(a, 'emig_MigratorDX63', b1)
    if hasattr(b1, 'emig_EClass64'):
        assert _is_linked(b1, 'emig_EClass64', a)
    _safe_set(a, 'emig_MigratorDX63', b2)
    assert _is_linked(a, 'emig_MigratorDX63', b2)
    if hasattr(b1, 'emig_EClass64'):
        assert not _is_linked(b1, 'emig_EClass64', a)
    if hasattr(b2, 'emig_EClass64'):
        assert _is_linked(b2, 'emig_EClass64', a)
    _safe_set(a, 'emig_MigratorDX63', None)
    assert not _is_linked(a, 'emig_MigratorDX63', b2)
    if hasattr(b2, 'emig_EClass64'):
        assert not _is_linked(b2, 'emig_EClass64', a)
...
def test_assoc_filterDX65_link_reassign_clear():
    a = emig_MigratorDX(name="sample_text")
    b1 = emig_FilterMigrator()
    b2 = emig_FilterMigrator()
    _safe_set(a, 'emig_MigratorDX66', {b1})
    assert _is_linked(a, 'emig_MigratorDX66', b1)
    if hasattr(b1, 'emig_FilterMigrator67'):
        assert _is_linked(b1, 'emig_FilterMigrator67', a)
    _safe_set(a, 'emig_MigratorDX66', {b2})
    assert _is_linked(a, 'emig_MigratorDX66', b2)
    if hasattr(b1, 'emig_FilterMigrator67'):
        assert not _is_linked(b1, 'emig_FilterMigrator67', a)
    if hasattr(b2, 'emig_FilterMigrator67'):
        assert _is_linked(b2, 'emig_FilterMigrator67', a)
    _safe_set(a, 'emig_MigratorDX66', set())
    assert not _is_linked(a, 'emig_MigratorDX66', b2)
    if hasattr(b2, 'emig_FilterMigrator67'):
        assert not _is_linked(b2, 'emig_FilterMigrator67', a)
...
def test_assoc_migrationLib0_link_reassign_clear():
    a = emig_MigrationLibrary(title="sample_text")
    b1 = emig_MyModel()
    b2 = emig_MyModel()
...
def test_assoc_migratorDX50_link_reassign_clear():
    a = emig_MigratorDX(name="sample_text")
    b1 = emig_RewritingRule()
    b2 = emig_RewritingRule()
    _safe_set(a, 'emig_MigratorDX', b1)
    assert _is_linked(a, 'emig_MigratorDX', b1)
    if hasattr(b1, 'emig_RewritingRule51'):
        assert _is_linked(b1, 'emig_RewritingRule51', a)
    _safe_set(a, 'emig_MigratorDX', b2)
    assert _is_linked(a, 'emig_MigratorDX', b2)
    if hasattr(b1, 'emig_RewritingRule51'):
        assert not _is_linked(b1, 'emig_RewritingRule51', a)
    if hasattr(b2, 'emig_RewritingRule51'):
        assert _is_linked(b2, 'emig_RewritingRule51', a)
    _safe_set(a, 'emig_MigratorDX', None)
    assert not _is_linked(a, 'emig_MigratorDX', b2)
    if hasattr(b2, 'emig_RewritingRule51'):
        assert not _is_linked(b2, 'emig_RewritingRule51', a)
...
def test_assoc_rules3_link_reassign_clear():
    a = emig_Rule(name="sample_text")
    b1 = emig_MigrationLibrary(title="sample_text")
    b2 = emig_MigrationLibrary(title="sample_text_2")
...
def test_assoc_rules9_link_reassign_clear():
    a = emig_Rule(name="sample_text")
    b1 = emig_MigrationProgram(delta="sample_text", libs="sample_text", migr="sample_text", name="sample_text")
    b2 = emig_MigrationProgram(delta="sample_text_2", libs="sample_text_2", migr="sample_text_2", name="sample_text_2")
...
BagExp_strategy = st.builds(BagExp)
...
OclUndefinedExp_strategy = st.builds(OclUndefinedExp)
...
OrderedSetExp_strategy = st.builds(OrderedSetExp)
...
SequenceExp_strategy = st.builds(SequenceExp)
...
SetExp_strategy = st.builds(SetExp)
...
SuperExp_strategy = st.builds(SuperExp)
...
emig_BagExp_strategy = st.builds(emig_BagExp)
...
emig_FilterMigrator_strategy = st.builds(emig_FilterMigrator)
...
emig_MapExp_strategy = st.builds(emig_MapExp)
...
emig_MigrationLibrary_strategy = st.builds(emig_MigrationLibrary, title=safe_text)
@given(instance=emig_MigrationLibrary_strategy)
@settings(max_examples=25)
...
emig_MigrationProgram_strategy = st.builds(emig_MigrationProgram, delta=safe_text, libs=safe_text, migr=safe_text, name=safe_text)
@given(instance=emig_MigrationProgram_strategy)
@settings(max_examples=25)
...
emig_Migrator_strategy = st.builds(emig_Migrator)
...
emig_MigratorDX_strategy = st.builds(emig_MigratorDX, name=safe_text)
@given(instance=emig_MigratorDX_strategy)
@settings(max_examples=25)
...
emig_NavigationOrAttributeCallExp_strategy = st.builds(emig_NavigationOrAttributeCallExp)
...
emig_OclExpression_strategy = st.builds(emig_OclExpression)
...
emig_OclUndefinedExp_strategy = st.builds(emig_OclUndefinedExp)
...
emig_OrderedSetExp_strategy = st.builds(emig_OrderedSetExp)
...
emig_SequenceExp_strategy = st.builds(emig_SequenceExp)
...
emig_SetExp_strategy = st.builds(emig_SetExp)
...
emig_SuperExp_strategy = st.builds(emig_SuperExp)
...
emig_TupleExp_strategy = st.builds(emig_TupleExp)
...
emig_VariableDeclaration_strategy = st.builds(emig_VariableDeclaration)
...
emig_VariableExp_strategy = st.builds(emig_VariableExp)
