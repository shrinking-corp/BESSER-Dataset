...
class effbdpattern_Keyword:
    ...
    def __init__(self, value: str, effbdpattern_Keyword: "effbdpattern_Workbench" = None, effbdpattern_Keyword60: "effbdpattern_Indexable" = None):
        self.value = value
...
class effbdpattern_PatternCatalog:
    ...
    def __init__(self, id: str, effbdpattern_PatternCatalog55: "effbdpattern_Workbench" = None, effbdpattern_PatternCatalog: set["effbdpattern_Function"] = None, effbdpattern_PatternCatalog36: set["effbdpattern_SystemPattern"] = None):
        self.id = id
...
class effbdpattern_Condition:
    ...
    def __init__(self, name: str, effbdpattern_Condition: "effbdpattern_Workbench" = None, effbdpattern_Condition89: "effbdpattern_Force" = None, effbdpattern_Condition67: "effbdpattern_Context" = None):
        self.name = name
...
class effbdpattern_Feature:
    ...
    def __init__(self, name: str, description: str, effbdpattern_Feature: "effbdpattern_Workbench" = None, effbdpattern_Feature98: "effbdpattern_Impact" = None, effbdpattern_Feature95: "effbdpattern_Problem" = None):
        self.name = name
...
class effbdpattern_FunctionProperty:
    ...
    def __init__(self, description: str, effbdpattern_FunctionProperty32: "effbdpattern_FunctionProperty" = None, effbdpattern_FunctionProperty30: "effbdpattern_FunctionProperty" = None, effbdpattern_FunctionProperty38: "effbdpattern_Workbench" = None, effbdpattern_FunctionProperty: "effbdpattern_Function" = None):
        self.description = description
...
class effbdpattern_Sequence(SequenceNode):
    ...
    pass
class effbdpattern_Function(ModelElement, SequenceNode):

    def __init__(self, domain: str, Function: "effbdpattern_Function" = None, parent: set["effbdpattern_Function"] = None, effbdpattern_Function: set["effbdpattern_Sequence"] = None, effbdpattern_Function4: set["effbdpattern_Flow"] = None, effbdpattern_Function6: set["effbdpattern_OutputPort"] = None, effbdpattern_Function8: set["effbdpattern_InputPort"] = None, effbdpattern_Function10: set["effbdpattern_Description"] = None, effbdpattern_Function12: set["effbdpattern_Token"] = None, effbdpattern_Function34: "effbdpattern_PatternCatalog" = None, effbdpattern_Function14: set["effbdpattern_FunctionProperty"] = None, Function17: "effbdpattern_Function" = None, decompositions: "effbdpattern_Function" = None, effbdpattern_Function69: "effbdpattern_PatternModel" = None, effbdpattern_Function136: "effbdpattern_Model" = None, effbdpattern_Function142: "effbdpattern_Allocation" = None):
        self.domain = domain
...
class effbdpattern_Force:
    ...
    def __init__(self, value: int, scale: int, description: str, effbdpattern_Force: "effbdpattern_Condition" = None, Force: "effbdpattern_Problem" = None, forces: "effbdpattern_Problem" = None):
        self.value = value
        self.scale = scale
        self.description = description
...
class effbdpattern_SystemPattern(Indexable):
    ...
    def __init__(self, patternId: int, name: str, alias: str, challeng: str, description: str, creationDate: date, knownApplications: str, effbdpattern_SystemPattern: "effbdpattern_PatternCatalog" = None, SystemPattern: "effbdpattern_ModelElement" = None, SystemPattern100: "effbdpattern_Impact" = None, effbdpattern_SystemPattern102: set["effbdpattern_Parameter"] = None, effbdpattern_SystemPattern105: "effbdpattern_Context" = None, effbdpattern_SystemPattern108: "effbdpattern_Problem" = None, effbdpattern_SystemPattern126: "effbdpattern_PatternModel" = None, pattern: set["effbdpattern_Impact"] = None, pattern130: "effbdpattern_ModelElement" = None, effbdpattern_SystemPattern118: "effbdpattern_SystemPattern" = None, effbdpattern_SystemPattern116: set["effbdpattern_SystemPattern"] = None, effbdpattern_SystemPattern121: "effbdpattern_SystemPattern" = None, effbdpattern_SystemPattern119: set["effbdpattern_SystemPattern"] = None, effbdpattern_SystemPattern124: "effbdpattern_SystemPattern" = None, effbdpattern_SystemPattern122: set["effbdpattern_SystemPattern"] = None, effbdpattern_SystemPattern111: "effbdpattern_Domain" = None, effbdpattern_SystemPattern115: "effbdpattern_SystemPattern" = None, effbdpattern_SystemPattern113: set["effbdpattern_SystemPattern"] = None):
...
class effbdpattern_Context(Indexable):
    ...
    def __init__(self, description: str, effbdpattern_Context: "effbdpattern_Workbench" = None, effbdpattern_Context106: "effbdpattern_SystemPattern" = None, effbdpattern_Context66: set["effbdpattern_Condition"] = None):
        self.description = description
...
class effbdpattern_Problem(Indexable):
    ...
    def __init__(self, name: str, description: str, effbdpattern_Problem: "effbdpattern_Workbench" = None, effbdpattern_Problem109: "effbdpattern_SystemPattern" = None, effbdpattern_Problem91: set["effbdpattern_PatternModel"] = None, effbdpattern_Problem94: set["effbdpattern_Feature"] = None, problem: set["effbdpattern_Force"] = None, Problem: "effbdpattern_Force" = None):
        self.name = name
        self.description = description
...
class effbdpattern_ModelElement(Indexable):
    ...
    def __init__(self, modelId: int, modelName: str, effbdpattern_ModelElement: "effbdpattern_Parameter" = None, effbdpattern_ModelElement64: "effbdpattern_Parameter" = None, modelElement: "effbdpattern_SystemPattern" = None, ModelElement: "effbdpattern_SystemPattern" = None):
