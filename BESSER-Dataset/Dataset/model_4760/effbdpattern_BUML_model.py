...
# Classes
effbdpattern_Function = Class(name="effbdpattern_Function")
SequenceNode = Class(name="SequenceNode")
ModelElement = Class(name="ModelElement")
effbdpattern_Sequence = Class(name="effbdpattern_Sequence", is_abstract=True)
effbdpattern_Flow = Class(name="effbdpattern_Flow")
effbdpattern_OutputPort = Class(name="effbdpattern_OutputPort")
effbdpattern_InputPort = Class(name="effbdpattern_InputPort")
effbdpattern_Description = Class(name="effbdpattern_Description")
effbdpattern_Token = Class(name="effbdpattern_Token")
effbdpattern_Port = Class(name="effbdpattern_Port", is_abstract=True)
effbdpattern_FunctionProperty = Class(name="effbdpattern_FunctionProperty")
effbdpattern_Item = Class(name="effbdpattern_Item")
effbdpattern_SequenceNode = Class(name="effbdpattern_SequenceNode", is_abstract=True)
effbdpattern_And = Class(name="effbdpattern_And")
Sequence = Class(name="Sequence")
effbdpattern_Or = Class(name="effbdpattern_Or")
effbdpattern_Start = Class(name="effbdpattern_Start")
effbdpattern_Final = Class(name="effbdpattern_Final")
effbdpattern_Loop = Class(name="effbdpattern_Loop")
Port = Class(name="Port")
effbdpattern_LoopExit = Class(name="effbdpattern_LoopExit")
effbdpattern_Iteration = Class(name="effbdpattern_Iteration")
effbdpattern_Feature = Class(name="effbdpattern_Feature")
effbdpattern_Condition = Class(name="effbdpattern_Condition")
effbdpattern_Context = Class(name="effbdpattern_Context")
effbdpattern_Model = Class(name="effbdpattern_Model")
effbdpattern_PatternCatalog = Class(name="effbdpattern_PatternCatalog")
effbdpattern_SystemPattern = Class(name="effbdpattern_SystemPattern")
effbdpattern_Workbench = Class(name="effbdpattern_Workbench")
effbdpattern_Problem = Class(name="effbdpattern_Problem")
effbdpattern_Domain = Class(name="effbdpattern_Domain")
effbdpattern_Keyword = Class(name="effbdpattern_Keyword")
effbdpattern_Allocation = Class(name="effbdpattern_Allocation")
effbdpattern_ModelElement = Class(name="effbdpattern_ModelElement", is_abstract=True)
Indexable = Class(name="Indexable")
effbdpattern_Indexable = Class(name="effbdpattern_Indexable", is_abstract=True)
effbdpattern_Parameter = Class(name="effbdpattern_Parameter")
effbdpattern_AbstractModel = Class(name="effbdpattern_AbstractModel", is_abstract=True)
effbdpattern_Force = Class(name="effbdpattern_Force")
effbdpattern_PatternModel = Class(name="effbdpattern_PatternModel")
AbstractModel = Class(name="AbstractModel")
effbdpattern_Component = Class(name="effbdpattern_Component")
effbdpattern_Impact = Class(name="effbdpattern_Impact")
...
effbdpattern_SequenceNode.attributes={effbdpattern_SequenceNode_tMin, effbdpattern_SequenceNode_tMax, effbdpattern_SequenceNode_name}
...
effbdpattern_Feature.attributes={effbdpattern_Feature_name, effbdpattern_Feature_description}
...
effbdpattern_SystemPattern.attributes={effbdpattern_SystemPattern_knownApplications, effbdpattern_SystemPattern_creationDate, effbdpattern_SystemPattern_description, effbdpattern_SystemPattern_name, effbdpattern_SystemPattern_patternId, effbdpattern_SystemPattern_alias, effbdpattern_SystemPattern_challeng}
...
effbdpattern_Problem.attributes={effbdpattern_Problem_name, effbdpattern_Problem_description}
...
effbdpattern_Allocation.attributes={effbdpattern_Allocation_redundant, effbdpattern_Allocation_id}
...
effbdpattern_AbstractModel.attributes={effbdpattern_AbstractModel_version, effbdpattern_AbstractModel_name}
...
domain_model = DomainModel(
    name="effbdpattern",
    types={effbdpattern_Function, SequenceNode, ModelElement, effbdpattern_Sequence, effbdpattern_Flow, effbdpattern_OutputPort, effbdpattern_InputPort, effbdpattern_Description, effbdpattern_Token, effbdpattern_Port, effbdpattern_FunctionProperty, effbdpattern_Item, effbdpattern_SequenceNode, effbdpattern_And, Sequence, effbdpattern_Or, effbdpattern_Start, effbdpattern_Final, effbdpattern_Loop, Port, effbdpattern_LoopExit, effbdpattern_Iteration, effbdpattern_Feature, effbdpattern_Condition, effbdpattern_Context, effbdpattern_Model, effbdpattern_PatternCatalog, effbdpattern_SystemPattern, effbdpattern_Workbench, effbdpattern_Problem, effbdpattern_Domain, effbdpattern_Keyword, effbdpattern_Allocation, effbdpattern_ModelElement, Indexable, effbdpattern_Indexable, effbdpattern_Parameter, effbdpattern_AbstractModel, effbdpattern_Force, effbdpattern_PatternModel, AbstractModel, effbdpattern_Component, effbdpattern_Impact, FunctionDomain},
    associations={decompositions1, sequenceNodes2, flows3, outputPorts5, inputPorts7, descriptions9, tokens11, controlFlowEdge19, delegate21, property13, parent16, inputflowEdge22, items25, outputflowEdge27, features45, conditions47, contexts49, workingModels51, patternCatalog53, parent31, patterns33, systemPatterns35, functionProperties37, problems39, domains41, keywords43, patternRole61, concreteRole62, allocations56, pattern58, keywords59, domain79, parent82, fragments84, conditions65, functionalPattern68, physicalPattern70, problem87, condition88, decompositions73, parent76, feature97, pattern99, parameters101, context104, problem107, useCasesBeforePattern90, featuresToOptimize93, forces96, patternModel125, impacts128, modelElement129, versionBeforePattern132, functionalArchitecture134, physicalArchitecture137, fromFunction140, toComponent143, domain110, antiPatterns114, requestedPatterns117, relatedPatterns120, equivalentPatterns123},
    generalizations={gen_effbdpattern_Function_SequenceNode, gen_effbdpattern_Function_ModelElement, gen_effbdpattern_Sequence_SequenceNode, gen_effbdpattern_And_Sequence, gen_effbdpattern_Or_Sequence, gen_effbdpattern_Start_Sequence, gen_effbdpattern_Final_Sequence, gen_effbdpattern_Loop_Sequence, gen_effbdpattern_InputPort_Port, gen_effbdpattern_LoopExit_Sequence, gen_effbdpattern_Iteration_Sequence, gen_effbdpattern_OutputPort_Port, gen_effbdpattern_ModelElement_Indexable, gen_effbdpattern_AbstractModel_Indexable, gen_effbdpattern_Context_Indexable, gen_effbdpattern_PatternModel_AbstractModel, gen_effbdpattern_Component_ModelElement, gen_effbdpattern_Problem_Indexable, gen_effbdpattern_Domain_Indexable, gen_effbdpattern_SystemPattern_Indexable, gen_effbdpattern_Model_AbstractModel},
    metadata=None
)
