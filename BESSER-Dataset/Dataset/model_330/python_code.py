...
class extlibrary_Library(Addressable):
    ...
    def __init__(self, name: str, people: str, extlibrary_Library3: set["extlibrary_Employee"] = None, extlibrary_Library: set["extlibrary_Writer"] = None, extlibrary_Library5: set["extlibrary_Borrower"] = None, extlibrary_Library7: set["extlibrary_Item"] = None, extlibrary_Library9: set["extlibrary_Book"] = None):
        self.name = name
        self.people = people
...
class extlibrary_Writer(Person):
    ...
    def __init__(self, name: str, author: set["extlibrary_Book"] = None, extlibrary_Writer15: "extlibrary_BookOnTape" = None, Writer: "extlibrary_Book" = None, extlibrary_Writer: "extlibrary_Library" = None):
        self.name = name
