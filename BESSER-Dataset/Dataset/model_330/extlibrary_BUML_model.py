...
domain_model = DomainModel(
    name="extlibrary",
    types={extlibrary_Employee, extlibrary_Borrower, extlibrary_Book, CirculatingItem, extlibrary_Writer, extlibrary_Library, Addressable, extlibrary_VideoCassette, extlibrary_Item, Person, extlibrary_Lendable, extlibrary_CirculatingItem, Item, Lendable, extlibrary_Periodical, extlibrary_AudioVisualItem, extlibrary_BookOnTape, AudioVisualItem, extlibrary_Person, extlibrary_Addressable, BookCategory},
    associations={employees2, author0, writers1, cast16, borrowed18, borrowers4, stock6, books8, books10, borrowers11, reader12, bookAuthor13, manager20},
    generalizations={gen_extlibrary_Book_CirculatingItem, gen_extlibrary_Library_Addressable, gen_extlibrary_VideoCassette_AudioVisualItem, gen_extlibrary_Borrower_Person, gen_extlibrary_Writer_Person, gen_extlibrary_CirculatingItem_Item, gen_extlibrary_CirculatingItem_Lendable, gen_extlibrary_Periodical_Item, gen_extlibrary_AudioVisualItem_CirculatingItem, gen_extlibrary_BookOnTape_AudioVisualItem, gen_extlibrary_Person_Addressable, gen_extlibrary_Employee_Person},
    metadata=None
)
