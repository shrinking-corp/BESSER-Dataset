...
# Classes
PersonCompany_Person = Class(name="PersonCompany_Person")
PersonCompany_Job = Class(name="PersonCompany_Job")
PersonCompany_Company = Class(name="PersonCompany_Company")
...
PersonCompany_Job_m_workerPlusOnSet: Method = Method(name="workerPlusOnSet", parameters={Parameter(name='PersonCompany_s', type=StringType)}, type=StringType)
PersonCompany_Job.attributes={PersonCompany_Job_salary}
PersonCompany_Job.methods={PersonCompany_Job_m_workerPlus, PersonCompany_Job_m_bossPlus, PersonCompany_Job_m_workerPlusOnSet}
