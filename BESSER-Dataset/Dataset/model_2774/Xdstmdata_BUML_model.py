...
# Classes
xDstmdata_tTypes = Class(name="xDstmdata_tTypes")
xDstmdata_tEnum = Class(name="xDstmdata_tEnum")
xDstmdata_tCompound = Class(name="xDstmdata_tCompound")
xDstmdata_tMultitype = Class(name="xDstmdata_tMultitype")
xDstmdata_cIntchannel = Class(name="xDstmdata_cIntchannel")
xDstmdata_cExtchannel = Class(name="xDstmdata_cExtchannel")
xDstmdata_vVariable = Class(name="xDstmdata_vVariable")
xDstmdata_subtype = Class(name="xDstmdata_subtype")
xDstmdata_channel_specifier = Class(name="xDstmdata_channel_specifier")
xDstmdata_composingtype = Class(name="xDstmdata_composingtype")
...
xDstmdata_cIntchannel.attributes={xDstmdata_cIntchannel_tID, xDstmdata_cIntchannel_name, xDstmdata_cIntchannel_tString, xDstmdata_cIntchannel_bound}
...
xDstmdata_cExtchannel.attributes={xDstmdata_cExtchannel_tString, xDstmdata_cExtchannel_tID, xDstmdata_cExtchannel_name}
...
xDstmdata_subtype.attributes={xDstmdata_subtype_tID, xDstmdata_subtype_tString}
...
xDstmdata_composingtype.attributes={xDstmdata_composingtype_tID, xDstmdata_composingtype_tString}
...
domain_model = DomainModel(
    name="xDstmdata",
    types={xDstmdata_tTypes, xDstmdata_tEnum, xDstmdata_tCompound, xDstmdata_tMultitype, xDstmdata_cIntchannel, xDstmdata_cExtchannel, xDstmdata_vVariable, xDstmdata_subtype, xDstmdata_channel_specifier, xDstmdata_composingtype},
    associations={vVariable9, tEnum0, tCompound1, tMultitype3, cIntchannel5, cExtchannel7, subtypes11, tChn13, composingtypes15, tChn17, tChn20, tChn23, tChn26},
    generalizations={},
    metadata=None
)
