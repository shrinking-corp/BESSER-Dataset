...
GameView.attributes={GameView_standButton, GameView_bet, GameView_doubleButton, GameView_showStrategy, GameView_dealButton, GameView_hitButton, GameView_splitButton}
...
PlayerView.attributes={PlayerView_cardLabels, PlayerView_player, PlayerView_moneyBox, PlayerView_busted, PlayerView_status, PlayerView_cardTotal}
...
Card.attributes={Card_valueHard, Card_suit, Card_name, Card_Count, Card_avatar, Card_valueSoft, Card_rank}
...
domain_model = DomainModel(
    name="_90727442_8a26_4ee2_8a6a_5feb4b678149",
    ...
    associations={Blackjack_GameView, Blackjack_Strategy, PlayerView_GameView, Player_Blackjack, Dealer_Blackjack, LoginView_Profile2, GameLauncher_LoginView, Profile_Blackjack, Blackjack_Deck, BasePlayer_PlayerView, Player_Profile, Dealer_Hand, Player_Hand, Hand_Card, Deck_Card},
    generalizations={},
    metadata=None
)
