...
class statemachine_Event:
    ...
    def __init__(self, code: str, name: str, statemachine_Event: "statemachine_Statemachine" = None, statemachine_Event3: "statemachine_Statemachine" = None, statemachine_Event15: "statemachine_Transition" = None):
        self.code = code
        self.name = name
