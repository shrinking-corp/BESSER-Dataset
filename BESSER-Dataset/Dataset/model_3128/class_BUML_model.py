...
domain_model = DomainModel(
    name="class",
    types={class_Attribute, class_NamedElt, class_Package, NamedElt, class_Class, class_DataType, class_Classifier, Classifier},
    associations={attr6, type7, owner8, classes0, types1, super4},
