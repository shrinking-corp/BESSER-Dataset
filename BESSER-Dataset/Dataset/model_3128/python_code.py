...
class class_Class(Classifier):
    ...
    def __init__(self, isAbstract: bool, owner: set["class_Attribute"] = None, Class: "class_Attribute" = None, class_Class: "class_Package" = None, class_Class5: "class_Class" = None, class_Class3: set["class_Class"] = None):
