...
class PetriNet_Place:
    ...
    def __init__(self, name: str, PetriNet_Place7: "PetriNet_Transition" = None, PetriNet_Place10: "PetriNet_Transition" = None, PetriNet_Place: "PetriNet_PetriNet" = None, PetriNet_Place4: set["PetriNet_Token"] = None):
        self.name = name
...
class PetriNet_Transition:
    ...
    def __init__(self, name: str, PetriNet_Transition6: set["PetriNet_Place"] = None, PetriNet_Transition9: set["PetriNet_Place"] = None, PetriNet_Transition: "PetriNet_PetriNet" = None):
        self.name = name
