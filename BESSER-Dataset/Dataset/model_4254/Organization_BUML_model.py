...
# Classes
Organization_Skill = Class(name="Organization_Skill")
...
Organization_Employee.attributes={Organization_Employee_EmpID, Organization_Employee_Address, Organization_Employee_Name}
...
domain_model = DomainModel(
    name="Organization",
    types={Organization_Skill, Organization_Employee},
