...
di_Fill = Class(name="di_Fill")
di_Color = Class(name="di_Color")
...
di_Diagram.attributes={di_Diagram_name, di_Diagram_documentation, di_Diagram_resolution}
...
di_Style_m_valid_stroke_width: Method = Method(name="valid_stroke_width", parameters={Parameter(name='di_diagnostics', type=StringType), Parameter(name='di_context', type=StringType)}, type=BooleanType)
di_Style_m_valid_dash_length_size: Method = Method(name="valid_dash_length_size", parameters={Parameter(name='di_context', type=StringType), Parameter(name='di_diagnostics', type=StringType)}, type=BooleanType)
di_Style_m_valid_font_size: Method = Method(name="valid_font_size", parameters={Parameter(name='di_diagnostics', type=StringType), Parameter(name='di_context', type=StringType)}, type=BooleanType)
di_Style_m_valid_fill_opacity: Method = Method(name="valid_fill_opacity", parameters={Parameter(name='di_context', type=StringType), Parameter(name='di_diagnostics', type=StringType)}, type=BooleanType)
di_Style_m_valid_stroke_opacity: Method = Method(name="valid_stroke_opacity", parameters={Parameter(name='di_context', type=StringType), Parameter(name='di_diagnostics', type=StringType)}, type=BooleanType)
di_Style.attributes={di_Style_fillOpacity, di_Style_fontSize, di_Style_strokeDashLength, di_Style_fontBold, di_Style_strokeWidth, di_Style_fontUnderline, di_Style_fontStrikeThrough, di_Style_fontName, di_Style_fontItalic, di_Style_strokeOpacity}
di_Style.methods={di_Style_m_valid_font_size, di_Style_m_valid_stroke_opacity, di_Style_m_valid_fill_opacity, di_Style_m_valid_stroke_width, di_Style_m_valid_dash_length_size}
...
domain_model = DomainModel(
    name="di",
    types={di_EObject, di_Edge, DiagramElement, di_Point, di_Diagram, Shape, di_DiagramElement, di_Style, di_Shape, di_Bounds, di_Fill, di_Color},
    associations={modelElement9, source11, target13, waypoint16, owningElement1, ownedElement3, localStyle5, sharedStyle6, bounds18, fill19, fillColor21, strokeColor23, fontColor26},
