...
class cpsml_ProbTransition(Transition):
    ...
    def __init__(self, probability: float, incomingProbTransitions: "cpsml_State" = None, ProbTransition: "cpsml_State" = None, ProbTransition21: "cpsml_State" = None, outgoingProbTransitions: "cpsml_State" = None):
...
class cpsml_ODE:
    ...
    def __init__(self, name: str, cpsml_ODE: "cpsml_System" = None, cpsml_ODE33: "cpsml_State" = None, cpsml_ODE15: "cpsml_State" = None, cpsml_ODE51: "cpsml_Function" = None, cpsml_ODE53: "cpsml_Condition" = None, cpsml_ODE55: "cpsml_Interval" = None):
        self.name = name
...
class cpsml_State:
    ...
    def __init__(self, name: str, cpsml_State: "cpsml_System" = None, cpsml_State10: "cpsml_System" = None, cpsml_State24: "cpsml_State" = None, cpsml_State22: set["cpsml_State"] = None, cpsml_State27: "cpsml_State" = None, cpsml_State25: "cpsml_State" = None, cpsml_State29: set["cpsml_Transition"] = None, State49: "cpsml_ProbTransition" = None, cpsml_State32: set["cpsml_ODE"] = None, cpsml_State35: set["cpsml_Variable"] = None, cpsml_State38: "cpsml_Variable" = None, State: "cpsml_ComTransition" = None, cpsml_State14: "cpsml_ODE" = None, csrc: set["cpsml_ComTransition"] = None, ctgt: set["cpsml_ComTransition"] = None, psrc: set["cpsml_ProbTransition"] = None, ptgt: set["cpsml_ProbTransition"] = None, State45: "cpsml_ComTransition" = None, State47: "cpsml_ProbTransition" = None):
        self.name = name
