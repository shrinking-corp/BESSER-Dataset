...
cpsml_Transition.attributes={cpsml_Transition_event, cpsml_Transition_name, cpsml_Transition_action, cpsml_Transition_guard}
...
cpsml_Interval.attributes={cpsml_Interval_right, cpsml_Interval_name, cpsml_Interval_left, cpsml_Interval_subinterval}
...
domain_model = DomainModel(
    name="cpsml",
    types={cpsml_System, cpsml_Variable, cpsml_State, cpsml_Transition, cpsml_ODE, Transition, cpsml_ComTransition, cpsml_ProbTransition, cpsml_Function, cpsml_Condition, cpsml_Interval, cpsml_IndeVariable, cpsml_DeVariable, cpsml_Fright},
    associations={ownedvariables0, relatedvariable1, ownedStates4, ownedTransitions6, initialState8, ownedodes11, subStates23, initialsubstate26, subtransitions28, subodes31, subrelatedvariables34, subrelatedvariable37, relatedvariable240, csrc43, slaveode13, outgoingComTransitions16, incomingComTransitions17, outgoingProbTransitions19, incomingProbTransitions20, function50, condition52, interval54, indevariable56, devariable58, fright60, ctgt44, psrc46, ptgt48},
