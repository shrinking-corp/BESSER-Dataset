...
public class bpmn2_Process extends CallableElement, FlowElementsContainer {
    ...
    public bpmn2_Process(
        boolean isClosed,        boolean isExecutable,        String processType        ArrayList<bpmn2_Process> bpmn2_processs,        ArrayList<bpmn2_Artifact> bpmn2_artifacts,        ArrayList<bpmn2_ResourceRole> bpmn2_resourceroles,        ArrayList<bpmn2_Process> bpmn2_processs,        ArrayList<bpmn2_CorrelationSubscription> bpmn2_correlationsubscriptions    ) {
        this.isClosed = isClosed;
        this.isExecutable = isExecutable;
        this.processType = processType;
