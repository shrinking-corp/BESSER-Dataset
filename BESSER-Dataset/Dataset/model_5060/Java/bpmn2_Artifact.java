...
public class bpmn2_Artifact extends BaseElement {
    ...
    private bpmn2_SubChoreography bpmn2_subchoreography;
    ...
    public bpmn2_SubChoreography getBpmn2_subchoreography() {
        return bpmn2_subchoreography;
    }

    public void setBpmn2_subchoreography(bpmn2_SubChoreography bpmn2_subchoreography) {
        this.bpmn2_subchoreography = bpmn2_subchoreography;
    }
