...
public class bpmn2_DataInput extends ItemAwareElement {
    ...
    public bpmn2_DataInput(
        boolean isCollection,        String name        ArrayList<bpmn2_InputSet> bpmn2_inputsets,        ArrayList<bpmn2_InputSet> bpmn2_inputsets,        ArrayList<bpmn2_InputSet> bpmn2_inputsets    ) {
        this.isCollection = isCollection;
        this.name = name;
