...
Customer.attributes={Customer_emailAddress, Customer_phoneNumber, Customer_name, Customer_dateOfBirth, Customer_address}
...
transaction_Transaction.attributes={transaction_Transaction_type, transaction_Transaction_amount, transaction_Transaction_transactionTime, transaction_Transaction_id}
...
RequestOTPAuthentication.attributes={RequestOTPAuthentication_UserID, RequestOTPAuthentication_UserEmail}
...
Authentication.attributes={Authentication_UserPassWord1, Authentication_UserEmail, Authentication_Authentication_Result, Authentication_UserPassWord, Authentication_UserID, Authentication_AuthenticationType}
...
LoginAuthenticationProcessor.attributes={LoginAuthenticationProcessor_Authentication_Result, LoginAuthenticationProcessor_UserID, LoginAuthenticationProcessor_UserPassWord}
...
OPT_AuthenticationProcessor.attributes={OPT_AuthenticationProcessor_UserEmail, OPT_AuthenticationProcessor_Authentication_Result}
...
domain_model = DomainModel(
    name="_224f02c2_a988_4885_b310_a857de85adab",
