...
# Classes
simpleumltordbms_AssociationToForeignKey = Class(name="simpleumltordbms_AssociationToForeignKey")
UmlToRdbmsModelElement = Class(name="UmlToRdbmsModelElement")
simpleumltordbms_Association = Class(name="simpleumltordbms_Association")
simpleumltordbms_ForeignKey = Class(name="simpleumltordbms_ForeignKey")
simpleumltordbms_ClassToTable = Class(name="simpleumltordbms_ClassToTable")
simpleumltordbms_AttributeToColumn = Class(name="simpleumltordbms_AttributeToColumn")
FromAttribute = Class(name="FromAttribute")
ToColumn = Class(name="ToColumn")
simpleumltordbms_PrimitiveToName = Class(name="simpleumltordbms_PrimitiveToName", is_abstract=True)
simpleumltordbms_Attribute = Class(name="simpleumltordbms_Attribute")
simpleumltordbms_FromAttributeOwner = Class(name="simpleumltordbms_FromAttributeOwner", is_abstract=True)
simpleumltordbms_IntegerToNumber = Class(name="simpleumltordbms_IntegerToNumber")
simpleumltordbms_NonLeafAttribute = Class(name="simpleumltordbms_NonLeafAttribute")
simpleumltordbms_BooleanToBoolean = Class(name="simpleumltordbms_BooleanToBoolean")
PrimitiveToName = Class(name="PrimitiveToName")
FromAttributeOwner = Class(name="FromAttributeOwner")
simpleumltordbms_PackageToSchema = Class(name="simpleumltordbms_PackageToSchema")
simpleumltordbms_Key = Class(name="simpleumltordbms_Key")
simpleumltordbms_Table = Class(name="simpleumltordbms_Table")
simpleumltordbms_Class = Class(name="simpleumltordbms_Class")
simpleumltordbms_FromAttribute = Class(name="simpleumltordbms_FromAttribute", is_abstract=True)
simpleumltordbms_StringToVarchar = Class(name="simpleumltordbms_StringToVarchar")
simpleumltordbms_ToColumn = Class(name="simpleumltordbms_ToColumn", is_abstract=True)
simpleumltordbms_Column = Class(name="simpleumltordbms_Column")
simpleumltordbms_UmlToRdbmsModelElement = Class(name="simpleumltordbms_UmlToRdbmsModelElement", is_abstract=True)
simpleumltordbms_Schema = Class(name="simpleumltordbms_Schema")
simpleumltordbms_Package = Class(name="simpleumltordbms_Package")
simpleumltordbms_PrimitiveDataType = Class(name="simpleumltordbms_PrimitiveDataType")
...
domain_model = DomainModel(
    ...
    types={simpleumltordbms_AssociationToForeignKey, UmlToRdbmsModelElement, simpleumltordbms_Association, simpleumltordbms_ForeignKey, simpleumltordbms_ClassToTable, simpleumltordbms_AttributeToColumn, FromAttribute, ToColumn, simpleumltordbms_PrimitiveToName, simpleumltordbms_Attribute, simpleumltordbms_FromAttributeOwner, simpleumltordbms_IntegerToNumber, simpleumltordbms_NonLeafAttribute, simpleumltordbms_BooleanToBoolean, PrimitiveToName, FromAttributeOwner, simpleumltordbms_PackageToSchema, simpleumltordbms_Key, simpleumltordbms_Table, simpleumltordbms_Class, simpleumltordbms_FromAttribute, simpleumltordbms_StringToVarchar, simpleumltordbms_ToColumn, simpleumltordbms_Column, simpleumltordbms_UmlToRdbmsModelElement, simpleumltordbms_Schema, simpleumltordbms_Package, simpleumltordbms_PrimitiveDataType},
    associations={type0, association1, foreignKey2, owner4, referenced5, attribute15, leafs16, owner19, fromAttributes20, associationsToForeignKeys7, owner8, primaryKey9, table11, umlClass13, primitive32, column34, classesToTables22, primitivesToNames25, schema27, umlPackage28, owner30},
    generalizations={gen_simpleumltordbms_AssociationToForeignKey_ToColumn, gen_simpleumltordbms_AssociationToForeignKey_UmlToRdbmsModelElement, gen_simpleumltordbms_AttributeToColumn_FromAttribute, gen_simpleumltordbms_AttributeToColumn_ToColumn, gen_simpleumltordbms_FromAttribute_UmlToRdbmsModelElement, gen_simpleumltordbms_IntegerToNumber_PrimitiveToName, gen_simpleumltordbms_NonLeafAttribute_FromAttributeOwner, gen_simpleumltordbms_NonLeafAttribute_FromAttribute, gen_simpleumltordbms_PackageToSchema_UmlToRdbmsModelElement, gen_simpleumltordbms_BooleanToBoolean_PrimitiveToName, gen_simpleumltordbms_ClassToTable_FromAttributeOwner, gen_simpleumltordbms_ClassToTable_ToColumn, gen_simpleumltordbms_ClassToTable_UmlToRdbmsModelElement, gen_simpleumltordbms_StringToVarchar_PrimitiveToName, gen_simpleumltordbms_PrimitiveToName_UmlToRdbmsModelElement},
    metadata=None
)
