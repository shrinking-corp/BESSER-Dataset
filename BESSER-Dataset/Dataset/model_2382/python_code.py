...
class simpleumltordbms_NonLeafAttribute(FromAttributeOwner, FromAttribute):
    ...
    pass
class simpleumltordbms_AttributeToColumn(ToColumn, FromAttribute):
...
class simpleumltordbms_PrimitiveToName(UmlToRdbmsModelElement):
    ...
    def __init__(self, typeName: str, simpleumltordbms_PrimitiveToName33: "simpleumltordbms_PrimitiveDataType" = None, PrimitiveToName: "simpleumltordbms_PackageToSchema" = None, primitivesToNames: "simpleumltordbms_PackageToSchema" = None, simpleumltordbms_PrimitiveToName: "simpleumltordbms_AttributeToColumn" = None):
...
class simpleumltordbms_FromAttribute(UmlToRdbmsModelElement):
    ...
    def __init__(self, kind: str, simpleumltordbms_FromAttribute: "simpleumltordbms_Attribute" = None, simpleumltordbms_FromAttribute17: set["simpleumltordbms_AttributeToColumn"] = None, fromAttributes: "simpleumltordbms_FromAttributeOwner" = None, FromAttribute: "simpleumltordbms_FromAttributeOwner" = None):
        self.kind = kind
...
class simpleumltordbms_ClassToTable(ToColumn, FromAttributeOwner, UmlToRdbmsModelElement):
