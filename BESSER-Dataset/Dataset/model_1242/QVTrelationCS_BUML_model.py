...
# Classes
qvtrelationcs_AbstractDomainCS = Class(name="qvtrelationcs_AbstractDomainCS", is_abstract=True)
ModelElementCS = Class(name="ModelElementCS")
Nameable = Class(name="Nameable")
qvtrelationcs_CollectionTemplateCS = Class(name="qvtrelationcs_CollectionTemplateCS")
TemplateCS = Class(name="TemplateCS")
qvtrelationcs_TypedModel = Class(name="qvtrelationcs_TypedModel")
qvtrelationcs_DomainPatternCS = Class(name="qvtrelationcs_DomainPatternCS")
qvtrelationcs_TemplateCS = Class(name="qvtrelationcs_TemplateCS", is_abstract=True)
TemplateVariableCS = Class(name="TemplateVariableCS")
qvtrelationcs_KeyDeclCS = Class(name="qvtrelationcs_KeyDeclCS")
qvtrelationcs_PathNameCS = Class(name="qvtrelationcs_PathNameCS")
qvtrelationcs_Property = Class(name="qvtrelationcs_Property")
qvtrelationcs_Class = Class(name="qvtrelationcs_Class")
qvtrelationcs_ModelDeclCS = Class(name="qvtrelationcs_ModelDeclCS")
NamedElementCS = Class(name="NamedElementCS")
qvtrelationcs_Namespace = Class(name="qvtrelationcs_Namespace")
qvtrelationcs_ObjectTemplateCS = Class(name="qvtrelationcs_ObjectTemplateCS")
qvtrelationcs_TemplateVariableCS = Class(name="qvtrelationcs_TemplateVariableCS", is_abstract=True)
qvtrelationcs_ElementTemplateCS = Class(name="qvtrelationcs_ElementTemplateCS")
qvtrelationcs_DefaultValueCS = Class(name="qvtrelationcs_DefaultValueCS")
qvtrelationcs_ExpCS = Class(name="qvtrelationcs_ExpCS")
qvtrelationcs_Variable = Class(name="qvtrelationcs_Variable")
qvtrelationcs_DomainCS = Class(name="qvtrelationcs_DomainCS")
AbstractDomainCS = Class(name="AbstractDomainCS")
qvtrelationcs_QueryCS = Class(name="qvtrelationcs_QueryCS")
qvtrelationcs_RelationCS = Class(name="qvtrelationcs_RelationCS")
Relation = Class(name="Relation")
qvtrelationcs_VarDeclarationCS = Class(name="qvtrelationcs_VarDeclarationCS")
ExpCS = Class(name="ExpCS")
qvtrelationcs_PropertyTemplateCS = Class(name="qvtrelationcs_PropertyTemplateCS")
qvtrelationcs_ParamDeclarationCS = Class(name="qvtrelationcs_ParamDeclarationCS")
TypedElementCS = Class(name="TypedElementCS")
qvtrelationcs_PatternCS = Class(name="qvtrelationcs_PatternCS")
qvtrelationcs_PredicateCS = Class(name="qvtrelationcs_PredicateCS")
qvtrelationcs_PrimitiveTypeDomainCS = Class(name="qvtrelationcs_PrimitiveTypeDomainCS")
qvtrelationcs_Element = Class(name="qvtrelationcs_Element")
qvtrelationcs_VarDeclarationIdCS = Class(name="qvtrelationcs_VarDeclarationIdCS")
qvtrelationcs_TypedRefCS = Class(name="qvtrelationcs_TypedRefCS")
qvtrelationcs_TopLevelCS = Class(name="qvtrelationcs_TopLevelCS")
RootPackageCS = Class(name="RootPackageCS")
qvtrelationcs_UnitCS = Class(name="qvtrelationcs_UnitCS")
qvtrelationcs_TransformationCS = Class(name="qvtrelationcs_TransformationCS")
ClassCS = Class(name="ClassCS")
qvtrelationcs_Transformation = Class(name="qvtrelationcs_Transformation")
...
qvtrelationcs_DomainCS.attributes={qvtrelationcs_DomainCS_implementedBy, qvtrelationcs_DomainCS_isCheckonly, qvtrelationcs_DomainCS_isEnforce, qvtrelationcs_DomainCS_isReplace}
...
domain_model = DomainModel(
    name="qvtrelationcs",
    types={qvtrelationcs_AbstractDomainCS, ModelElementCS, Nameable, qvtrelationcs_CollectionTemplateCS, TemplateCS, qvtrelationcs_TypedModel, qvtrelationcs_DomainPatternCS, qvtrelationcs_TemplateCS, TemplateVariableCS, qvtrelationcs_KeyDeclCS, qvtrelationcs_PathNameCS, qvtrelationcs_Property, qvtrelationcs_Class, qvtrelationcs_ModelDeclCS, NamedElementCS, qvtrelationcs_Namespace, qvtrelationcs_ObjectTemplateCS, qvtrelationcs_TemplateVariableCS, qvtrelationcs_ElementTemplateCS, qvtrelationcs_DefaultValueCS, qvtrelationcs_ExpCS, qvtrelationcs_Variable, qvtrelationcs_DomainCS, AbstractDomainCS, qvtrelationcs_QueryCS, qvtrelationcs_RelationCS, Relation, qvtrelationcs_VarDeclarationCS, ExpCS, qvtrelationcs_PropertyTemplateCS, qvtrelationcs_ParamDeclarationCS, TypedElementCS, qvtrelationcs_PatternCS, qvtrelationcs_PredicateCS, qvtrelationcs_PrimitiveTypeDomainCS, qvtrelationcs_Element, qvtrelationcs_VarDeclarationIdCS, qvtrelationcs_TypedRefCS, qvtrelationcs_TopLevelCS, RootPackageCS, qvtrelationcs_UnitCS, qvtrelationcs_TransformationCS, ClassCS, qvtrelationcs_Transformation},
    associations={modelId6, ownedPattern7, ownedDefaultValues9, ownedImplementedBy12, ownedTemplate15, identifier17, ownedPathName20, propertyIds21, ownedOppositePropertyIds23, classId26, metamodelIds28, ownedMemberIdentifiers0, ownedRestIdentifier1, ownedInitExpression3, propertyId4, propertyId35, ownedOppositePropertyId37, ownedExpression40, ownedParameters43, ownedExpression44, overrides47, ownedVarDeclarations48, ownedDomains50, ownedWhen52, ownedWhere55, ownedGuardExpression58, ownedPropertyTemplates29, ownedPredicates30, ownedCondition31, owningObjectTemplate34, ownedPathName74, ownedQueries77, ownedRelations80, identifiers83, ownedInitExpression85, ownedType88, ownedVarDeclarationIds91, ownedType61, ownedImportClauses63, ownedTransformations64, ownedModelDecls66, extends69, ownedKeyDecls71},
    generalizations={gen_qvtrelationcs_AbstractDomainCS_ModelElementCS, gen_qvtrelationcs_AbstractDomainCS_Nameable, gen_qvtrelationcs_CollectionTemplateCS_TemplateCS, gen_qvtrelationcs_DomainPatternCS_ModelElementCS, gen_qvtrelationcs_ElementTemplateCS_TemplateVariableCS, gen_qvtrelationcs_KeyDeclCS_ModelElementCS, gen_qvtrelationcs_ModelDeclCS_NamedElementCS, gen_qvtrelationcs_DefaultValueCS_ModelElementCS, gen_qvtrelationcs_DomainCS_AbstractDomainCS, gen_qvtrelationcs_QueryCS_TypedElementCS, gen_qvtrelationcs_RelationCS_NamedElementCS, gen_qvtrelationcs_TemplateCS_ExpCS, gen_qvtrelationcs_TemplateCS_TemplateVariableCS, gen_qvtrelationcs_TemplateVariableCS_NamedElementCS, gen_qvtrelationcs_ObjectTemplateCS_TemplateCS, gen_qvtrelationcs_ParamDeclarationCS_TypedElementCS, gen_qvtrelationcs_PatternCS_ModelElementCS, gen_qvtrelationcs_PredicateCS_ModelElementCS, gen_qvtrelationcs_PrimitiveTypeDomainCS_TemplateVariableCS, gen_qvtrelationcs_PrimitiveTypeDomainCS_AbstractDomainCS, gen_qvtrelationcs_PropertyTemplateCS_ModelElementCS, gen_qvtrelationcs_UnitCS_ModelElementCS, gen_qvtrelationcs_VarDeclarationCS_ModelElementCS, gen_qvtrelationcs_VarDeclarationIdCS_NamedElementCS, gen_qvtrelationcs_TopLevelCS_RootPackageCS, gen_qvtrelationcs_TransformationCS_ClassCS},
    metadata=None
)
