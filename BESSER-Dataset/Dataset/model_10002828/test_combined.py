...
def test_hyp_userguest_is_not_abstract():
    assert not inspect.isabstract(Userguest)


def test_hyp_userguest_constructor_exists():
    assert callable(Userguest.__init__)


def test_hyp_userguest_constructor_args():
...
def test_hyp_cancle_user_id__setter(instance):
...
@given(instance=Cancle_strategy)
def test_hyp_cancle_ticket_id__setter(instance):
