...
forms_CompositionCondition = Class(name="forms_CompositionCondition")
Condition = Class(name="Condition")
forms_AttributeValueCondition = Class(name="forms_AttributeValueCondition")
forms_EMFL_FormModel = Class(name="forms_EMFL_FormModel")
...
forms_EMFL_EntityModel = Class(name="forms_EMFL_EntityModel")
...
forms_Relationship.attributes={forms_Relationship_lowerBound, forms_Relationship_name, forms_Relationship_upperBound}
...
forms_Form.attributes={forms_Form_name, forms_Form_title, forms_Form_description, forms_Form_isWelcomeForm}
...
domain_model = DomainModel(
    name="forms",
    types={forms_Entity, forms_Relationship, forms_Enumeration, forms_Literal, forms_Attribute, forms_Page, forms_PageElement, forms_AttributePageElement, PageElement, forms_RelationshipPageElement, forms_TextArea, AttributePageElement, forms_SelectionField, forms_Form, forms_Condition, forms_CompositionCondition, Condition, forms_AttributeValueCondition, forms_EMFL_FormModel, forms_DateSelectionField, forms_TimeSelectionField, forms_TextField, forms_List, RelationshipPageElement, forms_Table, forms_Column, forms_EMFL_EntityModel, AttributeType, conditionType},
    associations={identifier1, relationships4, supertypes7, enumerationType9, consists11, attributes0, consists19, associated_with20, contains23, refers_to25, editing_form27, refers_to29, target13, opposite17, refers_to33, combinesAttributeValue36, combinesComposite38, conditionsPage40, conditionsPageElement43, attributePageElement46, consists32, forms49, conditions51, entities53, entities56, enums58},
    generalizations={gen_forms_AttributePageElement_PageElement, gen_forms_RelationshipPageElement_PageElement, gen_forms_TextArea_AttributePageElement, gen_forms_SelectionField_AttributePageElement, gen_forms_CompositionCondition_Condition, gen_forms_AttributeValueCondition_Condition, gen_forms_DateSelectionField_AttributePageElement, gen_forms_TimeSelectionField_AttributePageElement, gen_forms_TextField_AttributePageElement, gen_forms_List_RelationshipPageElement, gen_forms_Table_RelationshipPageElement},
    metadata=None
)
