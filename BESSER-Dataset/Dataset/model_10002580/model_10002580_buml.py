...
domain_model = DomainModel(
    name="c3579eb5_9897_499d_b88c_2a6be3352bce",
    types={admin_Actor2, job_seeker_Actor2, employer_Actor1, login_UseCase1, job_offers_UseCase, educational_qualification_UseCase1, list_of_jobs_related_to_graduation_UseCase, job_vacancies_UseCase, logout_UseCase, Job_Seeker_Actor, Administrator_Actor1, Employer_Actor, login_UseCase2, apply_for_job_UseCase, post_resume_UseCase, search_jobs_UseCase, Manage_database_UseCase, Update_categories_UseCase, Response_to_users_employee_to_job_seekers__UseCase, search_job_UseCase, post_job_UseCase, add_update_and_delete_job_UseCase, User, Employer, Administrator, JobSeeker, Administrator_Actor, employer_Actor, job_seeker_Actor, log_in_UseCase, list_of_jobs_available_UseCase, seeking_for_job_UseCase, educational_qualification_UseCase, UseCase_UseCase, Actor_Actor, admin_Actor, Actor2_Actor, Actor3_Actor, login_UseCase, job_offer_UseCase, MyClass, admin_Actor1, job_seeker_Actor1, Actor4_Actor},
