...
# Classes
simple_lang_SimpleLang = Class(name="simple_lang_SimpleLang")
simple_lang_Statement = Class(name="simple_lang_Statement", is_abstract=True)
simple_lang_Expression = Class(name="simple_lang_Expression", is_abstract=True)
simple_lang_Type = Class(name="simple_lang_Type")
simple_lang_BinaryExpression = Class(name="simple_lang_BinaryExpression", is_abstract=True)
Expression = Class(name="Expression")
simple_lang_LogicalExpression = Class(name="simple_lang_LogicalExpression")
BinaryExpression = Class(name="BinaryExpression")
simple_lang_ArithmeticExpression = Class(name="simple_lang_ArithmeticExpression")
simple_lang_ComparisonExpression = Class(name="simple_lang_ComparisonExpression")
simple_lang_WhileStatement = Class(name="simple_lang_WhileStatement")
simple_lang_AssignmentStatement = Class(name="simple_lang_AssignmentStatement")
simple_lang_FeatureCallExpression = Class(name="simple_lang_FeatureCallExpression", is_abstract=True)
simple_lang_MethodCallExpression = Class(name="simple_lang_MethodCallExpression")
FeatureCallExpression = Class(name="FeatureCallExpression")
simple_lang_PropertyCallExpression = Class(name="simple_lang_PropertyCallExpression")
simple_lang_ExpressionStatement = Class(name="simple_lang_ExpressionStatement")
Statement = Class(name="Statement")
simple_lang_IfStatement = Class(name="simple_lang_IfStatement")
...
domain_model = DomainModel(
    name="simple_lang",
    types={simple_lang_SimpleLang, simple_lang_Statement, simple_lang_Expression, simple_lang_Type, simple_lang_BinaryExpression, Expression, simple_lang_LogicalExpression, BinaryExpression, simple_lang_ArithmeticExpression, simple_lang_ComparisonExpression, simple_lang_WhileStatement, simple_lang_AssignmentStatement, simple_lang_FeatureCallExpression, simple_lang_MethodCallExpression, FeatureCallExpression, simple_lang_PropertyCallExpression, simple_lang_ExpressionStatement, Statement, simple_lang_IfStatement},
    associations={statements0, type1, lhs2, rhs4, condition13, ifBody15, elseBody18, condition21, statement23, lhs26, rhs28, target7, arguments9, expression11},
    generalizations={gen_simple_lang_BinaryExpression_Expression, gen_simple_lang_LogicalExpression_BinaryExpression, gen_simple_lang_ArithmeticExpression_BinaryExpression, gen_simple_lang_WhileStatement_Statement, gen_simple_lang_AssignmentStatement_Statement, gen_simple_lang_ComparisonExpression_BinaryExpression, gen_simple_lang_FeatureCallExpression_Expression, gen_simple_lang_MethodCallExpression_FeatureCallExpression, gen_simple_lang_PropertyCallExpression_FeatureCallExpression, gen_simple_lang_ExpressionStatement_Statement, gen_simple_lang_IfStatement_Statement},
    metadata=None
)
