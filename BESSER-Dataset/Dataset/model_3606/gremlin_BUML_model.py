...
gremlin_MethodDeclaration = Class(name="gremlin_MethodDeclaration")
gremlin_GremlinScript = Class(name="gremlin_GremlinScript")
gremlin_Instruction = Class(name="gremlin_Instruction", is_abstract=True)
gremlin_ReturnStatement = Class(name="gremlin_ReturnStatement")
gremlin_Closure = Class(name="gremlin_Closure")
gremlin_ClosureIt = Class(name="gremlin_ClosureIt")
VariableAccess = Class(name="VariableAccess")
gremlin_TypeDeclaration = Class(name="gremlin_TypeDeclaration", is_abstract=True)
gremlin_ListDeclaration = Class(name="gremlin_ListDeclaration")
TypeDeclaration = Class(name="TypeDeclaration")
gremlin_SetDeclaration = Class(name="gremlin_SetDeclaration")
gremlin_SortedSetDeclaration = Class(name="gremlin_SortedSetDeclaration")
gremlin_VariableDeclaration = Class(name="gremlin_VariableDeclaration")
gremlin_TraversalElement = Class(name="gremlin_TraversalElement", is_abstract=True)
gremlin_CollectionDefinition = Class(name="gremlin_CollectionDefinition")
TraversalElement = Class(name="TraversalElement")
gremlin_OutEStep = Class(name="gremlin_OutEStep")
gremlin_InEStep = Class(name="gremlin_InEStep")
gremlin_VariableAccess = Class(name="gremlin_VariableAccess")
gremlin_Step = Class(name="gremlin_Step", is_abstract=True)
gremlin_IdentityStep = Class(name="gremlin_IdentityStep")
Step = Class(name="Step")
gremlin_FillStep = Class(name="gremlin_FillStep")
gremlin_StartStep = Class(name="gremlin_StartStep")
gremlin_VerticesStep = Class(name="gremlin_VerticesStep")
gremlin_EdgesStep = Class(name="gremlin_EdgesStep")
gremlin_PropertyStep = Class(name="gremlin_PropertyStep")
gremlin_ScatterStep = Class(name="gremlin_ScatterStep")
gremlin_MethodCall = Class(name="gremlin_MethodCall", is_abstract=True)
gremlin_InVStep = Class(name="gremlin_InVStep")
gremlin_OutVStep = Class(name="gremlin_OutVStep")
gremlin_FilterStep = Class(name="gremlin_FilterStep")
gremlin_RetainStep = Class(name="gremlin_RetainStep")
gremlin_ExceptStep = Class(name="gremlin_ExceptStep")
gremlin_TransformStep = Class(name="gremlin_TransformStep")
gremlin_GatherStep = Class(name="gremlin_GatherStep")
gremlin_IsEmptyCall = Class(name="gremlin_IsEmptyCall")
gremlin_ContainsCall = Class(name="gremlin_ContainsCall")
gremlin_CustomMethodCall = Class(name="gremlin_CustomMethodCall")
MethodCall = Class(name="MethodCall")
gremlin_EObject = Class(name="gremlin_EObject")
gremlin_NextCall = Class(name="gremlin_NextCall")
gremlin_HasNextCall = Class(name="gremlin_HasNextCall")
gremlin_IndexCall = Class(name="gremlin_IndexCall")
gremlin_CountCall = Class(name="gremlin_CountCall")
gremlin_FirstCall = Class(name="gremlin_FirstCall")
gremlin_ToListCall = Class(name="gremlin_ToListCall")
gremlin_SizeCall = Class(name="gremlin_SizeCall")
gremlin_Expression = Class(name="gremlin_Expression")
gremlin_UnaryExpression = Class(name="gremlin_UnaryExpression")
Expression = Class(name="Expression")
gremlin_ContainsAllCall = Class(name="gremlin_ContainsAllCall")
gremlin_AddAllCall = Class(name="gremlin_AddAllCall")
gremlin_RetainAllCall = Class(name="gremlin_RetainAllCall")
gremlin_UnionCall = Class(name="gremlin_UnionCall")
gremlin_IntersectionCall = Class(name="gremlin_IntersectionCall")
gremlin_LessExpression = Class(name="gremlin_LessExpression")
gremlin_LessOrEqualExpression = Class(name="gremlin_LessOrEqualExpression")
gremlin_AffectationExpression = Class(name="gremlin_AffectationExpression")
gremlin_NotExpression = Class(name="gremlin_NotExpression")
UnaryExpression = Class(name="UnaryExpression")
gremlin_BinaryExpression = Class(name="gremlin_BinaryExpression")
gremlin_EqualityExpression = Class(name="gremlin_EqualityExpression")
BinaryExpression = Class(name="BinaryExpression")
gremlin_InExpression = Class(name="gremlin_InExpression")
gremlin_DifferenceExpression = Class(name="gremlin_DifferenceExpression")
gremlin_OrExpression = Class(name="gremlin_OrExpression")
gremlin_AndExpression = Class(name="gremlin_AndExpression")
gremlin_GreaterExpression = Class(name="gremlin_GreaterExpression")
gremlin_GreaterOrEqualExpression = Class(name="gremlin_GreaterOrEqualExpression")
gremlin_NullLiteral = Class(name="gremlin_NullLiteral")
gremlin_ToIntegerCall = Class(name="gremlin_ToIntegerCall")
gremlin_PlusExpression = Class(name="gremlin_PlusExpression")
gremlin_LeftShiftExpression = Class(name="gremlin_LeftShiftExpression")
gremlin_TernaryOperator = Class(name="gremlin_TernaryOperator")
gremlin_StringLiteral = Class(name="gremlin_StringLiteral")
gremlin_IntegerLiteral = Class(name="gremlin_IntegerLiteral")
gremlin_DoubleLiteral = Class(name="gremlin_DoubleLiteral")
gremlin_BooleanLiteral = Class(name="gremlin_BooleanLiteral")
gremlin_CustomStep = Class(name="gremlin_CustomStep")
...
gremlin_VariableDeclaration.attributes={gremlin_VariableDeclaration_final, gremlin_VariableDeclaration_name}
...
gremlin_IndexCall.attributes={gremlin_IndexCall_indexProperty, gremlin_IndexCall_indexName, gremlin_IndexCall_indexQuery}
...
domain_model = DomainModel(
    name="gremlin",
    types={Instruction, gremlin_MethodDeclaration, gremlin_GremlinScript, gremlin_Instruction, gremlin_ReturnStatement, gremlin_Closure, gremlin_ClosureIt, VariableAccess, gremlin_TypeDeclaration, gremlin_ListDeclaration, TypeDeclaration, gremlin_SetDeclaration, gremlin_SortedSetDeclaration, gremlin_VariableDeclaration, gremlin_TraversalElement, gremlin_CollectionDefinition, TraversalElement, gremlin_OutEStep, gremlin_InEStep, gremlin_VariableAccess, gremlin_Step, gremlin_IdentityStep, Step, gremlin_FillStep, gremlin_StartStep, gremlin_VerticesStep, gremlin_EdgesStep, gremlin_PropertyStep, gremlin_ScatterStep, gremlin_MethodCall, gremlin_InVStep, gremlin_OutVStep, gremlin_FilterStep, gremlin_RetainStep, gremlin_ExceptStep, gremlin_TransformStep, gremlin_GatherStep, gremlin_IsEmptyCall, gremlin_ContainsCall, gremlin_CustomMethodCall, MethodCall, gremlin_EObject, gremlin_NextCall, gremlin_HasNextCall, gremlin_IndexCall, gremlin_CountCall, gremlin_FirstCall, gremlin_ToListCall, gremlin_SizeCall, gremlin_Expression, gremlin_UnaryExpression, Expression, gremlin_ContainsAllCall, gremlin_AddAllCall, gremlin_RetainAllCall, gremlin_UnionCall, gremlin_IntersectionCall, gremlin_LessExpression, gremlin_LessOrEqualExpression, gremlin_AffectationExpression, gremlin_NotExpression, UnaryExpression, gremlin_BinaryExpression, gremlin_EqualityExpression, BinaryExpression, gremlin_InExpression, gremlin_DifferenceExpression, gremlin_OrExpression, gremlin_AndExpression, gremlin_GreaterExpression, gremlin_GreaterOrEqualExpression, gremlin_NullLiteral, gremlin_ToIntegerCall, gremlin_PlusExpression, gremlin_LeftShiftExpression, gremlin_TernaryOperator, gremlin_StringLiteral, gremlin_IntegerLiteral, gremlin_DoubleLiteral, gremlin_BooleanLiteral, gremlin_CustomStep},
    associations={instructions0, values12, type14, instructions17, instructions1, value3, type5, nextElement8, previousElement10, value23, cast19, instruction21, closure33, closure25, collection27, collection29, closure31, value36, params35, cast57, value38, value40, value42, leftCollection44, rightCollection46, cast49, leftCollection52, rightCollection54, exp60, left62, right64, condition67, ifTrue69, ifFalse72, params75},
    generalizations={gen_gremlin_ReturnStatement_Instruction, gen_gremlin_MethodDeclaration_Instruction, gen_gremlin_Closure_Instruction, gen_gremlin_ClosureIt_VariableAccess, gen_gremlin_TypeDeclaration_Instruction, gen_gremlin_ListDeclaration_TypeDeclaration, gen_gremlin_SetDeclaration_TypeDeclaration, gen_gremlin_SortedSetDeclaration_TypeDeclaration, gen_gremlin_VariableDeclaration_Instruction, gen_gremlin_TraversalElement_Instruction, gen_gremlin_CollectionDefinition_TraversalElement, gen_gremlin_OutEStep_Step, gen_gremlin_InEStep_Step, gen_gremlin_VariableAccess_TraversalElement, gen_gremlin_Step_TraversalElement, gen_gremlin_IdentityStep_Step, gen_gremlin_FillStep_Step, gen_gremlin_StartStep_Step, gen_gremlin_VerticesStep_Step, gen_gremlin_EdgesStep_Step, gen_gremlin_PropertyStep_Step, gen_gremlin_GatherStep_Step, gen_gremlin_ScatterStep_Step, gen_gremlin_MethodCall_TraversalElement, gen_gremlin_InVStep_Step, gen_gremlin_OutVStep_Step, gen_gremlin_FilterStep_Step, gen_gremlin_RetainStep_Step, gen_gremlin_ExceptStep_Step, gen_gremlin_TransformStep_Step, gen_gremlin_IsEmptyCall_MethodCall, gen_gremlin_ContainsCall_MethodCall, gen_gremlin_CustomMethodCall_MethodCall, gen_gremlin_NextCall_MethodCall, gen_gremlin_HasNextCall_MethodCall, gen_gremlin_IndexCall_MethodCall, gen_gremlin_CountCall_MethodCall, gen_gremlin_FirstCall_MethodCall, gen_gremlin_ToListCall_MethodCall, gen_gremlin_SizeCall_MethodCall, gen_gremlin_Expression_Instruction, gen_gremlin_UnaryExpression_Expression, gen_gremlin_ContainsAllCall_MethodCall, gen_gremlin_AddAllCall_MethodCall, gen_gremlin_RetainAllCall_MethodCall, gen_gremlin_UnionCall_MethodCall, gen_gremlin_IntersectionCall_MethodCall, gen_gremlin_LessExpression_BinaryExpression, gen_gremlin_LessOrEqualExpression_BinaryExpression, gen_gremlin_AffectationExpression_BinaryExpression, gen_gremlin_NotExpression_UnaryExpression, gen_gremlin_BinaryExpression_Expression, gen_gremlin_EqualityExpression_BinaryExpression, gen_gremlin_InExpression_BinaryExpression, gen_gremlin_DifferenceExpression_BinaryExpression, gen_gremlin_OrExpression_BinaryExpression, gen_gremlin_AndExpression_BinaryExpression, gen_gremlin_GreaterExpression_BinaryExpression, gen_gremlin_GreaterOrEqualExpression_BinaryExpression, gen_gremlin_NullLiteral_Expression, gen_gremlin_ToIntegerCall_MethodCall, gen_gremlin_PlusExpression_BinaryExpression, gen_gremlin_LeftShiftExpression_BinaryExpression, gen_gremlin_TernaryOperator_Expression, gen_gremlin_StringLiteral_Expression, gen_gremlin_IntegerLiteral_Expression, gen_gremlin_DoubleLiteral_Expression, gen_gremlin_BooleanLiteral_Expression, gen_gremlin_CustomStep_Step},
    metadata=None
)
