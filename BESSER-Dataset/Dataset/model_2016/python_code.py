...
class trace_DebugLocationData:
    ...
    def __init__(self, endLineNumber: int, path: str, endOffset: int, label: str, offset: int, length: int, lineNumber: int, trace_DebugLocationData: "trace_DebugTraceRegion" = None):
