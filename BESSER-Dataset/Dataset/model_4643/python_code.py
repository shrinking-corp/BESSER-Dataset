...
class TitleStyle:
    ...
    pass
class notation_SemanticListCompartment(BasicSemanticCompartment, TitleStyle, SortingStyle, FilteringStyle):
...
class BasicCompartment:
    ...
    pass
class notation_ListCompartment(BasicCompartment, TitleStyle, SortingStyle, FilteringStyle):

    pass
class notation_Compartment(BasicCompartment, TitleStyle, CanonicalStyle):
...
class DescriptionStyle:
    ...
    pass
class notation_DiagramStyle(DescriptionStyle, GuideStyle, PageStyle):
...
class RoundedCornersStyle:
    ...
    pass
class notation_ShapeStyle(RoundedCornersStyle, LineStyle, DescriptionStyle, FontStyle, FillStyle):
...
class notation_View(EModelElement):
    ...
    def getNamedStyle(self, notation_name, notation_eClass) :
...
class notation_PageStyle(Style):
    ...
    def __init__(self, pageWidth: int, pageHeight: int, pageX: int, pageY: int):
...
class notation_FontStyle(Style):
    ...
    def __init__(self, underline: bool, strikeThrough: bool, fontColor: int, fontName: str, fontHeight: int, bold: bool, italic: bool):
...
class notation_Diagram(View):
    ...
    def __init__(self, name: str, measurementUnit: str, notation_Diagram57: "notation_DiagramLinkStyle" = None, notation_Diagram: "notation_View" = None, notation_Diagram27: set["notation_Edge"] = None, notation_Diagram30: set["notation_Edge"] = None, notation_Diagram59: "notation_MultiDiagramLinkStyle" = None):
        self.name = name
