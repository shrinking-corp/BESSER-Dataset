...
public class notation_View extends EModelElement {
    ...
    public notation_View(
        boolean mutable,        boolean visible,        String type        ArrayList<notation_Style> notation_styles,        ArrayList<notation_Node> notation_nodes,        ArrayList<notation_Edge> notation_edges,        ArrayList<notation_Node> notation_nodes,        ArrayList<notation_Edge> notation_edges    ) {
        this.mutable = mutable;
        this.visible = visible;
        this.type = type;
