...
def test_hyp_patient_check_in_apatient_is_not_abstract():
    assert not inspect.isabstract(Patient_Check_In_aPatient)


def test_hyp_patient_check_in_apatient_constructor_exists():
    assert callable(Patient_Check_In_aPatient.__init__)


def test_hyp_patient_check_in_apatient_constructor_args():
...
def test_hyp_patient_check_in_adoctor_is_not_abstract():
    assert not inspect.isabstract(Patient_Check_In_aDoctor)


def test_hyp_patient_check_in_adoctor_constructor_exists():
    assert callable(Patient_Check_In_aDoctor.__init__)


def test_hyp_patient_check_in_adoctor_constructor_args():
...
def test_hyp_patient_check_in__areceptionist_is_not_abstract():
    assert not inspect.isabstract(Patient_Check_In__aReceptionist)


def test_hyp_patient_check_in__areceptionist_constructor_exists():
    assert callable(Patient_Check_In__aReceptionist.__init__)


def test_hyp_patient_check_in__areceptionist_constructor_args():
...
def test_hyp_patient_check_in_anurse_is_not_abstract():
    assert not inspect.isabstract(Patient_Check_In_aNurse)


def test_hyp_patient_check_in_anurse_constructor_exists():
    assert callable(Patient_Check_In_aNurse.__init__)


def test_hyp_patient_check_in_anurse_constructor_args():
...
def test_hyp_patient_check_in_apatient_Phone_Number_setter(instance):
...
@given(instance=Patient_Check_In_aPatient_strategy)
def test_hyp_patient_check_in_apatient_MRN_Number_setter(instance):
...
@given(instance=Patient_Check_In_aPatient_strategy)
def test_hyp_patient_check_in_apatient_Symptoms_setter(instance):
...
@given(instance=Patient_Check_In_aPatient_strategy)
def test_hyp_patient_check_in_apatient_Patient_s_Name_setter(instance):
...
def test_hyp_patient_check_in_adoctor_Name_setter(instance):
...
@given(instance=Patient_Check_In_aDoctor_strategy)
def test_hyp_patient_check_in_adoctor_ID_setter(instance):
...
@given(instance=Patient_Check_In_aDoctor_strategy)
def test_hyp_patient_check_in_adoctor_Rank_setter(instance):
...
@given(instance=Patient_Check_In_aDoctor_strategy)
def test_hyp_patient_check_in_adoctor_Specialization_setter(instance):
...
def test_hyp_patient_check_in__areceptionist_Name_setter(instance):
    original = instance.Name
    instance.Name = original
    assert instance.Name == original
...
@given(instance=Patient_Check_In__aReceptionist_strategy)
def test_hyp_patient_check_in__areceptionist_Employee_ID_setter(instance):
...
def test_hyp_patient_check_in_anurse_Name_setter(instance):
    original = instance.Name
    instance.Name = original
    assert instance.Name == original
...
@given(instance=Patient_Check_In_aNurse_strategy)
def test_hyp_patient_check_in_anurse_ID_setter(instance):
    original = instance.ID
    instance.ID = original
    assert instance.ID == original
...
@given(instance=Patient_Check_In_aNurse_strategy)
def test_hyp_patient_check_in_anurse_Ranking_setter(instance):
