...
# Classes
stateMachine_model = Class(name="stateMachine_model")
...
stateMachine_Type = Class(name="stateMachine_Type")
stateMachine_Test = Class(name="stateMachine_Test")
stateMachine_Transition = Class(name="stateMachine_Transition")
stateMachine_Condition = Class(name="stateMachine_Condition")
stateMachine_VarName = Class(name="stateMachine_VarName")
stateMachine_StringType = Class(name="stateMachine_StringType")
Type = Class(name="Type")
stateMachine_FloatType = Class(name="stateMachine_FloatType")
stateMachine_DeclaredParameter = Class(name="stateMachine_DeclaredParameter")
stateMachine_Modifier = Class(name="stateMachine_Modifier")
...
domain_model = DomainModel(
    name="stateMachine",
    types={stateMachine_model, stateMachine_StateMachine, stateMachine_Event, stateMachine_Command, stateMachine_State, stateMachine_Type, stateMachine_Test, stateMachine_Transition, stateMachine_Condition, stateMachine_VarName, stateMachine_StringType, Type, stateMachine_FloatType, stateMachine_DeclaredParameter, stateMachine_Modifier, Visibility},
    associations={statemachine0, events1, commands3, states5, initialstates7, finalstates10, returnType13, tests15, actions22, transitions25, event27, state30, condition33, name35, types17, args20},
