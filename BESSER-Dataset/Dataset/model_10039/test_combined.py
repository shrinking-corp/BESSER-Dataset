...
def test_hyp_t3_tree_is_not_abstract():
    assert not inspect.isabstract(t3_Tree)


def test_hyp_t3_tree_constructor_exists():
    assert callable(t3_Tree.__init__)


def test_hyp_t3_tree_constructor_args():
...
def test_hyp_t3_tree_balanced_setter(instance):
...
def test_t3_Tree_balanced_value_roundtrip():
    instance = t3_Tree(balanced=True)
    assert instance.balanced == True
    instance.balanced = False
    assert instance.balanced == False
...
t3_Tree_strategy = st.builds(t3_Tree, balanced=st.booleans())
@given(instance=t3_Tree_strategy)
