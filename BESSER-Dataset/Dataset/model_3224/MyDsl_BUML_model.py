...
myDsl_translation_unit = Class(name="myDsl_translation_unit")
myDsl_external_declaration = Class(name="myDsl_external_declaration")
myDsl_translation_unit_linha = Class(name="myDsl_translation_unit_linha")
myDsl_function_definition = Class(name="myDsl_function_definition")
myDsl_declaration = Class(name="myDsl_declaration")
myDsl_declaration_specifiers = Class(name="myDsl_declaration_specifiers")
myDsl_type_specifier = Class(name="myDsl_type_specifier")
myDsl_type_qualifier = Class(name="myDsl_type_qualifier")
myDsl_alignment_specifier = Class(name="myDsl_alignment_specifier")
myDsl_type_name = Class(name="myDsl_type_name")
myDsl_constant_expression = Class(name="myDsl_constant_expression")
myDsl_atomic_type_specifier = Class(name="myDsl_atomic_type_specifier")
myDsl_struct_or_union_specifier = Class(name="myDsl_struct_or_union_specifier")
myDsl_enum_specifier = Class(name="myDsl_enum_specifier")
myDsl_enumerator_list = Class(name="myDsl_enumerator_list")
myDsl_enumerator = Class(name="myDsl_enumerator")
myDsl_enumerator_list_linha = Class(name="myDsl_enumerator_list_linha")
myDsl_enumeration_constant = Class(name="myDsl_enumeration_constant")
myDsl_struct_declaration_list = Class(name="myDsl_struct_declaration_list")
myDsl_struct_or_union_specifier_complement = Class(name="myDsl_struct_or_union_specifier_complement")
myDsl_struct_declaration = Class(name="myDsl_struct_declaration")
myDsl_struct_declaration_list_linha = Class(name="myDsl_struct_declaration_list_linha")
myDsl_specifier_qualifier_list = Class(name="myDsl_specifier_qualifier_list")
myDsl_struct_declarator_list = Class(name="myDsl_struct_declarator_list")
myDsl_static_assert_declaration = Class(name="myDsl_static_assert_declaration")
myDsl_struct_declarator = Class(name="myDsl_struct_declarator")
myDsl_struct_declarator_list_linha = Class(name="myDsl_struct_declarator_list_linha")
myDsl_declarator = Class(name="myDsl_declarator")
myDsl_init_declarator_list = Class(name="myDsl_init_declarator_list")
myDsl_parameter_lista = Class(name="myDsl_parameter_lista")
myDsl_declaration_list = Class(name="myDsl_declaration_list")
myDsl_compound_statement = Class(name="myDsl_compound_statement")
myDsl_declaration_list_linha = Class(name="myDsl_declaration_list_linha")
myDsl_pointer = Class(name="myDsl_pointer")
myDsl_direct_declarator = Class(name="myDsl_direct_declarator")
myDsl_type_qualifier_list = Class(name="myDsl_type_qualifier_list")
direct_abstract_declarator_complement = Class(name="direct_abstract_declarator_complement")
myDsl_type_qualifier_list_linha = Class(name="myDsl_type_qualifier_list_linha")
myDsl_direct_declarator_linha = Class(name="myDsl_direct_declarator_linha")
myDsl_direct_declarator_complemento = Class(name="myDsl_direct_declarator_complemento")
myDsl_assignment_expression = Class(name="myDsl_assignment_expression")
myDsl_parameter_type_list = Class(name="myDsl_parameter_type_list")
myDsl_identifier_list = Class(name="myDsl_identifier_list")
myDsl_parameter_declaration = Class(name="myDsl_parameter_declaration")
myDsl_parameter_list_linha = Class(name="myDsl_parameter_list_linha")
myDsl_abstract_declarator = Class(name="myDsl_abstract_declarator")
myDsl_direct_abstract_declarator = Class(name="myDsl_direct_abstract_declarator")
myDsl_direct_abstract_declarator_linha = Class(name="myDsl_direct_abstract_declarator_linha")
myDsl_initializer = Class(name="myDsl_initializer")
myDsl_initializer_list = Class(name="myDsl_initializer_list")
myDsl_direct_abstract_declarator_complement = Class(name="myDsl_direct_abstract_declarator_complement")
myDsl_identifier_list_linha = Class(name="myDsl_identifier_list_linha")
myDsl_primary_expression = Class(name="myDsl_primary_expression")
myDsl_constant = Class(name="myDsl_constant")
myDsl_expression = Class(name="myDsl_expression")
myDsl_generic_selection = Class(name="myDsl_generic_selection")
myDsl_generic_assoc_list = Class(name="myDsl_generic_assoc_list")
myDsl_generic_association = Class(name="myDsl_generic_association")
myDsl_generic_assoc_list_linha = Class(name="myDsl_generic_assoc_list_linha")
myDsl_postfix_expression = Class(name="myDsl_postfix_expression")
myDsl_postfix_expression_linha = Class(name="myDsl_postfix_expression_linha")
myDsl_designation = Class(name="myDsl_designation")
myDsl_init_declarator_list_linha = Class(name="myDsl_init_declarator_list_linha")
myDsl_initializer_list_linha = Class(name="myDsl_initializer_list_linha")
myDsl_initializer_list_complement = Class(name="myDsl_initializer_list_complement")
myDsl_designator_list = Class(name="myDsl_designator_list")
myDsl_designator = Class(name="myDsl_designator")
myDsl_designator_list_linha = Class(name="myDsl_designator_list_linha")
myDsl_conditional_expression = Class(name="myDsl_conditional_expression")
myDsl_postfix_expression_complement = Class(name="myDsl_postfix_expression_complement")
myDsl_argument_expression_list = Class(name="myDsl_argument_expression_list")
myDsl_argument_expression_list_linha = Class(name="myDsl_argument_expression_list_linha")
myDsl_unary_expression = Class(name="myDsl_unary_expression")
myDsl_cast_expression = Class(name="myDsl_cast_expression")
myDsl_multiplicative_expression = Class(name="myDsl_multiplicative_expression")
myDsl_multiplicative_expression_linha = Class(name="myDsl_multiplicative_expression_linha")
myDsl_multiplicative_expression_complement = Class(name="myDsl_multiplicative_expression_complement")
myDsl_additive_expression = Class(name="myDsl_additive_expression")
myDsl_relational_expression = Class(name="myDsl_relational_expression")
myDsl_relational_expression_linha = Class(name="myDsl_relational_expression_linha")
myDsl_relational_expression_complement = Class(name="myDsl_relational_expression_complement")
myDsl_equality_expression = Class(name="myDsl_equality_expression")
myDsl_equality_expression_linha = Class(name="myDsl_equality_expression_linha")
myDsl_equality_expression_complement = Class(name="myDsl_equality_expression_complement")
myDsl_additive_expression_linha = Class(name="myDsl_additive_expression_linha")
myDsl_additive_expression_complement = Class(name="myDsl_additive_expression_complement")
myDsl_shift_expression = Class(name="myDsl_shift_expression")
myDsl_shift_expression_linha = Class(name="myDsl_shift_expression_linha")
myDsl_shift_expression_complement = Class(name="myDsl_shift_expression_complement")
myDsl_statement = Class(name="myDsl_statement")
myDsl_labeled_statement = Class(name="myDsl_labeled_statement")
myDsl_expression_statement = Class(name="myDsl_expression_statement")
myDsl_selection_statement = Class(name="myDsl_selection_statement")
myDsl_iteration_statement = Class(name="myDsl_iteration_statement")
myDsl_jump_statement = Class(name="myDsl_jump_statement")
myDsl_and_expression = Class(name="myDsl_and_expression")
myDsl_and_expression_linha = Class(name="myDsl_and_expression_linha")
myDsl_exclusive_or_expression = Class(name="myDsl_exclusive_or_expression")
myDsl_exclusive_or_expression_linha = Class(name="myDsl_exclusive_or_expression_linha")
myDsl_inclusive_or_expression = Class(name="myDsl_inclusive_or_expression")
myDsl_inclusive_or_expression_linha = Class(name="myDsl_inclusive_or_expression_linha")
myDsl_block_item_list = Class(name="myDsl_block_item_list")
myDsl_block_item = Class(name="myDsl_block_item")
myDsl_block_item_list_linha = Class(name="myDsl_block_item_list_linha")
postfix_expression = Class(name="postfix_expression")
myDsl_logical_and_expression = Class(name="myDsl_logical_and_expression")
myDsl_logical_and_expression_linha = Class(name="myDsl_logical_and_expression_linha")
myDsl_logical_or_expression = Class(name="myDsl_logical_or_expression")
myDsl_logical_or_expression_linha = Class(name="myDsl_logical_or_expression_linha")
myDsl_conditional_expression_linha = Class(name="myDsl_conditional_expression_linha")
myDsl_string_dsl = Class(name="myDsl_string_dsl")
myDsl_EnumeratorListLinhaAction = Class(name="myDsl_EnumeratorListLinhaAction")
enumerator_list_linha = Class(name="enumerator_list_linha")
myDsl_StructOrUnionSpecifierComplementAction = Class(name="myDsl_StructOrUnionSpecifierComplementAction")
struct_or_union_specifier_complement = Class(name="struct_or_union_specifier_complement")
myDsl_StructDeclarationListLinhaAction = Class(name="myDsl_StructDeclarationListLinhaAction")
struct_declaration_list_linha = Class(name="struct_declaration_list_linha")
myDsl_expression_linha = Class(name="myDsl_expression_linha")
myDsl_init_declarator = Class(name="myDsl_init_declarator")
myDsl_IdentifierListLinhaAction = Class(name="myDsl_IdentifierListLinhaAction")
identifier_list_linha = Class(name="identifier_list_linha")
myDsl_TranlationUnitLinhaAction = Class(name="myDsl_TranlationUnitLinhaAction")
translation_unit_linha = Class(name="translation_unit_linha")
myDsl_GenericAssocListLinhaAction = Class(name="myDsl_GenericAssocListLinhaAction")
generic_assoc_list_linha = Class(name="generic_assoc_list_linha")
myDsl_PostfixExpressionLinhaAction = Class(name="myDsl_PostfixExpressionLinhaAction")
postfix_expression_linha = Class(name="postfix_expression_linha")
myDsl_StructDeclaratorListLinhaAction = Class(name="myDsl_StructDeclaratorListLinhaAction")
struct_declarator_list_linha = Class(name="struct_declarator_list_linha")
myDsl_DeclarationListLinhaAction = Class(name="myDsl_DeclarationListLinhaAction")
declaration_list_linha = Class(name="declaration_list_linha")
myDsl_TypeQualifierListLinhaAtion = Class(name="myDsl_TypeQualifierListLinhaAtion")
type_qualifier_list_linha = Class(name="type_qualifier_list_linha")
myDsl_DirectAbstractDeclarratorLinhaAction = Class(name="myDsl_DirectAbstractDeclarratorLinhaAction")
direct_abstract_declarator_linha = Class(name="direct_abstract_declarator_linha")
myDsl_PlusPlus = Class(name="myDsl_PlusPlus")
unary_expression = Class(name="unary_expression")
myDsl_InitDecclaratorListLinhaAction = Class(name="myDsl_InitDecclaratorListLinhaAction")
init_declarator_list_linha = Class(name="init_declarator_list_linha")
myDsl_InitializerListLinhaAction = Class(name="myDsl_InitializerListLinhaAction")
initializer_list_linha = Class(name="initializer_list_linha")
myDsl_DesignatorListLinhaAction = Class(name="myDsl_DesignatorListLinhaAction")
designator_list_linha = Class(name="designator_list_linha")
myDsl_PostFixEmpryParams = Class(name="myDsl_PostFixEmpryParams")
postfix_expression_complement = Class(name="postfix_expression_complement")
myDsl_ArgumentExpressionListLinhaAction = Class(name="myDsl_ArgumentExpressionListLinhaAction")
argument_expression_list_linha = Class(name="argument_expression_list_linha")
...
myDsl_declaration_specifiers.attributes={myDsl_declaration_specifiers_storage_class_specifier, myDsl_declaration_specifiers_function_specifier}
...
myDsl_constant.attributes={myDsl_constant_f_constant, myDsl_constant_enumz, myDsl_constant_char, myDsl_constant_i_constant, myDsl_constant_string}
...
myDsl_multiplicative_expression_complement.attributes={myDsl_multiplicative_expression_complement_divide, myDsl_multiplicative_expression_complement_modulo, myDsl_multiplicative_expression_complement_multiplica}
...
myDsl_relational_expression_complement.attributes={myDsl_relational_expression_complement_menor, myDsl_relational_expression_complement_menor_igual, myDsl_relational_expression_complement_maior, myDsl_relational_expression_complement_maior_igual}
...
myDsl_equality_expression_complement.attributes={myDsl_equality_expression_complement_menor_igual, myDsl_equality_expression_complement_n_igual, myDsl_equality_expression_complement_menor, myDsl_equality_expression_complement_maior_igual, myDsl_equality_expression_complement_igual, myDsl_equality_expression_complement_maior}
...
myDsl_additive_expression_complement.attributes={myDsl_additive_expression_complement_menos, myDsl_additive_expression_complement_mais}
...
myDsl_shift_expression_complement.attributes={myDsl_shift_expression_complement_sleft, myDsl_shift_expression_complement_sright}
...
myDsl_jump_statement_break_: Property = Property(name="break_", type=StringType)
myDsl_jump_statement_return_vazio: Property = Property(name="return_vazio", type=StringType)
myDsl_jump_statement_return_: Property = Property(name="return_", type=StringType)
myDsl_jump_statement_identifier: Property = Property(name="identifier", type=StringType)
myDsl_jump_statement.attributes={myDsl_jump_statement_return_, myDsl_jump_statement_break_, myDsl_jump_statement_return_vazio, myDsl_jump_statement_identifier}
...
myDsl_string_dsl.attributes={myDsl_string_dsl___func__, myDsl_string_dsl_string_literal}
...
domain_model = DomainModel(
    name="myDsl",
    types={myDsl_Model, myDsl_translation_unit, myDsl_external_declaration, myDsl_translation_unit_linha, myDsl_function_definition, myDsl_declaration, myDsl_declaration_specifiers, myDsl_type_specifier, myDsl_type_qualifier, myDsl_alignment_specifier, myDsl_type_name, myDsl_constant_expression, myDsl_atomic_type_specifier, myDsl_struct_or_union_specifier, myDsl_enum_specifier, myDsl_enumerator_list, myDsl_enumerator, myDsl_enumerator_list_linha, myDsl_enumeration_constant, myDsl_struct_declaration_list, myDsl_struct_or_union_specifier_complement, myDsl_struct_declaration, myDsl_struct_declaration_list_linha, myDsl_specifier_qualifier_list, myDsl_struct_declarator_list, myDsl_static_assert_declaration, myDsl_struct_declarator, myDsl_struct_declarator_list_linha, myDsl_declarator, myDsl_init_declarator_list, myDsl_parameter_lista, myDsl_declaration_list, myDsl_compound_statement, myDsl_declaration_list_linha, myDsl_pointer, myDsl_direct_declarator, myDsl_type_qualifier_list, direct_abstract_declarator_complement, myDsl_type_qualifier_list_linha, myDsl_direct_declarator_linha, myDsl_direct_declarator_complemento, myDsl_assignment_expression, myDsl_parameter_type_list, myDsl_identifier_list, myDsl_parameter_declaration, myDsl_parameter_list_linha, myDsl_abstract_declarator, myDsl_direct_abstract_declarator, myDsl_direct_abstract_declarator_linha, myDsl_initializer, myDsl_initializer_list, myDsl_direct_abstract_declarator_complement, myDsl_identifier_list_linha, myDsl_primary_expression, myDsl_constant, myDsl_expression, myDsl_generic_selection, myDsl_generic_assoc_list, myDsl_generic_association, myDsl_generic_assoc_list_linha, myDsl_postfix_expression, myDsl_postfix_expression_linha, myDsl_designation, myDsl_init_declarator_list_linha, myDsl_initializer_list_linha, myDsl_initializer_list_complement, myDsl_designator_list, myDsl_designator, myDsl_designator_list_linha, myDsl_conditional_expression, myDsl_postfix_expression_complement, myDsl_argument_expression_list, myDsl_argument_expression_list_linha, myDsl_unary_expression, myDsl_cast_expression, myDsl_multiplicative_expression, myDsl_multiplicative_expression_linha, myDsl_multiplicative_expression_complement, myDsl_additive_expression, myDsl_relational_expression, myDsl_relational_expression_linha, myDsl_relational_expression_complement, myDsl_equality_expression, myDsl_equality_expression_linha, myDsl_equality_expression_complement, myDsl_additive_expression_linha, myDsl_additive_expression_complement, myDsl_shift_expression, myDsl_shift_expression_linha, myDsl_shift_expression_complement, myDsl_statement, myDsl_labeled_statement, myDsl_expression_statement, myDsl_selection_statement, myDsl_iteration_statement, myDsl_jump_statement, myDsl_and_expression, myDsl_and_expression_linha, myDsl_exclusive_or_expression, myDsl_exclusive_or_expression_linha, myDsl_inclusive_or_expression, myDsl_inclusive_or_expression_linha, myDsl_block_item_list, myDsl_block_item, myDsl_block_item_list_linha, postfix_expression, myDsl_logical_and_expression, myDsl_logical_and_expression_linha, myDsl_logical_or_expression, myDsl_logical_or_expression_linha, myDsl_conditional_expression_linha, myDsl_string_dsl, myDsl_EnumeratorListLinhaAction, enumerator_list_linha, myDsl_StructOrUnionSpecifierComplementAction, struct_or_union_specifier_complement, myDsl_StructDeclarationListLinhaAction, struct_declaration_list_linha, myDsl_expression_linha, myDsl_init_declarator, myDsl_IdentifierListLinhaAction, identifier_list_linha, myDsl_TranlationUnitLinhaAction, translation_unit_linha, myDsl_GenericAssocListLinhaAction, generic_assoc_list_linha, myDsl_PostfixExpressionLinhaAction, postfix_expression_linha, myDsl_StructDeclaratorListLinhaAction, struct_declarator_list_linha, myDsl_DeclarationListLinhaAction, declaration_list_linha, myDsl_TypeQualifierListLinhaAtion, type_qualifier_list_linha, myDsl_DirectAbstractDeclarratorLinhaAction, direct_abstract_declarator_linha, myDsl_PlusPlus, unary_expression, myDsl_InitDecclaratorListLinhaAction, init_declarator_list_linha, myDsl_InitializerListLinhaAction, initializer_list_linha, myDsl_DesignatorListLinhaAction, designator_list_linha, myDsl_PostFixEmpryParams, postfix_expression_complement, myDsl_ArgumentExpressionListLinhaAction, argument_expression_list_linha},
    associations={function_definitio5, greetings0, external_declaration1, translation_unit_linha3, declaration7, declaration_specifiers10, type_specifier11, type_qualifier13, alignment_specifier15, type_name17, constant_expression19, atomic_type_specifier21, struct_or_union_specifier23, enum_specifier25, enumerator_list27, enumarator29, enumerator_list_linha31, enumeration_constant33, conditional_expression35, type_name38, struct_declaration_list41, struct_or_union_specifier_complement43, struct_declaration45, struct_declaration_list_linha47, specifier_qualifier_list49, struct_declarator_list51, static_assert_declaration53, struct_declarator55, struct_declarator_list_linha57, constant_expression59, declarator62, type_specifier64, specifier_qualifier_list68, type_qualifier70, declaration_specifiers73, init_declarator_list76, static_assert_declaration78, parameter_lista129, declaration_specifiers81, declarator84, declaration_list87, compound_statement89, declaration91, declaration_list_linha94, pointer96, direct_declarator98, type_qualifier_list100, pointer103, type_qualifier105, type_qualifier_list_linha108, direct_declarator_linha110, declarator112, direct_declarator_complemento115, direct_declarator_linha118, type_qualifier_list120, assignment_expression123, parameter_type_list125, identifier_list127, constant179, parameter_declarations131, parameter_declaration133, parameter_list_linha136, declaration_specifiers138, declarator141, abstract_declarator144, pointer146, direct_abstract_declarator149, abstract_declarator151, type_qualifier_list154, assignment_expression157, parameter_type_list160, direct_abstract_declarator_linha163, init_declarator_list165, assignment_expression166, assignment_expression169, type_qualifier_list171, parameter_type_list174, identifier_list_linha177, constant_expression221, expression180, generic_selection182, assignment_expression184, generic_assoc_list187, generic_association189, generic_assoc_list_linha191, type_name193, assignment_expression196, primary_expression199, postfix_expression_linha201, designation203, initializer205, init_declarator_list_linha208, designation210, initializer212, designator_list215, designator217, designator_list_linha219, constant_expression223, expression226, argument_expression_list228, assignment_expressions230, postfix_expression233, unary_expression236, cast_expression238, type_name240, unary_expression243, type_name246, cast_expression250, cast_expression252, multiplicative_expression_linha254, multiplicative_expression_complement256, multiplicative_expression_linha259, cast_expression261, shift_expression288, relational_expression_linha290, shift_expression_complement292, relational_expression_linha296, shift_expression298, relational_expression300, equality_expression_linha302, equality_expression_complement304, equality_expression_linha307, multiplicative_expression264, additive_expression_linha266, additive_expression_complement268, additive_expression_linha271, multiplicative_expression273, additive_expression276, shift_expression_linha278, shift_expression_complement280, shift_expression_linha283, additive_expression285, expression324, expression327, statement330, expression_statement333, expression_statement2336, declaration339, expression342, statement345, statement2348, statement351, relational_expression309, labeled_statement312, compound_statement313, expression_statement316, selection_statement318, iteration_statement320, jump_statement322, equality_expression378, and_expression_linha380, equality_expression382, and_expression_linha386, and_expression388, exclusive_or_expression_linha390, and_expression392, exclusive_or_expression_linha396, exclusive_or_expression398, inclusive_or_expression_linha400, exclusive_or_expression402, conditional_expression354, block_item_list357, block_item359, block_item_list_linha361, block_item363, block_item_list_linha367, declaration369, statement372, expression375, expression433, conditional_expression436, conditional_expression_linha440, conditional_expression442, unary_expression445, assignment_expression449, initializer_list451, specifier_qualifier_list454, abstract_declarator457, inclusive_or_expression_linha406, inclusive_or_expression408, logical_and_expression_linha410, inclusive_or_expression412, logical_and_expression_linha416, logical_and_expression418, logical_or_expression_linha420, logical_and_expression422, logical_or_expression_linha426, logical_or_expression428, conditional_expression_linha431, enumerator485, enumerator_list_linha487, struct_declaration_list490, struct_declaration492, struct_declaration_list_linha494, assignment_expression460, expression_linha463, assignment_expression465, expression_linha469, conditional_expression471, init_declarator474, init_declarator_list_linha476, declarator479, initializer482, direct_abstract_declarator_complement512, direct_abstract_declarator_linha514, identifier_list_linha517, external_declaration519, translation_unit_linha521, generic_association524, generic_assoc_list_linha526, postfix_expression_complement529, struct_declarator497, struct_declarator_list_linha499, declaration502, declaration_list_linha504, type_qualifier507, type_qualifier_list_linha509, init_declarator548, init_declarator_list_linha550, postfix_expression_linha531, initializer_list_complement534, init_declarator_list_linha536, designator539, designator_list_linha541, assignment_expression544, argument_expression_list_linha546},
    generalizations={gen_myDsl_type_qualifier_list_direct_abstract_declarator_complement, gen_myDsl_type_name_postfix_expression, gen_myDsl_EnumeratorListLinhaAction_enumerator_list_linha, gen_myDsl_StructOrUnionSpecifierComplementAction_struct_or_union_specifier_complement, gen_myDsl_StructDeclarationListLinhaAction_struct_declaration_list_linha, gen_myDsl_IdentifierListLinhaAction_identifier_list_linha, gen_myDsl_TranlationUnitLinhaAction_translation_unit_linha, gen_myDsl_GenericAssocListLinhaAction_generic_assoc_list_linha, gen_myDsl_PostfixExpressionLinhaAction_postfix_expression_linha, gen_myDsl_StructDeclaratorListLinhaAction_struct_declarator_list_linha, gen_myDsl_DeclarationListLinhaAction_declaration_list_linha, gen_myDsl_TypeQualifierListLinhaAtion_type_qualifier_list_linha, gen_myDsl_DirectAbstractDeclarratorLinhaAction_direct_abstract_declarator_linha, gen_myDsl_PlusPlus_unary_expression, gen_myDsl_InitDecclaratorListLinhaAction_init_declarator_list_linha, gen_myDsl_InitializerListLinhaAction_initializer_list_linha, gen_myDsl_DesignatorListLinhaAction_designator_list_linha, gen_myDsl_PostFixEmpryParams_postfix_expression_complement, gen_myDsl_ArgumentExpressionListLinhaAction_argument_expression_list_linha},
    metadata=None
)
