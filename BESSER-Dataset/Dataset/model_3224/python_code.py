...
class myDsl_assignment_expression:
    ...
    def __init__(self, assignment_operator: str, myDsl_assignment_expression159: "myDsl_direct_abstract_declarator" = None, myDsl_assignment_expression168: "myDsl_initializer" = None, myDsl_assignment_expression170: "myDsl_direct_abstract_declarator_complement" = None, myDsl_assignment_expression: "myDsl_direct_declarator_complemento" = None, myDsl_assignment_expression186: "myDsl_generic_selection" = None, myDsl_assignment_expression198: "myDsl_generic_association" = None, myDsl_assignment_expression232: "myDsl_argument_expression_list" = None, myDsl_assignment_expression443: "myDsl_conditional_expression" = None, myDsl_assignment_expression446: "myDsl_unary_expression" = None, myDsl_assignment_expression450: "myDsl_assignment_expression" = None, myDsl_assignment_expression448: "myDsl_assignment_expression" = None, myDsl_assignment_expression462: "myDsl_expression" = None, myDsl_assignment_expression467: "myDsl_expression_linha" = None, myDsl_assignment_expression545: "myDsl_ArgumentExpressionListLinhaAction" = None):
...
class myDsl_struct_or_union_specifier:
    ...
    def __init__(self, struct_or_union: str, identifier: str, myDsl_struct_or_union_specifier42: "myDsl_struct_declaration_list" = None, myDsl_struct_or_union_specifier44: "myDsl_struct_or_union_specifier_complement" = None, myDsl_struct_or_union_specifier: "myDsl_type_specifier" = None):
...
class myDsl_type_specifier:
    ...
    def __init__(self, type_name_str: str, myDsl_type_specifier66: "myDsl_specifier_qualifier_list" = None, myDsl_type_specifier: "myDsl_declaration_specifiers" = None, myDsl_type_specifier22: "myDsl_atomic_type_specifier" = None, myDsl_type_specifier24: "myDsl_struct_or_union_specifier" = None, myDsl_type_specifier26: "myDsl_enum_specifier" = None):
...
class myDsl_declaration_specifiers:
    ...
    def __init__(self, storage_class_specifier: str, function_specifier: str, myDsl_declaration_specifiers: "myDsl_declaration_specifiers" = None, myDsl_declaration_specifiers9: set["myDsl_declaration_specifiers"] = None, myDsl_declaration_specifiers12: "myDsl_type_specifier" = None, myDsl_declaration_specifiers14: "myDsl_type_qualifier" = None, myDsl_declaration_specifiers16: "myDsl_alignment_specifier" = None, myDsl_declaration_specifiers75: "myDsl_declaration" = None, myDsl_declaration_specifiers83: "myDsl_function_definition" = None, myDsl_declaration_specifiers140: "myDsl_parameter_declaration" = None):
...
class myDsl_jump_statement:
    ...
    def __init__(self, break_: str, return_vazio: str, return_: str, identifier: str, myDsl_jump_statement325: "myDsl_expression" = None, myDsl_jump_statement: "myDsl_statement" = None):
        self.break_ = break_
...
class myDsl_labeled_statement:
    ...
    def __init__(self, identifier: str, myDsl_labeled_statement352: "myDsl_statement" = None, myDsl_labeled_statement: "myDsl_statement" = None, myDsl_labeled_statement355: "myDsl_conditional_expression" = None):
        self.identifier = identifier
...
class myDsl_unary_expression:
    ...
    def __init__(self, unary_operator: str, myDsl_unary_expression: "myDsl_postfix_expression" = None, myDsl_unary_expression237: "myDsl_unary_expression" = None, myDsl_unary_expression235: "myDsl_unary_expression" = None, myDsl_unary_expression239: "myDsl_cast_expression" = None, myDsl_unary_expression241: "myDsl_type_name" = None, myDsl_unary_expression245: "myDsl_cast_expression" = None, myDsl_unary_expression447: "myDsl_assignment_expression" = None):
...
class myDsl_designator:
    ...
    def __init__(self, identifier: str, myDsl_designator222: "myDsl_conditional_expression" = None, myDsl_designator: "myDsl_designator_list" = None, myDsl_designator540: "myDsl_DesignatorListLinhaAction" = None):
        self.identifier = identifier
