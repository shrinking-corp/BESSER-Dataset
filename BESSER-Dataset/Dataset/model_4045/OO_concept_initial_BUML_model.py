...
domain_model = DomainModel(
    name="OO_concept",
    types={OO_concept_PackageableElement, OO_concept_Package, PackageableElement, NamedElement, OO_concept_Class, Classifier, Type, OO_concept_Operation, OO_concept_Property, OO_concept_Classifier, OO_concept_Model, Package, TypedElement, BehavioralFeature, OO_concept_Parameter, OO_concept_Feature, StructuralFeature, OO_concept_Generalization, OO_concept_Dependency, OO_concept_TypedElement, OO_concept_Type, OO_concept_BehavioralFeature, Feature, OO_concept_Behavior, Class_, OO_concept_StructuralFeature, OO_concept_NamedElement, VisibilityKind},
    associations={packagedElement0, ownedOperation1, ownedAttribute2, ownedParameter6, general8, specific10, supplier11, client12, generalization15, type16, method17, nestedClassifier4},
