...
class ControlPort:
    ...
    pass
class sam_InControlPort(InputPort, ControlPort):
...
class MessagePort:
    ...
    pass
class sam_InMessagePort(InputPort, MessagePort):
...
class OutputPort:
    ...
    pass
class sam_OutMessagePort(MessagePort, OutputPort):

    pass
class sam_OutDataPort(OutputPort, DataPort):

    pass
class sam_OutControlPort(ControlPort, OutputPort):
...
class sam_Automaton(ModelContent):
    ...
    pass
class sam_System(ModelContent, TraceableElement):
