...
sam_ControlMerge = Class(name="sam_ControlMerge")
...
sam_DataSynchronisation = Class(name="sam_DataSynchronisation", is_abstract=True)
...
sam_MessageSplit = Class(name="sam_MessageSplit")
sam_OutDataPort = Class(name="sam_OutDataPort")
sam_OutputPort = Class(name="sam_OutputPort", is_abstract=True)
sam_FlowGroup = Class(name="sam_FlowGroup")
sam_Gate = Class(name="sam_Gate", is_abstract=True)
Flow = Class(name="Flow")
sam_DataFlow = Class(name="sam_DataFlow")
sam_DataDecomposition = Class(name="sam_DataDecomposition")
sam_MessagePort = Class(name="sam_MessagePort", is_abstract=True)
sam_MessageFlow = Class(name="sam_MessageFlow")
sam_OutMessagePort = Class(name="sam_OutMessagePort")
...
sam_EObject = Class(name="sam_EObject")
...
sam_SplitGate = Class(name="sam_SplitGate", is_abstract=True)
AsynchronousGate = Class(name="AsynchronousGate")
sam_MergeGate = Class(name="sam_MergeGate", is_abstract=True)
SplitGate = Class(name="SplitGate")
MergeGate = Class(name="MergeGate")
sam_MessageMerge = Class(name="sam_MessageMerge")
sam_InMessagePort = Class(name="sam_InMessagePort")
ENamedElement = Class(name="ENamedElement")
sam_AsynchronousGate = Class(name="sam_AsynchronousGate", is_abstract=True)
Gate = Class(name="Gate")
sam_SynchronousGate = Class(name="sam_SynchronousGate", is_abstract=True)
SynchronousGate = Class(name="SynchronousGate")
sam_TraceableElement = Class(name="sam_TraceableElement")
...
merge20: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="in_", type=sam_ControlMerge, multiplicity=Multiplicity(0, 1))
    }
)
...
parentSync23: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="in_24", type=sam_DataSynchronisation, multiplicity=Multiplicity(0, 1))
    }
)
merge25: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="in_26", type=sam_DataMerge, multiplicity=Multiplicity(0, 1))
    }
)
...
in_64: BinaryAssociation = BinaryAssociation(
    name="in_64",
    ends={
...
split106: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="in_107", type=sam_MessageSplit, multiplicity=Multiplicity(0, 1))
    }
)
merge109: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="in_110", type=sam_MessageMerge, multiplicity=Multiplicity(0, 1))
    }
)
...
in_118: BinaryAssociation = BinaryAssociation(
    name="in_118",
    ends={
...
in_139: BinaryAssociation = BinaryAssociation(
    name="in_139",
    ends={
...
in_129: BinaryAssociation = BinaryAssociation(
    name="in_129",
    ends={
...
in_134: BinaryAssociation = BinaryAssociation(
    name="in_134",
    ends={
...
domain_model = DomainModel(
    name="sam",
    types={sam_Transition, sam_AbstractState, NamedItem, sam_MacroState, sam_Automaton, sam_ControlPort, Port, sam_DataPort, sam_InControlPort, ControlPort, InputPort, sam_ControlMerge, sam_InDataPort, DataPort, ModelContent, sam_DataStore, sam_DataSynchronisation, sam_Port, sam_InitialState, State, AbstractState, sam_State, TraceableElement, sam_System, sam_Flow, sam_MultiPort, sam_DataComposition, DataSynchronisation, sam_ControlFlow, sam_DataMerge, sam_InputPort, sam_OutControlPort, OutputPort, sam_MessageSplit, sam_OutDataPort, sam_OutputPort, sam_FlowGroup, sam_Gate, Flow, sam_DataFlow, sam_DataDecomposition, sam_MessagePort, sam_MessageFlow, sam_OutMessagePort, MessagePort, sam_ModelContent, sam_Model, sam_EObject, sam_IdentifiedItem, EModelElement, sam_NamedItem, IdentifiedItem, sam_SplitGate, AsynchronousGate, sam_MergeGate, SplitGate, MergeGate, sam_MessageMerge, sam_InMessagePort, ENamedElement, sam_AsynchronousGate, Gate, sam_SynchronousGate, SynchronousGate, sam_TraceableElement, DataType},
    associations={parentAutomaton1, outlink2, parentState0, merge20, parentDataStore21, listTransitions3, listPorts5, listStates7, isInstanceOf10, composition11, inlink13, dest15, parentAutomaton16, source18, parentSystem41, outlink42, inlink43, parentAutomaton46, parentMultiPort49, isInstanceOf52, parentSync23, merge25, split27, merge28, parentDataStore30, parentSync33, split36, merge38, parentSystem67, group69, listPorts70, listStores72, listSynchronisation75, listFlows77, source54, dest55, source58, dest59, parentSystem62, in_64, out65, parent95, isInstanceOf98, source100, dest101, listElements79, isInstanceOf82, modelContent83, flowGroups85, requirementModel87, parentModel88, parentSystem89, listMultiPort91, listPort92, in_123, outData124, outControl127, merge104, split106, merge109, flows112, model114, parentSystem116, in_118, out120, in_139, out142, in_129, out131, in_134, out136},
    generalizations={gen_sam_AbstractState_NamedItem, gen_sam_ControlPort_Port, gen_sam_DataPort_Port, gen_sam_InControlPort_ControlPort, gen_sam_InControlPort_InputPort, gen_sam_InDataPort_DataPort, gen_sam_InDataPort_InputPort, gen_sam_Automaton_ModelContent, gen_sam_InitialState_State, gen_sam_MacroState_AbstractState, gen_sam_State_AbstractState, gen_sam_Transition_TraceableElement, gen_sam_DataComposition_DataSynchronisation, gen_sam_InputPort_Port, gen_sam_OutControlPort_ControlPort, gen_sam_OutControlPort_OutputPort, gen_sam_OutDataPort_DataPort, gen_sam_OutDataPort_OutputPort, gen_sam_OutputPort_Port, gen_sam_Port_NamedItem, gen_sam_System_ModelContent, gen_sam_System_TraceableElement, gen_sam_ControlFlow_Flow, gen_sam_DataFlow_Flow, gen_sam_DataStore_NamedItem, gen_sam_DataDecomposition_DataSynchronisation, gen_sam_Flow_NamedItem, gen_sam_MessagePort_Port, gen_sam_MessageFlow_Flow, gen_sam_OutMessagePort_MessagePort, gen_sam_OutMessagePort_OutputPort, gen_sam_ModelContent_NamedItem, gen_sam_IdentifiedItem_EModelElement, gen_sam_NamedItem_IdentifiedItem, gen_sam_MultiPort_NamedItem, gen_sam_SplitGate_AsynchronousGate, gen_sam_MergeGate_AsynchronousGate, gen_sam_MessageSplit_SplitGate, gen_sam_DataMerge_MergeGate, gen_sam_InMessagePort_MessagePort, gen_sam_InMessagePort_InputPort, gen_sam_FlowGroup_ENamedElement, gen_sam_Gate_IdentifiedItem, gen_sam_AsynchronousGate_Gate, gen_sam_SynchronousGate_Gate, gen_sam_DataSynchronisation_SynchronousGate, gen_sam_ControlMerge_MergeGate, gen_sam_MessageMerge_MergeGate, gen_sam_TraceableElement_NamedItem},
    metadata=None
)
