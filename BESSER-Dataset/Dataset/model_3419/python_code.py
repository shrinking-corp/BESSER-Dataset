...
class tracker_Animal(ABC):
    ...
    def __init__(self, birthDate: date, sex: str, species: str, breed: str, age: str, id: str, comments: str, lastEventDateTime: date, weight: str, weightGainPerDay: str, sexCode: str, speciesCode: str, tracker_Animal: set["tracker_Tag"] = None, tracker_Animal3: "tracker_Animal" = None, tracker_Animal1: "tracker_Animal" = None, tracker_Animal6: "tracker_Animal" = None, tracker_Animal4: "tracker_Animal" = None, tracker_Animal10: "tracker_Premises" = None):
