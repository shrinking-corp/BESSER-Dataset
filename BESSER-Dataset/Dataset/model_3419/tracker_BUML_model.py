...
tracker_Animal.attributes={tracker_Animal_id, tracker_Animal_breed, tracker_Animal_sex, tracker_Animal_weightGainPerDay, tracker_Animal_speciesCode, tracker_Animal_comments, tracker_Animal_sexCode, tracker_Animal_weight, tracker_Animal_age, tracker_Animal_birthDate, tracker_Animal_lastEventDateTime, tracker_Animal_species}
tracker_Animal.methods={tracker_Animal_m_allEvents, tracker_Animal_m_lastWeighIn, tracker_Animal_m_eventHistory, tracker_Animal_m_activeTag, tracker_Animal_m_addTemplate}
...
tracker_Event.attributes={tracker_Event_correction, tracker_Event_id, tracker_Event_electronicallyRead, tracker_Event_comments, tracker_Event_eventCode, tracker_Event_dateTime}
...
tracker_Premises.attributes={tracker_Premises_name, tracker_Premises_premisesId, tracker_Premises_emailContact, tracker_Premises_uri}
...
tracker_Swine.attributes={tracker_Swine_rightEarNotching, tracker_Swine_swineBreed, tracker_Swine_leftEarNotching}
...
tracker_MedicalTreatment.attributes={tracker_MedicalTreatment_treatment, tracker_MedicalTreatment_lot, tracker_MedicalTreatment_quantity, tracker_MedicalTreatment_name, tracker_MedicalTreatment_product, tracker_MedicalTreatment_method, tracker_MedicalTreatment_manufacturer}
...
tracker_MilkTest.attributes={tracker_MilkTest_somaticCellCounts, tracker_MilkTest_percentProtein, tracker_MilkTest_otherSolids, tracker_MilkTest_poundsProduced, tracker_MilkTest_percentButterFat}
...
domain_model = DomainModel(
    name="tracker",
    types={tracker_Animal, tracker_Tag, tracker_Event, tracker_Bovine, Animal, tracker_TagAllocated, Event, tracker_Premises, tracker_Location, tracker_Schema, Bovine, tracker_Ovine, tracker_BovineBeef, tracker_BovineBison, tracker_BovineDairy, tracker_TagApplied, tracker_MovedIn, tracker_MovedOut, tracker_LostTag, tracker_ReplacedTag, tracker_Imported, tracker_Exported, tracker_Sighting, tracker_Slaughtered, tracker_Died, tracker_TagRetired, tracker_AnimalMissing, tracker_ICVI, tracker_WeighIn, tracker_Swine, tracker_Equine, tracker_Caprine, tracker_MedicalCondition, tracker_MedicalTreatment, tracker_Birthing, tracker_Calving, Birthing, tracker_BirthDefect, tracker_Mastitis, MedicalCondition, tracker_MilkTest, tracker_HerdTest, tracker_GenericEvent, tracker_EventAttribute, tracker_EventSchema, tracker_EventAttributeSchema, Sex, BisonBreed, SheepBreed, BeefBreed, DairyBreed, SwineBreed, HorseBreed, GoatBreed, Treatment, TreatmentMethod, OneToTen, AnimalType, EventDataType},
    associations={tags0, dam2, sire5, events7, tag8, animals9, unAppliedTags11, locations14, schema16, oldTag18, location20, eventAttributes22, eventSchema23, eventAttributes25, eventSchemas27},
    generalizations={gen_tracker_Bovine_Animal, gen_tracker_TagAllocated_Event, gen_tracker_BovineBeef_Bovine, gen_tracker_Ovine_Animal, gen_tracker_BovineBison_Bovine, gen_tracker_BovineDairy_Bovine, gen_tracker_TagApplied_Event, gen_tracker_MovedIn_Event, gen_tracker_MovedOut_Event, gen_tracker_LostTag_Event, gen_tracker_ReplacedTag_Event, gen_tracker_Imported_Event, gen_tracker_Exported_Event, gen_tracker_Sighting_Event, gen_tracker_Slaughtered_Event, gen_tracker_Died_Event, gen_tracker_TagRetired_Event, gen_tracker_AnimalMissing_Event, gen_tracker_ICVI_Event, gen_tracker_WeighIn_Event, gen_tracker_Swine_Animal, gen_tracker_Equine_Animal, gen_tracker_Caprine_Animal, gen_tracker_MedicalCondition_Event, gen_tracker_MedicalTreatment_Event, gen_tracker_Birthing_Event, gen_tracker_Calving_Birthing, gen_tracker_BirthDefect_Event, gen_tracker_Mastitis_MedicalCondition, gen_tracker_MilkTest_Event, gen_tracker_HerdTest_Event, gen_tracker_GenericEvent_Event},
    metadata=None
)
