...
# Classes
company_Subunit = Class(name="company_Subunit", is_abstract=True)
company_Person = Class(name="company_Person")
company_Company = Class(name="company_Company")
company_Dept = Class(name="company_Dept")
...
domain_model = DomainModel(
    name="company",
    types={company_Subunit, company_Person, company_Company, company_Dept, Subunit, company_Employee},
    associations={subunits3, person5, depts0, manager1},
