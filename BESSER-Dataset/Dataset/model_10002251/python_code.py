...
class C(ABC):
    ...
    def __init__(self, attC1: int, attC2: bool, b4: set["B"] = None):
        self.attC1 = attC1
        self.attC2 = attC2
...
class B:
    ...
    def __init__(self, attB: int, a3: "A" = None, c5: set["C"] = None):
        self.attB = attB
        self.a3 = a3
