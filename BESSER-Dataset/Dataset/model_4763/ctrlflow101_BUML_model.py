...
# Classes
ctrlflow101_Sequence = Class(name="ctrlflow101_Sequence", is_abstract=True)
ctrlflow101_Token = Class(name="ctrlflow101_Token")
ctrlflow101_Function = Class(name="ctrlflow101_Function")
SequenceNode = Class(name="SequenceNode")
ctrlflow101_SequenceNode = Class(name="ctrlflow101_SequenceNode", is_abstract=True)
ctrlflow101_And = Class(name="ctrlflow101_And")
Sequence = Class(name="Sequence")
ctrlflow101_Or = Class(name="ctrlflow101_Or")
ctrlflow101_Start = Class(name="ctrlflow101_Start")
ctrlflow101_Final = Class(name="ctrlflow101_Final")
ctrlflow101_Loop = Class(name="ctrlflow101_Loop")
...
ctrlflow101_SequenceNode.attributes={ctrlflow101_SequenceNode_tMin, ctrlflow101_SequenceNode_name, ctrlflow101_SequenceNode_tMax}
...
domain_model = DomainModel(
    name="ctrlflow101",
    types={ctrlflow101_Sequence, ctrlflow101_Token, ctrlflow101_Function, SequenceNode, ctrlflow101_SequenceNode, ctrlflow101_And, Sequence, ctrlflow101_Or, ctrlflow101_Start, ctrlflow101_Final, ctrlflow101_Loop},
    associations={decompositions1, sequenceNodes2, tokens4, controlFlowEdge7},
    generalizations={gen_ctrlflow101_Function_SequenceNode, gen_ctrlflow101_Sequence_SequenceNode, gen_ctrlflow101_And_Sequence, gen_ctrlflow101_Or_Sequence, gen_ctrlflow101_Start_Sequence, gen_ctrlflow101_Final_Sequence, gen_ctrlflow101_Loop_Sequence},
    metadata=None
)
