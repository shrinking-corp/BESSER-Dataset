...
def test_ModeleTp3_pack2_D_isa_C():
    instance = ModeleTp3_pack2_D()
...
ModeleTp3_Int_strategy = st.builds(ModeleTp3_Int)
...
ModeleTp3_pack1_A_strategy = st.builds(ModeleTp3_pack1_A)
...
ModeleTp3_pack1_B_strategy = st.builds(ModeleTp3_pack1_B)
...
ModeleTp3_pack2_C_strategy = st.builds(ModeleTp3_pack2_C)
...
ModeleTp3_pack2_D_strategy = st.builds(ModeleTp3_pack2_D)
...
ModeleTp3_pack2_E_strategy = st.builds(ModeleTp3_pack2_E)
...
pack1_ModeleTp3_Int_strategy = st.builds(pack1_ModeleTp3_Int)
...
pack2_ModeleTp3_Int_strategy = st.builds(pack2_ModeleTp3_Int)
