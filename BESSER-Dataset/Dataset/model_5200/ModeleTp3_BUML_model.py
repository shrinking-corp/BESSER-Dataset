...
# Classes
ModeleTp3_Int = Class(name="ModeleTp3_Int")
ModeleTp3_pack1_B = Class(name="ModeleTp3_pack1_B")
ModeleTp3_pack1_A = Class(name="ModeleTp3_pack1_A")
pack1_ModeleTp3_Int = Class(name="pack1_ModeleTp3_Int")
ModeleTp3_pack2_C = Class(name="ModeleTp3_pack2_C")
ModeleTp3_pack2_D = Class(name="ModeleTp3_pack2_D")
C = Class(name="C")
ModeleTp3_pack2_E = Class(name="ModeleTp3_pack2_E")
pack2_ModeleTp3_Int = Class(name="pack2_ModeleTp3_Int")
