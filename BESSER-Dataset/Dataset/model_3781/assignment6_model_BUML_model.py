...
# Classes
assignment6_model_Configurator = Class(name="assignment6_model_Configurator")
assignment6_model_Feature = Class(name="assignment6_model_Feature", is_abstract=True)
assignment6_model_Group = Class(name="assignment6_model_Group")
assignment6_model_Dependency = Class(name="assignment6_model_Dependency", is_abstract=True)
assignment6_model_SimpleFeature = Class(name="assignment6_model_SimpleFeature")
Feature = Class(name="Feature")
assignment6_model_IntegerFeature = Class(name="assignment6_model_IntegerFeature")
assignment6_model_UnaryDependency = Class(name="assignment6_model_UnaryDependency", is_abstract=True)
Dependency = Class(name="Dependency")
assignment6_model_BinaryDependency = Class(name="assignment6_model_BinaryDependency")
assignment6_model_IsSelectedDependency = Class(name="assignment6_model_IsSelectedDependency")
UnaryDependency = Class(name="UnaryDependency")
assignment6_model_IntegerValueDependency = Class(name="assignment6_model_IntegerValueDependency")
...
assignment6_model_Feature.attributes={assignment6_model_Feature_selected, assignment6_model_Feature_mandatory, assignment6_model_Feature_name}
...
assignment6_model_Group.attributes={assignment6_model_Group_groupType, assignment6_model_Group_name}

# assignment6_model_Dependency class attributes and methods
assignment6_model_Dependency_not_: Property = Property(name="not_", type=BooleanType)
assignment6_model_Dependency.attributes={assignment6_model_Dependency_not_}
...
assignment6_model_IntegerFeature.attributes={assignment6_model_IntegerFeature_step, assignment6_model_IntegerFeature_minValue, assignment6_model_IntegerFeature_maxValue, assignment6_model_IntegerFeature_value}
...
domain_model = DomainModel(
    ...
    types={assignment6_model_Configurator, assignment6_model_Feature, assignment6_model_Group, assignment6_model_Dependency, assignment6_model_SimpleFeature, Feature, assignment6_model_IntegerFeature, assignment6_model_UnaryDependency, Dependency, assignment6_model_BinaryDependency, assignment6_model_IsSelectedDependency, UnaryDependency, assignment6_model_IntegerValueDependency, GroupType, BinaryOperator},
    associations={features0, groups1, features4, groups6, dependencies9, features11, rightHand13, leftHand15, target18, target20},
    generalizations={gen_assignment6_model_SimpleFeature_Feature, gen_assignment6_model_IntegerFeature_Feature, gen_assignment6_model_UnaryDependency_Dependency, gen_assignment6_model_BinaryDependency_Dependency, gen_assignment6_model_IsSelectedDependency_UnaryDependency, gen_assignment6_model_IntegerValueDependency_UnaryDependency},
    metadata=None
)
