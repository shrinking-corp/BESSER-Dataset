...
classes_TypedElement = Class(name="classes_TypedElement", is_abstract=True)
classes_Class = Class(name="classes_Class")
classes_CallExp = Class(name="classes_CallExp", is_abstract=True)
TypedElement = Class(name="TypedElement")
classes_Root = Class(name="classes_Root")
...
classes_PropertyCallExp = Class(name="classes_PropertyCallExp")
CallExp = Class(name="CallExp")
classes_OperationCallExp = Class(name="classes_OperationCallExp")
classes_Argument = Class(name="classes_Argument")
classes_Visitable = Class(name="classes_Visitable", is_abstract=True)
...
domain_model = DomainModel(
    name="classes",
    types={classes_Element, Visitable, classes_NamedElement, Element, classes_Namespace, classes_TypedElement, classes_Class, classes_CallExp, TypedElement, classes_Root, classes_Package, NamedElement, Namespace, classes_Operation, classes_Property, classes_Parameter, classes_PropertyCallExp, CallExp, classes_OperationCallExp, classes_Argument, classes_Visitable},
    associations={ownedCallExp2, owningSource4, type0, ownedPackages6, ownedClasses7, ownedPackages11, superClass14, ownedOperations16, ownedProperties18, ownedParameters20, ownedExpressions22, referredProperty24, ownedArguments26, referredOperation27},
    generalizations={gen_classes_Element_Visitable, gen_classes_NamedElement_Element, gen_classes_Namespace_Element, gen_classes_TypedElement_Element, gen_classes_CallExp_TypedElement, gen_classes_Root_Element, gen_classes_Package_NamedElement, gen_classes_Package_Namespace, gen_classes_Class_NamedElement, gen_classes_Property_NamedElement, gen_classes_Property_TypedElement, gen_classes_Operation_NamedElement, gen_classes_Operation_TypedElement, gen_classes_Parameter_NamedElement, gen_classes_PropertyCallExp_CallExp, gen_classes_OperationCallExp_CallExp, gen_classes_Argument_NamedElement},
    metadata=None
)
