...
# Classes
smartadapters4MODERATES_Aspect = Class(name="smartadapters4MODERATES_Aspect")
smartadapters4MODERATES_PointcutModel = Class(name="smartadapters4MODERATES_PointcutModel")
smartadapters4MODERATES_AdviceModel = Class(name="smartadapters4MODERATES_AdviceModel")
smartadapters4MODERATES_InstantiationStrategy = Class(name="smartadapters4MODERATES_InstantiationStrategy", is_abstract=True)
smartadapters4MODERATES_CloneAdaptation = Class(name="smartadapters4MODERATES_CloneAdaptation", is_abstract=True)
Adaptation = Class(name="Adaptation")
smartadapters4MODERATES_CreateAdaptation = Class(name="smartadapters4MODERATES_CreateAdaptation", is_abstract=True)
smartadapters4MODERATES_SetAdaptation = Class(name="smartadapters4MODERATES_SetAdaptation", is_abstract=True)
smartadapters4MODERATES_UnsetAdaptation = Class(name="smartadapters4MODERATES_UnsetAdaptation", is_abstract=True)
smartadapters4MODERATES_AspectModelElement = Class(name="smartadapters4MODERATES_AspectModelElement")
smartadapters4MODERATES_GlobalInstantiation = Class(name="smartadapters4MODERATES_GlobalInstantiation")
InstantiationStrategy = Class(name="InstantiationStrategy")
smartadapters4MODERATES_ScopedInstantiation = Class(name="smartadapters4MODERATES_ScopedInstantiation", is_abstract=True)
smartadapters4MODERATES_PerRoleMatch = Class(name="smartadapters4MODERATES_PerRoleMatch")
ScopedInstantiation = Class(name="ScopedInstantiation")
smartadapters4MODERATES_PerElementMatch = Class(name="smartadapters4MODERATES_PerElementMatch")
smartadapters4MODERATES_adaptations_SetCompositeState = Class(name="smartadapters4MODERATES_adaptations_SetCompositeState")
SetAdaptation = Class(name="SetAdaptation")
adaptations_smartadapters4MODERATES_CompositeState = Class(name="adaptations_smartadapters4MODERATES_CompositeState")
adaptations_smartadapters4MODERATES_State = Class(name="adaptations_smartadapters4MODERATES_State")
smartadapters4MODERATES_adaptations_UnsetCompositeState = Class(name="smartadapters4MODERATES_adaptations_UnsetCompositeState")
UnsetAdaptation = Class(name="UnsetAdaptation")
smartadapters4MODERATES_Adaptation = Class(name="smartadapters4MODERATES_Adaptation", is_abstract=True)
adaptations_smartadapters4MODERATES_Transition = Class(name="adaptations_smartadapters4MODERATES_Transition")
adaptations_smartadapters4MODERATES_Action = Class(name="adaptations_smartadapters4MODERATES_Action")
adaptations_smartadapters4MODERATES_Property = Class(name="adaptations_smartadapters4MODERATES_Property")
smartadapters4MODERATES_adaptations_UnsetState = Class(name="smartadapters4MODERATES_adaptations_UnsetState")
smartadapters4MODERATES_adaptations_SetTransition = Class(name="smartadapters4MODERATES_adaptations_SetTransition")
adaptations_smartadapters4MODERATES_Event = Class(name="adaptations_smartadapters4MODERATES_Event")
adaptations_smartadapters4MODERATES_Expression = Class(name="adaptations_smartadapters4MODERATES_Expression")
smartadapters4MODERATES_adaptations_UnsetTransition = Class(name="smartadapters4MODERATES_adaptations_UnsetTransition")
smartadapters4MODERATES_adaptations_SetState = Class(name="smartadapters4MODERATES_adaptations_SetState")
smartadapters4MODERATES_adaptations_SetAnnotatedElement = Class(name="smartadapters4MODERATES_adaptations_SetAnnotatedElement")
adaptations_smartadapters4MODERATES_AnnotatedElement = Class(name="adaptations_smartadapters4MODERATES_AnnotatedElement")
adaptations_smartadapters4MODERATES_PlatformAnnotation = Class(name="adaptations_smartadapters4MODERATES_PlatformAnnotation")
smartadapters4MODERATES_adaptations_SetActionBlock = Class(name="smartadapters4MODERATES_adaptations_SetActionBlock")
adaptations_smartadapters4MODERATES_ActionBlock = Class(name="adaptations_smartadapters4MODERATES_ActionBlock")
