...
# Classes
asso_EvalExpression = Class(name="asso_EvalExpression")
asso_Expression = Class(name="asso_Expression")
asso_FloatConstant = Class(name="asso_FloatConstant")
Expression = Class(name="Expression")
asso_NegFloatConstant = Class(name="asso_NegFloatConstant")
asso_VariableRef = Class(name="asso_VariableRef")
asso_Plus = Class(name="asso_Plus")
asso_Minus = Class(name="asso_Minus")
asso_Model = Class(name="asso_Model")
asso_Variable = Class(name="asso_Variable")
asso_Mult = Class(name="asso_Mult")
asso_Div = Class(name="asso_Div")
...
domain_model = DomainModel(
    name="asso",
    types={asso_EvalExpression, asso_Expression, asso_FloatConstant, Expression, asso_NegFloatConstant, asso_VariableRef, asso_Plus, asso_Minus, asso_Model, asso_Variable, asso_Mult, asso_Div},
    associations={variables0, evaluations1, subVar4, expression6, expression8, value11, left13, right15, left18, left28, right30, right20, left23, right25},
    generalizations={gen_asso_FloatConstant_Expression, gen_asso_NegFloatConstant_Expression, gen_asso_VariableRef_Expression, gen_asso_Plus_Expression, gen_asso_Minus_Expression, gen_asso_Mult_Expression, gen_asso_Div_Expression},
    metadata=None
)
