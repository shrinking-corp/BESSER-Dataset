...
class stext_FeatureCall(Expression):
    ...
    def __init__(self, operationCall: bool, stext_FeatureCall: "stext_Expression" = None, stext_FeatureCall94: "stext_EObject" = None, stext_FeatureCall96: set["stext_Expression"] = None):
