...
class fsm_Transition:
    ...
    def __init__(self, output: str, input: str, Transition: "fsm_State" = None, Transition4: "fsm_State" = None, outgoingTransition: "fsm_State" = None, incomingTransition: "fsm_State" = None):
        self.output = output
        self.input = input
