...
def test_hyp_yyc_blias_is_not_abstract():
    assert not inspect.isabstract(yyc_Blias)


def test_hyp_yyc_blias_constructor_exists():
    assert callable(yyc_Blias.__init__)


def test_hyp_yyc_blias_constructor_args():
...
def test_hyp_yyc_alias_is_not_abstract():
    assert not inspect.isabstract(yyc_Alias)


def test_hyp_yyc_alias_constructor_exists():
    assert callable(yyc_Alias.__init__)


def test_hyp_yyc_alias_constructor_args():
...
def test_hyp_yyc_relatedto_is_not_abstract():
    assert not inspect.isabstract(yyc_RelatedTo)


def test_hyp_yyc_relatedto_constructor_exists():
    assert callable(yyc_RelatedTo.__init__)


def test_hyp_yyc_relatedto_constructor_args():
...
def test_hyp_yyc_thing_is_not_abstract():
    assert not inspect.isabstract(yyc_Thing)


def test_hyp_yyc_thing_constructor_exists():
    assert callable(yyc_Thing.__init__)


def test_hyp_yyc_thing_constructor_args():
...
def test_hyp_yyc_blias_id_setter(instance):
...
def test_hyp_yyc_alias_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
def test_hyp_yyc_relatedto_since_setter(instance):
...
def test_hyp_yyc_thing_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
