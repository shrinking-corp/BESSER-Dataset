...
# Classes
yyc_Thing = Class(name="yyc_Thing")
yyc_RelatedTo = Class(name="yyc_RelatedTo")
yyc_Alias = Class(name="yyc_Alias")
yyc_Blias = Class(name="yyc_Blias")
...
domain_model = DomainModel(
    name="yyc",
    types={yyc_Thing, yyc_RelatedTo, yyc_Alias, yyc_Blias},
