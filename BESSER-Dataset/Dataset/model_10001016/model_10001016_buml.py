...
Karta.attributes={Karta_PovratakKarta, Karta_KartaID, Karta_RezerID, Karta_VremeOdlaska, Karta_CenaKarte, Karta_VremePovratka, Karta_OdlazakKarta}
...
Destinacija.attributes={Destinacija_DesDrzava, Destinacija_DesGrad, Destinacija_DestiID}
...
Rezervisanje.attributes={Rezervisanje_RezerID, Rezervisanje_DatumDolaska, Rezervisanje_SlobMesto, Rezervisanje_Cena, Rezervisanje_KorisnikID, Rezervisanje_DatumPolaska, Rezervisanje_DestiID, Rezervisanje_PutnikID}
...
Hotel.attributes={Hotel_SpratHotela, Hotel_DestiID, Hotel_AdresaHotela, Hotel_DuzinaBoravka, Hotel_UslugaHotela, Hotel_ImeHotela, Hotel_CenaSmestaja, Hotel_HotelID, Hotel_SobaHotela}
...
Osiguranje.attributes={Osiguranje_OsigID, Osiguranje_KucaOsiguranje}
...
Putnik.attributes={Putnik_JMBG, Putnik_PrezimePut, Putnik_ImePut, Putnik_Grad, Putnik_OsigID, Putnik_PutnikID, Putnik_Mobilni, Putnik_eMail, Putnik_Adresa}
...
Korisnik_IS.attributes={Korisnik_IS_ImeKorisnika, Korisnik_IS_KorisnikID, Korisnik_IS_PrezimeKorisnika, Korisnik_IS_UserName, Korisnik_IS_Password}
...
domain_model = DomainModel(
    name="_7b42be48_3aa7_4791_819e_a962d123ef1f",
    types={Karta, Destinacija, Rezervisanje, Hotel, Osiguranje, Putnik, Korisnik_IS},
