...
# Classes
extlibraryprofile_CirculatingItem = Class(name="extlibraryprofile_CirculatingItem", is_abstract=True)
Item = Class(name="Item")
Lendable = Class(name="Lendable")
extlibraryprofile_Item = Class(name="extlibraryprofile_Item", is_abstract=True)
extlibraryprofile_Class = Class(name="extlibraryprofile_Class")
extlibraryprofile_Lendable = Class(name="extlibraryprofile_Lendable", is_abstract=True)
extlibraryprofile_Library = Class(name="extlibraryprofile_Library")
Addressable = Class(name="Addressable")
extlibraryprofile_Package = Class(name="extlibraryprofile_Package")
extlibraryprofile_Addressable = Class(name="extlibraryprofile_Addressable", is_abstract=True)
extlibraryprofile_Book = Class(name="extlibraryprofile_Book")
CirculatingItem = Class(name="CirculatingItem")
extlibraryprofile_Borrower = Class(name="extlibraryprofile_Borrower")
extlibraryprofile_Employee = Class(name="extlibraryprofile_Employee")
extlibraryprofile_Borrows = Class(name="extlibraryprofile_Borrows")
extlibraryprofile_Dependency = Class(name="extlibraryprofile_Dependency")
extlibraryprofile_Writer = Class(name="extlibraryprofile_Writer")
Person = Class(name="Person")
extlibraryprofile_BookOnTape = Class(name="extlibraryprofile_BookOnTape")
extlibraryprofile_Person = Class(name="extlibraryprofile_Person", is_abstract=True)
extlibraryprofile_VideoCassete = Class(name="extlibraryprofile_VideoCassete")
AudioVisualItem = Class(name="AudioVisualItem")
extlibraryprofile_AudioVisualItem = Class(name="extlibraryprofile_AudioVisualItem", is_abstract=True)
extlibraryprofile_Periodical = Class(name="extlibraryprofile_Periodical")
...
extlibraryprofile_AudioVisualItem.attributes={extlibraryprofile_AudioVisualItem_damaged, extlibraryprofile_AudioVisualItem_minutesLength}
...
domain_model = DomainModel(
    ...
    types={extlibraryprofile_CirculatingItem, Item, Lendable, extlibraryprofile_Item, extlibraryprofile_Class, extlibraryprofile_Lendable, extlibraryprofile_Library, Addressable, extlibraryprofile_Package, extlibraryprofile_Addressable, extlibraryprofile_Book, CirculatingItem, extlibraryprofile_Borrower, extlibraryprofile_Employee, extlibraryprofile_Borrows, extlibraryprofile_Dependency, extlibraryprofile_Writer, Person, extlibraryprofile_BookOnTape, extlibraryprofile_Person, extlibraryprofile_VideoCassete, AudioVisualItem, extlibraryprofile_AudioVisualItem, extlibraryprofile_Periodical, BookCategory},
    associations={base_Class0, base_Package1, base_Dependency10, bookOnTape2, videoCassete3, bookOnTape14, base_Class7},
    generalizations={gen_extlibraryprofile_CirculatingItem_Item, gen_extlibraryprofile_CirculatingItem_Lendable, gen_extlibraryprofile_Library_Addressable, gen_extlibraryprofile_Book_CirculatingItem, gen_extlibraryprofile_Borrower_Person, gen_extlibraryprofile_Employee_Person, gen_extlibraryprofile_Writer_Person, gen_extlibraryprofile_Person_Addressable, gen_extlibraryprofile_VideoCassete_AudioVisualItem, gen_extlibraryprofile_AudioVisualItem_CirculatingItem, gen_extlibraryprofile_BookOnTape_AudioVisualItem, gen_extlibraryprofile_Periodical_Item},
    metadata=None
)
