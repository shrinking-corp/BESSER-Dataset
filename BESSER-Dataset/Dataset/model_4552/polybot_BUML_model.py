...
# Classes
polybot_Bot = Class(name="polybot_Bot")
polybot_Point = Class(name="polybot_Point")
polybot_Instruction = Class(name="polybot_Instruction", is_abstract=True)
Move = Class(name="Move")
polybot_Move = Class(name="polybot_Move", is_abstract=True)
Instruction = Class(name="Instruction")
polybot_Right = Class(name="polybot_Right")
polybot_Left = Class(name="polybot_Left")
polybot_Reverse = Class(name="polybot_Reverse")
polybot_Forward = Class(name="polybot_Forward")
polybot_IfObjectDetected = Class(name="polybot_IfObjectDetected")
polybot_IfObstacleDetected = Class(name="polybot_IfObstacleDetected")
polybot_TakeDropObject = Class(name="polybot_TakeDropObject")
polybot_While = Class(name="polybot_While")
polybot_GoTo = Class(name="polybot_GoTo")
...
domain_model = DomainModel(
    name="polybot",
    types={polybot_Bot, polybot_Point, polybot_Instruction, Move, polybot_Move, Instruction, polybot_Right, polybot_Left, polybot_Reverse, polybot_Forward, polybot_IfObjectDetected, polybot_IfObstacleDetected, polybot_TakeDropObject, polybot_While, polybot_GoTo},
    associations={initialPosition0, instructionList1, listOfInstructions3, listOfInstructions5, listOfInstructions7},
