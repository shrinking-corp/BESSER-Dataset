...
Customer.attributes={Customer_id, Customer_phoneno, Customer_address, Customer_name, Customer_mailid}
...
company_type: Property = Property(name="type", type=StringType)
company.attributes={company_name, company_id, company_type}

# services class attributes and methods
services_database: Property = Property(name="database", type=StringType)
services_location: Property = Property(name="location", type=StringType)
services.attributes={services_database, services_location}
...
Product_Warehouse: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="warehouse26", type=services, multiplicity=Multiplicity(1, 9999)),
        Property(name="product27", type=company, multiplicity=Multiplicity(0, 9999))
    }
)
Customer_Product: BinaryAssociation = BinaryAssociation(
    name="Customer_Product",
    ends={
        Property(name="company28", type=company, multiplicity=Multiplicity(0, 9999)),
