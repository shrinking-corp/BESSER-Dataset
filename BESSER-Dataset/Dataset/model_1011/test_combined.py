...
def test_hyp_fsm_stateoff_is_not_abstract():
    assert not inspect.isabstract(fsm_StateOff)


def test_hyp_fsm_stateoff_constructor_exists():
    assert callable(fsm_StateOff.__init__)


def test_hyp_fsm_stateoff_constructor_args():
    sig = inspect.signature(fsm_StateOff.__init__)
    params = list(sig.parameters.keys())



def test_hyp_fsm_statefinal_is_not_abstract():
    assert not inspect.isabstract(fsm_StateFinal)


def test_hyp_fsm_statefinal_constructor_exists():
    assert callable(fsm_StateFinal.__init__)


def test_hyp_fsm_statefinal_constructor_args():
    sig = inspect.signature(fsm_StateFinal.__init__)
    params = list(sig.parameters.keys())



def test_hyp_fsm_stateon_is_not_abstract():
    assert not inspect.isabstract(fsm_StateOn)


def test_hyp_fsm_stateon_constructor_exists():
    assert callable(fsm_StateOn.__init__)


def test_hyp_fsm_stateon_constructor_args():
