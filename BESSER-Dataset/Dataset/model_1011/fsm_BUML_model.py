...
fsm_State = Class(name="fsm_State", is_abstract=True)
fsm_Transition = Class(name="fsm_Transition")
fsm_StateOn = Class(name="fsm_StateOn")
State = Class(name="State")
fsm_StateOff = Class(name="fsm_StateOff")
fsm_StateFinal = Class(name="fsm_StateFinal")
