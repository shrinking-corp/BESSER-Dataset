...
domain_model = DomainModel(
    name="PetriNet",
    types={PetriNet_Element, PetriNet_PetriNet, Element, PetriNet_Place, PetriNet_Transition, PetriNet_Arc, PetriNet_TransToPlaceArc, PetriNet_PlaceToTransArc, Arc},
    associations={places0, transitions1, source15, target18, arcs3, incoming5, outgoing6, incoming7, outgoing10, source13, target14},
    generalizations={gen_PetriNet_PetriNet_Element, gen_PetriNet_TransToPlaceArc_Arc, gen_PetriNet_Place_Element, gen_PetriNet_Transition_Element, gen_PetriNet_PlaceToTransArc_Arc},
    metadata=None
)
