...
ecore_EClassNotMatching = Class(name="ecore_EClassNotMatching")
...
ecore_EObject_m_eGet: Method = Method(name="eGet", parameters={Parameter(name='ecore_feature', type=StringType)}, type=StringType)
ecore_EObject_m_eGet: Method = Method(name="eGet", parameters={Parameter(name='ecore_feature', type=StringType), Parameter(name='ecore_resolve', type=StringType)}, type=StringType)
...
ecore_EObject_m_eIsSet: Method = Method(name="eIsSet", parameters={Parameter(name='ecore_feature', type=StringType)}, type=BooleanType)
ecore_EObject_m_eUnset: Method = Method(name="eUnset", parameters={Parameter(name='ecore_feature', type=StringType)})
ecore_EObject_m_eInvoke: Method = Method(name="eInvoke", parameters={Parameter(name='ecore_operation', type=StringType), Parameter(name='ecore_arguments', type=StringType)}, type=StringType)
ecore_EObject.methods={ecore_EObject_m_eSet, ecore_EObject_m_eIsSet, ecore_EObject_m_eIsProxy, ecore_EObject_m_eClass, ecore_EObject_m_eGet, ecore_EObject_m_eContainingFeature, ecore_EObject_m_eInvoke, ecore_EObject_m_eContainmentFeature, ecore_EObject_m_eResource, ecore_EObject_m_eUnset, ecore_EObject_m_eAllContents, ecore_EObject_m_eGet, ecore_EObject_m_eCrossReferences, ecore_EObject_m_eContainer, ecore_EObject_m_eContents}
...
ecore_EClassNotMatching_m_isSuperTypeOf: Method = Method(name="isSuperTypeOf", parameters={Parameter(name='ecore_someClass', type=StringType)}, type=BooleanType)
ecore_EClassNotMatching_m_getFeatureCount: Method = Method(name="getFeatureCount", parameters={}, type=IntegerType)
ecore_EClassNotMatching_m_getEStructuralFeature: Method = Method(name="getEStructuralFeature", parameters={Parameter(name='ecore_featureID', type=StringType)}, type=EStructuralFeature)
ecore_EClassNotMatching_m_getFeatureID: Method = Method(name="getFeatureID", parameters={Parameter(name='ecore_feature', type=StringType)}, type=IntegerType)
ecore_EClassNotMatching_m_getEStructuralFeature: Method = Method(name="getEStructuralFeature", parameters={Parameter(name='ecore_featureName', type=StringType)}, type=EStructuralFeature)
ecore_EClassNotMatching_m_getOperationCount: Method = Method(name="getOperationCount", parameters={}, type=IntegerType)
ecore_EClassNotMatching_m_getEOperation: Method = Method(name="getEOperation", parameters={Parameter(name='ecore_operationID', type=StringType)}, type=StringType)
ecore_EClassNotMatching_m_getOperationID: Method = Method(name="getOperationID", parameters={Parameter(name='ecore_operation', type=StringType)}, type=IntegerType)
ecore_EClassNotMatching_m_getOverride: Method = Method(name="getOverride", parameters={Parameter(name='ecore_operation', type=StringType)}, type=StringType)
ecore_EClassNotMatching_m_getFeatureType: Method = Method(name="getFeatureType", parameters={Parameter(name='ecore_feature', type=StringType)}, type=StringType)
ecore_EClassNotMatching.attributes={ecore_EClassNotMatching_abstract, ecore_EClassNotMatching_interface}
ecore_EClassNotMatching.methods={ecore_EClassNotMatching_m_getFeatureID, ecore_EClassNotMatching_m_getEStructuralFeature, ecore_EClassNotMatching_m_getFeatureCount, ecore_EClassNotMatching_m_getEOperation, ecore_EClassNotMatching_m_getFeatureType, ecore_EClassNotMatching_m_getOperationID, ecore_EClassNotMatching_m_getEStructuralFeature, ecore_EClassNotMatching_m_getOperationCount, ecore_EClassNotMatching_m_isSuperTypeOf, ecore_EClassNotMatching_m_getOverride}
...
ecore_EStructuralFeature.attributes={ecore_EStructuralFeature_unsettable, ecore_EStructuralFeature_derived, ecore_EStructuralFeature_defaultValue, ecore_EStructuralFeature_volatile, ecore_EStructuralFeature_transient, ecore_EStructuralFeature_changeable, ecore_EStructuralFeature_defaultValueLiteral}
...
ecore_EOperation_m_isOverrideOf: Method = Method(name="isOverrideOf", parameters={Parameter(name='ecore_someOperation', type=StringType)}, type=BooleanType)
...
ecore_EPackage_m_getEClassifier: Method = Method(name="getEClassifier", parameters={Parameter(name='ecore_name', type=StringType)}, type=EClassifier)
...
ecore_EEnum_m_getEEnumLiteral: Method = Method(name="getEEnumLiteral", parameters={Parameter(name='ecore_name', type=StringType)}, type=StringType)
...
ecore_EGenericType_m_isInstance: Method = Method(name="isInstance", parameters={Parameter(name='ecore_object', type=StringType)}, type=BooleanType)
...
ecore_EClassifier_m_isInstance: Method = Method(name="isInstance", parameters={Parameter(name='ecore_object', type=StringType)}, type=BooleanType)
...
ecore_EFactory_m_createFromString: Method = Method(name="createFromString", parameters={Parameter(name='ecore_eDataType', type=StringType), Parameter(name='ecore_literalValue', type=StringType)}, type=StringType)
ecore_EFactory_m_convertToString: Method = Method(name="convertToString", parameters={Parameter(name='ecore_eDataType', type=StringType), Parameter(name='ecore_instanceValue', type=StringType)}, type=StringType)
...
ecore_ETypedElement.attributes={ecore_ETypedElement_required, ecore_ETypedElement_lowerBound, ecore_ETypedElement_upperBound, ecore_ETypedElement_ordered, ecore_ETypedElement_unique, ecore_ETypedElement_many}
...
domain_model = DomainModel(
    name="ecore",
    types={ecore_EStringToStringMapEntry, ecore_EModelElement, ecore_EObject, ecore_EClassNotMatching, EClassifier, ecore_EAttribute, EStructuralFeature, ecore_EDataType, ecore_EAnnotation, EModelElement, ecore_EStructuralFeature, ecore_EOperation, ecore_EReference, ecore_EPackage, ecore_ETypeParameter, ecore_EEnum, EDataType, ecore_EGenericType, ecore_EClassifier, ENamedElement, ecore_ENamedElement, ecore_EEnumLiteral, ecore_EFactory, ecore_EParameter, ETypedElement, ecore_ETypedElement},
    associations={details1, eModelElement2, contents3, references5, eAttributeType0, eAllReferences14, eReferences16, eAttributes19, eAllContainments22, eAllOperations25, eSuperTypes9, eOperations10, eAllAttributes11, ePackage42, eTypeParameters43, eAllStructuralFeatures27, eAllSuperTypes30, eIDAttribute32, eStructuralFeatures35, eGenericSuperTypes37, eAllGenericSuperTypes39, eAnnotations48, eLiterals44, eEnum45, ePackage46, eParameters53, eExceptions54, eGenericExceptions57, eContainingClass49, eTypeParameters50, eKeys77, eFactoryInstance60, eClassifiers61, eSubpackages64, eSuperPackage67, eOperation69, eOpposite72, eReferenceType74, eContainingClass80, eType82, eGenericType84, eUpperBound88, eTypeArguments91, eRawType93, eLowerBound97, eTypeParameter99, eClassifier102, eBounds105},
    generalizations={gen_ecore_EClassNotMatching_EClassifier, gen_ecore_EAttribute_EStructuralFeature, gen_ecore_EAnnotation_EModelElement, gen_ecore_EDataType_EClassifier, gen_ecore_EEnum_EDataType, gen_ecore_EClassifier_ENamedElement, gen_ecore_ENamedElement_EModelElement, gen_ecore_EEnumLiteral_ENamedElement, gen_ecore_EFactory_EModelElement, gen_ecore_EPackage_ENamedElement, gen_ecore_EOperation_ETypedElement, gen_ecore_EStructuralFeature_ETypedElement, gen_ecore_EParameter_ETypedElement, gen_ecore_EReference_EStructuralFeature, gen_ecore_ETypedElement_ENamedElement, gen_ecore_ETypeParameter_ENamedElement},
    metadata=None
)
