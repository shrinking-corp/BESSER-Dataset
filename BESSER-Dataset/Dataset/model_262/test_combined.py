...
def test_hyp_ecore_eclassnotmatching_is_not_abstract():
    assert not inspect.isabstract(ecore_EClassNotMatching)


def test_hyp_ecore_eclassnotmatching_constructor_exists():
    assert callable(ecore_EClassNotMatching.__init__)


def test_hyp_ecore_eclassnotmatching_constructor_args():
...
def test_hyp_ecore_eclassnotmatching_abstract_setter(instance):
...
@given(instance=ecore_EClassNotMatching_strategy)
def test_hyp_ecore_eclassnotmatching_interface_setter(instance):
...
@given(instance=ecore_EClassNotMatching_strategy)
@settings(max_examples=30)
def test_hyp_ecore_eclassnotmatching_issupertypeof_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
