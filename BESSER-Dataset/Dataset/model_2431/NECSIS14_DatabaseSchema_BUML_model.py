...
# Classes
necsis14_databaseschema_DatabaseSchema = Class(name="necsis14_databaseschema_DatabaseSchema")
necsis14_databaseschema_Table = Class(name="necsis14_databaseschema_Table")
necsis14_databaseschema_NamedElement = Class(name="necsis14_databaseschema_NamedElement", is_abstract=True)
NamedElement = Class(name="NamedElement")
necsis14_databaseschema_Column = Class(name="necsis14_databaseschema_Column")
...
domain_model = DomainModel(
    ...
    associations={tables0, columns1, primaryKeys3},
