...
public class connection_SAPConnection extends Connection {
    ...
    public connection_SAPConnection(
        String Language,        String Username,        String Client,        String SystemNumber,        String Password,        String Host,        String currentFucntion    ) {
        super(
        );
    ...
    public connection_SAPConnection(
        String Language,        String Username,        String Client,        String SystemNumber,        String Password,        String Host,        String currentFucntion        ArrayList<connection_SAPIDocUnit> connection_sapidocunits,        ArrayList<connection_SAPFunctionUnit> connection_sapfunctionunits    ) {
        this.Language = Language;
        this.Username = Username;
        this.Client = Client;
        this.SystemNumber = SystemNumber;
