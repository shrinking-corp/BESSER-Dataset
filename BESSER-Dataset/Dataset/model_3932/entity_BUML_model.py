...
# Classes
entity_Package = Class(name="entity_Package")
NamedElement = Class(name="NamedElement")
entity_Type = Class(name="entity_Type", is_abstract=True)
entity_Entity = Class(name="entity_Entity")
Type = Class(name="Type")
entity_Member = Class(name="entity_Member", is_abstract=True)
entity_Field = Class(name="entity_Field")
Member = Class(name="Member")
entity_Method = Class(name="entity_Method")
entity_Service = Class(name="entity_Service")
