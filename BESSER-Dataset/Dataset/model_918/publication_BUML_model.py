...
publication_Researcher.attributes={publication_Researcher_forName, publication_Researcher_name, publication_Researcher_position}
...
domain_model = DomainModel(
    name="publication",
    types={publication_PublicationPhase, publication_PublicationProcess, Named, publication_Rule, publication_Sequence, publication_Researcher, publication_PlaceHolderPP, publication_PlaceHolderRule, publication_Write, publication_Review, publication_Paper, publication_PlaceHolderRs, publication_Paragraph, publication_Progress, Counted, publication_ReviewNote, publication_PlaceHolderRn, Labelled, publication_PublicationStructure, publication_PublicationSystem, publication_Named, publication_Counted, publication_Labelled, PlaceHolder, publication_PlaceHolder, SequenceType},
    associations={phases0, phaseParticipation19, publicationRules1, linksToSuccessors3, neededPerson5, rules6, placeholder9, successor11, predecessor14, placeholder17, paper36, writes20, reviews21, papers23, placeholder24, paragraphs26, progress27, authors28, reviews30, placeholder32, process34, paragraph38, reviewNote41, researchers44, papers46, processView49, structuralView51},
    generalizations={gen_publication_PublicationProcess_Named, gen_publication_Write_Labelled, gen_publication_Paper_Named, gen_publication_Paragraph_Counted, gen_publication_Paragraph_Named, gen_publication_ReviewNote_Named, gen_publication_Progress_Labelled, gen_publication_Review_Labelled, gen_publication_PublicationStructure_Named, gen_publication_PlaceHolderRs_PlaceHolder, gen_publication_PlaceHolderRule_PlaceHolder, gen_publication_PlaceHolderRn_PlaceHolder, gen_publication_PlaceHolderPP_PlaceHolder},
    metadata=None
)
