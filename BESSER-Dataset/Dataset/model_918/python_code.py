...
class publication_Researcher:
    ...
    def __init__(self, name: str, forName: str, position: str, neededPerson: set["publication_PublicationPhase"] = None, Researcher: "publication_PublicationPhase" = None, publication_Researcher: set["publication_Write"] = None, publication_Researcher22: set["publication_Review"] = None, authors: set["publication_Paper"] = None, publication_Researcher25: "publication_PlaceHolderRs" = None, Researcher29: "publication_Paper" = None, publication_Researcher45: "publication_PublicationStructure" = None):
        self.name = name
...
class publication_Sequence:
    ...
    def __init__(self, sequenceType: str, publication_Sequence15: "publication_PublicationPhase" = None, publication_Sequence: "publication_PublicationPhase" = None, publication_Sequence12: "publication_PublicationPhase" = None):
...
class publication_Rule:
    ...
    def __init__(self, text: str, key: str, publication_Rule: "publication_PublicationProcess" = None, publication_Rule8: "publication_PublicationPhase" = None, publication_Rule18: "publication_PlaceHolderRule" = None):
        self.text = text
        self.key = key
...
class publication_ReviewNote(Named):
    ...
    def __init__(self, content: str, publication_ReviewNote: "publication_Paragraph" = None, publication_ReviewNote33: "publication_PlaceHolderRn" = None, publication_ReviewNote43: "publication_Review" = None):
...
class publication_PublicationPhase:
    ...
    def __init__(self, name: str, minTime: int, maxTime: int, publication_PublicationPhase16: "publication_Sequence" = None, publication_PublicationPhase: "publication_PublicationProcess" = None, PublicationPhase: "publication_Researcher" = None, publication_PublicationPhase4: set["publication_Sequence"] = None, phaseParticipation: set["publication_Researcher"] = None, publication_PublicationPhase7: set["publication_Rule"] = None, publication_PublicationPhase10: "publication_PlaceHolderPP" = None, publication_PublicationPhase13: "publication_Sequence" = None):
        self.name = name
        self.minTime = minTime
        self.maxTime = maxTime
