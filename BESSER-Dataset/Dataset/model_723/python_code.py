...
class org_structure_Operation(structure_MultiplicityElement, structure_AbstractOperation):
    ...
    def __init__(self, isAbstract: str, uniqueName: str, org_structure_Operation: set["structure_Type"] = None, operation: set["structure_Parameter"] = None, postOwner: set["structure_Constraint"] = None, org_structure_Operation77: "behavior_Expression" = None, org_structure_Operation80: set["structure_UnresolvedOperation"] = None, ownedOperation: "structure_ClassDefinition" = None, org_structure_Operation83: set["structure_TypeVariable"] = None, preOwner: set["structure_Constraint"] = None):
        self.isAbstract = isAbstract
...
class org_structure_ModelTransformation(MultiplicityElement):
    ...
    def __init__(self, isAbstract: str, org_structure_ModelTransformation228: "behavior_Expression" = None, org_structure_ModelTransformation: set["structure_ModelTypeVariable"] = None, org_structure_ModelTransformation231: set["structure_Operation"] = None, ownedTransformations: "structure_ModelTypeDefinition" = None, org_structure_ModelTransformation235: set["structure_Parameter"] = None):
        self.isAbstract = isAbstract
...
class structure_UnresolvedReference:
    ...
    pass
class org_structure_UnresolvedType(structure_Type, structure_UnresolvedReference, structure_TypeContainer):

    def __init__(self, typeIdentifier: str, org_structure_UnresolvedType: set["structure_Using"] = None, org_structure_UnresolvedType162: set["structure_Type"] = None, structure_UnresolvedReference: "org_structure_UseAdaptationOperator" = None, TypeContainer: "org_structure_Type" = None, structure_Type121: "org_structure_TypedElement" = None, structure_Type150: "org_structure_TypeVariable" = None, structure_Type60: "org_behavior_UnresolvedCall" = None, structure_Type8: "org_behavior_CallExpression" = None, structure_Type167: "org_structure_FunctionType" = None, structure_Type: "org_behavior_Expression" = None, structure_Type163: "org_structure_UnresolvedType" = None, Type: "org_structure_TypeContainer" = None, structure_Type102: "org_structure_TypeVariableBinding" = None, structure_Type104: "org_structure_TypeDefinition" = None, structure_Type119: "org_structure_PrimitiveType" = None, structure_Type165: "org_structure_ProductType" = None, structure_Type71: "org_structure_Operation" = None, structure_Type170: "org_structure_FunctionType" = None, structure_Type63: "org_behavior_UnresolvedCall" = None, structure_Type16: "org_behavior_CallSuperOperation" = None):
...
class org_structure_UnresolvedOperation(structure_UnresolvedReference, structure_TypeContainer, structure_AbstractOperation):
    ...
    def __init__(self, operationIdentifier: str, structure_UnresolvedReference: "org_structure_UseAdaptationOperator" = None, TypeContainer: "org_structure_Type" = None):
...
class org_behavior_UnresolvedCall(structure_UnresolvedReference, behavior_CallExpression, structure_TypeContainer):
    ...
    def __init__(self, isAtpre: str, isCalledWithParenthesis: str, org_behavior_UnresolvedCall59: "structure_Type" = None, org_behavior_UnresolvedCall62: set["structure_Type"] = None, org_behavior_UnresolvedCall: set["structure_Using"] = None, org_behavior_UnresolvedCall56: "behavior_Expression" = None, structure_UnresolvedReference: "org_structure_UseAdaptationOperator" = None, behavior_CallExpression: "org_behavior_Assignment" = None, TypeContainer: "org_structure_Type" = None):
        self.isAtpre = isAtpre
