...
Payment.attributes={Payment_pay_mode, Payment_pay_amount, Payment_card_no, Payment_ex_date, Payment_pay_id}
...
Request.attributes={Request_requser_id, Request_request_id, Request_request_type, Request_request_details}
...
Advertiesment.attributes={Advertiesment_start_date, Advertiesment_end_date, Advertiesment_advertiesment_id, Advertiesment_advertiser_id}
...
Property_.attributes={Property__property_type, Property__address, Property__property_id, Property__location}
...
Advertiser_Advertiesment: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="advertiesment2", type=Advertiesment, multiplicity=Multiplicity(0, 9999)),
        Property(name="advertiser3", type=Advertiser, multiplicity=Multiplicity(1, 1))
    }
)
Property_Seller: BinaryAssociation = BinaryAssociation(
    name="Property_Seller",
    ends={
        Property(name="seller4", type=Seller, multiplicity=Multiplicity(1, 1)),
...
Property_Buyer: BinaryAssociation = BinaryAssociation(
    name="Property_Buyer",
    ends={
        Property(name="buyer8", type=Buyer, multiplicity=Multiplicity(1, 1)),
...
Reg_User_Requirement: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="reg_User11", type=Reg_User, multiplicity=Multiplicity(1, 9999))
    }
)
...
domain_model = DomainModel(
    name="_7ccb9c31_71ee_4885_9418_9a62a03678a7",
    types={Seller, Administrator, Payment, Requirement, Request, Management, Advertiesment, Property_, User, Reg_User, Unreg_User, Advertiser, Buyer},
