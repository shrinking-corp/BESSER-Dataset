...
# Classes
myDsl_Reponse = Class(name="myDsl_Reponse")
myDsl_Model = Class(name="myDsl_Model")
myDsl_Greeting = Class(name="myDsl_Greeting")
myDsl_ReponseT = Class(name="myDsl_ReponseT")
Reponse = Class(name="Reponse")
myDsl_ReponseF = Class(name="myDsl_ReponseF")
...
domain_model = DomainModel(
    name="myDsl",
    types={myDsl_Reponse, myDsl_Model, myDsl_Greeting, myDsl_ReponseT, Reponse, myDsl_ReponseF},
