...
def test_hyp_reponse_is_not_abstract():
    assert not inspect.isabstract(Reponse)


def test_hyp_reponse_constructor_exists():
    assert callable(Reponse.__init__)


def test_hyp_reponse_constructor_args():
    sig = inspect.signature(Reponse.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mydsl_reponsef_is_not_abstract():
    assert not inspect.isabstract(myDsl_ReponseF)


def test_hyp_mydsl_reponsef_constructor_exists():
    assert callable(myDsl_ReponseF.__init__)


def test_hyp_mydsl_reponsef_constructor_args():
    sig = inspect.signature(myDsl_ReponseF.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mydsl_reponset_is_not_abstract():
    assert not inspect.isabstract(myDsl_ReponseT)


def test_hyp_mydsl_reponset_constructor_exists():
    assert callable(myDsl_ReponseT.__init__)


def test_hyp_mydsl_reponset_constructor_args():
...
def test_hyp_mydsl_reponse_is_not_abstract():
    assert not inspect.isabstract(myDsl_Reponse)


def test_hyp_mydsl_reponse_constructor_exists():
    assert callable(myDsl_Reponse.__init__)


def test_hyp_mydsl_reponse_constructor_args():
...
def test_hyp_mydsl_greeting_question_setter(instance):
...
def test_hyp_mydsl_reponse_name_setter(instance):
