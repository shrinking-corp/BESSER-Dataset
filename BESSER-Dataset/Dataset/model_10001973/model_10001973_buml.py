...
RandomPlayer.attributes={RandomPlayer_score, RandomPlayer_name}
...
Piece.attributes={Piece_pieceSize, Piece_pieceColor}
...
GameboardGUI.attributes={GameboardGUI_rows, GameboardGUI_piecesList, GameboardGUI_columns}
...
Connect4GUI.attributes={Connect4GUI_undo, Connect4GUI_root}
...
GameBoard.attributes={GameBoard_player1, GameBoard_board, GameBoard_whoPlay, GameBoard_player2}
...
domain_model = DomainModel(
    ...
    associations={GameboardGUI_Piece, ScoreBoardGUI_Player, GameboardGUI_Connect4GUI, Player_GameBoard, Connect4_MainMenuGUI, MainMenuGUI_Connect4GUI, ScoreBoardGUI_MainMenuGUI, GameBoard_Connect4GUI},
    generalizations={},
    metadata=None
)
