...
Order.attributes={Order_shipped, Order_status, Order_ordered, Order_number, Order_shipTo, Order_total}
...
domain_model = DomainModel(
    name="_0z32QE3JEeqesv9gci_YTQ",
    types={Customer, Payment, ShoppingCart, Account, WebUser, Order, LineItem, Product, UserState, OrderStatus},
    associations={WebUser_ShoppingCart, WebUser_Customer, Customer_Account, Account_ShoppingCart, ShoppingCart_LineItem, Product_LineItem, Order_LineItem, Account_Order, Payment_Order, Account_Payment},
    generalizations={},
    metadata=None
)
