...
class statemachine_Command:
    ...
    def __init__(self, newValue: bool, statemachine_Command21: "statemachine_Signal" = None, statemachine_Command: "statemachine_State" = None):
...
class statemachine_Signal:
    ...
    def __init__(self, name: str, statemachine_Signal19: "statemachine_Event" = None, statemachine_Signal22: "statemachine_Command" = None, statemachine_Signal: "statemachine_Statemachine" = None):
        self.name = name
