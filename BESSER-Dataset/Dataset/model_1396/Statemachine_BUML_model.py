...
statemachine_InputSignal = Class(name="statemachine_InputSignal")
Signal = Class(name="Signal")
statemachine_OutputSignal = Class(name="statemachine_OutputSignal")
...
domain_model = DomainModel(
    name="statemachine",
    types={statemachine_Statemachine, statemachine_Signal, statemachine_Transition, statemachine_Condition, statemachine_Event, statemachine_State, statemachine_InputSignal, Signal, statemachine_OutputSignal, statemachine_Command},
    associations={signals0, transitions5, nestedStates8, condition10, state12, events15, signal17, signal20, states1, commands3},
