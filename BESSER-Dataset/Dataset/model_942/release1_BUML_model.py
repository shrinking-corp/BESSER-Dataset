...
model_UnicaseModelElement.attributes={model_UnicaseModelElement_state, model_UnicaseModelElement_name, model_UnicaseModelElement_description}
...
model_task_WorkItem.attributes={model_task_WorkItem_effort, model_task_WorkItem_priority, model_task_WorkItem_resolved, model_task_WorkItem_estimate, model_task_WorkItem_dueDate}
...
model_classes_Association.attributes={model_classes_Association_sourceMultiplicity, model_classes_Association_sourceRole, model_classes_Association_targetRole, model_classes_Association_targetMultiplicity, model_classes_Association_type}
...
model_classes_Attribute.attributes={model_classes_Attribute_signature, model_classes_Attribute_type, model_classes_Attribute_label, model_classes_Attribute_scope, model_classes_Attribute_defaultValue, model_classes_Attribute_visibility, model_classes_Attribute_properties}
...
model_classes_Method.attributes={model_classes_Method_stubbed, model_classes_Method_visibility, model_classes_Method_properties, model_classes_Method_returnType, model_classes_Method_signature, model_classes_Method_scope, model_classes_Method_label}
...
model_classes_MethodArgument.attributes={model_classes_MethodArgument_label, model_classes_MethodArgument_type, model_classes_MethodArgument_signature, model_classes_MethodArgument_direction, model_classes_MethodArgument_defaultValue}
...
model_requirement_FunctionalRequirement.attributes={model_requirement_FunctionalRequirement_cost, model_requirement_FunctionalRequirement_reviewed, model_requirement_FunctionalRequirement_priority, model_requirement_FunctionalRequirement_storyPoints}
...
model_requirement_UseCase.attributes={model_requirement_UseCase_rules, model_requirement_UseCase_precondition, model_requirement_UseCase_postcondition, model_requirement_UseCase_exception}
...
model_requirement_SystemFunction.attributes={model_requirement_SystemFunction_exception, model_requirement_SystemFunction_output, model_requirement_SystemFunction_input}
...
model_bug_BugReport.attributes={model_bug_BugReport_resolution, model_bug_BugReport_resolutionType, model_bug_BugReport_severity, model_bug_BugReport_Status}
...
model_attachment_FileAttachment.attributes={model_attachment_FileAttachment_fileSize, model_attachment_FileAttachment_fileHash, model_attachment_FileAttachment_requiredOffline, model_attachment_FileAttachment_fileID, model_attachment_FileAttachment_fileName}
...
esmodel_versioning_LogMessage.attributes={esmodel_versioning_LogMessage_author, esmodel_versioning_LogMessage_message, esmodel_versioning_LogMessage_clientDate, esmodel_versioning_LogMessage_date}
...
esmodel_operations_AbstractOperation.attributes={esmodel_operations_AbstractOperation_accepted, esmodel_operations_AbstractOperation_name, esmodel_operations_AbstractOperation_clientDate, esmodel_operations_AbstractOperation_description}
...
esmodel_events_ExceptionEvent.attributes={esmodel_events_ExceptionEvent_ExceptionCauseStackTrace, esmodel_events_ExceptionEvent_ExceptionTitle, esmodel_events_ExceptionEvent_ExceptionStackTrace, esmodel_events_ExceptionEvent_ExceptionCauseTitle}
...
esmodel_roles_Role_m_canDelete: Method = Method(name="canDelete", parameters={Parameter(name='esmodel_modelElement', type=StringType), Parameter(name='esmodel_projectId', type=StringType)}, type=BooleanType)
...
esmodel_roles_Role_m_canRead: Method = Method(name="canRead", parameters={Parameter(name='esmodel_projectId', type=StringType), Parameter(name='esmodel_modelElement', type=StringType)}, type=BooleanType)
esmodel_roles_Role.methods={esmodel_roles_Role_m_canDelete, esmodel_roles_Role_m_canModify, esmodel_roles_Role_m_canRead, esmodel_roles_Role_m_canCreate, esmodel_roles_Role_m_canAdministrate}
...
esmodel_notification_ESNotification.attributes={esmodel_notification_ESNotification_creationDate, esmodel_notification_ESNotification_message, esmodel_notification_ESNotification_sender, esmodel_notification_ESNotification_provider, esmodel_notification_ESNotification_recipient, esmodel_notification_ESNotification_details, esmodel_notification_ESNotification_name, esmodel_notification_ESNotification_seen}
...
domain_model = DomainModel(
    name="esmodel",
    types={metamodel_Project, ModelElement, metamodel_IdentifiableElement, metamodel_ModelElement, IdentifiableElement, metamodel_ModelElementId, UniqueIdentifier, metamodel_ModelVersion, metamodel_NonDomainElement, metamodel_AssociationClassElement, model_UnicaseModelElement, Annotation, Attachment, document_LeafSection, rationale_Comment, metamodel_UniqueIdentifier, model_Attachment, model_NonDomainElement, model_Project, Project, model_organization_OrgUnit, organization_Group, task_WorkItem, model_organization_User, OrgUnit, profile_StereotypeInstance, task_WorkPackage, model_Annotation, UnicaseModelElement, organization_User, model_organization_Group, organization_OrgUnit, model_task_WorkItem, change_ModelChangePackage, model_task_WorkPackage, WorkItem, model_task_Milestone, model_task_Checkable, model_task_ActionItem, task_Checkable, diagram_model_Diagram, model_classes_PackageElement, classes_Package, classes_Dependency, model_classes_Class, PackageElement, classes_Class, model_diagram_MEDiagram, classes_Attribute, classes_Method, requirement_UseCase, requirement_Scenario, model_classes_Package, classes_Association, model_classes_Association, model_classes_Attribute, classes_PackageElement, model_classes_Method, classes_MethodArgument, model_classes_MethodArgument, model_document_Section, document_CompositeSection, model_document_LeafSection, Section, model_classes_Dependency, requirement_FunctionalRequirement, model_document_CompositeSection, document_Section, model_requirement_FunctionalRequirement, model_requirement_UseCase, requirement_Actor, requirement_Step, requirement_UserTask, requirement_NonFunctionalRequirement, model_requirement_Scenario, requirement_ActorInstance, model_requirement_Actor, model_requirement_ActorInstance, model_requirement_Step, NonDomainElement, requirement_SystemFunction, model_requirement_SystemFunction, model_requirement_NonFunctionalRequirement, Criterion, model_rationale_Issue, rationale_Proposal, rationale_Solution, model_requirement_UserTask, rationale_Assessment, model_rationale_Solution, model_rationale_Criterion, model_rationale_Assessment, rationale_Criterion, model_rationale_Proposal, rationale_Issue, model_change_ModelChangePackage, model_change_MergingIssue, Issue, model_change_MergingProposal, Proposal, change_MergingProposal, model_change_MergingSolution, Solution, model_bug_BugReport, model_rationale_Comment, model_component_Component, component_ComponentService, model_component_DeploymentNode, model_meeting_Meeting, model_component_ComponentService, component_Component, meeting_MeetingSection, meeting_IssueMeetingSection, meeting_WorkItemMeetingSection, model_meeting_MeetingSection, model_meeting_CompositeMeetingSection, MeetingSection, model_state_Transition, state_StateNode, model_state_StateNode, state_Transition, model_state_State, StateNode, model_state_StateInitial, model_state_StateEnd, model_meeting_IssueMeetingSection, model_meeting_WorkItemMeetingSection, model_profile_Profile, profile_Stereotype, model_profile_Stereotype, profile_Profile, model_attachment_UrlAttachment, model_attachment_FileAttachment, profile_StereotypeAttribute, model_profile_StereotypeInstance, model_activity_ActivityObject, activity_Transition, profile_StereotypeAttributeInstance, model_profile_StereotypeAttribute, model_profile_StereotypeAttributeSimple, StereotypeAttribute, model_profile_StereotypeAttributeInstance, model_profile_StereotypeAttributeInstanceString, StereotypeAttributeInstance, model_util_ModelElementPath, ModelElementId, esmodel_SessionId, esmodel_ServerSpace, accesscontrol_ACGroup, ProjectHistory, model_activity_Transition, SessionId, accesscontrol_ACUser, activity_ActivityObject, model_activity_Activity, ActivityObject, model_activity_Fork, model_activity_Branch, model_activity_ActivityInitial, model_activity_ActivityEnd, esmodel_ProjectHistory, ProjectId, versioning_Version, esmodel_ProjectInfo, versioning_PrimaryVersionSpec, esmodel_versioning_PrimaryVersionSpec, esmodel_ProjectId, esmodel_VersionInfo, esmodel_ClientVersionInfo, esmodel_versioning_VersionSpec, esmodel_versioning_LogMessage, esmodel_FileIdentifier, esmodel_versioning_TagVersionSpec, VersionSpec, esmodel_versioning_DateVersionSpec, versioning_VersionProperty, esmodel_versioning_HistoryInfo, versioning_TagVersionSpec, versioning_ChangePackage, esmodel_versioning_ChangePackage, operations_AbstractOperation, events_Event, versioning_LogMessage, notification_ESNotification, esmodel_versioning_HeadVersionSpec, esmodel_versioning_VersionProperty, esmodel_operations_AbstractOperation, esmodel_versioning_HistoryQuery, esmodel_versioning_Version, operations_ReferenceOperation, operations_EObjectToModelElementIdMap, esmodel_operations_AttributeOperation, FeatureOperation, esmodel_operations_MultiAttributeOperation, esmodel_operations_MultiAttributeSetOperation, esmodel_operations_CompositeOperation, AbstractOperation, esmodel_operations_FeatureOperation, esmodel_operations_CreateDeleteOperation, operations_esmodel_EObject, esmodel_operations_MultiReferenceOperation, esmodel_operations_MultiReferenceMoveOperation, esmodel_operations_ReferenceOperation, esmodel_operations_DiagramLayoutOperation, AttributeOperation, esmodel_operations_OperationId, esmodel_operations_OperationGroup, esmodel_operations_MultiAttributeMoveOperation, esmodel_operations_ModelElementGroup, esmodel_operations_SingleReferenceOperation, ReferenceOperation, esmodel_operations_MultiReferenceSetOperation, esmodel_events_ReadEvent, Event, esmodel_events_MergeEvent, esmodel_events_CheckoutEvent, esmodel_events_ExceptionEvent, esmodel_events_PluginStartEvent, esmodel_events_UpdateEvent, esmodel_operations_EObjectToModelElementIdMap, esmodel_semantic_SemanticCompositeOperation, CompositeOperation, esmodel_events_Event, esmodel_events_ShowHistoryEvent, esmodel_events_PerspectiveEvent, esmodel_events_DNDEvent, esmodel_events_LinkEvent, esmodel_events_AnnotationEvent, esmodel_events_RevertEvent, esmodel_events_NavigatorCreateEvent, esmodel_events_PluginFocusEvent, esmodel_events_PresentationSwitchEvent, esmodel_events_UndoEvent, esmodel_events_Validate, esmodel_events_ShowChangesEvent, esmodel_events_TraceEvent, esmodel_events_NotificationReadEvent, ReadEvent, esmodel_events_NotificationGenerationEvent, esmodel_events_NotificationIgnoreEvent, esmodel_events_URLEvent, esmodel_events_MergeChoiceEvent, operations_OperationId, esmodel_events_MergeGlobalChoiceEvent, esmodel_server_ServerEvent, esmodel_server_ServerProjectEvent, ServerEvent, esmodel_server_ProjectUpdatedEvent, ServerProjectEvent, esmodel_accesscontrol_ACOrgUnit, roles_Role, accesscontrol_OrgUnitProperty, esmodel_accesscontrol_ACGroup, accesscontrol_ACOrgUnit, esmodel_accesscontrol_ACOrgUnitId, esmodel_accesscontrol_OrgUnitProperty, esmodel_roles_Role, esmodel_accesscontrol_ACUser, ACOrgUnit, esmodel_roles_ReaderRole, Role, esmodel_roles_WriterRole, esmodel_roles_ProjectAdminRole, esmodel_roles_ServerAdmin, esmodel_notification_ESNotification, esmodel_url_ServerUrl, esmodel_url_ProjectUrlFragment, esmodel_url_ModelElementUrl, url_ServerUrl, url_ProjectUrlFragment, url_ModelElementUrlFragment, esmodel_url_ModelElementUrlFragment, ActivityType, DiagramType, AssociationType, VisibilityType, ScopeType, ArgumentDirectionType, BugStatus, Severity, ResolutionType, ContainmentType, MergeChoiceSelection, MergeGlobalChoiceSelection},
    associations={modelElements0, annotations4, attachments5, leafSection6, incomingDocumentReferences7, comments9, cutElements1, annotatedModelElements11, referringModelElements12, groupMemberships14, participations15, assignments16, workItemsToReview18, appliedStereotypeInstances10, containingWorkpackage21, successors22, predecessors24, assignee26, reviewer28, participants29, orgUnits20, associatedChangePackages31, containedWorkItems32, containedModelElements34, elements36, gmfdiagram38, newElements40, parentPackage43, outgoingDependencies44, incomingDependencies45, incomingAssociations52, attributes55, methods56, participatedUseCases58, demoParticipations59, subClasses47, superClasses48, outgoingAssociations50, source62, target64, definingClass66, facadeClass60, containedPackageElements61, definingClass68, calledMethods70, callingMethods72, arguments74, demoParticipations75, source77, target79, parent81, modelElements82, referencedModelElements84, refiningRequirements87, refinedRequirement88, stakeholder90, useCases91, subsections86, functionalRequirements96, identifiedClasses98, scenarios93, extendedUseCases101, scenarios104, initiatingActor106, participatingActors107, includedUseCases100, useCaseSteps110, realizedUserTask111, nonFunctionalRequirements112, instantiatedUseCases113, functionalRequirements115, participatingMethods118, participatingClasses120, initiatingActorInstance123, nonFunctionalRequirements127, initiatedUseCases129, participatingActorInstances124, steps126, participatedUserTasks135, initiatedUserTask137, initiatedScenarios140, participatedScenarios142, instantiatedActor144, includedUseCase146, useCase148, includedSystemFunction150, participatedUseCases131, instances133, participatingActor154, realizingUseCases156, restrictedUseCases158, restrictedScenarios160, proposals163, solution164, issue167, initiatingActor152, assessments168, underlyingProposals169, issue170, assessments172, proposal174, criterion176, criteria166, recipients180, commentedElement183, conflictingProposals185, pendingChanges186, appliedChanges189, sender178, packages191, subsystems192, offeredServices195, consumedServices196, offeringComponent198, consumingComponents199, components201, facilitator202, minutetaker203, timekeeper206, participants209, identifiedIssuesSection214, identifiedWorkItemsSection216, subsections218, sections212, includedWorkItems221, source222, target223, outgoingTransitions225, incomingTransitions227, includedIssues220, stereotype238, modelElement240, affectedContainers230, stereotypes232, profile233, stereotypeInstances234, stereotypeAttributes236, outgoingTransitions259, incomingTransitions262, stereotypeAttributeInstances242, stereotype243, stereotypeAttributeInstances245, stereotypeInstance247, stereotypeAttribute249, source252, target253, path256, groups277, projects278, openSessions280, users282, source265, target267, projectId270, versions271, projectId273, version275, notifications289, versionProperties291, primerySpec293, logMessage295, tagSpecs298, versionProperties300, changePackage303, operations284, events285, logMessage287, previousVersion321, changes323, logMessage326, source305, target307, modelElements310, projectState313, primarySpec314, tagSpecs317, nextVersion320, modelElement336, subOperations337, eObjectToIdMap339, modelElementId329, subOperations331, mainOperation333, newValue348, referencedModelElements351, referencedModelElementId353, operations355, modelElements357, oldValue341, newValue343, oldValue346, modelElement364, baseVersion366, targetVersion368, localChanges371, baseVersion374, baseVersion376, key359, value361, sourceVersion386, targetVersion388, modelElement391, dragSourceElement394, dropTargetElement396, sourceElement399, targetVersion378, annotatedElement381, annotation383, sourceElement404, targetElement406, createdElement409, sourceSection411, operation414, targetElement401, targetVersion418, notifications421, sourceModelElement423, sourceURL425, myAcceptedChanges428, theirRejectedChanges429, contextModelElement432, sourceVersion416, projectId435, roles439, properties440, members442, project443, newVersion437, projects445, project447, relatedModelElements449, relatedOperations452, serverUrl459, projectUrlFragment460, modelElementUrlFragment462, projectId455, modelElementId457},
    generalizations={gen_metamodel_ModelElement_IdentifiableElement, gen_metamodel_ModelElementId_UniqueIdentifier, gen_model_UnicaseModelElement_ModelElement, gen_model_Attachment_UnicaseModelElement, gen_model_Project_Project, gen_model_organization_OrgUnit_UnicaseModelElement, gen_model_organization_User_OrgUnit, gen_model_Annotation_UnicaseModelElement, gen_model_organization_Group_OrgUnit, gen_model_task_WorkItem_Annotation, gen_model_task_WorkPackage_WorkItem, gen_model_task_Milestone_WorkItem, gen_model_task_Checkable_UnicaseModelElement, gen_model_task_ActionItem_task_WorkItem, gen_model_task_ActionItem_task_Checkable, gen_model_classes_PackageElement_UnicaseModelElement, gen_model_classes_Class_PackageElement, gen_model_diagram_MEDiagram_Attachment, gen_model_classes_Package_PackageElement, gen_model_classes_Association_UnicaseModelElement, gen_model_classes_Attribute_UnicaseModelElement, gen_model_classes_Method_UnicaseModelElement, gen_model_classes_MethodArgument_UnicaseModelElement, gen_model_document_Section_UnicaseModelElement, gen_model_document_LeafSection_Section, gen_model_classes_Dependency_UnicaseModelElement, gen_model_document_CompositeSection_Section, gen_model_requirement_FunctionalRequirement_UnicaseModelElement, gen_model_requirement_UseCase_UnicaseModelElement, gen_model_requirement_Scenario_UnicaseModelElement, gen_model_requirement_Actor_UnicaseModelElement, gen_model_requirement_ActorInstance_UnicaseModelElement, gen_model_requirement_Step_UnicaseModelElement, gen_model_requirement_Step_NonDomainElement, gen_model_requirement_SystemFunction_UnicaseModelElement, gen_model_requirement_SystemFunction_NonDomainElement, gen_model_requirement_NonFunctionalRequirement_Criterion, gen_model_rationale_Issue_Annotation, gen_model_rationale_Issue_task_Checkable, gen_model_rationale_Issue_task_WorkItem, gen_model_requirement_UserTask_UnicaseModelElement, gen_model_requirement_UserTask_NonDomainElement, gen_model_rationale_Solution_UnicaseModelElement, gen_model_rationale_Solution_NonDomainElement, gen_model_rationale_Criterion_UnicaseModelElement, gen_model_rationale_Assessment_UnicaseModelElement, gen_model_rationale_Assessment_NonDomainElement, gen_model_rationale_Proposal_UnicaseModelElement, gen_model_rationale_Proposal_NonDomainElement, gen_model_change_ModelChangePackage_UnicaseModelElement, gen_model_change_MergingIssue_Issue, gen_model_change_MergingProposal_Proposal, gen_model_change_MergingSolution_Solution, gen_model_bug_BugReport_task_WorkItem, gen_model_bug_BugReport_task_Checkable, gen_model_rationale_Comment_UnicaseModelElement, gen_model_rationale_Comment_NonDomainElement, gen_model_component_Component_UnicaseModelElement, gen_model_component_DeploymentNode_UnicaseModelElement, gen_model_meeting_Meeting_UnicaseModelElement, gen_model_component_ComponentService_UnicaseModelElement, gen_model_meeting_MeetingSection_UnicaseModelElement, gen_model_meeting_CompositeMeetingSection_MeetingSection, gen_model_state_Transition_UnicaseModelElement, gen_model_state_StateNode_UnicaseModelElement, gen_model_state_State_StateNode, gen_model_state_StateInitial_StateNode, gen_model_state_StateEnd_StateNode, gen_model_meeting_IssueMeetingSection_MeetingSection, gen_model_meeting_WorkItemMeetingSection_MeetingSection, gen_model_profile_Profile_UnicaseModelElement, gen_model_profile_Stereotype_UnicaseModelElement, gen_model_attachment_UrlAttachment_Attachment, gen_model_attachment_FileAttachment_Attachment, gen_model_profile_StereotypeInstance_UnicaseModelElement, gen_model_activity_ActivityObject_UnicaseModelElement, gen_model_profile_StereotypeAttribute_UnicaseModelElement, gen_model_profile_StereotypeAttributeSimple_StereotypeAttribute, gen_model_profile_StereotypeAttributeInstance_UnicaseModelElement, gen_model_profile_StereotypeAttributeInstanceString_StereotypeAttributeInstance, gen_esmodel_SessionId_UniqueIdentifier, gen_model_activity_Transition_UnicaseModelElement, gen_model_activity_Activity_ActivityObject, gen_model_activity_Fork_ActivityObject, gen_model_activity_Branch_ActivityObject, gen_model_activity_ActivityInitial_ActivityObject, gen_model_activity_ActivityEnd_ActivityObject, gen_esmodel_versioning_PrimaryVersionSpec_VersionSpec, gen_esmodel_ProjectId_UniqueIdentifier, gen_esmodel_FileIdentifier_IdentifiableElement, gen_esmodel_versioning_TagVersionSpec_VersionSpec, gen_esmodel_versioning_DateVersionSpec_VersionSpec, gen_esmodel_versioning_HeadVersionSpec_VersionSpec, gen_esmodel_operations_AbstractOperation_IdentifiableElement, gen_esmodel_operations_AttributeOperation_FeatureOperation, gen_esmodel_operations_MultiAttributeOperation_FeatureOperation, gen_esmodel_operations_MultiAttributeSetOperation_FeatureOperation, gen_esmodel_operations_CompositeOperation_AbstractOperation, gen_esmodel_operations_FeatureOperation_AbstractOperation, gen_esmodel_operations_CreateDeleteOperation_AbstractOperation, gen_esmodel_operations_MultiReferenceOperation_ReferenceOperation, gen_esmodel_operations_MultiReferenceMoveOperation_FeatureOperation, gen_esmodel_operations_ReferenceOperation_FeatureOperation, gen_esmodel_operations_DiagramLayoutOperation_AttributeOperation, gen_esmodel_operations_OperationId_UniqueIdentifier, gen_esmodel_operations_MultiAttributeMoveOperation_FeatureOperation, gen_esmodel_operations_SingleReferenceOperation_ReferenceOperation, gen_esmodel_operations_MultiReferenceSetOperation_ReferenceOperation, gen_esmodel_events_ReadEvent_Event, gen_esmodel_events_MergeEvent_Event, gen_esmodel_events_CheckoutEvent_Event, gen_esmodel_events_ExceptionEvent_Event, gen_esmodel_events_PluginStartEvent_Event, gen_esmodel_events_UpdateEvent_Event, gen_esmodel_semantic_SemanticCompositeOperation_CompositeOperation, gen_esmodel_events_ShowHistoryEvent_Event, gen_esmodel_events_PerspectiveEvent_Event, gen_esmodel_events_DNDEvent_Event, gen_esmodel_events_LinkEvent_Event, gen_esmodel_events_AnnotationEvent_Event, gen_esmodel_events_RevertEvent_Event, gen_esmodel_events_NavigatorCreateEvent_Event, gen_esmodel_events_PluginFocusEvent_Event, gen_esmodel_events_PresentationSwitchEvent_Event, gen_esmodel_events_UndoEvent_Event, gen_esmodel_events_Validate_Event, gen_esmodel_events_ShowChangesEvent_Event, gen_esmodel_events_TraceEvent_Event, gen_esmodel_events_NotificationReadEvent_ReadEvent, gen_esmodel_events_NotificationGenerationEvent_Event, gen_esmodel_events_NotificationIgnoreEvent_Event, gen_esmodel_events_URLEvent_Event, gen_esmodel_events_MergeChoiceEvent_Event, gen_esmodel_events_MergeGlobalChoiceEvent_Event, gen_esmodel_server_ServerEvent_Event, gen_esmodel_server_ServerProjectEvent_ServerEvent, gen_esmodel_server_ProjectUpdatedEvent_ServerProjectEvent, gen_esmodel_accesscontrol_ACOrgUnit_IdentifiableElement, gen_esmodel_accesscontrol_ACGroup_ACOrgUnit, gen_esmodel_accesscontrol_ACOrgUnitId_UniqueIdentifier, gen_esmodel_accesscontrol_ACUser_ACOrgUnit, gen_esmodel_roles_ReaderRole_Role, gen_esmodel_roles_WriterRole_Role, gen_esmodel_roles_ProjectAdminRole_Role, gen_esmodel_roles_ServerAdmin_Role, gen_esmodel_notification_ESNotification_IdentifiableElement},
    metadata=None
)
