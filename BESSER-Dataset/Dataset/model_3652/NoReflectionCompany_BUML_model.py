...
noreflectioncompany_Employee_m_noManagerImpliesDirectReports: Method = Method(name="noManagerImpliesDirectReports", parameters={Parameter(name='noreflectioncompany_diagnostics', type=StringType), Parameter(name='noreflectioncompany_context', type=StringType)}, type=BooleanType)
...
noreflectioncompany_Employee.methods={noreflectioncompany_Employee_m_noManagerImpliesDirectReports, noreflectioncompany_Employee_m_hasNameAsOperation, noreflectioncompany_Employee_m_reportsTo}
...
noreflectioncompany_Company_m_dummyInvariant: Method = Method(name="dummyInvariant", parameters={Parameter(name='noreflectioncompany_context', type=StringType), Parameter(name='noreflectioncompany_diagnostics', type=StringType)}, type=BooleanType)
