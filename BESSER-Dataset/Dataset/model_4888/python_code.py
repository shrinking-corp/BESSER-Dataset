...
class p2_IRepository(ABC):
    ...
    def setProperty(self, p2_value, p2_monitor, p2_key) :
...
class p2_IUpdateDescriptor(ABC):
    ...
    def __init__(self, location: str, description: str, severity: int, p2_IUpdateDescriptor: "p2_IInstallableUnit" = None):
        self.location = location
        self.description = description
...
class p2_IInstallableUnit(ABC):
    ...
    def getProperty(self, p2_locale, p2_key) :
        # TODO: Implement getProperty method
        pass
...
class p2_IRequirement(ABC):
    ...
    def __init__(self, max: str, min: str, matches: str, greedy: bool, description: str, filter: str, p2_IRequirement: "p2_IInstallableUnit" = None, p2_IRequirement25: "p2_IInstallableUnit" = None, p2_IRequirement38: "p2_IInstallableUnitPatch" = None, p2_IRequirement42: "p2_InstallableUnitFragment" = None, p2_IRequirement35: "p2_IInstallableUnitPatch" = None):
        self.max = max
        self.min = min
...
class p2_IArtifactRepository(ABC):
    ...
    def getRawArtifact(self, p2_monitor, p2_descriptor, p2_destination) :
    ...
    def getArtifact(self, p2_monitor, p2_descriptor, p2_destination) :
