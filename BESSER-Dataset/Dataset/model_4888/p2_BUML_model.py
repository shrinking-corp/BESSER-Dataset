...
# Classes
p2_ArtifactKey = Class(name="p2_ArtifactKey")
IArtifactKey = Class(name="IArtifactKey")
p2_ArtifactRepository = Class(name="p2_ArtifactRepository")
p2_ArtifactsByKey = Class(name="p2_ArtifactsByKey")
p2_IArtifactKey = Class(name="p2_IArtifactKey", is_abstract=True)
p2_IArtifactDescriptor = Class(name="p2_IArtifactDescriptor", is_abstract=True)
p2_ArtifactDescriptor = Class(name="p2_ArtifactDescriptor")
IArtifactDescriptor = Class(name="IArtifactDescriptor")
p2_Property = Class(name="p2_Property")
p2_IProcessingStepDescriptor = Class(name="p2_IProcessingStepDescriptor", is_abstract=True)
p2_IArtifactRepository = Class(name="p2_IArtifactRepository", is_abstract=True)
p2_Comparable = Class(name="p2_Comparable", is_abstract=True)
p2_Copyright = Class(name="p2_Copyright")
ICopyright = Class(name="ICopyright")
p2_IAdaptable = Class(name="p2_IAdaptable", is_abstract=True)
p2_ICopyright = Class(name="p2_ICopyright", is_abstract=True)
p2_IInstallableUnitFragment = Class(name="p2_IInstallableUnitFragment", is_abstract=True)
p2_ILicense = Class(name="p2_ILicense", is_abstract=True)
p2_IRequirement = Class(name="p2_IRequirement", is_abstract=True)
p2_IProvidedCapability = Class(name="p2_IProvidedCapability", is_abstract=True)
p2_ITouchpointData = Class(name="p2_ITouchpointData", is_abstract=True)
p2_ITouchpointType = Class(name="p2_ITouchpointType", is_abstract=True)
p2_IFileArtifactRepository = Class(name="p2_IFileArtifactRepository", is_abstract=True)
IArtifactRepository = Class(name="IArtifactRepository")
p2_IInstallableUnit = Class(name="p2_IInstallableUnit", is_abstract=True)
p2_InstallableUnit = Class(name="p2_InstallableUnit")
p2_InstallableUnitFragment = Class(name="p2_InstallableUnitFragment")
InstallableUnit = Class(name="InstallableUnit")
IInstallableUnitFragment = Class(name="IInstallableUnitFragment")
p2_InstallableUnitPatch = Class(name="p2_InstallableUnitPatch")
IInstallableUnitPatch = Class(name="IInstallableUnitPatch")
p2_InstructionMap = Class(name="p2_InstructionMap")
p2_ITouchpointInstruction = Class(name="p2_ITouchpointInstruction", is_abstract=True)
p2_IMetadataRepository = Class(name="p2_IMetadataRepository", is_abstract=True)
p2_IUpdateDescriptor = Class(name="p2_IUpdateDescriptor", is_abstract=True)
IInstallableUnit = Class(name="IInstallableUnit")
p2_IInstallableUnitPatch = Class(name="p2_IInstallableUnitPatch", is_abstract=True)
p2_IRequirementChange = Class(name="p2_IRequirementChange", is_abstract=True)
p2_IQueryable = Class(name="p2_IQueryable", is_abstract=True)
p2_IRepository = Class(name="p2_IRepository", is_abstract=True)
p2_IRequiredCapability = Class(name="p2_IRequiredCapability", is_abstract=True)
IRequirement = Class(name="IRequirement")
p2_IRepositoryReference = Class(name="p2_IRepositoryReference", is_abstract=True)
p2_License = Class(name="p2_License")
ILicense = Class(name="ILicense")
p2_MappingRule = Class(name="p2_MappingRule")
p2_MetadataRepository = Class(name="p2_MetadataRepository")
p2_ProcessingStepDescriptor = Class(name="p2_ProcessingStepDescriptor")
IProcessingStepDescriptor = Class(name="IProcessingStepDescriptor")
p2_ProvidedCapability = Class(name="p2_ProvidedCapability")
IProvidedCapability = Class(name="IProvidedCapability")
p2_Repository = Class(name="p2_Repository", is_abstract=True)
p2_RepositoryReference = Class(name="p2_RepositoryReference")
IRepositoryReference = Class(name="IRepositoryReference")
p2_RequiredCapability = Class(name="p2_RequiredCapability")
Requirement = Class(name="Requirement")
IRequiredCapability = Class(name="IRequiredCapability")
p2_Requirement = Class(name="p2_Requirement")
p2_RequirementChange = Class(name="p2_RequirementChange")
IRequirementChange = Class(name="IRequirementChange")
p2_IVersionedId = Class(name="p2_IVersionedId", is_abstract=True)
p2_TouchpointData = Class(name="p2_TouchpointData")
ITouchpointData = Class(name="ITouchpointData")
p2_TouchpointInstruction = Class(name="p2_TouchpointInstruction")
ITouchpointInstruction = Class(name="ITouchpointInstruction")
p2_TouchpointType = Class(name="p2_TouchpointType")
ITouchpointType = Class(name="ITouchpointType")
p2_UpdateDescriptor = Class(name="p2_UpdateDescriptor")
IUpdateDescriptor = Class(name="IUpdateDescriptor")
p2_SimpleArtifactRepository = Class(name="p2_SimpleArtifactRepository")
ArtifactRepository = Class(name="ArtifactRepository")
IFileArtifactRepository = Class(name="IFileArtifactRepository")
p2_SimpleArtifactDescriptor = Class(name="p2_SimpleArtifactDescriptor")
...
p2_IArtifactKey.attributes={p2_IArtifactKey_version, p2_IArtifactKey_id, p2_IArtifactKey_classifier}
...
p2_IArtifactDescriptor_m_getProperty: Method = Method(name="getProperty", parameters={Parameter(name='p2_key', type=StringType)}, type=StringType)
...
p2_IArtifactDescriptor.methods={p2_IArtifactDescriptor_m_getProperty, p2_IArtifactDescriptor_m_getProcessingSteps, p2_IArtifactDescriptor_m_getRepository, p2_IArtifactDescriptor_m_getProperties}
...
p2_IProcessingStepDescriptor.attributes={p2_IProcessingStepDescriptor_required, p2_IProcessingStepDescriptor_processorId, p2_IProcessingStepDescriptor_data}

# p2_IArtifactRepository class attributes and methods
p2_IArtifactRepository_m_createArtifactDescriptor: Method = Method(name="createArtifactDescriptor", parameters={Parameter(name='p2_key', type=StringType)}, type=IArtifactDescriptor)
p2_IArtifactRepository_m_createArtifactKey: Method = Method(name="createArtifactKey", parameters={Parameter(name='p2_classifier', type=StringType), Parameter(name='p2_version', type=StringType), Parameter(name='p2_id', type=StringType)}, type=IArtifactKey)
p2_IArtifactRepository_m_addDescriptor: Method = Method(name="addDescriptor", parameters={Parameter(name='p2_descriptor', type=StringType)})
p2_IArtifactRepository_m_addDescriptor: Method = Method(name="addDescriptor", parameters={Parameter(name='p2_descriptor', type=StringType), Parameter(name='p2_monitor', type=StringType)})
p2_IArtifactRepository_m_addDescriptors: Method = Method(name="addDescriptors", parameters={Parameter(name='p2_descriptors', type=StringType)})
p2_IArtifactRepository_m_addDescriptors: Method = Method(name="addDescriptors", parameters={Parameter(name='p2_descriptors', type=StringType), Parameter(name='p2_monitor', type=StringType)})
p2_IArtifactRepository_m_getArtifacts: Method = Method(name="getArtifacts", parameters={Parameter(name='p2_monitor', type=StringType), Parameter(name='p2_requests', type=StringType)}, type=StringType)
p2_IArtifactRepository_m_getOutputStream: Method = Method(name="getOutputStream", parameters={Parameter(name='p2_descriptor', type=StringType)}, type=StringType)
...
p2_IArtifactRepository_m_removeAll: Method = Method(name="removeAll", parameters={Parameter(name='p2_monitor', type=StringType)})
p2_IArtifactRepository_m_removeDescriptor: Method = Method(name="removeDescriptor", parameters={Parameter(name='p2_descriptor', type=StringType)})
p2_IArtifactRepository_m_removeDescriptor: Method = Method(name="removeDescriptor", parameters={Parameter(name='p2_monitor', type=StringType), Parameter(name='p2_descriptor', type=StringType)})
p2_IArtifactRepository_m_removeDescriptor: Method = Method(name="removeDescriptor", parameters={Parameter(name='p2_key', type=StringType)})
p2_IArtifactRepository_m_removeDescriptor: Method = Method(name="removeDescriptor", parameters={Parameter(name='p2_key', type=StringType), Parameter(name='p2_monitor', type=StringType)})
p2_IArtifactRepository_m_removeDescriptors: Method = Method(name="removeDescriptors", parameters={Parameter(name='p2_descriptors', type=StringType)})
p2_IArtifactRepository_m_removeDescriptors: Method = Method(name="removeDescriptors", parameters={Parameter(name='p2_monitor', type=StringType), Parameter(name='p2_descriptors', type=StringType)})
p2_IArtifactRepository_m_removeDescriptors: Method = Method(name="removeDescriptors", parameters={Parameter(name='p2_keys', type=StringType)})
p2_IArtifactRepository_m_removeDescriptors: Method = Method(name="removeDescriptors", parameters={Parameter(name='p2_monitor', type=StringType), Parameter(name='p2_keys', type=StringType)})
p2_IArtifactRepository_m_executeBatch: Method = Method(name="executeBatch", parameters={Parameter(name='p2_runnable', type=StringType), Parameter(name='p2_monitor', type=StringType)}, type=StringType)
p2_IArtifactRepository_m_contains: Method = Method(name="contains", parameters={Parameter(name='p2_descriptor', type=StringType)}, type=BooleanType)
p2_IArtifactRepository_m_contains: Method = Method(name="contains", parameters={Parameter(name='p2_key', type=StringType)}, type=BooleanType)
p2_IArtifactRepository_m_getArtifact: Method = Method(name="getArtifact", parameters={Parameter(name='p2_destination', type=StringType), Parameter(name='p2_descriptor', type=StringType), Parameter(name='p2_monitor', type=StringType)}, type=StringType)
p2_IArtifactRepository_m_getRawArtifact: Method = Method(name="getRawArtifact", parameters={Parameter(name='p2_destination', type=StringType), Parameter(name='p2_descriptor', type=StringType), Parameter(name='p2_monitor', type=StringType)}, type=StringType)
p2_IArtifactRepository_m_getArtifactDescriptors: Method = Method(name="getArtifactDescriptors", parameters={Parameter(name='p2_key', type=StringType)}, type=StringType)
p2_IArtifactRepository.methods={p2_IArtifactRepository_m_removeDescriptor, p2_IArtifactRepository_m_contains, p2_IArtifactRepository_m_addDescriptors, p2_IArtifactRepository_m_removeDescriptor, p2_IArtifactRepository_m_contains, p2_IArtifactRepository_m_getArtifact, p2_IArtifactRepository_m_getArtifactDescriptors, p2_IArtifactRepository_m_removeDescriptors, p2_IArtifactRepository_m_removeDescriptors, p2_IArtifactRepository_m_getRawArtifact, p2_IArtifactRepository_m_createArtifactKey, p2_IArtifactRepository_m_removeAll, p2_IArtifactRepository_m_addDescriptors, p2_IArtifactRepository_m_removeDescriptor, p2_IArtifactRepository_m_removeDescriptors, p2_IArtifactRepository_m_removeDescriptor, p2_IArtifactRepository_m_getOutputStream, p2_IArtifactRepository_m_getArtifacts, p2_IArtifactRepository_m_createArtifactDescriptor, p2_IArtifactRepository_m_executeBatch, p2_IArtifactRepository_m_removeDescriptors, p2_IArtifactRepository_m_addDescriptor, p2_IArtifactRepository_m_descriptorQueryable, p2_IArtifactRepository_m_removeAll, p2_IArtifactRepository_m_addDescriptor}

# p2_Comparable class attributes and methods
p2_Comparable_m_compareTo: Method = Method(name="compareTo", parameters={Parameter(name='p2_o', type=StringType)}, type=IntegerType)
...
p2_IAdaptable_m_getAdapter: Method = Method(name="getAdapter", parameters={Parameter(name='p2_adapter', type=StringType)}, type=StringType)
...
p2_ILicense.attributes={p2_ILicense_body, p2_ILicense_UUID, p2_ILicense_location}
...
p2_IRequirement_m_isMatch: Method = Method(name="isMatch", parameters={Parameter(name='p2_installableUnit', type=StringType)}, type=BooleanType)
p2_IRequirement.attributes={p2_IRequirement_description, p2_IRequirement_greedy, p2_IRequirement_min, p2_IRequirement_max, p2_IRequirement_matches, p2_IRequirement_filter}
...
p2_IProvidedCapability.attributes={p2_IProvidedCapability_version, p2_IProvidedCapability_name, p2_IProvidedCapability_namespace}
...
p2_ITouchpointData_m_getInstruction: Method = Method(name="getInstruction", parameters={Parameter(name='p2_key', type=StringType)}, type=StringType)
...
p2_IFileArtifactRepository_m_getArtifactFile: Method = Method(name="getArtifactFile", parameters={Parameter(name='p2_key', type=StringType)}, type=StringType)
p2_IFileArtifactRepository_m_getArtifactFile: Method = Method(name="getArtifactFile", parameters={Parameter(name='p2_descriptor', type=StringType)}, type=StringType)
...
p2_IInstallableUnit_m_getProperty: Method = Method(name="getProperty", parameters={Parameter(name='p2_key', type=StringType)}, type=StringType)
p2_IInstallableUnit_m_getProperty: Method = Method(name="getProperty", parameters={Parameter(name='p2_key', type=StringType), Parameter(name='p2_locale', type=StringType)}, type=StringType)
p2_IInstallableUnit_m_satisfies: Method = Method(name="satisfies", parameters={Parameter(name='p2_candidate', type=StringType)}, type=BooleanType)
p2_IInstallableUnit_m_unresolved: Method = Method(name="unresolved", parameters={}, type=StringType)
p2_IInstallableUnit_m_getCopyright: Method = Method(name="getCopyright", parameters={Parameter(name='p2_locale', type=StringType)}, type=ICopyright)
p2_IInstallableUnit_m_getLicenses: Method = Method(name="getLicenses", parameters={Parameter(name='p2_locale', type=StringType)}, type=StringType)
...
p2_IInstallableUnit.methods={p2_IInstallableUnit_m_getCopyright, p2_IInstallableUnit_m_unresolved, p2_IInstallableUnit_m_getLicenses, p2_IInstallableUnit_m_getProperty, p2_IInstallableUnit_m_getProperty, p2_IInstallableUnit_m_getProperties, p2_IInstallableUnit_m_satisfies}
...
p2_IMetadataRepository_m_addInstallableUnits: Method = Method(name="addInstallableUnits", parameters={Parameter(name='p2_installableUnits', type=StringType)})
p2_IMetadataRepository_m_addReferences: Method = Method(name="addReferences", parameters={Parameter(name='p2_references', type=StringType)})
p2_IMetadataRepository_m_removeAll: Method = Method(name="removeAll", parameters={})
p2_IMetadataRepository_m_removeInstallableUnits: Method = Method(name="removeInstallableUnits", parameters={Parameter(name='p2_installableUnits', type=StringType)}, type=BooleanType)
p2_IMetadataRepository_m_executeBatch: Method = Method(name="executeBatch", parameters={Parameter(name='p2_runnable', type=StringType), Parameter(name='p2_monitor', type=StringType)}, type=StringType)
p2_IMetadataRepository_m_compress: Method = Method(name="compress", parameters={Parameter(name='p2_iuPool', type=StringType)})
p2_IMetadataRepository.methods={p2_IMetadataRepository_m_executeBatch, p2_IMetadataRepository_m_compress, p2_IMetadataRepository_m_removeAll, p2_IMetadataRepository_m_addInstallableUnits, p2_IMetadataRepository_m_removeInstallableUnits, p2_IMetadataRepository_m_addReferences}
...
p2_IUpdateDescriptor_m_isUpdateOf: Method = Method(name="isUpdateOf", parameters={Parameter(name='p2_installableUnit', type=StringType)}, type=BooleanType)
...
p2_IUpdateDescriptor.methods={p2_IUpdateDescriptor_m_isUpdateOf, p2_IUpdateDescriptor_m_getIUsBeingUpdated}
...
p2_IRequirementChange_m_matches: Method = Method(name="matches", parameters={Parameter(name='p2_toMatch', type=StringType)}, type=BooleanType)
p2_IRequirementChange.methods={p2_IRequirementChange_m_matches, p2_IRequirementChange_m_newValue, p2_IRequirementChange_m_applyOn}

# p2_IQueryable class attributes and methods
p2_IQueryable_m_query: Method = Method(name="query", parameters={Parameter(name='p2_progress', type=StringType), Parameter(name='p2_query', type=StringType)})
...
p2_IRepository_m_getProperty: Method = Method(name="getProperty", parameters={Parameter(name='p2_key', type=StringType)}, type=StringType)
p2_IRepository_m_getProperties: Method = Method(name="getProperties", parameters={})
p2_IRepository_m_setProperty: Method = Method(name="setProperty", parameters={Parameter(name='p2_key', type=StringType), Parameter(name='p2_value', type=StringType)}, type=StringType)
p2_IRepository_m_setProperty: Method = Method(name="setProperty", parameters={Parameter(name='p2_value', type=StringType), Parameter(name='p2_monitor', type=StringType), Parameter(name='p2_key', type=StringType)}, type=StringType)
p2_IRepository.attributes={p2_IRepository_description, p2_IRepository_provisioningAgent, p2_IRepository_type, p2_IRepository_version, p2_IRepository_location, p2_IRepository_name, p2_IRepository_provider, p2_IRepository_modifiable}
...
p2_IRepositoryReference.attributes={p2_IRepositoryReference_nickname, p2_IRepositoryReference_location, p2_IRepositoryReference_options, p2_IRepositoryReference_type}
...
p2_IVersionedId.attributes={p2_IVersionedId_version, p2_IVersionedId_id}
...
p2_SimpleArtifactDescriptor_m_getRepositoryProperty: Method = Method(name="getRepositoryProperty", parameters={Parameter(name='p2_key', type=StringType)}, type=StringType)
...
domain_model = DomainModel(
    name="p2",
    types={p2_ArtifactKey, IArtifactKey, p2_ArtifactRepository, p2_ArtifactsByKey, p2_IArtifactKey, p2_IArtifactDescriptor, p2_ArtifactDescriptor, IArtifactDescriptor, p2_Property, p2_IProcessingStepDescriptor, p2_IArtifactRepository, p2_Comparable, p2_Copyright, ICopyright, p2_IAdaptable, p2_ICopyright, p2_IInstallableUnitFragment, p2_ILicense, p2_IRequirement, p2_IProvidedCapability, p2_ITouchpointData, p2_ITouchpointType, p2_IFileArtifactRepository, IArtifactRepository, p2_IInstallableUnit, p2_InstallableUnit, p2_InstallableUnitFragment, InstallableUnit, IInstallableUnitFragment, p2_InstallableUnitPatch, IInstallableUnitPatch, p2_InstructionMap, p2_ITouchpointInstruction, p2_IMetadataRepository, p2_IUpdateDescriptor, IInstallableUnit, p2_IInstallableUnitPatch, p2_IRequirementChange, p2_IQueryable, p2_IRepository, p2_IRequiredCapability, IRequirement, p2_IRepositoryReference, p2_License, ILicense, p2_MappingRule, p2_MetadataRepository, p2_ProcessingStepDescriptor, IProcessingStepDescriptor, p2_ProvidedCapability, IProvidedCapability, p2_Repository, p2_RepositoryReference, IRepositoryReference, p2_RequiredCapability, Requirement, IRequiredCapability, p2_Requirement, p2_RequirementChange, IRequirementChange, p2_IVersionedId, p2_TouchpointData, ITouchpointData, p2_TouchpointInstruction, ITouchpointInstruction, p2_TouchpointType, ITouchpointType, p2_UpdateDescriptor, IUpdateDescriptor, p2_SimpleArtifactRepository, ArtifactRepository, IFileArtifactRepository, p2_SimpleArtifactDescriptor, ArtifactDescriptor},
    associations={artifactMap3, key4, value6, propertyMap0, processingStepList1, artifactKey8, artifacts11, copyright13, fragments15, licenses17, metaRequirements19, providedCapabilities21, requirements23, touchpointData26, touchpointType28, appliesTo36, propertyMap39, host41, value43, updateDescriptor30, requirementsChange32, lifeCycle33, applyOn44, newValue46, installableUnits49, references51, propertyMap53, repositoryPropertyMap56, instructionMap58, rules55},
    generalizations={gen_p2_ArtifactKey_IArtifactKey, gen_p2_ArtifactDescriptor_IArtifactDescriptor, gen_p2_Copyright_ICopyright, gen_p2_IFileArtifactRepository_IArtifactRepository, gen_p2_InstallableUnit_IInstallableUnit, gen_p2_InstallableUnitFragment_InstallableUnit, gen_p2_InstallableUnitFragment_IInstallableUnitFragment, gen_p2_InstallableUnitPatch_InstallableUnit, gen_p2_InstallableUnitPatch_IInstallableUnitPatch, gen_p2_IInstallableUnitFragment_IInstallableUnit, gen_p2_IInstallableUnitPatch_IInstallableUnit, gen_p2_IRequiredCapability_IRequirement, gen_p2_License_ILicense, gen_p2_ProcessingStepDescriptor_IProcessingStepDescriptor, gen_p2_ProvidedCapability_IProvidedCapability, gen_p2_RepositoryReference_IRepositoryReference, gen_p2_RequiredCapability_Requirement, gen_p2_RequiredCapability_IRequiredCapability, gen_p2_Requirement_IRequirement, gen_p2_TouchpointData_ITouchpointData, gen_p2_TouchpointInstruction_ITouchpointInstruction, gen_p2_TouchpointType_ITouchpointType, gen_p2_UpdateDescriptor_IUpdateDescriptor, gen_p2_RequirementChange_IRequirementChange, gen_p2_SimpleArtifactRepository_ArtifactRepository, gen_p2_SimpleArtifactRepository_IFileArtifactRepository, gen_p2_SimpleArtifactDescriptor_ArtifactDescriptor},
    metadata=None
)
