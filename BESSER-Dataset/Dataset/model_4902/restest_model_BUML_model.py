...
model_Config = Class(name="model_Config")
model_Scenario = Class(name="model_Scenario")
model_ConfigExpectedResultPair = Class(name="model_ConfigExpectedResultPair")
model_ExpectedResult = Class(name="model_ExpectedResult")
...
model_Response.attributes={model_Response_responseTime, model_Response_contentType, model_Response_responseBody, model_Response_statusCode}
...
model_Config.attributes={model_Config_name, model_Config_httpVerb, model_Config_requestURL, model_Config_requestBody, model_Config_contentType}
...
domain_model = DomainModel(
    name="model",
    types={model_Response, model_Config, model_Scenario, model_ConfigExpectedResultPair, model_ExpectedResult, ContentType, HttpVerb, StatusCode},
