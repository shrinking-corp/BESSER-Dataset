...
class model_Config:
    ...
    def __init__(self, requestURL: str, httpVerb: str, contentType: str, requestBody: str, name: str, model_Config: "model_Response" = None, model_Config4: "model_ConfigExpectedResultPair" = None):
