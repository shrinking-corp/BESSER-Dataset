...
# Classes
statesml_SystemUnits = Class(name="statesml_SystemUnits")
statesml_Function = Class(name="statesml_Function")
statesml_Parameter = Class(name="statesml_Parameter")
statesml_DataType = Class(name="statesml_DataType")
statesml_SystemUnitLibrariy = Class(name="statesml_SystemUnitLibrariy")
statesml_DataTypeLibrary = Class(name="statesml_DataTypeLibrary")
statesml_State = Class(name="statesml_State")
...
statesml_StatesML = Class(name="statesml_StatesML")
...
statesml_State.attributes={statesml_State_isInitial, statesml_State_isTerminal}
...
domain_model = DomainModel(
    name="statesml",
    types={statesml_SystemUnits, statesml_Function, statesml_Parameter, statesml_DataType, statesml_SystemUnitLibrariy, statesml_DataTypeLibrary, statesml_State, Node, statesml_Transition, statesml_Attribute, statesml_ChangeEvent, statesml_SelectionConvergence, statesml_StatesML, statesml_Event, statesml_Node, statesml_Edge, statesml_SelectionDivergence, statesml_Trigger, Event},
    associations={function0, inParameter3, returnParameter5, datatype8, datatype10, function13, systemunits16, datatype18, attribute1, trigger22, state23, selectionconvergence24, transition26, state29, event32, systemunits33, datatypelibrary36, systemunitlibrariy39, node42, edge44, attribute46, transition20, selectiondivergence21, node49, edge50, function51, changeevent54},
    generalizations={gen_statesml_State_Node, gen_statesml_SelectionDivergence_Node, gen_statesml_SelectionConvergence_Node, gen_statesml_Transition_Node, gen_statesml_ChangeEvent_Event},
    metadata=None
)
