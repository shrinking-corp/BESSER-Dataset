...
class statesml_Attribute:
    ...
    def __init__(self, name: str, statesml_Attribute9: "statesml_DataType" = None, statesml_Attribute: "statesml_SystemUnits" = None, statesml_Attribute48: "statesml_StatesML" = None):
        self.name = name
...
class statesml_State(Node):
    ...
    def __init__(self, isInitial: bool, isTerminal: bool, State: "statesml_Transition" = None, statesml_State31: "statesml_SelectionConvergence" = None, state: "statesml_Transition" = None, statesml_State: "statesml_SelectionDivergence" = None):
...
class statesml_SystemUnits:
    ...
    def __init__(self, name: str, statesml_SystemUnits: set["statesml_Function"] = None, statesml_SystemUnits17: "statesml_SystemUnitLibrariy" = None, statesml_SystemUnits2: set["statesml_Attribute"] = None, statesml_SystemUnits35: "statesml_StatesML" = None):
        self.name = name
