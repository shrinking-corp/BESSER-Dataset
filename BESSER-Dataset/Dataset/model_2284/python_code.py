...
class Univerity_Courses(uncertainty_ModelElement, uncertainty_aCourses):
    ...
    def __init__(self, Name: str, CFU: int, Semester: str, Univerity_Courses: set["aCourses"] = None, Univerity_Courses2: "aPerson" = None, Univerity_Courses4: set["aPerson"] = None):
        self.Name = Name
        self.CFU = CFU
...
class uncertainty_aUniversity:
    ...
    pass
class Univerity_uncertainty_uUniversity(uncertainty_aUniversity, uncertainty_UData):
