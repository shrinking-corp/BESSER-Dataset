...
# Classes
Univerity_University = Class(name="Univerity_University")
uncertainty_aUniversity = Class(name="uncertainty_aUniversity")
Univerity_uncertainty_ModelElement = Class(name="Univerity_uncertainty_ModelElement", is_abstract=True)
ModelElement = Class(name="ModelElement")
Univerity_Courses = Class(name="Univerity_Courses")
...
Univerity_Person = Class(name="Univerity_Person")
uncertainty_aPerson = Class(name="uncertainty_aPerson")
Univerity_uncertainty_UData = Class(name="Univerity_uncertainty_UData", is_abstract=True)
Univerity_uncertainty_uCourses = Class(name="Univerity_uncertainty_uCourses")
uncertainty_UData = Class(name="uncertainty_UData")
uncertainty_Univerity_Courses = Class(name="uncertainty_Univerity_Courses")
uCourses = Class(name="uCourses")
Univerity_uncertainty_aCourses = Class(name="Univerity_uncertainty_aCourses", is_abstract=True)
Univerity_uncertainty_uPerson = Class(name="Univerity_uncertainty_uPerson")
uncertainty_Univerity_Person = Class(name="uncertainty_Univerity_Person")
uPerson = Class(name="uPerson")
Univerity_uncertainty_aPerson = Class(name="Univerity_uncertainty_aPerson", is_abstract=True)
Univerity_uncertainty_uUniversity = Class(name="Univerity_uncertainty_uUniversity")
uncertainty_Univerity_University = Class(name="uncertainty_Univerity_University")
uUniversity = Class(name="uUniversity")
Univerity_uncertainty_aUniversity = Class(name="Univerity_uncertainty_aUniversity", is_abstract=True)
...
Univerity_Courses.attributes={Univerity_Courses_Name, Univerity_Courses_CFU, Univerity_Courses_Semester}
...
Univerity_Person.attributes={Univerity_Person_Name, Univerity_Person_Email}
...
domain_model = DomainModel(
    name="Univerity",
    types={Univerity_University, uncertainty_aUniversity, Univerity_uncertainty_ModelElement, ModelElement, Univerity_Courses, uncertainty_ModelElement, uncertainty_aCourses, aCourses, aPerson, Univerity_Person, uncertainty_aPerson, Univerity_uncertainty_UData, Univerity_uncertainty_uCourses, uncertainty_UData, uncertainty_Univerity_Courses, uCourses, Univerity_uncertainty_aCourses, Univerity_uncertainty_uPerson, uncertainty_Univerity_Person, uPerson, Univerity_uncertainty_aPerson, Univerity_uncertainty_uUniversity, uncertainty_Univerity_University, uUniversity, Univerity_uncertainty_aUniversity, OperatorType},
    associations={Courses8, include10, links0, Professor1, Student3, relatives6, exclude11, uleft14, uright15, upoint18, uleft20, uright21, upoint24, uleft26, uright27, upoint30},
    generalizations={gen_Univerity_University_uncertainty_ModelElement, gen_Univerity_University_uncertainty_aUniversity, gen_Univerity_Courses_uncertainty_ModelElement, gen_Univerity_Courses_uncertainty_aCourses, gen_Univerity_Person_uncertainty_ModelElement, gen_Univerity_Person_uncertainty_aPerson, gen_Univerity_uncertainty_uCourses_uncertainty_aCourses, gen_Univerity_uncertainty_uCourses_uncertainty_UData, gen_Univerity_uncertainty_uPerson_uncertainty_aPerson, gen_Univerity_uncertainty_uPerson_uncertainty_UData, gen_Univerity_uncertainty_uUniversity_uncertainty_aUniversity, gen_Univerity_uncertainty_uUniversity_uncertainty_UData},
    metadata=None
)
