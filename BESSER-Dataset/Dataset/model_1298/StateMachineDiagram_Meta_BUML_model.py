...
StateMachineDiagram_Meta_Screen = Class(name="StateMachineDiagram_Meta_Screen")
...
domain_model = DomainModel(
    ...
    types={StateMachineDiagram_Meta_Application, StateMachineDiagram_Meta_StateMachine, StateMachineDiagram_Meta_Vertex, StateMachineDiagram_Meta_Transition, StateMachineDiagram_Meta_Pseudostate, Vertex, StateMachineDiagram_Meta_State, StateMachineDiagram_Meta_Screen, State, StateMachineDiagram_Meta_Event},
    associations={incoming6, source8, target9, statemachine0, vertex1, transition3, outgoing5, statemachine11},
