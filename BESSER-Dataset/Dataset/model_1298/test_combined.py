...
def test_hyp_statemachinediagram_meta_screen_is_not_abstract():
    assert not inspect.isabstract(StateMachineDiagram_Meta_Screen)


def test_hyp_statemachinediagram_meta_screen_constructor_exists():
    assert callable(StateMachineDiagram_Meta_Screen.__init__)


def test_hyp_statemachinediagram_meta_screen_constructor_args():
...
def test_StateMachineDiagram_Meta_Screen_isa_State():
    instance = StateMachineDiagram_Meta_Screen()
    assert isinstance(instance, State)
...
StateMachineDiagram_Meta_Screen_strategy = st.builds(StateMachineDiagram_Meta_Screen)
