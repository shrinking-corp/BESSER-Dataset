...
def test_model_instances_simpleinstance_is_not_abstract():
    assert not inspect.isabstract(model_instances_SimpleInstance)


def test_model_instances_simpleinstance_constructor_exists():
    assert callable(model_instances_SimpleInstance.__init__)


def test_model_instances_simpleinstance_constructor_args():
    sig = inspect.signature(model_instances_SimpleInstance.__init__)
    params = list(sig.parameters.keys())



def test_model_instances_simpleconnectioninstance_is_not_abstract():
    assert not inspect.isabstract(model_instances_SimpleConnectionInstance)


def test_model_instances_simpleconnectioninstance_constructor_exists():
    assert callable(model_instances_SimpleConnectionInstance.__init__)


def test_model_instances_simpleconnectioninstance_constructor_args():
...
def test_model_instances_simpleconnectioninstance_has_connectivity():
    assert hasattr(model_instances_SimpleConnectionInstance, "connectivity")
    descriptor = None
    for klass in model_instances_SimpleConnectionInstance.__mro__:
...
def test_model_instances_instance_is_not_abstract():
    assert not inspect.isabstract(model_instances_Instance)


def test_model_instances_instance_constructor_exists():
    assert callable(model_instances_Instance.__init__)


def test_model_instances_instance_constructor_args():
...
@given(instance=model_instances_SimpleConnectionInstance_strategy)
def test_model_instances_simpleconnectioninstance_connectivity_setter(instance):
