...
def test_hyp_aarrayvalue_is_not_abstract():
    assert not inspect.isabstract(AArrayValue)


def test_hyp_aarrayvalue_constructor_exists():
    assert callable(AArrayValue.__init__)


def test_hyp_aarrayvalue_constructor_args():
    sig = inspect.signature(AArrayValue.__init__)
    params = list(sig.parameters.keys())



def test_hyp_model_values_stringarray_is_not_abstract():
    assert not inspect.isabstract(model_values_StringArray)


def test_hyp_model_values_stringarray_constructor_exists():
    assert callable(model_values_StringArray.__init__)


def test_hyp_model_values_stringarray_constructor_args():
...
def test_hyp_model_values_intarray_is_not_abstract():
    assert not inspect.isabstract(model_values_IntArray)


def test_hyp_model_values_intarray_constructor_exists():
    assert callable(model_values_IntArray.__init__)


def test_hyp_model_values_intarray_constructor_args():
...
def test_hyp_model_values_genericarray_is_not_abstract():
    assert not inspect.isabstract(model_values_GenericArray)


def test_hyp_model_values_genericarray_constructor_exists():
    assert callable(model_values_GenericArray.__init__)


def test_hyp_model_values_genericarray_constructor_args():
    sig = inspect.signature(model_values_GenericArray.__init__)
    params = list(sig.parameters.keys())



def test_hyp_model_values_doublearray_is_not_abstract():
    assert not inspect.isabstract(model_values_DoubleArray)


def test_hyp_model_values_doublearray_constructor_exists():
    assert callable(model_values_DoubleArray.__init__)


def test_hyp_model_values_doublearray_constructor_args():
...
def test_hyp_model_values_metadata_is_not_abstract():
    assert not inspect.isabstract(model_values_Metadata)


def test_hyp_model_values_metadata_constructor_exists():
    assert callable(model_values_Metadata.__init__)


def test_hyp_model_values_metadata_constructor_args():
    sig = inspect.signature(model_values_Metadata.__init__)
    params = list(sig.parameters.keys())



def test_hyp_model_values_json_is_not_abstract():
    assert not inspect.isabstract(model_values_JSON)


def test_hyp_model_values_json_constructor_exists():
    assert callable(model_values_JSON.__init__)


def test_hyp_model_values_json_constructor_args():
...
def test_hyp_model_instances_simpleinstance_is_not_abstract():
    assert not inspect.isabstract(model_instances_SimpleInstance)


def test_hyp_model_instances_simpleinstance_constructor_exists():
    assert callable(model_instances_SimpleInstance.__init__)


def test_hyp_model_instances_simpleinstance_constructor_args():
    sig = inspect.signature(model_instances_SimpleInstance.__init__)
    params = list(sig.parameters.keys())



def test_hyp_model_instances_simpleconnectioninstance_is_not_abstract():
    assert not inspect.isabstract(model_instances_SimpleConnectionInstance)


def test_hyp_model_instances_simpleconnectioninstance_constructor_exists():
    assert callable(model_instances_SimpleConnectionInstance.__init__)


def test_hyp_model_instances_simpleconnectioninstance_constructor_args():
    sig = inspect.signature(model_instances_SimpleConnectionInstance.__init__)
    params = list(sig.parameters.keys())
...
def test_hyp_model_values_aarrayvalue_is_not_abstract():
    assert not inspect.isabstract(model_values_AArrayValue)


def test_hyp_model_values_aarrayvalue_constructor_exists():
    assert callable(model_values_AArrayValue.__init__)


def test_hyp_model_values_aarrayvalue_constructor_args():
...
def test_hyp_model_types_simplearraytype_is_not_abstract():
    assert not inspect.isabstract(model_types_SimpleArrayType)


def test_hyp_model_types_simplearraytype_constructor_exists():
    assert callable(model_types_SimpleArrayType.__init__)


def test_hyp_model_types_simplearraytype_constructor_args():
...
def test_hyp_model_types_jsontype_is_not_abstract():
    assert not inspect.isabstract(model_types_JSONType)


def test_hyp_model_types_jsontype_constructor_exists():
    assert callable(model_types_JSONType.__init__)


def test_hyp_model_types_jsontype_constructor_args():
...
def test_hyp_model_types_metadatatype_is_not_abstract():
    assert not inspect.isabstract(model_types_MetadataType)


def test_hyp_model_types_metadatatype_constructor_exists():
    assert callable(model_types_MetadataType.__init__)


def test_hyp_model_types_metadatatype_constructor_args():
...
def test_hyp_model_instances_instance_is_not_abstract():
    assert not inspect.isabstract(model_instances_Instance)


def test_hyp_model_instances_instance_constructor_exists():
    assert callable(model_instances_Instance.__init__)


def test_hyp_model_instances_instance_constructor_args():
    sig = inspect.signature(model_instances_Instance.__init__)
    params = list(sig.parameters.keys())
...
model_instances_SimpleInstance_strategy = st.builds(
    model_instances_SimpleInstance,
)
model_instances_SimpleConnectionInstance_strategy = st.builds(
    model_instances_SimpleConnectionInstance,
    connectivity=
        safe_text
)
...
model_instances_Instance_strategy = st.builds(
    model_instances_Instance,
)
...
def test_hyp_model_values_stringarray_elements_setter(instance):
...
def test_hyp_model_values_intarray_elements_setter(instance):
    original = instance.elements
    instance.elements = original
    assert instance.elements == original
...
def test_hyp_model_values_doublearray_elements_setter(instance):
    original = instance.elements
    instance.elements = original
    assert instance.elements == original
...
def test_hyp_model_values_json_json_setter(instance):
...
def test_hyp_model_instances_simpleconnectioninstance_connectivity_setter(instance):
