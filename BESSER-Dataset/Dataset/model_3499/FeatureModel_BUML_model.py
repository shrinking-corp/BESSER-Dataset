...
domain_model = DomainModel(
    name="FeatureModel",
    types={FeatureModel_FeatureConstraint, FeatureModel_ConfigConstraint, FeatureModel_Constraint, Constraint, FeatureModel_FeatureModel, FeatureModel_RootFeature, FeatureModel_And, ConfigConstraint, FeatureModel_Or, FeatureModel_Xor, FeatureModel_Feature, Type, kind},
    associations={FConst1, ConfConst3, RootFeature0, ConfFeatures8, Features5, Config7},
    generalizations={gen_FeatureModel_FeatureConstraint_Constraint, gen_FeatureModel_And_ConfigConstraint, gen_FeatureModel_Or_ConfigConstraint, gen_FeatureModel_Xor_ConfigConstraint, gen_FeatureModel_ConfigConstraint_Constraint},
    metadata=None
)
