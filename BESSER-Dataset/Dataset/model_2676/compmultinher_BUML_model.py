...
# Classes
compmultinher_A = Class(name="compmultinher_A")
compmultinher_B = Class(name="compmultinher_B")
compmultinher_K = Class(name="compmultinher_K")
Named = Class(name="Named")
compmultinher_C = Class(name="compmultinher_C")
compmultinher_Named = Class(name="compmultinher_Named")
compmultinher_E = Class(name="compmultinher_E")
compmultinher_D = Class(name="compmultinher_D")
B = Class(name="B")
compmultinher_F = Class(name="compmultinher_F")
D = Class(name="D")
compmultinher_G = Class(name="compmultinher_G")
compmultinher_H = Class(name="compmultinher_H")
compmultinher_I = Class(name="compmultinher_I")
F = Class(name="F")
K = Class(name="K")
compmultinher_L = Class(name="compmultinher_L")
...
domain_model = DomainModel(
    name="compmultinher",
    types={compmultinher_A, compmultinher_B, compmultinher_K, Named, compmultinher_C, compmultinher_Named, compmultinher_E, compmultinher_D, B, compmultinher_F, D, compmultinher_G, compmultinher_H, compmultinher_I, F, K, compmultinher_L},
    associations={bs0, ks1, cs3, es5, gs6, hs7, ls9},
    generalizations={gen_compmultinher_B_Named, gen_compmultinher_C_Named, gen_compmultinher_D_B, gen_compmultinher_E_Named, gen_compmultinher_F_D, gen_compmultinher_G_Named, gen_compmultinher_I_F, gen_compmultinher_I_K, gen_compmultinher_H_Named, gen_compmultinher_K_Named, gen_compmultinher_L_Named},
    metadata=None
)
