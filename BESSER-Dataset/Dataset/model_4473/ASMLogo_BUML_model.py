...
domain_model = DomainModel(
    name="kmlogo",
    types={kmlogo_asm_Instruction, kmlogo_asm_Primitive, Instruction, kmlogo_asm_Back, Primitive, Expression, kmlogo_asm_Right, kmlogo_asm_PenDown, kmlogo_asm_PenUp, kmlogo_asm_Clear, kmlogo_asm_Expression, kmlogo_asm_BinaryExp, kmlogo_asm_Constant, kmlogo_asm_ProcCall, ProcDeclaration, kmlogo_asm_ProcDeclaration, kmlogo_asm_Forward, kmlogo_asm_Left, kmlogo_asm_Block, kmlogo_asm_If, ControlStructure, Block, kmlogo_asm_ControlStructure, kmlogo_asm_Repeat, kmlogo_asm_While, kmlogo_asm_Parameter, kmlogo_asm_ParameterCall, kmlogo_asm_Plus, BinaryExp, Parameter_, ProcCall, kmlogo_asm_LogoProgram, kmlogo_asm_Minus, kmlogo_asm_Mult, kmlogo_asm_Div, kmlogo_asm_Equals, kmlogo_asm_Greater, kmlogo_asm_Lower},
    associations={steps0, angle5, lhs7, rhs9, actualArgs12, declaration14, steps1, angle3, instructions19, thenPart21, elsePart22, condition25, block27, block29, parameter31, args15, procCall16, instructions17, instructions33},
    generalizations={gen_kmlogo_asm_Primitive_Instruction, gen_kmlogo_asm_Back_Primitive, gen_kmlogo_asm_Right_Primitive, gen_kmlogo_asm_PenDown_Primitive, gen_kmlogo_asm_PenUp_Primitive, gen_kmlogo_asm_Clear_Primitive, gen_kmlogo_asm_Expression_Instruction, gen_kmlogo_asm_BinaryExp_Expression, gen_kmlogo_asm_Constant_Expression, gen_kmlogo_asm_ProcCall_Expression, gen_kmlogo_asm_ProcDeclaration_Instruction, gen_kmlogo_asm_Forward_Primitive, gen_kmlogo_asm_Left_Primitive, gen_kmlogo_asm_Block_Instruction, gen_kmlogo_asm_If_ControlStructure, gen_kmlogo_asm_ControlStructure_Instruction, gen_kmlogo_asm_Repeat_ControlStructure, gen_kmlogo_asm_While_ControlStructure, gen_kmlogo_asm_ParameterCall_Expression, gen_kmlogo_asm_Plus_BinaryExp, gen_kmlogo_asm_Minus_BinaryExp, gen_kmlogo_asm_Mult_BinaryExp, gen_kmlogo_asm_Div_BinaryExp, gen_kmlogo_asm_Equals_BinaryExp, gen_kmlogo_asm_Greater_BinaryExp, gen_kmlogo_asm_Lower_BinaryExp},
    metadata=None
)
