...
class diva_visitors_TopDownVisitor(ABC):
    ...
    def visitBaseModel(self, diva_context, diva_node):
...
class diva_Property(NamedElement):
    ...
    def __init__(self, direction: str, diva_Property44: set["diva_PropertyLiteral"] = None, diva_Property47: "diva_PropertyValue" = None, diva_Property: "diva_VariabilityModel" = None, diva_Property33: "diva_Dimension" = None, diva_Property50: "diva_PropertyPriority" = None, diva_Property76: "diva_Score" = None, diva_Property79: "diva_Priority" = None):
...
class diva_Variant(ModelContainer, NamedElement):
    ...
    def __init__(self, weaveLevel: str, diva_Variant: "diva_VariantTerm" = None, diva_Variant24: "diva_VariantExpression" = None, diva_Variant26: "diva_ContextExpression" = None, diva_Variant28: "diva_ContextExpression" = None, Variant: "diva_Dimension" = None, variant: "diva_Dimension" = None, diva_Variant22: set["diva_PropertyValue"] = None, diva_Variant69: "diva_ConfigVariant" = None):
...
class diva_VariabilityModel(ModelContainer):
    ...
    def __init__(self, diva_VariabilityModel8: set["diva_Constraint"] = None, model: "diva_SimulationModel" = None, diva_VariabilityModel: set["diva_Variable"] = None, diva_VariabilityModel2: set["diva_Property"] = None, diva_VariabilityModel4: set["diva_Dimension"] = None, diva_VariabilityModel6: set["diva_Rule"] = None, VariabilityModel: "diva_SimulationModel" = None):
