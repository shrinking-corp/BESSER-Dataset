...
diva_PropertyLiteral = Class(name="diva_PropertyLiteral")
...
diva_ConfigurationModel = Class(name="diva_ConfigurationModel")
diva_SuitableConfiguration = Class(name="diva_SuitableConfiguration")
diva_ContextModel = Class(name="diva_ContextModel")
diva_ModelContainer = Class(name="diva_ModelContainer", is_abstract=True)
diva_visitors_Visitable = Class(name="diva_visitors_Visitable", is_abstract=True)
diva_visitors_Visitor = Class(name="diva_visitors_Visitor", is_abstract=True)
diva_visitors_TopDownVisitor = Class(name="diva_visitors_TopDownVisitor", is_abstract=True)

# diva_Constraint class attributes and methods

# diva_SimulationModel class attributes and methods
diva_SimulationModel_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_visitor', type=StringType)})
diva_SimulationModel.methods={diva_SimulationModel_m_accept}

# diva_Invariant class attributes and methods
diva_Invariant_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_visitor', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_Invariant.methods={diva_Invariant_m_accept}

# Constraint class attributes and methods

# diva_VariabilityModel class attributes and methods
diva_VariabilityModel_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_visitor', type=StringType), Parameter(name='diva_context', type=StringType)})
...
diva_Property_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_visitor', type=StringType), Parameter(name='diva_context', type=StringType)})
...
diva_Dimension_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_visitor', type=StringType)})
...
diva_EnumVariable_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_visitor', type=StringType)})
...
diva_Expression_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_visitor', type=StringType)})
...
diva_BaseModel_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_visitor', type=StringType), Parameter(name='diva_context', type=StringType)})
...
diva_AspectModel_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_visitor', type=StringType)})
diva_AspectModel.methods={diva_AspectModel_m_accept}

# diva_NotTerm class attributes and methods
diva_NotTerm_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_visitor', type=StringType)})
diva_NotTerm.methods={diva_NotTerm_m_accept}

# Term class attributes and methods

# diva_EnumLiteral class attributes and methods
diva_EnumLiteral_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_visitor', type=StringType)})
diva_EnumLiteral.methods={diva_EnumLiteral_m_accept}

# diva_BooleanVariable class attributes and methods
diva_BooleanVariable_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_visitor', type=StringType), Parameter(name='diva_context', type=StringType)})
...
diva_AndTerm_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_visitor', type=StringType)})
diva_AndTerm.methods={diva_AndTerm_m_accept}

# NaryTerm class attributes and methods

# diva_OrTerm class attributes and methods
diva_OrTerm_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_visitor', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_OrTerm.methods={diva_OrTerm_m_accept}

# diva_BooleanTerm class attributes and methods
diva_BooleanTerm_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_visitor', type=StringType), Parameter(name='diva_context', type=StringType)})
...
diva_VariantTerm_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_visitor', type=StringType)})
...
diva_Variant_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_visitor', type=StringType), Parameter(name='diva_context', type=StringType)})
...
diva_EnumTerm_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_visitor', type=StringType), Parameter(name='diva_context', type=StringType)})
...
diva_VariantExpression_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_visitor', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_VariantExpression.methods={diva_VariantExpression_m_accept}

# diva_ContextExpression class attributes and methods
diva_ContextExpression_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_visitor', type=StringType)})
...
diva_MultiplicityConstraint_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_visitor', type=StringType)})
...
diva_PropertyValue_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_visitor', type=StringType)})
...
diva_PriorityRule_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_visitor', type=StringType), Parameter(name='diva_context', type=StringType)})
...
diva_PropertyLiteral_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_visitor', type=StringType)})
...
diva_PropertyPriority_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_visitor', type=StringType), Parameter(name='diva_context', type=StringType)})
...
diva_Annotation_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_visitor', type=StringType), Parameter(name='diva_context', type=StringType)})
...
diva_Scenario_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_visitor', type=StringType), Parameter(name='diva_context', type=StringType)})
...
diva_Context_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_visitor', type=StringType), Parameter(name='diva_context', type=StringType)})
...
diva_Configuration_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_visitor', type=StringType), Parameter(name='diva_context', type=StringType)})
...
diva_Priority_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_visitor', type=StringType), Parameter(name='diva_context', type=StringType)})
...
diva_Score_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_visitor', type=StringType), Parameter(name='diva_context', type=StringType)})
...
diva_ConfigVariant_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_visitor', type=StringType)})
...
diva_BoolVariableValue_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_visitor', type=StringType), Parameter(name='diva_context', type=StringType)})
...
diva_EnumVariableValue_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_visitor', type=StringType)})
diva_EnumVariableValue.methods={diva_EnumVariableValue_m_accept}

# diva_ConfigurationModel class attributes and methods
diva_ConfigurationModel_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_visitor', type=StringType)})
...
diva_SuitableConfiguration_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_visitor', type=StringType), Parameter(name='diva_context', type=StringType)})
...
diva_ContextModel_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_visitor', type=StringType)})
...
diva_visitors_Visitable_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_visitor', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_Visitable.methods={diva_visitors_Visitable_m_accept}

# diva_visitors_Visitor class attributes and methods
diva_visitors_Visitor_m_visitVariabilityModel: Method = Method(name="visitVariabilityModel", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_Visitor_m_visitInvariant: Method = Method(name="visitInvariant", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_Visitor_m_visitBaseModel: Method = Method(name="visitBaseModel", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_Visitor_m_visitAspectModel: Method = Method(name="visitAspectModel", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_Visitor_m_visitEnumVariable: Method = Method(name="visitEnumVariable", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_Visitor_m_visitBooleanVariable: Method = Method(name="visitBooleanVariable", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_Visitor_m_visitAndTerm: Method = Method(name="visitAndTerm", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_Visitor_m_visitOrTerm: Method = Method(name="visitOrTerm", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_Visitor_m_visitNotTerm: Method = Method(name="visitNotTerm", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_Visitor_m_visitBooleanTerm: Method = Method(name="visitBooleanTerm", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_Visitor_m_visitEnumLiteral: Method = Method(name="visitEnumLiteral", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_Visitor_m_visitVariant: Method = Method(name="visitVariant", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_Visitor_m_visitDimension: Method = Method(name="visitDimension", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_Visitor_m_visitExpression: Method = Method(name="visitExpression", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_Visitor_m_visitContextExpression: Method = Method(name="visitContextExpression", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_Visitor_m_visitVariantExpression: Method = Method(name="visitVariantExpression", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_Visitor_m_visitPriorityRule: Method = Method(name="visitPriorityRule", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_Visitor_m_visitProperty: Method = Method(name="visitProperty", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_Visitor_m_visitPropertyLiteral: Method = Method(name="visitPropertyLiteral", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_Visitor_m_visitPropertyValue: Method = Method(name="visitPropertyValue", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_Visitor_m_visitPropertyPriority: Method = Method(name="visitPropertyPriority", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_Visitor_m_visitMultiplicityConstraint: Method = Method(name="visitMultiplicityConstraint", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_Visitor_m_visitVariantTerm: Method = Method(name="visitVariantTerm", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_Visitor_m_visitEnumTerm: Method = Method(name="visitEnumTerm", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_Visitor_m_visitContext: Method = Method(name="visitContext", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_Visitor_m_visitConfiguration: Method = Method(name="visitConfiguration", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_Visitor_m_visitConfigVariant: Method = Method(name="visitConfigVariant", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_Visitor_m_visitScenario: Method = Method(name="visitScenario", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_Visitor_m_visitScore: Method = Method(name="visitScore", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_Visitor_m_visitPriority: Method = Method(name="visitPriority", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_Visitor_m_visitBoolVariableValue: Method = Method(name="visitBoolVariableValue", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_Visitor_m_visitEnumVariableValue: Method = Method(name="visitEnumVariableValue", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_Visitor_m_visitConfigurationModel: Method = Method(name="visitConfigurationModel", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_Visitor_m_visitSuitableConfiguration: Method = Method(name="visitSuitableConfiguration", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_Visitor_m_visitContextModel: Method = Method(name="visitContextModel", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_Visitor_m_visitAnnotation: Method = Method(name="visitAnnotation", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_Visitor_m_visitSimulationModel: Method = Method(name="visitSimulationModel", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_Visitor.methods={diva_visitors_Visitor_m_visitPriority, diva_visitors_Visitor_m_visitConfigVariant, diva_visitors_Visitor_m_visitPropertyValue, diva_visitors_Visitor_m_visitScore, diva_visitors_Visitor_m_visitVariantTerm, diva_visitors_Visitor_m_visitContext, diva_visitors_Visitor_m_visitConfigurationModel, diva_visitors_Visitor_m_visitContextExpression, diva_visitors_Visitor_m_visitAspectModel, diva_visitors_Visitor_m_visitDimension, diva_visitors_Visitor_m_visitBaseModel, diva_visitors_Visitor_m_visitOrTerm, diva_visitors_Visitor_m_visitEnumLiteral, diva_visitors_Visitor_m_visitNotTerm, diva_visitors_Visitor_m_visitConfiguration, diva_visitors_Visitor_m_visitBooleanTerm, diva_visitors_Visitor_m_visitEnumVariableValue, diva_visitors_Visitor_m_visitVariant, diva_visitors_Visitor_m_visitSimulationModel, diva_visitors_Visitor_m_visitPriorityRule, diva_visitors_Visitor_m_visitExpression, diva_visitors_Visitor_m_visitVariantExpression, diva_visitors_Visitor_m_visitSuitableConfiguration, diva_visitors_Visitor_m_visitMultiplicityConstraint, diva_visitors_Visitor_m_visitPropertyLiteral, diva_visitors_Visitor_m_visitPropertyPriority, diva_visitors_Visitor_m_visitAnnotation, diva_visitors_Visitor_m_visitEnumVariable, diva_visitors_Visitor_m_visitInvariant, diva_visitors_Visitor_m_visitContextModel, diva_visitors_Visitor_m_visitScenario, diva_visitors_Visitor_m_visitBoolVariableValue, diva_visitors_Visitor_m_visitVariabilityModel, diva_visitors_Visitor_m_visitProperty, diva_visitors_Visitor_m_visitAndTerm, diva_visitors_Visitor_m_visitEnumTerm, diva_visitors_Visitor_m_visitBooleanVariable}

# diva_visitors_TopDownVisitor class attributes and methods
diva_visitors_TopDownVisitor_m_visitBaseModel: Method = Method(name="visitBaseModel", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_TopDownVisitor_m_visitAspectModel: Method = Method(name="visitAspectModel", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_TopDownVisitor_m_visitEnumVariable: Method = Method(name="visitEnumVariable", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_TopDownVisitor_m_visitBooleanVariable: Method = Method(name="visitBooleanVariable", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_TopDownVisitor_m_visitAndTerm: Method = Method(name="visitAndTerm", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_TopDownVisitor_m_visitOrTerm: Method = Method(name="visitOrTerm", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_TopDownVisitor_m_visitVariabilityModel: Method = Method(name="visitVariabilityModel", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_TopDownVisitor_m_visitInvariant: Method = Method(name="visitInvariant", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_TopDownVisitor_m_visitVariantTerm: Method = Method(name="visitVariantTerm", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_TopDownVisitor_m_visitEnumTerm: Method = Method(name="visitEnumTerm", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_TopDownVisitor_m_visitBooleanTerm: Method = Method(name="visitBooleanTerm", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_TopDownVisitor_m_visitEnumLiteral: Method = Method(name="visitEnumLiteral", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_TopDownVisitor_m_visitVariant: Method = Method(name="visitVariant", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_TopDownVisitor_m_visitDimension: Method = Method(name="visitDimension", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_TopDownVisitor_m_visitNotTerm: Method = Method(name="visitNotTerm", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_TopDownVisitor_m_visitContextExpression: Method = Method(name="visitContextExpression", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_TopDownVisitor_m_visitVariantExpression: Method = Method(name="visitVariantExpression", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_TopDownVisitor_m_visitPriorityRule: Method = Method(name="visitPriorityRule", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_TopDownVisitor_m_visitProperty: Method = Method(name="visitProperty", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_TopDownVisitor_m_visitPropertyLiteral: Method = Method(name="visitPropertyLiteral", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_TopDownVisitor_m_visitPropertyValue: Method = Method(name="visitPropertyValue", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_TopDownVisitor_m_visitPropertyPriority: Method = Method(name="visitPropertyPriority", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_TopDownVisitor_m_visitExpression: Method = Method(name="visitExpression", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_TopDownVisitor_m_visitAnnotation: Method = Method(name="visitAnnotation", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_TopDownVisitor_m_visitSimulationModel: Method = Method(name="visitSimulationModel", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_TopDownVisitor_m_visitContext: Method = Method(name="visitContext", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_TopDownVisitor_m_visitConfiguration: Method = Method(name="visitConfiguration", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_TopDownVisitor_m_visitConfigVariant: Method = Method(name="visitConfigVariant", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_TopDownVisitor_m_visitScenario: Method = Method(name="visitScenario", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_TopDownVisitor_m_visitScore: Method = Method(name="visitScore", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_TopDownVisitor_m_visitMultiplicityConstraint: Method = Method(name="visitMultiplicityConstraint", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_TopDownVisitor_m_visitBoolVariableValue: Method = Method(name="visitBoolVariableValue", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_TopDownVisitor_m_visitEnumVariableValue: Method = Method(name="visitEnumVariableValue", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_TopDownVisitor_m_visitConfigurationModel: Method = Method(name="visitConfigurationModel", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_TopDownVisitor_m_visitSuitableConfiguration: Method = Method(name="visitSuitableConfiguration", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_TopDownVisitor_m_visitContextModel: Method = Method(name="visitContextModel", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
diva_visitors_TopDownVisitor_m_visitPriority: Method = Method(name="visitPriority", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_TopDownVisitor.methods={diva_visitors_TopDownVisitor_m_visitContextExpression, diva_visitors_TopDownVisitor_m_visitPriority, diva_visitors_TopDownVisitor_m_visitBoolVariableValue, diva_visitors_TopDownVisitor_m_visitEnumVariableValue, diva_visitors_TopDownVisitor_m_visitPropertyPriority, diva_visitors_TopDownVisitor_m_visitVariabilityModel, diva_visitors_TopDownVisitor_m_visitEnumTerm, diva_visitors_TopDownVisitor_m_visitPriorityRule, diva_visitors_TopDownVisitor_m_visitConfigVariant, diva_visitors_TopDownVisitor_m_visitContextModel, diva_visitors_TopDownVisitor_m_visitConfigurationModel, diva_visitors_TopDownVisitor_m_visitBaseModel, diva_visitors_TopDownVisitor_m_visitVariantTerm, diva_visitors_TopDownVisitor_m_visitAndTerm, diva_visitors_TopDownVisitor_m_visitEnumLiteral, diva_visitors_TopDownVisitor_m_visitVariant, diva_visitors_TopDownVisitor_m_visitVariantExpression, diva_visitors_TopDownVisitor_m_visitExpression, diva_visitors_TopDownVisitor_m_visitScenario, diva_visitors_TopDownVisitor_m_visitConfiguration, diva_visitors_TopDownVisitor_m_visitOrTerm, diva_visitors_TopDownVisitor_m_visitBooleanVariable, diva_visitors_TopDownVisitor_m_visitDimension, diva_visitors_TopDownVisitor_m_visitProperty, diva_visitors_TopDownVisitor_m_visitInvariant, diva_visitors_TopDownVisitor_m_visitEnumVariable, diva_visitors_TopDownVisitor_m_visitAspectModel, diva_visitors_TopDownVisitor_m_visitScore, diva_visitors_TopDownVisitor_m_visitAnnotation, diva_visitors_TopDownVisitor_m_visitMultiplicityConstraint, diva_visitors_TopDownVisitor_m_visitSimulationModel, diva_visitors_TopDownVisitor_m_visitContext, diva_visitors_TopDownVisitor_m_visitNotTerm, diva_visitors_TopDownVisitor_m_visitPropertyValue, diva_visitors_TopDownVisitor_m_visitPropertyLiteral, diva_visitors_TopDownVisitor_m_visitBooleanTerm, diva_visitors_TopDownVisitor_m_visitSuitableConfiguration}
...
domain_model = DomainModel(
    name="diva",
    types={diva_Constraint, diva_SimulationModel, diva_Invariant, Constraint, diva_VariabilityModel, ModelContainer, diva_Variable, diva_Property, diva_Dimension, diva_Rule, diva_EnumVariable, Variable, diva_Expression, NamedElement, diva_Model, DiVAModelElement, diva_BaseModel, Model, diva_AspectModel, diva_NotTerm, Term, diva_EnumLiteral, diva_BooleanVariable, diva_Term, diva_AndTerm, NaryTerm, diva_OrTerm, diva_BooleanTerm, diva_NaryTerm, diva_VariantTerm, diva_NamedElement, diva_Variant, diva_VariableTerm, diva_EnumTerm, VariableTerm, diva_VariantExpression, diva_ContextExpression, diva_MultiplicityConstraint, diva_PropertyValue, diva_PriorityRule, Rule, Expression, diva_PropertyLiteral, diva_PropertyPriority, diva_Annotation, Visitable, diva_DiVAModelElement, diva_Scenario, diva_Context, diva_VariableValue, diva_Configuration, diva_Priority, ScoredElement, diva_ScoredElement, diva_Score, diva_ConfigVariant, diva_BoolVariableValue, VariableValue, diva_EnumVariableValue, diva_ConfigurationModel, diva_SuitableConfiguration, diva_ContextModel, diva_ModelContainer, diva_visitors_Visitable, diva_visitors_Visitor, diva_visitors_TopDownVisitor, Verdict},
    associations={constraint7, simulation9, context0, property1, dimension3, rule5, expression10, literal11, value18, term12, term13, variant15, variable16, dependency23, available25, required27, variant30, property31, constraints34, term36, type20, propertyValue21, literal43, property45, context39, priority41, property48, available51, scenario55, model56, variable57, configuration58, oracle60, priority63, annotation54, variant65, variant67, context70, score73, property74, property77, variable80, literal83, configurations85, variant86, model91, variable89},
    generalizations={gen_diva_Invariant_Constraint, gen_diva_VariabilityModel_ModelContainer, gen_diva_EnumVariable_Variable, gen_diva_Variable_NamedElement, gen_diva_Model_DiVAModelElement, gen_diva_BaseModel_Model, gen_diva_AspectModel_Model, gen_diva_NotTerm_Term, gen_diva_BooleanVariable_Variable, gen_diva_Term_DiVAModelElement, gen_diva_AndTerm_NaryTerm, gen_diva_OrTerm_NaryTerm, gen_diva_BooleanTerm_VariableTerm, gen_diva_Rule_NamedElement, gen_diva_EnumLiteral_NamedElement, gen_diva_NaryTerm_Term, gen_diva_VariantTerm_Term, gen_diva_NamedElement_DiVAModelElement, gen_diva_Constraint_NamedElement, gen_diva_Variant_NamedElement, gen_diva_Variant_ModelContainer, gen_diva_VariableTerm_Term, gen_diva_EnumTerm_VariableTerm, gen_diva_Dimension_NamedElement, gen_diva_Expression_DiVAModelElement, gen_diva_VariantExpression_Expression, gen_diva_PriorityRule_Rule, gen_diva_ContextExpression_Expression, gen_diva_PropertyLiteral_NamedElement, gen_diva_PropertyValue_DiVAModelElement, gen_diva_PropertyPriority_DiVAModelElement, gen_diva_Property_NamedElement, gen_diva_MultiplicityConstraint_Constraint, gen_diva_Annotation_Visitable, gen_diva_Context_NamedElement, gen_diva_Configuration_ScoredElement, gen_diva_DiVAModelElement_Visitable, gen_diva_SimulationModel_DiVAModelElement, gen_diva_ConfigVariant_ScoredElement, gen_diva_Scenario_NamedElement, gen_diva_ScoredElement_DiVAModelElement, gen_diva_Score_DiVAModelElement, gen_diva_Priority_DiVAModelElement, gen_diva_VariableValue_DiVAModelElement, gen_diva_BoolVariableValue_VariableValue, gen_diva_EnumVariableValue_VariableValue, gen_diva_ConfigurationModel_Visitable, gen_diva_SuitableConfiguration_Visitable, gen_diva_ContextModel_Visitable, gen_diva_ModelContainer_Visitable},
    metadata=None
)
