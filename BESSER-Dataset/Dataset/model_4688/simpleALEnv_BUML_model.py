...
# Classes
simpleALEnv_Block = Class(name="simpleALEnv_Block")
simpleALEnv_Stmt = Class(name="simpleALEnv_Stmt", is_abstract=True)
simpleALEnv_ArithPlus = Class(name="simpleALEnv_ArithPlus")
ArithOp = Class(name="ArithOp")
simpleALEnv_ArithMinus = Class(name="simpleALEnv_ArithMinus")
simpleALEnv_Print = Class(name="simpleALEnv_Print")
Stmt = Class(name="Stmt")
simpleALEnv_Assign = Class(name="simpleALEnv_Assign")
simpleALEnv_IfStmt = Class(name="simpleALEnv_IfStmt")
simpleALEnv_EqualityTest = Class(name="simpleALEnv_EqualityTest")
simpleALEnv_RandRange = Class(name="simpleALEnv_RandRange")
simpleALEnv_Arith = Class(name="simpleALEnv_Arith", is_abstract=True)
simpleALEnv_ALVarRef = Class(name="simpleALEnv_ALVarRef")
Arith = Class(name="Arith")
simpleALEnv_ArithLit = Class(name="simpleALEnv_ArithLit")
simpleALEnv_ArithOp = Class(name="simpleALEnv_ArithOp", is_abstract=True)
...
domain_model = DomainModel(
    name="simpleALEnv",
    types={simpleALEnv_Block, simpleALEnv_Stmt, simpleALEnv_ArithPlus, ArithOp, simpleALEnv_ArithMinus, simpleALEnv_Print, Stmt, simpleALEnv_Assign, simpleALEnv_IfStmt, simpleALEnv_EqualityTest, simpleALEnv_RandRange, simpleALEnv_Arith, simpleALEnv_ALVarRef, Arith, simpleALEnv_ArithLit, simpleALEnv_ArithOp},
    associations={stmts0, val5, ifBranch7, elseBranch9, test12, lhs14, rhs17, lhs1, rhs2},
    generalizations={gen_simpleALEnv_ArithPlus_ArithOp, gen_simpleALEnv_ArithMinus_ArithOp, gen_simpleALEnv_Print_Stmt, gen_simpleALEnv_Assign_Stmt, gen_simpleALEnv_IfStmt_Stmt, gen_simpleALEnv_RandRange_Arith, gen_simpleALEnv_ALVarRef_Arith, gen_simpleALEnv_ArithLit_Arith, gen_simpleALEnv_ArithOp_Arith},
    metadata=None
)
