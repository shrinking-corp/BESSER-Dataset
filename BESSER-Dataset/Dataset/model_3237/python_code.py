...
class UppaalFlat11_NameType:
    ...
    def __init__(self, y: str, mixed: str, x: str, UppaalFlat11_NameType: "UppaalFlat11_DocumentRoot" = None, UppaalFlat11_NameType32: "UppaalFlat11_LocationType" = None, UppaalFlat11_NameType47: "UppaalFlat11_TemplateType" = None):
        self.y = y
        self.mixed = mixed
        self.x = x
...
class UppaalFlat11_LabelType:
    ...
    def __init__(self, mixed: str, kind: str, x: str, y: str, UppaalFlat11_LabelType: "UppaalFlat11_DocumentRoot" = None, UppaalFlat11_LabelType35: "UppaalFlat11_LocationType" = None, UppaalFlat11_LabelType68: "UppaalFlat11_TransitionType" = None):
        self.mixed = mixed
        self.kind = kind
        self.x = x
        self.y = y
