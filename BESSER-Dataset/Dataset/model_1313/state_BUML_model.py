...
domain_model = DomainModel(
    name="state",
    types={state_Behaviour, state_Vertex, state_StateMachine, state_Transition, state_NamedElement, state_State, Vertex, NamedElement, state_Region, state_Trigger, state_FinalState, State, state_OpaqueExpression, state_Event, state_StateModel, state_PseudoState, state_Constraint, TransitionKind, PseudoStateKind},
    associations={doActivity3, entry5, exit8, state11, subVertex14, stateMachine16, transition18, region20, region0, defferableTrigger1, guard32, effect34, specification37, event39, packagedElment41, outgoing23, incoming24, source26, target27, trigger29},
    generalizations={gen_state_Region_NamedElement, gen_state_StateMachine_NamedElement, gen_state_State_Vertex, gen_state_State_NamedElement, gen_state_FinalState_State, gen_state_Trigger_NamedElement, gen_state_PseudoState_Vertex, gen_state_Vertex_NamedElement, gen_state_Transition_NamedElement},
    metadata=None
)
