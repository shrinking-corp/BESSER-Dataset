...
Order.attributes={Order_finalTotal, Order_id, Order_status, Order_shippingAddress}
...
Customer.attributes={Customer_id, Customer_isBan, Customer_emailAddress, Customer_login, Customer_lastname, Customer_firstname, Customer_password}
...
domain_model = DomainModel(
    name="_770fa93c_9879_4383_b903_9c8ea9f9b075",
    types={ShoppingCart, Item, Product, Account, Payment, Order, Customer, OrderStatus},
    associations={association8, association2, association3, association4, association5, association6, association7},
    generalizations={},
    metadata=None
)
