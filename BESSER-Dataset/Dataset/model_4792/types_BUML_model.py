...
domain_model = DomainModel(
    name="types",
    types={types_Library, types_Type, NamedElement, types_Feature, TypedElement, types_Operation, Feature, types_Parameter, types_Property, types_TypedElement, types_Event},
    associations={types0, features1, superTypes3, owningLibrary4, owningType5, parameters7, owningOperation8, type9},
