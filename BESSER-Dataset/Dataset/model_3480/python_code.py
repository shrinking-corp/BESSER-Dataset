...
class feature_Feature:
    ...
    def __init__(self, name: str, minCardinality: int, maxCardinality: int, feature: set["feature_Attribute"] = None, parentFeature: set["feature_Group"] = None, childFeatures: "feature_Group" = None, Feature: "feature_Group" = None, Feature14: "feature_Group" = None, Feature16: "feature_Attribute" = None, feature_Feature: "feature_FeatureModel" = None):
        self.name = name
        self.minCardinality = minCardinality
        self.maxCardinality = maxCardinality
...
class feature_FeatureModel:
    ...
    def __init__(self, name: str, feature_FeatureModel: set["feature_Constraint"] = None, FeatureModel7: "feature_FeatureModel" = None, children: "feature_FeatureModel" = None, feature_FeatureModel2: "feature_Feature" = None, FeatureModel: "feature_FeatureModel" = None, parent: set["feature_FeatureModel"] = None):
        self.name = name
