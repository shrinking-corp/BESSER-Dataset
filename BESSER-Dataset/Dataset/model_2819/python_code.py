...
class dg_Scale(Transform):
    ...
    def nonnegativescale(self, dg_diagnostics, dg_context) :
...
class dg_RadialGradient(Gradient):
    ...
    def validRadius(self, dg_context, dg_diagnostics) :
    ...
    def validCenterPoint(self, dg_context, dg_diagnostics) :
...
class dg_GradientStop:
    ...
    def validOffset(self, dg_context, dg_diagnostics) :
        # TODO: Implement validOffset method
        pass

    def validOpacity(self, dg_diagnostics, dg_context) :
...
class dg_Paint:
    ...
    def __init__(self, color: str, dg_Paint13: "dg_Style" = None, dg_Paint15: "dg_PaintServer" = None, dg_Paint: "dg_Style" = None):
        self.color = color
    ...
    def referencedPaintServerHasId(self, dg_context, dg_diagnostics) :
...
class dg_Definition(ABC):
    ...
    def idCannotBeEmpty(self, dg_context, dg_diagnostics) :
...
class dg_Style:
    ...
    def __init__(self, fillOpacity: str, strokeWidth: str, strokeOpacity: str, strokeDashLength: str, fontSize: str, fontName: str, fontItalic: str, fontBold: str, fontDecoration: str, dg_Style: "dg_GraphicalElement" = None, dg_Style12: "dg_Paint" = None, dg_Style10: "dg_Paint" = None, dg_Style38: "dg_StyleRule" = None):
    ...
    def validFillOpacity(self, dg_context, dg_diagnostics) :
    ...
    def validFontSize(self, dg_diagnostics, dg_context) :
...
class dg_Text(GraphicalElement):
    ...
    def dataCannotBeEmpty(self, dg_context, dg_diagnostics) :
...
class dg_Canvas(Group):
    ...
    def canvasCannotHaveTransforms(self, dg_context, dg_diagnostics) :
