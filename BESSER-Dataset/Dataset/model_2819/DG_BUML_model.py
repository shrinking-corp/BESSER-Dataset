...
dg_Canvas_m_canvasCannotHaveTransforms: Method = Method(name="canvasCannotHaveTransforms", parameters={Parameter(name='dg_context', type=StringType), Parameter(name='dg_diagnostics', type=StringType)}, type=BooleanType)
...
dg_Style_m_validFontSize: Method = Method(name="validFontSize", parameters={Parameter(name='dg_context', type=StringType), Parameter(name='dg_diagnostics', type=StringType)}, type=BooleanType)
...
dg_Style_m_validStrokeWidth: Method = Method(name="validStrokeWidth", parameters={Parameter(name='dg_diagnostics', type=StringType), Parameter(name='dg_context', type=StringType)}, type=BooleanType)
...
dg_Style_m_validStrokeOpacity: Method = Method(name="validStrokeOpacity", parameters={Parameter(name='dg_context', type=StringType), Parameter(name='dg_diagnostics', type=StringType)}, type=BooleanType)
dg_Style.attributes={dg_Style_strokeOpacity, dg_Style_fontName, dg_Style_strokeWidth, dg_Style_fontDecoration, dg_Style_fontBold, dg_Style_fillOpacity, dg_Style_fontSize, dg_Style_strokeDashLength, dg_Style_fontItalic}
dg_Style.methods={dg_Style_m_validStrokeOpacity, dg_Style_m_validStrokeWidth, dg_Style_m_validDashLengthSize, dg_Style_m_validFillOpacity, dg_Style_m_validFontSize}
...
dg_Paint_m_referencedPaintServerHasId: Method = Method(name="referencedPaintServerHasId", parameters={Parameter(name='dg_context', type=StringType), Parameter(name='dg_diagnostics', type=StringType)}, type=BooleanType)
...
dg_StyleSelector.attributes={dg_StyleSelector_kind, dg_StyleSelector_class_}

# dg_Circle class attributes and methods
dg_Circle_radius: Property = Property(name="radius", type=StringType)
dg_Circle_m_nonNegativeRadius: Method = Method(name="nonNegativeRadius", parameters={Parameter(name='dg_context', type=StringType), Parameter(name='dg_diagnostics', type=StringType)}, type=BooleanType)
...
dg_GradientStop.attributes={dg_GradientStop_opacity, dg_GradientStop_color, dg_GradientStop_offset}
...
dg_MarkedElement_m_referencedStartMarkerHasId: Method = Method(name="referencedStartMarkerHasId", parameters={Parameter(name='dg_context', type=StringType), Parameter(name='dg_diagnostics', type=StringType)}, type=BooleanType)
...
dg_MarkedElement_m_referencedEndMarkerHasId: Method = Method(name="referencedEndMarkerHasId", parameters={Parameter(name='dg_diagnostics', type=StringType), Parameter(name='dg_context', type=StringType)}, type=BooleanType)
...
dg_Matrix.attributes={dg_Matrix_f, dg_Matrix_d, dg_Matrix_e, dg_Matrix_a, dg_Matrix_b, dg_Matrix_c}

# Transform class attributes and methods

# dg_Path class attributes and methods
dg_Path_m_firstCommandMustBeMove: Method = Method(name="firstCommandMustBeMove", parameters={Parameter(name='dg_diagnostics', type=StringType), Parameter(name='dg_context', type=StringType)}, type=BooleanType)
...
dg_RadialGradient_m_validCenterPoint: Method = Method(name="validCenterPoint", parameters={Parameter(name='dg_context', type=StringType), Parameter(name='dg_diagnostics', type=StringType)}, type=BooleanType)
dg_RadialGradient_m_validRadius: Method = Method(name="validRadius", parameters={Parameter(name='dg_diagnostics', type=StringType), Parameter(name='dg_context', type=StringType)}, type=BooleanType)
...
dg_Rectangle_m_nonNegativeCornerRadius: Method = Method(name="nonNegativeCornerRadius", parameters={Parameter(name='dg_context', type=StringType), Parameter(name='dg_diagnostics', type=StringType)}, type=BooleanType)
...
dg_Text_m_dataCannotBeEmpty: Method = Method(name="dataCannotBeEmpty", parameters={Parameter(name='dg_diagnostics', type=StringType), Parameter(name='dg_context', type=StringType)}, type=BooleanType)
...
domain_model = DomainModel(
    name="dg",
    types={dg_Canvas, Group, dg_Bounds, dg_Group, GraphicalElement, dg_GraphicalElement, dg_ClipPath, dg_Style, dg_Transform, dg_Definition, dg_MoveTo, PathCommand, dg_Point, dg_PathCommand, Definition, dg_Paint, dg_PaintServer, dg_ClosePath, dg_CubicCurveTo, dg_Definitions, dg_StyleSheet, dg_StyleRule, dg_StyleSelector, dg_Circle, dg_Ellipse, dg_Dimension, dg_EllipticalArcTo, dg_QuadraticCurveTo, dg_Gradient, PaintServer, dg_GradientStop, dg_Image, dg_Line, MarkedElement, dg_MarkedElement, dg_Marker, dg_LinearGradient, Gradient, dg_LineTo, dg_Matrix, Transform, dg_Path, dg_Pattern, dg_Polygon, dg_Polyline, dg_RadialGradient, dg_Rectangle, dg_RootCanvas, Canvas, dg_Scale, dg_Skew, dg_Text, dg_Rotate, dg_Use, dg_Translate, FontDecoration, ElementKind, TextAnchor},
    associations={bounds0, member1, clipPath2, group3, style4, transform6, point8, stroke11, paintServer14, transform16, fill9, center19, startControl21, endControl23, point26, definition29, styleSheet30, rule32, selector34, style36, center39, radii41, radii43, point45, control48, point50, stop53, bounds54, start56, endMarker61, midMarker62, startMarker65, size68, reference71, end58, start74, end76, point79, command81, tile84, point87, point89, bounds82, center91, focus93, bounds96, definitions98, externalStyleSheet100, center103, bounds105, bounds107, referencedElement109},
    generalizations={gen_dg_Canvas_Group, gen_dg_Group_GraphicalElement, gen_dg_MoveTo_PathCommand, gen_dg_GraphicalElement_Definition, gen_dg_ClipPath_Group, gen_dg_PaintServer_Definition, gen_dg_ClosePath_PathCommand, gen_dg_CubicCurveTo_PathCommand, gen_dg_Circle_GraphicalElement, gen_dg_Ellipse_GraphicalElement, gen_dg_EllipticalArcTo_PathCommand, gen_dg_QuadraticCurveTo_PathCommand, gen_dg_Gradient_PaintServer, gen_dg_Image_GraphicalElement, gen_dg_Line_MarkedElement, gen_dg_MarkedElement_GraphicalElement, gen_dg_Marker_Group, gen_dg_LinearGradient_Gradient, gen_dg_LineTo_PathCommand, gen_dg_Matrix_Transform, gen_dg_Path_MarkedElement, gen_dg_Pattern_PaintServer, gen_dg_Polygon_MarkedElement, gen_dg_Polyline_MarkedElement, gen_dg_RadialGradient_Gradient, gen_dg_Rectangle_GraphicalElement, gen_dg_RootCanvas_Canvas, gen_dg_Scale_Transform, gen_dg_Skew_Transform, gen_dg_Text_GraphicalElement, gen_dg_Rotate_Transform, gen_dg_Use_GraphicalElement, gen_dg_Translate_Transform},
    metadata=None
)
