...
class SpecificationElement:
    ...
    pass
class sgraph_State(ScopedElement, ReactiveElement, SpecificationElement, CompositeElement, RegularState):
...
class sgraph_Region(NamedElement):
    ...
    def __init__(self, priority: int, regions: "sgraph_CompositeElement" = None, Region: "sgraph_Vertex" = None, parentRegion: set["sgraph_Vertex"] = None, Region27: "sgraph_CompositeElement" = None):
        self.priority = priority
...
class sgraph_Declaration(NamedElement):
    ...
    pass
class sgraph_Statechart(ScopedElement, ReactiveElement, SpecificationElement, CompositeElement, NamedElement):
