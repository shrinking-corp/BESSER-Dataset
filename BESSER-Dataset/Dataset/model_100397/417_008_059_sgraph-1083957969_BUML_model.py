...
sgraph_State.attributes={sgraph_State_orthogonal, sgraph_State_leaf, sgraph_State_subchart, sgraph_State_composite, sgraph_State_simple, sgraph_State_substatechartId}
...
domain_model = DomainModel(
    name="sgraph",
    types={sgraph_CompositeElement, sgraph_Pseudostate, Vertex, sgraph_Vertex, NamedElement, sgraph_Region, sgraph_Transition, SpecificationElement, Reaction, sgraph_FinalState, RegularState, sgraph_Variable, Declaration, sgraph_Event, sgraph_Choice, Pseudostate, sgraph_Statechart, ReactiveElement, ScopedElement, CompositeElement, sgraph_Entry, sgraph_Trigger, sgraph_Effect, sgraph_SpecificationElement, sgraph_Declaration, sgraph_Reaction, sgraph_ReactiveElement, sgraph_Exit, sgraph_Scope, sgraph_ScopedElement, sgraph_Synchronization, sgraph_State, sgraph_Statement, sgraph_RegularState, EntryKind, ChoiceKind},
    associations={composite5, parentRegion0, incomingTransitions1, outgoingTransitions2, vertices4, trigger10, target6, source8, substatechart25, effect11, reactions13, localReactions15, declarations18, events19, variables21, scopes23, regions26},
