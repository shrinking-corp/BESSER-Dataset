...
class Train5_TrackElement(NamedElement):
    ...
    def __init__(self, State: str, length: str, Train5_TrackElement19: "Train5_RoutePart" = None, Train5_TrackElement: "Train5_Route" = None, Train5_TrackElement7: "Train5_RailwayDiagram" = None):
        self.State = State
        self.length = length
