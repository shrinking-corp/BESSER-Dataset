...
# Classes
Train5_NamedElement = Class(name="Train5_NamedElement", is_abstract=True)
Train5_TrackElement = Class(name="Train5_TrackElement", is_abstract=True)
NamedElement = Class(name="NamedElement")
Train5_Route = Class(name="Train5_Route")
Train5_RoutePart = Class(name="Train5_RoutePart")
Train5_Switch = Class(name="Train5_Switch")
TrackElement = Class(name="TrackElement")
Train5_Segment = Class(name="Train5_Segment")
Train5_Station = Class(name="Train5_Station")
Train5_SensorNetwork = Class(name="Train5_SensorNetwork")
Train5_RailwayDiagram = Class(name="Train5_RailwayDiagram")
...
Train5_Route.attributes={Train5_Route_currentIndex, Train5_Route_leftOver, Train5_Route_speed}
...
domain_model = DomainModel(
    name="Train5",
    types={Train5_NamedElement, Train5_TrackElement, NamedElement, Train5_Route, Train5_RoutePart, Train5_Switch, TrackElement, Train5_Segment, Train5_Station, Train5_SensorNetwork, Train5_RailwayDiagram, Signal},
    associations={next15, element17, previous21, train0, route1, neighbour3, sensors4, trackelements6, sensors8, routes11},
    generalizations={gen_Train5_RoutePart_NamedElement, gen_Train5_TrackElement_NamedElement, gen_Train5_Route_NamedElement, gen_Train5_Switch_TrackElement, gen_Train5_Segment_TrackElement, gen_Train5_Station_TrackElement, gen_Train5_SensorNetwork_NamedElement},
    metadata=None
)
