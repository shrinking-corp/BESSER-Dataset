...
# Classes
SQL2003_evo_ARRAY = Class(name="SQL2003_evo_ARRAY")
CollectionType = Class(name="CollectionType")
SQL2003_evo_Attribute = Class(name="SQL2003_evo_Attribute")
StructuralComponent = Class(name="StructuralComponent")
SQL2003_evo_StructuredType = Class(name="SQL2003_evo_StructuredType")
SQL2003_evo_BooleanType = Class(name="SQL2003_evo_BooleanType")
SQL2003_evo_BaseTable = Class(name="SQL2003_evo_BaseTable")
Table = Class(name="Table")
SQL2003_evo_BehaviouralComponent = Class(name="SQL2003_evo_BehaviouralComponent", is_abstract=True)
SQL2003_evo_Schema = Class(name="SQL2003_evo_Schema")
SQL2003_evo_ParameterWithMode = Class(name="SQL2003_evo_ParameterWithMode")
SQL2003_evo_BinaryStringType = Class(name="SQL2003_evo_BinaryStringType")
PredefinedType = Class(name="PredefinedType")
SQL2003_evo_Table = Class(name="SQL2003_evo_Table", is_abstract=True)
SQL2003_evo_CharacterStringType = Class(name="SQL2003_evo_CharacterStringType")
SQL2003_evo_CollectionType = Class(name="SQL2003_evo_CollectionType", is_abstract=True)
ConstructedType = Class(name="ConstructedType")
SQL2003_evo_DataType = Class(name="SQL2003_evo_DataType", is_abstract=True)
SQL2003_evo_Column = Class(name="SQL2003_evo_Column")
SQL2003_evo_ColumnConstraint = Class(name="SQL2003_evo_ColumnConstraint", is_abstract=True)
Restriction = Class(name="Restriction")
SQL2003_evo_ConstructedType = Class(name="SQL2003_evo_ConstructedType", is_abstract=True)
DataType = Class(name="DataType")
SQL2003_evo_DatetimeFeature = Class(name="SQL2003_evo_DatetimeFeature")
Feature = Class(name="Feature")
SQL2003_evo_DatetimeType = Class(name="SQL2003_evo_DatetimeType")
SQL2003_evo_ROW = Class(name="SQL2003_evo_ROW")
SQL2003_evo_Function = Class(name="SQL2003_evo_Function")
BehaviouralComponent = Class(name="BehaviouralComponent")
SQL2003_evo_DerivedTable = Class(name="SQL2003_evo_DerivedTable")
SQL2003_evo_DistinctType = Class(name="SQL2003_evo_DistinctType")
UserDefinedType = Class(name="UserDefinedType")
SQL2003_evo_PredefinedType = Class(name="SQL2003_evo_PredefinedType", is_abstract=True)
SQL2003_evo_Feature = Class(name="SQL2003_evo_Feature", is_abstract=True)
SQL2003_evo_Field = Class(name="SQL2003_evo_Field")
SQL2003_evo_IntervalType = Class(name="SQL2003_evo_IntervalType")
SQL2003_evo_IntervalFeature = Class(name="SQL2003_evo_IntervalFeature")
SQL2003_evo_Method = Class(name="SQL2003_evo_Method")
SQL2003_evo_MULTISET = Class(name="SQL2003_evo_MULTISET")
SQL2003_evo_MethodParameter = Class(name="SQL2003_evo_MethodParameter")
Parameter_ = Class(name="Parameter")
SQL2003_evo_NotNull = Class(name="SQL2003_evo_NotNull")
ColumnConstraint = Class(name="ColumnConstraint")
SQL2003_evo_NumericType = Class(name="SQL2003_evo_NumericType")
SQL2003_evo_NumericFeature = Class(name="SQL2003_evo_NumericFeature")
SQL2003_evo_Parameter = Class(name="SQL2003_evo_Parameter", is_abstract=True)
SQL2003_evo_PrimaryKey = Class(name="SQL2003_evo_PrimaryKey")
UniqueConstraint = Class(name="UniqueConstraint")
SQL2003_evo_Procedure = Class(name="SQL2003_evo_Procedure")
SQL2003_evo_ReferenceType = Class(name="SQL2003_evo_ReferenceType")
SQL2003_evo_StructuralComponent = Class(name="SQL2003_evo_StructuralComponent", is_abstract=True)
SQL2003_evo_ReferentialConstraint = Class(name="SQL2003_evo_ReferentialConstraint")
TableConstraint = Class(name="TableConstraint")
SQL2003_evo_UniqueConstraint = Class(name="SQL2003_evo_UniqueConstraint")
SQL2003_evo_Restriction = Class(name="SQL2003_evo_Restriction", is_abstract=True)
SQL2003_evo_StringFeature = Class(name="SQL2003_evo_StringFeature")
SQL2003_evo_View = Class(name="SQL2003_evo_View")
SQL2003_evo_TableCheckConstraint = Class(name="SQL2003_evo_TableCheckConstraint")
SQL2003_evo_TypedTable = Class(name="SQL2003_evo_TypedTable")
SQL2003_evo_TableConstraint = Class(name="SQL2003_evo_TableConstraint", is_abstract=True)
SQL2003_evo_Trigger = Class(name="SQL2003_evo_Trigger")
SQL2003_evo_TriggerDescriptor = Class(name="SQL2003_evo_TriggerDescriptor")
BaseTable = Class(name="BaseTable")
SQL2003_evo_XMLType = Class(name="SQL2003_evo_XMLType")
SQL2003_evo_UserDefinedType = Class(name="SQL2003_evo_UserDefinedType", is_abstract=True)
...
SQL2003_evo_StructuredType.attributes={SQL2003_evo_StructuredType_is_instantiable, SQL2003_evo_StructuredType_is_final}
...
SQL2003_evo_BehaviouralComponent.attributes={SQL2003_evo_BehaviouralComponent_name, SQL2003_evo_BehaviouralComponent_body}
...
SQL2003_evo_DatetimeFeature.attributes={SQL2003_evo_DatetimeFeature_key, SQL2003_evo_DatetimeFeature_value}
...
SQL2003_evo_IntervalFeature.attributes={SQL2003_evo_IntervalFeature_key, SQL2003_evo_IntervalFeature_value}
...
SQL2003_evo_NumericFeature.attributes={SQL2003_evo_NumericFeature_value, SQL2003_evo_NumericFeature_key}
...
SQL2003_evo_ReferentialConstraint.attributes={SQL2003_evo_ReferentialConstraint_match, SQL2003_evo_ReferentialConstraint_update_action, SQL2003_evo_ReferentialConstraint_delete_action}
...
SQL2003_evo_StringFeature.attributes={SQL2003_evo_StringFeature_key, SQL2003_evo_StringFeature_value}
...
SQL2003_evo_TriggerDescriptor.attributes={SQL2003_evo_TriggerDescriptor_level, SQL2003_evo_TriggerDescriptor_event, SQL2003_evo_TriggerDescriptor_actionTime, SQL2003_evo_TriggerDescriptor_triggeredAction}
...
domain_model = DomainModel(
    name="SQL2003_evo",
    types={SQL2003_evo_ARRAY, CollectionType, SQL2003_evo_Attribute, StructuralComponent, SQL2003_evo_StructuredType, SQL2003_evo_BooleanType, SQL2003_evo_BaseTable, Table, SQL2003_evo_BehaviouralComponent, SQL2003_evo_Schema, SQL2003_evo_ParameterWithMode, SQL2003_evo_BinaryStringType, PredefinedType, SQL2003_evo_Table, SQL2003_evo_CharacterStringType, SQL2003_evo_CollectionType, ConstructedType, SQL2003_evo_DataType, SQL2003_evo_Column, SQL2003_evo_ColumnConstraint, Restriction, SQL2003_evo_ConstructedType, DataType, SQL2003_evo_DatetimeFeature, Feature, SQL2003_evo_DatetimeType, SQL2003_evo_ROW, SQL2003_evo_Function, BehaviouralComponent, SQL2003_evo_DerivedTable, SQL2003_evo_DistinctType, UserDefinedType, SQL2003_evo_PredefinedType, SQL2003_evo_Feature, SQL2003_evo_Field, SQL2003_evo_IntervalType, SQL2003_evo_IntervalFeature, SQL2003_evo_Method, SQL2003_evo_MULTISET, SQL2003_evo_MethodParameter, Parameter_, SQL2003_evo_NotNull, ColumnConstraint, SQL2003_evo_NumericType, SQL2003_evo_NumericFeature, SQL2003_evo_Parameter, SQL2003_evo_PrimaryKey, UniqueConstraint, SQL2003_evo_Procedure, SQL2003_evo_ReferenceType, SQL2003_evo_StructuralComponent, SQL2003_evo_ReferentialConstraint, TableConstraint, SQL2003_evo_UniqueConstraint, SQL2003_evo_Restriction, SQL2003_evo_StringFeature, SQL2003_evo_View, SQL2003_evo_TableCheckConstraint, SQL2003_evo_TypedTable, SQL2003_evo_TableConstraint, SQL2003_evo_Trigger, SQL2003_evo_TriggerDescriptor, BaseTable, SQL2003_evo_XMLType, SQL2003_evo_UserDefinedType, DerivedTable, BooleanTypes, BinaryStringTypes, CharacterStringTypes, DatetimeTypes, DatetimeFeatures, IntervalTypes, IntervalFeatures, MatchTypes, Multiplier, NumericRadix, NumericTypes, NumericFeatures, ParameterMode, ReferentialAction, StringFeatures, TriggerActionTime, TriggerEvent, TriggerLevel, XMLTypes, Unit},
    associations={structured0, schema1, parametersWithMode2, table7, super_type4, type5, schema8, row12, return_type13, source_type10, features11, override16, structured17, return_type19, parameters22, method23, type24, type35, is_source_of27, super_type29, fields31, sub_types33, behaviouralComponent26, columns39, references36, table37, behaviouralComponents41, datatypes43, tables45, super_type57, attributes59, type48, views50, restrictions51, features53, views68, restrictions71, methods60, typed63, schema65, columns67, updateColumns75, description74, structured78, supertable81, subtables84, trigger77, tables86, components88},
    generalizations={gen_SQL2003_evo_ARRAY_CollectionType, gen_SQL2003_evo_Attribute_StructuralComponent, gen_SQL2003_evo_BooleanType_PredefinedType, gen_SQL2003_evo_BaseTable_Table, gen_SQL2003_evo_BinaryStringType_PredefinedType, gen_SQL2003_evo_CharacterStringType_PredefinedType, gen_SQL2003_evo_CollectionType_ConstructedType, gen_SQL2003_evo_Column_StructuralComponent, gen_SQL2003_evo_ColumnConstraint_Restriction, gen_SQL2003_evo_ConstructedType_DataType, gen_SQL2003_evo_DatetimeFeature_Feature, gen_SQL2003_evo_DatetimeType_PredefinedType, gen_SQL2003_evo_Function_BehaviouralComponent, gen_SQL2003_evo_DerivedTable_Table, gen_SQL2003_evo_DistinctType_UserDefinedType, gen_SQL2003_evo_Field_StructuralComponent, gen_SQL2003_evo_IntervalType_PredefinedType, gen_SQL2003_evo_IntervalFeature_Feature, gen_SQL2003_evo_MULTISET_CollectionType, gen_SQL2003_evo_MethodParameter_Parameter, gen_SQL2003_evo_NotNull_ColumnConstraint, gen_SQL2003_evo_NumericType_PredefinedType, gen_SQL2003_evo_NumericFeature_Feature, gen_SQL2003_evo_ParameterWithMode_Parameter, gen_SQL2003_evo_PrimaryKey_UniqueConstraint, gen_SQL2003_evo_Procedure_BehaviouralComponent, gen_SQL2003_evo_ROW_ConstructedType, gen_SQL2003_evo_ReferenceType_ConstructedType, gen_SQL2003_evo_PredefinedType_DataType, gen_SQL2003_evo_ReferentialConstraint_TableConstraint, gen_SQL2003_evo_StringFeature_Feature, gen_SQL2003_evo_StructuredType_UserDefinedType, gen_SQL2003_evo_TableCheckConstraint_TableConstraint, gen_SQL2003_evo_TableConstraint_Restriction, gen_SQL2003_evo_Trigger_Restriction, gen_SQL2003_evo_TypedTable_BaseTable, gen_SQL2003_evo_XMLType_PredefinedType, gen_SQL2003_evo_UniqueConstraint_TableConstraint, gen_SQL2003_evo_UserDefinedType_DataType, gen_SQL2003_evo_View_DerivedTable},
    metadata=None
)
