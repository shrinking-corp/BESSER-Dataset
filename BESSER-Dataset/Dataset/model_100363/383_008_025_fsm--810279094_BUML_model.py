...
domain_model = DomainModel(
    name="fsm",
    types={fsm_FSM, fsm_InitialState, SuperState, fsm_Action, fsm_eAction, fsm_SteadyState, State, fsm_TransientState, fsm_State, fsm_SuperState, fsm_Transition},
    associations={intialState1, entry3, exit5, state0, target7, source9, src11, outTrans12},
