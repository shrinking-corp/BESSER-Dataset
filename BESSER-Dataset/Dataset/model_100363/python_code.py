...
class fsm_Transition:
    ...
    def __init__(self, guard: str, action: str, fsm_Transition: "fsm_State" = None, fsm_Transition10: "fsm_SuperState" = None, outTrans: "fsm_SuperState" = None, Transition: "fsm_SuperState" = None):
        self.guard = guard
        self.action = action
