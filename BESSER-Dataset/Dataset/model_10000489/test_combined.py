...
def test_hyp_staff_id_usecase_is_not_abstract():
    assert not inspect.isabstract(Staff_ID_UseCase)


def test_hyp_staff_id_usecase_constructor_exists():
    assert callable(Staff_ID_UseCase.__init__)


def test_hyp_staff_id_usecase_constructor_args():
    sig = inspect.signature(Staff_ID_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_service_provided_usecase_is_not_abstract():
    assert not inspect.isabstract(Service_Provided_UseCase)


def test_hyp_service_provided_usecase_constructor_exists():
    assert callable(Service_Provided_UseCase.__init__)


def test_hyp_service_provided_usecase_constructor_args():
    sig = inspect.signature(Service_Provided_UseCase.__init__)
    params = list(sig.parameters.keys())
...
def test_hyp_service_provided_by_actor_is_not_abstract():
    assert not inspect.isabstract(Service_Provided_By_Actor)


def test_hyp_service_provided_by_actor_constructor_exists():
    assert callable(Service_Provided_By_Actor.__init__)


def test_hyp_service_provided_by_actor_constructor_args():
    sig = inspect.signature(Service_Provided_By_Actor.__init__)
    params = list(sig.parameters.keys())
...
Staff_ID_UseCase_strategy = st.builds(
    Staff_ID_UseCase,
)
Service_Provided_UseCase_strategy = st.builds(
    Service_Provided_UseCase,
)
...
Service_Provided_By_Actor_strategy = st.builds(
    Service_Provided_By_Actor,
)
