...
def test_staff_id_usecase_is_not_abstract():
    assert not inspect.isabstract(Staff_ID_UseCase)


def test_staff_id_usecase_constructor_exists():
    assert callable(Staff_ID_UseCase.__init__)


def test_staff_id_usecase_constructor_args():
    sig = inspect.signature(Staff_ID_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_service_provided_usecase_is_not_abstract():
    assert not inspect.isabstract(Service_Provided_UseCase)


def test_service_provided_usecase_constructor_exists():
    assert callable(Service_Provided_UseCase.__init__)


def test_service_provided_usecase_constructor_args():
...
def test_service_provided_by_actor_is_not_abstract():
    assert not inspect.isabstract(Service_Provided_By_Actor)


def test_service_provided_by_actor_constructor_exists():
    assert callable(Service_Provided_By_Actor.__init__)


def test_service_provided_by_actor_constructor_args():
