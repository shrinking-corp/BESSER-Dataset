...
# Classes
jointPackage_JointMM = Class(name="jointPackage_JointMM")
SrcMasterThesis = Class(name="SrcMasterThesis")
TrgDocBook = Class(name="TrgDocBook")
jointPackage_SrcBibTeXFile = Class(name="jointPackage_SrcBibTeXFile")
SrcBibTeXEntry = Class(name="SrcBibTeXEntry")
jointPackage_SrcArticle = Class(name="jointPackage_SrcArticle")
...
jointPackage_SrcInCollection = Class(name="jointPackage_SrcInCollection")
SrcBook = Class(name="SrcBook")
jointPackage_SrcInBook = Class(name="jointPackage_SrcInBook")
jointPackage_SrcPhDThesis = Class(name="jointPackage_SrcPhDThesis")
SrcThesisEntry = Class(name="SrcThesisEntry")
jointPackage_SrcMasterThesis = Class(name="jointPackage_SrcMasterThesis")
jointPackage_SrcAuthor = Class(name="jointPackage_SrcAuthor")
jointPackage_SrcBibTeXEntry = Class(name="jointPackage_SrcBibTeXEntry", is_abstract=True)
jointPackage_SrcAuthoredEntry = Class(name="jointPackage_SrcAuthoredEntry", is_abstract=True)
SrcAuthor = Class(name="SrcAuthor")
jointPackage_SrcDatedEntry = Class(name="jointPackage_SrcDatedEntry", is_abstract=True)
jointPackage_SrcTitledEntry = Class(name="jointPackage_SrcTitledEntry", is_abstract=True)
jointPackage_SrcBookTitledEntry = Class(name="jointPackage_SrcBookTitledEntry", is_abstract=True)
jointPackage_SrcMisc = Class(name="jointPackage_SrcMisc")
jointPackage_SrcTechReport = Class(name="jointPackage_SrcTechReport")
jointPackage_SrcUnpublished = Class(name="jointPackage_SrcUnpublished")
jointPackage_SrcManual = Class(name="jointPackage_SrcManual")
jointPackage_SrcProceedings = Class(name="jointPackage_SrcProceedings")
jointPackage_SrcInProceedings = Class(name="jointPackage_SrcInProceedings")
SrcProceedings = Class(name="SrcProceedings")
SrcBookTitledEntry = Class(name="SrcBookTitledEntry")
jointPackage_SrcBooklet = Class(name="jointPackage_SrcBooklet")
jointPackage_SrcBook = Class(name="jointPackage_SrcBook")
jointPackage_TrgSection = Class(name="jointPackage_TrgSection", is_abstract=True)
TrgPara = Class(name="TrgPara")
jointPackage_TrgSect1 = Class(name="jointPackage_TrgSect1")
TrgSection = Class(name="TrgSection")
TrgSect2 = Class(name="TrgSect2")
jointPackage_TrgSect2 = Class(name="jointPackage_TrgSect2")
jointPackage_TrgPara = Class(name="jointPackage_TrgPara")
jointPackage_SrcThesisEntry = Class(name="jointPackage_SrcThesisEntry", is_abstract=True)
jointPackage_TrgDocBook = Class(name="jointPackage_TrgDocBook")
TrgBook = Class(name="TrgBook")
jointPackage_TrgBook = Class(name="jointPackage_TrgBook")
TrgArticle = Class(name="TrgArticle")
jointPackage_TrgTitledElement = Class(name="jointPackage_TrgTitledElement", is_abstract=True)
jointPackage_TrgArticle = Class(name="jointPackage_TrgArticle")
...
paras8: BinaryAssociation = BinaryAssociation(
    name="paras8",
    ends={
        Property(name="TrgPara", type=jointPackage_TrgSection, multiplicity=Multiplicity(1, 1)),
...
section10: BinaryAssociation = BinaryAssociation(
    name="section10",
    ends={
        Property(name="TrgSection", type=jointPackage_TrgPara, multiplicity=Multiplicity(1, 1)),
...
domain_model = DomainModel(
    name="jointPackage",
    types={jointPackage_JointMM, SrcMasterThesis, TrgDocBook, jointPackage_SrcBibTeXFile, SrcBibTeXEntry, jointPackage_SrcArticle, SrcAuthoredEntry, SrcDatedEntry, SrcTitledEntry, jointPackage_SrcInCollection, SrcBook, jointPackage_SrcInBook, jointPackage_SrcPhDThesis, SrcThesisEntry, jointPackage_SrcMasterThesis, jointPackage_SrcAuthor, jointPackage_SrcBibTeXEntry, jointPackage_SrcAuthoredEntry, SrcAuthor, jointPackage_SrcDatedEntry, jointPackage_SrcTitledEntry, jointPackage_SrcBookTitledEntry, jointPackage_SrcMisc, jointPackage_SrcTechReport, jointPackage_SrcUnpublished, jointPackage_SrcManual, jointPackage_SrcProceedings, jointPackage_SrcInProceedings, SrcProceedings, SrcBookTitledEntry, jointPackage_SrcBooklet, jointPackage_SrcBook, jointPackage_TrgSection, TrgPara, jointPackage_TrgSect1, TrgSection, TrgSect2, jointPackage_TrgSect2, jointPackage_TrgPara, jointPackage_SrcThesisEntry, jointPackage_TrgDocBook, TrgBook, jointPackage_TrgBook, TrgArticle, jointPackage_TrgTitledElement, jointPackage_TrgArticle, TrgTitledElement, TrgSect1},
    associations={sourceRoot0, targetRoot1, entries3, authors4, sections_17, paras8, sections_29, section10, books5, articles6},
    generalizations={gen_jointPackage_SrcArticle_SrcAuthoredEntry, gen_jointPackage_SrcArticle_SrcDatedEntry, gen_jointPackage_SrcArticle_SrcTitledEntry, gen_jointPackage_SrcBook_SrcTitledEntry, gen_jointPackage_SrcInCollection_SrcBook, gen_jointPackage_SrcInCollection_SrcBookTitledEntry, gen_jointPackage_SrcInBook_SrcBook, gen_jointPackage_SrcPhDThesis_SrcThesisEntry, gen_jointPackage_SrcMasterThesis_SrcThesisEntry, gen_jointPackage_SrcAuthoredEntry_SrcBibTeXEntry, gen_jointPackage_SrcDatedEntry_SrcBibTeXEntry, gen_jointPackage_SrcTitledEntry_SrcBibTeXEntry, gen_jointPackage_SrcBookTitledEntry_SrcBibTeXEntry, gen_jointPackage_SrcTechReport_SrcAuthoredEntry, gen_jointPackage_SrcTechReport_SrcDatedEntry, gen_jointPackage_SrcTechReport_SrcTitledEntry, gen_jointPackage_SrcUnpublished_SrcAuthoredEntry, gen_jointPackage_SrcUnpublished_SrcTitledEntry, gen_jointPackage_SrcManual_SrcTitledEntry, gen_jointPackage_SrcProceedings_SrcDatedEntry, gen_jointPackage_SrcProceedings_SrcTitledEntry, gen_jointPackage_SrcInProceedings_SrcProceedings, gen_jointPackage_SrcInProceedings_SrcAuthoredEntry, gen_jointPackage_SrcInProceedings_SrcBookTitledEntry, gen_jointPackage_SrcBooklet_SrcDatedEntry, gen_jointPackage_SrcBook_SrcAuthoredEntry, gen_jointPackage_SrcBook_SrcDatedEntry, gen_jointPackage_TrgSection_TrgTitledElement, gen_jointPackage_TrgSect1_TrgSection, gen_jointPackage_TrgSect2_TrgSection, gen_jointPackage_SrcMisc_SrcBibTeXEntry, gen_jointPackage_SrcThesisEntry_SrcAuthoredEntry, gen_jointPackage_SrcThesisEntry_SrcDatedEntry, gen_jointPackage_SrcThesisEntry_SrcTitledEntry, gen_jointPackage_TrgArticle_TrgTitledElement},
    metadata=None
)
