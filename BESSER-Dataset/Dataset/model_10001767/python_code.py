...
class ShoppingCart:
    ...
    def __init__(self, cartId: int, productId: int, quantity: int, dateAdded: int, ShoppingCart_cartitem_02: "cartitem" = None, ShoppingCart_coustomer_00: "coustomer" = None):
        self.cartId = cartId
        self.productId = productId
        self.quantity = quantity
...
class coustomer:
    ...
    def __init__(self, customerId: int, name: str, address: str, email: str, phoneno: int, shippinginfo: str, coustomer_order_08: set["order"] = None, ShoppingCart_coustomer_11: "ShoppingCart" = None):
        self.customerId = customerId
        self.name = name
