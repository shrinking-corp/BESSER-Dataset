...
user.attributes={user_UserId, user_email, user_loginstatus, user_password}
...
coustomer.attributes={coustomer_customerId, coustomer_phoneno, coustomer_email, coustomer_shippinginfo, coustomer_address, coustomer_name}
...
cartitem.attributes={cartitem_subtotal, cartitem_unitcost, cartitem_quantity, cartitem_productId}
...
product.attributes={product_image, product_productId, product_description, product_price, product_name}
...
orderDetail.attributes={orderDetail_productname, orderDetail_quantity, orderDetail_subtotall, orderDetail_unitcost, orderDetail_productid, orderDetail_orderId}
...
order.attributes={order_customerid, order_shippingid, order_datecreated, order_name, order_orderId}
...
domain_model = DomainModel(
    name="_UFLu4IP1EeqWAK1R3DAmBw",
    types={user, coustomer, ShoppingCart, cartitem, product, orderDetail, order, shippinginfo},
    associations={ShoppingCart_cartitem, cartitem_ProLocal, orderDetail_ProLocal, coustomer_order, order_orderDetail, order_shippinginfo, ShoppingCart_coustomer},
    generalizations={},
    metadata=None
)
