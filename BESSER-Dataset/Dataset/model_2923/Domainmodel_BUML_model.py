...
domain_model = DomainModel(
    name="domainmodel",
    types={domainmodel_PackageDeclaration, AbstractElement, domainmodel_Domainmodel, domainmodel_AbstractElement, domainmodel_Import, domainmodel_Type, domainmodel_DataType, Type, domainmodel_Entity, domainmodel_Feature},
