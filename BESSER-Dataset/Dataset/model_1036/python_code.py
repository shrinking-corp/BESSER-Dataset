...
class fsm_ArithmeticExpression(Expression):
    ...
    def __init__(self, operator: str, fsm_ArithmeticExpression: "fsm_Expression" = None, fsm_ArithmeticExpression44: "fsm_Expression" = None):
        self.operator = operator
...
class fsm_AbstractState(ABC):
    ...
    def __init__(self, name: str, fsm_AbstractState: "fsm_StateMachine" = None, target: set["fsm_Transition"] = None, source: set["fsm_Transition"] = None, AbstractState: "fsm_Transition" = None, AbstractState17: "fsm_Transition" = None):
        self.name = name
