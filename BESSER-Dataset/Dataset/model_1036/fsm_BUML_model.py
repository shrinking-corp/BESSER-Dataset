...
domain_model = DomainModel(
    name="fsm",
    types={fsm_StateMachine, fsm_AbstractState, fsm_Transition, fsm_State, AbstractState, fsm_Program, fsm_Statement, fsm_Constraint, fsm_Pseudostate, fsm_FinalState, State, fsm_RelationalConstraint, Constraint, fsm_Expression, Statement, fsm_Conditional, fsm_Trigger, fsm_Loop, fsm_VarDecl, fsm_Literal, Expression, fsm_IntegerLit, Literal, fsm_StringLit, fsm_BoolLit, fsm_ArithmeticExpression, fsm_RelationalExpression, fsm_VarReference, fsm_ConsoleOutput, fsm_Println, ConsoleOutput, fsm_Print, fsm_Assignation, fsm_Wait, PseudostateKind, ArithmeticOperator, RelationalOperator},
    associations={subvertex0, transitions1, incoming3, outgoing4, doActivity6, entry7, exit10, trigger13, target15, source16, effect18, guard20, expression22, statements23, condition26, thenInstructions28, guard34, body36, expression39, left41, right43, left46, right48, elseInstructions31, varRef51, expression53},
