...
# Classes
errorkref_D = Class(name="errorkref_D")
errorkref_L1 = Class(name="errorkref_L1")
B = Class(name="B")
errorkref_B = Class(name="errorkref_B")
errorkref_G = Class(name="errorkref_G")
G = Class(name="G")
errorkref_F = Class(name="errorkref_F")
errorkref_C = Class(name="errorkref_C")
errorkref_A = Class(name="errorkref_A")
errorkref_I = Class(name="errorkref_I")
errorkref_M = Class(name="errorkref_M")
errorkref_N = Class(name="errorkref_N")
errorkref_E = Class(name="errorkref_E")
D = Class(name="D")
errorkref_J = Class(name="errorkref_J")
E = Class(name="E")
errorkref_Q = Class(name="errorkref_Q")
M = Class(name="M")
errorkref_K = Class(name="errorkref_K")
...
is_27: BinaryAssociation = BinaryAssociation(
    name="is_27",
    ends={
...
domain_model = DomainModel(
    name="errorkref",
    types={errorkref_D, errorkref_L1, B, errorkref_B, errorkref_G, G, errorkref_F, errorkref_C, errorkref_A, errorkref_I, errorkref_M, errorkref_N, errorkref_E, D, errorkref_J, E, errorkref_Q, M, errorkref_K},
    associations={ds1, l1s3, bs5, gs7, fs9, as_0, ks19, from_21, to24, is_27, gs11, ns14, js16, qs17},
    generalizations={gen_errorkref_A_B, gen_errorkref_D_G, gen_errorkref_E_D, gen_errorkref_F_E, gen_errorkref_G_M},
    metadata=None
)
