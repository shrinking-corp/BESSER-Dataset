...
class BasicFMmetamodel_Feature:
    ...
    def __init__(self, selected: bool, id: str, name: str, mandatory: bool, BasicFMmetamodel_Feature: "BasicFMmetamodel_FeatureModel" = None, BasicFMmetamodel_Feature3: "BasicFMmetamodel_FeatureModel" = None, Feature: "BasicFMmetamodel_Feature" = None, parent: set["BasicFMmetamodel_Feature"] = None, Feature10: "BasicFMmetamodel_Feature" = None, children: "BasicFMmetamodel_Feature" = None):
...
class BasicFMmetamodel_FeatureModel:
    ...
    def getFeature(self, BasicFMmetamodel_id) :
