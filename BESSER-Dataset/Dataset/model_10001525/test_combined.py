...
@given(instance=Ward_strategy)
def test_hyp_ward_Ward_Type_setter(instance):
...
@given(instance=Bill_strategy)
def test_hyp_bill_Patient_Id_setter(instance):
...
@given(instance=Patient_strategy)
def test_hyp_patient_PhNo__setter(instance):
...
@given(instance=Doctor_strategy)
def test_hyp_doctor_DocId__setter(instance):
