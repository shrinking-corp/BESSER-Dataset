...
# Classes
metaModelStateMachine_StateMachine = Class(name="metaModelStateMachine_StateMachine")
metaModelStateMachine_state = Class(name="metaModelStateMachine_state")
metaModelStateMachine_Transition = Class(name="metaModelStateMachine_Transition")
metaModelStateMachine_Guard = Class(name="metaModelStateMachine_Guard")
metaModelStateMachine_Trigger = Class(name="metaModelStateMachine_Trigger")
...
domain_model = DomainModel(
    ...
    associations={guard22, transition25, state0, transition1, statemachine3, transition6, transition9, target11, source14, statemachine17, trigger20},
    generalizations={},
    metadata=None
)
