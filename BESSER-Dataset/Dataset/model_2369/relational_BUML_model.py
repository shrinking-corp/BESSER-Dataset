...
# Classes
relational_4relational2UML_Database = Class(name="relational_4relational2UML_Database")
ModelElement = Class(name="ModelElement")
relational_4relational2UML_Schema = Class(name="relational_4relational2UML_Schema")
relational_4relational2UML_Column = Class(name="relational_4relational2UML_Column")
relational_4relational2UML_ForeignKey = Class(name="relational_4relational2UML_ForeignKey")
relational_4relational2UML_ModelElement = Class(name="relational_4relational2UML_ModelElement", is_abstract=True)
relational_4relational2UML_Table = Class(name="relational_4relational2UML_Table")
...
relational_4relational2UML_Database.attributes={relational_4relational2UML_Database_url, relational_4relational2UML_Database_name}
...
relational_4relational2UML_Column.attributes={relational_4relational2UML_Column_name, relational_4relational2UML_Column_isUnique, relational_4relational2UML_Column_isPrimaryKey, relational_4relational2UML_Column_type}
...
domain_model = DomainModel(
    ...
    types={relational_4relational2UML_Database, ModelElement, relational_4relational2UML_Schema, relational_4relational2UML_Column, relational_4relational2UML_ForeignKey, relational_4relational2UML_ModelElement, relational_4relational2UML_Table, Type},
    associations={ownedColumns4, ownedForeignKeys6, owner7, foreignTable9, sourceTable11, owner12, ownedSchemas0, ownedTables1, owner3},
    generalizations={gen_relational_4relational2UML_Database_ModelElement, gen_relational_4relational2UML_ForeignKey_ModelElement, gen_relational_4relational2UML_Column_ModelElement, gen_relational_4relational2UML_Schema_ModelElement, gen_relational_4relational2UML_Table_ModelElement},
    metadata=None
)
