...
# Classes
plSql_CompilationUnit = Class(name="plSql_CompilationUnit")
plSql_Procedure = Class(name="plSql_Procedure")
CompilationUnit = Class(name="CompilationUnit")
NameDeclaration = Class(name="NameDeclaration")
plSql_ParameterSequence = Class(name="plSql_ParameterSequence")
plSql_ProcedureInvokerRightsClause = Class(name="plSql_ProcedureInvokerRightsClause")
plSql_ProcedureContent = Class(name="plSql_ProcedureContent")
plSql_Package = Class(name="plSql_Package")
plSql_Item = Class(name="plSql_Item")
plSql_ProcedureDeclaration = Class(name="plSql_ProcedureDeclaration")
Item = Class(name="Item")
plSql_ProcedureDefinition = Class(name="plSql_ProcedureDefinition")
plSql_ParameterValue = Class(name="plSql_ParameterValue")
plSql_Expression = Class(name="plSql_Expression")
plSql_ProcedureImplementation = Class(name="plSql_ProcedureImplementation")
plSql_Function = Class(name="plSql_Function")
plSql_FunctionClause = Class(name="plSql_FunctionClause")
plSql_FunctionContent = Class(name="plSql_FunctionContent")
plSql_ParameterDeclaration = Class(name="plSql_ParameterDeclaration")
plSql_ItemDeclaration = Class(name="plSql_ItemDeclaration")
plSql_ExternalProcedureDeclaration = Class(name="plSql_ExternalProcedureDeclaration")
plSql_VariableDeclaration = Class(name="plSql_VariableDeclaration")
ItemDeclaration = Class(name="ItemDeclaration")
plSql_FunctionInvokerRightsClause = Class(name="plSql_FunctionInvokerRightsClause")
FunctionClause = Class(name="FunctionClause")
plSql_Pragma = Class(name="plSql_Pragma")
plSql_PragmaRestrictReferences = Class(name="plSql_PragmaRestrictReferences")
Pragma = Class(name="Pragma")
plSql_PragmaTimestamp = Class(name="plSql_PragmaTimestamp")
ProcedureContent = Class(name="ProcedureContent")
plSql_DeclareSection = Class(name="plSql_DeclareSection")
plSql_StatementBody = Class(name="plSql_StatementBody")
plSql_FunctionImplementation = Class(name="plSql_FunctionImplementation")
FunctionContent = Class(name="FunctionContent")
plSql_DeterministicClause = Class(name="plSql_DeterministicClause")
plSql_ResultCacheClause = Class(name="plSql_ResultCacheClause")
plSql_PipelinedClause = Class(name="plSql_PipelinedClause")
plSql_Statement = Class(name="plSql_Statement")
plSql_CaseStatement = Class(name="plSql_CaseStatement")
plSql_CaseStatementWhenBranch = Class(name="plSql_CaseStatementWhenBranch")
plSql_VariableValue = Class(name="plSql_VariableValue")
plSql_IntLiteralExpression = Class(name="plSql_IntLiteralExpression")
Expression = Class(name="Expression")
plSql_StringLiteralExpression = Class(name="plSql_StringLiteralExpression")
plSql_BooleanLiteralExpression = Class(name="plSql_BooleanLiteralExpression")
plSql_NullLiteralExpression = Class(name="plSql_NullLiteralExpression")
plSql_VariableRefExpression = Class(name="plSql_VariableRefExpression")
plSql_VariableRef = Class(name="plSql_VariableRef")
plSql_Label = Class(name="plSql_Label")
plSql_AssignmentStatement = Class(name="plSql_AssignmentStatement")
Statement = Class(name="Statement")
plSql_AssignmentTarget = Class(name="plSql_AssignmentTarget")
plSql_VariableAssignmentTarget = Class(name="plSql_VariableAssignmentTarget")
AssignmentTarget = Class(name="AssignmentTarget")
plSql_BlockStatement = Class(name="plSql_BlockStatement")
plSql_GotoStatement = Class(name="plSql_GotoStatement")
plSql_IfStatement = Class(name="plSql_IfStatement")
plSql_CaseStatementElseBranch = Class(name="plSql_CaseStatementElseBranch")
plSql_CloseStatement = Class(name="plSql_CloseStatement")
plSql_ContinueStatement = Class(name="plSql_ContinueStatement")
plSql_ExitStatement = Class(name="plSql_ExitStatement")
plSql_FetchStatement = Class(name="plSql_FetchStatement")
plSql_FetchStatementIntoClause = Class(name="plSql_FetchStatementIntoClause")
plSql_FetchStatementSingleIntoClause = Class(name="plSql_FetchStatementSingleIntoClause")
FetchStatementIntoClause = Class(name="FetchStatementIntoClause")
plSql_FetchStatementBulkIntoClause = Class(name="plSql_FetchStatementBulkIntoClause")
plSql_ReturnStatement = Class(name="plSql_ReturnStatement")
plSql_NullStatement = Class(name="plSql_NullStatement")
plSql_RaiseStatement = Class(name="plSql_RaiseStatement")
plSql_IfStatementElsifBranch = Class(name="plSql_IfStatementElsifBranch")
plSql_IfStatementElseBranch = Class(name="plSql_IfStatementElseBranch")
plSql_LoopStatement = Class(name="plSql_LoopStatement")
plSql_BasicLoopStatement = Class(name="plSql_BasicLoopStatement")
LoopStatement = Class(name="LoopStatement")
plSql_WhileLoopStatement = Class(name="plSql_WhileLoopStatement")
plSql_ForLoopStatement = Class(name="plSql_ForLoopStatement")
plSql_LoopVariableDeclaration = Class(name="plSql_LoopVariableDeclaration")
plSql_QualifiedName = Class(name="plSql_QualifiedName")
plSql_Name = Class(name="plSql_Name")
plSql_NameDeclaration = Class(name="plSql_NameDeclaration")
...
plSql_ParameterDeclaration.attributes={plSql_ParameterDeclaration_behavior, plSql_ParameterDeclaration_dataType}
...
plSql_VariableDeclaration.attributes={plSql_VariableDeclaration_isNotNull, plSql_VariableDeclaration_dataType, plSql_VariableDeclaration_isConstant}
...
domain_model = DomainModel(
    name="plSql",
    types={plSql_CompilationUnit, plSql_Procedure, CompilationUnit, NameDeclaration, plSql_ParameterSequence, plSql_ProcedureInvokerRightsClause, plSql_ProcedureContent, plSql_Package, plSql_Item, plSql_ProcedureDeclaration, Item, plSql_ProcedureDefinition, plSql_ParameterValue, plSql_Expression, plSql_ProcedureImplementation, plSql_Function, plSql_FunctionClause, plSql_FunctionContent, plSql_ParameterDeclaration, plSql_ItemDeclaration, plSql_ExternalProcedureDeclaration, plSql_VariableDeclaration, ItemDeclaration, plSql_FunctionInvokerRightsClause, FunctionClause, plSql_Pragma, plSql_PragmaRestrictReferences, Pragma, plSql_PragmaTimestamp, ProcedureContent, plSql_DeclareSection, plSql_StatementBody, plSql_FunctionImplementation, FunctionContent, plSql_DeterministicClause, plSql_ResultCacheClause, plSql_PipelinedClause, plSql_Statement, plSql_CaseStatement, plSql_CaseStatementWhenBranch, plSql_VariableValue, plSql_IntLiteralExpression, Expression, plSql_StringLiteralExpression, plSql_BooleanLiteralExpression, plSql_NullLiteralExpression, plSql_VariableRefExpression, plSql_VariableRef, plSql_Label, plSql_AssignmentStatement, Statement, plSql_AssignmentTarget, plSql_VariableAssignmentTarget, AssignmentTarget, plSql_BlockStatement, plSql_GotoStatement, plSql_IfStatement, plSql_CaseStatementElseBranch, plSql_CloseStatement, plSql_ContinueStatement, plSql_ExitStatement, plSql_FetchStatement, plSql_FetchStatementIntoClause, plSql_FetchStatementSingleIntoClause, FetchStatementIntoClause, plSql_FetchStatementBulkIntoClause, plSql_ReturnStatement, plSql_NullStatement, plSql_RaiseStatement, plSql_IfStatementElsifBranch, plSql_IfStatementElseBranch, plSql_LoopStatement, plSql_BasicLoopStatement, LoopStatement, plSql_WhileLoopStatement, plSql_ForLoopStatement, plSql_LoopVariableDeclaration, plSql_QualifiedName, plSql_Name, plSql_NameDeclaration, InvokerRight},
    associations={parameters0, invokerRights1, content3, invokerRights5, items7, parameters9, parameters11, value23, expression25, implementation13, parameters15, functionClauses17, content19, parameters21, items38, declareSection27, body29, declareSection31, body33, statements36, body56, expression59, value41, expression42, variable45, labels46, target48, expression49, variable52, declareSection54, limitExpression87, labelName89, expression91, whenBranches61, elseBranch63, expression65, statements68, statements71, cursor74, whenExpression76, whenExpression78, cursor80, intoClause82, targetVariables84, expression120, statements93, elsifBranches96, elseBranch98, expression100, statements103, statements106, statements109, expression111, indexVariable113, lowerBound114, upperBound117, name122, names124, declaration126},
    generalizations={gen_plSql_Procedure_CompilationUnit, gen_plSql_Procedure_NameDeclaration, gen_plSql_Package_CompilationUnit, gen_plSql_Package_NameDeclaration, gen_plSql_ProcedureDeclaration_Item, gen_plSql_ProcedureDefinition_Item, gen_plSql_ProcedureDefinition_NameDeclaration, gen_plSql_Function_CompilationUnit, gen_plSql_Function_NameDeclaration, gen_plSql_ParameterDeclaration_NameDeclaration, gen_plSql_ItemDeclaration_Item, gen_plSql_ExternalProcedureDeclaration_ProcedureContent, gen_plSql_VariableDeclaration_ItemDeclaration, gen_plSql_VariableDeclaration_NameDeclaration, gen_plSql_FunctionInvokerRightsClause_FunctionClause, gen_plSql_Pragma_Item, gen_plSql_PragmaRestrictReferences_Pragma, gen_plSql_PragmaTimestamp_Pragma, gen_plSql_ProcedureImplementation_ProcedureContent, gen_plSql_FunctionImplementation_FunctionContent, gen_plSql_DeterministicClause_FunctionClause, gen_plSql_ResultCacheClause_FunctionClause, gen_plSql_PipelinedClause_FunctionClause, gen_plSql_CaseStatement_Statement, gen_plSql_IntLiteralExpression_Expression, gen_plSql_StringLiteralExpression_Expression, gen_plSql_BooleanLiteralExpression_Expression, gen_plSql_NullLiteralExpression_Expression, gen_plSql_VariableRefExpression_Expression, gen_plSql_AssignmentStatement_Statement, gen_plSql_VariableAssignmentTarget_AssignmentTarget, gen_plSql_BlockStatement_Statement, gen_plSql_GotoStatement_Statement, gen_plSql_IfStatement_Statement, gen_plSql_CloseStatement_Statement, gen_plSql_ContinueStatement_Statement, gen_plSql_ExitStatement_Statement, gen_plSql_FetchStatement_Statement, gen_plSql_FetchStatementSingleIntoClause_FetchStatementIntoClause, gen_plSql_FetchStatementBulkIntoClause_FetchStatementIntoClause, gen_plSql_ReturnStatement_Statement, gen_plSql_NullStatement_Statement, gen_plSql_RaiseStatement_Statement, gen_plSql_LoopStatement_Statement, gen_plSql_BasicLoopStatement_LoopStatement, gen_plSql_WhileLoopStatement_LoopStatement, gen_plSql_ForLoopStatement_LoopStatement, gen_plSql_LoopVariableDeclaration_NameDeclaration},
    metadata=None
)
