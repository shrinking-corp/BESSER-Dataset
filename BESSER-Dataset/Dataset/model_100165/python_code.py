...
class plSql_VariableRef:
    ...
    def __init__(self, isHostRef: bool, plSql_VariableRef: "plSql_VariableRefExpression" = None, plSql_VariableRef53: "plSql_VariableAssignmentTarget" = None, plSql_VariableRef75: "plSql_CloseStatement" = None, plSql_VariableRef81: "plSql_FetchStatement" = None, plSql_VariableRef86: "plSql_FetchStatementIntoClause" = None, plSql_VariableRef123: "plSql_QualifiedName" = None):
...
class plSql_StatementBody:
    ...
    def __init__(self, endName: str, plSql_StatementBody: "plSql_ProcedureImplementation" = None, plSql_StatementBody35: "plSql_FunctionImplementation" = None, plSql_StatementBody37: set["plSql_Statement"] = None, plSql_StatementBody58: "plSql_BlockStatement" = None):
...
class plSql_ParameterDeclaration(NameDeclaration):
    ...
    def __init__(self, dataType: str, behavior: str, plSql_ParameterDeclaration24: "plSql_ParameterValue" = None, plSql_ParameterDeclaration: "plSql_ParameterSequence" = None):
...
class plSql_VariableDeclaration(ItemDeclaration, NameDeclaration):
...
class plSql_ProcedureDefinition(Item, NameDeclaration):
...
class CompilationUnit:
    ...
    pass
class plSql_Function(CompilationUnit, NameDeclaration):

    def __init__(self, schemaName: str, returnType: str, plSql_Function18: set["plSql_FunctionClause"] = None, plSql_Function20: "plSql_FunctionContent" = None, plSql_Function: "plSql_ParameterSequence" = None):
...
class plSql_Package(CompilationUnit, NameDeclaration):
...
class plSql_Procedure(CompilationUnit, NameDeclaration):
