...
class CapellaElement:
    ...
    pass
class capellacommon_GenericTrace(ModelElement, TraceableElement, CapellaElement):
...
class capellacommon_StateEvent(AbstractEvent, NamedElement):
    ...
    pass
class capellacommon_StateTransition(ModelElement, NamedElement, CapellaElement):

    def __init__(self, kind: str, triggerDescription: str, capellacommon_StateTransition28: "capellacommon_AbstractState" = None, capellacommon_StateTransition: "capellacommon_Region" = None, capellacommon_StateTransition31: "capellacommon_AbstractState" = None, capellacommon_StateTransition34: "capellacommon_AbstractEvent" = None, capellacommon_StateTransition37: set["capellacommon_AbstractEvent"] = None, capellacommon_StateTransition41: "capellacommon_StateTransition" = None, capellacommon_StateTransition39: set["capellacommon_StateTransition"] = None, capellacommon_StateTransition26: "capellacommon_Constraint" = None):
        self.kind = kind
