...
# Classes
behaviouralProgramMM_Behaviour = Class(name="behaviouralProgramMM_Behaviour")
behaviouralProgramMM_Function = Class(name="behaviouralProgramMM_Function")
behaviouralProgramMM_Return = Class(name="behaviouralProgramMM_Return")
behaviouralProgramMM_TryCatch = Class(name="behaviouralProgramMM_TryCatch")
behaviouralProgramMM_Statement = Class(name="behaviouralProgramMM_Statement", is_abstract=True)
behaviouralProgramMM_Assignment = Class(name="behaviouralProgramMM_Assignment")
Statement = Class(name="Statement")
behaviouralProgramMM_Expression = Class(name="behaviouralProgramMM_Expression", is_abstract=True)
behaviouralProgramMM_ConditionalBranch = Class(name="behaviouralProgramMM_ConditionalBranch")
behaviouralProgramMM_Loop = Class(name="behaviouralProgramMM_Loop")
behaviouralProgramMM_FunctionCall = Class(name="behaviouralProgramMM_FunctionCall")
Expression = Class(name="Expression")
behaviouralProgramMM_Instantiation = Class(name="behaviouralProgramMM_Instantiation")
behaviouralProgramMM_RaiseException = Class(name="behaviouralProgramMM_RaiseException")
behaviouralProgramMM_ReadLine = Class(name="behaviouralProgramMM_ReadLine")
behaviouralProgramMM_ArithmeticInfixOperator = Class(name="behaviouralProgramMM_ArithmeticInfixOperator", is_abstract=True)
BinaryOperator = Class(name="BinaryOperator")
behaviouralProgramMM_Plus = Class(name="behaviouralProgramMM_Plus")
ArithmeticInfixOperator = Class(name="ArithmeticInfixOperator")
behaviouralProgramMM_FunctionCallStatement = Class(name="behaviouralProgramMM_FunctionCallStatement")
behaviouralProgramMM_ReadLineStatement = Class(name="behaviouralProgramMM_ReadLineStatement")
FunctionCallStatement = Class(name="FunctionCallStatement")
behaviouralProgramMM_WriteLineStatement = Class(name="behaviouralProgramMM_WriteLineStatement")
behaviouralProgramMM_ComparsionOperator = Class(name="behaviouralProgramMM_ComparsionOperator", is_abstract=True)
behaviouralProgramMM_Equals = Class(name="behaviouralProgramMM_Equals")
ComparsionOperator = Class(name="ComparsionOperator")
behaviouralProgramMM_Variable = Class(name="behaviouralProgramMM_Variable")
behaviouralProgramMM_Literal = Class(name="behaviouralProgramMM_Literal")
behaviouralProgramMM_BinaryOperator = Class(name="behaviouralProgramMM_BinaryOperator", is_abstract=True)
...
try_28: BinaryAssociation = BinaryAssociation(
    name="try_28",
    ends={
...
domain_model = DomainModel(
    ...
    types={behaviouralProgramMM_Behaviour, behaviouralProgramMM_Function, behaviouralProgramMM_Return, behaviouralProgramMM_TryCatch, behaviouralProgramMM_Statement, behaviouralProgramMM_Assignment, Statement, behaviouralProgramMM_Expression, behaviouralProgramMM_ConditionalBranch, behaviouralProgramMM_Loop, behaviouralProgramMM_FunctionCall, Expression, behaviouralProgramMM_Instantiation, behaviouralProgramMM_RaiseException, behaviouralProgramMM_ReadLine, behaviouralProgramMM_ArithmeticInfixOperator, BinaryOperator, behaviouralProgramMM_Plus, ArithmeticInfixOperator, behaviouralProgramMM_FunctionCallStatement, behaviouralProgramMM_ReadLineStatement, FunctionCallStatement, behaviouralProgramMM_WriteLineStatement, behaviouralProgramMM_ComparsionOperator, behaviouralProgramMM_Equals, ComparsionOperator, behaviouralProgramMM_Variable, behaviouralProgramMM_Literal, behaviouralProgramMM_BinaryOperator},
    associations={functions0, startfunction1, expression24, functionBody4, assignexpression6, Ifstatements7, elsestatements9, ifexpression12, loopstatements15, loopexpression17, arguments20, InitiationExpression22, catch26, try_28, expression31, arguments33, leftSide35, rightSide37},
    generalizations={gen_behaviouralProgramMM_Return_Statement, gen_behaviouralProgramMM_TryCatch_Statement, gen_behaviouralProgramMM_Assignment_Statement, gen_behaviouralProgramMM_ConditionalBranch_Statement, gen_behaviouralProgramMM_Loop_Statement, gen_behaviouralProgramMM_FunctionCall_Expression, gen_behaviouralProgramMM_Instantiation_Statement, gen_behaviouralProgramMM_RaiseException_Statement, gen_behaviouralProgramMM_ReadLine_Expression, gen_behaviouralProgramMM_ArithmeticInfixOperator_BinaryOperator, gen_behaviouralProgramMM_Plus_ArithmeticInfixOperator, gen_behaviouralProgramMM_FunctionCallStatement_Statement, gen_behaviouralProgramMM_ReadLineStatement_FunctionCallStatement, gen_behaviouralProgramMM_WriteLineStatement_FunctionCallStatement, gen_behaviouralProgramMM_ComparsionOperator_BinaryOperator, gen_behaviouralProgramMM_Equals_ComparsionOperator, gen_behaviouralProgramMM_Variable_Expression, gen_behaviouralProgramMM_Literal_Expression, gen_behaviouralProgramMM_BinaryOperator_Expression},
    metadata=None
)
