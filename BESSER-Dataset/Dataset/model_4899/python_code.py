...
class behaviouralProgramMM_Function:
    ...
    def __init__(self, Name: str, behaviouralProgramMM_Function3: "behaviouralProgramMM_Behaviour" = None, behaviouralProgramMM_Function5: set["behaviouralProgramMM_Statement"] = None, behaviouralProgramMM_Function: "behaviouralProgramMM_Behaviour" = None):
        self.Name = Name
