...
public class epo2_PurchaseOrder  {
    ...
    public epo2_PurchaseOrder(
        String comment,        String status,        String orderDate,        int totalAmount    ) {
    ...
    public epo2_PurchaseOrder(
        String comment,        String status,        String orderDate,        int totalAmount        ArrayList<epo2_Item> epo2_items    ) {
        this.comment = comment;
        this.status = status;
        this.orderDate = orderDate;
        this.totalAmount = totalAmount;
