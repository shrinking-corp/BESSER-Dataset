...
public class epo2_Supplier  {
    ...
    public epo2_Supplier(
        String name        ArrayList<epo2_PurchaseOrder> epo2_purchaseorders,        ArrayList<epo2_PurchaseOrder> epo2_purchaseorders,        ArrayList<epo2_PurchaseOrder> epo2_purchaseorders,        ArrayList<epo2_Customer> epo2_customers    ) {
        this.name = name;
