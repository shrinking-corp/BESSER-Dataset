...
# Classes
hExample_6_LHS_model = Class(name="hExample_6_LHS_model")
hExample_6_LHS_A = Class(name="hExample_6_LHS_A")
hExample_6_LHS_B = Class(name="hExample_6_LHS_B")
hExample_6_LHS_C = Class(name="hExample_6_LHS_C")
