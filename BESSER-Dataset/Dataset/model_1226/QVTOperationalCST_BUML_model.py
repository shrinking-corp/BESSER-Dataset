...
# Classes
qvtoperational_cst_MappingModuleCS = Class(name="qvtoperational_cst_MappingModuleCS")
...
qvtoperational_cst_ModulePropertyCS = Class(name="qvtoperational_cst_ModulePropertyCS", is_abstract=True)
qvtoperational_cst_ConfigPropertyCS = Class(name="qvtoperational_cst_ConfigPropertyCS")
qvtoperational_cst_LocalPropertyCS = Class(name="qvtoperational_cst_LocalPropertyCS")
...
qvtoperational_cst_LibraryCS = Class(name="qvtoperational_cst_LibraryCS")
MappingModuleCS = Class(name="MappingModuleCS")
qvtoperational_cst_ImportCS = Class(name="qvtoperational_cst_ImportCS")
PathNameCS = Class(name="PathNameCS")
qvtoperational_cst_LibraryImportCS = Class(name="qvtoperational_cst_LibraryImportCS")
qvtoperational_cst_RenameCS = Class(name="qvtoperational_cst_RenameCS")
TypeCS = Class(name="TypeCS")
SimpleNameCS = Class(name="SimpleNameCS")
qvtoperational_cst_MultiplicityDefCS = Class(name="qvtoperational_cst_MultiplicityDefCS")
PrimitiveLiteralExpCS = Class(name="PrimitiveLiteralExpCS")
qvtoperational_cst_MappingDeclarationCS = Class(name="qvtoperational_cst_MappingDeclarationCS")
OCLExpressionCS = Class(name="OCLExpressionCS")
qvtoperational_cst_ContextualPropertyCS = Class(name="qvtoperational_cst_ContextualPropertyCS")
ScopedNameCS = Class(name="ScopedNameCS")
qvtoperational_cst_ClassifierDefCS = Class(name="qvtoperational_cst_ClassifierDefCS")
ClassifierPropertyCS = Class(name="ClassifierPropertyCS")
qvtoperational_cst_ClassifierPropertyCS = Class(name="qvtoperational_cst_ClassifierPropertyCS")
...
qvtoperational_cst_IntermediateClassDefCS = Class(name="qvtoperational_cst_IntermediateClassDefCS")
qvtoperational_cst_ExceptionDefCS = Class(name="qvtoperational_cst_ExceptionDefCS")
qvtoperational_cst_OppositePropertyCS = Class(name="qvtoperational_cst_OppositePropertyCS")
MappingDeclarationCS = Class(name="MappingDeclarationCS")
qvtoperational_cst_MappingRuleCS = Class(name="qvtoperational_cst_MappingRuleCS")
MappingSectionsCS = Class(name="MappingSectionsCS")
qvtoperational_cst_MappingQueryCS = Class(name="qvtoperational_cst_MappingQueryCS")
...
qvtoperational_cst_ParameterDeclarationCS = Class(name="qvtoperational_cst_ParameterDeclarationCS")
TypeSpecCS = Class(name="TypeSpecCS")
qvtoperational_cst_SimpleSignatureCS = Class(name="qvtoperational_cst_SimpleSignatureCS")
qvtoperational_cst_CompleteSignatureCS = Class(name="qvtoperational_cst_CompleteSignatureCS")
SimpleSignatureCS = Class(name="SimpleSignatureCS")
qvtoperational_cst_MappingMethodCS = Class(name="qvtoperational_cst_MappingMethodCS", is_abstract=True)
qvtoperational_cst_ImperativeLoopExpCS = Class(name="qvtoperational_cst_ImperativeLoopExpCS")
cst_LoopExpCS = Class(name="cst_LoopExpCS")
cst_StatementCS = Class(name="cst_StatementCS")
qvtoperational_cst_ForExpCS = Class(name="qvtoperational_cst_ForExpCS")
ImperativeLoopExpCS = Class(name="ImperativeLoopExpCS")
qvtoperational_cst_ImperativeIterateExpCS = Class(name="qvtoperational_cst_ImperativeIterateExpCS")
qvtoperational_cst_SwitchExpCS = Class(name="qvtoperational_cst_SwitchExpCS")
SwitchAltExpCS = Class(name="SwitchAltExpCS")
qvtoperational_cst_ConstructorCS = Class(name="qvtoperational_cst_ConstructorCS")
qvtoperational_cst_MappingSectionCS = Class(name="qvtoperational_cst_MappingSectionCS", is_abstract=True)
cst_CSTNode = Class(name="cst_CSTNode")
cst_ElementWithBody = Class(name="cst_ElementWithBody")
MappingRuleCS = Class(name="MappingRuleCS")
qvtoperational_cst_MappingInitCS = Class(name="qvtoperational_cst_MappingInitCS")
MappingSectionCS = Class(name="MappingSectionCS")
qvtoperational_cst_MappingEndCS = Class(name="qvtoperational_cst_MappingEndCS")
qvtoperational_cst_MappingSectionsCS = Class(name="qvtoperational_cst_MappingSectionsCS")
MappingInitCS = Class(name="MappingInitCS")
MappingBodyCS = Class(name="MappingBodyCS")
MappingEndCS = Class(name="MappingEndCS")
qvtoperational_cst_StatementCS = Class(name="qvtoperational_cst_StatementCS", is_abstract=True)
qvtoperational_cst_BlockExpCS = Class(name="qvtoperational_cst_BlockExpCS")
StatementCS = Class(name="StatementCS")
qvtoperational_cst_ComputeExpCS = Class(name="qvtoperational_cst_ComputeExpCS")
VariableCS = Class(name="VariableCS")
qvtoperational_cst_WhileExpCS = Class(name="qvtoperational_cst_WhileExpCS")
qvtoperational_cst_BreakExpCS = Class(name="qvtoperational_cst_BreakExpCS")
qvtoperational_cst_ContinueExpCS = Class(name="qvtoperational_cst_ContinueExpCS")
qvtoperational_cst_ExpressionStatementCS = Class(name="qvtoperational_cst_ExpressionStatementCS")
qvtoperational_cst_SwitchAltExpCS = Class(name="qvtoperational_cst_SwitchAltExpCS")
qvtoperational_cst_VariableInitializationCS = Class(name="qvtoperational_cst_VariableInitializationCS")
qvtoperational_cst_AssignStatementCS = Class(name="qvtoperational_cst_AssignStatementCS")
qvtoperational_cst_ModelTypeCS = Class(name="qvtoperational_cst_ModelTypeCS")
qvtoperational_cst_MappingBodyCS = Class(name="qvtoperational_cst_MappingBodyCS")
qvtoperational_cst_ObjectExpCS = Class(name="qvtoperational_cst_ObjectExpCS")
cst_InstantiationExpCS = Class(name="cst_InstantiationExpCS")
qvtoperational_cst_MappingCallExpCS = Class(name="qvtoperational_cst_MappingCallExpCS")
ImperativeOperationCallExpCS = Class(name="ImperativeOperationCallExpCS")
qvtoperational_cst_ImperativeOperationCallExpCS = Class(name="qvtoperational_cst_ImperativeOperationCallExpCS")
OperationCallExpCS = Class(name="OperationCallExpCS")
qvtoperational_cst_DirectionKindCS = Class(name="qvtoperational_cst_DirectionKindCS")
qvtoperational_cst_ElementWithBody = Class(name="qvtoperational_cst_ElementWithBody", is_abstract=True)
qvtoperational_cst_ResolveExpCS = Class(name="qvtoperational_cst_ResolveExpCS")
CallExpCS = Class(name="CallExpCS")
qvtoperational_cst_ResolveInExpCS = Class(name="qvtoperational_cst_ResolveInExpCS")
ResolveExpCS = Class(name="ResolveExpCS")
qvtoperational_cst_ModuleUsageCS = Class(name="qvtoperational_cst_ModuleUsageCS")
ModuleKindCS = Class(name="ModuleKindCS")
ModuleRefCS = Class(name="ModuleRefCS")
qvtoperational_cst_TransformationRefineCS = Class(name="qvtoperational_cst_TransformationRefineCS")
PackageRefCS = Class(name="PackageRefCS")
qvtoperational_cst_PackageRefCS = Class(name="qvtoperational_cst_PackageRefCS")
qvtoperational_cst_TransformationHeaderCS = Class(name="qvtoperational_cst_TransformationHeaderCS")
ModuleUsageCS = Class(name="ModuleUsageCS")
TransformationRefineCS = Class(name="TransformationRefineCS")
qvtoperational_cst_ModuleKindCS = Class(name="qvtoperational_cst_ModuleKindCS")
qvtoperational_cst_ModuleRefCS = Class(name="qvtoperational_cst_ModuleRefCS")
qvtoperational_cst_InstantiationExpCS = Class(name="qvtoperational_cst_InstantiationExpCS")
qvtoperational_cst_ListTypeCS = Class(name="qvtoperational_cst_ListTypeCS")
qvtoperational_cst_TypeSpecCS = Class(name="qvtoperational_cst_TypeSpecCS")
qvtoperational_cst_LogExpCS = Class(name="qvtoperational_cst_LogExpCS")
qvtoperational_cst_AssertExpCS = Class(name="qvtoperational_cst_AssertExpCS")
LogExpCS = Class(name="LogExpCS")
qvtoperational_cst_ReturnExpCS = Class(name="qvtoperational_cst_ReturnExpCS")
qvtoperational_cst_MappingExtensionCS = Class(name="qvtoperational_cst_MappingExtensionCS")
qvtoperational_cst_ListLiteralExpCS = Class(name="qvtoperational_cst_ListLiteralExpCS")
LiteralExpCS = Class(name="LiteralExpCS")
CollectionLiteralPartCS = Class(name="CollectionLiteralPartCS")
qvtoperational_cst_DictionaryTypeCS = Class(name="qvtoperational_cst_DictionaryTypeCS")
qvtoperational_cst_DictLiteralExpCS = Class(name="qvtoperational_cst_DictLiteralExpCS")
DictLiteralPartCS = Class(name="DictLiteralPartCS")
qvtoperational_cst_DictLiteralPartCS = Class(name="qvtoperational_cst_DictLiteralPartCS")
qvtoperational_cst_TagCS = Class(name="qvtoperational_cst_TagCS")
qvtoperational_cst_UnitCS = Class(name="qvtoperational_cst_UnitCS")
qvtoperational_cst_ResolveOpArgsExpCS = Class(name="qvtoperational_cst_ResolveOpArgsExpCS")
qvtoperational_cst_ScopedNameCS = Class(name="qvtoperational_cst_ScopedNameCS")
qvtoperational_cst_TryExpCS = Class(name="qvtoperational_cst_TryExpCS")
CatchExpCS = Class(name="CatchExpCS")
qvtoperational_cst_CatchExpCS = Class(name="qvtoperational_cst_CatchExpCS")
qvtoperational_cst_RaiseExpCS = Class(name="qvtoperational_cst_RaiseExpCS")
...
qvtoperational_cst_MappingDeclarationCS.attributes={qvtoperational_cst_MappingDeclarationCS_qualifiers, qvtoperational_cst_MappingDeclarationCS_isQuery}
...
qvtoperational_cst_ResolveExpCS.attributes={qvtoperational_cst_ResolveExpCS_isInverse, qvtoperational_cst_ResolveExpCS_one, qvtoperational_cst_ResolveExpCS_isDeferred}
...
domain_model = DomainModel(
    name="qvtoperational",
    types={qvtoperational_cst_MappingModuleCS, CSTNode, TransformationHeaderCS, StringLiteralExpCS, qvtoperational_cst_ModulePropertyCS, qvtoperational_cst_ConfigPropertyCS, qvtoperational_cst_LocalPropertyCS, ImportCS, ModelTypeCS, RenameCS, ModulePropertyCS, MappingMethodCS, ClassifierDefCS, TagCS, qvtoperational_cst_LibraryCS, MappingModuleCS, qvtoperational_cst_ImportCS, PathNameCS, qvtoperational_cst_LibraryImportCS, qvtoperational_cst_RenameCS, TypeCS, SimpleNameCS, qvtoperational_cst_MultiplicityDefCS, PrimitiveLiteralExpCS, qvtoperational_cst_MappingDeclarationCS, OCLExpressionCS, qvtoperational_cst_ContextualPropertyCS, ScopedNameCS, qvtoperational_cst_ClassifierDefCS, ClassifierPropertyCS, qvtoperational_cst_ClassifierPropertyCS, LocalPropertyCS, MultiplicityDefCS, OppositePropertyCS, qvtoperational_cst_IntermediateClassDefCS, qvtoperational_cst_ExceptionDefCS, qvtoperational_cst_OppositePropertyCS, MappingDeclarationCS, qvtoperational_cst_MappingRuleCS, MappingSectionsCS, qvtoperational_cst_MappingQueryCS, BlockExpCS, ParameterDeclarationCS, DirectionKindCS, MappingExtensionCS, qvtoperational_cst_ParameterDeclarationCS, TypeSpecCS, qvtoperational_cst_SimpleSignatureCS, qvtoperational_cst_CompleteSignatureCS, SimpleSignatureCS, qvtoperational_cst_MappingMethodCS, qvtoperational_cst_ImperativeLoopExpCS, cst_LoopExpCS, cst_StatementCS, qvtoperational_cst_ForExpCS, ImperativeLoopExpCS, qvtoperational_cst_ImperativeIterateExpCS, qvtoperational_cst_SwitchExpCS, SwitchAltExpCS, qvtoperational_cst_ConstructorCS, qvtoperational_cst_MappingSectionCS, cst_CSTNode, cst_ElementWithBody, MappingRuleCS, qvtoperational_cst_MappingInitCS, MappingSectionCS, qvtoperational_cst_MappingEndCS, qvtoperational_cst_MappingSectionsCS, MappingInitCS, MappingBodyCS, MappingEndCS, qvtoperational_cst_StatementCS, qvtoperational_cst_BlockExpCS, StatementCS, qvtoperational_cst_ComputeExpCS, VariableCS, qvtoperational_cst_WhileExpCS, qvtoperational_cst_BreakExpCS, qvtoperational_cst_ContinueExpCS, qvtoperational_cst_ExpressionStatementCS, qvtoperational_cst_SwitchAltExpCS, qvtoperational_cst_VariableInitializationCS, qvtoperational_cst_AssignStatementCS, qvtoperational_cst_ModelTypeCS, qvtoperational_cst_MappingBodyCS, qvtoperational_cst_ObjectExpCS, cst_InstantiationExpCS, qvtoperational_cst_MappingCallExpCS, ImperativeOperationCallExpCS, qvtoperational_cst_ImperativeOperationCallExpCS, OperationCallExpCS, qvtoperational_cst_DirectionKindCS, qvtoperational_cst_ElementWithBody, qvtoperational_cst_ResolveExpCS, CallExpCS, qvtoperational_cst_ResolveInExpCS, ResolveExpCS, qvtoperational_cst_ModuleUsageCS, ModuleKindCS, ModuleRefCS, qvtoperational_cst_TransformationRefineCS, PackageRefCS, qvtoperational_cst_PackageRefCS, qvtoperational_cst_TransformationHeaderCS, ModuleUsageCS, TransformationRefineCS, qvtoperational_cst_ModuleKindCS, qvtoperational_cst_ModuleRefCS, qvtoperational_cst_InstantiationExpCS, qvtoperational_cst_ListTypeCS, qvtoperational_cst_TypeSpecCS, qvtoperational_cst_LogExpCS, qvtoperational_cst_AssertExpCS, LogExpCS, qvtoperational_cst_ReturnExpCS, qvtoperational_cst_MappingExtensionCS, qvtoperational_cst_ListLiteralExpCS, LiteralExpCS, CollectionLiteralPartCS, qvtoperational_cst_DictionaryTypeCS, qvtoperational_cst_DictLiteralExpCS, DictLiteralPartCS, qvtoperational_cst_DictLiteralPartCS, qvtoperational_cst_TagCS, qvtoperational_cst_UnitCS, qvtoperational_cst_ResolveOpArgsExpCS, qvtoperational_cst_ScopedNameCS, qvtoperational_cst_TryExpCS, CatchExpCS, qvtoperational_cst_CatchExpCS, qvtoperational_cst_RaiseExpCS, DirectionKindEnum, ImportKindEnum, ModuleKindEnum, QualifierKindCS, MappingExtensionKindCS},
    associations={originalName19, simpleNameCS21, typeCS23, typeCS25, headerCS0, imports1, metamodels3, renamings5, properties7, methods9, classifierDefCS11, tags13, pathNameCS15, typeCS16, simpleNameCS17, lowerBound60, upperBound61, oclExpressionCS27, scopedNameCS29, typeCS30, oclExpressionCS33, simpleNameCS36, extends38, properties41, tags43, stereotypeQualifiers46, featureKeys48, multiplicity51, opposite53, simpleNameCS55, multiplicity57, mappingDeclarationCS88, guards89, posts91, mappingBody94, body96, simpleNameCS64, contextType66, parameters69, result71, directionKindCS74, mappingExtension76, simpleNameCS78, typeSpecCS80, params82, simpleSignature84, resultParams85, condition122, target124, alternativePart126, body97, statements99, mappingRuleCS101, mappingInitCS103, mappingBodyCS104, mappingEndCS106, bodyExpressions108, returnedElement110, body111, body114, condition116, resultVar119, elsePart127, condition130, body132, oclExpressionCS135, simpleNameCS137, typeCS140, inMappingType162, lValueCS143, inMappingName164, oclExpressionCS145, identifierCS167, oclExpressionCS148, complianceKindCS169, simpleNameCS150, expressions152, module155, target157, condition159, parameters193, moduleKindCS196, moduleRefs197, packageRefs172, whereStatements174, pathNameCS177, uriCS179, pathNameCS182, parameters184, moduleUsages187, transformationRefineCS189, pathNameCS191, typeSpecCS222, arguments224, moduleRefCS199, simpleNameCS201, typeCS204, simpleNameCS206, condition209, assertion211, log213, severity215, value218, mappingIdentifiers220, modules249, modelTypes251, imports254, typeCS227, collectionLiteralParts229, key230, value232, parts235, key236, value237, name240, scopedNameCS242, oclExpressionCS245, topLevelElements248, target257, condition259, typeCS262, tryBody264, exceptClauses266, body268, exceptions270, simpleNameCS273, exception276, argument278},
    generalizations={gen_qvtoperational_cst_MappingModuleCS_CSTNode, gen_qvtoperational_cst_ModulePropertyCS_CSTNode, gen_qvtoperational_cst_ConfigPropertyCS_ModulePropertyCS, gen_qvtoperational_cst_LocalPropertyCS_ModulePropertyCS, gen_qvtoperational_cst_LibraryCS_MappingModuleCS, gen_qvtoperational_cst_ImportCS_CSTNode, gen_qvtoperational_cst_LibraryImportCS_ImportCS, gen_qvtoperational_cst_RenameCS_CSTNode, gen_qvtoperational_cst_MultiplicityDefCS_CSTNode, gen_qvtoperational_cst_MappingDeclarationCS_CSTNode, gen_qvtoperational_cst_ContextualPropertyCS_ModulePropertyCS, gen_qvtoperational_cst_ClassifierDefCS_CSTNode, gen_qvtoperational_cst_ClassifierPropertyCS_LocalPropertyCS, gen_qvtoperational_cst_IntermediateClassDefCS_ClassifierDefCS, gen_qvtoperational_cst_ExceptionDefCS_ClassifierDefCS, gen_qvtoperational_cst_OppositePropertyCS_CSTNode, gen_qvtoperational_cst_MappingRuleCS_MappingMethodCS, gen_qvtoperational_cst_MappingQueryCS_MappingMethodCS, gen_qvtoperational_cst_ParameterDeclarationCS_CSTNode, gen_qvtoperational_cst_SimpleSignatureCS_CSTNode, gen_qvtoperational_cst_CompleteSignatureCS_CSTNode, gen_qvtoperational_cst_MappingMethodCS_CSTNode, gen_qvtoperational_cst_ImperativeLoopExpCS_cst_LoopExpCS, gen_qvtoperational_cst_ImperativeLoopExpCS_cst_StatementCS, gen_qvtoperational_cst_ForExpCS_ImperativeLoopExpCS, gen_qvtoperational_cst_ImperativeIterateExpCS_ImperativeLoopExpCS, gen_qvtoperational_cst_SwitchExpCS_StatementCS, gen_qvtoperational_cst_ConstructorCS_MappingMethodCS, gen_qvtoperational_cst_MappingSectionCS_cst_CSTNode, gen_qvtoperational_cst_MappingSectionCS_cst_ElementWithBody, gen_qvtoperational_cst_MappingInitCS_MappingSectionCS, gen_qvtoperational_cst_MappingEndCS_MappingSectionCS, gen_qvtoperational_cst_MappingSectionsCS_CSTNode, gen_qvtoperational_cst_StatementCS_OCLExpressionCS, gen_qvtoperational_cst_BlockExpCS_StatementCS, gen_qvtoperational_cst_ComputeExpCS_StatementCS, gen_qvtoperational_cst_WhileExpCS_StatementCS, gen_qvtoperational_cst_BreakExpCS_StatementCS, gen_qvtoperational_cst_ContinueExpCS_StatementCS, gen_qvtoperational_cst_ExpressionStatementCS_StatementCS, gen_qvtoperational_cst_SwitchAltExpCS_StatementCS, gen_qvtoperational_cst_VariableInitializationCS_StatementCS, gen_qvtoperational_cst_ResolveInExpCS_ResolveExpCS, gen_qvtoperational_cst_AssignStatementCS_StatementCS, gen_qvtoperational_cst_ModelTypeCS_cst_CSTNode, gen_qvtoperational_cst_ModelTypeCS_cst_ElementWithBody, gen_qvtoperational_cst_MappingBodyCS_MappingSectionCS, gen_qvtoperational_cst_ObjectExpCS_cst_InstantiationExpCS, gen_qvtoperational_cst_ObjectExpCS_cst_ElementWithBody, gen_qvtoperational_cst_MappingCallExpCS_ImperativeOperationCallExpCS, gen_qvtoperational_cst_ImperativeOperationCallExpCS_OperationCallExpCS, gen_qvtoperational_cst_DirectionKindCS_CSTNode, gen_qvtoperational_cst_ResolveExpCS_CallExpCS, gen_qvtoperational_cst_ModuleUsageCS_CSTNode, gen_qvtoperational_cst_TransformationRefineCS_CSTNode, gen_qvtoperational_cst_PackageRefCS_CSTNode, gen_qvtoperational_cst_TransformationHeaderCS_CSTNode, gen_qvtoperational_cst_ModuleKindCS_CSTNode, gen_qvtoperational_cst_ModuleRefCS_CSTNode, gen_qvtoperational_cst_InstantiationExpCS_StatementCS, gen_qvtoperational_cst_TypeSpecCS_CSTNode, gen_qvtoperational_cst_LogExpCS_OperationCallExpCS, gen_qvtoperational_cst_AssertExpCS_StatementCS, gen_qvtoperational_cst_ReturnExpCS_StatementCS, gen_qvtoperational_cst_MappingExtensionCS_CSTNode, gen_qvtoperational_cst_ListTypeCS_TypeCS, gen_qvtoperational_cst_ListLiteralExpCS_LiteralExpCS, gen_qvtoperational_cst_DictionaryTypeCS_TypeCS, gen_qvtoperational_cst_DictLiteralExpCS_LiteralExpCS, gen_qvtoperational_cst_DictLiteralPartCS_CSTNode, gen_qvtoperational_cst_TagCS_CSTNode, gen_qvtoperational_cst_UnitCS_CSTNode, gen_qvtoperational_cst_ResolveOpArgsExpCS_CSTNode, gen_qvtoperational_cst_ScopedNameCS_CSTNode, gen_qvtoperational_cst_TryExpCS_StatementCS, gen_qvtoperational_cst_CatchExpCS_CSTNode, gen_qvtoperational_cst_RaiseExpCS_StatementCS},
    metadata=None
)
