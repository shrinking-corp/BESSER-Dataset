...
def test_hyp_blockexpcs_is_not_abstract():
    assert not inspect.isabstract(BlockExpCS)


def test_hyp_blockexpcs_constructor_exists():
    assert callable(BlockExpCS.__init__)


def test_hyp_blockexpcs_constructor_args():
...
def test_hyp_qvtoperational_cst_raiseexpcs_is_not_abstract():
    assert not inspect.isabstract(qvtoperational_cst_RaiseExpCS)


def test_hyp_qvtoperational_cst_raiseexpcs_constructor_exists():
    assert callable(qvtoperational_cst_RaiseExpCS.__init__)


def test_hyp_qvtoperational_cst_raiseexpcs_constructor_args():
    sig = inspect.signature(qvtoperational_cst_RaiseExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_catchexpcs_is_not_abstract():
    assert not inspect.isabstract(CatchExpCS)


def test_hyp_catchexpcs_constructor_exists():
    assert callable(CatchExpCS.__init__)


def test_hyp_catchexpcs_constructor_args():
    sig = inspect.signature(CatchExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_qvtoperational_cst_tryexpcs_is_not_abstract():
    assert not inspect.isabstract(qvtoperational_cst_TryExpCS)


def test_hyp_qvtoperational_cst_tryexpcs_constructor_exists():
    assert callable(qvtoperational_cst_TryExpCS.__init__)


def test_hyp_qvtoperational_cst_tryexpcs_constructor_args():
...
def test_hyp_qvtoperational_cst_exceptiondefcs_is_not_abstract():
    assert not inspect.isabstract(qvtoperational_cst_ExceptionDefCS)


def test_hyp_qvtoperational_cst_exceptiondefcs_constructor_exists():
    assert callable(qvtoperational_cst_ExceptionDefCS.__init__)


def test_hyp_qvtoperational_cst_exceptiondefcs_constructor_args():
    sig = inspect.signature(qvtoperational_cst_ExceptionDefCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_qvtoperational_cst_intermediateclassdefcs_is_not_abstract():
    assert not inspect.isabstract(qvtoperational_cst_IntermediateClassDefCS)


def test_hyp_qvtoperational_cst_intermediateclassdefcs_constructor_exists():
    assert callable(qvtoperational_cst_IntermediateClassDefCS.__init__)


def test_hyp_qvtoperational_cst_intermediateclassdefcs_constructor_args():
...
def test_hyp_qvtoperational_cst_catchexpcs_is_not_abstract():
    assert not inspect.isabstract(qvtoperational_cst_CatchExpCS)


def test_hyp_qvtoperational_cst_catchexpcs_constructor_exists():
    assert callable(qvtoperational_cst_CatchExpCS.__init__)


def test_hyp_qvtoperational_cst_catchexpcs_constructor_args():
...
def test_hyp_qvtoperational_cst_transformationheadercs_qualifiers_setter(instance):
