...
class qvtoperational_cst_MappingQueryCS(MappingMethodCS):
    ...
    def __init__(self, isSimpleDefinition: bool, qvtoperational_cst_MappingQueryCS: "BlockExpCS" = None, MappingMethodCS: "qvtoperational_cst_MappingModuleCS" = None):
        self.isSimpleDefinition = isSimpleDefinition
        self.qvtoperational_cst_MappingQueryCS = qvtoperational_cst_MappingQueryCS
        
        pass
    @property
    def isSimpleDefinition(self):
...
class qvtoperational_cst_DirectionKindCS(CSTNode):
    ...
    def __init__(self, directionKind: str, CSTNode: "qvtoperational_cst_UnitCS" = None):
        self.directionKind = directionKind
        
        pass
    @property
    def directionKind(self):
...
class qvtoperational_cst_ModuleUsageCS(CSTNode):
    ...
    def __init__(self, importKind: str, qvtoperational_cst_ModuleUsageCS: "ModuleKindCS" = None, qvtoperational_cst_ModuleUsageCS198: set["ModuleRefCS"] = None, CSTNode: "qvtoperational_cst_UnitCS" = None):
...
class qvtoperational_cst_ParameterDeclarationCS(CSTNode):
    ...
    def __init__(self, directionKind: str, qvtoperational_cst_ParameterDeclarationCS: "SimpleNameCS" = None, qvtoperational_cst_ParameterDeclarationCS81: "TypeSpecCS" = None, CSTNode: "qvtoperational_cst_UnitCS" = None):
        self.directionKind = directionKind
...
class qvtoperational_cst_MappingMethodCS(CSTNode):
    ...
    def __init__(self, blackBox: bool, qvtoperational_cst_MappingMethodCS: "MappingDeclarationCS" = None, CSTNode: "qvtoperational_cst_UnitCS" = None):
...
class qvtoperational_cst_TransformationHeaderCS(CSTNode):
    ...
    def __init__(self, qualifiers: str, qvtoperational_cst_TransformationHeaderCS185: set["ParameterDeclarationCS"] = None, qvtoperational_cst_TransformationHeaderCS188: set["ModuleUsageCS"] = None, qvtoperational_cst_TransformationHeaderCS190: "TransformationRefineCS" = None, qvtoperational_cst_TransformationHeaderCS: "PathNameCS" = None, CSTNode: "qvtoperational_cst_UnitCS" = None):
        self.qualifiers = qualifiers
...
class qvtoperational_cst_ScopedNameCS(CSTNode):
    ...
    def __init__(self, name: str, qvtoperational_cst_ScopedNameCS: "TypeCS" = None, CSTNode: "qvtoperational_cst_UnitCS" = None):
        self.name = name
...
class qvtoperational_cst_MappingExtensionCS(CSTNode):
    ...
    def __init__(self, kind: str, qvtoperational_cst_MappingExtensionCS: set["ScopedNameCS"] = None, CSTNode: "qvtoperational_cst_UnitCS" = None):
        self.kind = kind
...
class qvtoperational_cst_OppositePropertyCS(CSTNode):
    ...
    def __init__(self, isNavigable: bool, qvtoperational_cst_OppositePropertyCS: "SimpleNameCS" = None, qvtoperational_cst_OppositePropertyCS58: "MultiplicityDefCS" = None, CSTNode: "qvtoperational_cst_UnitCS" = None):
...
class qvtoperational_cst_ModuleKindCS(CSTNode):
    ...
    def __init__(self, moduleKind: str, CSTNode: "qvtoperational_cst_UnitCS" = None):
