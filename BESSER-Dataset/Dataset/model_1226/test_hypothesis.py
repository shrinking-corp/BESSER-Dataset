...
def test_blockexpcs_is_not_abstract():
    assert not inspect.isabstract(BlockExpCS)


def test_blockexpcs_constructor_exists():
    assert callable(BlockExpCS.__init__)


def test_blockexpcs_constructor_args():
    sig = inspect.signature(BlockExpCS.__init__)
    params = list(sig.parameters.keys())
...
def test_qvtoperational_cst_raiseexpcs_is_not_abstract():
    assert not inspect.isabstract(qvtoperational_cst_RaiseExpCS)


def test_qvtoperational_cst_raiseexpcs_constructor_exists():
    assert callable(qvtoperational_cst_RaiseExpCS.__init__)


def test_qvtoperational_cst_raiseexpcs_constructor_args():
    sig = inspect.signature(qvtoperational_cst_RaiseExpCS.__init__)
    params = list(sig.parameters.keys())



def test_catchexpcs_is_not_abstract():
    assert not inspect.isabstract(CatchExpCS)


def test_catchexpcs_constructor_exists():
    assert callable(CatchExpCS.__init__)


def test_catchexpcs_constructor_args():
    sig = inspect.signature(CatchExpCS.__init__)
    params = list(sig.parameters.keys())



def test_qvtoperational_cst_tryexpcs_is_not_abstract():
    assert not inspect.isabstract(qvtoperational_cst_TryExpCS)


def test_qvtoperational_cst_tryexpcs_constructor_exists():
    assert callable(qvtoperational_cst_TryExpCS.__init__)


def test_qvtoperational_cst_tryexpcs_constructor_args():
    sig = inspect.signature(qvtoperational_cst_TryExpCS.__init__)
    params = list(sig.parameters.keys())
...
def test_qvtoperational_cst_exceptiondefcs_is_not_abstract():
    assert not inspect.isabstract(qvtoperational_cst_ExceptionDefCS)


def test_qvtoperational_cst_exceptiondefcs_constructor_exists():
    assert callable(qvtoperational_cst_ExceptionDefCS.__init__)


def test_qvtoperational_cst_exceptiondefcs_constructor_args():
    sig = inspect.signature(qvtoperational_cst_ExceptionDefCS.__init__)
    params = list(sig.parameters.keys())



def test_qvtoperational_cst_intermediateclassdefcs_is_not_abstract():
    assert not inspect.isabstract(qvtoperational_cst_IntermediateClassDefCS)


def test_qvtoperational_cst_intermediateclassdefcs_constructor_exists():
    assert callable(qvtoperational_cst_IntermediateClassDefCS.__init__)


def test_qvtoperational_cst_intermediateclassdefcs_constructor_args():
    sig = inspect.signature(qvtoperational_cst_IntermediateClassDefCS.__init__)
    params = list(sig.parameters.keys())
...
def test_qvtoperational_cst_transformationheadercs_has_qualifiers():
    assert hasattr(qvtoperational_cst_TransformationHeaderCS, "qualifiers")
    descriptor = None
    for klass in qvtoperational_cst_TransformationHeaderCS.__mro__:
...
def test_qvtoperational_cst_catchexpcs_is_not_abstract():
    assert not inspect.isabstract(qvtoperational_cst_CatchExpCS)


def test_qvtoperational_cst_catchexpcs_constructor_exists():
    assert callable(qvtoperational_cst_CatchExpCS.__init__)


def test_qvtoperational_cst_catchexpcs_constructor_args():
    sig = inspect.signature(qvtoperational_cst_CatchExpCS.__init__)
    params = list(sig.parameters.keys())
...
qvtoperational_cst_RaiseExpCS_strategy = st.builds(
    qvtoperational_cst_RaiseExpCS,
)
CatchExpCS_strategy = st.builds(
    CatchExpCS,
)
qvtoperational_cst_TryExpCS_strategy = st.builds(
    qvtoperational_cst_TryExpCS,
)
...
qvtoperational_cst_ExceptionDefCS_strategy = st.builds(
    qvtoperational_cst_ExceptionDefCS,
)
qvtoperational_cst_IntermediateClassDefCS_strategy = st.builds(
    qvtoperational_cst_IntermediateClassDefCS,
)
...
qvtoperational_cst_CatchExpCS_strategy = st.builds(
    qvtoperational_cst_CatchExpCS,
)
...
@given(instance=qvtoperational_cst_TransformationHeaderCS_strategy)
def test_qvtoperational_cst_transformationheadercs_qualifiers_setter(instance):
