...
# Classes
nonemf_MySerializableClass = Class(name="nonemf_MySerializableClass")
Serializable = Class(name="Serializable")
nonemf_B = Class(name="nonemf_B")
nonemf_A = Class(name="nonemf_A")
nonemf_Serializable = Class(name="nonemf_Serializable", is_abstract=True)
...
domain_model = DomainModel(
    name="nonemf",
    types={nonemf_MySerializableClass, Serializable, nonemf_B, nonemf_A, nonemf_Serializable, TestB, TestA},
    associations={},
