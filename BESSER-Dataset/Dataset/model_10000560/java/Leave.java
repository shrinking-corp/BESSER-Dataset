...
public class Leave  {
    ...
    public Leave(
        LocalDate Leave_ApplyDate,        String Leave_detail,        int Emp_Id,        LocalDate Leave_EndDate,        String Leave_Status,        int leave_id,        int Leave_NoOfDays,        LocalDate Leave_StartDate,        String Leave_Title    ) {
