...
# Classes
jdtmm_JDTMethod = Class(name="jdtmm_JDTMethod")
JDTMember = Class(name="JDTMember")
jdtmm_JDTType = Class(name="jdtmm_JDTType", is_abstract=True)
jdtmm_JDTParameter = Class(name="jdtmm_JDTParameter")
jdtmm_JDTMember = Class(name="jdtmm_JDTMember", is_abstract=True)
JDTParentJavaElement = Class(name="JDTParentJavaElement")
jdtmm_JDTTypeParameter = Class(name="jdtmm_JDTTypeParameter")
jdtmm_JDTMethodBody = Class(name="jdtmm_JDTMethodBody", is_abstract=True)
jdtmm_JDTJavaElement = Class(name="jdtmm_JDTJavaElement", is_abstract=True)
jdtmm_JDTField = Class(name="jdtmm_JDTField")
jdtmm_JDTCompilationUnit = Class(name="jdtmm_JDTCompilationUnit")
jdtmm_JDTParentJavaElement = Class(name="jdtmm_JDTParentJavaElement", is_abstract=True)
JDTJavaElement = Class(name="JDTJavaElement")
JDTParent = Class(name="JDTParent")
jdtmm_JDTParent = Class(name="jdtmm_JDTParent", is_abstract=True)
JDTTypeRoot = Class(name="JDTTypeRoot")
jdtmm_JDTPackageFragment = Class(name="jdtmm_JDTPackageFragment")
jdtmm_JDTTypeRoot = Class(name="jdtmm_JDTTypeRoot", is_abstract=True)
jdtmm_JDTPackageFragmentRoot = Class(name="jdtmm_JDTPackageFragmentRoot")
jdtmm_JDTJavaProject = Class(name="jdtmm_JDTJavaProject")
jdtmm_JDTJavaModel = Class(name="jdtmm_JDTJavaModel")
jdtmm_JDTClass = Class(name="jdtmm_JDTClass")
JDTType = Class(name="JDTType")
jdtmm_JDTInterface = Class(name="jdtmm_JDTInterface")
jdtmm_JDTEnum = Class(name="jdtmm_JDTEnum")
jdtmm_JDTImportDeclaration = Class(name="jdtmm_JDTImportDeclaration")
jdtmm_JDTImportContainer = Class(name="jdtmm_JDTImportContainer")
jdtmm_JDTException = Class(name="jdtmm_JDTException")
jdtmm_JDTOpaqueBody = Class(name="jdtmm_JDTOpaqueBody")
...
jdtmm_JDTMethod.attributes={jdtmm_JDTMethod_final, jdtmm_JDTMethod_abstract, jdtmm_JDTMethod_static, jdtmm_JDTMethod_synchronized, jdtmm_JDTMethod_constructor}

# JDTMember class attributes and methods

# jdtmm_JDTType class attributes and methods
jdtmm_JDTType_class_: Property = Property(name="class_", type=StringType)
...
jdtmm_JDTType.attributes={jdtmm_JDTType_final, jdtmm_JDTType_superClassName, jdtmm_JDTType_static, jdtmm_JDTType_abstract, jdtmm_JDTType_class_, jdtmm_JDTType_superInterfaceNames, jdtmm_JDTType_interface, jdtmm_JDTType_enum}
...
jdtmm_JDTMember.attributes={jdtmm_JDTMember_visibility, jdtmm_JDTMember_explicitPlainTextRequiredImports}
...
jdtmm_JDTJavaElement_m_accept: Method = Method(name="accept", parameters={Parameter(name='jdtmm_visitor', type=StringType)})
jdtmm_JDTJavaElement_m_getJDTSignature: Method = Method(name="getJDTSignature", parameters={}, type=StringType)
jdtmm_JDTJavaElement.attributes={jdtmm_JDTJavaElement_elementType, jdtmm_JDTJavaElement_elementName, jdtmm_JDTJavaElement_generated, jdtmm_JDTJavaElement_comment}
...
jdtmm_JDTField.attributes={jdtmm_JDTField_final, jdtmm_JDTField_value, jdtmm_JDTField_generateGetter, jdtmm_JDTField_isMultiValued, jdtmm_JDTField_generateSetter, jdtmm_JDTField_abstract, jdtmm_JDTField_static}
...
jdtmm_JDTParent_m_isFlagSet: Method = Method(name="isFlagSet", parameters={Parameter(name='jdtmm_flag', type=StringType)}, type=StringType)
jdtmm_JDTParent_m_setFlag: Method = Method(name="setFlag", parameters={Parameter(name='jdtmm_value', type=StringType), Parameter(name='jdtmm_flag', type=StringType)})
jdtmm_JDTParent.attributes={jdtmm_JDTParent_flags}
jdtmm_JDTParent.methods={jdtmm_JDTParent_m_isFlagSet, jdtmm_JDTParent_m_setFlag}
...
domain_model = DomainModel(
    name="jdtmm",
    types={jdtmm_JDTMethod, JDTMember, jdtmm_JDTType, jdtmm_JDTParameter, jdtmm_JDTMember, JDTParentJavaElement, jdtmm_JDTTypeParameter, jdtmm_JDTMethodBody, jdtmm_JDTJavaElement, jdtmm_JDTField, jdtmm_JDTCompilationUnit, jdtmm_JDTParentJavaElement, JDTJavaElement, JDTParent, jdtmm_JDTParent, JDTTypeRoot, jdtmm_JDTPackageFragment, jdtmm_JDTTypeRoot, jdtmm_JDTPackageFragmentRoot, jdtmm_JDTJavaProject, jdtmm_JDTJavaModel, jdtmm_JDTClass, JDTType, jdtmm_JDTInterface, jdtmm_JDTEnum, jdtmm_JDTImportDeclaration, jdtmm_JDTImportContainer, jdtmm_JDTException, jdtmm_JDTOpaqueBody, JDTMethodBody, VisibilityKind, TrueFalseDefault},
    associations={owner0, owner1, returnType2, parameters3, exceptions5, bodies6, typeParameters7, explicitRequiredImports8, children10, parent11, declaringMember12, methods13, fields16, compilationUnit18, types20, owner24, superInterfaces28, superClass31, type33, owner35, packageFragment37, types38, packageFragmentRoot40, javaProject43, packageFragments44, javaModel46, packageFragmentRoots47, javaProject50, parameterOwner52, type54, returnOwner56, compilationUnits41},
    generalizations={gen_jdtmm_JDTMethod_JDTMember, gen_jdtmm_JDTMember_JDTParentJavaElement, gen_jdtmm_JDTTypeParameter_JDTJavaElement, gen_jdtmm_JDTType_JDTMember, gen_jdtmm_JDTParentJavaElement_JDTJavaElement, gen_jdtmm_JDTParentJavaElement_JDTParent, gen_jdtmm_JDTField_JDTMember, gen_jdtmm_JDTCompilationUnit_JDTTypeRoot, gen_jdtmm_JDTTypeRoot_JDTParentJavaElement, gen_jdtmm_JDTPackageFragment_JDTParentJavaElement, gen_jdtmm_JDTPackageFragmentRoot_JDTParentJavaElement, gen_jdtmm_JDTJavaProject_JDTParentJavaElement, gen_jdtmm_JDTJavaModel_JDTParentJavaElement, gen_jdtmm_JDTParameter_JDTMember, gen_jdtmm_JDTClass_JDTType, gen_jdtmm_JDTInterface_JDTType, gen_jdtmm_JDTEnum_JDTType, gen_jdtmm_JDTImportDeclaration_JDTJavaElement, gen_jdtmm_JDTImportContainer_JDTParentJavaElement, gen_jdtmm_JDTOpaqueBody_JDTMethodBody},
    metadata=None
)
