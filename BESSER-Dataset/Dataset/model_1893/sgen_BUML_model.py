...
# Classes
sgen_GeneratorModel = Class(name="sgen_GeneratorModel")
sgen_GeneratorEntry = Class(name="sgen_GeneratorEntry")
sgen_GeneratorConfiguration = Class(name="sgen_GeneratorConfiguration")
sgen_FeatureParameterValue = Class(name="sgen_FeatureParameterValue")
sgen_EObject = Class(name="sgen_EObject")
sgen_FeatureConfiguration = Class(name="sgen_FeatureConfiguration")
sgen_FeatureType = Class(name="sgen_FeatureType")
NamedElement = Class(name="NamedElement")
DeprecatableElement = Class(name="DeprecatableElement")
sgen_FeatureParameter = Class(name="sgen_FeatureParameter")
sgen_FeatureTypeLibrary = Class(name="sgen_FeatureTypeLibrary")
sgen_BoolLiteral = Class(name="sgen_BoolLiteral")
Literal = Class(name="Literal")
sgen_IntLiteral = Class(name="sgen_IntLiteral")
sgen_RealLiteral = Class(name="sgen_RealLiteral")
sgen_StringLiteral = Class(name="sgen_StringLiteral")
sgen_DeprecatableElement = Class(name="sgen_DeprecatableElement")
sgen_Literal = Class(name="sgen_Literal", is_abstract=True)
...
sgen_GeneratorEntry_m_getFeatureConfiguration: Method = Method(name="getFeatureConfiguration", parameters={Parameter(name='sgen_featureName', type=StringType)}, type=StringType)
sgen_GeneratorEntry_m_getFeatureParameterValue: Method = Method(name="getFeatureParameterValue", parameters={Parameter(name='sgen_paramName', type=StringType), Parameter(name='sgen_featureName', type=StringType)}, type=StringType)
...
sgen_FeatureParameterValue_m_setValue: Method = Method(name="setValue", parameters={Parameter(name='sgen_string', type=StringType)})
sgen_FeatureParameterValue_m_setValue: Method = Method(name="setValue", parameters={Parameter(name='sgen_boolean', type=StringType)})
...
sgen_FeatureParameterValue.methods={sgen_FeatureParameterValue_m_setValue, sgen_FeatureParameterValue_m_setValue, sgen_FeatureParameterValue_m_getBooleanValue, sgen_FeatureParameterValue_m_getStringValue}

# sgen_EObject class attributes and methods

# sgen_FeatureConfiguration class attributes and methods
sgen_FeatureConfiguration_m_getParameterValue: Method = Method(name="getParameterValue", parameters={Parameter(name='sgen_parameterName', type=StringType)}, type=StringType)
...
domain_model = DomainModel(
    name="sgen",
    types={sgen_GeneratorModel, sgen_GeneratorEntry, sgen_GeneratorConfiguration, sgen_FeatureParameterValue, sgen_EObject, sgen_FeatureConfiguration, sgen_FeatureType, NamedElement, DeprecatableElement, sgen_FeatureParameter, sgen_FeatureTypeLibrary, sgen_BoolLiteral, Literal, sgen_IntLiteral, sgen_RealLiteral, sgen_StringLiteral, sgen_DeprecatableElement, sgen_Literal, ParameterTypes},
    associations={entries0, featureType4, type5, parameterValues8, elementRef9, features11, configurations1, parameters2, library3, parameter14, featureConfiguration15, expression16, types18},
    generalizations={gen_sgen_FeatureType_NamedElement, gen_sgen_FeatureType_DeprecatableElement, gen_sgen_FeatureParameter_NamedElement, gen_sgen_FeatureParameter_DeprecatableElement, gen_sgen_BoolLiteral_Literal, gen_sgen_IntLiteral_Literal, gen_sgen_RealLiteral_Literal, gen_sgen_StringLiteral_Literal},
    metadata=None
)
