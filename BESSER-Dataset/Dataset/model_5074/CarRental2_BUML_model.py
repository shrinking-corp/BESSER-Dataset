...
# Classes
CarRental2_Person = Class(name="CarRental2_Person", is_abstract=True)
CarRental2_Rental = Class(name="CarRental2_Rental")
CarRental2_Employee = Class(name="CarRental2_Employee")
CarRental2_Branch = Class(name="CarRental2_Branch")
CarRental2_Customer = Class(name="CarRental2_Customer")
Person = Class(name="Person")
CarRental2_Car = Class(name="CarRental2_Car")
CarRental2_CarGroup = Class(name="CarRental2_CarGroup")
CarRental2_TernaryRelationMaintenance = Class(name="CarRental2_TernaryRelationMaintenance")
CarRental2_ServiceDepot = Class(name="CarRental2_ServiceDepot")
CarRental2_Check = Class(name="CarRental2_Check")
...
CarRental2_Person_m_fullname: Method = Method(name="fullname", parameters={Parameter(name='CarRental2_prefix', type=StringType)}, type=StringType)
CarRental2_Person.attributes={CarRental2_Person_firstname, CarRental2_Person_lastname, CarRental2_Person_age, CarRental2_Person_isMarried}
...
CarRental2_Employee_m_raiseSalary: Method = Method(name="raiseSalary", parameters={Parameter(name='CarRental2_amount', type=StringType)}, type=IntegerType)
...
domain_model = DomainModel(
    name="CarRental2",
    types={CarRental2_Person, CarRental2_Rental, CarRental2_Employee, CarRental2_Branch, CarRental2_Customer, Person, CarRental2_Car, CarRental2_CarGroup, CarRental2_TernaryRelationMaintenance, CarRental2_ServiceDepot, CarRental2_Check},
    associations={Booking_Rental0, Management_Branch_role_managedBranch1, Management_Employee_role_manager4, Employment_Employee_role_employee5, Fleet_Car7, Offers_CarGroup8, Provider_Rental9, Booking_Customer11, Employment_Branch_role_employer2, Assignment_Car16, Offers_Branch18, Classification_Car20, Reservation_Rental22, Quality_CarGroup_role_lower25, Quality_CarGroup_role_higher28, Provider_Branch12, Reservation_CarGroup14, Fleet_Branch30, Classification_CarGroup32, Assignment_Rental34, toMaintenance36, toMaintenance37, toMaintenance39, toServiceDepot41, toCheck42, toCar44},
