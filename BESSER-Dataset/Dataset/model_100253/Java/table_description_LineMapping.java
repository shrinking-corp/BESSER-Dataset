...
public class table_description_LineMapping extends description_TableMapping, description_StyleUpdater {
    ...
    public table_description_LineMapping(
        String headerLabelExpression,        String semanticCandidatesExpression,        String domainClass        ArrayList<LineMapping> linemappings,        ArrayList<LineMapping> linemappings,        ArrayList<CreateLineTool> createlinetools,        ArrayList<LineMapping> linemappings,        ArrayList<LineMapping> linemappings    ) {
        this.headerLabelExpression = headerLabelExpression;
        this.semanticCandidatesExpression = semanticCandidatesExpression;
        this.domainClass = domainClass;
