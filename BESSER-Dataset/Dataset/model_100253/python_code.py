...
class table_description_FeatureColumnMapping(description_CellUpdater, description_StyleUpdater, description_ColumnMapping):
...
class table_description_IntersectionMapping(description_CellUpdater, description_TableMapping, description_StyleUpdater):
    ...
    def __init__(self, useDomainClass: bool, labelExpression: str, columnFinderExpression: str, lineFinderExpression: str, semanticCandidatesExpression: str, domainClass: str, preconditionExpression: str, table_description_IntersectionMapping: set["LineMapping"] = None, table_description_IntersectionMapping113: "ColumnMapping" = None, mapping116: "CreateCellTool" = None):
...
class description_RepresentationDescription:
    ...
    pass
class table_description_TableDescription(description_DocumentedElement, description_RepresentationDescription, description_EndUserDocumentedElement):

    def __init__(self, preconditionExpression: str, domainClass: str, initialHeaderColumnWidth: int, table_description_TableDescription: set["tool_RepresentationCreationDescription"] = None, table_description_TableDescription40: set["tool_RepresentationCreationDescription"] = None, table_description_TableDescription43: set["tool_RepresentationCreationDescription"] = None, table_description_TableDescription46: set["tool_RepresentationNavigationDescription"] = None, table_description_TableDescription48: set["tool_RepresentationNavigationDescription"] = None, table_description_TableDescription51: set["tool_RepresentationNavigationDescription"] = None, table_description_TableDescription54: set["LineMapping"] = None, table_description_TableDescription57: set["LineMapping"] = None, table_description_TableDescription60: set["LineMapping"] = None, table_description_TableDescription63: set["CreateLineTool"] = None, table_description_TableDescription65: set["CreateLineTool"] = None, table_description_TableDescription68: set["CreateLineTool"] = None, table_description_TableDescription71: set["description_table_EObject"] = None):
        self.preconditionExpression = preconditionExpression
        self.domainClass = domainClass
...
class table_DTableElementStyle:
    ...
    def __init__(self, labelSize: int, defaultForegroundStyle: bool, defaultBackgroundStyle: bool, foregroundColor: str, backgroundColor: str, labelFormat: str, table_DTableElementStyle: "table_DLine" = None, table_DTableElementStyle37: "table_DColumn" = None):
        self.labelSize = labelSize
...
class table_description_ColumnMapping(TableMapping):
    ...
    def __init__(self, headerLabelExpression: str, initialWidth: int, TableMapping: "table_DTableElement" = None, TableMapping24: "table_DCellStyle" = None, TableMapping27: "table_DCellStyle" = None):
        self.headerLabelExpression = headerLabelExpression
...
class table_DCell(DSemanticDecorator, DTableElement):
    ...
    def __init__(self, label: str, DCell: "table_DLine" = None, table_DCell: "table_DLine" = None, cells14: "table_DColumn" = None, table_DCell17: "table_DCellStyle" = None, cells: "table_DLine" = None, table_DCell21: "IntersectionMapping" = None, table_DCell19: "CellUpdater" = None, DCell29: "table_DColumn" = None, table_DCell34: "table_DColumn" = None):
        self.label = label
        self.DCell = DCell
...
class table_DColumn(DTableElement):
    ...
    def __init__(self, label: str, visible: bool, width: int, DColumn: "table_DTable" = None, table_DColumn36: "table_DTableElementStyle" = None, DColumn15: "table_DCell" = None, table_DColumn: "ColumnMapping" = None, column: set["table_DCell"] = None, columns: "table_DTable" = None, table_DColumn33: set["table_DCell"] = None):
        self.label = label
...
class table_DLine(LineContainer, DTableElement):
    ...
    def __init__(self, label: str, visible: bool, collapsed: bool, table_DLine: "LineMapping" = None, DLine: "table_LineContainer" = None, table_DLine10: "table_DTableElementStyle" = None, line: set["table_DCell"] = None, lines: "table_LineContainer" = None, table_DLine8: set["table_DCell"] = None, DLine12: "table_DCell" = None):
        self.label = label
        self.visible = visible
