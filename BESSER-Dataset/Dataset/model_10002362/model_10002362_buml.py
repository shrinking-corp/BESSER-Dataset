...
Employee.attributes={Employee_jobLevel, Employee_managerId, Employee_noOfLeaves, Employee_password, Employee_employeeId, Employee_employeeName, Employee_leavesTaken}
...
LeaveApplication.attributes={LeaveApplication_fromDate, LeaveApplication_toDate, LeaveApplication_employeeId, LeaveApplication_status, LeaveApplication_reason, LeaveApplication_approverComments, LeaveApplication_applicationId}
...
Application_SendNotification: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="application19", type=Employee_Actor1, multiplicity=Multiplicity(0, 1))
    }
)
Credit_Leaves_Application: BinaryAssociation = BinaryAssociation(
    name="Credit_Leaves_Application",
    ends={
        Property(name="application20", type=Employee_Actor1, multiplicity=Multiplicity(0, 1)),
...
Application_AutoApproval: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="application23", type=Employee_Actor1, multiplicity=Multiplicity(0, 1))
    }
)
Application_GenerateSummary: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="application25", type=Employee_Actor1, multiplicity=Multiplicity(0, 1))
    }
)
...
domain_model = DomainModel(
    name="abd72e16_2026_4ff6_8817_2a357c9262b8",
    types={Login_UseCase, Employee_Actor, Change_Password_UseCase, Query_Eligibility_UseCase, Query_Leave_Balance_UseCase, Query_Leave_History_UseCase, Apply_Leave_UseCase, Leave_Request_Status_UseCase, Withdraw_Application_UseCase, Approver_Jobs_UseCase, Approve_RejectRequests_UseCase, Cancel_Leaves_UseCase, Admin_Actor, CreateUser_UseCase, Update_Calendar_UseCase, Employee_Actor1, SendNotification_UseCase, Credit_Leaves_UseCase, AutoApproval_UseCase, GenerateSummary_UseCase, Employee, Query, EligibilityQuery, LeaveBalanceQuery, LeaveHistoryQuery, LeaveApplication, Request, ApplyLeaveRequest, WithdrawLeaveRequest, CancelLeaveRequest, LeaveStatusQuery, ApproveOrRejectStatus, LoginAction, CreateUserAction, UpdateCalendar, ApplicationUtils, LeaveStatus},
    associations={User_Login, User_Query_Eligibility, User_Query_Leave_Balance, Employee_Approver_Jobs, Admin_CreateUser, Admin_Update_Calendar, Application_SendNotification, Credit_Leaves_Application, Application_AutoApproval, Application_GenerateSummary, User_Query_Leave_History, Employee_Apply_Leave, Employee_Leave_Request_Status},
    generalizations={},
    metadata=None
)
