...
class MocaTree_Node(Text):
    ...
    def __init__(self, startIndex: int, startLineIndex: int, stopIndex: int, stopLineIndex: int, Node: "MocaTree_Attribute" = None, Node4: "MocaTree_File" = None, rootNode: "MocaTree_File" = None, parentNode: set["MocaTree_Text"] = None, node: set["MocaTree_Attribute"] = None, Node20: "MocaTree_Text" = None):
