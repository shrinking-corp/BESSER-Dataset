...
# Classes
MocaTree_Attribute = Class(name="MocaTree_Attribute")
TreeElement = Class(name="TreeElement")
MocaTree_Node = Class(name="MocaTree_Node")
MocaTree_File = Class(name="MocaTree_File")
MocaTree_Folder = Class(name="MocaTree_Folder")
MocaTree_Link = Class(name="MocaTree_Link")
MocaTree_TreeElement = Class(name="MocaTree_TreeElement", is_abstract=True)
Text = Class(name="Text")
MocaTree_Text = Class(name="MocaTree_Text")
...
MocaTree_Node.attributes={MocaTree_Node_stopIndex, MocaTree_Node_stopLineIndex, MocaTree_Node_startLineIndex, MocaTree_Node_startIndex}
...
MocaTree_TreeElement.attributes={MocaTree_TreeElement_index, MocaTree_TreeElement_name}
...
domain_model = DomainModel(
    name="MocaTree",
    types={MocaTree_Attribute, TreeElement, MocaTree_Node, MocaTree_File, MocaTree_Folder, MocaTree_Link, MocaTree_TreeElement, Text, MocaTree_Text},
    associations={node0, folder1, rootNode2, subFolder6, parentFolder9, file11, targets12, attribute13, file15, children17, attribute18, parentNode19, links21},
    generalizations={gen_MocaTree_Attribute_TreeElement, gen_MocaTree_File_TreeElement, gen_MocaTree_Folder_TreeElement, gen_MocaTree_Link_TreeElement, gen_MocaTree_Node_Text, gen_MocaTree_Text_TreeElement},
    metadata=None
)
