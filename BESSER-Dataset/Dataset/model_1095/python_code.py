...
class petrinets_Transition:
    ...
    def __init__(self, name: str, transitions: "petrinets_Net" = None, dst11: set["petrinets_Place"] = None, src14: set["petrinets_Place"] = None, Transition: "petrinets_Net" = None, Transition5: "petrinets_Place" = None, Transition7: "petrinets_Place" = None):
        self.name = name
...
class petrinets_Place:
    ...
    def __init__(self, name: str, Place12: "petrinets_Transition" = None, Place15: "petrinets_Transition" = None, Place: "petrinets_Net" = None, places: "petrinets_Net" = None, dst: set["petrinets_Transition"] = None, src: set["petrinets_Transition"] = None):
        self.name = name
