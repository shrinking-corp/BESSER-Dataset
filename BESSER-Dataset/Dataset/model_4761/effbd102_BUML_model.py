...
# Classes
effbd102_Sequence = Class(name="effbd102_Sequence", is_abstract=True)
effbd102_Flow = Class(name="effbd102_Flow")
effbd102_OutputPort = Class(name="effbd102_OutputPort")
effbd102_InputPort = Class(name="effbd102_InputPort")
effbd102_Function = Class(name="effbd102_Function")
SequenceNode = Class(name="SequenceNode")
ProcessNode = Class(name="ProcessNode")
effbd102_Port = Class(name="effbd102_Port", is_abstract=True)
effbd102_Item = Class(name="effbd102_Item")
effbd102_ProcessNode = Class(name="effbd102_ProcessNode", is_abstract=True)
effbd102_Description = Class(name="effbd102_Description")
effbd102_SequenceNode = Class(name="effbd102_SequenceNode", is_abstract=True)
effbd102_And = Class(name="effbd102_And")
Sequence = Class(name="Sequence")
effbd102_Or = Class(name="effbd102_Or")
effbd102_Start = Class(name="effbd102_Start")
effbd102_Final = Class(name="effbd102_Final")
effbd102_Loop = Class(name="effbd102_Loop")
Port = Class(name="Port")
effbd102_LoopExit = Class(name="effbd102_LoopExit")
effbd102_Iteration = Class(name="effbd102_Iteration")
...
effbd102_Function.attributes={effbd102_Function_domain, effbd102_Function_minDuration, effbd102_Function_maxDuration}
...
domain_model = DomainModel(
    name="effbd102",
    types={effbd102_Sequence, effbd102_Flow, effbd102_OutputPort, effbd102_InputPort, effbd102_Function, SequenceNode, ProcessNode, effbd102_Port, effbd102_Item, effbd102_ProcessNode, effbd102_Description, effbd102_SequenceNode, effbd102_And, Sequence, effbd102_Or, effbd102_Start, effbd102_Final, effbd102_Loop, Port, effbd102_LoopExit, effbd102_Iteration, FunctionDomain},
    associations={decompositions1, sequenceNodes2, flows4, outputPorts6, inputPorts8, inputflowEdge14, items17, descriptions10, controlFlowEdge13, outputflowEdge19},
    generalizations={gen_effbd102_Function_SequenceNode, gen_effbd102_Function_ProcessNode, gen_effbd102_Flow_ProcessNode, gen_effbd102_Sequence_SequenceNode, gen_effbd102_And_Sequence, gen_effbd102_Or_Sequence, gen_effbd102_Start_Sequence, gen_effbd102_Final_Sequence, gen_effbd102_Loop_Sequence, gen_effbd102_InputPort_Port, gen_effbd102_OutputPort_Port, gen_effbd102_LoopExit_Sequence, gen_effbd102_Iteration_Sequence},
    metadata=None
)
