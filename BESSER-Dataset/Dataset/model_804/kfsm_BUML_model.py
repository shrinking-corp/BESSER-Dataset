...
# Classes
kfsm_FSM = Class(name="kfsm_FSM")
kfsm_State = Class(name="kfsm_State")
kfsm_Transition = Class(name="kfsm_Transition")
kfsm_Action = Class(name="kfsm_Action")
...
kfsm_Transition.attributes={kfsm_Transition_input, kfsm_Transition_output}
...
domain_model = DomainModel(
    name="kfsm",
    types={kfsm_FSM, kfsm_State, kfsm_Transition, kfsm_Action},
    associations={ownedState0, initialState1, finalState2, owningFSM5, outgoingTransition6, incomingTransition7, s_action9, target13, source11},
    generalizations={},
    metadata=None
)
