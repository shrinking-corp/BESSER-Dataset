...
class kfsm_Transition:
    ...
    def __init__(self, input: str, output: str, incomingTransition: "kfsm_State" = None, outgoingTransition: "kfsm_State" = None, Transition: "kfsm_State" = None, Transition8: "kfsm_State" = None):
        self.input = input
        self.output = output
...
class kfsm_State:
    ...
    def __init__(self, name: str, kfsm_State10: "kfsm_Action" = None, State14: "kfsm_Transition" = None, State12: "kfsm_Transition" = None, State: "kfsm_FSM" = None, kfsm_State: "kfsm_FSM" = None, kfsm_State4: "kfsm_FSM" = None, ownedState: "kfsm_FSM" = None, source: set["kfsm_Transition"] = None, target: set["kfsm_Transition"] = None):
        self.name = name
