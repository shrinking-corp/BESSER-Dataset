...
# Carro class attributes and methods
Carro_velocidade: Property = Property(name="velocidade", type=FloatType)
Carro.attributes={Carro_velocidade}
...
domain_model = DomainModel(
    name="c3c89683_808f_4642_90ec_a36384a3afad",
    types={CPU, Processor, AcceleratorCard, Cache, RAM, Machine, Program, Instruction, Memory_Interface, DeviceCard, Card, Sound, GenericSound, Vendor1Adapter, Vendor2Adapter, Vendor1Sound, Vendor2Sound, ExtensionBoard, FastCard, Carro},
