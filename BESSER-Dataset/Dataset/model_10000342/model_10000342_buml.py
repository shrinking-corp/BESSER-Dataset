...
Service.attributes={Service_serviceId, Service_type, Service_arrivalDateTime, Service_departureDateTime, Service_serviceName}
...
TrainStats.attributes={TrainStats_trainService, TrainStats_humidityAvg, TrainStats_passengerCount, TrainStats_tempAvg, TrainStats_fuelAvg}
...
ServiceTypeFactory.attributes={ServiceTypeFactory_getServiceType, ServiceTypeFactory_type}
...
Commutator.attributes={Commutator_builder, Commutator_commutatorTrain}
...
Sleeper.attributes={Sleeper_sleeperTrain, Sleeper_builder}
...
Coach.attributes={Coach_totalPassengers, Coach_coachType, Coach_temprature, Coach_humidity, Coach_capacity}
...
Route.attributes={Route_destination, Route_source, Route_stops, Route_routeId}
...
Engine.attributes={Engine_horsePower, Engine_fuelAvg}
...
Train.attributes={Train_myCoach, Train_myEngine}
...
domain_model = DomainModel(
    name="_2b53ee4f_be26_4119_8378_1472ac99ed12",
    ...
    associations={Service_ServiceTypeFactory, ServiceTypeFactory_ServiceType, Sleeper_TrainBuilder, InterCity_TrainBuilder, Commutator_TrainBuilder, Service_Route, TrainStats_Service, InterCity_TrainBuilder2, Sleeper_TrainBuilder2, Commutator_TrainBuilder2},
    generalizations={},
    metadata=None
)
