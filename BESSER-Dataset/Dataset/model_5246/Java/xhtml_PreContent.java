...
public class xhtml_PreContent  {
    ...
    public xhtml_PreContent(
        String group,        String mixed        ArrayList<xhtml_TtType> xhtml_tttypes,        ArrayList<xhtml_SpanType> xhtml_spantypes,        ArrayList<xhtml_SubType> xhtml_subtypes,        ArrayList<xhtml_CiteType> xhtml_citetypes,        ArrayList<xhtml_DfnType> xhtml_dfntypes,        ArrayList<xhtml_IType> xhtml_itypes,        ArrayList<xhtml_SmallType> xhtml_smalltypes,        ArrayList<xhtml_VarType> xhtml_vartypes,        ArrayList<xhtml_AbbrType> xhtml_abbrtypes,        ArrayList<xhtml_BrType> xhtml_brtypes,        ArrayList<xhtml_EmType> xhtml_emtypes,        ArrayList<xhtml_MapType> xhtml_maptypes,        ArrayList<xhtml_CodeType> xhtml_codetypes,        ArrayList<xhtml_BdoType> xhtml_bdotypes,        ArrayList<xhtml_StrongType> xhtml_strongtypes,        ArrayList<xhtml_KbdType> xhtml_kbdtypes,        ArrayList<xhtml_QType> xhtml_qtypes,        ArrayList<xhtml_AType> xhtml_atypes,        ArrayList<xhtml_AcronymType> xhtml_acronymtypes,        ArrayList<xhtml_SupType> xhtml_suptypes,        ArrayList<xhtml_BigType> xhtml_bigtypes,        ArrayList<xhtml_SampType> xhtml_samptypes,        ArrayList<xhtml_BType> xhtml_btypes    ) {
        this.group = group;
        this.mixed = mixed;
