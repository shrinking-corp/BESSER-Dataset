...
public class xhtml_Flow  {
    ...
    public xhtml_Flow(
        String mixed,        String group        ArrayList<xhtml_TtType> xhtml_tttypes,        ArrayList<xhtml_DfnType> xhtml_dfntypes,        ArrayList<xhtml_SubType> xhtml_subtypes,        ArrayList<xhtml_H1Type> xhtml_h1types,        ArrayList<xhtml_H6Type> xhtml_h6types,        ArrayList<xhtml_H4Type> xhtml_h4types,        ArrayList<xhtml_AType> xhtml_atypes,        ArrayList<xhtml_H5Type> xhtml_h5types,        ArrayList<xhtml_PType> xhtml_ptypes,        ArrayList<xhtml_AcronymType> xhtml_acronymtypes,        ArrayList<xhtml_OlType> xhtml_oltypes,        ArrayList<xhtml_HrType> xhtml_hrtypes,        ArrayList<xhtml_SampType> xhtml_samptypes,        ArrayList<xhtml_PreType> xhtml_pretypes,        ArrayList<xhtml_KbdType> xhtml_kbdtypes,        ArrayList<xhtml_SmallType> xhtml_smalltypes,        ArrayList<xhtml_BrType> xhtml_brtypes,        ArrayList<xhtml_BigType> xhtml_bigtypes,        ArrayList<xhtml_AddressType> xhtml_addresstypes,        ArrayList<xhtml_SupType> xhtml_suptypes,        ArrayList<xhtml_SpanType> xhtml_spantypes,        ArrayList<xhtml_BlockquoteType> xhtml_blockquotetypes,        ArrayList<xhtml_H3Type> xhtml_h3types,        ArrayList<xhtml_TableType> xhtml_tabletypes,        ArrayList<xhtml_BType> xhtml_btypes,        ArrayList<xhtml_CiteType> xhtml_citetypes,        ArrayList<xhtml_AbbrType> xhtml_abbrtypes,        ArrayList<xhtml_ImgType> xhtml_imgtypes,        ArrayList<xhtml_VarType> xhtml_vartypes,        ArrayList<xhtml_UlType> xhtml_ultypes,        ArrayList<xhtml_QType> xhtml_qtypes,        ArrayList<xhtml_IType> xhtml_itypes,        ArrayList<xhtml_BdoType> xhtml_bdotypes,        ArrayList<xhtml_DivType> xhtml_divtypes,        ArrayList<xhtml_StrongType> xhtml_strongtypes,        ArrayList<xhtml_MapType> xhtml_maptypes,        ArrayList<xhtml_DlType> xhtml_dltypes,        ArrayList<xhtml_CodeType> xhtml_codetypes,        ArrayList<xhtml_H2Type> xhtml_h2types,        ArrayList<xhtml_EmType> xhtml_emtypes    ) {
        this.mixed = mixed;
        this.group = group;
