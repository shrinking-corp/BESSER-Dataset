...
# Classes
xhtml_AbbrType = Class(name="xhtml_AbbrType")
Inline = Class(name="Inline")
xhtml_AContent = Class(name="xhtml_AContent")
xhtml_BrType = Class(name="xhtml_BrType")
xhtml_SpanType = Class(name="xhtml_SpanType")
xhtml_BdoType = Class(name="xhtml_BdoType")
xhtml_MapType = Class(name="xhtml_MapType")
xhtml_ImgType = Class(name="xhtml_ImgType")
xhtml_TtType = Class(name="xhtml_TtType")
xhtml_IType = Class(name="xhtml_IType")
xhtml_BType = Class(name="xhtml_BType")
xhtml_SmallType = Class(name="xhtml_SmallType")
xhtml_EmType = Class(name="xhtml_EmType")
xhtml_StrongType = Class(name="xhtml_StrongType")
xhtml_DfnType = Class(name="xhtml_DfnType")
xhtml_CodeType = Class(name="xhtml_CodeType")
xhtml_QType = Class(name="xhtml_QType")
xhtml_SampType = Class(name="xhtml_SampType")
xhtml_BigType = Class(name="xhtml_BigType")
xhtml_KbdType = Class(name="xhtml_KbdType")
xhtml_VarType = Class(name="xhtml_VarType")
xhtml_CiteType = Class(name="xhtml_CiteType")
xhtml_AcronymType = Class(name="xhtml_AcronymType")
xhtml_SubType = Class(name="xhtml_SubType")
xhtml_SupType = Class(name="xhtml_SupType")
xhtml_AddressType = Class(name="xhtml_AddressType")
xhtml_AreaType = Class(name="xhtml_AreaType")
xhtml_AType = Class(name="xhtml_AType")
AContent = Class(name="AContent")
xhtml_Block = Class(name="xhtml_Block")
xhtml_PType = Class(name="xhtml_PType")
xhtml_H1Type = Class(name="xhtml_H1Type")
xhtml_H3Type = Class(name="xhtml_H3Type")
xhtml_H4Type = Class(name="xhtml_H4Type")
xhtml_H5Type = Class(name="xhtml_H5Type")
xhtml_H6Type = Class(name="xhtml_H6Type")
xhtml_DivType = Class(name="xhtml_DivType")
xhtml_UlType = Class(name="xhtml_UlType")
xhtml_OlType = Class(name="xhtml_OlType")
xhtml_H2Type = Class(name="xhtml_H2Type")
xhtml_DlType = Class(name="xhtml_DlType")
xhtml_PreType = Class(name="xhtml_PreType")
xhtml_HrType = Class(name="xhtml_HrType")
xhtml_BlockquoteType = Class(name="xhtml_BlockquoteType")
xhtml_TableType = Class(name="xhtml_TableType")
Block = Class(name="Block")
xhtml_CaptionType = Class(name="xhtml_CaptionType")
xhtml_ColgroupType = Class(name="xhtml_ColgroupType")
xhtml_ColType = Class(name="xhtml_ColType")
xhtml_DdType = Class(name="xhtml_DdType")
Flow = Class(name="Flow")
xhtml_DtType = Class(name="xhtml_DtType")
xhtml_DocumentRoot = Class(name="xhtml_DocumentRoot")
xhtml_EStringToStringMapEntry = Class(name="xhtml_EStringToStringMapEntry")
xhtml_LiType = Class(name="xhtml_LiType")
xhtml_TdType = Class(name="xhtml_TdType")
xhtml_TfootType = Class(name="xhtml_TfootType")
xhtml_ThType = Class(name="xhtml_ThType")
xhtml_TheadType = Class(name="xhtml_TheadType")
xhtml_TrType = Class(name="xhtml_TrType")
xhtml_TbodyType = Class(name="xhtml_TbodyType")
xhtml_Flow = Class(name="xhtml_Flow")
xhtml_Inline = Class(name="xhtml_Inline")
xhtml_PreContent = Class(name="xhtml_PreContent")
PreContent = Class(name="PreContent")

# xhtml_AbbrType class attributes and methods
xhtml_AbbrType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_AbbrType.attributes={xhtml_AbbrType_dir, xhtml_AbbrType_lang, xhtml_AbbrType_style, xhtml_AbbrType_id, xhtml_AbbrType_class_, xhtml_AbbrType_lang1, xhtml_AbbrType_title}
...
xhtml_BrType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_BrType.attributes={xhtml_BrType_id, xhtml_BrType_style, xhtml_BrType_class_, xhtml_BrType_title}
...
xhtml_SpanType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_SpanType.attributes={xhtml_SpanType_dir, xhtml_SpanType_title, xhtml_SpanType_style, xhtml_SpanType_class_, xhtml_SpanType_lang1, xhtml_SpanType_id, xhtml_SpanType_lang}

# xhtml_BdoType class attributes and methods
xhtml_BdoType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_BdoType.attributes={xhtml_BdoType_class_, xhtml_BdoType_id, xhtml_BdoType_title, xhtml_BdoType_style, xhtml_BdoType_lang, xhtml_BdoType_dir, xhtml_BdoType_lang1}

# xhtml_MapType class attributes and methods
xhtml_MapType_block: Property = Property(name="block", type=StringType)
xhtml_MapType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_MapType.attributes={xhtml_MapType_style, xhtml_MapType_class_, xhtml_MapType_lang, xhtml_MapType_name, xhtml_MapType_title, xhtml_MapType_lang1, xhtml_MapType_block, xhtml_MapType_id, xhtml_MapType_dir}
...
xhtml_ImgType_class_: Property = Property(name="class_", type=StringType)
xhtml_ImgType.attributes={xhtml_ImgType_src, xhtml_ImgType_height, xhtml_ImgType_alt, xhtml_ImgType_width, xhtml_ImgType_usemap, xhtml_ImgType_longdesc, xhtml_ImgType_title, xhtml_ImgType_id, xhtml_ImgType_lang, xhtml_ImgType_class_, xhtml_ImgType_lang1, xhtml_ImgType_dir, xhtml_ImgType_ismap, xhtml_ImgType_style}

# xhtml_TtType class attributes and methods
xhtml_TtType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_TtType.attributes={xhtml_TtType_style, xhtml_TtType_dir, xhtml_TtType_lang1, xhtml_TtType_title, xhtml_TtType_lang, xhtml_TtType_id, xhtml_TtType_class_}

# xhtml_IType class attributes and methods
xhtml_IType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_IType.attributes={xhtml_IType_dir, xhtml_IType_style, xhtml_IType_class_, xhtml_IType_id, xhtml_IType_lang1, xhtml_IType_title, xhtml_IType_lang}
...
xhtml_BType_class_: Property = Property(name="class_", type=StringType)
xhtml_BType.attributes={xhtml_BType_dir, xhtml_BType_class_, xhtml_BType_title, xhtml_BType_lang, xhtml_BType_lang1, xhtml_BType_style, xhtml_BType_id}
...
xhtml_SmallType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_SmallType.attributes={xhtml_SmallType_id, xhtml_SmallType_class_, xhtml_SmallType_lang1, xhtml_SmallType_dir, xhtml_SmallType_title, xhtml_SmallType_style, xhtml_SmallType_lang}

# xhtml_EmType class attributes and methods
xhtml_EmType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_EmType.attributes={xhtml_EmType_style, xhtml_EmType_title, xhtml_EmType_class_, xhtml_EmType_lang, xhtml_EmType_dir, xhtml_EmType_lang1, xhtml_EmType_id}

# xhtml_StrongType class attributes and methods
xhtml_StrongType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_StrongType.attributes={xhtml_StrongType_lang, xhtml_StrongType_id, xhtml_StrongType_lang1, xhtml_StrongType_style, xhtml_StrongType_dir, xhtml_StrongType_class_, xhtml_StrongType_title}

# xhtml_DfnType class attributes and methods
xhtml_DfnType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_DfnType.attributes={xhtml_DfnType_style, xhtml_DfnType_title, xhtml_DfnType_lang1, xhtml_DfnType_id, xhtml_DfnType_lang, xhtml_DfnType_dir, xhtml_DfnType_class_}

# xhtml_CodeType class attributes and methods
xhtml_CodeType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_CodeType.attributes={xhtml_CodeType_id, xhtml_CodeType_lang1, xhtml_CodeType_title, xhtml_CodeType_dir, xhtml_CodeType_class_, xhtml_CodeType_lang, xhtml_CodeType_style}
...
xhtml_QType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_QType.attributes={xhtml_QType_cite1, xhtml_QType_lang, xhtml_QType_style, xhtml_QType_id, xhtml_QType_lang1, xhtml_QType_title, xhtml_QType_dir, xhtml_QType_class_}

# xhtml_SampType class attributes and methods
xhtml_SampType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_SampType.attributes={xhtml_SampType_title, xhtml_SampType_class_, xhtml_SampType_id, xhtml_SampType_dir, xhtml_SampType_lang, xhtml_SampType_style, xhtml_SampType_lang1}

# xhtml_BigType class attributes and methods
xhtml_BigType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_BigType.attributes={xhtml_BigType_lang, xhtml_BigType_dir, xhtml_BigType_class_, xhtml_BigType_style, xhtml_BigType_id, xhtml_BigType_title, xhtml_BigType_lang1}

# xhtml_KbdType class attributes and methods
xhtml_KbdType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_KbdType.attributes={xhtml_KbdType_dir, xhtml_KbdType_lang1, xhtml_KbdType_style, xhtml_KbdType_lang, xhtml_KbdType_class_, xhtml_KbdType_title, xhtml_KbdType_id}

# xhtml_VarType class attributes and methods
xhtml_VarType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_VarType.attributes={xhtml_VarType_style, xhtml_VarType_id, xhtml_VarType_lang1, xhtml_VarType_class_, xhtml_VarType_lang, xhtml_VarType_dir, xhtml_VarType_title}

# xhtml_CiteType class attributes and methods
xhtml_CiteType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_CiteType.attributes={xhtml_CiteType_dir, xhtml_CiteType_lang, xhtml_CiteType_id, xhtml_CiteType_style, xhtml_CiteType_title, xhtml_CiteType_class_, xhtml_CiteType_lang1}

# xhtml_AcronymType class attributes and methods
xhtml_AcronymType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_AcronymType.attributes={xhtml_AcronymType_id, xhtml_AcronymType_style, xhtml_AcronymType_lang1, xhtml_AcronymType_class_, xhtml_AcronymType_dir, xhtml_AcronymType_lang, xhtml_AcronymType_title}
...
xhtml_SubType_class_: Property = Property(name="class_", type=StringType)
xhtml_SubType_dir: Property = Property(name="dir", type=StringType)
xhtml_SubType_id: Property = Property(name="id", type=StringType)
xhtml_SubType.attributes={xhtml_SubType_dir, xhtml_SubType_class_, xhtml_SubType_style, xhtml_SubType_lang1, xhtml_SubType_title, xhtml_SubType_id, xhtml_SubType_lang}

# xhtml_SupType class attributes and methods
xhtml_SupType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_SupType.attributes={xhtml_SupType_id, xhtml_SupType_dir, xhtml_SupType_lang, xhtml_SupType_style, xhtml_SupType_class_, xhtml_SupType_title, xhtml_SupType_lang1}

# xhtml_AddressType class attributes and methods
xhtml_AddressType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_AddressType.attributes={xhtml_AddressType_lang, xhtml_AddressType_dir, xhtml_AddressType_title, xhtml_AddressType_class_, xhtml_AddressType_id, xhtml_AddressType_style, xhtml_AddressType_lang1}
...
xhtml_AreaType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_AreaType.attributes={xhtml_AreaType_lang, xhtml_AreaType_class_, xhtml_AreaType_id, xhtml_AreaType_lang1, xhtml_AreaType_tabindex, xhtml_AreaType_coords, xhtml_AreaType_title, xhtml_AreaType_style, xhtml_AreaType_dir, xhtml_AreaType_shape, xhtml_AreaType_href, xhtml_AreaType_accesskey, xhtml_AreaType_alt, xhtml_AreaType_nohref}
...
xhtml_AType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_AType.attributes={xhtml_AType_dir, xhtml_AType_rev, xhtml_AType_shape, xhtml_AType_type, xhtml_AType_charset, xhtml_AType_lang, xhtml_AType_hreflang, xhtml_AType_style, xhtml_AType_name, xhtml_AType_accesskey, xhtml_AType_href, xhtml_AType_tabindex, xhtml_AType_class_, xhtml_AType_title, xhtml_AType_rel, xhtml_AType_coords, xhtml_AType_lang1, xhtml_AType_id}
...
xhtml_PType_class_: Property = Property(name="class_", type=StringType)
xhtml_PType_dir: Property = Property(name="dir", type=StringType)
xhtml_PType_id: Property = Property(name="id", type=StringType)
xhtml_PType.attributes={xhtml_PType_dir, xhtml_PType_class_, xhtml_PType_id, xhtml_PType_lang1, xhtml_PType_title, xhtml_PType_lang, xhtml_PType_style}

# xhtml_H1Type class attributes and methods
xhtml_H1Type_class_: Property = Property(name="class_", type=StringType)
...
xhtml_H1Type.attributes={xhtml_H1Type_title, xhtml_H1Type_lang1, xhtml_H1Type_lang, xhtml_H1Type_class_, xhtml_H1Type_id, xhtml_H1Type_dir, xhtml_H1Type_style}

# xhtml_H3Type class attributes and methods
xhtml_H3Type_class_: Property = Property(name="class_", type=StringType)
...
xhtml_H3Type.attributes={xhtml_H3Type_class_, xhtml_H3Type_dir, xhtml_H3Type_lang1, xhtml_H3Type_lang, xhtml_H3Type_style, xhtml_H3Type_id, xhtml_H3Type_title}

# xhtml_H4Type class attributes and methods
xhtml_H4Type_class_: Property = Property(name="class_", type=StringType)
...
xhtml_H4Type.attributes={xhtml_H4Type_dir, xhtml_H4Type_lang1, xhtml_H4Type_lang, xhtml_H4Type_title, xhtml_H4Type_class_, xhtml_H4Type_style, xhtml_H4Type_id}

# xhtml_H5Type class attributes and methods
xhtml_H5Type_class_: Property = Property(name="class_", type=StringType)
...
xhtml_H5Type.attributes={xhtml_H5Type_title, xhtml_H5Type_id, xhtml_H5Type_dir, xhtml_H5Type_class_, xhtml_H5Type_style, xhtml_H5Type_lang, xhtml_H5Type_lang1}

# xhtml_H6Type class attributes and methods
xhtml_H6Type_class_: Property = Property(name="class_", type=StringType)
...
xhtml_H6Type.attributes={xhtml_H6Type_id, xhtml_H6Type_lang1, xhtml_H6Type_class_, xhtml_H6Type_style, xhtml_H6Type_lang, xhtml_H6Type_title, xhtml_H6Type_dir}

# xhtml_DivType class attributes and methods
xhtml_DivType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_DivType.attributes={xhtml_DivType_class_, xhtml_DivType_dir, xhtml_DivType_id, xhtml_DivType_lang, xhtml_DivType_style, xhtml_DivType_lang1, xhtml_DivType_title}
...
xhtml_UlType_class_: Property = Property(name="class_", type=StringType)
xhtml_UlType_dir: Property = Property(name="dir", type=StringType)
xhtml_UlType_id: Property = Property(name="id", type=StringType)
xhtml_UlType.attributes={xhtml_UlType_title, xhtml_UlType_lang, xhtml_UlType_dir, xhtml_UlType_id, xhtml_UlType_style, xhtml_UlType_class_, xhtml_UlType_lang1}
...
xhtml_OlType_class_: Property = Property(name="class_", type=StringType)
xhtml_OlType_dir: Property = Property(name="dir", type=StringType)
xhtml_OlType_id: Property = Property(name="id", type=StringType)
xhtml_OlType.attributes={xhtml_OlType_id, xhtml_OlType_lang, xhtml_OlType_title, xhtml_OlType_style, xhtml_OlType_lang1, xhtml_OlType_class_, xhtml_OlType_dir}

# xhtml_H2Type class attributes and methods
xhtml_H2Type_class_: Property = Property(name="class_", type=StringType)
...
xhtml_H2Type.attributes={xhtml_H2Type_class_, xhtml_H2Type_style, xhtml_H2Type_dir, xhtml_H2Type_lang1, xhtml_H2Type_id, xhtml_H2Type_lang, xhtml_H2Type_title}

# xhtml_DlType class attributes and methods
xhtml_DlType_group: Property = Property(name="group", type=StringType)
xhtml_DlType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_DlType.attributes={xhtml_DlType_title, xhtml_DlType_lang, xhtml_DlType_style, xhtml_DlType_lang1, xhtml_DlType_class_, xhtml_DlType_dir, xhtml_DlType_group, xhtml_DlType_id}
...
xhtml_PreType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_PreType.attributes={xhtml_PreType_space, xhtml_PreType_lang, xhtml_PreType_title, xhtml_PreType_class_, xhtml_PreType_lang1, xhtml_PreType_style, xhtml_PreType_id, xhtml_PreType_dir}

# xhtml_HrType class attributes and methods
xhtml_HrType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_HrType.attributes={xhtml_HrType_class_, xhtml_HrType_lang1, xhtml_HrType_style, xhtml_HrType_title, xhtml_HrType_dir, xhtml_HrType_id, xhtml_HrType_lang}

# xhtml_BlockquoteType class attributes and methods
xhtml_BlockquoteType_cite: Property = Property(name="cite", type=StringType)
xhtml_BlockquoteType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_BlockquoteType.attributes={xhtml_BlockquoteType_id, xhtml_BlockquoteType_lang, xhtml_BlockquoteType_style, xhtml_BlockquoteType_title, xhtml_BlockquoteType_class_, xhtml_BlockquoteType_cite, xhtml_BlockquoteType_lang1, xhtml_BlockquoteType_dir}
...
xhtml_TableType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_TableType.attributes={xhtml_TableType_rules, xhtml_TableType_cellspacing, xhtml_TableType_class_, xhtml_TableType_lang1, xhtml_TableType_lang, xhtml_TableType_cellpadding, xhtml_TableType_title, xhtml_TableType_width, xhtml_TableType_style, xhtml_TableType_frame, xhtml_TableType_id, xhtml_TableType_dir, xhtml_TableType_border, xhtml_TableType_summary}

# Block class attributes and methods

# xhtml_CaptionType class attributes and methods
xhtml_CaptionType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_CaptionType.attributes={xhtml_CaptionType_id, xhtml_CaptionType_lang1, xhtml_CaptionType_dir, xhtml_CaptionType_lang, xhtml_CaptionType_style, xhtml_CaptionType_class_, xhtml_CaptionType_title}
...
xhtml_ColgroupType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_ColgroupType.attributes={xhtml_ColgroupType_lang, xhtml_ColgroupType_width, xhtml_ColgroupType_style, xhtml_ColgroupType_valign, xhtml_ColgroupType_class_, xhtml_ColgroupType_char, xhtml_ColgroupType_lang1, xhtml_ColgroupType_span, xhtml_ColgroupType_align, xhtml_ColgroupType_title, xhtml_ColgroupType_dir, xhtml_ColgroupType_id, xhtml_ColgroupType_charoff}
...
xhtml_ColType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_ColType.attributes={xhtml_ColType_align, xhtml_ColType_id, xhtml_ColType_style, xhtml_ColType_dir, xhtml_ColType_class_, xhtml_ColType_charoff, xhtml_ColType_span, xhtml_ColType_lang, xhtml_ColType_valign, xhtml_ColType_width, xhtml_ColType_char, xhtml_ColType_title, xhtml_ColType_lang1}

# xhtml_DdType class attributes and methods
xhtml_DdType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_DdType.attributes={xhtml_DdType_lang1, xhtml_DdType_class_, xhtml_DdType_style, xhtml_DdType_lang, xhtml_DdType_dir, xhtml_DdType_title, xhtml_DdType_id}

# Flow class attributes and methods

# xhtml_DtType class attributes and methods
xhtml_DtType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_DtType.attributes={xhtml_DtType_dir, xhtml_DtType_lang1, xhtml_DtType_style, xhtml_DtType_title, xhtml_DtType_lang, xhtml_DtType_class_, xhtml_DtType_id}
...
xhtml_LiType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_LiType.attributes={xhtml_LiType_id, xhtml_LiType_lang1, xhtml_LiType_style, xhtml_LiType_class_, xhtml_LiType_lang, xhtml_LiType_dir, xhtml_LiType_title}
...
xhtml_TdType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_TdType.attributes={xhtml_TdType_axis, xhtml_TdType_abbr1, xhtml_TdType_char, xhtml_TdType_headers, xhtml_TdType_align, xhtml_TdType_rowspan, xhtml_TdType_valign, xhtml_TdType_dir, xhtml_TdType_lang, xhtml_TdType_class_, xhtml_TdType_id, xhtml_TdType_charoff, xhtml_TdType_lang1, xhtml_TdType_title, xhtml_TdType_style, xhtml_TdType_colspan, xhtml_TdType_scope}
...
xhtml_TfootType_class_: Property = Property(name="class_", type=StringType)
xhtml_TfootType.attributes={xhtml_TfootType_dir, xhtml_TfootType_style, xhtml_TfootType_align, xhtml_TfootType_charoff, xhtml_TfootType_lang1, xhtml_TfootType_lang, xhtml_TfootType_id, xhtml_TfootType_class_, xhtml_TfootType_char, xhtml_TfootType_valign, xhtml_TfootType_title}

# xhtml_ThType class attributes and methods
xhtml_ThType_charoff: Property = Property(name="charoff", type=StringType)
xhtml_ThType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_ThType.attributes={xhtml_ThType_rowspan, xhtml_ThType_id, xhtml_ThType_title, xhtml_ThType_char, xhtml_ThType_headers, xhtml_ThType_style, xhtml_ThType_dir, xhtml_ThType_lang1, xhtml_ThType_abbr1, xhtml_ThType_colspan, xhtml_ThType_charoff, xhtml_ThType_scope, xhtml_ThType_class_, xhtml_ThType_align, xhtml_ThType_lang, xhtml_ThType_axis, xhtml_ThType_valign}
...
xhtml_TheadType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_TheadType.attributes={xhtml_TheadType_dir, xhtml_TheadType_valign, xhtml_TheadType_title, xhtml_TheadType_class_, xhtml_TheadType_id, xhtml_TheadType_style, xhtml_TheadType_align, xhtml_TheadType_char, xhtml_TheadType_lang, xhtml_TheadType_charoff, xhtml_TheadType_lang1}
...
xhtml_TrType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_TrType.attributes={xhtml_TrType_group, xhtml_TrType_lang, xhtml_TrType_class_, xhtml_TrType_lang1, xhtml_TrType_title, xhtml_TrType_char, xhtml_TrType_valign, xhtml_TrType_id, xhtml_TrType_align, xhtml_TrType_dir, xhtml_TrType_charoff, xhtml_TrType_style}
...
xhtml_TbodyType_class_: Property = Property(name="class_", type=StringType)
...
xhtml_TbodyType.attributes={xhtml_TbodyType_lang, xhtml_TbodyType_char, xhtml_TbodyType_align, xhtml_TbodyType_lang1, xhtml_TbodyType_title, xhtml_TbodyType_valign, xhtml_TbodyType_style, xhtml_TbodyType_dir, xhtml_TbodyType_charoff, xhtml_TbodyType_class_, xhtml_TbodyType_id}
...
domain_model = DomainModel(
    name="xhtml",
    types={xhtml_AbbrType, Inline, xhtml_AContent, xhtml_BrType, xhtml_SpanType, xhtml_BdoType, xhtml_MapType, xhtml_ImgType, xhtml_TtType, xhtml_IType, xhtml_BType, xhtml_SmallType, xhtml_EmType, xhtml_StrongType, xhtml_DfnType, xhtml_CodeType, xhtml_QType, xhtml_SampType, xhtml_BigType, xhtml_KbdType, xhtml_VarType, xhtml_CiteType, xhtml_AcronymType, xhtml_SubType, xhtml_SupType, xhtml_AddressType, xhtml_AreaType, xhtml_AType, AContent, xhtml_Block, xhtml_PType, xhtml_H1Type, xhtml_H3Type, xhtml_H4Type, xhtml_H5Type, xhtml_H6Type, xhtml_DivType, xhtml_UlType, xhtml_OlType, xhtml_H2Type, xhtml_DlType, xhtml_PreType, xhtml_HrType, xhtml_BlockquoteType, xhtml_TableType, Block, xhtml_CaptionType, xhtml_ColgroupType, xhtml_ColType, xhtml_DdType, Flow, xhtml_DtType, xhtml_DocumentRoot, xhtml_EStringToStringMapEntry, xhtml_LiType, xhtml_TdType, xhtml_TfootType, xhtml_ThType, xhtml_TheadType, xhtml_TrType, xhtml_TbodyType, xhtml_Flow, xhtml_Inline, xhtml_PreContent, PreContent, AlignType, DirType, DirType1, IsmapType, NohrefType, Scope, Shape, TFrame, TRules, ValignType},
    associations={br0, span1, bdo3, map5, img7, tt9, i11, b13, small17, em19, strong21, dfn23, code25, q27, big15, kbd31, var33, cite35, abbr37, acronym39, sub41, sup43, samp29, p45, h146, h248, h350, h452, h554, h656, div58, ul60, ol62, dl64, pre66, hr68, blockquote70, address72, table74, col76, dt77, dd79, xMLNSPrefixMap81, xSISchemaLocation82, a85, abbr87, acronym90, address93, area96, b98, big104, blockquote107, br110, caption113, cite115, code118, col121, bdo101, dd127, dfn130, div133, dl136, dt139, em142, h1145, colgroup124, h3151, h4154, h5157, h6160, hr163, i166, img169, h2148, kbd172, li175, map177, ol180, p183, pre186, q189, samp192, small195, span198, strong201, sub204, sup207, table210, td215, tfoot217, th219, thead221, tr223, tt225, tbody213, ul228, var231, p234, h1236, h2239, h4245, h5248, h6251, div254, ul257, ol260, h3242, dl263, pre266, hr269, blockquote272, address275, table278, a281, br284, span287, bdo290, map293, img296, tt299, i302, b305, big308, small311, em314, strong317, dfn320, code323, samp329, kbd332, var335, cite338, abbr341, acronym344, q326, sup350, sub347, br355, span358, bdo361, map364, img367, tt370, i373, a353, big379, small382, em385, strong388, dfn391, code394, q397, b376, samp400, kbd403, var406, cite409, abbr412, acronym415, sub418, sup421, p424, h1427, h2430, h5439, h3433, h4436, ol451, dl454, pre457, h6442, div445, ul448, area472, hr460, blockquote463, address466, table469, li475, a478, tt480, small492, i483, b486, big489, code504, em495, strong498, dfn501, var516, cite519, q507, samp510, kbd513, sup531, br534, abbr522, acronym525, sub528, map543, span537, bdo540, caption546, col549, colgroup552, thead555, tfoot558, tbody561, tr564, tr567, tr570, tr573, th576, td579, li582},
    generalizations={gen_xhtml_AbbrType_Inline, gen_xhtml_AcronymType_Inline, gen_xhtml_AddressType_Inline, gen_xhtml_AType_AContent, gen_xhtml_BdoType_Inline, gen_xhtml_BigType_Inline, gen_xhtml_BlockquoteType_Block, gen_xhtml_BType_Inline, gen_xhtml_CaptionType_Inline, gen_xhtml_CiteType_Inline, gen_xhtml_CodeType_Inline, gen_xhtml_DdType_Flow, gen_xhtml_DfnType_Inline, gen_xhtml_DivType_Flow, gen_xhtml_DtType_Inline, gen_xhtml_EmType_Inline, gen_xhtml_H1Type_Inline, gen_xhtml_H2Type_Inline, gen_xhtml_H3Type_Inline, gen_xhtml_H4Type_Inline, gen_xhtml_H5Type_Inline, gen_xhtml_H6Type_Inline, gen_xhtml_IType_Inline, gen_xhtml_KbdType_Inline, gen_xhtml_LiType_Flow, gen_xhtml_PreType_PreContent, gen_xhtml_QType_Inline, gen_xhtml_PType_Inline, gen_xhtml_SampType_Inline, gen_xhtml_SpanType_Inline, gen_xhtml_SmallType_Inline, gen_xhtml_StrongType_Inline, gen_xhtml_SupType_Inline, gen_xhtml_SubType_Inline, gen_xhtml_TdType_Flow, gen_xhtml_ThType_Flow, gen_xhtml_TtType_Inline, gen_xhtml_VarType_Inline},
    metadata=None
)
