...
class selflet_SelfletProperties:
    ...
    def __init__(self, author: str, description: str, limePort: str, enableOptimizationPolicy: str, enableCloudOptimizationPolicy: str, selflet_SelfletProperties17: "selflet_Empty" = None, selflet_SelfletProperties: "selflet_Selflet" = None, selflet_SelfletProperties19: "selflet_Active" = None, selflet_SelfletProperties21: "selflet_Reds" = None, selflet_SelfletProperties23: "selflet_GeneralKnowledge" = None, selflet_SelfletProperties26: "selflet_TypeKnowledge" = None):
        self.author = author
        ...
        pass
    @property
    def enableCloudOptimizationPolicy(self):
    ...
    @property
    def enableOptimizationPolicy(self):
...
class selflet_Method:
    ...
    def __init__(self, paramType: str, name: str, selflet_Method: "selflet_Methods" = None):
...
class selflet_Service:
    ...
    def __init__(self, active: str, revenue: str, maxResponseTime: str, name: str, selflet_Service67: "selflet_IntermediateState" = None, selflet_Service: "selflet_Behavior" = None, selflet_Service45: "selflet_Input" = None, selflet_Service48: "selflet_Output" = None, selflet_Service43: "selflet_Services" = None, selflet_Service51: "selflet_OfferMode" = None, selflet_Service53: set["selflet_Behavior"] = None):
        self.active = active
...
class selflet_Behavior:
    ...
    @property
    def elementaryBehaviorCost(self):
    ...
    @property
    def elementaryBehaviorCPUTime(self):
