...
selflet_CPUUtilization.attributes={selflet_CPUUtilization_upperBound, selflet_CPUUtilization_lowerBound}
...
selflet_Behavior.attributes={selflet_Behavior_elementaryBehaviorCPUTime, selflet_Behavior_name, selflet_Behavior_elementaryBehaviorCost, selflet_Behavior_fileName, selflet_Behavior_isDefaultBehavior}
...
selflet_Service.attributes={selflet_Service_revenue, selflet_Service_maxResponseTime, selflet_Service_name, selflet_Service_active}
...
selflet_SelfLetProperty.attributes={selflet_SelfLetProperty_name, selflet_SelfLetProperty_value, selflet_SelfLetProperty_type}
...
selflet_SelfletProperties.attributes={selflet_SelfletProperties_enableCloudOptimizationPolicy, selflet_SelfletProperties_enableOptimizationPolicy, selflet_SelfletProperties_description, selflet_SelfletProperties_limePort, selflet_SelfletProperties_author}
...
domain_model = DomainModel(
    name="selflet",
    types={selflet_Action, selflet_Active, selflet_Abilities, selflet_Ability, selflet_Methods, selflet_Actions, selflet_CPUUtilization, selflet_Empty, selflet_GeneralKnowledge, selflet_Behavior, selflet_Service, selflet_Conditions, selflet_Condition, selflet_Method, selflet_SelfLetProperty, selflet_Input, selflet_Parameter, selflet_OfferMode, selflet_Reds, selflet_Output, selflet_Rules, selflet_Rule, selflet_Selflet, selflet_SelfletProperties, selflet_SelfletResources, selflet_TypeKnowledge, selflet_Services, selflet_ElementaryBehavior, Behavior, selflet_State, selflet_ComplexBehavior, selflet_InitialState, State, selflet_FinalState, selflet_AbilityState, selflet_IntermediateState, Mode, Type},
    associations={action3, ability0, methods1, implements4, condition5, selfLetProperty6, parameter7, method8, parameter10, passive16, rule12, selfletProperties13, selfletResources14, active18, reds20, generalknowledge22, typeKnowledge25, input44, output47, abilities27, actions30, conditions33, services36, rules38, service41, states58, states59, offermode50, implementations52, selfLetProperty55, next62, do64, invoke66},
