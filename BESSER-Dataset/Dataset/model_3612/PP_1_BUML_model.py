...
# Classes
pp1_PuppetManifest = Class(name="pp1_PuppetManifest")
ExpressionBlock = Class(name="ExpressionBlock")
pp1_Expression = Class(name="pp1_Expression")
pp1_ResourceBody = Class(name="pp1_ResourceBody")
pp1_AttributeOperations = Class(name="pp1_AttributeOperations")
pp1_AttributeOperation = Class(name="pp1_AttributeOperation")
pp1_ICollectQuery = Class(name="pp1_ICollectQuery", is_abstract=True)
pp1_VirtualCollectQuery = Class(name="pp1_VirtualCollectQuery")
UnaryExpression = Class(name="UnaryExpression")
ICollectQuery = Class(name="ICollectQuery")
pp1_ExportedCollectQuery = Class(name="pp1_ExportedCollectQuery")
pp1_HostClassDefinition = Class(name="pp1_HostClassDefinition")
Definition = Class(name="Definition")
pp1_LiteralExpression = Class(name="pp1_LiteralExpression", is_abstract=True)
pp1_Definition = Class(name="pp1_Definition")
Expression = Class(name="Expression")
pp1_DefinitionArgumentList = Class(name="pp1_DefinitionArgumentList")
pp1_DefinitionArgument = Class(name="pp1_DefinitionArgument")
pp1_IfExpression = Class(name="pp1_IfExpression")
pp1_LiteralNameOrReference = Class(name="pp1_LiteralNameOrReference")
LiteralExpression = Class(name="LiteralExpression")
pp1_ResourceExpression = Class(name="pp1_ResourceExpression")
pp1_ImportExpression = Class(name="pp1_ImportExpression")
pp1_IQuotedString = Class(name="pp1_IQuotedString", is_abstract=True)
pp1_LiteralList = Class(name="pp1_LiteralList")
pp1_LiteralHash = Class(name="pp1_LiteralHash")
pp1_HashEntry = Class(name="pp1_HashEntry")
pp1_LiteralBoolean = Class(name="pp1_LiteralBoolean")
pp1_CaseExpression = Class(name="pp1_CaseExpression")
pp1_RelationshipExpression = Class(name="pp1_RelationshipExpression")
BinaryOpExpression = Class(name="BinaryOpExpression")
pp1_Case = Class(name="pp1_Case")
pp1_AssignmentExpression = Class(name="pp1_AssignmentExpression")
BinaryExpression = Class(name="BinaryExpression")
pp1_AppendExpression = Class(name="pp1_AppendExpression")
pp1_OrExpression = Class(name="pp1_OrExpression")
pp1_AndExpression = Class(name="pp1_AndExpression")
pp1_RelationalExpression = Class(name="pp1_RelationalExpression")
pp1_EqualityExpression = Class(name="pp1_EqualityExpression")
pp1_ShiftExpression = Class(name="pp1_ShiftExpression")
pp1_AdditiveExpression = Class(name="pp1_AdditiveExpression")
pp1_MultiplicativeExpression = Class(name="pp1_MultiplicativeExpression")
pp1_MatchingExpression = Class(name="pp1_MatchingExpression")
pp1_InExpression = Class(name="pp1_InExpression")
pp1_AtExpression = Class(name="pp1_AtExpression")
ParameterizedExpression = Class(name="ParameterizedExpression")
pp1_CollectExpression = Class(name="pp1_CollectExpression")
pp1_SelectorExpression = Class(name="pp1_SelectorExpression")
pp1_SelectorEntry = Class(name="pp1_SelectorEntry")
pp1_FunctionCall = Class(name="pp1_FunctionCall")
WithLambdaExpression = Class(name="WithLambdaExpression")
pp1_BinaryOpExpression = Class(name="pp1_BinaryOpExpression", is_abstract=True)
pp1_BinaryExpression = Class(name="pp1_BinaryExpression", is_abstract=True)
pp1_ParameterizedExpression = Class(name="pp1_ParameterizedExpression", is_abstract=True)
pp1_LiteralUndef = Class(name="pp1_LiteralUndef")
pp1_LiteralDefault = Class(name="pp1_LiteralDefault")
pp1_LiteralRegex = Class(name="pp1_LiteralRegex")
pp1_LiteralName = Class(name="pp1_LiteralName")
pp1_VariableExpression = Class(name="pp1_VariableExpression")
pp1_UnaryMinusExpression = Class(name="pp1_UnaryMinusExpression")
pp1_UnaryNotExpression = Class(name="pp1_UnaryNotExpression")
pp1_ExpressionBlock = Class(name="pp1_ExpressionBlock", is_abstract=True)
pp1_ElseExpression = Class(name="pp1_ElseExpression")
pp1_ElseIfExpression = Class(name="pp1_ElseIfExpression")
IfExpression = Class(name="IfExpression")
pp1_VirtualNameOrReference = Class(name="pp1_VirtualNameOrReference")
pp1_ParenthesisedExpression = Class(name="pp1_ParenthesisedExpression")
pp1_ExprList = Class(name="pp1_ExprList")
pp1_DoubleQuotedString = Class(name="pp1_DoubleQuotedString")
StringExpression = Class(name="StringExpression")
IQuotedString = Class(name="IQuotedString")
pp1_TextExpression = Class(name="pp1_TextExpression", is_abstract=True)
pp1_SingleQuotedString = Class(name="pp1_SingleQuotedString")
pp1_StringExpression = Class(name="pp1_StringExpression", is_abstract=True)
pp1_UnquotedString = Class(name="pp1_UnquotedString")
pp1_InterpolatedVariable = Class(name="pp1_InterpolatedVariable")
pp1_NodeDefinition = Class(name="pp1_NodeDefinition")
pp1_UnaryExpression = Class(name="pp1_UnaryExpression", is_abstract=True)
pp1_Lambda = Class(name="pp1_Lambda", is_abstract=True)
pp1_NamedAccessExpression = Class(name="pp1_NamedAccessExpression")
pp1_MethodCall = Class(name="pp1_MethodCall")
pp1_WithLambdaExpression = Class(name="pp1_WithLambdaExpression")
pp1_JavaLambda = Class(name="pp1_JavaLambda")
Lambda = Class(name="Lambda")
pp1_RubyLambda = Class(name="pp1_RubyLambda")
pp1_SeparatorExpression = Class(name="pp1_SeparatorExpression")
pp1_VerbatimTE = Class(name="pp1_VerbatimTE")
TextExpression = Class(name="TextExpression")
pp1_ExpressionTE = Class(name="pp1_ExpressionTE")
pp1_VariableTE = Class(name="pp1_VariableTE")
pp1_LiteralClass = Class(name="pp1_LiteralClass")
pp1_UnlessExpression = Class(name="pp1_UnlessExpression")
...
pp1_DefinitionArgument.attributes={pp1_DefinitionArgument_op, pp1_DefinitionArgument_argName}
...
lambda_101: BinaryAssociation = BinaryAssociation(
    name="lambda_101",
    ends={
...
domain_model = DomainModel(
    name="pp1",
    types={pp1_PuppetManifest, ExpressionBlock, pp1_Expression, pp1_ResourceBody, pp1_AttributeOperations, pp1_AttributeOperation, pp1_ICollectQuery, pp1_VirtualCollectQuery, UnaryExpression, ICollectQuery, pp1_ExportedCollectQuery, pp1_HostClassDefinition, Definition, pp1_LiteralExpression, pp1_Definition, Expression, pp1_DefinitionArgumentList, pp1_DefinitionArgument, pp1_IfExpression, pp1_LiteralNameOrReference, LiteralExpression, pp1_ResourceExpression, pp1_ImportExpression, pp1_IQuotedString, pp1_LiteralList, pp1_LiteralHash, pp1_HashEntry, pp1_LiteralBoolean, pp1_CaseExpression, pp1_RelationshipExpression, BinaryOpExpression, pp1_Case, pp1_AssignmentExpression, BinaryExpression, pp1_AppendExpression, pp1_OrExpression, pp1_AndExpression, pp1_RelationalExpression, pp1_EqualityExpression, pp1_ShiftExpression, pp1_AdditiveExpression, pp1_MultiplicativeExpression, pp1_MatchingExpression, pp1_InExpression, pp1_AtExpression, ParameterizedExpression, pp1_CollectExpression, pp1_SelectorExpression, pp1_SelectorEntry, pp1_FunctionCall, WithLambdaExpression, pp1_BinaryOpExpression, pp1_BinaryExpression, pp1_ParameterizedExpression, pp1_LiteralUndef, pp1_LiteralDefault, pp1_LiteralRegex, pp1_LiteralName, pp1_VariableExpression, pp1_UnaryMinusExpression, pp1_UnaryNotExpression, pp1_ExpressionBlock, pp1_ElseExpression, pp1_ElseIfExpression, IfExpression, pp1_VirtualNameOrReference, pp1_ParenthesisedExpression, pp1_ExprList, pp1_DoubleQuotedString, StringExpression, IQuotedString, pp1_TextExpression, pp1_SingleQuotedString, pp1_StringExpression, pp1_UnquotedString, pp1_InterpolatedVariable, pp1_NodeDefinition, pp1_UnaryExpression, pp1_Lambda, pp1_NamedAccessExpression, pp1_MethodCall, pp1_WithLambdaExpression, pp1_JavaLambda, Lambda, pp1_RubyLambda, pp1_SeparatorExpression, pp1_VerbatimTE, TextExpression, pp1_ExpressionTE, pp1_VariableTE, pp1_LiteralClass, pp1_UnlessExpression},
    associations={attributes0, nameExpr1, value3, attributes5, parent8, arguments9, statements10, arguments13, cases20, statements22, values25, condExpr28, thenStatements30, elseStatement33, resourceExpr36, resourceData38, values41, elements42, elements44, key45, value48, value15, switchExpr18, classReference51, query53, attributes55, leftExpr58, rightExpr60, leftExpr63, parameters65, expr76, statements78, expr80, expressions82, stringPart84, expression85, hostNames68, parentName70, statements73, condExpr89, thenStatements91, elseStatement94, arguments97, methodExpr99, lambda_101, expression87},
    generalizations={gen_pp1_PuppetManifest_ExpressionBlock, gen_pp1_VirtualCollectQuery_UnaryExpression, gen_pp1_VirtualCollectQuery_ICollectQuery, gen_pp1_ExportedCollectQuery_UnaryExpression, gen_pp1_ExportedCollectQuery_ICollectQuery, gen_pp1_HostClassDefinition_Definition, gen_pp1_Definition_Expression, gen_pp1_IfExpression_Expression, gen_pp1_LiteralExpression_Expression, gen_pp1_LiteralNameOrReference_LiteralExpression, gen_pp1_ResourceExpression_Expression, gen_pp1_ImportExpression_Expression, gen_pp1_LiteralList_LiteralExpression, gen_pp1_LiteralHash_LiteralExpression, gen_pp1_CaseExpression_Expression, gen_pp1_RelationshipExpression_BinaryOpExpression, gen_pp1_AssignmentExpression_BinaryExpression, gen_pp1_AppendExpression_BinaryExpression, gen_pp1_OrExpression_BinaryExpression, gen_pp1_AndExpression_BinaryExpression, gen_pp1_RelationalExpression_BinaryOpExpression, gen_pp1_EqualityExpression_BinaryOpExpression, gen_pp1_ShiftExpression_BinaryOpExpression, gen_pp1_AdditiveExpression_BinaryOpExpression, gen_pp1_MultiplicativeExpression_BinaryOpExpression, gen_pp1_MatchingExpression_BinaryOpExpression, gen_pp1_InExpression_BinaryOpExpression, gen_pp1_AtExpression_ParameterizedExpression, gen_pp1_CollectExpression_Expression, gen_pp1_SelectorExpression_ParameterizedExpression, gen_pp1_SelectorEntry_BinaryExpression, gen_pp1_FunctionCall_WithLambdaExpression, gen_pp1_BinaryOpExpression_BinaryExpression, gen_pp1_BinaryExpression_Expression, gen_pp1_ParameterizedExpression_Expression, gen_pp1_LiteralBoolean_LiteralExpression, gen_pp1_LiteralUndef_LiteralExpression, gen_pp1_LiteralDefault_LiteralExpression, gen_pp1_LiteralRegex_LiteralExpression, gen_pp1_LiteralName_LiteralExpression, gen_pp1_VariableExpression_Expression, gen_pp1_UnaryExpression_Expression, gen_pp1_UnaryMinusExpression_UnaryExpression, gen_pp1_UnaryNotExpression_UnaryExpression, gen_pp1_ExpressionBlock_Expression, gen_pp1_ElseExpression_ExpressionBlock, gen_pp1_ElseIfExpression_IfExpression, gen_pp1_VirtualNameOrReference_LiteralExpression, gen_pp1_ParenthesisedExpression_Expression, gen_pp1_ExprList_Expression, gen_pp1_DoubleQuotedString_StringExpression, gen_pp1_DoubleQuotedString_IQuotedString, gen_pp1_SingleQuotedString_StringExpression, gen_pp1_SingleQuotedString_IQuotedString, gen_pp1_StringExpression_Expression, gen_pp1_UnquotedString_StringExpression, gen_pp1_InterpolatedVariable_Expression, gen_pp1_NodeDefinition_Expression, gen_pp1_UnlessExpression_Expression, gen_pp1_Lambda_ExpressionBlock, gen_pp1_NamedAccessExpression_BinaryExpression, gen_pp1_MethodCall_WithLambdaExpression, gen_pp1_WithLambdaExpression_ParameterizedExpression, gen_pp1_JavaLambda_Lambda, gen_pp1_RubyLambda_Lambda, gen_pp1_SeparatorExpression_Expression, gen_pp1_VerbatimTE_TextExpression, gen_pp1_ExpressionTE_TextExpression, gen_pp1_VariableTE_TextExpression, gen_pp1_LiteralClass_LiteralExpression},
    metadata=None
)
