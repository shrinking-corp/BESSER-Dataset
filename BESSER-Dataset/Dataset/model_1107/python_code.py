...
class fsml_FSMTransition:
    ...
    def __init__(self, input: str, action: str, fsml_FSMTransition4: "fsml_FSMState" = None, fsml_FSMTransition: "fsml_FSMState" = None):
        self.input = input
        self.action = action
...
class fsml_FSMState:
    ...
    def __init__(self, initial: bool, name: str, fsml_FSMState: "fsml_FSM" = None, fsml_FSMState5: "fsml_FSMTransition" = None, fsml_FSMState2: set["fsml_FSMTransition"] = None):
    ...
    def hasDistinctEvents(self, fsml_diagnostics, fsml_context) :
        # TODO: Implement hasDistinctEvents method
        pass

    def isReachable(self, fsml_diagnostics, fsml_context) :
...
class fsml_FSM:
    ...
    def hasExactOneInitialState(self, fsml_context, fsml_diagnostics) :
