...
# Classes
model_Equation = Class(name="model_Equation")
model_Implication = Class(name="model_Implication")
model_Disjunction = Class(name="model_Disjunction")
model_Conjunction = Class(name="model_Conjunction")
model_Expression = Class(name="model_Expression", is_abstract=True)
model_ForAllContextualExpression = Class(name="model_ForAllContextualExpression")
Expression = Class(name="Expression")
model_ExistsContextualExpression = Class(name="model_ExistsContextualExpression")
model_Negation = Class(name="model_Negation")
model_PrimaryExpression = Class(name="model_PrimaryExpression")
...
domain_model = DomainModel(
    name="model",
    types={model_Equation, model_Implication, model_Disjunction, model_Conjunction, model_Expression, model_ForAllContextualExpression, Expression, model_ExistsContextualExpression, model_Negation, model_PrimaryExpression},
    associations={expression1, leftPart3, rightPart5, leftPart8, rightPart10, leftPart13, rightPart15, leftPart18, expression0, rightPart20, expression23},
    generalizations={gen_model_Equation_Expression, gen_model_Implication_Expression, gen_model_Disjunction_Expression, gen_model_Conjunction_Expression, gen_model_ForAllContextualExpression_Expression, gen_model_ExistsContextualExpression_Expression, gen_model_Negation_Expression, gen_model_PrimaryExpression_Expression},
    metadata=None
)
