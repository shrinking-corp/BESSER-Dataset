...
class ecore_ETypedElement(ENamedElement):
    ...
    def __init__(self, lowerBound: int, upperBound: int, ecore_ETypedElement: "ecore_EClassifier" = None, ecore_ETypedElement85: "ecore_EGenericType" = None):
...
class ecore_EClassifier(ENamedElement):
    ...
    def __init__(self, instanceTypeName: str, eClassifiers: "ecore_EPackage" = None, ecore_EClassifier: set["ecore_ETypeParameter"] = None, ecore_EClassifier56: "ecore_EOperation" = None, EClassifier: "ecore_EPackage" = None, ecore_EClassifier83: "ecore_ETypedElement" = None, ecore_EClassifier95: "ecore_EGenericType" = None, ecore_EClassifier104: "ecore_EGenericType" = None):
