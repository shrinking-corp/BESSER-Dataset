...
public class LoopExp  {
    ...
    private OCL_Iterator ocl_iterator;
    ...
    public OCL_Iterator getOcl_iterator() {
        return ocl_iterator;
    }

    public void setOcl_iterator(OCL_Iterator ocl_iterator) {
        this.ocl_iterator = ocl_iterator;
    }
