...
class helloworld150_Person(NamedElement):
    ...
    def __init__(self, forName: str, birthDate: str, helloworld150_Person: "helloworld150_World" = None, helloworld150_Person14: "helloworld150_Profession" = None, helloworld150_Person12: "helloworld150_Own" = None):
...
class helloworld150_Thing(NamedElement):
    ...
    def __init__(self, id: int, thing: "helloworld150_Own" = None, helloworld150_Thing7: set["helloworld150_Own"] = None, helloworld150_Thing: "helloworld150_World" = None, Thing: "helloworld150_Own" = None):
        self.id = id
        self.thing = thing
