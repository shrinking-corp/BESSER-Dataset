...
helloworld150_Own = Class(name="helloworld150_Own")
helloworld150_NamedElement = Class(name="helloworld150_NamedElement", is_abstract=True)
helloworld150_Comment = Class(name="helloworld150_Comment")
helloworld150_World = Class(name="helloworld150_World")
helloworld150_Thing = Class(name="helloworld150_Thing")
helloworld150_Person = Class(name="helloworld150_Person")
helloworld150_Profession = Class(name="helloworld150_Profession")
...
helloworld150_Own.attributes={helloworld150_Own_ownerName, helloworld150_Own_since}
...
helloworld150_Person.attributes={helloworld150_Person_forName, helloworld150_Person_birthDate}
...
domain_model = DomainModel(
    name="helloworld150",
    types={NamedElement, helloworld150_Own, helloworld150_NamedElement, helloworld150_Comment, helloworld150_World, helloworld150_Thing, helloworld150_Person, helloworld150_Profession},
    associations={ownership5, ownerships6, comment8, things0, persons1, professions3, profession13, thing9, person10},
    generalizations={gen_helloworld150_Thing_NamedElement, gen_helloworld150_Own_NamedElement, gen_helloworld150_Person_NamedElement},
    metadata=None
)
