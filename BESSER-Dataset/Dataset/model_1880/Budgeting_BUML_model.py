...
# Classes
budgeting_Category = Class(name="budgeting_Category")
budgeting_BudgetingFile = Class(name="budgeting_BudgetingFile")
budgeting_Library = Class(name="budgeting_Library")
BudgetingFile = Class(name="BudgetingFile")
budgeting_Year = Class(name="budgeting_Year")
budgeting_Month = Class(name="budgeting_Month")
budgeting_BudgetEntry = Class(name="budgeting_BudgetEntry")
budgeting_ActualEntry = Class(name="budgeting_ActualEntry")
budgeting_Transaction = Class(name="budgeting_Transaction")
budgeting_IncomeCategory = Class(name="budgeting_IncomeCategory")
Category = Class(name="Category")
budgeting_ExpenseCategory = Class(name="budgeting_ExpenseCategory")
budgeting_BudgetAmountEntry = Class(name="budgeting_BudgetAmountEntry")
BudgetEntry = Class(name="BudgetEntry")
budgeting_BudgetFactorEntry = Class(name="budgeting_BudgetFactorEntry")
budgeting_ActualAmountEntry = Class(name="budgeting_ActualAmountEntry")
ActualEntry = Class(name="ActualEntry")
budgeting_ActualTransactionEntry = Class(name="budgeting_ActualTransactionEntry")
budgeting_CashTransaction = Class(name="budgeting_CashTransaction")
Transaction = Class(name="Transaction")
budgeting_CardTransaction = Class(name="budgeting_CardTransaction")
...
budgeting_CardTransaction_from_: Property = Property(name="from_", type=StringType)
budgeting_CardTransaction.attributes={budgeting_CardTransaction_from_, budgeting_CardTransaction_day}
...
domain_model = DomainModel(
    name="budgeting",
    types={budgeting_Category, budgeting_BudgetingFile, budgeting_Library, BudgetingFile, budgeting_Year, budgeting_Month, budgeting_BudgetEntry, budgeting_ActualEntry, budgeting_Transaction, budgeting_IncomeCategory, Category, budgeting_ExpenseCategory, budgeting_BudgetAmountEntry, BudgetEntry, budgeting_BudgetFactorEntry, budgeting_ActualAmountEntry, ActualEntry, budgeting_ActualTransactionEntry, budgeting_CashTransaction, Transaction, budgeting_CardTransaction, MonthEnum},
    associations={categories0, library1, months3, budgetEntries5, actualEntries7, category9, category12, baseEntry15, transactions17},
    generalizations={gen_budgeting_Library_BudgetingFile, gen_budgeting_Year_BudgetingFile, gen_budgeting_IncomeCategory_Category, gen_budgeting_ExpenseCategory_Category, gen_budgeting_BudgetAmountEntry_BudgetEntry, gen_budgeting_BudgetFactorEntry_BudgetEntry, gen_budgeting_ActualAmountEntry_ActualEntry, gen_budgeting_ActualTransactionEntry_ActualEntry, gen_budgeting_CashTransaction_Transaction, gen_budgeting_CardTransaction_Transaction},
    metadata=None
)
