...
# Classes
whileComp_Function = Class(name="whileComp_Function")
whileComp_Definition = Class(name="whileComp_Definition")
whileComp_Read = Class(name="whileComp_Read")
whileComp_Commands = Class(name="whileComp_Commands")
whileComp_Write = Class(name="whileComp_Write")
whileComp_Affectation = Class(name="whileComp_Affectation")
whileComp_Expr = Class(name="whileComp_Expr")
whileComp_Nop = Class(name="whileComp_Nop")
whileComp_Command = Class(name="whileComp_Command")
whileComp_EObject = Class(name="whileComp_EObject")
whileComp_Foreach = Class(name="whileComp_Foreach")
whileComp_Program = Class(name="whileComp_Program")
whileComp_If = Class(name="whileComp_If")
whileComp_For = Class(name="whileComp_For")
whileComp_While = Class(name="whileComp_While")
whileComp_ExprSimple = Class(name="whileComp_ExprSimple")
whileComp_Lexpr = Class(name="whileComp_Lexpr")
whileComp_Not = Class(name="whileComp_Not")
whileComp_Cons = Class(name="whileComp_Cons")
whileComp_Nil2 = Class(name="whileComp_Nil2")
whileComp_List = Class(name="whileComp_List")
whileComp_Hd = Class(name="whileComp_Hd")
whileComp_Tl = Class(name="whileComp_Tl")
...
whileComp_ExprSimple.attributes={whileComp_ExprSimple_valeur, whileComp_ExprSimple_call, whileComp_ExprSimple_ope}

# whileComp_Lexpr class attributes and methods

# whileComp_Not class attributes and methods
whileComp_Not_not_: Property = Property(name="not_", type=StringType)
whileComp_Not.attributes={whileComp_Not_not_}
...
domain_model = DomainModel(
    name="whileComp",
    types={whileComp_Function, whileComp_Definition, whileComp_Read, whileComp_Commands, whileComp_Write, whileComp_Affectation, whileComp_Expr, whileComp_Nop, whileComp_Command, whileComp_EObject, whileComp_Foreach, whileComp_Program, whileComp_If, whileComp_For, whileComp_While, whileComp_ExprSimple, whileComp_Lexpr, whileComp_Not, whileComp_Cons, whileComp_Nil2, whileComp_List, whileComp_Hd, whileComp_Tl},
    associations={functions0, definition1, read3, commands5, write7, valeurs9, command10, commands12, command15, expr25, commands127, commands230, expr33, commands35, expr38, commands40, exprsimple43, lexpr45, expr47, n50, ex152, ex255, expr58, lexpr62, expr117, expr219, commands22},
    generalizations={},
    metadata=None
)
