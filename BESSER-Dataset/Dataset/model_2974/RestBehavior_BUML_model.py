...
# Classes
restbehavior_State = Class(name="restbehavior_State")
restbehavior_Transition = Class(name="restbehavior_Transition")
restbehavior_Method = Class(name="restbehavior_Method")
restbehavior_Trigger = Class(name="restbehavior_Trigger", is_abstract=True)
restbehavior_Condition = Class(name="restbehavior_Condition")
restbehavior_Value = Class(name="restbehavior_Value", is_abstract=True)
restbehavior_Creator = Class(name="restbehavior_Creator")
restbehavior_MediaType = Class(name="restbehavior_MediaType")
restbehavior_Parameter = Class(name="restbehavior_Parameter")
restbehavior_BehaviorSpecification = Class(name="restbehavior_BehaviorSpecification")
restbehavior_Action = Class(name="restbehavior_Action", is_abstract=True)
restbehavior_UpdateAction = Class(name="restbehavior_UpdateAction")
restbehavior_WritableReference = Class(name="restbehavior_WritableReference", is_abstract=True)
restbehavior_ReturnAction = Class(name="restbehavior_ReturnAction")
restbehavior_StatusCode = Class(name="restbehavior_StatusCode")
restbehavior_Metadata = Class(name="restbehavior_Metadata")
restbehavior_Representation = Class(name="restbehavior_Representation")
restbehavior_Constant = Class(name="restbehavior_Constant")
Value = Class(name="Value")
restbehavior_DataType = Class(name="restbehavior_DataType")
restbehavior_Reference = Class(name="restbehavior_Reference", is_abstract=True)
restbehavior_InternalMessage = Class(name="restbehavior_InternalMessage")
Trigger = Class(name="Trigger")
restbehavior_MessageAction = Class(name="restbehavior_MessageAction")
Action = Class(name="Action")
restbehavior_ConditionalAction = Class(name="restbehavior_ConditionalAction")
restbehavior_CreateAction = Class(name="restbehavior_CreateAction")
restbehavior_ListAddAction = Class(name="restbehavior_ListAddAction")
restbehavior_ListRemoveAction = Class(name="restbehavior_ListRemoveAction")
restbehavior_ActionSequence = Class(name="restbehavior_ActionSequence")
WritableReference = Class(name="WritableReference")
restbehavior_Attribute = Class(name="restbehavior_Attribute")
restbehavior_InternalLinkReference = Class(name="restbehavior_InternalLinkReference")
restbehavior_InternalLink = Class(name="restbehavior_InternalLink")
Reference = Class(name="Reference")
restbehavior_MTReference = Class(name="restbehavior_MTReference", is_abstract=True)
restbehavior_MTLinkReference = Class(name="restbehavior_MTLinkReference")
MTReference = Class(name="MTReference")
restbehavior_MediaTypeLink = Class(name="restbehavior_MediaTypeLink")
restbehavior_MtElementReference = Class(name="restbehavior_MtElementReference")
restbehavior_MediaTypeElement = Class(name="restbehavior_MediaTypeElement")
restbehavior_DeletedState = Class(name="restbehavior_DeletedState")
State = Class(name="State")
restbehavior_ExternalLinkReference = Class(name="restbehavior_ExternalLinkReference")
restbehavior_ExternalLink = Class(name="restbehavior_ExternalLink")
restbehavior_Operation = Class(name="restbehavior_Operation", is_abstract=True)
restbehavior_BinaryOperation = Class(name="restbehavior_BinaryOperation")
Operation = Class(name="Operation")
restbehavior_BinOpType = Class(name="restbehavior_BinOpType")
restbehavior_OpType = Class(name="restbehavior_OpType", is_abstract=True)
OpType = Class(name="OpType")
restbehavior_AttributeReference = Class(name="restbehavior_AttributeReference")
...
domain_model = DomainModel(
    name="restbehavior",
    types={restbehavior_State, restbehavior_Transition, restbehavior_Method, restbehavior_Trigger, restbehavior_Condition, restbehavior_Value, restbehavior_Creator, restbehavior_MediaType, restbehavior_Parameter, restbehavior_BehaviorSpecification, restbehavior_Action, restbehavior_UpdateAction, restbehavior_WritableReference, restbehavior_ReturnAction, restbehavior_StatusCode, restbehavior_Metadata, restbehavior_Representation, restbehavior_Constant, Value, restbehavior_DataType, restbehavior_Reference, restbehavior_InternalMessage, Trigger, restbehavior_MessageAction, Action, restbehavior_ConditionalAction, restbehavior_CreateAction, restbehavior_ListAddAction, restbehavior_ListRemoveAction, restbehavior_ActionSequence, WritableReference, restbehavior_Attribute, restbehavior_InternalLinkReference, restbehavior_InternalLink, Reference, restbehavior_MTReference, restbehavior_MTLinkReference, MTReference, restbehavior_MediaTypeLink, restbehavior_MtElementReference, restbehavior_MediaTypeElement, restbehavior_DeletedState, State, restbehavior_ExternalLinkReference, restbehavior_ExternalLink, restbehavior_Operation, restbehavior_BinaryOperation, Operation, restbehavior_BinOpType, restbehavior_OpType, OpType, restbehavior_AttributeReference},
    associations={entering7, leaving9, transitions12, supportedMethods14, trigger16, targetState18, condition21, effect23, conditionExpr26, consumedMT0, creatorParams1, createbehavior3, action5, elementForUpdate41, newValue42, status45, metadata46, representation48, type50, message28, actionCondition29, actionIfTrue31, actionIfFalse34, creator37, actionelements39, referencedAttribute66, referencedLink67, referencedReference68, referencedMTLink71, referencedMTElement72, referencedExternalLink73, firstOp51, secondOp53, optype56, resultType58, firstOpType60, secondOpType63},
    generalizations={gen_restbehavior_UpdateAction_Action, gen_restbehavior_ReturnAction_Action, gen_restbehavior_Constant_Value, gen_restbehavior_InternalMessage_Trigger, gen_restbehavior_MessageAction_Action, gen_restbehavior_ConditionalAction_Action, gen_restbehavior_CreateAction_Action, gen_restbehavior_ListAddAction_Action, gen_restbehavior_ListRemoveAction_Action, gen_restbehavior_ActionSequence_Action, gen_restbehavior_AttributeReference_WritableReference, gen_restbehavior_InternalLinkReference_WritableReference, gen_restbehavior_WritableReference_Reference, gen_restbehavior_MTReference_Reference, gen_restbehavior_MTLinkReference_MTReference, gen_restbehavior_MtElementReference_MTReference, gen_restbehavior_DeletedState_State, gen_restbehavior_ExternalLinkReference_WritableReference, gen_restbehavior_Reference_Value, gen_restbehavior_Operation_Value, gen_restbehavior_BinaryOperation_Operation, gen_restbehavior_BinOpType_OpType},
    metadata=None
)
