...
class restbehavior_State:
    ...
    def __init__(self, name: str, restbehavior_State15: set["restbehavior_Method"] = None, restbehavior_State20: "restbehavior_Transition" = None, restbehavior_State: "restbehavior_BehaviorSpecification" = None, restbehavior_State10: "restbehavior_BehaviorSpecification" = None, restbehavior_State13: set["restbehavior_Transition"] = None):
        self.name = name
