...
# Classes
giraffeDSL_DomainModel = Class(name="giraffeDSL_DomainModel")
giraffeDSL_Type = Class(name="giraffeDSL_Type")
giraffeDSL_Create = Class(name="giraffeDSL_Create")
Type = Class(name="Type")
giraffeDSL_VirtualMachineTypeFeature = Class(name="giraffeDSL_VirtualMachineTypeFeature")
giraffeDSL_CloudProviderType = Class(name="giraffeDSL_CloudProviderType")
giraffeDSL_CloudProvider = Class(name="giraffeDSL_CloudProvider")
giraffeDSL_CloudType = Class(name="giraffeDSL_CloudType")
giraffeDSL_MgmAddressType = Class(name="giraffeDSL_MgmAddressType")
giraffeDSL_VirtualMachineFeature = Class(name="giraffeDSL_VirtualMachineFeature")
giraffeDSL_InitMachinesFeature = Class(name="giraffeDSL_InitMachinesFeature")
giraffeDSL_InitIncrementFeature = Class(name="giraffeDSL_InitIncrementFeature")
giraffeDSL_VirtualMachine = Class(name="giraffeDSL_VirtualMachine")
giraffeDSL_CloudUserType = Class(name="giraffeDSL_CloudUserType")
giraffeDSL_CloudPasswordType = Class(name="giraffeDSL_CloudPasswordType")
giraffeDSL_Deploy = Class(name="giraffeDSL_Deploy")
giraffeDSL_DeployAppFeature = Class(name="giraffeDSL_DeployAppFeature")
giraffeDSL_DeployTypeFeature = Class(name="giraffeDSL_DeployTypeFeature")
giraffeDSL_DeployApp = Class(name="giraffeDSL_DeployApp")
giraffeDSL_DeployType = Class(name="giraffeDSL_DeployType")
giraffeDSL_DeployRangeType = Class(name="giraffeDSL_DeployRangeType")
giraffeDSL_CloudCredentialType = Class(name="giraffeDSL_CloudCredentialType")
giraffeDSL_CloudOptionalTypes = Class(name="giraffeDSL_CloudOptionalTypes")
giraffeDSL_ScriptType = Class(name="giraffeDSL_ScriptType")
CloudOptionalTypes = Class(name="CloudOptionalTypes")
giraffeDSL_GeoZoneType = Class(name="giraffeDSL_GeoZoneType")
giraffeDSL_Monitor = Class(name="giraffeDSL_Monitor")
giraffeDSL_MonitorRangeType = Class(name="giraffeDSL_MonitorRangeType")
giraffeDSL_MonitoringType = Class(name="giraffeDSL_MonitoringType")
giraffeDSL_Stress = Class(name="giraffeDSL_Stress")
giraffeDSL_StressRangeType = Class(name="giraffeDSL_StressRangeType")
giraffeDSL_StressClassType = Class(name="giraffeDSL_StressClassType")
giraffeDSL_DeployAppClassType = Class(name="giraffeDSL_DeployAppClassType")
giraffeDSL_DeployAppMasterMethodType = Class(name="giraffeDSL_DeployAppMasterMethodType")
giraffeDSL_DeployAppSlaveMethodType = Class(name="giraffeDSL_DeployAppSlaveMethodType")
giraffeDSL_Features = Class(name="giraffeDSL_Features")
giraffeDSL_IntFeature = Class(name="giraffeDSL_IntFeature")
giraffeDSL_StressMethodType = Class(name="giraffeDSL_StressMethodType")
giraffeDSL_Action = Class(name="giraffeDSL_Action")
giraffeDSL_ActionRangeType = Class(name="giraffeDSL_ActionRangeType")
giraffeDSL_ActionClassType = Class(name="giraffeDSL_ActionClassType")
giraffeDSL_ActionMethodType = Class(name="giraffeDSL_ActionMethodType")
...
giraffeDSL_CloudType.attributes={giraffeDSL_CloudType_type, giraffeDSL_CloudType_many, giraffeDSL_CloudType_name}
...
giraffeDSL_MgmAddressType.attributes={giraffeDSL_MgmAddressType_many, giraffeDSL_MgmAddressType_name, giraffeDSL_MgmAddressType_type}
...
giraffeDSL_VirtualMachineFeature.attributes={giraffeDSL_VirtualMachineFeature_many, giraffeDSL_VirtualMachineFeature_name}
...
giraffeDSL_InitMachinesFeature.attributes={giraffeDSL_InitMachinesFeature_many, giraffeDSL_InitMachinesFeature_name, giraffeDSL_InitMachinesFeature_type}
...
giraffeDSL_DeployRangeType.attributes={giraffeDSL_DeployRangeType_many, giraffeDSL_DeployRangeType_name, giraffeDSL_DeployRangeType_type}
...
giraffeDSL_CloudCredentialType.attributes={giraffeDSL_CloudCredentialType_name, giraffeDSL_CloudCredentialType_type, giraffeDSL_CloudCredentialType_many}
...
giraffeDSL_CloudOptionalTypes.attributes={giraffeDSL_CloudOptionalTypes_name, giraffeDSL_CloudOptionalTypes_type, giraffeDSL_CloudOptionalTypes_many}
...
giraffeDSL_MonitorRangeType.attributes={giraffeDSL_MonitorRangeType_many, giraffeDSL_MonitorRangeType_name, giraffeDSL_MonitorRangeType_type}
...
giraffeDSL_MonitoringType.attributes={giraffeDSL_MonitoringType_many, giraffeDSL_MonitoringType_name, giraffeDSL_MonitoringType_type}
...
giraffeDSL_StressRangeType.attributes={giraffeDSL_StressRangeType_type, giraffeDSL_StressRangeType_many, giraffeDSL_StressRangeType_name}
...
giraffeDSL_StressClassType.attributes={giraffeDSL_StressClassType_name, giraffeDSL_StressClassType_many, giraffeDSL_StressClassType_type}
...
giraffeDSL_DeployAppClassType.attributes={giraffeDSL_DeployAppClassType_type, giraffeDSL_DeployAppClassType_name, giraffeDSL_DeployAppClassType_many}
...
giraffeDSL_DeployAppMasterMethodType.attributes={giraffeDSL_DeployAppMasterMethodType_type, giraffeDSL_DeployAppMasterMethodType_name, giraffeDSL_DeployAppMasterMethodType_many}
...
giraffeDSL_DeployAppSlaveMethodType.attributes={giraffeDSL_DeployAppSlaveMethodType_many, giraffeDSL_DeployAppSlaveMethodType_type, giraffeDSL_DeployAppSlaveMethodType_name}
...
giraffeDSL_StressMethodType.attributes={giraffeDSL_StressMethodType_type, giraffeDSL_StressMethodType_many, giraffeDSL_StressMethodType_name}
...
giraffeDSL_ActionRangeType.attributes={giraffeDSL_ActionRangeType_type, giraffeDSL_ActionRangeType_many, giraffeDSL_ActionRangeType_name}
...
giraffeDSL_ActionClassType.attributes={giraffeDSL_ActionClassType_many, giraffeDSL_ActionClassType_name, giraffeDSL_ActionClassType_type}
...
giraffeDSL_ActionMethodType.attributes={giraffeDSL_ActionMethodType_name, giraffeDSL_ActionMethodType_type, giraffeDSL_ActionMethodType_many}
...
class_31: BinaryAssociation = BinaryAssociation(
    name="class_31",
    ends={
...
class_46: BinaryAssociation = BinaryAssociation(
    name="class_46",
    ends={
...
domain_model = DomainModel(
    name="giraffeDSL",
    types={giraffeDSL_DomainModel, giraffeDSL_Type, giraffeDSL_Create, Type, giraffeDSL_VirtualMachineTypeFeature, giraffeDSL_CloudProviderType, giraffeDSL_CloudProvider, giraffeDSL_CloudType, giraffeDSL_MgmAddressType, giraffeDSL_VirtualMachineFeature, giraffeDSL_InitMachinesFeature, giraffeDSL_InitIncrementFeature, giraffeDSL_VirtualMachine, giraffeDSL_CloudUserType, giraffeDSL_CloudPasswordType, giraffeDSL_Deploy, giraffeDSL_DeployAppFeature, giraffeDSL_DeployTypeFeature, giraffeDSL_DeployApp, giraffeDSL_DeployType, giraffeDSL_DeployRangeType, giraffeDSL_CloudCredentialType, giraffeDSL_CloudOptionalTypes, giraffeDSL_ScriptType, CloudOptionalTypes, giraffeDSL_GeoZoneType, giraffeDSL_Monitor, giraffeDSL_MonitorRangeType, giraffeDSL_MonitoringType, giraffeDSL_Stress, giraffeDSL_StressRangeType, giraffeDSL_StressClassType, giraffeDSL_DeployAppClassType, giraffeDSL_DeployAppMasterMethodType, giraffeDSL_DeployAppSlaveMethodType, giraffeDSL_Features, giraffeDSL_IntFeature, giraffeDSL_StressMethodType, giraffeDSL_Action, giraffeDSL_ActionRangeType, giraffeDSL_ActionClassType, giraffeDSL_ActionMethodType},
    associations={elements0, vM8, cloudProvider10, type12, cloudType14, cloudAddress16, vMachine1, initMachines2, initIncrement4, type6, deployOne22, deployTwo23, type25, type27, range29, cloudCredential18, cloudOptionalTypes20, range37, monitoringType38, range40, stressClass41, class_31, deployMasterMethod33, deploySlaveMethod35, stressMethod43, range45, class_46, method48},
    generalizations={gen_giraffeDSL_VirtualMachine_Type, gen_giraffeDSL_CloudProvider_Type, gen_giraffeDSL_Create_Type, gen_giraffeDSL_CloudUserType_CloudOptionalTypes, gen_giraffeDSL_CloudPasswordType_CloudOptionalTypes, gen_giraffeDSL_Deploy_Type, gen_giraffeDSL_DeployType_Type, gen_giraffeDSL_ScriptType_CloudOptionalTypes, gen_giraffeDSL_GeoZoneType_CloudOptionalTypes, gen_giraffeDSL_Monitor_Type, gen_giraffeDSL_Stress_Type, gen_giraffeDSL_DeployApp_Type, gen_giraffeDSL_Action_Type},
    metadata=None
)
