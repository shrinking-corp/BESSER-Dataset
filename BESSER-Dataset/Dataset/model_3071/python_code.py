...
class giraffeDSL_DeployAppSlaveMethodType:
    ...
    def __init__(self, name: str, type: str, many: str, giraffeDSL_DeployAppSlaveMethodType: "giraffeDSL_DeployApp" = None):
        self.name = name
        self.type = type
        self.many = many
...
class giraffeDSL_CloudCredentialType:
    ...
    def __init__(self, name: str, type: str, many: str, giraffeDSL_CloudCredentialType: "giraffeDSL_CloudProvider" = None):
        self.name = name
        self.type = type
        self.many = many
