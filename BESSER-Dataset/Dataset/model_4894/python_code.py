...
class aggregator_p2_RepositoryReference:
    ...
    def __init__(self, options: int, nickname: str, location: str, type: int):
...
class aggregator_p2view_MetadataRepositoryStructuredView:
    ...
    def __init__(self, name: str, loaded: bool, aggregator_p2view_MetadataRepositoryStructuredView73: "Properties" = None, aggregator_p2view_MetadataRepositoryStructuredView75: "MetadataRepository" = None, aggregator_p2view_MetadataRepositoryStructuredView: "InstallableUnits" = None):
        self.name = name
        self.loaded = loaded
...
class aggregator_p2_IMetadataRepository(p2_IQueryable, p2_IRepository):
    ...
    def addReference(self, aggregator_type, aggregator_location, aggregator_options, aggregator_nickname):
...
class aggregator_p2_IQueryable(ABC):
    ...
    def __init__(self):
        ...
        pass
    def query(self, aggregator_collector, aggregator_progress, aggregator_query) :
...
class aggregator_p2_ILicense(ABC):
    ...
    def __init__(self, body: str, digest: str, location: str):
        self.body = body
        self.digest = digest
        self.location = location
...
class aggregator_MetadataRepositoryReference(EnabledStatusProvider, InfosProvider, StatusProvider):
    ...
    def __init__(self, nature: str, location: str, aggregator_MetadataRepositoryReference39: "MetadataRepository" = None, aggregator_MetadataRepositoryReference: "aggregator_Aggregator" = None):
        self.nature = nature
        self.location = location
...
class aggregator_Contact:
    ...
    def __init__(self, name: str, email: str, aggregator_Contact26: "aggregator_Contribution" = None, aggregator_Contact: "aggregator_Aggregator" = None, Contact: "aggregator_Aggregator" = None, contacts: "aggregator_Aggregator" = None):
        self.name = name
        self.email = email
...
class aggregator_Contribution(EnabledStatusProvider, DescriptionProvider, InfosProvider, StatusProvider):
