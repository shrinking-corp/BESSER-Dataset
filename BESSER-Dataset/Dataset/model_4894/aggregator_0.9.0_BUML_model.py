...
# Classes
aggregator_Configuration = Class(name="aggregator_Configuration")
aggregator_Contribution = Class(name="aggregator_Contribution")
aggregator_Contact = Class(name="aggregator_Contact")
aggregator_CustomCategory = Class(name="aggregator_CustomCategory")
aggregator_Aggregator = Class(name="aggregator_Aggregator")
...
aggregator_Product = Class(name="aggregator_Product")
aggregator_Bundle = Class(name="aggregator_Bundle")
aggregator_Feature = Class(name="aggregator_Feature")
aggregator_Category = Class(name="aggregator_Category")
aggregator_MapRule = Class(name="aggregator_MapRule", is_abstract=True)
EnabledStatusProvider = Class(name="EnabledStatusProvider")
aggregator_MetadataRepositoryReference = Class(name="aggregator_MetadataRepositoryReference")
aggregator_MavenMapping = Class(name="aggregator_MavenMapping")
aggregator_MappedRepository = Class(name="aggregator_MappedRepository")
MetadataRepositoryReference = Class(name="MetadataRepositoryReference")
MappedUnit = Class(name="MappedUnit")
aggregator_MappedUnit = Class(name="aggregator_MappedUnit", is_abstract=True)
InstallableUnitReference = Class(name="InstallableUnitReference")
aggregator_Property = Class(name="aggregator_Property")
aggregator_EnabledStatusProvider = Class(name="aggregator_EnabledStatusProvider", is_abstract=True)
aggregator_InstallableUnitReference = Class(name="aggregator_InstallableUnitReference", is_abstract=True)
InstallableUnit = Class(name="InstallableUnit")
aggregator_ExclusionRule = Class(name="aggregator_ExclusionRule")
MapRule = Class(name="MapRule")
aggregator_ValidConfigurationsRule = Class(name="aggregator_ValidConfigurationsRule")
aggregator_Comparable = Class(name="aggregator_Comparable", is_abstract=True)
aggregator_LabelProvider = Class(name="aggregator_LabelProvider", is_abstract=True)
aggregator_DescriptionProvider = Class(name="aggregator_DescriptionProvider")
aggregator_MavenItem = Class(name="aggregator_MavenItem")
aggregator_ChildrenProvider = Class(name="aggregator_ChildrenProvider", is_abstract=True)
MetadataRepository = Class(name="MetadataRepository")
aggregator_p2_IArtifactKey = Class(name="aggregator_p2_IArtifactKey", is_abstract=True)
aggregator_p2_ICopyright = Class(name="aggregator_p2_ICopyright", is_abstract=True)
aggregator_p2_IInstallableUnit = Class(name="aggregator_p2_IInstallableUnit", is_abstract=True)
ITouchpointType = Class(name="ITouchpointType")
aggregator_Status = Class(name="aggregator_Status")
aggregator_StatusProvider = Class(name="aggregator_StatusProvider", is_abstract=True)
aggregator_InfosProvider = Class(name="aggregator_InfosProvider")
aggregator_p2_IProvidedCapability = Class(name="aggregator_p2_IProvidedCapability", is_abstract=True)
aggregator_p2_IRequiredCapability = Class(name="aggregator_p2_IRequiredCapability", is_abstract=True)
aggregator_p2_ITouchpointData = Class(name="aggregator_p2_ITouchpointData", is_abstract=True)
aggregator_p2_ITouchpointInstruction = Class(name="aggregator_p2_ITouchpointInstruction", is_abstract=True)
IUpdateDescriptor = Class(name="IUpdateDescriptor")
ILicense = Class(name="ILicense")
ICopyright = Class(name="ICopyright")
aggregator_p2_IInstallableUnitFragment = Class(name="aggregator_p2_IInstallableUnitFragment", is_abstract=True)
IInstallableUnit = Class(name="IInstallableUnit")
aggregator_p2_ILicense = Class(name="aggregator_p2_ILicense", is_abstract=True)
aggregator_p2_Copyright = Class(name="aggregator_p2_Copyright")
aggregator_p2_MetadataRepository = Class(name="aggregator_p2_MetadataRepository")
IMetadataRepository = Class(name="IMetadataRepository")
RepositoryReference = Class(name="RepositoryReference")
Property_ = Class(name="Property")
aggregator_p2_InstallableUnit = Class(name="aggregator_p2_InstallableUnit")
...
aggregator_p2_ITouchpointType = Class(name="aggregator_p2_ITouchpointType", is_abstract=True)
aggregator_p2_IUpdateDescriptor = Class(name="aggregator_p2_IUpdateDescriptor", is_abstract=True)
aggregator_p2_ArtifactKey = Class(name="aggregator_p2_ArtifactKey")
IArtifactKey = Class(name="IArtifactKey")
aggregator_p2_TouchpointInstruction = Class(name="aggregator_p2_TouchpointInstruction")
ITouchpointInstruction = Class(name="ITouchpointInstruction")
aggregator_p2_TouchpointType = Class(name="aggregator_p2_TouchpointType")
aggregator_p2_UpdateDescriptor = Class(name="aggregator_p2_UpdateDescriptor")
aggregator_p2_Property = Class(name="aggregator_p2_Property")
aggregator_p2_InstructionMap = Class(name="aggregator_p2_InstructionMap")
TouchpointInstruction = Class(name="TouchpointInstruction")
aggregator_p2_IQueryable = Class(name="aggregator_p2_IQueryable", is_abstract=True)
aggregator_p2_InstallableUnitFragment = Class(name="aggregator_p2_InstallableUnitFragment")
p2_InstallableUnit = Class(name="p2_InstallableUnit")
p2_IInstallableUnitFragment = Class(name="p2_IInstallableUnitFragment")
aggregator_p2_License = Class(name="aggregator_p2_License")
aggregator_p2_ProvidedCapability = Class(name="aggregator_p2_ProvidedCapability")
IProvidedCapability = Class(name="IProvidedCapability")
aggregator_p2_RequiredCapability = Class(name="aggregator_p2_RequiredCapability")
IRequiredCapability = Class(name="IRequiredCapability")
aggregator_p2_TouchpointData = Class(name="aggregator_p2_TouchpointData")
ITouchpointData = Class(name="ITouchpointData")
InstructionMap = Class(name="InstructionMap")
aggregator_p2_IRepository = Class(name="aggregator_p2_IRepository", is_abstract=True)
IAdaptable = Class(name="IAdaptable")
aggregator_p2_IMetadataRepository = Class(name="aggregator_p2_IMetadataRepository", is_abstract=True)
p2_IQueryable = Class(name="p2_IQueryable")
p2_IRepository = Class(name="p2_IRepository")
aggregator_p2_IAdaptable = Class(name="aggregator_p2_IAdaptable", is_abstract=True)
aggregator_p2view_MetadataRepositoryStructuredView = Class(name="aggregator_p2view_MetadataRepositoryStructuredView")
InstallableUnits = Class(name="InstallableUnits")
Properties = Class(name="Properties")
aggregator_p2view_InstallableUnits = Class(name="aggregator_p2view_InstallableUnits")
Categories = Class(name="Categories")
aggregator_p2_RepositoryReference = Class(name="aggregator_p2_RepositoryReference")
aggregator_p2view_Categories = Class(name="aggregator_p2view_Categories")
Category = Class(name="Category")
aggregator_p2view_Features = Class(name="aggregator_p2view_Features")
Feature = Class(name="Feature")
aggregator_p2view_Products = Class(name="aggregator_p2view_Products")
Product = Class(name="Product")
aggregator_p2view_Bundles = Class(name="aggregator_p2view_Bundles")
Bundle = Class(name="Bundle")
aggregator_p2view_Fragments = Class(name="aggregator_p2view_Fragments")
Fragment = Class(name="Fragment")
aggregator_p2view_Miscellaneous = Class(name="aggregator_p2view_Miscellaneous")
OtherIU = Class(name="OtherIU")
aggregator_p2view_IUPresentation = Class(name="aggregator_p2view_IUPresentation", is_abstract=True)
...
aggregator_p2view_Feature = Class(name="aggregator_p2view_Feature")
IUPresentationWithDetails = Class(name="IUPresentationWithDetails")
aggregator_p2view_Product = Class(name="aggregator_p2view_Product")
aggregator_p2view_IUPresentationWithDetails = Class(name="aggregator_p2view_IUPresentationWithDetails", is_abstract=True)
p2view_IUPresentation = Class(name="p2view_IUPresentation")
p2view_IUDetails = Class(name="p2view_IUDetails")
aggregator_p2view_Category = Class(name="aggregator_p2view_Category")
IUPresentation = Class(name="IUPresentation")
aggregator_p2view_RequiredCapabilities = Class(name="aggregator_p2view_RequiredCapabilities")
RequiredCapabilityWrapper = Class(name="RequiredCapabilityWrapper")
aggregator_p2view_ProvidedCapabilities = Class(name="aggregator_p2view_ProvidedCapabilities")
ProvidedCapabilityWrapper = Class(name="ProvidedCapabilityWrapper")
aggregator_p2view_Touchpoints = Class(name="aggregator_p2view_Touchpoints")
aggregator_p2view_IUDetails = Class(name="aggregator_p2view_IUDetails")
...
aggregator_p2view_Bundle = Class(name="aggregator_p2view_Bundle")
aggregator_p2view_Fragment = Class(name="aggregator_p2view_Fragment")
aggregator_p2view_OtherIU = Class(name="aggregator_p2view_OtherIU")
aggregator_p2view_Properties = Class(name="aggregator_p2view_Properties")
p2view_aggregator_Property = Class(name="p2view_aggregator_Property")
aggregator_p2view_RequiredCapabilityWrapper = Class(name="aggregator_p2view_RequiredCapabilityWrapper")
p2_IRequiredCapability = Class(name="p2_IRequiredCapability")
LabelProvider = Class(name="LabelProvider")
aggregator_p2view_ProvidedCapabilityWrapper = Class(name="aggregator_p2view_ProvidedCapabilityWrapper")
p2_IProvidedCapability = Class(name="p2_IProvidedCapability")
...
aggregator_Contribution_m_getRepositories: Method = Method(name="getRepositories", parameters={Parameter(name='aggregator_enabledOnly', type=StringType)}, type=StringType)
...
aggregator_Aggregator_m_getValidationRepositories: Method = Method(name="getValidationRepositories", parameters={Parameter(name='aggregator_enabledOnly', type=StringType)}, type=StringType)
aggregator_Aggregator_m_getAllMetadataRepositoryReferences: Method = Method(name="getAllMetadataRepositoryReferences", parameters={Parameter(name='aggregator_enabledOnly', type=StringType)}, type=StringType)
aggregator_Aggregator_m_getContributions: Method = Method(name="getContributions", parameters={Parameter(name='aggregator_enabledOnly', type=StringType)}, type=StringType)
aggregator_Aggregator.attributes={aggregator_Aggregator_mavenResult, aggregator_Aggregator_type, aggregator_Aggregator_buildRoot, aggregator_Aggregator_sendmail, aggregator_Aggregator_label, aggregator_Aggregator_packedStrategy}
aggregator_Aggregator.methods={aggregator_Aggregator_m_getAllMetadataRepositoryReferences, aggregator_Aggregator_m_getValidationRepositories, aggregator_Aggregator_m_getContributions}
...
aggregator_MetadataRepositoryReference_m_getMetadataRepository: Method = Method(name="getMetadataRepository", parameters={Parameter(name='aggregator_forceResolve', type=StringType)}, type=StringType)
...
aggregator_MetadataRepositoryReference_m_startRepositoryLoad: Method = Method(name="startRepositoryLoad", parameters={Parameter(name='aggregator_forceReload', type=StringType)})
...
aggregator_MavenMapping_m_map: Method = Method(name="map", parameters={Parameter(name='aggregator_installableUnitID', type=StringType)}, type=StringType)
aggregator_MavenMapping.attributes={aggregator_MavenMapping_groupId, aggregator_MavenMapping_artifactId, aggregator_MavenMapping_namePattern}
...
aggregator_MappedRepository_m_getUnits: Method = Method(name="getUnits", parameters={Parameter(name='aggregator_enabledOnly', type=StringType)}, type=StringType)
...
aggregator_InstallableUnitReference_m_getInstallableUnit: Method = Method(name="getInstallableUnit", parameters={Parameter(name='aggregator_forceResolve', type=StringType)}, type=StringType)
...
aggregator_InstallableUnitReference.methods={aggregator_InstallableUnitReference_m_isMappedRepositoryBroken, aggregator_InstallableUnitReference_m_isBranchEnabled, aggregator_InstallableUnitReference_m_getInstallableUnit}
...
aggregator_p2_IInstallableUnit_m_getProperty: Method = Method(name="getProperty", parameters={Parameter(name='aggregator_key', type=StringType)}, type=StringType)
...
aggregator_p2_IInstallableUnit_m_satisfies: Method = Method(name="satisfies", parameters={Parameter(name='aggregator_candidate', type=StringType)}, type=BooleanType)
aggregator_p2_IInstallableUnit_m_unresolved: Method = Method(name="unresolved", parameters={}, type=StringType)
aggregator_p2_IInstallableUnit.attributes={aggregator_p2_IInstallableUnit_id, aggregator_p2_IInstallableUnit_version, aggregator_p2_IInstallableUnit_filter, aggregator_p2_IInstallableUnit_resolved, aggregator_p2_IInstallableUnit_singleton}
aggregator_p2_IInstallableUnit.methods={aggregator_p2_IInstallableUnit_m_getFragments, aggregator_p2_IInstallableUnit_m_unresolved, aggregator_p2_IInstallableUnit_m_getRequiredCapabilities, aggregator_p2_IInstallableUnit_m_getArtifacts, aggregator_p2_IInstallableUnit_m_getProvidedCapabilities, aggregator_p2_IInstallableUnit_m_isFragment, aggregator_p2_IInstallableUnit_m_satisfies, aggregator_p2_IInstallableUnit_m_getTouchpointData, aggregator_p2_IInstallableUnit_m_getProperties, aggregator_p2_IInstallableUnit_m_getProperty, aggregator_p2_IInstallableUnit_m_getMetaRequiredCapabilities}
...
aggregator_InfosProvider.attributes={aggregator_InfosProvider_errors, aggregator_InfosProvider_infos, aggregator_InfosProvider_warnings}
...
aggregator_p2_IProvidedCapability_m_satisfies: Method = Method(name="satisfies", parameters={Parameter(name='aggregator_requirement', type=StringType)}, type=BooleanType)
aggregator_p2_IProvidedCapability.attributes={aggregator_p2_IProvidedCapability_namespace, aggregator_p2_IProvidedCapability_name, aggregator_p2_IProvidedCapability_version}
...
aggregator_p2_IRequiredCapability_m_setSelectors: Method = Method(name="setSelectors", parameters={Parameter(name='aggregator_selectors', type=StringType)})
aggregator_p2_IRequiredCapability_m_satisfiedBy: Method = Method(name="satisfiedBy", parameters={Parameter(name='aggregator_capability', type=StringType)}, type=BooleanType)
aggregator_p2_IRequiredCapability.attributes={aggregator_p2_IRequiredCapability_selectorList, aggregator_p2_IRequiredCapability_greedy, aggregator_p2_IRequiredCapability_filter, aggregator_p2_IRequiredCapability_namespace, aggregator_p2_IRequiredCapability_negation, aggregator_p2_IRequiredCapability_name, aggregator_p2_IRequiredCapability_range, aggregator_p2_IRequiredCapability_multiple, aggregator_p2_IRequiredCapability_optional}
aggregator_p2_IRequiredCapability.methods={aggregator_p2_IRequiredCapability_m_satisfiedBy, aggregator_p2_IRequiredCapability_m_getSelectors, aggregator_p2_IRequiredCapability_m_setSelectors}

# aggregator_p2_ITouchpointData class attributes and methods
aggregator_p2_ITouchpointData_m_getInstruction: Method = Method(name="getInstruction", parameters={Parameter(name='aggregator_instructionKey', type=StringType)}, type=StringType)
...
aggregator_p2_InstallableUnit_m_compareTo: Method = Method(name="compareTo", parameters={Parameter(name='aggregator_other', type=StringType)}, type=IntegerType)
...
aggregator_p2_IUpdateDescriptor_m_isUpdateOf: Method = Method(name="isUpdateOf", parameters={Parameter(name='aggregator_iu', type=StringType)}, type=BooleanType)
aggregator_p2_IUpdateDescriptor.attributes={aggregator_p2_IUpdateDescriptor_id, aggregator_p2_IUpdateDescriptor_range, aggregator_p2_IUpdateDescriptor_description, aggregator_p2_IUpdateDescriptor_severity}
...
aggregator_p2_IQueryable_m_query: Method = Method(name="query", parameters={Parameter(name='aggregator_progress', type=StringType), Parameter(name='aggregator_collector', type=StringType), Parameter(name='aggregator_query', type=StringType)}, type=StringType)
...
aggregator_p2_IRepository_m_setProperty: Method = Method(name="setProperty", parameters={Parameter(name='aggregator_value', type=StringType), Parameter(name='aggregator_key', type=StringType)}, type=StringType)
aggregator_p2_IRepository.attributes={aggregator_p2_IRepository_description, aggregator_p2_IRepository_name, aggregator_p2_IRepository_location, aggregator_p2_IRepository_type, aggregator_p2_IRepository_provider, aggregator_p2_IRepository_version, aggregator_p2_IRepository_modifiable}
aggregator_p2_IRepository.methods={aggregator_p2_IRepository_m_setProperty, aggregator_p2_IRepository_m_getProperties}

# IAdaptable class attributes and methods

# aggregator_p2_IMetadataRepository class attributes and methods
aggregator_p2_IMetadataRepository_m_removeInstallableUnits: Method = Method(name="removeInstallableUnits", parameters={Parameter(name='aggregator_monitor', type=StringType), Parameter(name='aggregator_query', type=StringType)}, type=BooleanType)
aggregator_p2_IMetadataRepository_m_removeAll: Method = Method(name="removeAll", parameters={})
aggregator_p2_IMetadataRepository_m_addInstallableUnits: Method = Method(name="addInstallableUnits", parameters={Parameter(name='aggregator_installableUnits', type=StringType)})
aggregator_p2_IMetadataRepository_m_addReference: Method = Method(name="addReference", parameters={Parameter(name='aggregator_location', type=StringType), Parameter(name='aggregator_nickname', type=StringType), Parameter(name='aggregator_options', type=StringType), Parameter(name='aggregator_type', type=StringType)})
aggregator_p2_IMetadataRepository.methods={aggregator_p2_IMetadataRepository_m_removeInstallableUnits, aggregator_p2_IMetadataRepository_m_addInstallableUnits, aggregator_p2_IMetadataRepository_m_removeAll, aggregator_p2_IMetadataRepository_m_addReference}
...
aggregator_p2_IAdaptable_m_getAdapter: Method = Method(name="getAdapter", parameters={Parameter(name='aggregator_adapter', type=StringType)}, type=StringType)
...
aggregator_p2view_InstallableUnits.methods={aggregator_p2view_InstallableUnits_m_getNotNullProductContainer, aggregator_p2view_InstallableUnits_m_getNotNullFragmentContainer, aggregator_p2view_InstallableUnits_m_getNotNullBundleContainer, aggregator_p2view_InstallableUnits_m_getNotNullFeatureContainer, aggregator_p2view_InstallableUnits_m_getNotNullCategoryContainer, aggregator_p2view_InstallableUnits_m_getNotNullMiscellaneousContainer}
...
aggregator_p2view_IUPresentation.attributes={aggregator_p2view_IUPresentation_id, aggregator_p2view_IUPresentation_description, aggregator_p2view_IUPresentation_label, aggregator_p2view_IUPresentation_version, aggregator_p2view_IUPresentation_type, aggregator_p2view_IUPresentation_name}
...
aggregator_p2view_Feature.methods={aggregator_p2view_Feature_m_getNotNullFragmentContainer, aggregator_p2view_Feature_m_getNotNullBundleContainer, aggregator_p2view_Feature_m_getNotNullFeatureContainer}
...
aggregator_p2view_Category.methods={aggregator_p2view_Category_m_getNotNullCategoryContainer, aggregator_p2view_Category_m_isNested, aggregator_p2view_Category_m_getNotNullFragmentContainer, aggregator_p2view_Category_m_getNotNullProductContainer, aggregator_p2view_Category_m_getNotNullBundleContainer, aggregator_p2view_Category_m_getNotNullFeatureContainer}
...
domain_model = DomainModel(
    name="aggregator",
    types={aggregator_Configuration, aggregator_Contribution, aggregator_Contact, aggregator_CustomCategory, aggregator_Aggregator, DescriptionProvider, StatusProvider, InfosProvider, aggregator_Product, aggregator_Bundle, aggregator_Feature, aggregator_Category, aggregator_MapRule, EnabledStatusProvider, aggregator_MetadataRepositoryReference, aggregator_MavenMapping, aggregator_MappedRepository, MetadataRepositoryReference, MappedUnit, aggregator_MappedUnit, InstallableUnitReference, aggregator_Property, aggregator_EnabledStatusProvider, aggregator_InstallableUnitReference, InstallableUnit, aggregator_ExclusionRule, MapRule, aggregator_ValidConfigurationsRule, aggregator_Comparable, aggregator_LabelProvider, aggregator_DescriptionProvider, aggregator_MavenItem, aggregator_ChildrenProvider, MetadataRepository, aggregator_p2_IArtifactKey, aggregator_p2_ICopyright, aggregator_p2_IInstallableUnit, ITouchpointType, aggregator_Status, aggregator_StatusProvider, aggregator_InfosProvider, aggregator_p2_IProvidedCapability, aggregator_p2_IRequiredCapability, aggregator_p2_ITouchpointData, aggregator_p2_ITouchpointInstruction, IUpdateDescriptor, ILicense, ICopyright, aggregator_p2_IInstallableUnitFragment, IInstallableUnit, aggregator_p2_ILicense, aggregator_p2_Copyright, aggregator_p2_MetadataRepository, IMetadataRepository, RepositoryReference, Property_, aggregator_p2_InstallableUnit, ArtifactKey, ProvidedCapability, RequiredCapability, TouchpointData, aggregator_p2_ITouchpointType, aggregator_p2_IUpdateDescriptor, aggregator_p2_ArtifactKey, IArtifactKey, aggregator_p2_TouchpointInstruction, ITouchpointInstruction, aggregator_p2_TouchpointType, aggregator_p2_UpdateDescriptor, aggregator_p2_Property, aggregator_p2_InstructionMap, TouchpointInstruction, aggregator_p2_IQueryable, aggregator_p2_InstallableUnitFragment, p2_InstallableUnit, p2_IInstallableUnitFragment, aggregator_p2_License, aggregator_p2_ProvidedCapability, IProvidedCapability, aggregator_p2_RequiredCapability, IRequiredCapability, aggregator_p2_TouchpointData, ITouchpointData, InstructionMap, aggregator_p2_IRepository, IAdaptable, aggregator_p2_IMetadataRepository, p2_IQueryable, p2_IRepository, aggregator_p2_IAdaptable, aggregator_p2view_MetadataRepositoryStructuredView, InstallableUnits, Properties, aggregator_p2view_InstallableUnits, Categories, aggregator_p2_RepositoryReference, aggregator_p2view_Categories, Category, aggregator_p2view_Features, Feature, aggregator_p2view_Products, Product, aggregator_p2view_Bundles, Bundle, aggregator_p2view_Fragments, Fragment, aggregator_p2view_Miscellaneous, OtherIU, aggregator_p2view_IUPresentation, Features, Products, Bundles, Fragments, Miscellaneous, IUDetails, aggregator_p2view_Feature, IUPresentationWithDetails, aggregator_p2view_Product, aggregator_p2view_IUPresentationWithDetails, p2view_IUPresentation, p2view_IUDetails, aggregator_p2view_Category, IUPresentation, aggregator_p2view_RequiredCapabilities, RequiredCapabilityWrapper, aggregator_p2view_ProvidedCapabilities, ProvidedCapabilityWrapper, aggregator_p2view_Touchpoints, aggregator_p2view_IUDetails, RequiredCapabilities, ProvidedCapabilities, Touchpoints, aggregator_p2view_Bundle, aggregator_p2view_Fragment, aggregator_p2view_OtherIU, aggregator_p2view_Properties, p2view_aggregator_Property, aggregator_p2view_RequiredCapabilityWrapper, p2_IRequiredCapability, LabelProvider, aggregator_p2view_ProvidedCapabilityWrapper, p2_IProvidedCapability, AggregationType, OperatingSystem, WindowSystem, Architecture, PackedStrategy, InstallableUnitType, StatusCode},
    associations={configurations0, contributions1, buildmaster3, contacts5, customCategories6, products12, bundles13, features15, categories17, mapRules19, validationRepositories8, mavenMappings10, aggregator30, categories31, validConfigurations32, repositories21, contacts24, mavenMappings27, features34, installableUnit35, validConfigurations36, metadataRepository38, touchpointType41, status40, updateDescriptor42, license44, copyright46, installableUnits48, repositoryReferences50, propertyMap52, artifactList54, providedCapabilityList55, requiredCapabilityList57, metaRequiredCapabilityList59, propertyMap62, touchpointDataList65, value70, hostList67, instructionMap69, installableUnitList71, properties72, metadataRepository74, categoryContainer77, categories88, features89, products91, bundles92, fragments93, others94, featureContainer78, productContainer80, bundleContainer82, fragmentContainer84, miscellaneousContainer86, categoryContainer97, featureContainer99, productContainer102, bundleContainer105, fragmentContainer108, iuDetails111, featureContainer113, bundleContainer115, fragmentContainer118, installableUnit95, requiredCapabilities130, providedCapabilities131, touchpointType132, touchpointDataList134, requiredCapabilitiesContainer137, providedCapabilitiesContainer138, propertiesContainer140, touchpointsContainer143, updateDescriptor145, copyright148, featureContainer121, bundleContainer123, fragmentContainer126, propertyList129, license151, genuine154, genuine156},
    generalizations={gen_aggregator_Aggregator_DescriptionProvider, gen_aggregator_Aggregator_StatusProvider, gen_aggregator_Aggregator_InfosProvider, gen_aggregator_Configuration_EnabledStatusProvider, gen_aggregator_Contribution_EnabledStatusProvider, gen_aggregator_MappedRepository_MetadataRepositoryReference, gen_aggregator_MappedRepository_DescriptionProvider, gen_aggregator_Feature_MappedUnit, gen_aggregator_Bundle_MappedUnit, gen_aggregator_MappedUnit_InstallableUnitReference, gen_aggregator_MappedUnit_EnabledStatusProvider, gen_aggregator_Product_MappedUnit, gen_aggregator_Contribution_DescriptionProvider, gen_aggregator_Contribution_StatusProvider, gen_aggregator_Contribution_InfosProvider, gen_aggregator_Category_MappedUnit, gen_aggregator_CustomCategory_StatusProvider, gen_aggregator_CustomCategory_InfosProvider, gen_aggregator_MapRule_InstallableUnitReference, gen_aggregator_MapRule_DescriptionProvider, gen_aggregator_InstallableUnitReference_StatusProvider, gen_aggregator_InstallableUnitReference_InfosProvider, gen_aggregator_ExclusionRule_MapRule, gen_aggregator_ValidConfigurationsRule_MapRule, gen_aggregator_MavenMapping_StatusProvider, gen_aggregator_MavenMapping_InfosProvider, gen_aggregator_MetadataRepositoryReference_EnabledStatusProvider, gen_aggregator_MetadataRepositoryReference_StatusProvider, gen_aggregator_MetadataRepositoryReference_InfosProvider, gen_aggregator_p2_IInstallableUnitFragment_IInstallableUnit, gen_aggregator_p2_Copyright_ICopyright, gen_aggregator_p2_MetadataRepository_IMetadataRepository, gen_aggregator_p2_InstallableUnit_IInstallableUnit, gen_aggregator_p2_ArtifactKey_IArtifactKey, gen_aggregator_p2_TouchpointInstruction_ITouchpointInstruction, gen_aggregator_p2_TouchpointType_ITouchpointType, gen_aggregator_p2_UpdateDescriptor_IUpdateDescriptor, gen_aggregator_p2_InstallableUnitFragment_p2_InstallableUnit, gen_aggregator_p2_InstallableUnitFragment_p2_IInstallableUnitFragment, gen_aggregator_p2_License_ILicense, gen_aggregator_p2_ProvidedCapability_IProvidedCapability, gen_aggregator_p2_RequiredCapability_IRequiredCapability, gen_aggregator_p2_TouchpointData_ITouchpointData, gen_aggregator_p2_IRepository_IAdaptable, gen_aggregator_p2_IMetadataRepository_p2_IQueryable, gen_aggregator_p2_IMetadataRepository_p2_IRepository, gen_aggregator_p2view_Feature_IUPresentationWithDetails, gen_aggregator_p2view_Product_IUPresentationWithDetails, gen_aggregator_p2view_IUPresentationWithDetails_p2view_IUPresentation, gen_aggregator_p2view_IUPresentationWithDetails_p2view_IUDetails, gen_aggregator_p2view_Category_IUPresentation, gen_aggregator_p2view_Bundle_IUPresentationWithDetails, gen_aggregator_p2view_Fragment_Bundle, gen_aggregator_p2view_OtherIU_IUPresentationWithDetails, gen_aggregator_p2view_RequiredCapabilityWrapper_p2_IRequiredCapability, gen_aggregator_p2view_RequiredCapabilityWrapper_LabelProvider, gen_aggregator_p2view_ProvidedCapabilityWrapper_p2_IProvidedCapability, gen_aggregator_p2view_ProvidedCapabilityWrapper_LabelProvider},
    metadata=None
)
