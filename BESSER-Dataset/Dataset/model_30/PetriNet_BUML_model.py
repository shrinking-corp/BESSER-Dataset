...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={PetriNet_PetriNet, Element, Place, Transition, Arc, PetriNet_Place, TransToPlaceArc, PlaceToTransArc, PetriNet, PetriNet_Transition, PetriNet_Arc, PetriNet_PlaceToTransArc, PetriNet_Element, PetriNet_TransToPlaceArc},
    associations={places0, transitions1, arcs2, incoming4, outgoing5, net6, incoming7, outgoing10, source13, source17, target20, target15},
