...
# Classes
hockeyleague_Arena = Class(name="hockeyleague_Arena")
HockeyleagueObject = Class(name="HockeyleagueObject")
hockeyleague_Defence = Class(name="hockeyleague_Defence")
Player = Class(name="Player")
hockeyleague_PlayerStats = Class(name="hockeyleague_PlayerStats")
hockeyleague_Forward = Class(name="hockeyleague_Forward")
hockeyleague_Goalie = Class(name="hockeyleague_Goalie")
hockeyleague_GoalieStats = Class(name="hockeyleague_GoalieStats")
hockeyleague_Team = Class(name="hockeyleague_Team")
hockeyleague_League = Class(name="hockeyleague_League")
hockeyleague_Player = Class(name="hockeyleague_Player", is_abstract=True)
hockeyleague_HockeyleagueObject = Class(name="hockeyleague_HockeyleagueObject", is_abstract=True)
...
hockeyleague_PlayerStats.attributes={hockeyleague_PlayerStats_assists, hockeyleague_PlayerStats_points, hockeyleague_PlayerStats_gamesPlayedIn, hockeyleague_PlayerStats_plusMinus, hockeyleague_PlayerStats_powerPlayGoals, hockeyleague_PlayerStats_shortHandedGoals, hockeyleague_PlayerStats_goals, hockeyleague_PlayerStats_shots, hockeyleague_PlayerStats_year, hockeyleague_PlayerStats_penaltyMinutes, hockeyleague_PlayerStats_shotPercentage, hockeyleague_PlayerStats_gameWinningGoals}
...
hockeyleague_GoalieStats.attributes={hockeyleague_GoalieStats_saves, hockeyleague_GoalieStats_points, hockeyleague_GoalieStats_assists, hockeyleague_GoalieStats_penaltyMinutes, hockeyleague_GoalieStats_gamesPlayedIn, hockeyleague_GoalieStats_wins, hockeyleague_GoalieStats_goalsAgainst, hockeyleague_GoalieStats_losses, hockeyleague_GoalieStats_goals, hockeyleague_GoalieStats_emptyNetGoals, hockeyleague_GoalieStats_shutouts, hockeyleague_GoalieStats_goalsAgainstAverage, hockeyleague_GoalieStats_year, hockeyleague_GoalieStats_minutesPlayedIn, hockeyleague_GoalieStats_ties}
...
hockeyleague_Player.attributes={hockeyleague_Player_heightValue, hockeyleague_Player_heightMesurement, hockeyleague_Player_birthdate, hockeyleague_Player_weightValue, hockeyleague_Player_number, hockeyleague_Player_shot, hockeyleague_Player_weightMesurement, hockeyleague_Player_birthplace}
...
domain_model = DomainModel(
    name="hockeyleague",
    types={hockeyleague_Arena, HockeyleagueObject, hockeyleague_Defence, Player, hockeyleague_PlayerStats, hockeyleague_Forward, hockeyleague_Goalie, hockeyleague_GoalieStats, hockeyleague_Team, hockeyleague_League, hockeyleague_Player, hockeyleague_HockeyleagueObject, ForwardPositionKind, HeightKind, ShotKind, WeightKind, DefencePositionKind},
