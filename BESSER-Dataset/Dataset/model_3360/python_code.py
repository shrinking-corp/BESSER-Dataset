...
class metamodel_Column:
    ...
    def __init__(self, name: str, type: str, nullable: bool, size: str, metamodel_Column13: set["metamodel_Constraint"] = None, metamodel_Column: "metamodel_Table" = None, metamodel_Column11: "metamodel_Constraint" = None, metamodel_Column19: "metamodel_Cell" = None):
        self.name = name
        self.type = type
...
class metamodel_Constraint:
    ...
    def __init__(self, name: str, type: str, reference: str, metamodel_Constraint14: "metamodel_Column" = None, metamodel_Constraint: "metamodel_Table" = None, metamodel_Constraint10: set["metamodel_Column"] = None):
        self.name = name
        self.type = type
...
class metamodel_Sequence:
    ...
    def __init__(self, minValue: int, maxValue: str, incrementby: int, startwith: str, currentValue: str, cycle: bool, name: str, metamodel_Sequence: "metamodel_Database" = None):
...
class metamodel_Table:
    ...
    def __init__(self, name: str, metamodel_Table: "metamodel_Database" = None, metamodel_Table4: set["metamodel_Constraint"] = None, metamodel_Table6: set["metamodel_Column"] = None, metamodel_Table8: set["metamodel_Row"] = None):
        self.name = name
