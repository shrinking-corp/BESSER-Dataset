...
# Classes
metamodel_Database = Class(name="metamodel_Database")
metamodel_Table = Class(name="metamodel_Table")
metamodel_Sequence = Class(name="metamodel_Sequence")
metamodel_Constraint = Class(name="metamodel_Constraint")
metamodel_Column = Class(name="metamodel_Column")
metamodel_Row = Class(name="metamodel_Row")
metamodel_Cell = Class(name="metamodel_Cell")
...
metamodel_Sequence.attributes={metamodel_Sequence_cycle, metamodel_Sequence_currentValue, metamodel_Sequence_minValue, metamodel_Sequence_incrementby, metamodel_Sequence_name, metamodel_Sequence_startwith, metamodel_Sequence_maxValue}
...
metamodel_Constraint.attributes={metamodel_Constraint_reference, metamodel_Constraint_type, metamodel_Constraint_name}
...
metamodel_Column.attributes={metamodel_Column_type, metamodel_Column_nullable, metamodel_Column_name, metamodel_Column_size}
...
domain_model = DomainModel(
    name="metamodel",
    types={metamodel_Database, metamodel_Table, metamodel_Sequence, metamodel_Constraint, metamodel_Column, metamodel_Row, metamodel_Cell, Datatype, ConstraintType},
    associations={constraints12, table0, sequences1, constraints3, columns5, rows7, References9, cells15, column17},
    generalizations={},
    metadata=None
)
