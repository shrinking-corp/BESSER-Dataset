...
ptnet_ToolInfo.attributes={ptnet_ToolInfo_toolInfoGrammarURI, ptnet_ToolInfo_tool, ptnet_ToolInfo_version, ptnet_ToolInfo_formattedXMLBuffer}
...
ptnet_Line.attributes={ptnet_Line_style, ptnet_Line_width, ptnet_Line_color, ptnet_Line_shape}
...
ptnet_Fill.attributes={ptnet_Fill_gradientrotation, ptnet_Fill_gradientcolor, ptnet_Fill_image, ptnet_Fill_color}
...
ptnet_Font.attributes={ptnet_Font_family, ptnet_Font_align, ptnet_Font_rotation, ptnet_Font_decoration, ptnet_Font_weight, ptnet_Font_style, ptnet_Font_size}
...
domain_model = DomainModel(
    name="ptnet",
    types={ptnet_Arc, ptnet_PetriNetDoc, ptnet_PTMarking, Annotation, ptnet_Place, ptnet_PTArcAnnotation, ptnet_ToolInfo, ptnet_PetriNet, ptnet_Page, ptnet_Name, PnObject, ptnet_PnObject, ptnet_NodeGraphics, ptnet_Label, ptnet_AnyObject, Graphics, ptnet_Line, ptnet_Node, ptnet_Graphics, ptnet_Coordinate, ptnet_Position, ptnet_Dimension, ptnet_Fill, Coordinate, ptnet_ArcGraphics, ptnet_Offset, ptnet_AnnotationGraphics, ptnet_Font, ptnet_Annotation, ptnet_RefPlace, ptnet_TransitionNode, ptnet_RefTransition, PlaceNode, ptnet_PlaceNode, Node, ptnet_Attribute, Label, TransitionNode, ptnet_Transition, PNType, CSS2Color, Gradient, LineShape, FontAlign, FontDecoration, CSS2FontFamily, CSS2FontSize, CSS2FontStyle, CSS2FontWeight, LineStyle},
    associations={containerArc1, containerPlace0, toolspecifics5, containerPetriNetDoc7, nets2, pages3, name4, toolspecifics15, containerPage17, objects8, containerPetriNet9, nodegraphics11, name13, containerLabel29, toolInfoModel31, toolspecifics32, containerNamePetriNet19, containerNamePnObject21, containerPetriNet24, containerPnObject26, line37, containerNode39, containerPage40, position34, dimension35, fill36, containerDNodeGraphics47, offset49, containerArcGraphics43, containerPNodeGraphics44, containerAnnotationGraphics46, containerAnnotation58, fill50, line53, font56, containerAnnotationGraphics61, containerNodeGraphics59, containerAnnotationGraphics69, containerNodeGraphics64, containerArcGraphics66, target81, positions72, line74, containerArc77, source79, OutArcs89, nodegraphics91, arcgraphics83, inscription85, InArcs87, containerAnnotationGraphics93, referencingPlaces95, referencingTransitions96, initialMarking98, annotationgraphics101, ref99, ref100, containerToolInfo103},
    generalizations={gen_ptnet_PTMarking_Annotation, gen_ptnet_PTArcAnnotation_Annotation, gen_ptnet_Name_Annotation, gen_ptnet_Page_PnObject, gen_ptnet_NodeGraphics_Graphics, gen_ptnet_AnnotationGraphics_Graphics, gen_ptnet_Position_Coordinate, gen_ptnet_Offset_Coordinate, gen_ptnet_Dimension_Coordinate, gen_ptnet_ArcGraphics_Graphics, gen_ptnet_Arc_PnObject, gen_ptnet_Node_PnObject, gen_ptnet_TransitionNode_Node, gen_ptnet_Place_PlaceNode, gen_ptnet_PlaceNode_Node, gen_ptnet_Attribute_Label, gen_ptnet_Annotation_Label, gen_ptnet_RefTransition_TransitionNode, gen_ptnet_Transition_TransitionNode, gen_ptnet_RefPlace_PlaceNode},
    metadata=None
)
