...
# Classes
z3fsm_Region = Class(name="z3fsm_Region")
AbstractState = Class(name="AbstractState")
z3fsm_AbstractState = Class(name="z3fsm_AbstractState", is_abstract=True)
z3fsm_State = Class(name="z3fsm_State")
...
domain_model = DomainModel(
    name="z3fsm",
    types={z3fsm_Region, AbstractState, z3fsm_AbstractState, z3fsm_State},
