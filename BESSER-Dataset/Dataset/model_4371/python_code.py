    ...
    def cobol_tables_KeyName(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "IdentifierReference355"):
                    opp_val = getattr(item, "IdentifierReference355", None)
                    
                    if opp_val == self:
                        setattr(item, "IdentifierReference355", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "IdentifierReference355"):
                    ...
                    setattr(item, "IdentifierReference355", self)
...
class cobol_specialnames_CodeNameAlphabetType(AlphabetType):
    ...
    def __init__(self, value: str, AlphabetType: "cobol_specialnames_AlphabetName" = None):
        self.value = value
...
class cobol_dataitems_Usage(DataItemAttribute):
    ...
    def __init__(self, usage: str, isNative: bool, DataItemAttribute: "cobol_dataitems_DataItem" = None, DataItemAttribute361: "cobol_files_FileName" = None):
        self.usage = usage
...
class cobol_dataitems_PictureString(DataItemAttribute):
    ...
    def __init__(self, picture: str, DataItemAttribute: "cobol_dataitems_DataItem" = None, DataItemAttribute361: "cobol_files_FileName" = None):
...
class strings_Tallying:
    ...
    pass
class cobol_strings_TallyingOccurrence(strings_Tallying, strings_Occurrence):
...
class cobol_strings_Location:
    ...
    def cobol_strings_Location(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "PrimaryOperand403"):
                opp_val = getattr(old_value, "PrimaryOperand403", None)
                if opp_val == self:
                    setattr(old_value, "PrimaryOperand403", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "PrimaryOperand403"):
                opp_val = getattr(value, "PrimaryOperand403", None)
                setattr(value, "PrimaryOperand403", self)
...
class strings_Replacement:
    ...
    pass
class cobol_strings_ReplacementOccurrence(strings_Replacement, strings_Occurrence):
...
class operands_ReplacementOperand:
    ...
    pass
class cobol_operands_PrimaryOperand(arithmetics_PrimaryExpression, operands_Operand, operands_ArithmeticOperand, operands_ReplacementOperand):
...
class references_IdentifierReferenceQualifier:
    ...
    pass
class cobol_references_DataNameReference(identifiers_IdentifierReference, references_IdentifierReferenceQualifier):

    pass
class references_ConditionName:

    pass
class cobol_references_ConditionNameReference(identifiers_IdentifierReference, references_ConditionName):
...
class cobol_specialnames_SymbolicCharacterStatement(references_ElementReference, specialnames_SpecialNameStatement):
    ...
    pass
class cobol_references_SpecialNamesConditionNameReference(references_Qualifiable, references_ElementReference, references_ConditionName):
...
class cobol_water_SpecialNamesClause(SpecialNamesParagraphWater):
    ...
    def __init__(self, value: str, SpecialNamesParagraphWater: "cobol_paragraphs_SpecialNamesParagraph" = None):
        self.value = value
...
class cobol_identifiers_LinageCounter(references_Qualifiable, identifiers_Identifier):
    ...
    pass
class cobol_identifiers_IdentifierReference(references_Qualifiable, identifiers_Identifier, references_ElementReference):
...
class water_IdentificationDivisionWater:
    ...
    pass
class cobol_water_Dot(water_IdentificationDivisionWater, water_SQLStatementWater):
...
class cobol_files_SelectStatement(IncompleteElement):
    ...
    def __init__(self, isOptional: bool, externalFileNames: str, cobol_files_SelectStatement: "FileStatus" = None, cobol_files_SelectStatement367: "FileNameReference" = None):
        self.isOptional = isOptional
        self.externalFileNames = externalFileNames
        self.cobol_files_SelectStatement = cobol_files_SelectStatement
        self.cobol_files_SelectStatement367 = cobol_files_SelectStatement367
        
        pass
    @property
    def externalFileNames(self):
    ...
    @property
    def cobol_files_SelectStatement367(self):
        return self.__cobol_files_SelectStatement367

    @cobol_files_SelectStatement367.setter
    def cobol_files_SelectStatement367(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_cobol_files_SelectStatement__cobol_files_SelectStatement367", None)
        self.__cobol_files_SelectStatement367 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "FileNameReference368"):
                opp_val = getattr(old_value, "FileNameReference368", None)
                if opp_val == self:
                    setattr(old_value, "FileNameReference368", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "FileNameReference368"):
                opp_val = getattr(value, "FileNameReference368", None)
                setattr(value, "FileNameReference368", self)
...
class cobol_statements_KeyDescriptor:
    ...
    def cobol_statements_KeyDescriptor(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "IdentifierReference266"):
                    opp_val = getattr(item, "IdentifierReference266", None)
                    
                    if opp_val == self:
                        setattr(item, "IdentifierReference266", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "IdentifierReference266"):
                    ...
                    setattr(item, "IdentifierReference266", self)
...
class statements_PerformProcedure:
    ...
    pass
class cobol_statements_PerformProcedureFixedTimes(statements_PerformProcedure, statements_PerformFixedTimes):
...
class statements_PerformNestedStatement:
    ...
    pass
class cobol_statements_PerformNestedStatementFixedTimes(statements_PerformNestedStatement, statements_PerformFixedTimes):
...
class statements_PerformUntilCondition:
    ...
    pass
class cobol_statements_PerformNestedStatementUntilCondition(statements_PerformNestedStatement, statements_PerformUntilCondition):

    pass
class cobol_statements_PerformProcedureUntilCondition(statements_PerformProcedure, statements_PerformUntilCondition):
...
class cobol_statements_SwitchStatus:
    ...
    def cobol_statements_SwitchStatus(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "MnemonicNameReference246"):
                    opp_val = getattr(item, "MnemonicNameReference246", None)
                    
                    if opp_val == self:
                        setattr(item, "MnemonicNameReference246", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "MnemonicNameReference246"):
                    ...
                    setattr(item, "MnemonicNameReference246", self)
...
class cobol_statements_Replace(Statement):
    ...
    def __init__(self, replaceSwitch: bool, Statement151: "cobol_statements_Condition" = None, Statement120: "cobol_sentences_StatementContainer" = None, Statement124: "cobol_statements_Statement" = None, Statement: "cobol_sections_DataDivisionSection" = None, Statement145: "cobol_statements_NestedStatement" = None):
        self.replaceSwitch = replaceSwitch
        
        pass
    @property
    def replaceSwitch(self):
...
class cobol_handlers_AtEndOfPage(Handler):
    ...
    def __init__(self, eop: str, Handler: "cobol_statements_ErrorHandled" = None, Handler393: "cobol_handlers_NotErrorHandler" = None):
        self.eop = eop
...
class cobol_statements_Execute(Statement):
    ...
    def __init__(self, water: str, Statement151: "cobol_statements_Condition" = None, Statement120: "cobol_sentences_StatementContainer" = None, Statement124: "cobol_statements_Statement" = None, Statement: "cobol_sections_DataDivisionSection" = None, Statement145: "cobol_statements_NestedStatement" = None):
        self.water = water
...
class cobol_statements_Move(Statement):
    ...
    def __init__(self, corresponding: str, cobol_statements_Move148: set["PrimaryOperand"] = None, cobol_statements_Move: set["PrimaryOperand"] = None, Statement151: "cobol_statements_Condition" = None, Statement120: "cobol_sentences_StatementContainer" = None, Statement124: "cobol_statements_Statement" = None, Statement: "cobol_sections_DataDivisionSection" = None, Statement145: "cobol_statements_NestedStatement" = None):
        self.corresponding = corresponding
        self.cobol_statements_Move148 = cobol_statements_Move148 if cobol_statements_Move148 is not None else set()
    ...
    @property
    def cobol_statements_Move148(self):
        return self.__cobol_statements_Move148

    @cobol_statements_Move148.setter
    def cobol_statements_Move148(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_cobol_statements_Move__cobol_statements_Move148", None)
        self.__cobol_statements_Move148 = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "PrimaryOperand149"):
                    opp_val = getattr(item, "PrimaryOperand149", None)
                    
                    if opp_val == self:
                        setattr(item, "PrimaryOperand149", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "PrimaryOperand149"):
                    ...
                    setattr(item, "PrimaryOperand149", self)
...
class cobol_environments_UPSI(Environment):
    ...
    def __init__(self, value: str, Environment: "cobol_statements_Display" = None, Environment337: "cobol_specialnames_MnemonicName" = None):
        self.value = value
...
class cobol_statements_Exit(Statement):
    ...
    def __init__(self, exitLabel: str, Statement151: "cobol_statements_Condition" = None, Statement120: "cobol_sentences_StatementContainer" = None, Statement124: "cobol_statements_Statement" = None, Statement: "cobol_sections_DataDivisionSection" = None, Statement145: "cobol_statements_NestedStatement" = None):
...
class cobol_statements_Statement(ABC):
    ...
    def cobol_statements_Statement(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "Statement124"):
                opp_val = getattr(old_value, "Statement124", None)
                if opp_val == self:
                    setattr(old_value, "Statement124", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "Statement124"):
                opp_val = getattr(value, "Statement124", None)
                setattr(value, "Statement124", self)
...
class cobol_operands_Encoding(ReplacementOperand):
    ...
    def __init__(self, type: str, ReplacementOperand412: "cobol_strings_SpecificCharacterBySpecificCharacter" = None, ReplacementOperand: "cobol_strings_Replacement" = None):
        self.type = type
...
class statements_Perform:
    ...
    pass
class cobol_statements_PerformUntilCondition(statements_VaryingUntilCondition, statements_Perform):
    ...
    def cobol_statements_PerformUntilCondition(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "Condition248"):
                    opp_val = getattr(item, "Condition248", None)
                    
                    if opp_val == self:
                        setattr(item, "Condition248", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "Condition248"):
                    ...
                    setattr(item, "Condition248", self)
...
class cobol_statements_Unstring(statements_Statement, statements_ErrorHandled):
    ...
    pass
class cobol_statements_Call(statements_Statement, statements_ErrorHandled, functions_Argumentable):
...
class cobol_statements_ArithmeticStatement(statements_Statement, statements_ErrorHandled):
    ...
    def __init__(self, corresponding: str, cobol_statements_ArithmeticStatement: set["ArithmeticOperand"] = None, cobol_statements_ArithmeticStatement127: set["ArithmeticOperand"] = None):
        self.corresponding = corresponding
        ...
        self.cobol_statements_ArithmeticStatement127 = cobol_statements_ArithmeticStatement127 if cobol_statements_ArithmeticStatement127 is not None else set()
    ...
    @property
    def cobol_statements_ArithmeticStatement127(self):
        return self.__cobol_statements_ArithmeticStatement127

    @cobol_statements_ArithmeticStatement127.setter
    def cobol_statements_ArithmeticStatement127(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_cobol_statements_ArithmeticStatement__cobol_statements_ArithmeticStatement127", None)
        self.__cobol_statements_ArithmeticStatement127 = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "ArithmeticOperand128"):
                    opp_val = getattr(item, "ArithmeticOperand128", None)
                    
                    if opp_val == self:
                        setattr(item, "ArithmeticOperand128", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "ArithmeticOperand128"):
                    ...
                    setattr(item, "ArithmeticOperand128", self)
...
class cobol_operators_Equal(RelationalOperator):
    ...
    def __init__(self, to: bool, RelationalOperator: "cobol_conditions_RelationalExpression" = None, RelationalOperator287: "cobol_statements_Start" = None, RelationalOperator22: "cobol_conditions_AbbreviatedRelationalExpression" = None):
        self.to = to
...
class cobol_operators_LessThanOrEqual(RelationalOperator):
    ...
    def __init__(self, than: bool, to: bool, RelationalOperator: "cobol_conditions_RelationalExpression" = None, RelationalOperator287: "cobol_statements_Start" = None, RelationalOperator22: "cobol_conditions_AbbreviatedRelationalExpression" = None):
        self.than = than
        self.to = to
...
class cobol_operators_LessThan(RelationalOperator):
    ...
    def __init__(self, than: bool, RelationalOperator: "cobol_conditions_RelationalExpression" = None, RelationalOperator287: "cobol_statements_Start" = None, RelationalOperator22: "cobol_conditions_AbbreviatedRelationalExpression" = None):
        self.than = than
...
class cobol_literals_Quote(ConstantLiteral):
    ...
    def __init__(self, value: str, ConstantLiteral: "cobol_literals_AllLiteral" = None):
        self.value = value
...
class literals_NumericLiteral:
    ...
    pass
class cobol_literals_IntegerLiteral(water_FileDescriptorWater, water_IOControlParagraphWater, water_ObjectComputerParagraphWater, literals_NumericLiteral):
...
class cobol_literals_PseudoLiteral(Literal):
    ...
    def __init__(self, value: str, Literal: "cobol_specialnames_CurrencySign" = None):
        self.value = value
...
class cobol_literals_BooleanLiteral(Literal):
    ...
    def __init__(self, value: bool, Literal: "cobol_specialnames_CurrencySign" = None):
        self.value = value
...
class water_SelectStatementWater:
    ...
    pass
class cobol_identifiers_Identifier(water_InvokeStatementWater, water_CICSStatementWater, water_ObjectComputerParagraphWater, water_IOControlParagraphWater, water_SpecialNamesParagraphWater, water_SortPhraseWater, water_RepositoryParagraphWater, operands_PrimaryOperand, water_DataDescriptorWater, water_AcceptStatementWater, water_SQLStatementWater, water_SelectStatementWater, water_FileDescriptorWater, water_IdentificationDivisionWater, water_UseStatementWater):

    pass
class cobol_literals_Literal(water_CICSStatementWater, water_InvokeStatementWater, water_SpecialNamesParagraphWater, operands_PrimaryOperand, labels_StopLabel, water_SelectStatementWater):
...
class parameters_Parametrizable:
    ...
    pass
class cobol_statements_Entry(statements_Statement, parameters_Parametrizable):
...
class cobol_files_FileName(water_IncompleteElement, references_ReferenceableElement):
    ...
    def __init__(self, fileDescriptor: str, cobol_files_FileName: set["DataItem"] = None, cobol_files_FileName360: set["DataItemAttribute"] = None, cobol_files_FileName363: set["StatementContainer"] = None):
        self.fileDescriptor = fileDescriptor
        self.cobol_files_FileName = cobol_files_FileName if cobol_files_FileName is not None else set()
        self.cobol_files_FileName360 = cobol_files_FileName360 if cobol_files_FileName360 is not None else set()
        self.cobol_files_FileName363 = cobol_files_FileName363 if cobol_files_FileName363 is not None else set()
    ...
    def cobol_files_FileName(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "DataItem358"):
                    opp_val = getattr(item, "DataItem358", None)
                    
                    if opp_val == self:
                        setattr(item, "DataItem358", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "DataItem358"):
                    ...
                    setattr(item, "DataItem358", self)
                    

    @property
    def cobol_files_FileName363(self):
        return self.__cobol_files_FileName363

    @cobol_files_FileName363.setter
    def cobol_files_FileName363(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_cobol_files_FileName__cobol_files_FileName363", None)
        self.__cobol_files_FileName363 = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "StatementContainer364"):
                    opp_val = getattr(item, "StatementContainer364", None)
                    
                    if opp_val == self:
                        setattr(item, "StatementContainer364", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "StatementContainer364"):
                    ...
                    setattr(item, "StatementContainer364", self)
                    

    @property
    def cobol_files_FileName360(self):
        return self.__cobol_files_FileName360

    @cobol_files_FileName360.setter
    def cobol_files_FileName360(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_cobol_files_FileName__cobol_files_FileName360", None)
        self.__cobol_files_FileName360 = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "DataItemAttribute361"):
                    opp_val = getattr(item, "DataItemAttribute361", None)
                    
                    if opp_val == self:
                        setattr(item, "DataItemAttribute361", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "DataItemAttribute361"):
                    ...
                    setattr(item, "DataItemAttribute361", self)
                    

class cobol_paragraphs_RepositoryParagraph(paragraphs_ConfigurationSectionParagraph, water_IncompleteElement):
...
class cobol_statements_Open(water_IncompleteElement, statements_IOStatement):
    ...
    pass
class cobol_statements_Accept(statements_Statement, water_IncompleteElement):

    pass
class cobol_dataitems_DataItem(water_IncompleteElement, references_ReferenceableElement):

    def __init__(self, levelNumber: str, superentry: set["DataItem"] = None, subentries: "DataItem" = None, cobol_dataitems_DataItem: set["DataItemAttribute"] = None):
        self.levelNumber = levelNumber
        self.superentry = superentry if superentry is not None else set()
    ...
    @subentries.setter
    def subentries(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_cobol_dataitems_DataItem__subentries", None)
        self.__subentries = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "DataItem324"):
                opp_val = getattr(old_value, "DataItem324", None)
                if opp_val == self:
                    setattr(old_value, "DataItem324", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "DataItem324"):
                opp_val = getattr(value, "DataItem324", None)
                setattr(value, "DataItem324", self)

    @property
    def superentry(self):
        return self.__superentry

    @superentry.setter
    def superentry(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_cobol_dataitems_DataItem__superentry", None)
        self.__superentry = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "DataItem322"):
                    opp_val = getattr(item, "DataItem322", None)
                    
                    if opp_val == self:
                        setattr(item, "DataItem322", None)
...
class cobol_sentences_UseSentence(sentences_StatementContainer, water_IncompleteElement):

    pass
class cobol_statements_Close(water_IncompleteElement, statements_IOStatement):

    pass
class cobol_tables_Table(dataitems_DataItem, water_IncompleteElement):

    pass
class cobol_statements_Sort(water_IncompleteElement, statements_FileIOStatement):

    pass
class cobol_paragraphs_ObjectComputerParagraph(paragraphs_ConfigurationSectionParagraph, water_IncompleteElement):
...
class cobol_divisions_ProcedureDivision(divisions_Division, parameters_Parametrizable):
    ...
    pass
class cobol_divisions_IdentificationDivision(divisions_Division, water_IncompleteElement):
...
class commons_NamedElement:
    ...
    pass
class cobol_paragraphs_Paragraph(commons_NamedElement, labels_Procedure):

    pass
class cobol_specialnames_ConditionName(commons_NamedElement, specialnames_SpecialName):

    pass
class cobol_tables_IndexName(commons_NamedElement, references_ReferenceableElement):

    pass
class cobol_sections_Section(commons_NamedElement, labels_Procedure):

    def __init__(self, segmentNumber: str, cobol_sections_Section: set["StatementContainer"] = None, cobol_sections_Section113: set["Paragraph"] = None):
        self.segmentNumber = segmentNumber
        self.cobol_sections_Section = cobol_sections_Section if cobol_sections_Section is not None else set()
        self.cobol_sections_Section113 = cobol_sections_Section113 if cobol_sections_Section113 is not None else set()
    ...
    @property
    def cobol_sections_Section113(self):
        return self.__cobol_sections_Section113

    @cobol_sections_Section113.setter
    def cobol_sections_Section113(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_cobol_sections_Section__cobol_sections_Section113", None)
        self.__cobol_sections_Section113 = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "Paragraph114"):
                    opp_val = getattr(item, "Paragraph114", None)
                    
                    if opp_val == self:
                        setattr(item, "Paragraph114", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "Paragraph114"):
                    ...
                    setattr(item, "Paragraph114", self)
    ...
    def cobol_sections_Section(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "StatementContainer111"):
                    opp_val = getattr(item, "StatementContainer111", None)
                    
                    if opp_val == self:
                        setattr(item, "StatementContainer111", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "StatementContainer111"):
                    ...
                    setattr(item, "StatementContainer111", self)
                    

class cobol_functions_FunctionCall(commons_NamedElement, identifiers_Identifier, functions_Argumentable):
