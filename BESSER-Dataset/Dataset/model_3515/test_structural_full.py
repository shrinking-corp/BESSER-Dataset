...
testtypesystem_Assignment_strategy = st.builds(testtypesystem_Assignment)
...
testtypesystem_Expression_strategy = st.builds(testtypesystem_Expression)
...
testtypesystem_State_strategy = st.builds(testtypesystem_State)
...
testtypesystem_Value_strategy = st.builds(testtypesystem_Value)
