...
petrinet_NetworkSystem = Class(name="petrinet_NetworkSystem")
...
domain_model = DomainModel(
    name="petrinet",
    types={petrinet_Element, petrinet_PetriNet, Node, petrinet_NetworkSystem, petrinet_Node, Element, petrinet_Arc, petrinet_OutputArc, Arc, petrinet_Transition, petrinet_Place, petrinet_InputArc},
    associations={to9, from_11, petrinets14, elements0, fromNet1, toNet3, from_6, to7},
    generalizations={gen_petrinet_Transition_Node, gen_petrinet_Place_Node, gen_petrinet_Node_Element, gen_petrinet_Arc_Element, gen_petrinet_OutputArc_Arc, gen_petrinet_InputArc_Arc},
    metadata=None
)
