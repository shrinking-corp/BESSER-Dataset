...
class petrinet_Transition(Node):
    ...
    def __init__(self, maxDelay: float, minDelay: float, petrinet_Transition10: "petrinet_InputArc" = None, petrinet_Transition: "petrinet_OutputArc" = None):
...
class petrinet_PetriNet:
    ...
    def __init__(self, name: str, petrinet_PetriNet15: "petrinet_NetworkSystem" = None, petrinet_PetriNet: set["petrinet_Element"] = None, petrinet_PetriNet2: "petrinet_Arc" = None, petrinet_PetriNet5: "petrinet_Arc" = None):
        self.name = name
