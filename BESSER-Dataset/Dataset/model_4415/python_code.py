...
class arduino_Actuadores(ABC):
    ...
    def __init__(self, pin: str, arduino_Actuadores8: "arduino_Instrucciones" = None, arduino_Actuadores12: "arduino_Sensores" = None, arduino_Actuadores: "arduino_Sketch" = None, arduino_Actuadores29: "arduino_Bloques" = None, arduino_Actuadores38: "arduino_Bloques" = None):
        self.pin = pin
...
class arduino_Sensores(ABC):
    ...
    def __init__(self, pin: str, med: str, arduino_Sensores11: set["arduino_Actuadores"] = None, arduino_Sensores15: "arduino_Variar" = None, arduino_Sensores: "arduino_Sketch" = None, arduino_Sensores35: "arduino_Bloques" = None):
        self.pin = pin
        self.med = med
...
class arduino_Sketch:
    ...
    def __init__(self, Nombre: str, arduino_Sketch4: set["arduino_Instrucciones"] = None, arduino_Sketch6: set["arduino_Bloques"] = None, arduino_Sketch: set["arduino_Sensores"] = None, arduino_Sketch2: set["arduino_Actuadores"] = None):
        self.Nombre = Nombre
