...
arduino_Instrucciones = Class(name="arduino_Instrucciones", is_abstract=True)
arduino_Bloques = Class(name="arduino_Bloques", is_abstract=True)
arduino_Led = Class(name="arduino_Led")
Actuadores = Class(name="Actuadores")
arduino_LDR = Class(name="arduino_LDR")
Sensores = Class(name="Sensores")
arduino_Apagar = Class(name="arduino_Apagar")
Instrucciones = Class(name="Instrucciones")
arduino_Esperar = Class(name="arduino_Esperar")
arduino_Variar = Class(name="arduino_Variar")
arduino_Sensores = Class(name="arduino_Sensores", is_abstract=True)
arduino_Actuadores = Class(name="arduino_Actuadores", is_abstract=True)
arduino_If = Class(name="arduino_If")
Bloques = Class(name="Bloques")
arduino_While = Class(name="arduino_While")
arduino_Temperatura = Class(name="arduino_Temperatura")
arduino_Potenciometro = Class(name="arduino_Potenciometro")
arduino_Boton = Class(name="arduino_Boton")
arduino_PIR = Class(name="arduino_PIR")
arduino_Buzzer = Class(name="arduino_Buzzer")
arduino_Servo = Class(name="arduino_Servo")
arduino_Encender = Class(name="arduino_Encender")
...
arduino_If.attributes={arduino_If_operando, arduino_If_valor, arduino_If_referencia}
...
arduino_While.attributes={arduino_While_referencia, arduino_While_valor, arduino_While_operando}
...
arduino_Servo.attributes={arduino_Servo_libreria, arduino_Servo_angulo}
...
domain_model = DomainModel(
    name="arduino",
    types={arduino_Sketch, arduino_Instrucciones, arduino_Bloques, arduino_Led, Actuadores, arduino_LDR, Sensores, arduino_Apagar, Instrucciones, arduino_Esperar, arduino_Variar, arduino_Sensores, arduino_Actuadores, arduino_If, Bloques, arduino_While, arduino_Temperatura, arduino_Potenciometro, arduino_Boton, arduino_PIR, arduino_Buzzer, arduino_Servo, arduino_Encender, operandos},
    associations={instrucciones3, bloques5, actuadorinstruccion7, act10, esperar113, datos14, apagar16, sensores0, actuadores1, bactuadores27, binstrucciones30, bsensores33, bloacts36, encender19, esperar21, bloq25},
    generalizations={gen_arduino_Led_Actuadores, gen_arduino_LDR_Sensores, gen_arduino_Apagar_Instrucciones, gen_arduino_Variar_Instrucciones, gen_arduino_Esperar_Instrucciones, gen_arduino_If_Bloques, gen_arduino_While_Bloques, gen_arduino_Temperatura_Sensores, gen_arduino_Potenciometro_Sensores, gen_arduino_Boton_Sensores, gen_arduino_PIR_Sensores, gen_arduino_Buzzer_Actuadores, gen_arduino_Servo_Actuadores, gen_arduino_Encender_Instrucciones},
    metadata=None
)
