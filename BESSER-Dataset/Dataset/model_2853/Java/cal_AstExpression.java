...
public class cal_AstExpression  {
    ...
    private cal_AstAssignParameter cal_astassignparameter;
    ...
    public cal_AstExpression(
    ) {
    }



    public cal_AstAssignParameter getCal_astassignparameter() {
        return cal_astassignparameter;
    }

    public void setCal_astassignparameter(cal_AstAssignParameter cal_astassignparameter) {
        this.cal_astassignparameter = cal_astassignparameter;
    }
