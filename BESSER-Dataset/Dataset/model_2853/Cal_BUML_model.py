...
# Classes
cal_AstTop = Class(name="cal_AstTop")
cal_AstPackage = Class(name="cal_AstPackage")
AstTop = Class(name="AstTop")
cal_AstUnit = Class(name="cal_AstUnit")
cal_AstNamespace = Class(name="cal_AstNamespace")
AstPackage = Class(name="AstPackage")
AstUnit = Class(name="AstUnit")
cal_AstAbstractActor = Class(name="cal_AstAbstractActor")
cal_AstPort = Class(name="cal_AstPort")
cal_AstEntity = Class(name="cal_AstEntity")
cal_Import = Class(name="cal_Import")
cal_AstFunction = Class(name="cal_AstFunction")
cal_AstVariable = Class(name="cal_AstVariable")
cal_EObject = Class(name="cal_EObject")
cal_AstAnnotation = Class(name="cal_AstAnnotation")
cal_AstTypeName = Class(name="cal_AstTypeName")
cal_AstAssignParameter = Class(name="cal_AstAssignParameter")
cal_AstExpression = Class(name="cal_AstExpression")
cal_AstConnection = Class(name="cal_AstConnection")
cal_AstNetwork = Class(name="cal_AstNetwork")
AstAbstractActor = Class(name="AstAbstractActor")
cal_AstActorVariable = Class(name="cal_AstActorVariable")
cal_AstStructure = Class(name="cal_AstStructure")
cal_AstType = Class(name="cal_AstType")
cal_AstTypeDefinitionParameter = Class(name="cal_AstTypeDefinitionParameter")
cal_AstActorVariableReference = Class(name="cal_AstActorVariableReference")
cal_AstConnectionAttribute = Class(name="cal_AstConnectionAttribute")
cal_AstAction = Class(name="cal_AstAction")
cal_AstSchedule = Class(name="cal_AstSchedule")
cal_AstPriority = Class(name="cal_AstPriority")
cal_AstExternalFunction = Class(name="cal_AstExternalFunction")
AstExternalFunction = Class(name="AstExternalFunction")
cal_AstActor = Class(name="cal_AstActor")
cal_AstProcedure = Class(name="cal_AstProcedure")
cal_AstState = Class(name="cal_AstState")
cal_AstTransition = Class(name="cal_AstTransition")
cal_AstInputPattern = Class(name="cal_AstInputPattern")
AstExternalProcedure = Class(name="AstExternalProcedure")
cal_AstStatement = Class(name="cal_AstStatement")
cal_AstExternalProcedure = Class(name="cal_AstExternalProcedure")
cal_AstTag = Class(name="cal_AstTag")
cal_AstExternalActor = Class(name="cal_AstExternalActor")
cal_AstInequality = Class(name="cal_AstInequality")
cal_AstStatementAssign = Class(name="cal_AstStatementAssign")
AstStatement = Class(name="AstStatement")
cal_AstVariableReference = Class(name="cal_AstVariableReference")
cal_AstMemberAccess = Class(name="cal_AstMemberAccess")
cal_AstStatementCall = Class(name="cal_AstStatementCall")
cal_AstOutputPattern = Class(name="cal_AstOutputPattern")
cal_AstStatementIf = Class(name="cal_AstStatementIf")
cal_AstStatementWhile = Class(name="cal_AstStatementWhile")
cal_AstStatementForeach = Class(name="cal_AstStatementForeach")
cal_AstForeachGenerator = Class(name="cal_AstForeachGenerator")
cal_AstStatementBlock = Class(name="cal_AstStatementBlock")
cal_AstExpressionVariable = Class(name="cal_AstExpressionVariable")
cal_AstExpressionLiteral = Class(name="cal_AstExpressionLiteral")
cal_AstExpressionCall = Class(name="cal_AstExpressionCall")
AstExpression = Class(name="AstExpression")
cal_AstExpressionIf = Class(name="cal_AstExpressionIf")
cal_AstExpressionList = Class(name="cal_AstExpressionList")
cal_AstGenerator = Class(name="cal_AstGenerator")
cal_AstTypeParam = Class(name="cal_AstTypeParam")
cal_AstExpressionBoolean = Class(name="cal_AstExpressionBoolean")
AstExpressionLiteral = Class(name="AstExpressionLiteral")
cal_AstExpressionFloat = Class(name="cal_AstExpressionFloat")
cal_AstExpressionInteger = Class(name="cal_AstExpressionInteger")
cal_AstExpressionString = Class(name="cal_AstExpressionString")
cal_AstTypeParameterList = Class(name="cal_AstTypeParameterList")
cal_AstAnnotationArgument = Class(name="cal_AstAnnotationArgument")
cal_AstInitialize = Class(name="cal_AstInitialize")
AstAction = Class(name="AstAction")
cal_AstExpressionBinary = Class(name="cal_AstExpressionBinary")
cal_AstExpressionUnary = Class(name="cal_AstExpressionUnary")
...
else_226: BinaryAssociation = BinaryAssociation(
    name="else_226",
    ends={
...
else_244: BinaryAssociation = BinaryAssociation(
    name="else_244",
    ends={
...
domain_model = DomainModel(
    name="cal",
    types={cal_AstTop, cal_AstPackage, AstTop, cal_AstUnit, cal_AstNamespace, AstPackage, AstUnit, cal_AstAbstractActor, cal_AstPort, cal_AstEntity, cal_Import, cal_AstFunction, cal_AstVariable, cal_EObject, cal_AstAnnotation, cal_AstTypeName, cal_AstAssignParameter, cal_AstExpression, cal_AstConnection, cal_AstNetwork, AstAbstractActor, cal_AstActorVariable, cal_AstStructure, cal_AstType, cal_AstTypeDefinitionParameter, cal_AstActorVariableReference, cal_AstConnectionAttribute, cal_AstAction, cal_AstSchedule, cal_AstPriority, cal_AstExternalFunction, AstExternalFunction, cal_AstActor, cal_AstProcedure, cal_AstState, cal_AstTransition, cal_AstInputPattern, AstExternalProcedure, cal_AstStatement, cal_AstExternalProcedure, cal_AstTag, cal_AstExternalActor, cal_AstInequality, cal_AstStatementAssign, AstStatement, cal_AstVariableReference, cal_AstMemberAccess, cal_AstStatementCall, cal_AstOutputPattern, cal_AstStatementIf, cal_AstStatementWhile, cal_AstStatementForeach, cal_AstForeachGenerator, cal_AstStatementBlock, cal_AstExpressionVariable, cal_AstExpressionLiteral, cal_AstExpressionCall, AstExpression, cal_AstExpressionIf, cal_AstExpressionList, cal_AstGenerator, cal_AstTypeParam, cal_AstExpressionBoolean, AstExpressionLiteral, cal_AstExpressionFloat, cal_AstExpressionInteger, cal_AstExpressionString, cal_AstTypeParameterList, cal_AstAnnotationArgument, cal_AstInitialize, AstAction, cal_AstExpressionBinary, cal_AstExpressionUnary},
    associations={annotations18, actor21, parameters23, inputs26, entities0, imports1, units3, functions5, variables7, externals9, annotations11, typedefs13, namespaces16, type37, parameters40, value42, outputs28, variables31, instances33, structure35, annotations62, type65, dimensions67, parameters70, constructor72, type75, value78, connections44, from_46, to48, attribute51, variable53, value56, value59, procedures104, actions106, initializes108, stateVariables111, schedules114, priorities116, annotations118, type121, type81, members84, annotations87, parameters90, type93, variables96, expression99, functions102, initialState139, transitions141, source143, tags146, target149, annotations152, tag155, inputs158, annotations124, parameters127, variables130, statements133, tags135, inequalities136, repeat186, target189, indexes190, member193, value195, outputs160, guards162, variables165, statements168, port171, tokens174, repeat177, port180, values183, variables216, statements218, condition221, then223, else_226, condition229, statements231, procedure198, parameters200, generators203, variables204, statements207, variable210, expression213, generators249, variable251, expression254, value257, indexes259, member262, function234, parameters236, condition239, then241, else_244, expressions247, members279, params282, value284, type287, variable290, typeParams265, dimensions267, name270, domain274, codomain277, memberIndex293, arguments296, left298, right300, expression303},
    generalizations={gen_cal_AstPackage_AstTop, gen_cal_AstNamespace_AstTop, gen_cal_AstNamespace_AstPackage, gen_cal_AstNamespace_AstUnit, gen_cal_AstNetwork_AstAbstractActor, gen_cal_AstFunction_AstExternalFunction, gen_cal_AstActor_AstAbstractActor, gen_cal_AstProcedure_AstExternalProcedure, gen_cal_AstExternalActor_AstAbstractActor, gen_cal_AstStatementAssign_AstStatement, gen_cal_AstStatementIf_AstStatement, gen_cal_AstStatementWhile_AstStatement, gen_cal_AstStatementCall_AstStatement, gen_cal_AstStatementForeach_AstStatement, gen_cal_AstStatementBlock_AstStatement, gen_cal_AstExpressionVariable_AstExpression, gen_cal_AstExpressionLiteral_AstExpression, gen_cal_AstExpressionCall_AstExpression, gen_cal_AstExpressionIf_AstExpression, gen_cal_AstExpressionList_AstExpression, gen_cal_AstExpressionBoolean_AstExpressionLiteral, gen_cal_AstExpressionFloat_AstExpressionLiteral, gen_cal_AstExpressionInteger_AstExpressionLiteral, gen_cal_AstExpressionString_AstExpressionLiteral, gen_cal_AstInitialize_AstAction, gen_cal_AstExpressionBinary_AstExpression, gen_cal_AstExpressionUnary_AstExpression},
    metadata=None
)
