...
# Classes
FamilyMModel_Family = Class(name="FamilyMModel_Family")
FamilyMModel_Member = Class(name="FamilyMModel_Member")
...
FamilyMModel_Member.attributes={FamilyMModel_Member_firstName, FamilyMModel_Member_relation}
