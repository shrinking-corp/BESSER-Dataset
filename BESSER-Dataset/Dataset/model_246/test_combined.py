...
def test_hyp_ecore_y_is_not_abstract():
    assert not inspect.isabstract(ecore_Y)


def test_hyp_ecore_y_constructor_exists():
    assert callable(ecore_Y.__init__)


def test_hyp_ecore_y_constructor_args():
...
def test_hyp_ecore_x_is_not_abstract():
    assert not inspect.isabstract(ecore_X)


def test_hyp_ecore_x_constructor_exists():
    assert callable(ecore_X.__init__)


def test_hyp_ecore_x_constructor_args():
...
def test_hyp_ecore_c_is_not_abstract():
    assert not inspect.isabstract(ecore_C)


def test_hyp_ecore_c_constructor_exists():
    assert callable(ecore_C.__init__)


def test_hyp_ecore_c_constructor_args():
    sig = inspect.signature(ecore_C.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecore_b_is_not_abstract():
    assert not inspect.isabstract(ecore_B)


def test_hyp_ecore_b_constructor_exists():
    assert callable(ecore_B.__init__)


def test_hyp_ecore_b_constructor_args():
...
def test_hyp_ecore_a_is_not_abstract():
    assert not inspect.isabstract(ecore_A)


def test_hyp_ecore_a_constructor_exists():
    assert callable(ecore_A.__init__)


def test_hyp_ecore_a_constructor_args():
