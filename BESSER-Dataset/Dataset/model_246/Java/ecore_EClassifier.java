...
public class ecore_EClassifier extends ENamedElement {
    ...
    public ecore_EClassifier(
        String instanceTypeName,        String instanceClass,        String defaultValue,        String instanceClassName    ) {
        super(
        );
    ...
    public ecore_EClassifier(
        String instanceTypeName,        String instanceClass,        String defaultValue,        String instanceClassName        ArrayList<ecore_ETypeParameter> ecore_etypeparameters    ) {
        this.instanceTypeName = instanceTypeName;
        this.instanceClass = instanceClass;
        this.defaultValue = defaultValue;
        this.instanceClassName = instanceClassName;
