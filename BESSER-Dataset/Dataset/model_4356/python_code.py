...
class mpl_Operation(ABC):
    ...
    def __init__(self, name: str, mpl_Operation51: set["mpl_VariableDeclaration"] = None, mpl_Operation54: "mpl_Block" = None, mpl_Operation62: "mpl_OperationCall" = None, mpl_Operation66: "mpl_MPLModel" = None, mpl_Operation: set["mpl_VariableDeclaration"] = None):
        self.name = name
