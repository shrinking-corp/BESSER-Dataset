...
def test_hyp_calender_event_has_start_date():
    assert hasattr(Calender_Event, "start_date")
    descriptor = None
    for klass in Calender_Event.__mro__:
...
def test_hyp_calender_event_has_end_date():
    assert hasattr(Calender_Event, "end_date")
    descriptor = None
    for klass in Calender_Event.__mro__:
...
@given(instance=Calender_Event_strategy)
def test_hyp_calender_event_start_date_setter(instance):
...
@given(instance=Calender_Event_strategy)
def test_hyp_calender_event_end_date_setter(instance):
