...
def test_calender_event_has_start_date():
...
def test_calender_event_has_end_date():
...
@given(instance=Calender_Event_strategy)
def test_calender_event_start_date_setter(instance):
...
@given(instance=Calender_Event_strategy)
def test_calender_event_end_date_setter(instance):
