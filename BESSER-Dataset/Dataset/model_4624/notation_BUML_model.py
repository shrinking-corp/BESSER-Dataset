...
# Classes
notation_NotationDefinition = Class(name="notation_NotationDefinition")
notation_Relation = Class(name="notation_Relation", is_abstract=True)
notation_Compartment = Class(name="notation_Compartment")
Relation = Class(name="Relation")
notation_Link = Class(name="notation_Link")
notation_DiagramDefinition = Class(name="notation_DiagramDefinition")
notation_DiagramElement = Class(name="notation_DiagramElement", is_abstract=True)
notation_IDElement = Class(name="notation_IDElement")
IDElement = Class(name="IDElement")
notation_Node = Class(name="notation_Node")
DiagramElement = Class(name="DiagramElement")
notation_Line = Class(name="notation_Line")
notation_GraphicalElement = Class(name="notation_GraphicalElement", is_abstract=True)
notation_LineStyle = Class(name="notation_LineStyle")
notation_Figure = Class(name="notation_Figure", is_abstract=True)
notation_FigureStyle = Class(name="notation_FigureStyle")
notation_BorderStyle = Class(name="notation_BorderStyle")
notation_SyntaxOf = Class(name="notation_SyntaxOf")
GraphicalElement = Class(name="GraphicalElement")
notation_FigureContainment = Class(name="notation_FigureContainment")
notation_Icon = Class(name="notation_Icon")
notation_IconStyle = Class(name="notation_IconStyle")
notation_Image = Class(name="notation_Image")
notation_Composite = Class(name="notation_Composite")
notation_Label = Class(name="notation_Label")
notation_TextStyle = Class(name="notation_TextStyle")
notation_TextualContainment = Class(name="notation_TextualContainment")
notation_Token = Class(name="notation_Token")
TextualElement = Class(name="TextualElement")
notation_Keyword = Class(name="notation_Keyword")
notation_Value = Class(name="notation_Value", is_abstract=True)
notation_AttributeValue = Class(name="notation_AttributeValue")
Value = Class(name="Value")
notation_ReferenceValue = Class(name="notation_ReferenceValue")
notation_Style = Class(name="notation_Style", is_abstract=True)
Style = Class(name="Style")
notation_Rectangle = Class(name="notation_Rectangle")
Figure = Class(name="Figure")
notation_Roundtangle = Class(name="notation_Roundtangle")
notation_Square = Class(name="notation_Square")
notation_Diamond = Class(name="notation_Diamond")
notation_Triangle = Class(name="notation_Triangle")
notation_Circle = Class(name="notation_Circle")
notation_Cylinder = Class(name="notation_Cylinder")
notation_Cube = Class(name="notation_Cube")
notation_Polyline = Class(name="notation_Polyline")
notation_Point = Class(name="notation_Point")
notation_TextualElement = Class(name="notation_TextualElement", is_abstract=True)
...
notation_DiagramDefinition.attributes={notation_DiagramDefinition_allowChunks, notation_DiagramDefinition_Legend, notation_DiagramDefinition_targetedAudience, notation_DiagramDefinition_Level}
...
notation_LineStyle.attributes={notation_LineStyle_brightness, notation_LineStyle_color, notation_LineStyle_orientation, notation_LineStyle_thickness, notation_LineStyle_texture, notation_LineStyle_length}
...
notation_FigureStyle.attributes={notation_FigureStyle_fillColor, notation_FigureStyle_fillOrientation, notation_FigureStyle_brightness, notation_FigureStyle_fillTexture, notation_FigureStyle_width, notation_FigureStyle_orientation, notation_FigureStyle_fillTextureColor, notation_FigureStyle_height}
...
notation_IconStyle.attributes={notation_IconStyle_brightness, notation_IconStyle_color, notation_IconStyle_height, notation_IconStyle_orientation, notation_IconStyle_width}
...
notation_TextStyle.attributes={notation_TextStyle_underlined, notation_TextStyle_italic, notation_TextStyle_fontSize, notation_TextStyle_fontColor, notation_TextStyle_fontName, notation_TextStyle_bold}
...
notation_Point.attributes={notation_Point_x, notation_Point_y}
...
domain_model = DomainModel(
    name="notation",
    types={notation_NotationDefinition, notation_Relation, notation_Compartment, Relation, notation_Link, notation_DiagramDefinition, notation_DiagramElement, notation_IDElement, IDElement, notation_Node, DiagramElement, notation_Line, notation_GraphicalElement, notation_LineStyle, notation_Figure, notation_FigureStyle, notation_BorderStyle, notation_SyntaxOf, GraphicalElement, notation_FigureContainment, notation_Icon, notation_IconStyle, notation_Image, notation_Composite, notation_Label, notation_TextStyle, notation_TextualContainment, notation_Token, TextualElement, notation_Keyword, notation_Value, notation_AttributeValue, Value, notation_ReferenceValue, notation_Style, Style, notation_Rectangle, Figure, notation_Roundtangle, notation_Square, notation_Diamond, notation_Triangle, notation_Circle, notation_Cylinder, notation_Cube, notation_Polyline, notation_Point, notation_TextualElement, Color, Orientation, LineTextureType, FillTextureType, DefinitionType, Layout, IconType, AudienceType},
    associations={nodeType4, graphicalElement6, diagrams0, elements1, graphicalElement3, lineStyle21, figureStyle22, borderStyle23, figureContainment25, referredElement8, style10, approximateRepresentation11, subElements13, primaryShape15, textStyle18, text19, elements27, points30, elements31},
    generalizations={gen_notation_Relation_DiagramElement, gen_notation_Compartment_Relation, gen_notation_Link_Relation, gen_notation_GraphicalElement_IDElement, gen_notation_DiagramElement_IDElement, gen_notation_Node_DiagramElement, gen_notation_Line_GraphicalElement, gen_notation_Figure_GraphicalElement, gen_notation_SyntaxOf_GraphicalElement, gen_notation_Icon_GraphicalElement, gen_notation_Image_GraphicalElement, gen_notation_Composite_GraphicalElement, gen_notation_Label_GraphicalElement, gen_notation_Token_TextualElement, gen_notation_Keyword_TextualElement, gen_notation_Value_TextualElement, gen_notation_AttributeValue_Value, gen_notation_ReferenceValue_Value, gen_notation_LineStyle_Style, gen_notation_Rectangle_Figure, gen_notation_Roundtangle_Figure, gen_notation_Square_Figure, gen_notation_Diamond_Figure, gen_notation_Triangle_Figure, gen_notation_Circle_Figure, gen_notation_Cylinder_Figure, gen_notation_Cube_Figure, gen_notation_Polyline_Figure, gen_notation_TextualElement_IDElement, gen_notation_FigureStyle_Style, gen_notation_IconStyle_Style, gen_notation_BorderStyle_Style, gen_notation_TextStyle_Style},
    metadata=None
)
