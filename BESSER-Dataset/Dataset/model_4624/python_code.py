...
class notation_TextStyle(Style):
    ...
    def __init__(self, bold: bool, italic: bool, underlined: bool, fontColor: str, fontSize: int, fontName: str, notation_TextStyle: "notation_Label" = None):
        self.bold = bold
        self.italic = italic
...
class notation_FigureStyle(Style):
    ...
    def __init__(self, width: float, height: float, orientation: str, brightness: int, fillColor: str, fillTexture: str, fillOrientation: str, fillTextureColor: str, notation_FigureStyle: "notation_Figure" = None):
        self.width = width
        self.height = height
        self.orientation = orientation
        self.brightness = brightness
