...
Engine_Interface = Class(name="Engine_Interface")
powered_vechile = Class(name="powered_vechile")
...
# Engine_Interface class attributes and methods

# powered_vechile class attributes and methods
...
domain_model = DomainModel(
    name="a3c7ffc8_424b_4125_9f7c_466383d55112",
    types={Library_Management_Component, Member_Actor, Librarian_Actor, Engine_Interface, powered_vechile, Inquiry_for_membership_external, Request_book_external, Request_book_return_external, Search_books_external, Issue_member_card_external, Issue_book_external, Return_book_external, Update_member_profile_external},
