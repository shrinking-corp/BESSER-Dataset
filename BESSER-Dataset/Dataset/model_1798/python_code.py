...
class bibtexml_DocumentRoot:
    ...
    def __init__(self, mixed: str, address: str, annote: str, author: str, booktitle: str, chapter: str, crossref: str, doi: str, edition: str, editor: str, howpublished: str, institution: str, journal: str, key: str, number: str, organization: str, pages: str, month: str, note: str, title: str, type: str, publisher: str, school: str, series: str, url: str, volume: str, year: str, bibtexml_DocumentRoot54: set["bibtexml_InproceedingsType"] = None, bibtexml_DocumentRoot57: set["bibtexml_ManualType"] = None, bibtexml_DocumentRoot60: set["bibtexml_MastersthesisType"] = None, bibtexml_DocumentRoot63: set["bibtexml_MiscType"] = None, bibtexml_DocumentRoot72: set["bibtexml_TechreportType"] = None, bibtexml_DocumentRoot66: set["bibtexml_PhdthesisType"] = None, bibtexml_DocumentRoot69: set["bibtexml_ProceedingsType"] = None, bibtexml_DocumentRoot75: set["bibtexml_UnpublishedType"] = None, bibtexml_DocumentRoot29: set["bibtexml_EStringToStringMapEntry"] = None, bibtexml_DocumentRoot32: set["bibtexml_ArticleType"] = None, bibtexml_DocumentRoot35: set["bibtexml_BookType"] = None, bibtexml_DocumentRoot38: set["bibtexml_BookletType"] = None, bibtexml_DocumentRoot: set["bibtexml_EStringToStringMapEntry"] = None, bibtexml_DocumentRoot41: set["bibtexml_ConferenceType"] = None, bibtexml_DocumentRoot44: set["bibtexml_BibTeXMLEntryType"] = None, bibtexml_DocumentRoot46: set["bibtexml_FileType"] = None, bibtexml_DocumentRoot48: set["bibtexml_InbookType"] = None, bibtexml_DocumentRoot51: set["bibtexml_IncollectionType"] = None):
        self.mixed = mixed
...
class bibtexml_BibTeXMLEntryType(BibTeXMLEntriesClass):
    ...
    def __init__(self, id: str, bibtexml_BibTeXMLEntryType79: "bibtexml_FileType" = None, bibtexml_BibTeXMLEntryType: "bibtexml_DocumentRoot" = None):
        self.id = id
...
class bibtexml_MiscType:
    ...
    def __init__(self, author: str, crossref: str, doi: str, url: str, title: str, howpublished: str, month: str, year: str, note: str, key: str, bibtexml_MiscType64: "bibtexml_DocumentRoot" = None, bibtexml_MiscType: "bibtexml_BibTeXMLEntriesClass" = None):
        self.author = author
        self.crossref = crossref
        self.doi = doi
        self.url = url
...
class bibtexml_UnpublishedType:
    ...
    def __init__(self, author: str, year: str, key: str, crossref: str, doi: str, url: str, title: str, note: str, month: str, bibtexml_UnpublishedType: "bibtexml_BibTeXMLEntriesClass" = None, bibtexml_UnpublishedType76: "bibtexml_DocumentRoot" = None):
        self.author = author
        self.year = year
        self.key = key
        self.crossref = crossref
...
class bibtexml_ConferenceType:
    ...
    def __init__(self, author: str, title: str, booktitle: str, year: str, editor: str, volume: str, number: str, series: str, address: str, month: str, organization: str, publisher: str, note: str, key: str, crossref: str, doi: str, url: str, pages: str, bibtexml_ConferenceType: "bibtexml_BibTeXMLEntriesClass" = None, bibtexml_ConferenceType42: "bibtexml_DocumentRoot" = None):
        self.author = author
        self.title = title
        self.booktitle = booktitle
        self.year = year
...
class bibtexml_InproceedingsType:
    ...
    def __init__(self, author: str, title: str, booktitle: str, month: str, organization: str, publisher: str, note: str, year: str, editor: str, volume: str, number: str, series: str, pages: str, address: str, key: str, crossref: str, doi: str, url: str, bibtexml_InproceedingsType: "bibtexml_BibTeXMLEntriesClass" = None, bibtexml_InproceedingsType55: "bibtexml_DocumentRoot" = None):
        self.author = author
        self.title = title
        self.booktitle = booktitle
        self.month = month
...
class bibtexml_ProceedingsType:
    ...
    def __init__(self, volume: str, number: str, series: str, address: str, editor: str, title: str, year: str, publisher: str, note: str, key: str, crossref: str, month: str, organization: str, doi: str, url: str, bibtexml_ProceedingsType: "bibtexml_BibTeXMLEntriesClass" = None, bibtexml_ProceedingsType70: "bibtexml_DocumentRoot" = None):
        self.volume = volume
        self.number = number
        self.series = series
        self.address = address
...
class bibtexml_IncollectionType:
    ...
    def __init__(self, author: str, title: str, series: str, type: str, chapter: str, pages: str, address: str, booktitle: str, publisher: str, year: str, editor: str, volume: str, number: str, url: str, edition: str, month: str, note: str, key: str, crossref: str, doi: str, bibtexml_IncollectionType: "bibtexml_BibTeXMLEntriesClass" = None, bibtexml_IncollectionType52: "bibtexml_DocumentRoot" = None):
        self.author = author
        self.title = title
        self.series = series
        self.type = type
...
class bibtexml_InbookType:
    ...
    def __init__(self, author: str, editor: str, title: str, volume: str, number: str, series: str, type: str, address: str, chapter: str, pages: str, pages1: str, publisher: str, year: str, doi: str, url: str, edition: str, month: str, note: str, key: str, crossref: str, bibtexml_InbookType: "bibtexml_BibTeXMLEntriesClass" = None, bibtexml_InbookType49: "bibtexml_DocumentRoot" = None):
        self.author = author
        self.editor = editor
        self.title = title
        self.volume = volume
...
class bibtexml_PhdthesisType:
    ...
    def __init__(self, author: str, title: str, month: str, note: str, key: str, crossref: str, school: str, year: str, type: str, address: str, doi: str, url: str, bibtexml_PhdthesisType: "bibtexml_BibTeXMLEntriesClass" = None, bibtexml_PhdthesisType67: "bibtexml_DocumentRoot" = None):
        self.author = author
        self.title = title
        self.month = month
        self.note = note
...
class bibtexml_MastersthesisType:
    ...
    def __init__(self, author: str, title: str, school: str, crossref: str, doi: str, url: str, year: str, type: str, address: str, month: str, note: str, key: str, bibtexml_MastersthesisType: "bibtexml_BibTeXMLEntriesClass" = None, bibtexml_MastersthesisType61: "bibtexml_DocumentRoot" = None):
        self.author = author
        self.title = title
        self.school = school
        self.crossref = crossref
...
class bibtexml_TechreportType:
    ...
    def __init__(self, author: str, title: str, institution: str, month: str, note: str, key: str, crossref: str, doi: str, url: str, year: str, type: str, number: str, address: str, bibtexml_TechreportType: "bibtexml_BibTeXMLEntriesClass" = None, bibtexml_TechreportType73: "bibtexml_DocumentRoot" = None):
        self.author = author
        self.title = title
        self.institution = institution
        self.month = month
...
class bibtexml_ManualType:
    ...
    def __init__(self, author: str, title: str, organization: str, address: str, doi: str, url: str, edition: str, month: str, year: str, note: str, key: str, crossref: str, bibtexml_ManualType: "bibtexml_BibTeXMLEntriesClass" = None, bibtexml_ManualType58: "bibtexml_DocumentRoot" = None):
        self.author = author
        self.title = title
        self.organization = organization
        self.address = address
...
class bibtexml_BookletType:
    ...
    def __init__(self, author: str, title: str, howpublished: str, address: str, month: str, year: str, note: str, key: str, crossref: str, doi: str, url: str, bibtexml_BookletType: "bibtexml_BibTeXMLEntriesClass" = None, bibtexml_BookletType39: "bibtexml_DocumentRoot" = None):
        self.author = author
        self.title = title
        self.howpublished = howpublished
        self.address = address
...
class bibtexml_BookType:
    ...
    def __init__(self, author: str, editor: str, title: str, publisher: str, year: str, number: str, series: str, address: str, edition: str, month: str, note: str, key: str, crossref: str, volume: str, url: str, doi: str, bibtexml_BookType: "bibtexml_BibTeXMLEntriesClass" = None, bibtexml_BookType36: "bibtexml_DocumentRoot" = None):
        self.author = author
        self.editor = editor
        self.title = title
        self.publisher = publisher
...
class bibtexml_ArticleType:
    ...
    def __init__(self, author: str, title: str, journal: str, year: str, volume: str, number: str, pages: str, month: str, key: str, crossref: str, doi: str, url: str, note: str, bibtexml_ArticleType: "bibtexml_BibTeXMLEntriesClass" = None, bibtexml_ArticleType33: "bibtexml_DocumentRoot" = None):
        self.author = author
        self.title = title
        self.journal = journal
        self.year = year
