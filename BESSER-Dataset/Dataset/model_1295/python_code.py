...
class StateMachine_Region:
    ...
    def __init__(self, name: str, StateMachine_Region27: "StateMachine_StateMachine" = None, StateMachine_Region23: set["StateMachine_Vertex"] = None, StateMachine_Region25: set["StateMachine_Transition"] = None, StateMachine_Region: "StateMachine_State" = None):
        self.name = name
...
class StateMachine_State(Vertex):
    ...
    def __init__(self, isComposite: str, isSimple: str, isSubmachineState: str, State: "StateMachine_StateMachine" = None, StateMachine_State4: set["StateMachine_Trigger"] = None, StateMachine_State6: "StateMachine_Constraint" = None, StateMachine_State8: "StateMachine_Behavior" = None, StateMachine_State11: "StateMachine_Behavior" = None, submachineState: "StateMachine_StateMachine" = None, StateMachine_State15: "StateMachine_PseudoState" = None, StateMachine_State17: set["StateMachine_PseudoState"] = None, StateMachine_State: set["StateMachine_Region"] = None, StateMachine_State2: "StateMachine_Behavior" = None):
...
class StateMachine_Transition:
    ...
    def __init__(self, kind: str, name: str, StateMachine_Transition39: "StateMachine_Constraint" = None, outgoing: "StateMachine_Vertex" = None, incoming: "StateMachine_Vertex" = None, Transition: "StateMachine_Vertex" = None, Transition21: "StateMachine_Vertex" = None, StateMachine_Transition: "StateMachine_Region" = None, StateMachine_Transition33: "StateMachine_Behavior" = None, StateMachine_Transition36: set["StateMachine_Trigger"] = None):
        self.kind = kind
        self.name = name
...
class StateMachine_Vertex:
    ...
    def __init__(self, name: str, Vertex: "StateMachine_Transition" = None, Vertex31: "StateMachine_Transition" = None, source: set["StateMachine_Transition"] = None, target: set["StateMachine_Transition"] = None, StateMachine_Vertex: "StateMachine_Region" = None):
        self.name = name
        self.Vertex = Vertex
...
class StateMachine_StateMachine(Behavior):
    ...
    def __init__(self, name: str, StateMachine_StateMachine: set["StateMachine_Region"] = None, submachine: set["StateMachine_State"] = None, StateMachine: "StateMachine_State" = None):
        self.name = name
...
class StateMachine_Constraint:
    ...
    def __init__(self, constraint: str, StateMachine_Constraint40: "StateMachine_Transition" = None, StateMachine_Constraint: "StateMachine_State" = None):
