...
StateMachine_Vertex = Class(name="StateMachine_Vertex")
...
StateMachine_CodeBlock = Class(name="StateMachine_CodeBlock")
...
StateMachine_State.attributes={StateMachine_State_isSubmachineState, StateMachine_State_isSimple, StateMachine_State_isComposite}
...
domain_model = DomainModel(
    name="StateMachine",
    types={StateMachine_Constraint, StateMachine_StateMachine, StateMachine_PseudoState, StateMachine_Vertex, StateMachine_Transition, StateMachine_FinalState, State, StateMachine_State, Vertex, StateMachine_Region, StateMachine_Behavior, StateMachine_Trigger, StateMachine_CodeBlock, Behavior, TransitionKind, PseudoStateKind},
    associations={deferrableTrigger3, stateInvariant5, exit7, entry10, submachine13, entryPoint14, exitPoint16, outgoing19, incoming20, subvertex22, transition24, region0, doActivity1, effect32, trigger35, guard38, region26, submachineState28, source29, target30},
    generalizations={gen_StateMachine_FinalState_State, gen_StateMachine_State_Vertex, gen_StateMachine_CodeBlock_Behavior, gen_StateMachine_PseudoState_Vertex, gen_StateMachine_StateMachine_Behavior},
    metadata=None
)
