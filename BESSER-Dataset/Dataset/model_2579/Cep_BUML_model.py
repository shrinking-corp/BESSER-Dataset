...
# Classes
events_EventModel = Class(name="events_EventModel")
events_EventPattern = Class(name="events_EventPattern", is_abstract=True)
events_Timewindow = Class(name="events_Timewindow")
events_EventPatternReference = Class(name="events_EventPatternReference")
events_AbstractMultiplicity = Class(name="events_AbstractMultiplicity", is_abstract=True)
events_Event = Class(name="events_Event")
events_EventSource = Class(name="events_EventSource", is_abstract=True)
events_OR = Class(name="events_OR")
ComplexEventOperator = Class(name="ComplexEventOperator")
events_NEG = Class(name="events_NEG")
events_FOLLOWS = Class(name="events_FOLLOWS")
events_AND = Class(name="events_AND")
events_Multiplicity = Class(name="events_Multiplicity")
AbstractMultiplicity = Class(name="AbstractMultiplicity")
events_Infinite = Class(name="events_Infinite")
events_AtLeastOne = Class(name="events_AtLeastOne")
events_Automaton = Class(name="events_Automaton")
events_AtomicEventPattern = Class(name="events_AtomicEventPattern")
EventPattern = Class(name="EventPattern")
events_ComplexEventPattern = Class(name="events_ComplexEventPattern")
events_ComplexEventOperator = Class(name="events_ComplexEventOperator", is_abstract=True)
...
events_Event.attributes={events_Event_isProcessed, events_Event_timestamp, events_Event_type}
...
domain_model = DomainModel(
    name="events",
    types={events_EventModel, events_EventPattern, events_Timewindow, events_EventPatternReference, events_AbstractMultiplicity, events_Event, events_EventSource, events_OR, ComplexEventOperator, events_NEG, events_FOLLOWS, events_AND, events_Multiplicity, AbstractMultiplicity, events_Infinite, events_AtLeastOne, events_Automaton, events_AtomicEventPattern, EventPattern, events_ComplexEventPattern, events_ComplexEventOperator},
    associations={eventPatterns0, eventModel1, timewindow4, containedEventPatterns6, eventPattern8, multiplicity11, source13, automaton2, operator3},
    generalizations={gen_events_OR_ComplexEventOperator, gen_events_NEG_ComplexEventOperator, gen_events_FOLLOWS_ComplexEventOperator, gen_events_AND_ComplexEventOperator, gen_events_Multiplicity_AbstractMultiplicity, gen_events_Infinite_AbstractMultiplicity, gen_events_AtomicEventPattern_EventPattern, gen_events_ComplexEventPattern_EventPattern, gen_events_AtLeastOne_AbstractMultiplicity},
    metadata=None
)
