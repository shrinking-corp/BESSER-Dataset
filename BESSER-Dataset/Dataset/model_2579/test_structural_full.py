...
def test_events_ComplexEventPattern_isa_EventPattern():
    instance = events_ComplexEventPattern()
    assert isinstance(instance, EventPattern)
...
def test_assoc_containedEventPatterns6_link_reassign_clear():
    ...
    b1 = events_ComplexEventPattern()
    b2 = events_ComplexEventPattern()
...
events_ComplexEventPattern_strategy = st.builds(events_ComplexEventPattern)
