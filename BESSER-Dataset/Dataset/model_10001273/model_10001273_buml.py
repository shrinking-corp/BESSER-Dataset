...
Item.attributes={Item_quantity, Item_id, Item_price}
...
Account.attributes={Account_billingAddress, Account_openDate, Account_id}
...
Payment.attributes={Payment_comments, Payment_total, Payment_id}
...
Customer.attributes={Customer_isBan, Customer_login, Customer_password, Customer_id, Customer_emailAddress, Customer_lastname, Customer_firstname}
...
domain_model = DomainModel(
    name="_9b8bf6af_0d78_47ec_bf12_2b1fb24f2ffb",
    types={ShoppingCart, Item, Product, Account, Payment, Order, Customer, Class_, OrderStatus},
    associations={association3, association4, association5, association6, association7, association8, association2},
    generalizations={},
    metadata=None
)
