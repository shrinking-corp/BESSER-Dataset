...
automaton_Parameter.attributes={automaton_Parameter_symbolicName, automaton_Parameter_position}
...
domain_model = DomainModel(
    name="automaton",
    types={automaton_Event, automaton_EventToken, automaton_State, automaton_InternalModel, automaton_Automaton, automaton_TimedZone, automaton_InitState, automaton_FinalState, automaton_TrapState, automaton_ParameterTable, automaton_Transition, automaton_Guard, automaton_Parameter, State, automaton_TypedTransition, Transition, automaton_NegativeTransition, TypedTransition, automaton_EpsilonTransition, automaton_EventPattern, automaton_ParameterBinding, automaton_Within, TimedZone, automaton_HoldsFor, EventContext},
    associations={latestEvent1, enabledForTheLatestEvent3, eventTokensInModel6, states8, automata0, timedZones13, initialState15, finalStates17, trapState19, eventTokens10, recordedEvents22, lastProcessed25, timedZones28, parameterTable31, inTransitions32, outTransitions33, currentState21, lastProcessedEvent36, inStateOf39, guards46, parameters47, outStateOf40, eventTokens35, preState42, postState44, inState51, eventType49, transition50, parameterBindings57, eventToken58, outState53, transition55, parameterTable61},
    generalizations={gen_automaton_InitState_State, gen_automaton_FinalState_State, gen_automaton_TrapState_State, gen_automaton_TypedTransition_Transition, gen_automaton_NegativeTransition_TypedTransition, gen_automaton_EpsilonTransition_Transition, gen_automaton_Within_TimedZone, gen_automaton_HoldsFor_TimedZone},
    metadata=None
)
