...
class automaton_ParameterBinding:
    ...
    def __init__(self, symbolicName: str, value: str, parameterBindings: "automaton_ParameterTable" = None, ParameterBinding: "automaton_ParameterTable" = None):
...
class automaton_Automaton:
    ...
    def __init__(self, eventPatternId: str, automaton_Automaton5: "automaton_InternalModel" = None, automaton_Automaton9: set["automaton_State"] = None, automaton_Automaton: "automaton_InternalModel" = None, automaton_Automaton14: set["automaton_TimedZone"] = None, automaton_Automaton16: "automaton_InitState" = None, automaton_Automaton18: set["automaton_FinalState"] = None, automaton_Automaton20: "automaton_TrapState" = None, automaton_Automaton11: set["automaton_EventToken"] = None):
...
class automaton_State:
    ...
    def __init__(self, label: str, automaton_State: "automaton_Automaton" = None, postState: set["automaton_Transition"] = None, preState: set["automaton_Transition"] = None, State: "automaton_EventToken" = None, automaton_State37: "automaton_Event" = None, inState: set["automaton_TimedZone"] = None, outState: set["automaton_TimedZone"] = None, currentState: set["automaton_EventToken"] = None, State43: "automaton_Transition" = None, State45: "automaton_Transition" = None, State52: "automaton_TimedZone" = None, State54: "automaton_TimedZone" = None):
        self.label = label
