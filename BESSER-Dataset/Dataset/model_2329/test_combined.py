...
def test_hyp_my_testenum2_is_not_abstract():
    assert not inspect.isabstract(My_TestEnum2)


def test_hyp_my_testenum2_constructor_exists():
    assert callable(My_TestEnum2.__init__)


def test_hyp_my_testenum2_constructor_args():
    sig = inspect.signature(My_TestEnum2.__init__)
    params = list(sig.parameters.keys())



def test_hyp_my_testclass2_is_not_abstract():
    assert not inspect.isabstract(My_TestClass2)


def test_hyp_my_testclass2_constructor_exists():
    assert callable(My_TestClass2.__init__)


def test_hyp_my_testclass2_constructor_args():
    sig = inspect.signature(My_TestClass2.__init__)
    params = list(sig.parameters.keys())



def test_hyp_my_testclass_is_not_abstract():
    assert not inspect.isabstract(My_TestClass)


def test_hyp_my_testclass_constructor_exists():
    assert callable(My_TestClass.__init__)


def test_hyp_my_testclass_constructor_args():
...
def test_hyp_my_testclass_testAtt2_setter(instance):
...
@given(instance=My_TestClass_strategy)
def test_hyp_my_testclass_testAtt_setter(instance):
...
def test_My_TestClass_testAtt_value_roundtrip():
    instance = My_TestClass(testAtt="sample_text", testAtt2="sample_text")
    assert instance.testAtt == "sample_text"
    instance.testAtt = "sample_text_2"
    assert instance.testAtt == "sample_text_2"


def test_My_TestClass_testAtt2_value_roundtrip():
    instance = My_TestClass(testAtt="sample_text", testAtt2="sample_text")
...
My_TestClass_strategy = st.builds(My_TestClass, testAtt=safe_text, testAtt2=safe_text)
@given(instance=My_TestClass_strategy)
...
My_TestClass2_strategy = st.builds(My_TestClass2)
...
My_TestEnum2_strategy = st.builds(My_TestEnum2)
