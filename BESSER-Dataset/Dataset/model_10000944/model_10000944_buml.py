...
Restaurant.attributes={Restaurant_PostCode, Restaurant_Address, Restaurant_Name, Restaurant_Menu}
...
Food.attributes={Food_Price, Food_Vegetarian, Food_Calories}
...
Order.attributes={Order_ItemList, Order_Restaurant, Order_Customer}
...
Customer.attributes={Customer_Cellphone, Customer_CreditCard, Customer_Address, Customer_FullName, Customer_PostCode}
...
domain_model = DomainModel(
    name="_72fcca3d_c7ac_4be6_b170_57f052a8847a",
    types={Restaurant, MenuItem, FoodPackage, FoodItem, Food, Order, Customer, RestaurantController, OrderController},
    associations={MenuItem_FoodItem, MenuItem_FoodPackage, FoodItem_Food, FoodPackage_Food, Restaurant_MenuItem, Order_Customer, RestaurantManager_Restaurant, OrderController_Order, Order_MenuItem, Order_Restaurant},
    generalizations={},
    metadata=None
)
