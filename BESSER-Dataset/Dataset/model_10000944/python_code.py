...
class Order:
    ...
    def __init__(self, Restaurant: Restaurant, ItemList: MenuItem, Customer: Customer, Order_Customer_014: "Customer" = None, OrderController_Order_119: set["OrderController"] = None, Order_MenuItem_010: set["MenuItem"] = None, Order_Restaurant_012: "Restaurant" = None):
        self.Restaurant = Restaurant
...
class MenuItem:
    ...
    def __init__(self, Description: str, MenuItem_FoodItem_00: set["FoodItem"] = None, MenuItem_FoodPackage_02: set["FoodPackage"] = None, Restaurant_MenuItem_19: set["Restaurant"] = None, Order_MenuItem_111: set["Order"] = None):
...
class Restaurant:
    ...
    def __init__(self, Name: str, Address: str, PostCode: int, Menu: MenuItem, Restaurant_MenuItem_08: set["MenuItem"] = None, RestaurantManager_Restaurant_117: set["RestaurantController"] = None, Order_Restaurant_113: set["Order"] = None):
        self.Name = Name
        self.Address = Address
        self.PostCode = PostCode
        self.Menu = Menu
