...
class rcd_ClassModel:
    ...
    def __init__(self, name: str, rcd_ClassModel: set["rcd_Classifier"] = None, rcd_ClassModel14: set["rcd_Association"] = None):
        self.name = name
...
class rcd_Class(Classifier):
    ...
    def __init__(self, is_persistent: bool, rcd_Class: "rcd_Association" = None, rcd_Class3: "rcd_Association" = None, rcd_Class10: "rcd_Class" = None, rcd_Class8: "rcd_Class" = None, rcd_Class6: set["rcd_Attribute"] = None):
...
class rcd_Association:
    ...
    def __init__(self, name: str, upper: str, lower: str, rcd_Association: "rcd_Class" = None, rcd_Association2: "rcd_Class" = None, rcd_Association15: "rcd_ClassModel" = None):
        self.name = name
        self.upper = upper
        self.lower = lower
