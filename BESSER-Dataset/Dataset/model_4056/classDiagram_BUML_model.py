...
classDiagram_ClassModel = Class(name="classDiagram_ClassModel")
...
classDiagram_ModelingConcept = Class(name="classDiagram_ModelingConcept", is_abstract=True)
ModelingConcept = Class(name="ModelingConcept")
classDiagram_Method = Class(name="classDiagram_Method")
classDiagram_ElementType = Class(name="classDiagram_ElementType")
...
classDiagram_Class.attributes={classDiagram_Class_accessModifier, classDiagram_Class_isAbstract, classDiagram_Class_isStatic}
...
classDiagram_Method.attributes={classDiagram_Method_accessModifier, classDiagram_Method_body, classDiagram_Method_isAbstract, classDiagram_Method_isStatic}
...
domain_model = DomainModel(
    name="classDiagram",
    types={classDiagram_Class, Classifier, classDiagram_ClassModel, classDiagram_Package, classDiagram_Attribute, classDiagram_Type, classDiagram_ModelingConcept, ModelingConcept, classDiagram_Method, classDiagram_ElementType, classDiagram_Classifier, AccessModifier},
    associations={elements3, package6, subpackages8, classes10, type29, packages0, fields12, types1, supertypes15, subtypes17, methods19, type21, returnType23, parameters26},
