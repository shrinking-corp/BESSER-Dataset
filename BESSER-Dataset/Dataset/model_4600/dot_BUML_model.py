...
dot_RecordNode = Class(name="dot_RecordNode")
Node = Class(name="Node")
dot_InnerNode = Class(name="dot_InnerNode")
dot_Edge = Class(name="dot_Edge")
...
dot_Settings = Class(name="dot_Settings")
dot_StringToStringMapEntry = Class(name="dot_StringToStringMapEntry")
dot_AttributedItem = Class(name="dot_AttributedItem", is_abstract=True)
dot_Assignment = Class(name="dot_Assignment")
...
dot_Assignment.attributes={dot_Assignment_value, dot_Assignment_key}
...
domain_model = DomainModel(
    name="dot",
    types={dot_Node, AttributedItem, dot_RecordNode, Node, dot_InnerNode, dot_Edge, dot_Graph, Identifiable, Statement, dot_Statement, dot_Identifiable, dot_Settings, dot_StringToStringMapEntry, dot_AttributedItem, dot_Assignment, SettingsType},
    associations={innerNodes1, statements0, source2, target3, attributes6, recordNode7},
    generalizations={gen_dot_Node_Identifiable, gen_dot_Node_Statement, gen_dot_Node_AttributedItem, gen_dot_RecordNode_Node, gen_dot_Edge_Statement, gen_dot_Edge_AttributedItem, gen_dot_Graph_Identifiable, gen_dot_Graph_Statement, gen_dot_Settings_Statement, gen_dot_Settings_AttributedItem, gen_dot_InnerNode_Node, gen_dot_Assignment_Statement},
    metadata=None
)
