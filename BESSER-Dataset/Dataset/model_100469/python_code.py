...
class stext_FeatureCall(Expression):
    ...
    def __init__(self, operationCall: bool, stext_FeatureCall108: set["stext_Expression"] = None, stext_FeatureCall: "stext_Expression" = None, stext_FeatureCall106: "stext_Feature" = None):
