...
paramTypes18: BinaryAssociation = BinaryAssociation(
    name="paramTypes18",
    ends={
        Property(name="stext_Type", type=stext_OperationDefinition, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_OperationDefinition", type=stext_Type, multiplicity=Multiplicity(0, 9999))
    }
)
...
domain_model = DomainModel(
    name="stext",
    types={stext_StatechartRoot, DefRoot, stext_StatechartSpecification, stext_StateRoot, stext_StateSpecification, stext_TransitionRoot, stext_TransitionSpecification, stext_StatechartScope, stext_Scope, stext_TransitionReaction, Scope, stext_InterfaceScope, StatechartScope, NamedElement, stext_InternalScope, stext_EventDefinition, Event, stext_EventDerivation, stext_Expression, stext_Root, stext_DefRoot, stext_Type, stext_LocalReaction, Reaction, stext_ReactionProperties, stext_ReactionProperty, stext_EntryPointSpec, ReactionProperty, stext_Entrypoint, stext_ExitPointSpec, stext_Exitpoint, stext_EventSpec, stext_RegularEventSpec, EventSpec, stext_TimeEventSpec, stext_BuiltinEventSpec, stext_EntryEvent, BuiltinEventSpec, stext_ExitEvent, stext_OnCycleEvent, stext_AlwaysEvent, stext_DefaultEvent, Statement, stext_Literal, stext_BoolLiteral, Literal, stext_VariableDefinition, Variable, Property_, stext_OperationDefinition, Declaration, Operation, stext_SimpleScope, stext_ReactionTrigger, Trigger, stext_ReactionEffect, Effect, stext_EventRaisingExpression, Expression, stext_IntLiteral, stext_RealLiteral, stext_HexLiteral, stext_StringLiteral, stext_LogicalOrExpression, stext_LogicalAndExpression, stext_LogicalNotExpression, stext_BitwiseXorExpression, stext_BitwiseOrExpression, stext_BitwiseAndExpression, stext_LogicalRelationExpression, stext_AssignmentExpression, stext_ConditionalExpression, stext_NumericalAddSubtractExpression, stext_NumericalMultiplyDivideExpression, stext_NumericalUnaryExpression, stext_PrimitiveValueExpression, stext_FeatureCall, stext_Feature, stext_ShiftExpression, stext_State, stext_TypedElementReferenceExpression, stext_NamedElement, stext_EventValueReferenceExpression, stext_ActiveStateReferenceExpression, TimeEventType, Direction, ShiftOperator, AdditiveOperator, MultiplicativeOperator, UnaryOperator, RelationalOperator, TimeUnit, AssignmentOperator},
    associations={def_1, def_2, def_3, definitionScopes4, scope6, reaction8, derivation10, condition11, value13, roots0, paramTypes18, properties19, properties20, properties23, entrypoint25, exitpoint26, event27, initialValue16, triggers29, guardExpression30, actions33, event35, falseCase50, leftOperand53, rightOperand55, leftOperand58, rightOperand60, operand63, leftOperand65, rightOperand67, leftOperand70, rightOperand72, leftOperand75, rightOperand77, value37, varRef40, expression42, condition45, trueCase47, rightOperand87, leftOperand90, rightOperand92, leftOperand95, rightOperand97, operand100, value102, owner103, feature105, leftOperand80, rightOperand82, leftOperand85, value113, args107, reference110, value111},
    generalizations={gen_stext_StatechartRoot_DefRoot, gen_stext_StateRoot_DefRoot, gen_stext_TransitionRoot_DefRoot, gen_stext_StatechartScope_Scope, gen_stext_InterfaceScope_StatechartScope, gen_stext_InterfaceScope_NamedElement, gen_stext_InternalScope_StatechartScope, gen_stext_EventDefinition_Event, gen_stext_EventDefinition_Event, gen_stext_LocalReaction_Declaration, gen_stext_LocalReaction_Reaction, gen_stext_TransitionReaction_Reaction, gen_stext_EntryPointSpec_ReactionProperty, gen_stext_ExitPointSpec_ReactionProperty, gen_stext_RegularEventSpec_EventSpec, gen_stext_TimeEventSpec_EventSpec, gen_stext_BuiltinEventSpec_EventSpec, gen_stext_EntryEvent_BuiltinEventSpec, gen_stext_ExitEvent_BuiltinEventSpec, gen_stext_OnCycleEvent_BuiltinEventSpec, gen_stext_AlwaysEvent_BuiltinEventSpec, gen_stext_DefaultEvent_BuiltinEventSpec, gen_stext_Expression_Statement, gen_stext_BoolLiteral_Literal, gen_stext_VariableDefinition_Variable, gen_stext_VariableDefinition_Property, gen_stext_OperationDefinition_Declaration, gen_stext_OperationDefinition_Operation, gen_stext_SimpleScope_Scope, gen_stext_Entrypoint_Declaration, gen_stext_Exitpoint_Declaration, gen_stext_ReactionTrigger_Trigger, gen_stext_ReactionEffect_Effect, gen_stext_EventRaisingExpression_Expression, gen_stext_IntLiteral_Literal, gen_stext_RealLiteral_Literal, gen_stext_HexLiteral_Literal, gen_stext_StringLiteral_Literal, gen_stext_LogicalOrExpression_Expression, gen_stext_LogicalAndExpression_Expression, gen_stext_LogicalNotExpression_Expression, gen_stext_BitwiseXorExpression_Expression, gen_stext_BitwiseOrExpression_Expression, gen_stext_BitwiseAndExpression_Expression, gen_stext_LogicalRelationExpression_Expression, gen_stext_AssignmentExpression_Expression, gen_stext_ConditionalExpression_Expression, gen_stext_NumericalAddSubtractExpression_Expression, gen_stext_NumericalMultiplyDivideExpression_Expression, gen_stext_NumericalUnaryExpression_Expression, gen_stext_PrimitiveValueExpression_Expression, gen_stext_FeatureCall_Expression, gen_stext_ShiftExpression_Expression, gen_stext_TypedElementReferenceExpression_Expression, gen_stext_EventValueReferenceExpression_Expression, gen_stext_ActiveStateReferenceExpression_Expression},
    metadata=None
)
