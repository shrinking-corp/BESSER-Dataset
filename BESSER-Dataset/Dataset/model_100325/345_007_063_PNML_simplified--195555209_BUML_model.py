...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={PNML_LocatedElement, PNMLDocument, NetContent, Name, PNML_NetContent, PNML_IdedElement, LocatedElement, PNML_URI, PNML_PNMLDocument, URI, NetElement, PNML_NetElement, IdedElement, PNML_Arc, NetContentElement, PNML_Place, PNML_Transition, PNML_LabeledElement, Label, PNML_Label, LabeledElement, PNML_Name, PNML_NetContentElement},
    associations={document4, contents5, name6, net8, name10, xmlns0, nets1, type2, source19, target20, labels12, labeledElement13, net14, netContent16},
    generalizations={gen_PNML_NetContent_LocatedElement, gen_PNML_IdedElement_LocatedElement, gen_PNML_URI_LocatedElement, gen_PNML_PNMLDocument_LocatedElement, gen_PNML_NetElement_IdedElement, gen_PNML_Arc_NetContent, gen_PNML_Arc_IdedElement, gen_PNML_Place_NetContentElement, gen_PNML_Transition_NetContentElement, gen_PNML_LabeledElement_LocatedElement, gen_PNML_Label_LocatedElement, gen_PNML_Name_LabeledElement, gen_PNML_NetContentElement_NetContent, gen_PNML_NetContentElement_IdedElement},
    metadata=None
)
