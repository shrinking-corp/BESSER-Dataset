...
class cSharpArchId_Modifier(ASTNode):
    ...
    def __init__(self, visibility: str, inheritance: str, static: bool, cSharpArchId_Modifier: "cSharpArchId_AbstractTypeDeclaration" = None, modifier: "cSharpArchId_BodyDeclaration" = None, cSharpArchId_Modifier41: set["cSharpArchId_Annotation"] = None):
...
class cSharpArchId_CompileUnit(NamedElement):
    ...
    def __init__(self, originalFilePath: str, cSharpArchId_CompileUnit13: set["cSharpArchId_NamedElement"] = None, cSharpArchId_CompileUnit15: set["cSharpArchId_Comment"] = None, cSharpArchId_CompileUnit17: "cSharpArchId_AbstractTypeDeclaration" = None, cSharpArchId_CompileUnit19: set["cSharpArchId_UsingDeclaration"] = None, cSharpArchId_CompileUnit21: "cSharpArchId_Namespace" = None, cSharpArchId_CompileUnit: "cSharpArchId_Model" = None, cSharpArchId_CompileUnit24: "cSharpArchId_ASTNode" = None, cSharpArchId_CompileUnit27: "cSharpArchId_Archive" = None):
