...
# Classes
cSharpArchId_Model = Class(name="cSharpArchId_Model")
cSharpArchId_Archive = Class(name="cSharpArchId_Archive")
cSharpArchId_CompileUnit = Class(name="cSharpArchId_CompileUnit")
cSharpArchId_EnumerationLiteral = Class(name="cSharpArchId_EnumerationLiteral")
NamedElement = Class(name="NamedElement")
cSharpArchId_NamedElement = Class(name="cSharpArchId_NamedElement", is_abstract=True)
ASTNode = Class(name="ASTNode")
cSharpArchId_Type = Class(name="cSharpArchId_Type", is_abstract=True)
cSharpArchId_Namespace = Class(name="cSharpArchId_Namespace")
cSharpArchId_MethodParameter = Class(name="cSharpArchId_MethodParameter")
cSharpArchId_Enumeration = Class(name="cSharpArchId_Enumeration")
Type = Class(name="Type")
cSharpArchId_ClassDeclaration = Class(name="cSharpArchId_ClassDeclaration")
TypeDeclaration = Class(name="TypeDeclaration")
cSharpArchId_InterfaceDeclaration = Class(name="cSharpArchId_InterfaceDeclaration")
cSharpArchId_PrimitiveType = Class(name="cSharpArchId_PrimitiveType")
cSharpArchId_LineComment = Class(name="cSharpArchId_LineComment")
Comment = Class(name="Comment")
cSharpArchId_BlockComment = Class(name="cSharpArchId_BlockComment")
cSharpArchId_BodyDeclaration = Class(name="cSharpArchId_BodyDeclaration", is_abstract=True)
cSharpArchId_Modifier = Class(name="cSharpArchId_Modifier")
cSharpArchId_TypeDeclaration = Class(name="cSharpArchId_TypeDeclaration", is_abstract=True)
AbstractTypeDeclaration = Class(name="AbstractTypeDeclaration")
cSharpArchId_Comment = Class(name="cSharpArchId_Comment", is_abstract=True)
cSharpArchId_AbstractTypeDeclaration = Class(name="cSharpArchId_AbstractTypeDeclaration", is_abstract=True)
cSharpArchId_UsingDeclaration = Class(name="cSharpArchId_UsingDeclaration")
cSharpArchId_ElementRef = Class(name="cSharpArchId_ElementRef")
cSharpArchId_ASTNode = Class(name="cSharpArchId_ASTNode", is_abstract=True)
cSharpArchId_AbstractMethodDeclaration = Class(name="cSharpArchId_AbstractMethodDeclaration", is_abstract=True)
BodyDeclaration = Class(name="BodyDeclaration")
cSharpArchId_Block = Class(name="cSharpArchId_Block")
cSharpArchId_VariableDeclaration = Class(name="cSharpArchId_VariableDeclaration", is_abstract=True)
cSharpArchId_TypeParameter = Class(name="cSharpArchId_TypeParameter")
Statement = Class(name="Statement")
cSharpArchId_Statement = Class(name="cSharpArchId_Statement", is_abstract=True)
cSharpArchId_TypeAcces = Class(name="cSharpArchId_TypeAcces")
Expresion = Class(name="Expresion")
cSharpArchId_Expresion = Class(name="cSharpArchId_Expresion", is_abstract=True)
cSharpArchId_Annotation = Class(name="cSharpArchId_Annotation")
cSharpArchId_Assignment = Class(name="cSharpArchId_Assignment")
cSharpArchId_ClassInstanceCreation = Class(name="cSharpArchId_ClassInstanceCreation")
cSharpArchId_ConstructorInvocation = Class(name="cSharpArchId_ConstructorInvocation")
cSharpArchId_ReturnType = Class(name="cSharpArchId_ReturnType")
cSharpArchId_SingleVariableDeclaration = Class(name="cSharpArchId_SingleVariableDeclaration")
VariableDeclaration = Class(name="VariableDeclaration")
cSharpArchId_MethodDeclaration = Class(name="cSharpArchId_MethodDeclaration")
AbstractMethodDeclaration = Class(name="AbstractMethodDeclaration")
cSharpArchId_ConstructorDeclaration = Class(name="cSharpArchId_ConstructorDeclaration")
cSharpArchId_AbstractMethodInvocation = Class(name="cSharpArchId_AbstractMethodInvocation", is_abstract=True)
cSharpArchId_MethodInvocation = Class(name="cSharpArchId_MethodInvocation")
...
cSharpArchId_Modifier.attributes={cSharpArchId_Modifier_static, cSharpArchId_Modifier_modifier, cSharpArchId_Modifier_visibility, cSharpArchId_Modifier_inheritance}
...
domain_model = DomainModel(
    name="cSharpArchId",
    types={cSharpArchId_Model, cSharpArchId_Archive, cSharpArchId_CompileUnit, cSharpArchId_EnumerationLiteral, NamedElement, cSharpArchId_NamedElement, ASTNode, cSharpArchId_Type, cSharpArchId_Namespace, cSharpArchId_MethodParameter, cSharpArchId_Enumeration, Type, cSharpArchId_ClassDeclaration, TypeDeclaration, cSharpArchId_InterfaceDeclaration, cSharpArchId_PrimitiveType, cSharpArchId_LineComment, Comment, cSharpArchId_BlockComment, cSharpArchId_BodyDeclaration, cSharpArchId_Modifier, cSharpArchId_TypeDeclaration, AbstractTypeDeclaration, cSharpArchId_Comment, cSharpArchId_AbstractTypeDeclaration, cSharpArchId_UsingDeclaration, cSharpArchId_ElementRef, cSharpArchId_ASTNode, cSharpArchId_AbstractMethodDeclaration, BodyDeclaration, cSharpArchId_Block, cSharpArchId_VariableDeclaration, cSharpArchId_TypeParameter, Statement, cSharpArchId_Statement, cSharpArchId_TypeAcces, Expresion, cSharpArchId_Expresion, cSharpArchId_Annotation, cSharpArchId_Assignment, cSharpArchId_ClassInstanceCreation, cSharpArchId_ConstructorInvocation, cSharpArchId_ReturnType, cSharpArchId_SingleVariableDeclaration, VariableDeclaration, cSharpArchId_MethodDeclaration, AbstractMethodDeclaration, cSharpArchId_ConstructorDeclaration, cSharpArchId_AbstractMethodInvocation, cSharpArchId_MethodInvocation, AbstractMethodInvocation, VisibilityKind, ModifierKind, SimpleType, InheritanceKind},
    associations={archives0, compileUnits1, classes5, enumerations7, type10, enumLiterals3, superClass4, originalCompilationUnit23, compileUnits25, commentsBeforeBody28, commentsAfterBody31, bodyDeclarations34, modifier36, elements12, commentList14, typeDeclaration16, usings18, namespace20, typeacces42, body44, parameters45, typeParameters46, thrownExceptions48, returnType51, modifier38, bodyDeclaration39, annotations40, expression63, type65, expresion67, methodDeclaration54, type55, localVariableDeclaration57, typeArguments59, arguments61},
    generalizations={gen_cSharpArchId_EnumerationLiteral_NamedElement, gen_cSharpArchId_NamedElement_ASTNode, gen_cSharpArchId_Type_NamedElement, gen_cSharpArchId_Namespace_NamedElement, gen_cSharpArchId_MethodParameter_NamedElement, gen_cSharpArchId_Enumeration_Type, gen_cSharpArchId_ClassDeclaration_TypeDeclaration, gen_cSharpArchId_InterfaceDeclaration_TypeDeclaration, gen_cSharpArchId_PrimitiveType_Type, gen_cSharpArchId_Archive_NamedElement, gen_cSharpArchId_UsingDeclaration_NamedElement, gen_cSharpArchId_Comment_ASTNode, gen_cSharpArchId_LineComment_Comment, gen_cSharpArchId_BlockComment_Comment, gen_cSharpArchId_AbstractTypeDeclaration_Type, gen_cSharpArchId_TypeDeclaration_AbstractTypeDeclaration, gen_cSharpArchId_CompileUnit_NamedElement, gen_cSharpArchId_ElementRef_Type, gen_cSharpArchId_Annotation_Expresion, gen_cSharpArchId_AbstractMethodDeclaration_BodyDeclaration, gen_cSharpArchId_Block_Statement, gen_cSharpArchId_Statement_ASTNode, gen_cSharpArchId_VariableDeclaration_BodyDeclaration, gen_cSharpArchId_TypeAcces_Expresion, gen_cSharpArchId_Expresion_ASTNode, gen_cSharpArchId_BodyDeclaration_NamedElement, gen_cSharpArchId_Modifier_ASTNode, gen_cSharpArchId_Assignment_Expresion, gen_cSharpArchId_ClassInstanceCreation_AbstractMethodInvocation, gen_cSharpArchId_ConstructorInvocation_AbstractMethodInvocation, gen_cSharpArchId_ReturnType_Type, gen_cSharpArchId_SingleVariableDeclaration_VariableDeclaration, gen_cSharpArchId_TypeParameter_Type, gen_cSharpArchId_MethodDeclaration_AbstractMethodDeclaration, gen_cSharpArchId_ConstructorDeclaration_AbstractMethodDeclaration, gen_cSharpArchId_AbstractMethodInvocation_ASTNode, gen_cSharpArchId_MethodInvocation_AbstractMethodInvocation},
    metadata=None
)
