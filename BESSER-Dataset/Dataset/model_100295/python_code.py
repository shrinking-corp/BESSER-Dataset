...
class petrinet_Transition:
    ...
    def __init__(self, name: str, petrinet_Transition2: "petrinet_Arc" = None, petrinet_Transition13: "petrinet_PetriNet" = None, petrinet_Transition: "petrinet_Place" = None):
        self.name = name
...
class petrinet_Place:
    ...
    def __init__(self, token: int, name: str, petrinet_Place5: "petrinet_Arc" = None, petrinet_Place7: "petrinet_PetriNet" = None, petrinet_Place: set["petrinet_Transition"] = None):
        self.token = token
        self.name = name
