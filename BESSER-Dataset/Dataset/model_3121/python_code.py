...
class ClassDiagram_Class(Classifier):
    ...
    def __init__(self, isAbstract: str, ClassDiagram_Class: set["Class"] = None, owner4: set["Attribute"] = None, ownedElements: "Package" = None, Classifier: "ClassDiagram_Attribute" = None):
    ...
    def ownedElements(self, value):
        ...
        old_value = getattr(self, f"_ClassDiagram_Class__ownedElements", None)
