...
# Classes
cs_CSRoot = Class(name="cs_CSRoot")
CSElement = Class(name="CSElement")
cs_CSElement = Class(name="cs_CSElement")
ENamedElement = Class(name="ENamedElement")
cs_CSStroke = Class(name="cs_CSStroke")
cs_CSColor = Class(name="cs_CSColor")
cs_CSNode = Class(name="cs_CSNode")
cs_CSConnection = Class(name="cs_CSConnection")
cs_CSConnectionEnd = Class(name="cs_CSConnectionEnd")
cs_CSText = Class(name="cs_CSText")
CSNode = Class(name="CSNode")
cs_CSShape = Class(name="cs_CSShape")
cs_CSTransform = Class(name="cs_CSTransform")
cs_EObject = Class(name="cs_EObject")
cs_EStructuralFeature = Class(name="cs_EStructuralFeature")
cs_CSLayout = Class(name="cs_CSLayout")
cs_CSTemplateDescription = Class(name="cs_CSTemplateDescription")
cs_EClass = Class(name="cs_EClass")
cs_CSPoint = Class(name="cs_CSPoint")
...
cs_CSElement.attributes={cs_CSElement_draggable, cs_CSElement_resizable, cs_CSElement_minZoom, cs_CSElement_selectable, cs_CSElement_templateRoot, cs_CSElement_maxZoom}
...
cs_CSStroke.attributes={cs_CSStroke_width, cs_CSStroke_dash_phase, cs_CSStroke_join, cs_CSStroke_cap, cs_CSStroke_miterlimit, cs_CSStroke_dash}
...
cs_CSNode.attributes={cs_CSNode_widthRatioToParent, cs_CSNode_x, cs_CSNode_width, cs_CSNode_verticalAlign, cs_CSNode_minWidth, cs_CSNode_heightRatioToParent, cs_CSNode_minHeight, cs_CSNode_maxHeight, cs_CSNode_horizontalAlign, cs_CSNode_maxWidth, cs_CSNode_height, cs_CSNode_y}
...
cs_CSTransform.attributes={cs_CSTransform_m01, cs_CSTransform_m12, cs_CSTransform_m22, cs_CSTransform_m21, cs_CSTransform_m10, cs_CSTransform_m00, cs_CSTransform_m02, cs_CSTransform_m11, cs_CSTransform_m20}
...
domain_model = DomainModel(
    name="cs",
    types={cs_CSRoot, CSElement, cs_CSElement, ENamedElement, cs_CSStroke, cs_CSColor, cs_CSNode, cs_CSConnection, cs_CSConnectionEnd, cs_CSText, CSNode, cs_CSShape, cs_CSTransform, cs_EObject, cs_EStructuralFeature, cs_CSLayout, cs_CSTemplateDescription, cs_EClass, cs_CSPoint, CSOrientation, CSFitType},
    associations={stroke0, children2, parent4, foreground6, connections21, connectionEnds22, background8, shape11, transform13, object15, displayedStructuralFeatures17, layout19, containerClass26, theClass27, containerStructuralFeature30, template33, node36, connStructuralFeature39, nodeStructuralFeature42, points24},
    generalizations={gen_cs_CSRoot_CSElement, gen_cs_CSElement_ENamedElement, gen_cs_CSNode_CSElement, gen_cs_CSConnection_CSElement, gen_cs_CSText_CSNode, gen_cs_CSTemplateDescription_CSNode, gen_cs_CSShape_ENamedElement},
    metadata=None
)
