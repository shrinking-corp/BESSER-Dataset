...
def test_hyp_thingml_dictionary_is_not_abstract():
    assert not inspect.isabstract(thingml_Dictionary)


def test_hyp_thingml_dictionary_constructor_exists():
    assert callable(thingml_Dictionary.__init__)


def test_hyp_thingml_dictionary_constructor_args():
...
def test_hyp_thingmlelement_is_not_abstract():
    assert not inspect.isabstract(ThingMLElement)


def test_hyp_thingmlelement_constructor_exists():
    assert callable(ThingMLElement.__init__)


def test_hyp_thingmlelement_constructor_args():
...
def test_hyp_thingml_statemachine_is_not_abstract():
    assert not inspect.isabstract(thingml_StateMachine)


def test_hyp_thingml_statemachine_constructor_exists():
    assert callable(thingml_StateMachine.__init__)


def test_hyp_thingml_statemachine_constructor_args():
...
def test_hyp_thingml_typedelement_is_not_abstract():
    assert not inspect.isabstract(thingml_TypedElement)


def test_hyp_thingml_typedelement_constructor_exists():
    assert callable(thingml_TypedElement.__init__)


def test_hyp_thingml_typedelement_constructor_args():
    sig = inspect.signature(thingml_TypedElement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_thingml_thingmlelement_is_not_abstract():
    assert not inspect.isabstract(thingml_ThingMLElement)


def test_hyp_thingml_thingmlelement_constructor_exists():
    assert callable(thingml_ThingMLElement.__init__)


def test_hyp_thingml_thingmlelement_constructor_args():
...
def test_hyp_thingml_functioncall_is_not_abstract():
    assert not inspect.isabstract(thingml_FunctionCall)


def test_hyp_thingml_functioncall_constructor_exists():
    assert callable(thingml_FunctionCall.__init__)


def test_hyp_thingml_functioncall_constructor_args():
...
def test_hyp_propertyreference_is_not_abstract():
    assert not inspect.isabstract(PropertyReference)


def test_hyp_propertyreference_constructor_exists():
    assert callable(PropertyReference.__init__)


def test_hyp_propertyreference_constructor_args():
    sig = inspect.signature(PropertyReference.__init__)
    params = list(sig.parameters.keys())



def test_hyp_thingml_dictionaryreference_is_not_abstract():
    assert not inspect.isabstract(thingml_DictionaryReference)


def test_hyp_thingml_dictionaryreference_constructor_exists():
    assert callable(thingml_DictionaryReference.__init__)


def test_hyp_thingml_dictionaryreference_constructor_args():
...
def test_hyp_thingml_configinclude_is_not_abstract():
    assert not inspect.isabstract(thingml_ConfigInclude)


def test_hyp_thingml_configinclude_constructor_exists():
    assert callable(thingml_ConfigInclude.__init__)


def test_hyp_thingml_configinclude_constructor_args():
...
def test_hyp_thingml_binaryexpression_is_not_abstract():
    assert not inspect.isabstract(thingml_BinaryExpression)


def test_hyp_thingml_binaryexpression_constructor_exists():
    assert callable(thingml_BinaryExpression.__init__)


def test_hyp_thingml_binaryexpression_constructor_args():
...
def test_hyp_thingml_unaryexpression_is_not_abstract():
    assert not inspect.isabstract(thingml_UnaryExpression)


def test_hyp_thingml_unaryexpression_constructor_exists():
    assert callable(thingml_UnaryExpression.__init__)


def test_hyp_thingml_unaryexpression_constructor_args():
...
def test_hyp_thingml_controlstructure_is_not_abstract():
    assert not inspect.isabstract(thingml_ControlStructure)


def test_hyp_thingml_controlstructure_constructor_exists():
    assert callable(thingml_ControlStructure.__init__)


def test_hyp_thingml_controlstructure_constructor_args():
...
def test_hyp_thingml_thingmlelement_name_setter(instance):
...
def test_hyp_thingml_region_history_setter(instance):
...
def test_hyp_thingml_configuration_fragment_setter(instance):
    original = instance.fragment
    instance.fragment = original
    assert instance.fragment == original
