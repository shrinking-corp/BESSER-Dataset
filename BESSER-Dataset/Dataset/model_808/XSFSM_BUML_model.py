...
domain_model = DomainModel(
    name="fsm",
    types={fsm_StateMachine, NamedElement, fsm_NamedElement, fsm_State, fsm_Transition},
    associations={incomingTransitions9, source11, target13, ownedStates0, initialState1, ownedTransitions2, currentState4, owningFSM7, outgoingTransitions8},
