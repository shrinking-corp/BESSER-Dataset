...
@given(instance=simplejava_Type_strategy)
def test_hyp_simplejava_type_isArray_setter(instance):
...
def test_simplejava_Type_isArray_value_roundtrip():
    instance = simplejava_Type(isArray=True, isVoid=True, typeName="sample_text")
...
def test_assoc_returnType15_link_reassign_clear():
    a = simplejava_Type(isArray=True, isVoid=True, typeName="sample_text")
    b1 = simplejava_Method(name="sample_text", static=True)
    b2 = simplejava_Method(name="sample_text_2", static=False)
...
simplejava_Type_strategy = st.builds(simplejava_Type, isArray=st.booleans(), isVoid=st.booleans(), typeName=safe_text)
@given(instance=simplejava_Type_strategy)
@settings(max_examples=25)
