...
public class model_IServiceID  {
    ...
    private model_IServiceTypeID model_iservicetypeid;
    ...
    public model_IServiceTypeID getModel_iservicetypeid() {
        return model_iservicetypeid;
    }

    public void setModel_iservicetypeid(model_IServiceTypeID model_iservicetypeid) {
        this.model_iservicetypeid = model_iservicetypeid;
    }
