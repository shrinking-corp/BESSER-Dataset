...
class model_IServiceInfo:
    ...
    def __init__(self, ecfServiceInfo: str, ecfName: str, ecfLocation: str, ecfPriority: int, ecfWeight: int, model_IServiceInfo4: "model_IHost" = None, model_IServiceInfo: "model_IServiceID" = None):
