...
# Classes
imp_Stmt = Class(name="imp_Stmt", is_abstract=True)
imp_If = Class(name="imp_If")
imp_While = Class(name="imp_While")
imp_IntConst = Class(name="imp_IntConst")
Expr = Class(name="Expr")
imp_Unary = Class(name="imp_Unary")
imp_Binary = Class(name="imp_Binary")
imp_Declaration = Class(name="imp_Declaration")
Stmt = Class(name="Stmt")
Symbol = Class(name="Symbol")
imp_Expr = Class(name="imp_Expr", is_abstract=True)
imp_Block = Class(name="imp_Block")
imp_Store = Class(name="imp_Store")
imp_StringToValueMap = Class(name="imp_StringToValueMap")
imp_Value = Class(name="imp_Value", is_abstract=True)
imp_IntValue = Class(name="imp_IntValue")
Value = Class(name="Value")
imp_BoolValue = Class(name="imp_BoolValue")
imp_ArrayValue = Class(name="imp_ArrayValue")
imp_ArrayDecl = Class(name="imp_ArrayDecl")
imp_BoolConst = Class(name="imp_BoolConst")
imp_Program = Class(name="imp_Program")
imp_MethodDecl = Class(name="imp_MethodDecl")
imp_Class = Class(name="imp_Class")
imp_StringConst = Class(name="imp_StringConst")
imp_StringValue = Class(name="imp_StringValue")
imp_NamedElement = Class(name="imp_NamedElement", is_abstract=True)
NamedElement = Class(name="NamedElement")
imp_AttributeDecl = Class(name="imp_AttributeDecl")
imp_This = Class(name="imp_This")
imp_NewClass = Class(name="imp_NewClass")
imp_Assignment = Class(name="imp_Assignment")
Member = Class(name="Member")
imp_ParamDecl = Class(name="imp_ParamDecl")
imp_Return = Class(name="imp_Return")
imp_Print = Class(name="imp_Print")
imp_Project = Class(name="imp_Project")
imp_Member = Class(name="imp_Member", is_abstract=True)
imp_Symbol = Class(name="imp_Symbol", is_abstract=True)
imp_VarRef = Class(name="imp_VarRef")
...
class_49: BinaryAssociation = BinaryAssociation(
    name="class_49",
    ends={
...
domain_model = DomainModel(
    name="imp",
    types={imp_Stmt, imp_If, imp_While, imp_IntConst, Expr, imp_Unary, imp_Binary, imp_Declaration, Stmt, Symbol, imp_Expr, imp_Block, imp_Store, imp_StringToValueMap, imp_Value, imp_IntValue, Value, imp_BoolValue, imp_ArrayValue, imp_ArrayDecl, imp_BoolConst, imp_Program, imp_MethodDecl, imp_Class, imp_StringConst, imp_StringValue, imp_NamedElement, NamedElement, imp_AttributeDecl, imp_This, imp_NewClass, imp_Assignment, Member, imp_ParamDecl, imp_Return, imp_Print, imp_Project, imp_Member, imp_Symbol, imp_VarRef, UnaryOp, BinaryOp},
    associations={stmts4, cond5, lhs7, rhs10, cond13, body15, expr18, lhs20, exp0, index1, values25, value26, values28, values30, methods32, classes33, rhs22, attributes44, methods46, class_49, lhs51, rhs53, stmt35, params38, expr40, expr42, ref63, lhs56, rhs58, params60},
    generalizations={gen_imp_If_Stmt, gen_imp_While_Stmt, gen_imp_IntConst_Expr, gen_imp_Unary_Expr, gen_imp_Binary_Expr, gen_imp_Declaration_Stmt, gen_imp_Declaration_Symbol, gen_imp_Expr_Stmt, gen_imp_Block_Stmt, gen_imp_IntValue_Value, gen_imp_BoolValue_Value, gen_imp_ArrayValue_Value, gen_imp_ArrayDecl_Expr, gen_imp_BoolConst_Expr, gen_imp_StringConst_Expr, gen_imp_StringValue_Value, gen_imp_ParamDecl_Symbol, gen_imp_Class_NamedElement, gen_imp_AttributeDecl_Member, gen_imp_This_Expr, gen_imp_NewClass_Expr, gen_imp_Assignment_Stmt, gen_imp_MethodDecl_Member, gen_imp_Return_Stmt, gen_imp_Print_Stmt, gen_imp_Project_Expr, gen_imp_Symbol_NamedElement, gen_imp_VarRef_Expr},
    metadata=None
)
