...
class imp_MethodDecl(Member):
    ...
    def __init__(self, name: str, imp_MethodDecl: "imp_Program" = None, imp_MethodDecl48: "imp_Class" = None, imp_MethodDecl36: "imp_Stmt" = None, imp_MethodDecl39: set["imp_ParamDecl"] = None):
        self.name = name
