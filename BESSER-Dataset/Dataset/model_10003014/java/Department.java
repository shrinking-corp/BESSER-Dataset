...
public class Department  {
    ...
    public Department(
        None students__,        None teachers__,        None hod,        None course    ) {
    ...
    public Department(
        None students__,        None teachers__,        None hod,        None course        ArrayList<Student> students,        ArrayList<Employee_Interface> employee_interfaces    ) {
        this.students__ = students__;
        this.teachers__ = teachers__;
        this.hod = hod;
        this.course = course;
