...
# Classes
micro_Model = Class(name="micro_Model")
micro_MicroserviceArchitecture = Class(name="micro_MicroserviceArchitecture")
NamedElement = Class(name="NamedElement")
micro_Service = Class(name="micro_Service", is_abstract=True)
micro_Operation = Class(name="micro_Operation")
micro_API = Class(name="micro_API")
micro_ViewService = Class(name="micro_ViewService")
micro_Attribute = Class(name="micro_Attribute", is_abstract=True)
micro_ModelEvent = Class(name="micro_ModelEvent")
micro_AggregateService = Class(name="micro_AggregateService")
Service = Class(name="Service")
micro_Command = Class(name="micro_Command")
micro_Info = Class(name="micro_Info")
micro_Event = Class(name="micro_Event")
micro_Saga = Class(name="micro_Saga")
micro_NamedElement = Class(name="micro_NamedElement")
micro_Data = Class(name="micro_Data")
micro_ReferenceAttribute = Class(name="micro_ReferenceAttribute")
micro_Step = Class(name="micro_Step")
Attribute = Class(name="Attribute")
micro_PrimitiveTypeAttribute = Class(name="micro_PrimitiveTypeAttribute")
...
micro_Service.attributes={micro_Service_shortname, micro_Service_port, micro_Service_description, micro_Service_fullname}
...
micro_Attribute.attributes={micro_Attribute_isId, micro_Attribute_name, micro_Attribute_isGenerated, micro_Attribute_isMany}
...
domain_model = DomainModel(
    name="micro",
    types={micro_Model, micro_MicroserviceArchitecture, NamedElement, micro_Service, micro_Operation, micro_API, micro_ViewService, micro_Attribute, micro_ModelEvent, micro_AggregateService, Service, micro_Command, micro_Info, micro_Event, micro_Saga, micro_NamedElement, micro_Data, micro_ReferenceAttribute, micro_Step, Attribute, micro_PrimitiveTypeAttribute, CRUDOperation, CommandType, AttributePrimitiveValue},
    associations={models1, services0, modelEvents7, operation8, api10, handleModelEvents11, models14, replicateServices17, attributes3, model4, aggregateService6, events27, commands28, infos30, replyInfo32, api33, publish19, Saga20, model22, aggregateService25, commands41, Steps43, Data46, model48, api34, dto36, api39, type49, ModelToView51},
    generalizations={gen_micro_Service_NamedElement, gen_micro_Model_NamedElement, gen_micro_MicroserviceArchitecture_NamedElement, gen_micro_ViewService_Service, gen_micro_ModelEvent_NamedElement, gen_micro_AggregateService_Service, gen_micro_API_NamedElement, gen_micro_Command_NamedElement, gen_micro_Operation_NamedElement, gen_micro_Saga_NamedElement, gen_micro_Data_NamedElement, gen_micro_Event_NamedElement, gen_micro_Info_NamedElement, gen_micro_Step_NamedElement, gen_micro_ReferenceAttribute_Attribute, gen_micro_PrimitiveTypeAttribute_Attribute},
    metadata=None
)
