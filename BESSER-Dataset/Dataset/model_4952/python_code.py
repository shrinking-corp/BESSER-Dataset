...
class micro_AggregateService(Service):
    ...
    def __init__(self, aggregateService: set["micro_ModelEvent"] = None, micro_AggregateService12: set["micro_ModelEvent"] = None, micro_AggregateService15: set["micro_Model"] = None, micro_AggregateService18: "micro_ViewService" = None, AggregateService: "micro_ModelEvent" = None, AggregateService26: "micro_Operation" = None, aggregateService9: set["micro_Operation"] = None, micro_AggregateService: "micro_API" = None):
...
class micro_Operation(NamedElement):
    ...
    def __init__(self, operationType: str, isMethodController: bool, micro_Operation: "micro_Event" = None, micro_Operation21: "micro_Saga" = None, micro_Operation23: "micro_Model" = None, operation: "micro_AggregateService" = None, Operation: "micro_AggregateService" = None):
