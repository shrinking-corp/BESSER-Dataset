...
def test_library_referencerelationship_is_not_abstract():
    assert not inspect.isabstract(library_ReferenceRelationship)


def test_library_referencerelationship_constructor_exists():
    assert callable(library_ReferenceRelationship.__init__)


def test_library_referencerelationship_constructor_args():
    sig = inspect.signature(library_ReferenceRelationship.__init__)
    params = list(sig.parameters.keys())
    assert "name" in params, "Missing parameter 'name'"

def test_library_referencerelationship_has_name():
    assert hasattr(library_ReferenceRelationship, "name")
    descriptor = None
    for klass in library_ReferenceRelationship.__mro__:
        if "name" in klass.__dict__:
            descriptor = klass.__dict__["name"]
            break
    assert isinstance(descriptor, property)
...
def test_library_referencenetwork_is_not_abstract():
    assert not inspect.isabstract(library_ReferenceNetwork)


def test_library_referencenetwork_constructor_exists():
    assert callable(library_ReferenceNetwork.__init__)


def test_library_referencenetwork_constructor_args():
    sig = inspect.signature(library_ReferenceNetwork.__init__)
    params = list(sig.parameters.keys())
    assert "description" in params, "Missing parameter 'description'"
    assert "name" in params, "Missing parameter 'name'"

def test_library_referencenetwork_has_description():
    assert hasattr(library_ReferenceNetwork, "description")
    descriptor = None
    for klass in library_ReferenceNetwork.__mro__:
        if "description" in klass.__dict__:
            descriptor = klass.__dict__["description"]
            break
    assert isinstance(descriptor, property)

def test_library_referencenetwork_has_name():
    assert hasattr(library_ReferenceNetwork, "name")
    descriptor = None
    for klass in library_ReferenceNetwork.__mro__:
        if "name" in klass.__dict__:
            descriptor = klass.__dict__["name"]
...
def test_library_configattribute_is_not_abstract():
    assert not inspect.isabstract(library_ConfigAttribute)


def test_library_configattribute_constructor_exists():
    assert callable(library_ConfigAttribute.__init__)


def test_library_configattribute_constructor_args():
    sig = inspect.signature(library_ConfigAttribute.__init__)
    params = list(sig.parameters.keys())
...
library_ReferenceRelationship_strategy = st.builds(
    library_ReferenceRelationship,
    name=
        safe_text
)
...
library_ReferenceNetwork_strategy = st.builds(
    library_ReferenceNetwork,
    description=
        safe_text,
    name=
...
library_ConfigAttribute_strategy = st.builds(
    library_ConfigAttribute,
)
...
@given(instance=library_ReferenceRelationship_strategy)
def test_library_referencerelationship_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=library_ReferenceNetwork_strategy)
def test_library_referencenetwork_description_setter(instance):
    original = instance.description
    instance.description = original
    assert instance.description == original
...
@given(instance=library_ReferenceNetwork_strategy)
def test_library_referencenetwork_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
