...
def test_hyp_library_referencerelationship_is_not_abstract():
    assert not inspect.isabstract(library_ReferenceRelationship)


def test_hyp_library_referencerelationship_constructor_exists():
    assert callable(library_ReferenceRelationship.__init__)


def test_hyp_library_referencerelationship_constructor_args():
...
def test_hyp_library_referencenetwork_is_not_abstract():
    assert not inspect.isabstract(library_ReferenceNetwork)


def test_hyp_library_referencenetwork_constructor_exists():
    assert callable(library_ReferenceNetwork.__init__)


def test_hyp_library_referencenetwork_constructor_args():
...
def test_hyp_library_configattribute_is_not_abstract():
    assert not inspect.isabstract(library_ConfigAttribute)


def test_hyp_library_configattribute_constructor_exists():
    assert callable(library_ConfigAttribute.__init__)


def test_hyp_library_configattribute_constructor_args():
...
def test_hyp_library_referencerelationship_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_library_referencenetwork_description_setter(instance):
    original = instance.description
    instance.description = original
    assert instance.description == original
...
@given(instance=library_ReferenceNetwork_strategy)
def test_hyp_library_referencenetwork_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
