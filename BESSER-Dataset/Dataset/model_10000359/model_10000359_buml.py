...
Applicant.attributes={Applicant_Date_of_Birth, Applicant_Address, Applicant_Password, Applicant_Last_Name, Applicant_Phone, Applicant_Email, Applicant_Applied_Position, Applicant_First_Name}
...
Admin.attributes={Admin_qualification, Admin_address, Admin_name}
...
Registration.attributes={Registration_Skills___Requirement, Registration_Email, Registration_Position_Type, Registration_Address, Registration_Name, Registration_Date, Registration_Applied_Position, Registration_Phone}
...
Position.attributes={Position_jobID, Position_positionName, Position_positionID, Position_divisionName}
...
Attendance.attributes={Attendance_Date___Time, Attendance_Position, Attendance_Details, Attendance_Name}
...
Requirement.attributes={Requirement_Diploma, Requirement_ID_Card, Requirement_Transcript, Requirement_Photo, Requirement_Curriculum_Vitae}
...
Task.attributes={Task_Task_Detail, Task_Task_Name, Task_Name, Task_Deadline}
...
New_Employee.attributes={New_Employee_Working_Since, New_Employee_Name, New_Employee_Division, New_Employee_Position, New_Employee_Date_of_Birth, New_Employee_Place_of_Birth}
...
Survey.attributes={Survey_Name, Survey_Score, Survey_Question}
...
Performance.attributes={Performance_Coordination, Performance_Name, Performance_Target, Performance_Punctuality}
...
Assessment.attributes={Assessment_Type_of_Assessment, Assessment_Total_Score, Assessment_Name}
...
Assessment__Self_Assessment.attributes={Assessment__Self_Assessment_Score, Assessment__Self_Assessment_Name, Assessment__Self_Assessment_Question}
...
domain_model = DomainModel(
    name="_2cba2d8c_82ab_4c14_bd54_a6013779e9bf",
    types={Applicant, Admin, Registration, Position, Login, Attendance, Requirement, Task, New_Employee, Survey, Performance, Assessment, Assessment__Self_Assessment},
    associations={Attendance_Assessment, Assessment__Self_Assessment_Assessment, Survey_Assessment, Performance_Assessment, Admin_Login, Applicant_Login, Applicant_Registration, Admin_Registration, Applicant_Position, Registration_New_Employee, Applicant_New_Employee, Task_New_Employee, New_Employee_Attendance, Requirement_Registration},
    generalizations={},
    metadata=None
)
