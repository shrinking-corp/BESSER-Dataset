...
class be_jebouquine_entities_Client:
    ...
    def __init__(self, motDePasseClient: str, etatLogin: str, idClient: int, nomClient: str, adresseClient: str, emailClient: str, telephoneClient: str, commande12: set["be_jebouquine_entities_Commande"] = None, commentaire22: set["be_jebouquine_entities_Commentaire"] = None):
