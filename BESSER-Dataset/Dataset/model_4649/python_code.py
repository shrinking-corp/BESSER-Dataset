...
class di_GradientShape(Shape):
    ...
    def __init__(self, gradientColor: int, verticalGradient: bool, usingGradient: bool):
...
class di_Ruler:
    ...
    def __init__(self, unit: str, di_Ruler16: "di_Diagram" = None, di_Ruler: "di_Diagram" = None, ruler: set["di_Guide"] = None, Ruler: "di_Guide" = None):
        self.unit = unit
...
class di_Grid:
    ...
    def __init__(self, spacing: int, style: str, color: int, di_Grid: "di_Diagram" = None):
...
class di_Diagram(Container):
    ...
    def __init__(self, snapToGrid: bool, snapToGeometry: bool, rulers: str, di_Diagram: set["di_Comment"] = None, di_Diagram11: set["di_CommentLink"] = None, di_Diagram15: "di_Ruler" = None, di_Diagram18: "di_Grid" = None, di_Diagram13: "di_Ruler" = None):
...
class di_Node(View):
    ...
    def __init__(self, allOutgoingLines: str, allIncomingLines: str, source: set["di_CommentLink"] = None, target: set["di_Connector"] = None, source3: set["di_Connector"] = None, Node21: "di_Connector" = None, Node: "di_Connector" = None, Node28: "di_CommentLink" = None):
