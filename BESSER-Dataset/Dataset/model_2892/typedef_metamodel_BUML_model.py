...
# Classes
typedef_DocumentRoot = Class(name="typedef_DocumentRoot")
typedef_Type = Class(name="typedef_Type", is_abstract=True)
typedef_TypeAnnotation = Class(name="typedef_TypeAnnotation")
typedef_Feature = Class(name="typedef_Feature")
typedef_TDDocumentation = Class(name="typedef_TDDocumentation")
typedef_CSIDatatype = Class(name="typedef_CSIDatatype")
Type = Class(name="Type")
typedef_Entity = Class(name="typedef_Entity")
typedef_TDAnnotationDetail = Class(name="typedef_TDAnnotationDetail")
typedef_PrimitiveType = Class(name="typedef_PrimitiveType")
typedef_TypedArray = Class(name="typedef_TypedArray")
typedef_Exception = Class(name="typedef_Exception")
typedef_EnumVal = Class(name="typedef_EnumVal")
typedef_EnumLiteral = Class(name="typedef_EnumLiteral")
typedef_TypeLanguageBinding = Class(name="typedef_TypeLanguageBinding")
...
typedef_TDAnnotationDetail.attributes={typedef_TDAnnotationDetail_value, typedef_TDAnnotationDetail_key}
...
typedef_PrimitiveType.attributes={typedef_PrimitiveType_nillable, typedef_PrimitiveType_typesetName}
...
typedef_TypeLanguageBinding.attributes={typedef_TypeLanguageBinding_defaultInitValue, typedef_TypeLanguageBinding_langSpecificType, typedef_TypeLanguageBinding_nullValueLiteral, typedef_TypeLanguageBinding_lang, typedef_TypeLanguageBinding_langSpecificNS}
...
domain_model = DomainModel(
    name="typedef",
    types={typedef_DocumentRoot, typedef_Type, typedef_TypeAnnotation, typedef_Feature, typedef_TDDocumentation, typedef_CSIDatatype, Type, typedef_Entity, typedef_TDAnnotationDetail, typedef_PrimitiveType, typedef_TypedArray, typedef_Exception, typedef_EnumVal, typedef_EnumLiteral, typedef_TypeLanguageBinding, CSIDatatypeCodes, CSIExceptionTypes},
    associations={types0, annotations1, features5, type6, documentation9, documentation3, details14, componentType12, valueType17, literals19, documentation21, languageBindings16},
    generalizations={gen_typedef_CSIDatatype_Type, gen_typedef_Entity_Type, gen_typedef_PrimitiveType_Type, gen_typedef_TypedArray_Type, gen_typedef_Exception_Type, gen_typedef_EnumVal_Type},
    metadata=None
)
