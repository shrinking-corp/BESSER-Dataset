...
class typedef_TypeLanguageBinding:
    ...
    def __init__(self, langSpecificNS: str, defaultInitValue: str, nullValueLiteral: str, lang: str, langSpecificType: str, typedef_TypeLanguageBinding: "typedef_PrimitiveType" = None):
...
class typedef_TDDocumentation:
    ...
    def __init__(self, doc: str, typedef_TDDocumentation23: "typedef_EnumLiteral" = None, typedef_TDDocumentation11: "typedef_Feature" = None, typedef_TDDocumentation: "typedef_Type" = None):
        self.doc = doc
...
class typedef_Feature:
    ...
    def __init__(self, name: str, typedef_Feature: "typedef_Entity" = None, typedef_Feature7: "typedef_Type" = None, typedef_Feature10: "typedef_TDDocumentation" = None):
        self.name = name
...
class typedef_TypeAnnotation:
    ...
    def __init__(self, source: str, typedef_TypeAnnotation15: set["typedef_TDAnnotationDetail"] = None, typedef_TypeAnnotation: "typedef_Type" = None):
        self.source = source
...
class typedef_Type(ABC):
    ...
    def __init__(self, name: str, typedef_Type13: "typedef_TypedArray" = None, typedef_Type18: "typedef_EnumVal" = None, typedef_Type: "typedef_DocumentRoot" = None, typedef_Type2: set["typedef_TypeAnnotation"] = None, typedef_Type8: "typedef_Feature" = None, typedef_Type4: "typedef_TDDocumentation" = None):
        self.name = name
