...
def test_hyp_hbmxml_entity_is_not_abstract():
    assert not inspect.isabstract(hbmxml_Entity)


def test_hyp_hbmxml_entity_constructor_exists():
    assert callable(hbmxml_Entity.__init__)


def test_hyp_hbmxml_entity_constructor_args():
...
def test_hyp_hbmxml_datatype_is_not_abstract():
    assert not inspect.isabstract(hbmxml_DataType)


def test_hyp_hbmxml_datatype_constructor_exists():
    assert callable(hbmxml_DataType.__init__)


def test_hyp_hbmxml_datatype_constructor_args():
...
def test_hyp_hbmxml_feature_is_not_abstract():
    assert not inspect.isabstract(hbmxml_Feature)


def test_hyp_hbmxml_feature_constructor_exists():
    assert callable(hbmxml_Feature.__init__)


def test_hyp_hbmxml_feature_constructor_args():
...
def test_hyp_hbmxml_type_is_not_abstract():
    assert not inspect.isabstract(hbmxml_Type)


def test_hyp_hbmxml_type_constructor_exists():
    assert callable(hbmxml_Type.__init__)


def test_hyp_hbmxml_type_constructor_args():
    sig = inspect.signature(hbmxml_Type.__init__)
    params = list(sig.parameters.keys())



def test_hyp_hbmxml_namedelement_is_not_abstract():
    assert not inspect.isabstract(hbmxml_NamedElement)


def test_hyp_hbmxml_namedelement_constructor_exists():
    assert callable(hbmxml_NamedElement.__init__)


def test_hyp_hbmxml_namedelement_constructor_args():
...
def test_hyp_hbmxml_entitymodel_is_not_abstract():
    assert not inspect.isabstract(hbmxml_EntityModel)


def test_hyp_hbmxml_entitymodel_constructor_exists():
    assert callable(hbmxml_EntityModel.__init__)


def test_hyp_hbmxml_entitymodel_constructor_args():
...
def test_hyp_hbmxml_entity_abstract_setter(instance):
...
def test_hyp_hbmxml_feature_kind_setter(instance):
...
def test_hyp_hbmxml_namedelement_name_setter(instance):
