...
# Classes
hbmxml_EntityModel = Class(name="hbmxml_EntityModel")
hbmxml_NamedElement = Class(name="hbmxml_NamedElement", is_abstract=True)
hbmxml_Type = Class(name="hbmxml_Type", is_abstract=True)
NamedElement = Class(name="NamedElement")
hbmxml_DataType = Class(name="hbmxml_DataType")
Type = Class(name="Type")
hbmxml_Entity = Class(name="hbmxml_Entity")
hbmxml_Feature = Class(name="hbmxml_Feature")
