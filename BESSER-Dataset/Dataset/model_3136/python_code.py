...
class ClassDiagram_Property:
    ...
    def __init__(self, name: str, lower: int, upper: str, aggregation: str, ClassDiagram_Property4: "ClassDiagram_Classifier" = None, ClassDiagram_Property6: "ClassDiagram_Association" = None, ClassDiagram_Property: "ClassDiagram_Class" = None, ClassDiagram_Property2: "ClassDiagram_Interface" = None):
        self.name = name
        self.lower = lower
        self.upper = upper
...
class ClassDiagram_Classifier(ABC):
    ...
    def __init__(self, name: str, ClassDiagram_Classifier: "ClassDiagram_Property" = None, ClassDiagram_Classifier8: "ClassDiagram_Generalization" = None, ClassDiagram_Classifier11: "ClassDiagram_Generalization" = None, ClassDiagram_Classifier13: "ClassDiagram_Dependency" = None, ClassDiagram_Classifier16: "ClassDiagram_Dependency" = None):
        self.name = name
