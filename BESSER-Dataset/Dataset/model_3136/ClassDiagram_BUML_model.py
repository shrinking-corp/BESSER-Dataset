...
# Classes
ClassDiagram_Relationship = Class(name="ClassDiagram_Relationship", is_abstract=True)
...
ClassDiagram_Property = Class(name="ClassDiagram_Property")
...
ClassDiagram_Property.attributes={ClassDiagram_Property_name, ClassDiagram_Property_lower, ClassDiagram_Property_aggregation, ClassDiagram_Property_upper}
...
domain_model = DomainModel(
    name="ClassDiagram",
    types={ClassDiagram_Relationship, ClassDiagram_Association, Relationship, ClassDiagram_Generalization, ClassDiagram_Classifier, ClassDiagram_DataType, Classifier, ClassDiagram_Class, ClassDiagram_Property, ClassDiagram_Interface, ClassDiagram_Dependency, ClassDiagram_Realization, Dependency, AggregationKind},
    associations={type3, memberEnd5, general7, ownedAttribute0, ownedAttribute1, specific9, supplier12, client14},
    generalizations={gen_ClassDiagram_Association_Relationship, gen_ClassDiagram_Generalization_Relationship, gen_ClassDiagram_DataType_Classifier, gen_ClassDiagram_Class_Classifier, gen_ClassDiagram_Interface_Classifier, gen_ClassDiagram_Dependency_Relationship, gen_ClassDiagram_Realization_Dependency},
    metadata=None
)
