...
# Classes
edges_MigrationEdge = Class(name="edges_MigrationEdge")
PopulationEdge = Class(name="PopulationEdge")
edges_MigrationEdgeLabel = Class(name="edges_MigrationEdgeLabel")
EdgeLabel = Class(name="EdgeLabel")
edges_MigrationEdgeLabelValue = Class(name="edges_MigrationEdgeLabelValue")
LabelValue = Class(name="LabelValue")
edges_MixingEdge = Class(name="edges_MixingEdge")
edges_MixingEdgeLabel = Class(name="edges_MixingEdgeLabel")
edges_MixingEdgeLabelValue = Class(name="edges_MixingEdgeLabelValue")
edges_PopulationEdge = Class(name="edges_PopulationEdge")
