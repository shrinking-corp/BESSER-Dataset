...
domain_model = DomainModel(
    name="entities",
    types={entities_Model, entities_EntityType, ElementType, entities_BasicType, entities_Entity, entities_Attribute, entities_AttributeType, entities_ElementType},
    associations={entity10, entities0, superType2, attributes4, type6, elementType8},
