...
class petrinet_Transition:
    ...
    def __init__(self, name: str, petrinet_Transition14: "petrinet_TransitionFireEvent" = None, petrinet_Transition: "petrinet_Net" = None, petrinet_Transition4: set["petrinet_Place"] = None, petrinet_Transition7: set["petrinet_Place"] = None):
        self.name = name
