...
petrinet_Net.methods={petrinet_Net_m_fireEnabledTransition, petrinet_Net_m_initializeModel, petrinet_Net_m_stop, petrinet_Net_m_run}
...
petrinet_Transition.methods={petrinet_Transition_m_fire_PreCondition, petrinet_Transition_m_fire, petrinet_Transition_m_isEnabled}
...
domain_model = DomainModel(
    ...
    associations={transition13, places0, transitions1, input3, output6, tokens9, net11},
    generalizations={},
    metadata=None
)
