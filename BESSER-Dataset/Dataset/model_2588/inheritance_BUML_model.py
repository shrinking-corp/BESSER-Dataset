...
# Classes
inheritance_Superclass = Class(name="inheritance_Superclass")
inheritance_Subclass1 = Class(name="inheritance_Subclass1")
Subclass2 = Class(name="Subclass2")
inheritance_Subclass2 = Class(name="inheritance_Subclass2")
Superclass = Class(name="Superclass")
inheritance_Sub1Subclass = Class(name="inheritance_Sub1Subclass")
Subclass1 = Class(name="Subclass1")
inheritance_Subclass3 = Class(name="inheritance_Subclass3")
inheritance_Sub2Subclass = Class(name="inheritance_Sub2Subclass")
Subclass3 = Class(name="Subclass3")
inheritance_Sub3Subclass = Class(name="inheritance_Sub3Subclass")
...
domain_model = DomainModel(
    name="inheritance",
    types={inheritance_Superclass, inheritance_Subclass1, Subclass2, inheritance_Subclass2, Superclass, inheritance_Sub1Subclass, Subclass1, inheritance_Subclass3, inheritance_Sub2Subclass, Subclass3, inheritance_Sub3Subclass},
    associations={},
    generalizations={gen_inheritance_Subclass1_Subclass2, gen_inheritance_Subclass2_Superclass, gen_inheritance_Sub1Subclass_Subclass1, gen_inheritance_Subclass3_Superclass, gen_inheritance_Sub2Subclass_Subclass3, gen_inheritance_Sub3Subclass_Subclass3},
    metadata=None
)
