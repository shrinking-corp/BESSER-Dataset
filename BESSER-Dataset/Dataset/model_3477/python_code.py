...
class feature_Group:
    ...
    def __init__(self, minCardinality: int, maxCardinality: int, groups: "feature_Feature" = None, parentGroup: set["feature_Feature"] = None, Group: "feature_Feature" = None, Group14: "feature_Feature" = None):
...
class feature_Feature:
    ...
    def __init__(self, name: str, minCardinality: int, maxCardinality: int, Feature: "feature_Group" = None, Feature20: "feature_Group" = None, Feature22: "feature_Constraint" = None, feature_Feature: "feature_FeatureModel" = None, feature: set["feature_Attribute"] = None, parentFeature: set["feature_Group"] = None, childFeatures: "feature_Group" = None, feature16: set["feature_Annotation"] = None, constrainedFeatures: set["feature_Constraint"] = None, Feature24: "feature_Attribute" = None, Feature26: "feature_Annotation" = None):
        self.name = name
        self.minCardinality = minCardinality
        self.maxCardinality = maxCardinality
...
class feature_Constraint:
    ...
    def __init__(self, language: str, expression: str, constraints: set["feature_Feature"] = None, feature_Constraint: "feature_FeatureModel" = None, Constraint: "feature_Feature" = None):
...
class feature_FeatureModel:
    ...
    def __init__(self, name: str, feature_FeatureModel: set["feature_Constraint"] = None, feature_FeatureModel2: "feature_Feature" = None, FeatureModel: "feature_FeatureModel" = None, parent: set["feature_FeatureModel"] = None, FeatureModel7: "feature_FeatureModel" = None, children: "feature_FeatureModel" = None, feature_FeatureModel10: "feature_FeatureModel" = None, feature_FeatureModel8: "feature_FeatureModel" = None):
        self.name = name
