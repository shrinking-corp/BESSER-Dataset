...
myPackage_MyOtherClass = Class(name="myPackage_MyOtherClass")
myPackage_AThirdClass = Class(name="myPackage_AThirdClass")
MyClass = Class(name="MyClass")
myPackage_subPackage_Foo = Class(name="myPackage_subPackage_Foo")
myPackage_subsub_Bar = Class(name="myPackage_subsub_Bar")
myPackage_subsub_Baz = Class(name="myPackage_subsub_Baz")
subsub_Bar = Class(name="subsub_Bar")
subPackage_Foo = Class(name="subPackage_Foo")
