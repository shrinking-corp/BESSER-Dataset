...
class classifiers_Interface(ConcreteClassifier):
    ...
    def __init__(self, classifiers_Interface: set["TypeReference"] = None, classifiers_Interface30: set["TypeReference"] = None, ConcreteClassifier96: "imports_ClassifierImport" = None, ConcreteClassifier: "containers_CompilationUnit" = None):
...
class statements_Switch(Statement):
    ...
    pass
class statements_ForLoop(Conditional, Statement, StatementContainer):

    pass
class statements_Condition(Conditional, Statement, StatementContainer):
...
class ReferenceableElement:
    ...
    pass
class containers_Package(JavaRoot, Annotable, ReferenceableElement):
...
class types_PrimitiveType(TypeReference, Type):
    ...
    def __init__(self, TypeReference92: "generics_TypeParameter" = None, TypeReference26: "classifiers_Class" = None, TypeReference162: "types_TypedElement" = None, TypeReference88: "generics_ExtendsTypeArgument" = None, TypeReference28: "classifiers_Interface" = None, TypeReference23: "classifiers_Class" = None, TypeReference31: "classifiers_Interface" = None, TypeReference: "classifiers_Implementor" = None, TypeReference90: "generics_SuperTypeArgument" = None):
...
class classifiers_Classifier(Type, ReferenceableElement):
    ...
    def __init__(self, ReferenceableElement: "imports_StaticMemberImport" = None, ReferenceableElement119: "references_ElementReference" = None):
...
class Classifier:
    ...
    pass
class classifiers_ConcreteClassifier(MemberContainer, AnnotableAndModifiable, Member, Statement, Classifier, TypeParametrizable):

    def __init__(self, fullName: str, Classifier164: "types_ClassifierReference" = None, Classifier: "annotations_AnnotationInstance" = None, Member106: "members_MemberContainer" = None, Member: "members_MemberContainer" = None, Statement125: "statements_StatementListContainer" = None, Statement132: "statements_Condition" = None, Statement: "statements_StatementContainer" = None):
...
class Reference:
    ...
    pass
class arrays_ArrayInstantiationBySize(ArrayTypeable, Reference, Expression, TypedElement):
...
class references_ReflectiveClassReference(Reference):
    ...
    pass
class arrays_ArrayInstantiationByValues(ArrayTypeable, Reference, Expression, TypedElement):
...
class types_Type(Commentable):
    ...
    def __init__(self):
        ...
        pass
    def equalsType(self, types_arrayDimension, types_otherArrayDimension, types_otherType) :
    ...
    def isSuperType(self, types_otherType, types_otherArrayType, types_arrayDimension) :
...
class statements_TryBlock(StatementListContainer, Statement):
    ...
    pass
class statements_Block(StatementListContainer, Member, Modifiable, Statement):
...
class statements_SwitchCase(StatementListContainer):
    ...
    pass
class members_Constructor(AnnotableAndModifiable, Parametrizable, StatementListContainer, Member, ExceptionThrower, TypeParametrizable):

    pass
class Initializable:

    pass
class variables_AdditionalLocalVariable(ArrayTypeable, Initializable, ReferenceableElement):
...
class members_AdditionalField(ArrayTypeable, Initializable, ReferenceableElement):
...
class members_Member(NamedElement):
    ...
    pass
class members_Method(AnnotableAndModifiable, Parametrizable, ReferenceableElement, Member, ArrayTypeable, TypedElement, ExceptionThrower, TypeParametrizable):

    def __init__(self, ReferenceableElement: "imports_StaticMemberImport" = None, ReferenceableElement119: "references_ElementReference" = None, Member106: "members_MemberContainer" = None, Member: "members_MemberContainer" = None):
...
class parameters_Parameter(AnnotableAndModifiable, Variable):
    ...
    pass
class variables_LocalVariable(ForLoopInitializer, Initializable, AnnotableAndModifiable, Variable):

    pass
class members_Field(Initializable, AnnotableAndModifiable, ReferenceableElement, Member, Variable):
...
class variables_Variable(NamedElement, ReferenceableElement, TypeArgumentable, ArrayTypeable, TypedElement):
...
class references_MethodCall(ElementReference, CallTypeArgumentable, Argumentable):
    ...
    pass
class instantiations_Instantiation(Reference, TypeArgumentable, Argumentable, TypedElement):
...
class generics_TypeParameter(Classifier):
    ...
    def __init__(self, generics_TypeParameter: set["TypeReference"] = None, Classifier164: "types_ClassifierReference" = None, Classifier: "annotations_AnnotationInstance" = None):
...
class expressions_Expression(AnnotationValue, ArrayInitializationValue):
    ...
    def __init__(self, AnnotationValue9: "annotations_AnnotationAttributeSetting" = None, AnnotationValue: "annotations_SingleAnnotationParameter" = None, ArrayInitializationValue: "arrays_ArrayInitializer" = None):
