...
# Classes
exercises_DFA = Class(name="exercises_DFA")
NamableElement = Class(name="NamableElement")
exercises_State = Class(name="exercises_State")
exercises_NamableElement = Class(name="exercises_NamableElement", is_abstract=True)
exercises_Transition = Class(name="exercises_Transition")
...
exercises_State.attributes={exercises_State_isEnd, exercises_State_id, exercises_State_isStart}
...
domain_model = DomainModel(
    name="exercises",
    types={exercises_DFA, NamableElement, exercises_State, exercises_NamableElement, exercises_Transition},
    associations={states0, incoming3, outgoing6, transition1},
    generalizations={gen_exercises_DFA_NamableElement, gen_exercises_Transition_NamableElement, gen_exercises_State_NamableElement},
    metadata=None
)
