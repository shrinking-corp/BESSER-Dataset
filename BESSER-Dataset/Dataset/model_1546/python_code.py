...
class tp6_Researcher:
    ...
    def __init__(self, name: str, forName: str, tp6_Researcher14: "tp6_PublicationStructure" = None, authors: set["tp6_Paper"] = None, tp6_Researcher: set["tp6_Skill"] = None, tp6_Researcher3: "tp6_Position" = None, tp6_Researcher5: set["tp6_Collaboration"] = None, Researcher: "tp6_Paper" = None):
        self.name = name
...
class tp6_Position:
    ...
    def __init__(self, name: str, description: str, tp6_Position20: "tp6_PublicationStructure" = None, tp6_Position: "tp6_Researcher" = None, tp6_Position25: "tp6_Position" = None, tp6_Position23: "tp6_Position" = None):
        self.name = name
        self.description = description
...
class tp6_Paper:
    ...
    def __init__(self, name: str, tp6_Paper10: "tp6_Paper" = None, tp6_Paper8: "tp6_Paper" = None, tp6_Paper12: set["tp6_PaperKeywords"] = None, tp6_Paper17: "tp6_PublicationStructure" = None, tp6_Paper28: "tp6_Collaboration" = None, tp6_Paper30: "tp6_Keyword" = None, Paper: "tp6_Researcher" = None, tp6_Paper: set["tp6_Paragraph"] = None, res_papers: set["tp6_Researcher"] = None):
        self.name = name
