...
domain_model = DomainModel(
    name="tp6",
    types={tp6_Paper, tp6_Skill, tp6_Position, tp6_Collaboration, tp6_Researcher, tp6_KnowledgeManager, tp6_Paragraph, tp6_PaperKeywords, tp6_PublicationStructure, tp6_Keyword, Role},
    associations={res_papers0, skills1, res_position2, collaborations4, knowledgeMan21, parent24, paragraphs6, authors7, citedBy9, keywords11, researchers13, papers15, positions18, col_paper26, kPapers29, keyword31, allKeywords34},
    generalizations={},
    metadata=None
)
