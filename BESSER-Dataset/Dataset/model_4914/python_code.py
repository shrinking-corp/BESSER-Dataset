...
class services_ServiceDescription:
    ...
    def __init__(self, serviceDescriptionCommon: str, serviceDescriptionNational: str, services_ServiceDescription: "services_Service" = None):
        ...
        pass
    @property
    def serviceDescriptionNational(self):
    ...
    @property
    def serviceDescriptionCommon(self):
...
class services_ServiceName:
    ...
    def __init__(self, index: str, alias: str, identifier: str, name: str, services_ServiceName: "services_Service" = None):
        self.index = index
        self.alias = alias
...
class services_Service:
    ...
    def __init__(self, serviceClass: str, mostTopService: str, serviceCategory: str, serviceCharacterCommon: str, serviceKind: str, serviceSupport1: str, ssDomain: str, services_Service11: "services_ServiceIncidentMgt" = None, services_Service: "services_ServiceName" = None, services_Service7: "services_ServiceDescription" = None, services_Service9: "services_ServiceSecurityMgt" = None, services_Service13: "services_CIID" = None, services_Service15: "services_ServiceInterrest" = None, services_Service17: set["services_ServiceContract"] = None, services_Service19: "services_ServiceSupport" = None, services_Service21: "services_ServiceAdditional" = None, services_Service24: "services_Service" = None, services_Service22: set["services_Service"] = None):
    ...
    @property
    def serviceCharacterCommon(self):
...
class services_ServiceIncidentMgt:
    ...
    def __init__(self, maintenance: str, businessImpact: str, maintenanceWindow: str, monitoring: str, services_ServiceIncidentMgt: "services_Service" = None):
...
class services_CFSService(Service):
    ...
    def __init__(self, scenario: str, provider: str, services_CFSService: set["services_EObject"] = None):
