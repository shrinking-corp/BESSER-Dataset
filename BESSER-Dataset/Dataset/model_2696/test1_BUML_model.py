...
# Classes
test1_ConceptB = Class(name="test1_ConceptB")
ConceptA = Class(name="ConceptA")
test1_ConceptA = Class(name="test1_ConceptA")
test1_ConceptC = Class(name="test1_ConceptC")
...
domain_model = DomainModel(
    name="test1",
    types={test1_ConceptB, ConceptA, test1_ConceptA, test1_ConceptC},
    associations={cs0},
