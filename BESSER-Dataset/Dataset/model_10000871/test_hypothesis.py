...
def test_procedure_has_idProcedure():
    assert hasattr(Procedure, "idProcedure")
    descriptor = None
    for klass in Procedure.__mro__:
        if "idProcedure" in klass.__dict__:
            descriptor = klass.__dict__["idProcedure"]
            break
    assert isinstance(descriptor, property)

def test_procedure_has_price():
    assert hasattr(Procedure, "price")
    descriptor = None
    for klass in Procedure.__mro__:
...
def test_treatment_has_procedureID():
    assert hasattr(Treatment, "procedureID")
    descriptor = None
    for klass in Treatment.__mro__:
        if "procedureID" in klass.__dict__:
            descriptor = klass.__dict__["procedureID"]
            break
    assert isinstance(descriptor, property)

def test_treatment_has_patientID():
    assert hasattr(Treatment, "patientID")
    descriptor = None
    for klass in Treatment.__mro__:
...
def test_treatment_has_idTreatment():
    assert hasattr(Treatment, "idTreatment")
    descriptor = None
    for klass in Treatment.__mro__:
        if "idTreatment" in klass.__dict__:
            descriptor = klass.__dict__["idTreatment"]
            break
    assert isinstance(descriptor, property)

def test_treatment_has_idBill():
    assert hasattr(Treatment, "idBill")
    descriptor = None
    for klass in Treatment.__mro__:
        if "idBill" in klass.__dict__:
            descriptor = klass.__dict__["idBill"]
            break
    assert isinstance(descriptor, property)
...
def test_doctor_has_departamentID():
    assert hasattr(Doctor, "departamentID")
    descriptor = None
    for klass in Doctor.__mro__:
        if "departamentID" in klass.__dict__:
            descriptor = klass.__dict__["departamentID"]
            break
    assert isinstance(descriptor, property)
...
@given(instance=Procedure_strategy)
def test_procedure_idProcedure_setter(instance):
...
@given(instance=Procedure_strategy)
def test_procedure_price_setter(instance):
...
@given(instance=Procedure_strategy)
def test_procedure_name_setter(instance):
...
@given(instance=Treatment_strategy)
def test_treatment_procedureID_setter(instance):
...
@given(instance=Treatment_strategy)
def test_treatment_patientID_setter(instance):
...
@given(instance=Treatment_strategy)
def test_treatment_idTreatment_setter(instance):
...
@given(instance=Treatment_strategy)
def test_treatment_idBill_setter(instance):
...
@given(instance=Doctor_strategy)
def test_doctor_departamentID_setter(instance):
