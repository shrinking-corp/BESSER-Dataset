...
domain_model = DomainModel(
    ...
    associations={models0, collections1, router3, views5, attributes7, type13, parameters16, model18, application20, mappings22, application23, view25, operations27, references8, operations10, application12, application30},
    generalizations={gen_backbone_Application_NamedElement, gen_backbone_Model_NamedElement, gen_backbone_Attribute_NamedElement, gen_backbone_Reference_NamedElement, gen_backbone_Operation_NamedElement, gen_backbone_Parameter_NamedElement, gen_backbone_Collection_NamedElement, gen_backbone_Router_NamedElement, gen_backbone_View_NamedElement},
    metadata=None
)
