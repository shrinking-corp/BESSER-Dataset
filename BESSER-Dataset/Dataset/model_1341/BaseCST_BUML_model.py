...
# Classes
baseCST_AnnotationCS = Class(name="baseCST_AnnotationCS")
AnnotationElementCS = Class(name="AnnotationElementCS")
baseCST_ModelElementCS = Class(name="baseCST_ModelElementCS", is_abstract=True)
baseCST_ModelElementRefCS = Class(name="baseCST_ModelElementRefCS")
baseCST_AnnotationElementCS = Class(name="baseCST_AnnotationElementCS", is_abstract=True)
NamedElementCS = Class(name="NamedElementCS")
baseCST_DetailCS = Class(name="baseCST_DetailCS")
baseCST_AttributeCS = Class(name="baseCST_AttributeCS")
StructuralFeatureCS = Class(name="StructuralFeatureCS")
baseCST_ClassCS = Class(name="baseCST_ClassCS")
ClassifierCS = Class(name="ClassifierCS")
NamespaceCS = Class(name="NamespaceCS")
baseCST_TypedRefCS = Class(name="baseCST_TypedRefCS", is_abstract=True)
baseCST_StructuralFeatureCS = Class(name="baseCST_StructuralFeatureCS", is_abstract=True)
baseCST_ClassifierCS = Class(name="baseCST_ClassifierCS", is_abstract=True)
TypeCS = Class(name="TypeCS")
TemplateableElementCS = Class(name="TemplateableElementCS")
baseCST_PackageCS = Class(name="baseCST_PackageCS")
baseCST_ConstraintCS = Class(name="baseCST_ConstraintCS")
baseCST_SpecificationCS = Class(name="baseCST_SpecificationCS")
baseCST_DataTypeCS = Class(name="baseCST_DataTypeCS")
baseCST_EnumerationLiteralCS = Class(name="baseCST_EnumerationLiteralCS")
baseCST_DocumentationCS = Class(name="baseCST_DocumentationCS")
baseCST_ElementCS = Class(name="baseCST_ElementCS", is_abstract=True)
VisitableCS = Class(name="VisitableCS")
baseCST_ElementRefCS = Class(name="baseCST_ElementRefCS", is_abstract=True)
PivotableElementCS = Class(name="PivotableElementCS")
baseCST_EnumerationCS = Class(name="baseCST_EnumerationCS")
baseCST_FeatureCS = Class(name="baseCST_FeatureCS", is_abstract=True)
TypedElementCS = Class(name="TypedElementCS")
baseCST_OperationCS = Class(name="baseCST_OperationCS")
baseCST_Namespace = Class(name="baseCST_Namespace")
baseCST_LambdaTypeCS = Class(name="baseCST_LambdaTypeCS")
TypedRefCS = Class(name="TypedRefCS")
Nameable = Class(name="Nameable")
baseCST_LibraryCS = Class(name="baseCST_LibraryCS")
ElementRefCS = Class(name="ElementRefCS")
baseCST_Element = Class(name="baseCST_Element")
baseCST_MultiplicityBoundsCS = Class(name="baseCST_MultiplicityBoundsCS")
MultiplicityCS = Class(name="MultiplicityCS")
baseCST_MultiplicityCS = Class(name="baseCST_MultiplicityCS", is_abstract=True)
ElementCS = Class(name="ElementCS")
baseCST_ImportCS = Class(name="baseCST_ImportCS")
baseCST_PathNameCS = Class(name="baseCST_PathNameCS")
ModelElementCS = Class(name="ModelElementCS")
baseCST_NamespaceCS = Class(name="baseCST_NamespaceCS", is_abstract=True)
FeatureCS = Class(name="FeatureCS")
baseCST_ParameterCS = Class(name="baseCST_ParameterCS")
baseCST_PathElementCS = Class(name="baseCST_PathElementCS")
Pivotable = Class(name="Pivotable")
baseCST_EClassifier = Class(name="baseCST_EClassifier")
baseCST_MultiplicityStringCS = Class(name="baseCST_MultiplicityStringCS")
baseCST_NamedElementCS = Class(name="baseCST_NamedElementCS", is_abstract=True)
baseCST_PivotableElementCS = Class(name="baseCST_PivotableElementCS", is_abstract=True)
baseCST_PrimitiveTypeRefCS = Class(name="baseCST_PrimitiveTypeRefCS")
baseCST_ReferenceCS = Class(name="baseCST_ReferenceCS")
baseCST_Property = Class(name="baseCST_Property")
baseCST_RootCS = Class(name="baseCST_RootCS", is_abstract=True)
baseCST_RootPackageCS = Class(name="baseCST_RootPackageCS")
PackageCS = Class(name="PackageCS")
RootCS = Class(name="RootCS")
baseCST_PathElementWithURICS = Class(name="baseCST_PathElementWithURICS")
PathElementCS = Class(name="PathElementCS")
baseCST_TemplateParameterSubstitutionCS = Class(name="baseCST_TemplateParameterSubstitutionCS")
baseCST_TemplateParameterCS = Class(name="baseCST_TemplateParameterCS", is_abstract=True)
baseCST_TemplateSignatureCS = Class(name="baseCST_TemplateSignatureCS")
baseCST_TypeRefCS = Class(name="baseCST_TypeRefCS", is_abstract=True)
baseCST_TemplateableElementCS = Class(name="baseCST_TemplateableElementCS", is_abstract=True)
baseCST_TuplePartCS = Class(name="baseCST_TuplePartCS")
baseCST_TupleTypeCS = Class(name="baseCST_TupleTypeCS")
baseCST_TypeCS = Class(name="baseCST_TypeCS", is_abstract=True)
baseCST_TypeParameterCS = Class(name="baseCST_TypeParameterCS")
TemplateParameterCS = Class(name="TemplateParameterCS")
baseCST_TypedElementCS = Class(name="baseCST_TypedElementCS", is_abstract=True)
TypeRefCS = Class(name="TypeRefCS")
baseCST_TemplateBindingCS = Class(name="baseCST_TemplateBindingCS")
baseCST_TypedTypeRefCS = Class(name="baseCST_TypedTypeRefCS")
baseCST_Type = Class(name="baseCST_Type")
baseCST_VisitableCS = Class(name="baseCST_VisitableCS", is_abstract=True)
baseCST_WildcardTypeRefCS = Class(name="baseCST_WildcardTypeRefCS")
...
baseCST_PackageCS_m_getClassifier: Method = Method(name="getClassifier", parameters={Parameter(name='baseCST_name', type=StringType)}, type=ClassifierCS)
baseCST_PackageCS.attributes={baseCST_PackageCS_nsPrefix, baseCST_PackageCS_nsURI}
...
baseCST_MultiplicityBoundsCS.attributes={baseCST_MultiplicityBoundsCS_upperBound, baseCST_MultiplicityBoundsCS_lowerBound}
...
baseCST_MultiplicityCS.methods={baseCST_MultiplicityCS_m_getLower, baseCST_MultiplicityCS_m_getUpper}
...
baseCST_TypedElementCS.attributes={baseCST_TypedElementCS_qualifier, baseCST_TypedElementCS_optional}
...
domain_model = DomainModel(
    name="baseCST",
    types={baseCST_AnnotationCS, AnnotationElementCS, baseCST_ModelElementCS, baseCST_ModelElementRefCS, baseCST_AnnotationElementCS, NamedElementCS, baseCST_DetailCS, baseCST_AttributeCS, StructuralFeatureCS, baseCST_ClassCS, ClassifierCS, NamespaceCS, baseCST_TypedRefCS, baseCST_StructuralFeatureCS, baseCST_ClassifierCS, TypeCS, TemplateableElementCS, baseCST_PackageCS, baseCST_ConstraintCS, baseCST_SpecificationCS, baseCST_DataTypeCS, baseCST_EnumerationLiteralCS, baseCST_DocumentationCS, baseCST_ElementCS, VisitableCS, baseCST_ElementRefCS, PivotableElementCS, baseCST_EnumerationCS, baseCST_FeatureCS, TypedElementCS, baseCST_OperationCS, baseCST_Namespace, baseCST_LambdaTypeCS, TypedRefCS, Nameable, baseCST_LibraryCS, ElementRefCS, baseCST_Element, baseCST_MultiplicityBoundsCS, MultiplicityCS, baseCST_MultiplicityCS, ElementCS, baseCST_ImportCS, baseCST_PathNameCS, ModelElementCS, baseCST_NamespaceCS, FeatureCS, baseCST_ParameterCS, baseCST_PathElementCS, Pivotable, baseCST_EClassifier, baseCST_MultiplicityStringCS, baseCST_NamedElementCS, baseCST_PivotableElementCS, baseCST_PrimitiveTypeRefCS, baseCST_ReferenceCS, baseCST_Property, baseCST_RootCS, baseCST_RootPackageCS, PackageCS, RootCS, baseCST_PathElementWithURICS, PathElementCS, baseCST_TemplateParameterSubstitutionCS, baseCST_TemplateParameterCS, baseCST_TemplateSignatureCS, baseCST_TypeRefCS, baseCST_TemplateableElementCS, baseCST_TuplePartCS, baseCST_TupleTypeCS, baseCST_TypeCS, baseCST_TypeParameterCS, TemplateParameterCS, baseCST_TypedElementCS, TypeRefCS, baseCST_TemplateBindingCS, baseCST_TypedTypeRefCS, baseCST_Type, baseCST_VisitableCS, baseCST_WildcardTypeRefCS, IteratorKind},
    associations={ownedContent0, ownedReference1, ownedDetail3, ownedSuperType4, ownedOperation5, ownedProperty6, ownedMetaType7, owner10, ownedConstraint11, specification12, messageSpecification14, literals17, logicalParent19, ownedLiterals20, namespace23, ownedContextType25, ownedParameterType27, ownedResultType30, package33, ownedAnnotation35, pathName38, element41, pathName22, owningClass43, ownedParameter44, ownedException46, ownedPrecondition48, ownedPostcondition51, ownedBodyExpression54, ownedType57, ownedNestedPackage60, owner61, pathName63, element64, path68, element69, context72, pivot75, opposite77, keys78, ownedImport81, ownedLibrary83, owner86, ownedDefaultExpression88, elementType66, ownedParameterSubstitution91, owningTemplateSignature92, owningTemplateBinding93, ownedActualParameter94, owningTemplateElement95, ownedTemplateParameter96, ownedTemplateSignature97, ownedParts99, ownedExtends100, ownedSuper102, ownedType105, owningTemplateBindableElement90, pathName109, type111, ownedTemplateBinding113, extends115, super117, multiplicity107},
    generalizations={gen_baseCST_AnnotationCS_AnnotationElementCS, gen_baseCST_AnnotationElementCS_NamedElementCS, gen_baseCST_AttributeCS_StructuralFeatureCS, gen_baseCST_ClassCS_ClassifierCS, gen_baseCST_ClassCS_NamespaceCS, gen_baseCST_ClassifierCS_NamedElementCS, gen_baseCST_ClassifierCS_TypeCS, gen_baseCST_ClassifierCS_TemplateableElementCS, gen_baseCST_ConstraintCS_NamedElementCS, gen_baseCST_DataTypeCS_ClassifierCS, gen_baseCST_DataTypeCS_NamespaceCS, gen_baseCST_DetailCS_NamedElementCS, gen_baseCST_DocumentationCS_AnnotationElementCS, gen_baseCST_ElementCS_VisitableCS, gen_baseCST_ElementRefCS_PivotableElementCS, gen_baseCST_EnumerationCS_ClassifierCS, gen_baseCST_EnumerationCS_NamespaceCS, gen_baseCST_EnumerationLiteralCS_NamedElementCS, gen_baseCST_FeatureCS_TypedElementCS, gen_baseCST_LambdaTypeCS_TypedRefCS, gen_baseCST_LambdaTypeCS_TemplateableElementCS, gen_baseCST_LambdaTypeCS_Nameable, gen_baseCST_LibraryCS_NamespaceCS, gen_baseCST_ModelElementCS_PivotableElementCS, gen_baseCST_ModelElementRefCS_ElementRefCS, gen_baseCST_MultiplicityBoundsCS_MultiplicityCS, gen_baseCST_MultiplicityCS_ElementCS, gen_baseCST_ImportCS_NamespaceCS, gen_baseCST_NamedElementCS_ModelElementCS, gen_baseCST_NamedElementCS_Nameable, gen_baseCST_NamespaceCS_NamedElementCS, gen_baseCST_OperationCS_FeatureCS, gen_baseCST_OperationCS_TemplateableElementCS, gen_baseCST_PackageCS_NamespaceCS, gen_baseCST_ParameterCS_TypedElementCS, gen_baseCST_PathElementCS_ElementCS, gen_baseCST_PathElementCS_Pivotable, gen_baseCST_MultiplicityStringCS_MultiplicityCS, gen_baseCST_PathNameCS_ElementCS, gen_baseCST_PathNameCS_Pivotable, gen_baseCST_PivotableElementCS_ElementCS, gen_baseCST_PivotableElementCS_Pivotable, gen_baseCST_PrimitiveTypeRefCS_TypedRefCS, gen_baseCST_PrimitiveTypeRefCS_Nameable, gen_baseCST_ReferenceCS_StructuralFeatureCS, gen_baseCST_RootCS_ModelElementCS, gen_baseCST_RootPackageCS_PackageCS, gen_baseCST_RootPackageCS_RootCS, gen_baseCST_SpecificationCS_ModelElementCS, gen_baseCST_StructuralFeatureCS_FeatureCS, gen_baseCST_PathElementWithURICS_PathElementCS, gen_baseCST_TemplateParameterCS_NamedElementCS, gen_baseCST_TemplateParameterSubstitutionCS_ModelElementCS, gen_baseCST_TemplateSignatureCS_ModelElementCS, gen_baseCST_TemplateableElementCS_ElementCS, gen_baseCST_TuplePartCS_TypedElementCS, gen_baseCST_TupleTypeCS_TypedRefCS, gen_baseCST_TupleTypeCS_Nameable, gen_baseCST_TypeCS_ModelElementCS, gen_baseCST_TypeParameterCS_TemplateParameterCS, gen_baseCST_TypeParameterCS_TypeCS, gen_baseCST_TypeRefCS_ElementRefCS, gen_baseCST_TypedElementCS_NamedElementCS, gen_baseCST_TypedRefCS_TypeRefCS, gen_baseCST_TemplateBindingCS_ElementRefCS, gen_baseCST_WildcardTypeRefCS_TypeRefCS, gen_baseCST_TypedTypeRefCS_TypedRefCS},
    metadata=None
)
