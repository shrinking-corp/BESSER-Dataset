...
class PackageCS:
    ...
    pass
class baseCST_RootPackageCS(PackageCS, RootCS):
...
class baseCST_PathNameCS(Pivotable, ElementCS):
    ...
    def __init__(self, scopeFilter: str, baseCST_PathNameCS40: "baseCST_ModelElementRefCS" = None, baseCST_PathNameCS: "baseCST_ImportCS" = None, PathNameCS: "baseCST_PathElementCS" = None, pathName: set["baseCST_PathElementCS"] = None, baseCST_PathNameCS70: "baseCST_Element" = None, baseCST_PathNameCS73: "baseCST_ElementCS" = None, baseCST_PathNameCS110: "baseCST_TypedTypeRefCS" = None):
...
class TypedRefCS:
    ...
    pass
class baseCST_TupleTypeCS(TypedRefCS, Nameable):
...
class baseCST_TypedTypeRefCS(TypedRefCS):
    ...
    pass
class baseCST_PrimitiveTypeRefCS(TypedRefCS, Nameable):
...
class baseCST_SpecificationCS(ModelElementCS):
    ...
    def __init__(self, exprString: str, baseCST_SpecificationCS56: "baseCST_OperationCS" = None, baseCST_SpecificationCS: "baseCST_ConstraintCS" = None, baseCST_SpecificationCS16: "baseCST_ConstraintCS" = None, baseCST_SpecificationCS89: "baseCST_StructuralFeatureCS" = None):
...
class TemplateableElementCS:
    ...
    pass
class baseCST_LambdaTypeCS(TypedRefCS, Nameable, TemplateableElementCS):
...
class baseCST_ImportCS(NamespaceCS):
    ...
    def __init__(self, all: bool, baseCST_ImportCS24: "baseCST_Namespace" = None, baseCST_ImportCS: "baseCST_PathNameCS" = None, baseCST_ImportCS82: "baseCST_RootCS" = None):
        self.all = all
...
class baseCST_PackageCS(NamespaceCS):
    ...
    def __init__(self, nsPrefix: str, nsURI: str, owner58: set["baseCST_ClassifierCS"] = None, baseCST_PackageCS: "baseCST_PackageCS" = None, baseCST_PackageCS59: set["baseCST_PackageCS"] = None, PackageCS: "baseCST_ClassifierCS" = None):
    ...
    def getClassifier(self, baseCST_name) :
...
class baseCST_EnumerationCS(NamespaceCS, ClassifierCS):
    ...
    pass
class baseCST_DataTypeCS(ClassifierCS, NamespaceCS):
...
class baseCST_EnumerationLiteralCS(NamedElementCS):
    ...
    def __init__(self, value: int, baseCST_EnumerationLiteralCS21: "baseCST_EnumerationCS" = None, baseCST_EnumerationLiteralCS: "baseCST_DataTypeCS" = None):
        self.value = value
...
class baseCST_ConstraintCS(NamedElementCS):
    ...
    def __init__(self, stereotype: str, baseCST_ConstraintCS50: "baseCST_OperationCS" = None, baseCST_ConstraintCS53: "baseCST_OperationCS" = None, baseCST_ConstraintCS: "baseCST_ClassifierCS" = None, baseCST_ConstraintCS13: "baseCST_SpecificationCS" = None, baseCST_ConstraintCS15: "baseCST_SpecificationCS" = None):
...
class baseCST_ClassifierCS(TypeCS, NamedElementCS, TemplateableElementCS):
    ...
    def __init__(self, instanceClassName: str, qualifier: str, ClassifierCS: "baseCST_PackageCS" = None, ownedType: "baseCST_PackageCS" = None, baseCST_ClassifierCS: set["baseCST_ConstraintCS"] = None):
...
class baseCST_ModelElementCS(PivotableElementCS):
    ...
    def __init__(self, originalXmiId: str, csi: str, baseCST_ModelElementCS36: set["baseCST_AnnotationElementCS"] = None, baseCST_ModelElementCS: "baseCST_AnnotationCS" = None):
