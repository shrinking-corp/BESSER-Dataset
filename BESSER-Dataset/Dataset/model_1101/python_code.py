...
class PetriNets_Transition:
    ...
    def __init__(self, priority: float, Transition: "PetriNets_PetriNet" = None, trans: "PetriNets_PetriNet" = None, PetriNets_Transition: set["PetriNets_Place"] = None, PetriNets_Transition10: set["PetriNets_Place"] = None, PetriNets_Transition13: set["PetriNets_Place"] = None, PetriNets_Transition16: set["PetriNets_Place"] = None):
...
class PetriNets_Place:
    ...
    def __init__(self, itokens: int, bound: int, Place: "PetriNets_PetriNet" = None, places: "PetriNets_PetriNet" = None, PetriNets_Place: set["PetriNets_Token"] = None, PetriNets_Place8: "PetriNets_Transition" = None, PetriNets_Place11: "PetriNets_Transition" = None, PetriNets_Place14: "PetriNets_Transition" = None, PetriNets_Place17: "PetriNets_Transition" = None):
