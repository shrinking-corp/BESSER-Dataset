...
SimpleRDBMS_Table.attributes={SimpleRDBMS_Table_tipo, SimpleRDBMS_Table_name}
...
SimpleRDBMS_Column.attributes={SimpleRDBMS_Column_type, SimpleRDBMS_Column_name}
...
domain_model = DomainModel(
    name="SimpleRDBMS",
    types={SimpleRDBMS_Table, FKey, Column, SimpleRDBMS_Column, SimpleRDBMS_FKey, Table},
