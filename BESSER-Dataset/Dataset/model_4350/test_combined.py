...
def test_ecoreDiff_ETypedElement_lowerBound_value_roundtrip():
    instance = ecoreDiff_ETypedElement(lowerBound=7, many=True, ordered=True, required=True, unique=True, upperBound=7)
...
def test_assoc_eAttributeType92_link_reassign_clear():
    ...
    if hasattr(b1, 'ecoreDiff_EAttribute93'):
        assert _is_linked(b1, 'ecoreDiff_EAttribute93', a)
    _safe_set(a, 'ecoreDiff_EDataType', b2)
    assert _is_linked(a, 'ecoreDiff_EDataType', b2)
    if hasattr(b1, 'ecoreDiff_EAttribute93'):
        assert not _is_linked(b1, 'ecoreDiff_EAttribute93', a)
    if hasattr(b2, 'ecoreDiff_EAttribute93'):
        assert _is_linked(b2, 'ecoreDiff_EAttribute93', a)
    _safe_set(a, 'ecoreDiff_EDataType', None)
    assert not _is_linked(a, 'ecoreDiff_EDataType', b2)
    if hasattr(b2, 'ecoreDiff_EAttribute93'):
        assert not _is_linked(b2, 'ecoreDiff_EAttribute93', a)
...
def test_assoc_eGenericType87_link_reassign_clear():
    a = ecoreDiff_ETypedElement(lowerBound=7, many=True, ordered=True, required=True, unique=True, upperBound=7)
    b1 = ecoreDiff_EGenericType()
    b2 = ecoreDiff_EGenericType()
    _safe_set(a, 'ecoreDiff_ETypedElement88', b1)
    assert _is_linked(a, 'ecoreDiff_ETypedElement88', b1)
    if hasattr(b1, 'ecoreDiff_EGenericType89'):
        assert _is_linked(b1, 'ecoreDiff_EGenericType89', a)
    _safe_set(a, 'ecoreDiff_ETypedElement88', b2)
    assert _is_linked(a, 'ecoreDiff_ETypedElement88', b2)
    if hasattr(b1, 'ecoreDiff_EGenericType89'):
        assert not _is_linked(b1, 'ecoreDiff_EGenericType89', a)
    if hasattr(b2, 'ecoreDiff_EGenericType89'):
        assert _is_linked(b2, 'ecoreDiff_EGenericType89', a)
    _safe_set(a, 'ecoreDiff_ETypedElement88', None)
    assert not _is_linked(a, 'ecoreDiff_ETypedElement88', b2)
    if hasattr(b2, 'ecoreDiff_EGenericType89'):
        assert not _is_linked(b2, 'ecoreDiff_EGenericType89', a)
...
def test_assoc_eKeys102_link_reassign_clear():
    ...
    b1 = ecoreDiff_EAttribute(iD=True)
    b2 = ecoreDiff_EAttribute(iD=False)
    _safe_set(a, 'ecoreDiff_EReference103', {b1})
    assert _is_linked(a, 'ecoreDiff_EReference103', b1)
    if hasattr(b1, 'ecoreDiff_EAttribute104'):
        assert _is_linked(b1, 'ecoreDiff_EAttribute104', a)
    _safe_set(a, 'ecoreDiff_EReference103', {b2})
    assert _is_linked(a, 'ecoreDiff_EReference103', b2)
    if hasattr(b1, 'ecoreDiff_EAttribute104'):
        assert not _is_linked(b1, 'ecoreDiff_EAttribute104', a)
    if hasattr(b2, 'ecoreDiff_EAttribute104'):
        assert _is_linked(b2, 'ecoreDiff_EAttribute104', a)
    _safe_set(a, 'ecoreDiff_EReference103', set())
    assert not _is_linked(a, 'ecoreDiff_EReference103', b2)
    if hasattr(b2, 'ecoreDiff_EAttribute104'):
        assert not _is_linked(b2, 'ecoreDiff_EAttribute104', a)
...
def test_assoc_eOpposite97_link_reassign_clear():
    ...
    _safe_set(a, 'ecoreDiff_EReference96', b1)
    assert _is_linked(a, 'ecoreDiff_EReference96', b1)
    if hasattr(b1, 'ecoreDiff_EReference98'):
        assert _is_linked(b1, 'ecoreDiff_EReference98', a)
    _safe_set(a, 'ecoreDiff_EReference96', b2)
    assert _is_linked(a, 'ecoreDiff_EReference96', b2)
    if hasattr(b1, 'ecoreDiff_EReference98'):
        assert not _is_linked(b1, 'ecoreDiff_EReference98', a)
    if hasattr(b2, 'ecoreDiff_EReference98'):
        assert _is_linked(b2, 'ecoreDiff_EReference98', a)
    _safe_set(a, 'ecoreDiff_EReference96', None)
    assert not _is_linked(a, 'ecoreDiff_EReference96', b2)
    if hasattr(b2, 'ecoreDiff_EReference98'):
        assert not _is_linked(b2, 'ecoreDiff_EReference98', a)
...
def test_assoc_eReferenceType99_link_reassign_clear():
    ...
    if hasattr(b1, 'ecoreDiff_EClass101'):
        assert _is_linked(b1, 'ecoreDiff_EClass101', a)
    _safe_set(a, 'ecoreDiff_EReference100', b2)
    assert _is_linked(a, 'ecoreDiff_EReference100', b2)
    if hasattr(b1, 'ecoreDiff_EClass101'):
        assert not _is_linked(b1, 'ecoreDiff_EClass101', a)
    if hasattr(b2, 'ecoreDiff_EClass101'):
        assert _is_linked(b2, 'ecoreDiff_EClass101', a)
    _safe_set(a, 'ecoreDiff_EReference100', None)
    assert not _is_linked(a, 'ecoreDiff_EReference100', b2)
    if hasattr(b2, 'ecoreDiff_EClass101'):
        assert not _is_linked(b2, 'ecoreDiff_EClass101', a)
...
def test_assoc_eType85_link_reassign_clear():
    ...
    if hasattr(b1, 'ecoreDiff_EObject86'):
        assert _is_linked(b1, 'ecoreDiff_EObject86', a)
    _safe_set(a, 'ecoreDiff_ETypedElement', b2)
    assert _is_linked(a, 'ecoreDiff_ETypedElement', b2)
    if hasattr(b1, 'ecoreDiff_EObject86'):
        assert not _is_linked(b1, 'ecoreDiff_EObject86', a)
    if hasattr(b2, 'ecoreDiff_EObject86'):
        assert _is_linked(b2, 'ecoreDiff_EObject86', a)
    _safe_set(a, 'ecoreDiff_ETypedElement', None)
    assert not _is_linked(a, 'ecoreDiff_ETypedElement', b2)
    if hasattr(b2, 'ecoreDiff_EObject86'):
        assert not _is_linked(b2, 'ecoreDiff_EObject86', a)
...
def test_assoc_updatedElement111_link_reassign_clear():
    a = ecoreDiff_EAnnotation(source="sample_text")
    b1 = ecoreDiff_ChangedEAnnotation()
    b2 = ecoreDiff_ChangedEAnnotation()
    _safe_set(a, 'ecoreDiff_EAnnotation112', b1)
    assert _is_linked(a, 'ecoreDiff_EAnnotation112', b1)
    if hasattr(b1, 'ecoreDiff_ChangedEAnnotation'):
        assert _is_linked(b1, 'ecoreDiff_ChangedEAnnotation', a)
    _safe_set(a, 'ecoreDiff_EAnnotation112', b2)
    assert _is_linked(a, 'ecoreDiff_EAnnotation112', b2)
    if hasattr(b1, 'ecoreDiff_ChangedEAnnotation'):
    ...
    _safe_set(a, 'ecoreDiff_EAnnotation112', None)
    assert not _is_linked(a, 'ecoreDiff_EAnnotation112', b2)
    if hasattr(b2, 'ecoreDiff_ChangedEAnnotation'):
        assert not _is_linked(b2, 'ecoreDiff_ChangedEAnnotation', a)


def test_assoc_updatedElement118_link_reassign_clear():
    a = ecoreDiff_EStringToStringMapEntry(key="sample_text", value="sample_text")
    b1 = ecoreDiff_ChangedEStringToStringMapEntry()
    b2 = ecoreDiff_ChangedEStringToStringMapEntry()
    _safe_set(a, 'ecoreDiff_EStringToStringMapEntry119', b1)
    assert _is_linked(a, 'ecoreDiff_EStringToStringMapEntry119', b1)
    if hasattr(b1, 'ecoreDiff_ChangedEStringToStringMapEntry'):
        assert _is_linked(b1, 'ecoreDiff_ChangedEStringToStringMapEntry', a)
    _safe_set(a, 'ecoreDiff_EStringToStringMapEntry119', b2)
    assert _is_linked(a, 'ecoreDiff_EStringToStringMapEntry119', b2)
    if hasattr(b1, 'ecoreDiff_ChangedEStringToStringMapEntry'):
    ...
    _safe_set(a, 'ecoreDiff_EStringToStringMapEntry119', None)
    assert not _is_linked(a, 'ecoreDiff_EStringToStringMapEntry119', b2)
    if hasattr(b2, 'ecoreDiff_ChangedEStringToStringMapEntry'):
        assert not _is_linked(b2, 'ecoreDiff_ChangedEStringToStringMapEntry', a)


def test_assoc_updatedElement132_link_reassign_clear():
    a = ecoreDiff_EClass(abstract=True, interface=True)
    b1 = ecoreDiff_ChangedEClass()
    b2 = ecoreDiff_ChangedEClass()
    _safe_set(a, 'ecoreDiff_EClass133', b1)
    assert _is_linked(a, 'ecoreDiff_EClass133', b1)
    if hasattr(b1, 'ecoreDiff_ChangedEClass'):
        assert _is_linked(b1, 'ecoreDiff_ChangedEClass', a)
    _safe_set(a, 'ecoreDiff_EClass133', b2)
    assert _is_linked(a, 'ecoreDiff_EClass133', b2)
    if hasattr(b1, 'ecoreDiff_ChangedEClass'):
    ...
    _safe_set(a, 'ecoreDiff_EClass133', None)
    assert not _is_linked(a, 'ecoreDiff_EClass133', b2)
    if hasattr(b2, 'ecoreDiff_ChangedEClass'):
...
def test_assoc_updatedElement139_link_reassign_clear():
    ...
    _safe_set(a, 'ecoreDiff_EClassifier140', b1)
    assert _is_linked(a, 'ecoreDiff_EClassifier140', b1)
    if hasattr(b1, 'ecoreDiff_ChangedEClassifier'):
        assert _is_linked(b1, 'ecoreDiff_ChangedEClassifier', a)
    _safe_set(a, 'ecoreDiff_EClassifier140', b2)
    assert _is_linked(a, 'ecoreDiff_EClassifier140', b2)
    if hasattr(b1, 'ecoreDiff_ChangedEClassifier'):
    ...
    _safe_set(a, 'ecoreDiff_EClassifier140', None)
    assert not _is_linked(a, 'ecoreDiff_EClassifier140', b2)
    if hasattr(b2, 'ecoreDiff_ChangedEClassifier'):
        assert not _is_linked(b2, 'ecoreDiff_ChangedEClassifier', a)


def test_assoc_updatedElement146_link_reassign_clear():
...
def test_assoc_updatedElement152_link_reassign_clear():
    a = ecoreDiff_EPackage(nsPrefix="sample_text", nsURI="sample_text")
...
def test_assoc_updatedElement164_link_reassign_clear():
    a = ecoreDiff_EDataType(serializable=True)
    b1 = ecoreDiff_ChangedEDataType()
    b2 = ecoreDiff_ChangedEDataType()
    _safe_set(a, 'ecoreDiff_EDataType165', b1)
    assert _is_linked(a, 'ecoreDiff_EDataType165', b1)
    if hasattr(b1, 'ecoreDiff_ChangedEDataType'):
        assert _is_linked(b1, 'ecoreDiff_ChangedEDataType', a)
    _safe_set(a, 'ecoreDiff_EDataType165', b2)
    assert _is_linked(a, 'ecoreDiff_EDataType165', b2)
    if hasattr(b1, 'ecoreDiff_ChangedEDataType'):
    ...
    _safe_set(a, 'ecoreDiff_EDataType165', None)
    assert not _is_linked(a, 'ecoreDiff_EDataType165', b2)
    if hasattr(b2, 'ecoreDiff_ChangedEDataType'):
        assert not _is_linked(b2, 'ecoreDiff_ChangedEDataType', a)


def test_assoc_updatedElement198_link_reassign_clear():
    a = ecoreDiff_ETypedElement(lowerBound=7, many=True, ordered=True, required=True, unique=True, upperBound=7)
    b1 = ecoreDiff_ChangedETypedElement()
    b2 = ecoreDiff_ChangedETypedElement()
    _safe_set(a, 'ecoreDiff_ETypedElement199', b1)
    assert _is_linked(a, 'ecoreDiff_ETypedElement199', b1)
    if hasattr(b1, 'ecoreDiff_ChangedETypedElement'):
        assert _is_linked(b1, 'ecoreDiff_ChangedETypedElement', a)
    _safe_set(a, 'ecoreDiff_ETypedElement199', b2)
    assert _is_linked(a, 'ecoreDiff_ETypedElement199', b2)
    if hasattr(b1, 'ecoreDiff_ChangedETypedElement'):
    ...
    _safe_set(a, 'ecoreDiff_ETypedElement199', None)
    assert not _is_linked(a, 'ecoreDiff_ETypedElement199', b2)
    if hasattr(b2, 'ecoreDiff_ChangedETypedElement'):
        assert not _is_linked(b2, 'ecoreDiff_ChangedETypedElement', a)


def test_assoc_updatedElement211_link_reassign_clear():
    a = ecoreDiff_EAttribute(iD=True)
    b1 = ecoreDiff_ChangedEAttribute()
    b2 = ecoreDiff_ChangedEAttribute()
    _safe_set(a, 'ecoreDiff_EAttribute212', b1)
    assert _is_linked(a, 'ecoreDiff_EAttribute212', b1)
    if hasattr(b1, 'ecoreDiff_ChangedEAttribute'):
        assert _is_linked(b1, 'ecoreDiff_ChangedEAttribute', a)
    _safe_set(a, 'ecoreDiff_EAttribute212', b2)
    assert _is_linked(a, 'ecoreDiff_EAttribute212', b2)
    if hasattr(b1, 'ecoreDiff_ChangedEAttribute'):
    ...
    _safe_set(a, 'ecoreDiff_EAttribute212', None)
    assert not _is_linked(a, 'ecoreDiff_EAttribute212', b2)
    if hasattr(b2, 'ecoreDiff_ChangedEAttribute'):
        assert not _is_linked(b2, 'ecoreDiff_ChangedEAttribute', a)


def test_assoc_updatedElement218_link_reassign_clear():
    a = ecoreDiff_EStructuralFeature(changeable=True, defaultValue="sample_text", defaultValueLiteral="sample_text", derived=True, transient=True, unsettable=True, volatile=True)
    b1 = ecoreDiff_ChangedEStructuralFeature()
    b2 = ecoreDiff_ChangedEStructuralFeature()
    _safe_set(a, 'ecoreDiff_EStructuralFeature219', b1)
    assert _is_linked(a, 'ecoreDiff_EStructuralFeature219', b1)
    if hasattr(b1, 'ecoreDiff_ChangedEStructuralFeature'):
        assert _is_linked(b1, 'ecoreDiff_ChangedEStructuralFeature', a)
    _safe_set(a, 'ecoreDiff_EStructuralFeature219', b2)
    assert _is_linked(a, 'ecoreDiff_EStructuralFeature219', b2)
    if hasattr(b1, 'ecoreDiff_ChangedEStructuralFeature'):
    ...
    _safe_set(a, 'ecoreDiff_EStructuralFeature219', None)
    assert not _is_linked(a, 'ecoreDiff_EStructuralFeature219', b2)
    if hasattr(b2, 'ecoreDiff_ChangedEStructuralFeature'):
        assert not _is_linked(b2, 'ecoreDiff_ChangedEStructuralFeature', a)


def test_assoc_updatedElement231_link_reassign_clear():
    a = ecoreDiff_EReference(container=True, containment=True, resolveProxies=True)
    b1 = ecoreDiff_ChangedEReference()
    b2 = ecoreDiff_ChangedEReference()
    _safe_set(a, 'ecoreDiff_EReference232', b1)
    assert _is_linked(a, 'ecoreDiff_EReference232', b1)
    if hasattr(b1, 'ecoreDiff_ChangedEReference'):
        assert _is_linked(b1, 'ecoreDiff_ChangedEReference', a)
    _safe_set(a, 'ecoreDiff_EReference232', b2)
    assert _is_linked(a, 'ecoreDiff_EReference232', b2)
    if hasattr(b1, 'ecoreDiff_ChangedEReference'):
    ...
    _safe_set(a, 'ecoreDiff_EReference232', None)
    assert not _is_linked(a, 'ecoreDiff_EReference232', b2)
    if hasattr(b2, 'ecoreDiff_ChangedEReference'):
        assert not _is_linked(b2, 'ecoreDiff_ChangedEReference', a)


def test_assoc_updatedElement244_link_reassign_clear():
    a = ecoreDiff_EEnumLiteral(instance="sample_text", literal="sample_text", value=7)
...
ecoreDiff_ETypedElement_strategy = st.builds(ecoreDiff_ETypedElement, lowerBound=st.integers(), many=st.booleans(), ordered=st.booleans(), required=st.booleans(), unique=st.booleans(), upperBound=st.integers())
@given(instance=ecoreDiff_ETypedElement_strategy)
@settings(max_examples=25)
