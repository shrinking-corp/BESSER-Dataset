...
def test_hyp_pedido_exame_is_not_abstract():
    assert not inspect.isabstract(Pedido_Exame)


def test_hyp_pedido_exame_constructor_exists():
    assert callable(Pedido_Exame.__init__)


def test_hyp_pedido_exame_constructor_args():
...
def test_hyp_uf_is_not_abstract():
    assert not inspect.isabstract(UF)


def test_hyp_uf_constructor_exists():
    assert callable(UF.__init__)


def test_hyp_uf_constructor_args():
...
def test_hyp_cidade_is_not_abstract():
    assert not inspect.isabstract(Cidade)


def test_hyp_cidade_constructor_exists():
    assert callable(Cidade.__init__)


def test_hyp_cidade_constructor_args():
...
@given(instance=Exame_strategy)
def test_hyp_exame_valor_setter(instance):
...
@given(instance=Exame_strategy)
def test_hyp_exame_procedimentos_setter(instance):
...
def test_hyp_pedido_exame_codigo_setter(instance):
    original = instance.codigo
    instance.codigo = original
    assert instance.codigo == original
...
def test_hyp_uf_nome_setter(instance):
    original = instance.nome
    instance.nome = original
    assert instance.nome == original
...
@given(instance=UF_strategy)
def test_hyp_uf_sigla_setter(instance):
...
def test_hyp_cidade_ddd_setter(instance):
...
@given(instance=Cidade_strategy)
def test_hyp_cidade_codigo_setter(instance):
    original = instance.codigo
    instance.codigo = original
    assert instance.codigo == original
...
@given(instance=Cidade_strategy)
def test_hyp_cidade_nome_setter(instance):
    original = instance.nome
    instance.nome = original
    assert instance.nome == original
...
@given(instance=Paciente_strategy)
def test_hyp_paciente_codigo_setter(instance):
    original = instance.codigo
    instance.codigo = original
    assert instance.codigo == original
