...
class Widget:
    ...
    pass
class model_CrossOut(SkinSupport, AnnotationSupport, Widget, ColorAlphaSupport, ColorForegroundSupport):

    pass
class model_DateField(SkinSupport, ColorBorderSupport, Widget, ColorBackgroundSupport, ColorAlphaSupport, StateSupport):

    pass
class model_VButtonBar(SkinSupport, TextAlignmentSupport, Widget, ColorBackgroundSupport, FontSupport, ItemSupport, SelectionSupport):

    pass
class model_Tabs(SkinSupport, Widget, FontSupport, ItemSupport, SelectionSupport):

    pass
class model_Window(SkinSupport, Widget, ColorBackgroundSupport, VerticalScrollbarSupport, ColorAlphaSupport):
...
class model_Callout(SkinSupport, LinkSupport, AnnotationSupport, Widget, ColorBackgroundSupport, FontSupport, ColorAlphaSupport):

    pass
class model_Link(SkinSupport, LinkSupport, Widget, FontSupport, StateSupport):

    pass
class model_HSplitter(SkinSupport, Widget):

    pass
class model_Checkbox(SkinSupport, LinkSupport, Widget, FontSupport, StateSupport, BooleanSelectionSupport):

    pass
class model_Tree(BorderSupport, Widget, ColorBackgroundSupport, VerticalScrollbarSupport, FontSupport, ColorAlphaSupport, ItemSupport, SelectionSupport):

    pass
class model_VSlider(ValueSupport, SkinSupport, Widget, ColorBackgroundSupport, StateSupport):
...
class model_VLine(SkinSupport, Widget, LineStyleSupport, ColorForegroundSupport):
    ...
    pass
class model_ScratchOut(SkinSupport, AnnotationSupport, Widget, ColorForegroundSupport, ColorAlphaSupport):

    pass
class model_LinkBar(SkinSupport, Widget, FontSupport, ItemSupport, SelectionSupport):

    pass
class model_List(ListSupport, BorderSupport, ColorAlternativeSupport, Widget, ColorBackgroundSupport, VerticalScrollbarSupport, FontSupport, ColorAlphaSupport, ItemSupport, SelectionSupport):
...
class model_CurlyBrace(SkinSupport, TextLinksSupport, AnnotationSupport, Widget, FontSupport, ColorForegroundSupport):
...
class model_CoverFlow(Widget, SkinSupport):
    ...
    pass
class model_Rectangle(TextAlignmentSupport, BorderStyleSupport, LinkSupport, IconPositionSupport, ColorBackgroundSupport, Widget, FontSupport, ColorForegroundSupport, ColorAlphaSupport, IconSupport):

    pass
class model_Table(TextLinksSupport, TextAlignmentSupport, ListSupport, BorderSupport, ColorAlternativeSupport, DoubleClickSupport, TextInputSupport, Widget, VerticalScrollbarSupport, ColorBackgroundSupport, FontSupport, ClickSupport, ColorAlphaSupport, SelectionSupport):
...
class model_Placeholder(Widget, SkinSupport, LinkSupport):

    pass
class model_Tooltip(SkinSupport, TextLinksSupport, TextAlignmentSupport, Widget, ColorBackgroundSupport, FontSupport):
...
class model_Hotspot(Widget, LinkSupport):
    ...
    pass
class model_ProgressBar(Widget, SkinSupport, ValueSupport, ColorBackgroundSupport):

    pass
class model_Text(TextAlignmentSupport, TextLinksSupport, LineHeightSupport, LinkSupport, Widget, FontSupport, ColorForegroundSupport):
...
class model_HSlider(ValueSupport, SkinSupport, Widget, ColorBackgroundSupport, StateSupport):

    pass
class model_Shape(SkinSupport, TextAlignmentSupport, RotationSupport, LineStyleSupport, LinkSupport, BorderSupport, IconPositionSupport, ColorBackgroundSupport, Widget, FontSupport, ColorAlphaSupport, ColorForegroundSupport, IconSupport):
...
class model_ButtonBar(SkinSupport, Widget, ColorBackgroundSupport, FontSupport, ItemSupport, SelectionSupport):

    pass
class model_Circle(TextAlignmentSupport, LineStyleSupport, BorderSupport, LinkSupport, IconPositionSupport, Widget, ColorBackgroundSupport, FontSupport, ColorForegroundSupport, ColorAlphaSupport, IconSupport):

    pass
class model_Arrow(Widget, LineStyleSupport, ColorForegroundSupport, AnnotationSupport):
...
class model_Area(Widget):
    ...
    pass
class model_Label(TextLinksSupport, RotationSupport, TextAlignmentSupport, LinkSupport, IconPositionSupport, Widget, FontSupport, ColorForegroundSupport, StateSupport, IconSupport):
...
class model_Map(Widget, SkinSupport):
    ...
    pass
class model_HLine(Widget, SkinSupport, LineStyleSupport, ColorForegroundSupport):

    pass
class model_SearchField(SkinSupport, LinkSupport, ColorBorderSupport, Widget, FontSupport, StateSupport):

    pass
class model_Group(SkinSupport, Widget, VerticalScrollbarSupport, ColorBackgroundSupport, FontSupport, ColorAlphaSupport):

    pass
class model_Browser(SkinSupport, Widget, VerticalScrollbarSupport, ColorBackgroundSupport, FontSupport, ColorAlphaSupport):

    pass
class model_Accordion(Widget, VerticalScrollbarSupport, FontSupport, ItemSupport, SelectionSupport):

    pass
class model_Icon(Widget, LinkSupport, IconSupport, ColorForegroundSupport):

    pass
class model_TextField(SkinSupport, TextAlignmentSupport, TextInputSupport, ColorBorderSupport, Widget, ColorBackgroundSupport, FontSupport, ColorAlphaSupport, StateSupport):
...
class model_Menu(SkinSupport, Widget, IconSupport, SelectionSupport, ItemSupport):

    pass
class model_Panel(SkinSupport, BorderStyleSupport, LinkSupport, Widget, ColorBackgroundSupport, VerticalScrollbarSupport, ColorAlphaSupport, ColorForegroundSupport):

    pass
class model_Switch(SkinSupport, LinkSupport, Widget, ColorBackgroundSupport, FontSupport, StateSupport, BooleanSelectionSupport):

    pass
class model_Combo(SkinSupport, LinkSupport, ColorBorderSupport, Widget, ColorBackgroundSupport, FontSupport, ColorAlphaSupport, StateSupport, SelectionSupport):

    pass
class model_Alert(SkinSupport, Widget, FontSupport, IconSupport, ItemSupport):

    pass
class model_VScrollbar(Widget, SkinSupport, ValueSupport):
...
class model_TabbedPane(SkinSupport, Widget, VerticalScrollbarSupport, ColorBackgroundSupport, FontSupport, ColorAlphaSupport, ItemSupport, SelectionSupport):
...
class model_Note(SkinSupport, TextLinksSupport, TextAlignmentSupport, LinkSupport, AnnotationSupport, Widget, ColorBackgroundSupport, FontSupport, ColorAlphaSupport):

    pass
class model_SVGImage(RotationSupport, LinkSupport, Widget, ColorBackgroundSupport, FlipSupport, ColorAlphaSupport, ColorForegroundSupport):
...
class model_VideoPlayer(Widget, SkinSupport):
    ...
    pass
class model_TextArea(SkinSupport, TextAlignmentSupport, TextLinksSupport, LineHeightSupport, ColorBorderSupport, Widget, VerticalScrollbarSupport, ColorBackgroundSupport, FontSupport, ColorAlphaSupport, StateSupport):

    pass
class model_ColorPicker(SkinSupport, ColorBackgroundSupport, Widget):

    pass
class model_Spinner(SkinSupport, ColorBorderSupport, Widget, ColorBackgroundSupport, FontSupport, ColorAlphaSupport, StateSupport):

    pass
class model_Image(RotationSupport, LinkSupport, BorderSupport, Widget, FlipSupport):
...
class model_RadioButton(SkinSupport, LinkSupport, Widget, FontSupport, StateSupport, BooleanSelectionSupport):

    pass
class model_Button(SkinSupport, TextAlignmentSupport, LinkSupport, Widget, ColorBackgroundSupport, FontSupport, ClickSupport, StateSupport, IconSupport):
...
class VisibleSupport:
    ...
    pass
class model_Item(VisibleSupport, LinkSupport, ClickSupport):
...
class NoteSupport:
    ...
    pass
class model_Widget(VisibleSupport, NoteSupport, NameSupport):

    def __init__(self, customData: str, annotation: bool, layoutParams: str, id: str, x: int, y: int, width: int, height: int, text: str, locked: bool, measuredWidth: int, measuredHeight: int, customId: str, widgets: "model_WidgetContainer" = None, model_Widget: "model_WidgetDescriptor" = None, Widget: "model_WidgetContainer" = None):
...
class WidgetContainer:
    ...
    pass
class model_WidgetGroup(Widget, LinkSupport, NameSupport, WidgetContainer):

    pass
class model_Screen(NoteSupport, NameSupport, WidgetContainer):
