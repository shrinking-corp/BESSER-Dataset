...
# Classes
model_Screen = Class(name="model_Screen")
WidgetContainer = Class(name="WidgetContainer")
NoteSupport = Class(name="NoteSupport")
NameSupport = Class(name="NameSupport")
model_ScreenRuler = Class(name="model_ScreenRuler")
model_ScreenFont = Class(name="model_ScreenFont")
model_RulerGuide = Class(name="model_RulerGuide")
model_Widget = Class(name="model_Widget", is_abstract=True)
VisibleSupport = Class(name="VisibleSupport")
model_WidgetContainer = Class(name="model_WidgetContainer", is_abstract=True)
model_WidgetDescriptor = Class(name="model_WidgetDescriptor")
model_Button = Class(name="model_Button")
...
model_Checkbox = Class(name="model_Checkbox")
BooleanSelectionSupport = Class(name="BooleanSelectionSupport")
model_Combo = Class(name="model_Combo")
...
model_Label = Class(name="model_Label")
...
model_Placeholder = Class(name="model_Placeholder")
model_RadioButton = Class(name="model_RadioButton")
model_TextField = Class(name="model_TextField")
TextInputSupport = Class(name="TextInputSupport")
model_Spinner = Class(name="model_Spinner")
model_Window = Class(name="model_Window")
VerticalScrollbarSupport = Class(name="VerticalScrollbarSupport")
model_Browser = Class(name="model_Browser")
model_Text = Class(name="model_Text")
LineHeightSupport = Class(name="LineHeightSupport")
model_Area = Class(name="model_Area")
model_Panel = Class(name="model_Panel")
BorderStyleSupport = Class(name="BorderStyleSupport")
model_Group = Class(name="model_Group")
model_Icon = Class(name="model_Icon")
model_List = Class(name="model_List")
...
model_Popup = Class(name="model_Popup")
model_Menu = Class(name="model_Menu")
model_Table = Class(name="model_Table")
DoubleClickSupport = Class(name="DoubleClickSupport")
model_Tree = Class(name="model_Tree")
model_TextArea = Class(name="model_TextArea")
model_HScrollbar = Class(name="model_HScrollbar")
ValueSupport = Class(name="ValueSupport")
model_VScrollbar = Class(name="model_VScrollbar")
model_HLine = Class(name="model_HLine")
LineStyleSupport = Class(name="LineStyleSupport")
model_VLine = Class(name="model_VLine")
model_HSlider = Class(name="model_HSlider")
model_VSlider = Class(name="model_VSlider")
model_Tabs = Class(name="model_Tabs")
model_Image = Class(name="model_Image")
model_Font = Class(name="model_Font")
model_WidgetGroup = Class(name="model_WidgetGroup")
model_Master = Class(name="model_Master")
Overrides = Class(name="Overrides")
model_TextAlignmentSupport = Class(name="model_TextAlignmentSupport", is_abstract=True)
model_BooleanSelectionSupport = Class(name="model_BooleanSelectionSupport", is_abstract=True)
FlipSupport = Class(name="FlipSupport")
model_FontSupport = Class(name="model_FontSupport", is_abstract=True)
model_ColorForegroundSupport = Class(name="model_ColorForegroundSupport", is_abstract=True)
model_ColorBackgroundSupport = Class(name="model_ColorBackgroundSupport", is_abstract=True)
model_ColorBorderSupport = Class(name="model_ColorBorderSupport", is_abstract=True)
model_ColorAlphaSupport = Class(name="model_ColorAlphaSupport", is_abstract=True)
model_SelectionSupport = Class(name="model_SelectionSupport", is_abstract=True)
model_ScratchOut = Class(name="model_ScratchOut")
model_Note = Class(name="model_Note")
AnnotationSupport = Class(name="AnnotationSupport")
model_ProgressBar = Class(name="model_ProgressBar")
model_Callout = Class(name="model_Callout")
model_SearchField = Class(name="model_SearchField")
model_LinkBar = Class(name="model_LinkBar")
model_Tooltip = Class(name="model_Tooltip")
model_BorderSupport = Class(name="model_BorderSupport", is_abstract=True)
model_StateSupport = Class(name="model_StateSupport", is_abstract=True)
model_Breadcrumbs = Class(name="model_Breadcrumbs")
model_Accordion = Class(name="model_Accordion")
model_VerticalScrollbarSupport = Class(name="model_VerticalScrollbarSupport", is_abstract=True)
model_DateField = Class(name="model_DateField")
model_VideoPlayer = Class(name="model_VideoPlayer")
model_Map = Class(name="model_Map")
model_CoverFlow = Class(name="model_CoverFlow")
model_TabbedPane = Class(name="model_TabbedPane")
model_IconSupport = Class(name="model_IconSupport", is_abstract=True)
model_HSplitter = Class(name="model_HSplitter")
model_VSplitter = Class(name="model_VSplitter")
model_ValueSupport = Class(name="model_ValueSupport", is_abstract=True)
model_ColorPicker = Class(name="model_ColorPicker")
model_Arrow = Class(name="model_Arrow")
model_CurlyBrace = Class(name="model_CurlyBrace")
model_ButtonBar = Class(name="model_ButtonBar")
model_BorderStyleSupport = Class(name="model_BorderStyleSupport", is_abstract=True)
model_Circle = Class(name="model_Circle")
model_Rectangle = Class(name="model_Rectangle")
model_IconPositionSupport = Class(name="model_IconPositionSupport", is_abstract=True)
model_ListSupport = Class(name="model_ListSupport", is_abstract=True)
model_Chart = Class(name="model_Chart")
model_CrossOut = Class(name="model_CrossOut")
model_Item = Class(name="model_Item")
model_ItemSupport = Class(name="model_ItemSupport", is_abstract=True)
model_LinkSupport = Class(name="model_LinkSupport", is_abstract=True)
model_Hotspot = Class(name="model_Hotspot")
model_NameSupport = Class(name="model_NameSupport", is_abstract=True)
model_ColorAlternativeSupport = Class(name="model_ColorAlternativeSupport", is_abstract=True)
model_LineStyleSupport = Class(name="model_LineStyleSupport", is_abstract=True)
model_RotationSupport = Class(name="model_RotationSupport", is_abstract=True)
model_FlipSupport = Class(name="model_FlipSupport", is_abstract=True)
model_SVGImage = Class(name="model_SVGImage")
model_Alert = Class(name="model_Alert")
model_SkinSupport = Class(name="model_SkinSupport", is_abstract=True)
model_Shape = Class(name="model_Shape")
model_story_Storyboard = Class(name="model_story_Storyboard")
model_Switch = Class(name="model_Switch")
model_LineHeightSupport = Class(name="model_LineHeightSupport", is_abstract=True)
model_ClickSupport = Class(name="model_ClickSupport")
model_TextInputSupport = Class(name="model_TextInputSupport")
model_DoubleClickSupport = Class(name="model_DoubleClickSupport", is_abstract=True)
model_VisibleSupport = Class(name="model_VisibleSupport", is_abstract=True)
model_Frame = Class(name="model_Frame")
Panel = Class(name="Panel")
model_VButtonBar = Class(name="model_VButtonBar")
model_AnnotationSupport = Class(name="model_AnnotationSupport", is_abstract=True)
model_TextLinksSupport = Class(name="model_TextLinksSupport", is_abstract=True)
model_NoteSupport = Class(name="model_NoteSupport", is_abstract=True)
model_story_Panel = Class(name="model_story_Panel")
story_model_Screen = Class(name="story_model_Screen")
Storyboard = Class(name="Storyboard")
model_overrides_Overrides = Class(name="model_overrides_Overrides")
WidgetContainerOverrides = Class(name="WidgetContainerOverrides")
WidgetOverrides = Class(name="WidgetOverrides")
model_overrides_WidgetOverrides = Class(name="model_overrides_WidgetOverrides")
overrides_WidgetContainerOverrides = Class(name="overrides_WidgetContainerOverrides")
overrides_Reference = Class(name="overrides_Reference")
overrides_Operation = Class(name="overrides_Operation")
model_overrides_Delete = Class(name="model_overrides_Delete")
...
model_overrides_FontOverrides = Class(name="model_overrides_FontOverrides")
model_overrides_ItemOverrides = Class(name="model_overrides_ItemOverrides")
Reference = Class(name="Reference")
model_overrides_StringToStringMap = Class(name="model_overrides_StringToStringMap")
model_overrides_Operation = Class(name="model_overrides_Operation", is_abstract=True)
model_overrides_Move = Class(name="model_overrides_Move")
model_overrides_Insert = Class(name="model_overrides_Insert")
overrides_model_EObject = Class(name="overrides_model_EObject")
model_overrides_Reference = Class(name="model_overrides_Reference", is_abstract=True)
model_overrides_WidgetContainerOverrides = Class(name="model_overrides_WidgetContainerOverrides", is_abstract=True)
...
model_Screen.attributes={model_Screen_minVersion, model_Screen_theme}
...
model_ScreenFont.attributes={model_ScreenFont_bold, model_ScreenFont_size, model_ScreenFont_available, model_ScreenFont_name, model_ScreenFont_italic}
...
model_Widget.attributes={model_Widget_annotation, model_Widget_text, model_Widget_height, model_Widget_y, model_Widget_id, model_Widget_x, model_Widget_width, model_Widget_locked, model_Widget_measuredWidth, model_Widget_customId, model_Widget_customData, model_Widget_layoutParams, model_Widget_measuredHeight}
...
model_WidgetDescriptor.attributes={model_WidgetDescriptor_typeName, model_WidgetDescriptor_textWrappable, model_WidgetDescriptor_textEditable, model_WidgetDescriptor_resizeMode, model_WidgetDescriptor_textLines, model_WidgetDescriptor_textCentered}
...
model_Window.attributes={model_Window_closeButton, model_Window_minimizeButton, model_Window_maximizeButton}
...
model_Table.attributes={model_Table_header, model_Table_verticalLines}
...
model_Font.attributes={model_Font_bold, model_Font_italic, model_Font_underline, model_Font_size}
...
model_StateSupport_m_isValidState: Method = Method(name="isValidState", parameters={Parameter(name='model_state', type=StringType)}, type=BooleanType)
...
model_Arrow.attributes={model_Arrow_left, model_Arrow_right, model_Arrow_direction}
...
model_ListSupport.attributes={model_ListSupport_horizontalLines, model_ListSupport_rowHeight}
...
model_Item.attributes={model_Item_y, model_Item_x, model_Item_height, model_Item_text, model_Item_width}
...
model_overrides_WidgetOverrides.attributes={model_overrides_WidgetOverrides_link, model_overrides_WidgetOverrides_src, model_overrides_WidgetOverrides_noText, model_overrides_WidgetOverrides_height, model_overrides_WidgetOverrides_noLink, model_overrides_WidgetOverrides_y, model_overrides_WidgetOverrides_text, model_overrides_WidgetOverrides_width, model_overrides_WidgetOverrides_x}
...
model_overrides_FontOverrides.attributes={model_overrides_FontOverrides_italic, model_overrides_FontOverrides_bold, model_overrides_FontOverrides_size, model_overrides_FontOverrides_underline}
