...
# Classes
dml_D = Class(name="dml_D")
dml_F = Class(name="dml_F")
dml_S = Class(name="dml_S")
dml_ID = Class(name="dml_ID")
dml_PL = Class(name="dml_PL")
dml_SPKV = Class(name="dml_SPKV")
dml_E = Class(name="dml_E")
dml_BS = Class(name="dml_BS")
dml_FP = Class(name="dml_FP")
dml_PARFORPARAMS = Class(name="dml_PARFORPARAMS")
dml_DI = Class(name="dml_DI")
dml_FC = Class(name="dml_FC")
dml_PE = Class(name="dml_PE")
dml_IS = Class(name="dml_IS")
dml_TAN = Class(name="dml_TAN")
dml_EObject = Class(name="dml_EObject")
dml_TE = Class(name="dml_TE")
...
dml_TE.attributes={dml_TE_d, dml_TE_i, dml_TE_b, dml_TE_s}
...
is_20: BinaryAssociation = BinaryAssociation(
    name="is_20",
    ends={
...
is_62: BinaryAssociation = BinaryAssociation(
    name="is_62",
    ends={
...
domain_model = DomainModel(
    name="dml",
    types={dml_D, dml_F, dml_S, dml_ID, dml_PL, dml_SPKV, dml_E, dml_BS, dml_FP, dml_PARFORPARAMS, dml_DI, dml_FC, dml_PE, dml_IS, dml_TAN, dml_EObject, dml_TE},
    associations={f0, s1, name3, i5, r7, s10, spkv13, srcid15, ife18, is_20, es22, fp25, p27, s29, pf32, we35, di38, fc40, lhsdi42, e45, id48, pe51, singleS53, s56, id59, is_62, id64, b67, e70, e173, e276, t79, t181, t284, e86, f88, di91, k94, id97, e100, name103},
    generalizations={},
    metadata=None
)
