...
public class Docbook_MediaobjectType  {
    ...
    private Docbook_FigureType docbook_figuretype;




    private Docbook_ImageobjectType docbook_imageobjecttype;
    ...
    public Docbook_MediaobjectType(
    ) {
    }



    public Docbook_FigureType getDocbook_figuretype() {
        return docbook_figuretype;
    }

    public void setDocbook_figuretype(Docbook_FigureType docbook_figuretype) {
        this.docbook_figuretype = docbook_figuretype;
    }
    public Docbook_ImageobjectType getDocbook_imageobjecttype() {
        return docbook_imageobjecttype;
    }

    public void setDocbook_imageobjecttype(Docbook_ImageobjectType docbook_imageobjecttype) {
        this.docbook_imageobjecttype = docbook_imageobjecttype;
    }
