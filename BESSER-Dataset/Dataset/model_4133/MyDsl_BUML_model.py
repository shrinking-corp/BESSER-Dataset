...
# Classes
myDsl_Classs = Class(name="myDsl_Classs")
myDsl_Instance = Class(name="myDsl_Instance")
myDsl_Method = Class(name="myDsl_Method")
Instance = Class(name="Instance")
myDsl_Minus = Class(name="myDsl_Minus")
myDsl_Mult = Class(name="myDsl_Mult")
myDsl_Div = Class(name="myDsl_Div")
myDsl_Var = Class(name="myDsl_Var")
myDsl_Let = Class(name="myDsl_Let")
myDsl_Num = Class(name="myDsl_Num")
myDsl_Parameter = Class(name="myDsl_Parameter")
myDsl_MathExp = Class(name="myDsl_MathExp")
...
domain_model = DomainModel(
    name="myDsl",
    types={myDsl_Classs, myDsl_Instance, myDsl_Method, Instance, myDsl_Minus, myDsl_Mult, myDsl_Div, myDsl_Var, myDsl_Let, myDsl_Num, myDsl_Parameter, myDsl_MathExp, myDsl_Expression, myDsl_Plus, Expression},
    associations={instances0, left8, right10, left13, right15, left18, right20, binding23, body25, params1, exp2, left3, right5},
    generalizations={gen_myDsl_Minus_Expression, gen_myDsl_Mult_Expression, gen_myDsl_Div_Expression, gen_myDsl_Var_Expression, gen_myDsl_Let_Expression, gen_myDsl_Num_Expression, gen_myDsl_Method_Instance, gen_myDsl_MathExp_Instance, gen_myDsl_Plus_Expression},
    metadata=None
)
