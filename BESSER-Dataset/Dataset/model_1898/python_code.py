...
class emig_FilterMigrator(LocatedElement):
    ...
    def __init__(self, op: str, emig_FilterMigrator: "emig_MigratorSX" = None, emig_FilterMigrator60: "emig_MigratorDX" = None, emig_FilterMigrator64: "emig_DotNavigationObjSX" = None, emig_FilterMigrator66: "emig_DotNavigationObjDX" = None):
        self.op = op
...
class emig_MigrationProgram(LocatedElement):
    ...
    def __init__(self, migr: str, artifact: str, delta: str, name: str, libs: str, emig_MigrationProgram: "emig_MyModel" = None, emig_MigrationProgram6: "emig_Artifact" = None, emig_MigrationProgram8: set["emig_EPackage"] = None, emig_MigrationProgram10: set["emig_Rule"] = None):
        self.migr = migr
