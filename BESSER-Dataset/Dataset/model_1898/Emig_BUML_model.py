...
emig_LocatedElement = Class(name="emig_LocatedElement")
...
emig_MigrationProgram.attributes={emig_MigrationProgram_delta, emig_MigrationProgram_libs, emig_MigrationProgram_artifact, emig_MigrationProgram_migr, emig_MigrationProgram_name}
...
emig_LocatedElement.attributes={emig_LocatedElement_endoffset, emig_LocatedElement_endline, emig_LocatedElement_line, emig_LocatedElement_offset}
...
domain_model = DomainModel(
    name="emig",
    types={emig_MyModel, emig_MigrationLibrary, emig_MigrationProgram, emig_Rule, emig_LocatedElement, LocatedElement, emig_Artifact, emig_EPackage, emig_OpDef, emig_RewritingRule, emig_setterDef, emig_EPackageOpDef, OpDef, emig_EClassOpDef, emig_EClass, emig_EAttributeOpDef, emig_EReferenceOpDef, emig_EAttribute, emig_EReference, emig_EStructuralFeature, emig_Parameter, emig_MigratorSX, emig_MigratorDX, emig_Migrator, Migrator, emig_FilterMigrator, emig_DotNavigationObjSX, emig_DotNavigationObjDX, emig_EObject, emig_Package, EPackage, emig_Class, EClass, emig_Attribute, EAttribute, emig_Reference, EReference},
    associations={migrationLib0, MigrationProgr1, rules3, typeArt5, transformationPackage7, rules9, filter12, rewritingRules14, setters16, var18, ref20, classes23, var25, ref27, attributes30, references32, var34, ref36, var39, ref41, metafeature44, par46, migratorSX48, migratorDX49, elementSX51, filterSX53, rewritingRule55, elementDX56, filterDX58, rewritingRule61, featureSX63, value65, obj67, ref69, obj72, ref75},
    generalizations={gen_emig_MigrationProgram_LocatedElement, gen_emig_Artifact_LocatedElement, gen_emig_Rule_LocatedElement, gen_emig_OpDef_LocatedElement, gen_emig_EPackageOpDef_OpDef, gen_emig_EClassOpDef_OpDef, gen_emig_EAttributeOpDef_OpDef, gen_emig_EReferenceOpDef_OpDef, gen_emig_setterDef_LocatedElement, gen_emig_RewritingRule_LocatedElement, gen_emig_Migrator_LocatedElement, gen_emig_MigratorSX_Migrator, gen_emig_MigratorDX_Migrator, gen_emig_FilterMigrator_LocatedElement, gen_emig_DotNavigationObjSX_LocatedElement, gen_emig_DotNavigationObjDX_LocatedElement, gen_emig_Parameter_LocatedElement, gen_emig_Package_EPackage, gen_emig_Class_EClass, gen_emig_Attribute_EAttribute, gen_emig_Reference_EReference},
    metadata=None
)
