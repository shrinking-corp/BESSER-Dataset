...
class Families_Family:
    ...
    def __init__(self, lastName: str, familyDaughter: set["Member"] = None, familyFather: "Member" = None, familyMother: "Member" = None, familySon: set["Member"] = None):
...
class Families_Member:
    ...
    def __init__(self, firstName: str, lastName: str, father: "Family" = None, mother: "Family" = None, sons: "Family" = None, daughters: "Family" = None):
