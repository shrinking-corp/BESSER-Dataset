...
# Classes
ardlers_Program = Class(name="ardlers_Program")
ardlers_Library = Class(name="ardlers_Library")
ardlers_SensorImport = Class(name="ardlers_SensorImport")
ardlers_EObject = Class(name="ardlers_EObject")
ardlers_BoardDefinition = Class(name="ardlers_BoardDefinition")
ardlers_Rule = Class(name="ardlers_Rule")
ardlers_Or = Class(name="ardlers_Or")
ardlers_RuleBody = Class(name="ardlers_RuleBody")
ardlers_Expression = Class(name="ardlers_Expression")
Or = Class(name="Or")
ardlers_Parenthesis = Class(name="ardlers_Parenthesis")
Expression = Class(name="Expression")
ardlers_Value = Class(name="ardlers_Value")
Parenthesis = Class(name="Parenthesis")
ardlers_Attribute = Class(name="ardlers_Attribute")
Value = Class(name="Value")
ardlers_Node = Class(name="ardlers_Node")
ardlers_Component = Class(name="ardlers_Component")
ardlers_Delta = Class(name="ardlers_Delta")
ardlers_NumberLiteral = Class(name="ardlers_NumberLiteral")
ardlers_State = Class(name="ardlers_State")
ardlers_Assignment = Class(name="ardlers_Assignment")
ardlers_ComponentBody = Class(name="ardlers_ComponentBody")
ardlers_Rate = Class(name="ardlers_Rate")
ardlers_Map = Class(name="ardlers_Map")
ardlers_Range = Class(name="ardlers_Range")
ardlers_Smoothing = Class(name="ardlers_Smoothing")
ardlers_And = Class(name="ardlers_And")
ardlers_Comparison = Class(name="ardlers_Comparison")
ardlers_Exp = Class(name="ardlers_Exp")
ardlers_Factor = Class(name="ardlers_Factor")
...
ardlers_BoardDefinition.attributes={ardlers_BoardDefinition_di, ardlers_BoardDefinition_aout, ardlers_BoardDefinition_ain, ardlers_BoardDefinition_do, ardlers_BoardDefinition_name}
...
in_48: BinaryAssociation = BinaryAssociation(
    name="in_48",
    ends={
...
domain_model = DomainModel(
    name="ardlers",
    types={ardlers_Program, ardlers_Library, ardlers_SensorImport, ardlers_EObject, ardlers_BoardDefinition, ardlers_Rule, ardlers_Or, ardlers_RuleBody, ardlers_Expression, Or, ardlers_Parenthesis, Expression, ardlers_Value, Parenthesis, ardlers_Attribute, Value, ardlers_Node, ardlers_Component, ardlers_Delta, ardlers_NumberLiteral, ardlers_State, ardlers_Assignment, ardlers_ComponentBody, ardlers_Rate, ardlers_Map, ardlers_Range, ardlers_Smoothing, ardlers_And, ardlers_Comparison, ardlers_Exp, ardlers_Factor, IO, TYPE},
    associations={board0, sensorsImports1, program3, definitions5, attr23, boardtype7, condition10, body11, left14, right16, sub18, name20, component21, assignment25, attribute27, value30, boardType33, components36, sensor39, properties42, rate44, map46, in_48, out50},
