...
domain_model = DomainModel(
    name="hsm",
    types={hsm_CompositeState, hsm_InitialState, AbstractState, hsm_RegularState, hsm_StateMachine, hsm_Transition, hsm_AbstractState, hsm_Root},
    associations={stateMachine8, compositeStates10, transitions0, states1, stateMachine3, source4, target5, states12, statemachines14},
