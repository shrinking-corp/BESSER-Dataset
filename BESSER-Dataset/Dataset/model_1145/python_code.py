...
class hsm_AbstractState(ABC):
    ...
    def __init__(self, name: str, states: "hsm_StateMachine" = None, states11: "hsm_CompositeState" = None, AbstractState: "hsm_StateMachine" = None, hsm_AbstractState: "hsm_Transition" = None, hsm_AbstractState7: "hsm_Transition" = None, AbstractState13: "hsm_CompositeState" = None):
        self.name = name
        self.states = states
...
class hsm_StateMachine:
    ...
    def __init__(self, name: str, StateMachine9: "hsm_AbstractState" = None, stateMachine: set["hsm_Transition"] = None, stateMachine2: set["hsm_AbstractState"] = None, StateMachine: "hsm_Transition" = None, hsm_StateMachine: "hsm_Root" = None):
        self.name = name
