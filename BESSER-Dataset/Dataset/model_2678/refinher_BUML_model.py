...
# Classes
refinher_A = Class(name="refinher_A")
refinher_B = Class(name="refinher_B")
refinher_K = Class(name="refinher_K")
refinher_Named = Class(name="refinher_Named")
Named = Class(name="Named")
refinher_C = Class(name="refinher_C")
refinher_D = Class(name="refinher_D")
B = Class(name="B")
refinher_E = Class(name="refinher_E")
refinher_H = Class(name="refinher_H")
refinher_I = Class(name="refinher_I")
F = Class(name="F")
K = Class(name="K")
refinher_L = Class(name="refinher_L")
refinher_F = Class(name="refinher_F")
D = Class(name="D")
refinher_G = Class(name="refinher_G")
...
domain_model = DomainModel(
    name="refinher",
    types={refinher_A, refinher_B, refinher_K, refinher_Named, Named, refinher_C, refinher_D, B, refinher_E, refinher_H, refinher_I, F, K, refinher_L, refinher_F, D, refinher_G},
    associations={bs0, ks1, nameds3, cs5, es7, hs9, ls11, gs8},
    generalizations={gen_refinher_B_Named, gen_refinher_C_Named, gen_refinher_D_B, gen_refinher_E_Named, gen_refinher_G_Named, gen_refinher_I_F, gen_refinher_I_K, gen_refinher_H_Named, gen_refinher_K_Named, gen_refinher_L_Named, gen_refinher_F_D},
    metadata=None
)
