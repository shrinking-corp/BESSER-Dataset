...
domain_model = DomainModel(
    name="statemodel",
    types={statemodel_Model, statemodel_Import, statemodel_Element, statemodel_Statemachine, Element, statemodel_State, Activity, statemodel_Activity, statemodel_TransitionBlock, statemodel_Transition, StateType},
