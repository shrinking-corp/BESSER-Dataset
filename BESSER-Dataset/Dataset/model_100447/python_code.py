...
class states_Statemachine:
    ...
    def __init__(self, initial: bool, name: str, value: int, states_Statemachine8: "states_CompoundState" = None, states_Statemachine: "states_Module" = None, states_Statemachine2: set["states_Event"] = None, states_Statemachine4: set["states_State"] = None):
        self.initial = initial
        self.name = name
        self.value = value
