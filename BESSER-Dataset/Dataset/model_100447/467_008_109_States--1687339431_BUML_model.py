...
domain_model = DomainModel(
    name="states",
    types={states_Transition, states_SimpleState, State, states_CompoundState, states_Module, states_Statemachine, states_Event, states_State},
    associations={transitions5, machine7, machines0, events1, states3, event9, state12},
