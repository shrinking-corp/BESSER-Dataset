...
def test_hyp_refs_named_is_not_abstract():
    assert not inspect.isabstract(refs_Named)


def test_hyp_refs_named_constructor_exists():
    assert callable(refs_Named.__init__)


def test_hyp_refs_named_constructor_args():
...
def test_hyp_refs_e_is_not_abstract():
    assert not inspect.isabstract(refs_E)


def test_hyp_refs_e_constructor_exists():
    assert callable(refs_E.__init__)


def test_hyp_refs_e_constructor_args():
    sig = inspect.signature(refs_E.__init__)
    params = list(sig.parameters.keys())



def test_hyp_refs_b_is_not_abstract():
    assert not inspect.isabstract(refs_B)


def test_hyp_refs_b_constructor_exists():
    assert callable(refs_B.__init__)


def test_hyp_refs_b_constructor_args():
    sig = inspect.signature(refs_B.__init__)
    params = list(sig.parameters.keys())



def test_hyp_refs_h_is_not_abstract():
    assert not inspect.isabstract(refs_H)


def test_hyp_refs_h_constructor_exists():
    assert callable(refs_H.__init__)


def test_hyp_refs_h_constructor_args():
    sig = inspect.signature(refs_H.__init__)
    params = list(sig.parameters.keys())



def test_hyp_refs_c_is_not_abstract():
    assert not inspect.isabstract(refs_C)


def test_hyp_refs_c_constructor_exists():
    assert callable(refs_C.__init__)


def test_hyp_refs_c_constructor_args():
    sig = inspect.signature(refs_C.__init__)
    params = list(sig.parameters.keys())



def test_hyp_refs_g_is_not_abstract():
    assert not inspect.isabstract(refs_G)


def test_hyp_refs_g_constructor_exists():
    assert callable(refs_G.__init__)


def test_hyp_refs_g_constructor_args():
    sig = inspect.signature(refs_G.__init__)
    params = list(sig.parameters.keys())



def test_hyp_refs_f_is_not_abstract():
    assert not inspect.isabstract(refs_F)


def test_hyp_refs_f_constructor_exists():
    assert callable(refs_F.__init__)


def test_hyp_refs_f_constructor_args():
    sig = inspect.signature(refs_F.__init__)
    params = list(sig.parameters.keys())



def test_hyp_refs_a_is_not_abstract():
    assert not inspect.isabstract(refs_A)


def test_hyp_refs_a_constructor_exists():
    assert callable(refs_A.__init__)


def test_hyp_refs_a_constructor_args():
...
def test_hyp_refs_named_name_setter(instance):
