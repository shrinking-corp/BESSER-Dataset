...
html5_select_multiple = Class(name="html5_select_multiple")
...
html5_legend.attributes={html5_legend_class_, html5_legend_valor}
...
domain_model = DomainModel(
    name="html5",
    types={html5_div, container, html5_html, html5_container, html5_table, htmlElement, html5_tr, html5_td, html5_htmlElement, html5_img, html5_label, html5_input, html5_button, html5_option, html5_fieldset, html5_legend, html5_dialog, html5_select_multiple, types},
    associations={tr0, td1, elements3, legend5, container6, elements7, innercontainer11, options13},
    generalizations={gen_html5_div_container, gen_html5_table_htmlElement, gen_html5_img_htmlElement, gen_html5_label_htmlElement, gen_html5_input_htmlElement, gen_html5_button_htmlElement, gen_html5_fieldset_container, gen_html5_dialog_htmlElement, gen_html5_select_multiple_htmlElement},
    metadata=None
)
