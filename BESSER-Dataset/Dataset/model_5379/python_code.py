...
class html5_htmlElement(ABC):
    ...
    def __init__(self, class_: str, html5_htmlElement: "html5_td" = None, html5_htmlElement9: "html5_container" = None):
        self.class_ = class_
...
class html5_container(ABC):
    ...
    def __init__(self, class_: str, html5_container10: set["html5_container"] = None, html5_container: "html5_html" = None, html5_container8: set["html5_htmlElement"] = None, html5_container12: "html5_container" = None):
        self.class_ = class_
