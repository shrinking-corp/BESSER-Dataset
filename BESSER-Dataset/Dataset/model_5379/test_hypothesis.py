...
def test_html5_select_multiple_is_not_abstract():
    assert not inspect.isabstract(html5_select_multiple)


def test_html5_select_multiple_constructor_exists():
    assert callable(html5_select_multiple.__init__)


def test_html5_select_multiple_constructor_args():
    sig = inspect.signature(html5_select_multiple.__init__)
    params = list(sig.parameters.keys())
    assert "multiple" in params, "Missing parameter 'multiple'"

def test_html5_select_multiple_has_multiple():
    assert hasattr(html5_select_multiple, "multiple")
    descriptor = None
    for klass in html5_select_multiple.__mro__:
...
@given(instance=html5_select_multiple_strategy)
def test_html5_select_multiple_multiple_setter(instance):
