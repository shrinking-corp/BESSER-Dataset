...
domain_model = DomainModel(
    name="petriNet",
    types={petriNet_LocatedElement, petriNet_NamedElement, LocatedElement, petriNet_PetriNet, NamedElement, petriNet_Element, petriNet_Arc, petriNet_Place, Element, petriNet_TransitionToPlace, petriNet_PlaceToTransition, petriNet_Transition, Arc},
    associations={elements0, arcs1, from_16, to19, net3, incomingArc4, outgoingArc5, incomingArc6, outgoingArc9, net12, from_14, to15},
    generalizations={gen_petriNet_NamedElement_LocatedElement, gen_petriNet_PetriNet_NamedElement, gen_petriNet_Element_NamedElement, gen_petriNet_TransitionToPlace_Arc, gen_petriNet_Place_Element, gen_petriNet_Transition_Element, gen_petriNet_Arc_NamedElement, gen_petriNet_PlaceToTransition_Arc},
    metadata=None
)
