...
class HSM_AbstractState(ABC):
    ...
    def __init__(self, name: str, states: "HSM_StateMachine" = None, states11: "HSM_CompositeState" = None, AbstractState13: "HSM_CompositeState" = None, AbstractState: "HSM_StateMachine" = None, HSM_AbstractState: "HSM_Transition" = None, HSM_AbstractState7: "HSM_Transition" = None):
        self.name = name
        self.states = states
