...
class henshin_text_Parameter:
    ...
    def __init__(self, name: str, henshin_text_Parameter84: "henshin_text_ParameterType" = None, henshin_text_Parameter110: "henshin_text_Call" = None, henshin_text_Parameter: "henshin_text_ModelElement" = None, henshin_text_Parameter151: "henshin_text_ParameterValue" = None):
        self.name = name
...
class henshin_text_MultiRuleReuseNode(RuleNodeTypes, GraphElements):
    ...
    pass
class henshin_text_Node(RuleNodeTypes, ConditionNodeTypes, GraphElements):
