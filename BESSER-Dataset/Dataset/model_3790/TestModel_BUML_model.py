...
# Classes
model_TestElement = Class(name="model_TestElement", is_abstract=True)
model_TestContainer = Class(name="model_TestContainer")
model_TestProblem = Class(name="model_TestProblem")
TestElement = Class(name="TestElement")
model_TestCaseElement = Class(name="model_TestCaseElement")
model_TestRoot = Class(name="model_TestRoot")
TestContainer = Class(name="TestContainer")
model_TraceElement = Class(name="model_TraceElement", is_abstract=True)
model_ComparisonProblem = Class(name="model_ComparisonProblem")
TestProblem = Class(name="TestProblem")
model_TraceException = Class(name="model_TraceException")
TraceElement = Class(name="TraceElement")
model_TraceStackframe = Class(name="model_TraceStackframe")
...
model_TestElement.attributes={model_TestElement_name, model_TestElement_startTimestamp, model_TestElement_elementUnderTest, model_TestElement_progressState, model_TestElement_endTimestamp, model_TestElement_testState, model_TestElement_target, model_TestElement_description}
model_TestElement.methods={model_TestElement_m_getDuration, model_TestElement_m_isErrorOrFailure, model_TestElement_m_isRunning, model_TestElement_m_open, model_TestElement_m_getImageDescriptor, model_TestElement_m_hasWrongAssumption, model_TestElement_m_getRoot}
...
model_TestContainer.methods={model_TestContainer_m_updateProgressState, model_TestContainer_m_getMergedTestState, model_TestContainer_m_getCompletedCount, model_TestContainer_m_getTestCaseCount, model_TestContainer_m_getAssumptionMismatchCount, model_TestContainer_m_getIgnoredCount, model_TestContainer_m_getErrorCount, model_TestContainer_m_getFailureCount}
...
model_TestProblem.attributes={model_TestProblem_problemType, model_TestProblem_message}
...
model_TraceElement.methods={model_TraceElement_m_open, model_TraceElement_m_getImageDescriptor, model_TraceElement_m_getProblem}
...
domain_model = DomainModel(
    name="model",
    types={model_TestElement, model_TestContainer, model_TestProblem, TestElement, model_TestCaseElement, model_TestRoot, TestContainer, model_TraceElement, model_ComparisonProblem, TestProblem, model_TraceException, TraceElement, model_TraceStackframe, model_Metadata, ProgressState, ProblemType, TestState},
    associations={parent0, problem1, children2, trace3},
    generalizations={gen_model_TestContainer_TestElement, gen_model_TestCaseElement_TestElement, gen_model_TestRoot_TestContainer, gen_model_ComparisonProblem_TestProblem, gen_model_TraceException_TraceElement, gen_model_TraceStackframe_TraceElement},
    metadata=None
)
