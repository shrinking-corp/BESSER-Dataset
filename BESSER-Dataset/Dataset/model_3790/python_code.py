...
class model_TestContainer(TestElement):
    ...
    def __init__(self, TestContainer: "model_TestElement" = None, parent: set["model_TestElement"] = None):
    ...
    def getAssumptionMismatchCount(self) :
...
class model_TestElement(ABC):
    ...
    def __init__(self, name: str, description: str, testState: str, progressState: str, startTimestamp: str, endTimestamp: str, target: str, elementUnderTest: str, children: "model_TestContainer" = None, model_TestElement: "model_TestProblem" = None, TestElement: "model_TestContainer" = None):
        self.name = name
