...
def test_assoc_actual359_link_reassign_clear():
...
def test_assoc_baseUnit784_link_reassign_clear():
    a = aadl2_UnitLiteral()
    b1 = aadl2_UnitLiteral()
    b2 = aadl2_UnitLiteral()
    _safe_set(a, 'aadl2_UnitLiteral783', b1)
    assert _is_linked(a, 'aadl2_UnitLiteral783', b1)
    if hasattr(b1, 'aadl2_UnitLiteral785'):
        assert _is_linked(b1, 'aadl2_UnitLiteral785', a)
    _safe_set(a, 'aadl2_UnitLiteral783', b2)
    assert _is_linked(a, 'aadl2_UnitLiteral783', b2)
    if hasattr(b1, 'aadl2_UnitLiteral785'):
        assert not _is_linked(b1, 'aadl2_UnitLiteral785', a)
    if hasattr(b2, 'aadl2_UnitLiteral785'):
        assert _is_linked(b2, 'aadl2_UnitLiteral785', a)
    _safe_set(a, 'aadl2_UnitLiteral783', None)
    assert not _is_linked(a, 'aadl2_UnitLiteral783', b2)
    if hasattr(b2, 'aadl2_UnitLiteral785'):
        assert not _is_linked(b2, 'aadl2_UnitLiteral785', a)


def test_assoc_binding360_link_reassign_clear():
    a = aadl2_ComponentPrototypeActual(category="sample_text")
    b1 = aadl2_PrototypeBinding()
    b2 = aadl2_PrototypeBinding()
    _safe_set(a, 'aadl2_ComponentPrototypeActual361', {b1})
    assert _is_linked(a, 'aadl2_ComponentPrototypeActual361', b1)
    if hasattr(b1, 'aadl2_PrototypeBinding362'):
        assert _is_linked(b1, 'aadl2_PrototypeBinding362', a)
    _safe_set(a, 'aadl2_ComponentPrototypeActual361', {b2})
    assert _is_linked(a, 'aadl2_ComponentPrototypeActual361', b2)
    if hasattr(b1, 'aadl2_PrototypeBinding362'):
        assert not _is_linked(b1, 'aadl2_PrototypeBinding362', a)
    if hasattr(b2, 'aadl2_PrototypeBinding362'):
        assert _is_linked(b2, 'aadl2_PrototypeBinding362', a)
    _safe_set(a, 'aadl2_ComponentPrototypeActual361', set())
    assert not _is_linked(a, 'aadl2_ComponentPrototypeActual361', b2)
    if hasattr(b2, 'aadl2_PrototypeBinding362'):
        assert not _is_linked(b2, 'aadl2_PrototypeBinding362', a)
...
def test_assoc_classifier374_link_reassign_clear():
    ...
    _safe_set(a, 'aadl2_ComponentClassifier375', b1)
    assert _is_linked(a, 'aadl2_ComponentClassifier375', b1)
    if hasattr(b1, 'aadl2_AccessSpecification'):
        assert _is_linked(b1, 'aadl2_AccessSpecification', a)
    _safe_set(a, 'aadl2_ComponentClassifier375', b2)
    assert _is_linked(a, 'aadl2_ComponentClassifier375', b2)
    if hasattr(b1, 'aadl2_AccessSpecification'):
    ...
    _safe_set(a, 'aadl2_ComponentClassifier375', None)
    assert not _is_linked(a, 'aadl2_ComponentClassifier375', b2)
    if hasattr(b2, 'aadl2_AccessSpecification'):
        assert not _is_linked(b2, 'aadl2_AccessSpecification', a)


def test_assoc_classifier379_link_reassign_clear():
    ...
    if hasattr(b1, 'aadl2_ComponentClassifier380'):
        assert _is_linked(b1, 'aadl2_ComponentClassifier380', a)
    _safe_set(a, 'aadl2_PortSpecification', b2)
    assert _is_linked(a, 'aadl2_PortSpecification', b2)
    if hasattr(b1, 'aadl2_ComponentClassifier380'):
        assert not _is_linked(b1, 'aadl2_ComponentClassifier380', a)
    if hasattr(b2, 'aadl2_ComponentClassifier380'):
        assert _is_linked(b2, 'aadl2_ComponentClassifier380', a)
    _safe_set(a, 'aadl2_PortSpecification', None)
    assert not _is_linked(a, 'aadl2_PortSpecification', b2)
    if hasattr(b2, 'aadl2_ComponentClassifier380'):
        assert not _is_linked(b2, 'aadl2_ComponentClassifier380', a)


def test_assoc_classifier789_link_reassign_clear():
    a = aadl2_Classifier(noAnnexes="sample_text", noProperties="sample_text", noPrototypes="sample_text")
    b1 = aadl2_ClassifierValue()
    b2 = aadl2_ClassifierValue()
    _safe_set(a, 'aadl2_Classifier790', b1)
    assert _is_linked(a, 'aadl2_Classifier790', b1)
    if hasattr(b1, 'aadl2_ClassifierValue'):
        assert _is_linked(b1, 'aadl2_ClassifierValue', a)
    _safe_set(a, 'aadl2_Classifier790', b2)
    assert _is_linked(a, 'aadl2_Classifier790', b2)
    if hasattr(b1, 'aadl2_ClassifierValue'):
    ...
    _safe_set(a, 'aadl2_Classifier790', None)
    assert not _is_linked(a, 'aadl2_Classifier790', b2)
    if hasattr(b2, 'aadl2_ClassifierValue'):
...
def test_assoc_classifierReference838_link_reassign_clear():
    a = aadl2_MetaclassReference(annexName="sample_text", metaclassName="sample_text")
    b1 = aadl2_ClassifierType()
    b2 = aadl2_ClassifierType()
    _safe_set(a, 'aadl2_MetaclassReference839', b1)
    assert _is_linked(a, 'aadl2_MetaclassReference839', b1)
    if hasattr(b1, 'aadl2_ClassifierType'):
        assert _is_linked(b1, 'aadl2_ClassifierType', a)
    _safe_set(a, 'aadl2_MetaclassReference839', b2)
    assert _is_linked(a, 'aadl2_MetaclassReference839', b2)
    if hasattr(b1, 'aadl2_ClassifierType'):
    ...
    _safe_set(a, 'aadl2_MetaclassReference839', None)
    assert not _is_linked(a, 'aadl2_MetaclassReference839', b2)
    if hasattr(b2, 'aadl2_ClassifierType'):
        assert not _is_linked(b2, 'aadl2_ClassifierType', a)


def test_assoc_componentPrototype376_link_reassign_clear():
    a = aadl2_ComponentPrototype(array="sample_text")
    b1 = aadl2_AccessSpecification(category="sample_text", kind="sample_text")
    b2 = aadl2_AccessSpecification(category="sample_text_2", kind="sample_text_2")
    _safe_set(a, 'aadl2_ComponentPrototype378', b1)
    assert _is_linked(a, 'aadl2_ComponentPrototype378', b1)
    if hasattr(b1, 'aadl2_AccessSpecification377'):
        assert _is_linked(b1, 'aadl2_AccessSpecification377', a)
    _safe_set(a, 'aadl2_ComponentPrototype378', b2)
    assert _is_linked(a, 'aadl2_ComponentPrototype378', b2)
    if hasattr(b1, 'aadl2_AccessSpecification377'):
        assert not _is_linked(b1, 'aadl2_AccessSpecification377', a)
    if hasattr(b2, 'aadl2_AccessSpecification377'):
        assert _is_linked(b2, 'aadl2_AccessSpecification377', a)
    _safe_set(a, 'aadl2_ComponentPrototype378', None)
    assert not _is_linked(a, 'aadl2_ComponentPrototype378', b2)
    if hasattr(b2, 'aadl2_AccessSpecification377'):
        assert not _is_linked(b2, 'aadl2_AccessSpecification377', a)


def test_assoc_componentPrototype381_link_reassign_clear():
    a = aadl2_PortSpecification(category="sample_text", direction="sample_text")
    b1 = aadl2_ComponentPrototype(array="sample_text")
    b2 = aadl2_ComponentPrototype(array="sample_text_2")
    _safe_set(a, 'aadl2_PortSpecification382', b1)
    assert _is_linked(a, 'aadl2_PortSpecification382', b1)
    if hasattr(b1, 'aadl2_ComponentPrototype383'):
        assert _is_linked(b1, 'aadl2_ComponentPrototype383', a)
    _safe_set(a, 'aadl2_PortSpecification382', b2)
    assert _is_linked(a, 'aadl2_PortSpecification382', b2)
    if hasattr(b1, 'aadl2_ComponentPrototype383'):
        assert not _is_linked(b1, 'aadl2_ComponentPrototype383', a)
    if hasattr(b2, 'aadl2_ComponentPrototype383'):
        assert _is_linked(b2, 'aadl2_ComponentPrototype383', a)
    _safe_set(a, 'aadl2_PortSpecification382', None)
    assert not _is_linked(a, 'aadl2_PortSpecification382', b2)
    if hasattr(b2, 'aadl2_ComponentPrototype383'):
        assert not _is_linked(b2, 'aadl2_ComponentPrototype383', a)
...
def test_assoc_factor786_link_reassign_clear():
    a = aadl2_UnitLiteral()
    b1 = aadl2_NumberValue()
    b2 = aadl2_NumberValue()
    _safe_set(a, 'aadl2_UnitLiteral787', b1)
    assert _is_linked(a, 'aadl2_UnitLiteral787', b1)
    if hasattr(b1, 'aadl2_NumberValue788'):
        assert _is_linked(b1, 'aadl2_NumberValue788', a)
    _safe_set(a, 'aadl2_UnitLiteral787', b2)
    assert _is_linked(a, 'aadl2_UnitLiteral787', b2)
    if hasattr(b1, 'aadl2_NumberValue788'):
        assert not _is_linked(b1, 'aadl2_NumberValue788', a)
    if hasattr(b2, 'aadl2_NumberValue788'):
        assert _is_linked(b2, 'aadl2_NumberValue788', a)
    _safe_set(a, 'aadl2_UnitLiteral787', None)
    assert not _is_linked(a, 'aadl2_UnitLiteral787', b2)
    if hasattr(b2, 'aadl2_NumberValue788'):
        assert not _is_linked(b2, 'aadl2_NumberValue788', a)
...
def test_assoc_importedUnit338_link_reassign_clear():
...
def test_assoc_namedElementReference847_link_reassign_clear():
    a = aadl2_MetaclassReference(annexName="sample_text", metaclassName="sample_text")
    b1 = aadl2_ReferenceType()
    b2 = aadl2_ReferenceType()
    _safe_set(a, 'aadl2_MetaclassReference848', b1)
    assert _is_linked(a, 'aadl2_MetaclassReference848', b1)
    if hasattr(b1, 'aadl2_ReferenceType'):
        assert _is_linked(b1, 'aadl2_ReferenceType', a)
    _safe_set(a, 'aadl2_MetaclassReference848', b2)
    assert _is_linked(a, 'aadl2_MetaclassReference848', b2)
    if hasattr(b1, 'aadl2_ReferenceType'):
    ...
    _safe_set(a, 'aadl2_MetaclassReference848', None)
    assert not _is_linked(a, 'aadl2_MetaclassReference848', b2)
    if hasattr(b2, 'aadl2_ReferenceType'):
...
def test_assoc_ownedAnnexLibrary335_link_reassign_clear():
    a = aadl2_PackageSection(noAnnexes="sample_text", noProperties="sample_text")
    ...
    if hasattr(b1, 'aadl2_AnnexLibrary337'):
        assert _is_linked(b1, 'aadl2_AnnexLibrary337', a)
    _safe_set(a, 'aadl2_PackageSection336', {b2})
    assert _is_linked(a, 'aadl2_PackageSection336', b2)
    if hasattr(b1, 'aadl2_AnnexLibrary337'):
        assert not _is_linked(b1, 'aadl2_AnnexLibrary337', a)
    if hasattr(b2, 'aadl2_AnnexLibrary337'):
        assert _is_linked(b2, 'aadl2_AnnexLibrary337', a)
    _safe_set(a, 'aadl2_PackageSection336', set())
    assert not _is_linked(a, 'aadl2_PackageSection336', b2)
    if hasattr(b2, 'aadl2_AnnexLibrary337'):
        assert not _is_linked(b2, 'aadl2_AnnexLibrary337', a)
...
def test_assoc_ownedClassifier330_link_reassign_clear():
    a = aadl2_PackageSection(noAnnexes="sample_text", noProperties="sample_text")
    b1 = aadl2_Classifier(noAnnexes="sample_text", noProperties="sample_text", noPrototypes="sample_text")
    b2 = aadl2_Classifier(noAnnexes="sample_text_2", noProperties="sample_text_2", noPrototypes="sample_text_2")
    _safe_set(a, 'aadl2_PackageSection331', {b1})
    assert _is_linked(a, 'aadl2_PackageSection331', b1)
    if hasattr(b1, 'aadl2_Classifier332'):
        assert _is_linked(b1, 'aadl2_Classifier332', a)
    _safe_set(a, 'aadl2_PackageSection331', {b2})
    assert _is_linked(a, 'aadl2_PackageSection331', b2)
    if hasattr(b1, 'aadl2_Classifier332'):
        assert not _is_linked(b1, 'aadl2_Classifier332', a)
    if hasattr(b2, 'aadl2_Classifier332'):
        assert _is_linked(b2, 'aadl2_Classifier332', a)
    _safe_set(a, 'aadl2_PackageSection331', set())
    assert not _is_linked(a, 'aadl2_PackageSection331', b2)
    if hasattr(b2, 'aadl2_Classifier332'):
        assert not _is_linked(b2, 'aadl2_Classifier332', a)
...
def test_assoc_ownedComponentTypeRename328_link_reassign_clear():
    a = aadl2_PackageSection(noAnnexes="sample_text", noProperties="sample_text")
...
def test_assoc_ownedFeatureGroupTypeRename333_link_reassign_clear():
    a = aadl2_PackageSection(noAnnexes="sample_text", noProperties="sample_text")
    b1 = aadl2_FeatureGroupTypeRename()
    b2 = aadl2_FeatureGroupTypeRename()
    _safe_set(a, 'aadl2_PackageSection334', {b1})
    assert _is_linked(a, 'aadl2_PackageSection334', b1)
    if hasattr(b1, 'aadl2_FeatureGroupTypeRename'):
        assert _is_linked(b1, 'aadl2_FeatureGroupTypeRename', a)
    _safe_set(a, 'aadl2_PackageSection334', {b2})
    assert _is_linked(a, 'aadl2_PackageSection334', b2)
    if hasattr(b1, 'aadl2_FeatureGroupTypeRename'):
    ...
    _safe_set(a, 'aadl2_PackageSection334', set())
    assert not _is_linked(a, 'aadl2_PackageSection334', b2)
    if hasattr(b2, 'aadl2_FeatureGroupTypeRename'):
...
def test_assoc_ownedPackageRename327_link_reassign_clear():
    a = aadl2_PackageSection(noAnnexes="sample_text", noProperties="sample_text")
...
def test_assoc_ownedProperty808_link_reassign_clear():
    a = aadl2_Property(emptyListDefault="sample_text", inherit="sample_text")
    b1 = aadl2_PropertySet()
    b2 = aadl2_PropertySet()
    _safe_set(a, 'aadl2_Property810', b1)
    assert _is_linked(a, 'aadl2_Property810', b1)
    if hasattr(b1, 'aadl2_PropertySet809'):
        assert _is_linked(b1, 'aadl2_PropertySet809', a)
    _safe_set(a, 'aadl2_Property810', b2)
    assert _is_linked(a, 'aadl2_Property810', b2)
    if hasattr(b1, 'aadl2_PropertySet809'):
        assert not _is_linked(b1, 'aadl2_PropertySet809', a)
    if hasattr(b2, 'aadl2_PropertySet809'):
        assert _is_linked(b2, 'aadl2_PropertySet809', a)
    _safe_set(a, 'aadl2_Property810', None)
    assert not _is_linked(a, 'aadl2_Property810', b2)
    if hasattr(b2, 'aadl2_PropertySet809'):
        assert not _is_linked(b2, 'aadl2_PropertySet809', a)
...
def test_assoc_ownedPropertyExpression799_link_reassign_clear():
    a = aadl2_Operation(op="sample_text")
    b1 = aadl2_PropertyExpression()
    b2 = aadl2_PropertyExpression()
    _safe_set(a, 'aadl2_Operation', {b1})
    assert _is_linked(a, 'aadl2_Operation', b1)
    if hasattr(b1, 'aadl2_PropertyExpression800'):
        assert _is_linked(b1, 'aadl2_PropertyExpression800', a)
    _safe_set(a, 'aadl2_Operation', {b2})
    assert _is_linked(a, 'aadl2_Operation', b2)
    if hasattr(b1, 'aadl2_PropertyExpression800'):
        assert not _is_linked(b1, 'aadl2_PropertyExpression800', a)
    if hasattr(b2, 'aadl2_PropertyExpression800'):
        assert _is_linked(b2, 'aadl2_PropertyExpression800', a)
    _safe_set(a, 'aadl2_Operation', set())
    assert not _is_linked(a, 'aadl2_Operation', b2)
    if hasattr(b2, 'aadl2_PropertyExpression800'):
        assert not _is_linked(b2, 'aadl2_PropertyExpression800', a)
...
def test_assoc_ownedSubprogramCallSequence393_link_reassign_clear():
    a = aadl2_BehavioredImplementation()
    b1 = aadl2_SubprogramCallSequence()
    b2 = aadl2_SubprogramCallSequence()
    _safe_set(a, 'aadl2_BehavioredImplementation394', {b1})
    assert _is_linked(a, 'aadl2_BehavioredImplementation394', b1)
    if hasattr(b1, 'aadl2_SubprogramCallSequence395'):
        assert _is_linked(b1, 'aadl2_SubprogramCallSequence395', a)
    _safe_set(a, 'aadl2_BehavioredImplementation394', {b2})
    assert _is_linked(a, 'aadl2_BehavioredImplementation394', b2)
    if hasattr(b1, 'aadl2_SubprogramCallSequence395'):
        assert not _is_linked(b1, 'aadl2_SubprogramCallSequence395', a)
    if hasattr(b2, 'aadl2_SubprogramCallSequence395'):
        assert _is_linked(b2, 'aadl2_SubprogramCallSequence395', a)
    _safe_set(a, 'aadl2_BehavioredImplementation394', set())
    assert not _is_linked(a, 'aadl2_BehavioredImplementation394', b2)
    if hasattr(b2, 'aadl2_SubprogramCallSequence395'):
        assert not _is_linked(b2, 'aadl2_SubprogramCallSequence395', a)
...
def test_assoc_parsedAnnexLibrary323_link_reassign_clear():
...
def test_assoc_parsedAnnexSubclause324_link_reassign_clear():
    ...
    if hasattr(b1, 'aadl2_AnnexSubclause325'):
        assert _is_linked(b1, 'aadl2_AnnexSubclause325', a)
    _safe_set(a, 'aadl2_DefaultAnnexSubclause', b2)
    assert _is_linked(a, 'aadl2_DefaultAnnexSubclause', b2)
    if hasattr(b1, 'aadl2_AnnexSubclause325'):
        assert not _is_linked(b1, 'aadl2_AnnexSubclause325', a)
    if hasattr(b2, 'aadl2_AnnexSubclause325'):
        assert _is_linked(b2, 'aadl2_AnnexSubclause325', a)
    _safe_set(a, 'aadl2_DefaultAnnexSubclause', None)
    assert not _is_linked(a, 'aadl2_DefaultAnnexSubclause', b2)
    if hasattr(b2, 'aadl2_AnnexSubclause325'):
        assert not _is_linked(b2, 'aadl2_AnnexSubclause325', a)
...
def test_assoc_prototype384_link_reassign_clear():
    ...
    if hasattr(b1, 'aadl2_FeaturePrototype385'):
        assert _is_linked(b1, 'aadl2_FeaturePrototype385', a)
    _safe_set(a, 'aadl2_FeaturePrototypeReference', b2)
    assert _is_linked(a, 'aadl2_FeaturePrototypeReference', b2)
    if hasattr(b1, 'aadl2_FeaturePrototype385'):
        assert not _is_linked(b1, 'aadl2_FeaturePrototype385', a)
    if hasattr(b2, 'aadl2_FeaturePrototype385'):
        assert _is_linked(b2, 'aadl2_FeaturePrototype385', a)
    _safe_set(a, 'aadl2_FeaturePrototypeReference', None)
    assert not _is_linked(a, 'aadl2_FeaturePrototypeReference', b2)
    if hasattr(b2, 'aadl2_FeaturePrototype385'):
        assert not _is_linked(b2, 'aadl2_FeaturePrototype385', a)
...
def test_assoc_renamedComponentType353_link_reassign_clear():
    a = aadl2_ComponentTypeRename(category="sample_text")
    b1 = aadl2_ComponentType(noFeatures="sample_text")
    b2 = aadl2_ComponentType(noFeatures="sample_text_2")
    _safe_set(a, 'aadl2_ComponentTypeRename354', b1)
    assert _is_linked(a, 'aadl2_ComponentTypeRename354', b1)
    if hasattr(b1, 'aadl2_ComponentType355'):
        assert _is_linked(b1, 'aadl2_ComponentType355', a)
    _safe_set(a, 'aadl2_ComponentTypeRename354', b2)
    assert _is_linked(a, 'aadl2_ComponentTypeRename354', b2)
    if hasattr(b1, 'aadl2_ComponentType355'):
        assert not _is_linked(b1, 'aadl2_ComponentType355', a)
    if hasattr(b2, 'aadl2_ComponentType355'):
        assert _is_linked(b2, 'aadl2_ComponentType355', a)
    _safe_set(a, 'aadl2_ComponentTypeRename354', None)
    assert not _is_linked(a, 'aadl2_ComponentTypeRename354', b2)
    if hasattr(b2, 'aadl2_ComponentType355'):
        assert not _is_linked(b2, 'aadl2_ComponentType355', a)


def test_assoc_renamedPackage340_link_reassign_clear():
    a = aadl2_PackageRename(renameAll="sample_text")
    b1 = aadl2_AadlPackage()
    b2 = aadl2_AadlPackage()
    _safe_set(a, 'aadl2_PackageRename341', b1)
    assert _is_linked(a, 'aadl2_PackageRename341', b1)
    if hasattr(b1, 'aadl2_AadlPackage'):
        assert _is_linked(b1, 'aadl2_AadlPackage', a)
    _safe_set(a, 'aadl2_PackageRename341', b2)
    assert _is_linked(a, 'aadl2_PackageRename341', b2)
    if hasattr(b1, 'aadl2_AadlPackage'):
        assert not _is_linked(b1, 'aadl2_AadlPackage', a)
    if hasattr(b2, 'aadl2_AadlPackage'):
        assert _is_linked(b2, 'aadl2_AadlPackage', a)
    _safe_set(a, 'aadl2_PackageRename341', None)
    assert not _is_linked(a, 'aadl2_PackageRename341', b2)
    if hasattr(b2, 'aadl2_AadlPackage'):
...
def test_assoc_subcomponentType363_link_reassign_clear():
    a = aadl2_ComponentPrototypeActual(category="sample_text")
    b1 = aadl2_SubcomponentType()
    b2 = aadl2_SubcomponentType()
    _safe_set(a, 'aadl2_ComponentPrototypeActual364', b1)
    assert _is_linked(a, 'aadl2_ComponentPrototypeActual364', b1)
    if hasattr(b1, 'aadl2_SubcomponentType365'):
        assert _is_linked(b1, 'aadl2_SubcomponentType365', a)
    _safe_set(a, 'aadl2_ComponentPrototypeActual364', b2)
    assert _is_linked(a, 'aadl2_ComponentPrototypeActual364', b2)
    if hasattr(b1, 'aadl2_SubcomponentType365'):
        assert not _is_linked(b1, 'aadl2_SubcomponentType365', a)
    if hasattr(b2, 'aadl2_SubcomponentType365'):
        assert _is_linked(b2, 'aadl2_SubcomponentType365', a)
    _safe_set(a, 'aadl2_ComponentPrototypeActual364', None)
    assert not _is_linked(a, 'aadl2_ComponentPrototypeActual364', b2)
    if hasattr(b2, 'aadl2_SubcomponentType365'):
        assert not _is_linked(b2, 'aadl2_SubcomponentType365', a)


def test_assoc_subprogramCall391_link_reassign_clear():
    a = aadl2_BehavioredImplementation()
    ...
    if hasattr(b1, 'aadl2_SubprogramCall392'):
        assert _is_linked(b1, 'aadl2_SubprogramCall392', a)
    _safe_set(a, 'aadl2_BehavioredImplementation', {b2})
    assert _is_linked(a, 'aadl2_BehavioredImplementation', b2)
    if hasattr(b1, 'aadl2_SubprogramCall392'):
        assert not _is_linked(b1, 'aadl2_SubprogramCall392', a)
    if hasattr(b2, 'aadl2_SubprogramCall392'):
        assert _is_linked(b2, 'aadl2_SubprogramCall392', a)
    _safe_set(a, 'aadl2_BehavioredImplementation', set())
    assert not _is_linked(a, 'aadl2_BehavioredImplementation', b2)
    if hasattr(b2, 'aadl2_SubprogramCall392'):
        assert not _is_linked(b2, 'aadl2_SubprogramCall392', a)
...
def test_assoc_unit782_link_reassign_clear():
    a = aadl2_UnitLiteral()
    b1 = aadl2_NumberValue()
    b2 = aadl2_NumberValue()
