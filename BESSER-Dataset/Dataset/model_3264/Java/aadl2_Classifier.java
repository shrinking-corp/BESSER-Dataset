...
public class aadl2_Classifier extends Type, Namespace {
    ...
    public aadl2_Classifier(
        String noAnnexes,        String noPrototypes,        String noProperties    ) {
        super(
        );
    ...
    public aadl2_Classifier(
        String noAnnexes,        String noPrototypes,        String noProperties        ArrayList<aadl2_NamedElement> aadl2_namedelements,        ArrayList<aadl2_ClassifierFeature> aadl2_classifierfeatures,        ArrayList<aadl2_PrototypeBinding> aadl2_prototypebindings    ) {
        this.noAnnexes = noAnnexes;
        this.noPrototypes = noPrototypes;
        this.noProperties = noProperties;
