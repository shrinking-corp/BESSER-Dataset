...
public class aadl2_Subcomponent extends ArrayableElement, Context, StructuralFeature, ModalElement, FlowElement {
    ...
    public aadl2_Subcomponent(
        String allModes        ArrayList<aadl2_PrototypeBinding> aadl2_prototypebindings,        ArrayList<aadl2_ComponentImplementationReference> aadl2_componentimplementationreferences,        ArrayList<aadl2_ModeBinding> aadl2_modebindings    ) {
        this.allModes = allModes;
