...
def test_hyp_carnot_idrefowner_is_not_abstract():
    assert not inspect.isabstract(carnot_IdRefOwner)


def test_hyp_carnot_idrefowner_constructor_exists():
    assert callable(carnot_IdRefOwner.__init__)


def test_hyp_carnot_idrefowner_constructor_args():
...
def test_hyp_carnot_looptype_is_not_abstract():
    assert not inspect.isabstract(carnot_LoopType)


def test_hyp_carnot_looptype_constructor_exists():
    assert callable(carnot_LoopType.__init__)


def test_hyp_carnot_looptype_constructor_args():
...
def test_hyp_idrefowner_is_not_abstract():
    assert not inspect.isabstract(IdRefOwner)


def test_hyp_idrefowner_constructor_exists():
    assert callable(IdRefOwner.__init__)


def test_hyp_idrefowner_constructor_args():
...
def test_carnot_DataMappingType_isa_IExtensibleElement():
    instance = carnot_DataMappingType(applicationAccessPoint="sample_text", applicationPath="sample_text", context="sample_text", dataPath="sample_text", direction="sample_text")
    assert isinstance(instance, IExtensibleElement)
...
def test_carnot_ActivityType_isa_IdRefOwner():
    instance = carnot_ActivityType(allowsAbortByPerformer="sample_text", hibernateOnCreation="sample_text", implementation="sample_text", join="sample_text", loopCondition="sample_text", loopType="sample_text", split="sample_text", subProcessMode="sample_text")
    assert isinstance(instance, IdRefOwner)


def test_carnot_ProcessDefinitionType_isa_IdRefOwner():
    instance = carnot_ProcessDefinitionType(defaultPriority="sample_text")
    assert isinstance(instance, IdRefOwner)


def test_assoc_Code306_link_reassign_clear():
    ...
    _safe_set(a, 'carnot_Code308', b1)
    assert _is_linked(a, 'carnot_Code308', b1)
    if hasattr(b1, 'carnot_QualityControlType307'):
        assert _is_linked(b1, 'carnot_QualityControlType307', a)
    _safe_set(a, 'carnot_Code308', b2)
    assert _is_linked(a, 'carnot_Code308', b2)
    if hasattr(b1, 'carnot_QualityControlType307'):
        assert not _is_linked(b1, 'carnot_QualityControlType307', a)
    if hasattr(b2, 'carnot_QualityControlType307'):
        assert _is_linked(b2, 'carnot_QualityControlType307', a)
    _safe_set(a, 'carnot_Code308', None)
    assert not _is_linked(a, 'carnot_Code308', b2)
    if hasattr(b2, 'carnot_QualityControlType307'):
        assert not _is_linked(b2, 'carnot_QualityControlType307', a)
...
def test_assoc_activity282_link_reassign_clear():
    ...
    _safe_set(a, 'carnot_ProcessDefinitionType283', {b1})
    assert _is_linked(a, 'carnot_ProcessDefinitionType283', b1)
    if hasattr(b1, 'carnot_ActivityType284'):
        assert _is_linked(b1, 'carnot_ActivityType284', a)
    _safe_set(a, 'carnot_ProcessDefinitionType283', {b2})
    assert _is_linked(a, 'carnot_ProcessDefinitionType283', b2)
    if hasattr(b1, 'carnot_ActivityType284'):
        assert not _is_linked(b1, 'carnot_ActivityType284', a)
    if hasattr(b2, 'carnot_ActivityType284'):
        assert _is_linked(b2, 'carnot_ActivityType284', a)
    _safe_set(a, 'carnot_ProcessDefinitionType283', set())
    assert not _is_linked(a, 'carnot_ProcessDefinitionType283', b2)
    if hasattr(b2, 'carnot_ActivityType284'):
        assert not _is_linked(b2, 'carnot_ActivityType284', a)
...
def test_assoc_activitySymbol194_link_reassign_clear():
    a = carnot_GatewaySymbol(flowKind="sample_text")
    b1 = carnot_ActivitySymbolType()
    b2 = carnot_ActivitySymbolType()
    _safe_set(a, 'gatewaySymbols', b1)
    assert _is_linked(a, 'gatewaySymbols', b1)
    if hasattr(b1, 'ActivitySymbolType195'):
        assert _is_linked(b1, 'ActivitySymbolType195', a)
    _safe_set(a, 'gatewaySymbols', b2)
    assert _is_linked(a, 'gatewaySymbols', b2)
    if hasattr(b1, 'ActivitySymbolType195'):
        assert not _is_linked(b1, 'ActivitySymbolType195', a)
    if hasattr(b2, 'ActivitySymbolType195'):
        assert _is_linked(b2, 'ActivitySymbolType195', a)
    _safe_set(a, 'gatewaySymbols', None)
    assert not _is_linked(a, 'gatewaySymbols', b2)
    if hasattr(b2, 'ActivitySymbolType195'):
        assert not _is_linked(b2, 'ActivitySymbolType195', a)
...
def test_assoc_application227_link_reassign_clear():
    ...
    _safe_set(a, 'carnot_ModelType228', {b1})
    assert _is_linked(a, 'carnot_ModelType228', b1)
    if hasattr(b1, 'carnot_ApplicationType229'):
        assert _is_linked(b1, 'carnot_ApplicationType229', a)
    _safe_set(a, 'carnot_ModelType228', {b2})
    assert _is_linked(a, 'carnot_ModelType228', b2)
    if hasattr(b1, 'carnot_ApplicationType229'):
        assert not _is_linked(b1, 'carnot_ApplicationType229', a)
    if hasattr(b2, 'carnot_ApplicationType229'):
        assert _is_linked(b2, 'carnot_ApplicationType229', a)
    _safe_set(a, 'carnot_ModelType228', set())
    assert not _is_linked(a, 'carnot_ModelType228', b2)
    if hasattr(b2, 'carnot_ApplicationType229'):
        assert not _is_linked(b2, 'carnot_ApplicationType229', a)
...
def test_assoc_applicationContextType216_link_reassign_clear():
    a = carnot_ModelType(author="sample_text", carnotVersion="sample_text", created="sample_text", modelOID="sample_text", oid="sample_text", vendor="sample_text")
    ...
    _safe_set(a, 'carnot_ModelType217', {b1})
    assert _is_linked(a, 'carnot_ModelType217', b1)
    if hasattr(b1, 'carnot_ApplicationContextTypeType'):
        assert _is_linked(b1, 'carnot_ApplicationContextTypeType', a)
    _safe_set(a, 'carnot_ModelType217', {b2})
    assert _is_linked(a, 'carnot_ModelType217', b2)
    if hasattr(b1, 'carnot_ApplicationContextTypeType'):
    ...
    _safe_set(a, 'carnot_ModelType217', set())
    assert not _is_linked(a, 'carnot_ModelType217', b2)
    if hasattr(b2, 'carnot_ApplicationContextTypeType'):
...
def test_assoc_applicationType214_link_reassign_clear():
    a = carnot_ModelType(author="sample_text", carnotVersion="sample_text", created="sample_text", modelOID="sample_text", oid="sample_text", vendor="sample_text")
    ...
    _safe_set(a, 'carnot_ModelType215', {b1})
    assert _is_linked(a, 'carnot_ModelType215', b1)
    if hasattr(b1, 'carnot_ApplicationTypeType'):
        assert _is_linked(b1, 'carnot_ApplicationTypeType', a)
    _safe_set(a, 'carnot_ModelType215', {b2})
    assert _is_linked(a, 'carnot_ModelType215', b2)
    if hasattr(b1, 'carnot_ApplicationTypeType'):
    ...
    _safe_set(a, 'carnot_ModelType215', set())
    assert not _is_linked(a, 'carnot_ModelType215', b2)
    if hasattr(b2, 'carnot_ApplicationTypeType'):
...
def test_assoc_conditionalPerformer238_link_reassign_clear():
    a = carnot_ModelType(author="sample_text", carnotVersion="sample_text", created="sample_text", modelOID="sample_text", oid="sample_text", vendor="sample_text")
    ...
    _safe_set(a, 'carnot_ModelType239', {b1})
    assert _is_linked(a, 'carnot_ModelType239', b1)
    if hasattr(b1, 'carnot_ConditionalPerformerType'):
        assert _is_linked(b1, 'carnot_ConditionalPerformerType', a)
    _safe_set(a, 'carnot_ModelType239', {b2})
    assert _is_linked(a, 'carnot_ModelType239', b2)
    if hasattr(b1, 'carnot_ConditionalPerformerType'):
    ...
    _safe_set(a, 'carnot_ModelType239', set())
    assert not _is_linked(a, 'carnot_ModelType239', b2)
    if hasattr(b2, 'carnot_ConditionalPerformerType'):
...
def test_assoc_data224_link_reassign_clear():
    a = carnot_ModelType(author="sample_text", carnotVersion="sample_text", created="sample_text", modelOID="sample_text", oid="sample_text", vendor="sample_text")
    b1 = carnot_DataType(predefined="sample_text")
    b2 = carnot_DataType(predefined="sample_text_2")
    _safe_set(a, 'carnot_ModelType225', {b1})
    assert _is_linked(a, 'carnot_ModelType225', b1)
    if hasattr(b1, 'carnot_DataType226'):
        assert _is_linked(b1, 'carnot_DataType226', a)
    _safe_set(a, 'carnot_ModelType225', {b2})
    assert _is_linked(a, 'carnot_ModelType225', b2)
    if hasattr(b1, 'carnot_DataType226'):
        assert not _is_linked(b1, 'carnot_DataType226', a)
    if hasattr(b2, 'carnot_DataType226'):
        assert _is_linked(b2, 'carnot_DataType226', a)
    _safe_set(a, 'carnot_ModelType225', set())
    assert not _is_linked(a, 'carnot_ModelType225', b2)
    if hasattr(b2, 'carnot_DataType226'):
        assert not _is_linked(b2, 'carnot_DataType226', a)


def test_assoc_data265_link_reassign_clear():
    ...
    if hasattr(b1, 'DataType266'):
        assert _is_linked(b1, 'DataType266', a)
    _safe_set(a, 'parameterMappings', b2)
    assert _is_linked(a, 'parameterMappings', b2)
    if hasattr(b1, 'DataType266'):
        assert not _is_linked(b1, 'DataType266', a)
    if hasattr(b2, 'DataType266'):
        assert _is_linked(b2, 'DataType266', a)
    _safe_set(a, 'parameterMappings', None)
    assert not _is_linked(a, 'parameterMappings', b2)
    if hasattr(b2, 'DataType266'):
        assert not _is_linked(b2, 'DataType266', a)
...
def test_assoc_dataPath289_link_reassign_clear():
    a = carnot_ProcessDefinitionType(defaultPriority="sample_text")
    b1 = carnot_DataPathType(dataPath="sample_text", descriptor="sample_text", direction="sample_text", key="sample_text")
    b2 = carnot_DataPathType(dataPath="sample_text_2", descriptor="sample_text_2", direction="sample_text_2", key="sample_text_2")
    _safe_set(a, 'carnot_ProcessDefinitionType290', {b1})
    assert _is_linked(a, 'carnot_ProcessDefinitionType290', b1)
    if hasattr(b1, 'carnot_DataPathType'):
        assert _is_linked(b1, 'carnot_DataPathType', a)
    _safe_set(a, 'carnot_ProcessDefinitionType290', {b2})
    assert _is_linked(a, 'carnot_ProcessDefinitionType290', b2)
    if hasattr(b1, 'carnot_DataPathType'):
    ...
    _safe_set(a, 'carnot_ProcessDefinitionType290', set())
    assert not _is_linked(a, 'carnot_ProcessDefinitionType290', b2)
    if hasattr(b2, 'carnot_DataPathType'):
...
def test_assoc_dataType211_link_reassign_clear():
    a = carnot_ModelType(author="sample_text", carnotVersion="sample_text", created="sample_text", modelOID="sample_text", oid="sample_text", vendor="sample_text")
    ...
    _safe_set(a, 'carnot_ModelType212', {b1})
    assert _is_linked(a, 'carnot_ModelType212', b1)
    if hasattr(b1, 'carnot_DataTypeType213'):
        assert _is_linked(b1, 'carnot_DataTypeType213', a)
    _safe_set(a, 'carnot_ModelType212', {b2})
    assert _is_linked(a, 'carnot_ModelType212', b2)
    if hasattr(b1, 'carnot_DataTypeType213'):
        assert not _is_linked(b1, 'carnot_DataTypeType213', a)
    if hasattr(b2, 'carnot_DataTypeType213'):
        assert _is_linked(b2, 'carnot_DataTypeType213', a)
    _safe_set(a, 'carnot_ModelType212', set())
    assert not _is_linked(a, 'carnot_ModelType212', b2)
    if hasattr(b2, 'carnot_DataTypeType213'):
        assert not _is_linked(b2, 'carnot_DataTypeType213', a)
...
def test_assoc_description208_link_reassign_clear():
    a = carnot_ModelType(author="sample_text", carnotVersion="sample_text", created="sample_text", modelOID="sample_text", oid="sample_text", vendor="sample_text")
    b1 = carnot_DescriptionType(mixed="sample_text")
    b2 = carnot_DescriptionType(mixed="sample_text_2")
    _safe_set(a, 'carnot_ModelType209', b1)
    assert _is_linked(a, 'carnot_ModelType209', b1)
    if hasattr(b1, 'carnot_DescriptionType210'):
        assert _is_linked(b1, 'carnot_DescriptionType210', a)
    _safe_set(a, 'carnot_ModelType209', b2)
    assert _is_linked(a, 'carnot_ModelType209', b2)
    if hasattr(b1, 'carnot_DescriptionType210'):
        assert not _is_linked(b1, 'carnot_DescriptionType210', a)
    if hasattr(b2, 'carnot_DescriptionType210'):
        assert _is_linked(b2, 'carnot_DescriptionType210', a)
    _safe_set(a, 'carnot_ModelType209', None)
    assert not _is_linked(a, 'carnot_ModelType209', b2)
    if hasattr(b2, 'carnot_DescriptionType210'):
        assert not _is_linked(b2, 'carnot_DescriptionType210', a)
...
def test_assoc_description367_link_reassign_clear():
    a = carnot_ViewType(name="sample_text")
    b1 = carnot_DescriptionType(mixed="sample_text")
    b2 = carnot_DescriptionType(mixed="sample_text_2")
    _safe_set(a, 'carnot_ViewType368', b1)
    assert _is_linked(a, 'carnot_ViewType368', b1)
    if hasattr(b1, 'carnot_DescriptionType369'):
        assert _is_linked(b1, 'carnot_DescriptionType369', a)
    _safe_set(a, 'carnot_ViewType368', b2)
    assert _is_linked(a, 'carnot_ViewType368', b2)
    if hasattr(b1, 'carnot_DescriptionType369'):
        assert not _is_linked(b1, 'carnot_DescriptionType369', a)
    if hasattr(b2, 'carnot_DescriptionType369'):
        assert _is_linked(b2, 'carnot_DescriptionType369', a)
    _safe_set(a, 'carnot_ViewType368', None)
    assert not _is_linked(a, 'carnot_ViewType368', b2)
    if hasattr(b2, 'carnot_DescriptionType369'):
        assert not _is_linked(b2, 'carnot_DescriptionType369', a)


def test_assoc_diagram248_link_reassign_clear():
    a = carnot_ModelType(author="sample_text", carnotVersion="sample_text", created="sample_text", modelOID="sample_text", oid="sample_text", vendor="sample_text")
    ...
    _safe_set(a, 'carnot_ModelType249', {b1})
    assert _is_linked(a, 'carnot_ModelType249', b1)
    if hasattr(b1, 'carnot_DiagramType'):
        assert _is_linked(b1, 'carnot_DiagramType', a)
    _safe_set(a, 'carnot_ModelType249', {b2})
    assert _is_linked(a, 'carnot_ModelType249', b2)
    if hasattr(b1, 'carnot_DiagramType'):
        assert not _is_linked(b1, 'carnot_DiagramType', a)
    if hasattr(b2, 'carnot_DiagramType'):
        assert _is_linked(b2, 'carnot_DiagramType', a)
    _safe_set(a, 'carnot_ModelType249', set())
    assert not _is_linked(a, 'carnot_ModelType249', b2)
    if hasattr(b2, 'carnot_DiagramType'):
        assert not _is_linked(b2, 'carnot_DiagramType', a)


def test_assoc_diagram277_link_reassign_clear():
...
def test_assoc_diagram291_link_reassign_clear():
    a = carnot_ProcessDefinitionType(defaultPriority="sample_text")
    b1 = carnot_DiagramType(mode="sample_text", name="sample_text", orientation="sample_text")
    b2 = carnot_DiagramType(mode="sample_text_2", name="sample_text_2", orientation="sample_text_2")
    _safe_set(a, 'carnot_ProcessDefinitionType292', {b1})
    assert _is_linked(a, 'carnot_ProcessDefinitionType292', b1)
    if hasattr(b1, 'carnot_DiagramType293'):
        assert _is_linked(b1, 'carnot_DiagramType293', a)
    _safe_set(a, 'carnot_ProcessDefinitionType292', {b2})
    assert _is_linked(a, 'carnot_ProcessDefinitionType292', b2)
    if hasattr(b1, 'carnot_DiagramType293'):
        assert not _is_linked(b1, 'carnot_DiagramType293', a)
    if hasattr(b2, 'carnot_DiagramType293'):
        assert _is_linked(b2, 'carnot_DiagramType293', a)
    _safe_set(a, 'carnot_ProcessDefinitionType292', set())
    assert not _is_linked(a, 'carnot_ProcessDefinitionType292', b2)
    if hasattr(b2, 'carnot_DiagramType293'):
        assert not _is_linked(b2, 'carnot_DiagramType293', a)
...
def test_assoc_eventActionType222_link_reassign_clear():
    a = carnot_ModelType(author="sample_text", carnotVersion="sample_text", created="sample_text", modelOID="sample_text", oid="sample_text", vendor="sample_text")
    ...
    _safe_set(a, 'carnot_ModelType223', {b1})
    assert _is_linked(a, 'carnot_ModelType223', b1)
    if hasattr(b1, 'carnot_EventActionTypeType'):
        assert _is_linked(b1, 'carnot_EventActionTypeType', a)
    _safe_set(a, 'carnot_ModelType223', {b2})
    assert _is_linked(a, 'carnot_ModelType223', b2)
    if hasattr(b1, 'carnot_EventActionTypeType'):
    ...
    _safe_set(a, 'carnot_ModelType223', set())
    assert not _is_linked(a, 'carnot_ModelType223', b2)
    if hasattr(b2, 'carnot_EventActionTypeType'):
        assert not _is_linked(b2, 'carnot_EventActionTypeType', a)


def test_assoc_eventConditionType220_link_reassign_clear():
    a = carnot_ModelType(author="sample_text", carnotVersion="sample_text", created="sample_text", modelOID="sample_text", oid="sample_text", vendor="sample_text")
    ...
    _safe_set(a, 'carnot_ModelType221', {b1})
    assert _is_linked(a, 'carnot_ModelType221', b1)
    if hasattr(b1, 'carnot_EventConditionTypeType'):
        assert _is_linked(b1, 'carnot_EventConditionTypeType', a)
    _safe_set(a, 'carnot_ModelType221', {b2})
    assert _is_linked(a, 'carnot_ModelType221', b2)
    if hasattr(b1, 'carnot_EventConditionTypeType'):
    ...
    _safe_set(a, 'carnot_ModelType221', set())
    assert not _is_linked(a, 'carnot_ModelType221', b2)
    if hasattr(b2, 'carnot_EventConditionTypeType'):
...
def test_assoc_executingActivities294_link_reassign_clear():
    a = carnot_ProcessDefinitionType(defaultPriority="sample_text")
    b1 = carnot_ActivityType(allowsAbortByPerformer="sample_text", hibernateOnCreation="sample_text", implementation="sample_text", join="sample_text", loopCondition="sample_text", loopType="sample_text", split="sample_text", subProcessMode="sample_text")
    b2 = carnot_ActivityType(allowsAbortByPerformer="sample_text_2", hibernateOnCreation="sample_text_2", implementation="sample_text_2", join="sample_text_2", loopCondition="sample_text_2", loopType="sample_text_2", split="sample_text_2", subProcessMode="sample_text_2")
    _safe_set(a, 'implementationProcess', {b1})
    assert _is_linked(a, 'implementationProcess', b1)
    if hasattr(b1, 'ActivityType295'):
        assert _is_linked(b1, 'ActivityType295', a)
    _safe_set(a, 'implementationProcess', {b2})
    assert _is_linked(a, 'implementationProcess', b2)
    if hasattr(b1, 'ActivityType295'):
        assert not _is_linked(b1, 'ActivityType295', a)
    if hasattr(b2, 'ActivityType295'):
        assert _is_linked(b2, 'ActivityType295', a)
    _safe_set(a, 'implementationProcess', set())
    assert not _is_linked(a, 'implementationProcess', b2)
    if hasattr(b2, 'ActivityType295'):
        assert not _is_linked(b2, 'ActivityType295', a)
...
def test_assoc_expression343_link_reassign_clear():
    ...
    _safe_set(a, 'carnot_XmlTextNode345', b1)
    assert _is_linked(a, 'carnot_XmlTextNode345', b1)
    if hasattr(b1, 'carnot_TransitionType344'):
        assert _is_linked(b1, 'carnot_TransitionType344', a)
    _safe_set(a, 'carnot_XmlTextNode345', b2)
    assert _is_linked(a, 'carnot_XmlTextNode345', b2)
    if hasattr(b1, 'carnot_TransitionType344'):
        assert not _is_linked(b1, 'carnot_TransitionType344', a)
    if hasattr(b2, 'carnot_TransitionType344'):
        assert _is_linked(b2, 'carnot_TransitionType344', a)
    _safe_set(a, 'carnot_XmlTextNode345', None)
    assert not _is_linked(a, 'carnot_XmlTextNode345', b2)
    if hasattr(b2, 'carnot_TransitionType344'):
        assert not _is_linked(b2, 'carnot_TransitionType344', a)


def test_assoc_externalPackages242_link_reassign_clear():
    a = carnot_ModelType(author="sample_text", carnotVersion="sample_text", created="sample_text", modelOID="sample_text", oid="sample_text", vendor="sample_text")
    b1 = carnot_ExternalPackages()
    b2 = carnot_ExternalPackages()
    _safe_set(a, 'carnot_ModelType243', b1)
    assert _is_linked(a, 'carnot_ModelType243', b1)
    if hasattr(b1, 'carnot_ExternalPackages'):
        assert _is_linked(b1, 'carnot_ExternalPackages', a)
    _safe_set(a, 'carnot_ModelType243', b2)
    assert _is_linked(a, 'carnot_ModelType243', b2)
    if hasattr(b1, 'carnot_ExternalPackages'):
    ...
    _safe_set(a, 'carnot_ModelType243', None)
    assert not _is_linked(a, 'carnot_ModelType243', b2)
    if hasattr(b2, 'carnot_ExternalPackages'):
        assert not _is_linked(b2, 'carnot_ExternalPackages', a)


def test_assoc_externalRef192_link_reassign_clear():
    a = carnot_IdRef(ref="sample_text")
    b1 = carnot_IdRefOwner()
    b2 = carnot_IdRefOwner()
    _safe_set(a, 'carnot_IdRef193', b1)
    assert _is_linked(a, 'carnot_IdRef193', b1)
    if hasattr(b1, 'carnot_IdRefOwner'):
        assert _is_linked(b1, 'carnot_IdRefOwner', a)
    _safe_set(a, 'carnot_IdRef193', b2)
    assert _is_linked(a, 'carnot_IdRef193', b2)
    if hasattr(b1, 'carnot_IdRefOwner'):
        assert not _is_linked(b1, 'carnot_IdRefOwner', a)
    if hasattr(b2, 'carnot_IdRefOwner'):
        assert _is_linked(b2, 'carnot_IdRefOwner', a)
    _safe_set(a, 'carnot_IdRef193', None)
    assert not _is_linked(a, 'carnot_IdRef193', b2)
    if hasattr(b2, 'carnot_IdRefOwner'):
        assert not _is_linked(b2, 'carnot_IdRefOwner', a)
...
def test_assoc_formalParameterMappings299_link_reassign_clear():
    a = carnot_ProcessDefinitionType(defaultPriority="sample_text")
    b1 = FormalParameterMappingsType()
    b2 = FormalParameterMappingsType()
    _safe_set(a, 'carnot_ProcessDefinitionType300', b1)
    assert _is_linked(a, 'carnot_ProcessDefinitionType300', b1)
    if hasattr(b1, 'FormalParameterMappingsType'):
        assert _is_linked(b1, 'FormalParameterMappingsType', a)
    _safe_set(a, 'carnot_ProcessDefinitionType300', b2)
    assert _is_linked(a, 'carnot_ProcessDefinitionType300', b2)
    if hasattr(b1, 'FormalParameterMappingsType'):
    ...
    _safe_set(a, 'carnot_ProcessDefinitionType300', None)
    assert not _is_linked(a, 'carnot_ProcessDefinitionType300', b2)
    if hasattr(b2, 'FormalParameterMappingsType'):
        assert not _is_linked(b2, 'FormalParameterMappingsType', a)


def test_assoc_formalParameters297_link_reassign_clear():
    a = carnot_ProcessDefinitionType(defaultPriority="sample_text")
    b1 = carnot_FormalParametersType()
    b2 = carnot_FormalParametersType()
    _safe_set(a, 'carnot_ProcessDefinitionType298', b1)
    assert _is_linked(a, 'carnot_ProcessDefinitionType298', b1)
    if hasattr(b1, 'carnot_FormalParametersType'):
        assert _is_linked(b1, 'carnot_FormalParametersType', a)
    _safe_set(a, 'carnot_ProcessDefinitionType298', b2)
    assert _is_linked(a, 'carnot_ProcessDefinitionType298', b2)
    if hasattr(b1, 'carnot_FormalParametersType'):
    ...
    _safe_set(a, 'carnot_ProcessDefinitionType298', None)
    assert not _is_linked(a, 'carnot_ProcessDefinitionType298', b2)
    if hasattr(b2, 'carnot_FormalParametersType'):
        assert not _is_linked(b2, 'carnot_FormalParametersType', a)


def test_assoc_from_309_link_reassign_clear():
...
def test_assoc_from_346_link_reassign_clear():
    a = carnot_TransitionType(condition="sample_text", forkOnTraversal="sample_text")
    b1 = carnot_ActivityType(allowsAbortByPerformer="sample_text", hibernateOnCreation="sample_text", implementation="sample_text", join="sample_text", loopCondition="sample_text", loopType="sample_text", split="sample_text", subProcessMode="sample_text")
    b2 = carnot_ActivityType(allowsAbortByPerformer="sample_text_2", hibernateOnCreation="sample_text_2", implementation="sample_text_2", join="sample_text_2", loopCondition="sample_text_2", loopType="sample_text_2", split="sample_text_2", subProcessMode="sample_text_2")
    _safe_set(a, 'outTransitions347', b1)
    assert _is_linked(a, 'outTransitions347', b1)
    if hasattr(b1, 'ActivityType348'):
        assert _is_linked(b1, 'ActivityType348', a)
    _safe_set(a, 'outTransitions347', b2)
    assert _is_linked(a, 'outTransitions347', b2)
    if hasattr(b1, 'ActivityType348'):
        assert not _is_linked(b1, 'ActivityType348', a)
    if hasattr(b2, 'ActivityType348'):
        assert _is_linked(b2, 'ActivityType348', a)
    _safe_set(a, 'outTransitions347', None)
    assert not _is_linked(a, 'outTransitions347', b2)
    if hasattr(b2, 'ActivityType348'):
        assert not _is_linked(b2, 'ActivityType348', a)
...
def test_assoc_lanes280_link_reassign_clear():
    a = carnot_PoolSymbol(boundaryVisible="sample_text")
    b1 = carnot_LaneSymbol()
    b2 = carnot_LaneSymbol()
    _safe_set(a, 'parentPool', {b1})
    assert _is_linked(a, 'parentPool', b1)
    if hasattr(b1, 'LaneSymbol281'):
        assert _is_linked(b1, 'LaneSymbol281', a)
    _safe_set(a, 'parentPool', {b2})
    assert _is_linked(a, 'parentPool', b2)
    if hasattr(b1, 'LaneSymbol281'):
        assert not _is_linked(b1, 'LaneSymbol281', a)
    if hasattr(b2, 'LaneSymbol281'):
        assert _is_linked(b2, 'LaneSymbol281', a)
    _safe_set(a, 'parentPool', set())
    assert not _is_linked(a, 'parentPool', b2)
    if hasattr(b2, 'LaneSymbol281'):
        assert not _is_linked(b2, 'LaneSymbol281', a)


def test_assoc_linkInstances204_link_reassign_clear():
    a = carnot_LinkTypeType(lineColor="sample_text", lineStyle="sample_text", showLinkTypeName="sample_text", showRoleNames="sample_text", sourceCardinality="sample_text", sourceClass="sample_text", sourceRole="sample_text", sourceSymbol="sample_text", targetCardinality="sample_text", targetClass="sample_text", targetRole="sample_text", targetSymbol="sample_text")
    b1 = carnot_GenericLinkConnectionType()
    b2 = carnot_GenericLinkConnectionType()
    _safe_set(a, 'linkType', {b1})
    assert _is_linked(a, 'linkType', b1)
    if hasattr(b1, 'GenericLinkConnectionType205'):
        assert _is_linked(b1, 'GenericLinkConnectionType205', a)
    _safe_set(a, 'linkType', {b2})
    assert _is_linked(a, 'linkType', b2)
    if hasattr(b1, 'GenericLinkConnectionType205'):
        assert not _is_linked(b1, 'GenericLinkConnectionType205', a)
    if hasattr(b2, 'GenericLinkConnectionType205'):
        assert _is_linked(b2, 'GenericLinkConnectionType205', a)
    _safe_set(a, 'linkType', set())
    assert not _is_linked(a, 'linkType', b2)
    if hasattr(b2, 'GenericLinkConnectionType205'):
        assert not _is_linked(b2, 'GenericLinkConnectionType205', a)


def test_assoc_linkType196_link_reassign_clear():
    a = carnot_LinkTypeType(lineColor="sample_text", lineStyle="sample_text", showLinkTypeName="sample_text", showRoleNames="sample_text", sourceCardinality="sample_text", sourceClass="sample_text", sourceRole="sample_text", sourceSymbol="sample_text", targetCardinality="sample_text", targetClass="sample_text", targetRole="sample_text", targetSymbol="sample_text")
    b1 = carnot_GenericLinkConnectionType()
    b2 = carnot_GenericLinkConnectionType()
...
def test_assoc_linkType250_link_reassign_clear():
    a = carnot_ModelType(author="sample_text", carnotVersion="sample_text", created="sample_text", modelOID="sample_text", oid="sample_text", vendor="sample_text")
    ...
    _safe_set(a, 'carnot_ModelType251', {b1})
    assert _is_linked(a, 'carnot_ModelType251', b1)
    if hasattr(b1, 'carnot_LinkTypeType'):
        assert _is_linked(b1, 'carnot_LinkTypeType', a)
    _safe_set(a, 'carnot_ModelType251', {b2})
    assert _is_linked(a, 'carnot_ModelType251', b2)
    if hasattr(b1, 'carnot_LinkTypeType'):
    ...
    _safe_set(a, 'carnot_ModelType251', set())
    assert not _is_linked(a, 'carnot_ModelType251', b2)
    if hasattr(b2, 'carnot_LinkTypeType'):
...
def test_assoc_loop109_link_reassign_clear():
    ...
    b1 = carnot_LoopType()
    b2 = carnot_LoopType()
    _safe_set(a, 'carnot_ActivityType110', b1)
    assert _is_linked(a, 'carnot_ActivityType110', b1)
    if hasattr(b1, 'carnot_LoopType'):
        assert _is_linked(b1, 'carnot_LoopType', a)
    _safe_set(a, 'carnot_ActivityType110', b2)
    assert _is_linked(a, 'carnot_ActivityType110', b2)
    if hasattr(b1, 'carnot_LoopType'):
        assert not _is_linked(b1, 'carnot_LoopType', a)
    if hasattr(b2, 'carnot_LoopType'):
        assert _is_linked(b2, 'carnot_LoopType', a)
    _safe_set(a, 'carnot_ActivityType110', None)
    assert not _is_linked(a, 'carnot_ActivityType110', b2)
    if hasattr(b2, 'carnot_LoopType'):
        assert not _is_linked(b2, 'carnot_LoopType', a)


def test_assoc_mapping383_link_reassign_clear():
...
def test_assoc_modeler206_link_reassign_clear():
...
def test_assoc_modeler230_link_reassign_clear():
    a = carnot_ModelerType(email="sample_text", password="sample_text")
    ...
    if hasattr(b1, 'carnot_ModelType231'):
        assert _is_linked(b1, 'carnot_ModelType231', a)
    _safe_set(a, 'carnot_ModelerType', b2)
    assert _is_linked(a, 'carnot_ModelerType', b2)
    if hasattr(b1, 'carnot_ModelType231'):
        assert not _is_linked(b1, 'carnot_ModelType231', a)
    if hasattr(b2, 'carnot_ModelType231'):
        assert _is_linked(b2, 'carnot_ModelType231', a)
    _safe_set(a, 'carnot_ModelerType', None)
    assert not _is_linked(a, 'carnot_ModelerType', b2)
    if hasattr(b2, 'carnot_ModelType231'):
        assert not _is_linked(b2, 'carnot_ModelType231', a)
...
def test_assoc_modelerSymbols207_link_reassign_clear():
    a = carnot_ModelerType(email="sample_text", password="sample_text")
    b1 = carnot_ModelerSymbolType()
    b2 = carnot_ModelerSymbolType()
...
def test_assoc_organization236_link_reassign_clear():
    a = carnot_ModelType(author="sample_text", carnotVersion="sample_text", created="sample_text", modelOID="sample_text", oid="sample_text", vendor="sample_text")
    b1 = carnot_OrganizationType()
    b2 = carnot_OrganizationType()
    _safe_set(a, 'carnot_ModelType237', {b1})
    assert _is_linked(a, 'carnot_ModelType237', b1)
    if hasattr(b1, 'carnot_OrganizationType'):
        assert _is_linked(b1, 'carnot_OrganizationType', a)
    _safe_set(a, 'carnot_ModelType237', {b2})
    assert _is_linked(a, 'carnot_ModelType237', b2)
    if hasattr(b1, 'carnot_OrganizationType'):
    ...
    _safe_set(a, 'carnot_ModelType237', set())
    assert not _is_linked(a, 'carnot_ModelType237', b2)
    if hasattr(b2, 'carnot_OrganizationType'):
...
def test_assoc_parameterMapping358_link_reassign_clear():
    a = carnot_ParameterMappingType(dataPath="sample_text", parameter="sample_text", parameterPath="sample_text")
    ...
    if hasattr(b1, 'carnot_TriggerType359'):
        assert _is_linked(b1, 'carnot_TriggerType359', a)
    _safe_set(a, 'carnot_ParameterMappingType', b2)
    assert _is_linked(a, 'carnot_ParameterMappingType', b2)
    if hasattr(b1, 'carnot_TriggerType359'):
        assert not _is_linked(b1, 'carnot_TriggerType359', a)
    if hasattr(b2, 'carnot_TriggerType359'):
        assert _is_linked(b2, 'carnot_TriggerType359', a)
    _safe_set(a, 'carnot_ParameterMappingType', None)
    assert not _is_linked(a, 'carnot_ParameterMappingType', b2)
    if hasattr(b2, 'carnot_TriggerType359'):
        assert not _is_linked(b2, 'carnot_TriggerType359', a)
...
def test_assoc_parentLane202_link_reassign_clear():
    a = carnot_ISwimlaneSymbol(collapsed="sample_text", orientation="sample_text")
    b1 = carnot_LaneSymbol()
    b2 = carnot_LaneSymbol()
    _safe_set(a, 'ISwimlaneSymbol203', b1)
    assert _is_linked(a, 'ISwimlaneSymbol203', b1)
    if hasattr(b1, 'childLanes'):
        assert _is_linked(b1, 'childLanes', a)
    _safe_set(a, 'ISwimlaneSymbol203', b2)
    assert _is_linked(a, 'ISwimlaneSymbol203', b2)
    if hasattr(b1, 'childLanes'):
        assert not _is_linked(b1, 'childLanes', a)
    if hasattr(b2, 'childLanes'):
        assert _is_linked(b2, 'childLanes', a)
    _safe_set(a, 'ISwimlaneSymbol203', None)
    assert not _is_linked(a, 'ISwimlaneSymbol203', b2)
    if hasattr(b2, 'childLanes'):
        assert not _is_linked(b2, 'childLanes', a)


def test_assoc_parentPool200_link_reassign_clear():
    a = carnot_PoolSymbol(boundaryVisible="sample_text")
    b1 = carnot_LaneSymbol()
    b2 = carnot_LaneSymbol()
    _safe_set(a, 'PoolSymbol201', b1)
    assert _is_linked(a, 'PoolSymbol201', b1)
    if hasattr(b1, 'lanes'):
        assert _is_linked(b1, 'lanes', a)
    _safe_set(a, 'PoolSymbol201', b2)
    assert _is_linked(a, 'PoolSymbol201', b2)
    if hasattr(b1, 'lanes'):
        assert not _is_linked(b1, 'lanes', a)
    if hasattr(b2, 'lanes'):
        assert _is_linked(b2, 'lanes', a)
    _safe_set(a, 'PoolSymbol201', None)
    assert not _is_linked(a, 'PoolSymbol201', b2)
    if hasattr(b2, 'lanes'):
...
def test_assoc_process278_link_reassign_clear():
    a = carnot_ProcessDefinitionType(defaultPriority="sample_text")
    b1 = carnot_PoolSymbol(boundaryVisible="sample_text")
    b2 = carnot_PoolSymbol(boundaryVisible="sample_text_2")
    _safe_set(a, 'carnot_ProcessDefinitionType279', b1)
    assert _is_linked(a, 'carnot_ProcessDefinitionType279', b1)
    if hasattr(b1, 'carnot_PoolSymbol'):
        assert _is_linked(b1, 'carnot_PoolSymbol', a)
    _safe_set(a, 'carnot_ProcessDefinitionType279', b2)
    assert _is_linked(a, 'carnot_ProcessDefinitionType279', b2)
    if hasattr(b1, 'carnot_PoolSymbol'):
        assert not _is_linked(b1, 'carnot_PoolSymbol', a)
    if hasattr(b2, 'carnot_PoolSymbol'):
        assert _is_linked(b2, 'carnot_PoolSymbol', a)
    _safe_set(a, 'carnot_ProcessDefinitionType279', None)
    assert not _is_linked(a, 'carnot_ProcessDefinitionType279', b2)
    if hasattr(b2, 'carnot_PoolSymbol'):
        assert not _is_linked(b2, 'carnot_PoolSymbol', a)


def test_assoc_process301_link_reassign_clear():
    a = carnot_ProcessDefinitionType(defaultPriority="sample_text")
    b1 = carnot_ProcessSymbolType()
    b2 = carnot_ProcessSymbolType()
    _safe_set(a, 'ProcessDefinitionType302', b1)
    assert _is_linked(a, 'ProcessDefinitionType302', b1)
    if hasattr(b1, 'processSymbols'):
        assert _is_linked(b1, 'processSymbols', a)
    _safe_set(a, 'ProcessDefinitionType302', b2)
    assert _is_linked(a, 'ProcessDefinitionType302', b2)
    if hasattr(b1, 'processSymbols'):
        assert not _is_linked(b1, 'processSymbols', a)
    if hasattr(b2, 'processSymbols'):
        assert _is_linked(b2, 'processSymbols', a)
    _safe_set(a, 'ProcessDefinitionType302', None)
    assert not _is_linked(a, 'ProcessDefinitionType302', b2)
    if hasattr(b2, 'processSymbols'):
        assert not _is_linked(b2, 'processSymbols', a)


def test_assoc_processDefinition240_link_reassign_clear():
    a = carnot_ProcessDefinitionType(defaultPriority="sample_text")
    b1 = carnot_ModelType(author="sample_text", carnotVersion="sample_text", created="sample_text", modelOID="sample_text", oid="sample_text", vendor="sample_text")
    b2 = carnot_ModelType(author="sample_text_2", carnotVersion="sample_text_2", created="sample_text_2", modelOID="sample_text_2", oid="sample_text_2", vendor="sample_text_2")
    _safe_set(a, 'carnot_ProcessDefinitionType', b1)
    assert _is_linked(a, 'carnot_ProcessDefinitionType', b1)
    if hasattr(b1, 'carnot_ModelType241'):
        assert _is_linked(b1, 'carnot_ModelType241', a)
    _safe_set(a, 'carnot_ProcessDefinitionType', b2)
    assert _is_linked(a, 'carnot_ProcessDefinitionType', b2)
    if hasattr(b1, 'carnot_ModelType241'):
        assert not _is_linked(b1, 'carnot_ModelType241', a)
    if hasattr(b2, 'carnot_ModelType241'):
        assert _is_linked(b2, 'carnot_ModelType241', a)
    _safe_set(a, 'carnot_ProcessDefinitionType', None)
    assert not _is_linked(a, 'carnot_ProcessDefinitionType', b2)
    if hasattr(b2, 'carnot_ModelType241'):
        assert not _is_linked(b2, 'carnot_ModelType241', a)
...
def test_assoc_processSymbols296_link_reassign_clear():
    a = carnot_ProcessDefinitionType(defaultPriority="sample_text")
    b1 = carnot_ProcessSymbolType()
    b2 = carnot_ProcessSymbolType()
...
def test_assoc_qualityControl232_link_reassign_clear():
    a = carnot_ModelType(author="sample_text", carnotVersion="sample_text", created="sample_text", modelOID="sample_text", oid="sample_text", vendor="sample_text")
    b1 = carnot_QualityControlType()
    b2 = carnot_QualityControlType()
    _safe_set(a, 'carnot_ModelType233', b1)
    assert _is_linked(a, 'carnot_ModelType233', b1)
    if hasattr(b1, 'carnot_QualityControlType'):
        assert _is_linked(b1, 'carnot_QualityControlType', a)
    _safe_set(a, 'carnot_ModelType233', b2)
    assert _is_linked(a, 'carnot_ModelType233', b2)
    if hasattr(b1, 'carnot_QualityControlType'):
    ...
    _safe_set(a, 'carnot_ModelType233', None)
    assert not _is_linked(a, 'carnot_ModelType233', b2)
    if hasattr(b2, 'carnot_QualityControlType'):
...
def test_assoc_role234_link_reassign_clear():
    a = carnot_RoleType(cardinality=7)
    b1 = carnot_ModelType(author="sample_text", carnotVersion="sample_text", created="sample_text", modelOID="sample_text", oid="sample_text", vendor="sample_text")
    b2 = carnot_ModelType(author="sample_text_2", carnotVersion="sample_text_2", created="sample_text_2", modelOID="sample_text_2", oid="sample_text_2", vendor="sample_text_2")
    _safe_set(a, 'carnot_RoleType', b1)
    assert _is_linked(a, 'carnot_RoleType', b1)
    if hasattr(b1, 'carnot_ModelType235'):
        assert _is_linked(b1, 'carnot_ModelType235', a)
    _safe_set(a, 'carnot_RoleType', b2)
    assert _is_linked(a, 'carnot_RoleType', b2)
    if hasattr(b1, 'carnot_ModelType235'):
        assert not _is_linked(b1, 'carnot_ModelType235', a)
    if hasattr(b2, 'carnot_ModelType235'):
        assert _is_linked(b2, 'carnot_ModelType235', a)
    _safe_set(a, 'carnot_RoleType', None)
    assert not _is_linked(a, 'carnot_RoleType', b2)
    if hasattr(b2, 'carnot_ModelType235'):
        assert not _is_linked(b2, 'carnot_ModelType235', a)


def test_assoc_role312_link_reassign_clear():
    a = carnot_RoleType(cardinality=7)
    b1 = carnot_RoleSymbolType()
    b2 = carnot_RoleSymbolType()
    _safe_set(a, 'RoleType313', b1)
    assert _is_linked(a, 'RoleType313', b1)
    if hasattr(b1, 'roleSymbols'):
        assert _is_linked(b1, 'roleSymbols', a)
    _safe_set(a, 'RoleType313', b2)
    assert _is_linked(a, 'RoleType313', b2)
    if hasattr(b1, 'roleSymbols'):
        assert not _is_linked(b1, 'roleSymbols', a)
    if hasattr(b2, 'roleSymbols'):
        assert _is_linked(b2, 'roleSymbols', a)
    _safe_set(a, 'RoleType313', None)
    assert not _is_linked(a, 'RoleType313', b2)
    if hasattr(b2, 'roleSymbols'):
...
def test_assoc_roleSymbols321_link_reassign_clear():
    a = carnot_RoleType(cardinality=7)
    b1 = carnot_RoleSymbolType()
    b2 = carnot_RoleSymbolType()
    _safe_set(a, 'role', {b1})
...
def test_assoc_script244_link_reassign_clear():
    a = carnot_ModelType(author="sample_text", carnotVersion="sample_text", created="sample_text", modelOID="sample_text", oid="sample_text", vendor="sample_text")
    b1 = carnot_ScriptType()
    b2 = carnot_ScriptType()
    _safe_set(a, 'carnot_ModelType245', b1)
    assert _is_linked(a, 'carnot_ModelType245', b1)
    if hasattr(b1, 'carnot_ScriptType'):
        assert _is_linked(b1, 'carnot_ScriptType', a)
    _safe_set(a, 'carnot_ModelType245', b2)
    assert _is_linked(a, 'carnot_ModelType245', b2)
    if hasattr(b1, 'carnot_ScriptType'):
        assert not _is_linked(b1, 'carnot_ScriptType', a)
    if hasattr(b2, 'carnot_ScriptType'):
        assert _is_linked(b2, 'carnot_ScriptType', a)
    _safe_set(a, 'carnot_ModelType245', None)
    assert not _is_linked(a, 'carnot_ModelType245', b2)
    if hasattr(b2, 'carnot_ScriptType'):
        assert not _is_linked(b2, 'carnot_ScriptType', a)


def test_assoc_sourceActivitySymbol338_link_reassign_clear():
    a = carnot_TransitionConnectionType(points="sample_text")
    b1 = carnot_IFlowObjectSymbol()
    b2 = carnot_IFlowObjectSymbol()
...
def test_assoc_sourceSymbol197_link_reassign_clear():
    a = carnot_INodeSymbol(height="sample_text", shape="sample_text", width="sample_text", xPos="sample_text", yPos="sample_text")
    b1 = carnot_GenericLinkConnectionType()
    b2 = carnot_GenericLinkConnectionType()
...
def test_assoc_startActivity325_link_reassign_clear():
    a = carnot_ActivityType(allowsAbortByPerformer="sample_text", hibernateOnCreation="sample_text", implementation="sample_text", join="sample_text", loopCondition="sample_text", loopType="sample_text", split="sample_text", subProcessMode="sample_text")
    b1 = carnot_StartEventSymbol()
    b2 = carnot_StartEventSymbol()
    _safe_set(a, 'ActivityType327', b1)
    assert _is_linked(a, 'ActivityType327', b1)
    if hasattr(b1, 'startingEventSymbols326'):
        assert _is_linked(b1, 'startingEventSymbols326', a)
    _safe_set(a, 'ActivityType327', b2)
    assert _is_linked(a, 'ActivityType327', b2)
    if hasattr(b1, 'startingEventSymbols326'):
        assert not _is_linked(b1, 'startingEventSymbols326', a)
    if hasattr(b2, 'startingEventSymbols326'):
        assert _is_linked(b2, 'startingEventSymbols326', a)
    _safe_set(a, 'ActivityType327', None)
    assert not _is_linked(a, 'ActivityType327', b2)
    if hasattr(b2, 'startingEventSymbols326'):
        assert not _is_linked(b2, 'startingEventSymbols326', a)
...
def test_assoc_targetActivitySymbol339_link_reassign_clear():
    a = carnot_TransitionConnectionType(points="sample_text")
    b1 = carnot_IFlowObjectSymbol()
    b2 = carnot_IFlowObjectSymbol()
    _safe_set(a, 'inTransitions', b1)
    assert _is_linked(a, 'inTransitions', b1)
    if hasattr(b1, 'IFlowObjectSymbol340'):
        assert _is_linked(b1, 'IFlowObjectSymbol340', a)
    _safe_set(a, 'inTransitions', b2)
    assert _is_linked(a, 'inTransitions', b2)
    if hasattr(b1, 'IFlowObjectSymbol340'):
        assert not _is_linked(b1, 'IFlowObjectSymbol340', a)
    if hasattr(b2, 'IFlowObjectSymbol340'):
        assert _is_linked(b2, 'IFlowObjectSymbol340', a)
    _safe_set(a, 'inTransitions', None)
    assert not _is_linked(a, 'inTransitions', b2)
    if hasattr(b2, 'IFlowObjectSymbol340'):
        assert not _is_linked(b2, 'IFlowObjectSymbol340', a)


def test_assoc_targetSymbol198_link_reassign_clear():
    a = carnot_INodeSymbol(height="sample_text", shape="sample_text", width="sample_text", xPos="sample_text", yPos="sample_text")
    b1 = carnot_GenericLinkConnectionType()
    b2 = carnot_GenericLinkConnectionType()
    _safe_set(a, 'INodeSymbol199', b1)
    assert _is_linked(a, 'INodeSymbol199', b1)
    if hasattr(b1, 'inLinks'):
        assert _is_linked(b1, 'inLinks', a)
    _safe_set(a, 'INodeSymbol199', b2)
    assert _is_linked(a, 'INodeSymbol199', b2)
    if hasattr(b1, 'inLinks'):
        assert not _is_linked(b1, 'inLinks', a)
    if hasattr(b2, 'inLinks'):
        assert _is_linked(b2, 'inLinks', a)
    _safe_set(a, 'INodeSymbol199', None)
    assert not _is_linked(a, 'INodeSymbol199', b2)
    if hasattr(b2, 'inLinks'):
        assert not _is_linked(b2, 'inLinks', a)


def test_assoc_teamLead264_link_reassign_clear():
    a = carnot_RoleType(cardinality=7)
    b1 = carnot_OrganizationType()
    b2 = carnot_OrganizationType()
...
def test_assoc_teams319_link_reassign_clear():
    a = carnot_RoleType(cardinality=7)
    b1 = carnot_OrganizationType()
    b2 = carnot_OrganizationType()
    _safe_set(a, 'teamLead', {b1})
    assert _is_linked(a, 'teamLead', b1)
    if hasattr(b1, 'OrganizationType320'):
        assert _is_linked(b1, 'OrganizationType320', a)
    _safe_set(a, 'teamLead', {b2})
    assert _is_linked(a, 'teamLead', b2)
    if hasattr(b1, 'OrganizationType320'):
        assert not _is_linked(b1, 'OrganizationType320', a)
    if hasattr(b2, 'OrganizationType320'):
        assert _is_linked(b2, 'OrganizationType320', a)
    _safe_set(a, 'teamLead', set())
    assert not _is_linked(a, 'teamLead', b2)
    if hasattr(b2, 'OrganizationType320'):
        assert not _is_linked(b2, 'OrganizationType320', a)
...
def test_assoc_to310_link_reassign_clear():
    a = carnot_IGraphicalObject(borderColor="sample_text", fillColor="sample_text", style="sample_text")
    b1 = carnot_RefersToConnectionType()
    b2 = carnot_RefersToConnectionType()
    _safe_set(a, 'IGraphicalObject311', b1)
    assert _is_linked(a, 'IGraphicalObject311', b1)
    if hasattr(b1, 'referingToConnections'):
        assert _is_linked(b1, 'referingToConnections', a)
    _safe_set(a, 'IGraphicalObject311', b2)
    assert _is_linked(a, 'IGraphicalObject311', b2)
    if hasattr(b1, 'referingToConnections'):
    ...
    _safe_set(a, 'IGraphicalObject311', None)
    assert not _is_linked(a, 'IGraphicalObject311', b2)
    if hasattr(b2, 'referingToConnections'):
        assert not _is_linked(b2, 'referingToConnections', a)


def test_assoc_to349_link_reassign_clear():
    a = carnot_TransitionType(condition="sample_text", forkOnTraversal="sample_text")
    b1 = carnot_ActivityType(allowsAbortByPerformer="sample_text", hibernateOnCreation="sample_text", implementation="sample_text", join="sample_text", loopCondition="sample_text", loopType="sample_text", split="sample_text", subProcessMode="sample_text")
    b2 = carnot_ActivityType(allowsAbortByPerformer="sample_text_2", hibernateOnCreation="sample_text_2", implementation="sample_text_2", join="sample_text_2", loopCondition="sample_text_2", loopType="sample_text_2", split="sample_text_2", subProcessMode="sample_text_2")
    _safe_set(a, 'inTransitions350', b1)
    assert _is_linked(a, 'inTransitions350', b1)
    if hasattr(b1, 'ActivityType351'):
        assert _is_linked(b1, 'ActivityType351', a)
    _safe_set(a, 'inTransitions350', b2)
    assert _is_linked(a, 'inTransitions350', b2)
    if hasattr(b1, 'ActivityType351'):
        assert not _is_linked(b1, 'ActivityType351', a)
    if hasattr(b2, 'ActivityType351'):
        assert _is_linked(b2, 'ActivityType351', a)
    _safe_set(a, 'inTransitions350', None)
    assert not _is_linked(a, 'inTransitions350', b2)
    if hasattr(b2, 'ActivityType351'):
        assert not _is_linked(b2, 'ActivityType351', a)


def test_assoc_transition285_link_reassign_clear():
    a = carnot_TransitionType(condition="sample_text", forkOnTraversal="sample_text")
    ...
    if hasattr(b1, 'carnot_ProcessDefinitionType286'):
        assert _is_linked(b1, 'carnot_ProcessDefinitionType286', a)
    _safe_set(a, 'carnot_TransitionType', b2)
    assert _is_linked(a, 'carnot_TransitionType', b2)
    if hasattr(b1, 'carnot_ProcessDefinitionType286'):
        assert not _is_linked(b1, 'carnot_ProcessDefinitionType286', a)
    if hasattr(b2, 'carnot_ProcessDefinitionType286'):
        assert _is_linked(b2, 'carnot_ProcessDefinitionType286', a)
    _safe_set(a, 'carnot_TransitionType', None)
    assert not _is_linked(a, 'carnot_TransitionType', b2)
    if hasattr(b2, 'carnot_ProcessDefinitionType286'):
        assert not _is_linked(b2, 'carnot_ProcessDefinitionType286', a)


def test_assoc_transition341_link_reassign_clear():
    a = carnot_TransitionType(condition="sample_text", forkOnTraversal="sample_text")
    b1 = carnot_TransitionConnectionType(points="sample_text")
    b2 = carnot_TransitionConnectionType(points="sample_text_2")
    _safe_set(a, 'TransitionType342', b1)
    assert _is_linked(a, 'TransitionType342', b1)
    if hasattr(b1, 'transitionConnections'):
        assert _is_linked(b1, 'transitionConnections', a)
    _safe_set(a, 'TransitionType342', b2)
    assert _is_linked(a, 'TransitionType342', b2)
    if hasattr(b1, 'transitionConnections'):
    ...
    _safe_set(a, 'TransitionType342', None)
    assert not _is_linked(a, 'TransitionType342', b2)
    if hasattr(b2, 'transitionConnections'):
...
def test_assoc_transitionConnections352_link_reassign_clear():
    a = carnot_TransitionType(condition="sample_text", forkOnTraversal="sample_text")
    b1 = carnot_TransitionConnectionType(points="sample_text")
    b2 = carnot_TransitionConnectionType(points="sample_text_2")
    _safe_set(a, 'transition', {b1})
    assert _is_linked(a, 'transition', b1)
    if hasattr(b1, 'TransitionConnectionType353'):
        assert _is_linked(b1, 'TransitionConnectionType353', a)
    _safe_set(a, 'transition', {b2})
    assert _is_linked(a, 'transition', b2)
    if hasattr(b1, 'TransitionConnectionType353'):
        assert not _is_linked(b1, 'TransitionConnectionType353', a)
    if hasattr(b2, 'TransitionConnectionType353'):
        assert _is_linked(b2, 'TransitionConnectionType353', a)
    _safe_set(a, 'transition', set())
    assert not _is_linked(a, 'transition', b2)
    if hasattr(b2, 'TransitionConnectionType353'):
        assert not _is_linked(b2, 'TransitionConnectionType353', a)
...
def test_assoc_trigger287_link_reassign_clear():
    ...
    b1 = carnot_TriggerType()
    b2 = carnot_TriggerType()
    _safe_set(a, 'carnot_ProcessDefinitionType288', {b1})
    assert _is_linked(a, 'carnot_ProcessDefinitionType288', b1)
    if hasattr(b1, 'carnot_TriggerType'):
        assert _is_linked(b1, 'carnot_TriggerType', a)
    _safe_set(a, 'carnot_ProcessDefinitionType288', {b2})
    assert _is_linked(a, 'carnot_ProcessDefinitionType288', b2)
    if hasattr(b1, 'carnot_TriggerType'):
        assert not _is_linked(b1, 'carnot_TriggerType', a)
    if hasattr(b2, 'carnot_TriggerType'):
        assert _is_linked(b2, 'carnot_TriggerType', a)
    _safe_set(a, 'carnot_ProcessDefinitionType288', set())
    assert not _is_linked(a, 'carnot_ProcessDefinitionType288', b2)
    if hasattr(b2, 'carnot_TriggerType'):
        assert not _is_linked(b2, 'carnot_TriggerType', a)


def test_assoc_triggerType218_link_reassign_clear():
    ...
    if hasattr(b1, 'carnot_ModelType219'):
        assert _is_linked(b1, 'carnot_ModelType219', a)
    _safe_set(a, 'carnot_TriggerTypeType', b2)
    assert _is_linked(a, 'carnot_TriggerTypeType', b2)
    if hasattr(b1, 'carnot_ModelType219'):
        assert not _is_linked(b1, 'carnot_ModelType219', a)
    if hasattr(b2, 'carnot_ModelType219'):
        assert _is_linked(b2, 'carnot_ModelType219', a)
    _safe_set(a, 'carnot_TriggerTypeType', None)
    assert not _is_linked(a, 'carnot_TriggerTypeType', b2)
    if hasattr(b2, 'carnot_ModelType219'):
        assert not _is_linked(b2, 'carnot_ModelType219', a)


def test_assoc_triggers363_link_reassign_clear():
    a = carnot_TriggerTypeType(panelClass="sample_text", pullTrigger="sample_text", pullTriggerEvaluator="sample_text", rule="sample_text")
    b1 = carnot_TriggerType()
    b2 = carnot_TriggerType()
    _safe_set(a, 'type364', {b1})
    assert _is_linked(a, 'type364', b1)
    if hasattr(b1, 'TriggerType365'):
        assert _is_linked(b1, 'TriggerType365', a)
    _safe_set(a, 'type364', {b2})
    assert _is_linked(a, 'type364', b2)
    if hasattr(b1, 'TriggerType365'):
        assert not _is_linked(b1, 'TriggerType365', a)
    if hasattr(b2, 'TriggerType365'):
        assert _is_linked(b2, 'TriggerType365', a)
    _safe_set(a, 'type364', set())
    assert not _is_linked(a, 'type364', b2)
    if hasattr(b2, 'TriggerType365'):
        assert not _is_linked(b2, 'TriggerType365', a)
...
def test_assoc_typeDeclarations246_link_reassign_clear():
    a = carnot_ModelType(author="sample_text", carnotVersion="sample_text", created="sample_text", modelOID="sample_text", oid="sample_text", vendor="sample_text")
    b1 = carnot_TypeDeclarationsType()
    b2 = carnot_TypeDeclarationsType()
    _safe_set(a, 'carnot_ModelType247', b1)
    assert _is_linked(a, 'carnot_ModelType247', b1)
    if hasattr(b1, 'carnot_TypeDeclarationsType'):
        assert _is_linked(b1, 'carnot_TypeDeclarationsType', a)
    _safe_set(a, 'carnot_ModelType247', b2)
    assert _is_linked(a, 'carnot_ModelType247', b2)
    if hasattr(b1, 'carnot_TypeDeclarationsType'):
    ...
    _safe_set(a, 'carnot_ModelType247', None)
    assert not _is_linked(a, 'carnot_ModelType247', b2)
    if hasattr(b2, 'carnot_TypeDeclarationsType'):
...
def test_assoc_validQualityCodes107_link_reassign_clear():
    a = carnot_Code(code="sample_text", name="sample_text", value="sample_text")
    b1 = carnot_ActivityType(allowsAbortByPerformer="sample_text", hibernateOnCreation="sample_text", implementation="sample_text", join="sample_text", loopCondition="sample_text", loopType="sample_text", split="sample_text", subProcessMode="sample_text")
    b2 = carnot_ActivityType(allowsAbortByPerformer="sample_text_2", hibernateOnCreation="sample_text_2", implementation="sample_text_2", join="sample_text_2", loopCondition="sample_text_2", loopType="sample_text_2", split="sample_text_2", subProcessMode="sample_text_2")
...
def test_assoc_view252_link_reassign_clear():
    a = carnot_ViewType(name="sample_text")
    b1 = carnot_ModelType(author="sample_text", carnotVersion="sample_text", created="sample_text", modelOID="sample_text", oid="sample_text", vendor="sample_text")
    b2 = carnot_ModelType(author="sample_text_2", carnotVersion="sample_text_2", created="sample_text_2", modelOID="sample_text_2", oid="sample_text_2", vendor="sample_text_2")
    _safe_set(a, 'carnot_ViewType', b1)
    assert _is_linked(a, 'carnot_ViewType', b1)
    if hasattr(b1, 'carnot_ModelType253'):
        assert _is_linked(b1, 'carnot_ModelType253', a)
    _safe_set(a, 'carnot_ViewType', b2)
    assert _is_linked(a, 'carnot_ViewType', b2)
    if hasattr(b1, 'carnot_ModelType253'):
        assert not _is_linked(b1, 'carnot_ModelType253', a)
    if hasattr(b2, 'carnot_ModelType253'):
        assert _is_linked(b2, 'carnot_ModelType253', a)
    _safe_set(a, 'carnot_ViewType', None)
    assert not _is_linked(a, 'carnot_ViewType', b2)
    if hasattr(b2, 'carnot_ModelType253'):
        assert not _is_linked(b2, 'carnot_ModelType253', a)


def test_assoc_view371_link_reassign_clear():
    a = carnot_ViewType(name="sample_text")
    ...
    if hasattr(b1, 'carnot_ViewType372'):
        assert _is_linked(b1, 'carnot_ViewType372', a)
    _safe_set(a, 'carnot_ViewType370', {b2})
    assert _is_linked(a, 'carnot_ViewType370', b2)
    if hasattr(b1, 'carnot_ViewType372'):
        assert not _is_linked(b1, 'carnot_ViewType372', a)
    if hasattr(b2, 'carnot_ViewType372'):
        assert _is_linked(b2, 'carnot_ViewType372', a)
    _safe_set(a, 'carnot_ViewType370', set())
    assert not _is_linked(a, 'carnot_ViewType370', b2)
    if hasattr(b2, 'carnot_ViewType372'):
        assert not _is_linked(b2, 'carnot_ViewType372', a)


def test_assoc_viewable366_link_reassign_clear():
...
def test_assoc_viewable373_link_reassign_clear():
    a = carnot_ViewType(name="sample_text")
    b1 = carnot_ViewableType()
    b2 = carnot_ViewableType()
    _safe_set(a, 'carnot_ViewType374', {b1})
    assert _is_linked(a, 'carnot_ViewType374', b1)
    if hasattr(b1, 'carnot_ViewableType375'):
        assert _is_linked(b1, 'carnot_ViewableType375', a)
    _safe_set(a, 'carnot_ViewType374', {b2})
    assert _is_linked(a, 'carnot_ViewType374', b2)
    if hasattr(b1, 'carnot_ViewableType375'):
        assert not _is_linked(b1, 'carnot_ViewableType375', a)
    if hasattr(b2, 'carnot_ViewableType375'):
        assert _is_linked(b2, 'carnot_ViewableType375', a)
    _safe_set(a, 'carnot_ViewType374', set())
    assert not _is_linked(a, 'carnot_ViewType374', b2)
    if hasattr(b2, 'carnot_ViewableType375'):
        assert not _is_linked(b2, 'carnot_ViewableType375', a)
...
IdRefOwner_strategy = st.builds(IdRefOwner)
...
carnot_IdRefOwner_strategy = st.builds(carnot_IdRefOwner)
...
carnot_LoopType_strategy = st.builds(carnot_LoopType)
