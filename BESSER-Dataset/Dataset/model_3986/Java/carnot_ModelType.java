...
public class carnot_ModelType extends IExtensibleElement, IIdentifiableElement {
    ...
    public carnot_ModelType(
        String vendor,        String author,        String modelOID,        String created,        String oid,        String carnotVersion    ) {
        super(
        );
        this.vendor = vendor;
        this.author = author;
    ...
    public carnot_ModelType(
        String vendor,        String author,        String modelOID,        String created,        String oid,        String carnotVersion        ArrayList<carnot_DiagramType> carnot_diagramtypes,        ArrayList<carnot_ViewType> carnot_viewtypes    ) {
        this.vendor = vendor;
        this.author = author;
        this.modelOID = modelOID;
        this.created = created;
