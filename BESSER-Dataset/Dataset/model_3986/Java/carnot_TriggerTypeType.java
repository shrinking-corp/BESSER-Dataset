...
public class carnot_TriggerTypeType extends IMetaType {
    ...
    public carnot_TriggerTypeType(
        String panelClass,        String pullTrigger,        String pullTriggerEvaluator,        String rule    ) {
        super(
        );
    ...
    public carnot_TriggerTypeType(
        String panelClass,        String pullTrigger,        String pullTriggerEvaluator,        String rule        ArrayList<carnot_TriggerType> carnot_triggertypes    ) {
        this.panelClass = panelClass;
        this.pullTrigger = pullTrigger;
        this.pullTriggerEvaluator = pullTriggerEvaluator;
        this.rule = rule;
