...
class carnot_extensions_FormalParameterMappingsType:
    ...
    def setMappedData(self, carnot_data, carnot_formalParameter):
...
class carnot_DocumentRoot:
    ...
    def __init__(self, mixed: str, carnot_DocumentRoot174: set["carnot_ModelType"] = None, carnot_DocumentRoot: set["carnot_EStringToStringMapEntry"] = None, carnot_DocumentRoot171: set["carnot_EStringToStringMapEntry"] = None):
        self.mixed = mixed
...
class carnot_RoleType(IModelParticipant):
    ...
    def __init__(self, cardinality: int, RoleType: "carnot_OrganizationType" = None, carnot_RoleType: "carnot_ModelType" = None, RoleType313: "carnot_RoleSymbolType" = None, teamLead: set["carnot_OrganizationType"] = None, role: set["carnot_RoleSymbolType"] = None):
...
class carnot_EventConditionTypeType(IMetaType):
    ...
    def __init__(self, pullEventEmitterClass: str, rule: str, activityCondition: str, binderClass: str, implementation: str, panelClass: str, processCondition: str, type178: set["carnot_EventHandlerType"] = None, EventConditionTypeType: "carnot_EventHandlerType" = None, carnot_EventConditionTypeType: "carnot_ModelType" = None):
...
class carnot_ApplicationTypeType(IMetaType):
    ...
    def __init__(self, synchronous: str, validatorClass: str, accessPointProviderClass: str, instanceClass: str, panelClass: str, type125: set["carnot_ApplicationType"] = None, ApplicationTypeType: "carnot_ApplicationType" = None, carnot_ApplicationTypeType: "carnot_ModelType" = None):
...
class carnot_INodeSymbol(IGraphicalObject):
    ...
    def __init__(self, shape: str, xPos: str, yPos: str, width: str, height: str, targetSymbol: set["carnot_GenericLinkConnectionType"] = None, sourceSymbol: set["carnot_GenericLinkConnectionType"] = None, INodeSymbol: "carnot_GenericLinkConnectionType" = None, INodeSymbol199: "carnot_GenericLinkConnectionType" = None):
        self.shape = shape
        self.xPos = xPos
        self.yPos = yPos
        self.width = width
...
class IIdentifiableModelElement:
    ...
    pass
class carnot_TriggerType(ITypedElement, IIdentifiableModelElement, IAccessPointOwner):

    pass
class carnot_ProcessDefinitionType(IdRefOwner, IIdentifiableModelElement, IEventHandlerOwner):

    def __init__(self, defaultPriority: str, ProcessDefinitionType: "carnot_ActivityType" = None, carnot_ProcessDefinitionType: "carnot_ModelType" = None, carnot_ProcessDefinitionType283: set["carnot_ActivityType"] = None, carnot_ProcessDefinitionType286: set["carnot_TransitionType"] = None, carnot_ProcessDefinitionType279: "carnot_PoolSymbol" = None, carnot_ProcessDefinitionType298: "carnot_FormalParametersType" = None, carnot_ProcessDefinitionType300: "FormalParameterMappingsType" = None, carnot_ProcessDefinitionType288: set["carnot_TriggerType"] = None, ProcessDefinitionType302: "carnot_ProcessSymbolType" = None, carnot_ProcessDefinitionType290: set["carnot_DataPathType"] = None, carnot_ProcessDefinitionType292: set["carnot_DiagramType"] = None, implementationProcess: set["carnot_ActivityType"] = None, process: set["carnot_ProcessSymbolType"] = None):
...
class carnot_TransitionType(IIdentifiableModelElement):
    ...
    def __init__(self, condition: str, forkOnTraversal: str, TransitionType106: "carnot_ActivityType" = None, TransitionType: "carnot_ActivityType" = None, carnot_TransitionType: "carnot_ProcessDefinitionType" = None, carnot_TransitionType344: "carnot_XmlTextNode" = None, outTransitions347: "carnot_ActivityType" = None, TransitionType342: "carnot_TransitionConnectionType" = None, inTransitions350: "carnot_ActivityType" = None, transition: set["carnot_TransitionConnectionType"] = None):
...
class carnot_ApplicationType(ITypedElement, IIdentifiableModelElement, IAccessPointOwner):

    def __init__(self, interactive: str, ApplicationType: "carnot_ActivityType" = None, ApplicationType117: "carnot_ApplicationSymbolType" = None, ApplicationType126: "carnot_ApplicationTypeType" = None, carnot_ApplicationType: set["carnot_ContextType"] = None, applications: "carnot_ApplicationTypeType" = None, application: set["carnot_ActivityType"] = None, application123: set["carnot_ApplicationSymbolType"] = None, carnot_ApplicationType229: "carnot_ModelType" = None):
...
class carnot_ActivityType(IdRefOwner, IIdentifiableModelElement, IEventHandlerOwner):

    def __init__(self, hibernateOnCreation: str, implementation: str, allowsAbortByPerformer: str, join: str, loopCondition: str, loopType: str, split: str, subProcessMode: str, from_105: set["carnot_TransitionType"] = None, carnot_ActivityType108: set["carnot_Code"] = None, executingActivities: "carnot_ProcessDefinitionType" = None, performedActivities: "carnot_IModelParticipant" = None, carnot_ActivityType98: "carnot_IModelParticipant" = None, ActivityType: "carnot_IModelParticipant" = None, executedActivities: "carnot_ApplicationType" = None, ActivityType83: "carnot_ActivitySymbolType" = None, carnot_ActivityType: set["carnot_DataMappingType"] = None, activity: set["carnot_ActivitySymbolType"] = None, startActivity: set["carnot_StartEventSymbol"] = None, to103: set["carnot_TransitionType"] = None, carnot_ActivityType110: "carnot_LoopType" = None, ActivityType121: "carnot_ApplicationType" = None, carnot_ActivityType284: "carnot_ProcessDefinitionType" = None, ActivityType295: "carnot_ProcessDefinitionType" = None, ActivityType327: "carnot_StartEventSymbol" = None, ActivityType348: "carnot_TransitionType" = None, ActivityType351: "carnot_TransitionType" = None):
...
class carnot_AttributeType:
    ...
    def __init__(self, mixed: str, group: str, name: str, any: str, type: str, value: str, carnot_AttributeType: "carnot_IExtensibleElement" = None, AttributeType: "carnot_IdentifiableReference" = None, carnot_AttributeType128: "carnot_XmlTextNode" = None, attribute: "carnot_IdentifiableReference" = None):
        self.mixed = mixed
        self.group = group
        self.name = name
        self.any = any
...
class carnot_LinkTypeType(IExtensibleElement, IMetaType):
    ...
    def __init__(self, targetCardinality: str, lineStyle: str, lineColor: str, sourceRole: str, sourceClass: str, sourceCardinality: str, targetRole: str, targetClass: str, sourceSymbol: str, targetSymbol: str, showRoleNames: str, showLinkTypeName: str, LinkTypeType: "carnot_GenericLinkConnectionType" = None, linkType: set["carnot_GenericLinkConnectionType"] = None, carnot_LinkTypeType: "carnot_ModelType" = None):
...
class carnot_ISymbolContainer(IExtensibleElement):
    ...
    def __init__(self, nodes: str, connections: str, carnot_ISymbolContainer34: set["carnot_StartEventSymbol"] = None, carnot_ISymbolContainer28: set["carnot_ProcessSymbolType"] = None, carnot_ISymbolContainer30: set["carnot_PublicInterfaceSymbol"] = None, carnot_ISymbolContainer44: set["carnot_PartOfConnectionType"] = None, carnot_ISymbolContainer46: set["carnot_PerformsConnectionType"] = None, carnot_ISymbolContainer36: set["carnot_TextSymbolType"] = None, carnot_ISymbolContainer38: set["carnot_DataMappingConnectionType"] = None, carnot_ISymbolContainer40: set["carnot_ExecutedByConnectionType"] = None, carnot_ISymbolContainer: set["carnot_ActivitySymbolType"] = None, carnot_ISymbolContainer8: set["carnot_AnnotationSymbolType"] = None, carnot_ISymbolContainer10: set["carnot_ApplicationSymbolType"] = None, carnot_ISymbolContainer12: set["carnot_ConditionalPerformerSymbolType"] = None, carnot_ISymbolContainer22: set["carnot_IntermediateEventSymbol"] = None, carnot_ISymbolContainer24: set["carnot_ModelerSymbolType"] = None, carnot_ISymbolContainer26: set["carnot_OrganizationSymbolType"] = None, carnot_ISymbolContainer14: set["carnot_DataSymbolType"] = None, carnot_ISymbolContainer16: set["carnot_EndEventSymbol"] = None, carnot_ISymbolContainer18: set["carnot_GatewaySymbol"] = None, carnot_ISymbolContainer20: set["carnot_GroupSymbolType"] = None, carnot_ISymbolContainer32: set["carnot_RoleSymbolType"] = None, carnot_ISymbolContainer42: set["carnot_GenericLinkConnectionType"] = None, carnot_ISymbolContainer58: set["carnot_TeamLeadConnectionType"] = None, carnot_ISymbolContainer48: set["carnot_TriggersConnectionType"] = None, carnot_ISymbolContainer50: set["carnot_RefersToConnectionType"] = None, carnot_ISymbolContainer52: set["carnot_SubProcessOfConnectionType"] = None, carnot_ISymbolContainer54: set["carnot_TransitionConnectionType"] = None, carnot_ISymbolContainer56: set["carnot_WorksForConnectionType"] = None):
        self.nodes = nodes
...
class carnot_ModelType(IExtensibleElement, IIdentifiableElement):
    ...
    def __init__(self, author: str, carnotVersion: str, created: str, modelOID: str, oid: str, vendor: str, carnot_ModelType: "carnot_DocumentRoot" = None, carnot_ModelType253: set["carnot_ViewType"] = None, carnot_ModelType209: "carnot_DescriptionType" = None, carnot_ModelType212: set["carnot_DataTypeType"] = None, carnot_ModelType231: set["carnot_ModelerType"] = None, carnot_ModelType233: "carnot_QualityControlType" = None, carnot_ModelType235: set["carnot_RoleType"] = None, carnot_ModelType215: set["carnot_ApplicationTypeType"] = None, carnot_ModelType217: set["carnot_ApplicationContextTypeType"] = None, carnot_ModelType219: set["carnot_TriggerTypeType"] = None, carnot_ModelType221: set["carnot_EventConditionTypeType"] = None, carnot_ModelType223: set["carnot_EventActionTypeType"] = None, carnot_ModelType225: set["carnot_DataType"] = None, carnot_ModelType228: set["carnot_ApplicationType"] = None, carnot_ModelType249: set["carnot_DiagramType"] = None, carnot_ModelType251: set["carnot_LinkTypeType"] = None, carnot_ModelType237: set["carnot_OrganizationType"] = None, carnot_ModelType239: set["carnot_ConditionalPerformerType"] = None, carnot_ModelType241: set["carnot_ProcessDefinitionType"] = None, carnot_ModelType243: "carnot_ExternalPackages" = None, carnot_ModelType245: "carnot_ScriptType" = None, carnot_ModelType247: "carnot_TypeDeclarationsType" = None):
        self.author = author
...
class carnot_ContextType(IExtensibleElement, IAccessPointOwner, ITypedElement, IModelElement):
    ...
    pass
class carnot_DataMappingType(IExtensibleElement, IIdentifiableElement, IModelElement):
...
class carnot_IGraphicalObject(IModelElement):
    ...
    def __init__(self, borderColor: str, fillColor: str, style: str, to: set["carnot_RefersToConnectionType"] = None, from_: set["carnot_RefersToConnectionType"] = None, IGraphicalObject: "carnot_RefersToConnectionType" = None, IGraphicalObject311: "carnot_RefersToConnectionType" = None):
...
class carnot_ViewType(IExtensibleElement, IModelElement):
    ...
    def __init__(self, name: str, carnot_ViewType: "carnot_ModelType" = None, carnot_ViewType368: "carnot_DescriptionType" = None, carnot_ViewType372: "carnot_ViewType" = None, carnot_ViewType370: set["carnot_ViewType"] = None, carnot_ViewType374: set["carnot_ViewableType"] = None):
        self.name = name
...
class carnot_DiagramType(ISymbolContainer, IExtensibleElement, IModelElement):
...
class carnot_IIdentifiableModelElement(IExtensibleElement, IIdentifiableElement, IModelElement):
