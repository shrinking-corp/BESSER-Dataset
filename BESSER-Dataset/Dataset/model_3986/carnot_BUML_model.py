...
# Classes
carnot_Coordinates = Class(name="carnot_Coordinates")
carnot_IIdentifiableModelElement = Class(name="carnot_IIdentifiableModelElement", is_abstract=True)
...
carnot_DescriptionType = Class(name="carnot_DescriptionType")
carnot_IEventHandlerOwner = Class(name="carnot_IEventHandlerOwner", is_abstract=True)
carnot_EventHandlerType = Class(name="carnot_EventHandlerType")
carnot_IIdentifiableElement = Class(name="carnot_IIdentifiableElement", is_abstract=True)
carnot_IExtensibleElement = Class(name="carnot_IExtensibleElement")
carnot_AttributeType = Class(name="carnot_AttributeType")
carnot_IdentifiableReference = Class(name="carnot_IdentifiableReference")
carnot_EObject = Class(name="carnot_EObject")
carnot_IModelElement = Class(name="carnot_IModelElement", is_abstract=True)
carnot_AnnotationSymbolType = Class(name="carnot_AnnotationSymbolType")
carnot_ApplicationSymbolType = Class(name="carnot_ApplicationSymbolType")
carnot_ConditionalPerformerSymbolType = Class(name="carnot_ConditionalPerformerSymbolType")
carnot_IAccessPointOwner = Class(name="carnot_IAccessPointOwner", is_abstract=True)
carnot_AccessPointType = Class(name="carnot_AccessPointType")
carnot_IMetaType = Class(name="carnot_IMetaType", is_abstract=True)
IIdentifiableModelElement = Class(name="IIdentifiableModelElement")
carnot_ITypedElement = Class(name="carnot_ITypedElement", is_abstract=True)
carnot_ISymbolContainer = Class(name="carnot_ISymbolContainer", is_abstract=True)
carnot_ActivitySymbolType = Class(name="carnot_ActivitySymbolType")
carnot_ModelerSymbolType = Class(name="carnot_ModelerSymbolType")
carnot_OrganizationSymbolType = Class(name="carnot_OrganizationSymbolType")
carnot_DataSymbolType = Class(name="carnot_DataSymbolType")
carnot_EndEventSymbol = Class(name="carnot_EndEventSymbol")
carnot_GatewaySymbol = Class(name="carnot_GatewaySymbol")
carnot_GroupSymbolType = Class(name="carnot_GroupSymbolType")
carnot_IntermediateEventSymbol = Class(name="carnot_IntermediateEventSymbol")
carnot_RoleSymbolType = Class(name="carnot_RoleSymbolType")
carnot_StartEventSymbol = Class(name="carnot_StartEventSymbol")
carnot_ProcessSymbolType = Class(name="carnot_ProcessSymbolType")
carnot_PublicInterfaceSymbol = Class(name="carnot_PublicInterfaceSymbol")
carnot_PartOfConnectionType = Class(name="carnot_PartOfConnectionType")
carnot_PerformsConnectionType = Class(name="carnot_PerformsConnectionType")
carnot_TextSymbolType = Class(name="carnot_TextSymbolType")
carnot_DataMappingConnectionType = Class(name="carnot_DataMappingConnectionType")
carnot_ExecutedByConnectionType = Class(name="carnot_ExecutedByConnectionType")
carnot_GenericLinkConnectionType = Class(name="carnot_GenericLinkConnectionType")
carnot_TeamLeadConnectionType = Class(name="carnot_TeamLeadConnectionType")
carnot_IGraphicalObject = Class(name="carnot_IGraphicalObject", is_abstract=True)
carnot_TriggersConnectionType = Class(name="carnot_TriggersConnectionType")
carnot_RefersToConnectionType = Class(name="carnot_RefersToConnectionType")
carnot_SubProcessOfConnectionType = Class(name="carnot_SubProcessOfConnectionType")
carnot_TransitionConnectionType = Class(name="carnot_TransitionConnectionType")
carnot_WorksForConnectionType = Class(name="carnot_WorksForConnectionType")
carnot_ISwimlaneSymbol = Class(name="carnot_ISwimlaneSymbol", is_abstract=True)
INodeSymbol = Class(name="INodeSymbol")
carnot_INodeSymbol = Class(name="carnot_INodeSymbol", is_abstract=True)
IGraphicalObject = Class(name="IGraphicalObject")
carnot_IModelParticipant = Class(name="carnot_IModelParticipant", is_abstract=True)
carnot_LaneSymbol = Class(name="carnot_LaneSymbol")
carnot_IModelElementNodeSymbol = Class(name="carnot_IModelElementNodeSymbol", is_abstract=True)
carnot_IFlowObjectSymbol = Class(name="carnot_IFlowObjectSymbol", is_abstract=True)
carnot_IConnectionSymbol = Class(name="carnot_IConnectionSymbol", is_abstract=True)
carnot_AbstractEventSymbol = Class(name="carnot_AbstractEventSymbol", is_abstract=True)
IFlowObjectSymbol = Class(name="IFlowObjectSymbol")
carnot_DataTypeType = Class(name="carnot_DataTypeType")
carnot_ActivityType = Class(name="carnot_ActivityType")
carnot_ParticipantType = Class(name="carnot_ParticipantType")
carnot_IModelParticipantSymbol = Class(name="carnot_IModelParticipantSymbol", is_abstract=True)
IModelElementNodeSymbol = Class(name="IModelElementNodeSymbol")
carnot_AbstractEventAction = Class(name="carnot_AbstractEventAction", is_abstract=True)
ITypedElement = Class(name="ITypedElement")
carnot_EventActionTypeType = Class(name="carnot_EventActionTypeType")
carnot_ApplicationType = Class(name="carnot_ApplicationType")
IEventHandlerOwner = Class(name="IEventHandlerOwner")
IdRefOwner = Class(name="IdRefOwner")
carnot_DataMappingType = Class(name="carnot_DataMappingType")
carnot_TransitionType = Class(name="carnot_TransitionType")
carnot_Code = Class(name="carnot_Code")
carnot_ProcessDefinitionType = Class(name="carnot_ProcessDefinitionType")
IAccessPointOwner = Class(name="IAccessPointOwner")
carnot_LoopType = Class(name="carnot_LoopType")
carnot_TextType = Class(name="carnot_TextType")
carnot_ApplicationContextTypeType = Class(name="carnot_ApplicationContextTypeType")
IMetaType = Class(name="IMetaType")
carnot_ContextType = Class(name="carnot_ContextType")
carnot_ApplicationTypeType = Class(name="carnot_ApplicationTypeType")
carnot_XmlTextNode = Class(name="carnot_XmlTextNode")
carnot_ConditionalPerformerType = Class(name="carnot_ConditionalPerformerType")
IModelParticipant = Class(name="IModelParticipant")
carnot_DataType = Class(name="carnot_DataType")
carnot_BindActionType = Class(name="carnot_BindActionType")
...
carnot_DataPathType = Class(name="carnot_DataPathType")
carnot_DiagramType = Class(name="carnot_DiagramType")
ISymbolContainer = Class(name="ISymbolContainer")
carnot_ParameterMappingType = Class(name="carnot_ParameterMappingType")
carnot_ExternalReferenceType = Class(name="carnot_ExternalReferenceType")
carnot_ModelType = Class(name="carnot_ModelType")
AbstractEventSymbol = Class(name="AbstractEventSymbol")
carnot_EventActionType = Class(name="carnot_EventActionType")
carnot_PoolSymbol = Class(name="carnot_PoolSymbol")
carnot_DocumentRoot = Class(name="carnot_DocumentRoot")
carnot_EStringToStringMapEntry = Class(name="carnot_EStringToStringMapEntry")
carnot_EventConditionTypeType = Class(name="carnot_EventConditionTypeType")
carnot_UnbindActionType = Class(name="carnot_UnbindActionType")
carnot_IdRef = Class(name="carnot_IdRef")
carnot_ExternalPackage = Class(name="carnot_ExternalPackage")
carnot_IdRefOwner = Class(name="carnot_IdRefOwner", is_abstract=True)
carnot_LinkTypeType = Class(name="carnot_LinkTypeType")
ISwimlaneSymbol = Class(name="ISwimlaneSymbol")
carnot_ModelerType = Class(name="carnot_ModelerType")
carnot_QualityControlType = Class(name="carnot_QualityControlType")
carnot_RoleType = Class(name="carnot_RoleType")
carnot_TriggerTypeType = Class(name="carnot_TriggerTypeType")
carnot_OrganizationType = Class(name="carnot_OrganizationType")
carnot_ExternalPackages = Class(name="carnot_ExternalPackages")
carnot_ScriptType = Class(name="carnot_ScriptType")
carnot_TypeDeclarationsType = Class(name="carnot_TypeDeclarationsType")
carnot_ViewType = Class(name="carnot_ViewType")
carnot_FormalParametersType = Class(name="carnot_FormalParametersType")
FormalParameterMappingsType = Class(name="FormalParameterMappingsType")
carnot_TriggerType = Class(name="carnot_TriggerType")
carnot_ViewableType = Class(name="carnot_ViewableType")
carnot_extensions_FormalParameterMappingType = Class(name="carnot_extensions_FormalParameterMappingType")
extensions_carnot_DataType = Class(name="extensions_carnot_DataType")
extensions_carnot_FormalParameterType = Class(name="extensions_carnot_FormalParameterType")
carnot_extensions_FormalParameterMappingsType = Class(name="carnot_extensions_FormalParameterMappingsType")
...
carnot_Coordinates.attributes={carnot_Coordinates_yPos, carnot_Coordinates_xPos}
...
carnot_AttributeType_m_setAttributeValue: Method = Method(name="setAttributeValue", parameters={Parameter(name='carnot_type', type=StringType), Parameter(name='carnot_value', type=StringType)})
carnot_AttributeType.attributes={carnot_AttributeType_group, carnot_AttributeType_any, carnot_AttributeType_name, carnot_AttributeType_mixed, carnot_AttributeType_value, carnot_AttributeType_type}
carnot_AttributeType.methods={carnot_AttributeType_m_getAttributeValue, carnot_AttributeType_m_setAttributeValue}
...
carnot_IGraphicalObject.attributes={carnot_IGraphicalObject_fillColor, carnot_IGraphicalObject_borderColor, carnot_IGraphicalObject_style}
...
carnot_INodeSymbol.attributes={carnot_INodeSymbol_yPos, carnot_INodeSymbol_width, carnot_INodeSymbol_shape, carnot_INodeSymbol_height, carnot_INodeSymbol_xPos}
...
carnot_IModelElementNodeSymbol_m_setModelElement: Method = Method(name="setModelElement", parameters={Parameter(name='carnot_element', type=StringType)})
...
carnot_IConnectionSymbol_m_setSourceNode: Method = Method(name="setSourceNode", parameters={Parameter(name='carnot_nodeSymbol', type=StringType)})
carnot_IConnectionSymbol_m_getTargetNode: Method = Method(name="getTargetNode", parameters={}, type=INodeSymbol)
carnot_IConnectionSymbol_m_setTargetNode: Method = Method(name="setTargetNode", parameters={Parameter(name='carnot_nodeSymbol', type=StringType)})
carnot_IConnectionSymbol_m_getSourceNode: Method = Method(name="getSourceNode", parameters={}, type=INodeSymbol)
carnot_IConnectionSymbol.attributes={carnot_IConnectionSymbol_targetAnchor, carnot_IConnectionSymbol_routing, carnot_IConnectionSymbol_sourceAnchor}
carnot_IConnectionSymbol.methods={carnot_IConnectionSymbol_m_setTargetNode, carnot_IConnectionSymbol_m_getSourceNode, carnot_IConnectionSymbol_m_setSourceNode, carnot_IConnectionSymbol_m_getTargetNode}
...
carnot_DataTypeType.attributes={carnot_DataTypeType_storageStrategy, carnot_DataTypeType_evaluator, carnot_DataTypeType_panelClass, carnot_DataTypeType_accessPathEditor, carnot_DataTypeType_readable, carnot_DataTypeType_valueCreator, carnot_DataTypeType_writable, carnot_DataTypeType_instanceClass, carnot_DataTypeType_validatorClass}
...
carnot_ActivityType.attributes={carnot_ActivityType_implementation, carnot_ActivityType_join, carnot_ActivityType_loopCondition, carnot_ActivityType_subProcessMode, carnot_ActivityType_allowsAbortByPerformer, carnot_ActivityType_loopType, carnot_ActivityType_split, carnot_ActivityType_hibernateOnCreation}
...
carnot_EventActionTypeType.attributes={carnot_EventActionTypeType_actionClass, carnot_EventActionTypeType_activityAction, carnot_EventActionTypeType_unsupportedContexts, carnot_EventActionTypeType_panelClass, carnot_EventActionTypeType_processAction, carnot_EventActionTypeType_supportedConditionTypes}
...
carnot_DataMappingType.attributes={carnot_DataMappingType_direction, carnot_DataMappingType_applicationPath, carnot_DataMappingType_applicationAccessPoint, carnot_DataMappingType_context, carnot_DataMappingType_dataPath}
...
carnot_Code.attributes={carnot_Code_code, carnot_Code_value, carnot_Code_name}
...
carnot_ApplicationContextTypeType.attributes={carnot_ApplicationContextTypeType_accessPointProviderClass, carnot_ApplicationContextTypeType_hasMappingId, carnot_ApplicationContextTypeType_hasApplicationPath, carnot_ApplicationContextTypeType_panelClass, carnot_ApplicationContextTypeType_validatorClass}
...
carnot_ApplicationTypeType.attributes={carnot_ApplicationTypeType_synchronous, carnot_ApplicationTypeType_panelClass, carnot_ApplicationTypeType_accessPointProviderClass, carnot_ApplicationTypeType_validatorClass, carnot_ApplicationTypeType_instanceClass}
...
carnot_ConditionalPerformerType.attributes={carnot_ConditionalPerformerType_dataPath, carnot_ConditionalPerformerType_isUser}
...
carnot_DiagramType.attributes={carnot_DiagramType_mode, carnot_DiagramType_name, carnot_DiagramType_orientation}
...
carnot_ParameterMappingType.attributes={carnot_ParameterMappingType_parameter, carnot_ParameterMappingType_dataPath, carnot_ParameterMappingType_parameterPath}
...
carnot_ModelType.attributes={carnot_ModelType_modelOID, carnot_ModelType_vendor, carnot_ModelType_author, carnot_ModelType_oid, carnot_ModelType_created, carnot_ModelType_carnotVersion}
...
carnot_EventConditionTypeType.attributes={carnot_EventConditionTypeType_activityCondition, carnot_EventConditionTypeType_implementation, carnot_EventConditionTypeType_rule, carnot_EventConditionTypeType_processCondition, carnot_EventConditionTypeType_panelClass, carnot_EventConditionTypeType_pullEventEmitterClass, carnot_EventConditionTypeType_binderClass}
...
carnot_LinkTypeType.attributes={carnot_LinkTypeType_sourceClass, carnot_LinkTypeType_targetSymbol, carnot_LinkTypeType_targetRole, carnot_LinkTypeType_sourceRole, carnot_LinkTypeType_targetCardinality, carnot_LinkTypeType_showLinkTypeName, carnot_LinkTypeType_lineStyle, carnot_LinkTypeType_sourceCardinality, carnot_LinkTypeType_showRoleNames, carnot_LinkTypeType_sourceSymbol, carnot_LinkTypeType_lineColor, carnot_LinkTypeType_targetClass}
...
carnot_TriggerTypeType.attributes={carnot_TriggerTypeType_pullTriggerEvaluator, carnot_TriggerTypeType_rule, carnot_TriggerTypeType_pullTrigger, carnot_TriggerTypeType_panelClass}
...
carnot_extensions_FormalParameterMappingsType_m_getMappedData: Method = Method(name="getMappedData", parameters={Parameter(name='carnot_formalParameter', type=StringType)}, type=StringType)
carnot_extensions_FormalParameterMappingsType_m_setMappedData: Method = Method(name="setMappedData", parameters={Parameter(name='carnot_formalParameter', type=StringType), Parameter(name='carnot_data', type=StringType)})
carnot_extensions_FormalParameterMappingsType.methods={carnot_extensions_FormalParameterMappingsType_m_setMappedData, carnot_extensions_FormalParameterMappingsType_m_getMappedData}
...
referingFromConnections60: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_", type=carnot_RefersToConnectionType, multiplicity=Multiplicity(0, 9999))
    }
)
...
outTransitions104: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_105", type=carnot_TransitionType, multiplicity=Multiplicity(0, 9999))
    }
)
...
from_309: BinaryAssociation = BinaryAssociation(
    name="from_309",
    ends={
...
from_346: BinaryAssociation = BinaryAssociation(
    name="from_346",
    ends={
...
domain_model = DomainModel(
    name="carnot",
    types={carnot_Coordinates, carnot_IIdentifiableModelElement, IModelElement, IIdentifiableElement, IExtensibleElement, carnot_DescriptionType, carnot_IEventHandlerOwner, carnot_EventHandlerType, carnot_IIdentifiableElement, carnot_IExtensibleElement, carnot_AttributeType, carnot_IdentifiableReference, carnot_EObject, carnot_IModelElement, carnot_AnnotationSymbolType, carnot_ApplicationSymbolType, carnot_ConditionalPerformerSymbolType, carnot_IAccessPointOwner, carnot_AccessPointType, carnot_IMetaType, IIdentifiableModelElement, carnot_ITypedElement, carnot_ISymbolContainer, carnot_ActivitySymbolType, carnot_ModelerSymbolType, carnot_OrganizationSymbolType, carnot_DataSymbolType, carnot_EndEventSymbol, carnot_GatewaySymbol, carnot_GroupSymbolType, carnot_IntermediateEventSymbol, carnot_RoleSymbolType, carnot_StartEventSymbol, carnot_ProcessSymbolType, carnot_PublicInterfaceSymbol, carnot_PartOfConnectionType, carnot_PerformsConnectionType, carnot_TextSymbolType, carnot_DataMappingConnectionType, carnot_ExecutedByConnectionType, carnot_GenericLinkConnectionType, carnot_TeamLeadConnectionType, carnot_IGraphicalObject, carnot_TriggersConnectionType, carnot_RefersToConnectionType, carnot_SubProcessOfConnectionType, carnot_TransitionConnectionType, carnot_WorksForConnectionType, carnot_ISwimlaneSymbol, INodeSymbol, carnot_INodeSymbol, IGraphicalObject, carnot_IModelParticipant, carnot_LaneSymbol, carnot_IModelElementNodeSymbol, carnot_IFlowObjectSymbol, carnot_IConnectionSymbol, carnot_AbstractEventSymbol, IFlowObjectSymbol, carnot_DataTypeType, carnot_ActivityType, carnot_ParticipantType, carnot_IModelParticipantSymbol, IModelElementNodeSymbol, carnot_AbstractEventAction, ITypedElement, carnot_EventActionTypeType, carnot_ApplicationType, IEventHandlerOwner, IdRefOwner, carnot_DataMappingType, carnot_TransitionType, carnot_Code, carnot_ProcessDefinitionType, IAccessPointOwner, carnot_LoopType, carnot_TextType, carnot_ApplicationContextTypeType, IMetaType, carnot_ContextType, carnot_ApplicationTypeType, carnot_XmlTextNode, carnot_ConditionalPerformerType, IModelParticipant, carnot_DataType, carnot_BindActionType, AbstractEventAction, IModelParticipantSymbol, IConnectionSymbol, carnot_DataPathType, carnot_DiagramType, ISymbolContainer, carnot_ParameterMappingType, carnot_ExternalReferenceType, carnot_ModelType, AbstractEventSymbol, carnot_EventActionType, carnot_PoolSymbol, carnot_DocumentRoot, carnot_EStringToStringMapEntry, carnot_EventConditionTypeType, carnot_UnbindActionType, carnot_IdRef, carnot_ExternalPackage, carnot_IdRefOwner, carnot_LinkTypeType, ISwimlaneSymbol, carnot_ModelerType, carnot_QualityControlType, carnot_RoleType, carnot_TriggerTypeType, carnot_OrganizationType, carnot_ExternalPackages, carnot_ScriptType, carnot_TypeDeclarationsType, carnot_ViewType, carnot_FormalParametersType, FormalParameterMappingsType, carnot_TriggerType, carnot_ViewableType, carnot_extensions_FormalParameterMappingType, extensions_carnot_DataType, extensions_carnot_FormalParameterType, carnot_extensions_FormalParameterMappingsType, FormalParameterMappingType, LinkColor, LinkLineStyle, LinkEndStyle, LoopType, ActivityImplementationType, DirectionType, FlowControlType, ImplementationType, JoinSplitType, LinkCardinality, OrientationType, RoutingType, SubProcessModeType, DiagramModeType},
    associations={description3, eventHandler4, attribute0, attribute1, identifiable2, activitySymbol6, annotationSymbol7, applicationSymbol9, conditionalPerformerSymbol11, accessPoint5, intermediateEventSymbols21, modelerSymbol23, organizationSymbol25, dataSymbol13, endEventSymbols15, gatewaySymbol17, groupSymbol19, roleSymbol31, startEventSymbols33, processSymbol27, processInterfaceSymbols29, partOfConnection43, performsConnection45, textSymbol35, dataMappingConnection37, executedByConnection39, genericLinkConnection41, teamLeadConnection57, triggersConnection47, refersToConnection49, subProcessOfConnection51, transitionConnection53, worksForConnection55, inLinks62, outLinks63, referingToConnections59, referingFromConnections60, participant65, childLanes66, participantReference67, inTransitions68, outTransitions69, type80, coordinates71, performedActivities72, performedSwimlanes73, participantAssociations74, performedActivities76, triggeredEvents77, type79, application93, activity82, performsConnections84, executedByConnections86, dataMappings88, gatewaySymbols90, dataMapping92, activitySymbols100, startingEventSymbols101, inTransitions102, outTransitions104, validQualityCodes107, implementationProcess94, performer95, qualityControlPerformer97, executingActivities114, application116, loop109, text111, contexts113, applications124, context118, type119, executedActivities120, applicationSymbols122, valueNode127, participant130, data131, reference129, data142, conditionalPerformerSymbols132, description134, type137, activitySymbol138, dataSymbol140, data147, dataMappings149, dataMappings151, type152, data145, data165, dataSymbols154, conditionalPerformers157, dataPaths160, parameterMappings162, externalReference164, model173, poolSymbols168, xMLNSPrefixMap169, xSISchemaLocation170, eventHandlers177, actionInstances175, activitySymbol186, bindAction179, eventAction181, unbindAction183, type185, sourceSymbol197, targetSymbol198, applicationSymbol188, packageRef191, externalRef192, activitySymbol194, linkType196, parentPool200, parentLane202, description208, dataType211, linkInstances204, modeler206, modelerSymbols207, modeler230, qualityControl232, role234, applicationType214, applicationContextType216, triggerType218, eventConditionType220, eventActionType222, data224, application227, diagram248, linkType250, organization236, conditionalPerformer238, processDefinition240, externalPackages242, script244, typeDeclarations246, superOrganizations255, subOrganizations256, memberRoles258, teamLead260, participant261, view252, organization254, organizationSymbol269, suborganizationSymbol271, organizationSymbols263, teamLead264, data265, participant267, activity282, transition285, activitySymbol273, participantSymbol275, diagram277, process278, lanes280, formalParameters297, formalParameterMappings299, trigger287, process301, dataPath289, diagram291, executingActivities294, processSymbols296, role312, organizationMemberships314, teams317, subProcesses303, parentProcesses304, Code306, from_309, to310, processSymbol328, subprocessSymbol330, teamSymbol332, teamLeadSymbol335, teams319, roleSymbols321, trigger322, triggersConnections323, startActivity325, expression343, from_346, sourceActivitySymbol338, targetActivitySymbol339, transition341, parameterMapping358, type360, startingEventSymbols361, to349, transitionConnections352, startEventSymbol354, participantSymbol356, viewable373, organizationSymbol376, triggers363, viewable366, description367, view371, participantSymbol378, mapping383, data380, parameter381},
    generalizations={gen_carnot_IIdentifiableModelElement_IModelElement, gen_carnot_IIdentifiableModelElement_IIdentifiableElement, gen_carnot_IIdentifiableModelElement_IExtensibleElement, gen_carnot_IMetaType_IIdentifiableModelElement, gen_carnot_ISymbolContainer_IExtensibleElement, gen_carnot_IGraphicalObject_IModelElement, gen_carnot_ISwimlaneSymbol_INodeSymbol, gen_carnot_ISwimlaneSymbol_IIdentifiableElement, gen_carnot_INodeSymbol_IGraphicalObject, gen_carnot_IModelElementNodeSymbol_INodeSymbol, gen_carnot_IFlowObjectSymbol_INodeSymbol, gen_carnot_IConnectionSymbol_IGraphicalObject, gen_carnot_AbstractEventSymbol_IFlowObjectSymbol, gen_carnot_AbstractEventSymbol_IModelElementNodeSymbol, gen_carnot_AccessPointType_IIdentifiableModelElement, gen_carnot_AccessPointType_ITypedElement, gen_carnot_IModelParticipant_IIdentifiableModelElement, gen_carnot_IModelParticipantSymbol_IModelElementNodeSymbol, gen_carnot_AbstractEventAction_IIdentifiableModelElement, gen_carnot_AbstractEventAction_ITypedElement, gen_carnot_ActivitySymbolType_IFlowObjectSymbol, gen_carnot_ActivitySymbolType_IModelElementNodeSymbol, gen_carnot_ActivityType_IIdentifiableModelElement, gen_carnot_ActivityType_IEventHandlerOwner, gen_carnot_ActivityType_IdRefOwner, gen_carnot_ApplicationSymbolType_IModelElementNodeSymbol, gen_carnot_ApplicationType_IIdentifiableModelElement, gen_carnot_ApplicationType_ITypedElement, gen_carnot_ApplicationType_IAccessPointOwner, gen_carnot_AnnotationSymbolType_INodeSymbol, gen_carnot_ApplicationContextTypeType_IMetaType, gen_carnot_ApplicationTypeType_IMetaType, gen_carnot_ConditionalPerformerType_IModelParticipant, gen_carnot_BindActionType_AbstractEventAction, gen_carnot_ConditionalPerformerSymbolType_IModelParticipantSymbol, gen_carnot_DataMappingType_IModelElement, gen_carnot_DataMappingType_IIdentifiableElement, gen_carnot_DataMappingType_IExtensibleElement, gen_carnot_ContextType_IModelElement, gen_carnot_ContextType_IExtensibleElement, gen_carnot_ContextType_ITypedElement, gen_carnot_ContextType_IAccessPointOwner, gen_carnot_DataMappingConnectionType_IConnectionSymbol, gen_carnot_DataType_IIdentifiableModelElement, gen_carnot_DataType_ITypedElement, gen_carnot_DataPathType_IIdentifiableModelElement, gen_carnot_DataSymbolType_IModelElementNodeSymbol, gen_carnot_DiagramType_ISymbolContainer, gen_carnot_DiagramType_IModelElement, gen_carnot_DiagramType_IExtensibleElement, gen_carnot_DataTypeType_IMetaType, gen_carnot_EndEventSymbol_AbstractEventSymbol, gen_carnot_EventActionType_AbstractEventAction, gen_carnot_EventActionTypeType_IMetaType, gen_carnot_EventHandlerType_IIdentifiableModelElement, gen_carnot_EventHandlerType_ITypedElement, gen_carnot_EventConditionTypeType_IMetaType, gen_carnot_ExecutedByConnectionType_IConnectionSymbol, gen_carnot_EventHandlerType_IAccessPointOwner, gen_carnot_GatewaySymbol_IFlowObjectSymbol, gen_carnot_GenericLinkConnectionType_IConnectionSymbol, gen_carnot_GenericLinkConnectionType_ITypedElement, gen_carnot_GroupSymbolType_ISymbolContainer, gen_carnot_GroupSymbolType_INodeSymbol, gen_carnot_IntermediateEventSymbol_AbstractEventSymbol, gen_carnot_LaneSymbol_ISymbolContainer, gen_carnot_LaneSymbol_ISwimlaneSymbol, gen_carnot_LinkTypeType_IMetaType, gen_carnot_LinkTypeType_IExtensibleElement, gen_carnot_ModelType_IIdentifiableElement, gen_carnot_ModelType_IExtensibleElement, gen_carnot_ModelerSymbolType_IModelElementNodeSymbol, gen_carnot_ModelerType_IIdentifiableModelElement, gen_carnot_OrganizationType_IModelParticipant, gen_carnot_OrganizationSymbolType_IModelParticipantSymbol, gen_carnot_PartOfConnectionType_IConnectionSymbol, gen_carnot_ParameterMappingType_IModelElement, gen_carnot_PerformsConnectionType_IConnectionSymbol, gen_carnot_PoolSymbol_ISymbolContainer, gen_carnot_PoolSymbol_ISwimlaneSymbol, gen_carnot_ProcessDefinitionType_IIdentifiableModelElement, gen_carnot_ProcessDefinitionType_IEventHandlerOwner, gen_carnot_ProcessDefinitionType_IdRefOwner, gen_carnot_ProcessSymbolType_IModelElementNodeSymbol, gen_carnot_RoleSymbolType_IModelParticipantSymbol, gen_carnot_RoleType_IModelParticipant, gen_carnot_PublicInterfaceSymbol_AbstractEventSymbol, gen_carnot_RefersToConnectionType_IConnectionSymbol, gen_carnot_TeamLeadConnectionType_IConnectionSymbol, gen_carnot_StartEventSymbol_AbstractEventSymbol, gen_carnot_SubProcessOfConnectionType_IConnectionSymbol, gen_carnot_TransitionType_IIdentifiableModelElement, gen_carnot_TextSymbolType_INodeSymbol, gen_carnot_TransitionConnectionType_IConnectionSymbol, gen_carnot_TriggersConnectionType_IConnectionSymbol, gen_carnot_TriggerType_IIdentifiableModelElement, gen_carnot_TriggerType_ITypedElement, gen_carnot_TriggerType_IAccessPointOwner, gen_carnot_WorksForConnectionType_IConnectionSymbol, gen_carnot_TriggerTypeType_IMetaType, gen_carnot_UnbindActionType_AbstractEventAction, gen_carnot_ViewType_IModelElement, gen_carnot_ViewType_IExtensibleElement},
    metadata=None
)
