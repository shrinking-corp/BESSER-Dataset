...
public class cmof_Classifier extends Namespace, RedefinableElement, Type {
    ...
    public cmof_Classifier(
        String isAbstract,        String isFinalSpecialization        ArrayList<cmof_Property> cmof_propertys,        ArrayList<cmof_Classifier> cmof_classifiers,        ArrayList<cmof_Classifier> cmof_classifiers,        ArrayList<cmof_Feature> cmof_features    ) {
        this.isAbstract = isAbstract;
        this.isFinalSpecialization = isFinalSpecialization;
