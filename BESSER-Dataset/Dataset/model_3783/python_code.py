...
class test_TestElement(NamedElement):
    ...
    def __init__(self, test_TestElement: "test_Root" = None, test_TestElement2: set["test_TestPolicy"] = None, test_TestElement4: "test_TestClassDelegate" = None, test_TestElement6: "test_TestElementWrapper" = None):
