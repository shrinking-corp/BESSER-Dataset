...
# Classes
test_Root = Class(name="test_Root")
test_TestElement = Class(name="test_TestElement")
NamedElement = Class(name="NamedElement")
test_TestPolicy = Class(name="test_TestPolicy")
test_TestClassDelegate = Class(name="test_TestClassDelegate")
test_NamedElement = Class(name="test_NamedElement")
test_TestElementWrapper = Class(name="test_TestElementWrapper")
...
domain_model = DomainModel(
    name="test",
    types={test_Root, test_TestElement, NamedElement, test_TestPolicy, test_TestClassDelegate, test_NamedElement, test_TestElementWrapper},
    associations={children0, policies1, testClassDelegate3, element5},
    generalizations={gen_test_TestElement_NamedElement, gen_test_TestPolicy_NamedElement, gen_test_TestElementWrapper_NamedElement, gen_test_TestClassDelegate_NamedElement},
    metadata=None
)
