...
def test_hyp_eol_program_is_not_abstract():
    assert not inspect.isabstract(eol_Program)


def test_hyp_eol_program_constructor_exists():
    assert callable(eol_Program.__init__)


def test_hyp_eol_program_constructor_args():
...
def test_hyp_eol_variabledeclarationexpression_lastDefinitionPoint_setter(instance):
