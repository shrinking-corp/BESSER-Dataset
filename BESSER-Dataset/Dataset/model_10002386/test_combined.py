...
def test_hyp_staff_constructor_args():
    ...
    assert "contato" in params, "Missing parameter 'contato'"
    assert "TrabalhoTipo" in params, "Missing parameter 'TrabalhoTipo'"
...
def test_hyp_staff_nome_setter(instance):
...
@given(instance=Staff_strategy)
def test_hyp_staff_contato_setter(instance):
    original = instance.contato
    instance.contato = original
    assert instance.contato == original



@given(instance=Staff_strategy)
def test_hyp_staff_TrabalhoTipo_setter(instance):
    original = instance.TrabalhoTipo
    instance.TrabalhoTipo = original
    assert instance.TrabalhoTipo == original
...
def test_Staff_TrabalhoTipo_value_roundtrip():
    instance = Staff(TrabalhoTipo=7, contato="sample_text", nome="sample_text", staff_Id="sample_text")
    assert instance.TrabalhoTipo == 7
    instance.TrabalhoTipo = 13
    assert instance.TrabalhoTipo == 13


def test_Staff_contato_value_roundtrip():
    instance = Staff(TrabalhoTipo=7, contato="sample_text", nome="sample_text", staff_Id="sample_text")
    assert instance.contato == "sample_text"
    instance.contato = "sample_text_2"
    assert instance.contato == "sample_text_2"


def test_Staff_nome_value_roundtrip():
    instance = Staff(TrabalhoTipo=7, contato="sample_text", nome="sample_text", staff_Id="sample_text")
...
def test_assoc_Staff_RMS_link_reassign_clear():
    a = Staff(TrabalhoTipo=7, contato="sample_text", nome="sample_text", staff_Id="sample_text")
    b1 = RMS(bookings="sample_text")
    b2 = RMS(bookings="sample_text_2")
...
Staff_strategy = st.builds(Staff, TrabalhoTipo=st.integers(), contato=safe_text, nome=safe_text, staff_Id=safe_text)
@given(instance=Staff_strategy)
@settings(max_examples=25)
