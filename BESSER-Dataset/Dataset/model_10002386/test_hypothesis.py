...
def test_staff_has_nome():
    assert hasattr(Staff, "nome")
    descriptor = None
...
def test_staff_has_contato():
    assert hasattr(Staff, "contato")
    descriptor = None
    for klass in Staff.__mro__:
        if "contato" in klass.__dict__:
            descriptor = klass.__dict__["contato"]
            break
    assert isinstance(descriptor, property)

def test_staff_has_TrabalhoTipo():
    assert hasattr(Staff, "TrabalhoTipo")
    descriptor = None
    for klass in Staff.__mro__:
        if "TrabalhoTipo" in klass.__dict__:
            descriptor = klass.__dict__["TrabalhoTipo"]
            break
    assert isinstance(descriptor, property)
...
@given(instance=Staff_strategy)
def test_staff_nome_setter(instance):
...
@given(instance=Staff_strategy)
def test_staff_contato_setter(instance):
...
@given(instance=Staff_strategy)
def test_staff_TrabalhoTipo_setter(instance):
