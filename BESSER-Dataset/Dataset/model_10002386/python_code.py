...
class Table:
    ...
    def __init__(self, table_Id: str, numSeats: int, occupied: bool, specialRequest: str, order: str, reserved4: "Booking" = None, has3: "Order" = None):
...
class Staff:
    ...
    def __init__(self, staff_Id: str, nome: str, TrabalhoTipo: int, contato: str, Staff_RMS_08: "RMS" = None):
        self.staff_Id = staff_Id
        self.nome = nome
        self.TrabalhoTipo = TrabalhoTipo
    ...
    @property
    def TrabalhoTipo(self):
        return self.__TrabalhoTipo
    @TrabalhoTipo.setter
    def TrabalhoTipo(self, TrabalhoTipo: int):
        self.__TrabalhoTipo = TrabalhoTipo
