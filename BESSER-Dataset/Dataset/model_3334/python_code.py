...
class javaMetaModel_JFeature(JElement):
    ...
    def __init__(self, isStatic: bool, visibility: str, JFeature: "javaMetaModel_JClass" = None, jfeature: "javaMetaModel_JClass" = None):
...
class javaMetaModel_JClass(JElement):
    ...
    def __init__(self, isAbstract: bool, isFinal: bool, JClass: "javaMetaModel_JClass" = None, jsuperClass: set["javaMetaModel_JClass"] = None, owner2: set["javaMetaModel_JFeature"] = None, jclass: "javaMetaModel_JPackage" = None, JClass14: "javaMetaModel_JFeature" = None, JClass8: "javaMetaModel_JClass" = None, jsubClass: "javaMetaModel_JClass" = None, JClass11: "javaMetaModel_JPackage" = None):
