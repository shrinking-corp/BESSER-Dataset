...
# Classes
javaMetaModel_JElement = Class(name="javaMetaModel_JElement")
javaMetaModel_JMethod = Class(name="javaMetaModel_JMethod")
JFeature = Class(name="JFeature")
javaMetaModel_JParameter = Class(name="javaMetaModel_JParameter", is_abstract=True)
javaMetaModel_JClass = Class(name="javaMetaModel_JClass")
JElement = Class(name="JElement")
javaMetaModel_JFeature = Class(name="javaMetaModel_JFeature", is_abstract=True)
javaMetaModel_JPackage = Class(name="javaMetaModel_JPackage")
javaMetaModel_JField = Class(name="javaMetaModel_JField", is_abstract=True)
javaMetaModel_JAttribute = Class(name="javaMetaModel_JAttribute")
JField = Class(name="JField")
javaMetaModel_JReference = Class(name="javaMetaModel_JReference")
javaMetaModel_JPrimitiveTypePar = Class(name="javaMetaModel_JPrimitiveTypePar")
JParameter = Class(name="JParameter")
javaMetaModel_JReferenceTypePar = Class(name="javaMetaModel_JReferenceTypePar")
...
javaMetaModel_JClass.attributes={javaMetaModel_JClass_isFinal, javaMetaModel_JClass_isAbstract}
...
javaMetaModel_JFeature.attributes={javaMetaModel_JFeature_isStatic, javaMetaModel_JFeature_visibility}
...
domain_model = DomainModel(
    name="javaMetaModel",
    types={javaMetaModel_JElement, javaMetaModel_JMethod, JFeature, javaMetaModel_JParameter, javaMetaModel_JClass, JElement, javaMetaModel_JFeature, javaMetaModel_JPackage, javaMetaModel_JField, javaMetaModel_JAttribute, JField, javaMetaModel_JReference, javaMetaModel_JPrimitiveTypePar, JParameter, javaMetaModel_JReferenceTypePar, Vis, PrimitiveType, ReferenceType, Direction},
    associations={jsubClass5, jparameter0, jfeature1, owner3, owner13, jsuperClass7, jclass9, owner12},
    generalizations={gen_javaMetaModel_JMethod_JFeature, gen_javaMetaModel_JClass_JElement, gen_javaMetaModel_JPackage_JElement, gen_javaMetaModel_JField_JFeature, gen_javaMetaModel_JAttribute_JField, gen_javaMetaModel_JReference_JField, gen_javaMetaModel_JParameter_JElement, gen_javaMetaModel_JPrimitiveTypePar_JParameter, gen_javaMetaModel_JReferenceTypePar_JParameter, gen_javaMetaModel_JFeature_JElement},
    metadata=None
)
