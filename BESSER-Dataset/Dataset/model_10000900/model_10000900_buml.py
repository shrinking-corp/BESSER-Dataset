...
Customer.attributes={Customer_phoneNumber, Customer_dateOfBirth, Customer_address, Customer_name, Customer_emailAddress}
...
Login.attributes={Login_securityAnswer, Login_username, Login_password, Login_securityQuestion, Login_lastLoginTime}
...
domain_model = DomainModel(
    name="_6d470774_5563_4ccc_bf48_439fda92dc1b",
    types={account_CertificatesOfDepositAccount, account_CheckingAccount, account_Account, Customer, Login, transaction_Transaction, transaction_DepositTransaction, transaction_WithdrawTransaction, transaction_TransferTransaction, account_SavingsAccount, transaction_TransactionType, account_AccountType},
