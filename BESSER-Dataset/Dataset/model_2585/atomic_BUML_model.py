...
# Classes
atomic_AGraph = Class(name="atomic_AGraph")
atomic_AToken = Class(name="atomic_AToken")
atomic_AStructured = Class(name="atomic_AStructured")
atomic_AEdge = Class(name="atomic_AEdge")
ANode = Class(name="ANode")
atomic_ANode = Class(name="atomic_ANode", is_abstract=True)
XAnnotable = Class(name="XAnnotable")
atomic_ATargetEdge = Class(name="atomic_ATargetEdge")
atomic_XAnnotable = Class(name="atomic_XAnnotable", is_abstract=True)
...
domain_model = DomainModel(
    ...
    associations={tokens0, structures1, edges3, next6, previous9, graph13, graph15, source17, target19, target22, graph25, graph11, targetedges12},
    generalizations={gen_atomic_AToken_ANode, gen_atomic_AStructured_ANode, gen_atomic_ANode_XAnnotable},
    metadata=None
)
