...
# Classes
haxe_HaxeModel = Class(name="haxe_HaxeModel")
haxe_HaxeClass = Class(name="haxe_HaxeClass")
haxe_HaxePathReferentiable = Class(name="haxe_HaxePathReferentiable", is_abstract=True)
haxe_HaxeModule = Class(name="haxe_HaxeModule")
haxe_HaxeModelElement = Class(name="haxe_HaxeModelElement", is_abstract=True)
haxe_HaxeASTNode = Class(name="haxe_HaxeASTNode", is_abstract=True)
HaxeModelElement = Class(name="HaxeModelElement")
haxe_HaxeComment = Class(name="haxe_HaxeComment")
haxe_HaxeNamedElement = Class(name="haxe_HaxeNamedElement", is_abstract=True)
HaxeASTNode = Class(name="HaxeASTNode")
haxe_HaxeHaxedocComment = Class(name="haxe_HaxeHaxedocComment")
HaxeComment = Class(name="HaxeComment")
haxe_HaxeTagElement = Class(name="haxe_HaxeTagElement")
haxe_HaxeTextElement = Class(name="haxe_HaxeTextElement")
HaxeNamedElement = Class(name="HaxeNamedElement")
haxe_HaxePackage = Class(name="haxe_HaxePackage")
haxe_HaxePathReference = Class(name="haxe_HaxePathReference", is_abstract=True)
haxe_HaxeFieldContainer = Class(name="haxe_HaxeFieldContainer", is_abstract=True)
haxe_HaxeField = Class(name="haxe_HaxeField", is_abstract=True)
haxe_HaxeExpression = Class(name="haxe_HaxeExpression", is_abstract=True)
haxe_HaxeLoopStatement = Class(name="haxe_HaxeLoopStatement", is_abstract=True)
HaxeExpression = Class(name="HaxeExpression")
haxe_HaxeUnaryExpression = Class(name="haxe_HaxeUnaryExpression", is_abstract=True)
haxe_HaxeBinaryExpression = Class(name="haxe_HaxeBinaryExpression", is_abstract=True)
haxe_HaxeBlock = Class(name="haxe_HaxeBlock")
haxe_HaxeConditionalExpression = Class(name="haxe_HaxeConditionalExpression", is_abstract=True)
haxe_HaxeIfStatement = Class(name="haxe_HaxeIfStatement")
HaxeConditionalExpression = Class(name="HaxeConditionalExpression")
haxe_HaxeTernaryExpression = Class(name="haxe_HaxeTernaryExpression")
haxe_HaxeForStatement = Class(name="haxe_HaxeForStatement")
HaxeLoopStatement = Class(name="HaxeLoopStatement")
haxe_HaxeSingleVariableDeclaration = Class(name="haxe_HaxeSingleVariableDeclaration")
haxe_HaxeWhileStatement = Class(name="haxe_HaxeWhileStatement")
haxe_HaxeInExpression = Class(name="haxe_HaxeInExpression")
haxe_HaxeDoWhileStatement = Class(name="haxe_HaxeDoWhileStatement")
haxe_HaxePrefixExpression = Class(name="haxe_HaxePrefixExpression")
HaxeUnaryExpression = Class(name="HaxeUnaryExpression")
haxe_HaxeInfixExpression = Class(name="haxe_HaxeInfixExpression")
HaxeBinaryExpression = Class(name="HaxeBinaryExpression")
haxe_HaxePostfixExpression = Class(name="haxe_HaxePostfixExpression")
haxe_HaxeReturn = Class(name="haxe_HaxeReturn")
HaxeExpressionStatement = Class(name="HaxeExpressionStatement")
haxe_HaxeBreak = Class(name="haxe_HaxeBreak")
haxe_HaxeContinue = Class(name="haxe_HaxeContinue")
haxe_HaxeThisExpression = Class(name="haxe_HaxeThisExpression")
haxe_HaxeEmptyStatement = Class(name="haxe_HaxeEmptyStatement")
haxe_HaxeConstant = Class(name="haxe_HaxeConstant", is_abstract=True)
haxe_HaxeStringLiteral = Class(name="haxe_HaxeStringLiteral")
HaxeConstant = Class(name="HaxeConstant")
haxe_HaxeNullLiteral = Class(name="haxe_HaxeNullLiteral")
haxe_HaxeBooleanLiteral = Class(name="haxe_HaxeBooleanLiteral")
haxe_HaxeNumberLiteral = Class(name="haxe_HaxeNumberLiteral")
haxe_HaxeIdentifierLiteral = Class(name="haxe_HaxeIdentifierLiteral")
haxe_HaxeRegexLiteral = Class(name="haxe_HaxeRegexLiteral")
haxe_HaxeFieldAccess = Class(name="haxe_HaxeFieldAccess")
haxe_HaxeSingleVariableAccess = Class(name="haxe_HaxeSingleVariableAccess")
haxe_HaxeParenthizedExpression = Class(name="haxe_HaxeParenthizedExpression")
haxe_HaxeArrayInitializer = Class(name="haxe_HaxeArrayInitializer")
haxe_HaxeArrayCreation = Class(name="haxe_HaxeArrayCreation")
haxe_HaxeTypeAccess = Class(name="haxe_HaxeTypeAccess", is_abstract=True)
haxe_HaxeArrayAccess = Class(name="haxe_HaxeArrayAccess")
haxe_HaxeSwitch = Class(name="haxe_HaxeSwitch")
haxe_HaxeCase = Class(name="haxe_HaxeCase")
haxe_HaxeFunctionExpression = Class(name="haxe_HaxeFunctionExpression")
HaxeAbstractFunction = Class(name="HaxeAbstractFunction")
haxe_HaxeCallExpression = Class(name="haxe_HaxeCallExpression")
haxe_HaxeObjectDeclaration = Class(name="haxe_HaxeObjectDeclaration")
haxe_HaxeFieldDeclaration = Class(name="haxe_HaxeFieldDeclaration")
HaxeTypedElement = Class(name="HaxeTypedElement")
haxe_HaxeTryExpression = Class(name="haxe_HaxeTryExpression")
haxe_HaxeCatchClause = Class(name="haxe_HaxeCatchClause")
haxe_HaxeThrowExpression = Class(name="haxe_HaxeThrowExpression")
haxe_HaxeExpressionStatement = Class(name="haxe_HaxeExpressionStatement")
haxe_HaxeCastingExpression = Class(name="haxe_HaxeCastingExpression")
haxe_HaxeUnsafeCastExpression = Class(name="haxe_HaxeUnsafeCastExpression")
haxe_HaxeTypeCheckExpression = Class(name="haxe_HaxeTypeCheckExpression")
haxe_HaxeSuperMethodInvocation = Class(name="haxe_HaxeSuperMethodInvocation")
HaxeAbstractMethodInvocation = Class(name="HaxeAbstractMethodInvocation")
haxe_HaxeMethodInvocation = Class(name="haxe_HaxeMethodInvocation")
haxe_HaxeSuperConstructorInvocation = Class(name="haxe_HaxeSuperConstructorInvocation")
HaxeMethodInvocation = Class(name="HaxeMethodInvocation")
haxe_HaxeVariableDeclaration = Class(name="haxe_HaxeVariableDeclaration", is_abstract=True)
haxe_HaxePackageAccess = Class(name="haxe_HaxePackageAccess")
HaxePathReference = Class(name="HaxePathReference")
haxe_HaxeAssignment = Class(name="haxe_HaxeAssignment")
haxe_HaxeAbstractMethodInvocation = Class(name="haxe_HaxeAbstractMethodInvocation", is_abstract=True)
haxe_HaxeAbstractOperation = Class(name="haxe_HaxeAbstractOperation", is_abstract=True)
haxe_HaxeVariableDeclarationGroup = Class(name="haxe_HaxeVariableDeclarationGroup")
haxe_HaxeVariableDeclarationExpression = Class(name="haxe_HaxeVariableDeclarationExpression")
haxe_HaxeVariableDeclarationFragment = Class(name="haxe_HaxeVariableDeclarationFragment")
HaxeVariableDeclaration = Class(name="HaxeVariableDeclaration")
HaxePathReferentiable = Class(name="HaxePathReferentiable")
haxe_HaxeType = Class(name="haxe_HaxeType", is_abstract=True)
haxe_HaxeDependencyDeclaration = Class(name="haxe_HaxeDependencyDeclaration", is_abstract=True)
haxe_HaxeTypeParameter = Class(name="haxe_HaxeTypeParameter")
haxe_HaxeClassifier = Class(name="haxe_HaxeClassifier", is_abstract=True)
...
haxe_HaxeOperation = Class(name="haxe_HaxeOperation")
haxe_HaxeAttribute = Class(name="haxe_HaxeAttribute")
haxe_HaxeConstructor = Class(name="haxe_HaxeConstructor")
haxe_HaxeFunctionTypeAccess = Class(name="haxe_HaxeFunctionTypeAccess")
HaxeTypeAccess = Class(name="HaxeTypeAccess")
haxe_HaxeClassifierAccess = Class(name="haxe_HaxeClassifierAccess")
haxe_HaxeTypedElement = Class(name="haxe_HaxeTypedElement", is_abstract=True)
HaxeClassifier = Class(name="HaxeClassifier")
haxe_HaxeAbstract = Class(name="haxe_HaxeAbstract")
haxe_HaxeEnum = Class(name="haxe_HaxeEnum")
haxe_HaxeEnumConstructor = Class(name="haxe_HaxeEnumConstructor")
haxe_HaxeTypedef = Class(name="haxe_HaxeTypedef")
HaxeField = Class(name="HaxeField")
HaxeSingleVariableDeclaration = Class(name="HaxeSingleVariableDeclaration")
haxe_HaxeAbstractFunction = Class(name="haxe_HaxeAbstractFunction", is_abstract=True)
HaxeAbstractOperation = Class(name="HaxeAbstractOperation")
haxe_HaxeImportDeclaration = Class(name="haxe_HaxeImportDeclaration")
HaxeDependencyDeclaration = Class(name="HaxeDependencyDeclaration")
haxe_HaxeUsingDeclaration = Class(name="haxe_HaxeUsingDeclaration")
haxe_HaxeMetadata = Class(name="haxe_HaxeMetadata")
haxe_HaxeMetadataContainer = Class(name="haxe_HaxeMetadataContainer", is_abstract=True)
...
haxe_HaxeModel.attributes={haxe_HaxeModel_sourceFolder, haxe_HaxeModel_targetFolder, haxe_HaxeModel_name, haxe_HaxeModel_target}
...
haxe_HaxeComment.attributes={haxe_HaxeComment_content, haxe_HaxeComment_prefixOfParent, haxe_HaxeComment_enclosedByParent, haxe_HaxeComment_lineComment}
...
haxe_HaxeRegexLiteral.attributes={haxe_HaxeRegexLiteral_options, haxe_HaxeRegexLiteral_pattern}
...
haxe_HaxeType.attributes={haxe_HaxeType_extern, haxe_HaxeType_private}
...
domain_model = DomainModel(
    name="haxe",
    types={haxe_HaxeModel, haxe_HaxeClass, haxe_HaxePathReferentiable, haxe_HaxeModule, haxe_HaxeModelElement, haxe_HaxeASTNode, HaxeModelElement, haxe_HaxeComment, haxe_HaxeNamedElement, HaxeASTNode, haxe_HaxeHaxedocComment, HaxeComment, haxe_HaxeTagElement, haxe_HaxeTextElement, HaxeNamedElement, haxe_HaxePackage, haxe_HaxePathReference, haxe_HaxeFieldContainer, haxe_HaxeField, haxe_HaxeExpression, haxe_HaxeLoopStatement, HaxeExpression, haxe_HaxeUnaryExpression, haxe_HaxeBinaryExpression, haxe_HaxeBlock, haxe_HaxeConditionalExpression, haxe_HaxeIfStatement, HaxeConditionalExpression, haxe_HaxeTernaryExpression, haxe_HaxeForStatement, HaxeLoopStatement, haxe_HaxeSingleVariableDeclaration, haxe_HaxeWhileStatement, haxe_HaxeInExpression, haxe_HaxeDoWhileStatement, haxe_HaxePrefixExpression, HaxeUnaryExpression, haxe_HaxeInfixExpression, HaxeBinaryExpression, haxe_HaxePostfixExpression, haxe_HaxeReturn, HaxeExpressionStatement, haxe_HaxeBreak, haxe_HaxeContinue, haxe_HaxeThisExpression, haxe_HaxeEmptyStatement, haxe_HaxeConstant, haxe_HaxeStringLiteral, HaxeConstant, haxe_HaxeNullLiteral, haxe_HaxeBooleanLiteral, haxe_HaxeNumberLiteral, haxe_HaxeIdentifierLiteral, haxe_HaxeRegexLiteral, haxe_HaxeFieldAccess, haxe_HaxeSingleVariableAccess, haxe_HaxeParenthizedExpression, haxe_HaxeArrayInitializer, haxe_HaxeArrayCreation, haxe_HaxeTypeAccess, haxe_HaxeArrayAccess, haxe_HaxeSwitch, haxe_HaxeCase, haxe_HaxeFunctionExpression, HaxeAbstractFunction, haxe_HaxeCallExpression, haxe_HaxeObjectDeclaration, haxe_HaxeFieldDeclaration, HaxeTypedElement, haxe_HaxeTryExpression, haxe_HaxeCatchClause, haxe_HaxeThrowExpression, haxe_HaxeExpressionStatement, haxe_HaxeCastingExpression, haxe_HaxeUnsafeCastExpression, haxe_HaxeTypeCheckExpression, haxe_HaxeSuperMethodInvocation, HaxeAbstractMethodInvocation, haxe_HaxeMethodInvocation, haxe_HaxeSuperConstructorInvocation, HaxeMethodInvocation, haxe_HaxeVariableDeclaration, haxe_HaxePackageAccess, HaxePathReference, haxe_HaxeAssignment, haxe_HaxeAbstractMethodInvocation, haxe_HaxeAbstractOperation, haxe_HaxeVariableDeclarationGroup, haxe_HaxeVariableDeclarationExpression, haxe_HaxeVariableDeclarationFragment, HaxeVariableDeclaration, HaxePathReferentiable, haxe_HaxeType, haxe_HaxeDependencyDeclaration, haxe_HaxeTypeParameter, haxe_HaxeClassifier, HaxeType, HaxeFieldContainer, HaxeMetadataContainer, haxe_HaxeOperation, haxe_HaxeAttribute, haxe_HaxeConstructor, haxe_HaxeFunctionTypeAccess, HaxeTypeAccess, haxe_HaxeClassifierAccess, haxe_HaxeTypedElement, HaxeClassifier, haxe_HaxeAbstract, haxe_HaxeEnum, haxe_HaxeEnumConstructor, haxe_HaxeTypedef, HaxeField, HaxeSingleVariableDeclaration, haxe_HaxeAbstractFunction, HaxeAbstractOperation, haxe_HaxeImportDeclaration, HaxeDependencyDeclaration, haxe_HaxeUsingDeclaration, haxe_HaxeMetadata, haxe_HaxeMetadataContainer, HaxeTarget, HaxeAttributeProperty, HaxePrefixOperators, HaxeAssignmentOperator, HaxeInfixOperators},
    associations={mainClass0, elements1, referenced3, haxeModules6, comments8, tags9, fragments10, parentReference13, referencedIn14, referencedTerminal15, haxeFields16, theBody17, expression18, operand21, leftSide23, rightSide25, statements28, expression30, thenStatement32, elseStatement35, elseExpression37, parameter39, variable40, expression42, expression51, extendedSide45, field47, expression48, expressions53, dimensions55, initializer57, type60, array62, index64, expression67, cases69, default71, values74, expression77, type104, expression80, arguments82, extendsType85, fields87, value89, theBody92, catchClauses94, exception96, theBody97, expression100, expression102, expression107, expression109, type111, expression114, qualifier116, variable119, qualifier121, method122, arguments123, typeArguments126, usageInVariableAccess129, initializer130, container132, initializer133, fragments135, variablesContainer136, groups137, catchClause139, childrenReferences140, childrenPackages143, containedTypes144, commentList146, dependencies149, thePackage151, theElements154, containerModule155, commentsAfterDeclaration156, commentsBeforeDeclaration159, typeParameters162, containerPackage164, haxeOperations166, haxeAttribute168, haxeConstructors170, bounds172, returnType175, argumentTypes177, parameterMapping180, type182, generalization184, implementation187, underlyingType190, directCastingFromType192, directCastingToType195, literals198, refType199, fieldContainer201, getter202, setter205, formalParameters208, typeParameters210, theBody213, constructedClass216, parameters219, staticElement222, staticField223, usedIn225, parameters226, metadata228},
    generalizations={gen_haxe_HaxeASTNode_HaxeModelElement, gen_haxe_HaxeNamedElement_HaxeASTNode, gen_haxe_HaxeComment_HaxeASTNode, gen_haxe_HaxeHaxedocComment_HaxeComment, gen_haxe_HaxeTagElement_HaxeASTNode, gen_haxe_HaxeTextElement_HaxeASTNode, gen_haxe_HaxePathReferentiable_HaxeNamedElement, gen_haxe_HaxePathReference_HaxeModelElement, gen_haxe_HaxeFieldContainer_HaxeModelElement, gen_haxe_HaxeExpression_HaxeASTNode, gen_haxe_HaxeLoopStatement_HaxeExpression, gen_haxe_HaxeUnaryExpression_HaxeExpression, gen_haxe_HaxeBinaryExpression_HaxeExpression, gen_haxe_HaxeBlock_HaxeExpression, gen_haxe_HaxeConditionalExpression_HaxeExpression, gen_haxe_HaxeIfStatement_HaxeConditionalExpression, gen_haxe_HaxeTernaryExpression_HaxeConditionalExpression, gen_haxe_HaxeForStatement_HaxeLoopStatement, gen_haxe_HaxeWhileStatement_HaxeLoopStatement, gen_haxe_HaxeInExpression_HaxeExpression, gen_haxe_HaxeDoWhileStatement_HaxeLoopStatement, gen_haxe_HaxePrefixExpression_HaxeUnaryExpression, gen_haxe_HaxePostfixExpression_HaxeUnaryExpression, gen_haxe_HaxeReturn_HaxeExpressionStatement, gen_haxe_HaxeBreak_HaxeExpression, gen_haxe_HaxeContinue_HaxeExpression, gen_haxe_HaxeThisExpression_HaxeExpression, gen_haxe_HaxeEmptyStatement_HaxeExpression, gen_haxe_HaxeConstant_HaxeExpression, gen_haxe_HaxeStringLiteral_HaxeConstant, gen_haxe_HaxeNullLiteral_HaxeConstant, gen_haxe_HaxeBooleanLiteral_HaxeConstant, gen_haxe_HaxeNumberLiteral_HaxeConstant, gen_haxe_HaxeIdentifierLiteral_HaxeConstant, gen_haxe_HaxeRegexLiteral_HaxeConstant, gen_haxe_HaxeFieldAccess_HaxeExpression, gen_haxe_HaxeParenthizedExpression_HaxeExpression, gen_haxe_HaxeInfixExpression_HaxeBinaryExpression, gen_haxe_HaxeArrayInitializer_HaxeExpression, gen_haxe_HaxeArrayCreation_HaxeExpression, gen_haxe_HaxeArrayAccess_HaxeExpression, gen_haxe_HaxeSwitch_HaxeExpression, gen_haxe_HaxeCase_HaxeExpression, gen_haxe_HaxeFunctionExpression_HaxeExpression, gen_haxe_HaxeFunctionExpression_HaxeAbstractFunction, gen_haxe_HaxeCallExpression_HaxeExpression, gen_haxe_HaxeObjectDeclaration_HaxeExpression, gen_haxe_HaxeFieldDeclaration_HaxeNamedElement, gen_haxe_HaxeFieldDeclaration_HaxeTypedElement, gen_haxe_HaxeTryExpression_HaxeExpression, gen_haxe_HaxeCatchClause_HaxeExpression, gen_haxe_HaxeThrowExpression_HaxeExpressionStatement, gen_haxe_HaxeExpressionStatement_HaxeExpression, gen_haxe_HaxeCastingExpression_HaxeExpression, gen_haxe_HaxeUnsafeCastExpression_HaxeExpression, gen_haxe_HaxeTypeCheckExpression_HaxeExpression, gen_haxe_HaxeSuperMethodInvocation_HaxeExpression, gen_haxe_HaxeSuperMethodInvocation_HaxeAbstractMethodInvocation, gen_haxe_HaxeMethodInvocation_HaxeExpression, gen_haxe_HaxeMethodInvocation_HaxeAbstractMethodInvocation, gen_haxe_HaxeSuperConstructorInvocation_HaxeMethodInvocation, gen_haxe_HaxeSingleVariableAccess_HaxeExpression, gen_haxe_HaxePackageAccess_HaxeExpression, gen_haxe_HaxePackageAccess_HaxePathReference, gen_haxe_HaxeAssignment_HaxeBinaryExpression, gen_haxe_HaxeAbstractMethodInvocation_HaxeASTNode, gen_haxe_HaxeVariableDeclaration_HaxeNamedElement, gen_haxe_HaxeVariableDeclarationGroup_HaxeTypedElement, gen_haxe_HaxeVariableDeclarationFragment_HaxeVariableDeclaration, gen_haxe_HaxeVariableDeclarationExpression_HaxeExpression, gen_haxe_HaxeSingleVariableDeclaration_HaxeVariableDeclaration, gen_haxe_HaxeSingleVariableDeclaration_HaxeTypedElement, gen_haxe_HaxePackage_HaxePathReferentiable, gen_haxe_HaxeModule_HaxeNamedElement, gen_haxe_HaxeType_HaxePathReferentiable, gen_haxe_HaxeType_HaxeASTNode, gen_haxe_HaxeClassifier_HaxeType, gen_haxe_HaxeClassifier_HaxeFieldContainer, gen_haxe_HaxeClassifier_HaxeMetadataContainer, gen_haxe_HaxeTypeParameter_HaxeType, gen_haxe_HaxeTypeAccess_HaxeExpression, gen_haxe_HaxeFunctionTypeAccess_HaxeTypeAccess, gen_haxe_HaxeClassifierAccess_HaxePathReference, gen_haxe_HaxeClassifierAccess_HaxeTypeAccess, gen_haxe_HaxeTypedElement_HaxeModelElement, gen_haxe_HaxeClass_HaxeClassifier, gen_haxe_HaxeAbstract_HaxeClassifier, gen_haxe_HaxeEnum_HaxeClassifier, gen_haxe_HaxeTypedef_HaxeType, gen_haxe_HaxeField_HaxeNamedElement, gen_haxe_HaxeField_HaxeMetadataContainer, gen_haxe_HaxeAttribute_HaxeField, gen_haxe_HaxeAttribute_HaxeSingleVariableDeclaration, gen_haxe_HaxeAbstractFunction_HaxeASTNode, gen_haxe_HaxeAbstractOperation_HaxeAbstractFunction, gen_haxe_HaxeOperation_HaxeAbstractOperation, gen_haxe_HaxeOperation_HaxeField, gen_haxe_HaxeOperation_HaxeTypedElement, gen_haxe_HaxeConstructor_HaxeAbstractOperation, gen_haxe_HaxeConstructor_HaxeField, gen_haxe_HaxeEnumConstructor_HaxeVariableDeclaration, gen_haxe_HaxeEnumConstructor_HaxeField, gen_haxe_HaxeDependencyDeclaration_HaxePathReference, gen_haxe_HaxeDependencyDeclaration_HaxeASTNode, gen_haxe_HaxeImportDeclaration_HaxeDependencyDeclaration, gen_haxe_HaxeUsingDeclaration_HaxeDependencyDeclaration, gen_haxe_HaxeMetadata_HaxeNamedElement, gen_haxe_HaxeMetadata_HaxeExpression, gen_haxe_HaxeMetadataContainer_HaxeModelElement},
    metadata=None
)
