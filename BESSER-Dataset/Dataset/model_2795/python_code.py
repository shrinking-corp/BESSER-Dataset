...
class haxe_HaxeTypedef(HaxeType):
    ...
    pass
class haxe_HaxeClassifier(HaxeMetadataContainer, HaxeType, HaxeFieldContainer):
...
class HaxeVariableDeclaration:
    ...
    pass
class haxe_HaxeEnumConstructor(HaxeVariableDeclaration, HaxeField):
...
class haxe_HaxeVariableDeclarationGroup(HaxeTypedElement):
    ...
    pass
class haxe_HaxeOperation(HaxeAbstractOperation, HaxeField, HaxeTypedElement):
...
class haxe_HaxeVariableDeclaration(HaxeNamedElement):
    ...
    pass
class haxe_HaxeFieldDeclaration(HaxeNamedElement, HaxeTypedElement):
...
class haxe_HaxeMetadata(HaxeExpression, HaxeNamedElement):
    ...
    def __init__(self, compilerMetadata: bool, metadata: "haxe_HaxeMetadataContainer" = None, haxe_HaxeMetadata: set["haxe_HaxeExpression"] = None, HaxeMetadata: "haxe_HaxeMetadataContainer" = None):
...
class haxe_HaxeDependencyDeclaration(HaxePathReference, HaxeASTNode):
    ...
    pass
class haxe_HaxeType(HaxePathReferentiable, HaxeASTNode):

    def __init__(self, private: bool, extern: bool, haxe_HaxeType: "haxe_HaxePackage" = None, HaxeType: "haxe_HaxeModule" = None, theElements: "haxe_HaxeModule" = None, haxe_HaxeType157: set["haxe_HaxeComment"] = None, haxe_HaxeType160: set["haxe_HaxeComment"] = None, haxe_HaxeType163: set["haxe_HaxeTypeParameter"] = None):
...
class haxe_HaxeModel:
    ...
    def __init__(self, name: str, sourceFolder: str, targetFolder: str, target: str, haxe_HaxeModel: "haxe_HaxeClass" = None, haxe_HaxeModel2: set["haxe_HaxePathReferentiable"] = None, haxe_HaxeModel4: set["haxe_HaxePathReferentiable"] = None, haxe_HaxeModel7: set["haxe_HaxeModule"] = None):
        self.name = name
