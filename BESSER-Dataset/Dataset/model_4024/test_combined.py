...
def test_assoc_memberEnd35_link_reassign_clear():
    ...
    _safe_set(a, 'uml2CD_Property37', b1)
    assert _is_linked(a, 'uml2CD_Property37', b1)
    if hasattr(b1, 'uml2CD_Association36'):
        assert _is_linked(b1, 'uml2CD_Association36', a)
    _safe_set(a, 'uml2CD_Property37', b2)
    assert _is_linked(a, 'uml2CD_Property37', b2)
    if hasattr(b1, 'uml2CD_Association36'):
        assert not _is_linked(b1, 'uml2CD_Association36', a)
    if hasattr(b2, 'uml2CD_Association36'):
        assert _is_linked(b2, 'uml2CD_Association36', a)
    _safe_set(a, 'uml2CD_Property37', None)
    assert not _is_linked(a, 'uml2CD_Property37', b2)
    if hasattr(b2, 'uml2CD_Association36'):
        assert not _is_linked(b2, 'uml2CD_Association36', a)


def test_assoc_ownedAttribute33_link_reassign_clear():
    a = uml2CD_Property(aggregation="sample_text", isDerived="sample_text", lower="sample_text", upper="sample_text")
    b1 = uml2CD_Class(active="sample_text")
    b2 = uml2CD_Class(active="sample_text_2")
...
def test_assoc_ownedEnd38_link_reassign_clear():
    a = uml2CD_Property(aggregation="sample_text", isDerived="sample_text", lower="sample_text", upper="sample_text")
    b1 = uml2CD_Association(isDerived="sample_text")
    b2 = uml2CD_Association(isDerived="sample_text_2")
...
def test_assoc_ownedOperation30_link_reassign_clear():
    a = uml2CD_Operation(body="sample_text", isQuery="sample_text", visibility="sample_text")
    b1 = uml2CD_Class(active="sample_text")
    b2 = uml2CD_Class(active="sample_text_2")
    _safe_set(a, 'uml2CD_Operation32', b1)
    assert _is_linked(a, 'uml2CD_Operation32', b1)
    if hasattr(b1, 'uml2CD_Class31'):
        assert _is_linked(b1, 'uml2CD_Class31', a)
    _safe_set(a, 'uml2CD_Operation32', b2)
    assert _is_linked(a, 'uml2CD_Operation32', b2)
    if hasattr(b1, 'uml2CD_Class31'):
        assert not _is_linked(b1, 'uml2CD_Class31', a)
    if hasattr(b2, 'uml2CD_Class31'):
        assert _is_linked(b2, 'uml2CD_Class31', a)
    _safe_set(a, 'uml2CD_Operation32', None)
    assert not _is_linked(a, 'uml2CD_Operation32', b2)
    if hasattr(b2, 'uml2CD_Class31'):
        assert not _is_linked(b2, 'uml2CD_Class31', a)
