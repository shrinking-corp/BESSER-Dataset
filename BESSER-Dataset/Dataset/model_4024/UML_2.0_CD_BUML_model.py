...
uml2CD_NamedElement = Class(name="uml2CD_NamedElement", is_abstract=True)
...
uml2CD_DataType = Class(name="uml2CD_DataType", is_abstract=True)
uml2CD_EnumerationLiteral = Class(name="uml2CD_EnumerationLiteral")
uml2CD_UMLModel = Class(name="uml2CD_UMLModel")
...
uml2CD_Operation.attributes={uml2CD_Operation_body, uml2CD_Operation_isQuery, uml2CD_Operation_visibility}
...
uml2CD_Property.attributes={uml2CD_Property_lower, uml2CD_Property_aggregation, uml2CD_Property_upper, uml2CD_Property_isDerived}
...
domain_model = DomainModel(
    name="uml2CD",
    types={uml2CD_GeneralizationSet, uml2CD_Parameter, uml2CD_Operation, uml2CD_Comment, uml2CD_NamedElement, uml2CD_Constraint, uml2CD_Package, NamedElement, uml2CD_Class, uml2CD_Enumeration, uml2CD_Association, uml2CD_Generalization, uml2CD_PrimitiveType, DataType, uml2CD_Property, uml2CD_DataType, uml2CD_EnumerationLiteral, uml2CD_UMLModel},
    associations={packagedPrimitive13, general15, specific18, generalizationSet21, enumType23, primitiveType25, comments0, constraints1, nestedPackage4, packagedClass5, packagedEnum7, packagedAssoc9, packagedGeneralizations11, memberEnd35, ownedEnd38, redefinedOperation29, ownedOperation30, ownedAttribute33, ownedLiteral41, packages43},
    generalizations={gen_uml2CD_Operation_NamedElement, gen_uml2CD_Package_NamedElement, gen_uml2CD_PrimitiveType_DataType, gen_uml2CD_Class_NamedElement, gen_uml2CD_DataType_NamedElement, gen_uml2CD_Property_NamedElement, gen_uml2CD_Association_NamedElement, gen_uml2CD_Enumeration_DataType, gen_uml2CD_EnumerationLiteral_NamedElement},
    metadata=None
)
