...
class domainmodel_BusinessFeature:
    ...
    def __init__(self, name: str, connectPoint1: str, connectEnd: str, domainmodel_BusinessFeature105: "domainmodel_BusinessFeatureType" = None, domainmodel_BusinessFeature108: "domainmodel_BusinessFeature" = None, domainmodel_BusinessFeature106: "domainmodel_BusinessFeature" = None, domainmodel_BusinessFeature110: "domainmodel_BusinessFeatures" = None, domainmodel_BusinessFeature: "domainmodel_InterfaceMethodCall" = None):
        self.name = name
...
class domainmodel_ScreenFeature(UIFeature):
    ...
    def __init__(self, name: str, domainmodel_ScreenFeature101: set["domainmodel_ScreenModule"] = None, domainmodel_ScreenFeature: "domainmodel_NavigateToAction" = None):
        self.name = name
...
class domainmodel_SetUIElementReceiver(SetActionReceiver):
    ...
    def __init__(self, uiKey: str, domainmodel_SetUIElementReceiver46: "domainmodel_AttachAction" = None, domainmodel_SetUIElementReceiver53: "domainmodel_BindAction" = None, domainmodel_SetUIElementReceiver: "domainmodel_ValidateAction" = None, domainmodel_SetUIElementReceiver80: "domainmodel_ViewElement" = None):
        self.uiKey = uiKey
...
class domainmodel_ValidatorFeature:
    ...
    def __init__(self, name: str, domainmodel_ValidatorFeature: "domainmodel_ValidateAction" = None, domainmodel_ValidatorFeature60: "domainmodel_ValidatorRules" = None, domainmodel_ValidatorFeature63: "domainmodel_ValidatorModule" = None, domainmodel_ValidatorFeature56: "domainmodel_ValidatorRule" = None):
        self.name = name
...
class domainmodel_AttachAction(InitActionFeature):
    ...
    pass
class domainmodel_SetAction(InitActionFeature, UIActionFeature):
...
class domainmodel_InterfaceOperationUsageRule:
    ...
    def __init__(self, name: str, domainmodel_InterfaceOperationUsageRule21: "domainmodel_InterfaceOperationsUsageRule" = None, domainmodel_InterfaceOperationUsageRule: "domainmodel_InterfaceDeclaration" = None):
        self.name = name
...
class domainmodel_MethodCall:
    ...
    def __init__(self, name: str, domainmodel_MethodCall: "domainmodel_MethodParameters" = None, domainmodel_MethodCall12: "domainmodel_InterfaceOperation" = None, domainmodel_MethodCall93: "domainmodel_InterfaceMethodCall" = None):
        self.name = name
...
class AbstractNamespaceElement:
    ...
    pass
class domainmodel_InterfaceDeclaration(BusinessFeatureType, AbstractNamespaceElement):
...
class domainmodel_DomainRepository(BusinessFeatureType, AbstractNamespaceElement):
...
class domainmodel_DomainEntity(Type, AbstractNamespaceElement):

    def __init__(self, name: str, domainmodel_DomainEntity25: "domainmodel_DomainRepository" = None, domainmodel_DomainEntity: set["domainmodel_Feature"] = None):
        self.name = name
...
class domainmodel_StatelessComponent(BusinessFeatureType, AbstractNamespaceElement):
...
class domainmodel_DataType(Type, AbstractNamespaceElement):
