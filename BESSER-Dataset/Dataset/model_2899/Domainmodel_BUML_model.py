...
domainmodel_NamespaceDeclaration = Class(name="domainmodel_NamespaceDeclaration")
AbstractElement = Class(name="AbstractElement")
domainmodel_AbstractNamespaceElement = Class(name="domainmodel_AbstractNamespaceElement")
domainmodel_Feature = Class(name="domainmodel_Feature")
domainmodel_InterfaceOperationsUsageRule = Class(name="domainmodel_InterfaceOperationsUsageRule")
domainmodel_StatelessComponent = Class(name="domainmodel_StatelessComponent")
domainmodel_DomainRepository = Class(name="domainmodel_DomainRepository")
domainmodel_EntryParametersModule = Class(name="domainmodel_EntryParametersModule")
ScreenModule = Class(name="ScreenModule")
domainmodel_ModelFeature = Class(name="domainmodel_ModelFeature")
domainmodel_ModelModule = Class(name="domainmodel_ModelModule")
domainmodel_DomainEntity = Class(name="domainmodel_DomainEntity")
domainmodel_MethodParameter = Class(name="domainmodel_MethodParameter")
domainmodel_MethodParameters = Class(name="domainmodel_MethodParameters")
domainmodel_MethodCall = Class(name="domainmodel_MethodCall")
domainmodel_InterfaceOperation = Class(name="domainmodel_InterfaceOperation")
domainmodel_InterfaceDeclaration = Class(name="domainmodel_InterfaceDeclaration")
BusinessFeatureType = Class(name="BusinessFeatureType")
domainmodel_InterfaceOperationUsageRule = Class(name="domainmodel_InterfaceOperationUsageRule")
domainmodel_ContentElement = Class(name="domainmodel_ContentElement")
ViewElement = Class(name="ViewElement")
domainmodel_ContainerElement = Class(name="domainmodel_ContainerElement")
domainmodel_ViewElement = Class(name="domainmodel_ViewElement")
domainmodel_ViewModule = Class(name="domainmodel_ViewModule")
domainmodel_ElementFeature = Class(name="domainmodel_ElementFeature")
domainmodel_BindEnumSource = Class(name="domainmodel_BindEnumSource")
BindSource = Class(name="BindSource")
domainmodel_BindSource = Class(name="domainmodel_BindSource")
domainmodel_BindAction = Class(name="domainmodel_BindAction")
domainmodel_InitActionFeature = Class(name="domainmodel_InitActionFeature")
domainmodel_InitActionModule = Class(name="domainmodel_InitActionModule")
ControllerElement = Class(name="ControllerElement")
domainmodel_ValidateAction = Class(name="domainmodel_ValidateAction")
InitActionFeature = Class(name="InitActionFeature")
domainmodel_ValidatorFeature = Class(name="domainmodel_ValidatorFeature")
domainmodel_SetUIElementReceiver = Class(name="domainmodel_SetUIElementReceiver")
domainmodel_AttachAction = Class(name="domainmodel_AttachAction")
domainmodel_UIActionModule = Class(name="domainmodel_UIActionModule")
domainmodel_ValidatorModule = Class(name="domainmodel_ValidatorModule")
domainmodel_ScreenModelParameter = Class(name="domainmodel_ScreenModelParameter")
domainmodel_ScreenModelParameters = Class(name="domainmodel_ScreenModelParameters")
domainmodel_NavigateToAction = Class(name="domainmodel_NavigateToAction")
UIActionFeature = Class(name="UIActionFeature")
domainmodel_ScreenFeature = Class(name="domainmodel_ScreenFeature")
domainmodel_ValidatorRule = Class(name="domainmodel_ValidatorRule")
domainmodel_ValidatorRules = Class(name="domainmodel_ValidatorRules")
domainmodel_SetRestCallReceiverIDParameter = Class(name="domainmodel_SetRestCallReceiverIDParameter")
domainmodel_SetRestCallReceiverParameter = Class(name="domainmodel_SetRestCallReceiverParameter")
domainmodel_SetRestCallReceiverParameters = Class(name="domainmodel_SetRestCallReceiverParameters")
domainmodel_SetRestCallReceiver = Class(name="domainmodel_SetRestCallReceiver")
SetActionReceiver = Class(name="SetActionReceiver")
domainmodel_ExecuteAction = Class(name="domainmodel_ExecuteAction")
domainmodel_SetRestCallReceiverURLParameter = Class(name="domainmodel_SetRestCallReceiverURLParameter")
SetRestCallReceiverParameter = Class(name="SetRestCallReceiverParameter")
domainmodel_SetRestCallReceiverReturnTypeParameter = Class(name="domainmodel_SetRestCallReceiverReturnTypeParameter")
domainmodel_InterfaceMethodCallParameters = Class(name="domainmodel_InterfaceMethodCallParameters")
domainmodel_InterfaceMethodCall = Class(name="domainmodel_InterfaceMethodCall")
domainmodel_BusinessFeature = Class(name="domainmodel_BusinessFeature")
domainmodel_UIActionFeature = Class(name="domainmodel_UIActionFeature")
domainmodel_SetActionReceiver = Class(name="domainmodel_SetActionReceiver")
domainmodel_SetAction = Class(name="domainmodel_SetAction")
domainmodel_InterfaceMethodCallParameter = Class(name="domainmodel_InterfaceMethodCallParameter")
domainmodel_UIFeature = Class(name="domainmodel_UIFeature")
domainmodel_UIModule = Class(name="domainmodel_UIModule")
SystemModule = Class(name="SystemModule")
domainmodel_BusinessFeatureType = Class(name="domainmodel_BusinessFeatureType")
domainmodel_ControllerElement = Class(name="domainmodel_ControllerElement")
domainmodel_ControllerModule = Class(name="domainmodel_ControllerModule")
domainmodel_ScreenModule = Class(name="domainmodel_ScreenModule")
UIFeature = Class(name="UIFeature")
domainmodel_MainFeatureOption = Class(name="domainmodel_MainFeatureOption")
domainmodel_MainFeature = Class(name="domainmodel_MainFeature")
domainmodel_BusinessFeatures = Class(name="domainmodel_BusinessFeatures")
BusinessModule = Class(name="BusinessModule")
domainmodel_BusinessModule = Class(name="domainmodel_BusinessModule")
domainmodel_SystemModule = Class(name="domainmodel_SystemModule")
domainmodel_SystemDefinition = Class(name="domainmodel_SystemDefinition")
...
domainmodel_DataType.attributes={domainmodel_DataType_initValue, domainmodel_DataType_mappedType, domainmodel_DataType_name}
...
domainmodel_Feature.attributes={domainmodel_Feature_mappingOption, domainmodel_Feature_mapName, domainmodel_Feature_name}
...
domain_model = DomainModel(
    name="domainmodel",
    types={domainmodel_Domainmodel, domainmodel_AbstractElement, domainmodel_Type, domainmodel_Import, AbstractNamespaceElement, domainmodel_DataType, Type, domainmodel_NamespaceDeclaration, AbstractElement, domainmodel_AbstractNamespaceElement, domainmodel_Feature, domainmodel_InterfaceOperationsUsageRule, domainmodel_StatelessComponent, domainmodel_DomainRepository, domainmodel_EntryParametersModule, ScreenModule, domainmodel_ModelFeature, domainmodel_ModelModule, domainmodel_DomainEntity, domainmodel_MethodParameter, domainmodel_MethodParameters, domainmodel_MethodCall, domainmodel_InterfaceOperation, domainmodel_InterfaceDeclaration, BusinessFeatureType, domainmodel_InterfaceOperationUsageRule, domainmodel_ContentElement, ViewElement, domainmodel_ContainerElement, domainmodel_ViewElement, domainmodel_ViewModule, domainmodel_ElementFeature, domainmodel_BindEnumSource, BindSource, domainmodel_BindSource, domainmodel_BindAction, domainmodel_InitActionFeature, domainmodel_InitActionModule, ControllerElement, domainmodel_ValidateAction, InitActionFeature, domainmodel_ValidatorFeature, domainmodel_SetUIElementReceiver, domainmodel_AttachAction, domainmodel_UIActionModule, domainmodel_ValidatorModule, domainmodel_ScreenModelParameter, domainmodel_ScreenModelParameters, domainmodel_NavigateToAction, UIActionFeature, domainmodel_ScreenFeature, domainmodel_ValidatorRule, domainmodel_ValidatorRules, domainmodel_SetRestCallReceiverIDParameter, domainmodel_SetRestCallReceiverParameter, domainmodel_SetRestCallReceiverParameters, domainmodel_SetRestCallReceiver, SetActionReceiver, domainmodel_ExecuteAction, domainmodel_SetRestCallReceiverURLParameter, SetRestCallReceiverParameter, domainmodel_SetRestCallReceiverReturnTypeParameter, domainmodel_InterfaceMethodCallParameters, domainmodel_InterfaceMethodCall, domainmodel_BusinessFeature, domainmodel_UIActionFeature, domainmodel_SetActionReceiver, domainmodel_SetAction, domainmodel_InterfaceMethodCallParameter, domainmodel_UIFeature, domainmodel_UIModule, SystemModule, domainmodel_BusinessFeatureType, domainmodel_ControllerElement, domainmodel_ControllerModule, domainmodel_ScreenModule, UIFeature, domainmodel_MainFeatureOption, domainmodel_MainFeature, domainmodel_BusinessFeatures, BusinessModule, domainmodel_BusinessModule, domainmodel_SystemModule, domainmodel_SystemDefinition, ContainerElementLiteral, ContentElementLiteral, PropertyNameLiteral, UIElementReceiverKey},
    associations={elements0, namespaceElements1, usageOperations20, operations22, entityType24, operations26, entryFeatures29, type30, modelFeatures33, type2, features3, type5, parameters7, parameters9, methodCall11, type13, operations16, interfaceName18, elements35, features36, uiReceiver44, modelFeatureName47, bindSource49, uiReceiver51, elements38, condition40, uiReceiver41, uiAction43, validatorRules59, validatorFeatures62, modelFeatureName64, parameters66, screenElementId68, initActionFeatures54, conditionName55, validatorRules57, parameters76, parameters77, widgetName79, modelFeatures69, uiActionName72, parameterType74, parameters88, interfaceInstanceName90, methodName91, parameters94, uiActionFeatures97, modelFeatureName82, setActionReceiver84, parameterName86, features102, uiFeatures103, type104, elements99, screenModules100, connectPoint2107, features109, modules111},
    generalizations={gen_domainmodel_Import_AbstractNamespaceElement, gen_domainmodel_DataType_Type, gen_domainmodel_DataType_AbstractNamespaceElement, gen_domainmodel_NamespaceDeclaration_AbstractElement, gen_domainmodel_StatelessComponent_AbstractNamespaceElement, gen_domainmodel_StatelessComponent_BusinessFeatureType, gen_domainmodel_DomainRepository_AbstractNamespaceElement, gen_domainmodel_DomainRepository_BusinessFeatureType, gen_domainmodel_EntryParametersModule_ScreenModule, gen_domainmodel_ModelModule_ScreenModule, gen_domainmodel_DomainEntity_Type, gen_domainmodel_DomainEntity_AbstractNamespaceElement, gen_domainmodel_InterfaceDeclaration_AbstractNamespaceElement, gen_domainmodel_InterfaceDeclaration_BusinessFeatureType, gen_domainmodel_ContentElement_ViewElement, gen_domainmodel_ContainerElement_ViewElement, gen_domainmodel_ViewModule_ScreenModule, gen_domainmodel_BindEnumSource_BindSource, gen_domainmodel_BindAction_InitActionFeature, gen_domainmodel_InitActionModule_ControllerElement, gen_domainmodel_ValidateAction_InitActionFeature, gen_domainmodel_AttachAction_InitActionFeature, gen_domainmodel_ValidatorModule_ControllerElement, gen_domainmodel_NavigateToAction_UIActionFeature, gen_domainmodel_SetRestCallReceiverIDParameter_SetRestCallReceiverParameter, gen_domainmodel_SetRestCallReceiver_SetActionReceiver, gen_domainmodel_SetUIElementReceiver_SetActionReceiver, gen_domainmodel_ExecuteAction_UIActionFeature, gen_domainmodel_SetRestCallReceiverURLParameter_SetRestCallReceiverParameter, gen_domainmodel_SetRestCallReceiverReturnTypeParameter_SetRestCallReceiverParameter, gen_domainmodel_InterfaceMethodCall_UIActionFeature, gen_domainmodel_UIActionModule_ControllerElement, gen_domainmodel_SetAction_InitActionFeature, gen_domainmodel_SetAction_UIActionFeature, gen_domainmodel_UIModule_SystemModule, gen_domainmodel_ControllerModule_ScreenModule, gen_domainmodel_ScreenFeature_UIFeature, gen_domainmodel_MainFeature_UIFeature, gen_domainmodel_BusinessFeatures_BusinessModule, gen_domainmodel_BusinessModule_SystemModule, gen_domainmodel_SystemDefinition_AbstractElement},
    metadata=None
)
