...
def test_RefOntoUML_LiteralDecimal_value_value_roundtrip():
    instance = RefOntoUML_LiteralDecimal(value="sample_text")
    assert instance.value == "sample_text"
    instance.value = "sample_text_2"
    assert instance.value == "sample_text_2"
...
def test_RefOntoUML_MeasurementDimension_unitOfMeasure_value_roundtrip():
    instance = RefOntoUML_MeasurementDimension(unitOfMeasure="sample_text")
    assert instance.unitOfMeasure == "sample_text"
    instance.unitOfMeasure = "sample_text_2"
    assert instance.unitOfMeasure == "sample_text_2"
...
def test_RefOntoUML_DecimalMeasurementRegion_isa_BasicMeasurementRegion():
    instance = RefOntoUML_DecimalMeasurementRegion()
    assert isinstance(instance, BasicMeasurementRegion)


def test_RefOntoUML_IntegerMeasurementRegion_isa_BasicMeasurementRegion():
    instance = RefOntoUML_IntegerMeasurementRegion()
    assert isinstance(instance, BasicMeasurementRegion)
...
def test_RefOntoUML_ReferenceStructure_isa_DataType():
    instance = RefOntoUML_ReferenceStructure()
    assert isinstance(instance, DataType)
...
def test_RefOntoUML_Structuration_isa_DependencyRelationship():
    instance = RefOntoUML_Structuration()
    assert isinstance(instance, DependencyRelationship)
...
def test_RefOntoUML_MeasurementEnumeration_isa_Enumeration():
    instance = RefOntoUML_MeasurementEnumeration()
    assert isinstance(instance, Enumeration)


def test_RefOntoUML_MeasurementLiteral_isa_EnumerationLiteral():
    instance = RefOntoUML_MeasurementLiteral()
...
def test_RefOntoUML_DecimalIntervalDimension_isa_IntervalDimension():
    instance = RefOntoUML_DecimalIntervalDimension()
    assert isinstance(instance, IntervalDimension)


def test_RefOntoUML_IntegerIntervalDimension_isa_IntervalDimension():
    instance = RefOntoUML_IntegerIntervalDimension()
    assert isinstance(instance, IntervalDimension)
...
def test_RefOntoUML_DecimalMeasurementRegion_isa_LiteralDecimal():
    instance = RefOntoUML_DecimalMeasurementRegion()
    assert isinstance(instance, LiteralDecimal)


def test_RefOntoUML_IntegerMeasurementRegion_isa_LiteralInteger():
    instance = RefOntoUML_IntegerMeasurementRegion()
...
def test_RefOntoUML_LiteralDecimal_isa_LiteralSpecification():
    instance = RefOntoUML_LiteralDecimal(value="sample_text")
    assert isinstance(instance, LiteralSpecification)
...
def test_RefOntoUML_StringNominalRegion_isa_LiteralString():
    instance = RefOntoUML_StringNominalRegion()
    assert isinstance(instance, LiteralString)


def test_RefOntoUML_NonPerceivableQuality_isa_MeasurableQuality():
    instance = RefOntoUML_NonPerceivableQuality()
    assert isinstance(instance, MeasurableQuality)


def test_RefOntoUML_PerceivableQuality_isa_MeasurableQuality():
    instance = RefOntoUML_PerceivableQuality()
    assert isinstance(instance, MeasurableQuality)


def test_RefOntoUML_IntervalDimension_isa_MeasurementDimension():
    instance = RefOntoUML_IntervalDimension()
    assert isinstance(instance, MeasurementDimension)


def test_RefOntoUML_OrdinalDimension_isa_MeasurementDimension():
    instance = RefOntoUML_OrdinalDimension()
    assert isinstance(instance, MeasurementDimension)


def test_RefOntoUML_RationalDimension_isa_MeasurementDimension():
    instance = RefOntoUML_RationalDimension()
    assert isinstance(instance, MeasurementDimension)


def test_RefOntoUML_BasicMeasurementRegion_isa_MeasurementRegion():
    instance = RefOntoUML_BasicMeasurementRegion()
    assert isinstance(instance, MeasurementRegion)


def test_RefOntoUML_ComposedMeasurementRegion_isa_MeasurementRegion():
    instance = RefOntoUML_ComposedMeasurementRegion()
    assert isinstance(instance, MeasurementRegion)


def test_RefOntoUML_MeasurementDimension_isa_MeasurementStructure():
    instance = RefOntoUML_MeasurementDimension(unitOfMeasure="sample_text")
    assert isinstance(instance, MeasurementStructure)


def test_RefOntoUML_MeasurementDomain_isa_MeasurementStructure():
    instance = RefOntoUML_MeasurementDomain()
    assert isinstance(instance, MeasurementStructure)
...
def test_RefOntoUML_StringNominalRegion_isa_NominalRegion():
    instance = RefOntoUML_StringNominalRegion()
    assert isinstance(instance, NominalRegion)


def test_RefOntoUML_StringNominalStructure_isa_NominalStructure():
    instance = RefOntoUML_StringNominalStructure()
...
def test_RefOntoUML_DecimalOrdinalDimension_isa_OrdinalDimension():
    instance = RefOntoUML_DecimalOrdinalDimension()
    assert isinstance(instance, OrdinalDimension)


def test_RefOntoUML_IntegerOrdinalDimension_isa_OrdinalDimension():
    instance = RefOntoUML_IntegerOrdinalDimension()
    assert isinstance(instance, OrdinalDimension)
...
def test_RefOntoUML_MeasurableQuality_isa_Quality():
    instance = RefOntoUML_MeasurableQuality()
    assert isinstance(instance, Quality)


def test_RefOntoUML_NominalQuality_isa_Quality():
    instance = RefOntoUML_NominalQuality()
    assert isinstance(instance, Quality)


def test_RefOntoUML_DecimalRationalDimension_isa_RationalDimension():
    instance = RefOntoUML_DecimalRationalDimension()
    assert isinstance(instance, RationalDimension)


def test_RefOntoUML_IntegerRationalDimension_isa_RationalDimension():
    instance = RefOntoUML_IntegerRationalDimension()
    assert isinstance(instance, RationalDimension)
...
def test_RefOntoUML_MeasurementRegion_isa_ReferenceRegion():
    instance = RefOntoUML_MeasurementRegion()
    assert isinstance(instance, ReferenceRegion)


def test_RefOntoUML_NominalRegion_isa_ReferenceRegion():
    instance = RefOntoUML_NominalRegion()
    assert isinstance(instance, ReferenceRegion)


def test_RefOntoUML_MeasurementStructure_isa_ReferenceStructure():
    instance = RefOntoUML_MeasurementStructure()
    assert isinstance(instance, ReferenceStructure)


def test_RefOntoUML_NominalStructure_isa_ReferenceStructure():
    instance = RefOntoUML_NominalStructure()
    assert isinstance(instance, ReferenceStructure)
...
def test_RefOntoUML_ReferenceRegion_isa_ValueSpecification():
    instance = RefOntoUML_ReferenceRegion()
    assert isinstance(instance, ValueSpecification)
...
def test_assoc_classifier139_link_reassign_clear():
    ...
    if hasattr(b1, 'RefOntoUML_Classifier140'):
        assert _is_linked(b1, 'RefOntoUML_Classifier140', a)
    _safe_set(a, 'RefOntoUML_InstanceSpecification', {b2})
    assert _is_linked(a, 'RefOntoUML_InstanceSpecification', b2)
    if hasattr(b1, 'RefOntoUML_Classifier140'):
        assert not _is_linked(b1, 'RefOntoUML_Classifier140', a)
    if hasattr(b2, 'RefOntoUML_Classifier140'):
        assert _is_linked(b2, 'RefOntoUML_Classifier140', a)
    _safe_set(a, 'RefOntoUML_InstanceSpecification', set())
    assert not _is_linked(a, 'RefOntoUML_InstanceSpecification', b2)
    if hasattr(b2, 'RefOntoUML_Classifier140'):
        assert not _is_linked(b2, 'RefOntoUML_Classifier140', a)
...
def test_assoc_compositionRule162_link_reassign_clear():
    a = RefOntoUML_MeasurementDomain()
    b1 = RefOntoUML_Expression(symbol="sample_text")
    b2 = RefOntoUML_Expression(symbol="sample_text_2")
    _safe_set(a, 'RefOntoUML_MeasurementDomain', b1)
    assert _is_linked(a, 'RefOntoUML_MeasurementDomain', b1)
    if hasattr(b1, 'RefOntoUML_Expression163'):
        assert _is_linked(b1, 'RefOntoUML_Expression163', a)
    _safe_set(a, 'RefOntoUML_MeasurementDomain', b2)
    assert _is_linked(a, 'RefOntoUML_MeasurementDomain', b2)
    if hasattr(b1, 'RefOntoUML_Expression163'):
        assert not _is_linked(b1, 'RefOntoUML_Expression163', a)
    if hasattr(b2, 'RefOntoUML_Expression163'):
        assert _is_linked(b2, 'RefOntoUML_Expression163', a)
    _safe_set(a, 'RefOntoUML_MeasurementDomain', None)
    assert not _is_linked(a, 'RefOntoUML_MeasurementDomain', b2)
    if hasattr(b2, 'RefOntoUML_Expression163'):
        assert not _is_linked(b2, 'RefOntoUML_Expression163', a)
...
def test_assoc_definingFeature145_link_reassign_clear():
...
def test_assoc_domain156_link_reassign_clear():
    a = RefOntoUML_MeasurementDomain()
    b1 = RefOntoUML_MeasurementDimension(unitOfMeasure="sample_text")
    b2 = RefOntoUML_MeasurementDimension(unitOfMeasure="sample_text_2")
    _safe_set(a, 'MeasurementDomain', b1)
    assert _is_linked(a, 'MeasurementDomain', b1)
    if hasattr(b1, 'ownedDimensions'):
        assert _is_linked(b1, 'ownedDimensions', a)
    _safe_set(a, 'MeasurementDomain', b2)
    assert _is_linked(a, 'MeasurementDomain', b2)
    if hasattr(b1, 'ownedDimensions'):
        assert not _is_linked(b1, 'ownedDimensions', a)
    if hasattr(b2, 'ownedDimensions'):
        assert _is_linked(b2, 'ownedDimensions', a)
    _safe_set(a, 'MeasurementDomain', None)
    assert not _is_linked(a, 'MeasurementDomain', b2)
    if hasattr(b2, 'ownedDimensions'):
        assert not _is_linked(b2, 'ownedDimensions', a)
...
def test_assoc_instance168_link_reassign_clear():
    a = RefOntoUML_InstanceSpecification()
    b1 = RefOntoUML_InstanceValue()
    b2 = RefOntoUML_InstanceValue()
    _safe_set(a, 'RefOntoUML_InstanceSpecification169', b1)
    assert _is_linked(a, 'RefOntoUML_InstanceSpecification169', b1)
    if hasattr(b1, 'RefOntoUML_InstanceValue'):
        assert _is_linked(b1, 'RefOntoUML_InstanceValue', a)
    _safe_set(a, 'RefOntoUML_InstanceSpecification169', b2)
    assert _is_linked(a, 'RefOntoUML_InstanceSpecification169', b2)
    if hasattr(b1, 'RefOntoUML_InstanceValue'):
    ...
    _safe_set(a, 'RefOntoUML_InstanceSpecification169', None)
    assert not _is_linked(a, 'RefOntoUML_InstanceSpecification169', b2)
    if hasattr(b2, 'RefOntoUML_InstanceValue'):
        assert not _is_linked(b2, 'RefOntoUML_InstanceValue', a)


def test_assoc_lowerBound157_link_reassign_clear():
    a = RefOntoUML_MeasurementDimension(unitOfMeasure="sample_text")
    b1 = RefOntoUML_BasicMeasurementRegion()
    b2 = RefOntoUML_BasicMeasurementRegion()
    _safe_set(a, 'RefOntoUML_MeasurementDimension', b1)
    assert _is_linked(a, 'RefOntoUML_MeasurementDimension', b1)
    if hasattr(b1, 'RefOntoUML_BasicMeasurementRegion'):
        assert _is_linked(b1, 'RefOntoUML_BasicMeasurementRegion', a)
    _safe_set(a, 'RefOntoUML_MeasurementDimension', b2)
    assert _is_linked(a, 'RefOntoUML_MeasurementDimension', b2)
    if hasattr(b1, 'RefOntoUML_BasicMeasurementRegion'):
        assert not _is_linked(b1, 'RefOntoUML_BasicMeasurementRegion', a)
    if hasattr(b2, 'RefOntoUML_BasicMeasurementRegion'):
        assert _is_linked(b2, 'RefOntoUML_BasicMeasurementRegion', a)
    _safe_set(a, 'RefOntoUML_MeasurementDimension', None)
    assert not _is_linked(a, 'RefOntoUML_MeasurementDimension', b2)
    if hasattr(b2, 'RefOntoUML_BasicMeasurementRegion'):
        assert not _is_linked(b2, 'RefOntoUML_BasicMeasurementRegion', a)
...
def test_assoc_ownedDimensions161_link_reassign_clear():
    a = RefOntoUML_MeasurementDomain()
    b1 = RefOntoUML_MeasurementDimension(unitOfMeasure="sample_text")
    b2 = RefOntoUML_MeasurementDimension(unitOfMeasure="sample_text_2")
    _safe_set(a, 'domain', {b1})
    assert _is_linked(a, 'domain', b1)
    if hasattr(b1, 'MeasurementDimension'):
        assert _is_linked(b1, 'MeasurementDimension', a)
    _safe_set(a, 'domain', {b2})
    assert _is_linked(a, 'domain', b2)
    if hasattr(b1, 'MeasurementDimension'):
        assert not _is_linked(b1, 'MeasurementDimension', a)
    if hasattr(b2, 'MeasurementDimension'):
        assert _is_linked(b2, 'MeasurementDimension', a)
    _safe_set(a, 'domain', set())
    assert not _is_linked(a, 'domain', b2)
    if hasattr(b2, 'MeasurementDimension'):
        assert not _is_linked(b2, 'MeasurementDimension', a)
...
def test_assoc_owningInstance149_link_reassign_clear():
    a = RefOntoUML_InstanceSpecification()
    b1 = RefOntoUML_Slot()
    b2 = RefOntoUML_Slot()
...
def test_assoc_slot141_link_reassign_clear():
    a = RefOntoUML_InstanceSpecification()
    b1 = RefOntoUML_Slot()
    b2 = RefOntoUML_Slot()
...
def test_assoc_specification142_link_reassign_clear():
    a = RefOntoUML_ValueSpecification()
    b1 = RefOntoUML_InstanceSpecification()
    b2 = RefOntoUML_InstanceSpecification()
    _safe_set(a, 'RefOntoUML_ValueSpecification144', b1)
    assert _is_linked(a, 'RefOntoUML_ValueSpecification144', b1)
    if hasattr(b1, 'RefOntoUML_InstanceSpecification143'):
        assert _is_linked(b1, 'RefOntoUML_InstanceSpecification143', a)
    _safe_set(a, 'RefOntoUML_ValueSpecification144', b2)
    assert _is_linked(a, 'RefOntoUML_ValueSpecification144', b2)
    if hasattr(b1, 'RefOntoUML_InstanceSpecification143'):
        assert not _is_linked(b1, 'RefOntoUML_InstanceSpecification143', a)
    if hasattr(b2, 'RefOntoUML_InstanceSpecification143'):
        assert _is_linked(b2, 'RefOntoUML_InstanceSpecification143', a)
    _safe_set(a, 'RefOntoUML_ValueSpecification144', None)
    assert not _is_linked(a, 'RefOntoUML_ValueSpecification144', b2)
    if hasattr(b2, 'RefOntoUML_InstanceSpecification143'):
        assert not _is_linked(b2, 'RefOntoUML_InstanceSpecification143', a)
...
def test_assoc_upperBound158_link_reassign_clear():
    a = RefOntoUML_MeasurementDimension(unitOfMeasure="sample_text")
    b1 = RefOntoUML_BasicMeasurementRegion()
    b2 = RefOntoUML_BasicMeasurementRegion()
    _safe_set(a, 'RefOntoUML_MeasurementDimension159', b1)
    assert _is_linked(a, 'RefOntoUML_MeasurementDimension159', b1)
    if hasattr(b1, 'RefOntoUML_BasicMeasurementRegion160'):
        assert _is_linked(b1, 'RefOntoUML_BasicMeasurementRegion160', a)
    _safe_set(a, 'RefOntoUML_MeasurementDimension159', b2)
    assert _is_linked(a, 'RefOntoUML_MeasurementDimension159', b2)
    if hasattr(b1, 'RefOntoUML_BasicMeasurementRegion160'):
        assert not _is_linked(b1, 'RefOntoUML_BasicMeasurementRegion160', a)
    if hasattr(b2, 'RefOntoUML_BasicMeasurementRegion160'):
        assert _is_linked(b2, 'RefOntoUML_BasicMeasurementRegion160', a)
    _safe_set(a, 'RefOntoUML_MeasurementDimension159', None)
    assert not _is_linked(a, 'RefOntoUML_MeasurementDimension159', b2)
    if hasattr(b2, 'RefOntoUML_BasicMeasurementRegion160'):
        assert not _is_linked(b2, 'RefOntoUML_BasicMeasurementRegion160', a)
...
def test_assoc_value146_link_reassign_clear():
    ...
    b1 = RefOntoUML_Slot()
    b2 = RefOntoUML_Slot()
    _safe_set(a, 'RefOntoUML_ValueSpecification148', b1)
    assert _is_linked(a, 'RefOntoUML_ValueSpecification148', b1)
    if hasattr(b1, 'RefOntoUML_Slot147'):
        assert _is_linked(b1, 'RefOntoUML_Slot147', a)
    _safe_set(a, 'RefOntoUML_ValueSpecification148', b2)
    assert _is_linked(a, 'RefOntoUML_ValueSpecification148', b2)
    if hasattr(b1, 'RefOntoUML_Slot147'):
        assert not _is_linked(b1, 'RefOntoUML_Slot147', a)
    if hasattr(b2, 'RefOntoUML_Slot147'):
        assert _is_linked(b2, 'RefOntoUML_Slot147', a)
    _safe_set(a, 'RefOntoUML_ValueSpecification148', None)
    assert not _is_linked(a, 'RefOntoUML_ValueSpecification148', b2)
    if hasattr(b2, 'RefOntoUML_Slot147'):
        assert not _is_linked(b2, 'RefOntoUML_Slot147', a)
...
BasicMeasurementRegion_strategy = st.builds(BasicMeasurementRegion)
...
IntervalDimension_strategy = st.builds(IntervalDimension)
...
LiteralDecimal_strategy = st.builds(LiteralDecimal)
...
LiteralInteger_strategy = st.builds(LiteralInteger)
...
MeasurableQuality_strategy = st.builds(MeasurableQuality)
...
MeasurementDimension_strategy = st.builds(MeasurementDimension)
...
MeasurementRegion_strategy = st.builds(MeasurementRegion)
...
MeasurementStructure_strategy = st.builds(MeasurementStructure)
...
NominalRegion_strategy = st.builds(NominalRegion)
...
NominalStructure_strategy = st.builds(NominalStructure)
...
OrdinalDimension_strategy = st.builds(OrdinalDimension)
...
Quality_strategy = st.builds(Quality)
...
RationalDimension_strategy = st.builds(RationalDimension)
...
RefOntoUML_BasicMeasurementRegion_strategy = st.builds(RefOntoUML_BasicMeasurementRegion)
...
RefOntoUML_ComposedMeasurementRegion_strategy = st.builds(RefOntoUML_ComposedMeasurementRegion)
...
RefOntoUML_DecimalIntervalDimension_strategy = st.builds(RefOntoUML_DecimalIntervalDimension)
...
RefOntoUML_DecimalMeasurementRegion_strategy = st.builds(RefOntoUML_DecimalMeasurementRegion)
...
RefOntoUML_DecimalOrdinalDimension_strategy = st.builds(RefOntoUML_DecimalOrdinalDimension)
...
RefOntoUML_DecimalRationalDimension_strategy = st.builds(RefOntoUML_DecimalRationalDimension)
...
RefOntoUML_IntegerIntervalDimension_strategy = st.builds(RefOntoUML_IntegerIntervalDimension)
...
RefOntoUML_IntegerMeasurementRegion_strategy = st.builds(RefOntoUML_IntegerMeasurementRegion)
...
RefOntoUML_IntegerOrdinalDimension_strategy = st.builds(RefOntoUML_IntegerOrdinalDimension)
...
RefOntoUML_IntegerRationalDimension_strategy = st.builds(RefOntoUML_IntegerRationalDimension)
...
RefOntoUML_IntervalDimension_strategy = st.builds(RefOntoUML_IntervalDimension)
...
RefOntoUML_LiteralDecimal_strategy = st.builds(RefOntoUML_LiteralDecimal, value=safe_text)
...
RefOntoUML_MeasurableQuality_strategy = st.builds(RefOntoUML_MeasurableQuality)
...
RefOntoUML_MeasurementDimension_strategy = st.builds(RefOntoUML_MeasurementDimension, unitOfMeasure=safe_text)
...
RefOntoUML_MeasurementDomain_strategy = st.builds(RefOntoUML_MeasurementDomain)
...
RefOntoUML_MeasurementEnumeration_strategy = st.builds(RefOntoUML_MeasurementEnumeration)
...
RefOntoUML_MeasurementLiteral_strategy = st.builds(RefOntoUML_MeasurementLiteral)
...
RefOntoUML_MeasurementRegion_strategy = st.builds(RefOntoUML_MeasurementRegion)
...
RefOntoUML_MeasurementStructure_strategy = st.builds(RefOntoUML_MeasurementStructure)
...
RefOntoUML_NominalQuality_strategy = st.builds(RefOntoUML_NominalQuality)
...
RefOntoUML_NominalRegion_strategy = st.builds(RefOntoUML_NominalRegion)
...
RefOntoUML_NominalStructure_strategy = st.builds(RefOntoUML_NominalStructure)
...
RefOntoUML_NonPerceivableQuality_strategy = st.builds(RefOntoUML_NonPerceivableQuality)
...
RefOntoUML_OrdinalDimension_strategy = st.builds(RefOntoUML_OrdinalDimension)
...
RefOntoUML_PerceivableQuality_strategy = st.builds(RefOntoUML_PerceivableQuality)
...
RefOntoUML_RationalDimension_strategy = st.builds(RefOntoUML_RationalDimension)
...
RefOntoUML_ReferenceRegion_strategy = st.builds(RefOntoUML_ReferenceRegion)
...
RefOntoUML_ReferenceStructure_strategy = st.builds(RefOntoUML_ReferenceStructure)
...
RefOntoUML_StringNominalRegion_strategy = st.builds(RefOntoUML_StringNominalRegion)
...
RefOntoUML_StringNominalStructure_strategy = st.builds(RefOntoUML_StringNominalStructure)
...
RefOntoUML_Structuration_strategy = st.builds(RefOntoUML_Structuration)
...
ReferenceRegion_strategy = st.builds(ReferenceRegion)
...
ReferenceStructure_strategy = st.builds(ReferenceStructure)
