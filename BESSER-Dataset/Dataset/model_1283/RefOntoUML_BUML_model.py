...
# Classes
RefOntoUML_Comment = Class(name="RefOntoUML_Comment")
Element = Class(name="Element")
RefOntoUML_Element = Class(name="RefOntoUML_Element", is_abstract=True)
EModelElement = Class(name="EModelElement")
RefOntoUML_Package = Class(name="RefOntoUML_Package")
Namespace = Class(name="Namespace")
PackageableElement = Class(name="PackageableElement")
RefOntoUML_Type = Class(name="RefOntoUML_Type", is_abstract=True)
RefOntoUML_PackageMerge = Class(name="RefOntoUML_PackageMerge")
RefOntoUML_PackageableElement = Class(name="RefOntoUML_PackageableElement", is_abstract=True)
NamedElement = Class(name="NamedElement")
RefOntoUML_NamedElement = Class(name="RefOntoUML_NamedElement", is_abstract=True)
RefOntoUML_Dependency = Class(name="RefOntoUML_Dependency")
RefOntoUML_Namespace = Class(name="RefOntoUML_Namespace", is_abstract=True)
RefOntoUML_DirectedRelationship = Class(name="RefOntoUML_DirectedRelationship", is_abstract=True)
Relationship = Class(name="Relationship")
RefOntoUML_Relationship = Class(name="RefOntoUML_Relationship", is_abstract=True)
RefOntoUML_StringExpression = Class(name="RefOntoUML_StringExpression")
DirectedRelationship = Class(name="DirectedRelationship")
RefOntoUML_PackageImport = Class(name="RefOntoUML_PackageImport")
RefOntoUML_Constraintx = Class(name="RefOntoUML_Constraintx")
RefOntoUML_ElementImport = Class(name="RefOntoUML_ElementImport")
TypedElement = Class(name="TypedElement")
RefOntoUML_TypedElement = Class(name="RefOntoUML_TypedElement", is_abstract=True)
RefOntoUML_ValueSpecification = Class(name="RefOntoUML_ValueSpecification", is_abstract=True)
RefOntoUML_Association = Class(name="RefOntoUML_Association")
Classifier = Class(name="Classifier")
RefOntoUML_Classifier = Class(name="RefOntoUML_Classifier", is_abstract=True)
RedefinableElement = Class(name="RedefinableElement")
Type = Class(name="Type")
RefOntoUML_Property = Class(name="RefOntoUML_Property")
RefOntoUML_RedefinableElement = Class(name="RefOntoUML_RedefinableElement", is_abstract=True)
RefOntoUML_Generalization = Class(name="RefOntoUML_Generalization")
RefOntoUML_GeneralizationSet = Class(name="RefOntoUML_GeneralizationSet")
RefOntoUML_Feature = Class(name="RefOntoUML_Feature", is_abstract=True)
RefOntoUML_OpaqueExpression = Class(name="RefOntoUML_OpaqueExpression")
ValueSpecification = Class(name="ValueSpecification")
RefOntoUML_MultiplicityElement = Class(name="RefOntoUML_MultiplicityElement", is_abstract=True)
StructuralFeature = Class(name="StructuralFeature")
RefOntoUML_DataType = Class(name="RefOntoUML_DataType")
RefOntoUML_Class = Class(name="RefOntoUML_Class")
RefOntoUML_Model = Class(name="RefOntoUML_Model")
Package = Class(name="Package")
RefOntoUML_StructuralFeature = Class(name="RefOntoUML_StructuralFeature", is_abstract=True)
Feature = Class(name="Feature")
MultiplicityElement = Class(name="MultiplicityElement")
Expression = Class(name="Expression")
RefOntoUML_Expression = Class(name="RefOntoUML_Expression")
RefOntoUML_InstanceSpecification = Class(name="RefOntoUML_InstanceSpecification")
RefOntoUML_MeasurementEnumeration = Class(name="RefOntoUML_MeasurementEnumeration")
Enumeration_ = Class(name="Enumeration")
RefOntoUML_Slot = Class(name="RefOntoUML_Slot")
RefOntoUML_LiteralSpecification = Class(name="RefOntoUML_LiteralSpecification", is_abstract=True)
RefOntoUML_Enumeration = Class(name="RefOntoUML_Enumeration")
DataType = Class(name="DataType")
RefOntoUML_EnumerationLiteral = Class(name="RefOntoUML_EnumerationLiteral")
InstanceSpecification = Class(name="InstanceSpecification")
RefOntoUML_MeasurementStructure = Class(name="RefOntoUML_MeasurementStructure", is_abstract=True)
RefOntoUML_MeasurementLiteral = Class(name="RefOntoUML_MeasurementLiteral")
EnumerationLiteral = Class(name="EnumerationLiteral")
RefOntoUML_MeasurementRegion = Class(name="RefOntoUML_MeasurementRegion", is_abstract=True)
RefOntoUML_PrimitiveType = Class(name="RefOntoUML_PrimitiveType")
RefOntoUML_ReferenceStructure = Class(name="RefOntoUML_ReferenceStructure", is_abstract=True)
RefOntoUML_ReferenceRegion = Class(name="RefOntoUML_ReferenceRegion", is_abstract=True)
RefOntoUML_NominalStructure = Class(name="RefOntoUML_NominalStructure")
ReferenceStructure = Class(name="ReferenceStructure")
RefOntoUML_StringNominalStructure = Class(name="RefOntoUML_StringNominalStructure")
NominalStructure = Class(name="NominalStructure")
RefOntoUML_MeasurementDimension = Class(name="RefOntoUML_MeasurementDimension", is_abstract=True)
MeasurementStructure = Class(name="MeasurementStructure")
RefOntoUML_DecimalIntervalDimension = Class(name="RefOntoUML_DecimalIntervalDimension")
RefOntoUML_MeasurementDomain = Class(name="RefOntoUML_MeasurementDomain")
RefOntoUML_BasicMeasurementRegion = Class(name="RefOntoUML_BasicMeasurementRegion", is_abstract=True)
RefOntoUML_OrdinalDimension = Class(name="RefOntoUML_OrdinalDimension", is_abstract=True)
MeasurementDimension = Class(name="MeasurementDimension")
RefOntoUML_IntegerOrdinalDimension = Class(name="RefOntoUML_IntegerOrdinalDimension")
OrdinalDimension = Class(name="OrdinalDimension")
RefOntoUML_DecimalOrdinalDimension = Class(name="RefOntoUML_DecimalOrdinalDimension")
RefOntoUML_IntervalDimension = Class(name="RefOntoUML_IntervalDimension", is_abstract=True)
RefOntoUML_IntegerIntervalDimension = Class(name="RefOntoUML_IntegerIntervalDimension")
IntervalDimension = Class(name="IntervalDimension")
RefOntoUML_RationalDimension = Class(name="RefOntoUML_RationalDimension", is_abstract=True)
RefOntoUML_IntegerRationalDimension = Class(name="RefOntoUML_IntegerRationalDimension")
RationalDimension = Class(name="RationalDimension")
RefOntoUML_DecimalRationalDimension = Class(name="RefOntoUML_DecimalRationalDimension")
ReferenceRegion = Class(name="ReferenceRegion")
MeasurementRegion = Class(name="MeasurementRegion")
RefOntoUML_DecimalMeasurementRegion = Class(name="RefOntoUML_DecimalMeasurementRegion")
BasicMeasurementRegion = Class(name="BasicMeasurementRegion")
LiteralDecimal = Class(name="LiteralDecimal")
RefOntoUML_IntegerMeasurementRegion = Class(name="RefOntoUML_IntegerMeasurementRegion")
LiteralInteger = Class(name="LiteralInteger")
RefOntoUML_ComposedMeasurementRegion = Class(name="RefOntoUML_ComposedMeasurementRegion")
RefOntoUML_NominalRegion = Class(name="RefOntoUML_NominalRegion", is_abstract=True)
RefOntoUML_StringNominalRegion = Class(name="RefOntoUML_StringNominalRegion")
NominalRegion = Class(name="NominalRegion")
LiteralString = Class(name="LiteralString")
RefOntoUML_LiteralInteger = Class(name="RefOntoUML_LiteralInteger")
LiteralSpecification = Class(name="LiteralSpecification")
RefOntoUML_LiteralDecimal = Class(name="RefOntoUML_LiteralDecimal")
RefOntoUML_LiteralString = Class(name="RefOntoUML_LiteralString")
RefOntoUML_LiteralBoolean = Class(name="RefOntoUML_LiteralBoolean")
RefOntoUML_LiteralNull = Class(name="RefOntoUML_LiteralNull")
RefOntoUML_InstanceValue = Class(name="RefOntoUML_InstanceValue")
RefOntoUML_LiteralUnlimitedNatural = Class(name="RefOntoUML_LiteralUnlimitedNatural")
RefOntoUML_Quantity = Class(name="RefOntoUML_Quantity")
RefOntoUML_ObjectClass = Class(name="RefOntoUML_ObjectClass", is_abstract=True)
Class_ = Class(name="Class")
RefOntoUML_MomentClass = Class(name="RefOntoUML_MomentClass", is_abstract=True)
RefOntoUML_SortalClass = Class(name="RefOntoUML_SortalClass", is_abstract=True)
ObjectClass = Class(name="ObjectClass")
RefOntoUML_MixinClass = Class(name="RefOntoUML_MixinClass", is_abstract=True)
RefOntoUML_RigidSortalClass = Class(name="RefOntoUML_RigidSortalClass", is_abstract=True)
SortalClass = Class(name="SortalClass")
RefOntoUML_AntiRigidSortalClass = Class(name="RefOntoUML_AntiRigidSortalClass", is_abstract=True)
RefOntoUML_SubstanceSortal = Class(name="RefOntoUML_SubstanceSortal", is_abstract=True)
RigidSortalClass = Class(name="RigidSortalClass")
RefOntoUML_SubKind = Class(name="RefOntoUML_SubKind")
RefOntoUML_Kind = Class(name="RefOntoUML_Kind")
SubstanceSortal = Class(name="SubstanceSortal")
RefOntoUML_Collective = Class(name="RefOntoUML_Collective")
RefOntoUML_Phase = Class(name="RefOntoUML_Phase")
AntiRigidSortalClass = Class(name="AntiRigidSortalClass")
RefOntoUML_Role = Class(name="RefOntoUML_Role")
RefOntoUML_RigidMixinClass = Class(name="RefOntoUML_RigidMixinClass", is_abstract=True)
MixinClass = Class(name="MixinClass")
RefOntoUML_NonRigidMixinClass = Class(name="RefOntoUML_NonRigidMixinClass", is_abstract=True)
RefOntoUML_Category = Class(name="RefOntoUML_Category")
RigidMixinClass = Class(name="RigidMixinClass")
RefOntoUML_AntiRigidMixinClass = Class(name="RefOntoUML_AntiRigidMixinClass", is_abstract=True)
NonRigidMixinClass = Class(name="NonRigidMixinClass")
RefOntoUML_SemiRigidMixinClass = Class(name="RefOntoUML_SemiRigidMixinClass", is_abstract=True)
RefOntoUML_RoleMixin = Class(name="RefOntoUML_RoleMixin")
AntiRigidMixinClass = Class(name="AntiRigidMixinClass")
RefOntoUML_Relator = Class(name="RefOntoUML_Relator")
RefOntoUML_Mixin = Class(name="RefOntoUML_Mixin")
SemiRigidMixinClass = Class(name="SemiRigidMixinClass")
RefOntoUML_IntrinsicMomentClass = Class(name="RefOntoUML_IntrinsicMomentClass", is_abstract=True)
MomentClass = Class(name="MomentClass")
RefOntoUML_Mode = Class(name="RefOntoUML_Mode")
IntrinsicMomentClass = Class(name="IntrinsicMomentClass")
RefOntoUML_Quality = Class(name="RefOntoUML_Quality", is_abstract=True)
RefOntoUML_MeasurableQuality = Class(name="RefOntoUML_MeasurableQuality", is_abstract=True)
Quality = Class(name="Quality")
RefOntoUML_NominalQuality = Class(name="RefOntoUML_NominalQuality")
RefOntoUML_NonPerceivableQuality = Class(name="RefOntoUML_NonPerceivableQuality")
MeasurableQuality = Class(name="MeasurableQuality")
RefOntoUML_PerceivableQuality = Class(name="RefOntoUML_PerceivableQuality")
RefOntoUML_DirectedBinaryAssociation = Class(name="RefOntoUML_DirectedBinaryAssociation", is_abstract=True)
Association = Class(name="Association")
RefOntoUML_Meronymic = Class(name="RefOntoUML_Meronymic", is_abstract=True)
DirectedBinaryAssociation = Class(name="DirectedBinaryAssociation")
RefOntoUML_subQuantityOf = Class(name="RefOntoUML_subQuantityOf")
Meronymic = Class(name="Meronymic")
RefOntoUML_subCollectionOf = Class(name="RefOntoUML_subCollectionOf")
RefOntoUML_Derivation = Class(name="RefOntoUML_Derivation")
RefOntoUML_memberOf = Class(name="RefOntoUML_memberOf")
RefOntoUML_componentOf = Class(name="RefOntoUML_componentOf")
RefOntoUML_DependencyRelationship = Class(name="RefOntoUML_DependencyRelationship", is_abstract=True)
RefOntoUML_Characterization = Class(name="RefOntoUML_Characterization")
DependencyRelationship = Class(name="DependencyRelationship")
RefOntoUML_Mediation = Class(name="RefOntoUML_Mediation")
RefOntoUML_Structuration = Class(name="RefOntoUML_Structuration")
RefOntoUML_FormalAssociation = Class(name="RefOntoUML_FormalAssociation")
RefOntoUML_MaterialAssociation = Class(name="RefOntoUML_MaterialAssociation")
...
RefOntoUML_Element_m_addKeyword: Method = Method(name="addKeyword", parameters={Parameter(name='RefOntoUML_keyword', type=StringType)}, type=StringType)
RefOntoUML_Element_m_removeKeyword: Method = Method(name="removeKeyword", parameters={Parameter(name='RefOntoUML_keyword', type=StringType)}, type=StringType)
...
RefOntoUML_Element_m_getApplicableStereotype: Method = Method(name="getApplicableStereotype", parameters={Parameter(name='RefOntoUML_qualifiedName', type=StringType)})
RefOntoUML_Element_m_getStereotypeApplications: Method = Method(name="getStereotypeApplications", parameters={})
RefOntoUML_Element_m_getRequiredStereotype: Method = Method(name="getRequiredStereotype", parameters={Parameter(name='RefOntoUML_qualifiedName', type=StringType)})
RefOntoUML_Element_m_getAppliedStereotype: Method = Method(name="getAppliedStereotype", parameters={Parameter(name='RefOntoUML_qualifiedName', type=StringType)})
RefOntoUML_Element_m_not_own_self: Method = Method(name="not_own_self", parameters={Parameter(name='RefOntoUML_diagnostics', type=StringType), Parameter(name='RefOntoUML_context', type=StringType)}, type=BooleanType)
RefOntoUML_Element_m_has_owner: Method = Method(name="has_owner", parameters={Parameter(name='RefOntoUML_context', type=StringType), Parameter(name='RefOntoUML_diagnostics', type=StringType)}, type=BooleanType)
RefOntoUML_Element_m_destroy: Method = Method(name="destroy", parameters={})
RefOntoUML_Element_m_hasKeyword: Method = Method(name="hasKeyword", parameters={Parameter(name='RefOntoUML_keyword', type=StringType)}, type=StringType)
...
RefOntoUML_Element_m_createEAnnotation: Method = Method(name="createEAnnotation", parameters={Parameter(name='RefOntoUML_source', type=StringType)}, type=StringType)
RefOntoUML_Element_m_getRelationships: Method = Method(name="getRelationships", parameters={}, type=StringType)
RefOntoUML_Element_m_getRelationships: Method = Method(name="getRelationships", parameters={Parameter(name='RefOntoUML_eClass', type=StringType)}, type=StringType)
...
RefOntoUML_Element_m_getSourceDirectedRelationships: Method = Method(name="getSourceDirectedRelationships", parameters={Parameter(name='RefOntoUML_eClass', type=StringType)}, type=StringType)
...
RefOntoUML_Element_m_getTargetDirectedRelationships: Method = Method(name="getTargetDirectedRelationships", parameters={Parameter(name='RefOntoUML_eClass', type=StringType)}, type=StringType)
RefOntoUML_Element.methods={RefOntoUML_Element_m_mustBeOwned, RefOntoUML_Element_m_removeKeyword, RefOntoUML_Element_m_getSourceDirectedRelationships, RefOntoUML_Element_m_allOwnedElements, RefOntoUML_Element_m_createEAnnotation, RefOntoUML_Element_m_getAppliedStereotype, RefOntoUML_Element_m_getSourceDirectedRelationships, RefOntoUML_Element_m_not_own_self, RefOntoUML_Element_m_getNearestPackage, RefOntoUML_Element_m_getStereotypeApplications, RefOntoUML_Element_m_has_owner, RefOntoUML_Element_m_getTargetDirectedRelationships, RefOntoUML_Element_m_getTargetDirectedRelationships, RefOntoUML_Element_m_getRelationships, RefOntoUML_Element_m_getRelationships, RefOntoUML_Element_m_hasKeyword, RefOntoUML_Element_m_addKeyword, RefOntoUML_Element_m_getApplicableStereotype, RefOntoUML_Element_m_getKeywords, RefOntoUML_Element_m_getRequiredStereotype, RefOntoUML_Element_m_destroy, RefOntoUML_Element_m_getModel}

# EModelElement class attributes and methods

# RefOntoUML_Package class attributes and methods
RefOntoUML_Package_m_createOwnedEnumeration: Method = Method(name="createOwnedEnumeration", parameters={Parameter(name='RefOntoUML_name', type=StringType)}, type=StringType)
RefOntoUML_Package_m_createOwnedPrimitiveType: Method = Method(name="createOwnedPrimitiveType", parameters={Parameter(name='RefOntoUML_name', type=StringType)}, type=StringType)
RefOntoUML_Package_m_createOwnedInterface: Method = Method(name="createOwnedInterface", parameters={Parameter(name='RefOntoUML_name', type=StringType)})
RefOntoUML_Package_m_getAppliedProfile: Method = Method(name="getAppliedProfile", parameters={Parameter(name='RefOntoUML_qualifiedName', type=StringType)})
RefOntoUML_Package_m_elements_public_or_private: Method = Method(name="elements_public_or_private", parameters={Parameter(name='RefOntoUML_context', type=StringType), Parameter(name='RefOntoUML_diagnostics', type=StringType)}, type=BooleanType)
RefOntoUML_Package_m_getAppliedProfile: Method = Method(name="getAppliedProfile", parameters={Parameter(name='RefOntoUML_qualifiedName', type=StringType), Parameter(name='RefOntoUML_recurse', type=StringType)})
RefOntoUML_Package_m_createOwnedClass: Method = Method(name="createOwnedClass", parameters={Parameter(name='RefOntoUML_isAbstract', type=StringType), Parameter(name='RefOntoUML_name', type=StringType)}, type=StringType)
...
RefOntoUML_Package_m_makesVisible: Method = Method(name="makesVisible", parameters={Parameter(name='RefOntoUML_el', type=StringType)}, type=StringType)
RefOntoUML_Package.methods={RefOntoUML_Package_m_makesVisible, RefOntoUML_Package_m_isModelLibrary, RefOntoUML_Package_m_createOwnedEnumeration, RefOntoUML_Package_m_getAppliedProfile, RefOntoUML_Package_m_createOwnedInterface, RefOntoUML_Package_m_createOwnedClass, RefOntoUML_Package_m_createOwnedPrimitiveType, RefOntoUML_Package_m_elements_public_or_private, RefOntoUML_Package_m_visibleMembers, RefOntoUML_Package_m_getAppliedProfile}
...
RefOntoUML_Type_m_createAssociation: Method = Method(name="createAssociation", parameters={Parameter(name='RefOntoUML_end1Upper', type=StringType), Parameter(name='RefOntoUML_end1Name', type=StringType), Parameter(name='RefOntoUML_end2Aggregation', type=StringType), Parameter(name='RefOntoUML_end2Lower', type=StringType), Parameter(name='RefOntoUML_end2Name', type=StringType), Parameter(name='RefOntoUML_end2Upper', type=StringType), Parameter(name='RefOntoUML_end1Aggregation', type=StringType), Parameter(name='RefOntoUML_end1IsNavigable', type=StringType), Parameter(name='RefOntoUML_end2IsNavigable', type=StringType), Parameter(name='RefOntoUML_end1Lower', type=StringType), Parameter(name='RefOntoUML_end1Type', type=StringType)}, type=StringType)
RefOntoUML_Type_m_conformsTo: Method = Method(name="conformsTo", parameters={Parameter(name='RefOntoUML_other', type=StringType)}, type=StringType)
...
RefOntoUML_NamedElement_m_has_qualified_name: Method = Method(name="has_qualified_name", parameters={Parameter(name='RefOntoUML_diagnostics', type=StringType), Parameter(name='RefOntoUML_context', type=StringType)}, type=BooleanType)
RefOntoUML_NamedElement_m_visibility_needs_ownership: Method = Method(name="visibility_needs_ownership", parameters={Parameter(name='RefOntoUML_context', type=StringType), Parameter(name='RefOntoUML_diagnostics', type=StringType)}, type=BooleanType)
RefOntoUML_NamedElement_m_createDependency: Method = Method(name="createDependency", parameters={Parameter(name='RefOntoUML_supplier', type=StringType)}, type=StringType)
RefOntoUML_NamedElement_m_getLabel: Method = Method(name="getLabel", parameters={}, type=StringType)
RefOntoUML_NamedElement_m_getLabel: Method = Method(name="getLabel", parameters={Parameter(name='RefOntoUML_localize', type=StringType)}, type=StringType)
RefOntoUML_NamedElement_m_has_no_qualified_name: Method = Method(name="has_no_qualified_name", parameters={Parameter(name='RefOntoUML_diagnostics', type=StringType), Parameter(name='RefOntoUML_context', type=StringType)}, type=BooleanType)
RefOntoUML_NamedElement_m_isDistinguishableFrom: Method = Method(name="isDistinguishableFrom", parameters={Parameter(name='RefOntoUML_n', type=StringType), Parameter(name='RefOntoUML_ns', type=StringType)}, type=StringType)
...
RefOntoUML_NamedElement_m_createUsage: Method = Method(name="createUsage", parameters={Parameter(name='RefOntoUML_supplier', type=StringType)})
...
RefOntoUML_NamedElement.methods={RefOntoUML_NamedElement_m_getQualifiedName, RefOntoUML_NamedElement_m_allNamespaces, RefOntoUML_NamedElement_m_createUsage, RefOntoUML_NamedElement_m_getLabel, RefOntoUML_NamedElement_m_separator, RefOntoUML_NamedElement_m_isDistinguishableFrom, RefOntoUML_NamedElement_m_allOwningPackages, RefOntoUML_NamedElement_m_visibility_needs_ownership, RefOntoUML_NamedElement_m_getLabel, RefOntoUML_NamedElement_m_has_no_qualified_name, RefOntoUML_NamedElement_m_has_qualified_name, RefOntoUML_NamedElement_m_createDependency}

# RefOntoUML_Dependency class attributes and methods

# RefOntoUML_Namespace class attributes and methods
RefOntoUML_Namespace_m_createElementImport: Method = Method(name="createElementImport", parameters={Parameter(name='RefOntoUML_element', type=StringType), Parameter(name='RefOntoUML_visibility', type=StringType)}, type=StringType)
RefOntoUML_Namespace_m_createPackageImport: Method = Method(name="createPackageImport", parameters={Parameter(name='RefOntoUML_package_', type=StringType), Parameter(name='RefOntoUML_visibility', type=StringType)}, type=StringType)
...
RefOntoUML_Namespace_m_getNamesOfMember: Method = Method(name="getNamesOfMember", parameters={Parameter(name='RefOntoUML_element', type=StringType)}, type=StringType)
RefOntoUML_Namespace_m_members_distinguishable: Method = Method(name="members_distinguishable", parameters={Parameter(name='RefOntoUML_context', type=StringType), Parameter(name='RefOntoUML_diagnostics', type=StringType)}, type=BooleanType)
RefOntoUML_Namespace_m_membersAreDistinguishable: Method = Method(name="membersAreDistinguishable", parameters={}, type=StringType)
RefOntoUML_Namespace_m_importMembers: Method = Method(name="importMembers", parameters={Parameter(name='RefOntoUML_imps', type=StringType)}, type=PackageableElement)
RefOntoUML_Namespace_m_excludeCollisions: Method = Method(name="excludeCollisions", parameters={Parameter(name='RefOntoUML_imps', type=StringType)}, type=PackageableElement)
RefOntoUML_Namespace.methods={RefOntoUML_Namespace_m_createElementImport, RefOntoUML_Namespace_m_membersAreDistinguishable, RefOntoUML_Namespace_m_getImportedPackages, RefOntoUML_Namespace_m_createPackageImport, RefOntoUML_Namespace_m_getImportedMembers, RefOntoUML_Namespace_m_getNamesOfMember, RefOntoUML_Namespace_m_excludeCollisions, RefOntoUML_Namespace_m_members_distinguishable, RefOntoUML_Namespace_m_importMembers, RefOntoUML_Namespace_m_getImportedElements}
...
RefOntoUML_StringExpression_m_operands: Method = Method(name="operands", parameters={Parameter(name='RefOntoUML_diagnostics', type=StringType), Parameter(name='RefOntoUML_context', type=StringType)}, type=BooleanType)
RefOntoUML_StringExpression_m_subexpressions: Method = Method(name="subexpressions", parameters={Parameter(name='RefOntoUML_diagnostics', type=StringType), Parameter(name='RefOntoUML_context', type=StringType)}, type=BooleanType)
...
RefOntoUML_PackageImport_m_public_or_private: Method = Method(name="public_or_private", parameters={Parameter(name='RefOntoUML_diagnostics', type=StringType), Parameter(name='RefOntoUML_context', type=StringType)}, type=BooleanType)
...
RefOntoUML_Constraintx_m_value_specification_boolean: Method = Method(name="value_specification_boolean", parameters={Parameter(name='RefOntoUML_context', type=StringType), Parameter(name='RefOntoUML_diagnostics', type=StringType)}, type=BooleanType)
RefOntoUML_Constraintx_m_boolean_value: Method = Method(name="boolean_value", parameters={Parameter(name='RefOntoUML_context', type=StringType), Parameter(name='RefOntoUML_diagnostics', type=StringType)}, type=BooleanType)
RefOntoUML_Constraintx_m_not_apply_to_self: Method = Method(name="not_apply_to_self", parameters={Parameter(name='RefOntoUML_diagnostics', type=StringType), Parameter(name='RefOntoUML_context', type=StringType)}, type=BooleanType)
RefOntoUML_Constraintx_m_no_side_effects: Method = Method(name="no_side_effects", parameters={Parameter(name='RefOntoUML_diagnostics', type=StringType), Parameter(name='RefOntoUML_context', type=StringType)}, type=BooleanType)
RefOntoUML_Constraintx_m_not_applied_to_self: Method = Method(name="not_applied_to_self", parameters={Parameter(name='RefOntoUML_context', type=StringType), Parameter(name='RefOntoUML_diagnostics', type=StringType)}, type=BooleanType)
RefOntoUML_Constraintx.methods={RefOntoUML_Constraintx_m_no_side_effects, RefOntoUML_Constraintx_m_boolean_value, RefOntoUML_Constraintx_m_value_specification_boolean, RefOntoUML_Constraintx_m_not_apply_to_self, RefOntoUML_Constraintx_m_not_applied_to_self}
...
RefOntoUML_ElementImport_m_visibility_public_or_private: Method = Method(name="visibility_public_or_private", parameters={Parameter(name='RefOntoUML_context', type=StringType), Parameter(name='RefOntoUML_diagnostics', type=StringType)}, type=BooleanType)
RefOntoUML_ElementImport_m_imported_element_is_public: Method = Method(name="imported_element_is_public", parameters={Parameter(name='RefOntoUML_diagnostics', type=StringType), Parameter(name='RefOntoUML_context', type=StringType)}, type=BooleanType)
...
RefOntoUML_ValueSpecification.methods={RefOntoUML_ValueSpecification_m_stringValue, RefOntoUML_ValueSpecification_m_isNull, RefOntoUML_ValueSpecification_m_integerValue, RefOntoUML_ValueSpecification_m_unlimitedValue, RefOntoUML_ValueSpecification_m_isComputable, RefOntoUML_ValueSpecification_m_booleanValue}
...
RefOntoUML_Association_m_specialized_end_types: Method = Method(name="specialized_end_types", parameters={Parameter(name='RefOntoUML_context', type=StringType), Parameter(name='RefOntoUML_diagnostics', type=StringType)}, type=BooleanType)
RefOntoUML_Association_m_binary_associations: Method = Method(name="binary_associations", parameters={Parameter(name='RefOntoUML_diagnostics', type=StringType), Parameter(name='RefOntoUML_context', type=StringType)}, type=BooleanType)
RefOntoUML_Association_m_association_ends: Method = Method(name="association_ends", parameters={Parameter(name='RefOntoUML_diagnostics', type=StringType), Parameter(name='RefOntoUML_context', type=StringType)}, type=BooleanType)
RefOntoUML_Association_m_specialized_end_number: Method = Method(name="specialized_end_number", parameters={Parameter(name='RefOntoUML_diagnostics', type=StringType), Parameter(name='RefOntoUML_context', type=StringType)}, type=BooleanType)
...
RefOntoUML_Association.methods={RefOntoUML_Association_m_specialized_end_types, RefOntoUML_Association_m_isBinary, RefOntoUML_Association_m_getEndTypes, RefOntoUML_Association_m_specialized_end_number, RefOntoUML_Association_m_association_ends, RefOntoUML_Association_m_binary_associations}
...
RefOntoUML_Classifier_m_no_cycles_in_generalization: Method = Method(name="no_cycles_in_generalization", parameters={Parameter(name='RefOntoUML_context', type=StringType), Parameter(name='RefOntoUML_diagnostics', type=StringType)}, type=BooleanType)
RefOntoUML_Classifier_m_generalization_hierarchies: Method = Method(name="generalization_hierarchies", parameters={Parameter(name='RefOntoUML_context', type=StringType), Parameter(name='RefOntoUML_diagnostics', type=StringType)}, type=BooleanType)
...
RefOntoUML_Classifier_m_inheritableMembers: Method = Method(name="inheritableMembers", parameters={Parameter(name='RefOntoUML_c', type=StringType)}, type=NamedElement)
RefOntoUML_Classifier_m_hasVisibilityOf: Method = Method(name="hasVisibilityOf", parameters={Parameter(name='RefOntoUML_n', type=StringType)}, type=StringType)
RefOntoUML_Classifier_m_specialize_type: Method = Method(name="specialize_type", parameters={Parameter(name='RefOntoUML_diagnostics', type=StringType), Parameter(name='RefOntoUML_context', type=StringType)}, type=BooleanType)
RefOntoUML_Classifier_m_maps_to_generalization_set: Method = Method(name="maps_to_generalization_set", parameters={Parameter(name='RefOntoUML_diagnostics', type=StringType), Parameter(name='RefOntoUML_context', type=StringType)}, type=BooleanType)
...
RefOntoUML_Classifier_m_conformsTo: Method = Method(name="conformsTo", parameters={Parameter(name='RefOntoUML_other', type=StringType)}, type=StringType)
RefOntoUML_Classifier_m_inherit: Method = Method(name="inherit", parameters={Parameter(name='RefOntoUML_inhs', type=StringType)}, type=NamedElement)
RefOntoUML_Classifier_m_maySpecializeType: Method = Method(name="maySpecializeType", parameters={Parameter(name='RefOntoUML_c', type=StringType)}, type=StringType)
...
RefOntoUML_Classifier.methods={RefOntoUML_Classifier_m_maySpecializeType, RefOntoUML_Classifier_m_allChildren, RefOntoUML_Classifier_m_children, RefOntoUML_Classifier_m_partitions, RefOntoUML_Classifier_m_getGenerals, RefOntoUML_Classifier_m_generalization_hierarchies, RefOntoUML_Classifier_m_hasCollectiveOffspring, RefOntoUML_Classifier_m_hasQuantityInstances, RefOntoUML_Classifier_m_allParents, RefOntoUML_Classifier_m_hasQuantityAncestor, RefOntoUML_Classifier_m_hasVisibilityOf, RefOntoUML_Classifier_m_getInheritedMembers, RefOntoUML_Classifier_m_parents, RefOntoUML_Classifier_m_getAllAttributes, RefOntoUML_Classifier_m_hasCollectiveInstances, RefOntoUML_Classifier_m_maps_to_generalization_set, RefOntoUML_Classifier_m_specialize_type, RefOntoUML_Classifier_m_hasKindAncestor, RefOntoUML_Classifier_m_hasCollectiveAncestor, RefOntoUML_Classifier_m_inheritableMembers, RefOntoUML_Classifier_m_hasKindOffspring, RefOntoUML_Classifier_m_hasFunctionalComplexInstances, RefOntoUML_Classifier_m_no_cycles_in_generalization, RefOntoUML_Classifier_m_hasQuantityOffspring, RefOntoUML_Classifier_m_inherit, RefOntoUML_Classifier_m_conformsTo, RefOntoUML_Classifier_m_allFeatures}
...
RefOntoUML_Property_m_multiplicity_of_composite: Method = Method(name="multiplicity_of_composite", parameters={Parameter(name='RefOntoUML_diagnostics', type=StringType), Parameter(name='RefOntoUML_context', type=StringType)}, type=BooleanType)
RefOntoUML_Property_m_subsetting_context_conforms: Method = Method(name="subsetting_context_conforms", parameters={Parameter(name='RefOntoUML_context', type=StringType), Parameter(name='RefOntoUML_diagnostics', type=StringType)}, type=BooleanType)
RefOntoUML_Property_m_redefined_property_inherited: Method = Method(name="redefined_property_inherited", parameters={Parameter(name='RefOntoUML_context', type=StringType), Parameter(name='RefOntoUML_diagnostics', type=StringType)}, type=BooleanType)
RefOntoUML_Property_m_subsetting_rules: Method = Method(name="subsetting_rules", parameters={Parameter(name='RefOntoUML_context', type=StringType), Parameter(name='RefOntoUML_diagnostics', type=StringType)}, type=BooleanType)
RefOntoUML_Property_m_navigable_readonly: Method = Method(name="navigable_readonly", parameters={Parameter(name='RefOntoUML_context', type=StringType), Parameter(name='RefOntoUML_diagnostics', type=StringType)}, type=BooleanType)
RefOntoUML_Property_m_unsetDefault: Method = Method(name="unsetDefault", parameters={})
RefOntoUML_Property_m_derived_union_is_derived: Method = Method(name="derived_union_is_derived", parameters={Parameter(name='RefOntoUML_context', type=StringType), Parameter(name='RefOntoUML_diagnostics', type=StringType)}, type=BooleanType)
RefOntoUML_Property_m_derived_union_is_read_only: Method = Method(name="derived_union_is_read_only", parameters={Parameter(name='RefOntoUML_diagnostics', type=StringType), Parameter(name='RefOntoUML_context', type=StringType)}, type=BooleanType)
RefOntoUML_Property_m_subsetted_property_names: Method = Method(name="subsetted_property_names", parameters={Parameter(name='RefOntoUML_context', type=StringType), Parameter(name='RefOntoUML_diagnostics', type=StringType)}, type=BooleanType)
RefOntoUML_Property_m_deployment_target: Method = Method(name="deployment_target", parameters={Parameter(name='RefOntoUML_context', type=StringType), Parameter(name='RefOntoUML_diagnostics', type=StringType)}, type=BooleanType)
RefOntoUML_Property_m_binding_to_attribute: Method = Method(name="binding_to_attribute", parameters={Parameter(name='RefOntoUML_diagnostics', type=StringType), Parameter(name='RefOntoUML_context', type=StringType)}, type=BooleanType)
...
RefOntoUML_Property_m_setDefault: Method = Method(name="setDefault", parameters={Parameter(name='RefOntoUML_newDefault', type=StringType)})
RefOntoUML_Property_m_setIsComposite: Method = Method(name="setIsComposite", parameters={Parameter(name='RefOntoUML_newIsComposite', type=StringType)})
RefOntoUML_Property_m_setOpposite: Method = Method(name="setOpposite", parameters={Parameter(name='RefOntoUML_newOpposite', type=StringType)})
RefOntoUML_Property_m_setIsNavigable: Method = Method(name="setIsNavigable", parameters={Parameter(name='RefOntoUML_isNavigable', type=StringType)})
RefOntoUML_Property_m_getOtherEnd: Method = Method(name="getOtherEnd", parameters={}, type=StringType)
RefOntoUML_Property_m_setBooleanDefaultValue: Method = Method(name="setBooleanDefaultValue", parameters={Parameter(name='RefOntoUML_value', type=StringType)})
RefOntoUML_Property_m_setIntegerDefaultValue: Method = Method(name="setIntegerDefaultValue", parameters={Parameter(name='RefOntoUML_value', type=StringType)})
RefOntoUML_Property_m_setStringDefaultValue: Method = Method(name="setStringDefaultValue", parameters={Parameter(name='RefOntoUML_value', type=StringType)})
RefOntoUML_Property_m_setUnlimitedNaturalDefaultValue: Method = Method(name="setUnlimitedNaturalDefaultValue", parameters={Parameter(name='RefOntoUML_value', type=StringType)})
RefOntoUML_Property_m_setNullDefaultValue: Method = Method(name="setNullDefaultValue", parameters={})
RefOntoUML_Property_m_isAttribute: Method = Method(name="isAttribute", parameters={Parameter(name='RefOntoUML_p', type=StringType)}, type=StringType)
...
RefOntoUML_Property.attributes={RefOntoUML_Property_default, RefOntoUML_Property_isDerivedUnion, RefOntoUML_Property_isComposite, RefOntoUML_Property_aggregation, RefOntoUML_Property_isDerived}
RefOntoUML_Property.methods={RefOntoUML_Property_m_multiplicity_of_composite, RefOntoUML_Property_m_deployment_target, RefOntoUML_Property_m_isNavigable, RefOntoUML_Property_m_setBooleanDefaultValue, RefOntoUML_Property_m_setUnlimitedNaturalDefaultValue, RefOntoUML_Property_m_getOpposite, RefOntoUML_Property_m_getOtherEnd, RefOntoUML_Property_m_subsettingContext, RefOntoUML_Property_m_isSetDefault, RefOntoUML_Property_m_subsetting_rules, RefOntoUML_Property_m_subsetted_property_names, RefOntoUML_Property_m_derived_union_is_derived, RefOntoUML_Property_m_setIntegerDefaultValue, RefOntoUML_Property_m_redefined_property_inherited, RefOntoUML_Property_m_isComposite, RefOntoUML_Property_m_setOpposite, RefOntoUML_Property_m_setStringDefaultValue, RefOntoUML_Property_m_navigable_readonly, RefOntoUML_Property_m_setIsNavigable, RefOntoUML_Property_m_getDefault, RefOntoUML_Property_m_setNullDefaultValue, RefOntoUML_Property_m_derived_union_is_read_only, RefOntoUML_Property_m_setIsComposite, RefOntoUML_Property_m_setDefault, RefOntoUML_Property_m_subsetting_context_conforms, RefOntoUML_Property_m_binding_to_attribute, RefOntoUML_Property_m_unsetDefault, RefOntoUML_Property_m_isAttribute}
...
RefOntoUML_RedefinableElement_m_redefinition_context_valid: Method = Method(name="redefinition_context_valid", parameters={Parameter(name='RefOntoUML_diagnostics', type=StringType), Parameter(name='RefOntoUML_context', type=StringType)}, type=BooleanType)
RefOntoUML_RedefinableElement_m_isRedefinitionContextValid: Method = Method(name="isRedefinitionContextValid", parameters={Parameter(name='RefOntoUML_redefined', type=StringType)}, type=StringType)
RefOntoUML_RedefinableElement_m_redefinition_consistent: Method = Method(name="redefinition_consistent", parameters={Parameter(name='RefOntoUML_context', type=StringType), Parameter(name='RefOntoUML_diagnostics', type=StringType)}, type=BooleanType)
RefOntoUML_RedefinableElement_m_isConsistentWith: Method = Method(name="isConsistentWith", parameters={Parameter(name='RefOntoUML_redefinee', type=StringType)}, type=StringType)
...
RefOntoUML_Generalization_m_generalization_same_classifier: Method = Method(name="generalization_same_classifier", parameters={Parameter(name='RefOntoUML_context', type=StringType), Parameter(name='RefOntoUML_diagnostics', type=StringType)}, type=BooleanType)
...
RefOntoUML_GeneralizationSet_m_generalization_same_classifier: Method = Method(name="generalization_same_classifier", parameters={Parameter(name='RefOntoUML_context', type=StringType), Parameter(name='RefOntoUML_diagnostics', type=StringType)}, type=BooleanType)
RefOntoUML_GeneralizationSet_m_maps_to_generalization_set: Method = Method(name="maps_to_generalization_set", parameters={Parameter(name='RefOntoUML_context', type=StringType), Parameter(name='RefOntoUML_diagnostics', type=StringType)}, type=BooleanType)
...
RefOntoUML_GeneralizationSet.methods={RefOntoUML_GeneralizationSet_m_maps_to_generalization_set, RefOntoUML_GeneralizationSet_m_generalization_same_classifier, RefOntoUML_GeneralizationSet_m_parent, RefOntoUML_GeneralizationSet_m_children}
...
RefOntoUML_OpaqueExpression_m_language_body_size: Method = Method(name="language_body_size", parameters={Parameter(name='RefOntoUML_diagnostics', type=StringType), Parameter(name='RefOntoUML_context', type=StringType)}, type=BooleanType)
RefOntoUML_OpaqueExpression_m_only_return_result_parameters: Method = Method(name="only_return_result_parameters", parameters={Parameter(name='RefOntoUML_diagnostics', type=StringType), Parameter(name='RefOntoUML_context', type=StringType)}, type=BooleanType)
RefOntoUML_OpaqueExpression_m_one_return_result_parameter: Method = Method(name="one_return_result_parameter", parameters={Parameter(name='RefOntoUML_diagnostics', type=StringType), Parameter(name='RefOntoUML_context', type=StringType)}, type=BooleanType)
...
RefOntoUML_OpaqueExpression.methods={RefOntoUML_OpaqueExpression_m_isIntegral, RefOntoUML_OpaqueExpression_m_language_body_size, RefOntoUML_OpaqueExpression_m_only_return_result_parameters, RefOntoUML_OpaqueExpression_m_isNonNegative, RefOntoUML_OpaqueExpression_m_isPositive, RefOntoUML_OpaqueExpression_m_value, RefOntoUML_OpaqueExpression_m_one_return_result_parameter, RefOntoUML_OpaqueExpression_m_getResult}
...
RefOntoUML_MultiplicityElement_m_lower_ge_0: Method = Method(name="lower_ge_0", parameters={Parameter(name='RefOntoUML_diagnostics', type=StringType), Parameter(name='RefOntoUML_context', type=StringType)}, type=BooleanType)
RefOntoUML_MultiplicityElement_m_upper_ge_lower: Method = Method(name="upper_ge_lower", parameters={Parameter(name='RefOntoUML_context', type=StringType), Parameter(name='RefOntoUML_diagnostics', type=StringType)}, type=BooleanType)
RefOntoUML_MultiplicityElement_m_value_specification_no_side_effects: Method = Method(name="value_specification_no_side_effects", parameters={Parameter(name='RefOntoUML_context', type=StringType), Parameter(name='RefOntoUML_diagnostics', type=StringType)}, type=BooleanType)
RefOntoUML_MultiplicityElement_m_value_specification_constant: Method = Method(name="value_specification_constant", parameters={Parameter(name='RefOntoUML_context', type=StringType), Parameter(name='RefOntoUML_diagnostics', type=StringType)}, type=BooleanType)
RefOntoUML_MultiplicityElement_m_setLower: Method = Method(name="setLower", parameters={Parameter(name='RefOntoUML_newLower', type=StringType)})
RefOntoUML_MultiplicityElement_m_setUpper: Method = Method(name="setUpper", parameters={Parameter(name='RefOntoUML_newUpper', type=StringType)})
...
RefOntoUML_MultiplicityElement_m_includesCardinality: Method = Method(name="includesCardinality", parameters={Parameter(name='RefOntoUML_C', type=StringType)}, type=StringType)
RefOntoUML_MultiplicityElement_m_includesMultiplicity: Method = Method(name="includesMultiplicity", parameters={Parameter(name='RefOntoUML_M', type=StringType)}, type=StringType)
...
RefOntoUML_MultiplicityElement_m_compatibleWith: Method = Method(name="compatibleWith", parameters={Parameter(name='RefOntoUML_other', type=StringType)}, type=StringType)
RefOntoUML_MultiplicityElement_m_is: Method = Method(name="is", parameters={Parameter(name='RefOntoUML_lowerbound', type=StringType), Parameter(name='RefOntoUML_upperbound', type=StringType)}, type=StringType)
RefOntoUML_MultiplicityElement.attributes={RefOntoUML_MultiplicityElement_upper, RefOntoUML_MultiplicityElement_isOrdered, RefOntoUML_MultiplicityElement_isUnique, RefOntoUML_MultiplicityElement_lower}
RefOntoUML_MultiplicityElement.methods={RefOntoUML_MultiplicityElement_m_lower_ge_0, RefOntoUML_MultiplicityElement_m_getLower, RefOntoUML_MultiplicityElement_m_getUpper, RefOntoUML_MultiplicityElement_m_is, RefOntoUML_MultiplicityElement_m_compatibleWith, RefOntoUML_MultiplicityElement_m_isMultivalued, RefOntoUML_MultiplicityElement_m_value_specification_constant, RefOntoUML_MultiplicityElement_m_includesMultiplicity, RefOntoUML_MultiplicityElement_m_setLower, RefOntoUML_MultiplicityElement_m_setUpper, RefOntoUML_MultiplicityElement_m_includesCardinality, RefOntoUML_MultiplicityElement_m_lowerBound, RefOntoUML_MultiplicityElement_m_upper_ge_lower, RefOntoUML_MultiplicityElement_m_value_specification_no_side_effects, RefOntoUML_MultiplicityElement_m_upperBound}

# StructuralFeature class attributes and methods

# RefOntoUML_DataType class attributes and methods
RefOntoUML_DataType_m_createOwnedOperation: Method = Method(name="createOwnedOperation", parameters={Parameter(name='RefOntoUML_parameterNames', type=StringType), Parameter(name='RefOntoUML_returnType', type=StringType), Parameter(name='RefOntoUML_name', type=StringType), Parameter(name='RefOntoUML_parameterTypes', type=StringType)})
RefOntoUML_DataType_m_createOwnedAttribute: Method = Method(name="createOwnedAttribute", parameters={Parameter(name='RefOntoUML_upper', type=StringType), Parameter(name='RefOntoUML_name', type=StringType), Parameter(name='RefOntoUML_lower', type=StringType), Parameter(name='RefOntoUML_type', type=StringType)}, type=StringType)
...
RefOntoUML_Class_m_passive_class: Method = Method(name="passive_class", parameters={Parameter(name='RefOntoUML_diagnostics', type=StringType), Parameter(name='RefOntoUML_context', type=StringType)}, type=BooleanType)
RefOntoUML_Class_m_createOwnedOperation: Method = Method(name="createOwnedOperation", parameters={Parameter(name='RefOntoUML_parameterTypes', type=StringType), Parameter(name='RefOntoUML_parameterNames', type=StringType), Parameter(name='RefOntoUML_name', type=StringType), Parameter(name='RefOntoUML_returnType', type=StringType)})
...
RefOntoUML_InstanceSpecification_m_deployment_artifact: Method = Method(name="deployment_artifact", parameters={Parameter(name='RefOntoUML_diagnostics', type=StringType), Parameter(name='RefOntoUML_context', type=StringType)}, type=BooleanType)
RefOntoUML_InstanceSpecification_m_defining_feature: Method = Method(name="defining_feature", parameters={Parameter(name='RefOntoUML_context', type=StringType), Parameter(name='RefOntoUML_diagnostics', type=StringType)}, type=BooleanType)
RefOntoUML_InstanceSpecification_m_structural_feature: Method = Method(name="structural_feature", parameters={Parameter(name='RefOntoUML_context', type=StringType), Parameter(name='RefOntoUML_diagnostics', type=StringType)}, type=BooleanType)
RefOntoUML_InstanceSpecification_m_deployment_target: Method = Method(name="deployment_target", parameters={Parameter(name='RefOntoUML_context', type=StringType), Parameter(name='RefOntoUML_diagnostics', type=StringType)}, type=BooleanType)
RefOntoUML_InstanceSpecification.methods={RefOntoUML_InstanceSpecification_m_deployment_target, RefOntoUML_InstanceSpecification_m_defining_feature, RefOntoUML_InstanceSpecification_m_structural_feature, RefOntoUML_InstanceSpecification_m_deployment_artifact}
...
RefOntoUML_MeasurementDimension.methods={RefOntoUML_MeasurementDimension_m_isNonBoundary, RefOntoUML_MeasurementDimension_m_isOneBoundary, RefOntoUML_MeasurementDimension_m_isCircular}
...
RefOntoUML_RoleMixin.methods={RefOntoUML_RoleMixin_m_rigidSortals, RefOntoUML_RoleMixin_m_mediation, RefOntoUML_RoleMixin_m_relator, RefOntoUML_RoleMixin_m_roles}
...
RefOntoUML_Meronymic.attributes={RefOntoUML_Meronymic_isEssential, RefOntoUML_Meronymic_isShareable, RefOntoUML_Meronymic_isInseparable, RefOntoUML_Meronymic_isImmutableWhole, RefOntoUML_Meronymic_isImmutablePart}
...
RefOntoUML_Derivation.methods={RefOntoUML_Derivation_m_material, RefOntoUML_Derivation_m_relatorEnd, RefOntoUML_Derivation_m_relator, RefOntoUML_Derivation_m_materialEnd}
...
RefOntoUML_Characterization.methods={RefOntoUML_Characterization_m_characterizedEnd, RefOntoUML_Characterization_m_characterizing, RefOntoUML_Characterization_m_characterized, RefOntoUML_Characterization_m_characterizingEnd}
...
RefOntoUML_Mediation.methods={RefOntoUML_Mediation_m_mediated, RefOntoUML_Mediation_m_relator, RefOntoUML_Mediation_m_mediatedEnd, RefOntoUML_Mediation_m_relatorEnd}
...
RefOntoUML_Structuration.methods={RefOntoUML_Structuration_m_structuring, RefOntoUML_Structuration_m_structuringEnd, RefOntoUML_Structuration_m_structured, RefOntoUML_Structuration_m_structuredEnd}
...
class_101: BinaryAssociation = BinaryAssociation(
    name="class_101",
    ends={
...
ownedAttribute124: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="class_", type=RefOntoUML_Property, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
domain_model = DomainModel(
    name="RefOntoUML",
    types={RefOntoUML_Comment, Element, RefOntoUML_Element, EModelElement, RefOntoUML_Package, Namespace, PackageableElement, RefOntoUML_Type, RefOntoUML_PackageMerge, RefOntoUML_PackageableElement, NamedElement, RefOntoUML_NamedElement, RefOntoUML_Dependency, RefOntoUML_Namespace, RefOntoUML_DirectedRelationship, Relationship, RefOntoUML_Relationship, RefOntoUML_StringExpression, DirectedRelationship, RefOntoUML_PackageImport, RefOntoUML_Constraintx, RefOntoUML_ElementImport, TypedElement, RefOntoUML_TypedElement, RefOntoUML_ValueSpecification, RefOntoUML_Association, Classifier, RefOntoUML_Classifier, RedefinableElement, Type, RefOntoUML_Property, RefOntoUML_RedefinableElement, RefOntoUML_Generalization, RefOntoUML_GeneralizationSet, RefOntoUML_Feature, RefOntoUML_OpaqueExpression, ValueSpecification, RefOntoUML_MultiplicityElement, StructuralFeature, RefOntoUML_DataType, RefOntoUML_Class, RefOntoUML_Model, Package, RefOntoUML_StructuralFeature, Feature, MultiplicityElement, Expression, RefOntoUML_Expression, RefOntoUML_InstanceSpecification, RefOntoUML_MeasurementEnumeration, Enumeration_, RefOntoUML_Slot, RefOntoUML_LiteralSpecification, RefOntoUML_Enumeration, DataType, RefOntoUML_EnumerationLiteral, InstanceSpecification, RefOntoUML_MeasurementStructure, RefOntoUML_MeasurementLiteral, EnumerationLiteral, RefOntoUML_MeasurementRegion, RefOntoUML_PrimitiveType, RefOntoUML_ReferenceStructure, RefOntoUML_ReferenceRegion, RefOntoUML_NominalStructure, ReferenceStructure, RefOntoUML_StringNominalStructure, NominalStructure, RefOntoUML_MeasurementDimension, MeasurementStructure, RefOntoUML_DecimalIntervalDimension, RefOntoUML_MeasurementDomain, RefOntoUML_BasicMeasurementRegion, RefOntoUML_OrdinalDimension, MeasurementDimension, RefOntoUML_IntegerOrdinalDimension, OrdinalDimension, RefOntoUML_DecimalOrdinalDimension, RefOntoUML_IntervalDimension, RefOntoUML_IntegerIntervalDimension, IntervalDimension, RefOntoUML_RationalDimension, RefOntoUML_IntegerRationalDimension, RationalDimension, RefOntoUML_DecimalRationalDimension, ReferenceRegion, MeasurementRegion, RefOntoUML_DecimalMeasurementRegion, BasicMeasurementRegion, LiteralDecimal, RefOntoUML_IntegerMeasurementRegion, LiteralInteger, RefOntoUML_ComposedMeasurementRegion, RefOntoUML_NominalRegion, RefOntoUML_StringNominalRegion, NominalRegion, LiteralString, RefOntoUML_LiteralInteger, LiteralSpecification, RefOntoUML_LiteralDecimal, RefOntoUML_LiteralString, RefOntoUML_LiteralBoolean, RefOntoUML_LiteralNull, RefOntoUML_InstanceValue, RefOntoUML_LiteralUnlimitedNatural, RefOntoUML_Quantity, RefOntoUML_ObjectClass, Class_, RefOntoUML_MomentClass, RefOntoUML_SortalClass, ObjectClass, RefOntoUML_MixinClass, RefOntoUML_RigidSortalClass, SortalClass, RefOntoUML_AntiRigidSortalClass, RefOntoUML_SubstanceSortal, RigidSortalClass, RefOntoUML_SubKind, RefOntoUML_Kind, SubstanceSortal, RefOntoUML_Collective, RefOntoUML_Phase, AntiRigidSortalClass, RefOntoUML_Role, RefOntoUML_RigidMixinClass, MixinClass, RefOntoUML_NonRigidMixinClass, RefOntoUML_Category, RigidMixinClass, RefOntoUML_AntiRigidMixinClass, NonRigidMixinClass, RefOntoUML_SemiRigidMixinClass, RefOntoUML_RoleMixin, AntiRigidMixinClass, RefOntoUML_Relator, RefOntoUML_Mixin, SemiRigidMixinClass, RefOntoUML_IntrinsicMomentClass, MomentClass, RefOntoUML_Mode, IntrinsicMomentClass, RefOntoUML_Quality, RefOntoUML_MeasurableQuality, Quality, RefOntoUML_NominalQuality, RefOntoUML_NonPerceivableQuality, MeasurableQuality, RefOntoUML_PerceivableQuality, RefOntoUML_DirectedBinaryAssociation, Association, RefOntoUML_Meronymic, DirectedBinaryAssociation, RefOntoUML_subQuantityOf, Meronymic, RefOntoUML_subCollectionOf, RefOntoUML_Derivation, RefOntoUML_memberOf, RefOntoUML_componentOf, RefOntoUML_DependencyRelationship, RefOntoUML_Characterization, DependencyRelationship, RefOntoUML_Mediation, RefOntoUML_Structuration, RefOntoUML_FormalAssociation, RefOntoUML_MaterialAssociation, AggregationKind, VisibilityKind},
    associations={annotatedElement0, ownedElement2, owner4, ownedComment6, ownedType9, packageMerge10, packagedElement11, nestedPackage13, nestingPackage15, clientDependency17, namespace18, client22, source23, target25, nameExpression19, supplier20, relatedElement28, packageImport31, ownedRule33, member34, importedMember36, ownedMember39, elementImport30, importedElement41, importingNamespace43, importedPackage45, importingNamespace47, context53, constrainedElement49, specification51, type55, package56, navigableOwnedEnd63, ownedEnd58, memberEnd59, endType61, inheritedMember68, redefinedClassifier71, general74, attribute76, generalization65, powertypeExtent66, feature67, redefinedElement80, redefinitionContext81, general84, generalizationSet86, specific88, powertype90, generalization92, featuringClassifier94, upperValue96, lowerValue98, datatype102, class_101, redefinedProperty105, owningAssociation107, defaultValue108, opposite112, subsettedProperty115, association117, nestedClassifier119, superClass122, ownedAttribute124, subExpression129, ownedAttribute126, owningExpression131, operand133, mergedPackage135, receivingPackage137, classifier139, slot141, specification142, definingFeature145, value146, owningInstance149, ownedLiteral150, enumeration151, groundedEnumeration155, groundingStructure152, groundingRegion153, ownedRegions154, domain156, lowerBound157, upperBound158, ownedDimensions161, compositionRule162, structure164, groundedLiteral165, ownedRegions166, instance168},
    generalizations={gen_RefOntoUML_Comment_Element, gen_RefOntoUML_Element_EModelElement, gen_RefOntoUML_Package_Namespace, gen_RefOntoUML_Package_PackageableElement, gen_RefOntoUML_PackageableElement_NamedElement, gen_RefOntoUML_NamedElement_Element, gen_RefOntoUML_DirectedRelationship_Relationship, gen_RefOntoUML_Relationship_Element, gen_RefOntoUML_Dependency_PackageableElement, gen_RefOntoUML_Dependency_DirectedRelationship, gen_RefOntoUML_Namespace_NamedElement, gen_RefOntoUML_ElementImport_DirectedRelationship, gen_RefOntoUML_PackageImport_DirectedRelationship, gen_RefOntoUML_ValueSpecification_PackageableElement, gen_RefOntoUML_ValueSpecification_TypedElement, gen_RefOntoUML_Constraintx_PackageableElement, gen_RefOntoUML_TypedElement_NamedElement, gen_RefOntoUML_Type_PackageableElement, gen_RefOntoUML_Association_Classifier, gen_RefOntoUML_Association_Relationship, gen_RefOntoUML_Classifier_Namespace, gen_RefOntoUML_Classifier_RedefinableElement, gen_RefOntoUML_Classifier_Type, gen_RefOntoUML_RedefinableElement_NamedElement, gen_RefOntoUML_Generalization_DirectedRelationship, gen_RefOntoUML_GeneralizationSet_PackageableElement, gen_RefOntoUML_Feature_RedefinableElement, gen_RefOntoUML_OpaqueExpression_ValueSpecification, gen_RefOntoUML_MultiplicityElement_Element, gen_RefOntoUML_Property_StructuralFeature, gen_RefOntoUML_Class_Classifier, gen_RefOntoUML_Model_Package, gen_RefOntoUML_DataType_Classifier, gen_RefOntoUML_StructuralFeature_Feature, gen_RefOntoUML_StructuralFeature_TypedElement, gen_RefOntoUML_StructuralFeature_MultiplicityElement, gen_RefOntoUML_StringExpression_Expression, gen_RefOntoUML_Expression_ValueSpecification, gen_RefOntoUML_PackageMerge_DirectedRelationship, gen_RefOntoUML_InstanceSpecification_PackageableElement, gen_RefOntoUML_MeasurementEnumeration_Enumeration, gen_RefOntoUML_Slot_Element, gen_RefOntoUML_LiteralSpecification_ValueSpecification, gen_RefOntoUML_Enumeration_DataType, gen_RefOntoUML_EnumerationLiteral_InstanceSpecification, gen_RefOntoUML_MeasurementLiteral_EnumerationLiteral, gen_RefOntoUML_PrimitiveType_DataType, gen_RefOntoUML_ReferenceStructure_DataType, gen_RefOntoUML_NominalStructure_ReferenceStructure, gen_RefOntoUML_StringNominalStructure_NominalStructure, gen_RefOntoUML_MeasurementDimension_MeasurementStructure, gen_RefOntoUML_MeasurementStructure_ReferenceStructure, gen_RefOntoUML_DecimalIntervalDimension_IntervalDimension, gen_RefOntoUML_OrdinalDimension_MeasurementDimension, gen_RefOntoUML_IntegerOrdinalDimension_OrdinalDimension, gen_RefOntoUML_DecimalOrdinalDimension_OrdinalDimension, gen_RefOntoUML_IntervalDimension_MeasurementDimension, gen_RefOntoUML_IntegerIntervalDimension_IntervalDimension, gen_RefOntoUML_RationalDimension_MeasurementDimension, gen_RefOntoUML_IntegerRationalDimension_RationalDimension, gen_RefOntoUML_DecimalRationalDimension_RationalDimension, gen_RefOntoUML_MeasurementDomain_MeasurementStructure, gen_RefOntoUML_ReferenceRegion_ValueSpecification, gen_RefOntoUML_MeasurementRegion_ReferenceRegion, gen_RefOntoUML_BasicMeasurementRegion_MeasurementRegion, gen_RefOntoUML_DecimalMeasurementRegion_BasicMeasurementRegion, gen_RefOntoUML_DecimalMeasurementRegion_LiteralDecimal, gen_RefOntoUML_IntegerMeasurementRegion_BasicMeasurementRegion, gen_RefOntoUML_IntegerMeasurementRegion_LiteralInteger, gen_RefOntoUML_ComposedMeasurementRegion_MeasurementRegion, gen_RefOntoUML_NominalRegion_ReferenceRegion, gen_RefOntoUML_StringNominalRegion_NominalRegion, gen_RefOntoUML_StringNominalRegion_LiteralString, gen_RefOntoUML_LiteralInteger_LiteralSpecification, gen_RefOntoUML_LiteralDecimal_LiteralSpecification, gen_RefOntoUML_LiteralString_LiteralSpecification, gen_RefOntoUML_LiteralBoolean_LiteralSpecification, gen_RefOntoUML_LiteralNull_LiteralSpecification, gen_RefOntoUML_InstanceValue_ValueSpecification, gen_RefOntoUML_LiteralUnlimitedNatural_LiteralSpecification, gen_RefOntoUML_Kind_SubstanceSortal, gen_RefOntoUML_Quantity_SubstanceSortal, gen_RefOntoUML_ObjectClass_Class, gen_RefOntoUML_MomentClass_Class, gen_RefOntoUML_SortalClass_ObjectClass, gen_RefOntoUML_MixinClass_ObjectClass, gen_RefOntoUML_RigidSortalClass_SortalClass, gen_RefOntoUML_AntiRigidSortalClass_SortalClass, gen_RefOntoUML_SubstanceSortal_RigidSortalClass, gen_RefOntoUML_SubKind_RigidSortalClass, gen_RefOntoUML_Collective_SubstanceSortal, gen_RefOntoUML_Phase_AntiRigidSortalClass, gen_RefOntoUML_Role_AntiRigidSortalClass, gen_RefOntoUML_RigidMixinClass_MixinClass, gen_RefOntoUML_NonRigidMixinClass_MixinClass, gen_RefOntoUML_Category_RigidMixinClass, gen_RefOntoUML_AntiRigidMixinClass_NonRigidMixinClass, gen_RefOntoUML_SemiRigidMixinClass_NonRigidMixinClass, gen_RefOntoUML_RoleMixin_AntiRigidMixinClass, gen_RefOntoUML_Relator_MomentClass, gen_RefOntoUML_Mixin_SemiRigidMixinClass, gen_RefOntoUML_IntrinsicMomentClass_MomentClass, gen_RefOntoUML_Mode_IntrinsicMomentClass, gen_RefOntoUML_Quality_IntrinsicMomentClass, gen_RefOntoUML_MeasurableQuality_Quality, gen_RefOntoUML_NominalQuality_Quality, gen_RefOntoUML_NonPerceivableQuality_MeasurableQuality, gen_RefOntoUML_PerceivableQuality_MeasurableQuality, gen_RefOntoUML_DirectedBinaryAssociation_Association, gen_RefOntoUML_Meronymic_DirectedBinaryAssociation, gen_RefOntoUML_subQuantityOf_Meronymic, gen_RefOntoUML_subCollectionOf_Meronymic, gen_RefOntoUML_Derivation_DependencyRelationship, gen_RefOntoUML_memberOf_Meronymic, gen_RefOntoUML_componentOf_Meronymic, gen_RefOntoUML_DependencyRelationship_DirectedBinaryAssociation, gen_RefOntoUML_Characterization_DependencyRelationship, gen_RefOntoUML_Mediation_DependencyRelationship, gen_RefOntoUML_Structuration_DependencyRelationship, gen_RefOntoUML_FormalAssociation_Association, gen_RefOntoUML_MaterialAssociation_Association},
    metadata=None
)
