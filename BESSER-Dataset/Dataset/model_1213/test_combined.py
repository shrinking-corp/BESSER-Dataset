...
def test_hyp_eol_selfinnermostcontenttype_is_not_abstract():
    assert not inspect.isabstract(eol_SelfInnermostContentType)


def test_hyp_eol_selfinnermostcontenttype_constructor_exists():
    assert callable(eol_SelfInnermostContentType.__init__)


def test_hyp_eol_selfinnermostcontenttype_constructor_args():
...
def test_hyp_eol_ipackage_is_not_abstract():
    assert not inspect.isabstract(eol_IPackage)


def test_hyp_eol_ipackage_constructor_exists():
    assert callable(eol_IPackage.__init__)


def test_hyp_eol_ipackage_constructor_args():
...
def test_hyp_eol_imodel_is_not_abstract():
    assert not inspect.isabstract(eol_IModel)


def test_hyp_eol_imodel_constructor_exists():
    assert callable(eol_IModel.__init__)


def test_hyp_eol_imodel_constructor_args():
...
@given(instance=eol_ModelElementType_strategy)
def test_hyp_eol_modelelementtype_modelType_setter(instance):
...
def test_hyp_eol_featurecallexpression_isArrow_setter(instance):
...
def test_hyp_eol_ipackage_nsPrefix_setter(instance):
...
@given(instance=eol_IPackage_strategy)
def test_hyp_eol_ipackage_iPackageDriver_setter(instance):
...
@given(instance=eol_IPackage_strategy)
def test_hyp_eol_ipackage_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_eol_imodel_iMetamodelDriver_setter(instance):
...
def test_eol_FeatureCallExpression_isArrow_value_roundtrip():
    instance = eol_FeatureCallExpression(isArrow=True)
    assert instance.isArrow == True
    instance.isArrow = False
    assert instance.isArrow == False


def test_eol_IModel_iMetamodelDriver_value_roundtrip():
    instance = eol_IModel(iMetamodelDriver="sample_text")
    assert instance.iMetamodelDriver == "sample_text"
    instance.iMetamodelDriver = "sample_text_2"
    assert instance.iMetamodelDriver == "sample_text_2"


def test_eol_IPackage_iPackageDriver_value_roundtrip():
    instance = eol_IPackage(iPackageDriver="sample_text", name="sample_text", nsPrefix="sample_text")
    assert instance.iPackageDriver == "sample_text"
    instance.iPackageDriver = "sample_text_2"
    assert instance.iPackageDriver == "sample_text_2"


def test_eol_IPackage_name_value_roundtrip():
    instance = eol_IPackage(iPackageDriver="sample_text", name="sample_text", nsPrefix="sample_text")
    assert instance.name == "sample_text"
    instance.name = "sample_text_2"
    assert instance.name == "sample_text_2"
...
def test_eol_IPackage_nsPrefix_value_roundtrip():
    instance = eol_IPackage(iPackageDriver="sample_text", name="sample_text", nsPrefix="sample_text")
...
def test_eol_ModelElementType_elementName_value_roundtrip():
    instance = eol_ModelElementType(elementName="sample_text", modelName="sample_text", modelType="sample_text")
...
def test_eol_ModelElementType_modelType_value_roundtrip():
    instance = eol_ModelElementType(elementName="sample_text", modelName="sample_text", modelType="sample_text")
...
def test_eol_IModel_isa_EOLElement():
    instance = eol_IModel(iMetamodelDriver="sample_text")
    assert isinstance(instance, EOLElement)


def test_eol_IPackage_isa_EOLElement():
    instance = eol_IPackage(iPackageDriver="sample_text", name="sample_text", nsPrefix="sample_text")
    assert isinstance(instance, EOLElement)
...
def test_eol_TextPosition_isa_EOLElement():
    instance = eol_TextPosition(column=7, line=7)
    assert isinstance(instance, EOLElement)


def test_eol_TextRegion_isa_EOLElement():
    instance = eol_TextRegion()
    assert isinstance(instance, EOLElement)
...
def test_eol_SelfInnermostContentType_isa_PseudoType():
    instance = eol_SelfInnermostContentType()
    assert isinstance(instance, PseudoType)
...
def test_assoc_alias202_link_reassign_clear():
    a = eol_VariableDeclarationExpression(create=True)
    b1 = eol_ModelDeclarationStatement()
    b2 = eol_ModelDeclarationStatement()
    _safe_set(a, 'eol_VariableDeclarationExpression204', b1)
    assert _is_linked(a, 'eol_VariableDeclarationExpression204', b1)
    if hasattr(b1, 'eol_ModelDeclarationStatement203'):
        assert _is_linked(b1, 'eol_ModelDeclarationStatement203', a)
    _safe_set(a, 'eol_VariableDeclarationExpression204', b2)
    assert _is_linked(a, 'eol_VariableDeclarationExpression204', b2)
    if hasattr(b1, 'eol_ModelDeclarationStatement203'):
        assert not _is_linked(b1, 'eol_ModelDeclarationStatement203', a)
    if hasattr(b2, 'eol_ModelDeclarationStatement203'):
        assert _is_linked(b2, 'eol_ModelDeclarationStatement203', a)
    _safe_set(a, 'eol_VariableDeclarationExpression204', None)
    assert not _is_linked(a, 'eol_VariableDeclarationExpression204', b2)
    if hasattr(b2, 'eol_ModelDeclarationStatement203'):
        assert not _is_linked(b2, 'eol_ModelDeclarationStatement203', a)


def test_assoc_aliases5_link_reassign_clear():
    a = eol_NameExpression(isType=True, name="sample_text", resolvedContent="sample_text")
    b1 = eol_IModel(iMetamodelDriver="sample_text")
    b2 = eol_IModel(iMetamodelDriver="sample_text_2")
    _safe_set(a, 'eol_NameExpression7', b1)
    assert _is_linked(a, 'eol_NameExpression7', b1)
    if hasattr(b1, 'eol_IModel6'):
        assert _is_linked(b1, 'eol_IModel6', a)
    _safe_set(a, 'eol_NameExpression7', b2)
    assert _is_linked(a, 'eol_NameExpression7', b2)
    if hasattr(b1, 'eol_IModel6'):
        assert not _is_linked(b1, 'eol_IModel6', a)
    if hasattr(b2, 'eol_IModel6'):
        assert _is_linked(b2, 'eol_IModel6', a)
    _safe_set(a, 'eol_NameExpression7', None)
    assert not _is_linked(a, 'eol_NameExpression7', b2)
    if hasattr(b2, 'eol_IModel6'):
        assert not _is_linked(b2, 'eol_IModel6', a)
...
def test_assoc_driver199_link_reassign_clear():
    a = eol_NameExpression(isType=True, name="sample_text", resolvedContent="sample_text")
    b1 = eol_ModelDeclarationStatement()
    b2 = eol_ModelDeclarationStatement()
    _safe_set(a, 'eol_NameExpression201', b1)
    assert _is_linked(a, 'eol_NameExpression201', b1)
    if hasattr(b1, 'eol_ModelDeclarationStatement200'):
        assert _is_linked(b1, 'eol_ModelDeclarationStatement200', a)
    _safe_set(a, 'eol_NameExpression201', b2)
    assert _is_linked(a, 'eol_NameExpression201', b2)
    if hasattr(b1, 'eol_ModelDeclarationStatement200'):
        assert not _is_linked(b1, 'eol_ModelDeclarationStatement200', a)
    if hasattr(b2, 'eol_ModelDeclarationStatement200'):
        assert _is_linked(b2, 'eol_ModelDeclarationStatement200', a)
    _safe_set(a, 'eol_NameExpression201', None)
    assert not _is_linked(a, 'eol_NameExpression201', b2)
    if hasattr(b2, 'eol_ModelDeclarationStatement200'):
        assert not _is_linked(b2, 'eol_ModelDeclarationStatement200', a)
...
def test_assoc_driver8_link_reassign_clear():
    ...
    b1 = eol_IModel(iMetamodelDriver="sample_text")
    b2 = eol_IModel(iMetamodelDriver="sample_text_2")
    _safe_set(a, 'eol_NameExpression10', b1)
    assert _is_linked(a, 'eol_NameExpression10', b1)
    if hasattr(b1, 'eol_IModel9'):
        assert _is_linked(b1, 'eol_IModel9', a)
    _safe_set(a, 'eol_NameExpression10', b2)
    assert _is_linked(a, 'eol_NameExpression10', b2)
    if hasattr(b1, 'eol_IModel9'):
        assert not _is_linked(b1, 'eol_IModel9', a)
    if hasattr(b2, 'eol_IModel9'):
        assert _is_linked(b2, 'eol_IModel9', a)
    _safe_set(a, 'eol_NameExpression10', None)
    assert not _is_linked(a, 'eol_NameExpression10', b2)
    if hasattr(b2, 'eol_IModel9'):
        assert not _is_linked(b2, 'eol_IModel9', a)


def test_assoc_dynamicTypes210_link_reassign_clear():
    a = eol_AnyType(declared=True)
    b1 = eol_Type()
    b2 = eol_Type()
    _safe_set(a, 'eol_AnyType', {b1})
    assert _is_linked(a, 'eol_AnyType', b1)
    if hasattr(b1, 'eol_Type211'):
        assert _is_linked(b1, 'eol_Type211', a)
    _safe_set(a, 'eol_AnyType', {b2})
    assert _is_linked(a, 'eol_AnyType', b2)
    if hasattr(b1, 'eol_Type211'):
        assert not _is_linked(b1, 'eol_Type211', a)
    if hasattr(b2, 'eol_Type211'):
        assert _is_linked(b2, 'eol_Type211', a)
    _safe_set(a, 'eol_AnyType', set())
    assert not _is_linked(a, 'eol_AnyType', b2)
    if hasattr(b2, 'eol_Type211'):
        assert not _is_linked(b2, 'eol_Type211', a)


def test_assoc_end20_link_reassign_clear():
    a = eol_TextPosition(column=7, line=7)
    b1 = eol_TextRegion()
    b2 = eol_TextRegion()
    _safe_set(a, 'eol_TextPosition22', b1)
    assert _is_linked(a, 'eol_TextPosition22', b1)
    if hasattr(b1, 'eol_TextRegion21'):
        assert _is_linked(b1, 'eol_TextRegion21', a)
    _safe_set(a, 'eol_TextPosition22', b2)
    assert _is_linked(a, 'eol_TextPosition22', b2)
    if hasattr(b1, 'eol_TextRegion21'):
        assert not _is_linked(b1, 'eol_TextRegion21', a)
    if hasattr(b2, 'eol_TextRegion21'):
        assert _is_linked(b2, 'eol_TextRegion21', a)
    _safe_set(a, 'eol_TextPosition22', None)
    assert not _is_linked(a, 'eol_TextPosition22', b2)
    if hasattr(b2, 'eol_TextRegion21'):
        assert not _is_linked(b2, 'eol_TextRegion21', a)


def test_assoc_enumeration124_link_reassign_clear():
    a = eol_NameExpression(isType=True, name="sample_text", resolvedContent="sample_text")
    b1 = eol_EnumerationLiteralExpression()
    b2 = eol_EnumerationLiteralExpression()
    _safe_set(a, 'eol_NameExpression126', b1)
    assert _is_linked(a, 'eol_NameExpression126', b1)
    if hasattr(b1, 'eol_EnumerationLiteralExpression125'):
        assert _is_linked(b1, 'eol_EnumerationLiteralExpression125', a)
    _safe_set(a, 'eol_NameExpression126', b2)
    assert _is_linked(a, 'eol_NameExpression126', b2)
    if hasattr(b1, 'eol_EnumerationLiteralExpression125'):
        assert not _is_linked(b1, 'eol_EnumerationLiteralExpression125', a)
    if hasattr(b2, 'eol_EnumerationLiteralExpression125'):
        assert _is_linked(b2, 'eol_EnumerationLiteralExpression125', a)
    _safe_set(a, 'eol_NameExpression126', None)
    assert not _is_linked(a, 'eol_NameExpression126', b2)
    if hasattr(b2, 'eol_EnumerationLiteralExpression125'):
        assert not _is_linked(b2, 'eol_EnumerationLiteralExpression125', a)


def test_assoc_expression227_link_reassign_clear():
    a = eol_StringExpression(value="sample_text")
    b1 = eol_NativeType()
    b2 = eol_NativeType()
    _safe_set(a, 'eol_StringExpression228', b1)
    assert _is_linked(a, 'eol_StringExpression228', b1)
    if hasattr(b1, 'eol_NativeType'):
        assert _is_linked(b1, 'eol_NativeType', a)
    _safe_set(a, 'eol_StringExpression228', b2)
    assert _is_linked(a, 'eol_StringExpression228', b2)
    if hasattr(b1, 'eol_NativeType'):
        assert not _is_linked(b1, 'eol_NativeType', a)
    if hasattr(b2, 'eol_NativeType'):
        assert _is_linked(b2, 'eol_NativeType', a)
    _safe_set(a, 'eol_StringExpression228', None)
    assert not _is_linked(a, 'eol_StringExpression228', b2)
    if hasattr(b2, 'eol_NativeType'):
        assert not _is_linked(b2, 'eol_NativeType', a)


def test_assoc_iModel127_link_reassign_clear():
    a = eol_IModel(iMetamodelDriver="sample_text")
    b1 = eol_EnumerationLiteralExpression()
    b2 = eol_EnumerationLiteralExpression()
    _safe_set(a, 'eol_IModel129', b1)
    assert _is_linked(a, 'eol_IModel129', b1)
    if hasattr(b1, 'eol_EnumerationLiteralExpression128'):
        assert _is_linked(b1, 'eol_EnumerationLiteralExpression128', a)
    _safe_set(a, 'eol_IModel129', b2)
    assert _is_linked(a, 'eol_IModel129', b2)
    if hasattr(b1, 'eol_EnumerationLiteralExpression128'):
        assert not _is_linked(b1, 'eol_EnumerationLiteralExpression128', a)
    if hasattr(b2, 'eol_EnumerationLiteralExpression128'):
        assert _is_linked(b2, 'eol_EnumerationLiteralExpression128', a)
    _safe_set(a, 'eol_IModel129', None)
    assert not _is_linked(a, 'eol_IModel129', b2)
    if hasattr(b2, 'eol_EnumerationLiteralExpression128'):
        assert not _is_linked(b2, 'eol_EnumerationLiteralExpression128', a)


def test_assoc_iModels24_link_reassign_clear():
    a = eol_IModel(iMetamodelDriver="sample_text")
    b1 = eol_EOLLibraryModule(name="sample_text")
    b2 = eol_EOLLibraryModule(name="sample_text_2")
    _safe_set(a, 'eol_IModel26', b1)
    assert _is_linked(a, 'eol_IModel26', b1)
    if hasattr(b1, 'eol_EOLLibraryModule25'):
        assert _is_linked(b1, 'eol_EOLLibraryModule25', a)
    _safe_set(a, 'eol_IModel26', b2)
    assert _is_linked(a, 'eol_IModel26', b2)
    if hasattr(b1, 'eol_EOLLibraryModule25'):
        assert not _is_linked(b1, 'eol_EOLLibraryModule25', a)
    if hasattr(b2, 'eol_EOLLibraryModule25'):
        assert _is_linked(b2, 'eol_EOLLibraryModule25', a)
    _safe_set(a, 'eol_IModel26', None)
    assert not _is_linked(a, 'eol_IModel26', b2)
    if hasattr(b2, 'eol_EOLLibraryModule25'):
        assert not _is_linked(b2, 'eol_EOLLibraryModule25', a)


def test_assoc_iPackages11_link_reassign_clear():
    a = eol_IPackage(iPackageDriver="sample_text", name="sample_text", nsPrefix="sample_text")
    b1 = eol_IModel(iMetamodelDriver="sample_text")
    b2 = eol_IModel(iMetamodelDriver="sample_text_2")
    _safe_set(a, 'eol_IPackage', b1)
    assert _is_linked(a, 'eol_IPackage', b1)
    if hasattr(b1, 'eol_IModel12'):
        assert _is_linked(b1, 'eol_IModel12', a)
    _safe_set(a, 'eol_IPackage', b2)
    assert _is_linked(a, 'eol_IPackage', b2)
    if hasattr(b1, 'eol_IModel12'):
        assert not _is_linked(b1, 'eol_IModel12', a)
    if hasattr(b2, 'eol_IModel12'):
        assert _is_linked(b2, 'eol_IModel12', a)
    _safe_set(a, 'eol_IPackage', None)
    assert not _is_linked(a, 'eol_IPackage', b2)
    if hasattr(b2, 'eol_IModel12'):
        assert not _is_linked(b2, 'eol_IModel12', a)


def test_assoc_imodel205_link_reassign_clear():
    a = eol_IModel(iMetamodelDriver="sample_text")
    b1 = eol_ModelDeclarationStatement()
    b2 = eol_ModelDeclarationStatement()
    _safe_set(a, 'eol_IModel207', b1)
    assert _is_linked(a, 'eol_IModel207', b1)
    if hasattr(b1, 'eol_ModelDeclarationStatement206'):
        assert _is_linked(b1, 'eol_ModelDeclarationStatement206', a)
    _safe_set(a, 'eol_IModel207', b2)
    assert _is_linked(a, 'eol_IModel207', b2)
    if hasattr(b1, 'eol_ModelDeclarationStatement206'):
        assert not _is_linked(b1, 'eol_ModelDeclarationStatement206', a)
    if hasattr(b2, 'eol_ModelDeclarationStatement206'):
        assert _is_linked(b2, 'eol_ModelDeclarationStatement206', a)
    _safe_set(a, 'eol_IModel207', None)
    assert not _is_linked(a, 'eol_IModel207', b2)
    if hasattr(b2, 'eol_ModelDeclarationStatement206'):
        assert not _is_linked(b2, 'eol_ModelDeclarationStatement206', a)


def test_assoc_importedModule32_link_reassign_clear():
    a = eol_Import(imported="sample_text")
    b1 = eol_EOLLibraryModule(name="sample_text")
    b2 = eol_EOLLibraryModule(name="sample_text_2")
    _safe_set(a, 'eol_Import33', b1)
    assert _is_linked(a, 'eol_Import33', b1)
    if hasattr(b1, 'eol_EOLLibraryModule34'):
        assert _is_linked(b1, 'eol_EOLLibraryModule34', a)
    _safe_set(a, 'eol_Import33', b2)
    assert _is_linked(a, 'eol_Import33', b2)
    if hasattr(b1, 'eol_EOLLibraryModule34'):
        assert not _is_linked(b1, 'eol_EOLLibraryModule34', a)
    if hasattr(b2, 'eol_EOLLibraryModule34'):
        assert _is_linked(b2, 'eol_EOLLibraryModule34', a)
    _safe_set(a, 'eol_Import33', None)
    assert not _is_linked(a, 'eol_Import33', b2)
    if hasattr(b2, 'eol_EOLLibraryModule34'):
        assert not _is_linked(b2, 'eol_EOLLibraryModule34', a)


def test_assoc_imports23_link_reassign_clear():
    a = eol_Import(imported="sample_text")
    b1 = eol_EOLLibraryModule(name="sample_text")
    b2 = eol_EOLLibraryModule(name="sample_text_2")
...
def test_assoc_keyType222_link_reassign_clear():
    a = eol_AnyType(declared=True)
    b1 = eol_MapType()
    b2 = eol_MapType()
    _safe_set(a, 'eol_AnyType223', b1)
    assert _is_linked(a, 'eol_AnyType223', b1)
    if hasattr(b1, 'eol_MapType'):
        assert _is_linked(b1, 'eol_MapType', a)
    _safe_set(a, 'eol_AnyType223', b2)
    assert _is_linked(a, 'eol_AnyType223', b2)
    if hasattr(b1, 'eol_MapType'):
        assert not _is_linked(b1, 'eol_MapType', a)
    if hasattr(b2, 'eol_MapType'):
        assert _is_linked(b2, 'eol_MapType', a)
    _safe_set(a, 'eol_AnyType223', None)
    assert not _is_linked(a, 'eol_AnyType223', b2)
    if hasattr(b2, 'eol_MapType'):
        assert not _is_linked(b2, 'eol_MapType', a)


def test_assoc_literal122_link_reassign_clear():
    a = eol_NameExpression(isType=True, name="sample_text", resolvedContent="sample_text")
    b1 = eol_EnumerationLiteralExpression()
    b2 = eol_EnumerationLiteralExpression()
    _safe_set(a, 'eol_NameExpression123', b1)
    assert _is_linked(a, 'eol_NameExpression123', b1)
    if hasattr(b1, 'eol_EnumerationLiteralExpression'):
        assert _is_linked(b1, 'eol_EnumerationLiteralExpression', a)
    _safe_set(a, 'eol_NameExpression123', b2)
    assert _is_linked(a, 'eol_NameExpression123', b2)
    if hasattr(b1, 'eol_EnumerationLiteralExpression'):
    ...
    _safe_set(a, 'eol_NameExpression123', None)
    assert not _is_linked(a, 'eol_NameExpression123', b2)
    if hasattr(b2, 'eol_EnumerationLiteralExpression'):
        assert not _is_linked(b2, 'eol_EnumerationLiteralExpression', a)


def test_assoc_method100_link_reassign_clear():
    a = eol_NameExpression(isType=True, name="sample_text", resolvedContent="sample_text")
    ...
    if hasattr(b1, 'eol_FOLMethodCallExpression101'):
        assert _is_linked(b1, 'eol_FOLMethodCallExpression101', a)
    _safe_set(a, 'eol_NameExpression102', b2)
    assert _is_linked(a, 'eol_NameExpression102', b2)
    if hasattr(b1, 'eol_FOLMethodCallExpression101'):
        assert not _is_linked(b1, 'eol_FOLMethodCallExpression101', a)
    if hasattr(b2, 'eol_FOLMethodCallExpression101'):
        assert _is_linked(b2, 'eol_FOLMethodCallExpression101', a)
    _safe_set(a, 'eol_NameExpression102', None)
    assert not _is_linked(a, 'eol_NameExpression102', b2)
    if hasattr(b2, 'eol_FOLMethodCallExpression101'):
        assert not _is_linked(b2, 'eol_FOLMethodCallExpression101', a)


def test_assoc_method87_link_reassign_clear():
    a = eol_NameExpression(isType=True, name="sample_text", resolvedContent="sample_text")
    b1 = eol_MethodCallExpression()
    b2 = eol_MethodCallExpression()
    _safe_set(a, 'eol_NameExpression89', b1)
    assert _is_linked(a, 'eol_NameExpression89', b1)
    if hasattr(b1, 'eol_MethodCallExpression88'):
        assert _is_linked(b1, 'eol_MethodCallExpression88', a)
    _safe_set(a, 'eol_NameExpression89', b2)
    assert _is_linked(a, 'eol_NameExpression89', b2)
    if hasattr(b1, 'eol_MethodCallExpression88'):
        assert not _is_linked(b1, 'eol_MethodCallExpression88', a)
    if hasattr(b2, 'eol_MethodCallExpression88'):
        assert _is_linked(b2, 'eol_MethodCallExpression88', a)
    _safe_set(a, 'eol_NameExpression89', None)
    assert not _is_linked(a, 'eol_NameExpression89', b2)
    if hasattr(b2, 'eol_MethodCallExpression88'):
        assert not _is_linked(b2, 'eol_MethodCallExpression88', a)


def test_assoc_model130_link_reassign_clear():
    a = eol_NameExpression(isType=True, name="sample_text", resolvedContent="sample_text")
    b1 = eol_EnumerationLiteralExpression()
    b2 = eol_EnumerationLiteralExpression()
    _safe_set(a, 'eol_NameExpression132', b1)
    assert _is_linked(a, 'eol_NameExpression132', b1)
    if hasattr(b1, 'eol_EnumerationLiteralExpression131'):
        assert _is_linked(b1, 'eol_EnumerationLiteralExpression131', a)
    _safe_set(a, 'eol_NameExpression132', b2)
    assert _is_linked(a, 'eol_NameExpression132', b2)
    if hasattr(b1, 'eol_EnumerationLiteralExpression131'):
        assert not _is_linked(b1, 'eol_EnumerationLiteralExpression131', a)
    if hasattr(b2, 'eol_EnumerationLiteralExpression131'):
        assert _is_linked(b2, 'eol_EnumerationLiteralExpression131', a)
    _safe_set(a, 'eol_NameExpression132', None)
    assert not _is_linked(a, 'eol_NameExpression132', b2)
    if hasattr(b2, 'eol_EnumerationLiteralExpression131'):
        assert not _is_linked(b2, 'eol_EnumerationLiteralExpression131', a)


def test_assoc_modelDeclarations27_link_reassign_clear():
    a = eol_EOLLibraryModule(name="sample_text")
    b1 = eol_ModelDeclarationStatement()
    b2 = eol_ModelDeclarationStatement()
    _safe_set(a, 'eol_EOLLibraryModule28', {b1})
    assert _is_linked(a, 'eol_EOLLibraryModule28', b1)
    if hasattr(b1, 'eol_ModelDeclarationStatement'):
        assert _is_linked(b1, 'eol_ModelDeclarationStatement', a)
    _safe_set(a, 'eol_EOLLibraryModule28', {b2})
    assert _is_linked(a, 'eol_EOLLibraryModule28', b2)
    if hasattr(b1, 'eol_ModelDeclarationStatement'):
        assert not _is_linked(b1, 'eol_ModelDeclarationStatement', a)
    if hasattr(b2, 'eol_ModelDeclarationStatement'):
        assert _is_linked(b2, 'eol_ModelDeclarationStatement', a)
    _safe_set(a, 'eol_EOLLibraryModule28', set())
    assert not _is_linked(a, 'eol_EOLLibraryModule28', b2)
    if hasattr(b2, 'eol_ModelDeclarationStatement'):
        assert not _is_linked(b2, 'eol_ModelDeclarationStatement', a)


def test_assoc_name190_link_reassign_clear():
    a = eol_NameExpression(isType=True, name="sample_text", resolvedContent="sample_text")
    b1 = eol_AnnotationStatement()
    b2 = eol_AnnotationStatement()
    _safe_set(a, 'eol_NameExpression191', b1)
    assert _is_linked(a, 'eol_NameExpression191', b1)
    if hasattr(b1, 'eol_AnnotationStatement'):
        assert _is_linked(b1, 'eol_AnnotationStatement', a)
    _safe_set(a, 'eol_NameExpression191', b2)
    assert _is_linked(a, 'eol_NameExpression191', b2)
    if hasattr(b1, 'eol_AnnotationStatement'):
    ...
    _safe_set(a, 'eol_NameExpression191', None)
    assert not _is_linked(a, 'eol_NameExpression191', b2)
    if hasattr(b2, 'eol_AnnotationStatement'):
        assert not _is_linked(b2, 'eol_AnnotationStatement', a)


def test_assoc_name196_link_reassign_clear():
    a = eol_VariableDeclarationExpression(create=True)
    b1 = eol_ModelDeclarationStatement()
    b2 = eol_ModelDeclarationStatement()
    _safe_set(a, 'eol_VariableDeclarationExpression198', b1)
    assert _is_linked(a, 'eol_VariableDeclarationExpression198', b1)
    if hasattr(b1, 'eol_ModelDeclarationStatement197'):
        assert _is_linked(b1, 'eol_ModelDeclarationStatement197', a)
    _safe_set(a, 'eol_VariableDeclarationExpression198', b2)
    assert _is_linked(a, 'eol_VariableDeclarationExpression198', b2)
    if hasattr(b1, 'eol_ModelDeclarationStatement197'):
        assert not _is_linked(b1, 'eol_ModelDeclarationStatement197', a)
    if hasattr(b2, 'eol_ModelDeclarationStatement197'):
        assert _is_linked(b2, 'eol_ModelDeclarationStatement197', a)
    _safe_set(a, 'eol_VariableDeclarationExpression198', None)
    assert not _is_linked(a, 'eol_VariableDeclarationExpression198', b2)
    if hasattr(b2, 'eol_ModelDeclarationStatement197'):
        assert not _is_linked(b2, 'eol_ModelDeclarationStatement197', a)
...
def test_assoc_name4_link_reassign_clear():
    ...
    if hasattr(b1, 'eol_IModel'):
        assert _is_linked(b1, 'eol_IModel', a)
    _safe_set(a, 'eol_NameExpression', b2)
    assert _is_linked(a, 'eol_NameExpression', b2)
    if hasattr(b1, 'eol_IModel'):
        assert not _is_linked(b1, 'eol_IModel', a)
    if hasattr(b2, 'eol_IModel'):
        assert _is_linked(b2, 'eol_IModel', a)
    _safe_set(a, 'eol_NameExpression', None)
    assert not _is_linked(a, 'eol_NameExpression', b2)
    if hasattr(b2, 'eol_IModel'):
        assert not _is_linked(b2, 'eol_IModel', a)
...
def test_assoc_name51_link_reassign_clear():
    ...
    if hasattr(b1, 'eol_OperationDefinition52'):
        assert _is_linked(b1, 'eol_OperationDefinition52', a)
    _safe_set(a, 'eol_NameExpression53', b2)
    assert _is_linked(a, 'eol_NameExpression53', b2)
    if hasattr(b1, 'eol_OperationDefinition52'):
        assert not _is_linked(b1, 'eol_OperationDefinition52', a)
    if hasattr(b2, 'eol_OperationDefinition52'):
        assert _is_linked(b2, 'eol_OperationDefinition52', a)
    _safe_set(a, 'eol_NameExpression53', None)
    assert not _is_linked(a, 'eol_NameExpression53', b2)
    if hasattr(b2, 'eol_OperationDefinition52'):
        assert not _is_linked(b2, 'eol_OperationDefinition52', a)


def test_assoc_name74_link_reassign_clear():
    a = eol_VariableDeclarationExpression(create=True)
    ...
    _safe_set(a, 'eol_VariableDeclarationExpression75', b1)
    assert _is_linked(a, 'eol_VariableDeclarationExpression75', b1)
    if hasattr(b1, 'eol_NameExpression76'):
        assert _is_linked(b1, 'eol_NameExpression76', a)
    _safe_set(a, 'eol_VariableDeclarationExpression75', b2)
    assert _is_linked(a, 'eol_VariableDeclarationExpression75', b2)
    if hasattr(b1, 'eol_NameExpression76'):
    ...
    _safe_set(a, 'eol_VariableDeclarationExpression75', None)
    assert not _is_linked(a, 'eol_VariableDeclarationExpression75', b2)
    if hasattr(b2, 'eol_NameExpression76'):
        assert not _is_linked(b2, 'eol_NameExpression76', a)


def test_assoc_names140_link_reassign_clear():
    a = eol_NameExpression(isType=True, name="sample_text", resolvedContent="sample_text")
    b1 = eol_TransactionStatement()
    b2 = eol_TransactionStatement()
    _safe_set(a, 'eol_NameExpression141', b1)
    assert _is_linked(a, 'eol_NameExpression141', b1)
    if hasattr(b1, 'eol_TransactionStatement'):
        assert _is_linked(b1, 'eol_TransactionStatement', a)
    _safe_set(a, 'eol_NameExpression141', b2)
    assert _is_linked(a, 'eol_NameExpression141', b2)
    if hasattr(b1, 'eol_TransactionStatement'):
    ...
    _safe_set(a, 'eol_NameExpression141', None)
    assert not _is_linked(a, 'eol_NameExpression141', b2)
    if hasattr(b2, 'eol_TransactionStatement'):
        assert not _is_linked(b2, 'eol_TransactionStatement', a)


def test_assoc_nsURI13_link_reassign_clear():
    a = eol_StringExpression(value="sample_text")
    b1 = eol_IPackage(iPackageDriver="sample_text", name="sample_text", nsPrefix="sample_text")
    b2 = eol_IPackage(iPackageDriver="sample_text_2", name="sample_text_2", nsPrefix="sample_text_2")
    _safe_set(a, 'eol_StringExpression', b1)
    assert _is_linked(a, 'eol_StringExpression', b1)
    if hasattr(b1, 'eol_IPackage14'):
        assert _is_linked(b1, 'eol_IPackage14', a)
    _safe_set(a, 'eol_StringExpression', b2)
    assert _is_linked(a, 'eol_StringExpression', b2)
    if hasattr(b1, 'eol_IPackage14'):
        assert not _is_linked(b1, 'eol_IPackage14', a)
    if hasattr(b2, 'eol_IPackage14'):
        assert _is_linked(b2, 'eol_IPackage14', a)
    _safe_set(a, 'eol_StringExpression', None)
    assert not _is_linked(a, 'eol_StringExpression', b2)
    if hasattr(b2, 'eol_IPackage14'):
        assert not _is_linked(b2, 'eol_IPackage14', a)


def test_assoc_operations29_link_reassign_clear():
    a = eol_EOLLibraryModule(name="sample_text")
    b1 = eol_OperationDefinition()
    b2 = eol_OperationDefinition()
    _safe_set(a, 'eol_EOLLibraryModule30', {b1})
    assert _is_linked(a, 'eol_EOLLibraryModule30', b1)
    if hasattr(b1, 'eol_OperationDefinition'):
        assert _is_linked(b1, 'eol_OperationDefinition', a)
    _safe_set(a, 'eol_EOLLibraryModule30', {b2})
    assert _is_linked(a, 'eol_EOLLibraryModule30', b2)
    if hasattr(b1, 'eol_OperationDefinition'):
    ...
    _safe_set(a, 'eol_EOLLibraryModule30', set())
    assert not _is_linked(a, 'eol_EOLLibraryModule30', b2)
    if hasattr(b2, 'eol_OperationDefinition'):
...
def test_assoc_parameters77_link_reassign_clear():
    ...
    b1 = eol_Expression()
    b2 = eol_Expression()
    _safe_set(a, 'eol_VariableDeclarationExpression78', {b1})
    assert _is_linked(a, 'eol_VariableDeclarationExpression78', b1)
    if hasattr(b1, 'eol_Expression79'):
        assert _is_linked(b1, 'eol_Expression79', a)
    _safe_set(a, 'eol_VariableDeclarationExpression78', {b2})
    assert _is_linked(a, 'eol_VariableDeclarationExpression78', b2)
    if hasattr(b1, 'eol_Expression79'):
        assert not _is_linked(b1, 'eol_Expression79', a)
    if hasattr(b2, 'eol_Expression79'):
        assert _is_linked(b2, 'eol_Expression79', a)
    _safe_set(a, 'eol_VariableDeclarationExpression78', set())
    assert not _is_linked(a, 'eol_VariableDeclarationExpression78', b2)
    if hasattr(b2, 'eol_Expression79'):
        assert not _is_linked(b2, 'eol_Expression79', a)


def test_assoc_property93_link_reassign_clear():
    ...
    if hasattr(b1, 'eol_NameExpression94'):
        assert _is_linked(b1, 'eol_NameExpression94', a)
    _safe_set(a, 'eol_PropertyCallExpression', b2)
    assert _is_linked(a, 'eol_PropertyCallExpression', b2)
    if hasattr(b1, 'eol_NameExpression94'):
        assert not _is_linked(b1, 'eol_NameExpression94', a)
    if hasattr(b2, 'eol_NameExpression94'):
        assert _is_linked(b2, 'eol_NameExpression94', a)
    _safe_set(a, 'eol_PropertyCallExpression', None)
    assert not _is_linked(a, 'eol_PropertyCallExpression', b2)
    if hasattr(b2, 'eol_NameExpression94'):
        assert not _is_linked(b2, 'eol_NameExpression94', a)


def test_assoc_references80_link_reassign_clear():
    a = eol_VariableDeclarationExpression(create=True)
    b1 = eol_NameExpression(isType=True, name="sample_text", resolvedContent="sample_text")
    b2 = eol_NameExpression(isType=False, name="sample_text_2", resolvedContent="sample_text_2")
    _safe_set(a, 'eol_VariableDeclarationExpression81', {b1})
    assert _is_linked(a, 'eol_VariableDeclarationExpression81', b1)
    if hasattr(b1, 'eol_NameExpression82'):
        assert _is_linked(b1, 'eol_NameExpression82', a)
    _safe_set(a, 'eol_VariableDeclarationExpression81', {b2})
    assert _is_linked(a, 'eol_VariableDeclarationExpression81', b2)
    if hasattr(b1, 'eol_NameExpression82'):
        assert not _is_linked(b1, 'eol_NameExpression82', a)
    if hasattr(b2, 'eol_NameExpression82'):
        assert _is_linked(b2, 'eol_NameExpression82', a)
    _safe_set(a, 'eol_VariableDeclarationExpression81', set())
    assert not _is_linked(a, 'eol_VariableDeclarationExpression81', b2)
    if hasattr(b2, 'eol_NameExpression82'):
        assert not _is_linked(b2, 'eol_NameExpression82', a)
...
def test_assoc_resolvedIModel212_link_reassign_clear():
    a = eol_IModel(iMetamodelDriver="sample_text")
    b1 = eol_ModelType()
    b2 = eol_ModelType()
    _safe_set(a, 'eol_IModel213', b1)
    assert _is_linked(a, 'eol_IModel213', b1)
    if hasattr(b1, 'eol_ModelType'):
        assert _is_linked(b1, 'eol_ModelType', a)
    _safe_set(a, 'eol_IModel213', b2)
    assert _is_linked(a, 'eol_IModel213', b2)
    if hasattr(b1, 'eol_ModelType'):
        assert not _is_linked(b1, 'eol_ModelType', a)
    if hasattr(b2, 'eol_ModelType'):
        assert _is_linked(b2, 'eol_ModelType', a)
    _safe_set(a, 'eol_IModel213', None)
    assert not _is_linked(a, 'eol_IModel213', b2)
    if hasattr(b2, 'eol_ModelType'):
        assert not _is_linked(b2, 'eol_ModelType', a)


def test_assoc_resolvedIModel214_link_reassign_clear():
    a = eol_ModelElementType(elementName="sample_text", modelName="sample_text", modelType="sample_text")
    b1 = eol_IModel(iMetamodelDriver="sample_text")
    b2 = eol_IModel(iMetamodelDriver="sample_text_2")
    _safe_set(a, 'eol_ModelElementType', b1)
    assert _is_linked(a, 'eol_ModelElementType', b1)
    if hasattr(b1, 'eol_IModel215'):
        assert _is_linked(b1, 'eol_IModel215', a)
    _safe_set(a, 'eol_ModelElementType', b2)
    assert _is_linked(a, 'eol_ModelElementType', b2)
    if hasattr(b1, 'eol_IModel215'):
        assert not _is_linked(b1, 'eol_IModel215', a)
    if hasattr(b2, 'eol_IModel215'):
        assert _is_linked(b2, 'eol_IModel215', a)
    _safe_set(a, 'eol_ModelElementType', None)
    assert not _is_linked(a, 'eol_ModelElementType', b2)
    if hasattr(b2, 'eol_IModel215'):
        assert not _is_linked(b2, 'eol_IModel215', a)


def test_assoc_resolvedIPackage219_link_reassign_clear():
    a = eol_ModelElementType(elementName="sample_text", modelName="sample_text", modelType="sample_text")
    b1 = eol_IPackage(iPackageDriver="sample_text", name="sample_text", nsPrefix="sample_text")
    b2 = eol_IPackage(iPackageDriver="sample_text_2", name="sample_text_2", nsPrefix="sample_text_2")
    _safe_set(a, 'eol_ModelElementType220', b1)
    assert _is_linked(a, 'eol_ModelElementType220', b1)
    if hasattr(b1, 'eol_IPackage221'):
        assert _is_linked(b1, 'eol_IPackage221', a)
    _safe_set(a, 'eol_ModelElementType220', b2)
    assert _is_linked(a, 'eol_ModelElementType220', b2)
    if hasattr(b1, 'eol_IPackage221'):
        assert not _is_linked(b1, 'eol_IPackage221', a)
    if hasattr(b2, 'eol_IPackage221'):
        assert _is_linked(b2, 'eol_IPackage221', a)
    _safe_set(a, 'eol_ModelElementType220', None)
    assert not _is_linked(a, 'eol_ModelElementType220', b2)
    if hasattr(b2, 'eol_IPackage221'):
        assert not _is_linked(b2, 'eol_IPackage221', a)


def test_assoc_resolvedModelDeclaration216_link_reassign_clear():
    a = eol_ModelElementType(elementName="sample_text", modelName="sample_text", modelType="sample_text")
    b1 = eol_ModelDeclarationStatement()
    b2 = eol_ModelDeclarationStatement()
    _safe_set(a, 'eol_ModelElementType217', b1)
    assert _is_linked(a, 'eol_ModelElementType217', b1)
    if hasattr(b1, 'eol_ModelDeclarationStatement218'):
        assert _is_linked(b1, 'eol_ModelDeclarationStatement218', a)
    _safe_set(a, 'eol_ModelElementType217', b2)
    assert _is_linked(a, 'eol_ModelElementType217', b2)
    if hasattr(b1, 'eol_ModelDeclarationStatement218'):
        assert not _is_linked(b1, 'eol_ModelDeclarationStatement218', a)
    if hasattr(b2, 'eol_ModelDeclarationStatement218'):
        assert _is_linked(b2, 'eol_ModelDeclarationStatement218', a)
    _safe_set(a, 'eol_ModelElementType217', None)
    assert not _is_linked(a, 'eol_ModelElementType217', b2)
    if hasattr(b2, 'eol_ModelDeclarationStatement218'):
        assert not _is_linked(b2, 'eol_ModelDeclarationStatement218', a)
...
def test_assoc_result58_link_reassign_clear():
    ...
    if hasattr(b1, 'eol_OperationDefinition59'):
        assert _is_linked(b1, 'eol_OperationDefinition59', a)
    _safe_set(a, 'eol_VariableDeclarationExpression60', b2)
    assert _is_linked(a, 'eol_VariableDeclarationExpression60', b2)
    if hasattr(b1, 'eol_OperationDefinition59'):
        assert not _is_linked(b1, 'eol_OperationDefinition59', a)
    if hasattr(b2, 'eol_OperationDefinition59'):
        assert _is_linked(b2, 'eol_OperationDefinition59', a)
    _safe_set(a, 'eol_VariableDeclarationExpression60', None)
    assert not _is_linked(a, 'eol_VariableDeclarationExpression60', b2)
    if hasattr(b2, 'eol_OperationDefinition59'):
        assert not _is_linked(b2, 'eol_OperationDefinition59', a)


def test_assoc_self56_link_reassign_clear():
    a = eol_VariableDeclarationExpression(create=True)
    b1 = eol_OperationDefinition()
    b2 = eol_OperationDefinition()
    _safe_set(a, 'eol_VariableDeclarationExpression', b1)
    assert _is_linked(a, 'eol_VariableDeclarationExpression', b1)
    if hasattr(b1, 'eol_OperationDefinition57'):
        assert _is_linked(b1, 'eol_OperationDefinition57', a)
    _safe_set(a, 'eol_VariableDeclarationExpression', b2)
    assert _is_linked(a, 'eol_VariableDeclarationExpression', b2)
    if hasattr(b1, 'eol_OperationDefinition57'):
        assert not _is_linked(b1, 'eol_OperationDefinition57', a)
    if hasattr(b2, 'eol_OperationDefinition57'):
        assert _is_linked(b2, 'eol_OperationDefinition57', a)
    _safe_set(a, 'eol_VariableDeclarationExpression', None)
    assert not _is_linked(a, 'eol_VariableDeclarationExpression', b2)
    if hasattr(b2, 'eol_OperationDefinition57'):
        assert not _is_linked(b2, 'eol_OperationDefinition57', a)


def test_assoc_start18_link_reassign_clear():
    a = eol_TextPosition(column=7, line=7)
    b1 = eol_TextRegion()
    b2 = eol_TextRegion()
    _safe_set(a, 'eol_TextPosition', b1)
    assert _is_linked(a, 'eol_TextPosition', b1)
    if hasattr(b1, 'eol_TextRegion19'):
        assert _is_linked(b1, 'eol_TextRegion19', a)
    _safe_set(a, 'eol_TextPosition', b2)
    assert _is_linked(a, 'eol_TextPosition', b2)
    if hasattr(b1, 'eol_TextRegion19'):
        assert not _is_linked(b1, 'eol_TextRegion19', a)
    if hasattr(b2, 'eol_TextRegion19'):
        assert _is_linked(b2, 'eol_TextRegion19', a)
    _safe_set(a, 'eol_TextPosition', None)
    assert not _is_linked(a, 'eol_TextPosition', b2)
    if hasattr(b2, 'eol_TextRegion19'):
        assert not _is_linked(b2, 'eol_TextRegion19', a)


def test_assoc_subPackages16_link_reassign_clear():
    a = eol_IPackage(iPackageDriver="sample_text", name="sample_text", nsPrefix="sample_text")
    b1 = eol_IPackage(iPackageDriver="sample_text", name="sample_text", nsPrefix="sample_text")
    b2 = eol_IPackage(iPackageDriver="sample_text_2", name="sample_text_2", nsPrefix="sample_text_2")
    _safe_set(a, 'eol_IPackage15', {b1})
    assert _is_linked(a, 'eol_IPackage15', b1)
    if hasattr(b1, 'eol_IPackage17'):
        assert _is_linked(b1, 'eol_IPackage17', a)
    _safe_set(a, 'eol_IPackage15', {b2})
    assert _is_linked(a, 'eol_IPackage15', b2)
    if hasattr(b1, 'eol_IPackage17'):
        assert not _is_linked(b1, 'eol_IPackage17', a)
    if hasattr(b2, 'eol_IPackage17'):
        assert _is_linked(b2, 'eol_IPackage17', a)
    _safe_set(a, 'eol_IPackage15', set())
    assert not _is_linked(a, 'eol_IPackage15', b2)
    if hasattr(b2, 'eol_IPackage17'):
        assert not _is_linked(b2, 'eol_IPackage17', a)


def test_assoc_target83_link_reassign_clear():
    a = eol_FeatureCallExpression(isArrow=True)
    b1 = eol_Expression()
    b2 = eol_Expression()
    _safe_set(a, 'eol_FeatureCallExpression', b1)
    assert _is_linked(a, 'eol_FeatureCallExpression', b1)
    if hasattr(b1, 'eol_Expression84'):
        assert _is_linked(b1, 'eol_Expression84', a)
    _safe_set(a, 'eol_FeatureCallExpression', b2)
    assert _is_linked(a, 'eol_FeatureCallExpression', b2)
    if hasattr(b1, 'eol_Expression84'):
        assert not _is_linked(b1, 'eol_Expression84', a)
    if hasattr(b2, 'eol_Expression84'):
        assert _is_linked(b2, 'eol_Expression84', a)
    _safe_set(a, 'eol_FeatureCallExpression', None)
    assert not _is_linked(a, 'eol_FeatureCallExpression', b2)
    if hasattr(b2, 'eol_Expression84'):
        assert not _is_linked(b2, 'eol_Expression84', a)


def test_assoc_typeName111_link_reassign_clear():
    a = eol_NameExpression(isType=True, name="sample_text", resolvedContent="sample_text")
    b1 = eol_NewExpression()
    b2 = eol_NewExpression()
    _safe_set(a, 'eol_NameExpression112', b1)
    assert _is_linked(a, 'eol_NameExpression112', b1)
    if hasattr(b1, 'eol_NewExpression'):
        assert _is_linked(b1, 'eol_NewExpression', a)
    _safe_set(a, 'eol_NameExpression112', b2)
    assert _is_linked(a, 'eol_NameExpression112', b2)
    if hasattr(b1, 'eol_NewExpression'):
        assert not _is_linked(b1, 'eol_NewExpression', a)
    if hasattr(b2, 'eol_NewExpression'):
        assert _is_linked(b2, 'eol_NewExpression', a)
    _safe_set(a, 'eol_NameExpression112', None)
    assert not _is_linked(a, 'eol_NameExpression112', b2)
    if hasattr(b2, 'eol_NewExpression'):
        assert not _is_linked(b2, 'eol_NewExpression', a)


def test_assoc_valueType224_link_reassign_clear():
    a = eol_AnyType(declared=True)
    b1 = eol_MapType()
    b2 = eol_MapType()
    _safe_set(a, 'eol_AnyType226', b1)
    assert _is_linked(a, 'eol_AnyType226', b1)
    if hasattr(b1, 'eol_MapType225'):
        assert _is_linked(b1, 'eol_MapType225', a)
    _safe_set(a, 'eol_AnyType226', b2)
    assert _is_linked(a, 'eol_AnyType226', b2)
    if hasattr(b1, 'eol_MapType225'):
        assert not _is_linked(b1, 'eol_MapType225', a)
    if hasattr(b2, 'eol_MapType225'):
        assert _is_linked(b2, 'eol_MapType225', a)
    _safe_set(a, 'eol_AnyType226', None)
    assert not _is_linked(a, 'eol_AnyType226', b2)
    if hasattr(b2, 'eol_MapType225'):
        assert not _is_linked(b2, 'eol_MapType225', a)


def test_assoc_values192_link_reassign_clear():
    a = eol_StringExpression(value="sample_text")
...
eol_FeatureCallExpression_strategy = st.builds(eol_FeatureCallExpression, isArrow=st.booleans())
@given(instance=eol_FeatureCallExpression_strategy)
@settings(max_examples=25)
...
eol_IModel_strategy = st.builds(eol_IModel, iMetamodelDriver=safe_text)
@given(instance=eol_IModel_strategy)
@settings(max_examples=25)
...
eol_IPackage_strategy = st.builds(eol_IPackage, iPackageDriver=safe_text, name=safe_text, nsPrefix=safe_text)
@given(instance=eol_IPackage_strategy)
@settings(max_examples=25)
...
eol_ModelElementType_strategy = st.builds(eol_ModelElementType, elementName=safe_text, modelName=safe_text, modelType=safe_text)
@given(instance=eol_ModelElementType_strategy)
@settings(max_examples=25)
...
eol_SelfInnermostContentType_strategy = st.builds(eol_SelfInnermostContentType)
