...
class eol_ModelElementType(AnyType):
    ...
    def __init__(self, modelName: str, modelType: str, elementName: str, eol_ModelElementType: "eol_IModel" = None, eol_ModelElementType217: "eol_ModelDeclarationStatement" = None, eol_ModelElementType220: "eol_IPackage" = None):
...
class eol_AnyType(Type):
    ...
    def __init__(self, declared: bool, eol_AnyType: set["eol_Type"] = None, eol_AnyType223: "eol_MapType" = None, eol_AnyType226: "eol_MapType" = None):
...
class eol_VariableDeclarationExpression(Expression):
    ...
    def __init__(self, create: bool, eol_VariableDeclarationExpression: "eol_OperationDefinition" = None, eol_VariableDeclarationExpression60: "eol_OperationDefinition" = None, eol_VariableDeclarationExpression78: set["eol_Expression"] = None, eol_VariableDeclarationExpression81: set["eol_NameExpression"] = None, eol_VariableDeclarationExpression75: "eol_NameExpression" = None, eol_VariableDeclarationExpression198: "eol_ModelDeclarationStatement" = None, eol_VariableDeclarationExpression204: "eol_ModelDeclarationStatement" = None):
        self.create = create
...
class eol_NameExpression(Expression):
    ...
    def __init__(self, name: str, resolvedContent: str, isType: bool, eol_NameExpression10: "eol_IModel" = None, eol_NameExpression: "eol_IModel" = None, eol_NameExpression7: "eol_IModel" = None, eol_NameExpression53: "eol_OperationDefinition" = None, eol_NameExpression82: "eol_VariableDeclarationExpression" = None, eol_NameExpression89: "eol_MethodCallExpression" = None, eol_NameExpression76: "eol_VariableDeclarationExpression" = None, eol_NameExpression94: "eol_PropertyCallExpression" = None, eol_NameExpression123: "eol_EnumerationLiteralExpression" = None, eol_NameExpression126: "eol_EnumerationLiteralExpression" = None, eol_NameExpression132: "eol_EnumerationLiteralExpression" = None, eol_NameExpression141: "eol_TransactionStatement" = None, eol_NameExpression191: "eol_AnnotationStatement" = None, eol_NameExpression102: "eol_FOLMethodCallExpression" = None, eol_NameExpression112: "eol_NewExpression" = None, eol_NameExpression201: "eol_ModelDeclarationStatement" = None):
        self.name = name
...
class eol_Import(EOLElement):
    ...
    def __init__(self, imported: str, eol_Import: "eol_EOLLibraryModule" = None, eol_Import33: "eol_EOLLibraryModule" = None):
...
class eol_IPackage(EOLElement):
    ...
    def __init__(self, iPackageDriver: str, name: str, nsPrefix: str, eol_IPackage: "eol_IModel" = None, eol_IPackage14: "eol_StringExpression" = None, eol_IPackage17: "eol_IPackage" = None, eol_IPackage15: set["eol_IPackage"] = None, eol_IPackage221: "eol_ModelElementType" = None):
...
class eol_IModel(EOLElement):
    ...
    def __init__(self, iMetamodelDriver: str, eol_IModel9: "eol_NameExpression" = None, eol_IModel: "eol_NameExpression" = None, eol_IModel6: set["eol_NameExpression"] = None, eol_IModel12: set["eol_IPackage"] = None, eol_IModel26: "eol_EOLLibraryModule" = None, eol_IModel129: "eol_EnumerationLiteralExpression" = None, eol_IModel207: "eol_ModelDeclarationStatement" = None, eol_IModel213: "eol_ModelType" = None, eol_IModel215: "eol_ModelElementType" = None):
