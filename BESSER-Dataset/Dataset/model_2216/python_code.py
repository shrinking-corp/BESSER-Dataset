...
class university_Semesters:
    ...
    def __init__(self, year: int, semesterTime: str, university_Semesters32: "university_University" = None, university_Semesters: "university_CourseInstances" = None, Semesters: "university_ProgrammeSemesters" = None, semester: set["university_ProgrammeSemesters"] = None):
        self.year = year
...
class university_Courses:
    ...
    def __init__(self, credits: float, code: str, name: str, university_Courses: "university_University" = None, Courses: "university_CourseInstances" = None, course: set["university_CourseInstances"] = None):
...
class university_ProgrammeInstances:
    ...
    def __init__(self, startYear: int, ProgrammeInstances: "university_Programmes" = None, ProgrammeInstances10: "university_ProgrammeSemesters" = None, instances: "university_Programmes" = None, programmeInstance: set["university_ProgrammeSemesters"] = None, programmeInstance4: set["university_Specializations"] = None, ProgrammeInstances24: "university_Specializations" = None):
