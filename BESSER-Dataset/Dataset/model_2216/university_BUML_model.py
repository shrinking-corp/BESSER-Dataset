...
# Classes
university_Programmes = Class(name="university_Programmes")
university_ProgrammeInstances = Class(name="university_ProgrammeInstances")
university_ProgrammeSemesters = Class(name="university_ProgrammeSemesters")
university_Specializations = Class(name="university_Specializations")
university_Courses = Class(name="university_Courses")
university_CourseInstances = Class(name="university_CourseInstances")
university_University = Class(name="university_University")
university_Semesters = Class(name="university_Semesters")
university_Slot = Class(name="university_Slot")
...
university_Courses.attributes={university_Courses_credits, university_Courses_code, university_Courses_name}
...
domain_model = DomainModel(
    name="university",
    types={university_Programmes, university_ProgrammeInstances, university_ProgrammeSemesters, university_Specializations, university_Courses, university_CourseInstances, university_University, university_Semesters, university_Slot, SemesterTime, SlotType},
    associations={instances0, programme1, programmeSemesters2, specializations3, instances5, specialization14, programmeSemester17, avaliableCourses19, programmeSemesters21, programmeInstance23, programmeSemester25, programmes27, courses28, semesters30, course6, semester8, programmeInstance9, slots11, semester12},
    generalizations={},
    metadata=None
)
