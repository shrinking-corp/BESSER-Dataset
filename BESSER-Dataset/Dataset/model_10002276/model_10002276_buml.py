...
LogON = Class(name="LogON")
LogOn = Class(name="LogOn")
ProjectController = Class(name="ProjectController")
...
# LogON class attributes and methods

# LogOn class attributes and methods

# ProjectController class attributes and methods
...
domain_model = DomainModel(
    name="a2efefeb_3d2e_4e00_a927_e352fede338b",
    types={ShoppingCartExample_ShoppingCart, ShoppingCartExample_Order, ShoppingCartExample_LineItem, ShoppingCartExample_Account, ShoppingCartExample_Customer, Class_, Class2, LogON, LogOn, ProjectController, Class3},
