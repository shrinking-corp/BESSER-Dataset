...
def test_projectcontroller_is_not_abstract():
    assert not inspect.isabstract(ProjectController)


def test_projectcontroller_constructor_exists():
    assert callable(ProjectController.__init__)


def test_projectcontroller_constructor_args():
    sig = inspect.signature(ProjectController.__init__)
    params = list(sig.parameters.keys())



def test_logon_is_not_abstract():
    assert not inspect.isabstract(LogOn)


def test_logon_constructor_exists():
    assert callable(LogOn.__init__)


def test_logon_constructor_args():
