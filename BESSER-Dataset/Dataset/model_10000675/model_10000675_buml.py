...
# Hola class attributes and methods
Hola_hppal: Property = Property(name="hppal", type=StringType)
Hola.attributes={Hola_hppal}
...
domain_model = DomainModel(
    name="_5434e10f_b6fe_42ed_a53c_8bd17952301a",
    types={User, Profile, Post, Group, Message, Friend, Login, Hola, T, T1},
