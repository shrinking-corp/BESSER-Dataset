...
class database_Column(NamedElement):
    ...
    def __init__(self, nullable: bool, defaultValue: str, autoincrement: bool, inPrimaryKey: bool, inForeignKey: bool, unique: bool, columns: "database_PrimaryKey" = None, database_Column9: set["database_ForeignKey"] = None, Column: "database_AbstractTable" = None, database_Column: set["database_Index"] = None, column: set["database_IndexElement"] = None, fkColumn: set["database_ForeignKeyElement"] = None, database_Column12: "database_Type" = None, columns14: "database_Sequence" = None, columns16: "database_AbstractTable" = None, Column30: "database_PrimaryKey" = None, Column41: "database_ForeignKeyElement" = None, database_Column44: "database_ForeignKeyElement" = None, Column46: "database_IndexElement" = None, Column50: "database_Sequence" = None):
    ...
    @property
    def columns14(self):
        return self.__columns14

    @columns14.setter
    def columns14(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_database_Column__columns14", None)
        self.__columns14 = value
    ...
    @property
    def Column50(self):
        return self.__Column50

    @Column50.setter
    def Column50(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_database_Column__Column50", None)
        self.__Column50 = value
...
class database_Sequence(NamedElement):
    ...
    def Sequence(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "columns14"):
                opp_val = getattr(old_value, "columns14", None)
                if opp_val == self:
                    setattr(old_value, "columns14", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "columns14"):
                opp_val = getattr(value, "columns14", None)
                setattr(value, "columns14", self)
    ...
    def sequence(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "Column50"):
                    opp_val = getattr(item, "Column50", None)
                    
                    if opp_val == self:
                        setattr(item, "Column50", None)
...
class database_ForeignKey(NamedElement):
    ...
    def __init__(self, database_ForeignKey: "database_Column" = None, ForeignKey: "database_Table" = None, database_ForeignKey35: set["database_ForeignKeyElement"] = None, foreignKeys: "database_Table" = None, database_ForeignKey39: "database_Table" = None):
