...
public class database_Column extends NamedElement {
    ...
    public database_Column(
        boolean inForeignKey,        String defaultValue,        boolean inPrimaryKey,        boolean unique,        boolean autoincrement,        boolean nullable    ) {
        super(
        );
    ...
    public database_Column(
        boolean inForeignKey,        String defaultValue,        boolean inPrimaryKey,        boolean unique,        boolean autoincrement,        boolean nullable        ArrayList<database_ForeignKey> database_foreignkeys,        ArrayList<database_Index> database_indexs,        ArrayList<database_ForeignKeyElement> database_foreignkeyelements,        ArrayList<database_IndexElement> database_indexelements    ) {
        this.inForeignKey = inForeignKey;
        this.defaultValue = defaultValue;
        this.inPrimaryKey = inPrimaryKey;
        this.unique = unique;
