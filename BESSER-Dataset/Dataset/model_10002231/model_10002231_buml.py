...
RedisStateStore.attributes={RedisStateStore_RadixClient, RedisStateStore_log, RedisStateStore_cluster}
...
RadixClient.attributes={RadixClient_state, RadixClient_password, RadixClient_redisUrl}
...
Order.attributes={Order_total, Order_shipTo, Order_number, Order_ordered, Order_status, Order_shipped}
...
domain_model = DomainModel(
    name="_y_n4sHf2EeqeQcxm9hmzHw",
    types={RedisStateStore, Payment, ShoppingCart, Redis, RadixClient, Order, LineItem, Product, Cluster, UserState, OrderStatus},
    associations={ShoppingCart_LineItem, Product_LineItem, Order_LineItem, Account_Order, Payment_Order, RadixClient_RedisClient, Cluster_Redis, Account_Payment, WebUser_ShoppingCart, Customer_Account, Account_ShoppingCart},
    generalizations={},
    metadata=None
)
