...
public class umlTrace_uml_TracedClearStructuralFeatureAction extends TracedStructuralFeatureAction {
    ...
    public umlTrace_uml_TracedClearStructuralFeatureAction(
    ) {
        super(
        );
    }
