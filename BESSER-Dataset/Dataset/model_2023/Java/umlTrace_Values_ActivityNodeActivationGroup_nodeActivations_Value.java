...
public class umlTrace_Values_ActivityNodeActivationGroup_nodeActivations_Value  {
    ...
    public umlTrace_Values_ActivityNodeActivationGroup_nodeActivations_Value(
    ) {
