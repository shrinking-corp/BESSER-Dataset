...
public class umlTrace_Values_ActivityEdgeInstance_edge_ActivityEdgeInstance_Value  {
    ...
    public umlTrace_Values_ActivityEdgeInstance_edge_ActivityEdgeInstance_Value(
    ) {
    }
