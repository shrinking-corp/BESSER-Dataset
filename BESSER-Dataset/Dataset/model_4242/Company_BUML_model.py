...
company_Subunit = Class(name="company_Subunit")
...
domain_model = DomainModel(
    name="company",
    types={company_Dept, company_Employee, company_Subunit, company_Person, company_Company},
    associations={depts0, manager1, subunits3, person5, pu7, du10},
    generalizations={},
    metadata=None
)
