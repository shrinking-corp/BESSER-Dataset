...
class aggregator_p2view_Category(IUPresentation):
    ...
    def __init__(self, aggregator_p2view_Category57: "Bundles" = None, aggregator_p2view_Category59: "Fragments" = None, aggregator_p2view_Category61: "IUDetails" = None, aggregator_p2view_Category: "Categories" = None, aggregator_p2view_Category53: "Features" = None, aggregator_p2view_Category55: "Products" = None, IUPresentation: "aggregator_p2view_InstallableUnits" = None):
...
class DescriptionProvider:
    ...
    pass
class aggregator_MapRule(EnabledStatusProvider, DescriptionProvider, InstallableUnitRequest):

    pass
class aggregator_ValidationSet(StatusProvider, InfosProvider, DescriptionProvider, EnabledStatusProvider, IdentificationProvider):
...
class aggregator_MappedRepository(IdentificationProvider, MetadataRepositoryReference, DescriptionProvider):
    ...
    def __init__(self, mirrorArtifacts: bool, categoryPrefix: str, aggregator_MappedRepository26: set["aggregator_Product"] = None, aggregator_MappedRepository28: set["aggregator_Bundle"] = None, aggregator_MappedRepository: "aggregator_Contribution" = None, aggregator_MappedRepository30: set["aggregator_Feature"] = None, aggregator_MappedRepository32: set["aggregator_Category"] = None, aggregator_MappedRepository34: set["aggregator_MapRule"] = None):
...
class aggregator_Contribution(StatusProvider, InfosProvider, DescriptionProvider, EnabledStatusProvider, IdentificationProvider):

    def __init__(self, label: str, aggregator_Contribution41: "aggregator_ValidationSet" = None, aggregator_Contribution: set["aggregator_MappedRepository"] = None, aggregator_Contribution15: set["aggregator_Contact"] = None, aggregator_Contribution18: set["aggregator_MavenMapping"] = None):
        self.label = label
...
class aggregator_Aggregation(StatusProvider, DescriptionProvider, InfosProvider):

    def __init__(self, label: str, buildRoot: str, packedStrategy: str, sendmail: bool, type: str, mavenResult: bool, aggregator_Aggregation4: set["aggregator_CustomCategory"] = None, aggregation: set["aggregator_Contact"] = None, aggregator_Aggregation7: "aggregator_Contact" = None, aggregator_Aggregation: set["aggregator_ValidationSet"] = None, aggregator_Aggregation2: set["aggregator_Configuration"] = None, aggregator_Aggregation9: set["aggregator_MavenMapping"] = None, Aggregation: "aggregator_Contact" = None):
        self.label = label
