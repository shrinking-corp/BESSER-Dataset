...
AssistantMVC_ExamItem.attributes={AssistantMVC_ExamItem_optional, AssistantMVC_ExamItem_question, AssistantMVC_ExamItem_value}
...
domain_model = DomainModel(
    name="AssistantMVC",
    types={AssistantMVC_ExamItem, AssistantMVC_Controller, AssistantMVC_View, AssistantMVC_Open, ExamItem, AssistantMVC_MultipleChoice, AssistantMVC_Observer, Observer, AssistantMVC_ExamController, Controller, AssistantMVC_ExamItemController, AssistantMVC_MultipleChoiceController, ExamItemController, AssistantMVC_OpenController, AssistantMVC_Exam, AssistantMVC_ExamView, View, AssistantMVC_ExamItemView, AssistantMVC_OpenView, ExamView, AssistantMVC_MultipleChoiceView, ExamItemView},
