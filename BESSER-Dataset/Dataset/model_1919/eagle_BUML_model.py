...
# Classes
eaglemodel_Note = Class(name="eaglemodel_Note")
eaglemodel_Settings = Class(name="eaglemodel_Settings")
eaglemodel_Grid = Class(name="eaglemodel_Grid")
eaglemodel_Layers = Class(name="eaglemodel_Layers")
eaglemodel_Schematic = Class(name="eaglemodel_Schematic")
eaglemodel_Setting = Class(name="eaglemodel_Setting")
eaglemodel_Layer = Class(name="eaglemodel_Layer")
eaglemodel_Eagle = Class(name="eaglemodel_Eagle")
eaglemodel_Compatibility = Class(name="eaglemodel_Compatibility")
eaglemodel_Drawing = Class(name="eaglemodel_Drawing")
eaglemodel_Description = Class(name="eaglemodel_Description")
eaglemodel_Libraries = Class(name="eaglemodel_Libraries")
eaglemodel_Attributes = Class(name="eaglemodel_Attributes")
eaglemodel_Variantdefs = Class(name="eaglemodel_Variantdefs")
eaglemodel_Classes = Class(name="eaglemodel_Classes")
eaglemodel_Parts = Class(name="eaglemodel_Parts")
eaglemodel_Sheets = Class(name="eaglemodel_Sheets")
eaglemodel_Errors = Class(name="eaglemodel_Errors")
eaglemodel_Library = Class(name="eaglemodel_Library")
eaglemodel_Packages = Class(name="eaglemodel_Packages")
eaglemodel_Symbols = Class(name="eaglemodel_Symbols")
eaglemodel_Devicesets = Class(name="eaglemodel_Devicesets")
eaglemodel_Attribute = Class(name="eaglemodel_Attribute")
eaglemodel_Variantdef = Class(name="eaglemodel_Variantdef")
eaglemodel_Variant = Class(name="eaglemodel_Variant")
eaglemodel_Class = Class(name="eaglemodel_Class")
eaglemodel_Clearance = Class(name="eaglemodel_Clearance")
eaglemodel_Part = Class(name="eaglemodel_Part")
eaglemodel_Plain = Class(name="eaglemodel_Plain")
eaglemodel_Instances = Class(name="eaglemodel_Instances")
eaglemodel_Busses = Class(name="eaglemodel_Busses")
eaglemodel_Nets = Class(name="eaglemodel_Nets")
eaglemodel_Approved = Class(name="eaglemodel_Approved")
eaglemodel_Package = Class(name="eaglemodel_Package")
eaglemodel_Polygon = Class(name="eaglemodel_Polygon")
eaglemodel_Wire = Class(name="eaglemodel_Wire")
eaglemodel_Text = Class(name="eaglemodel_Text")
eaglemodel_Dimension = Class(name="eaglemodel_Dimension")
eaglemodel_Circle = Class(name="eaglemodel_Circle")
eaglemodel_Rectangle = Class(name="eaglemodel_Rectangle")
eaglemodel_Frame = Class(name="eaglemodel_Frame")
eaglemodel_Hole = Class(name="eaglemodel_Hole")
eaglemodel_Pad = Class(name="eaglemodel_Pad")
eaglemodel_Sheet = Class(name="eaglemodel_Sheet")
eaglemodel_Pin = Class(name="eaglemodel_Pin")
eaglemodel_Deviceset = Class(name="eaglemodel_Deviceset")
eaglemodel_Gates = Class(name="eaglemodel_Gates")
eaglemodel_Devices = Class(name="eaglemodel_Devices")
eaglemodel_SMD = Class(name="eaglemodel_SMD")
eaglemodel_Symbol = Class(name="eaglemodel_Symbol")
eaglemodel_Vertex = Class(name="eaglemodel_Vertex")
eaglemodel_Gate = Class(name="eaglemodel_Gate")
eaglemodel_Device = Class(name="eaglemodel_Device")
eaglemodel_Connects = Class(name="eaglemodel_Connects")
eaglemodel_Technologies = Class(name="eaglemodel_Technologies")
eaglemodel_Connect = Class(name="eaglemodel_Connect")
eaglemodel_Technology = Class(name="eaglemodel_Technology")
eaglemodel_Instance = Class(name="eaglemodel_Instance")
eaglemodel_Bus = Class(name="eaglemodel_Bus")
eaglemodel_Segment = Class(name="eaglemodel_Segment")
eaglemodel_Net = Class(name="eaglemodel_Net")
eaglemodel_Label = Class(name="eaglemodel_Label")
eaglemodel_Pinref = Class(name="eaglemodel_Pinref")
eaglemodel_Junction = Class(name="eaglemodel_Junction")
...
eaglemodel_Note.attributes={eaglemodel_Note_severity, eaglemodel_Note_version, eaglemodel_Note_value}
...
eaglemodel_Grid.attributes={eaglemodel_Grid_altunit, eaglemodel_Grid_altdistance, eaglemodel_Grid_distance, eaglemodel_Grid_display, eaglemodel_Grid_multiple, eaglemodel_Grid_style, eaglemodel_Grid_unit, eaglemodel_Grid_unitdist, eaglemodel_Grid_altunitdist}
...
eaglemodel_Setting.attributes={eaglemodel_Setting_verticaltext, eaglemodel_Setting_alwaysvectorfont}
...
eaglemodel_Layer.attributes={eaglemodel_Layer_name, eaglemodel_Layer_number, eaglemodel_Layer_color, eaglemodel_Layer_visible, eaglemodel_Layer_fill, eaglemodel_Layer_active}
...
eaglemodel_Attribute.attributes={eaglemodel_Attribute_rot, eaglemodel_Attribute_display, eaglemodel_Attribute_font, eaglemodel_Attribute_ratio, eaglemodel_Attribute_constant, eaglemodel_Attribute_x, eaglemodel_Attribute_size, eaglemodel_Attribute_layer, eaglemodel_Attribute_value, eaglemodel_Attribute_name, eaglemodel_Attribute_y}
...
eaglemodel_Variant.attributes={eaglemodel_Variant_technology, eaglemodel_Variant_populate, eaglemodel_Variant_value, eaglemodel_Variant_name}
...
eaglemodel_Class.attributes={eaglemodel_Class_name, eaglemodel_Class_number, eaglemodel_Class_drill, eaglemodel_Class_width}

# eaglemodel_Clearance class attributes and methods
eaglemodel_Clearance_class_: Property = Property(name="class_", type=IntegerType)
eaglemodel_Clearance_value: Property = Property(name="value", type=FloatType)
eaglemodel_Clearance.attributes={eaglemodel_Clearance_value, eaglemodel_Clearance_class_}
...
eaglemodel_Part.attributes={eaglemodel_Part_library, eaglemodel_Part_technology, eaglemodel_Part_rot, eaglemodel_Part_smashed, eaglemodel_Part_value, eaglemodel_Part_y, eaglemodel_Part_name, eaglemodel_Part_uid, eaglemodel_Part_gate, eaglemodel_Part_x, eaglemodel_Part_deviceset, eaglemodel_Part_device}
...
eaglemodel_Polygon.attributes={eaglemodel_Polygon_thermals, eaglemodel_Polygon_layer, eaglemodel_Polygon_spacing, eaglemodel_Polygon_pour, eaglemodel_Polygon_orphans, eaglemodel_Polygon_rank, eaglemodel_Polygon_isolate, eaglemodel_Polygon_width}
...
eaglemodel_Wire.attributes={eaglemodel_Wire_y2, eaglemodel_Wire_y1, eaglemodel_Wire_extent, eaglemodel_Wire_width, eaglemodel_Wire_cap, eaglemodel_Wire_x1, eaglemodel_Wire_x2, eaglemodel_Wire_layer, eaglemodel_Wire_curve, eaglemodel_Wire_style}
...
eaglemodel_Text.attributes={eaglemodel_Text_font, eaglemodel_Text_value, eaglemodel_Text_align, eaglemodel_Text_layer, eaglemodel_Text_y, eaglemodel_Text_distance, eaglemodel_Text_size, eaglemodel_Text_ratio, eaglemodel_Text_rot, eaglemodel_Text_x}
...
eaglemodel_Dimension.attributes={eaglemodel_Dimension_dtype, eaglemodel_Dimension_textratio, eaglemodel_Dimension_y3, eaglemodel_Dimension_extwidth, eaglemodel_Dimension_y2, eaglemodel_Dimension_width, eaglemodel_Dimension_layer, eaglemodel_Dimension_extlength, eaglemodel_Dimension_precision, eaglemodel_Dimension_x1, eaglemodel_Dimension_textsize, eaglemodel_Dimension_extoffset, eaglemodel_Dimension_unit, eaglemodel_Dimension_visible, eaglemodel_Dimension_x3, eaglemodel_Dimension_y1, eaglemodel_Dimension_x2}
...
eaglemodel_Circle.attributes={eaglemodel_Circle_x, eaglemodel_Circle_layer, eaglemodel_Circle_width, eaglemodel_Circle_radius, eaglemodel_Circle_y}
...
eaglemodel_Rectangle.attributes={eaglemodel_Rectangle_rot, eaglemodel_Rectangle_y1, eaglemodel_Rectangle_y2, eaglemodel_Rectangle_layer, eaglemodel_Rectangle_x1, eaglemodel_Rectangle_x2}
...
eaglemodel_Frame.attributes={eaglemodel_Frame_borderright, eaglemodel_Frame_layer, eaglemodel_Frame_borderleft, eaglemodel_Frame_columns, eaglemodel_Frame_bordertop, eaglemodel_Frame_borderbottom, eaglemodel_Frame_x1, eaglemodel_Frame_rows, eaglemodel_Frame_y1, eaglemodel_Frame_x2, eaglemodel_Frame_y2}
...
eaglemodel_Hole.attributes={eaglemodel_Hole_y, eaglemodel_Hole_drill, eaglemodel_Hole_x}
...
eaglemodel_Pad.attributes={eaglemodel_Pad_diameter, eaglemodel_Pad_first, eaglemodel_Pad_thermals, eaglemodel_Pad_x, eaglemodel_Pad_stop, eaglemodel_Pad_drill, eaglemodel_Pad_name, eaglemodel_Pad_shape, eaglemodel_Pad_y, eaglemodel_Pad_rot}
...
eaglemodel_Pin.attributes={eaglemodel_Pin_x, eaglemodel_Pin_name, eaglemodel_Pin_function, eaglemodel_Pin_length, eaglemodel_Pin_visible, eaglemodel_Pin_rot, eaglemodel_Pin_y, eaglemodel_Pin_direction, eaglemodel_Pin_swaplevel}
...
eaglemodel_Deviceset.attributes={eaglemodel_Deviceset_uservalue, eaglemodel_Deviceset_name, eaglemodel_Deviceset_prefix}
...
eaglemodel_SMD.attributes={eaglemodel_SMD_layer, eaglemodel_SMD_name, eaglemodel_SMD_thermals, eaglemodel_SMD_dy, eaglemodel_SMD_x, eaglemodel_SMD_roundness, eaglemodel_SMD_cream, eaglemodel_SMD_rot, eaglemodel_SMD_dx, eaglemodel_SMD_stop, eaglemodel_SMD_y}
...
eaglemodel_Vertex.attributes={eaglemodel_Vertex_y, eaglemodel_Vertex_x, eaglemodel_Vertex_curve}
...
eaglemodel_Gate.attributes={eaglemodel_Gate_x, eaglemodel_Gate_swaplevel, eaglemodel_Gate_addlevel, eaglemodel_Gate_y, eaglemodel_Gate_symbol, eaglemodel_Gate_name}
...
eaglemodel_Device.attributes={eaglemodel_Device_name, eaglemodel_Device_package}
...
eaglemodel_Connect.attributes={eaglemodel_Connect_gate, eaglemodel_Connect_pin, eaglemodel_Connect_route, eaglemodel_Connect_pad}
...
eaglemodel_Instance.attributes={eaglemodel_Instance_smashed, eaglemodel_Instance_rot, eaglemodel_Instance_part, eaglemodel_Instance_x, eaglemodel_Instance_y, eaglemodel_Instance_gate}
...
eaglemodel_Net_class_: Property = Property(name="class_", type=IntegerType)
eaglemodel_Net.attributes={eaglemodel_Net_name, eaglemodel_Net_class_}
...
eaglemodel_Label.attributes={eaglemodel_Label_xref, eaglemodel_Label_font, eaglemodel_Label_layer, eaglemodel_Label_x, eaglemodel_Label_ratio, eaglemodel_Label_size, eaglemodel_Label_y, eaglemodel_Label_rot}
...
eaglemodel_Junction.attributes={eaglemodel_Junction_x, eaglemodel_Junction_y}
...
domain_model = DomainModel(
    name="eaglemodel",
    types={eaglemodel_Note, eaglemodel_Settings, eaglemodel_Grid, eaglemodel_Layers, eaglemodel_Schematic, eaglemodel_Setting, eaglemodel_Layer, eaglemodel_Eagle, eaglemodel_Compatibility, eaglemodel_Drawing, eaglemodel_Description, eaglemodel_Libraries, eaglemodel_Attributes, eaglemodel_Variantdefs, eaglemodel_Classes, eaglemodel_Parts, eaglemodel_Sheets, eaglemodel_Errors, eaglemodel_Library, eaglemodel_Packages, eaglemodel_Symbols, eaglemodel_Devicesets, eaglemodel_Attribute, eaglemodel_Variantdef, eaglemodel_Variant, eaglemodel_Class, eaglemodel_Clearance, eaglemodel_Part, eaglemodel_Plain, eaglemodel_Instances, eaglemodel_Busses, eaglemodel_Nets, eaglemodel_Approved, eaglemodel_Package, eaglemodel_Polygon, eaglemodel_Wire, eaglemodel_Text, eaglemodel_Dimension, eaglemodel_Circle, eaglemodel_Rectangle, eaglemodel_Frame, eaglemodel_Hole, eaglemodel_Pad, eaglemodel_Sheet, eaglemodel_Pin, eaglemodel_Deviceset, eaglemodel_Gates, eaglemodel_Devices, eaglemodel_SMD, eaglemodel_Symbol, eaglemodel_Vertex, eaglemodel_Gate, eaglemodel_Device, eaglemodel_Connects, eaglemodel_Technologies, eaglemodel_Connect, eaglemodel_Technology, eaglemodel_Instance, eaglemodel_Bus, eaglemodel_Segment, eaglemodel_Net, eaglemodel_Label, eaglemodel_Pinref, eaglemodel_Junction, Severity, GateAddLevel, WireStyle, WireCap, DimensionType, GridUnit, PadShape, PolygonPour, PinVisible, PinLength, PinDirection, PinFunction, ContactRoute, AttributeDisplay, VerticalText, GridStyle, TextFont, Align},
    associations={drawing1, note3, settings5, grid7, layers9, schematic11, settings13, layers15, compatibility0, description17, libraries19, attributes21, variantdefs23, classes25, parts27, sheets29, errors31, library33, description35, packages38, symbols40, devicesets42, attribute44, variantdef46, class_48, clearance50, part52, plain64, instances66, busses68, nets70, error72, package74, description76, polygon79, wire81, text83, dimension85, circle87, rectangle89, frame91, hole93, attribute54, variant57, sheet59, description61, description101, polygon104, wire107, text110, dimension113, pin116, circle118, rectangle121, frame124, deviceset127, description129, gates132, devices134, pad95, smd97, symbol99, vertex136, gate138, device140, connects142, technologies144, connect146, technology148, dimension162, circle165, rectangle168, frame171, hole174, instance177, attribute179, bus182, segment184, net186, segment188, attribute150, polygon153, wire156, text159, label198, pinref191, wire193, junction196},
    generalizations={},
    metadata=None
)
