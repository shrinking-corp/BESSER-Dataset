...
class eaglemodel_Library:
    ...
    def __init__(self, name: str, eaglemodel_Library: "eaglemodel_Libraries" = None, eaglemodel_Library36: "eaglemodel_Description" = None, eaglemodel_Library39: "eaglemodel_Packages" = None, eaglemodel_Library41: "eaglemodel_Symbols" = None, eaglemodel_Library43: "eaglemodel_Devicesets" = None):
        self.name = name
...
class eaglemodel_Description:
    ...
    def __init__(self, language: str, value: str, eaglemodel_Description37: "eaglemodel_Library" = None, eaglemodel_Description78: "eaglemodel_Package" = None, eaglemodel_Description63: "eaglemodel_Sheet" = None, eaglemodel_Description103: "eaglemodel_Symbol" = None, eaglemodel_Description: "eaglemodel_Schematic" = None, eaglemodel_Description131: "eaglemodel_Deviceset" = None):
...
class eaglemodel_Eagle:
    ...
    def __init__(self, version: str, eaglemodel_Eagle2: "eaglemodel_Drawing" = None, eaglemodel_Eagle: "eaglemodel_Compatibility" = None):
...
class eaglemodel_Schematic:
    ...
    def __init__(self, xrefpart: str, xreflabel: str, eaglemodel_Schematic22: "eaglemodel_Attributes" = None, eaglemodel_Schematic24: "eaglemodel_Variantdefs" = None, eaglemodel_Schematic26: "eaglemodel_Classes" = None, eaglemodel_Schematic28: "eaglemodel_Parts" = None, eaglemodel_Schematic30: "eaglemodel_Sheets" = None, eaglemodel_Schematic32: "eaglemodel_Errors" = None, eaglemodel_Schematic: "eaglemodel_Drawing" = None, eaglemodel_Schematic18: "eaglemodel_Description" = None, eaglemodel_Schematic20: "eaglemodel_Libraries" = None):
...
class eaglemodel_Grid:
    ...
    def __init__(self, distance: float, unitdist: str, unit: str, style: str, multiple: int, display: bool, altdistance: float, altunitdist: str, altunit: str, eaglemodel_Grid: "eaglemodel_Drawing" = None):
...
class eaglemodel_Net:
    ...
    def __init__(self, name: str, class_: int, eaglemodel_Net: "eaglemodel_Nets" = None, eaglemodel_Net189: set["eaglemodel_Segment"] = None):
        self.name = name
        self.class_ = class_
...
class eaglemodel_Bus:
    ...
    def __init__(self, name: str, eaglemodel_Bus: "eaglemodel_Busses" = None, eaglemodel_Bus185: set["eaglemodel_Segment"] = None):
        self.name = name
...
class eaglemodel_Symbol:
    ...
    def __init__(self, name: str, eaglemodel_Symbol102: "eaglemodel_Description" = None, eaglemodel_Symbol105: set["eaglemodel_Polygon"] = None, eaglemodel_Symbol108: set["eaglemodel_Wire"] = None, eaglemodel_Symbol111: set["eaglemodel_Text"] = None, eaglemodel_Symbol114: set["eaglemodel_Dimension"] = None, eaglemodel_Symbol117: set["eaglemodel_Pin"] = None, eaglemodel_Symbol119: set["eaglemodel_Circle"] = None, eaglemodel_Symbol122: set["eaglemodel_Rectangle"] = None, eaglemodel_Symbol125: set["eaglemodel_Frame"] = None, eaglemodel_Symbol: "eaglemodel_Symbols" = None):
        self.name = name
...
class eaglemodel_SMD:
    ...
    def __init__(self, dy: float, layer: int, roundness: int, rot: int, stop: bool, thermals: bool, cream: bool, name: str, x: float, y: float, dx: float, eaglemodel_SMD: "eaglemodel_Package" = None):
        self.dy = dy
        self.layer = layer
...
class eaglemodel_Deviceset:
    ...
    def __init__(self, name: str, prefix: str, uservalue: bool, eaglemodel_Deviceset: "eaglemodel_Devicesets" = None, eaglemodel_Deviceset130: "eaglemodel_Description" = None, eaglemodel_Deviceset133: "eaglemodel_Gates" = None, eaglemodel_Deviceset135: "eaglemodel_Devices" = None):
        self.name = name
        self.prefix = prefix
...
class eaglemodel_Pin:
    ...
    def __init__(self, rot: int, name: str, x: float, y: float, visible: str, length: str, direction: str, function: str, swaplevel: int, eaglemodel_Pin: "eaglemodel_Symbol" = None):
        self.rot = rot
        self.name = name
        self.x = x
        self.y = y
...
class eaglemodel_Frame:
    ...
    def __init__(self, x1: float, y1: float, x2: float, y2: float, columns: int, rows: int, layer: int, borderleft: bool, bordertop: bool, borderright: bool, borderbottom: bool, eaglemodel_Frame: "eaglemodel_Package" = None, eaglemodel_Frame173: "eaglemodel_Plain" = None, eaglemodel_Frame126: "eaglemodel_Symbol" = None):
        self.x1 = x1
        self.y1 = y1
        self.x2 = x2
        self.y2 = y2
...
class eaglemodel_Rectangle:
    ...
    def __init__(self, x1: float, y1: float, x2: float, y2: float, layer: int, rot: int, eaglemodel_Rectangle: "eaglemodel_Package" = None, eaglemodel_Rectangle170: "eaglemodel_Plain" = None, eaglemodel_Rectangle123: "eaglemodel_Symbol" = None):
        self.x1 = x1
        self.y1 = y1
        self.x2 = x2
        self.y2 = y2
...
class eaglemodel_Circle:
    ...
    def __init__(self, x: float, y: float, radius: float, width: float, layer: int, eaglemodel_Circle: "eaglemodel_Package" = None, eaglemodel_Circle167: "eaglemodel_Plain" = None, eaglemodel_Circle120: "eaglemodel_Symbol" = None):
        self.x = x
        self.y = y
        self.radius = radius
        self.width = width
...
class eaglemodel_Dimension:
    ...
    def __init__(self, x1: float, y1: float, x2: float, y2: float, x3: float, y3: float, layer: int, dtype: str, width: float, extwidth: float, extlength: float, extoffset: float, textsize: float, textratio: int, unit: str, precision: int, visible: bool, eaglemodel_Dimension: "eaglemodel_Package" = None, eaglemodel_Dimension164: "eaglemodel_Plain" = None, eaglemodel_Dimension115: "eaglemodel_Symbol" = None):
        self.x1 = x1
        self.y1 = y1
        self.x2 = x2
        self.y2 = y2
...
class eaglemodel_Polygon:
    ...
    def __init__(self, width: float, layer: int, spacing: float, pour: str, isolate: float, orphans: bool, thermals: bool, rank: int, eaglemodel_Polygon: "eaglemodel_Package" = None, eaglemodel_Polygon106: "eaglemodel_Symbol" = None, eaglemodel_Polygon155: "eaglemodel_Plain" = None, eaglemodel_Polygon137: set["eaglemodel_Vertex"] = None):
        self.width = width
        self.layer = layer
...
class eaglemodel_Package:
    ...
    def __init__(self, name: str, eaglemodel_Package: "eaglemodel_Packages" = None, eaglemodel_Package77: "eaglemodel_Description" = None, eaglemodel_Package80: set["eaglemodel_Polygon"] = None, eaglemodel_Package82: set["eaglemodel_Wire"] = None, eaglemodel_Package84: set["eaglemodel_Text"] = None, eaglemodel_Package86: set["eaglemodel_Dimension"] = None, eaglemodel_Package88: set["eaglemodel_Circle"] = None, eaglemodel_Package90: set["eaglemodel_Rectangle"] = None, eaglemodel_Package92: set["eaglemodel_Frame"] = None, eaglemodel_Package94: set["eaglemodel_Hole"] = None, eaglemodel_Package96: set["eaglemodel_Pad"] = None, eaglemodel_Package98: set["eaglemodel_SMD"] = None):
        self.name = name
...
class eaglemodel_Clearance:
    ...
    def __init__(self, class_: int, value: float, eaglemodel_Clearance: "eaglemodel_Class" = None):
        self.class_ = class_
        self.value = value
...
class eaglemodel_Attribute:
    ...
    def __init__(self, name: str, value: str, x: float, y: float, size: float, layer: int, font: str, ratio: int, rot: int, display: str, constant: bool, eaglemodel_Attribute: "eaglemodel_Attributes" = None, eaglemodel_Attribute56: "eaglemodel_Part" = None, eaglemodel_Attribute181: "eaglemodel_Instance" = None, eaglemodel_Attribute152: "eaglemodel_Technology" = None):
        self.name = name
        self.value = value
        self.x = x
        self.y = y
