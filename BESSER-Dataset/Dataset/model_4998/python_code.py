...
class cloudml_core_Node(WithProperties):
    ...
    def __init__(self, is64os: bool, minRam: int, minCore: int, minDisk: int, location: str, OS: str, sshKey: str, securityGroup: str, groupName: str, privateKey: str, imageID: str, cloudml_core_Node: set["NodePort"] = None, cloudml_core_Node27: "Provider" = None):
        self.is64os = is64os
        self.minRam = minRam
