...
class Order:
    ...
    def __init__(self, CustomerID: str, Status: str, ShippingID: str, OrderID: int, DateCreated: str, DateShipped: str, CustomerName: str, customer3: "Customer" = None, shippingInfo4: "ShippingInfo" = None, has_a6: "OrderDetails" = None):
