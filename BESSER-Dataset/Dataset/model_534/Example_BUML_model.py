...
domain_model = DomainModel(
    name="Example",
    types={Example_Son, Example_Daughter, Example_Pet, Example_Member, Member, Example_Dog, Pet, Example_Cat, Example_Family, Example_Parent, Example_RaceDog, Dog, Example_HuntingDog},
