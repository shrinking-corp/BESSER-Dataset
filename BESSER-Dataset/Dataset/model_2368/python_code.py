...
class relational_obeo_Column(ModelElement):
    ...
    def __init__(self, name: str, type: str, isPrimaryKey: bool, isUnique: bool, ownedColumns: "relational_obeo_Table" = None, Column: "relational_obeo_Table" = None):
        self.name = name
        self.type = type
...
class relational_obeo_Table(ModelElement):
    ...
    def __init__(self, name: str, Table13: "relational_obeo_Column" = None, Table: "relational_obeo_Schema" = None, owner5: set["relational_obeo_Column"] = None, foreignTable: set["relational_obeo_ForeignKey"] = None, ownedTables: "relational_obeo_Schema" = None, Table10: "relational_obeo_ForeignKey" = None, relational_obeo_Table: "relational_obeo_ForeignKey" = None):
        self.name = name
...
class relational_obeo_Database(ModelElement):
    ...
    def __init__(self, name: str, url: str, owner: set["relational_obeo_Schema"] = None, Database: "relational_obeo_Schema" = None):
        self.name = name
        self.url = url
