...
# Classes
relational_obeo_Database = Class(name="relational_obeo_Database")
ModelElement = Class(name="ModelElement")
relational_obeo_Schema = Class(name="relational_obeo_Schema")
relational_obeo_Table = Class(name="relational_obeo_Table")
relational_obeo_Column = Class(name="relational_obeo_Column")
relational_obeo_ForeignKey = Class(name="relational_obeo_ForeignKey")
relational_obeo_ModelElement = Class(name="relational_obeo_ModelElement", is_abstract=True)
...
relational_obeo_Column.attributes={relational_obeo_Column_isUnique, relational_obeo_Column_name, relational_obeo_Column_isPrimaryKey, relational_obeo_Column_type}
...
domain_model = DomainModel(
    ...
    types={relational_obeo_Database, ModelElement, relational_obeo_Schema, relational_obeo_Table, relational_obeo_Column, relational_obeo_ForeignKey, relational_obeo_ModelElement, Type},
    associations={owner12, ownedSchemas0, ownedTables1, owner3, ownedColumns4, ownedForeignKeys6, owner7, foreignTable9, sourceTable11},
    generalizations={gen_relational_obeo_Database_ModelElement, gen_relational_obeo_Column_ModelElement, gen_relational_obeo_Schema_ModelElement, gen_relational_obeo_Table_ModelElement, gen_relational_obeo_ForeignKey_ModelElement},
    metadata=None
)
