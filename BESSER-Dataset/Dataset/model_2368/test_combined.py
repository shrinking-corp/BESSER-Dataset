...
def test_hyp_relational_obeo_modelelement_is_not_abstract():
    assert not inspect.isabstract(relational_obeo_ModelElement)


def test_hyp_relational_obeo_modelelement_constructor_exists():
    assert callable(relational_obeo_ModelElement.__init__)


def test_hyp_relational_obeo_modelelement_constructor_args():
...
def test_hyp_relational_obeo_table_is_not_abstract():
    assert not inspect.isabstract(relational_obeo_Table)


def test_hyp_relational_obeo_table_constructor_exists():
    assert callable(relational_obeo_Table.__init__)


def test_hyp_relational_obeo_table_constructor_args():
...
def test_hyp_relational_obeo_column_is_not_abstract():
    assert not inspect.isabstract(relational_obeo_Column)


def test_hyp_relational_obeo_column_constructor_exists():
    assert callable(relational_obeo_Column.__init__)


def test_hyp_relational_obeo_column_constructor_args():
...
def test_hyp_relational_obeo_schema_is_not_abstract():
    assert not inspect.isabstract(relational_obeo_Schema)


def test_hyp_relational_obeo_schema_constructor_exists():
    assert callable(relational_obeo_Schema.__init__)


def test_hyp_relational_obeo_schema_constructor_args():
...
def test_hyp_relational_obeo_foreignkey_is_not_abstract():
    assert not inspect.isabstract(relational_obeo_ForeignKey)


def test_hyp_relational_obeo_foreignkey_constructor_exists():
    assert callable(relational_obeo_ForeignKey.__init__)


def test_hyp_relational_obeo_foreignkey_constructor_args():
...
def test_hyp_relational_obeo_database_is_not_abstract():
    assert not inspect.isabstract(relational_obeo_Database)


def test_hyp_relational_obeo_database_constructor_exists():
    assert callable(relational_obeo_Database.__init__)


def test_hyp_relational_obeo_database_constructor_args():
...
def test_hyp_relational_obeo_modelelement_comment_setter(instance):
...
def test_hyp_relational_obeo_table_name_setter(instance):
...
def test_hyp_relational_obeo_column_type_setter(instance):
...
@given(instance=relational_obeo_Column_strategy)
def test_hyp_relational_obeo_column_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=relational_obeo_Column_strategy)
def test_hyp_relational_obeo_column_isUnique_setter(instance):
...
@given(instance=relational_obeo_Column_strategy)
def test_hyp_relational_obeo_column_isPrimaryKey_setter(instance):
...
def test_hyp_relational_obeo_schema_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_relational_obeo_foreignkey_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_relational_obeo_database_url_setter(instance):
...
@given(instance=relational_obeo_Database_strategy)
def test_hyp_relational_obeo_database_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_relational_obeo_Column_isPrimaryKey_value_roundtrip():
    instance = relational_obeo_Column(isPrimaryKey=True, isUnique=True, name="sample_text", type="sample_text")
    assert instance.isPrimaryKey == True
    instance.isPrimaryKey = False
    assert instance.isPrimaryKey == False


def test_relational_obeo_Column_isUnique_value_roundtrip():
    instance = relational_obeo_Column(isPrimaryKey=True, isUnique=True, name="sample_text", type="sample_text")
...
def test_relational_obeo_Column_name_value_roundtrip():
    instance = relational_obeo_Column(isPrimaryKey=True, isUnique=True, name="sample_text", type="sample_text")
...
def test_relational_obeo_Column_type_value_roundtrip():
    instance = relational_obeo_Column(isPrimaryKey=True, isUnique=True, name="sample_text", type="sample_text")
...
def test_relational_obeo_Database_name_value_roundtrip():
    instance = relational_obeo_Database(name="sample_text", url="sample_text")
    assert instance.name == "sample_text"
    instance.name = "sample_text_2"
    assert instance.name == "sample_text_2"


def test_relational_obeo_Database_url_value_roundtrip():
    instance = relational_obeo_Database(name="sample_text", url="sample_text")
...
def test_relational_obeo_ForeignKey_name_value_roundtrip():
    instance = relational_obeo_ForeignKey(name="sample_text")
    assert instance.name == "sample_text"
    instance.name = "sample_text_2"
    assert instance.name == "sample_text_2"


def test_relational_obeo_ModelElement_comment_value_roundtrip():
    instance = relational_obeo_ModelElement(comment="sample_text")
    assert instance.comment == "sample_text"
    instance.comment = "sample_text_2"
    assert instance.comment == "sample_text_2"


def test_relational_obeo_Schema_name_value_roundtrip():
    instance = relational_obeo_Schema(name="sample_text")
    assert instance.name == "sample_text"
    instance.name = "sample_text_2"
    assert instance.name == "sample_text_2"


def test_relational_obeo_Table_name_value_roundtrip():
    instance = relational_obeo_Table(name="sample_text")
    assert instance.name == "sample_text"
    instance.name = "sample_text_2"
    assert instance.name == "sample_text_2"


def test_relational_obeo_Column_isa_ModelElement():
    instance = relational_obeo_Column(isPrimaryKey=True, isUnique=True, name="sample_text", type="sample_text")
    assert isinstance(instance, ModelElement)


def test_relational_obeo_Database_isa_ModelElement():
    instance = relational_obeo_Database(name="sample_text", url="sample_text")
    assert isinstance(instance, ModelElement)


def test_relational_obeo_ForeignKey_isa_ModelElement():
    instance = relational_obeo_ForeignKey(name="sample_text")
    assert isinstance(instance, ModelElement)


def test_relational_obeo_Schema_isa_ModelElement():
    instance = relational_obeo_Schema(name="sample_text")
    assert isinstance(instance, ModelElement)


def test_relational_obeo_Table_isa_ModelElement():
    instance = relational_obeo_Table(name="sample_text")
    assert isinstance(instance, ModelElement)


def test_assoc_foreignTable9_link_reassign_clear():
    a = relational_obeo_Table(name="sample_text")
    b1 = relational_obeo_ForeignKey(name="sample_text")
    b2 = relational_obeo_ForeignKey(name="sample_text_2")
...
def test_assoc_ownedColumns4_link_reassign_clear():
    a = relational_obeo_Table(name="sample_text")
    b1 = relational_obeo_Column(isPrimaryKey=True, isUnique=True, name="sample_text", type="sample_text")
    b2 = relational_obeo_Column(isPrimaryKey=False, isUnique=False, name="sample_text_2", type="sample_text_2")
...
def test_assoc_ownedSchemas0_link_reassign_clear():
    a = relational_obeo_Schema(name="sample_text")
    b1 = relational_obeo_Database(name="sample_text", url="sample_text")
    b2 = relational_obeo_Database(name="sample_text_2", url="sample_text_2")
...
def test_assoc_ownedTables1_link_reassign_clear():
    a = relational_obeo_Table(name="sample_text")
    b1 = relational_obeo_Schema(name="sample_text")
    b2 = relational_obeo_Schema(name="sample_text_2")
...
def test_assoc_sourceTable11_link_reassign_clear():
    ...
    b1 = relational_obeo_ForeignKey(name="sample_text")
    b2 = relational_obeo_ForeignKey(name="sample_text_2")
    _safe_set(a, 'relational_obeo_Table', b1)
    assert _is_linked(a, 'relational_obeo_Table', b1)
    if hasattr(b1, 'relational_obeo_ForeignKey'):
        assert _is_linked(b1, 'relational_obeo_ForeignKey', a)
    _safe_set(a, 'relational_obeo_Table', b2)
    assert _is_linked(a, 'relational_obeo_Table', b2)
    if hasattr(b1, 'relational_obeo_ForeignKey'):
        assert not _is_linked(b1, 'relational_obeo_ForeignKey', a)
    if hasattr(b2, 'relational_obeo_ForeignKey'):
        assert _is_linked(b2, 'relational_obeo_ForeignKey', a)
    _safe_set(a, 'relational_obeo_Table', None)
    assert not _is_linked(a, 'relational_obeo_Table', b2)
    if hasattr(b2, 'relational_obeo_ForeignKey'):
        assert not _is_linked(b2, 'relational_obeo_ForeignKey', a)
...
relational_obeo_Column_strategy = st.builds(relational_obeo_Column, isPrimaryKey=st.booleans(), isUnique=st.booleans(), name=safe_text, type=safe_text)
@given(instance=relational_obeo_Column_strategy)
@settings(max_examples=25)
...
relational_obeo_Database_strategy = st.builds(relational_obeo_Database, name=safe_text, url=safe_text)
@given(instance=relational_obeo_Database_strategy)
@settings(max_examples=25)
...
relational_obeo_ForeignKey_strategy = st.builds(relational_obeo_ForeignKey, name=safe_text)
@given(instance=relational_obeo_ForeignKey_strategy)
@settings(max_examples=25)
...
relational_obeo_ModelElement_strategy = st.builds(relational_obeo_ModelElement, comment=safe_text)
@given(instance=relational_obeo_ModelElement_strategy)
@settings(max_examples=25)
...
relational_obeo_Schema_strategy = st.builds(relational_obeo_Schema, name=safe_text)
@given(instance=relational_obeo_Schema_strategy)
@settings(max_examples=25)
...
relational_obeo_Table_strategy = st.builds(relational_obeo_Table, name=safe_text)
@given(instance=relational_obeo_Table_strategy)
@settings(max_examples=25)
