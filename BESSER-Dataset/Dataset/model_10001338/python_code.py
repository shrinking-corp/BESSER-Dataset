...
class A1:
    ...
    def __init__(self, attA: str, b4: set["B1"] = None, class77: "R" = None):
        self.attA = attA
        self.b4 = b4 if b4 is not None else set()
        self.class77 = class77
    ...
    @property
    def class77(self):
        return self.__class77
    @class77.setter
    def class77(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_A1__class77", None)
        self.__class77 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "class36"):
                opp_val = getattr(old_value, "class36", None)
                if isinstance(opp_val, set):
                    opp_val.discard(self)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "class36"):
                opp_val = getattr(value, "class36", None)
                if opp_val is None:
                    setattr(value, "class36", set([self]))
                elif isinstance(opp_val, set):
                    opp_val.add(self)
...
class B1:
    ...
    def __init__(self, attB: str, a5: "A1" = None, c8: set["C1"] = None):
        self.attB = attB
        self.a5 = a5
...
class C:
    ...
    def __init__(self, attC: str, b3: "B" = None):
        self.attC = attC
        self.b3 = b3
