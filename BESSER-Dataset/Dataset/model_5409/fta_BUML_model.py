...
# Classes
fta_Diagram = Class(name="fta_Diagram", is_abstract=True)
fta_Hazard = Class(name="fta_Hazard")
Diagram = Class(name="Diagram")
fta_Condition = Class(name="fta_Condition")
fta_Event = Class(name="fta_Event")
fta_FTA = Class(name="fta_FTA")
...
fta_Diagram.attributes={fta_Diagram_id, fta_Diagram_detail, fta_Diagram_name}
...
domain_model = DomainModel(
    name="fta",
    types={fta_Diagram, fta_Hazard, Diagram, fta_Condition, fta_Event, fta_FTA, GateType},
