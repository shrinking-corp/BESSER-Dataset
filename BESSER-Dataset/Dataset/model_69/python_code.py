...
class java_Model:
    ...
    def __init__(self, name: str, model: set["java_Package"] = None, java_Model: set["java_Type"] = None, java_Model239: set["java_UnresolvedItem"] = None, Model: "java_Package" = None, java_Model241: set["java_CompilationUnit"] = None, java_Model244: set["java_ClassFile"] = None, java_Model247: set["java_Archive"] = None):
        self.name = name
...
class java_MethodRefParameter(ASTNode):
    ...
    def __init__(self, varargs: bool, name: str, java_MethodRefParameter233: "java_TypeAccess" = None, java_MethodRefParameter: "java_MethodRef" = None):
...
class java_NamedElement(ASTNode):
    ...
    def __init__(self, name: str, proxy: bool, java_NamedElement: "java_MemberRef" = None, importedElement: set["java_ImportDeclaration"] = None, NamedElement: "java_ImportDeclaration" = None):
        self.name = name
        self.proxy = proxy
...
class java_ImportDeclaration(ASTNode):
    ...
    def __init__(self, static: bool, java_ImportDeclaration: "java_CompilationUnit" = None, ImportDeclaration: "java_NamedElement" = None, usagesInImports: "java_NamedElement" = None):
        self.static = static
...
class java_SingleVariableDeclaration(VariableDeclaration):
    ...
    def __init__(self, varargs: bool, SingleVariableDeclaration: "java_AbstractMethodDeclaration" = None, SingleVariableDeclaration152: "java_EnhancedForStatement" = None, SingleVariableDeclaration100: "java_CatchClause" = None, SingleVariableDeclaration253: "java_Modifier" = None, java_SingleVariableDeclaration298: set["java_Annotation"] = None, parameters: "java_AbstractMethodDeclaration" = None, exception: "java_CatchClause" = None, singleVariableDeclaration: "java_Modifier" = None, java_SingleVariableDeclaration: "java_TypeAccess" = None, parameter: "java_EnhancedForStatement" = None):
        self.varargs = varargs
