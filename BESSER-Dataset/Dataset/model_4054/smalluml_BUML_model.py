...
smalluml_ClassDiagram = Class(name="smalluml_ClassDiagram")
smalluml_Entity = Class(name="smalluml_Entity")
smalluml_Type = Class(name="smalluml_Type")
smalluml_Parameter = Class(name="smalluml_Parameter")
smalluml_Cardinalities = Class(name="smalluml_Cardinalities")
...
smalluml_BooleanType = Class(name="smalluml_BooleanType")
Type = Class(name="Type")
smalluml_RealType = Class(name="smalluml_RealType")
smalluml_IntegerType = Class(name="smalluml_IntegerType")
...
domain_model = DomainModel(
    name="smalluml",
    types={smalluml_Operation, smalluml_ClassDiagram, smalluml_Entity, smalluml_Type, smalluml_Parameter, smalluml_Cardinalities, smalluml_Association, smalluml_Class, Entity, smalluml_Attribute, smalluml_Enumeration, smalluml_BooleanType, Type, smalluml_RealType, smalluml_IntegerType},
    ...
    generalizations={gen_smalluml_Association_Entity, gen_smalluml_Class_Entity, gen_smalluml_Enumeration_Type, gen_smalluml_BooleanType_Type, gen_smalluml_RealType_Type, gen_smalluml_IntegerType_Type},
    metadata=None
)
