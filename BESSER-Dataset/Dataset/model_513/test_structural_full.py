...
def test_assoc_families10_link_reassign_clear():
    ...
    _safe_set(a, 'Families_Family11', None)
...
def test_assoc_guardian7_link_reassign_clear():
    ...
    b1 = Families_Family(address="sample_text", lastName="sample_text")
    b2 = Families_Family(address="sample_text_2", lastName="sample_text_2")
    _safe_set(a, 'Families_Member8', b1)
    assert _is_linked(a, 'Families_Member8', b1)
    if hasattr(b1, 'Families_Family9'):
        assert _is_linked(b1, 'Families_Family9', a)
    _safe_set(a, 'Families_Member8', b2)
    assert _is_linked(a, 'Families_Member8', b2)
    if hasattr(b1, 'Families_Family9'):
        assert not _is_linked(b1, 'Families_Family9', a)
    if hasattr(b2, 'Families_Family9'):
        assert _is_linked(b2, 'Families_Family9', a)
    _safe_set(a, 'Families_Member8', None)
    assert not _is_linked(a, 'Families_Member8', b2)
    if hasattr(b2, 'Families_Family9'):
        assert not _is_linked(b2, 'Families_Family9', a)
