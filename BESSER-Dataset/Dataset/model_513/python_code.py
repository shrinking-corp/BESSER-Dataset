...
class Families_Member:
    ...
    def __init__(self, firstName: str, age: int, Families_Member6: "Families_Family" = None, Families_Member8: "Families_Family" = None, Families_Member: "Families_Family" = None, Families_Member3: "Families_Family" = None):
...
class Families_Family:
    ...
    def __init__(self, address: str, lastName: str, Families_Family5: "Families_Member" = None, Families_Family9: "Families_Member" = None, Families_Family11: "Families_FamilyRegistry" = None, Families_Family: set["Families_Member"] = None, Families_Family2: "Families_Member" = None):
