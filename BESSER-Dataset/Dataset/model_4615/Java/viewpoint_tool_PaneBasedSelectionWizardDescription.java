...
public class viewpoint_tool_PaneBasedSelectionWizardDescription extends AbstractToolDescription {
    ...
    public viewpoint_tool_PaneBasedSelectionWizardDescription(
        String rootExpression,        String preSelectedCandidatesExpression,        String childrenExpression,        String selectedValuesMessage,        String message,        String choiceOfValuesMessage,        String windowTitle,        String windowImagePath,        boolean tree,        String candidatesExpression,        String iconPath    ) {
        super(
        );
