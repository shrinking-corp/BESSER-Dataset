...
@given(instance=viewpoint_description_DecorationDescription_strategy)
def test_hyp_viewpoint_description_decorationdescription_decoratorPath_setter(instance):
...
def test_viewpoint_UIState_inverseSelectionOrder_value_roundtrip():
    instance = viewpoint_UIState(inverseSelectionOrder=True)
...
def test_assoc_activatedViewpoints45_link_reassign_clear():
    ...
    if hasattr(b1, 'Viewpoint46'):
        assert _is_linked(b1, 'Viewpoint46', a)
    _safe_set(a, 'viewpoint_DAnalysisSessionEObject', {b2})
    assert _is_linked(a, 'viewpoint_DAnalysisSessionEObject', b2)
    if hasattr(b1, 'Viewpoint46'):
        assert not _is_linked(b1, 'Viewpoint46', a)
    if hasattr(b2, 'Viewpoint46'):
        assert _is_linked(b2, 'Viewpoint46', a)
    _safe_set(a, 'viewpoint_DAnalysisSessionEObject', set())
    assert not _is_linked(a, 'viewpoint_DAnalysisSessionEObject', b2)
    if hasattr(b2, 'Viewpoint46'):
        assert not _is_linked(b2, 'Viewpoint46', a)


def test_assoc_allRules208_link_reassign_clear():
    a = viewpoint_validation_ValidationSet(name="sample_text")
    b1 = validation_ValidationRule()
    b2 = validation_ValidationRule()
    _safe_set(a, 'viewpoint_validation_ValidationSet209', {b1})
    assert _is_linked(a, 'viewpoint_validation_ValidationSet209', b1)
    if hasattr(b1, 'validation_ValidationRule210'):
        assert _is_linked(b1, 'validation_ValidationRule210', a)
    _safe_set(a, 'viewpoint_validation_ValidationSet209', {b2})
    assert _is_linked(a, 'viewpoint_validation_ValidationSet209', b2)
    if hasattr(b1, 'validation_ValidationRule210'):
        assert not _is_linked(b1, 'validation_ValidationRule210', a)
    if hasattr(b2, 'validation_ValidationRule210'):
        assert _is_linked(b2, 'validation_ValidationRule210', a)
    _safe_set(a, 'viewpoint_validation_ValidationSet209', set())
    assert not _is_linked(a, 'viewpoint_validation_ValidationSet209', b2)
    if hasattr(b2, 'validation_ValidationRule210'):
        assert not _is_linked(b2, 'validation_ValidationRule210', a)


def test_assoc_analyses47_link_reassign_clear():
    a = viewpoint_DAnalysisSessionEObject(controlledResources="sample_text", open=True, resources="sample_text", synchronizationStatus="sample_text")
    ...
    _safe_set(a, 'viewpoint_DAnalysisSessionEObject48', {b1})
    assert _is_linked(a, 'viewpoint_DAnalysisSessionEObject48', b1)
    if hasattr(b1, 'viewpoint_DAnalysis49'):
        assert _is_linked(b1, 'viewpoint_DAnalysis49', a)
    _safe_set(a, 'viewpoint_DAnalysisSessionEObject48', {b2})
    assert _is_linked(a, 'viewpoint_DAnalysisSessionEObject48', b2)
    if hasattr(b1, 'viewpoint_DAnalysis49'):
        assert not _is_linked(b1, 'viewpoint_DAnalysis49', a)
    if hasattr(b2, 'viewpoint_DAnalysis49'):
        assert _is_linked(b2, 'viewpoint_DAnalysis49', a)
    _safe_set(a, 'viewpoint_DAnalysisSessionEObject48', set())
    assert not _is_linked(a, 'viewpoint_DAnalysisSessionEObject48', b2)
    if hasattr(b2, 'viewpoint_DAnalysis49'):
        assert not _is_linked(b2, 'viewpoint_DAnalysis49', a)


def test_assoc_appliedOn99_link_reassign_clear():
    ...
    if hasattr(b1, 'description_viewpoint_EObject100'):
        assert _is_linked(b1, 'description_viewpoint_EObject100', a)
    ...
    if hasattr(b1, 'description_viewpoint_EObject100'):
        assert not _is_linked(b1, 'description_viewpoint_EObject100', a)
    if hasattr(b2, 'description_viewpoint_EObject100'):
        assert _is_linked(b2, 'description_viewpoint_EObject100', a)
    ...
    if hasattr(b2, 'description_viewpoint_EObject100'):
        assert not _is_linked(b2, 'description_viewpoint_EObject100', a)


def test_assoc_associatedColor104_link_reassign_clear():
...
def test_assoc_audits211_link_reassign_clear():
...
def test_assoc_colorSteps103_link_reassign_clear():
...
def test_assoc_container124_link_reassign_clear():
...
def test_assoc_container140_link_reassign_clear():
    ...
    _safe_set(a, 'viewpoint_tool_SelectionWizardDescription141', b1)
    assert _is_linked(a, 'viewpoint_tool_SelectionWizardDescription141', b1)
    if hasattr(b1, 'tool_SelectContainerVariable'):
        assert _is_linked(b1, 'tool_SelectContainerVariable', a)
    _safe_set(a, 'viewpoint_tool_SelectionWizardDescription141', b2)
    assert _is_linked(a, 'viewpoint_tool_SelectionWizardDescription141', b2)
    if hasattr(b1, 'tool_SelectContainerVariable'):
    ...
    _safe_set(a, 'viewpoint_tool_SelectionWizardDescription141', None)
    assert not _is_linked(a, 'viewpoint_tool_SelectionWizardDescription141', b2)
    if hasattr(b2, 'tool_SelectContainerVariable'):
        assert not _is_linked(b2, 'tool_SelectContainerVariable', a)


def test_assoc_container150_link_reassign_clear():
    a = viewpoint_tool_PaneBasedSelectionWizardDescription(candidatesExpression="sample_text", childrenExpression="sample_text", choiceOfValuesMessage="sample_text", iconPath="sample_text", message="sample_text", preSelectedCandidatesExpression="sample_text", rootExpression="sample_text", selectedValuesMessage="sample_text", tree=True, windowImagePath="sample_text", windowTitle="sample_text")
    b1 = tool_SelectContainerVariable()
    b2 = tool_SelectContainerVariable()
    _safe_set(a, 'viewpoint_tool_PaneBasedSelectionWizardDescription151', b1)
    assert _is_linked(a, 'viewpoint_tool_PaneBasedSelectionWizardDescription151', b1)
    if hasattr(b1, 'tool_SelectContainerVariable152'):
        assert _is_linked(b1, 'tool_SelectContainerVariable152', a)
    _safe_set(a, 'viewpoint_tool_PaneBasedSelectionWizardDescription151', b2)
    assert _is_linked(a, 'viewpoint_tool_PaneBasedSelectionWizardDescription151', b2)
    if hasattr(b1, 'tool_SelectContainerVariable152'):
        assert not _is_linked(b1, 'tool_SelectContainerVariable152', a)
    if hasattr(b2, 'tool_SelectContainerVariable152'):
        assert _is_linked(b2, 'tool_SelectContainerVariable152', a)
    _safe_set(a, 'viewpoint_tool_PaneBasedSelectionWizardDescription151', None)
    assert not _is_linked(a, 'viewpoint_tool_PaneBasedSelectionWizardDescription151', b2)
    if hasattr(b2, 'tool_SelectContainerVariable152'):
        assert not _is_linked(b2, 'tool_SelectContainerVariable152', a)


def test_assoc_containerVariable171_link_reassign_clear():
    ...
    _safe_set(a, 'viewpoint_tool_RepresentationNavigationDescription172', b1)
    assert _is_linked(a, 'viewpoint_tool_RepresentationNavigationDescription172', b1)
    if hasattr(b1, 'tool_ElementSelectVariable173'):
        assert _is_linked(b1, 'tool_ElementSelectVariable173', a)
    _safe_set(a, 'viewpoint_tool_RepresentationNavigationDescription172', b2)
    assert _is_linked(a, 'viewpoint_tool_RepresentationNavigationDescription172', b2)
    if hasattr(b1, 'tool_ElementSelectVariable173'):
        assert not _is_linked(b1, 'tool_ElementSelectVariable173', a)
    if hasattr(b2, 'tool_ElementSelectVariable173'):
        assert _is_linked(b2, 'tool_ElementSelectVariable173', a)
    _safe_set(a, 'viewpoint_tool_RepresentationNavigationDescription172', None)
    assert not _is_linked(a, 'viewpoint_tool_RepresentationNavigationDescription172', b2)
    if hasattr(b2, 'tool_ElementSelectVariable173'):
        assert not _is_linked(b2, 'tool_ElementSelectVariable173', a)


def test_assoc_containerView125_link_reassign_clear():
    a = viewpoint_tool_PasteDescription()
    b1 = tool_ContainerViewVariable()
    b2 = tool_ContainerViewVariable()
    _safe_set(a, 'viewpoint_tool_PasteDescription126', b1)
    assert _is_linked(a, 'viewpoint_tool_PasteDescription126', b1)
    if hasattr(b1, 'tool_ContainerViewVariable'):
        assert _is_linked(b1, 'tool_ContainerViewVariable', a)
    _safe_set(a, 'viewpoint_tool_PasteDescription126', b2)
    assert _is_linked(a, 'viewpoint_tool_PasteDescription126', b2)
    if hasattr(b1, 'tool_ContainerViewVariable'):
    ...
    _safe_set(a, 'viewpoint_tool_PasteDescription126', None)
    assert not _is_linked(a, 'viewpoint_tool_PasteDescription126', b2)
    if hasattr(b2, 'tool_ContainerViewVariable'):
        assert not _is_linked(b2, 'tool_ContainerViewVariable', a)


def test_assoc_containerView137_link_reassign_clear():
    a = viewpoint_tool_SelectionWizardDescription(iconPath="sample_text", windowImagePath="sample_text", windowTitle="sample_text")
    b1 = tool_ContainerViewVariable()
    b2 = tool_ContainerViewVariable()
    _safe_set(a, 'viewpoint_tool_SelectionWizardDescription138', b1)
    assert _is_linked(a, 'viewpoint_tool_SelectionWizardDescription138', b1)
    if hasattr(b1, 'tool_ContainerViewVariable139'):
        assert _is_linked(b1, 'tool_ContainerViewVariable139', a)
    _safe_set(a, 'viewpoint_tool_SelectionWizardDescription138', b2)
    assert _is_linked(a, 'viewpoint_tool_SelectionWizardDescription138', b2)
    if hasattr(b1, 'tool_ContainerViewVariable139'):
        assert not _is_linked(b1, 'tool_ContainerViewVariable139', a)
    if hasattr(b2, 'tool_ContainerViewVariable139'):
        assert _is_linked(b2, 'tool_ContainerViewVariable139', a)
    _safe_set(a, 'viewpoint_tool_SelectionWizardDescription138', None)
    assert not _is_linked(a, 'viewpoint_tool_SelectionWizardDescription138', b2)
    if hasattr(b2, 'tool_ContainerViewVariable139'):
        assert not _is_linked(b2, 'tool_ContainerViewVariable139', a)


def test_assoc_containerView147_link_reassign_clear():
    a = viewpoint_tool_PaneBasedSelectionWizardDescription(candidatesExpression="sample_text", childrenExpression="sample_text", choiceOfValuesMessage="sample_text", iconPath="sample_text", message="sample_text", preSelectedCandidatesExpression="sample_text", rootExpression="sample_text", selectedValuesMessage="sample_text", tree=True, windowImagePath="sample_text", windowTitle="sample_text")
    b1 = tool_ContainerViewVariable()
    b2 = tool_ContainerViewVariable()
    _safe_set(a, 'viewpoint_tool_PaneBasedSelectionWizardDescription148', b1)
    assert _is_linked(a, 'viewpoint_tool_PaneBasedSelectionWizardDescription148', b1)
    if hasattr(b1, 'tool_ContainerViewVariable149'):
        assert _is_linked(b1, 'tool_ContainerViewVariable149', a)
    _safe_set(a, 'viewpoint_tool_PaneBasedSelectionWizardDescription148', b2)
    assert _is_linked(a, 'viewpoint_tool_PaneBasedSelectionWizardDescription148', b2)
    if hasattr(b1, 'tool_ContainerViewVariable149'):
        assert not _is_linked(b1, 'tool_ContainerViewVariable149', a)
    if hasattr(b2, 'tool_ContainerViewVariable149'):
        assert _is_linked(b2, 'tool_ContainerViewVariable149', a)
    _safe_set(a, 'viewpoint_tool_PaneBasedSelectionWizardDescription148', None)
    assert not _is_linked(a, 'viewpoint_tool_PaneBasedSelectionWizardDescription148', b2)
    if hasattr(b2, 'tool_ContainerViewVariable149'):
        assert not _is_linked(b2, 'tool_ContainerViewVariable149', a)


def test_assoc_containerViewVariable161_link_reassign_clear():
    a = viewpoint_tool_RepresentationCreationDescription(browseExpression="sample_text", titleExpression="sample_text")
    b1 = tool_ContainerViewVariable()
    b2 = tool_ContainerViewVariable()
    _safe_set(a, 'viewpoint_tool_RepresentationCreationDescription162', b1)
    assert _is_linked(a, 'viewpoint_tool_RepresentationCreationDescription162', b1)
    if hasattr(b1, 'tool_ContainerViewVariable163'):
        assert _is_linked(b1, 'tool_ContainerViewVariable163', a)
    _safe_set(a, 'viewpoint_tool_RepresentationCreationDescription162', b2)
    assert _is_linked(a, 'viewpoint_tool_RepresentationCreationDescription162', b2)
    if hasattr(b1, 'tool_ContainerViewVariable163'):
        assert not _is_linked(b1, 'tool_ContainerViewVariable163', a)
    if hasattr(b2, 'tool_ContainerViewVariable163'):
        assert _is_linked(b2, 'tool_ContainerViewVariable163', a)
    _safe_set(a, 'viewpoint_tool_RepresentationCreationDescription162', None)
    assert not _is_linked(a, 'viewpoint_tool_RepresentationCreationDescription162', b2)
    if hasattr(b2, 'tool_ContainerViewVariable163'):
        assert not _is_linked(b2, 'tool_ContainerViewVariable163', a)


def test_assoc_containerViewVariable168_link_reassign_clear():
    a = viewpoint_tool_RepresentationNavigationDescription(browseExpression="sample_text", navigationNameExpression="sample_text")
    b1 = tool_ContainerViewVariable()
    b2 = tool_ContainerViewVariable()
    _safe_set(a, 'viewpoint_tool_RepresentationNavigationDescription169', b1)
    assert _is_linked(a, 'viewpoint_tool_RepresentationNavigationDescription169', b1)
    if hasattr(b1, 'tool_ContainerViewVariable170'):
        assert _is_linked(b1, 'tool_ContainerViewVariable170', a)
    _safe_set(a, 'viewpoint_tool_RepresentationNavigationDescription169', b2)
    assert _is_linked(a, 'viewpoint_tool_RepresentationNavigationDescription169', b2)
    if hasattr(b1, 'tool_ContainerViewVariable170'):
    ...
    _safe_set(a, 'viewpoint_tool_RepresentationNavigationDescription169', None)
    assert not _is_linked(a, 'viewpoint_tool_RepresentationNavigationDescription169', b2)
    if hasattr(b2, 'tool_ContainerViewVariable170'):
        assert not _is_linked(b2, 'tool_ContainerViewVariable170', a)


def test_assoc_copiedElement130_link_reassign_clear():
    a = viewpoint_tool_PasteDescription()
    b1 = tool_ElementVariable()
    b2 = tool_ElementVariable()
    _safe_set(a, 'viewpoint_tool_PasteDescription131', b1)
    assert _is_linked(a, 'viewpoint_tool_PasteDescription131', b1)
    if hasattr(b1, 'tool_ElementVariable132'):
        assert _is_linked(b1, 'tool_ElementVariable132', a)
    _safe_set(a, 'viewpoint_tool_PasteDescription131', b2)
    assert _is_linked(a, 'viewpoint_tool_PasteDescription131', b2)
    if hasattr(b1, 'tool_ElementVariable132'):
        assert not _is_linked(b1, 'tool_ElementVariable132', a)
    if hasattr(b2, 'tool_ElementVariable132'):
        assert _is_linked(b2, 'tool_ElementVariable132', a)
    _safe_set(a, 'viewpoint_tool_PasteDescription131', None)
    assert not _is_linked(a, 'viewpoint_tool_PasteDescription131', b2)
    if hasattr(b2, 'tool_ElementVariable132'):
        assert not _is_linked(b2, 'tool_ElementVariable132', a)


def test_assoc_copiedView127_link_reassign_clear():
    a = viewpoint_tool_PasteDescription()
    ...
    if hasattr(b1, 'tool_ElementViewVariable129'):
        assert _is_linked(b1, 'tool_ElementViewVariable129', a)
    _safe_set(a, 'viewpoint_tool_PasteDescription128', b2)
    assert _is_linked(a, 'viewpoint_tool_PasteDescription128', b2)
    if hasattr(b1, 'tool_ElementViewVariable129'):
        assert not _is_linked(b1, 'tool_ElementViewVariable129', a)
    if hasattr(b2, 'tool_ElementViewVariable129'):
        assert _is_linked(b2, 'tool_ElementViewVariable129', a)
    _safe_set(a, 'viewpoint_tool_PasteDescription128', None)
    assert not _is_linked(a, 'viewpoint_tool_PasteDescription128', b2)
    if hasattr(b2, 'tool_ElementViewVariable129'):
        assert not _is_linked(b2, 'tool_ElementViewVariable129', a)


def test_assoc_data113_link_reassign_clear():
    ...
    if hasattr(b1, 'description_viewpoint_EObject114'):
        assert _is_linked(b1, 'description_viewpoint_EObject114', a)
    _safe_set(a, 'viewpoint_description_AnnotationEntry', b2)
    assert _is_linked(a, 'viewpoint_description_AnnotationEntry', b2)
    if hasattr(b1, 'description_viewpoint_EObject114'):
        assert not _is_linked(b1, 'description_viewpoint_EObject114', a)
    if hasattr(b2, 'description_viewpoint_EObject114'):
        assert _is_linked(b2, 'description_viewpoint_EObject114', a)
    _safe_set(a, 'viewpoint_description_AnnotationEntry', None)
    assert not _is_linked(a, 'viewpoint_description_AnnotationEntry', b2)
    if hasattr(b2, 'description_viewpoint_EObject114'):
        assert not _is_linked(b2, 'description_viewpoint_EObject114', a)


def test_assoc_data42_link_reassign_clear():
    ...
    if hasattr(b1, 'viewpoint_EObject43'):
        assert _is_linked(b1, 'viewpoint_EObject43', a)
    _safe_set(a, 'viewpoint_DAnalysisCustomData', b2)
    assert _is_linked(a, 'viewpoint_DAnalysisCustomData', b2)
    if hasattr(b1, 'viewpoint_EObject43'):
        assert not _is_linked(b1, 'viewpoint_EObject43', a)
    if hasattr(b2, 'viewpoint_EObject43'):
        assert _is_linked(b2, 'viewpoint_EObject43', a)
    _safe_set(a, 'viewpoint_DAnalysisCustomData', None)
    assert not _is_linked(a, 'viewpoint_DAnalysisCustomData', b2)
    if hasattr(b2, 'viewpoint_EObject43'):
        assert not _is_linked(b2, 'viewpoint_EObject43', a)


def test_assoc_details88_link_reassign_clear():
...
def test_assoc_eAnnotations87_link_reassign_clear():
...
def test_assoc_element119_link_reassign_clear():
...
def test_assoc_element136_link_reassign_clear():
    a = viewpoint_tool_SelectionWizardDescription(iconPath="sample_text", windowImagePath="sample_text", windowTitle="sample_text")
    b1 = tool_ElementSelectVariable()
    b2 = tool_ElementSelectVariable()
...
def test_assoc_element145_link_reassign_clear():
    ...
    if hasattr(b1, 'tool_ElementSelectVariable146'):
        assert _is_linked(b1, 'tool_ElementSelectVariable146', a)
    ...
    if hasattr(b1, 'tool_ElementSelectVariable146'):
        assert not _is_linked(b1, 'tool_ElementSelectVariable146', a)
    if hasattr(b2, 'tool_ElementSelectVariable146'):
        assert _is_linked(b2, 'tool_ElementSelectVariable146', a)
    ...
    if hasattr(b2, 'tool_ElementSelectVariable146'):
        assert not _is_linked(b2, 'tool_ElementSelectVariable146', a)


def test_assoc_elementView120_link_reassign_clear():
    a = viewpoint_tool_ToolDescription(iconPath="sample_text")
    b1 = tool_ElementViewVariable()
    b2 = tool_ElementViewVariable()
    _safe_set(a, 'viewpoint_tool_ToolDescription121', b1)
    assert _is_linked(a, 'viewpoint_tool_ToolDescription121', b1)
    if hasattr(b1, 'tool_ElementViewVariable'):
        assert _is_linked(b1, 'tool_ElementViewVariable', a)
    _safe_set(a, 'viewpoint_tool_ToolDescription121', b2)
    assert _is_linked(a, 'viewpoint_tool_ToolDescription121', b2)
    if hasattr(b1, 'tool_ElementViewVariable'):
    ...
    _safe_set(a, 'viewpoint_tool_ToolDescription121', None)
    assert not _is_linked(a, 'viewpoint_tool_ToolDescription121', b2)
    if hasattr(b2, 'tool_ElementViewVariable'):
        assert not _is_linked(b2, 'tool_ElementViewVariable', a)


def test_assoc_elementsToSelect53_link_reassign_clear():
    a = viewpoint_UIState(inverseSelectionOrder=True)
    b1 = viewpoint_EObject()
    b2 = viewpoint_EObject()
    _safe_set(a, 'viewpoint_UIState54', {b1})
    assert _is_linked(a, 'viewpoint_UIState54', b1)
    if hasattr(b1, 'viewpoint_EObject55'):
        assert _is_linked(b1, 'viewpoint_EObject55', a)
    _safe_set(a, 'viewpoint_UIState54', {b2})
    assert _is_linked(a, 'viewpoint_UIState54', b2)
    if hasattr(b1, 'viewpoint_EObject55'):
        assert not _is_linked(b1, 'viewpoint_EObject55', a)
    if hasattr(b2, 'viewpoint_EObject55'):
        assert _is_linked(b2, 'viewpoint_EObject55', a)
    _safe_set(a, 'viewpoint_UIState54', set())
    assert not _is_linked(a, 'viewpoint_UIState54', b2)
    if hasattr(b2, 'viewpoint_EObject55'):
        assert not _is_linked(b2, 'viewpoint_EObject55', a)


def test_assoc_entries112_link_reassign_clear():
...
def test_assoc_extensions62_link_reassign_clear():
    a = viewpoint_description_Group(name="sample_text", version="sample_text")
    b1 = Extension()
    b2 = Extension()
    _safe_set(a, 'viewpoint_description_Group63', {b1})
    assert _is_linked(a, 'viewpoint_description_Group63', b1)
    if hasattr(b1, 'Extension'):
        assert _is_linked(b1, 'Extension', a)
    _safe_set(a, 'viewpoint_description_Group63', {b2})
    assert _is_linked(a, 'viewpoint_description_Group63', b2)
    if hasattr(b1, 'Extension'):
        assert not _is_linked(b1, 'Extension', a)
    if hasattr(b2, 'Extension'):
        assert _is_linked(b2, 'Extension', a)
    _safe_set(a, 'viewpoint_description_Group63', set())
    assert not _is_linked(a, 'viewpoint_description_Group63', b2)
    if hasattr(b2, 'Extension'):
        assert not _is_linked(b2, 'Extension', a)


def test_assoc_featureCustomizations93_link_reassign_clear():
...
def test_assoc_filters118_link_reassign_clear():
...
def test_assoc_fixes212_link_reassign_clear():
    a = viewpoint_validation_ValidationRule(level="sample_text", message="sample_text")
    b1 = validation_ValidationFix()
    b2 = validation_ValidationFix()
    _safe_set(a, 'viewpoint_validation_ValidationRule213', {b1})
    assert _is_linked(a, 'viewpoint_validation_ValidationRule213', b1)
    if hasattr(b1, 'validation_ValidationFix'):
        assert _is_linked(b1, 'validation_ValidationFix', a)
    _safe_set(a, 'viewpoint_validation_ValidationRule213', {b2})
    assert _is_linked(a, 'viewpoint_validation_ValidationRule213', b2)
    if hasattr(b1, 'validation_ValidationFix'):
    ...
    _safe_set(a, 'viewpoint_validation_ValidationRule213', set())
    assert not _is_linked(a, 'viewpoint_validation_ValidationRule213', b2)
    if hasattr(b2, 'validation_ValidationFix'):
        assert not _is_linked(b2, 'validation_ValidationFix', a)


def test_assoc_initialOperation122_link_reassign_clear():
    a = viewpoint_tool_ToolDescription(iconPath="sample_text")
...
def test_assoc_initialOperation133_link_reassign_clear():
    a = viewpoint_tool_PasteDescription()
    b1 = tool_InitialOperation()
    b2 = tool_InitialOperation()
    _safe_set(a, 'viewpoint_tool_PasteDescription134', b1)
    assert _is_linked(a, 'viewpoint_tool_PasteDescription134', b1)
    if hasattr(b1, 'tool_InitialOperation135'):
        assert _is_linked(b1, 'tool_InitialOperation135', a)
    _safe_set(a, 'viewpoint_tool_PasteDescription134', b2)
    assert _is_linked(a, 'viewpoint_tool_PasteDescription134', b2)
    if hasattr(b1, 'tool_InitialOperation135'):
        assert not _is_linked(b1, 'tool_InitialOperation135', a)
    if hasattr(b2, 'tool_InitialOperation135'):
        assert _is_linked(b2, 'tool_InitialOperation135', a)
    _safe_set(a, 'viewpoint_tool_PasteDescription134', None)
    assert not _is_linked(a, 'viewpoint_tool_PasteDescription134', b2)
    if hasattr(b2, 'tool_InitialOperation135'):
        assert not _is_linked(b2, 'tool_InitialOperation135', a)


def test_assoc_initialOperation142_link_reassign_clear():
    a = viewpoint_tool_SelectionWizardDescription(iconPath="sample_text", windowImagePath="sample_text", windowTitle="sample_text")
    b1 = tool_InitialOperation()
    b2 = tool_InitialOperation()
    ...
    if hasattr(b1, 'tool_InitialOperation144'):
        assert _is_linked(b1, 'tool_InitialOperation144', a)
    ...
    if hasattr(b1, 'tool_InitialOperation144'):
        assert not _is_linked(b1, 'tool_InitialOperation144', a)
    if hasattr(b2, 'tool_InitialOperation144'):
        assert _is_linked(b2, 'tool_InitialOperation144', a)
    ...
    if hasattr(b2, 'tool_InitialOperation144'):
        assert not _is_linked(b2, 'tool_InitialOperation144', a)


def test_assoc_initialOperation153_link_reassign_clear():
    a = viewpoint_tool_PaneBasedSelectionWizardDescription(candidatesExpression="sample_text", childrenExpression="sample_text", choiceOfValuesMessage="sample_text", iconPath="sample_text", message="sample_text", preSelectedCandidatesExpression="sample_text", rootExpression="sample_text", selectedValuesMessage="sample_text", tree=True, windowImagePath="sample_text", windowTitle="sample_text")
    b1 = tool_InitialOperation()
    b2 = tool_InitialOperation()
    _safe_set(a, 'viewpoint_tool_PaneBasedSelectionWizardDescription154', b1)
    assert _is_linked(a, 'viewpoint_tool_PaneBasedSelectionWizardDescription154', b1)
    if hasattr(b1, 'tool_InitialOperation155'):
        assert _is_linked(b1, 'tool_InitialOperation155', a)
    _safe_set(a, 'viewpoint_tool_PaneBasedSelectionWizardDescription154', b2)
    assert _is_linked(a, 'viewpoint_tool_PaneBasedSelectionWizardDescription154', b2)
    if hasattr(b1, 'tool_InitialOperation155'):
        assert not _is_linked(b1, 'tool_InitialOperation155', a)
    if hasattr(b2, 'tool_InitialOperation155'):
        assert _is_linked(b2, 'tool_InitialOperation155', a)
    _safe_set(a, 'viewpoint_tool_PaneBasedSelectionWizardDescription154', None)
    assert not _is_linked(a, 'viewpoint_tool_PaneBasedSelectionWizardDescription154', b2)
    if hasattr(b2, 'tool_InitialOperation155'):
        assert not _is_linked(b2, 'tool_InitialOperation155', a)


def test_assoc_initialOperation158_link_reassign_clear():
    a = viewpoint_tool_RepresentationCreationDescription(browseExpression="sample_text", titleExpression="sample_text")
    b1 = tool_InitialOperation()
    b2 = tool_InitialOperation()
    _safe_set(a, 'viewpoint_tool_RepresentationCreationDescription159', b1)
    assert _is_linked(a, 'viewpoint_tool_RepresentationCreationDescription159', b1)
    if hasattr(b1, 'tool_InitialOperation160'):
        assert _is_linked(b1, 'tool_InitialOperation160', a)
    _safe_set(a, 'viewpoint_tool_RepresentationCreationDescription159', b2)
    assert _is_linked(a, 'viewpoint_tool_RepresentationCreationDescription159', b2)
    if hasattr(b1, 'tool_InitialOperation160'):
        assert not _is_linked(b1, 'tool_InitialOperation160', a)
    if hasattr(b2, 'tool_InitialOperation160'):
        assert _is_linked(b2, 'tool_InitialOperation160', a)
    _safe_set(a, 'viewpoint_tool_RepresentationCreationDescription159', None)
    assert not _is_linked(a, 'viewpoint_tool_RepresentationCreationDescription159', b2)
    if hasattr(b2, 'tool_InitialOperation160'):
        assert not _is_linked(b2, 'tool_InitialOperation160', a)


def test_assoc_initialOperation215_link_reassign_clear():
    ...
    if hasattr(b1, 'tool_InitialOperation216'):
        assert _is_linked(b1, 'tool_InitialOperation216', a)
    _safe_set(a, 'viewpoint_validation_ValidationFix', b2)
    assert _is_linked(a, 'viewpoint_validation_ValidationFix', b2)
    if hasattr(b1, 'tool_InitialOperation216'):
        assert not _is_linked(b1, 'tool_InitialOperation216', a)
    if hasattr(b2, 'tool_InitialOperation216'):
        assert _is_linked(b2, 'tool_InitialOperation216', a)
    _safe_set(a, 'viewpoint_validation_ValidationFix', None)
    assert not _is_linked(a, 'viewpoint_validation_ValidationFix', b2)
    if hasattr(b2, 'tool_InitialOperation216'):
        assert not _is_linked(b2, 'tool_InitialOperation216', a)


def test_assoc_labelColor116_link_reassign_clear():
...
def test_assoc_listeners198_link_reassign_clear():
...
def test_assoc_members52_link_reassign_clear():
...
def test_assoc_metamodel78_link_reassign_clear():
...
def test_assoc_metamodel81_link_reassign_clear():
    ...
    if hasattr(b1, 'description_viewpoint_EPackage82'):
        assert _is_linked(b1, 'description_viewpoint_EPackage82', a)
    ...
    if hasattr(b1, 'description_viewpoint_EPackage82'):
        assert not _is_linked(b1, 'description_viewpoint_EPackage82', a)
    if hasattr(b2, 'description_viewpoint_EPackage82'):
        assert _is_linked(b2, 'description_viewpoint_EPackage82', a)
    ...
    if hasattr(b2, 'description_viewpoint_EPackage82'):
        assert not _is_linked(b2, 'description_viewpoint_EPackage82', a)
...
def test_assoc_ownedAnnotationEntries21_link_reassign_clear():
    a = viewpoint_DRepresentation(name="sample_text")
    b1 = AnnotationEntry()
    b2 = AnnotationEntry()
    _safe_set(a, 'viewpoint_DRepresentation22', {b1})
    assert _is_linked(a, 'viewpoint_DRepresentation22', b1)
    if hasattr(b1, 'AnnotationEntry'):
        assert _is_linked(b1, 'AnnotationEntry', a)
    _safe_set(a, 'viewpoint_DRepresentation22', {b2})
    assert _is_linked(a, 'viewpoint_DRepresentation22', b2)
    if hasattr(b1, 'AnnotationEntry'):
        assert not _is_linked(b1, 'AnnotationEntry', a)
    if hasattr(b2, 'AnnotationEntry'):
        assert _is_linked(b2, 'AnnotationEntry', a)
    _safe_set(a, 'viewpoint_DRepresentation22', set())
    assert not _is_linked(a, 'viewpoint_DRepresentation22', b2)
    if hasattr(b2, 'AnnotationEntry'):
...
def test_assoc_ownedFeatureExtensions73_link_reassign_clear():
    ...
    _safe_set(a, 'viewpoint_description_Viewpoint74', {b1})
    assert _is_linked(a, 'viewpoint_description_Viewpoint74', b1)
    if hasattr(b1, 'FeatureExtensionDescription75'):
        assert _is_linked(b1, 'FeatureExtensionDescription75', a)
    _safe_set(a, 'viewpoint_description_Viewpoint74', {b2})
    assert _is_linked(a, 'viewpoint_description_Viewpoint74', b2)
    if hasattr(b1, 'FeatureExtensionDescription75'):
        assert not _is_linked(b1, 'FeatureExtensionDescription75', a)
    if hasattr(b2, 'FeatureExtensionDescription75'):
        assert _is_linked(b2, 'FeatureExtensionDescription75', a)
    _safe_set(a, 'viewpoint_description_Viewpoint74', set())
    assert not _is_linked(a, 'viewpoint_description_Viewpoint74', b2)
    if hasattr(b2, 'FeatureExtensionDescription75'):
        assert not _is_linked(b2, 'FeatureExtensionDescription75', a)


def test_assoc_ownedJavaExtensions69_link_reassign_clear():
    a = viewpoint_description_Viewpoint(conflicts="sample_text", customizes="sample_text", icon="sample_text", modelFileExtension="sample_text", reuses="sample_text")
    b1 = JavaExtension()
    b2 = JavaExtension()
    _safe_set(a, 'viewpoint_description_Viewpoint70', {b1})
    assert _is_linked(a, 'viewpoint_description_Viewpoint70', b1)
    if hasattr(b1, 'JavaExtension'):
        assert _is_linked(b1, 'JavaExtension', a)
    _safe_set(a, 'viewpoint_description_Viewpoint70', {b2})
    assert _is_linked(a, 'viewpoint_description_Viewpoint70', b2)
    if hasattr(b1, 'JavaExtension'):
        assert not _is_linked(b1, 'JavaExtension', a)
    if hasattr(b2, 'JavaExtension'):
        assert _is_linked(b2, 'JavaExtension', a)
    _safe_set(a, 'viewpoint_description_Viewpoint70', set())
    assert not _is_linked(a, 'viewpoint_description_Viewpoint70', b2)
    if hasattr(b2, 'JavaExtension'):
        assert not _is_linked(b2, 'JavaExtension', a)


def test_assoc_ownedMMExtensions71_link_reassign_clear():
    a = viewpoint_description_Viewpoint(conflicts="sample_text", customizes="sample_text", icon="sample_text", modelFileExtension="sample_text", reuses="sample_text")
    b1 = MetamodelExtensionSetting()
    b2 = MetamodelExtensionSetting()
    _safe_set(a, 'viewpoint_description_Viewpoint72', {b1})
    assert _is_linked(a, 'viewpoint_description_Viewpoint72', b1)
    if hasattr(b1, 'MetamodelExtensionSetting'):
        assert _is_linked(b1, 'MetamodelExtensionSetting', a)
    _safe_set(a, 'viewpoint_description_Viewpoint72', {b2})
    assert _is_linked(a, 'viewpoint_description_Viewpoint72', b2)
    if hasattr(b1, 'MetamodelExtensionSetting'):
    ...
    _safe_set(a, 'viewpoint_description_Viewpoint72', set())
    assert not _is_linked(a, 'viewpoint_description_Viewpoint72', b2)
    if hasattr(b2, 'MetamodelExtensionSetting'):
        assert not _is_linked(b2, 'MetamodelExtensionSetting', a)


def test_assoc_ownedRepresentationElements17_link_reassign_clear():
...
def test_assoc_ownedRepresentationExtensions67_link_reassign_clear():
    a = viewpoint_description_Viewpoint(conflicts="sample_text", customizes="sample_text", icon="sample_text", modelFileExtension="sample_text", reuses="sample_text")
    b1 = RepresentationExtensionDescription()
    b2 = RepresentationExtensionDescription()
    _safe_set(a, 'viewpoint_description_Viewpoint68', {b1})
    assert _is_linked(a, 'viewpoint_description_Viewpoint68', b1)
    if hasattr(b1, 'RepresentationExtensionDescription'):
        assert _is_linked(b1, 'RepresentationExtensionDescription', a)
    _safe_set(a, 'viewpoint_description_Viewpoint68', {b2})
    assert _is_linked(a, 'viewpoint_description_Viewpoint68', b2)
    if hasattr(b1, 'RepresentationExtensionDescription'):
    ...
    _safe_set(a, 'viewpoint_description_Viewpoint68', set())
    assert not _is_linked(a, 'viewpoint_description_Viewpoint68', b2)
    if hasattr(b2, 'RepresentationExtensionDescription'):
        assert not _is_linked(b2, 'RepresentationExtensionDescription', a)


def test_assoc_ownedRepresentations30_link_reassign_clear():
    a = viewpoint_DRepresentation(name="sample_text")
    b1 = viewpoint_DView()
    b2 = viewpoint_DView()
    _safe_set(a, 'viewpoint_DRepresentation32', b1)
    assert _is_linked(a, 'viewpoint_DRepresentation32', b1)
    if hasattr(b1, 'viewpoint_DView31'):
        assert _is_linked(b1, 'viewpoint_DView31', a)
    _safe_set(a, 'viewpoint_DRepresentation32', b2)
    assert _is_linked(a, 'viewpoint_DRepresentation32', b2)
    if hasattr(b1, 'viewpoint_DView31'):
        assert not _is_linked(b1, 'viewpoint_DView31', a)
    if hasattr(b2, 'viewpoint_DView31'):
        assert _is_linked(b2, 'viewpoint_DView31', a)
    _safe_set(a, 'viewpoint_DRepresentation32', None)
    assert not _is_linked(a, 'viewpoint_DRepresentation32', b2)
    if hasattr(b2, 'viewpoint_DView31'):
        assert not _is_linked(b2, 'viewpoint_DView31', a)


def test_assoc_ownedRepresentations65_link_reassign_clear():
    a = viewpoint_description_Viewpoint(conflicts="sample_text", customizes="sample_text", icon="sample_text", modelFileExtension="sample_text", reuses="sample_text")
    b1 = RepresentationDescription()
    b2 = RepresentationDescription()
    _safe_set(a, 'viewpoint_description_Viewpoint66', {b1})
    assert _is_linked(a, 'viewpoint_description_Viewpoint66', b1)
    if hasattr(b1, 'RepresentationDescription'):
        assert _is_linked(b1, 'RepresentationDescription', a)
    _safe_set(a, 'viewpoint_description_Viewpoint66', {b2})
    assert _is_linked(a, 'viewpoint_description_Viewpoint66', b2)
    if hasattr(b1, 'RepresentationDescription'):
    ...
    _safe_set(a, 'viewpoint_description_Viewpoint66', set())
    assert not _is_linked(a, 'viewpoint_description_Viewpoint66', b2)
    if hasattr(b2, 'RepresentationDescription'):
        assert not _is_linked(b2, 'RepresentationDescription', a)


def test_assoc_ownedRepresentations79_link_reassign_clear():
    ...
    if hasattr(b1, 'RepresentationDescription80'):
        assert _is_linked(b1, 'RepresentationDescription80', a)
    ...
    if hasattr(b1, 'RepresentationDescription80'):
        assert not _is_linked(b1, 'RepresentationDescription80', a)
    if hasattr(b2, 'RepresentationDescription80'):
        assert _is_linked(b2, 'RepresentationDescription80', a)
    ...
    if hasattr(b2, 'RepresentationDescription80'):
        assert not _is_linked(b2, 'RepresentationDescription80', a)


def test_assoc_ownedRules204_link_reassign_clear():
    a = viewpoint_validation_ValidationSet(name="sample_text")
    b1 = validation_ValidationRule()
    b2 = validation_ValidationRule()
...
def test_assoc_ownedSessions50_link_reassign_clear():
    a = viewpoint_DAnalysisSessionEObject(controlledResources="sample_text", open=True, resources="sample_text", synchronizationStatus="sample_text")
    b1 = viewpoint_SessionManagerEObject()
    b2 = viewpoint_SessionManagerEObject()
    _safe_set(a, 'viewpoint_DAnalysisSessionEObject51', b1)
    assert _is_linked(a, 'viewpoint_DAnalysisSessionEObject51', b1)
    if hasattr(b1, 'viewpoint_SessionManagerEObject'):
        assert _is_linked(b1, 'viewpoint_SessionManagerEObject', a)
    _safe_set(a, 'viewpoint_DAnalysisSessionEObject51', b2)
    assert _is_linked(a, 'viewpoint_DAnalysisSessionEObject51', b2)
    if hasattr(b1, 'viewpoint_SessionManagerEObject'):
    ...
    _safe_set(a, 'viewpoint_DAnalysisSessionEObject51', None)
    assert not _is_linked(a, 'viewpoint_DAnalysisSessionEObject51', b2)
    if hasattr(b2, 'viewpoint_SessionManagerEObject'):
        assert not _is_linked(b2, 'viewpoint_SessionManagerEObject', a)


def test_assoc_ownedTemplates76_link_reassign_clear():
    a = viewpoint_description_Viewpoint(conflicts="sample_text", customizes="sample_text", icon="sample_text", modelFileExtension="sample_text", reuses="sample_text")
...
def test_assoc_ownedViewpoints56_link_reassign_clear():
    a = viewpoint_description_Group(name="sample_text", version="sample_text")
    b1 = Viewpoint()
    b2 = Viewpoint()
...
def test_assoc_representationDescription156_link_reassign_clear():
    a = viewpoint_tool_RepresentationCreationDescription(browseExpression="sample_text", titleExpression="sample_text")
    b1 = RepresentationDescription()
    b2 = RepresentationDescription()
    ...
    if hasattr(b1, 'RepresentationDescription157'):
        assert _is_linked(b1, 'RepresentationDescription157', a)
    ...
    if hasattr(b1, 'RepresentationDescription157'):
        assert not _is_linked(b1, 'RepresentationDescription157', a)
    if hasattr(b2, 'RepresentationDescription157'):
        assert _is_linked(b2, 'RepresentationDescription157', a)
    ...
    if hasattr(b2, 'RepresentationDescription157'):
        assert not _is_linked(b2, 'RepresentationDescription157', a)


def test_assoc_representationDescription166_link_reassign_clear():
    a = viewpoint_tool_RepresentationNavigationDescription(browseExpression="sample_text", navigationNameExpression="sample_text")
    b1 = RepresentationDescription()
    b2 = RepresentationDescription()
    ...
    if hasattr(b1, 'RepresentationDescription167'):
        assert _is_linked(b1, 'RepresentationDescription167', a)
    ...
    if hasattr(b1, 'RepresentationDescription167'):
        assert not _is_linked(b1, 'RepresentationDescription167', a)
    if hasattr(b2, 'RepresentationDescription167'):
        assert _is_linked(b2, 'RepresentationDescription167', a)
    ...
    if hasattr(b2, 'RepresentationDescription167'):
        assert not _is_linked(b2, 'RepresentationDescription167', a)


def test_assoc_representationElements18_link_reassign_clear():
    a = viewpoint_DRepresentationElement(name="sample_text")
    b1 = viewpoint_DRepresentation(name="sample_text")
    b2 = viewpoint_DRepresentation(name="sample_text_2")
    _safe_set(a, 'viewpoint_DRepresentationElement20', b1)
    assert _is_linked(a, 'viewpoint_DRepresentationElement20', b1)
    if hasattr(b1, 'viewpoint_DRepresentation19'):
        assert _is_linked(b1, 'viewpoint_DRepresentation19', a)
    _safe_set(a, 'viewpoint_DRepresentationElement20', b2)
    assert _is_linked(a, 'viewpoint_DRepresentationElement20', b2)
    if hasattr(b1, 'viewpoint_DRepresentation19'):
        assert not _is_linked(b1, 'viewpoint_DRepresentation19', a)
    if hasattr(b2, 'viewpoint_DRepresentation19'):
        assert _is_linked(b2, 'viewpoint_DRepresentation19', a)
    _safe_set(a, 'viewpoint_DRepresentationElement20', None)
    assert not _is_linked(a, 'viewpoint_DRepresentationElement20', b2)
    if hasattr(b2, 'viewpoint_DRepresentation19'):
        assert not _is_linked(b2, 'viewpoint_DRepresentation19', a)


def test_assoc_representationNameVariable164_link_reassign_clear():
    a = viewpoint_tool_RepresentationCreationDescription(browseExpression="sample_text", titleExpression="sample_text")
    b1 = tool_NameVariable()
    b2 = tool_NameVariable()
    _safe_set(a, 'viewpoint_tool_RepresentationCreationDescription165', b1)
    assert _is_linked(a, 'viewpoint_tool_RepresentationCreationDescription165', b1)
    if hasattr(b1, 'tool_NameVariable'):
        assert _is_linked(b1, 'tool_NameVariable', a)
    _safe_set(a, 'viewpoint_tool_RepresentationCreationDescription165', b2)
    assert _is_linked(a, 'viewpoint_tool_RepresentationCreationDescription165', b2)
    if hasattr(b1, 'tool_NameVariable'):
        assert not _is_linked(b1, 'tool_NameVariable', a)
    if hasattr(b2, 'tool_NameVariable'):
        assert _is_linked(b2, 'tool_NameVariable', a)
    _safe_set(a, 'viewpoint_tool_RepresentationCreationDescription165', None)
    assert not _is_linked(a, 'viewpoint_tool_RepresentationCreationDescription165', b2)
    if hasattr(b2, 'tool_NameVariable'):
        assert not _is_linked(b2, 'tool_NameVariable', a)


def test_assoc_representationNameVariable174_link_reassign_clear():
    a = viewpoint_tool_RepresentationNavigationDescription(browseExpression="sample_text", navigationNameExpression="sample_text")
    b1 = tool_NameVariable()
    b2 = tool_NameVariable()
    _safe_set(a, 'viewpoint_tool_RepresentationNavigationDescription175', b1)
    assert _is_linked(a, 'viewpoint_tool_RepresentationNavigationDescription175', b1)
    if hasattr(b1, 'tool_NameVariable176'):
        assert _is_linked(b1, 'tool_NameVariable176', a)
    _safe_set(a, 'viewpoint_tool_RepresentationNavigationDescription175', b2)
    assert _is_linked(a, 'viewpoint_tool_RepresentationNavigationDescription175', b2)
    if hasattr(b1, 'tool_NameVariable176'):
        assert not _is_linked(b1, 'tool_NameVariable176', a)
    if hasattr(b2, 'tool_NameVariable176'):
        assert _is_linked(b2, 'tool_NameVariable176', a)
    _safe_set(a, 'viewpoint_tool_RepresentationNavigationDescription175', None)
    assert not _is_linked(a, 'viewpoint_tool_RepresentationNavigationDescription175', b2)
    if hasattr(b2, 'tool_NameVariable176'):
        assert not _is_linked(b2, 'tool_NameVariable176', a)


def test_assoc_reusedRules205_link_reassign_clear():
    a = viewpoint_validation_ValidationSet(name="sample_text")
    b1 = validation_ValidationRule()
    b2 = validation_ValidationRule()
    _safe_set(a, 'viewpoint_validation_ValidationSet206', {b1})
    assert _is_linked(a, 'viewpoint_validation_ValidationSet206', b1)
    if hasattr(b1, 'validation_ValidationRule207'):
        assert _is_linked(b1, 'validation_ValidationRule207', a)
    _safe_set(a, 'viewpoint_validation_ValidationSet206', {b2})
    assert _is_linked(a, 'viewpoint_validation_ValidationSet206', b2)
    if hasattr(b1, 'validation_ValidationRule207'):
        assert not _is_linked(b1, 'validation_ValidationRule207', a)
    if hasattr(b2, 'validation_ValidationRule207'):
        assert _is_linked(b2, 'validation_ValidationRule207', a)
    _safe_set(a, 'viewpoint_validation_ValidationSet206', set())
    assert not _is_linked(a, 'viewpoint_validation_ValidationSet206', b2)
    if hasattr(b2, 'validation_ValidationRule207'):
        assert not _is_linked(b2, 'validation_ValidationRule207', a)
...
def test_assoc_semanticElements25_link_reassign_clear():
    a = viewpoint_DRepresentationElement(name="sample_text")
    b1 = viewpoint_EObject()
    b2 = viewpoint_EObject()
    _safe_set(a, 'viewpoint_DRepresentationElement26', {b1})
    assert _is_linked(a, 'viewpoint_DRepresentationElement26', b1)
    if hasattr(b1, 'viewpoint_EObject27'):
        assert _is_linked(b1, 'viewpoint_EObject27', a)
    _safe_set(a, 'viewpoint_DRepresentationElement26', {b2})
    assert _is_linked(a, 'viewpoint_DRepresentationElement26', b2)
    if hasattr(b1, 'viewpoint_EObject27'):
        assert not _is_linked(b1, 'viewpoint_EObject27', a)
    if hasattr(b2, 'viewpoint_EObject27'):
        assert _is_linked(b2, 'viewpoint_EObject27', a)
    _safe_set(a, 'viewpoint_DRepresentationElement26', set())
    assert not _is_linked(a, 'viewpoint_DRepresentationElement26', b2)
    if hasattr(b2, 'viewpoint_EObject27'):
        assert not _is_linked(b2, 'viewpoint_EObject27', a)


def test_assoc_systemColorsPalette58_link_reassign_clear():
    a = viewpoint_description_Group(name="sample_text", version="sample_text")
    b1 = SytemColorsPalette()
    b2 = SytemColorsPalette()
    _safe_set(a, 'viewpoint_description_Group59', b1)
    assert _is_linked(a, 'viewpoint_description_Group59', b1)
    if hasattr(b1, 'SytemColorsPalette'):
        assert _is_linked(b1, 'SytemColorsPalette', a)
    _safe_set(a, 'viewpoint_description_Group59', b2)
    assert _is_linked(a, 'viewpoint_description_Group59', b2)
    if hasattr(b1, 'SytemColorsPalette'):
        assert not _is_linked(b1, 'SytemColorsPalette', a)
    if hasattr(b2, 'SytemColorsPalette'):
        assert _is_linked(b2, 'SytemColorsPalette', a)
    _safe_set(a, 'viewpoint_description_Group59', None)
    assert not _is_linked(a, 'viewpoint_description_Group59', b2)
    if hasattr(b2, 'SytemColorsPalette'):
        assert not _is_linked(b2, 'SytemColorsPalette', a)


def test_assoc_uiState23_link_reassign_clear():
    a = viewpoint_UIState(inverseSelectionOrder=True)
    b1 = viewpoint_DRepresentation(name="sample_text")
    b2 = viewpoint_DRepresentation(name="sample_text_2")
...
def test_assoc_userColorsPalettes60_link_reassign_clear():
    a = viewpoint_description_Group(name="sample_text", version="sample_text")
    b1 = UserColorsPalette()
    b2 = UserColorsPalette()
    _safe_set(a, 'viewpoint_description_Group61', {b1})
    assert _is_linked(a, 'viewpoint_description_Group61', b1)
    if hasattr(b1, 'UserColorsPalette'):
        assert _is_linked(b1, 'UserColorsPalette', a)
    _safe_set(a, 'viewpoint_description_Group61', {b2})
    assert _is_linked(a, 'viewpoint_description_Group61', b2)
    if hasattr(b1, 'UserColorsPalette'):
        assert not _is_linked(b1, 'UserColorsPalette', a)
    if hasattr(b2, 'UserColorsPalette'):
        assert _is_linked(b2, 'UserColorsPalette', a)
    _safe_set(a, 'viewpoint_description_Group61', set())
    assert not _is_linked(a, 'viewpoint_description_Group61', b2)
    if hasattr(b2, 'UserColorsPalette'):
        assert not _is_linked(b2, 'UserColorsPalette', a)


def test_assoc_validationSet64_link_reassign_clear():
    a = viewpoint_description_Viewpoint(conflicts="sample_text", customizes="sample_text", icon="sample_text", modelFileExtension="sample_text", reuses="sample_text")
...
def test_assoc_value101_link_reassign_clear():
    ...
    if hasattr(b1, 'description_viewpoint_EObject102'):
        assert _is_linked(b1, 'description_viewpoint_EObject102', a)
    ...
    if hasattr(b1, 'description_viewpoint_EObject102'):
        assert not _is_linked(b1, 'description_viewpoint_EObject102', a)
    if hasattr(b2, 'description_viewpoint_EObject102'):
        assert _is_linked(b2, 'description_viewpoint_EObject102', a)
    ...
    if hasattr(b2, 'description_viewpoint_EObject102'):
        assert not _is_linked(b2, 'description_viewpoint_EObject102', a)


def test_assoc_valueType115_link_reassign_clear():
...
viewpoint_UIState_strategy = st.builds(viewpoint_UIState, inverseSelectionOrder=st.booleans())
@given(instance=viewpoint_UIState_strategy)
@settings(max_examples=25)
