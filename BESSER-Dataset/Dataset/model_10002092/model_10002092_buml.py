...
hw3_Elevator.attributes={hw3_Elevator_CAPACITY, hw3_Elevator_currentFloorIndex, hw3_Elevator_passengersToFloor, hw3_Elevator_numOfPassengers, hw3_Elevator_isGoingUp, hw3_Elevator_NUMBER_OF_FLOORS}
...
hw3_Passenger.attributes={hw3_Passenger_destinationFloor, hw3_Passenger_UNDEFINED_FLOOR, hw3_Passenger_currentFloor, hw3_Passenger_id}
...
downwardBound_Floor_Passenger_4: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="downward_Bound11", type=hw3_Passenger, multiplicity=Multiplicity(0, 9999))
    }
)

# Domain Model
domain_model = DomainModel(
    name="_nqh4YKg6EeeEQN1ZyOr__g",
    types={hw3_Building, hw3_Elevator, hw3_ElevatorFullException, hw3_Floor, hw3_Passenger, genmymodelreverse_java_lang_Exception, Building},
