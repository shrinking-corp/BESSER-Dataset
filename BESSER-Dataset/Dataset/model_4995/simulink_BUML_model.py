...
simulink_SimulinkElement = Class(name="simulink_SimulinkElement", is_abstract=True)
simulink_Block = Class(name="simulink_Block")
SimulinkElement = Class(name="SimulinkElement")
simulink_Port = Class(name="simulink_Port", is_abstract=True)
...
simulink_Chart = Class(name="simulink_Chart")
CompositeStateflowElement = Class(name="CompositeStateflowElement")
simulink_Vertex = Class(name="simulink_Vertex", is_abstract=True)
ContainableStateflowElement = Class(name="ContainableStateflowElement")
simulink_Transition = Class(name="simulink_Transition")
simulink_PortBlock = Class(name="simulink_PortBlock", is_abstract=True)
simulink_InPort = Class(name="simulink_InPort")
Port = Class(name="Port")
simulink_Connection = Class(name="simulink_Connection")
simulink_OutPort = Class(name="simulink_OutPort")
Block = Class(name="Block")
simulink_SFWGuard = Class(name="simulink_SFWGuard")
simulink_SFWTrigger = Class(name="simulink_SFWTrigger")
simulink_State = Class(name="simulink_State")
Vertex = Class(name="Vertex")
simulink_Action = Class(name="simulink_Action")
simulink_Junction = Class(name="simulink_Junction")
simulink_TruthTable = Class(name="simulink_TruthTable", is_abstract=True)
simulink_ConditionTable = Class(name="simulink_ConditionTable")
simulink_ActionTable = Class(name="simulink_ActionTable")
simulink_Data = Class(name="simulink_Data", is_abstract=True)
simulink_Decision = Class(name="simulink_Decision")
simulink_Condition = Class(name="simulink_Condition")
simulink_ActionEntry = Class(name="simulink_ActionEntry")
simulink_DecisionEntry = Class(name="simulink_DecisionEntry")
simulink_StateflowElement = Class(name="simulink_StateflowElement", is_abstract=True)
simulink_Function = Class(name="simulink_Function")
simulink_CompositeStateflowElement = Class(name="simulink_CompositeStateflowElement", is_abstract=True)
StateflowElement = Class(name="StateflowElement")
simulink_ContainableStateflowElement = Class(name="simulink_ContainableStateflowElement", is_abstract=True)
simulink_InputData = Class(name="simulink_InputData")
Data = Class(name="Data")
InPort = Class(name="InPort")
simulink_OutputData = Class(name="simulink_OutputData")
OutPort = Class(name="OutPort")
simulink_LocalData = Class(name="simulink_LocalData")
simulink_BlockReference = Class(name="simulink_BlockReference")
Reference = Class(name="Reference")
simulink_ModelReference = Class(name="simulink_ModelReference")
simulink_Reference = Class(name="simulink_Reference", is_abstract=True)
simulink_ContainableTruthTable = Class(name="simulink_ContainableTruthTable")
TruthTable = Class(name="TruthTable")
simulink_TruthTableChart = Class(name="simulink_TruthTableChart")
...
simulink_SimulinkModel.attributes={simulink_SimulinkModel_isLibrary, simulink_SimulinkModel_file}
...
simulink_Port.attributes={simulink_Port_dataType, simulink_Port_portNumber}
...
simulink_Decision.attributes={simulink_Decision_actionReference, simulink_Decision_id}
...
connection5: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_", type=simulink_Connection, multiplicity=Multiplicity(0, 1))
    }
)
...
domain_model = DomainModel(
    name="simulink",
    types={simulink_SimulinkModel, SubSystem, simulink_SimulinkElement, simulink_Block, SimulinkElement, simulink_Port, simulink_SubSystem, simulink_InPortBlock, PortBlock, simulink_OutPortBlock, simulink_Chart, CompositeStateflowElement, simulink_Vertex, ContainableStateflowElement, simulink_Transition, simulink_PortBlock, simulink_InPort, Port, simulink_Connection, simulink_OutPort, Block, simulink_SFWGuard, simulink_SFWTrigger, simulink_State, Vertex, simulink_Action, simulink_Junction, simulink_TruthTable, simulink_ConditionTable, simulink_ActionTable, simulink_Data, simulink_Decision, simulink_Condition, simulink_ActionEntry, simulink_DecisionEntry, simulink_StateflowElement, simulink_Function, simulink_CompositeStateflowElement, StateflowElement, simulink_ContainableStateflowElement, simulink_InputData, Data, InPort, simulink_OutputData, OutPort, simulink_LocalData, simulink_BlockReference, Reference, simulink_ModelReference, simulink_Reference, simulink_ContainableTruthTable, TruthTable, simulink_TruthTableChart, DecompositionType},
    associations={ownedPorts0, parent1, connections9, port10, from_12, to13, incomingTransitions15, block2, portBlock3, connection4, connection5, subBlocks7, source23, destination24, guard26, triggeredActions27, trigger30, transition32, transition34, outgoingTransitions16, entryActions18, duringActions19, exitActions21, parent43, conditionTable44, actionTable45, data47, decisions49, conditions51, actionEntries53, stateEntry36, stateDuring37, stateExit39, children41, transition60, sourceBlock62, decisionEntries55, condition57},
    generalizations={gen_simulink_SimulinkModel_SubSystem, gen_simulink_Block_SimulinkElement, gen_simulink_PortBlock_Block, gen_simulink_InPortBlock_PortBlock, gen_simulink_OutPortBlock_PortBlock, gen_simulink_Connection_SimulinkElement, gen_simulink_Chart_CompositeStateflowElement, gen_simulink_Chart_Block, gen_simulink_Vertex_ContainableStateflowElement, gen_simulink_Port_SimulinkElement, gen_simulink_InPort_Port, gen_simulink_OutPort_Port, gen_simulink_SubSystem_Block, gen_simulink_State_Vertex, gen_simulink_State_CompositeStateflowElement, gen_simulink_Junction_Vertex, gen_simulink_Transition_ContainableStateflowElement, gen_simulink_TruthTable_StateflowElement, gen_simulink_StateflowElement_SimulinkElement, gen_simulink_Function_CompositeStateflowElement, gen_simulink_Function_ContainableStateflowElement, gen_simulink_CompositeStateflowElement_StateflowElement, gen_simulink_ContainableStateflowElement_StateflowElement, gen_simulink_Data_ContainableStateflowElement, gen_simulink_InputData_Data, gen_simulink_InputData_InPort, gen_simulink_OutputData_Data, gen_simulink_OutputData_OutPort, gen_simulink_LocalData_Data, gen_simulink_BlockReference_Reference, gen_simulink_ModelReference_Reference, gen_simulink_Reference_SubSystem, gen_simulink_ContainableTruthTable_TruthTable, gen_simulink_ContainableTruthTable_ContainableStateflowElement, gen_simulink_TruthTableChart_TruthTable, gen_simulink_TruthTableChart_Block},
    metadata=None
)
