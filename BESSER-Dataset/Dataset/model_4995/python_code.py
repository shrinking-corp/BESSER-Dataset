...
class simulink_OutputData(OutPort, Data):
    ...
    pass
class simulink_InputData(Data, InPort):
...
class simulink_Condition:
    ...
    def __init__(self, description: str, statement: str, simulink_Condition59: "simulink_DecisionEntry" = None, simulink_Condition: "simulink_ConditionTable" = None):
        self.description = description
...
class simulink_Decision:
    ...
    def __init__(self, actionReference: str, id: int, simulink_Decision56: set["simulink_DecisionEntry"] = None, simulink_Decision: "simulink_ConditionTable" = None):
        self.actionReference = actionReference
        self.id = id
...
class Block:
    ...
    pass
class simulink_TruthTableChart(TruthTable, Block):
...
class simulink_Transition(ContainableStateflowElement):
    ...
    def __init__(self, isDefaultTransition: bool, executionOrder: int, Transition35: "simulink_Action" = None, Transition17: "simulink_Vertex" = None, Transition: "simulink_Vertex" = None, outgoingTransitions: "simulink_Vertex" = None, incomingTransitions: "simulink_Vertex" = None, transition: "simulink_SFWGuard" = None, transition28: set["simulink_Action"] = None, transition31: "simulink_SFWTrigger" = None, Transition33: "simulink_SFWGuard" = None, Transition61: "simulink_SFWTrigger" = None):
...
class CompositeStateflowElement:
    ...
    pass
class simulink_Function(CompositeStateflowElement, ContainableStateflowElement):
...
class simulink_Port(SimulinkElement):
    ...
    def __init__(self, dataType: str, portNumber: int, Port: "simulink_Block" = None, Port11: "simulink_PortBlock" = None, ownedPorts: "simulink_Block" = None, port: "simulink_PortBlock" = None):
        self.dataType = dataType
        self.portNumber = portNumber
        self.Port = Port
        self.Port11 = Port11
...
class simulink_Action:
    ...
    def __init__(self, statement: str, triggeredActions: "simulink_Transition" = None, Action29: "simulink_Transition" = None, Action: "simulink_State" = None, Action20: "simulink_State" = None, Action22: "simulink_State" = None, entryActions: "simulink_State" = None, duringActions: "simulink_State" = None, exitActions: "simulink_State" = None):
        self.statement = statement
...
class simulink_Junction(Vertex):
    ...
    pass
class simulink_State(CompositeStateflowElement, Vertex):
