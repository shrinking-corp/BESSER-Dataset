...
domain_model = DomainModel(
    name="units",
    types={units_UnitCarryingElement, units_Unit, units_UnitDivision, units_BaseUnit, Unit, units_UnitRepository, units_UnitMultiplication, units_UnitPower, UnitNames},
    associations={unit0, unit4, dividend6, divisor8, units1, units2},
