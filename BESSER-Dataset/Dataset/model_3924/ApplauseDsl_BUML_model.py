...
applauseDsl_TabbarButton = Class(name="applauseDsl_TabbarButton")
...
domain_model = DomainModel(
    name="applauseDsl",
    types={applauseDsl_Model, applauseDsl_StringFunction, applauseDsl_CollectionLiteral, applauseDsl_CollectionFunction, applauseDsl_Application, applauseDsl_ModelElement, applauseDsl_VariableDeclaration, applauseDsl_TypeDescription, applauseDsl_Type, applauseDsl_Parameter, VariableDeclaration, applauseDsl_ObjectReference, Expression, ScalarExpression, CollectionExpression, applauseDsl_Expression, applauseDsl_ScalarExpression, applauseDsl_CollectionExpression, applauseDsl_StringLiteral, applauseDsl_TabbarButton, applauseDsl_ViewCall, ModelElement, applauseDsl_SimpleType, Type, applauseDsl_Entity, applauseDsl_ProviderConstruction, applauseDsl_Property, applauseDsl_View, applauseDsl_SectionedView, View, applauseDsl_ViewSection, applauseDsl_TableView, SectionedView, applauseDsl_DetailsView, applauseDsl_ViewHeader, applauseDsl_CustomView, applauseDsl_ContentProvider, applauseDsl_CollectionIterator, applauseDsl_ViewAction, applauseDsl_ExternalOpen, ViewAction, applauseDsl_SectionCell, applauseDsl_StringReplace, applauseDsl_StringUrlConform, applauseDsl_StringSplit, CollectionFunction, applauseDsl_ComplexProviderConstruction, ProviderConstruction, applauseDsl_SimpleProviderConstruction, applauseDsl_StringConcat, StringFunction, CellType},
    associations={items10, application0, elements1, type3, description4, object6, tail8, background11, buttons14, title16, icon19, view22, type33, url36, selection39, extends25, properties26, content42, title44, sections46, header48, title49, subtitle52, description28, parameter31, iterator66, text68, details71, image74, action77, collection79, url81, details55, image58, title61, cells64, value90, match92, replacement95, value98, value100, delimiter102, provider105, argument107, expression109, view83, provider86, values88},
    generalizations={gen_applauseDsl_StringFunction_Expression, gen_applauseDsl_StringFunction_ScalarExpression, gen_applauseDsl_CollectionLiteral_Expression, gen_applauseDsl_CollectionLiteral_CollectionExpression, gen_applauseDsl_CollectionFunction_Expression, gen_applauseDsl_CollectionFunction_CollectionExpression, gen_applauseDsl_Parameter_VariableDeclaration, gen_applauseDsl_ObjectReference_Expression, gen_applauseDsl_ObjectReference_ScalarExpression, gen_applauseDsl_ObjectReference_CollectionExpression, gen_applauseDsl_StringLiteral_Expression, gen_applauseDsl_StringLiteral_ScalarExpression, gen_applauseDsl_Type_ModelElement, gen_applauseDsl_SimpleType_Type, gen_applauseDsl_Entity_Type, gen_applauseDsl_View_ModelElement, gen_applauseDsl_Property_VariableDeclaration, gen_applauseDsl_SectionedView_View, gen_applauseDsl_TableView_SectionedView, gen_applauseDsl_DetailsView_SectionedView, gen_applauseDsl_CustomView_View, gen_applauseDsl_ContentProvider_ModelElement, gen_applauseDsl_CollectionIterator_VariableDeclaration, gen_applauseDsl_ExternalOpen_ViewAction, gen_applauseDsl_StringReplace_StringFunction, gen_applauseDsl_StringUrlConform_StringFunction, gen_applauseDsl_StringSplit_CollectionFunction, gen_applauseDsl_ComplexProviderConstruction_ProviderConstruction, gen_applauseDsl_SimpleProviderConstruction_ProviderConstruction, gen_applauseDsl_ViewCall_ViewAction, gen_applauseDsl_StringConcat_StringFunction},
    metadata=None
)
