...
class applauseDsl_SectionCell:
    ...
    def __init__(self, type: str, applauseDsl_SectionCell67: "applauseDsl_CollectionIterator" = None, applauseDsl_SectionCell69: "applauseDsl_ScalarExpression" = None, applauseDsl_SectionCell72: "applauseDsl_ScalarExpression" = None, applauseDsl_SectionCell75: "applauseDsl_ScalarExpression" = None, applauseDsl_SectionCell78: "applauseDsl_ViewAction" = None, applauseDsl_SectionCell: "applauseDsl_ViewSection" = None):
        self.type = type
...
class applauseDsl_ContentProvider(ModelElement):
    ...
    def __init__(self, many: bool, applauseDsl_ContentProvider34: "applauseDsl_Type" = None, applauseDsl_ContentProvider37: "applauseDsl_ScalarExpression" = None, applauseDsl_ContentProvider40: "applauseDsl_ScalarExpression" = None, applauseDsl_ContentProvider: "applauseDsl_Parameter" = None, applauseDsl_ContentProvider106: "applauseDsl_ComplexProviderConstruction" = None):
        self.many = many
...
class applauseDsl_ObjectReference(Expression, CollectionExpression, ScalarExpression):
...
class applauseDsl_Property(VariableDeclaration):
    ...
    def __init__(self, derived: bool, applauseDsl_Property: "applauseDsl_Entity" = None, applauseDsl_Property29: "applauseDsl_TypeDescription" = None):
...
class applauseDsl_Application:
    ...
    def __init__(self, name: str, applauseDsl_Application12: "applauseDsl_ScalarExpression" = None, applauseDsl_Application15: set["applauseDsl_TabbarButton"] = None, applauseDsl_Application: "applauseDsl_Model" = None):
        self.name = name
