...
def test_hyp_mission_is_not_abstract():
    assert not inspect.isabstract(Mission)


def test_hyp_mission_constructor_exists():
    assert callable(Mission.__init__)


def test_hyp_mission_constructor_args():
...
def test_hyp_mission_staff_Id_setter(instance):
...
@given(instance=Mission_strategy)
def test_hyp_mission_mission_id_setter(instance):
...
@given(instance=Mission_strategy)
def test_hyp_mission_mission_StartDate_setter(instance):
...
@given(instance=Mission_strategy)
def test_hyp_mission_mission_NoOfDays_setter(instance):
...
@given(instance=Mission_strategy)
def test_hyp_mission_mission_detail_setter(instance):
...
@given(instance=Mission_strategy)
def test_hyp_mission_mission_Status_setter(instance):
...
@given(instance=Mission_strategy)
def test_hyp_mission_mission_Title_setter(instance):
...
@given(instance=Mission_strategy)
def test_hyp_mission_mission_EndDate_setter(instance):
...
def test_hyp_staff_member_staff_Address_setter(instance):
...
@given(instance=staff_member_strategy)
def test_hyp_staff_member_staff_NIC_setter(instance):
...
@given(instance=staff_member_strategy)
def test_hyp_staff_member_staff_Email_setter(instance):
...
@given(instance=staff_member_strategy)
def test_hyp_staff_member_staff_Salary_setter(instance):
...
@given(instance=staff_member_strategy)
def test_hyp_staff_member_staff_Name_setter(instance):
...
@given(instance=staff_member_strategy)
def test_hyp_staff_member_staff_ContactNo_setter(instance):
...
@given(instance=staff_member_strategy)
def test_hyp_staff_member_staff_Department_setter(instance):
...
@given(instance=staff_member_strategy)
def test_hyp_staff_member_staff_Date_Of_Joint_setter(instance):
...
@given(instance=staff_member_strategy)
def test_hyp_staff_member_staff_Id_setter(instance):
    original = instance.staff_Id
    instance.staff_Id = original
    assert instance.staff_Id == original
...
@given(instance=staff_member_strategy)
def test_hyp_staff_member_staff_DOB_setter(instance):
...
@given(instance=staff_member_strategy)
def test_hyp_staff_member_staff_Position_setter(instance):
