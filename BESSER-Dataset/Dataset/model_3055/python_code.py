...
class entityDsl_DataType:
    ...
    def __init__(self, type: str, entityDsl_DataType13: "entityDsl_RadioButtonGroup" = None, entityDsl_DataType16: "entityDsl_TextBox" = None, entityDsl_DataType20: "entityDsl_ComboBox" = None, entityDsl_DataType: "entityDsl_TrackBar" = None):
        self.type = type
...
class entityDsl_WinFormControlType:
    ...
    def __init__(self, name: str, entityDsl_WinFormControlType8: "entityDsl_TextBox" = None, entityDsl_WinFormControlType: "entityDsl_Attribute" = None):
        self.name = name
...
class entityDsl_Attribute:
    ...
    def __init__(self, required: str, name: str, entityDsl_Attribute6: "entityDsl_Label" = None, entityDsl_Attribute: "entityDsl_Entity" = None, entityDsl_Attribute4: "entityDsl_WinFormControlType" = None):
...
class entityDsl_TrackBar(WinFormControlType):
    ...
    def __init__(self, defaultTick: int, increment: int, denominator: int, minimumValue: int, maximumValue: int, stringValues: str, entityDsl_TrackBar: "entityDsl_DataType" = None):
...
class entityDsl_TextBox:
    ...
    def __init__(self, name: str, minTextLength: int, maxTextLength: int, entityDsl_TextBox15: "entityDsl_DataType" = None, entityDsl_TextBox: "entityDsl_WinFormControlType" = None):
        self.name = name
