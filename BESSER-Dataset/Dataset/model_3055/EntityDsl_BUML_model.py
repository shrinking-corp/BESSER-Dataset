...
# Classes
entityDsl_TextBox = Class(name="entityDsl_TextBox")
entityDsl_TrackBar = Class(name="entityDsl_TrackBar")
WinFormControlType = Class(name="WinFormControlType")
entityDsl_Spinner = Class(name="entityDsl_Spinner")
entityDsl_RadioButtonGroup = Class(name="entityDsl_RadioButtonGroup")
entityDsl_Domainmodel = Class(name="entityDsl_Domainmodel")
entityDsl_Entity = Class(name="entityDsl_Entity")
entityDsl_Attribute = Class(name="entityDsl_Attribute")
entityDsl_WinFormControlType = Class(name="entityDsl_WinFormControlType")
entityDsl_Label = Class(name="entityDsl_Label")
entityDsl_DataType = Class(name="entityDsl_DataType")
entityDsl_RadioButton = Class(name="entityDsl_RadioButton")
entityDsl_CheckBox = Class(name="entityDsl_CheckBox")
entityDsl_ComboBox = Class(name="entityDsl_ComboBox")
entityDsl_ComboBoxItem = Class(name="entityDsl_ComboBoxItem")
...
entityDsl_TrackBar.attributes={entityDsl_TrackBar_denominator, entityDsl_TrackBar_minimumValue, entityDsl_TrackBar_stringValues, entityDsl_TrackBar_increment, entityDsl_TrackBar_maximumValue, entityDsl_TrackBar_defaultTick}
...
entityDsl_Spinner.attributes={entityDsl_Spinner_minimumValue, entityDsl_Spinner_maximumValue, entityDsl_Spinner_defaultValue}
...
entityDsl_Attribute.attributes={entityDsl_Attribute_name, entityDsl_Attribute_required}
...
domain_model = DomainModel(
    name="entityDsl",
    types={entityDsl_TextBox, entityDsl_TrackBar, WinFormControlType, entityDsl_Spinner, entityDsl_RadioButtonGroup, entityDsl_Domainmodel, entityDsl_Entity, entityDsl_Attribute, entityDsl_WinFormControlType, entityDsl_Label, entityDsl_DataType, entityDsl_RadioButton, entityDsl_CheckBox, entityDsl_ComboBox, entityDsl_ComboBoxItem},
    associations={controlType7, dataType9, elements0, attributes1, inputType3, labelText5, buttons10, dataType11, dataType14, items17, dataType18},
    generalizations={gen_entityDsl_TrackBar_WinFormControlType, gen_entityDsl_Spinner_WinFormControlType, gen_entityDsl_RadioButtonGroup_WinFormControlType, gen_entityDsl_CheckBox_WinFormControlType, gen_entityDsl_ComboBox_WinFormControlType},
    metadata=None
)
