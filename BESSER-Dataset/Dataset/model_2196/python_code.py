...
class datamodel_Slice:
    ...
    def __init__(self, name: str, diagram: str, datamodel_Slice: set["datamodel_Constraint"] = None, slices: set["datamodel_Ensemble"] = None, Slice: "datamodel_Ensemble" = None, Slice9: "datamodel_SliceRepository" = None, slices16: "datamodel_SliceRepository" = None):
        self.name = name
...
class datamodel_Constraint:
    ...
    def __init__(self, constraintType: str, dependencyKind: str, datamodel_Constraint13: "datamodel_Slice" = None, datamodel_Constraint: "datamodel_Ensemble" = None, datamodel_Constraint3: "datamodel_Ensemble" = None, datamodel_Constraint6: "datamodel_Ensemble" = None):
...
class datamodel_Ensemble(TreeNode):
    ...
    def __init__(self, name: str, derived: bool, description: str, query: str, datamodel_Ensemble11: "datamodel_SliceRepository" = None, Ensemble: "datamodel_Slice" = None, datamodel_Ensemble: set["datamodel_Constraint"] = None, ensembles: set["datamodel_Slice"] = None, datamodel_Ensemble4: "datamodel_Constraint" = None, datamodel_Ensemble7: "datamodel_Constraint" = None):
        self.name = name
