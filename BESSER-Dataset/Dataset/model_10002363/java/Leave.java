...
public class Leave  {
    ...
    public Leave(
        LocalDate Leave_ApplyDate,        int leave_id,        String Leave_Title,        String Leave_detail,        LocalDate Leave_EndDate,        int Emp_Id,        int Leave_NoOfDays,        String Leave_Status,        LocalDate Leave_StartDate    ) {
