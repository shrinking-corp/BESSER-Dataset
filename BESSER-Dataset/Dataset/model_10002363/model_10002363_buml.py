...
Employee.attributes={Employee_Emp_ContactNo, Employee_Emp_Address, Employee_Emp_Department, Employee_Emp_Date_Of_Joint, Employee_Emp_Salary, Employee_Emp_Name, Employee_Emp_NIC, Employee_Emp_DOB, Employee_Emp_Id, Employee_Emp_Email, Employee_Emp_Position}
...
Salary.attributes={Salary_OverTime, Salary_Sly_Netgross, Salary_Emp_Id, Salary_Sly_Increment, Salary_Sly_Decrement, Salary_Sly_Basic}
...
Leave.attributes={Leave_Emp_Id, Leave_Leave_ApplyDate, Leave_Leave_NoOfDays, Leave_leave_id, Leave_Leave_EndDate, Leave_Leave_detail, Leave_Leave_StartDate, Leave_Leave_Title, Leave_Leave_Status}
...
domain_model = DomainModel(
    name="abeb2c6f_b998_47b3_b81f_f878a5180bf0",
