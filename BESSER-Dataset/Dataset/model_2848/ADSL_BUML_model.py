...
# Classes
aDSL_Program = Class(name="aDSL_Program")
aDSL_AbstractElements = Class(name="aDSL_AbstractElements")
aDSL_XClass = Class(name="aDSL_XClass")
VarDef = Class(name="VarDef")
aDSL_Member = Class(name="aDSL_Member")
aDSL_Method = Class(name="aDSL_Method")
aDSL_Parameter = Class(name="aDSL_Parameter")
aDSL_Operator = Class(name="aDSL_Operator")
aDSL_FuncVarDef = Class(name="aDSL_FuncVarDef")
aDSL_VariableDef = Class(name="aDSL_VariableDef")
aDSL_SharedArrayDef = Class(name="aDSL_SharedArrayDef")
SharedDef = Class(name="SharedDef")
aDSL_SharedVarDef = Class(name="aDSL_SharedVarDef")
aDSL_MainMethod = Class(name="aDSL_MainMethod")
Member = Class(name="Member")
aDSL_VariableType = Class(name="aDSL_VariableType")
aDSL_Body = Class(name="aDSL_Body")
aDSL_PrintInst = Class(name="aDSL_PrintInst")
Statement = Class(name="Statement")
aDSL_Expression = Class(name="aDSL_Expression")
aDSL_AsyncStat = Class(name="aDSL_AsyncStat")
aDSL_FinishStat = Class(name="aDSL_FinishStat")
aDSL_AtStat = Class(name="aDSL_AtStat")
aDSL_AtomicStatement = Class(name="aDSL_AtomicStatement")
aDSL_WhenStatement = Class(name="aDSL_WhenStatement")
aDSL_For2Statement = Class(name="aDSL_For2Statement")
aDSL_VarDef = Class(name="aDSL_VarDef")
aDSL_SharedDef = Class(name="aDSL_SharedDef")
aDSL_Statement = Class(name="aDSL_Statement")
aDSL_Block = Class(name="aDSL_Block")
aDSL_WhileStat = Class(name="aDSL_WhileStat")
aDSL_ForStat = Class(name="aDSL_ForStat")
aDSL_ReturnStat = Class(name="aDSL_ReturnStat")
aDSL_IfStat = Class(name="aDSL_IfStat")
aDSL_Assignment = Class(name="aDSL_Assignment")
Expression = Class(name="Expression")
aDSL_MemberSelection = Class(name="aDSL_MemberSelection")
aDSL_IntegerNegative = Class(name="aDSL_IntegerNegative")
aDSL_TryCatchStat = Class(name="aDSL_TryCatchStat")
aDSL_Or = Class(name="aDSL_Or")
aDSL_And = Class(name="aDSL_And")
aDSL_Equality = Class(name="aDSL_Equality")
aDSL_Comparison = Class(name="aDSL_Comparison")
aDSL_Plus = Class(name="aDSL_Plus")
aDSL_Minus = Class(name="aDSL_Minus")
aDSL_StringConstant = Class(name="aDSL_StringConstant")
aDSL_IntConstant = Class(name="aDSL_IntConstant")
aDSL_BoolConstant = Class(name="aDSL_BoolConstant")
aDSL_DeRef = Class(name="aDSL_DeRef")
aDSL_This = Class(name="aDSL_This")
aDSL_Null = Class(name="aDSL_Null")
aDSL_Here = Class(name="aDSL_Here")
aDSL_Reference = Class(name="aDSL_Reference")
aDSL_New = Class(name="aDSL_New")
aDSL_MulOrDiv = Class(name="aDSL_MulOrDiv")
aDSL_Not = Class(name="aDSL_Not")
aDSL_Init = Class(name="aDSL_Init")
...
aDSL_Method.attributes={aDSL_Method_isconst, aDSL_Method_name, aDSL_Method_istyped}
...
aDSL_Parameter.attributes={aDSL_Parameter_name, aDSL_Parameter_istyped}
...
aDSL_VariableDef.attributes={aDSL_VariableDef_vartype, aDSL_VariableDef_istyped, aDSL_VariableDef_isstatic, aDSL_VariableDef_isinit, aDSL_VariableDef_name}
...
aDSL_IntegerNegative.attributes={aDSL_IntegerNegative_value, aDSL_IntegerNegative_isneg}
...
domain_model = DomainModel(
    name="aDSL",
    types={aDSL_Program, aDSL_AbstractElements, aDSL_XClass, VarDef, aDSL_Member, aDSL_Method, aDSL_Parameter, aDSL_Operator, aDSL_FuncVarDef, aDSL_VariableDef, aDSL_SharedArrayDef, SharedDef, aDSL_SharedVarDef, aDSL_MainMethod, Member, aDSL_VariableType, aDSL_Body, aDSL_PrintInst, Statement, aDSL_Expression, aDSL_AsyncStat, aDSL_FinishStat, aDSL_AtStat, aDSL_AtomicStatement, aDSL_WhenStatement, aDSL_For2Statement, aDSL_VarDef, aDSL_SharedDef, aDSL_Statement, aDSL_Block, aDSL_WhileStat, aDSL_ForStat, aDSL_ReturnStat, aDSL_IfStat, aDSL_Assignment, Expression, aDSL_MemberSelection, aDSL_IntegerNegative, aDSL_TryCatchStat, aDSL_Or, aDSL_And, aDSL_Equality, aDSL_Comparison, aDSL_Plus, aDSL_Minus, aDSL_StringConstant, aDSL_IntConstant, aDSL_BoolConstant, aDSL_DeRef, aDSL_This, aDSL_Null, aDSL_Here, aDSL_Reference, aDSL_New, aDSL_MulOrDiv, aDSL_Not, aDSL_Init},
    associations={importElements0, xclass1, superclass4, params12, type13, body16, params19, expression21, params24, type26, body29, type32, expression34, expression37, expression39, members6, type8, body9, expression11, statements46, type48, innerType52, body54, body56, exp58, body60, statement63, expression65, statement67, par70, data72, body75, type41, statements44, bodyTry82, bodyCatch84, expression87, body89, temp92, condition94, finalexp97, body100, expression103, expression105, thenBlock107, elseBlock110, left113, right115, receiver118, type78, sym80, left129, right131, left134, right136, left139, right141, left144, right146, left149, right151, left154, right156, member120, par123, args126, expression164, value166, ref167, base169, params171, type174, left159, right161, args176, type179, expression181},
    generalizations={gen_aDSL_XClass_VarDef, gen_aDSL_Method_Member, gen_aDSL_Operator_Member, gen_aDSL_FuncVarDef_Member, gen_aDSL_FuncVarDef_Statement, gen_aDSL_FuncVarDef_VarDef, gen_aDSL_VariableDef_Member, gen_aDSL_VariableDef_Statement, gen_aDSL_VariableDef_VarDef, gen_aDSL_SharedArrayDef_SharedDef, gen_aDSL_SharedVarDef_SharedDef, gen_aDSL_MainMethod_Member, gen_aDSL_PrintInst_Member, gen_aDSL_PrintInst_Statement, gen_aDSL_VariableType_VarDef, gen_aDSL_AsyncStat_Statement, gen_aDSL_FinishStat_Statement, gen_aDSL_AtStat_Statement, gen_aDSL_AtomicStatement_Statement, gen_aDSL_WhenStatement_Statement, gen_aDSL_For2Statement_Statement, gen_aDSL_SharedDef_Member, gen_aDSL_SharedDef_Statement, gen_aDSL_SharedDef_VarDef, gen_aDSL_Parameter_VarDef, gen_aDSL_TryCatchStat_Statement, gen_aDSL_WhileStat_Statement, gen_aDSL_ForStat_Statement, gen_aDSL_ReturnStat_Statement, gen_aDSL_IfStat_Statement, gen_aDSL_Assignment_Expression, gen_aDSL_MemberSelection_Expression, gen_aDSL_Expression_Statement, gen_aDSL_Or_Expression, gen_aDSL_And_Expression, gen_aDSL_Equality_Expression, gen_aDSL_Comparison_Expression, gen_aDSL_Plus_Expression, gen_aDSL_Minus_Expression, gen_aDSL_Not_Expression, gen_aDSL_StringConstant_Expression, gen_aDSL_IntConstant_Expression, gen_aDSL_BoolConstant_Expression, gen_aDSL_DeRef_Expression, gen_aDSL_This_Expression, gen_aDSL_Null_Expression, gen_aDSL_Here_Expression, gen_aDSL_Reference_Expression, gen_aDSL_New_Expression, gen_aDSL_MulOrDiv_Expression, gen_aDSL_Init_Expression},
    metadata=None
)
