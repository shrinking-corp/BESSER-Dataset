...
class aDSL_MemberSelection(Expression):
    ...
    def __init__(self, ispar: bool, methodinvocation: bool, aDSL_MemberSelection121: "aDSL_Member" = None, aDSL_MemberSelection124: "aDSL_XClass" = None, aDSL_MemberSelection127: set["aDSL_Expression"] = None, aDSL_MemberSelection: "aDSL_Expression" = None):
        self.ispar = ispar
...
class aDSL_MulOrDiv(Expression):
    ...
    def __init__(self, op: str, aDSL_MulOrDiv: "aDSL_Expression" = None, aDSL_MulOrDiv162: "aDSL_Expression" = None):
        self.op = op
...
class aDSL_TryCatchStat(Statement):
    ...
    def __init__(self, name: str, aDSL_TryCatchStat: "aDSL_Body" = None, aDSL_TryCatchStat85: "aDSL_Body" = None):
        self.name = name
...
class aDSL_Parameter(VarDef):
    ...
    def __init__(self, name: str, istyped: bool, aDSL_Parameter71: "aDSL_For2Statement" = None, aDSL_Parameter42: "aDSL_VariableType" = None, aDSL_Parameter: "aDSL_Method" = None, aDSL_Parameter20: "aDSL_Operator" = None, aDSL_Parameter25: "aDSL_FuncVarDef" = None):
        self.name = name
        self.istyped = istyped
...
class aDSL_VariableDef(Member, VarDef, Statement):
    ...
    def __init__(self, isstatic: bool, vartype: str, name: str, istyped: bool, isinit: bool, aDSL_VariableDef: "aDSL_VariableType" = None, aDSL_VariableDef35: "aDSL_Expression" = None, aDSL_VariableDef38: "aDSL_SharedArrayDef" = None, aDSL_VariableDef93: "aDSL_ForStat" = None):
...
class aDSL_SharedDef(VarDef, Member, Statement):
...
class aDSL_VariableType(VarDef):
    ...
    def __init__(self, isarray: bool, aDSL_VariableType49: "aDSL_XClass" = None, aDSL_VariableType53: "aDSL_VariableType" = None, aDSL_VariableType51: "aDSL_VariableType" = None, aDSL_VariableType43: "aDSL_Parameter" = None, aDSL_VariableType15: "aDSL_Method" = None, aDSL_VariableType28: "aDSL_FuncVarDef" = None, aDSL_VariableType33: "aDSL_VariableDef" = None, aDSL_VariableType: "aDSL_MainMethod" = None, aDSL_VariableType175: "aDSL_New" = None, aDSL_VariableType79: "aDSL_SharedDef" = None, aDSL_VariableType180: "aDSL_Init" = None):
        self.isarray = isarray
...
class aDSL_XClass(VarDef):
    ...
    def __init__(self, name: str, aDSL_XClass50: "aDSL_VariableType" = None, aDSL_XClass: "aDSL_Program" = None, aDSL_XClass5: "aDSL_XClass" = None, aDSL_XClass3: "aDSL_XClass" = None, aDSL_XClass7: set["aDSL_Member"] = None, aDSL_XClass125: "aDSL_MemberSelection" = None):
        self.name = name
