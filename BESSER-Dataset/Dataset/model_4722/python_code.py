...
class Model_Port(ABC):
    ...
    def __init__(self, portId: str, Model_Port: "Model_DEVS" = None, Model_Port26: "Model_EClassifier" = None, Model_Port58: "Model_Event" = None):
        self.portId = portId
...
class Model_Phase:
    ...
    def __init__(self, phaseID: str, timeAdvance: float, Model_Phase63: set["Model_Variable"] = None, Model_Phase66: "Model_PhaseTransition" = None, Model_Phase69: "Model_PhaseTransition" = None, Model_Phase: "Model_AtomicDEVS" = None):
...
class Model_Variable:
    ...
    def __init__(self, name: str, Model_Variable64: "Model_Phase" = None, Model_Variable71: "Model_EClassifier" = None, Model_Variable: "Model_AtomicDEVS" = None):
        self.name = name
