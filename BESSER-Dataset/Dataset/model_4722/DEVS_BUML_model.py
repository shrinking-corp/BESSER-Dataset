...
Model_EClassifier = Class(name="Model_EClassifier")
...
domain_model = DomainModel(
    name="Model",
    types={Model_Variable, Model_DEVS, Model_IPort, Model_OPort, Model_AtomicDEVS, DEVS, Model_IntTransition, Model_ConfTrans, Model_ExtTrans, Model_Phase, Model_Event, Model_CoupledDEVS, Model_EIC, Model_IC, Model_EOC, Port, Model_Port, Model_EClassifier, PhaseTransition, Model_PhaseTransition},
    associations={stateVars13, container1, iports2, oports4, deltaInt6, deltaConf7, deltaExt9, phases11, outputs45, subModels15, eics17, ics19, eocs21, owner23, portType25, influencer27, influencee30, influencer33, influencee36, influencer39, influencee42, outputs47, inputs50, inputs53, targetPort56, value59, predicates62, sourcePhase65, targetPhase67, domain70},
    generalizations={gen_Model_AtomicDEVS_DEVS, gen_Model_ConfTrans_PhaseTransition, gen_Model_CoupledDEVS_DEVS, gen_Model_IPort_Port, gen_Model_OPort_Port, gen_Model_IntTransition_PhaseTransition, gen_Model_ExtTrans_PhaseTransition},
    metadata=None
)
