...
class Connect4_connect:
    ...
    def __init__(self, FRAME_WIDTH: int, FRAME_HEIGHT: int, rowSize: int, columnSize: int, x: int, y: int, panel: str, label1: str, label2: str, label3: str, label4: str, label5: str):
...
class Connect4_CirclePanel:
    ...
    def __init__(self, color: str, colorIndex: int):
        self.color = color
...
class Connect4_Board:
    ...
    def __init__(self, maxRows: int, maxColumns: int, gameBoard: str, token0: set["Connect4_Token"] = None, player2: set["Connect4_Player"] = None):
...
class Connect4_Player:
    ...
    def __init__(self, wins: int, tokenColor: str, currentPlayer: bool, roundWon: bool, name: str, board3: "Connect4_Board" = None):
        self.wins = wins
