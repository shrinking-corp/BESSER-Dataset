...
drones_FieldObject = Class(name="drones_FieldObject", is_abstract=True)
drones_TemporalContainmentProxy = Class(name="drones_TemporalContainmentProxy", is_abstract=True)
SizedElement = Class(name="SizedElement")
drones_Parameter = Class(name="drones_Parameter")
drones_Drone = Class(name="drones_Drone")
drones_Battery = Class(name="drones_Battery")
drones_ChargeStation = Class(name="drones_ChargeStation")
drones_Action = Class(name="drones_Action")
TemporalContainmentProxy = Class(name="TemporalContainmentProxy")
ImmovableObject = Class(name="ImmovableObject")
drones_Mission = Class(name="drones_Mission")
drones_NamedElement = Class(name="drones_NamedElement", is_abstract=True)
drones_MovableObject = Class(name="drones_MovableObject")
FieldObject = Class(name="FieldObject")
drones_SizedElement = Class(name="drones_SizedElement", is_abstract=True)
drones_ImmovableObject = Class(name="drones_ImmovableObject")
...
drones_Drone.attributes={drones_Drone_maxPayload, drones_Drone_minSpeed, drones_Drone_cpuFrequency, drones_Drone_maxSpeed, drones_Drone_memory, drones_Drone_communicationRange}
...
drones_Battery.attributes={drones_Battery_rechargeRate, drones_Battery_charge, drones_Battery_remainingLifeTime, drones_Battery_lifeTime}
...
drones_Action.attributes={drones_Action_range, drones_Action_key, drones_Action_operation, drones_Action_value}
...
drones_SizedElement.attributes={drones_SizedElement_z, drones_SizedElement_length, drones_SizedElement_y, drones_SizedElement_height, drones_SizedElement_x, drones_SizedElement_width}
...
domain_model = DomainModel(
    name="drones",
    types={NamedElement, drones_FieldObject, drones_TemporalContainmentProxy, SizedElement, drones_Parameter, drones_Drone, drones_Battery, drones_ChargeStation, drones_Action, TemporalContainmentProxy, ImmovableObject, drones_Mission, drones_NamedElement, drones_MovableObject, FieldObject, drones_SizedElement, drones_ImmovableObject, ActionKind},
    associations={parameters0, battery1, chargeStation2, supportedActions4, fieldObjects6, drones8, temporalObjects11, actions13},
    generalizations={gen_drones_FieldObject_NamedElement, gen_drones_FieldObject_SizedElement, gen_drones_Drone_NamedElement, gen_drones_Drone_SizedElement, gen_drones_Battery_TemporalContainmentProxy, gen_drones_ChargeStation_ImmovableObject, gen_drones_Mission_NamedElement, gen_drones_Parameter_TemporalContainmentProxy, gen_drones_Action_TemporalContainmentProxy, gen_drones_Action_NamedElement, gen_drones_MovableObject_FieldObject, gen_drones_ImmovableObject_FieldObject},
    metadata=None
)
