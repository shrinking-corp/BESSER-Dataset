...
class OCL_EnumLiteralExp(OclExpression):
    ...
    def __init__(self, name: str, OclExpression47: "OCL_CollectionExp" = None, OclExpression77: "OCL_IfExp" = None, OclExpression139: "OCL_Operation" = None, OclExpression63: "OCL_LoopExp" = None, OclExpression: "genericity_dsl_ClassBinding" = None, OclExpression81: "OCL_VariableDeclaration" = None, OclExpression131: "OCL_Attribute" = None, OclExpression59: "OCL_PropertyCallExp" = None, OclExpression21: "genericity_dsl_BHelper" = None, OclExpression16: "genericity_dsl_OclFeatureBinding" = None, OclExpression61: "OCL_OperationCallExp" = None, OclExpression94: "OCL_OclType" = None, OclExpression71: "OCL_LetExp" = None, OclExpression57: "OCL_MapElement" = None, OclExpression75: "OCL_IfExp" = None, OclExpression54: "OCL_MapElement" = None, OclExpression73: "OCL_IfExp" = None):
        self.name = name
...
class genericity_dsl_BindingModel(LocatedElement):
    ...
    def __init__(self, metamodel: str, name: str, model_: set["ConceptBinding"] = None, model_2: set["BHelper"] = None, genericity_dsl_BindingModel: set["VariableDeclaration"] = None):
...
class OCL_Operation(OclFeature):
    ...
    def __init__(self, name: str, operation: set["Parameter"] = None, operation136: "OclType" = None, owningOperation: "OclExpression" = None, OclFeature: "OCL_OclFeatureDefinition" = None):
        self.name = name
...
class OCL_OclType(OclExpression):
    ...
    def __init__(self, name: str, returnType: "Operation" = None, valueType: "MapType" = None, type99: "Attribute" = None, keyType: "MapType" = None, elementType: "CollectionType" = None, type105: "TupleTypeAttribute" = None, type107: "VariableDeclaration" = None, context_: "OclContextDefinition" = None, type: "OclExpression" = None, OclExpression47: "OCL_CollectionExp" = None, OclExpression77: "OCL_IfExp" = None, OclExpression139: "OCL_Operation" = None, OclExpression63: "OCL_LoopExp" = None, OclExpression: "genericity_dsl_ClassBinding" = None, OclExpression81: "OCL_VariableDeclaration" = None, OclExpression131: "OCL_Attribute" = None, OclExpression59: "OCL_PropertyCallExp" = None, OclExpression21: "genericity_dsl_BHelper" = None, OclExpression16: "genericity_dsl_OclFeatureBinding" = None, OclExpression61: "OCL_OperationCallExp" = None, OclExpression94: "OCL_OclType" = None, OclExpression71: "OCL_LetExp" = None, OclExpression57: "OCL_MapElement" = None, OclExpression75: "OCL_IfExp" = None, OclExpression54: "OCL_MapElement" = None, OclExpression73: "OCL_IfExp" = None):
        self.name = name
