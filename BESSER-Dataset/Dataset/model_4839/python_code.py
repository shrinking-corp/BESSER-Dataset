...
class contentfwk_DataEntity(Element):
    ...
    def __init__(self, retentionClassification: str, dataEntityCategory: str, privacyClassification: str, contentfwk_DataEntity: "contentfwk_DataArchitecture" = None, suppliesEntities: set["contentfwk_Actor"] = None, consumesEntities: set["contentfwk_Actor"] = None, consumesEntities105: set["contentfwk_Service"] = None, providesEntities: set["contentfwk_Service"] = None, DataEntity: "contentfwk_Actor" = None, DataEntity72: "contentfwk_Actor" = None, encapsulatesDataEntities: "contentfwk_LogicalDataComponent" = None, operatesOnDataEntities: set["contentfwk_LogicalApplicationComponent"] = None, contentfwk_DataEntity113: "contentfwk_DataEntity" = None, contentfwk_DataEntity111: "contentfwk_DataEntity" = None, contentfwk_DataEntity116: "contentfwk_DataEntity" = None, contentfwk_DataEntity114: set["contentfwk_DataEntity"] = None, DataEntity120: "contentfwk_LogicalApplicationComponent" = None, DataEntity317: "contentfwk_Service" = None, DataEntity319: "contentfwk_Service" = None, DataEntity261: "contentfwk_LogicalDataComponent" = None):
...
class contentfwk_Label:
    ...
    def __init__(self, name: str, id: str, description: str, contentfwk_Label: "contentfwk_EnterpriseArchitecture" = None, contentfwk_Label239: set["contentfwk_Label"] = None, category: set["contentfwk_Element"] = None, labels: set["contentfwk_Container"] = None, Label: "contentfwk_Element" = None, Label238: "contentfwk_Container" = None, contentfwk_Label241: "contentfwk_Label" = None):
        self.name = name
        self.id = id
...
class contentfwk_Container:
    ...
    def __init__(self, name: str, id: str, description: str, contentfwk_Container: "contentfwk_EnterpriseArchitecture" = None, Container: "contentfwk_Label" = None, contentfwk_Container236: "contentfwk_Container" = None, contentfwk_Container234: set["contentfwk_Container"] = None, containers: set["contentfwk_Label"] = None):
        self.name = name
        self.id = id
        self.description = description
...
class contentfwk_Role(Element):
    ...
    def __init__(self, estimatedFTEs: str, contentfwk_Role: "contentfwk_BusinessArchitecture" = None, canBeAccessedByRoles: set["contentfwk_Function"] = None, contentfwk_Role99: "contentfwk_Role" = None, contentfwk_Role97: "contentfwk_Role" = None, Role: "contentfwk_Actor" = None, performsTaskInRoles: set["contentfwk_Actor"] = None, Role138: "contentfwk_Function" = None):
...
class contentfwk_Actor(Element):
    ...
    def __init__(self, FTEs: str, actorGoal: str, actorTasks: str, contentfwk_Actor: "contentfwk_BusinessArchitecture" = None, Actor101: "contentfwk_DataEntity" = None, Actor103: "contentfwk_DataEntity" = None, Actor: "contentfwk_OrganizationUnit" = None, isSuppliedByActors: set["contentfwk_DataEntity"] = None, isConsumedByActors: set["contentfwk_DataEntity"] = None, containsActors: "contentfwk_OrganizationUnit" = None, supportsActors: set["contentfwk_Function"] = None, isAssumedByActors: set["contentfwk_Role"] = None, involvesActors: set["contentfwk_Process"] = None, contentfwk_Actor81: set["contentfwk_Service"] = None, isResolvedByActors: set["contentfwk_Event"] = None, isGeneratedByActors: set["contentfwk_Event"] = None, isPerformedByActors: set["contentfwk_Function"] = None, contentfwk_Actor92: "contentfwk_Actor" = None, contentfwk_Actor90: set["contentfwk_Actor"] = None, Actor94: "contentfwk_Role" = None, containsActors86: "contentfwk_Location" = None, Actor128: "contentfwk_Function" = None, Actor140: "contentfwk_Function" = None, Actor164: "contentfwk_Process" = None, Actor246: "contentfwk_Location" = None, Actor222: "contentfwk_Event" = None, Actor225: "contentfwk_Event" = None, contentfwk_Actor313: "contentfwk_Service" = None):
        self.FTEs = FTEs
...
class contentfwk_OrganizationUnit(Element):
    ...
    def __init__(self, headcount: str, OrganizationUnit: "contentfwk_Driver" = None, contentfwk_OrganizationUnit: "contentfwk_BusinessArchitecture" = None, isOwnedAndGovernedByOrganizationUnits: set["contentfwk_Service"] = None, belongsTo: set["contentfwk_Actor"] = None, isOwnedByUnit: set["contentfwk_Function"] = None, involvesOrganizationUnits: set["contentfwk_Process"] = None, motivatesOrganizationUnits: set["contentfwk_Driver"] = None, isProducedByOrganizationUnits: set["contentfwk_Product"] = None, containsOrganizationUnits: "contentfwk_Location" = None, OrganizationUnit74: "contentfwk_Actor" = None, OrganizationUnit130: "contentfwk_Function" = None, OrganizationUnit155: "contentfwk_Process" = None, OrganizationUnit249: "contentfwk_Location" = None, OrganizationUnit195: "contentfwk_Product" = None, OrganizationUnit329: "contentfwk_Service" = None):
...
class contentfwk_Element:
    ...
    def __init__(self, name: str, description: str, ID: str, sourceDescr: str, ownerDescr: str, Element243: "contentfwk_Label" = None, Element: "contentfwk_Element" = None, isDelegatedBy: set["contentfwk_Element"] = None, Element232: "contentfwk_Element" = None, delegates: set["contentfwk_Element"] = None, ownedElements: set["contentfwk_Label"] = None):
        self.name = name
        self.description = description
        self.ID = ID
...
class contentfwk_Process(Standard, Element):
    ...
    def __init__(self, processVolumetrics: str, processCritiality: str, isAutomated: bool, contentfwk_Process: "contentfwk_BusinessArchitecture" = None, Process: "contentfwk_OrganizationUnit" = None, Process79: "contentfwk_Actor" = None, isProducedByProcesses: set["contentfwk_Product"] = None, contentfwk_Process174: "contentfwk_Process" = None, contentfwk_Process172: "contentfwk_Process" = None, Process134: "contentfwk_Function" = None, Process136: "contentfwk_Function" = None, isRealizedByProcesses: set["contentfwk_Function"] = None, supportsProcesses: set["contentfwk_Function"] = None, participatesInProcesses: set["contentfwk_OrganizationUnit"] = None, isRealizedByProcesses157: set["contentfwk_Service"] = None, supportsProcesses160: set["contentfwk_Service"] = None, participatesInProcesses163: set["contentfwk_Actor"] = None, ensuresCorrectOperationOfProcesses: set["contentfwk_Control"] = None, isResolvedByProcesses: set["contentfwk_Event"] = None, isGeneratedByProcesses: set["contentfwk_Event"] = None, Process177: "contentfwk_Process" = None, followsProcesses: set["contentfwk_Process"] = None, Process180: "contentfwk_Process" = None, precedesProcesses: set["contentfwk_Process"] = None, Process198: "contentfwk_Product" = None, Process217: "contentfwk_Event" = None, Process219: "contentfwk_Event" = None, Process227: "contentfwk_Control" = None, Process333: "contentfwk_Service" = None, Process335: "contentfwk_Service" = None):
