...
# Classes
UML2_Element = Class(name="UML2_Element", is_abstract=True)
UML2_Comment = Class(name="UML2_Comment")
UML2_MultiplicityElement = Class(name="UML2_MultiplicityElement", is_abstract=True)
Element = Class(name="Element")
UML2_ValueSpecification = Class(name="UML2_ValueSpecification", is_abstract=True)
UML2_Namespace = Class(name="UML2_Namespace", is_abstract=True)
NamedElement = Class(name="NamedElement")
UML2_Constraint = Class(name="UML2_Constraint")
UML2_PackageableElement = Class(name="UML2_PackageableElement", is_abstract=True)
...
UML2_Behavior = Class(name="UML2_Behavior", is_abstract=True)
...
UML2_NamedElement = Class(name="UML2_NamedElement", is_abstract=True)
...
UML2_Classifier = Class(name="UML2_Classifier", is_abstract=True)
UML2_Reception = Class(name="UML2_Reception")
UML2_Type = Class(name="UML2_Type", is_abstract=True)
...
UML2_DirectedRelationship = Class(name="UML2_DirectedRelationship", is_abstract=True)
Relationship = Class(name="Relationship")
UML2_Relationship = Class(name="UML2_Relationship", is_abstract=True)
...
UML2_TypedElement = Class(name="UML2_TypedElement", is_abstract=True)
...
UML2_Feature = Class(name="UML2_Feature", is_abstract=True)
...
UML2_LiteralSpecification = Class(name="UML2_LiteralSpecification", is_abstract=True)
...
UML2_BehavioralFeature = Class(name="UML2_BehavioralFeature", is_abstract=True)
Feature = Class(name="Feature")
UML2_StructuralFeature = Class(name="UML2_StructuralFeature", is_abstract=True)
...
UML2_RedefinableElement = Class(name="UML2_RedefinableElement", is_abstract=True)
...
UML2_BehavioredClassifier = Class(name="UML2_BehavioredClassifier", is_abstract=True)
UML2_Implementation = Class(name="UML2_Implementation")
UML2_ExtensionEnd = Class(name="UML2_ExtensionEnd")
Property_ = Class(name="Property")
UML2_ActivityEdge = Class(name="UML2_ActivityEdge", is_abstract=True)
UML2_ActivityGroup = Class(name="UML2_ActivityGroup", is_abstract=True)
UML2_ActivityNode = Class(name="UML2_ActivityNode", is_abstract=True)
...
UML2_Trigger = Class(name="UML2_Trigger", is_abstract=True)
...
UML2_ConnectableElement = Class(name="UML2_ConnectableElement", is_abstract=True)
Realization = Class(name="Realization")
UML2_StructuredClassifier = Class(name="UML2_StructuredClassifier", is_abstract=True)
...
UML2_ObjectNode = Class(name="UML2_ObjectNode", is_abstract=True)
ActivityNode = Class(name="ActivityNode")
UML2_State = Class(name="UML2_State")
UML2_ControlNode = Class(name="UML2_ControlNode", is_abstract=True)
...
UML2_ExecutableNode = Class(name="UML2_ExecutableNode", is_abstract=True)
UML2_ExceptionHandler = Class(name="UML2_ExceptionHandler")
Pin = Class(name="Pin")
UML2_Pin = Class(name="UML2_Pin", is_abstract=True)
...
UML2_FinalNode = Class(name="UML2_FinalNode", is_abstract=True)
...
UML2_MessageTrigger = Class(name="UML2_MessageTrigger", is_abstract=True)
...
UML2_EncapsulatedClassifier = Class(name="UML2_EncapsulatedClassifier", is_abstract=True)
...
UML2_InteractionFragment = Class(name="UML2_InteractionFragment", is_abstract=True)
...
UML2_MessageEnd = Class(name="UML2_MessageEnd", is_abstract=True)
...
UML2_TemplateableElement = Class(name="UML2_TemplateableElement", is_abstract=True)
UML2_ParameterableElement = Class(name="UML2_ParameterableElement", is_abstract=True)
...
UML2_ParameterableClassifier = Class(name="UML2_ParameterableClassifier", is_abstract=True)
...
UML2_TemplateableClassifier = Class(name="UML2_TemplateableClassifier", is_abstract=True)
...
UML2_Vertex = Class(name="UML2_Vertex", is_abstract=True)
...
UML2_WriteStructuralFeatureAction = Class(name="UML2_WriteStructuralFeatureAction", is_abstract=True)
...
UML2_LinkAction = Class(name="UML2_LinkAction", is_abstract=True)
...
UML2_StructuralFeatureAction = Class(name="UML2_StructuralFeatureAction", is_abstract=True)
UML2_WriteLinkAction = Class(name="UML2_WriteLinkAction", is_abstract=True)
...
UML2_VariableAction = Class(name="UML2_VariableAction", is_abstract=True)
UML2_ReadVariableAction = Class(name="UML2_ReadVariableAction")
VariableAction = Class(name="VariableAction")
UML2_WriteVariableAction = Class(name="UML2_WriteVariableAction", is_abstract=True)
...
UML2_CallAction = Class(name="UML2_CallAction", is_abstract=True)
InvocationAction = Class(name="InvocationAction")
UML2_InvocationAction = Class(name="UML2_InvocationAction", is_abstract=True)
...
UML2_DeployedArtifact = Class(name="UML2_DeployedArtifact", is_abstract=True)
UML2_DeploymentTarget = Class(name="UML2_DeploymentTarget", is_abstract=True)
...
UML2_Parameter.attributes={UML2_Parameter_direction, UML2_Parameter_isException, UML2_Parameter_effect, UML2_Parameter_default, UML2_Parameter_isStream}
...
UML2_NamedElement.attributes={UML2_NamedElement_name, UML2_NamedElement_visibility, UML2_NamedElement_qualifiedName}
...
UML2_Property.attributes={UML2_Property_aggregation, UML2_Property_isComposite, UML2_Property_isDerived, UML2_Property_default, UML2_Property_isDerivedUnion}
...
UML2_Activity.attributes={UML2_Activity_isSingleExecution, UML2_Activity_body, UML2_Activity_language, UML2_Activity_isReadOnly}
...
UML2_State.attributes={UML2_State_isSimple, UML2_State_isOrthogonal, UML2_State_isSubmachineState, UML2_State_isComposite}
...
UML2_ConditionalNode.attributes={UML2_ConditionalNode_isAssured, UML2_ConditionalNode_isDeterminate}
...
UML2_DeploymentSpecification.attributes={UML2_DeploymentSpecification_deploymentLocation, UML2_DeploymentSpecification_executionLocation}
...
domain_model = DomainModel(
    name="UML2",
    types={UML2_Element, UML2_Comment, UML2_MultiplicityElement, Element, UML2_ValueSpecification, UML2_Namespace, NamedElement, UML2_Constraint, UML2_PackageableElement, UML2_ElementImport, UML2_PackageImport, UML2_OpaqueExpression, ValueSpecification, UML2_Parameter, UML2_Behavior, TypedElement, ParameterableElement, UML2_Expression, OpaqueExpression, UML2_NamedElement, TemplateableElement, UML2_Dependency, UML2_StringExpression, UML2_Class, BehavioredClassifier, EncapsulatedClassifier, UML2_Operation, UML2_Extension, UML2_Classifier, UML2_Reception, UML2_Type, PackageableElement, UML2_Package, UML2_Property, StructuralFeature, ConnectableElement, DeploymentTarget, UML2_DirectedRelationship, Relationship, UML2_Relationship, UML2_DataType, BehavioralFeature, MultiplicityElement, UML2_Association, UML2_ParameterSet, Namespace, UML2_PackageMerge, UML2_ProfileApplication, UML2_Enumeration, DataType, UML2_TypedElement, Classifier, InstanceSpecification, UML2_PrimitiveType, Type, RedefinableElement, UML2_Feature, UML2_EnumerationLiteral, UML2_Substitution, UML2_GeneralizationSet, UML2_UseCase, UML2_CollaborationOccurrence, UML2_Generalization, UML2_LiteralSpecification, UML2_LiteralString, UML2_LiteralNull, UML2_LiteralInteger, UML2_LiteralUnlimitedNatural, UML2_BehavioralFeature, Feature, UML2_StructuralFeature, UML2_LiteralBoolean, LiteralSpecification, UML2_InstanceValue, UML2_RedefinableElement, DirectedRelationship, UML2_InstanceSpecification, DeployedArtifact, UML2_Slot, UML2_Stereotype, Class_, UML2_Profile, Package, PackageImport, Association, UML2_BehavioredClassifier, UML2_Implementation, UML2_ExtensionEnd, Property_, UML2_ActivityEdge, UML2_ActivityGroup, UML2_ActivityNode, UML2_Action, UML2_StructuredActivityNode, UML2_Permission, Dependency, UML2_Usage, UML2_Abstraction, UML2_Realization, Abstraction, UML2_Component, UML2_Trigger, UML2_StateMachine, UML2_Activity, Behavior, UML2_AssociationClass, UML2_InformationItem, UML2_InformationFlow, UML2_Model, UML2_ConnectorEnd, UML2_ConnectableElement, Realization, UML2_StructuredClassifier, UML2_Connector, UML2_InterruptibleActivityRegion, UML2_ActivityPartition, UML2_ObjectNode, ActivityNode, UML2_State, UML2_ControlNode, UML2_ControlFlow, ActivityEdge, UML2_ObjectFlow, ExecutableNode, UML2_OutputPin, UML2_InputPin, UML2_MergeNode, UML2_ExecutableNode, UML2_ExceptionHandler, Pin, UML2_Pin, ObjectNode, UML2_ActivityParameterNode, UML2_ValuePin, InputPin, UML2_Interface, UML2_InitialNode, ControlNode, UML2_FinalNode, UML2_ActivityFinalNode, FinalNode, UML2_DecisionNode, UML2_Manifestation, UML2_Actor, UML2_Extend, UML2_ExtensionPoint, UML2_Include, UML2_ProtocolStateMachine, UML2_Artifact, UML2_Collaboration, StructuredClassifier, UML2_Port, UML2_MessageTrigger, Trigger, UML2_ChangeTrigger, UML2_Signal, UML2_SignalTrigger, UML2_TimeTrigger, UML2_AnyTrigger, UML2_Variable, UML2_EncapsulatedClassifier, UML2_CallTrigger, MessageTrigger, UML2_ConditionalNode, StructuredActivityNode, UML2_Clause, Action, ActivityGroup, UML2_Interaction, InteractionFragment, UML2_Lifeline, UML2_Message, UML2_InteractionFragment, UML2_Gate, UML2_LoopNode, UML2_PartDecomposition, UML2_MessageEnd, UML2_GeneralOrdering, UML2_InteractionOperand, MessageEnd, UML2_ExecutionOccurrence, UML2_EventOccurrence, UML2_Stop, EventOccurrence, UML2_TemplateSignature, UML2_TemplateParameter, UML2_TemplateableElement, UML2_ParameterableElement, UML2_StateInvariant, UML2_TemplateParameterSubstitution, UML2_TemplateBinding, UML2_OperationTemplateParameter, TemplateParameter, UML2_ClassifierTemplateParameter, UML2_ParameterableClassifier, UML2_RedefinableTemplateSignature, TemplateSignature, UML2_TemplateableClassifier, UML2_ConnectableElementTemplateParameter, UML2_FlowFinalNode, UML2_CentralBufferNode, UML2_ExpansionNode, UML2_ExpansionRegion, UML2_ForkNode, UML2_JoinNode, UML2_InteractionOccurrence, InteractionOccurrence, UML2_InteractionConstraint, UML2_CombinedFragment, UML2_Continuation, UML2_Region, UML2_Pseudostate, Constraint, Vertex, UML2_ConnectionPointReference, UML2_Vertex, UML2_Transition, UML2_FinalState, State, UML2_CreateObjectAction, UML2_DestroyObjectAction, UML2_TestIdentityAction, UML2_ReadStructuralFeatureAction, StructuralFeatureAction, UML2_WriteStructuralFeatureAction, UML2_ClearStructuralFeatureAction, UML2_RemoveStructuralFeatureValueAction, WriteStructuralFeatureAction, UML2_AddStructuralFeatureValueAction, UML2_LinkAction, UML2_LinkEndData, UML2_QualifierValue, UML2_ReadSelfAction, UML2_StructuralFeatureAction, UML2_WriteLinkAction, UML2_DestroyLinkAction, UML2_ClearAssociationAction, UML2_VariableAction, UML2_ReadVariableAction, VariableAction, UML2_WriteVariableAction, UML2_ClearVariableAction, UML2_AddVariableValueAction, WriteVariableAction, UML2_RemoveVariableValueAction, UML2_ApplyFunctionAction, UML2_ReadLinkAction, LinkAction, UML2_LinkEndCreationData, LinkEndData, UML2_CreateLinkAction, WriteLinkAction, UML2_CallAction, InvocationAction, UML2_InvocationAction, UML2_SendSignalAction, UML2_BroadcastSignalAction, UML2_SendObjectAction, UML2_PrimitiveFunction, UML2_CallOperationAction, CallAction, UML2_CallBehaviorAction, UML2_TimeExpression, UML2_TimeObservationAction, UML2_DurationInterval, Interval, UML2_Interval, UML2_TimeConstraint, IntervalConstraint, UML2_IntervalConstraint, UML2_TimeInterval, UML2_Duration, CentralBufferNode, UML2_DurationObservationAction, UML2_DurationConstraint, UML2_DataStoreNode, UML2_Deployment, UML2_DeployedArtifact, UML2_DeploymentTarget, UML2_DeploymentSpecification, UML2_Node, StateMachine, UML2_ProtocolTransition, Transition, UML2_ReadExtentAction, UML2_ReclassifyObjectAction, UML2_Device, Node, UML2_ExecutionEnvironment, UML2_CommunicationPath, UML2_ProtocolConformance, UML2_StartOwnedBehaviorAction, UML2_ReadLinkObjectEndAction, UML2_ReadIsClassifiedObjectAction, UML2_CreateLinkObjectAction, CreateLinkAction, UML2_AcceptEventAction, UML2_ReadLinkObjectEndQualifierAction, UML2_ReplyAction, UML2_RaiseExceptionAction, Artifact, UML2_AcceptCallAction, AcceptEventAction, VisibilityKind, ParameterDirectionKind, AggregationKind, CallConcurrencyKind, MessageKind, MessageSort, ExpansionKind, InteractionOperator, PseudostateKind, TransitionKind, ParameterEffectKind, ObjectNodeOrderingKind, ConnectorKind},
    associations={ownedElement1, owner3, ownedComment5, upperValue6, lowerValue7, member12, ownedRule14, importedMember15, elementImport17, packageImport18, result20, behavior21, operand23, clientDependency10, nameExpression11, relatedElement36, ownedOperation38, superClass40, extension41, nestedClassifier42, ownedReception44, package46, annotatedElement25, bodyExpression28, source31, target33, datatype59, association60, defaultValue62, qualifier66, associationEnd68, ownedParameter70, class_71, datatype72, precondition75, postcondition76, redefinedOperation80, class_47, opposite50, owningAssociation52, redefinedProperty54, subsettedProperty57, defaultValue88, parameterSet91, nestedPackage93, nestingPackage96, ownedType98, ownedMember99, packageMerge101, appliedProfile102, packageExtension104, bodyCondition82, type85, operation86, ownedAttribute107, ownedOperation109, enumeration112, feature113, inheritedMember114, general118, ownedLiteral106, substitution127, powertypeExtent128, ownedUseCase129, useCase131, representation132, occurrence134, featuringClassifier137, context138, namespace141, generalization120, attribute121, redefinedClassifier125, parameter148, formalParameter150, returnResult153, raisedException156, method159, specification142, constrainedElement145, owningInstance166, value167, definingFeature169, instance171, redefinitionContext173, specific175, general177, generalizationSet179, slot160, classifier161, specification163, importingNamespace184, importedPackage186, importingNamespace188, importedElement182, endType192, memberEnd194, mergingPackage196, mergedPackage198, ownedStereotype201, metaclassReference202, metamodelReference205, importedProfile208, metaclass211, ownedEnd190, context213, redefinedBehavior215, specification217, parameter218, formalParameter221, returnResult224, precondition227, postcondition230, ownedParameterSet233, ownedBehavior235, classifierBehavior237, edge243, group244, node245, action247, structuredNode248, client250, supplier251, mapping253, abstraction255, realizingClassifier256, implementation239, ownedTrigger240, ownedStateMachine242, powertype262, generalization264, represented266, realization268, conveyed270, definingEnd273, role275, partWithPort276, contract258, substitutingClassifier260, end285, contract288, ownedAttribute291, part293, role296, ownedConnector298, activity301, source302, target304, inGroup306, end279, type280, redefinedConnector283, weight316, interrupts319, superGroup321, activityGroup_activity323, outgoing325, incoming327, inGroup329, activity331, redefinedElement334, inStructuredNode336, guard307, redefinedElement311, inStructuredNode313, inPartition314, context_348, localPrecondition351, localPostcondition354, upperBound357, inState359, selection361, transformation364, inPartition338, inInterruptibleRegion341, output344, input346, handler371, parameter372, value374, ownedAttribute376, ownedOperation378, redefinedInterface382, nestedClassifier384, selection366, decisionInput369, nestedArtifact397, manifestation398, ownedOperation400, ownedAttribute403, utilizedElement406, extendedCase409, extension411, condition413, extensionLocation416, include418, ownedReception387, protocol390, contract392, implementingClassifier394, useCase425, includingCase427, addition429, type431, roleBinding433, collaborationRole436, required439, redefinedPort442, provided444, extend419, extensionPoint421, subject422, operation452, changeExpression454, port456, signal459, ownedAttribute461, signal464, when466, protocol447, ownedPort450, containedEdge473, clause476, result477, test480, body483, predecessorClause487, successorClause489, decider491, scope468, variable470, containedNode471, setupPart499, decider502, test505, result508, loopVariable511, bodyOutput514, loopVariableInput517, lifeline520, message521, fragment523, formalGate524, bodyOutput494, bodyPart497, coveredBy531, represents533, interaction535, selector537, decomposedAs540, receiveEvent542, sendEvent543, connector545, interaction547, signature549, covered525, generalOrdering527, enclosingInteraction528, enclosingOperand529, receiveMessage558, sendMessage560, startExec562, finishExec563, toAfter565, toBefore566, start568, argument552, before555, after556, parameter576, ownedParameter577, nestedSignature579, nestingSignature581, template583, signature584, parameteredElement587, ownedParameteredElement588, default590, ownedDefault592, finish570, behavior572, invariant574, ownedTemplateSignature596, subExpression599, owningExpression601, templateParameter603, owningParameter605, boundElement607, signature609, parameterSubstitution611, formal613, templateBinding595, templateBinding615, actual617, ownedActual620, containedEdge625, containedNode627, subgroup631, superPartition634, represents636, regionAsOutput638, regionAsInput639, joinSpec623, protectedNode644, handlerBody645, exceptionInput646, exceptionType649, refersTo652, actualGate654, argument657, guard660, outputElement641, inputElement642, operand669, cfragmentGate671, region674, connectionPoint675, extendedStateMachine677, fragment661, minint663, maxint666, stateMachine684, state686, extendedRegion689, submachine690, connection693, redefinedState696, deferrableTrigger698, region701, stateMachine_redefinitionContext679, subvertex681, transition682, container715, outgoing717, incoming720, entry723, exit726, container729, source731, target734, redefinedTransition738, entry703, exit706, doActivity709, stateInvariant712, classifier748, result750, target753, first755, second757, trigger739, guard742, effect745, result770, value772, insertAt774, endData776, value777, end780, qualifier783, result760, result763, structuralFeature765, object767, object789, association791, variable794, result795, value797, insertAt799, result785, insertAt787, result808, argument810, onPort812, target815, signal817, signal820, target822, function801, argument802, result805, request824, operation827, target829, behavior832, event836, now838, min840, max842, event834, interruptingEdge847, containedNode849, parameter851, condition853, duration845, ownedMember862, deployedArtifact865, location866, configuration867, deployment869, deployedElement870, nestedNode873, required856, provided858, realization861, generalMachine875, conformance877, postCondition878, referred880, preCondition883, result886, classifier888, oldClassifier891, specificMachine874, classifier899, result901, object904, object907, qualifier909, value912, object915, end917, newClassifier893, object896, result925, qualifier928, result931, trigger933, result935, result920, object923, replyToCall940, replyValue942, returnInformation945, exception948, returnInformation938},
    generalizations={gen_UML2_MultiplicityElement_Element, gen_UML2_Namespace_NamedElement, gen_UML2_OpaqueExpression_ValueSpecification, gen_UML2_ValueSpecification_TypedElement, gen_UML2_ValueSpecification_ParameterableElement, gen_UML2_Expression_OpaqueExpression, gen_UML2_Comment_TemplateableElement, gen_UML2_NamedElement_TemplateableElement, gen_UML2_Relationship_Element, gen_UML2_Class_BehavioredClassifier, gen_UML2_Class_EncapsulatedClassifier, gen_UML2_Type_PackageableElement, gen_UML2_Property_StructuralFeature, gen_UML2_Property_ConnectableElement, gen_UML2_Property_DeploymentTarget, gen_UML2_DirectedRelationship_Relationship, gen_UML2_Operation_BehavioralFeature, gen_UML2_Operation_TypedElement, gen_UML2_Operation_MultiplicityElement, gen_UML2_Operation_ParameterableElement, gen_UML2_Package_Namespace, gen_UML2_Package_PackageableElement, gen_UML2_Enumeration_DataType, gen_UML2_TypedElement_NamedElement, gen_UML2_Parameter_ConnectableElement, gen_UML2_Parameter_TypedElement, gen_UML2_Parameter_MultiplicityElement, gen_UML2_DataType_Classifier, gen_UML2_EnumerationLiteral_InstanceSpecification, gen_UML2_PrimitiveType_DataType, gen_UML2_Classifier_Namespace, gen_UML2_Classifier_Type, gen_UML2_Classifier_RedefinableElement, gen_UML2_Feature_RedefinableElement, gen_UML2_Constraint_PackageableElement, gen_UML2_LiteralSpecification_ValueSpecification, gen_UML2_LiteralString_LiteralSpecification, gen_UML2_LiteralNull_LiteralSpecification, gen_UML2_LiteralInteger_LiteralSpecification, gen_UML2_LiteralUnlimitedNatural_LiteralSpecification, gen_UML2_BehavioralFeature_Namespace, gen_UML2_BehavioralFeature_Feature, gen_UML2_StructuralFeature_Feature, gen_UML2_StructuralFeature_TypedElement, gen_UML2_StructuralFeature_MultiplicityElement, gen_UML2_LiteralBoolean_LiteralSpecification, gen_UML2_Slot_Element, gen_UML2_InstanceValue_ValueSpecification, gen_UML2_RedefinableElement_NamedElement, gen_UML2_Generalization_DirectedRelationship, gen_UML2_PackageableElement_NamedElement, gen_UML2_PackageableElement_ParameterableElement, gen_UML2_InstanceSpecification_PackageableElement, gen_UML2_InstanceSpecification_DeploymentTarget, gen_UML2_InstanceSpecification_DeployedArtifact, gen_UML2_PackageImport_DirectedRelationship, gen_UML2_ElementImport_DirectedRelationship, gen_UML2_PackageMerge_DirectedRelationship, gen_UML2_Stereotype_Class, gen_UML2_Profile_Package, gen_UML2_ProfileApplication_PackageImport, gen_UML2_Extension_Association, gen_UML2_Association_Classifier, gen_UML2_Association_Relationship, gen_UML2_BehavioredClassifier_Classifier, gen_UML2_ExtensionEnd_Property, gen_UML2_Behavior_Class, gen_UML2_Permission_Dependency, gen_UML2_Dependency_PackageableElement, gen_UML2_Dependency_DirectedRelationship, gen_UML2_Usage_Dependency, gen_UML2_Abstraction_Dependency, gen_UML2_Realization_Abstraction, gen_UML2_Activity_Behavior, gen_UML2_AssociationClass_Class, gen_UML2_AssociationClass_Association, gen_UML2_InformationItem_Classifier, gen_UML2_InformationFlow_PackageableElement, gen_UML2_InformationFlow_DirectedRelationship, gen_UML2_Model_Package, gen_UML2_ConnectorEnd_MultiplicityElement, gen_UML2_ConnectableElement_NamedElement, gen_UML2_ConnectableElement_ParameterableElement, gen_UML2_Substitution_Realization, gen_UML2_GeneralizationSet_PackageableElement, gen_UML2_StructuredClassifier_Classifier, gen_UML2_ActivityEdge_RedefinableElement, gen_UML2_Connector_Feature, gen_UML2_ActivityGroup_Element, gen_UML2_ActivityNode_RedefinableElement, gen_UML2_ObjectNode_ActivityNode, gen_UML2_ObjectNode_TypedElement, gen_UML2_ControlNode_ActivityNode, gen_UML2_ControlFlow_ActivityEdge, gen_UML2_ObjectFlow_ActivityEdge, gen_UML2_Action_ExecutableNode, gen_UML2_MergeNode_ControlNode, gen_UML2_ExecutableNode_ActivityNode, gen_UML2_OutputPin_Pin, gen_UML2_InputPin_Pin, gen_UML2_Pin_ObjectNode, gen_UML2_Pin_MultiplicityElement, gen_UML2_ActivityParameterNode_ObjectNode, gen_UML2_ValuePin_InputPin, gen_UML2_Interface_Classifier, gen_UML2_InitialNode_ControlNode, gen_UML2_FinalNode_ControlNode, gen_UML2_ActivityFinalNode_FinalNode, gen_UML2_DecisionNode_ControlNode, gen_UML2_Manifestation_Abstraction, gen_UML2_Actor_Classifier, gen_UML2_Extend_NamedElement, gen_UML2_Extend_DirectedRelationship, gen_UML2_UseCase_BehavioredClassifier, gen_UML2_Implementation_Realization, gen_UML2_Artifact_Classifier, gen_UML2_Artifact_DeployedArtifact, gen_UML2_Include_NamedElement, gen_UML2_Include_DirectedRelationship, gen_UML2_CollaborationOccurrence_NamedElement, gen_UML2_Collaboration_BehavioredClassifier, gen_UML2_Collaboration_StructuredClassifier, gen_UML2_Port_Property, gen_UML2_ExtensionPoint_RedefinableElement, gen_UML2_MessageTrigger_Trigger, gen_UML2_ChangeTrigger_Trigger, gen_UML2_Trigger_NamedElement, gen_UML2_Reception_BehavioralFeature, gen_UML2_Signal_Classifier, gen_UML2_SignalTrigger_MessageTrigger, gen_UML2_TimeTrigger_Trigger, gen_UML2_AnyTrigger_MessageTrigger, gen_UML2_Variable_ConnectableElement, gen_UML2_Variable_TypedElement, gen_UML2_Variable_MultiplicityElement, gen_UML2_EncapsulatedClassifier_StructuredClassifier, gen_UML2_CallTrigger_MessageTrigger, gen_UML2_ConditionalNode_StructuredActivityNode, gen_UML2_Clause_Element, gen_UML2_StructuredActivityNode_Action, gen_UML2_StructuredActivityNode_Namespace, gen_UML2_StructuredActivityNode_ActivityGroup, gen_UML2_Interaction_Behavior, gen_UML2_Interaction_InteractionFragment, gen_UML2_InteractionFragment_NamedElement, gen_UML2_LoopNode_StructuredActivityNode, gen_UML2_Message_NamedElement, gen_UML2_Lifeline_NamedElement, gen_UML2_MessageEnd_NamedElement, gen_UML2_EventOccurrence_InteractionFragment, gen_UML2_EventOccurrence_MessageEnd, gen_UML2_ExecutionOccurrence_InteractionFragment, gen_UML2_GeneralOrdering_NamedElement, gen_UML2_Stop_EventOccurrence, gen_UML2_TemplateSignature_Element, gen_UML2_TemplateParameter_Element, gen_UML2_StateInvariant_InteractionFragment, gen_UML2_StringExpression_TemplateableElement, gen_UML2_ParameterableElement_Element, gen_UML2_TemplateBinding_DirectedRelationship, gen_UML2_TemplateParameterSubstitution_Element, gen_UML2_TemplateableElement_Element, gen_UML2_OperationTemplateParameter_TemplateParameter, gen_UML2_ClassifierTemplateParameter_TemplateParameter, gen_UML2_ParameterableClassifier_Classifier, gen_UML2_RedefinableTemplateSignature_RedefinableElement, gen_UML2_RedefinableTemplateSignature_TemplateSignature, gen_UML2_TemplateableClassifier_Classifier, gen_UML2_ConnectableElementTemplateParameter_TemplateParameter, gen_UML2_FlowFinalNode_FinalNode, gen_UML2_CentralBufferNode_ObjectNode, gen_UML2_ActivityPartition_NamedElement, gen_UML2_ActivityPartition_ActivityGroup, gen_UML2_ExpansionNode_ObjectNode, gen_UML2_ExpansionRegion_StructuredActivityNode, gen_UML2_ForkNode_ControlNode, gen_UML2_JoinNode_ControlNode, gen_UML2_InteractionOccurrence_InteractionFragment, gen_UML2_Gate_MessageEnd, gen_UML2_PartDecomposition_InteractionOccurrence, gen_UML2_InteractionOperand_Namespace, gen_UML2_InteractionOperand_InteractionFragment, gen_UML2_ExceptionHandler_Element, gen_UML2_CombinedFragment_InteractionFragment, gen_UML2_Continuation_InteractionFragment, gen_UML2_StateMachine_Behavior, gen_UML2_InteractionConstraint_Constraint, gen_UML2_Pseudostate_Vertex, gen_UML2_State_Namespace, gen_UML2_State_RedefinableElement, gen_UML2_State_Vertex, gen_UML2_Region_Namespace, gen_UML2_Region_RedefinableElement, gen_UML2_Vertex_NamedElement, gen_UML2_ConnectionPointReference_Vertex, gen_UML2_Transition_RedefinableElement, gen_UML2_FinalState_State, gen_UML2_CreateObjectAction_Action, gen_UML2_DestroyObjectAction_Action, gen_UML2_TestIdentityAction_Action, gen_UML2_ReadStructuralFeatureAction_StructuralFeatureAction, gen_UML2_WriteStructuralFeatureAction_StructuralFeatureAction, gen_UML2_ClearStructuralFeatureAction_StructuralFeatureAction, gen_UML2_RemoveStructuralFeatureValueAction_WriteStructuralFeatureAction, gen_UML2_AddStructuralFeatureValueAction_WriteStructuralFeatureAction, gen_UML2_LinkAction_Action, gen_UML2_LinkEndData_Element, gen_UML2_ReadSelfAction_Action, gen_UML2_StructuralFeatureAction_Action, gen_UML2_WriteLinkAction_LinkAction, gen_UML2_DestroyLinkAction_WriteLinkAction, gen_UML2_ClearAssociationAction_Action, gen_UML2_VariableAction_Action, gen_UML2_ReadVariableAction_VariableAction, gen_UML2_WriteVariableAction_VariableAction, gen_UML2_ClearVariableAction_VariableAction, gen_UML2_AddVariableValueAction_WriteVariableAction, gen_UML2_RemoveVariableValueAction_WriteVariableAction, gen_UML2_ApplyFunctionAction_Action, gen_UML2_ReadLinkAction_LinkAction, gen_UML2_LinkEndCreationData_LinkEndData, gen_UML2_CreateLinkAction_WriteLinkAction, gen_UML2_CallAction_InvocationAction, gen_UML2_InvocationAction_Action, gen_UML2_SendSignalAction_InvocationAction, gen_UML2_BroadcastSignalAction_InvocationAction, gen_UML2_SendObjectAction_InvocationAction, gen_UML2_PrimitiveFunction_PackageableElement, gen_UML2_CallOperationAction_CallAction, gen_UML2_CallBehaviorAction_CallAction, gen_UML2_TimeExpression_ValueSpecification, gen_UML2_TimeObservationAction_WriteStructuralFeatureAction, gen_UML2_DurationInterval_Interval, gen_UML2_Interval_ValueSpecification, gen_UML2_TimeConstraint_IntervalConstraint, gen_UML2_IntervalConstraint_Constraint, gen_UML2_TimeInterval_Interval, gen_UML2_Duration_ValueSpecification, gen_UML2_DataStoreNode_CentralBufferNode, gen_UML2_InterruptibleActivityRegion_ActivityGroup, gen_UML2_ParameterSet_NamedElement, gen_UML2_Component_Class, gen_UML2_DurationObservationAction_WriteStructuralFeatureAction, gen_UML2_DurationConstraint_IntervalConstraint, gen_UML2_Deployment_Dependency, gen_UML2_DeployedArtifact_NamedElement, gen_UML2_DeploymentTarget_NamedElement, gen_UML2_Node_Class, gen_UML2_Node_DeploymentTarget, gen_UML2_ProtocolStateMachine_StateMachine, gen_UML2_ProtocolTransition_Transition, gen_UML2_ReadExtentAction_Action, gen_UML2_ReclassifyObjectAction_Action, gen_UML2_Device_Node, gen_UML2_ExecutionEnvironment_Node, gen_UML2_CommunicationPath_Association, gen_UML2_ProtocolConformance_DirectedRelationship, gen_UML2_StartOwnedBehaviorAction_Action, gen_UML2_QualifierValue_Element, gen_UML2_ReadLinkObjectEndAction_Action, gen_UML2_ReadIsClassifiedObjectAction_Action, gen_UML2_CreateLinkObjectAction_CreateLinkAction, gen_UML2_AcceptEventAction_Action, gen_UML2_ReadLinkObjectEndQualifierAction_Action, gen_UML2_ReplyAction_Action, gen_UML2_RaiseExceptionAction_Action, gen_UML2_DeploymentSpecification_Artifact, gen_UML2_AcceptCallAction_AcceptEventAction},
    metadata=None
)
