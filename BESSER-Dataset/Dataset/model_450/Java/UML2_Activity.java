...
public class UML2_Activity extends Behavior {
    ...
    public UML2_Activity(
        String language,        boolean isReadOnly,        String body,        boolean isSingleExecution        ArrayList<UML2_StructuredActivityNode> uml2_structuredactivitynodes,        ArrayList<UML2_ActivityGroup> uml2_activitygroups,        ArrayList<UML2_ActivityNode> uml2_activitynodes,        ArrayList<UML2_Action> uml2_actions,        ArrayList<UML2_ActivityEdge> uml2_activityedges    ) {
        this.language = language;
        this.isReadOnly = isReadOnly;
        this.body = body;
        this.isSingleExecution = isSingleExecution;
