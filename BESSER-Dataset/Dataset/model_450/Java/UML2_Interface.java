...
public class UML2_Interface extends Classifier {
    ...
    public UML2_Interface(
        ArrayList<UML2_Property> uml2_propertys,        ArrayList<UML2_Interface> uml2_interfaces,        ArrayList<UML2_Classifier> uml2_classifiers,        ArrayList<UML2_Reception> uml2_receptions,        ArrayList<UML2_Operation> uml2_operations    ) {
