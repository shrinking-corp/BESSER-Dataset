...
# Classes
nodesAndEdges_ColoredNode = Class(name="nodesAndEdges_ColoredNode")
Node = Class(name="Node")
nodesAndEdges_Node = Class(name="nodesAndEdges_Node")
nodesAndEdges_Node_toString = Class(name="nodesAndEdges_Node_toString")
nodesAndEdges_ColoredNode_toString = Class(name="nodesAndEdges_ColoredNode_toString")
nodesAndEdges_Edge = Class(name="nodesAndEdges_Edge")
nodesAndEdges_Edge_toString = Class(name="nodesAndEdges_Edge_toString")
nodesAndEdges_ShapedNode = Class(name="nodesAndEdges_ShapedNode")
nodesAndEdges_ShapedNode_toString = Class(name="nodesAndEdges_ShapedNode_toString")
...
nodesAndEdges_Edge.attributes={nodesAndEdges_Edge_type, nodesAndEdges_Edge_name}
...
domain_model = DomainModel(
    name="nodesAndEdges",
    types={nodesAndEdges_ColoredNode, Node, nodesAndEdges_Node, nodesAndEdges_Node_toString, nodesAndEdges_ColoredNode_toString, nodesAndEdges_Edge, nodesAndEdges_Edge_toString, nodesAndEdges_ShapedNode, nodesAndEdges_ShapedNode_toString, Color, EdgeViewType, Shape},
    associations={},
