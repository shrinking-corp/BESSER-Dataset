...
extlibrary_Periodical = Class(name="extlibrary_Periodical")
...
domain_model = DomainModel(
    name="extlibrary",
    types={extlibrary_Person, Person, extlibrary_Lendable, extlibrary_Book, CirculatingItem, extlibrary_CirculatingItem, Item, Lendable, extlibrary_Periodical, extlibrary_Writer, extlibrary_AudioVisualItem, extlibrary_Library, Addressable, extlibrary_Employee, extlibrary_Borrower, extlibrary_Item, extlibrary_Addressable, extlibrary_BookOnTape, AudioVisualItem, extlibrary_VideoCassette, BookCategory},
    associations={branches11, parentBranch13, casts15, readers17, books20, borrowers21, author0, writers1, employees2, borrowers4, stock6, books8, manager31, reader22, author24, cast27, borrowed29},
    generalizations={gen_extlibrary_Writer_Person, gen_extlibrary_Book_CirculatingItem, gen_extlibrary_CirculatingItem_Item, gen_extlibrary_CirculatingItem_Lendable, gen_extlibrary_Periodical_Item, gen_extlibrary_AudioVisualItem_CirculatingItem, gen_extlibrary_Library_Addressable, gen_extlibrary_Person_Addressable, gen_extlibrary_Employee_Person, gen_extlibrary_BookOnTape_AudioVisualItem, gen_extlibrary_VideoCassette_AudioVisualItem, gen_extlibrary_Borrower_Person},
    metadata=None
)
