...
class extlibrary_Writer(Person):
    ...
    def __init__(self, name: str, author: set["extlibrary_Book"] = None, Writer: "extlibrary_Book" = None, extlibrary_Writer: "extlibrary_Library" = None, extlibrary_Writer26: "extlibrary_BookOnTape" = None):
        self.name = name
