...
public class xhtml_Inline  {
    ...
    public xhtml_Inline(
        String mixed,        String inline        ArrayList<xhtml_Kbd> xhtml_kbds,        ArrayList<xhtml_Br> xhtml_brs,        ArrayList<xhtml_Dfn> xhtml_dfns,        ArrayList<xhtml_Object> xhtml_objects,        ArrayList<xhtml_Span> xhtml_spans,        ArrayList<xhtml_Var> xhtml_vars,        ArrayList<xhtml_Abbr> xhtml_abbrs,        ArrayList<xhtml_Sup> xhtml_sups,        ArrayList<xhtml_Img> xhtml_imgs,        ArrayList<xhtml_Small> xhtml_smalls,        ArrayList<xhtml_Acronym> xhtml_acronyms,        ArrayList<xhtml_Q> xhtml_qs,        ArrayList<xhtml_Cite> xhtml_cites,        ArrayList<xhtml_I> xhtml_is,        ArrayList<xhtml_B> xhtml_bs,        ArrayList<xhtml_Strong> xhtml_strongs,        ArrayList<xhtml_Big> xhtml_bigs,        ArrayList<xhtml_Em> xhtml_ems,        ArrayList<xhtml_Samp> xhtml_samps,        ArrayList<xhtml_Sub> xhtml_subs,        ArrayList<xhtml_Tt> xhtml_tts,        ArrayList<xhtml_A> xhtml_as,        ArrayList<xhtml_Code> xhtml_codes    ) {
        this.mixed = mixed;
        this.inline = inline;
