...
public class xhtml_Flow  {
    ...
    public xhtml_Flow(
        String mixed,        String group        ArrayList<xhtml_Table> xhtml_tables,        ArrayList<xhtml_B> xhtml_bs,        ArrayList<xhtml_Strong> xhtml_strongs,        ArrayList<xhtml_Tt> xhtml_tts,        ArrayList<xhtml_I> xhtml_is,        ArrayList<xhtml_Dfn> xhtml_dfns,        ArrayList<xhtml_Abbr> xhtml_abbrs,        ArrayList<xhtml_Ul> xhtml_uls,        ArrayList<xhtml_Blockquote> xhtml_blockquotes,        ArrayList<xhtml_Small> xhtml_smalls,        ArrayList<xhtml_Kbd> xhtml_kbds,        ArrayList<xhtml_Cite> xhtml_cites,        ArrayList<xhtml_Code> xhtml_codes,        ArrayList<xhtml_Hr> xhtml_hrs,        ArrayList<xhtml_Br> xhtml_brs,        ArrayList<xhtml_Img> xhtml_imgs,        ArrayList<xhtml_Q> xhtml_qs,        ArrayList<xhtml_Div> xhtml_divs,        ArrayList<xhtml_Ol> xhtml_ols,        ArrayList<xhtml_Sup> xhtml_sups,        ArrayList<xhtml_Em> xhtml_ems,        ArrayList<xhtml_Pre> xhtml_pres,        ArrayList<xhtml_Var> xhtml_vars,        ArrayList<xhtml_A> xhtml_as,        ArrayList<xhtml_Samp> xhtml_samps,        ArrayList<xhtml_Object> xhtml_objects,        ArrayList<xhtml_Dl> xhtml_dls,        ArrayList<xhtml_Span> xhtml_spans,        ArrayList<xhtml_P> xhtml_ps,        ArrayList<xhtml_Big> xhtml_bigs,        ArrayList<xhtml_Acronym> xhtml_acronyms,        ArrayList<xhtml_Sub> xhtml_subs    ) {
        this.mixed = mixed;
        this.group = group;
