...
class forms_Attribute:
    ...
    def __init__(self, name: str, mandatory: bool, type: str, isId: str, forms_Attribute7: "forms_Enumeration" = None, forms_Attribute: "forms_Entity" = None, forms_Attribute42: "forms_Column" = None, forms_Attribute33: "forms_AttributePageElement" = None):
        self.name = name
...
class forms_Entity:
    ...
    def __init__(self, name: str, forms_Entity9: "forms_Model" = None, forms_Entity: set["forms_Attribute"] = None, forms_Entity2: set["forms_Relationship"] = None, forms_Entity5: "forms_Entity" = None, forms_Entity3: "forms_Entity" = None, forms_Entity21: "forms_Relationship" = None, forms_Entity27: "forms_Form" = None):
        self.name = name
...
class forms_Form:
    ...
    def __init__(self, name: str, title: str, description: str, isWelcomeForm: str, forms_Form: "forms_Model" = None, forms_Form35: "forms_RelationshipPageElement" = None, forms_Form26: "forms_Entity" = None, forms_Form29: set["forms_Page"] = None):
        self.name = name
        self.title = title
