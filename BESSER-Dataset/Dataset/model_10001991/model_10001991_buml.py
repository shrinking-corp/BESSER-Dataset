...
Account.attributes={Account_open, Account_closed, Account_isClosed, Account_billingAddress}
...
Order.attributes={Order_total, Order_ordered, Order_shipped, Order_number, Order_status, Order_shipTo}
...
domain_model = DomainModel(
    name="_iIgT4PvmEemPd5ZtCQMxVQ",
    types={Customer, Payment, ShoppinCart, Account, WebUser, Order, LineItem, Product, MyActor_Actor, Admin_Actor, Webuser_Actor, AjoutProduit_UseCase, UserState, OrderStatus},
    associations={Order_LineItem, Account_ShoppinCart, ShoppinCart_LineItem, association2, Account_Payment, Payment_Order, Account_Order, WebUser_Customer, ShoppinCart_WebUser, Customer_Account, Product_LineItem},
    generalizations={},
    metadata=None
)
