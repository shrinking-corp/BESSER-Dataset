...
Person.attributes={Person_Address, Person_Gender, Person_Phone, Person_MiddleName, Person_Title, Person_PersonPatientId, Person_PersonHospitalId, Person_LastName, Person_BirthDate, Person_FirstName}
...
Hospital.attributes={Hospital_Phone, Hospital_HospitalId, Hospital_Name, Hospital_Address}
...
Patient.attributes={Patient_Name, Patient_Sickness, Patient_Gender, Patient_PatientId, Patient_DateOfEntry, Patient_Birthdate, Patient_Age}
...
Staff.attributes={Staff_Joined, Staff_Certification, Staff_Languages, Staff_Education}
...
Operation_Staff.attributes={Operation_Staff_DoctorSpeciality, Operation_Staff_DoctorLocation, Operation_Staff_NurseName}
...
Techinal_Staff.attributes={Techinal_Staff_Technician, Techinal_Staff_Technologist}
