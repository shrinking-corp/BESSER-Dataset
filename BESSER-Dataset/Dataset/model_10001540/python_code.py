...
class Person:
    ...
    def __init__(self, PersonPatientId: int, Title: str, FirstName: str, MiddleName: str, LastName: str, PersonHospitalId: int, BirthDate: str, Gender: str, Address: str, Phone: int, hospital0: set["Hospital"] = None):
