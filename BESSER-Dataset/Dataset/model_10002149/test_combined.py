...
def test_hyp_atestado_is_not_abstract():
    assert not inspect.isabstract(Atestado)


def test_hyp_atestado_constructor_exists():
    assert callable(Atestado.__init__)


def test_hyp_atestado_constructor_args():
...
def test_hyp_atestado_has_quantidadeDias():
...
def test_hyp_atestado_has_dataFimDoAtestado():
...
def test_hyp_atestado_has_dataInicioDoAtestado():
...
def test_hyp_atestado_has_consulta():
...
def test_hyp_consulta_has_codigoDiagnostico():
...
def test_hyp_consulta_has_medicamentos():
...
def test_hyp_consulta_has_medico():
...
def test_hyp_consulta_has_triagem():
...
def test_hyp_consulta_has_diagnostico():
...
def test_hyp_consulta_has_atestado():
...
def test_hyp_string_interface_is_not_abstract():
    assert not inspect.isabstract(String_Interface)


def test_hyp_string_interface_constructor_exists():
    assert callable(String_Interface.__init__)


def test_hyp_string_interface_constructor_args():
    sig = inspect.signature(String_Interface.__init__)
    params = list(sig.parameters.keys())



def test_hyp_triagem_is_not_abstract():
    assert not inspect.isabstract(Triagem)


def test_hyp_triagem_constructor_exists():
    assert callable(Triagem.__init__)


def test_hyp_triagem_constructor_args():
...
def test_hyp_triagem_has_febre():
...
def test_hyp_triagem_has_paciente():
...
def test_hyp_triagem_has_altura():
...
def test_hyp_triagem_has_enfermeira():
...
def test_hyp_triagem_has_alergias():
...
def test_hyp_triagem_has_temperatura():
...
def test_hyp_triagem_has_pressao():
...
def test_hyp_triagem_has_sintoma():
...
def test_hyp_enfermeira_is_not_abstract():
    assert not inspect.isabstract(Enfermeira)


def test_hyp_enfermeira_constructor_exists():
    assert callable(Enfermeira.__init__)


def test_hyp_enfermeira_constructor_args():
...
def test_hyp_paciente_has_responsavel():
...
def test_hyp_paciente_has_numeroSus():
...
def test_hyp_atestado_instantiation(instance):
    assert isinstance(instance, Atestado)



@given(instance=Atestado_strategy)
def test_hyp_atestado_quantidadeDias_setter(instance):
...
@given(instance=Atestado_strategy)
def test_hyp_atestado_dataFimDoAtestado_setter(instance):
...
@given(instance=Atestado_strategy)
def test_hyp_atestado_dataInicioDoAtestado_setter(instance):
...
@given(instance=Atestado_strategy)
def test_hyp_atestado_consulta_setter(instance):
...
@given(instance=Consulta_strategy)
def test_hyp_consulta_codigoDiagnostico_setter(instance):
...
@given(instance=Consulta_strategy)
def test_hyp_consulta_medicamentos_setter(instance):
...
@given(instance=Consulta_strategy)
def test_hyp_consulta_triagem_setter(instance):
...
@given(instance=Consulta_strategy)
def test_hyp_consulta_diagnostico_setter(instance):
...
@given(instance=Consulta_strategy)
def test_hyp_consulta_atestado_setter(instance):
...
@settings(max_examples=50)
def test_hyp_triagem_instantiation(instance):
    assert isinstance(instance, Triagem)



@given(instance=Triagem_strategy)
def test_hyp_triagem_IMC_setter(instance):
...
@given(instance=Triagem_strategy)
def test_hyp_triagem_febre_setter(instance):
...
@given(instance=Triagem_strategy)
def test_hyp_triagem_paciente_setter(instance):
...
@given(instance=Triagem_strategy)
def test_hyp_triagem_altura_setter(instance):
...
@given(instance=Triagem_strategy)
def test_hyp_triagem_enfermeira_setter(instance):
...
@given(instance=Triagem_strategy)
def test_hyp_triagem_alergias_setter(instance):
...
@given(instance=Triagem_strategy)
def test_hyp_triagem_temperatura_setter(instance):
...
@given(instance=Triagem_strategy)
def test_hyp_triagem_pressao_setter(instance):
...
@given(instance=Triagem_strategy)
def test_hyp_triagem_sintoma_setter(instance):
...
@given(instance=Triagem_strategy)
def test_hyp_triagem_peso_setter(instance):
...
def test_hyp_enfermeira_cofen_setter(instance):
...
@given(instance=Enfermeira_strategy)
def test_hyp_enfermeira_setor_setter(instance):
...
@given(instance=Medico_strategy)
def test_hyp_medico_especialidade_setter(instance):
...
@given(instance=Medico_strategy)
def test_hyp_medico_setor_setter(instance):
    original = instance.setor
    instance.setor = original
    assert instance.setor == original
...
@given(instance=Paciente_strategy)
def test_hyp_paciente_responsavel_setter(instance):
...
@given(instance=Paciente_strategy)
def test_hyp_paciente_numeroSus_setter(instance):
...
def test_hyp_pessoa_rg_setter(instance):
...
@given(instance=Pessoa_strategy)
def test_hyp_pessoa_telefone_setter(instance):
...
@given(instance=Pessoa_strategy)
def test_hyp_pessoa_estadoCivil_setter(instance):
...
@given(instance=Pessoa_strategy)
def test_hyp_pessoa_endereco_setter(instance):
