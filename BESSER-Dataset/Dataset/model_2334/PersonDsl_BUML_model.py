...
# Classes
personDsl_PersonContainer = Class(name="personDsl_PersonContainer")
personDsl_Person = Class(name="personDsl_Person")
...
personDsl_Person.attributes={personDsl_Person_ID, personDsl_Person_name}
