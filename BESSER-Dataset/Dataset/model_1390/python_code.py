...
class statemachine_Transition:
    ...
    def __init__(self, name: str, statemachine_Transition6: "statemachine_State" = None, statemachine_Transition9: "statemachine_State" = None, statemachine_Transition: "statemachine_MyFSM" = None):
        self.name = name
...
class statemachine_State:
    ...
    def __init__(self, name: str, statemachine_State7: "statemachine_Transition" = None, statemachine_State10: "statemachine_Transition" = None, statemachine_State: "statemachine_MyFSM" = None):
        self.name = name
