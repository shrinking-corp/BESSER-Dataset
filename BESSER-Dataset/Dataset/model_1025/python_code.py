...
class nicoLang_State:
    ...
    def __init__(self, name: str, nicoLang_State8: "nicoLang_Transition" = None, nicoLang_State: "nicoLang_FSM" = None, nicoLang_State5: "nicoLang_Transition" = None):
        self.name = name
...
class nicoLang_Transition:
    ...
    def __init__(self, trigger: str, name: str, nicoLang_Transition7: "nicoLang_State" = None, nicoLang_Transition: "nicoLang_FSM" = None, nicoLang_Transition4: "nicoLang_State" = None):
