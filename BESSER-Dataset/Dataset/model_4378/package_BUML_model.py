...
# Classes
KragsteinPackage_Composition = Class(name="KragsteinPackage_Composition")
KragsteinPackage_Package = Class(name="KragsteinPackage_Package")
KragsteinPackage_Unit = Class(name="KragsteinPackage_Unit", is_abstract=True)
KragsteinPackage_Relationship = Class(name="KragsteinPackage_Relationship", is_abstract=True)
KragsteinPackage_Class = Class(name="KragsteinPackage_Class")
KragsteinPackage_Generalization = Class(name="KragsteinPackage_Generalization")
Relationship = Class(name="Relationship")
KragsteinPackage_Realization = Class(name="KragsteinPackage_Realization")
KragsteinPackage_Association = Class(name="KragsteinPackage_Association")
KragsteinPackage_Aggregation = Class(name="KragsteinPackage_Aggregation")
KragsteinPackage_Dependency = Class(name="KragsteinPackage_Dependency")
KragsteinPackage_Note = Class(name="KragsteinPackage_Note")
Unit = Class(name="Unit")
KragsteinPackage_Attribute = Class(name="KragsteinPackage_Attribute")
KragsteinPackage_Method = Class(name="KragsteinPackage_Method")
KragsteinPackage_ImportedClass = Class(name="KragsteinPackage_ImportedClass")
KragsteinPackage_Parameter = Class(name="KragsteinPackage_Parameter")
KragsteinPackage_Link = Class(name="KragsteinPackage_Link")
...
KragsteinPackage_Package.attributes={KragsteinPackage_Package_path, KragsteinPackage_Package_name}
...
KragsteinPackage_Relationship.attributes={KragsteinPackage_Relationship_name, KragsteinPackage_Relationship_lowerBound, KragsteinPackage_Relationship_upperBound}
...
KragsteinPackage_Class.attributes={KragsteinPackage_Class_isSingletone, KragsteinPackage_Class_name, KragsteinPackage_Class_supplierElement, KragsteinPackage_Class_visibility, KragsteinPackage_Class_isInterface, KragsteinPackage_Class_superClass}
...
KragsteinPackage_Note.attributes={KragsteinPackage_Note_name, KragsteinPackage_Note_text}
...
KragsteinPackage_Attribute.attributes={KragsteinPackage_Attribute_isStatic, KragsteinPackage_Attribute_visibility, KragsteinPackage_Attribute_value, KragsteinPackage_Attribute_type, KragsteinPackage_Attribute_isConst, KragsteinPackage_Attribute_name}
...
KragsteinPackage_Method.attributes={KragsteinPackage_Method_name, KragsteinPackage_Method_isVirtual, KragsteinPackage_Method_visibility, KragsteinPackage_Method_type, KragsteinPackage_Method_isConst, KragsteinPackage_Method_isStatic}
...
KragsteinPackage_Parameter.attributes={KragsteinPackage_Parameter_type, KragsteinPackage_Parameter_name, KragsteinPackage_Parameter_value}
...
domain_model = DomainModel(
    ...
    types={KragsteinPackage_Composition, KragsteinPackage_Package, KragsteinPackage_Unit, KragsteinPackage_Relationship, KragsteinPackage_Class, KragsteinPackage_Generalization, Relationship, KragsteinPackage_Realization, KragsteinPackage_Association, KragsteinPackage_Aggregation, KragsteinPackage_Dependency, KragsteinPackage_Note, Unit, KragsteinPackage_Attribute, KragsteinPackage_Method, KragsteinPackage_ImportedClass, KragsteinPackage_Parameter, KragsteinPackage_Link},
    associations={unit0, target1, source2, targetLink16, attribute5, method7, targetRelationship9, importedClass12, parameter14, source18, target21},
    generalizations={gen_KragsteinPackage_Composition_Relationship, gen_KragsteinPackage_Generalization_Relationship, gen_KragsteinPackage_Realization_Relationship, gen_KragsteinPackage_Association_Relationship, gen_KragsteinPackage_Aggregation_Relationship, gen_KragsteinPackage_Dependency_Relationship, gen_KragsteinPackage_Note_Unit, gen_KragsteinPackage_Class_Unit},
    metadata=None
)
