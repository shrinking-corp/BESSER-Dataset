...
class RDBMS_Key:
    ...
    def __init__(self, name: str, hasKey: "RDBMS_Table" = None, hasKey21: set["RDBMS_Column"] = None, refersTo: set["RDBMS_ForeignKey"] = None, Key28: "RDBMS_ForeignKey" = None, Key: "RDBMS_Table" = None, Key14: "RDBMS_Column" = None):
        self.name = name
        self.hasKey = hasKey
...
class RDBMS_Column:
    ...
    def __init__(self, name: str, type: str, column16: set["RDBMS_ForeignKey"] = None, Column22: "RDBMS_Key" = None, Column: "RDBMS_Table" = None, column: "RDBMS_Table" = None, column13: set["RDBMS_Key"] = None, Column33: "RDBMS_ForeignKey" = None):
        self.name = name
        self.type = type
...
class RDBMS_ForeignKey:
    ...
    def __init__(self, name: str, ForeignKey17: "RDBMS_Column" = None, ForeignKey24: "RDBMS_Key" = None, foreignKey: "RDBMS_Schema" = None, referredBy: "RDBMS_Key" = None, ForeignKey: "RDBMS_Schema" = None, ForeignKey9: "RDBMS_Table" = None, hasForeignKey: "RDBMS_Table" = None, hasForeignKey32: set["RDBMS_Column"] = None):
        self.name = name
...
class RDBMS_Table:
    ...
    def __init__(self, name: str, Table19: "RDBMS_Key" = None, Table: "RDBMS_Schema" = None, table: "RDBMS_Schema" = None, owner: set["RDBMS_Column"] = None, owner6: "RDBMS_Key" = None, owner8: set["RDBMS_ForeignKey"] = None, Table11: "RDBMS_Column" = None, Table30: "RDBMS_ForeignKey" = None):
        self.name = name
...
class RDBMS_Schema:
    ...
    def __init__(self, name: str, Schema26: "RDBMS_ForeignKey" = None, schema: set["RDBMS_Table"] = None, schema2: set["RDBMS_ForeignKey"] = None, Schema: "RDBMS_Table" = None):
        self.name = name
