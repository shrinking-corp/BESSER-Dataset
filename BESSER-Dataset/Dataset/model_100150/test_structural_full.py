...
def test_connection_MetadataColumn_defaultValue_value_roundtrip():
    instance = connection_MetadataColumn(defaultValue="sample_text", displayField="sample_text", key=True, length=7, nullable=True, originalField="sample_text", pattern="sample_text", precision=7, sourceType="sample_text", talendType="sample_text")
...
def test_assoc_columns6_link_reassign_clear():
    ...
    b1 = connection_MetadataColumn(defaultValue="sample_text", displayField="sample_text", key=True, length=7, nullable=True, originalField="sample_text", pattern="sample_text", precision=7, sourceType="sample_text", talendType="sample_text")
    b2 = connection_MetadataColumn(defaultValue="sample_text_2", displayField="sample_text_2", key=False, length=13, nullable=False, originalField="sample_text_2", pattern="sample_text_2", precision=13, sourceType="sample_text_2", talendType="sample_text_2")
...
connection_MetadataColumn_strategy = st.builds(connection_MetadataColumn, defaultValue=safe_text, displayField=safe_text, key=st.booleans(), length=st.integers(), nullable=st.booleans(), originalField=safe_text, pattern=safe_text, precision=st.integers(), sourceType=safe_text, talendType=safe_text)
