...
class roverDSL_Colors:
    ...
    def __init__(self, color: str, roverDSL_Colors7: "roverDSL_Mission" = None, roverDSL_Colors: "roverDSL_Mission" = None):
        self.color = color
...
class roverDSL_Mission:
    ...
    def __init__(self, id: str, roverDSL_Mission4: "roverDSL_DetectBottle" = None, roverDSL_Mission6: "roverDSL_Colors" = None, roverDSL_Mission: "roverDSL_Robot" = None, roverDSL_Mission2: "roverDSL_Colors" = None):
        self.id = id
