...
roverDSL_Mission = Class(name="roverDSL_Mission")
roverDSL_Colors = Class(name="roverDSL_Colors")
roverDSL_DetectBottle = Class(name="roverDSL_DetectBottle")
...
roverDSL_Robot.attributes={roverDSL_Robot_defaultSpeed, roverDSL_Robot_maxAngle, roverDSL_Robot_minAngle, roverDSL_Robot_slowSpeed}
...
domain_model = DomainModel(
    ...
    associations={bottle3, avoid5, mission0, find1},
    generalizations={},
    metadata=None
)
