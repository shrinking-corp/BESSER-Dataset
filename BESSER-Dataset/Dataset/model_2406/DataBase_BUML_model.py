...
database_Unique = Class(name="database_Unique")
...
database_DataBase_m_getTable: Method = Method(name="getTable", parameters={Parameter(name='database_tableName', type=StringType)}, type=StringType)
...
database_Table_m_getColumn: Method = Method(name="getColumn", parameters={Parameter(name='database_columnName', type=StringType)}, type=StringType)
database_Table_m_getIndex: Method = Method(name="getIndex", parameters={Parameter(name='database_indexName', type=StringType)}, type=StringType)
database_Table.attributes={database_Table_collation, database_Table_storageEngine}
database_Table.methods={database_Table_m_getColumn, database_Table_m_getIndex}
...
database_Column.attributes={database_Column_default, database_Column_collation, database_Column_length, database_Column_type, database_Column_nullable}
...
domain_model = DomainModel(
    name="database",
    types={database_Index, database_PrimaryKey, database_Unique, Index, database_DataBase, database_Table, NamedElement, database_Column, database_NamedElement},
    associations={indexes6, primaryKey8, uniques10, tables0, dataBase1, columns4, columns12},
    generalizations={gen_database_Column_NamedElement, gen_database_PrimaryKey_Index, gen_database_Index_NamedElement, gen_database_Table_NamedElement, gen_database_Unique_Index},
    metadata=None
)
