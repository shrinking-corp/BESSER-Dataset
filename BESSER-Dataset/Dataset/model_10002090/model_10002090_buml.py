...
Customer.attributes={Customer_name, Customer_emailAddress, Customer_dateOfBirth, Customer_phoneNumber, Customer_address}
...
Account.attributes={Account_accountNo, Account_type, Account_balance}
...
Transaction.attributes={Transaction_amount, Transaction_id, Transaction_transactionTime, Transaction_type}
...
Login.attributes={Login_password, Login_username, Login_securityAnswer, Login_lastLoginTime, Login_securityQuestion}
...
CertificatesOfDepositAccount.attributes={CertificatesOfDepositAccount_timePeriod, CertificatesOfDepositAccount_interestRate}
...
domain_model = DomainModel(
    name="_nk28kHghEeqeQcxm9hmzHw",
    types={Customer, Account, Transaction, CheckingAccount, SavingsAccount, Login, DepositTransaction, WithdrawTransaction, TransferTransaction, CertificatesOfDepositAccount, AccountType, TransactionType},
