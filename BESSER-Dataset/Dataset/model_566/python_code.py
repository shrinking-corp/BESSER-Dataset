...
class tutorial_Loan:
    ...
    def __init__(self, date: date, tutorial_Loan6: "tutorial_Book" = None, tutorial_Loan10: "tutorial_Member" = None, tutorial_Loan15: "tutorial_Book" = None, tutorial_Loan: "tutorial_Library" = None, tutorial_Loan18: "tutorial_Member" = None):
        self.date = date
...
class tutorial_Book:
    ...
    def __init__(self, name: str, copies: str, books: "tutorial_Library" = None, tutorial_Book: set["tutorial_Loan"] = None, tutorial_Book13: "tutorial_Member" = None, tutorial_Book16: "tutorial_Loan" = None, Book: "tutorial_Library" = None):
        self.name = name
        self.copies = copies
        self.books = books
...
class tutorial_Library:
    ...
    def __init__(self, name: str, Library: "tutorial_Book" = None, Library8: "tutorial_Member" = None, library: set["tutorial_Book"] = None, tutorial_Library: set["tutorial_Loan"] = None, library3: set["tutorial_Member"] = None):
        self.name = name
