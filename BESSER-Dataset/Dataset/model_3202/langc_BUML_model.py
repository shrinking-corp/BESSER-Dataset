...
# Classes
langc_NamedElement = Class(name="langc_NamedElement", is_abstract=True)
UserElement = Class(name="UserElement")
BindableValue = Class(name="BindableValue")
langc_Name = Class(name="langc_Name")
langc_ElementList = Class(name="langc_ElementList")
langc_UserElement = Class(name="langc_UserElement", is_abstract=True)
langc_BuiltInType = Class(name="langc_BuiltInType")
Element = Class(name="Element")
langc_FileName = Class(name="langc_FileName")
langc_DependencyList = Class(name="langc_DependencyList")
langc_Directive = Class(name="langc_Directive", is_abstract=True)
langc_Struct = Class(name="langc_Struct")
Structure = Class(name="Structure")
langc_Union = Class(name="langc_Union")
langc_Function = Class(name="langc_Function")
NamedElement = Class(name="NamedElement")
langc_ElementReference = Class(name="langc_ElementReference")
langc_NamedReference = Class(name="langc_NamedReference")
langc_FunctionImplementation = Class(name="langc_FunctionImplementation")
langc_Element = Class(name="langc_Element", is_abstract=True)
langc_Expression = Class(name="langc_Expression")
langc_FunctionCall = Class(name="langc_FunctionCall")
Expression = Class(name="Expression")
langc_ElementAccess = Class(name="langc_ElementAccess")
langc_Structure = Class(name="langc_Structure", is_abstract=True)
langc_FunctionPointer = Class(name="langc_FunctionPointer")
langc_FunctionAddress = Class(name="langc_FunctionAddress")
langc_Literal = Class(name="langc_Literal", is_abstract=True)
langc_IntegralLiteral = Class(name="langc_IntegralLiteral")
Literal = Class(name="Literal")
langc_CharacterLiteral = Class(name="langc_CharacterLiteral")
langc_FloatingLiteral = Class(name="langc_FloatingLiteral")
langc_Statement = Class(name="langc_Statement", is_abstract=True)
langc_ExpressionStatement = Class(name="langc_ExpressionStatement")
Statement = Class(name="Statement")
langc_ReturnStatement = Class(name="langc_ReturnStatement")
ExpressionStatement = Class(name="ExpressionStatement")
langc_CodeBlock = Class(name="langc_CodeBlock")
langc_BinaryOperation = Class(name="langc_BinaryOperation")
langc_FileDependency = Class(name="langc_FileDependency", is_abstract=True)
Dependency = Class(name="Dependency")
langc_SystemInclude = Class(name="langc_SystemInclude")
FileDependency = Class(name="FileDependency")
langc_UserInclude = Class(name="langc_UserInclude")
Name = Class(name="Name")
langc_CastExpr = Class(name="langc_CastExpr")
langc_VariableDeclaration = Class(name="langc_VariableDeclaration")
langc_Typedef = Class(name="langc_Typedef")
langc_MemberAccess = Class(name="langc_MemberAccess")
ElementAccess = Class(name="ElementAccess")
langc_ExpressionBlob = Class(name="langc_ExpressionBlob")
langc_SubSystem = Class(name="langc_SubSystem")
langc_FolderName = Class(name="langc_FolderName")
langc_Enum = Class(name="langc_Enum")
langc_Enumerator = Class(name="langc_Enumerator")
langc_DereferenceExpr = Class(name="langc_DereferenceExpr")
langc_WhileStatement = Class(name="langc_WhileStatement")
langc_Macro = Class(name="langc_Macro")
Directive = Class(name="Directive")
langc_Dependency = Class(name="langc_Dependency", is_abstract=True)
langc_SizeofType = Class(name="langc_SizeofType")
Sizeof = Class(name="Sizeof")
langc_BindableValue = Class(name="langc_BindableValue", is_abstract=True)
langc_SystemFileName = Class(name="langc_SystemFileName")
FileName = Class(name="FileName")
langc_SwitchClause = Class(name="langc_SwitchClause")
CodeBlock = Class(name="CodeBlock")
langc_LabeledClause = Class(name="langc_LabeledClause")
SwitchClause = Class(name="SwitchClause")
langc_SwitchStatement = Class(name="langc_SwitchStatement")
langc_BreakStatement = Class(name="langc_BreakStatement")
langc_AddressOfExpr = Class(name="langc_AddressOfExpr")
langc_Sizeof = Class(name="langc_Sizeof", is_abstract=True)
langc_System = Class(name="langc_System")
langc_LinkableArtifact = Class(name="langc_LinkableArtifact")
langc_CodeBlob = Class(name="langc_CodeBlob")
langc_DependencyBlob = Class(name="langc_DependencyBlob")
langc_StringLiteral = Class(name="langc_StringLiteral")
langc_VariableDeclarationStatement = Class(name="langc_VariableDeclarationStatement")
langc_BlockInitializer = Class(name="langc_BlockInitializer")
langc_IndexExpr = Class(name="langc_IndexExpr")
langc_LogicalComparison = Class(name="langc_LogicalComparison")
langc_SizeofExpr = Class(name="langc_SizeofExpr")
langc_ConditionalStatement = Class(name="langc_ConditionalStatement")
...
langc_IntegralLiteral.attributes={langc_IntegralLiteral_bytes, langc_IntegralLiteral_value, langc_IntegralLiteral_signed}
...
langc_DependencyBlob.attributes={langc_DependencyBlob_markerComment, langc_DependencyBlob_text}
...
domain_model = DomainModel(
    name="langc",
    types={langc_NamedElement, UserElement, BindableValue, langc_Name, langc_ElementList, langc_UserElement, langc_BuiltInType, Element, langc_FileName, langc_DependencyList, langc_Directive, langc_Struct, Structure, langc_Union, langc_Function, NamedElement, langc_ElementReference, langc_NamedReference, langc_FunctionImplementation, langc_Element, langc_Expression, langc_FunctionCall, Expression, langc_ElementAccess, langc_Structure, langc_FunctionPointer, langc_FunctionAddress, langc_Literal, langc_IntegralLiteral, Literal, langc_CharacterLiteral, langc_FloatingLiteral, langc_Statement, langc_ExpressionStatement, Statement, langc_ReturnStatement, ExpressionStatement, langc_CodeBlock, langc_BinaryOperation, langc_FileDependency, Dependency, langc_SystemInclude, FileDependency, langc_UserInclude, Name, langc_CastExpr, langc_VariableDeclaration, langc_Typedef, langc_MemberAccess, ElementAccess, langc_ExpressionBlob, langc_SubSystem, langc_FolderName, langc_Enum, langc_Enumerator, langc_DereferenceExpr, langc_WhileStatement, langc_Macro, Directive, langc_Dependency, langc_SizeofType, Sizeof, langc_BindableValue, langc_SystemFileName, FileName, langc_SwitchClause, CodeBlock, langc_LabeledClause, SwitchClause, langc_SwitchStatement, langc_BreakStatement, langc_AddressOfExpr, langc_Sizeof, langc_System, langc_LinkableArtifact, langc_CodeBlob, langc_DependencyBlob, langc_StringLiteral, langc_VariableDeclarationStatement, langc_BlockInitializer, langc_IndexExpr, langc_LogicalComparison, langc_SizeofExpr, langc_ConditionalStatement, CVQualifier, PrimitiveType, Operator, Pointer, LinkageSpec, ElementKind, BooleanOperator},
    associations={parent2, name0, elements29, name30, types32, declIncludes35, defnIncludes37, publicDirectives40, privateDirectives42, returnType4, parameters5, defaultImpl7, name9, type12, element15, arrayBounds17, type19, function22, arguments24, name27, members53, returnType55, parameters57, expr45, statements47, lhs48, rhs50, value79, name81, filename84, function60, element62, initializer64, element67, container69, files71, folders73, publicFolders75, enumerators78, expr104, expr106, condition108, parameters110, replacement112, name115, targetType86, expr88, defn91, dependencies94, element96, labels98, clauses100, condition101, body134, function137, subSystems140, publicFolders142, artifacts145, variable118, exprs120, index122, array124, lhs127, rhs129, expr132, dependencies147, functionImplementations148, rootElements151, condition154},
    generalizations={gen_langc_NamedElement_UserElement, gen_langc_NamedElement_BindableValue, gen_langc_BuiltInType_Element, gen_langc_Struct_Structure, gen_langc_Union_Structure, gen_langc_Function_NamedElement, gen_langc_ElementReference_BindableValue, gen_langc_FunctionCall_Expression, gen_langc_ElementAccess_Expression, gen_langc_Structure_NamedElement, gen_langc_FunctionPointer_UserElement, gen_langc_Literal_Expression, gen_langc_IntegralLiteral_Literal, gen_langc_CharacterLiteral_Literal, gen_langc_FloatingLiteral_Literal, gen_langc_ExpressionStatement_Statement, gen_langc_ReturnStatement_ExpressionStatement, gen_langc_CodeBlock_Statement, gen_langc_BinaryOperation_Expression, gen_langc_Enumerator_BindableValue, gen_langc_FileDependency_Dependency, gen_langc_SystemInclude_FileDependency, gen_langc_UserInclude_FileDependency, gen_langc_FileName_Name, gen_langc_FolderName_Name, gen_langc_CastExpr_Expression, gen_langc_FunctionAddress_Expression, gen_langc_VariableDeclaration_NamedElement, gen_langc_Typedef_NamedElement, gen_langc_MemberAccess_ElementAccess, gen_langc_ExpressionBlob_Expression, gen_langc_Enum_NamedElement, gen_langc_DereferenceExpr_Expression, gen_langc_WhileStatement_CodeBlock, gen_langc_Macro_Directive, gen_langc_Macro_BindableValue, gen_langc_UserElement_Element, gen_langc_SizeofType_Sizeof, gen_langc_SystemFileName_FileName, gen_langc_SwitchClause_CodeBlock, gen_langc_LabeledClause_SwitchClause, gen_langc_SwitchStatement_Statement, gen_langc_BreakStatement_Statement, gen_langc_AddressOfExpr_Expression, gen_langc_Sizeof_Expression, gen_langc_FunctionImplementation_UserElement, gen_langc_CodeBlob_CodeBlock, gen_langc_StringLiteral_Expression, gen_langc_VariableDeclarationStatement_Statement, gen_langc_BlockInitializer_Expression, gen_langc_IndexExpr_Expression, gen_langc_LogicalComparison_Expression, gen_langc_SizeofExpr_Sizeof, gen_langc_DependencyBlob_Dependency, gen_langc_ConditionalStatement_CodeBlock},
    metadata=None
)
