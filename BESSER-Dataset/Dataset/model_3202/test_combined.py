...
def test_hyp_langc_linkableartifact_is_not_abstract():
    assert not inspect.isabstract(langc_LinkableArtifact)


def test_hyp_langc_linkableartifact_constructor_exists():
    assert callable(langc_LinkableArtifact.__init__)


def test_hyp_langc_linkableartifact_constructor_args():
...
def test_hyp_langc_system_is_not_abstract():
    assert not inspect.isabstract(langc_System)


def test_hyp_langc_system_constructor_exists():
    assert callable(langc_System.__init__)


def test_hyp_langc_system_constructor_args():
    sig = inspect.signature(langc_System.__init__)
    params = list(sig.parameters.keys())



def test_hyp_switchclause_is_not_abstract():
    assert not inspect.isabstract(SwitchClause)


def test_hyp_switchclause_constructor_exists():
    assert callable(SwitchClause.__init__)


def test_hyp_switchclause_constructor_args():
    sig = inspect.signature(SwitchClause.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_labeledclause_is_not_abstract():
    assert not inspect.isabstract(langc_LabeledClause)


def test_hyp_langc_labeledclause_constructor_exists():
    assert callable(langc_LabeledClause.__init__)


def test_hyp_langc_labeledclause_constructor_args():
...
def test_hyp_langc_conditionalstatement_is_not_abstract():
    assert not inspect.isabstract(langc_ConditionalStatement)


def test_hyp_langc_conditionalstatement_constructor_exists():
    assert callable(langc_ConditionalStatement.__init__)


def test_hyp_langc_conditionalstatement_constructor_args():
    sig = inspect.signature(langc_ConditionalStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_codeblob_is_not_abstract():
    assert not inspect.isabstract(langc_CodeBlob)


def test_hyp_langc_codeblob_constructor_exists():
    assert callable(langc_CodeBlob.__init__)


def test_hyp_langc_codeblob_constructor_args():
...
def test_hyp_langc_switchclause_is_not_abstract():
    assert not inspect.isabstract(langc_SwitchClause)


def test_hyp_langc_switchclause_constructor_exists():
    assert callable(langc_SwitchClause.__init__)


def test_hyp_langc_switchclause_constructor_args():
...
def test_hyp_langc_systemfilename_is_not_abstract():
    assert not inspect.isabstract(langc_SystemFileName)


def test_hyp_langc_systemfilename_constructor_exists():
    assert callable(langc_SystemFileName.__init__)


def test_hyp_langc_systemfilename_constructor_args():
    sig = inspect.signature(langc_SystemFileName.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_bindablevalue_is_not_abstract():
    assert not inspect.isabstract(langc_BindableValue)


def test_hyp_langc_bindablevalue_constructor_exists():
    assert callable(langc_BindableValue.__init__)


def test_hyp_langc_bindablevalue_constructor_args():
    sig = inspect.signature(langc_BindableValue.__init__)
    params = list(sig.parameters.keys())



def test_hyp_sizeof_is_not_abstract():
    assert not inspect.isabstract(Sizeof)


def test_hyp_sizeof_constructor_exists():
    assert callable(Sizeof.__init__)


def test_hyp_sizeof_constructor_args():
    sig = inspect.signature(Sizeof.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_sizeofexpr_is_not_abstract():
    assert not inspect.isabstract(langc_SizeofExpr)


def test_hyp_langc_sizeofexpr_constructor_exists():
    assert callable(langc_SizeofExpr.__init__)


def test_hyp_langc_sizeofexpr_constructor_args():
    sig = inspect.signature(langc_SizeofExpr.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_sizeoftype_is_not_abstract():
    assert not inspect.isabstract(langc_SizeofType)


def test_hyp_langc_sizeoftype_constructor_exists():
    assert callable(langc_SizeofType.__init__)


def test_hyp_langc_sizeoftype_constructor_args():
    sig = inspect.signature(langc_SizeofType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_dependency_is_not_abstract():
    assert not inspect.isabstract(langc_Dependency)


def test_hyp_langc_dependency_constructor_exists():
    assert callable(langc_Dependency.__init__)


def test_hyp_langc_dependency_constructor_args():
...
def test_hyp_langc_whilestatement_is_not_abstract():
    assert not inspect.isabstract(langc_WhileStatement)


def test_hyp_langc_whilestatement_constructor_exists():
    assert callable(langc_WhileStatement.__init__)


def test_hyp_langc_whilestatement_constructor_args():
    sig = inspect.signature(langc_WhileStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_subsystem_is_not_abstract():
    assert not inspect.isabstract(langc_SubSystem)


def test_hyp_langc_subsystem_constructor_exists():
    assert callable(langc_SubSystem.__init__)


def test_hyp_langc_subsystem_constructor_args():
...
def test_hyp_langc_memberaccess_is_not_abstract():
    assert not inspect.isabstract(langc_MemberAccess)


def test_hyp_langc_memberaccess_constructor_exists():
    assert callable(langc_MemberAccess.__init__)


def test_hyp_langc_memberaccess_constructor_args():
...
def test_hyp_langc_foldername_is_not_abstract():
    assert not inspect.isabstract(langc_FolderName)


def test_hyp_langc_foldername_constructor_exists():
    assert callable(langc_FolderName.__init__)


def test_hyp_langc_foldername_constructor_args():
...
def test_hyp_filedependency_is_not_abstract():
    assert not inspect.isabstract(FileDependency)


def test_hyp_filedependency_constructor_exists():
    assert callable(FileDependency.__init__)


def test_hyp_filedependency_constructor_args():
    sig = inspect.signature(FileDependency.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_userinclude_is_not_abstract():
    assert not inspect.isabstract(langc_UserInclude)


def test_hyp_langc_userinclude_constructor_exists():
    assert callable(langc_UserInclude.__init__)


def test_hyp_langc_userinclude_constructor_args():
    sig = inspect.signature(langc_UserInclude.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_systeminclude_is_not_abstract():
    assert not inspect.isabstract(langc_SystemInclude)


def test_hyp_langc_systeminclude_constructor_exists():
    assert callable(langc_SystemInclude.__init__)


def test_hyp_langc_systeminclude_constructor_args():
...
def test_hyp_langc_dependencyblob_is_not_abstract():
    assert not inspect.isabstract(langc_DependencyBlob)


def test_hyp_langc_dependencyblob_constructor_exists():
    assert callable(langc_DependencyBlob.__init__)


def test_hyp_langc_dependencyblob_constructor_args():
...
def test_hyp_langc_filedependency_is_not_abstract():
    assert not inspect.isabstract(langc_FileDependency)


def test_hyp_langc_filedependency_constructor_exists():
    assert callable(langc_FileDependency.__init__)


def test_hyp_langc_filedependency_constructor_args():
...
def test_hyp_langc_returnstatement_is_not_abstract():
    assert not inspect.isabstract(langc_ReturnStatement)


def test_hyp_langc_returnstatement_constructor_exists():
    assert callable(langc_ReturnStatement.__init__)


def test_hyp_langc_returnstatement_constructor_args():
...
def test_hyp_langc_switchstatement_is_not_abstract():
    assert not inspect.isabstract(langc_SwitchStatement)


def test_hyp_langc_switchstatement_constructor_exists():
    assert callable(langc_SwitchStatement.__init__)


def test_hyp_langc_switchstatement_constructor_args():
    sig = inspect.signature(langc_SwitchStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_variabledeclarationstatement_is_not_abstract():
    assert not inspect.isabstract(langc_VariableDeclarationStatement)


def test_hyp_langc_variabledeclarationstatement_constructor_exists():
    assert callable(langc_VariableDeclarationStatement.__init__)


def test_hyp_langc_variabledeclarationstatement_constructor_args():
    sig = inspect.signature(langc_VariableDeclarationStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_breakstatement_is_not_abstract():
    assert not inspect.isabstract(langc_BreakStatement)


def test_hyp_langc_breakstatement_constructor_exists():
    assert callable(langc_BreakStatement.__init__)


def test_hyp_langc_breakstatement_constructor_args():
    sig = inspect.signature(langc_BreakStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_codeblock_is_not_abstract():
    assert not inspect.isabstract(langc_CodeBlock)


def test_hyp_langc_codeblock_constructor_exists():
    assert callable(langc_CodeBlock.__init__)


def test_hyp_langc_codeblock_constructor_args():
...
def test_hyp_langc_expressionstatement_is_not_abstract():
    assert not inspect.isabstract(langc_ExpressionStatement)


def test_hyp_langc_expressionstatement_constructor_exists():
    assert callable(langc_ExpressionStatement.__init__)


def test_hyp_langc_expressionstatement_constructor_args():
    sig = inspect.signature(langc_ExpressionStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_statement_is_not_abstract():
    assert not inspect.isabstract(langc_Statement)


def test_hyp_langc_statement_constructor_exists():
    assert callable(langc_Statement.__init__)


def test_hyp_langc_statement_constructor_args():
...
def test_hyp_langc_characterliteral_is_not_abstract():
    assert not inspect.isabstract(langc_CharacterLiteral)


def test_hyp_langc_characterliteral_constructor_exists():
    assert callable(langc_CharacterLiteral.__init__)


def test_hyp_langc_characterliteral_constructor_args():
...
def test_hyp_langc_floatingliteral_is_not_abstract():
    assert not inspect.isabstract(langc_FloatingLiteral)


def test_hyp_langc_floatingliteral_constructor_exists():
    assert callable(langc_FloatingLiteral.__init__)


def test_hyp_langc_floatingliteral_constructor_args():
...
def test_hyp_langc_integralliteral_is_not_abstract():
    assert not inspect.isabstract(langc_IntegralLiteral)


def test_hyp_langc_integralliteral_constructor_exists():
    assert callable(langc_IntegralLiteral.__init__)


def test_hyp_langc_integralliteral_constructor_args():
...
def test_hyp_langc_functionaddress_is_not_abstract():
    assert not inspect.isabstract(langc_FunctionAddress)


def test_hyp_langc_functionaddress_constructor_exists():
    assert callable(langc_FunctionAddress.__init__)


def test_hyp_langc_functionaddress_constructor_args():
    sig = inspect.signature(langc_FunctionAddress.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_expressionblob_is_not_abstract():
    assert not inspect.isabstract(langc_ExpressionBlob)


def test_hyp_langc_expressionblob_constructor_exists():
    assert callable(langc_ExpressionBlob.__init__)


def test_hyp_langc_expressionblob_constructor_args():
...
def test_hyp_langc_literal_is_not_abstract():
    assert not inspect.isabstract(langc_Literal)


def test_hyp_langc_literal_constructor_exists():
    assert callable(langc_Literal.__init__)


def test_hyp_langc_literal_constructor_args():
...
def test_hyp_langc_sizeof_is_not_abstract():
    assert not inspect.isabstract(langc_Sizeof)


def test_hyp_langc_sizeof_constructor_exists():
    assert callable(langc_Sizeof.__init__)


def test_hyp_langc_sizeof_constructor_args():
    sig = inspect.signature(langc_Sizeof.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_elementaccess_is_not_abstract():
    assert not inspect.isabstract(langc_ElementAccess)


def test_hyp_langc_elementaccess_constructor_exists():
    assert callable(langc_ElementAccess.__init__)


def test_hyp_langc_elementaccess_constructor_args():
    sig = inspect.signature(langc_ElementAccess.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_logicalcomparison_is_not_abstract():
    assert not inspect.isabstract(langc_LogicalComparison)


def test_hyp_langc_logicalcomparison_constructor_exists():
    assert callable(langc_LogicalComparison.__init__)


def test_hyp_langc_logicalcomparison_constructor_args():
...
def test_hyp_langc_indexexpr_is_not_abstract():
    assert not inspect.isabstract(langc_IndexExpr)


def test_hyp_langc_indexexpr_constructor_exists():
    assert callable(langc_IndexExpr.__init__)


def test_hyp_langc_indexexpr_constructor_args():
    sig = inspect.signature(langc_IndexExpr.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_castexpr_is_not_abstract():
    assert not inspect.isabstract(langc_CastExpr)


def test_hyp_langc_castexpr_constructor_exists():
    assert callable(langc_CastExpr.__init__)


def test_hyp_langc_castexpr_constructor_args():
    sig = inspect.signature(langc_CastExpr.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_stringliteral_is_not_abstract():
    assert not inspect.isabstract(langc_StringLiteral)


def test_hyp_langc_stringliteral_constructor_exists():
    assert callable(langc_StringLiteral.__init__)


def test_hyp_langc_stringliteral_constructor_args():
...
def test_hyp_langc_binaryoperation_is_not_abstract():
    assert not inspect.isabstract(langc_BinaryOperation)


def test_hyp_langc_binaryoperation_constructor_exists():
    assert callable(langc_BinaryOperation.__init__)


def test_hyp_langc_binaryoperation_constructor_args():
...
def test_hyp_langc_blockinitializer_is_not_abstract():
    assert not inspect.isabstract(langc_BlockInitializer)


def test_hyp_langc_blockinitializer_constructor_exists():
    assert callable(langc_BlockInitializer.__init__)


def test_hyp_langc_blockinitializer_constructor_args():
    sig = inspect.signature(langc_BlockInitializer.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_addressofexpr_is_not_abstract():
    assert not inspect.isabstract(langc_AddressOfExpr)


def test_hyp_langc_addressofexpr_constructor_exists():
    assert callable(langc_AddressOfExpr.__init__)


def test_hyp_langc_addressofexpr_constructor_args():
    sig = inspect.signature(langc_AddressOfExpr.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_dereferenceexpr_is_not_abstract():
    assert not inspect.isabstract(langc_DereferenceExpr)


def test_hyp_langc_dereferenceexpr_constructor_exists():
    assert callable(langc_DereferenceExpr.__init__)


def test_hyp_langc_dereferenceexpr_constructor_args():
    sig = inspect.signature(langc_DereferenceExpr.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_functioncall_is_not_abstract():
    assert not inspect.isabstract(langc_FunctionCall)


def test_hyp_langc_functioncall_constructor_exists():
    assert callable(langc_FunctionCall.__init__)


def test_hyp_langc_functioncall_constructor_args():
    sig = inspect.signature(langc_FunctionCall.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_expression_is_not_abstract():
    assert not inspect.isabstract(langc_Expression)


def test_hyp_langc_expression_constructor_exists():
    assert callable(langc_Expression.__init__)


def test_hyp_langc_expression_constructor_args():
...
def test_hyp_langc_element_is_not_abstract():
    assert not inspect.isabstract(langc_Element)


def test_hyp_langc_element_constructor_exists():
    assert callable(langc_Element.__init__)


def test_hyp_langc_element_constructor_args():
    sig = inspect.signature(langc_Element.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_namedreference_is_not_abstract():
    assert not inspect.isabstract(langc_NamedReference)


def test_hyp_langc_namedreference_constructor_exists():
    assert callable(langc_NamedReference.__init__)


def test_hyp_langc_namedreference_constructor_args():
...
def test_hyp_langc_enum_is_not_abstract():
    assert not inspect.isabstract(langc_Enum)


def test_hyp_langc_enum_constructor_exists():
    assert callable(langc_Enum.__init__)


def test_hyp_langc_enum_constructor_args():
    sig = inspect.signature(langc_Enum.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_structure_is_not_abstract():
    assert not inspect.isabstract(langc_Structure)


def test_hyp_langc_structure_constructor_exists():
    assert callable(langc_Structure.__init__)


def test_hyp_langc_structure_constructor_args():
    sig = inspect.signature(langc_Structure.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_variabledeclaration_is_not_abstract():
    assert not inspect.isabstract(langc_VariableDeclaration)


def test_hyp_langc_variabledeclaration_constructor_exists():
    assert callable(langc_VariableDeclaration.__init__)


def test_hyp_langc_variabledeclaration_constructor_args():
...
def test_hyp_langc_typedef_is_not_abstract():
    assert not inspect.isabstract(langc_Typedef)


def test_hyp_langc_typedef_constructor_exists():
    assert callable(langc_Typedef.__init__)


def test_hyp_langc_typedef_constructor_args():
    sig = inspect.signature(langc_Typedef.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_function_is_not_abstract():
    assert not inspect.isabstract(langc_Function)


def test_hyp_langc_function_constructor_exists():
    assert callable(langc_Function.__init__)


def test_hyp_langc_function_constructor_args():
...
def test_hyp_langc_union_is_not_abstract():
    assert not inspect.isabstract(langc_Union)


def test_hyp_langc_union_constructor_exists():
    assert callable(langc_Union.__init__)


def test_hyp_langc_union_constructor_args():
    sig = inspect.signature(langc_Union.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_struct_is_not_abstract():
    assert not inspect.isabstract(langc_Struct)


def test_hyp_langc_struct_constructor_exists():
    assert callable(langc_Struct.__init__)


def test_hyp_langc_struct_constructor_args():
    sig = inspect.signature(langc_Struct.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_directive_is_not_abstract():
    assert not inspect.isabstract(langc_Directive)


def test_hyp_langc_directive_constructor_exists():
    assert callable(langc_Directive.__init__)


def test_hyp_langc_directive_constructor_args():
    sig = inspect.signature(langc_Directive.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_dependencylist_is_not_abstract():
    assert not inspect.isabstract(langc_DependencyList)


def test_hyp_langc_dependencylist_constructor_exists():
    assert callable(langc_DependencyList.__init__)


def test_hyp_langc_dependencylist_constructor_args():
    sig = inspect.signature(langc_DependencyList.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_filename_is_not_abstract():
    assert not inspect.isabstract(langc_FileName)


def test_hyp_langc_filename_constructor_exists():
    assert callable(langc_FileName.__init__)


def test_hyp_langc_filename_constructor_args():
...
def test_hyp_langc_builtintype_is_not_abstract():
    assert not inspect.isabstract(langc_BuiltInType)


def test_hyp_langc_builtintype_constructor_exists():
    assert callable(langc_BuiltInType.__init__)


def test_hyp_langc_builtintype_constructor_args():
...
def test_hyp_langc_userelement_is_not_abstract():
    assert not inspect.isabstract(langc_UserElement)


def test_hyp_langc_userelement_constructor_exists():
    assert callable(langc_UserElement.__init__)


def test_hyp_langc_userelement_constructor_args():
...
def test_hyp_langc_elementlist_is_not_abstract():
    assert not inspect.isabstract(langc_ElementList)


def test_hyp_langc_elementlist_constructor_exists():
    assert callable(langc_ElementList.__init__)


def test_hyp_langc_elementlist_constructor_args():
    sig = inspect.signature(langc_ElementList.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_name_is_not_abstract():
    assert not inspect.isabstract(langc_Name)


def test_hyp_langc_name_constructor_exists():
    assert callable(langc_Name.__init__)


def test_hyp_langc_name_constructor_args():
...
def test_hyp_bindablevalue_is_not_abstract():
    assert not inspect.isabstract(BindableValue)


def test_hyp_bindablevalue_constructor_exists():
    assert callable(BindableValue.__init__)


def test_hyp_bindablevalue_constructor_args():
    sig = inspect.signature(BindableValue.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_elementreference_is_not_abstract():
    assert not inspect.isabstract(langc_ElementReference)


def test_hyp_langc_elementreference_constructor_exists():
    assert callable(langc_ElementReference.__init__)


def test_hyp_langc_elementreference_constructor_args():
...
def test_hyp_langc_enumerator_is_not_abstract():
    assert not inspect.isabstract(langc_Enumerator)


def test_hyp_langc_enumerator_constructor_exists():
    assert callable(langc_Enumerator.__init__)


def test_hyp_langc_enumerator_constructor_args():
    sig = inspect.signature(langc_Enumerator.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_macro_is_not_abstract():
    assert not inspect.isabstract(langc_Macro)


def test_hyp_langc_macro_constructor_exists():
    assert callable(langc_Macro.__init__)


def test_hyp_langc_macro_constructor_args():
    sig = inspect.signature(langc_Macro.__init__)
    params = list(sig.parameters.keys())



def test_hyp_userelement_is_not_abstract():
    assert not inspect.isabstract(UserElement)


def test_hyp_userelement_constructor_exists():
    assert callable(UserElement.__init__)


def test_hyp_userelement_constructor_args():
    sig = inspect.signature(UserElement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_functionimplementation_is_not_abstract():
    assert not inspect.isabstract(langc_FunctionImplementation)


def test_hyp_langc_functionimplementation_constructor_exists():
    assert callable(langc_FunctionImplementation.__init__)


def test_hyp_langc_functionimplementation_constructor_args():
    sig = inspect.signature(langc_FunctionImplementation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_functionpointer_is_not_abstract():
    assert not inspect.isabstract(langc_FunctionPointer)


def test_hyp_langc_functionpointer_constructor_exists():
    assert callable(langc_FunctionPointer.__init__)


def test_hyp_langc_functionpointer_constructor_args():
    sig = inspect.signature(langc_FunctionPointer.__init__)
    params = list(sig.parameters.keys())



def test_hyp_langc_namedelement_is_not_abstract():
    assert not inspect.isabstract(langc_NamedElement)


def test_hyp_langc_namedelement_constructor_exists():
    assert callable(langc_NamedElement.__init__)


def test_hyp_langc_namedelement_constructor_args():
...
def test_hyp_linkagespec_exists():
    # Check that the Enumeration exists
    assert LinkageSpec is not None

def test_hyp_linkagespec_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_cvqualifier_exists():
    # Check that the Enumeration exists
    assert CVQualifier is not None

def test_hyp_cvqualifier_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_pointer_exists():
    # Check that the Enumeration exists
    assert Pointer is not None

def test_hyp_pointer_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_langc_linkableartifact_name_setter(instance):
...
def test_hyp_langc_codeblob_text_setter(instance):
...
@given(instance=langc_CodeBlob_strategy)
def test_hyp_langc_codeblob_markerComment_setter(instance):
...
def test_hyp_langc_switchclause_fallthrough_setter(instance):
...
def test_hyp_langc_subsystem_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_langc_foldername_api_setter(instance):
...
def test_hyp_langc_dependencyblob_text_setter(instance):
    original = instance.text
    instance.text = original
    assert instance.text == original
...
@given(instance=langc_DependencyBlob_strategy)
def test_hyp_langc_dependencyblob_markerComment_setter(instance):
    original = instance.markerComment
    instance.markerComment = original
    assert instance.markerComment == original
...
def test_hyp_langc_codeblock_forceBraces_setter(instance):
...
def test_hyp_langc_characterliteral_value_setter(instance):
...
def test_hyp_langc_floatingliteral_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_langc_integralliteral_bytes_setter(instance):
...
@given(instance=langc_IntegralLiteral_strategy)
def test_hyp_langc_integralliteral_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
@given(instance=langc_IntegralLiteral_strategy)
def test_hyp_langc_integralliteral_signed_setter(instance):
...
def test_hyp_langc_expressionblob_text_setter(instance):
    original = instance.text
    instance.text = original
    assert instance.text == original
...
def test_hyp_langc_literal_primitiveType_setter(instance):
...
def test_hyp_langc_logicalcomparison_operator_setter(instance):
...
def test_hyp_langc_stringliteral_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_langc_binaryoperation_operator_setter(instance):
    original = instance.operator
    instance.operator = original
    assert instance.operator == original
...
def test_hyp_langc_expression_precendence_setter(instance):
...
def test_hyp_langc_variabledeclaration_linkage_setter(instance):
...
def test_hyp_langc_function_linkage_setter(instance):
    original = instance.linkage
    instance.linkage = original
    assert instance.linkage == original
...
def test_hyp_langc_filename_hasObjectCode_setter(instance):
...
def test_hyp_langc_builtintype_type_setter(instance):
...
def test_hyp_langc_userelement_kind_setter(instance):
...
def test_hyp_langc_name_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_langc_elementreference_cvQualifier_setter(instance):
...
@given(instance=langc_ElementReference_strategy)
def test_hyp_langc_elementreference_pointerSpec_setter(instance):
