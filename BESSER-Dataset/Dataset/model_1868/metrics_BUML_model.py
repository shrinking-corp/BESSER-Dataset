...
metrics_MetricLibrary = Class(name="metrics_MetricLibrary")
...
metrics_MetricSource.attributes={metrics_MetricSource_metricLocation, metrics_MetricSource_name, metrics_MetricSource_lastPurge, metrics_MetricSource_mappingFile, metrics_MetricSource_lastContact, metrics_MetricSource_metrickind}
...
domain_model = DomainModel(
    name="metrics",
    types={metrics_MetricSource, metrics_Metric, metrics_MetricLibrary, MetricKind},
    associations={metricSources0, metricRefs1},
    generalizations={},
    metadata=None
)
