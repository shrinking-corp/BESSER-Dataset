...
# Classes
bootstrap_Site = Class(name="bootstrap_Site")
bootstrap_Page = Class(name="bootstrap_Page")
bootstrap_MainPage = Class(name="bootstrap_MainPage")
bootstrap_Widget = Class(name="bootstrap_Widget", is_abstract=True)
bootstrap_Form = Class(name="bootstrap_Form")
Widget = Class(name="Widget")
bootstrap_FormWidget = Class(name="bootstrap_FormWidget", is_abstract=True)
bootstrap_Table = Class(name="bootstrap_Table")
bootstrap_Text = Class(name="bootstrap_Text")
bootstrap_Video = Class(name="bootstrap_Video")
bootstrap_Gallery = Class(name="bootstrap_Gallery")
bootstrap_ImagesBlock = Class(name="bootstrap_ImagesBlock")
bootstrap_Section = Class(name="bootstrap_Section")
bootstrap_CheckBox = Class(name="bootstrap_CheckBox")
bootstrap_TextArea = Class(name="bootstrap_TextArea")
FormWidget = Class(name="FormWidget")
bootstrap_Spinner = Class(name="bootstrap_Spinner")
...
bootstrap_Table.attributes={bootstrap_Table_striped, bootstrap_Table_rowNames, bootstrap_Table_bordered, bootstrap_Table_columnNames}
...
domain_model = DomainModel(
    name="bootstrap",
    types={bootstrap_Site, bootstrap_Page, bootstrap_MainPage, bootstrap_Widget, bootstrap_Form, Widget, bootstrap_FormWidget, bootstrap_Table, bootstrap_Text, bootstrap_Video, bootstrap_Gallery, bootstrap_ImagesBlock, bootstrap_Section, bootstrap_CheckBox, bootstrap_TextArea, FormWidget, bootstrap_Spinner},
    associations={pages0, mainPage1, site5, widgets7, page8, section10, formWidgets12, sections3, site4, form13},
    generalizations={gen_bootstrap_Form_Widget, gen_bootstrap_Table_Widget, gen_bootstrap_Text_Widget, gen_bootstrap_Video_Widget, gen_bootstrap_Gallery_Widget, gen_bootstrap_ImagesBlock_Widget, gen_bootstrap_CheckBox_FormWidget, gen_bootstrap_TextArea_FormWidget, gen_bootstrap_Spinner_FormWidget},
    metadata=None
)
