...
class bootstrap_Section:
    ...
    def __init__(self, title: str, description: str, section: set["bootstrap_Widget"] = None, sections: "bootstrap_Page" = None, Section11: "bootstrap_Widget" = None, Section: "bootstrap_Page" = None):
        self.title = title
        self.description = description
...
class bootstrap_Page:
    ...
    def __init__(self, title: str, description: str, name: str, Page: "bootstrap_Site" = None, Page9: "bootstrap_Section" = None, page: set["bootstrap_Section"] = None, pages: "bootstrap_Site" = None):
        self.title = title
        self.description = description
        self.name = name
        self.Page = Page
...
class bootstrap_Site:
    ...
    def __init__(self, title: str, site: set["bootstrap_Page"] = None, site2: "bootstrap_MainPage" = None, Site6: "bootstrap_MainPage" = None, Site: "bootstrap_Page" = None):
        self.title = title
