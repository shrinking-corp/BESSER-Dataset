...
class fm_Operation:
    ...
    def __init__(self, value: int, fm_Operation: "fm_CardExConstraint" = None, fm_Operation17: "fm_CardExConstraint" = None, fm_Operation21: "fm_Feature" = None):
        self.value = value
...
class fm_Attribute:
    ...
    def __init__(self, value: str, name: str, fm_Attribute: "fm_Feature" = None):
        self.value = value
        self.name = name
...
class fm_Feature:
    ...
    def __init__(self, name: str, fm_Feature5: "fm_Feature" = None, fm_Feature3: set["fm_Feature"] = None, fm_Feature7: "fm_FeatureCardinality" = None, fm_Feature9: set["fm_Attribute"] = None, fm_Feature11: "fm_OrFeature" = None, fm_Feature22: "fm_Operation" = None, fm_Feature24: "fm_BooleanConstraints" = None, fm_Feature27: "fm_BooleanConstraints" = None, fm_Feature: "fm_FeatureModel" = None):
        self.name = name
