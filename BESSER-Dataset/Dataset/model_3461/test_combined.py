...
def test_hyp_fm_cardinality_is_not_abstract():
    assert not inspect.isabstract(fm_Cardinality)


def test_hyp_fm_cardinality_constructor_exists():
    assert callable(fm_Cardinality.__init__)


def test_hyp_fm_cardinality_constructor_args():
...
def test_hyp_orfeature_is_not_abstract():
    assert not inspect.isabstract(OrFeature)


def test_hyp_orfeature_constructor_exists():
    assert callable(OrFeature.__init__)


def test_hyp_orfeature_constructor_args():
    sig = inspect.signature(OrFeature.__init__)
    params = list(sig.parameters.keys())



def test_hyp_fm_xorfeature_is_not_abstract():
    assert not inspect.isabstract(fm_XorFeature)


def test_hyp_fm_xorfeature_constructor_exists():
    assert callable(fm_XorFeature.__init__)


def test_hyp_fm_xorfeature_constructor_args():
    sig = inspect.signature(fm_XorFeature.__init__)
    params = list(sig.parameters.keys())



def test_hyp_fm_groupcardinality_is_not_abstract():
    assert not inspect.isabstract(fm_GroupCardinality)


def test_hyp_fm_groupcardinality_constructor_exists():
    assert callable(fm_GroupCardinality.__init__)


def test_hyp_fm_groupcardinality_constructor_args():
...
def test_hyp_fm_oroperator_is_not_abstract():
    assert not inspect.isabstract(fm_OrOperator)


def test_hyp_fm_oroperator_constructor_exists():
    assert callable(fm_OrOperator.__init__)


def test_hyp_fm_oroperator_constructor_args():
    sig = inspect.signature(fm_OrOperator.__init__)
    params = list(sig.parameters.keys())



def test_hyp_fm_andoperator_is_not_abstract():
    assert not inspect.isabstract(fm_AndOperator)


def test_hyp_fm_andoperator_constructor_exists():
    assert callable(fm_AndOperator.__init__)


def test_hyp_fm_andoperator_constructor_args():
    sig = inspect.signature(fm_AndOperator.__init__)
    params = list(sig.parameters.keys())



def test_hyp_fm_operator_is_not_abstract():
    assert not inspect.isabstract(fm_Operator)


def test_hyp_fm_operator_constructor_exists():
    assert callable(fm_Operator.__init__)


def test_hyp_fm_operator_constructor_args():
    sig = inspect.signature(fm_Operator.__init__)
    params = list(sig.parameters.keys())



def test_hyp_fm_operation_is_not_abstract():
    assert not inspect.isabstract(fm_Operation)


def test_hyp_fm_operation_constructor_exists():
    assert callable(fm_Operation.__init__)


def test_hyp_fm_operation_constructor_args():
...
def test_hyp_fm_booleanconstraints_is_not_abstract():
    assert not inspect.isabstract(fm_BooleanConstraints)


def test_hyp_fm_booleanconstraints_constructor_exists():
    assert callable(fm_BooleanConstraints.__init__)


def test_hyp_fm_booleanconstraints_constructor_args():
    sig = inspect.signature(fm_BooleanConstraints.__init__)
    params = list(sig.parameters.keys())



def test_hyp_fm_cardexconstraint_is_not_abstract():
    assert not inspect.isabstract(fm_CardExConstraint)


def test_hyp_fm_cardexconstraint_constructor_exists():
    assert callable(fm_CardExConstraint.__init__)


def test_hyp_fm_cardexconstraint_constructor_args():
...
def test_hyp_fm_orfeature_is_not_abstract():
    assert not inspect.isabstract(fm_OrFeature)


def test_hyp_fm_orfeature_constructor_exists():
    assert callable(fm_OrFeature.__init__)


def test_hyp_fm_orfeature_constructor_args():
...
def test_hyp_fm_featurecardinality_is_not_abstract():
    assert not inspect.isabstract(fm_FeatureCardinality)


def test_hyp_fm_featurecardinality_constructor_exists():
    assert callable(fm_FeatureCardinality.__init__)


def test_hyp_fm_featurecardinality_constructor_args():
...
def test_hyp_fm_cardinality_max_setter(instance):
...
@given(instance=fm_Cardinality_strategy)
def test_hyp_fm_cardinality_min_setter(instance):
...
def test_hyp_fm_operation_value_setter(instance):
...
@given(instance=fm_Attribute_strategy)
def test_hyp_fm_attribute_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
