...
mm_rdb_RenameColumn_m_renameColumn: Method = Method(name="renameColumn", parameters={Parameter(name='mm_renamedColumn', type=StringType), Parameter(name='mm_newColumnName', type=StringType), Parameter(name='mm_changedTable', type=StringType)}, type=BooleanType)
...
domain_model = DomainModel(
    name="mm",
    types={Operation, mm_rdb_NamedElement, mm_rdb_Database, NamedElement, Schema, mm_rdb_DbObject, mm_rdb_Schema, DbObject, Table, Sequence, Index, mm_rdb_Relation, mm_rdb_Table, rdb_DbObject, rdb_Relation, mm_rdb_ModelRoot, Database, mm_rdb_Constraint, mm_rdb_TableConstraint, rdb_Constraint, rdb_NamedElement, mm_rdb_ColumnConstraint, Constraint, mm_rdb_ForeignKey, mm_rdb_Column, mm_rdb_TableColumn, Column, ColumnConstraint, PrimaryKey, TableColumn, TableConstraint, mm_rdb_Sequence, mm_rdb_UniqueIndex, mm_rdb_PrimaryKey, UniqueIndex, mm_rdb_Operation, ModelRoot, mm_rdb_CreateTable, mm_rdb_Index, mm_rdb_AddColumn, mm_rdb_RenameColumn, mm_rdb_TypeChangeToColumn, mm_rdb_RenameTable, mm_rdb_DeleteTable, mm_dml_Query, Relation, dml_ColumnReference, mm_dml_ColumnReference, mm_rdb_DeleteColumn},
    associations={operations4, schemas5, tables6, sequences7, indexes9, sourceDB0, targetDB1, owningSchema16, owningTable18, owningColumn20, targetTable23, constrainedColumn25, _owningTable28, constraints30, owningSchema11, primaryKey13, ownedColumns14, constraints15, owningSchema36, underlyingIndex38, modelRoot40, tableColumns41, tableConstraints43, primaryKey46, generateID49, columns31, indexedTable33, deletedTable54, changedTable56, columnConstrains58, changedTable61, renamedColumn63, changedTable66, renamedTable52, changedTable71, deleteColumn73, columnReferences76, reference77, changedTypeColumn68},
    generalizations={gen_mm_rdb_Database_NamedElement, gen_mm_rdb_DbObject_NamedElement, gen_mm_rdb_Schema_DbObject, gen_mm_rdb_Table_rdb_DbObject, gen_mm_rdb_Table_rdb_Relation, gen_mm_rdb_Constraint_DbObject, gen_mm_rdb_TableConstraint_rdb_Constraint, gen_mm_rdb_TableConstraint_rdb_NamedElement, gen_mm_rdb_ColumnConstraint_Constraint, gen_mm_rdb_ForeignKey_TableConstraint, gen_mm_rdb_Column_NamedElement, gen_mm_rdb_TableColumn_Column, gen_mm_rdb_Sequence_DbObject, gen_mm_rdb_UniqueIndex_TableConstraint, gen_mm_rdb_PrimaryKey_UniqueIndex, gen_mm_rdb_CreateTable_Operation, gen_mm_rdb_Index_DbObject, gen_mm_rdb_AddColumn_Operation, gen_mm_rdb_RenameColumn_Operation, gen_mm_rdb_TypeChangeToColumn_Operation, gen_mm_rdb_RenameTable_Operation, gen_mm_rdb_DeleteTable_Operation, gen_mm_dml_Query_Relation, gen_mm_dml_ColumnReference_Column, gen_mm_rdb_DeleteColumn_Operation},
    metadata=None
)
