...
class mm_rdb_AddColumn(Operation):
    ...
    def addColumn(self, mm_changedTable, mm_columnConstrains, mm_newColumnName) :
...
class mm_rdb_TypeChangeToColumn(Operation):
    ...
    def typeChangeToColumn(self, mm_changedTable, mm_newType, mm_changedTypeColumn) :
...
class mm_rdb_DeleteColumn(Operation):
    ...
    def deleteColumn(self, mm_changedTable, mm_deleteColumn) :
...
class mm_rdb_RenameColumn(Operation):
    ...
    def renameColumn(self, mm_changedTable, mm_newColumnName, mm_renamedColumn) :
        # TODO: Implement renameColumn method
        pass

class mm_rdb_CreateTable(Operation):

    def __init__(self, tableName: str, mm_rdb_CreateTable47: "PrimaryKey" = None, mm_rdb_CreateTable50: "Sequence" = None, mm_rdb_CreateTable: set["TableColumn"] = None, mm_rdb_CreateTable44: set["TableConstraint"] = None, Operation: "mm_rdb_ModelRoot" = None):
    ...
    def createTable(self, mm_tableName, mm_primaryKey, mm_tableConstraints, mm_tableColumns, mm_generateID) :
...
class mm_rdb_RenameTable(Operation):
    ...
    def renameTable(self, mm_newName, mm_renamedTable) :
