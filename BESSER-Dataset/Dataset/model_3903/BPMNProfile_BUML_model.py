...
# Classes
BPMNProfile_SequenceFlow = Class(name="BPMNProfile_SequenceFlow")
BPMNProfile_NonExclusiveGateway = Class(name="BPMNProfile_NonExclusiveGateway", is_abstract=True)
Gateway = Class(name="Gateway")
BPMNProfile_JoinNode = Class(name="BPMNProfile_JoinNode")
BPMNProfile_ForkNode = Class(name="BPMNProfile_ForkNode")
BPMNProfile_Gateway = Class(name="BPMNProfile_Gateway", is_abstract=True)
FlowNode = Class(name="FlowNode")
BPMNProfile_ControlNode = Class(name="BPMNProfile_ControlNode")
BPMNProfile_ActivityGroup = Class(name="BPMNProfile_ActivityGroup")
BPMNProfile_FlowNode = Class(name="BPMNProfile_FlowNode", is_abstract=True)
FlowElement = Class(name="FlowElement")
BPMNProfile_ActivityNode = Class(name="BPMNProfile_ActivityNode")
BPMNProfile_FlowElement = Class(name="BPMNProfile_FlowElement", is_abstract=True)
BaseElement = Class(name="BaseElement")
BPMNProfile_Auditing = Class(name="BPMNProfile_Auditing")
BPMNProfile_Monitoring = Class(name="BPMNProfile_Monitoring")
BPMNProfile_CategoryValue = Class(name="BPMNProfile_CategoryValue")
BPMNProfile_FlowElementsContainer = Class(name="BPMNProfile_FlowElementsContainer", is_abstract=True)
BPMNProfile_InclusiveGateway = Class(name="BPMNProfile_InclusiveGateway")
NonExclusiveGateway = Class(name="NonExclusiveGateway")
BPMNProfile_ExtensionDefinition = Class(name="BPMNProfile_ExtensionDefinition")
BPMNProfile_BPMNAssociation = Class(name="BPMNProfile_BPMNAssociation")
BPMNProfile_Slot = Class(name="BPMNProfile_Slot")
BPMNProfile_ExtensionAttributeDefinition = Class(name="BPMNProfile_ExtensionAttributeDefinition")
BPMNProfile_Property = Class(name="BPMNProfile_Property")
BPMNProfile_Comment = Class(name="BPMNProfile_Comment")
BPMNProfile_Stereotype = Class(name="BPMNProfile_Stereotype")
BPMNArtifact = Class(name="BPMNArtifact")
BPMNProfile_BaseElement = Class(name="BPMNProfile_BaseElement", is_abstract=True)
BPMNProfile_ExtensionAttributeValue = Class(name="BPMNProfile_ExtensionAttributeValue")
BPMNProfile_Element = Class(name="BPMNProfile_Element")
BPMNProfile_Documentation = Class(name="BPMNProfile_Documentation")
BPMNProfile_Class = Class(name="BPMNProfile_Class")
BPMNProfile_EnumerationLiteral = Class(name="BPMNProfile_EnumerationLiteral")
BPMNProfile_LaneSet = Class(name="BPMNProfile_LaneSet")
BPMNProfile_Dependency = Class(name="BPMNProfile_Dependency")
BPMNProfile_BPMNArtifact = Class(name="BPMNProfile_BPMNArtifact", is_abstract=True)
BPMNProfile_ActivityPartition = Class(name="BPMNProfile_ActivityPartition")
BPMNProfile_Lane = Class(name="BPMNProfile_Lane")
BPMNProfile_ControlFlow = Class(name="BPMNProfile_ControlFlow")
BPMNProfile_BPMNExpression = Class(name="BPMNProfile_BPMNExpression")
BPMNProfile_OpaqueExpression = Class(name="BPMNProfile_OpaqueExpression")
BPMNProfile_EventBasedGateway = Class(name="BPMNProfile_EventBasedGateway")
BPMNProfile_StructuredActivityNode = Class(name="BPMNProfile_StructuredActivityNode")
BPMNProfile_InterruptibleActivityRegion = Class(name="BPMNProfile_InterruptibleActivityRegion")
BPMNProfile_ExclusiveGateway = Class(name="BPMNProfile_ExclusiveGateway")
BPMNProfile_DecisionNode = Class(name="BPMNProfile_DecisionNode")
BPMNProfile_MergeNode = Class(name="BPMNProfile_MergeNode")
BPMNProfile_RootElement = Class(name="BPMNProfile_RootElement", is_abstract=True)
BPMNProfile_PackageableElement = Class(name="BPMNProfile_PackageableElement")
BPMNProfile_Definitions = Class(name="BPMNProfile_Definitions")
BPMNProfile_ParallelGateway = Class(name="BPMNProfile_ParallelGateway")
BPMNProfile_ComplexGateway = Class(name="BPMNProfile_ComplexGateway")
BPMNProfile_BPMNExtension = Class(name="BPMNProfile_BPMNExtension")
BPMNProfile_Import = Class(name="BPMNProfile_Import")
BPMNProfile_BPMNRelationship = Class(name="BPMNProfile_BPMNRelationship")
BPMNProfile_Package = Class(name="BPMNProfile_Package")
BPMNProfile_Constraint = Class(name="BPMNProfile_Constraint")
BPMNProfile_BPMNProcess = Class(name="BPMNProfile_BPMNProcess")
CallableElement = Class(name="CallableElement")
FlowElementsContainer = Class(name="FlowElementsContainer")
BPMNProfile_PackageImport = Class(name="BPMNProfile_PackageImport")
BPMNProfile_BPMNCollaboration = Class(name="BPMNProfile_BPMNCollaboration")
BPMNProfile_Activity = Class(name="BPMNProfile_Activity")
BPMNProfile_CorrelationSubscription = Class(name="BPMNProfile_CorrelationSubscription")
BPMNProfile_BPMNProperty = Class(name="BPMNProfile_BPMNProperty")
BPMNProfile_ResourceRole = Class(name="BPMNProfile_ResourceRole")
BPMNProfile_Behavior = Class(name="BPMNProfile_Behavior")
BPMNProfile_InputOutputSpecification = Class(name="BPMNProfile_InputOutputSpecification")
BPMNProfile_BPMNInterface = Class(name="BPMNProfile_BPMNInterface")
BPMNProfile_InputOutputBinding = Class(name="BPMNProfile_InputOutputBinding")
BPMNProfile_Action = Class(name="BPMNProfile_Action")
BPMNProfile_DataInput = Class(name="BPMNProfile_DataInput")
BPMNProfile_DataOutput = Class(name="BPMNProfile_DataOutput")
BPMNProfile_InputSet = Class(name="BPMNProfile_InputSet")
BPMNProfile_OutputSet = Class(name="BPMNProfile_OutputSet")
ItemAwareElement = Class(name="ItemAwareElement")
BPMNProfile_CallableElement = Class(name="BPMNProfile_CallableElement", is_abstract=True)
RootElement = Class(name="RootElement")
BPMNProfile_Parameter = Class(name="BPMNProfile_Parameter")
BPMNProfile_ActivityParameterNode = Class(name="BPMNProfile_ActivityParameterNode")
BPMNProfile_ItemAwareElement = Class(name="BPMNProfile_ItemAwareElement", is_abstract=True)
BPMNProfile_DataState = Class(name="BPMNProfile_DataState")
BPMNProfile_TypedElement = Class(name="BPMNProfile_TypedElement")
BPMNProfile_ItemDefinition = Class(name="BPMNProfile_ItemDefinition")
BPMNProfile_State = Class(name="BPMNProfile_State")
BPMNProfile_InputPin = Class(name="BPMNProfile_InputPin")
BPMNProfile_ParameterSet = Class(name="BPMNProfile_ParameterSet")
BPMNProfile_OutputPin = Class(name="BPMNProfile_OutputPin")
BPMNProfile_Interface = Class(name="BPMNProfile_Interface")
BPMNProfile_BPMNOperation = Class(name="BPMNProfile_BPMNOperation")
BPMNProfile_Operation = Class(name="BPMNProfile_Operation")
BPMNProfile_BPMNMessage = Class(name="BPMNProfile_BPMNMessage")
BPMNProfile_Error = Class(name="BPMNProfile_Error")
ItemDefinition = Class(name="ItemDefinition")
BPMNProfile_ParticipantAssociation = Class(name="BPMNProfile_ParticipantAssociation")
BPMNProfile_ConversationLink = Class(name="BPMNProfile_ConversationLink")
BPMNProfile_MessageFlowAssociation = Class(name="BPMNProfile_MessageFlowAssociation")
BPMNProfile_MessageFlow = Class(name="BPMNProfile_MessageFlow")
BPMNProfile_Collaboration = Class(name="BPMNProfile_Collaboration")
BPMNProfile_ConversationNode = Class(name="BPMNProfile_ConversationNode", is_abstract=True)
BPMNProfile_CorrelationKey = Class(name="BPMNProfile_CorrelationKey")
BPMNProfile_Participant = Class(name="BPMNProfile_Participant")
BPMNProfile_PartnerEntity = Class(name="BPMNProfile_PartnerEntity")
BPMNProfile_PartnerRole = Class(name="BPMNProfile_PartnerRole")
BPMNProfile_InteractionNode = Class(name="BPMNProfile_InteractionNode", is_abstract=True)
BPMNProfile_ParticipantMultiplicity = Class(name="BPMNProfile_ParticipantMultiplicity")
BPMNProfile_InstanceSpecification = Class(name="BPMNProfile_InstanceSpecification")
BPMNProfile_MultiplicityElement = Class(name="BPMNProfile_MultiplicityElement")
BPMNProfile_InformationFlow = Class(name="BPMNProfile_InformationFlow")
InteractionNode = Class(name="InteractionNode")
BPMNProfile_FormalExpression = Class(name="BPMNProfile_FormalExpression")
BPMNExpression = Class(name="BPMNExpression")
BPMNProfile_CorrelationPropertyBinding = Class(name="BPMNProfile_CorrelationPropertyBinding")
BPMNProfile_CorrelationProperty = Class(name="BPMNProfile_CorrelationProperty")
BPMNProfile_CorrelationPropertyRetrievalExpression = Class(name="BPMNProfile_CorrelationPropertyRetrievalExpression")
BPMNProfile_ResourceAssignmentExpression = Class(name="BPMNProfile_ResourceAssignmentExpression")
BPMNProfile_DataStoreNode = Class(name="BPMNProfile_DataStoreNode")
BPMNProfile_ResourceParameter = Class(name="BPMNProfile_ResourceParameter")
BPMNProfile_Resource = Class(name="BPMNProfile_Resource")
BPMNProfile_ResourceParameterBinding = Class(name="BPMNProfile_ResourceParameterBinding")
BPMNProfile_GlobalTask = Class(name="BPMNProfile_GlobalTask")
BPMNProfile_GlobalScriptTask = Class(name="BPMNProfile_GlobalScriptTask")
GlobalTask = Class(name="GlobalTask")
BPMNProfile_OpaqueBehavior = Class(name="BPMNProfile_OpaqueBehavior")
BPMNProfile_GlobalBusinessRuleTask = Class(name="BPMNProfile_GlobalBusinessRuleTask")
BPMNProfile_CompensateEventDefinition = Class(name="BPMNProfile_CompensateEventDefinition")
EventDefinition = Class(name="EventDefinition")
BPMNProfile_BPMNActivity = Class(name="BPMNProfile_BPMNActivity", is_abstract=True)
BPMNProfile_CallEvent = Class(name="BPMNProfile_CallEvent")
BPMNProfile_EventDefinition = Class(name="BPMNProfile_EventDefinition", is_abstract=True)
BPMNProfile_Event = Class(name="BPMNProfile_Event")
BPMNProfile_BoundaryEvent = Class(name="BPMNProfile_BoundaryEvent")
BPMNProfile_DataInputAssociation = Class(name="BPMNProfile_DataInputAssociation")
BPMNProfile_DataOutputAssociation = Class(name="BPMNProfile_DataOutputAssociation")
BPMNProfile_LoopCharacteristics = Class(name="BPMNProfile_LoopCharacteristics", is_abstract=True)
CatchEvent = Class(name="CatchEvent")
DataAssociation = Class(name="DataAssociation")
BPMNProfile_DataAssociation = Class(name="BPMNProfile_DataAssociation", is_abstract=True)
BPMNProfile_CatchEvent = Class(name="BPMNProfile_CatchEvent", is_abstract=True)
BPMNEvent = Class(name="BPMNEvent")
BPMNProfile_AcceptEventAction = Class(name="BPMNProfile_AcceptEventAction")
BPMNProfile_InitialNode = Class(name="BPMNProfile_InitialNode")
BPMNProfile_BPMNEvent = Class(name="BPMNProfile_BPMNEvent", is_abstract=True)
BPMNProfile_ObjectFlow = Class(name="BPMNProfile_ObjectFlow")
BPMNProfile_Assignment = Class(name="BPMNProfile_Assignment")
BPMNProfile_ChangeEvent = Class(name="BPMNProfile_ChangeEvent")
BPMNProfile_SignalEventDefinition = Class(name="BPMNProfile_SignalEventDefinition")
BPMNProfile_BPMNSignal = Class(name="BPMNProfile_BPMNSignal")
BPMNProfile_EndEvent = Class(name="BPMNProfile_EndEvent")
ThrowEvent = Class(name="ThrowEvent")
BPMNProfile_FinalNode = Class(name="BPMNProfile_FinalNode")
BPMNProfile_ThrowEvent = Class(name="BPMNProfile_ThrowEvent", is_abstract=True)
BPMNProfile_EscalationEventDefinition = Class(name="BPMNProfile_EscalationEventDefinition")
BPMNProfile_Escalation = Class(name="BPMNProfile_Escalation")
BPMNProfile_TimerEventDefinition = Class(name="BPMNProfile_TimerEventDefinition")
BPMNProfile_LinkEventDefinition = Class(name="BPMNProfile_LinkEventDefinition")
BPMNProfile_ErrorEventDefinition = Class(name="BPMNProfile_ErrorEventDefinition")
BPMNProfile_IntermediateCatchEvent = Class(name="BPMNProfile_IntermediateCatchEvent")
BPMNProfile_IntermediateThrowEvent = Class(name="BPMNProfile_IntermediateThrowEvent")
BPMNProfile_SendObjectAction = Class(name="BPMNProfile_SendObjectAction")
BPMNProfile_CallOperationAction = Class(name="BPMNProfile_CallOperationAction")
BPMNProfile_FlowFinalNode = Class(name="BPMNProfile_FlowFinalNode")
BPMNProfile_MessageEventDefinition = Class(name="BPMNProfile_MessageEventDefinition")
BPMNProfile_StartEvent = Class(name="BPMNProfile_StartEvent")
BPMNProfile_ConditionalEventDefinition = Class(name="BPMNProfile_ConditionalEventDefinition")
BPMNProfile_DataObjectReference = Class(name="BPMNProfile_DataObjectReference")
BPMNProfile_DataObject = Class(name="BPMNProfile_DataObject")
BPMNProfile_TerminateEventDefinition = Class(name="BPMNProfile_TerminateEventDefinition")
BPMNProfile_ImplicitThrowEvent = Class(name="BPMNProfile_ImplicitThrowEvent")
BPMNProfile_CancelEventDefinition = Class(name="BPMNProfile_CancelEventDefinition")
BPMNProfile_TextAnnotation = Class(name="BPMNProfile_TextAnnotation")
BPMNProfile_Category = Class(name="BPMNProfile_Category")
BPMNProfile_Enumeration = Class(name="BPMNProfile_Enumeration")
BPMNProfile_Group = Class(name="BPMNProfile_Group")
BPMNProfile_OpaqueAction = Class(name="BPMNProfile_OpaqueAction")
BPMNProfile_Rendering = Class(name="BPMNProfile_Rendering")
BPMNProfile_Task = Class(name="BPMNProfile_Task")
BPMNActivity = Class(name="BPMNActivity")
BPMNProfile_Image = Class(name="BPMNProfile_Image")
BPMNProfile_HumanPerformer = Class(name="BPMNProfile_HumanPerformer")
Performer = Class(name="Performer")
BPMNProfile_DataStore = Class(name="BPMNProfile_DataStore")
BPMNProfile_DataStoreReference = Class(name="BPMNProfile_DataStoreReference")
BPMNProfile_UserTask = Class(name="BPMNProfile_UserTask")
Task = Class(name="Task")
BPMNProfile_GlobalConversation = Class(name="BPMNProfile_GlobalConversation")
BPMNCollaboration = Class(name="BPMNCollaboration")
BPMNProfile_CallConversation = Class(name="BPMNProfile_CallConversation")
BPMNProfile_CollaborationUse = Class(name="BPMNProfile_CollaborationUse")
BPMNProfile_Performer = Class(name="BPMNProfile_Performer")
ResourceRole = Class(name="ResourceRole")
BPMNProfile_GlobalUserTask = Class(name="BPMNProfile_GlobalUserTask")
BPMNProfile_GlobalManualTask = Class(name="BPMNProfile_GlobalManualTask")
BPMNProfile_ManualTask = Class(name="BPMNProfile_ManualTask")
BPMNProfile_PotentialOwner = Class(name="BPMNProfile_PotentialOwner")
HumanPerformer = Class(name="HumanPerformer")
BPMNProfile_SubConversation = Class(name="BPMNProfile_SubConversation")
ConversationNode = Class(name="ConversationNode")
BPMNProfile_CallBehaviorAction = Class(name="BPMNProfile_CallBehaviorAction")
BPMNProfile_BusinessRuleTask = Class(name="BPMNProfile_BusinessRuleTask")
BPMNProfile_ComplexBehaviorDefinition = Class(name="BPMNProfile_ComplexBehaviorDefinition")
BPMNProfile_Conversation = Class(name="BPMNProfile_Conversation")
BPMNProfile_SubProcess = Class(name="BPMNProfile_SubProcess")
BPMNProfile_CallActivity = Class(name="BPMNProfile_CallActivity")
BPMNProfile_SendTask = Class(name="BPMNProfile_SendTask")
BPMNProfile_AdHocSubProcess = Class(name="BPMNProfile_AdHocSubProcess")
SubProcess = Class(name="SubProcess")
BPMNProfile_ScriptTask = Class(name="BPMNProfile_ScriptTask")
BPMNProfile_LoopNode = Class(name="BPMNProfile_LoopNode")
BPMNProfile_ReceiveTask = Class(name="BPMNProfile_ReceiveTask")
BPMNProfile_Transaction = Class(name="BPMNProfile_Transaction")
BPMNProfile_StandardLoopCharacteristics = Class(name="BPMNProfile_StandardLoopCharacteristics")
LoopCharacteristics = Class(name="LoopCharacteristics")
BPMNProfile_ServiceTask = Class(name="BPMNProfile_ServiceTask")
BPMNProfile_MultiInstanceLoopCharacteristics = Class(name="BPMNProfile_MultiInstanceLoopCharacteristics")
BPMNProfile_ExpansionRegion = Class(name="BPMNProfile_ExpansionRegion")
...
BPMNProfile_SequenceFlow_m_SequenceFlowsourceRef: Method = Method(name="SequenceFlowsourceRef", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_SequenceFlow_m_SequenceFlowtargetRef: Method = Method(name="SequenceFlowtargetRef", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_SequenceFlow_m_SequenceFlowconditionExpression: Method = Method(name="SequenceFlowconditionExpression", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_InclusiveGateway_m_inclusiveGatewaydefault: Method = Method(name="inclusiveGatewaydefault", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_BPMNAssociation_m_AssociationEnd: Method = Method(name="AssociationEnd", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_ExtensionAttributeDefinition.attributes={BPMNProfile_ExtensionAttributeDefinition_isReference, BPMNProfile_ExtensionAttributeDefinition_type}
...
BPMNProfile_Documentation.attributes={BPMNProfile_Documentation_textFormat, BPMNProfile_Documentation_text}
...
BPMNProfile_LaneSet_m_LaneSetlanes: Method = Method(name="LaneSetlanes", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_LaneSet_m_LaneSetparentLane: Method = Method(name="LaneSetparentLane", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_LaneSet_m_LaneSetflowElementsContainer: Method = Method(name="LaneSetflowElementsContainer", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_LaneSet_m_LaneSet: Method = Method(name="LaneSet", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_LaneSet.methods={BPMNProfile_LaneSet_m_LaneSetparentLane, BPMNProfile_LaneSet_m_LaneSetflowElementsContainer, BPMNProfile_LaneSet_m_LaneSet, BPMNProfile_LaneSet_m_LaneSetlanes}
...
BPMNProfile_Lane_m_LanelaneSet: Method = Method(name="LanelaneSet", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_Lane_m_LanechildLaneSet: Method = Method(name="LanechildLaneSet", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_Lane_m_LanepartitionElementRef: Method = Method(name="LanepartitionElementRef", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_Lane_m_LaneflowNodeRefs: Method = Method(name="LaneflowNodeRefs", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_Lane.methods={BPMNProfile_Lane_m_LanepartitionElementRef, BPMNProfile_Lane_m_LanechildLaneSet, BPMNProfile_Lane_m_LaneflowNodeRefs, BPMNProfile_Lane_m_LanelaneSet}
...
BPMNProfile_ExclusiveGateway_m_exclusiveGatewaydefault: Method = Method(name="exclusiveGatewaydefault", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_Definitions.attributes={BPMNProfile_Definitions_expressionLanguage, BPMNProfile_Definitions_exporterVersion, BPMNProfile_Definitions_typeLanguage, BPMNProfile_Definitions_exporter, BPMNProfile_Definitions_targetNamespace}

# BPMNProfile_ParallelGateway class attributes and methods

# BPMNProfile_ComplexGateway class attributes and methods
BPMNProfile_ComplexGateway_m_complexGatewayactivationCondition: Method = Method(name="complexGatewayactivationCondition", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_ComplexGateway_m_complexGatewayjoinSpec: Method = Method(name="complexGatewayjoinSpec", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_ComplexGateway_m_complexGatewaydefault: Method = Method(name="complexGatewaydefault", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_ComplexGateway.methods={BPMNProfile_ComplexGateway_m_complexGatewayactivationCondition, BPMNProfile_ComplexGateway_m_complexGatewayjoinSpec, BPMNProfile_ComplexGateway_m_complexGatewaydefault}
...
BPMNProfile_Import.attributes={BPMNProfile_Import_importType, BPMNProfile_Import_location, BPMNProfile_Import_namespace}
...
BPMNProfile_BPMNProcess_m_ProcesssupportedInterfaceRefs: Method = Method(name="ProcesssupportedInterfaceRefs", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_BPMNProcess_m_ProcesslaneSets: Method = Method(name="ProcesslaneSets", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_BPMNProcess_m_ProcessflowElements: Method = Method(name="ProcessflowElements", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_BPMNProcess_m_Processsupports: Method = Method(name="Processsupports", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_BPMNProcess_m_Processproperties: Method = Method(name="Processproperties", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_BPMNProcess.attributes={BPMNProfile_BPMNProcess_isExecutable, BPMNProfile_BPMNProcess_isClosed, BPMNProfile_BPMNProcess_processType}
BPMNProfile_BPMNProcess.methods={BPMNProfile_BPMNProcess_m_Processproperties, BPMNProfile_BPMNProcess_m_ProcesssupportedInterfaceRefs, BPMNProfile_BPMNProcess_m_ProcesslaneSets, BPMNProfile_BPMNProcess_m_ProcessflowElements, BPMNProfile_BPMNProcess_m_Processsupports}
...
BPMNProfile_BPMNCollaboration_m_Collaborationparticipants: Method = Method(name="Collaborationparticipants", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_BPMNProperty_m_Propertynotation: Method = Method(name="Propertynotation", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_BPMNProperty_m_BPMNPropertyapply: Method = Method(name="BPMNPropertyapply", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_ResourceRole_m_ResourceRoleresourceRef: Method = Method(name="ResourceRoleresourceRef", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_ResourceRole_m_ResourceRoleisRequired: Method = Method(name="ResourceRoleisRequired", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_ResourceRole_m_ResourceRoleprocess: Method = Method(name="ResourceRoleprocess", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_ResourceRole_m_ResourceRoleresourceParameterBindings: Method = Method(name="ResourceRoleresourceParameterBindings", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_ResourceRole_m_ResourceRoleowner: Method = Method(name="ResourceRoleowner", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_ResourceRole.methods={BPMNProfile_ResourceRole_m_ResourceRoleisRequired, BPMNProfile_ResourceRole_m_ResourceRoleprocess, BPMNProfile_ResourceRole_m_ResourceRoleowner, BPMNProfile_ResourceRole_m_ResourceRoleresourceParameterBindings, BPMNProfile_ResourceRole_m_ResourceRoleresourceRef}
...
BPMNProfile_BPMNInterface_m_InterfaceownedOperation: Method = Method(name="InterfaceownedOperation", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_BPMNInterface_m_BPMNInterfacecallableElements: Method = Method(name="BPMNInterfacecallableElements", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_BPMNInterface_m_BPMNInterfaceoperations: Method = Method(name="BPMNInterfaceoperations", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_BPMNInterface_m_Interfaceoperationmultiplicity: Method = Method(name="Interfaceoperationmultiplicity", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_BPMNInterface.methods={BPMNProfile_BPMNInterface_m_BPMNInterfaceoperations, BPMNProfile_BPMNInterface_m_InterfaceownedOperation, BPMNProfile_BPMNInterface_m_Interfaceoperationmultiplicity, BPMNProfile_BPMNInterface_m_BPMNInterfacecallableElements}
...
BPMNProfile_DataInput_m_DataInputAssociation: Method = Method(name="DataInputAssociation", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_DataInput_m_DataInputnotation: Method = Method(name="DataInputnotation", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_DataInput_m_DataInputitemSubjectRef: Method = Method(name="DataInputitemSubjectRef", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_DataInput.attributes={BPMNProfile_DataInput_isCollection}
BPMNProfile_DataInput.methods={BPMNProfile_DataInput_m_DataInputnotation, BPMNProfile_DataInput_m_DataInputAssociation, BPMNProfile_DataInput_m_DataInputitemSubjectRef}
...
BPMNProfile_DataOutput_m_DataOutputnotation: Method = Method(name="DataOutputnotation", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_DataOutput_m_DataOutputitemSubjectRef: Method = Method(name="DataOutputitemSubjectRef", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_InputSet_m_InputSetdataInputRefs: Method = Method(name="InputSetdataInputRefs", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_InputSet_m_InputSetoptionalInputRefs: Method = Method(name="InputSetoptionalInputRefs", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_InputSet_m_InputSetwhileExecutingInputRefs: Method = Method(name="InputSetwhileExecutingInputRefs", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_InputSet.methods={BPMNProfile_InputSet_m_InputSetwhileExecutingInputRefs, BPMNProfile_InputSet_m_InputSetdataInputRefs, BPMNProfile_InputSet_m_InputSetoptionalInputRefs}

# BPMNProfile_OutputSet class attributes and methods
BPMNProfile_OutputSet_m_OutputSetdataOutputRefs: Method = Method(name="OutputSetdataOutputRefs", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_OutputSet_m_OutputSetoptionalOutputRefs: Method = Method(name="OutputSetoptionalOutputRefs", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_OutputSet_m_OutputSetwhileExecutingOutputRefs: Method = Method(name="OutputSetwhileExecutingOutputRefs", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_OutputSet.methods={BPMNProfile_OutputSet_m_OutputSetoptionalOutputRefs, BPMNProfile_OutputSet_m_OutputSetwhileExecutingOutputRefs, BPMNProfile_OutputSet_m_OutputSetdataOutputRefs}

# ItemAwareElement class attributes and methods

# BPMNProfile_CallableElement class attributes and methods
BPMNProfile_CallableElement_m_CallableEelementsupportedInterfaceRefs: Method = Method(name="CallableEelementsupportedInterfaceRefs", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_CallableElement_m_CallableElementresources: Method = Method(name="CallableElementresources", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_ItemAwareElement_m_ItemAwareElementdataState: Method = Method(name="ItemAwareElementdataState", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_ItemDefinition_m_ItemDefinitionstructureRef: Method = Method(name="ItemDefinitionstructureRef", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_ItemDefinition.attributes={BPMNProfile_ItemDefinition_itemKind, BPMNProfile_ItemDefinition_isCollection}
...
BPMNProfile_BPMNOperation_m_BPMNOperationowner: Method = Method(name="BPMNOperationowner", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_BPMNOperation_m_BPMNOperationinMessageRef: Method = Method(name="BPMNOperationinMessageRef", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_BPMNOperation_m_BPMNOperationoutMessageRef: Method = Method(name="BPMNOperationoutMessageRef", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_BPMNOperation_m_BPMNOperationerrorRefs: Method = Method(name="BPMNOperationerrorRefs", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_BPMNOperation.methods={BPMNProfile_BPMNOperation_m_BPMNOperationinMessageRef, BPMNProfile_BPMNOperation_m_BPMNOperationoutMessageRef, BPMNProfile_BPMNOperation_m_BPMNOperationowner, BPMNProfile_BPMNOperation_m_BPMNOperationerrorRefs}

# BPMNProfile_Operation class attributes and methods

# BPMNProfile_BPMNMessage class attributes and methods
BPMNProfile_BPMNMessage_m_MessageitemRef: Method = Method(name="MessageitemRef", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_ParticipantAssociation_m_ParticipantAssociationinnerParticipantRef: Method = Method(name="ParticipantAssociationinnerParticipantRef", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_ParticipantAssociation_m_ParticipantAssociationouterParticipantRef: Method = Method(name="ParticipantAssociationouterParticipantRef", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_MessageFlowAssociation_m_MessageFlowAssociationinnerMessageFlowRef: Method = Method(name="MessageFlowAssociationinnerMessageFlowRef", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_MessageFlowAssociation_m_MessageFlowAssociationouterMessageFlowRef: Method = Method(name="MessageFlowAssociationouterMessageFlowRef", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_MessageFlow_m_MessageFlowsourceRef: Method = Method(name="MessageFlowsourceRef", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_MessageFlow_m_MessageFlowtargetRef: Method = Method(name="MessageFlowtargetRef", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_MessageFlow_m_MessageFlowmessageRef: Method = Method(name="MessageFlowmessageRef", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_ConversationNode_m_ConversationNodeparticipantRefs: Method = Method(name="ConversationNodeparticipantRefs", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_Participant_m_Participanttype: Method = Method(name="Participanttype", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_Participant_m_ParticipantmultiplicityMinimum: Method = Method(name="ParticipantmultiplicityMinimum", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_Participant_m_Participantrealizationsupplier: Method = Method(name="Participantrealizationsupplier", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_Participant_m_ParticipantprocessRef: Method = Method(name="ParticipantprocessRef", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_Participant_m_ParticipantmultiplicityMaximum: Method = Method(name="ParticipantmultiplicityMaximum", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_Participant_m_Participantownership: Method = Method(name="Participantownership", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_Participant_m_participantpartnerEntityRef: Method = Method(name="participantpartnerEntityRef", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_Participant_m_participantpartnerRoleRef: Method = Method(name="participantpartnerRoleRef", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_Participant_m_ParticipantinterfaceRefs: Method = Method(name="ParticipantinterfaceRefs", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_Participant.methods={BPMNProfile_Participant_m_Participantownership, BPMNProfile_Participant_m_ParticipantmultiplicityMaximum, BPMNProfile_Participant_m_participantpartnerEntityRef, BPMNProfile_Participant_m_ParticipantinterfaceRefs, BPMNProfile_Participant_m_participantpartnerRoleRef, BPMNProfile_Participant_m_Participantrealizationsupplier, BPMNProfile_Participant_m_ParticipantmultiplicityMinimum, BPMNProfile_Participant_m_ParticipantprocessRef, BPMNProfile_Participant_m_Participanttype}

# BPMNProfile_PartnerEntity class attributes and methods
BPMNProfile_PartnerEntity_m_PartnerEntityparticipantRef: Method = Method(name="PartnerEntityparticipantRef", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_PartnerRole_m_PartnerRoleparticipantRef: Method = Method(name="PartnerRoleparticipantRef", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_FormalExpression_m_FormalExpressionevaluatesToTypeRef: Method = Method(name="FormalExpressionevaluatesToTypeRef", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_ResourceAssignmentExpression_m_ResourceAssignmentExpressionexpression: Method = Method(name="ResourceAssignmentExpressionexpression", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_ResourceParameter_m_ResourceParameterowner: Method = Method(name="ResourceParameterowner", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_ResourceParameter_m_ResourceParametertype: Method = Method(name="ResourceParametertype", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_ResourceParameter_m_ResourceParameterisRequired: Method = Method(name="ResourceParameterisRequired", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_ResourceParameter.attributes={BPMNProfile_ResourceParameter_isRequired}
BPMNProfile_ResourceParameter.methods={BPMNProfile_ResourceParameter_m_ResourceParameterisRequired, BPMNProfile_ResourceParameter_m_ResourceParametertype, BPMNProfile_ResourceParameter_m_ResourceParameterowner}

# BPMNProfile_Resource class attributes and methods
BPMNProfile_Resource_m_ResourceresourceParameters: Method = Method(name="ResourceresourceParameters", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_ResourceParameterBinding_m_ResourceParameterBindingexpression: Method = Method(name="ResourceParameterBindingexpression", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_ResourceParameterBinding_m_ResourceParameterBindingparameterRef: Method = Method(name="ResourceParameterBindingparameterRef", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_GlobalTask_m_GlobalTasksupportedInterfaceRefs: Method = Method(name="GlobalTasksupportedInterfaceRefs", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_GlobalScriptTask_m_GlobalScriptTaskscriptFormat: Method = Method(name="GlobalScriptTaskscriptFormat", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_GlobalScriptTask_m_GlobalScriptTaskscript: Method = Method(name="GlobalScriptTaskscript", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_GlobalScriptTask.attributes={BPMNProfile_GlobalScriptTask_script, BPMNProfile_GlobalScriptTask_scriptFormat}
BPMNProfile_GlobalScriptTask.methods={BPMNProfile_GlobalScriptTask_m_GlobalScriptTaskscriptFormat, BPMNProfile_GlobalScriptTask_m_GlobalScriptTaskscript}
...
BPMNProfile_GlobalBusinessRuleTask_m_GlobalBusinessRuleTaskimplementation: Method = Method(name="GlobalBusinessRuleTaskimplementation", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_BPMNActivity_m_BPMNActivityresources: Method = Method(name="BPMNActivityresources", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_BPMNActivity_m_BPMNActivitycontainer: Method = Method(name="BPMNActivitycontainer", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_BPMNActivity_m_BPMNActivityproperties: Method = Method(name="BPMNActivityproperties", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_BPMNActivity_m_BPMNActivitydefault: Method = Method(name="BPMNActivitydefault", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_BPMNActivity_m_BPMNActivityboundaryEventsRefs: Method = Method(name="BPMNActivityboundaryEventsRefs", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_BPMNActivity_m_BPMNActivityloopCharacteristics: Method = Method(name="BPMNActivityloopCharacteristics", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_BPMNActivity.attributes={BPMNProfile_BPMNActivity_isForCompensation, BPMNProfile_BPMNActivity_completionQuantity, BPMNProfile_BPMNActivity_startQuantity}
BPMNProfile_BPMNActivity.methods={BPMNProfile_BPMNActivity_m_BPMNActivitycontainer, BPMNProfile_BPMNActivity_m_BPMNActivityresources, BPMNProfile_BPMNActivity_m_BPMNActivityloopCharacteristics, BPMNProfile_BPMNActivity_m_BPMNActivitydefault, BPMNProfile_BPMNActivity_m_BPMNActivityboundaryEventsRefs, BPMNProfile_BPMNActivity_m_BPMNActivityproperties}
...
BPMNProfile_BoundaryEvent_m_boundaryEventattachedToRef: Method = Method(name="boundaryEventattachedToRef", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_DataInputAssociation_m_dataInputAssociationsource: Method = Method(name="dataInputAssociationsource", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_DataInputAssociation_m_dataInputAssociationtarget: Method = Method(name="dataInputAssociationtarget", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_DataOutputAssociation_m_dataOutputAssociationsource: Method = Method(name="dataOutputAssociationsource", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_DataOutputAssociation_m_dataOutputAssociationtarget: Method = Method(name="dataOutputAssociationtarget", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_DataAssociation_m_DataAssociationsource: Method = Method(name="DataAssociationsource", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_DataAssociation_m_DataAssociationtransformation: Method = Method(name="DataAssociationtransformation", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_DataAssociation_m_DataAssociationtarget: Method = Method(name="DataAssociationtarget", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_DataAssociation.methods={BPMNProfile_DataAssociation_m_DataAssociationtransformation, BPMNProfile_DataAssociation_m_DataAssociationsource, BPMNProfile_DataAssociation_m_DataAssociationtarget}
...
BPMNProfile_CatchEvent_m_catchEventeventDefinitionsRefs: Method = Method(name="catchEventeventDefinitionsRefs", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_BPMNSignal_m_BPMNSignalstructureRef: Method = Method(name="BPMNSignalstructureRef", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_ThrowEvent_m_ThrowEventeventDefinitionRefs: Method = Method(name="ThrowEventeventDefinitionRefs", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_Escalation_m_EscalationstructureRef: Method = Method(name="EscalationstructureRef", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_ConditionalEventDefinition_m_conditionalEventDefinitioncondition: Method = Method(name="conditionalEventDefinitioncondition", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_DataObjectReference_m_DataObjectRefsourcetarget: Method = Method(name="DataObjectRefsourcetarget", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_DataObjectReference_m_DataObjectRefdataState: Method = Method(name="DataObjectRefdataState", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_DataObject_m_DataObjectdataState: Method = Method(name="DataObjectdataState", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_UserTask_m_UserTaskimplementation: Method = Method(name="UserTaskimplementation", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_UserTask_m_UserTaskrenderings: Method = Method(name="UserTaskrenderings", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_GlobalConversation_m_GlobalConversationcontainedelements: Method = Method(name="GlobalConversationcontainedelements", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_CallConversation_m_CallConversationcalledCollaborationRef: Method = Method(name="CallConversationcalledCollaborationRef", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_CallConversation_m_CallConversationparticipantAssociations: Method = Method(name="CallConversationparticipantAssociations", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_CallConversation.methods={BPMNProfile_CallConversation_m_CallConversationcalledCollaborationRef, BPMNProfile_CallConversation_m_CallConversationparticipantAssociations}
...
BPMNProfile_GlobalUserTask_m_GlobalUserTaskrenderings: Method = Method(name="GlobalUserTaskrenderings", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_GlobalUserTask_m_GlobalUserTaskimplementation: Method = Method(name="GlobalUserTaskimplementation", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_SubConversation_m_SubConversationconnectedelements: Method = Method(name="SubConversationconnectedelements", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_BusinessRuleTask_m_BusinessRuleTaskimplementation: Method = Method(name="BusinessRuleTaskimplementation", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_SubProcess_m_SubProcesstriggeredByEvent: Method = Method(name="SubProcesstriggeredByEvent", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_CallActivity_m_CallActivitycalledElementRefvalues: Method = Method(name="CallActivitycalledElementRefvalues", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_SendTask_m_SendTaskoperationRef: Method = Method(name="SendTaskoperationRef", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_AdHocSubProcess_m_AdHocSubProcesscancelRemainingInstances: Method = Method(name="AdHocSubProcesscancelRemainingInstances", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_AdHocSubProcess.attributes={BPMNProfile_AdHocSubProcess_cancelRemainingInstances, BPMNProfile_AdHocSubProcess_ordering}
...
BPMNProfile_ScriptTask_m_ScriptTaskscriptFormat: Method = Method(name="ScriptTaskscriptFormat", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_ScriptTask_m_ScriptTaskscript: Method = Method(name="ScriptTaskscript", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_ScriptTask.attributes={BPMNProfile_ScriptTask_scriptFormat, BPMNProfile_ScriptTask_script}
BPMNProfile_ScriptTask.methods={BPMNProfile_ScriptTask_m_ScriptTaskscriptFormat, BPMNProfile_ScriptTask_m_ScriptTaskscript}
...
BPMNProfile_ReceiveTask_m_ReceiveTaskoperationRef: Method = Method(name="ReceiveTaskoperationRef", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_ReceiveTask.attributes={BPMNProfile_ReceiveTask_implementation, BPMNProfile_ReceiveTask_instantiate}
...
BPMNProfile_StandardLoopCharacteristics_m_StandardLoopCharacteristicsloopCondition: Method = Method(name="StandardLoopCharacteristicsloopCondition", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_StandardLoopCharacteristics_m_StandardLoopCharacteristicstestBefore: Method = Method(name="StandardLoopCharacteristicstestBefore", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_StandardLoopCharacteristics.methods={BPMNProfile_StandardLoopCharacteristics_m_StandardLoopCharacteristicstestBefore, BPMNProfile_StandardLoopCharacteristics_m_StandardLoopCharacteristicsloopCondition}
...
BPMNProfile_ServiceTask_m_ServiceTaskinputSet: Method = Method(name="ServiceTaskinputSet", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_ServiceTask_m_ServiceTaskoutputSet: Method = Method(name="ServiceTaskoutputSet", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_ServiceTask_m_ServiceTaskoperationRef: Method = Method(name="ServiceTaskoperationRef", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_ServiceTask.attributes={BPMNProfile_ServiceTask_implementation}
BPMNProfile_ServiceTask.methods={BPMNProfile_ServiceTask_m_ServiceTaskoperationRef, BPMNProfile_ServiceTask_m_ServiceTaskinputSet, BPMNProfile_ServiceTask_m_ServiceTaskoutputSet}
...
BPMNProfile_MultiInstanceLoopCharacteristics_m_MultiinstanceLoopCharacteristicstarget: Method = Method(name="MultiinstanceLoopCharacteristicstarget", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
import_192: BinaryAssociation = BinaryAssociation(
    name="import_192",
    ends={
...
from_497: BinaryAssociation = BinaryAssociation(
    name="from_497",
    ends={
...
domain_model = DomainModel(
    name="BPMNProfile",
    types={BPMNProfile_SequenceFlow, BPMNProfile_NonExclusiveGateway, Gateway, BPMNProfile_JoinNode, BPMNProfile_ForkNode, BPMNProfile_Gateway, FlowNode, BPMNProfile_ControlNode, BPMNProfile_ActivityGroup, BPMNProfile_FlowNode, FlowElement, BPMNProfile_ActivityNode, BPMNProfile_FlowElement, BaseElement, BPMNProfile_Auditing, BPMNProfile_Monitoring, BPMNProfile_CategoryValue, BPMNProfile_FlowElementsContainer, BPMNProfile_InclusiveGateway, NonExclusiveGateway, BPMNProfile_ExtensionDefinition, BPMNProfile_BPMNAssociation, BPMNProfile_Slot, BPMNProfile_ExtensionAttributeDefinition, BPMNProfile_Property, BPMNProfile_Comment, BPMNProfile_Stereotype, BPMNArtifact, BPMNProfile_BaseElement, BPMNProfile_ExtensionAttributeValue, BPMNProfile_Element, BPMNProfile_Documentation, BPMNProfile_Class, BPMNProfile_EnumerationLiteral, BPMNProfile_LaneSet, BPMNProfile_Dependency, BPMNProfile_BPMNArtifact, BPMNProfile_ActivityPartition, BPMNProfile_Lane, BPMNProfile_ControlFlow, BPMNProfile_BPMNExpression, BPMNProfile_OpaqueExpression, BPMNProfile_EventBasedGateway, BPMNProfile_StructuredActivityNode, BPMNProfile_InterruptibleActivityRegion, BPMNProfile_ExclusiveGateway, BPMNProfile_DecisionNode, BPMNProfile_MergeNode, BPMNProfile_RootElement, BPMNProfile_PackageableElement, BPMNProfile_Definitions, BPMNProfile_ParallelGateway, BPMNProfile_ComplexGateway, BPMNProfile_BPMNExtension, BPMNProfile_Import, BPMNProfile_BPMNRelationship, BPMNProfile_Package, BPMNProfile_Constraint, BPMNProfile_BPMNProcess, CallableElement, FlowElementsContainer, BPMNProfile_PackageImport, BPMNProfile_BPMNCollaboration, BPMNProfile_Activity, BPMNProfile_CorrelationSubscription, BPMNProfile_BPMNProperty, BPMNProfile_ResourceRole, BPMNProfile_Behavior, BPMNProfile_InputOutputSpecification, BPMNProfile_BPMNInterface, BPMNProfile_InputOutputBinding, BPMNProfile_Action, BPMNProfile_DataInput, BPMNProfile_DataOutput, BPMNProfile_InputSet, BPMNProfile_OutputSet, ItemAwareElement, BPMNProfile_CallableElement, RootElement, BPMNProfile_Parameter, BPMNProfile_ActivityParameterNode, BPMNProfile_ItemAwareElement, BPMNProfile_DataState, BPMNProfile_TypedElement, BPMNProfile_ItemDefinition, BPMNProfile_State, BPMNProfile_InputPin, BPMNProfile_ParameterSet, BPMNProfile_OutputPin, BPMNProfile_Interface, BPMNProfile_BPMNOperation, BPMNProfile_Operation, BPMNProfile_BPMNMessage, BPMNProfile_Error, ItemDefinition, BPMNProfile_ParticipantAssociation, BPMNProfile_ConversationLink, BPMNProfile_MessageFlowAssociation, BPMNProfile_MessageFlow, BPMNProfile_Collaboration, BPMNProfile_ConversationNode, BPMNProfile_CorrelationKey, BPMNProfile_Participant, BPMNProfile_PartnerEntity, BPMNProfile_PartnerRole, BPMNProfile_InteractionNode, BPMNProfile_ParticipantMultiplicity, BPMNProfile_InstanceSpecification, BPMNProfile_MultiplicityElement, BPMNProfile_InformationFlow, InteractionNode, BPMNProfile_FormalExpression, BPMNExpression, BPMNProfile_CorrelationPropertyBinding, BPMNProfile_CorrelationProperty, BPMNProfile_CorrelationPropertyRetrievalExpression, BPMNProfile_ResourceAssignmentExpression, BPMNProfile_DataStoreNode, BPMNProfile_ResourceParameter, BPMNProfile_Resource, BPMNProfile_ResourceParameterBinding, BPMNProfile_GlobalTask, BPMNProfile_GlobalScriptTask, GlobalTask, BPMNProfile_OpaqueBehavior, BPMNProfile_GlobalBusinessRuleTask, BPMNProfile_CompensateEventDefinition, EventDefinition, BPMNProfile_BPMNActivity, BPMNProfile_CallEvent, BPMNProfile_EventDefinition, BPMNProfile_Event, BPMNProfile_BoundaryEvent, BPMNProfile_DataInputAssociation, BPMNProfile_DataOutputAssociation, BPMNProfile_LoopCharacteristics, CatchEvent, DataAssociation, BPMNProfile_DataAssociation, BPMNProfile_CatchEvent, BPMNEvent, BPMNProfile_AcceptEventAction, BPMNProfile_InitialNode, BPMNProfile_BPMNEvent, BPMNProfile_ObjectFlow, BPMNProfile_Assignment, BPMNProfile_ChangeEvent, BPMNProfile_SignalEventDefinition, BPMNProfile_BPMNSignal, BPMNProfile_EndEvent, ThrowEvent, BPMNProfile_FinalNode, BPMNProfile_ThrowEvent, BPMNProfile_EscalationEventDefinition, BPMNProfile_Escalation, BPMNProfile_TimerEventDefinition, BPMNProfile_LinkEventDefinition, BPMNProfile_ErrorEventDefinition, BPMNProfile_IntermediateCatchEvent, BPMNProfile_IntermediateThrowEvent, BPMNProfile_SendObjectAction, BPMNProfile_CallOperationAction, BPMNProfile_FlowFinalNode, BPMNProfile_MessageEventDefinition, BPMNProfile_StartEvent, BPMNProfile_ConditionalEventDefinition, BPMNProfile_DataObjectReference, BPMNProfile_DataObject, BPMNProfile_TerminateEventDefinition, BPMNProfile_ImplicitThrowEvent, BPMNProfile_CancelEventDefinition, BPMNProfile_TextAnnotation, BPMNProfile_Category, BPMNProfile_Enumeration, BPMNProfile_Group, BPMNProfile_OpaqueAction, BPMNProfile_Rendering, BPMNProfile_Task, BPMNActivity, BPMNProfile_Image, BPMNProfile_HumanPerformer, Performer, BPMNProfile_DataStore, BPMNProfile_DataStoreReference, BPMNProfile_UserTask, Task, BPMNProfile_GlobalConversation, BPMNCollaboration, BPMNProfile_CallConversation, BPMNProfile_CollaborationUse, BPMNProfile_Performer, ResourceRole, BPMNProfile_GlobalUserTask, BPMNProfile_GlobalManualTask, BPMNProfile_ManualTask, BPMNProfile_PotentialOwner, HumanPerformer, BPMNProfile_SubConversation, ConversationNode, BPMNProfile_CallBehaviorAction, BPMNProfile_BusinessRuleTask, BPMNProfile_ComplexBehaviorDefinition, BPMNProfile_Conversation, BPMNProfile_SubProcess, BPMNProfile_CallActivity, BPMNProfile_SendTask, BPMNProfile_AdHocSubProcess, SubProcess, BPMNProfile_ScriptTask, BPMNProfile_LoopNode, BPMNProfile_ReceiveTask, BPMNProfile_Transaction, BPMNProfile_StandardLoopCharacteristics, LoopCharacteristics, BPMNProfile_ServiceTask, BPMNProfile_MultiInstanceLoopCharacteristics, BPMNProfile_ExpansionRegion, AssociationDirection, EventBasedGatewayType, GatewayDirection, RelationshipDirection, ItemKind, ProcessType, AdHocOrdering, MultiInstanceBehavior},
    associations={default0, base_JoinNode1, base_ForkNode2, base_ControlNode4, base_ActivityGroup5, base_ActivityNode7, auditing8, monitoring9, _categoryValueRef11, container12, extensionDefinitions18, outgoing20, incoming21, base_Slot23, valueRef25, extensionAttributeDefinition28, base_Property30, base_Comment32, base_Stereotype34, extensionAttributeDefinitions36, extensionValues13, base_Element14, documentation16, base_Class43, base_Class45, base_EnumerationLiteral48, categorizedFlowElements49, laneSets50, flowElements51, base_Dependency39, targetRef40, sourceRef41, lanes54, parentLane55, flowElementsContainer57, base_ActivityPartition59, _partitionElement62, flowNodeRefs65, partitionElementRef68, base_ActivityPartition53, base_ControlFlow76, conditionExpression78, base_OpaqueExpression80, base_ForkNode82, base_StructuredActivityNode84, base_InterruptibleActivityRegion86, childLaneSet71, laneSet74, default88, activationCondition90, base_DecisionNode93, base_MergeNode94, default96, base_PackageableElement99, extensions102, imports104, relationships106, rootElements108, base_Stereotype109, definition112, definition100, base_Package101, definitions117, base_Constraint120, targets122, sources125, definition128, base_PackageImport115, auditing131, definitionalCollaborationRef133, base_Activity135, correlationSubscriptions137, monitoring139, supports143, properties145, resources147, base_Behavior148, ioSpecification149, supportedInterfaceRefs151, ioBinding153, base_Behavior155, base_Action158, dataInputs160, dataOutputs162, inputSets164, outputSets166, base_Parameter170, base_ActivityParameterNode172, inputSetRefs174, inputSetWithOptional175, inputSetWithWhileExecuting177, dataState179, base_TypedElement180, itemSubjectRef182, base_State184, base_InputPin168, base_ParameterSet195, optionalInputRefs197, whileExecutingInputRefs198, dataInputRefs200, base_Class186, structureRef189, import_192, base_ActivityParameterNode207, outputSetRefs210, outputSetWithOptional211, outputSetWithWhileExecuting214, base_ParameterSet217, optionalOutputRefs220, base_OutputPin202, base_Parameter204, base_Interface227, implementationRef229, operations232, callableElements234, whileExecutingOutputRefs223, dataOutputRefs226, base_Operation237, implementationRef239, inMessageRef242, outMessageRef244, errorRef247, participantAssociations264, conversationLinks266, messageFlowAssociations267, messageFlows269, base_Collaboration271, conversations273, correlationKeys275, participants277, itemRef249, inputDataRef252, outputDataRef255, operationRef258, base_Dependency261, base_Dependency279, innerParticipantRef282, outerParticipantRef285, partnerEntityRef296, partnerRoleRef297, interfaceRefs299, base_Element302, outgoingConversationLinks304, incomingConversationLinks307, collaboration310, base_Property288, processRef291, participantMultiplicity294, base_InstanceSpecification318, participantRef319, base_Class320, participantRef322, base_Dependency311, targetRef313, sourceRef314, base_MultiplicityElement316, base_InformationFlow333, sourceRef335, targetRef338, messageRef341, base_InformationFlow344, messageFlowRefs347, base_Dependency324, innerMessageFlowRef327, outerMessageFlowRef330, messageRef372, messagePath375, evaluatesToTypeRef377, base_Class380, correlationKeyRef383, correlationPropertyBinding386, base_Property388, correlationKeys350, participantRefs353, base_Class356, correlationPropertyRef359, base_Property361, type364, correlationPropertyRetrievalExpression367, base_Dependency369, base_Property402, resourceAssignmentExpression404, dataPath391, correlationPropertyRef394, base_DataStoreNode397, umlProperty399, expression411, resourceParameters414, resourceRef406, resourceParameterBindings408, process410, base_Property416, type419, base_Slot422, parameterRef425, expression428, base_OpaqueBehavior431, resources432, activityRef435, base_CallEvent436, base_Event438, boundaryEventRefs451, dataInputAssociations453, dataOutputAssociations455, loopCharacteristics457, resources459, attachedToRef462, base_Action439, activityClass442, properties445, default448, properties476, eventDefinitionRefs479, base_AcceptEventAction465, base_InitialNode466, dataOutputAssociation468, eventClass471, _eventDefinitions473, base_Dependency494, from_497, to500, base_StructuredActivityNode503, base_ObjectFlow482, sourceRef483, targetRef486, transformation489, assignment492, base_ChangeEvent518, signalRef520, base_CallEvent521, base_FinalNode524, escalationRef506, base_CallEvent507, timeCycle510, timeDate512, timeDuration515, base_ChangeEvent539, condition541, _target545, source547, base_CallEvent549, errorRef551, base_CallEvent553, base_CallOperationAction525, base_FlowFinalNode526, dataInputAssociation528, messageRef531, operationRef533, base_CallEvent536, _categoryValueRef569, dataObjectRef572, base_DataStoreNode573, base_SendObjectAction556, base_CallEvent557, base_CallEvent559, base_Comment561, base_Enumeration563, categoryValue564, base_ActivityPartition567, base_OpaqueAction589, renderings590, ioSpecification592, base_Image594, base_DataStoreNode576, base_Class579, itemSubjectRef581, _dataStore584, base_DataStoreNode586, conversationNodes600, _collaborationUse602, renderings596, base_OpaqueAction598, base_CallBehaviorAction614, calledElementRef615, base_OpaqueAction618, condition620, event622, base_ControlFlow624, calledCollaborationRef603, participantAssociations606, base_StructuredActivityNode609, hasLaneSets611, messageRef631, base_CallOperationAction633, completionCondition627, base_OpaqueAction629, base_LoopNode639, loopCondition640, operationRef636, base_CallOperationAction651, messageRef643, base_AcceptEventAction645, operationRef648, loopDataInputRef663, loopDataOutputRef666, outputDataItem669, inputDataItem672, oneBehaviorEventRef675, noneBehaviorEventRef678, complexBehaviorDefinition681, operationRef653, loopCardinality656, completionCondition658, base_ExpansionRegion661},
    generalizations={gen_BPMNProfile_NonExclusiveGateway_Gateway, gen_BPMNProfile_Gateway_FlowNode, gen_BPMNProfile_FlowNode_FlowElement, gen_BPMNProfile_FlowElement_BaseElement, gen_BPMNProfile_InclusiveGateway_NonExclusiveGateway, gen_BPMNProfile_Documentation_BaseElement, gen_BPMNProfile_BPMNAssociation_BPMNArtifact, gen_BPMNProfile_Auditing_BaseElement, gen_BPMNProfile_Monitoring_BaseElement, gen_BPMNProfile_CategoryValue_BaseElement, gen_BPMNProfile_FlowElementsContainer_BaseElement, gen_BPMNProfile_LaneSet_BaseElement, gen_BPMNProfile_BPMNArtifact_BaseElement, gen_BPMNProfile_Lane_BaseElement, gen_BPMNProfile_BPMNExpression_BaseElement, gen_BPMNProfile_EventBasedGateway_Gateway, gen_BPMNProfile_SequenceFlow_FlowElement, gen_BPMNProfile_ExclusiveGateway_Gateway, gen_BPMNProfile_RootElement_BaseElement, gen_BPMNProfile_ParallelGateway_NonExclusiveGateway, gen_BPMNProfile_ComplexGateway_NonExclusiveGateway, gen_BPMNProfile_Definitions_BaseElement, gen_BPMNProfile_BPMNRelationship_BaseElement, gen_BPMNProfile_BPMNProcess_CallableElement, gen_BPMNProfile_BPMNProcess_FlowElementsContainer, gen_BPMNProfile_InputOutputSpecification_BaseElement, gen_BPMNProfile_DataInput_ItemAwareElement, gen_BPMNProfile_CallableElement_RootElement, gen_BPMNProfile_ItemAwareElement_BaseElement, gen_BPMNProfile_DataState_BaseElement, gen_BPMNProfile_ItemDefinition_RootElement, gen_BPMNProfile_InputSet_BaseElement, gen_BPMNProfile_DataOutput_ItemAwareElement, gen_BPMNProfile_OutputSet_BaseElement, gen_BPMNProfile_BPMNOperation_BaseElement, gen_BPMNProfile_BPMNInterface_RootElement, gen_BPMNProfile_BPMNMessage_ItemDefinition, gen_BPMNProfile_ParticipantAssociation_BaseElement, gen_BPMNProfile_Error_ItemDefinition, gen_BPMNProfile_InputOutputBinding_BaseElement, gen_BPMNProfile_BPMNCollaboration_RootElement, gen_BPMNProfile_Participant_BaseElement, gen_BPMNProfile_ConversationLink_BaseElement, gen_BPMNProfile_PartnerRole_RootElement, gen_BPMNProfile_MessageFlowAssociation_BaseElement, gen_BPMNProfile_ParticipantMultiplicity_BaseElement, gen_BPMNProfile_PartnerEntity_RootElement, gen_BPMNProfile_ConversationNode_InteractionNode, gen_BPMNProfile_MessageFlow_BaseElement, gen_BPMNProfile_FormalExpression_BPMNExpression, gen_BPMNProfile_CorrelationSubscription_BaseElement, gen_BPMNProfile_CorrelationPropertyBinding_BaseElement, gen_BPMNProfile_CorrelationKey_BaseElement, gen_BPMNProfile_CorrelationProperty_BaseElement, gen_BPMNProfile_CorrelationPropertyRetrievalExpression_BaseElement, gen_BPMNProfile_BPMNProperty_ItemAwareElement, gen_BPMNProfile_ResourceRole_BaseElement, gen_BPMNProfile_ResourceAssignmentExpression_BPMNExpression, gen_BPMNProfile_Resource_ItemDefinition, gen_BPMNProfile_ResourceParameterBinding_BaseElement, gen_BPMNProfile_ResourceParameter_BaseElement, gen_BPMNProfile_GlobalTask_CallableElement, gen_BPMNProfile_GlobalScriptTask_GlobalTask, gen_BPMNProfile_BPMNActivity_FlowNode, gen_BPMNProfile_GlobalBusinessRuleTask_GlobalTask, gen_BPMNProfile_CompensateEventDefinition_EventDefinition, gen_BPMNProfile_EventDefinition_RootElement, gen_BPMNProfile_BoundaryEvent_CatchEvent, gen_BPMNProfile_DataOutputAssociation_DataAssociation, gen_BPMNProfile_DataAssociation_BaseElement, gen_BPMNProfile_CatchEvent_BPMNEvent, gen_BPMNProfile_BPMNEvent_FlowNode, gen_BPMNProfile_DataInputAssociation_DataAssociation, gen_BPMNProfile_LoopCharacteristics_BaseElement, gen_BPMNProfile_Assignment_BaseElement, gen_BPMNProfile_SignalEventDefinition_EventDefinition, gen_BPMNProfile_BPMNSignal_ItemDefinition, gen_BPMNProfile_EndEvent_ThrowEvent, gen_BPMNProfile_ThrowEvent_BPMNEvent, gen_BPMNProfile_EscalationEventDefinition_EventDefinition, gen_BPMNProfile_Escalation_ItemDefinition, gen_BPMNProfile_TimerEventDefinition_EventDefinition, gen_BPMNProfile_LinkEventDefinition_EventDefinition, gen_BPMNProfile_ErrorEventDefinition_EventDefinition, gen_BPMNProfile_IntermediateCatchEvent_CatchEvent, gen_BPMNProfile_IntermediateThrowEvent_ThrowEvent, gen_BPMNProfile_MessageEventDefinition_EventDefinition, gen_BPMNProfile_StartEvent_CatchEvent, gen_BPMNProfile_ConditionalEventDefinition_EventDefinition, gen_BPMNProfile_DataObjectReference_FlowElement, gen_BPMNProfile_DataObjectReference_ItemAwareElement, gen_BPMNProfile_DataObject_FlowElement, gen_BPMNProfile_DataObject_ItemAwareElement, gen_BPMNProfile_TerminateEventDefinition_EventDefinition, gen_BPMNProfile_ImplicitThrowEvent_ThrowEvent, gen_BPMNProfile_CancelEventDefinition_EventDefinition, gen_BPMNProfile_TextAnnotation_BPMNArtifact, gen_BPMNProfile_Category_RootElement, gen_BPMNProfile_Group_BPMNArtifact, gen_BPMNProfile_Task_BPMNActivity, gen_BPMNProfile_Rendering_BaseElement, gen_BPMNProfile_DataStore_RootElement, gen_BPMNProfile_DataStoreReference_FlowElement, gen_BPMNProfile_DataStoreReference_ItemAwareElement, gen_BPMNProfile_UserTask_Task, gen_BPMNProfile_GlobalConversation_BPMNCollaboration, gen_BPMNProfile_CallConversation_ConversationNode, gen_BPMNProfile_HumanPerformer_Performer, gen_BPMNProfile_Performer_ResourceRole, gen_BPMNProfile_GlobalUserTask_GlobalTask, gen_BPMNProfile_GlobalManualTask_GlobalTask, gen_BPMNProfile_ManualTask_Task, gen_BPMNProfile_PotentialOwner_HumanPerformer, gen_BPMNProfile_SubConversation_ConversationNode, gen_BPMNProfile_BusinessRuleTask_Task, gen_BPMNProfile_ComplexBehaviorDefinition_BaseElement, gen_BPMNProfile_Conversation_ConversationNode, gen_BPMNProfile_SubProcess_BPMNActivity, gen_BPMNProfile_SubProcess_FlowElementsContainer, gen_BPMNProfile_CallActivity_BPMNActivity, gen_BPMNProfile_SendTask_Task, gen_BPMNProfile_AdHocSubProcess_SubProcess, gen_BPMNProfile_ScriptTask_Task, gen_BPMNProfile_ReceiveTask_Task, gen_BPMNProfile_Transaction_SubProcess, gen_BPMNProfile_StandardLoopCharacteristics_LoopCharacteristics, gen_BPMNProfile_ServiceTask_Task, gen_BPMNProfile_MultiInstanceLoopCharacteristics_LoopCharacteristics},
    metadata=None
)
