...
class fuml_CompleteStructuredActivities_LoopNode(StructuredActivityNode):
    ...
    def __init__(self, testedFirst: bool, fuml_CompleteStructuredActivities_LoopNode143: set["BasicActions_OutputPin"] = None, fuml_CompleteStructuredActivities_LoopNode146: set["BasicActions_InputPin"] = None, fuml_CompleteStructuredActivities_LoopNode148: set["CompleteStructuredActivities_ExecutableNode"] = None, fuml_CompleteStructuredActivities_LoopNode151: set["BasicActions_OutputPin"] = None, fuml_CompleteStructuredActivities_LoopNode154: set["BasicActions_OutputPin"] = None, fuml_CompleteStructuredActivities_LoopNode157: set["CompleteStructuredActivities_ExecutableNode"] = None, fuml_CompleteStructuredActivities_LoopNode: "BasicActions_OutputPin" = None, fuml_CompleteStructuredActivities_LoopNode141: set["CompleteStructuredActivities_ExecutableNode"] = None):
...
class fuml_Kernel_Property(StructuralFeature):
    ...
    def __init__(self, aggregation: str, composite: bool, derived: bool, derivedUnion: bool, ownedAttribute: "Kernel_DataType" = None, ownedAttribute65: "Kernel_Class" = None, fuml_Kernel_Property: "Kernel_Property" = None, ownedEnd: "Kernel_Association" = None, memberEnd: "Kernel_Association" = None):
...
class fuml_Kernel_RedefinableElement(NamedElement):
    ...
    def __init__(self, leaf: bool, fuml_Kernel_RedefinableElement45: set["Kernel_Classifier"] = None, fuml_Kernel_RedefinableElement: set["Kernel_RedefinableElement"] = None):
        self.leaf = leaf
...
class fuml_Kernel_Classifier(Kernel_Type, Kernel_Namespace):
    ...
    def __init__(self, abstract: bool, finalSpecialization: bool, fuml_Kernel_Classifier54: set["Kernel_Classifier"] = None, specific: set["Kernel_Generalization"] = None, featuringClassifier: set["Kernel_Feature"] = None, fuml_Kernel_Classifier: set["Kernel_NamedElement"] = None, fuml_Kernel_Classifier51: set["Kernel_Property"] = None, Kernel_Type90: "fuml_Kernel_Operation" = None, Type: "fuml_Kernel_Package" = None, Kernel_Type: "fuml_Kernel_TypedElement" = None, Kernel_Type69: "fuml_Kernel_Association" = None, Namespace30: "fuml_Kernel_ElementImport" = None, Namespace33: "fuml_Kernel_PackageImport" = None, Namespace: "fuml_Kernel_NamedElement" = None):
        self.abstract = abstract
...
class fuml_Kernel_Association(Classifier):
    ...
    def __init__(self, derived: bool, fuml_Kernel_Association72: set["Kernel_Property"] = None, owningAssociation: set["Kernel_Property"] = None, fuml_Kernel_Association: set["Kernel_Type"] = None, association: set["Kernel_Property"] = None):
        self.derived = derived
