...
def test_fuml_basicbehaviors_parametervalue_is_not_abstract():
    assert not inspect.isabstract(fuml_BasicBehaviors_ParameterValue)


def test_fuml_basicbehaviors_parametervalue_constructor_exists():
    assert callable(fuml_BasicBehaviors_ParameterValue.__init__)


def test_fuml_basicbehaviors_parametervalue_constructor_args():
    sig = inspect.signature(fuml_BasicBehaviors_ParameterValue.__init__)
    params = list(sig.parameters.keys())



def test_kernel_extensionalvalue_is_not_abstract():
    assert not inspect.isabstract(Kernel_ExtensionalValue)


def test_kernel_extensionalvalue_constructor_exists():
    assert callable(Kernel_ExtensionalValue.__init__)


def test_kernel_extensionalvalue_constructor_args():
    sig = inspect.signature(Kernel_ExtensionalValue.__init__)
    params = list(sig.parameters.keys())



def test_fuml_locil1_locus_is_not_abstract():
    assert not inspect.isabstract(fuml_LociL1_Locus)


def test_fuml_locil1_locus_constructor_exists():
    assert callable(fuml_LociL1_Locus.__init__)


def test_fuml_locil1_locus_constructor_args():
...
def test_locil1_locus_is_not_abstract():
    assert not inspect.isabstract(LociL1_Locus)


def test_locil1_locus_constructor_exists():
    assert callable(LociL1_Locus.__init__)


def test_locil1_locus_constructor_args():
