...
# Classes
ctxmngr_ManagerState = Class(name="ctxmngr_ManagerState")
ctxmngr_ContextManager = Class(name="ctxmngr_ContextManager")
NamedElement = Class(name="NamedElement")
ctxmngr_CtxState = Class(name="ctxmngr_CtxState")
ctxmngr_ContextParameter = Class(name="ctxmngr_ContextParameter")
ctxmngr_Manager = Class(name="ctxmngr_Manager")
ctxmngr_RemoteFiringDependency = Class(name="ctxmngr_RemoteFiringDependency")
ctxmngr_CtxTransition = Class(name="ctxmngr_CtxTransition")
ctxmngr_ManagerTransition = Class(name="ctxmngr_ManagerTransition")
ctxmngr_OpaqueExpression = Class(name="ctxmngr_OpaqueExpression")
...
ctxmngr_CtxState.attributes={ctxmngr_CtxState_isEnd, ctxmngr_CtxState_isStart}
...
ctxmngr_ContextParameter.attributes={ctxmngr_ContextParameter_isInput, ctxmngr_ContextParameter_LitteralBoolean, ctxmngr_ContextParameter_LitteralUnlimitedNatural, ctxmngr_ContextParameter_LitteralInteger, ctxmngr_ContextParameter_LitteralString}
...
ctxmngr_CtxTransition.attributes={ctxmngr_CtxTransition_Condition, ctxmngr_CtxTransition_transProb, ctxmngr_CtxTransition_input, ctxmngr_CtxTransition_isRemote, ctxmngr_CtxTransition_transRate, ctxmngr_CtxTransition_Event, ctxmngr_CtxTransition_output, ctxmngr_CtxTransition_Action}
...
domain_model = DomainModel(
    name="ctxmngr",
    types={ctxmngr_ManagerState, ctxmngr_ContextManager, NamedElement, ctxmngr_CtxState, ctxmngr_ContextParameter, ctxmngr_Manager, ctxmngr_RemoteFiringDependency, ctxmngr_CtxTransition, ctxmngr_ManagerTransition, ctxmngr_OpaqueExpression},
    associations={contextParameters18, managerStates20, owningManager22, source24, target26, ownedState0, initialState1, finalState2, contextParameters5, combinedManager7, remoteFirings9, ownedTransition11, owningManager13, outgoingTransition14, incomingTransition16, managerTransition28, state29, opaqueExpressions31, owningManager32, fired35, firing37, owningManager40, represents42},
    generalizations={gen_ctxmngr_CtxTransition_NamedElement, gen_ctxmngr_ContextManager_NamedElement, gen_ctxmngr_CtxState_NamedElement, gen_ctxmngr_ContextParameter_NamedElement, gen_ctxmngr_RemoteFiringDependency_NamedElement},
    metadata=None
)
