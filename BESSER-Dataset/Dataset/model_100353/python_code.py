...
class DFAAutomaton_AlphabetSymbol:
    ...
    def __init__(self, symbol: str, DFAAutomaton_AlphabetSymbol: "DFAAutomaton_Automaton" = None, DFAAutomaton_AlphabetSymbol13: "DFAAutomaton_Transition" = None):
        self.symbol = symbol
        self.DFAAutomaton_AlphabetSymbol = DFAAutomaton_AlphabetSymbol
        self.DFAAutomaton_AlphabetSymbol13 = DFAAutomaton_AlphabetSymbol13
    ...
    @property
    def DFAAutomaton_AlphabetSymbol13(self):
        return self.__DFAAutomaton_AlphabetSymbol13

    @DFAAutomaton_AlphabetSymbol13.setter
    def DFAAutomaton_AlphabetSymbol13(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DFAAutomaton_AlphabetSymbol__DFAAutomaton_AlphabetSymbol13", None)
        self.__DFAAutomaton_AlphabetSymbol13 = value
