...
class raspduinoDSL_Timer:
    ...
    def __init__(self, repeattype: str, secs: int, hours: int, minutes: int, raspduinoDSL_Timer17: "raspduinoDSL_EventHandler" = None, raspduinoDSL_Timer: "raspduinoDSL_Model" = None):
...
class raspduinoDSL_SensorListener:
    ...
    def __init__(self, type: str, l: int, h: int, raspduinoDSL_SensorListener12: "raspduinoDSL_Sensor" = None, raspduinoDSL_SensorListener14: "raspduinoDSL_EventHandler" = None, raspduinoDSL_SensorListener: "raspduinoDSL_Model" = None):
        self.type = type
        self.l = l
        self.h = h
...
class raspduinoDSL_EventHandler:
    ...
    def __init__(self, name: str, raspduinoDSL_EventHandler8: set["raspduinoDSL_ChangeActuator"] = None, raspduinoDSL_EventHandler15: "raspduinoDSL_SensorListener" = None, raspduinoDSL_EventHandler18: "raspduinoDSL_Timer" = None, raspduinoDSL_EventHandler: "raspduinoDSL_Model" = None):
        self.name = name
