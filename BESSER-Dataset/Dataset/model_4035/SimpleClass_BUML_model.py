...
# Classes
simpleClass_NamedElement = Class(name="simpleClass_NamedElement", is_abstract=True)
simpleClass_ClassModel = Class(name="simpleClass_ClassModel")
simpleClass_Package = Class(name="simpleClass_Package")
...
domain_model = DomainModel(
    ...
    associations={packages0, subPackages2, classes4, source13, target16, associations6, attributes8, super11},
    generalizations={gen_simpleClass_Package_NamedElement, gen_simpleClass_Attribute_NamedElement, gen_simpleClass_Association_NamedElement, gen_simpleClass_Class_NamedElement},
    metadata=None
)
