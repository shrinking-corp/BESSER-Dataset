...
public class mypackage_Customer  {
    ...
    public mypackage_Customer(
        String name,        String address,        LocalDate dateOfBirth,        String emailAddress,        String phoneNumber    ) {
        this.name = name;
    ...
    public mypackage_Customer(
        String name,        String address,        LocalDate dateOfBirth,        String emailAddress,        String phoneNumber        ArrayList<account_Account> account_accounts    ) {
        this.name = name;
        this.address = address;
        this.dateOfBirth = dateOfBirth;
        this.emailAddress = emailAddress;
