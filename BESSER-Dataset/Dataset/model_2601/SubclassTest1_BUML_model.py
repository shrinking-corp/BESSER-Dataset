...
# Classes
package1_RootClass = Class(name="package1_RootClass")
package1_RootAbstractClass = Class(name="package1_RootAbstractClass", is_abstract=True)
package1_RootInterface = Class(name="package1_RootInterface", is_abstract=True)
package1_Child1 = Class(name="package1_Child1")
RootClass = Class(name="RootClass")
package1_Child2 = Class(name="package1_Child2")
RootAbstractClass = Class(name="RootAbstractClass")
package1_Child3 = Class(name="package1_Child3")
RootInterface = Class(name="RootInterface")
package1_Child4 = Class(name="package1_Child4")
package1_SubChild = Class(name="package1_SubChild")
Child4 = Class(name="Child4")
package1_SubChild3 = Class(name="package1_SubChild3")
SubChild = Class(name="SubChild")
package1_subpackage_Child5 = Class(name="package1_subpackage_Child5")
package1_subpackage_Child6 = Class(name="package1_subpackage_Child6")
package1_subpackage_SubChild2 = Class(name="package1_subpackage_SubChild2")
...
domain_model = DomainModel(
    name="package1",
    types={package1_RootClass, package1_RootAbstractClass, package1_RootInterface, package1_Child1, RootClass, package1_Child2, RootAbstractClass, package1_Child3, RootInterface, package1_Child4, package1_SubChild, Child4, package1_SubChild3, SubChild, package1_subpackage_Child5, package1_subpackage_Child6, package1_subpackage_SubChild2},
    associations={},
    generalizations={gen_package1_Child1_RootClass, gen_package1_Child2_RootAbstractClass, gen_package1_Child3_RootInterface, gen_package1_Child4_RootAbstractClass, gen_package1_Child4_RootClass, gen_package1_Child4_RootInterface, gen_package1_SubChild_Child4, gen_package1_SubChild3_RootClass, gen_package1_SubChild3_SubChild, gen_package1_subpackage_Child5_RootClass, gen_package1_subpackage_Child6_RootAbstractClass, gen_package1_subpackage_Child6_RootClass, gen_package1_subpackage_Child6_RootInterface, gen_package1_subpackage_SubChild2_Child4},
    metadata=None
)
