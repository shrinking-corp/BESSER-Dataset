...
class FlowDesigner_Flow:
    ...
    def __init__(self, FlowDesigner_Flow5: set["FlowDesigner_NamedState"] = None, FlowDesigner_Flow7: "FlowDesigner_FinalState" = None, FlowDesigner_Flow: "FlowDesigner_InitialState" = None):
    ...
    def hasLastState(self) :
        # TODO: Implement hasLastState method
        pass

    def findStateByName(self, FlowDesigner_name) :
...
class FlowDesigner_Source(ABC):
    ...
    def canBeSource(self, FlowDesigner_target) :
...
class FlowDesigner_Target(ABC):
    ...
    def canBeTarget(self, FlowDesigner_source) :
...
class Source:
    ...
    pass
class FlowDesigner_NamedState(Target, Source):
