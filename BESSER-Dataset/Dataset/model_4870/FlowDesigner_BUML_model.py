...
# Classes
FlowDesigner_InitialState = Class(name="FlowDesigner_InitialState")
Source = Class(name="Source")
FlowDesigner_FinalState = Class(name="FlowDesigner_FinalState")
Target = Class(name="Target")
FlowDesigner_ActionState = Class(name="FlowDesigner_ActionState")
NamedState = Class(name="NamedState")
FlowDesigner_ViewState = Class(name="FlowDesigner_ViewState")
FlowDesigner_Event = Class(name="FlowDesigner_Event")
FlowDesigner_Target = Class(name="FlowDesigner_Target", is_abstract=True)
FlowDesigner_Source = Class(name="FlowDesigner_Source", is_abstract=True)
FlowDesigner_NamedState = Class(name="FlowDesigner_NamedState", is_abstract=True)
FlowDesigner_Flow = Class(name="FlowDesigner_Flow")
...
FlowDesigner_Event.attributes={FlowDesigner_Event_event, FlowDesigner_Event_guard, FlowDesigner_Event_action}

# FlowDesigner_Target class attributes and methods
FlowDesigner_Target_m_canBeTarget: Method = Method(name="canBeTarget", parameters={Parameter(name='FlowDesigner_source', type=StringType)}, type=BooleanType)
FlowDesigner_Target.methods={FlowDesigner_Target_m_canBeTarget}

# FlowDesigner_Source class attributes and methods
FlowDesigner_Source_m_canBeSource: Method = Method(name="canBeSource", parameters={Parameter(name='FlowDesigner_target', type=StringType)}, type=BooleanType)
...
FlowDesigner_NamedState.attributes={FlowDesigner_NamedState_exit, FlowDesigner_NamedState_entry, FlowDesigner_NamedState_name, FlowDesigner_NamedState_activity}

# FlowDesigner_Flow class attributes and methods
FlowDesigner_Flow_m_findStateByName: Method = Method(name="findStateByName", parameters={Parameter(name='FlowDesigner_name', type=StringType)}, type=NamedState)
...
domain_model = DomainModel(
    name="FlowDesigner",
    types={FlowDesigner_InitialState, Source, FlowDesigner_FinalState, Target, FlowDesigner_ActionState, NamedState, FlowDesigner_ViewState, FlowDesigner_Event, FlowDesigner_Target, FlowDesigner_Source, FlowDesigner_NamedState, FlowDesigner_Flow},
    associations={states4, finalState6, nextState0, events1, initialState3},
