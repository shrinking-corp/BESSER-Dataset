...
def test_hyp_carro_de_compras_is_not_abstract():
    assert not inspect.isabstract(Carro_de_Compras)


def test_hyp_carro_de_compras_constructor_exists():
    assert callable(Carro_de_Compras.__init__)


def test_hyp_carro_de_compras_constructor_args():
...
def test_hyp_cliente_Contacto_setter(instance):
...
@given(instance=Cliente_strategy)
def test_hyp_cliente_Direcci_n_setter(instance):
...
def test_hyp_carro_de_compras_IdCarro_setter(instance):
...
@given(instance=Carro_de_Compras_strategy)
def test_hyp_carro_de_compras_Producto_setter(instance):
...
@given(instance=Carro_de_Compras_strategy)
def test_hyp_carro_de_compras_Precio_setter(instance):
...
@given(instance=Carro_de_Compras_strategy)
def test_hyp_carro_de_compras_Cantidad_setter(instance):
