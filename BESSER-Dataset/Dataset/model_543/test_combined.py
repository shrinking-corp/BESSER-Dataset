...
def test_ExtendedFamilies_Family_lastName_value_roundtrip():
    instance = ExtendedFamilies_Family(lastName="sample_text", noOfChildren=7)
...
def test_assoc_family1_link_reassign_clear():
    a = ExtendedFamilies_Person(firstName="sample_text")
    b1 = ExtendedFamilies_Family(lastName="sample_text", noOfChildren=7)
    b2 = ExtendedFamilies_Family(lastName="sample_text_2", noOfChildren=13)
...
ExtendedFamilies_Family_strategy = st.builds(ExtendedFamilies_Family, lastName=safe_text, noOfChildren=st.integers())
@given(instance=ExtendedFamilies_Family_strategy)
