...
# Classes
ExtendedFamilies_Male = Class(name="ExtendedFamilies_Male")
Person = Class(name="Person")
ExtendedFamilies_Female = Class(name="ExtendedFamilies_Female")
ExtendedFamilies_Family = Class(name="ExtendedFamilies_Family")
ExtendedFamilies_Person = Class(name="ExtendedFamilies_Person", is_abstract=True)
...
ExtendedFamilies_Family.attributes={ExtendedFamilies_Family_lastName, ExtendedFamilies_Family_noOfChildren}
...
domain_model = DomainModel(
    ...
    types={ExtendedFamilies_Male, Person, ExtendedFamilies_Female, ExtendedFamilies_Family, ExtendedFamilies_Person},
    associations={family1, children3, parents6, members0},
