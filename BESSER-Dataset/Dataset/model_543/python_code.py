...
class ExtendedFamilies_Person(ABC):
    ...
    def __init__(self, firstName: str, members: "ExtendedFamilies_Family" = None, Person4: "ExtendedFamilies_Person" = None, parents: set["ExtendedFamilies_Person"] = None, Person7: "ExtendedFamilies_Person" = None, children: set["ExtendedFamilies_Person"] = None, Person: "ExtendedFamilies_Family" = None):
...
class ExtendedFamilies_Family:
    ...
    def __init__(self, noOfChildren: int, lastName: str, Family: "ExtendedFamilies_Person" = None, family: set["ExtendedFamilies_Person"] = None):
