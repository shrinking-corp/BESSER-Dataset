...
def test_hyp_types_bool_is_not_abstract():
    assert not inspect.isabstract(types_Bool)


def test_hyp_types_bool_constructor_exists():
    assert callable(types_Bool.__init__)


def test_hyp_types_bool_constructor_args():
    sig = inspect.signature(types_Bool.__init__)
    params = list(sig.parameters.keys())
