...
sql_common_SchemaQualifiedName.attributes={sql_common_SchemaQualifiedName_name, sql_common_SchemaQualifiedName_schemaName, sql_common_SchemaQualifiedName_catalogName}
...
sql_datatype_LargeObjectLength.attributes={sql_datatype_LargeObjectLength_units, sql_datatype_LargeObjectLength_value, sql_datatype_LargeObjectLength_multiplier}
...
domain_model = DomainModel(
    name="sql",
    types={sql_common_SQLScript, Statement, sql_common_DirectSQLStatement, sql_common_Separator, sql_Dummy, sql_literal_TimeLiteral, sql_literal_TimestampLiteral, sql_literal_ExactNumericLiteral, NumericLiteral, sql_literal_ApproximateNumericLiteral, sql_literal_NumericLiteral, sql_common_Comment, Separator, sql_common_SimpleComment, Comment, sql_common_BracketedComment, sql_common_Statement, sql_common_SchemaQualifiedName, sql_literal_Literal, sql_literal_GeneralLiteral, Literal, sql_literal_CharacterStringLiteral, NationalCharacterStringLiteral, SchemaQualifiedName, sql_literal_NationalCharacterStringLiteral, GeneralLiteral, sql_literal_DatetimeLiteral, sql_literal_BooleanLiteral, sql_literal_DateLiteral, DatetimeLiteral, sql_datatype_DataType, sql_datatype_PredefinedType, DataType, sql_datatype_CharacterStringType, PredefinedType, sql_datatype_NationalCharacterStringType, sql_datatype_BinaryLargeObjectStringType, LargeObjectLength, sql_datatype_NumericType, sql_datatype_BooleanType, sql_datatype_DatetimeType, sql_function_DatetimeValueFunction, sql_expression_ImplicitlyTypedValueSpecification, sql_expression_NullSpecification, ImplicitlyTypedValueSpecification, sql_datatype_ExactNumericType, NumericType, sql_datatype_ApproximateNumericType, sql_datatype_LargeObjectLength, sql_datatype_DateType, DatetimeType, sql_datatype_TimeType, sql_datatype_TimestampType, sql_schema_TableContentsSource, TableDefinition, sql_schema_DefaultOption, Column, sql_schema_ColumnConstraint, sql_schema_TableDefinition, schema_SQLSchemaDefinitionStatement, EObject, TableContentsSource, sql_schema_TableElementList, TableElement, sql_schema_TableElement, TableElementList, sql_schema_Column, DefaultOption, ColumnConstraint, sql_schema_TableConstraint, schema_TableElement, sql_schema_UniqueConstraint, sql_schema_ReferentialConstraint, TableReference, sql_schema_TableReference, sql_schema_NotNullColumnConstraint, sql_schema_UniqueColumnConstraint, schema_UniqueConstraint, schema_ColumnConstraint, sql_schema_ReferentialColumnConstraint, schema_ReferentialConstraint, sql_schema_SQLSchemaStatement, DirectSQLStatement, sql_schema_SQLSchemaDefinitionStatement, SQLSchemaStatement, sql_schema_LiteralDefaultOption, sql_schema_DatetimeValueFunctionDefaultOption, DatetimeValueFunction, sql_schema_ImplicitlyTypedValueSpecificationDefaultOption, sql_schema_UniqueTableConstraint, schema_TableColumnsConstraint, sql_schema_ReferentialTableConstraint, sql_schema_TableColumnsConstraint, TableConstraint, NationalCharacterStringTypeKind, BinaryLargeObjectStringTypeKind, ExactNumericTypeKind, CharacterStringTypeKind, DatetimeValueFunctionKind, ApproximateNumericTypeKind, Multiplier, CharLengthUnits, TableScope, UniqueSpecificationKind},
    associations={statements0, characterSetName1, separators2, characterSetName3, collationName5, collationName8, length10, schemaQualifiedName25, owner27, owner28, schemaQualifiedName11, contentsSource13, elements14, owner16, dataType17, defaultOption18, constraint20, collationName22, referencedColumns36, referencedTable38, target40, owner29, schemaQualifiedName31, literal33, function34, specification35, columns42},
    generalizations={gen_sql_common_DirectSQLStatement_Statement, gen_sql_common_Separator_Statement, gen_sql_literal_TimeLiteral_DatetimeLiteral, gen_sql_literal_TimestampLiteral_DatetimeLiteral, gen_sql_literal_ExactNumericLiteral_NumericLiteral, gen_sql_literal_ApproximateNumericLiteral_NumericLiteral, gen_sql_literal_NumericLiteral_Literal, gen_sql_common_Comment_Separator, gen_sql_common_SimpleComment_Comment, gen_sql_common_BracketedComment_Comment, gen_sql_literal_GeneralLiteral_Literal, gen_sql_literal_CharacterStringLiteral_NationalCharacterStringLiteral, gen_sql_literal_NationalCharacterStringLiteral_GeneralLiteral, gen_sql_literal_DatetimeLiteral_GeneralLiteral, gen_sql_literal_BooleanLiteral_GeneralLiteral, gen_sql_literal_DateLiteral_DatetimeLiteral, gen_sql_datatype_PredefinedType_DataType, gen_sql_datatype_CharacterStringType_PredefinedType, gen_sql_datatype_NationalCharacterStringType_PredefinedType, gen_sql_datatype_BinaryLargeObjectStringType_PredefinedType, gen_sql_datatype_NumericType_PredefinedType, gen_sql_datatype_BooleanType_PredefinedType, gen_sql_datatype_DatetimeType_PredefinedType, gen_sql_expression_NullSpecification_ImplicitlyTypedValueSpecification, gen_sql_datatype_ExactNumericType_NumericType, gen_sql_datatype_ApproximateNumericType_NumericType, gen_sql_datatype_DateType_DatetimeType, gen_sql_datatype_TimeType_DatetimeType, gen_sql_datatype_TimestampType_DatetimeType, gen_sql_schema_TableConstraint_EObject, gen_sql_schema_ColumnConstraint_EObject, gen_sql_schema_TableDefinition_schema_SQLSchemaDefinitionStatement, gen_sql_schema_TableDefinition_EObject, gen_sql_schema_TableElementList_TableContentsSource, gen_sql_schema_Column_TableElement, gen_sql_schema_TableConstraint_schema_TableElement, gen_sql_schema_NotNullColumnConstraint_ColumnConstraint, gen_sql_schema_UniqueColumnConstraint_schema_UniqueConstraint, gen_sql_schema_UniqueColumnConstraint_schema_ColumnConstraint, gen_sql_schema_ReferentialColumnConstraint_schema_ReferentialConstraint, gen_sql_schema_ReferentialColumnConstraint_schema_ColumnConstraint, gen_sql_schema_SQLSchemaStatement_DirectSQLStatement, gen_sql_schema_SQLSchemaDefinitionStatement_SQLSchemaStatement, gen_sql_schema_LiteralDefaultOption_DefaultOption, gen_sql_schema_DatetimeValueFunctionDefaultOption_DefaultOption, gen_sql_schema_ImplicitlyTypedValueSpecificationDefaultOption_DefaultOption, gen_sql_schema_UniqueTableConstraint_schema_UniqueConstraint, gen_sql_schema_UniqueTableConstraint_schema_TableColumnsConstraint, gen_sql_schema_ReferentialTableConstraint_schema_ReferentialConstraint, gen_sql_schema_ReferentialTableConstraint_schema_TableColumnsConstraint, gen_sql_schema_TableColumnsConstraint_TableConstraint},
    metadata=None
)
