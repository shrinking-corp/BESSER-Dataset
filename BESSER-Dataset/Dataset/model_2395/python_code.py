...
class schema_ReferentialConstraint:
    ...
    pass
class sql_schema_ReferentialTableConstraint(schema_TableColumnsConstraint, schema_ReferentialConstraint):

    pass
class schema_ColumnConstraint:

    pass
class sql_schema_ReferentialColumnConstraint(schema_ColumnConstraint, schema_ReferentialConstraint):
...
class sql_schema_Column(TableElement):
    ...
    def __init__(self, name: str, sql_schema_Column: "DataType" = None, owner19: "DefaultOption" = None, owner21: "ColumnConstraint" = None, sql_schema_Column23: "SchemaQualifiedName" = None, TableElement: "sql_schema_TableElementList" = None):
        self.name = name
...
class sql_datatype_NationalCharacterStringType(PredefinedType):
    ...
    def __init__(self, length: str, kind: str, sql_datatype_NationalCharacterStringType: "SchemaQualifiedName" = None):
        self.length = length
        self.kind = kind
