...
class EMOF_Class(Type):
    ...
    def __init__(self, isAbstract: str, EMOF_Class: set["Property"] = None, EMOF_Class2: set["Operation"] = None, EMOF_Class4: set["Class"] = None, Type35: "EMOF_TypedElement" = None, Type23: "EMOF_Package" = None, Type: "EMOF_Operation" = None):
