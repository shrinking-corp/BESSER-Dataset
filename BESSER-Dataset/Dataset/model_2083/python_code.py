...
class UATMM_structure_Node:
    ...
    def __init__(self, id: str, label: str, nature: str, role: str, Node21: "UATMM_structure_Connector" = None, gate: "UATMM_structure_Connector" = None, Node: "UATMM_structure_Node" = None, parents: set["UATMM_structure_Node"] = None, Node13: "UATMM_structure_Node" = None, children: set["UATMM_structure_Node"] = None, UATMM_structure_Node16: "UATMM_structure_Edge" = None, UATMM_structure_Node19: "UATMM_structure_Edge" = None, UATMM_structure_Node3: "UATMM_structure_AttackTree" = None, UATMM_structure_Node: "UATMM_structure_AttackTree" = None):
        self.id = id
        self.label = label
        self.nature = nature
        self.role = role
...
class UATMM_structure_Edge:
    ...
    def __init__(self, edgeKind: str, UATMM_structure_Edge15: "UATMM_structure_Node" = None, UATMM_structure_Edge18: "UATMM_structure_Node" = None, UATMM_structure_Edge: "UATMM_structure_AttackTree" = None):
