...
# Classes
UATMM_structure_Edge = Class(name="UATMM_structure_Edge")
UATMM_structure_TreeMetaData = Class(name="UATMM_structure_TreeMetaData")
UATMM_structure_AttackTree = Class(name="UATMM_structure_AttackTree")
UATMM_structure_Node = Class(name="UATMM_structure_Node")
UATMM_structure_AND = Class(name="UATMM_structure_AND")
Connector = Class(name="Connector")
UATMM_structure_OR = Class(name="UATMM_structure_OR")
UATMM_structure_XOR = Class(name="UATMM_structure_XOR")
UATMM_structure_PAND = Class(name="UATMM_structure_PAND")
UATMM_structure_TAND = Class(name="UATMM_structure_TAND")
UATMM_structure_KofN = Class(name="UATMM_structure_KofN")
UATMM_structure_Weighted = Class(name="UATMM_structure_Weighted")
UATMM_structure_SAND = Class(name="UATMM_structure_SAND")
UATMM_structure_Connector = Class(name="UATMM_structure_Connector")
UATMM_structure_SOR = Class(name="UATMM_structure_SOR")
UATMM_structure_FDEP = Class(name="UATMM_structure_FDEP")
UATMM_structure_Spare = Class(name="UATMM_structure_Spare")
UATMM_structure_RDEP = Class(name="UATMM_structure_RDEP")
...
UATMM_structure_Node.attributes={UATMM_structure_Node_nature, UATMM_structure_Node_id, UATMM_structure_Node_role, UATMM_structure_Node_label}
...
domain_model = DomainModel(
    ...
    types={UATMM_structure_Edge, UATMM_structure_TreeMetaData, UATMM_structure_AttackTree, UATMM_structure_Node, UATMM_structure_AND, Connector, UATMM_structure_OR, UATMM_structure_XOR, UATMM_structure_PAND, UATMM_structure_TAND, UATMM_structure_KofN, UATMM_structure_Weighted, UATMM_structure_SAND, UATMM_structure_Connector, UATMM_structure_SOR, UATMM_structure_FDEP, UATMM_structure_Spare, UATMM_structure_RDEP, RoleType, Nature, EdgeKind},
    associations={Nodes1, Edges4, metadata6, Root0, gate20, connector8, children10, parents12, Target14, Source17},
    generalizations={gen_UATMM_structure_AND_Connector, gen_UATMM_structure_OR_Connector, gen_UATMM_structure_XOR_Connector, gen_UATMM_structure_PAND_Connector, gen_UATMM_structure_TAND_Connector, gen_UATMM_structure_KofN_Connector, gen_UATMM_structure_Weighted_Connector, gen_UATMM_structure_SAND_Connector, gen_UATMM_structure_SOR_Connector, gen_UATMM_structure_FDEP_Connector, gen_UATMM_structure_Spare_Connector, gen_UATMM_structure_RDEP_Connector},
    metadata=None
)
