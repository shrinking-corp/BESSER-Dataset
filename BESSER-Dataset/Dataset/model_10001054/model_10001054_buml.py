...
account_MyClass = Class(name="account_MyClass")
...
Customer.attributes={Customer_emailAddress, Customer_name, Customer_address, Customer_dateOfBirth, Customer_phoneNumber}
...
Login.attributes={Login_securityQuestion, Login_password, Login_lastLoginTime, Login_securityAnswer, Login_username}
...
transaction_Transaction.attributes={transaction_Transaction_transactionTime, transaction_Transaction_type, transaction_Transaction_amount, transaction_Transaction_id}
...
# account_MyClass class attributes and methods
...
domain_model = DomainModel(
    name="_8084d100_2bf1_4895_95fb_12b66966a8ef",
    types={Customer, Login, transaction_Transaction, transaction_DepositTransaction, transaction_WithdrawTransaction, transaction_TransferTransaction, account_SavingsAccount, account_CertificatesOfDepositAccount, account_CheckingAccount, account_Account, account_MyClass, transaction_TransactionType, account_AccountType},
