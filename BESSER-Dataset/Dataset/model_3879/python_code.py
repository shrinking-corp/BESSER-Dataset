...
class dinkiemodel_FilledArrayDecl(Statement):
    ...
    def __init__(self, global_: bool, varName: str, dinkiemodel_FilledArrayDecl: "dinkiemodel_ArrayType" = None, dinkiemodel_FilledArrayDecl28: set["dinkiemodel_Expression"] = None):
...
class dinkiemodel_EmptyArrayDecl(Statement):
    ...
    def __init__(self, global_: bool, varName: str, size: int, dinkiemodel_EmptyArrayDecl: "dinkiemodel_ArrayType" = None):
        self.global_ = global_
        self.varName = varName
        self.size = size
...
class dinkiemodel_StringArrayDecl(Statement):
    ...
    def __init__(self, global_: bool, varName: str, content: str):
        self.global_ = global_
        self.varName = varName
...
class dinkiemodel_Declaration(Statement):
    ...
    def __init__(self, global_: bool, varName: str, dinkiemodel_Declaration: "dinkiemodel_BaseType" = None, dinkiemodel_Declaration14: "dinkiemodel_Expression" = None):
        self.global_ = global_
        self.varName = varName
...
class dinkiemodel_Argument:
    ...
    def __init__(self, name: str, dinkiemodel_Argument73: "dinkiemodel_Type" = None, dinkiemodel_Argument: "dinkiemodel_FunctionDecl" = None):
        self.name = name
