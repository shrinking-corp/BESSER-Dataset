...
# Classes
dinkiemodel_FunctionDecl = Class(name="dinkiemodel_FunctionDecl")
dinkiemodel_Main = Class(name="dinkiemodel_Main")
dinkiemodel_Statement = Class(name="dinkiemodel_Statement", is_abstract=True)
dinkiemodel_Program = Class(name="dinkiemodel_Program")
dinkiemodel_ReadStatement = Class(name="dinkiemodel_ReadStatement")
dinkiemodel_Argument = Class(name="dinkiemodel_Argument")
dinkiemodel_Type = Class(name="dinkiemodel_Type", is_abstract=True)
dinkiemodel_Declaration = Class(name="dinkiemodel_Declaration")
Statement = Class(name="Statement")
dinkiemodel_BaseType = Class(name="dinkiemodel_BaseType")
dinkiemodel_Expression = Class(name="dinkiemodel_Expression", is_abstract=True)
Type = Class(name="Type")
dinkiemodel_ArrayType = Class(name="dinkiemodel_ArrayType")
dinkiemodel_EmptyArrayDecl = Class(name="dinkiemodel_EmptyArrayDecl")
dinkiemodel_While = Class(name="dinkiemodel_While")
dinkiemodel_IfOne = Class(name="dinkiemodel_IfOne")
dinkiemodel_WriteStatement = Class(name="dinkiemodel_WriteStatement")
dinkiemodel_Assign = Class(name="dinkiemodel_Assign")
dinkiemodel_FilledArrayDecl = Class(name="dinkiemodel_FilledArrayDecl")
dinkiemodel_StringArrayDecl = Class(name="dinkiemodel_StringArrayDecl")
dinkiemodel_ArrayAssign = Class(name="dinkiemodel_ArrayAssign")
dinkiemodel_IfTwo = Class(name="dinkiemodel_IfTwo")
dinkiemodel_Parallel = Class(name="dinkiemodel_Parallel")
dinkiemodel_Sync = Class(name="dinkiemodel_Sync")
dinkiemodel_Return = Class(name="dinkiemodel_Return")
dinkiemodel_FuncExpr = Class(name="dinkiemodel_FuncExpr")
dinkiemodel_ThreadID = Class(name="dinkiemodel_ThreadID")
dinkiemodel_Number = Class(name="dinkiemodel_Number")
Expression = Class(name="Expression")
dinkiemodel_BoolVal = Class(name="dinkiemodel_BoolVal")
dinkiemodel_Character = Class(name="dinkiemodel_Character")
dinkiemodel_OneOperator = Class(name="dinkiemodel_OneOperator")
dinkiemodel_TwoOperator = Class(name="dinkiemodel_TwoOperator")
dinkiemodel_BracketExpr = Class(name="dinkiemodel_BracketExpr")
dinkiemodel_ArrayExpr = Class(name="dinkiemodel_ArrayExpr")
dinkiemodel_VariableExpr = Class(name="dinkiemodel_VariableExpr")
...
dinkiemodel_Declaration_global_: Property = Property(name="global_", type=BooleanType)
dinkiemodel_Declaration_varName: Property = Property(name="varName", type=StringType)
dinkiemodel_Declaration.attributes={dinkiemodel_Declaration_global_, dinkiemodel_Declaration_varName}
...
dinkiemodel_EmptyArrayDecl_global_: Property = Property(name="global_", type=BooleanType)
...
dinkiemodel_EmptyArrayDecl.attributes={dinkiemodel_EmptyArrayDecl_size, dinkiemodel_EmptyArrayDecl_varName, dinkiemodel_EmptyArrayDecl_global_}
...
dinkiemodel_FilledArrayDecl_global_: Property = Property(name="global_", type=BooleanType)
dinkiemodel_FilledArrayDecl_varName: Property = Property(name="varName", type=StringType)
dinkiemodel_FilledArrayDecl.attributes={dinkiemodel_FilledArrayDecl_global_, dinkiemodel_FilledArrayDecl_varName}

# dinkiemodel_StringArrayDecl class attributes and methods
dinkiemodel_StringArrayDecl_global_: Property = Property(name="global_", type=BooleanType)
...
dinkiemodel_StringArrayDecl.attributes={dinkiemodel_StringArrayDecl_content, dinkiemodel_StringArrayDecl_global_, dinkiemodel_StringArrayDecl_varName}
...
domain_model = DomainModel(
    name="dinkiemodel",
    types={dinkiemodel_FunctionDecl, dinkiemodel_Main, dinkiemodel_Statement, dinkiemodel_Program, dinkiemodel_ReadStatement, dinkiemodel_Argument, dinkiemodel_Type, dinkiemodel_Declaration, Statement, dinkiemodel_BaseType, dinkiemodel_Expression, Type, dinkiemodel_ArrayType, dinkiemodel_EmptyArrayDecl, dinkiemodel_While, dinkiemodel_IfOne, dinkiemodel_WriteStatement, dinkiemodel_Assign, dinkiemodel_FilledArrayDecl, dinkiemodel_StringArrayDecl, dinkiemodel_ArrayAssign, dinkiemodel_IfTwo, dinkiemodel_Parallel, dinkiemodel_Sync, dinkiemodel_Return, dinkiemodel_FuncExpr, dinkiemodel_ThreadID, dinkiemodel_Number, Expression, dinkiemodel_BoolVal, dinkiemodel_Character, dinkiemodel_OneOperator, dinkiemodel_TwoOperator, dinkiemodel_BracketExpr, dinkiemodel_ArrayExpr, dinkiemodel_VariableExpr, EBaseType, EOneOperator, ETwoOperator},
    associations={functions0, mainFunc1, statements3, arraytype15, type16, statements5, arguments8, type10, type12, expression13, expression35, statements37, type18, expression20, expression23, arraytype25, expression27, index30, expression32, expression40, statements42, thenStats45, expression47, elseStats50, statements53, statements55, expression57, arguments70, type72, expression59, leftExpr61, rightExpr63, expression66, index68},
    generalizations={gen_dinkiemodel_ReadStatement_Statement, gen_dinkiemodel_Declaration_Statement, gen_dinkiemodel_BaseType_Type, gen_dinkiemodel_ArrayType_Type, gen_dinkiemodel_EmptyArrayDecl_Statement, gen_dinkiemodel_While_Statement, gen_dinkiemodel_IfOne_Statement, gen_dinkiemodel_WriteStatement_Statement, gen_dinkiemodel_Assign_Statement, gen_dinkiemodel_FilledArrayDecl_Statement, gen_dinkiemodel_StringArrayDecl_Statement, gen_dinkiemodel_ArrayAssign_Statement, gen_dinkiemodel_IfTwo_Statement, gen_dinkiemodel_Parallel_Statement, gen_dinkiemodel_Sync_Statement, gen_dinkiemodel_Return_Statement, gen_dinkiemodel_FuncExpr_Expression, gen_dinkiemodel_FuncExpr_Statement, gen_dinkiemodel_ThreadID_Expression, gen_dinkiemodel_Number_Expression, gen_dinkiemodel_BoolVal_Expression, gen_dinkiemodel_Character_Expression, gen_dinkiemodel_OneOperator_Expression, gen_dinkiemodel_TwoOperator_Expression, gen_dinkiemodel_BracketExpr_Expression, gen_dinkiemodel_ArrayExpr_Expression, gen_dinkiemodel_VariableExpr_Expression},
    metadata=None
)
