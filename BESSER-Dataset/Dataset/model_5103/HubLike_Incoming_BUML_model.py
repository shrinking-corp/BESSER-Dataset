...
# Classes
testPackage_Class2 = Class(name="testPackage_Class2")
testPackage_Class3 = Class(name="testPackage_Class3")
testPackage_Class4 = Class(name="testPackage_Class4")
testPackage_Class5 = Class(name="testPackage_Class5")
testPackage_HubClass = Class(name="testPackage_HubClass")
testPackage_Class1 = Class(name="testPackage_Class1")
...
domain_model = DomainModel(
    name="testPackage",
    types={testPackage_Class2, testPackage_Class3, testPackage_Class4, testPackage_Class5, testPackage_HubClass, testPackage_Class1},
    associations={testReference1, testReference3, testReference5, testReference7, testReference0},
    generalizations={},
    metadata=None
)
