...
# Classes
dSL_Behaviors = Class(name="dSL_Behaviors")
dSL_Expression = Class(name="dSL_Expression")
dSL_RobotBehavior = Class(name="dSL_RobotBehavior")
...
domain_model = DomainModel(
    name="dSL",
    types={dSL_Behaviors, dSL_Expression, dSL_RobotBehavior, dSL_ExpressionBracket, Expression, dSL_Actions, dSL_LeftMovementAction, Actions, dSL_MovementAction, dSL_RightMovementAction, dSL_RotateMovementAction, dSL_RotatePoints, RotateMovementAction, dSL_LeftRotatePoint, RotatePoints, dSL_RightRotatePoint, dSL_MiddleRotatePoint, dSL_TouchLiteral, dSL_ColorLiteral, dSL_DistanceLiteral, dSL_EdgeLiteral, dSL_ANDexpression, dSL_ORexpression, ActionEnum, LREnum, FBEnum, EdgeEnum, TouchEnum, ColorEnum},
    associations={behaviorlist0, sensorExpression1, exp8, actionlist3, leftmove5, rightmove6, right17, left10, right12, left15},
    generalizations={gen_dSL_ExpressionBracket_Expression, gen_dSL_LeftMovementAction_Actions, gen_dSL_RightMovementAction_Actions, gen_dSL_RotateMovementAction_Actions, gen_dSL_RotatePoints_RotateMovementAction, gen_dSL_LeftRotatePoint_RotatePoints, gen_dSL_RightRotatePoint_RotatePoints, gen_dSL_MiddleRotatePoint_RotatePoints, gen_dSL_TouchLiteral_Expression, gen_dSL_ColorLiteral_Expression, gen_dSL_DistanceLiteral_Expression, gen_dSL_EdgeLiteral_Expression, gen_dSL_ANDexpression_Expression, gen_dSL_ORexpression_Expression},
    metadata=None
)
