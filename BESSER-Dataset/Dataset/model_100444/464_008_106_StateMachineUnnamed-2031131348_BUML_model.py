...
StateMachineUnnamed_StateVertex = Class(name="StateMachineUnnamed_StateVertex")
...
domain_model = DomainModel(
    ...
    associations={transitions1, outgoing3, incoming4, states0, target10, trigger12, targets7, source9},
