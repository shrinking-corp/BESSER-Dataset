...
class book_Control(Node):
    ...
    def __init__(self, image: str, sound: str, book_Control: "book_Layer" = None, book_Control11: set["book_Action"] = None, book_Control13: set["book_Action"] = None):
        self.image = image
        self.sound = sound
...
class book_Page:
    ...
    def __init__(self, name: str, book_Page: "book_Book" = None, book_Page5: "book_Book" = None, book_Page7: set["book_Layer"] = None, book_Page21: "book_OpenPage" = None):
        self.name = name
