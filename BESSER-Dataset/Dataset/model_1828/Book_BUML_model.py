...
# Classes
book_Node = Class(name="book_Node", is_abstract=True)
book_Book = Class(name="book_Book")
book_Page = Class(name="book_Page")
book_Splash = Class(name="book_Splash")
book_Layer = Class(name="book_Layer")
Page = Class(name="Page")
book_Control = Class(name="book_Control")
book_JSAction = Class(name="book_JSAction")
book_Shape = Class(name="book_Shape")
Node = Class(name="Node")
book_Action = Class(name="book_Action", is_abstract=True)
book_Group = Class(name="book_Group")
Control = Class(name="Control")
book_ImageFlash = Class(name="book_ImageFlash")
book_Animation = Class(name="book_Animation", is_abstract=True)
book_Media = Class(name="book_Media")
book_Label = Class(name="book_Label")
book_OpenPage = Class(name="book_OpenPage")
Action = Class(name="Action")
book_Fade = Class(name="book_Fade")
Animation = Class(name="Animation")
book_Move = Class(name="book_Move")
book_Rotation = Class(name="book_Rotation")
...
book_Node.attributes={book_Node_background, book_Node_opacity, book_Node_enable, book_Node_bounds, book_Node_foreground}
...
book_Book.attributes={book_Book_resolution, book_Book_version, book_Book_bookId, book_Book_author, book_Book_title, book_Book_description}
...
book_Animation.attributes={book_Animation_autoReverse, book_Animation_duration, book_Animation_repeat, book_Animation_delay}
...
book_Media.attributes={book_Media_repeat, book_Media_duration, book_Media_autoPlay, book_Media_url}
...
book_Label.attributes={book_Label_font, book_Label_text}
...
domain_model = DomainModel(
    name="book",
    types={book_Node, book_Book, book_Page, book_Splash, book_Layer, Page, book_Control, book_JSAction, book_Shape, Node, book_Action, book_Group, Control, book_ImageFlash, book_Animation, book_Media, book_Label, book_OpenPage, Action, book_Fade, Animation, book_Move, book_Rotation},
    associations={pages0, splash1, main3, layers6, control8, page20, onExposed10, onTouched12, children15, out16, in_17},
    generalizations={gen_book_Splash_Page, gen_book_JSAction_Action, gen_book_Shape_Node, gen_book_Control_Node, gen_book_Group_Control, gen_book_ImageFlash_Control, gen_book_Media_Control, gen_book_Label_Control, gen_book_OpenPage_Action, gen_book_Animation_Action, gen_book_Fade_Animation, gen_book_Move_Animation, gen_book_Rotation_Animation},
    metadata=None
)
