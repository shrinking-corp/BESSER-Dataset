...
class hbmapkeys_StringToWriterMapEntry:
    ...
    def __init__(self, key: str, hbmapkeys_StringToWriterMapEntry5: "hbmapkeys_Writer" = None, hbmapkeys_StringToWriterMapEntry: "hbmapkeys_Book" = None):
        self.key = key
...
class hbmapkeys_Writer:
    ...
    def __init__(self, name: str, hbmapkeys_Writer: "hbmapkeys_City" = None, hbmapkeys_Writer6: "hbmapkeys_StringToWriterMapEntry" = None, hbmapkeys_Writer9: "hbmapkeys_WriterToCityMapEntry" = None):
        self.name = name
