...
# Classes
jgrapht_Graph = Class(name="jgrapht_Graph")
jgrapht_Edge = Class(name="jgrapht_Edge")
jgrapht_Vertex = Class(name="jgrapht_Vertex")
...
domain_model = DomainModel(
    name="jgrapht",
    types={jgrapht_Graph, jgrapht_Edge, jgrapht_Vertex},
    associations={edges0, vertices1, from_3, to6},
    generalizations={},
    metadata=None
)
