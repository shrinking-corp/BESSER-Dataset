...
class Staff:
    ...
    def __init__(self, staffId: str, name: str, type: str, Staff_StaffUI_00: set["StaffUI"] = None, reservationManagementSystem2: "Reservation_System" = None):
...
class Report:
    ...
    def __init__(self, report_id: str, orders: str, reservationManagementSystem9: "Reservation_System" = None):
...
class Booking:
    ...
    def __init__(self, booking_id: int, date: date, startTime: str, endTime: str, reservedTables: str, customer_name: str, contact_no: int, email_id: str, ReservationManagementSystem_Booking_17: "Reservation_System" = None, reservedBy13: set["Table"] = None):
...
class Reservation_System:
    ...
    def interacts3(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Reservation_System__interacts3", None)
    ...
    def generates8(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Reservation_System__generates8", None)
    ...
    def interacts5(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Reservation_System__interacts5", None)
    ...
    def booking6(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Reservation_System__booking6", None)
