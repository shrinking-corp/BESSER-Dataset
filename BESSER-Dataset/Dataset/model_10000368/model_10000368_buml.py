...
Reservation_System_bookings: Property = Property(name="bookings", type=StringType)
Reservation_System.attributes={Reservation_System_bookings}
...
Booking.attributes={Booking_startTime, Booking_email_id, Booking_customer_name, Booking_booking_id, Booking_contact_no, Booking_date, Booking_endTime, Booking_reservedTables}
...
Table.attributes={Table_avaliable, Table_numSeats, Table_table_id}
...
Food.attributes={Food_price, Food_prepared, Food_name, Food_food_id, Food_served}
...
Staff_ReservationManagementSystem: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="reservationManagementSystem2", type=Reservation_System, multiplicity=Multiplicity(1, 1)),
...
CustomerUI_ReservationManagementSystem: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="CustomerUI_ReservationManagementSystem_04", type=Reservation_System, multiplicity=Multiplicity(1, 1)),
...
ReservationManagementSystem_Booking: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="ReservationManagementSystem_Booking_17", type=Reservation_System, multiplicity=Multiplicity(1, 1))
    }
)
ReservationManagementSystem_Report: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="reservationManagementSystem9", type=Reservation_System, multiplicity=Multiplicity(1, 1))
    }
)
...
domain_model = DomainModel(
    name="_2dd271e1_4923_4a0b_b70c_2d3523493a84",
    types={Reservation_System, Booking, Table, Report, Order, Food, Staff, Waiter, Chef, StaffUI, CustomerUI},
