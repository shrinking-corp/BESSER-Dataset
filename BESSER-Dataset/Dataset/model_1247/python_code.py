...
class DocumentedElement:
    ...
    pass
class mtl_Macro(DocumentedElement, ModuleElement, Block):

    pass
class mtl_Template(DocumentedElement, ModuleElement, Block):

    def __init__(self, main: bool, mtl_Template: "mtl_Template" = None, mtl_Template14: set["mtl_Template"] = None, mtl_Template26: "mtl_TemplateInvocation" = None, mtl_Template17: set["Variable"] = None, mtl_Template20: "OCLExpression" = None, mtl_Template23: "OCLExpression" = None):
        self.main = main
...
class mtl_Query(DocumentedElement, ModuleElement):
