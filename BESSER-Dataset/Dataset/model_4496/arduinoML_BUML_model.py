...
domain_model = DomainModel(
    name="arduinoML",
    types={arduinoML_Brick, NamedElement, arduinoML_Actuator, Brick, arduinoML_Sensor, arduinoML_App, arduinoML_State, arduinoML_Action, arduinoML_Transition, arduinoML_NamedElement, Signal},
