...
Company_Organisation.attributes={Company_Organisation_completeAddress, Company_Organisation_name, Company_Organisation_city}
...
domain_model = DomainModel(
    name="Company",
    types={Company_Organisation, Company_Division, Company_Topic, Company_Category, Company_Person, Company_Project, Company_Unit, Company_CompanyModel, Company_Employee, Person, Company_Client, Division, Company_ServiceLine},
    associations={persons3, projects5, lines8, related10, topics12, assignedTo0, employed1, category13, company14, categories16, topics18, division21},
