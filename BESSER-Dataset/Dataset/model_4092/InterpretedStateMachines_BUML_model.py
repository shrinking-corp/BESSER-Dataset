...
domain_model = DomainModel(
    name="statemachines",
    types={statemachines_CustomSystem, StateMachine, statemachines_CustomEvent, Event, statemachines_EventOccurrence, statemachines_Util, statemachines_almostuml_StateMachine, NamedElement, Region, almostuml_statemachines_EventOccurrence, statemachines_almostuml_Region, Vertex, State, statemachines_almostuml_State, almostuml_NamedElement, almostuml_Vertex, Behavior, statemachines_almostuml_Vertex, statemachines_almostuml_Transition, Trigger, Constraint, statemachines_almostuml_Trigger, statemachines_almostuml_Constraint, statemachines_almostuml_Behavior, statemachines_almostuml_NamedElement, Transition, statemachines_almostuml_Event, statemachines_almostuml_FinalState, statemachines_almostuml_Pseudostate, PseudostateKind},
    associations={statemachine0, events1, event3, region5, queue6, subvertex7, transition8, stateMachine9, currentState11, entry13, exit14, doActivity17, region20, container23, source25, target27, trigger30, guard32, effect34, event37},
