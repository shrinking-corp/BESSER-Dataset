...
User1.attributes={User1_attribute, User1_username, User1_name, User1_email, User1_isStaff, User1_campus}
...
Post1.attributes={Post1_date, Post1_title, Post1_files, Post1_author, Post1_body}
...
Event1.attributes={Event1_date, Event1_eventOwner, Event1_isOpen, Event1_invites, Event1_size, Event1_location, Event1_name, Event1_joined, Event1_rating}
...
Location1.attributes={Location1_name, Location1_capacity, Location1_address}
...
Comment1.attributes={Comment1_body, Comment1_date, Comment1_author}
...
Student1.attributes={Student1_school, Student1_course, Student1_yearOfStudy}
...
domain_model = DomainModel(
    name="_8d62c23d_e546_4f50_b7fc_cd5833dccbcf",
    ...
    associations={MyClass_MyClass2, User_Post, User_Event, Location_Event, Comment_Post, Comment_User, User_VirtualTour, MyClass_MyClass22, User_VirtualTour2, User_Post2, Comment_User2, User_Event2, Post_Comment, Event_Post, Location_Event2},
    generalizations={},
    metadata=None
)
