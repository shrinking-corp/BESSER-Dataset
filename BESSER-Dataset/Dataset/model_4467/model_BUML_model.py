...
# Classes
RobotProjectModel_Instruction = Class(name="RobotProjectModel_Instruction", is_abstract=True)
RobotProjectModel_MoveStraight = Class(name="RobotProjectModel_MoveStraight")
TimedInstruction = Class(name="TimedInstruction")
RobotProjectModel_Distance = Class(name="RobotProjectModel_Distance")
RobotProjectModel_Robot = Class(name="RobotProjectModel_Robot")
RobotProjectModel_TimedInstruction = Class(name="RobotProjectModel_TimedInstruction", is_abstract=True)
Instruction = Class(name="Instruction")
RobotProjectModel_Function = Class(name="RobotProjectModel_Function")
RobotProjectModel_InstructionBlock = Class(name="RobotProjectModel_InstructionBlock")
RobotProjectModel_Call = Class(name="RobotProjectModel_Call")
RobotProjectModel_Duration = Class(name="RobotProjectModel_Duration")
RobotProjectModel_Turn = Class(name="RobotProjectModel_Turn")
RobotProjectModel_Angle = Class(name="RobotProjectModel_Angle")
RobotProjectModel_Amount = Class(name="RobotProjectModel_Amount")
Amount = Class(name="Amount")
RobotProjectModel_DetectedObjectIs = Class(name="RobotProjectModel_DetectedObjectIs")
RobotProjectModel_HomeDirection = Class(name="RobotProjectModel_HomeDirection")
Angle = Class(name="Angle")
RobotProjectModel_Print = Class(name="RobotProjectModel_Print")
RobotProjectModel_Condition = Class(name="RobotProjectModel_Condition", is_abstract=True)
RobotProjectModel_SensorActivation = Class(name="RobotProjectModel_SensorActivation")
Condition = Class(name="Condition")
RobotProjectModel_Grab = Class(name="RobotProjectModel_Grab")
RobotProjectModel_Release = Class(name="RobotProjectModel_Release")
RobotProjectModel_Wait = Class(name="RobotProjectModel_Wait")
RobotProjectModel_If = Class(name="RobotProjectModel_If")
...
domain_model = DomainModel(
    ...
    types={RobotProjectModel_Instruction, RobotProjectModel_MoveStraight, TimedInstruction, RobotProjectModel_Distance, RobotProjectModel_Robot, RobotProjectModel_TimedInstruction, Instruction, RobotProjectModel_Function, RobotProjectModel_InstructionBlock, RobotProjectModel_Call, RobotProjectModel_Duration, RobotProjectModel_Turn, RobotProjectModel_Angle, RobotProjectModel_Amount, Amount, RobotProjectModel_DetectedObjectIs, RobotProjectModel_HomeDirection, Angle, RobotProjectModel_Print, RobotProjectModel_Condition, RobotProjectModel_SensorActivation, Condition, RobotProjectModel_Grab, RobotProjectModel_Release, RobotProjectModel_Wait, RobotProjectModel_If, DistanceUnit, AngleUnit, TimeUnit, DetectedType},
    associations={distance0, instructions1, instructionBlock4, destination5, duration2, angle3, condition7, falseBlock8, trueBlock11, instructions14},
    generalizations={gen_RobotProjectModel_MoveStraight_TimedInstruction, gen_RobotProjectModel_TimedInstruction_Instruction, gen_RobotProjectModel_Function_Instruction, gen_RobotProjectModel_Call_Instruction, gen_RobotProjectModel_Turn_TimedInstruction, gen_RobotProjectModel_Duration_Amount, gen_RobotProjectModel_InstructionBlock_Instruction, gen_RobotProjectModel_DetectedObjectIs_Condition, gen_RobotProjectModel_HomeDirection_Angle, gen_RobotProjectModel_Print_Instruction, gen_RobotProjectModel_Distance_Amount, gen_RobotProjectModel_Angle_Amount, gen_RobotProjectModel_SensorActivation_Condition, gen_RobotProjectModel_Grab_Instruction, gen_RobotProjectModel_Release_Instruction, gen_RobotProjectModel_Wait_TimedInstruction, gen_RobotProjectModel_If_Instruction},
    metadata=None
)
