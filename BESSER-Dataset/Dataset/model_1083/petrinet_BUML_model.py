...
domain_model = DomainModel(
    name="petrinet",
    types={petrinet_Arc, petrinet_Node, petrinet_Petrinet, petrinet_Place, Node, petrinet_Token, petrinet_Transition},
    associations={source0, target1, petrinet3, petrinet4, in_6, out7, nodes9, arcs11, tokens14, place15},
