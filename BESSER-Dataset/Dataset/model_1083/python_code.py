...
class petrinet_Petrinet:
    ...
    def __init__(self, name: str, Petrinet: "petrinet_Arc" = None, Petrinet5: "petrinet_Node" = None, petrinet: set["petrinet_Node"] = None, petrinet12: set["petrinet_Arc"] = None):
        self.name = name
...
class petrinet_Node(ABC):
    ...
    def __init__(self, name: str, Node: "petrinet_Arc" = None, Node2: "petrinet_Arc" = None, nodes: "petrinet_Petrinet" = None, target: set["petrinet_Arc"] = None, source: set["petrinet_Arc"] = None, Node10: "petrinet_Petrinet" = None):
        self.name = name
        self.Node = Node
        self.Node2 = Node2
        self.nodes = nodes
