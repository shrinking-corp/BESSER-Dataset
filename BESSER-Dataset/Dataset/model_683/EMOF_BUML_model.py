...
EMOF_Element.methods={EMOF_Element_m_isSet, EMOF_Element_m_container, EMOF_Element_m_get, EMOF_Element_m_equals, EMOF_Element_m_unset, EMOF_Element_m_set, EMOF_Element_m_getMetaClass}
...
EMOF_Property.attributes={EMOF_Property_isDerived, EMOF_Property_isReadOnly, EMOF_Property_default, EMOF_Property_isComposite, EMOF_Property_isID}
...
EMOF_ReflectiveCollection.methods={EMOF_ReflectiveCollection_m_remove, EMOF_ReflectiveCollection_m_addAll, EMOF_ReflectiveCollection_m_add, EMOF_ReflectiveCollection_m_size, EMOF_ReflectiveCollection_m_clear}
...
domain_model = DomainModel(
    name="EMOF",
    types={Operation, Class_, EMOF_Comment, Element, NamedElement, EMOF_Class, Type, Property_, EMOF_DataType, EMOF_Element, Object, EMOF_Property, EMOF_Factory, Comment, EMOF_Enumeration, DataType, EnumerationLiteral, Package, EMOF_EnumerationLiteral, EMOF_MultiplicityElement, Enumeration_, EMOF_Extent, EMOF_NamedElement, EMOF_Object, EMOF_Operation, TypedElement, MultiplicityElement, Parameter_, EMOF_Package, EMOF_Parameter, EMOF_PrimitiveType, EMOF_ReflectiveCollection, EMOF_ReflectiveSequence, ReflectiveCollection, EMOF_Tag, EMOF_Type, EMOF_TypedElement, EMOF_URIExtent, Extent},
    associations={ownedOperation1, superClass3, annotatedElement5, ownedAttribute0, ownedComment6, ownedLiteral7, package9, enumeration8, class_10, ownedParameter12, raisedException14, nestedPackage16, nestingPackage18, ownedType21, operation24, class_26, opposite28, element31, package32, type34},
    generalizations={gen_EMOF_Comment_Element, gen_EMOF_Class_Type, gen_EMOF_DataType_Type, gen_EMOF_Element_Object, gen_EMOF_Property_TypedElement, gen_EMOF_Property_MultiplicityElement, gen_EMOF_Factory_Element, gen_EMOF_Enumeration_DataType, gen_EMOF_EnumerationLiteral_NamedElement, gen_EMOF_Extent_Object, gen_EMOF_NamedElement_Element, gen_EMOF_Operation_TypedElement, gen_EMOF_Operation_MultiplicityElement, gen_EMOF_Package_NamedElement, gen_EMOF_Parameter_TypedElement, gen_EMOF_Parameter_MultiplicityElement, gen_EMOF_PrimitiveType_DataType, gen_EMOF_ReflectiveCollection_Object, gen_EMOF_ReflectiveSequence_ReflectiveCollection, gen_EMOF_Tag_Element, gen_EMOF_Type_NamedElement, gen_EMOF_TypedElement_NamedElement, gen_EMOF_URIExtent_Extent},
    metadata=None
)
