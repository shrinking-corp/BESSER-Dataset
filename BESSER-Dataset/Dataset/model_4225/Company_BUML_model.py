...
company_Employee.attributes={company_Employee_name, company_Employee_salary, company_Employee_address}
...
domain_model = DomainModel(
    ...
    associations={manager1, subdepts4, employees6, mentor10, depts0},
    generalizations={},
    metadata=None
)
