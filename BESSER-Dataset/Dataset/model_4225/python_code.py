...
class company_Department:
    ...
    def __init__(self, name: str, company_Department2: "company_Employee" = None, company_Department5: "company_Department" = None, company_Department3: set["company_Department"] = None, company_Department7: set["company_Employee"] = None, company_Department: "company_Company" = None):
        self.name = name
