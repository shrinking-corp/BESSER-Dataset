...
class petrinets_Transition:
    ...
    def __init__(self, name: str, Transition21: "petrinets_PTArc" = None, Transition24: "petrinets_TPArc" = None, Transition: "petrinets_Net" = None, transitions: "petrinets_Net" = None, dst11: set["petrinets_PTArc"] = None, src14: set["petrinets_TPArc"] = None):
        self.name = name
...
class petrinets_Place:
    ...
    def __init__(self, name: str, Place: "petrinets_Net" = None, Place19: "petrinets_PTArc" = None, Place27: "petrinets_TPArc" = None, places: "petrinets_Net" = None, dst: set["petrinets_TPArc"] = None, src: set["petrinets_PTArc"] = None):
        self.name = name
        self.Place = Place
