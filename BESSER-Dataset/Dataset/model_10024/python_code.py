...
class RandL_TransactionReport:
    ...
    def __init__(self, balance: str, totalEarned: str, totalBurned: str, number: str, name: str, RandL_TransactionReport22: "RandL_Date" = None, report: set["RandL_TransactionReportLine"] = None, RandL_TransactionReport26: "RandL_CustomerCard" = None, RandL_TransactionReport79: "RandL_Container_RandL" = None, TransactionReport: "RandL_TransactionReportLine" = None, RandL_TransactionReport: "RandL_Date" = None):
...
class RandL_ProgramPartner:
    ...
    def __init__(self, name: str, numberOfCustomers: str, RandL_ProgramPartner: "RandL_Container_RandL" = None, ProgramPartner: "RandL_Service" = None, ProgramPartner109: "RandL_LoyaltyProgram" = None, partner: set["RandL_Service"] = None, partners: set["RandL_LoyaltyProgram"] = None):
        self.name = name
...
class RandL_CustomerCard:
    ...
    def __init__(self, valid: str, color: str, printedName: str, CustomerCard: "RandL_Transaction" = None, RandL_CustomerCard: "RandL_TransactionReport" = None, cards: "RandL_Customer" = None, card: "RandL_Membership" = None, card39: set["RandL_Transaction"] = None, RandL_CustomerCard28: "RandL_Date" = None, RandL_CustomerCard31: "RandL_Date" = None, RandL_CustomerCard34: "RandL_ServiceLevel" = None, CustomerCard45: "RandL_Membership" = None, RandL_CustomerCard59: "RandL_Container_RandL" = None, CustomerCard97: "RandL_Customer" = None):
        self.valid = valid
        self.color = color
...
class RandL_LoyaltyProgram:
    ...
    def __init__(self, name: str, LoyaltyProgram: "RandL_ServiceLevel" = None, RandL_LoyaltyProgram: "RandL_Membership" = None, RandL_LoyaltyProgram68: "RandL_Container_RandL" = None, LoyaltyProgram95: "RandL_Customer" = None, programs: set["RandL_ProgramPartner"] = None, LoyaltyProgram18: "RandL_ProgramPartner" = None, RandL_LoyaltyProgram116: set["RandL_Membership"] = None, program: set["RandL_ServiceLevel"] = None, programs113: set["RandL_Customer"] = None):
        self.name = name
    ...
    def addTransaction(self, RandL_servId, RandL_amnt, RandL_accNr, RandL_d, RandL_pName):
...
class RandL_LoyaltyAccount:
    ...
    def __init__(self, points: str, totalPointsEarned: str, number: str, LoyaltyAccount: "RandL_Transaction" = None, LoyaltyAccount48: "RandL_Membership" = None, RandL_LoyaltyAccount73: "RandL_Container_RandL" = None, account14: set["RandL_Transaction"] = None, RandL_LoyaltyAccount: set["RandL_Service"] = None, account: "RandL_Membership" = None):
        self.points = points
...
class RandL_Date:
    ...
    def __init__(self, year: str, month: str, day: str, RandL_Date: "RandL_Transaction" = None, RandL_Date23: "RandL_TransactionReport" = None, RandL_Date29: "RandL_CustomerCard" = None, RandL_Date32: "RandL_CustomerCard" = None, RandL_Date56: "RandL_Container_RandL" = None, RandL_Date93: "RandL_Customer" = None, RandL_Date103: "RandL_TransactionReportLine" = None, RandL_Date20: "RandL_TransactionReport" = None):
        self.year = year
        self.month = month
        self.day = day
    ...
    def fromYMD(self, RandL_k, RandL_m, RandL_y) :
