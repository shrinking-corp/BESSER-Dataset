...
class HSM_Transition(MgaObject):
    ...
    def __init__(self, guard: str, trigger: str, action: str, isSync: str, transition: "OrState" = None, transition14: "AssociationStateState" = None):
        self.guard = guard
...
class HSM_StateBase(MgaObject):
    ...
    def __init__(self, defaultTransition: str, marked: str, dstTransition: set["AssociationStateState"] = None, srcTransition: set["AssociationStateState"] = None, stateBase: set["DataVar"] = None, stateBase5: "AssociationDataStateBase" = None):
