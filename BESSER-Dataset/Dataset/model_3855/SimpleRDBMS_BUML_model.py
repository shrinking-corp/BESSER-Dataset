...
SimpleRDBMS_PrimaryKey = Class(name="SimpleRDBMS_PrimaryKey")
...
SimpleRDBMS_Database.attributes={SimpleRDBMS_Database_collation, SimpleRDBMS_Database_author, SimpleRDBMS_Database_serverAddr}
