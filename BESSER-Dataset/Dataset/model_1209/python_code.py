...
class ocl_types_TupleType:
    ...
    def tuple_type_name(self, ocl_context, ocl_diagnostics) :
...
class ocl_expressions_VariableExp:
    ...
    def __init__(self):
        ...
        pass
    def var_type(self, ocl_diagnostics, ocl_context) :
...
class ocl_expressions_LetExp:
    ...
    def __init__(self):
        ...
        pass
    def let_type(self, ocl_diagnostics, ocl_context) :
...
class ocl_expressions_LoopExp(ABC):
    ...
    def loop_variable_init(self, ocl_diagnostics, ocl_context) :
...
class ocl_expressions_CollectionLiteralExp:
    ...
    def bag_kind(self, ocl_diagnostics, ocl_context) :
