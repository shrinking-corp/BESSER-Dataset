...
class caracteristica_Estado:
    ...
    def __init__(self, nome: str, safe: bool, caracteristica_Estado93: "caracteristica_Transicao" = None, caracteristica_Estado96: "caracteristica_Transicao" = None, caracteristica_Estado104: "caracteristica_CaracteristicaProduto" = None, caracteristica_Estado: "caracteristica_Simulacao" = None):
        self.nome = nome
        self.safe = safe
...
class caracteristica_AcaoLogico(Acao):
    ...
    def __init__(self, operadorAcaoLogico: str, caracteristica_AcaoLogico: "caracteristica_Acao" = None, caracteristica_AcaoLogico73: "caracteristica_Acao" = None):
...
class caracteristica_VariacaoDoisProduto(CaracteristicaProduto, ElementoDeProduto):
...
class caracteristica_CaracteristicaAgrupada(Caracteristica, ElementoCaracteristico):
    ...
    pass
class caracteristica_Variante(Caracteristica, ElementoCaracteristico, PontoDeVariacao):
...
class caracteristica_Atributo(Elemento):
    ...
    def __init__(self, tipoValor: str, caracteristica_Atributo77: "caracteristica_Designar" = None, caracteristica_Atributo84: "caracteristica_ExpressaoRelacional" = None, atributo: "caracteristica_Caracteristica" = None, Atributo: "caracteristica_Caracteristica" = None, caracteristica_Atributo: "caracteristica_LPS" = None):
        self.tipoValor = tipoValor
...
class caracteristica_Simulacao:
    ...
    def __init__(self, nome: str, caracteristica_Simulacao88: set["caracteristica_Transicao"] = None, caracteristica_Simulacao90: set["caracteristica_Estado"] = None, caracteristica_Simulacao: "caracteristica_LPS" = None):
        self.nome = nome
...
class caracteristica_ElementoDeProduto:
    ...
    def __init__(self, nome: str, caracteristica_ElementoDeProduto41: "caracteristica_Elemento" = None, caracteristica_ElementoDeProduto: "caracteristica_LPS" = None):
        self.nome = nome
...
class caracteristica_LPS:
    ...
    def __init__(self, valoresContextuais: str, erro: str, nome: str, caracteristica_LPS: set["caracteristica_PontoDeVariacao"] = None, caracteristica_LPS2: set["caracteristica_Elemento"] = None, caracteristica_LPS4: set["caracteristica_Regra"] = None, caracteristica_LPS6: set["caracteristica_Produto"] = None, caracteristica_LPS8: set["caracteristica_Expressao"] = None, caracteristica_LPS10: set["caracteristica_ElementoDeProduto"] = None, LpsDoSistema: "caracteristica_CaracteristicaRaiz" = None, caracteristica_LPS15: set["caracteristica_Simulacao"] = None, caracteristica_LPS17: set["caracteristica_InconsistenciaRegraAdaptacao"] = None, caracteristica_LPS13: set["caracteristica_Atributo"] = None, LPS: "caracteristica_CaracteristicaRaiz" = None):
