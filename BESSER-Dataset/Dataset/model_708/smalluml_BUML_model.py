...
smalluml_Operation = Class(name="smalluml_Operation")
smalluml_Attribute = Class(name="smalluml_Attribute")
smalluml_Element = Class(name="smalluml_Element")
...
smalluml_NamedElement = Class(name="smalluml_NamedElement")
Element = Class(name="Element")
Type = Class(name="Type")
smalluml_Type = Class(name="smalluml_Type")
smalluml_BooleanV = Class(name="smalluml_BooleanV")
smalluml_StringV = Class(name="smalluml_StringV")
smalluml_RealV = Class(name="smalluml_RealV")
smalluml_IntegerV = Class(name="smalluml_IntegerV")
...
smalluml_Cardinalite.attributes={smalluml_Cardinalite_lowerBound, smalluml_Cardinalite_upperBound}
...
domain_model = DomainModel(
    name="smalluml",
    types={smalluml_Class, NamedElement, smalluml_Operation, smalluml_Attribute, smalluml_Element, smalluml_Enumeration, smalluml_Association, smalluml_Cardinalite, smalluml_Package, smalluml_NamedElement, Element, Type, smalluml_Type, smalluml_BooleanV, smalluml_StringV, smalluml_RealV, smalluml_IntegerV},
    associations={Operations0, Attributes1, SuperClass4, From8, To10, cardFrom13, cardTo15, listElements18, Type6},
    generalizations={gen_smalluml_Class_NamedElement, gen_smalluml_Enumeration_NamedElement, gen_smalluml_Cardinalite_NamedElement, gen_smalluml_NamedElement_Element, gen_smalluml_Operation_NamedElement, gen_smalluml_Attribute_Type, gen_smalluml_Type_NamedElement, gen_smalluml_BooleanV_Type, gen_smalluml_StringV_Type, gen_smalluml_RealV_Type, gen_smalluml_IntegerV_Type},
    metadata=None
)
