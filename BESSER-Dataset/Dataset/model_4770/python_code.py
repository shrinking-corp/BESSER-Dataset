...
class atl_types_Type(ABC):
    ...
    def __init__(self, multivalued: bool, atl_types_Type11: "atl_types_UnionType" = None, atl_types_Type: "atl_types_MapType" = None, atl_types_Type4: "atl_types_MapType" = None, atl_types_Type7: "atl_types_TupleAttribute" = None):
