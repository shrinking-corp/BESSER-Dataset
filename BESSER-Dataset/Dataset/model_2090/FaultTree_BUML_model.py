...
FaultTree_EObject = Class(name="FaultTree_EObject")
...
FaultTree_FaultTree.attributes={FaultTree_FaultTree_name, FaultTree_FaultTree_faultTreeType, FaultTree_FaultTree_message}
...
FaultTree_Event.attributes={FaultTree_Event_message, FaultTree_Event_name, FaultTree_Event_referenceCount, FaultTree_Event_assignedProbability, FaultTree_Event_sharedEvent, FaultTree_Event_type, FaultTree_Event_subEventLogic, FaultTree_Event_k, FaultTree_Event_computedProbability}
...
domain_model = DomainModel(
    ...
    associations={events3, subEvents7, relatedInstanceObject9, relatedErrorType12, relatedEMV2Object15, root0, instanceRoot1},
    generalizations={},
    metadata=None
)
