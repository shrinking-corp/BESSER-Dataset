...
def test_hyp_emigocl_settype_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_SetType)


def test_hyp_emigocl_settype_constructor_exists():
    assert callable(EmigOcl_SetType.__init__)


def test_hyp_emigocl_settype_constructor_args():
    sig = inspect.signature(EmigOcl_SetType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_orderedsettype_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_OrderedSetType)


def test_hyp_emigocl_orderedsettype_constructor_exists():
    assert callable(EmigOcl_OrderedSetType.__init__)


def test_hyp_emigocl_orderedsettype_constructor_args():
    sig = inspect.signature(EmigOcl_OrderedSetType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_sequencetype_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_SequenceType)


def test_hyp_emigocl_sequencetype_constructor_exists():
    assert callable(EmigOcl_SequenceType.__init__)


def test_hyp_emigocl_sequencetype_constructor_args():
    sig = inspect.signature(EmigOcl_SequenceType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_bagtype_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_BagType)


def test_hyp_emigocl_bagtype_constructor_exists():
    assert callable(EmigOcl_BagType.__init__)


def test_hyp_emigocl_bagtype_constructor_args():
...
def test_hyp_emigocl_realtype_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_RealType)


def test_hyp_emigocl_realtype_constructor_exists():
    assert callable(EmigOcl_RealType.__init__)


def test_hyp_emigocl_realtype_constructor_args():
    sig = inspect.signature(EmigOcl_RealType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_integertype_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_IntegerType)


def test_hyp_emigocl_integertype_constructor_exists():
    assert callable(EmigOcl_IntegerType.__init__)


def test_hyp_emigocl_integertype_constructor_args():
...
def test_hyp_emigocl_booleantype_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_BooleanType)


def test_hyp_emigocl_booleantype_constructor_exists():
    assert callable(EmigOcl_BooleanType.__init__)


def test_hyp_emigocl_booleantype_constructor_args():
    sig = inspect.signature(EmigOcl_BooleanType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_numerictype_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_NumericType)


def test_hyp_emigocl_numerictype_constructor_exists():
    assert callable(EmigOcl_NumericType.__init__)


def test_hyp_emigocl_numerictype_constructor_args():
    sig = inspect.signature(EmigOcl_NumericType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_stringtype_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_StringType)


def test_hyp_emigocl_stringtype_constructor_exists():
    assert callable(EmigOcl_StringType.__init__)


def test_hyp_emigocl_stringtype_constructor_args():
...
def test_hyp_emigocl_primitive_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_Primitive)


def test_hyp_emigocl_primitive_constructor_exists():
    assert callable(EmigOcl_Primitive.__init__)


def test_hyp_emigocl_primitive_constructor_args():
    sig = inspect.signature(EmigOcl_Primitive.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_oclanytype_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_OclAnyType)


def test_hyp_emigocl_oclanytype_constructor_exists():
    assert callable(EmigOcl_OclAnyType.__init__)


def test_hyp_emigocl_oclanytype_constructor_args():
    sig = inspect.signature(EmigOcl_OclAnyType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_maptype_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_MapType)


def test_hyp_emigocl_maptype_constructor_exists():
    assert callable(EmigOcl_MapType.__init__)


def test_hyp_emigocl_maptype_constructor_args():
    sig = inspect.signature(EmigOcl_MapType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_oclmodelelement_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_OclModelElement)


def test_hyp_emigocl_oclmodelelement_constructor_exists():
    assert callable(EmigOcl_OclModelElement.__init__)


def test_hyp_emigocl_oclmodelelement_constructor_args():
    sig = inspect.signature(EmigOcl_OclModelElement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_tupletype_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_TupleType)


def test_hyp_emigocl_tupletype_constructor_exists():
    assert callable(EmigOcl_TupleType.__init__)


def test_hyp_emigocl_tupletype_constructor_args():
    sig = inspect.signature(EmigOcl_TupleType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_lambdatype_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_LambdaType)


def test_hyp_emigocl_lambdatype_constructor_exists():
    assert callable(EmigOcl_LambdaType.__init__)


def test_hyp_emigocl_lambdatype_constructor_args():
    sig = inspect.signature(EmigOcl_LambdaType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_collectiontype_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_CollectionType)


def test_hyp_emigocl_collectiontype_constructor_exists():
    assert callable(EmigOcl_CollectionType.__init__)


def test_hyp_emigocl_collectiontype_constructor_args():
...
def test_hyp_emigocl_parameter_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_Parameter)


def test_hyp_emigocl_parameter_constructor_exists():
    assert callable(EmigOcl_Parameter.__init__)


def test_hyp_emigocl_parameter_constructor_args():
...
def test_hyp_emigocl_iteratorexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_IteratorExp)


def test_hyp_emigocl_iteratorexp_constructor_exists():
    assert callable(EmigOcl_IteratorExp.__init__)


def test_hyp_emigocl_iteratorexp_constructor_args():
...
def test_hyp_emigocl_iterator_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_Iterator)


def test_hyp_emigocl_iterator_constructor_exists():
    assert callable(EmigOcl_Iterator.__init__)


def test_hyp_emigocl_iterator_constructor_args():
    sig = inspect.signature(EmigOcl_Iterator.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_iterateexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_IterateExp)


def test_hyp_emigocl_iterateexp_constructor_exists():
    assert callable(EmigOcl_IterateExp.__init__)


def test_hyp_emigocl_iterateexp_constructor_args():
...
def test_hyp_emigocl_collectionoperationcall_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_CollectionOperationCall)


def test_hyp_emigocl_collectionoperationcall_constructor_exists():
    assert callable(EmigOcl_CollectionOperationCall.__init__)


def test_hyp_emigocl_collectionoperationcall_constructor_args():
...
def test_hyp_emigocl_lambdacallexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_LambdaCallExp)


def test_hyp_emigocl_lambdacallexp_constructor_exists():
    assert callable(EmigOcl_LambdaCallExp.__init__)


def test_hyp_emigocl_lambdacallexp_constructor_args():
...
def test_hyp_emigocl_intopcallexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_IntOpCallExp)


def test_hyp_emigocl_intopcallexp_constructor_exists():
    assert callable(EmigOcl_IntOpCallExp.__init__)


def test_hyp_emigocl_intopcallexp_constructor_args():
    sig = inspect.signature(EmigOcl_IntOpCallExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_relopcallexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_RelOpCallExp)


def test_hyp_emigocl_relopcallexp_constructor_exists():
    assert callable(EmigOcl_RelOpCallExp.__init__)


def test_hyp_emigocl_relopcallexp_constructor_args():
    sig = inspect.signature(EmigOcl_RelOpCallExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_eqopcallexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_EqOpCallExp)


def test_hyp_emigocl_eqopcallexp_constructor_exists():
    assert callable(EmigOcl_EqOpCallExp.__init__)


def test_hyp_emigocl_eqopcallexp_constructor_args():
    sig = inspect.signature(EmigOcl_EqOpCallExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_mulopcallexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_MulOpCallExp)


def test_hyp_emigocl_mulopcallexp_constructor_exists():
    assert callable(EmigOcl_MulOpCallExp.__init__)


def test_hyp_emigocl_mulopcallexp_constructor_args():
    sig = inspect.signature(EmigOcl_MulOpCallExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_addopcallexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_AddOpCallExp)


def test_hyp_emigocl_addopcallexp_constructor_exists():
    assert callable(EmigOcl_AddOpCallExp.__init__)


def test_hyp_emigocl_addopcallexp_constructor_args():
    sig = inspect.signature(EmigOcl_AddOpCallExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_notopcallexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_NotOpCallExp)


def test_hyp_emigocl_notopcallexp_constructor_exists():
    assert callable(EmigOcl_NotOpCallExp.__init__)


def test_hyp_emigocl_notopcallexp_constructor_args():
...
def test_hyp_emigocl_operatorcallexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_OperatorCallExp)


def test_hyp_emigocl_operatorcallexp_constructor_exists():
    assert callable(EmigOcl_OperatorCallExp.__init__)


def test_hyp_emigocl_operatorcallexp_constructor_args():
...
def test_hyp_emigocl_navigationorattributecall_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_NavigationOrAttributeCall)


def test_hyp_emigocl_navigationorattributecall_constructor_exists():
    assert callable(EmigOcl_NavigationOrAttributeCall.__init__)


def test_hyp_emigocl_navigationorattributecall_constructor_args():
...
def test_hyp_emigocl_propertycall_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_PropertyCall)


def test_hyp_emigocl_propertycall_constructor_exists():
    assert callable(EmigOcl_PropertyCall.__init__)


def test_hyp_emigocl_propertycall_constructor_args():
...
def test_hyp_emigocl_staticoperationcall_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_StaticOperationCall)


def test_hyp_emigocl_staticoperationcall_constructor_exists():
    assert callable(EmigOcl_StaticOperationCall.__init__)


def test_hyp_emigocl_staticoperationcall_constructor_args():
...
def test_hyp_emigocl_staticnavigationorattributecall_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_StaticNavigationOrAttributeCall)


def test_hyp_emigocl_staticnavigationorattributecall_constructor_exists():
    assert callable(EmigOcl_StaticNavigationOrAttributeCall.__init__)


def test_hyp_emigocl_staticnavigationorattributecall_constructor_args():
...
def test_hyp_emigocl_staticpropertycall_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_StaticPropertyCall)


def test_hyp_emigocl_staticpropertycall_constructor_exists():
    assert callable(EmigOcl_StaticPropertyCall.__init__)


def test_hyp_emigocl_staticpropertycall_constructor_args():
...
def test_hyp_emigocl_tuplepart_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_TuplePart)


def test_hyp_emigocl_tuplepart_constructor_exists():
    assert callable(EmigOcl_TuplePart.__init__)


def test_hyp_emigocl_tuplepart_constructor_args():
...
def test_hyp_emigocl_integerexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_IntegerExp)


def test_hyp_emigocl_integerexp_constructor_exists():
    assert callable(EmigOcl_IntegerExp.__init__)


def test_hyp_emigocl_integerexp_constructor_args():
...
def test_hyp_emigocl_realexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_RealExp)


def test_hyp_emigocl_realexp_constructor_exists():
    assert callable(EmigOcl_RealExp.__init__)


def test_hyp_emigocl_realexp_constructor_args():
...
def test_hyp_emigocl_booleanexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_BooleanExp)


def test_hyp_emigocl_booleanexp_constructor_exists():
    assert callable(EmigOcl_BooleanExp.__init__)


def test_hyp_emigocl_booleanexp_constructor_args():
...
def test_hyp_emigocl_numericexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_NumericExp)


def test_hyp_emigocl_numericexp_constructor_exists():
    assert callable(EmigOcl_NumericExp.__init__)


def test_hyp_emigocl_numericexp_constructor_args():
    sig = inspect.signature(EmigOcl_NumericExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_stringexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_StringExp)


def test_hyp_emigocl_stringexp_constructor_exists():
    assert callable(EmigOcl_StringExp.__init__)


def test_hyp_emigocl_stringexp_constructor_args():
...
def test_hyp_emigocl_braceexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_BraceExp)


def test_hyp_emigocl_braceexp_constructor_exists():
    assert callable(EmigOcl_BraceExp.__init__)


def test_hyp_emigocl_braceexp_constructor_args():
    sig = inspect.signature(EmigOcl_BraceExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_oclundefinedexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_OclUndefinedExp)


def test_hyp_emigocl_oclundefinedexp_constructor_exists():
    assert callable(EmigOcl_OclUndefinedExp.__init__)


def test_hyp_emigocl_oclundefinedexp_constructor_args():
    sig = inspect.signature(EmigOcl_OclUndefinedExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_oclmodelelementexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_OclModelElementExp)


def test_hyp_emigocl_oclmodelelementexp_constructor_exists():
    assert callable(EmigOcl_OclModelElementExp.__init__)


def test_hyp_emigocl_oclmodelelementexp_constructor_args():
...
def test_hyp_emigocl_staticpropertycallexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_StaticPropertyCallExp)


def test_hyp_emigocl_staticpropertycallexp_constructor_exists():
    assert callable(EmigOcl_StaticPropertyCallExp.__init__)


def test_hyp_emigocl_staticpropertycallexp_constructor_args():
    sig = inspect.signature(EmigOcl_StaticPropertyCallExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_enumliteralexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_EnumLiteralExp)


def test_hyp_emigocl_enumliteralexp_constructor_exists():
    assert callable(EmigOcl_EnumLiteralExp.__init__)


def test_hyp_emigocl_enumliteralexp_constructor_args():
...
def test_hyp_emigocl_tupleexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_TupleExp)


def test_hyp_emigocl_tupleexp_constructor_exists():
    assert callable(EmigOcl_TupleExp.__init__)


def test_hyp_emigocl_tupleexp_constructor_args():
    sig = inspect.signature(EmigOcl_TupleExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_mapexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_MapExp)


def test_hyp_emigocl_mapexp_constructor_exists():
    assert callable(EmigOcl_MapExp.__init__)


def test_hyp_emigocl_mapexp_constructor_args():
    sig = inspect.signature(EmigOcl_MapExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_primitiveexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_PrimitiveExp)


def test_hyp_emigocl_primitiveexp_constructor_exists():
    assert callable(EmigOcl_PrimitiveExp.__init__)


def test_hyp_emigocl_primitiveexp_constructor_args():
    sig = inspect.signature(EmigOcl_PrimitiveExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_selfexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_SelfExp)


def test_hyp_emigocl_selfexp_constructor_exists():
    assert callable(EmigOcl_SelfExp.__init__)


def test_hyp_emigocl_selfexp_constructor_args():
    sig = inspect.signature(EmigOcl_SelfExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_superexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_SuperExp)


def test_hyp_emigocl_superexp_constructor_exists():
    assert callable(EmigOcl_SuperExp.__init__)


def test_hyp_emigocl_superexp_constructor_args():
    sig = inspect.signature(EmigOcl_SuperExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_variableexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_VariableExp)


def test_hyp_emigocl_variableexp_constructor_exists():
    assert callable(EmigOcl_VariableExp.__init__)


def test_hyp_emigocl_variableexp_constructor_args():
    sig = inspect.signature(EmigOcl_VariableExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_attribute_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_Attribute)


def test_hyp_emigocl_attribute_constructor_exists():
    assert callable(EmigOcl_Attribute.__init__)


def test_hyp_emigocl_attribute_constructor_args():
...
def test_hyp_emigocl_operation_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_Operation)


def test_hyp_emigocl_operation_constructor_exists():
    assert callable(EmigOcl_Operation.__init__)


def test_hyp_emigocl_operation_constructor_args():
...
def test_hyp_emigocl_localvariable_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_LocalVariable)


def test_hyp_emigocl_localvariable_constructor_exists():
    assert callable(EmigOcl_LocalVariable.__init__)


def test_hyp_emigocl_localvariable_constructor_args():
...
def test_hyp_emigocl_operationcall_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_OperationCall)


def test_hyp_emigocl_operationcall_constructor_exists():
    assert callable(EmigOcl_OperationCall.__init__)


def test_hyp_emigocl_operationcall_constructor_args():
...
def test_hyp_emigocl_loopexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_LoopExp)


def test_hyp_emigocl_loopexp_constructor_exists():
    assert callable(EmigOcl_LoopExp.__init__)


def test_hyp_emigocl_loopexp_constructor_args():
...
def test_hyp_emigocl_sequenceexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_SequenceExp)


def test_hyp_emigocl_sequenceexp_constructor_exists():
    assert callable(EmigOcl_SequenceExp.__init__)


def test_hyp_emigocl_sequenceexp_constructor_args():
    sig = inspect.signature(EmigOcl_SequenceExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_orderedsetexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_OrderedSetExp)


def test_hyp_emigocl_orderedsetexp_constructor_exists():
    assert callable(EmigOcl_OrderedSetExp.__init__)


def test_hyp_emigocl_orderedsetexp_constructor_args():
    sig = inspect.signature(EmigOcl_OrderedSetExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_setexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_SetExp)


def test_hyp_emigocl_setexp_constructor_exists():
    assert callable(EmigOcl_SetExp.__init__)


def test_hyp_emigocl_setexp_constructor_args():
    sig = inspect.signature(EmigOcl_SetExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_bagexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_BagExp)


def test_hyp_emigocl_bagexp_constructor_exists():
    assert callable(EmigOcl_BagExp.__init__)


def test_hyp_emigocl_bagexp_constructor_args():
    sig = inspect.signature(EmigOcl_BagExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_collectionexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_CollectionExp)


def test_hyp_emigocl_collectionexp_constructor_exists():
    assert callable(EmigOcl_CollectionExp.__init__)


def test_hyp_emigocl_collectionexp_constructor_args():
    sig = inspect.signature(EmigOcl_CollectionExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_propertycallexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_PropertyCallExp)


def test_hyp_emigocl_propertycallexp_constructor_exists():
    assert callable(EmigOcl_PropertyCallExp.__init__)


def test_hyp_emigocl_propertycallexp_constructor_args():
    sig = inspect.signature(EmigOcl_PropertyCallExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_ifexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_IfExp)


def test_hyp_emigocl_ifexp_constructor_exists():
    assert callable(EmigOcl_IfExp.__init__)


def test_hyp_emigocl_ifexp_constructor_args():
...
def test_hyp_emigocl_tupletypeattribute_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_TupleTypeAttribute)


def test_hyp_emigocl_tupletypeattribute_constructor_exists():
    assert callable(EmigOcl_TupleTypeAttribute.__init__)


def test_hyp_emigocl_tupletypeattribute_constructor_args():
...
def test_hyp_emigocl_oclexpression_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_OclExpression)


def test_hyp_emigocl_oclexpression_constructor_exists():
    assert callable(EmigOcl_OclExpression.__init__)


def test_hyp_emigocl_oclexpression_constructor_args():
    sig = inspect.signature(EmigOcl_OclExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_variabledeclaration_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_VariableDeclaration)


def test_hyp_emigocl_variabledeclaration_constructor_exists():
    assert callable(EmigOcl_VariableDeclaration.__init__)


def test_hyp_emigocl_variabledeclaration_constructor_args():
...
def test_hyp_emigocl_oclfeature_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_OclFeature)


def test_hyp_emigocl_oclfeature_constructor_exists():
    assert callable(EmigOcl_OclFeature.__init__)


def test_hyp_emigocl_oclfeature_constructor_args():
...
def test_hyp_emigocl_oclmodel_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_OclModel)


def test_hyp_emigocl_oclmodel_constructor_exists():
    assert callable(EmigOcl_OclModel.__init__)


def test_hyp_emigocl_oclmodel_constructor_args():
...
def test_hyp_emigocl_oclfeaturedefinition_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_OclFeatureDefinition)


def test_hyp_emigocl_oclfeaturedefinition_constructor_exists():
    assert callable(EmigOcl_OclFeatureDefinition.__init__)


def test_hyp_emigocl_oclfeaturedefinition_constructor_args():
...
def test_hyp_emigocl_mapelement_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_MapElement)


def test_hyp_emigocl_mapelement_constructor_exists():
    assert callable(EmigOcl_MapElement.__init__)


def test_hyp_emigocl_mapelement_constructor_args():
    sig = inspect.signature(EmigOcl_MapElement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_oclcontextdefinition_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_OclContextDefinition)


def test_hyp_emigocl_oclcontextdefinition_constructor_exists():
    assert callable(EmigOcl_OclContextDefinition.__init__)


def test_hyp_emigocl_oclcontextdefinition_constructor_args():
    sig = inspect.signature(EmigOcl_OclContextDefinition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_emigocl_ocltype_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_OclType)


def test_hyp_emigocl_ocltype_constructor_exists():
    assert callable(EmigOcl_OclType.__init__)


def test_hyp_emigocl_ocltype_constructor_args():
...
def test_hyp_emigocl_module_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_Module)


def test_hyp_emigocl_module_constructor_exists():
    assert callable(EmigOcl_Module.__init__)


def test_hyp_emigocl_module_constructor_args():
...
def test_hyp_emigocl_locatedelement_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_LocatedElement)


def test_hyp_emigocl_locatedelement_constructor_exists():
    assert callable(EmigOcl_LocatedElement.__init__)


def test_hyp_emigocl_locatedelement_constructor_args():
...
def test_hyp_emigocl_letexp_is_not_abstract():
    assert not inspect.isabstract(EmigOcl_LetExp)


def test_hyp_emigocl_letexp_constructor_exists():
    assert callable(EmigOcl_LetExp.__init__)


def test_hyp_emigocl_letexp_constructor_args():
...
def test_hyp_emigocl_iteratorexp_name_setter(instance):
...
def test_hyp_emigocl_operatorcallexp_operationName_setter(instance):
...
def test_hyp_emigocl_navigationorattributecall_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_emigocl_staticoperationcall_operationName_setter(instance):
    original = instance.operationName
    instance.operationName = original
    assert instance.operationName == original
...
def test_hyp_emigocl_staticnavigationorattributecall_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_emigocl_integerexp_integerSymbol_setter(instance):
...
def test_hyp_emigocl_realexp_realSymbol_setter(instance):
...
def test_hyp_emigocl_booleanexp_booleanSymbol_setter(instance):
...
def test_hyp_emigocl_stringexp_stringSymbol_setter(instance):
...
def test_hyp_emigocl_oclmodelelementexp_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_emigocl_enumliteralexp_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_emigocl_attribute_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_emigocl_operation_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_emigocl_localvariable_eq_setter(instance):
...
def test_hyp_emigocl_operationcall_operationName_setter(instance):
    original = instance.operationName
    instance.operationName = original
    assert instance.operationName == original
...
def test_hyp_emigocl_tupletypeattribute_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_emigocl_variabledeclaration_varName_setter(instance):
...
def test_hyp_emigocl_oclfeature_eq_setter(instance):
    original = instance.eq
    instance.eq = original
    assert instance.eq == original
...
def test_hyp_emigocl_oclmodel_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_emigocl_oclfeaturedefinition_static_setter(instance):
...
def test_hyp_emigocl_ocltype_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_emigocl_module_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_emigocl_locatedelement_charEnd_setter(instance):
...
@given(instance=EmigOcl_LocatedElement_strategy)
def test_hyp_emigocl_locatedelement_line_setter(instance):
...
@given(instance=EmigOcl_LocatedElement_strategy)
def test_hyp_emigocl_locatedelement_column_setter(instance):
...
@given(instance=EmigOcl_LocatedElement_strategy)
def test_hyp_emigocl_locatedelement_charStart_setter(instance):
