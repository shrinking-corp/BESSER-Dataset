...
# Classes
EmigOcl_LetExp = Class(name="EmigOcl_LetExp")
EmigOcl_LocatedElement = Class(name="EmigOcl_LocatedElement", is_abstract=True)
EmigOcl_Module = Class(name="EmigOcl_Module")
LocatedElement = Class(name="LocatedElement")
EmigOcl_OclModel = Class(name="EmigOcl_OclModel")
EmigOcl_OclFeatureDefinition = Class(name="EmigOcl_OclFeatureDefinition")
EmigOcl_OclExpression = Class(name="EmigOcl_OclExpression", is_abstract=True)
EmigOcl_OclType = Class(name="EmigOcl_OclType", is_abstract=True)
EmigOcl_IfExp = Class(name="EmigOcl_IfExp")
EmigOcl_PropertyCallExp = Class(name="EmigOcl_PropertyCallExp")
EmigOcl_CollectionExp = Class(name="EmigOcl_CollectionExp", is_abstract=True)
CollectionExp = Class(name="CollectionExp")
EmigOcl_LoopExp = Class(name="EmigOcl_LoopExp", is_abstract=True)
EmigOcl_OperationCall = Class(name="EmigOcl_OperationCall")
EmigOcl_LocalVariable = Class(name="EmigOcl_LocalVariable")
EmigOcl_Operation = Class(name="EmigOcl_Operation")
EmigOcl_Attribute = Class(name="EmigOcl_Attribute")
EmigOcl_VariableExp = Class(name="EmigOcl_VariableExp")
OclExpression = Class(name="OclExpression")
EmigOcl_VariableDeclaration = Class(name="EmigOcl_VariableDeclaration", is_abstract=True)
EmigOcl_SuperExp = Class(name="EmigOcl_SuperExp")
EmigOcl_SelfExp = Class(name="EmigOcl_SelfExp")
EmigOcl_PrimitiveExp = Class(name="EmigOcl_PrimitiveExp", is_abstract=True)
EmigOcl_StringExp = Class(name="EmigOcl_StringExp")
PrimitiveExp = Class(name="PrimitiveExp")
EmigOcl_BooleanExp = Class(name="EmigOcl_BooleanExp")
EmigOcl_NumericExp = Class(name="EmigOcl_NumericExp", is_abstract=True)
EmigOcl_RealExp = Class(name="EmigOcl_RealExp")
NumericExp = Class(name="NumericExp")
EmigOcl_IntegerExp = Class(name="EmigOcl_IntegerExp")
EmigOcl_BagExp = Class(name="EmigOcl_BagExp")
EmigOcl_OrderedSetExp = Class(name="EmigOcl_OrderedSetExp")
EmigOcl_SequenceExp = Class(name="EmigOcl_SequenceExp")
EmigOcl_SetExp = Class(name="EmigOcl_SetExp")
EmigOcl_TupleExp = Class(name="EmigOcl_TupleExp")
EmigOcl_TuplePart = Class(name="EmigOcl_TuplePart")
LocalVariable = Class(name="LocalVariable")
EmigOcl_MapExp = Class(name="EmigOcl_MapExp")
EmigOcl_MapElement = Class(name="EmigOcl_MapElement")
EmigOcl_EnumLiteralExp = Class(name="EmigOcl_EnumLiteralExp")
EmigOcl_OclUndefinedExp = Class(name="EmigOcl_OclUndefinedExp")
EmigOcl_StaticPropertyCallExp = Class(name="EmigOcl_StaticPropertyCallExp")
EmigOcl_StaticPropertyCall = Class(name="EmigOcl_StaticPropertyCall", is_abstract=True)
EmigOcl_StaticNavigationOrAttributeCall = Class(name="EmigOcl_StaticNavigationOrAttributeCall")
StaticPropertyCall = Class(name="StaticPropertyCall")
EmigOcl_StaticOperationCall = Class(name="EmigOcl_StaticOperationCall")
EmigOcl_PropertyCall = Class(name="EmigOcl_PropertyCall", is_abstract=True)
EmigOcl_NavigationOrAttributeCall = Class(name="EmigOcl_NavigationOrAttributeCall")
PropertyCall = Class(name="PropertyCall")
EmigOcl_OperatorCallExp = Class(name="EmigOcl_OperatorCallExp")
PropertyCallExp = Class(name="PropertyCallExp")
EmigOcl_NotOpCallExp = Class(name="EmigOcl_NotOpCallExp")
OperatorCallExp = Class(name="OperatorCallExp")
EmigOcl_RelOpCallExp = Class(name="EmigOcl_RelOpCallExp")
EmigOcl_EqOpCallExp = Class(name="EmigOcl_EqOpCallExp")
EmigOcl_AddOpCallExp = Class(name="EmigOcl_AddOpCallExp")
EmigOcl_IntOpCallExp = Class(name="EmigOcl_IntOpCallExp")
EmigOcl_MulOpCallExp = Class(name="EmigOcl_MulOpCallExp")
EmigOcl_LambdaCallExp = Class(name="EmigOcl_LambdaCallExp")
VariableExp = Class(name="VariableExp")
EmigOcl_BraceExp = Class(name="EmigOcl_BraceExp")
EmigOcl_CollectionOperationCall = Class(name="EmigOcl_CollectionOperationCall")
OperationCall = Class(name="OperationCall")
EmigOcl_IterateExp = Class(name="EmigOcl_IterateExp")
EmigOcl_Iterator = Class(name="EmigOcl_Iterator")
LoopExp = Class(name="LoopExp")
EmigOcl_IteratorExp = Class(name="EmigOcl_IteratorExp")
VariableDeclaration = Class(name="VariableDeclaration")
EmigOcl_OclModelElementExp = Class(name="EmigOcl_OclModelElementExp")
EmigOcl_Parameter = Class(name="EmigOcl_Parameter")
EmigOcl_CollectionType = Class(name="EmigOcl_CollectionType")
OclType = Class(name="OclType")
EmigOcl_OclContextDefinition = Class(name="EmigOcl_OclContextDefinition")
EmigOcl_MapType = Class(name="EmigOcl_MapType")
EmigOcl_TupleTypeAttribute = Class(name="EmigOcl_TupleTypeAttribute")
EmigOcl_OclFeature = Class(name="EmigOcl_OclFeature", is_abstract=True)
EmigOcl_Primitive = Class(name="EmigOcl_Primitive", is_abstract=True)
EmigOcl_StringType = Class(name="EmigOcl_StringType")
Primitive = Class(name="Primitive")
EmigOcl_BooleanType = Class(name="EmigOcl_BooleanType")
EmigOcl_NumericType = Class(name="EmigOcl_NumericType", is_abstract=True)
EmigOcl_IntegerType = Class(name="EmigOcl_IntegerType")
NumericType = Class(name="NumericType")
EmigOcl_RealType = Class(name="EmigOcl_RealType")
EmigOcl_BagType = Class(name="EmigOcl_BagType")
CollectionType = Class(name="CollectionType")
EmigOcl_OrderedSetType = Class(name="EmigOcl_OrderedSetType")
EmigOcl_SequenceType = Class(name="EmigOcl_SequenceType")
EmigOcl_SetType = Class(name="EmigOcl_SetType")
EmigOcl_OclAnyType = Class(name="EmigOcl_OclAnyType")
EmigOcl_TupleType = Class(name="EmigOcl_TupleType")
EmigOcl_OclModelElement = Class(name="EmigOcl_OclModelElement")
EmigOcl_LambdaType = Class(name="EmigOcl_LambdaType")
...
EmigOcl_LocatedElement.attributes={EmigOcl_LocatedElement_charStart, EmigOcl_LocatedElement_column, EmigOcl_LocatedElement_line, EmigOcl_LocatedElement_charEnd}
...
domain_model = DomainModel(
    name="EmigOcl",
    types={EmigOcl_LetExp, EmigOcl_LocatedElement, EmigOcl_Module, LocatedElement, EmigOcl_OclModel, EmigOcl_OclFeatureDefinition, EmigOcl_OclExpression, EmigOcl_OclType, EmigOcl_IfExp, EmigOcl_PropertyCallExp, EmigOcl_CollectionExp, CollectionExp, EmigOcl_LoopExp, EmigOcl_OperationCall, EmigOcl_LocalVariable, EmigOcl_Operation, EmigOcl_Attribute, EmigOcl_VariableExp, OclExpression, EmigOcl_VariableDeclaration, EmigOcl_SuperExp, EmigOcl_SelfExp, EmigOcl_PrimitiveExp, EmigOcl_StringExp, PrimitiveExp, EmigOcl_BooleanExp, EmigOcl_NumericExp, EmigOcl_RealExp, NumericExp, EmigOcl_IntegerExp, EmigOcl_BagExp, EmigOcl_OrderedSetExp, EmigOcl_SequenceExp, EmigOcl_SetExp, EmigOcl_TupleExp, EmigOcl_TuplePart, LocalVariable, EmigOcl_MapExp, EmigOcl_MapElement, EmigOcl_EnumLiteralExp, EmigOcl_OclUndefinedExp, EmigOcl_StaticPropertyCallExp, EmigOcl_StaticPropertyCall, EmigOcl_StaticNavigationOrAttributeCall, StaticPropertyCall, EmigOcl_StaticOperationCall, EmigOcl_PropertyCall, EmigOcl_NavigationOrAttributeCall, PropertyCall, EmigOcl_OperatorCallExp, PropertyCallExp, EmigOcl_NotOpCallExp, OperatorCallExp, EmigOcl_RelOpCallExp, EmigOcl_EqOpCallExp, EmigOcl_AddOpCallExp, EmigOcl_IntOpCallExp, EmigOcl_MulOpCallExp, EmigOcl_LambdaCallExp, VariableExp, EmigOcl_BraceExp, EmigOcl_CollectionOperationCall, OperationCall, EmigOcl_IterateExp, EmigOcl_Iterator, LoopExp, EmigOcl_IteratorExp, VariableDeclaration, EmigOcl_OclModelElementExp, EmigOcl_Parameter, EmigOcl_CollectionType, OclType, EmigOcl_OclContextDefinition, EmigOcl_MapType, EmigOcl_TupleTypeAttribute, EmigOcl_OclFeature, EmigOcl_Primitive, EmigOcl_StringType, Primitive, EmigOcl_BooleanType, EmigOcl_NumericType, EmigOcl_IntegerType, NumericType, EmigOcl_RealType, EmigOcl_BagType, CollectionType, EmigOcl_OrderedSetType, EmigOcl_SequenceType, EmigOcl_SetType, EmigOcl_OclAnyType, EmigOcl_TupleType, EmigOcl_OclModelElement, EmigOcl_LambdaType, OclFeature},
    associations={letExp7, models0, features1, type3, ifExp34, appliedProperty5, collection6, loopExp8, parentOperation9, initializedVariable10, ifExp211, owningOperation13, ifExp115, owningAttribute17, referredVariable19, elements20, arguments38, tuplePart21, tuple22, elements23, map24, key26, value27, source30, staticCall31, arguments33, calls35, source36, iterators48, argument40, arguments42, exp44, body46, result49, variable51, in_53, thenExpression56, condition58, elseExpression60, type62, variableExp64, letExp65, initExpression67, variableDeclaration90, baseExp69, model93, loopExpr70, operation72, elementType74, definitions76, oclExpression77, operation79, mapType281, attribute82, mapType85, collectionTypes87, tupleTypeAttribute88, feature111, context_112, attributes95, type97, tupleType99, model100, valueType102, keyType104, returnType106, argumentTypes108, definition115, context_117, definition119, initExpression121, type123, parameters125, returnType126, body129, metamodel132, elements134, model137},
    generalizations={gen_EmigOcl_Module_LocatedElement, gen_EmigOcl_OclExpression_LocatedElement, gen_EmigOcl_BagExp_CollectionExp, gen_EmigOcl_VariableExp_OclExpression, gen_EmigOcl_SuperExp_OclExpression, gen_EmigOcl_SelfExp_OclExpression, gen_EmigOcl_PrimitiveExp_OclExpression, gen_EmigOcl_StringExp_PrimitiveExp, gen_EmigOcl_BooleanExp_PrimitiveExp, gen_EmigOcl_NumericExp_PrimitiveExp, gen_EmigOcl_RealExp_NumericExp, gen_EmigOcl_IntegerExp_NumericExp, gen_EmigOcl_CollectionExp_OclExpression, gen_EmigOcl_OperationCall_PropertyCall, gen_EmigOcl_OrderedSetExp_CollectionExp, gen_EmigOcl_SequenceExp_CollectionExp, gen_EmigOcl_SetExp_CollectionExp, gen_EmigOcl_TupleExp_OclExpression, gen_EmigOcl_TuplePart_LocalVariable, gen_EmigOcl_MapExp_OclExpression, gen_EmigOcl_MapElement_LocatedElement, gen_EmigOcl_EnumLiteralExp_OclExpression, gen_EmigOcl_OclUndefinedExp_OclExpression, gen_EmigOcl_StaticPropertyCallExp_OclExpression, gen_EmigOcl_StaticNavigationOrAttributeCall_StaticPropertyCall, gen_EmigOcl_StaticOperationCall_StaticPropertyCall, gen_EmigOcl_PropertyCallExp_OclExpression, gen_EmigOcl_NavigationOrAttributeCall_PropertyCall, gen_EmigOcl_OperatorCallExp_PropertyCallExp, gen_EmigOcl_NotOpCallExp_OperatorCallExp, gen_EmigOcl_RelOpCallExp_OperatorCallExp, gen_EmigOcl_EqOpCallExp_OperatorCallExp, gen_EmigOcl_AddOpCallExp_OperatorCallExp, gen_EmigOcl_IntOpCallExp_OperatorCallExp, gen_EmigOcl_MulOpCallExp_OperatorCallExp, gen_EmigOcl_LambdaCallExp_VariableExp, gen_EmigOcl_BraceExp_OclExpression, gen_EmigOcl_CollectionOperationCall_OperationCall, gen_EmigOcl_LoopExp_PropertyCall, gen_EmigOcl_IterateExp_LoopExp, gen_EmigOcl_IteratorExp_LoopExp, gen_EmigOcl_LetExp_OclExpression, gen_EmigOcl_IfExp_OclExpression, gen_EmigOcl_VariableDeclaration_LocatedElement, gen_EmigOcl_LocalVariable_VariableDeclaration, gen_EmigOcl_OclModelElementExp_OclExpression, gen_EmigOcl_Iterator_VariableDeclaration, gen_EmigOcl_Parameter_VariableDeclaration, gen_EmigOcl_CollectionType_OclType, gen_EmigOcl_OclType_LocatedElement, gen_EmigOcl_OclContextDefinition_LocatedElement, gen_EmigOcl_Primitive_OclType, gen_EmigOcl_StringType_Primitive, gen_EmigOcl_BooleanType_Primitive, gen_EmigOcl_NumericType_Primitive, gen_EmigOcl_IntegerType_NumericType, gen_EmigOcl_RealType_NumericType, gen_EmigOcl_BagType_CollectionType, gen_EmigOcl_OrderedSetType_CollectionType, gen_EmigOcl_SequenceType_CollectionType, gen_EmigOcl_SetType_CollectionType, gen_EmigOcl_OclAnyType_OclType, gen_EmigOcl_TupleType_OclType, gen_EmigOcl_TupleTypeAttribute_LocatedElement, gen_EmigOcl_OclModelElement_OclType, gen_EmigOcl_MapType_OclType, gen_EmigOcl_LambdaType_OclType, gen_EmigOcl_OclFeatureDefinition_LocatedElement, gen_EmigOcl_OclFeature_LocatedElement, gen_EmigOcl_Attribute_OclFeature, gen_EmigOcl_Operation_OclFeature, gen_EmigOcl_OclModel_LocatedElement},
    metadata=None
)
