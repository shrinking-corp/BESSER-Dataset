...
class EmigOcl_Operation(OclFeature):
    ...
    def __init__(self, name: str, Operation: "EmigOcl_OclExpression" = None, Operation73: "EmigOcl_Parameter" = None, Operation80: "EmigOcl_OclType" = None, operation: set["EmigOcl_Parameter"] = None, operation127: "EmigOcl_OclType" = None, owningOperation: "EmigOcl_OclExpression" = None):
        self.name = name
...
class EmigOcl_LocalVariable(VariableDeclaration):
    ...
    def __init__(self, eq: str, LocalVariable: "EmigOcl_OclExpression" = None, LocalVariable50: "EmigOcl_IterateExp" = None, LocalVariable52: "EmigOcl_LetExp" = None, variable: "EmigOcl_LetExp" = None, initializedVariable: "EmigOcl_OclExpression" = None, result: "EmigOcl_IterateExp" = None):
        self.eq = eq
...
class EmigOcl_OclFeature(LocatedElement):
    ...
    def __init__(self, eq: str, OclFeature: "EmigOcl_OclFeatureDefinition" = None, feature: "EmigOcl_OclFeatureDefinition" = None):
        self.eq = eq
...
class EmigOcl_OclFeatureDefinition(LocatedElement):
    ...
    def __init__(self, static: str, EmigOcl_OclFeatureDefinition: "EmigOcl_Module" = None, definition: "EmigOcl_OclFeature" = None, definition113: "EmigOcl_OclContextDefinition" = None, OclFeatureDefinition: "EmigOcl_OclContextDefinition" = None, OclFeatureDefinition120: "EmigOcl_OclFeature" = None):
        self.static = static
...
class EmigOcl_TupleTypeAttribute(LocatedElement):
    ...
    def __init__(self, name: str, TupleTypeAttribute: "EmigOcl_OclType" = None, TupleTypeAttribute96: "EmigOcl_TupleType" = None, tupleTypeAttribute: "EmigOcl_OclType" = None, attributes: "EmigOcl_TupleType" = None):
        self.name = name
...
class EmigOcl_OclType(LocatedElement):
    ...
    def __init__(self, name: str, OclType: "EmigOcl_OclExpression" = None, EmigOcl_OclType: "EmigOcl_StaticPropertyCallExp" = None, OclType63: "EmigOcl_VariableDeclaration" = None, type91: "EmigOcl_VariableDeclaration" = None, OclType75: "EmigOcl_CollectionType" = None, context_: "EmigOcl_OclContextDefinition" = None, type: "EmigOcl_OclExpression" = None, returnType: "EmigOcl_Operation" = None, valueType: "EmigOcl_MapType" = None, type83: "EmigOcl_Attribute" = None, keyType: "EmigOcl_MapType" = None, elementType: "EmigOcl_CollectionType" = None, type89: "EmigOcl_TupleTypeAttribute" = None, OclType98: "EmigOcl_TupleTypeAttribute" = None, OclType103: "EmigOcl_MapType" = None, OclType105: "EmigOcl_MapType" = None, EmigOcl_OclType107: "EmigOcl_LambdaType" = None, EmigOcl_OclType110: "EmigOcl_LambdaType" = None, OclType118: "EmigOcl_OclContextDefinition" = None, OclType124: "EmigOcl_Attribute" = None, OclType128: "EmigOcl_Operation" = None):
        self.name = name
