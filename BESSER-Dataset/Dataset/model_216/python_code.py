...
class ecore_EClassifier(ENamedElement):
    ...
    def __init__(self, instanceTypeName: str, instanceClassName: str, instanceClass: str, defaultValue: str, eClassifiers: "ecore_EPackage" = None, ecore_EClassifier: set["ecore_ETypeParameter"] = None, ecore_EClassifier64: "ecore_EGenericType" = None, ecore_EClassifier73: "ecore_EGenericType" = None, ecore_EClassifier80: "ecore_EOperation" = None, EClassifier: "ecore_EPackage" = None, ecore_EClassifier86: "ecore_ETypedElement" = None):
