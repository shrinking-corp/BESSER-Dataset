...
def test_hyp_employee2_is_not_abstract():
    assert not inspect.isabstract(Employee2)


def test_hyp_employee2_constructor_exists():
    assert callable(Employee2.__init__)


def test_hyp_employee2_constructor_args():
    sig = inspect.signature(Employee2.__init__)
    params = list(sig.parameters.keys())
...
@given(instance=Employee2_strategy)
def test_hyp_employee2_Emp_Date_Of_Joint_setter(instance):
...
@given(instance=Employee2_strategy)
def test_hyp_employee2_Emp_Id_setter(instance):
    original = instance.Emp_Id
    instance.Emp_Id = original
    assert instance.Emp_Id == original
...
@given(instance=Employee2_strategy)
def test_hyp_employee2_Emp_DOB_setter(instance):
...
@given(instance=Employee2_strategy)
def test_hyp_employee2_Emp_Address_setter(instance):
...
@given(instance=Employee2_strategy)
def test_hyp_employee2_Emp_ContactNo_setter(instance):
...
@given(instance=Employee2_strategy)
def test_hyp_employee2_Emp_Email_setter(instance):
...
@given(instance=Employee2_strategy)
def test_hyp_employee2_Emp_NIC_setter(instance):
...
@given(instance=Employee2_strategy)
def test_hyp_employee2_Emp_Salary_setter(instance):
...
@given(instance=Employee2_strategy)
def test_hyp_employee2_Emp_Department_setter(instance):
...
@given(instance=Employee2_strategy)
def test_hyp_employee2_Emp_Position_setter(instance):
...
@given(instance=Employee2_strategy)
def test_hyp_employee2_Emp_Name_setter(instance):
...
def test_Employee2_Emp_Address_value_roundtrip():
    instance = Employee2(Emp_Address="sample_text", Emp_ContactNo="sample_text", Emp_DOB=date(2024, 1, 1), Emp_Date_Of_Joint=date(2024, 1, 1), Emp_Department="sample_text", Emp_Email="sample_text", Emp_Id=7, Emp_NIC="sample_text", Emp_Name="sample_text", Emp_Position="sample_text", Emp_Salary=3.14)
    assert instance.Emp_Address == "sample_text"
    instance.Emp_Address = "sample_text_2"
    assert instance.Emp_Address == "sample_text_2"


def test_Employee2_Emp_ContactNo_value_roundtrip():
    instance = Employee2(Emp_Address="sample_text", Emp_ContactNo="sample_text", Emp_DOB=date(2024, 1, 1), Emp_Date_Of_Joint=date(2024, 1, 1), Emp_Department="sample_text", Emp_Email="sample_text", Emp_Id=7, Emp_NIC="sample_text", Emp_Name="sample_text", Emp_Position="sample_text", Emp_Salary=3.14)
...
def test_Employee2_Emp_DOB_value_roundtrip():
    instance = Employee2(Emp_Address="sample_text", Emp_ContactNo="sample_text", Emp_DOB=date(2024, 1, 1), Emp_Date_Of_Joint=date(2024, 1, 1), Emp_Department="sample_text", Emp_Email="sample_text", Emp_Id=7, Emp_NIC="sample_text", Emp_Name="sample_text", Emp_Position="sample_text", Emp_Salary=3.14)
...
def test_Employee2_Emp_Date_Of_Joint_value_roundtrip():
    instance = Employee2(Emp_Address="sample_text", Emp_ContactNo="sample_text", Emp_DOB=date(2024, 1, 1), Emp_Date_Of_Joint=date(2024, 1, 1), Emp_Department="sample_text", Emp_Email="sample_text", Emp_Id=7, Emp_NIC="sample_text", Emp_Name="sample_text", Emp_Position="sample_text", Emp_Salary=3.14)
...
def test_Employee2_Emp_Department_value_roundtrip():
    instance = Employee2(Emp_Address="sample_text", Emp_ContactNo="sample_text", Emp_DOB=date(2024, 1, 1), Emp_Date_Of_Joint=date(2024, 1, 1), Emp_Department="sample_text", Emp_Email="sample_text", Emp_Id=7, Emp_NIC="sample_text", Emp_Name="sample_text", Emp_Position="sample_text", Emp_Salary=3.14)
...
def test_Employee2_Emp_Email_value_roundtrip():
    instance = Employee2(Emp_Address="sample_text", Emp_ContactNo="sample_text", Emp_DOB=date(2024, 1, 1), Emp_Date_Of_Joint=date(2024, 1, 1), Emp_Department="sample_text", Emp_Email="sample_text", Emp_Id=7, Emp_NIC="sample_text", Emp_Name="sample_text", Emp_Position="sample_text", Emp_Salary=3.14)
...
def test_Employee2_Emp_Id_value_roundtrip():
    instance = Employee2(Emp_Address="sample_text", Emp_ContactNo="sample_text", Emp_DOB=date(2024, 1, 1), Emp_Date_Of_Joint=date(2024, 1, 1), Emp_Department="sample_text", Emp_Email="sample_text", Emp_Id=7, Emp_NIC="sample_text", Emp_Name="sample_text", Emp_Position="sample_text", Emp_Salary=3.14)
...
def test_Employee2_Emp_NIC_value_roundtrip():
    instance = Employee2(Emp_Address="sample_text", Emp_ContactNo="sample_text", Emp_DOB=date(2024, 1, 1), Emp_Date_Of_Joint=date(2024, 1, 1), Emp_Department="sample_text", Emp_Email="sample_text", Emp_Id=7, Emp_NIC="sample_text", Emp_Name="sample_text", Emp_Position="sample_text", Emp_Salary=3.14)
...
def test_Employee2_Emp_Name_value_roundtrip():
    instance = Employee2(Emp_Address="sample_text", Emp_ContactNo="sample_text", Emp_DOB=date(2024, 1, 1), Emp_Date_Of_Joint=date(2024, 1, 1), Emp_Department="sample_text", Emp_Email="sample_text", Emp_Id=7, Emp_NIC="sample_text", Emp_Name="sample_text", Emp_Position="sample_text", Emp_Salary=3.14)
...
def test_Employee2_Emp_Position_value_roundtrip():
    instance = Employee2(Emp_Address="sample_text", Emp_ContactNo="sample_text", Emp_DOB=date(2024, 1, 1), Emp_Date_Of_Joint=date(2024, 1, 1), Emp_Department="sample_text", Emp_Email="sample_text", Emp_Id=7, Emp_NIC="sample_text", Emp_Name="sample_text", Emp_Position="sample_text", Emp_Salary=3.14)
...
def test_Employee2_Emp_Salary_value_roundtrip():
    instance = Employee2(Emp_Address="sample_text", Emp_ContactNo="sample_text", Emp_DOB=date(2024, 1, 1), Emp_Date_Of_Joint=date(2024, 1, 1), Emp_Department="sample_text", Emp_Email="sample_text", Emp_Id=7, Emp_NIC="sample_text", Emp_Name="sample_text", Emp_Position="sample_text", Emp_Salary=3.14)
...
def test_assoc_Employee_Leave_link_reassign_clear():
    ...
    b1 = Employee2(Emp_Address="sample_text", Emp_ContactNo="sample_text", Emp_DOB=date(2024, 1, 1), Emp_Date_Of_Joint=date(2024, 1, 1), Emp_Department="sample_text", Emp_Email="sample_text", Emp_Id=7, Emp_NIC="sample_text", Emp_Name="sample_text", Emp_Position="sample_text", Emp_Salary=3.14)
    b2 = Employee2(Emp_Address="sample_text_2", Emp_ContactNo="sample_text_2", Emp_DOB=date(2025, 6, 15), Emp_Date_Of_Joint=date(2025, 6, 15), Emp_Department="sample_text_2", Emp_Email="sample_text_2", Emp_Id=13, Emp_NIC="sample_text_2", Emp_Name="sample_text_2", Emp_Position="sample_text_2", Emp_Salary=9.99)
    _safe_set(a, 'employee5', b1)
    assert _is_linked(a, 'employee5', b1)
    if hasattr(b1, 'leave4'):
        assert _is_linked(b1, 'leave4', a)
    _safe_set(a, 'employee5', b2)
    assert _is_linked(a, 'employee5', b2)
    if hasattr(b1, 'leave4'):
        assert not _is_linked(b1, 'leave4', a)
    if hasattr(b2, 'leave4'):
        assert _is_linked(b2, 'leave4', a)
    _safe_set(a, 'employee5', None)
    assert not _is_linked(a, 'employee5', b2)
    if hasattr(b2, 'leave4'):
        assert not _is_linked(b2, 'leave4', a)
...
Employee2_strategy = st.builds(Employee2, Emp_Address=safe_text, Emp_ContactNo=safe_text, Emp_DOB=st.dates(), Emp_Date_Of_Joint=st.dates(), Emp_Department=safe_text, Emp_Email=safe_text, Emp_Id=st.integers(), Emp_NIC=safe_text, Emp_Name=safe_text, Emp_Position=safe_text, Emp_Salary=st.floats(allow_nan=False, allow_infinity=False))
@given(instance=Employee2_strategy)
@settings(max_examples=25)
def test_Employee2_instantiation(instance):
    assert isinstance(instance, Employee2)
