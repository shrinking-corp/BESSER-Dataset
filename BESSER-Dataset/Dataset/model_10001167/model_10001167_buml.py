...
Employee2 = Class(name="Employee2")
...
Attendance.attributes={Attendance_AttendTime, Attendance_Leaving_Time, Attendance_Attend_date, Attendance_Emp_id}
...
Leave.attributes={Leave_leave_id, Leave_Leave_NoOfDays, Leave_Leave_detail, Leave_Leave_Status, Leave_Leave_Title, Leave_Leave_EndDate, Leave_Leave_StartDate, Leave_Emp_Id, Leave_Leave_ApplyDate}

# Employee2 class attributes and methods
Employee2_Emp_Address: Property = Property(name="Emp_Address", type=StringType)
Employee2_Emp_DOB: Property = Property(name="Emp_DOB", type=DateType)
Employee2_Emp_Department: Property = Property(name="Emp_Department", type=StringType)
Employee2_Emp_Date_Of_Joint: Property = Property(name="Emp_Date_Of_Joint", type=DateType)
Employee2_Emp_Position: Property = Property(name="Emp_Position", type=StringType)
Employee2_Emp_Salary: Property = Property(name="Emp_Salary", type=FloatType)
Employee2_Emp_Id: Property = Property(name="Emp_Id", type=IntegerType)
Employee2_Emp_Name: Property = Property(name="Emp_Name", type=StringType)
Employee2_Emp_ContactNo: Property = Property(name="Emp_ContactNo", type=StringType)
Employee2_Emp_Email: Property = Property(name="Emp_Email", type=StringType)
Employee2_Emp_NIC: Property = Property(name="Emp_NIC", type=StringType)
Employee2.attributes={Employee2_Emp_Email, Employee2_Emp_Name, Employee2_Emp_Department, Employee2_Emp_Address, Employee2_Emp_Id, Employee2_Emp_NIC, Employee2_Emp_ContactNo, Employee2_Emp_Position, Employee2_Emp_DOB, Employee2_Emp_Date_Of_Joint, Employee2_Emp_Salary}
...
Authenticate_staff.attributes={Authenticate_staff_Password, Authenticate_staff_UserName, Authenticate_staff_Authendication_Mood}
...
Salary.attributes={Salary_Sly_Basic, Salary_Sly_Netgross, Salary_OverTime, Salary_Sly_Decrement, Salary_Emp_Id, Salary_Sly_Increment}
...
Employee_Leave: BinaryAssociation = BinaryAssociation(
    name="Employee_Leave",
    ends={
        Property(name="leave4", type=Leave, multiplicity=Multiplicity(0, 1)),
        Property(name="employee5", type=Employee2, multiplicity=Multiplicity(0, 1))
    }
)

# Domain Model
domain_model = DomainModel(
    name="_8cc178fa_e357_4681_adb9_d6797ebf883c",
    types={Attendance, Employee_Management_System_Component, Authentication_UseCase, Salary_Management_UseCase, Administrator_Actor, Employee_Actor, Leave, Employee2, Authenticate_staff, Login, Salary, Login_external, Logout_external},
    associations={Employee_Login, Employee_Logout, Employee_Leave},
    generalizations={},
    metadata=None
)
