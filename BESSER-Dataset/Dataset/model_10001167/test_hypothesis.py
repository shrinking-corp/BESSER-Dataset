...
def test_employee2_is_not_abstract():
    assert not inspect.isabstract(Employee2)


def test_employee2_constructor_exists():
    assert callable(Employee2.__init__)


def test_employee2_constructor_args():
...
def test_employee2_has_Emp_Date_Of_Joint():
    assert hasattr(Employee2, "Emp_Date_Of_Joint")
    descriptor = None
    for klass in Employee2.__mro__:
        if "Emp_Date_Of_Joint" in klass.__dict__:
            descriptor = klass.__dict__["Emp_Date_Of_Joint"]
            break
    assert isinstance(descriptor, property)

def test_employee2_has_Emp_Id():
    assert hasattr(Employee2, "Emp_Id")
    descriptor = None
    for klass in Employee2.__mro__:
        if "Emp_Id" in klass.__dict__:
            descriptor = klass.__dict__["Emp_Id"]
...
def test_employee2_has_Emp_DOB():
    assert hasattr(Employee2, "Emp_DOB")
    descriptor = None
    for klass in Employee2.__mro__:
...
def test_employee2_has_Emp_Address():
    assert hasattr(Employee2, "Emp_Address")
    descriptor = None
    for klass in Employee2.__mro__:
...
def test_employee2_has_Emp_ContactNo():
    assert hasattr(Employee2, "Emp_ContactNo")
    descriptor = None
    for klass in Employee2.__mro__:
...
def test_employee2_has_Emp_Email():
    assert hasattr(Employee2, "Emp_Email")
    descriptor = None
    for klass in Employee2.__mro__:
...
def test_employee2_has_Emp_NIC():
    assert hasattr(Employee2, "Emp_NIC")
    descriptor = None
    for klass in Employee2.__mro__:
...
def test_employee2_has_Emp_Salary():
    assert hasattr(Employee2, "Emp_Salary")
    descriptor = None
    for klass in Employee2.__mro__:
...
def test_employee2_has_Emp_Department():
    assert hasattr(Employee2, "Emp_Department")
    descriptor = None
    for klass in Employee2.__mro__:
...
def test_employee2_has_Emp_Position():
    assert hasattr(Employee2, "Emp_Position")
    descriptor = None
    for klass in Employee2.__mro__:
...
def test_employee2_has_Emp_Name():
    assert hasattr(Employee2, "Emp_Name")
    descriptor = None
    for klass in Employee2.__mro__:
...
@given(instance=Employee2_strategy)
def test_employee2_Emp_Date_Of_Joint_setter(instance):
...
@given(instance=Employee2_strategy)
def test_employee2_Emp_Id_setter(instance):
    original = instance.Emp_Id
    instance.Emp_Id = original
    assert instance.Emp_Id == original
...
@given(instance=Employee2_strategy)
def test_employee2_Emp_DOB_setter(instance):
...
@given(instance=Employee2_strategy)
def test_employee2_Emp_Address_setter(instance):
...
@given(instance=Employee2_strategy)
def test_employee2_Emp_ContactNo_setter(instance):
...
@given(instance=Employee2_strategy)
def test_employee2_Emp_Email_setter(instance):
...
@given(instance=Employee2_strategy)
def test_employee2_Emp_NIC_setter(instance):
...
@given(instance=Employee2_strategy)
def test_employee2_Emp_Salary_setter(instance):
...
@given(instance=Employee2_strategy)
def test_employee2_Emp_Department_setter(instance):
...
@given(instance=Employee2_strategy)
def test_employee2_Emp_Position_setter(instance):
...
@given(instance=Employee2_strategy)
def test_employee2_Emp_Name_setter(instance):
