...
Actor2_UseCase2: BinaryAssociation = BinaryAssociation(
    name="Actor2_UseCase2",
    ends={
        Property(name="useCase26", type=UseCase2_UseCase, multiplicity=Multiplicity(0, 1)),
        Property(name="actor27", type=Actor2_Actor, multiplicity=Multiplicity(0, 1))
    }
)

# Domain Model
domain_model = DomainModel(
    name="_Ac_4YOFKEeiYbfLD2MSOuQ",
    types={Actor_Actor, UseCase_UseCase, UseCase2_UseCase, UseCase3_UseCase, Actor2_Actor, Class_, Interface_Interface},
    associations={Actor_UseCase, Actor_UseCase3, Actor_UseCase2, Actor2_UseCase2},
    generalizations={},
    metadata=None
)
