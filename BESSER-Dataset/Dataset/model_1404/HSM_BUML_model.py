...
HSM_StateMachine_m_addTransition: Method = Method(name="addTransition", parameters={Parameter(name='HSM_trg', type=StringType), Parameter(name='HSM_src', type=StringType)})
...
domain_model = DomainModel(
    name="HSM",
    types={HSM_StateMachine, HSM_State, HSM_Transition, HSM_CompositeState, State},
    associations={states0, transitions1, container2, machine3, source4, target7, machine10},
