...
User.attributes={User_Password, User_Email, User_Firstname, User_Hiredate, User_Roles___, User_Settings, User_UserID, User_Linkedin_link, User_Position, User_Lastname, User_About, User_DepartmentID, User_Facebook_link, User_Phone, User_Google_plus_link, User_Username, User_Active, User_Dateofbirth, User_TitleID}
...
Project.attributes={Project_PriorityID, Project_Comments___, Project_Description, Project_Attachments___, Project_Subscriptions___, Project_Team___, Project_Created, Project_Activities___, Project_Author, Project_Assignee, Project_ProjectManager, Project_Title, Project_PorjectID, Project_StatusID, Project_Deadline}
...
Activity.attributes={Activity_ActivityID, Activity_Seen, Activity_Project, Activity_ActivitySubType, Activity_ActivityType, Activity_User, Activity_PrevValue, Activity_NewValue}
...
Comment.attributes={Comment_CommentID, Comment_Project, Comment_User, Comment_Content, Comment_Created}
...
Attachment.attributes={Attachment_Name, Attachment_AttachmentID, Attachment_Created, Attachment_Path, Attachment_Project, Attachment_Extension, Attachment_Size, Attachment_User}
...
domain_model = DomainModel(
    name="_1e7ef0b7_9bbf_473c_acfe_9836f88357c2",
