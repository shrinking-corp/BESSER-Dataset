...
class xmof_IntermediateActions_DestroyObjectAction(Action):
    ...
    def __init__(self, destroyOwnedObjects: bool, destroyLinks: bool, xmof_IntermediateActions_DestroyObjectAction: "BasicActions_InputPin" = None):
