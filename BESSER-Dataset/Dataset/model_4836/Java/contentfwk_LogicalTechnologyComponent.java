...
public class contentfwk_LogicalTechnologyComponent extends Element, TechnologyComponent {
    ...
    public contentfwk_LogicalTechnologyComponent(
        ArrayList<contentfwk_PhysicalTechnologyComponent> contentfwk_physicaltechnologycomponents,        ArrayList<contentfwk_PlatformService> contentfwk_platformservices    ) {
