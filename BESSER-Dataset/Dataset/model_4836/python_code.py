...
class contentfwk_Element:
    ...
    def __init__(self, name: str, description: str, category: str, sourceDescr: str, ownerDescr: str, ID: str, contentfwk_Element: "contentfwk_Container" = None, Element: "contentfwk_Element" = None, isDelegatedBy: set["contentfwk_Element"] = None, Element241: "contentfwk_Element" = None, delegates: set["contentfwk_Element"] = None):
        self.name = name
...
class contentfwk_PhysicalTechnologyComponent(Element, TechnologyComponent):
    ...
    def __init__(self, productName: str, moduleName: str, vendor: str, version: str, contentfwk_PhysicalTechnologyComponent: "contentfwk_TechnologyArchitecture" = None, contentfwk_PhysicalTechnologyComponent192: set["contentfwk_PhysicalApplicationComponent"] = None, isRealizedByPhysicalTechnologyComponents: set["contentfwk_LogicalTechnologyComponent"] = None, containsPhysicalTechnologyComponents: set["contentfwk_Location"] = None, contentfwk_PhysicalTechnologyComponent199: "contentfwk_PhysicalTechnologyComponent" = None, contentfwk_PhysicalTechnologyComponent197: "contentfwk_PhysicalTechnologyComponent" = None, contentfwk_PhysicalTechnologyComponent202: "contentfwk_PhysicalTechnologyComponent" = None, contentfwk_PhysicalTechnologyComponent200: set["contentfwk_PhysicalTechnologyComponent"] = None, PhysicalTechnologyComponent: "contentfwk_Location" = None, PhysicalTechnologyComponent303: "contentfwk_LogicalTechnologyComponent" = None, contentfwk_PhysicalTechnologyComponent295: "contentfwk_PhysicalApplicationComponent" = None):
...
class contentfwk_DataEntity(Element):
    ...
    def __init__(self, dataEntityCategory: str, privacyClassification: str, retentionClassification: str, contentfwk_DataEntity: "contentfwk_DataArchitecture" = None, suppliesEntities: set["contentfwk_Actor"] = None, DataEntity: "contentfwk_Actor" = None, DataEntity72: "contentfwk_Actor" = None, consumesEntities: set["contentfwk_Actor"] = None, consumesEntities105: set["contentfwk_Service"] = None, providesEntities: set["contentfwk_Service"] = None, encapsulatesDataEntities: "contentfwk_LogicalDataComponent" = None, operatesOnDataEntities: set["contentfwk_LogicalApplicationComponent"] = None, contentfwk_DataEntity113: "contentfwk_DataEntity" = None, contentfwk_DataEntity111: "contentfwk_DataEntity" = None, contentfwk_DataEntity116: "contentfwk_DataEntity" = None, contentfwk_DataEntity114: set["contentfwk_DataEntity"] = None, contentfwk_DataEntity118: "contentfwk_EObject" = None, DataEntity123: "contentfwk_LogicalApplicationComponent" = None, DataEntity321: "contentfwk_Service" = None, DataEntity260: "contentfwk_LogicalDataComponent" = None, DataEntity319: "contentfwk_Service" = None):
...
class contentfwk_Actor(Element):
    ...
    def __init__(self, FTEs: str, actorGoal: str, actorTasks: str, contentfwk_Actor: "contentfwk_BusinessArchitecture" = None, involvesActors: set["contentfwk_Process"] = None, contentfwk_Actor81: set["contentfwk_Service"] = None, isSuppliedByActors: set["contentfwk_DataEntity"] = None, isResolvedByActors: set["contentfwk_Event"] = None, isConsumedByActors: set["contentfwk_DataEntity"] = None, containsActors: "contentfwk_OrganizationUnit" = None, isGeneratedByActors: set["contentfwk_Event"] = None, supportsActors: set["contentfwk_Function"] = None, containsActors86: "contentfwk_Location" = None, isAssumedByActors: set["contentfwk_Role"] = None, isPerformedByActors: set["contentfwk_Function"] = None, contentfwk_Actor92: "contentfwk_Actor" = None, contentfwk_Actor90: set["contentfwk_Actor"] = None, Actor94: "contentfwk_Role" = None, Actor: "contentfwk_OrganizationUnit" = None, Actor134: "contentfwk_Function" = None, Actor103: "contentfwk_DataEntity" = None, Actor101: "contentfwk_DataEntity" = None, Actor170: "contentfwk_Process" = None, Actor146: "contentfwk_Function" = None, Actor245: "contentfwk_Location" = None, Actor231: "contentfwk_Event" = None, Actor234: "contentfwk_Event" = None, contentfwk_Actor315: "contentfwk_Service" = None):
        self.FTEs = FTEs
...
class contentfwk_OrganizationUnit(Element):
    ...
    def __init__(self, headcount: str, contentfwk_OrganizationUnit: "contentfwk_BusinessArchitecture" = None, OrganizationUnit: "contentfwk_Driver" = None, OrganizationUnit74: "contentfwk_Actor" = None, isOwnedAndGovernedByOrganizationUnits: set["contentfwk_Service"] = None, belongsTo: set["contentfwk_Actor"] = None, OrganizationUnit136: "contentfwk_Function" = None, isOwnedByUnit: set["contentfwk_Function"] = None, involvesOrganizationUnits: set["contentfwk_Process"] = None, motivatesOrganizationUnits: set["contentfwk_Driver"] = None, isProducedByOrganizationUnits: set["contentfwk_Product"] = None, containsOrganizationUnits: "contentfwk_Location" = None, OrganizationUnit161: "contentfwk_Process" = None, OrganizationUnit204: "contentfwk_Product" = None, OrganizationUnit248: "contentfwk_Location" = None, OrganizationUnit331: "contentfwk_Service" = None):
...
class contentfwk_Process(Element, Standard):
    ...
    def __init__(self, processCritiality: str, isAutomated: bool, processVolumetrics: str, contentfwk_Process: "contentfwk_BusinessArchitecture" = None, Process79: "contentfwk_Actor" = None, Process140: "contentfwk_Function" = None, Process: "contentfwk_OrganizationUnit" = None, Process186: "contentfwk_Process" = None, precedesProcesses: set["contentfwk_Process"] = None, contentfwk_Process188: "contentfwk_EObject" = None, isRealizedByProcesses: set["contentfwk_Function"] = None, supportsProcesses: set["contentfwk_Function"] = None, participatesInProcesses: set["contentfwk_OrganizationUnit"] = None, isRealizedByProcesses163: set["contentfwk_Service"] = None, supportsProcesses166: set["contentfwk_Service"] = None, participatesInProcesses169: set["contentfwk_Actor"] = None, ensuresCorrectOperationOfProcesses: set["contentfwk_Control"] = None, isResolvedByProcesses: set["contentfwk_Event"] = None, isGeneratedByProcesses: set["contentfwk_Event"] = None, isProducedByProcesses: set["contentfwk_Product"] = None, Process207: "contentfwk_Product" = None, Process142: "contentfwk_Function" = None, Process226: "contentfwk_Event" = None, Process228: "contentfwk_Event" = None, contentfwk_Process180: "contentfwk_Process" = None, contentfwk_Process178: "contentfwk_Process" = None, Process183: "contentfwk_Process" = None, followsProcesses: set["contentfwk_Process"] = None, Process236: "contentfwk_Control" = None, Process335: "contentfwk_Service" = None, Process337: "contentfwk_Service" = None):
