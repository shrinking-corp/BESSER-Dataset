...
MeshGeometry3D = Class(name="MeshGeometry3D")
...
# MeshGeometry3D class attributes and methods
MeshGeometry3D_publicAttribute: Property = Property(name="publicAttribute", type=Point3D)
MeshGeometry3D_privateAttribute: Property = Property(name="privateAttribute", type=IntegerType)
MeshGeometry3D_protectedAttribute: Property = Property(name="protectedAttribute", type=StringType)
MeshGeometry3D_packageAttribute: Property = Property(name="packageAttribute", type=StringType)
MeshGeometry3D.attributes={MeshGeometry3D_publicAttribute, MeshGeometry3D_privateAttribute, MeshGeometry3D_packageAttribute, MeshGeometry3D_protectedAttribute}

# Point3D class attributes and methods
Point3D_X: Property = Property(name="X", type=IntegerType)
Point3D_Y: Property = Property(name="Y", type=IntegerType)
Point3D_Z: Property = Property(name="Z", type=IntegerType)
Point3D.attributes={Point3D_Z, Point3D_Y, Point3D_X}
...
domain_model = DomainModel(
    name="_31f40df5_7013_44f2_bee5_68c85afc4282",
    types={BankAccount, MeshGeometry3D, Point3D, ClassC, ClassD, ClassE, ClassF, ClassG, ClassJ, ClassH, ClassK, ClassL, ClassM, ClassN, ClassP, InterfaceO_Interface, ClassQ, ClassR, ClassS, ClassT, ClassU, ClassV},
