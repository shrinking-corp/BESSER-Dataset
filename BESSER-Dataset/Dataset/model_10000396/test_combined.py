...
def test_hyp_meshgeometry3d_is_not_abstract():
    assert not inspect.isabstract(MeshGeometry3D)


def test_hyp_meshgeometry3d_constructor_exists():
    assert callable(MeshGeometry3D.__init__)


def test_hyp_meshgeometry3d_constructor_args():
...
def test_hyp_meshgeometry3d_has_privateAttribute():
...
def test_hyp_meshgeometry3d_has_packageAttribute():
...
def test_hyp_meshgeometry3d_has_publicAttribute():
...
def test_hyp_meshgeometry3d_has_protectedAttribute():
...
def test_hyp_point3d_Z_setter(instance):
    original = instance.Z
    instance.Z = original
...
@given(instance=Point3D_strategy)
def test_hyp_point3d_Y_setter(instance):
    original = instance.Y
    instance.Y = original
...
@given(instance=Point3D_strategy)
def test_hyp_point3d_X_setter(instance):
    original = instance.X
    instance.X = original
...
def test_hyp_meshgeometry3d_instantiation(instance):
    assert isinstance(instance, MeshGeometry3D)



@given(instance=MeshGeometry3D_strategy)
def test_hyp_meshgeometry3d_privateAttribute_setter(instance):
    original = instance.privateAttribute
    instance.privateAttribute = original
    assert instance.privateAttribute == original
...
@given(instance=MeshGeometry3D_strategy)
def test_hyp_meshgeometry3d_packageAttribute_setter(instance):
    original = instance.packageAttribute
    instance.packageAttribute = original
    assert instance.packageAttribute == original
...
@given(instance=MeshGeometry3D_strategy)
def test_hyp_meshgeometry3d_publicAttribute_setter(instance):
    original = instance.publicAttribute
    instance.publicAttribute = original
    assert instance.publicAttribute == original
...
@given(instance=MeshGeometry3D_strategy)
def test_hyp_meshgeometry3d_protectedAttribute_setter(instance):
    original = instance.protectedAttribute
    instance.protectedAttribute = original
    assert instance.protectedAttribute == original
...
def test_Point3D_X_value_roundtrip():
    instance = Point3D(X=7, Y=7, Z=7)
    assert instance.X == 7
    instance.X = 13
    assert instance.X == 13


def test_Point3D_Y_value_roundtrip():
    instance = Point3D(X=7, Y=7, Z=7)
    assert instance.Y == 7
    instance.Y = 13
...
def test_Point3D_Z_value_roundtrip():
    instance = Point3D(X=7, Y=7, Z=7)
    assert instance.Z == 7
    instance.Z = 13
...
Point3D_strategy = st.builds(Point3D, X=st.integers(), Y=st.integers(), Z=st.integers())
@given(instance=Point3D_strategy)
@settings(max_examples=25)
