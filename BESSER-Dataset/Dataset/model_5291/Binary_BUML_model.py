...
# Classes
BinaryCalculator_BitSeq = Class(name="BinaryCalculator_BitSeq", is_abstract=True)
BinaryCalculator_Value = Class(name="BinaryCalculator_Value")
BinaryCalculator_L = Class(name="BinaryCalculator_L")
BitSeq = Class(name="BitSeq")
BinaryCalculator_Bit = Class(name="BinaryCalculator_Bit")
BinaryCalculator_Model = Class(name="BinaryCalculator_Model")
BinaryCalculator_BinaryCalculator = Class(name="BinaryCalculator_BinaryCalculator")
...
domain_model = DomainModel(
    ...
    types={BinaryCalculator_BitSeq, BinaryCalculator_Value, BinaryCalculator_L, BitSeq, BinaryCalculator_Bit, BinaryCalculator_Model, BinaryCalculator_BinaryCalculator},
