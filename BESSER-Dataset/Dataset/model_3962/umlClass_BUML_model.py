...
umlClass_NamedElement = Class(name="umlClass_NamedElement", is_abstract=True)
umlClass_Classifier = Class(name="umlClass_Classifier", is_abstract=True)
NamedElement = Class(name="NamedElement")
umlClass_Property = Class(name="umlClass_Property")
umlClass_Package = Class(name="umlClass_Package")
umlClass_Generalization = Class(name="umlClass_Generalization")
umlClass_StructuralFeature = Class(name="umlClass_StructuralFeature", is_abstract=True)
TypedElement = Class(name="TypedElement")
umlClass_Class = Class(name="umlClass_Class")
Classifier = Class(name="Classifier")
umlClass_Operation = Class(name="umlClass_Operation")
umlClass_Association = Class(name="umlClass_Association")
StructuralFeature = Class(name="StructuralFeature")
umlClass_DataType = Class(name="umlClass_DataType")
umlClass_Relationship = Class(name="umlClass_Relationship", is_abstract=True)
umlClass_Element = Class(name="umlClass_Element", is_abstract=True)
Relationship = Class(name="Relationship")
umlClass_TypedElement = Class(name="umlClass_TypedElement", is_abstract=True)
DirectedRelationship = Class(name="DirectedRelationship")
umlClass_DirectedRelationship = Class(name="umlClass_DirectedRelationship", is_abstract=True)
umlClass_OptionalOperation = Class(name="umlClass_OptionalOperation")
Operation = Class(name="Operation")
umlClass_AlternativeOperation = Class(name="umlClass_AlternativeOperation")
...
umlClass_Operation.attributes={umlClass_Operation_isOrdered, umlClass_Operation_upper, umlClass_Operation_isUnique, umlClass_Operation_lower, umlClass_Operation_isQuery}
...
ownedOperation5: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="class_", type=umlClass_Operation, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
ownedAttribute6: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="class_7", type=umlClass_Property, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
domain_model = DomainModel(
    name="umlClass",
    types={Element, umlClass_NamedElement, umlClass_Classifier, NamedElement, umlClass_Property, umlClass_Package, umlClass_Generalization, umlClass_StructuralFeature, TypedElement, umlClass_Class, Classifier, umlClass_Operation, umlClass_Association, StructuralFeature, umlClass_DataType, umlClass_Relationship, umlClass_Element, Relationship, umlClass_TypedElement, DirectedRelationship, umlClass_DirectedRelationship, umlClass_OptionalOperation, Operation, umlClass_AlternativeOperation},
    associations={subsettedProperty28, classifier30, attribute0, redefinedClassifier2, package3, generalization4, ownedOperation5, ownedAttribute6, superClass10, reference11, nestedClassifier13, class_16, datatype17, opposite20, owningAssociation21, association22, redefinedProperty25, owner61, ownedElement63, ownedEnd31, memberEnd33, navigableOwnedEnd35, target38, class_41, datatype43, ownedAttribute46, ownedOperation48, classifiers51, specific53, target55, source57, operations65},
    generalizations={gen_umlClass_NamedElement_Element, gen_umlClass_Association_Classifier, gen_umlClass_Classifier_NamedElement, gen_umlClass_StructuralFeature_TypedElement, gen_umlClass_Class_Classifier, gen_umlClass_Property_StructuralFeature, gen_umlClass_Relationship_Element, gen_umlClass_Association_Relationship, gen_umlClass_Operation_NamedElement, gen_umlClass_DataType_Classifier, gen_umlClass_TypedElement_NamedElement, gen_umlClass_Package_NamedElement, gen_umlClass_Generalization_DirectedRelationship, gen_umlClass_DirectedRelationship_Relationship, gen_umlClass_OptionalOperation_Operation, gen_umlClass_AlternativeOperation_Operation},
    metadata=None
)
