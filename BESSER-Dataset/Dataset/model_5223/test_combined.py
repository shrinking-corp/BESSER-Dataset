...
def test_hyp_faultyrelations_a_is_not_abstract():
    assert not inspect.isabstract(FaultyRelations_A)


def test_hyp_faultyrelations_a_constructor_exists():
    assert callable(FaultyRelations_A.__init__)


def test_hyp_faultyrelations_a_constructor_args():
...
def test_hyp_faultyrelations_c_is_not_abstract():
    assert not inspect.isabstract(FaultyRelations_C)


def test_hyp_faultyrelations_c_constructor_exists():
    assert callable(FaultyRelations_C.__init__)


def test_hyp_faultyrelations_c_constructor_args():
...
def test_hyp_faultyrelations_b_is_not_abstract():
    assert not inspect.isabstract(FaultyRelations_B)


def test_hyp_faultyrelations_b_constructor_exists():
    assert callable(FaultyRelations_B.__init__)


def test_hyp_faultyrelations_b_constructor_args():
...
def test_hyp_faultyrelations_a_v_setter(instance):
    original = instance.v
    instance.v = original
...
@given(instance=FaultyRelations_A_strategy)
def test_hyp_faultyrelations_a_w_setter(instance):
    original = instance.w
    instance.w = original
...
def test_hyp_faultyrelations_c_u_setter(instance):
    original = instance.u
    instance.u = original
...
def test_hyp_faultyrelations_b_y_setter(instance):
    original = instance.y
    instance.y = original
...
@given(instance=FaultyRelations_B_strategy)
def test_hyp_faultyrelations_b_x_setter(instance):
    original = instance.x
    instance.x = original
...
def test_FaultyRelations_A_v_value_roundtrip():
    instance = FaultyRelations_A(v=7, w=True)
    assert instance.v == 7
    instance.v = 13
    assert instance.v == 13


def test_FaultyRelations_A_w_value_roundtrip():
    instance = FaultyRelations_A(v=7, w=True)
...
def test_FaultyRelations_B_x_value_roundtrip():
    instance = FaultyRelations_B(x=7, y=7)
    assert instance.x == 7
    instance.x = 13
    assert instance.x == 13


def test_FaultyRelations_B_y_value_roundtrip():
    instance = FaultyRelations_B(x=7, y=7)
    assert instance.y == 7
    instance.y = 13
...
def test_FaultyRelations_C_u_value_roundtrip():
    instance = FaultyRelations_C(u=7)
    assert instance.u == 7
    instance.u = 13
...
def test_assoc_AB0_link_reassign_clear():
    a = FaultyRelations_B(x=7, y=7)
    b1 = FaultyRelations_A(v=7, w=True)
    b2 = FaultyRelations_A(v=13, w=False)
    _safe_set(a, 'B', b1)
...
def test_assoc_BC3_link_reassign_clear():
    a = FaultyRelations_C(u=7)
    b1 = FaultyRelations_B(x=7, y=7)
    b2 = FaultyRelations_B(x=13, y=13)
    _safe_set(a, 'C4', b1)
...
FaultyRelations_A_strategy = st.builds(FaultyRelations_A, v=st.integers(), w=st.booleans())
@given(instance=FaultyRelations_A_strategy)
...
FaultyRelations_B_strategy = st.builds(FaultyRelations_B, x=st.integers(), y=st.integers())
@given(instance=FaultyRelations_B_strategy)
@settings(max_examples=25)
...
FaultyRelations_C_strategy = st.builds(FaultyRelations_C, u=st.integers())
@given(instance=FaultyRelations_C_strategy)
@settings(max_examples=25)
