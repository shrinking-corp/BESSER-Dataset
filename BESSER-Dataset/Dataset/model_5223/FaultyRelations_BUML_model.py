...
# Classes
FaultyRelations_B = Class(name="FaultyRelations_B")
FaultyRelations_C = Class(name="FaultyRelations_C")
FaultyRelations_A = Class(name="FaultyRelations_A")
...
domain_model = DomainModel(
    ...
    types={FaultyRelations_B, FaultyRelations_C, FaultyRelations_A},
