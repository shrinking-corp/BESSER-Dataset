...
class rdb_Relation:
    ...
    def __init__(self, comment: str, constraint_name: str, source_kind: str, target_kind: str, column_name: str, referenced_column_name: str, bendpoint: str, Relation9: "rdb_Table" = None, Relation11: "rdb_Table" = None, Relation: "rdb_DB" = None, outgoingLinks: "rdb_Table" = None, incomingLinks: "rdb_Table" = None, references: "rdb_DB" = None):
...
class rdb_Table:
    ...
    def __init__(self, name: str, constraints: str, logicalName: str, comment: str, table: set["rdb_Column"] = None, tables: "rdb_DB" = None, target: set["rdb_Relation"] = None, source: set["rdb_Relation"] = None, rdb_Table: "rdb_UserComment" = None, Table: "rdb_DB" = None, rdb_Table23: "rdb_View" = None, Table15: "rdb_Column" = None, Table17: "rdb_Relation" = None, Table19: "rdb_Relation" = None):
        self.name = name
...
class rdb_DB(ERDInfo):
    ...
    def __init__(self, dbType: str, key: str, url: str, id: str, sid: str, comment: str, rdb_DB: "rdb_UserComment" = None, db5: set["rdb_Style"] = None, DB: "rdb_Table" = None, db: set["rdb_Table"] = None, db2: set["rdb_Relation"] = None, DB21: "rdb_Relation" = None, DB26: "rdb_Style" = None):
        self.dbType = dbType
        self.key = key
        self.url = url
        self.id = id
