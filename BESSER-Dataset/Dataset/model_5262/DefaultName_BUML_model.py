...
# Classes
defaultname_HTML = Class(name="defaultname_HTML")
defaultname_HEAD = Class(name="defaultname_HEAD")
defaultname_HTMLElement = Class(name="defaultname_HTMLElement")
HTMLElement = Class(name="HTMLElement")
defaultname_HEADElement = Class(name="defaultname_HEADElement", is_abstract=True)
defaultname_LINK = Class(name="defaultname_LINK")
HEADElement = Class(name="HEADElement")
defaultname_TITLE = Class(name="defaultname_TITLE")
defaultname_BODYElement = Class(name="defaultname_BODYElement", is_abstract=True)
defaultname_BODY = Class(name="defaultname_BODY")
defaultname_H1 = Class(name="defaultname_H1")
BODYElement = Class(name="BODYElement")
defaultname_H2 = Class(name="defaultname_H2")
defaultname_H3 = Class(name="defaultname_H3")
defaultname_H4 = Class(name="defaultname_H4")
defaultname_EM = Class(name="defaultname_EM")
defaultname_STRONG = Class(name="defaultname_STRONG")
defaultname_B = Class(name="defaultname_B")
defaultname_I = Class(name="defaultname_I")
defaultname_TT = Class(name="defaultname_TT")
defaultname_PRE = Class(name="defaultname_PRE")
defaultname_BIG = Class(name="defaultname_BIG")
defaultname_SMALL = Class(name="defaultname_SMALL")
defaultname_SUB = Class(name="defaultname_SUB")
defaultname_SUP = Class(name="defaultname_SUP")
defaultname_STRIKE = Class(name="defaultname_STRIKE")
defaultname_FONT = Class(name="defaultname_FONT")
defaultname_IMG = Class(name="defaultname_IMG")
defaultname_BR = Class(name="defaultname_BR")
defaultname_MAP = Class(name="defaultname_MAP")
defaultname_AREA = Class(name="defaultname_AREA")
defaultname_STYLE = Class(name="defaultname_STYLE")
defaultname_EMBED = Class(name="defaultname_EMBED")
defaultname_NOEMBED = Class(name="defaultname_NOEMBED")
defaultname_SPAN = Class(name="defaultname_SPAN")
defaultname_A = Class(name="defaultname_A")
defaultname_DIV = Class(name="defaultname_DIV")
defaultname_P = Class(name="defaultname_P")
defaultname_TABLEElement = Class(name="defaultname_TABLEElement", is_abstract=True)
defaultname_TR = Class(name="defaultname_TR")
defaultname_TD = Class(name="defaultname_TD")
defaultname_TH = Class(name="defaultname_TH")
TD = Class(name="TD")
defaultname_FORM = Class(name="defaultname_FORM")
defaultname_INPUT = Class(name="defaultname_INPUT")
defaultname_TABLE = Class(name="defaultname_TABLE")
TABLEElement = Class(name="TABLEElement")
defaultname_SELECT = Class(name="defaultname_SELECT")
defaultname_OPTION = Class(name="defaultname_OPTION")
defaultname_ListElement = Class(name="defaultname_ListElement", is_abstract=True)
defaultname_OL = Class(name="defaultname_OL")
ListElement = Class(name="ListElement")
defaultname_UL = Class(name="defaultname_UL")
defaultname_LI = Class(name="defaultname_LI")
defaultname_DL = Class(name="defaultname_DL")
defaultname_DT = Class(name="defaultname_DT")
defaultname_DD = Class(name="defaultname_DD")
defaultname_APPLET = Class(name="defaultname_APPLET")
defaultname_PARAM = Class(name="defaultname_PARAM")
defaultname_OBJECT = Class(name="defaultname_OBJECT")
defaultname_TEXTAREA = Class(name="defaultname_TEXTAREA")
defaultname_FRAME = Class(name="defaultname_FRAME")
defaultname_NOFRAME = Class(name="defaultname_NOFRAME")
defaultname_IFRAME = Class(name="defaultname_IFRAME")
FRAME = Class(name="FRAME")
defaultname_FRAMESET = Class(name="defaultname_FRAMESET")
...
defaultname_LINK.attributes={defaultname_LINK_rel, defaultname_LINK_type, defaultname_LINK_ahref, defaultname_LINK_title}
...
defaultname_BODY.attributes={defaultname_BODY_alink, defaultname_BODY_vlink, defaultname_BODY_bgcolor, defaultname_BODY_text, defaultname_BODY_background, defaultname_BODY_link}
...
defaultname_FONT.attributes={defaultname_FONT_face, defaultname_FONT_color, defaultname_FONT_size}
...
defaultname_IMG.attributes={defaultname_IMG_height, defaultname_IMG_src, defaultname_IMG_usemap, defaultname_IMG_alt, defaultname_IMG_border, defaultname_IMG_hspace, defaultname_IMG_vspace, defaultname_IMG_align, defaultname_IMG_width, defaultname_IMG_ismap}
...
defaultname_AREA.attributes={defaultname_AREA_shape, defaultname_AREA_ahref, defaultname_AREA_coords}
...
defaultname_EMBED.attributes={defaultname_EMBED_border, defaultname_EMBED_src, defaultname_EMBED_align, defaultname_EMBED_hspace, defaultname_EMBED_width, defaultname_EMBED_vspace, defaultname_EMBED_height}
...
defaultname_TD.attributes={defaultname_TD_rowspan, defaultname_TD_width, defaultname_TD_valign, defaultname_TD_align, defaultname_TD_colspan}
...
defaultname_FORM.attributes={defaultname_FORM_method, defaultname_FORM_action}
...
defaultname_INPUT.attributes={defaultname_INPUT_align, defaultname_INPUT_src, defaultname_INPUT_name, defaultname_INPUT_size, defaultname_INPUT_checked, defaultname_INPUT_inputValue, defaultname_INPUT_maxlength, defaultname_INPUT_type}
...
defaultname_TABLE.attributes={defaultname_TABLE_cellpadding, defaultname_TABLE_width, defaultname_TABLE_cellspacing, defaultname_TABLE_border}
...
defaultname_APPLET_class_: Property = Property(name="class_", type=StringType)
...
defaultname_APPLET.attributes={defaultname_APPLET_align, defaultname_APPLET_class_, defaultname_APPLET_src, defaultname_APPLET_height, defaultname_APPLET_width, defaultname_APPLET_applet}
...
defaultname_OBJECT.attributes={defaultname_OBJECT_data, defaultname_OBJECT_id, defaultname_OBJECT_standby, defaultname_OBJECT_type, defaultname_OBJECT_classid}
...
defaultname_TEXTAREA.attributes={defaultname_TEXTAREA_cols, defaultname_TEXTAREA_rows, defaultname_TEXTAREA_name}
...
defaultname_FRAME.attributes={defaultname_FRAME_marginwidth, defaultname_FRAME_src, defaultname_FRAME_noresize, defaultname_FRAME_scrolling, defaultname_FRAME_name, defaultname_FRAME_marginheight}
...
defaultname_FRAMESET.attributes={defaultname_FRAMESET_framespacing, defaultname_FRAMESET_cols, defaultname_FRAMESET_rows, defaultname_FRAMESET_border, defaultname_FRAMESET_frameborder}
...
domain_model = DomainModel(
    name="defaultname",
    types={defaultname_HTML, defaultname_HEAD, defaultname_HTMLElement, HTMLElement, defaultname_HEADElement, defaultname_LINK, HEADElement, defaultname_TITLE, defaultname_BODYElement, defaultname_BODY, defaultname_H1, BODYElement, defaultname_H2, defaultname_H3, defaultname_H4, defaultname_EM, defaultname_STRONG, defaultname_B, defaultname_I, defaultname_TT, defaultname_PRE, defaultname_BIG, defaultname_SMALL, defaultname_SUB, defaultname_SUP, defaultname_STRIKE, defaultname_FONT, defaultname_IMG, defaultname_BR, defaultname_MAP, defaultname_AREA, defaultname_STYLE, defaultname_EMBED, defaultname_NOEMBED, defaultname_SPAN, defaultname_A, defaultname_DIV, defaultname_P, defaultname_TABLEElement, defaultname_TR, defaultname_TD, defaultname_TH, TD, defaultname_FORM, defaultname_INPUT, defaultname_TABLE, TABLEElement, defaultname_SELECT, defaultname_OPTION, defaultname_ListElement, defaultname_OL, ListElement, defaultname_UL, defaultname_LI, defaultname_DL, defaultname_DT, defaultname_DD, defaultname_APPLET, defaultname_PARAM, defaultname_OBJECT, defaultname_TEXTAREA, defaultname_FRAME, defaultname_NOFRAME, defaultname_IFRAME, FRAME, defaultname_FRAMESET},
    associations={head0, body1, children4, parent6, headElements8, html9, head11, bodyElements13, body17, html14, trs19, table20, tds21, tr22},
    generalizations={gen_defaultname_HEAD_HTMLElement, gen_defaultname_HEADElement_HTMLElement, gen_defaultname_LINK_HEADElement, gen_defaultname_TITLE_HEADElement, gen_defaultname_BODY_HTMLElement, gen_defaultname_BODYElement_HTMLElement, gen_defaultname_H1_BODYElement, gen_defaultname_H2_BODYElement, gen_defaultname_H3_BODYElement, gen_defaultname_H4_BODYElement, gen_defaultname_EM_BODYElement, gen_defaultname_STRONG_BODYElement, gen_defaultname_B_BODYElement, gen_defaultname_I_BODYElement, gen_defaultname_TT_BODYElement, gen_defaultname_PRE_BODYElement, gen_defaultname_BIG_BODYElement, gen_defaultname_SMALL_BODYElement, gen_defaultname_SUB_BODYElement, gen_defaultname_SUP_BODYElement, gen_defaultname_STRIKE_BODYElement, gen_defaultname_FONT_BODYElement, gen_defaultname_IMG_BODYElement, gen_defaultname_BR_BODYElement, gen_defaultname_MAP_BODYElement, gen_defaultname_AREA_BODYElement, gen_defaultname_STYLE_BODYElement, gen_defaultname_EMBED_BODYElement, gen_defaultname_NOEMBED_BODYElement, gen_defaultname_SPAN_BODYElement, gen_defaultname_A_BODYElement, gen_defaultname_DIV_BODYElement, gen_defaultname_P_BODYElement, gen_defaultname_TABLEElement_BODYElement, gen_defaultname_TR_TABLEElement, gen_defaultname_TD_TABLEElement, gen_defaultname_TH_TD, gen_defaultname_TABLE_TABLEElement, gen_defaultname_OL_ListElement, gen_defaultname_UL_ListElement, gen_defaultname_LI_ListElement, gen_defaultname_IFRAME_FRAME},
    metadata=None
)
