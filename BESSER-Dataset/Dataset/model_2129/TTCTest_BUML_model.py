...
# Classes
tTCTest_Classes = Class(name="tTCTest_Classes")
tTCTest_Java_Method = Class(name="tTCTest_Java_Method")
tTCTest_Refactoring_Instance = Class(name="tTCTest_Refactoring_Instance")
tTCTest_Test_File = Class(name="tTCTest_Test_File")
tTCTest_Test_Case = Class(name="tTCTest_Test_Case")
tTCTest_Java_Class = Class(name="tTCTest_Java_Class")
tTCTest_Test_Step_Element = Class(name="tTCTest_Test_Step_Element")
tTCTest_Test_Step = Class(name="tTCTest_Test_Step")
Test_Step_Element = Class(name="Test_Step_Element")
Class_Element = Class(name="Class_Element")
tTCTest_Methods = Class(name="tTCTest_Methods")
tTCTest_Java_Field = Class(name="tTCTest_Java_Field")
tTCTest_Fields = Class(name="tTCTest_Fields")
tTCTest_Test_Flow = Class(name="tTCTest_Test_Flow")
Refactoring = Class(name="Refactoring")
tTCTest_Refactoring = Class(name="tTCTest_Refactoring")
tTCTest_Pull_Up_Refactoring = Class(name="tTCTest_Pull_Up_Refactoring")
Refactoring_Instance = Class(name="Refactoring_Instance")
tTCTest_Create_Superclass_Refactoring = Class(name="tTCTest_Create_Superclass_Refactoring")
tTCTest_Contains = Class(name="tTCTest_Contains")
Containment = Class(name="Containment")
tTCTest_Contains_Not = Class(name="tTCTest_Contains_Not")
tTCTest_Implementation = Class(name="tTCTest_Implementation")
tTCTest_Assertion = Class(name="tTCTest_Assertion")
tTCTest_Assert_False = Class(name="tTCTest_Assert_False")
Assertion = Class(name="Assertion")
tTCTest_Assert_True = Class(name="tTCTest_Assert_True")
tTCTest_Condition = Class(name="tTCTest_Condition")
tTCTest_Warning = Class(name="tTCTest_Warning")
tTCTest_Expect_True = Class(name="tTCTest_Expect_True")
Condition = Class(name="Condition")
tTCTest_Expect_False = Class(name="tTCTest_Expect_False")
tTCTest_Compile = Class(name="tTCTest_Compile")
tTCTest_Synchronize = Class(name="tTCTest_Synchronize")
tTCTest_No_Refactoring = Class(name="tTCTest_No_Refactoring")
tTCTest_Propose_Refactoring = Class(name="tTCTest_Propose_Refactoring")
tTCTest_Propose_Pullup_Method_Refactoring = Class(name="tTCTest_Propose_Pullup_Method_Refactoring")
Propose_Refactoring = Class(name="Propose_Refactoring")
tTCTest_Propose_Create_Superclass_Refactoring = Class(name="tTCTest_Propose_Create_Superclass_Refactoring")
tTCTest_Containment = Class(name="tTCTest_Containment")
tTCTest_Class_Element = Class(name="tTCTest_Class_Element")
tTCTest_Implements = Class(name="tTCTest_Implements")
Implementation = Class(name="Implementation")
tTCTest_Implements_Not = Class(name="tTCTest_Implements_Not")
...
tTCTest_Test_Case.attributes={tTCTest_Test_Case_description, tTCTest_Test_Case_java_program, tTCTest_Test_Case_name}
...
tTCTest_Java_Class.attributes={tTCTest_Java_Class_package, tTCTest_Java_Class_class_name, tTCTest_Java_Class_name}
...
class_50: BinaryAssociation = BinaryAssociation(
    name="class_50",
    ends={
...
domain_model = DomainModel(
    name="tTCTest",
    types={tTCTest_Classes, tTCTest_Java_Method, tTCTest_Refactoring_Instance, tTCTest_Test_File, tTCTest_Test_Case, tTCTest_Java_Class, tTCTest_Test_Step_Element, tTCTest_Test_Step, Test_Step_Element, Class_Element, tTCTest_Methods, tTCTest_Java_Field, tTCTest_Fields, tTCTest_Test_Flow, Refactoring, tTCTest_Refactoring, tTCTest_Pull_Up_Refactoring, Refactoring_Instance, tTCTest_Create_Superclass_Refactoring, tTCTest_Contains, Containment, tTCTest_Contains_Not, tTCTest_Implementation, tTCTest_Assertion, tTCTest_Assert_False, Assertion, tTCTest_Assert_True, tTCTest_Condition, tTCTest_Warning, tTCTest_Expect_True, Condition, tTCTest_Expect_False, tTCTest_Compile, tTCTest_Synchronize, tTCTest_No_Refactoring, tTCTest_Propose_Refactoring, tTCTest_Propose_Pullup_Method_Refactoring, Propose_Refactoring, tTCTest_Propose_Create_Superclass_Refactoring, tTCTest_Containment, tTCTest_Class_Element, tTCTest_Implements, Implementation, tTCTest_Implements_Not},
    associations={java_classes3, java_method5, refactorings7, test_cases0, java_class1, child28, target30, step33, classes9, params12, methods15, type17, fields19, test_flow21, parent23, method25, child54, parent56, elements35, input37, refactoring38, true_steps40, warning43, false_steps45, refactoring48, class_50, contains52},
    generalizations={gen_tTCTest_Test_Step_Test_Step_Element, gen_tTCTest_Java_Method_Class_Element, gen_tTCTest_Java_Field_Class_Element, gen_tTCTest_Refactoring_Instance_Refactoring, gen_tTCTest_Pull_Up_Refactoring_Refactoring_Instance, gen_tTCTest_Create_Superclass_Refactoring_Refactoring_Instance, gen_tTCTest_Contains_Containment, gen_tTCTest_Contains_Not_Containment, gen_tTCTest_Implementation_Test_Step_Element, gen_tTCTest_Assertion_Test_Step_Element, gen_tTCTest_Assert_False_Assertion, gen_tTCTest_Assert_True_Assertion, gen_tTCTest_Condition_Test_Step_Element, gen_tTCTest_Expect_True_Condition, gen_tTCTest_Expect_False_Condition, gen_tTCTest_Compile_Test_Step_Element, gen_tTCTest_Synchronize_Test_Step_Element, gen_tTCTest_No_Refactoring_Refactoring, gen_tTCTest_Propose_Pullup_Method_Refactoring_Propose_Refactoring, gen_tTCTest_Propose_Create_Superclass_Refactoring_Propose_Refactoring, gen_tTCTest_Containment_Test_Step_Element, gen_tTCTest_Implements_Implementation, gen_tTCTest_Implements_Not_Implementation},
    metadata=None
)
