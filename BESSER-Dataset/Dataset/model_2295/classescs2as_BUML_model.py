...
# Classes
classescstraces_PackageCS2Package = Class(name="classescstraces_PackageCS2Package")
classescstraces_PackageCS = Class(name="classescstraces_PackageCS")
classescstraces_Package = Class(name="classescstraces_Package")
classescstraces_ClassCS2Class = Class(name="classescstraces_ClassCS2Class")
classescstraces_ClassCS = Class(name="classescstraces_ClassCS")
classescstraces_Class = Class(name="classescstraces_Class")
classescstraces_RootCS2Root = Class(name="classescstraces_RootCS2Root")
classescstraces_RootCS = Class(name="classescstraces_RootCS")
classescstraces_Root = Class(name="classescstraces_Root")
...
domain_model = DomainModel(
    ...
    types={classescstraces_PackageCS2Package, classescstraces_PackageCS, classescstraces_Package, classescstraces_ClassCS2Class, classescstraces_ClassCS, classescstraces_Class, classescstraces_RootCS2Root, classescstraces_RootCS, classescstraces_Root},
    associations={packageCS0, package1, classCS3, class_4, rootCS6, root7},
    generalizations={},
    metadata=None
)
