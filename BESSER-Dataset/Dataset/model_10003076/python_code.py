...
class LineItem:
    ...
    def __init__(self, price: float, quantity: int, order15: "Order" = None, sc11: "ShoppingCart" = None, product13: "Product" = None):
        self.price = price
...
class Order:
    ...
    def __init__(self, number: int, ordered: date, shipped: bool, shipTo: str, total: float, status: OrderStatus, account17: "Account" = None, payment19: "Payment" = None, items14: set["LineItem"] = None):
        self.number = number
