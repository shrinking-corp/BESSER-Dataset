...
# Classes
apromore_CanonicalProcess = Class(name="apromore_CanonicalProcess")
apromore_Net = Class(name="apromore_Net")
apromore_Node = Class(name="apromore_Node", is_abstract=True)
apromore_Edge = Class(name="apromore_Edge")
apromore_Work = Class(name="apromore_Work")
Node = Class(name="Node")
apromore_Event = Class(name="apromore_Event")
Work = Class(name="Work")
apromore_Message = Class(name="apromore_Message")
Event = Class(name="Event")
apromore_Time = Class(name="apromore_Time")
apromore_Task = Class(name="apromore_Task")
apromore_Routing = Class(name="apromore_Routing")
apromore_Split = Class(name="apromore_Split")
Routing = Class(name="Routing")
apromore_ORSplit = Class(name="apromore_ORSplit")
Split = Class(name="Split")
apromore_XORSplit = Class(name="apromore_XORSplit")
apromore_ANDSplit = Class(name="apromore_ANDSplit")
apromore_State = Class(name="apromore_State")
apromore_Join = Class(name="apromore_Join")
apromore_ORJoin = Class(name="apromore_ORJoin")
Join = Class(name="Join")
apromore_XORJoin = Class(name="apromore_XORJoin")
apromore_ANDJoin = Class(name="apromore_ANDJoin")
...
apromore_CanonicalProcess.attributes={apromore_CanonicalProcess_author, apromore_CanonicalProcess_version, apromore_CanonicalProcess_uri}
...
apromore_Node.attributes={apromore_Node_ident, apromore_Node_name, apromore_Node_configurable}
...
apromore_Edge.attributes={apromore_Edge_ident, apromore_Edge_condition, apromore_Edge_default}
...
domain_model = DomainModel(
    name="apromore",
    types={apromore_CanonicalProcess, apromore_Net, apromore_Node, apromore_Edge, apromore_Work, Node, apromore_Event, Work, apromore_Message, Event, apromore_Time, apromore_Task, apromore_Routing, apromore_Split, Routing, apromore_ORSplit, Split, apromore_XORSplit, apromore_ANDSplit, apromore_State, apromore_Join, apromore_ORJoin, Join, apromore_XORJoin, apromore_ANDJoin},
    associations={nets0, root1, nodes4, edges6, source8, target11, subnet14},
    generalizations={gen_apromore_Work_Node, gen_apromore_Event_Work, gen_apromore_Message_Event, gen_apromore_Time_Event, gen_apromore_Task_Work, gen_apromore_Routing_Node, gen_apromore_Split_Routing, gen_apromore_ORSplit_Split, gen_apromore_XORSplit_Split, gen_apromore_ANDSplit_Split, gen_apromore_State_Routing, gen_apromore_Join_Routing, gen_apromore_ORJoin_Join, gen_apromore_XORJoin_Join, gen_apromore_ANDJoin_Join},
    metadata=None
)
