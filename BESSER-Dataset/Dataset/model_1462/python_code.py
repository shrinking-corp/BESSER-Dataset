...
class apromore_Node(ABC):
    ...
    def __init__(self, configurable: bool, ident: int, name: str, apromore_Node: "apromore_Net" = None, apromore_Node10: "apromore_Edge" = None, apromore_Node13: "apromore_Edge" = None):
