...
PostalAddress = Class(name="PostalAddress")
...
ClassA.attributes={ClassA_protectedAttribute, ClassA_privateAttribute, ClassA_packageAttribute, ClassA_publicAttribute}
...
# PostalAddress class attributes and methods
...
ClassD_ClassE: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="classD1", type=PostalAddress, multiplicity=Multiplicity(0, 1))
    }
)
...
domain_model = DomainModel(
    name="_8ca907c0_a33d_4271_abf3_179ae296410b",
    types={BankAccount, ClassA, ClassB, ClassC, PostalAddress, ClassE, ClassF, ClassG, ClassJ, ClassH, ClassK, ClassL, ClassM, ClassN, ClassP, InterfaceO_Interface, ClassQ, ClassR, ClassS, ClassT, ClassU, ClassV},
