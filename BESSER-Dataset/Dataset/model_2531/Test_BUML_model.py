...
test_C = Class(name="test_C")
test_E = Class(name="test_E")
test_I = Class(name="test_I")
test_D = Class(name="test_D")
test_F = Class(name="test_F")
test_H = Class(name="test_H")
test_G = Class(name="test_G")
...
domain_model = DomainModel(
    name="test",
    types={test_ClassA, test_ClassB, test_C, test_E, test_I, test_D, test_F, test_H, test_G},
    associations={b0, c1, e3, i5, f7, h8, e10, d11, g12},
    generalizations={},
    metadata=None
)
