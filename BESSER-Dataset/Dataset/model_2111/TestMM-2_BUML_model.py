...
# Classes
TestMM2_Test = Class(name="TestMM2_Test")
TestMM2_Metadata = Class(name="TestMM2_Metadata")
...
TestMM2_Metadata.attributes={TestMM2_Metadata_user, TestMM2_Metadata_taglist, TestMM2_Metadata_date, TestMM2_Metadata_webpage}
...
domain_model = DomainModel(
    name="TestMM2",
    types={TestMM2_Test, TestMM2_Metadata},
