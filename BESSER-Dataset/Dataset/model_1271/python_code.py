...
class family_ecore_Person:
    ...
    def __init__(self, age: int, name: str, family_ecore_Person4: "family_ecore_Person" = None, family_ecore_Person2: set["family_ecore_Person"] = None, family_ecore_Person7: "family_ecore_Person" = None, family_ecore_Person5: set["family_ecore_Person"] = None, family_ecore_Person9: "family_ecore_Family" = None, family_ecore_Person: "family_ecore_Person" = None, family_ecore_Person0: "family_ecore_Person" = None):
        self.age = age
        self.name = name
