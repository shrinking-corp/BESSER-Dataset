...
class trace_TraceLink:
    ...
    def __init__(self, overridden: bool, TraceLink18: "trace_SourceElement" = None, sourceOf: set["trace_SourceElement"] = None, targetOf: set["trace_TargetElement"] = None, links: "trace_TracedRule" = None, TraceLink: "trace_TracedRule" = None, TraceLink26: "trace_TargetElement" = None):
    ...
    def getSourceElement(self, trace_name, trace_create) :
...
class trace_SourceElementList:
    ...
    def __init__(self, SourceElementList: "trace_TraceLinkSet" = None, SourceElementList10: "trace_TracedRule" = None, uniqueSourceElementLists: "trace_TracedRule" = None, trace_SourceElementList: set["trace_SourceElement"] = None, defaultSourceElementLists: "trace_TraceLinkSet" = None):
...
class trace_SourceElement(TraceElement):
    ...
    def __init__(self, mapsToSelf: bool, sourceElements: "trace_TraceLink" = None, SourceElement: "trace_TraceLinkSet" = None, SourceElement12: "trace_TraceLink" = None, mapsTo: set["trace_TargetElement"] = None, SourceElement7: "trace_TracedRule" = None, defaultSourceElements: "trace_TraceLinkSet" = None, uniqueSourceElements: "trace_TracedRule" = None, SourceElement29: "trace_TargetElement" = None, trace_SourceElement: "trace_SourceElementList" = None):
...
class trace_TracedRule:
    ...
    def __init__(self, rule1: str, TracedRule: "trace_TraceLinkSet" = None, TracedRule15: "trace_TraceLink" = None, rule: set["trace_TraceLink"] = None, rules: "trace_TraceLinkSet" = None, uniqueFor: set["trace_SourceElement"] = None, uniqueFor9: set["trace_SourceElementList"] = None, TracedRule34: "trace_SourceElementList" = None, TracedRule24: "trace_SourceElement" = None):
        self.rule1 = rule1
