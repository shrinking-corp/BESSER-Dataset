...
trace_TraceLinkSet.methods={trace_TraceLinkSet_m_getDefaultSourceElements, trace_TraceLinkSet_m_getDefaultSourceElement, trace_TraceLinkSet_m_clear, trace_TraceLinkSet_m_getLinksByRule}
...
domain_model = DomainModel(
    name="trace",
    types={trace_TraceLinkSet, trace_TracedRule, trace_SourceElement, trace_SourceElementList, trace_TargetElement, trace_TraceElement, trace_EObject, TraceElement, trace_TraceLink},
    associations={rules0, defaultSourceElements1, sourceElements11, targetElements13, rule14, object16, sourceOf17, defaultSourceElementLists2, mapsTo19, links4, linkSet5, uniqueSourceElements6, uniqueSourceElementLists8, uniqueFor33, defaultFor21, uniqueFor23, targetOf25, mapsTo27, sourceElements30, defaultFor31},
