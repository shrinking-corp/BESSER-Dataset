...
class fUML_Kernel_Classifier(Kernel_Namespace, Kernel_Type):
    ...
    def __init__(self, abstract: bool, finalSpecialization: bool, fUML_Kernel_Classifier54: set["Kernel_Classifier"] = None, specific: set["Kernel_Generalization"] = None, featuringClassifier: set["Kernel_Feature"] = None, fUML_Kernel_Classifier: set["Kernel_NamedElement"] = None, fUML_Kernel_Classifier51: set["Kernel_Property"] = None, Kernel_Type: "fUML_Kernel_TypedElement" = None, Kernel_Type90: "fUML_Kernel_Operation" = None, Type: "fUML_Kernel_Package" = None, Kernel_Type69: "fUML_Kernel_Association" = None, Namespace30: "fUML_Kernel_ElementImport" = None, Namespace: "fUML_Kernel_NamedElement" = None, Namespace33: "fUML_Kernel_PackageImport" = None):
...
class fUML_CompleteStructuredActivities_StructuredActivityNode(Action):
    ...
    def __init__(self, mustIsolate: bool, inStructuredNode: set["IntermediateActivities_ActivityNode"] = None, inStructuredNode180: set["IntermediateActivities_ActivityEdge"] = None, fUML_CompleteStructuredActivities_StructuredActivityNode185: set["BasicActions_InputPin"] = None, fUML_CompleteStructuredActivities_StructuredActivityNode: set["BasicActions_OutputPin"] = None):
...
class fUML_Kernel_BehavioralFeature(Feature):
    ...
    def __init__(self, concurrency: str, abstract: bool, fUML_Kernel_BehavioralFeature: set["Kernel_Parameter"] = None, specification: set["BasicBehaviors_Behavior"] = None):
...
class fUML_Kernel_MultiplicityElement(Element):
    ...
    def __init__(self, ordered: bool, unique: bool, lower: int, upper: int, fUML_Kernel_MultiplicityElement: "Kernel_ValueSpecification" = None, fUML_Kernel_MultiplicityElement80: "Kernel_ValueSpecification" = None):
        self.ordered = ordered
        self.unique = unique
        self.lower = lower
        self.upper = upper
...
class fUML_Kernel_Property(StructuralFeature):
    ...
    def __init__(self, derived: bool, derivedUnion: bool, aggregation: str, composite: bool, ownedEnd: "Kernel_Association" = None, memberEnd: "Kernel_Association" = None, ownedAttribute: "Kernel_DataType" = None, ownedAttribute65: "Kernel_Class" = None, fUML_Kernel_Property: "Kernel_Property" = None):
        self.derived = derived
