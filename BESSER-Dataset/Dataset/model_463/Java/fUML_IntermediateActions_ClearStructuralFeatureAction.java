...
public class fUML_IntermediateActions_ClearStructuralFeatureAction extends StructuralFeatureAction {
    ...
    public fUML_IntermediateActions_ClearStructuralFeatureAction(
    ) {
        super(
        );
    }
