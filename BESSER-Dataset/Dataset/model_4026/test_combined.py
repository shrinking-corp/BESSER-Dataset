...
def test_assoc_generalizationSet19_link_reassign_clear():
    ...
    if hasattr(b1, 'uml2CD_Generalization20'):
        assert _is_linked(b1, 'uml2CD_Generalization20', a)
    _safe_set(a, 'uml2CD_GeneralizationSet', b2)
    assert _is_linked(a, 'uml2CD_GeneralizationSet', b2)
    if hasattr(b1, 'uml2CD_Generalization20'):
        assert not _is_linked(b1, 'uml2CD_Generalization20', a)
    if hasattr(b2, 'uml2CD_Generalization20'):
        assert _is_linked(b2, 'uml2CD_Generalization20', a)
    _safe_set(a, 'uml2CD_GeneralizationSet', None)
    assert not _is_linked(a, 'uml2CD_GeneralizationSet', b2)
    if hasattr(b2, 'uml2CD_Generalization20'):
        assert not _is_linked(b2, 'uml2CD_Generalization20', a)
...
def test_assoc_memberEnd30_link_reassign_clear():
    ...
    _safe_set(a, 'uml2CD_Property32', b1)
    assert _is_linked(a, 'uml2CD_Property32', b1)
    if hasattr(b1, 'uml2CD_Association31'):
        assert _is_linked(b1, 'uml2CD_Association31', a)
    _safe_set(a, 'uml2CD_Property32', b2)
    assert _is_linked(a, 'uml2CD_Property32', b2)
    if hasattr(b1, 'uml2CD_Association31'):
        assert not _is_linked(b1, 'uml2CD_Association31', a)
    if hasattr(b2, 'uml2CD_Association31'):
        assert _is_linked(b2, 'uml2CD_Association31', a)
    _safe_set(a, 'uml2CD_Property32', None)
    assert not _is_linked(a, 'uml2CD_Property32', b2)
    if hasattr(b2, 'uml2CD_Association31'):
        assert not _is_linked(b2, 'uml2CD_Association31', a)


def test_assoc_ownedAttribute28_link_reassign_clear():
    a = uml2CD_Property(aggregation="sample_text", isDerived="sample_text", lower="sample_text", upper="sample_text")
    b1 = uml2CD_Class(active="sample_text")
    b2 = uml2CD_Class(active="sample_text_2")
    _safe_set(a, 'uml2CD_Property', b1)
    assert _is_linked(a, 'uml2CD_Property', b1)
    if hasattr(b1, 'uml2CD_Class29'):
        assert _is_linked(b1, 'uml2CD_Class29', a)
    _safe_set(a, 'uml2CD_Property', b2)
    assert _is_linked(a, 'uml2CD_Property', b2)
    if hasattr(b1, 'uml2CD_Class29'):
        assert not _is_linked(b1, 'uml2CD_Class29', a)
    if hasattr(b2, 'uml2CD_Class29'):
        assert _is_linked(b2, 'uml2CD_Class29', a)
    _safe_set(a, 'uml2CD_Property', None)
    assert not _is_linked(a, 'uml2CD_Property', b2)
    if hasattr(b2, 'uml2CD_Class29'):
        assert not _is_linked(b2, 'uml2CD_Class29', a)
...
def test_assoc_ownedEnd33_link_reassign_clear():
    ...
    b1 = uml2CD_Association(isDerived="sample_text")
    b2 = uml2CD_Association(isDerived="sample_text_2")
    _safe_set(a, 'uml2CD_Property35', b1)
    assert _is_linked(a, 'uml2CD_Property35', b1)
    if hasattr(b1, 'uml2CD_Association34'):
        assert _is_linked(b1, 'uml2CD_Association34', a)
    _safe_set(a, 'uml2CD_Property35', b2)
    assert _is_linked(a, 'uml2CD_Property35', b2)
    if hasattr(b1, 'uml2CD_Association34'):
        assert not _is_linked(b1, 'uml2CD_Association34', a)
    if hasattr(b2, 'uml2CD_Association34'):
        assert _is_linked(b2, 'uml2CD_Association34', a)
    _safe_set(a, 'uml2CD_Property35', None)
    assert not _is_linked(a, 'uml2CD_Property35', b2)
    if hasattr(b2, 'uml2CD_Association34'):
        assert not _is_linked(b2, 'uml2CD_Association34', a)
...
def test_assoc_ownedOperation25_link_reassign_clear():
    ...
    b1 = uml2CD_Class(active="sample_text")
    b2 = uml2CD_Class(active="sample_text_2")
    _safe_set(a, 'uml2CD_Operation27', b1)
    assert _is_linked(a, 'uml2CD_Operation27', b1)
    if hasattr(b1, 'uml2CD_Class26'):
        assert _is_linked(b1, 'uml2CD_Class26', a)
    _safe_set(a, 'uml2CD_Operation27', b2)
    assert _is_linked(a, 'uml2CD_Operation27', b2)
    if hasattr(b1, 'uml2CD_Class26'):
        assert not _is_linked(b1, 'uml2CD_Class26', a)
    if hasattr(b2, 'uml2CD_Class26'):
        assert _is_linked(b2, 'uml2CD_Class26', a)
    _safe_set(a, 'uml2CD_Operation27', None)
    assert not _is_linked(a, 'uml2CD_Operation27', b2)
    if hasattr(b2, 'uml2CD_Class26'):
        assert not _is_linked(b2, 'uml2CD_Class26', a)
...
def test_assoc_redefinedOperation24_link_reassign_clear():
    a = uml2CD_Operation(body="sample_text", isQuery="sample_text", visibility="sample_text")
    ...
    if hasattr(b1, 'uml2CD_Operation23'):
        assert _is_linked(b1, 'uml2CD_Operation23', a)
    _safe_set(a, 'uml2CD_Operation', b2)
    assert _is_linked(a, 'uml2CD_Operation', b2)
    if hasattr(b1, 'uml2CD_Operation23'):
        assert not _is_linked(b1, 'uml2CD_Operation23', a)
    if hasattr(b2, 'uml2CD_Operation23'):
        assert _is_linked(b2, 'uml2CD_Operation23', a)
    _safe_set(a, 'uml2CD_Operation', None)
    assert not _is_linked(a, 'uml2CD_Operation', b2)
    if hasattr(b2, 'uml2CD_Operation23'):
        assert not _is_linked(b2, 'uml2CD_Operation23', a)
...
def test_assoc_type21_link_reassign_clear():
    ...
    if hasattr(b1, 'uml2CD_DataType22'):
        assert _is_linked(b1, 'uml2CD_DataType22', a)
    _safe_set(a, 'uml2CD_Parameter', b2)
    assert _is_linked(a, 'uml2CD_Parameter', b2)
    if hasattr(b1, 'uml2CD_DataType22'):
        assert not _is_linked(b1, 'uml2CD_DataType22', a)
    if hasattr(b2, 'uml2CD_DataType22'):
        assert _is_linked(b2, 'uml2CD_DataType22', a)
    _safe_set(a, 'uml2CD_Parameter', None)
    assert not _is_linked(a, 'uml2CD_Parameter', b2)
    if hasattr(b2, 'uml2CD_DataType22'):
        assert not _is_linked(b2, 'uml2CD_DataType22', a)
