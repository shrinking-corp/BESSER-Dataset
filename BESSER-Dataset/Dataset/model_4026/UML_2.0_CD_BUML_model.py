...
uml2CD_Property.attributes={uml2CD_Property_upper, uml2CD_Property_lower, uml2CD_Property_isDerived, uml2CD_Property_aggregation}
...
domain_model = DomainModel(
    name="uml2CD",
    types={uml2CD_Comment, uml2CD_NamedElement, uml2CD_Constraint, uml2CD_DataType, uml2CD_Association, uml2CD_Generalization, uml2CD_Package, NamedElement, uml2CD_Class, uml2CD_Property, uml2CD_GeneralizationSet, uml2CD_Parameter, uml2CD_Operation, uml2CD_PrimitiveType, DataType, uml2CD_Enumeration, uml2CD_EnumerationLiteral, uml2CD_UMLModel},
    associations={comments0, packagedType7, packagedAssoc9, packagedGeneralizations11, general13, constraints1, nestedPackage4, packagedClass5, redefinedOperation24, ownedOperation25, ownedAttribute28, specific16, generalizationSet19, type21, memberEnd30, ownedEnd33, ownedLiteral36, packages37},
    generalizations={gen_uml2CD_Package_NamedElement, gen_uml2CD_Class_NamedElement, gen_uml2CD_DataType_NamedElement, gen_uml2CD_Property_NamedElement, gen_uml2CD_Association_NamedElement, gen_uml2CD_Operation_NamedElement, gen_uml2CD_PrimitiveType_DataType, gen_uml2CD_Enumeration_DataType, gen_uml2CD_EnumerationLiteral_NamedElement},
    metadata=None
)
