...
petrinet_Noeud = Class(name="petrinet_Noeud")
...
petrinet_Arc.attributes={petrinet_Arc_arcType, petrinet_Arc_name, petrinet_Arc_weight}
...
petrinet_Transition.attributes={petrinet_Transition_maxTime, petrinet_Transition_minTime}
...
domain_model = DomainModel(
    name="petrinet",
    types={petrinet_Arc, petrinet_PetriNet, petrinet_Noeud, petrinet_Place, petrinet_Transition, Noeud, ArcKindType},
    associations={arcs1, noeuds0, source3, target6},
    generalizations={gen_petrinet_Place_Noeud, gen_petrinet_Transition_Noeud},
    metadata=None
)
