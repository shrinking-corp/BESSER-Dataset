...
domain_model = DomainModel(
    name="model",
    types={model_NamedElement, model_OzobotProgram, NamedElement, model_Block, model_Command, model_Transition, model_Move, Command, model_Ozobot, model_Light, model_Rotate, model_Wait, model_Repeat, Color, Direction, Velocity},
    associations={block0, current1, outgoing3, incoming4, programs8, commands10, transitions13, block6, source15, target16},
    generalizations={gen_model_OzobotProgram_NamedElement, gen_model_Command_NamedElement, gen_model_Move_Command, gen_model_Ozobot_NamedElement, gen_model_Block_NamedElement, gen_model_Light_Command, gen_model_Rotate_Command, gen_model_Wait_Command, gen_model_Repeat_Command, gen_model_Transition_NamedElement},
    metadata=None
)
