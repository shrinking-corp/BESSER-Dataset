...
uml_EModelElement = Class(name="uml_EModelElement", is_abstract=True)
...
domain_model = DomainModel(
    name="uml",
    types={uml_Feature, RedefinableElement, uml_NamedElement, Element, uml_PackageableElement, NamedElement, ParameterableElement, uml_Dependency, PackageableElement, DirectedRelationship, uml_Property, StructuralFeature, ConnectableElement, DeploymentTarget, uml_Generalization, uml_Classifier, uml_Class, EncapsulatedClassifier, BehavioredClassifier, uml_Operation, uml_Parameter, MultiplicityElement, uml_Model, Package, BehavioralFeature, TemplateableElement, uml_Package, Namespace, Type, uml_TypedElement, uml_BehavioralFeature, Feature, uml_Behavior, Class_, uml_EncapsulatedClassifier, StructuredClassifier, uml_Type, uml_StructuredClassifier, Classifier, uml_Element, EModelElement, uml_EModelElement, uml_StructuralFeature, uml_Namespace, uml_RedefinableElement, uml_ParameterableElement, uml_TemplateableElement, uml_BehavioredClassifier, uml_DirectedRelationship, Relationship, uml_Relationship, uml_ConnectableElement, TypedElement, uml_MultiplicityElement, uml_DeploymentTarget, VisibilityKind},
    associations={general2, supplier0, specific1, ownedOperation3, nestedClassifier4, packagedElement7, generalization8, method9, ownedParameter10, type12, ownedAttribute13},
    generalizations={gen_uml_Feature_RedefinableElement, gen_uml_NamedElement_Element, gen_uml_PackageableElement_NamedElement, gen_uml_PackageableElement_ParameterableElement, gen_uml_Dependency_PackageableElement, gen_uml_Dependency_DirectedRelationship, gen_uml_Property_StructuralFeature, gen_uml_Property_ConnectableElement, gen_uml_Property_DeploymentTarget, gen_uml_Generalization_DirectedRelationship, gen_uml_Classifier_TemplateableElement, gen_uml_Class_EncapsulatedClassifier, gen_uml_Class_BehavioredClassifier, gen_uml_Parameter_ConnectableElement, gen_uml_Parameter_MultiplicityElement, gen_uml_Model_Package, gen_uml_Operation_BehavioralFeature, gen_uml_Operation_ParameterableElement, gen_uml_Operation_TemplateableElement, gen_uml_Package_Namespace, gen_uml_Package_PackageableElement, gen_uml_Package_TemplateableElement, gen_uml_Classifier_Namespace, gen_uml_Classifier_RedefinableElement, gen_uml_Classifier_Type, gen_uml_TypedElement_NamedElement, gen_uml_BehavioralFeature_Namespace, gen_uml_BehavioralFeature_Feature, gen_uml_Behavior_Class, gen_uml_EncapsulatedClassifier_StructuredClassifier, gen_uml_Type_PackageableElement, gen_uml_StructuredClassifier_Classifier, gen_uml_Element_EModelElement, gen_uml_StructuralFeature_Feature, gen_uml_Namespace_NamedElement, gen_uml_RedefinableElement_NamedElement, gen_uml_ParameterableElement_Element, gen_uml_TemplateableElement_Element, gen_uml_BehavioredClassifier_Classifier, gen_uml_DirectedRelationship_Relationship, gen_uml_Relationship_Element, gen_uml_ConnectableElement_TypedElement, gen_uml_ConnectableElement_ParameterableElement, gen_uml_MultiplicityElement_Element, gen_uml_StructuralFeature_TypedElement, gen_uml_StructuralFeature_MultiplicityElement, gen_uml_DeploymentTarget_NamedElement},
    metadata=None
)
