...
dst21: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="in_22", type=PetriNet_Place, multiplicity=Multiplicity(1, 1))
    }
)
...
domain_model = DomainModel(
    name="PetriNet",
    types={PetriNet_Arc, Arc, PetriNet_Place, PetriNet_Net, PetriNet_PTArc, PetriNet_TPArc, PetriNet_Transition},
    associations={in_5, out8, place11, transition12, dst14, src16, src18, net0, out1, in_2, net3, dst21},
