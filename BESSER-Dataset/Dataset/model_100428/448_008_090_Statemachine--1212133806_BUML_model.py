...
statemachine_Declaration = Class(name="statemachine_Declaration", is_abstract=True)
statemachine_StateMachineVariable = Class(name="statemachine_StateMachineVariable")
...
statemachine_Statement = Class(name="statemachine_Statement")
statemachine_Action = Class(name="statemachine_Action")
statemachine_NormalState = Class(name="statemachine_NormalState")
...
statemachine_StateMachineVariable.attributes={statemachine_StateMachineVariable_name, statemachine_StateMachineVariable_type}
...
statemachine_Transition.attributes={statemachine_Transition_guardLabel, statemachine_Transition_sourceLabel, statemachine_Transition_label, statemachine_Transition_targetLabel, statemachine_Transition_actionLabel}
...
statemachine_State.attributes={statemachine_State_label, statemachine_State_id}
statemachine_State.methods={statemachine_State_m_printReachable}

# statemachine_Expression class attributes and methods

# statemachine_Statement class attributes and methods
...
statemachine_Action.attributes={statemachine_Action_actionLabel}
...
guardExpression7: BinaryAssociation = BinaryAssociation(
    name="guardExpression7",
    ends={
        Property(name="statemachine_Expression", type=statemachine_Transition, multiplicity=Multiplicity(1, 1)),
        Property(name="statemachine_Transition8", type=statemachine_Expression, multiplicity=Multiplicity(0, 1))
    }
)
actionStatement9: BinaryAssociation = BinaryAssociation(
    name="actionStatement9",
    ends={
        Property(name="statemachine_Statement", type=statemachine_Transition, multiplicity=Multiplicity(1, 1)),
        Property(name="statemachine_Transition10", type=statemachine_Statement, multiplicity=Multiplicity(0, 1))
    }
)
reachable15: BinaryAssociation = BinaryAssociation(
    name="reachable15",
    ends={
        Property(name="statemachine_State16", type=statemachine_State, multiplicity=Multiplicity(1, 1)),
        Property(name="statemachine_State14", type=statemachine_State, multiplicity=Multiplicity(0, 9999))
    }
)
actionStatement17: BinaryAssociation = BinaryAssociation(
    name="actionStatement17",
    ends={
        Property(name="statemachine_Statement18", type=statemachine_Action, multiplicity=Multiplicity(1, 1)),
        Property(name="statemachine_Action", type=statemachine_Statement, multiplicity=Multiplicity(0, 1))
    }
)
successors12: BinaryAssociation = BinaryAssociation(
    name="successors12",
    ends={
        Property(name="statemachine_State13", type=statemachine_State, multiplicity=Multiplicity(1, 1)),
        Property(name="statemachine_State11", type=statemachine_State, multiplicity=Multiplicity(0, 9999))
    }
)
entry19: BinaryAssociation = BinaryAssociation(
    name="entry19",
    ends={
        Property(name="statemachine_Action20", type=statemachine_NormalState, multiplicity=Multiplicity(1, 1)),
...
domain_model = DomainModel(
    name="statemachine",
    types={statemachine_StateMachine, statemachine_Declaration, statemachine_StateMachineVariable, statemachine_Transition, Declaration, statemachine_State, statemachine_Expression, statemachine_Statement, statemachine_Action, statemachine_NormalState, State, statemachine_InitialState, statemachine_FinalState},
    associations={declarations0, machineVariables1, source3, target4, guardExpression7, actionStatement9, reachable15, actionStatement17, successors12, entry19},
