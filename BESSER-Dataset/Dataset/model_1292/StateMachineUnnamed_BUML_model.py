...
# Classes
StateMachineUnnamed_StateMachine = Class(name="StateMachineUnnamed_StateMachine")
StateMachineUnnamed_StateVertex = Class(name="StateMachineUnnamed_StateVertex", is_abstract=True)
StateMachineUnnamed_Transition = Class(name="StateMachineUnnamed_Transition")
StateMachineUnnamed_Event = Class(name="StateMachineUnnamed_Event")
StateMachineUnnamed_InitialState = Class(name="StateMachineUnnamed_InitialState")
StateVertex = Class(name="StateVertex")
StateMachineUnnamed_SimpleState = Class(name="StateMachineUnnamed_SimpleState")
StateMachineUnnamed_FinalState = Class(name="StateMachineUnnamed_FinalState")
...
domain_model = DomainModel(
    ...
    associations={targets7, source9, target10, states0, transitions1, outgoing3, incoming4, trigger12},
