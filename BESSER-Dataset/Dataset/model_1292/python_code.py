...
class StateMachineUnnamed_Transition:
    ...
    def __init__(self, name: str, outgoing: "StateMachineUnnamed_StateVertex" = None, incoming: "StateMachineUnnamed_StateVertex" = None, StateMachineUnnamed_Transition: "StateMachineUnnamed_StateMachine" = None, Transition: "StateMachineUnnamed_StateVertex" = None, Transition5: "StateMachineUnnamed_StateVertex" = None, StateMachineUnnamed_Transition13: "StateMachineUnnamed_Event" = None):
        self.name = name
...
class StateMachineUnnamed_StateVertex(ABC):
    ...
    def __init__(self, name: str, StateMachineUnnamed_StateVertex8: "StateMachineUnnamed_StateVertex" = None, StateMachineUnnamed_StateVertex6: set["StateMachineUnnamed_StateVertex"] = None, StateVertex: "StateMachineUnnamed_Transition" = None, StateVertex11: "StateMachineUnnamed_Transition" = None, StateMachineUnnamed_StateVertex: "StateMachineUnnamed_StateMachine" = None, source: set["StateMachineUnnamed_Transition"] = None, target: set["StateMachineUnnamed_Transition"] = None):
        self.name = name
