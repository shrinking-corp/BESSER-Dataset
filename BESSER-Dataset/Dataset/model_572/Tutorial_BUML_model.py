...
tutorial_Book_m_add: Method = Method(name="add", parameters={Parameter(name='tutorial_b', type=StringType)}, type=StringType)
tutorial_Book.attributes={tutorial_Book_copies, tutorial_Book_name}
tutorial_Book.methods={tutorial_Book_m_isAvailable, tutorial_Book_m_add}
...
domain_model = DomainModel(
    ...
    associations={books0, loans1, members2, library4, loans5, library7, book9, member12},
    generalizations={},
    metadata=None
)
