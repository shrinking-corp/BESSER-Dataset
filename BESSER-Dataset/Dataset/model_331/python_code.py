...
class library_Member:
    ...
    def __init__(self, name: str, id: int, library_Member: "library_Library" = None, library_Member8: set["library_Book"] = None):
        self.name = name
        self.id = id
...
class library_Book:
    ...
    def __init__(self, title: str, pages: int, library_Book: "library_Library" = None, books: "library_Writer" = None, Book: "library_Writer" = None, library_Book9: "library_Member" = None):
        self.title = title
        self.pages = pages
