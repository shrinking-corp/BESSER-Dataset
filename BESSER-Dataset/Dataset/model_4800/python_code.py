...
class testModel_ContainedElement:
    ...
    def __init__(self, name: str, byteArray: str, byteObject: str, char: str, Character: str, date: date, DiagnosticChain: str, double: float, DoubleObj: str, float: float, elementType: str, testModel_ContainedElement: "testModel_Kategorie" = None, testModel_ContainedElement5: set["testModel_referenziertesElement"] = None, testModel_ContainedElement7: set["testModel_upperBound"] = None):
        self.name = name
