...
# Classes
testModel_Kategorie = Class(name="testModel_Kategorie")
testModel_ContainedElement = Class(name="testModel_ContainedElement")
testModel_referenziertesElement = Class(name="testModel_referenziertesElement")
testModel_upperBound = Class(name="testModel_upperBound")
Element = Class(name="Element")
testModel_multiRefElement = Class(name="testModel_multiRefElement")
testModel_Element = Class(name="testModel_Element", is_abstract=True)
...
testModel_Kategorie.attributes={testModel_Kategorie_byte, testModel_Kategorie_name, testModel_Kategorie_bigdeci, testModel_Kategorie_bool, testModel_Kategorie_bigint, testModel_Kategorie_Boolean}
...
testModel_ContainedElement.attributes={testModel_ContainedElement_date, testModel_ContainedElement_Character, testModel_ContainedElement_char, testModel_ContainedElement_DoubleObj, testModel_ContainedElement_float, testModel_ContainedElement_double, testModel_ContainedElement_elementType, testModel_ContainedElement_byteArray, testModel_ContainedElement_DiagnosticChain, testModel_ContainedElement_byteObject, testModel_ContainedElement_name}
...
testModel_referenziertesElement.attributes={testModel_referenziertesElement_int, testModel_referenziertesElement_LongObj, testModel_referenziertesElement_notChangeable, testModel_referenziertesElement_name, testModel_referenziertesElement_Integer, testModel_referenziertesElement_short, testModel_referenziertesElement_ShortObj, testModel_referenziertesElement_long, testModel_referenziertesElement_Float}
...
domain_model = DomainModel(
    name="testModel",
    types={testModel_Kategorie, testModel_ContainedElement, testModel_referenziertesElement, testModel_upperBound, Element, testModel_multiRefElement, testModel_Element, ElementType},
    associations={subKategorie1, contains2, ref4, upperBound6, multiRef8},
