...
class emap_Book:
    ...
    def __init__(self, title: str, emap_Book: set["emap_StringToWriterMapEntry"] = None, emap_Book4: set["emap_WriterToStringMapEntry"] = None, emap_Book6: set["emap_DateToCategoryMapEntry"] = None, emap_Book2: set["emap_StringToStringMapEntry"] = None):
        self.title = title
