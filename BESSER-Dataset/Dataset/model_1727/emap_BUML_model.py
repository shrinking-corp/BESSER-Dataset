...
# Classes
emap_Book = Class(name="emap_Book")
emap_StringToWriterMapEntry = Class(name="emap_StringToWriterMapEntry")
emap_WriterToStringMapEntry = Class(name="emap_WriterToStringMapEntry")
emap_DateToCategoryMapEntry = Class(name="emap_DateToCategoryMapEntry")
emap_StringToStringMapEntry = Class(name="emap_StringToStringMapEntry")
emap_Writer = Class(name="emap_Writer")
...
domain_model = DomainModel(
    name="emap",
    types={emap_Book, emap_StringToWriterMapEntry, emap_WriterToStringMapEntry, emap_DateToCategoryMapEntry, emap_StringToStringMapEntry, emap_Writer, Category},
    associations={writers0, cityByWriter3, categoryByDate5, keyWords1, key9, value7},
    generalizations={},
    metadata=None
)
