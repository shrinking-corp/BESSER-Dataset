...
class backtrackingContentAssistTest_Pre:
    ...
    def __init__(self, constraintName: str, backtrackingContentAssistTest_Pre49: "backtrackingContentAssistTest_Expression" = None, backtrackingContentAssistTest_Pre: "backtrackingContentAssistTest_OperationContextDecl" = None):
...
class backtrackingContentAssistTest_Expression(NavigatingExp, OclMessageArg):
...
class backtrackingContentAssistTest_Parameter:
    ...
    def __init__(self, name: str, backtrackingContentAssistTest_Parameter: "backtrackingContentAssistTest_Definition" = None, backtrackingContentAssistTest_Parameter43: "backtrackingContentAssistTest_TypeExp" = None, backtrackingContentAssistTest_Parameter26: "backtrackingContentAssistTest_OperationContextDecl" = None):
        self.name = name
...
class backtrackingContentAssistTest_Definition:
    ...
    def __init__(self, static: bool, constraintName: str, constrainedName: str, backtrackingContentAssistTest_Definition: "backtrackingContentAssistTest_ClassifierContextDecl" = None, backtrackingContentAssistTest_Definition10: set["backtrackingContentAssistTest_Parameter"] = None, backtrackingContentAssistTest_Definition12: "backtrackingContentAssistTest_TypeExp" = None, backtrackingContentAssistTest_Definition14: "backtrackingContentAssistTest_Expression" = None):
        self.static = static
        self.constraintName = constraintName
...
class backtrackingContentAssistTest_iteratorAccumulator:
    ...
    def __init__(self, name: str, backtrackingContentAssistTest_iteratorAccumulator94: "backtrackingContentAssistTest_Expression" = None, backtrackingContentAssistTest_iteratorAccumulator: "backtrackingContentAssistTest_TypeExp" = None):
        self.name = name
...
class backtrackingContentAssistTest_iteratorVariable:
    ...
    def __init__(self, name: str, backtrackingContentAssistTest_iteratorVariable99: "backtrackingContentAssistTest_RoundBracketExp" = None, backtrackingContentAssistTest_iteratorVariable: "backtrackingContentAssistTest_TypeExp" = None):
        self.name = name
...
class backtrackingContentAssistTest_CollectionType(TypeExp, CollectionLiteralExp):
