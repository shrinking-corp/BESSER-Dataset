...
# Classes
libraryinteractionmodel_BookShort = Class(name="libraryinteractionmodel_BookShort")
libraryinteractionmodel_Author = Class(name="libraryinteractionmodel_Author")
libraryinteractionmodel_Library = Class(name="libraryinteractionmodel_Library")
libraryinteractionmodel_Books = Class(name="libraryinteractionmodel_Books")
libraryinteractionmodel_Authors = Class(name="libraryinteractionmodel_Authors")
libraryinteractionmodel_Clients = Class(name="libraryinteractionmodel_Clients")
libraryinteractionmodel_Book = Class(name="libraryinteractionmodel_Book")
libraryinteractionmodel_AuthorShort = Class(name="libraryinteractionmodel_AuthorShort")
libraryinteractionmodel_Reservation = Class(name="libraryinteractionmodel_Reservation")
libraryinteractionmodel_Reservations = Class(name="libraryinteractionmodel_Reservations")
libraryinteractionmodel_Client = Class(name="libraryinteractionmodel_Client")
...
libraryinteractionmodel_Author.attributes={libraryinteractionmodel_Author_name, libraryinteractionmodel_Author_fullBio, libraryinteractionmodel_Author_nationality}
...
libraryinteractionmodel_Book.attributes={libraryinteractionmodel_Book_isbn, libraryinteractionmodel_Book_title}
...
libraryinteractionmodel_AuthorShort.attributes={libraryinteractionmodel_AuthorShort_nationality, libraryinteractionmodel_AuthorShort_name}
...
libraryinteractionmodel_Reservation_from_: Property = Property(name="from_", type=DateType)
libraryinteractionmodel_Reservation.attributes={libraryinteractionmodel_Reservation_from_, libraryinteractionmodel_Reservation_to}
...
libraryinteractionmodel_Client.attributes={libraryinteractionmodel_Client_name, libraryinteractionmodel_Client_email}
...
domain_model = DomainModel(
    ...
    types={libraryinteractionmodel_BookShort, libraryinteractionmodel_Author, libraryinteractionmodel_Library, libraryinteractionmodel_Books, libraryinteractionmodel_Authors, libraryinteractionmodel_Clients, libraryinteractionmodel_Book, libraryinteractionmodel_AuthorShort, libraryinteractionmodel_Reservation, libraryinteractionmodel_Reservations, libraryinteractionmodel_Client},
    associations={items10, items12, self15, availableBooks0, authors1, clients3, author5, currentReservation6, reservations8, self18, items19, client22, book25, books28, self31, items34},
    generalizations={},
    metadata=None
)
