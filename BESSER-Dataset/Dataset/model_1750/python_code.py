...
class libraryinteractionmodel_AuthorShort:
    ...
    def __init__(self, nationality: str, name: str, libraryinteractionmodel_AuthorShort14: "libraryinteractionmodel_Authors" = None, libraryinteractionmodel_AuthorShort16: "libraryinteractionmodel_Author" = None, libraryinteractionmodel_AuthorShort: "libraryinteractionmodel_Book" = None):
