...
class sistedesMM_InProceedings(Publication):
    ...
    def __init__(self, title: str, bookTitle: str, year: int, fromPage: str, toPage: str, month: str, sistedesMM_InProceedings: "sistedesMM_Publisher" = None, sistedesMM_InProceedings6: set["sistedesMM_Editor"] = None):
        self.title = title
...
class sistedesMM_Person:
    ...
    def __init__(self, name: str, surname: str, email: str, nationality: str, sistedesMM_Person: set["sistedesMM_University"] = None, authors: set["sistedesMM_Publication"] = None, Person: "sistedesMM_Publication" = None):
        self.name = name
