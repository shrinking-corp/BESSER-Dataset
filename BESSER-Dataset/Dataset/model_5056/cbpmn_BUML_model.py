...
# Classes
cbpmn_ProcessModel = Class(name="cbpmn_ProcessModel")
cbpmn_Branch = Class(name="cbpmn_Branch")
cbpmn_OCLConstraint = Class(name="cbpmn_OCLConstraint")
cbpmn_Activity = Class(name="cbpmn_Activity")
FlowNode = Class(name="FlowNode")
cbpmn_DataObjectReference = Class(name="cbpmn_DataObjectReference")
cbpmn_DecisionGateway = Class(name="cbpmn_DecisionGateway")
SplitGateway = Class(name="SplitGateway")
cbpmn_Event = Class(name="cbpmn_Event", is_abstract=True)
cbpmn_FlowNode = Class(name="cbpmn_FlowNode", is_abstract=True)
cbpmn_SplitGateway = Class(name="cbpmn_SplitGateway", is_abstract=True)
cbpmn_EClass = Class(name="cbpmn_EClass")
cbpmn_ProcessInstance = Class(name="cbpmn_ProcessInstance")
cbpmn_FlowNodeInstance = Class(name="cbpmn_FlowNodeInstance")
cbpmn_EObject = Class(name="cbpmn_EObject")
cbpmn_ParallelGateway = Class(name="cbpmn_ParallelGateway")
cbpmn_StartEvent = Class(name="cbpmn_StartEvent")
Event = Class(name="Event")
cbpmn_EndEvent = Class(name="cbpmn_EndEvent")
cbpmn_IntermediateEvent = Class(name="cbpmn_IntermediateEvent")
cbpmn_DataObject = Class(name="cbpmn_DataObject")
...
cbpmn_ProcessModel_m_iterator: Method = Method(name="iterator", parameters={Parameter(name='cbpmn_iterator', type=StringType)}, type=StringType)
cbpmn_ProcessModel_m_iterator: Method = Method(name="iterator", parameters={Parameter(name='cbpmn_iterator', type=StringType), Parameter(name='cbpmn_start', type=StringType)}, type=StringType)
...
cbpmn_ProcessModel.methods={cbpmn_ProcessModel_m_getRandomStartEvent, cbpmn_ProcessModel_m_iterator, cbpmn_ProcessModel_m_iterator}
...
cbpmn_DecisionGateway_m_addBranchWithCondition: Method = Method(name="addBranchWithCondition", parameters={Parameter(name='cbpmn_default', type=StringType), Parameter(name='cbpmn_branch', type=StringType), Parameter(name='cbpmn_condition', type=StringType)})
...
cbpmn_DecisionGateway.methods={cbpmn_DecisionGateway_m_getRandomBranch, cbpmn_DecisionGateway_m_addBranchWithCondition, cbpmn_DecisionGateway_m_getDefaultBranch}
...
domain_model = DomainModel(
    name="cbpmn",
    types={cbpmn_ProcessModel, cbpmn_Branch, cbpmn_OCLConstraint, cbpmn_Activity, FlowNode, cbpmn_DataObjectReference, cbpmn_DecisionGateway, SplitGateway, cbpmn_Event, cbpmn_FlowNode, cbpmn_SplitGateway, cbpmn_EClass, cbpmn_ProcessInstance, cbpmn_FlowNodeInstance, cbpmn_EObject, cbpmn_ParallelGateway, cbpmn_StartEvent, Event, cbpmn_EndEvent, cbpmn_IntermediateEvent, cbpmn_DataObject, EObject, GatewayType, DataObjectType, ActivityType, EventType, DecisionType, FlowNodeInstanceStatus},
    associations={mainBranch0, processInvariants1, preConditions3, postConditions5, outputs8, branch17, next19, previous22, inputs24, branch26, invariabilityClauses10, nodes13, entryConditions14, gateway16, branches30, dataObjectClass32, processModel34, executedNodes36, dataObjects37, nodeDef39, trigger28, type48, inputs41, outputs44, processInstance47},
    generalizations={gen_cbpmn_Activity_FlowNode, gen_cbpmn_DecisionGateway_SplitGateway, gen_cbpmn_Event_FlowNode, gen_cbpmn_ParallelGateway_SplitGateway, gen_cbpmn_SplitGateway_FlowNode, gen_cbpmn_StartEvent_Event, gen_cbpmn_EndEvent_Event, gen_cbpmn_IntermediateEvent_Event, gen_cbpmn_DataObject_EObject},
    metadata=None
)
