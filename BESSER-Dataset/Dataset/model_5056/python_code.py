...
class cbpmn_FlowNodeInstance:
    ...
    def __init__(self, status: str, cbpmn_FlowNodeInstance42: set["cbpmn_EObject"] = None, cbpmn_FlowNodeInstance45: set["cbpmn_EObject"] = None, executedNodes: "cbpmn_ProcessInstance" = None, FlowNodeInstance: "cbpmn_ProcessInstance" = None, cbpmn_FlowNodeInstance: "cbpmn_FlowNode" = None):
        self.status = status
...
class cbpmn_ProcessInstance:
    ...
    def __init__(self, id: str, ProcessInstance: "cbpmn_FlowNodeInstance" = None, cbpmn_ProcessInstance: "cbpmn_ProcessModel" = None, processInstance: set["cbpmn_FlowNodeInstance"] = None, cbpmn_ProcessInstance38: set["cbpmn_EObject"] = None):
        self.id = id
...
class cbpmn_FlowNode(ABC):
    ...
    def __init__(self, name: str, nodes: "cbpmn_Branch" = None, FlowNode20: "cbpmn_FlowNode" = None, previous: "cbpmn_FlowNode" = None, FlowNode23: "cbpmn_FlowNode" = None, next: "cbpmn_FlowNode" = None, cbpmn_FlowNode: set["cbpmn_DataObjectReference"] = None, FlowNode: "cbpmn_Branch" = None, cbpmn_FlowNode40: "cbpmn_FlowNodeInstance" = None):
        self.name = name
        self.nodes = nodes
...
class cbpmn_DecisionGateway(SplitGateway):
    ...
    def addBranchWithCondition(self, cbpmn_default, cbpmn_condition, cbpmn_branch):
...
class cbpmn_OCLConstraint:
    ...
    def __init__(self, constraintName: str, constraintStr: str, cbpmn_OCLConstraint: "cbpmn_ProcessModel" = None, cbpmn_OCLConstraint4: "cbpmn_Activity" = None, cbpmn_OCLConstraint7: "cbpmn_Activity" = None, entryConditions: "cbpmn_Branch" = None, cbpmn_OCLConstraint12: "cbpmn_Activity" = None, OCLConstraint: "cbpmn_Branch" = None, cbpmn_OCLConstraint29: "cbpmn_Event" = None):
...
class cbpmn_Branch:
    ...
    def __init__(self, default: bool, cbpmn_Branch: "cbpmn_ProcessModel" = None, Branch: "cbpmn_FlowNode" = None, Branch27: "cbpmn_OCLConstraint" = None, branch: set["cbpmn_FlowNode"] = None, branch15: set["cbpmn_OCLConstraint"] = None, branches: "cbpmn_SplitGateway" = None, Branch31: "cbpmn_SplitGateway" = None):
...
class cbpmn_ProcessModel:
    ...
    def getRandomStartEvent(self) :
        # TODO: Implement getRandomStartEvent method
        pass

    def iterator(self, cbpmn_iterator, cbpmn_start) :
