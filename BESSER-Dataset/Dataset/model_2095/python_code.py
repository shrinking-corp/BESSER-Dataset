...
class safetyDSL_ClassTestCaseRelation:
    ...
    def __init__(self, testCases: str, safetyDSL_ClassTestCaseRelation: "safetyDSL_ImplementationDetail" = None, safetyDSL_ClassTestCaseRelation72: "safetyDSL_ClassDef" = None):
...
class safetyDSL_SafetyTactic:
    ...
    def __init__(self, name: str, type: str, safetyDSL_SafetyTactic37: "safetyDSL_SafetyCritical" = None, safetyDSL_SafetyTactic46: "safetyDSL_Monitor" = None, safetyDSL_SafetyTactic: "safetyDSL_SafetyTacticViewpoint" = None, safetyDSL_SafetyTactic26: set["safetyDSL_Fault"] = None):
        self.name = name
        self.type = type
...
class safetyDSL_ArchitecturalElement:
    ...
    def __init__(self, name: str, safetyDSL_ArchitecturalElement: "safetyDSL_SafetyCriticalViewpoint" = None, safetyDSL_ArchitecturalElement68: "safetyDSL_ModuleClassRelation" = None, safetyDSL_ArchitecturalElement48: "safetyDSL_ArchElementToArchElement" = None, safetyDSL_ArchitecturalElement51: "safetyDSL_ArchElementToArchElement" = None):
        self.name = name
