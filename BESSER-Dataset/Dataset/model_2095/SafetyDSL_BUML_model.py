...
# Classes
safetyDSL_SafetyFramework = Class(name="safetyDSL_SafetyFramework")
safetyDSL_SafetyViewpoint = Class(name="safetyDSL_SafetyViewpoint")
safetyDSL_ImplementationDetail = Class(name="safetyDSL_ImplementationDetail")
safetyDSL_HazardViewpoint = Class(name="safetyDSL_HazardViewpoint")
SafetyViewpoint = Class(name="SafetyViewpoint")
safetyDSL_HazardElement = Class(name="safetyDSL_HazardElement")
safetyDSL_HazardRelation = Class(name="safetyDSL_HazardRelation")
safetyDSL_Hazard = Class(name="safetyDSL_Hazard")
HazardElement = Class(name="HazardElement")
safetyDSL_SafetyRequirement = Class(name="safetyDSL_SafetyRequirement")
safetyDSL_Consequence = Class(name="safetyDSL_Consequence")
safetyDSL_Fault = Class(name="safetyDSL_Fault")
safetyDSL_FaultTree = Class(name="safetyDSL_FaultTree")
safetyDSL_FaultTreeNode = Class(name="safetyDSL_FaultTreeNode")
safetyDSL_FaultDetection = Class(name="safetyDSL_FaultDetection")
safetyDSL_FaultContainment = Class(name="safetyDSL_FaultContainment")
safetyDSL_SafetyCriticalViewpoint = Class(name="safetyDSL_SafetyCriticalViewpoint")
safetyDSL_ArchitecturalElement = Class(name="safetyDSL_ArchitecturalElement")
safetyDSL_SafetyCriticalRelation = Class(name="safetyDSL_SafetyCriticalRelation")
safetyDSL_SafetyCritical = Class(name="safetyDSL_SafetyCritical")
ArchitecturalElement = Class(name="ArchitecturalElement")
safetyDSL_CriticalityLevel = Class(name="safetyDSL_CriticalityLevel")
safetyDSL_State = Class(name="safetyDSL_State")
safetyDSL_NonSafetyCritical = Class(name="safetyDSL_NonSafetyCritical")
safetyDSL_Monitor = Class(name="safetyDSL_Monitor")
safetyDSL_DerivedFrom = Class(name="safetyDSL_DerivedFrom")
HazardRelation = Class(name="HazardRelation")
safetyDSL_Causes = Class(name="safetyDSL_Causes")
safetyDSL_CausedBy = Class(name="safetyDSL_CausedBy")
safetyDSL_SafetyTacticViewpoint = Class(name="safetyDSL_SafetyTacticViewpoint")
safetyDSL_SafetyTactic = Class(name="safetyDSL_SafetyTactic")
safetyDSL_FaultAvoidance = Class(name="safetyDSL_FaultAvoidance")
SafetyTactic = Class(name="SafetyTactic")
safetyDSL_ModuleClassRelation = Class(name="safetyDSL_ModuleClassRelation")
safetyDSL_ClassTestCaseRelation = Class(name="safetyDSL_ClassTestCaseRelation")
safetyDSL_ClassDef = Class(name="safetyDSL_ClassDef")
safetyDSL_ORNodeExpression = Class(name="safetyDSL_ORNodeExpression")
FaultTreeNode = Class(name="FaultTreeNode")
safetyDSL_ANDNodeExpression = Class(name="safetyDSL_ANDNodeExpression")
safetyDSL_LevelA = Class(name="safetyDSL_LevelA")
CriticalityLevel = Class(name="CriticalityLevel")
safetyDSL_LevelB = Class(name="safetyDSL_LevelB")
safetyDSL_LevelC = Class(name="safetyDSL_LevelC")
safetyDSL_LevelD = Class(name="safetyDSL_LevelD")
safetyDSL_SafeState = Class(name="safetyDSL_SafeState")
State = Class(name="State")
safetyDSL_Reads = Class(name="safetyDSL_Reads")
ArchElementToArchElement = Class(name="ArchElementToArchElement")
safetyDSL_Writes = Class(name="safetyDSL_Writes")
safetyDSL_Commands = Class(name="safetyDSL_Commands")
safetyDSL_Stops = Class(name="safetyDSL_Stops")
MonitorToArchitecturalElement = Class(name="MonitorToArchitecturalElement")
safetyDSL_Starts = Class(name="safetyDSL_Starts")
safetyDSL_Inits = Class(name="safetyDSL_Inits")
safetyDSL_ArchElementToArchElement = Class(name="safetyDSL_ArchElementToArchElement")
SafetyCriticalRelation = Class(name="SafetyCriticalRelation")
safetyDSL_MonitorToArchitecturalElement = Class(name="safetyDSL_MonitorToArchitecturalElement")
safetyDSL_ReportsFault = Class(name="safetyDSL_ReportsFault")
safetyDSL_Restarts = Class(name="safetyDSL_Restarts")
safetyDSL_Monitors = Class(name="safetyDSL_Monitors")
...
domain_model = DomainModel(
    name="safetyDSL",
    types={safetyDSL_SafetyFramework, safetyDSL_SafetyViewpoint, safetyDSL_ImplementationDetail, safetyDSL_HazardViewpoint, SafetyViewpoint, safetyDSL_HazardElement, safetyDSL_HazardRelation, safetyDSL_Hazard, HazardElement, safetyDSL_SafetyRequirement, safetyDSL_Consequence, safetyDSL_Fault, safetyDSL_FaultTree, safetyDSL_FaultTreeNode, safetyDSL_FaultDetection, safetyDSL_FaultContainment, safetyDSL_SafetyCriticalViewpoint, safetyDSL_ArchitecturalElement, safetyDSL_SafetyCriticalRelation, safetyDSL_SafetyCritical, ArchitecturalElement, safetyDSL_CriticalityLevel, safetyDSL_State, safetyDSL_NonSafetyCritical, safetyDSL_Monitor, safetyDSL_DerivedFrom, HazardRelation, safetyDSL_Causes, safetyDSL_CausedBy, safetyDSL_SafetyTacticViewpoint, safetyDSL_SafetyTactic, safetyDSL_FaultAvoidance, SafetyTactic, safetyDSL_ModuleClassRelation, safetyDSL_ClassTestCaseRelation, safetyDSL_ClassDef, safetyDSL_ORNodeExpression, FaultTreeNode, safetyDSL_ANDNodeExpression, safetyDSL_LevelA, CriticalityLevel, safetyDSL_LevelB, safetyDSL_LevelC, safetyDSL_LevelD, safetyDSL_SafeState, State, safetyDSL_Reads, ArchElementToArchElement, safetyDSL_Writes, safetyDSL_Commands, safetyDSL_Stops, MonitorToArchitecturalElement, safetyDSL_Starts, safetyDSL_Inits, safetyDSL_ArchElementToArchElement, SafetyCriticalRelation, safetyDSL_MonitorToArchitecturalElement, safetyDSL_ReportsFault, safetyDSL_Restarts, safetyDSL_Monitors},
    associations={views0, detail1, value9, left12, right15, hazard17, elements3, relations4, subrequirements7, rootNode8, elements28, relations29, level31, implementedSafetyRequirements32, implementedTactics35, subelements39, states41, subelements44, implementedTactics45, safetyRequirements19, consequences21, fault22, safetyTactics24, handledFaults25, moduleClassRelations62, classTestCaseRelations64, module66, classes69, clazz71, element147, element249, monitor52, safetyCritical54, safetyCritical157, safetyCritical259},
    generalizations={gen_safetyDSL_HazardViewpoint_SafetyViewpoint, gen_safetyDSL_Hazard_HazardElement, gen_safetyDSL_SafetyRequirement_HazardElement, gen_safetyDSL_Consequence_HazardElement, gen_safetyDSL_Fault_HazardElement, gen_safetyDSL_FaultTree_HazardElement, gen_safetyDSL_FaultAvoidance_SafetyTactic, gen_safetyDSL_FaultDetection_SafetyTactic, gen_safetyDSL_FaultContainment_SafetyTactic, gen_safetyDSL_SafetyCriticalViewpoint_SafetyViewpoint, gen_safetyDSL_SafetyCritical_ArchitecturalElement, gen_safetyDSL_NonSafetyCritical_ArchitecturalElement, gen_safetyDSL_Monitor_ArchitecturalElement, gen_safetyDSL_DerivedFrom_HazardRelation, gen_safetyDSL_Causes_HazardRelation, gen_safetyDSL_CausedBy_HazardRelation, gen_safetyDSL_SafetyTacticViewpoint_SafetyViewpoint, gen_safetyDSL_ORNodeExpression_FaultTreeNode, gen_safetyDSL_ANDNodeExpression_FaultTreeNode, gen_safetyDSL_LevelA_CriticalityLevel, gen_safetyDSL_LevelB_CriticalityLevel, gen_safetyDSL_LevelC_CriticalityLevel, gen_safetyDSL_LevelD_CriticalityLevel, gen_safetyDSL_SafeState_State, gen_safetyDSL_Reads_ArchElementToArchElement, gen_safetyDSL_Writes_ArchElementToArchElement, gen_safetyDSL_Commands_ArchElementToArchElement, gen_safetyDSL_Stops_MonitorToArchitecturalElement, gen_safetyDSL_Starts_MonitorToArchitecturalElement, gen_safetyDSL_Inits_MonitorToArchitecturalElement, gen_safetyDSL_ArchElementToArchElement_SafetyCriticalRelation, gen_safetyDSL_MonitorToArchitecturalElement_SafetyCriticalRelation, gen_safetyDSL_ReportsFault_SafetyCriticalRelation, gen_safetyDSL_Restarts_MonitorToArchitecturalElement, gen_safetyDSL_Monitors_MonitorToArchitecturalElement},
    metadata=None
)
