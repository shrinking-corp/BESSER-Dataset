...
ecore_FSM = Class(name="ecore_FSM")
...
ecore_State = Class(name="ecore_State")
ecore_Transition = Class(name="ecore_Transition")
...
ecore_EClass.methods={ecore_EClass_m_getEStructuralFeature, ecore_EClass_m_getEOperation, ecore_EClass_m_getFeatureType, ecore_EClass_m_getFeatureCount, ecore_EClass_m_isSuperTypeOf, ecore_EClass_m_getFeatureID, ecore_EClass_m_getEStructuralFeature, ecore_EClass_m_getOperationCount, ecore_EClass_m_getOverride, ecore_EClass_m_getOperationID}
...
ecore_EObject.methods={ecore_EObject_m_eGet, ecore_EObject_m_eContainer, ecore_EObject_m_eClass, ecore_EObject_m_eContents, ecore_EObject_m_eAllContents, ecore_EObject_m_eCrossReferences, ecore_EObject_m_eContainingFeature, ecore_EObject_m_eIsSet, ecore_EObject_m_eIsProxy, ecore_EObject_m_eInvoke, ecore_EObject_m_eContainmentFeature, ecore_EObject_m_eResource, ecore_EObject_m_eGet, ecore_EObject_m_eSet, ecore_EObject_m_eUnset}
...
ecore_EStructuralFeature.attributes={ecore_EStructuralFeature_volatile, ecore_EStructuralFeature_changeable, ecore_EStructuralFeature_transient, ecore_EStructuralFeature_unsettable, ecore_EStructuralFeature_defaultValueLiteral, ecore_EStructuralFeature_defaultValue, ecore_EStructuralFeature_derived}
...
domain_model = DomainModel(
    name="ecore",
    types={ecore_EClass, EClassifier, FSM, ecore_EAttribute, EStructuralFeature, ecore_EDataType, ecore_EAnnotation, EModelElement, ecore_EStringToStringMapEntry, ecore_EModelElement, ecore_EObject, ecore_EStructuralFeature, ecore_EOperation, ecore_EReference, ecore_EGenericType, ecore_EClassifier, ENamedElement, ecore_EEnumLiteral, ecore_EPackage, ecore_ETypeParameter, ecore_EEnum, EDataType, ecore_EFactory, ecore_ENamedElement, ecore_FSM, ETypedElement, ecore_EParameter, ecore_ETypedElement, ecore_State, ecore_Transition},
    associations={eAttributeType0, details1, eModelElement2, contents3, references5, eAllStructuralFeatures27, eSuperTypes9, eOperations10, eAllAttributes11, eAllReferences14, eReferences16, eAttributes19, eAllContainments22, eAllOperations25, eAllSuperTypes30, eIDAttribute32, eStructuralFeatures35, eGenericSuperTypes37, eAllGenericSuperTypes39, eLiterals44, ePackage42, eTypeParameters43, eEnum45, ePackage46, eAnnotations48, myFSMs49, eContainingClass50, eTypeParameters51, eParameters54, eExceptions55, eGenericExceptions58, eContainingClass81, eFactoryInstance61, eClassifiers62, eSubpackages65, eSuperPackage68, eOperation70, eOpposite73, eReferenceType75, eKeys78, eType83, eGenericType85, eClassifier103, eUpperBound89, eTypeArguments92, eRawType94, eLowerBound98, eTypeParameter100, eBounds106, ownedState109, initialState110, finalState112, owningFSM115, outgoingTransition116, incomingTransition117, myClasses119, source122, target124},
    generalizations={gen_ecore_EClass_EClassifier, gen_ecore_EClass_FSM, gen_ecore_EAttribute_EStructuralFeature, gen_ecore_EAnnotation_EModelElement, gen_ecore_EClassifier_ENamedElement, gen_ecore_EEnumLiteral_ENamedElement, gen_ecore_EDataType_EClassifier, gen_ecore_EEnum_EDataType, gen_ecore_EFactory_EModelElement, gen_ecore_ENamedElement_EModelElement, gen_ecore_EOperation_ETypedElement, gen_ecore_EPackage_ENamedElement, gen_ecore_EParameter_ETypedElement, gen_ecore_EReference_EStructuralFeature, gen_ecore_EStructuralFeature_ETypedElement, gen_ecore_ETypedElement_ENamedElement, gen_ecore_ETypeParameter_ENamedElement},
    metadata=None
)
