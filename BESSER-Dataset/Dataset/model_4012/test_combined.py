...
def test_assoc_enumType6_link_reassign_clear():
    a = UML_14_Attribute(initialValue="sample_text", visibility="sample_text")
    b1 = UML_14_Enumeration()
    b2 = UML_14_Enumeration()
    _safe_set(a, 'UML_14_Attribute7', b1)
    assert _is_linked(a, 'UML_14_Attribute7', b1)
    if hasattr(b1, 'UML_14_Enumeration8'):
        assert _is_linked(b1, 'UML_14_Enumeration8', a)
    _safe_set(a, 'UML_14_Attribute7', b2)
    assert _is_linked(a, 'UML_14_Attribute7', b2)
    if hasattr(b1, 'UML_14_Enumeration8'):
        assert not _is_linked(b1, 'UML_14_Enumeration8', a)
    if hasattr(b2, 'UML_14_Enumeration8'):
        assert _is_linked(b2, 'UML_14_Enumeration8', a)
    _safe_set(a, 'UML_14_Attribute7', None)
    assert not _is_linked(a, 'UML_14_Attribute7', b2)
    if hasattr(b2, 'UML_14_Enumeration8'):
        assert not _is_linked(b2, 'UML_14_Enumeration8', a)
...
def test_assoc_multiplicity5_link_reassign_clear():
    a = UML_14_MultiplicityRange(lower="sample_text", upper="sample_text")
    b1 = UML_14_Attribute(initialValue="sample_text", visibility="sample_text")
    b2 = UML_14_Attribute(initialValue="sample_text_2", visibility="sample_text_2")
...
def test_assoc_params3_link_reassign_clear():
    ...
    _safe_set(a, 'UML_14_Parameter4', b1)
    assert _is_linked(a, 'UML_14_Parameter4', b1)
    if hasattr(b1, 'UML_14_Method'):
        assert _is_linked(b1, 'UML_14_Method', a)
    _safe_set(a, 'UML_14_Parameter4', b2)
    assert _is_linked(a, 'UML_14_Parameter4', b2)
    if hasattr(b1, 'UML_14_Method'):
        assert not _is_linked(b1, 'UML_14_Method', a)
    if hasattr(b2, 'UML_14_Method'):
        assert _is_linked(b2, 'UML_14_Method', a)
    _safe_set(a, 'UML_14_Parameter4', None)
    assert not _is_linked(a, 'UML_14_Parameter4', b2)
    if hasattr(b2, 'UML_14_Method'):
...
def test_assoc_primitiveType9_link_reassign_clear():
    a = UML_14_Attribute(initialValue="sample_text", visibility="sample_text")
    b1 = UML_14_Primitive()
    b2 = UML_14_Primitive()
    _safe_set(a, 'UML_14_Attribute10', b1)
    assert _is_linked(a, 'UML_14_Attribute10', b1)
    if hasattr(b1, 'UML_14_Primitive11'):
        assert _is_linked(b1, 'UML_14_Primitive11', a)
    _safe_set(a, 'UML_14_Attribute10', b2)
    assert _is_linked(a, 'UML_14_Attribute10', b2)
    if hasattr(b1, 'UML_14_Primitive11'):
        assert not _is_linked(b1, 'UML_14_Primitive11', a)
    if hasattr(b2, 'UML_14_Primitive11'):
        assert _is_linked(b2, 'UML_14_Primitive11', a)
    _safe_set(a, 'UML_14_Attribute10', None)
    assert not _is_linked(a, 'UML_14_Attribute10', b2)
    if hasattr(b2, 'UML_14_Primitive11'):
        assert not _is_linked(b2, 'UML_14_Primitive11', a)
