...
class services_ServiceUser(Base):
    ...
    def __init__(self, name: str, description: str, services_ServiceUser: "services_Service" = None, services_ServiceUser44: "services_ServiceForecastUsers" = None, services_ServiceUser53: "services_ServiceProfile" = None, services_ServiceUser56: "services_Expression" = None):
        self.name = name
