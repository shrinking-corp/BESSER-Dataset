...
domain_model = DomainModel(
    name="services",
    types={services_CFSService, Service, services_CIID, Base, services_DerivedResource, BaseResource, services_Value, services_DistributionEntry, services_NetXResource, services_RFSService, services_Node, services_Tolerance, services_Service, services_Lifecycle, services_ServiceForecast, services_ServiceMonitor, services_ServiceUser, services_ServiceDistribution, services_Expression, services_DateTimeRange, services_ServiceForecastUsers, services_ResourceForecast, services_ResourceMonitor, services_ServiceProfile, ResourceOriginType, ServiceClassType},
    associations={values0, forecastValues1, trendedValues4, resourceRef7, distribution8, nodes11, toleranceRefs12, cIID14, lifecycle15, services18, serviceForecasts20, serviceMonitors22, serviceUserRefs24, serviceDistribution26, distributionEntries28, expressionRefs31, period33, serviceForecastUsers35, resourceForecasts37, userValues39, serviceUserRef42, period45, resourceMonitors48, profileResources50, serviceProfile52, expressionRef55},
