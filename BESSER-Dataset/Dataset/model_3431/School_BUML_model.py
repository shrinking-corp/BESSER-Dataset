...
school_SchoolStatistics = Class(name="school_SchoolStatistics")
school_Person = Class(name="school_Person", is_abstract=True)
school_Named = Class(name="school_Named", is_abstract=True)
school_Student = Class(name="school_Student")
Person = Class(name="Person")
school_Teacher = Class(name="school_Teacher")
school_SchoolModel = Class(name="school_SchoolModel")
...
school_SchoolStatistics.attributes={school_SchoolStatistics_teachersNumber, school_SchoolStatistics_studentsWithNoTeacher, school_SchoolStatistics_studentsNumber}
...
domain_model = DomainModel(
    name="school",
    types={Named, school_SchoolStatistics, school_Person, school_Named, school_Student, Person, school_Teacher, school_SchoolModel, school_School},
    associations={statistics1, persons3, teachers5, schools0},
    generalizations={gen_school_School_Named, gen_school_Person_Named, gen_school_Student_Person, gen_school_Teacher_Person},
    metadata=None
)
