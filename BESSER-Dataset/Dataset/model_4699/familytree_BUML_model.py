...
familytree_Wedding = Class(name="familytree_Wedding")
...
familytree_Person.attributes={familytree_Person_deathYear, familytree_Person_birthYear, familytree_Person_lastName, familytree_Person_firstName}
...
domain_model = DomainModel(
    name="familytree",
    types={familytree_Person, familytree_Wedding, familytree_FamilyTree, familytree_Man, Person, familytree_Woman},
    associations={persons0, weddings1, wife10, husband12, children4, parents6, wife8, husband9},
