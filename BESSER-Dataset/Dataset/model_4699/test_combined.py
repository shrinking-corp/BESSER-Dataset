...
def test_hyp_familytree_wedding_is_not_abstract():
    assert not inspect.isabstract(familytree_Wedding)


def test_hyp_familytree_wedding_constructor_exists():
    assert callable(familytree_Wedding.__init__)


def test_hyp_familytree_wedding_constructor_args():
...
def test_hyp_familytree_familytree_name_setter(instance):
...
@given(instance=familytree_Person_strategy)
def test_hyp_familytree_person_deathYear_setter(instance):
...
@given(instance=familytree_Person_strategy)
def test_hyp_familytree_person_birthYear_setter(instance):
