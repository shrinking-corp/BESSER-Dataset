...
class familytree_Person(ABC):
    ...
    def __init__(self, firstName: str, lastName: str, birthYear: int, deathYear: int, Person7: "familytree_Person" = None, children: set["familytree_Person"] = None, familytree_Person: "familytree_FamilyTree" = None, Person: "familytree_Person" = None, parents: set["familytree_Person"] = None):
