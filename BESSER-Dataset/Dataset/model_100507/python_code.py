...
class requirement_Category(NamedElement):
    ...
    def __init__(self, id: str, Category: "requirement_Repository" = None, Category15: "requirement_Requirement" = None, category: set["requirement_Requirement"] = None, Category5: "requirement_Category" = None, parentCategory: set["requirement_Category"] = None, mainCategories: "requirement_Repository" = None, Category9: "requirement_Category" = None, subCategories: "requirement_Category" = None, requirement_Category: set["requirement_EObject"] = None):
        self.id = id
...
class requirement_Requirement(NamedElement):
    ...
    def __init__(self, acceptanceCriteria: str, type: str, subtype: str, status: str, createdOn: date, modifiedOn: date, id: str, version: int, statement: str, rationale: str, requirements: "requirement_Category" = None, Requirement: "requirement_Category" = None, requirement_Requirement: set["requirement_EObject"] = None):
