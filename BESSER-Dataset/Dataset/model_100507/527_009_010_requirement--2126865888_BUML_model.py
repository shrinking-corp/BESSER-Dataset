...
requirement_Requirement.attributes={requirement_Requirement_rationale, requirement_Requirement_modifiedOn, requirement_Requirement_id, requirement_Requirement_version, requirement_Requirement_statement, requirement_Requirement_status, requirement_Requirement_subtype, requirement_Requirement_acceptanceCriteria, requirement_Requirement_createdOn, requirement_Requirement_type}
...
domain_model = DomainModel(
    name="requirement",
    types={requirement_Repository, NamedElement, requirement_Category, requirement_EObject, requirement_NamedElement, requirement_Requirement, RequirementType},
    associations={mainCategories0, referencedObject1, category14, requirements2, subCategories4, repository6, parentCategory8, referencedObject10, referencedObject12},
    generalizations={gen_requirement_Repository_NamedElement, gen_requirement_Category_NamedElement, gen_requirement_Requirement_NamedElement},
    metadata=None
)
