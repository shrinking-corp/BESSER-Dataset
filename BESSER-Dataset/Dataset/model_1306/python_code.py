...
class SimplStateMachine_Assignment:
    ...
    def __init__(self, _name: str, SimplStateMachine_Assignment33: "SimplStateMachine_ExpressionElement" = None, SimplStateMachine_Assignment36: "SimplStateMachine_Variable" = None, SimplStateMachine_Assignment: "SimplStateMachine_Operation" = None):
        self._name = _name
...
class SimplStateMachine_CompositeState(State):
    ...
    def __init__(self, container: set["SimplStateMachine_State"] = None, SimplStateMachine_CompositeState: "SimplStateMachine_InitialState" = None, CompositeState: "SimplStateMachine_State" = None):
...
class SimplStateMachine_Variable(ABC):
    ...
    def __init__(self, name: str, SimplStateMachine_Variable37: "SimplStateMachine_Assignment" = None, SimplStateMachine_Variable39: "SimplStateMachine_VariableReference" = None, SimplStateMachine_Variable29: "SimplStateMachine_Data" = None, SimplStateMachine_Variable: "SimplStateMachine_StateMachine" = None):
        self.name = name
...
class SimplStateMachine_Event:
    ...
    def __init__(self, name: str, SimplStateMachine_Event20: "SimplStateMachine_Transition" = None, SimplStateMachine_Event: "SimplStateMachine_StateMachine" = None):
        self.name = name
