...
def test_hyp_lazy_book_is_not_abstract():
    assert not inspect.isabstract(lazy_Book)


def test_hyp_lazy_book_constructor_exists():
    assert callable(lazy_Book.__init__)


def test_hyp_lazy_book_constructor_args():
...
def test_hyp_lazy_library_is_not_abstract():
    assert not inspect.isabstract(lazy_Library)


def test_hyp_lazy_library_constructor_exists():
    assert callable(lazy_Library.__init__)


def test_hyp_lazy_library_constructor_args():
...
def test_hyp_lazy_writer_is_not_abstract():
    assert not inspect.isabstract(lazy_Writer)


def test_hyp_lazy_writer_constructor_exists():
    assert callable(lazy_Writer.__init__)


def test_hyp_lazy_writer_constructor_args():
...
def test_hyp_lazy_book_pages_setter(instance):
...
@given(instance=lazy_Book_strategy)
def test_hyp_lazy_book_category_setter(instance):
...
@given(instance=lazy_Book_strategy)
def test_hyp_lazy_book_title_setter(instance):
...
def test_hyp_lazy_library_name_setter(instance):
...
def test_hyp_lazy_writer_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
