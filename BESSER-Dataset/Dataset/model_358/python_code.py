...
class lazy_Book:
    ...
    def __init__(self, title: str, pages: str, category: str, lazy_Book: "lazy_Library" = None, Book: "lazy_Writer" = None, books: "lazy_Writer" = None):
        self.title = title
        self.pages = pages
...
class lazy_Library:
    ...
    def __init__(self, name: str, lazy_Library3: set["lazy_Book"] = None, lazy_Library: set["lazy_Writer"] = None):
        self.name = name
...
class lazy_Writer:
    ...
    def __init__(self, name: str, author: set["lazy_Book"] = None, Writer: "lazy_Book" = None, lazy_Writer: "lazy_Library" = None):
        self.name = name
