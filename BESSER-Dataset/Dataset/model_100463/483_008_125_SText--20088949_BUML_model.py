...
domain_model = DomainModel(
    name="stext",
    types={stext_Root, stext_StatechartSpecification, stext_StateRoot, stext_StateSpecification, stext_TransitionRoot, stext_TransitionSpecification, stext_StatechartScope, stext_Scope, stext_TransitionReaction, Scope, stext_InterfaceScope, StatechartScope, NamedElement, stext_InternalScope, stext_EventDefinition, Event, stext_EventDerivation, stext_Expression, stext_DefRoot, stext_StatechartRoot, DefRoot, stext_VariableDefinition, Variable, Property_, stext_OperationDefinition, Declaration, Operation, stext_Parameter, stext_LocalReaction, Reaction, stext_ReactionProperties, stext_ReactionProperty, stext_EntryPointSpec, ReactionProperty, stext_Entrypoint, stext_ExitPointSpec, stext_Exitpoint, stext_EventSpec, stext_RegularEventSpec, EventSpec, stext_TimeEventSpec, stext_BuiltinEventSpec, stext_ExitEvent, stext_OnCycleEvent, stext_AlwaysEvent, stext_DefaultEvent, Statement, stext_Literal, stext_BoolLiteral, Literal, stext_IntLiteral, stext_RealLiteral, stext_HexLiteral, stext_StringLiteral, stext_EntryEvent, BuiltinEventSpec, stext_SimpleScope, stext_ReactionTrigger, Trigger, stext_ReactionEffect, Effect, stext_EventRaisingExpression, Expression, stext_AssignmentExpression, stext_ConditionalExpression, stext_LogicalOrExpression, stext_LogicalAndExpression, stext_LogicalNotExpression, stext_BitwiseXorExpression, stext_BitwiseOrExpression, stext_BitwiseAndExpression, stext_LogicalRelationExpression, stext_ShiftExpression, stext_NumericalAddSubtractExpression, stext_NumericalMultiplyDivideExpression, stext_NumericalUnaryExpression, stext_PrimitiveValueExpression, stext_FeatureCall, stext_Feature, stext_TypedElementReferenceExpression, stext_NamedElement, stext_EventValueReferenceExpression, stext_ActiveStateReferenceExpression, stext_State, TimeEventType, Direction, AssignmentOperator, ShiftOperator, AdditiveOperator, MultiplicativeOperator, UnaryOperator, RelationalOperator, TimeUnit},
    associations={def_1, def_2, def_3, definitionScopes4, scope6, reaction8, derivation10, condition11, roots0, initialValue16, params18, properties19, properties20, properties23, entrypoint25, exitpoint26, event27, value13, triggers29, guardExpression30, actions33, event35, value37, varRef40, expression42, condition45, trueCase47, falseCase50, rightOperand55, leftOperand58, rightOperand60, operand63, leftOperand65, rightOperand67, leftOperand70, rightOperand72, leftOperand75, rightOperand77, leftOperand80, rightOperand82, leftOperand53, leftOperand85, rightOperand87, leftOperand90, rightOperand92, leftOperand95, rightOperand97, operand100, value102, owner103, feature105, reference110, value111, value113, args107},
    generalizations={gen_stext_StatechartRoot_DefRoot, gen_stext_StateRoot_DefRoot, gen_stext_TransitionRoot_DefRoot, gen_stext_StatechartScope_Scope, gen_stext_InterfaceScope_StatechartScope, gen_stext_InterfaceScope_NamedElement, gen_stext_InternalScope_StatechartScope, gen_stext_EventDefinition_Event, gen_stext_EventDefinition_Event, gen_stext_VariableDefinition_Variable, gen_stext_VariableDefinition_Property, gen_stext_OperationDefinition_Declaration, gen_stext_OperationDefinition_Operation, gen_stext_LocalReaction_Declaration, gen_stext_LocalReaction_Reaction, gen_stext_TransitionReaction_Reaction, gen_stext_EntryPointSpec_ReactionProperty, gen_stext_ExitPointSpec_ReactionProperty, gen_stext_RegularEventSpec_EventSpec, gen_stext_TimeEventSpec_EventSpec, gen_stext_BuiltinEventSpec_EventSpec, gen_stext_ExitEvent_BuiltinEventSpec, gen_stext_OnCycleEvent_BuiltinEventSpec, gen_stext_AlwaysEvent_BuiltinEventSpec, gen_stext_DefaultEvent_BuiltinEventSpec, gen_stext_Expression_Statement, gen_stext_BoolLiteral_Literal, gen_stext_IntLiteral_Literal, gen_stext_RealLiteral_Literal, gen_stext_HexLiteral_Literal, gen_stext_StringLiteral_Literal, gen_stext_EntryEvent_BuiltinEventSpec, gen_stext_SimpleScope_Scope, gen_stext_Entrypoint_Declaration, gen_stext_Exitpoint_Declaration, gen_stext_ReactionTrigger_Trigger, gen_stext_ReactionEffect_Effect, gen_stext_EventRaisingExpression_Expression, gen_stext_AssignmentExpression_Expression, gen_stext_ConditionalExpression_Expression, gen_stext_LogicalAndExpression_Expression, gen_stext_LogicalNotExpression_Expression, gen_stext_BitwiseXorExpression_Expression, gen_stext_BitwiseOrExpression_Expression, gen_stext_BitwiseAndExpression_Expression, gen_stext_LogicalRelationExpression_Expression, gen_stext_LogicalOrExpression_Expression, gen_stext_ShiftExpression_Expression, gen_stext_NumericalAddSubtractExpression_Expression, gen_stext_NumericalMultiplyDivideExpression_Expression, gen_stext_NumericalUnaryExpression_Expression, gen_stext_PrimitiveValueExpression_Expression, gen_stext_FeatureCall_Expression, gen_stext_TypedElementReferenceExpression_Expression, gen_stext_EventValueReferenceExpression_Expression, gen_stext_ActiveStateReferenceExpression_Expression},
    metadata=None
)
