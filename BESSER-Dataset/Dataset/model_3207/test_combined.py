...
def test_hyp_nqc_case_is_not_abstract():
    assert not inspect.isabstract(NQC_Case)


def test_hyp_nqc_case_constructor_exists():
    assert callable(NQC_Case.__init__)


def test_hyp_nqc_case_constructor_args():
...
def test_hyp_callstatement_is_not_abstract():
    assert not inspect.isabstract(CallStatement)


def test_hyp_callstatement_constructor_exists():
    assert callable(CallStatement.__init__)


def test_hyp_callstatement_constructor_args():
    sig = inspect.signature(CallStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nqc_subroutinecall_is_not_abstract():
    assert not inspect.isabstract(NQC_SubroutineCall)


def test_hyp_nqc_subroutinecall_constructor_exists():
    assert callable(NQC_SubroutineCall.__init__)


def test_hyp_nqc_subroutinecall_constructor_args():
    sig = inspect.signature(NQC_SubroutineCall.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nqc_functioncall_is_not_abstract():
    assert not inspect.isabstract(NQC_FunctionCall)


def test_hyp_nqc_functioncall_constructor_exists():
    assert callable(NQC_FunctionCall.__init__)


def test_hyp_nqc_functioncall_constructor_args():
    sig = inspect.signature(NQC_FunctionCall.__init__)
    params = list(sig.parameters.keys())



def test_hyp_compoundexpression_is_not_abstract():
    assert not inspect.isabstract(CompoundExpression)


def test_hyp_compoundexpression_constructor_exists():
    assert callable(CompoundExpression.__init__)


def test_hyp_compoundexpression_constructor_args():
    sig = inspect.signature(CompoundExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nqc_binaryexpression_is_not_abstract():
    assert not inspect.isabstract(NQC_BinaryExpression)


def test_hyp_nqc_binaryexpression_constructor_exists():
    assert callable(NQC_BinaryExpression.__init__)


def test_hyp_nqc_binaryexpression_constructor_args():
...
def test_hyp_nqc_booleanconstant_is_not_abstract():
    assert not inspect.isabstract(NQC_BooleanConstant)


def test_hyp_nqc_booleanconstant_constructor_exists():
    assert callable(NQC_BooleanConstant.__init__)


def test_hyp_nqc_booleanconstant_constructor_args():
...
def test_hyp_nqc_arrayexpression_is_not_abstract():
    assert not inspect.isabstract(NQC_ArrayExpression)


def test_hyp_nqc_arrayexpression_constructor_exists():
    assert callable(NQC_ArrayExpression.__init__)


def test_hyp_nqc_arrayexpression_constructor_args():
...
def test_hyp_nqc_compoundexpression_is_not_abstract():
    assert not inspect.isabstract(NQC_CompoundExpression)


def test_hyp_nqc_compoundexpression_constructor_exists():
    assert callable(NQC_CompoundExpression.__init__)


def test_hyp_nqc_compoundexpression_constructor_args():
    sig = inspect.signature(NQC_CompoundExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nqc_valueexpression_is_not_abstract():
    assert not inspect.isabstract(NQC_ValueExpression)


def test_hyp_nqc_valueexpression_constructor_exists():
    assert callable(NQC_ValueExpression.__init__)


def test_hyp_nqc_valueexpression_constructor_args():
    sig = inspect.signature(NQC_ValueExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nqc_variableexpression_is_not_abstract():
    assert not inspect.isabstract(NQC_VariableExpression)


def test_hyp_nqc_variableexpression_constructor_exists():
    assert callable(NQC_VariableExpression.__init__)


def test_hyp_nqc_variableexpression_constructor_args():
...
def test_hyp_nqc_continuestatement_is_not_abstract():
    assert not inspect.isabstract(NQC_ContinueStatement)


def test_hyp_nqc_continuestatement_constructor_exists():
    assert callable(NQC_ContinueStatement.__init__)


def test_hyp_nqc_continuestatement_constructor_args():
    sig = inspect.signature(NQC_ContinueStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nqc_callstatement_is_not_abstract():
    assert not inspect.isabstract(NQC_CallStatement)


def test_hyp_nqc_callstatement_constructor_exists():
    assert callable(NQC_CallStatement.__init__)


def test_hyp_nqc_callstatement_constructor_args():
    sig = inspect.signature(NQC_CallStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nqc_expression_is_not_abstract():
    assert not inspect.isabstract(NQC_Expression)


def test_hyp_nqc_expression_constructor_exists():
    assert callable(NQC_Expression.__init__)


def test_hyp_nqc_expression_constructor_args():
    sig = inspect.signature(NQC_Expression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nqc_blockstatement_is_not_abstract():
    assert not inspect.isabstract(NQC_BlockStatement)


def test_hyp_nqc_blockstatement_constructor_exists():
    assert callable(NQC_BlockStatement.__init__)


def test_hyp_nqc_blockstatement_constructor_args():
    sig = inspect.signature(NQC_BlockStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nqc_controlstructure_is_not_abstract():
    assert not inspect.isabstract(NQC_ControlStructure)


def test_hyp_nqc_controlstructure_constructor_exists():
    assert callable(NQC_ControlStructure.__init__)


def test_hyp_nqc_controlstructure_constructor_args():
    sig = inspect.signature(NQC_ControlStructure.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nqc_breakstatement_is_not_abstract():
    assert not inspect.isabstract(NQC_BreakStatement)


def test_hyp_nqc_breakstatement_constructor_exists():
    assert callable(NQC_BreakStatement.__init__)


def test_hyp_nqc_breakstatement_constructor_args():
    sig = inspect.signature(NQC_BreakStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nqc_emptystatement_is_not_abstract():
    assert not inspect.isabstract(NQC_EmptyStatement)


def test_hyp_nqc_emptystatement_constructor_exists():
    assert callable(NQC_EmptyStatement.__init__)


def test_hyp_nqc_emptystatement_constructor_args():
    sig = inspect.signature(NQC_EmptyStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nqc_assignmentstatement_is_not_abstract():
    assert not inspect.isabstract(NQC_AssignmentStatement)


def test_hyp_nqc_assignmentstatement_constructor_exists():
    assert callable(NQC_AssignmentStatement.__init__)


def test_hyp_nqc_assignmentstatement_constructor_args():
...
def test_hyp_nqc_ifstatement_is_not_abstract():
    assert not inspect.isabstract(NQC_IfStatement)


def test_hyp_nqc_ifstatement_constructor_exists():
    assert callable(NQC_IfStatement.__init__)


def test_hyp_nqc_ifstatement_constructor_args():
    sig = inspect.signature(NQC_IfStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nqc_forstatement_is_not_abstract():
    assert not inspect.isabstract(NQC_ForStatement)


def test_hyp_nqc_forstatement_constructor_exists():
    assert callable(NQC_ForStatement.__init__)


def test_hyp_nqc_forstatement_constructor_args():
    sig = inspect.signature(NQC_ForStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nqc_gotostatement_is_not_abstract():
    assert not inspect.isabstract(NQC_GoToStatement)


def test_hyp_nqc_gotostatement_constructor_exists():
    assert callable(NQC_GoToStatement.__init__)


def test_hyp_nqc_gotostatement_constructor_args():
    sig = inspect.signature(NQC_GoToStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nqc_untilstatement_is_not_abstract():
    assert not inspect.isabstract(NQC_UntilStatement)


def test_hyp_nqc_untilstatement_constructor_exists():
    assert callable(NQC_UntilStatement.__init__)


def test_hyp_nqc_untilstatement_constructor_args():
    sig = inspect.signature(NQC_UntilStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nqc_whilestatement_is_not_abstract():
    assert not inspect.isabstract(NQC_WhileStatement)


def test_hyp_nqc_whilestatement_constructor_exists():
    assert callable(NQC_WhileStatement.__init__)


def test_hyp_nqc_whilestatement_constructor_args():
    sig = inspect.signature(NQC_WhileStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nqc_repeatstatement_is_not_abstract():
    assert not inspect.isabstract(NQC_RepeatStatement)


def test_hyp_nqc_repeatstatement_constructor_exists():
    assert callable(NQC_RepeatStatement.__init__)


def test_hyp_nqc_repeatstatement_constructor_args():
    sig = inspect.signature(NQC_RepeatStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nqc_switchstatement_is_not_abstract():
    assert not inspect.isabstract(NQC_SwitchStatement)


def test_hyp_nqc_switchstatement_constructor_exists():
    assert callable(NQC_SwitchStatement.__init__)


def test_hyp_nqc_switchstatement_constructor_args():
    sig = inspect.signature(NQC_SwitchStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nqc_dowhilestatement_is_not_abstract():
    assert not inspect.isabstract(NQC_DoWhileStatement)


def test_hyp_nqc_dowhilestatement_constructor_exists():
    assert callable(NQC_DoWhileStatement.__init__)


def test_hyp_nqc_dowhilestatement_constructor_args():
    sig = inspect.signature(NQC_DoWhileStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nqc_stopstatement_is_not_abstract():
    assert not inspect.isabstract(NQC_StopStatement)


def test_hyp_nqc_stopstatement_constructor_exists():
    assert callable(NQC_StopStatement.__init__)


def test_hyp_nqc_stopstatement_constructor_args():
    sig = inspect.signature(NQC_StopStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nqc_startstatement_is_not_abstract():
    assert not inspect.isabstract(NQC_StartStatement)


def test_hyp_nqc_startstatement_constructor_exists():
    assert callable(NQC_StartStatement.__init__)


def test_hyp_nqc_startstatement_constructor_args():
    sig = inspect.signature(NQC_StartStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nqc_returnstatement_is_not_abstract():
    assert not inspect.isabstract(NQC_ReturnStatement)


def test_hyp_nqc_returnstatement_constructor_exists():
    assert callable(NQC_ReturnStatement.__init__)


def test_hyp_nqc_returnstatement_constructor_args():
    sig = inspect.signature(NQC_ReturnStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nqc_subroutine_is_not_abstract():
    assert not inspect.isabstract(NQC_Subroutine)


def test_hyp_nqc_subroutine_constructor_exists():
    assert callable(NQC_Subroutine.__init__)


def test_hyp_nqc_subroutine_constructor_args():
...
def test_hyp_nqc_function_is_not_abstract():
    assert not inspect.isabstract(NQC_Function)


def test_hyp_nqc_function_constructor_exists():
    assert callable(NQC_Function.__init__)


def test_hyp_nqc_function_constructor_args():
...
def test_hyp_nqc_task_is_not_abstract():
    assert not inspect.isabstract(NQC_Task)


def test_hyp_nqc_task_constructor_exists():
    assert callable(NQC_Task.__init__)


def test_hyp_nqc_task_constructor_args():
...
def test_hyp_nqc_program_is_not_abstract():
    assert not inspect.isabstract(NQC_Program)


def test_hyp_nqc_program_constructor_exists():
    assert callable(NQC_Program.__init__)


def test_hyp_nqc_program_constructor_args():
...
def test_hyp_nqc_label_is_not_abstract():
    assert not inspect.isabstract(NQC_Label)


def test_hyp_nqc_label_constructor_exists():
    assert callable(NQC_Label.__init__)


def test_hyp_nqc_label_constructor_args():
...
def test_hyp_nqc_integerconstant_is_not_abstract():
    assert not inspect.isabstract(NQC_IntegerConstant)


def test_hyp_nqc_integerconstant_constructor_exists():
    assert callable(NQC_IntegerConstant.__init__)


def test_hyp_nqc_integerconstant_constructor_args():
...
def test_hyp_nqc_constantexpression_is_not_abstract():
    assert not inspect.isabstract(NQC_ConstantExpression)


def test_hyp_nqc_constantexpression_constructor_exists():
    assert callable(NQC_ConstantExpression.__init__)


def test_hyp_nqc_constantexpression_constructor_args():
    sig = inspect.signature(NQC_ConstantExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nqc_variable_is_not_abstract():
    assert not inspect.isabstract(NQC_Variable)


def test_hyp_nqc_variable_constructor_exists():
    assert callable(NQC_Variable.__init__)


def test_hyp_nqc_variable_constructor_args():
...
def test_hyp_nqc_globalvariable_is_not_abstract():
    assert not inspect.isabstract(NQC_GlobalVariable)


def test_hyp_nqc_globalvariable_constructor_exists():
    assert callable(NQC_GlobalVariable.__init__)


def test_hyp_nqc_globalvariable_constructor_args():
    sig = inspect.signature(NQC_GlobalVariable.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nqc_parameter_is_not_abstract():
    assert not inspect.isabstract(NQC_Parameter)


def test_hyp_nqc_parameter_constructor_exists():
    assert callable(NQC_Parameter.__init__)


def test_hyp_nqc_parameter_constructor_args():
    sig = inspect.signature(NQC_Parameter.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nqc_localvariable_is_not_abstract():
    assert not inspect.isabstract(NQC_LocalVariable)


def test_hyp_nqc_localvariable_constructor_exists():
    assert callable(NQC_LocalVariable.__init__)


def test_hyp_nqc_localvariable_constructor_args():
    sig = inspect.signature(NQC_LocalVariable.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nqc_statement_is_not_abstract():
    assert not inspect.isabstract(NQC_Statement)


def test_hyp_nqc_statement_constructor_exists():
    assert callable(NQC_Statement.__init__)


def test_hyp_nqc_statement_constructor_args():
    sig = inspect.signature(NQC_Statement.__init__)
    params = list(sig.parameters.keys())

def test_hyp_assignmentstatementenum_exists():
    # Check that the Enumeration exists
    assert AssignmentStatementEnum is not None

def test_hyp_assignmentstatementenum_has_all_literals():
...
def test_hyp_binaryoperatorenum_exists():
    # Check that the Enumeration exists
    assert BinaryOperatorEnum is not None

def test_hyp_binaryoperatorenum_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_nqc_case_IsDefault_setter(instance):
...
def test_hyp_nqc_binaryexpression_Operator_setter(instance):
...
def test_hyp_nqc_booleanconstant_Value_setter(instance):
...
def test_hyp_nqc_assignmentstatement_Operator_setter(instance):
    original = instance.Operator
    instance.Operator = original
    assert instance.Operator == original
...
def test_hyp_nqc_subroutine_Name_setter(instance):
...
def test_hyp_nqc_function_Name_setter(instance):
    original = instance.Name
    instance.Name = original
    assert instance.Name == original
...
def test_hyp_nqc_task_Name_setter(instance):
    original = instance.Name
    instance.Name = original
    assert instance.Name == original
...
def test_hyp_nqc_program_Name_setter(instance):
    original = instance.Name
    instance.Name = original
    assert instance.Name == original
...
def test_hyp_nqc_label_Label_setter(instance):
...
def test_hyp_nqc_integerconstant_Value_setter(instance):
    original = instance.Value
    instance.Value = original
    assert instance.Value == original
...
def test_hyp_nqc_variable_Name_setter(instance):
    original = instance.Name
    instance.Name = original
    assert instance.Name == original
...
@given(instance=NQC_Variable_strategy)
def test_hyp_nqc_variable_Type_setter(instance):
