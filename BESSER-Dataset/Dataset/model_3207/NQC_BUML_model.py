...
domain_model = DomainModel(
    name="NQC",
    types={NQC_Statement, NQC_LocalVariable, NQC_Parameter, Variable, NQC_Variable, NQC_ConstantExpression, NQC_IntegerConstant, NQC_Label, NQC_Program, NQC_Task, NQC_Function, NQC_Subroutine, NQC_GlobalVariable, NQC_ReturnStatement, NQC_StartStatement, NQC_StopStatement, NQC_DoWhileStatement, ControlStructure, NQC_ForStatement, NQC_GoToStatement, NQC_IfStatement, NQC_RepeatStatement, NQC_AssignmentStatement, Statement, NQC_VariableExpression, NQC_Expression, NQC_BlockStatement, NQC_BreakStatement, NQC_ContinueStatement, NQC_ControlStructure, NQC_EmptyStatement, NQC_ValueExpression, Expression, ValueExpression, NQC_ArrayExpression, VariableExpression, NQC_BooleanConstant, ConstantExpression, NQC_CompoundExpression, NQC_BinaryExpression, CompoundExpression, NQC_CallStatement, NQC_FunctionCall, CallStatement, NQC_SwitchStatement, NQC_Case, NQC_UntilStatement, NQC_WhileStatement, NQC_SubroutineCall, TypeEnum, BinaryOperatorEnum, AssignmentStatementEnum},
    associations={Statements7, LocalVariables9, Statements11, LocalVariables14, Parameters17, Statements19, LocalVariables22, InitialValue25, ArrayMaxSize26, Label28, Tasks0, Functions1, Subroutines3, GlobalVariables5, Task38, Task40, Body42, Condition44, Initialization47, Condition49, Update52, JumpLabel55, Condition57, Consequence59, Alternative62, Variable30, Expression31, LocalVariables33, Statements35, Body81, Label84, Statements87, Variable90, index93, Operand195, Operand297, Condition65, Body67, Condition70, Cases72, Condition74, Body76, Condition79, Callee100, Parameters102, Callee105},
    generalizations={gen_NQC_Parameter_Variable, gen_NQC_LocalVariable_Variable, gen_NQC_GlobalVariable_Variable, gen_NQC_ReturnStatement_Statement, gen_NQC_StartStatement_Statement, gen_NQC_StopStatement_Statement, gen_NQC_DoWhileStatement_ControlStructure, gen_NQC_ForStatement_ControlStructure, gen_NQC_GoToStatement_ControlStructure, gen_NQC_IfStatement_ControlStructure, gen_NQC_RepeatStatement_ControlStructure, gen_NQC_AssignmentStatement_Statement, gen_NQC_BlockStatement_Statement, gen_NQC_BreakStatement_Statement, gen_NQC_ContinueStatement_Statement, gen_NQC_ControlStructure_Statement, gen_NQC_EmptyStatement_Statement, gen_NQC_Expression_Statement, gen_NQC_ValueExpression_Expression, gen_NQC_VariableExpression_ValueExpression, gen_NQC_ArrayExpression_VariableExpression, gen_NQC_ConstantExpression_ValueExpression, gen_NQC_BooleanConstant_ConstantExpression, gen_NQC_IntegerConstant_ConstantExpression, gen_NQC_CompoundExpression_Expression, gen_NQC_BinaryExpression_CompoundExpression, gen_NQC_CallStatement_Statement, gen_NQC_FunctionCall_CallStatement, gen_NQC_SwitchStatement_ControlStructure, gen_NQC_UntilStatement_ControlStructure, gen_NQC_WhileStatement_ControlStructure, gen_NQC_SubroutineCall_CallStatement},
    metadata=None
)
