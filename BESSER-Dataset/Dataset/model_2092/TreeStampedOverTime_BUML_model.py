...
# Classes
ChangingOverTime_TimeStampedElement = Class(name="ChangingOverTime_TimeStampedElement")
ChangingOverTime_Tree = Class(name="ChangingOverTime_Tree")
ChangingOverTime_NodeKind = Class(name="ChangingOverTime_NodeKind")
TimeStampedElement = Class(name="TimeStampedElement")
ChangingOverTime_BindingKind = Class(name="ChangingOverTime_BindingKind")
ChangingOverTime_Entity = Class(name="ChangingOverTime_Entity")
ChangingOverTime_LinkKind = Class(name="ChangingOverTime_LinkKind")
...
domain_model = DomainModel(
    ...
    types={ChangingOverTime_TimeStampedElement, ChangingOverTime_Tree, ChangingOverTime_NodeKind, TimeStampedElement, ChangingOverTime_BindingKind, ChangingOverTime_Entity, ChangingOverTime_LinkKind},
    associations={root0, tree1, child7, node2, entity3, parent5},
    generalizations={gen_ChangingOverTime_NodeKind_TimeStampedElement, gen_ChangingOverTime_BindingKind_TimeStampedElement, gen_ChangingOverTime_Entity_TimeStampedElement},
    metadata=None
)
