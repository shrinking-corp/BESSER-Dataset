...
def test_hyp_sourcecleaner_extensionreference_is_not_abstract():
    assert not inspect.isabstract(sourcecleaner_ExtensionReference)


def test_hyp_sourcecleaner_extensionreference_constructor_exists():
    assert callable(sourcecleaner_ExtensionReference.__init__)


def test_hyp_sourcecleaner_extensionreference_constructor_args():
...
def test_hyp_sourcecleaner_extensionattribute_is_not_abstract():
    assert not inspect.isabstract(sourcecleaner_ExtensionAttribute)


def test_hyp_sourcecleaner_extensionattribute_constructor_exists():
    assert callable(sourcecleaner_ExtensionAttribute.__init__)


def test_hyp_sourcecleaner_extensionattribute_constructor_args():
...
def test_hyp_sourcecleaner_dependency_is_not_abstract():
    assert not inspect.isabstract(sourcecleaner_Dependency)


def test_hyp_sourcecleaner_dependency_constructor_exists():
    assert callable(sourcecleaner_Dependency.__init__)


def test_hyp_sourcecleaner_dependency_constructor_args():
...
def test_hyp_sourcecleaner_locatedelement_is_not_abstract():
    assert not inspect.isabstract(sourcecleaner_LocatedElement)


def test_hyp_sourcecleaner_locatedelement_constructor_exists():
    assert callable(sourcecleaner_LocatedElement.__init__)


def test_hyp_sourcecleaner_locatedelement_constructor_args():
...
def test_hyp_sourcecleaner_schema_is_not_abstract():
    assert not inspect.isabstract(sourcecleaner_Schema)


def test_hyp_sourcecleaner_schema_constructor_exists():
    assert callable(sourcecleaner_Schema.__init__)


def test_hyp_sourcecleaner_schema_constructor_args():
...
def test_hyp_sourcecleaner_extensionpoint_is_not_abstract():
    assert not inspect.isabstract(sourcecleaner_ExtensionPoint)


def test_hyp_sourcecleaner_extensionpoint_constructor_exists():
    assert callable(sourcecleaner_ExtensionPoint.__init__)


def test_hyp_sourcecleaner_extensionpoint_constructor_args():
...
def test_hyp_sourcecleaner_extension_is_not_abstract():
    assert not inspect.isabstract(sourcecleaner_Extension)


def test_hyp_sourcecleaner_extension_constructor_exists():
    assert callable(sourcecleaner_Extension.__init__)


def test_hyp_sourcecleaner_extension_constructor_args():
...
def test_hyp_sourcecleaner_export_is_not_abstract():
    assert not inspect.isabstract(sourcecleaner_Export)


def test_hyp_sourcecleaner_export_constructor_exists():
    assert callable(sourcecleaner_Export.__init__)


def test_hyp_sourcecleaner_export_constructor_args():
...
def test_hyp_sourcecleaner_classpath_is_not_abstract():
    assert not inspect.isabstract(sourcecleaner_ClassPath)


def test_hyp_sourcecleaner_classpath_constructor_exists():
    assert callable(sourcecleaner_ClassPath.__init__)


def test_hyp_sourcecleaner_classpath_constructor_args():
...
def test_hyp_sourcecleaner_source_is_not_abstract():
    assert not inspect.isabstract(sourcecleaner_Source)


def test_hyp_sourcecleaner_source_constructor_exists():
    assert callable(sourcecleaner_Source.__init__)


def test_hyp_sourcecleaner_source_constructor_args():
...
def test_hyp_sourcecleaner_project_is_not_abstract():
    assert not inspect.isabstract(sourcecleaner_Project)


def test_hyp_sourcecleaner_project_constructor_exists():
    assert callable(sourcecleaner_Project.__init__)


def test_hyp_sourcecleaner_project_constructor_args():
...
def test_hyp_sourcecleaner_configuration_is_not_abstract():
    assert not inspect.isabstract(sourcecleaner_Configuration)


def test_hyp_sourcecleaner_configuration_constructor_exists():
    assert callable(sourcecleaner_Configuration.__init__)


def test_hyp_sourcecleaner_configuration_constructor_args():
...
def test_hyp_sourcecleaner_plugin_is_not_abstract():
    assert not inspect.isabstract(sourcecleaner_Plugin)


def test_hyp_sourcecleaner_plugin_constructor_exists():
    assert callable(sourcecleaner_Plugin.__init__)


def test_hyp_sourcecleaner_plugin_constructor_args():
...
def test_hyp_sourcecleaner_build_is_not_abstract():
    assert not inspect.isabstract(sourcecleaner_Build)


def test_hyp_sourcecleaner_build_constructor_exists():
    assert callable(sourcecleaner_Build.__init__)


def test_hyp_sourcecleaner_build_constructor_args():
    sig = inspect.signature(sourcecleaner_Build.__init__)
    params = list(sig.parameters.keys())



def test_hyp_sourcecleaner_manifest_is_not_abstract():
    assert not inspect.isabstract(sourcecleaner_Manifest)


def test_hyp_sourcecleaner_manifest_constructor_exists():
    assert callable(sourcecleaner_Manifest.__init__)


def test_hyp_sourcecleaner_manifest_constructor_args():
...
def test_hyp_sourcecleaner_java_is_not_abstract():
    assert not inspect.isabstract(sourcecleaner_Java)


def test_hyp_sourcecleaner_java_constructor_exists():
    assert callable(sourcecleaner_Java.__init__)


def test_hyp_sourcecleaner_java_constructor_args():
...
def test_hyp_sourcecleaner_extensionreference_java_setter(instance):
...
@given(instance=sourcecleaner_ExtensionReference_strategy)
def test_hyp_sourcecleaner_extensionreference_project_setter(instance):
...
@given(instance=sourcecleaner_ExtensionReference_strategy)
def test_hyp_sourcecleaner_extensionreference_package_setter(instance):
...
@given(instance=sourcecleaner_ExtensionReference_strategy)
def test_hyp_sourcecleaner_extensionreference_name_setter(instance):
...
def test_hyp_sourcecleaner_extensionattribute_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=sourcecleaner_ExtensionAttribute_strategy)
def test_hyp_sourcecleaner_extensionattribute_value_setter(instance):
...
def test_hyp_sourcecleaner_dependency_reexport_setter(instance):
...
@given(instance=sourcecleaner_Dependency_strategy)
def test_hyp_sourcecleaner_dependency_diagraph_setter(instance):
...
@given(instance=sourcecleaner_Dependency_strategy)
def test_hyp_sourcecleaner_dependency_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=sourcecleaner_Dependency_strategy)
def test_hyp_sourcecleaner_dependency_version_setter(instance):
...
def test_hyp_sourcecleaner_locatedelement_absolutePath_setter(instance):
...
@given(instance=sourcecleaner_LocatedElement_strategy)
def test_hyp_sourcecleaner_locatedelement_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_sourcecleaner_schema_pluginName_setter(instance):
...
@given(instance=sourcecleaner_Schema_strategy)
def test_hyp_sourcecleaner_schema_extensionId_setter(instance):
...
@given(instance=sourcecleaner_Schema_strategy)
def test_hyp_sourcecleaner_schema_extensionName_setter(instance):
...
def test_hyp_sourcecleaner_extensionpoint_diagraph_setter(instance):
    original = instance.diagraph
    instance.diagraph = original
    assert instance.diagraph == original
...
@given(instance=sourcecleaner_ExtensionPoint_strategy)
def test_hyp_sourcecleaner_extensionpoint_id_setter(instance):
...
@given(instance=sourcecleaner_ExtensionPoint_strategy)
def test_hyp_sourcecleaner_extensionpoint_schema_setter(instance):
...
@given(instance=sourcecleaner_ExtensionPoint_strategy)
def test_hyp_sourcecleaner_extensionpoint_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_sourcecleaner_extension_diagraph_setter(instance):
    original = instance.diagraph
    instance.diagraph = original
    assert instance.diagraph == original
...
@given(instance=sourcecleaner_Extension_strategy)
def test_hyp_sourcecleaner_extension_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=sourcecleaner_Extension_strategy)
def test_hyp_sourcecleaner_extension_extra_setter(instance):
...
@given(instance=sourcecleaner_Extension_strategy)
def test_hyp_sourcecleaner_extension_pointId_setter(instance):
...
@given(instance=sourcecleaner_Extension_strategy)
def test_hyp_sourcecleaner_extension_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
@given(instance=sourcecleaner_Extension_strategy)
def test_hyp_sourcecleaner_extension_clazz_setter(instance):
...
def test_hyp_sourcecleaner_export_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_sourcecleaner_classpath_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_sourcecleaner_source_mark_setter(instance):
...
@given(instance=sourcecleaner_Source_strategy)
def test_hyp_sourcecleaner_source_handled_setter(instance):
...
@given(instance=sourcecleaner_Source_strategy)
def test_hyp_sourcecleaner_source_comment_setter(instance):
...
@given(instance=sourcecleaner_Source_strategy)
def test_hyp_sourcecleaner_source_content_setter(instance):
...
def test_hyp_sourcecleaner_project_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
@given(instance=sourcecleaner_Project_strategy)
def test_hyp_sourcecleaner_project_workspace_setter(instance):
...
def test_hyp_sourcecleaner_configuration_temp_setter(instance):
...
@given(instance=sourcecleaner_Configuration_strategy)
def test_hyp_sourcecleaner_configuration_location_setter(instance):
...
def test_hyp_sourcecleaner_plugin_extra_setter(instance):
    original = instance.extra
    instance.extra = original
    assert instance.extra == original
...
def test_hyp_sourcecleaner_manifest_executionEnvironment_setter(instance):
...
@given(instance=sourcecleaner_Manifest_strategy)
def test_hyp_sourcecleaner_manifest_vendor_setter(instance):
...
@given(instance=sourcecleaner_Manifest_strategy)
def test_hyp_sourcecleaner_manifest_diagraph_setter(instance):
    original = instance.diagraph
    instance.diagraph = original
    assert instance.diagraph == original
...
@given(instance=sourcecleaner_Manifest_strategy)
def test_hyp_sourcecleaner_manifest_symbolicName_setter(instance):
...
@given(instance=sourcecleaner_Manifest_strategy)
def test_hyp_sourcecleaner_manifest_singleton_setter(instance):
...
@given(instance=sourcecleaner_Manifest_strategy)
def test_hyp_sourcecleaner_manifest_version_setter(instance):
    original = instance.version
    instance.version = original
    assert instance.version == original
...
@given(instance=sourcecleaner_Manifest_strategy)
def test_hyp_sourcecleaner_manifest_lazy_setter(instance):
...
@given(instance=sourcecleaner_Manifest_strategy)
def test_hyp_sourcecleaner_manifest_versionId_setter(instance):
...
@given(instance=sourcecleaner_Manifest_strategy)
def test_hyp_sourcecleaner_manifest_versionQualifier_setter(instance):
...
def test_hyp_sourcecleaner_java_package_setter(instance):
    original = instance.package
    instance.package = original
    assert instance.package == original
