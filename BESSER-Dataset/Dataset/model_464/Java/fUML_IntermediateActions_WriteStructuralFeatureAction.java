...
public class fUML_IntermediateActions_WriteStructuralFeatureAction extends StructuralFeatureAction {
    ...
    public fUML_IntermediateActions_WriteStructuralFeatureAction(
    ) {
        super(
        );
    }
