...
public class fUML_IntermediateActions_ReadStructuralFeatureAction extends StructuralFeatureAction {
    ...
    public fUML_IntermediateActions_ReadStructuralFeatureAction(
    ) {
        super(
        );
    }
