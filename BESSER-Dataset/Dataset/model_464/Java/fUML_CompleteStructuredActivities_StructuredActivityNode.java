...
public class fUML_CompleteStructuredActivities_StructuredActivityNode extends Action {
    ...
    public fUML_CompleteStructuredActivities_StructuredActivityNode(
        boolean mustIsolate        ArrayList<IntermediateActivities_ActivityEdge> intermediateactivities_activityedges,        ArrayList<BasicActions_InputPin> basicactions_inputpins,        ArrayList<BasicActions_OutputPin> basicactions_outputpins,        ArrayList<IntermediateActivities_ActivityNode> intermediateactivities_activitynodes    ) {
        this.mustIsolate = mustIsolate;
