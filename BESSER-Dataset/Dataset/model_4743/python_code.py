...
class swml_v2_Attribute:
    ...
    def __init__(self, name: str, type: str, swml_v2_Attribute14: "swml_v2_Class" = None, swml_v2_Attribute: "swml_v2_Class" = None):
        self.name = name
        self.type = type
...
class swml_v2_Class:
    ...
    def __init__(self, name: str, swml_v2_Class13: "swml_v2_Attribute" = None, swml_v2_Class: "swml_v2_ContentLayer" = None, swml_v2_Class11: set["swml_v2_Attribute"] = None, swml_v2_Class18: "swml_v2_DynamicPage" = None):
        self.name = name
...
class swml_v2_Page(ABC):
    ...
    def __init__(self, name: str, swml_v2_Page: "swml_v2_NavigationLayer" = None, swml_v2_Page7: "swml_v2_NavigationLayer" = None, swml_v2_Page21: "swml_v2_Link" = None, swml_v2_Page16: set["swml_v2_Link"] = None):
        self.name = name
