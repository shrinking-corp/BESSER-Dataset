...
class transformr_Node(GraphElement):
    ...
    def __init__(self, transformr_Node2: set["transformr_Edge"] = None, transformr_Node4: set["transformr_Attribute"] = None, transformr_Node: "transformr_Graph" = None, transformr_Node7: "transformr_Edge" = None):
