...
# Classes
refinher2_BB = Class(name="refinher2_BB")
refinher2_DR = Class(name="refinher2_DR")
E = Class(name="E")
refinher2_DC = Class(name="refinher2_DC")
refinher2_DG = Class(name="refinher2_DG")
refinher2_E = Class(name="refinher2_E", is_abstract=True)
DNamedElement = Class(name="DNamedElement")
refinher2_N = Class(name="refinher2_N")
refinher2_M = Class(name="refinher2_M")
refinher2_DNamedElement = Class(name="refinher2_DNamedElement", is_abstract=True)
refinher2_DL = Class(name="refinher2_DL")
CE = Class(name="CE")
refinher2_H = Class(name="refinher2_H")
N = Class(name="N")
refinher2_Y = Class(name="refinher2_Y")
refinher2_AB = Class(name="refinher2_AB")
refinher2_A = Class(name="refinher2_A", is_abstract=True)
refinher2_CE = Class(name="refinher2_CE", is_abstract=True)
A = Class(name="A")
M = Class(name="M")
...
domain_model = DomainModel(
    name="refinher2",
    types={refinher2_BB, refinher2_DR, E, refinher2_DC, refinher2_DG, refinher2_E, DNamedElement, refinher2_N, refinher2_M, refinher2_DNamedElement, refinher2_DL, CE, refinher2_H, N, refinher2_Y, refinher2_AB, refinher2_A, refinher2_CE, A, M},
    associations={bBridge3, sn0, tn1, es16, ns4, bridges6, abridges9, aBridge11, n13},
    generalizations={gen_refinher2_DR_E, gen_refinher2_DC_CE, gen_refinher2_E_DNamedElement, gen_refinher2_DL_CE, gen_refinher2_H_N, gen_refinher2_Y_N, gen_refinher2_A_DNamedElement, gen_refinher2_CE_A, gen_refinher2_CE_E, gen_refinher2_N_DNamedElement, gen_refinher2_N_A, gen_refinher2_N_M, gen_refinher2_BB_DNamedElement, gen_refinher2_AB_DNamedElement},
    metadata=None
)
