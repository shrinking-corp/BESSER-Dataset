...
# Classes
reqLanguage_Requirement = Class(name="reqLanguage_Requirement")
reqLanguage_ReqID = Class(name="reqLanguage_ReqID")
reqLanguage_Model = Class(name="reqLanguage_Model")
reqLanguage_ActorEvent = Class(name="reqLanguage_ActorEvent")
reqLanguage_Parameter = Class(name="reqLanguage_Parameter")
reqLanguage_Prefix = Class(name="reqLanguage_Prefix")
reqLanguage_EObject = Class(name="reqLanguage_EObject")
reqLanguage_PrefixRightOperand = Class(name="reqLanguage_PrefixRightOperand")
reqLanguage_PrefixState = Class(name="reqLanguage_PrefixState")
reqLanguage_PrefixCondition = Class(name="reqLanguage_PrefixCondition")
reqLanguage_Operator = Class(name="reqLanguage_Operator")
reqLanguage_Value = Class(name="reqLanguage_Value")
reqLanguage_TimingConstraint = Class(name="reqLanguage_TimingConstraint")
reqLanguage_PrefixEvent = Class(name="reqLanguage_PrefixEvent")
reqLanguage_ParamEvent = Class(name="reqLanguage_ParamEvent")
reqLanguage_NoTransition = Class(name="reqLanguage_NoTransition")
reqLanguage_StateEvent = Class(name="reqLanguage_StateEvent")
reqLanguage_System = Class(name="reqLanguage_System")
reqLanguage_State = Class(name="reqLanguage_State")
reqLanguage_ParameterState = Class(name="reqLanguage_ParameterState")
reqLanguage_MainFunction = Class(name="reqLanguage_MainFunction")
reqLanguage_Action = Class(name="reqLanguage_Action")
reqLanguage_MainComposition = Class(name="reqLanguage_MainComposition")
reqLanguage_MainStateTransition = Class(name="reqLanguage_MainStateTransition")
reqLanguage_MainAttributes = Class(name="reqLanguage_MainAttributes")
reqLanguage_Attribute = Class(name="reqLanguage_Attribute")
reqLanguage_MainFunctions = Class(name="reqLanguage_MainFunctions")
reqLanguage_Function = Class(name="reqLanguage_Function")
reqLanguage_Transition = Class(name="reqLanguage_Transition")
reqLanguage_OutTransition = Class(name="reqLanguage_OutTransition")
reqLanguage_Actor = Class(name="reqLanguage_Actor")
reqLanguage_User = Class(name="reqLanguage_User")
reqLanguage_Time = Class(name="reqLanguage_Time")
...
reqLanguage_Parameter.attributes={reqLanguage_Parameter_name, reqLanguage_Parameter_parameter}
...
reqLanguage_TimingConstraint.attributes={reqLanguage_TimingConstraint_timingConstraint, reqLanguage_TimingConstraint_minmax}
...
reqLanguage_System.attributes={reqLanguage_System_name, reqLanguage_System_system}
...
reqLanguage_Action.attributes={reqLanguage_Action_name, reqLanguage_Action_action}
...
reqLanguage_Attribute.attributes={reqLanguage_Attribute_attribute, reqLanguage_Attribute_name, reqLanguage_Attribute_type}
...
reqLanguage_Function.attributes={reqLanguage_Function_name, reqLanguage_Function_type, reqLanguage_Function_function}
...
reqLanguage_Actor.attributes={reqLanguage_Actor_name, reqLanguage_Actor_actor}
...
domain_model = DomainModel(
    name="reqLanguage",
    types={reqLanguage_Requirement, reqLanguage_ReqID, reqLanguage_Model, reqLanguage_ActorEvent, reqLanguage_Parameter, reqLanguage_Prefix, reqLanguage_EObject, reqLanguage_PrefixRightOperand, reqLanguage_PrefixState, reqLanguage_PrefixCondition, reqLanguage_Operator, reqLanguage_Value, reqLanguage_TimingConstraint, reqLanguage_PrefixEvent, reqLanguage_ParamEvent, reqLanguage_NoTransition, reqLanguage_StateEvent, reqLanguage_System, reqLanguage_State, reqLanguage_ParameterState, reqLanguage_MainFunction, reqLanguage_Action, reqLanguage_MainComposition, reqLanguage_MainStateTransition, reqLanguage_MainAttributes, reqLanguage_Attribute, reqLanguage_MainFunctions, reqLanguage_Function, reqLanguage_Transition, reqLanguage_OutTransition, reqLanguage_Actor, reqLanguage_User, reqLanguage_Time},
    associations={requirements0, reqID1, value29, actor32, prefix3, mainRequirement5, leftOperand7, prefixList10, prefixRightOperand12, stateExpression15, parameter17, operator19, value21, time23, event_expression25, parameter27, source_state74, state76, entity34, system36, state37, parameter39, parameter_value41, system44, function46, system48, subsystemList50, system53, transition55, function58, system61, attributeList63, system65, functionList67, source_state69, target_state71, parameter78, value81, subject84, time87},
    generalizations={},
    metadata=None
)
