...
class reqLanguage_Function:
    ...
    def __init__(self, function: str, name: str, type: str, reqLanguage_Function: "reqLanguage_MainFunctions" = None):
...
class reqLanguage_Action:
    ...
    def __init__(self, action: str, name: str, reqLanguage_Action: "reqLanguage_MainFunction" = None, reqLanguage_Action60: "reqLanguage_MainStateTransition" = None, reqLanguage_Action79: "reqLanguage_Parameter" = None, reqLanguage_Action82: "reqLanguage_Value" = None, reqLanguage_Action85: "reqLanguage_EObject" = None):
        self.action = action
        self.name = name
...
class reqLanguage_ParamEvent:
    ...
    def __init__(self, action: str, reqLanguage_ParamEvent30: "reqLanguage_Value" = None, reqLanguage_ParamEvent: "reqLanguage_EObject" = None):
        self.action = action
...
class reqLanguage_Value:
    ...
    def __init__(self, val: str, value: int, reqLanguage_Value31: "reqLanguage_ParamEvent" = None, reqLanguage_Value: "reqLanguage_PrefixCondition" = None, reqLanguage_Value83: "reqLanguage_Action" = None):
        self.val = val
        self.value = value
...
class reqLanguage_Parameter:
    ...
    def __init__(self, parameter: str, name: str, reqLanguage_Parameter: "reqLanguage_ActorEvent" = None, reqLanguage_Parameter40: "reqLanguage_ParameterState" = None, reqLanguage_Parameter80: "reqLanguage_Action" = None):
