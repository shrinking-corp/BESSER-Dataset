...
class database_Table:
    ...
    def __init__(self, Name: str, DbTable: "database_Database" = None, ColumnTable: set["database_Column"] = None, Table5: "database_Column" = None, database_Table: "database_ForeignKey" = None, database_Table9: "database_ForeignKey" = None, Table: "database_Database" = None):
        self.Name = Name
