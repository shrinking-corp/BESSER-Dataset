...
domain_model = DomainModel(
    name="ImperativeOCL",
    types={ImperativeOCL_AltExp, ImperativeExpression, ImperativeOCL_AssertExp, LogExp, ImperativeOCL_BreakExp, ImperativeOCL_CatchExp, ImperativeOCL_ComputeExp, ImperativeOCL_ContinueExp, ImperativeOCL_DictLiteralExp, DictLiteralPart, ImperativeOCL_AssignExp, ImperativeOCL_BlockExp, ImperativeOCL_DictionaryType, ImperativeOCL_ForExp, ImperativeLoopExp, ImperativeOCL_ImperativeExpression, ImperativeOCL_ImperativeIterateExp, ImperativeOCL_ImperativeLoopExp, ImperativeOCL_InstantiationExp, ImperativeOCL_ListLiteralExp, ImperativeOCL_DictLiteralPart, ImperativeOCL_ReturnExp, ImperativeOCL_SwitchExp, AltExp, ImperativeOCL_TryExp, CatchExp, ImperativeOCL_Typedef, ImperativeOCL_ListType, ImperativeOCL_LogExp, ImperativeOCL_OrderedTupleLiteralExp, OrderedTupleLiteralPart, ImperativeOCL_OrderedTupleLiteralPart, ImperativeOCL_OrderedTupleType, ImperativeOCL_RaiseExp, ImperativeOCL_UnlinkExp, ImperativeOCL_UnpackExp, ImperativeOCL_VariableInitExp, ImperativeOCL_WhileExp, SeverityKind},
    associations={log0, part1, alternativePart3, exceptClause4, part2},
    generalizations={gen_ImperativeOCL_AltExp_ImperativeExpression, gen_ImperativeOCL_AssertExp_ImperativeExpression, gen_ImperativeOCL_BreakExp_ImperativeExpression, gen_ImperativeOCL_CatchExp_ImperativeExpression, gen_ImperativeOCL_ComputeExp_ImperativeExpression, gen_ImperativeOCL_ContinueExp_ImperativeExpression, gen_ImperativeOCL_AssignExp_ImperativeExpression, gen_ImperativeOCL_BlockExp_ImperativeExpression, gen_ImperativeOCL_ForExp_ImperativeLoopExp, gen_ImperativeOCL_ImperativeIterateExp_ImperativeLoopExp, gen_ImperativeOCL_InstantiationExp_ImperativeExpression, gen_ImperativeOCL_ReturnExp_ImperativeExpression, gen_ImperativeOCL_SwitchExp_ImperativeExpression, gen_ImperativeOCL_TryExp_ImperativeExpression, gen_ImperativeOCL_RaiseExp_ImperativeExpression, gen_ImperativeOCL_UnlinkExp_ImperativeExpression, gen_ImperativeOCL_UnpackExp_ImperativeExpression, gen_ImperativeOCL_VariableInitExp_ImperativeExpression, gen_ImperativeOCL_WhileExp_ImperativeExpression},
    metadata=None
)
