...
domain_model = DomainModel(
    name="sWML",
    types={sWML_Class, sWML_Attribute, sWML_WebModel, sWML_HypertextLayer, sWML_ContentLayer, sWML_IndexPage, SWMLTypes},
    associations={pages3, displayedClass5, classes7, hypertext0, content1, attributes10},
    generalizations={},
    metadata=None
)
