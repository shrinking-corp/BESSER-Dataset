...
@given(instance=Course_strategy)
def test_hyp_course_Timing_setter(instance):
...
@given(instance=Student_strategy)
def test_hyp_student_Age_setter(instance):
...
def test_hyp_teacher_Age_setter(instance):
    original = instance.Age
    instance.Age = original
    assert instance.Age == original
...
def test_Course_Timing_value_roundtrip():
    instance = Course(Timing="sample_text", name="sample_text")
...
def test_Student_Age_value_roundtrip():
    instance = Student(Age=7, Phone=7, name="sample_text")
...
def test_Teacher_Age_value_roundtrip():
    instance = Teacher(Age=7, Phone=7, name="sample_text")
    assert instance.Age == 7
    instance.Age = 13
    assert instance.Age == 13
...
def test_assoc_Student_Course_link_reassign_clear():
    a = Student(Age=7, Phone=7, name="sample_text")
    b1 = Course(Timing="sample_text", name="sample_text")
    b2 = Course(Timing="sample_text_2", name="sample_text_2")
    ...
    _safe_set(a, 'course8', set())
    assert not _is_linked(a, 'course8', b2)
    if hasattr(b2, 'student9'):
        assert not _is_linked(b2, 'student9', a)


def test_assoc_Teacher__Course_link_reassign_clear():
    a = Teacher(Age=7, Phone=7, name="sample_text")
    b1 = Course(Timing="sample_text", name="sample_text")
    b2 = Course(Timing="sample_text_2", name="sample_text_2")
    _safe_set(a, 'course6', {b1})
    assert _is_linked(a, 'course6', b1)
    if hasattr(b1, 'teacher7'):
        assert _is_linked(b1, 'teacher7', a)
    _safe_set(a, 'course6', {b2})
    assert _is_linked(a, 'course6', b2)
    if hasattr(b1, 'teacher7'):
        assert not _is_linked(b1, 'teacher7', a)
    if hasattr(b2, 'teacher7'):
        assert _is_linked(b2, 'teacher7', a)
    _safe_set(a, 'course6', set())
    assert not _is_linked(a, 'course6', b2)
    if hasattr(b2, 'teacher7'):
        assert not _is_linked(b2, 'teacher7', a)


def test_assoc_Teacher__Student_link_reassign_clear():
    a = Teacher(Age=7, Phone=7, name="sample_text")
    b1 = Student(Age=7, Phone=7, name="sample_text")
    b2 = Student(Age=13, Phone=13, name="sample_text_2")
    _safe_set(a, 'student10', {b1})
    assert _is_linked(a, 'student10', b1)
    if hasattr(b1, 'teacher11'):
        assert _is_linked(b1, 'teacher11', a)
    _safe_set(a, 'student10', {b2})
    assert _is_linked(a, 'student10', b2)
    if hasattr(b1, 'teacher11'):
        assert not _is_linked(b1, 'teacher11', a)
    if hasattr(b2, 'teacher11'):
        assert _is_linked(b2, 'teacher11', a)
    _safe_set(a, 'student10', set())
    assert not _is_linked(a, 'student10', b2)
    if hasattr(b2, 'teacher11'):
        assert not _is_linked(b2, 'teacher11', a)
...
Course_strategy = st.builds(Course, Timing=safe_text, name=safe_text)
@given(instance=Course_strategy)
...
Student_strategy = st.builds(Student, Age=st.integers(), Phone=st.integers(), name=safe_text)
@given(instance=Student_strategy)
@settings(max_examples=25)
...
Teacher_strategy = st.builds(Teacher, Age=st.integers(), Phone=st.integers(), name=safe_text)
@given(instance=Teacher_strategy)
@settings(max_examples=25)
