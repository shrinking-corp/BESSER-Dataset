...
def test_course_has_Timing():
    assert hasattr(Course, "Timing")
    descriptor = None
    for klass in Course.__mro__:
...
def test_teacher_has_Age():
    assert hasattr(Teacher, "Age")
    descriptor = None
...
@given(instance=Course_strategy)
def test_course_Timing_setter(instance):
...
@given(instance=Student_strategy)
def test_student_Age_setter(instance):
...
@given(instance=Teacher_strategy)
def test_teacher_Age_setter(instance):
    original = instance.Age
    instance.Age = original
    assert instance.Age == original
