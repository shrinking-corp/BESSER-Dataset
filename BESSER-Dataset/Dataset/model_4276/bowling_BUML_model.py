...
bowling_Player.attributes={bowling_Player_dateOfBirth, bowling_Player_heigth, bowling_Player_isProfessional, bowling_Player_name}
...
domain_model = DomainModel(
    name="bowling",
    types={bowling_Player, bowling_league, bowling_Game, bowling_Tournament, bowling_Matchup, TournamentType},
    associations={games2, matchup3, player4, Players0, matchups1},
    generalizations={},
    metadata=None
)
