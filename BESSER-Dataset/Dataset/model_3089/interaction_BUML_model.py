...
# Classes
interaction_Part = Class(name="interaction_Part")
interaction_AbstractFunction = Class(name="interaction_AbstractFunction")
interaction_SequenceMessageValuation = Class(name="interaction_SequenceMessageValuation")
interaction_Scenario = Class(name="interaction_Scenario")
Namespace = Class(name="Namespace")
AbstractBehavior = Class(name="AbstractBehavior")
interaction_SequenceMessage = Class(name="interaction_SequenceMessage")
NamedElement = Class(name="NamedElement")
interaction_Constraint = Class(name="interaction_Constraint")
interaction_AbstractEventOperation = Class(name="interaction_AbstractEventOperation")
interaction_ExchangeItem = Class(name="interaction_ExchangeItem")
interaction_State = Class(name="interaction_State")
interaction_FunctionalChain = Class(name="interaction_FunctionalChain")
interaction_CombinedFragment = Class(name="interaction_CombinedFragment")
interaction_InteractionOperand = Class(name="interaction_InteractionOperand")
interaction_ExchangeItemElement = Class(name="interaction_ExchangeItemElement")
interaction_AbstractCapability = Class(name="interaction_AbstractCapability", is_abstract=True)
...
interaction_ValueSpecification = Class(name="interaction_ValueSpecification")
...
interaction_Scenario.attributes={interaction_Scenario_merged, interaction_Scenario_kind}
...
domain_model = DomainModel(
    name="interaction",
    types={interaction_Part, interaction_AbstractFunction, interaction_SequenceMessageValuation, interaction_Scenario, Namespace, AbstractBehavior, interaction_SequenceMessage, NamedElement, interaction_Constraint, interaction_AbstractEventOperation, interaction_ExchangeItem, interaction_State, interaction_FunctionalChain, interaction_CombinedFragment, interaction_InteractionOperand, interaction_ExchangeItemElement, interaction_AbstractCapability, Structure, AbstractFunctionalChainContainer, CapellaElement, interaction_ValueSpecification, MessageKind, ScenarioKind, InteractionOperatorKind},
    associations={sendingPart5, receivingPart7, sendingFunction10, receivingFunction12, ownedSequenceMessageValuations15, preCondition17, postCondition19, ownedMessages22, containedFunctions25, containedParts28, exchangeContext0, invokedOperation1, exchangedItems3, super46, includedAbstractCapabilities49, extendedAbstractCapabilities52, availableInStates54, involvedAbstractFunctions56, involvedFunctionalChains59, guard61, exchangeItemElement63, referencedScenarios32, realizedScenarios35, preCondition37, postCondition39, ownedScenarios42, value65},
    generalizations={gen_interaction_Scenario_Namespace, gen_interaction_Scenario_AbstractBehavior, gen_interaction_SequenceMessage_NamedElement, gen_interaction_CombinedFragment_NamedElement, gen_interaction_InteractionOperand_NamedElement, gen_interaction_SequenceMessageValuation_CapellaElement, gen_interaction_AbstractCapability_Structure, gen_interaction_AbstractCapability_AbstractFunctionalChainContainer, gen_interaction_AbstractCapability_CapellaElement},
    metadata=None
)
