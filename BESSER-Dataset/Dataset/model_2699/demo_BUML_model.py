...
# Classes
democea_ConceptA = Class(name="democea_ConceptA")
democea_ConceptB = Class(name="democea_ConceptB")
ConceptA = Class(name="ConceptA")
democea_ConceptC = Class(name="democea_ConceptC")
...
domain_model = DomainModel(
    name="democea",
    types={democea_ConceptA, democea_ConceptB, ConceptA, democea_ConceptC},
    associations={cs0, b1},
