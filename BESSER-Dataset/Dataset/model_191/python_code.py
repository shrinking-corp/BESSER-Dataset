...
class ecore_EClassifier(ENamedElement):
    ...
    def __init__(self, instanceClassName: str, instanceClass: str, defaultValue: str, instanceTypeName: str, ecore_EClassifier56: "ecore_EOperation" = None, EClassifier: "ecore_EPackage" = None, eClassifiers: "ecore_EPackage" = None, ecore_EClassifier: set["ecore_ETypeParameter"] = None, ecore_EClassifier83: "ecore_ETypedElement" = None, ecore_EClassifier95: "ecore_EGenericType" = None, ecore_EClassifier104: "ecore_EGenericType" = None):
...
class ecore_EStructuralFeature(ETypedElement):
    ...
    def __init__(self, unsettable: bool, changeable: bool, volatile: bool, transient: bool, defaultValueLiteral: str, defaultValue: str, derived: bool, ecore_EStructuralFeature: "ecore_EClass" = None, EStructuralFeature: "ecore_EClass" = None, eStructuralFeatures: "ecore_EClass" = None):
