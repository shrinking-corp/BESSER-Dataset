...
ecore_EObject.methods={ecore_EObject_m_eClass, ecore_EObject_m_eResource, ecore_EObject_m_eCrossReferences, ecore_EObject_m_eIsProxy, ecore_EObject_m_eGet, ecore_EObject_m_eAllContents, ecore_EObject_m_eUnset, ecore_EObject_m_eGet, ecore_EObject_m_eContainmentFeature, ecore_EObject_m_eIsSet, ecore_EObject_m_eSet, ecore_EObject_m_eContainingFeature, ecore_EObject_m_eContents, ecore_EObject_m_eContainer}
...
ecore_EStructuralFeature.attributes={ecore_EStructuralFeature_defaultValueLiteral, ecore_EStructuralFeature_changeable, ecore_EStructuralFeature_transient, ecore_EStructuralFeature_derived, ecore_EStructuralFeature_unsettable, ecore_EStructuralFeature_volatile, ecore_EStructuralFeature_defaultValue}
