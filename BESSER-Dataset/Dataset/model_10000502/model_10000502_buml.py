...
AcceleratorCard_CPU: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="decoratedCPU18", type=CPU, multiplicity=Multiplicity(0, 1)),
        Property(name="acceleratorCard19", type=AcceleratorCard, multiplicity=Multiplicity(0, 1))
    }
)

# Domain Model
domain_model = DomainModel(
    name="_3df5e4ff_beec_4bf8_a8a6_a11e19ce5300",
    types={CPU, Processor, AcceleratorCard, Cache, RAM, Machine, Program, Instruction, Memory_Interface, Card, Sound, GenericSound, Vendor1Adapter, Vendor2Adapter, Vendor1Sound, Vendor2Sound, ExtensionBoard, FastCard},
    associations={Machine_Memory, Processor_Memory, Program_Instruction, Machine_Processor, Processor_Program, Cache_RAM, ExtensionBoard_Card, Vendor1Adapter_Vendor1Sound, Vendor2Adapter_Vendor2Sound, AcceleratorCard_CPU},
    generalizations={},
    metadata=None
)
