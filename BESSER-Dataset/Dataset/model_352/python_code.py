...
class extlibrary_Book(CirculatingItem):
    ...
    def __init__(self, title: str, pages: int, category: str, extlibrary_Book: "extlibrary_Library" = None, books: set["extlibrary_Writer"] = None, Book: "extlibrary_Writer" = None):
        self.title = title
        self.pages = pages
