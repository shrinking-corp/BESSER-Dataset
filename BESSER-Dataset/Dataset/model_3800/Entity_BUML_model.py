...
# Classes
era_System = Class(name="era_System")
era_Entity = Class(name="era_Entity")
era_Relationship = Class(name="era_Relationship")
era_Attribute = Class(name="era_Attribute")
...
era_Entity.attributes={era_Entity_inDomain, era_Entity_name}
...
domain_model = DomainModel(
    name="era",
    types={era_System, era_Entity, era_Relationship, era_Attribute},
    associations={entity0, system1, relationships2, entities3},
    generalizations={},
    metadata=None
)
