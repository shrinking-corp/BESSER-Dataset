...
# Classes
demo1_Model = Class(name="demo1_Model")
demo1_EObject = Class(name="demo1_EObject")
demo1_TestExpression = Class(name="demo1_TestExpression")
demo1_RatioExpression = Class(name="demo1_RatioExpression")
demo1_Category = Class(name="demo1_Category")
demo1_Rule = Class(name="demo1_Rule")
demo1_RuleExpression = Class(name="demo1_RuleExpression")
...
domain_model = DomainModel(
    name="demo1",
    types={demo1_Model, demo1_EObject, demo1_TestExpression, demo1_RatioExpression, demo1_Category, demo1_Rule, demo1_RuleExpression},
    associations={next5, test7, ratio9, category11, categories0, rule1, first3},
    generalizations={},
    metadata=None
)
