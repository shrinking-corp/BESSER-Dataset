...
ClassInOtherPackage_strategy = st.builds(ClassInOtherPackage)
...
test_containmentwalker_dependency_Foo_strategy = st.builds(test_containmentwalker_dependency_Foo)
...
test_containmentwalker_dependency_IsolatedClassInReachablePackage_strategy = st.builds(test_containmentwalker_dependency_IsolatedClassInReachablePackage)
...
test_containmentwalker_dependency_subpackage_ClassInOtherPackage_strategy = st.builds(test_containmentwalker_dependency_subpackage_ClassInOtherPackage)
