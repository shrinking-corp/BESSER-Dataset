...
# Classes
test_containmentwalker_dependency_Foo = Class(name="test_containmentwalker_dependency_Foo")
ClassInOtherPackage = Class(name="ClassInOtherPackage")
test_containmentwalker_dependency_IsolatedClassInReachablePackage = Class(name="test_containmentwalker_dependency_IsolatedClassInReachablePackage")
test_containmentwalker_dependency_subpackage_ClassInOtherPackage = Class(name="test_containmentwalker_dependency_subpackage_ClassInOtherPackage")
