...
def test_hyp_bibtex_literaturedb_is_not_abstract():
    assert not inspect.isabstract(Bibtex_LiteratureDb)


def test_hyp_bibtex_literaturedb_constructor_exists():
    assert callable(Bibtex_LiteratureDb.__init__)


def test_hyp_bibtex_literaturedb_constructor_args():
...
def test_hyp_bibtex_entry_id_setter(instance):
...
@given(instance=Bibtex_Entry_strategy)
def test_hyp_bibtex_entry_title_setter(instance):
...
def test_hyp_bibtex_literaturedb_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
