...
MediaLibrary_Store.attributes={MediaLibrary_Store_name, MediaLibrary_Store_url}
...
domain_model = DomainModel(
    name="MediaLibrary",
    types={MediaLibrary_Library, MediaLibrary_Ecosystem, MediaLibrary_Device, MediaLibrary_MediaSource, MediaLibrary_Artifact, MediaLibrary_MediaCollection, MediaLibrary_Tablet, Device, MediaLibrary_Computer, MediaLibrary_Smartphone, MediaLibrary_EReader, MediaLibrary_DurationArtifact, Artifact, MediaLibrary_AudioBook, DurationArtifact, MediaLibrary_MusicTrack, MediaLibrary_Video, MediaLibrary_Ebook, MediaLibrary_Image, MediaLibrary_ExternalSource, MediaSource, MediaLibrary_Store, SourceType},
    associations={libraries0, origin18, devices1, mediaSources3, mediaArtifacts5, collections7, members9, host12, syncedDevices13, hostOf15, collections16, contents19},
