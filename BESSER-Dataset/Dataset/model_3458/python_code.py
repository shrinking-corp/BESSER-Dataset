...
class featureModel_Condition:
    ...
    def __init__(self, type: str, featureModel_Condition: "featureModel_AdaptationRule" = None, featureModel_Condition24: "featureModel_IntValue" = None, featureModel_Condition26: "featureModel_Feature" = None, featureModel_Condition21: "featureModel_Attribute" = None):
        self.type = type
...
class featureModel_Feature(VariabilityElement):
    ...
    def __init__(self, name: str, selected: bool, unselected: bool, mandatory: bool, featureModel_Feature: "featureModel_FeatureModel" = None, featureModel_Feature4: set["featureModel_Attribute"] = None, featureModel_Feature7: "featureModel_Feature" = None, featureModel_Feature5: set["featureModel_Feature"] = None, featureModel_Feature9: "featureModel_Alternative" = None, featureModel_Feature13: "featureModel_BooleanConstraint" = None, featureModel_Feature16: "featureModel_BooleanConstraint" = None, featureModel_Feature27: "featureModel_Condition" = None, featureModel_Feature30: "featureModel_Action" = None):
        self.name = name
