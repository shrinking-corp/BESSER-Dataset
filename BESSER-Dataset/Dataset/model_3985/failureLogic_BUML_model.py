...
failureLogic_FaultTree = Class(name="failureLogic_FaultTree")
FailureModel = Class(name="FailureModel")
failureLogic_Cause = Class(name="failureLogic_Cause")
failureLogic_Gate = Class(name="failureLogic_Gate")
Cause = Class(name="Cause")
failureLogic_MarkovChain = Class(name="failureLogic_MarkovChain")
failureLogic_Transition = Class(name="failureLogic_Transition")
failureLogic_MinimalCutSets = Class(name="failureLogic_MinimalCutSets")
failureLogic_FMEA = Class(name="failureLogic_FMEA")
failureLogic_FMEAEntry = Class(name="failureLogic_FMEAEntry")
failureLogic_FMEDAEntry = Class(name="failureLogic_FMEDAEntry")
FMEAEntry = Class(name="FMEAEntry")
failureLogic_State = Class(name="failureLogic_State")
...
failureLogic_Failure.attributes={failureLogic_Failure_originType, failureLogic_Failure_failureRate, failureLogic_Failure_isCcf, failureLogic_Failure_failureClass}
...
domain_model = DomainModel(
    name="failureLogic",
    types={failureLogic_FailureLogicPackage, ODEProductPackage, failureLogic_FailureModel, failureLogic_Failure, BaseElement, failureLogic_ProbDist, failureLogic_SecurityViolation, Failure, failureLogic_MinimalCutset, failureLogic_ProbDistParam, failureLogic_FaultTree, FailureModel, failureLogic_Cause, failureLogic_Gate, Cause, failureLogic_MarkovChain, failureLogic_Transition, failureLogic_MinimalCutSets, failureLogic_FMEA, failureLogic_FMEAEntry, failureLogic_FMEDAEntry, FMEAEntry, failureLogic_State, GateType, CauseType, FailureOriginType, FMEAType},
    associations={failureModels0, failureProbDistribution1, ccfFailures3, cutsets13, failures15, failures18, parameters21, causes23, failure24, causes27, transitions29, minimalCutsets5, failures7, subModels11, transitionProbDistribution35, fromStates38, toStates41, entries44, effect45, mode48, diagnosisProbDistribution51, states30, failState32},
    generalizations={gen_failureLogic_FailureLogicPackage_ODEProductPackage, gen_failureLogic_Failure_BaseElement, gen_failureLogic_MinimalCutSets_BaseElement, gen_failureLogic_MinimalCutset_BaseElement, gen_failureLogic_ProbDist_BaseElement, gen_failureLogic_ProbDistParam_BaseElement, gen_failureLogic_FaultTree_FailureModel, gen_failureLogic_Cause_BaseElement, gen_failureLogic_Gate_Cause, gen_failureLogic_MarkovChain_FailureModel, gen_failureLogic_SecurityViolation_Failure, gen_failureLogic_FailureModel_BaseElement, gen_failureLogic_FMEA_FailureModel, gen_failureLogic_FMEAEntry_BaseElement, gen_failureLogic_FMEDAEntry_FMEAEntry, gen_failureLogic_State_BaseElement, gen_failureLogic_Transition_BaseElement},
    metadata=None
)
