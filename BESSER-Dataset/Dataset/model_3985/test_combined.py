...
def test_hyp_failurelogic_fmedaentry_is_not_abstract():
    assert not inspect.isabstract(failureLogic_FMEDAEntry)


def test_hyp_failurelogic_fmedaentry_constructor_exists():
    assert callable(failureLogic_FMEDAEntry.__init__)


def test_hyp_failurelogic_fmedaentry_constructor_args():
...
def test_hyp_failurelogic_gate_is_not_abstract():
    assert not inspect.isabstract(failureLogic_Gate)


def test_hyp_failurelogic_gate_constructor_exists():
    assert callable(failureLogic_Gate.__init__)


def test_hyp_failurelogic_gate_constructor_args():
...
def test_hyp_failurelogic_markovchain_is_not_abstract():
    assert not inspect.isabstract(failureLogic_MarkovChain)


def test_hyp_failurelogic_markovchain_constructor_exists():
    assert callable(failureLogic_MarkovChain.__init__)


def test_hyp_failurelogic_markovchain_constructor_args():
    sig = inspect.signature(failureLogic_MarkovChain.__init__)
    params = list(sig.parameters.keys())



def test_hyp_failurelogic_fmea_is_not_abstract():
    assert not inspect.isabstract(failureLogic_FMEA)


def test_hyp_failurelogic_fmea_constructor_exists():
    assert callable(failureLogic_FMEA.__init__)


def test_hyp_failurelogic_fmea_constructor_args():
...
def test_hyp_failurelogic_faulttree_is_not_abstract():
    assert not inspect.isabstract(failureLogic_FaultTree)


def test_hyp_failurelogic_faulttree_constructor_exists():
    assert callable(failureLogic_FaultTree.__init__)


def test_hyp_failurelogic_faulttree_constructor_args():
...
def test_hyp_failurelogic_state_is_not_abstract():
    assert not inspect.isabstract(failureLogic_State)


def test_hyp_failurelogic_state_constructor_exists():
    assert callable(failureLogic_State.__init__)


def test_hyp_failurelogic_state_constructor_args():
...
def test_hyp_failurelogic_fmeaentry_is_not_abstract():
    assert not inspect.isabstract(failureLogic_FMEAEntry)


def test_hyp_failurelogic_fmeaentry_constructor_exists():
    assert callable(failureLogic_FMEAEntry.__init__)


def test_hyp_failurelogic_fmeaentry_constructor_args():
    sig = inspect.signature(failureLogic_FMEAEntry.__init__)
    params = list(sig.parameters.keys())



def test_hyp_failurelogic_cause_is_not_abstract():
    assert not inspect.isabstract(failureLogic_Cause)


def test_hyp_failurelogic_cause_constructor_exists():
    assert callable(failureLogic_Cause.__init__)


def test_hyp_failurelogic_cause_constructor_args():
...
def test_hyp_failurelogic_transition_is_not_abstract():
    assert not inspect.isabstract(failureLogic_Transition)


def test_hyp_failurelogic_transition_constructor_exists():
    assert callable(failureLogic_Transition.__init__)


def test_hyp_failurelogic_transition_constructor_args():
...
def test_hyp_odeproductpackage_is_not_abstract():
    assert not inspect.isabstract(ODEProductPackage)


def test_hyp_odeproductpackage_constructor_exists():
    assert callable(ODEProductPackage.__init__)


def test_hyp_odeproductpackage_constructor_args():
...
def test_hyp_failurelogic_fmedaentry_diagnosisRate_setter(instance):
...
def test_hyp_failurelogic_gate_gateType_setter(instance):
...
def test_hyp_failurelogic_fmea_type_setter(instance):
...
def test_hyp_failurelogic_state_isFailState_setter(instance):
...
@given(instance=failureLogic_State_strategy)
def test_hyp_failurelogic_state_isInitialState_setter(instance):
...
def test_hyp_failurelogic_cause_causeType_setter(instance):
...
def test_hyp_failurelogic_transition_transition_setter(instance):
