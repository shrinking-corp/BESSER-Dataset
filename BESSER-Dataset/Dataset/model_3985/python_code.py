...
class failureLogic_State(BaseElement):
    ...
    def __init__(self, isInitialState: bool, isFailState: bool, failureLogic_State40: "failureLogic_Transition" = None, failureLogic_State43: "failureLogic_Transition" = None, failureLogic_State: "failureLogic_MarkovChain" = None, failureLogic_State33: "failureLogic_Failure" = None):
...
class failureLogic_ProbDist(BaseElement):
    ...
    def __init__(self, type: str, failureLogic_ProbDist: "failureLogic_Failure" = None, failureLogic_ProbDist22: set["failureLogic_ProbDistParam"] = None, failureLogic_ProbDist37: "failureLogic_Transition" = None, failureLogic_ProbDist52: "failureLogic_FMEDAEntry" = None):
        self.type = type
...
class failureLogic_Failure(BaseElement):
    ...
    def __init__(self, originType: str, failureClass: str, failureRate: float, isCcf: bool, failureLogic_Failure: "failureLogic_ProbDist" = None, failureLogic_Failure4: "failureLogic_Failure" = None, failureLogic_Failure2: set["failureLogic_Failure"] = None, failureLogic_Failure17: "failureLogic_MinimalCutSets" = None, failureLogic_Failure20: "failureLogic_MinimalCutset" = None, failureLogic_Failure26: "failureLogic_Cause" = None, failureLogic_Failure9: "failureLogic_FailureModel" = None, failureLogic_Failure47: "failureLogic_FMEAEntry" = None, failureLogic_Failure50: "failureLogic_FMEAEntry" = None, failureLogic_Failure34: "failureLogic_State" = None):
