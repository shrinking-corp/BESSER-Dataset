...
def test_hyp_crom_l1_composed_reflexive_is_not_abstract():
    assert not inspect.isabstract(crom_l1_composed_Reflexive)


def test_hyp_crom_l1_composed_reflexive_constructor_exists():
    assert callable(crom_l1_composed_Reflexive.__init__)


def test_hyp_crom_l1_composed_reflexive_constructor_args():
    sig = inspect.signature(crom_l1_composed_Reflexive.__init__)
    params = list(sig.parameters.keys())



def test_hyp_crom_l1_composed_acyclic_is_not_abstract():
    assert not inspect.isabstract(crom_l1_composed_Acyclic)


def test_hyp_crom_l1_composed_acyclic_constructor_exists():
    assert callable(crom_l1_composed_Acyclic.__init__)


def test_hyp_crom_l1_composed_acyclic_constructor_args():
...
def test_hyp_crom_l1_composed_relationshipexclusion_is_not_abstract():
    assert not inspect.isabstract(crom_l1_composed_RelationshipExclusion)


def test_hyp_crom_l1_composed_relationshipexclusion_constructor_exists():
    assert callable(crom_l1_composed_RelationshipExclusion.__init__)


def test_hyp_crom_l1_composed_relationshipexclusion_constructor_args():
