...
crom_l1_composed_NamedElement = Class(name="crom_l1_composed_NamedElement", is_abstract=True)
crom_l1_composed_ModelElement = Class(name="crom_l1_composed_ModelElement", is_abstract=True)
NamedElement = Class(name="NamedElement")
crom_l1_composed_Model = Class(name="crom_l1_composed_Model")
crom_l1_composed_Relation = Class(name="crom_l1_composed_Relation", is_abstract=True)
crom_l1_composed_RigidType = Class(name="crom_l1_composed_RigidType")
Type = Class(name="Type")
ModelElement = Class(name="ModelElement")
crom_l1_composed_Group = Class(name="crom_l1_composed_Group")
Model = Class(name="Model")
crom_l1_composed_Parameter = Class(name="crom_l1_composed_Parameter")
TypedElement = Class(name="TypedElement")
crom_l1_composed_Operation = Class(name="crom_l1_composed_Operation")
crom_l1_composed_Type = Class(name="crom_l1_composed_Type")
crom_l1_composed_Attribute = Class(name="crom_l1_composed_Attribute")
crom_l1_composed_DataType = Class(name="crom_l1_composed_DataType")
RigidType = Class(name="RigidType")
crom_l1_composed_NaturalType = Class(name="crom_l1_composed_NaturalType")
crom_l1_composed_CompartmentType = Class(name="crom_l1_composed_CompartmentType")
crom_l1_composed_Part = Class(name="crom_l1_composed_Part")
crom_l1_composed_Relationship = Class(name="crom_l1_composed_Relationship")
crom_l1_composed_Constraint = Class(name="crom_l1_composed_Constraint")
crom_l1_composed_Fulfillment = Class(name="crom_l1_composed_Fulfillment")
crom_l1_composed_AntiRigidType = Class(name="crom_l1_composed_AntiRigidType")
crom_l1_composed_RoleType = Class(name="crom_l1_composed_RoleType")
AntiRigidType = Class(name="AntiRigidType")
AbstractRole = Class(name="AbstractRole")
Relation = Class(name="Relation")
crom_l1_composed_Place = Class(name="crom_l1_composed_Place")
crom_l1_composed_CompartmentInheritance = Class(name="crom_l1_composed_CompartmentInheritance")
crom_l1_composed_IntraRelationshipConstraint = Class(name="crom_l1_composed_IntraRelationshipConstraint")
crom_l1_composed_AbstractRole = Class(name="crom_l1_composed_AbstractRole", is_abstract=True)
crom_l1_composed_Inheritance = Class(name="crom_l1_composed_Inheritance")
crom_l1_composed_RoleConstraint = Class(name="crom_l1_composed_RoleConstraint")
Constraint = Class(name="Constraint")
crom_l1_composed_RelationshipConstraint = Class(name="crom_l1_composed_RelationshipConstraint")
RelationshipConstraint = Class(name="RelationshipConstraint")
crom_l1_composed_InterRelationshipConstraint = Class(name="crom_l1_composed_InterRelationshipConstraint")
crom_l1_composed_ComplexConstraint = Class(name="crom_l1_composed_ComplexConstraint")
crom_l1_composed_DataInheritance = Class(name="crom_l1_composed_DataInheritance")
Inheritance = Class(name="Inheritance")
crom_l1_composed_NaturalInheritance = Class(name="crom_l1_composed_NaturalInheritance")
RoleGroupElement = Class(name="RoleGroupElement")
crom_l1_composed_RoleGroup = Class(name="crom_l1_composed_RoleGroup")
crom_l1_composed_RoleInheritance = Class(name="crom_l1_composed_RoleInheritance")
crom_l1_composed_RelationshipImplication = Class(name="crom_l1_composed_RelationshipImplication")
InterRelationshipConstraint = Class(name="InterRelationshipConstraint")
crom_l1_composed_RelationshipExclusion = Class(name="crom_l1_composed_RelationshipExclusion")
crom_l1_composed_RelationTarget = Class(name="crom_l1_composed_RelationTarget", is_abstract=True)
crom_l1_composed_Irreflexive = Class(name="crom_l1_composed_Irreflexive")
IntraRelationshipConstraint = Class(name="IntraRelationshipConstraint")
crom_l1_composed_Cyclic = Class(name="crom_l1_composed_Cyclic")
crom_l1_composed_Total = Class(name="crom_l1_composed_Total")
crom_l1_composed_Acyclic = Class(name="crom_l1_composed_Acyclic")
crom_l1_composed_Reflexive = Class(name="crom_l1_composed_Reflexive")
crom_l1_composed_RoleGroupElement = Class(name="crom_l1_composed_RoleGroupElement", is_abstract=True)
crom_l1_composed_RoleImplication = Class(name="crom_l1_composed_RoleImplication")
RoleConstraint = Class(name="RoleConstraint")
crom_l1_composed_RoleEquivalence = Class(name="crom_l1_composed_RoleEquivalence")
crom_l1_composed_RoleProhibition = Class(name="crom_l1_composed_RoleProhibition")
crom_l1_composed_TypedElement = Class(name="crom_l1_composed_TypedElement", is_abstract=True)
crom_l1_composed_ParthoodConstraint = Class(name="crom_l1_composed_ParthoodConstraint")
crom_l1_composed_AbstractRoleRef = Class(name="crom_l1_composed_AbstractRoleRef")
...
domain_model = DomainModel(
    ...
    types={RelationTarget, crom_l1_composed_NamedElement, crom_l1_composed_ModelElement, NamedElement, crom_l1_composed_Model, crom_l1_composed_Relation, crom_l1_composed_RigidType, Type, ModelElement, crom_l1_composed_Group, Model, crom_l1_composed_Parameter, TypedElement, crom_l1_composed_Operation, crom_l1_composed_Type, crom_l1_composed_Attribute, crom_l1_composed_DataType, RigidType, crom_l1_composed_NaturalType, crom_l1_composed_CompartmentType, crom_l1_composed_Part, crom_l1_composed_Relationship, crom_l1_composed_Constraint, crom_l1_composed_Fulfillment, crom_l1_composed_AntiRigidType, crom_l1_composed_RoleType, AntiRigidType, AbstractRole, Relation, crom_l1_composed_Place, crom_l1_composed_CompartmentInheritance, crom_l1_composed_IntraRelationshipConstraint, crom_l1_composed_AbstractRole, crom_l1_composed_Inheritance, crom_l1_composed_RoleConstraint, Constraint, crom_l1_composed_RelationshipConstraint, RelationshipConstraint, crom_l1_composed_InterRelationshipConstraint, crom_l1_composed_ComplexConstraint, crom_l1_composed_DataInheritance, Inheritance, crom_l1_composed_NaturalInheritance, RoleGroupElement, crom_l1_composed_RoleGroup, crom_l1_composed_RoleInheritance, crom_l1_composed_RelationshipImplication, InterRelationshipConstraint, crom_l1_composed_RelationshipExclusion, crom_l1_composed_RelationTarget, crom_l1_composed_Irreflexive, IntraRelationshipConstraint, crom_l1_composed_Cyclic, crom_l1_composed_Total, crom_l1_composed_Acyclic, crom_l1_composed_Reflexive, crom_l1_composed_RoleGroupElement, crom_l1_composed_RoleImplication, RoleConstraint, crom_l1_composed_RoleEquivalence, crom_l1_composed_RoleProhibition, crom_l1_composed_TypedElement, crom_l1_composed_ParthoodConstraint, crom_l1_composed_AbstractRoleRef, Direction, Parthood},
    associations={attributes7, elements0, relations1, params3, owner4, owner5, second30, operations8, tr_extends11, tr_extends13, parts14, relationships15, constraints16, tr_extends19, contains22, fulfillments24, tr_extends27, first28, sub61, tr_constraints33, filled35, filler37, first39, second41, relation44, first47, second49, targets52, super54, sub56, super59, super64, sub66, super69, sub71, holder74, incoming77, outgoing79, elements82, whole83, role84, type86, ref87},
    generalizations={gen_crom_l1_composed_Type_RelationTarget, gen_crom_l1_composed_ModelElement_NamedElement, gen_crom_l1_composed_RigidType_Type, gen_crom_l1_composed_RigidType_ModelElement, gen_crom_l1_composed_Group_ModelElement, gen_crom_l1_composed_Group_Model, gen_crom_l1_composed_Parameter_TypedElement, gen_crom_l1_composed_Operation_TypedElement, gen_crom_l1_composed_Attribute_TypedElement, gen_crom_l1_composed_DataType_RigidType, gen_crom_l1_composed_NaturalType_RigidType, gen_crom_l1_composed_CompartmentType_RigidType, gen_crom_l1_composed_AntiRigidType_Type, gen_crom_l1_composed_RoleType_AntiRigidType, gen_crom_l1_composed_RoleType_AbstractRole, gen_crom_l1_composed_Relationship_Relation, gen_crom_l1_composed_Relationship_NamedElement, gen_crom_l1_composed_CompartmentInheritance_Inheritance, gen_crom_l1_composed_Fulfillment_Relation, gen_crom_l1_composed_Inheritance_Relation, gen_crom_l1_composed_Constraint_Relation, gen_crom_l1_composed_RoleConstraint_Constraint, gen_crom_l1_composed_RelationshipConstraint_Constraint, gen_crom_l1_composed_IntraRelationshipConstraint_RelationshipConstraint, gen_crom_l1_composed_InterRelationshipConstraint_RelationshipConstraint, gen_crom_l1_composed_ComplexConstraint_Constraint, gen_crom_l1_composed_DataInheritance_Inheritance, gen_crom_l1_composed_NaturalInheritance_Inheritance, gen_crom_l1_composed_AbstractRole_RoleGroupElement, gen_crom_l1_composed_RoleGroup_AbstractRole, gen_crom_l1_composed_RoleGroup_RelationTarget, gen_crom_l1_composed_RoleInheritance_Inheritance, gen_crom_l1_composed_RelationshipImplication_InterRelationshipConstraint, gen_crom_l1_composed_RelationshipExclusion_InterRelationshipConstraint, gen_crom_l1_composed_RelationTarget_NamedElement, gen_crom_l1_composed_Irreflexive_IntraRelationshipConstraint, gen_crom_l1_composed_Cyclic_IntraRelationshipConstraint, gen_crom_l1_composed_Total_IntraRelationshipConstraint, gen_crom_l1_composed_Acyclic_IntraRelationshipConstraint, gen_crom_l1_composed_Reflexive_IntraRelationshipConstraint, gen_crom_l1_composed_RoleImplication_RoleConstraint, gen_crom_l1_composed_RoleEquivalence_RoleConstraint, gen_crom_l1_composed_RoleProhibition_RoleConstraint, gen_crom_l1_composed_TypedElement_NamedElement, gen_crom_l1_composed_ParthoodConstraint_IntraRelationshipConstraint, gen_crom_l1_composed_AbstractRoleRef_RoleGroupElement},
    metadata=None
)
