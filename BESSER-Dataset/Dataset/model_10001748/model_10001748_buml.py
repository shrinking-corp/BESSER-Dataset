...
ClassA.attributes={ClassA_publicAttribute, ClassA_packageAttribute, ClassA_protectedAttribute, ClassA_privateAttribute}
...
ClassC.attributes={ClassC_packageAttribute, ClassC_protectedAttribute, ClassC_publicAttribute, ClassC_privateAttribute}
...
ClassM_ClassP: BinaryAssociation = BinaryAssociation(
    name="ClassM_ClassP",
    ends={
        Property(name="classP6", type=ClassP, multiplicity=Multiplicity(0, 1)),
        Property(name="classM7", type=ClassM, multiplicity=Multiplicity(0, 1))
    }
)
...
domain_model = DomainModel(
    ...
    associations={ClassD_ClassECopyCopy, ClassM_ClassP, ClassD_ClassE, ClassD_ClassECopy},
    generalizations={},
    metadata=None
)
