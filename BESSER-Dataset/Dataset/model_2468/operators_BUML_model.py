...
operators_Network.attributes={operators_Network_description, operators_Network_name, operators_Network_createdDate}
...
domain_model = DomainModel(
    name="operators",
    types={operators_EquipmentRelationship, Relationship, operators_Equipment, operators_FunctionRelationship, operators_Function, operators_Marker, Base, operators_Value, operators_Network, operators_DiagramInfo, operators_Node, operators_NetXResource, operators_Person, operators_Lifecycle, operators_NodeType, operators_Location, operators_MetricSource, operators_Operator, Company, operators_Warehouse, operators_Service, operators_ServiceUser, operators_Relationship, operators_Protocol, operators_ResourceExpansion, operators_ResourceMonitor, operators_DateTimeRange, operators_ToleranceMarker, Marker, operators_ResourceForecast, MarkerKind, ToleranceMarkerDirectionKind},
    associations={equipment1Ref0, equipment2Ref1, function1Ref4, function2Ref5, valueRef8, diagrams11, nodes12, networks15, functionRelationships17, equipmentRelationships20, markerResourceRef9, createdByRef25, lifecycle27, nodeType29, createdByRef31, locationRef34, metricSources23, networks39, warehouses41, services43, originalNodeTypeRef36, nodeID1Ref49, nodeID2Ref51, protocolRef54, nodeRefs56, equipmentRefs59, functionRefs62, serviceUsers45, resourceExpansions47, markers67, nodeRef69, resourceRef72, period75, markers65, equipments80, nodes77},
    generalizations={gen_operators_EquipmentRelationship_Relationship, gen_operators_FunctionRelationship_Relationship, gen_operators_Marker_Base, gen_operators_Network_Base, gen_operators_Node_Base, gen_operators_Operator_Company, gen_operators_Relationship_Base, gen_operators_ResourceExpansion_Base, gen_operators_ResourceMonitor_Base, gen_operators_ToleranceMarker_Marker, gen_operators_ResourceForecast_Base, gen_operators_Warehouse_Base},
    metadata=None
)
