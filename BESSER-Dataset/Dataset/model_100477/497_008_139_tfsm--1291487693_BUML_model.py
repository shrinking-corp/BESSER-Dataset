...
# Classes
tfsmextended_TFSM = Class(name="tfsmextended_TFSM")
NamedElement = Class(name="NamedElement")
tfsmextended_State = Class(name="tfsmextended_State")
tfsmextended_FSMEvent = Class(name="tfsmextended_FSMEvent")
tfsmextended_FSMClock = Class(name="tfsmextended_FSMClock")
tfsmextended_Transition = Class(name="tfsmextended_Transition")
tfsmextended_TimedSystem = Class(name="tfsmextended_TimedSystem")
tfsmextended_EvaluateGuard = Class(name="tfsmextended_EvaluateGuard")
tfsmextended_Guard = Class(name="tfsmextended_Guard", is_abstract=True)
tfsmextended_NamedElement = Class(name="tfsmextended_NamedElement")
tfsmextended_TemporalGuard = Class(name="tfsmextended_TemporalGuard")
Guard = Class(name="Guard")
tfsmextended_EventGuard = Class(name="tfsmextended_EventGuard")
...
domain_model = DomainModel(
    name="tfsmextended",
    types={tfsmextended_TFSM, NamedElement, tfsmextended_State, tfsmextended_FSMEvent, tfsmextended_FSMClock, tfsmextended_Transition, tfsmextended_TimedSystem, tfsmextended_EvaluateGuard, tfsmextended_Guard, tfsmextended_NamedElement, tfsmextended_TemporalGuard, Guard, tfsmextended_EventGuard},
    associations={currentState8, owningFSM11, outgoingTransitions12, incomingTransitions13, source15, ownedStates0, initialState1, localEvents2, localClock4, ownedTransitions6, tfsms31, globalClocks33, globalEvents36, target17, ownedGuard19, generatedEvents21, onClock24, triggeringEvent26, sollicitingTransitions28},
    generalizations={gen_tfsmextended_State_NamedElement, gen_tfsmextended_Transition_NamedElement, gen_tfsmextended_TFSM_NamedElement, gen_tfsmextended_FSMClock_NamedElement, gen_tfsmextended_TimedSystem_NamedElement, gen_tfsmextended_EvaluateGuard_Guard, gen_tfsmextended_Guard_NamedElement, gen_tfsmextended_TemporalGuard_Guard, gen_tfsmextended_EventGuard_Guard, gen_tfsmextended_FSMEvent_NamedElement},
    metadata=None
)
