...
from python_code import (
    ...
    ClassD,
    ClassC,
    ProviderACSearchHandler,
    com_changehealthcare_datamatching_DataMatchingController,
    ClassV,
    ClassU,
    ClassT,
    ClassS,
...
def test_hyp_provideracsearchhandler_is_not_abstract():
    assert not inspect.isabstract(ProviderACSearchHandler)


def test_hyp_provideracsearchhandler_constructor_exists():
    assert callable(ProviderACSearchHandler.__init__)


def test_hyp_provideracsearchhandler_constructor_args():
    sig = inspect.signature(ProviderACSearchHandler.__init__)
    params = list(sig.parameters.keys())



def test_hyp_com_changehealthcare_datamatching_datamatchingcontroller_is_not_abstract():
    assert not inspect.isabstract(com_changehealthcare_datamatching_DataMatchingController)


def test_hyp_com_changehealthcare_datamatching_datamatchingcontroller_constructor_exists():
    assert callable(com_changehealthcare_datamatching_DataMatchingController.__init__)


def test_hyp_com_changehealthcare_datamatching_datamatchingcontroller_constructor_args():
    sig = inspect.signature(com_changehealthcare_datamatching_DataMatchingController.__init__)
    params = list(sig.parameters.keys())
    assert "getRoot__" in params, "Missing parameter 'getRoot__'"
...
ProviderACSearchHandler_strategy = st.builds(
    ProviderACSearchHandler,
)
com_changehealthcare_datamatching_DataMatchingController_strategy = st.builds(
    com_changehealthcare_datamatching_DataMatchingController,
    getRoot__=
        safe_text
)
...
def test_hyp_com_changehealthcare_datamatching_datamatchingcontroller_getRoot___setter(instance):
    original = instance.getRoot__
    instance.getRoot__ = original
    assert instance.getRoot__ == original
...
def test_com_changehealthcare_datamatching_DataMatchingController_getRoot___value_roundtrip():
    instance = com_changehealthcare_datamatching_DataMatchingController(getRoot__="sample_text")
    assert instance.getRoot__ == "sample_text"
    instance.getRoot__ = "sample_text_2"
    assert instance.getRoot__ == "sample_text_2"
...
ProviderACSearchHandler_strategy = st.builds(ProviderACSearchHandler)
@given(instance=ProviderACSearchHandler_strategy)
@settings(max_examples=25)
def test_ProviderACSearchHandler_instantiation(instance):
    assert isinstance(instance, ProviderACSearchHandler)


com_changehealthcare_datamatching_DataMatchingController_strategy = st.builds(com_changehealthcare_datamatching_DataMatchingController, getRoot__=safe_text)
@given(instance=com_changehealthcare_datamatching_DataMatchingController_strategy)
@settings(max_examples=25)
