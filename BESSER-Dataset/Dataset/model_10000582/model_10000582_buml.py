...
com_changehealthcare_datamatching_DataMatchingController = Class(name="com_changehealthcare_datamatching_DataMatchingController")
ProviderACSearchHandler = Class(name="ProviderACSearchHandler")
...
# com_changehealthcare_datamatching_DataMatchingController class attributes and methods
com_changehealthcare_datamatching_DataMatchingController_getRoot__: Property = Property(name="getRoot__", type=StringType)
com_changehealthcare_datamatching_DataMatchingController.attributes={com_changehealthcare_datamatching_DataMatchingController_getRoot__}

# ProviderACSearchHandler class attributes and methods
...
ClassC.attributes={ClassC_publicAttribute, ClassC_packageAttribute, ClassC_privateAttribute, ClassC_protectedAttribute}
...
domain_model = DomainModel(
    name="_47cad680_8f91_488b_bef9_f1d807ef7b27",
    types={ClassM, ClassN, ClassP, InterfaceO_Interface, ClassQ, ClassR, ClassS, ClassT, ClassU, ClassV, com_changehealthcare_datamatching_DataMatchingController, ProviderACSearchHandler, ClassC, ClassD, ClassE, ClassF, ClassG, ClassJ, ClassH, ClassK, ClassL},
