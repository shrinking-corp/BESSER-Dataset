...
# Classes
course_desc_Course = Class(name="course_desc_Course")
course_desc_Exam = Class(name="course_desc_Exam")
Evaluation = Class(name="Evaluation")
course_desc_Student = Class(name="course_desc_Student")
course_desc_CourseInstance = Class(name="course_desc_CourseInstance")
course_desc_CoursePreconditions = Class(name="course_desc_CoursePreconditions")
course_desc_Timetable = Class(name="course_desc_Timetable")
course_desc_Evaluation = Class(name="course_desc_Evaluation", is_abstract=True)
course_desc_Department = Class(name="course_desc_Department")
course_desc_Lecturer = Class(name="course_desc_Lecturer")
course_desc_CourseCoordinator = Class(name="course_desc_CourseCoordinator")
course_desc_StudyProgram = Class(name="course_desc_StudyProgram")
PersonRole = Class(name="PersonRole")
course_desc_CourseWork = Class(name="course_desc_CourseWork")
course_desc_Person = Class(name="course_desc_Person")
course_desc_PersonRole = Class(name="course_desc_PersonRole", is_abstract=True)
course_desc_EvaluationWithDeadline = Class(name="course_desc_EvaluationWithDeadline")
course_desc_Univ = Class(name="course_desc_Univ")
...
course_desc_Course.attributes={course_desc_Course_Code, course_desc_Course_Content, course_desc_Course_Credits, course_desc_Course_name}
...
course_desc_Exam.attributes={course_desc_Exam_date, course_desc_Exam_duration, course_desc_Exam_place}
...
course_desc_Student_m_signUpForExam: Method = Method(name="signUpForExam", parameters={Parameter(name='course_desc_exam', type=StringType)}, type=BooleanType)
course_desc_Student_m_cancelExam: Method = Method(name="cancelExam", parameters={Parameter(name='course_desc_exam', type=StringType)}, type=BooleanType)
course_desc_Student_m_takeExam: Method = Method(name="takeExam", parameters={Parameter(name='course_desc_exam', type=StringType)}, type=BooleanType)
course_desc_Student.attributes={course_desc_Student_totalStudyPoints}
course_desc_Student.methods={course_desc_Student_m_cancelExam, course_desc_Student_m_takeExam, course_desc_Student_m_signUpForExam}
...
course_desc_CourseInstance.attributes={course_desc_CourseInstance_LectureHours, course_desc_CourseInstance_LabHours, course_desc_CourseInstance_Year}
...
course_desc_CoursePreconditions.attributes={course_desc_CoursePreconditions_isRecommended, course_desc_CoursePreconditions_reductionPoints, course_desc_CoursePreconditions_isRequired}
...
course_desc_CourseWork.attributes={course_desc_CourseWork_isMandatory, course_desc_CourseWork_Type, course_desc_CourseWork_Room, course_desc_CourseWork_Duration, course_desc_CourseWork_isRestricted}
...
course_desc_Person.attributes={course_desc_Person_lastName, course_desc_Person_personNr, course_desc_Person_name, course_desc_Person_fullName}
...
domain_model = DomainModel(
    name="course_desc",
    types={course_desc_Course, course_desc_Exam, Evaluation, course_desc_Student, course_desc_CourseInstance, course_desc_CoursePreconditions, course_desc_Timetable, course_desc_Evaluation, course_desc_Department, course_desc_Lecturer, course_desc_CourseCoordinator, course_desc_StudyProgram, PersonRole, course_desc_CourseWork, course_desc_Person, course_desc_PersonRole, course_desc_EvaluationWithDeadline, course_desc_Univ, CourseWorkType, StudyProgramCode, DeadlineEvaluation},
    associations={manages12, belongsTo13, hasRegisteredStudents15, hasInstance0, hasPrecondition1, hasTimetable2, instanceOfCourse3, hasEvaluations4, isInstanceOf5, hasLecturers6, hasCourseCoordinator8, responsible10, linkedTo29, hasCourseWork16, programs18, belongsTo20, offers23, belongs26, hasRole28, hasExams30, finishedExams31, belongsTo32, belongsTo35, hasDepartment38, hasCourses39, hasPersons42, hasPrecond44, hasStudents47},
    generalizations={gen_course_desc_Exam_Evaluation, gen_course_desc_Student_PersonRole, gen_course_desc_EvaluationWithDeadline_Evaluation, gen_course_desc_Lecturer_PersonRole, gen_course_desc_CourseCoordinator_PersonRole},
    metadata=None
)
