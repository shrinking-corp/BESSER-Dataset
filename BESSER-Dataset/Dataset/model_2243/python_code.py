...
class course_desc_Department:
    ...
    def __init__(self, name: str, belongs: set["course_desc_StudyProgram"] = None, Department: "course_desc_CourseInstance" = None, isInstanceOf: set["course_desc_CourseInstance"] = None, Department27: "course_desc_StudyProgram" = None, course_desc_Department: "course_desc_Univ" = None):
        self.name = name
...
class course_desc_Evaluation(ABC):
    ...
    def __init__(self, Percentage: float, hasEvaluations: "course_desc_CourseInstance" = None, Evaluation: "course_desc_CourseInstance" = None):
...
class course_desc_CoursePreconditions:
    ...
    def __init__(self, isRequired: bool, reductionPoints: float, isRecommended: bool, course_desc_CoursePreconditions: "course_desc_Course" = None, course_desc_CoursePreconditions21: "course_desc_Course" = None, course_desc_CoursePreconditions46: "course_desc_Univ" = None):
...
class course_desc_CourseInstance:
    ...
    def __init__(self, Year: int, LectureHours: float, LabHours: float, CourseInstance14: "course_desc_Evaluation" = None, CourseInstance: "course_desc_Course" = None, course_desc_CourseInstance: set["course_desc_Timetable"] = None, hasInstance: "course_desc_Course" = None, belongsTo: set["course_desc_Evaluation"] = None, responsible: "course_desc_Department" = None, course_desc_CourseInstance7: set["course_desc_Lecturer"] = None, course_desc_CourseInstance9: set["course_desc_CourseCoordinator"] = None, CourseInstance11: "course_desc_Department" = None, course_desc_CourseInstance34: "course_desc_Lecturer" = None, course_desc_CourseInstance37: "course_desc_CourseCoordinator" = None):
        self.Year = Year
...
class course_desc_Course:
    ...
    def __init__(self, Code: str, name: str, Content: str, Credits: str, instanceOfCourse: set["course_desc_CourseInstance"] = None, course_desc_Course: set["course_desc_CoursePreconditions"] = None, Course: "course_desc_CourseInstance" = None, course_desc_Course22: "course_desc_CoursePreconditions" = None, course_desc_Course25: "course_desc_StudyProgram" = None, course_desc_Course41: "course_desc_Univ" = None):
        self.Code = Code
        self.name = name
...
class course_desc_Student(PersonRole):
    ...
    def signUpForExam(self, course_desc_exam) :
        # TODO: Implement signUpForExam method
        pass

    def cancelExam(self, course_desc_exam) :
        # TODO: Implement cancelExam method
        pass

    def takeExam(self, course_desc_exam) :
...
class course_desc_StudyProgram:
    ...
    def __init__(self, studyCode: str, StudyProgram: "course_desc_Department" = None, course_desc_StudyProgram: "course_desc_Timetable" = None, course_desc_StudyProgram24: set["course_desc_Course"] = None, manages: "course_desc_Department" = None):
