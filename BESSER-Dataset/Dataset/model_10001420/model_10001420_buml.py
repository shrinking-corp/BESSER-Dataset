...
Login_Process = Class(name="Login_Process")
...
Employee.attributes={Employee_Emp_DOB, Employee_Emp_Email, Employee_Emp_Salary, Employee_Emp_ContactNo, Employee_Emp_Position, Employee_Emp_Name, Employee_Emp_Address, Employee_Emp_Date_Of_Joint, Employee_Emp_Department, Employee_Emp_Id, Employee_Emp_NIC}
...
Salary.attributes={Salary_Sly_Basic, Salary_Emp_Id, Salary_OverTime, Salary_Sly_Netgross}

# Login_Process class attributes and methods
Login_Process_Time_In: Property = Property(name="Time_In", type=StringType)
Login_Process_Time_Out: Property = Property(name="Time_Out", type=StringType)
Login_Process.attributes={Login_Process_Time_In, Login_Process_Time_Out}
...
Leave.attributes={Leave_Leave_NoOfDays, Leave_Leave_Title, Leave_Leave_Status, Leave_Emp_Id, Leave_Leave_detail, Leave_leave_id, Leave_Leave_EndDate, Leave_Leave_ApplyDate, Leave_Leave_StartDate}
...
domain_model = DomainModel(
    name="_5cG_wAHlEeqF_c9bu8KhDg",
    types={Employee, Salary, Login_Process, Leave, Attendance, Employee_Management_System_Component, Authentication_UseCase, Salary_Management_UseCase, Administrator_Actor, Employee_Actor, Administrator, Login_external, Logout_external, Enumeration_},
