...
public class Leave  {
    ...
    public Leave(
        String Leave_Title,        LocalDate Leave_EndDate,        int Leave_NoOfDays,        int Emp_Id,        LocalDate Leave_StartDate,        LocalDate Leave_ApplyDate,        String Leave_detail,        int leave_id,        String Leave_Status    ) {
