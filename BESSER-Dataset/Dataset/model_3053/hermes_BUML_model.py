...
# Classes
hermes_Module = Class(name="hermes_Module")
NamedElement = Class(name="NamedElement")
hermes_Package = Class(name="hermes_Package")
hermes_Entity = Class(name="hermes_Entity")
hermes_NamedElement = Class(name="hermes_NamedElement", is_abstract=True)
hermes_Feature = Class(name="hermes_Feature", is_abstract=True)
hermes_Reference = Class(name="hermes_Reference")
Feature = Class(name="Feature")
hermes_DataType = Class(name="hermes_DataType")
...
hermes_Feature.attributes={hermes_Feature_annotations, hermes_Feature_many}
...
domain_model = DomainModel(
    name="hermes",
    types={hermes_Module, NamedElement, hermes_Package, hermes_Entity, hermes_NamedElement, hermes_Feature, hermes_Reference, Feature, hermes_DataType, DataTypes, EntityAnnotation, FetureAnnotation},
    associations={packages0, entities1, features3, superEntity6, reference8},
    generalizations={gen_hermes_Module_NamedElement, gen_hermes_Package_NamedElement, gen_hermes_Entity_NamedElement, gen_hermes_Feature_NamedElement, gen_hermes_Reference_Feature, gen_hermes_DataType_Feature},
    metadata=None
)
