...
class hermes_Entity(NamedElement):
    ...
    def __init__(self, annotations: str, hermes_Entity: "hermes_Package" = None, hermes_Entity4: set["hermes_Feature"] = None, hermes_Entity7: "hermes_Entity" = None, hermes_Entity5: "hermes_Entity" = None, hermes_Entity9: "hermes_Reference" = None):
        self.annotations = annotations
