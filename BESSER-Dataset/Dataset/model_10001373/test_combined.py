...
@given(instance=Discription_strategy)
def test_hyp_discription_Email_setter(instance):
...
@given(instance=User_strategy)
def test_hyp_user_Phone_num_setter(instance):
...
def test_hyp_order_Type_setter(instance):
    original = instance.Type
    instance.Type = original
    assert instance.Type == original
...
@given(instance=Order_strategy)
def test_hyp_order_Size_setter(instance):
