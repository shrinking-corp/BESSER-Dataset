...
class petrinet_Arc:
    ...
    def __init__(self, poids: int, readArc: bool, petrinet_Arc7: "petrinet_Node" = None, petrinet_Arc: "petrinet_PetriNet" = None, petrinet_Arc4: "petrinet_Node" = None):
        self.poids = poids
...
class petrinet_Node:
    ...
    def __init__(self, name: str, petrinet_Node8: "petrinet_Arc" = None, petrinet_Node: "petrinet_PetriNet" = None, petrinet_Node5: "petrinet_Arc" = None):
        self.name = name
