...
class standard_Specification:
    ...
    def cannot_be_type(self, standard_context, standard_diagnostics) :
...
class standard_Utility:
    ...
    def is_utility(self, standard_context, standard_diagnostics) :
...
class standard_Type:
    ...
    def cannot_be_specification(self, standard_context, standard_diagnostics) :
...
class standard_Realization:
    ...
    def cannot_be_implementationClass(self, standard_diagnostics, standard_context) :
...
class standard_Send:
    ...
    def client_operation_sends_supplier_signal(self, standard_context, standard_diagnostics) :
...
class standard_Instantiate:
    ...
    def client_and_supplier_are_classifiers(self, standard_diagnostics, standard_context) :
...
class standard_ImplementationClass:
    ...
    def cannot_be_realization(self, standard_diagnostics, standard_context) :
...
class standard_Implement:
    ...
    def implements_specification(self, standard_context, standard_diagnostics) :
...
class standard_Create:
    ...
    def client_and_supplier_are_classifiers(self, standard_context, standard_diagnostics) :
        # TODO: Implement client_and_supplier_are_classifiers method
        pass
...
class standard_Call:
    ...
    def client_and_supplier_are_operations(self, standard_diagnostics, standard_context) :
