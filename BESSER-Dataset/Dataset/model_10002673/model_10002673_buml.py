...
Profile.attributes={Profile_l_Name, Profile_f_Name, Profile_password, Profile_user_Name}
...
SuperAdmin.attributes={SuperAdmin_userName, SuperAdmin_password, SuperAdmin_userID}
...
Normal_user.attributes={Normal_user_password, Normal_user_userName, Normal_user_userID}
...
Calender_Event.attributes={Calender_Event_volunteer, Calender_Event_nomarlUser, Calender_Event_admin, Calender_Event_participantAmount, Calender_Event_category, Calender_Event_description, Calender_Event_eventType, Calender_Event_date, Calender_Event_time}
...
Login.attributes={Login_loggedinTime, Login_loggedoutTime, Login_userID}
...
Attendance.attributes={Attendance_checkInTime, Attendance_checkOutTime, Attendance_attendanceID}
...
Payment.attributes={Payment_expiryDate, Payment_cardNumber, Payment_issuerName, Payment_amount, Payment_cardType}
...
Mail.attributes={Mail_sendTo, Mail_emailID, Mail_sendBy, Mail_subject}
...
domain_model = DomainModel(
    name="cd92e3c3_dc11_48cb_94c8_2312114a28ce",
    types={Profile, SuperAdmin, void, Normal_user, Admin, Volunteer, Calender_Event, Login, Attendance, Payment, Mail},
