...
# Classes
trace_SmallStep = Class(name="trace_SmallStep")
Step = Class(name="Step")
trace_Trace = Class(name="trace_Trace")
trace_Step = Class(name="trace_Step", is_abstract=True)
trace_ModelState = Class(name="trace_ModelState")
trace_ObjectState = Class(name="trace_ObjectState")
trace_TracedObject = Class(name="trace_TracedObject")
trace_Value = Class(name="trace_Value", is_abstract=True)
trace_ParameterValue = Class(name="trace_ParameterValue")
trace_BigStep = Class(name="trace_BigStep")
trace_RefValue = Class(name="trace_RefValue")
Value = Class(name="Value")
trace_LiteralValue = Class(name="trace_LiteralValue")
...
domain_model = DomainModel(
    name="trace",
    types={trace_SmallStep, Step, trace_Trace, trace_Step, trace_ModelState, trace_ObjectState, trace_TracedObject, trace_Value, trace_ParameterValue, trace_BigStep, trace_RefValue, Value, trace_LiteralValue, ParamterKindEnum},
    associations={objectstates21, children24, objectstates25, steps0, modelstate1, objectstates3, tracedobject5, values7, state9, parametervalue12, parent14, value15, tracedobject18, objectstate19, value26},
    generalizations={gen_trace_SmallStep_Step, gen_trace_BigStep_Step, gen_trace_RefValue_Value, gen_trace_LiteralValue_Value},
    metadata=None
)
