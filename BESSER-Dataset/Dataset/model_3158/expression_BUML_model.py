...
# Classes
model_ParametricElement = Class(name="model_ParametricElement", is_abstract=True)
model_ParameterDeclaration = Class(name="model_ParameterDeclaration")
model_ArgumentedElement = Class(name="model_ArgumentedElement")
model_Expression = Class(name="model_Expression", is_abstract=True)
model_NamedElement = Class(name="model_NamedElement", is_abstract=True)
model_CommentableElement = Class(name="model_CommentableElement")
model_Comment = Class(name="model_Comment")
model_VariableDeclaration = Class(name="model_VariableDeclaration")
ValueDeclaration = Class(name="ValueDeclaration")
InitializableElement = Class(name="InitializableElement")
model_FieldDeclaration = Class(name="model_FieldDeclaration")
model_LambdaDeclaration = Class(name="model_LambdaDeclaration")
FunctionDeclaration = Class(name="FunctionDeclaration")
model_TypeReference = Class(name="model_TypeReference")
Type = Class(name="Type")
model_TypeDefinition = Class(name="model_TypeDefinition")
model_NumericalTypeDefinition = Class(name="model_NumericalTypeDefinition")
TypeDefinition = Class(name="TypeDefinition")
model_CompositeTypeDefinition = Class(name="model_CompositeTypeDefinition")
model_VoidTypeDefinition = Class(name="model_VoidTypeDefinition")
model_BooleanTypeDefinition = Class(name="model_BooleanTypeDefinition")
model_IntegerTypeDefinition = Class(name="model_IntegerTypeDefinition")
NumericalTypeDefinition = Class(name="NumericalTypeDefinition")
model_ExpressionPackage = Class(name="model_ExpressionPackage")
NamedElement = Class(name="NamedElement")
ParametricElement = Class(name="ParametricElement")
model_TypeDeclaration = Class(name="model_TypeDeclaration")
model_ConstantDeclaration = Class(name="model_ConstantDeclaration")
model_FunctionDeclaration = Class(name="model_FunctionDeclaration")
model_BasicConstraintDefinition = Class(name="model_BasicConstraintDefinition")
model_InitializableElement = Class(name="model_InitializableElement", is_abstract=True)
model_Declaration = Class(name="model_Declaration", is_abstract=True)
model_Type = Class(name="model_Type")
model_ValueDeclaration = Class(name="model_ValueDeclaration")
Declaration = Class(name="Declaration")
model_EnumerableTypeDefinition = Class(name="model_EnumerableTypeDefinition", is_abstract=True)
model_EnumerationTypeDefinition = Class(name="model_EnumerationTypeDefinition")
EnumerableTypeDefinition = Class(name="EnumerableTypeDefinition")
model_EnumerationLiteralDefinition = Class(name="model_EnumerationLiteralDefinition")
model_RationalTypeDefinition = Class(name="model_RationalTypeDefinition")
model_DecimalTypeDefinition = Class(name="model_DecimalTypeDefinition")
model_SubrangeTypeDefinition = Class(name="model_SubrangeTypeDefinition")
CompositeTypeDefinition = Class(name="CompositeTypeDefinition")
model_BinaryExpression = Class(name="model_BinaryExpression", is_abstract=True)
model_MultiaryExpression = Class(name="model_MultiaryExpression", is_abstract=True)
model_ArithmeticExpression = Class(name="model_ArithmeticExpression", is_abstract=True)
model_LogicExpression = Class(name="model_LogicExpression")
model_BooleanExpression = Class(name="model_BooleanExpression", is_abstract=True)
LogicExpression = Class(name="LogicExpression")
model_PredicateExpression = Class(name="model_PredicateExpression", is_abstract=True)
model_OpaqueExpression = Class(name="model_OpaqueExpression")
NullaryExpression = Class(name="NullaryExpression")
model_ElseExpression = Class(name="model_ElseExpression")
model_DefaultExpression = Class(name="model_DefaultExpression")
ElseExpression = Class(name="ElseExpression")
model_QuantifierExpression = Class(name="model_QuantifierExpression", is_abstract=True)
UnaryExpression = Class(name="UnaryExpression")
model_ArrayTypeDefinition = Class(name="model_ArrayTypeDefinition")
model_IntegerRangeTypeDefinition = Class(name="model_IntegerRangeTypeDefinition")
model_FunctionTypeDefinition = Class(name="model_FunctionTypeDefinition")
model_RecordTypeDefinition = Class(name="model_RecordTypeDefinition")
model_ConstraintDefinition = Class(name="model_ConstraintDefinition", is_abstract=True)
ConstraintDefinition = Class(name="ConstraintDefinition")
model_NullaryExpression = Class(name="model_NullaryExpression", is_abstract=True)
Expression = Class(name="Expression")
model_UnaryExpression = Class(name="model_UnaryExpression", is_abstract=True)
model_ArrayLiteralExpression = Class(name="model_ArrayLiteralExpression")
EnumerableExpression = Class(name="EnumerableExpression")
MultiaryExpression = Class(name="MultiaryExpression")
model_IntegerRangeLiteralExpression = Class(name="model_IntegerRangeLiteralExpression")
BinaryExpression = Class(name="BinaryExpression")
model_RecordLiteralExpression = Class(name="model_RecordLiteralExpression")
model_FieldAssignment = Class(name="model_FieldAssignment")
model_EnumerationLiteralExpression = Class(name="model_EnumerationLiteralExpression")
model_ReferenceExpression = Class(name="model_ReferenceExpression")
model_IfThenElseExpression = Class(name="model_IfThenElseExpression")
model_AccessExpression = Class(name="model_AccessExpression", is_abstract=True)
model_LiteralExpression = Class(name="model_LiteralExpression", is_abstract=True)
model_EnumerableExpression = Class(name="model_EnumerableExpression", is_abstract=True)
model_ArithmeticLiteralExpression = Class(name="model_ArithmeticLiteralExpression", is_abstract=True)
LiteralExpression = Class(name="LiteralExpression")
ArithmeticExpression = Class(name="ArithmeticExpression")
model_IntegerLiteralExpression = Class(name="model_IntegerLiteralExpression")
ArithmeticLiteralExpression = Class(name="ArithmeticLiteralExpression")
model_DecimalLiteralExpression = Class(name="model_DecimalLiteralExpression")
model_RationalLiteralExpression = Class(name="model_RationalLiteralExpression")
model_BooleanLiteralExpression = Class(name="model_BooleanLiteralExpression", is_abstract=True)
BooleanExpression = Class(name="BooleanExpression")
model_TrueExpression = Class(name="model_TrueExpression")
BooleanLiteralExpression = Class(name="BooleanLiteralExpression")
model_FalseExpression = Class(name="model_FalseExpression")
model_LessExpression = Class(name="model_LessExpression")
model_LessEqualExpression = Class(name="model_LessEqualExpression")
model_AddExpression = Class(name="model_AddExpression")
model_SubtractExpression = Class(name="model_SubtractExpression")
model_MultiplyExpression = Class(name="model_MultiplyExpression")
model_DivideExpression = Class(name="model_DivideExpression")
model_DivExpression = Class(name="model_DivExpression")
model_ModExpression = Class(name="model_ModExpression")
model_UnaryMinusExpression = Class(name="model_UnaryMinusExpression")
model_UnaryPlusExpression = Class(name="model_UnaryPlusExpression")
model_FunctionAccessExpression = Class(name="model_FunctionAccessExpression")
AccessExpression = Class(name="AccessExpression")
ArgumentedElement = Class(name="ArgumentedElement")
model_ArrayAccessExpression = Class(name="model_ArrayAccessExpression")
model_RecordAccessExpression = Class(name="model_RecordAccessExpression")
model_SelectExpression = Class(name="model_SelectExpression")
model_NotExpression = Class(name="model_NotExpression")
model_ForallExpression = Class(name="model_ForallExpression")
QuantifierExpression = Class(name="QuantifierExpression")
model_ExistsExpression = Class(name="model_ExistsExpression")
model_ImplyExpression = Class(name="model_ImplyExpression")
model_OrExpression = Class(name="model_OrExpression")
model_AndExpression = Class(name="model_AndExpression")
model_XorExpression = Class(name="model_XorExpression")
model_EquivalenceExpression = Class(name="model_EquivalenceExpression", is_abstract=True)
PredicateExpression = Class(name="PredicateExpression")
model_EqualityExpression = Class(name="model_EqualityExpression")
EquivalenceExpression = Class(name="EquivalenceExpression")
model_InequalityExpression = Class(name="model_InequalityExpression")
model_ComparisonExpression = Class(name="model_ComparisonExpression", is_abstract=True)
model_GreaterExpression = Class(name="model_GreaterExpression")
ComparisonExpression = Class(name="ComparisonExpression")
model_GreaterEqualExpression = Class(name="model_GreaterEqualExpression")
...
model_RationalLiteralExpression.attributes={model_RationalLiteralExpression_numerator, model_RationalLiteralExpression_denominator}
...
else_58: BinaryAssociation = BinaryAssociation(
    name="else_58",
    ends={
...
domain_model = DomainModel(
    name="model",
    types={model_ParametricElement, model_ParameterDeclaration, model_ArgumentedElement, model_Expression, model_NamedElement, model_CommentableElement, model_Comment, model_VariableDeclaration, ValueDeclaration, InitializableElement, model_FieldDeclaration, model_LambdaDeclaration, FunctionDeclaration, model_TypeReference, Type, model_TypeDefinition, model_NumericalTypeDefinition, TypeDefinition, model_CompositeTypeDefinition, model_VoidTypeDefinition, model_BooleanTypeDefinition, model_IntegerTypeDefinition, NumericalTypeDefinition, model_ExpressionPackage, NamedElement, ParametricElement, model_TypeDeclaration, model_ConstantDeclaration, model_FunctionDeclaration, model_BasicConstraintDefinition, model_InitializableElement, model_Declaration, model_Type, model_ValueDeclaration, Declaration, model_EnumerableTypeDefinition, model_EnumerationTypeDefinition, EnumerableTypeDefinition, model_EnumerationLiteralDefinition, model_RationalTypeDefinition, model_DecimalTypeDefinition, model_SubrangeTypeDefinition, CompositeTypeDefinition, model_BinaryExpression, model_MultiaryExpression, model_ArithmeticExpression, model_LogicExpression, model_BooleanExpression, LogicExpression, model_PredicateExpression, model_OpaqueExpression, NullaryExpression, model_ElseExpression, model_DefaultExpression, ElseExpression, model_QuantifierExpression, UnaryExpression, model_ArrayTypeDefinition, model_IntegerRangeTypeDefinition, model_FunctionTypeDefinition, model_RecordTypeDefinition, model_ConstraintDefinition, ConstraintDefinition, model_NullaryExpression, Expression, model_UnaryExpression, model_ArrayLiteralExpression, EnumerableExpression, MultiaryExpression, model_IntegerRangeLiteralExpression, BinaryExpression, model_RecordLiteralExpression, model_FieldAssignment, model_EnumerationLiteralExpression, model_ReferenceExpression, model_IfThenElseExpression, model_AccessExpression, model_LiteralExpression, model_EnumerableExpression, model_ArithmeticLiteralExpression, LiteralExpression, ArithmeticExpression, model_IntegerLiteralExpression, ArithmeticLiteralExpression, model_DecimalLiteralExpression, model_RationalLiteralExpression, model_BooleanLiteralExpression, BooleanExpression, model_TrueExpression, BooleanLiteralExpression, model_FalseExpression, model_LessExpression, model_LessEqualExpression, model_AddExpression, model_SubtractExpression, model_MultiplyExpression, model_DivideExpression, model_DivExpression, model_ModExpression, model_UnaryMinusExpression, model_UnaryPlusExpression, model_FunctionAccessExpression, AccessExpression, ArgumentedElement, model_ArrayAccessExpression, model_RecordAccessExpression, model_SelectExpression, model_NotExpression, model_ForallExpression, QuantifierExpression, model_ExistsExpression, model_ImplyExpression, model_OrExpression, model_AndExpression, model_XorExpression, model_EquivalenceExpression, PredicateExpression, model_EqualityExpression, EquivalenceExpression, model_InequalityExpression, model_ComparisonExpression, model_GreaterExpression, ComparisonExpression, model_GreaterEqualExpression},
    associations={comments0, parameterDeclarations1, arguments2, reference13, typeDeclarations3, constantDeclarations4, functionDeclarations6, basicConstraintDefinitions8, expression10, type12, upperBound17, literals20, lowerBound15, leftOperand36, rightOperand38, operands41, elementType21, size23, parameterTypes26, returnType28, fieldDeclarations31, expression32, operand34, fieldAssignments45, reference46, value48, declaration51, operand43, condition53, then55, else_58},
    generalizations={gen_model_TypeDeclaration_Declaration, gen_model_VariableDeclaration_ValueDeclaration, gen_model_VariableDeclaration_InitializableElement, gen_model_ConstantDeclaration_ValueDeclaration, gen_model_ConstantDeclaration_InitializableElement, gen_model_ParameterDeclaration_ValueDeclaration, gen_model_FieldDeclaration_ValueDeclaration, gen_model_LambdaDeclaration_InitializableElement, gen_model_LambdaDeclaration_FunctionDeclaration, gen_model_TypeReference_Type, gen_model_TypeDefinition_Type, gen_model_NumericalTypeDefinition_TypeDefinition, gen_model_CompositeTypeDefinition_TypeDefinition, gen_model_VoidTypeDefinition_TypeDefinition, gen_model_BooleanTypeDefinition_TypeDefinition, gen_model_IntegerTypeDefinition_NumericalTypeDefinition, gen_model_ExpressionPackage_NamedElement, gen_model_ExpressionPackage_ParametricElement, gen_model_InitializableElement_NamedElement, gen_model_Declaration_NamedElement, gen_model_ValueDeclaration_Declaration, gen_model_FunctionDeclaration_Declaration, gen_model_FunctionDeclaration_ParametricElement, gen_model_EnumerableTypeDefinition_CompositeTypeDefinition, gen_model_EnumerationTypeDefinition_EnumerableTypeDefinition, gen_model_EnumerationLiteralDefinition_NamedElement, gen_model_RationalTypeDefinition_NumericalTypeDefinition, gen_model_DecimalTypeDefinition_NumericalTypeDefinition, gen_model_SubrangeTypeDefinition_NumericalTypeDefinition, gen_model_SubrangeTypeDefinition_CompositeTypeDefinition, gen_model_BinaryExpression_Expression, gen_model_MultiaryExpression_Expression, gen_model_ArithmeticExpression_Expression, gen_model_LogicExpression_Expression, gen_model_BooleanExpression_LogicExpression, gen_model_PredicateExpression_LogicExpression, gen_model_OpaqueExpression_NullaryExpression, gen_model_ElseExpression_NullaryExpression, gen_model_ElseExpression_LogicExpression, gen_model_DefaultExpression_ElseExpression, gen_model_QuantifierExpression_UnaryExpression, gen_model_QuantifierExpression_ParametricElement, gen_model_QuantifierExpression_LogicExpression, gen_model_ArrayTypeDefinition_EnumerableTypeDefinition, gen_model_IntegerRangeTypeDefinition_EnumerableTypeDefinition, gen_model_FunctionTypeDefinition_CompositeTypeDefinition, gen_model_RecordTypeDefinition_CompositeTypeDefinition, gen_model_BasicConstraintDefinition_ConstraintDefinition, gen_model_NullaryExpression_Expression, gen_model_UnaryExpression_Expression, gen_model_ArrayLiteralExpression_LiteralExpression, gen_model_ArrayLiteralExpression_EnumerableExpression, gen_model_ArrayLiteralExpression_MultiaryExpression, gen_model_IntegerRangeLiteralExpression_LiteralExpression, gen_model_IntegerRangeLiteralExpression_EnumerableExpression, gen_model_IntegerRangeLiteralExpression_BinaryExpression, gen_model_RecordLiteralExpression_LiteralExpression, gen_model_EnumerationLiteralExpression_NullaryExpression, gen_model_EnumerationLiteralExpression_LiteralExpression, gen_model_ReferenceExpression_NullaryExpression, gen_model_IfThenElseExpression_Expression, gen_model_AccessExpression_Expression, gen_model_LiteralExpression_Expression, gen_model_EnumerableExpression_Expression, gen_model_ArithmeticLiteralExpression_NullaryExpression, gen_model_ArithmeticLiteralExpression_LiteralExpression, gen_model_ArithmeticLiteralExpression_ArithmeticExpression, gen_model_IntegerLiteralExpression_ArithmeticLiteralExpression, gen_model_DecimalLiteralExpression_ArithmeticLiteralExpression, gen_model_RationalLiteralExpression_ArithmeticLiteralExpression, gen_model_BooleanLiteralExpression_NullaryExpression, gen_model_BooleanLiteralExpression_LiteralExpression, gen_model_BooleanLiteralExpression_BooleanExpression, gen_model_TrueExpression_BooleanLiteralExpression, gen_model_FalseExpression_BooleanLiteralExpression, gen_model_LessExpression_ComparisonExpression, gen_model_LessEqualExpression_ComparisonExpression, gen_model_AddExpression_ArithmeticExpression, gen_model_AddExpression_MultiaryExpression, gen_model_SubtractExpression_ArithmeticExpression, gen_model_SubtractExpression_BinaryExpression, gen_model_MultiplyExpression_ArithmeticExpression, gen_model_MultiplyExpression_MultiaryExpression, gen_model_DivideExpression_ArithmeticExpression, gen_model_DivideExpression_BinaryExpression, gen_model_DivExpression_ArithmeticExpression, gen_model_DivExpression_BinaryExpression, gen_model_ModExpression_ArithmeticExpression, gen_model_ModExpression_BinaryExpression, gen_model_UnaryMinusExpression_ArithmeticExpression, gen_model_UnaryMinusExpression_UnaryExpression, gen_model_UnaryPlusExpression_ArithmeticExpression, gen_model_UnaryPlusExpression_UnaryExpression, gen_model_FunctionAccessExpression_AccessExpression, gen_model_FunctionAccessExpression_ArgumentedElement, gen_model_ArrayAccessExpression_AccessExpression, gen_model_ArrayAccessExpression_ArgumentedElement, gen_model_RecordAccessExpression_AccessExpression, gen_model_SelectExpression_AccessExpression, gen_model_NotExpression_BooleanExpression, gen_model_NotExpression_UnaryExpression, gen_model_ForallExpression_QuantifierExpression, gen_model_ExistsExpression_QuantifierExpression, gen_model_ImplyExpression_BooleanExpression, gen_model_ImplyExpression_BinaryExpression, gen_model_OrExpression_BooleanExpression, gen_model_OrExpression_MultiaryExpression, gen_model_AndExpression_BooleanExpression, gen_model_AndExpression_MultiaryExpression, gen_model_XorExpression_BooleanExpression, gen_model_XorExpression_MultiaryExpression, gen_model_EquivalenceExpression_PredicateExpression, gen_model_EquivalenceExpression_BinaryExpression, gen_model_EqualityExpression_EquivalenceExpression, gen_model_InequalityExpression_EquivalenceExpression, gen_model_ComparisonExpression_PredicateExpression, gen_model_ComparisonExpression_BinaryExpression, gen_model_GreaterExpression_ComparisonExpression, gen_model_GreaterEqualExpression_ComparisonExpression},
    metadata=None
)
