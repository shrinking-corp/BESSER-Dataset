...
class model_Declaration(NamedElement):
    ...
    pass
class model_ExpressionPackage(ParametricElement, NamedElement):
...
class InitializableElement:
    ...
    pass
class model_LambdaDeclaration(FunctionDeclaration, InitializableElement):
...
class model_FieldDeclaration(ValueDeclaration):
    ...
    pass
class model_VariableDeclaration(ValueDeclaration, InitializableElement):
...
class BinaryExpression:
    ...
    pass
class model_SubtractExpression(ArithmeticExpression, BinaryExpression):

    pass
class model_DivideExpression(ArithmeticExpression, BinaryExpression):

    pass
class model_EquivalenceExpression(PredicateExpression, BinaryExpression):

    pass
class model_ComparisonExpression(PredicateExpression, BinaryExpression):

    pass
class model_ImplyExpression(BooleanExpression, BinaryExpression):

    pass
class model_ModExpression(ArithmeticExpression, BinaryExpression):

    pass
class model_DivExpression(ArithmeticExpression, BinaryExpression):
...
class EnumerableExpression:
    ...
    pass
class model_IntegerRangeLiteralExpression(LiteralExpression, EnumerableExpression, BinaryExpression):

    def __init__(self, leftInclusive: bool, rightInclusive: bool):
        self.leftInclusive = leftInclusive
        self.rightInclusive = rightInclusive
        
        pass
    @property
    def leftInclusive(self):
...
class model_ArrayLiteralExpression(LiteralExpression, EnumerableExpression, MultiaryExpression):
...
class model_UnaryPlusExpression(UnaryExpression, ArithmeticExpression):
    ...
    pass
class model_NotExpression(BooleanExpression, UnaryExpression):
...
class NullaryExpression:
    ...
    pass
class model_BooleanLiteralExpression(BooleanExpression, LiteralExpression, NullaryExpression):

    pass
class model_ArithmeticLiteralExpression(LiteralExpression, ArithmeticExpression, NullaryExpression):

    pass
class model_ReferenceExpression(NullaryExpression):

    pass
class model_EnumerationLiteralExpression(LiteralExpression, NullaryExpression):
...
class model_PredicateExpression(LogicExpression):
    ...
    pass
class model_QuantifierExpression(LogicExpression, ParametricElement, UnaryExpression):

    pass
class model_ElseExpression(LogicExpression, NullaryExpression):
