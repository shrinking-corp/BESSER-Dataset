...
# Classes
sbase_Z = Class(name="sbase_Z")
sbase_X = Class(name="sbase_X")
SElement = Class(name="SElement")
sbase_Y = Class(name="sbase_Y")
sbase_SRoot = Class(name="sbase_SRoot")
sbase_SElement = Class(name="sbase_SElement")
sbase_EObject = Class(name="sbase_EObject")
...
domain_model = DomainModel(
    name="sbase",
    types={sbase_Z, sbase_X, SElement, sbase_Y, sbase_SRoot, sbase_SElement, sbase_EObject},
    associations={ownsY0, ownsZ1, toX2, toY3, ownedX5, ast6},
    generalizations={gen_sbase_Y_SElement, gen_sbase_X_SElement, gen_sbase_Z_SElement, gen_sbase_SRoot_SElement},
    metadata=None
)
