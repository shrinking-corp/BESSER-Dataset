...
class behaviour_WaitForMessage(Instruction):
    ...
    def __init__(self, type: str, timeout: float, behaviour_WaitForMessage: set["behaviour_Instruction"] = None, behaviour_WaitForMessage21: set["behaviour_Instruction"] = None):
        self.type = type
...
class behaviour_Condition:
    ...
    def __init__(self, operation: str, key: str, value: str, behaviour_Condition16: "behaviour_FieldObject" = None, behaviour_Condition27: "behaviour_While" = None, behaviour_Condition: "behaviour_Choice" = None):
...
class behaviour_DroneBehaviour(NamedElement):
    ...
    def __init__(self, canBeInterrupted: bool, behaviour_DroneBehaviour2: set["behaviour_Drone"] = None, behaviour_DroneBehaviour: set["behaviour_Instruction"] = None):
