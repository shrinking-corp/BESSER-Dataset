...
def test_hyp_behaviour_movableobject_is_not_abstract():
    assert not inspect.isabstract(behaviour_MovableObject)


def test_hyp_behaviour_movableobject_constructor_exists():
    assert callable(behaviour_MovableObject.__init__)


def test_hyp_behaviour_movableobject_constructor_args():
    sig = inspect.signature(behaviour_MovableObject.__init__)
    params = list(sig.parameters.keys())



def test_hyp_behaviour_fieldobject_is_not_abstract():
    assert not inspect.isabstract(behaviour_FieldObject)


def test_hyp_behaviour_fieldobject_constructor_exists():
    assert callable(behaviour_FieldObject.__init__)


def test_hyp_behaviour_fieldobject_constructor_args():
...
def test_hyp_behaviour_lift_is_not_abstract():
    assert not inspect.isabstract(behaviour_Lift)


def test_hyp_behaviour_lift_constructor_exists():
    assert callable(behaviour_Lift.__init__)


def test_hyp_behaviour_lift_constructor_args():
    sig = inspect.signature(behaviour_Lift.__init__)
    params = list(sig.parameters.keys())



def test_hyp_behaviour_sendmessage_is_not_abstract():
    assert not inspect.isabstract(behaviour_SendMessage)


def test_hyp_behaviour_sendmessage_constructor_exists():
    assert callable(behaviour_SendMessage.__init__)


def test_hyp_behaviour_sendmessage_constructor_args():
...
def test_hyp_behaviour_instruct_is_not_abstract():
    assert not inspect.isabstract(behaviour_Instruct)


def test_hyp_behaviour_instruct_constructor_exists():
    assert callable(behaviour_Instruct.__init__)


def test_hyp_behaviour_instruct_constructor_args():
    sig = inspect.signature(behaviour_Instruct.__init__)
    params = list(sig.parameters.keys())



def test_hyp_behaviour_placeobject_is_not_abstract():
    assert not inspect.isabstract(behaviour_PlaceObject)


def test_hyp_behaviour_placeobject_constructor_exists():
    assert callable(behaviour_PlaceObject.__init__)


def test_hyp_behaviour_placeobject_constructor_args():
    sig = inspect.signature(behaviour_PlaceObject.__init__)
    params = list(sig.parameters.keys())



def test_hyp_behaviour_pause_is_not_abstract():
    assert not inspect.isabstract(behaviour_Pause)


def test_hyp_behaviour_pause_constructor_exists():
    assert callable(behaviour_Pause.__init__)


def test_hyp_behaviour_pause_constructor_args():
...
def test_hyp_behaviour_moveto_is_not_abstract():
    assert not inspect.isabstract(behaviour_MoveTo)


def test_hyp_behaviour_moveto_constructor_exists():
    assert callable(behaviour_MoveTo.__init__)


def test_hyp_behaviour_moveto_constructor_args():
    sig = inspect.signature(behaviour_MoveTo.__init__)
    params = list(sig.parameters.keys())



def test_hyp_behaviour_waitformessage_is_not_abstract():
    assert not inspect.isabstract(behaviour_WaitForMessage)


def test_hyp_behaviour_waitformessage_constructor_exists():
    assert callable(behaviour_WaitForMessage.__init__)


def test_hyp_behaviour_waitformessage_constructor_args():
...
def test_hyp_behaviour_condition_is_not_abstract():
    assert not inspect.isabstract(behaviour_Condition)


def test_hyp_behaviour_condition_constructor_exists():
    assert callable(behaviour_Condition.__init__)


def test_hyp_behaviour_condition_constructor_args():
...
def test_hyp_behaviour_performaction_is_not_abstract():
    assert not inspect.isabstract(behaviour_PerformAction)


def test_hyp_behaviour_performaction_constructor_exists():
    assert callable(behaviour_PerformAction.__init__)


def test_hyp_behaviour_performaction_constructor_args():
...
def test_hyp_behaviour_instruction_is_not_abstract():
    assert not inspect.isabstract(behaviour_Instruction)


def test_hyp_behaviour_instruction_constructor_exists():
    assert callable(behaviour_Instruction.__init__)


def test_hyp_behaviour_instruction_constructor_args():
...
def test_hyp_behaviour_dronebehaviour_is_not_abstract():
    assert not inspect.isabstract(behaviour_DroneBehaviour)


def test_hyp_behaviour_dronebehaviour_constructor_exists():
    assert callable(behaviour_DroneBehaviour.__init__)


def test_hyp_behaviour_dronebehaviour_constructor_args():
...
def test_hyp_conditionkind_exists():
    # Check that the Enumeration exists
    assert ConditionKind is not None

def test_hyp_conditionkind_has_all_literals():
...
def test_hyp_behaviour_sendmessage_messageType_setter(instance):
...
def test_hyp_behaviour_pause_duration_setter(instance):
...
def test_hyp_behaviour_waitformessage_type_setter(instance):
...
@given(instance=behaviour_WaitForMessage_strategy)
def test_hyp_behaviour_waitformessage_timeout_setter(instance):
...
def test_hyp_behaviour_condition_operation_setter(instance):
...
@given(instance=behaviour_Condition_strategy)
def test_hyp_behaviour_condition_value_setter(instance):
...
@given(instance=behaviour_Condition_strategy)
def test_hyp_behaviour_condition_key_setter(instance):
...
def test_hyp_behaviour_dronebehaviour_canBeInterrupted_setter(instance):
