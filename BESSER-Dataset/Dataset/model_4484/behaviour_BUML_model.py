...
behaviour_DroneBehaviour = Class(name="behaviour_DroneBehaviour")
NamedElement = Class(name="NamedElement")
behaviour_Instruction = Class(name="behaviour_Instruction", is_abstract=True)
behaviour_Drone = Class(name="behaviour_Drone")
behaviour_PerformAction = Class(name="behaviour_PerformAction")
behaviour_Action = Class(name="behaviour_Action")
behaviour_Choice = Class(name="behaviour_Choice")
behaviour_Condition = Class(name="behaviour_Condition")
behaviour_WaitForMessage = Class(name="behaviour_WaitForMessage")
behaviour_MoveTo = Class(name="behaviour_MoveTo")
Instruction = Class(name="Instruction")
behaviour_FieldObject = Class(name="behaviour_FieldObject")
behaviour_Pause = Class(name="behaviour_Pause")
behaviour_Instruct = Class(name="behaviour_Instruct")
behaviour_Lift = Class(name="behaviour_Lift")
behaviour_MovableObject = Class(name="behaviour_MovableObject")
behaviour_PlaceObject = Class(name="behaviour_PlaceObject")
behaviour_SendMessage = Class(name="behaviour_SendMessage")
...
behaviour_Condition.attributes={behaviour_Condition_value, behaviour_Condition_operation, behaviour_Condition_key}
...
behaviour_WaitForMessage.attributes={behaviour_WaitForMessage_timeout, behaviour_WaitForMessage_type}
...
domain_model = DomainModel(
    name="behaviour",
    types={behaviour_NamedElement, behaviour_DroneBehaviour, NamedElement, behaviour_Instruction, behaviour_Drone, behaviour_PerformAction, behaviour_Action, behaviour_Choice, behaviour_Condition, behaviour_WaitForMessage, behaviour_MoveTo, Instruction, behaviour_FieldObject, behaviour_Pause, behaviour_Instruct, behaviour_Lift, behaviour_MovableObject, behaviour_PlaceObject, behaviour_SendMessage, behaviour_While, ConditionKind},
    associations={instructions0, action4, target5, condition8, trueBranch9, falseBranch12, fieldObject15, drones1, fieldObject3, instructions28, target30, whenArrived18, whenLost20, instructions23, condition25},
    generalizations={gen_behaviour_DroneBehaviour_NamedElement, gen_behaviour_PerformAction_Instruction, gen_behaviour_Choice_Instruction, gen_behaviour_WaitForMessage_Instruction, gen_behaviour_MoveTo_Instruction, gen_behaviour_Pause_Instruction, gen_behaviour_Instruct_Instruction, gen_behaviour_Lift_Instruction, gen_behaviour_PlaceObject_Instruction, gen_behaviour_SendMessage_Instruction, gen_behaviour_While_Instruction},
    metadata=None
)
