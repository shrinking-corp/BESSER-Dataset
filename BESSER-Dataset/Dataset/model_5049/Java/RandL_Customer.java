...
public class RandL_Customer  {
    ...
    public RandL_Customer(
        String gender,        String isMale,        String title,        String name,        String age    ) {
        this.gender = gender;
        this.isMale = isMale;
        this.title = title;
        this.name = name;
    ...
    public RandL_Customer(
        String gender,        String isMale,        String title,        String name,        String age        ArrayList<RandL_Membership> randl_memberships,        ArrayList<RandL_LoyaltyProgram> randl_loyaltyprograms,        ArrayList<RandL_CustomerCard> randl_customercards    ) {
        this.gender = gender;
        this.isMale = isMale;
        this.title = title;
        this.name = name;
