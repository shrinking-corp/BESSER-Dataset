...
RandL_LoyaltyProgram_m_addService: Method = Method(name="addService", parameters={Parameter(name='RandL_s', type=StringType), Parameter(name='RandL_p', type=StringType), Parameter(name='RandL_l', type=StringType)})
...
RandL_LoyaltyProgram_m_addTransaction: Method = Method(name="addTransaction", parameters={Parameter(name='RandL_servId', type=StringType), Parameter(name='RandL_pName', type=StringType), Parameter(name='RandL_d', type=StringType), Parameter(name='RandL_accNr', type=StringType), Parameter(name='RandL_amnt', type=StringType)})
...
RandL_LoyaltyProgram.methods={RandL_LoyaltyProgram_m_enroll, RandL_LoyaltyProgram_m_getServices, RandL_LoyaltyProgram_m_selectPopularPartners, RandL_LoyaltyProgram_m_addTransaction, RandL_LoyaltyProgram_m_enrollAndCreateCustomer, RandL_LoyaltyProgram_m_getServices, RandL_LoyaltyProgram_m_addService}
...
RandL_Date_m_fromYMD: Method = Method(name="fromYMD", parameters={Parameter(name='RandL_y', type=StringType), Parameter(name='RandL_m', type=StringType), Parameter(name='RandL_k', type=StringType)}, type=StringType)
...
RandL_LoyaltyAccount.methods={RandL_LoyaltyAccount_m_getCustomerName, RandL_LoyaltyAccount_m_isEmpty, RandL_LoyaltyAccount_m_burn, RandL_LoyaltyAccount_m_earn}
...
RandL_TransactionReport.attributes={RandL_TransactionReport_totalEarned, RandL_TransactionReport_name, RandL_TransactionReport_number, RandL_TransactionReport_totalBurned, RandL_TransactionReport_balance}
...
RandL_Customer.attributes={RandL_Customer_gender, RandL_Customer_name, RandL_Customer_isMale, RandL_Customer_age, RandL_Customer_title}
...
domain_model = DomainModel(
    name="RandL",
    types={RandL_LoyaltyProgram, RandL_Service, RandL_Membership, RandL_Transaction, RandL_Date, RandL_LoyaltyAccount, RandL_CustomerCard, RandL_ServiceLevel, RandL_Earning, Transaction, RandL_ProgramPartner, RandL_Burning, RandL_TransactionReport, RandL_TransactionReportLine, RandL_Customer, RandL_Container_RandL, Gender, RandLColor},
    associations={program0, availableServices1, Membership2, date3, account4, generatedBy5, card8, deliveredServices15, programs17, until19, from_21, lines24, usedServices10, Membership11, transactions13, owner35, Membership36, transactions38, currentLevel41, card43, account46, card25, goodThru27, validFrom30, myLevel33, ref_RandL_LoyaltyProgram66, ref_RandL_Earning69, ref_RandL_LoyaltyAccount71, ref_RandL_ServiceLevel74, ref_RandL_TransactionReport77, ref_RandL_ProgramPartner80, ref_RandL_Burning82, ref_RandL_TransactionReportLine84, programs49, participants50, ref_RandL_Customer52, ref_RandL_Date54, ref_RandL_CustomerCard57, ref_RandL_Membership60, ref_RandL_Service63, programs94, cards96, memberships98, date101, transaction104, report107, partner86, transactions87, level89, dateOfBirth91, levels110, participants112, memberships115, partners108},
