...
Families_MemberFemale = Class(name="Families_MemberFemale")
...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={Families_Member, Family, Families_MemberMale, Families_MemberFemale, Families_Family, Member},
    associations={mother1, sons3, daughters5, familyFather7, familyMother8, familySon10, familyDaughter12, father0},
