...
domain_model = DomainModel(
    name="statemachine",
    types={statemachine_Named, statemachine_GStopState, statemachine_GStatemachine, GCompositeState, statemachine_Parameter, statemachine_CallAction, GAbstractAction, statemachine_Call, statemachine_GetParameter, Value, statemachine_GAbstractState, statemachine_GAbstractAction, statemachine_GState, Named, GAbstractState, statemachine_Transition, statemachine_Value, statemachine_GCompositeState, GState, statemachine_GStartState, statemachine_ConstantValue, statemachine_StringValue, ConstantValue, statemachine_NumberValue, statemachine_BooleanValue, statemachine_LongValue, NumberValue, ActionKind},
    associations={parameter19, call20, actions0, from_1, to3, guard6, delay8, signals11, states14, transitions16, parameter21},
    generalizations={gen_statemachine_GStopState_GAbstractState, gen_statemachine_GStatemachine_GCompositeState, gen_statemachine_CallAction_GAbstractAction, gen_statemachine_Parameter_Named, gen_statemachine_GetParameter_Value, gen_statemachine_GState_Named, gen_statemachine_GState_GAbstractState, gen_statemachine_Transition_Named, gen_statemachine_GCompositeState_GState, gen_statemachine_GStartState_GAbstractState, gen_statemachine_Call_Value, gen_statemachine_ConstantValue_Value, gen_statemachine_StringValue_ConstantValue, gen_statemachine_NumberValue_ConstantValue, gen_statemachine_BooleanValue_ConstantValue, gen_statemachine_LongValue_NumberValue},
    metadata=None
)
