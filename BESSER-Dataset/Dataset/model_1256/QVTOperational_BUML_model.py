...
domain_model = DomainModel(
    name="QVTOperational",
    types={QVTOperational_Constructor, ImperativeOperation, QVTOperational_ConstructorBody, OperationBody, QVTOperational_ContextualProperty, VarParameter, QVTOperational_Library, Module, QVTOperational_MappingBody, QVTOperational_MappingCallExp, ImperativeCallExp, QVTOperational_MappingOperation, MappingOperation, QVTOperational_EntryOperation, QVTOperational_Helper, QVTOperational_ImperativeCallExp, QVTOperational_ImperativeOperation, QVTOperational_MappingParameter, ModelParameter, QVTOperational_ModelParameter, QVTOperational_ModelType, QVTOperational_Module, EntryOperation, ModuleImport, ModelType, QVTOperational_ModuleImport, QVTOperational_OperationBody, QVTOperational_OperationalTransformation, QVTOperational_ResolveExp, QVTOperational_ResolveInExp, ResolveExp, QVTOperational_ObjectExp, ConstructorBody, QVTOperational_VarParameter, ImportKind, DirectionKind},
    associations={body0, context1, overridden3, result5, disjunct8, inherited9, extent15, entry16, moduleImport17, usedModelType19, merged12, operation29, modelParameter31, binding21, importedModule23, module25, body28, inMapping33, ctxOwner35, resOwner37},
    generalizations={gen_QVTOperational_Constructor_ImperativeOperation, gen_QVTOperational_ConstructorBody_OperationBody, gen_QVTOperational_Library_Module, gen_QVTOperational_MappingBody_OperationBody, gen_QVTOperational_MappingCallExp_ImperativeCallExp, gen_QVTOperational_MappingOperation_ImperativeOperation, gen_QVTOperational_EntryOperation_ImperativeOperation, gen_QVTOperational_Helper_ImperativeOperation, gen_QVTOperational_MappingParameter_VarParameter, gen_QVTOperational_ModelParameter_VarParameter, gen_QVTOperational_OperationalTransformation_Module, gen_QVTOperational_ResolveInExp_ResolveExp},
    metadata=None
)
