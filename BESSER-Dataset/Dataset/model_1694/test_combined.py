...
def test_hyp_helloworld_thing_is_not_abstract():
    assert not inspect.isabstract(helloworld_Thing)


def test_hyp_helloworld_thing_constructor_exists():
    assert callable(helloworld_Thing.__init__)


def test_hyp_helloworld_thing_constructor_args():
...
def test_hyp_helloworld_world_is_not_abstract():
    assert not inspect.isabstract(helloworld_World)


def test_hyp_helloworld_world_constructor_exists():
    assert callable(helloworld_World.__init__)


def test_hyp_helloworld_world_constructor_args():
...
def test_hyp_helloworld_thing_name_setter(instance):
