...
class helloworld_Thing:
    ...
    def __init__(self, name: str, helloworld_Thing: "helloworld_World" = None, helloworld_Thing3: "helloworld_Thing" = None, helloworld_Thing1: set["helloworld_Thing"] = None, helloworld_Thing6: "helloworld_Thing" = None, helloworld_Thing4: set["helloworld_Thing"] = None):
        self.name = name
