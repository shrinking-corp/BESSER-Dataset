...
# Classes
simpleJava_name = Class(name="simpleJava_name")
simpleJava_class_declaration = Class(name="simpleJava_class_declaration")
simpleJava_interface_declaration = Class(name="simpleJava_interface_declaration")
simpleJava_doc_comment = Class(name="simpleJava_doc_comment")
type_declaration = Class(name="type_declaration")
simpleJava_MODIFIER = Class(name="simpleJava_MODIFIER")
simpleJava_Model = Class(name="simpleJava_Model")
simpleJava_compilation_unit = Class(name="simpleJava_compilation_unit")
Model = Class(name="Model")
simpleJava_package_statement = Class(name="simpleJava_package_statement")
simpleJava_import_statement = Class(name="simpleJava_import_statement")
simpleJava_type_declaration = Class(name="simpleJava_type_declaration")
simpleJava_statement = Class(name="simpleJava_statement")
simpleJava_expression = Class(name="simpleJava_expression")
simpleJava_if_statement = Class(name="simpleJava_if_statement")
simpleJava_do_statement = Class(name="simpleJava_do_statement")
simpleJava_field_declaration = Class(name="simpleJava_field_declaration")
simpleJava_method_declaration = Class(name="simpleJava_method_declaration")
simpleJava_constructor_declaration = Class(name="simpleJava_constructor_declaration")
simpleJava_variable_declaration = Class(name="simpleJava_variable_declaration")
simpleJava_static_initializer = Class(name="simpleJava_static_initializer")
simpleJava_type = Class(name="simpleJava_type")
simpleJava_parameter_list = Class(name="simpleJava_parameter_list")
simpleJava_statement_block = Class(name="simpleJava_statement_block")
simpleJava_parameter = Class(name="simpleJava_parameter")
simpleJava_while_statement = Class(name="simpleJava_while_statement")
simpleJava_for_statement = Class(name="simpleJava_for_statement")
simpleJava_try_statement = Class(name="simpleJava_try_statement")
simpleJava_switch_statement = Class(name="simpleJava_switch_statement")
simpleJava_variable_declarator = Class(name="simpleJava_variable_declarator")
simpleJava_variable_initializer = Class(name="simpleJava_variable_initializer")
newBlock = Class(name="newBlock")
simpleJava_expression_aux = Class(name="simpleJava_expression_aux")
simpleJava_arglist = Class(name="simpleJava_arglist")
simpleJava_mais_aux = Class(name="simpleJava_mais_aux")
simpleJava_aux = Class(name="simpleJava_aux")
creating_aux = Class(name="creating_aux")
simpleJava_creating_expression = Class(name="simpleJava_creating_expression")
simpleJava_creating_aux = Class(name="simpleJava_creating_aux")
simpleJava_type_specifier = Class(name="simpleJava_type_specifier")
simpleJava_newBlock = Class(name="simpleJava_newBlock")
simpleJava_exp_aux = Class(name="simpleJava_exp_aux")
expression = Class(name="expression")
expression_aux = Class(name="expression_aux")
simpleJava_logical_expression = Class(name="simpleJava_logical_expression")
simpleJava_numeric_expression = Class(name="simpleJava_numeric_expression")
simpleJava_bit_expression = Class(name="simpleJava_bit_expression")
simpleJava_literal_expression = Class(name="simpleJava_literal_expression")
variable_declarator = Class(name="variable_declarator")
simpleJava_package_name_aux = Class(name="simpleJava_package_name_aux")
exp_aux = Class(name="exp_aux")
...
simpleJava_statement_break_: Property = Property(name="break_", type=StringType)
simpleJava_statement_continue_: Property = Property(name="continue_", type=StringType)
simpleJava_statement.attributes={simpleJava_statement_continue_, simpleJava_statement_break_}
...
simpleJava_variable_declarator.attributes={simpleJava_variable_declarator_nomeVariavel, simpleJava_variable_declarator_op}
...
simpleJava_literal_expression.attributes={simpleJava_literal_expression_string, simpleJava_literal_expression_l_float, simpleJava_literal_expression_inteiro, simpleJava_literal_expression_decimal}
...
return_88: BinaryAssociation = BinaryAssociation(
    name="return_88",
    ends={
...
domain_model = DomainModel(
    name="simpleJava",
    types={simpleJava_name, simpleJava_class_declaration, simpleJava_interface_declaration, simpleJava_doc_comment, type_declaration, simpleJava_MODIFIER, simpleJava_Model, simpleJava_compilation_unit, Model, simpleJava_package_statement, simpleJava_import_statement, simpleJava_type_declaration, simpleJava_statement, simpleJava_expression, simpleJava_if_statement, simpleJava_do_statement, simpleJava_field_declaration, simpleJava_method_declaration, simpleJava_constructor_declaration, simpleJava_variable_declaration, simpleJava_static_initializer, simpleJava_type, simpleJava_parameter_list, simpleJava_statement_block, simpleJava_parameter, simpleJava_while_statement, simpleJava_for_statement, simpleJava_try_statement, simpleJava_switch_statement, simpleJava_variable_declarator, simpleJava_variable_initializer, newBlock, simpleJava_expression_aux, simpleJava_arglist, simpleJava_mais_aux, simpleJava_aux, creating_aux, simpleJava_creating_expression, simpleJava_creating_aux, simpleJava_type_specifier, simpleJava_newBlock, simpleJava_exp_aux, expression, expression_aux, simpleJava_logical_expression, simpleJava_numeric_expression, simpleJava_bit_expression, simpleJava_literal_expression, variable_declarator, simpleJava_package_name_aux, exp_aux},
    associations={noomePacote5, nomeImporte7, declaracaoClasse10, declaracaoInterface12, modificadores14, pacote0, importes1, declaracao3, parametros57, corpo60, declaracaoVariavel62, expressao65, newbloco67, corpoIf70, corpoDoWhile72, superclasse16, implementosClasse19, corpoClasse22, declaracaoClasse25, modificadores27, superinterfaces30, corpoInterface33, comentario36, declaracaoMetodo38, declaracaoConstrutor40, declaracaoVariavel42, estatico44, modificadorMetodo46, tipoRetorno49, parametrosMetodo51, blocoMetodo53, tipoParametro55, expressaoVariavel107, valorVariaveis111, espressaoIf113, blcoIf116, blocoElse119, blocoDo122, corpoWhile74, corpoFor76, corpoTryCatch78, corpoSwitchCase80, expressaoSynchronized82, corpoSynchronize86, return_88, exececao91, modificador94, tipoVariavel97, declaracaoVariaveis100, blocoVariavel102, valorVariavel105, expressaoSwitch161, expressaoCases164, blocoSwitch167, modificador170, parametrosContrutor173, expressaoWhile125, blocoConstrutor176, expressaoWhile128, blocoWhile131, declaracaoVariavel134, expressaoDeclaracao137, expressaoFor140, expressaoIncremento143, blocoFor146, blocoTry149, parametroCatch152, blocoCatch155, blocoFinally158, parametros206, exp207, op210, expressoes213, argumentos215, blocoEstatico179, novoObjeto182, parametros184, tipoObjeto186, expressaoNew188, novo191, expressao193, logical195, numeric197, bit199, novo201, literal204, primitivo240, objeto243, espressao218, exp220, expressao223, expressao226, expressoesArgumentos229, tipoParametro232, pacote235, pacote238},
    generalizations={gen_simpleJava_doc_comment_type_declaration, gen_simpleJava_compilation_unit_Model, gen_simpleJava_constructor_declaration_newBlock, gen_simpleJava_aux_expression_aux, gen_simpleJava_aux_creating_aux, gen_simpleJava_exp_aux_expression, gen_simpleJava_expression_expression_aux, gen_simpleJava_arglist_variable_declarator, gen_simpleJava_name_expression_aux, gen_simpleJava_type_exp_aux},
    metadata=None
)
