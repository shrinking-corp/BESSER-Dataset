...
public class Customer  {
    ...
    public Customer(
        LocalDate dateOfBirth,        String emailAddress,        String phoneNumber,        String address,        String name    ) {
    ...
    public Customer(
        LocalDate dateOfBirth,        String emailAddress,        String phoneNumber,        String address,        String name        ArrayList<account_Account> account_accounts    ) {
        this.dateOfBirth = dateOfBirth;
        this.emailAddress = emailAddress;
        this.phoneNumber = phoneNumber;
        this.address = address;
