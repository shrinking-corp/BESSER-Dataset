...
SM_InitialState = Class(name="SM_InitialState")
State = Class(name="State")
SM_FinalState = Class(name="SM_FinalState")
...
domain_model = DomainModel(
    ...
    associations={owningStateMachine0, target1, source2, owningStateMachine5, ownedState7, ownedTransition8},
