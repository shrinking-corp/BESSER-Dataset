...
class SM_Transition:
    ...
    def __init__(self, trigger: str, effect: str, SM_Transition: "SM_State" = None, SM_Transition3: "SM_State" = None, ownedTransition: "SM_StateMachine" = None, Transition: "SM_StateMachine" = None):
...
class SM_State:
    ...
    def __init__(self, name: str, ownedState: "SM_StateMachine" = None, SM_State: "SM_Transition" = None, SM_State4: "SM_Transition" = None, State: "SM_StateMachine" = None):
        self.name = name
