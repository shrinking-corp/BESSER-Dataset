...
Simpletree_Node.attributes={Simpletree_Node_stopIndex, Simpletree_Node_startLineIndex, Simpletree_Node_stopLineIndex, Simpletree_Node_startIndex}
...
domain_model = DomainModel(
    name="Simpletree",
    types={Text, Simpletree_Text, Simpletree_Attribute, TreeElement, Simpletree_Node, Simpletree_File, Simpletree_Folder, Simpletree_TreeElement},
    associations={subFolder4, parentFolder7, file9, children10, attribute11, node0, folder1, rootNode2, parentNode12},
    generalizations={gen_Simpletree_Folder_TreeElement, gen_Simpletree_Node_Text, gen_Simpletree_Text_TreeElement, gen_Simpletree_Attribute_TreeElement, gen_Simpletree_File_TreeElement},
    metadata=None
)
