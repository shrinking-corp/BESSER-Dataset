...
class Simpletree_Node(Text):
    ...
    def __init__(self, startIndex: int, startLineIndex: int, stopIndex: int, stopLineIndex: int, parentNode: set["Simpletree_Text"] = None, node: set["Simpletree_Attribute"] = None, Node: "Simpletree_Attribute" = None, Node13: "Simpletree_Text" = None):
