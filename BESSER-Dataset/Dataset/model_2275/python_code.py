...
class education_School:
    ...
    def __init__(self, name: str, address: str, phone: str, education_School2: set["education_Course"] = None, education_School: set["education_Student"] = None, education_School5: "education_Student" = None, education_School14: "education_Course" = None):
        self.name = name
