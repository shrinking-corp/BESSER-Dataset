...
education_School = Class(name="education_School")
...
education_School.attributes={education_School_name, education_School_address, education_School_phone}
...
domain_model = DomainModel(
    name="education",
    types={education_Course, education_School, education_Student},
    associations={courses1, students0, schools3, courses6, students9, school12},
    generalizations={},
    metadata=None
)
