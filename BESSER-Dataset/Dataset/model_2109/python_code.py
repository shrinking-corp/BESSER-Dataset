...
class test_SomeTestClass:
    ...
    def __init__(self, attribute: str, test_SomeTestClass6: "test_PatchTestModel" = None, test_SomeTestClass9: "test_PatchTestModel" = None, test_SomeTestClass: "test_PatchTestModel" = None, test_SomeTestClass3: "test_PatchTestModel" = None):
...
class test_PatchTestModel:
    ...
    def __init__(self, id: str, oneAttribute: str, multiAttribute: str, test_PatchTestModel5: "test_SomeTestClass" = None, test_PatchTestModel8: set["test_SomeTestClass"] = None, test_PatchTestModel: "test_SomeTestClass" = None, test_PatchTestModel2: set["test_SomeTestClass"] = None):
        self.id = id
