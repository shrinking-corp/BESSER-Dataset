...
# Classes
test_PatchTestModel = Class(name="test_PatchTestModel")
test_SomeTestClass = Class(name="test_SomeTestClass")
test_SomeTestClassWithID = Class(name="test_SomeTestClassWithID")
