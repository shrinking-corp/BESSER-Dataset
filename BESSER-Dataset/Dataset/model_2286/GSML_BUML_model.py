...
# Classes
gsml_Course = Class(name="gsml_Course")
gsml_Grading = Class(name="gsml_Grading")
gsml_GradingScheme = Class(name="gsml_GradingScheme")
gsml_Task = Class(name="gsml_Task", is_abstract=True)
gsml_ConcreteTask = Class(name="gsml_ConcreteTask")
Task = Class(name="Task")
gsml_TaskGroup = Class(name="gsml_TaskGroup")
gsml_Grade = Class(name="gsml_Grade")
gsml_GradingSystem = Class(name="gsml_GradingSystem")
...
gsml_Task.attributes={gsml_Task_Name, gsml_Task_MinRequirementType, gsml_Task_MinRequirement}
...
domain_model = DomainModel(
    name="gsml",
    types={gsml_Course, gsml_Grading, gsml_GradingScheme, gsml_Task, gsml_ConcreteTask, Task, gsml_TaskGroup, gsml_Grade, gsml_GradingSystem, MinRequirementType},
    associations={gradingscheme17, gradings0, gradingschemes1, gradingscheme3, gradingScheme6, contains9, grades10, fallback12, courses15, tasks20, has23},
