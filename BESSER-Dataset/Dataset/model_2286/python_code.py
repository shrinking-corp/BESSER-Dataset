...
class gsml_Grading:
    ...
    def __init__(self, Semester: str, gsml_Grading18: "gsml_GradingScheme" = None, gsml_Grading: "gsml_Course" = None, gsml_Grading21: set["gsml_Task"] = None, gsml_Grading24: set["gsml_Task"] = None):
...
class gsml_Course:
    ...
    def __init__(self, Name: str, gsml_Course: set["gsml_Grading"] = None, gsml_Course2: set["gsml_GradingScheme"] = None, gsml_Course4: "gsml_GradingScheme" = None, gsml_Course7: "gsml_GradingScheme" = None, gsml_Course16: "gsml_GradingSystem" = None):
        self.Name = Name
