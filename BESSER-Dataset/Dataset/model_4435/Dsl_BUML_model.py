...
dsl_Task = Class(name="dsl_Task")
dsl_SensorType = Class(name="dsl_SensorType")
dsl_Ignorables = Class(name="dsl_Ignorables")
dsl_TouchSensor = Class(name="dsl_TouchSensor")
dsl_UltrasonicSensor = Class(name="dsl_UltrasonicSensor")
dsl_timeUnitValue = Class(name="dsl_timeUnitValue")
dsl_ColorSensor = Class(name="dsl_ColorSensor")
SensorType = Class(name="SensorType")
dsl_ColorValue = Class(name="dsl_ColorValue")
...
domain_model = DomainModel(
    name="dsl",
    types={dsl_Mission, dsl_Task, dsl_SensorType, dsl_Ignorables, dsl_TouchSensor, dsl_UltrasonicSensor, dsl_timeUnitValue, dsl_ColorSensor, SensorType, dsl_ColorValue, TouchSensorSides, Actions, timeUnit, Colors, Directions, CompareOperator},
    associations={tasks0, sensor1, ignoreBehavior3, keys8, timeunit5, key7},
    generalizations={gen_dsl_TouchSensor_SensorType, gen_dsl_UltrasonicSensor_SensorType, gen_dsl_ColorSensor_SensorType},
    metadata=None
)
