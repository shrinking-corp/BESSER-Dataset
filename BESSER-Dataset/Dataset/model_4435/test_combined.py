...
def test_hyp_dsl_colorvalue_is_not_abstract():
    assert not inspect.isabstract(dsl_ColorValue)


def test_hyp_dsl_colorvalue_constructor_exists():
    assert callable(dsl_ColorValue.__init__)


def test_hyp_dsl_colorvalue_constructor_args():
...
def test_hyp_dsl_timeunitvalue_is_not_abstract():
    assert not inspect.isabstract(dsl_timeUnitValue)


def test_hyp_dsl_timeunitvalue_constructor_exists():
    assert callable(dsl_timeUnitValue.__init__)


def test_hyp_dsl_timeunitvalue_constructor_args():
...
def test_hyp_dsl_colorvalue_color_setter(instance):
...
def test_hyp_dsl_colorsensor_distinct_setter(instance):
...
def test_hyp_dsl_timeunitvalue_unit_setter(instance):
...
def test_hyp_dsl_task_nrOfTimes_setter(instance):
...
@given(instance=dsl_Task_strategy)
def test_hyp_dsl_task_time_setter(instance):
