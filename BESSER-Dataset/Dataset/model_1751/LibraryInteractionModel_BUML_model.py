...
libraryinteractionmodel_Author.attributes={libraryinteractionmodel_Author_nationality, libraryinteractionmodel_Author_name, libraryinteractionmodel_Author_fullBio}
...
domain_model = DomainModel(
    ...
    types={libraryinteractionmodel_Clients, libraryinteractionmodel_Book, libraryinteractionmodel_Library, libraryinteractionmodel_Books, libraryinteractionmodel_Authors, libraryinteractionmodel_AuthorShort, libraryinteractionmodel_Reservation, libraryinteractionmodel_Reservations, libraryinteractionmodel_BookShort, libraryinteractionmodel_Author, libraryinteractionmodel_Client},
    associations={authors1, clients3, availableBooks0, self31, author5, currentReservation6, reservations8, items10, items12, self15, self18, items19, client22, book25, books28, items34},
    generalizations={},
    metadata=None
)
