...
class Order:
    ...
    def __init__(self, shipped: bool, number: int, ordered: date, shipTo: str, total: float, status: OrderStatus, items14: set["LineItem"] = None, account17: "Account" = None, payment19: "Payment" = None):
