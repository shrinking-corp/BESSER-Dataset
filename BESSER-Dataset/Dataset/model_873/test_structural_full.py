...
def test_assoc_ressource10_link_reassign_clear():
    ...
    _safe_set(a, 'simplepdl_RessourceLink11', b1)
    assert _is_linked(a, 'simplepdl_RessourceLink11', b1)
    if hasattr(b1, 'simplepdl_Ressource'):
        assert _is_linked(b1, 'simplepdl_Ressource', a)
    _safe_set(a, 'simplepdl_RessourceLink11', b2)
    assert _is_linked(a, 'simplepdl_RessourceLink11', b2)
    if hasattr(b1, 'simplepdl_Ressource'):
    ...
    _safe_set(a, 'simplepdl_RessourceLink11', None)
    assert not _is_linked(a, 'simplepdl_RessourceLink11', b2)
    if hasattr(b2, 'simplepdl_Ressource'):
...
def test_assoc_workDef9_link_reassign_clear():
    ...
    if hasattr(b1, 'simplepdl_RessourceLink'):
        assert _is_linked(b1, 'simplepdl_RessourceLink', a)
    _safe_set(a, 'simplepdl_WorkDefinition', b2)
    assert _is_linked(a, 'simplepdl_WorkDefinition', b2)
    if hasattr(b1, 'simplepdl_RessourceLink'):
        assert not _is_linked(b1, 'simplepdl_RessourceLink', a)
    if hasattr(b2, 'simplepdl_RessourceLink'):
        assert _is_linked(b2, 'simplepdl_RessourceLink', a)
    _safe_set(a, 'simplepdl_WorkDefinition', None)
    assert not _is_linked(a, 'simplepdl_WorkDefinition', b2)
    if hasattr(b2, 'simplepdl_RessourceLink'):
        assert not _is_linked(b2, 'simplepdl_RessourceLink', a)
