...
domain_model = DomainModel(
    name="simplepdl",
    types={simplepdl_Ressource, simplepdl_RessourceLink, simplepdl_Process, simplepdl_ProcessElement, simplepdl_WorkDefinition, ProcessElement, simplepdl_WorkSequence, simplepdl_Guidance, WorkSequenceType},
    associations={element7, workDef9, ressource10, processElements0, linksToPredecessors1, linksToSuccessors2, predecessor4, successor5},
    generalizations={gen_simplepdl_Guidance_ProcessElement, gen_simplepdl_Ressource_ProcessElement, gen_simplepdl_RessourceLink_ProcessElement, gen_simplepdl_WorkDefinition_ProcessElement, gen_simplepdl_WorkSequence_ProcessElement},
    metadata=None
)
