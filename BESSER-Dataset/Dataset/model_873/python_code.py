...
class simplepdl_WorkDefinition(ProcessElement):
    ...
    def __init__(self, name: str, max_time: int, min_time: int, simplepdl_WorkDefinition: "simplepdl_RessourceLink" = None, successor: set["simplepdl_WorkSequence"] = None, predecessor: set["simplepdl_WorkSequence"] = None, WorkDefinition: "simplepdl_WorkSequence" = None, WorkDefinition6: "simplepdl_WorkSequence" = None):
        self.name = name
