...
UML_14_Model = Class(name="UML_14_Model")
UML_14_Package = Class(name="UML_14_Package")
UML_14_Association = Class(name="UML_14_Association")
UML_14_AssociationEnd = Class(name="UML_14_AssociationEnd")
UML_14_NamedElement = Class(name="UML_14_NamedElement", is_abstract=True)
...
domain_model = DomainModel(
    name="UML_14",
    types={UML_14_DataType, UML_14_Constraint, UML_14_MultiplicityRange, UML_14_Method, UML_14_Attribute, UML_14_Generalization, UML_14_Class, UML_14_Parameter, NamedElement, UML_14_Primitive, DataType, UML_14_Enumeration, UML_14_EnumerationLiteral, UML_14_Comment, UML_14_Model, UML_14_Package, UML_14_Association, UML_14_AssociationEnd, UML_14_NamedElement},
    associations={type0, parameters1, multiplicity3, type4, child7, attributes21, methods24, literal27, enumeration28, package29, classes30, packages34, parent8, connection11, association12, participant13, multiplicity15, qualifier18, dataTypes36, generalizations39, associations42, comments44, constraints45},
    generalizations={gen_UML_14_Method_NamedElement, gen_UML_14_Attribute_NamedElement, gen_UML_14_Parameter_NamedElement, gen_UML_14_DataType_NamedElement, gen_UML_14_Primitive_DataType, gen_UML_14_Enumeration_DataType, gen_UML_14_Package_NamedElement, gen_UML_14_Association_NamedElement, gen_UML_14_AssociationEnd_NamedElement, gen_UML_14_Class_NamedElement},
    metadata=None
)
