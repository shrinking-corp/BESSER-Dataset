...
def test_hyp_database_scheme_is_not_abstract():
    assert not inspect.isabstract(database_Scheme)


def test_hyp_database_scheme_constructor_exists():
    assert callable(database_Scheme.__init__)


def test_hyp_database_scheme_constructor_args():
...
@given(instance=database_Column_strategy)
def test_hyp_database_column_PrimaryKey_setter(instance):
...
@given(instance=database_Column_strategy)
def test_hyp_database_column_NotNull_setter(instance):
...
def test_hyp_database_scheme_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
