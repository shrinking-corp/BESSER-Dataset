...
# Classes
kiamaas_Top = Class(name="kiamaas_Top")
kiamaas_Node = Class(name="kiamaas_Node", is_abstract=True)
kiamaas_Composite = Class(name="kiamaas_Composite")
Node = Class(name="Node")
kiamaas_Leaf = Class(name="kiamaas_Leaf")
