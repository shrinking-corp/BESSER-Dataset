...
class petriNet_InputArc:
    ...
    def __init__(self, weight: int, petriNet_InputArc8: "petriNet_GenericPlace" = None, petriNet_InputArc: "petriNet_PetriNet" = None, petriNet_InputArc11: "petriNet_Transition" = None):
        self.weight = weight
...
class petriNet_GenericPlace(ABC):
    ...
    def __init__(self, name: str, numberOfTokens: int, petriNet_GenericPlace9: "petriNet_InputArc" = None, petriNet_GenericPlace: "petriNet_PetriNet" = None, petriNet_GenericPlace18: "petriNet_OutputArc" = None):
        self.name = name
