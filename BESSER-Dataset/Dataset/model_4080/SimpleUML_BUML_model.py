...
# Classes
SimpleUML_UmlAttribute = Class(name="SimpleUML_UmlAttribute")
UmlModelElement = Class(name="UmlModelElement")
SimpleUML_UmlAssociation = Class(name="SimpleUML_UmlAssociation")
UmlPackageElement = Class(name="UmlPackageElement")
SimpleUML_UmlClass = Class(name="SimpleUML_UmlClass")
SimpleUML_UmlClassifier = Class(name="SimpleUML_UmlClassifier")
UmlClassifier = Class(name="UmlClassifier")
SimpleUML_UmlModelElement = Class(name="SimpleUML_UmlModelElement")
SimpleUML_UmlPackage = Class(name="SimpleUML_UmlPackage")
SimpleUML_UmlPackageElement = Class(name="SimpleUML_UmlPackageElement")
SimpleUML_UmlPrimitiveDataType = Class(name="SimpleUML_UmlPrimitiveDataType")
...
SimpleUML_UmlModelElement.attributes={SimpleUML_UmlModelElement_umlName, SimpleUML_UmlModelElement_id, SimpleUML_UmlModelElement_umlKind}
...
domain_model = DomainModel(
    name="SimpleUML",
    types={SimpleUML_UmlAttribute, UmlModelElement, SimpleUML_UmlAssociation, UmlPackageElement, SimpleUML_UmlClass, SimpleUML_UmlClassifier, UmlClassifier, SimpleUML_UmlModelElement, SimpleUML_UmlPackage, SimpleUML_UmlPackageElement, SimpleUML_UmlPrimitiveDataType},
    associations={umlSource1, umlDestination0, umlOwner3, umlType5, umlForward6, umlReverse7, umlAttribute9, umlGeneral11, umlSpecific14, umlAttribute116, umlOwnedElement18, umlNamespace19},
    generalizations={gen_SimpleUML_UmlAttribute_UmlModelElement, gen_SimpleUML_UmlAssociation_UmlPackageElement, gen_SimpleUML_UmlClass_UmlClassifier, gen_SimpleUML_UmlClassifier_UmlPackageElement, gen_SimpleUML_UmlPackage_UmlModelElement, gen_SimpleUML_UmlPackageElement_UmlModelElement, gen_SimpleUML_UmlPrimitiveDataType_UmlClassifier},
    metadata=None
)
