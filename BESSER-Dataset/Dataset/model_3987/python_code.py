...
class carnot_extensions_FormalParameterMappingsType:
    ...
    def setMappedData(self, carnot_formalParameter, carnot_data):
        # TODO: Implement setMappedData method
        pass

    def getMappedData(self, carnot_formalParameter) :
...
class carnot_Code:
    ...
    def __init__(self, name: str, code: str, value: str, carnot_Code: "carnot_ActivityType" = None, carnot_Code310: "carnot_QualityControlType" = None):
        self.name = name
        self.code = code
        self.value = value
...
class carnot_ApplicationTypeType(IMetaType):
    ...
    def __init__(self, accessPointProviderClass: str, instanceClass: str, panelClass: str, synchronous: str, validatorClass: str, type125: set["carnot_ApplicationType"] = None, ApplicationTypeType: "carnot_ApplicationType" = None, carnot_ApplicationTypeType: "carnot_ModelType" = None):
    ...
    @property
    def accessPointProviderClass(self):
...
class carnot_EventConditionTypeType(IMetaType):
    ...
    def __init__(self, processCondition: str, pullEventEmitterClass: str, rule: str, activityCondition: str, binderClass: str, implementation: str, panelClass: str, carnot_EventConditionTypeType: "carnot_ModelType" = None, EventConditionTypeType: "carnot_EventHandlerType" = None, type178: set["carnot_EventHandlerType"] = None):
    ...
    @property
    def pullEventEmitterClass(self):
...
class carnot_TriggerTypeType(IMetaType):
    ...
    def __init__(self, panelClass: str, pullTrigger: str, pullTriggerEvaluator: str, rule: str, carnot_TriggerTypeType: "carnot_ModelType" = None, type366: set["carnot_TriggerType"] = None, TriggerTypeType: "carnot_TriggerType" = None):
        self.panelClass = panelClass
...
class carnot_ApplicationContextTypeType(IMetaType):
    ...
    def __init__(self, validatorClass: str, accessPointProviderClass: str, hasApplicationPath: str, hasMappingId: str, panelClass: str, ApplicationContextTypeType: "carnot_ContextType" = None, type: set["carnot_ContextType"] = None, carnot_ApplicationContextTypeType: "carnot_ModelType" = None):
        self.validatorClass = validatorClass
        self.accessPointProviderClass = accessPointProviderClass
...
class carnot_EventActionTypeType(IMetaType):
    ...
    def __init__(self, actionClass: str, activityAction: str, panelClass: str, processAction: str, supportedConditionTypes: str, unsupportedContexts: str, EventActionTypeType: "carnot_AbstractEventAction" = None, type176: set["carnot_AbstractEventAction"] = None, carnot_EventActionTypeType: "carnot_ModelType" = None):
        ...
        pass
    @property
    def supportedConditionTypes(self):
...
class carnot_IConnectionSymbol(IGraphicalObject):
    ...
    def setTargetNode(self, carnot_nodeSymbol):
    ...
    def setSourceNode(self, carnot_nodeSymbol):
        # TODO: Implement setSourceNode method
        pass

class carnot_INodeSymbol(IGraphicalObject):

    def __init__(self, xPos: str, yPos: str, width: str, height: str, shape: str, targetSymbol: set["carnot_GenericLinkConnectionType"] = None, sourceSymbol: set["carnot_GenericLinkConnectionType"] = None, INodeSymbol: "carnot_GenericLinkConnectionType" = None, INodeSymbol198: "carnot_GenericLinkConnectionType" = None):
        self.xPos = xPos
        self.yPos = yPos
        self.width = width
        self.height = height
    ...
    def getInConnectionFeatures(self) :
        # TODO: Implement getInConnectionFeatures method
        pass

    def getOutConnectionFeatures(self) :
...
class carnot_IModelElementNodeSymbol(INodeSymbol):
    ...
    def __init__(self):
        ...
        pass
    def setModelElement(self, carnot_element):
...
class carnot_AbstractEventAction(IIdentifiableModelElement, ITypedElement):

    pass
class carnot_ApplicationType(IIdentifiableModelElement, ITypedElement, IAccessPointOwner):

    def __init__(self, interactive: str, ApplicationType126: "carnot_ApplicationTypeType" = None, ApplicationType: "carnot_ActivityType" = None, ApplicationType117: "carnot_ApplicationSymbolType" = None, carnot_ApplicationType: set["carnot_ContextType"] = None, applications: "carnot_ApplicationTypeType" = None, application: set["carnot_ActivityType"] = None, application123: set["carnot_ApplicationSymbolType"] = None, carnot_ApplicationType228: "carnot_ModelType" = None):
...
class carnot_ModelerType(IIdentifiableModelElement):
    ...
    def __init__(self, email: str, password: str, carnot_ModelerType: "carnot_ModelType" = None, ModelerType: "carnot_ModelerSymbolType" = None, modeler: set["carnot_ModelerSymbolType"] = None):
        self.email = email
...
class carnot_ActivityType(IEventHandlerOwner, IIdentifiableModelElement):
    ...
    def __init__(self, loopType: str, allowsAbortByPerformer: str, hibernateOnCreation: str, implementation: str, join: str, loopCondition: str, split: str, subProcessMode: str, ActivityType: "carnot_IModelParticipant" = None, ActivityType83: "carnot_ActivitySymbolType" = None, performedActivities: "carnot_IModelParticipant" = None, carnot_ActivityType: set["carnot_DataMappingType"] = None, carnot_ActivityType98: "carnot_IModelParticipant" = None, executedActivities: "carnot_ApplicationType" = None, executingActivities: "carnot_ProcessDefinitionType" = None, activity: set["carnot_ActivitySymbolType"] = None, startActivity: set["carnot_StartEventSymbol"] = None, to103: set["carnot_TransitionType"] = None, from_105: set["carnot_TransitionType"] = None, carnot_ActivityType108: "carnot_IdRef" = None, carnot_ActivityType110: set["carnot_Code"] = None, ActivityType121: "carnot_ApplicationType" = None, carnot_ActivityType283: "carnot_ProcessDefinitionType" = None, ActivityType294: "carnot_ProcessDefinitionType" = None, ActivityType329: "carnot_StartEventSymbol" = None, ActivityType350: "carnot_TransitionType" = None, ActivityType353: "carnot_TransitionType" = None):
        ...
        self.from_105 = from_105 if from_105 is not None else set()
    ...
    @property
    def allowsAbortByPerformer(self):
    ...
    @property
    def from_105(self):
        return self.__from_105

    @from_105.setter
    def from_105(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_carnot_ActivityType__from_105", None)
        self.__from_105 = value if value is not None else set()
...
class carnot_ProcessDefinitionType(IEventHandlerOwner, IIdentifiableModelElement):
    ...
    def __init__(self, defaultPriority: str, ProcessDefinitionType: "carnot_ActivityType" = None, ProcessDefinitionType304: "carnot_ProcessSymbolType" = None, carnot_ProcessDefinitionType297: "carnot_FormalParametersType" = None, carnot_ProcessDefinitionType299: "FormalParameterMappingsType" = None, carnot_ProcessDefinitionType301: "carnot_IdRef" = None, carnot_ProcessDefinitionType: "carnot_ModelType" = None, carnot_ProcessDefinitionType285: set["carnot_TransitionType"] = None, carnot_ProcessDefinitionType278: "carnot_PoolSymbol" = None, carnot_ProcessDefinitionType282: set["carnot_ActivityType"] = None, implementationProcess: set["carnot_ActivityType"] = None, process: set["carnot_ProcessSymbolType"] = None, carnot_ProcessDefinitionType287: set["carnot_TriggerType"] = None, carnot_ProcessDefinitionType289: set["carnot_DataPathType"] = None, carnot_ProcessDefinitionType291: set["carnot_DiagramType"] = None):
...
class carnot_TransitionType(IIdentifiableModelElement):
    ...
    def TransitionType106(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "from_105"):
                opp_val = getattr(old_value, "from_105", None)
                if isinstance(opp_val, set):
                    opp_val.discard(self)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "from_105"):
                opp_val = getattr(value, "from_105", None)
                if opp_val is None:
                    setattr(value, "from_105", set([self]))
                elif isinstance(opp_val, set):
                    opp_val.add(self)
...
class carnot_TriggerType(IIdentifiableModelElement, ITypedElement, IAccessPointOwner):

    pass
class carnot_DataType(IIdentifiableModelElement, ITypedElement):

    def __init__(self, predefined: str, DataType: "carnot_ConditionalPerformerType" = None, DataType144: "carnot_DataMappingType" = None, carnot_DataType225: "carnot_ModelType" = None, data: set["carnot_DataMappingType"] = None, DataType146: "carnot_DataPathType" = None, DataType148: "carnot_DataSymbolType" = None, data153: "carnot_DataTypeType" = None, data155: set["carnot_DataSymbolType"] = None, data158: set["carnot_ConditionalPerformerType"] = None, data161: set["carnot_DataPathType"] = None, data163: set["carnot_ParameterMappingType"] = None, carnot_DataType: "carnot_ExternalReferenceType" = None, DataType167: "carnot_DataTypeType" = None, DataType265: "carnot_ParameterMappingType" = None):
...
class carnot_IMetaType(IIdentifiableModelElement):
    ...
    def getExtensionPointId(self) :
        # TODO: Implement getExtensionPointId method
        pass

class carnot_AccessPointType(IIdentifiableModelElement, ITypedElement):
...
class carnot_IAccessPointOwner(ABC):
    ...
    pass
class carnot_EventHandlerType(IIdentifiableModelElement, ITypedElement, IAccessPointOwner):

    def __init__(self, unbindOnMatch: str, autoBind: str, consumeOnMatch: str, logHandler: str, carnot_EventHandlerType: "carnot_IEventHandlerOwner" = None, eventHandlers: "carnot_EventConditionTypeType" = None, EventHandlerType: "carnot_EventConditionTypeType" = None, carnot_EventHandlerType180: set["carnot_BindActionType"] = None, carnot_EventHandlerType182: set["carnot_EventActionType"] = None, carnot_EventHandlerType184: set["carnot_UnbindActionType"] = None):
...
class carnot_AttributeType:
    ...
    def __init__(self, group: str, any: str, mixed: str, name: str, type: str, value: str, carnot_AttributeType: "carnot_IExtensibleElement" = None, AttributeType: "carnot_IdentifiableReference" = None, carnot_AttributeType128: "carnot_XmlTextNode" = None, attribute: "carnot_IdentifiableReference" = None):
        self.group = group
        self.any = any
        self.mixed = mixed
        self.name = name
    ...
    def setAttributeValue(self, carnot_type, carnot_value):
...
class carnot_LinkTypeType(IMetaType, IExtensibleElement):
    ...
    def __init__(self, targetSymbol: str, showRoleNames: str, sourceRole: str, sourceClass: str, sourceCardinality: str, targetRole: str, targetClass: str, targetCardinality: str, lineStyle: str, lineColor: str, sourceSymbol: str, showLinkTypeName: str, LinkTypeType: "carnot_GenericLinkConnectionType" = None, linkType: set["carnot_GenericLinkConnectionType"] = None, carnot_LinkTypeType: "carnot_ModelType" = None):
...
class carnot_ISymbolContainer(IExtensibleElement):
    ...
    def __init__(self, nodes: str, connections: str, carnot_ISymbolContainer54: set["carnot_TransitionConnectionType"] = None, carnot_ISymbolContainer56: set["carnot_WorksForConnectionType"] = None, carnot_ISymbolContainer58: set["carnot_TeamLeadConnectionType"] = None, carnot_ISymbolContainer16: set["carnot_EndEventSymbol"] = None, carnot_ISymbolContainer18: set["carnot_GatewaySymbol"] = None, carnot_ISymbolContainer: set["carnot_ActivitySymbolType"] = None, carnot_ISymbolContainer8: set["carnot_AnnotationSymbolType"] = None, carnot_ISymbolContainer10: set["carnot_ApplicationSymbolType"] = None, carnot_ISymbolContainer12: set["carnot_ConditionalPerformerSymbolType"] = None, carnot_ISymbolContainer14: set["carnot_DataSymbolType"] = None, carnot_ISymbolContainer30: set["carnot_PublicInterfaceSymbol"] = None, carnot_ISymbolContainer20: set["carnot_GroupSymbolType"] = None, carnot_ISymbolContainer22: set["carnot_IntermediateEventSymbol"] = None, carnot_ISymbolContainer24: set["carnot_ModelerSymbolType"] = None, carnot_ISymbolContainer26: set["carnot_OrganizationSymbolType"] = None, carnot_ISymbolContainer28: set["carnot_ProcessSymbolType"] = None, carnot_ISymbolContainer40: set["carnot_ExecutedByConnectionType"] = None, carnot_ISymbolContainer32: set["carnot_RoleSymbolType"] = None, carnot_ISymbolContainer34: set["carnot_StartEventSymbol"] = None, carnot_ISymbolContainer36: set["carnot_TextSymbolType"] = None, carnot_ISymbolContainer38: set["carnot_DataMappingConnectionType"] = None, carnot_ISymbolContainer52: set["carnot_SubProcessOfConnectionType"] = None, carnot_ISymbolContainer42: set["carnot_GenericLinkConnectionType"] = None, carnot_ISymbolContainer44: set["carnot_PartOfConnectionType"] = None, carnot_ISymbolContainer46: set["carnot_PerformsConnectionType"] = None, carnot_ISymbolContainer48: set["carnot_TriggersConnectionType"] = None, carnot_ISymbolContainer50: set["carnot_RefersToConnectionType"] = None):
        self.nodes = nodes
    ...
    def getNodeContainingFeatures(self) :
        # TODO: Implement getNodeContainingFeatures method
        pass

    def getConnectionContainingFeatures(self) :
...
class carnot_IGraphicalObject(IModelElement):
    ...
    def __init__(self, fillColor: str, style: str, borderColor: str, to: set["carnot_RefersToConnectionType"] = None, from_: set["carnot_RefersToConnectionType"] = None, IGraphicalObject313: "carnot_RefersToConnectionType" = None, IGraphicalObject: "carnot_RefersToConnectionType" = None):
    ...
    def from_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_carnot_IGraphicalObject__from_", None)
...
class carnot_ContextType(ITypedElement, IExtensibleElement, IModelElement, IAccessPointOwner):

    pass
class carnot_DiagramType(IExtensibleElement, ISymbolContainer, IModelElement):

    def __init__(self, orientation: str, name: str, mode: str, diagram: set["carnot_PoolSymbol"] = None, carnot_DiagramType: "carnot_ModelType" = None, DiagramType: "carnot_PoolSymbol" = None, carnot_DiagramType292: "carnot_ProcessDefinitionType" = None):
        self.orientation = orientation
        self.name = name
        self.mode = mode
...
class carnot_DataMappingType(IModelElement, IIdentifiableElement):
    ...
    def __init__(self, dataPath: str, direction: str, applicationAccessPoint: str, applicationPath: str, context: str, dataMappings143: "carnot_DataType" = None, carnot_DataMappingType: "carnot_ActivityType" = None, DataMappingType: "carnot_DataType" = None):
        self.dataPath = dataPath
        self.direction = direction
    ...
    @property
    def applicationAccessPoint(self):
