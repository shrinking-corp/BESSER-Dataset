...
class opf_Reference:
    ...
    def __init__(self, href: str, type: str, title: str, opf_Reference: "opf_Guide" = None):
        self.href = href
        self.type = type
        self.title = title
...
class opf_Item:
    ...
    def __init__(self, id: str, href: str, media_type: str, fallback: str, fallback_style: str, required_namespace: str, required_modules: str, file: str, noToc: bool, title: str, generated: bool, sourcePath: str, opf_Item: "opf_Manifest" = None):
        self.id = id
        self.href = href
...
class opf_Meta:
    ...
    def __init__(self, name: str, content: str, opf_Meta: "opf_Metadata" = None):
        self.name = name
...
class opf_Itemref:
    ...
    def __init__(self, idref: str, linear: str, opf_Itemref: "opf_Spine" = None):
        self.idref = idref
        self.linear = linear
...
class opf_Spine:
    ...
    def __init__(self, toc: str, opf_Spine44: set["opf_Itemref"] = None, opf_Spine: "opf_Package" = None):
        self.toc = toc
...
class opf_Package:
    ...
    def __init__(self, version: str, uniqueIdentifier: str, generateCoverHTML: bool, generateTableOfContents: bool, includeReferencedResources: bool, opf_Package4: "opf_Spine" = None, opf_Package6: "opf_Guide" = None, opf_Package8: "opf_Tours" = None, opf_Package: "opf_Metadata" = None, opf_Package2: "opf_Manifest" = None):
