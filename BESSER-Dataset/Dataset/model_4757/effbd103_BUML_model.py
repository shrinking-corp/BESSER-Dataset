...
# Classes
effbd103_Sequence = Class(name="effbd103_Sequence", is_abstract=True)
effbd103_Flow = Class(name="effbd103_Flow")
effbd103_OutputPort = Class(name="effbd103_OutputPort")
effbd103_InputPort = Class(name="effbd103_InputPort")
effbd103_Description = Class(name="effbd103_Description")
effbd103_Token = Class(name="effbd103_Token")
effbd103_SequenceNode = Class(name="effbd103_SequenceNode", is_abstract=True)
effbd103_And = Class(name="effbd103_And")
Sequence = Class(name="Sequence")
effbd103_Function = Class(name="effbd103_Function")
SequenceNode = Class(name="SequenceNode")
ProcessNode = Class(name="ProcessNode")
Port = Class(name="Port")
effbd103_Port = Class(name="effbd103_Port", is_abstract=True)
effbd103_Item = Class(name="effbd103_Item")
effbd103_ProcessNode = Class(name="effbd103_ProcessNode", is_abstract=True)
effbd103_Or = Class(name="effbd103_Or")
effbd103_Start = Class(name="effbd103_Start")
effbd103_Final = Class(name="effbd103_Final")
effbd103_Loop = Class(name="effbd103_Loop")
effbd103_LoopExit = Class(name="effbd103_LoopExit")
effbd103_Iteration = Class(name="effbd103_Iteration")
...
effbd103_SequenceNode.attributes={effbd103_SequenceNode_name, effbd103_SequenceNode_tMax, effbd103_SequenceNode_tMin}
...
domain_model = DomainModel(
    name="effbd103",
    types={effbd103_Sequence, effbd103_Flow, effbd103_OutputPort, effbd103_InputPort, effbd103_Description, effbd103_Token, effbd103_SequenceNode, effbd103_And, Sequence, effbd103_Function, SequenceNode, ProcessNode, Port, effbd103_Port, effbd103_Item, effbd103_ProcessNode, effbd103_Or, effbd103_Start, effbd103_Final, effbd103_Loop, effbd103_LoopExit, effbd103_Iteration, FunctionDomain},
    ...
    generalizations={gen_effbd103_Sequence_SequenceNode, gen_effbd103_And_Sequence, gen_effbd103_Function_SequenceNode, gen_effbd103_Function_ProcessNode, gen_effbd103_InputPort_Port, gen_effbd103_Flow_ProcessNode, gen_effbd103_OutputPort_Port, gen_effbd103_Or_Sequence, gen_effbd103_Start_Sequence, gen_effbd103_Final_Sequence, gen_effbd103_Loop_Sequence, gen_effbd103_LoopExit_Sequence, gen_effbd103_Iteration_Sequence},
    metadata=None
)
