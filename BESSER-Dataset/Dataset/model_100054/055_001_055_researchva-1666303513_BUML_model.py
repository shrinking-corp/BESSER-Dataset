...
# Classes
researchva_Paragraph = Class(name="researchva_Paragraph")
Counted = Class(name="Counted")
researchva_Researcher = Class(name="researchva_Researcher")
researchva_Write = Class(name="researchva_Write")
researchva_Review = Class(name="researchva_Review")
researchva_Paper = Class(name="researchva_Paper")
researchva_Skill = Class(name="researchva_Skill")
Named = Class(name="Named")
researchva_Keyword = Class(name="researchva_Keyword")
researchva_Named = Class(name="researchva_Named", is_abstract=True)
researchva_Counted = Class(name="researchva_Counted", is_abstract=True)
researchva_Labelled = Class(name="researchva_Labelled", is_abstract=True)
researchva_ReviewNote = Class(name="researchva_ReviewNote")
Labelled = Class(name="Labelled")
researchva_PublicationStructure = Class(name="researchva_PublicationStructure")
...
domain_model = DomainModel(
    name="researchva",
    types={researchva_Paragraph, Counted, researchva_Researcher, researchva_Write, researchva_Review, researchva_Paper, researchva_Skill, Named, researchva_Keyword, researchva_Named, researchva_Counted, researchva_Labelled, researchva_ReviewNote, Labelled, researchva_PublicationStructure},
    associations={paragraphs6, authors7, citedBy9, writes0, reviews1, res_papers3, skills4, papers21, allKeyWords24, reviews11, paragraph13, reviewNote16, researchers19},
    generalizations={gen_researchva_Paragraph_Counted, gen_researchva_Paragraph_Named, gen_researchva_Paper_Named, gen_researchva_ReviewNote_Named, gen_researchva_Write_Labelled, gen_researchva_Review_Labelled, gen_researchva_PublicationStructure_Named, gen_researchva_Keyword_Named},
    metadata=None
)
