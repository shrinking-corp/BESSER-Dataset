...
# Classes
test_EClass0 = Class(name="test_EClass0")
test_EClass1 = Class(name="test_EClass1")
test_EClass2 = Class(name="test_EClass2")
...
domain_model = DomainModel(
    name="test",
    types={test_EClass0, test_EClass1, test_EClass2, EEnum0},
