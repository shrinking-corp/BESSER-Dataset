...
class eavlibrary_Writer:
    ...
    def __init__(self, image: str, abstract: str, name: str, Writer: "eavlibrary_Book" = None, eavlibrary_Writer: "eavlibrary_Library" = None, author: set["eavlibrary_Book"] = None, eavlibrary_Writer6: "eavlibrary_City" = None, eavlibrary_Writer8: set["eavlibrary_Pen"] = None):
        self.image = image
