...
# Classes
eavlibrary_City = Class(name="eavlibrary_City")
eavlibrary_Library = Class(name="eavlibrary_Library")
eavlibrary_Book = Class(name="eavlibrary_Book")
eavlibrary_Writer = Class(name="eavlibrary_Writer")
eavlibrary_Pen = Class(name="eavlibrary_Pen")
...
eavlibrary_Book.attributes={eavlibrary_Book_title, eavlibrary_Book_test, eavlibrary_Book_pages, eavlibrary_Book_category}
...
eavlibrary_Writer.attributes={eavlibrary_Writer_abstract, eavlibrary_Writer_name, eavlibrary_Writer_image}
...
domain_model = DomainModel(
    name="eavlibrary",
    types={eavlibrary_City, eavlibrary_Library, eavlibrary_Book, eavlibrary_Writer, eavlibrary_Pen, BookCategory},
    associations={author0, writers1, books2, books4, city5, pens7},
    generalizations={},
    metadata=None
)
