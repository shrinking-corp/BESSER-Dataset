...
def test_hyp_statemachinemetamodel_state_is_not_abstract():
    assert not inspect.isabstract(StatemachineMetamodel_State)


def test_hyp_statemachinemetamodel_state_constructor_exists():
    assert callable(StatemachineMetamodel_State.__init__)


def test_hyp_statemachinemetamodel_state_constructor_args():
...
def test_hyp_statemachinemetamodel_statemachine_is_not_abstract():
    assert not inspect.isabstract(StatemachineMetamodel_Statemachine)


def test_hyp_statemachinemetamodel_statemachine_constructor_exists():
    assert callable(StatemachineMetamodel_Statemachine.__init__)


def test_hyp_statemachinemetamodel_statemachine_constructor_args():
    sig = inspect.signature(StatemachineMetamodel_Statemachine.__init__)
    params = list(sig.parameters.keys())



def test_hyp_statemachinemetamodel_transition_is_not_abstract():
    assert not inspect.isabstract(StatemachineMetamodel_Transition)


def test_hyp_statemachinemetamodel_transition_constructor_exists():
    assert callable(StatemachineMetamodel_Transition.__init__)


def test_hyp_statemachinemetamodel_transition_constructor_args():
...
def test_hyp_statemachinemetamodel_state_name_setter(instance):
