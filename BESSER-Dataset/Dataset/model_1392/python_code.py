...
class StatemachineMetamodel_State:
    ...
    def __init__(self, name: str, StatemachineMetamodel_State2: "StatemachineMetamodel_Transition" = None, StatemachineMetamodel_State: "StatemachineMetamodel_Statemachine" = None, StatemachineMetamodel_State4: set["StatemachineMetamodel_Transition"] = None):
        self.name = name
