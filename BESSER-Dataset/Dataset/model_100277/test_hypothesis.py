...
def test_hlcorestructure_arbitrarysort_is_not_abstract():
    assert not inspect.isabstract(hlcorestructure_ArbitrarySort)


def test_hlcorestructure_arbitrarysort_constructor_exists():
    assert callable(hlcorestructure_ArbitrarySort.__init__)


def test_hlcorestructure_arbitrarysort_constructor_args():
    sig = inspect.signature(hlcorestructure_ArbitrarySort.__init__)
    params = list(sig.parameters.keys())



def test_hlcorestructure_anysort_is_not_abstract():
    assert not inspect.isabstract(hlcorestructure_AnySort)


def test_hlcorestructure_anysort_constructor_exists():
    assert callable(hlcorestructure_AnySort.__init__)


def test_hlcorestructure_anysort_constructor_args():
    sig = inspect.signature(hlcorestructure_AnySort.__init__)
    params = list(sig.parameters.keys())



def test_hlcorestructure_unparsed_is_not_abstract():
    assert not inspect.isabstract(hlcorestructure_Unparsed)


def test_hlcorestructure_unparsed_constructor_exists():
    assert callable(hlcorestructure_Unparsed.__init__)


def test_hlcorestructure_unparsed_constructor_args():
