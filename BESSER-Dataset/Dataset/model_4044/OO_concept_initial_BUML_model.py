...
OO_concept_StructuralFeature = Class(name="OO_concept_StructuralFeature", is_abstract=True)
...
domain_model = DomainModel(
    name="OO_concept",
    types={OO_concept_PackageableElement, OO_concept_Package, PackageableElement, NamedElement, OO_concept_Class, Classifier, Type, OO_concept_Operation, OO_concept_Property, OO_concept_Classifier, OO_concept_NamedElement, OO_concept_Model, Package, TypedElement, BehavioralFeature, OO_concept_TypedElement, OO_concept_Type, OO_concept_BehavioralFeature, Feature, OO_concept_Behavior, Class_, OO_concept_StructuralFeature, OO_concept_Parameter, OO_concept_Feature, StructuralFeature, OO_concept_Generalization, OO_concept_Dependency, VisibilityKind},
    associations={packagedElement0, ownedOperation1, ownedAttribute2, nestedClassifier4, generalization15, type16, method17, ownedParameter6, general8, specific10, supplier11, client12},
    generalizations={gen_OO_concept_Package_PackageableElement, gen_OO_concept_Package_NamedElement, gen_OO_concept_Class_PackageableElement, gen_OO_concept_Class_Classifier, gen_OO_concept_Class_Type, gen_OO_concept_Model_Package, gen_OO_concept_Operation_TypedElement, gen_OO_concept_Operation_BehavioralFeature, gen_OO_concept_TypedElement_NamedElement, gen_OO_concept_Type_NamedElement, gen_OO_concept_BehavioralFeature_Feature, gen_OO_concept_Behavior_Class, gen_OO_concept_StructuralFeature_Feature, gen_OO_concept_Feature_NamedElement, gen_OO_concept_Property_TypedElement, gen_OO_concept_Property_StructuralFeature, gen_OO_concept_Parameter_TypedElement},
    metadata=None
)
