...
def test_hyp_shopping_cart_has_Delete_from_Shopping_Cart__():
...
def test_hyp_shopping_cart_has_cartId():
...
def test_hyp_shopping_cart_has_date():
...
def test_hyp_shopping_cart_has_productId():
...
def test_hyp_shopping_cart_has_Checkout__():
...
def test_hyp_shopping_cart_has_change_to_cart__():
...
def test_hyp_shopping_cart_has_Add_items_to_shopping_cart__():
...
def test_hyp_order_details_has_subTotal():
...
def test_hyp_order_details_has_unitCost():
...
def test_hyp_order_details_has_Payment__():
...
def test_hyp_order_details_has_orderId():
...
def test_hyp_order_details_has_Report_Generation():
...
def test_hyp_order_details_has_quantity():
...
def test_hyp_order_details_has_productName():
...
def test_hyp_order_details_has_productId():
...
def test_hyp_shippinginfo_has_shippingCost():
...
def test_hyp_shippinginfo_has_shippingType():
...
def test_hyp_shippinginfo_has_shippingRegionId():
...
def test_hyp_shippinginfo_has_View_Shipping_Status__():
...
def test_hyp_shippinginfo_has_shippingId():
...
def test_hyp_admin_has_adminName():
...
def test_hyp_admin_has_Reverse__():
...
def test_hyp_admin_has_attribute():
...
def test_hyp_admin_has_Contact_Us__():
...
def test_hyp_user_has_View_Account_Purchase_History__():
...
def test_hyp_user_has_Update_Account_Information__():
...
def test_hyp_user_has_Logout__():
...
def test_hyp_user_has_loginStatus():
...
def test_hyp_customer_has_search__():
...
def test_hyp_customer_has_login__():
...
def test_hyp_customer_has_shippingInfo():
...
def test_hyp_customer_has_registration__():
...
def test_hyp_customer_has_creditCardInfo():
...
def test_hyp_customer_has_customerName():
...
@given(instance=Shopping_cart_strategy)
def test_hyp_shopping_cart_Delete_from_Shopping_Cart___setter(instance):
...
@given(instance=Shopping_cart_strategy)
def test_hyp_shopping_cart_Checkout___setter(instance):
...
@given(instance=Shopping_cart_strategy)
def test_hyp_shopping_cart_change_to_cart___setter(instance):
...
@given(instance=Shopping_cart_strategy)
def test_hyp_shopping_cart_Add_items_to_shopping_cart___setter(instance):
...
@settings(max_examples=50)
def test_hyp_order_details_instantiation(instance):
...
@given(instance=Order_Details_strategy)
def test_hyp_order_details_Payment___setter(instance):
...
@given(instance=Order_Details_strategy)
def test_hyp_order_details_Report_Generation_setter(instance):
...
@settings(max_examples=50)
def test_hyp_shippinginfo_instantiation(instance):
...
@given(instance=shippingInfo_strategy)
def test_hyp_shippinginfo_View_Shipping_Status___setter(instance):
...
@given(instance=Admin_strategy)
def test_hyp_admin_Help___setter(instance):
...
@given(instance=Admin_strategy)
def test_hyp_admin_Reverse___setter(instance):
...
@given(instance=Admin_strategy)
def test_hyp_admin_Contact_Us___setter(instance):
...
@given(instance=User_strategy)
def test_hyp_user_View_Account_Purchase_History___setter(instance):
...
@given(instance=User_strategy)
def test_hyp_user_Update_Account_Information___setter(instance):
...
@given(instance=User_strategy)
def test_hyp_user_Logout___setter(instance):
...
@given(instance=Customer_strategy)
def test_hyp_customer_search___setter(instance):
...
@given(instance=Customer_strategy)
def test_hyp_customer_login___setter(instance):
...
@given(instance=Customer_strategy)
def test_hyp_customer_registration___setter(instance):
