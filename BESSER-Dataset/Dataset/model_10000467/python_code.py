...
class Order:
    ...
    def __init__(self, shipTo: str, total: float, status: OrderStatus, number: int, ordered: date, shipped: bool, items14: set["LineItem"] = None, account17: "Account" = None, payment19: "Payment" = None):
        self.shipTo = shipTo
        self.total = total
        self.status = status
        self.number = number
