...
internalsm_TimeConstraintSpecification.attributes={internalsm_TimeConstraintSpecification_startTimestamp, internalsm_TimeConstraintSpecification_expectedLength, internalsm_TimeConstraintSpecification_stopTimestamp, internalsm_TimeConstraintSpecification_id}
...
domain_model = DomainModel(
    name="internalsm",
    types={internalsm_EventToken, internalsm_State, internalsm_Transition, internalsm_InternalExecutionModel, internalsm_TimeConstraint, internalsm_Event, internalsm_Guard, internalsm_AtomicEventPattern, internalsm_FinalState, State, internalsm_InitState, internalsm_TrapState, internalsm_StateMachine, internalsm_EventPattern, internalsm_TimeConstraintSpecification, NumericCompareOperator, TimeConstraintType, EventProcessingContext},
    associations={inTransitions1, eventTokens3, outTransitions0, stateMachines16, latestEvent18, eventTokens21, timeConstraints4, lastProcessedEvent5, preState7, guard8, postState9, eventType11, states13, eventPattern15, currentState23, recordedEvents25, timeConstraintSpecification28},
