...
# Classes
eol_expression_Expression = Class(name="eol_expression_Expression", is_abstract=True)
eol_expression_Type = Class(name="eol_expression_Type")
eol_expression_OperatorExpression = Class(name="eol_expression_OperatorExpression", is_abstract=True)
Expression = Class(name="Expression")
eol_expression_UnaryOperatorExpression = Class(name="eol_expression_UnaryOperatorExpression", is_abstract=True)
OperatorExpression = Class(name="OperatorExpression")
eol_expression_NotOperatorExpression = Class(name="eol_expression_NotOperatorExpression")
UnaryOperatorExpression = Class(name="UnaryOperatorExpression")
eol_expression_NegativeOperatorExpression = Class(name="eol_expression_NegativeOperatorExpression")
eol_expression_BinaryOperatorExpression = Class(name="eol_expression_BinaryOperatorExpression", is_abstract=True)
eol_expression_LogicalOperatorExpression = Class(name="eol_expression_LogicalOperatorExpression", is_abstract=True)
BinaryOperatorExpression = Class(name="BinaryOperatorExpression")
eol_expression_AndOperatorExpression = Class(name="eol_expression_AndOperatorExpression")
LogicalOperatorExpression = Class(name="LogicalOperatorExpression")
eol_expression_PlusOperatorExpression = Class(name="eol_expression_PlusOperatorExpression")
eol_expression_ComparisonOperatorExpression = Class(name="eol_expression_ComparisonOperatorExpression", is_abstract=True)
eol_expression_GreaterThanOrEqualToOperatorExpression = Class(name="eol_expression_GreaterThanOrEqualToOperatorExpression")
ComparisonOperatorExpression = Class(name="ComparisonOperatorExpression")
eol_expression_GreaterThanOperatorExpression = Class(name="eol_expression_GreaterThanOperatorExpression")
eol_expression_LessThanOrEqualToOperatorExpression = Class(name="eol_expression_LessThanOrEqualToOperatorExpression")
eol_expression_LessThanOperatorExpression = Class(name="eol_expression_LessThanOperatorExpression")
eol_expression_NotEqualsOperatorExpression = Class(name="eol_expression_NotEqualsOperatorExpression")
eol_expression_EqualsOperatorExpression = Class(name="eol_expression_EqualsOperatorExpression")
eol_expression_VariableDeclarationExpression = Class(name="eol_expression_VariableDeclarationExpression")
eol_expression_NameExpression = Class(name="eol_expression_NameExpression")
eol_expression_FormalParameterExpression = Class(name="eol_expression_FormalParameterExpression")
VariableDeclarationExpression = Class(name="VariableDeclarationExpression")
eol_expression_FeatureCallExpression = Class(name="eol_expression_FeatureCallExpression", is_abstract=True)
eol_expression_MethodCallExpression = Class(name="eol_expression_MethodCallExpression")
FeatureCallExpression = Class(name="FeatureCallExpression")
eol_expression_PropertyCallExpression = Class(name="eol_expression_PropertyCallExpression")
eol_expression_FOLMethodCallExpression = Class(name="eol_expression_FOLMethodCallExpression")
eol_expression_XorOperatorExpression = Class(name="eol_expression_XorOperatorExpression")
eol_expression_OrOperatorExpression = Class(name="eol_expression_OrOperatorExpression")
eol_expression_ImpliesOperatorExpression = Class(name="eol_expression_ImpliesOperatorExpression")
eol_expression_ArithmeticOperatorExpression = Class(name="eol_expression_ArithmeticOperatorExpression", is_abstract=True)
eol_expression_DivideOperatorExpression = Class(name="eol_expression_DivideOperatorExpression")
ArithmeticOperatorExpression = Class(name="ArithmeticOperatorExpression")
eol_expression_MultiplyOperatorExpression = Class(name="eol_expression_MultiplyOperatorExpression")
eol_expression_MinusOperatorExpression = Class(name="eol_expression_MinusOperatorExpression")
eol_expression_NewExpression = Class(name="eol_expression_NewExpression")
eol_expression_MapExpression = Class(name="eol_expression_MapExpression")
eol_expression_CollectionExpression = Class(name="eol_expression_CollectionExpression", is_abstract=True)
eol_expression_CollectionInitialisationExpression = Class(name="eol_expression_CollectionInitialisationExpression", is_abstract=True)
eol_expression_PrimitiveExpression = Class(name="eol_expression_PrimitiveExpression", is_abstract=True)
eol_expression_ComparableExpression = Class(name="eol_expression_ComparableExpression", is_abstract=True)
PrimitiveExpression = Class(name="PrimitiveExpression")
eol_expression_SummableExpression = Class(name="eol_expression_SummableExpression", is_abstract=True)
eol_expression_StringExpression = Class(name="eol_expression_StringExpression")
ComparableExpression = Class(name="ComparableExpression")
SummableExpression = Class(name="SummableExpression")
eol_expression_BooleanExpression = Class(name="eol_expression_BooleanExpression")
eol_expression_RealExpression = Class(name="eol_expression_RealExpression")
eol_expression_IntegerExpression = Class(name="eol_expression_IntegerExpression")
eol_expression_BagExpression = Class(name="eol_expression_BagExpression")
CollectionExpression = Class(name="CollectionExpression")
eol_expression_SetExpression = Class(name="eol_expression_SetExpression")
UniqueCollection = Class(name="UniqueCollection")
eol_expression_KeyValueExpression = Class(name="eol_expression_KeyValueExpression")
eol_expression_ExpressionRange = Class(name="eol_expression_ExpressionRange")
CollectionInitialisationExpression = Class(name="CollectionInitialisationExpression")
eol_expression_ExpressionList = Class(name="eol_expression_ExpressionList")
eol_expression_Statement = Class(name="eol_expression_Statement", is_abstract=True)
eol_expression_OrderedSetExpression = Class(name="eol_expression_OrderedSetExpression")
OrderedCollection = Class(name="OrderedCollection")
eol_expression_SequenceExpression = Class(name="eol_expression_SequenceExpression")
eol_expression_OrderedCollection = Class(name="eol_expression_OrderedCollection", is_abstract=True)
eol_expression_UniqueCollection = Class(name="eol_expression_UniqueCollection", is_abstract=True)
eol_expression_EnumerationLiteralExpression = Class(name="eol_expression_EnumerationLiteralExpression")
...
domain_model = DomainModel(
    name="eol_expression",
    types={eol_expression_Expression, eol_expression_Type, eol_expression_OperatorExpression, Expression, eol_expression_UnaryOperatorExpression, OperatorExpression, eol_expression_NotOperatorExpression, UnaryOperatorExpression, eol_expression_NegativeOperatorExpression, eol_expression_BinaryOperatorExpression, eol_expression_LogicalOperatorExpression, BinaryOperatorExpression, eol_expression_AndOperatorExpression, LogicalOperatorExpression, eol_expression_PlusOperatorExpression, eol_expression_ComparisonOperatorExpression, eol_expression_GreaterThanOrEqualToOperatorExpression, ComparisonOperatorExpression, eol_expression_GreaterThanOperatorExpression, eol_expression_LessThanOrEqualToOperatorExpression, eol_expression_LessThanOperatorExpression, eol_expression_NotEqualsOperatorExpression, eol_expression_EqualsOperatorExpression, eol_expression_VariableDeclarationExpression, eol_expression_NameExpression, eol_expression_FormalParameterExpression, VariableDeclarationExpression, eol_expression_FeatureCallExpression, eol_expression_MethodCallExpression, FeatureCallExpression, eol_expression_PropertyCallExpression, eol_expression_FOLMethodCallExpression, eol_expression_XorOperatorExpression, eol_expression_OrOperatorExpression, eol_expression_ImpliesOperatorExpression, eol_expression_ArithmeticOperatorExpression, eol_expression_DivideOperatorExpression, ArithmeticOperatorExpression, eol_expression_MultiplyOperatorExpression, eol_expression_MinusOperatorExpression, eol_expression_NewExpression, eol_expression_MapExpression, eol_expression_CollectionExpression, eol_expression_CollectionInitialisationExpression, eol_expression_PrimitiveExpression, eol_expression_ComparableExpression, PrimitiveExpression, eol_expression_SummableExpression, eol_expression_StringExpression, ComparableExpression, SummableExpression, eol_expression_BooleanExpression, eol_expression_RealExpression, eol_expression_IntegerExpression, eol_expression_BagExpression, CollectionExpression, eol_expression_SetExpression, UniqueCollection, eol_expression_KeyValueExpression, eol_expression_ExpressionRange, CollectionInitialisationExpression, eol_expression_ExpressionList, eol_expression_Statement, eol_expression_OrderedSetExpression, OrderedCollection, eol_expression_SequenceExpression, eol_expression_OrderedCollection, eol_expression_UniqueCollection, eol_expression_EnumerationLiteralExpression},
    associations={resolvedType0, expression1, lhs3, rhs5, name8, target9, arguments11, method13, property16, iterator18, conditions19, value27, typeName30, parameters32, keyValues35, contents37, parameterList39, method22, key25, literal41, enumeration43, model46, start49, end51, expressions54},
    generalizations={gen_eol_expression_OperatorExpression_Expression, gen_eol_expression_UnaryOperatorExpression_OperatorExpression, gen_eol_expression_NotOperatorExpression_UnaryOperatorExpression, gen_eol_expression_NegativeOperatorExpression_UnaryOperatorExpression, gen_eol_expression_BinaryOperatorExpression_OperatorExpression, gen_eol_expression_LogicalOperatorExpression_BinaryOperatorExpression, gen_eol_expression_AndOperatorExpression_LogicalOperatorExpression, gen_eol_expression_PlusOperatorExpression_ArithmeticOperatorExpression, gen_eol_expression_ComparisonOperatorExpression_BinaryOperatorExpression, gen_eol_expression_GreaterThanOrEqualToOperatorExpression_ComparisonOperatorExpression, gen_eol_expression_GreaterThanOperatorExpression_ComparisonOperatorExpression, gen_eol_expression_LessThanOrEqualToOperatorExpression_ComparisonOperatorExpression, gen_eol_expression_LessThanOperatorExpression_ComparisonOperatorExpression, gen_eol_expression_NotEqualsOperatorExpression_ComparisonOperatorExpression, gen_eol_expression_EqualsOperatorExpression_ComparisonOperatorExpression, gen_eol_expression_VariableDeclarationExpression_Expression, gen_eol_expression_FormalParameterExpression_VariableDeclarationExpression, gen_eol_expression_NameExpression_Expression, gen_eol_expression_FeatureCallExpression_Expression, gen_eol_expression_MethodCallExpression_FeatureCallExpression, gen_eol_expression_PropertyCallExpression_FeatureCallExpression, gen_eol_expression_FOLMethodCallExpression_FeatureCallExpression, gen_eol_expression_XorOperatorExpression_LogicalOperatorExpression, gen_eol_expression_OrOperatorExpression_LogicalOperatorExpression, gen_eol_expression_ImpliesOperatorExpression_LogicalOperatorExpression, gen_eol_expression_ArithmeticOperatorExpression_BinaryOperatorExpression, gen_eol_expression_DivideOperatorExpression_ArithmeticOperatorExpression, gen_eol_expression_MultiplyOperatorExpression_ArithmeticOperatorExpression, gen_eol_expression_MinusOperatorExpression_ArithmeticOperatorExpression, gen_eol_expression_NewExpression_Expression, gen_eol_expression_MapExpression_Expression, gen_eol_expression_CollectionExpression_Expression, gen_eol_expression_PrimitiveExpression_Expression, gen_eol_expression_ComparableExpression_PrimitiveExpression, gen_eol_expression_SummableExpression_PrimitiveExpression, gen_eol_expression_StringExpression_ComparableExpression, gen_eol_expression_StringExpression_SummableExpression, gen_eol_expression_BooleanExpression_PrimitiveExpression, gen_eol_expression_RealExpression_ComparableExpression, gen_eol_expression_RealExpression_SummableExpression, gen_eol_expression_IntegerExpression_ComparableExpression, gen_eol_expression_IntegerExpression_SummableExpression, gen_eol_expression_BagExpression_CollectionExpression, gen_eol_expression_SetExpression_UniqueCollection, gen_eol_expression_KeyValueExpression_Expression, gen_eol_expression_CollectionInitialisationExpression_Expression, gen_eol_expression_ExpressionRange_CollectionInitialisationExpression, gen_eol_expression_ExpressionList_CollectionInitialisationExpression, gen_eol_expression_OrderedSetExpression_OrderedCollection, gen_eol_expression_OrderedSetExpression_UniqueCollection, gen_eol_expression_SequenceExpression_OrderedCollection, gen_eol_expression_OrderedCollection_CollectionExpression, gen_eol_expression_UniqueCollection_CollectionExpression, gen_eol_expression_EnumerationLiteralExpression_Expression},
    metadata=None
)
