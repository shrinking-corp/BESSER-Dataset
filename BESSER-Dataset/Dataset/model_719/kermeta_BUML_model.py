...
# Classes
kermeta_DummyClass = Class(name="kermeta_DummyClass", is_abstract=True)
kermeta_language_DummyClass = Class(name="kermeta_language_DummyClass", is_abstract=True)
kermeta_behavior_Assignment = Class(name="kermeta_behavior_Assignment")
Expression = Class(name="Expression")
behavior_CallExpression = Class(name="behavior_CallExpression")
behavior_Expression = Class(name="behavior_Expression")
kermeta_behavior_Expression = Class(name="kermeta_behavior_Expression", is_abstract=True)
structure_Object = Class(name="structure_Object")
...
kermeta_behavior_CallVariable = Class(name="kermeta_behavior_CallVariable")
CallExpression = Class(name="CallExpression")
kermeta_behavior_CallFeature = Class(name="kermeta_behavior_CallFeature")
...
kermeta_behavior_CallSuperOperation = Class(name="kermeta_behavior_CallSuperOperation")
kermeta_behavior_CallExpression = Class(name="kermeta_behavior_CallExpression", is_abstract=True)
kermeta_behavior_Block = Class(name="kermeta_behavior_Block")
kermeta_behavior_Raise = Class(name="kermeta_behavior_Raise")
kermeta_behavior_Rescue = Class(name="kermeta_behavior_Rescue")
Object = Class(name="Object")
behavior_TypeReference = Class(name="behavior_TypeReference")
kermeta_behavior_TypeReference = Class(name="kermeta_behavior_TypeReference")
MultiplicityElement = Class(name="MultiplicityElement")
kermeta_behavior_Literal = Class(name="kermeta_behavior_Literal", is_abstract=True)
kermeta_behavior_EmptyExpression = Class(name="kermeta_behavior_EmptyExpression")
kermeta_behavior_CallResult = Class(name="kermeta_behavior_CallResult")
CallVariable = Class(name="CallVariable")
kermeta_behavior_CallValue = Class(name="kermeta_behavior_CallValue")
kermeta_behavior_Conditional = Class(name="kermeta_behavior_Conditional")
behavior_LambdaParameter = Class(name="behavior_LambdaParameter")
kermeta_behavior_LambdaParameter = Class(name="kermeta_behavior_LambdaParameter")
kermeta_behavior_IntegerLiteral = Class(name="kermeta_behavior_IntegerLiteral")
Literal = Class(name="Literal")
kermeta_behavior_StringLiteral = Class(name="kermeta_behavior_StringLiteral")
kermeta_behavior_BooleanLiteral = Class(name="kermeta_behavior_BooleanLiteral")
kermeta_behavior_TypeLiteral = Class(name="kermeta_behavior_TypeLiteral")
kermeta_behavior_JavaStaticCall = Class(name="kermeta_behavior_JavaStaticCall")
kermeta_behavior_LambdaExpression = Class(name="kermeta_behavior_LambdaExpression")
kermeta_behavior_SelfExpression = Class(name="kermeta_behavior_SelfExpression")
kermeta_behavior_VariableDecl = Class(name="kermeta_behavior_VariableDecl")
kermeta_structure_Class = Class(name="kermeta_structure_Class")
ParameterizedType = Class(name="ParameterizedType")
kermeta_behavior_VoidLiteral = Class(name="kermeta_behavior_VoidLiteral")
kermeta_behavior_Loop = Class(name="kermeta_behavior_Loop")
structure_Tag = Class(name="structure_Tag")
kermeta_structure_Model = Class(name="kermeta_structure_Model")
kermeta_structure_ModelType = Class(name="kermeta_structure_ModelType")
structure_TypeDefinition = Class(name="structure_TypeDefinition")
kermeta_structure_Operation = Class(name="kermeta_structure_Operation")
structure_Class = Class(name="structure_Class")
kermeta_structure_Object = Class(name="kermeta_structure_Object")
structure_ClassDefinition = Class(name="structure_ClassDefinition")
structure_TypeVariable = Class(name="structure_TypeVariable")
kermeta_structure_Property = Class(name="kermeta_structure_Property")
structure_Parameter = Class(name="structure_Parameter")
structure_Constraint = Class(name="structure_Constraint")
kermeta_structure_TypeContainer = Class(name="kermeta_structure_TypeContainer", is_abstract=True)
kermeta_structure_EnumerationLiteral = Class(name="kermeta_structure_EnumerationLiteral")
NamedElement = Class(name="NamedElement")
structure_Enumeration = Class(name="structure_Enumeration")
kermeta_structure_TypeVariableBinding = Class(name="kermeta_structure_TypeVariableBinding")
kermeta_structure_MultiplicityElement = Class(name="kermeta_structure_MultiplicityElement")
TypedElement = Class(name="TypedElement")
kermeta_structure_Type = Class(name="kermeta_structure_Type")
kermeta_structure_Enumeration = Class(name="kermeta_structure_Enumeration")
DataType = Class(name="DataType")
kermeta_structure_NamedElement = Class(name="kermeta_structure_NamedElement", is_abstract=True)
kermeta_structure_Package = Class(name="kermeta_structure_Package")
structure_NamedElement = Class(name="structure_NamedElement")
structure_TypeDefinitionContainer = Class(name="structure_TypeDefinitionContainer")
structure_Package = Class(name="structure_Package")
kermeta_structure_Parameter = Class(name="kermeta_structure_Parameter")
kermeta_structure_PrimitiveType = Class(name="kermeta_structure_PrimitiveType")
structure_DataType = Class(name="structure_DataType")
kermeta_structure_TypeDefinition = Class(name="kermeta_structure_TypeDefinition")
kermeta_structure_DataType = Class(name="kermeta_structure_DataType", is_abstract=True)
kermeta_structure_Tag = Class(name="kermeta_structure_Tag")
kermeta_structure_Constraint = Class(name="kermeta_structure_Constraint")
kermeta_structure_TypedElement = Class(name="kermeta_structure_TypedElement", is_abstract=True)
kermeta_structure_ModelingUnit = Class(name="kermeta_structure_ModelingUnit")
structure_Require = Class(name="structure_Require")
structure_Using = Class(name="structure_Using")
kermeta_structure_ClassDefinition = Class(name="kermeta_structure_ClassDefinition")
structure_GenericTypeDefinition = Class(name="structure_GenericTypeDefinition")
kermeta_structure_Require = Class(name="kermeta_structure_Require")
kermeta_structure_Using = Class(name="kermeta_structure_Using")
kermeta_structure_Filter = Class(name="kermeta_structure_Filter")
kermeta_structure_GenericTypeDefinition = Class(name="kermeta_structure_GenericTypeDefinition", is_abstract=True)
TypeDefinition = Class(name="TypeDefinition")
kermeta_structure_ParameterizedType = Class(name="kermeta_structure_ParameterizedType", is_abstract=True)
Type = Class(name="Type")
structure_TypeVariableBinding = Class(name="structure_TypeVariableBinding")
structure_ModelingUnit = Class(name="structure_ModelingUnit")
structure_Filter = Class(name="structure_Filter")
kermeta_structure_TypeVariable = Class(name="kermeta_structure_TypeVariable", is_abstract=True)
kermeta_structure_ObjectTypeVariable = Class(name="kermeta_structure_ObjectTypeVariable")
TypeVariable = Class(name="TypeVariable")
kermeta_structure_ModelTypeVariable = Class(name="kermeta_structure_ModelTypeVariable")
structure_VirtualType = Class(name="structure_VirtualType")
kermeta_structure_VirtualType = Class(name="kermeta_structure_VirtualType")
ObjectTypeVariable = Class(name="ObjectTypeVariable")
structure_ModelTypeVariable = Class(name="structure_ModelTypeVariable")
kermeta_structure_ProductType = Class(name="kermeta_structure_ProductType")
kermeta_structure_FunctionType = Class(name="kermeta_structure_FunctionType")
kermeta_structure_VoidType = Class(name="kermeta_structure_VoidType")
kermeta_structure_TypeDefinitionContainer = Class(name="kermeta_structure_TypeDefinitionContainer", is_abstract=True)
...
kermeta_behavior_JavaStaticCall.attributes={kermeta_behavior_JavaStaticCall_jclass, kermeta_behavior_JavaStaticCall_jmethod}
...
kermeta_structure_Property.attributes={kermeta_structure_Property_isDerived, kermeta_structure_Property_isGetterAbstract, kermeta_structure_Property_isReadOnly, kermeta_structure_Property_isComposite, kermeta_structure_Property_isID, kermeta_structure_Property_default, kermeta_structure_Property_isSetterAbstract}
...
kermeta_structure_MultiplicityElement.attributes={kermeta_structure_MultiplicityElement_lower, kermeta_structure_MultiplicityElement_isOrdered, kermeta_structure_MultiplicityElement_isUnique, kermeta_structure_MultiplicityElement_upper}
...
tag65: BinaryAssociation = BinaryAssociation(
    name="tag65",
    ends={
        Property(name="Tag", type=kermeta_structure_Object, multiplicity=Multiplicity(1, 1)),
...
superOperation78: BinaryAssociation = BinaryAssociation(
    name="superOperation78",
    ends={
        Property(name="structure_Operation80", type=kermeta_structure_Operation, multiplicity=Multiplicity(1, 1)),
        Property(name="kermeta_structure_Operation79", type=structure_Operation, multiplicity=Multiplicity(0, 1))
    }
)
owningClass81: BinaryAssociation = BinaryAssociation(
    name="owningClass81",
    ends={
        Property(name="ClassDefinition", type=kermeta_structure_Operation, multiplicity=Multiplicity(1, 1)),
...
typeParameter82: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="kermeta_structure_Operation83", type=structure_TypeVariable, multiplicity=Multiplicity(0, 9999))
    }
)
opposite84: BinaryAssociation = BinaryAssociation(
    name="opposite84",
    ends={
        Property(name="structure_Property85", type=kermeta_structure_Property, multiplicity=Multiplicity(1, 1)),
        Property(name="kermeta_structure_Property", type=structure_Property, multiplicity=Multiplicity(0, 1))
    }
)
getterBody86: BinaryAssociation = BinaryAssociation(
    name="getterBody86",
    ends={
        Property(name="behavior_Expression88", type=kermeta_structure_Property, multiplicity=Multiplicity(1, 1)),
        Property(name="kermeta_structure_Property87", type=behavior_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
ownedParameter71: BinaryAssociation = BinaryAssociation(
    name="ownedParameter71",
    ends={
        Property(name="Parameter", type=kermeta_structure_Operation, multiplicity=Multiplicity(1, 1)),
...
pre72: BinaryAssociation = BinaryAssociation(
    name="pre72",
    ends={
        Property(name="Constraint", type=kermeta_structure_Operation, multiplicity=Multiplicity(1, 1)),
        Property(name="preOwner", type=structure_Constraint, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
post73: BinaryAssociation = BinaryAssociation(
    name="post73",
    ends={
        Property(name="Constraint74", type=kermeta_structure_Operation, multiplicity=Multiplicity(1, 1)),
...
body75: BinaryAssociation = BinaryAssociation(
    name="body75",
    ends={
        Property(name="behavior_Expression77", type=kermeta_structure_Operation, multiplicity=Multiplicity(1, 1)),
        Property(name="kermeta_structure_Operation76", type=behavior_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
typeContainer94: BinaryAssociation = BinaryAssociation(
    name="typeContainer94",
    ends={
        Property(name="TypeContainer", type=kermeta_structure_Type, multiplicity=Multiplicity(1, 1)),
        Property(name="containedType", type=structure_TypeContainer, multiplicity=Multiplicity(0, 1))
    }
)
containedType95: BinaryAssociation = BinaryAssociation(
    name="containedType95",
    ends={
        Property(name="Type", type=kermeta_structure_TypeContainer, multiplicity=Multiplicity(1, 1)),
        Property(name="typeContainer", type=structure_Type, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
enumeration96: BinaryAssociation = BinaryAssociation(
    name="enumeration96",
    ends={
        Property(name="Enumeration", type=kermeta_structure_EnumerationLiteral, multiplicity=Multiplicity(1, 1)),
...
variable97: BinaryAssociation = BinaryAssociation(
    name="variable97",
    ends={
        Property(name="structure_TypeVariable98", type=kermeta_structure_TypeVariableBinding, multiplicity=Multiplicity(1, 1)),
...
type99: BinaryAssociation = BinaryAssociation(
    name="type99",
    ends={
        Property(name="structure_Type101", type=kermeta_structure_TypeVariableBinding, multiplicity=Multiplicity(1, 1)),
        Property(name="kermeta_structure_TypeVariableBinding100", type=structure_Type, multiplicity=Multiplicity(1, 1))
    }
)
setterBody89: BinaryAssociation = BinaryAssociation(
    name="setterBody89",
    ends={
        Property(name="behavior_Expression91", type=kermeta_structure_Property, multiplicity=Multiplicity(1, 1)),
        Property(name="kermeta_structure_Property90", type=behavior_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
owningClass92: BinaryAssociation = BinaryAssociation(
    name="owningClass92",
    ends={
        Property(name="ClassDefinition93", type=kermeta_structure_Property, multiplicity=Multiplicity(1, 1)),
        Property(name="ownedAttribute", type=structure_ClassDefinition, multiplicity=Multiplicity(0, 1))
    }
)
ownedLiteral102: BinaryAssociation = BinaryAssociation(
    name="ownedLiteral102",
    ends={
        Property(name="EnumerationLiteral", type=kermeta_structure_Enumeration, multiplicity=Multiplicity(1, 1)),
        Property(name="enumeration", type=structure_EnumerationLiteral, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
nestedPackage103: BinaryAssociation = BinaryAssociation(
    name="nestedPackage103",
    ends={
        Property(name="Package", type=kermeta_structure_Package, multiplicity=Multiplicity(1, 1)),
        Property(name="nestingPackage", type=structure_Package, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
nestingPackage104: BinaryAssociation = BinaryAssociation(
    name="nestingPackage104",
    ends={
        Property(name="Package105", type=kermeta_structure_Package, multiplicity=Multiplicity(1, 1)),
...
operation106: BinaryAssociation = BinaryAssociation(
    name="operation106",
    ends={
        Property(name="Operation", type=kermeta_structure_Parameter, multiplicity=Multiplicity(1, 1)),
...
object111: BinaryAssociation = BinaryAssociation(
    name="object111",
    ends={
        Property(name="Object", type=kermeta_structure_Tag, multiplicity=Multiplicity(1, 1)),
        Property(name="tag", type=structure_Object, multiplicity=Multiplicity(1, 9999))
    }
)
body112: BinaryAssociation = BinaryAssociation(
    name="body112",
    ends={
        Property(name="behavior_Expression113", type=kermeta_structure_Constraint, multiplicity=Multiplicity(1, 1)),
        Property(name="kermeta_structure_Constraint", type=behavior_Expression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
invOwner114: BinaryAssociation = BinaryAssociation(
    name="invOwner114",
    ends={
        Property(name="ClassDefinition115", type=kermeta_structure_Constraint, multiplicity=Multiplicity(1, 1)),
        Property(name="inv", type=structure_ClassDefinition, multiplicity=Multiplicity(0, 1))
    }
)
preOwner116: BinaryAssociation = BinaryAssociation(
    name="preOwner116",
    ends={
        Property(name="Operation117", type=kermeta_structure_Constraint, multiplicity=Multiplicity(1, 1)),
        Property(name="pre", type=structure_Operation, multiplicity=Multiplicity(0, 1))
    }
)
instanceType107: BinaryAssociation = BinaryAssociation(
    name="instanceType107",
    ends={
        Property(name="structure_Type108", type=kermeta_structure_PrimitiveType, multiplicity=Multiplicity(1, 1)),
...
type109: BinaryAssociation = BinaryAssociation(
    name="type109",
    ends={
        Property(name="structure_Type110", type=kermeta_structure_TypedElement, multiplicity=Multiplicity(1, 1)),
        Property(name="kermeta_structure_TypedElement", type=structure_Type, multiplicity=Multiplicity(0, 1))
    }
)
inv120: BinaryAssociation = BinaryAssociation(
    name="inv120",
    ends={
        Property(name="Constraint121", type=kermeta_structure_ClassDefinition, multiplicity=Multiplicity(1, 1)),
        Property(name="invOwner", type=structure_Constraint, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
ownedAttribute122: BinaryAssociation = BinaryAssociation(
    name="ownedAttribute122",
    ends={
        Property(name="Property", type=kermeta_structure_ClassDefinition, multiplicity=Multiplicity(1, 1)),
        Property(name="owningClass", type=structure_Property, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
ownedOperation123: BinaryAssociation = BinaryAssociation(
    name="ownedOperation123",
    ends={
        Property(name="Operation125", type=kermeta_structure_ClassDefinition, multiplicity=Multiplicity(1, 1)),
        Property(name="owningClass124", type=structure_Operation, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
superType126: BinaryAssociation = BinaryAssociation(
    name="superType126",
    ends={
        Property(name="structure_Type127", type=kermeta_structure_ClassDefinition, multiplicity=Multiplicity(1, 1)),
        Property(name="kermeta_structure_ClassDefinition", type=structure_Type, multiplicity=Multiplicity(0, 9999))
    }
)
packages128: BinaryAssociation = BinaryAssociation(
    name="packages128",
    ends={
...
requires129: BinaryAssociation = BinaryAssociation(
    name="requires129",
    ends={
        Property(name="structure_Require", type=kermeta_structure_ModelingUnit, multiplicity=Multiplicity(1, 1)),
        Property(name="kermeta_structure_ModelingUnit130", type=structure_Require, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
usings131: BinaryAssociation = BinaryAssociation(
    name="usings131",
    ends={
        Property(name="structure_Using", type=kermeta_structure_ModelingUnit, multiplicity=Multiplicity(1, 1)),
        Property(name="kermeta_structure_ModelingUnit132", type=structure_Using, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
postOwner118: BinaryAssociation = BinaryAssociation(
    name="postOwner118",
    ends={
        Property(name="Operation119", type=kermeta_structure_Constraint, multiplicity=Multiplicity(1, 1)),
        Property(name="post", type=structure_Operation, multiplicity=Multiplicity(0, 1))
    }
)
typeParameter140: BinaryAssociation = BinaryAssociation(
    name="typeParameter140",
    ends={
        Property(name="structure_TypeVariable141", type=kermeta_structure_GenericTypeDefinition, multiplicity=Multiplicity(1, 1)),
...
virtualTypeBinding142: BinaryAssociation = BinaryAssociation(
    name="virtualTypeBinding142",
    ends={
...
typeParamBinding143: BinaryAssociation = BinaryAssociation(
    name="typeParamBinding143",
    ends={
        Property(name="structure_TypeVariableBinding145", type=kermeta_structure_ParameterizedType, multiplicity=Multiplicity(1, 1)),
        Property(name="kermeta_structure_ParameterizedType144", type=structure_TypeVariableBinding, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
referencedModelingUnits133: BinaryAssociation = BinaryAssociation(
    name="referencedModelingUnits133",
    ends={
        Property(name="structure_ModelingUnit", type=kermeta_structure_ModelingUnit, multiplicity=Multiplicity(1, 1)),
        Property(name="kermeta_structure_ModelingUnit134", type=structure_ModelingUnit, multiplicity=Multiplicity(0, 9999))
    }
)
typeDefinition146: BinaryAssociation = BinaryAssociation(
    name="typeDefinition146",
    ends={
        Property(name="structure_GenericTypeDefinition", type=kermeta_structure_ParameterizedType, multiplicity=Multiplicity(1, 1)),
        Property(name="kermeta_structure_ParameterizedType147", type=structure_GenericTypeDefinition, multiplicity=Multiplicity(1, 1))
    }
)
includeFilters135: BinaryAssociation = BinaryAssociation(
    name="includeFilters135",
    ends={
        Property(name="structure_Filter", type=kermeta_structure_ModelingUnit, multiplicity=Multiplicity(1, 1)),
        Property(name="kermeta_structure_ModelingUnit136", type=structure_Filter, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
excludeFilters137: BinaryAssociation = BinaryAssociation(
    name="excludeFilters137",
    ends={
        Property(name="structure_Filter139", type=kermeta_structure_ModelingUnit, multiplicity=Multiplicity(1, 1)),
        Property(name="kermeta_structure_ModelingUnit138", type=structure_Filter, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
virtualType150: BinaryAssociation = BinaryAssociation(
    name="virtualType150",
    ends={
        Property(name="VirtualType", type=kermeta_structure_ModelTypeVariable, multiplicity=Multiplicity(1, 1)),
        Property(name="modelType", type=structure_VirtualType, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
classDefinition151: BinaryAssociation = BinaryAssociation(
    name="classDefinition151",
    ends={
...
modelType152: BinaryAssociation = BinaryAssociation(
    name="modelType152",
    ends={
        Property(name="ModelTypeVariable", type=kermeta_structure_VirtualType, multiplicity=Multiplicity(1, 1)),
        Property(name="virtualType", type=structure_ModelTypeVariable, multiplicity=Multiplicity(1, 1))
    }
)
typeParamBinding153: BinaryAssociation = BinaryAssociation(
    name="typeParamBinding153",
    ends={
        Property(name="structure_TypeVariableBinding155", type=kermeta_structure_VirtualType, multiplicity=Multiplicity(1, 1)),
        Property(name="kermeta_structure_VirtualType154", type=structure_TypeVariableBinding, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
type156: BinaryAssociation = BinaryAssociation(
    name="type156",
    ends={
        Property(name="structure_Type157", type=kermeta_structure_ProductType, multiplicity=Multiplicity(1, 1)),
...
left158: BinaryAssociation = BinaryAssociation(
    name="left158",
    ends={
        Property(name="structure_Type159", type=kermeta_structure_FunctionType, multiplicity=Multiplicity(1, 1)),
        Property(name="kermeta_structure_FunctionType", type=structure_Type, multiplicity=Multiplicity(0, 1))
    }
)
supertype148: BinaryAssociation = BinaryAssociation(
    name="supertype148",
    ends={
        Property(name="structure_Type149", type=kermeta_structure_TypeVariable, multiplicity=Multiplicity(1, 1)),
        Property(name="kermeta_structure_TypeVariable", type=structure_Type, multiplicity=Multiplicity(0, 1))
    }
)
ownedTypeDefinition163: BinaryAssociation = BinaryAssociation(
    name="ownedTypeDefinition163",
    ends={
        Property(name="structure_TypeDefinition164", type=kermeta_structure_TypeDefinitionContainer, multiplicity=Multiplicity(1, 1)),
...
right160: BinaryAssociation = BinaryAssociation(
    name="right160",
    ends={
        Property(name="structure_Type162", type=kermeta_structure_FunctionType, multiplicity=Multiplicity(1, 1)),
        Property(name="kermeta_structure_FunctionType161", type=structure_Type, multiplicity=Multiplicity(0, 1))
    }
)
...
domain_model = DomainModel(
    name="kermeta",
    types={kermeta_DummyClass, kermeta_language_DummyClass, kermeta_behavior_Assignment, Expression, behavior_CallExpression, behavior_Expression, kermeta_behavior_Expression, structure_Object, structure_TypeContainer, structure_Type, behavior_Rescue, kermeta_behavior_CallVariable, CallExpression, kermeta_behavior_CallFeature, structure_Property, structure_Operation, structure_EnumerationLiteral, kermeta_behavior_CallSuperOperation, kermeta_behavior_CallExpression, kermeta_behavior_Block, kermeta_behavior_Raise, kermeta_behavior_Rescue, Object, behavior_TypeReference, kermeta_behavior_TypeReference, MultiplicityElement, kermeta_behavior_Literal, kermeta_behavior_EmptyExpression, kermeta_behavior_CallResult, CallVariable, kermeta_behavior_CallValue, kermeta_behavior_Conditional, behavior_LambdaParameter, kermeta_behavior_LambdaParameter, kermeta_behavior_IntegerLiteral, Literal, kermeta_behavior_StringLiteral, kermeta_behavior_BooleanLiteral, kermeta_behavior_TypeLiteral, kermeta_behavior_JavaStaticCall, kermeta_behavior_LambdaExpression, kermeta_behavior_SelfExpression, kermeta_behavior_VariableDecl, kermeta_structure_Class, ParameterizedType, kermeta_behavior_VoidLiteral, kermeta_behavior_Loop, structure_Tag, kermeta_structure_Model, kermeta_structure_ModelType, structure_TypeDefinition, kermeta_structure_Operation, structure_Class, kermeta_structure_Object, structure_ClassDefinition, structure_TypeVariable, kermeta_structure_Property, structure_Parameter, structure_Constraint, kermeta_structure_TypeContainer, kermeta_structure_EnumerationLiteral, NamedElement, structure_Enumeration, kermeta_structure_TypeVariableBinding, kermeta_structure_MultiplicityElement, TypedElement, kermeta_structure_Type, kermeta_structure_Enumeration, DataType, kermeta_structure_NamedElement, kermeta_structure_Package, structure_NamedElement, structure_TypeDefinitionContainer, structure_Package, kermeta_structure_Parameter, kermeta_structure_PrimitiveType, structure_DataType, kermeta_structure_TypeDefinition, kermeta_structure_DataType, kermeta_structure_Tag, kermeta_structure_Constraint, kermeta_structure_TypedElement, kermeta_structure_ModelingUnit, structure_Require, structure_Using, kermeta_structure_ClassDefinition, structure_GenericTypeDefinition, kermeta_structure_Require, kermeta_structure_Using, kermeta_structure_Filter, kermeta_structure_GenericTypeDefinition, TypeDefinition, kermeta_structure_ParameterizedType, Type, structure_TypeVariableBinding, structure_ModelingUnit, structure_Filter, kermeta_structure_TypeVariable, kermeta_structure_ObjectTypeVariable, TypeVariable, kermeta_structure_ModelTypeVariable, structure_VirtualType, kermeta_structure_VirtualType, ObjectTypeVariable, structure_ModelTypeVariable, kermeta_structure_ProductType, kermeta_structure_FunctionType, kermeta_structure_VoidType, kermeta_structure_TypeDefinitionContainer, ConstraintType, ConstraintLanguage},
    associations={target0, value1, staticType3, statement9, rescueBlock11, target13, staticProperty15, staticOperation17, staticEnumLiteral19, parameters4, staticTypeVariableBindings6, elseBody23, condition26, expression29, body31, exceptionType33, thenBody21, parameters37, body38, type41, parameters35, stopCondition50, initialization53, type55, ownedAttribute58, typeref43, initialization45, body47, tag65, ownedTags66, contents67, includedTypeDefinition68, raisedException69, ownedOperation60, superClass63, superOperation78, owningClass81, typeParameter82, opposite84, getterBody86, ownedParameter71, pre72, post73, body75, typeContainer94, containedType95, enumeration96, variable97, type99, setterBody89, owningClass92, ownedLiteral102, nestedPackage103, nestingPackage104, operation106, object111, body112, invOwner114, preOwner116, instanceType107, type109, inv120, ownedAttribute122, ownedOperation123, superType126, packages128, requires129, usings131, postOwner118, typeParameter140, virtualTypeBinding142, typeParamBinding143, referencedModelingUnits133, typeDefinition146, includeFilters135, excludeFilters137, virtualType150, classDefinition151, modelType152, typeParamBinding153, type156, left158, supertype148, ownedTypeDefinition163, right160},
    generalizations={gen_kermeta_behavior_Assignment_Expression, gen_kermeta_behavior_Expression_structure_Object, gen_kermeta_behavior_Expression_structure_TypeContainer, gen_kermeta_behavior_CallVariable_CallExpression, gen_kermeta_behavior_CallFeature_CallExpression, gen_kermeta_behavior_CallSuperOperation_CallExpression, gen_kermeta_behavior_CallExpression_Expression, gen_kermeta_behavior_Block_Expression, gen_kermeta_behavior_Raise_Expression, gen_kermeta_behavior_Rescue_Object, gen_kermeta_behavior_TypeReference_MultiplicityElement, gen_kermeta_behavior_Literal_Expression, gen_kermeta_behavior_EmptyExpression_Expression, gen_kermeta_behavior_CallResult_CallVariable, gen_kermeta_behavior_CallValue_CallExpression, gen_kermeta_behavior_Conditional_Expression, gen_kermeta_behavior_LambdaParameter_Object, gen_kermeta_behavior_IntegerLiteral_Literal, gen_kermeta_behavior_StringLiteral_Literal, gen_kermeta_behavior_BooleanLiteral_Literal, gen_kermeta_behavior_TypeLiteral_Literal, gen_kermeta_behavior_JavaStaticCall_Expression, gen_kermeta_behavior_LambdaExpression_Expression, gen_kermeta_behavior_SelfExpression_Expression, gen_kermeta_behavior_VariableDecl_Expression, gen_kermeta_structure_Class_ParameterizedType, gen_kermeta_behavior_VoidLiteral_Literal, gen_kermeta_behavior_Loop_Expression, gen_kermeta_structure_Model_Object, gen_kermeta_structure_ModelType_structure_Type, gen_kermeta_structure_ModelType_structure_TypeDefinition, gen_kermeta_structure_Operation_MultiplicityElement, gen_kermeta_structure_Property_MultiplicityElement, gen_kermeta_structure_TypeContainer_Object, gen_kermeta_structure_EnumerationLiteral_NamedElement, gen_kermeta_structure_TypeVariableBinding_structure_TypeContainer, gen_kermeta_structure_TypeVariableBinding_structure_Object, gen_kermeta_structure_MultiplicityElement_TypedElement, gen_kermeta_structure_Type_Object, gen_kermeta_structure_Enumeration_DataType, gen_kermeta_structure_NamedElement_Object, gen_kermeta_structure_Package_structure_NamedElement, gen_kermeta_structure_Package_structure_TypeDefinitionContainer, gen_kermeta_structure_Parameter_MultiplicityElement, gen_kermeta_structure_TypeDefinition_NamedElement, gen_kermeta_structure_DataType_structure_Type, gen_kermeta_structure_DataType_structure_TypeDefinition, gen_kermeta_structure_Tag_Object, gen_kermeta_structure_Constraint_NamedElement, gen_kermeta_structure_PrimitiveType_structure_DataType, gen_kermeta_structure_PrimitiveType_structure_TypeContainer, gen_kermeta_structure_TypedElement_structure_TypeContainer, gen_kermeta_structure_TypedElement_structure_NamedElement, gen_kermeta_structure_ModelingUnit_Object, gen_kermeta_structure_ClassDefinition_structure_GenericTypeDefinition, gen_kermeta_structure_ClassDefinition_structure_TypeContainer, gen_kermeta_structure_Require_Object, gen_kermeta_structure_Using_Object, gen_kermeta_structure_Filter_Object, gen_kermeta_structure_GenericTypeDefinition_TypeDefinition, gen_kermeta_structure_ParameterizedType_Type, gen_kermeta_structure_TypeVariable_structure_TypeContainer, gen_kermeta_structure_ObjectTypeVariable_TypeVariable, gen_kermeta_structure_ModelTypeVariable_TypeVariable, gen_kermeta_structure_VirtualType_ObjectTypeVariable, gen_kermeta_structure_ProductType_structure_TypeContainer, gen_kermeta_structure_ProductType_structure_Type, gen_kermeta_structure_FunctionType_structure_TypeContainer, gen_kermeta_structure_FunctionType_structure_Type, gen_kermeta_structure_TypeVariable_structure_Type, gen_kermeta_structure_TypeVariable_structure_NamedElement, gen_kermeta_structure_VoidType_Type, gen_kermeta_structure_TypeDefinitionContainer_NamedElement},
    metadata=None
)
