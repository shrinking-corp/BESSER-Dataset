...
class kermeta_structure_Operation(MultiplicityElement):
    ...
    def __init__(self, isAbstract: str, kermeta_structure_Operation: set["structure_Type"] = None, kermeta_structure_Operation79: "structure_Operation" = None, ownedOperation: "structure_ClassDefinition" = None, kermeta_structure_Operation83: set["structure_TypeVariable"] = None, operation: set["structure_Parameter"] = None, preOwner: set["structure_Constraint"] = None, postOwner: set["structure_Constraint"] = None, kermeta_structure_Operation76: "behavior_Expression" = None):
        self.isAbstract = isAbstract
...
class structure_Type:
    ...
    pass
class kermeta_structure_ModelType(structure_Type, structure_TypeDefinition):

    def __init__(self, kermeta_structure_ModelType: set["structure_TypeDefinition"] = None, structure_Type162: "kermeta_structure_FunctionType" = None, structure_Type8: "kermeta_behavior_CallExpression" = None, structure_Type101: "kermeta_structure_TypeVariableBinding" = None, structure_Type: "kermeta_behavior_Expression" = None, structure_Type157: "kermeta_structure_ProductType" = None, Type: "kermeta_structure_TypeContainer" = None, structure_Type108: "kermeta_structure_PrimitiveType" = None, structure_Type127: "kermeta_structure_ClassDefinition" = None, structure_Type70: "kermeta_structure_Operation" = None, structure_Type159: "kermeta_structure_FunctionType" = None, structure_Type149: "kermeta_structure_TypeVariable" = None, structure_Type110: "kermeta_structure_TypedElement" = None, structure_TypeDefinition: "kermeta_structure_ModelType" = None, structure_TypeDefinition164: "kermeta_structure_TypeDefinitionContainer" = None):
...
class kermeta_structure_DataType(structure_Type, structure_TypeDefinition):
...
class kermeta_structure_ClassDefinition(structure_TypeContainer, structure_GenericTypeDefinition):
    ...
    def __init__(self, isAbstract: str, invOwner: set["structure_Constraint"] = None, owningClass: set["structure_Property"] = None, owningClass124: set["structure_Operation"] = None, kermeta_structure_ClassDefinition: set["structure_Type"] = None, TypeContainer: "kermeta_structure_Type" = None, structure_GenericTypeDefinition: "kermeta_structure_ParameterizedType" = None):
        self.isAbstract = isAbstract
...
class kermeta_structure_FunctionType(structure_TypeContainer, structure_Type):
    ...
    pass
class kermeta_structure_TypeVariable(structure_TypeContainer, structure_Type, structure_NamedElement):
