...
def test_hyp_treedsl_tree_is_not_abstract():
    assert not inspect.isabstract(TreeDsl_Tree)


def test_hyp_treedsl_tree_constructor_exists():
    assert callable(TreeDsl_Tree.__init__)


def test_hyp_treedsl_tree_constructor_args():
...
def test_hyp_treedsl_tree_label_setter(instance):
...
def test_TreeDsl_Tree_label_value_roundtrip():
    instance = TreeDsl_Tree(label="sample_text")
...
def test_assoc_children1_link_reassign_clear():
    a = TreeDsl_Tree(label="sample_text")
    b1 = TreeDsl_Tree(label="sample_text")
    b2 = TreeDsl_Tree(label="sample_text_2")
    _safe_set(a, 'Tree', b1)
...
TreeDsl_Tree_strategy = st.builds(TreeDsl_Tree, label=safe_text)
@given(instance=TreeDsl_Tree_strategy)
