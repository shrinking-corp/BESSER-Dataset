...
def test_assoc_array187_link_reassign_clear():
    ...
    _safe_set(a, 'pascal_resto186', b1)
    assert _is_linked(a, 'pascal_resto186', b1)
    if hasattr(b1, 'pascal_resto188'):
        assert _is_linked(b1, 'pascal_resto188', a)
    _safe_set(a, 'pascal_resto186', b2)
    assert _is_linked(a, 'pascal_resto186', b2)
    if hasattr(b1, 'pascal_resto188'):
        assert not _is_linked(b1, 'pascal_resto188', a)
    if hasattr(b2, 'pascal_resto188'):
        assert _is_linked(b2, 'pascal_resto188', a)
    _safe_set(a, 'pascal_resto186', None)
    assert not _is_linked(a, 'pascal_resto186', b2)
    if hasattr(b2, 'pascal_resto188'):
        assert not _is_linked(b2, 'pascal_resto188', a)
...
def test_assoc_assignment96_link_reassign_clear():
    a = pascal_simple_statement(function_noargs="sample_text")
    b1 = pascal_assignment_statement()
    b2 = pascal_assignment_statement()
    _safe_set(a, 'pascal_simple_statement97', b1)
    assert _is_linked(a, 'pascal_simple_statement97', b1)
    if hasattr(b1, 'pascal_assignment_statement'):
        assert _is_linked(b1, 'pascal_assignment_statement', a)
    _safe_set(a, 'pascal_simple_statement97', b2)
    assert _is_linked(a, 'pascal_simple_statement97', b2)
    if hasattr(b1, 'pascal_assignment_statement'):
    ...
    _safe_set(a, 'pascal_simple_statement97', None)
    assert not _is_linked(a, 'pascal_simple_statement97', b2)
    if hasattr(b2, 'pascal_assignment_statement'):
...
def test_assoc_const223_link_reassign_clear():
    ...
    _safe_set(a, 'pascal_subrange_type224', b1)
    assert _is_linked(a, 'pascal_subrange_type224', b1)
    if hasattr(b1, 'pascal_constant225'):
        assert _is_linked(b1, 'pascal_constant225', a)
    _safe_set(a, 'pascal_subrange_type224', b2)
    assert _is_linked(a, 'pascal_subrange_type224', b2)
    if hasattr(b1, 'pascal_constant225'):
        assert not _is_linked(b1, 'pascal_constant225', a)
    if hasattr(b2, 'pascal_constant225'):
        assert _is_linked(b2, 'pascal_constant225', a)
    _safe_set(a, 'pascal_subrange_type224', None)
    assert not _is_linked(a, 'pascal_subrange_type224', b2)
    if hasattr(b2, 'pascal_constant225'):
        assert not _is_linked(b2, 'pascal_constant225', a)
...
def test_assoc_constants279_link_reassign_clear():
    ...
    _safe_set(a, 'pascal_constant281', b1)
    assert _is_linked(a, 'pascal_constant281', b1)
    if hasattr(b1, 'pascal_case_label_list280'):
        assert _is_linked(b1, 'pascal_case_label_list280', a)
    _safe_set(a, 'pascal_constant281', b2)
    assert _is_linked(a, 'pascal_constant281', b2)
    if hasattr(b1, 'pascal_case_label_list280'):
        assert not _is_linked(b1, 'pascal_case_label_list280', a)
    if hasattr(b2, 'pascal_case_label_list280'):
        assert _is_linked(b2, 'pascal_case_label_list280', a)
    _safe_set(a, 'pascal_constant281', None)
    assert not _is_linked(a, 'pascal_constant281', b2)
    if hasattr(b2, 'pascal_case_label_list280'):
        assert not _is_linked(b2, 'pascal_case_label_list280', a)
...
def test_assoc_enumerated212_link_reassign_clear():
    a = pascal_simple_type(name="sample_text")
    b1 = pascal_enumerated_type()
    b2 = pascal_enumerated_type()
    _safe_set(a, 'pascal_simple_type213', b1)
    assert _is_linked(a, 'pascal_simple_type213', b1)
    if hasattr(b1, 'pascal_enumerated_type'):
        assert _is_linked(b1, 'pascal_enumerated_type', a)
    _safe_set(a, 'pascal_simple_type213', b2)
    assert _is_linked(a, 'pascal_simple_type213', b2)
    if hasattr(b1, 'pascal_enumerated_type'):
    ...
    _safe_set(a, 'pascal_simple_type213', None)
    assert not _is_linked(a, 'pascal_simple_type213', b2)
    if hasattr(b2, 'pascal_enumerated_type'):
...
def test_assoc_expression149_link_reassign_clear():
    a = pascal_expression(operators="sample_text")
    b1 = pascal_if_statement()
    b2 = pascal_if_statement()
    _safe_set(a, 'pascal_expression151', b1)
    assert _is_linked(a, 'pascal_expression151', b1)
    if hasattr(b1, 'pascal_if_statement150'):
        assert _is_linked(b1, 'pascal_if_statement150', a)
    _safe_set(a, 'pascal_expression151', b2)
    assert _is_linked(a, 'pascal_expression151', b2)
    if hasattr(b1, 'pascal_if_statement150'):
        assert not _is_linked(b1, 'pascal_if_statement150', a)
    if hasattr(b2, 'pascal_if_statement150'):
        assert _is_linked(b2, 'pascal_if_statement150', a)
    _safe_set(a, 'pascal_expression151', None)
    assert not _is_linked(a, 'pascal_expression151', b2)
    if hasattr(b2, 'pascal_if_statement150'):
        assert not _is_linked(b2, 'pascal_if_statement150', a)
...
def test_assoc_expression176_link_reassign_clear():
    ...
    _safe_set(a, 'pascal_factor177', b1)
    assert _is_linked(a, 'pascal_factor177', b1)
    if hasattr(b1, 'pascal_expression178'):
        assert _is_linked(b1, 'pascal_expression178', a)
    _safe_set(a, 'pascal_factor177', b2)
    assert _is_linked(a, 'pascal_factor177', b2)
    if hasattr(b1, 'pascal_expression178'):
        assert not _is_linked(b1, 'pascal_expression178', a)
    if hasattr(b2, 'pascal_expression178'):
        assert _is_linked(b2, 'pascal_expression178', a)
    _safe_set(a, 'pascal_factor177', None)
    assert not _is_linked(a, 'pascal_factor177', b2)
    if hasattr(b2, 'pascal_expression178'):
        assert not _is_linked(b2, 'pascal_expression178', a)
...
def test_assoc_expressions161_link_reassign_clear():
    ...
    if hasattr(b1, 'pascal_expression162'):
        assert _is_linked(b1, 'pascal_expression162', a)
    _safe_set(a, 'pascal_simple_expression', b2)
    assert _is_linked(a, 'pascal_simple_expression', b2)
    if hasattr(b1, 'pascal_expression162'):
        assert not _is_linked(b1, 'pascal_expression162', a)
    if hasattr(b2, 'pascal_expression162'):
        assert _is_linked(b2, 'pascal_expression162', a)
    _safe_set(a, 'pascal_simple_expression', None)
    assert not _is_linked(a, 'pascal_simple_expression', b2)
    if hasattr(b2, 'pascal_expression162'):
        assert not _is_linked(b2, 'pascal_expression162', a)


def test_assoc_expressions184_link_reassign_clear():
    a = pascal_resto(accessor=True, name="sample_text")
    b1 = pascal_expression_list()
    b2 = pascal_expression_list()
    _safe_set(a, 'pascal_resto185', b1)
    assert _is_linked(a, 'pascal_resto185', b1)
    if hasattr(b1, 'pascal_expression_list'):
        assert _is_linked(b1, 'pascal_expression_list', a)
    _safe_set(a, 'pascal_resto185', b2)
    assert _is_linked(a, 'pascal_resto185', b2)
    if hasattr(b1, 'pascal_expression_list'):
    ...
    _safe_set(a, 'pascal_resto185', None)
    assert not _is_linked(a, 'pascal_resto185', b2)
    if hasattr(b2, 'pascal_expression_list'):
        assert not _is_linked(b2, 'pascal_expression_list', a)


def test_assoc_expressions195_link_reassign_clear():
    a = pascal_set(brackets="sample_text")
    b1 = pascal_expression_list()
    b2 = pascal_expression_list()
    _safe_set(a, 'pascal_set196', b1)
    assert _is_linked(a, 'pascal_set196', b1)
    if hasattr(b1, 'pascal_expression_list197'):
        assert _is_linked(b1, 'pascal_expression_list197', a)
    _safe_set(a, 'pascal_set196', b2)
    assert _is_linked(a, 'pascal_set196', b2)
    if hasattr(b1, 'pascal_expression_list197'):
        assert not _is_linked(b1, 'pascal_expression_list197', a)
    if hasattr(b2, 'pascal_expression_list197'):
        assert _is_linked(b2, 'pascal_expression_list197', a)
    _safe_set(a, 'pascal_set196', None)
    assert not _is_linked(a, 'pascal_set196', b2)
    if hasattr(b2, 'pascal_expression_list197'):
        assert not _is_linked(b2, 'pascal_expression_list197', a)


def test_assoc_expressions198_link_reassign_clear():
    a = pascal_expression(operators="sample_text")
    b1 = pascal_expression_list()
    b2 = pascal_expression_list()
    _safe_set(a, 'pascal_expression200', b1)
    assert _is_linked(a, 'pascal_expression200', b1)
    if hasattr(b1, 'pascal_expression_list199'):
        assert _is_linked(b1, 'pascal_expression_list199', a)
    _safe_set(a, 'pascal_expression200', b2)
    assert _is_linked(a, 'pascal_expression200', b2)
    if hasattr(b1, 'pascal_expression_list199'):
        assert not _is_linked(b1, 'pascal_expression_list199', a)
    if hasattr(b2, 'pascal_expression_list199'):
        assert _is_linked(b2, 'pascal_expression_list199', a)
    _safe_set(a, 'pascal_expression200', None)
    assert not _is_linked(a, 'pascal_expression200', b2)
    if hasattr(b2, 'pascal_expression_list199'):
        assert not _is_linked(b2, 'pascal_expression_list199', a)


def test_assoc_expressions201_link_reassign_clear():
    a = pascal_function_designator(name="sample_text")
    b1 = pascal_expression_list()
    b2 = pascal_expression_list()
    _safe_set(a, 'pascal_function_designator202', b1)
    assert _is_linked(a, 'pascal_function_designator202', b1)
    if hasattr(b1, 'pascal_expression_list203'):
        assert _is_linked(b1, 'pascal_expression_list203', a)
    _safe_set(a, 'pascal_function_designator202', b2)
    assert _is_linked(a, 'pascal_function_designator202', b2)
    if hasattr(b1, 'pascal_expression_list203'):
        assert not _is_linked(b1, 'pascal_expression_list203', a)
    if hasattr(b2, 'pascal_expression_list203'):
        assert _is_linked(b2, 'pascal_expression_list203', a)
    _safe_set(a, 'pascal_function_designator202', None)
    assert not _is_linked(a, 'pascal_function_designator202', b2)
    if hasattr(b2, 'pascal_expression_list203'):
        assert not _is_linked(b2, 'pascal_expression_list203', a)


def test_assoc_factors165_link_reassign_clear():
...
def test_assoc_fields242_link_reassign_clear():
    a = pascal_record_type(end="sample_text", record="sample_text")
    b1 = pascal_field_list()
    b2 = pascal_field_list()
    _safe_set(a, 'pascal_record_type243', b1)
    assert _is_linked(a, 'pascal_record_type243', b1)
    if hasattr(b1, 'pascal_field_list'):
        assert _is_linked(b1, 'pascal_field_list', a)
    _safe_set(a, 'pascal_record_type243', b2)
    assert _is_linked(a, 'pascal_record_type243', b2)
    if hasattr(b1, 'pascal_field_list'):
        assert not _is_linked(b1, 'pascal_field_list', a)
    if hasattr(b2, 'pascal_field_list'):
        assert _is_linked(b2, 'pascal_field_list', a)
    _safe_set(a, 'pascal_record_type243', None)
    assert not _is_linked(a, 'pascal_record_type243', b2)
    if hasattr(b2, 'pascal_field_list'):
        assert not _is_linked(b2, 'pascal_field_list', a)


def test_assoc_finalConst220_link_reassign_clear():
    a = pascal_subrange_type(subrange="sample_text")
    b1 = pascal_constant(boolLiteral="sample_text", name="sample_text", nil="sample_text", opterator="sample_text", string="sample_text")
    b2 = pascal_constant(boolLiteral="sample_text_2", name="sample_text_2", nil="sample_text_2", opterator="sample_text_2", string="sample_text_2")
    _safe_set(a, 'pascal_subrange_type221', b1)
    assert _is_linked(a, 'pascal_subrange_type221', b1)
    if hasattr(b1, 'pascal_constant222'):
        assert _is_linked(b1, 'pascal_constant222', a)
    _safe_set(a, 'pascal_subrange_type221', b2)
    assert _is_linked(a, 'pascal_subrange_type221', b2)
    if hasattr(b1, 'pascal_constant222'):
        assert not _is_linked(b1, 'pascal_constant222', a)
    if hasattr(b2, 'pascal_constant222'):
        assert _is_linked(b2, 'pascal_constant222', a)
    _safe_set(a, 'pascal_subrange_type221', None)
    assert not _is_linked(a, 'pascal_subrange_type221', b2)
    if hasattr(b2, 'pascal_constant222'):
        assert not _is_linked(b2, 'pascal_constant222', a)
...
def test_assoc_function173_link_reassign_clear():
    a = pascal_function_designator(name="sample_text")
    b1 = pascal_factor(boolean="sample_text", nil=True, string="sample_text")
    b2 = pascal_factor(boolean="sample_text_2", nil=False, string="sample_text_2")
    _safe_set(a, 'pascal_function_designator175', b1)
    assert _is_linked(a, 'pascal_function_designator175', b1)
    if hasattr(b1, 'pascal_factor174'):
        assert _is_linked(b1, 'pascal_factor174', a)
    _safe_set(a, 'pascal_function_designator175', b2)
    assert _is_linked(a, 'pascal_function_designator175', b2)
    if hasattr(b1, 'pascal_factor174'):
        assert not _is_linked(b1, 'pascal_factor174', a)
    if hasattr(b2, 'pascal_factor174'):
        assert _is_linked(b2, 'pascal_factor174', a)
    _safe_set(a, 'pascal_function_designator175', None)
    assert not _is_linked(a, 'pascal_function_designator175', b2)
    if hasattr(b2, 'pascal_factor174'):
        assert not _is_linked(b2, 'pascal_factor174', a)
...
def test_assoc_function98_link_reassign_clear():
    ...
    _safe_set(a, 'pascal_simple_statement99', b1)
    assert _is_linked(a, 'pascal_simple_statement99', b1)
    if hasattr(b1, 'pascal_function_designator'):
        assert _is_linked(b1, 'pascal_function_designator', a)
    _safe_set(a, 'pascal_simple_statement99', b2)
    assert _is_linked(a, 'pascal_simple_statement99', b2)
    if hasattr(b1, 'pascal_function_designator'):
    ...
    _safe_set(a, 'pascal_simple_statement99', None)
    assert not _is_linked(a, 'pascal_simple_statement99', b2)
    if hasattr(b2, 'pascal_function_designator'):
...
def test_assoc_goto100_link_reassign_clear():
    a = pascal_simple_statement(function_noargs="sample_text")
    b1 = pascal_goto_statement()
    b2 = pascal_goto_statement()
    _safe_set(a, 'pascal_simple_statement101', b1)
    assert _is_linked(a, 'pascal_simple_statement101', b1)
    if hasattr(b1, 'pascal_goto_statement'):
        assert _is_linked(b1, 'pascal_goto_statement', a)
    _safe_set(a, 'pascal_simple_statement101', b2)
    assert _is_linked(a, 'pascal_simple_statement101', b2)
    if hasattr(b1, 'pascal_goto_statement'):
    ...
    _safe_set(a, 'pascal_simple_statement101', None)
    assert not _is_linked(a, 'pascal_simple_statement101', b2)
    if hasattr(b2, 'pascal_goto_statement'):
...
def test_assoc_identifiers214_link_reassign_clear():
    a = pascal_identifier_list(ids="sample_text")
    b1 = pascal_enumerated_type()
    b2 = pascal_enumerated_type()
    _safe_set(a, 'pascal_identifier_list216', b1)
    assert _is_linked(a, 'pascal_identifier_list216', b1)
    if hasattr(b1, 'pascal_enumerated_type215'):
        assert _is_linked(b1, 'pascal_enumerated_type215', a)
    _safe_set(a, 'pascal_identifier_list216', b2)
    assert _is_linked(a, 'pascal_identifier_list216', b2)
    if hasattr(b1, 'pascal_enumerated_type215'):
        assert not _is_linked(b1, 'pascal_enumerated_type215', a)
    if hasattr(b2, 'pascal_enumerated_type215'):
        assert _is_linked(b2, 'pascal_enumerated_type215', a)
    _safe_set(a, 'pascal_identifier_list216', None)
    assert not _is_linked(a, 'pascal_identifier_list216', b2)
    if hasattr(b2, 'pascal_enumerated_type215'):
        assert not _is_linked(b2, 'pascal_enumerated_type215', a)


def test_assoc_identifiers259_link_reassign_clear():
    a = pascal_identifier_list(ids="sample_text")
    b1 = pascal_record_section()
    b2 = pascal_record_section()
    _safe_set(a, 'pascal_identifier_list261', b1)
    assert _is_linked(a, 'pascal_identifier_list261', b1)
    if hasattr(b1, 'pascal_record_section260'):
        assert _is_linked(b1, 'pascal_record_section260', a)
    _safe_set(a, 'pascal_identifier_list261', b2)
    assert _is_linked(a, 'pascal_identifier_list261', b2)
    if hasattr(b1, 'pascal_record_section260'):
        assert not _is_linked(b1, 'pascal_record_section260', a)
    if hasattr(b2, 'pascal_record_section260'):
        assert _is_linked(b2, 'pascal_record_section260', a)
    _safe_set(a, 'pascal_identifier_list261', None)
    assert not _is_linked(a, 'pascal_identifier_list261', b2)
    if hasattr(b2, 'pascal_record_section260'):
        assert not _is_linked(b2, 'pascal_record_section260', a)
...
def test_assoc_indexes236_link_reassign_clear():
    a = pascal_simple_type(name="sample_text")
    b1 = pascal_array_type()
    b2 = pascal_array_type()
    _safe_set(a, 'pascal_simple_type238', b1)
    assert _is_linked(a, 'pascal_simple_type238', b1)
    if hasattr(b1, 'pascal_array_type237'):
        assert _is_linked(b1, 'pascal_array_type237', a)
    _safe_set(a, 'pascal_simple_type238', b2)
    assert _is_linked(a, 'pascal_simple_type238', b2)
    if hasattr(b1, 'pascal_array_type237'):
        assert not _is_linked(b1, 'pascal_array_type237', a)
    if hasattr(b2, 'pascal_array_type237'):
        assert _is_linked(b2, 'pascal_array_type237', a)
    _safe_set(a, 'pascal_simple_type238', None)
    assert not _is_linked(a, 'pascal_simple_type238', b2)
    if hasattr(b2, 'pascal_array_type237'):
        assert not _is_linked(b2, 'pascal_array_type237', a)


def test_assoc_initialConst217_link_reassign_clear():
    a = pascal_subrange_type(subrange="sample_text")
    b1 = pascal_constant(boolLiteral="sample_text", name="sample_text", nil="sample_text", opterator="sample_text", string="sample_text")
    b2 = pascal_constant(boolLiteral="sample_text_2", name="sample_text_2", nil="sample_text_2", opterator="sample_text_2", string="sample_text_2")
    _safe_set(a, 'pascal_subrange_type218', b1)
    assert _is_linked(a, 'pascal_subrange_type218', b1)
    if hasattr(b1, 'pascal_constant219'):
        assert _is_linked(b1, 'pascal_constant219', a)
    _safe_set(a, 'pascal_subrange_type218', b2)
    assert _is_linked(a, 'pascal_subrange_type218', b2)
    if hasattr(b1, 'pascal_constant219'):
        assert not _is_linked(b1, 'pascal_constant219', a)
    if hasattr(b2, 'pascal_constant219'):
        assert _is_linked(b2, 'pascal_constant219', a)
    _safe_set(a, 'pascal_subrange_type218', None)
    assert not _is_linked(a, 'pascal_subrange_type218', b2)
    if hasattr(b2, 'pascal_constant219'):
        assert not _is_linked(b2, 'pascal_constant219', a)
...
def test_assoc_not_180_link_reassign_clear():
    a = pascal_factor(boolean="sample_text", nil=True, string="sample_text")
    b1 = pascal_factor(boolean="sample_text", nil=True, string="sample_text")
    b2 = pascal_factor(boolean="sample_text_2", nil=False, string="sample_text_2")
    _safe_set(a, 'pascal_factor179', b1)
    assert _is_linked(a, 'pascal_factor179', b1)
    if hasattr(b1, 'pascal_factor181'):
        assert _is_linked(b1, 'pascal_factor181', a)
    _safe_set(a, 'pascal_factor179', b2)
    assert _is_linked(a, 'pascal_factor179', b2)
    if hasattr(b1, 'pascal_factor181'):
        assert not _is_linked(b1, 'pascal_factor181', a)
    if hasattr(b2, 'pascal_factor181'):
        assert _is_linked(b2, 'pascal_factor181', a)
    _safe_set(a, 'pascal_factor179', None)
    assert not _is_linked(a, 'pascal_factor179', b2)
    if hasattr(b2, 'pascal_factor181'):
        assert not _is_linked(b2, 'pascal_factor181', a)


def test_assoc_number169_link_reassign_clear():
    a = pascal_factor(boolean="sample_text", nil=True, string="sample_text")
    b1 = pascal_number()
    b2 = pascal_number()
    _safe_set(a, 'pascal_factor170', b1)
    assert _is_linked(a, 'pascal_factor170', b1)
    if hasattr(b1, 'pascal_number'):
        assert _is_linked(b1, 'pascal_number', a)
    _safe_set(a, 'pascal_factor170', b2)
    assert _is_linked(a, 'pascal_factor170', b2)
    if hasattr(b1, 'pascal_number'):
        assert not _is_linked(b1, 'pascal_number', a)
    if hasattr(b2, 'pascal_number'):
        assert _is_linked(b2, 'pascal_number', a)
    _safe_set(a, 'pascal_factor170', None)
    assert not _is_linked(a, 'pascal_factor170', b2)
    if hasattr(b2, 'pascal_number'):
        assert not _is_linked(b2, 'pascal_number', a)


def test_assoc_number274_link_reassign_clear():
    ...
    if hasattr(b1, 'pascal_number275'):
        assert _is_linked(b1, 'pascal_number275', a)
    _safe_set(a, 'pascal_any_number', b2)
    assert _is_linked(a, 'pascal_any_number', b2)
    if hasattr(b1, 'pascal_number275'):
        assert not _is_linked(b1, 'pascal_number275', a)
    if hasattr(b2, 'pascal_number275'):
        assert _is_linked(b2, 'pascal_number275', a)
    _safe_set(a, 'pascal_any_number', None)
    assert not _is_linked(a, 'pascal_any_number', b2)
    if hasattr(b2, 'pascal_number275'):
        assert not _is_linked(b2, 'pascal_number275', a)


def test_assoc_number276_link_reassign_clear():
    a = pascal_constant(boolLiteral="sample_text", name="sample_text", nil="sample_text", opterator="sample_text", string="sample_text")
    b1 = pascal_number()
    b2 = pascal_number()
    _safe_set(a, 'pascal_constant277', b1)
    assert _is_linked(a, 'pascal_constant277', b1)
    if hasattr(b1, 'pascal_number278'):
        assert _is_linked(b1, 'pascal_number278', a)
    _safe_set(a, 'pascal_constant277', b2)
    assert _is_linked(a, 'pascal_constant277', b2)
    if hasattr(b1, 'pascal_number278'):
        assert not _is_linked(b1, 'pascal_number278', a)
    if hasattr(b2, 'pascal_number278'):
        assert _is_linked(b2, 'pascal_number278', a)
    _safe_set(a, 'pascal_constant277', None)
    assert not _is_linked(a, 'pascal_constant277', b2)
    if hasattr(b2, 'pascal_number278'):
        assert not _is_linked(b2, 'pascal_number278', a)
...
def test_assoc_pointer193_link_reassign_clear():
    a = pascal_resto(accessor=True, name="sample_text")
    b1 = pascal_resto(accessor=True, name="sample_text")
    b2 = pascal_resto(accessor=False, name="sample_text_2")
    _safe_set(a, 'pascal_resto192', b1)
    assert _is_linked(a, 'pascal_resto192', b1)
    if hasattr(b1, 'pascal_resto194'):
        assert _is_linked(b1, 'pascal_resto194', a)
    _safe_set(a, 'pascal_resto192', b2)
    assert _is_linked(a, 'pascal_resto192', b2)
    if hasattr(b1, 'pascal_resto194'):
        assert not _is_linked(b1, 'pascal_resto194', a)
    if hasattr(b2, 'pascal_resto194'):
        assert _is_linked(b2, 'pascal_resto194', a)
    _safe_set(a, 'pascal_resto192', None)
    assert not _is_linked(a, 'pascal_resto192', b2)
    if hasattr(b2, 'pascal_resto194'):
        assert not _is_linked(b2, 'pascal_resto194', a)
...
def test_assoc_record230_link_reassign_clear():
    a = pascal_record_type(end="sample_text", record="sample_text")
    ...
    if hasattr(b1, 'pascal_unpacked_structured_type231'):
        assert _is_linked(b1, 'pascal_unpacked_structured_type231', a)
    _safe_set(a, 'pascal_record_type', b2)
    assert _is_linked(a, 'pascal_record_type', b2)
    if hasattr(b1, 'pascal_unpacked_structured_type231'):
        assert not _is_linked(b1, 'pascal_unpacked_structured_type231', a)
    if hasattr(b2, 'pascal_unpacked_structured_type231'):
        assert _is_linked(b2, 'pascal_unpacked_structured_type231', a)
    _safe_set(a, 'pascal_record_type', None)
    assert not _is_linked(a, 'pascal_record_type', b2)
    if hasattr(b2, 'pascal_unpacked_structured_type231'):
        assert not _is_linked(b2, 'pascal_unpacked_structured_type231', a)


def test_assoc_set171_link_reassign_clear():
    a = pascal_set(brackets="sample_text")
    b1 = pascal_factor(boolean="sample_text", nil=True, string="sample_text")
    b2 = pascal_factor(boolean="sample_text_2", nil=False, string="sample_text_2")
    _safe_set(a, 'pascal_set', b1)
    assert _is_linked(a, 'pascal_set', b1)
    if hasattr(b1, 'pascal_factor172'):
        assert _is_linked(b1, 'pascal_factor172', a)
    _safe_set(a, 'pascal_set', b2)
    assert _is_linked(a, 'pascal_set', b2)
    if hasattr(b1, 'pascal_factor172'):
        assert not _is_linked(b1, 'pascal_factor172', a)
    if hasattr(b2, 'pascal_factor172'):
        assert _is_linked(b2, 'pascal_factor172', a)
    _safe_set(a, 'pascal_set', None)
    assert not _is_linked(a, 'pascal_set', b2)
    if hasattr(b2, 'pascal_factor172'):
        assert not _is_linked(b2, 'pascal_factor172', a)


def test_assoc_simple204_link_reassign_clear():
    a = pascal_simple_type(name="sample_text")
    b1 = pascal_type()
    b2 = pascal_type()
    _safe_set(a, 'pascal_simple_type', b1)
    assert _is_linked(a, 'pascal_simple_type', b1)
    if hasattr(b1, 'pascal_type205'):
        assert _is_linked(b1, 'pascal_type205', a)
    _safe_set(a, 'pascal_simple_type', b2)
    assert _is_linked(a, 'pascal_simple_type', b2)
    if hasattr(b1, 'pascal_type205'):
        assert not _is_linked(b1, 'pascal_type205', a)
    if hasattr(b2, 'pascal_type205'):
        assert _is_linked(b2, 'pascal_type205', a)
    _safe_set(a, 'pascal_simple_type', None)
    assert not _is_linked(a, 'pascal_simple_type', b2)
    if hasattr(b2, 'pascal_type205'):
        assert not _is_linked(b2, 'pascal_type205', a)


def test_assoc_simple92_link_reassign_clear():
    a = pascal_simple_statement(function_noargs="sample_text")
    b1 = pascal_statement()
    b2 = pascal_statement()
    _safe_set(a, 'pascal_simple_statement', b1)
    assert _is_linked(a, 'pascal_simple_statement', b1)
    if hasattr(b1, 'pascal_statement93'):
        assert _is_linked(b1, 'pascal_statement93', a)
    _safe_set(a, 'pascal_simple_statement', b2)
    assert _is_linked(a, 'pascal_simple_statement', b2)
    if hasattr(b1, 'pascal_statement93'):
        assert not _is_linked(b1, 'pascal_statement93', a)
    if hasattr(b2, 'pascal_statement93'):
        assert _is_linked(b2, 'pascal_statement93', a)
    _safe_set(a, 'pascal_simple_statement', None)
    assert not _is_linked(a, 'pascal_simple_statement', b2)
    if hasattr(b2, 'pascal_statement93'):
        assert not _is_linked(b2, 'pascal_statement93', a)
...
def test_assoc_stmt158_link_reassign_clear():
    a = pascal_with_statement(record="sample_text", records="sample_text")
    b1 = pascal_statement()
    b2 = pascal_statement()
    _safe_set(a, 'pascal_with_statement159', b1)
    assert _is_linked(a, 'pascal_with_statement159', b1)
    if hasattr(b1, 'pascal_statement160'):
        assert _is_linked(b1, 'pascal_statement160', a)
    _safe_set(a, 'pascal_with_statement159', b2)
    assert _is_linked(a, 'pascal_with_statement159', b2)
    if hasattr(b1, 'pascal_statement160'):
        assert not _is_linked(b1, 'pascal_statement160', a)
    if hasattr(b2, 'pascal_statement160'):
        assert _is_linked(b2, 'pascal_statement160', a)
    _safe_set(a, 'pascal_with_statement159', None)
    assert not _is_linked(a, 'pascal_with_statement159', b2)
    if hasattr(b2, 'pascal_statement160'):
        assert not _is_linked(b2, 'pascal_statement160', a)


def test_assoc_structured206_link_reassign_clear():
    a = pascal_structured_type(packed=True)
    b1 = pascal_type()
    b2 = pascal_type()
    _safe_set(a, 'pascal_structured_type', b1)
    assert _is_linked(a, 'pascal_structured_type', b1)
    if hasattr(b1, 'pascal_type207'):
        assert _is_linked(b1, 'pascal_type207', a)
    _safe_set(a, 'pascal_structured_type', b2)
    assert _is_linked(a, 'pascal_structured_type', b2)
    if hasattr(b1, 'pascal_type207'):
        assert not _is_linked(b1, 'pascal_type207', a)
    if hasattr(b2, 'pascal_type207'):
        assert _is_linked(b2, 'pascal_type207', a)
    _safe_set(a, 'pascal_structured_type', None)
    assert not _is_linked(a, 'pascal_structured_type', b2)
    if hasattr(b2, 'pascal_type207'):
        assert not _is_linked(b2, 'pascal_type207', a)


def test_assoc_subrange210_link_reassign_clear():
    a = pascal_subrange_type(subrange="sample_text")
    ...
    if hasattr(b1, 'pascal_simple_type211'):
        assert _is_linked(b1, 'pascal_simple_type211', a)
    _safe_set(a, 'pascal_subrange_type', b2)
    assert _is_linked(a, 'pascal_subrange_type', b2)
    if hasattr(b1, 'pascal_simple_type211'):
        assert not _is_linked(b1, 'pascal_simple_type211', a)
    if hasattr(b2, 'pascal_simple_type211'):
        assert _is_linked(b2, 'pascal_simple_type211', a)
    _safe_set(a, 'pascal_subrange_type', None)
    assert not _is_linked(a, 'pascal_subrange_type', b2)
    if hasattr(b2, 'pascal_simple_type211'):
        assert not _is_linked(b2, 'pascal_simple_type211', a)


def test_assoc_tag265_link_reassign_clear():
    a = pascal_variant_part(name="sample_text")
    b1 = pascal_tag_field(name="sample_text")
    b2 = pascal_tag_field(name="sample_text_2")
    _safe_set(a, 'pascal_variant_part266', b1)
    assert _is_linked(a, 'pascal_variant_part266', b1)
    if hasattr(b1, 'pascal_tag_field'):
        assert _is_linked(b1, 'pascal_tag_field', a)
    _safe_set(a, 'pascal_variant_part266', b2)
    assert _is_linked(a, 'pascal_variant_part266', b2)
    if hasattr(b1, 'pascal_tag_field'):
        assert not _is_linked(b1, 'pascal_tag_field', a)
    if hasattr(b2, 'pascal_tag_field'):
        assert _is_linked(b2, 'pascal_tag_field', a)
    _safe_set(a, 'pascal_variant_part266', None)
    assert not _is_linked(a, 'pascal_variant_part266', b2)
    if hasattr(b2, 'pascal_tag_field'):
        assert not _is_linked(b2, 'pascal_tag_field', a)


def test_assoc_terms163_link_reassign_clear():
    a = pascal_simple_expression(operators="sample_text", prefixOperator="sample_text")
    b1 = pascal_EObject()
    b2 = pascal_EObject()
    _safe_set(a, 'pascal_simple_expression164', {b1})
    assert _is_linked(a, 'pascal_simple_expression164', b1)
    if hasattr(b1, 'pascal_EObject'):
        assert _is_linked(b1, 'pascal_EObject', a)
    _safe_set(a, 'pascal_simple_expression164', {b2})
    assert _is_linked(a, 'pascal_simple_expression164', b2)
    if hasattr(b1, 'pascal_EObject'):
        assert not _is_linked(b1, 'pascal_EObject', a)
    if hasattr(b2, 'pascal_EObject'):
        assert _is_linked(b2, 'pascal_EObject', a)
    _safe_set(a, 'pascal_simple_expression164', set())
    assert not _is_linked(a, 'pascal_simple_expression164', b2)
    if hasattr(b2, 'pascal_EObject'):
        assert not _is_linked(b2, 'pascal_EObject', a)


def test_assoc_type226_link_reassign_clear():
    a = pascal_structured_type(packed=True)
    b1 = pascal_unpacked_structured_type()
    b2 = pascal_unpacked_structured_type()
    _safe_set(a, 'pascal_structured_type227', b1)
    assert _is_linked(a, 'pascal_structured_type227', b1)
    if hasattr(b1, 'pascal_unpacked_structured_type'):
        assert _is_linked(b1, 'pascal_unpacked_structured_type', a)
    _safe_set(a, 'pascal_structured_type227', b2)
    assert _is_linked(a, 'pascal_structured_type227', b2)
    if hasattr(b1, 'pascal_unpacked_structured_type'):
    ...
    _safe_set(a, 'pascal_structured_type227', None)
    assert not _is_linked(a, 'pascal_structured_type227', b2)
    if hasattr(b2, 'pascal_unpacked_structured_type'):
...
def test_assoc_variable166_link_reassign_clear():
    a = pascal_variable(name="sample_text")
    b1 = pascal_factor(boolean="sample_text", nil=True, string="sample_text")
    b2 = pascal_factor(boolean="sample_text_2", nil=False, string="sample_text_2")
    _safe_set(a, 'pascal_variable168', b1)
    assert _is_linked(a, 'pascal_variable168', b1)
    if hasattr(b1, 'pascal_factor167'):
        assert _is_linked(b1, 'pascal_factor167', a)
    _safe_set(a, 'pascal_variable168', b2)
    assert _is_linked(a, 'pascal_variable168', b2)
    if hasattr(b1, 'pascal_factor167'):
        assert not _is_linked(b1, 'pascal_factor167', a)
    if hasattr(b2, 'pascal_factor167'):
        assert _is_linked(b2, 'pascal_factor167', a)
    _safe_set(a, 'pascal_variable168', None)
    assert not _is_linked(a, 'pascal_variable168', b2)
    if hasattr(b2, 'pascal_factor167'):
        assert not _is_linked(b2, 'pascal_factor167', a)
...
def test_assoc_variable190_link_reassign_clear():
    a = pascal_resto(accessor=True, name="sample_text")
    b1 = pascal_resto(accessor=True, name="sample_text")
    b2 = pascal_resto(accessor=False, name="sample_text_2")
    _safe_set(a, 'pascal_resto189', b1)
    assert _is_linked(a, 'pascal_resto189', b1)
    if hasattr(b1, 'pascal_resto191'):
        assert _is_linked(b1, 'pascal_resto191', a)
    _safe_set(a, 'pascal_resto189', b2)
    assert _is_linked(a, 'pascal_resto189', b2)
    if hasattr(b1, 'pascal_resto191'):
        assert not _is_linked(b1, 'pascal_resto191', a)
    if hasattr(b2, 'pascal_resto191'):
        assert _is_linked(b2, 'pascal_resto191', a)
    _safe_set(a, 'pascal_resto189', None)
    assert not _is_linked(a, 'pascal_resto189', b2)
    if hasattr(b2, 'pascal_resto191'):
        assert not _is_linked(b2, 'pascal_resto191', a)


def test_assoc_variants255_link_reassign_clear():
    a = pascal_variant_part(name="sample_text")
    b1 = pascal_field_list()
    b2 = pascal_field_list()
    _safe_set(a, 'pascal_variant_part', b1)
    assert _is_linked(a, 'pascal_variant_part', b1)
    if hasattr(b1, 'pascal_field_list256'):
        assert _is_linked(b1, 'pascal_field_list256', a)
    _safe_set(a, 'pascal_variant_part', b2)
    assert _is_linked(a, 'pascal_variant_part', b2)
    if hasattr(b1, 'pascal_field_list256'):
        assert not _is_linked(b1, 'pascal_field_list256', a)
    if hasattr(b2, 'pascal_field_list256'):
        assert _is_linked(b2, 'pascal_field_list256', a)
    _safe_set(a, 'pascal_variant_part', None)
    assert not _is_linked(a, 'pascal_variant_part', b2)
    if hasattr(b2, 'pascal_field_list256'):
        assert not _is_linked(b2, 'pascal_field_list256', a)


def test_assoc_variants267_link_reassign_clear():
    a = pascal_variant_part(name="sample_text")
    b1 = pascal_variant()
    b2 = pascal_variant()
    _safe_set(a, 'pascal_variant_part268', {b1})
    assert _is_linked(a, 'pascal_variant_part268', b1)
    if hasattr(b1, 'pascal_variant'):
        assert _is_linked(b1, 'pascal_variant', a)
    _safe_set(a, 'pascal_variant_part268', {b2})
    assert _is_linked(a, 'pascal_variant_part268', b2)
    if hasattr(b1, 'pascal_variant'):
        assert not _is_linked(b1, 'pascal_variant', a)
    if hasattr(b2, 'pascal_variant'):
        assert _is_linked(b2, 'pascal_variant', a)
    _safe_set(a, 'pascal_variant_part268', set())
    assert not _is_linked(a, 'pascal_variant_part268', b2)
    if hasattr(b2, 'pascal_variant'):
