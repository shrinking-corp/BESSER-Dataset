...
class declarations_LibraryItemDecl:
    ...
    pass
class ClockRDL_declarations_LibraryDecl(declarations_RepositoryDecl, declarations_LibraryItemDecl):

    pass
class ClockRDL_declarations_AbstractRelationDecl(declarations_LibraryItemDecl, kernel_NamedDeclaration):
...
class ClockRDL_statements_AssignmentStmt(Statement):
    ...
    def __init__(self, operator: str, ClockRDL_statements_AssignmentStmt33: "kernel_Expression" = None, ClockRDL_statements_AssignmentStmt: "kernel_Expression" = None):
...
class kernel_Declaration:
    ...
    pass
class ClockRDL_kernel_NamedDeclaration(kernel_Declaration, kernel_NamedElement):
...
class ClockRDL_expressions_BinaryExp(Expression):
    ...
    def __init__(self, operator: str, ClockRDL_expressions_BinaryExp13: "kernel_Expression" = None, ClockRDL_expressions_BinaryExp: "kernel_Expression" = None):
        self.operator = operator
...
class kernel_Statement:
    ...
    pass
class ClockRDL_expressions_FunctionCallExp(expressions_PrefixedExp, kernel_Statement):
