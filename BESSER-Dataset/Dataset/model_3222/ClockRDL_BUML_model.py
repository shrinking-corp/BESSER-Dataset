...
# Classes
ClockRDL_kernel_Element = Class(name="ClockRDL_kernel_Element", is_abstract=True)
ClockRDL_kernel_NamedElement = Class(name="ClockRDL_kernel_NamedElement", is_abstract=True)
Element = Class(name="Element")
ClockRDL_kernel_Expression = Class(name="ClockRDL_kernel_Expression", is_abstract=True)
kernel_Element = Class(name="kernel_Element")
kernel_Statement = Class(name="kernel_Statement")
ClockRDL_expressions_Literal = Class(name="ClockRDL_expressions_Literal", is_abstract=True)
Expression = Class(name="Expression")
ClockRDL_expressions_ParenExp = Class(name="ClockRDL_expressions_ParenExp")
kernel_Expression = Class(name="kernel_Expression")
ClockRDL_expressions_PrefixedExp = Class(name="ClockRDL_expressions_PrefixedExp", is_abstract=True)
ClockRDL_expressions_IndexedExp = Class(name="ClockRDL_expressions_IndexedExp")
PrefixedExp = Class(name="PrefixedExp")
ClockRDL_expressions_SelectedExp = Class(name="ClockRDL_expressions_SelectedExp")
ClockRDL_kernel_Declaration = Class(name="ClockRDL_kernel_Declaration", is_abstract=True)
ClockRDL_kernel_NamedDeclaration = Class(name="ClockRDL_kernel_NamedDeclaration", is_abstract=True)
kernel_Declaration = Class(name="kernel_Declaration")
kernel_NamedElement = Class(name="kernel_NamedElement")
ClockRDL_kernel_Statement = Class(name="ClockRDL_kernel_Statement", is_abstract=True)
ClockRDL_expressions_ClockReference = Class(name="ClockRDL_expressions_ClockReference")
ReferenceExp = Class(name="ReferenceExp")
ClockRDL_expressions_UnaryExp = Class(name="ClockRDL_expressions_UnaryExp")
ClockRDL_expressions_FunctionCallExp = Class(name="ClockRDL_expressions_FunctionCallExp")
expressions_PrefixedExp = Class(name="expressions_PrefixedExp")
ClockRDL_expressions_ReferenceExp = Class(name="ClockRDL_expressions_ReferenceExp")
kernel_NamedDeclaration = Class(name="kernel_NamedDeclaration")
ClockRDL_expressions_ConditionalExp = Class(name="ClockRDL_expressions_ConditionalExp")
ClockRDL_literals_IntegerLiteral = Class(name="ClockRDL_literals_IntegerLiteral")
Literal = Class(name="Literal")
ClockRDL_literals_BooleanLiteral = Class(name="ClockRDL_literals_BooleanLiteral")
ClockRDL_literals_ArrayLiteral = Class(name="ClockRDL_literals_ArrayLiteral")
ClockRDL_literals_FieldLiteral = Class(name="ClockRDL_literals_FieldLiteral")
expressions_Literal = Class(name="expressions_Literal")
ClockRDL_literals_RecordLiteral = Class(name="ClockRDL_literals_RecordLiteral")
literals_FieldLiteral = Class(name="literals_FieldLiteral")
ClockRDL_literals_QueueLiteral = Class(name="ClockRDL_literals_QueueLiteral")
ClockRDL_literals_ClockLiteral = Class(name="ClockRDL_literals_ClockLiteral")
ClockRDL_expressions_BinaryExp = Class(name="ClockRDL_expressions_BinaryExp")
ClockRDL_statements_ConditionalStmt = Class(name="ClockRDL_statements_ConditionalStmt")
statements_BlockStmt = Class(name="statements_BlockStmt")
ClockRDL_statements_LoopStmt = Class(name="ClockRDL_statements_LoopStmt")
ClockRDL_statements_ReturnStmt = Class(name="ClockRDL_statements_ReturnStmt")
ClockRDL_statements_BlockStmt = Class(name="ClockRDL_statements_BlockStmt")
ClockRDL_declarations_ClockDecl = Class(name="ClockRDL_declarations_ClockDecl")
NamedDeclaration = Class(name="NamedDeclaration")
literals_ClockLiteral = Class(name="literals_ClockLiteral")
ClockRDL_declarations_VariableDecl = Class(name="ClockRDL_declarations_VariableDecl")
ClockRDL_declarations_ConstantDecl = Class(name="ClockRDL_declarations_ConstantDecl")
VariableDecl = Class(name="VariableDecl")
ClockRDL_declarations_ArgumentDecl = Class(name="ClockRDL_declarations_ArgumentDecl")
ClockRDL_statements_AssignmentStmt = Class(name="ClockRDL_statements_AssignmentStmt")
Statement = Class(name="Statement")
ClockRDL_declarations_AbstractRelationDecl = Class(name="ClockRDL_declarations_AbstractRelationDecl")
declarations_LibraryItemDecl = Class(name="declarations_LibraryItemDecl")
ClockRDL_declarations_PrimitiveRelationDecl = Class(name="ClockRDL_declarations_PrimitiveRelationDecl")
AbstractRelationDecl = Class(name="AbstractRelationDecl")
declarations_TransitionDecl = Class(name="declarations_TransitionDecl")
ClockRDL_declarations_CompositeRelationDecl = Class(name="ClockRDL_declarations_CompositeRelationDecl")
declarations_ClockDecl = Class(name="declarations_ClockDecl")
declarations_RelationInstanceDecl = Class(name="declarations_RelationInstanceDecl")
ClockRDL_declarations_RelationInstanceDecl = Class(name="ClockRDL_declarations_RelationInstanceDecl")
declarations_AbstractRelationDecl = Class(name="declarations_AbstractRelationDecl")
declarations_FormalToActualMapEntry = Class(name="declarations_FormalToActualMapEntry")
ClockRDL_declarations_FormalToActualMapEntry = Class(name="ClockRDL_declarations_FormalToActualMapEntry")
ClockRDL_declarations_LibraryItemDecl = Class(name="ClockRDL_declarations_LibraryItemDecl", is_abstract=True)
declarations_RepositoryDecl = Class(name="declarations_RepositoryDecl")
ClockRDL_declarations_RepositoryDecl = Class(name="ClockRDL_declarations_RepositoryDecl")
ClockRDL_declarations_AbstractFunctionDecl = Class(name="ClockRDL_declarations_AbstractFunctionDecl", is_abstract=True)
declarations_ArgumentDecl = Class(name="declarations_ArgumentDecl")
ClockRDL_declarations_PrimitiveFunctionDecl = Class(name="ClockRDL_declarations_PrimitiveFunctionDecl")
AbstractFunctionDecl = Class(name="AbstractFunctionDecl")
ClockRDL_declarations_FunctionDecl = Class(name="ClockRDL_declarations_FunctionDecl")
ClockRDL_declarations_TransitionDecl = Class(name="ClockRDL_declarations_TransitionDecl")
Declaration = Class(name="Declaration")
expressions_ClockReference = Class(name="expressions_ClockReference")
ClockRDL_declarations_LibraryDecl = Class(name="ClockRDL_declarations_LibraryDecl")
ClockRDL_declarations_SystemDecl = Class(name="ClockRDL_declarations_SystemDecl")
...
library82: BinaryAssociation = BinaryAssociation(
    name="library82",
    ends={
        Property(name="RepositoryDecl", type=ClockRDL_declarations_LibraryItemDecl, multiplicity=Multiplicity(1, 1)),
        Property(name="libraries", type=declarations_RepositoryDecl, multiplicity=Multiplicity(1, 1))
    }
)
...
libraries83: BinaryAssociation = BinaryAssociation(
    name="libraries83",
    ends={
        Property(name="LibraryItemDecl", type=ClockRDL_declarations_RepositoryDecl, multiplicity=Multiplicity(1, 1)),
        Property(name="library", type=declarations_LibraryItemDecl, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
root84: BinaryAssociation = BinaryAssociation(
    name="root84",
    ends={
        Property(name="declarations_RelationInstanceDecl85", type=ClockRDL_declarations_SystemDecl, multiplicity=Multiplicity(1, 1)),
...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={ClockRDL_kernel_Element, ClockRDL_kernel_NamedElement, Element, ClockRDL_kernel_Expression, kernel_Element, kernel_Statement, ClockRDL_expressions_Literal, Expression, ClockRDL_expressions_ParenExp, kernel_Expression, ClockRDL_expressions_PrefixedExp, ClockRDL_expressions_IndexedExp, PrefixedExp, ClockRDL_expressions_SelectedExp, ClockRDL_kernel_Declaration, ClockRDL_kernel_NamedDeclaration, kernel_Declaration, kernel_NamedElement, ClockRDL_kernel_Statement, ClockRDL_expressions_ClockReference, ReferenceExp, ClockRDL_expressions_UnaryExp, ClockRDL_expressions_FunctionCallExp, expressions_PrefixedExp, ClockRDL_expressions_ReferenceExp, kernel_NamedDeclaration, ClockRDL_expressions_ConditionalExp, ClockRDL_literals_IntegerLiteral, Literal, ClockRDL_literals_BooleanLiteral, ClockRDL_literals_ArrayLiteral, ClockRDL_literals_FieldLiteral, expressions_Literal, ClockRDL_literals_RecordLiteral, literals_FieldLiteral, ClockRDL_literals_QueueLiteral, ClockRDL_literals_ClockLiteral, ClockRDL_expressions_BinaryExp, ClockRDL_statements_ConditionalStmt, statements_BlockStmt, ClockRDL_statements_LoopStmt, ClockRDL_statements_ReturnStmt, ClockRDL_statements_BlockStmt, ClockRDL_declarations_ClockDecl, NamedDeclaration, literals_ClockLiteral, ClockRDL_declarations_VariableDecl, ClockRDL_declarations_ConstantDecl, VariableDecl, ClockRDL_declarations_ArgumentDecl, ClockRDL_statements_AssignmentStmt, Statement, ClockRDL_declarations_AbstractRelationDecl, declarations_LibraryItemDecl, ClockRDL_declarations_PrimitiveRelationDecl, AbstractRelationDecl, declarations_TransitionDecl, ClockRDL_declarations_CompositeRelationDecl, declarations_ClockDecl, declarations_RelationInstanceDecl, ClockRDL_declarations_RelationInstanceDecl, declarations_AbstractRelationDecl, declarations_FormalToActualMapEntry, ClockRDL_declarations_FormalToActualMapEntry, ClockRDL_declarations_LibraryItemDecl, declarations_RepositoryDecl, ClockRDL_declarations_RepositoryDecl, ClockRDL_declarations_AbstractFunctionDecl, declarations_ArgumentDecl, ClockRDL_declarations_PrimitiveFunctionDecl, AbstractFunctionDecl, ClockRDL_declarations_FunctionDecl, ClockRDL_declarations_TransitionDecl, Declaration, expressions_ClockReference, ClockRDL_declarations_LibraryDecl, ClockRDL_declarations_SystemDecl, RepositoryDecl, UnaryOperator, BinaryOperator, AssignmentOperator},
    associations={exp0, prefix1, index3, ref7, arguments5, rhs12, condition15, trueBranch17, falseBranch20, value23, value25, value27, value28, operand8, lhs10, rhs32, condition35, trueBranch37, falseBranch39, condition42, body44, exp47, declarations49, statements51, initial53, initial54, lhs30, vector61, action63, arguments66, declarations68, transitions71, internalClocks72, instances73, relation75, argumentMap76, value78, formalDecl80, library82, arguments56, body57, guard59, libraries83, root84},
    generalizations={gen_ClockRDL_kernel_Expression_kernel_Element, gen_ClockRDL_kernel_Expression_kernel_Statement, gen_ClockRDL_expressions_Literal_Expression, gen_ClockRDL_expressions_ParenExp_Expression, gen_ClockRDL_expressions_PrefixedExp_Expression, gen_ClockRDL_expressions_IndexedExp_PrefixedExp, gen_ClockRDL_expressions_SelectedExp_PrefixedExp, gen_ClockRDL_kernel_NamedElement_Element, gen_ClockRDL_kernel_Declaration_Element, gen_ClockRDL_kernel_NamedDeclaration_kernel_Declaration, gen_ClockRDL_kernel_NamedDeclaration_kernel_NamedElement, gen_ClockRDL_kernel_Statement_Element, gen_ClockRDL_expressions_ClockReference_ReferenceExp, gen_ClockRDL_expressions_UnaryExp_Expression, gen_ClockRDL_expressions_FunctionCallExp_expressions_PrefixedExp, gen_ClockRDL_expressions_FunctionCallExp_kernel_Statement, gen_ClockRDL_expressions_ReferenceExp_Expression, gen_ClockRDL_expressions_ConditionalExp_Expression, gen_ClockRDL_literals_IntegerLiteral_Literal, gen_ClockRDL_literals_BooleanLiteral_Literal, gen_ClockRDL_literals_ArrayLiteral_Literal, gen_ClockRDL_literals_FieldLiteral_kernel_NamedElement, gen_ClockRDL_literals_FieldLiteral_expressions_Literal, gen_ClockRDL_literals_RecordLiteral_Literal, gen_ClockRDL_literals_QueueLiteral_Literal, gen_ClockRDL_literals_ClockLiteral_Literal, gen_ClockRDL_expressions_BinaryExp_Expression, gen_ClockRDL_statements_ConditionalStmt_Statement, gen_ClockRDL_statements_LoopStmt_Statement, gen_ClockRDL_statements_ReturnStmt_Statement, gen_ClockRDL_statements_BlockStmt_Statement, gen_ClockRDL_declarations_ClockDecl_NamedDeclaration, gen_ClockRDL_declarations_VariableDecl_NamedDeclaration, gen_ClockRDL_declarations_ConstantDecl_VariableDecl, gen_ClockRDL_declarations_ArgumentDecl_NamedDeclaration, gen_ClockRDL_statements_AssignmentStmt_Statement, gen_ClockRDL_declarations_AbstractRelationDecl_kernel_NamedDeclaration, gen_ClockRDL_declarations_AbstractRelationDecl_declarations_LibraryItemDecl, gen_ClockRDL_declarations_PrimitiveRelationDecl_AbstractRelationDecl, gen_ClockRDL_declarations_CompositeRelationDecl_AbstractRelationDecl, gen_ClockRDL_declarations_RelationInstanceDecl_NamedDeclaration, gen_ClockRDL_declarations_LibraryItemDecl_Declaration, gen_ClockRDL_declarations_RepositoryDecl_NamedDeclaration, gen_ClockRDL_declarations_AbstractFunctionDecl_NamedDeclaration, gen_ClockRDL_declarations_PrimitiveFunctionDecl_AbstractFunctionDecl, gen_ClockRDL_declarations_FunctionDecl_AbstractFunctionDecl, gen_ClockRDL_declarations_TransitionDecl_Declaration, gen_ClockRDL_declarations_LibraryDecl_declarations_RepositoryDecl, gen_ClockRDL_declarations_LibraryDecl_declarations_LibraryItemDecl, gen_ClockRDL_declarations_SystemDecl_RepositoryDecl},
    metadata=None
)
