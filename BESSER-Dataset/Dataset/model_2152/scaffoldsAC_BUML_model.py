...
# Classes
scaffolds_ScaffoldGraph = Class(name="scaffolds_ScaffoldGraph")
scaffolds_Contig = Class(name="scaffolds_Contig")
scaffolds_Edge = Class(name="scaffolds_Edge")
scaffolds_Vertex = Class(name="scaffolds_Vertex")
...
scaffolds_Contig.attributes={scaffolds_Contig_length, scaffolds_Contig_multiplicity}
...
scaffolds_Edge.attributes={scaffolds_Edge_distance, scaffolds_Edge_weight}
...
domain_model = DomainModel(
    name="scaffolds",
    types={scaffolds_ScaffoldGraph, scaffolds_Contig, scaffolds_Edge, scaffolds_Vertex},
