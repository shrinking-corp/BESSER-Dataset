...
def test_hyp_scaffolds_vertex_is_not_abstract():
    assert not inspect.isabstract(scaffolds_Vertex)


def test_hyp_scaffolds_vertex_constructor_exists():
    assert callable(scaffolds_Vertex.__init__)


def test_hyp_scaffolds_vertex_constructor_args():
...
def test_hyp_scaffolds_edge_is_not_abstract():
    assert not inspect.isabstract(scaffolds_Edge)


def test_hyp_scaffolds_edge_constructor_exists():
    assert callable(scaffolds_Edge.__init__)


def test_hyp_scaffolds_edge_constructor_args():
...
def test_hyp_scaffolds_contig_is_not_abstract():
    assert not inspect.isabstract(scaffolds_Contig)


def test_hyp_scaffolds_contig_constructor_exists():
    assert callable(scaffolds_Contig.__init__)


def test_hyp_scaffolds_contig_constructor_args():
...
def test_hyp_scaffolds_scaffoldgraph_is_not_abstract():
    assert not inspect.isabstract(scaffolds_ScaffoldGraph)


def test_hyp_scaffolds_scaffoldgraph_constructor_exists():
    assert callable(scaffolds_ScaffoldGraph.__init__)


def test_hyp_scaffolds_scaffoldgraph_constructor_args():
...
def test_hyp_scaffolds_vertex_num_setter(instance):
...
def test_hyp_scaffolds_edge_distance_setter(instance):
...
@given(instance=scaffolds_Edge_strategy)
def test_hyp_scaffolds_edge_weight_setter(instance):
...
def test_hyp_scaffolds_contig_multiplicity_setter(instance):
...
@given(instance=scaffolds_Contig_strategy)
def test_hyp_scaffolds_contig_length_setter(instance):
