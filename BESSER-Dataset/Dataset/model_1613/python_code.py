...
class hlcorestructure_Font:
    ...
    def __init__(self, align: str, decoration: str, size: str, style: str, weight: str, family: str, rotation: str, Font: "hlcorestructure_AnnotationGraphics" = None, font: "hlcorestructure_AnnotationGraphics" = None):
        self.align = align
...
class hlcorestructure_PnObject(ABC):
    ...
    def __init__(self, id: str, PnObject: "hlcorestructure_Page" = None, containerNamePnObject: "hlcorestructure_Name" = None, containerPnObject: set["hlcorestructure_ToolInfo"] = None, objects: "hlcorestructure_Page" = None, PnObject29: "hlcorestructure_ToolInfo" = None, PnObject24: "hlcorestructure_Name" = None):
        self.id = id
...
class hlcorestructure_PetriNet:
    ...
    def __init__(self, id: str, type: str, containerPetriNet4: set["hlcorestructure_ToolInfo"] = None, nets: "hlcorestructure_PetriNetDoc" = None, containerDeclarationPetriNet: set["hlcorestructure_Declaration"] = None, PetriNet9: "hlcorestructure_Page" = None, PetriNet26: "hlcorestructure_ToolInfo" = None, PetriNet21: "hlcorestructure_Name" = None, PetriNet: "hlcorestructure_PetriNetDoc" = None, containerPetriNet: set["hlcorestructure_Page"] = None, containerNamePetriNet: "hlcorestructure_Name" = None, PetriNet122: "hlcorestructure_Declaration" = None):
        self.id = id
        self.type = type
...
class hlcorestructure_Name(Annotation):
    ...
    def __init__(self, text: str, Name15: "hlcorestructure_PnObject" = None, name: "hlcorestructure_PetriNet" = None, name23: "hlcorestructure_PnObject" = None, Name: "hlcorestructure_PetriNet" = None):
        self.text = text
        self.Name15 = Name15
        self.name = name
        self.name23 = name23
