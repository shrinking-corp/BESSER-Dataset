...
# Classes
SMVC_SMVCApplication = Class(name="SMVC_SMVCApplication")
SMVC_Attribute = Class(name="SMVC_Attribute")
SMVC_Link = Class(name="SMVC_Link")
SMVC_View = Class(name="SMVC_View")
SMVC_Controller = Class(name="SMVC_Controller")
SMVC_DataAccessObject = Class(name="SMVC_DataAccessObject")
SMVC_Entity = Class(name="SMVC_Entity")
SMVC_Page = Class(name="SMVC_Page")
SMVC_EntityController = Class(name="SMVC_EntityController")
Controller = Class(name="Controller")
SMVC_Component = Class(name="SMVC_Component", is_abstract=True)
SMVC_EntityComponent = Class(name="SMVC_EntityComponent", is_abstract=True)
Component = Class(name="Component")
SMVC_List = Class(name="SMVC_List")
EntityComponent = Class(name="EntityComponent")
SMVC_SupportedOperation = Class(name="SMVC_SupportedOperation")
SMVC_Form = Class(name="SMVC_Form")
...
SMVC_Attribute.attributes={SMVC_Attribute_multiValued, SMVC_Attribute_name, SMVC_Attribute_type, SMVC_Attribute_label}
...
SMVC_DataAccessObject.attributes={SMVC_DataAccessObject_name, SMVC_DataAccessObject_showDirectInstancesOnly}
...
domain_model = DomainModel(
    name="SMVC",
    types={SMVC_SMVCApplication, SMVC_Attribute, SMVC_Link, SMVC_View, SMVC_Controller, SMVC_DataAccessObject, SMVC_Entity, SMVC_Page, SMVC_EntityController, Controller, SMVC_Component, SMVC_EntityComponent, Component, SMVC_List, EntityComponent, SMVC_SupportedOperation, SMVC_Form, AttributeType, Operation},
    associations={attributes18, complexType20, links23, view25, homeController0, controller1, daos4, entities6, subController9, page11, dao13, forEntity15, components27, entity29, supportedOperations31},
