...
class SMVC_Page:
    ...
    def __init__(self, title: str, SMVC_Page24: set["SMVC_Link"] = None, SMVC_Page26: "SMVC_View" = None, SMVC_Page: "SMVC_Controller" = None):
        self.title = title
...
class SMVC_Entity:
    ...
    def __init__(self, name: str, SMVC_Entity19: set["SMVC_Attribute"] = None, SMVC_Entity22: "SMVC_Attribute" = None, SMVC_Entity: "SMVC_SMVCApplication" = None, SMVC_Entity17: "SMVC_DataAccessObject" = None, SMVC_Entity30: "SMVC_EntityComponent" = None):
        self.name = name
