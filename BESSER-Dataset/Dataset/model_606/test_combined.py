...
def test_hyp_smvc_attribute_label_setter(instance):
...
def test_SMVC_Attribute_label_value_roundtrip():
    instance = SMVC_Attribute(label=True, multiValued=True, name="sample_text", type="sample_text")
...
def test_assoc_attributes18_link_reassign_clear():
    ...
    b1 = SMVC_Attribute(label=True, multiValued=True, name="sample_text", type="sample_text")
    b2 = SMVC_Attribute(label=False, multiValued=False, name="sample_text_2", type="sample_text_2")
...
SMVC_Attribute_strategy = st.builds(SMVC_Attribute, label=st.booleans(), multiValued=st.booleans(), name=safe_text, type=safe_text)
@given(instance=SMVC_Attribute_strategy)
@settings(max_examples=25)
