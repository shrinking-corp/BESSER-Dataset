...
# Classes
StandardProfile_Auxiliary = Class(name="StandardProfile_Auxiliary")
StandardProfile_Class = Class(name="StandardProfile_Class")
StandardProfile_Entity = Class(name="StandardProfile_Entity")
StandardProfile_Component = Class(name="StandardProfile_Component")
StandardProfile_Executable = Class(name="StandardProfile_Executable")
StandardProfile_Focus = Class(name="StandardProfile_Focus")
StandardProfile_Framework = Class(name="StandardProfile_Framework")
StandardProfile_Package = Class(name="StandardProfile_Package")
StandardProfile_Implement = Class(name="StandardProfile_Implement")
StandardProfile_ImplementationClass = Class(name="StandardProfile_ImplementationClass")
StandardProfile_Instantiate = Class(name="StandardProfile_Instantiate")
StandardProfile_Library = Class(name="StandardProfile_Library")
StandardProfile_Metaclass = Class(name="StandardProfile_Metaclass")
StandardProfile_Call = Class(name="StandardProfile_Call")
StandardProfile_Usage = Class(name="StandardProfile_Usage")
StandardProfile_Create = Class(name="StandardProfile_Create")
StandardProfile_BehavioralFeature = Class(name="StandardProfile_BehavioralFeature")
StandardProfile_Derive = Class(name="StandardProfile_Derive")
StandardProfile_Abstraction = Class(name="StandardProfile_Abstraction")
StandardProfile_Destroy = Class(name="StandardProfile_Destroy")
StandardProfile_Document = Class(name="StandardProfile_Document")
File = Class(name="File")
StandardProfile_File = Class(name="StandardProfile_File")
StandardProfile_Specification = Class(name="StandardProfile_Specification")
StandardProfile_Artifact = Class(name="StandardProfile_Artifact")
StandardProfile_Subsystem = Class(name="StandardProfile_Subsystem")
StandardProfile_Trace = Class(name="StandardProfile_Trace")
StandardProfile_Type = Class(name="StandardProfile_Type")
StandardProfile_ModelLibrary = Class(name="StandardProfile_ModelLibrary")
StandardProfile_Process = Class(name="StandardProfile_Process")
StandardProfile_Realization = Class(name="StandardProfile_Realization")
StandardProfile_Classifier = Class(name="StandardProfile_Classifier")
StandardProfile_Refine = Class(name="StandardProfile_Refine")
StandardProfile_Responsibility = Class(name="StandardProfile_Responsibility")
StandardProfile_Script = Class(name="StandardProfile_Script")
StandardProfile_Send = Class(name="StandardProfile_Send")
StandardProfile_Service = Class(name="StandardProfile_Service")
StandardProfile_Source = Class(name="StandardProfile_Source")
StandardProfile_Utility = Class(name="StandardProfile_Utility")
StandardProfile_BuildComponent = Class(name="StandardProfile_BuildComponent")
StandardProfile_Metamodel = Class(name="StandardProfile_Metamodel")
StandardProfile_Model = Class(name="StandardProfile_Model")
StandardProfile_SystemModel = Class(name="StandardProfile_SystemModel")
...
domain_model = DomainModel(
    ...
    types={StandardProfile_Auxiliary, StandardProfile_Class, StandardProfile_Entity, StandardProfile_Component, StandardProfile_Executable, StandardProfile_Focus, StandardProfile_Framework, StandardProfile_Package, StandardProfile_Implement, StandardProfile_ImplementationClass, StandardProfile_Instantiate, StandardProfile_Library, StandardProfile_Metaclass, StandardProfile_Call, StandardProfile_Usage, StandardProfile_Create, StandardProfile_BehavioralFeature, StandardProfile_Derive, StandardProfile_Abstraction, StandardProfile_Destroy, StandardProfile_Document, File, StandardProfile_File, StandardProfile_Specification, StandardProfile_Artifact, StandardProfile_Subsystem, StandardProfile_Trace, StandardProfile_Type, StandardProfile_ModelLibrary, StandardProfile_Process, StandardProfile_Realization, StandardProfile_Classifier, StandardProfile_Refine, StandardProfile_Responsibility, StandardProfile_Script, StandardProfile_Send, StandardProfile_Service, StandardProfile_Source, StandardProfile_Utility, StandardProfile_BuildComponent, StandardProfile_Metamodel, StandardProfile_Model, StandardProfile_SystemModel},
    associations={base_Class0, base_Artifact9, base_Component10, base_Class11, base_Package13, base_Component14, base_Class16, base_Usage18, base_Class20, base_Usage1, base_BehavioralFeature2, base_Usage3, base_Abstraction6, base_BehavioralFeature7, base_Classifier35, base_Component37, base_Abstraction39, base_Class41, base_Package22, base_Component24, base_Classifier26, base_Abstraction27, base_Usage29, base_Usage31, base_Component33, base_Class43, base_Component45, base_Model47, base_Model48},
    generalizations={gen_StandardProfile_Executable_File, gen_StandardProfile_Library_File, gen_StandardProfile_Document_File, gen_StandardProfile_Script_File, gen_StandardProfile_Source_File},
    metadata=None
)
