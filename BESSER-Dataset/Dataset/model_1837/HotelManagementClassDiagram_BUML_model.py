...
HotelManagementClassDiagram_Extra = Class(name="HotelManagementClassDiagram_Extra")
...
HotelManagementClassDiagram_DBInterface = Class(name="HotelManagementClassDiagram_DBInterface", is_abstract=True)
HotelManagementClassDiagram_FakeDBContext = Class(name="HotelManagementClassDiagram_FakeDBContext")
...
HotelManagementClassDiagram_Person.attributes={HotelManagementClassDiagram_Person_name, HotelManagementClassDiagram_Person_postalCode, HotelManagementClassDiagram_Person_gender, HotelManagementClassDiagram_Person_phoneNumber, HotelManagementClassDiagram_Person_country, HotelManagementClassDiagram_Person_city, HotelManagementClassDiagram_Person_SSNumber, HotelManagementClassDiagram_Person_title, HotelManagementClassDiagram_Person_street}
...
HotelManagementClassDiagram_Booking.attributes={HotelManagementClassDiagram_Booking_internalComments, HotelManagementClassDiagram_Booking_checkedIn, HotelManagementClassDiagram_Booking_startDate, HotelManagementClassDiagram_Booking_checkedOut, HotelManagementClassDiagram_Booking_created, HotelManagementClassDiagram_Booking_endDate, HotelManagementClassDiagram_Booking_externalComments, HotelManagementClassDiagram_Booking_bookingId, HotelManagementClassDiagram_Booking_roomTypes}
HotelManagementClassDiagram_Booking.methods={HotelManagementClassDiagram_Booking_m_generateBill, HotelManagementClassDiagram_Booking_m_pay, HotelManagementClassDiagram_Booking_m_removeAddon, HotelManagementClassDiagram_Booking_m_addRoom, HotelManagementClassDiagram_Booking_m_addAddon, HotelManagementClassDiagram_Booking_m_removeRoom, HotelManagementClassDiagram_Booking_m_removeDiscount, HotelManagementClassDiagram_Booking_m_checkOut, HotelManagementClassDiagram_Booking_m_checkIn, HotelManagementClassDiagram_Booking_m_addDiscount}
...
HotelManagementClassDiagram_Employee.attributes={HotelManagementClassDiagram_Employee_password, HotelManagementClassDiagram_Employee_workRate, HotelManagementClassDiagram_Employee_employeeID, HotelManagementClassDiagram_Employee_salary}
...
HotelManagementClassDiagram_Creditcard.attributes={HotelManagementClassDiagram_Creditcard_expirationYear, HotelManagementClassDiagram_Creditcard_number, HotelManagementClassDiagram_Creditcard_cvc, HotelManagementClassDiagram_Creditcard_expirationMonth, HotelManagementClassDiagram_Creditcard_owner}
...
HotelManagementClassDiagram_Room.attributes={HotelManagementClassDiagram_Room_type, HotelManagementClassDiagram_Room_roomNumber, HotelManagementClassDiagram_Room_maxNbrPeople, HotelManagementClassDiagram_Room_internalComment, HotelManagementClassDiagram_Room_size, HotelManagementClassDiagram_Room_underCleaning, HotelManagementClassDiagram_Room_underRepair}
...
HotelManagementClassDiagram_Customer.attributes={HotelManagementClassDiagram_Customer_miscInfo, HotelManagementClassDiagram_Customer_customerID, HotelManagementClassDiagram_Customer_bonusPoints}
...
HotelManagementClassDiagram_Discount.attributes={HotelManagementClassDiagram_Discount_name, HotelManagementClassDiagram_Discount_isPercentage, HotelManagementClassDiagram_Discount_amount}
...
HotelManagementClassDiagram_Bill.attributes={HotelManagementClassDiagram_Bill_final, HotelManagementClassDiagram_Bill_paid, HotelManagementClassDiagram_Bill_totalPrice}
...
HotelManagementClassDiagram_Extra.attributes={HotelManagementClassDiagram_Extra_description, HotelManagementClassDiagram_Extra_name}
...
HotelManagementClassDiagram_Costable_m_addDiscount: Method = Method(name="addDiscount", parameters={Parameter(name='HotelManagementClassDiagram_discount', type=StringType)})
HotelManagementClassDiagram_Costable_m_removeDiscount: Method = Method(name="removeDiscount", parameters={Parameter(name='HotelManagementClassDiagram_discount', type=StringType)})
...
HotelManagementClassDiagram_BookingController_m_getCustomer: Method = Method(name="getCustomer", parameters={Parameter(name='HotelManagementClassDiagram_SSN', type=StringType)}, type=StringType)
HotelManagementClassDiagram_BookingController_m_updateOrAddCustomer: Method = Method(name="updateOrAddCustomer", parameters={Parameter(name='HotelManagementClassDiagram_customer', type=StringType)})
HotelManagementClassDiagram_BookingController_m_updateOrAddBooking: Method = Method(name="updateOrAddBooking", parameters={Parameter(name='HotelManagementClassDiagram_booking', type=StringType)})
...
HotelManagementClassDiagram_BookingController.methods={HotelManagementClassDiagram_BookingController_m_saveCustomer, HotelManagementClassDiagram_BookingController_m_updateOrAddCustomer, HotelManagementClassDiagram_BookingController_m_checkOut, HotelManagementClassDiagram_BookingController_m_checkIn, HotelManagementClassDiagram_BookingController_m_findCustomer, HotelManagementClassDiagram_BookingController_m_getAllBookings, HotelManagementClassDiagram_BookingController_m_getAllCustomers, HotelManagementClassDiagram_BookingController_m_getBooking, HotelManagementClassDiagram_BookingController_m_assignRoom, HotelManagementClassDiagram_BookingController_m_updateOrAddBooking, HotelManagementClassDiagram_BookingController_m_getCustomer, HotelManagementClassDiagram_BookingController_m_searchAvailableRoomTypes, HotelManagementClassDiagram_BookingController_m_sendConfirmation}

# HotelManagementClassDiagram_ManagementController class attributes and methods
HotelManagementClassDiagram_ManagementController_m_updateOrAddEmployee: Method = Method(name="updateOrAddEmployee", parameters={Parameter(name='HotelManagementClassDiagram_employee', type=StringType)})
HotelManagementClassDiagram_ManagementController_m_updateOrAddEmployeeType: Method = Method(name="updateOrAddEmployeeType", parameters={Parameter(name='HotelManagementClassDiagram_employeeType', type=StringType)})
HotelManagementClassDiagram_ManagementController_m_updateOrAddRoom: Method = Method(name="updateOrAddRoom", parameters={Parameter(name='HotelManagementClassDiagram_room', type=StringType)})
HotelManagementClassDiagram_ManagementController_m_updateOrAddRoomType: Method = Method(name="updateOrAddRoomType", parameters={Parameter(name='HotelManagementClassDiagram_roomType', type=StringType)})
HotelManagementClassDiagram_ManagementController_m_updateOrAddDiscount: Method = Method(name="updateOrAddDiscount", parameters={Parameter(name='HotelManagementClassDiagram_discount', type=StringType)})
HotelManagementClassDiagram_ManagementController_m_updateOrAddAddon: Method = Method(name="updateOrAddAddon", parameters={Parameter(name='HotelManagementClassDiagram_addon', type=StringType)})
HotelManagementClassDiagram_ManagementController_m_updateOrAddExtra: Method = Method(name="updateOrAddExtra", parameters={Parameter(name='HotelManagementClassDiagram_extra', type=StringType)})
...
HotelManagementClassDiagram_ManagementController_m_getEmployee: Method = Method(name="getEmployee", parameters={Parameter(name='HotelManagementClassDiagram_SSN', type=StringType)}, type=StringType)
HotelManagementClassDiagram_ManagementController.methods={HotelManagementClassDiagram_ManagementController_m_getAllAddons, HotelManagementClassDiagram_ManagementController_m_updateOrAddDiscount, HotelManagementClassDiagram_ManagementController_m_updateOrAddRoomType, HotelManagementClassDiagram_ManagementController_m_getAllDiscounts, HotelManagementClassDiagram_ManagementController_m_getAllEmployees, HotelManagementClassDiagram_ManagementController_m_getEmployee, HotelManagementClassDiagram_ManagementController_m_updateOrAddEmployeeType, HotelManagementClassDiagram_ManagementController_m_updateOrAddEmployee, HotelManagementClassDiagram_ManagementController_m_getAllExtras, HotelManagementClassDiagram_ManagementController_m_updateOrAddAddon, HotelManagementClassDiagram_ManagementController_m_updateOrAddRoom, HotelManagementClassDiagram_ManagementController_m_updateOrAddExtra}

# HotelManagementClassDiagram_MaintenanceController class attributes and methods
HotelManagementClassDiagram_MaintenanceController_m_addToQueue: Method = Method(name="addToQueue", parameters={Parameter(name='HotelManagementClassDiagram_room', type=StringType)})
HotelManagementClassDiagram_MaintenanceController_m_setCleanedStatus: Method = Method(name="setCleanedStatus", parameters={Parameter(name='HotelManagementClassDiagram_room', type=StringType), Parameter(name='HotelManagementClassDiagram_status', type=StringType)})
HotelManagementClassDiagram_MaintenanceController_m_removeFromQueue: Method = Method(name="removeFromQueue", parameters={Parameter(name='HotelManagementClassDiagram_room', type=StringType)})
...
HotelManagementClassDiagram_MaintenanceController_m_setRepairedStatus: Method = Method(name="setRepairedStatus", parameters={Parameter(name='HotelManagementClassDiagram_repaired', type=StringType), Parameter(name='HotelManagementClassDiagram_room', type=StringType)})
...
HotelManagementClassDiagram_Hotel_m_logIn: Method = Method(name="logIn", parameters={Parameter(name='HotelManagementClassDiagram_password', type=StringType), Parameter(name='HotelManagementClassDiagram_SSN', type=StringType)}, type=StringType)
HotelManagementClassDiagram_Hotel.attributes={HotelManagementClassDiagram_Hotel_rank, HotelManagementClassDiagram_Hotel_name, HotelManagementClassDiagram_Hotel_address}
...
HotelManagementClassDiagram_DBInterface_m_getAddon: Method = Method(name="getAddon", parameters={Parameter(name='HotelManagementClassDiagram_addonName', type=StringType)}, type=StringType)
HotelManagementClassDiagram_DBInterface_m_getAllDiscounts: Method = Method(name="getAllDiscounts", parameters={}, type=StringType)
HotelManagementClassDiagram_DBInterface_m_getDiscount: Method = Method(name="getDiscount", parameters={Parameter(name='HotelManagementClassDiagram_discountName', type=StringType)}, type=StringType)
HotelManagementClassDiagram_DBInterface_m_getAllBookings: Method = Method(name="getAllBookings", parameters={}, type=StringType)
HotelManagementClassDiagram_DBInterface_m_getBookings: Method = Method(name="getBookings", parameters={Parameter(name='HotelManagementClassDiagram_toDate', type=StringType), Parameter(name='HotelManagementClassDiagram_fromDate', type=StringType)}, type=StringType)
...
HotelManagementClassDiagram_DBInterface_m_findBookings: Method = Method(name="findBookings", parameters={Parameter(name='HotelManagementClassDiagram_customerName', type=StringType)}, type=StringType)
HotelManagementClassDiagram_DBInterface_m_getAllCustomers: Method = Method(name="getAllCustomers", parameters={}, type=StringType)
HotelManagementClassDiagram_DBInterface_m_getCustomer: Method = Method(name="getCustomer", parameters={Parameter(name='HotelManagementClassDiagram_customerSSNumber', type=StringType)}, type=StringType)
HotelManagementClassDiagram_DBInterface_m_findCustomers: Method = Method(name="findCustomers", parameters={Parameter(name='HotelManagementClassDiagram_partOfCustomerName', type=StringType)}, type=StringType)
HotelManagementClassDiagram_DBInterface_m_getAllEmployees: Method = Method(name="getAllEmployees", parameters={}, type=StringType)
HotelManagementClassDiagram_DBInterface_m_getEmployee: Method = Method(name="getEmployee", parameters={Parameter(name='HotelManagementClassDiagram_employeeSSNumber', type=StringType)}, type=StringType)
...
HotelManagementClassDiagram_DBInterface_m_updateOrAddRoom: Method = Method(name="updateOrAddRoom", parameters={Parameter(name='HotelManagementClassDiagram_room', type=StringType)})
HotelManagementClassDiagram_DBInterface_m_updateOrAddCustomer: Method = Method(name="updateOrAddCustomer", parameters={Parameter(name='HotelManagementClassDiagram_customer', type=StringType)})
HotelManagementClassDiagram_DBInterface_m_updateOrAddBooking: Method = Method(name="updateOrAddBooking", parameters={Parameter(name='HotelManagementClassDiagram_booking', type=StringType)})
HotelManagementClassDiagram_DBInterface_m_updateOrAddDiscount: Method = Method(name="updateOrAddDiscount", parameters={Parameter(name='HotelManagementClassDiagram_discount', type=StringType)})
HotelManagementClassDiagram_DBInterface_m_updateOrAddAddon: Method = Method(name="updateOrAddAddon", parameters={Parameter(name='HotelManagementClassDiagram_addon', type=StringType)})
HotelManagementClassDiagram_DBInterface_m_getRoom: Method = Method(name="getRoom", parameters={Parameter(name='HotelManagementClassDiagram_roomNumber', type=StringType)}, type=StringType)
HotelManagementClassDiagram_DBInterface_m_getAllRoomTypes: Method = Method(name="getAllRoomTypes", parameters={}, type=StringType)
HotelManagementClassDiagram_DBInterface_m_getAvaliableRoomTypes: Method = Method(name="getAvaliableRoomTypes", parameters={Parameter(name='HotelManagementClassDiagram_from_', type=StringType), Parameter(name='HotelManagementClassDiagram_to', type=StringType)}, type=StringType)
HotelManagementClassDiagram_DBInterface_m_getAvailableRooms: Method = Method(name="getAvailableRooms", parameters={Parameter(name='HotelManagementClassDiagram_to', type=StringType), Parameter(name='HotelManagementClassDiagram_type', type=StringType), Parameter(name='HotelManagementClassDiagram_from_', type=StringType)}, type=StringType)
HotelManagementClassDiagram_DBInterface_m_getRooms: Method = Method(name="getRooms", parameters={Parameter(name='HotelManagementClassDiagram_type', type=StringType)}, type=StringType)
HotelManagementClassDiagram_DBInterface_m_getBooking: Method = Method(name="getBooking", parameters={Parameter(name='HotelManagementClassDiagram_bookingID', type=StringType)}, type=StringType)
HotelManagementClassDiagram_DBInterface_m_updateOrAddEmployee: Method = Method(name="updateOrAddEmployee", parameters={Parameter(name='HotelManagementClassDiagram_employee', type=StringType)})
HotelManagementClassDiagram_DBInterface_m_updateOrAddRoomType: Method = Method(name="updateOrAddRoomType", parameters={Parameter(name='HotelManagementClassDiagram_type', type=StringType)})
HotelManagementClassDiagram_DBInterface_m_updateOrAddEmployeeType: Method = Method(name="updateOrAddEmployeeType", parameters={Parameter(name='HotelManagementClassDiagram_type', type=StringType)})
HotelManagementClassDiagram_DBInterface_m_updateOrAddExtra: Method = Method(name="updateOrAddExtra", parameters={Parameter(name='HotelManagementClassDiagram_extra', type=StringType)})
HotelManagementClassDiagram_DBInterface.methods={HotelManagementClassDiagram_DBInterface_m_getRoom, HotelManagementClassDiagram_DBInterface_m_getRooms, HotelManagementClassDiagram_DBInterface_m_getPastBookings, HotelManagementClassDiagram_DBInterface_m_getAllEmployees, HotelManagementClassDiagram_DBInterface_m_getAvailableRooms, HotelManagementClassDiagram_DBInterface_m_getBookings, HotelManagementClassDiagram_DBInterface_m_getAddon, HotelManagementClassDiagram_DBInterface_m_getAllRoomTypes, HotelManagementClassDiagram_DBInterface_m_updateOrAddRoomType, HotelManagementClassDiagram_DBInterface_m_findCustomers, HotelManagementClassDiagram_DBInterface_m_getBooking, HotelManagementClassDiagram_DBInterface_m_getAllCustomers, HotelManagementClassDiagram_DBInterface_m__getAllRooms, HotelManagementClassDiagram_DBInterface_m_updateOrAddExtra, HotelManagementClassDiagram_DBInterface_m_getAllManagers, HotelManagementClassDiagram_DBInterface_m_getEmployee, HotelManagementClassDiagram_DBInterface_m_getCustomer, HotelManagementClassDiagram_DBInterface_m_getDiscount, HotelManagementClassDiagram_DBInterface_m_updateOrAddDiscount, HotelManagementClassDiagram_DBInterface_m_getAllReceptionists, HotelManagementClassDiagram_DBInterface_m_getCurrentBookings, HotelManagementClassDiagram_DBInterface_m_updateOrAddBooking, HotelManagementClassDiagram_DBInterface_m_updateOrAddEmployee, HotelManagementClassDiagram_DBInterface_m_getAllAddons, HotelManagementClassDiagram_DBInterface_m_getAllBookings, HotelManagementClassDiagram_DBInterface_m_updateOrAddRoom, HotelManagementClassDiagram_DBInterface_m_updateOrAddEmployeeType, HotelManagementClassDiagram_DBInterface_m_getFutureBookings, HotelManagementClassDiagram_DBInterface_m_updateOrAddCustomer, HotelManagementClassDiagram_DBInterface_m_getAvaliableRoomTypes, HotelManagementClassDiagram_DBInterface_m_updateOrAddAddon, HotelManagementClassDiagram_DBInterface_m_findBookings, HotelManagementClassDiagram_DBInterface_m_getAllDiscounts, HotelManagementClassDiagram_DBInterface_m_getAllCleaners}
