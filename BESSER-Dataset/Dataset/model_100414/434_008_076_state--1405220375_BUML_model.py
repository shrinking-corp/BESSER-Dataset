...
domain_model = DomainModel(
    name="state",
    types={state_Trigger, state_State, Vertex, NamedElement, state_Region, state_Behaviour, state_Vertex, state_StateMachine, state_Transition, state_NamedElement, state_Constraint, state_FinalState, State, state_OpaqueExpression, state_Event, state_StateModel, state_PseudoState, TransitionKind, PseudoStateKind},
    associations={defferableTrigger1, region0, source26, doActivity3, entry5, exit8, state11, subVertex14, stateMachine16, transition18, region20, outgoing23, incoming24, target27, trigger29, guard32, effect34, specification37, event39, packagedElment41},
