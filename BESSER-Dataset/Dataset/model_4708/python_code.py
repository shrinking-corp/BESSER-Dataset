...
class smif_metadata_Definition(Metadata):
    ...
    def __init__(self, summaryDescription: str, textDefinition: str, definedBy: "IdentifiableEntity" = None, smif_metadata_Definition: "IRIIdentifier" = None, smif_metadata_Definition185: "Term" = None, Metadata: "smif_toplevel_IdentifiableEntity" = None):
...
class constraints_Conditional:
    ...
    pass
class smif_patterns_PatternVariable(constraints_Conditional, properties_OwnedPropertyType):

    def __init__(self, qualification: str, explicit: str, concreteFocus: "Mapping" = None, ownsVariable: "Pattern" = None, subsets: set["PatternVariable"] = None, mapsVariable: set["MatchEnd"] = None, hasSubset: set["PatternVariable"] = None, excludes: set["PatternVariable"] = None, excludedBy: set["PatternVariable"] = None, referenceFocus: "Mapping" = None):
...
class smif_mapping_MatchEnd(constraints_Conditional, patterns_Computed):
...
class smif_mapping_Mapping(constraints_Rule, patterns_Pattern):
    ...
    def __init__(self, strength: str, concreteMapping: "PatternVariable" = None, mapRuleOf: set["MatchRule"] = None, referenceMapping: "PatternVariable" = None):
...
class smif_constraints_MultiplicityConstraint(TypeConstraint):
    ...
    def __init__(self, isSufficent: str, mininumNumber: str, maximumNumber: str, atOnce: str, respectOf: set["Type"] = None, hasMultiplicity: "Type" = None):
...
class smif_mapping_MatchRule(Rule):
    ...
    def __init__(self, coerce: str, matchFrom: "MatchEnd" = None, matchTo: "MatchEnd" = None, hasMapRule: "Mapping" = None, Rule78: "smif_toplevel_IdentifiableEntity" = None, Rule51: "smif_constraints_Rule" = None, Rule: "smif_constraints_Rule" = None):
        self.coerce = coerce
...
class smif_identifiers_TextIdentifier(Identifier):
    ...
    def __init__(self, value: str, Identifier: "smif_toplevel_IdentifiableEntity" = None, Identifier73: "smif_toplevel_IdentifiableEntity" = None):
        self.value = value
...
class smif_values_UnitType(ValueType):
    ...
    def __init__(self, ratio: str, offset: str, symbol: str, smif_values_UnitType: "Definition" = None, unitOfSystem: "SystemOfUnits" = None, ValueType173: "smif_metadata_Statement" = None, ValueType176: "smif_metadata_Statement" = None, ValueType: "smif_metadata_Statement" = None):
        self.ratio = ratio
        self.offset = offset
        self.symbol = symbol
...
class smif_patterns_Pattern(lexicalscope_LexicalScope, situations_SituationType, situations_Situation, properties_PropertyOwner):
    ...
    pass
class smif_situations_Situation(lexicalscope_LexicalScope, toplevel_TemporalEntity, toplevel_Context, toplevel_Proposition):
