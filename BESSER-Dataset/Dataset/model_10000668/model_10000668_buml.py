...
customer.attributes={customer_product_id, customer_email_id, customer_address, customer_name}
...
monitor_complaint.attributes={monitor_complaint_complaintid, monitor_complaint_complaint_type, monitor_complaint_date}
...
D_B_details.attributes={D_B_details_session_out, D_B_details_logged_in}
...
# Customer class attributes and methods
Customer_userid: Property = Property(name="userid", type=IntegerType)
Customer_name: Property = Property(name="name", type=StringType)
Customer_password: Property = Property(name="password", type=StringType)
Customer.attributes={Customer_password, Customer_name, Customer_userid}

# MonitorComplaint class attributes and methods
MonitorComplaint_complaintid: Property = Property(name="complaintid", type=IntegerType)
MonitorComplaint_date: Property = Property(name="date", type=DateType)
MonitorComplaint_complainttype: Property = Property(name="complainttype", type=StringType)
MonitorComplaint.attributes={MonitorComplaint_date, MonitorComplaint_complaintid, MonitorComplaint_complainttype}

# RegisterComplaint class attributes and methods
RegisterComplaint_complainttype: Property = Property(name="complainttype", type=StringType)
RegisterComplaint_description: Property = Property(name="description", type=StringType)
RegisterComplaint.attributes={RegisterComplaint_complainttype, RegisterComplaint_description}
...
UpdateStatus_isupdated: Property = Property(name="isupdated", type=BooleanType)
UpdateStatus.attributes={UpdateStatus_isupdated}

# Logout class attributes and methods
Logout_sessionout: Property = Property(name="sessionout", type=IntegerType)
Logout.attributes={Logout_sessionout}

# CheckStatus class attributes and methods
CheckStatus_complaintid: Property = Property(name="complaintid", type=StringType)
CheckStatus.attributes={CheckStatus_complaintid}

# DBDetails class attributes and methods
DBDetails_isloggedin: Property = Property(name="isloggedin", type=BooleanType)
DBDetails_iIssessionout: Property = Property(name="iIssessionout", type=BooleanType)
DBDetails.attributes={DBDetails_iIssessionout, DBDetails_isloggedin}
...
domain_model = DomainModel(
    name="_536cd263_d816_4768_8c07_b0e6280ff4c9",
    types={search_user_UseCase, technical_team_Actor, login_technical_UseCase, new_complaint_details_UseCase, find_out_fault_UseCase, send_to_admin_UseCase, logout_technician_UseCase, customer, monitor_complaint, administrator, update_status, register_complaint, check_status, logout, D_B_details, login, Customer, MonitorComplaint, RegisterComplaint, Administrator, UpdateStatus, Logout, CheckStatus, DBDetails, Login, login_UseCase, client_Actor, register_complaint_UseCase, view_status_UseCase, logout_UseCase, administrator_Actor, create_user_UseCase},
    associations={administrator_logout, administrator_create_user, administrator_search_user, technical_team_login_technical, technical_team_new_complaint_details, technical_team_find_out_fault, technical_team_send_to_admin, technical_team_logout_technician, client_register_complaint, client_login, client_view_status, client_logout, administrator_login},
    generalizations={},
    metadata=None
)
