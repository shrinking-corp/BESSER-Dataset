...
# Classes
comicBookCollection2_ComicBookCollection = Class(name="comicBookCollection2_ComicBookCollection")
comicBookCollection2_Book = Class(name="comicBookCollection2_Book")
comicBookCollection2_Artist = Class(name="comicBookCollection2_Artist")
comicBookCollection2_Editor = Class(name="comicBookCollection2_Editor")
comicBookCollection2_Writer = Class(name="comicBookCollection2_Writer")
comicBookCollection2_Publisher = Class(name="comicBookCollection2_Publisher")
comicBookCollection2_Series = Class(name="comicBookCollection2_Series")
...
domain_model = DomainModel(
    ...
    types={comicBookCollection2_ComicBookCollection, comicBookCollection2_Book, comicBookCollection2_Artist, comicBookCollection2_Editor, comicBookCollection2_Writer, comicBookCollection2_Publisher, comicBookCollection2_Series},
    associations={books0, artists1, editors3, writers5, publishingCompanies7, series9, booksPublished11, editors15, writers16, coverArtist17, publisher19, seriesPartOf20, booksArtistFor21, booksCoverArtistFor23, booksEditorFor25, booksWriterFor27, booksInSeries12, artists14},
    generalizations={},
    metadata=None
)
