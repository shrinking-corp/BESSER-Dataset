...
# Classes
Friends_Person = Class(name="Friends_Person", is_abstract=True)
Friends_Classroom = Class(name="Friends_Classroom")
Friends_Man = Class(name="Friends_Man")
Person = Class(name="Person")
Friends_Woman = Class(name="Friends_Woman")
