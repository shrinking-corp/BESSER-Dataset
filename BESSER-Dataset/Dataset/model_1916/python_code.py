...
class mancoosimm_MimeType:
    ...
    def __init__(self, name: str, extension: str, type: set["mancoosimm_MimeTypeHandler"] = None, mimeTypes: "mancoosimm_MimeTypeHandlerCache" = None, MimeType: "mancoosimm_MimeTypeHandlerCache" = None, MimeType206: "mancoosimm_MimeTypeHandler" = None):
        self.name = name
...
class mancoosimm_ModuleCache:
    ...
    def __init__(self, version: str, ModuleCache: "mancoosimm_Environment" = None, ModuleCache237: "mancoosimm_Module" = None, moduleCache: set["mancoosimm_Module"] = None, moduleCache232: "mancoosimm_Environment" = None):
        self.version = version
...
class mancoosimm_UnpackedPackage(Package):
    ...
    def __init__(self, maintainer: str, checkSum: str, description: str, section: str, tag: str, priority: str, uploaders: str, mancoosimm_UnpackedPackage: "mancoosimm_Configuration" = None, mancoosimm_UnpackedPackage45: set["mancoosimm_File"] = None):
...
class mancoosimm_File(NamedElement):
    ...
    def __init__(self, extension: str, description: str, size: int, checkSum: str, isDirectory: bool, suid: bool, guid: bool, permission: str, location: str, isMissing: bool, mancoosimm_File: "mancoosimm_InstalledPackage" = None, mancoosimm_File131: "mancoosimm_FileSystem" = None, mancoosimm_File46: "mancoosimm_UnpackedPackage" = None, mancoosimm_File193: "mancoosimm_IconCache" = None, mancoosimm_File133: "mancoosimm_GConf" = None, mancoosimm_File136: "mancoosimm_GConf" = None, File: "mancoosimm_FileSystem" = None, mancoosimm_File150: "mancoosimm_MenuEntry" = None, mancoosimm_File157: "mancoosimm_Service" = None, mancoosimm_File179: "mancoosimm_Alternative" = None, root: "mancoosimm_FileSystem" = None, File164: "mancoosimm_File" = None, parent: set["mancoosimm_File"] = None, File167: "mancoosimm_File" = None, childs: "mancoosimm_File" = None, mancoosimm_File169: "mancoosimm_User" = None, mancoosimm_File171: "mancoosimm_Group" = None, files: set["mancoosimm_PackageSetting"] = None, mancoosimm_File176: "mancoosimm_Alternative" = None, File185: "mancoosimm_PackageSetting" = None, mancoosimm_File197: "mancoosimm_DesktopDB" = None, mancoosimm_File204: "mancoosimm_MimeTypeHandler" = None, mancoosimm_File235: "mancoosimm_Module" = None, mancoosimm_File219: "mancoosimm_XFont" = None, mancoosimm_File221: "mancoosimm_LibraryCache" = None, mancoosimm_File227: "mancoosimm_SharedLibrary" = None, mancoosimm_File267: "mancoosimm_User" = None, mancoosimm_File243: "mancoosimm_SGMLDocument" = None, mancoosimm_File246: "mancoosimm_SGMLDocument" = None, mancoosimm_File252: "mancoosimm_SkeeperDocument" = None, mancoosimm_File255: "mancoosimm_SkeeperDocument" = None, mancoosimm_File257: "mancoosimm_EmacsPackage" = None):
        self.extension = extension
        self.description = description
        self.size = size
        self.checkSum = checkSum
...
class mancoosimm_Configuration(NamedElement):
    ...
    def __init__(self, creationTime: str, systemType: str, mancoosimm_Configuration7: set["mancoosimm_ConfigFilesPackage"] = None, mancoosimm_Configuration9: set["mancoosimm_UnpackedPackage"] = None, mancoosimm_Configuration11: set["mancoosimm_HalfConfiguredPackage"] = None, mancoosimm_Configuration13: set["mancoosimm_HalfInstalledPackage"] = None, mancoosimm_Configuration15: "mancoosimm_Package" = None, configuration: "mancoosimm_FileSystem" = None, configuration2: "mancoosimm_Environment" = None, mancoosimm_Configuration: set["mancoosimm_InstalledPackage"] = None, mancoosimm_Configuration5: set["mancoosimm_NotInstalledPackage"] = None, Configuration: "mancoosimm_Environment" = None, Configuration129: "mancoosimm_FileSystem" = None):
...
class mancoosimm_Package(NamedElement):
    ...
    def __init__(self, version: str, architecture: str, pkg: "mancoosimm_PackageSetting" = None, mancoosimm_Package: "mancoosimm_Configuration" = None, mancoosimm_Package65: "mancoosimm_Dependence" = None, Package: "mancoosimm_PackageSetting" = None, mancoosimm_Package281: "mancoosimm_Conflict" = None):
        self.version = version
