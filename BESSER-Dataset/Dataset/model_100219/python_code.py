...
class HTML_APPLET:
    ...
    def __init__(self, height: str, applet: str, class_: str, src: str, align: str, width: str):
        self.height = height
        self.applet = applet
        self.class_ = class_
        self.src = src
...
class HTML_INPUT:
    ...
    def __init__(self, name: str, align: str, maxlength: str, size: str, checked: str, src: str, inputValue: str, type: str):
        self.name = name
        self.align = align
...
class HTML_IMG(BODYElement):
    ...
    def __init__(self, width: str, src: str, height: str, alt: str, align: str, vspace: str, hspace: str, ismap: str, usemap: str, border: str, BODYElement: "HTML_BODY" = None):
        self.width = width
        self.src = src
        self.height = height
        self.alt = alt
...
class HTML_EMBED(BODYElement):
    ...
    def __init__(self, height: str, align: str, src: str, width: str, vspace: str, hspace: str, border: str, BODYElement: "HTML_BODY" = None):
        self.height = height
        self.align = align
        self.src = src
        self.width = width
...
class HTML_BODY(HTMLElement):
    ...
    def __init__(self, background: str, bgcolor: str, text: str, link: str, alink: str, vlink: str, body: set["BODYElement"] = None, body13: "HTML" = None, HTMLElement5: "HTML_HTMLElement" = None, HTMLElement: "HTML_HTMLElement" = None):
        self.background = background
        self.bgcolor = bgcolor
        self.text = text
        self.link = link
