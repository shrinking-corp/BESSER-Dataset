...
def test_assoc_examController6_link_reassign_clear():
    a = AssistantMVC_View(fontColor="sample_text", fontName="sample_text")
    b1 = AssistantMVC_ExamController()
    b2 = AssistantMVC_ExamController()
    _safe_set(a, 'AssistantMVC_View7', b1)
    assert _is_linked(a, 'AssistantMVC_View7', b1)
    if hasattr(b1, 'AssistantMVC_ExamController'):
        assert _is_linked(b1, 'AssistantMVC_ExamController', a)
    _safe_set(a, 'AssistantMVC_View7', b2)
    assert _is_linked(a, 'AssistantMVC_View7', b2)
    if hasattr(b1, 'AssistantMVC_ExamController'):
        assert not _is_linked(b1, 'AssistantMVC_ExamController', a)
    if hasattr(b2, 'AssistantMVC_ExamController'):
        assert _is_linked(b2, 'AssistantMVC_ExamController', a)
    _safe_set(a, 'AssistantMVC_View7', None)
    assert not _is_linked(a, 'AssistantMVC_View7', b2)
    if hasattr(b2, 'AssistantMVC_ExamController'):
        assert not _is_linked(b2, 'AssistantMVC_ExamController', a)


def test_assoc_examItemController8_link_reassign_clear():
    a = AssistantMVC_View(fontColor="sample_text", fontName="sample_text")
    b1 = AssistantMVC_ExamItemController()
    b2 = AssistantMVC_ExamItemController()
    _safe_set(a, 'AssistantMVC_View9', b1)
    assert _is_linked(a, 'AssistantMVC_View9', b1)
    if hasattr(b1, 'AssistantMVC_ExamItemController'):
        assert _is_linked(b1, 'AssistantMVC_ExamItemController', a)
    _safe_set(a, 'AssistantMVC_View9', b2)
    assert _is_linked(a, 'AssistantMVC_View9', b2)
    if hasattr(b1, 'AssistantMVC_ExamItemController'):
        assert not _is_linked(b1, 'AssistantMVC_ExamItemController', a)
    if hasattr(b2, 'AssistantMVC_ExamItemController'):
        assert _is_linked(b2, 'AssistantMVC_ExamItemController', a)
    _safe_set(a, 'AssistantMVC_View9', None)
    assert not _is_linked(a, 'AssistantMVC_View9', b2)
    if hasattr(b2, 'AssistantMVC_ExamItemController'):
        assert not _is_linked(b2, 'AssistantMVC_ExamItemController', a)
