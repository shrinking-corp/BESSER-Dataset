...
# Classes
umltordbms_PrimitiveToName = Class(name="umltordbms_PrimitiveToName")
umltordbms_AssociationToForeignKey = Class(name="umltordbms_AssociationToForeignKey")
umltordbms_ClassToTable = Class(name="umltordbms_ClassToTable")
umltordbms_Association = Class(name="umltordbms_Association")
umltordbms_ForeignKey = Class(name="umltordbms_ForeignKey")
FromAttributeOwner = Class(name="FromAttributeOwner")
umltordbms_PackageToSchema = Class(name="umltordbms_PackageToSchema")
umltordbms_Class = Class(name="umltordbms_Class")
umltordbms_Table = Class(name="umltordbms_Table")
umltordbms_Key = Class(name="umltordbms_Key")
umltordbms_FromAttribute = Class(name="umltordbms_FromAttribute", is_abstract=True)
umltordbms_NonLeafAttribute = Class(name="umltordbms_NonLeafAttribute")
umltordbms_AttributeToColumn = Class(name="umltordbms_AttributeToColumn")
FromAttribute = Class(name="FromAttribute")
ToColumn = Class(name="ToColumn")
umltordbms_Package = Class(name="umltordbms_Package")
umltordbms_Schema = Class(name="umltordbms_Schema")
umltordbms_PrimitiveDataType = Class(name="umltordbms_PrimitiveDataType")
umltordbms_ToColumn = Class(name="umltordbms_ToColumn")
umltordbms_Column = Class(name="umltordbms_Column")
umltordbms_FromAttributeOwner = Class(name="umltordbms_FromAttributeOwner", is_abstract=True)
umltordbms_Attribute = Class(name="umltordbms_Attribute")
...
umltordbms_FromAttribute.attributes={umltordbms_FromAttribute_name, umltordbms_FromAttribute_kind}
...
domain_model = DomainModel(
    name="umltordbms",
    types={umltordbms_PrimitiveToName, umltordbms_AssociationToForeignKey, umltordbms_ClassToTable, umltordbms_Association, umltordbms_ForeignKey, FromAttributeOwner, umltordbms_PackageToSchema, umltordbms_Class, umltordbms_Table, umltordbms_Key, umltordbms_FromAttribute, umltordbms_NonLeafAttribute, umltordbms_AttributeToColumn, FromAttribute, ToColumn, umltordbms_Package, umltordbms_Schema, umltordbms_PrimitiveDataType, umltordbms_ToColumn, umltordbms_Column, umltordbms_FromAttributeOwner, umltordbms_Attribute},
    associations={type0, referenced1, owner2, association3, foreignKey5, owner7, associationsToForeignKeys8, umlClass9, table11, primaryKey13, classesToTables22, primitivesToNames25, umlPackage27, schema28, owner30, primitive32, column34, owner15, leafs16, attribute18, fromAttributes20},
    generalizations={gen_umltordbms_AssociationToForeignKey_ToColumn, gen_umltordbms_ClassToTable_FromAttributeOwner, gen_umltordbms_ClassToTable_ToColumn, gen_umltordbms_NonLeafAttribute_FromAttributeOwner, gen_umltordbms_NonLeafAttribute_FromAttribute, gen_umltordbms_AttributeToColumn_FromAttribute, gen_umltordbms_AttributeToColumn_ToColumn},
    metadata=None
)
