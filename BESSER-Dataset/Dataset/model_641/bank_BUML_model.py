...
# Classes
BankingSystem_Bank = Class(name="BankingSystem_Bank")
BankingSystem_Branch = Class(name="BankingSystem_Branch")
BankingSystem_Customer = Class(name="BankingSystem_Customer")
BankingSystem_Employee = Class(name="BankingSystem_Employee", is_abstract=True)
BankingSystem_Account = Class(name="BankingSystem_Account", is_abstract=True)
BankingSystem_Loan = Class(name="BankingSystem_Loan")
BankingSystem_Financial_Representative = Class(name="BankingSystem_Financial_Representative")
BankingSystem_Chequing = Class(name="BankingSystem_Chequing")
Account = Class(name="Account")
BankingSystem_Saving = Class(name="BankingSystem_Saving")
...
BankingSystem_Bank.attributes={BankingSystem_Bank_bankId, BankingSystem_Bank_name, BankingSystem_Bank_description}
...
BankingSystem_Branch.attributes={BankingSystem_Branch_phoneNumber, BankingSystem_Branch_branchId, BankingSystem_Branch_location, BankingSystem_Branch_name}
...
BankingSystem_Customer.attributes={BankingSystem_Customer_phoneNumber, BankingSystem_Customer_customerType, BankingSystem_Customer_age, BankingSystem_Customer_name, BankingSystem_Customer_address}
...
BankingSystem_Employee.attributes={BankingSystem_Employee_eid, BankingSystem_Employee_ename, BankingSystem_Employee_ephoneNumber, BankingSystem_Employee_eage, BankingSystem_Employee_isCustomer, BankingSystem_Employee_eaddress}
...
BankingSystem_Loan.attributes={BankingSystem_Loan_amount, BankingSystem_Loan_duration, BankingSystem_Loan_interestRate, BankingSystem_Loan_loanNumber}
...
domain_model = DomainModel(
    name="BankingSystem",
    types={BankingSystem_Bank, BankingSystem_Branch, BankingSystem_Customer, BankingSystem_Employee, BankingSystem_Account, BankingSystem_Loan, BankingSystem_Financial_Representative, BankingSystem_Chequing, Account, BankingSystem_Saving, Employee, CustomerType},
    associations={branches0, customers1, employees2, bank4, branch5, accounts7, loans8, representative10, customer11, customer15, a17, branch13},
