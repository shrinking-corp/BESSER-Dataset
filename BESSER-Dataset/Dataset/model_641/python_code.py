...
class BankingSystem_Loan:
    ...
    def __init__(self, loanNumber: str, amount: float, interestRate: float, duration: int, loans: "BankingSystem_Customer" = None, Loan: "BankingSystem_Customer" = None):
...
class BankingSystem_Employee(ABC):
    ...
    def __init__(self, isCustomer: bool, eage: int, eaddress: str, ephoneNumber: str, eid: int, ename: str, employees: "BankingSystem_Branch" = None, Employee: "BankingSystem_Branch" = None):
...
class BankingSystem_Customer:
    ...
    def __init__(self, name: str, age: int, address: str, phoneNumber: str, customerType: str, Customer16: "BankingSystem_Loan" = None, Customer18: "BankingSystem_Financial_Representative" = None, Customer: "BankingSystem_Branch" = None, customers: "BankingSystem_Branch" = None, customer: set["BankingSystem_Account"] = None, customer9: set["BankingSystem_Loan"] = None, a: set["BankingSystem_Financial_Representative"] = None, Customer12: "BankingSystem_Account" = None):
        self.name = name
        self.age = age
...
class BankingSystem_Branch:
    ...
    def __init__(self, name: str, branchId: int, location: str, phoneNumber: str, Branch14: "BankingSystem_Employee" = None, Branch: "BankingSystem_Bank" = None, branch: set["BankingSystem_Customer"] = None, branch3: set["BankingSystem_Employee"] = None, branches: "BankingSystem_Bank" = None, Branch6: "BankingSystem_Customer" = None):
        self.name = name
...
class BankingSystem_Bank:
    ...
    def __init__(self, name: str, bankId: int, description: str, bank: set["BankingSystem_Branch"] = None, Bank: "BankingSystem_Branch" = None):
        self.name = name
        self.bankId = bankId
