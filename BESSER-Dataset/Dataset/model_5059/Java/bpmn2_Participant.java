...
public class bpmn2_Participant extends BaseElement, InteractionNode {
    ...
    private bpmn2_ParticipantMultiplicity bpmn2_participantmultiplicity;
    ...
    public bpmn2_ParticipantMultiplicity getBpmn2_participantmultiplicity() {
        return bpmn2_participantmultiplicity;
    }

    public void setBpmn2_participantmultiplicity(bpmn2_ParticipantMultiplicity bpmn2_participantmultiplicity) {
        this.bpmn2_participantmultiplicity = bpmn2_participantmultiplicity;
    }
