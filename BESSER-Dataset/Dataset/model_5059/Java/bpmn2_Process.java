...
public class bpmn2_Process extends CallableElement, FlowElementsContainer {
    ...
    public bpmn2_Process(
        String processType,        boolean isClosed,        boolean isExecutable        ArrayList<bpmn2_Artifact> bpmn2_artifacts,        ArrayList<bpmn2_CorrelationSubscription> bpmn2_correlationsubscriptions,        ArrayList<bpmn2_ResourceRole> bpmn2_resourceroles    ) {
        this.processType = processType;
        this.isClosed = isClosed;
        this.isExecutable = isExecutable;
