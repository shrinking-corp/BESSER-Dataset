...
# Classes
ca_rule_Rule = Class(name="ca_rule_Rule")
ca_rule_IntegerExpression = Class(name="ca_rule_IntegerExpression")
ca_rule_PopulationRange = Class(name="ca_rule_PopulationRange")
ca_rule_Max = Class(name="ca_rule_Max")
NeighborsExpression = Class(name="NeighborsExpression")
ca_rule_Add = Class(name="ca_rule_Add")
BinaryExpression = Class(name="BinaryExpression")
ca_rule_UnaryExpression = Class(name="ca_rule_UnaryExpression")
IntegerExpression = Class(name="IntegerExpression")
ca_rule_And = Class(name="ca_rule_And")
ca_rule_Or = Class(name="ca_rule_Or")
ca_rule_Not = Class(name="ca_rule_Not")
UnaryExpression = Class(name="UnaryExpression")
ca_rule_Greater = Class(name="ca_rule_Greater")
ca_rule_Lower = Class(name="ca_rule_Lower")
ca_rule_IntegerLiteral = Class(name="ca_rule_IntegerLiteral")
ca_rule_Conditional = Class(name="ca_rule_Conditional")
ca_rule_CurrentCellPopulation = Class(name="ca_rule_CurrentCellPopulation")
ca_rule_Size = Class(name="ca_rule_Size")
ca_rule_NeighborsExpression = Class(name="ca_rule_NeighborsExpression")
ca_rule_Min = Class(name="ca_rule_Min")
ca_rule_BinaryExpression = Class(name="ca_rule_BinaryExpression")
ca_rule_Mult = Class(name="ca_rule_Mult")
ca_rule_Div = Class(name="ca_rule_Div")
ca_rule_Sum = Class(name="ca_rule_Sum")
ca_rule_CellularAutomata = Class(name="ca_rule_CellularAutomata")
ca_rule_Mod = Class(name="ca_rule_Mod")
ca_rule_UMinus = Class(name="ca_rule_UMinus")
ca_rule_Minus = Class(name="ca_rule_Minus")
ca_rule_Equal = Class(name="ca_rule_Equal")
...
domain_model = DomainModel(
    name="ca_rule",
    types={ca_rule_Rule, ca_rule_IntegerExpression, ca_rule_PopulationRange, ca_rule_Max, NeighborsExpression, ca_rule_Add, BinaryExpression, ca_rule_UnaryExpression, IntegerExpression, ca_rule_And, ca_rule_Or, ca_rule_Not, UnaryExpression, ca_rule_Greater, ca_rule_Lower, ca_rule_IntegerLiteral, ca_rule_Conditional, ca_rule_CurrentCellPopulation, ca_rule_Size, ca_rule_NeighborsExpression, ca_rule_Min, ca_rule_BinaryExpression, ca_rule_Mult, ca_rule_Div, ca_rule_Sum, ca_rule_CellularAutomata, ca_rule_Mod, ca_rule_UMinus, ca_rule_Minus, ca_rule_Equal},
    associations={nextValue0, filter1, target3, ifTrueExpression5, ifFalseExpression7, condition10, neighborsFilter13, left15, right17, rules20},
    generalizations={gen_ca_rule_Max_NeighborsExpression, gen_ca_rule_Add_BinaryExpression, gen_ca_rule_UnaryExpression_IntegerExpression, gen_ca_rule_And_BinaryExpression, gen_ca_rule_Or_BinaryExpression, gen_ca_rule_Not_UnaryExpression, gen_ca_rule_Greater_BinaryExpression, gen_ca_rule_Lower_BinaryExpression, gen_ca_rule_IntegerLiteral_IntegerExpression, gen_ca_rule_Conditional_IntegerExpression, gen_ca_rule_CurrentCellPopulation_IntegerExpression, gen_ca_rule_Size_NeighborsExpression, gen_ca_rule_NeighborsExpression_IntegerExpression, gen_ca_rule_Min_NeighborsExpression, gen_ca_rule_BinaryExpression_IntegerExpression, gen_ca_rule_Mult_BinaryExpression, gen_ca_rule_Div_BinaryExpression, gen_ca_rule_Sum_NeighborsExpression, gen_ca_rule_Mod_BinaryExpression, gen_ca_rule_UMinus_UnaryExpression, gen_ca_rule_Minus_BinaryExpression, gen_ca_rule_Equal_BinaryExpression},
    metadata=None
)
