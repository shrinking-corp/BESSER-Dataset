...
class ast_EqualityExpression(Expression):
    ...
    def __init__(self, operator: str, ast_EqualityExpression138: "ast_Expression" = None, ast_EqualityExpression: "ast_Expression" = None):
        self.operator = operator
...
class ast_IterationCall(Expression):
    ...
    def __init__(self, identifier: str, ast_IterationCall95: "ast_Expression" = None, ast_IterationCall98: "ast_Expression" = None, ast_IterationCall: "ast_Expression" = None, ast_IterationCall91: set["ast_IterationVariable"] = None, ast_IterationCall93: "ast_IterationAccumulator" = None):
...
class ast_MultiplicativeExpression(Expression):
    ...
    def __init__(self, operator: str, ast_MultiplicativeExpression158: "ast_Expression" = None, ast_MultiplicativeExpression: "ast_Expression" = None):
        self.operator = operator
...
class ast_Equation:
    ...
    def __init__(self, initial: bool, ast_Equation: "ast_FunctionDefinition" = None, ast_Equation44: "ast_Expression" = None, ast_Equation41: "ast_Expression" = None):
