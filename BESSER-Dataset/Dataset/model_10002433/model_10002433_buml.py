...
Person.attributes={Person_password_, Person_phone_, Person_id_, Person_name_}
...
Book_a_ticek.attributes={Book_a_ticek_ticket_id_, Book_a_ticek_destination_city, Book_a_ticek_time_, Book_a_ticek_date_, Book_a_ticek_starting_city_}
...
Submit_information.attributes={Submit_information_name_, Submit_information_username, Submit_information_phone_, Submit_information_password_}
...
domain_model = DomainModel(
    name="b321b95a_caac_4f56_ad4e_b9302a28b690",
    types={ticket_printing_UseCase, view_seat_UseCase, send_message_to_number_registered_UseCase, exciting_package_UseCase, book_a_ticket_UseCase, changing_seats_by_admin_UseCase, payment_UseCase, submit_information_UseCase, cancle_UseCase, cancle_with_driver_UseCase, return_the_money_to_the_customer_UseCase, logout_UseCase, remove_user_UseCase, driver_planing_UseCase, enter_password_UseCase, Person, Driver, Admin, User, Login, view_item, Pay, Book_a_ticek, Userguest, Submit_information, Cancle, user_Actor, guest_user_Actor, driver_Actor, admin_Actor, login_UseCase, enter_user_name_UseCase, view_item_UseCase, captcha_UseCase, browse_item_UseCase, search_item__UseCase},
    associations={Book_a_ticek_Pay, Book_a_ticek_Cancle, Submit_information_Userguest, Userguest_view_item, user_login, guest_user_view_item, guest_user_submit_information, admin_login, driver_login, Person_Login, Login_view_item, Driver_User},
    generalizations={},
    metadata=None
)
