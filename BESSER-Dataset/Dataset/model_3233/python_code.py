...
class ecdarText_ETParameter:
    ...
    def __init__(self, name: str, ioType: str, ecdarText_ETParameter59: "ecdarText_ETType" = None, ecdarText_ETParameter: "ecdarText_ETSpecificationTemplate" = None, ecdarText_ETParameter62: set["ecdarText_ETArrayDeclaration"] = None):
        self.name = name
        self.ioType = ioType
