...
# Classes
ecdarText_ETDeclarations = Class(name="ecdarText_ETDeclarations")
ecdarText_ETSpecification = Class(name="ecdarText_ETSpecification")
ecdarText_ETFile = Class(name="ecdarText_ETFile")
ecdarText_ETImport = Class(name="ecdarText_ETImport")
ecdarText_ETTypeDeclaration = Class(name="ecdarText_ETTypeDeclaration")
ecdarText_ETTypeID = Class(name="ecdarText_ETTypeID")
ecdarText_ETArrayDeclaration = Class(name="ecdarText_ETArrayDeclaration")
ecdarText_ETExpression = Class(name="ecdarText_ETExpression")
ecdarText_ETDeclaration = Class(name="ecdarText_ETDeclaration")
ecdarText_ETType = Class(name="ecdarText_ETType")
ecdarText_ETTypeModifiers = Class(name="ecdarText_ETTypeModifiers")
ecdarText_ETTypeIdentifier = Class(name="ecdarText_ETTypeIdentifier")
ecdarText_ETVariableDeclaration = Class(name="ecdarText_ETVariableDeclaration")
ETDeclaration = Class(name="ETDeclaration")
ecdarText_ETVariableID = Class(name="ecdarText_ETVariableID")
ecdarText_ETInitialiser = Class(name="ecdarText_ETInitialiser")
ecdarText_ETSingleInitialiser = Class(name="ecdarText_ETSingleInitialiser")
ETInitialiser = Class(name="ETInitialiser")
ecdarText_ETMultiInitialiser = Class(name="ecdarText_ETMultiInitialiser")
ecdarText_ETIntegerType = Class(name="ecdarText_ETIntegerType")
ETTypeIdentifier = Class(name="ETTypeIdentifier")
ecdarText_ETClockType = Class(name="ecdarText_ETClockType")
ecdarText_ETActionType = Class(name="ecdarText_ETActionType")
ecdarText_ETInputType = Class(name="ecdarText_ETInputType")
ETActionType = Class(name="ETActionType")
ecdarText_ETOutputType = Class(name="ecdarText_ETOutputType")
ecdarText_ETBooleanType = Class(name="ecdarText_ETBooleanType")
ecdarText_ETScalarType = Class(name="ecdarText_ETScalarType")
ecdarText_ETStructType = Class(name="ecdarText_ETStructType")
ecdarText_ETFieldDeclaration = Class(name="ecdarText_ETFieldDeclaration")
ecdarText_ETFieldID = Class(name="ecdarText_ETFieldID")
ecdarText_ETSpecificationExpression = Class(name="ecdarText_ETSpecificationExpression")
ecdarText_ETSpecificationBinding = Class(name="ecdarText_ETSpecificationBinding")
ETSpecification = Class(name="ETSpecification")
ecdarText_ETSpecificationDefinition = Class(name="ecdarText_ETSpecificationDefinition")
ecdarText_ETSpecificationBody = Class(name="ecdarText_ETSpecificationBody")
ecdarText_ETSpecificationTemplate = Class(name="ecdarText_ETSpecificationTemplate")
ETSpecificationDefinition = Class(name="ETSpecificationDefinition")
ecdarText_ETParameter = Class(name="ecdarText_ETParameter")
ecdarText_ETLocation = Class(name="ecdarText_ETLocation")
ecdarText_ETSpecificationCompositionExpression = Class(name="ecdarText_ETSpecificationCompositionExpression")
ecdarText_ETEdge = Class(name="ecdarText_ETEdge")
ecdarText_ETSelect = Class(name="ecdarText_ETSelect")
ecdarText_ETIO = Class(name="ecdarText_ETIO")
ecdarText_ETTypeReference = Class(name="ecdarText_ETTypeReference")
ecdarText_ETSpecificationDisjunctionExpression = Class(name="ecdarText_ETSpecificationDisjunctionExpression")
ETSpecificationExpression = Class(name="ETSpecificationExpression")
ecdarText_ETSpecificationConjunctionExpression = Class(name="ecdarText_ETSpecificationConjunctionExpression")
ecdarText_ETSubtractionAssignmentExpression = Class(name="ecdarText_ETSubtractionAssignmentExpression")
ecdarText_ETSpecificationReference = Class(name="ecdarText_ETSpecificationReference")
ecdarText_ETSpecificationInstantiation = Class(name="ecdarText_ETSpecificationInstantiation")
ecdarText_ETForallExpression = Class(name="ecdarText_ETForallExpression")
ETExpression = Class(name="ETExpression")
ecdarText_ETExistsExpression = Class(name="ecdarText_ETExistsExpression")
ecdarText_ETImplyExpression = Class(name="ecdarText_ETImplyExpression")
ecdarText_ETLogicOrExpression = Class(name="ecdarText_ETLogicOrExpression")
ecdarText_ETLogicAndExpression = Class(name="ecdarText_ETLogicAndExpression")
ecdarText_ETAssignmentExpression = Class(name="ecdarText_ETAssignmentExpression")
ecdarText_ETAdditionAssignmentExpression = Class(name="ecdarText_ETAdditionAssignmentExpression")
ecdarText_ETBitLeftAssignmentExpression = Class(name="ecdarText_ETBitLeftAssignmentExpression")
ecdarText_ETMultiplicationAssignmentExpression = Class(name="ecdarText_ETMultiplicationAssignmentExpression")
ecdarText_ETDivisionAssignmentExpression = Class(name="ecdarText_ETDivisionAssignmentExpression")
ecdarText_ETModuloAssignmentExpression = Class(name="ecdarText_ETModuloAssignmentExpression")
ecdarText_ETBitOrAssignmentExpression = Class(name="ecdarText_ETBitOrAssignmentExpression")
ecdarText_ETBitAndAssignmentExpression = Class(name="ecdarText_ETBitAndAssignmentExpression")
ecdarText_ETBitXORAssignmentExpression = Class(name="ecdarText_ETBitXORAssignmentExpression")
ecdarText_ETUnequalExpression = Class(name="ecdarText_ETUnequalExpression")
ecdarText_ETBitRightAssignmentExpression = Class(name="ecdarText_ETBitRightAssignmentExpression")
ecdarText_ETConditionalExpression = Class(name="ecdarText_ETConditionalExpression")
ecdarText_ETBitOrExpression = Class(name="ecdarText_ETBitOrExpression")
ecdarText_ETBitXORExpression = Class(name="ecdarText_ETBitXORExpression")
ecdarText_ETBitAndExpression = Class(name="ecdarText_ETBitAndExpression")
ecdarText_ETEqualExpression = Class(name="ecdarText_ETEqualExpression")
ecdarText_ETLessExpression = Class(name="ecdarText_ETLessExpression")
ecdarText_ETLessEqualExpression = Class(name="ecdarText_ETLessEqualExpression")
ecdarText_ETGreaterEqualExpression = Class(name="ecdarText_ETGreaterEqualExpression")
ecdarText_ETGreaterExpression = Class(name="ecdarText_ETGreaterExpression")
ecdarText_ETMinExpression = Class(name="ecdarText_ETMinExpression")
ecdarText_ETMaxExpression = Class(name="ecdarText_ETMaxExpression")
ecdarText_ETModuloExpression = Class(name="ecdarText_ETModuloExpression")
ecdarText_ETBitLeftExpression = Class(name="ecdarText_ETBitLeftExpression")
ecdarText_ETBitRightExpression = Class(name="ecdarText_ETBitRightExpression")
ecdarText_ETAddExpression = Class(name="ecdarText_ETAddExpression")
ecdarText_ETSubtractExpression = Class(name="ecdarText_ETSubtractExpression")
ecdarText_ETMultiplyExpression = Class(name="ecdarText_ETMultiplyExpression")
ecdarText_ETDivideExpression = Class(name="ecdarText_ETDivideExpression")
ecdarText_ETReference = Class(name="ecdarText_ETReference")
ecdarText_ETPreIncrementExpression = Class(name="ecdarText_ETPreIncrementExpression")
ecdarText_ETPreDecrementExpression = Class(name="ecdarText_ETPreDecrementExpression")
ecdarText_ETLogicNotExpression = Class(name="ecdarText_ETLogicNotExpression")
ecdarText_ETMinusExpression = Class(name="ecdarText_ETMinusExpression")
ecdarText_ETPostIncrementExpression = Class(name="ecdarText_ETPostIncrementExpression")
ecdarText_ETPostDecrementExpression = Class(name="ecdarText_ETPostDecrementExpression")
ecdarText_ETStructExpression = Class(name="ecdarText_ETStructExpression")
ecdarText_ETArrayExpression = Class(name="ecdarText_ETArrayExpression")
ecdarText_EObject = Class(name="ecdarText_EObject")
ecdarText_ETBooleanLiteral = Class(name="ecdarText_ETBooleanLiteral")
ecdarText_ETNumberLiteral = Class(name="ecdarText_ETNumberLiteral")
...
ecdarText_ETParameter.attributes={ecdarText_ETParameter_ioType, ecdarText_ETParameter_name}
...
ecdarText_ETLocation.attributes={ecdarText_ETLocation_universal, ecdarText_ETLocation_urgent, ecdarText_ETLocation_name}
...
else_197: BinaryAssociation = BinaryAssociation(
    name="else_197",
    ends={
...
domain_model = DomainModel(
    name="ecdarText",
    types={ecdarText_ETDeclarations, ecdarText_ETSpecification, ecdarText_ETFile, ecdarText_ETImport, ecdarText_ETTypeDeclaration, ecdarText_ETTypeID, ecdarText_ETArrayDeclaration, ecdarText_ETExpression, ecdarText_ETDeclaration, ecdarText_ETType, ecdarText_ETTypeModifiers, ecdarText_ETTypeIdentifier, ecdarText_ETVariableDeclaration, ETDeclaration, ecdarText_ETVariableID, ecdarText_ETInitialiser, ecdarText_ETSingleInitialiser, ETInitialiser, ecdarText_ETMultiInitialiser, ecdarText_ETIntegerType, ETTypeIdentifier, ecdarText_ETClockType, ecdarText_ETActionType, ecdarText_ETInputType, ETActionType, ecdarText_ETOutputType, ecdarText_ETBooleanType, ecdarText_ETScalarType, ecdarText_ETStructType, ecdarText_ETFieldDeclaration, ecdarText_ETFieldID, ecdarText_ETSpecificationExpression, ecdarText_ETSpecificationBinding, ETSpecification, ecdarText_ETSpecificationDefinition, ecdarText_ETSpecificationBody, ecdarText_ETSpecificationTemplate, ETSpecificationDefinition, ecdarText_ETParameter, ecdarText_ETLocation, ecdarText_ETSpecificationCompositionExpression, ecdarText_ETEdge, ecdarText_ETSelect, ecdarText_ETIO, ecdarText_ETTypeReference, ecdarText_ETSpecificationDisjunctionExpression, ETSpecificationExpression, ecdarText_ETSpecificationConjunctionExpression, ecdarText_ETSubtractionAssignmentExpression, ecdarText_ETSpecificationReference, ecdarText_ETSpecificationInstantiation, ecdarText_ETForallExpression, ETExpression, ecdarText_ETExistsExpression, ecdarText_ETImplyExpression, ecdarText_ETLogicOrExpression, ecdarText_ETLogicAndExpression, ecdarText_ETAssignmentExpression, ecdarText_ETAdditionAssignmentExpression, ecdarText_ETBitLeftAssignmentExpression, ecdarText_ETMultiplicationAssignmentExpression, ecdarText_ETDivisionAssignmentExpression, ecdarText_ETModuloAssignmentExpression, ecdarText_ETBitOrAssignmentExpression, ecdarText_ETBitAndAssignmentExpression, ecdarText_ETBitXORAssignmentExpression, ecdarText_ETUnequalExpression, ecdarText_ETBitRightAssignmentExpression, ecdarText_ETConditionalExpression, ecdarText_ETBitOrExpression, ecdarText_ETBitXORExpression, ecdarText_ETBitAndExpression, ecdarText_ETEqualExpression, ecdarText_ETLessExpression, ecdarText_ETLessEqualExpression, ecdarText_ETGreaterEqualExpression, ecdarText_ETGreaterExpression, ecdarText_ETMinExpression, ecdarText_ETMaxExpression, ecdarText_ETModuloExpression, ecdarText_ETBitLeftExpression, ecdarText_ETBitRightExpression, ecdarText_ETAddExpression, ecdarText_ETSubtractExpression, ecdarText_ETMultiplyExpression, ecdarText_ETDivideExpression, ecdarText_ETReference, ecdarText_ETPreIncrementExpression, ecdarText_ETPreDecrementExpression, ecdarText_ETLogicNotExpression, ecdarText_ETMinusExpression, ecdarText_ETPostIncrementExpression, ecdarText_ETPostDecrementExpression, ecdarText_ETStructExpression, ecdarText_ETArrayExpression, ecdarText_EObject, ecdarText_ETBooleanLiteral, ecdarText_ETNumberLiteral, ETIOType},
    associations={declarations1, specifications3, imports0, baseType24, types26, size5, declarations6, modifiers8, identifier9, type11, variables13, dimensions15, initialiser18, expression20, initialisers22, locations55, type58, dimensions28, min31, max33, size36, declarations38, type39, fields42, dimensions44, expression47, body48, parameters49, declarations50, initialLocation53, left100, right102, dimensions61, invariants64, edges67, selects69, io71, guard73, target76, updates79, expression82, type85, target88, left90, right92, left95, right97, left142, right144, specification105, template107, arguments109, type112, expression114, type117, expression119, left122, right124, left127, right129, left132, right134, left137, right139, right179, left182, left147, right149, left152, right154, left157, right159, left162, right164, left167, right169, left172, right174, left177, right217, right184, left187, right189, condition192, then194, else_197, left200, right202, left205, right207, left210, right212, left215, left220, right222, left225, right252, right227, left230, right232, left235, right237, left240, right242, left245, right247, left250, left285, left255, right257, left260, right262, left265, right267, left270, right272, left275, right277, left280, right282, right306, right287, expression290, expression292, expression294, expression296, expression298, expression300, left302, left304, target309},
    generalizations={gen_ecdarText_ETTypeDeclaration_ETDeclaration, gen_ecdarText_ETVariableDeclaration_ETDeclaration, gen_ecdarText_ETSingleInitialiser_ETInitialiser, gen_ecdarText_ETMultiInitialiser_ETInitialiser, gen_ecdarText_ETIntegerType_ETTypeIdentifier, gen_ecdarText_ETClockType_ETTypeIdentifier, gen_ecdarText_ETActionType_ETTypeIdentifier, gen_ecdarText_ETInputType_ETActionType, gen_ecdarText_ETOutputType_ETActionType, gen_ecdarText_ETBooleanType_ETTypeIdentifier, gen_ecdarText_ETScalarType_ETTypeIdentifier, gen_ecdarText_ETStructType_ETTypeIdentifier, gen_ecdarText_ETSpecificationBinding_ETSpecification, gen_ecdarText_ETSpecificationDefinition_ETSpecification, gen_ecdarText_ETSpecificationTemplate_ETSpecificationDefinition, gen_ecdarText_ETSpecificationCompositionExpression_ETSpecificationExpression, gen_ecdarText_ETTypeReference_ETTypeIdentifier, gen_ecdarText_ETSpecificationDisjunctionExpression_ETSpecificationExpression, gen_ecdarText_ETSpecificationConjunctionExpression_ETSpecificationExpression, gen_ecdarText_ETSpecificationReference_ETSpecificationExpression, gen_ecdarText_ETSpecificationInstantiation_ETSpecificationExpression, gen_ecdarText_ETForallExpression_ETExpression, gen_ecdarText_ETExistsExpression_ETExpression, gen_ecdarText_ETImplyExpression_ETExpression, gen_ecdarText_ETLogicOrExpression_ETExpression, gen_ecdarText_ETLogicAndExpression_ETExpression, gen_ecdarText_ETAssignmentExpression_ETExpression, gen_ecdarText_ETAdditionAssignmentExpression_ETExpression, gen_ecdarText_ETBitLeftAssignmentExpression_ETExpression, gen_ecdarText_ETSubtractionAssignmentExpression_ETExpression, gen_ecdarText_ETMultiplicationAssignmentExpression_ETExpression, gen_ecdarText_ETDivisionAssignmentExpression_ETExpression, gen_ecdarText_ETModuloAssignmentExpression_ETExpression, gen_ecdarText_ETBitOrAssignmentExpression_ETExpression, gen_ecdarText_ETBitAndAssignmentExpression_ETExpression, gen_ecdarText_ETBitXORAssignmentExpression_ETExpression, gen_ecdarText_ETUnequalExpression_ETExpression, gen_ecdarText_ETBitRightAssignmentExpression_ETExpression, gen_ecdarText_ETConditionalExpression_ETExpression, gen_ecdarText_ETBitOrExpression_ETExpression, gen_ecdarText_ETBitXORExpression_ETExpression, gen_ecdarText_ETBitAndExpression_ETExpression, gen_ecdarText_ETEqualExpression_ETExpression, gen_ecdarText_ETLessExpression_ETExpression, gen_ecdarText_ETLessEqualExpression_ETExpression, gen_ecdarText_ETGreaterEqualExpression_ETExpression, gen_ecdarText_ETGreaterExpression_ETExpression, gen_ecdarText_ETMinExpression_ETExpression, gen_ecdarText_ETMaxExpression_ETExpression, gen_ecdarText_ETModuloExpression_ETExpression, gen_ecdarText_ETBitLeftExpression_ETExpression, gen_ecdarText_ETBitRightExpression_ETExpression, gen_ecdarText_ETAddExpression_ETExpression, gen_ecdarText_ETSubtractExpression_ETExpression, gen_ecdarText_ETMultiplyExpression_ETExpression, gen_ecdarText_ETDivideExpression_ETExpression, gen_ecdarText_ETPreIncrementExpression_ETExpression, gen_ecdarText_ETPreDecrementExpression_ETExpression, gen_ecdarText_ETLogicNotExpression_ETExpression, gen_ecdarText_ETMinusExpression_ETExpression, gen_ecdarText_ETPostIncrementExpression_ETExpression, gen_ecdarText_ETPostDecrementExpression_ETExpression, gen_ecdarText_ETStructExpression_ETExpression, gen_ecdarText_ETArrayExpression_ETExpression, gen_ecdarText_ETReference_ETExpression, gen_ecdarText_ETBooleanLiteral_ETExpression, gen_ecdarText_ETNumberLiteral_ETExpression},
    metadata=None
)
