...
# Classes
helloworldext_GreetingMessage = Class(name="helloworldext_GreetingMessage")
helloworldext_Person = Class(name="helloworldext_Person")
helloworldext_Greeting = Class(name="helloworldext_Greeting")
