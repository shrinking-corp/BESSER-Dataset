...
class_ClassModel = Class(name="class_ClassModel")
...
domain_model = DomainModel(
    name="class",
    types={class_Classifier, NamedElt, class_NamedElt, class_DataType, Classifier, class_Class, class_Attribute, class_ClassModel},
