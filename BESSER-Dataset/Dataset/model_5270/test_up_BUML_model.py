...
# Classes
testup_AUp = Class(name="testup_AUp")
testup_B = Class(name="testup_B")
testup_D = Class(name="testup_D")
testup_E = Class(name="testup_E")
AUp = Class(name="AUp")
testup_F = Class(name="testup_F")
E = Class(name="E")
G = Class(name="G")
testup_G = Class(name="testup_G")
