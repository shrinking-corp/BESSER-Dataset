...
Student.attributes={Student_name, Student_reg_Num, Student_mail_ID}
...
Faculty.attributes={Faculty_mail_ID, Faculty_name, Faculty_emp_ID}
...
domain_model = DomainModel(
    name="_55247966_3423_4855_afef_0f81abdddd60",
    ...
    associations={Student_SignUp, Student_Login, Admin_Manage_Student___Faculty_List, Faculty_Admin, Teacher_SignUp, Teacher_Login, Teacher_Upload_Materials, Admin_View___Modify_the_Uploaded_Materials, Teacher_View___Modify_the_Uploaded_Materials, Student_View_The_Uploaded_Materials, Student_Post_Questions, Teacher_View_Questions_And_Post_Answers, Student_Logout, Teacher_Logout, Admin_Logout, Student_Faculty, Student_Admin},
    generalizations={},
    metadata=None
)
