...
class metrics_MetricAggregationRule(Rule):
    ...
    def __init__(self, intervalHint: str, period: str, metrics_MetricAggregationRule16: "metrics_MetricAggregationRules" = None, metrics_MetricAggregationRule: "metrics_EObject" = None):
        self.intervalHint = intervalHint
        self.period = period
...
class metrics_MetricSource(Base):
    ...
    def __init__(self, name: str, metrics_MetricSource23: "metrics_MetricRetentionRules" = None, metrics_MetricSource: "metrics_Addon" = None, metrics_MetricSource20: "metrics_MetricAggregationRules" = None):
        self.name = name
