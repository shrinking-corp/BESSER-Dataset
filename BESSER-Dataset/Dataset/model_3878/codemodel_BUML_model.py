...
# Classes
codemodel_CMElement = Class(name="codemodel_CMElement", is_abstract=True)
codemodel_CodeModule = Class(name="codemodel_CodeModule")
CMElement = Class(name="CMElement")
codemodel_GlobalVariable = Class(name="codemodel_GlobalVariable")
codemodel_Function = Class(name="codemodel_Function")
codemodel_DataType = Class(name="codemodel_DataType", is_abstract=True)
codemodel_Variable = Class(name="codemodel_Variable", is_abstract=True)
Variable = Class(name="Variable")
codemodel_MatrixType = Class(name="codemodel_MatrixType")
DataType = Class(name="DataType")
codemodel_VectorType = Class(name="codemodel_VectorType")
codemodel_ScalarType = Class(name="codemodel_ScalarType")
codemodel_expressions_Expression = Class(name="codemodel_expressions_Expression", is_abstract=True)
codemodel_expressions_VariableExp = Class(name="codemodel_expressions_VariableExp")
Expression = Class(name="Expression")
expressions_codemodel_Variable = Class(name="expressions_codemodel_Variable")
codemodel_expressions_BinaryExp = Class(name="codemodel_expressions_BinaryExp")
codemodel_expressions_LiteralExp = Class(name="codemodel_expressions_LiteralExp")
codemodel_FunctionArgument = Class(name="codemodel_FunctionArgument")
codemodel_LocalVariable = Class(name="codemodel_LocalVariable")
Statement = Class(name="Statement")
codemodel_statements_CompositeStmt = Class(name="codemodel_statements_CompositeStmt")
codemodel_statements_IfStmt = Class(name="codemodel_statements_IfStmt")
codemodel_statements_ForStmt = Class(name="codemodel_statements_ForStmt")
AssignmentStmt = Class(name="AssignmentStmt")
codemodel_statements_Statement = Class(name="codemodel_statements_Statement", is_abstract=True)
codemodel_statements_AssignmentStmt = Class(name="codemodel_statements_AssignmentStmt")
...
codemodel_Variable.attributes={codemodel_Variable_identifier, codemodel_Variable_constant}
...
codemodel_MatrixType.attributes={codemodel_MatrixType_rows, codemodel_MatrixType_columns}
...
domain_model = DomainModel(
    name="codemodel",
    types={codemodel_CMElement, codemodel_CodeModule, CMElement, codemodel_GlobalVariable, codemodel_Function, codemodel_DataType, codemodel_Variable, Variable, codemodel_MatrixType, DataType, codemodel_VectorType, codemodel_ScalarType, codemodel_expressions_Expression, codemodel_expressions_VariableExp, Expression, expressions_codemodel_Variable, codemodel_expressions_BinaryExp, codemodel_expressions_LiteralExp, codemodel_FunctionArgument, codemodel_LocalVariable, Statement, codemodel_statements_CompositeStmt, codemodel_statements_IfStmt, codemodel_statements_ForStmt, AssignmentStmt, codemodel_statements_Statement, codemodel_statements_AssignmentStmt},
    associations={globalVariables0, functions1, dataTypes3, type5, body11, referencedVariable13, left14, right15, arguments7, localVariables9, rightExp20, statements23, condition25, thenStmt27, elseStmt30, init33, condition34, increment37, forStmt40, leftExp18},
    generalizations={gen_codemodel_CodeModule_CMElement, gen_codemodel_Variable_CMElement, gen_codemodel_GlobalVariable_Variable, gen_codemodel_FunctionArgument_Variable, gen_codemodel_LocalVariable_Variable, gen_codemodel_MatrixType_DataType, gen_codemodel_DataType_CMElement, gen_codemodel_VectorType_DataType, gen_codemodel_ScalarType_DataType, gen_codemodel_expressions_Expression_CMElement, gen_codemodel_expressions_VariableExp_Expression, gen_codemodel_expressions_BinaryExp_Expression, gen_codemodel_expressions_LiteralExp_Expression, gen_codemodel_Function_CMElement, gen_codemodel_statements_CompositeStmt_Statement, gen_codemodel_statements_IfStmt_Statement, gen_codemodel_statements_ForStmt_Statement, gen_codemodel_statements_Statement_CMElement, gen_codemodel_statements_AssignmentStmt_Statement},
    metadata=None
)
