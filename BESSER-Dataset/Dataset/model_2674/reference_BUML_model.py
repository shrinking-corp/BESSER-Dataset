...
reference_E = Class(name="reference_E")
reference_C = Class(name="reference_C")
reference_G = Class(name="reference_G")
reference_H = Class(name="reference_H")
reference_Named = Class(name="reference_Named")
reference_F = Class(name="reference_F")
...
domain_model = DomainModel(
    ...
    associations={bs0, es1, acs3, ags5, ahs7, hs17, cs9, gs12, fs15},
    generalizations={gen_reference_A_Named, gen_reference_B_Named, gen_reference_H_Named, gen_reference_C_Named, gen_reference_E_Named, gen_reference_F_Named, gen_reference_G_Named},
    metadata=None
)
