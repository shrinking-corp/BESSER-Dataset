...
def test_smalluml_boolean_has_value():
    assert hasattr(smalluml_Boolean, "value")
    descriptor = None
    for klass in smalluml_Boolean.__mro__:
...
@given(instance=smalluml_Boolean_strategy)
def test_smalluml_boolean_value_setter(instance):
