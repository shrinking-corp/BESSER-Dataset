...
# Classes
refinher3_E = Class(name="refinher3_E")
DNamedElement = Class(name="DNamedElement")
refinher3_N = Class(name="refinher3_N")
refinher3_DNamedElement = Class(name="refinher3_DNamedElement", is_abstract=True)
refinher3_DL = Class(name="refinher3_DL")
refinher3_DR = Class(name="refinher3_DR")
E = Class(name="E")
refinher3_DC = Class(name="refinher3_DC")
refinher3_DG = Class(name="refinher3_DG")
CE = Class(name="CE")
refinher3_BB = Class(name="refinher3_BB")
refinher3_M = Class(name="refinher3_M")
refinher3_A = Class(name="refinher3_A", is_abstract=True)
refinher3_CE = Class(name="refinher3_CE")
A = Class(name="A")
refinher3_Foobar = Class(name="refinher3_Foobar")
...
domain_model = DomainModel(
    name="refinher3",
    types={refinher3_E, DNamedElement, refinher3_N, refinher3_DNamedElement, refinher3_DL, refinher3_DR, E, refinher3_DC, refinher3_DG, CE, refinher3_BB, refinher3_M, refinher3_A, refinher3_CE, A, refinher3_Foobar},
    associations={sn0, tn1, bridges5, bBridge4, ns7, ms10, esbars12, foobars15},
    generalizations={gen_refinher3_E_DNamedElement, gen_refinher3_DR_E, gen_refinher3_DC_CE, gen_refinher3_DL_CE, gen_refinher3_A_DNamedElement, gen_refinher3_CE_A, gen_refinher3_CE_E, gen_refinher3_BB_DNamedElement, gen_refinher3_Foobar_DNamedElement},
    metadata=None
)
