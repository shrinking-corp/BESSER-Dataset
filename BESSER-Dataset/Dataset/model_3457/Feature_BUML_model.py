...
# Classes
feature_HyFeature = Class(name="feature_HyFeature")
feature_HyGroup = Class(name="feature_HyGroup")
feature_HyEnum = Class(name="feature_HyEnum")
feature_HyContextModel = Class(name="feature_HyContextModel")
HyTemporalElement = Class(name="HyTemporalElement")
HyNamedElement = Class(name="HyNamedElement")
feature_HyVersion = Class(name="feature_HyVersion")
feature_HyGroupComposition = Class(name="feature_HyGroupComposition")
feature_HyFeatureChild = Class(name="feature_HyFeatureChild")
feature_HyFeatureAttribute = Class(name="feature_HyFeatureAttribute", is_abstract=True)
feature_HyFeatureType = Class(name="feature_HyFeatureType")
feature_HyFeatureModel = Class(name="feature_HyFeatureModel")
feature_HyRootFeature = Class(name="feature_HyRootFeature")
feature_HyGroupType = Class(name="feature_HyGroupType")
feature_HyNumberAttribute = Class(name="feature_HyNumberAttribute")
HyFeatureAttribute = Class(name="HyFeatureAttribute")
feature_HyBooleanAttribute = Class(name="feature_HyBooleanAttribute")
feature_HyStringAttribute = Class(name="feature_HyStringAttribute")
feature_HyEnumAttribute = Class(name="feature_HyEnumAttribute")
feature_HyEnumLiteral = Class(name="feature_HyEnumLiteral")
...
feature_HyFeature_m_isOptional: Method = Method(name="isOptional", parameters={Parameter(name='feature_date', type=StringType)}, type=BooleanType)
feature_HyFeature_m_isMandatory: Method = Method(name="isMandatory", parameters={Parameter(name='feature_date', type=StringType)}, type=BooleanType)
...
feature_HyGroup_m_isAlternative: Method = Method(name="isAlternative", parameters={Parameter(name='feature_date', type=StringType)}, type=BooleanType)
feature_HyGroup_m_isOr: Method = Method(name="isOr", parameters={Parameter(name='feature_date', type=StringType)}, type=BooleanType)
feature_HyGroup_m_isAnd: Method = Method(name="isAnd", parameters={Parameter(name='feature_date', type=StringType)}, type=BooleanType)
feature_HyGroup.methods={feature_HyGroup_m_isAnd, feature_HyGroup_m_isOr, feature_HyGroup_m_isAlternative}
...
domain_model = DomainModel(
    name="feature",
    types={feature_HyFeature, feature_HyGroup, feature_HyEnum, feature_HyContextModel, HyTemporalElement, HyNamedElement, feature_HyVersion, feature_HyGroupComposition, feature_HyFeatureChild, feature_HyFeatureAttribute, feature_HyFeatureType, feature_HyFeatureModel, feature_HyRootFeature, feature_HyGroupType, feature_HyNumberAttribute, HyFeatureAttribute, feature_HyBooleanAttribute, feature_HyStringAttribute, feature_HyEnumAttribute, feature_HyEnumLiteral, HyLinearTemporalElement, HyFeatureTypeEnum, HyGroupTypeEnum},
    associations={rootFeature0, features1, groups2, enums4, contexts6, versions8, groupMembership9, parentOf10, attributes11, types13, featureModel14, parentOf16, childOf18, types20, featureModel21, feature23, supersedingVersions26, supersededVersion29, enumType31, default33, features42, parent44, childGroup47, feature35, feature37, compositionOf40},
    generalizations={gen_feature_HyFeature_HyTemporalElement, gen_feature_HyFeature_HyNamedElement, gen_feature_HyVersion_HyTemporalElement, gen_feature_HyNumberAttribute_HyFeatureAttribute, gen_feature_HyBooleanAttribute_HyFeatureAttribute, gen_feature_HyStringAttribute_HyFeatureAttribute, gen_feature_HyEnumAttribute_HyFeatureAttribute, gen_feature_HyFeatureAttribute_HyTemporalElement, gen_feature_HyFeatureAttribute_HyNamedElement, gen_feature_HyGroup_HyTemporalElement, gen_feature_HyFeatureChild_HyLinearTemporalElement, gen_feature_HyFeatureType_HyLinearTemporalElement, gen_feature_HyGroupType_HyLinearTemporalElement, gen_feature_HyRootFeature_HyLinearTemporalElement, gen_feature_HyGroupComposition_HyLinearTemporalElement},
    metadata=None
)
