...
class feature_HyVersion(HyTemporalElement):
    ...
    def __init__(self, number: str, HyVersion: "feature_HyFeature" = None, versions: "feature_HyFeature" = None, HyVersion27: "feature_HyVersion" = None, supersededVersion: set["feature_HyVersion"] = None, HyVersion30: "feature_HyVersion" = None, supersedingVersions: "feature_HyVersion" = None):
        self.number = number
...
class feature_HyGroup(HyTemporalElement):
    ...
    def __init__(self, HyGroup: "feature_HyFeatureModel" = None, compositionOf: set["feature_HyGroupComposition"] = None, childGroup: set["feature_HyFeatureChild"] = None, HyGroup41: "feature_HyGroupComposition" = None, feature_HyGroup: set["feature_HyGroupType"] = None, groups: "feature_HyFeatureModel" = None, HyGroup48: "feature_HyFeatureChild" = None):
...
class feature_HyFeature(HyTemporalElement, HyNamedElement):
    ...
    def isMandatory(self, feature_date) :
        # TODO: Implement isMandatory method
        pass

    def isOptional(self, feature_date) :
