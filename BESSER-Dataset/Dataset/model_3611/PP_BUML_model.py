...
# Classes
pp_DefinitionArgumentList = Class(name="pp_DefinitionArgumentList")
pp_DefinitionArgument = Class(name="pp_DefinitionArgument")
pp_PuppetManifest = Class(name="pp_PuppetManifest")
ExpressionBlock = Class(name="ExpressionBlock")
pp_Expression = Class(name="pp_Expression")
pp_ResourceBody = Class(name="pp_ResourceBody")
pp_AttributeOperations = Class(name="pp_AttributeOperations")
pp_AttributeOperation = Class(name="pp_AttributeOperation")
pp_ICollectQuery = Class(name="pp_ICollectQuery", is_abstract=True)
pp_VirtualCollectQuery = Class(name="pp_VirtualCollectQuery")
UnaryExpression = Class(name="UnaryExpression")
ICollectQuery = Class(name="ICollectQuery")
pp_ExportedCollectQuery = Class(name="pp_ExportedCollectQuery")
pp_HostClassDefinition = Class(name="pp_HostClassDefinition")
Definition = Class(name="Definition")
pp_LiteralExpression = Class(name="pp_LiteralExpression", is_abstract=True)
pp_Definition = Class(name="pp_Definition")
Expression = Class(name="Expression")
pp_IQuotedString = Class(name="pp_IQuotedString", is_abstract=True)
pp_LiteralList = Class(name="pp_LiteralList")
pp_LiteralHash = Class(name="pp_LiteralHash")
pp_HashEntry = Class(name="pp_HashEntry")
pp_CaseExpression = Class(name="pp_CaseExpression")
pp_Case = Class(name="pp_Case")
pp_IfExpression = Class(name="pp_IfExpression")
pp_LiteralNameOrReference = Class(name="pp_LiteralNameOrReference")
LiteralExpression = Class(name="LiteralExpression")
pp_ResourceExpression = Class(name="pp_ResourceExpression")
pp_ImportExpression = Class(name="pp_ImportExpression")
pp_SelectorExpression = Class(name="pp_SelectorExpression")
pp_SelectorEntry = Class(name="pp_SelectorEntry")
pp_FunctionCall = Class(name="pp_FunctionCall")
WithLambdaExpression = Class(name="WithLambdaExpression")
pp_BinaryOpExpression = Class(name="pp_BinaryOpExpression", is_abstract=True)
pp_BinaryExpression = Class(name="pp_BinaryExpression", is_abstract=True)
pp_LiteralBoolean = Class(name="pp_LiteralBoolean")
pp_LiteralUndef = Class(name="pp_LiteralUndef")
pp_LiteralDefault = Class(name="pp_LiteralDefault")
pp_LiteralRegex = Class(name="pp_LiteralRegex")
pp_LiteralName = Class(name="pp_LiteralName")
pp_VariableExpression = Class(name="pp_VariableExpression")
pp_RelationshipExpression = Class(name="pp_RelationshipExpression")
BinaryOpExpression = Class(name="BinaryOpExpression")
pp_AssignmentExpression = Class(name="pp_AssignmentExpression")
BinaryExpression = Class(name="BinaryExpression")
pp_AppendExpression = Class(name="pp_AppendExpression")
pp_OrExpression = Class(name="pp_OrExpression")
pp_AndExpression = Class(name="pp_AndExpression")
pp_RelationalExpression = Class(name="pp_RelationalExpression")
pp_EqualityExpression = Class(name="pp_EqualityExpression")
pp_ShiftExpression = Class(name="pp_ShiftExpression")
pp_AdditiveExpression = Class(name="pp_AdditiveExpression")
pp_MultiplicativeExpression = Class(name="pp_MultiplicativeExpression")
pp_MatchingExpression = Class(name="pp_MatchingExpression")
pp_InExpression = Class(name="pp_InExpression")
pp_AtExpression = Class(name="pp_AtExpression")
ParameterizedExpression = Class(name="ParameterizedExpression")
pp_CollectExpression = Class(name="pp_CollectExpression")
pp_ElseIfExpression = Class(name="pp_ElseIfExpression")
IfExpression = Class(name="IfExpression")
pp_VirtualNameOrReference = Class(name="pp_VirtualNameOrReference")
pp_ParenthesisedExpression = Class(name="pp_ParenthesisedExpression")
pp_ExprList = Class(name="pp_ExprList")
pp_ParameterizedExpression = Class(name="pp_ParameterizedExpression", is_abstract=True)
pp_NodeDefinition = Class(name="pp_NodeDefinition")
pp_UnaryExpression = Class(name="pp_UnaryExpression", is_abstract=True)
pp_UnaryMinusExpression = Class(name="pp_UnaryMinusExpression")
pp_UnaryNotExpression = Class(name="pp_UnaryNotExpression")
pp_ExpressionBlock = Class(name="pp_ExpressionBlock", is_abstract=True)
pp_ElseExpression = Class(name="pp_ElseExpression")
pp_Lambda = Class(name="pp_Lambda", is_abstract=True)
pp_NamedAccessExpression = Class(name="pp_NamedAccessExpression")
pp_MethodCall = Class(name="pp_MethodCall")
pp_DoubleQuotedString = Class(name="pp_DoubleQuotedString")
StringExpression = Class(name="StringExpression")
IQuotedString = Class(name="IQuotedString")
pp_TextExpression = Class(name="pp_TextExpression", is_abstract=True)
pp_SingleQuotedString = Class(name="pp_SingleQuotedString")
pp_StringExpression = Class(name="pp_StringExpression", is_abstract=True)
pp_UnquotedString = Class(name="pp_UnquotedString")
pp_InterpolatedVariable = Class(name="pp_InterpolatedVariable")
pp_VerbatimTE = Class(name="pp_VerbatimTE")
TextExpression = Class(name="TextExpression")
pp_ExpressionTE = Class(name="pp_ExpressionTE")
pp_VariableTE = Class(name="pp_VariableTE")
pp_LiteralClass = Class(name="pp_LiteralClass")
pp_UnlessExpression = Class(name="pp_UnlessExpression")
pp_WithLambdaExpression = Class(name="pp_WithLambdaExpression")
pp_JavaLambda = Class(name="pp_JavaLambda")
Lambda = Class(name="Lambda")
pp_RubyLambda = Class(name="pp_RubyLambda")
pp_SeparatorExpression = Class(name="pp_SeparatorExpression")
...
domain_model = DomainModel(
    name="pp",
    types={pp_DefinitionArgumentList, pp_DefinitionArgument, pp_PuppetManifest, ExpressionBlock, pp_Expression, pp_ResourceBody, pp_AttributeOperations, pp_AttributeOperation, pp_ICollectQuery, pp_VirtualCollectQuery, UnaryExpression, ICollectQuery, pp_ExportedCollectQuery, pp_HostClassDefinition, Definition, pp_LiteralExpression, pp_Definition, Expression, pp_IQuotedString, pp_LiteralList, pp_LiteralHash, pp_HashEntry, pp_CaseExpression, pp_Case, pp_IfExpression, pp_LiteralNameOrReference, LiteralExpression, pp_ResourceExpression, pp_ImportExpression, pp_SelectorExpression, pp_SelectorEntry, pp_FunctionCall, WithLambdaExpression, pp_BinaryOpExpression, pp_BinaryExpression, pp_LiteralBoolean, pp_LiteralUndef, pp_LiteralDefault, pp_LiteralRegex, pp_LiteralName, pp_VariableExpression, pp_RelationshipExpression, BinaryOpExpression, pp_AssignmentExpression, BinaryExpression, pp_AppendExpression, pp_OrExpression, pp_AndExpression, pp_RelationalExpression, pp_EqualityExpression, pp_ShiftExpression, pp_AdditiveExpression, pp_MultiplicativeExpression, pp_MatchingExpression, pp_InExpression, pp_AtExpression, ParameterizedExpression, pp_CollectExpression, pp_ElseIfExpression, IfExpression, pp_VirtualNameOrReference, pp_ParenthesisedExpression, pp_ExprList, pp_ParameterizedExpression, pp_NodeDefinition, pp_UnaryExpression, pp_UnaryMinusExpression, pp_UnaryNotExpression, pp_ExpressionBlock, pp_ElseExpression, pp_Lambda, pp_NamedAccessExpression, pp_MethodCall, pp_DoubleQuotedString, StringExpression, IQuotedString, pp_TextExpression, pp_SingleQuotedString, pp_StringExpression, pp_UnquotedString, pp_InterpolatedVariable, pp_VerbatimTE, TextExpression, pp_ExpressionTE, pp_VariableTE, pp_LiteralClass, pp_UnlessExpression, pp_WithLambdaExpression, pp_JavaLambda, Lambda, pp_RubyLambda, pp_SeparatorExpression},
    associations={arguments9, statements10, arguments13, value15, attributes0, nameExpr1, value3, attributes5, parent8, values41, elements42, elements44, key45, switchExpr18, cases20, statements22, values25, condExpr28, thenStatements30, elseStatement33, resourceExpr36, resourceData38, query53, attributes55, leftExpr58, value48, classReference51, expr80, expressions82, rightExpr60, leftExpr63, parameters65, hostNames68, parentName70, statements73, expr76, statements78, elseStatement94, arguments97, stringPart84, expression85, expression87, condExpr89, thenStatements91, methodExpr99, lambda_101},
    generalizations={gen_pp_PuppetManifest_ExpressionBlock, gen_pp_VirtualCollectQuery_UnaryExpression, gen_pp_VirtualCollectQuery_ICollectQuery, gen_pp_ExportedCollectQuery_UnaryExpression, gen_pp_ExportedCollectQuery_ICollectQuery, gen_pp_HostClassDefinition_Definition, gen_pp_Definition_Expression, gen_pp_LiteralList_LiteralExpression, gen_pp_LiteralHash_LiteralExpression, gen_pp_CaseExpression_Expression, gen_pp_IfExpression_Expression, gen_pp_LiteralExpression_Expression, gen_pp_LiteralNameOrReference_LiteralExpression, gen_pp_ResourceExpression_Expression, gen_pp_ImportExpression_Expression, gen_pp_SelectorExpression_ParameterizedExpression, gen_pp_SelectorEntry_BinaryExpression, gen_pp_FunctionCall_WithLambdaExpression, gen_pp_BinaryOpExpression_BinaryExpression, gen_pp_BinaryExpression_Expression, gen_pp_LiteralBoolean_LiteralExpression, gen_pp_LiteralUndef_LiteralExpression, gen_pp_LiteralDefault_LiteralExpression, gen_pp_LiteralRegex_LiteralExpression, gen_pp_LiteralName_LiteralExpression, gen_pp_VariableExpression_Expression, gen_pp_RelationshipExpression_BinaryOpExpression, gen_pp_AssignmentExpression_BinaryExpression, gen_pp_AppendExpression_BinaryExpression, gen_pp_OrExpression_BinaryExpression, gen_pp_AndExpression_BinaryExpression, gen_pp_RelationalExpression_BinaryOpExpression, gen_pp_EqualityExpression_BinaryOpExpression, gen_pp_ShiftExpression_BinaryOpExpression, gen_pp_AdditiveExpression_BinaryOpExpression, gen_pp_MultiplicativeExpression_BinaryOpExpression, gen_pp_MatchingExpression_BinaryOpExpression, gen_pp_InExpression_BinaryOpExpression, gen_pp_AtExpression_ParameterizedExpression, gen_pp_CollectExpression_Expression, gen_pp_ElseIfExpression_IfExpression, gen_pp_VirtualNameOrReference_LiteralExpression, gen_pp_ParenthesisedExpression_Expression, gen_pp_ExprList_Expression, gen_pp_ParameterizedExpression_Expression, gen_pp_NodeDefinition_Expression, gen_pp_UnaryExpression_Expression, gen_pp_UnaryMinusExpression_UnaryExpression, gen_pp_UnaryNotExpression_UnaryExpression, gen_pp_ExpressionBlock_Expression, gen_pp_ElseExpression_ExpressionBlock, gen_pp_Lambda_ExpressionBlock, gen_pp_NamedAccessExpression_BinaryExpression, gen_pp_MethodCall_WithLambdaExpression, gen_pp_DoubleQuotedString_StringExpression, gen_pp_DoubleQuotedString_IQuotedString, gen_pp_SingleQuotedString_StringExpression, gen_pp_SingleQuotedString_IQuotedString, gen_pp_StringExpression_Expression, gen_pp_UnquotedString_StringExpression, gen_pp_InterpolatedVariable_Expression, gen_pp_VerbatimTE_TextExpression, gen_pp_ExpressionTE_TextExpression, gen_pp_VariableTE_TextExpression, gen_pp_LiteralClass_LiteralExpression, gen_pp_UnlessExpression_Expression, gen_pp_WithLambdaExpression_ParameterizedExpression, gen_pp_JavaLambda_Lambda, gen_pp_RubyLambda_Lambda, gen_pp_SeparatorExpression_Expression},
    metadata=None
)
