...
# Classes
mancoosimm_NamedElement = Class(name="mancoosimm_NamedElement", is_abstract=True)
mancoosimm_Configuration = Class(name="mancoosimm_Configuration")
NamedElement = Class(name="NamedElement")
mancoosimm_Package = Class(name="mancoosimm_Package", is_abstract=True)
mancoosimm_PackageSetting = Class(name="mancoosimm_PackageSetting")
Package = Class(name="Package")
mancoosimm_FileSystem = Class(name="mancoosimm_FileSystem")
mancoosimm_Environment = Class(name="mancoosimm_Environment")
mancoosimm_InstalledPackage = Class(name="mancoosimm_InstalledPackage")
mancoosimm_NotInstalledPackage = Class(name="mancoosimm_NotInstalledPackage")
mancoosimm_ConfigFilesPackage = Class(name="mancoosimm_ConfigFilesPackage")
mancoosimm_UnpackedPackage = Class(name="mancoosimm_UnpackedPackage")
mancoosimm_HalfConfiguredPackage = Class(name="mancoosimm_HalfConfiguredPackage")
mancoosimm_HalfInstalledPackage = Class(name="mancoosimm_HalfInstalledPackage")
mancoosimm_HalfConfiguredReinstRequiredPackage = Class(name="mancoosimm_HalfConfiguredReinstRequiredPackage")
mancoosimm_HalfInstalledReinstRequiredPackage = Class(name="mancoosimm_HalfInstalledReinstRequiredPackage")
mancoosimm_DocumentationFile = Class(name="mancoosimm_DocumentationFile")
mancoosimm_Conflict = Class(name="mancoosimm_Conflict", is_abstract=True)
mancoosimm_SrcPackage = Class(name="mancoosimm_SrcPackage")
mancoosimm_Dependence = Class(name="mancoosimm_Dependence", is_abstract=True)
mancoosimm_VirtualPackage = Class(name="mancoosimm_VirtualPackage")
mancoosimm_File = Class(name="mancoosimm_File")
InstalledPackage = Class(name="InstalledPackage")
mancoosimm_BinPackage = Class(name="mancoosimm_BinPackage")
UnpackedPackage = Class(name="UnpackedPackage")
mancoosimm_Invariant = Class(name="mancoosimm_Invariant")
mancoosimm_Atom = Class(name="mancoosimm_Atom")
mancoosimm_AndInv = Class(name="mancoosimm_AndInv")
mancoosimm_OrInv = Class(name="mancoosimm_OrInv")
mancoosimm_AndDep = Class(name="mancoosimm_AndDep")
mancoosimm_OrDep = Class(name="mancoosimm_OrDep")
mancoosimm_SingleDep = Class(name="mancoosimm_SingleDep")
Dependence = Class(name="Dependence")
mancoosimm_User = Class(name="mancoosimm_User")
mancoosimm_Group = Class(name="mancoosimm_Group")
mancoosimm_EmacsPackage = Class(name="mancoosimm_EmacsPackage")
mancoosimm_IconCache = Class(name="mancoosimm_IconCache")
mancoosimm_DesktopDB = Class(name="mancoosimm_DesktopDB")
mancoosimm_MimeTypeHandlerCache = Class(name="mancoosimm_MimeTypeHandlerCache")
mancoosimm_LibraryCache = Class(name="mancoosimm_LibraryCache")
mancoosimm_NotInv = Class(name="mancoosimm_NotInv")
mancoosimm_Service = Class(name="mancoosimm_Service")
mancoosimm_Alternative = Class(name="mancoosimm_Alternative")
mancoosimm_ApplicationMenuCatalog = Class(name="mancoosimm_ApplicationMenuCatalog")
mancoosimm_SkeeperCatalog = Class(name="mancoosimm_SkeeperCatalog")
mancoosimm_SGMLCatalog = Class(name="mancoosimm_SGMLCatalog")
mancoosimm_ModuleCache = Class(name="mancoosimm_ModuleCache")
mancoosimm_XFontCache = Class(name="mancoosimm_XFontCache")
mancoosimm_GConf = Class(name="mancoosimm_GConf")
mancoosimm_Menu = Class(name="mancoosimm_Menu")
mancoosimm_MenuEntry = Class(name="mancoosimm_MenuEntry")
mancoosimm_Boot = Class(name="mancoosimm_Boot")
File = Class(name="File")
mancoosimm_InformationFile = Class(name="mancoosimm_InformationFile")
mancoosimm_XFont = Class(name="mancoosimm_XFont")
mancoosimm_MimeTypeHandler = Class(name="mancoosimm_MimeTypeHandler")
mancoosimm_MimeType = Class(name="mancoosimm_MimeType")
mancoosimm_SGMLDocument = Class(name="mancoosimm_SGMLDocument")
mancoosimm_SharedLibrary = Class(name="mancoosimm_SharedLibrary")
mancoosimm_Module = Class(name="mancoosimm_Module")
mancoosimm_SkeeperDocument = Class(name="mancoosimm_SkeeperDocument")
mancoosimm_AndConflict = Class(name="mancoosimm_AndConflict")
mancoosimm_OrConflict = Class(name="mancoosimm_OrConflict")
mancoosimm_SingleConflict = Class(name="mancoosimm_SingleConflict")
...
mancoosimm_InstalledPackage.attributes={mancoosimm_InstalledPackage_maintainer, mancoosimm_InstalledPackage_uploaders, mancoosimm_InstalledPackage_installedSize, mancoosimm_InstalledPackage_fileSize, mancoosimm_InstalledPackage_section, mancoosimm_InstalledPackage_tag, mancoosimm_InstalledPackage_checkSum, mancoosimm_InstalledPackage_priority, mancoosimm_InstalledPackage_description}
...
mancoosimm_ConfigFilesPackage.attributes={mancoosimm_ConfigFilesPackage_maintainer, mancoosimm_ConfigFilesPackage_checkSum, mancoosimm_ConfigFilesPackage_priority, mancoosimm_ConfigFilesPackage_uploaders, mancoosimm_ConfigFilesPackage_section, mancoosimm_ConfigFilesPackage_tag, mancoosimm_ConfigFilesPackage_description}
...
mancoosimm_UnpackedPackage.attributes={mancoosimm_UnpackedPackage_checkSum, mancoosimm_UnpackedPackage_tag, mancoosimm_UnpackedPackage_uploaders, mancoosimm_UnpackedPackage_description, mancoosimm_UnpackedPackage_priority, mancoosimm_UnpackedPackage_section, mancoosimm_UnpackedPackage_maintainer}
...
mancoosimm_HalfInstalledPackage.attributes={mancoosimm_HalfInstalledPackage_checkSum, mancoosimm_HalfInstalledPackage_priority, mancoosimm_HalfInstalledPackage_tag, mancoosimm_HalfInstalledPackage_uploaders, mancoosimm_HalfInstalledPackage_description, mancoosimm_HalfInstalledPackage_section, mancoosimm_HalfInstalledPackage_maintainer}
...
mancoosimm_HalfInstalledReinstRequiredPackage.attributes={mancoosimm_HalfInstalledReinstRequiredPackage_checkSum, mancoosimm_HalfInstalledReinstRequiredPackage_priority, mancoosimm_HalfInstalledReinstRequiredPackage_tag, mancoosimm_HalfInstalledReinstRequiredPackage_uploaders, mancoosimm_HalfInstalledReinstRequiredPackage_description, mancoosimm_HalfInstalledReinstRequiredPackage_maintainer, mancoosimm_HalfInstalledReinstRequiredPackage_section}
...
mancoosimm_File.attributes={mancoosimm_File_guid, mancoosimm_File_description, mancoosimm_File_location, mancoosimm_File_isMissing, mancoosimm_File_checkSum, mancoosimm_File_permission, mancoosimm_File_isDirectory, mancoosimm_File_extension, mancoosimm_File_suid, mancoosimm_File_size}
...
and_86: BinaryAssociation = BinaryAssociation(
    name="and_86",
    ends={
...
or_88: BinaryAssociation = BinaryAssociation(
    name="or_88",
    ends={
...
not_90: BinaryAssociation = BinaryAssociation(
    name="not_90",
    ends={
...
domain_model = DomainModel(
    name="mancoosimm",
    types={mancoosimm_NamedElement, mancoosimm_Configuration, NamedElement, mancoosimm_Package, mancoosimm_PackageSetting, Package, mancoosimm_FileSystem, mancoosimm_Environment, mancoosimm_InstalledPackage, mancoosimm_NotInstalledPackage, mancoosimm_ConfigFilesPackage, mancoosimm_UnpackedPackage, mancoosimm_HalfConfiguredPackage, mancoosimm_HalfInstalledPackage, mancoosimm_HalfConfiguredReinstRequiredPackage, mancoosimm_HalfInstalledReinstRequiredPackage, mancoosimm_DocumentationFile, mancoosimm_Conflict, mancoosimm_SrcPackage, mancoosimm_Dependence, mancoosimm_VirtualPackage, mancoosimm_File, InstalledPackage, mancoosimm_BinPackage, UnpackedPackage, mancoosimm_Invariant, mancoosimm_Atom, mancoosimm_AndInv, mancoosimm_OrInv, mancoosimm_AndDep, mancoosimm_OrDep, mancoosimm_SingleDep, Dependence, mancoosimm_User, mancoosimm_Group, mancoosimm_EmacsPackage, mancoosimm_IconCache, mancoosimm_DesktopDB, mancoosimm_MimeTypeHandlerCache, mancoosimm_LibraryCache, mancoosimm_NotInv, mancoosimm_Service, mancoosimm_Alternative, mancoosimm_ApplicationMenuCatalog, mancoosimm_SkeeperCatalog, mancoosimm_SGMLCatalog, mancoosimm_ModuleCache, mancoosimm_XFontCache, mancoosimm_GConf, mancoosimm_Menu, mancoosimm_MenuEntry, mancoosimm_Boot, File, mancoosimm_InformationFile, mancoosimm_XFont, mancoosimm_MimeTypeHandler, mancoosimm_MimeType, mancoosimm_SGMLDocument, mancoosimm_SharedLibrary, mancoosimm_Module, mancoosimm_SkeeperDocument, mancoosimm_AndConflict, mancoosimm_OrConflict, mancoosimm_SingleConflict, Conflict, PriorityType, StatusType, VersionType},
    associations={configuration18, packageSettings20, fileSystem0, environment1, installedPackages3, notInstalledPackages4, configFilesPackages6, unpackedPackages8, halfConfiguredPackages10, halfInstalledPackages12, halfConfiguredReinstRequiredPackages14, halfInstalledReinstRequiredPackages16, documentationFiles44, conflict46, sourcePackage21, depends23, recommends26, suggests29, enhances32, predepends35, provides37, replaces40, files42, buildDepends51, buildConflicts53, srcRef56, files48, ops79, dependence81, dependence83, atomEl85, and_86, impPackage59, andDep62, orDep63, singleDep65, pkg67, owner71, ownerPkg73, ops76, dependence78, users110, groups112, emacspkg114, iconCache116, desktopDb118, mimeTypeHandlerCache120, or_88, not_90, left92, right95, left98, right101, elem104, runningServices107, alternatives108, root137, configuration138, allFiles140, confFiles142, schemas144, env147, menu149, libraryCache122, skeeperCatalog124, sgmlCatalog126, configuration128, moduleCache129, xfontCaches131, gconf133, menu135, services164, executable165, env168, entries151, catalog152, env154, menu157, executable159, parent162, current185, location187, env190, services192, files194, pkg196, fs170, childs173, parent176, owner178, group180, pkgSettings182, pkg184, type215, cache217, mimeTypeHandlers219, cache221, xfonts223, env224, dependences198, env200, icons202, env204, applications206, env208, handlers210, mimeTypes211, handler213, modules240, env241, file244, moduleCache246, env248, documents250, xfontCache226, file228, locations230, sharedLibraries232, env233, file236, libraryCache238, env268, env270, groups272, home275, env278, location251, document254, env257, documents259, location260, document263, files266, andConflict284, orConflict285, users280, conflict283, singleConflict287, pkg289, owner293, ownerPkg295, ops298, conflict300, ops302, conflict304},
    generalizations={gen_mancoosimm_Configuration_NamedElement, gen_mancoosimm_Package_NamedElement, gen_mancoosimm_InstalledPackage_Package, gen_mancoosimm_NotInstalledPackage_Package, gen_mancoosimm_ConfigFilesPackage_Package, gen_mancoosimm_UnpackedPackage_Package, gen_mancoosimm_SrcPackage_InstalledPackage, gen_mancoosimm_BinPackage_InstalledPackage, gen_mancoosimm_HalfConfiguredPackage_UnpackedPackage, gen_mancoosimm_HalfConfiguredReinstRequiredPackage_UnpackedPackage, gen_mancoosimm_HalfInstalledPackage_Package, gen_mancoosimm_HalfInstalledReinstRequiredPackage_Package, gen_mancoosimm_SingleDep_Dependence, gen_mancoosimm_Invariant_NamedElement, gen_mancoosimm_VirtualPackage_InstalledPackage, gen_mancoosimm_AndDep_Dependence, gen_mancoosimm_OrDep_Dependence, gen_mancoosimm_Atom_NamedElement, gen_mancoosimm_Environment_NamedElement, gen_mancoosimm_ApplicationMenuCatalog_NamedElement, gen_mancoosimm_FileSystem_NamedElement, gen_mancoosimm_Service_NamedElement, gen_mancoosimm_File_NamedElement, gen_mancoosimm_MenuEntry_NamedElement, gen_mancoosimm_Alternative_NamedElement, gen_mancoosimm_PackageSetting_NamedElement, gen_mancoosimm_DocumentationFile_File, gen_mancoosimm_InformationFile_File, gen_mancoosimm_Module_NamedElement, gen_mancoosimm_SGMLCatalog_NamedElement, gen_mancoosimm_SGMLDocument_NamedElement, gen_mancoosimm_XFont_NamedElement, gen_mancoosimm_User_NamedElement, gen_mancoosimm_Group_NamedElement, gen_mancoosimm_SkeeperCatalog_NamedElement, gen_mancoosimm_SkeeperDocument_NamedElement, gen_mancoosimm_EmacsPackage_NamedElement, gen_mancoosimm_SingleConflict_Conflict, gen_mancoosimm_AndConflict_Conflict, gen_mancoosimm_OrConflict_Conflict},
    metadata=None
)
