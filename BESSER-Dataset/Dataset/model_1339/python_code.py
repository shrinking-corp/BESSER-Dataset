...
class mutatorenvironment_miniOCL_NavigationPathVariableCS(NavigationPathCS):
    ...
    def __init__(self, varName: str, NavigationPathCS: "mutatorenvironment_miniOCL_NavigationPathNameCS" = None):
...
class mutatorenvironment_miniOCL_PathVariableCS(PathCS):
    ...
    def __init__(self, varName: str, PathCS: "mutatorenvironment_miniOCL_PathNameCS" = None):
        self.varName = varName
...
class mutatorenvironment_miniOCL_LoopExpCS(NavigationExpCS):
    ...
    def __init__(self, logicOp: str, mutatorenvironment_miniOCL_LoopExpCS: "IteratorVarCS" = None, mutatorenvironment_miniOCL_LoopExpCS247: set["ExpCS"] = None, NavigationExpCS: "mutatorenvironment_miniOCL_CallExpCS" = None):
...
class mutatorenvironment_miniOCL_LogicExpCS(ExpCS):
    ...
    def __init__(self, op: str, mutatorenvironment_miniOCL_LogicExpCS: "LogicExpCS" = None, mutatorenvironment_miniOCL_LogicExpCS233: "CallExpCS" = None, ExpCS256: "mutatorenvironment_miniOCL_AccVarCS" = None, ExpCS230: "mutatorenvironment_miniOCL_InvariantCS" = None, ExpCS: "mutatorenvironment_miniOCL_OperationCS" = None, ExpCS258: "mutatorenvironment_miniOCL_RoundedBracketClauseCS" = None, ExpCS248: "mutatorenvironment_miniOCL_LoopExpCS" = None):
        self.op = op
...
class mutatorenvironment_miniOCL_ClassCS:
    ...
    def __init__(self, name: str, mutatorenvironment_miniOCL_ClassCS211: set["PropertyCS"] = None, mutatorenvironment_miniOCL_ClassCS213: set["OperationCS"] = None, mutatorenvironment_miniOCL_ClassCS: "PathNameCS" = None):
        self.name = name
...
class mutatorenvironment_ReferenceEvaluation(Evaluation):
    ...
    def __init__(self, operator: str, container: bool, mutatorenvironment_ReferenceEvaluation116: "mutatorenvironment_EReference" = None, mutatorenvironment_ReferenceEvaluation119: "mutatorenvironment_ObSelectionStrategy" = None, mutatorenvironment_ReferenceEvaluation122: "mutatorenvironment_EReference" = None, mutatorenvironment_ReferenceEvaluation125: "mutatorenvironment_EAttribute" = None, mutatorenvironment_ReferenceEvaluation128: "mutatorenvironment_AttributeEvaluationType" = None, mutatorenvironment_ReferenceEvaluation: "mutatorenvironment_EReference" = None, mutatorenvironment_ReferenceEvaluation113: "mutatorenvironment_EReference" = None):
...
class bool:
    ...
    pass
class mutatorenvironment_Randombool(bool):
...
class mutatorenvironment_Specificbool(bool):
...
class AttributeType:
    ...
    pass
class mutatorenvironment_str(AttributeType):

    pass
class mutatorenvironment_NumberType(AttributeType):

    pass
class mutatorenvironment_Liststr(AttributeType):
...
class mutatorenvironment_ListType(AttributeType):
    ...
    pass
class mutatorenvironment_bool(AttributeType):
...
class mutatorenvironment_RandomDoubleType(DoubleType):
    ...
    def __init__(self, min: float, max: float, allowsNull: bool):
        self.min = min
        self.max = max
        self.allowsNull = allowsNull
...
class int:
    ...
    pass
class mutatorenvironment_Randomint(int):
...
class mutatorenvironment_Specificint(int):
...
class mutatorenvironment_MaxValueType(NumberType):
    ...
    pass
class mutatorenvironment_int(NumberType):

    pass
class str:

    pass
class mutatorenvironment_CatStartstr(str):
...
class mutatorenvironment_Lowerstr(str):
...
class mutatorenvironment_Replacestr(str):

    def __init__(self, oldstring: str, newstring: str):
...
class mutatorenvironment_Upperstr(str):
...
class mutatorenvironment_RandomStringNumberType(str):
...
class mutatorenvironment_CatEndstr(str):
...
class mutatorenvironment_Randomstr(str):
...
class mutatorenvironment_Specificstr(str):
...
class mutatorenvironment_ObjectEmitter(ABC):
    ...
    def __init__(self, name: str, mutatorenvironment_ObjectEmitter: "mutatorenvironment_EClass" = None, mutatorenvironment_ObjectEmitter14: set["mutatorenvironment_EClass"] = None, mutatorenvironment_ObjectEmitter45: "mutatorenvironment_SpecificReferenceSelection" = None, mutatorenvironment_ObjectEmitter34: "mutatorenvironment_SpecificObjectSelection" = None, mutatorenvironment_ObjectEmitter164: "mutatorenvironment_ObjectAttributeType" = None, mutatorenvironment_ObjectEmitter180: "mutatorenvironment_SpecificClosureSelection" = None):
        self.name = name
...
class mutatorenvironment_Program(Definition):
    ...
    def __init__(self, output: str, num: int, description: str, exhaustive: bool, mutatorenvironment_Program: "mutatorenvironment_Source" = None, mutatorenvironment_Program11: set["mutatorenvironment_Resource"] = None):
        self.output = output
        self.num = num
...
class mutatorenvironment_SelectSampleMutator(Mutator):
    ...
    def __init__(self, clause: str, mutatorenvironment_SelectSampleMutator184: set["mutatorenvironment_EStructuralFeature"] = None, mutatorenvironment_SelectSampleMutator: "mutatorenvironment_ObSelectionStrategy" = None):
        self.clause = clause
...
class mutatorenvironment_CloneObjectMutator(Mutator):
    ...
    def __init__(self, contents: bool, mutatorenvironment_CloneObjectMutator: "mutatorenvironment_ObSelectionStrategy" = None, mutatorenvironment_CloneObjectMutator151: "mutatorenvironment_ObSelectionStrategy" = None, mutatorenvironment_CloneObjectMutator154: "mutatorenvironment_EReference" = None, mutatorenvironment_CloneObjectMutator157: set["mutatorenvironment_AttributeSet"] = None, mutatorenvironment_CloneObjectMutator160: set["mutatorenvironment_ReferenceSet"] = None):
...
class mutatorenvironment_ObSelectionStrategy(ObjectEmitter):
    ...
    def __init__(self, resource: str, mutatorenvironment_ObSelectionStrategy: "mutatorenvironment_CreateObjectMutator" = None, mutatorenvironment_ObSelectionStrategy24: "mutatorenvironment_EReference" = None, mutatorenvironment_ObSelectionStrategy26: "mutatorenvironment_Expression" = None, mutatorenvironment_ObSelectionStrategy28: "mutatorenvironment_EReference" = None, mutatorenvironment_ObSelectionStrategy31: "mutatorenvironment_EReference" = None, mutatorenvironment_ObSelectionStrategy40: "mutatorenvironment_ModifySourceReferenceMutator" = None, mutatorenvironment_ObSelectionStrategy43: "mutatorenvironment_ModifySourceReferenceMutator" = None, mutatorenvironment_ObSelectionStrategy120: "mutatorenvironment_ReferenceEvaluation" = None, mutatorenvironment_ObSelectionStrategy91: "mutatorenvironment_SelectObjectMutator" = None, mutatorenvironment_ObSelectionStrategy94: "mutatorenvironment_SelectObjectMutator" = None, mutatorenvironment_ObSelectionStrategy104: "mutatorenvironment_ReferenceSet" = None, mutatorenvironment_ObSelectionStrategy149: "mutatorenvironment_CloneObjectMutator" = None, mutatorenvironment_ObSelectionStrategy55: "mutatorenvironment_CreateReferenceMutator" = None, mutatorenvironment_ObSelectionStrategy58: "mutatorenvironment_CreateReferenceMutator" = None, mutatorenvironment_ObSelectionStrategy63: "mutatorenvironment_RemoveObjectMutator" = None, mutatorenvironment_ObSelectionStrategy66: "mutatorenvironment_RemoveObjectMutator" = None, mutatorenvironment_ObSelectionStrategy68: "mutatorenvironment_ModifyInformationMutator" = None, mutatorenvironment_ObSelectionStrategy50: "mutatorenvironment_ModifyTargetReferenceMutator" = None, mutatorenvironment_ObSelectionStrategy53: "mutatorenvironment_ModifyTargetReferenceMutator" = None, mutatorenvironment_ObSelectionStrategy80: "mutatorenvironment_AttributeCopy" = None, mutatorenvironment_ObSelectionStrategy87: "mutatorenvironment_RemoveSpecificReferenceMutator" = None, mutatorenvironment_ObSelectionStrategy78: "mutatorenvironment_AttributeSwap" = None, mutatorenvironment_ObSelectionStrategy175: "mutatorenvironment_RandomNumberType" = None, mutatorenvironment_ObSelectionStrategy186: "mutatorenvironment_RetypeObjectMutator" = None, mutatorenvironment_ObSelectionStrategy152: "mutatorenvironment_CloneObjectMutator" = None, mutatorenvironment_ObSelectionStrategy189: "mutatorenvironment_RetypeObjectMutator" = None, mutatorenvironment_ObSelectionStrategy182: "mutatorenvironment_SelectSampleMutator" = None):
