...
# Classes
mutatorenvironment_MutatorEnvironment = Class(name="mutatorenvironment_MutatorEnvironment")
mutatorenvironment_Definition = Class(name="mutatorenvironment_Definition", is_abstract=True)
mutatorenvironment_Mutator = Class(name="mutatorenvironment_Mutator", is_abstract=True)
mutatorenvironment_Load = Class(name="mutatorenvironment_Load")
mutatorenvironment_EClass = Class(name="mutatorenvironment_EClass")
ObjectEmitter = Class(name="ObjectEmitter")
mutatorenvironment_CompositeMutator = Class(name="mutatorenvironment_CompositeMutator")
Mutator = Class(name="Mutator")
mutatorenvironment_CreateObjectMutator = Class(name="mutatorenvironment_CreateObjectMutator")
mutatorenvironment_ObSelectionStrategy = Class(name="mutatorenvironment_ObSelectionStrategy", is_abstract=True)
mutatorenvironment_AttributeSet = Class(name="mutatorenvironment_AttributeSet")
mutatorenvironment_ReferenceSet = Class(name="mutatorenvironment_ReferenceSet")
mutatorenvironment_EReference = Class(name="mutatorenvironment_EReference")
mutatorenvironment_Expression = Class(name="mutatorenvironment_Expression")
mutatorenvironment_RandomSelection = Class(name="mutatorenvironment_RandomSelection", is_abstract=True)
ObSelectionStrategy = Class(name="ObSelectionStrategy")
mutatorenvironment_Block = Class(name="mutatorenvironment_Block")
mutatorenvironment_Constraint = Class(name="mutatorenvironment_Constraint")
mutatorenvironment_Library = Class(name="mutatorenvironment_Library")
Definition = Class(name="Definition")
mutatorenvironment_Program = Class(name="mutatorenvironment_Program")
mutatorenvironment_Source = Class(name="mutatorenvironment_Source")
mutatorenvironment_Resource = Class(name="mutatorenvironment_Resource")
mutatorenvironment_ObjectEmitter = Class(name="mutatorenvironment_ObjectEmitter", is_abstract=True)
mutatorenvironment_SpecificStringType = Class(name="mutatorenvironment_SpecificStringType")
StringType = Class(name="StringType")
mutatorenvironment_RandomStringType = Class(name="mutatorenvironment_RandomStringType")
mutatorenvironment_IntegerType = Class(name="mutatorenvironment_IntegerType", is_abstract=True)
NumberType = Class(name="NumberType")
mutatorenvironment_SpecificIntegerType = Class(name="mutatorenvironment_SpecificIntegerType")
IntegerType = Class(name="IntegerType")
mutatorenvironment_RandomIntegerType = Class(name="mutatorenvironment_RandomIntegerType")
mutatorenvironment_DoubleType = Class(name="mutatorenvironment_DoubleType", is_abstract=True)
mutatorenvironment_SpecificDoubleType = Class(name="mutatorenvironment_SpecificDoubleType")
DoubleType = Class(name="DoubleType")
mutatorenvironment_RandomDoubleType = Class(name="mutatorenvironment_RandomDoubleType")
mutatorenvironment_ModifySourceReferenceMutator = Class(name="mutatorenvironment_ModifySourceReferenceMutator")
mutatorenvironment_SpecificSelection = Class(name="mutatorenvironment_SpecificSelection", is_abstract=True)
mutatorenvironment_SpecificReferenceSelection = Class(name="mutatorenvironment_SpecificReferenceSelection")
mutatorenvironment_RandomTypeSelection = Class(name="mutatorenvironment_RandomTypeSelection")
RandomSelection = Class(name="RandomSelection")
mutatorenvironment_SpecificObjectSelection = Class(name="mutatorenvironment_SpecificObjectSelection")
SpecificSelection = Class(name="SpecificSelection")
mutatorenvironment_AttributeScalar = Class(name="mutatorenvironment_AttributeScalar")
AttributeSet = Class(name="AttributeSet")
mutatorenvironment_AttributeType = Class(name="mutatorenvironment_AttributeType", is_abstract=True)
AttributeEvaluationType = Class(name="AttributeEvaluationType")
mutatorenvironment_BooleanType = Class(name="mutatorenvironment_BooleanType", is_abstract=True)
AttributeType = Class(name="AttributeType")
mutatorenvironment_SpecificBooleanType = Class(name="mutatorenvironment_SpecificBooleanType")
BooleanType = Class(name="BooleanType")
mutatorenvironment_RandomBooleanType = Class(name="mutatorenvironment_RandomBooleanType")
mutatorenvironment_StringType = Class(name="mutatorenvironment_StringType", is_abstract=True)
mutatorenvironment_CreateReferenceMutator = Class(name="mutatorenvironment_CreateReferenceMutator")
mutatorenvironment_RemoveObjectMutator = Class(name="mutatorenvironment_RemoveObjectMutator")
mutatorenvironment_RemoveReferenceMutator = Class(name="mutatorenvironment_RemoveReferenceMutator", is_abstract=True)
mutatorenvironment_ModifyInformationMutator = Class(name="mutatorenvironment_ModifyInformationMutator")
mutatorenvironment_ModifyTargetReferenceMutator = Class(name="mutatorenvironment_ModifyTargetReferenceMutator")
mutatorenvironment_AttributeCopy = Class(name="mutatorenvironment_AttributeCopy")
mutatorenvironment_RemoveRandomReferenceMutator = Class(name="mutatorenvironment_RemoveRandomReferenceMutator")
RemoveReferenceMutator = Class(name="RemoveReferenceMutator")
mutatorenvironment_RemoveSpecificReferenceMutator = Class(name="mutatorenvironment_RemoveSpecificReferenceMutator")
mutatorenvironment_CompleteSelection = Class(name="mutatorenvironment_CompleteSelection")
mutatorenvironment_CompleteTypeSelection = Class(name="mutatorenvironment_CompleteTypeSelection")
CompleteSelection = Class(name="CompleteSelection")
mutatorenvironment_RemoveCompleteReferenceMutator = Class(name="mutatorenvironment_RemoveCompleteReferenceMutator")
mutatorenvironment_OtherSelection = Class(name="mutatorenvironment_OtherSelection")
mutatorenvironment_OtherTypeSelection = Class(name="mutatorenvironment_OtherTypeSelection")
OtherSelection = Class(name="OtherSelection")
mutatorenvironment_SelectObjectMutator = Class(name="mutatorenvironment_SelectObjectMutator")
mutatorenvironment_UpperStringType = Class(name="mutatorenvironment_UpperStringType")
mutatorenvironment_LowerStringType = Class(name="mutatorenvironment_LowerStringType")
mutatorenvironment_ListStringType = Class(name="mutatorenvironment_ListStringType")
mutatorenvironment_CatStartStringType = Class(name="mutatorenvironment_CatStartStringType")
mutatorenvironment_CatEndStringType = Class(name="mutatorenvironment_CatEndStringType")
mutatorenvironment_AttributeUnset = Class(name="mutatorenvironment_AttributeUnset")
mutatorenvironment_EAttribute = Class(name="mutatorenvironment_EAttribute")
mutatorenvironment_AttributeSwap = Class(name="mutatorenvironment_AttributeSwap")
mutatorenvironment_ReplaceStringType = Class(name="mutatorenvironment_ReplaceStringType")
mutatorenvironment_ReferenceEvaluation = Class(name="mutatorenvironment_ReferenceEvaluation")
mutatorenvironment_Evaluation = Class(name="mutatorenvironment_Evaluation", is_abstract=True)
mutatorenvironment_AttributeEvaluation = Class(name="mutatorenvironment_AttributeEvaluation")
Evaluation = Class(name="Evaluation")
mutatorenvironment_AttributeEvaluationType = Class(name="mutatorenvironment_AttributeEvaluationType", is_abstract=True)
mutatorenvironment_AttributeReverse = Class(name="mutatorenvironment_AttributeReverse")
mutatorenvironment_ReferenceInit = Class(name="mutatorenvironment_ReferenceInit")
ReferenceSet = Class(name="ReferenceSet")
mutatorenvironment_ReferenceAtt = Class(name="mutatorenvironment_ReferenceAtt")
InvariantCS = Class(name="InvariantCS")
mutatorenvironment_RandomType = Class(name="mutatorenvironment_RandomType")
mutatorenvironment_CloneObjectMutator = Class(name="mutatorenvironment_CloneObjectMutator")
mutatorenvironment_BinaryOperator = Class(name="mutatorenvironment_BinaryOperator")
mutatorenvironment_ReferenceSwap = Class(name="mutatorenvironment_ReferenceSwap")
mutatorenvironment_MinValueType = Class(name="mutatorenvironment_MinValueType")
mutatorenvironment_MaxValueType = Class(name="mutatorenvironment_MaxValueType")
mutatorenvironment_NumberType = Class(name="mutatorenvironment_NumberType", is_abstract=True)
mutatorenvironment_AttributeOperation = Class(name="mutatorenvironment_AttributeOperation")
mutatorenvironment_RandomNumberType = Class(name="mutatorenvironment_RandomNumberType", is_abstract=True)
mutatorenvironment_RandomDoubleNumberType = Class(name="mutatorenvironment_RandomDoubleNumberType")
RandomNumberType = Class(name="RandomNumberType")
mutatorenvironment_RandomIntegerNumberType = Class(name="mutatorenvironment_RandomIntegerNumberType")
mutatorenvironment_SpecificClosureSelection = Class(name="mutatorenvironment_SpecificClosureSelection")
mutatorenvironment_ListType = Class(name="mutatorenvironment_ListType")
mutatorenvironment_EObject = Class(name="mutatorenvironment_EObject")
mutatorenvironment_ObjectAttributeType = Class(name="mutatorenvironment_ObjectAttributeType")
mutatorenvironment_TypedSelection = Class(name="mutatorenvironment_TypedSelection")
mutatorenvironment_RandomStringNumberType = Class(name="mutatorenvironment_RandomStringNumberType")
mutatorenvironment_miniOCL_RootCS = Class(name="mutatorenvironment_miniOCL_RootCS")
PackageCS = Class(name="PackageCS")
ConstraintCS = Class(name="ConstraintCS")
mutatorenvironment_miniOCL_PackageCS = Class(name="mutatorenvironment_miniOCL_PackageCS")
ClassCS = Class(name="ClassCS")
mutatorenvironment_miniOCL_ClassCS = Class(name="mutatorenvironment_miniOCL_ClassCS")
PathNameCS = Class(name="PathNameCS")
mutatorenvironment_SelectSampleMutator = Class(name="mutatorenvironment_SelectSampleMutator")
mutatorenvironment_EStructuralFeature = Class(name="mutatorenvironment_EStructuralFeature")
mutatorenvironment_ReferenceAdd = Class(name="mutatorenvironment_ReferenceAdd")
mutatorenvironment_ReferenceRemove = Class(name="mutatorenvironment_ReferenceRemove")
mutatorenvironment_RetypeObjectMutator = Class(name="mutatorenvironment_RetypeObjectMutator")
mutatorenvironment_miniOCL_ParameterCS = Class(name="mutatorenvironment_miniOCL_ParameterCS")
mutatorenvironment_miniOCL_ConstraintCS = Class(name="mutatorenvironment_miniOCL_ConstraintCS")
mutatorenvironment_miniOCL_InvariantCS = Class(name="mutatorenvironment_miniOCL_InvariantCS")
mutatorenvironment_miniOCL_ExpCS = Class(name="mutatorenvironment_miniOCL_ExpCS")
mutatorenvironment_miniOCL_LogicExpCS = Class(name="mutatorenvironment_miniOCL_LogicExpCS")
LogicExpCS = Class(name="LogicExpCS")
CallExpCS = Class(name="CallExpCS")
mutatorenvironment_miniOCL_CallExpCS = Class(name="mutatorenvironment_miniOCL_CallExpCS")
NavigationExpCS = Class(name="NavigationExpCS")
mutatorenvironment_miniOCL_PrimaryExpCS = Class(name="mutatorenvironment_miniOCL_PrimaryExpCS")
mutatorenvironment_miniOCL_NavigationExpCS = Class(name="mutatorenvironment_miniOCL_NavigationExpCS")
PrimaryExpCS = Class(name="PrimaryExpCS")
mutatorenvironment_miniOCL_NameExpCS = Class(name="mutatorenvironment_miniOCL_NameExpCS")
...
mutatorenvironment_miniOCL_PropertyCS = Class(name="mutatorenvironment_miniOCL_PropertyCS")
mutatorenvironment_miniOCL_OperationCS = Class(name="mutatorenvironment_miniOCL_OperationCS")
ParameterCS = Class(name="ParameterCS")
ExpCS = Class(name="ExpCS")
AccVarCS = Class(name="AccVarCS")
mutatorenvironment_miniOCL_AccVarCS = Class(name="mutatorenvironment_miniOCL_AccVarCS")
mutatorenvironment_miniOCL_RoundedBracketClauseCS = Class(name="mutatorenvironment_miniOCL_RoundedBracketClauseCS")
mutatorenvironment_miniOCL_LiteralExpCS = Class(name="mutatorenvironment_miniOCL_LiteralExpCS")
mutatorenvironment_miniOCL_IntLiteralExpCS = Class(name="mutatorenvironment_miniOCL_IntLiteralExpCS")
LiteralExpCS = Class(name="LiteralExpCS")
mutatorenvironment_miniOCL_StringLiteralExpCS = Class(name="mutatorenvironment_miniOCL_StringLiteralExpCS")
mutatorenvironment_miniOCL_BooleanLiteralExpCS = Class(name="mutatorenvironment_miniOCL_BooleanLiteralExpCS")
mutatorenvironment_miniOCL_PathNameCS = Class(name="mutatorenvironment_miniOCL_PathNameCS")
PathCS = Class(name="PathCS")
mutatorenvironment_miniOCL_PathCS = Class(name="mutatorenvironment_miniOCL_PathCS")
mutatorenvironment_miniOCL_PathVariableCS = Class(name="mutatorenvironment_miniOCL_PathVariableCS")
mutatorenvironment_miniOCL_PathElementCS = Class(name="mutatorenvironment_miniOCL_PathElementCS")
miniOCL_mutatorenvironment_EStructuralFeature = Class(name="miniOCL_mutatorenvironment_EStructuralFeature")
mutatorenvironment_miniOCL_BooleanExpCS = Class(name="mutatorenvironment_miniOCL_BooleanExpCS")
BooleanLiteralExpCS = Class(name="BooleanLiteralExpCS")
mutatorenvironment_miniOCL_ExistsExpCS = Class(name="mutatorenvironment_miniOCL_ExistsExpCS")
mutatorenvironment_miniOCL_LoopExpCS = Class(name="mutatorenvironment_miniOCL_LoopExpCS")
IteratorVarCS = Class(name="IteratorVarCS")
mutatorenvironment_miniOCL_CollectExpCS = Class(name="mutatorenvironment_miniOCL_CollectExpCS")
LoopExpCS = Class(name="LoopExpCS")
mutatorenvironment_miniOCL_IteratorVarCS = Class(name="mutatorenvironment_miniOCL_IteratorVarCS")
mutatorenvironment_miniOCL_IterateExpCS = Class(name="mutatorenvironment_miniOCL_IterateExpCS")
mutatorenvironment_miniOCL_NavigationNameExpCS = Class(name="mutatorenvironment_miniOCL_NavigationNameExpCS")
NavigationPathNameCS = Class(name="NavigationPathNameCS")
mutatorenvironment_miniOCL_NavigationPathNameCS = Class(name="mutatorenvironment_miniOCL_NavigationPathNameCS")
NavigationPathCS = Class(name="NavigationPathCS")
mutatorenvironment_miniOCL_NavigationPathCS = Class(name="mutatorenvironment_miniOCL_NavigationPathCS")
mutatorenvironment_miniOCL_NavigationPathVariableCS = Class(name="mutatorenvironment_miniOCL_NavigationPathVariableCS")
mutatorenvironment_miniOCL_NavigationPathElementCS = Class(name="mutatorenvironment_miniOCL_NavigationPathElementCS")
mutatorenvironment_miniOCL_ForAllExpCS = Class(name="mutatorenvironment_miniOCL_ForAllExpCS")
...
mutatorenvironment_Mutator.attributes={mutatorenvironment_Mutator_min, mutatorenvironment_Mutator_fixed, mutatorenvironment_Mutator_max}
...
mutatorenvironment_Block.attributes={mutatorenvironment_Block_max, mutatorenvironment_Block_min, mutatorenvironment_Block_name, mutatorenvironment_Block_description, mutatorenvironment_Block_repeat, mutatorenvironment_Block_fixed}
...
mutatorenvironment_Constraint.attributes={mutatorenvironment_Constraint_id, mutatorenvironment_Constraint_rules}
...
mutatorenvironment_Program.attributes={mutatorenvironment_Program_description, mutatorenvironment_Program_num, mutatorenvironment_Program_output, mutatorenvironment_Program_exhaustive}
...
mutatorenvironment_RandomStringType.attributes={mutatorenvironment_RandomStringType_min, mutatorenvironment_RandomStringType_max, mutatorenvironment_RandomStringType_allowsNull}
...
mutatorenvironment_RandomIntegerType.attributes={mutatorenvironment_RandomIntegerType_allowsNull, mutatorenvironment_RandomIntegerType_min, mutatorenvironment_RandomIntegerType_max}
...
mutatorenvironment_RandomDoubleType.attributes={mutatorenvironment_RandomDoubleType_max, mutatorenvironment_RandomDoubleType_allowsNull, mutatorenvironment_RandomDoubleType_min}
...
mutatorenvironment_RandomStringNumberType.attributes={mutatorenvironment_RandomStringNumberType_min, mutatorenvironment_RandomStringNumberType_max, mutatorenvironment_RandomStringNumberType_allowsNull}
...
from_141: BinaryAssociation = BinaryAssociation(
    name="from_141",
    ends={
...
domain_model = DomainModel(
    ...
    types={mutatorenvironment_MutatorEnvironment, mutatorenvironment_Definition, mutatorenvironment_Mutator, mutatorenvironment_Load, mutatorenvironment_EClass, ObjectEmitter, mutatorenvironment_CompositeMutator, Mutator, mutatorenvironment_CreateObjectMutator, mutatorenvironment_ObSelectionStrategy, mutatorenvironment_AttributeSet, mutatorenvironment_ReferenceSet, mutatorenvironment_EReference, mutatorenvironment_Expression, mutatorenvironment_RandomSelection, ObSelectionStrategy, mutatorenvironment_Block, mutatorenvironment_Constraint, mutatorenvironment_Library, Definition, mutatorenvironment_Program, mutatorenvironment_Source, mutatorenvironment_Resource, mutatorenvironment_ObjectEmitter, mutatorenvironment_SpecificStringType, StringType, mutatorenvironment_RandomStringType, mutatorenvironment_IntegerType, NumberType, mutatorenvironment_SpecificIntegerType, IntegerType, mutatorenvironment_RandomIntegerType, mutatorenvironment_DoubleType, mutatorenvironment_SpecificDoubleType, DoubleType, mutatorenvironment_RandomDoubleType, mutatorenvironment_ModifySourceReferenceMutator, mutatorenvironment_SpecificSelection, mutatorenvironment_SpecificReferenceSelection, mutatorenvironment_RandomTypeSelection, RandomSelection, mutatorenvironment_SpecificObjectSelection, SpecificSelection, mutatorenvironment_AttributeScalar, AttributeSet, mutatorenvironment_AttributeType, AttributeEvaluationType, mutatorenvironment_BooleanType, AttributeType, mutatorenvironment_SpecificBooleanType, BooleanType, mutatorenvironment_RandomBooleanType, mutatorenvironment_StringType, mutatorenvironment_CreateReferenceMutator, mutatorenvironment_RemoveObjectMutator, mutatorenvironment_RemoveReferenceMutator, mutatorenvironment_ModifyInformationMutator, mutatorenvironment_ModifyTargetReferenceMutator, mutatorenvironment_AttributeCopy, mutatorenvironment_RemoveRandomReferenceMutator, RemoveReferenceMutator, mutatorenvironment_RemoveSpecificReferenceMutator, mutatorenvironment_CompleteSelection, mutatorenvironment_CompleteTypeSelection, CompleteSelection, mutatorenvironment_RemoveCompleteReferenceMutator, mutatorenvironment_OtherSelection, mutatorenvironment_OtherTypeSelection, OtherSelection, mutatorenvironment_SelectObjectMutator, mutatorenvironment_UpperStringType, mutatorenvironment_LowerStringType, mutatorenvironment_ListStringType, mutatorenvironment_CatStartStringType, mutatorenvironment_CatEndStringType, mutatorenvironment_AttributeUnset, mutatorenvironment_EAttribute, mutatorenvironment_AttributeSwap, mutatorenvironment_ReplaceStringType, mutatorenvironment_ReferenceEvaluation, mutatorenvironment_Evaluation, mutatorenvironment_AttributeEvaluation, Evaluation, mutatorenvironment_AttributeEvaluationType, mutatorenvironment_AttributeReverse, mutatorenvironment_ReferenceInit, ReferenceSet, mutatorenvironment_ReferenceAtt, InvariantCS, mutatorenvironment_RandomType, mutatorenvironment_CloneObjectMutator, mutatorenvironment_BinaryOperator, mutatorenvironment_ReferenceSwap, mutatorenvironment_MinValueType, mutatorenvironment_MaxValueType, mutatorenvironment_NumberType, mutatorenvironment_AttributeOperation, mutatorenvironment_RandomNumberType, mutatorenvironment_RandomDoubleNumberType, RandomNumberType, mutatorenvironment_RandomIntegerNumberType, mutatorenvironment_SpecificClosureSelection, mutatorenvironment_ListType, mutatorenvironment_EObject, mutatorenvironment_ObjectAttributeType, mutatorenvironment_TypedSelection, mutatorenvironment_RandomStringNumberType, mutatorenvironment_miniOCL_RootCS, PackageCS, ConstraintCS, mutatorenvironment_miniOCL_PackageCS, ClassCS, mutatorenvironment_miniOCL_ClassCS, PathNameCS, mutatorenvironment_SelectSampleMutator, mutatorenvironment_EStructuralFeature, mutatorenvironment_ReferenceAdd, mutatorenvironment_ReferenceRemove, mutatorenvironment_RetypeObjectMutator, mutatorenvironment_miniOCL_ParameterCS, mutatorenvironment_miniOCL_ConstraintCS, mutatorenvironment_miniOCL_InvariantCS, mutatorenvironment_miniOCL_ExpCS, mutatorenvironment_miniOCL_LogicExpCS, LogicExpCS, CallExpCS, mutatorenvironment_miniOCL_CallExpCS, NavigationExpCS, mutatorenvironment_miniOCL_PrimaryExpCS, mutatorenvironment_miniOCL_NavigationExpCS, PrimaryExpCS, mutatorenvironment_miniOCL_NameExpCS, RoundedBracketClauseCS, PropertyCS, OperationCS, mutatorenvironment_miniOCL_PropertyCS, mutatorenvironment_miniOCL_OperationCS, ParameterCS, ExpCS, AccVarCS, mutatorenvironment_miniOCL_AccVarCS, mutatorenvironment_miniOCL_RoundedBracketClauseCS, mutatorenvironment_miniOCL_LiteralExpCS, mutatorenvironment_miniOCL_IntLiteralExpCS, LiteralExpCS, mutatorenvironment_miniOCL_StringLiteralExpCS, mutatorenvironment_miniOCL_BooleanLiteralExpCS, mutatorenvironment_miniOCL_PathNameCS, PathCS, mutatorenvironment_miniOCL_PathCS, mutatorenvironment_miniOCL_PathVariableCS, mutatorenvironment_miniOCL_PathElementCS, miniOCL_mutatorenvironment_EStructuralFeature, mutatorenvironment_miniOCL_BooleanExpCS, BooleanLiteralExpCS, mutatorenvironment_miniOCL_ExistsExpCS, mutatorenvironment_miniOCL_LoopExpCS, IteratorVarCS, mutatorenvironment_miniOCL_CollectExpCS, LoopExpCS, mutatorenvironment_miniOCL_IteratorVarCS, mutatorenvironment_miniOCL_IterateExpCS, mutatorenvironment_miniOCL_NavigationNameExpCS, NavigationPathNameCS, mutatorenvironment_miniOCL_NavigationPathNameCS, NavigationPathCS, mutatorenvironment_miniOCL_NavigationPathCS, mutatorenvironment_miniOCL_NavigationPathVariableCS, mutatorenvironment_miniOCL_NavigationPathElementCS, mutatorenvironment_miniOCL_ForAllExpCS, Repeat, LogicOperator, Operator, ArithmeticOperator, SampleClause},
    associations={definition0, commands1, load3, type12, types13, commands16, container18, attributes19, references21, refType23, expression25, refRefType27, refRefRefType30, blocks5, constraints7, source9, resources10, refType36, source38, newSource41, objSel44, objSel33, value35, source54, target56, refType59, object62, container64, object67, attributes69, references72, refType46, source48, newTarget51, object79, refType81, refType83, container85, refType88, attribute75, object77, value107, name110, refName112, refRefName115, value118, refType121, attName124, attValue127, container90, object92, name95, value97, reference99, object102, attribute105, commands137, from_141, type143, expressions146, object148, first130, operator132, second134, attribute168, attribute170, value172, object174, max176, container150, refType153, attributes156, references159, value162, objSel163, attribute165, container187, refType190, attributes193, references196, path199, packages202, contraints203, packages205, classes207, extends209, objSel179, object181, features183, object185, typeRef222, typeRef224, invariants226, exp229, left231, right232, source234, navExp236, expName238, roundedBrackets240, properties210, operations212, typeRef214, params216, resultRef217, body220, accVar251, accType252, accInitExp254, args257, path259, pathName260, accVars261, callExp242, itVar245, exp246, itType249, accVars273, expName263, roundedBrackets264, callExp267, path270, pathName271},
    generalizations={gen_mutatorenvironment_Mutator_ObjectEmitter, gen_mutatorenvironment_CompositeMutator_Mutator, gen_mutatorenvironment_CreateObjectMutator_Mutator, gen_mutatorenvironment_ObSelectionStrategy_ObjectEmitter, gen_mutatorenvironment_RandomSelection_ObSelectionStrategy, gen_mutatorenvironment_Library_Definition, gen_mutatorenvironment_Program_Definition, gen_mutatorenvironment_StringType_AttributeType, gen_mutatorenvironment_SpecificStringType_StringType, gen_mutatorenvironment_RandomStringType_StringType, gen_mutatorenvironment_IntegerType_NumberType, gen_mutatorenvironment_SpecificIntegerType_IntegerType, gen_mutatorenvironment_RandomIntegerType_IntegerType, gen_mutatorenvironment_DoubleType_NumberType, gen_mutatorenvironment_SpecificDoubleType_DoubleType, gen_mutatorenvironment_RandomDoubleType_DoubleType, gen_mutatorenvironment_ModifySourceReferenceMutator_Mutator, gen_mutatorenvironment_SpecificSelection_ObSelectionStrategy, gen_mutatorenvironment_SpecificReferenceSelection_SpecificSelection, gen_mutatorenvironment_RandomTypeSelection_RandomSelection, gen_mutatorenvironment_SpecificObjectSelection_SpecificSelection, gen_mutatorenvironment_AttributeScalar_AttributeSet, gen_mutatorenvironment_AttributeType_AttributeEvaluationType, gen_mutatorenvironment_BooleanType_AttributeType, gen_mutatorenvironment_SpecificBooleanType_BooleanType, gen_mutatorenvironment_RandomBooleanType_BooleanType, gen_mutatorenvironment_CreateReferenceMutator_Mutator, gen_mutatorenvironment_RemoveObjectMutator_Mutator, gen_mutatorenvironment_RemoveReferenceMutator_Mutator, gen_mutatorenvironment_ModifyInformationMutator_Mutator, gen_mutatorenvironment_ModifyTargetReferenceMutator_Mutator, gen_mutatorenvironment_AttributeCopy_AttributeSet, gen_mutatorenvironment_RemoveRandomReferenceMutator_RemoveReferenceMutator, gen_mutatorenvironment_RemoveSpecificReferenceMutator_RemoveReferenceMutator, gen_mutatorenvironment_CompleteSelection_ObSelectionStrategy, gen_mutatorenvironment_CompleteTypeSelection_CompleteSelection, gen_mutatorenvironment_RemoveCompleteReferenceMutator_RemoveReferenceMutator, gen_mutatorenvironment_OtherSelection_ObSelectionStrategy, gen_mutatorenvironment_OtherTypeSelection_OtherSelection, gen_mutatorenvironment_UpperStringType_StringType, gen_mutatorenvironment_LowerStringType_StringType, gen_mutatorenvironment_ListStringType_AttributeType, gen_mutatorenvironment_CatStartStringType_StringType, gen_mutatorenvironment_CatEndStringType_StringType, gen_mutatorenvironment_AttributeUnset_AttributeSet, gen_mutatorenvironment_AttributeSwap_AttributeSet, gen_mutatorenvironment_ReplaceStringType_StringType, gen_mutatorenvironment_ReferenceEvaluation_Evaluation, gen_mutatorenvironment_SelectObjectMutator_Mutator, gen_mutatorenvironment_AttributeEvaluation_Evaluation, gen_mutatorenvironment_AttributeReverse_AttributeSet, gen_mutatorenvironment_ReferenceInit_ReferenceSet, gen_mutatorenvironment_ReferenceAtt_ReferenceSet, gen_mutatorenvironment_RandomType_AttributeType, gen_mutatorenvironment_CloneObjectMutator_Mutator, gen_mutatorenvironment_ReferenceSwap_ReferenceSet, gen_mutatorenvironment_MinValueType_NumberType, gen_mutatorenvironment_MaxValueType_NumberType, gen_mutatorenvironment_NumberType_AttributeType, gen_mutatorenvironment_AttributeOperation_AttributeSet, gen_mutatorenvironment_RandomNumberType_NumberType, gen_mutatorenvironment_RandomDoubleNumberType_RandomNumberType, gen_mutatorenvironment_RandomIntegerNumberType_RandomNumberType, gen_mutatorenvironment_SpecificClosureSelection_SpecificSelection, gen_mutatorenvironment_ListType_AttributeType, gen_mutatorenvironment_ObjectAttributeType_AttributeEvaluationType, gen_mutatorenvironment_TypedSelection_ObSelectionStrategy, gen_mutatorenvironment_RandomStringNumberType_StringType, gen_mutatorenvironment_Resource_Definition, gen_mutatorenvironment_SelectSampleMutator_Mutator, gen_mutatorenvironment_ReferenceAdd_ReferenceSet, gen_mutatorenvironment_ReferenceRemove_ReferenceSet, gen_mutatorenvironment_RetypeObjectMutator_Mutator, gen_mutatorenvironment_miniOCL_LogicExpCS_ExpCS, gen_mutatorenvironment_miniOCL_CallExpCS_LogicExpCS, gen_mutatorenvironment_miniOCL_PrimaryExpCS_CallExpCS, gen_mutatorenvironment_miniOCL_NavigationExpCS_PrimaryExpCS, gen_mutatorenvironment_miniOCL_NameExpCS_NavigationExpCS, gen_mutatorenvironment_miniOCL_LiteralExpCS_PrimaryExpCS, gen_mutatorenvironment_miniOCL_IntLiteralExpCS_LiteralExpCS, gen_mutatorenvironment_miniOCL_StringLiteralExpCS_LiteralExpCS, gen_mutatorenvironment_miniOCL_BooleanLiteralExpCS_LiteralExpCS, gen_mutatorenvironment_miniOCL_PathVariableCS_PathCS, gen_mutatorenvironment_miniOCL_PathElementCS_PathCS, gen_mutatorenvironment_miniOCL_BooleanExpCS_BooleanLiteralExpCS, gen_mutatorenvironment_miniOCL_ExistsExpCS_LoopExpCS, gen_mutatorenvironment_miniOCL_LoopExpCS_NavigationExpCS, gen_mutatorenvironment_miniOCL_CollectExpCS_LoopExpCS, gen_mutatorenvironment_miniOCL_IterateExpCS_LoopExpCS, gen_mutatorenvironment_miniOCL_NavigationNameExpCS_NavigationExpCS, gen_mutatorenvironment_miniOCL_NavigationPathVariableCS_NavigationPathCS, gen_mutatorenvironment_miniOCL_NavigationPathElementCS_NavigationPathCS, gen_mutatorenvironment_miniOCL_ForAllExpCS_LoopExpCS},
    metadata=None
)
