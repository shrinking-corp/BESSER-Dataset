...
def test_hyp_expression_function_is_not_abstract():
    assert not inspect.isabstract(expression_Function)


def test_hyp_expression_function_constructor_exists():
    assert callable(expression_Function.__init__)


def test_hyp_expression_function_constructor_args():
...
def test_hyp_expression_function_name_setter(instance):
...
def test_expression_Function_name_value_roundtrip():
    instance = expression_Function(name="sample_text")
...
def test_expression_Function_isa_Expression():
    instance = expression_Function(name="sample_text")
...
expression_Function_strategy = st.builds(expression_Function, name=safe_text)
@given(instance=expression_Function_strategy)
@settings(max_examples=25)
