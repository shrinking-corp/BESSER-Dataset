...
# Classes
expression_Function = Class(name="expression_Function")
...
domain_model = DomainModel(
    name="expression",
    types={expression_Function, expression_Expression, expression_Literal, Expression, expression_NullLiteral, Literal, expression_BooleanLiteral, expression_IntegerLiteral, expression_StringLiteral, expression_TimeLiteral, expression_Variable, expression_Predicate, expression_PredicateBooleanOperator, Predicate, expression_PredicateEqualityOperator, expression_PredicateComparisonOperator, expression_PredicateIsOperator, expression_PredicateLikeOperator, expression_PredicateIsEmpty, expression_PredicateIsNull, BooleanOperator, ComparisionOperator},
    associations={expressions0, left1, right2, left5, right7, left10, right12, left15, right17, feature20, feature21},
    generalizations={gen_expression_Function_Expression, gen_expression_Literal_Expression, gen_expression_NullLiteral_Literal, gen_expression_BooleanLiteral_Literal, gen_expression_IntegerLiteral_Literal, gen_expression_StringLiteral_Literal, gen_expression_TimeLiteral_Literal, gen_expression_Variable_Expression, gen_expression_Predicate_Expression, gen_expression_PredicateBooleanOperator_Predicate, gen_expression_PredicateEqualityOperator_Predicate, gen_expression_PredicateComparisonOperator_Predicate, gen_expression_PredicateIsOperator_Predicate, gen_expression_PredicateLikeOperator_Predicate, gen_expression_PredicateIsEmpty_Predicate, gen_expression_PredicateIsNull_Predicate},
    metadata=None
)
