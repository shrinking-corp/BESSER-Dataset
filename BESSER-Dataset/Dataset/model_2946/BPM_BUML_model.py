...
# Classes
slolpBPM_DomainModel = Class(name="slolpBPM_DomainModel")
slolpBPM_Type = Class(name="slolpBPM_Type")
slolpBPM_Datatype = Class(name="slolpBPM_Datatype")
Type = Class(name="Type")
slolpBPM_Entity = Class(name="slolpBPM_Entity")
slolpBPM_Feature = Class(name="slolpBPM_Feature")
...
slolpBPM_Feature.attributes={slolpBPM_Feature_name, slolpBPM_Feature_many}
...
domain_model = DomainModel(
    ...
    associations={elements0, superType2, feautres3, type5},
