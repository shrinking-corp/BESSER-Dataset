...
class eol_module_Import:
    ...
    def __init__(self, imported: str, eol_module_Import: "eol_module_EOLLibraryModule" = None, eol_module_Import7: "eol_module_EOLLibraryModule" = None):
...
class eol_module_EOLLibraryModule:
    ...
    def __init__(self, name: str, eol_module_EOLLibraryModule: set["eol_module_Import"] = None, eol_module_EOLLibraryModule2: set["eol_module_ModelDeclarationStatement"] = None, eol_module_EOLLibraryModule4: set["eol_module_OperationDefinition"] = None, eol_module_EOLLibraryModule8: "eol_module_Import" = None):
        self.name = name
