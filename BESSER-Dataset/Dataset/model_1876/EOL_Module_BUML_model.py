...
# Classes
eol_module_EOLLibraryModule = Class(name="eol_module_EOLLibraryModule")
eol_module_Import = Class(name="eol_module_Import")
eol_module_ModelDeclarationStatement = Class(name="eol_module_ModelDeclarationStatement")
eol_module_OperationDefinition = Class(name="eol_module_OperationDefinition")
eol_module_EOLModule = Class(name="eol_module_EOLModule")
EOLLibraryModule = Class(name="EOLLibraryModule")
eol_module_Block = Class(name="eol_module_Block")
eol_module_Statement = Class(name="eol_module_Statement", is_abstract=True)
eol_module_AnnotationBlock = Class(name="eol_module_AnnotationBlock")
Block = Class(name="Block")
eol_module_ExpressionOrStatementBlock = Class(name="eol_module_ExpressionOrStatementBlock")
eol_module_Expression = Class(name="eol_module_Expression", is_abstract=True)
eol_module_NameExpression = Class(name="eol_module_NameExpression")
eol_module_FormalParameterExpression = Class(name="eol_module_FormalParameterExpression")
Expression = Class(name="Expression")
eol_module_Type = Class(name="eol_module_Type")
...
eol_module_NameExpression.attributes={eol_module_NameExpression_name, eol_module_NameExpression_isType}
...
domain_model = DomainModel(
    name="eol_module",
    types={eol_module_EOLLibraryModule, eol_module_Import, eol_module_ModelDeclarationStatement, eol_module_OperationDefinition, eol_module_EOLModule, EOLLibraryModule, eol_module_Block, eol_module_Statement, eol_module_AnnotationBlock, Block, eol_module_ExpressionOrStatementBlock, eol_module_Expression, eol_module_NameExpression, eol_module_FormalParameterExpression, Expression, eol_module_Type},
    associations={imports0, modelDeclarations1, operations3, block5, importedModule6, statements9, block11, expression13, condition15, name28, parameters30, contextType18, returnType20, annotationBlock23, body25},
