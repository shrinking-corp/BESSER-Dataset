...
class prosjekt_Course:
    ...
    def __init__(self, name: str, code: str, studyPoints: float, Course: "prosjekt_Department" = None, course: "prosjekt_Department" = None, course7: set["prosjekt_Semester"] = None, Course9: "prosjekt_Semester" = None, prosjekt_Course: "prosjekt_CourseCoordinator" = None):
        self.name = name
        self.code = code
