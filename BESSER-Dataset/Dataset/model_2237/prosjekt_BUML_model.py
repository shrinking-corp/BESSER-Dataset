...
# Classes
prosjekt_Department = Class(name="prosjekt_Department")
prosjekt_University = Class(name="prosjekt_University")
prosjekt_Course = Class(name="prosjekt_Course")
prosjekt_Person = Class(name="prosjekt_Person")
prosjekt_Semester = Class(name="prosjekt_Semester")
prosjekt_CourseCoordinator = Class(name="prosjekt_CourseCoordinator")
...
prosjekt_Department.attributes={prosjekt_Department_shortName, prosjekt_Department_name}
...
prosjekt_University.attributes={prosjekt_University_shortName, prosjekt_University_name}
...
prosjekt_Course.attributes={prosjekt_Course_code, prosjekt_Course_name, prosjekt_Course_studyPoints}
...
prosjekt_Semester.attributes={prosjekt_Semester_averageGrade, prosjekt_Semester_amountF, prosjekt_Semester_name, prosjekt_Semester_amountA, prosjekt_Semester_amountD, prosjekt_Semester_amountB, prosjekt_Semester_amountE, prosjekt_Semester_amountC}
...
domain_model = DomainModel(
    ...
    associations={departments0, university1, course2, staff3, department4, semester6, course8, worksForDepartment10, roles12, course13, person14},
    generalizations={},
    metadata=None
)
