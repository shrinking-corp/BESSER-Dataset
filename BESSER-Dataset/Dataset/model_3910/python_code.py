...
class entity_pc_av_ComposedProvidingRequiringEntity:
    ...
    pass
class pcm_pc_av_repository_pc_av_CompositeComponent(entity_pc_av_ComposedProvidingRequiringEntity, repository_pc_av_ImplementationComponentType):

    def __init__(self):
        
        pass
    def RequireSameInterfaces(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
        # TODO: Implement RequireSameInterfaces method
        pass

    def ProvideSameInterfaces(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
...
class pcm_pc_av_repository_pc_av_OperationSignature(Signature):
    ...
    def __init__(self, signatures__OperationInterface: "OperationInterface" = None, operationSignature__Parameter: set["Parameter"] = None, pcm_pc_av_repository_pc_av_OperationSignature: "DataType" = None, Signature431: "pcm_pc_av_qosannotations_pc_av_SpecifiedQoSAnnotation" = None, Signature440: "pcm_pc_av_qosannotations_pc_av_SpecifiedOutputParameterAbstraction" = None, Signature: "pcm_pc_av_seff_pc_av_ServiceEffectSpecification" = None):
    ...
    def operationSignature__Parameter(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_repository_pc_av_OperationSignature__operationSignature__Parameter", None)
    ...
    def signatures__OperationInterface(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_repository_pc_av_OperationSignature__signatures__OperationInterface", None)
    ...
    def ParameterNamesHaveToBeUniqueForASignature(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
...
class pcm_pc_av_repository_pc_av_RequiredCharacterisation:
    ...
    def __init__(self, type: str, pcm_pc_av_repository_pc_av_RequiredCharacterisation: "Parameter" = None, requiredCharacterisations: "Interface" = None):
        self.type = type
    ...
    def requiredCharacterisations(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_repository_pc_av_RequiredCharacterisation__requiredCharacterisations", None)
...
class pcm_pc_av_repository_pc_av_PrimitiveDataType(DataType):
    ...
    def __init__(self, type: str, DataType261: "pcm_pc_av_repository_pc_av_OperationSignature" = None, DataType280: "pcm_pc_av_repository_pc_av_InnerDeclaration" = None, DataType: "pcm_pc_av_repository_pc_av_Parameter" = None, DataType276: "pcm_pc_av_repository_pc_av_CollectionDataType" = None, DataType228: "pcm_pc_av_repository_pc_av_Repository" = None):
        self.type = type
...
class pcm_pc_av_repository_pc_av_Parameter:
    ...
    def __init__(self, modifier__Parameter: str, parameterName: str, parameter__ResourceSignature: "ResourceSignature" = None, pcm_pc_av_repository_pc_av_Parameter: "DataType" = None, parameters__InfrastructureSignature: "InfrastructureSignature" = None, parameters__OperationSignature: "OperationSignature" = None, parameter__EventType: "EventType" = None):
    ...
    def parameter__EventType(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_repository_pc_av_Parameter__parameter__EventType", None)
    ...
    def parameter__ResourceSignature(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_repository_pc_av_Parameter__parameter__ResourceSignature", None)
    ...
    def parameters__InfrastructureSignature(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_repository_pc_av_Parameter__parameters__InfrastructureSignature", None)
    ...
    def parameters__OperationSignature(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_repository_pc_av_Parameter__parameters__OperationSignature", None)
...
class Repository:
    ...
    pass
class pcm_pc_av_completions_pc_av_Completion(entity_pc_av_ComposedProvidingRequiringEntity, repository_pc_av_ImplementationComponentType):

    pass
class repository_pc_av_RepositoryComponent:

    pass
class pcm_pc_av_subsystem_pc_av_SubSystem(entity_pc_av_ComposedProvidingRequiringEntity, repository_pc_av_RepositoryComponent):
...
class pcm_pc_av_qos_performance_pc_av_SystemSpecifiedExecutionTime(SpecifiedExecutionTime):
    ...
    def __init__(self):
        ...
        pass
    def SystemSpecifiedExecutionTimeMustReferenceRequiredRoleOfASystem(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
...
class pcm_pc_av_qos_reliability_pc_av_SpecifiedReliabilityAnnotation(SpecifiedQoSAnnotation):
    ...
    def __init__(self, specifiedReliabilityAnnotation__ExternalFailureOccurrenceDescription: set["ExternalFailureOccurrenceDescription"] = None, SpecifiedQoSAnnotation: "pcm_pc_av_qosannotations_pc_av_QoSAnnotations" = None):
    ...
    def specifiedReliabilityAnnotation__ExternalFailureOccurrenceDescription(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_qos_reliability_pc_av_SpecifiedReliabilityAnnotation__specifiedReliabilityAnnotation__ExternalFailureOccurrenceDescription", None)
    ...
    def SumOfReliabilityAnnotationFailureProbabilitiesMustNotExceed1(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
        # TODO: Implement SumOfReliabilityAnnotationFailureProbabilitiesMustNotExceed1 method
        pass

    def SpecifiedReliabilityAnnotationMustReferenceRequiredRoleOfASystem(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
        # TODO: Implement SpecifiedReliabilityAnnotationMustReferenceRequiredRoleOfASystem method
        pass

    def MultipleExternalOccurrenceDescriptionsPerFailureTypeNotAllowed(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
...
class pcm_pc_av_seff_performance_pc_av_ParametricResourceDemand:
    ...
    def __init__(self, pcm_pc_av_seff_performance_pc_av_ParametricResourceDemand: "ProcessingResourceType" = None, resourceDemand_Action: "AbstractInternalControlFlowAction" = None, parametricResourceDemand_PCMRandomVariable: "PCMRandomVariable" = None):
    ...
    def parametricResourceDemand_PCMRandomVariable(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_seff_performance_pc_av_ParametricResourceDemand__parametricResourceDemand_PCMRandomVariable", None)
    ...
    def resourceDemand_Action(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_seff_performance_pc_av_ParametricResourceDemand__resourceDemand_Action", None)
    ...
    def DemandedProcessingResourceMustBeUniqueWithinAbstractInternalControlFlowAction(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
...
class seff_pc_av_CallAction:
    ...
    pass
class pcm_pc_av_seff_pc_av_InternalCallAction(seff_pc_av_CallAction, seff_pc_av_AbstractInternalControlFlowAction):
...
class seff_pc_av_AbstractAction:
    ...
    pass
class pcm_pc_av_seff_pc_av_EmitEventAction(seff_pc_av_CallAction, seff_pc_av_AbstractAction):

    pass
class pcm_pc_av_seff_pc_av_ExternalCallAction(seff_pc_av_CallReturnAction, seff_pc_av_AbstractAction, seff_reliability_pc_av_FailureHandlingEntity):

    def __init__(self, retryCount: int, pcm_pc_av_seff_pc_av_ExternalCallAction379: "OperationRequiredRole" = None, pcm_pc_av_seff_pc_av_ExternalCallAction: "OperationSignature" = None):
        self.retryCount = retryCount
        self.pcm_pc_av_seff_pc_av_ExternalCallAction379 = pcm_pc_av_seff_pc_av_ExternalCallAction379
    ...
    @property
    def pcm_pc_av_seff_pc_av_ExternalCallAction379(self):
        return self.__pcm_pc_av_seff_pc_av_ExternalCallAction379

    @pcm_pc_av_seff_pc_av_ExternalCallAction379.setter
    def pcm_pc_av_seff_pc_av_ExternalCallAction379(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_seff_pc_av_ExternalCallAction__pcm_pc_av_seff_pc_av_ExternalCallAction379", None)
        self.__pcm_pc_av_seff_pc_av_ExternalCallAction379 = value
    ...
    def OperationRequiredRoleMustBeReferencedByContainer(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
        # TODO: Implement OperationRequiredRoleMustBeReferencedByContainer method
        pass

    def SignatureBelongsToRole(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
...
class pcm_pc_av_seff_reliability_pc_av_RecoveryActionBehaviour(seff_reliability_pc_av_FailureHandlingEntity, seff_pc_av_ResourceDemandingBehaviour):
    ...
    def __init__(self, pcm_pc_av_seff_reliability_pc_av_RecoveryActionBehaviour: set["seff_reliability_pc_av_RecoveryActionBehaviour"] = None, recoveryActionBehaviours__RecoveryAction: "seff_reliability_pc_av_RecoveryAction" = None):
    ...
    def recoveryActionBehaviours__RecoveryAction(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_seff_reliability_pc_av_RecoveryActionBehaviour__recoveryActionBehaviours__RecoveryAction", None)
    ...
    def SuccessorsOfRecoveryActionBehaviourHandleDisjointFailureTypes(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
        # TODO: Implement SuccessorsOfRecoveryActionBehaviourHandleDisjointFailureTypes method
        pass

    def RecoveryActionBehaviourHasOnlyOnePredecessor(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
        # TODO: Implement RecoveryActionBehaviourHasOnlyOnePredecessor method
        pass

    def RecoveryActionBehaviourIsNotSuccessorOfItself(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
...
class pcm_pc_av_seff_pc_av_ServiceEffectSpecification:
    ...
    def __init__(self, seffTypeID: str, pcm_pc_av_seff_pc_av_ServiceEffectSpecification: "Signature" = None, serviceEffectSpecifications__BasicComponent: "BasicComponent" = None):
    ...
    def serviceEffectSpecifications__BasicComponent(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_seff_pc_av_ServiceEffectSpecification__serviceEffectSpecifications__BasicComponent", None)
    ...
    def ReferencedSignatureMustBelongToInterfaceReferencedByProvidedRole(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
...
class pcm_pc_av_seff_pc_av_ProbabilisticBranchTransition(AbstractBranchTransition):
    ...
    def __init__(self, branchProbability: float, AbstractBranchTransition: "pcm_pc_av_seff_pc_av_ResourceDemandingBehaviour" = None, AbstractBranchTransition352: "pcm_pc_av_seff_pc_av_BranchAction" = None):
...
class pcm_pc_av_reliability_pc_av_NetworkInducedFailureType(FailureType):
    ...
    def __init__(self, networkInducedFailureType__CommunicationLinkResourceType: "CommunicationLinkResourceType" = None, FailureType326: "pcm_pc_av_reliability_pc_av_ExternalFailureOccurrenceDescription" = None, FailureType429: "pcm_pc_av_seff_reliability_pc_av_FailureHandlingEntity" = None, FailureType: "pcm_pc_av_repository_pc_av_Repository" = None, FailureType248: "pcm_pc_av_repository_pc_av_Signature" = None):
    ...
    def networkInducedFailureType__CommunicationLinkResourceType(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_reliability_pc_av_NetworkInducedFailureType__networkInducedFailureType__CommunicationLinkResourceType", None)
    ...
    def NetworkInducedFailureTypeHasCommunicationLinkResourceType(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
...
class pcm_pc_av_seff_pc_av_InternalAction(AbstractInternalControlFlowAction):
    ...
    def __init__(self, internalAction__InternalFailureOccurrenceDescription: set["InternalFailureOccurrenceDescription"] = None, AbstractInternalControlFlowAction422: "pcm_pc_av_seff_performance_pc_av_ParametricResourceDemand" = None, AbstractInternalControlFlowAction409: "pcm_pc_av_seff_performance_pc_av_ResourceCall" = None, AbstractInternalControlFlowAction: "pcm_pc_av_seff_performance_pc_av_InfrastructureCall" = None):
    ...
    def internalAction__InternalFailureOccurrenceDescription(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_seff_pc_av_InternalAction__internalAction__InternalFailureOccurrenceDescription", None)
    ...
    def SumOfInternalActionFailureProbabilitiesMustNotExceed1(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
        # TODO: Implement SumOfInternalActionFailureProbabilitiesMustNotExceed1 method
        pass

    def MultipleInternalOccurrenceDescriptionsPerFailureTypeNotAllowed(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
...
class pcm_pc_av_seff_reliability_pc_av_RecoveryAction(AbstractInternalControlFlowAction):
    ...
    def __init__(self, pcm_pc_av_seff_reliability_pc_av_RecoveryAction: "seff_reliability_pc_av_RecoveryActionBehaviour" = None, recoveryAction__RecoveryActionBehaviour: set["seff_reliability_pc_av_RecoveryActionBehaviour"] = None, AbstractInternalControlFlowAction422: "pcm_pc_av_seff_performance_pc_av_ParametricResourceDemand" = None, AbstractInternalControlFlowAction409: "pcm_pc_av_seff_performance_pc_av_ResourceCall" = None, AbstractInternalControlFlowAction: "pcm_pc_av_seff_performance_pc_av_InfrastructureCall" = None):
    ...
    def recoveryAction__RecoveryActionBehaviour(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_seff_reliability_pc_av_RecoveryAction__recoveryAction__RecoveryActionBehaviour", None)
    ...
    def pcm_pc_av_seff_reliability_pc_av_RecoveryAction(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "seff_reliability_pc_av_RecoveryActionBehaviour426"):
                opp_val = getattr(old_value, "seff_reliability_pc_av_RecoveryActionBehaviour426", None)
                if opp_val == self:
                    setattr(old_value, "seff_reliability_pc_av_RecoveryActionBehaviour426", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "seff_reliability_pc_av_RecoveryActionBehaviour426"):
                opp_val = getattr(value, "seff_reliability_pc_av_RecoveryActionBehaviour426", None)
                setattr(value, "seff_reliability_pc_av_RecoveryActionBehaviour426", self)

    def PrimaryBehaviourOfRecoveryActionMustBeSet(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
...
class pcm_pc_av_seff_pc_av_BranchAction(AbstractInternalControlFlowAction):
    ...
    def __init__(self, branchAction_AbstractBranchTransition: set["AbstractBranchTransition"] = None, AbstractInternalControlFlowAction422: "pcm_pc_av_seff_performance_pc_av_ParametricResourceDemand" = None, AbstractInternalControlFlowAction409: "pcm_pc_av_seff_performance_pc_av_ResourceCall" = None, AbstractInternalControlFlowAction: "pcm_pc_av_seff_performance_pc_av_InfrastructureCall" = None):
    ...
    def branchAction_AbstractBranchTransition(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_seff_pc_av_BranchAction__branchAction_AbstractBranchTransition", None)
    ...
    def EitherGuardedBranchesOrProbabilisiticBranchTransitions(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
        # TODO: Implement EitherGuardedBranchesOrProbabilisiticBranchTransitions method
        pass

    def AllProbabilisticBranchProbabilitiesMustSumUpTo1(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
...
class pcm_pc_av_seff_pc_av_StartAction(AbstractInternalControlFlowAction):
    ...
    def __init__(self, AbstractInternalControlFlowAction422: "pcm_pc_av_seff_performance_pc_av_ParametricResourceDemand" = None, AbstractInternalControlFlowAction409: "pcm_pc_av_seff_performance_pc_av_ResourceCall" = None, AbstractInternalControlFlowAction: "pcm_pc_av_seff_performance_pc_av_InfrastructureCall" = None):
        
        pass
    def StartActionPredecessorMustNotBeDefined(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
...
class pcm_pc_av_seff_pc_av_AcquireAction(AbstractInternalControlFlowAction):
    ...
    def __init__(self, timeout: bool, timeoutValue: float, pcm_pc_av_seff_pc_av_AcquireAction: "PassiveResource" = None, AbstractInternalControlFlowAction422: "pcm_pc_av_seff_performance_pc_av_ParametricResourceDemand" = None, AbstractInternalControlFlowAction409: "pcm_pc_av_seff_performance_pc_av_ResourceCall" = None, AbstractInternalControlFlowAction: "pcm_pc_av_seff_performance_pc_av_InfrastructureCall" = None):
    ...
    def TimeoutValueOfAcquireActionMustNotBeNegative(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
...
class pcm_pc_av_seff_pc_av_StopAction(AbstractInternalControlFlowAction):
    ...
    def __init__(self, AbstractInternalControlFlowAction422: "pcm_pc_av_seff_performance_pc_av_ParametricResourceDemand" = None, AbstractInternalControlFlowAction409: "pcm_pc_av_seff_performance_pc_av_ResourceCall" = None, AbstractInternalControlFlowAction: "pcm_pc_av_seff_performance_pc_av_InfrastructureCall" = None):
        ...
        pass
    def StopActionSuccessorMustNotBeDefined(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
...
class pcm_pc_av_reliability_pc_av_HardwareInducedFailureType(FailureType):
    ...
    def __init__(self, hardwareInducedFailureType__ProcessingResourceType: "ProcessingResourceType" = None, FailureType326: "pcm_pc_av_reliability_pc_av_ExternalFailureOccurrenceDescription" = None, FailureType429: "pcm_pc_av_seff_reliability_pc_av_FailureHandlingEntity" = None, FailureType: "pcm_pc_av_repository_pc_av_Repository" = None, FailureType248: "pcm_pc_av_repository_pc_av_Signature" = None):
    ...
    def hardwareInducedFailureType__ProcessingResourceType(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_reliability_pc_av_HardwareInducedFailureType__hardwareInducedFailureType__ProcessingResourceType", None)
    ...
    def HardwareInducedFailureTypeHasProcessingResourceType(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
...
class pcm_pc_av_reliability_pc_av_FailureOccurrenceDescription:
    ...
    def EnsureValidFailureProbabilityRange(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
...
class pcm_pc_av_reliability_pc_av_ExternalFailureOccurrenceDescription(FailureOccurrenceDescription):
    ...
    def __init__(self, pcm_pc_av_reliability_pc_av_ExternalFailureOccurrenceDescription: "FailureType" = None, externalFailureOccurrenceDescriptions__SpecifiedReliabilityAnnotation: "qos_reliability_pc_av_SpecifiedReliabilityAnnotation" = None):
    ...
    def externalFailureOccurrenceDescriptions__SpecifiedReliabilityAnnotation(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_reliability_pc_av_ExternalFailureOccurrenceDescription__externalFailureOccurrenceDescriptions__SpecifiedReliabilityAnnotation", None)
    ...
    def NoResourceTimeoutFailureAllowedForExternalFailureOccurrenceDescription(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
...
class pcm_pc_av_reliability_pc_av_InternalFailureOccurrenceDescription(FailureOccurrenceDescription):
    ...
    def internalFailureOccurrenceDescriptions__SoftwareInducedFailureType(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_reliability_pc_av_InternalFailureOccurrenceDescription__internalFailureOccurrenceDescriptions__SoftwareInducedFailureType", None)
    ...
    def internalFailureOccurrenceDescriptions__InternalAction(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_reliability_pc_av_InternalFailureOccurrenceDescription__internalFailureOccurrenceDescriptions__InternalAction", None)
    ...
    def NoResourceTimeoutFailureAllowedForInternalFailureOccurrenceDescription(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
...
class pcm_pc_av_seff_performance_pc_av_ResourceCall(CallAction):
    ...
    def __init__(self, resourceCall__Action: "AbstractInternalControlFlowAction" = None, pcm_pc_av_seff_performance_pc_av_ResourceCall: "entity_pc_av_ResourceRequiredRole" = None, pcm_pc_av_seff_performance_pc_av_ResourceCall413: "ResourceSignature" = None, resourceCall__PCMRandomVariable: "PCMRandomVariable" = None, CallAction: "pcm_pc_av_parameter_pc_av_VariableUsage" = None):
        ...
        self.pcm_pc_av_seff_performance_pc_av_ResourceCall413 = pcm_pc_av_seff_performance_pc_av_ResourceCall413
    ...
    def pcm_pc_av_seff_performance_pc_av_ResourceCall(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "entity_pc_av_ResourceRequiredRole411"):
                opp_val = getattr(old_value, "entity_pc_av_ResourceRequiredRole411", None)
                if opp_val == self:
                    setattr(old_value, "entity_pc_av_ResourceRequiredRole411", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "entity_pc_av_ResourceRequiredRole411"):
                opp_val = getattr(value, "entity_pc_av_ResourceRequiredRole411", None)
                setattr(value, "entity_pc_av_ResourceRequiredRole411", self)

    @property
    def pcm_pc_av_seff_performance_pc_av_ResourceCall413(self):
        return self.__pcm_pc_av_seff_performance_pc_av_ResourceCall413

    @pcm_pc_av_seff_performance_pc_av_ResourceCall413.setter
    def pcm_pc_av_seff_performance_pc_av_ResourceCall413(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_seff_performance_pc_av_ResourceCall__pcm_pc_av_seff_performance_pc_av_ResourceCall413", None)
        self.__pcm_pc_av_seff_performance_pc_av_ResourceCall413 = value
    ...
    def resourceCall__PCMRandomVariable(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_seff_performance_pc_av_ResourceCall__resourceCall__PCMRandomVariable", None)
    ...
    def resourceCall__Action(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_seff_performance_pc_av_ResourceCall__resourceCall__Action", None)
    ...
    def ResourceRequiredRoleMustBeReferencedByComponent(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
        # TODO: Implement ResourceRequiredRoleMustBeReferencedByComponent method
        pass

    def ResourceSignatureBelongsToResourceRequiredRole(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
        # TODO: Implement ResourceSignatureBelongsToResourceRequiredRole method
        pass

    def SignatureRoleCombinationMustBeUniqueWithinAbstractInternalControlFlowAction(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
...
class pcm_pc_av_seff_performance_pc_av_InfrastructureCall(CallAction):
    ...
    def __init__(self, pcm_pc_av_seff_performance_pc_av_InfrastructureCall: "InfrastructureSignature" = None, infrastructureCall__PCMRandomVariable: "PCMRandomVariable" = None, infrastructureCall__Action: "AbstractInternalControlFlowAction" = None, pcm_pc_av_seff_performance_pc_av_InfrastructureCall406: "InfrastructureRequiredRole" = None, CallAction: "pcm_pc_av_parameter_pc_av_VariableUsage" = None):
        ...
        self.pcm_pc_av_seff_performance_pc_av_InfrastructureCall406 = pcm_pc_av_seff_performance_pc_av_InfrastructureCall406
    ...
    def infrastructureCall__PCMRandomVariable(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_seff_performance_pc_av_InfrastructureCall__infrastructureCall__PCMRandomVariable", None)
    ...
    def infrastructureCall__Action(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_seff_performance_pc_av_InfrastructureCall__infrastructureCall__Action", None)
    ...
    @property
    def pcm_pc_av_seff_performance_pc_av_InfrastructureCall406(self):
        return self.__pcm_pc_av_seff_performance_pc_av_InfrastructureCall406

    @pcm_pc_av_seff_performance_pc_av_InfrastructureCall406.setter
    def pcm_pc_av_seff_performance_pc_av_InfrastructureCall406(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_seff_performance_pc_av_InfrastructureCall__pcm_pc_av_seff_performance_pc_av_InfrastructureCall406", None)
        self.__pcm_pc_av_seff_performance_pc_av_InfrastructureCall406 = value
    ...
    def SignatureMustBelongToUsedRequiredRole(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
        # TODO: Implement SignatureMustBelongToUsedRequiredRole method
        pass

    def SignatureRoleCombinationMustBeUniqueWithinAbstractInternalControlFlowAction(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
        # TODO: Implement SignatureRoleCombinationMustBeUniqueWithinAbstractInternalControlFlowAction method
        pass

    def ReferencedRequiredRoleMustBeRequiredByComponent(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
...
class pcm_pc_av_parameter_pc_av_VariableCharacterisation:
    ...
    def variableCharacterisation_VariableUsage(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_parameter_pc_av_VariableCharacterisation__variableCharacterisation_VariableUsage", None)
    ...
    def variableCharacterisation_Specification(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_parameter_pc_av_VariableCharacterisation__variableCharacterisation_Specification", None)
...
class pcm_pc_av_repository_pc_av_OperationInterface(Interface):
    ...
    def __init__(self, interface__OperationSignature: set["OperationSignature"] = None, Interface: "pcm_pc_av_repository_pc_av_Repository" = None, Interface230: "pcm_pc_av_repository_pc_av_Interface" = None, Interface238: "pcm_pc_av_repository_pc_av_RequiredCharacterisation" = None):
    ...
    def interface__OperationSignature(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_repository_pc_av_OperationInterface__interface__OperationSignature", None)
    ...
    def SignaturesHaveToBeUniqueForAnInterface(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
...
class pcm_pc_av_repository_pc_av_BasicComponent(ImplementationComponentType):
    ...
    def basicComponent_ServiceEffectSpecification(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_repository_pc_av_BasicComponent__basicComponent_ServiceEffectSpecification", None)
    ...
    def basicComponent_PassiveResource(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_repository_pc_av_BasicComponent__basicComponent_PassiveResource", None)
    ...
    def NoSeffTypeUsedTwice(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
        # TODO: Implement NoSeffTypeUsedTwice method
        pass

    def RequireSameInterfacesAsImplementationType(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
        # TODO: Implement RequireSameInterfacesAsImplementationType method
        pass

    def ProvideSameInterfacesAsImplementationType(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
...
class pcm_pc_av_usagemodel_pc_av_BranchTransition:
    ...
    def branchTransition_ScenarioBehaviour(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_usagemodel_pc_av_BranchTransition__branchTransition_ScenarioBehaviour", None)
    ...
    def branchTransitions_Branch(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_usagemodel_pc_av_BranchTransition__branchTransitions_Branch", None)
...
class pcm_pc_av_usagemodel_pc_av_Start(AbstractUserAction):
    ...
    def __init__(self, AbstractUserAction177: "pcm_pc_av_usagemodel_pc_av_AbstractUserAction" = None, AbstractUserAction: "pcm_pc_av_usagemodel_pc_av_AbstractUserAction" = None, AbstractUserAction186: "pcm_pc_av_usagemodel_pc_av_ScenarioBehaviour" = None):
        
        pass
    def StartHasNoPredecessor(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
...
class pcm_pc_av_usagemodel_pc_av_Stop(AbstractUserAction):
    ...
    def __init__(self, AbstractUserAction177: "pcm_pc_av_usagemodel_pc_av_AbstractUserAction" = None, AbstractUserAction: "pcm_pc_av_usagemodel_pc_av_AbstractUserAction" = None, AbstractUserAction186: "pcm_pc_av_usagemodel_pc_av_ScenarioBehaviour" = None):
        ...
        pass
    def StopHasNoSuccessor(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
        # TODO: Implement StopHasNoSuccessor method
        pass

class pcm_pc_av_usagemodel_pc_av_Branch(AbstractUserAction):

    def __init__(self, branch_BranchTransition: set["BranchTransition"] = None, AbstractUserAction177: "pcm_pc_av_usagemodel_pc_av_AbstractUserAction" = None, AbstractUserAction: "pcm_pc_av_usagemodel_pc_av_AbstractUserAction" = None, AbstractUserAction186: "pcm_pc_av_usagemodel_pc_av_ScenarioBehaviour" = None):
    ...
    def branch_BranchTransition(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_usagemodel_pc_av_Branch__branch_BranchTransition", None)
    ...
    def AllBranchProbabilitiesMustSumUpTo1(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
...
class pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall(AbstractUserAction):
    ...
    def __init__(self, priority: int, entryLevelSystemCall_InputParameterUsage: set["VariableUsage"] = None, pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall: "OperationProvidedRole" = None, pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall170: "OperationSignature" = None, entryLevelSystemCall_OutputParameterUsage: set["VariableUsage"] = None, AbstractUserAction177: "pcm_pc_av_usagemodel_pc_av_AbstractUserAction" = None, AbstractUserAction: "pcm_pc_av_usagemodel_pc_av_AbstractUserAction" = None, AbstractUserAction186: "pcm_pc_av_usagemodel_pc_av_ScenarioBehaviour" = None):
        ...
        self.pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall170 = pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall170
    ...
    def entryLevelSystemCall_OutputParameterUsage(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall__entryLevelSystemCall_OutputParameterUsage", None)
    ...
    def entryLevelSystemCall_InputParameterUsage(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall__entryLevelSystemCall_InputParameterUsage", None)
    ...
    @property
    def pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall170(self):
        return self.__pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall170

    @pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall170.setter
    def pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall170(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall__pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall170", None)
        self.__pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall170 = value
    ...
    def EntryLevelSystemCallSignatureMustMatchItsProvidedRole(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
        # TODO: Implement EntryLevelSystemCallSignatureMustMatchItsProvidedRole method
        pass

    def EntryLevelSystemCallMustReferenceProvidedRoleOfASystem(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
...
class pcm_pc_av_usagemodel_pc_av_ClosedWorkload(Workload):
    ...
    def __init__(self, population: int, closedWorkload_PCMRandomVariable: "PCMRandomVariable" = None, Workload: "pcm_pc_av_usagemodel_pc_av_UsageScenario" = None):
    ...
    def closedWorkload_PCMRandomVariable(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_usagemodel_pc_av_ClosedWorkload__closedWorkload_PCMRandomVariable", None)
    ...
    def PopulationInClosedWorkloadNeedsToBeSpecified(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
        # TODO: Implement PopulationInClosedWorkloadNeedsToBeSpecified method
        pass

    def ThinkTimeInClosedWorkloadNeedsToBeSpecified(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
        # TODO: Implement ThinkTimeInClosedWorkloadNeedsToBeSpecified method
        pass

class pcm_pc_av_usagemodel_pc_av_OpenWorkload(Workload):

    def __init__(self, openWorkload_PCMRandomVariable: "PCMRandomVariable" = None, Workload: "pcm_pc_av_usagemodel_pc_av_UsageScenario" = None):
    ...
    def openWorkload_PCMRandomVariable(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_usagemodel_pc_av_OpenWorkload__openWorkload_PCMRandomVariable", None)
    ...
    def InterArrivalTimeInOpenWorkloadNeedsToBeSpecified(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
...
class pcm_pc_av_repository_pc_av_CompleteComponentType(RepositoryComponent):
    ...
    def __init__(self, pcm_pc_av_repository_pc_av_CompleteComponentType: set["ProvidesComponentType"] = None, RepositoryComponent: "pcm_pc_av_composition_pc_av_AssemblyContext" = None, RepositoryComponent224: "pcm_pc_av_repository_pc_av_Repository" = None):
    ...
    def AtLeastOneInterfaceHasToBeProvidedOrRequiredByAUsefullCompleteComponentType(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
        # TODO: Implement AtLeastOneInterfaceHasToBeProvidedOrRequiredByAUsefullCompleteComponentType method
        pass

    def providedInterfacesHaveToConformToProvidedType2(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
...
class pcm_pc_av_repository_pc_av_ProvidesComponentType(RepositoryComponent):
    ...
    def __init__(self, RepositoryComponent: "pcm_pc_av_composition_pc_av_AssemblyContext" = None, RepositoryComponent224: "pcm_pc_av_repository_pc_av_Repository" = None):
        
        pass
    def AtLeastOneInterfaceHasToBeProvidedByAUsefullProvidesComponentType(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
...
class pcm_pc_av_repository_pc_av_ImplementationComponentType(RepositoryComponent):
    ...
    def __init__(self, componentType: str, pcm_pc_av_repository_pc_av_ImplementationComponentType: set["CompleteComponentType"] = None, pcm_pc_av_repository_pc_av_ImplementationComponentType211: set["VariableUsage"] = None, RepositoryComponent: "pcm_pc_av_composition_pc_av_AssemblyContext" = None, RepositoryComponent224: "pcm_pc_av_repository_pc_av_Repository" = None):
        ...
        self.pcm_pc_av_repository_pc_av_ImplementationComponentType211 = pcm_pc_av_repository_pc_av_ImplementationComponentType211 if pcm_pc_av_repository_pc_av_ImplementationComponentType211 is not None else set()
    ...
    @property
    def pcm_pc_av_repository_pc_av_ImplementationComponentType211(self):
        return self.__pcm_pc_av_repository_pc_av_ImplementationComponentType211

    @pcm_pc_av_repository_pc_av_ImplementationComponentType211.setter
    def pcm_pc_av_repository_pc_av_ImplementationComponentType211(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_repository_pc_av_ImplementationComponentType__pcm_pc_av_repository_pc_av_ImplementationComponentType211", None)
        self.__pcm_pc_av_repository_pc_av_ImplementationComponentType211 = value if value is not None else set()
    ...
    def providedInterfacesHaveToConformToCompleteType(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
        # TODO: Implement providedInterfacesHaveToConformToCompleteType method
        pass

    def RequiredInterfacesHaveToConformToCompleteType(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
        # TODO: Implement RequiredInterfacesHaveToConformToCompleteType method
        pass

    def ProvidedInterfaceHaveToConformToComponentType(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
...
class pcm_pc_av_composition_pc_av_RequiredDelegationConnector(DelegationConnector):
    ...
    def __init__(self, pcm_pc_av_composition_pc_av_RequiredDelegationConnector: "OperationRequiredRole" = None, pcm_pc_av_composition_pc_av_RequiredDelegationConnector72: "OperationRequiredRole" = None, pcm_pc_av_composition_pc_av_RequiredDelegationConnector75: "composition_pc_av_AssemblyContext" = None):
        self.pcm_pc_av_composition_pc_av_RequiredDelegationConnector = pcm_pc_av_composition_pc_av_RequiredDelegationConnector
        self.pcm_pc_av_composition_pc_av_RequiredDelegationConnector72 = pcm_pc_av_composition_pc_av_RequiredDelegationConnector72
        self.pcm_pc_av_composition_pc_av_RequiredDelegationConnector75 = pcm_pc_av_composition_pc_av_RequiredDelegationConnector75
        
        pass
    @property
    def pcm_pc_av_composition_pc_av_RequiredDelegationConnector72(self):
        return self.__pcm_pc_av_composition_pc_av_RequiredDelegationConnector72

    @pcm_pc_av_composition_pc_av_RequiredDelegationConnector72.setter
    def pcm_pc_av_composition_pc_av_RequiredDelegationConnector72(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_composition_pc_av_RequiredDelegationConnector__pcm_pc_av_composition_pc_av_RequiredDelegationConnector72", None)
        self.__pcm_pc_av_composition_pc_av_RequiredDelegationConnector72 = value
    ...
    @property
    def pcm_pc_av_composition_pc_av_RequiredDelegationConnector75(self):
        return self.__pcm_pc_av_composition_pc_av_RequiredDelegationConnector75

    @pcm_pc_av_composition_pc_av_RequiredDelegationConnector75.setter
    def pcm_pc_av_composition_pc_av_RequiredDelegationConnector75(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_composition_pc_av_RequiredDelegationConnector__pcm_pc_av_composition_pc_av_RequiredDelegationConnector75", None)
        self.__pcm_pc_av_composition_pc_av_RequiredDelegationConnector75 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "composition_pc_av_AssemblyContext76"):
                opp_val = getattr(old_value, "composition_pc_av_AssemblyContext76", None)
                if opp_val == self:
                    setattr(old_value, "composition_pc_av_AssemblyContext76", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "composition_pc_av_AssemblyContext76"):
                opp_val = getattr(value, "composition_pc_av_AssemblyContext76", None)
                setattr(value, "composition_pc_av_AssemblyContext76", self)

    def ComponentOfAssemblyContextAndInnerRoleRequiringComponentNeedToBeTheSame(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
        # TODO: Implement ComponentOfAssemblyContextAndInnerRoleRequiringComponentNeedToBeTheSame method
        pass

    def RequiredDelegationConnectorandtheconnectedComponentmustbepartofthesamecompositestructure(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
        # TODO: Implement RequiredDelegationConnectorandtheconnectedComponentmustbepartofthesamecompositestructure method
        pass

    def RequiringEntityOfOuterRequiredRoleMustBeTheSameAsTheParentOfTheRequiredDelegationConnector(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
...
class pcm_pc_av_composition_pc_av_ProvidedDelegationConnector(DelegationConnector):
    ...
    def __init__(self, pcm_pc_av_composition_pc_av_ProvidedDelegationConnector: "OperationProvidedRole" = None, pcm_pc_av_composition_pc_av_ProvidedDelegationConnector65: "OperationProvidedRole" = None, pcm_pc_av_composition_pc_av_ProvidedDelegationConnector68: "composition_pc_av_AssemblyContext" = None):
        self.pcm_pc_av_composition_pc_av_ProvidedDelegationConnector = pcm_pc_av_composition_pc_av_ProvidedDelegationConnector
        self.pcm_pc_av_composition_pc_av_ProvidedDelegationConnector65 = pcm_pc_av_composition_pc_av_ProvidedDelegationConnector65
        self.pcm_pc_av_composition_pc_av_ProvidedDelegationConnector68 = pcm_pc_av_composition_pc_av_ProvidedDelegationConnector68
        
        pass
    @property
    def pcm_pc_av_composition_pc_av_ProvidedDelegationConnector65(self):
        return self.__pcm_pc_av_composition_pc_av_ProvidedDelegationConnector65

    @pcm_pc_av_composition_pc_av_ProvidedDelegationConnector65.setter
    def pcm_pc_av_composition_pc_av_ProvidedDelegationConnector65(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_composition_pc_av_ProvidedDelegationConnector__pcm_pc_av_composition_pc_av_ProvidedDelegationConnector65", None)
        self.__pcm_pc_av_composition_pc_av_ProvidedDelegationConnector65 = value
    ...
    @property
    def pcm_pc_av_composition_pc_av_ProvidedDelegationConnector68(self):
        return self.__pcm_pc_av_composition_pc_av_ProvidedDelegationConnector68

    @pcm_pc_av_composition_pc_av_ProvidedDelegationConnector68.setter
    def pcm_pc_av_composition_pc_av_ProvidedDelegationConnector68(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_composition_pc_av_ProvidedDelegationConnector__pcm_pc_av_composition_pc_av_ProvidedDelegationConnector68", None)
        self.__pcm_pc_av_composition_pc_av_ProvidedDelegationConnector68 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "composition_pc_av_AssemblyContext69"):
                opp_val = getattr(old_value, "composition_pc_av_AssemblyContext69", None)
                if opp_val == self:
                    setattr(old_value, "composition_pc_av_AssemblyContext69", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "composition_pc_av_AssemblyContext69"):
                opp_val = getattr(value, "composition_pc_av_AssemblyContext69", None)
                setattr(value, "composition_pc_av_AssemblyContext69", self)

    def ComponentOfAssemblyContextAndInnerRoleProvidingComponentNeedToBeTheSame(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
        # TODO: Implement ComponentOfAssemblyContextAndInnerRoleProvidingComponentNeedToBeTheSame method
        pass

    def ProvidedDelegationConnectorandtheconnectedComponentmustbepartofthesamecompositestructure(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
...
class composition_pc_av_ComposedStructure:
    ...
    pass
class pcm_pc_av_entity_pc_av_ComposedProvidingRequiringEntity(composition_pc_av_ComposedStructure, entity_pc_av_InterfaceProvidingRequiringEntity):

    def __init__(self, ComposedStructure151: "pcm_pc_av_composition_pc_av_AssemblyContext" = None, ComposedStructure: "pcm_pc_av_composition_pc_av_Connector" = None, ComposedStructure50: "pcm_pc_av_composition_pc_av_EventChannel" = None, ComposedStructure44: "pcm_pc_av_composition_pc_av_ResourceRequiredDelegationConnector" = None):
        
        pass
    def ProvidedRolesMustBeBound(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
...
class pcm_pc_av_composition_pc_av_AssemblyConnector(Connector):
    ...
    def __init__(self, pcm_pc_av_composition_pc_av_AssemblyConnector: "composition_pc_av_AssemblyContext" = None, pcm_pc_av_composition_pc_av_AssemblyConnector80: "composition_pc_av_AssemblyContext" = None, pcm_pc_av_composition_pc_av_AssemblyConnector83: "OperationProvidedRole" = None, pcm_pc_av_composition_pc_av_AssemblyConnector86: "OperationRequiredRole" = None):
        self.pcm_pc_av_composition_pc_av_AssemblyConnector = pcm_pc_av_composition_pc_av_AssemblyConnector
        self.pcm_pc_av_composition_pc_av_AssemblyConnector80 = pcm_pc_av_composition_pc_av_AssemblyConnector80
        self.pcm_pc_av_composition_pc_av_AssemblyConnector83 = pcm_pc_av_composition_pc_av_AssemblyConnector83
        self.pcm_pc_av_composition_pc_av_AssemblyConnector86 = pcm_pc_av_composition_pc_av_AssemblyConnector86
        
        pass
    @property
    def pcm_pc_av_composition_pc_av_AssemblyConnector86(self):
        return self.__pcm_pc_av_composition_pc_av_AssemblyConnector86

    @pcm_pc_av_composition_pc_av_AssemblyConnector86.setter
    def pcm_pc_av_composition_pc_av_AssemblyConnector86(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_composition_pc_av_AssemblyConnector__pcm_pc_av_composition_pc_av_AssemblyConnector86", None)
        self.__pcm_pc_av_composition_pc_av_AssemblyConnector86 = value
    ...
    @property
    def pcm_pc_av_composition_pc_av_AssemblyConnector83(self):
        return self.__pcm_pc_av_composition_pc_av_AssemblyConnector83

    @pcm_pc_av_composition_pc_av_AssemblyConnector83.setter
    def pcm_pc_av_composition_pc_av_AssemblyConnector83(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_composition_pc_av_AssemblyConnector__pcm_pc_av_composition_pc_av_AssemblyConnector83", None)
        self.__pcm_pc_av_composition_pc_av_AssemblyConnector83 = value
    ...
    @property
    def pcm_pc_av_composition_pc_av_AssemblyConnector80(self):
        return self.__pcm_pc_av_composition_pc_av_AssemblyConnector80

    @pcm_pc_av_composition_pc_av_AssemblyConnector80.setter
    def pcm_pc_av_composition_pc_av_AssemblyConnector80(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_composition_pc_av_AssemblyConnector__pcm_pc_av_composition_pc_av_AssemblyConnector80", None)
        self.__pcm_pc_av_composition_pc_av_AssemblyConnector80 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "composition_pc_av_AssemblyContext81"):
                opp_val = getattr(old_value, "composition_pc_av_AssemblyContext81", None)
                if opp_val == self:
                    setattr(old_value, "composition_pc_av_AssemblyContext81", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "composition_pc_av_AssemblyContext81"):
                opp_val = getattr(value, "composition_pc_av_AssemblyContext81", None)
                setattr(value, "composition_pc_av_AssemblyContext81", self)
    ...
    def pcm_pc_av_composition_pc_av_AssemblyConnector(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "composition_pc_av_AssemblyContext78"):
                opp_val = getattr(old_value, "composition_pc_av_AssemblyContext78", None)
                if opp_val == self:
                    setattr(old_value, "composition_pc_av_AssemblyContext78", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "composition_pc_av_AssemblyContext78"):
                opp_val = getattr(value, "composition_pc_av_AssemblyContext78", None)
                setattr(value, "composition_pc_av_AssemblyContext78", self)

    def AssemblyConnectorsReferencedInterfacesMustMatch(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
        # TODO: Implement AssemblyConnectorsReferencedInterfacesMustMatch method
        pass

    def AssemblyConnectorsReferencedRequiredRoleAndChildContextMustMatch(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
        # TODO: Implement AssemblyConnectorsReferencedRequiredRoleAndChildContextMustMatch method
        pass

    def AssemblyConnectorsReferencedProvidedRolesAndChildContextMustMatch(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
...
class pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification(Identifier):
    ...
    def __init__(self, requiredByContainer: bool, numberOfReplicas: int, MTTR: float, MTTF: float, pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification: "SchedulingPolicy" = None, pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification473: "ProcessingResourceType" = None, processingResourceSpecification_processingRate_PCMRandomVariable: "PCMRandomVariable" = None, activeResourceSpecifications_ResourceContainer: "ResourceContainer" = None):
        ...
        self.pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification473 = pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification473
    ...
    def processingResourceSpecification_processingRate_PCMRandomVariable(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification__processingResourceSpecification_processingRate_PCMRandomVariable", None)
    ...
    @property
    def pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification473(self):
        return self.__pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification473

    @pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification473.setter
    def pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification473(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification__pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification473", None)
        self.__pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification473 = value
    ...
    def activeResourceSpecifications_ResourceContainer(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification__activeResourceSpecifications_ResourceContainer", None)
...
class pcm_pc_av_seff_pc_av_ResourceDemandingBehaviour(Identifier):
    ...
    def __init__(self, bodyBehaviour_Loop342: "AbstractLoopAction" = None, branchBehaviour_BranchTransition: "AbstractBranchTransition" = None, resourceDemandingBehaviour_AbstractAction: set["AbstractAction"] = None):
    ...
    def bodyBehaviour_Loop342(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_seff_pc_av_ResourceDemandingBehaviour__bodyBehaviour_Loop342", None)
    ...
    def resourceDemandingBehaviour_AbstractAction(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_seff_pc_av_ResourceDemandingBehaviour__resourceDemandingBehaviour_AbstractAction", None)
    ...
    def branchBehaviour_BranchTransition(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_seff_pc_av_ResourceDemandingBehaviour__branchBehaviour_BranchTransition", None)
...
class pcm_pc_av_resourceenvironment_pc_av_CommunicationLinkResourceSpecification(Identifier):
    ...
    def communicationLinkResourceSpecifications_LinkingResource(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_resourceenvironment_pc_av_CommunicationLinkResourceSpecification__communicationLinkResourceSpecifications_LinkingResource", None)
    ...
    def communicationLinkResourceSpecifcation_throughput_PCMRandomVariable(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_resourceenvironment_pc_av_CommunicationLinkResourceSpecification__communicationLinkResourceSpecifcation_throughput_PCMRandomVariable", None)
    ...
    def communicationLinkResourceSpecification_latency_PCMRandomVariable(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_resourceenvironment_pc_av_CommunicationLinkResourceSpecification__communicationLinkResourceSpecification_latency_PCMRandomVariable", None)
...
class pcm_pc_av_entity_pc_av_Entity(entity_pc_av_NamedElement, Identifier):
...
class pcm_pc_av_repository_pc_av_CompositeDataType(repository_pc_av_DataType, entity_pc_av_Entity):
    ...
    pass
class pcm_pc_av_system_pc_av_System(entity_pc_av_ComposedProvidingRequiringEntity, entity_pc_av_Entity):
    ...
    def system_QoSAnnotations(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_system_pc_av_System__system_QoSAnnotations", None)
    ...
    def SystemMustHaveAtLeastOneProvidedRole(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
        # TODO: Implement SystemMustHaveAtLeastOneProvidedRole method
        pass

class pcm_pc_av_entity_pc_av_InterfaceRequiringEntity(entity_pc_av_Entity, entity_pc_av_ResourceInterfaceRequiringEntity):
...
class pcm_pc_av_composition_pc_av_ComposedStructure(Entity):
    ...
    def __init__(self, parentStructure__AssemblyContext: set["composition_pc_av_AssemblyContext"] = None, parentStructure_ResourceRequiredDelegationConnector: set["composition_pc_av_ResourceRequiredDelegationConnector"] = None, parentStructure__EventChannel: set["composition_pc_av_EventChannel"] = None, parentStructure__Connector: set["composition_pc_av_Connector"] = None):
    ...
    def parentStructure__EventChannel(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_composition_pc_av_ComposedStructure__parentStructure__EventChannel", None)
    ...
    def parentStructure_ResourceRequiredDelegationConnector(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_composition_pc_av_ComposedStructure__parentStructure_ResourceRequiredDelegationConnector", None)
    ...
    def parentStructure__Connector(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_composition_pc_av_ComposedStructure__parentStructure__Connector", None)
    ...
    def parentStructure__AssemblyContext(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_composition_pc_av_ComposedStructure__parentStructure__AssemblyContext", None)
    ...
    def MultipleConnectorsConstraintForAssemblyConnectors(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
        # TODO: Implement MultipleConnectorsConstraintForAssemblyConnectors method
        pass

    def MultipleConnectorsConstraint(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
...
class pcm_pc_av_usagemodel_pc_av_ScenarioBehaviour(Entity):
    ...
    def __init__(self, bodyBehaviour_Loop: "Loop" = None, scenarioBehaviour_AbstractUserAction: set["AbstractUserAction"] = None, scenarioBehaviour_UsageScenario: "UsageScenario" = None, branchedBehaviour_BranchTransition: "BranchTransition" = None):
    ...
    def branchedBehaviour_BranchTransition(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_usagemodel_pc_av_ScenarioBehaviour__branchedBehaviour_BranchTransition", None)
    ...
    def scenarioBehaviour_UsageScenario(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_usagemodel_pc_av_ScenarioBehaviour__scenarioBehaviour_UsageScenario", None)
    ...
    def scenarioBehaviour_AbstractUserAction(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_usagemodel_pc_av_ScenarioBehaviour__scenarioBehaviour_AbstractUserAction", None)
    ...
    def bodyBehaviour_Loop(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_usagemodel_pc_av_ScenarioBehaviour__bodyBehaviour_Loop", None)
    ...
    def Exactlyonestart(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
        # TODO: Implement Exactlyonestart method
        pass

    def Exactlyonestop(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
        # TODO: Implement Exactlyonestop method
        pass

    def EachuseractionexceptStartandStopmusthaveapredecessorandsuccessor(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
...
class pcm_pc_av_allocation_pc_av_AllocationContext(Entity):
    ...
    def __init__(self, pcm_pc_av_allocation_pc_av_AllocationContext: "ResourceContainer" = None, pcm_pc_av_allocation_pc_av_AllocationContext490: "composition_pc_av_AssemblyContext" = None, allocationContexts_Allocation: "Allocation" = None, pcm_pc_av_allocation_pc_av_AllocationContext494: "composition_pc_av_EventChannel" = None):
        self.pcm_pc_av_allocation_pc_av_AllocationContext = pcm_pc_av_allocation_pc_av_AllocationContext
        self.pcm_pc_av_allocation_pc_av_AllocationContext490 = pcm_pc_av_allocation_pc_av_AllocationContext490
        self.allocationContexts_Allocation = allocationContexts_Allocation
        self.pcm_pc_av_allocation_pc_av_AllocationContext494 = pcm_pc_av_allocation_pc_av_AllocationContext494
    ...
    def allocationContexts_Allocation(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_allocation_pc_av_AllocationContext__allocationContexts_Allocation", None)
    ...
    @property
    def pcm_pc_av_allocation_pc_av_AllocationContext490(self):
        return self.__pcm_pc_av_allocation_pc_av_AllocationContext490

    @pcm_pc_av_allocation_pc_av_AllocationContext490.setter
    def pcm_pc_av_allocation_pc_av_AllocationContext490(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_allocation_pc_av_AllocationContext__pcm_pc_av_allocation_pc_av_AllocationContext490", None)
        self.__pcm_pc_av_allocation_pc_av_AllocationContext490 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "composition_pc_av_AssemblyContext491"):
                opp_val = getattr(old_value, "composition_pc_av_AssemblyContext491", None)
                if opp_val == self:
                    setattr(old_value, "composition_pc_av_AssemblyContext491", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "composition_pc_av_AssemblyContext491"):
                opp_val = getattr(value, "composition_pc_av_AssemblyContext491", None)
                setattr(value, "composition_pc_av_AssemblyContext491", self)

    @property
    def pcm_pc_av_allocation_pc_av_AllocationContext494(self):
        return self.__pcm_pc_av_allocation_pc_av_AllocationContext494

    @pcm_pc_av_allocation_pc_av_AllocationContext494.setter
    def pcm_pc_av_allocation_pc_av_AllocationContext494(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_allocation_pc_av_AllocationContext__pcm_pc_av_allocation_pc_av_AllocationContext494", None)
        self.__pcm_pc_av_allocation_pc_av_AllocationContext494 = value
    ...
    def OneAssemblyContextOrOneEventChannelShouldBeReferred(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
...
class pcm_pc_av_repository_pc_av_Interface(Entity):
    ...
    def __init__(self, interface_RequiredCharacterisation: set["RequiredCharacterisation"] = None, interfaces__Repository: "Repository" = None, pcm_pc_av_repository_pc_av_Interface: set["Interface"] = None, pcm_pc_av_repository_pc_av_Interface232: set["Protocol"] = None):
        ...
        self.pcm_pc_av_repository_pc_av_Interface232 = pcm_pc_av_repository_pc_av_Interface232 if pcm_pc_av_repository_pc_av_Interface232 is not None else set()
    ...
    @property
    def pcm_pc_av_repository_pc_av_Interface232(self):
        return self.__pcm_pc_av_repository_pc_av_Interface232

    @pcm_pc_av_repository_pc_av_Interface232.setter
    def pcm_pc_av_repository_pc_av_Interface232(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_repository_pc_av_Interface__pcm_pc_av_repository_pc_av_Interface232", None)
        self.__pcm_pc_av_repository_pc_av_Interface232 = value if value is not None else set()
    ...
    def interface_RequiredCharacterisation(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_repository_pc_av_Interface__interface_RequiredCharacterisation", None)
    ...
    def interfaces__Repository(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_repository_pc_av_Interface__interfaces__Repository", None)
    ...
    def NoProtocolTypeIDUsedTwice(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
...
class pcm_pc_av_resourcetype_pc_av_ResourceSignature(Entity):
    ...
    def resourceSignature__Parameter(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_resourcetype_pc_av_ResourceSignature__resourceSignature__Parameter", None)
    ...
    def resourceSignatures__ResourceInterface(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_resourcetype_pc_av_ResourceSignature__resourceSignatures__ResourceInterface", None)
...
class pcm_pc_av_repository_pc_av_Repository(Entity):
    ...
    def repository__DataType(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_repository_pc_av_Repository__repository__DataType", None)
    ...
    def repository__RepositoryComponent(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_repository_pc_av_Repository__repository__RepositoryComponent", None)
    ...
    def repository__Interface(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_repository_pc_av_Repository__repository__Interface", None)
    ...
    def repository__FailureType(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_repository_pc_av_Repository__repository__FailureType", None)
...
class pcm_pc_av_qosannotations_pc_av_QoSAnnotations(Entity):
    ...
    def __init__(self, qosAnnotations_System: "System" = None, qosAnnotations_SpecifiedQoSAnnotation: set["SpecifiedQoSAnnotation"] = None, qosAnnotations_SpecifiedOutputParameterAbstraction: set["SpecifiedOutputParameterAbstraction"] = None):
    ...
    def qosAnnotations_SpecifiedQoSAnnotation(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_qosannotations_pc_av_QoSAnnotations__qosAnnotations_SpecifiedQoSAnnotation", None)
    ...
    def qosAnnotations_SpecifiedOutputParameterAbstraction(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_qosannotations_pc_av_QoSAnnotations__qosAnnotations_SpecifiedOutputParameterAbstraction", None)
    ...
    def qosAnnotations_System(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_qosannotations_pc_av_QoSAnnotations__qosAnnotations_System", None)
    ...
    def MultipleReliabilityAnnotationsPerExternalCallNotAllowed(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
...
class pcm_pc_av_allocation_pc_av_Allocation(Entity):
    ...
    def __init__(self, pcm_pc_av_allocation_pc_av_Allocation: "ResourceEnvironment" = None, pcm_pc_av_allocation_pc_av_Allocation498: "System" = None, allocation_AllocationContext: set["AllocationContext"] = None):
        self.pcm_pc_av_allocation_pc_av_Allocation = pcm_pc_av_allocation_pc_av_Allocation
        self.pcm_pc_av_allocation_pc_av_Allocation498 = pcm_pc_av_allocation_pc_av_Allocation498
        self.allocation_AllocationContext = allocation_AllocationContext if allocation_AllocationContext is not None else set()
        
        pass
    @property
    def pcm_pc_av_allocation_pc_av_Allocation498(self):
        return self.__pcm_pc_av_allocation_pc_av_Allocation498

    @pcm_pc_av_allocation_pc_av_Allocation498.setter
    def pcm_pc_av_allocation_pc_av_Allocation498(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_allocation_pc_av_Allocation__pcm_pc_av_allocation_pc_av_Allocation498", None)
        self.__pcm_pc_av_allocation_pc_av_Allocation498 = value
    ...
    def allocation_AllocationContext(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_allocation_pc_av_Allocation__allocation_AllocationContext", None)
    ...
    def CommunicatingServersHaveToBeConnectedByLinkingResource(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
        # TODO: Implement CommunicatingServersHaveToBeConnectedByLinkingResource method
        pass

    def EachAssemblyContextWithinSystemHasToBeAllocatedExactlyOnce(self, pcm_pc_av_context, pcm_pc_av_diagnostics) :
...
class entity_pc_av_InterfaceProvidingEntity:
    ...
    pass
class pcm_pc_av_entity_pc_av_InterfaceProvidingRequiringEntity(entity_pc_av_InterfaceProvidingEntity, entity_pc_av_InterfaceRequiringEntity):
...
class entity_pc_av_ResourceInterfaceProvidingEntity:
    ...
    pass
class pcm_pc_av_resourcetype_pc_av_ResourceType(entity_pc_av_Entity, UnitCarryingElement, entity_pc_av_ResourceInterfaceProvidingEntity):

    pass
class pcm_pc_av_entity_pc_av_ResourceInterfaceProvidingRequiringEntity(entity_pc_av_ResourceInterfaceProvidingEntity, entity_pc_av_ResourceInterfaceRequiringEntity):
...
class pcm_pc_av_core_pc_av_PCMRandomVariable(RandomVariable):
    ...
    def __init__(self, thinkTime_ClosedWorkload: "ClosedWorkload" = None, capacity_PassiveResource: "PassiveResource" = None, specification_VariableCharacterisation: "VariableCharacterisation" = None, numberOfCalls__InfrastructureCall: "seff_performance_pc_av_InfrastructureCall" = None, iterationCount_LoopAction: "LoopAction" = None, branchCondition_GuardedBranchTransition: "GuardedBranchTransition" = None, specification_SpecifiedExecutionTime: "qos_performance_pc_av_SpecifiedExecutionTime" = None, filterCondition__EventChannelSinkConnector: "composition_pc_av_EventChannelSinkConnector" = None, filterCondition__AssemblyEventConnector: "composition_pc_av_AssemblyEventConnector" = None, loopIteration_Loop: "Loop" = None, interArrivalTime_OpenWorkload: "OpenWorkload" = None, numberOfCalls__ResourceCall: "seff_performance_pc_av_ResourceCall" = None, specification_ParametericResourceDemand: "seff_performance_pc_av_ParametricResourceDemand" = None, processingRate_ProcessingResourceSpecification: "ProcessingResourceSpecification" = None, latency_CommunicationLinkResourceSpecification: "CommunicationLinkResourceSpecification" = None, timeSpecification_Delay: "Delay" = None, throughput_CommunicationLinkResourceSpecification: "CommunicationLinkResourceSpecification" = None):
    ...
    def loopIteration_Loop(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_core_pc_av_PCMRandomVariable__loopIteration_Loop", None)
    ...
    def timeSpecification_Delay(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_core_pc_av_PCMRandomVariable__timeSpecification_Delay", None)
    ...
    def iterationCount_LoopAction(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_core_pc_av_PCMRandomVariable__iterationCount_LoopAction", None)
    ...
    def numberOfCalls__ResourceCall(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_core_pc_av_PCMRandomVariable__numberOfCalls__ResourceCall", None)
    ...
    def specification_ParametericResourceDemand(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_core_pc_av_PCMRandomVariable__specification_ParametericResourceDemand", None)
    ...
    def specification_VariableCharacterisation(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_core_pc_av_PCMRandomVariable__specification_VariableCharacterisation", None)
    ...
    def specification_SpecifiedExecutionTime(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_core_pc_av_PCMRandomVariable__specification_SpecifiedExecutionTime", None)
    ...
    def filterCondition__EventChannelSinkConnector(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_core_pc_av_PCMRandomVariable__filterCondition__EventChannelSinkConnector", None)
    ...
    def processingRate_ProcessingResourceSpecification(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_core_pc_av_PCMRandomVariable__processingRate_ProcessingResourceSpecification", None)
    ...
    def capacity_PassiveResource(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_core_pc_av_PCMRandomVariable__capacity_PassiveResource", None)
    ...
    def latency_CommunicationLinkResourceSpecification(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_core_pc_av_PCMRandomVariable__latency_CommunicationLinkResourceSpecification", None)
    ...
    def throughput_CommunicationLinkResourceSpecification(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_core_pc_av_PCMRandomVariable__throughput_CommunicationLinkResourceSpecification", None)
    ...
    def thinkTime_ClosedWorkload(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_core_pc_av_PCMRandomVariable__thinkTime_ClosedWorkload", None)
    ...
    def branchCondition_GuardedBranchTransition(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_core_pc_av_PCMRandomVariable__branchCondition_GuardedBranchTransition", None)
    ...
    def numberOfCalls__InfrastructureCall(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_core_pc_av_PCMRandomVariable__numberOfCalls__InfrastructureCall", None)
    ...
    def filterCondition__AssemblyEventConnector(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_core_pc_av_PCMRandomVariable__filterCondition__AssemblyEventConnector", None)
    ...
    def interArrivalTime_OpenWorkload(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_av_core_pc_av_PCMRandomVariable__interArrivalTime_OpenWorkload", None)
    ...
    def SpecificationMustNotBeNULL(self, pcm_pc_av_diagnostics, pcm_pc_av_context) :
