...
def test_pcm_pc_av_entity_pc_av_NamedElement_entityName_value_roundtrip():
    instance = pcm_pc_av_entity_pc_av_NamedElement(entityName="sample_text")
    assert instance.entityName == "sample_text"
    instance.entityName = "sample_text_2"
    assert instance.entityName == "sample_text_2"


def test_pcm_pc_av_parameter_pc_av_CharacterisedVariable_characterisationType_value_roundtrip():
    instance = pcm_pc_av_parameter_pc_av_CharacterisedVariable(characterisationType="sample_text")
...
def test_pcm_pc_av_parameter_pc_av_VariableCharacterisation_type_value_roundtrip():
    instance = pcm_pc_av_parameter_pc_av_VariableCharacterisation(type="sample_text")
    assert instance.type == "sample_text"
    instance.type = "sample_text_2"
    assert instance.type == "sample_text_2"


def test_pcm_pc_av_protocol_pc_av_Protocol_protocolTypeID_value_roundtrip():
    instance = pcm_pc_av_protocol_pc_av_Protocol(protocolTypeID="sample_text")
...
def test_pcm_pc_av_reliability_pc_av_FailureOccurrenceDescription_failureProbability_value_roundtrip():
    instance = pcm_pc_av_reliability_pc_av_FailureOccurrenceDescription(failureProbability=3.14)
    assert instance.failureProbability == 3.14
    instance.failureProbability = 9.99
    assert instance.failureProbability == 9.99


def test_pcm_pc_av_repository_pc_av_ExceptionType_exceptionMessage_value_roundtrip():
    instance = pcm_pc_av_repository_pc_av_ExceptionType(exceptionMessage="sample_text", exceptionName="sample_text")
...
def test_pcm_pc_av_repository_pc_av_ExceptionType_exceptionName_value_roundtrip():
    instance = pcm_pc_av_repository_pc_av_ExceptionType(exceptionMessage="sample_text", exceptionName="sample_text")
...
def test_pcm_pc_av_repository_pc_av_ImplementationComponentType_componentType_value_roundtrip():
    instance = pcm_pc_av_repository_pc_av_ImplementationComponentType(componentType="sample_text")
    assert instance.componentType == "sample_text"
    instance.componentType = "sample_text_2"
    assert instance.componentType == "sample_text_2"


def test_pcm_pc_av_repository_pc_av_Parameter_modifier__Parameter_value_roundtrip():
    instance = pcm_pc_av_repository_pc_av_Parameter(modifier__Parameter="sample_text", parameterName="sample_text")
...
def test_pcm_pc_av_repository_pc_av_Parameter_parameterName_value_roundtrip():
    instance = pcm_pc_av_repository_pc_av_Parameter(modifier__Parameter="sample_text", parameterName="sample_text")
...
def test_pcm_pc_av_repository_pc_av_PrimitiveDataType_type_value_roundtrip():
    instance = pcm_pc_av_repository_pc_av_PrimitiveDataType(type="sample_text")
    assert instance.type == "sample_text"
    instance.type = "sample_text_2"
    assert instance.type == "sample_text_2"


def test_pcm_pc_av_repository_pc_av_Repository_repositoryDescription_value_roundtrip():
    instance = pcm_pc_av_repository_pc_av_Repository(repositoryDescription="sample_text")
...
def test_pcm_pc_av_repository_pc_av_RequiredCharacterisation_type_value_roundtrip():
    instance = pcm_pc_av_repository_pc_av_RequiredCharacterisation(type="sample_text")
    assert instance.type == "sample_text"
    instance.type = "sample_text_2"
    assert instance.type == "sample_text_2"


def test_pcm_pc_av_resourceenvironment_pc_av_CommunicationLinkResourceSpecification_failureProbability_value_roundtrip():
    instance = pcm_pc_av_resourceenvironment_pc_av_CommunicationLinkResourceSpecification(failureProbability=3.14)
    assert instance.failureProbability == 3.14
    instance.failureProbability = 9.99
    assert instance.failureProbability == 9.99


def test_pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification_MTTF_value_roundtrip():
    instance = pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification(MTTF=3.14, MTTR=3.14, numberOfReplicas=7, requiredByContainer=True)
    assert instance.MTTF == 3.14
    instance.MTTF = 9.99
    assert instance.MTTF == 9.99


def test_pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification_MTTR_value_roundtrip():
    instance = pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification(MTTF=3.14, MTTR=3.14, numberOfReplicas=7, requiredByContainer=True)
...
def test_pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification_numberOfReplicas_value_roundtrip():
    instance = pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification(MTTF=3.14, MTTR=3.14, numberOfReplicas=7, requiredByContainer=True)
...
def test_pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification_requiredByContainer_value_roundtrip():
    instance = pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification(MTTF=3.14, MTTR=3.14, numberOfReplicas=7, requiredByContainer=True)
...
def test_pcm_pc_av_resourcetype_pc_av_ResourceSignature_resourceServiceId_value_roundtrip():
    instance = pcm_pc_av_resourcetype_pc_av_ResourceSignature(resourceServiceId=7)
    assert instance.resourceServiceId == 7
    instance.resourceServiceId = 13
    assert instance.resourceServiceId == 13


def test_pcm_pc_av_seff_pc_av_AcquireAction_timeout_value_roundtrip():
    instance = pcm_pc_av_seff_pc_av_AcquireAction(timeout=True, timeoutValue=3.14)
    assert instance.timeout == True
    instance.timeout = False
    assert instance.timeout == False


def test_pcm_pc_av_seff_pc_av_AcquireAction_timeoutValue_value_roundtrip():
    instance = pcm_pc_av_seff_pc_av_AcquireAction(timeout=True, timeoutValue=3.14)
...
def test_pcm_pc_av_seff_pc_av_ExternalCallAction_retryCount_value_roundtrip():
    instance = pcm_pc_av_seff_pc_av_ExternalCallAction(retryCount=7)
    assert instance.retryCount == 7
    instance.retryCount = 13
    assert instance.retryCount == 13


def test_pcm_pc_av_seff_pc_av_ProbabilisticBranchTransition_branchProbability_value_roundtrip():
    instance = pcm_pc_av_seff_pc_av_ProbabilisticBranchTransition(branchProbability=3.14)
    assert instance.branchProbability == 3.14
    instance.branchProbability = 9.99
    assert instance.branchProbability == 9.99


def test_pcm_pc_av_seff_pc_av_ServiceEffectSpecification_seffTypeID_value_roundtrip():
    instance = pcm_pc_av_seff_pc_av_ServiceEffectSpecification(seffTypeID="sample_text")
    assert instance.seffTypeID == "sample_text"
    instance.seffTypeID = "sample_text_2"
    assert instance.seffTypeID == "sample_text_2"


def test_pcm_pc_av_usagemodel_pc_av_BranchTransition_branchProbability_value_roundtrip():
    instance = pcm_pc_av_usagemodel_pc_av_BranchTransition(branchProbability=3.14)
    assert instance.branchProbability == 3.14
    instance.branchProbability = 9.99
    assert instance.branchProbability == 9.99


def test_pcm_pc_av_usagemodel_pc_av_ClosedWorkload_population_value_roundtrip():
    instance = pcm_pc_av_usagemodel_pc_av_ClosedWorkload(population=7)
    assert instance.population == 7
    instance.population = 13
    assert instance.population == 13


def test_pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall_priority_value_roundtrip():
    instance = pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall(priority=7)
    assert instance.priority == 7
    instance.priority = 13
    assert instance.priority == 13


def test_pcm_pc_av_seff_pc_av_AbstractInternalControlFlowAction_isa_AbstractAction():
    instance = pcm_pc_av_seff_pc_av_AbstractInternalControlFlowAction()
    assert isinstance(instance, AbstractAction)


def test_pcm_pc_av_seff_pc_av_GuardedBranchTransition_isa_AbstractBranchTransition():
    instance = pcm_pc_av_seff_pc_av_GuardedBranchTransition()
    assert isinstance(instance, AbstractBranchTransition)


def test_pcm_pc_av_seff_pc_av_ProbabilisticBranchTransition_isa_AbstractBranchTransition():
    instance = pcm_pc_av_seff_pc_av_ProbabilisticBranchTransition(branchProbability=3.14)
    assert isinstance(instance, AbstractBranchTransition)


def test_pcm_pc_av_seff_pc_av_AbstractLoopAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_pc_av_seff_pc_av_AbstractLoopAction()
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_pc_av_seff_pc_av_AcquireAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_pc_av_seff_pc_av_AcquireAction(timeout=True, timeoutValue=3.14)
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_pc_av_seff_pc_av_BranchAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_pc_av_seff_pc_av_BranchAction()
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_pc_av_seff_pc_av_ForkAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_pc_av_seff_pc_av_ForkAction()
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_pc_av_seff_pc_av_InternalAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_pc_av_seff_pc_av_InternalAction()
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_pc_av_seff_pc_av_ReleaseAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_pc_av_seff_pc_av_ReleaseAction()
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_pc_av_seff_pc_av_SetVariableAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_pc_av_seff_pc_av_SetVariableAction()
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_pc_av_seff_pc_av_StartAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_pc_av_seff_pc_av_StartAction()
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_pc_av_seff_pc_av_StopAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_pc_av_seff_pc_av_StopAction()
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_pc_av_seff_reliability_pc_av_RecoveryAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_pc_av_seff_reliability_pc_av_RecoveryAction()
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_pc_av_seff_pc_av_CollectionIteratorAction_isa_AbstractLoopAction():
    instance = pcm_pc_av_seff_pc_av_CollectionIteratorAction()
    assert isinstance(instance, AbstractLoopAction)


def test_pcm_pc_av_seff_pc_av_LoopAction_isa_AbstractLoopAction():
    instance = pcm_pc_av_seff_pc_av_LoopAction()
    assert isinstance(instance, AbstractLoopAction)


def test_pcm_pc_av_usagemodel_pc_av_Branch_isa_AbstractUserAction():
    instance = pcm_pc_av_usagemodel_pc_av_Branch()
    assert isinstance(instance, AbstractUserAction)


def test_pcm_pc_av_usagemodel_pc_av_Delay_isa_AbstractUserAction():
    instance = pcm_pc_av_usagemodel_pc_av_Delay()
    assert isinstance(instance, AbstractUserAction)


def test_pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall_isa_AbstractUserAction():
    instance = pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall(priority=7)
    assert isinstance(instance, AbstractUserAction)


def test_pcm_pc_av_usagemodel_pc_av_Loop_isa_AbstractUserAction():
    instance = pcm_pc_av_usagemodel_pc_av_Loop()
    assert isinstance(instance, AbstractUserAction)


def test_pcm_pc_av_usagemodel_pc_av_Start_isa_AbstractUserAction():
    instance = pcm_pc_av_usagemodel_pc_av_Start()
    assert isinstance(instance, AbstractUserAction)


def test_pcm_pc_av_usagemodel_pc_av_Stop_isa_AbstractUserAction():
    instance = pcm_pc_av_usagemodel_pc_av_Stop()
    assert isinstance(instance, AbstractUserAction)


def test_pcm_pc_av_seff_pc_av_CallReturnAction_isa_CallAction():
    instance = pcm_pc_av_seff_pc_av_CallReturnAction()
    assert isinstance(instance, CallAction)


def test_pcm_pc_av_seff_performance_pc_av_InfrastructureCall_isa_CallAction():
    instance = pcm_pc_av_seff_performance_pc_av_InfrastructureCall()
    assert isinstance(instance, CallAction)


def test_pcm_pc_av_seff_performance_pc_av_ResourceCall_isa_CallAction():
    instance = pcm_pc_av_seff_performance_pc_av_ResourceCall()
    assert isinstance(instance, CallAction)


def test_pcm_pc_av_composition_pc_av_AssemblyConnector_isa_Connector():
    instance = pcm_pc_av_composition_pc_av_AssemblyConnector()
    assert isinstance(instance, Connector)


def test_pcm_pc_av_composition_pc_av_AssemblyEventConnector_isa_Connector():
    instance = pcm_pc_av_composition_pc_av_AssemblyEventConnector()
    assert isinstance(instance, Connector)


def test_pcm_pc_av_composition_pc_av_AssemblyInfrastructureConnector_isa_Connector():
    instance = pcm_pc_av_composition_pc_av_AssemblyInfrastructureConnector()
    assert isinstance(instance, Connector)


def test_pcm_pc_av_composition_pc_av_DelegationConnector_isa_Connector():
    instance = pcm_pc_av_composition_pc_av_DelegationConnector()
    assert isinstance(instance, Connector)


def test_pcm_pc_av_composition_pc_av_EventChannelSinkConnector_isa_Connector():
    instance = pcm_pc_av_composition_pc_av_EventChannelSinkConnector()
    assert isinstance(instance, Connector)


def test_pcm_pc_av_composition_pc_av_EventChannelSourceConnector_isa_Connector():
    instance = pcm_pc_av_composition_pc_av_EventChannelSourceConnector()
    assert isinstance(instance, Connector)


def test_pcm_pc_av_repository_pc_av_PrimitiveDataType_isa_DataType():
    instance = pcm_pc_av_repository_pc_av_PrimitiveDataType(type="sample_text")
    assert isinstance(instance, DataType)


def test_pcm_pc_av_composition_pc_av_ProvidedDelegationConnector_isa_DelegationConnector():
    instance = pcm_pc_av_composition_pc_av_ProvidedDelegationConnector()
    assert isinstance(instance, DelegationConnector)


def test_pcm_pc_av_composition_pc_av_ProvidedInfrastructureDelegationConnector_isa_DelegationConnector():
    instance = pcm_pc_av_composition_pc_av_ProvidedInfrastructureDelegationConnector()
    assert isinstance(instance, DelegationConnector)


def test_pcm_pc_av_composition_pc_av_RequiredDelegationConnector_isa_DelegationConnector():
    instance = pcm_pc_av_composition_pc_av_RequiredDelegationConnector()
    assert isinstance(instance, DelegationConnector)


def test_pcm_pc_av_composition_pc_av_RequiredInfrastructureDelegationConnector_isa_DelegationConnector():
    instance = pcm_pc_av_composition_pc_av_RequiredInfrastructureDelegationConnector()
    assert isinstance(instance, DelegationConnector)


def test_pcm_pc_av_composition_pc_av_RequiredResourceDelegationConnector_isa_DelegationConnector():
    instance = pcm_pc_av_composition_pc_av_RequiredResourceDelegationConnector()
    assert isinstance(instance, DelegationConnector)


def test_pcm_pc_av_composition_pc_av_SinkDelegationConnector_isa_DelegationConnector():
    instance = pcm_pc_av_composition_pc_av_SinkDelegationConnector()
    assert isinstance(instance, DelegationConnector)


def test_pcm_pc_av_composition_pc_av_SourceDelegationConnector_isa_DelegationConnector():
    instance = pcm_pc_av_composition_pc_av_SourceDelegationConnector()
    assert isinstance(instance, DelegationConnector)


def test_pcm_pc_av_allocation_pc_av_Allocation_isa_Entity():
    instance = pcm_pc_av_allocation_pc_av_Allocation()
    assert isinstance(instance, Entity)


def test_pcm_pc_av_allocation_pc_av_AllocationContext_isa_Entity():
    instance = pcm_pc_av_allocation_pc_av_AllocationContext()
    assert isinstance(instance, Entity)


def test_pcm_pc_av_composition_pc_av_AssemblyContext_isa_Entity():
    instance = pcm_pc_av_composition_pc_av_AssemblyContext()
    assert isinstance(instance, Entity)


def test_pcm_pc_av_composition_pc_av_ComposedStructure_isa_Entity():
    instance = pcm_pc_av_composition_pc_av_ComposedStructure()
    assert isinstance(instance, Entity)


def test_pcm_pc_av_composition_pc_av_Connector_isa_Entity():
    instance = pcm_pc_av_composition_pc_av_Connector()
    assert isinstance(instance, Entity)


def test_pcm_pc_av_composition_pc_av_EventChannel_isa_Entity():
    instance = pcm_pc_av_composition_pc_av_EventChannel()
    assert isinstance(instance, Entity)


def test_pcm_pc_av_entity_pc_av_InterfaceProvidingEntity_isa_Entity():
    instance = pcm_pc_av_entity_pc_av_InterfaceProvidingEntity()
    assert isinstance(instance, Entity)


def test_pcm_pc_av_entity_pc_av_ResourceInterfaceProvidingEntity_isa_Entity():
    instance = pcm_pc_av_entity_pc_av_ResourceInterfaceProvidingEntity()
    assert isinstance(instance, Entity)


def test_pcm_pc_av_entity_pc_av_ResourceInterfaceRequiringEntity_isa_Entity():
    instance = pcm_pc_av_entity_pc_av_ResourceInterfaceRequiringEntity()
    assert isinstance(instance, Entity)


def test_pcm_pc_av_qosannotations_pc_av_QoSAnnotations_isa_Entity():
    instance = pcm_pc_av_qosannotations_pc_av_QoSAnnotations()
    assert isinstance(instance, Entity)


def test_pcm_pc_av_reliability_pc_av_FailureType_isa_Entity():
    instance = pcm_pc_av_reliability_pc_av_FailureType()
    assert isinstance(instance, Entity)


def test_pcm_pc_av_repository_pc_av_Interface_isa_Entity():
    instance = pcm_pc_av_repository_pc_av_Interface()
    assert isinstance(instance, Entity)


def test_pcm_pc_av_repository_pc_av_PassiveResource_isa_Entity():
    instance = pcm_pc_av_repository_pc_av_PassiveResource()
    assert isinstance(instance, Entity)


def test_pcm_pc_av_repository_pc_av_Repository_isa_Entity():
    instance = pcm_pc_av_repository_pc_av_Repository(repositoryDescription="sample_text")
    assert isinstance(instance, Entity)


def test_pcm_pc_av_repository_pc_av_Role_isa_Entity():
    instance = pcm_pc_av_repository_pc_av_Role()
    assert isinstance(instance, Entity)


def test_pcm_pc_av_repository_pc_av_Signature_isa_Entity():
    instance = pcm_pc_av_repository_pc_av_Signature()
    assert isinstance(instance, Entity)


def test_pcm_pc_av_resourceenvironment_pc_av_LinkingResource_isa_Entity():
    instance = pcm_pc_av_resourceenvironment_pc_av_LinkingResource()
    assert isinstance(instance, Entity)


def test_pcm_pc_av_resourceenvironment_pc_av_ResourceContainer_isa_Entity():
    instance = pcm_pc_av_resourceenvironment_pc_av_ResourceContainer()
    assert isinstance(instance, Entity)


def test_pcm_pc_av_resourcetype_pc_av_ResourceInterface_isa_Entity():
    instance = pcm_pc_av_resourcetype_pc_av_ResourceInterface()
    assert isinstance(instance, Entity)


def test_pcm_pc_av_resourcetype_pc_av_ResourceSignature_isa_Entity():
    instance = pcm_pc_av_resourcetype_pc_av_ResourceSignature(resourceServiceId=7)
    assert isinstance(instance, Entity)


def test_pcm_pc_av_resourcetype_pc_av_SchedulingPolicy_isa_Entity():
    instance = pcm_pc_av_resourcetype_pc_av_SchedulingPolicy()
    assert isinstance(instance, Entity)


def test_pcm_pc_av_seff_pc_av_AbstractAction_isa_Entity():
    instance = pcm_pc_av_seff_pc_av_AbstractAction()
    assert isinstance(instance, Entity)


def test_pcm_pc_av_seff_pc_av_AbstractBranchTransition_isa_Entity():
    instance = pcm_pc_av_seff_pc_av_AbstractBranchTransition()
    assert isinstance(instance, Entity)


def test_pcm_pc_av_seff_reliability_pc_av_FailureHandlingEntity_isa_Entity():
    instance = pcm_pc_av_seff_reliability_pc_av_FailureHandlingEntity()
    assert isinstance(instance, Entity)


def test_pcm_pc_av_usagemodel_pc_av_AbstractUserAction_isa_Entity():
    instance = pcm_pc_av_usagemodel_pc_av_AbstractUserAction()
    assert isinstance(instance, Entity)


def test_pcm_pc_av_usagemodel_pc_av_ScenarioBehaviour_isa_Entity():
    instance = pcm_pc_av_usagemodel_pc_av_ScenarioBehaviour()
    assert isinstance(instance, Entity)


def test_pcm_pc_av_usagemodel_pc_av_UsageScenario_isa_Entity():
    instance = pcm_pc_av_usagemodel_pc_av_UsageScenario()
    assert isinstance(instance, Entity)


def test_pcm_pc_av_completions_pc_av_DelegatingExternalCallAction_isa_ExternalCallAction():
    instance = pcm_pc_av_completions_pc_av_DelegatingExternalCallAction()
    assert isinstance(instance, ExternalCallAction)


def test_pcm_pc_av_reliability_pc_av_ExternalFailureOccurrenceDescription_isa_FailureOccurrenceDescription():
    instance = pcm_pc_av_reliability_pc_av_ExternalFailureOccurrenceDescription()
    assert isinstance(instance, FailureOccurrenceDescription)


def test_pcm_pc_av_reliability_pc_av_InternalFailureOccurrenceDescription_isa_FailureOccurrenceDescription():
    instance = pcm_pc_av_reliability_pc_av_InternalFailureOccurrenceDescription()
    assert isinstance(instance, FailureOccurrenceDescription)


def test_pcm_pc_av_reliability_pc_av_HardwareInducedFailureType_isa_FailureType():
    instance = pcm_pc_av_reliability_pc_av_HardwareInducedFailureType()
    assert isinstance(instance, FailureType)


def test_pcm_pc_av_reliability_pc_av_NetworkInducedFailureType_isa_FailureType():
    instance = pcm_pc_av_reliability_pc_av_NetworkInducedFailureType()
    assert isinstance(instance, FailureType)


def test_pcm_pc_av_reliability_pc_av_SoftwareInducedFailureType_isa_FailureType():
    instance = pcm_pc_av_reliability_pc_av_SoftwareInducedFailureType()
    assert isinstance(instance, FailureType)


def test_pcm_pc_av_entity_pc_av_Entity_isa_Identifier():
    instance = pcm_pc_av_entity_pc_av_Entity()
    assert isinstance(instance, Identifier)


def test_pcm_pc_av_resourceenvironment_pc_av_CommunicationLinkResourceSpecification_isa_Identifier():
    instance = pcm_pc_av_resourceenvironment_pc_av_CommunicationLinkResourceSpecification(failureProbability=3.14)
    assert isinstance(instance, Identifier)


def test_pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification_isa_Identifier():
    instance = pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification(MTTF=3.14, MTTR=3.14, numberOfReplicas=7, requiredByContainer=True)
    assert isinstance(instance, Identifier)


def test_pcm_pc_av_seff_pc_av_ResourceDemandingBehaviour_isa_Identifier():
    instance = pcm_pc_av_seff_pc_av_ResourceDemandingBehaviour()
    assert isinstance(instance, Identifier)


def test_pcm_pc_av_seff_pc_av_ResourceDemandingSEFF_isa_Identifier():
    instance = pcm_pc_av_seff_pc_av_ResourceDemandingSEFF()
    assert isinstance(instance, Identifier)


def test_pcm_pc_av_repository_pc_av_BasicComponent_isa_ImplementationComponentType():
    instance = pcm_pc_av_repository_pc_av_BasicComponent()
    assert isinstance(instance, ImplementationComponentType)


def test_pcm_pc_av_repository_pc_av_EventGroup_isa_Interface():
    instance = pcm_pc_av_repository_pc_av_EventGroup()
    assert isinstance(instance, Interface)


def test_pcm_pc_av_repository_pc_av_InfrastructureInterface_isa_Interface():
    instance = pcm_pc_av_repository_pc_av_InfrastructureInterface()
    assert isinstance(instance, Interface)


def test_pcm_pc_av_repository_pc_av_OperationInterface_isa_Interface():
    instance = pcm_pc_av_repository_pc_av_OperationInterface()
    assert isinstance(instance, Interface)


def test_pcm_pc_av_repository_pc_av_RepositoryComponent_isa_InterfaceProvidingRequiringEntity():
    instance = pcm_pc_av_repository_pc_av_RepositoryComponent()
    assert isinstance(instance, InterfaceProvidingRequiringEntity)


def test_pcm_pc_av_repository_pc_av_InnerDeclaration_isa_NamedElement():
    instance = pcm_pc_av_repository_pc_av_InnerDeclaration()
    assert isinstance(instance, NamedElement)


def test_pcm_pc_av_resourceenvironment_pc_av_ResourceEnvironment_isa_NamedElement():
    instance = pcm_pc_av_resourceenvironment_pc_av_ResourceEnvironment()
    assert isinstance(instance, NamedElement)


def test_pcm_pc_av_completions_pc_av_NetworkDemandParametricResourceDemand_isa_ParametricResourceDemand():
    instance = pcm_pc_av_completions_pc_av_NetworkDemandParametricResourceDemand()
    assert isinstance(instance, ParametricResourceDemand)


def test_pcm_pc_av_repository_pc_av_InfrastructureProvidedRole_isa_ProvidedRole():
    instance = pcm_pc_av_repository_pc_av_InfrastructureProvidedRole()
    assert isinstance(instance, ProvidedRole)


def test_pcm_pc_av_repository_pc_av_OperationProvidedRole_isa_ProvidedRole():
    instance = pcm_pc_av_repository_pc_av_OperationProvidedRole()
    assert isinstance(instance, ProvidedRole)


def test_pcm_pc_av_repository_pc_av_SinkRole_isa_ProvidedRole():
    instance = pcm_pc_av_repository_pc_av_SinkRole()
    assert isinstance(instance, ProvidedRole)


def test_pcm_pc_av_core_pc_av_PCMRandomVariable_isa_RandomVariable():
    instance = pcm_pc_av_core_pc_av_PCMRandomVariable()
    assert isinstance(instance, RandomVariable)


def test_pcm_pc_av_repository_pc_av_CompleteComponentType_isa_RepositoryComponent():
    instance = pcm_pc_av_repository_pc_av_CompleteComponentType()
    assert isinstance(instance, RepositoryComponent)


def test_pcm_pc_av_repository_pc_av_ImplementationComponentType_isa_RepositoryComponent():
    instance = pcm_pc_av_repository_pc_av_ImplementationComponentType(componentType="sample_text")
    assert isinstance(instance, RepositoryComponent)


def test_pcm_pc_av_repository_pc_av_ProvidesComponentType_isa_RepositoryComponent():
    instance = pcm_pc_av_repository_pc_av_ProvidesComponentType()
    assert isinstance(instance, RepositoryComponent)


def test_pcm_pc_av_repository_pc_av_InfrastructureRequiredRole_isa_RequiredRole():
    instance = pcm_pc_av_repository_pc_av_InfrastructureRequiredRole()
    assert isinstance(instance, RequiredRole)


def test_pcm_pc_av_repository_pc_av_OperationRequiredRole_isa_RequiredRole():
    instance = pcm_pc_av_repository_pc_av_OperationRequiredRole()
    assert isinstance(instance, RequiredRole)


def test_pcm_pc_av_repository_pc_av_SourceRole_isa_RequiredRole():
    instance = pcm_pc_av_repository_pc_av_SourceRole()
    assert isinstance(instance, RequiredRole)


def test_pcm_pc_av_seff_pc_av_ForkedBehaviour_isa_ResourceDemandingBehaviour():
    instance = pcm_pc_av_seff_pc_av_ForkedBehaviour()
    assert isinstance(instance, ResourceDemandingBehaviour)


def test_pcm_pc_av_seff_pc_av_ResourceDemandingInternalBehaviour_isa_ResourceDemandingBehaviour():
    instance = pcm_pc_av_seff_pc_av_ResourceDemandingInternalBehaviour()
    assert isinstance(instance, ResourceDemandingBehaviour)


def test_pcm_pc_av_resourcetype_pc_av_CommunicationLinkResourceType_isa_ResourceType():
    instance = pcm_pc_av_resourcetype_pc_av_CommunicationLinkResourceType()
    assert isinstance(instance, ResourceType)


def test_pcm_pc_av_resourcetype_pc_av_ProcessingResourceType_isa_ResourceType():
    instance = pcm_pc_av_resourcetype_pc_av_ProcessingResourceType()
    assert isinstance(instance, ResourceType)


def test_pcm_pc_av_entity_pc_av_ResourceProvidedRole_isa_Role():
    instance = pcm_pc_av_entity_pc_av_ResourceProvidedRole()
    assert isinstance(instance, Role)


def test_pcm_pc_av_entity_pc_av_ResourceRequiredRole_isa_Role():
    instance = pcm_pc_av_entity_pc_av_ResourceRequiredRole()
    assert isinstance(instance, Role)


def test_pcm_pc_av_repository_pc_av_ProvidedRole_isa_Role():
    instance = pcm_pc_av_repository_pc_av_ProvidedRole()
    assert isinstance(instance, Role)


def test_pcm_pc_av_repository_pc_av_RequiredRole_isa_Role():
    instance = pcm_pc_av_repository_pc_av_RequiredRole()
    assert isinstance(instance, Role)


def test_pcm_pc_av_repository_pc_av_EventType_isa_Signature():
    instance = pcm_pc_av_repository_pc_av_EventType()
    assert isinstance(instance, Signature)


def test_pcm_pc_av_repository_pc_av_InfrastructureSignature_isa_Signature():
    instance = pcm_pc_av_repository_pc_av_InfrastructureSignature()
    assert isinstance(instance, Signature)


def test_pcm_pc_av_repository_pc_av_OperationSignature_isa_Signature():
    instance = pcm_pc_av_repository_pc_av_OperationSignature()
    assert isinstance(instance, Signature)


def test_pcm_pc_av_reliability_pc_av_ResourceTimeoutFailureType_isa_SoftwareInducedFailureType():
    instance = pcm_pc_av_reliability_pc_av_ResourceTimeoutFailureType()
    assert isinstance(instance, SoftwareInducedFailureType)


def test_pcm_pc_av_qos_performance_pc_av_ComponentSpecifiedExecutionTime_isa_SpecifiedExecutionTime():
    instance = pcm_pc_av_qos_performance_pc_av_ComponentSpecifiedExecutionTime()
    assert isinstance(instance, SpecifiedExecutionTime)


def test_pcm_pc_av_qos_performance_pc_av_SystemSpecifiedExecutionTime_isa_SpecifiedExecutionTime():
    instance = pcm_pc_av_qos_performance_pc_av_SystemSpecifiedExecutionTime()
    assert isinstance(instance, SpecifiedExecutionTime)


def test_pcm_pc_av_qos_performance_pc_av_SpecifiedExecutionTime_isa_SpecifiedQoSAnnotation():
    instance = pcm_pc_av_qos_performance_pc_av_SpecifiedExecutionTime()
    assert isinstance(instance, SpecifiedQoSAnnotation)


def test_pcm_pc_av_qos_reliability_pc_av_SpecifiedReliabilityAnnotation_isa_SpecifiedQoSAnnotation():
    instance = pcm_pc_av_qos_reliability_pc_av_SpecifiedReliabilityAnnotation()
    assert isinstance(instance, SpecifiedQoSAnnotation)


def test_pcm_pc_av_resourcetype_pc_av_ResourceType_isa_UnitCarryingElement():
    instance = pcm_pc_av_resourcetype_pc_av_ResourceType()
    assert isinstance(instance, UnitCarryingElement)


def test_pcm_pc_av_parameter_pc_av_CharacterisedVariable_isa_Variable():
    instance = pcm_pc_av_parameter_pc_av_CharacterisedVariable(characterisationType="sample_text")
    assert isinstance(instance, Variable)


def test_pcm_pc_av_usagemodel_pc_av_ClosedWorkload_isa_Workload():
    instance = pcm_pc_av_usagemodel_pc_av_ClosedWorkload(population=7)
    assert isinstance(instance, Workload)


def test_pcm_pc_av_usagemodel_pc_av_OpenWorkload_isa_Workload():
    instance = pcm_pc_av_usagemodel_pc_av_OpenWorkload()
    assert isinstance(instance, Workload)


def test_pcm_pc_av_entity_pc_av_ComposedProvidingRequiringEntity_isa_composition_pc_av_ComposedStructure():
    instance = pcm_pc_av_entity_pc_av_ComposedProvidingRequiringEntity()
    assert isinstance(instance, composition_pc_av_ComposedStructure)


def test_pcm_pc_av_completions_pc_av_Completion_isa_entity_pc_av_ComposedProvidingRequiringEntity():
    instance = pcm_pc_av_completions_pc_av_Completion()
    assert isinstance(instance, entity_pc_av_ComposedProvidingRequiringEntity)


def test_pcm_pc_av_repository_pc_av_CompositeComponent_isa_entity_pc_av_ComposedProvidingRequiringEntity():
    instance = pcm_pc_av_repository_pc_av_CompositeComponent()
    assert isinstance(instance, entity_pc_av_ComposedProvidingRequiringEntity)


def test_pcm_pc_av_subsystem_pc_av_SubSystem_isa_entity_pc_av_ComposedProvidingRequiringEntity():
    instance = pcm_pc_av_subsystem_pc_av_SubSystem()
    assert isinstance(instance, entity_pc_av_ComposedProvidingRequiringEntity)


def test_pcm_pc_av_system_pc_av_System_isa_entity_pc_av_ComposedProvidingRequiringEntity():
    instance = pcm_pc_av_system_pc_av_System()
    assert isinstance(instance, entity_pc_av_ComposedProvidingRequiringEntity)


def test_pcm_pc_av_entity_pc_av_InterfaceRequiringEntity_isa_entity_pc_av_Entity():
    instance = pcm_pc_av_entity_pc_av_InterfaceRequiringEntity()
    assert isinstance(instance, entity_pc_av_Entity)


def test_pcm_pc_av_repository_pc_av_CollectionDataType_isa_entity_pc_av_Entity():
    instance = pcm_pc_av_repository_pc_av_CollectionDataType()
    assert isinstance(instance, entity_pc_av_Entity)


def test_pcm_pc_av_repository_pc_av_CompositeDataType_isa_entity_pc_av_Entity():
    instance = pcm_pc_av_repository_pc_av_CompositeDataType()
    assert isinstance(instance, entity_pc_av_Entity)


def test_pcm_pc_av_resourcetype_pc_av_ResourceType_isa_entity_pc_av_Entity():
    instance = pcm_pc_av_resourcetype_pc_av_ResourceType()
    assert isinstance(instance, entity_pc_av_Entity)


def test_pcm_pc_av_system_pc_av_System_isa_entity_pc_av_Entity():
    instance = pcm_pc_av_system_pc_av_System()
    assert isinstance(instance, entity_pc_av_Entity)


def test_pcm_pc_av_entity_pc_av_InterfaceProvidingRequiringEntity_isa_entity_pc_av_InterfaceProvidingEntity():
    instance = pcm_pc_av_entity_pc_av_InterfaceProvidingRequiringEntity()
    assert isinstance(instance, entity_pc_av_InterfaceProvidingEntity)


def test_pcm_pc_av_entity_pc_av_ComposedProvidingRequiringEntity_isa_entity_pc_av_InterfaceProvidingRequiringEntity():
    instance = pcm_pc_av_entity_pc_av_ComposedProvidingRequiringEntity()
    assert isinstance(instance, entity_pc_av_InterfaceProvidingRequiringEntity)


def test_pcm_pc_av_entity_pc_av_InterfaceProvidingRequiringEntity_isa_entity_pc_av_InterfaceRequiringEntity():
    instance = pcm_pc_av_entity_pc_av_InterfaceProvidingRequiringEntity()
    assert isinstance(instance, entity_pc_av_InterfaceRequiringEntity)


def test_pcm_pc_av_entity_pc_av_Entity_isa_entity_pc_av_NamedElement():
    instance = pcm_pc_av_entity_pc_av_Entity()
    assert isinstance(instance, entity_pc_av_NamedElement)


def test_pcm_pc_av_entity_pc_av_ResourceInterfaceProvidingRequiringEntity_isa_entity_pc_av_ResourceInterfaceProvidingEntity():
    instance = pcm_pc_av_entity_pc_av_ResourceInterfaceProvidingRequiringEntity()
    assert isinstance(instance, entity_pc_av_ResourceInterfaceProvidingEntity)


def test_pcm_pc_av_resourcetype_pc_av_ResourceType_isa_entity_pc_av_ResourceInterfaceProvidingEntity():
    instance = pcm_pc_av_resourcetype_pc_av_ResourceType()
    assert isinstance(instance, entity_pc_av_ResourceInterfaceProvidingEntity)


def test_pcm_pc_av_entity_pc_av_InterfaceRequiringEntity_isa_entity_pc_av_ResourceInterfaceRequiringEntity():
    instance = pcm_pc_av_entity_pc_av_InterfaceRequiringEntity()
    assert isinstance(instance, entity_pc_av_ResourceInterfaceRequiringEntity)


def test_pcm_pc_av_entity_pc_av_ResourceInterfaceProvidingRequiringEntity_isa_entity_pc_av_ResourceInterfaceRequiringEntity():
    instance = pcm_pc_av_entity_pc_av_ResourceInterfaceProvidingRequiringEntity()
    assert isinstance(instance, entity_pc_av_ResourceInterfaceRequiringEntity)


def test_pcm_pc_av_repository_pc_av_CollectionDataType_isa_repository_pc_av_DataType():
    instance = pcm_pc_av_repository_pc_av_CollectionDataType()
    assert isinstance(instance, repository_pc_av_DataType)


def test_pcm_pc_av_repository_pc_av_CompositeDataType_isa_repository_pc_av_DataType():
    instance = pcm_pc_av_repository_pc_av_CompositeDataType()
    assert isinstance(instance, repository_pc_av_DataType)


def test_pcm_pc_av_completions_pc_av_Completion_isa_repository_pc_av_ImplementationComponentType():
    instance = pcm_pc_av_completions_pc_av_Completion()
    assert isinstance(instance, repository_pc_av_ImplementationComponentType)


def test_pcm_pc_av_repository_pc_av_CompositeComponent_isa_repository_pc_av_ImplementationComponentType():
    instance = pcm_pc_av_repository_pc_av_CompositeComponent()
    assert isinstance(instance, repository_pc_av_ImplementationComponentType)


def test_pcm_pc_av_subsystem_pc_av_SubSystem_isa_repository_pc_av_RepositoryComponent():
    instance = pcm_pc_av_subsystem_pc_av_SubSystem()
    assert isinstance(instance, repository_pc_av_RepositoryComponent)


def test_pcm_pc_av_seff_pc_av_EmitEventAction_isa_seff_pc_av_AbstractAction():
    instance = pcm_pc_av_seff_pc_av_EmitEventAction()
    assert isinstance(instance, seff_pc_av_AbstractAction)


def test_pcm_pc_av_seff_pc_av_ExternalCallAction_isa_seff_pc_av_AbstractAction():
    instance = pcm_pc_av_seff_pc_av_ExternalCallAction(retryCount=7)
    assert isinstance(instance, seff_pc_av_AbstractAction)


def test_pcm_pc_av_seff_pc_av_InternalCallAction_isa_seff_pc_av_AbstractInternalControlFlowAction():
    instance = pcm_pc_av_seff_pc_av_InternalCallAction()
    assert isinstance(instance, seff_pc_av_AbstractInternalControlFlowAction)


def test_pcm_pc_av_seff_pc_av_EmitEventAction_isa_seff_pc_av_CallAction():
    instance = pcm_pc_av_seff_pc_av_EmitEventAction()
    assert isinstance(instance, seff_pc_av_CallAction)


def test_pcm_pc_av_seff_pc_av_InternalCallAction_isa_seff_pc_av_CallAction():
    instance = pcm_pc_av_seff_pc_av_InternalCallAction()
    assert isinstance(instance, seff_pc_av_CallAction)


def test_pcm_pc_av_seff_pc_av_ExternalCallAction_isa_seff_pc_av_CallReturnAction():
    instance = pcm_pc_av_seff_pc_av_ExternalCallAction(retryCount=7)
    assert isinstance(instance, seff_pc_av_CallReturnAction)


def test_pcm_pc_av_seff_pc_av_ResourceDemandingSEFF_isa_seff_pc_av_ResourceDemandingBehaviour():
    instance = pcm_pc_av_seff_pc_av_ResourceDemandingSEFF()
    assert isinstance(instance, seff_pc_av_ResourceDemandingBehaviour)


def test_pcm_pc_av_seff_reliability_pc_av_RecoveryActionBehaviour_isa_seff_pc_av_ResourceDemandingBehaviour():
    instance = pcm_pc_av_seff_reliability_pc_av_RecoveryActionBehaviour()
    assert isinstance(instance, seff_pc_av_ResourceDemandingBehaviour)


def test_pcm_pc_av_seff_pc_av_ResourceDemandingSEFF_isa_seff_pc_av_ServiceEffectSpecification():
    instance = pcm_pc_av_seff_pc_av_ResourceDemandingSEFF()
    assert isinstance(instance, seff_pc_av_ServiceEffectSpecification)


def test_pcm_pc_av_seff_pc_av_ExternalCallAction_isa_seff_reliability_pc_av_FailureHandlingEntity():
    instance = pcm_pc_av_seff_pc_av_ExternalCallAction(retryCount=7)
    assert isinstance(instance, seff_reliability_pc_av_FailureHandlingEntity)


def test_pcm_pc_av_seff_reliability_pc_av_RecoveryActionBehaviour_isa_seff_reliability_pc_av_FailureHandlingEntity():
    instance = pcm_pc_av_seff_reliability_pc_av_RecoveryActionBehaviour()
    assert isinstance(instance, seff_reliability_pc_av_FailureHandlingEntity)


def test_assoc_abstractBranchTransition_ResourceDemandingBehaviour343_link_reassign_clear():
    a = pcm_pc_av_seff_pc_av_ResourceDemandingBehaviour()
...
def test_assoc_action_ParametricResourceDemand421_link_reassign_clear():
    a = pcm_pc_av_seff_performance_pc_av_ParametricResourceDemand()
...
def test_assoc_action__InfrastructureCall404_link_reassign_clear():
    a = pcm_pc_av_seff_performance_pc_av_InfrastructureCall()
    b1 = AbstractInternalControlFlowAction()
    b2 = AbstractInternalControlFlowAction()
...
def test_assoc_action__ResourceCall408_link_reassign_clear():
    a = pcm_pc_av_seff_performance_pc_av_ResourceCall()
    b1 = AbstractInternalControlFlowAction()
    b2 = AbstractInternalControlFlowAction()
...
def test_assoc_actions_ScenarioBehaviour185_link_reassign_clear():
    a = pcm_pc_av_usagemodel_pc_av_ScenarioBehaviour()
...
def test_assoc_activeResourceType_ActiveResourceSpecification472_link_reassign_clear():
    a = pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification(MTTF=3.14, MTTR=3.14, numberOfReplicas=7, requiredByContainer=True)
    b1 = ProcessingResourceType()
    b2 = ProcessingResourceType()
    _safe_set(a, 'pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification473', b1)
    assert _is_linked(a, 'pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification473', b1)
    if hasattr(b1, 'ProcessingResourceType474'):
        assert _is_linked(b1, 'ProcessingResourceType474', a)
    _safe_set(a, 'pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification473', b2)
    assert _is_linked(a, 'pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification473', b2)
    if hasattr(b1, 'ProcessingResourceType474'):
    ...
    _safe_set(a, 'pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification473', None)
    assert not _is_linked(a, 'pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification473', b2)
    if hasattr(b2, 'ProcessingResourceType474'):
        assert not _is_linked(b2, 'ProcessingResourceType474', a)


def test_assoc_allocationContexts_Allocation500_link_reassign_clear():
    a = pcm_pc_av_allocation_pc_av_Allocation()
...
def test_assoc_allocation_AllocationContext492_link_reassign_clear():
    a = pcm_pc_av_allocation_pc_av_AllocationContext()
    b1 = Allocation()
    b2 = Allocation()
...
def test_assoc_assemblyContext_AllocationContext489_link_reassign_clear():
    a = pcm_pc_av_allocation_pc_av_AllocationContext()
    b1 = composition_pc_av_AssemblyContext()
    b2 = composition_pc_av_AssemblyContext()
    _safe_set(a, 'pcm_pc_av_allocation_pc_av_AllocationContext490', b1)
    assert _is_linked(a, 'pcm_pc_av_allocation_pc_av_AllocationContext490', b1)
    if hasattr(b1, 'composition_pc_av_AssemblyContext491'):
        assert _is_linked(b1, 'composition_pc_av_AssemblyContext491', a)
    _safe_set(a, 'pcm_pc_av_allocation_pc_av_AllocationContext490', b2)
    assert _is_linked(a, 'pcm_pc_av_allocation_pc_av_AllocationContext490', b2)
    if hasattr(b1, 'composition_pc_av_AssemblyContext491'):
        assert not _is_linked(b1, 'composition_pc_av_AssemblyContext491', a)
    if hasattr(b2, 'composition_pc_av_AssemblyContext491'):
        assert _is_linked(b2, 'composition_pc_av_AssemblyContext491', a)
    _safe_set(a, 'pcm_pc_av_allocation_pc_av_AllocationContext490', None)
    assert not _is_linked(a, 'pcm_pc_av_allocation_pc_av_AllocationContext490', b2)
    if hasattr(b2, 'composition_pc_av_AssemblyContext491'):
        assert not _is_linked(b2, 'composition_pc_av_AssemblyContext491', a)


def test_assoc_assemblyContext_ProvidedDelegationConnector67_link_reassign_clear():
    a = pcm_pc_av_composition_pc_av_ProvidedDelegationConnector()
    b1 = composition_pc_av_AssemblyContext()
    b2 = composition_pc_av_AssemblyContext()
    _safe_set(a, 'pcm_pc_av_composition_pc_av_ProvidedDelegationConnector68', b1)
    assert _is_linked(a, 'pcm_pc_av_composition_pc_av_ProvidedDelegationConnector68', b1)
    if hasattr(b1, 'composition_pc_av_AssemblyContext69'):
        assert _is_linked(b1, 'composition_pc_av_AssemblyContext69', a)
    _safe_set(a, 'pcm_pc_av_composition_pc_av_ProvidedDelegationConnector68', b2)
    assert _is_linked(a, 'pcm_pc_av_composition_pc_av_ProvidedDelegationConnector68', b2)
    if hasattr(b1, 'composition_pc_av_AssemblyContext69'):
        assert not _is_linked(b1, 'composition_pc_av_AssemblyContext69', a)
    if hasattr(b2, 'composition_pc_av_AssemblyContext69'):
        assert _is_linked(b2, 'composition_pc_av_AssemblyContext69', a)
    _safe_set(a, 'pcm_pc_av_composition_pc_av_ProvidedDelegationConnector68', None)
    assert not _is_linked(a, 'pcm_pc_av_composition_pc_av_ProvidedDelegationConnector68', b2)
    if hasattr(b2, 'composition_pc_av_AssemblyContext69'):
        assert not _is_linked(b2, 'composition_pc_av_AssemblyContext69', a)


def test_assoc_assemblyContext_RequiredDelegationConnector74_link_reassign_clear():
    a = pcm_pc_av_composition_pc_av_RequiredDelegationConnector()
    b1 = composition_pc_av_AssemblyContext()
    b2 = composition_pc_av_AssemblyContext()
    _safe_set(a, 'pcm_pc_av_composition_pc_av_RequiredDelegationConnector75', b1)
    assert _is_linked(a, 'pcm_pc_av_composition_pc_av_RequiredDelegationConnector75', b1)
    if hasattr(b1, 'composition_pc_av_AssemblyContext76'):
        assert _is_linked(b1, 'composition_pc_av_AssemblyContext76', a)
    _safe_set(a, 'pcm_pc_av_composition_pc_av_RequiredDelegationConnector75', b2)
    assert _is_linked(a, 'pcm_pc_av_composition_pc_av_RequiredDelegationConnector75', b2)
    if hasattr(b1, 'composition_pc_av_AssemblyContext76'):
        assert not _is_linked(b1, 'composition_pc_av_AssemblyContext76', a)
    if hasattr(b2, 'composition_pc_av_AssemblyContext76'):
        assert _is_linked(b2, 'composition_pc_av_AssemblyContext76', a)
    _safe_set(a, 'pcm_pc_av_composition_pc_av_RequiredDelegationConnector75', None)
    assert not _is_linked(a, 'pcm_pc_av_composition_pc_av_RequiredDelegationConnector75', b2)
    if hasattr(b2, 'composition_pc_av_AssemblyContext76'):
        assert not _is_linked(b2, 'composition_pc_av_AssemblyContext76', a)


def test_assoc_assemblyContexts__ComposedStructure35_link_reassign_clear():
    a = pcm_pc_av_composition_pc_av_ComposedStructure()
    b1 = composition_pc_av_AssemblyContext()
    b2 = composition_pc_av_AssemblyContext()
...
def test_assoc_assemblyEventConnector__FilterCondition17_link_reassign_clear():
    a = pcm_pc_av_core_pc_av_PCMRandomVariable()
    b1 = composition_pc_av_AssemblyEventConnector()
    b2 = composition_pc_av_AssemblyEventConnector()
...
def test_assoc_basicComponent_ServiceEffectSpecification356_link_reassign_clear():
    a = pcm_pc_av_seff_pc_av_ServiceEffectSpecification(seffTypeID="sample_text")
    b1 = BasicComponent()
    b2 = BasicComponent()
...
def test_assoc_branchTransitions_Branch190_link_reassign_clear():
    a = pcm_pc_av_usagemodel_pc_av_Branch()
    b1 = BranchTransition()
    b2 = BranchTransition()
...
def test_assoc_branch_BranchTransition187_link_reassign_clear():
    a = pcm_pc_av_usagemodel_pc_av_BranchTransition(branchProbability=3.14)
    b1 = Branch()
    b2 = Branch()
...
def test_assoc_branches_Branch351_link_reassign_clear():
    a = pcm_pc_av_seff_pc_av_BranchAction()
    b1 = AbstractBranchTransition()
    b2 = AbstractBranchTransition()
...
def test_assoc_calledService_ExternalService376_link_reassign_clear():
    a = pcm_pc_av_seff_pc_av_ExternalCallAction(retryCount=7)
    b1 = OperationSignature()
    b2 = OperationSignature()
    _safe_set(a, 'pcm_pc_av_seff_pc_av_ExternalCallAction', b1)
    assert _is_linked(a, 'pcm_pc_av_seff_pc_av_ExternalCallAction', b1)
    if hasattr(b1, 'OperationSignature377'):
        assert _is_linked(b1, 'OperationSignature377', a)
    _safe_set(a, 'pcm_pc_av_seff_pc_av_ExternalCallAction', b2)
    assert _is_linked(a, 'pcm_pc_av_seff_pc_av_ExternalCallAction', b2)
    if hasattr(b1, 'OperationSignature377'):
    ...
    _safe_set(a, 'pcm_pc_av_seff_pc_av_ExternalCallAction', None)
    assert not _is_linked(a, 'pcm_pc_av_seff_pc_av_ExternalCallAction', b2)
    if hasattr(b2, 'OperationSignature377'):
...
def test_assoc_communicationLinkResourceType_CommunicationLinkResourceSpecification481_link_reassign_clear():
    a = pcm_pc_av_resourceenvironment_pc_av_CommunicationLinkResourceSpecification(failureProbability=3.14)
    b1 = CommunicationLinkResourceType()
    b2 = CommunicationLinkResourceType()
    _safe_set(a, 'pcm_pc_av_resourceenvironment_pc_av_CommunicationLinkResourceSpecification', b1)
    assert _is_linked(a, 'pcm_pc_av_resourceenvironment_pc_av_CommunicationLinkResourceSpecification', b1)
    if hasattr(b1, 'CommunicationLinkResourceType482'):
        assert _is_linked(b1, 'CommunicationLinkResourceType482', a)
    _safe_set(a, 'pcm_pc_av_resourceenvironment_pc_av_CommunicationLinkResourceSpecification', b2)
    assert _is_linked(a, 'pcm_pc_av_resourceenvironment_pc_av_CommunicationLinkResourceSpecification', b2)
    if hasattr(b1, 'CommunicationLinkResourceType482'):
    ...
    _safe_set(a, 'pcm_pc_av_resourceenvironment_pc_av_CommunicationLinkResourceSpecification', None)
    assert not _is_linked(a, 'pcm_pc_av_resourceenvironment_pc_av_CommunicationLinkResourceSpecification', b2)
    if hasattr(b2, 'CommunicationLinkResourceType482'):
...
def test_assoc_communicationLinkResourceType__NetworkInducedFailureType323_link_reassign_clear():
    a = pcm_pc_av_reliability_pc_av_NetworkInducedFailureType()
    b1 = CommunicationLinkResourceType()
    b2 = CommunicationLinkResourceType()
...
def test_assoc_componentParameterUsage_ImplementationComponentType210_link_reassign_clear():
    a = pcm_pc_av_repository_pc_av_ImplementationComponentType(componentType="sample_text")
    b1 = VariableUsage()
    b2 = VariableUsage()
    _safe_set(a, 'pcm_pc_av_repository_pc_av_ImplementationComponentType211', {b1})
    assert _is_linked(a, 'pcm_pc_av_repository_pc_av_ImplementationComponentType211', b1)
    if hasattr(b1, 'VariableUsage212'):
        assert _is_linked(b1, 'VariableUsage212', a)
    _safe_set(a, 'pcm_pc_av_repository_pc_av_ImplementationComponentType211', {b2})
    assert _is_linked(a, 'pcm_pc_av_repository_pc_av_ImplementationComponentType211', b2)
    if hasattr(b1, 'VariableUsage212'):
        assert not _is_linked(b1, 'VariableUsage212', a)
    if hasattr(b2, 'VariableUsage212'):
        assert _is_linked(b2, 'VariableUsage212', a)
    _safe_set(a, 'pcm_pc_av_repository_pc_av_ImplementationComponentType211', set())
    assert not _is_linked(a, 'pcm_pc_av_repository_pc_av_ImplementationComponentType211', b2)
    if hasattr(b2, 'VariableUsage212'):
        assert not _is_linked(b2, 'VariableUsage212', a)


def test_assoc_components__Repository223_link_reassign_clear():
    a = pcm_pc_av_repository_pc_av_Repository(repositoryDescription="sample_text")
...
def test_assoc_connectors__ComposedStructure38_link_reassign_clear():
    a = pcm_pc_av_composition_pc_av_ComposedStructure()
    b1 = composition_pc_av_Connector()
    b2 = composition_pc_av_Connector()
...
def test_assoc_dataType__Parameter215_link_reassign_clear():
    a = pcm_pc_av_repository_pc_av_Parameter(modifier__Parameter="sample_text", parameterName="sample_text")
    b1 = DataType()
    b2 = DataType()
    _safe_set(a, 'pcm_pc_av_repository_pc_av_Parameter', b1)
    assert _is_linked(a, 'pcm_pc_av_repository_pc_av_Parameter', b1)
    if hasattr(b1, 'DataType'):
        assert _is_linked(b1, 'DataType', a)
    _safe_set(a, 'pcm_pc_av_repository_pc_av_Parameter', b2)
    assert _is_linked(a, 'pcm_pc_av_repository_pc_av_Parameter', b2)
    if hasattr(b1, 'DataType'):
        assert not _is_linked(b1, 'DataType', a)
    if hasattr(b2, 'DataType'):
        assert _is_linked(b2, 'DataType', a)
    _safe_set(a, 'pcm_pc_av_repository_pc_av_Parameter', None)
    assert not _is_linked(a, 'pcm_pc_av_repository_pc_av_Parameter', b2)
    if hasattr(b2, 'DataType'):
...
def test_assoc_describedService__SEFF355_link_reassign_clear():
    ...
    b1 = Signature()
    b2 = Signature()
    _safe_set(a, 'pcm_pc_av_seff_pc_av_ServiceEffectSpecification', b1)
    assert _is_linked(a, 'pcm_pc_av_seff_pc_av_ServiceEffectSpecification', b1)
    if hasattr(b1, 'Signature'):
        assert _is_linked(b1, 'Signature', a)
    _safe_set(a, 'pcm_pc_av_seff_pc_av_ServiceEffectSpecification', b2)
    assert _is_linked(a, 'pcm_pc_av_seff_pc_av_ServiceEffectSpecification', b2)
    if hasattr(b1, 'Signature'):
        assert not _is_linked(b1, 'Signature', a)
    if hasattr(b2, 'Signature'):
        assert _is_linked(b2, 'Signature', a)
    _safe_set(a, 'pcm_pc_av_seff_pc_av_ServiceEffectSpecification', None)
    assert not _is_linked(a, 'pcm_pc_av_seff_pc_av_ServiceEffectSpecification', b2)
    if hasattr(b2, 'Signature'):
...
def test_assoc_eventChannelSinkConnector__FilterCondition16_link_reassign_clear():
    a = pcm_pc_av_core_pc_av_PCMRandomVariable()
    b1 = composition_pc_av_EventChannelSinkConnector()
    b2 = composition_pc_av_EventChannelSinkConnector()
...
def test_assoc_eventChannel__AllocationContext493_link_reassign_clear():
    a = pcm_pc_av_allocation_pc_av_AllocationContext()
    b1 = composition_pc_av_EventChannel()
    b2 = composition_pc_av_EventChannel()
    _safe_set(a, 'pcm_pc_av_allocation_pc_av_AllocationContext494', b1)
    assert _is_linked(a, 'pcm_pc_av_allocation_pc_av_AllocationContext494', b1)
    if hasattr(b1, 'composition_pc_av_EventChannel'):
        assert _is_linked(b1, 'composition_pc_av_EventChannel', a)
    _safe_set(a, 'pcm_pc_av_allocation_pc_av_AllocationContext494', b2)
    assert _is_linked(a, 'pcm_pc_av_allocation_pc_av_AllocationContext494', b2)
    if hasattr(b1, 'composition_pc_av_EventChannel'):
        assert not _is_linked(b1, 'composition_pc_av_EventChannel', a)
    if hasattr(b2, 'composition_pc_av_EventChannel'):
        assert _is_linked(b2, 'composition_pc_av_EventChannel', a)
    _safe_set(a, 'pcm_pc_av_allocation_pc_av_AllocationContext494', None)
    assert not _is_linked(a, 'pcm_pc_av_allocation_pc_av_AllocationContext494', b2)
    if hasattr(b2, 'composition_pc_av_EventChannel'):
        assert not _is_linked(b2, 'composition_pc_av_EventChannel', a)
...
def test_assoc_externalFailureOccurrenceDescriptions__SpecifiedReliabilityAnnotation452_link_reassign_clear():
    a = pcm_pc_av_qos_reliability_pc_av_SpecifiedReliabilityAnnotation()
...
def test_assoc_failureHandlingAlternatives__RecoveryActionBehaviour423_link_reassign_clear():
    a = pcm_pc_av_seff_reliability_pc_av_RecoveryActionBehaviour()
    b1 = seff_reliability_pc_av_RecoveryActionBehaviour()
    b2 = seff_reliability_pc_av_RecoveryActionBehaviour()
    _safe_set(a, 'pcm_pc_av_seff_reliability_pc_av_RecoveryActionBehaviour', {b1})
    assert _is_linked(a, 'pcm_pc_av_seff_reliability_pc_av_RecoveryActionBehaviour', b1)
    if hasattr(b1, 'seff_reliability_pc_av_RecoveryActionBehaviour'):
        assert _is_linked(b1, 'seff_reliability_pc_av_RecoveryActionBehaviour', a)
    _safe_set(a, 'pcm_pc_av_seff_reliability_pc_av_RecoveryActionBehaviour', {b2})
    assert _is_linked(a, 'pcm_pc_av_seff_reliability_pc_av_RecoveryActionBehaviour', b2)
    if hasattr(b1, 'seff_reliability_pc_av_RecoveryActionBehaviour'):
        assert not _is_linked(b1, 'seff_reliability_pc_av_RecoveryActionBehaviour', a)
    if hasattr(b2, 'seff_reliability_pc_av_RecoveryActionBehaviour'):
        assert _is_linked(b2, 'seff_reliability_pc_av_RecoveryActionBehaviour', a)
    _safe_set(a, 'pcm_pc_av_seff_reliability_pc_av_RecoveryActionBehaviour', set())
    assert not _is_linked(a, 'pcm_pc_av_seff_reliability_pc_av_RecoveryActionBehaviour', b2)
    if hasattr(b2, 'seff_reliability_pc_av_RecoveryActionBehaviour'):
        assert not _is_linked(b2, 'seff_reliability_pc_av_RecoveryActionBehaviour', a)


def test_assoc_failureType__ExternalFailureOccurrenceDescription325_link_reassign_clear():
    a = pcm_pc_av_reliability_pc_av_ExternalFailureOccurrenceDescription()
    b1 = FailureType()
    b2 = FailureType()
    _safe_set(a, 'pcm_pc_av_reliability_pc_av_ExternalFailureOccurrenceDescription', b1)
    assert _is_linked(a, 'pcm_pc_av_reliability_pc_av_ExternalFailureOccurrenceDescription', b1)
    if hasattr(b1, 'FailureType326'):
        assert _is_linked(b1, 'FailureType326', a)
    _safe_set(a, 'pcm_pc_av_reliability_pc_av_ExternalFailureOccurrenceDescription', b2)
    assert _is_linked(a, 'pcm_pc_av_reliability_pc_av_ExternalFailureOccurrenceDescription', b2)
    if hasattr(b1, 'FailureType326'):
        assert not _is_linked(b1, 'FailureType326', a)
    if hasattr(b2, 'FailureType326'):
        assert _is_linked(b2, 'FailureType326', a)
    _safe_set(a, 'pcm_pc_av_reliability_pc_av_ExternalFailureOccurrenceDescription', None)
    assert not _is_linked(a, 'pcm_pc_av_reliability_pc_av_ExternalFailureOccurrenceDescription', b2)
    if hasattr(b2, 'FailureType326'):
...
def test_assoc_infrastructureCall__PCMRandomVariable10_link_reassign_clear():
    a = pcm_pc_av_core_pc_av_PCMRandomVariable()
    b1 = seff_performance_pc_av_InfrastructureCall()
    b2 = seff_performance_pc_av_InfrastructureCall()
...
def test_assoc_innerProvidedRole_ProvidedDelegationConnector63_link_reassign_clear():
    ...
    _safe_set(a, 'pcm_pc_av_composition_pc_av_ProvidedDelegationConnector', b1)
    assert _is_linked(a, 'pcm_pc_av_composition_pc_av_ProvidedDelegationConnector', b1)
    if hasattr(b1, 'OperationProvidedRole'):
        assert _is_linked(b1, 'OperationProvidedRole', a)
    _safe_set(a, 'pcm_pc_av_composition_pc_av_ProvidedDelegationConnector', b2)
    assert _is_linked(a, 'pcm_pc_av_composition_pc_av_ProvidedDelegationConnector', b2)
    if hasattr(b1, 'OperationProvidedRole'):
    ...
    _safe_set(a, 'pcm_pc_av_composition_pc_av_ProvidedDelegationConnector', None)
    assert not _is_linked(a, 'pcm_pc_av_composition_pc_av_ProvidedDelegationConnector', b2)
    if hasattr(b2, 'OperationProvidedRole'):
...
def test_assoc_innerRequiredRole_RequiredDelegationConnector70_link_reassign_clear():
    ...
    _safe_set(a, 'pcm_pc_av_composition_pc_av_RequiredDelegationConnector', b1)
    assert _is_linked(a, 'pcm_pc_av_composition_pc_av_RequiredDelegationConnector', b1)
    if hasattr(b1, 'OperationRequiredRole'):
        assert _is_linked(b1, 'OperationRequiredRole', a)
    _safe_set(a, 'pcm_pc_av_composition_pc_av_RequiredDelegationConnector', b2)
    assert _is_linked(a, 'pcm_pc_av_composition_pc_av_RequiredDelegationConnector', b2)
    if hasattr(b1, 'OperationRequiredRole'):
    ...
    _safe_set(a, 'pcm_pc_av_composition_pc_av_RequiredDelegationConnector', None)
    assert not _is_linked(a, 'pcm_pc_av_composition_pc_av_RequiredDelegationConnector', b2)
    if hasattr(b2, 'OperationRequiredRole'):
...
def test_assoc_inputParameterUsages_EntryLevelSystemCall173_link_reassign_clear():
    a = pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall(priority=7)
    b1 = VariableUsage()
    b2 = VariableUsage()
...
def test_assoc_interArrivalTime_OpenWorkload196_link_reassign_clear():
    a = pcm_pc_av_usagemodel_pc_av_OpenWorkload()
...
def test_assoc_interface_RequiredCharacterisation237_link_reassign_clear():
    a = pcm_pc_av_repository_pc_av_RequiredCharacterisation(type="sample_text")
    b1 = Interface()
    b2 = Interface()
...
def test_assoc_interface__OperationSignature257_link_reassign_clear():
    a = pcm_pc_av_repository_pc_av_OperationSignature()
...
def test_assoc_internalAction__InternalFailureOccurrenceDescription321_link_reassign_clear():
    a = pcm_pc_av_reliability_pc_av_InternalFailureOccurrenceDescription()
    b1 = InternalAction()
    b2 = InternalAction()
...
def test_assoc_internalFailureOccurrenceDescriptions__InternalAction398_link_reassign_clear():
    a = pcm_pc_av_seff_pc_av_InternalAction()
...
def test_assoc_operationSignature__EntryLevelSystemCall169_link_reassign_clear():
    ...
    b1 = OperationSignature()
    b2 = OperationSignature()
    _safe_set(a, 'pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall170', b1)
    assert _is_linked(a, 'pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall170', b1)
    if hasattr(b1, 'OperationSignature'):
        assert _is_linked(b1, 'OperationSignature', a)
    _safe_set(a, 'pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall170', b2)
    assert _is_linked(a, 'pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall170', b2)
    if hasattr(b1, 'OperationSignature'):
        assert not _is_linked(b1, 'OperationSignature', a)
    if hasattr(b2, 'OperationSignature'):
        assert _is_linked(b2, 'OperationSignature', a)
    _safe_set(a, 'pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall170', None)
    assert not _is_linked(a, 'pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall170', b2)
    if hasattr(b2, 'OperationSignature'):
...
def test_assoc_outerProvidedRole_ProvidedDelegationConnector64_link_reassign_clear():
    ...
    b1 = OperationProvidedRole()
    b2 = OperationProvidedRole()
    _safe_set(a, 'pcm_pc_av_composition_pc_av_ProvidedDelegationConnector65', b1)
    assert _is_linked(a, 'pcm_pc_av_composition_pc_av_ProvidedDelegationConnector65', b1)
    if hasattr(b1, 'OperationProvidedRole66'):
        assert _is_linked(b1, 'OperationProvidedRole66', a)
    _safe_set(a, 'pcm_pc_av_composition_pc_av_ProvidedDelegationConnector65', b2)
    assert _is_linked(a, 'pcm_pc_av_composition_pc_av_ProvidedDelegationConnector65', b2)
    if hasattr(b1, 'OperationProvidedRole66'):
    ...
    _safe_set(a, 'pcm_pc_av_composition_pc_av_ProvidedDelegationConnector65', None)
    assert not _is_linked(a, 'pcm_pc_av_composition_pc_av_ProvidedDelegationConnector65', b2)
    if hasattr(b2, 'OperationProvidedRole66'):
...
def test_assoc_outerRequiredRole_RequiredDelegationConnector71_link_reassign_clear():
    ...
    b1 = OperationRequiredRole()
    b2 = OperationRequiredRole()
    _safe_set(a, 'pcm_pc_av_composition_pc_av_RequiredDelegationConnector72', b1)
    assert _is_linked(a, 'pcm_pc_av_composition_pc_av_RequiredDelegationConnector72', b1)
    if hasattr(b1, 'OperationRequiredRole73'):
        assert _is_linked(b1, 'OperationRequiredRole73', a)
    _safe_set(a, 'pcm_pc_av_composition_pc_av_RequiredDelegationConnector72', b2)
    assert _is_linked(a, 'pcm_pc_av_composition_pc_av_RequiredDelegationConnector72', b2)
    if hasattr(b1, 'OperationRequiredRole73'):
    ...
    _safe_set(a, 'pcm_pc_av_composition_pc_av_RequiredDelegationConnector72', None)
    assert not _is_linked(a, 'pcm_pc_av_composition_pc_av_RequiredDelegationConnector72', b2)
    if hasattr(b2, 'OperationRequiredRole73'):
...
def test_assoc_parameter236_link_reassign_clear():
    ...
    b1 = Parameter()
    b2 = Parameter()
    _safe_set(a, 'pcm_pc_av_repository_pc_av_RequiredCharacterisation', b1)
    assert _is_linked(a, 'pcm_pc_av_repository_pc_av_RequiredCharacterisation', b1)
    if hasattr(b1, 'Parameter'):
        assert _is_linked(b1, 'Parameter', a)
    _safe_set(a, 'pcm_pc_av_repository_pc_av_RequiredCharacterisation', b2)
    assert _is_linked(a, 'pcm_pc_av_repository_pc_av_RequiredCharacterisation', b2)
    if hasattr(b1, 'Parameter'):
        assert not _is_linked(b1, 'Parameter', a)
    if hasattr(b2, 'Parameter'):
        assert _is_linked(b2, 'Parameter', a)
    _safe_set(a, 'pcm_pc_av_repository_pc_av_RequiredCharacterisation', None)
    assert not _is_linked(a, 'pcm_pc_av_repository_pc_av_RequiredCharacterisation', b2)
    if hasattr(b2, 'Parameter'):
        assert not _is_linked(b2, 'Parameter', a)


def test_assoc_parameter__ResourceSignature283_link_reassign_clear():
    a = pcm_pc_av_resourcetype_pc_av_ResourceSignature(resourceServiceId=7)
    b1 = Parameter()
    b2 = Parameter()
...
def test_assoc_parametricResourceDemand_PCMRandomVariable12_link_reassign_clear():
    a = pcm_pc_av_core_pc_av_PCMRandomVariable()
    b1 = seff_performance_pc_av_ParametricResourceDemand()
    b2 = seff_performance_pc_av_ParametricResourceDemand()
...
def test_assoc_parentCompleteComponentTypes209_link_reassign_clear():
    ...
    _safe_set(a, 'pcm_pc_av_repository_pc_av_ImplementationComponentType', {b1})
    assert _is_linked(a, 'pcm_pc_av_repository_pc_av_ImplementationComponentType', b1)
    if hasattr(b1, 'CompleteComponentType'):
        assert _is_linked(b1, 'CompleteComponentType', a)
    _safe_set(a, 'pcm_pc_av_repository_pc_av_ImplementationComponentType', {b2})
    assert _is_linked(a, 'pcm_pc_av_repository_pc_av_ImplementationComponentType', b2)
    if hasattr(b1, 'CompleteComponentType'):
    ...
    _safe_set(a, 'pcm_pc_av_repository_pc_av_ImplementationComponentType', set())
    assert not _is_linked(a, 'pcm_pc_av_repository_pc_av_ImplementationComponentType', b2)
    if hasattr(b2, 'CompleteComponentType'):
        assert not _is_linked(b2, 'CompleteComponentType', a)


def test_assoc_parentInterfaces__Interface229_link_reassign_clear():
    a = pcm_pc_av_repository_pc_av_Interface()
    b1 = Interface()
    b2 = Interface()
    _safe_set(a, 'pcm_pc_av_repository_pc_av_Interface', {b1})
    assert _is_linked(a, 'pcm_pc_av_repository_pc_av_Interface', b1)
    if hasattr(b1, 'Interface230'):
        assert _is_linked(b1, 'Interface230', a)
    _safe_set(a, 'pcm_pc_av_repository_pc_av_Interface', {b2})
    assert _is_linked(a, 'pcm_pc_av_repository_pc_av_Interface', b2)
    if hasattr(b1, 'Interface230'):
        assert not _is_linked(b1, 'Interface230', a)
    if hasattr(b2, 'Interface230'):
        assert _is_linked(b2, 'Interface230', a)
    _safe_set(a, 'pcm_pc_av_repository_pc_av_Interface', set())
    assert not _is_linked(a, 'pcm_pc_av_repository_pc_av_Interface', b2)
    if hasattr(b2, 'Interface230'):
        assert not _is_linked(b2, 'Interface230', a)


def test_assoc_parentProvidesComponentTypes274_link_reassign_clear():
    a = pcm_pc_av_repository_pc_av_CompleteComponentType()
    b1 = ProvidesComponentType()
    b2 = ProvidesComponentType()
    _safe_set(a, 'pcm_pc_av_repository_pc_av_CompleteComponentType', {b1})
    assert _is_linked(a, 'pcm_pc_av_repository_pc_av_CompleteComponentType', b1)
    if hasattr(b1, 'ProvidesComponentType'):
        assert _is_linked(b1, 'ProvidesComponentType', a)
    _safe_set(a, 'pcm_pc_av_repository_pc_av_CompleteComponentType', {b2})
    assert _is_linked(a, 'pcm_pc_av_repository_pc_av_CompleteComponentType', b2)
    if hasattr(b1, 'ProvidesComponentType'):
    ...
    _safe_set(a, 'pcm_pc_av_repository_pc_av_CompleteComponentType', set())
    assert not _is_linked(a, 'pcm_pc_av_repository_pc_av_CompleteComponentType', b2)
    if hasattr(b2, 'ProvidesComponentType'):
        assert not _is_linked(b2, 'ProvidesComponentType', a)


def test_assoc_passiveResource_BasicComponent207_link_reassign_clear():
    a = pcm_pc_av_repository_pc_av_BasicComponent()
    b1 = PassiveResource()
    b2 = PassiveResource()
...
def test_assoc_passiveresource_AcquireAction383_link_reassign_clear():
    a = pcm_pc_av_seff_pc_av_AcquireAction(timeout=True, timeoutValue=3.14)
    b1 = PassiveResource()
    b2 = PassiveResource()
    _safe_set(a, 'pcm_pc_av_seff_pc_av_AcquireAction', b1)
    assert _is_linked(a, 'pcm_pc_av_seff_pc_av_AcquireAction', b1)
    if hasattr(b1, 'PassiveResource384'):
        assert _is_linked(b1, 'PassiveResource384', a)
    _safe_set(a, 'pcm_pc_av_seff_pc_av_AcquireAction', b2)
    assert _is_linked(a, 'pcm_pc_av_seff_pc_av_AcquireAction', b2)
    if hasattr(b1, 'PassiveResource384'):
        assert not _is_linked(b1, 'PassiveResource384', a)
    if hasattr(b2, 'PassiveResource384'):
        assert _is_linked(b2, 'PassiveResource384', a)
    _safe_set(a, 'pcm_pc_av_seff_pc_av_AcquireAction', None)
    assert not _is_linked(a, 'pcm_pc_av_seff_pc_av_AcquireAction', b2)
    if hasattr(b2, 'PassiveResource384'):
        assert not _is_linked(b2, 'PassiveResource384', a)


def test_assoc_primaryBehaviour__RecoveryAction425_link_reassign_clear():
    a = pcm_pc_av_seff_reliability_pc_av_RecoveryAction()
    b1 = seff_reliability_pc_av_RecoveryActionBehaviour()
    b2 = seff_reliability_pc_av_RecoveryActionBehaviour()
    _safe_set(a, 'pcm_pc_av_seff_reliability_pc_av_RecoveryAction', b1)
    assert _is_linked(a, 'pcm_pc_av_seff_reliability_pc_av_RecoveryAction', b1)
    if hasattr(b1, 'seff_reliability_pc_av_RecoveryActionBehaviour426'):
        assert _is_linked(b1, 'seff_reliability_pc_av_RecoveryActionBehaviour426', a)
    _safe_set(a, 'pcm_pc_av_seff_reliability_pc_av_RecoveryAction', b2)
    assert _is_linked(a, 'pcm_pc_av_seff_reliability_pc_av_RecoveryAction', b2)
    if hasattr(b1, 'seff_reliability_pc_av_RecoveryActionBehaviour426'):
        assert not _is_linked(b1, 'seff_reliability_pc_av_RecoveryActionBehaviour426', a)
    if hasattr(b2, 'seff_reliability_pc_av_RecoveryActionBehaviour426'):
        assert _is_linked(b2, 'seff_reliability_pc_av_RecoveryActionBehaviour426', a)
    _safe_set(a, 'pcm_pc_av_seff_reliability_pc_av_RecoveryAction', None)
    assert not _is_linked(a, 'pcm_pc_av_seff_reliability_pc_av_RecoveryAction', b2)
    if hasattr(b2, 'seff_reliability_pc_av_RecoveryActionBehaviour426'):
        assert not _is_linked(b2, 'seff_reliability_pc_av_RecoveryActionBehaviour426', a)
...
def test_assoc_processingResourceType__HardwareInducedFailureType319_link_reassign_clear():
    a = pcm_pc_av_reliability_pc_av_HardwareInducedFailureType()
    b1 = ProcessingResourceType()
    b2 = ProcessingResourceType()
...
def test_assoc_protocols__Interface231_link_reassign_clear():
    ...
    b1 = Protocol()
    b2 = Protocol()
    _safe_set(a, 'pcm_pc_av_repository_pc_av_Interface232', {b1})
    assert _is_linked(a, 'pcm_pc_av_repository_pc_av_Interface232', b1)
    if hasattr(b1, 'Protocol'):
        assert _is_linked(b1, 'Protocol', a)
    _safe_set(a, 'pcm_pc_av_repository_pc_av_Interface232', {b2})
    assert _is_linked(a, 'pcm_pc_av_repository_pc_av_Interface232', b2)
    if hasattr(b1, 'Protocol'):
        assert not _is_linked(b1, 'Protocol', a)
    if hasattr(b2, 'Protocol'):
        assert _is_linked(b2, 'Protocol', a)
    _safe_set(a, 'pcm_pc_av_repository_pc_av_Interface232', set())
    assert not _is_linked(a, 'pcm_pc_av_repository_pc_av_Interface232', b2)
    if hasattr(b2, 'Protocol'):
        assert not _is_linked(b2, 'Protocol', a)


def test_assoc_providedRole_AssemblyConnector82_link_reassign_clear():
    a = pcm_pc_av_composition_pc_av_AssemblyConnector()
    b1 = OperationProvidedRole()
    b2 = OperationProvidedRole()
    _safe_set(a, 'pcm_pc_av_composition_pc_av_AssemblyConnector83', b1)
    assert _is_linked(a, 'pcm_pc_av_composition_pc_av_AssemblyConnector83', b1)
    if hasattr(b1, 'OperationProvidedRole84'):
        assert _is_linked(b1, 'OperationProvidedRole84', a)
    _safe_set(a, 'pcm_pc_av_composition_pc_av_AssemblyConnector83', b2)
    assert _is_linked(a, 'pcm_pc_av_composition_pc_av_AssemblyConnector83', b2)
    if hasattr(b1, 'OperationProvidedRole84'):
    ...
    _safe_set(a, 'pcm_pc_av_composition_pc_av_AssemblyConnector83', None)
    assert not _is_linked(a, 'pcm_pc_av_composition_pc_av_AssemblyConnector83', b2)
    if hasattr(b2, 'OperationProvidedRole84'):
...
def test_assoc_providedRole_EntryLevelSystemCall167_link_reassign_clear():
    ...
    b1 = OperationProvidedRole()
    b2 = OperationProvidedRole()
    _safe_set(a, 'pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall', b1)
    assert _is_linked(a, 'pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall', b1)
    if hasattr(b1, 'OperationProvidedRole168'):
        assert _is_linked(b1, 'OperationProvidedRole168', a)
    _safe_set(a, 'pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall', b2)
    assert _is_linked(a, 'pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall', b2)
    if hasattr(b1, 'OperationProvidedRole168'):
    ...
    _safe_set(a, 'pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall', None)
    assert not _is_linked(a, 'pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall', b2)
    if hasattr(b2, 'OperationProvidedRole168'):
...
def test_assoc_providingAssemblyContext_AssemblyConnector79_link_reassign_clear():
    ...
    b1 = composition_pc_av_AssemblyContext()
    b2 = composition_pc_av_AssemblyContext()
    _safe_set(a, 'pcm_pc_av_composition_pc_av_AssemblyConnector80', b1)
    assert _is_linked(a, 'pcm_pc_av_composition_pc_av_AssemblyConnector80', b1)
    if hasattr(b1, 'composition_pc_av_AssemblyContext81'):
        assert _is_linked(b1, 'composition_pc_av_AssemblyContext81', a)
    _safe_set(a, 'pcm_pc_av_composition_pc_av_AssemblyConnector80', b2)
    assert _is_linked(a, 'pcm_pc_av_composition_pc_av_AssemblyConnector80', b2)
    if hasattr(b1, 'composition_pc_av_AssemblyContext81'):
        assert not _is_linked(b1, 'composition_pc_av_AssemblyContext81', a)
    if hasattr(b2, 'composition_pc_av_AssemblyContext81'):
        assert _is_linked(b2, 'composition_pc_av_AssemblyContext81', a)
    _safe_set(a, 'pcm_pc_av_composition_pc_av_AssemblyConnector80', None)
    assert not _is_linked(a, 'pcm_pc_av_composition_pc_av_AssemblyConnector80', b2)
    if hasattr(b2, 'composition_pc_av_AssemblyContext81'):
        assert not _is_linked(b2, 'composition_pc_av_AssemblyContext81', a)


def test_assoc_qosAnnotations_System453_link_reassign_clear():
    a = pcm_pc_av_system_pc_av_System()
    b1 = QoSAnnotations()
    b2 = QoSAnnotations()
...
def test_assoc_recoveryAction__RecoveryActionBehaviour424_link_reassign_clear():
    a = pcm_pc_av_seff_reliability_pc_av_RecoveryActionBehaviour()
    b1 = seff_reliability_pc_av_RecoveryAction()
    b2 = seff_reliability_pc_av_RecoveryAction()
...
def test_assoc_requiredResource_ParametricResourceDemand419_link_reassign_clear():
    ...
    b1 = ProcessingResourceType()
    b2 = ProcessingResourceType()
    _safe_set(a, 'pcm_pc_av_seff_performance_pc_av_ParametricResourceDemand', b1)
    assert _is_linked(a, 'pcm_pc_av_seff_performance_pc_av_ParametricResourceDemand', b1)
    if hasattr(b1, 'ProcessingResourceType420'):
        assert _is_linked(b1, 'ProcessingResourceType420', a)
    _safe_set(a, 'pcm_pc_av_seff_performance_pc_av_ParametricResourceDemand', b2)
    assert _is_linked(a, 'pcm_pc_av_seff_performance_pc_av_ParametricResourceDemand', b2)
    if hasattr(b1, 'ProcessingResourceType420'):
    ...
    _safe_set(a, 'pcm_pc_av_seff_performance_pc_av_ParametricResourceDemand', None)
    assert not _is_linked(a, 'pcm_pc_av_seff_performance_pc_av_ParametricResourceDemand', b2)
    if hasattr(b2, 'ProcessingResourceType420'):
...
def test_assoc_requiredRole_AssemblyConnector85_link_reassign_clear():
    ...
    b1 = OperationRequiredRole()
    b2 = OperationRequiredRole()
    _safe_set(a, 'pcm_pc_av_composition_pc_av_AssemblyConnector86', b1)
    assert _is_linked(a, 'pcm_pc_av_composition_pc_av_AssemblyConnector86', b1)
    if hasattr(b1, 'OperationRequiredRole87'):
        assert _is_linked(b1, 'OperationRequiredRole87', a)
    _safe_set(a, 'pcm_pc_av_composition_pc_av_AssemblyConnector86', b2)
    assert _is_linked(a, 'pcm_pc_av_composition_pc_av_AssemblyConnector86', b2)
    if hasattr(b1, 'OperationRequiredRole87'):
    ...
    _safe_set(a, 'pcm_pc_av_composition_pc_av_AssemblyConnector86', None)
    assert not _is_linked(a, 'pcm_pc_av_composition_pc_av_AssemblyConnector86', b2)
    if hasattr(b2, 'OperationRequiredRole87'):
...
def test_assoc_requiredRole__InfrastructureCall405_link_reassign_clear():
    ...
    _safe_set(a, 'pcm_pc_av_seff_performance_pc_av_InfrastructureCall406', b1)
    assert _is_linked(a, 'pcm_pc_av_seff_performance_pc_av_InfrastructureCall406', b1)
    if hasattr(b1, 'InfrastructureRequiredRole407'):
        assert _is_linked(b1, 'InfrastructureRequiredRole407', a)
    _safe_set(a, 'pcm_pc_av_seff_performance_pc_av_InfrastructureCall406', b2)
    assert _is_linked(a, 'pcm_pc_av_seff_performance_pc_av_InfrastructureCall406', b2)
    if hasattr(b1, 'InfrastructureRequiredRole407'):
    ...
    _safe_set(a, 'pcm_pc_av_seff_performance_pc_av_InfrastructureCall406', None)
    assert not _is_linked(a, 'pcm_pc_av_seff_performance_pc_av_InfrastructureCall406', b2)
    if hasattr(b2, 'InfrastructureRequiredRole407'):
...
def test_assoc_requiringAssemblyContext_AssemblyConnector77_link_reassign_clear():
    ...
    b1 = composition_pc_av_AssemblyContext()
    b2 = composition_pc_av_AssemblyContext()
    _safe_set(a, 'pcm_pc_av_composition_pc_av_AssemblyConnector', b1)
    assert _is_linked(a, 'pcm_pc_av_composition_pc_av_AssemblyConnector', b1)
    if hasattr(b1, 'composition_pc_av_AssemblyContext78'):
        assert _is_linked(b1, 'composition_pc_av_AssemblyContext78', a)
    _safe_set(a, 'pcm_pc_av_composition_pc_av_AssemblyConnector', b2)
    assert _is_linked(a, 'pcm_pc_av_composition_pc_av_AssemblyConnector', b2)
    if hasattr(b1, 'composition_pc_av_AssemblyContext78'):
        assert not _is_linked(b1, 'composition_pc_av_AssemblyContext78', a)
    if hasattr(b2, 'composition_pc_av_AssemblyContext78'):
        assert _is_linked(b2, 'composition_pc_av_AssemblyContext78', a)
    _safe_set(a, 'pcm_pc_av_composition_pc_av_AssemblyConnector', None)
    assert not _is_linked(a, 'pcm_pc_av_composition_pc_av_AssemblyConnector', b2)
    if hasattr(b2, 'composition_pc_av_AssemblyContext78'):
        assert not _is_linked(b2, 'composition_pc_av_AssemblyContext78', a)


def test_assoc_resourceCall__PCMRandomVariable11_link_reassign_clear():
    a = pcm_pc_av_core_pc_av_PCMRandomVariable()
    b1 = seff_performance_pc_av_ResourceCall()
    b2 = seff_performance_pc_av_ResourceCall()
...
def test_assoc_resourceContainer_AllocationContext487_link_reassign_clear():
    ...
    _safe_set(a, 'pcm_pc_av_allocation_pc_av_AllocationContext', b1)
    assert _is_linked(a, 'pcm_pc_av_allocation_pc_av_AllocationContext', b1)
    if hasattr(b1, 'ResourceContainer488'):
        assert _is_linked(b1, 'ResourceContainer488', a)
    _safe_set(a, 'pcm_pc_av_allocation_pc_av_AllocationContext', b2)
    assert _is_linked(a, 'pcm_pc_av_allocation_pc_av_AllocationContext', b2)
    if hasattr(b1, 'ResourceContainer488'):
    ...
    _safe_set(a, 'pcm_pc_av_allocation_pc_av_AllocationContext', None)
    assert not _is_linked(a, 'pcm_pc_av_allocation_pc_av_AllocationContext', b2)
    if hasattr(b2, 'ResourceContainer488'):
...
def test_assoc_resourceRequiredDelegationConnectors_ComposedStructure36_link_reassign_clear():
    a = pcm_pc_av_composition_pc_av_ComposedStructure()
    b1 = composition_pc_av_ResourceRequiredDelegationConnector()
    b2 = composition_pc_av_ResourceRequiredDelegationConnector()
...
def test_assoc_resourceRequiredRole__ResourceCall410_link_reassign_clear():
    a = pcm_pc_av_seff_performance_pc_av_ResourceCall()
    b1 = entity_pc_av_ResourceRequiredRole()
    b2 = entity_pc_av_ResourceRequiredRole()
    _safe_set(a, 'pcm_pc_av_seff_performance_pc_av_ResourceCall', b1)
    assert _is_linked(a, 'pcm_pc_av_seff_performance_pc_av_ResourceCall', b1)
    if hasattr(b1, 'entity_pc_av_ResourceRequiredRole411'):
        assert _is_linked(b1, 'entity_pc_av_ResourceRequiredRole411', a)
    _safe_set(a, 'pcm_pc_av_seff_performance_pc_av_ResourceCall', b2)
    assert _is_linked(a, 'pcm_pc_av_seff_performance_pc_av_ResourceCall', b2)
    if hasattr(b1, 'entity_pc_av_ResourceRequiredRole411'):
        assert not _is_linked(b1, 'entity_pc_av_ResourceRequiredRole411', a)
    if hasattr(b2, 'entity_pc_av_ResourceRequiredRole411'):
        assert _is_linked(b2, 'entity_pc_av_ResourceRequiredRole411', a)
    _safe_set(a, 'pcm_pc_av_seff_performance_pc_av_ResourceCall', None)
    assert not _is_linked(a, 'pcm_pc_av_seff_performance_pc_av_ResourceCall', b2)
    if hasattr(b2, 'entity_pc_av_ResourceRequiredRole411'):
        assert not _is_linked(b2, 'entity_pc_av_ResourceRequiredRole411', a)
...
def test_assoc_returnType__OperationSignature260_link_reassign_clear():
    ...
    b1 = DataType()
    b2 = DataType()
    _safe_set(a, 'pcm_pc_av_repository_pc_av_OperationSignature', b1)
    assert _is_linked(a, 'pcm_pc_av_repository_pc_av_OperationSignature', b1)
    if hasattr(b1, 'DataType261'):
        assert _is_linked(b1, 'DataType261', a)
    _safe_set(a, 'pcm_pc_av_repository_pc_av_OperationSignature', b2)
    assert _is_linked(a, 'pcm_pc_av_repository_pc_av_OperationSignature', b2)
    if hasattr(b1, 'DataType261'):
        assert not _is_linked(b1, 'DataType261', a)
    if hasattr(b2, 'DataType261'):
        assert _is_linked(b2, 'DataType261', a)
    _safe_set(a, 'pcm_pc_av_repository_pc_av_OperationSignature', None)
    assert not _is_linked(a, 'pcm_pc_av_repository_pc_av_OperationSignature', b2)
    if hasattr(b2, 'DataType261'):
...
def test_assoc_role_ExternalService378_link_reassign_clear():
    ...
    b1 = OperationRequiredRole()
    b2 = OperationRequiredRole()
    _safe_set(a, 'pcm_pc_av_seff_pc_av_ExternalCallAction379', b1)
    assert _is_linked(a, 'pcm_pc_av_seff_pc_av_ExternalCallAction379', b1)
    if hasattr(b1, 'OperationRequiredRole380'):
        assert _is_linked(b1, 'OperationRequiredRole380', a)
    _safe_set(a, 'pcm_pc_av_seff_pc_av_ExternalCallAction379', b2)
    assert _is_linked(a, 'pcm_pc_av_seff_pc_av_ExternalCallAction379', b2)
    if hasattr(b1, 'OperationRequiredRole380'):
    ...
    _safe_set(a, 'pcm_pc_av_seff_pc_av_ExternalCallAction379', None)
    assert not _is_linked(a, 'pcm_pc_av_seff_pc_av_ExternalCallAction379', b2)
    if hasattr(b2, 'OperationRequiredRole380'):
...
def test_assoc_schedulingPolicy470_link_reassign_clear():
    ...
    b1 = SchedulingPolicy()
    b2 = SchedulingPolicy()
    _safe_set(a, 'pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification', b1)
    assert _is_linked(a, 'pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification', b1)
    if hasattr(b1, 'SchedulingPolicy471'):
        assert _is_linked(b1, 'SchedulingPolicy471', a)
    _safe_set(a, 'pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification', b2)
    assert _is_linked(a, 'pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification', b2)
    if hasattr(b1, 'SchedulingPolicy471'):
    ...
    _safe_set(a, 'pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification', None)
    assert not _is_linked(a, 'pcm_pc_av_resourceenvironment_pc_av_ProcessingResourceSpecification', b2)
    if hasattr(b2, 'SchedulingPolicy471'):
...
def test_assoc_signature__InfrastructureCall400_link_reassign_clear():
    ...
    b1 = InfrastructureSignature()
    b2 = InfrastructureSignature()
    _safe_set(a, 'pcm_pc_av_seff_performance_pc_av_InfrastructureCall', b1)
    assert _is_linked(a, 'pcm_pc_av_seff_performance_pc_av_InfrastructureCall', b1)
    if hasattr(b1, 'InfrastructureSignature401'):
        assert _is_linked(b1, 'InfrastructureSignature401', a)
    _safe_set(a, 'pcm_pc_av_seff_performance_pc_av_InfrastructureCall', b2)
    assert _is_linked(a, 'pcm_pc_av_seff_performance_pc_av_InfrastructureCall', b2)
    if hasattr(b1, 'InfrastructureSignature401'):
    ...
    _safe_set(a, 'pcm_pc_av_seff_performance_pc_av_InfrastructureCall', None)
    assert not _is_linked(a, 'pcm_pc_av_seff_performance_pc_av_InfrastructureCall', b2)
    if hasattr(b2, 'InfrastructureSignature401'):
...
def test_assoc_signature__ResourceCall412_link_reassign_clear():
    ...
    b1 = ResourceSignature()
    b2 = ResourceSignature()
    _safe_set(a, 'pcm_pc_av_seff_performance_pc_av_ResourceCall413', b1)
    assert _is_linked(a, 'pcm_pc_av_seff_performance_pc_av_ResourceCall413', b1)
    if hasattr(b1, 'ResourceSignature414'):
        assert _is_linked(b1, 'ResourceSignature414', a)
    _safe_set(a, 'pcm_pc_av_seff_performance_pc_av_ResourceCall413', b2)
    assert _is_linked(a, 'pcm_pc_av_seff_performance_pc_av_ResourceCall413', b2)
    if hasattr(b1, 'ResourceSignature414'):
    ...
    _safe_set(a, 'pcm_pc_av_seff_performance_pc_av_ResourceCall413', None)
    assert not _is_linked(a, 'pcm_pc_av_seff_performance_pc_av_ResourceCall413', b2)
    if hasattr(b2, 'ResourceSignature414'):
        assert not _is_linked(b2, 'ResourceSignature414', a)


def test_assoc_signatures__OperationInterface262_link_reassign_clear():
    a = pcm_pc_av_repository_pc_av_OperationInterface()
    b1 = OperationSignature()
    b2 = OperationSignature()
...
def test_assoc_specification_VariableCharacterisation315_link_reassign_clear():
    a = pcm_pc_av_parameter_pc_av_VariableCharacterisation(type="sample_text")
    b1 = PCMRandomVariable()
    b2 = PCMRandomVariable()
...
def test_assoc_specifiedExecutionTime_PCMRandomVariable15_link_reassign_clear():
    a = pcm_pc_av_core_pc_av_PCMRandomVariable()
    b1 = qos_performance_pc_av_SpecifiedExecutionTime()
    b2 = qos_performance_pc_av_SpecifiedExecutionTime()
...
def test_assoc_specifiedOutputParameterAbstractions_QoSAnnotations435_link_reassign_clear():
    a = pcm_pc_av_qosannotations_pc_av_QoSAnnotations()
...
def test_assoc_specifiedReliabilityAnnotation__ExternalFailureOccurrenceDescription324_link_reassign_clear():
    a = pcm_pc_av_reliability_pc_av_ExternalFailureOccurrenceDescription()
    b1 = qos_reliability_pc_av_SpecifiedReliabilityAnnotation()
    b2 = qos_reliability_pc_av_SpecifiedReliabilityAnnotation()
...
def test_assoc_system_Allocation497_link_reassign_clear():
    ...
    b1 = System()
    b2 = System()
    _safe_set(a, 'pcm_pc_av_allocation_pc_av_Allocation498', b1)
    assert _is_linked(a, 'pcm_pc_av_allocation_pc_av_Allocation498', b1)
    if hasattr(b1, 'System499'):
        assert _is_linked(b1, 'System499', a)
    _safe_set(a, 'pcm_pc_av_allocation_pc_av_Allocation498', b2)
    assert _is_linked(a, 'pcm_pc_av_allocation_pc_av_Allocation498', b2)
    if hasattr(b1, 'System499'):
        assert not _is_linked(b1, 'System499', a)
    if hasattr(b2, 'System499'):
        assert _is_linked(b2, 'System499', a)
    _safe_set(a, 'pcm_pc_av_allocation_pc_av_Allocation498', None)
    assert not _is_linked(a, 'pcm_pc_av_allocation_pc_av_Allocation498', b2)
    if hasattr(b2, 'System499'):
...
def test_assoc_targetResourceEnvironment_Allocation495_link_reassign_clear():
    ...
    _safe_set(a, 'pcm_pc_av_allocation_pc_av_Allocation', b1)
    assert _is_linked(a, 'pcm_pc_av_allocation_pc_av_Allocation', b1)
    if hasattr(b1, 'ResourceEnvironment496'):
        assert _is_linked(b1, 'ResourceEnvironment496', a)
    _safe_set(a, 'pcm_pc_av_allocation_pc_av_Allocation', b2)
    assert _is_linked(a, 'pcm_pc_av_allocation_pc_av_Allocation', b2)
    if hasattr(b1, 'ResourceEnvironment496'):
    ...
    _safe_set(a, 'pcm_pc_av_allocation_pc_av_Allocation', None)
    assert not _is_linked(a, 'pcm_pc_av_allocation_pc_av_Allocation', b2)
    if hasattr(b2, 'ResourceEnvironment496'):
        assert not _is_linked(b2, 'ResourceEnvironment496', a)


def test_assoc_thinkTime_ClosedWorkload200_link_reassign_clear():
    a = pcm_pc_av_usagemodel_pc_av_ClosedWorkload(population=7)
    b1 = PCMRandomVariable()
    b2 = PCMRandomVariable()
...
composition_pc_av_AssemblyContext_strategy = st.builds(composition_pc_av_AssemblyContext)
...
composition_pc_av_AssemblyEventConnector_strategy = st.builds(composition_pc_av_AssemblyEventConnector)
...
composition_pc_av_ComposedStructure_strategy = st.builds(composition_pc_av_ComposedStructure)
...
composition_pc_av_Connector_strategy = st.builds(composition_pc_av_Connector)
...
composition_pc_av_EventChannel_strategy = st.builds(composition_pc_av_EventChannel)
...
composition_pc_av_EventChannelSinkConnector_strategy = st.builds(composition_pc_av_EventChannelSinkConnector)
...
composition_pc_av_EventChannelSourceConnector_strategy = st.builds(composition_pc_av_EventChannelSourceConnector)
...
composition_pc_av_ResourceRequiredDelegationConnector_strategy = st.builds(composition_pc_av_ResourceRequiredDelegationConnector)
...
entity_pc_av_ComposedProvidingRequiringEntity_strategy = st.builds(entity_pc_av_ComposedProvidingRequiringEntity)
...
entity_pc_av_Entity_strategy = st.builds(entity_pc_av_Entity)
...
entity_pc_av_InterfaceProvidingEntity_strategy = st.builds(entity_pc_av_InterfaceProvidingEntity)
...
entity_pc_av_InterfaceProvidingRequiringEntity_strategy = st.builds(entity_pc_av_InterfaceProvidingRequiringEntity)
...
entity_pc_av_InterfaceRequiringEntity_strategy = st.builds(entity_pc_av_InterfaceRequiringEntity)
...
entity_pc_av_NamedElement_strategy = st.builds(entity_pc_av_NamedElement)
...
entity_pc_av_ResourceInterfaceProvidingEntity_strategy = st.builds(entity_pc_av_ResourceInterfaceProvidingEntity)
...
entity_pc_av_ResourceInterfaceRequiringEntity_strategy = st.builds(entity_pc_av_ResourceInterfaceRequiringEntity)
...
entity_pc_av_ResourceProvidedRole_strategy = st.builds(entity_pc_av_ResourceProvidedRole)
...
entity_pc_av_ResourceRequiredRole_strategy = st.builds(entity_pc_av_ResourceRequiredRole)
...
parameter_pc_av_pcm_pc_av_AbstractNamedReference_strategy = st.builds(parameter_pc_av_pcm_pc_av_AbstractNamedReference)
...
pcm_pc_av_Advice_strategy = st.builds(pcm_pc_av_Advice)
...
pcm_pc_av_DummyClass_strategy = st.builds(pcm_pc_av_DummyClass)
...
pcm_pc_av_EObject_strategy = st.builds(pcm_pc_av_EObject)
...
pcm_pc_av_GlobalScope_strategy = st.builds(pcm_pc_av_GlobalScope)
...
pcm_pc_av_PerJoinPointScope_strategy = st.builds(pcm_pc_av_PerJoinPointScope)
...
pcm_pc_av_Pointcut_strategy = st.builds(pcm_pc_av_Pointcut)
...
pcm_pc_av_allocation_pc_av_Allocation_strategy = st.builds(pcm_pc_av_allocation_pc_av_Allocation)
...
pcm_pc_av_allocation_pc_av_AllocationContext_strategy = st.builds(pcm_pc_av_allocation_pc_av_AllocationContext)
...
pcm_pc_av_completions_pc_av_Completion_strategy = st.builds(pcm_pc_av_completions_pc_av_Completion)
...
pcm_pc_av_completions_pc_av_CompletionRepository_strategy = st.builds(pcm_pc_av_completions_pc_av_CompletionRepository)
...
pcm_pc_av_completions_pc_av_DelegatingExternalCallAction_strategy = st.builds(pcm_pc_av_completions_pc_av_DelegatingExternalCallAction)
...
pcm_pc_av_completions_pc_av_NetworkDemandParametricResourceDemand_strategy = st.builds(pcm_pc_av_completions_pc_av_NetworkDemandParametricResourceDemand)
...
pcm_pc_av_composition_pc_av_AssemblyConnector_strategy = st.builds(pcm_pc_av_composition_pc_av_AssemblyConnector)
...
pcm_pc_av_composition_pc_av_AssemblyContext_strategy = st.builds(pcm_pc_av_composition_pc_av_AssemblyContext)
...
pcm_pc_av_composition_pc_av_AssemblyEventConnector_strategy = st.builds(pcm_pc_av_composition_pc_av_AssemblyEventConnector)
...
pcm_pc_av_composition_pc_av_AssemblyInfrastructureConnector_strategy = st.builds(pcm_pc_av_composition_pc_av_AssemblyInfrastructureConnector)
...
pcm_pc_av_composition_pc_av_ComposedStructure_strategy = st.builds(pcm_pc_av_composition_pc_av_ComposedStructure)
...
pcm_pc_av_composition_pc_av_Connector_strategy = st.builds(pcm_pc_av_composition_pc_av_Connector)
...
pcm_pc_av_composition_pc_av_DelegationConnector_strategy = st.builds(pcm_pc_av_composition_pc_av_DelegationConnector)
...
pcm_pc_av_composition_pc_av_EventChannel_strategy = st.builds(pcm_pc_av_composition_pc_av_EventChannel)
...
pcm_pc_av_composition_pc_av_EventChannelSinkConnector_strategy = st.builds(pcm_pc_av_composition_pc_av_EventChannelSinkConnector)
...
pcm_pc_av_composition_pc_av_EventChannelSourceConnector_strategy = st.builds(pcm_pc_av_composition_pc_av_EventChannelSourceConnector)
...
pcm_pc_av_composition_pc_av_ProvidedDelegationConnector_strategy = st.builds(pcm_pc_av_composition_pc_av_ProvidedDelegationConnector)
...
pcm_pc_av_composition_pc_av_ProvidedInfrastructureDelegationConnector_strategy = st.builds(pcm_pc_av_composition_pc_av_ProvidedInfrastructureDelegationConnector)
...
pcm_pc_av_composition_pc_av_RequiredDelegationConnector_strategy = st.builds(pcm_pc_av_composition_pc_av_RequiredDelegationConnector)
...
pcm_pc_av_composition_pc_av_RequiredInfrastructureDelegationConnector_strategy = st.builds(pcm_pc_av_composition_pc_av_RequiredInfrastructureDelegationConnector)
...
pcm_pc_av_composition_pc_av_RequiredResourceDelegationConnector_strategy = st.builds(pcm_pc_av_composition_pc_av_RequiredResourceDelegationConnector)
...
pcm_pc_av_composition_pc_av_ResourceRequiredDelegationConnector_strategy = st.builds(pcm_pc_av_composition_pc_av_ResourceRequiredDelegationConnector)
...
pcm_pc_av_composition_pc_av_SinkDelegationConnector_strategy = st.builds(pcm_pc_av_composition_pc_av_SinkDelegationConnector)
...
pcm_pc_av_composition_pc_av_SourceDelegationConnector_strategy = st.builds(pcm_pc_av_composition_pc_av_SourceDelegationConnector)
...
pcm_pc_av_core_pc_av_PCMRandomVariable_strategy = st.builds(pcm_pc_av_core_pc_av_PCMRandomVariable)
...
pcm_pc_av_entity_pc_av_ComposedProvidingRequiringEntity_strategy = st.builds(pcm_pc_av_entity_pc_av_ComposedProvidingRequiringEntity)
...
pcm_pc_av_entity_pc_av_Entity_strategy = st.builds(pcm_pc_av_entity_pc_av_Entity)
...
pcm_pc_av_entity_pc_av_InterfaceProvidingEntity_strategy = st.builds(pcm_pc_av_entity_pc_av_InterfaceProvidingEntity)
...
pcm_pc_av_entity_pc_av_InterfaceProvidingRequiringEntity_strategy = st.builds(pcm_pc_av_entity_pc_av_InterfaceProvidingRequiringEntity)
...
pcm_pc_av_entity_pc_av_InterfaceRequiringEntity_strategy = st.builds(pcm_pc_av_entity_pc_av_InterfaceRequiringEntity)
...
pcm_pc_av_entity_pc_av_NamedElement_strategy = st.builds(pcm_pc_av_entity_pc_av_NamedElement, entityName=safe_text)
...
pcm_pc_av_entity_pc_av_ResourceInterfaceProvidingEntity_strategy = st.builds(pcm_pc_av_entity_pc_av_ResourceInterfaceProvidingEntity)
...
pcm_pc_av_entity_pc_av_ResourceInterfaceProvidingRequiringEntity_strategy = st.builds(pcm_pc_av_entity_pc_av_ResourceInterfaceProvidingRequiringEntity)
...
pcm_pc_av_entity_pc_av_ResourceInterfaceRequiringEntity_strategy = st.builds(pcm_pc_av_entity_pc_av_ResourceInterfaceRequiringEntity)
...
pcm_pc_av_entity_pc_av_ResourceProvidedRole_strategy = st.builds(pcm_pc_av_entity_pc_av_ResourceProvidedRole)
...
pcm_pc_av_entity_pc_av_ResourceRequiredRole_strategy = st.builds(pcm_pc_av_entity_pc_av_ResourceRequiredRole)
...
pcm_pc_av_parameter_pc_av_CharacterisedVariable_strategy = st.builds(pcm_pc_av_parameter_pc_av_CharacterisedVariable, characterisationType=safe_text)
...
pcm_pc_av_parameter_pc_av_VariableCharacterisation_strategy = st.builds(pcm_pc_av_parameter_pc_av_VariableCharacterisation, type=safe_text)
...
pcm_pc_av_parameter_pc_av_VariableUsage_strategy = st.builds(pcm_pc_av_parameter_pc_av_VariableUsage)
...
pcm_pc_av_protocol_pc_av_Protocol_strategy = st.builds(pcm_pc_av_protocol_pc_av_Protocol, protocolTypeID=safe_text)
...
pcm_pc_av_qos_performance_pc_av_ComponentSpecifiedExecutionTime_strategy = st.builds(pcm_pc_av_qos_performance_pc_av_ComponentSpecifiedExecutionTime)
...
pcm_pc_av_qos_performance_pc_av_SpecifiedExecutionTime_strategy = st.builds(pcm_pc_av_qos_performance_pc_av_SpecifiedExecutionTime)
...
pcm_pc_av_qos_performance_pc_av_SystemSpecifiedExecutionTime_strategy = st.builds(pcm_pc_av_qos_performance_pc_av_SystemSpecifiedExecutionTime)
...
pcm_pc_av_qos_reliability_pc_av_SpecifiedReliabilityAnnotation_strategy = st.builds(pcm_pc_av_qos_reliability_pc_av_SpecifiedReliabilityAnnotation)
...
pcm_pc_av_qosannotations_pc_av_QoSAnnotations_strategy = st.builds(pcm_pc_av_qosannotations_pc_av_QoSAnnotations)
...
pcm_pc_av_qosannotations_pc_av_SpecifiedOutputParameterAbstraction_strategy = st.builds(pcm_pc_av_qosannotations_pc_av_SpecifiedOutputParameterAbstraction)
...
pcm_pc_av_qosannotations_pc_av_SpecifiedQoSAnnotation_strategy = st.builds(pcm_pc_av_qosannotations_pc_av_SpecifiedQoSAnnotation)
...
pcm_pc_av_reliability_pc_av_ExternalFailureOccurrenceDescription_strategy = st.builds(pcm_pc_av_reliability_pc_av_ExternalFailureOccurrenceDescription)
...
pcm_pc_av_reliability_pc_av_FailureOccurrenceDescription_strategy = st.builds(pcm_pc_av_reliability_pc_av_FailureOccurrenceDescription, failureProbability=st.floats(allow_nan=False, allow_infinity=False))
...
pcm_pc_av_reliability_pc_av_FailureType_strategy = st.builds(pcm_pc_av_reliability_pc_av_FailureType)
...
pcm_pc_av_reliability_pc_av_HardwareInducedFailureType_strategy = st.builds(pcm_pc_av_reliability_pc_av_HardwareInducedFailureType)
...
pcm_pc_av_reliability_pc_av_InternalFailureOccurrenceDescription_strategy = st.builds(pcm_pc_av_reliability_pc_av_InternalFailureOccurrenceDescription)
...
pcm_pc_av_reliability_pc_av_NetworkInducedFailureType_strategy = st.builds(pcm_pc_av_reliability_pc_av_NetworkInducedFailureType)
...
pcm_pc_av_reliability_pc_av_ResourceTimeoutFailureType_strategy = st.builds(pcm_pc_av_reliability_pc_av_ResourceTimeoutFailureType)
...
pcm_pc_av_reliability_pc_av_SoftwareInducedFailureType_strategy = st.builds(pcm_pc_av_reliability_pc_av_SoftwareInducedFailureType)
...
pcm_pc_av_repository_pc_av_BasicComponent_strategy = st.builds(pcm_pc_av_repository_pc_av_BasicComponent)
...
pcm_pc_av_repository_pc_av_CollectionDataType_strategy = st.builds(pcm_pc_av_repository_pc_av_CollectionDataType)
...
pcm_pc_av_repository_pc_av_CompleteComponentType_strategy = st.builds(pcm_pc_av_repository_pc_av_CompleteComponentType)
...
pcm_pc_av_repository_pc_av_CompositeComponent_strategy = st.builds(pcm_pc_av_repository_pc_av_CompositeComponent)
...
pcm_pc_av_repository_pc_av_CompositeDataType_strategy = st.builds(pcm_pc_av_repository_pc_av_CompositeDataType)
...
pcm_pc_av_repository_pc_av_DataType_strategy = st.builds(pcm_pc_av_repository_pc_av_DataType)
...
pcm_pc_av_repository_pc_av_EventGroup_strategy = st.builds(pcm_pc_av_repository_pc_av_EventGroup)
...
pcm_pc_av_repository_pc_av_EventType_strategy = st.builds(pcm_pc_av_repository_pc_av_EventType)
...
pcm_pc_av_repository_pc_av_ExceptionType_strategy = st.builds(pcm_pc_av_repository_pc_av_ExceptionType, exceptionMessage=safe_text, exceptionName=safe_text)
...
pcm_pc_av_repository_pc_av_ImplementationComponentType_strategy = st.builds(pcm_pc_av_repository_pc_av_ImplementationComponentType, componentType=safe_text)
...
pcm_pc_av_repository_pc_av_InfrastructureInterface_strategy = st.builds(pcm_pc_av_repository_pc_av_InfrastructureInterface)
...
pcm_pc_av_repository_pc_av_InfrastructureProvidedRole_strategy = st.builds(pcm_pc_av_repository_pc_av_InfrastructureProvidedRole)
...
pcm_pc_av_repository_pc_av_InfrastructureRequiredRole_strategy = st.builds(pcm_pc_av_repository_pc_av_InfrastructureRequiredRole)
...
pcm_pc_av_repository_pc_av_InfrastructureSignature_strategy = st.builds(pcm_pc_av_repository_pc_av_InfrastructureSignature)
...
pcm_pc_av_repository_pc_av_InnerDeclaration_strategy = st.builds(pcm_pc_av_repository_pc_av_InnerDeclaration)
...
pcm_pc_av_repository_pc_av_Interface_strategy = st.builds(pcm_pc_av_repository_pc_av_Interface)
...
pcm_pc_av_repository_pc_av_OperationInterface_strategy = st.builds(pcm_pc_av_repository_pc_av_OperationInterface)
...
pcm_pc_av_repository_pc_av_OperationProvidedRole_strategy = st.builds(pcm_pc_av_repository_pc_av_OperationProvidedRole)
...
pcm_pc_av_repository_pc_av_OperationRequiredRole_strategy = st.builds(pcm_pc_av_repository_pc_av_OperationRequiredRole)
...
pcm_pc_av_repository_pc_av_OperationSignature_strategy = st.builds(pcm_pc_av_repository_pc_av_OperationSignature)
...
pcm_pc_av_repository_pc_av_Parameter_strategy = st.builds(pcm_pc_av_repository_pc_av_Parameter, modifier__Parameter=safe_text, parameterName=safe_text)
...
pcm_pc_av_repository_pc_av_PassiveResource_strategy = st.builds(pcm_pc_av_repository_pc_av_PassiveResource)
...
pcm_pc_av_repository_pc_av_PrimitiveDataType_strategy = st.builds(pcm_pc_av_repository_pc_av_PrimitiveDataType, type=safe_text)
...
pcm_pc_av_repository_pc_av_ProvidedRole_strategy = st.builds(pcm_pc_av_repository_pc_av_ProvidedRole)
...
pcm_pc_av_repository_pc_av_ProvidesComponentType_strategy = st.builds(pcm_pc_av_repository_pc_av_ProvidesComponentType)
...
pcm_pc_av_repository_pc_av_Repository_strategy = st.builds(pcm_pc_av_repository_pc_av_Repository, repositoryDescription=safe_text)
...
pcm_pc_av_repository_pc_av_RepositoryComponent_strategy = st.builds(pcm_pc_av_repository_pc_av_RepositoryComponent)
...
pcm_pc_av_repository_pc_av_RequiredCharacterisation_strategy = st.builds(pcm_pc_av_repository_pc_av_RequiredCharacterisation, type=safe_text)
...
pcm_pc_av_repository_pc_av_RequiredRole_strategy = st.builds(pcm_pc_av_repository_pc_av_RequiredRole)
...
pcm_pc_av_repository_pc_av_Role_strategy = st.builds(pcm_pc_av_repository_pc_av_Role)
...
pcm_pc_av_repository_pc_av_Signature_strategy = st.builds(pcm_pc_av_repository_pc_av_Signature)
...
pcm_pc_av_repository_pc_av_SinkRole_strategy = st.builds(pcm_pc_av_repository_pc_av_SinkRole)
...
pcm_pc_av_repository_pc_av_SourceRole_strategy = st.builds(pcm_pc_av_repository_pc_av_SourceRole)
...
pcm_pc_av_resourceenvironment_pc_av_CommunicationLinkResourceSpecification_strategy = st.builds(pcm_pc_av_resourceenvironment_pc_av_CommunicationLinkResourceSpecification, failureProbability=st.floats(allow_nan=False, allow_infinity=False))
...
pcm_pc_av_resourceenvironment_pc_av_LinkingResource_strategy = st.builds(pcm_pc_av_resourceenvironment_pc_av_LinkingResource)
...
pcm_pc_av_resourceenvironment_pc_av_ResourceContainer_strategy = st.builds(pcm_pc_av_resourceenvironment_pc_av_ResourceContainer)
...
pcm_pc_av_resourceenvironment_pc_av_ResourceEnvironment_strategy = st.builds(pcm_pc_av_resourceenvironment_pc_av_ResourceEnvironment)
...
pcm_pc_av_resourcetype_pc_av_CommunicationLinkResourceType_strategy = st.builds(pcm_pc_av_resourcetype_pc_av_CommunicationLinkResourceType)
...
pcm_pc_av_resourcetype_pc_av_ProcessingResourceType_strategy = st.builds(pcm_pc_av_resourcetype_pc_av_ProcessingResourceType)
...
pcm_pc_av_resourcetype_pc_av_ResourceInterface_strategy = st.builds(pcm_pc_av_resourcetype_pc_av_ResourceInterface)
...
pcm_pc_av_resourcetype_pc_av_ResourceRepository_strategy = st.builds(pcm_pc_av_resourcetype_pc_av_ResourceRepository)
...
pcm_pc_av_resourcetype_pc_av_ResourceSignature_strategy = st.builds(pcm_pc_av_resourcetype_pc_av_ResourceSignature, resourceServiceId=st.integers())
...
pcm_pc_av_resourcetype_pc_av_ResourceType_strategy = st.builds(pcm_pc_av_resourcetype_pc_av_ResourceType)
...
pcm_pc_av_resourcetype_pc_av_SchedulingPolicy_strategy = st.builds(pcm_pc_av_resourcetype_pc_av_SchedulingPolicy)
...
pcm_pc_av_seff_pc_av_AbstractAction_strategy = st.builds(pcm_pc_av_seff_pc_av_AbstractAction)
...
pcm_pc_av_seff_pc_av_AbstractBranchTransition_strategy = st.builds(pcm_pc_av_seff_pc_av_AbstractBranchTransition)
...
pcm_pc_av_seff_pc_av_AbstractInternalControlFlowAction_strategy = st.builds(pcm_pc_av_seff_pc_av_AbstractInternalControlFlowAction)
...
pcm_pc_av_seff_pc_av_AbstractLoopAction_strategy = st.builds(pcm_pc_av_seff_pc_av_AbstractLoopAction)
...
pcm_pc_av_seff_pc_av_AcquireAction_strategy = st.builds(pcm_pc_av_seff_pc_av_AcquireAction, timeout=st.booleans(), timeoutValue=st.floats(allow_nan=False, allow_infinity=False))
...
pcm_pc_av_seff_pc_av_BranchAction_strategy = st.builds(pcm_pc_av_seff_pc_av_BranchAction)
...
pcm_pc_av_seff_pc_av_CallAction_strategy = st.builds(pcm_pc_av_seff_pc_av_CallAction)
...
pcm_pc_av_seff_pc_av_CallReturnAction_strategy = st.builds(pcm_pc_av_seff_pc_av_CallReturnAction)
...
pcm_pc_av_seff_pc_av_CollectionIteratorAction_strategy = st.builds(pcm_pc_av_seff_pc_av_CollectionIteratorAction)
...
pcm_pc_av_seff_pc_av_EmitEventAction_strategy = st.builds(pcm_pc_av_seff_pc_av_EmitEventAction)
...
pcm_pc_av_seff_pc_av_ExternalCallAction_strategy = st.builds(pcm_pc_av_seff_pc_av_ExternalCallAction, retryCount=st.integers())
...
pcm_pc_av_seff_pc_av_ForkAction_strategy = st.builds(pcm_pc_av_seff_pc_av_ForkAction)
...
pcm_pc_av_seff_pc_av_ForkedBehaviour_strategy = st.builds(pcm_pc_av_seff_pc_av_ForkedBehaviour)
...
pcm_pc_av_seff_pc_av_GuardedBranchTransition_strategy = st.builds(pcm_pc_av_seff_pc_av_GuardedBranchTransition)
...
pcm_pc_av_seff_pc_av_InternalAction_strategy = st.builds(pcm_pc_av_seff_pc_av_InternalAction)
...
pcm_pc_av_seff_pc_av_InternalCallAction_strategy = st.builds(pcm_pc_av_seff_pc_av_InternalCallAction)
...
pcm_pc_av_seff_pc_av_LoopAction_strategy = st.builds(pcm_pc_av_seff_pc_av_LoopAction)
...
pcm_pc_av_seff_pc_av_ProbabilisticBranchTransition_strategy = st.builds(pcm_pc_av_seff_pc_av_ProbabilisticBranchTransition, branchProbability=st.floats(allow_nan=False, allow_infinity=False))
...
pcm_pc_av_seff_pc_av_ReleaseAction_strategy = st.builds(pcm_pc_av_seff_pc_av_ReleaseAction)
...
pcm_pc_av_seff_pc_av_ResourceDemandingBehaviour_strategy = st.builds(pcm_pc_av_seff_pc_av_ResourceDemandingBehaviour)
...
pcm_pc_av_seff_pc_av_ResourceDemandingInternalBehaviour_strategy = st.builds(pcm_pc_av_seff_pc_av_ResourceDemandingInternalBehaviour)
...
pcm_pc_av_seff_pc_av_ResourceDemandingSEFF_strategy = st.builds(pcm_pc_av_seff_pc_av_ResourceDemandingSEFF)
...
pcm_pc_av_seff_pc_av_ServiceEffectSpecification_strategy = st.builds(pcm_pc_av_seff_pc_av_ServiceEffectSpecification, seffTypeID=safe_text)
...
pcm_pc_av_seff_pc_av_SetVariableAction_strategy = st.builds(pcm_pc_av_seff_pc_av_SetVariableAction)
...
pcm_pc_av_seff_pc_av_StartAction_strategy = st.builds(pcm_pc_av_seff_pc_av_StartAction)
...
pcm_pc_av_seff_pc_av_StopAction_strategy = st.builds(pcm_pc_av_seff_pc_av_StopAction)
...
pcm_pc_av_seff_pc_av_SynchronisationPoint_strategy = st.builds(pcm_pc_av_seff_pc_av_SynchronisationPoint)
...
pcm_pc_av_seff_performance_pc_av_InfrastructureCall_strategy = st.builds(pcm_pc_av_seff_performance_pc_av_InfrastructureCall)
...
pcm_pc_av_seff_performance_pc_av_ParametricResourceDemand_strategy = st.builds(pcm_pc_av_seff_performance_pc_av_ParametricResourceDemand)
...
pcm_pc_av_seff_performance_pc_av_ResourceCall_strategy = st.builds(pcm_pc_av_seff_performance_pc_av_ResourceCall)
...
pcm_pc_av_seff_reliability_pc_av_FailureHandlingEntity_strategy = st.builds(pcm_pc_av_seff_reliability_pc_av_FailureHandlingEntity)
...
pcm_pc_av_seff_reliability_pc_av_RecoveryAction_strategy = st.builds(pcm_pc_av_seff_reliability_pc_av_RecoveryAction)
...
pcm_pc_av_seff_reliability_pc_av_RecoveryActionBehaviour_strategy = st.builds(pcm_pc_av_seff_reliability_pc_av_RecoveryActionBehaviour)
...
pcm_pc_av_subsystem_pc_av_SubSystem_strategy = st.builds(pcm_pc_av_subsystem_pc_av_SubSystem)
...
pcm_pc_av_system_pc_av_System_strategy = st.builds(pcm_pc_av_system_pc_av_System)
...
pcm_pc_av_usagemodel_pc_av_AbstractUserAction_strategy = st.builds(pcm_pc_av_usagemodel_pc_av_AbstractUserAction)
...
pcm_pc_av_usagemodel_pc_av_Branch_strategy = st.builds(pcm_pc_av_usagemodel_pc_av_Branch)
...
pcm_pc_av_usagemodel_pc_av_BranchTransition_strategy = st.builds(pcm_pc_av_usagemodel_pc_av_BranchTransition, branchProbability=st.floats(allow_nan=False, allow_infinity=False))
...
pcm_pc_av_usagemodel_pc_av_ClosedWorkload_strategy = st.builds(pcm_pc_av_usagemodel_pc_av_ClosedWorkload, population=st.integers())
...
pcm_pc_av_usagemodel_pc_av_Delay_strategy = st.builds(pcm_pc_av_usagemodel_pc_av_Delay)
...
pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall_strategy = st.builds(pcm_pc_av_usagemodel_pc_av_EntryLevelSystemCall, priority=st.integers())
...
pcm_pc_av_usagemodel_pc_av_Loop_strategy = st.builds(pcm_pc_av_usagemodel_pc_av_Loop)
...
pcm_pc_av_usagemodel_pc_av_OpenWorkload_strategy = st.builds(pcm_pc_av_usagemodel_pc_av_OpenWorkload)
...
pcm_pc_av_usagemodel_pc_av_ScenarioBehaviour_strategy = st.builds(pcm_pc_av_usagemodel_pc_av_ScenarioBehaviour)
...
pcm_pc_av_usagemodel_pc_av_Start_strategy = st.builds(pcm_pc_av_usagemodel_pc_av_Start)
...
pcm_pc_av_usagemodel_pc_av_Stop_strategy = st.builds(pcm_pc_av_usagemodel_pc_av_Stop)
...
pcm_pc_av_usagemodel_pc_av_UsageModel_strategy = st.builds(pcm_pc_av_usagemodel_pc_av_UsageModel)
...
pcm_pc_av_usagemodel_pc_av_UsageScenario_strategy = st.builds(pcm_pc_av_usagemodel_pc_av_UsageScenario)
...
pcm_pc_av_usagemodel_pc_av_UserData_strategy = st.builds(pcm_pc_av_usagemodel_pc_av_UserData)
...
pcm_pc_av_usagemodel_pc_av_Workload_strategy = st.builds(pcm_pc_av_usagemodel_pc_av_Workload)
...
qos_performance_pc_av_SpecifiedExecutionTime_strategy = st.builds(qos_performance_pc_av_SpecifiedExecutionTime)
...
qos_reliability_pc_av_SpecifiedReliabilityAnnotation_strategy = st.builds(qos_reliability_pc_av_SpecifiedReliabilityAnnotation)
...
repository_pc_av_DataType_strategy = st.builds(repository_pc_av_DataType)
...
repository_pc_av_ImplementationComponentType_strategy = st.builds(repository_pc_av_ImplementationComponentType)
...
repository_pc_av_RepositoryComponent_strategy = st.builds(repository_pc_av_RepositoryComponent)
...
seff_pc_av_AbstractAction_strategy = st.builds(seff_pc_av_AbstractAction)
...
seff_pc_av_AbstractInternalControlFlowAction_strategy = st.builds(seff_pc_av_AbstractInternalControlFlowAction)
...
seff_pc_av_CallAction_strategy = st.builds(seff_pc_av_CallAction)
...
seff_pc_av_CallReturnAction_strategy = st.builds(seff_pc_av_CallReturnAction)
...
seff_pc_av_ResourceDemandingBehaviour_strategy = st.builds(seff_pc_av_ResourceDemandingBehaviour)
...
seff_pc_av_ServiceEffectSpecification_strategy = st.builds(seff_pc_av_ServiceEffectSpecification)
...
seff_performance_pc_av_InfrastructureCall_strategy = st.builds(seff_performance_pc_av_InfrastructureCall)
...
seff_performance_pc_av_ParametricResourceDemand_strategy = st.builds(seff_performance_pc_av_ParametricResourceDemand)
...
seff_performance_pc_av_ResourceCall_strategy = st.builds(seff_performance_pc_av_ResourceCall)
...
seff_reliability_pc_av_FailureHandlingEntity_strategy = st.builds(seff_reliability_pc_av_FailureHandlingEntity)
...
seff_reliability_pc_av_RecoveryAction_strategy = st.builds(seff_reliability_pc_av_RecoveryAction)
...
seff_reliability_pc_av_RecoveryActionBehaviour_strategy = st.builds(seff_reliability_pc_av_RecoveryActionBehaviour)
