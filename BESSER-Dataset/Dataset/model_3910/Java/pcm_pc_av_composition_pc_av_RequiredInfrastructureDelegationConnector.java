...
public class pcm_pc_av_composition_pc_av_RequiredInfrastructureDelegationConnector extends DelegationConnector {
    ...
    public pcm_pc_av_composition_pc_av_RequiredInfrastructureDelegationConnector(
    ) {
        super(
        );
    }
