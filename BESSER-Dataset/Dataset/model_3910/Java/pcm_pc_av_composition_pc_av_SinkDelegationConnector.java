...
public class pcm_pc_av_composition_pc_av_SinkDelegationConnector extends DelegationConnector {
    ...
    public pcm_pc_av_composition_pc_av_SinkDelegationConnector(
    ) {
        super(
        );
    }
