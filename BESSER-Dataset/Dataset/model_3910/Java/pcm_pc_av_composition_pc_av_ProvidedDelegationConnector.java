...
public class pcm_pc_av_composition_pc_av_ProvidedDelegationConnector extends DelegationConnector {
    ...
    public pcm_pc_av_composition_pc_av_ProvidedDelegationConnector(
    ) {
        super(
        );
    }
