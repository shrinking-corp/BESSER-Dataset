...
public class pcm_pc_av_qos_performance_pc_av_ComponentSpecifiedExecutionTime extends SpecifiedExecutionTime {
    ...
    public pcm_pc_av_qos_performance_pc_av_ComponentSpecifiedExecutionTime(
    ) {
        super(
        );
    }
