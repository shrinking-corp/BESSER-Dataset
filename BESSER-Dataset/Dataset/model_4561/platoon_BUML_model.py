...
platoon_JoiningVehicle = Class(name="platoon_JoiningVehicle")
Vehicle = Class(name="Vehicle")
platoon_FrontGap = Class(name="platoon_FrontGap")
platoon_Platoon = Class(name="platoon_Platoon")
platoon_PlatoonVehicle = Class(name="platoon_PlatoonVehicle")
platoon_JoinPlatoonCoord = Class(name="platoon_JoinPlatoonCoord")
platoon_JoiningPosition = Class(name="platoon_JoiningPosition")
platoon_PlatooningSystem = Class(name="platoon_PlatooningSystem")
...
platoon_Platoon.attributes={platoon_Platoon_desiredGapSize, platoon_Platoon_length}
...
domain_model = DomainModel(
    name="platoon",
    types={platoon_Vehicle, platoon_JoiningVehicle, Vehicle, platoon_FrontGap, platoon_Platoon, platoon_PlatoonVehicle, platoon_JoinPlatoonCoord, platoon_JoiningPosition, platoon_PlatooningSystem},
    associations={members9, follows11, isAwareOf13, joinCord15, cordManager18, gapMaker21, joiningVehicle24, insertsIn27, wantsToJoin28, leader0, follower1, follows5, joinplatoonCord7, vehicles40, platoon42, locatedIn30, forms32, marks35, joiningRequest38, platoon39},
