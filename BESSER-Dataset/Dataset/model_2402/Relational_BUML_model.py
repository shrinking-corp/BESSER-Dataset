...
domain_model = DomainModel(
    name="relational",
    types={relational_Named, relational_Table, Named, relational_Column, relational_Schema, relational_Type},
    associations={col0, key1, owner3, owner4, keyOf5, type7, tables8, types11},
