...
yyb_RelatedTo = Class(name="yyb_RelatedTo")
yyb_NamedElement = Class(name="yyb_NamedElement", is_abstract=True)
yyb_Alias = Class(name="yyb_Alias")
yyb_Thing = Class(name="yyb_Thing")
...
domain_model = DomainModel(
    name="yyb",
    types={NamedElement, yyb_RelatedTo, yyb_NamedElement, yyb_Alias, yyb_Thing},
