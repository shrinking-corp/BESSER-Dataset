...
PetriNets_Object = Class(name="PetriNets_Object", is_abstract=True)
PetriNets_Node = Class(name="PetriNets_Node", is_abstract=True)
Object = Class(name="Object")
PetriNets_Arc = Class(name="PetriNets_Arc")
...
target5: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="in_", type=PetriNets_Node, multiplicity=Multiplicity(1, 1))
    }
)
...
domain_model = DomainModel(
    name="PetriNets",
    types={PetriNets_PetriNet, PetriNets_Object, PetriNets_Node, Object, PetriNets_Arc, PetriNets_Transition, Node, PetriNets_Place, PetriNets_Token},
    associations={out2, object0, in_1, source4, target5, token7},
