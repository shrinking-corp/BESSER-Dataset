...
class simplegraph2graph_Node2Node(Element2Element):
    ...
    def __init__(self, label: str, simplegraph2graph_Node2Node18: "simplegraph2graph_Node" = None, simplegraph2graph_Node2Node: "simplegraph2graph_Edge2Edge" = None, simplegraph2graph_Node2Node14: "simplegraph2graph_Edge2Edge" = None, simplegraph2graph_Node2Node16: "simplegraph2graph_Node" = None):
        self.label = label
...
class simplegraph2graph_Graph2Graph:
    ...
    def __init__(self, name: str, simplegraph2graph_Graph2Graph2: "simplegraph2graph_Graph" = None, owner: set["simplegraph2graph_Element2Element"] = None, simplegraph2graph_Graph2Graph: "simplegraph2graph_Graph" = None, Graph2Graph: "simplegraph2graph_Element2Element" = None):
        self.name = name
