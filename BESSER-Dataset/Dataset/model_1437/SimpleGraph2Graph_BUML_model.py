...
# Classes
simplegraph2graph_Graph2Graph = Class(name="simplegraph2graph_Graph2Graph")
simplegraph2graph_Graph = Class(name="simplegraph2graph_Graph")
simplegraph2graph_Edge2Edge = Class(name="simplegraph2graph_Edge2Edge")
simplegraph2graph_Edge = Class(name="simplegraph2graph_Edge")
simplegraph2graph_Node2Node = Class(name="simplegraph2graph_Node2Node")
Element2Element = Class(name="Element2Element")
simplegraph2graph_Node = Class(name="simplegraph2graph_Node")
simplegraph2graph_Element2Element = Class(name="simplegraph2graph_Element2Element", is_abstract=True)
...
domain_model = DomainModel(
    ...
    types={simplegraph2graph_Graph2Graph, simplegraph2graph_Graph, simplegraph2graph_Edge2Edge, simplegraph2graph_Edge, simplegraph2graph_Node2Node, Element2Element, simplegraph2graph_Node, simplegraph2graph_Element2Element},
    associations={graph10, owner5, edge16, edge27, target10, source12, node115, node217, graph21, element2Element4},
