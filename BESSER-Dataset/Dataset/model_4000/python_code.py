...
class classes_CClass(Classifier):
    ...
    def __init__(self, abstract: bool, classes_CClass4: set["classes_Attribute"] = None, classes_CClass7: "classes_CClass" = None, classes_CClass5: set["classes_CClass"] = None, classes_CClass: "classes_CClass" = None, classes_CClass1: "classes_CClass" = None):
