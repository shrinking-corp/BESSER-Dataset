...
# Classes
classes_CModel = Class(name="classes_CModel")
...
classes_CClass = Class(name="classes_CClass")
...
domain_model = DomainModel(
    name="classes",
    types={classes_CModel, classes_Classifier, classes_NamedElement, NamedElement, classes_Attribute, TypedElement, classes_Datatype, classes_TypedElement, classes_CClass, Classifier},
    associations={contents0, attributes3, super6, type8, extends2},
    generalizations={gen_classes_Classifier_NamedElement, gen_classes_Attribute_NamedElement, gen_classes_Attribute_TypedElement, gen_classes_Datatype_Classifier, gen_classes_CClass_Classifier},
    metadata=None
)
