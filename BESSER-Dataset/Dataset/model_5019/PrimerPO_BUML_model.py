...
ppo_USAddress.attributes={ppo_USAddress_state, ppo_USAddress_city, ppo_USAddress_name, ppo_USAddress_country, ppo_USAddress_street, ppo_USAddress_zip}
...
ppo_Item.attributes={ppo_Item_USPrice, ppo_Item_comment, ppo_Item_quantity, ppo_Item_productName, ppo_Item_partNum, ppo_Item_shipDate}
