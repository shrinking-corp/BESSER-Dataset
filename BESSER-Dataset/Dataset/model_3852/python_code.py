...
class dDL_Tabname:
    ...
    def __init__(self, id: str, basename: str, dDL_Tabname13: "dDL_Comment" = None, dDL_Tabname: "dDL_Alter_table" = None, dDL_Tabname23: "dDL_Foreign_key" = None):
        self.id = id
...
class dDL_Constraint:
    ...
    def __init__(self, id: str, dDL_Constraint: "dDL_Create_table" = None, dDL_Constraint18: "dDL_Key" = None, dDL_Constraint11: "dDL_Alter_table" = None):
        self.id = id
...
class dDL_Column:
    ...
    def __init__(self, id: str, number: int, dDL_Column: "dDL_Create_table" = None, dDL_Column5: "dDL_TYPE" = None, dDL_Column7: "dDL_ISNULL" = None):
        self.id = id
        self.number = number
