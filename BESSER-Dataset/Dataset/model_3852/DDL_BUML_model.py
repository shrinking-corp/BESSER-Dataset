...
# Classes
dDL_Data_definition = Class(name="dDL_Data_definition")
dDL_Definition = Class(name="dDL_Definition")
dDL_Create_table = Class(name="dDL_Create_table")
Definition = Class(name="Definition")
dDL_Column = Class(name="dDL_Column")
dDL_Constraint = Class(name="dDL_Constraint")
dDL_TYPE = Class(name="dDL_TYPE")
dDL_Colname = Class(name="dDL_Colname")
dDL_Create_sequence = Class(name="dDL_Create_sequence")
dDL_Sequence_options = Class(name="dDL_Sequence_options")
dDL_Key = Class(name="dDL_Key")
dDL_Primary_key = Class(name="dDL_Primary_key")
Key = Class(name="Key")
dDL_ISNULL = Class(name="dDL_ISNULL")
dDL_Unique_key = Class(name="dDL_Unique_key")
dDL_Foreign_key = Class(name="dDL_Foreign_key")
dDL_Alter_table = Class(name="dDL_Alter_table")
dDL_Tabname = Class(name="dDL_Tabname")
dDL_Comment = Class(name="dDL_Comment")
...
dDL_Column.attributes={dDL_Column_number, dDL_Column_id}
...
dDL_Sequence_options.attributes={dDL_Sequence_options_increment, dDL_Sequence_options_cycle, dDL_Sequence_options_cache, dDL_Sequence_options_maxvalue, dDL_Sequence_options_minvalue, dDL_Sequence_options_nocycle, dDL_Sequence_options_nocache, dDL_Sequence_options_nomaxvalue, dDL_Sequence_options_start, dDL_Sequence_options_nominvalue, dDL_Sequence_options_noorder, dDL_Sequence_options_order}
...
dDL_ISNULL.attributes={dDL_ISNULL_nonNull, dDL_ISNULL_null}
...
dDL_Tabname.attributes={dDL_Tabname_basename, dDL_Tabname_id}
...
dDL_Comment.attributes={dDL_Comment_string, dDL_Comment_columnId}
...
domain_model = DomainModel(
    name="dDL",
    types={dDL_Data_definition, dDL_Definition, dDL_Create_table, Definition, dDL_Column, dDL_Constraint, dDL_TYPE, dDL_Colname, dDL_Create_sequence, dDL_Sequence_options, dDL_Key, dDL_Primary_key, Key, dDL_ISNULL, dDL_Unique_key, dDL_Foreign_key, dDL_Alter_table, dDL_Tabname, dDL_Comment},
    associations={definitions0, columns1, constraints2, type4, tabname12, colname14, sequence_options16, key17, colNames19, isNull6, tabname8, constraint9, tabname22},
    generalizations={gen_dDL_Create_table_Definition, gen_dDL_Create_sequence_Definition, gen_dDL_Primary_key_Key, gen_dDL_Unique_key_Key, gen_dDL_Foreign_key_Key, gen_dDL_Alter_table_Definition, gen_dDL_Comment_Definition},
    metadata=None
)
