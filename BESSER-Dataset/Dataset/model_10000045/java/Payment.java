...
public class Payment  {
    ...
    public Payment(
        int cardNumber,        String cardType,        String expiryDate,        int amount,        String issuerName    ) {
    ...
    public Payment(
        int cardNumber,        String cardType,        String expiryDate,        int amount,        String issuerName        ArrayList<Volunteer> volunteers,        ArrayList<Normal_user> normal_users,        ArrayList<SuperAdmin> superadmins,        ArrayList<Admin> admins    ) {
        this.cardNumber = cardNumber;
        this.cardType = cardType;
        this.expiryDate = expiryDate;
        this.amount = amount;
