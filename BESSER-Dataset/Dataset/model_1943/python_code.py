...
class oaam_allocations_SignalToMessageAssignment:
    ...
    def __init__(self, position: int, oaam_allocations_SignalToMessageAssignment730: set["OperationModeReference"] = None, oaam_allocations_SignalToMessageAssignment733: "DataTypeA" = None, oaam_allocations_SignalToMessageAssignment736: "SignalInMessageCapability" = None, oaam_allocations_SignalToMessageAssignment: "Signal" = None, oaam_allocations_SignalToMessageAssignment724: set["AttributeA"] = None, oaam_allocations_SignalToMessageAssignment727: set["Variant"] = None):
...
class oaam_common_Array(DataTypeA):
    ...
    def __init__(self, nElements: int, alignment: int, oaam_common_Array: "DataTypeA" = None, DataTypeA134: "oaam_library_InputDeclaration" = None, DataTypeA213: "oaam_library_MessageType" = None, DataTypeA200: "oaam_library_TaskParameterDeclaration" = None, DataTypeA138: "oaam_library_OutputDeclaration" = None, DataTypeA114: "oaam_library_SignalType" = None, DataTypeA32: "oaam_common_Struct" = None, DataTypeA48: "oaam_library_LibraryContainerA" = None, DataTypeA210: "oaam_library_MessageType" = None, DataTypeA734: "oaam_allocations_SignalToMessageAssignment" = None, DataTypeA: "oaam_common_Array" = None, DataTypeA198: "oaam_library_TaskStateDeclaration" = None):
...
class oaam_common_FloatingPoint(DataTypeA):
    ...
    def __init__(self, nBits: int, endianess: str, DataTypeA134: "oaam_library_InputDeclaration" = None, DataTypeA213: "oaam_library_MessageType" = None, DataTypeA200: "oaam_library_TaskParameterDeclaration" = None, DataTypeA138: "oaam_library_OutputDeclaration" = None, DataTypeA114: "oaam_library_SignalType" = None, DataTypeA32: "oaam_common_Struct" = None, DataTypeA48: "oaam_library_LibraryContainerA" = None, DataTypeA210: "oaam_library_MessageType" = None, DataTypeA734: "oaam_allocations_SignalToMessageAssignment" = None, DataTypeA: "oaam_common_Array" = None, DataTypeA198: "oaam_library_TaskStateDeclaration" = None):
        self.nBits = nBits
...
class oaam_common_Byte(DataTypeA):
    ...
    def __init__(self, nBits: int, DataTypeA134: "oaam_library_InputDeclaration" = None, DataTypeA213: "oaam_library_MessageType" = None, DataTypeA200: "oaam_library_TaskParameterDeclaration" = None, DataTypeA138: "oaam_library_OutputDeclaration" = None, DataTypeA114: "oaam_library_SignalType" = None, DataTypeA32: "oaam_common_Struct" = None, DataTypeA48: "oaam_library_LibraryContainerA" = None, DataTypeA210: "oaam_library_MessageType" = None, DataTypeA734: "oaam_allocations_SignalToMessageAssignment" = None, DataTypeA: "oaam_common_Array" = None, DataTypeA198: "oaam_library_TaskStateDeclaration" = None):
        self.nBits = nBits
...
class oaam_common_Struct(DataTypeA):
    ...
    def __init__(self, alignment: int, isAbstract: bool, oaam_common_Struct: set["DataTypeA"] = None, oaam_common_Struct34: "Struct" = None, DataTypeA134: "oaam_library_InputDeclaration" = None, DataTypeA213: "oaam_library_MessageType" = None, DataTypeA200: "oaam_library_TaskParameterDeclaration" = None, DataTypeA138: "oaam_library_OutputDeclaration" = None, DataTypeA114: "oaam_library_SignalType" = None, DataTypeA32: "oaam_common_Struct" = None, DataTypeA48: "oaam_library_LibraryContainerA" = None, DataTypeA210: "oaam_library_MessageType" = None, DataTypeA734: "oaam_allocations_SignalToMessageAssignment" = None, DataTypeA: "oaam_common_Array" = None, DataTypeA198: "oaam_library_TaskStateDeclaration" = None):
        self.alignment = alignment
...
class oaam_common_Character(DataTypeA):
    ...
    def __init__(self, encoding: str, nBits: int, DataTypeA134: "oaam_library_InputDeclaration" = None, DataTypeA213: "oaam_library_MessageType" = None, DataTypeA200: "oaam_library_TaskParameterDeclaration" = None, DataTypeA138: "oaam_library_OutputDeclaration" = None, DataTypeA114: "oaam_library_SignalType" = None, DataTypeA32: "oaam_common_Struct" = None, DataTypeA48: "oaam_library_LibraryContainerA" = None, DataTypeA210: "oaam_library_MessageType" = None, DataTypeA734: "oaam_allocations_SignalToMessageAssignment" = None, DataTypeA: "oaam_common_Array" = None, DataTypeA198: "oaam_library_TaskStateDeclaration" = None):
...
class oaam_common_Integer(DataTypeA):
    ...
    def __init__(self, signed: bool, nBits: int, endianess: str, DataTypeA134: "oaam_library_InputDeclaration" = None, DataTypeA213: "oaam_library_MessageType" = None, DataTypeA200: "oaam_library_TaskParameterDeclaration" = None, DataTypeA138: "oaam_library_OutputDeclaration" = None, DataTypeA114: "oaam_library_SignalType" = None, DataTypeA32: "oaam_common_Struct" = None, DataTypeA48: "oaam_library_LibraryContainerA" = None, DataTypeA210: "oaam_library_MessageType" = None, DataTypeA734: "oaam_allocations_SignalToMessageAssignment" = None, DataTypeA: "oaam_common_Array" = None, DataTypeA198: "oaam_library_TaskStateDeclaration" = None):
        self.signed = signed
        self.nBits = nBits
        self.endianess = endianess
...
class common_OaamBaseElementA:
    ...
    pass
class oaam_library_ResourceType(common_OaamBaseElementA, library_ResourceConsumerA):

    def __init__(self, isDistinguishable: bool, isPropagated: bool, direction: str, isIo: bool, isConfigurable: bool, unit: str, isConsumed: bool, oaam_library_ResourceType: set["Resource"] = None, oaam_library_ResourceType94: set["ResourceTypeModifierReference"] = None, oaam_library_ResourceType96: set["ResourceAlternatives"] = None):
...
class oaam_library_ConnectionType(library_ResourceProviderA, common_OaamBaseElementA, library_ResourceConsumerA):

    def __init__(self, allowsCircles: bool, nStartingPoints: int, nEndPoints: int, nJoints: int, isInformation: bool, isPower: bool, isWireless: bool, maxJointBranches: int, maxInterfaceToJointDistance: float, isSwitched: bool, directConnectionsAllowed: bool, maxLength: float, isUnidirectional: bool, requiresMaster: bool, oaam_library_ConnectionType121: set["ResourceType"] = None, oaam_library_ConnectionType124: set["ResourceType"] = None, oaam_library_ConnectionType: set["WireType"] = None, oaam_library_ConnectionType127: set["DeviceType"] = None, oaam_library_ConnectionType130: "MessageType" = None):
    ...
    @property
    def maxInterfaceToJointDistance(self):
    ...
    @property
    def directConnectionsAllowed(self):
...
class oaam_library_DeviceType(library_ResourceProviderA, common_OaamBaseElementA, library_ResourceConsumerA):
    ...
    def __init__(self, isSubdevice: bool, canHaveSubdevices: bool, mtbf: float, weight: float, cost: float, isSelfManaging: bool, oaam_library_DeviceType: set["IoDeclaration"] = None, oaam_library_DeviceType117: set["IoGroup"] = None):
...
class oaam_library_SignalType(common_OaamBaseElementA, library_ResourceConsumerA):

    pass
class oaam_library_MessageType(library_ResourceProviderA, common_OaamBaseElementA, library_ResourceConsumerA):

    def __init__(self, minLength: int, maxLength: int, alignment: int, oaam_library_MessageType: "DataTypeA" = None, oaam_library_MessageType212: "DataTypeA" = None):
...
class oaam_library_TaskType(common_OaamBaseElementA, library_ResourceConsumerA):

    def __init__(self, isDeterministic: bool, preferredExecutionRate: float, oaam_library_TaskType: set["OutputDeclaration"] = None, oaam_library_TaskType108: set["InputDeclaration"] = None, oaam_library_TaskType110: set["TaskStateDeclaration"] = None, oaam_library_TaskType112: set["TaskParameterDeclaration"] = None):
    ...
    @property
    def preferredExecutionRate(self):
...
class oaam_library_BusType(library_ResourceProviderA, common_OaamBaseElementA):
    ...
    def __init__(self, mtbf: float, isSelfManaging: bool, requiresMaster: bool, oaam_library_BusType: set["DeviceType"] = None, oaam_library_BusType204: set["ConnectionType"] = None, oaam_library_BusType207: set["MessageType"] = None):
        self.mtbf = mtbf
        self.isSelfManaging = isSelfManaging
        self.requiresMaster = requiresMaster
...
class common_BoolA:
    ...
    pass
class oaam_library_TaskInputState(common_OaamBaseElementA, common_BoolA):
...
class oaam_common_BoolNot(common_OaamBaseElementA, common_BoolA):
    ...
    pass
class oaam_library_TaskInputTrigger(common_OaamBaseElementA, common_BoolA):

    pass
class oaam_common_BoolOperation(common_OaamBaseElementA, common_BoolA):
...
class oaam_common_AttributeNumeric(AttributeA):
    ...
    def __init__(self, value: float, AttributeA: "oaam_common_OaamBaseElementA" = None, AttributeA725: "oaam_allocations_SignalToMessageAssignment" = None):
        self.value = value
...
class oaam_common_AttributeString(AttributeA):
    ...
    def __init__(self, value: str, AttributeA: "oaam_common_OaamBaseElementA" = None, AttributeA725: "oaam_allocations_SignalToMessageAssignment" = None):
        self.value = value
...
class oaam_library_AttributeDefinition(OaamBaseElementA):
    ...
    def __init__(self, dataType: str, target: str, OaamBaseElementA: "oaam_common_AttributeContainment" = None, OaamBaseElementA23: "oaam_common_AttributeReference" = None):
...
class oaam_library_WireType(OaamBaseElementA):
    ...
    def __init__(self, specificWeight: float, specificPrice: float, nConductors: int, minBendingRadius: float, nShields: int, mtbf: float, OaamBaseElementA: "oaam_common_AttributeContainment" = None, OaamBaseElementA23: "oaam_common_AttributeReference" = None):
...
class oaam_functions_TaskParameter(OaamBaseElementA):
    ...
    def __init__(self, value: str, oaam_functions_TaskParameter: "TaskParameterDeclaration" = None, OaamBaseElementA: "oaam_common_AttributeContainment" = None, OaamBaseElementA23: "oaam_common_AttributeReference" = None):
        self.value = value
...
class oaam_capabilities_ResourceConsumption(OaamBaseElementA):
    ...
    def __init__(self, count: float, oaam_capabilities_ResourceConsumption: set["Resource"] = None, oaam_capabilities_ResourceConsumption489: "ResourceType" = None, OaamBaseElementA: "oaam_common_AttributeContainment" = None, OaamBaseElementA23: "oaam_common_AttributeReference" = None):
        self.count = count
...
class oaam_library_DeviceTypeDissimilarity(OaamBaseElementA):
    ...
    def __init__(self, percentageOfCommonHardware: float, oaam_library_DeviceTypeDissimilarity: set["DeviceType"] = None, OaamBaseElementA: "oaam_common_AttributeContainment" = None, OaamBaseElementA23: "oaam_common_AttributeReference" = None):
        ...
        pass
    @property
    def percentageOfCommonHardware(self):
...
class oaam_library_TaskTypeDissimilarity(OaamBaseElementA):
    ...
    def __init__(self, percentageOfCommonCode: float, oaam_library_TaskTypeDissimilarity: set["TaskType"] = None, OaamBaseElementA: "oaam_common_AttributeContainment" = None, OaamBaseElementA23: "oaam_common_AttributeReference" = None):
        ...
        pass
    @property
    def percentageOfCommonCode(self):
...
class oaam_library_IoType(OaamBaseElementA):
    ...
    def __init__(self, direction: str, OaamBaseElementA: "oaam_common_AttributeContainment" = None, OaamBaseElementA23: "oaam_common_AttributeReference" = None):
        self.direction = direction
...
class oaam_library_Resource(OaamBaseElementA):
    ...
    def __init__(self, count: float, oaam_library_Resource: "ResourceType" = None, oaam_library_Resource100: set["ResourceTypeModifierLevel"] = None, OaamBaseElementA: "oaam_common_AttributeContainment" = None, OaamBaseElementA23: "oaam_common_AttributeReference" = None):
        self.count = count
...
class oaam_library_InputDeclaration(OaamBaseElementA):
    ...
    def __init__(self, unit: str, precondition: str, range: str, lowerBound: int, upperBound: int, oaam_library_InputDeclaration: "DataTypeA" = None, OaamBaseElementA: "oaam_common_AttributeContainment" = None, OaamBaseElementA23: "oaam_common_AttributeReference" = None):
        self.unit = unit
...
class oaam_functions_Subfunctions(FunctionsContainerA):
    ...
    def __init__(self, multiplicityMin: int, multiplicityMax: int, FunctionsContainerA: "oaam_restrictions_SegregationRestriction" = None, FunctionsContainerA576: "oaam_restrictions_SegregationRestriction" = None):
        self.multiplicityMin = multiplicityMin
        self.multiplicityMax = multiplicityMax
        
        pass
    @property
    def multiplicityMin(self):
...
class oaam_systems_ElectricPower(InformationPower):
    ...
    def __init__(self, frequency: float, nPhases: int, voltage: float, current: float):
...
class oaam_scenario_OperationModeReference(OaamBaseElementA):
    ...
    def __init__(self, activeProbability: float, oaam_scenario_OperationModeReference: "OperationMode" = None, OaamBaseElementA: "oaam_common_AttributeContainment" = None, OaamBaseElementA23: "oaam_common_AttributeReference" = None):
        self.activeProbability = activeProbability
        self.oaam_scenario_OperationModeReference = oaam_scenario_OperationModeReference
        
        pass
    @property
    def activeProbability(self):
...
class scenario_VariantDependentElementA:
    ...
    pass
class oaam_scenario_OperationMode(common_OaamBaseElementA, scenario_VariantDependentElementA):

    pass
class scenario_ModeDependentElementA:

    pass
class oaam_allocations_SubconnectionAssignment(common_OaamBaseElementA, scenario_VariantDependentElementA, scenario_ModeDependentElementA):

    pass
class oaam_allocations_SignalAssignment(common_OaamBaseElementA, scenario_ModeDependentElementA, scenario_VariantDependentElementA):

    pass
class oaam_functions_ExternalOutputLink(common_OaamBaseElementA, scenario_ModeDependentElementA, scenario_VariantDependentElementA):
...
class oaam_functions_FunctionsContainerA(common_OaamBaseElementA, scenario_ModeDependentElementA, scenario_VariantDependentElementA):

    pass
class oaam_systems_InformationSignal(common_OaamBaseElementA, scenario_ModeDependentElementA, systems_ProvidedInformationA, scenario_VariantDependentElementA, systems_RequiredInformationA):

    def __init__(self, accuracy: float, resolution: float, unit: str, rate: float, latency: float):
...
class oaam_restrictions_SynchronicityRestriction(common_OaamBaseElementA, restrictions_TaskRestrictionA, scenario_ModeDependentElementA, scenario_VariantDependentElementA):
...
class oaam_functions_OutputIntegrityState(common_OaamBaseElementA, scenario_ModeDependentElementA, scenario_VariantDependentElementA, common_BoolA):
...
class oaam_restrictions_TaskSymmetryRestriction(restrictions_TaskGroupRestrictionA, common_OaamBaseElementA, restrictions_SubfunctionRestrictionA, scenario_ModeDependentElementA, restrictions_TaskRestrictionA, scenario_VariantDependentElementA):
...
class oaam_allocations_Suballocations(scenario_VariantDependentElementA, scenario_ModeDependentElementA, allocations_AllocationsContainerA):
    ...
    pass
class oaam_restrictions_Subrestrictions(restrictions_RestrictionsContainerA, scenario_ModeDependentElementA, scenario_VariantDependentElementA):

    pass
class oaam_capabilities_MessageOnBusCapability(capabilities_CapabilityA, common_OaamBaseElementA, scenario_VariantDependentElementA, scenario_ModeDependentElementA):

    pass
class oaam_functions_Input(common_OaamBaseElementA, scenario_VariantDependentElementA, scenario_ModeDependentElementA):

    def __init__(self, queueLength: int, oaam_functions_Input323: set["Io"] = None, oaam_functions_Input325: "ExternalOutputLink" = None, oaam_functions_Input: "InputDeclaration" = None, oaam_functions_Input320: "RequiredInformationA" = None):
...
class oaam_hardware_Bus(library_ResourceProviderInstanceA, common_OaamBaseElementA, scenario_ModeDependentElementA, scenario_VariantDependentElementA):

    pass
class oaam_anatomy_Position3D(common_OaamBaseElementA, scenario_ModeDependentElementA, scenario_VariantDependentElementA):
...
class oaam_anatomy_Area(common_OaamBaseElementA, scenario_VariantDependentElementA, scenario_ModeDependentElementA):

    pass
class oaam_allocations_SignalAssignmentSegment(common_OaamBaseElementA, scenario_VariantDependentElementA, scenario_ModeDependentElementA):

    pass
class oaam_anatomy_Duct(common_OaamBaseElementA, scenario_VariantDependentElementA, scenario_ModeDependentElementA, library_ResourceProviderInstanceA):
...
class oaam_restrictions_AreaRestriction(restrictions_ConnectionRestrinctionA, restrictions_TaskGroupRestrictionA, restrictions_DeviceRestrictionA, restrictions_SignalGroupRestrictionA, common_OaamBaseElementA, restrictions_SubfunctionRestrictionA, scenario_ModeDependentElementA, restrictions_SignalRestrictionA, restrictions_TaskRestrictionA, scenario_VariantDependentElementA):
...
class oaam_hardware_Hardware(scenario_VariantDependentElementA, scenario_ModeDependentElementA, hardware_HardwareContainerA):

    pass
class oaam_capabilities_SubdeviceInDeviceCapability(capabilities_CapabilityA, common_OaamBaseElementA, scenario_VariantDependentElementA, scenario_ModeDependentElementA):

    pass
class oaam_capabilities_Subcapabilities(capabilities_CapabilitiesContainerA, scenario_ModeDependentElementA, scenario_VariantDependentElementA):

    pass
class oaam_anatomy_DuctOpening(common_OaamBaseElementA, scenario_VariantDependentElementA, scenario_ModeDependentElementA):

    pass
class oaam_systems_InformationPower(common_OaamBaseElementA, scenario_ModeDependentElementA, systems_ProvidedInformationA, scenario_VariantDependentElementA, systems_RequiredInformationA):
...
class oaam_capabilities_SignalOnConnectionOrDeviceCapability(common_OaamBaseElementA, capabilities_CapabilityA, scenario_ModeDependentElementA, scenario_VariantDependentElementA):
    ...
    def __init__(self, worstCaseTransmissionTime: float, oaam_capabilities_SignalOnConnectionOrDeviceCapability: "SignalType" = None, oaam_capabilities_SignalOnConnectionOrDeviceCapability471: "DeviceType" = None, oaam_capabilities_SignalOnConnectionOrDeviceCapability474: "ConnectionType" = None):
        ...
        pass
    @property
    def worstCaseTransmissionTime(self):
...
class oaam_systems_Subsystem(systems_SystemsContainerA, scenario_ModeDependentElementA, scenario_VariantDependentElementA):

    pass
class oaam_functions_Task(common_OaamBaseElementA, scenario_ModeDependentElementA, scenario_VariantDependentElementA):

    def __init__(self, nParallels: int, fixedRate: float, oaam_functions_Task273: "Device" = None, oaam_functions_Task275: set["TaskParameter"] = None, oaam_functions_Task: "TaskType" = None, oaam_functions_Task266: set["Input"] = None, oaam_functions_Task268: set["Output"] = None, oaam_functions_Task270: "System" = None):
...
class oaam_capabilities_MessageOnConnectionOrDeviceCapability(common_OaamBaseElementA, capabilities_CapabilityA, scenario_ModeDependentElementA, scenario_VariantDependentElementA):
...
class oaam_allocations_Schedule(common_OaamBaseElementA, scenario_VariantDependentElementA, scenario_ModeDependentElementA):
...
class oaam_restrictions_TimeDelayRestriction(common_OaamBaseElementA, scenario_VariantDependentElementA, scenario_ModeDependentElementA):
...
class oaam_allocations_ScheduledTime(common_OaamBaseElementA, scenario_ModeDependentElementA, scenario_VariantDependentElementA):

    def __init__(self, cycle: int, startTime: float, duration: float, restart: bool):
        self.cycle = cycle
...
class oaam_hardware_Device(scenario_VariantDependentElementA, common_OaamBaseElementA, library_ResourceProviderInstanceA, scenario_ModeDependentElementA):

    pass
class oaam_restrictions_ConnectionRestriction(restrictions_SignalGroupRestrictionA, common_OaamBaseElementA, scenario_ModeDependentElementA, restrictions_SubfunctionRestrictionA, restrictions_SignalRestrictionA, scenario_VariantDependentElementA):
...
class oaam_systems_System(common_OaamBaseElementA, scenario_ModeDependentElementA, scenario_VariantDependentElementA):

    pass
class oaam_functions_Signal(common_OaamBaseElementA, scenario_VariantDependentElementA, scenario_ModeDependentElementA):

    def __init__(self, inIndex: int, outIndex: int, oaam_functions_Signal: "Output" = None, oaam_functions_Signal308: "Input" = None, oaam_functions_Signal311: "SignalType" = None, oaam_functions_Signal314: "Connection" = None):
...
class oaam_systems_InformationFlow(common_OaamBaseElementA, scenario_ModeDependentElementA, scenario_VariantDependentElementA):

    pass
class oaam_restrictions_PowerSourceRestriction(restrictions_TaskGroupRestrictionA, restrictions_SignalGroupRestrictionA, common_OaamBaseElementA, scenario_ModeDependentElementA, restrictions_SubfunctionRestrictionA, scenario_VariantDependentElementA, restrictions_SignalRestrictionA, restrictions_TaskRestrictionA, restrictions_DeviceRestrictionA):

    def __init__(self, isForbidden: bool, powerSourceName: str, oaam_restrictions_PowerSourceRestriction: set["PowerSource"] = None):
        self.isForbidden = isForbidden
...
class oaam_capabilities_SubmessageInMessageCapability(capabilities_CapabilityA, common_OaamBaseElementA, scenario_VariantDependentElementA, scenario_ModeDependentElementA):

    pass
class oaam_anatomy_Subanatomy(anatomy_AnatomyContainerA, scenario_ModeDependentElementA, scenario_VariantDependentElementA):

    pass
class oaam_capabilities_ConnectionInDuctOrLocationCapability(capabilities_CapabilityA, common_OaamBaseElementA, scenario_VariantDependentElementA, scenario_ModeDependentElementA):

    pass
class oaam_allocations_ConnectionAssignment(common_OaamBaseElementA, scenario_VariantDependentElementA, scenario_ModeDependentElementA):

    pass
class oaam_restrictions_SegregationRestriction(common_OaamBaseElementA, scenario_VariantDependentElementA, scenario_ModeDependentElementA):

    def __init__(self, dissimilarTechnology: bool, dissimilarLocation: bool, dissimilarArea: bool, dissimilarPowerSource: bool, oaam_restrictions_SegregationRestriction: set["Task"] = None, oaam_restrictions_SegregationRestriction593: set["SignalGroup"] = None, oaam_restrictions_SegregationRestriction596: set["Device"] = None, oaam_restrictions_SegregationRestriction599: set["Device"] = None, oaam_restrictions_SegregationRestriction602: set["Connection"] = None, oaam_restrictions_SegregationRestriction578: set["Signal"] = None, oaam_restrictions_SegregationRestriction581: set["Signal"] = None, oaam_restrictions_SegregationRestriction584: set["TaskGroup"] = None, oaam_restrictions_SegregationRestriction587: set["TaskGroup"] = None, oaam_restrictions_SegregationRestriction590: set["SignalGroup"] = None, oaam_restrictions_SegregationRestriction605: set["Connection"] = None, oaam_restrictions_SegregationRestriction570: set["Task"] = None, oaam_restrictions_SegregationRestriction573: set["FunctionsContainerA"] = None, oaam_restrictions_SegregationRestriction575: set["FunctionsContainerA"] = None):
        self.dissimilarTechnology = dissimilarTechnology
    ...
    @property
    def dissimilarPowerSource(self):
...
class oaam_functions_TaskSymmetry(common_OaamBaseElementA, scenario_VariantDependentElementA, scenario_ModeDependentElementA):

    pass
class oaam_functions_SignalGroup(common_OaamBaseElementA, scenario_VariantDependentElementA, scenario_ModeDependentElementA):

    pass
class oaam_restrictions_LocationRestriction(restrictions_ConnectionRestrinctionA, restrictions_TaskGroupRestrictionA, restrictions_DeviceRestrictionA, restrictions_SignalGroupRestrictionA, common_OaamBaseElementA, scenario_ModeDependentElementA, restrictions_SubfunctionRestrictionA, restrictions_SignalRestrictionA, restrictions_TaskRestrictionA, scenario_VariantDependentElementA):
...
class oaam_hardware_DeviceSymmetry(common_OaamBaseElementA, scenario_VariantDependentElementA, scenario_ModeDependentElementA):

    pass
class oaam_functions_TaskRedundancy(common_OaamBaseElementA, scenario_VariantDependentElementA, scenario_ModeDependentElementA):

    pass
class oaam_anatomy_LocationSymmetry(common_OaamBaseElementA, scenario_ModeDependentElementA, scenario_VariantDependentElementA):

    pass
class oaam_allocations_DeviceAssignment(common_OaamBaseElementA, scenario_ModeDependentElementA, scenario_VariantDependentElementA):

    pass
class oaam_capabilities_TaskOnDeviceCapability(common_OaamBaseElementA, capabilities_CapabilityA, scenario_ModeDependentElementA, scenario_VariantDependentElementA):
    ...
    def __init__(self, worstCaseExecutionTime: float, failureProbability: float, oaam_capabilities_TaskOnDeviceCapability: "TaskType" = None, oaam_capabilities_TaskOnDeviceCapability453: "DeviceType" = None):
        ...
        pass
    @property
    def worstCaseExecutionTime(self):
...
class oaam_allocations_MessageSegment(common_OaamBaseElementA, scenario_ModeDependentElementA, scenario_VariantDependentElementA):

    pass
class oaam_allocations_TaskAssignment(common_OaamBaseElementA, scenario_VariantDependentElementA, scenario_ModeDependentElementA):

    pass
class oaam_scenario_Variant(common_OaamBaseElementA, scenario_ModeDependentElementA):

    pass
class oaam_capabilities_SignalInMessageCapability(common_OaamBaseElementA, capabilities_CapabilityA, scenario_ModeDependentElementA, scenario_VariantDependentElementA):

    pass
class oaam_systems_InformationMaterial(common_OaamBaseElementA, scenario_ModeDependentElementA, systems_ProvidedInformationA, scenario_VariantDependentElementA, systems_RequiredInformationA):
...
class oaam_restrictions_TaskAtomicRestriction(restrictions_TaskGroupRestrictionA, common_OaamBaseElementA, restrictions_SubfunctionRestrictionA, scenario_ModeDependentElementA, restrictions_TaskRestrictionA, scenario_VariantDependentElementA):

    pass
class oaam_anatomy_Location(library_ResourceProviderInstanceA, common_OaamBaseElementA, scenario_ModeDependentElementA, scenario_VariantDependentElementA):

    def __init__(self, length: float, oaam_anatomy_Location: "LocationType" = None, oaam_anatomy_Location403: "Position3D" = None, oaam_anatomy_Location405: set["DuctOpening"] = None):
        self.length = length
...
class oaam_functions_TaskGroup(common_OaamBaseElementA, scenario_VariantDependentElementA, scenario_ModeDependentElementA):

    pass
class oaam_anatomy_AreaSymmetry(common_OaamBaseElementA, scenario_ModeDependentElementA, scenario_VariantDependentElementA):

    pass
class oaam_capabilities_DeviceInLocationCapability(capabilities_CapabilityA, common_OaamBaseElementA, scenario_VariantDependentElementA, scenario_ModeDependentElementA):

    pass
class oaam_allocations_MessageA(common_OaamBaseElementA, scenario_VariantDependentElementA, scenario_ModeDependentElementA):

    def __init__(self, isPersistent: bool, length: int, oaam_allocations_MessageA: set["Schedule"] = None, oaam_allocations_MessageA692: set["Submessage"] = None, oaam_allocations_MessageA694: set["SignalToMessageAssignment"] = None, oaam_allocations_MessageA696: set["MessageSegment"] = None, oaam_allocations_MessageA698: "MessageType" = None):
...
class oaam_functions_ExternalTaskLink(common_OaamBaseElementA, scenario_ModeDependentElementA, scenario_VariantDependentElementA):

    def __init__(self, filter: str, oaam_functions_ExternalTaskLink: "TaskType" = None, oaam_functions_ExternalTaskLink279: set["Input"] = None, oaam_functions_ExternalTaskLink282: set["Output"] = None, oaam_functions_ExternalTaskLink285: "Task" = None):
        self.filter = filter
...
class oaam_allocations_ConnectionAssignmentSegment(common_OaamBaseElementA, scenario_ModeDependentElementA, scenario_VariantDependentElementA):

    pass
class oaam_functions_Output(common_OaamBaseElementA, scenario_ModeDependentElementA, scenario_VariantDependentElementA):

    def __init__(self, fixedRate: float, oaam_functions_Output332: set["Io"] = None, oaam_functions_Output: "ProvidedInformationA" = None, oaam_functions_Output329: "OutputDeclaration" = None):
        self.fixedRate = fixedRate
...
class oaam_hardware_Io(common_OaamBaseElementA, scenario_ModeDependentElementA, scenario_VariantDependentElementA):

    pass
class oaam_capabilities_SubconnectionInDeviceCapability(common_OaamBaseElementA, capabilities_CapabilityA, scenario_ModeDependentElementA, scenario_VariantDependentElementA):

    pass
class oaam_allocations_SubdeviceAssignment(common_OaamBaseElementA, scenario_VariantDependentElementA, scenario_ModeDependentElementA):

    pass
class oaam_hardware_Connection(common_OaamBaseElementA, scenario_VariantDependentElementA, scenario_ModeDependentElementA, library_ResourceProviderInstanceA):

    pass
class oaam_functions_FailureCondition(common_OaamBaseElementA, scenario_VariantDependentElementA, scenario_ModeDependentElementA):

    def __init__(self, maxOccurrenceProbability: float, noSingleFailure: bool, oaam_functions_FailureCondition: "BoolA" = None, oaam_functions_FailureCondition296: set["BoolOperation"] = None, oaam_functions_FailureCondition299: set["BoolNot"] = None, oaam_functions_FailureCondition302: set["OutputIntegrityState"] = None):
    ...
    @property
    def maxOccurrenceProbability(self):
...
class oaam_restrictions_ConnectionTypeRestriction(restrictions_SignalGroupRestrictionA, common_OaamBaseElementA, restrictions_SubfunctionRestrictionA, scenario_ModeDependentElementA, restrictions_SignalRestrictionA, scenario_VariantDependentElementA):
...
class oaam_hardware_Subhardware(scenario_VariantDependentElementA, scenario_ModeDependentElementA, hardware_HardwareContainerA):
    ...
    pass
class oaam_scenario_ScenarioParameterA(scenario_ModeDependentElementA, scenario_VariantDependentElementA):
