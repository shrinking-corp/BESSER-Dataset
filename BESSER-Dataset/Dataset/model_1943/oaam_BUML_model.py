...
oaam_Architecture = Class(name="oaam_Architecture")
OaamBaseElementA = Class(name="OaamBaseElementA")
Library = Class(name="Library")
oaam_common_OaamBaseElementA = Class(name="oaam_common_OaamBaseElementA", is_abstract=True)
...
oaam_common_AttributeContainment = Class(name="oaam_common_AttributeContainment")
AttributeA = Class(name="AttributeA")
oaam_common_BoolA = Class(name="oaam_common_BoolA", is_abstract=True)
oaam_common_AttributeA = Class(name="oaam_common_AttributeA", is_abstract=True)
oaam_common_AttributeString = Class(name="oaam_common_AttributeString")
oaam_common_AttributeNumeric = Class(name="oaam_common_AttributeNumeric")
oaam_common_AttributeReference = Class(name="oaam_common_AttributeReference")
oaam_common_BoolOperation = Class(name="oaam_common_BoolOperation")
common_BoolA = Class(name="common_BoolA")
common_OaamBaseElementA = Class(name="common_OaamBaseElementA")
BoolA = Class(name="BoolA")
oaam_common_BoolNot = Class(name="oaam_common_BoolNot")
oaam_common_DataTypeA = Class(name="oaam_common_DataTypeA", is_abstract=True)
oaam_common_Integer = Class(name="oaam_common_Integer")
DataTypeA = Class(name="DataTypeA")
oaam_common_Character = Class(name="oaam_common_Character")
oaam_common_Array = Class(name="oaam_common_Array")
oaam_common_Struct = Class(name="oaam_common_Struct")
Struct = Class(name="Struct")
oaam_common_FloatingPoint = Class(name="oaam_common_FloatingPoint")
oaam_common_Byte = Class(name="oaam_common_Byte")
oaam_common_Boolean = Class(name="oaam_common_Boolean")
Resource = Class(name="Resource")
ResourceGroup = Class(name="ResourceGroup")
oaam_library_ResourceConsumerA = Class(name="oaam_library_ResourceConsumerA", is_abstract=True)
oaam_library_LibraryContainerA = Class(name="oaam_library_LibraryContainerA", is_abstract=True)
oaam_library_ResourceProviderA = Class(name="oaam_library_ResourceProviderA", is_abstract=True)
ResourceBundle = Class(name="ResourceBundle")
ResourceType = Class(name="ResourceType")
ResourceLink = Class(name="ResourceLink")
oaam_library_ResourceProviderInstanceA = Class(name="oaam_library_ResourceProviderInstanceA", is_abstract=True)
...
oaam_library_ResourceType = Class(name="oaam_library_ResourceType")
library_ResourceConsumerA = Class(name="library_ResourceConsumerA")
oaam_library_ResourceBundle = Class(name="oaam_library_ResourceBundle")
oaam_library_TaskType = Class(name="oaam_library_TaskType")
...
oaam_library_Resource = Class(name="oaam_library_Resource")
oaam_library_ResourceAlternatives = Class(name="oaam_library_ResourceAlternatives")
oaam_library_DeviceType = Class(name="oaam_library_DeviceType")
library_ResourceProviderA = Class(name="library_ResourceProviderA")
...
oaam_library_SignalType = Class(name="oaam_library_SignalType")
IoGroup = Class(name="IoGroup")
oaam_library_ConnectionType = Class(name="oaam_library_ConnectionType")
DuctOpeningDeclaration = Class(name="DuctOpeningDeclaration")
oaam_library_DuctType = Class(name="oaam_library_DuctType")
oaam_library_WireType = Class(name="oaam_library_WireType")
oaam_library_LocationType = Class(name="oaam_library_LocationType")
oaam_library_OutputDeclaration = Class(name="oaam_library_OutputDeclaration")
oaam_library_IoType = Class(name="oaam_library_IoType")
oaam_library_InputDeclaration = Class(name="oaam_library_InputDeclaration")
oaam_library_DuctOpeningDeclaration = Class(name="oaam_library_DuctOpeningDeclaration")
oaam_library_ResourceGroup = Class(name="oaam_library_ResourceGroup")
oaam_library_DeviceTypeSymmetry = Class(name="oaam_library_DeviceTypeSymmetry")
TaskOutputTrigger = Class(name="TaskOutputTrigger")
FaultPropagation = Class(name="FaultPropagation")
oaam_library_IoDeclaration = Class(name="oaam_library_IoDeclaration")
BoolOperation = Class(name="BoolOperation")
BoolNot = Class(name="BoolNot")
TaskInputState = Class(name="TaskInputState")
oaam_library_TaskInputState = Class(name="oaam_library_TaskInputState")
oaam_library_IoGroup = Class(name="oaam_library_IoGroup")
oaam_library_AttributeDefinition = Class(name="oaam_library_AttributeDefinition")
oaam_library_FaultPropagation = Class(name="oaam_library_FaultPropagation")
oaam_library_ResourceTypeModifierReference = Class(name="oaam_library_ResourceTypeModifierReference")
oaam_library_PowerSource = Class(name="oaam_library_PowerSource")
oaam_library_ResourceLink = Class(name="oaam_library_ResourceLink")
oaam_library_ResourceTypeModifier = Class(name="oaam_library_ResourceTypeModifier")
oaam_library_ResourceTypeModifierLevel = Class(name="oaam_library_ResourceTypeModifierLevel")
oaam_library_TaskOutputTrigger = Class(name="oaam_library_TaskOutputTrigger")
oaam_library_TaskTypeDissimilarity = Class(name="oaam_library_TaskTypeDissimilarity")
oaam_library_DeviceTypeDissimilarity = Class(name="oaam_library_DeviceTypeDissimilarity")
oaam_library_ResourceTypeDissimilarity = Class(name="oaam_library_ResourceTypeDissimilarity")
oaam_library_MessageType = Class(name="oaam_library_MessageType")
TaskInputTrigger = Class(name="TaskInputTrigger")
oaam_library_TaskInputTrigger = Class(name="oaam_library_TaskInputTrigger")
oaam_library_TaskStateDeclaration = Class(name="oaam_library_TaskStateDeclaration")
oaam_library_TaskParameterDeclaration = Class(name="oaam_library_TaskParameterDeclaration")
oaam_library_BusType = Class(name="oaam_library_BusType")
oaam_scenario_ModeDependentElementA = Class(name="oaam_scenario_ModeDependentElementA", is_abstract=True)
OperationModeReference = Class(name="OperationModeReference")
oaam_scenario_VariantDependentElementA = Class(name="oaam_scenario_VariantDependentElementA", is_abstract=True)
Variant = Class(name="Variant")
oaam_scenario_ScenarioContainerA = Class(name="oaam_scenario_ScenarioContainerA", is_abstract=True)
ScenarioParameterA = Class(name="ScenarioParameterA")
oaam_library_Library = Class(name="oaam_library_Library")
LibraryContainerA = Class(name="LibraryContainerA")
oaam_library_Sublibrary = Class(name="oaam_library_Sublibrary")
oaam_scenario_ScenarioParameterA = Class(name="oaam_scenario_ScenarioParameterA", is_abstract=True)
scenario_ModeDependentElementA = Class(name="scenario_ModeDependentElementA")
scenario_VariantDependentElementA = Class(name="scenario_VariantDependentElementA")
oaam_scenario_ScenarioParameterBool = Class(name="oaam_scenario_ScenarioParameterBool")
oaam_scenario_Variant = Class(name="oaam_scenario_Variant")
oaam_scenario_OperationModeReference = Class(name="oaam_scenario_OperationModeReference")
OperationMode = Class(name="OperationMode")
Subscenario = Class(name="Subscenario")
oaam_scenario_OperationMode = Class(name="oaam_scenario_OperationMode")
oaam_scenario_ScenarioParameterNumeric = Class(name="oaam_scenario_ScenarioParameterNumeric")
scenario_ScenarioParameterA = Class(name="scenario_ScenarioParameterA")
oaam_systems_Systems = Class(name="oaam_systems_Systems")
SystemsContainerA = Class(name="SystemsContainerA")
oaam_systems_Subsystem = Class(name="oaam_systems_Subsystem")
systems_SystemsContainerA = Class(name="systems_SystemsContainerA")
oaam_systems_System = Class(name="oaam_systems_System")
ProvidedInformationA = Class(name="ProvidedInformationA")
oaam_scenario_Scenario = Class(name="oaam_scenario_Scenario")
ScenarioContainerA = Class(name="ScenarioContainerA")
oaam_scenario_Subscenario = Class(name="oaam_scenario_Subscenario")
oaam_systems_SystemsContainerA = Class(name="oaam_systems_SystemsContainerA", is_abstract=True)
...
oaam_systems_InformationMaterial = Class(name="oaam_systems_InformationMaterial")
RequiredInformationA = Class(name="RequiredInformationA")
oaam_systems_RequiredInformationA = Class(name="oaam_systems_RequiredInformationA", is_abstract=True)
oaam_systems_ProvidedInformationA = Class(name="oaam_systems_ProvidedInformationA", is_abstract=True)
oaam_systems_InformationFlow = Class(name="oaam_systems_InformationFlow")
oaam_systems_InformationSignal = Class(name="oaam_systems_InformationSignal")
systems_ProvidedInformationA = Class(name="systems_ProvidedInformationA")
systems_RequiredInformationA = Class(name="systems_RequiredInformationA")
oaam_systems_LinearPower = Class(name="oaam_systems_LinearPower")
oaam_systems_InputSegregation = Class(name="oaam_systems_InputSegregation")
oaam_systems_InformationPower = Class(name="oaam_systems_InformationPower")
oaam_systems_ElectricPower = Class(name="oaam_systems_ElectricPower")
InformationPower = Class(name="InformationPower")
oaam_systems_HydraulicPower = Class(name="oaam_systems_HydraulicPower")
oaam_systems_RotaryPower = Class(name="oaam_systems_RotaryPower")
...
oaam_functions_Functions = Class(name="oaam_functions_Functions")
FunctionsContainerA = Class(name="FunctionsContainerA")
oaam_functions_FunctionsContainerA = Class(name="oaam_functions_FunctionsContainerA", is_abstract=True)
...
oaam_functions_ExternalTaskLink = Class(name="oaam_functions_ExternalTaskLink")
FailureCondition = Class(name="FailureCondition")
Subfunctions = Class(name="Subfunctions")
oaam_functions_Task = Class(name="oaam_functions_Task")
Input = Class(name="Input")
Output = Class(name="Output")
oaam_functions_TaskRedundancy = Class(name="oaam_functions_TaskRedundancy")
oaam_functions_FailureCondition = Class(name="oaam_functions_FailureCondition")
oaam_functions_TaskGroup = Class(name="oaam_functions_TaskGroup")
oaam_functions_TaskSymmetry = Class(name="oaam_functions_TaskSymmetry")
oaam_functions_Signal = Class(name="oaam_functions_Signal")
OutputIntegrityState = Class(name="OutputIntegrityState")
oaam_functions_OutputIntegrityState = Class(name="oaam_functions_OutputIntegrityState")
Io = Class(name="Io")
ExternalOutputLink = Class(name="ExternalOutputLink")
oaam_functions_Output = Class(name="oaam_functions_Output")
Connection = Class(name="Connection")
oaam_functions_SignalGroup = Class(name="oaam_functions_SignalGroup")
oaam_functions_Input = Class(name="oaam_functions_Input")
oaam_functions_TaskParameter = Class(name="oaam_functions_TaskParameter")
oaam_hardware_HardwareContainerA = Class(name="oaam_hardware_HardwareContainerA", is_abstract=True)
oaam_functions_ExternalOutputLink = Class(name="oaam_functions_ExternalOutputLink")
oaam_functions_Subfunctions = Class(name="oaam_functions_Subfunctions")
Location = Class(name="Location")
oaam_hardware_Connection = Class(name="oaam_hardware_Connection")
DeviceSymmetry = Class(name="DeviceSymmetry")
Subhardware = Class(name="Subhardware")
Bus = Class(name="Bus")
oaam_hardware_Device = Class(name="oaam_hardware_Device")
library_ResourceProviderInstanceA = Class(name="library_ResourceProviderInstanceA")
oaam_hardware_Hardware = Class(name="oaam_hardware_Hardware")
hardware_HardwareContainerA = Class(name="hardware_HardwareContainerA")
oaam_hardware_Subhardware = Class(name="oaam_hardware_Subhardware")
oaam_hardware_Bus = Class(name="oaam_hardware_Bus")
oaam_hardware_Io = Class(name="oaam_hardware_Io")
oaam_hardware_DeviceSymmetry = Class(name="oaam_hardware_DeviceSymmetry")
Subanatomy = Class(name="Subanatomy")
AreaSymmetry = Class(name="AreaSymmetry")
oaam_anatomy_Location = Class(name="oaam_anatomy_Location")
Position3D = Class(name="Position3D")
oaam_anatomy_AnatomyContainerA = Class(name="oaam_anatomy_AnatomyContainerA", is_abstract=True)
LocationSymmetry = Class(name="LocationSymmetry")
Duct = Class(name="Duct")
Area = Class(name="Area")
oaam_anatomy_DuctOpening = Class(name="oaam_anatomy_DuctOpening")
DuctOpening = Class(name="DuctOpening")
oaam_anatomy_Area = Class(name="oaam_anatomy_Area")
oaam_anatomy_Duct = Class(name="oaam_anatomy_Duct")
oaam_anatomy_AreaSymmetry = Class(name="oaam_anatomy_AreaSymmetry")
oaam_anatomy_Subanatomy = Class(name="oaam_anatomy_Subanatomy")
anatomy_AnatomyContainerA = Class(name="anatomy_AnatomyContainerA")
oaam_anatomy_Anatomy = Class(name="oaam_anatomy_Anatomy")
AnatomyContainerA = Class(name="AnatomyContainerA")
oaam_anatomy_Position3D = Class(name="oaam_anatomy_Position3D")
oaam_anatomy_LocationSymmetry = Class(name="oaam_anatomy_LocationSymmetry")
...
oaam_capabilities_CapabilityA = Class(name="oaam_capabilities_CapabilityA", is_abstract=True)
ResourceConsumption = Class(name="ResourceConsumption")
oaam_capabilities_CapabilitiesContainerA = Class(name="oaam_capabilities_CapabilitiesContainerA", is_abstract=True)
...
oaam_capabilities_DeviceInLocationCapability = Class(name="oaam_capabilities_DeviceInLocationCapability")
oaam_capabilities_ConnectionInDuctOrLocationCapability = Class(name="oaam_capabilities_ConnectionInDuctOrLocationCapability")
MessageOnConnectionOrDeviceCapability = Class(name="MessageOnConnectionOrDeviceCapability")
oaam_capabilities_TaskOnDeviceCapability = Class(name="oaam_capabilities_TaskOnDeviceCapability")
capabilities_CapabilityA = Class(name="capabilities_CapabilityA")
oaam_capabilities_SubdeviceInDeviceCapability = Class(name="oaam_capabilities_SubdeviceInDeviceCapability")
oaam_capabilities_SignalOnConnectionOrDeviceCapability = Class(name="oaam_capabilities_SignalOnConnectionOrDeviceCapability")
oaam_capabilities_MessageOnConnectionOrDeviceCapability = Class(name="oaam_capabilities_MessageOnConnectionOrDeviceCapability")
oaam_capabilities_SubconnectionInDeviceCapability = Class(name="oaam_capabilities_SubconnectionInDeviceCapability")
oaam_capabilities_ResourceConsumption = Class(name="oaam_capabilities_ResourceConsumption")
oaam_capabilities_MessageOnBusCapability = Class(name="oaam_capabilities_MessageOnBusCapability")
oaam_capabilities_Capabilities = Class(name="oaam_capabilities_Capabilities")
CapabilitiesContainerA = Class(name="CapabilitiesContainerA")
oaam_capabilities_Subcapabilities = Class(name="oaam_capabilities_Subcapabilities")
capabilities_CapabilitiesContainerA = Class(name="capabilities_CapabilitiesContainerA")
oaam_capabilities_SubmessageInMessageCapability = Class(name="oaam_capabilities_SubmessageInMessageCapability")
oaam_capabilities_SignalInMessageCapability = Class(name="oaam_capabilities_SignalInMessageCapability")
...
oaam_restrictions_RestrictionsContainerA = Class(name="oaam_restrictions_RestrictionsContainerA", is_abstract=True)
...
oaam_restrictions_ConnectionRestrinctionA = Class(name="oaam_restrictions_ConnectionRestrinctionA", is_abstract=True)
oaam_restrictions_TaskRestrictionA = Class(name="oaam_restrictions_TaskRestrictionA", is_abstract=True)
oaam_restrictions_SignalRestrictionA = Class(name="oaam_restrictions_SignalRestrictionA", is_abstract=True)
...
oaam_restrictions_Restrictions = Class(name="oaam_restrictions_Restrictions")
RestrictionsContainerA = Class(name="RestrictionsContainerA")
oaam_restrictions_DeviceRestrictionA = Class(name="oaam_restrictions_DeviceRestrictionA", is_abstract=True)
oaam_restrictions_AreaRestriction = Class(name="oaam_restrictions_AreaRestriction")
oaam_restrictions_SubfunctionRestrictionA = Class(name="oaam_restrictions_SubfunctionRestrictionA", is_abstract=True)
oaam_restrictions_TaskGroupRestrictionA = Class(name="oaam_restrictions_TaskGroupRestrictionA", is_abstract=True)
oaam_restrictions_SignalGroupRestrictionA = Class(name="oaam_restrictions_SignalGroupRestrictionA", is_abstract=True)
oaam_restrictions_LocationRestriction = Class(name="oaam_restrictions_LocationRestriction")
restrictions_TaskRestrictionA = Class(name="restrictions_TaskRestrictionA")
restrictions_TaskGroupRestrictionA = Class(name="restrictions_TaskGroupRestrictionA")
restrictions_SignalRestrictionA = Class(name="restrictions_SignalRestrictionA")
restrictions_SignalGroupRestrictionA = Class(name="restrictions_SignalGroupRestrictionA")
restrictions_SubfunctionRestrictionA = Class(name="restrictions_SubfunctionRestrictionA")
restrictions_DeviceRestrictionA = Class(name="restrictions_DeviceRestrictionA")
restrictions_ConnectionRestrinctionA = Class(name="restrictions_ConnectionRestrinctionA")
oaam_restrictions_DeviceRestriction = Class(name="oaam_restrictions_DeviceRestriction")
oaam_restrictions_PowerSourceRestriction = Class(name="oaam_restrictions_PowerSourceRestriction")
oaam_restrictions_ConnectionTypeRestriction = Class(name="oaam_restrictions_ConnectionTypeRestriction")
oaam_restrictions_ConnectionRestriction = Class(name="oaam_restrictions_ConnectionRestriction")
oaam_restrictions_DeviceTypeRestriction = Class(name="oaam_restrictions_DeviceTypeRestriction")
oaam_restrictions_SegregationRestriction = Class(name="oaam_restrictions_SegregationRestriction")
oaam_restrictions_SynchronicityRestriction = Class(name="oaam_restrictions_SynchronicityRestriction")
oaam_restrictions_TaskAtomicRestriction = Class(name="oaam_restrictions_TaskAtomicRestriction")
oaam_restrictions_Subrestrictions = Class(name="oaam_restrictions_Subrestrictions")
restrictions_RestrictionsContainerA = Class(name="restrictions_RestrictionsContainerA")
oaam_restrictions_TaskSymmetryRestriction = Class(name="oaam_restrictions_TaskSymmetryRestriction")
oaam_restrictions_TimeDelayRestriction = Class(name="oaam_restrictions_TimeDelayRestriction")
...
oaam_allocations_AllocationsContainerA = Class(name="oaam_allocations_AllocationsContainerA", is_abstract=True)
...
oaam_allocations_SignalAssignment = Class(name="oaam_allocations_SignalAssignment")
...
oaam_allocations_TaskAssignment = Class(name="oaam_allocations_TaskAssignment")
oaam_allocations_DeviceAssignment = Class(name="oaam_allocations_DeviceAssignment")
oaam_allocations_ConnectionAssignment = Class(name="oaam_allocations_ConnectionAssignment")
ConnectionAssignmentSegment = Class(name="ConnectionAssignmentSegment")
oaam_allocations_SignalAssignmentSegment = Class(name="oaam_allocations_SignalAssignmentSegment")
oaam_allocations_SubdeviceAssignment = Class(name="oaam_allocations_SubdeviceAssignment")
oaam_allocations_ConnectionAssignmentSegment = Class(name="oaam_allocations_ConnectionAssignmentSegment")
ScheduledTime = Class(name="ScheduledTime")
oaam_allocations_ScheduledTime = Class(name="oaam_allocations_ScheduledTime")
oaam_allocations_MessageA = Class(name="oaam_allocations_MessageA", is_abstract=True)
oaam_allocations_SubconnectionAssignment = Class(name="oaam_allocations_SubconnectionAssignment")
oaam_allocations_Schedule = Class(name="oaam_allocations_Schedule")
oaam_allocations_MessageSegment = Class(name="oaam_allocations_MessageSegment")
oaam_allocations_Message = Class(name="oaam_allocations_Message")
...
oaam_allocations_Allocations = Class(name="oaam_allocations_Allocations")
AllocationsContainerA = Class(name="AllocationsContainerA")
oaam_allocations_Suballocations = Class(name="oaam_allocations_Suballocations")
allocations_AllocationsContainerA = Class(name="allocations_AllocationsContainerA")
oaam_allocations_Submessage = Class(name="oaam_allocations_Submessage")
oaam_allocations_SignalToMessageAssignment = Class(name="oaam_allocations_SignalToMessageAssignment")
...
oaam_common_OaamBaseElementA.attributes={oaam_common_OaamBaseElementA_modified, oaam_common_OaamBaseElementA_id, oaam_common_OaamBaseElementA_name, oaam_common_OaamBaseElementA_style, oaam_common_OaamBaseElementA_modifier, oaam_common_OaamBaseElementA_documentation, oaam_common_OaamBaseElementA_traceLink}
...
oaam_common_Integer.attributes={oaam_common_Integer_signed, oaam_common_Integer_nBits, oaam_common_Integer_endianess}
...
oaam_common_Character.attributes={oaam_common_Character_encoding, oaam_common_Character_nBits}
...
oaam_library_ResourceType.attributes={oaam_library_ResourceType_isConsumed, oaam_library_ResourceType_direction, oaam_library_ResourceType_isPropagated, oaam_library_ResourceType_unit, oaam_library_ResourceType_isConfigurable, oaam_library_ResourceType_isIo, oaam_library_ResourceType_isDistinguishable}
...
oaam_library_ResourceBundle.attributes={oaam_library_ResourceBundle_cost, oaam_library_ResourceBundle_mtbf, oaam_library_ResourceBundle_mass}
...
oaam_library_TaskType.attributes={oaam_library_TaskType_isDeterministic, oaam_library_TaskType_preferredExecutionRate}
...
oaam_library_DeviceType.attributes={oaam_library_DeviceType_weight, oaam_library_DeviceType_mtbf, oaam_library_DeviceType_cost, oaam_library_DeviceType_isSubdevice, oaam_library_DeviceType_isSelfManaging, oaam_library_DeviceType_canHaveSubdevices}
...
oaam_library_ConnectionType.attributes={oaam_library_ConnectionType_directConnectionsAllowed, oaam_library_ConnectionType_maxLength, oaam_library_ConnectionType_isPower, oaam_library_ConnectionType_nEndPoints, oaam_library_ConnectionType_nStartingPoints, oaam_library_ConnectionType_requiresMaster, oaam_library_ConnectionType_maxJointBranches, oaam_library_ConnectionType_maxInterfaceToJointDistance, oaam_library_ConnectionType_isSwitched, oaam_library_ConnectionType_isUnidirectional, oaam_library_ConnectionType_isInformation, oaam_library_ConnectionType_nJoints, oaam_library_ConnectionType_allowsCircles, oaam_library_ConnectionType_isWireless}
...
oaam_library_WireType.attributes={oaam_library_WireType_specificPrice, oaam_library_WireType_specificWeight, oaam_library_WireType_minBendingRadius, oaam_library_WireType_nShields, oaam_library_WireType_nConductors, oaam_library_WireType_mtbf}
...
oaam_library_OutputDeclaration.attributes={oaam_library_OutputDeclaration_postcondition, oaam_library_OutputDeclaration_unit, oaam_library_OutputDeclaration_range, oaam_library_OutputDeclaration_lowerBound, oaam_library_OutputDeclaration_upperBound}
...
oaam_library_InputDeclaration.attributes={oaam_library_InputDeclaration_range, oaam_library_InputDeclaration_upperBound, oaam_library_InputDeclaration_unit, oaam_library_InputDeclaration_lowerBound, oaam_library_InputDeclaration_precondition}
...
oaam_library_TaskOutputTrigger.attributes={oaam_library_TaskOutputTrigger_fixedRate, oaam_library_TaskOutputTrigger_isFixedRate}
...
oaam_library_BusType.attributes={oaam_library_BusType_mtbf, oaam_library_BusType_isSelfManaging, oaam_library_BusType_requiresMaster}
...
oaam_systems_InformationSignal.attributes={oaam_systems_InformationSignal_resolution, oaam_systems_InformationSignal_unit, oaam_systems_InformationSignal_rate, oaam_systems_InformationSignal_accuracy, oaam_systems_InformationSignal_latency}
...
oaam_systems_InputSegregation.attributes={oaam_systems_InputSegregation_dissimilarSource, oaam_systems_InputSegregation_dissimilarRoute, oaam_systems_InputSegregation_dissimilarTechnology}
...
oaam_systems_ElectricPower.attributes={oaam_systems_ElectricPower_current, oaam_systems_ElectricPower_nPhases, oaam_systems_ElectricPower_voltage, oaam_systems_ElectricPower_frequency}
...
oaam_systems_HydraulicPower.attributes={oaam_systems_HydraulicPower_pressure, oaam_systems_HydraulicPower_massFlowRate}
...
oaam_systems_RotaryPower.attributes={oaam_systems_RotaryPower_momentum, oaam_systems_RotaryPower_angularVelocity}
...
oaam_functions_Task.attributes={oaam_functions_Task_fixedRate, oaam_functions_Task_nParallels}
...
oaam_functions_Signal.attributes={oaam_functions_Signal_inIndex, oaam_functions_Signal_outIndex}
...
oaam_functions_Subfunctions.attributes={oaam_functions_Subfunctions_multiplicityMax, oaam_functions_Subfunctions_multiplicityMin}
...
oaam_anatomy_Position3D.attributes={oaam_anatomy_Position3D_x, oaam_anatomy_Position3D_y, oaam_anatomy_Position3D_z}
...
oaam_restrictions_AreaRestriction.attributes={oaam_restrictions_AreaRestriction_areaName, oaam_restrictions_AreaRestriction_isForbidden}
...
oaam_restrictions_DeviceRestriction.attributes={oaam_restrictions_DeviceRestriction_deviceName, oaam_restrictions_DeviceRestriction_isForbidden}
...
oaam_restrictions_PowerSourceRestriction.attributes={oaam_restrictions_PowerSourceRestriction_powerSourceName, oaam_restrictions_PowerSourceRestriction_isForbidden}
...
oaam_restrictions_DeviceTypeRestriction.attributes={oaam_restrictions_DeviceTypeRestriction_isForbidden, oaam_restrictions_DeviceTypeRestriction_deviceTypeName}
...
oaam_restrictions_SegregationRestriction.attributes={oaam_restrictions_SegregationRestriction_dissimilarTechnology, oaam_restrictions_SegregationRestriction_dissimilarLocation, oaam_restrictions_SegregationRestriction_dissimilarPowerSource, oaam_restrictions_SegregationRestriction_dissimilarArea}
...
oaam_allocations_ScheduledTime.attributes={oaam_allocations_ScheduledTime_restart, oaam_allocations_ScheduledTime_cycle, oaam_allocations_ScheduledTime_startTime, oaam_allocations_ScheduledTime_duration}
...
oaam_allocations_Schedule.attributes={oaam_allocations_Schedule_rate, oaam_allocations_Schedule_priority, oaam_allocations_Schedule_isPeriodic}
...
in_28: BinaryAssociation = BinaryAssociation(
    name="in_28",
    ends={
...
in_162: BinaryAssociation = BinaryAssociation(
    name="in_162",
    ends={
...
from_236: BinaryAssociation = BinaryAssociation(
    name="from_236",
    ends={
...
domain_model = DomainModel(
    name="oaam",
    types={Scenario, Systems, oaam_Architecture, OaamBaseElementA, Library, oaam_common_OaamBaseElementA, Functions, Hardware, Anatomy, Capabilities, Restrictions, Allocations, oaam_common_AttributeContainment, AttributeA, oaam_common_BoolA, oaam_common_AttributeA, oaam_common_AttributeString, oaam_common_AttributeNumeric, oaam_common_AttributeReference, oaam_common_BoolOperation, common_BoolA, common_OaamBaseElementA, BoolA, oaam_common_BoolNot, oaam_common_DataTypeA, oaam_common_Integer, DataTypeA, oaam_common_Character, oaam_common_Array, oaam_common_Struct, Struct, oaam_common_FloatingPoint, oaam_common_Byte, oaam_common_Boolean, Resource, ResourceGroup, oaam_library_ResourceConsumerA, oaam_library_LibraryContainerA, oaam_library_ResourceProviderA, ResourceBundle, ResourceType, ResourceLink, oaam_library_ResourceProviderInstanceA, ResourceTypeModifierLevel, SignalType, DeviceType, ResourceTypeModifier, ResourceTypeDissimilarity, TaskType, TaskTypeDissimilarity, DuctType, AttributeDefinition, PowerSource, DeviceTypeSymmetry, Sublibrary, DeviceTypeDissimilarity, ConnectionType, WireType, LocationType, IoType, BusType, MessageType, oaam_library_ResourceType, library_ResourceConsumerA, oaam_library_ResourceBundle, oaam_library_TaskType, ResourceTypeModifierReference, ResourceAlternatives, oaam_library_Resource, oaam_library_ResourceAlternatives, oaam_library_DeviceType, library_ResourceProviderA, IoDeclaration, OutputDeclaration, InputDeclaration, TaskStateDeclaration, TaskParameterDeclaration, oaam_library_SignalType, IoGroup, oaam_library_ConnectionType, DuctOpeningDeclaration, oaam_library_DuctType, oaam_library_WireType, oaam_library_LocationType, oaam_library_OutputDeclaration, oaam_library_IoType, oaam_library_InputDeclaration, oaam_library_DuctOpeningDeclaration, oaam_library_ResourceGroup, oaam_library_DeviceTypeSymmetry, TaskOutputTrigger, FaultPropagation, oaam_library_IoDeclaration, BoolOperation, BoolNot, TaskInputState, oaam_library_TaskInputState, oaam_library_IoGroup, oaam_library_AttributeDefinition, oaam_library_FaultPropagation, oaam_library_ResourceTypeModifierReference, oaam_library_PowerSource, oaam_library_ResourceLink, oaam_library_ResourceTypeModifier, oaam_library_ResourceTypeModifierLevel, oaam_library_TaskOutputTrigger, oaam_library_TaskTypeDissimilarity, oaam_library_DeviceTypeDissimilarity, oaam_library_ResourceTypeDissimilarity, oaam_library_MessageType, TaskInputTrigger, oaam_library_TaskInputTrigger, oaam_library_TaskStateDeclaration, oaam_library_TaskParameterDeclaration, oaam_library_BusType, oaam_scenario_ModeDependentElementA, OperationModeReference, oaam_scenario_VariantDependentElementA, Variant, oaam_scenario_ScenarioContainerA, ScenarioParameterA, oaam_library_Library, LibraryContainerA, oaam_library_Sublibrary, oaam_scenario_ScenarioParameterA, scenario_ModeDependentElementA, scenario_VariantDependentElementA, oaam_scenario_ScenarioParameterBool, oaam_scenario_Variant, oaam_scenario_OperationModeReference, OperationMode, Subscenario, oaam_scenario_OperationMode, oaam_scenario_ScenarioParameterNumeric, scenario_ScenarioParameterA, oaam_systems_Systems, SystemsContainerA, oaam_systems_Subsystem, systems_SystemsContainerA, oaam_systems_System, ProvidedInformationA, oaam_scenario_Scenario, ScenarioContainerA, oaam_scenario_Subscenario, oaam_systems_SystemsContainerA, System, InformationFlow, InputSegregation, Subsystem, oaam_systems_InformationMaterial, RequiredInformationA, oaam_systems_RequiredInformationA, oaam_systems_ProvidedInformationA, oaam_systems_InformationFlow, oaam_systems_InformationSignal, systems_ProvidedInformationA, systems_RequiredInformationA, oaam_systems_LinearPower, oaam_systems_InputSegregation, oaam_systems_InformationPower, oaam_systems_ElectricPower, InformationPower, oaam_systems_HydraulicPower, oaam_systems_RotaryPower, TaskGroup, TaskSymmetry, TaskRedundancy, Signal, SignalGroup, oaam_functions_Functions, FunctionsContainerA, oaam_functions_FunctionsContainerA, Task, ExternalTaskLink, Device, TaskParameter, oaam_functions_ExternalTaskLink, FailureCondition, Subfunctions, oaam_functions_Task, Input, Output, oaam_functions_TaskRedundancy, oaam_functions_FailureCondition, oaam_functions_TaskGroup, oaam_functions_TaskSymmetry, oaam_functions_Signal, OutputIntegrityState, oaam_functions_OutputIntegrityState, Io, ExternalOutputLink, oaam_functions_Output, Connection, oaam_functions_SignalGroup, oaam_functions_Input, oaam_functions_TaskParameter, oaam_hardware_HardwareContainerA, oaam_functions_ExternalOutputLink, oaam_functions_Subfunctions, Location, oaam_hardware_Connection, DeviceSymmetry, Subhardware, Bus, oaam_hardware_Device, library_ResourceProviderInstanceA, oaam_hardware_Hardware, hardware_HardwareContainerA, oaam_hardware_Subhardware, oaam_hardware_Bus, oaam_hardware_Io, oaam_hardware_DeviceSymmetry, Subanatomy, AreaSymmetry, oaam_anatomy_Location, Position3D, oaam_anatomy_AnatomyContainerA, LocationSymmetry, Duct, Area, oaam_anatomy_DuctOpening, DuctOpening, oaam_anatomy_Area, oaam_anatomy_Duct, oaam_anatomy_AreaSymmetry, oaam_anatomy_Subanatomy, anatomy_AnatomyContainerA, oaam_anatomy_Anatomy, AnatomyContainerA, oaam_anatomy_Position3D, oaam_anatomy_LocationSymmetry, SubconnectionInDeviceCapability, MessageOnBusCapability, SubmessageInMessageCapability, SignalInMessageCapability, oaam_capabilities_CapabilityA, ResourceConsumption, oaam_capabilities_CapabilitiesContainerA, TaskOnDeviceCapability, SignalOnConnectionOrDeviceCapability, DeviceInLocationCapability, SubdeviceInDeviceCapability, ConnectionInDuctOrLocationCapability, Subcapabilities, oaam_capabilities_DeviceInLocationCapability, oaam_capabilities_ConnectionInDuctOrLocationCapability, MessageOnConnectionOrDeviceCapability, oaam_capabilities_TaskOnDeviceCapability, capabilities_CapabilityA, oaam_capabilities_SubdeviceInDeviceCapability, oaam_capabilities_SignalOnConnectionOrDeviceCapability, oaam_capabilities_MessageOnConnectionOrDeviceCapability, oaam_capabilities_SubconnectionInDeviceCapability, oaam_capabilities_ResourceConsumption, oaam_capabilities_MessageOnBusCapability, oaam_capabilities_Capabilities, CapabilitiesContainerA, oaam_capabilities_Subcapabilities, capabilities_CapabilitiesContainerA, oaam_capabilities_SubmessageInMessageCapability, oaam_capabilities_SignalInMessageCapability, TaskAtomicRestriction, TaskSymmetryRestriction, SynchronicityRestriction, oaam_restrictions_RestrictionsContainerA, DeviceTypeRestriction, DeviceRestriction, LocationRestriction, AreaRestriction, PowerSourceRestriction, oaam_restrictions_ConnectionRestrinctionA, oaam_restrictions_TaskRestrictionA, oaam_restrictions_SignalRestrictionA, ConnectionRestriction, ConnectionTypeRestriction, SegregationRestriction, Subrestrictions, TimeDelayRestriction, oaam_restrictions_Restrictions, RestrictionsContainerA, oaam_restrictions_DeviceRestrictionA, oaam_restrictions_AreaRestriction, oaam_restrictions_SubfunctionRestrictionA, oaam_restrictions_TaskGroupRestrictionA, oaam_restrictions_SignalGroupRestrictionA, oaam_restrictions_LocationRestriction, restrictions_TaskRestrictionA, restrictions_TaskGroupRestrictionA, restrictions_SignalRestrictionA, restrictions_SignalGroupRestrictionA, restrictions_SubfunctionRestrictionA, restrictions_DeviceRestrictionA, restrictions_ConnectionRestrinctionA, oaam_restrictions_DeviceRestriction, oaam_restrictions_PowerSourceRestriction, oaam_restrictions_ConnectionTypeRestriction, oaam_restrictions_ConnectionRestriction, oaam_restrictions_DeviceTypeRestriction, oaam_restrictions_SegregationRestriction, oaam_restrictions_SynchronicityRestriction, oaam_restrictions_TaskAtomicRestriction, oaam_restrictions_Subrestrictions, restrictions_RestrictionsContainerA, oaam_restrictions_TaskSymmetryRestriction, oaam_restrictions_TimeDelayRestriction, ConnectionAssignment, TaskAssignment, SignalAssignment, Suballocations, oaam_allocations_AllocationsContainerA, DeviceAssignment, SubdeviceAssignment, Schedule, oaam_allocations_SignalAssignment, SignalAssignmentSegment, SubconnectionAssignment, Message, oaam_allocations_TaskAssignment, oaam_allocations_DeviceAssignment, oaam_allocations_ConnectionAssignment, ConnectionAssignmentSegment, oaam_allocations_SignalAssignmentSegment, oaam_allocations_SubdeviceAssignment, oaam_allocations_ConnectionAssignmentSegment, ScheduledTime, oaam_allocations_ScheduledTime, oaam_allocations_MessageA, oaam_allocations_SubconnectionAssignment, oaam_allocations_Schedule, oaam_allocations_MessageSegment, oaam_allocations_Message, MessageA, Submessage, SignalToMessageAssignment, MessageSegment, oaam_allocations_Allocations, AllocationsContainerA, oaam_allocations_Suballocations, allocations_AllocationsContainerA, oaam_allocations_Submessage, oaam_allocations_SignalToMessageAssignment, BoolOperationTypesE, IntegretyStateE, EndianessE, IoDirectionE, AttributeTypesE, AttributeTargetsE, SymmetryTypesE},
    associations={scenario4, systems6, include1, library2, functions8, hardware10, anatomy12, capabilities14, restrictions16, allocations18, value21, attributes20, value22, left24, right25, in_28, type30, fields31, inheritsFrom33, requiredResources35, consumedGroups36, dataTypes47, providedBundles38, possibleResourceProvisions39, providedGroups41, resourceLinks44, requiredModifiers46, signalTypes63, deviceTypes65, resourceTypes49, resourceBundles52, resourceModifiers55, resourceTypeDissimilarities57, taskTypes59, taskTypeDissimilarity61, ductTypes77, genericAttributes79, powerSources81, deviceTypeSymmetries67, deviceTypeDissimilarities69, connectionTypes71, wireTypes73, locationTypes75, propagetedResources91, sublibraries83, ioTypes85, hardwareGroupTypes87, messageTypes89, resources104, allowedModifiers93, alternatives95, type97, modifiers99, resources102, ioDeclarations115, outputDeclarations106, inputDeclarations107, stateDeclarations109, parameterDeclarations111, type113, startingPointResourceTypes120, endPointResourceTypes123, ioGroups116, wireTypes118, ductOpeningDeclarations132, switchTypes126, messageType129, type133, resources141, type143, resources146, trigger135, type136, faultPropagations139, booleanOperations154, booleanNots156, taskInputStates158, deviceTypes148, ios150, condition152, equalAlternatives169, betterAlternative171, type174, input160, in_162, out164, levels167, condition185, booleanOperations187, booleanNots190, allowedLevels176, tasks179, devices181, resourceTypes183, deviceTypes201, connectionTypes203, messagetypes206, taskInputTriggers193, input195, type197, type199, operationModes214, variants215, parameters216, headerDefinition209, trailerDefinition211, operationMode224, variants217, operationModes220, subscenarios222, providedOutputs233, systems226, informationFlows227, inputSegregations229, subsystems231, requiredInputs234, from_236, to238, taskGroups249, taskSymmetries251, taskRedundancies253, signals255, groupA241, groupB243, tasks246, taskLinks247, deviceBinding272, parameters274, signalGroups257, failureConditions259, subfunctions261, type263, inputs265, outputs267, implements269, tasks289, tasks291, condition293, type276, inputs278, outputs281, task284, tasks287, source305, target307, type310, booleanOperations295, booleanNots298, outputIntegrityStates301, output303, ioBindings322, outputLink324, implements326, connectionBinding313, signals315, declaration317, implements319, definition336, devices338, declaration328, ioBindings331, output334, ios351, subdevices354, locationBinding357, powerSources359, subconnections362, deviceSymmetries340, connections342, subhardware345, buses347, type349, devices378, type380, type365, startingPoints367, endPoints370, masters373, declaration376, subanatomies396, areaSymmetries398, type400, connections382, devices385, locations388, locationSymmetries390, ducts392, areas394, type411, startingPoint413, endPoint416, position402, ductOpenings404, locations406, ducts408, locations424, areas426, relativPosition419, declaration421, subcapabilities438, subconnectionInDeviceCapabilities440, messageOnBusCapabilities442, submessageInMessageCapabilities444, signalInMessageCapabilities446, resourceConsumptions428, taskOnDeviceCapabilities429, signalOnConnectionOrDeviceCapabilities430, deviceInLocationCapabilities432, subdeviceInDeviceCapabilities434, connectionInDuctOrLocationCapabilities436, deviceType455, locationType457, messageOnConnectionOrDeviceCapabilities448, taskType450, deviceType452, subdeviceType476, targetDeviceType478, connectionType460, locationType462, ductType465, signalType468, deviceType470, connectionType473, busType491, messageType493, messageType496, subconnectionType481, targetDeviceType483, originalResource486, type488, messageType509, signalType511, deviceType498, connectionType501, messageType504, submessageType506, powerSourceRestrictions521, taskAtomicRestrictions523, taskSymmetryRestrictions525, synchronicityRestriction527, deviceTypeRestrictions514, deviceRestrictions515, locationRestrictions517, areaRestrictions519, devices539, connections541, tasks543, connectionRestrictions529, connectionTypeRestrictions531, segregationRestrictions533, subrestrictions535, timeDelayRestrictions537, locations553, signals545, subfunctions547, taskGroups549, signalGroups551, powerSources557, areas555, connectionTypes563, devices559, deviceTypes561, tasksB569, subfunctionsA572, subfunctionsB574, connections565, tasksA567, signalGroupsA592, devicesA595, devicesB598, connectionsA601, signalsA577, signalsB580, taskGroupsA583, taskGroupsB586, signalGroupsB589, connectionsB604, startTask607, endTask609, connectionAssignments615, taskAssignments617, signalAssignments619, suballocations621, deviceAssignments612, subdeviceAssignments613, schedules635, segments637, subconnectionAssignments623, messages625, capability627, task629, device632, connection650, schedules653, device656, signal638, segments641, connection642, capability645, device647, duct669, capability672, subdevice674, targetDevice677, location658, capability661, capability664, location666, scheduledTimes688, capability680, subconnection682, targetDevice685, capability700, device702, connection705, schedules689, submessages691, signalToMessageAssignments693, segments695, type697, operationModes729, dataType732, capability735, capability708, bus710, sourceDevices713, destinationDevices716, capability719, signal721, attributes723, variants726},
    generalizations={gen_oaam_Architecture_OaamBaseElementA, gen_oaam_common_AttributeContainment_AttributeA, gen_oaam_common_AttributeA_OaamBaseElementA, gen_oaam_common_AttributeString_AttributeA, gen_oaam_common_AttributeNumeric_AttributeA, gen_oaam_common_AttributeReference_AttributeA, gen_oaam_common_BoolOperation_common_BoolA, gen_oaam_common_BoolOperation_common_OaamBaseElementA, gen_oaam_common_BoolNot_common_BoolA, gen_oaam_common_BoolNot_common_OaamBaseElementA, gen_oaam_common_DataTypeA_OaamBaseElementA, gen_oaam_common_Integer_DataTypeA, gen_oaam_common_Character_DataTypeA, gen_oaam_common_Array_DataTypeA, gen_oaam_common_Struct_DataTypeA, gen_oaam_common_FloatingPoint_DataTypeA, gen_oaam_common_Byte_DataTypeA, gen_oaam_common_Boolean_DataTypeA, gen_oaam_library_LibraryContainerA_OaamBaseElementA, gen_oaam_library_ResourceType_library_ResourceConsumerA, gen_oaam_library_ResourceType_common_OaamBaseElementA, gen_oaam_library_ResourceBundle_library_ResourceConsumerA, gen_oaam_library_ResourceBundle_common_OaamBaseElementA, gen_oaam_library_TaskType_library_ResourceConsumerA, gen_oaam_library_TaskType_common_OaamBaseElementA, gen_oaam_library_Resource_OaamBaseElementA, gen_oaam_library_ResourceAlternatives_OaamBaseElementA, gen_oaam_library_DeviceType_library_ResourceConsumerA, gen_oaam_library_DeviceType_library_ResourceProviderA, gen_oaam_library_DeviceType_common_OaamBaseElementA, gen_oaam_library_SignalType_library_ResourceConsumerA, gen_oaam_library_SignalType_common_OaamBaseElementA, gen_oaam_library_ConnectionType_library_ResourceProviderA, gen_oaam_library_ConnectionType_library_ResourceConsumerA, gen_oaam_library_ConnectionType_common_OaamBaseElementA, gen_oaam_library_LocationType_common_OaamBaseElementA, gen_oaam_library_DuctType_library_ResourceProviderA, gen_oaam_library_DuctType_common_OaamBaseElementA, gen_oaam_library_WireType_OaamBaseElementA, gen_oaam_library_LocationType_library_ResourceProviderA, gen_oaam_library_OutputDeclaration_OaamBaseElementA, gen_oaam_library_IoType_OaamBaseElementA, gen_oaam_library_InputDeclaration_OaamBaseElementA, gen_oaam_library_DuctOpeningDeclaration_OaamBaseElementA, gen_oaam_library_ResourceGroup_OaamBaseElementA, gen_oaam_library_DeviceTypeSymmetry_OaamBaseElementA, gen_oaam_library_IoDeclaration_OaamBaseElementA, gen_oaam_library_TaskInputState_common_BoolA, gen_oaam_library_TaskInputState_common_OaamBaseElementA, gen_oaam_library_IoGroup_OaamBaseElementA, gen_oaam_library_AttributeDefinition_OaamBaseElementA, gen_oaam_library_FaultPropagation_OaamBaseElementA, gen_oaam_library_ResourceTypeModifierReference_OaamBaseElementA, gen_oaam_library_PowerSource_OaamBaseElementA, gen_oaam_library_ResourceLink_OaamBaseElementA, gen_oaam_library_ResourceTypeModifier_OaamBaseElementA, gen_oaam_library_ResourceTypeModifierLevel_common_OaamBaseElementA, gen_oaam_library_ResourceTypeModifierLevel_library_ResourceConsumerA, gen_oaam_library_TaskOutputTrigger_OaamBaseElementA, gen_oaam_library_TaskTypeDissimilarity_OaamBaseElementA, gen_oaam_library_DeviceTypeDissimilarity_OaamBaseElementA, gen_oaam_library_ResourceTypeDissimilarity_OaamBaseElementA, gen_oaam_library_MessageType_common_OaamBaseElementA, gen_oaam_library_TaskInputTrigger_common_BoolA, gen_oaam_library_TaskInputTrigger_common_OaamBaseElementA, gen_oaam_library_TaskStateDeclaration_OaamBaseElementA, gen_oaam_library_TaskParameterDeclaration_OaamBaseElementA, gen_oaam_library_BusType_library_ResourceProviderA, gen_oaam_library_BusType_common_OaamBaseElementA, gen_oaam_scenario_ScenarioContainerA_OaamBaseElementA, gen_oaam_library_MessageType_library_ResourceConsumerA, gen_oaam_library_MessageType_library_ResourceProviderA, gen_oaam_library_Library_LibraryContainerA, gen_oaam_library_Sublibrary_LibraryContainerA, gen_oaam_scenario_ScenarioParameterA_scenario_ModeDependentElementA, gen_oaam_scenario_ScenarioParameterA_scenario_VariantDependentElementA, gen_oaam_scenario_ScenarioParameterBool_scenario_ScenarioParameterA, gen_oaam_scenario_ScenarioParameterBool_common_OaamBaseElementA, gen_oaam_scenario_Variant_common_OaamBaseElementA, gen_oaam_scenario_Variant_scenario_ModeDependentElementA, gen_oaam_scenario_OperationModeReference_OaamBaseElementA, gen_oaam_scenario_OperationMode_common_OaamBaseElementA, gen_oaam_scenario_OperationMode_scenario_VariantDependentElementA, gen_oaam_scenario_ScenarioParameterNumeric_scenario_ScenarioParameterA, gen_oaam_scenario_ScenarioParameterNumeric_common_OaamBaseElementA, gen_oaam_systems_Systems_SystemsContainerA, gen_oaam_systems_Subsystem_systems_SystemsContainerA, gen_oaam_systems_Subsystem_scenario_ModeDependentElementA, gen_oaam_systems_Subsystem_scenario_VariantDependentElementA, gen_oaam_systems_System_common_OaamBaseElementA, gen_oaam_systems_System_scenario_VariantDependentElementA, gen_oaam_systems_System_scenario_ModeDependentElementA, gen_oaam_scenario_Scenario_ScenarioContainerA, gen_oaam_scenario_Subscenario_ScenarioContainerA, gen_oaam_systems_SystemsContainerA_OaamBaseElementA, gen_oaam_systems_InformationMaterial_systems_ProvidedInformationA, gen_oaam_systems_InformationMaterial_systems_RequiredInformationA, gen_oaam_systems_InformationMaterial_common_OaamBaseElementA, gen_oaam_systems_InformationMaterial_scenario_ModeDependentElementA, gen_oaam_systems_InformationMaterial_scenario_VariantDependentElementA, gen_oaam_systems_InformationFlow_common_OaamBaseElementA, gen_oaam_systems_InformationFlow_scenario_ModeDependentElementA, gen_oaam_systems_InformationFlow_scenario_VariantDependentElementA, gen_oaam_systems_InformationSignal_systems_ProvidedInformationA, gen_oaam_systems_InformationSignal_systems_RequiredInformationA, gen_oaam_systems_InformationSignal_common_OaamBaseElementA, gen_oaam_systems_InformationSignal_scenario_ModeDependentElementA, gen_oaam_systems_InformationSignal_scenario_VariantDependentElementA, gen_oaam_systems_LinearPower_InformationPower, gen_oaam_systems_InputSegregation_OaamBaseElementA, gen_oaam_systems_InformationPower_systems_ProvidedInformationA, gen_oaam_systems_InformationPower_systems_RequiredInformationA, gen_oaam_systems_InformationPower_common_OaamBaseElementA, gen_oaam_systems_InformationPower_scenario_VariantDependentElementA, gen_oaam_systems_InformationPower_scenario_ModeDependentElementA, gen_oaam_systems_ElectricPower_InformationPower, gen_oaam_systems_HydraulicPower_InformationPower, gen_oaam_systems_RotaryPower_InformationPower, gen_oaam_functions_Functions_FunctionsContainerA, gen_oaam_functions_FunctionsContainerA_common_OaamBaseElementA, gen_oaam_functions_FunctionsContainerA_scenario_VariantDependentElementA, gen_oaam_functions_FunctionsContainerA_scenario_ModeDependentElementA, gen_oaam_functions_ExternalTaskLink_common_OaamBaseElementA, gen_oaam_functions_ExternalTaskLink_scenario_ModeDependentElementA, gen_oaam_functions_ExternalTaskLink_scenario_VariantDependentElementA, gen_oaam_functions_Task_common_OaamBaseElementA, gen_oaam_functions_Task_scenario_VariantDependentElementA, gen_oaam_functions_Task_scenario_ModeDependentElementA, gen_oaam_functions_TaskRedundancy_common_OaamBaseElementA, gen_oaam_functions_TaskRedundancy_scenario_ModeDependentElementA, gen_oaam_functions_TaskRedundancy_scenario_VariantDependentElementA, gen_oaam_functions_FailureCondition_common_OaamBaseElementA, gen_oaam_functions_FailureCondition_scenario_ModeDependentElementA, gen_oaam_functions_FailureCondition_scenario_VariantDependentElementA, gen_oaam_functions_TaskGroup_common_OaamBaseElementA, gen_oaam_functions_TaskGroup_scenario_ModeDependentElementA, gen_oaam_functions_TaskGroup_scenario_VariantDependentElementA, gen_oaam_functions_TaskSymmetry_common_OaamBaseElementA, gen_oaam_functions_TaskSymmetry_scenario_ModeDependentElementA, gen_oaam_functions_TaskSymmetry_scenario_VariantDependentElementA, gen_oaam_functions_Signal_common_OaamBaseElementA, gen_oaam_functions_Signal_scenario_VariantDependentElementA, gen_oaam_functions_Signal_scenario_ModeDependentElementA, gen_oaam_functions_OutputIntegrityState_common_BoolA, gen_oaam_functions_OutputIntegrityState_common_OaamBaseElementA, gen_oaam_functions_OutputIntegrityState_scenario_ModeDependentElementA, gen_oaam_functions_OutputIntegrityState_scenario_VariantDependentElementA, gen_oaam_functions_Output_common_OaamBaseElementA, gen_oaam_functions_Output_scenario_VariantDependentElementA, gen_oaam_functions_Output_scenario_ModeDependentElementA, gen_oaam_functions_SignalGroup_common_OaamBaseElementA, gen_oaam_functions_SignalGroup_scenario_ModeDependentElementA, gen_oaam_functions_SignalGroup_scenario_VariantDependentElementA, gen_oaam_functions_Input_common_OaamBaseElementA, gen_oaam_functions_Input_scenario_VariantDependentElementA, gen_oaam_functions_Input_scenario_ModeDependentElementA, gen_oaam_functions_TaskParameter_OaamBaseElementA, gen_oaam_hardware_HardwareContainerA_OaamBaseElementA, gen_oaam_functions_ExternalOutputLink_common_OaamBaseElementA, gen_oaam_functions_ExternalOutputLink_scenario_ModeDependentElementA, gen_oaam_functions_ExternalOutputLink_scenario_VariantDependentElementA, gen_oaam_functions_Subfunctions_FunctionsContainerA, gen_oaam_hardware_Connection_library_ResourceProviderInstanceA, gen_oaam_hardware_Device_library_ResourceProviderInstanceA, gen_oaam_hardware_Device_common_OaamBaseElementA, gen_oaam_hardware_Device_scenario_VariantDependentElementA, gen_oaam_hardware_Device_scenario_ModeDependentElementA, gen_oaam_hardware_Hardware_hardware_HardwareContainerA, gen_oaam_hardware_Hardware_scenario_VariantDependentElementA, gen_oaam_hardware_Hardware_scenario_ModeDependentElementA, gen_oaam_hardware_Subhardware_hardware_HardwareContainerA, gen_oaam_hardware_Subhardware_scenario_VariantDependentElementA, gen_oaam_hardware_Subhardware_scenario_ModeDependentElementA, gen_oaam_hardware_Bus_library_ResourceProviderInstanceA, gen_oaam_hardware_Bus_common_OaamBaseElementA, gen_oaam_hardware_Bus_scenario_VariantDependentElementA, gen_oaam_hardware_Bus_scenario_ModeDependentElementA, gen_oaam_hardware_Connection_common_OaamBaseElementA, gen_oaam_hardware_Connection_scenario_VariantDependentElementA, gen_oaam_hardware_Connection_scenario_ModeDependentElementA, gen_oaam_hardware_Io_common_OaamBaseElementA, gen_oaam_hardware_Io_scenario_VariantDependentElementA, gen_oaam_hardware_Io_scenario_ModeDependentElementA, gen_oaam_hardware_DeviceSymmetry_common_OaamBaseElementA, gen_oaam_hardware_DeviceSymmetry_scenario_VariantDependentElementA, gen_oaam_hardware_DeviceSymmetry_scenario_ModeDependentElementA, gen_oaam_anatomy_Location_library_ResourceProviderInstanceA, gen_oaam_anatomy_Location_common_OaamBaseElementA, gen_oaam_anatomy_Location_scenario_VariantDependentElementA, gen_oaam_anatomy_Location_scenario_ModeDependentElementA, gen_oaam_anatomy_AnatomyContainerA_OaamBaseElementA, gen_oaam_anatomy_DuctOpening_common_OaamBaseElementA, gen_oaam_anatomy_DuctOpening_scenario_VariantDependentElementA, gen_oaam_anatomy_Area_common_OaamBaseElementA, gen_oaam_anatomy_Area_scenario_VariantDependentElementA, gen_oaam_anatomy_Area_scenario_ModeDependentElementA, gen_oaam_anatomy_Duct_library_ResourceProviderInstanceA, gen_oaam_anatomy_Duct_common_OaamBaseElementA, gen_oaam_anatomy_Duct_scenario_VariantDependentElementA, gen_oaam_anatomy_Duct_scenario_ModeDependentElementA, gen_oaam_anatomy_AreaSymmetry_common_OaamBaseElementA, gen_oaam_anatomy_AreaSymmetry_scenario_ModeDependentElementA, gen_oaam_anatomy_AreaSymmetry_scenario_VariantDependentElementA, gen_oaam_anatomy_Subanatomy_anatomy_AnatomyContainerA, gen_oaam_anatomy_Subanatomy_scenario_VariantDependentElementA, gen_oaam_anatomy_Subanatomy_scenario_ModeDependentElementA, gen_oaam_anatomy_Anatomy_AnatomyContainerA, gen_oaam_anatomy_DuctOpening_scenario_ModeDependentElementA, gen_oaam_anatomy_Position3D_common_OaamBaseElementA, gen_oaam_anatomy_Position3D_scenario_VariantDependentElementA, gen_oaam_anatomy_Position3D_scenario_ModeDependentElementA, gen_oaam_anatomy_LocationSymmetry_common_OaamBaseElementA, gen_oaam_anatomy_LocationSymmetry_scenario_ModeDependentElementA, gen_oaam_anatomy_LocationSymmetry_scenario_VariantDependentElementA, gen_oaam_capabilities_CapabilitiesContainerA_OaamBaseElementA, gen_oaam_capabilities_DeviceInLocationCapability_capabilities_CapabilityA, gen_oaam_capabilities_DeviceInLocationCapability_common_OaamBaseElementA, gen_oaam_capabilities_DeviceInLocationCapability_scenario_VariantDependentElementA, gen_oaam_capabilities_DeviceInLocationCapability_scenario_ModeDependentElementA, gen_oaam_capabilities_ConnectionInDuctOrLocationCapability_capabilities_CapabilityA, gen_oaam_capabilities_ConnectionInDuctOrLocationCapability_common_OaamBaseElementA, gen_oaam_capabilities_ConnectionInDuctOrLocationCapability_scenario_VariantDependentElementA, gen_oaam_capabilities_TaskOnDeviceCapability_capabilities_CapabilityA, gen_oaam_capabilities_TaskOnDeviceCapability_common_OaamBaseElementA, gen_oaam_capabilities_TaskOnDeviceCapability_scenario_VariantDependentElementA, gen_oaam_capabilities_TaskOnDeviceCapability_scenario_ModeDependentElementA, gen_oaam_capabilities_SubdeviceInDeviceCapability_capabilities_CapabilityA, gen_oaam_capabilities_SubdeviceInDeviceCapability_common_OaamBaseElementA, gen_oaam_capabilities_SubdeviceInDeviceCapability_scenario_VariantDependentElementA, gen_oaam_capabilities_SubdeviceInDeviceCapability_scenario_ModeDependentElementA, gen_oaam_capabilities_ConnectionInDuctOrLocationCapability_scenario_ModeDependentElementA, gen_oaam_capabilities_SignalOnConnectionOrDeviceCapability_capabilities_CapabilityA, gen_oaam_capabilities_SignalOnConnectionOrDeviceCapability_common_OaamBaseElementA, gen_oaam_capabilities_SignalOnConnectionOrDeviceCapability_scenario_VariantDependentElementA, gen_oaam_capabilities_SignalOnConnectionOrDeviceCapability_scenario_ModeDependentElementA, gen_oaam_capabilities_MessageOnBusCapability_scenario_VariantDependentElementA, gen_oaam_capabilities_MessageOnBusCapability_scenario_ModeDependentElementA, gen_oaam_capabilities_MessageOnConnectionOrDeviceCapability_capabilities_CapabilityA, gen_oaam_capabilities_MessageOnConnectionOrDeviceCapability_common_OaamBaseElementA, gen_oaam_capabilities_MessageOnConnectionOrDeviceCapability_scenario_VariantDependentElementA, gen_oaam_capabilities_MessageOnConnectionOrDeviceCapability_scenario_ModeDependentElementA, gen_oaam_capabilities_SubconnectionInDeviceCapability_capabilities_CapabilityA, gen_oaam_capabilities_SubconnectionInDeviceCapability_common_OaamBaseElementA, gen_oaam_capabilities_SubconnectionInDeviceCapability_scenario_VariantDependentElementA, gen_oaam_capabilities_SubconnectionInDeviceCapability_scenario_ModeDependentElementA, gen_oaam_capabilities_ResourceConsumption_OaamBaseElementA, gen_oaam_capabilities_MessageOnBusCapability_capabilities_CapabilityA, gen_oaam_capabilities_MessageOnBusCapability_common_OaamBaseElementA, gen_oaam_capabilities_SignalInMessageCapability_scenario_VariantDependentElementA, gen_oaam_capabilities_SignalInMessageCapability_scenario_ModeDependentElementA, gen_oaam_capabilities_Capabilities_CapabilitiesContainerA, gen_oaam_capabilities_Subcapabilities_capabilities_CapabilitiesContainerA, gen_oaam_capabilities_Subcapabilities_scenario_ModeDependentElementA, gen_oaam_capabilities_Subcapabilities_scenario_VariantDependentElementA, gen_oaam_capabilities_SubmessageInMessageCapability_capabilities_CapabilityA, gen_oaam_capabilities_SubmessageInMessageCapability_common_OaamBaseElementA, gen_oaam_capabilities_SubmessageInMessageCapability_scenario_VariantDependentElementA, gen_oaam_capabilities_SubmessageInMessageCapability_scenario_ModeDependentElementA, gen_oaam_capabilities_SignalInMessageCapability_capabilities_CapabilityA, gen_oaam_capabilities_SignalInMessageCapability_common_OaamBaseElementA, gen_oaam_restrictions_RestrictionsContainerA_OaamBaseElementA, gen_oaam_restrictions_Restrictions_RestrictionsContainerA, gen_oaam_restrictions_LocationRestriction_scenario_VariantDependentElementA, gen_oaam_restrictions_LocationRestriction_scenario_ModeDependentElementA, gen_oaam_restrictions_AreaRestriction_restrictions_TaskRestrictionA, gen_oaam_restrictions_AreaRestriction_restrictions_TaskGroupRestrictionA, gen_oaam_restrictions_AreaRestriction_restrictions_SignalRestrictionA, gen_oaam_restrictions_AreaRestriction_restrictions_SignalGroupRestrictionA, gen_oaam_restrictions_AreaRestriction_restrictions_SubfunctionRestrictionA, gen_oaam_restrictions_LocationRestriction_restrictions_TaskRestrictionA, gen_oaam_restrictions_LocationRestriction_restrictions_TaskGroupRestrictionA, gen_oaam_restrictions_LocationRestriction_restrictions_SignalRestrictionA, gen_oaam_restrictions_LocationRestriction_restrictions_SignalGroupRestrictionA, gen_oaam_restrictions_LocationRestriction_restrictions_SubfunctionRestrictionA, gen_oaam_restrictions_LocationRestriction_restrictions_DeviceRestrictionA, gen_oaam_restrictions_LocationRestriction_restrictions_ConnectionRestrinctionA, gen_oaam_restrictions_LocationRestriction_common_OaamBaseElementA, gen_oaam_restrictions_DeviceRestriction_restrictions_TaskRestrictionA, gen_oaam_restrictions_DeviceRestriction_restrictions_TaskGroupRestrictionA, gen_oaam_restrictions_DeviceRestriction_restrictions_SignalRestrictionA, gen_oaam_restrictions_DeviceRestriction_restrictions_SignalGroupRestrictionA, gen_oaam_restrictions_DeviceRestriction_restrictions_SubfunctionRestrictionA, gen_oaam_restrictions_DeviceRestriction_common_OaamBaseElementA, gen_oaam_restrictions_DeviceRestriction_scenario_VariantDependentElementA, gen_oaam_restrictions_DeviceRestriction_scenario_ModeDependentElementA, gen_oaam_restrictions_AreaRestriction_restrictions_DeviceRestrictionA, gen_oaam_restrictions_AreaRestriction_restrictions_ConnectionRestrinctionA, gen_oaam_restrictions_AreaRestriction_common_OaamBaseElementA, gen_oaam_restrictions_AreaRestriction_scenario_VariantDependentElementA, gen_oaam_restrictions_AreaRestriction_scenario_ModeDependentElementA, gen_oaam_restrictions_PowerSourceRestriction_restrictions_TaskRestrictionA, gen_oaam_restrictions_PowerSourceRestriction_restrictions_TaskGroupRestrictionA, gen_oaam_restrictions_PowerSourceRestriction_restrictions_SignalRestrictionA, gen_oaam_restrictions_PowerSourceRestriction_restrictions_SignalGroupRestrictionA, gen_oaam_restrictions_PowerSourceRestriction_restrictions_SubfunctionRestrictionA, gen_oaam_restrictions_PowerSourceRestriction_restrictions_DeviceRestrictionA, gen_oaam_restrictions_PowerSourceRestriction_common_OaamBaseElementA, gen_oaam_restrictions_PowerSourceRestriction_scenario_VariantDependentElementA, gen_oaam_restrictions_PowerSourceRestriction_scenario_ModeDependentElementA, gen_oaam_restrictions_ConnectionTypeRestriction_restrictions_SignalRestrictionA, gen_oaam_restrictions_ConnectionTypeRestriction_restrictions_SignalGroupRestrictionA, gen_oaam_restrictions_ConnectionTypeRestriction_restrictions_SubfunctionRestrictionA, gen_oaam_restrictions_ConnectionTypeRestriction_common_OaamBaseElementA, gen_oaam_restrictions_ConnectionTypeRestriction_scenario_VariantDependentElementA, gen_oaam_restrictions_ConnectionTypeRestriction_scenario_ModeDependentElementA, gen_oaam_restrictions_ConnectionRestriction_restrictions_SignalRestrictionA, gen_oaam_restrictions_ConnectionRestriction_restrictions_SignalGroupRestrictionA, gen_oaam_restrictions_DeviceTypeRestriction_restrictions_TaskRestrictionA, gen_oaam_restrictions_DeviceTypeRestriction_restrictions_TaskGroupRestrictionA, gen_oaam_restrictions_DeviceTypeRestriction_restrictions_SignalRestrictionA, gen_oaam_restrictions_DeviceTypeRestriction_restrictions_SignalGroupRestrictionA, gen_oaam_restrictions_DeviceTypeRestriction_restrictions_SubfunctionRestrictionA, gen_oaam_restrictions_DeviceTypeRestriction_common_OaamBaseElementA, gen_oaam_restrictions_DeviceTypeRestriction_scenario_VariantDependentElementA, gen_oaam_restrictions_DeviceTypeRestriction_scenario_ModeDependentElementA, gen_oaam_restrictions_ConnectionRestriction_restrictions_SubfunctionRestrictionA, gen_oaam_restrictions_ConnectionRestriction_common_OaamBaseElementA, gen_oaam_restrictions_ConnectionRestriction_scenario_VariantDependentElementA, gen_oaam_restrictions_ConnectionRestriction_scenario_ModeDependentElementA, gen_oaam_restrictions_SegregationRestriction_common_OaamBaseElementA, gen_oaam_restrictions_SegregationRestriction_scenario_ModeDependentElementA, gen_oaam_restrictions_SegregationRestriction_scenario_VariantDependentElementA, gen_oaam_restrictions_SynchronicityRestriction_common_OaamBaseElementA, gen_oaam_restrictions_SynchronicityRestriction_scenario_ModeDependentElementA, gen_oaam_restrictions_SynchronicityRestriction_scenario_VariantDependentElementA, gen_oaam_restrictions_SynchronicityRestriction_restrictions_TaskRestrictionA, gen_oaam_restrictions_TaskAtomicRestriction_restrictions_TaskRestrictionA, gen_oaam_restrictions_TaskAtomicRestriction_restrictions_TaskGroupRestrictionA, gen_oaam_restrictions_TaskAtomicRestriction_restrictions_SubfunctionRestrictionA, gen_oaam_restrictions_TaskAtomicRestriction_common_OaamBaseElementA, gen_oaam_restrictions_TaskAtomicRestriction_scenario_ModeDependentElementA, gen_oaam_restrictions_TaskAtomicRestriction_scenario_VariantDependentElementA, gen_oaam_restrictions_Subrestrictions_restrictions_RestrictionsContainerA, gen_oaam_restrictions_Subrestrictions_scenario_VariantDependentElementA, gen_oaam_restrictions_Subrestrictions_scenario_ModeDependentElementA, gen_oaam_restrictions_TaskSymmetryRestriction_restrictions_TaskRestrictionA, gen_oaam_restrictions_TaskSymmetryRestriction_restrictions_TaskGroupRestrictionA, gen_oaam_restrictions_TaskSymmetryRestriction_restrictions_SubfunctionRestrictionA, gen_oaam_restrictions_TaskSymmetryRestriction_common_OaamBaseElementA, gen_oaam_restrictions_TaskSymmetryRestriction_scenario_ModeDependentElementA, gen_oaam_restrictions_TaskSymmetryRestriction_scenario_VariantDependentElementA, gen_oaam_restrictions_TimeDelayRestriction_common_OaamBaseElementA, gen_oaam_restrictions_TimeDelayRestriction_scenario_ModeDependentElementA, gen_oaam_restrictions_TimeDelayRestriction_scenario_VariantDependentElementA, gen_oaam_allocations_AllocationsContainerA_OaamBaseElementA, gen_oaam_allocations_SignalAssignment_common_OaamBaseElementA, gen_oaam_allocations_SignalAssignment_scenario_VariantDependentElementA, gen_oaam_allocations_SignalAssignment_scenario_ModeDependentElementA, gen_oaam_allocations_TaskAssignment_common_OaamBaseElementA, gen_oaam_allocations_TaskAssignment_scenario_VariantDependentElementA, gen_oaam_allocations_TaskAssignment_scenario_ModeDependentElementA, gen_oaam_allocations_DeviceAssignment_common_OaamBaseElementA, gen_oaam_allocations_DeviceAssignment_scenario_VariantDependentElementA, gen_oaam_allocations_DeviceAssignment_scenario_ModeDependentElementA, gen_oaam_allocations_ConnectionAssignment_common_OaamBaseElementA, gen_oaam_allocations_ConnectionAssignment_scenario_VariantDependentElementA, gen_oaam_allocations_ConnectionAssignment_scenario_ModeDependentElementA, gen_oaam_allocations_SignalAssignmentSegment_common_OaamBaseElementA, gen_oaam_allocations_SignalAssignmentSegment_scenario_VariantDependentElementA, gen_oaam_allocations_SignalAssignmentSegment_scenario_ModeDependentElementA, gen_oaam_allocations_SubdeviceAssignment_common_OaamBaseElementA, gen_oaam_allocations_SubdeviceAssignment_scenario_VariantDependentElementA, gen_oaam_allocations_SubdeviceAssignment_scenario_ModeDependentElementA, gen_oaam_allocations_ConnectionAssignmentSegment_common_OaamBaseElementA, gen_oaam_allocations_ConnectionAssignmentSegment_scenario_VariantDependentElementA, gen_oaam_allocations_ConnectionAssignmentSegment_scenario_ModeDependentElementA, gen_oaam_allocations_ScheduledTime_common_OaamBaseElementA, gen_oaam_allocations_ScheduledTime_scenario_ModeDependentElementA, gen_oaam_allocations_ScheduledTime_scenario_VariantDependentElementA, gen_oaam_allocations_MessageA_common_OaamBaseElementA, gen_oaam_allocations_MessageA_scenario_VariantDependentElementA, gen_oaam_allocations_MessageA_scenario_ModeDependentElementA, gen_oaam_allocations_SubconnectionAssignment_common_OaamBaseElementA, gen_oaam_allocations_SubconnectionAssignment_scenario_VariantDependentElementA, gen_oaam_allocations_SubconnectionAssignment_scenario_ModeDependentElementA, gen_oaam_allocations_Schedule_common_OaamBaseElementA, gen_oaam_allocations_Schedule_scenario_ModeDependentElementA, gen_oaam_allocations_Schedule_scenario_VariantDependentElementA, gen_oaam_allocations_MessageSegment_common_OaamBaseElementA, gen_oaam_allocations_MessageSegment_scenario_VariantDependentElementA, gen_oaam_allocations_MessageSegment_scenario_ModeDependentElementA, gen_oaam_allocations_Message_MessageA, gen_oaam_allocations_Allocations_AllocationsContainerA, gen_oaam_allocations_Suballocations_allocations_AllocationsContainerA, gen_oaam_allocations_Suballocations_scenario_ModeDependentElementA, gen_oaam_allocations_Suballocations_scenario_VariantDependentElementA, gen_oaam_allocations_Submessage_MessageA},
    metadata=None
)
