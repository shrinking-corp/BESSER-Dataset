...
public class oaam_capabilities_MessageOnConnectionOrDeviceCapability extends common_OaamBaseElementA, capabilities_CapabilityA, scenario_ModeDependentElementA, scenario_VariantDependentElementA {

    private float worstCaseTransmissionTime;



    public oaam_capabilities_MessageOnConnectionOrDeviceCapability(
