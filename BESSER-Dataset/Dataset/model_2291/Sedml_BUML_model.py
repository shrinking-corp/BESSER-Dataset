...
# Classes
sedml_uniformTimeCourse = Class(name="sedml_uniformTimeCourse")
sedml_sedML = Class(name="sedml_sedML")
sedml_listOfSimulations = Class(name="sedml_listOfSimulations")
sedml_listOfModels = Class(name="sedml_listOfModels")
sedml_listOfTasks = Class(name="sedml_listOfTasks")
sedml_listOfDataGenerators = Class(name="sedml_listOfDataGenerators")
sedml_listOfOutputs = Class(name="sedml_listOfOutputs")
sedml_model = Class(name="sedml_model")
sedml_task = Class(name="sedml_task")
sedml_dataGenerator = Class(name="sedml_dataGenerator")
sedml_plot2D = Class(name="sedml_plot2D")
sedml_algorithm = Class(name="sedml_algorithm")
sedml_listOfCurves = Class(name="sedml_listOfCurves")
sedml_curve = Class(name="sedml_curve")
sedml_listOfVariables = Class(name="sedml_listOfVariables")
sedml_math = Class(name="sedml_math")
sedml_variable = Class(name="sedml_variable")
...
sedml_uniformTimeCourse.attributes={sedml_uniformTimeCourse_id, sedml_uniformTimeCourse_initialTime, sedml_uniformTimeCourse_outputEndTime, sedml_uniformTimeCourse_outputStartTime, sedml_uniformTimeCourse_numberOfPoints}
...
sedml_model.attributes={sedml_model_id, sedml_model_language, sedml_model_source, sedml_model_name}
...
sedml_curve.attributes={sedml_curve_yDataReference, sedml_curve_id, sedml_curve_logX, sedml_curve_xDataReference, sedml_curve_logY}
...
sedml_variable.attributes={sedml_variable_target, sedml_variable_symbol, sedml_variable_id}
...
domain_model = DomainModel(
    name="sedml",
    types={sedml_uniformTimeCourse, sedml_sedML, sedml_listOfSimulations, sedml_listOfModels, sedml_listOfTasks, sedml_listOfDataGenerators, sedml_listOfOutputs, sedml_model, sedml_task, sedml_dataGenerator, sedml_plot2D, sedml_algorithm, sedml_listOfCurves, sedml_curve, sedml_listOfVariables, sedml_math, sedml_variable},
    associations={uniformTimeCourse9, listOfSimulations0, listOfModels1, listOfTasks3, listOfDataGenerators5, listOfOutputs7, model11, task13, dataGenerator15, plot2D17, algorithm19, modelReference21, simulationReference24, listOfCurves27, curve29, listOfVariables31, math33, variable35, taskReference37},
    generalizations={},
    metadata=None
)
