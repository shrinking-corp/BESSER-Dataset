...
class sedml_task:
    ...
    def __init__(self, id: str, name: str, sedml_task: "sedml_listOfTasks" = None, sedml_task22: "sedml_model" = None, sedml_task25: "sedml_uniformTimeCourse" = None, sedml_task39: "sedml_variable" = None):
        self.id = id
        self.name = name
...
class sedml_sedML:
    ...
    def __init__(self, version: int, level: int, sedml_sedML: "sedml_listOfSimulations" = None, sedml_sedML2: "sedml_listOfModels" = None, sedml_sedML4: "sedml_listOfTasks" = None, sedml_sedML6: "sedml_listOfDataGenerators" = None, sedml_sedML8: "sedml_listOfOutputs" = None):
...
class sedml_uniformTimeCourse:
    ...
    def __init__(self, id: str, initialTime: int, outputStartTime: int, outputEndTime: int, numberOfPoints: int, sedml_uniformTimeCourse: "sedml_listOfSimulations" = None, sedml_uniformTimeCourse20: "sedml_algorithm" = None, sedml_uniformTimeCourse26: "sedml_task" = None):
        self.id = id
