...
# Classes
dom_ComplexType = Class(name="dom_ComplexType", is_abstract=True)
ModelElement = Class(name="ModelElement")
Type = Class(name="Type")
dom_Attribute = Class(name="dom_Attribute")
dom_Property = Class(name="dom_Property")
...
dom_Parameter = Class(name="dom_Parameter")
dom_Service = Class(name="dom_Service")
Dependant = Class(name="Dependant")
dom_Dependant = Class(name="dom_Dependant", is_abstract=True)
dom_Operation = Class(name="dom_Operation")
dom_DelegateOperation = Class(name="dom_DelegateOperation")
dom_Dao = Class(name="dom_Dao")
dom_DaoOperation = Class(name="dom_DaoOperation")
dom_Expression = Class(name="dom_Expression")
QueryParameter = Class(name="QueryParameter")
QueryParameterReference = Class(name="QueryParameterReference")
dom_Type = Class(name="dom_Type")
dom_DataView = Class(name="dom_DataView")
dom_AttributeProperty = Class(name="dom_AttributeProperty")
dom_Mapper = Class(name="dom_Mapper")
dom_ValueObject = Class(name="dom_ValueObject")
ComplexType = Class(name="ComplexType")
dom_FeatureReference = Class(name="dom_FeatureReference")
PresentableFeature = Class(name="PresentableFeature")
dom_Entity = Class(name="dom_Entity")
dom_AttributeGroup = Class(name="dom_AttributeGroup")
dom_ConditionsBlock = Class(name="dom_ConditionsBlock")
dom_PropertyMapping = Class(name="dom_PropertyMapping")
dom_DataTypeAndTypeParameter = Class(name="dom_DataTypeAndTypeParameter")
dom_IncrementerReference = Class(name="dom_IncrementerReference")
dom_AttributeFlag = Class(name="dom_AttributeFlag")
AttributeProperty = Class(name="AttributeProperty")
dom_ExpressionFlag = Class(name="dom_ExpressionFlag")
AttributeFlag = Class(name="AttributeFlag")
dom_EqualityExpr = Class(name="dom_EqualityExpr")
dom_RequiredFlag = Class(name="dom_RequiredFlag")
ExpressionFlag = Class(name="ExpressionFlag")
dom_ReadOnlyFlag = Class(name="dom_ReadOnlyFlag")
dom_AvailableFlag = Class(name="dom_AvailableFlag")
dom_DerivedFlag = Class(name="dom_DerivedFlag")
dom_BoolLiteral = Class(name="dom_BoolLiteral")
dom_TransientFlag = Class(name="dom_TransientFlag")
dom_AttributeValidationProperty = Class(name="dom_AttributeValidationProperty")
dom_Constraint = Class(name="dom_Constraint")
dom_ValidatorReference = Class(name="dom_ValidatorReference")
dom_AttributeSortOrder = Class(name="dom_AttributeSortOrder")
dom_DaoFeature = Class(name="dom_DaoFeature", is_abstract=True)
dom_QueryOperation = Class(name="dom_QueryOperation")
dom_AttributeTextProperty = Class(name="dom_AttributeTextProperty")
dom_OneToMany = Class(name="dom_OneToMany")
dom_ManyToMany = Class(name="dom_ManyToMany")
dom_QueryParameter = Class(name="dom_QueryParameter")
dom_QlStatement = Class(name="dom_QlStatement")
dom_DataBaseConstraint = Class(name="dom_DataBaseConstraint")
dom_Column = Class(name="dom_Column")
dom_ManyToOne = Class(name="dom_ManyToOne")
dom_OneToOne = Class(name="dom_OneToOne")
dom_SqlType = Class(name="dom_SqlType")
DaoFeature = Class(name="DaoFeature")
dom_ApplicationSession = Class(name="dom_ApplicationSession")
dom_Function = Class(name="dom_Function")
dom_CallableStatement = Class(name="dom_CallableStatement")
QlStatement = Class(name="QlStatement")
dom_CallInputParameter = Class(name="dom_CallInputParameter")
dom_CallOutputParameter = Class(name="dom_CallOutputParameter")
dom_SelectStatement = Class(name="dom_SelectStatement")
dom_DeleteStatement = Class(name="dom_DeleteStatement")
dom_UpdateStatement = Class(name="dom_UpdateStatement")
dom_InsertStatement = Class(name="dom_InsertStatement")
dom_FromRange = Class(name="dom_FromRange")
dom_Join = Class(name="dom_Join")
dom_SortOrderElement = Class(name="dom_SortOrderElement")
dom_SelectProperties = Class(name="dom_SelectProperties")
SelectStatement = Class(name="SelectStatement")
dom_SelectClass = Class(name="dom_SelectClass")
dom_SelectObject = Class(name="dom_SelectObject")
dom_PropertyAssignment = Class(name="dom_PropertyAssignment")
dom_PropertyValue = Class(name="dom_PropertyValue")
dom_InCollectionElements = Class(name="dom_InCollectionElements")
dom_JoinEntity = Class(name="dom_JoinEntity")
Expression = Class(name="Expression")
dom_FunctionCall = Class(name="dom_FunctionCall")
dom_FromClass = Class(name="dom_FromClass")
FromRange = Class(name="FromRange")
JoinEntity = Class(name="JoinEntity")
dom_InClass = Class(name="dom_InClass")
dom_InCollection = Class(name="dom_InCollection")
dom_CastFunction = Class(name="dom_CastFunction")
dom_AggregateFunction = Class(name="dom_AggregateFunction")
dom_CollectionFunction = Class(name="dom_CollectionFunction")
dom_QueryParameterReference = Class(name="dom_QueryParameterReference")
dom_QueryParameterValue = Class(name="dom_QueryParameterValue")
dom_QuantifiedExpression = Class(name="dom_QuantifiedExpression")
dom_CaseExpression = Class(name="dom_CaseExpression")
dom_TrimFunction = Class(name="dom_TrimFunction")
dom_StringLiteralValue = Class(name="dom_StringLiteralValue")
dom_AltWhenClause = Class(name="dom_AltWhenClause")
dom_SubQuery = Class(name="dom_SubQuery")
dom_ParenthesizedExpression = Class(name="dom_ParenthesizedExpression")
dom_LiteralValue = Class(name="dom_LiteralValue")
LiteralValue = Class(name="LiteralValue")
dom_WhenClause = Class(name="dom_WhenClause")
dom_NullLiteralValue = Class(name="dom_NullLiteralValue")
dom_EmptyLiteralValue = Class(name="dom_EmptyLiteralValue")
dom_IElementWithNoName = Class(name="dom_IElementWithNoName")
dom_PresentableFeature = Class(name="dom_PresentableFeature", is_abstract=True)
dom_AliasedExpression = Class(name="dom_AliasedExpression")
dom_BinaryExpression = Class(name="dom_BinaryExpression")
dom_NotExpression = Class(name="dom_NotExpression")
dom_InExpression = Class(name="dom_InExpression")
dom_IntegerLiteralValue = Class(name="dom_IntegerLiteralValue")
dom_RealLiteralValue = Class(name="dom_RealLiteralValue")
dom_BooleanLiteralValue = Class(name="dom_BooleanLiteralValue")
dom_LikeExpression = Class(name="dom_LikeExpression")
dom_MemberOfExpression = Class(name="dom_MemberOfExpression")
dom_UnaryExpression = Class(name="dom_UnaryExpression")
dom_BetweenExpression = Class(name="dom_BetweenExpression")
...
dom_Attribute.attributes={dom_Attribute_dataTypeName, dom_Attribute_transient, dom_Attribute_derived, dom_Attribute_defaultValue, dom_Attribute_many, dom_Attribute_composition, dom_Attribute_reference, dom_Attribute_readOnly, dom_Attribute_required, dom_Attribute_version, dom_Attribute_identifier}
...
dom_Parameter.attributes={dom_Parameter_many, dom_Parameter_name}
...
dom_Dao.attributes={dom_Dao_qualifier, dom_Dao_tableName, dom_Dao_discriminator}
...
dom_DaoOperation.attributes={dom_DaoOperation_many, dom_DaoOperation_name}
...
dom_Mapper.attributes={dom_Mapper_toLeft, dom_Mapper_toRight, dom_Mapper_biDirectional}
...
dom_AttributeGroup.attributes={dom_AttributeGroup_filter, dom_AttributeGroup_unique, dom_AttributeGroup_name, dom_AttributeGroup_key, dom_AttributeGroup_sortorder}
...
dom_PropertyMapping.attributes={dom_PropertyMapping_biDirectional, dom_PropertyMapping_toRight, dom_PropertyMapping_toLeft}
...
dom_AttributeSortOrder.attributes={dom_AttributeSortOrder_desc, dom_AttributeSortOrder_asc}
...
dom_AttributeTextProperty.attributes={dom_AttributeTextProperty_unitText, dom_AttributeTextProperty_labelText, dom_AttributeTextProperty_hstoreColumn, dom_AttributeTextProperty_tooltipText}
...
dom_ManyToMany.attributes={dom_ManyToMany_columnName, dom_ManyToMany_tableName, dom_ManyToMany_inverse}
...
dom_DataBaseConstraint.attributes={dom_DataBaseConstraint_type, dom_DataBaseConstraint_name}
...
dom_CallableStatement.attributes={dom_CallableStatement_functionCall, dom_CallableStatement_name}
...
dom_SelectClass_class_: Property = Property(name="class_", type=StringType)
dom_SelectClass.attributes={dom_SelectClass_class_}
...
dom_PropertyValue.attributes={dom_PropertyValue_name, dom_PropertyValue_classProperty, dom_PropertyValue_segments}
...
dom_InClass_class_: Property = Property(name="class_", type=StringType)
dom_InClass.attributes={dom_InClass_class_, dom_InClass_name}
...
dom_InCollection.attributes={dom_InCollection_path, dom_InCollection_alias}
...
dom_AggregateFunction_from_: Property = Property(name="from_", type=StringType)
dom_AggregateFunction.attributes={dom_AggregateFunction_function, dom_AggregateFunction_all, dom_AggregateFunction_from_, dom_AggregateFunction_distinct}
...
dom_InExpression_not_: Property = Property(name="not_", type=BooleanType)
dom_InExpression_operator: Property = Property(name="operator", type=StringType)
dom_InExpression.attributes={dom_InExpression_operator, dom_InExpression_not_}
...
dom_LikeExpression_not_: Property = Property(name="not_", type=BooleanType)
dom_LikeExpression_operator: Property = Property(name="operator", type=StringType)
dom_LikeExpression.attributes={dom_LikeExpression_not_, dom_LikeExpression_operator}

# dom_MemberOfExpression class attributes and methods
dom_MemberOfExpression_not_: Property = Property(name="not_", type=BooleanType)
...
dom_MemberOfExpression.attributes={dom_MemberOfExpression_not_, dom_MemberOfExpression_memberOf, dom_MemberOfExpression_operator}
...
dom_BetweenExpression_not_: Property = Property(name="not_", type=BooleanType)
dom_BetweenExpression_operator: Property = Property(name="operator", type=StringType)
dom_BetweenExpression.attributes={dom_BetweenExpression_operator, dom_BetweenExpression_not_}
...
from_245: BinaryAssociation = BinaryAssociation(
    name="from_245",
    ends={
...
from_286: BinaryAssociation = BinaryAssociation(
    name="from_286",
    ends={
...
from_283: BinaryAssociation = BinaryAssociation(
    name="from_283",
    ends={
...
in_337: BinaryAssociation = BinaryAssociation(
    name="in_337",
    ends={
...
domain_model = DomainModel(
    name="dom",
    types={dom_ComplexType, ModelElement, Type, dom_Attribute, dom_Property, ReferenceableByXmadslVariable, IDocumentable, dom_SimpleType, DaoOperation, dom_Parameter, dom_Service, Dependant, dom_Dependant, dom_Operation, dom_DelegateOperation, dom_Dao, dom_DaoOperation, dom_Expression, QueryParameter, QueryParameterReference, dom_Type, dom_DataView, dom_AttributeProperty, dom_Mapper, dom_ValueObject, ComplexType, dom_FeatureReference, PresentableFeature, dom_Entity, dom_AttributeGroup, dom_ConditionsBlock, dom_PropertyMapping, dom_DataTypeAndTypeParameter, dom_IncrementerReference, dom_AttributeFlag, AttributeProperty, dom_ExpressionFlag, AttributeFlag, dom_EqualityExpr, dom_RequiredFlag, ExpressionFlag, dom_ReadOnlyFlag, dom_AvailableFlag, dom_DerivedFlag, dom_BoolLiteral, dom_TransientFlag, dom_AttributeValidationProperty, dom_Constraint, dom_ValidatorReference, dom_AttributeSortOrder, dom_DaoFeature, dom_QueryOperation, dom_AttributeTextProperty, dom_OneToMany, dom_ManyToMany, dom_QueryParameter, dom_QlStatement, dom_DataBaseConstraint, dom_Column, dom_ManyToOne, dom_OneToOne, dom_SqlType, DaoFeature, dom_ApplicationSession, dom_Function, dom_CallableStatement, QlStatement, dom_CallInputParameter, dom_CallOutputParameter, dom_SelectStatement, dom_DeleteStatement, dom_UpdateStatement, dom_InsertStatement, dom_FromRange, dom_Join, dom_SortOrderElement, dom_SelectProperties, SelectStatement, dom_SelectClass, dom_SelectObject, dom_PropertyAssignment, dom_PropertyValue, dom_InCollectionElements, dom_JoinEntity, Expression, dom_FunctionCall, dom_FromClass, FromRange, JoinEntity, dom_InClass, dom_InCollection, dom_CastFunction, dom_AggregateFunction, dom_CollectionFunction, dom_QueryParameterReference, dom_QueryParameterValue, dom_QuantifiedExpression, dom_CaseExpression, dom_TrimFunction, dom_StringLiteralValue, dom_AltWhenClause, dom_SubQuery, dom_ParenthesizedExpression, dom_LiteralValue, LiteralValue, dom_WhenClause, dom_NullLiteralValue, dom_EmptyLiteralValue, dom_IElementWithNoName, dom_PresentableFeature, dom_AliasedExpression, dom_BinaryExpression, dom_NotExpression, dom_InExpression, dom_IntegerLiteralValue, dom_RealLiteralValue, dom_BooleanLiteralValue, dom_LikeExpression, dom_MemberOfExpression, dom_UnaryExpression, dom_BetweenExpression, CrudOperationType, DataBaseConstraintType},
    associations={attributes0, allAttributes1, type9, parameters10, delegate12, dependencies4, operations5, delegateOperations7, repository19, operation21, viewParameter23, filter26, type28, type15, view17, source36, attribute38, view41, properties44, target46, left49, superType32, featureReferences34, right59, superType63, attributeGroups65, conditionsBlock67, repository69, key72, right51, propertyMappings54, left56, requiredReferences84, requiredAttributes87, type90, sortOrders75, identifier78, version81, opposite95, attributProperties97, sortOrder100, dataType103, incrementerReference92, expression112, expression113, expression114, constraints116, format117, oppositeReference107, resolvedAttributeList110, attributes121, resolvedAttributeList123, attribute126, attribute129, entity131, operations134, queryOperation137, unitAttribute119, oneToOneAssociations145, oneToManyAssociations147, manyToManyAssociations149, primaryKeyColumn151, naturalKeyColumns154, versionColumn157, primaryKey160, naturalKey163, queryParameters166, statement168, attribute170, dataBaseConstraints139, columns141, manyToOneAssociations143, userType182, sqlType185, columns187, columns190, attributes193, resolvedAttributeList196, userType173, columnType176, columns180, properties199, functions201, conditionsBlock203, inParameter206, outParameter207, parameter209, attribute212, attribute215, nestedAttribute218, expression223, selectStatement226, entity228, where230, entity233, entity221, from_245, join247, where249, groupBy252, having255, orderBy258, expression260, properties263, arguments265, assignment235, where237, property240, expression242, entity269, reference271, expression274, index277, entity267, from_286, aggregateExpression288, collection290, parameter292, attribute293, expression296, arguments280, character282, from_283, altWhenClause305, whenExpression307, thenExpression310, whenExpression313, thenExpression316, property319, queries322, expressions324, whenClause298, elseExpression299, expression302, expression326, left328, right330, expression333, expression335, left342, right345, expression348, like350, escape353, expression356, expression358, in_337, expression340},
    generalizations={gen_dom_ComplexType_ModelElement, gen_dom_ComplexType_Type, gen_dom_Property_ReferenceableByXmadslVariable, gen_dom_Property_IDocumentable, gen_dom_Operation_DaoOperation, gen_dom_Operation_IDocumentable, gen_dom_Service_ModelElement, gen_dom_Service_Dependant, gen_dom_Parameter_QueryParameter, gen_dom_Parameter_QueryParameterReference, gen_dom_DelegateOperation_IDocumentable, gen_dom_Mapper_ModelElement, gen_dom_ValueObject_ComplexType, gen_dom_DataView_ComplexType, gen_dom_FeatureReference_PresentableFeature, gen_dom_FeatureReference_IDocumentable, gen_dom_Entity_ComplexType, gen_dom_Entity_Dependant, gen_dom_Attribute_ReferenceableByXmadslVariable, gen_dom_Attribute_QueryParameterReference, gen_dom_Attribute_PresentableFeature, gen_dom_Attribute_IDocumentable, gen_dom_AttributeFlag_AttributeProperty, gen_dom_ExpressionFlag_AttributeFlag, gen_dom_RequiredFlag_ExpressionFlag, gen_dom_ReadOnlyFlag_ExpressionFlag, gen_dom_AvailableFlag_ExpressionFlag, gen_dom_DerivedFlag_AttributeFlag, gen_dom_TransientFlag_AttributeFlag, gen_dom_AttributeValidationProperty_AttributeProperty, gen_dom_Dao_ModelElement, gen_dom_Dao_Dependant, gen_dom_AttributeTextProperty_AttributeProperty, gen_dom_AttributeGroup_IDocumentable, gen_dom_QueryOperation_DaoOperation, gen_dom_QueryOperation_IDocumentable, gen_dom_ManyToOne_DaoFeature, gen_dom_OneToOne_DaoFeature, gen_dom_OneToMany_DaoFeature, gen_dom_ManyToMany_DaoFeature, gen_dom_Column_DaoFeature, gen_dom_ApplicationSession_ModelElement, gen_dom_CallableStatement_QlStatement, gen_dom_DeleteStatement_QlStatement, gen_dom_UpdateStatement_QlStatement, gen_dom_InsertStatement_QlStatement, gen_dom_SelectProperties_SelectStatement, gen_dom_SelectClass_SelectStatement, gen_dom_SelectObject_SelectStatement, gen_dom_SelectStatement_QlStatement, gen_dom_InCollectionElements_FromRange, gen_dom_Join_JoinEntity, gen_dom_PropertyValue_Expression, gen_dom_FunctionCall_Expression, gen_dom_FromClass_FromRange, gen_dom_FromClass_JoinEntity, gen_dom_InClass_FromRange, gen_dom_InCollection_FromRange, gen_dom_CastFunction_Expression, gen_dom_AggregateFunction_Expression, gen_dom_QueryParameterValue_Expression, gen_dom_QuantifiedExpression_Expression, gen_dom_TrimFunction_Expression, gen_dom_CollectionFunction_Expression, gen_dom_SubQuery_Expression, gen_dom_ParenthesizedExpression_Expression, gen_dom_LiteralValue_Expression, gen_dom_StringLiteralValue_LiteralValue, gen_dom_CaseExpression_Expression, gen_dom_NullLiteralValue_LiteralValue, gen_dom_EmptyLiteralValue_LiteralValue, gen_dom_IElementWithNoName_ReferenceableByXmadslVariable, gen_dom_IElementWithNoName_QueryParameterReference, gen_dom_AliasedExpression_Expression, gen_dom_BinaryExpression_Expression, gen_dom_NotExpression_Expression, gen_dom_InExpression_Expression, gen_dom_IntegerLiteralValue_LiteralValue, gen_dom_RealLiteralValue_LiteralValue, gen_dom_BooleanLiteralValue_LiteralValue, gen_dom_LikeExpression_Expression, gen_dom_MemberOfExpression_Expression, gen_dom_UnaryExpression_Expression, gen_dom_BetweenExpression_Expression},
    metadata=None
)
