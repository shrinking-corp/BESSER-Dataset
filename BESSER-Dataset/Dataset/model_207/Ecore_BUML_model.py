...
ecore_EClass.methods={ecore_EClass_m_getFeatureCount, ecore_EClass_m_getFeatureID, ecore_EClass_m_getEStructuralFeature, ecore_EClass_m_isSuperTypeOf, ecore_EClass_m_op_getEStructuralFeature}
...
ecore_EEnum.methods={ecore_EEnum_m_getEEnumLiteralByLiteral, ecore_EEnum_m_op_getEEnumLiteral, ecore_EEnum_m_getEEnumLiteral}
...
ecore_EObject.methods={ecore_EObject_m_eGet, ecore_EObject_m_eSet, ecore_EObject_m_op_eGet, ecore_EObject_m_eUnset, ecore_EObject_m_eAllContents, ecore_EObject_m_eClass, ecore_EObject_m_eIsProxy, ecore_EObject_m_eContainingFeature, ecore_EObject_m_eContainmentFeature, ecore_EObject_m_eContents, ecore_EObject_m_eCrossReferences, ecore_EObject_m_eContainer, ecore_EObject_m_eIsSet, ecore_EObject_m_eResource}
...
ecore_EStructuralFeature.attributes={ecore_EStructuralFeature_derived, ecore_EStructuralFeature_transient, ecore_EStructuralFeature_changeable, ecore_EStructuralFeature_unsettable, ecore_EStructuralFeature_volatile, ecore_EStructuralFeature_defaultValue, ecore_EStructuralFeature_defaultValueLiteral}
...
ecore_ETypedElement.attributes={ecore_ETypedElement_lowerBound, ecore_ETypedElement_ordered, ecore_ETypedElement_many, ecore_ETypedElement_unique, ecore_ETypedElement_required, ecore_ETypedElement_upperBound}
...
domain_model = DomainModel(
    name="ecore",
    types={ecore_EAttribute, EStructuralFeature, EDataType, ecore_EAnnotation, EModelElement, EStringToStringMapEntry, EObject, ecore_EClass, EClassifier, EClass, EOperation, EAttribute, EReference, EGenericType, ecore_EClassifier, ENamedElement, EPackage, ETypeParameter, ecore_EDataType, ecore_EEnum, EEnumLiteral, ecore_EEnumLiteral, EEnum, ecore_EFactory, ecore_EModelElement, EAnnotation, ecore_ENamedElement, ecore_EObject, ecore_EPackage, EFactory, ecore_EParameter, ETypedElement, ecore_EReference, ecore_EStructuralFeature, ecore_EOperation, EParameter, ecore_ETypedElement, ecore_EStringToStringMapEntry, ecore_EGenericType, ecore_ETypeParameter},
    associations={eAttributeType0, details1, eModelElement2, contents3, references5, eSuperTypes8, eOperations9, eAllAttributes10, eAllReferences12, eReferences14, eAttributes17, eAllContainments20, eAllOperations23, eAllStructuralFeatures26, eAllSuperTypes28, eIDAttribute31, eStructuralFeatures34, eGenericSuperTypes37, eAllGenericSuperTypes39, ePackage42, eTypeParameters43, eLiterals44, eEnum45, ePackage46, eAnnotations48, eFactoryInstance49, eClassifiers50, eSubpackages52, eSuperPackage54, eOperation56, eOpposite58, eReferenceType60, eKeys63, eContainingClass66, eContainingClass68, eTypeParameters70, eParameters72, eExceptions73, eGenericExceptions76, eType79, eGenericType81, eUpperBound84, eTypeArguments86, eRawType89, eLowerBound92, eTypeParameter95, eClassifier98, eBounds101},
    generalizations={gen_ecore_EAttribute_EStructuralFeature, gen_ecore_EAnnotation_EModelElement, gen_ecore_EClass_EClassifier, gen_ecore_EClassifier_ENamedElement, gen_ecore_EDataType_EClassifier, gen_ecore_EEnum_EDataType, gen_ecore_EEnumLiteral_ENamedElement, gen_ecore_EFactory_EModelElement, gen_ecore_EModelElement_EObject, gen_ecore_ENamedElement_EModelElement, gen_ecore_EReference_EStructuralFeature, gen_ecore_EPackage_ENamedElement, gen_ecore_EParameter_ETypedElement, gen_ecore_EStructuralFeature_ETypedElement, gen_ecore_EOperation_ETypedElement, gen_ecore_ETypedElement_ENamedElement, gen_ecore_EGenericType_EObject, gen_ecore_ETypeParameter_ENamedElement},
    metadata=None
)
