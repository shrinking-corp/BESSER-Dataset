...
class syswb103_Thing(NamedElement):
    ...
    def __init__(self, id: int, syswb103_Thing12: "syswb103_RelatedTo" = None, syswb103_Thing15: "syswb103_Thoughts" = None, fromThing: set["syswb103_RelatedTo"] = None, Thing: "syswb103_RelatedTo" = None, syswb103_Thing: "syswb103_Workbench" = None):
        self.id = id
...
class syswb103_Workbench(NamedElement):
    ...
    def __init__(self, aprop: str, syswb103_Workbench4: "syswb103_System" = None, syswb103_Workbench6: set["syswb103_FunctionProperty"] = None, syswb103_Workbench8: set["syswb103_PatternCatalog"] = None, syswb103_Workbench: set["syswb103_Thing"] = None, syswb103_Workbench2: set["syswb103_Thoughts"] = None):
        self.aprop = aprop
...
class syswb103_RelatedTo(NamedElement):
    ...
    def __init__(self, since: str, syswb103_RelatedTo: "syswb103_Thing" = None, RelatedTo: "syswb103_Thing" = None, relations: "syswb103_Thing" = None):
        self.since = since
...
class syswb103_PatternCatalog:
    ...
    def __init__(self, id: str, syswb103_PatternCatalog45: set["syswb103_Function"] = None, syswb103_PatternCatalog: "syswb103_Workbench" = None):
        self.id = id
