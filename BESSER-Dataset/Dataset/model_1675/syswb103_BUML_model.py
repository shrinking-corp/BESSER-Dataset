...
# Classes
syswb103_System = Class(name="syswb103_System")
syswb103_FunctionProperty = Class(name="syswb103_FunctionProperty")
syswb103_PatternCatalog = Class(name="syswb103_PatternCatalog")
syswb103_RelatedTo = Class(name="syswb103_RelatedTo")
syswb103_NamedElement = Class(name="syswb103_NamedElement", is_abstract=True)
syswb103_Workbench = Class(name="syswb103_Workbench")
NamedElement = Class(name="NamedElement")
syswb103_Thing = Class(name="syswb103_Thing")
syswb103_Thoughts = Class(name="syswb103_Thoughts")
syswb103_Function = Class(name="syswb103_Function")
syswb103_Component = Class(name="syswb103_Component")
...
domain_model = DomainModel(
    name="syswb103",
    types={syswb103_System, syswb103_FunctionProperty, syswb103_PatternCatalog, syswb103_RelatedTo, syswb103_NamedElement, syswb103_Workbench, NamedElement, syswb103_Thing, syswb103_Thoughts, syswb103_Function, syswb103_Component},
    associations={systemView3, functionProperties5, catalog7, relations9, fromThing10, things0, thoughts1, performs24, decompositions27, property29, associations33, allocatedTo35, functionalArchitecture38, physicalArchitecture41, toThing11, relatedTo13, parent17, decompositions20, associations22, patterns44},
    generalizations={gen_syswb103_Thing_NamedElement, gen_syswb103_RelatedTo_NamedElement, gen_syswb103_Workbench_NamedElement, gen_syswb103_Function_NamedElement, gen_syswb103_System_NamedElement, gen_syswb103_Thoughts_NamedElement, gen_syswb103_FunctionProperty_NamedElement, gen_syswb103_Component_NamedElement},
    metadata=None
)
