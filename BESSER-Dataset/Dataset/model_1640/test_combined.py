...
def test_hyp_kiamacs_eobject_is_not_abstract():
    assert not inspect.isabstract(kiamacs_EObject)


def test_hyp_kiamacs_eobject_constructor_exists():
    assert callable(kiamacs_EObject.__init__)


def test_hyp_kiamacs_eobject_constructor_args():
    sig = inspect.signature(kiamacs_EObject.__init__)
    params = list(sig.parameters.keys())



def test_hyp_kiamacs_basecs_is_not_abstract():
    assert not inspect.isabstract(kiamacs_BaseCS)


def test_hyp_kiamacs_basecs_constructor_exists():
    assert callable(kiamacs_BaseCS.__init__)


def test_hyp_kiamacs_basecs_constructor_args():
...
def test_hyp_basecs_is_not_abstract():
    assert not inspect.isabstract(BaseCS)


def test_hyp_basecs_constructor_exists():
    assert callable(BaseCS.__init__)


def test_hyp_basecs_constructor_args():
