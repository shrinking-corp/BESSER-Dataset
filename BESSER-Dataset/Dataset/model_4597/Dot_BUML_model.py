...
# Classes
dot_stmt = Class(name="dot_stmt")
dot_edge_stmt_node = Class(name="dot_edge_stmt_node")
stmt = Class(name="stmt")
dot_graphvizmodel = Class(name="dot_graphvizmodel")
dot_graph = Class(name="dot_graph")
dot_node_id = Class(name="dot_node_id")
dot_edgeRHS = Class(name="dot_edgeRHS")
dot_attr_list = Class(name="dot_attr_list")
dot_edge_stmt_subgraph = Class(name="dot_edge_stmt_subgraph")
dot_subgraph = Class(name="dot_subgraph")
dot_node_stmt = Class(name="dot_node_stmt")
dot_attribute = Class(name="dot_attribute")
dot_attr_stmt = Class(name="dot_attr_stmt")
dot_a_list = Class(name="dot_a_list")
dot_edgeRHS_node = Class(name="dot_edgeRHS_node")
edgeRHS = Class(name="edgeRHS")
dot_edgeRHS_subgraph = Class(name="dot_edgeRHS_subgraph")
...
dot_graph.attributes={dot_graph_type, dot_graph_name, dot_graph_strict}
...
domain_model = DomainModel(
    name="dot",
    types={dot_stmt, dot_edge_stmt_node, stmt, dot_graphvizmodel, dot_graph, dot_node_id, dot_edgeRHS, dot_attr_list, dot_edge_stmt_subgraph, dot_subgraph, dot_node_stmt, dot_attribute, dot_attr_stmt, dot_a_list, dot_edgeRHS_node, edgeRHS, dot_edgeRHS_subgraph, edgeop, graphtype, attributetype},
    associations={stmts1, graphs0, stmts21, node_id3, edgeRHS4, attributes6, subgraph8, edgeRHS9, attributes12, attributes15, attributes17, a_list19, node24, subgraph26},
    generalizations={gen_dot_subgraph_stmt, gen_dot_edge_stmt_node_stmt, gen_dot_edge_stmt_subgraph_stmt, gen_dot_node_stmt_stmt, gen_dot_attribute_stmt, gen_dot_attr_stmt_stmt, gen_dot_edgeRHS_node_edgeRHS, gen_dot_edgeRHS_subgraph_edgeRHS},
    metadata=None
)
