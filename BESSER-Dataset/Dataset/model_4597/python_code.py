...
class dot_a_list:
    ...
    def __init__(self, value: str, name: str, dot_a_list: "dot_attr_list" = None):
        self.value = value
        self.name = name
...
class dot_graph:
    ...
    def __init__(self, type: str, name: str, strict: bool, dot_graph2: set["dot_stmt"] = None, dot_graph: "dot_graphvizmodel" = None):
        self.type = type
        self.name = name
        self.strict = strict
...
class dot_subgraph(stmt):
    ...
    def __init__(self, name: str, dot_subgraph22: set["dot_stmt"] = None, dot_subgraph: "dot_edge_stmt_subgraph" = None, dot_subgraph27: "dot_edgeRHS_subgraph" = None):
        self.name = name
