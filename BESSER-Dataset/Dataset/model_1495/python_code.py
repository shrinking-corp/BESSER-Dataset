...
class petri_net_Arc:
    ...
    def __init__(self, name: str, petri_net_Arc: "petri_net_PetriNet" = None, petri_net_Arc4: "petri_net_Node" = None, petri_net_Arc7: "petri_net_Node" = None):
        self.name = name
...
class petri_net_Node(ABC):
    ...
    def __init__(self, name: str, petri_net_Node: "petri_net_PetriNet" = None, petri_net_Node5: "petri_net_Arc" = None, petri_net_Node8: "petri_net_Arc" = None):
        self.name = name
