...
# Classes
forcing_ForcingDiseaseModel = Class(name="forcing_ForcingDiseaseModel")
StochasticSIRDiseaseModel = Class(name="StochasticSIRDiseaseModel")
forcing_GaussianForcingDiseaseModel = Class(name="forcing_GaussianForcingDiseaseModel")
forcing_Gaussian3ForcingDiseaseModel = Class(name="forcing_Gaussian3ForcingDiseaseModel")
Gaussian2ForcingDiseaseModel = Class(name="Gaussian2ForcingDiseaseModel")
forcing_Gaussian2ForcingDiseaseModel = Class(name="forcing_Gaussian2ForcingDiseaseModel")
...
forcing_ForcingDiseaseModel.attributes={forcing_ForcingDiseaseModel_seasonalModulationFloor, forcing_ForcingDiseaseModel_modulationPhaseShift, forcing_ForcingDiseaseModel_modulationPeriod, forcing_ForcingDiseaseModel_seasonalModulationExponent}
...
forcing_GaussianForcingDiseaseModel.attributes={forcing_GaussianForcingDiseaseModel_sigma2, forcing_GaussianForcingDiseaseModel_modulationPeriod, forcing_GaussianForcingDiseaseModel_modulationFloor, forcing_GaussianForcingDiseaseModel_modulationPhaseShift}
...
forcing_Gaussian3ForcingDiseaseModel.attributes={forcing_Gaussian3ForcingDiseaseModel_transmissionRate3, forcing_Gaussian3ForcingDiseaseModel_modulationFloor_2, forcing_Gaussian3ForcingDiseaseModel_transmissionRate2, forcing_Gaussian3ForcingDiseaseModel_sigma2_3}
...
forcing_Gaussian2ForcingDiseaseModel.attributes={forcing_Gaussian2ForcingDiseaseModel_att3, forcing_Gaussian2ForcingDiseaseModel_modulationPhaseShift, forcing_Gaussian2ForcingDiseaseModel_modulationFloor, forcing_Gaussian2ForcingDiseaseModel_att4, forcing_Gaussian2ForcingDiseaseModel_modulationPeriod, forcing_Gaussian2ForcingDiseaseModel_sigma2_2, forcing_Gaussian2ForcingDiseaseModel_att1, forcing_Gaussian2ForcingDiseaseModel_att2, forcing_Gaussian2ForcingDiseaseModel_sigma2}
...
domain_model = DomainModel(
    name="forcing",
    types={forcing_ForcingDiseaseModel, StochasticSIRDiseaseModel, forcing_GaussianForcingDiseaseModel, forcing_Gaussian3ForcingDiseaseModel, Gaussian2ForcingDiseaseModel, forcing_Gaussian2ForcingDiseaseModel},
    associations={},
    generalizations={gen_forcing_ForcingDiseaseModel_StochasticSIRDiseaseModel, gen_forcing_GaussianForcingDiseaseModel_StochasticSIRDiseaseModel, gen_forcing_Gaussian3ForcingDiseaseModel_Gaussian2ForcingDiseaseModel, gen_forcing_Gaussian2ForcingDiseaseModel_StochasticSIRDiseaseModel},
    metadata=None
)
