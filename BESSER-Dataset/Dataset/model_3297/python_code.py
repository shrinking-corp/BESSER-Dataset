...
class forcing_Gaussian2ForcingDiseaseModel(StochasticSIRDiseaseModel):
    ...
    def __init__(self, att4: float, sigma2_2: float, sigma2: float, modulationPeriod: float, modulationPhaseShift: float, modulationFloor: float, att1: float, att2: float, att3: float):
        self.att4 = att4
...
class forcing_ForcingDiseaseModel(StochasticSIRDiseaseModel):
    ...
    def __init__(self, seasonalModulationExponent: float, modulationPeriod: float, modulationPhaseShift: float, seasonalModulationFloor: float):
        ...
        pass
    @property
    def seasonalModulationFloor(self):
    ...
    @property
    def seasonalModulationExponent(self):
