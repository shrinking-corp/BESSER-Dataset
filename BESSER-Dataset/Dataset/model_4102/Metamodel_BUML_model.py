...
# Classes
ConceptASE_Segment = Class(name="ConceptASE_Segment")
Trackelement = Class(name="Trackelement")
ConceptASE_Trackelement = Class(name="ConceptASE_Trackelement")
Thing = Class(name="Thing")
ConceptASE_Sensor = Class(name="ConceptASE_Sensor")
ConceptASE_Thing = Class(name="ConceptASE_Thing")
ConceptASE_IndividualContainer = Class(name="ConceptASE_IndividualContainer")
ConceptASE_Switch = Class(name="ConceptASE_Switch")
ConceptASE_SwitchPosition = Class(name="ConceptASE_SwitchPosition")
ConceptASE_Route = Class(name="ConceptASE_Route")
ConceptASE_Signal = Class(name="ConceptASE_Signal")
...
domain_model = DomainModel(
    name="ConceptASE",
    types={ConceptASE_Segment, Trackelement, ConceptASE_Trackelement, Thing, ConceptASE_Sensor, ConceptASE_Thing, ConceptASE_IndividualContainer, ConceptASE_Switch, ConceptASE_SwitchPosition, ConceptASE_Route, ConceptASE_Signal, SignalStateKind, SwitchStateKind},
    associations={TrackElement_sensor0, TrackElement_connectsTo2, SwitchPosition_switch12, SwitchPosition_route13, Sensor_trackElement14, contains15, Switch_switchPosition3, Route_entry4, Route_switchPosition5, Route_exit7, Route_routeDefinition10},
    generalizations={gen_ConceptASE_Segment_Trackelement, gen_ConceptASE_Trackelement_Thing, gen_ConceptASE_SwitchPosition_Thing, gen_ConceptASE_Sensor_Thing, gen_ConceptASE_Switch_Trackelement, gen_ConceptASE_Route_Thing, gen_ConceptASE_Signal_Thing},
    metadata=None
)
