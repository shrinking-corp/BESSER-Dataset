...
class ConceptASE_SwitchPosition(Thing):
    ...
    def __init__(self, SwitchPosition_switchState: str, SwitchPosition6: "ConceptASE_Route" = None, Switch_switchPosition: set["ConceptASE_Switch"] = None, Route_switchPosition: set["ConceptASE_Route"] = None, SwitchPosition: "ConceptASE_Switch" = None):
        ...
        pass
    @property
    def SwitchPosition_switchState(self):
...
class ConceptASE_Signal(Thing):
    ...
    def __init__(self, Signal_actualState: str, ConceptASE_Signal9: "ConceptASE_Route" = None, ConceptASE_Signal: "ConceptASE_Route" = None):
...
class ConceptASE_Sensor(Thing):
    ...
    def __init__(self, Sensor_year: int, ConceptASE_Sensor: "ConceptASE_Route" = None, Sensor: "ConceptASE_Trackelement" = None, TrackElement_sensor: set["ConceptASE_Trackelement"] = None):
...
class ConceptASE_Switch(Trackelement):
    ...
    def __init__(self, Switch_actualState: str, Switch: "ConceptASE_SwitchPosition" = None, SwitchPosition_switch: set["ConceptASE_SwitchPosition"] = None):
...
class ConceptASE_Segment(Trackelement):
    ...
    def __init__(self, Segment_length: int, Segment_height: int):
