...
class feature_Group(Identifiable):
    ...
    def __init__(self, minCardinality: int, maxCardinality: int, groups: "feature_Feature" = None, parentGroup: set["feature_Feature"] = None, Group: "feature_Feature" = None, Group11: "feature_Feature" = None):
...
class feature_Feature(Identifiable):
    ...
    def __init__(self, name: str, selected: str, Feature: "feature_Group" = None, Feature16: "feature_Group" = None, feature_Feature: "feature_FeatureModel" = None, feature: set["feature_Attribute"] = None, parentFeature: set["feature_Group"] = None, childFeatures: "feature_Group" = None, feature13: set["feature_Annotation"] = None, feature_Feature33: "feature_FeatureReference" = None, Feature20: "feature_Attribute" = None, Feature23: "feature_Annotation" = None):
        self.name = name
