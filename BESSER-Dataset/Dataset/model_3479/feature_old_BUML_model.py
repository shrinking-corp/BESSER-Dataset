...
# Classes
feature_Expression = Class(name="feature_Expression", is_abstract=True)
...
feature_AtomicExpression = Class(name="feature_AtomicExpression", is_abstract=True)
feature_FeatureReference = Class(name="feature_FeatureReference")
AtomicExpression = Class(name="AtomicExpression")
feature_NotExpression = Class(name="feature_NotExpression")
UnaryExpression = Class(name="UnaryExpression")
feature_AndExpression = Class(name="feature_AndExpression")
BinaryExpression = Class(name="BinaryExpression")
feature_OrExpression = Class(name="feature_OrExpression")
feature_Domain = Class(name="feature_Domain", is_abstract=True)
feature_EnumDomain = Class(name="feature_EnumDomain")
Domain = Class(name="Domain")
feature_ContinuousDomain = Class(name="feature_ContinuousDomain")
feature_Interval = Class(name="feature_Interval")
feature_UnaryExpression = Class(name="feature_UnaryExpression", is_abstract=True)
Expression = Class(name="Expression")
feature_BinaryExpression = Class(name="feature_BinaryExpression", is_abstract=True)
feature_AttributeValueLiteral = Class(name="feature_AttributeValueLiteral")
feature_ImpliesExpression = Class(name="feature_ImpliesExpression")
feature_NestedExpression = Class(name="feature_NestedExpression")
feature_Identifiable = Class(name="feature_Identifiable", is_abstract=True)
feature_AttributeComparisonExpression = Class(name="feature_AttributeComparisonExpression")
feature_AttributeOperand = Class(name="feature_AttributeOperand", is_abstract=True)
feature_ExcludesExpression = Class(name="feature_ExcludesExpression")
feature_AttributeReference = Class(name="feature_AttributeReference")
...
domain_model = DomainModel(
    name="feature",
    types={feature_Expression, feature_FeatureModel, feature_Feature, feature_Constraint, Identifiable, feature_Attribute, feature_Group, feature_Annotation, feature_AtomicExpression, feature_FeatureReference, AtomicExpression, feature_NotExpression, UnaryExpression, feature_AndExpression, BinaryExpression, feature_OrExpression, feature_Domain, feature_EnumDomain, Domain, feature_ContinuousDomain, feature_Interval, feature_UnaryExpression, Expression, feature_BinaryExpression, feature_AttributeValueLiteral, feature_ImpliesExpression, feature_NestedExpression, feature_Identifiable, feature_AttributeComparisonExpression, feature_AttributeOperand, feature_ExcludesExpression, feature_AttributeReference, AttributeOperand, SelectedState, AttributeComparisonOperator},
    associations={parentFeature14, childFeatures15, expression17, parent1, children3, root5, constraints6, attributes8, groups9, parentGroup10, annotations12, operand127, operand229, feature32, feature19, domain21, feature22, intervals24, operand25, attribute38, attribute134, attribute235},
    generalizations={gen_feature_Group_Identifiable, gen_feature_Constraint_Identifiable, gen_feature_Feature_Identifiable, gen_feature_AtomicExpression_Expression, gen_feature_FeatureReference_AtomicExpression, gen_feature_NotExpression_UnaryExpression, gen_feature_AndExpression_BinaryExpression, gen_feature_OrExpression_BinaryExpression, gen_feature_EnumDomain_Domain, gen_feature_ContinuousDomain_Domain, gen_feature_UnaryExpression_Expression, gen_feature_BinaryExpression_Expression, gen_feature_AttributeValueLiteral_AttributeOperand, gen_feature_ImpliesExpression_BinaryExpression, gen_feature_NestedExpression_UnaryExpression, gen_feature_AttributeComparisonExpression_AtomicExpression, gen_feature_ExcludesExpression_BinaryExpression, gen_feature_AttributeReference_AttributeOperand},
    metadata=None
)
