...
qsar_DescriptorproviderType.attributes={qsar_DescriptorproviderType_version, qsar_DescriptorproviderType_vendor, qsar_DescriptorproviderType_name, qsar_DescriptorproviderType_id, qsar_DescriptorproviderType_uRL}

# qsar_DescriptorresultlistsType class attributes and methods

# qsar_DescriptorresultType class attributes and methods
qsar_DescriptorresultType_errorString: Property = Property(name="errorString", type=StringType)
...
qsar_DescriptorresultType.attributes={qsar_DescriptorresultType_errorString, qsar_DescriptorresultType_descriptorid, qsar_DescriptorresultType_structureid}
...
qsar_DescriptorvalueType.attributes={qsar_DescriptorvalueType_label, qsar_DescriptorvalueType_index, qsar_DescriptorvalueType_value}
...
qsar_MetadataType_responseLabel: Property = Property(name="responseLabel", type=StringType)
qsar_MetadataType_responsePlacement: Property = Property(name="responsePlacement", type=StringType)
qsar_MetadataType_uRL: Property = Property(name="uRL", type=StringType)
qsar_MetadataType.attributes={qsar_MetadataType_description, qsar_MetadataType_authors, qsar_MetadataType_responseLabel, qsar_MetadataType_uRL, qsar_MetadataType_license, qsar_MetadataType_responsePlacement, qsar_MetadataType_datasetname}
...
qsar_ResponseunitType.attributes={qsar_ResponseunitType_id, qsar_ResponseunitType_shortname, qsar_ResponseunitType_uRL, qsar_ResponseunitType_description, qsar_ResponseunitType_name}
...
qsar_PreprocessingStepType.attributes={qsar_PreprocessingStepType_namespace, qsar_PreprocessingStepType_order, qsar_PreprocessingStepType_vendor, qsar_PreprocessingStepType_name, qsar_PreprocessingStepType_id}
...
qsar_ResourceType_containsErrors: Property = Property(name="containsErrors", type=StringType)
...
qsar_ResourceType.attributes={qsar_ResourceType_uRL, qsar_ResourceType_excluded, qsar_ResourceType_type, qsar_ResourceType_name, qsar_ResourceType_id, qsar_ResourceType_no3d, qsar_ResourceType_noMols, qsar_ResourceType_containsErrors, qsar_ResourceType_file, qsar_ResourceType_no2d, qsar_ResourceType_checksum}

# qsar_StructureType class attributes and methods
qsar_StructureType_problem: Property = Property(name="problem", type=StringType)
qsar_StructureType_has2d: Property = Property(name="has2d", type=StringType)
qsar_StructureType_has3d: Property = Property(name="has3d", type=StringType)
...
qsar_StructureType.attributes={qsar_StructureType_inchi, qsar_StructureType_problem, qsar_StructureType_resourceid, qsar_StructureType_resourceindex, qsar_StructureType_has2d, qsar_StructureType_id, qsar_StructureType_has3d}
...
qsar_ResponseType.attributes={qsar_ResponseType_structureID, qsar_ResponseType_value, qsar_ResponseType_unit}
...
domain_model = DomainModel(
    name="qsar",
    types={qsar_DescriptorlistType, qsar_DescriptorType, qsar_DescriptorproviderType, qsar_DescriptorresultlistsType, qsar_DescriptorresultType, qsar_DescriptorvalueType, qsar_QsarType, qsar_MetadataType, qsar_ParameterType, qsar_DocumentRoot, qsar_EStringToStringMapEntry, qsar_BibTeXMLEntriesClass, qsar_ResponseunitType, qsar_PreprocessingStepType, qsar_PreprocessingType, qsar_StructurelistType, qsar_ResponsesListType, qsar_ResourceType, qsar_StructureType, qsar_ResponseType, TypeType},
    associations={descriptors0, descriptorresult1, descriptorvalue2, xSISchemaLocation7, qsar10, parameter4, xMLNSPrefixMap6, reference12, responseunit26, metadata28, preprocessingStep13, structurelist14, descriptorlist16, descriptorproviders19, preprocessing21, responselist24, descriptorresultlist31, structure34, resources37, response35},
    generalizations={},
    metadata=None
)
