...
class raas_small_test_ReposRoot:
    ...
    def __init__(self, raasRef: str, singleAttrString: str, multiAttrString: str, raas_small_test_ReposRoot: set["raas_small_test_29373817"] = None, raas_small_test_ReposRoot2: "raas_small_test_19723516" = None, raas_small_test_ReposRoot4: "raas_small_test_7345254" = None, raas_small_test_ReposRoot8: "raas_small_test_TopClassM" = None, raas_small_test_ReposRoot6: set["raas_small_test_11832905"] = None):
    ...
    def raas_small_test_ReposRoot6(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "raas_small_test_11832905"):
                    opp_val = getattr(item, "raas_small_test_11832905", None)
                    
                    if opp_val == self:
                        setattr(item, "raas_small_test_11832905", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "raas_small_test_11832905"):
                    ...
                    setattr(item, "raas_small_test_11832905", self)
    ...
    def raas_small_test_ReposRoot2(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "raas_small_test_19723516"):
                opp_val = getattr(old_value, "raas_small_test_19723516", None)
                if opp_val == self:
                    setattr(old_value, "raas_small_test_19723516", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "raas_small_test_19723516"):
                opp_val = getattr(value, "raas_small_test_19723516", None)
                setattr(value, "raas_small_test_19723516", self)
    ...
    def raas_small_test_ReposRoot(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "raas_small_test_29373817"):
                    opp_val = getattr(item, "raas_small_test_29373817", None)
                    
                    if opp_val == self:
                        setattr(item, "raas_small_test_29373817", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "raas_small_test_29373817"):
                    ...
                    setattr(item, "raas_small_test_29373817", self)
    ...
    def raas_small_test_ReposRoot4(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "raas_small_test_7345254"):
                opp_val = getattr(old_value, "raas_small_test_7345254", None)
                if opp_val == self:
                    setattr(old_value, "raas_small_test_7345254", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "raas_small_test_7345254"):
                opp_val = getattr(value, "raas_small_test_7345254", None)
                setattr(value, "raas_small_test_7345254", self)

class raas_small_test_10382437:

    pass
class raas_small_test_30911270:

    pass
class raas_small_test_FourthLevelClassK:

    def __init__(self, raasRef: str, multi2lowerAttrInt: int, singleAttrInt: int, optionalAttrInt: int):
        self.raasRef = raasRef
...
class raas_small_test_11832905:

    pass
class raas_small_test_ThirdLevelClassJ:

    def __init__(self, raasRef: str, multi2lowerAttrInt: int, singleAttrInt: int, optionalAttrInt: int, raas_small_test_ThirdLevelClassJ: "raas_small_test_10382437" = None):
        self.raasRef = raasRef
        self.multi2lowerAttrInt = multi2lowerAttrInt
        self.singleAttrInt = singleAttrInt
        self.optionalAttrInt = optionalAttrInt
    ...
    def raas_small_test_ThirdLevelClassJ(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "raas_small_test_10382437"):
                opp_val = getattr(old_value, "raas_small_test_10382437", None)
                if opp_val == self:
                    setattr(old_value, "raas_small_test_10382437", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "raas_small_test_10382437"):
                opp_val = getattr(value, "raas_small_test_10382437", None)
                setattr(value, "raas_small_test_10382437", self)
...
class raas_small_test_DerivedUnderClassE2(raas_small_test_UnderClassE):
    ...
    def __init__(self, raasRef: str, raas_small_test_DerivedUnderClassE2: set["raas_small_test_30911270"] = None):
    ...
    def raas_small_test_DerivedUnderClassE2(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "raas_small_test_30911270"):
                    opp_val = getattr(item, "raas_small_test_30911270", None)
                    
                    if opp_val == self:
                        setattr(item, "raas_small_test_30911270", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "raas_small_test_30911270"):
                    ...
                    setattr(item, "raas_small_test_30911270", self)
                    

class raas_small_test_DerivedUnderClassE1(raas_small_test_UnderClassE):

    def __init__(self, raasRef: str, raas_small_test_DerivedUnderClassE1: "raas_small_test_11832905" = None):
        super().__init__(raasRef)
    ...
    def raas_small_test_DerivedUnderClassE1(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "raas_small_test_1183290518"):
                opp_val = getattr(old_value, "raas_small_test_1183290518", None)
                if opp_val == self:
                    setattr(old_value, "raas_small_test_1183290518", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "raas_small_test_1183290518"):
                opp_val = getattr(value, "raas_small_test_1183290518", None)
                setattr(value, "raas_small_test_1183290518", self)

class raas_small_test_MergingE1AndE2(raas_small_test_DerivedUnderClassE1, raas_small_test_DerivedUnderClassE2):

    def __init__(self, raasRef: str, optionalAttrString: str, raas_small_test_DerivedUnderClassE1: "raas_small_test_11832905" = None, raas_small_test_DerivedUnderClassE2: set["raas_small_test_30911270"] = None):
...
class raas_small_test_TopClassD:
    ...
    def __init__(self, raasRef: str, multi2lowerAttrInt: int, singleAttrInt: int, optionalAttrInt: int, optionalTimeZone: str):
        self.raasRef = raasRef
        self.multi2lowerAttrInt = multi2lowerAttrInt
        self.singleAttrInt = singleAttrInt
        self.optionalAttrInt = optionalAttrInt
...
class raas_small_test_TopClassC:
    ...
    def __init__(self, raasRef: str, multi2lowerAttrInt: int, singleAttrInt: int, optionalAttrInt: int, raas_small_test_TopClassC: "raas_small_test_16551649" = None):
        self.raasRef = raasRef
        self.multi2lowerAttrInt = multi2lowerAttrInt
        self.singleAttrInt = singleAttrInt
        self.optionalAttrInt = optionalAttrInt
    ...
    def raas_small_test_TopClassC(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "raas_small_test_1655164915"):
                opp_val = getattr(old_value, "raas_small_test_1655164915", None)
                if opp_val == self:
                    setattr(old_value, "raas_small_test_1655164915", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "raas_small_test_1655164915"):
                opp_val = getattr(value, "raas_small_test_1655164915", None)
                setattr(value, "raas_small_test_1655164915", self)

class raas_small_test_TopClassB:

    def __init__(self, raasRef: str, multi2lowerAttrInt: int, singleAttrInt: int, optionalAttrInt: int, raas_small_test_TopClassB: set["raas_small_test_5656663"] = None):
        self.raasRef = raasRef
        self.multi2lowerAttrInt = multi2lowerAttrInt
        self.singleAttrInt = singleAttrInt
        self.optionalAttrInt = optionalAttrInt
    ...
    def raas_small_test_TopClassB(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "raas_small_test_565666313"):
                    opp_val = getattr(item, "raas_small_test_565666313", None)
                    
                    if opp_val == self:
                        setattr(item, "raas_small_test_565666313", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "raas_small_test_565666313"):
                    ...
                    setattr(item, "raas_small_test_565666313", self)
                    

class raas_small_test_16551649:

    pass
class raas_small_test_5656663:

    pass
class raas_small_test_TopClassA:

    def __init__(self, raasRef: str, raas_small_test_TopClassA: set["raas_small_test_5656663"] = None, raas_small_test_TopClassA11: "raas_small_test_16551649" = None):
        self.raasRef = raasRef
    ...
    def raas_small_test_TopClassA11(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "raas_small_test_16551649"):
                opp_val = getattr(old_value, "raas_small_test_16551649", None)
                if opp_val == self:
                    setattr(old_value, "raas_small_test_16551649", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "raas_small_test_16551649"):
                opp_val = getattr(value, "raas_small_test_16551649", None)
                setattr(value, "raas_small_test_16551649", self)
    ...
    def raas_small_test_TopClassA(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "raas_small_test_5656663"):
                    opp_val = getattr(item, "raas_small_test_5656663", None)
                    
                    if opp_val == self:
                        setattr(item, "raas_small_test_5656663", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "raas_small_test_5656663"):
                    ...
                    setattr(item, "raas_small_test_5656663", self)
                    

class raas_small_test_TopClassM(raas_small_test_UnderClassE):

    def __init__(self, singleAttrInt: int, raasRef: str, raas_small_test_TopClassM: "raas_small_test_ReposRoot" = None):
        super().__init__(raasRef)
        self.singleAttrInt = singleAttrInt
...
class raas_small_test_7345254:

    pass
class raas_small_test_19723516:

    pass
class raas_small_test_29373817:
