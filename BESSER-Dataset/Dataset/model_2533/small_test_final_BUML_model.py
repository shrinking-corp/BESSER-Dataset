...
# Classes
raas_small_test_ReposRoot = Class(name="raas_small_test_ReposRoot")
raas_small_test_29373817 = Class(name="raas_small_test_#29373817")
raas_small_test_19723516 = Class(name="raas_small_test_#19723516")
raas_small_test_7345254 = Class(name="raas_small_test_#7345254")
raas_small_test_TopClassM = Class(name="raas_small_test_TopClassM")
raas_small_test_TopClassA = Class(name="raas_small_test_TopClassA")
raas_small_test_5656663 = Class(name="raas_small_test_#5656663")
raas_small_test_16551649 = Class(name="raas_small_test_#16551649")
raas_small_test_TopClassB = Class(name="raas_small_test_TopClassB")
raas_small_test_TopClassC = Class(name="raas_small_test_TopClassC")
raas_small_test_TopClassD = Class(name="raas_small_test_TopClassD")
raas_small_test_UnderClassE = Class(name="raas_small_test_UnderClassE")
raas_small_test_UnderClassF = Class(name="raas_small_test_UnderClassF")
raas_small_test_ThirdLevelClassJ = Class(name="raas_small_test_ThirdLevelClassJ")
raas_small_test_11832905 = Class(name="raas_small_test_#11832905")
raas_small_test_FourthLevelClassK = Class(name="raas_small_test_FourthLevelClassK")
raas_small_test_DerivedUnderClassE1 = Class(name="raas_small_test_DerivedUnderClassE1")
raas_small_test_DerivedUnderClassE2 = Class(name="raas_small_test_DerivedUnderClassE2")
raas_small_test_30911270 = Class(name="raas_small_test_#30911270")
raas_small_test_MergingE1AndE2 = Class(name="raas_small_test_MergingE1AndE2")
raas_small_test_10382437 = Class(name="raas_small_test_#10382437")
...
# raas_small_test_29373817 class attributes and methods

# raas_small_test_19723516 class attributes and methods

# raas_small_test_7345254 class attributes and methods
...
# raas_small_test_5656663 class attributes and methods

# raas_small_test_16551649 class attributes and methods
...
raas_small_test_TopClassB.attributes={raas_small_test_TopClassB_multi2lowerAttrInt, raas_small_test_TopClassB_raasRef, raas_small_test_TopClassB_optionalAttrInt, raas_small_test_TopClassB_singleAttrInt}
...
raas_small_test_TopClassC.attributes={raas_small_test_TopClassC_singleAttrInt, raas_small_test_TopClassC_raasRef, raas_small_test_TopClassC_optionalAttrInt, raas_small_test_TopClassC_multi2lowerAttrInt}
...
raas_small_test_TopClassD.attributes={raas_small_test_TopClassD_optionalAttrInt, raas_small_test_TopClassD_multi2lowerAttrInt, raas_small_test_TopClassD_optionalTimeZone, raas_small_test_TopClassD_raasRef, raas_small_test_TopClassD_singleAttrInt}
...
raas_small_test_UnderClassF.attributes={raas_small_test_UnderClassF_raasRef, raas_small_test_UnderClassF_singleAttrInt}
...
raas_small_test_ThirdLevelClassJ.attributes={raas_small_test_ThirdLevelClassJ_singleAttrInt, raas_small_test_ThirdLevelClassJ_raasRef, raas_small_test_ThirdLevelClassJ_optionalAttrInt, raas_small_test_ThirdLevelClassJ_multi2lowerAttrInt}

# raas_small_test_11832905 class attributes and methods
...
raas_small_test_FourthLevelClassK.attributes={raas_small_test_FourthLevelClassK_raasRef, raas_small_test_FourthLevelClassK_optionalAttrInt, raas_small_test_FourthLevelClassK_singleAttrInt, raas_small_test_FourthLevelClassK_multi2lowerAttrInt}
...
# raas_small_test_30911270 class attributes and methods
...
# raas_small_test_10382437 class attributes and methods

# Relationships
multiContainClassA0: BinaryAssociation = BinaryAssociation(
    name="multiContainClassA0",
    ends={
        Property(name="raas_small_test_29373817", type=raas_small_test_ReposRoot, multiplicity=Multiplicity(1, 1)),
        Property(name="raas_small_test_ReposRoot", type=raas_small_test_29373817, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
optionalContainClassB1: BinaryAssociation = BinaryAssociation(
    name="optionalContainClassB1",
    ends={
        Property(name="raas_small_test_19723516", type=raas_small_test_ReposRoot, multiplicity=Multiplicity(1, 1)),
        Property(name="raas_small_test_ReposRoot2", type=raas_small_test_19723516, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
singleContainClassC3: BinaryAssociation = BinaryAssociation(
    name="singleContainClassC3",
    ends={
        Property(name="raas_small_test_7345254", type=raas_small_test_ReposRoot, multiplicity=Multiplicity(1, 1)),
        Property(name="raas_small_test_ReposRoot4", type=raas_small_test_7345254, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
...
multiContainClassE9: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="raas_small_test_5656663", type=raas_small_test_TopClassA, multiplicity=Multiplicity(1, 1)),
        Property(name="raas_small_test_TopClassA", type=raas_small_test_5656663, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
singleContainClassF10: BinaryAssociation = BinaryAssociation(
    name="singleContainClassF10",
    ends={
        Property(name="raas_small_test_16551649", type=raas_small_test_TopClassA, multiplicity=Multiplicity(1, 1)),
        Property(name="raas_small_test_TopClassA11", type=raas_small_test_16551649, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
multiRefClassE12: BinaryAssociation = BinaryAssociation(
    name="multiRefClassE12",
    ends={
        Property(name="raas_small_test_565666313", type=raas_small_test_TopClassB, multiplicity=Multiplicity(1, 1)),
        Property(name="raas_small_test_TopClassB", type=raas_small_test_5656663, multiplicity=Multiplicity(0, 9999))
    }
)
singleContainClassF14: BinaryAssociation = BinaryAssociation(
    name="singleContainClassF14",
    ends={
        Property(name="raas_small_test_1655164915", type=raas_small_test_TopClassC, multiplicity=Multiplicity(1, 1)),
        Property(name="raas_small_test_TopClassC", type=raas_small_test_16551649, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
multiRefClassD5: BinaryAssociation = BinaryAssociation(
    name="multiRefClassD5",
    ends={
        Property(name="raas_small_test_11832905", type=raas_small_test_ReposRoot, multiplicity=Multiplicity(1, 1)),
        Property(name="raas_small_test_ReposRoot6", type=raas_small_test_11832905, multiplicity=Multiplicity(0, 9999))
    }
)
singleRefClassD17: BinaryAssociation = BinaryAssociation(
    name="singleRefClassD17",
    ends={
        Property(name="raas_small_test_1183290518", type=raas_small_test_DerivedUnderClassE1, multiplicity=Multiplicity(1, 1)),
        Property(name="raas_small_test_DerivedUnderClassE1", type=raas_small_test_11832905, multiplicity=Multiplicity(1, 1))
    }
)
multiContainClassJ19: BinaryAssociation = BinaryAssociation(
    name="multiContainClassJ19",
    ends={
        Property(name="raas_small_test_30911270", type=raas_small_test_DerivedUnderClassE2, multiplicity=Multiplicity(1, 1)),
        Property(name="raas_small_test_DerivedUnderClassE2", type=raas_small_test_30911270, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
optionalContainClassK16: BinaryAssociation = BinaryAssociation(
    name="optionalContainClassK16",
    ends={
        Property(name="raas_small_test_10382437", type=raas_small_test_ThirdLevelClassJ, multiplicity=Multiplicity(1, 1)),
        Property(name="raas_small_test_ThirdLevelClassJ", type=raas_small_test_10382437, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
...
domain_model = DomainModel(
    ...
    types={raas_small_test_ReposRoot, raas_small_test_29373817, raas_small_test_19723516, raas_small_test_7345254, raas_small_test_TopClassM, raas_small_test_TopClassA, raas_small_test_5656663, raas_small_test_16551649, raas_small_test_TopClassB, raas_small_test_TopClassC, raas_small_test_TopClassD, raas_small_test_UnderClassE, raas_small_test_UnderClassF, raas_small_test_ThirdLevelClassJ, raas_small_test_11832905, raas_small_test_FourthLevelClassK, raas_small_test_DerivedUnderClassE1, raas_small_test_DerivedUnderClassE2, raas_small_test_30911270, raas_small_test_MergingE1AndE2, raas_small_test_10382437},
    associations={multiContainClassA0, optionalContainClassB1, singleContainClassC3, singleNonContainClassM7, multiContainClassE9, singleContainClassF10, multiRefClassE12, singleContainClassF14, multiRefClassD5, singleRefClassD17, multiContainClassJ19, optionalContainClassK16},
