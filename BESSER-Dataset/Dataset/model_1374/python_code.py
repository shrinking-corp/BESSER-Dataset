...
class statemachines_Event:
    ...
    def __init__(self, name: str, code: str, statemachines_Event13: "statemachines_Transition" = None, statemachines_Event: "statemachines_StateMachine" = None, statemachines_Event5: "statemachines_StateMachine" = None):
        self.name = name
        self.code = code
