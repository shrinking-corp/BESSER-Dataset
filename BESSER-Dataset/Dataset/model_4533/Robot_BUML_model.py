...
# Classes
robotG_robot_Move = Class(name="robotG_robot_Move")
CommandeRobot = Class(name="CommandeRobot")
robotG_robot_Bip = Class(name="robotG_robot_Bip")
robotG_robot_Turn = Class(name="robotG_robot_Turn")
robotG_robot_SetTurnAngle = Class(name="robotG_robot_SetTurnAngle")
robotG_robot_HasTurned = Class(name="robotG_robot_HasTurned")
flow_ExprBool = Class(name="flow_ExprBool")
robot_CommandeRobot = Class(name="robot_CommandeRobot")
robotG_robot_Display = Class(name="robotG_robot_Display")
robotG_robot_CommandeRobot = Class(name="robotG_robot_CommandeRobot", is_abstract=True)
Expr = Class(name="Expr")
robotG_flow_While = Class(name="robotG_flow_While")
ExprBool = Class(name="ExprBool")
robotG_flow_If = Class(name="robotG_flow_If")
robotG_flow_Not = Class(name="robotG_flow_Not")
OpUnaire = Class(name="OpUnaire")
robotG_flow_ExprBool = Class(name="robotG_flow_ExprBool", is_abstract=True)
robotG_flow_StopProgram = Class(name="robotG_flow_StopProgram")
robotG_flow_Expr = Class(name="robotG_flow_Expr", is_abstract=True)
robotG_flow_OpUnaire = Class(name="robotG_flow_OpUnaire", is_abstract=True)
robotG_flow_OpBinaire = Class(name="robotG_flow_OpBinaire", is_abstract=True)
robotG_robot_Obstacle = Class(name="robotG_robot_Obstacle")
robotG_robot_StopEngine = Class(name="robotG_robot_StopEngine")
robotG_flow_And = Class(name="robotG_flow_And")
OpBinaire = Class(name="OpBinaire")
robotG_flow_Or = Class(name="robotG_flow_Or")
robotG_flow_Programme = Class(name="robotG_flow_Programme")
...
robotG_robot_Display.attributes={robotG_robot_Display_col, robotG_robot_Display_msg, robotG_robot_Display_line, robotG_robot_Display_duration}
...
domain_model = DomainModel(
    name="robotG",
    types={robotG_robot_Move, CommandeRobot, robotG_robot_Bip, robotG_robot_Turn, robotG_robot_SetTurnAngle, robotG_robot_HasTurned, flow_ExprBool, robot_CommandeRobot, robotG_robot_Display, robotG_robot_CommandeRobot, Expr, robotG_flow_While, ExprBool, robotG_flow_If, robotG_flow_Not, OpUnaire, robotG_flow_ExprBool, robotG_flow_StopProgram, robotG_flow_Expr, robotG_flow_OpUnaire, robotG_flow_OpBinaire, robotG_robot_Obstacle, robotG_robot_StopEngine, robotG_flow_And, OpBinaire, robotG_flow_Or, robotG_flow_Programme},
    associations={condition0, instructions1, condition3, instructions5, expression8, programme15, filsGauche10, filsDroit12},
    generalizations={gen_robotG_robot_Move_CommandeRobot, gen_robotG_robot_Bip_CommandeRobot, gen_robotG_robot_Turn_CommandeRobot, gen_robotG_robot_SetTurnAngle_CommandeRobot, gen_robotG_robot_HasTurned_flow_ExprBool, gen_robotG_robot_HasTurned_robot_CommandeRobot, gen_robotG_robot_Display_CommandeRobot, gen_robotG_robot_CommandeRobot_Expr, gen_robotG_flow_While_Expr, gen_robotG_flow_If_Expr, gen_robotG_flow_Not_OpUnaire, gen_robotG_flow_ExprBool_Expr, gen_robotG_flow_StopProgram_Expr, gen_robotG_flow_OpUnaire_ExprBool, gen_robotG_flow_OpBinaire_ExprBool, gen_robotG_robot_Obstacle_flow_ExprBool, gen_robotG_robot_Obstacle_robot_CommandeRobot, gen_robotG_robot_StopEngine_CommandeRobot, gen_robotG_flow_And_OpBinaire, gen_robotG_flow_Or_OpBinaire},
    metadata=None
)
