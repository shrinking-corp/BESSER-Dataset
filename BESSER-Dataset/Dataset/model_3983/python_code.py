...
class markov_Transition(Entity):
    ...
    def __init__(self, probability: float, markov_Transition4: "markov_State" = None, markov_Transition10: "markov_MarkovChain" = None, markov_Transition: "markov_State" = None):
...
class markov_State(Entity):
    ...
    def __init__(self, type: str, traces: str, markov_State5: "markov_Transition" = None, markov_State7: "markov_MarkovChain" = None, markov_State: set["markov_Label"] = None, markov_State2: "markov_Transition" = None):
        self.type = type
        self.traces = traces
