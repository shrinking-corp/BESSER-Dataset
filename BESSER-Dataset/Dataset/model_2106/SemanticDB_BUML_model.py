...
# Classes
SemanticResourceDB_SemanticDB = Class(name="SemanticResourceDB_SemanticDB")
SemanticResourceDB_TreeRoot = Class(name="SemanticResourceDB_TreeRoot")
ResourceTreeNode = Class(name="ResourceTreeNode")
SemanticResourceDB_ResourceTreeNode = Class(name="SemanticResourceDB_ResourceTreeNode")
...
SemanticResourceDB_ResourceTreeNode.attributes={SemanticResourceDB_ResourceTreeNode_exists, SemanticResourceDB_ResourceTreeNode_path, SemanticResourceDB_ResourceTreeNode_remoteURI, SemanticResourceDB_ResourceTreeNode_localOnly, SemanticResourceDB_ResourceTreeNode_templateID, SemanticResourceDB_ResourceTreeNode_queryPart, SemanticResourceDB_ResourceTreeNode_sessionProperties, SemanticResourceDB_ResourceTreeNode_name, SemanticResourceDB_ResourceTreeNode_type, SemanticResourceDB_ResourceTreeNode_dynamicContentProviderID, SemanticResourceDB_ResourceTreeNode_persistentProperties}
...
domain_model = DomainModel(
    ...
    types={SemanticResourceDB_SemanticDB, SemanticResourceDB_TreeRoot, ResourceTreeNode, SemanticResourceDB_ResourceTreeNode, TreeNodeType},
