...
HALL_Data.attributes={HALL_Data_type, HALL_Data_currentValue, HALL_Data_initValue, HALL_Data_name}
...
domain_model = DomainModel(
    name="HALL",
    types={HALL_UserProfile, HALL_Component, HALL_Data, FSM, MessageHandler, HALL_SystemComponent, HALL_Model, MessageDefinition, HALL_TaskObject, HALL_VisualObject, Component, ColorData, GeometryData, HALL_Parameter, HALL_Geometry_Color, RGBColor, ColorState, HALL_Geometry_RGBColor, Color, HALL_Goal, HALL_Geometry_NormalColors, HALL_Geometry_SelectedColors, HALL_Geometry_DisabledColors, HALL_Geometry_ColorData, SelectedColors, DisabledColors, NormalColors, Geometry_HALL_VisualObject, HALL_Geometry_GeometryData, HALL_Geometry_GeometryData3D, Face, HALL_Geometry_GeometryData2D, Point2D, HALL_Geometry_Face, Point3D, GeometryData3D, HALL_Geometry_Point3D, Point, HALL_Geometry_ColorState, AlphaTransparency, HALL_Geometry_AlphaTransparency, HALL_Messages_MessageTransition, MessageState, Conditions_PreConditionMessageExpression, Instructions_PosConditionMessageExpression, Actions_ActionMessageExpression, HALL_Messages_NamedMessageState, HALL_Messages_MessageDefinition, Messages_HALL_Model, Messages_HALL_Parameter, Messages_HALL_Data, HALL_Messages_MessageHandler, NamedMessageState, InitialMessageState, Messages_HALL_Component, HALL_Messages_MessageState, MessageTransition, HALL_Messages_InitialMessageState, HALL_Geometry_Point2D, GeometryData2D, HALL_Geometry_Point, HALL_Instructions_Literal, HALL_Instructions_BinaryOperator, HALL_Instructions_UnaryOperator, HALL_Instructions_GetData, Instructions_HALL_Component, HALL_Instructions_GetState, HALL_Instructions_SetState, HALL_Instructions_SetData, HALL_Instructions_SetMessageData, HALL_Instructions_SetMessageParameter, HALL_Instructions_Let, HALL_Instructions_PosConditionMessageExpression, Instructions_PosConditionMessageExpressionElement, HALL_Instructions_PosConditionMessageExpressionElement, HALL_Instructions_VarRef, PosConditionMessageExpressionElement, HALL_Instructions_GetMessageParameter, HALL_Instructions_SetTopDown, HALL_Conditions_PreConditionMessageExpression, Conditions_PreConditionMessageExpressionElement, HALL_Conditions_PreConditionMessageExpressionElement, HALL_Conditions_VarRef, PreConditionMessageExpressionElement, HALL_Conditions_Literal, HALL_Conditions_GetMessageData, HALL_Conditions_GetMessageParameter, HALL_Conditions_DomainPropertyGet, HALL_Conditions_GetState, Conditions_HALL_Component, HALL_Conditions_GetData, HALL_Conditions_Let, HALL_Conditions_UnaryOperator, HALL_Instructions_DomainPropertyGet, HALL_Instructions_GetMessageData, Actions_ActionMessageExpressionElement, HALL_Actions_ActionMessageExpressionElement, HALL_Actions_VarRef, ActionMessageExpressionElement, HALL_Actions_Literal, HALL_Actions_BinaryOperator, HALL_Actions_Let, HALL_Actions_DomainPropertyGet, HALL_Actions_GetMessageData, HALL_Actions_GetMessageParameter, HALL_Actions_MessageInvocation, HALL_Actions_UnaryOperator, HALL_Actions_GetData, HALL_Conditions_BinaryOperator, HALL_Actions_ActionMessageExpression, HALL_FSM_FSM, FSM_HALL_Component, InitialState, NamedState, HALL_FSM_NamedState, State, HALL_FSM_InitialState, HALL_FSM_Transition, FSMConditions_PreConditionExpression, FSMInstructions_PosConditionExpression, FSMActions_ActionExpression, Trigger_TriggerExpression, HALL_FSM_State, Transition, HALL_Trigger_TriggerExpression, Trigger_TriggerExpressionElement, Actions_HALL_Component, HALL_Actions_DomainPropertySet, HALL_Actions_Enable, FSMInstructions_PosConditionExpressionElement, HALL_FSMInstructions_PosConditionExpressionElement, HALL_FSMInstructions_VarRef, PosConditionExpressionElement, HALL_FSMInstructions_Literal, HALL_FSMInstructions_BinaryOperator, HALL_FSMInstructions_UnaryOperator, HALL_FSMInstructions_GetData, FSMInstructions_HALL_Component, HALL_FSMInstructions_GetState, HALL_FSMInstructions_SetState, HALL_FSMInstructions_SetData, HALL_Trigger_TriggerExpressionElement, HALL_Trigger_MessageNotification, TriggerExpressionElement, HALL_Trigger_DomainEventFired, HALL_FSMInstructions_PosConditionExpression, HALL_FSMConditions_PreConditionExpression, FSMConditions_PreConditionExpressionElement, HALL_FSMConditions_PreConditionExpressionElement, HALL_FSMConditions_Literal, PreConditionExpressionElement, HALL_FSMConditions_VarRef, HALL_FSMConditions_BinaryOperator, HALL_FSMConditions_UnaryOperator, HALL_FSMActions_Literal, HALL_FSMActions_DomainPropertyGet, HALL_FSMActions_Let, HALL_FSMInstructions_Let, HALL_FSMActions_MessageInvocation, HALL_FSMActions_Enable, HALL_FSMInstructions_DomainPropertyGet, HALL_FSMActions_DomainPropertySet, HALL_FSMConditions_GetState, FSMConditions_HALL_Component, HALL_FSMActions_GetData, HALL_FSMConditions_GetData, HALL_FSMConditions_DomainPropertyGet, HALL_FSMConditions_Let, HALL_FSMActions_ActionExpression, FSMActions_ActionExpressionElement, HALL_FSMActions_ActionExpressionElement, HALL_FSMActions_VarRef, ActionExpressionElement, FSMActions_HALL_Component, HALL_FSMActions_BinaryOperator, HALL_FSMActions_UnaryOperator},
    associations={geometryData1, visualObjectInv2, componentSet4, componentSetInv6, data8, FSM9, messageHandlerSet10, systemComponentInv11, componentSet13, componentSetInv16, userProfile19, systemComponent21, messageDefinition23, visualObject24, taskObject26, userProfileInv27, colorData0, componentSet41, componentSetInv45, goalInv48, parameterInv50, dataInvMessageDefinition52, dataInvComponent54, ambianceColor56, difuseColor57, specularColor59, foregroundColorInv61, backgroundColorInv62, ambianceColorInv64, difuseColorInv65, componentSet30, componentSetInv34, goal37, taskObjectInv38, alphaTransparencyInv74, normalColorsInv76, selectedColorsInv78, disabledColorsInv80, selectedColors82, disabledColors83, normalColors84, colorDataInv85, geometryDataInv87, face89, point2d90, point3d91, faceInv93, specularColorInv67, foregroundColor69, backgroundColor71, alphaTransparency73, transitionsInvMessageState97, stateRef98, PreCondition100, PosCondition101, ActionMessage102, messageStateInv103, messageDefinitionInv105, parameter107, data108, messageState110, initialMessageState111, messageHandlerSetInv112, transitions114, point2dInv94, point2dInv96, leftexpression122, rightexpression123, expression126, reference128, reference129, reference131, value133, reference135, value138, value140, initialMessageStateInv115, PosConditionInv117, PosConditionSet119, PosConditionSetInv120, value147, PreConditionInv149, PreConditionSet151, PreConditionSetInv152, reference154, reference155, in_157, initialization158, in_142, initialization144, ActionMessageInv168, ActionMessageSet170, ActionMessageSetInv171, leftexpression173, rightexpression174, in_177, initialization179, actualset182, expression184, expression161, leftexpression163, rightexpression165, reference191, FSMInv194, initialState197, state198, fsm200, fsm202, source204, stateRef206, PreCondition208, PosCondition210, Action212, Trigger213, transitions214, TriggerExpressionSet215, reference186, value187, value189, PosConditionSet220, PosConditionInv222, PosConditionSetInv225, rightexpression228, leftexpression229, expression232, reference234, reference235, reference237, value239, reference241, TriggerInv216, TriggerExpressionSetInv218, PreConditionSet249, PreConditionInv251, PreConditionSetInv254, rightexpression257, leftexpression258, in_276, initialization277, in_244, initialization246, actualset280, value282, message284, expression261, value287, reference263, reference264, initialization266, in_268, ActionInv271, ActionExpressionSet273, ActionExpressionSetInv274, reference289, leftoperator290, rightexpression292, expression295},
    generalizations={gen_HALL_SystemComponent_Component, gen_HALL_UserProfile_Component, gen_HALL_VisualObject_Component, gen_HALL_TaskObject_Component, gen_HALL_Geometry_NormalColors_ColorState, gen_HALL_Geometry_SelectedColors_ColorState, gen_HALL_Geometry_DisabledColors_ColorState, gen_HALL_Geometry_GeometryData3D_GeometryData, gen_HALL_Geometry_GeometryData2D_GeometryData, gen_HALL_Geometry_Point3D_Point, gen_HALL_Messages_NamedMessageState_MessageState, gen_HALL_Messages_InitialMessageState_MessageState, gen_HALL_Geometry_Point2D_Point, gen_HALL_Instructions_Literal_PosConditionMessageExpressionElement, gen_HALL_Instructions_BinaryOperator_PosConditionMessageExpressionElement, gen_HALL_Instructions_UnaryOperator_PosConditionMessageExpressionElement, gen_HALL_Instructions_GetData_PosConditionMessageExpressionElement, gen_HALL_Instructions_GetState_PosConditionMessageExpressionElement, gen_HALL_Instructions_SetState_PosConditionMessageExpressionElement, gen_HALL_Instructions_SetData_PosConditionMessageExpressionElement, gen_HALL_Instructions_SetMessageData_PosConditionMessageExpressionElement, gen_HALL_Instructions_SetMessageParameter_PosConditionMessageExpressionElement, gen_HALL_Instructions_Let_PosConditionMessageExpressionElement, gen_HALL_Instructions_VarRef_PosConditionMessageExpressionElement, gen_HALL_Instructions_GetMessageParameter_PosConditionMessageExpressionElement, gen_HALL_Instructions_SetTopDown_PosConditionMessageExpressionElement, gen_HALL_Conditions_VarRef_PreConditionMessageExpressionElement, gen_HALL_Conditions_Literal_PreConditionMessageExpressionElement, gen_HALL_Conditions_GetMessageData_PreConditionMessageExpressionElement, gen_HALL_Conditions_GetMessageParameter_PreConditionMessageExpressionElement, gen_HALL_Conditions_DomainPropertyGet_PreConditionMessageExpressionElement, gen_HALL_Conditions_GetState_PreConditionMessageExpressionElement, gen_HALL_Conditions_GetData_PreConditionMessageExpressionElement, gen_HALL_Conditions_Let_PreConditionMessageExpressionElement, gen_HALL_Conditions_UnaryOperator_PreConditionMessageExpressionElement, gen_HALL_Instructions_DomainPropertyGet_PosConditionMessageExpressionElement, gen_HALL_Instructions_GetMessageData_PosConditionMessageExpressionElement, gen_HALL_Actions_VarRef_ActionMessageExpressionElement, gen_HALL_Actions_Literal_ActionMessageExpressionElement, gen_HALL_Actions_BinaryOperator_ActionMessageExpressionElement, gen_HALL_Actions_Let_ActionMessageExpressionElement, gen_HALL_Actions_DomainPropertyGet_ActionMessageExpressionElement, gen_HALL_Actions_GetMessageData_ActionMessageExpressionElement, gen_HALL_Actions_GetMessageParameter_ActionMessageExpressionElement, gen_HALL_Actions_MessageInvocation_ActionMessageExpressionElement, gen_HALL_Actions_UnaryOperator_ActionMessageExpressionElement, gen_HALL_Actions_GetData_ActionMessageExpressionElement, gen_HALL_Conditions_BinaryOperator_PreConditionMessageExpressionElement, gen_HALL_FSM_NamedState_State, gen_HALL_FSM_InitialState_State, gen_HALL_Actions_DomainPropertySet_ActionMessageExpressionElement, gen_HALL_Actions_Enable_ActionMessageExpressionElement, gen_HALL_FSMInstructions_VarRef_PosConditionExpressionElement, gen_HALL_FSMInstructions_Literal_PosConditionExpressionElement, gen_HALL_FSMInstructions_BinaryOperator_PosConditionExpressionElement, gen_HALL_FSMInstructions_UnaryOperator_PosConditionExpressionElement, gen_HALL_FSMInstructions_GetData_PosConditionExpressionElement, gen_HALL_FSMInstructions_GetState_PosConditionExpressionElement, gen_HALL_FSMInstructions_SetState_PosConditionExpressionElement, gen_HALL_FSMInstructions_SetData_PosConditionExpressionElement, gen_HALL_Trigger_MessageNotification_TriggerExpressionElement, gen_HALL_Trigger_DomainEventFired_TriggerExpressionElement, gen_HALL_FSMConditions_Literal_PreConditionExpressionElement, gen_HALL_FSMConditions_VarRef_PreConditionExpressionElement, gen_HALL_FSMConditions_BinaryOperator_PreConditionExpressionElement, gen_HALL_FSMConditions_UnaryOperator_PreConditionExpressionElement, gen_HALL_FSMActions_Literal_ActionExpressionElement, gen_HALL_FSMActions_DomainPropertyGet_ActionExpressionElement, gen_HALL_FSMActions_Let_ActionExpressionElement, gen_HALL_FSMInstructions_Let_PosConditionExpressionElement, gen_HALL_FSMActions_MessageInvocation_ActionExpressionElement, gen_HALL_FSMActions_Enable_ActionMessageExpressionElement, gen_HALL_FSMInstructions_DomainPropertyGet_PosConditionExpressionElement, gen_HALL_FSMActions_DomainPropertySet_ActionExpressionElement, gen_HALL_FSMConditions_GetState_PreConditionExpressionElement, gen_HALL_FSMConditions_GetData_PreConditionExpressionElement, gen_HALL_FSMConditions_DomainPropertyGet_PreConditionExpressionElement, gen_HALL_FSMConditions_Let_PreConditionExpressionElement, gen_HALL_FSMActions_VarRef_ActionExpressionElement, gen_HALL_FSMActions_GetData_ActionExpressionElement, gen_HALL_FSMActions_BinaryOperator_ActionExpressionElement, gen_HALL_FSMActions_UnaryOperator_ActionExpressionElement},
    metadata=None
)
