...
# Classes
sensinact_DSL_ECA_STATEMENT = Class(name="sensinact_DSL_ECA_STATEMENT")
DSL_REF = Class(name="DSL_REF")
sensinact_DSL_REF_CONDITION = Class(name="sensinact_DSL_REF_CONDITION")
sensinact_DSL_IfDo = Class(name="sensinact_DSL_IfDo")
sensinact_Sensinact = Class(name="sensinact_Sensinact")
sensinact_DSL_SENSINACT = Class(name="sensinact_DSL_SENSINACT")
sensinact_DSL_FLAG_AUTOSTART = Class(name="sensinact_DSL_FLAG_AUTOSTART")
sensinact_DSL_Resource = Class(name="sensinact_DSL_Resource")
sensinact_DSL_CEP_STATEMENT = Class(name="sensinact_DSL_CEP_STATEMENT")
sensinact_DSL_On = Class(name="sensinact_DSL_On")
sensinact_DSL_REF = Class(name="sensinact_DSL_REF")
sensinact_EObject = Class(name="sensinact_EObject")
sensinact_DSL_CEP_AFTER = Class(name="sensinact_DSL_CEP_AFTER")
sensinact_DSL_CEP_DURATION = Class(name="sensinact_DSL_CEP_DURATION")
sensinact_DSL_ElseIfDo = Class(name="sensinact_DSL_ElseIfDo")
sensinact_DSL_ElseDo = Class(name="sensinact_DSL_ElseDo")
sensinact_DSL_Expression = Class(name="sensinact_DSL_Expression")
sensinact_DSL_ListActions = Class(name="sensinact_DSL_ListActions")
sensinact_DSL_CEP_MIN = Class(name="sensinact_DSL_CEP_MIN")
sensinact_DSL_CEP_MAX = Class(name="sensinact_DSL_CEP_MAX")
sensinact_DSL_CEP_AVG = Class(name="sensinact_DSL_CEP_AVG")
sensinact_DSL_CEP_SUM = Class(name="sensinact_DSL_CEP_SUM")
sensinact_DSL_CEP_BEFORE = Class(name="sensinact_DSL_CEP_BEFORE")
sensinact_DSL_CEP_COINCIDE = Class(name="sensinact_DSL_CEP_COINCIDE")
sensinact_DSL_ResourceAction = Class(name="sensinact_DSL_ResourceAction")
sensinact_DSL_ListParam = Class(name="sensinact_DSL_ListParam")
sensinact_DSL_Expression_Or = Class(name="sensinact_DSL_Expression_Or")
DSL_Expression = Class(name="DSL_Expression")
sensinact_DSL_CEP_COUNT = Class(name="sensinact_DSL_CEP_COUNT")
sensinact_DSL_CEP_DURATION_MIN = Class(name="sensinact_DSL_CEP_DURATION_MIN")
sensinact_DSL_CEP_DURATION_SEC = Class(name="sensinact_DSL_CEP_DURATION_SEC")
sensinact_DSL_Expression_Larger = Class(name="sensinact_DSL_Expression_Larger")
sensinact_DSL_Expression_Larger_Equal = Class(name="sensinact_DSL_Expression_Larger_Equal")
sensinact_DSL_Expression_And = Class(name="sensinact_DSL_Expression_And")
sensinact_DSL_Expression_Diff = Class(name="sensinact_DSL_Expression_Diff")
sensinact_DSL_Expression_Equal = Class(name="sensinact_DSL_Expression_Equal")
sensinact_DSL_Expression_Minus = Class(name="sensinact_DSL_Expression_Minus")
sensinact_DSL_Expression_Multiplication = Class(name="sensinact_DSL_Expression_Multiplication")
sensinact_DSL_Expression_Smaller = Class(name="sensinact_DSL_Expression_Smaller")
sensinact_DSL_Expression_Smaller_Equal = Class(name="sensinact_DSL_Expression_Smaller_Equal")
sensinact_DSL_Expression_Plus = Class(name="sensinact_DSL_Expression_Plus")
sensinact_DSL_Object_String = Class(name="sensinact_DSL_Object_String")
sensinact_DSL_Object_Boolean = Class(name="sensinact_DSL_Object_Boolean")
sensinact_DSL_Object_Ref = Class(name="sensinact_DSL_Object_Ref")
sensinact_DSL_Expression_Negate = Class(name="sensinact_DSL_Expression_Negate")
sensinact_DSL_Expression_Division = Class(name="sensinact_DSL_Expression_Division")
sensinact_DSL_Expression_Modulo = Class(name="sensinact_DSL_Expression_Modulo")
sensinact_DSL_Object_Number = Class(name="sensinact_DSL_Object_Number")
...
domain_model = DomainModel(
    name="sensinact",
    types={sensinact_DSL_ECA_STATEMENT, DSL_REF, sensinact_DSL_REF_CONDITION, sensinact_DSL_IfDo, sensinact_Sensinact, sensinact_DSL_SENSINACT, sensinact_DSL_FLAG_AUTOSTART, sensinact_DSL_Resource, sensinact_DSL_CEP_STATEMENT, sensinact_DSL_On, sensinact_DSL_REF, sensinact_EObject, sensinact_DSL_CEP_AFTER, sensinact_DSL_CEP_DURATION, sensinact_DSL_ElseIfDo, sensinact_DSL_ElseDo, sensinact_DSL_Expression, sensinact_DSL_ListActions, sensinact_DSL_CEP_MIN, sensinact_DSL_CEP_MAX, sensinact_DSL_CEP_AVG, sensinact_DSL_CEP_SUM, sensinact_DSL_CEP_BEFORE, sensinact_DSL_CEP_COINCIDE, sensinact_DSL_ResourceAction, sensinact_DSL_ListParam, sensinact_DSL_Expression_Or, DSL_Expression, sensinact_DSL_CEP_COUNT, sensinact_DSL_CEP_DURATION_MIN, sensinact_DSL_CEP_DURATION_SEC, sensinact_DSL_Expression_Larger, sensinact_DSL_Expression_Larger_Equal, sensinact_DSL_Expression_And, sensinact_DSL_Expression_Diff, sensinact_DSL_Expression_Equal, sensinact_DSL_Expression_Minus, sensinact_DSL_Expression_Multiplication, sensinact_DSL_Expression_Smaller, sensinact_DSL_Expression_Smaller_Equal, sensinact_DSL_Expression_Plus, sensinact_DSL_Object_String, sensinact_DSL_Object_Boolean, sensinact_DSL_Object_Ref, sensinact_DSL_Expression_Negate, sensinact_DSL_Expression_Division, sensinact_DSL_Expression_Modulo, sensinact_DSL_Object_Number},
    associations={eca9, triggers11, ifdo13, eca0, autostart1, resources3, cep5, on7, ref32, operation34, ref136, ref238, start41, elseIfdo15, elsedo17, condition19, actions21, condition23, actions26, actions29, ref65, window67, ref70, window72, ref75, window77, end43, ref146, ref248, start51, end54, ref157, ref259, window62, actionList93, ref95, listParam98, param100, ref80, window82, ref85, window87, units90, right120, left123, right125, left128, left103, right105, left108, right110, left113, right115, left118, left143, right145, left148, right150, left153, right130, left133, right135, left138, right140, value168, exp170, right155, left158, right160, left163, right165},
    generalizations={gen_sensinact_DSL_Resource_DSL_REF, gen_sensinact_DSL_CEP_STATEMENT_DSL_REF, gen_sensinact_DSL_Expression_Or_DSL_Expression, gen_sensinact_DSL_Expression_Larger_DSL_Expression, gen_sensinact_DSL_Expression_Larger_Equal_DSL_Expression, gen_sensinact_DSL_Expression_And_DSL_Expression, gen_sensinact_DSL_Expression_Diff_DSL_Expression, gen_sensinact_DSL_Expression_Equal_DSL_Expression, gen_sensinact_DSL_Expression_Minus_DSL_Expression, gen_sensinact_DSL_Expression_Multiplication_DSL_Expression, gen_sensinact_DSL_Expression_Smaller_DSL_Expression, gen_sensinact_DSL_Expression_Smaller_Equal_DSL_Expression, gen_sensinact_DSL_Expression_Plus_DSL_Expression, gen_sensinact_DSL_Object_String_DSL_Expression, gen_sensinact_DSL_Object_Boolean_DSL_Expression, gen_sensinact_DSL_Object_Ref_DSL_Expression, gen_sensinact_DSL_Expression_Negate_DSL_Expression, gen_sensinact_DSL_Expression_Division_DSL_Expression, gen_sensinact_DSL_Expression_Modulo_DSL_Expression, gen_sensinact_DSL_Object_Number_DSL_Expression},
    metadata=None
)
