...
public class sensinact_DSL_ListActions  {
    ...
    private sensinact_DSL_ElseIfDo sensinact_dsl_elseifdo;


    public sensinact_DSL_ListActions(
    ) {
    }
    ...
    public sensinact_DSL_ElseIfDo getSensinact_dsl_elseifdo() {
        return sensinact_dsl_elseifdo;
    }

    public void setSensinact_dsl_elseifdo(sensinact_DSL_ElseIfDo sensinact_dsl_elseifdo) {
        this.sensinact_dsl_elseifdo = sensinact_dsl_elseifdo;
    }
