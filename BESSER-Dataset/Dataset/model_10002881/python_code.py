...
class Order:
    ...
    def __init__(self, shipped: bool, shipTo: str, total: float, status: OrderStatus, number: int, ordered: date, items14: set["LineItem"] = None, account17: "Account" = None, payment19: "Payment" = None):
