...
class Account:
    ...
    def __init__(self, billingAddress: str, closed: date, isClosed: bool, open: date, payment0: set["Payment"] = None, order4: set["Order"] = None, customer11: "Customer" = None, cart16: "ShoppinCart" = None):
