...
class Delivering_Management:
    ...
    def __init__(self, client_name: str, client_key: str, deliver_boy_id: str, cleaning_Management5: "Gestion_de_Limpieza" = None, user13: "Usuario" = None, delivery_Boy18: "Delivery_Boy" = None):
...
class PAGO:
    ...
    def __init__(self, Type_of_payment: str, primary_Info1: "Informacion_Primaria" = None, cleaning_Management2: "Gestion_de_Limpieza" = None, user9: "Usuario" = None, money_Dispenser16: "Dispensador_de_dinero" = None):
    ...
    def user9(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_PAGO__user9", None)
        self.__user9 = value
    ...
    def money_Dispenser16(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_PAGO__money_Dispenser16", None)
    ...
    def cleaning_Management2(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_PAGO__cleaning_Management2", None)
    ...
    def primary_Info1(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_PAGO__primary_Info1", None)
...
class Informacion_Primaria:

    def __init__(self, Type_of_wash: str, Type_of_car: str, payment0: "PAGO" = None, user7: "Usuario" = None):
    ...
    def payment0(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Informacion_Primaria__payment0", None)
    ...
    def user7(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Informacion_Primaria__user7", None)
        self.__user7 = value
...
class Dispensador_de_dinero:

    pass


class Gestion_de_Limpieza:

    def __init__(self, water: str, powderized_wash: str, brushing: str, payment3: "PAGO" = None, delivering_Management4: "Delivering_Management" = None, user11: "Usuario" = None, cleaner14: "Limpiador" = None):
        self.water = water
    ...
    def user11(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Gestion_de_Limpieza__user11", None)
        self.__user11 = value
    ...
    def delivering_Management4(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Gestion_de_Limpieza__delivering_Management4", None)
    ...
    def cleaner14(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Gestion_de_Limpieza__cleaner14", None)
    ...
    def payment3(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Gestion_de_Limpieza__payment3", None)
