...
# Classes
epo2_Supplier = Class(name="epo2_Supplier")
epo2_Customer = Class(name="epo2_Customer")
epo2_Item = Class(name="epo2_Item")
epo2_Address = Class(name="epo2_Address", is_abstract=True)
epo2_PurchaseOrder = Class(name="epo2_PurchaseOrder")
epo2_GlobalAddress = Class(name="epo2_GlobalAddress")
GlobalLocation = Class(name="GlobalLocation")
epo2_GlobalLocation = Class(name="epo2_GlobalLocation")
epo2_USAddress = Class(name="epo2_USAddress")
...
epo2_Item.attributes={epo2_Item_shipDate, epo2_Item_partNum, epo2_Item_comment, epo2_Item_usPrice, epo2_Item_productName, epo2_Item_quantity}
...
epo2_PurchaseOrder.attributes={epo2_PurchaseOrder_totalAmount, epo2_PurchaseOrder_comment, epo2_PurchaseOrder_orderDate, epo2_PurchaseOrder_status}
...
epo2_USAddress.attributes={epo2_USAddress_street, epo2_USAddress_state, epo2_USAddress_zip, epo2_USAddress_city}
...
domain_model = DomainModel(
    name="epo2",
    types={epo2_Supplier, epo2_Customer, epo2_Item, epo2_Address, epo2_PurchaseOrder, epo2_GlobalAddress, GlobalLocation, epo2_GlobalLocation, epo2_USAddress, Address, OrderStatus},
    associations={pendingOrders1, shippedOrders4, customers7, customer9, previousOrder11, items13, billTo14, shipTo16, orders19, order20, orders0},
    generalizations={gen_epo2_GlobalAddress_Address, gen_epo2_GlobalAddress_GlobalLocation, gen_epo2_USAddress_Address},
    metadata=None
)
