...
class petriNet_Arc:
    ...
    def __init__(self, weight: int, kind: str, Arc: "petriNet_PetriNet" = None, incomings: "petriNet_Node" = None, outgoings: "petriNet_Node" = None, Arc5: "petriNet_Node" = None, Arc7: "petriNet_Node" = None, arcs: "petriNet_PetriNet" = None):
        self.weight = weight
        self.kind = kind
        self.Arc = Arc
