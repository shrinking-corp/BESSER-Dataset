...
domain_model = DomainModel(
    name="petriNet",
    types={petriNet_PetriNet, petriNet_Transition, Node, petriNet_Node, petriNet_Arc, petriNet_Place, ArcKind},
    associations={nodes0, arcs1, target8, source10, net3, outgoings4, incomings6, net12},
