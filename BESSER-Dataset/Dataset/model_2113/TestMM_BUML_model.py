...
# Classes
TestMM_Test = Class(name="TestMM_Test")
TestMM_Metadata = Class(name="TestMM_Metadata")
TestMM_Action = Class(name="TestMM_Action")
...
TestMM_Metadata.attributes={TestMM_Metadata_date, TestMM_Metadata_user, TestMM_Metadata_taglist, TestMM_Metadata_webpage}
...
TestMM_Action.attributes={TestMM_Action_type, TestMM_Action_value, TestMM_Action_id, TestMM_Action_description, TestMM_Action_xpath}
