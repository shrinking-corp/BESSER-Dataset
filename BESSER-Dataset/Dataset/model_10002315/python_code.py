...
class Hotel:
    ...
    def __init__(self, Hotel_ID: str, Hotel_Name: str, Hotel_Type: str, Hotel_Address: str, Hotel_Rent: str, booking13: "Booking" = None, customer15: "Customer" = None, admin17: "Admin" = None, room5: "Room" = None, payment23: "Payment" = None):
...
class Payment:
    ...
    def __init__(self, Customer_s_Id: str, Amount: str, Payment_Description: str, Payment_Date: str, customer7: "Customer" = None, debit_Card8: "Debit_Card" = None, credit_Card10: "Credit_Card" = None, booking18: "Booking" = None, room20: "Room" = None, hotel22: "Hotel" = None):
...
class Room:
    ...
    def __init__(self, Room_Id: str, Room_number: str, Room_type: str, Room_description: str, admin3: "Admin" = None, hotel4: "Hotel" = None, payment21: "Payment" = None):
...
class Customer:
    ...
    def __init__(self, Address: str, Mobile_no___Email: str, Name: str, Id: str, payment6: "Payment" = None, hotel14: "Hotel" = None):
...
class Booking:
    ...
    def __init__(self, Id: str, Date: str, Description: str, Type: str, hotel12: "Hotel" = None, admin1: "Admin" = None, payment19: "Payment" = None):
        self.Id = Id
        self.Date = Date
