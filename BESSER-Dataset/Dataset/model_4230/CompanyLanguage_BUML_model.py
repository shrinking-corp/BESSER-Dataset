...
# Classes
CompanyLanguage_Admin = Class(name="CompanyLanguage_Admin")
CompanyLanguage_CEO = Class(name="CompanyLanguage_CEO")
CompanyLanguage_Employee = Class(name="CompanyLanguage_Employee")
CompanyLanguage_Company = Class(name="CompanyLanguage_Company")
...
domain_model = DomainModel(
    ...
    associations={admin8, ceo0, employee1, employee3, ceo5},
    generalizations={},
    metadata=None
)
