...
class CompanyLanguage_Company:
    ...
    def __init__(self, name: str, CompanyLanguage_Company9: set["CompanyLanguage_Admin"] = None, CompanyLanguage_Company: set["CompanyLanguage_Employee"] = None, CompanyLanguage_Company6: set["CompanyLanguage_CEO"] = None):
        self.name = name
...
class CompanyLanguage_Admin:
    ...
    def __init__(self, name: str, CompanyLanguage_Admin10: "CompanyLanguage_Company" = None, CompanyLanguage_Admin: "CompanyLanguage_CEO" = None):
        self.name = name
