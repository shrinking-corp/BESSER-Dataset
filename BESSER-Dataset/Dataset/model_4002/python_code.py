...
class tallerE1Java_Package:
    ...
    def __init__(self, name: str, tallerE1Java_Package6: set["tallerE1Java_Class"] = None, tallerE1Java_Package: "tallerE1Java_Program" = None):
        self.name = name
...
class tallerE1Java_Container(Type):
    ...
    def __init__(self, type: str, tallerE1Java_Container14: "tallerE1Java_Type" = None, tallerE1Java_Container: "tallerE1Java_Program" = None):
        self.type = type
