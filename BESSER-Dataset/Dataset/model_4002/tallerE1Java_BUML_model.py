...
# Classes
tallerE1Java_Class = Class(name="tallerE1Java_Class", is_abstract=True)
Type = Class(name="Type")
tallerE1Java_Attribute = Class(name="tallerE1Java_Attribute")
tallerE1Java_Type = Class(name="tallerE1Java_Type", is_abstract=True)
tallerE1Java_Annotation = Class(name="tallerE1Java_Annotation")
tallerE1Java_EntityClass = Class(name="tallerE1Java_EntityClass")
Class_ = Class(name="Class")
tallerE1Java_DAOClass = Class(name="tallerE1Java_DAOClass")
tallerE1Java_TestClass = Class(name="tallerE1Java_TestClass")
tallerE1Java_Program = Class(name="tallerE1Java_Program")
tallerE1Java_Package = Class(name="tallerE1Java_Package")
tallerE1Java_PrimitiveType = Class(name="tallerE1Java_PrimitiveType")
tallerE1Java_Container = Class(name="tallerE1Java_Container")
...
tallerE1Java_Attribute.attributes={tallerE1Java_Attribute_name, tallerE1Java_Attribute_visibility}
...
tallerE1Java_Annotation.attributes={tallerE1Java_Annotation_content, tallerE1Java_Annotation_type}
...
domain_model = DomainModel(
    name="tallerE1Java",
    types={tallerE1Java_Class, Type, tallerE1Java_Attribute, tallerE1Java_Type, tallerE1Java_Annotation, tallerE1Java_EntityClass, Class_, tallerE1Java_DAOClass, tallerE1Java_TestClass, tallerE1Java_Program, tallerE1Java_Package, tallerE1Java_PrimitiveType, tallerE1Java_Container, Visibility},
    associations={classes5, attributes7, type9, annotations11, param13, entities16, dao17, packages0, primitiveTypes1, containerTypes3, entity19},
