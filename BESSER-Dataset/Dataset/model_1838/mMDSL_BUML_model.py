...
# Classes
mMDSL_Root = Class(name="mMDSL_Root")
mMDSL_MethodName = Class(name="mMDSL_MethodName")
mMDSL_IncludeLibraryType = Class(name="mMDSL_IncludeLibraryType")
mMDSL_EmbedPlatformType = Class(name="mMDSL_EmbedPlatformType")
mMDSL_EmbedCodeType = Class(name="mMDSL_EmbedCodeType")
mMDSL_IncludeLibrary = Class(name="mMDSL_IncludeLibrary")
mMDSL_EmbedCode = Class(name="mMDSL_EmbedCode")
mMDSL_Method = Class(name="mMDSL_Method")
mMDSL_InsertEmbedCode = Class(name="mMDSL_InsertEmbedCode")
mMDSL_Enumeration = Class(name="mMDSL_Enumeration")
mMDSL_SymbolStyle = Class(name="mMDSL_SymbolStyle")
mMDSL_SymbolClass = Class(name="mMDSL_SymbolClass")
mMDSL_SymbolRelation = Class(name="mMDSL_SymbolRelation")
mMDSL_Metamodel = Class(name="mMDSL_Metamodel")
mMDSL_Algorithm = Class(name="mMDSL_Algorithm")
mMDSL_Event = Class(name="mMDSL_Event")
mMDSL_Class = Class(name="mMDSL_Class")
mMDSL_Relation = Class(name="mMDSL_Relation")
mMDSL_Attribute = Class(name="mMDSL_Attribute")
mMDSL_ModelType = Class(name="mMDSL_ModelType")
mMDSL_ClassAttribute = Class(name="mMDSL_ClassAttribute")
mMDSL_Reference = Class(name="mMDSL_Reference")
mMDSL_Type = Class(name="mMDSL_Type")
mMDSL_RefName = Class(name="mMDSL_RefName")
mMDSL_EnumType = Class(name="mMDSL_EnumType")
mMDSL_Mode = Class(name="mMDSL_Mode")
mMDSL_SVGCommand = Class(name="mMDSL_SVGCommand")
mMDSL_Rectangle = Class(name="mMDSL_Rectangle")
mMDSL_Circle = Class(name="mMDSL_Circle")
mMDSL_Ellipse = Class(name="mMDSL_Ellipse")
mMDSL_Line = Class(name="mMDSL_Line")
mMDSL_Polyline = Class(name="mMDSL_Polyline")
mMDSL_Polygon = Class(name="mMDSL_Polygon")
mMDSL_Path = Class(name="mMDSL_Path")
mMDSL_Text = Class(name="mMDSL_Text")
mMDSL_Points = Class(name="mMDSL_Points")
mMDSL_PathData = Class(name="mMDSL_PathData")
mMDSL_FontFamily = Class(name="mMDSL_FontFamily")
mMDSL_FillColor = Class(name="mMDSL_FillColor")
mMDSL_MoveTo = Class(name="mMDSL_MoveTo")
mMDSL_LineTo = Class(name="mMDSL_LineTo")
mMDSL_HorizontalLineTo = Class(name="mMDSL_HorizontalLineTo")
mMDSL_VerticalLineTo = Class(name="mMDSL_VerticalLineTo")
mMDSL_CurveTo = Class(name="mMDSL_CurveTo")
mMDSL_SmoothCurveTo = Class(name="mMDSL_SmoothCurveTo")
mMDSL_QuadraticBezierCurve = Class(name="mMDSL_QuadraticBezierCurve")
mMDSL_SmoothQuadraticBezierCurveTo = Class(name="mMDSL_SmoothQuadraticBezierCurveTo")
mMDSL_EllipticalArc = Class(name="mMDSL_EllipticalArc")
mMDSL_PathParametersMLT = Class(name="mMDSL_PathParametersMLT")
mMDSL_PathParametersHV = Class(name="mMDSL_PathParametersHV")
mMDSL_PathParametersC = Class(name="mMDSL_PathParametersC")
mMDSL_PathParametersS = Class(name="mMDSL_PathParametersS")
mMDSL_PathParametersQ = Class(name="mMDSL_PathParametersQ")
mMDSL_PathParametersA = Class(name="mMDSL_PathParametersA")
mMDSL_StrokeColor = Class(name="mMDSL_StrokeColor")
mMDSL_Statement = Class(name="mMDSL_Statement")
mMDSL_SelectionStatement = Class(name="mMDSL_SelectionStatement")
mMDSL_LoopStatement = Class(name="mMDSL_LoopStatement")
mMDSL_Variable = Class(name="mMDSL_Variable")
mMDSL_AlgorithmOperation = Class(name="mMDSL_AlgorithmOperation")
mMDSL_Expr = Class(name="mMDSL_Expr")
mMDSL_WhileLoop = Class(name="mMDSL_WhileLoop")
mMDSL_ForLoop = Class(name="mMDSL_ForLoop")
mMDSL_BreakContinue = Class(name="mMDSL_BreakContinue")
mMDSL_OperatorAssign = Class(name="mMDSL_OperatorAssign")
mMDSL_VarStatement = Class(name="mMDSL_VarStatement")
mMDSL_OperatorMultyAssign = Class(name="mMDSL_OperatorMultyAssign")
mMDSL_OperatorUnary = Class(name="mMDSL_OperatorUnary")
mMDSL_OperatorMultiply = Class(name="mMDSL_OperatorMultiply")
mMDSL_OperatorAdd = Class(name="mMDSL_OperatorAdd")
mMDSL_OperatorCompare = Class(name="mMDSL_OperatorCompare")
mMDSL_OperatorEqual = Class(name="mMDSL_OperatorEqual")
mMDSL_OperatorAnd = Class(name="mMDSL_OperatorAnd")
mMDSL_OperatorOr = Class(name="mMDSL_OperatorOr")
mMDSL_Expression = Class(name="mMDSL_Expression")
mMDSL_EObject = Class(name="mMDSL_EObject")
mMDSL_FileOperation = Class(name="mMDSL_FileOperation")
mMDSL_DirOperation = Class(name="mMDSL_DirOperation")
mMDSL_SimpleUI = Class(name="mMDSL_SimpleUI")
mMDSL_ModelOperation = Class(name="mMDSL_ModelOperation")
mMDSL_InstanceOperation = Class(name="mMDSL_InstanceOperation")
mMDSL_AttributeOperation = Class(name="mMDSL_AttributeOperation")
mMDSL_FileCopy = Class(name="mMDSL_FileCopy")
mMDSL_FileDelete = Class(name="mMDSL_FileDelete")
mMDSL_FileCreate = Class(name="mMDSL_FileCreate")
mMDSL_FileRead = Class(name="mMDSL_FileRead")
mMDSL_FileWrite = Class(name="mMDSL_FileWrite")
mMDSL_DirSetWorking = Class(name="mMDSL_DirSetWorking")
mMDSL_DirGetWorking = Class(name="mMDSL_DirGetWorking")
mMDSL_DirCreate = Class(name="mMDSL_DirCreate")
mMDSL_DirDelete = Class(name="mMDSL_DirDelete")
mMDSL_DirList = Class(name="mMDSL_DirList")
mMDSL_EditBox = Class(name="mMDSL_EditBox")
mMDSL_InfoBox = Class(name="mMDSL_InfoBox")
mMDSL_ErrorBox = Class(name="mMDSL_ErrorBox")
mMDSL_WarningBox = Class(name="mMDSL_WarningBox")
mMDSL_ViewBox = Class(name="mMDSL_ViewBox")
mMDSL_ItemOperation = Class(name="mMDSL_ItemOperation")
mMDSL_MenuItem = Class(name="mMDSL_MenuItem")
mMDSL_ContextItem = Class(name="mMDSL_ContextItem")
mMDSL_InsertMenuItem = Class(name="mMDSL_InsertMenuItem")
mMDSL_RemoveMenuItem = Class(name="mMDSL_RemoveMenuItem")
mMDSL_InsertContextItem = Class(name="mMDSL_InsertContextItem")
mMDSL_RemoveContextItem = Class(name="mMDSL_RemoveContextItem")
mMDSL_ModelCreate = Class(name="mMDSL_ModelCreate")
mMDSL_ModelDelete = Class(name="mMDSL_ModelDelete")
mMDSL_ModelDiscard = Class(name="mMDSL_ModelDiscard")
mMDSL_ModelSave = Class(name="mMDSL_ModelSave")
mMDSL_ModelLoad = Class(name="mMDSL_ModelLoad")
mMDSL_ModelIsLoaded = Class(name="mMDSL_ModelIsLoaded")
mMDSL_ClassInstance = Class(name="mMDSL_ClassInstance")
mMDSL_RelationInstance = Class(name="mMDSL_RelationInstance")
mMDSL_ClassInstanceCreate = Class(name="mMDSL_ClassInstanceCreate")
mMDSL_ClassInstanceDelete = Class(name="mMDSL_ClassInstanceDelete")
mMDSL_ClassInstanceGet = Class(name="mMDSL_ClassInstanceGet")
mMDSL_ClassInstanceSet = Class(name="mMDSL_ClassInstanceSet")
mMDSL_ClassInstanceGetAll = Class(name="mMDSL_ClassInstanceGetAll")
mMDSL_RelationInstanceCreate = Class(name="mMDSL_RelationInstanceCreate")
mMDSL_RelationInstanceDelete = Class(name="mMDSL_RelationInstanceDelete")
mMDSL_RelationInstanceGet = Class(name="mMDSL_RelationInstanceGet")
mMDSL_RelationInstanceSet = Class(name="mMDSL_RelationInstanceSet")
mMDSL_RelationInstanceGetAll = Class(name="mMDSL_RelationInstanceGetAll")
mMDSL_AttributeGet = Class(name="mMDSL_AttributeGet")
mMDSL_AttributeSet = Class(name="mMDSL_AttributeSet")
mMDSL_OrExpression = Class(name="mMDSL_OrExpression")
Expression = Class(name="Expression")
mMDSL_AndExpression = Class(name="mMDSL_AndExpression")
mMDSL_EqualExpression = Class(name="mMDSL_EqualExpression")
mMDSL_CompareExpression = Class(name="mMDSL_CompareExpression")
mMDSL_AdditionExpression = Class(name="mMDSL_AdditionExpression")
mMDSL_MultiplicationExpression = Class(name="mMDSL_MultiplicationExpression")
...
mMDSL_EmbedCode.attributes={mMDSL_EmbedCode_embeddedcode, mMDSL_EmbedCode_name}
...
mMDSL_Attribute.attributes={mMDSL_Attribute_access, mMDSL_Attribute_name}
...
mMDSL_Rectangle.attributes={mMDSL_Rectangle_width, mMDSL_Rectangle_x, mMDSL_Rectangle_height, mMDSL_Rectangle_y}
...
mMDSL_Circle.attributes={mMDSL_Circle_r, mMDSL_Circle_cy, mMDSL_Circle_cx}
...
mMDSL_Ellipse.attributes={mMDSL_Ellipse_cy, mMDSL_Ellipse_cx, mMDSL_Ellipse_rx, mMDSL_Ellipse_ry}
...
mMDSL_Line.attributes={mMDSL_Line_y2, mMDSL_Line_x2, mMDSL_Line_y1, mMDSL_Line_x1}
...
mMDSL_Text.attributes={mMDSL_Text_y, mMDSL_Text_value, mMDSL_Text_fontsize, mMDSL_Text_x}
...
mMDSL_FontFamily.attributes={mMDSL_FontFamily_font, mMDSL_FontFamily_fontstr}
...
mMDSL_FillColor.attributes={mMDSL_FillColor_color, mMDSL_FillColor_hexcolor}
...
mMDSL_PathParametersC.attributes={mMDSL_PathParametersC_y1, mMDSL_PathParametersC_x1, mMDSL_PathParametersC_y2, mMDSL_PathParametersC_y, mMDSL_PathParametersC_x2, mMDSL_PathParametersC_x}
...
mMDSL_PathParametersS.attributes={mMDSL_PathParametersS_y2, mMDSL_PathParametersS_x2, mMDSL_PathParametersS_y, mMDSL_PathParametersS_x}
...
mMDSL_PathParametersQ.attributes={mMDSL_PathParametersQ_x1, mMDSL_PathParametersQ_y, mMDSL_PathParametersQ_y1, mMDSL_PathParametersQ_x}
...
mMDSL_PathParametersA.attributes={mMDSL_PathParametersA_ry, mMDSL_PathParametersA_largearcflag, mMDSL_PathParametersA_xaxisrot, mMDSL_PathParametersA_sweepflag, mMDSL_PathParametersA_rx, mMDSL_PathParametersA_x, mMDSL_PathParametersA_y}
...
mMDSL_StrokeColor.attributes={mMDSL_StrokeColor_color, mMDSL_StrokeColor_hexcolor}
...
mMDSL_ForLoop.attributes={mMDSL_ForLoop_start, mMDSL_ForLoop_interval, mMDSL_ForLoop_stop}

# mMDSL_BreakContinue class attributes and methods
mMDSL_BreakContinue_break_: Property = Property(name="break_", type=StringType)
mMDSL_BreakContinue_continue_: Property = Property(name="continue_", type=StringType)
mMDSL_BreakContinue.attributes={mMDSL_BreakContinue_continue_, mMDSL_BreakContinue_break_}
...
mMDSL_OperatorMultyAssign.attributes={mMDSL_OperatorMultyAssign_divassign, mMDSL_OperatorMultyAssign_multiassign, mMDSL_OperatorMultyAssign_addassign, mMDSL_OperatorMultyAssign_subassign}

# mMDSL_OperatorUnary class attributes and methods
mMDSL_OperatorUnary_not_: Property = Property(name="not_", type=StringType)
mMDSL_OperatorUnary.attributes={mMDSL_OperatorUnary_not_}
...
mMDSL_OperatorMultiply.attributes={mMDSL_OperatorMultiply_divide, mMDSL_OperatorMultiply_modulo, mMDSL_OperatorMultiply_multiply}
...
mMDSL_OperatorCompare.attributes={mMDSL_OperatorCompare_lesser, mMDSL_OperatorCompare_greater, mMDSL_OperatorCompare_greaterequal, mMDSL_OperatorCompare_lesserequal}
...
mMDSL_OperatorAnd_and_: Property = Property(name="and_", type=StringType)
mMDSL_OperatorAnd.attributes={mMDSL_OperatorAnd_and_}

# mMDSL_OperatorOr class attributes and methods
mMDSL_OperatorOr_or_: Property = Property(name="or_", type=StringType)
mMDSL_OperatorOr.attributes={mMDSL_OperatorOr_or_}
...
mMDSL_Expression.attributes={mMDSL_Expression_true, mMDSL_Expression_false, mMDSL_Expression_valueRealNumber, mMDSL_Expression_valueString}
...
mMDSL_ErrorBox.attributes={mMDSL_ErrorBox_text, mMDSL_ErrorBox_buttontype, mMDSL_ErrorBox_title}
...
mMDSL_WarningBox.attributes={mMDSL_WarningBox_title, mMDSL_WarningBox_text, mMDSL_WarningBox_buttontype}
...
mMDSL_ViewBox.attributes={mMDSL_ViewBox_text, mMDSL_ViewBox_title}
...
mMDSL_InsertMenuItem.attributes={mMDSL_InsertMenuItem_menu, mMDSL_InsertMenuItem_name}
...
mMDSL_InsertContextItem.attributes={mMDSL_InsertContextItem_context, mMDSL_InsertContextItem_name}
...
mMDSL_AttributeSet.attributes={mMDSL_AttributeSet_valueRealNumber, mMDSL_AttributeSet_valueString, mMDSL_AttributeSet_attrsetparams}
...
class_38: BinaryAssociation = BinaryAssociation(
    name="class_38",
    ends={
...
class_273: BinaryAssociation = BinaryAssociation(
    name="class_273",
    ends={
...
domain_model = DomainModel(
    name="mMDSL",
    types={mMDSL_Root, mMDSL_MethodName, mMDSL_IncludeLibraryType, mMDSL_EmbedPlatformType, mMDSL_EmbedCodeType, mMDSL_IncludeLibrary, mMDSL_EmbedCode, mMDSL_Method, mMDSL_InsertEmbedCode, mMDSL_Enumeration, mMDSL_SymbolStyle, mMDSL_SymbolClass, mMDSL_SymbolRelation, mMDSL_Metamodel, mMDSL_Algorithm, mMDSL_Event, mMDSL_Class, mMDSL_Relation, mMDSL_Attribute, mMDSL_ModelType, mMDSL_ClassAttribute, mMDSL_Reference, mMDSL_Type, mMDSL_RefName, mMDSL_EnumType, mMDSL_Mode, mMDSL_SVGCommand, mMDSL_Rectangle, mMDSL_Circle, mMDSL_Ellipse, mMDSL_Line, mMDSL_Polyline, mMDSL_Polygon, mMDSL_Path, mMDSL_Text, mMDSL_Points, mMDSL_PathData, mMDSL_FontFamily, mMDSL_FillColor, mMDSL_MoveTo, mMDSL_LineTo, mMDSL_HorizontalLineTo, mMDSL_VerticalLineTo, mMDSL_CurveTo, mMDSL_SmoothCurveTo, mMDSL_QuadraticBezierCurve, mMDSL_SmoothQuadraticBezierCurveTo, mMDSL_EllipticalArc, mMDSL_PathParametersMLT, mMDSL_PathParametersHV, mMDSL_PathParametersC, mMDSL_PathParametersS, mMDSL_PathParametersQ, mMDSL_PathParametersA, mMDSL_StrokeColor, mMDSL_Statement, mMDSL_SelectionStatement, mMDSL_LoopStatement, mMDSL_Variable, mMDSL_AlgorithmOperation, mMDSL_Expr, mMDSL_WhileLoop, mMDSL_ForLoop, mMDSL_BreakContinue, mMDSL_OperatorAssign, mMDSL_VarStatement, mMDSL_OperatorMultyAssign, mMDSL_OperatorUnary, mMDSL_OperatorMultiply, mMDSL_OperatorAdd, mMDSL_OperatorCompare, mMDSL_OperatorEqual, mMDSL_OperatorAnd, mMDSL_OperatorOr, mMDSL_Expression, mMDSL_EObject, mMDSL_FileOperation, mMDSL_DirOperation, mMDSL_SimpleUI, mMDSL_ModelOperation, mMDSL_InstanceOperation, mMDSL_AttributeOperation, mMDSL_FileCopy, mMDSL_FileDelete, mMDSL_FileCreate, mMDSL_FileRead, mMDSL_FileWrite, mMDSL_DirSetWorking, mMDSL_DirGetWorking, mMDSL_DirCreate, mMDSL_DirDelete, mMDSL_DirList, mMDSL_EditBox, mMDSL_InfoBox, mMDSL_ErrorBox, mMDSL_WarningBox, mMDSL_ViewBox, mMDSL_ItemOperation, mMDSL_MenuItem, mMDSL_ContextItem, mMDSL_InsertMenuItem, mMDSL_RemoveMenuItem, mMDSL_InsertContextItem, mMDSL_RemoveContextItem, mMDSL_ModelCreate, mMDSL_ModelDelete, mMDSL_ModelDiscard, mMDSL_ModelSave, mMDSL_ModelLoad, mMDSL_ModelIsLoaded, mMDSL_ClassInstance, mMDSL_RelationInstance, mMDSL_ClassInstanceCreate, mMDSL_ClassInstanceDelete, mMDSL_ClassInstanceGet, mMDSL_ClassInstanceSet, mMDSL_ClassInstanceGetAll, mMDSL_RelationInstanceCreate, mMDSL_RelationInstanceDelete, mMDSL_RelationInstanceGet, mMDSL_RelationInstanceSet, mMDSL_RelationInstanceGetAll, mMDSL_AttributeGet, mMDSL_AttributeSet, mMDSL_OrExpression, Expression, mMDSL_AndExpression, mMDSL_EqualExpression, mMDSL_CompareExpression, mMDSL_AdditionExpression, mMDSL_MultiplicationExpression, AccessType, SimpleType, Font, Color, ButtonType, AttrGetParams, AttrSetParams, EventName},
    associations={methodname0, includelibrarytype1, embedplatformtype3, embedcodetype5, includelibrary7, embedcode9, method11, includelibrarytype13, embedplatformtype16, embedcodetype19, codesnippetname22, enumeration24, symbolstyle26, symbolclass28, symbolrelation30, metamodel32, algorithm34, event36, class_38, relation40, attribute42, modeltype44, parentclassname47, symbolclass49, classattribute52, attribute54, insertembedcode57, reference60, parentrelationname63, symbolrelation65, fromclassname68, toclassname71, attribute74, insertembedcode77, type80, type82, refname85, modeltypename87, classname90, enumtype93, name95, classname98, relationname101, modename104, classname106, relationname109, globalstyle112, svgcommand115, globalstyle117, svgcommandsfrom120, svgcommandsmiddle123, svgcommandsto126, insertembedcode129, rectangle132, circle134, ellipse136, line138, polyline140, polygon142, path144, text146, symbolstyle148, symbolstyleref151, points154, points156, pathdata159, fontfamily161, fillcolor163, moveto165, lineto167, horizontallineto169, verticallineto171, curveto173, smoothcurveto175, quadraticbeziercurve177, smoothquadraticbeziercurveto179, ellipticalarc181, parameters183, parameters185, parameters188, parameters190, parameters193, parameters195, parameters197, parameters199, parameters202, fillcolor204, strokecolor207, fontfamily209, insertembedcode212, stmnt215, selection217, loop219, variable221, algorithmoperation223, insertembedcode225, ifcondition228, ifblock230, elseifcondition233, elseifblock236, elseblock239, whiletloop242, forloop244, condition246, whileblock249, breakcontinue252, forblock254, breakcontinue257, opassing260, varstatement262, variable265, expression267, algorithmoperation270, class_273, attribute276, reference279, symbolclass282, symbolrelation285, symbolstyle288, embeddedcode291, modeltype294, multyassign297, expr299, op301, operand304, atomic307, expression310, variable312, left316, right319, fileoperation321, diroperation323, simpleui325, modeloperation327, instanceoperation329, attributeoperation331, filecopy333, filedelete335, filecreate337, fileread339, filewrite341, dirsetworking343, dirgetworking345, dircreate347, dirdelete349, dirlist351, editbox353, infobox355, errorbox357, warningbox359, viewbox361, itemoperation363, menuitem365, contextitem367, insertmenuitem369, removemenuitem371, menuitemname373, insertcontextitem376, removecontextitem378, contextitem380, modelcreate383, modeldelete385, modeldiscard387, modelsave389, modelload391, modelisloaded393, modeltype395, modelname398, modelname401, modelname404, modelname407, modelname410, classinstance413, relationinstance415, classinstancecreate417, classinstancedelete419, classinstanceget421, classinstanceset423, classinstancegetall425, nameofclass427, nameofclassinstance430, nameofclassinstance433, nameofclass436, nameofclassinstance439, relationinstancecreate442, relationinstancedelete444, relationinstanceget446, relationinstanceset448, relationinstancegetall450, nameofrelation452, classinstancefrom455, classinstanceto458, nameofrelationinstance461, nameofrelationinstance464, nameofrelation467, nameofrelationinstance470, attributename473, attributeget476, attributeset478, valueVariable480, algorithmname483},
