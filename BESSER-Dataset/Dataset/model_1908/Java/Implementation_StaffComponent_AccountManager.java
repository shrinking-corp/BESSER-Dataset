...
public class Implementation_StaffComponent_AccountManager extends StaffComponent_IAuthentication, StaffComponent_IAccountAdministration {
    ...
    public Implementation_StaffComponent_AccountManager(
    ) {
        super(
        );
    }
