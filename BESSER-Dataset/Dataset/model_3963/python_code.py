...
class umlClass_Class(Classifier):
    ...
    def __init__(self, isActive: str, umlClass_Class14: set["umlClass_Classifier"] = None, Class: "umlClass_Property" = None, umlClass_Class40: "umlClass_Association" = None, Class42: "umlClass_Operation" = None, class_: set["umlClass_Operation"] = None, class_7: set["umlClass_Property"] = None, umlClass_Class: "umlClass_Class" = None, umlClass_Class9: set["umlClass_Class"] = None, umlClass_Class12: "umlClass_Association" = None, umlClass_Class56: "umlClass_Generalization" = None, umlClass_Class59: "umlClass_Generalization" = None):
        ...
        self.class_7 = class_7 if class_7 is not None else set()
    ...
    def class_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_umlClass_Class__class_", None)
    ...
    @property
    def class_7(self):
        return self.__class_7

    @class_7.setter
    def class_7(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_umlClass_Class__class_7", None)
        self.__class_7 = value if value is not None else set()
...
class umlClass_Operation(NamedElement):
    ...
    def __init__(self, isQuery: str, isOrdered: str, isUnique: str, lower: str, upper: str, ownedOperation: "umlClass_Class" = None, Operation: "umlClass_Class" = None, ownedOperation44: "umlClass_DataType" = None, Operation50: "umlClass_DataType" = None):
