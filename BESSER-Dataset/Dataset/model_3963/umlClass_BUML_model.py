...
umlClass_Operation.attributes={umlClass_Operation_isUnique, umlClass_Operation_isQuery, umlClass_Operation_isOrdered, umlClass_Operation_lower, umlClass_Operation_upper}
...
domain_model = DomainModel(
    name="umlClass",
    types={umlClass_NamedElement, Element, umlClass_Classifier, NamedElement, umlClass_Property, umlClass_Package, umlClass_Generalization, umlClass_StructuralFeature, TypedElement, StructuralFeature, umlClass_DataType, Relationship, umlClass_Class, Classifier, umlClass_Operation, umlClass_Association, umlClass_TypedElement, DirectedRelationship, umlClass_Relationship, umlClass_Element, umlClass_DirectedRelationship},
    associations={attribute0, redefinedClassifier2, package3, generalization4, nestedClassifier13, class_16, datatype17, opposite20, owningAssociation21, association22, redefinedProperty25, subsettedProperty28, classifier30, ownedEnd31, memberEnd33, navigableOwnedEnd35, target38, class_41, ownedOperation5, ownedAttribute6, superClass10, reference11, classifiers51, specific53, target55, source57, owner61, ownedElement63, datatype43, ownedAttribute46, ownedOperation48},
    generalizations={gen_umlClass_NamedElement_Element, gen_umlClass_Classifier_NamedElement, gen_umlClass_StructuralFeature_TypedElement, gen_umlClass_Property_StructuralFeature, gen_umlClass_Association_Classifier, gen_umlClass_Association_Relationship, gen_umlClass_Operation_NamedElement, gen_umlClass_Class_Classifier, gen_umlClass_TypedElement_NamedElement, gen_umlClass_Package_NamedElement, gen_umlClass_Generalization_DirectedRelationship, gen_umlClass_Relationship_Element, gen_umlClass_DirectedRelationship_Relationship, gen_umlClass_DataType_Classifier},
    metadata=None
)
