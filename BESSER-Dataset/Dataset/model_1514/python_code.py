...
class model_State:
    ...
    def __init__(self, name: str, model_State: "model_FSM" = None, tgt: set["model_Transition"] = None, src: set["model_Transition"] = None, ownedStates: "model_FSM" = None, State: "model_FSM" = None, State17: "model_Transition" = None, State19: "model_Transition" = None):
        self.name = name
...
class model_FSM:
    ...
    def __init__(self, name: str, fsm2: set["model_Transition"] = None, outgoingFSM: "model_Buffer" = None, incomingFSM: "model_Buffer" = None, model_FSM: "model_State" = None, FSM: "model_State" = None, FSM13: "model_Buffer" = None, fsm: set["model_State"] = None, FSM15: "model_Buffer" = None, FSM21: "model_Transition" = None, model_FSM23: "model_System" = None):
        self.name = name
