...
domain_model = DomainModel(
    name="model",
    types={model_FSM, model_Transition, model_Buffer, model_State, model_System},
    associations={ownedTransitions1, inputBuffer3, outputBuffer4, initialState6, incoming7, outgoing9, fsm11, outgoingFSM12, ownedStates0, incomingFSM14, tgt16, src18, fsm20, ownedFsms22, ownedBuffers24},
    generalizations={},
    metadata=None
)
