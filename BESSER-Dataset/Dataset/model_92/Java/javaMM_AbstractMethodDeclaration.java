...
public class javaMM_AbstractMethodDeclaration extends BodyDeclaration {
    ...
    public javaMM_AbstractMethodDeclaration(
        ArrayList<javaMM_SingleVariableDeclaration> javamm_singlevariabledeclarations,        ArrayList<javaMM_TypeAccess> javamm_typeaccesss,        ArrayList<javaMM_TypeParameter> javamm_typeparameters,        ArrayList<javaMM_MethodRef> javamm_methodrefs,        ArrayList<javaMM_AbstractMethodInvocation> javamm_abstractmethodinvocations    ) {
