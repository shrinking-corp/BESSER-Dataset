...
class javaMM_ImportDeclaration(ASTNode):
    ...
    def __init__(self, static: bool, javaMM_ImportDeclaration: "javaMM_CompilationUnit" = None, ImportDeclaration: "javaMM_NamedElement" = None, usagesInImports: "javaMM_NamedElement" = None):
        self.static = static
...
class javaMM_SingleVariableDeclaration(VariableDeclaration):
    ...
    def __init__(self, varargs: bool, SingleVariableDeclaration: "javaMM_AbstractMethodDeclaration" = None, SingleVariableDeclaration152: "javaMM_EnhancedForStatement" = None, SingleVariableDeclaration100: "javaMM_CatchClause" = None, SingleVariableDeclaration253: "javaMM_Modifier" = None, javaMM_SingleVariableDeclaration: "javaMM_TypeAccess" = None, javaMM_SingleVariableDeclaration298: set["javaMM_Annotation"] = None, parameters: "javaMM_AbstractMethodDeclaration" = None, exception: "javaMM_CatchClause" = None, parameter: "javaMM_EnhancedForStatement" = None, singleVariableDeclaration: "javaMM_Modifier" = None):
...
class javaMM_VariableDeclaration(NamedElement):
    ...
    def __init__(self, extraArrayDimensions: int, variable: set["javaMM_SingleVariableAccess"] = None, VariableDeclaration: "javaMM_SingleVariableAccess" = None, javaMM_VariableDeclaration: "javaMM_Expression" = None):
...
class javaMM_InfixExpression(Expression):
    ...
    def __init__(self, operator: str, javaMM_InfixExpression188: "javaMM_Expression" = None, javaMM_InfixExpression191: set["javaMM_Expression"] = None, javaMM_InfixExpression: "javaMM_Expression" = None):
        self.operator = operator
...
class javaMM_NamedElement(ASTNode):
    ...
    def __init__(self, name: str, proxy: bool, importedElement: set["javaMM_ImportDeclaration"] = None, NamedElement: "javaMM_ImportDeclaration" = None, javaMM_NamedElement: "javaMM_MemberRef" = None):
        self.name = name
        self.proxy = proxy
