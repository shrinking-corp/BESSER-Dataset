...
# Classes
jsonldConverter_Model = Class(name="jsonldConverter_Model")
jsonldConverter_Type = Class(name="jsonldConverter_Type")
jsonldConverter_DataType = Class(name="jsonldConverter_DataType")
Type = Class(name="Type")
jsonldConverter_Entity = Class(name="jsonldConverter_Entity")
jsonldConverter_Property = Class(name="jsonldConverter_Property")
jsonldConverter_Enum = Class(name="jsonldConverter_Enum")
jsonldConverter_EnumItem = Class(name="jsonldConverter_EnumItem")
...
jsonldConverter_Property.attributes={jsonldConverter_Property_one, jsonldConverter_Property_many, jsonldConverter_Property_name}
...
domain_model = DomainModel(
    ...
    types={jsonldConverter_Model, jsonldConverter_Type, jsonldConverter_DataType, Type, jsonldConverter_Entity, jsonldConverter_Property, jsonldConverter_Enum, jsonldConverter_EnumItem},
    associations={elements0, superType2, features3, type5, features8},
