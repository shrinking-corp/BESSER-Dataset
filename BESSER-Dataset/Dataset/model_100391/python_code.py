...
class NamedElement:
    ...
    pass
class sgraph_Statechart(ScopedElement, ExpressionElement, NamedElement, ReactiveElement):

    pass
class sgraph_Region(NamedElement):

    def __init__(self, priority: int, sgraph_Region26: "sgraph_State" = None, Region: "sgraph_Vertex" = None, parentRegion: set["sgraph_Vertex"] = None, sgraph_Region: "sgraph_Statechart" = None):
        self.priority = priority
...
class Vertex:
    ...
    pass
class sgraph_State(ScopedElement, ExpressionElement, ReactiveElement, Vertex):
