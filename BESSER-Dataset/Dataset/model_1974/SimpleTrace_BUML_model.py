...
# Classes
SimpleTrace_Trace = Class(name="SimpleTrace_Trace")
SimpleTrace_TraceLink = Class(name="SimpleTrace_TraceLink")
SimpleTrace_EObject = Class(name="SimpleTrace_EObject")
