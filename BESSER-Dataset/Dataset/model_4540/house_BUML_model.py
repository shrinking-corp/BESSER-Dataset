...
# Classes
House2_House = Class(name="House2_House")
House2_Boiler = Class(name="House2_Boiler")
Actor = Class(name="Actor")
House2_RollerBlind = Class(name="House2_RollerBlind")
House2_Condition = Class(name="House2_Condition", is_abstract=True)
Container = Class(name="Container")
Element = Class(name="Element")
House2_Room = Class(name="House2_Room")
House2_ControlRule = Class(name="House2_ControlRule")
House2_Container = Class(name="House2_Container", is_abstract=True)
NamedElement = Class(name="NamedElement")
House2_Element = Class(name="House2_Element", is_abstract=True)
House2_Sensor = Class(name="House2_Sensor", is_abstract=True)
House2_Actor = Class(name="House2_Actor", is_abstract=True)
House2_TemperatureSensor = Class(name="House2_TemperatureSensor")
Sensor = Class(name="Sensor")
House2_TwilightSwitch = Class(name="House2_TwilightSwitch")
House2_Action = Class(name="House2_Action", is_abstract=True)
House2_LessThanCondition = Class(name="House2_LessThanCondition")
Condition = Class(name="Condition")
House2_GreaterThanCondition = Class(name="House2_GreaterThanCondition")
House2_Lamp = Class(name="House2_Lamp")
House2_EqualCondition = Class(name="House2_EqualCondition")
House2_RainSensor = Class(name="House2_RainSensor")
House2_BooleanAction = Class(name="House2_BooleanAction")
Action = Class(name="Action")
House2_ValueAction = Class(name="House2_ValueAction")
House2_NamedElement = Class(name="House2_NamedElement", is_abstract=True)
...
House2_EqualCondition.attributes={House2_EqualCondition_valuecond, House2_EqualCondition_boolcond}
...
domain_model = DomainModel(
    name="House2",
    types={House2_House, House2_Boiler, Actor, House2_RollerBlind, House2_Condition, Container, Element, House2_Room, House2_ControlRule, House2_Container, NamedElement, House2_Element, House2_Sensor, House2_Actor, House2_TemperatureSensor, Sensor, House2_TwilightSwitch, House2_Action, House2_LessThanCondition, Condition, House2_GreaterThanCondition, House2_Lamp, House2_EqualCondition, House2_RainSensor, House2_BooleanAction, Action, House2_ValueAction, House2_NamedElement},
    associations={rooms0, controlRules1, elements3, isLocatedIn4, isLocatedIn6, condition8, action10, sensor12, actor15},
    generalizations={gen_House2_Boiler_Actor, gen_House2_RollerBlind_Actor, gen_House2_House_Container, gen_House2_House_Element, gen_House2_Room_Container, gen_House2_Container_NamedElement, gen_House2_Element_NamedElement, gen_House2_Sensor_NamedElement, gen_House2_Actor_NamedElement, gen_House2_TemperatureSensor_Sensor, gen_House2_TwilightSwitch_Sensor, gen_House2_LessThanCondition_Condition, gen_House2_GreaterThanCondition_Condition, gen_House2_Lamp_Actor, gen_House2_EqualCondition_Condition, gen_House2_RainSensor_Sensor, gen_House2_BooleanAction_Action, gen_House2_ValueAction_Action},
    metadata=None
)
