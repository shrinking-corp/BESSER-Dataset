...
# Classes
html5_div = Class(name="html5_div")
container = Class(name="container")
html5_Action = Class(name="html5_Action")
html5_table = Class(name="html5_table")
htmlElement = Class(name="htmlElement")
html5_tr = Class(name="html5_tr")
html5_option = Class(name="html5_option")
html5_fieldset = Class(name="html5_fieldset")
html5_legend = Class(name="html5_legend")
html5_html = Class(name="html5_html")
html5_container = Class(name="html5_container", is_abstract=True)
html5_dialog = Class(name="html5_dialog")
html5_td = Class(name="html5_td")
html5_htmlElement = Class(name="html5_htmlElement", is_abstract=True)
html5_img = Class(name="html5_img")
html5_label = Class(name="html5_label")
html5_input = Class(name="html5_input")
html5_button = Class(name="html5_button")
html5_select = Class(name="html5_select")
...
html5_legend_class_: Property = Property(name="class_", type=StringType)
html5_legend_valor: Property = Property(name="valor", type=StringType)
html5_legend.attributes={html5_legend_valor, html5_legend_class_}

# html5_html class attributes and methods

# html5_container class attributes and methods
html5_container_class_: Property = Property(name="class_", type=StringType)
html5_container.attributes={html5_container_class_}
...
html5_htmlElement_class_: Property = Property(name="class_", type=StringType)
html5_htmlElement.attributes={html5_htmlElement_class_}
...
html5_label.attributes={html5_label_valor, html5_label_value}
...
html5_input.attributes={html5_input_type, html5_input_value, html5_input_disable}
...
html5_button.attributes={html5_button_type, html5_button_value, html5_button_action}
...
html5_select.attributes={html5_select_size, html5_select_multiple}
...
domain_model = DomainModel(
    name="html5",
    types={html5_div, container, html5_Action, html5_table, htmlElement, html5_tr, html5_option, html5_fieldset, html5_legend, html5_html, html5_container, html5_dialog, html5_td, html5_htmlElement, html5_img, html5_label, html5_input, html5_button, html5_select, types},
    associations={actions0, tr1, legend6, container7, elements8, td2, elements4, innercontainer12, options14},
    generalizations={gen_html5_div_container, gen_html5_table_htmlElement, gen_html5_fieldset_container, gen_html5_dialog_htmlElement, gen_html5_img_htmlElement, gen_html5_label_htmlElement, gen_html5_input_htmlElement, gen_html5_button_htmlElement, gen_html5_select_htmlElement},
    metadata=None
)
