...
class html5_htmlElement(ABC):
    ...
    def __init__(self, class_: str, html5_htmlElement10: "html5_container" = None, html5_htmlElement: "html5_td" = None):
        self.class_ = class_
...
class html5_container(ABC):
    ...
    def __init__(self, class_: str, html5_container: "html5_html" = None, html5_container9: set["html5_htmlElement"] = None, html5_container13: "html5_container" = None, html5_container11: set["html5_container"] = None):
        self.class_ = class_
...
class html5_legend:
    ...
    def __init__(self, class_: str, valor: str, html5_legend: "html5_fieldset" = None):
        self.class_ = class_
        self.valor = valor
...
class html5_button(htmlElement):
    ...
    def __init__(self, value: str, action: str, type: str):
        self.value = value
        self.action = action
        self.type = type
