...
public class Department  {
    ...
    public Department(
        None students__,        None hod,        None course,        None teachers__    ) {
    ...
    public Department(
        None students__,        None hod,        None course,        None teachers__        ArrayList<Student> students,        ArrayList<Employee_Interface> employee_interfaces    ) {
        this.students__ = students__;
        this.hod = hod;
        this.course = course;
        this.teachers__ = teachers__;
