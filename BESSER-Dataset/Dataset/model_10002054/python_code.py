...
class Department:
    ...
    def __init__(self, course: Course, students__: Student, teachers__: Teacher, hod: HOD, employee6: set["Employee_Interface"] = None, access_Information19: "Access_Information" = None, course0: "Course" = None, student4: set["Student"] = None):
        self.course = course
...
class Student:
    ...
    def __init__(self, Name: str, ID: str, Having_Attendance8: "Access_Information" = None, admin13: "Administrator" = None, department5: "Department" = None):
        self.Name = Name
        self.ID = ID
