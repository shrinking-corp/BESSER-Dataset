...
class study_SemesterCourse:
    ...
    def __init__(self, mandatory: str, study_SemesterCourse: "study_Course" = None, courses: "study_Semester" = None, SemesterCourse: "study_Semester" = None):
...
class study_Department:
    ...
    def __init__(self, name: str, Department18: "study_Course" = None, department: set["study_Course"] = None, department21: set["study_Programme"] = None, Department: "study_Programme" = None):
        self.name = name
...
class study_Semester:
    ...
    def __init__(self, year: int, Season: str, Semester: "study_Programme" = None, Semester15: "study_SemesterCourse" = None, semester: set["study_SemesterCourse"] = None, semesters: "study_Programme" = None, semesters7: "study_Specialization" = None, Semester10: "study_Specialization" = None):
        self.year = year
        self.Season = Season
...
class study_Programme:
    ...
    def __init__(self, name: str, code: str, duration: int, programme: set["study_Semester"] = None, programme2: set["study_Specialization"] = None, Programme22: "study_Department" = None, programs: "study_Department" = None, Programme: "study_Semester" = None, Programme12: "study_Specialization" = None):
        self.name = name
        self.code = code
