...
study_SemesterCourse = Class(name="study_SemesterCourse")
...
study_Programme.attributes={study_Programme_name, study_Programme_duration, study_Programme_code}
...
study_Course.attributes={study_Course_code, study_Course_name, study_Course_level, study_Course_credits}
...
domain_model = DomainModel(
    name="study",
    types={study_Programme, study_Semester, study_Specialization, study_Department, study_SemesterCourse, study_Course, Season, IsMandatory},
    associations={semesters0, specializations1, course13, semester14, department16, courses19, programs20, department3, courses4, programme5, specialization6, semesters9, programme11},
    generalizations={},
    metadata=None
)
