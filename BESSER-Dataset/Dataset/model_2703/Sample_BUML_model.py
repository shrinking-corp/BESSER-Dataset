...
# Classes
sample_A = Class(name="sample_A", is_abstract=True)
sample_B = Class(name="sample_B")
A = Class(name="A")
sample_C = Class(name="sample_C")
...
sample_A.attributes={sample_A_name, sample_A_quantity, sample_A_valid}
