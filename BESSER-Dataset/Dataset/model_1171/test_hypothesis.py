...
def test_atlstatic_atl_statichelper_is_not_abstract():
    assert not inspect.isabstract(atlstatic_ATL_StaticHelper)


def test_atlstatic_atl_statichelper_constructor_exists():
    assert callable(atlstatic_ATL_StaticHelper.__init__)


def test_atlstatic_atl_statichelper_constructor_args():
...
def test_atlstatic_atl_lazyrule_is_not_abstract():
    assert not inspect.isabstract(atlstatic_ATL_LazyRule)


def test_atlstatic_atl_lazyrule_constructor_exists():
    assert callable(atlstatic_ATL_LazyRule.__init__)


def test_atlstatic_atl_lazyrule_constructor_args():
    sig = inspect.signature(atlstatic_ATL_LazyRule.__init__)
    params = list(sig.parameters.keys())
    assert "isUnique" in params, "Missing parameter 'isUnique'"

def test_atlstatic_atl_lazyrule_has_isUnique():
    assert hasattr(atlstatic_ATL_LazyRule, "isUnique")
    descriptor = None
    for klass in atlstatic_ATL_LazyRule.__mro__:
...
def test_atlstatic_atl_rulewithpattern_is_not_abstract():
    assert not inspect.isabstract(atlstatic_ATL_RuleWithPattern)


def test_atlstatic_atl_rulewithpattern_constructor_exists():
    assert callable(atlstatic_ATL_RuleWithPattern.__init__)


def test_atlstatic_atl_rulewithpattern_constructor_args():
...
def test_atlstatic_atl_rulewithpattern_has_isNoDefault():
    assert hasattr(atlstatic_ATL_RuleWithPattern, "isNoDefault")
    descriptor = None
    for klass in atlstatic_ATL_RuleWithPattern.__mro__:
        if "isNoDefault" in klass.__dict__:
            descriptor = klass.__dict__["isNoDefault"]
            break
    assert isinstance(descriptor, property)

def test_atlstatic_atl_rulewithpattern_has_isAbstract():
    assert hasattr(atlstatic_ATL_RuleWithPattern, "isAbstract")
    descriptor = None
    for klass in atlstatic_ATL_RuleWithPattern.__mro__:
...
def test_atlstatic_atl_rulewithpattern_has_isRefining():
    assert hasattr(atlstatic_ATL_RuleWithPattern, "isRefining")
    descriptor = None
    for klass in atlstatic_ATL_RuleWithPattern.__mro__:
...
def test_atlstatic_atl_callable_is_not_abstract():
    assert not inspect.isabstract(atlstatic_ATL_Callable)


def test_atlstatic_atl_callable_constructor_exists():
    assert callable(atlstatic_ATL_Callable.__init__)


def test_atlstatic_atl_callable_constructor_args():
...
def test_atlstatic_atl_modulecallable_is_not_abstract():
    assert not inspect.isabstract(atlstatic_ATL_ModuleCallable)


def test_atlstatic_atl_modulecallable_constructor_exists():
    assert callable(atlstatic_ATL_ModuleCallable.__init__)


def test_atlstatic_atl_modulecallable_constructor_args():
...
def test_atlstatic_atl_staticrule_is_not_abstract():
    assert not inspect.isabstract(atlstatic_ATL_StaticRule)


def test_atlstatic_atl_staticrule_constructor_exists():
    assert callable(atlstatic_ATL_StaticRule.__init__)


def test_atlstatic_atl_staticrule_constructor_args():
...
def test_atlstatic_atl_contexthelper_is_not_abstract():
    assert not inspect.isabstract(atlstatic_ATL_ContextHelper)


def test_atlstatic_atl_contexthelper_constructor_exists():
    assert callable(atlstatic_ATL_ContextHelper.__init__)


def test_atlstatic_atl_contexthelper_constructor_args():
...
@given(instance=atlstatic_ATL_LazyRule_strategy)
def test_atlstatic_atl_lazyrule_isUnique_setter(instance):
...
@given(instance=atlstatic_ATL_RuleWithPattern_strategy)
def test_atlstatic_atl_rulewithpattern_isNoDefault_setter(instance):
...
@given(instance=atlstatic_ATL_RuleWithPattern_strategy)
def test_atlstatic_atl_rulewithpattern_isAbstract_setter(instance):
...
@given(instance=atlstatic_ATL_RuleWithPattern_strategy)
def test_atlstatic_atl_rulewithpattern_isRefining_setter(instance):
