...
public class research23_Researcher  {
    ...
    private List<research23_Skill> research23_skills;
    ...
    private List<research23_Collaboration> research23_collaborations;
    ...
    public research23_Researcher(
        ...
        this.research23_skills = new ArrayList<>();
        this.research23_collaborations = new ArrayList<>();
        this.research23_papers = new ArrayList<>();
    }

    public research23_Researcher(
        String name,        String forName        ArrayList<research23_Skill> research23_skills,        ArrayList<research23_Collaboration> research23_collaborations,        ArrayList<research23_Paper> research23_papers    ) {
        this.name = name;
        this.forName = forName;
        this.research23_skills = research23_skills;
        this.research23_collaborations = research23_collaborations;
    ...
    public List<research23_Skill> getResearch23_skills() {
        return research23_skills;
    }

    public void addResearch23_skill(Research23_skill research23_skill) {
        this.research23_skills.add(research23_skill);
    }
    ...
    public List<research23_Collaboration> getResearch23_collaborations() {
        return research23_collaborations;
    }

    public void addResearch23_collaboration(Research23_collaboration research23_collaboration) {
        this.research23_collaborations.add(research23_collaboration);
    }
