...
# Classes
research23_PublicationProcess = Class(name="research23_PublicationProcess")
Named = Class(name="Named")
research23_Paper = Class(name="research23_Paper")
research23_Skill = Class(name="research23_Skill")
research23_Position = Class(name="research23_Position")
research23_Collaboration = Class(name="research23_Collaboration")
research23_Paragraph = Class(name="research23_Paragraph")
research23_Progress = Class(name="research23_Progress")
research23_Phase = Class(name="research23_Phase")
research23_Researcher = Class(name="research23_Researcher")
research23_Write = Class(name="research23_Write")
research23_Review = Class(name="research23_Review")
research23_ReviewNote = Class(name="research23_ReviewNote")
Labelled = Class(name="Labelled")
research23_PaperKeyword = Class(name="research23_PaperKeyword")
research23_State = Class(name="research23_State")
Counted = Class(name="Counted")
research23_KnowledgeManager = Class(name="research23_KnowledgeManager")
research23_PublicationStatus = Class(name="research23_PublicationStatus")
research23_PublicationSystem = Class(name="research23_PublicationSystem")
research23_PublicationStructure = Class(name="research23_PublicationStructure")
research23_Keyword = Class(name="research23_Keyword")
research23_Named = Class(name="research23_Named", is_abstract=True)
research23_Counted = Class(name="research23_Counted", is_abstract=True)
research23_Labelled = Class(name="research23_Labelled", is_abstract=True)
research23_Transition = Class(name="research23_Transition")
StateMachineObject = Class(name="StateMachineObject")
research23_Action = Class(name="research23_Action")
research23_StateMachineVariable = Class(name="research23_StateMachineVariable")
research23_StateMachineObject = Class(name="research23_StateMachineObject", is_abstract=True)
...
research23_PublicationProcess.attributes={research23_PublicationProcess_minTime, research23_PublicationProcess_maxTime}
...
research23_Researcher.attributes={research23_Researcher_name, research23_Researcher_forName}
...
research23_State.attributes={research23_State_name, research23_State_kind, research23_State_id}
...
research23_Transition.attributes={research23_Transition_guardExpression, research23_Transition_guardLabel}
...
research23_Action.attributes={research23_Action_actionStatement, research23_Action_actionLabel}
...
domain_model = DomainModel(
    name="research23",
    types={research23_PublicationProcess, Named, research23_Paper, research23_Skill, research23_Position, research23_Collaboration, research23_Paragraph, research23_Progress, research23_Phase, research23_Researcher, research23_Write, research23_Review, research23_ReviewNote, Labelled, research23_PaperKeyword, research23_State, Counted, research23_KnowledgeManager, research23_PublicationStatus, research23_PublicationSystem, research23_PublicationStructure, research23_Keyword, research23_Named, research23_Counted, research23_Labelled, research23_Transition, StateMachineObject, research23_Action, research23_StateMachineVariable, research23_StateMachineObject, StateType},
    associations={res_papers4, skills5, res_position7, collaborations9, paragraphs11, progress12, phases0, writes1, reviews2, reviews21, process23, paper25, authors13, keywords14, citedBy17, state19, researchers33, papers35, knowledgeMan38, status40, processView42, structuralView44, positions47, paragraph27, reviewNote30, kpapers53, allkeywords55, parent51, t_actions69, source70, target73, keyword58, col_paper61, machineVariables64, pubStates66, next83, transitions76, s_actions79},
    generalizations={gen_research23_PublicationProcess_Named, gen_research23_Paper_Named, gen_research23_ReviewNote_Named, gen_research23_Progress_Labelled, gen_research23_Write_Labelled, gen_research23_Paragraph_Counted, gen_research23_Paragraph_Named, gen_research23_PublicationSystem_Named, gen_research23_Review_Labelled, gen_research23_PublicationStructure_Named, gen_research23_Keyword_Named, gen_research23_KnowledgeManager_Named, gen_research23_Position_Named, gen_research23_Transition_StateMachineObject, gen_research23_State_StateMachineObject},
    metadata=None
)
