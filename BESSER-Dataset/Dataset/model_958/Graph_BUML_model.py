...
domain_model = DomainModel(
    name="graph",
    types={graph_Graph, Vertex, graph_Edge, graph_Vertex, Attributable, Adaptable},
    associations={edges0, vertices1, successors13, neighbors16, source18, target19, incoming3, outgoing4, connecting6, predecessors10},
    generalizations={gen_graph_Graph_Vertex, gen_graph_Vertex_Attributable, gen_graph_Vertex_Adaptable, gen_graph_Edge_Attributable},
    metadata=None
)
