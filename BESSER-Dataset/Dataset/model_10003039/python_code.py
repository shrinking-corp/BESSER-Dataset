...
class Leave:
    ...
    def __init__(self, leave_id: int, Emp_Id: int, Leave_Title: str, Leave_detail: str, Leave_ApplyDate: date, Leave_EndDate: date, Leave_StartDate: date, Leave_NoOfDays: int, Leave_Status: str, employee1: "Employee" = None):
...
class Employee:
    ...
    def __init__(self, Emp_Address: str, Emp_DOB: date, Emp_Department: str, Emp_Date_Of_Joint: date, Emp_Position: str, Emp_Salary: float, Emp_Id: int, Emp_Name: str, Emp_ContactNo: str, Emp_Email: str, Emp_NIC: str, leave0: "Leave" = None, attendance2: "Attendance" = None, salary4: "Salary" = None):
