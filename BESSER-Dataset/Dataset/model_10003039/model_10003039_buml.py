...
Employee.attributes={Employee_Emp_Date_Of_Joint, Employee_Emp_Id, Employee_Emp_DOB, Employee_Emp_Department, Employee_Emp_Salary, Employee_Emp_Name, Employee_Emp_Address, Employee_Emp_NIC, Employee_Emp_ContactNo, Employee_Emp_Position, Employee_Emp_Email}
...
Salary.attributes={Salary_Sly_Increment, Salary_Sly_Decrement, Salary_Sly_Basic, Salary_OverTime, Salary_Sly_Netgross, Salary_Emp_Id}
...
Leave.attributes={Leave_leave_id, Leave_Leave_detail, Leave_Leave_NoOfDays, Leave_Leave_ApplyDate, Leave_Leave_EndDate, Leave_Emp_Id, Leave_Leave_Title, Leave_Leave_StartDate, Leave_Leave_Status}
...
domain_model = DomainModel(
    name="f818e6f9_5192_4d0a_8440_ff3254e3679d",
