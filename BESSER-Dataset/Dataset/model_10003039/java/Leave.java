...
public class Leave  {
    ...
    public Leave(
        int leave_id,        LocalDate Leave_EndDate,        int Leave_NoOfDays,        int Emp_Id,        String Leave_detail,        String Leave_Title,        LocalDate Leave_ApplyDate,        String Leave_Status,        LocalDate Leave_StartDate    ) {
