...
class shr5_GebundenerGeist:
    ...
    def __init__(self, dienste: int, shr5_GebundenerGeist90: "shr5_Geist" = None, shr5_GebundenerGeist: "shr5_Zauberer" = None, shr5_GebundenerGeist61: "shr5_Zauberer" = None):
...
class MagischeMods:
    ...
    pass
class shr5_KiKraft(MagischeMods, Erlernbar):
...
class AbstraktPersona:
    ...
    pass
class shr5_KoerperPersona(Panzerung, PersonaZustand, AbstraktPersona, BerechneteAttribute):
...
class AbstraktModifikatoren:
    ...
    pass
class shr5_PersonaEigenschaft(AbstraktModifikatoren, Erlernbar):
...
class shr5_Projektilwaffe(AbstaktFernKampfwaffe):
    ...
    pass
class shr5_Wurfwaffe(AbstaktFernKampfwaffe, Menge):
...
class GeldWert:
    ...
    pass
class shr5_Cyberware(Capacity, Koerpermods, GeldWert):
...
class shr5_BioWare(Koerpermods, GeldWert):
    ...
    pass
class shr5_CyberwareEnhancement(AbstraktModifikatoren, GeldWert):
...
class shr5_FernkampfwaffeModifikator(AbstraktModifikatoren, GeldWert):
...
class shr5_Sichtverhaeltnisse(ModifikatorAttribute):
    ...
    def __init__(self, restlichtverstaerkung: str, infrarot: str, ultrasound: str):
        ...
        pass
    @property
    def restlichtverstaerkung(self):
...
class shr5_FernkampfwaffenModifikatoren(ModifikatorAttribute):
    ...
    def __init__(self, smartgun: str, rueckstoss: int, lasterPointer: bool, schalldaempfer: bool, vergroesserung: int, sichtverbesserung: int):
...
class AbstraktGegenstand:
    ...
    pass
class shr5_Magazin(Capacity, AbstraktGegenstand):
...
class shr5_Beschreibbar(ABC):
    ...
    def __init__(self, beschreibung: str, image: str, name: str):
...
class Beschreibbar:
    ...
    pass
class shr5_AbstraktGegenstand(Anwendbar, Modifizierbar, Quelle, GeldWert, Beschreibbar):

    pass
class shr5_Fertigkeit(Quelle, Beschreibbar, Modifyable):

    def __init__(self, kategorie: str, ausweichen: bool, shr5_Fertigkeit95: "shr5_StufenPersona" = None, Fertigkeit: "shr5_Spezialisierung" = None, shr5_Fertigkeit: "shr5_FertigkeitsGruppe" = None, shr5_Fertigkeit21: "shr5_EAttribute" = None, fertigkeit: set["shr5_Spezialisierung"] = None, shr5_Fertigkeit26: "shr5_PersonaFertigkeit" = None, shr5_Fertigkeit52: "shr5_Anwendbar" = None, shr5_Fertigkeit120: "shr5_AutoSoft" = None, shr5_Fertigkeit127: "shr5_Tutorsoft" = None, shr5_Fertigkeit129: "shr5_SkillSoft" = None, shr5_Fertigkeit164: "shr5_MartialartStyle" = None):
        self.kategorie = kategorie
        self.ausweichen = ausweichen
...
class shr5_AbstraktModifikatoren(Quelle, Beschreibbar, Modifizierbar):
...
class shr5_ShrList(Beschreibbar, Identifiable):

    pass
class shr5_Reichweite(Beschreibbar, Identifiable):
...
class shr5_AbstraktPersona(SpezielleAttribute, ChrakterLimits, Beschreibbar, KoerperlicheAttribute, GeistigeAttribute):
    ...
    @property
    def geschicklichkeitBasis(self):
...
class shr5_FertigkeitsGruppe(Quelle, Beschreibbar, Modifyable):

    pass
class shr5_Spezies(Quelle, Beschreibbar, Modifizierbar):
...
class shr5_Spezialisierung(Quelle, Beschreibbar, Modifyable, Erlernbar):

    pass
class shr5_SourceBook(Beschreibbar, Identifiable):
...
class Munition:
    ...
    pass
class shr5_MiniGrenate(Munition, AbtraktGranate):
...
class shr5_Sensor(Quelle, Beschreibbar, Capacity, GeldWert):
...
class shr5_TransferAmount(CredstickTransaction):
    ...
    def __init__(self, amountToTransfer: str, shr5_TransferAmount158: "shr5_Credstick" = None, shr5_TransferAmount: "shr5_Credstick" = None):
...
class shr5_Drug(Substance, Modifizierbar):
    ...
    def __init__(self, duration: str, addictionType: str):
        self.duration = duration
        self.addictionType = addictionType
        
        pass
    @property
    def addictionType(self):
...
class shr5_Capacity(ABC):
    ...
    def canAdd(self, shr5_object) :
        # TODO: Implement canAdd method
        pass

class shr5_Substance(Quelle, Beschreibbar, GeldWert, Menge):

    def __init__(self, vector: str, speed: str, shr5_Substance174: "shr5_AbtraktGranate" = None, shr5_Substance: "shr5_SubstanceContainer" = None):
        self.vector = vector
        self.speed = speed
...
class Fokus:
    ...
    pass
class shr5_WaffenFokus(Fokus, Nahkampfwaffe):
...
class shr5_BerechneteAttribute(ABC):
    ...
    def __init__(self, errinerungsvermoegen: int, menschenkenntnis: int, selbstbeherrschung: int):
...
class shr5_Software(Quelle, Beschreibbar, GeldWert):
...
class shr5_CyberwareModifikatioren(ModifikatorAttribute):
    ...
    def __init__(self, directNeuralInterface: bool, universalDataConnector: bool, riggerInterface: bool, controlRig: int, simRig: int):
    ...
    @property
    def universalDataConnector(self):
    ...
    @property
    def directNeuralInterface(self):
...
class MatrixProgram:
    ...
    pass
class shr5_CommonProgram(RiggerProgram, MatrixProgram):
...
class shr5_RiggerCommandConsole(AbstractMatrixDevice):
    ...
    @property
    def datenverarbeitungBasis(self):
...
class StufenPersona:
    ...
    pass
class shr5_StufenPersona(Panzerung, Quelle, SpezielleAttribute, ChrakterLimits, Beschreibbar, KoerperlicheAttribute, GeistigeAttribute):
...
class shr5_IntervallVertrag(Vertrag):
    ...
    def __init__(self, unit: str, begin: str, faelligkeitsIntervall: int):
        ...
        pass
    @property
    def faelligkeitsIntervall(self):
...
class shr5_PersonaZustand(ABC):
    ...
    def __init__(self, zustandKoerperlichMax: int, zustandGeistigMax: int, zustandGrenze: int):
        ...
        pass
    @property
    def zustandKoerperlichMax(self):
...
class shr5_Credstick(AbstraktGegenstand):
    ...
    def __init__(self, maxValue: int, currentValue: str, shr5_Credstick: set["shr5_CredstickTransaction"] = None, shr5_Credstick159: "shr5_TransferAmount" = None, shr5_Credstick156: "shr5_TransferAmount" = None):
...
class shr5_PersonaKomplexForm(Erlernbar):
    ...
    def __init__(self, stufe: int, shr5_PersonaKomplexForm81: "shr5_KomplexeForm" = None, shr5_PersonaKomplexForm: "shr5_Technomancer" = None):
        self.stufe = stufe
...
class ResonanzPersona:
    ...
    pass
class shr5_Technomancer(KoerperPersona, ResonanzPersona):

    pass
class shr5_LifestyleOption(Quelle, Beschreibbar, GeldWert):
...
class shr5_Vertrag(Quelle, Beschreibbar, GeldWert):

    pass
class shr5_Sprite(Quelle, Beschreibbar, ResonanzPersona):
...
class ActiveMatixDevice:
    ...
    pass
class shr5_Cyberdeck(Capacity, AbstractMatrixDevice, ActiveMatixDevice, MatrixDevice):

    def __init__(self, programSlots: int, attribute1: int, attribute2: int, attribute3: int, attribute4: int, modManager: str, shr5_Cyberdeck112: set["shr5_MatrixProgram"] = None, shr5_Cyberdeck: set["shr5_EAttribute"] = None, shr5_Cyberdeck110: set["shr5_MatrixProgram"] = None):
...
class shr5_Host(Beschreibbar, ActiveMatixDevice, MatrixDevice):
    ...
    @property
    def baseDatenverarbeitung(self):
...
class shr5_Bodenfahrzeug(PassagierFahrzeug):
    ...
    def __init__(self, handlingGelaende: int, geschwindigkeitGelaende: int):
        ...
        pass
    @property
    def geschwindigkeitGelaende(self):
...
class shr5_SensorArray(Sensor):
    ...
    pass
class shr5_FahrzeugModifikation(Quelle, Beschreibbar, GeldWert):
...
class FahrzeugZustand:
    ...
    pass
class shr5_Fahrzeug(Capacity, Anwendbar, Modifizierbar, Quelle, GeldWert, Beschreibbar, FahrzeugZustand):

    def __init__(self, handling: int, geschwindigkeit: int, beschleunigung: int, rumpf: int, pilot: int, sensor: int, fahrzeugTyp: str, panzer: int, weaponMounts: int, shr5_Fahrzeug: set["shr5_FahrzeugModifikation"] = None, shr5_Fahrzeug72: "shr5_SensorArray" = None):
...
class shr5_AstraleProjektion(ABC):
    ...
    @property
    def astraleInitativWuerfel(self):
    ...
    @property
    def astraleGeschicklichkeit(self):
...
class AstraleProjektion:
    ...
    pass
class shr5_Geist(AstraleProjektion, StufenPersona):

    def __init__(self, konstitutionBasis: int, geschicklichkeitBasis: int, reaktionBasis: int, staerkeBasis: int, charismaBasis: int, willenskraftBasis: int, intuitionBasis: int, logikBasis: int, shr5_Geist: "shr5_GebundenerGeist" = None, shr5_Geist97: set["shr5_CritterKraft"] = None, shr5_Geist100: set["shr5_CritterKraft"] = None, shr5_Geist153: "shr5_MagischeTradition" = None):
        self.konstitutionBasis = konstitutionBasis
        self.geschicklichkeitBasis = geschicklichkeitBasis
        self.reaktionBasis = reaktionBasis
        self.staerkeBasis = staerkeBasis
...
class shr5_MysticAdept(Zauberer, KiAdept):
    ...
    pass
class shr5_Magier(AstraleProjektion, MagischePersona, Zauberer):
...
class shr5_Anwendbar(ABC):
    ...
    pass
class shr5_KleindungsModifikator(Quelle, Beschreibbar, GeldWert):
