...
shr5_AbstraktPersona = Class(name="shr5_AbstraktPersona", is_abstract=True)
shr5_Beschreibbar = Class(name="shr5_Beschreibbar", is_abstract=True)
shr5_Quelle = Class(name="shr5_Quelle", is_abstract=True)
Identifiable = Class(name="Identifiable")
shr5_SourceBook = Class(name="shr5_SourceBook")
...
shr5_PersonaFertigkeit = Class(name="shr5_PersonaFertigkeit")
shr5_PersonaFertigkeitsGruppe = Class(name="shr5_PersonaFertigkeitsGruppe")
shr5_Spezies = Class(name="shr5_Spezies")
shr5_PersonaMartialartStyle = Class(name="shr5_PersonaMartialartStyle")
shr5_Gegenstand = Class(name="shr5_Gegenstand")
AbstraktGegenstand = Class(name="AbstraktGegenstand")
shr5_GeldWert = Class(name="shr5_GeldWert", is_abstract=True)
shr5_Reichweite = Class(name="shr5_Reichweite")
shr5_AbstaktWaffe = Class(name="shr5_AbstaktWaffe", is_abstract=True)
shr5_Nahkampfwaffe = Class(name="shr5_Nahkampfwaffe")
shr5_AttributModifikatorWert = Class(name="shr5_AttributModifikatorWert")
shr5_EAttribute = Class(name="shr5_EAttribute")
shr5_Modifizierbar = Class(name="shr5_Modifizierbar", is_abstract=True)
shr5_Modifyable = Class(name="shr5_Modifyable", is_abstract=True)
shr5_KoerperlicheAttribute = Class(name="shr5_KoerperlicheAttribute", is_abstract=True)
ModifikatorAttribute = Class(name="ModifikatorAttribute")
shr5_SpezielleAttribute = Class(name="shr5_SpezielleAttribute", is_abstract=True)
shr5_AbstraktGegenstand = Class(name="shr5_AbstraktGegenstand", is_abstract=True)
Quelle = Class(name="Quelle")
GeldWert = Class(name="GeldWert")
Modifizierbar = Class(name="Modifizierbar")
Anwendbar = Class(name="Anwendbar")
shr5_MatrixDevice = Class(name="shr5_MatrixDevice", is_abstract=True)
shr5_AbstaktFernKampfwaffe = Class(name="shr5_AbstaktFernKampfwaffe", is_abstract=True)
AbstaktWaffe = Class(name="AbstaktWaffe")
shr5_Cyberware = Class(name="shr5_Cyberware")
Koerpermods = Class(name="Koerpermods")
Capacity = Class(name="Capacity")
shr5_Feuerwaffe = Class(name="shr5_Feuerwaffe")
AbstaktFernKampfwaffe = Class(name="AbstaktFernKampfwaffe")
shr5_FernkampfwaffeModifikator = Class(name="shr5_FernkampfwaffeModifikator")
shr5_Magazin = Class(name="shr5_Magazin")
shr5_Wurfwaffe = Class(name="shr5_Wurfwaffe")
Menge = Class(name="Menge")
shr5_ShrList = Class(name="shr5_ShrList")
shr5_EObject = Class(name="shr5_EObject")
shr5_Projektilwaffe = Class(name="shr5_Projektilwaffe")
shr5_FertigkeitsGruppe = Class(name="shr5_FertigkeitsGruppe")
Modifyable = Class(name="Modifyable")
shr5_Fertigkeit = Class(name="shr5_Fertigkeit")
shr5_Spezialisierung = Class(name="shr5_Spezialisierung")
Steigerbar = Class(name="Steigerbar")
shr5_MagischePersona = Class(name="shr5_MagischePersona", is_abstract=True)
BaseMagischePersona = Class(name="BaseMagischePersona")
shr5_Schutzgeist = Class(name="shr5_Schutzgeist")
shr5_BaseMagischePersona = Class(name="shr5_BaseMagischePersona", is_abstract=True)
shr5_Initation = Class(name="shr5_Initation")
shr5_CyberwareEnhancement = Class(name="shr5_CyberwareEnhancement")
shr5_DefaultWifi = Class(name="shr5_DefaultWifi")
shr5_BioWare = Class(name="shr5_BioWare")
shr5_Koerpermods = Class(name="shr5_Koerpermods", is_abstract=True)
AbstraktModifikatoren = Class(name="AbstraktModifikatoren")
shr5_AbstraktModifikatoren = Class(name="shr5_AbstraktModifikatoren", is_abstract=True)
shr5_GeistigeAttribute = Class(name="shr5_GeistigeAttribute", is_abstract=True)
shr5_MudanPersona = Class(name="shr5_MudanPersona")
KoerperPersona = Class(name="KoerperPersona")
shr5_KoerperPersona = Class(name="shr5_KoerperPersona", is_abstract=True)
...
shr5_PersonaEigenschaft = Class(name="shr5_PersonaEigenschaft")
shr5_MagischeMods = Class(name="shr5_MagischeMods", is_abstract=True)
shr5_KiKraft = Class(name="shr5_KiKraft")
MagischeMods = Class(name="MagischeMods")
Erlernbar = Class(name="Erlernbar")
shr5_GegenstandStufen = Class(name="shr5_GegenstandStufen", is_abstract=True)
shr5_FokusBinding = Class(name="shr5_FokusBinding")
shr5_FernkampfwaffenModifikatoren = Class(name="shr5_FernkampfwaffenModifikatoren", is_abstract=True)
shr5_Sichtverhaeltnisse = Class(name="shr5_Sichtverhaeltnisse", is_abstract=True)
shr5_GebundenerGeist = Class(name="shr5_GebundenerGeist")
shr5_MagischeTradition = Class(name="shr5_MagischeTradition")
shr5_KiAdept = Class(name="shr5_KiAdept")
shr5_MysticAdept = Class(name="shr5_MysticAdept")
MagischePersona = Class(name="MagischePersona")
KiAdept = Class(name="KiAdept")
shr5_Kleidung = Class(name="shr5_Kleidung")
shr5_Zauber = Class(name="shr5_Zauber")
shr5_KleindungsModifikator = Class(name="shr5_KleindungsModifikator")
shr5_Anwendbar = Class(name="shr5_Anwendbar", is_abstract=True)
shr5_ProbenModifikatoren = Class(name="shr5_ProbenModifikatoren", is_abstract=True)
shr5_Magier = Class(name="shr5_Magier")
Zauberer = Class(name="Zauberer")
AstraleProjektion = Class(name="AstraleProjektion")
shr5_Zauberer = Class(name="shr5_Zauberer", is_abstract=True)
shr5_PersonaZauber = Class(name="shr5_PersonaZauber")
shr5_Panzerung = Class(name="shr5_Panzerung", is_abstract=True)
shr5_AspektMagier = Class(name="shr5_AspektMagier")
shr5_AstraleProjektion = Class(name="shr5_AstraleProjektion", is_abstract=True)
shr5_MetaMagie = Class(name="shr5_MetaMagie")
shr5_ChrakterLimits = Class(name="shr5_ChrakterLimits", is_abstract=True)
shr5_Fahrzeug = Class(name="shr5_Fahrzeug", is_abstract=True)
FahrzeugZustand = Class(name="FahrzeugZustand")
shr5_FahrzeugModifikation = Class(name="shr5_FahrzeugModifikation", is_abstract=True)
shr5_SensorArray = Class(name="shr5_SensorArray")
shr5_Bodenfahrzeug = Class(name="shr5_Bodenfahrzeug")
PassagierFahrzeug = Class(name="PassagierFahrzeug")
shr5_PassagierFahrzeug = Class(name="shr5_PassagierFahrzeug")
Fahrzeug = Class(name="Fahrzeug")
shr5_Drohne = Class(name="shr5_Drohne")
MatrixAttributes = Class(name="MatrixAttributes")
shr5_RiggerProgram = Class(name="shr5_RiggerProgram", is_abstract=True)
shr5_CritterKraft = Class(name="shr5_CritterKraft")
shr5_ResonanzPersona = Class(name="shr5_ResonanzPersona", is_abstract=True)
ActiveMatixDevice = Class(name="ActiveMatixDevice")
shr5_KomplexeForm = Class(name="shr5_KomplexeForm")
shr5_Sprite = Class(name="shr5_Sprite")
shr5_Vertrag = Class(name="shr5_Vertrag")
shr5_Lifestyle = Class(name="shr5_Lifestyle")
IntervallVertrag = Class(name="IntervallVertrag")
shr5_LifestyleOption = Class(name="shr5_LifestyleOption")
shr5_Technomancer = Class(name="shr5_Technomancer")
ResonanzPersona = Class(name="ResonanzPersona")
shr5_PersonaKomplexForm = Class(name="shr5_PersonaKomplexForm")
shr5_Echo = Class(name="shr5_Echo")
shr5_Sin = Class(name="shr5_Sin")
Fakeable = Class(name="Fakeable")
shr5_Lizenz = Class(name="shr5_Lizenz")
shr5_Fakeable = Class(name="shr5_Fakeable", is_abstract=True)
shr5_Steigerbar = Class(name="shr5_Steigerbar", is_abstract=True)
shr5_Erlernbar = Class(name="shr5_Erlernbar", is_abstract=True)
shr5_Credstick = Class(name="shr5_Credstick")
shr5_CredstickTransaction = Class(name="shr5_CredstickTransaction")
shr5_Menge = Class(name="shr5_Menge", is_abstract=True)
shr5_Wissensfertigkeit = Class(name="shr5_Wissensfertigkeit")
Fertigkeit = Class(name="Fertigkeit")
shr5_Sprachfertigkeit = Class(name="shr5_Sprachfertigkeit")
Wissensfertigkeit = Class(name="Wissensfertigkeit")
shr5_PersonaZustand = Class(name="shr5_PersonaZustand", is_abstract=True)
shr5_Critter = Class(name="shr5_Critter")
Spezies = Class(name="Spezies")
shr5_IntervallVertrag = Class(name="shr5_IntervallVertrag")
Vertrag = Class(name="Vertrag")
shr5_ModifikatorAttribute = Class(name="shr5_ModifikatorAttribute", is_abstract=True)
shr5_Geist = Class(name="shr5_Geist")
shr5_StufenPersona = Class(name="shr5_StufenPersona", is_abstract=True)
StufenPersona = Class(name="StufenPersona")
shr5_Identifiable = Class(name="shr5_Identifiable", is_abstract=True)
shr5_Munition = Class(name="shr5_Munition")
shr5_MatrixAttributes = Class(name="shr5_MatrixAttributes", is_abstract=True)
MatixConditionMonitor = Class(name="MatixConditionMonitor")
shr5_ActiveMatixDevice = Class(name="shr5_ActiveMatixDevice", is_abstract=True)
shr5_Commlink = Class(name="shr5_Commlink")
AbstractMatrixDevice = Class(name="AbstractMatrixDevice")
shr5_BasicProgram = Class(name="shr5_BasicProgram", is_abstract=True)
shr5_MatixConditionMonitor = Class(name="shr5_MatixConditionMonitor", is_abstract=True)
shr5_Cyberdeck = Class(name="shr5_Cyberdeck")
MatrixDevice = Class(name="MatrixDevice")
shr5_Localization = Class(name="shr5_Localization")
shr5_SoftwareAgent = Class(name="shr5_SoftwareAgent")
MatrixProgram = Class(name="MatrixProgram")
shr5_Host = Class(name="shr5_Host")
shr5_CyberwareModifikatioren = Class(name="shr5_CyberwareModifikatioren", is_abstract=True)
shr5_MatrixProgram = Class(name="shr5_MatrixProgram", is_abstract=True)
shr5_RiggerCommandConsole = Class(name="shr5_RiggerCommandConsole")
shr5_AutoSoft = Class(name="shr5_AutoSoft")
RiggerProgram = Class(name="RiggerProgram")
shr5_Software = Class(name="shr5_Software", is_abstract=True)
Software = Class(name="Software")
shr5_Tutorsoft = Class(name="shr5_Tutorsoft")
BasicProgram = Class(name="BasicProgram")
shr5_SkillSoft = Class(name="shr5_SkillSoft")
shr5_FahrzeugZustand = Class(name="shr5_FahrzeugZustand", is_abstract=True)
shr5_PersonalAreaNetwork = Class(name="shr5_PersonalAreaNetwork")
shr5_Datasoft = Class(name="shr5_Datasoft")
shr5_AbstractMatrixDevice = Class(name="shr5_AbstractMatrixDevice", is_abstract=True)
shr5_ConsumerSoft = Class(name="shr5_ConsumerSoft")
shr5_CommonProgram = Class(name="shr5_CommonProgram")
shr5_WeaponMount = Class(name="shr5_WeaponMount")
FahrzeugModifikation = Class(name="FahrzeugModifikation")
shr5_PercentLifestyleOption = Class(name="shr5_PercentLifestyleOption")
LifestyleOption = Class(name="LifestyleOption")
shr5_BerechneteAttribute = Class(name="shr5_BerechneteAttribute", is_abstract=True)
shr5_MagischeStufe = Class(name="shr5_MagischeStufe", is_abstract=True)
shr5_Fokus = Class(name="shr5_Fokus", is_abstract=True)
MagischeStufe = Class(name="MagischeStufe")
shr5_AbstraktFokus = Class(name="shr5_AbstraktFokus", is_abstract=True)
Fokus = Class(name="Fokus")
shr5_QiFokus = Class(name="shr5_QiFokus")
AbstraktFokus = Class(name="AbstraktFokus")
shr5_WaffenFokus = Class(name="shr5_WaffenFokus")
Nahkampfwaffe = Class(name="Nahkampfwaffe")
shr5_MagieFokus = Class(name="shr5_MagieFokus")
shr5_Substance = Class(name="shr5_Substance", is_abstract=True)
shr5_Capacity = Class(name="shr5_Capacity", is_abstract=True)
shr5_Toxin = Class(name="shr5_Toxin")
Substance = Class(name="Substance")
shr5_Drug = Class(name="shr5_Drug")
shr5_SubstanceContainer = Class(name="shr5_SubstanceContainer")
shr5_EReference = Class(name="shr5_EReference")
shr5_CyberImplantWeapon = Class(name="shr5_CyberImplantWeapon")
CyberwareEnhancement = Class(name="CyberwareEnhancement")
shr5_ShoppingTransaction = Class(name="shr5_ShoppingTransaction")
CredstickTransaction = Class(name="CredstickTransaction")
shr5_TransferAmount = Class(name="shr5_TransferAmount")
shr5_Sensor = Class(name="shr5_Sensor")
shr5_SensorFunction = Class(name="shr5_SensorFunction")
Sensor = Class(name="Sensor")
shr5_MartialartStyle = Class(name="shr5_MartialartStyle")
shr5_MartialartTechnique = Class(name="shr5_MartialartTechnique")
Spezialisierung = Class(name="Spezialisierung")
shr5_PersonaMartialartTechnique = Class(name="shr5_PersonaMartialartTechnique")
shr5_FahrzeugErweiterung = Class(name="shr5_FahrzeugErweiterung")
shr5_AbtraktGranate = Class(name="shr5_AbtraktGranate", is_abstract=True)
shr5_MiniGrenate = Class(name="shr5_MiniGrenate")
Munition = Class(name="Munition")
AbtraktGranate = Class(name="AbtraktGranate")
shr5_Granate = Class(name="shr5_Granate")
Wurfwaffe = Class(name="Wurfwaffe")
shr5_SourceLink = Class(name="shr5_SourceLink")
...
shr5_AbstraktPersona.attributes={shr5_AbstraktPersona_willenskraftBasis, shr5_AbstraktPersona_logikBasis, shr5_AbstraktPersona_charismaBasis, shr5_AbstraktPersona_reaktionBasis, shr5_AbstraktPersona_konstitutionBasis, shr5_AbstraktPersona_geschicklichkeitBasis, shr5_AbstraktPersona_modManager, shr5_AbstraktPersona_intuitionBasis, shr5_AbstraktPersona_staerkeBasis}
...
shr5_Beschreibbar.attributes={shr5_Beschreibbar_image, shr5_Beschreibbar_name, shr5_Beschreibbar_beschreibung}
...
shr5_Spezies.attributes={shr5_Spezies_logikMin, shr5_Spezies_staerkeMax, shr5_Spezies_magieMax, shr5_Spezies_edgeMax, shr5_Spezies_intuitionMin, shr5_Spezies_geschicklichkeitMax, shr5_Spezies_sprinten, shr5_Spezies_reaktionMin, shr5_Spezies_rennen, shr5_Spezies_essenzMin, shr5_Spezies_magieMin, shr5_Spezies_konstitutionMax, shr5_Spezies_geschicklichkeitMin, shr5_Spezies_intuitionMax, shr5_Spezies_charismaMin, shr5_Spezies_resonanzMax, shr5_Spezies_essenzMax, shr5_Spezies_reaktionMax, shr5_Spezies_konstitutionMin, shr5_Spezies_staerkeMin, shr5_Spezies_logikMax, shr5_Spezies_laufen, shr5_Spezies_charismaMax, shr5_Spezies_edgeMin, shr5_Spezies_willenskraftMax, shr5_Spezies_willenskraftMin, shr5_Spezies_resonanzMin}
...
shr5_GeldWert.attributes={shr5_GeldWert_verfuegbarkeit, shr5_GeldWert_wert, shr5_GeldWert_wertValue}
...
shr5_Reichweite.attributes={shr5_Reichweite_mittel, shr5_Reichweite_min, shr5_Reichweite_extrem, shr5_Reichweite_kurz, shr5_Reichweite_weit}
...
shr5_AbstaktWaffe.attributes={shr5_AbstaktWaffe_schadesTyp, shr5_AbstaktWaffe_praezision, shr5_AbstaktWaffe_schadenscode, shr5_AbstaktWaffe_durchschlagsKraft}
...
shr5_KoerperlicheAttribute.attributes={shr5_KoerperlicheAttribute_reaktion, shr5_KoerperlicheAttribute_staerke, shr5_KoerperlicheAttribute_geschicklichkeit, shr5_KoerperlicheAttribute_konstitution}
...
shr5_SpezielleAttribute.attributes={shr5_SpezielleAttribute_initativWuerfel, shr5_SpezielleAttribute_ausweichen, shr5_SpezielleAttribute_edgeBasis, shr5_SpezielleAttribute_essenz, shr5_SpezielleAttribute_edge, shr5_SpezielleAttribute_initative}
...
shr5_Feuerwaffe.attributes={shr5_Feuerwaffe_rueckstoss, shr5_Feuerwaffe_kapazitaet, shr5_Feuerwaffe_erweiterung, shr5_Feuerwaffe_munitionstyp, shr5_Feuerwaffe_modie}
...
shr5_Fertigkeit.attributes={shr5_Fertigkeit_ausweichen, shr5_Fertigkeit_kategorie}
...
shr5_Schutzgeist.attributes={shr5_Schutzgeist_nachteile, shr5_Schutzgeist_vorteile}
...
shr5_CyberwareEnhancement.attributes={shr5_CyberwareEnhancement_capacityUse, shr5_CyberwareEnhancement_type}
...
shr5_GeistigeAttribute.attributes={shr5_GeistigeAttribute_logik, shr5_GeistigeAttribute_willenskraft, shr5_GeistigeAttribute_intuition, shr5_GeistigeAttribute_charisma}
...
shr5_KoerperPersona.attributes={shr5_KoerperPersona_zustandGeistig, shr5_KoerperPersona_zustandKoerperlich}
...
shr5_GegenstandStufen.attributes={shr5_GegenstandStufen_protection, shr5_GegenstandStufen_elektronik, shr5_GegenstandStufen_antiTracing, shr5_GegenstandStufen_antiProtection, shr5_GegenstandStufen_tracing, shr5_GegenstandStufen_computer}
...
shr5_FernkampfwaffenModifikatoren.attributes={shr5_FernkampfwaffenModifikatoren_rueckstoss, shr5_FernkampfwaffenModifikatoren_sichtverbesserung, shr5_FernkampfwaffenModifikatoren_vergroesserung, shr5_FernkampfwaffenModifikatoren_smartgun, shr5_FernkampfwaffenModifikatoren_lasterPointer, shr5_FernkampfwaffenModifikatoren_schalldaempfer}
...
shr5_Sichtverhaeltnisse.attributes={shr5_Sichtverhaeltnisse_restlichtverstaerkung, shr5_Sichtverhaeltnisse_ultrasound, shr5_Sichtverhaeltnisse_infrarot}
...
shr5_Zauber.attributes={shr5_Zauber_art, shr5_Zauber_entzug, shr5_Zauber_schaden, shr5_Zauber_merkmale, shr5_Zauber_dauer, shr5_Zauber_kategorie, shr5_Zauber_reichweite}
...
shr5_KleindungsModifikator.attributes={shr5_KleindungsModifikator_rating, shr5_KleindungsModifikator_capacity, shr5_KleindungsModifikator_type}
...
shr5_ProbenModifikatoren.attributes={shr5_ProbenModifikatoren_heilung, shr5_ProbenModifikatoren_schadenswiederstand}
...
shr5_AstraleProjektion.attributes={shr5_AstraleProjektion_astraleStaerke, shr5_AstraleProjektion_astraleInitative, shr5_AstraleProjektion_astraleKonstitution, shr5_AstraleProjektion_astraleGeschicklichkeit, shr5_AstraleProjektion_astralesLimit, shr5_AstraleProjektion_astralePanzerung, shr5_AstraleProjektion_astraleReaktion, shr5_AstraleProjektion_astraleInitativWuerfel}
...
shr5_ChrakterLimits.attributes={shr5_ChrakterLimits_geistig, shr5_ChrakterLimits_sozial, shr5_ChrakterLimits_koerperlich}
...
shr5_Fahrzeug.attributes={shr5_Fahrzeug_rumpf, shr5_Fahrzeug_handling, shr5_Fahrzeug_panzer, shr5_Fahrzeug_sensor, shr5_Fahrzeug_weaponMounts, shr5_Fahrzeug_beschleunigung, shr5_Fahrzeug_pilot, shr5_Fahrzeug_geschwindigkeit, shr5_Fahrzeug_fahrzeugTyp}
...
shr5_Bodenfahrzeug.attributes={shr5_Bodenfahrzeug_handlingGelaende, shr5_Bodenfahrzeug_geschwindigkeitGelaende}
...
shr5_CritterKraft.attributes={shr5_CritterKraft_reichweite, shr5_CritterKraft_handlung, shr5_CritterKraft_dauer, shr5_CritterKraft_art}
...
shr5_ResonanzPersona.attributes={shr5_ResonanzPersona_resonanz, shr5_ResonanzPersona_resonanzBasis}
...
shr5_KomplexeForm.attributes={shr5_KomplexeForm_schwund, shr5_KomplexeForm_dauer, shr5_KomplexeForm_ziel}
...
shr5_Sprite.attributes={shr5_Sprite_firewallMod, shr5_Sprite_stufe, shr5_Sprite_angriffMod, shr5_Sprite_datenverarbeitungMod, shr5_Sprite_initativeMod, shr5_Sprite_schleicherMod}
...
shr5_Fakeable.attributes={shr5_Fakeable_stufe, shr5_Fakeable_gefaelscht}
...
shr5_Credstick.attributes={shr5_Credstick_maxValue, shr5_Credstick_currentValue}
...
shr5_PersonaZustand.attributes={shr5_PersonaZustand_zustandKoerperlichMax, shr5_PersonaZustand_zustandGeistigMax, shr5_PersonaZustand_zustandGrenze}
...
shr5_IntervallVertrag.attributes={shr5_IntervallVertrag_unit, shr5_IntervallVertrag_faelligkeitsIntervall, shr5_IntervallVertrag_begin}
...
shr5_Geist.attributes={shr5_Geist_charismaBasis, shr5_Geist_staerkeBasis, shr5_Geist_logikBasis, shr5_Geist_reaktionBasis, shr5_Geist_willenskraftBasis, shr5_Geist_geschicklichkeitBasis, shr5_Geist_intuitionBasis, shr5_Geist_konstitutionBasis}
...
shr5_Munition.attributes={shr5_Munition_damageType, shr5_Munition_armorMod, shr5_Munition_damageMod}
...
shr5_MatrixAttributes.attributes={shr5_MatrixAttributes_currentModus, shr5_MatrixAttributes_geraetestufe, shr5_MatrixAttributes_firewall, shr5_MatrixAttributes_datenverarbeitung}
...
shr5_ActiveMatixDevice.attributes={shr5_ActiveMatixDevice_angriff, shr5_ActiveMatixDevice_schleicher}
...
shr5_Cyberdeck.attributes={shr5_Cyberdeck_attribute2, shr5_Cyberdeck_attribute4, shr5_Cyberdeck_attribute3, shr5_Cyberdeck_modManager, shr5_Cyberdeck_programSlots, shr5_Cyberdeck_attribute1}
...
shr5_Localization.attributes={shr5_Localization_page, shr5_Localization_local, shr5_Localization_name}
...
shr5_Host.attributes={shr5_Host_baseAngriff, shr5_Host_baseDatenverarbeitung, shr5_Host_baseFirewall, shr5_Host_baseSchleicher, shr5_Host_hostRating}
...
shr5_CyberwareModifikatioren.attributes={shr5_CyberwareModifikatioren_controlRig, shr5_CyberwareModifikatioren_simRig, shr5_CyberwareModifikatioren_universalDataConnector, shr5_CyberwareModifikatioren_riggerInterface, shr5_CyberwareModifikatioren_directNeuralInterface}
...
shr5_RiggerCommandConsole.attributes={shr5_RiggerCommandConsole_datenverarbeitungBasis, shr5_RiggerCommandConsole_rauschunterdrueckung, shr5_RiggerCommandConsole_firewallBasis, shr5_RiggerCommandConsole_zugriffBasis, shr5_RiggerCommandConsole_zugriff}
...
shr5_BerechneteAttribute.attributes={shr5_BerechneteAttribute_errinerungsvermoegen, shr5_BerechneteAttribute_selbstbeherrschung, shr5_BerechneteAttribute_menschenkenntnis}
...
shr5_Capacity_m_canAdd: Method = Method(name="canAdd", parameters={Parameter(name='shr5_object', type=StringType)}, type=BooleanType)
...
shr5_Toxin.attributes={shr5_Toxin_penetration, shr5_Toxin_effect, shr5_Toxin_power}
...
shr5_Drug.attributes={shr5_Drug_addictionType, shr5_Drug_duration}
...
domain_model = DomainModel(
    name="shr5",
    types={Beschreibbar, shr5_AbstraktPersona, shr5_Beschreibbar, shr5_Quelle, Identifiable, shr5_SourceBook, KoerperlicheAttribute, SpezielleAttribute, GeistigeAttribute, ChrakterLimits, shr5_PersonaFertigkeit, shr5_PersonaFertigkeitsGruppe, shr5_Spezies, shr5_PersonaMartialartStyle, shr5_Gegenstand, AbstraktGegenstand, shr5_GeldWert, shr5_Reichweite, shr5_AbstaktWaffe, shr5_Nahkampfwaffe, shr5_AttributModifikatorWert, shr5_EAttribute, shr5_Modifizierbar, shr5_Modifyable, shr5_KoerperlicheAttribute, ModifikatorAttribute, shr5_SpezielleAttribute, shr5_AbstraktGegenstand, Quelle, GeldWert, Modifizierbar, Anwendbar, shr5_MatrixDevice, shr5_AbstaktFernKampfwaffe, AbstaktWaffe, shr5_Cyberware, Koerpermods, Capacity, shr5_Feuerwaffe, AbstaktFernKampfwaffe, shr5_FernkampfwaffeModifikator, shr5_Magazin, shr5_Wurfwaffe, Menge, shr5_ShrList, shr5_EObject, shr5_Projektilwaffe, shr5_FertigkeitsGruppe, Modifyable, shr5_Fertigkeit, shr5_Spezialisierung, Steigerbar, shr5_MagischePersona, BaseMagischePersona, shr5_Schutzgeist, shr5_BaseMagischePersona, shr5_Initation, shr5_CyberwareEnhancement, shr5_DefaultWifi, shr5_BioWare, shr5_Koerpermods, AbstraktModifikatoren, shr5_AbstraktModifikatoren, shr5_GeistigeAttribute, shr5_MudanPersona, KoerperPersona, shr5_KoerperPersona, AbstraktPersona, Panzerung, PersonaZustand, BerechneteAttribute, shr5_PersonaEigenschaft, shr5_MagischeMods, shr5_KiKraft, MagischeMods, Erlernbar, shr5_GegenstandStufen, shr5_FokusBinding, shr5_FernkampfwaffenModifikatoren, shr5_Sichtverhaeltnisse, shr5_GebundenerGeist, shr5_MagischeTradition, shr5_KiAdept, shr5_MysticAdept, MagischePersona, KiAdept, shr5_Kleidung, shr5_Zauber, shr5_KleindungsModifikator, shr5_Anwendbar, shr5_ProbenModifikatoren, shr5_Magier, Zauberer, AstraleProjektion, shr5_Zauberer, shr5_PersonaZauber, shr5_Panzerung, shr5_AspektMagier, shr5_AstraleProjektion, shr5_MetaMagie, shr5_ChrakterLimits, shr5_Fahrzeug, FahrzeugZustand, shr5_FahrzeugModifikation, shr5_SensorArray, shr5_Bodenfahrzeug, PassagierFahrzeug, shr5_PassagierFahrzeug, Fahrzeug, shr5_Drohne, MatrixAttributes, shr5_RiggerProgram, shr5_CritterKraft, shr5_ResonanzPersona, ActiveMatixDevice, shr5_KomplexeForm, shr5_Sprite, shr5_Vertrag, shr5_Lifestyle, IntervallVertrag, shr5_LifestyleOption, shr5_Technomancer, ResonanzPersona, shr5_PersonaKomplexForm, shr5_Echo, shr5_Sin, Fakeable, shr5_Lizenz, shr5_Fakeable, shr5_Steigerbar, shr5_Erlernbar, shr5_Credstick, shr5_CredstickTransaction, shr5_Menge, shr5_Wissensfertigkeit, Fertigkeit, shr5_Sprachfertigkeit, Wissensfertigkeit, shr5_PersonaZustand, shr5_Critter, Spezies, shr5_IntervallVertrag, Vertrag, shr5_ModifikatorAttribute, shr5_Geist, shr5_StufenPersona, StufenPersona, shr5_Identifiable, shr5_Munition, shr5_MatrixAttributes, MatixConditionMonitor, shr5_ActiveMatixDevice, shr5_Commlink, AbstractMatrixDevice, shr5_BasicProgram, shr5_MatixConditionMonitor, shr5_Cyberdeck, MatrixDevice, shr5_Localization, shr5_SoftwareAgent, MatrixProgram, shr5_Host, shr5_CyberwareModifikatioren, shr5_MatrixProgram, shr5_RiggerCommandConsole, shr5_AutoSoft, RiggerProgram, shr5_Software, Software, shr5_Tutorsoft, BasicProgram, shr5_SkillSoft, shr5_FahrzeugZustand, shr5_PersonalAreaNetwork, shr5_Datasoft, shr5_AbstractMatrixDevice, shr5_ConsumerSoft, shr5_CommonProgram, shr5_WeaponMount, FahrzeugModifikation, shr5_PercentLifestyleOption, LifestyleOption, shr5_BerechneteAttribute, shr5_MagischeStufe, shr5_Fokus, MagischeStufe, shr5_AbstraktFokus, Fokus, shr5_QiFokus, AbstraktFokus, shr5_WaffenFokus, Nahkampfwaffe, shr5_MagieFokus, shr5_Substance, shr5_Capacity, shr5_Toxin, Substance, shr5_Drug, shr5_SubstanceContainer, shr5_EReference, shr5_CyberImplantWeapon, CyberwareEnhancement, shr5_ShoppingTransaction, CredstickTransaction, shr5_TransferAmount, shr5_Sensor, shr5_SensorFunction, Sensor, shr5_MartialartStyle, shr5_MartialartTechnique, Spezialisierung, shr5_PersonaMartialartTechnique, shr5_FahrzeugErweiterung, shr5_AbtraktGranate, shr5_MiniGrenate, Munition, AbtraktGranate, shr5_Granate, Wurfwaffe, shr5_SourceLink, FeuerModus, SchadensTyp, MagazinTyp, FeuwerwaffenErweiterung, ModifikatorType, SmartgunType, ZauberArt, ZauberReichweite, ZauberDauer, CritterHandlung, CritterReichweite, CritterDauer, ResonanzZiel, InterfaceModus, ProgramType, MatrixProgramType, SubstanceVector, SubstanceEffect, AddictionType, TimeUnits, CyberwareType, Enzug, armorModificationType},
    associations={srcBook0, fertigkeiten1, fertigkeitsGruppen2, spezies4, martialartStyles6, reichweite14, attribut8, modifiziertes9, modifyable10, mods12, wifi13, gruppe29, persona32, einbau15, magazin16, entries18, fertigkeiten19, attribut20, spezialisierungen23, fertigkeit24, spezialisierungen27, mentor43, einbau34, wifi36, persona38, koerperMods40, eigenschaften41, initationen44, boundFoki45, angriff47, gebundeneGeister57, ungebundenerGeist59, tradition62, kikraft49, formel64, kmods50, fertigkeit51, spezialisierung53, zauber56, aspekt66, erlernt68, modifizierungen70, sensorArray71, runningPrograms73, echos78, form80, options82, storedPrograms74, complexForms77, licences84, lizenzTraeger85, transactionlog86, powers83, geist89, skillGroups91, skills93, powers96, optionalPowers99, type87, fertigkeit103, storedPrograms104, storedSins105, localizations102, runningPrograms111, configuration107, storedPrograms109, storedPrograms114, runningPrograms116, skill119, weapon121, model123, skill126, slaves130, master132, skill133, pan134, weapon135, skill128, power137, fokus139, type141, bullets144, substance147, dest157, capacityFeature148, weapon149, beschwoerbar151, items154, source155, functions160, techniques161, usableWith162, style165, techniques168, technique170, chemical173, subLinks176},
    generalizations={gen_shr5_SourceBook_Beschreibbar, gen_shr5_SourceBook_Identifiable, gen_shr5_AbstraktPersona_Beschreibbar, gen_shr5_Quelle_Identifiable, gen_shr5_Reichweite_Identifiable, gen_shr5_AbstraktPersona_KoerperlicheAttribute, gen_shr5_AbstraktPersona_SpezielleAttribute, gen_shr5_AbstraktPersona_GeistigeAttribute, gen_shr5_AbstraktPersona_ChrakterLimits, gen_shr5_Gegenstand_AbstraktGegenstand, gen_shr5_Reichweite_Beschreibbar, gen_shr5_AbstaktWaffe_AbstraktGegenstand, gen_shr5_Nahkampfwaffe_AbstaktWaffe, gen_shr5_KoerperlicheAttribute_ModifikatorAttribute, gen_shr5_SpezielleAttribute_ModifikatorAttribute, gen_shr5_AbstraktGegenstand_Quelle, gen_shr5_AbstraktGegenstand_GeldWert, gen_shr5_AbstraktGegenstand_Beschreibbar, gen_shr5_AbstraktGegenstand_Modifizierbar, gen_shr5_AbstraktGegenstand_Anwendbar, gen_shr5_AbstaktFernKampfwaffe_AbstaktWaffe, gen_shr5_Cyberware_Koerpermods, gen_shr5_Cyberware_GeldWert, gen_shr5_Cyberware_Capacity, gen_shr5_Feuerwaffe_AbstaktFernKampfwaffe, gen_shr5_Wurfwaffe_AbstaktFernKampfwaffe, gen_shr5_Wurfwaffe_Menge, gen_shr5_ShrList_Beschreibbar, gen_shr5_ShrList_Identifiable, gen_shr5_Projektilwaffe_AbstaktFernKampfwaffe, gen_shr5_FertigkeitsGruppe_Beschreibbar, gen_shr5_FertigkeitsGruppe_Quelle, gen_shr5_FertigkeitsGruppe_Modifyable, gen_shr5_Fertigkeit_Beschreibbar, gen_shr5_Fertigkeit_Quelle, gen_shr5_Fertigkeit_Modifyable, gen_shr5_PersonaFertigkeit_Steigerbar, gen_shr5_PersonaFertigkeitsGruppe_Steigerbar, gen_shr5_MagischePersona_KoerperPersona, gen_shr5_MagischePersona_BaseMagischePersona, gen_shr5_BioWare_Koerpermods, gen_shr5_BioWare_GeldWert, gen_shr5_Koerpermods_AbstraktModifikatoren, gen_shr5_AbstraktModifikatoren_Beschreibbar, gen_shr5_AbstraktModifikatoren_Modifizierbar, gen_shr5_AbstraktModifikatoren_Quelle, gen_shr5_GeistigeAttribute_ModifikatorAttribute, gen_shr5_MudanPersona_KoerperPersona, gen_shr5_KoerperPersona_AbstraktPersona, gen_shr5_KoerperPersona_Panzerung, gen_shr5_KoerperPersona_PersonaZustand, gen_shr5_KoerperPersona_BerechneteAttribute, gen_shr5_MagischeMods_AbstraktModifikatoren, gen_shr5_KiKraft_MagischeMods, gen_shr5_KiKraft_Erlernbar, gen_shr5_GegenstandStufen_ModifikatorAttribute, gen_shr5_FernkampfwaffenModifikatoren_ModifikatorAttribute, gen_shr5_Sichtverhaeltnisse_ModifikatorAttribute, gen_shr5_Spezies_Beschreibbar, gen_shr5_Spezies_Modifizierbar, gen_shr5_Spezies_Quelle, gen_shr5_KiAdept_MagischePersona, gen_shr5_MysticAdept_KiAdept, gen_shr5_MysticAdept_Zauberer, gen_shr5_PersonaZauber_Erlernbar, gen_shr5_Kleidung_AbstraktGegenstand, gen_shr5_Kleidung_Capacity, gen_shr5_Zauber_Beschreibbar, gen_shr5_Zauber_Quelle, gen_shr5_FernkampfwaffeModifikator_AbstraktModifikatoren, gen_shr5_FernkampfwaffeModifikator_GeldWert, gen_shr5_PersonaEigenschaft_AbstraktModifikatoren, gen_shr5_PersonaEigenschaft_Erlernbar, gen_shr5_ProbenModifikatoren_ModifikatorAttribute, gen_shr5_Magier_MagischePersona, gen_shr5_Magier_Zauberer, gen_shr5_Magier_AstraleProjektion, gen_shr5_AspektMagier_MagischePersona, gen_shr5_AspektMagier_Zauberer, gen_shr5_Schutzgeist_MagischeMods, gen_shr5_Initation_Steigerbar, gen_shr5_Fahrzeug_Beschreibbar, gen_shr5_Fahrzeug_Quelle, gen_shr5_Fahrzeug_GeldWert, gen_shr5_Fahrzeug_Anwendbar, gen_shr5_Fahrzeug_Modifizierbar, gen_shr5_Fahrzeug_FahrzeugZustand, gen_shr5_Fahrzeug_Capacity, gen_shr5_Bodenfahrzeug_PassagierFahrzeug, gen_shr5_PassagierFahrzeug_Fahrzeug, gen_shr5_Drohne_Fahrzeug, gen_shr5_Drohne_MatrixAttributes, gen_shr5_MetaMagie_Beschreibbar, gen_shr5_MetaMagie_Quelle, gen_shr5_CritterKraft_MagischeMods, gen_shr5_ResonanzPersona_ActiveMatixDevice, gen_shr5_KomplexeForm_Quelle, gen_shr5_KomplexeForm_Beschreibbar, gen_shr5_PersonaKomplexForm_Erlernbar, gen_shr5_Sprite_ResonanzPersona, gen_shr5_Sprite_Beschreibbar, gen_shr5_Sprite_Quelle, gen_shr5_Echo_AbstraktModifikatoren, gen_shr5_Vertrag_Beschreibbar, gen_shr5_Vertrag_Quelle, gen_shr5_Vertrag_GeldWert, gen_shr5_Lifestyle_IntervallVertrag, gen_shr5_FahrzeugModifikation_Beschreibbar, gen_shr5_FahrzeugModifikation_Quelle, gen_shr5_FahrzeugModifikation_GeldWert, gen_shr5_Technomancer_KoerperPersona, gen_shr5_Technomancer_ResonanzPersona, gen_shr5_Sin_Fakeable, gen_shr5_Lizenz_Fakeable, gen_shr5_Fakeable_Vertrag, gen_shr5_Steigerbar_Erlernbar, gen_shr5_Credstick_AbstraktGegenstand, gen_shr5_Wissensfertigkeit_Fertigkeit, gen_shr5_Sprachfertigkeit_Wissensfertigkeit, gen_shr5_Critter_Spezies, gen_shr5_IntervallVertrag_Vertrag, gen_shr5_StufenPersona_Quelle, gen_shr5_StufenPersona_SpezielleAttribute, gen_shr5_StufenPersona_GeistigeAttribute, gen_shr5_StufenPersona_KoerperlicheAttribute, gen_shr5_StufenPersona_Beschreibbar, gen_shr5_StufenPersona_ChrakterLimits, gen_shr5_StufenPersona_Panzerung, gen_shr5_Geist_StufenPersona, gen_shr5_Geist_AstraleProjektion, gen_shr5_Munition_AbstraktGegenstand, gen_shr5_Munition_Menge, gen_shr5_MatrixAttributes_MatixConditionMonitor, gen_shr5_ActiveMatixDevice_MatrixAttributes, gen_shr5_Commlink_AbstractMatrixDevice, gen_shr5_Cyberdeck_AbstractMatrixDevice, gen_shr5_Cyberdeck_MatrixDevice, gen_shr5_Cyberdeck_ActiveMatixDevice, gen_shr5_Cyberdeck_Capacity, gen_shr5_Spezialisierung_Beschreibbar, gen_shr5_Spezialisierung_Quelle, gen_shr5_Spezialisierung_Erlernbar, gen_shr5_Spezialisierung_Modifyable, gen_shr5_SoftwareAgent_MatrixProgram, gen_shr5_Host_Beschreibbar, gen_shr5_Host_MatrixDevice, gen_shr5_Host_ActiveMatixDevice, gen_shr5_CyberwareModifikatioren_ModifikatorAttribute, gen_shr5_RiggerCommandConsole_AbstractMatrixDevice, gen_shr5_AutoSoft_RiggerProgram, gen_shr5_Software_GeldWert, gen_shr5_Software_Beschreibbar, gen_shr5_Software_Quelle, gen_shr5_MatrixProgram_Software, gen_shr5_MatrixProgram_Modifizierbar, gen_shr5_Tutorsoft_BasicProgram, gen_shr5_SkillSoft_Software, gen_shr5_BasicProgram_Software, gen_shr5_Datasoft_BasicProgram, gen_shr5_AbstractMatrixDevice_AbstraktGegenstand, gen_shr5_AbstractMatrixDevice_MatrixDevice, gen_shr5_ConsumerSoft_BasicProgram, gen_shr5_RiggerProgram_Software, gen_shr5_MatrixDevice_MatrixAttributes, gen_shr5_CommonProgram_MatrixProgram, gen_shr5_CommonProgram_RiggerProgram, gen_shr5_WeaponMount_FahrzeugModifikation, gen_shr5_LifestyleOption_Beschreibbar, gen_shr5_LifestyleOption_Quelle, gen_shr5_LifestyleOption_GeldWert, gen_shr5_PercentLifestyleOption_LifestyleOption, gen_shr5_Substance_Menge, gen_shr5_Fokus_MagischeStufe, gen_shr5_Fokus_Erlernbar, gen_shr5_AbstraktFokus_Fokus, gen_shr5_AbstraktFokus_AbstraktGegenstand, gen_shr5_QiFokus_AbstraktFokus, gen_shr5_WaffenFokus_Nahkampfwaffe, gen_shr5_WaffenFokus_Fokus, gen_shr5_MagieFokus_AbstraktFokus, gen_shr5_Substance_Beschreibbar, gen_shr5_Substance_Quelle, gen_shr5_Substance_GeldWert, gen_shr5_Toxin_Substance, gen_shr5_Drug_Substance, gen_shr5_Drug_Modifizierbar, gen_shr5_Magazin_AbstraktGegenstand, gen_shr5_Magazin_Capacity, gen_shr5_DefaultWifi_AbstractMatrixDevice, gen_shr5_SubstanceContainer_AbstraktGegenstand, gen_shr5_CyberwareEnhancement_GeldWert, gen_shr5_CyberwareEnhancement_AbstraktModifikatoren, gen_shr5_CyberImplantWeapon_CyberwareEnhancement, gen_shr5_MagischeTradition_Beschreibbar, gen_shr5_MagischeTradition_Quelle, gen_shr5_ShoppingTransaction_CredstickTransaction, gen_shr5_TransferAmount_CredstickTransaction, gen_shr5_PersonaMartialartTechnique_Erlernbar, gen_shr5_KleindungsModifikator_Beschreibbar, gen_shr5_KleindungsModifikator_Quelle, gen_shr5_KleindungsModifikator_GeldWert, gen_shr5_Sensor_Capacity, gen_shr5_Sensor_Beschreibbar, gen_shr5_Sensor_Quelle, gen_shr5_Sensor_GeldWert, gen_shr5_SensorArray_Sensor, gen_shr5_SensorFunction_Beschreibbar, gen_shr5_SensorFunction_Quelle, gen_shr5_MartialartStyle_Beschreibbar, gen_shr5_MartialartStyle_Quelle, gen_shr5_MartialartTechnique_Beschreibbar, gen_shr5_MartialartTechnique_Quelle, gen_shr5_PersonaMartialartStyle_Spezialisierung, gen_shr5_FahrzeugErweiterung_FahrzeugModifikation, gen_shr5_MiniGrenate_Munition, gen_shr5_MiniGrenate_AbtraktGranate, gen_shr5_Granate_Wurfwaffe, gen_shr5_Granate_AbtraktGranate, gen_shr5_SourceLink_Beschreibbar, gen_shr5_SourceLink_Quelle},
    metadata=None
)
