...
pascal_programHeading = Class(name="pascal_programHeading")
pascal_block = Class(name="pascal_block")
pascal_identifier = Class(name="pascal_identifier")
pascal_identifierList = Class(name="pascal_identifierList")
pascal_pascal = Class(name="pascal_pascal")
pascal_constantDefinition = Class(name="pascal_constantDefinition")
pascal_constant = Class(name="pascal_constant")
variant = Class(name="variant")
pascal_unsignedNumber = Class(name="pascal_unsignedNumber")
pascal_label_declaration_part = Class(name="pascal_label_declaration_part")
pascal_constantDefinitionPart = Class(name="pascal_constantDefinitionPart")
pascal_typeDefinitionPart = Class(name="pascal_typeDefinitionPart")
pascal_variableDeclarationPart = Class(name="pascal_variableDeclarationPart")
pascal_procedureAndFunctionDeclarationPart = Class(name="pascal_procedureAndFunctionDeclarationPart")
pascal_usesUnitsPart = Class(name="pascal_usesUnitsPart")
pascal_compoundStatement = Class(name="pascal_compoundStatement")
pascal_label = Class(name="pascal_label")
label_declaration_part = Class(name="label_declaration_part")
statement = Class(name="statement")
pascal_unsignedInteger = Class(name="pascal_unsignedInteger")
pascal_type = Class(name="pascal_type")
pascal_functionType = Class(name="pascal_functionType")
pascal_procedureType = Class(name="pascal_procedureType")
pascal_formalParameterList = Class(name="pascal_formalParameterList")
pascal_typeIdentifier = Class(name="pascal_typeIdentifier")
pascal_constantChr = Class(name="pascal_constantChr")
pascal_fieldList = Class(name="pascal_fieldList")
pascal_typeDefinition = Class(name="pascal_typeDefinition")
pascal_simpleType = Class(name="pascal_simpleType")
pascal_structuredType = Class(name="pascal_structuredType")
pascal_pointerType = Class(name="pascal_pointerType")
pascal_scalarType = Class(name="pascal_scalarType")
pascal_subrangeType = Class(name="pascal_subrangeType")
pascal_stringtype = Class(name="pascal_stringtype")
pascal_formalParameterSection = Class(name="pascal_formalParameterSection")
pascal_parameterGroup = Class(name="pascal_parameterGroup")
pascal_tag = Class(name="pascal_tag")
pascal_variant = Class(name="pascal_variant")
pascal_unpackedStructuredType = Class(name="pascal_unpackedStructuredType")
pascal_recordType = Class(name="pascal_recordType")
pascal_fixedPart = Class(name="pascal_fixedPart")
pascal_variantPart = Class(name="pascal_variantPart")
pascal_recordSection = Class(name="pascal_recordSection")
pascal_statement = Class(name="pascal_statement")
pascal_unlabelledStatement = Class(name="pascal_unlabelledStatement")
pascal_constList = Class(name="pascal_constList")
pascal_variableDeclaration = Class(name="pascal_variableDeclaration")
pascal_expression = Class(name="pascal_expression")
pascal_procedureOrFunctionDeclaration = Class(name="pascal_procedureOrFunctionDeclaration")
pascal_procedureDeclaration = Class(name="pascal_procedureDeclaration")
pascal_functionDeclaration = Class(name="pascal_functionDeclaration")
pascal_signedFactor = Class(name="pascal_signedFactor")
pascal_factor = Class(name="pascal_factor")
pascal_unsignedConstant = Class(name="pascal_unsignedConstant")
pascal_simpleStatement = Class(name="pascal_simpleStatement")
pascal_structuredStatement = Class(name="pascal_structuredStatement")
pascal_parameterList = Class(name="pascal_parameterList")
pascal_gotoStatement = Class(name="pascal_gotoStatement")
pascal_assignmentStatement = Class(name="pascal_assignmentStatement")
pascal_variable = Class(name="pascal_variable")
pascal_simpleExpression = Class(name="pascal_simpleExpression")
pascal_term = Class(name="pascal_term")
pascal_conditionalStatement = Class(name="pascal_conditionalStatement")
pascal_statements = Class(name="pascal_statements")
pascal_caseStatement = Class(name="pascal_caseStatement")
pascal_functionDesignator = Class(name="pascal_functionDesignator")
pascal_actualParameter = Class(name="pascal_actualParameter")
parameterList = Class(name="parameterList")
pascal_caseListElement = Class(name="pascal_caseListElement")
...
pascal_constant.attributes={pascal_constant_sign, pascal_constant_string, pascal_constant_bool}
...
pascal_typeIdentifier.attributes={pascal_typeIdentifier_integer, pascal_typeIdentifier_boolean, pascal_typeIdentifier_real, pascal_typeIdentifier_string, pascal_typeIdentifier_char}
...
domain_model = DomainModel(
    name="pascal",
    types={pascal_program, pascal_programHeading, pascal_block, pascal_identifier, pascal_identifierList, pascal_pascal, pascal_constantDefinition, pascal_constant, variant, pascal_unsignedNumber, pascal_label_declaration_part, pascal_constantDefinitionPart, pascal_typeDefinitionPart, pascal_variableDeclarationPart, pascal_procedureAndFunctionDeclarationPart, pascal_usesUnitsPart, pascal_compoundStatement, pascal_label, label_declaration_part, statement, pascal_unsignedInteger, pascal_type, pascal_functionType, pascal_procedureType, pascal_formalParameterList, pascal_typeIdentifier, pascal_constantChr, pascal_fieldList, pascal_typeDefinition, pascal_simpleType, pascal_structuredType, pascal_pointerType, pascal_scalarType, pascal_subrangeType, pascal_stringtype, pascal_formalParameterSection, pascal_parameterGroup, pascal_tag, pascal_variant, pascal_unpackedStructuredType, pascal_recordType, pascal_fixedPart, pascal_variantPart, pascal_recordSection, pascal_statement, pascal_unlabelledStatement, pascal_constList, pascal_variableDeclaration, pascal_expression, pascal_procedureOrFunctionDeclaration, pascal_procedureDeclaration, pascal_functionDeclaration, pascal_signedFactor, pascal_factor, pascal_unsignedConstant, pascal_simpleStatement, pascal_structuredStatement, pascal_parameterList, pascal_gotoStatement, pascal_assignmentStatement, pascal_variable, pascal_simpleExpression, pascal_term, pascal_conditionalStatement, pascal_statements, pascal_caseStatement, pascal_functionDesignator, pascal_actualParameter, parameterList, pascal_caseListElement},
    associations={program0, head1, block3, identifer5, identifierList7, identifier9, constantDefinition36, identifier38, constant41, unsignedNumber43, identifier45, identifierList112, label15, constantDefinitionParts17, typeDefinitionParts19, variableDeclarationParts21, procedureAndFunctionDeclarationParts23, usesUnitsParts25, compoundStatement27, label30, unsignedInteger31, identifier33, identifier69, type72, functionType74, procedureType76, formalParameterList78, typeIdentifier80, constantChr48, constant51, fieldList53, unsignedInteger55, unsignedInteger58, identifierList61, typeDefinition64, typeDefinition166, simpleType110, structuredType112, pointerType114, typeIdentifier116, scalarType119, subrangeType121, typeIdentifier123, stringtype126, formalParameterSection82, formalParameterSection284, parameterGroup87, parameterGroup289, parameterGroup392, parameterGroup495, identifierList98, typeIdentifier101, identifier104, formalParameterList107, recordSection160, recordSection1162, identifierList165, type168, tag171, variant173, variant1175, identifier178, identifierList128, constant131, constant2134, unpackedStructuredType137, unpackedStructuredType1139, recordType142, identifier144, unsignedNumber147, fieldList150, fixedPart153, variantPart155, variantPart1157, formalParameterList214, block217, identifier220, formalParameterList223, typeIdentifier226, block229, unlabelledStatement232, typeIdentifier181, typeIdentifier1184, constant187, constant1189, variableDeclaration192, variableDeclaration1194, identifierList197, type200, expression203, procedureOrFunctionDeclaration205, procedureDeclaration207, functionDeclaration209, identifier211, simpleExpression262, signedFactor264, term267, factor269, expression271, unsignedConstant274, factor277, simpleStatement233, structuredStatement235, identifier237, parameterList240, gotoStatement242, assignmentStatement244, variable246, expression248, identifier251, simpleExpression254, expression257, term259, compoundStatement304, conditionalStatement307, statements309, statement311, caseStatement314, functionDesignator279, variable281, unsignedNumber284, constantChr287, identifier290, parameterList293, actualParameter297, expression298, label301, expression316, caseListElement319, caseListElement1321, statements324, constList327, statement330},
    generalizations={gen_pascal_constant_variant, gen_pascal_label_label_declaration_part, gen_pascal_label_statement, gen_pascal_actualParameter_parameterList},
    metadata=None
)
