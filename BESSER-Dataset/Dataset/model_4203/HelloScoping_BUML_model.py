...
# Classes
helloScoping_Model = Class(name="helloScoping_Model")
helloScoping_Greeting = Class(name="helloScoping_Greeting")
helloScoping_Field = Class(name="helloScoping_Field")
helloScoping_FieldReference = Class(name="helloScoping_FieldReference")
