...
class synccharts_State(Scope):
    ...
    def __init__(self, type: str, isInitial: bool, isFinal: bool, parentState: set["synccharts_Region"] = None, states: "synccharts_Region" = None, sourceState: set["synccharts_Transition"] = None, State: "synccharts_Region" = None, State13: "synccharts_Region" = None, State24: "synccharts_Transition" = None, targetState: set["synccharts_Transition"] = None, State22: "synccharts_Transition" = None):
        self.type = type
...
class synccharts_Transition(Action):
    ...
    def __init__(self, priority: int, type: str, isHistory: bool, Transition: "synccharts_State" = None, outgoingTransitions: "synccharts_State" = None, Transition20: "synccharts_State" = None, incomingTransitions: "synccharts_State" = None):
