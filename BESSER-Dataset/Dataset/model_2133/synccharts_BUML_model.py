...
# Classes
synccharts_Assignment = Class(name="synccharts_Assignment")
Effect = Class(name="Effect")
synccharts_Variable = Class(name="synccharts_Variable")
synccharts_Emission = Class(name="synccharts_Emission")
synccharts_Action = Class(name="synccharts_Action")
Annotatable = Class(name="Annotatable")
synccharts_Effect = Class(name="synccharts_Effect", is_abstract=True)
synccharts_Expression = Class(name="synccharts_Expression")
synccharts_Transition = Class(name="synccharts_Transition")
synccharts_Signal = Class(name="synccharts_Signal")
synccharts_Region = Class(name="synccharts_Region")
Scope = Class(name="Scope")
synccharts_State = Class(name="synccharts_State")
synccharts_Substitution = Class(name="synccharts_Substitution")
synccharts_Scope = Class(name="synccharts_Scope", is_abstract=True)
synccharts_EObject = Class(name="synccharts_EObject")
Action = Class(name="Action")
synccharts_TextualCode = Class(name="synccharts_TextualCode")
synccharts_TextEffect = Class(name="synccharts_TextEffect")
...
synccharts_Action.attributes={synccharts_Action_isImmediate, synccharts_Action_label, synccharts_Action_delay}
...
synccharts_Transition.attributes={synccharts_Transition_type, synccharts_Transition_priority, synccharts_Transition_isHistory}
...
synccharts_State.attributes={synccharts_State_type, synccharts_State_isInitial, synccharts_State_isFinal}
...
domain_model = DomainModel(
    name="synccharts",
    types={synccharts_Assignment, Effect, synccharts_Variable, synccharts_Emission, synccharts_Action, Annotatable, synccharts_Effect, synccharts_Expression, synccharts_Transition, synccharts_Signal, synccharts_Region, Scope, synccharts_State, synccharts_Substitution, synccharts_Scope, synccharts_EObject, Action, synccharts_TextualCode, synccharts_TextEffect, TextualCode, StateType, TransitionType},
    associations={variable3, expression4, effects0, trigger1, regions15, parentRegion16, outgoingTransitions18, signal7, newValue8, states11, parentState12, parentScope14, suspensionTrigger30, exitActions33, innerActions36, entryActions39, bodyReference42, incomingTransitions19, targetState21, sourceState23, signals25, variables27, bodyContents44, bodyText47, renamings49},
    generalizations={gen_synccharts_Assignment_Effect, gen_synccharts_Emission_Effect, gen_synccharts_Action_Annotatable, gen_synccharts_Region_Scope, gen_synccharts_State_Scope, gen_synccharts_Transition_Action, gen_synccharts_Scope_Annotatable, gen_synccharts_TextEffect_TextualCode, gen_synccharts_TextEffect_Effect},
    metadata=None
)
