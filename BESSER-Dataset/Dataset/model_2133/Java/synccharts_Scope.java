...
public class synccharts_Scope extends Annotatable {
    ...
    public synccharts_Scope(
        String id,        String interfaceDeclaration,        String label    ) {
        super(
        );
        this.id = id;
    ...
    public synccharts_Scope(
        String id,        String interfaceDeclaration,        String label        ArrayList<synccharts_Action> synccharts_actions,        ArrayList<synccharts_Action> synccharts_actions,        ArrayList<synccharts_Variable> synccharts_variables,        ArrayList<synccharts_Action> synccharts_actions    ) {
        this.id = id;
        this.interfaceDeclaration = interfaceDeclaration;
        this.label = label;
