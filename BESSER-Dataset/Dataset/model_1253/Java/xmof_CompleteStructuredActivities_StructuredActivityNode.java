...
public class xmof_CompleteStructuredActivities_StructuredActivityNode extends Action {
    ...
    public xmof_CompleteStructuredActivities_StructuredActivityNode(
        boolean mustIsolate        ArrayList<BasicActions_InputPin> basicactions_inputpins,        ArrayList<IntermediateActivities_ActivityNode> intermediateactivities_activitynodes,        ArrayList<BasicActions_OutputPin> basicactions_outputpins,        ArrayList<IntermediateActivities_ActivityEdge> intermediateactivities_activityedges    ) {
        this.mustIsolate = mustIsolate;
