...
def test_assoc_bodyCondition32_link_reassign_clear():
    ...
    if hasattr(b1, 'UML2_Constraint34'):
        assert _is_linked(b1, 'UML2_Constraint34', a)
    _safe_set(a, 'UML2_Operation33', b2)
    assert _is_linked(a, 'UML2_Operation33', b2)
    if hasattr(b1, 'UML2_Constraint34'):
        assert not _is_linked(b1, 'UML2_Constraint34', a)
    if hasattr(b2, 'UML2_Constraint34'):
        assert _is_linked(b2, 'UML2_Constraint34', a)
    _safe_set(a, 'UML2_Operation33', None)
    assert not _is_linked(a, 'UML2_Operation33', b2)
    if hasattr(b2, 'UML2_Constraint34'):
        assert not _is_linked(b2, 'UML2_Constraint34', a)


def test_assoc_classifier12_link_reassign_clear():
    a = UML2_Classifier(isAbstract=True)
    b1 = UML2_CreateObjectAction()
    b2 = UML2_CreateObjectAction()
    _safe_set(a, 'UML2_Classifier13', b1)
    assert _is_linked(a, 'UML2_Classifier13', b1)
    if hasattr(b1, 'UML2_CreateObjectAction'):
        assert _is_linked(b1, 'UML2_CreateObjectAction', a)
    _safe_set(a, 'UML2_Classifier13', b2)
    assert _is_linked(a, 'UML2_Classifier13', b2)
    if hasattr(b1, 'UML2_CreateObjectAction'):
    ...
    _safe_set(a, 'UML2_Classifier13', None)
    assert not _is_linked(a, 'UML2_Classifier13', b2)
    if hasattr(b2, 'UML2_CreateObjectAction'):
...
def test_assoc_classifier2_link_reassign_clear():
    ...
    if hasattr(b1, 'UML2_InstanceSpecification3'):
        assert _is_linked(b1, 'UML2_InstanceSpecification3', a)
    _safe_set(a, 'UML2_Classifier', b2)
    assert _is_linked(a, 'UML2_Classifier', b2)
    if hasattr(b1, 'UML2_InstanceSpecification3'):
        assert not _is_linked(b1, 'UML2_InstanceSpecification3', a)
    if hasattr(b2, 'UML2_InstanceSpecification3'):
        assert _is_linked(b2, 'UML2_InstanceSpecification3', a)
    _safe_set(a, 'UML2_Classifier', None)
    assert not _is_linked(a, 'UML2_Classifier', b2)
    if hasattr(b2, 'UML2_InstanceSpecification3'):
        assert not _is_linked(b2, 'UML2_InstanceSpecification3', a)


def test_assoc_context_4_link_reassign_clear():
    a = UML2_Classifier(isAbstract=True)
    b1 = UML2_Action()
    b2 = UML2_Action()
    _safe_set(a, 'UML2_Classifier5', b1)
    assert _is_linked(a, 'UML2_Classifier5', b1)
    if hasattr(b1, 'UML2_Action'):
        assert _is_linked(b1, 'UML2_Action', a)
    _safe_set(a, 'UML2_Classifier5', b2)
    assert _is_linked(a, 'UML2_Classifier5', b2)
    if hasattr(b1, 'UML2_Action'):
        assert not _is_linked(b1, 'UML2_Action', a)
    if hasattr(b2, 'UML2_Action'):
        assert _is_linked(b2, 'UML2_Action', a)
    _safe_set(a, 'UML2_Classifier5', None)
    assert not _is_linked(a, 'UML2_Classifier5', b2)
    if hasattr(b2, 'UML2_Action'):
        assert not _is_linked(b2, 'UML2_Action', a)


def test_assoc_definingFeature6_link_reassign_clear():
    a = UML2_StructuralFeature(isReadOnly=True)
    b1 = UML2_Slot()
    b2 = UML2_Slot()
    _safe_set(a, 'UML2_StructuralFeature8', b1)
    assert _is_linked(a, 'UML2_StructuralFeature8', b1)
    if hasattr(b1, 'UML2_Slot7'):
        assert _is_linked(b1, 'UML2_Slot7', a)
    _safe_set(a, 'UML2_StructuralFeature8', b2)
    assert _is_linked(a, 'UML2_StructuralFeature8', b2)
    if hasattr(b1, 'UML2_Slot7'):
        assert not _is_linked(b1, 'UML2_Slot7', a)
    if hasattr(b2, 'UML2_Slot7'):
        assert _is_linked(b2, 'UML2_Slot7', a)
    _safe_set(a, 'UML2_StructuralFeature8', None)
    assert not _is_linked(a, 'UML2_StructuralFeature8', b2)
    if hasattr(b2, 'UML2_Slot7'):
        assert not _is_linked(b2, 'UML2_Slot7', a)


def test_assoc_end75_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b1 = UML2_LinkEndData()
    b2 = UML2_LinkEndData()
    _safe_set(a, 'UML2_Property77', b1)
    assert _is_linked(a, 'UML2_Property77', b1)
    if hasattr(b1, 'UML2_LinkEndData76'):
        assert _is_linked(b1, 'UML2_LinkEndData76', a)
    _safe_set(a, 'UML2_Property77', b2)
    assert _is_linked(a, 'UML2_Property77', b2)
    if hasattr(b1, 'UML2_LinkEndData76'):
        assert not _is_linked(b1, 'UML2_LinkEndData76', a)
    if hasattr(b2, 'UML2_LinkEndData76'):
        assert _is_linked(b2, 'UML2_LinkEndData76', a)
    _safe_set(a, 'UML2_Property77', None)
    assert not _is_linked(a, 'UML2_Property77', b2)
    if hasattr(b2, 'UML2_LinkEndData76'):
        assert not _is_linked(b2, 'UML2_LinkEndData76', a)
...
def test_assoc_feature61_link_reassign_clear():
    ...
    _safe_set(a, 'UML2_Feature63', b1)
    assert _is_linked(a, 'UML2_Feature63', b1)
    if hasattr(b1, 'UML2_Classifier62'):
        assert _is_linked(b1, 'UML2_Classifier62', a)
    _safe_set(a, 'UML2_Feature63', b2)
    assert _is_linked(a, 'UML2_Feature63', b2)
    if hasattr(b1, 'UML2_Classifier62'):
        assert not _is_linked(b1, 'UML2_Classifier62', a)
    if hasattr(b2, 'UML2_Classifier62'):
        assert _is_linked(b2, 'UML2_Classifier62', a)
    _safe_set(a, 'UML2_Feature63', None)
    assert not _is_linked(a, 'UML2_Feature63', b2)
    if hasattr(b2, 'UML2_Classifier62'):
        assert not _is_linked(b2, 'UML2_Classifier62', a)
...
def test_assoc_general18_link_reassign_clear():
    ...
    _safe_set(a, 'UML2_Classifier19', b1)
    assert _is_linked(a, 'UML2_Classifier19', b1)
    if hasattr(b1, 'UML2_Generalization'):
        assert _is_linked(b1, 'UML2_Generalization', a)
    _safe_set(a, 'UML2_Classifier19', b2)
    assert _is_linked(a, 'UML2_Classifier19', b2)
    if hasattr(b1, 'UML2_Generalization'):
    ...
    _safe_set(a, 'UML2_Classifier19', None)
    assert not _is_linked(a, 'UML2_Classifier19', b2)
    if hasattr(b2, 'UML2_Generalization'):
        assert not _is_linked(b2, 'UML2_Generalization', a)


def test_assoc_generalization67_link_reassign_clear():
    a = UML2_Classifier(isAbstract=True)
    b1 = UML2_Generalization()
    b2 = UML2_Generalization()
    _safe_set(a, 'UML2_Classifier68', {b1})
    assert _is_linked(a, 'UML2_Classifier68', b1)
    if hasattr(b1, 'UML2_Generalization69'):
        assert _is_linked(b1, 'UML2_Generalization69', a)
    _safe_set(a, 'UML2_Classifier68', {b2})
    assert _is_linked(a, 'UML2_Classifier68', b2)
    if hasattr(b1, 'UML2_Generalization69'):
        assert not _is_linked(b1, 'UML2_Generalization69', a)
    if hasattr(b2, 'UML2_Generalization69'):
        assert _is_linked(b2, 'UML2_Generalization69', a)
    _safe_set(a, 'UML2_Classifier68', set())
    assert not _is_linked(a, 'UML2_Classifier68', b2)
    if hasattr(b2, 'UML2_Generalization69'):
        assert not _is_linked(b2, 'UML2_Generalization69', a)


def test_assoc_inheritedMember64_link_reassign_clear():
    a = UML2_NamedElement(name="sample_text", visibility="sample_text")
    b1 = UML2_Classifier(isAbstract=True)
    b2 = UML2_Classifier(isAbstract=False)
    _safe_set(a, 'UML2_NamedElement66', b1)
    assert _is_linked(a, 'UML2_NamedElement66', b1)
    if hasattr(b1, 'UML2_Classifier65'):
        assert _is_linked(b1, 'UML2_Classifier65', a)
    _safe_set(a, 'UML2_NamedElement66', b2)
    assert _is_linked(a, 'UML2_NamedElement66', b2)
    if hasattr(b1, 'UML2_Classifier65'):
        assert not _is_linked(b1, 'UML2_Classifier65', a)
    if hasattr(b2, 'UML2_Classifier65'):
        assert _is_linked(b2, 'UML2_Classifier65', a)
    _safe_set(a, 'UML2_NamedElement66', None)
    assert not _is_linked(a, 'UML2_NamedElement66', b2)
    if hasattr(b2, 'UML2_Classifier65'):
        assert not _is_linked(b2, 'UML2_Classifier65', a)
...
def test_assoc_memberEnd52_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b1 = UML2_Association()
    b2 = UML2_Association()
    _safe_set(a, 'UML2_Property54', b1)
    assert _is_linked(a, 'UML2_Property54', b1)
    if hasattr(b1, 'UML2_Association53'):
        assert _is_linked(b1, 'UML2_Association53', a)
    _safe_set(a, 'UML2_Property54', b2)
    assert _is_linked(a, 'UML2_Property54', b2)
    if hasattr(b1, 'UML2_Association53'):
        assert not _is_linked(b1, 'UML2_Association53', a)
    if hasattr(b2, 'UML2_Association53'):
        assert _is_linked(b2, 'UML2_Association53', a)
    _safe_set(a, 'UML2_Property54', None)
    assert not _is_linked(a, 'UML2_Property54', b2)
    if hasattr(b2, 'UML2_Association53'):
        assert not _is_linked(b2, 'UML2_Association53', a)


def test_assoc_nestedClassifier55_link_reassign_clear():
    a = UML2_Classifier(isAbstract=True)
    b1 = UML2_Class(isActive=True)
    b2 = UML2_Class(isActive=False)
    _safe_set(a, 'UML2_Classifier56', b1)
    assert _is_linked(a, 'UML2_Classifier56', b1)
    if hasattr(b1, 'UML2_Class'):
        assert _is_linked(b1, 'UML2_Class', a)
    _safe_set(a, 'UML2_Classifier56', b2)
    assert _is_linked(a, 'UML2_Classifier56', b2)
    if hasattr(b1, 'UML2_Class'):
        assert not _is_linked(b1, 'UML2_Class', a)
    if hasattr(b2, 'UML2_Class'):
        assert _is_linked(b2, 'UML2_Class', a)
    _safe_set(a, 'UML2_Classifier56', None)
    assert not _is_linked(a, 'UML2_Classifier56', b2)
    if hasattr(b2, 'UML2_Class'):
        assert not _is_linked(b2, 'UML2_Class', a)


def test_assoc_ownedEnd49_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b1 = UML2_Association()
    b2 = UML2_Association()
    _safe_set(a, 'UML2_Property51', b1)
    assert _is_linked(a, 'UML2_Property51', b1)
    if hasattr(b1, 'UML2_Association50'):
        assert _is_linked(b1, 'UML2_Association50', a)
    _safe_set(a, 'UML2_Property51', b2)
    assert _is_linked(a, 'UML2_Property51', b2)
    if hasattr(b1, 'UML2_Association50'):
        assert not _is_linked(b1, 'UML2_Association50', a)
    if hasattr(b2, 'UML2_Association50'):
        assert _is_linked(b2, 'UML2_Association50', a)
    _safe_set(a, 'UML2_Property51', None)
    assert not _is_linked(a, 'UML2_Property51', b2)
    if hasattr(b2, 'UML2_Association50'):
        assert not _is_linked(b2, 'UML2_Association50', a)
...
def test_assoc_ownedReception57_link_reassign_clear():
    a = UML2_Class(isActive=True)
    b1 = UML2_Reception()
    b2 = UML2_Reception()
    _safe_set(a, 'UML2_Class58', {b1})
    assert _is_linked(a, 'UML2_Class58', b1)
    if hasattr(b1, 'UML2_Reception'):
        assert _is_linked(b1, 'UML2_Reception', a)
    _safe_set(a, 'UML2_Class58', {b2})
    assert _is_linked(a, 'UML2_Class58', b2)
    if hasattr(b1, 'UML2_Reception'):
        assert not _is_linked(b1, 'UML2_Reception', a)
    if hasattr(b2, 'UML2_Reception'):
        assert _is_linked(b2, 'UML2_Reception', a)
    _safe_set(a, 'UML2_Class58', set())
    assert not _is_linked(a, 'UML2_Class58', b2)
    if hasattr(b2, 'UML2_Reception'):
        assert not _is_linked(b2, 'UML2_Reception', a)


def test_assoc_qualifier45_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    ...
    _safe_set(a, 'UML2_Property44', {b1})
    assert _is_linked(a, 'UML2_Property44', b1)
    if hasattr(b1, 'UML2_Property46'):
        assert _is_linked(b1, 'UML2_Property46', a)
    _safe_set(a, 'UML2_Property44', {b2})
    assert _is_linked(a, 'UML2_Property44', b2)
    if hasattr(b1, 'UML2_Property46'):
        assert not _is_linked(b1, 'UML2_Property46', a)
    if hasattr(b2, 'UML2_Property46'):
        assert _is_linked(b2, 'UML2_Property46', a)
    _safe_set(a, 'UML2_Property44', set())
    assert not _is_linked(a, 'UML2_Property44', b2)
    if hasattr(b2, 'UML2_Property46'):
        assert not _is_linked(b2, 'UML2_Property46', a)


def test_assoc_qualifier47_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b1 = UML2_QualifierValue()
    b2 = UML2_QualifierValue()
    _safe_set(a, 'UML2_Property48', b1)
    assert _is_linked(a, 'UML2_Property48', b1)
    if hasattr(b1, 'UML2_QualifierValue'):
        assert _is_linked(b1, 'UML2_QualifierValue', a)
    _safe_set(a, 'UML2_Property48', b2)
    assert _is_linked(a, 'UML2_Property48', b2)
    if hasattr(b1, 'UML2_QualifierValue'):
    ...
    _safe_set(a, 'UML2_Property48', None)
    assert not _is_linked(a, 'UML2_Property48', b2)
    if hasattr(b2, 'UML2_QualifierValue'):
...
def test_assoc_subsettedProperty41_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b1 = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b2 = UML2_Property(aggregation="sample_text_2", isComposite=False, isDerived=False, isDerivedUnion=False)
    _safe_set(a, 'UML2_Property', b1)
    assert _is_linked(a, 'UML2_Property', b1)
    if hasattr(b1, 'UML2_Property40'):
        assert _is_linked(b1, 'UML2_Property40', a)
    _safe_set(a, 'UML2_Property', b2)
    assert _is_linked(a, 'UML2_Property', b2)
    if hasattr(b1, 'UML2_Property40'):
        assert not _is_linked(b1, 'UML2_Property40', a)
    if hasattr(b2, 'UML2_Property40'):
        assert _is_linked(b2, 'UML2_Property40', a)
    _safe_set(a, 'UML2_Property', None)
    assert not _is_linked(a, 'UML2_Property', b2)
    if hasattr(b2, 'UML2_Property40'):
        assert not _is_linked(b2, 'UML2_Property40', a)
