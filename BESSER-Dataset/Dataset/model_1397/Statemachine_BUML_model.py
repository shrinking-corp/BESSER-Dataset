...
domain_model = DomainModel(
    name="statemachine",
    types={statemachine_Event, statemachine_Statemachine, statemachine_Signal, statemachine_State, statemachine_InputSignal, Signal, statemachine_OutputSignal, statemachine_Command, statemachine_Transition, statemachine_Condition},
    associations={events15, signal17, signal20, signals0, states1, commands3, transitions5, nestedStates8, condition10, state12},
