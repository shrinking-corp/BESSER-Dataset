...
simplepdl_Parameter = Class(name="simplepdl_Parameter")
...
domain_model = DomainModel(
    ...
    associations={processElements0, resources1, linksToPredecessors3, linksToSuccessors4, needs6, successor8, element10, resource12, workDefinition14, predecessor7},
    generalizations={gen_simplepdl_WorkDefinition_ProcessElement, gen_simplepdl_Guidance_ProcessElement, gen_simplepdl_Parameter_ProcessElement, gen_simplepdl_WorkSequence_ProcessElement},
    metadata=None
)
