...
class simplepdl_WorkSequence(ProcessElement):
    ...
    def __init__(self, name: str, linkType: str, WorkSequence: "simplepdl_WorkDefinition" = None, WorkSequence5: "simplepdl_WorkDefinition" = None, linksToPredecessors: "simplepdl_WorkDefinition" = None, linksToSuccessors: "simplepdl_WorkDefinition" = None):
        self.name = name
