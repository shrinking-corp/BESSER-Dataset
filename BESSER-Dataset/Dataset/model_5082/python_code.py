...
class adlsimple_Interface(ABC):
    ...
    def __init__(self, name: str, signature: str, adlsimple_Interface9: "adlsimple_Binding" = None, adlsimple_Interface: set["adlsimple_Binding"] = None, adlsimple_Interface6: "adlsimple_Binding" = None):
        self.name = name
