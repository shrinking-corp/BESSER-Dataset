...
def test_hyp_adlsimple_base_is_not_abstract():
    assert not inspect.isabstract(adlsimple_Base)


def test_hyp_adlsimple_base_constructor_exists():
    assert callable(adlsimple_Base.__init__)


def test_hyp_adlsimple_base_constructor_args():
    sig = inspect.signature(adlsimple_Base.__init__)
    params = list(sig.parameters.keys())



def test_hyp_adlsimple_binding_is_not_abstract():
    assert not inspect.isabstract(adlsimple_Binding)


def test_hyp_adlsimple_binding_constructor_exists():
    assert callable(adlsimple_Binding.__init__)


def test_hyp_adlsimple_binding_constructor_args():
    sig = inspect.signature(adlsimple_Binding.__init__)
    params = list(sig.parameters.keys())



def test_hyp_adlsimple_interface_is_not_abstract():
    assert not inspect.isabstract(adlsimple_Interface)


def test_hyp_adlsimple_interface_constructor_exists():
    assert callable(adlsimple_Interface.__init__)


def test_hyp_adlsimple_interface_constructor_args():
...
def test_hyp_adlsimple_component_is_not_abstract():
    assert not inspect.isabstract(adlsimple_Component)


def test_hyp_adlsimple_component_constructor_exists():
    assert callable(adlsimple_Component.__init__)


def test_hyp_adlsimple_component_constructor_args():
...
def test_hyp_adlsimple_provided_is_not_abstract():
    assert not inspect.isabstract(adlsimple_Provided)


def test_hyp_adlsimple_provided_constructor_exists():
    assert callable(adlsimple_Provided.__init__)


def test_hyp_adlsimple_provided_constructor_args():
    sig = inspect.signature(adlsimple_Provided.__init__)
    params = list(sig.parameters.keys())



def test_hyp_adlsimple_required_is_not_abstract():
    assert not inspect.isabstract(adlsimple_Required)


def test_hyp_adlsimple_required_constructor_exists():
    assert callable(adlsimple_Required.__init__)


def test_hyp_adlsimple_required_constructor_args():
...
def test_hyp_adlsimple_interface_signature_setter(instance):
...
@given(instance=adlsimple_Interface_strategy)
def test_hyp_adlsimple_interface_name_setter(instance):
...
def test_hyp_adlsimple_component_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
