...
adlsimple_Component = Class(name="adlsimple_Component")
adlsimple_Required = Class(name="adlsimple_Required")
adlsimple_Provided = Class(name="adlsimple_Provided")
adlsimple_Interface = Class(name="adlsimple_Interface", is_abstract=True)
adlsimple_Binding = Class(name="adlsimple_Binding")
adlsimple_Base = Class(name="adlsimple_Base")
...
adlsimple_Interface.attributes={adlsimple_Interface_signature, adlsimple_Interface_name}
...
domain_model = DomainModel(
    name="adlsimple",
    types={Interface, adlsimple_Component, adlsimple_Required, adlsimple_Provided, adlsimple_Interface, adlsimple_Binding, adlsimple_Base},
    associations={to7, requiredInterfaces0, providedInterfaces1, bindings3, from_4, components10},
    generalizations={gen_adlsimple_Required_Interface, gen_adlsimple_Provided_Interface},
    metadata=None
)
