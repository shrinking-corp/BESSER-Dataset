...
class Department:
    ...
    def __init__(self, students__: Student, teachers__: Teacher, hod: HOD, course: Course, student4: set["Student"] = None, employee6: set["Employee_Interface"] = None, access_Information19: "Access_Information" = None, course0: "Course" = None):
