...
services_Service.attributes={services_Service_serviceName, services_Service_serviceDescription, services_Service_serviceCategory, services_Service_serviceClass}
...
domain_model = DomainModel(
    name="services",
    types={services_CFSService, Service, services_CIID, Base, services_DerivedResource, BaseResource, services_Value, services_RFSService, services_Node, services_Tolerance, services_DistributionEntry, services_NetXResource, services_Lifecycle, services_ServiceForecast, services_ServiceMonitor, services_ServiceUser, services_Service, services_Expression, services_ServiceDistribution, services_ResourceForecast, services_DateTimeRange, services_ServiceForecastUsers, services_ServiceProfile, services_ResourceMonitor, ResourceOriginType, ServiceClassType},
    associations={values0, forecastValues1, trendedValues4, distribution8, nodes11, toleranceRefs12, resourceRef7, cIID14, lifecycle15, services18, serviceForecasts20, serviceMonitors22, serviceUserRefs24, distributionEntries28, expressionRefs31, serviceDistribution26, resourceForecasts37, userValues39, serviceUserRef42, period33, serviceForecastUsers35, profileResources50, period45, resourceMonitors48, serviceProfile52, expressionRef55},
    generalizations={gen_services_CFSService_Service, gen_services_CIID_Base, gen_services_DerivedResource_BaseResource, gen_services_RFSService_Service, gen_services_DistributionEntry_Base, gen_services_Service_Base, gen_services_ServiceDistribution_Base, gen_services_ServiceForecast_Base, gen_services_ServiceForecastUsers_Base, gen_services_ServiceMonitor_Base, gen_services_ServiceProfile_Base, gen_services_ServiceUser_Base},
    metadata=None
)
