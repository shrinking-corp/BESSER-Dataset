...
class services_ServiceForecast(Base):
    ...
    def __init__(self, name: str, revision: str, services_ServiceForecast: "services_Service" = None, services_ServiceForecast38: set["services_ResourceForecast"] = None, services_ServiceForecast34: "services_DateTimeRange" = None, services_ServiceForecast36: set["services_ServiceForecastUsers"] = None):
        self.name = name
        self.revision = revision
