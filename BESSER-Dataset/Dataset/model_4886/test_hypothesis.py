...
def test_build_filter_singlepropertyfilter_has__property():
    assert hasattr(build_filter_SinglePropertyFilter, "_property")
    descriptor = None
...
@given(instance=build_filter_SinglePropertyFilter_strategy)
def test_build_filter_singlepropertyfilter__property_setter(instance):
