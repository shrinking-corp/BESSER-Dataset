...
class build_filter_IFilter(ABC):
    ...
    def __init__(self):
        ...
        pass
    def match(self, build_properties, build_matched) :
...
class build_filter_SinglePropertyFilter(IFilter):
    ...
    def __init__(self, _property: str, IFilter94: "build_command_FilterAdvice" = None, IFilter98: "build_filter_FilterGroup" = None, IFilter: "build_command_FilterAdvice" = None):
...
class build_resolver_IMetaDataTranslator(ABC):
    ...
    def __init__(self):
        ...
        pass
    def resolve(self, build_resolver) :
...
class build_resolver_IMetaDataTranslatorFactory(ABC):
    ...
    def __init__(self):
        ...
        pass
    def getTranslator(self, build_nameSpace, build_resolver) :
...
class build_properties_Literal(IExpr):
    ...
    def __init__(self, value: str, IExpr: "build_resolver_IResolver" = None, IExpr75: "build_properties_IFunction" = None):
        self.value = value
...
class build_resolver_IResolver(ABC):
    ...
    def resolve(self, build_IResolutionContext) :
        # TODO: Implement resolve method
        pass
...
class build_context_ImportOptions(ABC):
    ...
    def __init__(self, location: str, conflictResolution: str, resourcePath: str, unpack: bool, expand: bool, suffix: str, build_context_ImportOptions: "IMaterializer" = None):
...
class build_context_ResolutionOptions(ABC):
    ...
    def __init__(self, source: str, excludeParts: str, prune: bool, mutable: str, branchTagPath: str, timestamp: str, revision: str, resolverFilter: str, filterGroups: bool, overlayPath: str, includeParts: str):
        self.source = source
...
class build_resolver_P2Resolver(IResolver):
    ...
    def __init__(self, IResolver72: "build_resolver_ResolverGroup" = None, IResolver69: "build_runtime_ResolverExtension" = None, IResolver84: "build_command_BuildUnitCommand" = None, IResolver: "build_context_IBuildContext" = None):
...
class build_command_BooleanAdvice(IAdvise):
    ...
    def __init__(self, value: bool, IAdvise: "build_IClosure" = None, IAdvise45: "build_context_IBuildContext" = None, IAdvise87: "build_command_BuildUnitCommand" = None, IAdvise96: "build_command_AdviceGroup" = None):
        self.value = value
...
class build_command_VersionAdvice(IAdvise):
    ...
    def __init__(self, version: str, IAdvise: "build_IClosure" = None, IAdvise45: "build_context_IBuildContext" = None, IAdvise87: "build_command_BuildUnitCommand" = None, IAdvise96: "build_command_AdviceGroup" = None):
...
class build_command_FilterAdvice(IAdvise):
    ...
    def __init__(self, filterOp: str, build_command_FilterAdvice: "IFilter" = None, build_command_FilterAdvice93: "IFilter" = None, IAdvise: "build_IClosure" = None, IAdvise45: "build_context_IBuildContext" = None, IAdvise87: "build_command_BuildUnitCommand" = None, IAdvise96: "build_command_AdviceGroup" = None):
...
class build_command_StringAdvice(IAdvise):
    ...
    def __init__(self, value: str, IAdvise: "build_IClosure" = None, IAdvise45: "build_context_IBuildContext" = None, IAdvise87: "build_command_BuildUnitCommand" = None, IAdvise96: "build_command_AdviceGroup" = None):
        self.value = value
...
class build_command_VersionRangeAdvice(IAdvise):
    ...
    def __init__(self, versionRange: str, IAdvise: "build_IClosure" = None, IAdvise45: "build_context_IBuildContext" = None, IAdvise87: "build_command_BuildUnitCommand" = None, IAdvise96: "build_command_AdviceGroup" = None):
...
class build_IPathGroup(ABC):
    ...
    def __init__(self, basePath: str, paths: str, build_IPathGroup: "build_IArtifactsPart" = None, build_IPathGroup25: "build_IProducedPart" = None, build_IPathGroup37: "build_IGenericUnit" = None, build_IPathGroup32: "build_ResultingPathGroup" = None):
...
class build_ICapability(ABC):
    ...
    def satisfies(self, build_required) :
...
class PropertyScope:
    ...
    pass
class build_IClosure(PropertyScope, IPrerequisites):
...
class IGenericUnit:
    ...
    pass
class build_IBuildUnit(IGenericUnit, ICapability, PropertyScope):

    def __init__(self, filter: str, circularityAllowed: bool, instanceLocation: str, buildUnit: set["build_IBuildPart"] = None, build_IBuildUnit: set["build_IRequiredCapability"] = None, build_IBuildUnit3: set["build_IRequiredCapability"] = None, build_IBuildUnit12: "build_IBuildUnit" = None, build_IBuildUnit10: "build_IBuildUnit" = None, build_IBuildUnit14: set["build_PartCapability"] = None, build_IBuildUnit6: set["build_IRequiredCapability"] = None, build_IBuildUnit9: set["build_ICapability"] = None, IBuildUnit: "build_IBuildPart" = None):
        self.filter = filter
