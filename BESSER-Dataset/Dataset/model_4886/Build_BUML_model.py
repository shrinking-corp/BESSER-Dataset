...
build_IBuildPart = Class(name="build_IBuildPart", is_abstract=True)
build_IRequiredCapability = Class(name="build_IRequiredCapability", is_abstract=True)
build_IBuildUnit = Class(name="build_IBuildUnit", is_abstract=True)
ICapability = Class(name="ICapability")
PropertyScope = Class(name="PropertyScope")
build_PartCapability = Class(name="build_PartCapability")
build_IProvidedCapability = Class(name="build_IProvidedCapability", is_abstract=True)
build_ICapability = Class(name="build_ICapability", is_abstract=True)
build_IPathGroup = Class(name="build_IPathGroup", is_abstract=True)
build_IActionPart = Class(name="build_IActionPart", is_abstract=True)
IClosurePart = Class(name="IClosurePart")
build_IActionResult = Class(name="build_IActionResult", is_abstract=True)
build_IUpToDatePolicy = Class(name="build_IUpToDatePolicy", is_abstract=True)
build_IClosure = Class(name="build_IClosure", is_abstract=True)
IPrerequisites = Class(name="IPrerequisites")
IAdvise = Class(name="IAdvise")
build_IArtifactsPart = Class(name="build_IArtifactsPart", is_abstract=True)
IBuildPart = Class(name="IBuildPart")
build_IRequirement = Class(name="build_IRequirement", is_abstract=True)
build_IPartGroup = Class(name="build_IPartGroup", is_abstract=True)
build_PartRequirement = Class(name="build_PartRequirement")
IRequirement = Class(name="IRequirement")
build_IPrerequisites = Class(name="build_IPrerequisites", is_abstract=True)
build_IProducedPart = Class(name="build_IProducedPart", is_abstract=True)
build_IResultingParts = Class(name="build_IResultingParts", is_abstract=True)
IActionResult = Class(name="IActionResult")
build_IClosurePart = Class(name="build_IClosurePart", is_abstract=True)
IClosure = Class(name="IClosure")
build_Requirement = Class(name="build_Requirement")
build_PropertyScope = Class(name="build_PropertyScope", is_abstract=True)
build_IGenericUnit = Class(name="build_IGenericUnit", is_abstract=True)
build_ResultingPathGroup = Class(name="build_ResultingPathGroup")
build_StringProperties = Class(name="build_StringProperties")
context_build_IBuildUnit = Class(name="context_build_IBuildUnit")
IResolver = Class(name="IResolver")
build_context_IResolution = Class(name="build_context_IResolution", is_abstract=True)
context_build_IRequiredCapability = Class(name="context_build_IRequiredCapability")
context_build_ICapability = Class(name="context_build_ICapability")
ImportOptions = Class(name="ImportOptions")
build_context_ResolutionOptions = Class(name="build_context_ResolutionOptions", is_abstract=True)
build_context_IBuildContext = Class(name="build_context_IBuildContext", is_abstract=True)
IUnitRequest = Class(name="IUnitRequest")
IResolution = Class(name="IResolution")
build_context_ImportOptions = Class(name="build_context_ImportOptions", is_abstract=True)
...
build_runtime_UpToDateExtension = Class(name="build_runtime_UpToDateExtension")
IHumanSelectable = Class(name="IHumanSelectable")
runtime_build_IUpToDatePolicy = Class(name="runtime_build_IUpToDatePolicy")
build_runtime_IHumanSelectable = Class(name="build_runtime_IHumanSelectable", is_abstract=True)
IExtension = Class(name="IExtension")
build_runtime_MaterializerExtension = Class(name="build_runtime_MaterializerExtension")
build_runtime_BuildRuntime = Class(name="build_runtime_BuildRuntime")
UpToDateExtension = Class(name="UpToDateExtension")
MaterializerExtension = Class(name="MaterializerExtension")
build_resolver_IResolver = Class(name="build_resolver_IResolver", is_abstract=True)
IExpr = Class(name="IExpr")
build_runtime_MetaDataTranslatorFactoryExtension = Class(name="build_runtime_MetaDataTranslatorFactoryExtension")
IMetaDataTranslatorFactory = Class(name="IMetaDataTranslatorFactory")
build_runtime_ResolverExtension = Class(name="build_runtime_ResolverExtension")
build_runtime_IExtension = Class(name="build_runtime_IExtension", is_abstract=True)
build_resolver_IResourceMap = Class(name="build_resolver_IResourceMap", is_abstract=True)
build_resolver_ILocation = Class(name="build_resolver_ILocation", is_abstract=True)
build_resolver_ResolverGroup = Class(name="build_resolver_ResolverGroup", is_abstract=True)
build_resolver_FirstChoice = Class(name="build_resolver_FirstChoice")
ResolverGroup = Class(name="ResolverGroup")
build_resolver_BestChoice = Class(name="build_resolver_BestChoice")
build_resolver_IMetaDataTranslatorFactory = Class(name="build_resolver_IMetaDataTranslatorFactory", is_abstract=True)
build_resolver_DefaultResolver = Class(name="build_resolver_DefaultResolver", is_abstract=True)
IMetaDataTranslator = Class(name="IMetaDataTranslator")
build_resolver_WorspaceResolver = Class(name="build_resolver_WorspaceResolver")
EFSResolver = Class(name="EFSResolver")
build_resolver_EFSResolver = Class(name="build_resolver_EFSResolver")
resolver_DefaultResolver = Class(name="resolver_DefaultResolver")
resolver_IEFSBasedAccess = Class(name="resolver_IEFSBasedAccess")
build_resolver_P2Resolver = Class(name="build_resolver_P2Resolver")
build_resolver_IMetaDataTranslator = Class(name="build_resolver_IMetaDataTranslator", is_abstract=True)
build_resolver_IEFSBasedAccess = Class(name="build_resolver_IEFSBasedAccess", is_abstract=True)
build_materializer_FileSystemMaterializer = Class(name="build_materializer_FileSystemMaterializer")
build_materializer_P2Materializer = Class(name="build_materializer_P2Materializer")
build_materializer_WorkspaceMaterializer = Class(name="build_materializer_WorkspaceMaterializer")
build_properties_IExpr = Class(name="build_properties_IExpr", is_abstract=True)
build_properties_Literal = Class(name="build_properties_Literal")
build_properties_IFunction = Class(name="build_properties_IFunction", is_abstract=True)
build_properties_PropertyRef = Class(name="build_properties_PropertyRef")
IFunction = Class(name="IFunction")
build_properties_Format = Class(name="build_properties_Format")
build_resolver_IResolutionContext = Class(name="build_resolver_IResolutionContext", is_abstract=True)
build_materializer_IMaterializer = Class(name="build_materializer_IMaterializer", is_abstract=True)
build_properties_Split = Class(name="build_properties_Split")
build_command_IUnitRequest = Class(name="build_command_IUnitRequest", is_abstract=True)
ResolutionOptions = Class(name="ResolutionOptions")
build_properties_ToUpper = Class(name="build_properties_ToUpper")
build_properties_toLower = Class(name="build_properties_toLower")
build_properties_replace = Class(name="build_properties_replace")
Match = Class(name="Match")
build_properties_Match = Class(name="build_properties_Match")
build_command_IAdvise = Class(name="build_command_IAdvise", is_abstract=True)
ContextNodeSelector = Class(name="ContextNodeSelector")
build_command_ImportCommand = Class(name="build_command_ImportCommand")
BuildUnitCommand = Class(name="BuildUnitCommand")
build_command_PropertyAdvice = Class(name="build_command_PropertyAdvice")
build_command_ContextNodeSelector = Class(name="build_command_ContextNodeSelector", is_abstract=True)
build_command_StringAdvice = Class(name="build_command_StringAdvice")
build_command_VersionAdvice = Class(name="build_command_VersionAdvice")
build_command_BuildUnitCommand = Class(name="build_command_BuildUnitCommand", is_abstract=True)
command_build_PropertyScope = Class(name="command_build_PropertyScope")
build_command_NewInstanceAdvice = Class(name="build_command_NewInstanceAdvice")
AdviceGroup = Class(name="AdviceGroup")
build_command_InvokeCommand = Class(name="build_command_InvokeCommand")
build_command_FilterAdvice = Class(name="build_command_FilterAdvice")
IFilter = Class(name="IFilter")
build_command_AdviceGroup = Class(name="build_command_AdviceGroup")
build_command_VersionRangeAdvice = Class(name="build_command_VersionRangeAdvice")
build_command_BooleanAdvice = Class(name="build_command_BooleanAdvice")
build_command_UnsetAdvice = Class(name="build_command_UnsetAdvice")
build_filter_OSGiBasedFilter = Class(name="build_filter_OSGiBasedFilter")
build_filter_AndFilter = Class(name="build_filter_AndFilter")
FilterGroup = Class(name="FilterGroup")
build_filter_OrFilter = Class(name="build_filter_OrFilter")
build_filter_FilterGroup = Class(name="build_filter_FilterGroup")
build_filter_RegexpFilter = Class(name="build_filter_RegexpFilter")
SinglePropertyFilter = Class(name="SinglePropertyFilter")
build_filter_SinglePropertyFilter = Class(name="build_filter_SinglePropertyFilter")
build_filter_SimplePatternFIlter = Class(name="build_filter_SimplePatternFIlter")
build_filter_IFilter = Class(name="build_filter_IFilter", is_abstract=True)
...
build_IRequiredCapability.attributes={build_IRequiredCapability_name, build_IRequiredCapability_range, build_IRequiredCapability_filter, build_IRequiredCapability_namespace}
...
build_IBuildUnit.attributes={build_IBuildUnit_filter, build_IBuildUnit_circularityAllowed, build_IBuildUnit_instanceLocation}
...
build_ICapability_m_satisfies: Method = Method(name="satisfies", parameters={Parameter(name='build_required', type=StringType)}, type=BooleanType)
build_ICapability.attributes={build_ICapability_version, build_ICapability_name, build_ICapability_namespace}
...
build_IPathGroup.attributes={build_IPathGroup_paths, build_IPathGroup_basePath}
...
build_IRequirement.attributes={build_IRequirement_filter, build_IRequirement_includePattern, build_IRequirement_excludePattern, build_IRequirement_contributor, build_IRequirement_alias, build_IRequirement_memberName}
...
build_IPrerequisites.attributes={build_IPrerequisites_alias, build_IPrerequisites_rebasePath}
...
build_StringProperties.attributes={build_StringProperties_immutable, build_StringProperties_key, build_StringProperties_value}
...
build_context_ResolutionOptions.attributes={build_context_ResolutionOptions_branchTagPath, build_context_ResolutionOptions_timestamp, build_context_ResolutionOptions_includeParts, build_context_ResolutionOptions_prune, build_context_ResolutionOptions_filterGroups, build_context_ResolutionOptions_revision, build_context_ResolutionOptions_excludeParts, build_context_ResolutionOptions_resolverFilter, build_context_ResolutionOptions_source, build_context_ResolutionOptions_overlayPath, build_context_ResolutionOptions_mutable}
...
build_context_ImportOptions.attributes={build_context_ImportOptions_conflictResolution, build_context_ImportOptions_location, build_context_ImportOptions_suffix, build_context_ImportOptions_expand, build_context_ImportOptions_resourcePath, build_context_ImportOptions_unpack}
...
build_runtime_IHumanSelectable.attributes={build_runtime_IHumanSelectable_label, build_runtime_IHumanSelectable_typeName}
...
build_resolver_IResolver_m_resolve: Method = Method(name="resolve", parameters={Parameter(name='build_IResolutionContext', type=StringType)}, type=StringType)
build_resolver_IResolver.attributes={build_resolver_IResolver_failOnError, build_resolver_IResolver_filter}
...
build_resolver_IResourceMap_m_lookup: Method = Method(name="lookup", parameters={Parameter(name='build_request', type=StringType)}, type=StringType)
...
build_resolver_IMetaDataTranslatorFactory_m_getTranslator: Method = Method(name="getTranslator", parameters={Parameter(name='build_nameSpace', type=StringType), Parameter(name='build_resolver', type=StringType)}, type=StringType)
...
build_resolver_P2Resolver_m_resolve: Method = Method(name="resolve", parameters={Parameter(name='build_IResolutionContext', type=StringType)}, type=StringType)
...
build_resolver_IMetaDataTranslator_m_resolve: Method = Method(name="resolve", parameters={Parameter(name='build_resolver', type=StringType)}, type=StringType)
...
build_properties_IExpr_m_eval: Method = Method(name="eval", parameters={Parameter(name='build_scope', type=StringType)}, type=StringType)
...
build_properties_Split.attributes={build_properties_Split_limit, build_properties_Split_style, build_properties_Split_pattern}
...
build_command_IUnitRequest.attributes={build_command_IUnitRequest_nameSpace, build_command_IUnitRequest_name, build_command_IUnitRequest_range}
...
build_properties_Match.attributes={build_properties_Match_quotePattern, build_properties_Match_pattern, build_properties_Match_replacement}
...
build_filter_SinglePropertyFilter__property: Property = Property(name="_property", type=StringType)
build_filter_SinglePropertyFilter.attributes={build_filter_SinglePropertyFilter__property}

# build_filter_SimplePatternFIlter class attributes and methods

# build_filter_IFilter class attributes and methods
build_filter_IFilter_m_match: Method = Method(name="match", parameters={Parameter(name='build_matched', type=StringType), Parameter(name='build_properties', type=StringType)}, type=BooleanType)
...
domain_model = DomainModel(
    name="build",
    types={IGenericUnit, build_IBuildPart, build_IRequiredCapability, build_IBuildUnit, ICapability, PropertyScope, build_PartCapability, build_IProvidedCapability, build_ICapability, build_IPathGroup, build_IActionPart, IClosurePart, build_IActionResult, build_IUpToDatePolicy, build_IClosure, IPrerequisites, IAdvise, build_IArtifactsPart, IBuildPart, build_IRequirement, build_IPartGroup, build_PartRequirement, IRequirement, build_IPrerequisites, build_IProducedPart, build_IResultingParts, IActionResult, build_IClosurePart, IClosure, build_Requirement, build_PropertyScope, build_IGenericUnit, build_ResultingPathGroup, build_StringProperties, context_build_IBuildUnit, IResolver, build_context_IResolution, context_build_IRequiredCapability, context_build_ICapability, ImportOptions, build_context_ResolutionOptions, build_context_IBuildContext, IUnitRequest, IResolution, build_context_ImportOptions, IMaterializer, MetaDataTranslatorFactoryExtension, ResolverExtension, build_runtime_UpToDateExtension, IHumanSelectable, runtime_build_IUpToDatePolicy, build_runtime_IHumanSelectable, IExtension, build_runtime_MaterializerExtension, build_runtime_BuildRuntime, UpToDateExtension, MaterializerExtension, build_resolver_IResolver, IExpr, build_runtime_MetaDataTranslatorFactoryExtension, IMetaDataTranslatorFactory, build_runtime_ResolverExtension, build_runtime_IExtension, build_resolver_IResourceMap, build_resolver_ILocation, build_resolver_ResolverGroup, build_resolver_FirstChoice, ResolverGroup, build_resolver_BestChoice, build_resolver_IMetaDataTranslatorFactory, build_resolver_DefaultResolver, IMetaDataTranslator, build_resolver_WorspaceResolver, EFSResolver, build_resolver_EFSResolver, resolver_DefaultResolver, resolver_IEFSBasedAccess, build_resolver_P2Resolver, build_resolver_IMetaDataTranslator, build_resolver_IEFSBasedAccess, build_materializer_FileSystemMaterializer, build_materializer_P2Materializer, build_materializer_WorkspaceMaterializer, build_properties_IExpr, build_properties_Literal, build_properties_IFunction, build_properties_PropertyRef, IFunction, build_properties_Format, build_resolver_IResolutionContext, build_materializer_IMaterializer, build_properties_Split, build_command_IUnitRequest, ResolutionOptions, build_properties_ToUpper, build_properties_toLower, build_properties_replace, Match, build_properties_Match, build_command_IAdvise, ContextNodeSelector, build_command_ImportCommand, BuildUnitCommand, build_command_PropertyAdvice, build_command_ContextNodeSelector, build_command_StringAdvice, build_command_VersionAdvice, build_command_BuildUnitCommand, command_build_PropertyScope, build_command_NewInstanceAdvice, AdviceGroup, build_command_InvokeCommand, build_command_FilterAdvice, IFilter, build_command_AdviceGroup, build_command_VersionRangeAdvice, build_command_BooleanAdvice, build_command_UnsetAdvice, build_filter_OSGiBasedFilter, build_filter_AndFilter, FilterGroup, build_filter_OrFilter, build_filter_FilterGroup, build_filter_RegexpFilter, SinglePropertyFilter, build_filter_SinglePropertyFilter, build_filter_SimplePatternFIlter, build_filter_IFilter, Disposition, ConflictResolution, SplitStyle, FilterAdviceOperation},
    associations={parts0, requiredCapabilities1, metaRequiredCapabilities2, selfCapability11, partCapabilities13, allRequiredCapabilities5, providedCapabilities8, paths17, produces18, upToDatePolicy19, advice20, publishedCapabilities15, buildUnit16, requiredParts21, paths24, producedBy26, producedParts27, requiredCapability29, requiredPart22, producedBy23, buildPart33, properties35, self36, paths31, units41, advice43, resolver46, resolves48, resolution49, subResolutions51, options54, requests38, resolutions39, materializer56, materializers58, unitTypes60, resolvers62, instance64, instance65, upToDatePolicies57, instance67, instance68, location70, resolvers71, translator73, operands74, options77, matchers76, advice85, selector88, properties89, requests78, properties80, resolver82, remove91, add92, filters97, advice95},
    generalizations={gen_build_IBuildUnit_PropertyScope, gen_build_IBuildUnit_IGenericUnit, gen_build_IBuildUnit_ICapability, gen_build_IActionPart_IClosurePart, gen_build_IClosure_IPrerequisites, gen_build_IClosure_PropertyScope, gen_build_IArtifactsPart_IBuildPart, gen_build_IPartGroup_IClosurePart, gen_build_PartRequirement_IRequirement, gen_build_IPrerequisites_IBuildPart, gen_build_IProducedPart_IClosurePart, gen_build_IResultingParts_IActionResult, gen_build_IClosurePart_IClosure, gen_build_IClosurePart_IBuildPart, gen_build_Requirement_IRequirement, gen_build_PartCapability_ICapability, gen_build_ResultingPathGroup_IActionResult, gen_build_runtime_UpToDateExtension_IHumanSelectable, gen_build_runtime_IHumanSelectable_IExtension, gen_build_runtime_MaterializerExtension_IHumanSelectable, gen_build_runtime_MetaDataTranslatorFactoryExtension_IExtension, gen_build_runtime_ResolverExtension_IHumanSelectable, gen_build_resolver_ResolverGroup_IResolver, gen_build_resolver_FirstChoice_ResolverGroup, gen_build_resolver_BestChoice_ResolverGroup, gen_build_resolver_DefaultResolver_IResolver, gen_build_resolver_WorspaceResolver_EFSResolver, gen_build_resolver_EFSResolver_resolver_DefaultResolver, gen_build_resolver_EFSResolver_resolver_IEFSBasedAccess, gen_build_resolver_P2Resolver_IResolver, gen_build_materializer_FileSystemMaterializer_IMaterializer, gen_build_materializer_P2Materializer_IMaterializer, gen_build_materializer_WorkspaceMaterializer_IMaterializer, gen_build_properties_Literal_IExpr, gen_build_properties_IFunction_IExpr, gen_build_properties_PropertyRef_IFunction, gen_build_properties_Format_IFunction, gen_build_properties_Split_IFunction, gen_build_properties_ToUpper_IFunction, gen_build_properties_toLower_IFunction, gen_build_properties_replace_IFunction, gen_build_command_ImportCommand_BuildUnitCommand, gen_build_command_PropertyAdvice_IAdvise, gen_build_command_StringAdvice_IAdvise, gen_build_command_VersionAdvice_IAdvise, gen_build_command_NewInstanceAdvice_AdviceGroup, gen_build_command_InvokeCommand_BuildUnitCommand, gen_build_command_FilterAdvice_IAdvise, gen_build_command_VersionRangeAdvice_IAdvise, gen_build_command_BooleanAdvice_IAdvise, gen_build_command_UnsetAdvice_IAdvise, gen_build_filter_OSGiBasedFilter_IFilter, gen_build_filter_AndFilter_FilterGroup, gen_build_filter_OrFilter_FilterGroup, gen_build_filter_FilterGroup_IFilter, gen_build_filter_RegexpFilter_SinglePropertyFilter, gen_build_filter_SinglePropertyFilter_IFilter, gen_build_filter_SimplePatternFIlter_SinglePropertyFilter},
    metadata=None
)
