...
# Classes
egt_DiEdge = Class(name="egt_DiEdge")
Edge = Class(name="Edge")
egt_GraphModel = Class(name="egt_GraphModel")
egt_SingleEdge = Class(name="egt_SingleEdge")
egt_Vertex = Class(name="egt_Vertex")
egt_Edge = Class(name="egt_Edge")
egt_ColorRegistry = Class(name="egt_ColorRegistry")
...
egt_Vertex.attributes={egt_Vertex_color, egt_Vertex_index, egt_Vertex_name}
...
egt_Edge.attributes={egt_Edge_weight, egt_Edge_color}
...
domain_model = DomainModel(
    ...
    associations={vertexes4, colorRegistry6, child9, edges0, parentVertex1},
