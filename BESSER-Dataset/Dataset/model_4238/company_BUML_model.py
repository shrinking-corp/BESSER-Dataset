...
company_Person.attributes={company_Person_name, company_Person_age, company_Person_isUnemployed, company_Person_salary, company_Person_gender, company_Person_lastname}
...
domain_model = DomainModel(
    name="company",
    types={company_Company, company_Person, Gender},
