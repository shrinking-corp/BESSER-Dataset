...
# Classes
tp6_Position = Class(name="tp6_Position")
tp6_Collaboration = Class(name="tp6_Collaboration")
tp6_Paragraph = Class(name="tp6_Paragraph")
tp6_Researcher = Class(name="tp6_Researcher")
tp6_Paper = Class(name="tp6_Paper")
tp6_Skill = Class(name="tp6_Skill")
tp6_Keyword = Class(name="tp6_Keyword")
tp6_PaperKeywords = Class(name="tp6_PaperKeywords")
tp6_PublicationStructure = Class(name="tp6_PublicationStructure")
tp6_KnowledgeManager = Class(name="tp6_KnowledgeManager")
...
tp6_Paragraph.attributes={tp6_Paragraph_content, tp6_Paragraph_name, tp6_Paragraph_id}
...
domain_model = DomainModel(
    name="tp6",
    types={tp6_Position, tp6_Collaboration, tp6_Paragraph, tp6_Researcher, tp6_Paper, tp6_Skill, tp6_Keyword, tp6_PaperKeywords, tp6_PublicationStructure, tp6_KnowledgeManager},
    associations={res_position2, collaborations4, paragraphs6, authors7, res_papers0, skills1, parent24, col_paper26, kPapers29, citedBy9, keywords11, researchers13, papers15, positions18, knowledgeMan21, keyword31, allKeywords34},
    generalizations={},
    metadata=None
)
