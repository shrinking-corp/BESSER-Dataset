...
# Classes
processModels_ProcessModel = Class(name="processModels_ProcessModel")
processModels_Node = Class(name="processModels_Node", is_abstract=True)
processModels_Task = Class(name="processModels_Task")
Node = Class(name="Node")
processModels_CompositeTask = Class(name="processModels_CompositeTask")
Task = Class(name="Task")
processModels_FlowEdge = Class(name="processModels_FlowEdge")
...
processModels_ProcessModel.methods={processModels_ProcessModel_m_nodes, processModels_ProcessModel_m_edges, processModels_ProcessModel_m_terminatingTasks}
...
processModels_FlowEdge.methods={processModels_FlowEdge_m_input, processModels_FlowEdge_m_output}
...
domain_model = DomainModel(
    name="processModels",
    types={processModels_ProcessModel, processModels_Node, processModels_Task, Node, processModels_CompositeTask, Task, processModels_FlowEdge},
    associations={},
    generalizations={gen_processModels_Task_Node, gen_processModels_CompositeTask_Task},
    metadata=None
)
