...
# Classes
semlink_G = Class(name="semlink_G")
NamedElement = Class(name="NamedElement")
semlink_B = Class(name="semlink_B")
semlink_NamedElement = Class(name="semlink_NamedElement")
semlink_A = Class(name="semlink_A")
semlink_C = Class(name="semlink_C")
...
domain_model = DomainModel(
    name="semlink",
    types={semlink_G, NamedElement, semlink_B, semlink_NamedElement, semlink_A, semlink_C},
    associations={bs9, a11, c14, subgs1, as_2, cs4, cs6},
