...
public class servicefeaturemodel_Configuration  {
    ...
    public servicefeaturemodel_Configuration(
        String id,        String name,        String description        ArrayList<servicefeaturemodel_Attribute> servicefeaturemodel_attributes,        ArrayList<servicefeaturemodel_ServiceFeature> servicefeaturemodel_servicefeatures    ) {
        this.id = id;
        this.name = name;
        this.description = description;
