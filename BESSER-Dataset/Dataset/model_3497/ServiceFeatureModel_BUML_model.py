...
servicefeaturemodel_ServiceFeatureDiagram_m_validate: Method = Method(name="validate", parameters={Parameter(name='servicefeaturemodel_diagnostic', type=StringType), Parameter(name='servicefeaturemodel_context', type=StringType)}, type=BooleanType)
...
servicefeaturemodel_ServiceFeature_m_validate: Method = Method(name="validate", parameters={Parameter(name='servicefeaturemodel_context', type=StringType), Parameter(name='servicefeaturemodel_diagnostic', type=StringType)}, type=BooleanType)
servicefeaturemodel_ServiceFeature.attributes={servicefeaturemodel_ServiceFeature_mapsToGSMElement, servicefeaturemodel_ServiceFeature_required, servicefeaturemodel_ServiceFeature_associatedGSMElement, servicefeaturemodel_ServiceFeature_maxAmount, servicefeaturemodel_ServiceFeature_featureType, servicefeaturemodel_ServiceFeature_description, servicefeaturemodel_ServiceFeature_id, servicefeaturemodel_ServiceFeature_minAmount, servicefeaturemodel_ServiceFeature_name}
...
servicefeaturemodel_AttributeType.attributes={servicefeaturemodel_AttributeType_customAttributeTypePriority, servicefeaturemodel_AttributeType_name, servicefeaturemodel_AttributeType_scaleOrder, servicefeaturemodel_AttributeType_description, servicefeaturemodel_AttributeType_requirement, servicefeaturemodel_AttributeType_aggregationRule, servicefeaturemodel_AttributeType_toBeEvaluated, servicefeaturemodel_AttributeType_domain}
...
servicefeaturemodel_Configuration_m_validate: Method = Method(name="validate", parameters={Parameter(name='servicefeaturemodel_diagnostic', type=StringType), Parameter(name='servicefeaturemodel_context', type=StringType)}, type=BooleanType)
servicefeaturemodel_Configuration.attributes={servicefeaturemodel_Configuration_id, servicefeaturemodel_Configuration_name, servicefeaturemodel_Configuration_description}
...
servicefeaturemodel_Preference.attributes={servicefeaturemodel_Preference_description, servicefeaturemodel_Preference_stakeholderGroup, servicefeaturemodel_Preference_creationDate, servicefeaturemodel_Preference_value}
...
domain_model = DomainModel(
    ...
    types={servicefeaturemodel_PossibleConfigurations, servicefeaturemodel_AttributeTypes, servicefeaturemodel_Service, servicefeaturemodel_ServiceFeatureDiagram, servicefeaturemodel_ServiceFeature, servicefeaturemodel_Attribute, servicefeaturemodel_Variant, servicefeaturemodel_Requires, servicefeaturemodel_Excludes, servicefeaturemodel_XOR, servicefeaturemodel_OptionalServiceFeature, ServiceFeature, servicefeaturemodel_AttributeType, servicefeaturemodel_ModifyRelationship, servicefeaturemodel_OR, Variant, servicefeaturemodel_Configuration, servicefeaturemodel_Preference, servicefeaturemodel_MandatoryServiceFeature, servicefeaturemodel_AttributeToAttributeModifyRelationship, ModifyRelationship, servicefeaturemodel_FeatureToAttributeModifyRelationship, AttributeDomain, AggregationRules, ScaleOrders, FeatureTypes},
    associations={representedBy0, enables1, has3, decomposesInto13, describedBy5, containsVariant6, containsRequires8, containsExcludes10, ofAttributeType15, containsModifyRelationship17, requiresServiceFeature19, excludesServiceFeature22, describedBy32, containsFeatures25, groups28, evaluatedBy30, contains35, contains37, contains40, triggeredByAttribute43, triggeredByServiceFeature45},
    generalizations={gen_servicefeaturemodel_OR_Variant, gen_servicefeaturemodel_XOR_Variant, gen_servicefeaturemodel_OptionalServiceFeature_ServiceFeature, gen_servicefeaturemodel_MandatoryServiceFeature_ServiceFeature, gen_servicefeaturemodel_AttributeToAttributeModifyRelationship_ModifyRelationship, gen_servicefeaturemodel_FeatureToAttributeModifyRelationship_ModifyRelationship},
    metadata=None
)
