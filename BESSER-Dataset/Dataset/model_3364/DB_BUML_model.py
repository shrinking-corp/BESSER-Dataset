...
domain_model = DomainModel(
    name="DB",
    types={DB_NamedElement, DB_Database, DB_DatabaseElement, NamedElement, DB_Table, DatabaseElement, DB_Column, DB_Type},
    associations={contents0, columns1, primaryKeys2, type5},
