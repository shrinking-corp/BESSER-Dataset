...
# Classes
multiview4_F = Class(name="multiview4_F")
multiview4_A = Class(name="multiview4_A")
Named = Class(name="Named")
multiview4_B = Class(name="multiview4_B")
multiview4_E = Class(name="multiview4_E")
multiview4_C = Class(name="multiview4_C")
multiview4_Named = Class(name="multiview4_Named")
...
domain_model = DomainModel(
    name="multiview4",
    types={multiview4_F, multiview4_A, Named, multiview4_B, multiview4_E, multiview4_C, multiview4_Named},
    associations={fs5, bs0, es1, cs3},
    generalizations={gen_multiview4_A_Named, gen_multiview4_B_Named, gen_multiview4_C_Named, gen_multiview4_E_Named, gen_multiview4_F_Named},
    metadata=None
)
