...
# Classes
wxyz_NamedElt = Class(name="wxyz_NamedElt", is_abstract=True)
wxyz_Model = Class(name="wxyz_Model")
NamedElt = Class(name="NamedElt")
wxyz_W = Class(name="wxyz_W")
wxyz_Other = Class(name="wxyz_Other")
wxyz_X = Class(name="wxyz_X")
W = Class(name="W")
wxyz_Y = Class(name="wxyz_Y")
X = Class(name="X")
wxyz_Y1 = Class(name="wxyz_Y1")
wxyz_Y2 = Class(name="wxyz_Y2")
wxyz_Z = Class(name="wxyz_Z")
Y = Class(name="Y")
wxyz_Z1 = Class(name="wxyz_Z1")
wxyz_Z2 = Class(name="wxyz_Z2")
wxyz_Z3 = Class(name="wxyz_Z3")
...
domain_model = DomainModel(
    name="wxyz",
    types={wxyz_NamedElt, wxyz_Model, NamedElt, wxyz_W, wxyz_Other, wxyz_X, W, wxyz_Y, X, wxyz_Y1, wxyz_Y2, wxyz_Z, Y, wxyz_Z1, wxyz_Z2, wxyz_Z3},
    associations={elements0, others1, optionalX3, children6},
    generalizations={gen_wxyz_Model_NamedElt, gen_wxyz_W_NamedElt, gen_wxyz_X_W, gen_wxyz_Y_X, gen_wxyz_Y1_X, gen_wxyz_Y2_X, gen_wxyz_Z_Y, gen_wxyz_Z1_Y, gen_wxyz_Z2_Y, gen_wxyz_Z3_Y, gen_wxyz_Other_NamedElt},
    metadata=None
)
