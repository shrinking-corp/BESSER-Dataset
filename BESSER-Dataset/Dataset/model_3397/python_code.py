...
class ramRoot_MTpre__Waitress(MTpre__Element):
    ...
    def __init__(self, MTpre__name: str, ramRoot_MTpre__Waitress11: "ramRoot_MTpre__Restaurant" = None, ramRoot_MTpre__Waitress: set["ramRoot_MTpre__Table"] = None):
...
class ramRoot_MTpre__Table(MTpre__Element):
    ...
    def __init__(self, MTpre__id: str, MTpre__isReserved: str, ramRoot_MTpre__Table: set["ramRoot_MTpre__Chair"] = None, ramRoot_MTpre__Table6: "ramRoot_MTpre__Waitress" = None, ramRoot_MTpre__Table8: "ramRoot_MTpre__Restaurant" = None):
...
class ramRoot_MTpos__Table(MTpos__Element):
    ...
    def __init__(self, MTpos__id: str, MTpos__isReserved: str, ramRoot_MTpos__Table: set["ramRoot_MTpos__Chair"] = None, ramRoot_MTpos__Table16: "ramRoot_MTpos__Restaurant" = None, ramRoot_MTpos__Table3: "ramRoot_MTpos__Waitress" = None):
