...
# Classes
opposite2_Root = Class(name="opposite2_Root")
opposite2_EndA = Class(name="opposite2_EndA")
opposite2_AbstractClassB = Class(name="opposite2_AbstractClassB", is_abstract=True)
opposite2_ConcreteEndB1 = Class(name="opposite2_ConcreteEndB1")
AbstractClassB = Class(name="AbstractClassB")
opposite2_ConcreteEndB2 = Class(name="opposite2_ConcreteEndB2")
...
domain_model = DomainModel(
    name="opposite2",
    types={opposite2_Root, opposite2_EndA, opposite2_AbstractClassB, opposite2_ConcreteEndB1, AbstractClassB, opposite2_ConcreteEndB2},
