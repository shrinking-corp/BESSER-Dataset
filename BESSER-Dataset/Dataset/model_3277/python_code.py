...
class sm_Observation:
    ...
    def __init__(self, time: str, mark: "sm_State" = None, marks: "sm_StateMachine" = None, Observation: "sm_StateMachine" = None, Observation13: "sm_State" = None):
        self.time = time
        self.mark = mark
        self.marks = marks
...
class sm_Transition:
    ...
    def __init__(self, name: str, sm_Transition: "sm_State" = None, sm_Transition18: "sm_State" = None, edges: "sm_StateMachine" = None, Transition: "sm_StateMachine" = None):
        self.name = name
...
class sm_State:
    ...
    def __init__(self, name: str, nodes: "sm_StateMachine" = None, sm_State16: "sm_Transition" = None, sm_State19: "sm_Transition" = None, State23: "sm_Observation" = None, sm_State3: "sm_StateMachine" = None, sm_State: "sm_StateMachine" = None, State: "sm_StateMachine" = None, sm_State10: set["sm_StateMachine"] = None, node: "sm_Observation" = None):
        self.name = name
        self.nodes = nodes
...
class sm_StateMachine:
    ...
    def __init__(self, name: str, StateMachine21: "sm_Transition" = None, StateMachine25: "sm_Observation" = None, sm_StateMachine2: set["sm_State"] = None, sm_StateMachine: "sm_State" = None, graph: set["sm_State"] = None, graph6: set["sm_Transition"] = None, graph8: set["sm_Observation"] = None, sm_StateMachine11: "sm_State" = None, StateMachine: "sm_State" = None):
        self.name = name
