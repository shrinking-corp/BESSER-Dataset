...
# Classes
WebApp_Pages = Class(name="WebApp_Pages")
NamedElement = Class(name="NamedElement")
WebApp_Action = Class(name="WebApp_Action")
WebApp_Views = Class(name="WebApp_Views")
IdElement = Class(name="IdElement")
WebApp_Tables = Class(name="WebApp_Tables")
WebApp_Forms = Class(name="WebApp_Forms")
WebApp_styleElements = Class(name="WebApp_styleElements")
WebApp_ActionMapping = Class(name="WebApp_ActionMapping")
WebApp_Entities = Class(name="WebApp_Entities")
WebApp_Dummies = Class(name="WebApp_Dummies")
WebApp_Attribute = Class(name="WebApp_Attribute")
WebApp_NamedElement = Class(name="WebApp_NamedElement", is_abstract=True)
WebApp_FormElements = Class(name="WebApp_FormElements")
WebApp_Controller = Class(name="WebApp_Controller")
WebApp_DynamicApplication = Class(name="WebApp_DynamicApplication")
WebApp_IdElement = Class(name="WebApp_IdElement", is_abstract=True)
...
domain_model = DomainModel(
    name="WebApp",
    types={WebApp_Pages, NamedElement, WebApp_Action, WebApp_Views, IdElement, WebApp_Tables, WebApp_Forms, WebApp_styleElements, WebApp_ActionMapping, WebApp_Entities, WebApp_Dummies, WebApp_Attribute, WebApp_NamedElement, WebApp_FormElements, WebApp_Controller, WebApp_DynamicApplication, WebApp_IdElement},
    associations={action0, views1, tables3, forms5, action11, actionmapping13, entities15, Controller17, views20, has24, values26, attribute28, has7, formelements9, attribute38, contain30, pages33, entities35},
    generalizations={gen_WebApp_Pages_NamedElement, gen_WebApp_Views_NamedElement, gen_WebApp_Views_IdElement, gen_WebApp_Action_NamedElement, gen_WebApp_Entities_NamedElement, gen_WebApp_Tables_NamedElement, gen_WebApp_Tables_IdElement, gen_WebApp_Forms_NamedElement, gen_WebApp_Forms_IdElement, gen_WebApp_FormElements_NamedElement, gen_WebApp_FormElements_IdElement, gen_WebApp_Controller_NamedElement, gen_WebApp_Dummies_NamedElement, gen_WebApp_Attribute_NamedElement, gen_WebApp_styleElements_NamedElement, gen_WebApp_styleElements_IdElement, gen_WebApp_DynamicApplication_NamedElement},
    metadata=None
)
