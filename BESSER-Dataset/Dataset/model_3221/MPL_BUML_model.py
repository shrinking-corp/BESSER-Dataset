...
mpl_ComparisonExpression = Class(name="mpl_ComparisonExpression")
...
mpl_MulExpression = Class(name="mpl_MulExpression")
...
mpl_Trace = Class(name="mpl_Trace")
...
domain_model = DomainModel(
    name="mpl",
    types={mpl_MPLModel, mpl_Program, mpl_Operation, mpl_FunctionalUnit, mpl_VariableDeclaration, mpl_Function, Operation, mpl_Procedure, mpl_Expression, mpl_Statement, mpl_Assignment, Statement, mpl_VariableReference, mpl_IfStatement, mpl_ComparisonExpression, mpl_WhileLoop, mpl_Block, FunctionalUnit, mpl_Variable, mpl_ReturnStatement, mpl_ExpressionStatement, mpl_AtomicExpression, Expression, mpl_LiteralValue, AtomicExpression, mpl_ArithmeticExpression, mpl_AddExpression, ArithmeticExpression, mpl_SubExpression, mpl_DivExpression, mpl_MulExpression, mpl_UnaryExpression, mpl_UnaryMinusExpression, UnaryExpression, mpl_ParenthesisExpression, mpl_OperationExpression, mpl_ForLoop, mpl_Trace, ComparisonOperator, ForLoopDirection},
    associations={program0, operations1, variableDeclarations3, variable8, variableInitialization11, statements13, rightHandSide15, leftHandSide17, condition19, thenBlock20, elseBlock23, condition26, body28, functionalBody4, parameters6, varToPrint39, returnValue41, expression43, variable45, leftHandSide48, rightHandSide51, operand154, operand256, operand59, counter31, bound33, body36, operation61, parameters63},
    generalizations={gen_mpl_Function_Operation, gen_mpl_Procedure_Operation, gen_mpl_Assignment_Statement, gen_mpl_IfStatement_Statement, gen_mpl_WhileLoop_Statement, gen_mpl_Program_FunctionalUnit, gen_mpl_Operation_FunctionalUnit, gen_mpl_ReturnStatement_Statement, gen_mpl_ExpressionStatement_Statement, gen_mpl_AtomicExpression_Expression, gen_mpl_LiteralValue_AtomicExpression, gen_mpl_VariableReference_AtomicExpression, gen_mpl_ArithmeticExpression_Expression, gen_mpl_AddExpression_ArithmeticExpression, gen_mpl_SubExpression_ArithmeticExpression, gen_mpl_DivExpression_ArithmeticExpression, gen_mpl_MulExpression_ArithmeticExpression, gen_mpl_UnaryExpression_Expression, gen_mpl_UnaryMinusExpression_UnaryExpression, gen_mpl_ParenthesisExpression_UnaryExpression, gen_mpl_OperationExpression_Expression, gen_mpl_ForLoop_Statement, gen_mpl_Trace_Statement},
    metadata=None
)
