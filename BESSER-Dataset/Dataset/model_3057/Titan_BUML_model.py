...
# Classes
titan_Module = Class(name="titan_Module")
titan_Package = Class(name="titan_Package")
titan_Entity = Class(name="titan_Entity")
titan_Feature = Class(name="titan_Feature")
titan_MultiDataType = Class(name="titan_MultiDataType")
titan_SingleDataType = Class(name="titan_SingleDataType")
DataType = Class(name="DataType")
titan_Reference = Class(name="titan_Reference")
Feature = Class(name="Feature")
titan_MultiReference = Class(name="titan_MultiReference")
titan_SingleReference = Class(name="titan_SingleReference")
Reference = Class(name="Reference")
titan_DataType = Class(name="titan_DataType")
...
domain_model = DomainModel(
    name="titan",
    types={titan_Module, titan_Package, titan_Entity, titan_Feature, titan_MultiDataType, titan_SingleDataType, DataType, titan_Reference, Feature, titan_MultiReference, titan_SingleReference, Reference, titan_DataType, InternalDSLType, DataTypes},
    associations={packages0, entities1, superEntity4, features6, opposite12, reference8, opposite10},
    generalizations={gen_titan_SingleDataType_DataType, gen_titan_MultiDataType_DataType, gen_titan_Reference_Feature, gen_titan_SingleReference_Reference, gen_titan_MultiReference_Reference, gen_titan_DataType_Feature},
    metadata=None
)
