...
class titan_Entity:
    ...
    def __init__(self, name: str, titan_Entity: "titan_Package" = None, titan_Entity5: "titan_Entity" = None, titan_Entity3: "titan_Entity" = None, titan_Entity7: set["titan_Feature"] = None, titan_Entity9: "titan_Reference" = None):
        self.name = name
