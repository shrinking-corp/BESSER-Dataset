...
class odemcustom_RhsExpression(ABC):
    ...
    def __init__(self, odemcustom_RhsExpression200: "odemcustom_ArbitraryExpr" = None, odemcustom_RhsExpression202: "odemcustom_AlternativeExpr" = None, odemcustom_RhsExpression205: "odemcustom_AlternativeExpr" = None, odemcustom_RhsExpression: "odemcustom_TsRule" = None, odemcustom_RhsExpression192: "odemcustom_SequenceExpr" = None, odemcustom_RhsExpression194: "odemcustom_OptionalExpr" = None, odemcustom_RhsExpression196: "odemcustom_RuntimeExpr" = None, odemcustom_RhsExpression198: "odemcustom_AtLeastOneExpr" = None):
...
class odemcustom_Clazz(Classifier, ClassSimilar):
    ...
    def __init__(self, active: bool, odemcustom_Clazz: "odemcustom_ClassSimilar" = None, odemcustom_Clazz71: set["odemcustom_Expression"] = None, odemcustom_Clazz78: "odemcustom_ClassAugment" = None, odemcustom_Clazz69: "odemcustom_Constructor" = None):
        self.active = active
...
class odemcustom_Variable(ModifierExtensionsContainer, AbstractVariable, Statement):

    def __init__(self, control: bool, clazz: bool, odemcustom_Variable30: "odemcustom_Annotation" = None, odemcustom_Variable: "odemcustom_Module" = None, odemcustom_Variable46: "odemcustom_ClassSimilar" = None, odemcustom_Variable86: "odemcustom_Expression" = None, odemcustom_Variable138: "odemcustom_ForEachStatement" = None):
...
class TypedElement:
    ...
    pass
class odemcustom_CreateObject(Expression, TypedElement):

    pass
class odemcustom_Cast(UnaryOperator, TypedElement):
...
class odemcustom_AbstractVariable(TypedElement, NamedElement):
    ...
    pass
class odemcustom_Procedure(AnnotatableElement, CodeBlock, TypedElement, NamedElement):

    def __init__(self, clazz: bool, odemcustom_Procedure27: set["odemcustom_Parameter"] = None, odemcustom_Procedure: "odemcustom_Module" = None, odemcustom_Procedure49: "odemcustom_ClassSimilar" = None, odemcustom_Procedure81: "odemcustom_Interface" = None):
        self.clazz = clazz
...
class odemcustom_ReferableRhsType(NamedElement):
    ...
    pass
class odemcustom_Classifier(NamedElement, Type, ReferableRhsType):
...
class odemcustom_Pattern(NamedElement):
    ...
    def __init__(self, top: bool, odemcustom_Pattern: "odemcustom_ReferencePropertyType" = None, odemcustom_Pattern272: "odemcustom_IncludePattern" = None, odemcustom_Pattern252: "odemcustom_IdResolution" = None, odemcustom_Pattern254: "odemcustom_Parameter" = None, odemcustom_Pattern257: "odemcustom_CodeBlock" = None):
        self.top = top
