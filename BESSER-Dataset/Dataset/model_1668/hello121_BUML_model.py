...
# Classes
hello121_Base = Class(name="hello121_Base")
hello121_Thing = Class(name="hello121_Thing")
hello121_Classoc = Class(name="hello121_Classoc")
NamedElement = Class(name="NamedElement")
hello121_RelatedTo = Class(name="hello121_RelatedTo")
hello121_Third = Class(name="hello121_Third")
hello121_NamedElement = Class(name="hello121_NamedElement", is_abstract=True)
hello121_Alias = Class(name="hello121_Alias")
...
domain_model = DomainModel(
    name="hello121",
    types={hello121_Base, hello121_Thing, hello121_Classoc, NamedElement, hello121_RelatedTo, hello121_Third, hello121_NamedElement, hello121_Alias},
    associations={toThing11, things0, classocs1, relations3, foos4, classocs6, aliases9, fromThing10, third13, base16},
