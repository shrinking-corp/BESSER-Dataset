...
class hello121_RelatedTo(NamedElement):
    ...
    def __init__(self, since: str, hello121_RelatedTo: "hello121_Thing" = None, RelatedTo: "hello121_Thing" = None, relations: "hello121_Thing" = None):
        self.since = since
...
class hello121_Thing(NamedElement):
    ...
    def __init__(self, id: int, hello121_Thing12: "hello121_RelatedTo" = None, hello121_Thing: "hello121_Base" = None, fromThing: set["hello121_RelatedTo"] = None, hello121_Thing5: set["hello121_Third"] = None, hello121_Thing7: set["hello121_Classoc"] = None, Thing: "hello121_RelatedTo" = None):
        self.id = id
