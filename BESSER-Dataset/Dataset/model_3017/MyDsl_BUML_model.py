...
myDsl_string_nova = Class(name="myDsl_string_nova")
...
myDsl_simple_expression = Class(name="myDsl_simple_expression")
...
myDsl_postfix_expression2 = Class(name="myDsl_postfix_expression2")
...
postfix_expression2 = Class(name="postfix_expression2")
myDsl_unary_expression = Class(name="myDsl_unary_expression")
simple_expression = Class(name="simple_expression")
...
myDsl_storage_class_specifier = Class(name="myDsl_storage_class_specifier")
myDsl_type_specifier = Class(name="myDsl_type_specifier")
myDsl_type_qualifier = Class(name="myDsl_type_qualifier")
myDsl_function_specifier = Class(name="myDsl_function_specifier")
myDsl_assignment_operator = Class(name="myDsl_assignment_operator")
myDsl_expression2 = Class(name="myDsl_expression2")
...
myDsl_struct_or_union = Class(name="myDsl_struct_or_union")
myDsl_struct_declaration_list = Class(name="myDsl_struct_declaration_list")
struct_or_union_specifier = Class(name="struct_or_union_specifier")
myDsl_struct_declaration = Class(name="myDsl_struct_declaration")
myDsl_struct_declaration_list2 = Class(name="myDsl_struct_declaration_list2")
myDsl_alignment_specifier = Class(name="myDsl_alignment_specifier")
myDsl_init_declarator = Class(name="myDsl_init_declarator")
myDsl_init_declarator_list2 = Class(name="myDsl_init_declarator_list2")
...
myDsl_enumerator_list2 = Class(name="myDsl_enumerator_list2")
...
myDsl_struct_declarator_list2 = Class(name="myDsl_struct_declarator_list2")
myDsl_direct_declarator2 = Class(name="myDsl_direct_declarator2")
...
myDsl_identifier_list2 = Class(name="myDsl_identifier_list2")
myDsl_type_qualifier_list2 = Class(name="myDsl_type_qualifier_list2")
myDsl_parameter_list = Class(name="myDsl_parameter_list")
myDsl_parameter_declaration = Class(name="myDsl_parameter_declaration")
myDsl_parameter_list2 = Class(name="myDsl_parameter_list2")
myDsl_designator_list = Class(name="myDsl_designator_list")
myDsl_designator = Class(name="myDsl_designator")
myDsl_designator_list2 = Class(name="myDsl_designator_list2")
myDsl_direct_abstract_declarator = Class(name="myDsl_direct_abstract_declarator")
myDsl_direct_abstract_declarator2 = Class(name="myDsl_direct_abstract_declarator2")
myDsl_initializer = Class(name="myDsl_initializer")
myDsl_designation = Class(name="myDsl_designation")
myDsl_initializer_list2 = Class(name="myDsl_initializer_list2")
...
myDsl_EObject = Class(name="myDsl_EObject")
myDsl_external_declaration = Class(name="myDsl_external_declaration")
myDsl_ADD = Class(name="myDsl_ADD")
myDsl_MINUS = Class(name="myDsl_MINUS")
myDsl_declaration_list2 = Class(name="myDsl_declaration_list2")
myDsl_variableRef = Class(name="myDsl_variableRef")
myDsl_intType = Class(name="myDsl_intType")
type_specifier = Class(name="type_specifier")
myDsl_floatType = Class(name="myDsl_floatType")
myDsl_stringType = Class(name="myDsl_stringType")
myDsl_booleanType = Class(name="myDsl_booleanType")
myDsl_EXC_OR = Class(name="myDsl_EXC_OR")
myDsl_MUL = Class(name="myDsl_MUL")
myDsl_INC_OR = Class(name="myDsl_INC_OR")
myDsl_LOG_AND = Class(name="myDsl_LOG_AND")
myDsl_SHF = Class(name="myDsl_SHF")
myDsl_REL = Class(name="myDsl_REL")
myDsl_EQL = Class(name="myDsl_EQL")
myDsl_AND = Class(name="myDsl_AND")
myDsl_complexType = Class(name="myDsl_complexType")
myDsl_imaginaryType = Class(name="myDsl_imaginaryType")
myDsl_LOG_OR = Class(name="myDsl_LOG_OR")
myDsl_voidType = Class(name="myDsl_voidType")
myDsl_charType = Class(name="myDsl_charType")
myDsl_shortType = Class(name="myDsl_shortType")
myDsl_longType = Class(name="myDsl_longType")
myDsl_doubleType = Class(name="myDsl_doubleType")
myDsl_signedType = Class(name="myDsl_signedType")
myDsl_unsignedType = Class(name="myDsl_unsignedType")
...
myDsl_constant.attributes={myDsl_constant_f_constant, myDsl_constant_i_constant, myDsl_constant_enumt}
...
myDsl_unary_expression.attributes={myDsl_unary_expression_unary_operator, myDsl_unary_expression_inc_op, myDsl_unary_expression_alignof, myDsl_unary_expression_dec_op, myDsl_unary_expression_sizeof}
...
myDsl_static_assert_declaration.attributes={myDsl_static_assert_declaration_string_literal, myDsl_static_assert_declaration_static_assert}
...
myDsl_storage_class_specifier.attributes={myDsl_storage_class_specifier_thread_local, myDsl_storage_class_specifier_typedef, myDsl_storage_class_specifier_static, myDsl_storage_class_specifier_register, myDsl_storage_class_specifier_extern, myDsl_storage_class_specifier_auto}
...
myDsl_type_qualifier.attributes={myDsl_type_qualifier_atomic, myDsl_type_qualifier_restrict, myDsl_type_qualifier_volatile, myDsl_type_qualifier_const}
...
myDsl_function_specifier.attributes={myDsl_function_specifier_inline, myDsl_function_specifier_noreturn}
...
myDsl_assignment_operator.attributes={myDsl_assignment_operator_or_assign, myDsl_assignment_operator_right_assign, myDsl_assignment_operator_mul_assign, myDsl_assignment_operator_sub_assign, myDsl_assignment_operator_xor_assign, myDsl_assignment_operator_left_assign, myDsl_assignment_operator_mod_assign, myDsl_assignment_operator_and_assign, myDsl_assignment_operator_div_assign, myDsl_assignment_operator_add_assign}
...
myDsl_struct_or_union.attributes={myDsl_struct_or_union_union, myDsl_struct_or_union_struct}
...
myDsl_labeled_statement.attributes={myDsl_labeled_statement_default, myDsl_labeled_statement_identifier, myDsl_labeled_statement_case}
...
myDsl_selection_statement_if_: Property = Property(name="if_", type=StringType)
myDsl_selection_statement_else_: Property = Property(name="else_", type=StringType)
myDsl_selection_statement_switch: Property = Property(name="switch", type=StringType)
myDsl_selection_statement.attributes={myDsl_selection_statement_switch, myDsl_selection_statement_if_, myDsl_selection_statement_else_}

# myDsl_iteration_statement class attributes and methods
myDsl_iteration_statement_while_: Property = Property(name="while_", type=StringType)
myDsl_iteration_statement_do: Property = Property(name="do", type=StringType)
myDsl_iteration_statement_for_: Property = Property(name="for_", type=StringType)
myDsl_iteration_statement.attributes={myDsl_iteration_statement_do, myDsl_iteration_statement_for_, myDsl_iteration_statement_while_}
...
myDsl_jump_statement_continue_: Property = Property(name="continue_", type=StringType)
...
myDsl_jump_statement.attributes={myDsl_jump_statement_goto, myDsl_jump_statement_continue_, myDsl_jump_statement_return_, myDsl_jump_statement_identifier, myDsl_jump_statement_break_}
...
domain_model = DomainModel(
    name="myDsl",
    types={myDsl_enumeration_constant, myDsl_string_nova, myDsl_generic_selection, myDsl_Model, myDsl_translation_unit, myDsl_simple_expression, myDsl_type_name, myDsl_constant, myDsl_conditional_expression, myDsl_expression, myDsl_assignment_expression, myDsl_generic_assoc_list, myDsl_generic_association, myDsl_postfix_expression, myDsl_postfix_expression2, myDsl_initializer_list, myDsl_argument_expression_list, postfix_expression2, myDsl_unary_expression, simple_expression, myDsl_init_declarator_list, myDsl_static_assert_declaration, myDsl_storage_class_specifier, myDsl_type_specifier, myDsl_type_qualifier, myDsl_function_specifier, myDsl_assignment_operator, myDsl_expression2, myDsl_constant_expression, myDsl_declaration, myDsl_declaration_specifiers, myDsl_struct_or_union_specifier, myDsl_enum_specifier, myDsl_struct_or_union, myDsl_struct_declaration_list, struct_or_union_specifier, myDsl_struct_declaration, myDsl_struct_declaration_list2, myDsl_alignment_specifier, myDsl_init_declarator, myDsl_init_declarator_list2, myDsl_declarator, myDsl_atomic_type_specifier, myDsl_enumerator_list, myDsl_enumerator, myDsl_enumerator_list2, myDsl_specifier_qualifier_list, myDsl_struct_declarator_list, myDsl_struct_declarator, myDsl_struct_declarator_list2, myDsl_direct_declarator2, myDsl_type_qualifier_list, myDsl_parameter_type_list, myDsl_identifier_list, myDsl_pointer, myDsl_direct_declarator, myDsl_abstract_declarator, myDsl_identifier_list2, myDsl_type_qualifier_list2, myDsl_parameter_list, myDsl_parameter_declaration, myDsl_parameter_list2, myDsl_designator_list, myDsl_designator, myDsl_designator_list2, myDsl_direct_abstract_declarator, myDsl_direct_abstract_declarator2, myDsl_initializer, myDsl_designation, myDsl_initializer_list2, myDsl_block_item, myDsl_statement, myDsl_labeled_statement, myDsl_compound_statement, myDsl_expression_statement, myDsl_selection_statement, myDsl_iteration_statement, myDsl_jump_statement, myDsl_function_definition, myDsl_declaration_list, myDsl_EObject, myDsl_external_declaration, myDsl_ADD, myDsl_MINUS, myDsl_declaration_list2, myDsl_variableRef, myDsl_intType, type_specifier, myDsl_floatType, myDsl_stringType, myDsl_booleanType, myDsl_EXC_OR, myDsl_MUL, myDsl_INC_OR, myDsl_LOG_AND, myDsl_SHF, myDsl_REL, myDsl_EQL, myDsl_AND, myDsl_complexType, myDsl_imaginaryType, myDsl_LOG_OR, myDsl_voidType, myDsl_charType, myDsl_shortType, myDsl_longType, myDsl_doubleType, myDsl_signedType, myDsl_unsignedType},
    associations={declaracoes0, type_name1, cast_expression3, unary_expression36, simple_expression38, logical_or_expression40, expression43, assignment_expression5, generic_assoc_list6, generic_association8, generic_list10, type_name13, assignment_expression16, primary_expression19, postifx_expres21, type_name23, initializer_list26, assignment_expression28, list31, postfix_expression33, init_declarator_list70, static_assert_declaration72, storage_class_specifier74, declaration_specifiers77, type_specifier79, conditional_expression46, type_qualifier81, function_specifier83, conditional_expression48, unary_expression51, assignment_operator54, assignment_expression57, expression259, assignment_expression61, expression265, conditional_expression67, declaration_specifiers69, struct_or_union_specifier104, enum_specifier106, struct_or_union108, struct_declaration_list110, struct_declaration112, alignment_specifier85, init_declarator87, init_declarator_list289, init_declarator91, init_declarator_list295, declarator97, initializer99, atomic_type_specifier102, constant_expression148, declarator151, enumerator_list154, enumerator156, enumerator_list2158, enumerator160, struct_declaration_list2114, struct_declaration116, struct_declaration_list2120, specifier_qualifier_list122, struct_declarator_list124, static_assert_declaration126, type_specifier129, specifier_qualifier_list133, type_qualifier135, struct_declarator138, struct_declarator_list2140, struct_declarator142, struct_declarator_list2146, direct_declarators184, Declarator186, declarators190, type_qualifier_list192, assignment_expression194, parameter_type_list197, identifier_list199, enumerator_list2164, enumeration_constant166, constant_expression168, type_name171, type_name174, constant_expression177, pointer180, direct_declarator182, declarator233, abstract_declarator236, identifier_list2238, identifier_list2241, specifier_qualifier_list243, abstract_declarator246, type_qualifier_list201, pointer205, type_qualifier207, type_qualifier_list2210, type_qualifier212, type_qualifier_list2216, parameter_list218, parameter_declaration220, parameter_list2222, parameter_declaration224, parameter_list2228, declaration_specifiers230, initializer_list2284, designator_list286, designator288, designator_list2290, designator292, designator_list2296, pointer249, direct_abstract_declarator252, direct_abstract_declarator2254, type_qualifier_list256, assignment_expression259, parameter_type_list262, initializer_list265, assignment_expression267, designation270, initializer272, initializer_list2275, designation277, initializer280, block_item_list321, declaration323, statement326, expression329, expression332, constant_expression298, constant_expression301, labeled_statement304, compound_statement305, expression_statement307, selection_statement309, iteration_statement311, jump_statement313, statement315, constant_expression318, function_definition360, declaration362, declaration_specifiers365, declarator368, declaration_list371, compound_statement373, declaration376, statement335, statement2338, expression341, statement343, expression_statement346, expression_statement2349, declaration352, expression355, external_declaration358, right390, left393, right395, declaration_list_2379, declaration381, declaration_list2385, value387, left423, left388, right425, left428, right430, left398, right400, left433, left403, right405, left408, right410, left413, right415, left418, right420, right435, left438, right440},
    generalizations={gen_myDsl_argument_expression_list_postfix_expression2, gen_myDsl_unary_expression_simple_expression, gen_myDsl_expression_postfix_expression2, gen_myDsl_struct_or_union_struct_or_union_specifier, gen_myDsl_ADD_simple_expression, gen_myDsl_MINUS_simple_expression, gen_myDsl_variableRef_simple_expression, gen_myDsl_intType_simple_expression, gen_myDsl_intType_type_specifier, gen_myDsl_floatType_simple_expression, gen_myDsl_floatType_type_specifier, gen_myDsl_stringType_simple_expression, gen_myDsl_booleanType_simple_expression, gen_myDsl_booleanType_type_specifier, gen_myDsl_EXC_OR_simple_expression, gen_myDsl_MUL_simple_expression, gen_myDsl_INC_OR_simple_expression, gen_myDsl_LOG_AND_simple_expression, gen_myDsl_SHF_simple_expression, gen_myDsl_REL_simple_expression, gen_myDsl_EQL_simple_expression, gen_myDsl_AND_simple_expression, gen_myDsl_complexType_type_specifier, gen_myDsl_imaginaryType_type_specifier, gen_myDsl_LOG_OR_simple_expression, gen_myDsl_voidType_type_specifier, gen_myDsl_charType_type_specifier, gen_myDsl_shortType_type_specifier, gen_myDsl_longType_type_specifier, gen_myDsl_doubleType_type_specifier, gen_myDsl_signedType_type_specifier, gen_myDsl_unsignedType_type_specifier},
    metadata=None
)
