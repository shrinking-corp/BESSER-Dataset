...
public class myDsl_parameter_declaration  {
    ...
    private myDsl_abstract_declarator mydsl_abstract_declarator;
    ...
    public myDsl_abstract_declarator getMydsl_abstract_declarator() {
        return mydsl_abstract_declarator;
    }

    public void setMydsl_abstract_declarator(myDsl_abstract_declarator mydsl_abstract_declarator) {
        this.mydsl_abstract_declarator = mydsl_abstract_declarator;
    }
