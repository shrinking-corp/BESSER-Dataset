...
def test_hyp_extlibrary_videocassette_has_length():
...
def test_hyp_extlibrary_videocassette_has_title():
...
def test_hyp_extlibrary_bookontape_has_length():
...
def test_hyp_extlibrary_bookontape_has_title():
...
def test_hyp_extlibrary_borrowable_copies_setter(instance):
...
def test_hyp_extlibrary_person_fullName_setter(instance):
...
def test_hyp_extlibrary_audiovisualitem_length_setter(instance):
...
@given(instance=extlibrary_VideoCassette_strategy)
def test_hyp_extlibrary_videocassette_length_setter(instance):
    original = instance.length
    instance.length = original
    assert instance.length == original
...
@given(instance=extlibrary_VideoCassette_strategy)
def test_hyp_extlibrary_videocassette_title_setter(instance):
    original = instance.title
    instance.title = original
    assert instance.title == original
...
@given(instance=extlibrary_BookOnTape_strategy)
def test_hyp_extlibrary_bookontape_length_setter(instance):
    original = instance.length
    instance.length = original
    assert instance.length == original
...
@given(instance=extlibrary_BookOnTape_strategy)
def test_hyp_extlibrary_bookontape_title_setter(instance):
    original = instance.title
    instance.title = original
    assert instance.title == original
...
def test_hyp_extlibrary_magazine_pages_setter(instance):
...
@given(instance=extlibrary_Magazine_strategy)
def test_hyp_extlibrary_magazine_title_setter(instance):
    original = instance.title
    instance.title = original
    assert instance.title == original
...
def test_extlibrary_AudioVisualItem_damaged_value_roundtrip():
    instance = extlibrary_AudioVisualItem(damaged=True, length=7, title="sample_text")
    assert instance.damaged == True
    instance.damaged = False
    assert instance.damaged == False


def test_extlibrary_AudioVisualItem_length_value_roundtrip():
    instance = extlibrary_AudioVisualItem(damaged=True, length=7, title="sample_text")
...
def test_extlibrary_Borrowable_copies_value_roundtrip():
    instance = extlibrary_Borrowable(copies=7)
...
def test_extlibrary_Magazine_pages_value_roundtrip():
    instance = extlibrary_Magazine(pages=7, title="sample_text")
    assert instance.pages == 7
    instance.pages = 13
    assert instance.pages == 13


def test_extlibrary_Magazine_title_value_roundtrip():
    instance = extlibrary_Magazine(pages=7, title="sample_text")
    assert instance.title == "sample_text"
    instance.title = "sample_text_2"
    assert instance.title == "sample_text_2"
...
def test_extlibrary_Person_fullName_value_roundtrip():
    instance = extlibrary_Person(fullName="sample_text")
...
def test_extlibrary_Magazine_isa__15LbQG60EeGkd4g88tZXfA():
    instance = extlibrary_Magazine(pages=7, title="sample_text")
    assert isinstance(instance, _15LbQG60EeGkd4g88tZXfA)
...
def test_assoc_borrowers18_link_reassign_clear():
    a = extlibrary_Borrowable(copies=7)
    b1 = extlibrary__15NQcW60EeGkd4g88tZXfA()
    b2 = extlibrary__15NQcW60EeGkd4g88tZXfA()
    _safe_set(a, 'extlibrary_Borrowable', {b1})
    assert _is_linked(a, 'extlibrary_Borrowable', b1)
    if hasattr(b1, 'extlibrary__15NQcW60EeGkd4g88tZXfA19'):
        assert _is_linked(b1, 'extlibrary__15NQcW60EeGkd4g88tZXfA19', a)
    _safe_set(a, 'extlibrary_Borrowable', {b2})
    assert _is_linked(a, 'extlibrary_Borrowable', b2)
    if hasattr(b1, 'extlibrary__15NQcW60EeGkd4g88tZXfA19'):
    ...
    _safe_set(a, 'extlibrary_Borrowable', set())
    assert not _is_linked(a, 'extlibrary_Borrowable', b2)
    if hasattr(b2, 'extlibrary__15NQcW60EeGkd4g88tZXfA19'):
...
extlibrary_AudioVisualItem_strategy = st.builds(extlibrary_AudioVisualItem, damaged=st.booleans(), length=st.integers(), title=safe_text)
@given(instance=extlibrary_AudioVisualItem_strategy)
@settings(max_examples=25)
...
extlibrary_Borrowable_strategy = st.builds(extlibrary_Borrowable, copies=st.integers())
@given(instance=extlibrary_Borrowable_strategy)
@settings(max_examples=25)
...
extlibrary_Magazine_strategy = st.builds(extlibrary_Magazine, pages=st.integers(), title=safe_text)
@given(instance=extlibrary_Magazine_strategy)
@settings(max_examples=25)
...
extlibrary_Person_strategy = st.builds(extlibrary_Person, fullName=safe_text)
@given(instance=extlibrary_Person_strategy)
@settings(max_examples=25)
