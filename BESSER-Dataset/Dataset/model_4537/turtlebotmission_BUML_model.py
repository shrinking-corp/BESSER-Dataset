...
# Classes
turtlebotmission_WaypointType = Class(name="turtlebotmission_WaypointType")
turtlebotmission_WayPoint = Class(name="turtlebotmission_WayPoint")
turtlebotmission_Mission = Class(name="turtlebotmission_Mission")
turtlebotmission_NamedElement = Class(name="turtlebotmission_NamedElement", is_abstract=True)
turtlebotmission_Task = Class(name="turtlebotmission_Task", is_abstract=True)
turtlebotmission_TurtleBot = Class(name="turtlebotmission_TurtleBot")
NamedElement = Class(name="NamedElement")
turtlebotmission_Area = Class(name="turtlebotmission_Area")
turtlebotmission_ReturnToStartTask = Class(name="turtlebotmission_ReturnToStartTask")
turtlebotmission_LineTask = Class(name="turtlebotmission_LineTask")
Task = Class(name="Task")
turtlebotmission_ShortestPathTask = Class(name="turtlebotmission_ShortestPathTask")
...
domain_model = DomainModel(
    ...
    types={turtlebotmission_WaypointType, turtlebotmission_WayPoint, turtlebotmission_Mission, turtlebotmission_NamedElement, turtlebotmission_Task, turtlebotmission_TurtleBot, NamedElement, turtlebotmission_Area, turtlebotmission_ReturnToStartTask, turtlebotmission_LineTask, Task, turtlebotmission_ShortestPathTask},
    associations={waypointtypes1, bot_start3, waypoints5, missions8, waypointtypes10, area0, task13, waypoints15, waypoints17},
    generalizations={gen_turtlebotmission_WaypointType_NamedElement, gen_turtlebotmission_WayPoint_NamedElement, gen_turtlebotmission_Mission_NamedElement, gen_turtlebotmission_TurtleBot_NamedElement, gen_turtlebotmission_ReturnToStartTask_Task, gen_turtlebotmission_LineTask_Task, gen_turtlebotmission_ShortestPathTask_Task},
    metadata=None
)
