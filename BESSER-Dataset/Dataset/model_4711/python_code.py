...
class SOS_set_ModelRelation(Term):
    ...
    def __init__(self, referenceName: str, SOS_set_ModelRelation: "VariableRef" = None, SOS_set_ModelRelation95: "VariableRef" = None, Term71: "SOS_adtmm_CTerm" = None, Term28: "SOS_TypeJudment" = None, Term26: "SOS_Transition" = None, Term20: "SOS_Transition" = None, Term23: "SOS_Transition" = None, Term88: "SOS_set_SetOperator" = None, Term80: "SOS_set_SetMembership" = None, Term76: "SOS_adtmm_AbstractEquation" = None, Term83: "SOS_set_SetMembership" = None, Term34: "SOS_TypeJudment" = None, Term: "SOS_Transition" = None, Term65: "SOS_adtmm_CTerm" = None, Term73: "SOS_adtmm_AbstractEquation" = None, Term92: "SOS_set_SetConstructor" = None, Term31: "SOS_TypeJudment" = None, Term85: "SOS_set_SetOperator" = None):
...
class SOS_set_ModelClassAttribute(Term):
    ...
    def __init__(self, attributeName: str, SOS_set_ModelClassAttribute: "VariableRef" = None, Term71: "SOS_adtmm_CTerm" = None, Term28: "SOS_TypeJudment" = None, Term26: "SOS_Transition" = None, Term20: "SOS_Transition" = None, Term23: "SOS_Transition" = None, Term88: "SOS_set_SetOperator" = None, Term80: "SOS_set_SetMembership" = None, Term76: "SOS_adtmm_AbstractEquation" = None, Term83: "SOS_set_SetMembership" = None, Term34: "SOS_TypeJudment" = None, Term: "SOS_Transition" = None, Term65: "SOS_adtmm_CTerm" = None, Term73: "SOS_adtmm_AbstractEquation" = None, Term92: "SOS_set_SetConstructor" = None, Term31: "SOS_TypeJudment" = None, Term85: "SOS_set_SetOperator" = None):
...
class SOS_adtmm_CTerm(Term):
    ...
    def __init__(self, iter: int, SOS_adtmm_CTerm: set["Term"] = None, SOS_adtmm_CTerm67: "Operation" = None, SOS_adtmm_CTerm70: "Term" = None, Term71: "SOS_adtmm_CTerm" = None, Term28: "SOS_TypeJudment" = None, Term26: "SOS_Transition" = None, Term20: "SOS_Transition" = None, Term23: "SOS_Transition" = None, Term88: "SOS_set_SetOperator" = None, Term80: "SOS_set_SetMembership" = None, Term76: "SOS_adtmm_AbstractEquation" = None, Term83: "SOS_set_SetMembership" = None, Term34: "SOS_TypeJudment" = None, Term: "SOS_Transition" = None, Term65: "SOS_adtmm_CTerm" = None, Term73: "SOS_adtmm_AbstractEquation" = None, Term92: "SOS_set_SetConstructor" = None, Term31: "SOS_TypeJudment" = None, Term85: "SOS_set_SetOperator" = None):
        self.iter = iter
