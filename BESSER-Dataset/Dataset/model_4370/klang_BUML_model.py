...
# Classes
klang_SceneActor = Class(name="klang_SceneActor")
klang_Program = Class(name="klang_Program")
klang_AbstractActor = Class(name="klang_AbstractActor", is_abstract=True)
klang_SpriteActor = Class(name="klang_SpriteActor")
klang_EventHandler = Class(name="klang_EventHandler")
klang_Statement = Class(name="klang_Statement")
klang_Event = Class(name="klang_Event", is_abstract=True)
klang_VariableDeclaration = Class(name="klang_VariableDeclaration")
klang_Expression = Class(name="klang_Expression")
klang_MessageReceivedEvent = Class(name="klang_MessageReceivedEvent")
klang_GameStartEvent = Class(name="klang_GameStartEvent")
GlobalEvent = Class(name="GlobalEvent")
klang_ClickEvent = Class(name="klang_ClickEvent")
ActorEvent = Class(name="ActorEvent")
klang_KeyPressEvent = Class(name="klang_KeyPressEvent")
klang_CollisionEvent = Class(name="klang_CollisionEvent")
klang_TreeNode = Class(name="klang_TreeNode", is_abstract=True)
klang_GlobalEvent = Class(name="klang_GlobalEvent", is_abstract=True)
Event = Class(name="Event")
klang_ActorEvent = Class(name="klang_ActorEvent", is_abstract=True)
...
klang_AbstractActor_m_isInScope: Method = Method(name="isInScope", parameters={Parameter(name='klang_variableName', type=StringType)}, type=BooleanType)
klang_AbstractActor_m_getVariableDeclaration: Method = Method(name="getVariableDeclaration", parameters={Parameter(name='klang_variableName', type=StringType)}, type=StringType)
klang_AbstractActor_m_isInLocalScope: Method = Method(name="isInLocalScope", parameters={Parameter(name='klang_variableName', type=StringType)}, type=BooleanType)
klang_AbstractActor_m_isInParentScope: Method = Method(name="isInParentScope", parameters={Parameter(name='klang_variableName', type=StringType)}, type=BooleanType)
klang_AbstractActor_m_getVariableDeclarations: Method = Method(name="getVariableDeclarations", parameters={Parameter(name='klang_variableName', type=StringType)})
klang_AbstractActor.attributes={klang_AbstractActor_subject, klang_AbstractActor_name, klang_AbstractActor_subjectType}
klang_AbstractActor.methods={klang_AbstractActor_m_isInLocalScope, klang_AbstractActor_m_getVariableDeclarations, klang_AbstractActor_m_isInParentScope, klang_AbstractActor_m_isInScope, klang_AbstractActor_m_getVariableDeclaration}
...
klang_Event_m_matchingEvent: Method = Method(name="matchingEvent", parameters={Parameter(name='klang_other', type=StringType)}, type=BooleanType)
...
domain_model = DomainModel(
    name="klang",
    types={klang_SceneActor, klang_Program, klang_AbstractActor, klang_SpriteActor, klang_EventHandler, klang_Statement, klang_Event, klang_VariableDeclaration, klang_Expression, klang_MessageReceivedEvent, klang_GameStartEvent, GlobalEvent, klang_ClickEvent, ActorEvent, klang_KeyPressEvent, klang_CollisionEvent, klang_TreeNode, klang_GlobalEvent, Event, klang_ActorEvent, Keys},
    associations={program0, eventHandlers7, localVariables8, program1, statements3, referenceEvent4, expression6, target10, sceneActor11, spriteActors12},
    generalizations={gen_klang_MessageReceivedEvent_GlobalEvent, gen_klang_GameStartEvent_GlobalEvent, gen_klang_ClickEvent_ActorEvent, gen_klang_KeyPressEvent_GlobalEvent, gen_klang_CollisionEvent_ActorEvent, gen_klang_GlobalEvent_Event, gen_klang_ActorEvent_Event},
    metadata=None
)
