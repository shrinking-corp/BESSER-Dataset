...
fsm_Model = Class(name="fsm_Model")
...
domain_model = DomainModel(
    name="fsm",
    types={fsm_FiniteStateMachine, fsm_State, fsm_NamedElement, fsm_Transition, fsm_Model, NamedElement},
    associations={machine0, states1, initial2, leavingTransitions4, machine5, target6, source8},
    generalizations={gen_fsm_FiniteStateMachine_NamedElement, gen_fsm_State_NamedElement, gen_fsm_Model_NamedElement},
    metadata=None
)
