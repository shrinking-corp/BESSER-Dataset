...
umlMM_Associaton = Class(name="umlMM_Associaton")
...
domain_model = DomainModel(
    name="umlMM",
    types={umlMM_Package, umlMM_Associaton, umlMM_Attribute, umlMM_Datatype, umlMM_Classifier, umlMM_Class, Classifier},
    associations={Association0, attribute11, type12, Owner14, typeOf16, namespace18, classifier1, namespace3, destination4, source5, destinationOf7, sourceOf9},
