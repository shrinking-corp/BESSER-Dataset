...
class umlMM_Package:
    ...
    def __init__(self, name: str, namespace: set["umlMM_Associaton"] = None, Package19: "umlMM_Classifier" = None, namespace2: set["umlMM_Classifier"] = None, Package: "umlMM_Associaton" = None):
        self.name = name
