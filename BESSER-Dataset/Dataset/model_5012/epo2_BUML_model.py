...
epo2_Item.attributes={epo2_Item_USPrice, epo2_Item_shipDate, epo2_Item_partNum, epo2_Item_comment, epo2_Item_quantity, epo2_Item_productName}
...
epo2_USAddress.attributes={epo2_USAddress_state, epo2_USAddress_street, epo2_USAddress_zip, epo2_USAddress_city}
...
domain_model = DomainModel(
    name="epo2",
    types={epo2_Item, epo2_USAddress, Address, epo2_Address, epo2_PurchaseOrder, epo2_Supplier, epo2_Customer, GlobalLocation, epo2_GlobalLocation, epo2_GlobalAddress, OrderStatus},
    associations={items1, billTo2, shipTo3, order0, previousOrder8, customers10, orders11, pendingOrders14, shippedOrders17, customer6, orders20},
    generalizations={gen_epo2_USAddress_Address, gen_epo2_GlobalAddress_GlobalLocation, gen_epo2_GlobalAddress_Address},
    metadata=None
)
