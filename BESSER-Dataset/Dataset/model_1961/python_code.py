...
class addressbook_Relationship:
    ...
    def __init__(self, Type: str, relates: "addressbook_Contact" = None, Relationship: "addressbook_Contact" = None, Relationship6: "addressbook_Contact" = None, isRelated: "addressbook_Contact" = None):
        self.Type = Type
...
class addressbook_Contact(ABC):
    ...
    def __init__(self, Name: str, Phone: str, Website: str, EMail: str, Contact13: "addressbook_Relationship" = None, addressbook_Contact: set["addressbook_Address"] = None, addressbook_Contact3: "addressbook_Contact" = None, addressbook_Contact1: set["addressbook_Contact"] = None, source: set["addressbook_Relationship"] = None, target: set["addressbook_Relationship"] = None, addressbook_Contact8: set["addressbook_Note"] = None, addressbook_Contact10: "addressbook_AddressBook" = None, Contact: "addressbook_Relationship" = None):
        self.Name = Name
        self.Phone = Phone
