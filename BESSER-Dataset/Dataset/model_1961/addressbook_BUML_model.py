...
addressbook_Address = Class(name="addressbook_Address")
addressbook_Relationship = Class(name="addressbook_Relationship")
addressbook_Note = Class(name="addressbook_Note")
addressbook_Person = Class(name="addressbook_Person")
Contact = Class(name="Contact")
addressbook_Company = Class(name="addressbook_Company")
...
addressbook_Contact.attributes={addressbook_Contact_Phone, addressbook_Contact_Name, addressbook_Contact_EMail, addressbook_Contact_Website}
...
addressbook_Note.attributes={addressbook_Note_Comment, addressbook_Note_Type, addressbook_Note_Time, addressbook_Note_Author}
...
domain_model = DomainModel(
    ...
    associations={source12, address0, inRelation2, relates4, isRelated5, Note7, Contact9, target11},
