...
class activitydiagram_Variable(ABC):
    ...
    def __init__(self, name: str, activitydiagram_Variable: "activitydiagram_Activity" = None, activitydiagram_Variable6: "activitydiagram_Activity" = None, activitydiagram_Variable18: "activitydiagram_Value" = None):
        self.name = name
...
class activitydiagram_ActivityNode(NamedElement):
    ...
    def __init__(self, running: bool, ActivityNode12: "activitydiagram_ActivityEdge" = None, ActivityNode14: "activitydiagram_ActivityEdge" = None, ActivityNode: "activitydiagram_Activity" = None, source: set["activitydiagram_ActivityEdge"] = None, target: set["activitydiagram_ActivityEdge"] = None, nodes: "activitydiagram_Activity" = None):
