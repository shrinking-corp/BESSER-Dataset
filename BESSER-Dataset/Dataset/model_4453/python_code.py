...
class rover_Length(SingleQuantity):
    ...
    def __init__(self, lengthUnit: str, rover_Length32: "rover_Move" = None, rover_Length: "rover_Distance" = None, rover_Length66: "rover_Position" = None, rover_Length69: "rover_Position" = None, rover_Length53: "rover_DistanceSensorTrigger" = None):
...
class rover_Program:
    ...
    def __init__(self, name: str, rover_Program6: "rover_Rover" = None, rover_Program9: "rover_Block" = None, rover_Program11: set["rover_Quantity"] = None, rover_Program: "rover_System" = None):
        self.name = name
...
class rover_Rover:
    ...
    def __init__(self, name: str, rover_Rover4: set["rover_Component"] = None, rover_Rover7: "rover_Program" = None, rover_Rover: "rover_System" = None):
        self.name = name
