...
# Classes
rover_System = Class(name="rover_System")
rover_Component = Class(name="rover_Component", is_abstract=True)
rover_Block = Class(name="rover_Block")
rover_Quantity = Class(name="rover_Quantity", is_abstract=True)
rover_Actuator = Class(name="rover_Actuator", is_abstract=True)
Component = Class(name="Component")
rover_Sensor = Class(name="rover_Sensor", is_abstract=True)
rover_Motor = Class(name="rover_Motor")
Actuator = Class(name="Actuator")
rover_Light = Class(name="rover_Light")
rover_GPS = Class(name="rover_GPS")
Sensor = Class(name="Sensor")
rover_Position = Class(name="rover_Position")
rover_Compass = Class(name="rover_Compass")
rover_Rover = Class(name="rover_Rover")
rover_Angle = Class(name="rover_Angle")
rover_Program = Class(name="rover_Program")
rover_Command = Class(name="rover_Command", is_abstract=True)
rover_Transition = Class(name="rover_Transition", is_abstract=True)
rover_Repeat = Class(name="rover_Repeat")
rover_SetLightColor = Class(name="rover_SetLightColor")
Command = Class(name="Command")
rover_Wait = Class(name="rover_Wait")
rover_Time = Class(name="rover_Time")
rover_Distance = Class(name="rover_Distance")
rover_Length = Class(name="rover_Length")
rover_Velocity = Class(name="rover_Velocity")
rover_Rotate = Class(name="rover_Rotate")
rover_Terminate = Class(name="rover_Terminate")
rover_Move = Class(name="rover_Move")
rover_CompassTrigger = Class(name="rover_CompassTrigger")
rover_GPSTrigger = Class(name="rover_GPSTrigger")
rover_SingleQuantity = Class(name="rover_SingleQuantity", is_abstract=True)
Quantity = Class(name="Quantity")
SingleQuantity = Class(name="SingleQuantity")
rover_TriggeredTransition = Class(name="rover_TriggeredTransition", is_abstract=True)
Transition = Class(name="Transition")
rover_DistanceSensorTrigger = Class(name="rover_DistanceSensorTrigger")
TriggeredTransition = Class(name="TriggeredTransition")
rover_NormalTransition = Class(name="rover_NormalTransition")
...
domain_model = DomainModel(
    name="rover",
    types={rover_System, rover_Component, rover_Block, rover_Quantity, rover_Actuator, Component, rover_Sensor, rover_Motor, Actuator, rover_Light, rover_GPS, Sensor, rover_Position, rover_Compass, rover_Rover, rover_Angle, rover_Program, rover_Command, rover_Transition, rover_Repeat, rover_SetLightColor, Command, rover_Wait, rover_Time, rover_Distance, rover_Length, rover_Velocity, rover_Rotate, rover_Terminate, rover_Move, rover_CompassTrigger, rover_GPSTrigger, rover_SingleQuantity, Quantity, SingleQuantity, rover_TriggeredTransition, Transition, rover_DistanceSensorTrigger, TriggeredTransition, rover_NormalTransition, ColorKind, Operator, TimeUnit, AngleUnit, LengthUnit, VelocityUnit},
    associations={component3, rover5, block8, quantity10, position12, angle13, rover0, program1, command15, transition17, repeat19, outgoingTransition21, incomingTransition22, source24, target25, light27, time28, length30, length14, velocity33, angle35, setlightcolor37, wait40, move43, motor29, compass54, angle56, gps59, position61, X64, Y67, rotate46, distance49, length51},
    generalizations={gen_rover_Actuator_Component, gen_rover_Sensor_Component, gen_rover_Motor_Actuator, gen_rover_Light_Actuator, gen_rover_GPS_Sensor, gen_rover_Compass_Sensor, gen_rover_SetLightColor_Command, gen_rover_Wait_Command, gen_rover_Distance_Sensor, gen_rover_Rotate_Command, gen_rover_Terminate_Command, gen_rover_Repeat_Command, gen_rover_Move_Command, gen_rover_CompassTrigger_TriggeredTransition, gen_rover_GPSTrigger_TriggeredTransition, gen_rover_SingleQuantity_Quantity, gen_rover_Position_Quantity, gen_rover_Time_SingleQuantity, gen_rover_TriggeredTransition_Transition, gen_rover_DistanceSensorTrigger_TriggeredTransition, gen_rover_Angle_SingleQuantity, gen_rover_Length_SingleQuantity, gen_rover_NormalTransition_Transition, gen_rover_Velocity_SingleQuantity},
    metadata=None
)
