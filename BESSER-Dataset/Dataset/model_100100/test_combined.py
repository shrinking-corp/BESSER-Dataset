...
def test_hyp_makingof_conference_person_is_not_abstract():
    assert not inspect.isabstract(makingOf_conference_Person)


def test_hyp_makingof_conference_person_constructor_exists():
    assert callable(makingOf_conference_Person.__init__)


def test_hyp_makingof_conference_person_constructor_args():
    sig = inspect.signature(makingOf_conference_Person.__init__)
    params = list(sig.parameters.keys())



def test_hyp_conference_makingof_participant_is_not_abstract():
    assert not inspect.isabstract(conference_makingOf_Participant)


def test_hyp_conference_makingof_participant_constructor_exists():
    assert callable(conference_makingOf_Participant.__init__)


def test_hyp_conference_makingof_participant_constructor_args():
...
def test_hyp_conference_makingof_task_is_not_abstract():
    assert not inspect.isabstract(conference_makingOf_Task)


def test_hyp_conference_makingof_task_constructor_exists():
    assert callable(conference_makingOf_Task.__init__)


def test_hyp_conference_makingof_task_constructor_args():
...
def test_hyp_day_is_not_abstract():
    assert not inspect.isabstract(Day)


def test_hyp_day_constructor_exists():
    assert callable(Day.__init__)


def test_hyp_day_constructor_args():
    sig = inspect.signature(Day.__init__)
    params = list(sig.parameters.keys())



def test_hyp_conference_makingof_story_is_not_abstract():
    assert not inspect.isabstract(conference_makingOf_Story)


def test_hyp_conference_makingof_story_constructor_exists():
    assert callable(conference_makingOf_Story.__init__)


def test_hyp_conference_makingof_story_constructor_args():
...
def test_hyp_conference_subject_is_not_abstract():
    assert not inspect.isabstract(conference_Subject)


def test_hyp_conference_subject_constructor_exists():
    assert callable(conference_Subject.__init__)


def test_hyp_conference_subject_constructor_args():
...
def test_hyp_conference_makingof_day_is_not_abstract():
    assert not inspect.isabstract(conference_makingOf_Day)


def test_hyp_conference_makingof_day_constructor_exists():
    assert callable(conference_makingOf_Day.__init__)


def test_hyp_conference_makingof_day_constructor_args():
...
def test_hyp_story_is_not_abstract():
    assert not inspect.isabstract(Story)


def test_hyp_story_constructor_exists():
    assert callable(Story.__init__)


def test_hyp_story_constructor_args():
...
def test_hyp_conference_location_is_not_abstract():
    assert not inspect.isabstract(conference_Location)


def test_hyp_conference_location_constructor_exists():
    assert callable(conference_Location.__init__)


def test_hyp_conference_location_constructor_args():
...
def test_hyp_conference_day_is_not_abstract():
    assert not inspect.isabstract(conference_Day)


def test_hyp_conference_day_constructor_exists():
    assert callable(conference_Day.__init__)


def test_hyp_conference_day_constructor_args():
...
def test_hyp_conference_track_is_not_abstract():
    assert not inspect.isabstract(conference_Track)


def test_hyp_conference_track_constructor_exists():
    assert callable(conference_Track.__init__)


def test_hyp_conference_track_constructor_args():
...
def test_hyp_attitude_exists():
    # Check that the Enumeration exists
    assert Attitude is not None

def test_hyp_attitude_has_all_literals():
...
def test_hyp_conference_makingof_participant_age_setter(instance):
...
@given(instance=conference_makingOf_Participant_strategy)
def test_hyp_conference_makingof_participant_attitude_setter(instance):
...
def test_hyp_conference_makingof_task_name_setter(instance):
...
def test_hyp_conference_makingof_story_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_conference_subject_description_setter(instance):
...
@given(instance=conference_Subject_strategy)
def test_hyp_conference_subject_isDone_setter(instance):
...
def test_hyp_conference_makingof_day_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_conference_talk_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=conference_Talk_strategy)
def test_hyp_conference_talk_time_setter(instance):
...
@given(instance=conference_Talk_strategy)
def test_hyp_conference_talk_duration_setter(instance):
...
@given(instance=conference_Talk_strategy)
def test_hyp_conference_talk_abstract_setter(instance):
...
def test_hyp_conference_location_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_conference_day_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_conference_person_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=conference_Person_strategy)
def test_hyp_conference_person_organisation_setter(instance):
...
def test_hyp_conference_track_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
