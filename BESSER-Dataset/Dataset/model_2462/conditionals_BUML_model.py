...
operators_Type = Class(name="operators_Type")
operators_OperationCallExp = Class(name="operators_OperationCallExp")
OclExpression = Class(name="OclExpression")
operators_IfExp = Class(name="operators_IfExp")
operators_OclType = Class(name="operators_OclType")

# operators_OclExpression class attributes and methods

# operators_Type class attributes and methods
operators_Type_m_isSameType: Method = Method(name="isSameType", parameters={Parameter(name='operators_t', type=StringType)}, type=BooleanType)
operators_Type_m_isSuperTypeOf: Method = Method(name="isSuperTypeOf", parameters={Parameter(name='operators_t', type=StringType)}, type=BooleanType)
...
domain_model = DomainModel(
    name="operators",
    types={operators_OclExpression, operators_Type, operators_OperationCallExp, OclExpression, operators_IfExp, operators_OclType},
