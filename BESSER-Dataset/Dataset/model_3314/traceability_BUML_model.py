...
traceability_CPS2DeploymentTrace = Class(name="traceability_CPS2DeploymentTrace")
...
domain_model = DomainModel(
    name="traceability",
    types={traceability_CPSToDeployment, traceability_CyberPhysicalSystem, traceability_Deployment, traceability_CPS2DeploymentTrace, traceability_Identifiable, traceability_DeploymentElement},
