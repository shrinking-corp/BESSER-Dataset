...
class java_Model:
    ...
    def __init__(self, name: str, java_Model247: set["java_Archive"] = None, Model: "java_Package" = None, model: set["java_Package"] = None, java_Model: set["java_Type"] = None, java_Model239: set["java_UnresolvedItem"] = None, java_Model241: set["java_CompilationUnit"] = None, java_Model244: set["java_ClassFile"] = None):
        self.name = name
...
class java_ClassFile(NamedElement):
    ...
    def __init__(self, originalFilePath: str, java_ClassFile110: "java_Package" = None, java_ClassFile104: "java_AbstractTypeDeclaration" = None, java_ClassFile46: "java_ASTNode" = None, java_ClassFile: "java_Archive" = None, java_ClassFile107: "java_CompilationUnit" = None, java_ClassFile245: "java_Model" = None):
...
class java_CompilationUnit(NamedElement):
    ...
    def __init__(self, originalFilePath: str, java_CompilationUnit: "java_ASTNode" = None, java_CompilationUnit108: "java_ClassFile" = None, java_CompilationUnit137: set["java_AbstractTypeDeclaration"] = None, java_CompilationUnit129: set["java_Comment"] = None, java_CompilationUnit132: set["java_ImportDeclaration"] = None, java_CompilationUnit134: "java_Package" = None, java_CompilationUnit242: "java_Model" = None):
        self.originalFilePath = originalFilePath
...
class java_VariableDeclaration(NamedElement):
    ...
    def __init__(self, extraArrayDimensions: int, variable: set["java_SingleVariableAccess"] = None, java_VariableDeclaration: "java_Expression" = None, VariableDeclaration: "java_SingleVariableAccess" = None):
        self.extraArrayDimensions = extraArrayDimensions
