...
# Classes
e2_Course = Class(name="e2_Course")
e2_Lecture = Class(name="e2_Lecture")
e2_LectureContent = Class(name="e2_LectureContent")
e2_SubGoal = Class(name="e2_SubGoal")
e2_Person = Class(name="e2_Person")
e2_AssignmentSubmission = Class(name="e2_AssignmentSubmission")
e2_Assingnment = Class(name="e2_Assingnment")
e2_Group = Class(name="e2_Group")
e2_Goal = Class(name="e2_Goal")
e2_University = Class(name="e2_University")
e2_EClass0 = Class(name="e2_EClass0")
...
e2_SubGoal.attributes={e2_SubGoal_GoalText, e2_SubGoal_GoalID}
...
e2_Assingnment.attributes={e2_Assingnment_isMandatory, e2_Assingnment_Content, e2_Assingnment_Type, e2_Assingnment_Title, e2_Assingnment_StartDate, e2_Assingnment_Deadline}
...
domain_model = DomainModel(
    ...
    associations={LearningGoals4, Students6, Lecturerer8, Content0, LearningGoals1, Submitted3, Persons36, Courses38, LectureAssignment41, SubGoals44, Assingments11, Lectures14, StudentGroups17, TeachingAssistant19, LearningGoals22, GroupMember24, Submitted27, Assignment30, AssesedBy33},
    generalizations={},
    metadata=None
)
