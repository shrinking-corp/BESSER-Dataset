...
class e2_Goal:
    ...
    def __init__(self, GoalID: str, GoalText: str, e2_Goal45: set["e2_SubGoal"] = None, e2_Goal: "e2_Course" = None):
        self.GoalID = GoalID
...
class e2_Assingnment:
    ...
    def __init__(self, StartDate: date, Title: str, Content: str, Type: str, isMandatory: bool, Deadline: date, e2_Assingnment: set["e2_SubGoal"] = None, e2_Assingnment43: "e2_LectureContent" = None, e2_Assingnment13: "e2_Course" = None, e2_Assingnment32: "e2_AssignmentSubmission" = None):
...
class e2_AssignmentSubmission:
    ...
    def __init__(self, Comments: str, assessment: int, e2_AssignmentSubmission: "e2_Person" = None, e2_AssignmentSubmission29: "e2_Group" = None, e2_AssignmentSubmission31: "e2_Assingnment" = None, e2_AssignmentSubmission34: "e2_Person" = None):
...
class e2_Person:
    ...
    def __init__(self, Name: str, e2_Person7: "e2_Course" = None, e2_Person10: "e2_Course" = None, e2_Person: set["e2_AssignmentSubmission"] = None, e2_Person37: "e2_University" = None, e2_Person21: "e2_Course" = None, e2_Person26: "e2_Group" = None, e2_Person35: "e2_AssignmentSubmission" = None):
        self.Name = Name
...
class e2_Course:
    ...
    def __init__(self, ID: str, Name: str, credit: float, e2_Course: set["e2_Person"] = None, e2_Course9: set["e2_Person"] = None, e2_Course40: "e2_University" = None, e2_Course12: set["e2_Assingnment"] = None, e2_Course15: set["e2_Lecture"] = None, e2_Course18: set["e2_Group"] = None, e2_Course20: set["e2_Person"] = None, e2_Course23: set["e2_Goal"] = None):
        self.ID = ID
        self.Name = Name
        self.credit = credit
