...
def test_hyp_e2_eclass0_is_not_abstract():
    assert not inspect.isabstract(e2_EClass0)


def test_hyp_e2_eclass0_constructor_exists():
    assert callable(e2_EClass0.__init__)


def test_hyp_e2_eclass0_constructor_args():
...
def test_hyp_e2_goal_is_not_abstract():
    assert not inspect.isabstract(e2_Goal)


def test_hyp_e2_goal_constructor_exists():
    assert callable(e2_Goal.__init__)


def test_hyp_e2_goal_constructor_args():
...
def test_hyp_e2_subgoal_is_not_abstract():
    assert not inspect.isabstract(e2_SubGoal)


def test_hyp_e2_subgoal_constructor_exists():
    assert callable(e2_SubGoal.__init__)


def test_hyp_e2_subgoal_constructor_args():
...
def test_hyp_e2_goal_GoalText_setter(instance):
...
@given(instance=e2_Goal_strategy)
def test_hyp_e2_goal_GoalID_setter(instance):
...
def test_hyp_e2_subgoal_GoalText_setter(instance):
    original = instance.GoalText
    instance.GoalText = original
    assert instance.GoalText == original
...
@given(instance=e2_SubGoal_strategy)
def test_hyp_e2_subgoal_GoalID_setter(instance):
    original = instance.GoalID
    instance.GoalID = original
    assert instance.GoalID == original
