...
# Classes
vhdl_Architecture = Class(name="vhdl_Architecture")
Module = Class(name="Module")
Named = Class(name="Named")
vhdl_EntityReference = Class(name="vhdl_EntityReference", is_abstract=True)
Statement = Class(name="Statement")
vhdl_DesignUnit = Class(name="vhdl_DesignUnit")
VhdlObject = Class(name="VhdlObject")
vhdl_Name = Class(name="vhdl_Name", is_abstract=True)
vhdl_Module = Class(name="vhdl_Module", is_abstract=True)
Declaration = Class(name="Declaration")
vhdl_Entity = Class(name="vhdl_Entity")
vhdl_GenericMaps = Class(name="vhdl_GenericMaps")
Expression = Class(name="Expression")
vhdl_Model = Class(name="vhdl_Model")
vhdl_Package = Class(name="vhdl_Package")
vhdl_PackageBody = Class(name="vhdl_PackageBody")
vhdl_PackageReference = Class(name="vhdl_PackageReference", is_abstract=True)
vhdl_PortMaps = Class(name="vhdl_PortMaps")
vhdl_Signature = Class(name="vhdl_Signature")
TypeReference = Class(name="TypeReference")
vhdl_Component = Class(name="vhdl_Component")
declaration_Declaration = Class(name="declaration_Declaration")
vhdl_Generics = Class(name="vhdl_Generics")
vhdl_Ports = Class(name="vhdl_Ports")
MultiName = Class(name="MultiName")
type_TypeReference = Class(name="type_TypeReference")
nature_NatureReference = Class(name="nature_NatureReference")
...
configuration_ConfigurationReference = Class(name="configuration_ConfigurationReference")
CallReference = Class(name="CallReference")
vhdl_NameList = Class(name="vhdl_NameList")
vhdl_EntityResolvedReference = Class(name="vhdl_EntityResolvedReference")
vhdl_Named = Class(name="vhdl_Named", is_abstract=True)
vhdl_MultiNamed = Class(name="vhdl_MultiNamed")
vhdl_MultiName = Class(name="vhdl_MultiName", is_abstract=True)
vhdl_VhdlObject = Class(name="vhdl_VhdlObject", is_abstract=True)
vhdl_CallReference = Class(name="vhdl_CallReference", is_abstract=True)
vhdl_CallResolvedReference = Class(name="vhdl_CallResolvedReference")
SubprogramDeclaration = Class(name="SubprogramDeclaration")
vhdl_statement_ReportStatement = Class(name="vhdl_statement_ReportStatement")
vhdl_statement_ReturnStatement = Class(name="vhdl_statement_ReturnStatement")
ExpressionStatement = Class(name="ExpressionStatement")
vhdl_statement_ConditionalSignalAssignmentStatement = Class(name="vhdl_statement_ConditionalSignalAssignmentStatement")
SignalAssignmentStatement = Class(name="SignalAssignmentStatement")
vhdl_statement_SelectedSignalAssignmentStatement = Class(name="vhdl_statement_SelectedSignalAssignmentStatement")
ConditionalSignalAssignmentStatement = Class(name="ConditionalSignalAssignmentStatement")
vhdl_statement_SequentialSignalAssignmentStatement = Class(name="vhdl_statement_SequentialSignalAssignmentStatement")
vhdl_statement_SignalAssignmentStatement = Class(name="vhdl_statement_SignalAssignmentStatement", is_abstract=True)
DelayMechanism = Class(name="DelayMechanism")
vhdl_statement_WaitStatement = Class(name="vhdl_statement_WaitStatement")
statement_vhdl_MultiName = Class(name="statement_vhdl_MultiName")
vhdl_statement_VariableAssignmentStatement = Class(name="vhdl_statement_VariableAssignmentStatement")
vhdl_PackageResolvedReference = Class(name="vhdl_PackageResolvedReference")
vhdl_ComponentReference = Class(name="vhdl_ComponentReference", is_abstract=True)
vhdl_ComponentResolvedReference = Class(name="vhdl_ComponentResolvedReference")
vhdl_statement_SimultaneousIfStatement = Class(name="vhdl_statement_SimultaneousIfStatement")
IfStatement = Class(name="IfStatement")
vhdl_statement_IfStatement = Class(name="vhdl_statement_IfStatement")
IfStatementTest = Class(name="IfStatementTest")
vhdl_statement_IfStatementTest = Class(name="vhdl_statement_IfStatementTest")
vhdl_statement_ProcedureCallStatement = Class(name="vhdl_statement_ProcedureCallStatement")
statement_vhdl_CallReference = Class(name="statement_vhdl_CallReference")
vhdl_statement_SimultaneousProceduralStatement = Class(name="vhdl_statement_SimultaneousProceduralStatement")
vhdl_statement_ProcessStatement = Class(name="vhdl_statement_ProcessStatement")
vhdl_statement_AssertionStatement = Class(name="vhdl_statement_AssertionStatement")
vhdl_statement_SimultaneousCaseStatement = Class(name="vhdl_statement_SimultaneousCaseStatement")
CaseStatement = Class(name="CaseStatement")
vhdl_statement_CaseStatement = Class(name="vhdl_statement_CaseStatement")
CaseAlternative = Class(name="CaseAlternative")
vhdl_statement_CaseAlternative = Class(name="vhdl_statement_CaseAlternative")
statement_vhdl_Generics = Class(name="statement_vhdl_Generics")
statement_vhdl_GenericMaps = Class(name="statement_vhdl_GenericMaps")
statement_vhdl_Ports = Class(name="statement_vhdl_Ports")
statement_vhdl_PortMaps = Class(name="statement_vhdl_PortMaps")
vhdl_statement_BreakStatement = Class(name="vhdl_statement_BreakStatement")
BreakStatementItem = Class(name="BreakStatementItem")
vhdl_statement_BreakStatementItem = Class(name="vhdl_statement_BreakStatementItem")
statement_vhdl_Name = Class(name="statement_vhdl_Name")
vhdl_statement_ComponentInstantiationStatement = Class(name="vhdl_statement_ComponentInstantiationStatement")
InstantiationStatement = Class(name="InstantiationStatement")
statement_vhdl_ComponentReference = Class(name="statement_vhdl_ComponentReference")
vhdl_statement_InstantiationStatement = Class(name="vhdl_statement_InstantiationStatement")
vhdl_statement_BlockStatement = Class(name="vhdl_statement_BlockStatement")
vhdl_statement_ExitStatement = Class(name="vhdl_statement_ExitStatement")
vhdl_statement_GenerateStatement = Class(name="vhdl_statement_GenerateStatement")
GenerationScheme = Class(name="GenerationScheme")
vhdl_statement_LoopStatement = Class(name="vhdl_statement_LoopStatement")
IterationScheme = Class(name="IterationScheme")
vhdl_statement_NextStatement = Class(name="vhdl_statement_NextStatement")
vhdl_statement_Statement = Class(name="vhdl_statement_Statement", is_abstract=True)
vhdl_statement_IterationScheme = Class(name="vhdl_statement_IterationScheme")
vhdl_statement_WhileIterationScheme = Class(name="vhdl_statement_WhileIterationScheme")
vhdl_statement_EntityInstantiationStatement = Class(name="vhdl_statement_EntityInstantiationStatement")
statement_vhdl_EntityReference = Class(name="statement_vhdl_EntityReference")
vhdl_statement_ConfigurationInstantiationStatement = Class(name="vhdl_statement_ConfigurationInstantiationStatement")
ConfigurationReference = Class(name="ConfigurationReference")
vhdl_statement_SimpleSimultaneousStatement = Class(name="vhdl_statement_SimpleSimultaneousStatement")
vhdl_statement_ForIterationScheme = Class(name="vhdl_statement_ForIterationScheme")
vhdl_statement_GenerationScheme = Class(name="vhdl_statement_GenerationScheme", is_abstract=True)
vhdl_statement_IfGenerationScheme = Class(name="vhdl_statement_IfGenerationScheme")
vhdl_statement_RejectMechanism = Class(name="vhdl_statement_RejectMechanism")
vhdl_statement_TransportMechanism = Class(name="vhdl_statement_TransportMechanism")
vhdl_expression_AddingExpression = Class(name="vhdl_expression_AddingExpression")
BinaryExpression = Class(name="BinaryExpression")
vhdl_expression_AggregateExpression = Class(name="vhdl_expression_AggregateExpression")
expression_MultiExpression = Class(name="expression_MultiExpression")
Name = Class(name="Name")
vhdl_expression_AllExpression = Class(name="vhdl_expression_AllExpression")
expression_Expression = Class(name="expression_Expression")
vhdl_expression_AllocatorExpression = Class(name="vhdl_expression_AllocatorExpression")
type_Typed = Class(name="type_Typed")
vhdl_expression_AssociationExpression = Class(name="vhdl_expression_AssociationExpression")
vhdl_expression_AttributeExpression = Class(name="vhdl_expression_AttributeExpression")
expression_ValueExpression = Class(name="expression_ValueExpression")
expression_vhdl_Signature = Class(name="expression_vhdl_Signature")
vhdl_statement_DelayMechanism = Class(name="vhdl_statement_DelayMechanism", is_abstract=True)
vhdl_statement_ExpressionStatement = Class(name="vhdl_statement_ExpressionStatement")
vhdl_statement_ForGenerationScheme = Class(name="vhdl_statement_ForGenerationScheme")
vhdl_expression_BitStringExpression = Class(name="vhdl_expression_BitStringExpression")
ValueExpression = Class(name="ValueExpression")
vhdl_expression_Expression = Class(name="vhdl_expression_Expression", is_abstract=True)
vhdl_expression_IndicationExpression = Class(name="vhdl_expression_IndicationExpression", is_abstract=True)
vhdl_expression_SubtypeIndicationExpression = Class(name="vhdl_expression_SubtypeIndicationExpression")
expression_IndicationExpression = Class(name="expression_IndicationExpression")
vhdl_expression_SubnatureIndicationExpression = Class(name="vhdl_expression_SubnatureIndicationExpression")
NatureReference = Class(name="NatureReference")
vhdl_expression_LogicalExpression = Class(name="vhdl_expression_LogicalExpression")
vhdl_expression_NameExpression = Class(name="vhdl_expression_NameExpression")
expression_vhdl_Name = Class(name="expression_vhdl_Name")
vhdl_expression_BinaryExpression = Class(name="vhdl_expression_BinaryExpression", is_abstract=True)
vhdl_expression_ShiftExpression = Class(name="vhdl_expression_ShiftExpression")
vhdl_expression_SignatureExpression = Class(name="vhdl_expression_SignatureExpression")
vhdl_expression_SignExpression = Class(name="vhdl_expression_SignExpression")
vhdl_expression_UnaryExpression = Class(name="vhdl_expression_UnaryExpression")
vhdl_expression_OpenExpression = Class(name="vhdl_expression_OpenExpression")
vhdl_expression_OthersExpression = Class(name="vhdl_expression_OthersExpression")
vhdl_expression_RangeExpression = Class(name="vhdl_expression_RangeExpression")
expression_BinaryExpression = Class(name="expression_BinaryExpression")
vhdl_expression_StringExpression = Class(name="vhdl_expression_StringExpression")
vhdl_expression_CharacterExpression = Class(name="vhdl_expression_CharacterExpression")
type_EnumerationLiteral = Class(name="type_EnumerationLiteral")
vhdl_expression_IdentifierExpression = Class(name="vhdl_expression_IdentifierExpression")
vhdl_expression_UnitValueExpression = Class(name="vhdl_expression_UnitValueExpression")
vhdl_expression_UnaffectedExpression = Class(name="vhdl_expression_UnaffectedExpression")
vhdl_expression_ValueExpression = Class(name="vhdl_expression_ValueExpression")
vhdl_expression_NullExpression = Class(name="vhdl_expression_NullExpression")
vhdl_expression_WaveformExpression = Class(name="vhdl_expression_WaveformExpression")
vhdl_expression_MultiplyingExpression = Class(name="vhdl_expression_MultiplyingExpression")
vhdl_expression_PowerExpression = Class(name="vhdl_expression_PowerExpression")
vhdl_expression_RelationalExpression = Class(name="vhdl_expression_RelationalExpression")
vhdl_expression_MultiExpression = Class(name="vhdl_expression_MultiExpression")
vhdl_expression_ConditionalWaveformExpression = Class(name="vhdl_expression_ConditionalWaveformExpression")
AssociationExpression = Class(name="AssociationExpression")
vhdl_expression_TypeQualificationExpression = Class(name="vhdl_expression_TypeQualificationExpression")
declaration_vhdl_Name = Class(name="declaration_vhdl_Name")
vhdl_declaration_AttributeDeclaration = Class(name="vhdl_declaration_AttributeDeclaration")
vhdl_declaration_AttributeSpecification = Class(name="vhdl_declaration_AttributeSpecification")
declaration_vhdl_MultiName = Class(name="declaration_vhdl_MultiName")
vhdl_declaration_BranchQuantityDeclaration = Class(name="vhdl_declaration_BranchQuantityDeclaration")
QuantityDeclaration = Class(name="QuantityDeclaration")
QuantityAspect = Class(name="QuantityAspect")
vhdl_declaration_FreeQuantityDeclaration = Class(name="vhdl_declaration_FreeQuantityDeclaration")
declaration_QuantityDeclaration = Class(name="declaration_QuantityDeclaration")
MultiNamed = Class(name="MultiNamed")
vhdl_declaration_LimitDeclaration = Class(name="vhdl_declaration_LimitDeclaration")
vhdl_declaration_QuantityDeclaration = Class(name="vhdl_declaration_QuantityDeclaration", is_abstract=True)
vhdl_declaration_SourceQuantityDeclaration = Class(name="vhdl_declaration_SourceQuantityDeclaration")
SourceAspect = Class(name="SourceAspect")
vhdl_declaration_SubnatureDeclaration = Class(name="vhdl_declaration_SubnatureDeclaration")
nature_Natured = Class(name="nature_Natured")
vhdl_declaration_SubprogramDeclaration = Class(name="vhdl_declaration_SubprogramDeclaration", is_abstract=True)
vhdl_declaration_AliasDeclaration = Class(name="vhdl_declaration_AliasDeclaration")
vhdl_declaration_FunctionDeclaration = Class(name="vhdl_declaration_FunctionDeclaration")
declaration_SubprogramDeclaration = Class(name="declaration_SubprogramDeclaration")
vhdl_declaration_SubprogramBody = Class(name="vhdl_declaration_SubprogramBody")
vhdl_declaration_SubtypeDeclaration = Class(name="vhdl_declaration_SubtypeDeclaration")
vhdl_declaration_ConfigurationSpecification = Class(name="vhdl_declaration_ConfigurationSpecification")
declaration_vhdl_ComponentReference = Class(name="declaration_vhdl_ComponentReference")
declaration_vhdl_EntityReference = Class(name="declaration_vhdl_EntityReference")
declaration_vhdl_GenericMaps = Class(name="declaration_vhdl_GenericMaps")
declaration_vhdl_PortMaps = Class(name="declaration_vhdl_PortMaps")
vhdl_declaration_Declaration = Class(name="vhdl_declaration_Declaration", is_abstract=True)
vhdl_declaration_DisconnectionSpecification = Class(name="vhdl_declaration_DisconnectionSpecification")
vhdl_declaration_FileDeclaration = Class(name="vhdl_declaration_FileDeclaration")
SubprogramBody = Class(name="SubprogramBody")
vhdl_declaration_ProcedureDeclaration = Class(name="vhdl_declaration_ProcedureDeclaration")
vhdl_declaration_ConstantDeclaration = Class(name="vhdl_declaration_ConstantDeclaration")
ValueDeclaration = Class(name="ValueDeclaration")
vhdl_declaration_GroupDeclaration = Class(name="vhdl_declaration_GroupDeclaration")
vhdl_declaration_GroupTemplateDeclaration = Class(name="vhdl_declaration_GroupTemplateDeclaration")
vhdl_declaration_NatureDeclaration = Class(name="vhdl_declaration_NatureDeclaration")
NatureDefinition = Class(name="NatureDefinition")
vhdl_declaration_SignalDeclaration = Class(name="vhdl_declaration_SignalDeclaration")
vhdl_declaration_UseClauseDeclaration = Class(name="vhdl_declaration_UseClauseDeclaration")
vhdl_declaration_VariableDeclaration = Class(name="vhdl_declaration_VariableDeclaration")
vhdl_declaration_ValueDeclaration = Class(name="vhdl_declaration_ValueDeclaration", is_abstract=True)
vhdl_declaration_TerminalDeclaration = Class(name="vhdl_declaration_TerminalDeclaration")
vhdl_declaration_TypeDeclaration = Class(name="vhdl_declaration_TypeDeclaration")
TypeDefinition = Class(name="TypeDefinition")
vhdl_type_AccessTypeDefinition = Class(name="vhdl_type_AccessTypeDefinition")
type_TypeDefinition = Class(name="type_TypeDefinition")
vhdl_type_CompositeTypeDefinition = Class(name="vhdl_type_CompositeTypeDefinition", is_abstract=True)
vhdl_type_RecordTypeDefinition = Class(name="vhdl_type_RecordTypeDefinition")
CompositeTypeDefinition = Class(name="CompositeTypeDefinition")
RecordTypeElement = Class(name="RecordTypeElement")
vhdl_type_ArrayTypeDefinition = Class(name="vhdl_type_ArrayTypeDefinition")
type_CompositeTypeDefinition = Class(name="type_CompositeTypeDefinition")
vhdl_type_ConstrainedArrayTypeDefinition = Class(name="vhdl_type_ConstrainedArrayTypeDefinition")
ArrayTypeDefinition = Class(name="ArrayTypeDefinition")
vhdl_type_UnconstrainedArrayTypeDefinition = Class(name="vhdl_type_UnconstrainedArrayTypeDefinition")
vhdl_type_EnumerationLiteral = Class(name="vhdl_type_EnumerationLiteral", is_abstract=True)
vhdl_type_EnumerationTypeDefinition = Class(name="vhdl_type_EnumerationTypeDefinition")
EnumerationLiteral = Class(name="EnumerationLiteral")
vhdl_type_FileTypeDefinition = Class(name="vhdl_type_FileTypeDefinition")
vhdl_type_PhysicalTypeDefinition = Class(name="vhdl_type_PhysicalTypeDefinition")
PhysicalTypeDefinitionSecondary = Class(name="PhysicalTypeDefinitionSecondary")
vhdl_type_PhysicalTypeDefinitionSecondary = Class(name="vhdl_type_PhysicalTypeDefinitionSecondary")
type_vhdl_Name = Class(name="type_vhdl_Name")
vhdl_type_RangeTypeDefinition = Class(name="vhdl_type_RangeTypeDefinition")
vhdl_type_RecordTypeElement = Class(name="vhdl_type_RecordTypeElement")
vhdl_nature_ConstrainedArrayNatureDefinition = Class(name="vhdl_nature_ConstrainedArrayNatureDefinition")
ArrayNatureDefinition = Class(name="ArrayNatureDefinition")
vhdl_nature_NatureDefinition = Class(name="vhdl_nature_NatureDefinition")
vhdl_nature_RecordNatureDefinition = Class(name="vhdl_nature_RecordNatureDefinition")
CompositeNatureDefinition = Class(name="CompositeNatureDefinition")
RecordNatureElement = Class(name="RecordNatureElement")
vhdl_nature_RecordNatureElement = Class(name="vhdl_nature_RecordNatureElement")
vhdl_nature_ScalarNatureDefinition = Class(name="vhdl_nature_ScalarNatureDefinition")
nature_vhdl_Name = Class(name="nature_vhdl_Name")
vhdl_nature_UnconstrainedArrayNatureDefinition = Class(name="vhdl_nature_UnconstrainedArrayNatureDefinition")
vhdl_nature_NatureReference = Class(name="vhdl_nature_NatureReference", is_abstract=True)
vhdl_nature_Natured = Class(name="vhdl_nature_Natured", is_abstract=True)
vhdl_ams_QuantityAspect = Class(name="vhdl_ams_QuantityAspect")
vhdl_type_Typed = Class(name="vhdl_type_Typed", is_abstract=True)
vhdl_type_TypeDefinition = Class(name="vhdl_type_TypeDefinition", is_abstract=True)
vhdl_ams_SourceAspect = Class(name="vhdl_ams_SourceAspect")
vhdl_type_TypeReference = Class(name="vhdl_type_TypeReference", is_abstract=True)
vhdl_nature_ArrayNatureDefinition = Class(name="vhdl_nature_ArrayNatureDefinition")
nature_CompositeNatureDefinition = Class(name="nature_CompositeNatureDefinition")
vhdl_nature_CompositeNatureDefinition = Class(name="vhdl_nature_CompositeNatureDefinition")
vhdl_ams_Noise = Class(name="vhdl_ams_Noise")
vhdl_configuration_BlockConfiguration = Class(name="vhdl_configuration_BlockConfiguration")
configuration_ConfigurationItem = Class(name="configuration_ConfigurationItem")
configuration_vhdl_Name = Class(name="configuration_vhdl_Name")
ConfigurationItem = Class(name="ConfigurationItem")
vhdl_configuration_ComponentConfiguration = Class(name="vhdl_configuration_ComponentConfiguration")
configuration_vhdl_MultiName = Class(name="configuration_vhdl_MultiName")
configuration_vhdl_GenericMaps = Class(name="configuration_vhdl_GenericMaps")
configuration_vhdl_PortMaps = Class(name="configuration_vhdl_PortMaps")
BlockConfiguration = Class(name="BlockConfiguration")
vhdl_configuration_Configuration = Class(name="vhdl_configuration_Configuration")
configuration_vhdl_EntityReference = Class(name="configuration_vhdl_EntityReference")
vhdl_configuration_ConfigurationItem = Class(name="vhdl_configuration_ConfigurationItem")
vhdl_configuration_ConfigurationReference = Class(name="vhdl_configuration_ConfigurationReference", is_abstract=True)
vhdl_ams_Spectrum = Class(name="vhdl_ams_Spectrum")
vhdl_configuration_ConfigurationResolvedReference = Class(name="vhdl_configuration_ConfigurationResolvedReference")
...
vhdl_declaration_AttributeSpecification_class_: Property = Property(name="class_", type=StringType)
vhdl_declaration_AttributeSpecification.attributes={vhdl_declaration_AttributeSpecification_class_}
...
vhdl_declaration_VariableDeclaration.attributes={vhdl_declaration_VariableDeclaration_shared, vhdl_declaration_VariableDeclaration_mode}
...
vhdl_type_PhysicalTypeDefinitionSecondary.attributes={vhdl_type_PhysicalTypeDefinitionSecondary_number, vhdl_type_PhysicalTypeDefinitionSecondary_name}
...
return_32: BinaryAssociation = BinaryAssociation(
    name="return_32",
    ends={
...
break_129: BinaryAssociation = BinaryAssociation(
    name="break_129",
    ends={
...
in_178: BinaryAssociation = BinaryAssociation(
    name="in_178",
    ends={
...
in_180: BinaryAssociation = BinaryAssociation(
    name="in_180",
    ends={
...
is_231: BinaryAssociation = BinaryAssociation(
    name="is_231",
    ends={
...
is_234: BinaryAssociation = BinaryAssociation(
    name="is_234",
    ends={
...
is_281: BinaryAssociation = BinaryAssociation(
    name="is_281",
    ends={
...
is_284: BinaryAssociation = BinaryAssociation(
    name="is_284",
    ends={
...
is_285: BinaryAssociation = BinaryAssociation(
    name="is_285",
    ends={
...
is_290: BinaryAssociation = BinaryAssociation(
    name="is_290",
    ends={
...
domain_model = DomainModel(
    name="vhdl",
    types={vhdl_Architecture, Module, Named, vhdl_EntityReference, Statement, vhdl_DesignUnit, VhdlObject, vhdl_Name, vhdl_Module, Declaration, vhdl_Entity, vhdl_GenericMaps, Expression, vhdl_Model, vhdl_Package, vhdl_PackageBody, vhdl_PackageReference, vhdl_PortMaps, vhdl_Signature, TypeReference, vhdl_Component, declaration_Declaration, vhdl_Generics, vhdl_Ports, MultiName, type_TypeReference, nature_NatureReference, EntityReference, PackageReference, ComponentReference, configuration_ConfigurationReference, CallReference, vhdl_NameList, vhdl_EntityResolvedReference, vhdl_Named, vhdl_MultiNamed, vhdl_MultiName, vhdl_VhdlObject, vhdl_CallReference, vhdl_CallResolvedReference, SubprogramDeclaration, vhdl_statement_ReportStatement, vhdl_statement_ReturnStatement, ExpressionStatement, vhdl_statement_ConditionalSignalAssignmentStatement, SignalAssignmentStatement, vhdl_statement_SelectedSignalAssignmentStatement, ConditionalSignalAssignmentStatement, vhdl_statement_SequentialSignalAssignmentStatement, vhdl_statement_SignalAssignmentStatement, DelayMechanism, vhdl_statement_WaitStatement, statement_vhdl_MultiName, vhdl_statement_VariableAssignmentStatement, vhdl_PackageResolvedReference, vhdl_ComponentReference, vhdl_ComponentResolvedReference, vhdl_statement_SimultaneousIfStatement, IfStatement, vhdl_statement_IfStatement, IfStatementTest, vhdl_statement_IfStatementTest, vhdl_statement_ProcedureCallStatement, statement_vhdl_CallReference, vhdl_statement_SimultaneousProceduralStatement, vhdl_statement_ProcessStatement, vhdl_statement_AssertionStatement, vhdl_statement_SimultaneousCaseStatement, CaseStatement, vhdl_statement_CaseStatement, CaseAlternative, vhdl_statement_CaseAlternative, statement_vhdl_Generics, statement_vhdl_GenericMaps, statement_vhdl_Ports, statement_vhdl_PortMaps, vhdl_statement_BreakStatement, BreakStatementItem, vhdl_statement_BreakStatementItem, statement_vhdl_Name, vhdl_statement_ComponentInstantiationStatement, InstantiationStatement, statement_vhdl_ComponentReference, vhdl_statement_InstantiationStatement, vhdl_statement_BlockStatement, vhdl_statement_ExitStatement, vhdl_statement_GenerateStatement, GenerationScheme, vhdl_statement_LoopStatement, IterationScheme, vhdl_statement_NextStatement, vhdl_statement_Statement, vhdl_statement_IterationScheme, vhdl_statement_WhileIterationScheme, vhdl_statement_EntityInstantiationStatement, statement_vhdl_EntityReference, vhdl_statement_ConfigurationInstantiationStatement, ConfigurationReference, vhdl_statement_SimpleSimultaneousStatement, vhdl_statement_ForIterationScheme, vhdl_statement_GenerationScheme, vhdl_statement_IfGenerationScheme, vhdl_statement_RejectMechanism, vhdl_statement_TransportMechanism, vhdl_expression_AddingExpression, BinaryExpression, vhdl_expression_AggregateExpression, expression_MultiExpression, Name, vhdl_expression_AllExpression, expression_Expression, vhdl_expression_AllocatorExpression, type_Typed, vhdl_expression_AssociationExpression, vhdl_expression_AttributeExpression, expression_ValueExpression, expression_vhdl_Signature, vhdl_statement_DelayMechanism, vhdl_statement_ExpressionStatement, vhdl_statement_ForGenerationScheme, vhdl_expression_BitStringExpression, ValueExpression, vhdl_expression_Expression, vhdl_expression_IndicationExpression, vhdl_expression_SubtypeIndicationExpression, expression_IndicationExpression, vhdl_expression_SubnatureIndicationExpression, NatureReference, vhdl_expression_LogicalExpression, vhdl_expression_NameExpression, expression_vhdl_Name, vhdl_expression_BinaryExpression, vhdl_expression_ShiftExpression, vhdl_expression_SignatureExpression, vhdl_expression_SignExpression, vhdl_expression_UnaryExpression, vhdl_expression_OpenExpression, vhdl_expression_OthersExpression, vhdl_expression_RangeExpression, expression_BinaryExpression, vhdl_expression_StringExpression, vhdl_expression_CharacterExpression, type_EnumerationLiteral, vhdl_expression_IdentifierExpression, vhdl_expression_UnitValueExpression, vhdl_expression_UnaffectedExpression, vhdl_expression_ValueExpression, vhdl_expression_NullExpression, vhdl_expression_WaveformExpression, vhdl_expression_MultiplyingExpression, vhdl_expression_PowerExpression, vhdl_expression_RelationalExpression, vhdl_expression_MultiExpression, vhdl_expression_ConditionalWaveformExpression, AssociationExpression, vhdl_expression_TypeQualificationExpression, declaration_vhdl_Name, vhdl_declaration_AttributeDeclaration, vhdl_declaration_AttributeSpecification, declaration_vhdl_MultiName, vhdl_declaration_BranchQuantityDeclaration, QuantityDeclaration, QuantityAspect, vhdl_declaration_FreeQuantityDeclaration, declaration_QuantityDeclaration, MultiNamed, vhdl_declaration_LimitDeclaration, vhdl_declaration_QuantityDeclaration, vhdl_declaration_SourceQuantityDeclaration, SourceAspect, vhdl_declaration_SubnatureDeclaration, nature_Natured, vhdl_declaration_SubprogramDeclaration, vhdl_declaration_AliasDeclaration, vhdl_declaration_FunctionDeclaration, declaration_SubprogramDeclaration, vhdl_declaration_SubprogramBody, vhdl_declaration_SubtypeDeclaration, vhdl_declaration_ConfigurationSpecification, declaration_vhdl_ComponentReference, declaration_vhdl_EntityReference, declaration_vhdl_GenericMaps, declaration_vhdl_PortMaps, vhdl_declaration_Declaration, vhdl_declaration_DisconnectionSpecification, vhdl_declaration_FileDeclaration, SubprogramBody, vhdl_declaration_ProcedureDeclaration, vhdl_declaration_ConstantDeclaration, ValueDeclaration, vhdl_declaration_GroupDeclaration, vhdl_declaration_GroupTemplateDeclaration, vhdl_declaration_NatureDeclaration, NatureDefinition, vhdl_declaration_SignalDeclaration, vhdl_declaration_UseClauseDeclaration, vhdl_declaration_VariableDeclaration, vhdl_declaration_ValueDeclaration, vhdl_declaration_TerminalDeclaration, vhdl_declaration_TypeDeclaration, TypeDefinition, vhdl_type_AccessTypeDefinition, type_TypeDefinition, vhdl_type_CompositeTypeDefinition, vhdl_type_RecordTypeDefinition, CompositeTypeDefinition, RecordTypeElement, vhdl_type_ArrayTypeDefinition, type_CompositeTypeDefinition, vhdl_type_ConstrainedArrayTypeDefinition, ArrayTypeDefinition, vhdl_type_UnconstrainedArrayTypeDefinition, vhdl_type_EnumerationLiteral, vhdl_type_EnumerationTypeDefinition, EnumerationLiteral, vhdl_type_FileTypeDefinition, vhdl_type_PhysicalTypeDefinition, PhysicalTypeDefinitionSecondary, vhdl_type_PhysicalTypeDefinitionSecondary, type_vhdl_Name, vhdl_type_RangeTypeDefinition, vhdl_type_RecordTypeElement, vhdl_nature_ConstrainedArrayNatureDefinition, ArrayNatureDefinition, vhdl_nature_NatureDefinition, vhdl_nature_RecordNatureDefinition, CompositeNatureDefinition, RecordNatureElement, vhdl_nature_RecordNatureElement, vhdl_nature_ScalarNatureDefinition, nature_vhdl_Name, vhdl_nature_UnconstrainedArrayNatureDefinition, vhdl_nature_NatureReference, vhdl_nature_Natured, vhdl_ams_QuantityAspect, vhdl_type_Typed, vhdl_type_TypeDefinition, vhdl_ams_SourceAspect, vhdl_type_TypeReference, vhdl_nature_ArrayNatureDefinition, nature_CompositeNatureDefinition, vhdl_nature_CompositeNatureDefinition, vhdl_ams_Noise, vhdl_configuration_BlockConfiguration, configuration_ConfigurationItem, configuration_vhdl_Name, ConfigurationItem, vhdl_configuration_ComponentConfiguration, configuration_vhdl_MultiName, configuration_vhdl_GenericMaps, configuration_vhdl_PortMaps, BlockConfiguration, vhdl_configuration_Configuration, configuration_vhdl_EntityReference, vhdl_configuration_ConfigurationItem, vhdl_configuration_ConfigurationReference, vhdl_ams_Spectrum, vhdl_configuration_ConfigurationResolvedReference, Configuration, UnaryOperator, MultiplyingOperator, ShiftOperator, RelationalOperator, LogicalOperator, AddingOperator, Sign, RangeDirection, SignalKind, Mode, EntityClass, Purity},
    associations={of0, statement1, use6, module7, declaration9, generic11, port13, statement16, generic19, declaration20, design23, name25, declaration26, port29, parameter31, generic3, port4, name38, entity40, return_32, name35, name37, call45, report46, severity48, waveform51, selected53, waveform55, target57, delay59, sensitivity61, until62, time65, target68, package42, component43, choice77, statement79, test82, statement83, condition86, statement88, procedure91, declaration92, statement94, declaration97, statement99, sensitivity102, condition105, initial70, case73, when75, guard113, generic115, genericMap117, port119, portMap121, declaration123, statement126, break_129, when130, sensitivity133, name136, use137, arrow140, name143, genericMap144, portMap146, report107, severity110, right153, tolerance156, when159, scheme161, declaration162, statement165, iteration168, statement169, when172, name149, name150, left151, in_178, in_180, condition182, reject184, choice186, expression188, signature191, condition174, expression176, right194, constraint197, tolerance199, across202, mark205, mark207, element208, left192, signature209, name211, expression214, expression216, unit218, expression225, expression227, expression220, after222, is_231, entity233, is_234, across237, through238, left241, right244, quantity247, value249, source251, parameter252, alias229, declaration256, statement258, list261, component263, entity265, configuration267, genericMap270, portMap272, disconnect274, after276, open279, is_281, body254, is_284, is_285, member287, is_290, use291, initial293, declaration295, constraint296, index298, literal300, range301, secondary303, of305, left306, right308, constraint313, record315, name316, across317, through320, index323, nature325, tolerance327, expression329, type311, right334, noise337, use339, item340, list342, component343, entity346, configuration349, genericMap352, portMap354, block356, of358, block359, left332, configuration362},
    generalizations={gen_vhdl_Architecture_Module, gen_vhdl_Architecture_Named, gen_vhdl_DesignUnit_VhdlObject, gen_vhdl_Module_VhdlObject, gen_vhdl_Entity_Module, gen_vhdl_Entity_Named, gen_vhdl_GenericMaps_VhdlObject, gen_vhdl_Generics_VhdlObject, gen_vhdl_Model_VhdlObject, gen_vhdl_Package_Module, gen_vhdl_Package_Named, gen_vhdl_PackageBody_Module, gen_vhdl_Ports_VhdlObject, gen_vhdl_PortMaps_VhdlObject, gen_vhdl_Signature_VhdlObject, gen_vhdl_Component_declaration_Declaration, gen_vhdl_Component_Named, gen_vhdl_Name_MultiName, gen_vhdl_Name_type_TypeReference, gen_vhdl_Name_nature_NatureReference, gen_vhdl_Name_EntityReference, gen_vhdl_Name_PackageReference, gen_vhdl_Name_ComponentReference, gen_vhdl_Name_configuration_ConfigurationReference, gen_vhdl_Name_CallReference, gen_vhdl_NameList_VhdlObject, gen_vhdl_NameList_MultiName, gen_vhdl_EntityResolvedReference_VhdlObject, gen_vhdl_EntityResolvedReference_EntityReference, gen_vhdl_CallResolvedReference_CallReference, gen_vhdl_statement_ReportStatement_Statement, gen_vhdl_statement_ReturnStatement_ExpressionStatement, gen_vhdl_statement_ConditionalSignalAssignmentStatement_SignalAssignmentStatement, gen_vhdl_statement_SelectedSignalAssignmentStatement_ConditionalSignalAssignmentStatement, gen_vhdl_statement_SequentialSignalAssignmentStatement_SignalAssignmentStatement, gen_vhdl_statement_SignalAssignmentStatement_Statement, gen_vhdl_statement_WaitStatement_Statement, gen_vhdl_statement_VariableAssignmentStatement_Statement, gen_vhdl_PackageResolvedReference_VhdlObject, gen_vhdl_PackageResolvedReference_PackageReference, gen_vhdl_ComponentResolvedReference_VhdlObject, gen_vhdl_ComponentResolvedReference_ComponentReference, gen_vhdl_statement_SimultaneousIfStatement_IfStatement, gen_vhdl_statement_IfStatement_Statement, gen_vhdl_statement_IfStatementTest_VhdlObject, gen_vhdl_statement_ProcedureCallStatement_Statement, gen_vhdl_statement_SimultaneousProceduralStatement_Statement, gen_vhdl_statement_ProcessStatement_Statement, gen_vhdl_statement_AssertionStatement_Statement, gen_vhdl_statement_SimultaneousCaseStatement_CaseStatement, gen_vhdl_statement_CaseStatement_Statement, gen_vhdl_statement_CaseAlternative_VhdlObject, gen_vhdl_statement_BreakStatement_Statement, gen_vhdl_statement_BreakStatementItem_VhdlObject, gen_vhdl_statement_ComponentInstantiationStatement_InstantiationStatement, gen_vhdl_statement_InstantiationStatement_Statement, gen_vhdl_statement_BlockStatement_Statement, gen_vhdl_statement_ExitStatement_Statement, gen_vhdl_statement_GenerateStatement_Statement, gen_vhdl_statement_LoopStatement_Statement, gen_vhdl_statement_NextStatement_Statement, gen_vhdl_statement_Statement_VhdlObject, gen_vhdl_statement_IterationScheme_VhdlObject, gen_vhdl_statement_WhileIterationScheme_IterationScheme, gen_vhdl_statement_EntityInstantiationStatement_InstantiationStatement, gen_vhdl_statement_ConfigurationInstantiationStatement_InstantiationStatement, gen_vhdl_statement_SimpleSimultaneousStatement_Statement, gen_vhdl_statement_ForIterationScheme_IterationScheme, gen_vhdl_statement_GenerationScheme_VhdlObject, gen_vhdl_statement_IfGenerationScheme_GenerationScheme, gen_vhdl_statement_RejectMechanism_DelayMechanism, gen_vhdl_statement_TransportMechanism_DelayMechanism, gen_vhdl_expression_AddingExpression_BinaryExpression, gen_vhdl_expression_AggregateExpression_expression_MultiExpression, gen_vhdl_expression_AggregateExpression_Name, gen_vhdl_expression_AllExpression_expression_Expression, gen_vhdl_expression_AllExpression_Name, gen_vhdl_expression_AllocatorExpression_expression_Expression, gen_vhdl_expression_AllocatorExpression_type_Typed, gen_vhdl_expression_AssociationExpression_Expression, gen_vhdl_expression_AttributeExpression_expression_ValueExpression, gen_vhdl_expression_AttributeExpression_Name, gen_vhdl_statement_DelayMechanism_VhdlObject, gen_vhdl_statement_ExpressionStatement_Statement, gen_vhdl_statement_ForGenerationScheme_GenerationScheme, gen_vhdl_expression_BitStringExpression_ValueExpression, gen_vhdl_expression_Expression_VhdlObject, gen_vhdl_expression_IndicationExpression_Expression, gen_vhdl_expression_SubtypeIndicationExpression_expression_IndicationExpression, gen_vhdl_expression_SubtypeIndicationExpression_type_TypeReference, gen_vhdl_expression_SubtypeIndicationExpression_Named, gen_vhdl_expression_SubnatureIndicationExpression_expression_IndicationExpression, gen_vhdl_expression_SubnatureIndicationExpression_nature_NatureReference, gen_vhdl_expression_LogicalExpression_BinaryExpression, gen_vhdl_expression_NameExpression_expression_Expression, gen_vhdl_expression_NameExpression_Name, gen_vhdl_expression_BinaryExpression_Expression, gen_vhdl_expression_ShiftExpression_BinaryExpression, gen_vhdl_expression_SignatureExpression_expression_Expression, gen_vhdl_expression_SignatureExpression_Name, gen_vhdl_expression_SignExpression_Expression, gen_vhdl_expression_UnaryExpression_Expression, gen_vhdl_expression_OpenExpression_Expression, gen_vhdl_expression_OthersExpression_expression_Expression, gen_vhdl_expression_OthersExpression_Name, gen_vhdl_expression_RangeExpression_expression_BinaryExpression, gen_vhdl_expression_RangeExpression_Name, gen_vhdl_expression_StringExpression_expression_ValueExpression, gen_vhdl_expression_StringExpression_Name, gen_vhdl_expression_CharacterExpression_expression_ValueExpression, gen_vhdl_expression_CharacterExpression_Name, gen_vhdl_expression_CharacterExpression_type_EnumerationLiteral, gen_vhdl_expression_IdentifierExpression_expression_ValueExpression, gen_vhdl_expression_IdentifierExpression_Name, gen_vhdl_expression_IdentifierExpression_type_EnumerationLiteral, gen_vhdl_expression_UnitValueExpression_ValueExpression, gen_vhdl_expression_UnaffectedExpression_Expression, gen_vhdl_expression_ValueExpression_Expression, gen_vhdl_expression_NullExpression_Expression, gen_vhdl_expression_WaveformExpression_Expression, gen_vhdl_expression_MultiplyingExpression_BinaryExpression, gen_vhdl_expression_PowerExpression_BinaryExpression, gen_vhdl_expression_RelationalExpression_BinaryExpression, gen_vhdl_expression_MultiExpression_Expression, gen_vhdl_expression_ConditionalWaveformExpression_AssociationExpression, gen_vhdl_expression_TypeQualificationExpression_expression_Expression, gen_vhdl_expression_TypeQualificationExpression_Name, gen_vhdl_declaration_AttributeDeclaration_declaration_Declaration, gen_vhdl_declaration_AttributeDeclaration_Named, gen_vhdl_declaration_AttributeDeclaration_type_Typed, gen_vhdl_declaration_AttributeSpecification_declaration_Declaration, gen_vhdl_declaration_AttributeSpecification_Named, gen_vhdl_declaration_BranchQuantityDeclaration_QuantityDeclaration, gen_vhdl_declaration_FreeQuantityDeclaration_declaration_QuantityDeclaration, gen_vhdl_declaration_FreeQuantityDeclaration_MultiNamed, gen_vhdl_declaration_FreeQuantityDeclaration_type_Typed, gen_vhdl_declaration_LimitDeclaration_declaration_Declaration, gen_vhdl_declaration_LimitDeclaration_MultiNamed, gen_vhdl_declaration_LimitDeclaration_type_Typed, gen_vhdl_declaration_QuantityDeclaration_Declaration, gen_vhdl_declaration_SourceQuantityDeclaration_declaration_QuantityDeclaration, gen_vhdl_declaration_SourceQuantityDeclaration_MultiNamed, gen_vhdl_declaration_SourceQuantityDeclaration_type_Typed, gen_vhdl_declaration_SubnatureDeclaration_declaration_Declaration, gen_vhdl_declaration_SubnatureDeclaration_Named, gen_vhdl_declaration_SubnatureDeclaration_nature_Natured, gen_vhdl_declaration_SubprogramDeclaration_declaration_Declaration, gen_vhdl_declaration_SubprogramDeclaration_Named, gen_vhdl_declaration_AliasDeclaration_declaration_Declaration, gen_vhdl_declaration_AliasDeclaration_Named, gen_vhdl_declaration_FunctionDeclaration_declaration_SubprogramDeclaration, gen_vhdl_declaration_FunctionDeclaration_type_Typed, gen_vhdl_declaration_SubprogramBody_VhdlObject, gen_vhdl_declaration_SubtypeDeclaration_declaration_Declaration, gen_vhdl_declaration_SubtypeDeclaration_Named, gen_vhdl_declaration_SubtypeDeclaration_type_Typed, gen_vhdl_declaration_ConfigurationSpecification_Declaration, gen_vhdl_declaration_Declaration_VhdlObject, gen_vhdl_declaration_DisconnectionSpecification_declaration_Declaration, gen_vhdl_declaration_DisconnectionSpecification_type_Typed, gen_vhdl_declaration_FileDeclaration_declaration_Declaration, gen_vhdl_declaration_FileDeclaration_MultiNamed, gen_vhdl_declaration_FileDeclaration_type_Typed, gen_vhdl_declaration_ProcedureDeclaration_SubprogramDeclaration, gen_vhdl_declaration_ConstantDeclaration_ValueDeclaration, gen_vhdl_declaration_GroupDeclaration_declaration_Declaration, gen_vhdl_declaration_GroupDeclaration_Named, gen_vhdl_declaration_GroupTemplateDeclaration_declaration_Declaration, gen_vhdl_declaration_GroupTemplateDeclaration_Named, gen_vhdl_declaration_NatureDeclaration_declaration_Declaration, gen_vhdl_declaration_NatureDeclaration_Named, gen_vhdl_declaration_SignalDeclaration_ValueDeclaration, gen_vhdl_declaration_UseClauseDeclaration_Declaration, gen_vhdl_declaration_VariableDeclaration_ValueDeclaration, gen_vhdl_declaration_ValueDeclaration_declaration_Declaration, gen_vhdl_declaration_ValueDeclaration_MultiNamed, gen_vhdl_declaration_ValueDeclaration_type_Typed, gen_vhdl_declaration_TerminalDeclaration_declaration_Declaration, gen_vhdl_declaration_TerminalDeclaration_MultiNamed, gen_vhdl_declaration_TerminalDeclaration_nature_Natured, gen_vhdl_declaration_TypeDeclaration_declaration_Declaration, gen_vhdl_declaration_TypeDeclaration_Named, gen_vhdl_type_AccessTypeDefinition_type_TypeDefinition, gen_vhdl_type_AccessTypeDefinition_type_Typed, gen_vhdl_type_CompositeTypeDefinition_TypeDefinition, gen_vhdl_type_RecordTypeDefinition_CompositeTypeDefinition, gen_vhdl_type_ArrayTypeDefinition_type_CompositeTypeDefinition, gen_vhdl_type_ArrayTypeDefinition_type_Typed, gen_vhdl_type_ConstrainedArrayTypeDefinition_ArrayTypeDefinition, gen_vhdl_type_UnconstrainedArrayTypeDefinition_ArrayTypeDefinition, gen_vhdl_type_EnumerationTypeDefinition_TypeDefinition, gen_vhdl_type_FileTypeDefinition_type_TypeDefinition, gen_vhdl_type_FileTypeDefinition_type_Typed, gen_vhdl_type_PhysicalTypeDefinition_TypeDefinition, gen_vhdl_type_RangeTypeDefinition_TypeDefinition, gen_vhdl_type_RecordTypeElement_VhdlObject, gen_vhdl_type_RecordTypeElement_MultiNamed, gen_vhdl_type_RecordTypeElement_type_Typed, gen_vhdl_nature_ConstrainedArrayNatureDefinition_ArrayNatureDefinition, gen_vhdl_nature_NatureDefinition_VhdlObject, gen_vhdl_nature_RecordNatureDefinition_CompositeNatureDefinition, gen_vhdl_nature_RecordNatureElement_VhdlObject, gen_vhdl_nature_RecordNatureElement_MultiNamed, gen_vhdl_nature_RecordNatureElement_nature_Natured, gen_vhdl_nature_ScalarNatureDefinition_NatureDefinition, gen_vhdl_nature_UnconstrainedArrayNatureDefinition_ArrayNatureDefinition, gen_vhdl_ams_QuantityAspect_VhdlObject, gen_vhdl_ams_QuantityAspect_MultiNamed, gen_vhdl_type_TypeDefinition_VhdlObject, gen_vhdl_ams_SourceAspect_VhdlObject, gen_vhdl_nature_ArrayNatureDefinition_nature_CompositeNatureDefinition, gen_vhdl_nature_ArrayNatureDefinition_nature_Natured, gen_vhdl_nature_CompositeNatureDefinition_NatureDefinition, gen_vhdl_ams_Noise_SourceAspect, gen_vhdl_configuration_BlockConfiguration_configuration_ConfigurationItem, gen_vhdl_configuration_BlockConfiguration_Named, gen_vhdl_configuration_ComponentConfiguration_ConfigurationItem, gen_vhdl_configuration_Configuration_Module, gen_vhdl_configuration_Configuration_Named, gen_vhdl_configuration_ConfigurationItem_VhdlObject, gen_vhdl_ams_Spectrum_SourceAspect, gen_vhdl_configuration_ConfigurationResolvedReference_VhdlObject, gen_vhdl_configuration_ConfigurationResolvedReference_configuration_ConfigurationReference},
    metadata=None
)
