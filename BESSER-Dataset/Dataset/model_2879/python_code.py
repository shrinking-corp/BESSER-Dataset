...
class vhdl_type_PhysicalTypeDefinitionSecondary:
    ...
    def __init__(self, name: str, number: str, vhdl_type_PhysicalTypeDefinitionSecondary: "type_vhdl_Name" = None):
        self.name = name
        self.number = number
...
class vhdl_type_RangeTypeDefinition(TypeDefinition):
    ...
    def __init__(self, direction: str, vhdl_type_RangeTypeDefinition: "Expression" = None, vhdl_type_RangeTypeDefinition309: "Expression" = None, TypeDefinition: "vhdl_declaration_TypeDeclaration" = None):
...
class vhdl_type_PhysicalTypeDefinition(TypeDefinition):
    ...
    def __init__(self, primary: str, vhdl_type_PhysicalTypeDefinition: "Expression" = None, vhdl_type_PhysicalTypeDefinition304: set["PhysicalTypeDefinitionSecondary"] = None, TypeDefinition: "vhdl_declaration_TypeDeclaration" = None):
...
class vhdl_type_FileTypeDefinition(type_Typed, type_TypeDefinition):
    ...
    pass
class vhdl_declaration_SourceQuantityDeclaration(type_Typed, MultiNamed, declaration_QuantityDeclaration):

    pass
class vhdl_type_ArrayTypeDefinition(type_CompositeTypeDefinition, type_Typed):

    pass
class vhdl_declaration_FunctionDeclaration(declaration_SubprogramDeclaration, type_Typed):
...
class vhdl_declaration_FreeQuantityDeclaration(type_Typed, MultiNamed, declaration_QuantityDeclaration):
...
class Name:
    ...
    pass
class vhdl_expression_AllExpression(expression_Expression, Name):

    pass
class vhdl_expression_IdentifierExpression(type_EnumerationLiteral, expression_ValueExpression, Name):

    pass
class vhdl_expression_NameExpression(expression_Expression, Name):

    pass
class vhdl_expression_SignatureExpression(expression_Expression, Name):

    pass
class vhdl_expression_OthersExpression(expression_Expression, Name):

    pass
class vhdl_expression_StringExpression(expression_ValueExpression, Name):

    pass
class vhdl_expression_TypeQualificationExpression(expression_Expression, Name):
...
class vhdl_statement_ForIterationScheme(IterationScheme):
    ...
    def __init__(self, variable: str, vhdl_statement_ForIterationScheme: "Expression" = None, IterationScheme: "vhdl_statement_LoopStatement" = None):
...
class vhdl_statement_ForGenerationScheme(GenerationScheme):
    ...
    def __init__(self, variable: str, vhdl_statement_ForGenerationScheme: "Expression" = None, GenerationScheme: "vhdl_statement_GenerateStatement" = None):
        self.variable = variable
...
class declaration_Declaration:
    ...
    pass
class vhdl_declaration_TerminalDeclaration(nature_Natured, MultiNamed, declaration_Declaration):

    pass
class vhdl_declaration_DisconnectionSpecification(type_Typed, declaration_Declaration):

    pass
class vhdl_declaration_FileDeclaration(type_Typed, MultiNamed, declaration_Declaration):

    pass
class vhdl_declaration_ValueDeclaration(type_Typed, MultiNamed, declaration_Declaration):

    pass
class vhdl_declaration_LimitDeclaration(type_Typed, MultiNamed, declaration_Declaration):
...
class vhdl_expression_ValueExpression(Expression):
    ...
    def __init__(self, value: str, Expression314: "vhdl_nature_ConstrainedArrayNatureDefinition" = None, Expression106: "vhdl_statement_AssertionStatement" = None, Expression294: "vhdl_declaration_ValueDeclaration" = None, Expression217: "vhdl_expression_UnaryExpression" = None, Expression224: "vhdl_expression_WaveformExpression" = None, Expression87: "vhdl_statement_IfStatementTest" = None, Expression328: "vhdl_ams_QuantityAspect" = None, Expression215: "vhdl_expression_SignExpression" = None, Expression280: "vhdl_declaration_FileDeclaration" = None, Expression248: "vhdl_declaration_FreeQuantityDeclaration" = None, Expression310: "vhdl_type_RangeTypeDefinition" = None, Expression173: "vhdl_statement_NextStatement" = None, Expression250: "vhdl_declaration_LimitDeclaration" = None, Expression72: "vhdl_statement_VariableAssignmentStatement" = None, Expression74: "vhdl_statement_CaseStatement" = None, Expression226: "vhdl_expression_MultiExpression" = None, Expression142: "vhdl_statement_BreakStatementItem" = None, Expression78: "vhdl_statement_CaseAlternative" = None, Expression30: "vhdl_PortMaps" = None, Expression331: "vhdl_ams_QuantityAspect" = None, Expression333: "vhdl_ams_Spectrum" = None, Expression175: "vhdl_statement_WhileIterationScheme" = None, Expression52: "vhdl_statement_ConditionalSignalAssignmentStatement" = None, Expression185: "vhdl_statement_RejectMechanism" = None, Expression132: "vhdl_statement_BreakStatement" = None, Expression336: "vhdl_ams_Spectrum" = None, Expression278: "vhdl_declaration_DisconnectionSpecification" = None, Expression114: "vhdl_statement_BlockStatement" = None, Expression204: "vhdl_expression_IndicationExpression" = None, Expression181: "vhdl_statement_ForIterationScheme" = None, Expression179: "vhdl_statement_ForGenerationScheme" = None, Expression56: "vhdl_statement_SequentialSignalAssignmentStatement" = None, Expression190: "vhdl_expression_AssociationExpression" = None, Expression221: "vhdl_expression_WaveformExpression" = None, Expression187: "vhdl_expression_AssociationExpression" = None, Expression64: "vhdl_statement_WaitStatement" = None, Expression112: "vhdl_statement_AssertionStatement" = None, Expression302: "vhdl_type_PhysicalTypeDefinition" = None, Expression58: "vhdl_statement_SignalAssignmentStatement" = None, Expression193: "vhdl_expression_BinaryExpression" = None, Expression198: "vhdl_expression_IndicationExpression" = None, Expression152: "vhdl_statement_SimpleSimultaneousStatement" = None, Expression160: "vhdl_statement_ExitStatement" = None, Expression283: "vhdl_declaration_FileDeclaration" = None, Expression201: "vhdl_expression_IndicationExpression" = None, Expression155: "vhdl_statement_SimpleSimultaneousStatement" = None, Expression177: "vhdl_statement_ExpressionStatement" = None, Expression67: "vhdl_statement_WaitStatement" = None, Expression109: "vhdl_statement_AssertionStatement" = None, Expression297: "vhdl_type_ConstrainedArrayTypeDefinition" = None, Expression54: "vhdl_statement_SelectedSignalAssignmentStatement" = None, Expression196: "vhdl_expression_BinaryExpression" = None, Expression: "vhdl_GenericMaps" = None, Expression236: "vhdl_declaration_AttributeSpecification" = None, Expression183: "vhdl_statement_IfGenerationScheme" = None, Expression158: "vhdl_statement_SimpleSimultaneousStatement" = None, Expression69: "vhdl_statement_VariableAssignmentStatement" = None, Expression50: "vhdl_statement_ReportStatement" = None, Expression228: "vhdl_expression_TypeQualificationExpression" = None, Expression47: "vhdl_statement_ReportStatement" = None, Expression307: "vhdl_type_RangeTypeDefinition" = None, Expression338: "vhdl_ams_Noise" = None):
        self.value = value
...
class vhdl_expression_SignExpression(Expression):
    ...
    def __init__(self, sign: str, vhdl_expression_SignExpression: "Expression" = None, Expression314: "vhdl_nature_ConstrainedArrayNatureDefinition" = None, Expression106: "vhdl_statement_AssertionStatement" = None, Expression294: "vhdl_declaration_ValueDeclaration" = None, Expression217: "vhdl_expression_UnaryExpression" = None, Expression224: "vhdl_expression_WaveformExpression" = None, Expression87: "vhdl_statement_IfStatementTest" = None, Expression328: "vhdl_ams_QuantityAspect" = None, Expression215: "vhdl_expression_SignExpression" = None, Expression280: "vhdl_declaration_FileDeclaration" = None, Expression248: "vhdl_declaration_FreeQuantityDeclaration" = None, Expression310: "vhdl_type_RangeTypeDefinition" = None, Expression173: "vhdl_statement_NextStatement" = None, Expression250: "vhdl_declaration_LimitDeclaration" = None, Expression72: "vhdl_statement_VariableAssignmentStatement" = None, Expression74: "vhdl_statement_CaseStatement" = None, Expression226: "vhdl_expression_MultiExpression" = None, Expression142: "vhdl_statement_BreakStatementItem" = None, Expression78: "vhdl_statement_CaseAlternative" = None, Expression30: "vhdl_PortMaps" = None, Expression331: "vhdl_ams_QuantityAspect" = None, Expression333: "vhdl_ams_Spectrum" = None, Expression175: "vhdl_statement_WhileIterationScheme" = None, Expression52: "vhdl_statement_ConditionalSignalAssignmentStatement" = None, Expression185: "vhdl_statement_RejectMechanism" = None, Expression132: "vhdl_statement_BreakStatement" = None, Expression336: "vhdl_ams_Spectrum" = None, Expression278: "vhdl_declaration_DisconnectionSpecification" = None, Expression114: "vhdl_statement_BlockStatement" = None, Expression204: "vhdl_expression_IndicationExpression" = None, Expression181: "vhdl_statement_ForIterationScheme" = None, Expression179: "vhdl_statement_ForGenerationScheme" = None, Expression56: "vhdl_statement_SequentialSignalAssignmentStatement" = None, Expression190: "vhdl_expression_AssociationExpression" = None, Expression221: "vhdl_expression_WaveformExpression" = None, Expression187: "vhdl_expression_AssociationExpression" = None, Expression64: "vhdl_statement_WaitStatement" = None, Expression112: "vhdl_statement_AssertionStatement" = None, Expression302: "vhdl_type_PhysicalTypeDefinition" = None, Expression58: "vhdl_statement_SignalAssignmentStatement" = None, Expression193: "vhdl_expression_BinaryExpression" = None, Expression198: "vhdl_expression_IndicationExpression" = None, Expression152: "vhdl_statement_SimpleSimultaneousStatement" = None, Expression160: "vhdl_statement_ExitStatement" = None, Expression283: "vhdl_declaration_FileDeclaration" = None, Expression201: "vhdl_expression_IndicationExpression" = None, Expression155: "vhdl_statement_SimpleSimultaneousStatement" = None, Expression177: "vhdl_statement_ExpressionStatement" = None, Expression67: "vhdl_statement_WaitStatement" = None, Expression109: "vhdl_statement_AssertionStatement" = None, Expression297: "vhdl_type_ConstrainedArrayTypeDefinition" = None, Expression54: "vhdl_statement_SelectedSignalAssignmentStatement" = None, Expression196: "vhdl_expression_BinaryExpression" = None, Expression: "vhdl_GenericMaps" = None, Expression236: "vhdl_declaration_AttributeSpecification" = None, Expression183: "vhdl_statement_IfGenerationScheme" = None, Expression158: "vhdl_statement_SimpleSimultaneousStatement" = None, Expression69: "vhdl_statement_VariableAssignmentStatement" = None, Expression50: "vhdl_statement_ReportStatement" = None, Expression228: "vhdl_expression_TypeQualificationExpression" = None, Expression47: "vhdl_statement_ReportStatement" = None, Expression307: "vhdl_type_RangeTypeDefinition" = None, Expression338: "vhdl_ams_Noise" = None):
        self.sign = sign
...
class vhdl_expression_UnaryExpression(Expression):
    ...
    def __init__(self, operator: str, vhdl_expression_UnaryExpression: "Expression" = None, Expression314: "vhdl_nature_ConstrainedArrayNatureDefinition" = None, Expression106: "vhdl_statement_AssertionStatement" = None, Expression294: "vhdl_declaration_ValueDeclaration" = None, Expression217: "vhdl_expression_UnaryExpression" = None, Expression224: "vhdl_expression_WaveformExpression" = None, Expression87: "vhdl_statement_IfStatementTest" = None, Expression328: "vhdl_ams_QuantityAspect" = None, Expression215: "vhdl_expression_SignExpression" = None, Expression280: "vhdl_declaration_FileDeclaration" = None, Expression248: "vhdl_declaration_FreeQuantityDeclaration" = None, Expression310: "vhdl_type_RangeTypeDefinition" = None, Expression173: "vhdl_statement_NextStatement" = None, Expression250: "vhdl_declaration_LimitDeclaration" = None, Expression72: "vhdl_statement_VariableAssignmentStatement" = None, Expression74: "vhdl_statement_CaseStatement" = None, Expression226: "vhdl_expression_MultiExpression" = None, Expression142: "vhdl_statement_BreakStatementItem" = None, Expression78: "vhdl_statement_CaseAlternative" = None, Expression30: "vhdl_PortMaps" = None, Expression331: "vhdl_ams_QuantityAspect" = None, Expression333: "vhdl_ams_Spectrum" = None, Expression175: "vhdl_statement_WhileIterationScheme" = None, Expression52: "vhdl_statement_ConditionalSignalAssignmentStatement" = None, Expression185: "vhdl_statement_RejectMechanism" = None, Expression132: "vhdl_statement_BreakStatement" = None, Expression336: "vhdl_ams_Spectrum" = None, Expression278: "vhdl_declaration_DisconnectionSpecification" = None, Expression114: "vhdl_statement_BlockStatement" = None, Expression204: "vhdl_expression_IndicationExpression" = None, Expression181: "vhdl_statement_ForIterationScheme" = None, Expression179: "vhdl_statement_ForGenerationScheme" = None, Expression56: "vhdl_statement_SequentialSignalAssignmentStatement" = None, Expression190: "vhdl_expression_AssociationExpression" = None, Expression221: "vhdl_expression_WaveformExpression" = None, Expression187: "vhdl_expression_AssociationExpression" = None, Expression64: "vhdl_statement_WaitStatement" = None, Expression112: "vhdl_statement_AssertionStatement" = None, Expression302: "vhdl_type_PhysicalTypeDefinition" = None, Expression58: "vhdl_statement_SignalAssignmentStatement" = None, Expression193: "vhdl_expression_BinaryExpression" = None, Expression198: "vhdl_expression_IndicationExpression" = None, Expression152: "vhdl_statement_SimpleSimultaneousStatement" = None, Expression160: "vhdl_statement_ExitStatement" = None, Expression283: "vhdl_declaration_FileDeclaration" = None, Expression201: "vhdl_expression_IndicationExpression" = None, Expression155: "vhdl_statement_SimpleSimultaneousStatement" = None, Expression177: "vhdl_statement_ExpressionStatement" = None, Expression67: "vhdl_statement_WaitStatement" = None, Expression109: "vhdl_statement_AssertionStatement" = None, Expression297: "vhdl_type_ConstrainedArrayTypeDefinition" = None, Expression54: "vhdl_statement_SelectedSignalAssignmentStatement" = None, Expression196: "vhdl_expression_BinaryExpression" = None, Expression: "vhdl_GenericMaps" = None, Expression236: "vhdl_declaration_AttributeSpecification" = None, Expression183: "vhdl_statement_IfGenerationScheme" = None, Expression158: "vhdl_statement_SimpleSimultaneousStatement" = None, Expression69: "vhdl_statement_VariableAssignmentStatement" = None, Expression50: "vhdl_statement_ReportStatement" = None, Expression228: "vhdl_expression_TypeQualificationExpression" = None, Expression47: "vhdl_statement_ReportStatement" = None, Expression307: "vhdl_type_RangeTypeDefinition" = None, Expression338: "vhdl_ams_Noise" = None):
        self.operator = operator
...
class vhdl_declaration_UseClauseDeclaration(Declaration):
    ...
    pass
class vhdl_Name(nature_NatureReference, EntityReference, CallReference, type_TypeReference, MultiName, PackageReference, ComponentReference, configuration_ConfigurationReference):
...
class vhdl_declaration_Declaration(VhdlObject):
    ...
    pass
class vhdl_nature_RecordNatureElement(VhdlObject, nature_Natured, MultiNamed):
...
class vhdl_expression_Expression(VhdlObject):
    ...
    pass
class vhdl_EntityResolvedReference(VhdlObject, EntityReference):

    pass
class vhdl_Generics(VhdlObject):

    pass
class vhdl_type_RecordTypeElement(VhdlObject, type_Typed, MultiNamed):
...
class vhdl_statement_CaseAlternative(VhdlObject):
    ...
    pass
class vhdl_ams_QuantityAspect(VhdlObject, MultiNamed):
...
class vhdl_statement_SignalAssignmentStatement(Statement):
    ...
    def __init__(self, postponed: bool, guarded: bool, vhdl_statement_SignalAssignmentStatement: "Expression" = None, vhdl_statement_SignalAssignmentStatement60: "DelayMechanism" = None, Statement101: "vhdl_statement_ProcessStatement" = None, Statement: "vhdl_Architecture" = None, Statement18: "vhdl_Entity" = None, Statement90: "vhdl_statement_IfStatementTest" = None, Statement85: "vhdl_statement_IfStatement" = None, Statement260: "vhdl_declaration_SubprogramBody" = None, Statement96: "vhdl_statement_SimultaneousProceduralStatement" = None, Statement167: "vhdl_statement_GenerateStatement" = None, Statement171: "vhdl_statement_LoopStatement" = None, Statement128: "vhdl_statement_BlockStatement" = None, Statement81: "vhdl_statement_CaseAlternative" = None):
...
class vhdl_statement_AssertionStatement(Statement):
    ...
    def __init__(self, postponed: bool, vhdl_statement_AssertionStatement: "Expression" = None, vhdl_statement_AssertionStatement108: "Expression" = None, vhdl_statement_AssertionStatement111: "Expression" = None, Statement101: "vhdl_statement_ProcessStatement" = None, Statement: "vhdl_Architecture" = None, Statement18: "vhdl_Entity" = None, Statement90: "vhdl_statement_IfStatementTest" = None, Statement85: "vhdl_statement_IfStatement" = None, Statement260: "vhdl_declaration_SubprogramBody" = None, Statement96: "vhdl_statement_SimultaneousProceduralStatement" = None, Statement167: "vhdl_statement_GenerateStatement" = None, Statement171: "vhdl_statement_LoopStatement" = None, Statement128: "vhdl_statement_BlockStatement" = None, Statement81: "vhdl_statement_CaseAlternative" = None):
        self.postponed = postponed
...
class vhdl_statement_ProcessStatement(Statement):
    ...
    def __init__(self, postponed: bool, vhdl_statement_ProcessStatement: set["Declaration"] = None, vhdl_statement_ProcessStatement100: set["Statement"] = None, vhdl_statement_ProcessStatement103: "statement_vhdl_MultiName" = None, Statement101: "vhdl_statement_ProcessStatement" = None, Statement: "vhdl_Architecture" = None, Statement18: "vhdl_Entity" = None, Statement90: "vhdl_statement_IfStatementTest" = None, Statement85: "vhdl_statement_IfStatement" = None, Statement260: "vhdl_declaration_SubprogramBody" = None, Statement96: "vhdl_statement_SimultaneousProceduralStatement" = None, Statement167: "vhdl_statement_GenerateStatement" = None, Statement171: "vhdl_statement_LoopStatement" = None, Statement128: "vhdl_statement_BlockStatement" = None, Statement81: "vhdl_statement_CaseAlternative" = None):
        self.postponed = postponed
...
class vhdl_statement_NextStatement(Statement):
    ...
    def __init__(self, next: str, vhdl_statement_NextStatement: "Expression" = None, Statement101: "vhdl_statement_ProcessStatement" = None, Statement: "vhdl_Architecture" = None, Statement18: "vhdl_Entity" = None, Statement90: "vhdl_statement_IfStatementTest" = None, Statement85: "vhdl_statement_IfStatement" = None, Statement260: "vhdl_declaration_SubprogramBody" = None, Statement96: "vhdl_statement_SimultaneousProceduralStatement" = None, Statement167: "vhdl_statement_GenerateStatement" = None, Statement171: "vhdl_statement_LoopStatement" = None, Statement128: "vhdl_statement_BlockStatement" = None, Statement81: "vhdl_statement_CaseAlternative" = None):
        self.next = next
...
class vhdl_statement_ProcedureCallStatement(Statement):
    ...
    def __init__(self, postponed: bool, vhdl_statement_ProcedureCallStatement: "statement_vhdl_CallReference" = None, Statement101: "vhdl_statement_ProcessStatement" = None, Statement: "vhdl_Architecture" = None, Statement18: "vhdl_Entity" = None, Statement90: "vhdl_statement_IfStatementTest" = None, Statement85: "vhdl_statement_IfStatement" = None, Statement260: "vhdl_declaration_SubprogramBody" = None, Statement96: "vhdl_statement_SimultaneousProceduralStatement" = None, Statement167: "vhdl_statement_GenerateStatement" = None, Statement171: "vhdl_statement_LoopStatement" = None, Statement128: "vhdl_statement_BlockStatement" = None, Statement81: "vhdl_statement_CaseAlternative" = None):
        self.postponed = postponed
...
class vhdl_statement_ExitStatement(Statement):
    ...
    def __init__(self, exit: str, vhdl_statement_ExitStatement: "Expression" = None, Statement101: "vhdl_statement_ProcessStatement" = None, Statement: "vhdl_Architecture" = None, Statement18: "vhdl_Entity" = None, Statement90: "vhdl_statement_IfStatementTest" = None, Statement85: "vhdl_statement_IfStatement" = None, Statement260: "vhdl_declaration_SubprogramBody" = None, Statement96: "vhdl_statement_SimultaneousProceduralStatement" = None, Statement167: "vhdl_statement_GenerateStatement" = None, Statement171: "vhdl_statement_LoopStatement" = None, Statement128: "vhdl_statement_BlockStatement" = None, Statement81: "vhdl_statement_CaseAlternative" = None):
        self.exit = exit
...
class Named:
    ...
    pass
class vhdl_declaration_SubtypeDeclaration(type_Typed, Named, declaration_Declaration):

    pass
class vhdl_declaration_AttributeSpecification(Named, declaration_Declaration):

    def __init__(self, class_: str, vhdl_declaration_AttributeSpecification: "declaration_vhdl_MultiName" = None, vhdl_declaration_AttributeSpecification235: "Expression" = None):
        self.class_ = class_
...
class vhdl_declaration_SubprogramDeclaration(Named, declaration_Declaration):
    ...
    pass
class vhdl_declaration_SubnatureDeclaration(Named, nature_Natured, declaration_Declaration):
...
class vhdl_declaration_AttributeDeclaration(type_Typed, Named, declaration_Declaration):
...
class vhdl_declaration_AliasDeclaration(Named, declaration_Declaration):
    ...
    pass
class vhdl_expression_SubtypeIndicationExpression(Named, expression_IndicationExpression, type_TypeReference):
...
class Configuration:
    ...
    pass
class vhdl_configuration_ConfigurationResolvedReference(VhdlObject, configuration_ConfigurationReference):
...
class configuration_ConfigurationItem:
    ...
    pass
class vhdl_configuration_BlockConfiguration(Named, configuration_ConfigurationItem):
