...
UML_Element.attributes={UML_Element_name, UML_Element_visibility}
...
class_20: BinaryAssociation = BinaryAssociation(
    name="class_20",
    ends={
...
domain_model = DomainModel(
    name="UML",
    types={UML_Element, UML_PackageableElement, Element, UML_Package, PackageableElement, UML_Model, Package, UML_TypedElement, UML_LiteralInteger, UML_LiteralUnlimitedNatural, UML_PrimitiveType, UML_Attribute, TypedElement, UML_Operation, UML_Class, UML_Generalization, UML_TemplateBinding, Class_, UML_EnumerationLiteral, UML_Enumeration, UML_Property, Attribute, UML_Association, UML_Interface, UML_Parameter, UML_TemplateParameterSubstitution},
    associations={packagedElement0, type1, lowerValue3, upperValue5, ownedParameter19, class_20, interface22, ownedAttribute25, ownedOperation27, generalization30, templateBinding32, nestedClassifier35, classifier37, association7, qualifier9, owningAssociation11, associationEnd14, interface17, ownedEnd53, actual56, templateBinding58, parameterSubstitution61, boundElement64, enumeration38, ownedLiteral41, general44, specific47, memberEnd50},
    generalizations={gen_UML_PackageableElement_Element, gen_UML_Package_PackageableElement, gen_UML_Model_Package, gen_UML_TypedElement_Element, gen_UML_PrimitiveType_Package, gen_UML_LiteralInteger_Package, gen_UML_LiteralUnlimitedNatural_Package, gen_UML_Operation_Package, gen_UML_Class_Package, gen_UML_Interface_Class, gen_UML_EnumerationLiteral_Package, gen_UML_Attribute_TypedElement, gen_UML_Property_Attribute, gen_UML_Parameter_TypedElement, gen_UML_TemplateParameterSubstitution_Element, gen_UML_TemplateBinding_Element, gen_UML_Enumeration_Class, gen_UML_Generalization_Element, gen_UML_Association_Package},
    metadata=None
)
