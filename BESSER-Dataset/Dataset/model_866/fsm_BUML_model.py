...
fsm_Transition.attributes={fsm_Transition_Effect, fsm_Transition_Guard}
...
domain_model = DomainModel(
    name="fsm",
    types={SuperState, fsm_Action, fsm_eAction, fsm_SteadyState, State, fsm_TransientState, fsm_Transition, fsm_SuperState, fsm_FSM, fsm_State, fsm_InitialState},
    associations={entry3, exit5, target7, source9, state0, intialState1, src11, outTrans12},
