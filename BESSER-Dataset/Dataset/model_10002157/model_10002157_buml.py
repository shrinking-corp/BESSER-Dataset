...
Customer.attributes={Customer_Name, Customer_Password}
...
Online_pizza_ordering.attributes={Online_pizza_ordering_Price, Online_pizza_ordering_Ingredients, Online_pizza_ordering_pizza_type}
...
Menu.attributes={Menu_toppings, Menu_Quantity}
...
assoc__P_v3o5fqEeqEM7mFKilpXw: BinaryAssociation = BinaryAssociation(
    name="assoc__P_v3o5fqEeqEM7mFKilpXw",
    ends={
...
assoc__P_v3tJfqEeqEM7mFKilpXw: BinaryAssociation = BinaryAssociation(
    name="assoc__P_v3tJfqEeqEM7mFKilpXw",
    ends={
...
assoc__P_v305fqEeqEM7mFKilpXw: BinaryAssociation = BinaryAssociation(
    name="assoc__P_v305fqEeqEM7mFKilpXw",
    ends={
...
domain_model = DomainModel(
    ...
    associations={Registered_User_Search_store_locations, Registered_User_View_side_orders, Registered_User_View_Pizza_types, Registered_User_Select_Meal_Deal, Registered_User_Checkout, Registered_User_Create_your_own_pizza, Registered_User_Order_tracking, Receive_order_Pizza_Chef, Delivery_person_Receive_order, Edit_menu_Admin, Manage_accounts_Admin, Registered_User_Pre_order, Registered_User_Create_Account, Registered_User_Sign_In, Customer_Online_pizza_ordering, assoc__P_v3o5fqEeqEM7mFKilpXw, assoc__P_v3tJfqEeqEM7mFKilpXw, assoc__P_v305fqEeqEM7mFKilpXw, Registered_User_Save_favourite_order},
    generalizations={},
    metadata=None
)
