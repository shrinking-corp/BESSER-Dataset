...
# Classes
mathInterpreter_Solution = Class(name="mathInterpreter_Solution")
mathInterpreter_Variable = Class(name="mathInterpreter_Variable")
mathInterpreter_Expression = Class(name="mathInterpreter_Expression")
mathInterpreter_PlusOrMinus = Class(name="mathInterpreter_PlusOrMinus")
mathInterpreter_EObject = Class(name="mathInterpreter_EObject")
mathInterpreter_MultiplyOrDivide = Class(name="mathInterpreter_MultiplyOrDivide")
...
mathInterpreter_Num = Class(name="mathInterpreter_Num")
Primary = Class(name="Primary")
mathInterpreter_VariableRef = Class(name="mathInterpreter_VariableRef")
mathInterpreter_Bracket = Class(name="mathInterpreter_Bracket")
...
domain_model = DomainModel(
    ...
    types={mathInterpreter_Solution, mathInterpreter_Variable, mathInterpreter_Expression, mathInterpreter_PlusOrMinus, mathInterpreter_EObject, mathInterpreter_MultiplyOrDivide, mathInterpreter_Primary, mathInterpreter_Plus, PlusOrMinus, mathInterpreter_Minus, mathInterpreter_Multiply, MultiplyOrDivide, mathInterpreter_Divide, mathInterpreter_Num, Primary, mathInterpreter_VariableRef, mathInterpreter_Bracket},
    associations={variables0, expression1, value3, value19, exp6, left8, right10, left12, right15, value17},
    generalizations={gen_mathInterpreter_Plus_PlusOrMinus, gen_mathInterpreter_Minus_PlusOrMinus, gen_mathInterpreter_Multiply_MultiplyOrDivide, gen_mathInterpreter_Divide_MultiplyOrDivide, gen_mathInterpreter_Num_Primary, gen_mathInterpreter_VariableRef_Primary, gen_mathInterpreter_Bracket_Primary},
    metadata=None
)
