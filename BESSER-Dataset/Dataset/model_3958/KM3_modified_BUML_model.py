...
KM3_TypedElement.attributes={KM3_TypedElement_isUnique, KM3_TypedElement_upper, KM3_TypedElement_isOrdered, KM3_TypedElement_lower}
...
domain_model = DomainModel(
    name="KM3",
    types={KM3_EnumLiteral, KM3_TemplateParameter, KM3_Class, KM3_StructuralFeature, KM3_Operation, KM3_TypedElement, KM3_LocatedElement, TypedElement, KM3_ModelElement, LocatedElement, KM3_Classifier, ModelElement, KM3_DataType, Classifier, KM3_Enumeration, KM3_Parameter, KM3_Package, KM3_Metamodel, KM3_Attribute, StructuralFeature, KM3_Reference},
    associations={literals0, enum1, parameters2, supertypes4, structuralFeatures6, operations7, type9, owner10, subsetOf12, opposite18, owner19, parameters21, owner23, contents25, metamodel26, derivedFrom15, contents27},
    generalizations={gen_KM3_EnumLiteral_ModelElement, gen_KM3_TemplateParameter_Classifier, gen_KM3_Class_Classifier, gen_KM3_TypedElement_ModelElement, gen_KM3_StructuralFeature_TypedElement, gen_KM3_ModelElement_LocatedElement, gen_KM3_Classifier_ModelElement, gen_KM3_DataType_Classifier, gen_KM3_Enumeration_Classifier, gen_KM3_Reference_StructuralFeature, gen_KM3_Operation_TypedElement, gen_KM3_Parameter_TypedElement, gen_KM3_Package_ModelElement, gen_KM3_Attribute_StructuralFeature, gen_KM3_Metamodel_LocatedElement},
    metadata=None
)
