...
class KM3_TypedElement(ModelElement):
    ...
    def __init__(self, lower: str, upper: str, isOrdered: str, isUnique: str, KM3_TypedElement: "KM3_Classifier" = None):
        self.lower = lower
        self.upper = upper
...
class KM3_Class(Classifier):
    ...
    def __init__(self, isAbstract: str, KM3_Class: set["KM3_TemplateParameter"] = None, KM3_Class5: "KM3_Class" = None, KM3_Class3: set["KM3_Class"] = None, owner: set["KM3_StructuralFeature"] = None, owner8: set["KM3_Operation"] = None, Class: "KM3_StructuralFeature" = None, Class20: "KM3_Operation" = None):
