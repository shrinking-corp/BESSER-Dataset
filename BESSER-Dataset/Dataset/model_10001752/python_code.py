...
class Leave:
    ...
    def __init__(self, leave_id: str, date: str, from1: str, to: str, leave_type: str, employee10: "Employee" = None):
...
class Employee:
    ...
    def __init__(self, fname: str, lname: str, address: str, email: str, phone: int, DOB: str, attendance_count: int, emp_id: str, section6: set["Section"] = None, attendance8: "Attendance" = None, leave11: "Leave" = None, salary16: "Salary" = None):
        self.fname = fname
        self.lname = lname
...
class Items:
    ...
    def __init__(self, item_id: str, item_code: str, description: str, re_order_qty: str, unit_of_measure: str, price_per_unit: str, stock3: set["Stock"] = None, orders5: set["Orders"] = None):
        self.item_id = item_id
        self.item_code = item_code
        self.description = description
...
class Orders:
    ...
    def __init__(self, order_id: str, item_id: str, Quantity: str, order_date: str, status: str, recieved_date: str, price_per_unit: str, total_amount: str, supplier1: set["Supplier"] = None, items4: set["Items"] = None, administrator13: "Administrator" = None):
