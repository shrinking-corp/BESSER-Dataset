...
class sgraph_Region(NamedElement):
    ...
    def __init__(self, priority: int, parentRegion: set["sgraph_Vertex"] = None, Region: "sgraph_Vertex" = None, sgraph_Region: "sgraph_Statechart" = None, sgraph_Region26: "sgraph_State" = None):
        self.priority = priority
...
class sgraph_Statechart(NamedElement, ExpressionElement, ScopedElement, ReactiveElement):
...
class Vertex:
    ...
    pass
class sgraph_State(ExpressionElement, Vertex, ScopedElement, ReactiveElement):

    def __init__(self, composite: bool, leaf: bool, orthogonal: bool, submachine: bool, simple: bool, sgraph_State28: "sgraph_Statechart" = None, sgraph_State: set["sgraph_Region"] = None):
