...
sgraph_State.attributes={sgraph_State_orthogonal, sgraph_State_composite, sgraph_State_leaf, sgraph_State_simple, sgraph_State_submachine}
...
domain_model = DomainModel(
    name="sgraph",
    types={sgraph_Pseudostate, Vertex, sgraph_Vertex, NamedElement, sgraph_Region, sgraph_Transition, sgraph_NamedElement, sgraph_FinalState, sgraph_Variable, Declaration, sgraph_Junction, ExpressionElement, Reaction, sgraph_Trigger, sgraph_Effect, sgraph_ExpressionElement, sgraph_Declaration, Pseudostate, sgraph_Event, sgraph_Choice, sgraph_Statechart, ReactiveElement, ScopedElement, sgraph_Entry, sgraph_Exit, sgraph_Reaction, sgraph_ReactiveElement, sgraph_Synchronization, sgraph_State, sgraph_Scope, sgraph_ScopedElement, sgraph_Statement, EntryKind},
    associations={vertices4, parentRegion0, incomingTransitions1, outgoingTransitions2, target5, source7, regions9, localReactions15, trigger10, effect11, reactions13, scopes23, declarations18, events19, variables21, subRegions25, substatechart27},
    generalizations={gen_sgraph_Pseudostate_Vertex, gen_sgraph_Region_NamedElement, gen_sgraph_Vertex_NamedElement, gen_sgraph_FinalState_Vertex, gen_sgraph_Variable_Declaration, gen_sgraph_Transition_ExpressionElement, gen_sgraph_Transition_Reaction, gen_sgraph_Declaration_NamedElement, gen_sgraph_Junction_Pseudostate, gen_sgraph_Event_Declaration, gen_sgraph_Choice_Pseudostate, gen_sgraph_Statechart_NamedElement, gen_sgraph_Statechart_ExpressionElement, gen_sgraph_Statechart_ReactiveElement, gen_sgraph_Statechart_ScopedElement, gen_sgraph_Entry_Pseudostate, gen_sgraph_Exit_Pseudostate, gen_sgraph_Synchronization_Pseudostate, gen_sgraph_State_Vertex, gen_sgraph_State_ExpressionElement, gen_sgraph_State_ReactiveElement, gen_sgraph_State_ScopedElement},
    metadata=None
)
