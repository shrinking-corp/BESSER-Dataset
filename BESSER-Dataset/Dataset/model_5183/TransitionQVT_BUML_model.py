...
# Classes
TransitionQVT_Root = Class(name="TransitionQVT_Root")
TransitionQVT_Element = Class(name="TransitionQVT_Element", is_abstract=True)
TransitionQVT_A = Class(name="TransitionQVT_A")
Element = Class(name="Element")
TransitionQVT_B = Class(name="TransitionQVT_B")
TransitionQVT_C = Class(name="TransitionQVT_C")
...
domain_model = DomainModel(
    name="TransitionQVT",
    types={TransitionQVT_Root, TransitionQVT_Element, TransitionQVT_A, Element, TransitionQVT_B, TransitionQVT_C},
