...
class uml2rdbms_PrimitiveToName:
    ...
    def __init__(self, name: str, typeName: str, uml2rdbms_PrimitiveToName: "uml2rdbms_AttributeToColumn" = None, uml2rdbms_PrimitiveToName33: "uml2rdbms_PrimitiveDataType" = None, PrimitiveToName: "uml2rdbms_PackageToSchema" = None, primitivesToNames: "uml2rdbms_PackageToSchema" = None):
        self.name = name
