...
# Classes
manypov_A = Class(name="manypov_A")
Named = Class(name="Named")
manypov_B = Class(name="manypov_B")
manypov_E = Class(name="manypov_E")
manypov_J = Class(name="manypov_J")
manypov_Named = Class(name="manypov_Named")
manypov_F = Class(name="manypov_F")
manypov_JK = Class(name="manypov_JK")
manypov_K = Class(name="manypov_K")
manypov_M = Class(name="manypov_M")
manypov_C = Class(name="manypov_C")
...
domain_model = DomainModel(
    name="manypov",
    types={manypov_A, Named, manypov_B, manypov_E, manypov_J, manypov_Named, manypov_F, manypov_JK, manypov_K, manypov_M, manypov_C},
    associations={bs0, es1, js3, cs5, fs7, jks9, ms11, cs12, ks15},
    generalizations={gen_manypov_A_Named, gen_manypov_C_Named, gen_manypov_E_Named, gen_manypov_F_Named, gen_manypov_J_Named, gen_manypov_K_Named, gen_manypov_JK_Named, gen_manypov_M_Named, gen_manypov_B_Named},
    metadata=None
)
