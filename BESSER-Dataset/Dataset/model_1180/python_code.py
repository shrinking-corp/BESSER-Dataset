...
class gbind_simpleocl_LocalVariable(VariableDeclaration):
    ...
    def __init__(self, eq: str, result: "IterateExp" = None, variable: "LetExp" = None, initializedVariable: "OclExpression" = None, VariableDeclaration: "gbind_simpleocl_VariableExp" = None, VariableDeclaration105: "gbind_simpleocl_OclType" = None):
        self.eq = eq
        self.result = result
...
class gbind_simpleocl_OperatorCallExp(OclExpression):
    ...
    def __init__(self, operationName: str, gbind_simpleocl_OperatorCallExp: "OclExpression" = None, appliedOperator: "OclExpression" = None, OclExpression72: "gbind_simpleocl_IfExp" = None, OclExpression74: "gbind_simpleocl_IfExp" = None, OclExpression81: "gbind_simpleocl_LocalVariable" = None, OclExpression68: "gbind_simpleocl_LetExp" = None, OclExpression218: "gbind_dsl_BaseHelper" = None, OclExpression58: "gbind_simpleocl_BraceExp" = None, OclExpression37: "gbind_simpleocl_MapElement" = None, OclExpression52: "gbind_simpleocl_OperatorCallExp" = None, OclExpression46: "gbind_simpleocl_PropertyCallExp" = None, OclExpression: "gbind_simpleocl_CollectionExp" = None, OclExpression179: "gbind_dsl_ClassBinding" = None, OclExpression60: "gbind_simpleocl_LoopExp" = None, OclExpression216: "gbind_dsl_OclFeatureBinding" = None, OclExpression91: "gbind_simpleocl_OclType" = None, OclExpression34: "gbind_simpleocl_MapElement" = None, OclExpression149: "gbind_simpleocl_Operation" = None, OclExpression54: "gbind_simpleocl_OperatorCallExp" = None, OclExpression70: "gbind_simpleocl_IfExp" = None, OclExpression141: "gbind_simpleocl_Attribute" = None, OclExpression50: "gbind_simpleocl_OperationCall" = None, OclExpression56: "gbind_simpleocl_LambdaCallExp" = None, OclExpression197: "gbind_dsl_VirtualMetaclass" = None, OclExpression43: "gbind_simpleocl_StaticOperationCall" = None):
        self.operationName = operationName
...
class gbind_dsl_MetamodelDeclaration(OclMetamodel):
    ...
    def __init__(self, metamodelURI: str, OclMetamodel154: "gbind_simpleocl_OclInstanceModel" = None, OclMetamodel: "gbind_simpleocl_Module" = None):
...
class gbind_dsl_BindingModel:
    ...
    def __init__(self, name: str, model_: set["ConceptBinding"] = None, model_157: set["BaseHelper"] = None, gbind_dsl_BindingModel: set["ConceptMetaclass"] = None, gbind_dsl_BindingModel160: set["ConcreteMetaclass"] = None, gbind_dsl_BindingModel162: set["VirtualMetaclass"] = None, gbind_dsl_BindingModel164: "MetamodelDeclaration" = None, gbind_dsl_BindingModel166: "MetamodelDeclaration" = None, gbind_dsl_BindingModel169: "BindingOptions" = None):
        self.name = name
...
class gbind_simpleocl_OclFeatureDefinition(ModuleElement):
    ...
    def __init__(self, static: str, definition132: "OclContextDefinition" = None, definition: "OclFeature" = None, ModuleElement: "gbind_simpleocl_Module" = None):
        self.static = static
