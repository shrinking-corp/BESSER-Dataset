...
# Classes
Measure_RootMeasureSet = Class(name="Measure_RootMeasureSet")
Measure_Category = Class(name="Measure_Category")
Measure_MeasureSet = Class(name="Measure_MeasureSet")
Measure_Metric = Class(name="Measure_Metric")
Measure_Measure = Class(name="Measure_Measure", is_abstract=True)
Measure_IntegerMeasure = Class(name="Measure_IntegerMeasure")
Measure = Class(name="Measure")
Measure_DoubleMeasure = Class(name="Measure_DoubleMeasure")
Measure_PercentageMeasure = Class(name="Measure_PercentageMeasure")
...
Measure_Metric.attributes={Measure_Metric_desc, Measure_Metric_name, Measure_Metric_preferredValue}
