...
domain_model = DomainModel(
    ...
    types={simpleExpressions_MethodCall, simpleExpressions_OrExpression, simpleExpressions_AndExpression, simpleExpressions_IfCondition, simpleExpressions_Expression, simpleExpressions_NumberLiteral, Expression, simpleExpressions_Comparison, simpleExpressions_NotExpression},
    associations={left1, right3, condition0, left6, right8, left11, right13, expression16},
    generalizations={gen_simpleExpressions_NumberLiteral_Expression, gen_simpleExpressions_MethodCall_Expression, gen_simpleExpressions_OrExpression_Expression, gen_simpleExpressions_AndExpression_Expression, gen_simpleExpressions_Comparison_Expression, gen_simpleExpressions_NotExpression_Expression},
    metadata=None
)
