...
# Classes
dsml_web_Website = Class(name="dsml_web_Website")
Page = Class(name="Page")
dsml_web_PasswordField = Class(name="dsml_web_PasswordField")
dsml_web_Label = Class(name="dsml_web_Label")
dsml_web_Button = Class(name="dsml_web_Button", is_abstract=True)
dsml_web_RadioButton = Class(name="dsml_web_RadioButton")
ListField = Class(name="ListField")
dsml_web_CheckBox = Class(name="dsml_web_CheckBox")
dsml_web_SubmitButton = Class(name="dsml_web_SubmitButton")
Button = Class(name="Button")
dsml_web_CancelButton = Class(name="dsml_web_CancelButton")
dsml_web_Item = Class(name="dsml_web_Item")
dsml_web_Select = Class(name="dsml_web_Select")
dsml_web_Page = Class(name="dsml_web_Page")
Form = Class(name="Form")
Text = Class(name="Text")
Link = Class(name="Link")
dsml_web_Field = Class(name="dsml_web_Field", is_abstract=True)
FormElement = Class(name="FormElement")
Validator = Class(name="Validator")
dsml_web_TextField = Class(name="dsml_web_TextField")
Field = Class(name="Field")
dsml_web_Hidden = Class(name="dsml_web_Hidden")
dsml_web_Form = Class(name="dsml_web_Form")
Success = Class(name="Success")
Error = Class(name="Error")
dsml_web_Text = Class(name="dsml_web_Text")
dsml_web_ListField = Class(name="dsml_web_ListField", is_abstract=True)
Item = Class(name="Item")
dsml_web_TextArea = Class(name="dsml_web_TextArea")
dsml_web_ResetButton = Class(name="dsml_web_ResetButton")
dsml_web_Link = Class(name="dsml_web_Link")
dsml_web_FormElement = Class(name="dsml_web_FormElement", is_abstract=True)
dsml_web_RegexValidator = Class(name="dsml_web_RegexValidator")
dsml_web_StringLengthValidator = Class(name="dsml_web_StringLengthValidator")
dsml_web_Success = Class(name="dsml_web_Success")
dsml_web_Error = Class(name="dsml_web_Error")
dsml_web_Validator = Class(name="dsml_web_Validator", is_abstract=True)
dsml_web_DateValidator = Class(name="dsml_web_DateValidator")
dsml_web_EmailValidator = Class(name="dsml_web_EmailValidator")
dsml_web_Required = Class(name="dsml_web_Required")
dsml_web_TimeValidator = Class(name="dsml_web_TimeValidator")
dsml_web_URLValidator = Class(name="dsml_web_URLValidator")
dsml_web_TypeValidator = Class(name="dsml_web_TypeValidator")
dsml_web_GreaterThanValidator = Class(name="dsml_web_GreaterThanValidator")
dsml_web_LessThanValidator = Class(name="dsml_web_LessThanValidator")
dsml_web_BetweenValidator = Class(name="dsml_web_BetweenValidator")
dsml_visitor_JSPVisitor = Class(name="dsml_visitor_JSPVisitor")
Visitor = Class(name="Visitor")
dsml_visitor_Visitor = Class(name="dsml_visitor_Visitor", is_abstract=True)
dsml_visitor_ResourceVisitor = Class(name="dsml_visitor_ResourceVisitor")
dsml_visitor_POJOVisitor = Class(name="dsml_visitor_POJOVisitor")
...
dsml_web_PasswordField.attributes={dsml_web_PasswordField_maxlength, dsml_web_PasswordField_size}
...
dsml_web_Form_m_accept: Method = Method(name="accept", parameters={Parameter(name='dsml_visitor', type=StringType)}, type=StringType)
...
dsml_web_Text_m_accept: Method = Method(name="accept", parameters={Parameter(name='dsml_visitor', type=StringType)}, type=StringType)
...
dsml_web_Link_m_accept: Method = Method(name="accept", parameters={Parameter(name='dsml_visitor', type=StringType)}, type=StringType)
...
dsml_web_FormElement_m_accept: Method = Method(name="accept", parameters={Parameter(name='dsml_visitor', type=StringType)}, type=StringType)
...
dsml_web_Validator_m_accept: Method = Method(name="accept", parameters={Parameter(name='dsml_visitor', type=StringType)}, type=StringType)
...
domain_model = DomainModel(
    name="dsml",
    types={dsml_web_Website, Page, dsml_web_PasswordField, dsml_web_Label, dsml_web_Button, dsml_web_RadioButton, ListField, dsml_web_CheckBox, dsml_web_SubmitButton, Button, dsml_web_CancelButton, dsml_web_Item, dsml_web_Select, dsml_web_Page, Form, Text, Link, dsml_web_Field, FormElement, Validator, dsml_web_TextField, Field, dsml_web_Hidden, dsml_web_Form, Success, Error, dsml_web_Text, dsml_web_ListField, Item, dsml_web_TextArea, dsml_web_ResetButton, dsml_web_Link, dsml_web_FormElement, dsml_web_RegexValidator, dsml_web_StringLengthValidator, dsml_web_Success, dsml_web_Error, dsml_web_Validator, dsml_web_DateValidator, dsml_web_EmailValidator, dsml_web_Required, dsml_web_TimeValidator, dsml_web_URLValidator, dsml_web_TypeValidator, dsml_web_GreaterThanValidator, dsml_web_LessThanValidator, dsml_web_BetweenValidator, dsml_visitor_JSPVisitor, Visitor, dsml_visitor_Visitor, dsml_visitor_ResourceVisitor, dsml_visitor_POJOVisitor, Type},
    associations={Pages0, Form1, Texts2, Links4, Validator6, FormElements10, Success11, Error13, Items7, LinkedPage8, SuccessPage15, ErrorPage17},
    generalizations={gen_dsml_web_PasswordField_Field, gen_dsml_web_Label_FormElement, gen_dsml_web_Button_FormElement, gen_dsml_web_RadioButton_ListField, gen_dsml_web_CheckBox_FormElement, gen_dsml_web_SubmitButton_Button, gen_dsml_web_CancelButton_Button, gen_dsml_web_Select_ListField, gen_dsml_web_Field_FormElement, gen_dsml_web_TextField_Field, gen_dsml_web_Hidden_FormElement, gen_dsml_web_ListField_FormElement, gen_dsml_web_TextArea_Field, gen_dsml_web_ResetButton_Button, gen_dsml_web_RegexValidator_Validator, gen_dsml_web_StringLengthValidator_Validator, gen_dsml_web_DateValidator_Validator, gen_dsml_web_EmailValidator_Validator, gen_dsml_web_Required_Validator, gen_dsml_web_TimeValidator_Validator, gen_dsml_web_URLValidator_Validator, gen_dsml_web_TypeValidator_Validator, gen_dsml_web_GreaterThanValidator_Validator, gen_dsml_web_LessThanValidator_Validator, gen_dsml_web_BetweenValidator_Validator, gen_dsml_visitor_JSPVisitor_Visitor, gen_dsml_visitor_ResourceVisitor_Visitor, gen_dsml_visitor_POJOVisitor_Visitor},
    metadata=None
)
