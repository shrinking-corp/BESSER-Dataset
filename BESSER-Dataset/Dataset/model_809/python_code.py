...
class fsm_Transition(NamedElement):
    ...
    def __init__(self, input: str, output: str, Transition: "fsm_State" = None, fsm_Transition: "fsm_StateMachine" = None, Transition7: "fsm_State" = None, outgoingTransitions: "fsm_State" = None, incomingTransitions: "fsm_State" = None):
        self.input = input
        self.output = output
