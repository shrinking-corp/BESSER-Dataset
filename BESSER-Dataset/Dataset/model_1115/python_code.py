...
class statechart_Node:
    ...
    def __init__(self, name: str, label: str, type: str, activity: str, actions: str, metadata: str, statechart_Node: "statechart_Model" = None, statechart_Node6: set["statechart_Variable"] = None, Node: "statechart_Node" = None, Father: set["statechart_Node"] = None, Node12: "statechart_Node" = None, Children: "statechart_Node" = None, statechart_Node15: "statechart_Transition" = None, statechart_Node18: "statechart_Transition" = None):
        self.name = name
        self.label = label
        self.type = type
