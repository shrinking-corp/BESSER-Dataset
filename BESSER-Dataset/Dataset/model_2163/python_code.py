...
class dependencies_RightTerm(Term):
    ...
    def __init__(self, value: str, dependencies_RightTerm28: "dependencies_Operation" = None, dependencies_RightTerm: "dependencies_Edge" = None, dependencies_RightTerm30: set["dependencies_SimpleTerm"] = None, dependencies_RightTerm34: "dependencies_Operation" = None):
        self.value = value
...
class dependencies_Edge:
    ...
    def __init__(self, referredTo: bool, equal: bool, dependencies_Edge: "dependencies_Vertex" = None, dependencies_Edge18: "dependencies_SimpleTerm" = None, dependencies_Edge20: "dependencies_RightTerm" = None):
