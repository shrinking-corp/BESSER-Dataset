...
def test_hyp_dependencies_namedelement_is_not_abstract():
    assert not inspect.isabstract(dependencies_NamedElement)


def test_hyp_dependencies_namedelement_constructor_exists():
    assert callable(dependencies_NamedElement.__init__)


def test_hyp_dependencies_namedelement_constructor_args():
...
def test_hyp_dependencies_term_is_not_abstract():
    assert not inspect.isabstract(dependencies_Term)


def test_hyp_dependencies_term_constructor_exists():
    assert callable(dependencies_Term.__init__)


def test_hyp_dependencies_term_constructor_args():
    sig = inspect.signature(dependencies_Term.__init__)
    params = list(sig.parameters.keys())



def test_hyp_dependencies_rightterm_is_not_abstract():
    assert not inspect.isabstract(dependencies_RightTerm)


def test_hyp_dependencies_rightterm_constructor_exists():
    assert callable(dependencies_RightTerm.__init__)


def test_hyp_dependencies_rightterm_constructor_args():
...
def test_hyp_dependencies_simpleterm_is_not_abstract():
    assert not inspect.isabstract(dependencies_SimpleTerm)


def test_hyp_dependencies_simpleterm_constructor_exists():
    assert callable(dependencies_SimpleTerm.__init__)


def test_hyp_dependencies_simpleterm_constructor_args():
    sig = inspect.signature(dependencies_SimpleTerm.__init__)
    params = list(sig.parameters.keys())



def test_hyp_dependencies_edge_is_not_abstract():
    assert not inspect.isabstract(dependencies_Edge)


def test_hyp_dependencies_edge_constructor_exists():
    assert callable(dependencies_Edge.__init__)


def test_hyp_dependencies_edge_constructor_args():
...
def test_hyp_dependencies_vertex_is_not_abstract():
    assert not inspect.isabstract(dependencies_Vertex)


def test_hyp_dependencies_vertex_constructor_exists():
    assert callable(dependencies_Vertex.__init__)


def test_hyp_dependencies_vertex_constructor_args():
    sig = inspect.signature(dependencies_Vertex.__init__)
    params = list(sig.parameters.keys())



def test_hyp_dependencies_eclass_is_not_abstract():
    assert not inspect.isabstract(dependencies_EClass)


def test_hyp_dependencies_eclass_constructor_exists():
    assert callable(dependencies_EClass.__init__)


def test_hyp_dependencies_eclass_constructor_args():
...
def test_hyp_dependencies_block_is_not_abstract():
    assert not inspect.isabstract(dependencies_Block)


def test_hyp_dependencies_block_constructor_exists():
    assert callable(dependencies_Block.__init__)


def test_hyp_dependencies_block_constructor_args():
    sig = inspect.signature(dependencies_Block.__init__)
    params = list(sig.parameters.keys())



def test_hyp_dependencies_rcpackage_is_not_abstract():
    assert not inspect.isabstract(dependencies_RCPackage)


def test_hyp_dependencies_rcpackage_constructor_exists():
    assert callable(dependencies_RCPackage.__init__)


def test_hyp_dependencies_rcpackage_constructor_args():
    sig = inspect.signature(dependencies_RCPackage.__init__)
    params = list(sig.parameters.keys())



def test_hyp_dependencies_create_is_not_abstract():
    assert not inspect.isabstract(dependencies_Create)


def test_hyp_dependencies_create_constructor_exists():
    assert callable(dependencies_Create.__init__)


def test_hyp_dependencies_create_constructor_args():
    sig = inspect.signature(dependencies_Create.__init__)
    params = list(sig.parameters.keys())



def test_hyp_dependencies_semirequired_is_not_abstract():
    assert not inspect.isabstract(dependencies_SemiRequired)


def test_hyp_dependencies_semirequired_constructor_exists():
    assert callable(dependencies_SemiRequired.__init__)


def test_hyp_dependencies_semirequired_constructor_args():
    sig = inspect.signature(dependencies_SemiRequired.__init__)
    params = list(sig.parameters.keys())



def test_hyp_dependencies_operation_is_not_abstract():
    assert not inspect.isabstract(dependencies_Operation)


def test_hyp_dependencies_operation_constructor_exists():
    assert callable(dependencies_Operation.__init__)


def test_hyp_dependencies_operation_constructor_args():
...
def test_hyp_dependencies_equivalence_is_not_abstract():
    assert not inspect.isabstract(dependencies_Equivalence)


def test_hyp_dependencies_equivalence_constructor_exists():
    assert callable(dependencies_Equivalence.__init__)


def test_hyp_dependencies_equivalence_constructor_args():
...
def test_hyp_dependencies_coreclass_is_not_abstract():
    assert not inspect.isabstract(dependencies_CoreClass)


def test_hyp_dependencies_coreclass_constructor_exists():
    assert callable(dependencies_CoreClass.__init__)


def test_hyp_dependencies_coreclass_constructor_args():
    sig = inspect.signature(dependencies_CoreClass.__init__)
    params = list(sig.parameters.keys())



def test_hyp_dependencies_domain_is_not_abstract():
    assert not inspect.isabstract(dependencies_Domain)


def test_hyp_dependencies_domain_constructor_exists():
    assert callable(dependencies_Domain.__init__)


def test_hyp_dependencies_domain_constructor_args():
    sig = inspect.signature(dependencies_Domain.__init__)
    params = list(sig.parameters.keys())



def test_hyp_dependencies_graph_is_not_abstract():
    assert not inspect.isabstract(dependencies_Graph)


def test_hyp_dependencies_graph_constructor_exists():
    assert callable(dependencies_Graph.__init__)


def test_hyp_dependencies_graph_constructor_args():
...
def test_hyp_dependencies_required_is_not_abstract():
    assert not inspect.isabstract(dependencies_Required)


def test_hyp_dependencies_required_constructor_exists():
    assert callable(dependencies_Required.__init__)


def test_hyp_dependencies_required_constructor_args():
    sig = inspect.signature(dependencies_Required.__init__)
    params = list(sig.parameters.keys())



def test_hyp_dependencies_epackage_is_not_abstract():
    assert not inspect.isabstract(dependencies_EPackage)


def test_hyp_dependencies_epackage_constructor_exists():
    assert callable(dependencies_EPackage.__init__)


def test_hyp_dependencies_epackage_constructor_args():
...
def test_hyp_dependencies_namedelement_name_setter(instance):
...
def test_hyp_dependencies_rightterm_value_setter(instance):
...
def test_hyp_dependencies_edge_referredTo_setter(instance):
...
@given(instance=dependencies_Edge_strategy)
def test_hyp_dependencies_edge_equal_setter(instance):
...
def test_hyp_dependencies_operation_operationType_setter(instance):
...
def test_hyp_dependencies_graph_priority_setter(instance):
