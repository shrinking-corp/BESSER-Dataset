...
# Classes
cascadenotall_Book = Class(name="cascadenotall_Book")
cascadenotall_Writer = Class(name="cascadenotall_Writer")
cascadenotall_Library = Class(name="cascadenotall_Library")
...
cascadenotall_Book.attributes={cascadenotall_Book_pages, cascadenotall_Book_category, cascadenotall_Book_title}
