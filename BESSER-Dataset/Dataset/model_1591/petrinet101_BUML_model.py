...
# Classes
petrinet101_Petrinet = Class(name="petrinet101_Petrinet")
petrinet101_Node = Class(name="petrinet101_Node", is_abstract=True)
petrinet101_Arc = Class(name="petrinet101_Arc")
petrinet101_Place = Class(name="petrinet101_Place")
Node = Class(name="Node")
petrinet101_Token = Class(name="petrinet101_Token")
petrinet101_Transition = Class(name="petrinet101_Transition")
...
domain_model = DomainModel(
    name="petrinet101",
    types={petrinet101_Petrinet, petrinet101_Node, petrinet101_Arc, petrinet101_Place, Node, petrinet101_Token, petrinet101_Transition},
    associations={nodes0, arcs1, tokens3, source4, target7},
