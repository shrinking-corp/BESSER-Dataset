...
domainModel_PackageDecl = Class(name="domainModel_PackageDecl")
...
domain_model = DomainModel(
    name="domainModel",
    types={domainModel_Domainmodel, domainModel_AbstractElement, domainModel_PackageDecl, AbstractElement, domainModel_Import, domainModel_Type, domainModel_DataType, Type, domainModel_Entity, domainModel_Feature},
    associations={elements0, elements1, superType4, features5, type7},
    generalizations={gen_domainModel_PackageDecl_AbstractElement, gen_domainModel_Import_AbstractElement, gen_domainModel_Type_AbstractElement, gen_domainModel_DataType_Type, gen_domainModel_Entity_Type},
    metadata=None
)
