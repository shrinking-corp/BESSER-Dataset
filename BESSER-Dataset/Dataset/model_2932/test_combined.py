...
def test_hyp_domainmodel_packagedecl_is_not_abstract():
    assert not inspect.isabstract(domainModel_PackageDecl)


def test_hyp_domainmodel_packagedecl_constructor_exists():
    assert callable(domainModel_PackageDecl.__init__)


def test_hyp_domainmodel_packagedecl_constructor_args():
...
def test_hyp_domainmodel_packagedecl_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
