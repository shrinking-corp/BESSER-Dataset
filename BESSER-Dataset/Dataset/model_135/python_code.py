...
class simTL4J_simTL_TMethodStatementImpl(TAbstractMethodStatement):
    ...
    def __init__(self, caller: str, simTL4J_simTL_TMethodStatementImpl: set["TMethodCall"] = None, TAbstractMethodStatement: "simTL4J_simTL_TIf" = None, TAbstractMethodStatement177: "simTL4J_simTL_TPlaceholder" = None, TAbstractMethodStatement179: "simTL4J_simTL_TUnaryOperator" = None, TAbstractMethodStatement171: "simTL4J_simTL_TForVariable" = None):
        self.caller = caller
...
class types_TypedElement:
    ...
    pass
class simTL4J_expressions_InstanceOfExpression(expressions_EqualityExpressionChild, types_TypedElement, arrays_ArrayTypeable):
...
class simTL4J_simTL_TIf_MemberContainer(members_Member, simTL_TIf, members_MemberContainer):
    ...
    pass
class simTL4J_simTL_TFor_MemberContainer(members_Member, members_MemberContainer, simTL_TFor):
...
class classifiers_Classifier:
    ...
    pass
class simTL4J_classifiers_ConcreteClassifier(generics_TypeParametrizable, members_Member, members_MemberContainer, statements_Statement, modifiers_AnnotableAndModifiable, classifiers_Classifier):
...
class references_ReferenceableElement:
    ...
    pass
class simTL4J_containers_Package(references_ReferenceableElement, annotations_Annotable, containers_JavaRoot):

    pass
class simTL4J_variables_Variable(arrays_ArrayTypeable, generics_TypeArgumentable, types_TypedElement, commons_NamedElement, references_ReferenceableElement):
...
class references_Reference:
    ...
    pass
class simTL4J_instantiations_Instantiation(generics_TypeArgumentable, references_Reference, types_TypedElement, references_Argumentable):
...
class simTL4J_arrays_ArrayInstantiationBySize(expressions_Expression, references_Reference, types_TypedElement, arrays_ArrayTypeable):
    ...
    pass
class simTL4J_arrays_ArrayInstantiationByValues(expressions_Expression, arrays_ArrayTypeable, references_Reference, types_TypedElement):
...
class simTL4J_types_Type(Commentable):
    ...
    def __init__(self):
        ...
        pass
    def isSuperType(self, simTL4J_otherType, simTL4J_otherArrayType, simTL4J_arrayDimension) :
    ...
    def equalsType(self, simTL4J_otherType, simTL4J_otherArrayDimension, simTL4J_arrayDimension) :
...
class simTL4J_generics_TypeParameter(Classifier):
    ...
    def __init__(self, simTL4J_generics_TypeParameter: set["TypeReference"] = None, Classifier: "simTL4J_annotations_AnnotationInstance" = None, Classifier165: "simTL4J_types_ClassifierReference" = None):
    ...
    def getBoundType(self, simTL4J_reference, simTL4J_typeReference) :
...
class simTL4J_types_NamespaceClassifierReference(types_TypeReference, commons_NamespaceAwareElement):
    ...
    pass
class simTL4J_annotations_AnnotationInstance(modifiers_AnnotationInstanceOrModifier, references_Reference, commons_NamespaceAwareElement):

    pass
class simTL4J_containers_JavaRoot(imports_ImportingElement, commons_NamedElement, commons_NamespaceAwareElement):
...
class parameters_Parametrizable:
    ...
    pass
class simTL4J_members_Method(generics_TypeParametrizable, members_Member, arrays_ArrayTypeable, members_ExceptionThrower, modifiers_AnnotableAndModifiable, types_TypedElement, parameters_Parametrizable, references_ReferenceableElement):

    def __init__(self):
        
        pass
    def isMethodForCall(self, simTL4J_needsPerfectMatch, simTL4J_methodCall) :
        # TODO: Implement isMethodForCall method
        pass

    def isBetterMethodForCall(self, simTL4J_methodCall, simTL4J_otherMethod) :
...
class simTL4J_statements_SynchronizedBlock(statements_Statement, statements_StatementListContainer):
    ...
    pass
class simTL4J_simTL_TFor_StatementListContainer(statements_Statement, statements_StatementListContainer, simTL_TFor):

    pass
class simTL4J_statements_TryBlock(statements_Statement, statements_StatementListContainer):

    pass
class simTL4J_members_Constructor(generics_TypeParametrizable, members_Member, members_ExceptionThrower, modifiers_AnnotableAndModifiable, statements_StatementListContainer, parameters_Parametrizable):

    pass
class instantiations_Initializable:

    pass
class simTL4J_members_Field(members_Member, instantiations_Initializable, variables_Variable, modifiers_AnnotableAndModifiable, references_ReferenceableElement):

    pass
class simTL4J_variables_LocalVariable(instantiations_Initializable, variables_Variable, modifiers_AnnotableAndModifiable, statements_ForLoopInitializer):

    pass
class simTL4J_variables_AdditionalLocalVariable(instantiations_Initializable, references_ReferenceableElement, arrays_ArrayTypeable):
...
class simTL4J_members_AdditionalField(instantiations_Initializable, references_ReferenceableElement, arrays_ArrayTypeable):
