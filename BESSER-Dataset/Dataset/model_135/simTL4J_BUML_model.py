...
simTL4J_classifiers_ConcreteClassifier.methods={simTL4J_classifiers_ConcreteClassifier_m_getAllInnerClassifiers, simTL4J_classifiers_ConcreteClassifier_m_getInnerClassifiers, simTL4J_classifiers_ConcreteClassifier_m_getSuperTypeReferences, simTL4J_classifiers_ConcreteClassifier_m_getAllMembers}
...
simTL4J_classifiers_AnonymousClass.methods={simTL4J_classifiers_AnonymousClass_m_getAllMembers, simTL4J_classifiers_AnonymousClass_m_getAllSuperClassifiers, simTL4J_classifiers_AnonymousClass_m_getSuperClassifier}
...
simTL4J_commons_Commentable_m_getConcreteClassifiers: Method = Method(name="getConcreteClassifiers", parameters={Parameter(name='simTL4J_classifierQuery', type=StringType), Parameter(name='simTL4J_packageName', type=StringType)}, type=StringType)
...
simTL4J_commons_Commentable.methods={simTL4J_commons_Commentable_m_getClassClass, simTL4J_commons_Commentable_m_getContainingAnonymousClass, simTL4J_commons_Commentable_m_getObjectClass, simTL4J_commons_Commentable_m_getContainingCompilationUnit, simTL4J_commons_Commentable_m_getStringClass, simTL4J_commons_Commentable_m_getLibInterface, simTL4J_commons_Commentable_m_getContainingPackageName, simTL4J_commons_Commentable_m_getContainingAnnotationInstance, simTL4J_commons_Commentable_m_getParentConcreteClassifier, simTL4J_commons_Commentable_m_getConcreteClassifiers, simTL4J_commons_Commentable_m_getAnnotationInterface, simTL4J_commons_Commentable_m_getLibClass, simTL4J_commons_Commentable_m_getContainingConcreteClassifier, simTL4J_commons_Commentable_m_getConcreteClassifier}
...
simTL4J_expressions_Expression.methods={simTL4J_expressions_Expression_m_getOneType, simTL4J_expressions_Expression_m_getType, simTL4J_expressions_Expression_m_getAlternativeType, simTL4J_expressions_Expression_m_getArrayDimension}
...
simTL4J_generics_TypeParameter_m_getBoundType: Method = Method(name="getBoundType", parameters={Parameter(name='simTL4J_reference', type=StringType), Parameter(name='simTL4J_typeReference', type=StringType)}, type=StringType)
...
simTL4J_imports_Import.methods={simTL4J_imports_Import_m_getImportedClassifier, simTL4J_imports_Import_m_getImportedMembers, simTL4J_imports_Import_m_getImportedClassifiers}
...
simTL4J_members_Method_m_isMethodForCall: Method = Method(name="isMethodForCall", parameters={Parameter(name='simTL4J_needsPerfectMatch', type=StringType), Parameter(name='simTL4J_methodCall', type=StringType)}, type=BooleanType)
...
simTL4J_members_Method_m_isBetterMethodForCall: Method = Method(name="isBetterMethodForCall", parameters={Parameter(name='simTL4J_otherMethod', type=StringType), Parameter(name='simTL4J_methodCall', type=StringType)}, type=BooleanType)
...
simTL4J_types_Type_m_equalsType: Method = Method(name="equalsType", parameters={Parameter(name='simTL4J_arrayDimension', type=StringType), Parameter(name='simTL4J_otherArrayDimension', type=StringType), Parameter(name='simTL4J_otherType', type=StringType)}, type=BooleanType)
...
simTL4J_types_Type.methods={simTL4J_types_Type_m_isSuperType, simTL4J_types_Type_m_equalsType, simTL4J_types_Type_m_getAllMembers}
...
simTL4J_types_TypeReference.methods={simTL4J_types_TypeReference_m_getPureClassifierReference, simTL4J_types_TypeReference_m_getBoundTarget, simTL4J_types_TypeReference_m_getTarget}
...
simTL4J_simTL_TModelImport.attributes={simTL4J_simTL_TModelImport_name, simTL4J_simTL_TModelImport_uri}
