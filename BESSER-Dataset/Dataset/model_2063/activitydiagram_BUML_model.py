...
target15: BinaryAssociation = BinaryAssociation(
    name="target15",
    ends={
        Property(name="ActivityNode16", type=activitydiagram_ActivityEdge, multiplicity=Multiplicity(1, 1)),
...
operand122: BinaryAssociation = BinaryAssociation(
    name="operand122",
    ends={
        Property(name="activitydiagram_IntegerVariable24", type=activitydiagram_IntegerExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="activitydiagram_IntegerExpression23", type=activitydiagram_IntegerVariable, multiplicity=Multiplicity(0, 1))
    }
)
assignee25: BinaryAssociation = BinaryAssociation(
    name="assignee25",
    ends={
        Property(name="activitydiagram_BooleanVariable26", type=activitydiagram_BooleanExpression, multiplicity=Multiplicity(1, 1)),
...
assignee27: BinaryAssociation = BinaryAssociation(
    name="assignee27",
    ends={
        Property(name="activitydiagram_IntegerVariable28", type=activitydiagram_IntegerCalculationExpression, multiplicity=Multiplicity(1, 1)),
...
assignee29: BinaryAssociation = BinaryAssociation(
    name="assignee29",
    ends={
        Property(name="activitydiagram_BooleanVariable30", type=activitydiagram_IntegerComparisonExpression, multiplicity=Multiplicity(1, 1)),
...
operand133: BinaryAssociation = BinaryAssociation(
    name="operand133",
    ends={
        Property(name="activitydiagram_BooleanVariable34", type=activitydiagram_BooleanBinaryExpression, multiplicity=Multiplicity(1, 1)),
...
operand235: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="activitydiagram_BooleanBinaryExpression36", type=activitydiagram_BooleanVariable, multiplicity=Multiplicity(1, 1))
    }
)
value38: BinaryAssociation = BinaryAssociation(
    name="value38",
    ends={
        Property(name="activitydiagram_Value39", type=activitydiagram_InputValue, multiplicity=Multiplicity(1, 1)),
...
variable40: BinaryAssociation = BinaryAssociation(
    name="variable40",
    ends={
        Property(name="activitydiagram_Variable42", type=activitydiagram_InputValue, multiplicity=Multiplicity(1, 1)),
        Property(name="activitydiagram_InputValue41", type=activitydiagram_Variable, multiplicity=Multiplicity(1, 1))
    }
)
inputValues43: BinaryAssociation = BinaryAssociation(
    name="inputValues43",
    ends={
        Property(name="activitydiagram_InputValue44", type=activitydiagram_Input, multiplicity=Multiplicity(1, 1)),
...
signal45: BinaryAssociation = BinaryAssociation(
    name="signal45",
    ends={
        Property(name="activitydiagram_Signal46", type=activitydiagram_SendSignalAction, multiplicity=Multiplicity(1, 1)),
        Property(name="activitydiagram_SendSignalAction", type=activitydiagram_Signal, multiplicity=Multiplicity(0, 1))
    }
)
trigger47: BinaryAssociation = BinaryAssociation(
    name="trigger47",
    ends={
...
operand31: BinaryAssociation = BinaryAssociation(
    name="operand31",
    ends={
        Property(name="activitydiagram_BooleanVariable32", type=activitydiagram_BooleanUnaryExpression, multiplicity=Multiplicity(1, 1)),
...
domain_model = DomainModel(
    ...
    types={activitydiagram_ActivityEdge, activitydiagram_Variable, activitydiagram_Signal, activitydiagram_ControlFlow, ActivityEdge, activitydiagram_BooleanVariable, activitydiagram_ControlNode, ActivityNode, activitydiagram_ExecutableNode, activitydiagram_Action, ExecutableNode, activitydiagram_OpaqueAction, Action, activitydiagram_Expression, activitydiagram_Activity, NamedElement, activitydiagram_ActivityNode, activitydiagram_Value, activitydiagram_IntegerVariable, Variable, activitydiagram_BooleanValue, Value, activitydiagram_IntegerValue, activitydiagram_IntegerExpression, Expression, activitydiagram_BooleanExpression, activitydiagram_IntegerCalculationExpression, IntegerExpression, activitydiagram_IntegerComparisonExpression, activitydiagram_NamedElement, activitydiagram_InitialNode, ControlNode, activitydiagram_FinalNode, activitydiagram_ActivityFinalNode, FinalNode, activitydiagram_ForkNode, activitydiagram_JoinNode, activitydiagram_MergeNode, activitydiagram_DecisionNode, activitydiagram_InputValue, activitydiagram_Input, activitydiagram_SendSignalAction, activitydiagram_AcceptEventAction, activitydiagram_SignalEvent, Signal, activitydiagram_BooleanUnaryExpression, BooleanExpression, activitydiagram_BooleanBinaryExpression, IntegerCalculationOperator, BooleanUnaryOperator, BooleanBinaryOperator, IntegerComparisonOperator},
    associations={edges1, locals2, inputs4, signals7, outgoing9, incoming10, activity12, source13, target15, guard17, expressions18, nodes0, initialValue19, operand221, operand122, assignee25, assignee27, assignee29, operand133, operand235, value38, variable40, inputValues43, signal45, trigger47, operand31},
    generalizations={gen_activitydiagram_ActivityNode_NamedElement, gen_activitydiagram_ActivityEdge_NamedElement, gen_activitydiagram_ControlFlow_ActivityEdge, gen_activitydiagram_ControlNode_ActivityNode, gen_activitydiagram_ExecutableNode_ActivityNode, gen_activitydiagram_Action_ExecutableNode, gen_activitydiagram_OpaqueAction_Action, gen_activitydiagram_Activity_NamedElement, gen_activitydiagram_IntegerVariable_Variable, gen_activitydiagram_BooleanVariable_Variable, gen_activitydiagram_BooleanValue_Value, gen_activitydiagram_IntegerValue_Value, gen_activitydiagram_IntegerExpression_Expression, gen_activitydiagram_BooleanExpression_Expression, gen_activitydiagram_IntegerCalculationExpression_IntegerExpression, gen_activitydiagram_IntegerComparisonExpression_IntegerExpression, gen_activitydiagram_InitialNode_ControlNode, gen_activitydiagram_FinalNode_ControlNode, gen_activitydiagram_ActivityFinalNode_FinalNode, gen_activitydiagram_ForkNode_ControlNode, gen_activitydiagram_JoinNode_ControlNode, gen_activitydiagram_MergeNode_ControlNode, gen_activitydiagram_DecisionNode_ControlNode, gen_activitydiagram_SendSignalAction_Action, gen_activitydiagram_AcceptEventAction_Action, gen_activitydiagram_Signal_NamedElement, gen_activitydiagram_SignalEvent_Signal, gen_activitydiagram_BooleanUnaryExpression_BooleanExpression, gen_activitydiagram_BooleanBinaryExpression_BooleanExpression},
    metadata=None
)
