...
Utilisateur_nom3: Property = Property(name="nom3", type=StringType)
Utilisateur_nom4: Property = Property(name="nom4", type=StringType)
Utilisateur.attributes={Utilisateur_nom, Utilisateur_nom4, Utilisateur_nom3, Utilisateur_prenom}
...
Profile.attributes={Profile_about, Profile_username, Profile_password}
...
Post.attributes={Post_info, Post_privacy}
...
Registration.attributes={Registration_password, Registration_fname, Registration_userName, Registration_lname}
...
User_Myprofile: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="user1", type=Utilisateur, multiplicity=Multiplicity(1, 1))
    }
)
User_Post: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="user3", type=Utilisateur, multiplicity=Multiplicity(1, 1))
    }
)
User_Login: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="user5", type=Utilisateur, multiplicity=Multiplicity(1, 1))
    }
)
User_Group: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="user7", type=Utilisateur, multiplicity=Multiplicity(1, 1))
    }
)
User_Registeration: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="user9", type=Utilisateur, multiplicity=Multiplicity(1, 1))
    }
)
User_Message: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="user11", type=Utilisateur, multiplicity=Multiplicity(1, 1))
    }
)
User_Friends: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="user13", type=Utilisateur, multiplicity=Multiplicity(1, 1))
    }
)
User_Hashtag: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="user15", type=Utilisateur, multiplicity=Multiplicity(1, 1))
    }
)
User_Pages: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="user17", type=Utilisateur, multiplicity=Multiplicity(1, 1))
    }
)

# Domain Model
domain_model = DomainModel(
    name="_08dc92cc_4481_46b6_a5b6_5c05f7c87abd",
    types={Utilisateur, Profile, Post, Group, public, secret, Message, Friend, Hashtag, Page, Registration, Login},
