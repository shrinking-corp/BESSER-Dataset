...
class Login:
    ...
    def __init__(self, username: str, password: str, user5: "Utilisateur" = None):
...
class Registration:
    ...
    def __init__(self, fname: str, lname: str, password: secret, userName: str, user9: "Utilisateur" = None):
        self.fname = fname
        self.lname = lname
        self.password = password
        self.userName = userName
...
class Page:
    ...
    def __init__(self, name: str, user17: "Utilisateur" = None):
        self.name = name
        self.user17 = user17
    ...
    def user17(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Page__user17", None)
        self.__user17 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "pages16"):
                opp_val = getattr(old_value, "pages16", None)
                if isinstance(opp_val, set):
                    opp_val.discard(self)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "pages16"):
                opp_val = getattr(value, "pages16", None)
                if opp_val is None:
                    setattr(value, "pages16", set([self]))
...
class Hashtag:
    ...
    def __init__(self, name: str, numOfRepeat: int, user15: "Utilisateur" = None):
        self.name = name
    ...
    def user15(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Hashtag__user15", None)
        self.__user15 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "hashtag14"):
                opp_val = getattr(old_value, "hashtag14", None)
                if isinstance(opp_val, set):
                    opp_val.discard(self)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "hashtag14"):
                opp_val = getattr(value, "hashtag14", None)
                if opp_val is None:
                    setattr(value, "hashtag14", set([self]))
                elif isinstance(opp_val, set):
                    opp_val.add(self)
...
class Message:
    ...
    def __init__(self, maxChars: str, user11: "Utilisateur" = None):
...
class Group:
    ...
    def __init__(self, name: str, discription: str, user7: "Utilisateur" = None):
        self.name = name
...
class Post:
    ...
    def __init__(self, privacy: str, info: str, user3: "Utilisateur" = None):
...
class Profile:
    ...
    def __init__(self, username: str, password: str, about: str, user1: "Utilisateur" = None):
        self.username = username
        self.password = password
        self.about = about
        self.user1 = user1
...
class Utilisateur:
    ...
    def __init__(self, nom: str, prenom: str, nom3: str, nom4: str, myprofile0: "Profile" = None, post2: set["Post"] = None, login4: "Login" = None, group6: set["Group"] = None, registeration8: "Registration" = None, message10: set["Message"] = None, friends12: set["Friend"] = None, hashtag14: set["Hashtag"] = None, pages16: set["Page"] = None):
        self.nom = nom
        self.prenom = prenom
        self.nom3 = nom3
        self.nom4 = nom4
        ...
        self.hashtag14 = hashtag14 if hashtag14 is not None else set()
        self.pages16 = pages16 if pages16 is not None else set()
    ...
    def myprofile0(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Utilisateur__myprofile0", None)
    ...
    def friends12(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Utilisateur__friends12", None)
    ...
    def post2(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Utilisateur__post2", None)
    ...
    @property
    def hashtag14(self):
        return self.__hashtag14
    @hashtag14.setter
    def hashtag14(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Utilisateur__hashtag14", None)
        self.__hashtag14 = value if value is not None else set()
    ...
    def login4(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Utilisateur__login4", None)
        self.__login4 = value
    ...
    def registeration8(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Utilisateur__registeration8", None)
    ...
    @property
    def pages16(self):
        return self.__pages16
    @pages16.setter
    def pages16(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Utilisateur__pages16", None)
        self.__pages16 = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "user17"):
                    opp_val = getattr(item, "user17", None)
                    
                    if opp_val == self:
                        setattr(item, "user17", None)
    ...
    def message10(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Utilisateur__message10", None)
    ...
    def group6(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Utilisateur__group6", None)
