...
class Card:
    ...
    def __init__(self, name: str, avatar: str, valueSoft: str, valueHard: str, suit: str, rank: str, Count: int, hand13: "HandDeck" = None, deck15: "Deck" = None):
        self.name = name
        self.avatar = avatar
...
class HandDeck:
    ...
    def __init__(self, cards: Card, total: int, dealer9: "Dealer" = None, player11: "Gambler" = None, card12: set["Card"] = None):
        self.cards = cards
        self.total = total
    ...
    def card12(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_HandDeck__card12", None)
    ...
    def dealer9(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_HandDeck__dealer9", None)
    ...
    def player11(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_HandDeck__player11", None)
...
class BlackjackGame:
    ...
    def __init__(self, deck: Deck, dealer: Dealer, player: Gambler, bet: int, strategy0: "Strategy" = None, player3: "Gambler" = None, dealer5: "Dealer" = None, deck26: "Deck" = None):
        self.deck = deck
        self.dealer = dealer
        self.player = player
        self.bet = bet
    ...
    @player.setter
    def player(self, player: Gambler):
...
class Dealer:
    ...
    def __init__(self, hand: HandDeck, cardTotalLimit: int, blackjack4: "BlackjackGame" = None, hand8: "HandDeck" = None):
        self.hand = hand
...
class Gambler:
    ...
    def __init__(self, hand: HandDeck, profile: str, money: int, blackjack2: "BlackjackGame" = None, hand10: set["HandDeck"] = None):
        self.hand = hand
    ...
    def blackjack2(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Gambler__blackjack2", None)
    ...
    def hand10(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Gambler__hand10", None)
