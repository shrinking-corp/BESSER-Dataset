...
# Classes
p2_Feature = Class(name="p2_Feature")
Tool = Class(name="Tool")
p2_Copyright = Class(name="p2_Copyright")
p2_Description = Class(name="p2_Description")
p2_DiscoverySite = Class(name="p2_DiscoverySite")
p2_License = Class(name="p2_License")
p2_Vendor = Class(name="p2_Vendor")
p2_Plugin = Class(name="p2_Plugin")
FeatureMetadata = Class(name="FeatureMetadata")
Bundle = Class(name="Bundle")
p2_FeatureMetadata = Class(name="p2_FeatureMetadata", is_abstract=True)
...
domain_model = DomainModel(
    name="p2",
    types={p2_Feature, Tool, p2_Copyright, p2_Description, p2_DiscoverySite, p2_License, p2_Vendor, p2_Plugin, FeatureMetadata, Bundle, p2_FeatureMetadata, LocatedElement},
