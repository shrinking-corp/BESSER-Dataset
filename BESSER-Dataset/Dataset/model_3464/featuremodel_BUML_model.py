...
# Classes
featuremodels_Feature = Class(name="featuremodels_Feature")
featuremodels_ContainmentAssociation = Class(name="featuremodels_ContainmentAssociation")
featuremodels_Attribute = Class(name="featuremodels_Attribute", is_abstract=True)
featuremodels_FeatureModel = Class(name="featuremodels_FeatureModel")
featuremodels_SimpleAttribute = Class(name="featuremodels_SimpleAttribute")
Attribute = Class(name="Attribute")
featuremodels_Constraint = Class(name="featuremodels_Constraint")
featuremodels_Instance = Class(name="featuremodels_Instance")
...
featuremodels_Feature.attributes={featuremodels_Feature_upperBound, featuremodels_Feature_required, featuremodels_Feature_name, featuremodels_Feature_lowerBound, featuremodels_Feature_root}
...
featuremodels_Constraint.attributes={featuremodels_Constraint_rule, featuremodels_Constraint_type, featuremodels_Constraint_name}
...
domain_model = DomainModel(
    name="featuremodels",
    types={featuremodels_Feature, featuremodels_ContainmentAssociation, featuremodels_Attribute, featuremodels_FeatureModel, featuremodels_SimpleAttribute, Attribute, featuremodels_Constraint, featuremodels_Instance, ConstraintType},
    associations={subFeatures1, featureParent3, containers5, containerParent6, attributes9, subFeatures10, parent12, rootFeature14, selectedFeatures20, constraints16, instances18},
