...
# Classes
RDM_Section = Class(name="RDM_Section")
RDM_Turnout = Class(name="RDM_Turnout")
RDM_ConnectionPoint = Class(name="RDM_ConnectionPoint")
RDM_Signal = Class(name="RDM_Signal")
RDM_TurnoutDesiredDirection = Class(name="RDM_TurnoutDesiredDirection")
RDM_Route = Class(name="RDM_Route")
RDM_RouteElement = Class(name="RDM_RouteElement")
RDMElement = Class(name="RDMElement")
RDM_Station = Class(name="RDM_Station")
RDM_RailwayDomainModel = Class(name="RDM_RailwayDomainModel")
RDM_Train = Class(name="RDM_Train")
RDM_RDMElement = Class(name="RDM_RDMElement", is_abstract=True)
TrackElement = Class(name="TrackElement")
Section = Class(name="Section")
RDM_TrackElement = Class(name="RDM_TrackElement", is_abstract=True)
RDM_TurnoutSignal = Class(name="RDM_TurnoutSignal")
...
RDM_Train.attributes={RDM_Train_headingSpeed, RDM_Train_maxSpeed}
...
domain_model = DomainModel(
    name="RDM",
    types={RDM_Section, RDM_Turnout, RDM_ConnectionPoint, RDM_Signal, RDM_TurnoutDesiredDirection, RDM_Route, RDM_RouteElement, RDMElement, RDM_Station, RDM_RailwayDomainModel, RDM_Train, RDM_RDMElement, TrackElement, Section, RDM_TrackElement, RDM_TurnoutSignal, Signal, Speed, TurnoutDirection, ConnectionDirection},
    associations={sections1, turnouts3, editorCP5, editorSignal7, editorTDD9, editorRoute11, editorRouteElement13, arrivesTo15, departuresFrom17, follows20, trains0, firstElement31, referredTurnout32, routeElement35, controls37, standsOn23, standsOn24, observes25, connectsTo27, occupiedBy30, referredElement45, desiredDirection48, belongsTo49, nextElement51, turnout53, holds40, nextElement42},
    generalizations={gen_RDM_Train_RDMElement, gen_RDM_Route_RDMElement, gen_RDM_Section_TrackElement, gen_RDM_Turnout_TrackElement, gen_RDM_TurnoutDesiredDirection_RDMElement, gen_RDM_Station_Section, gen_RDM_Signal_RDMElement, gen_RDM_TrackElement_RDMElement, gen_RDM_RouteElement_RDMElement, gen_RDM_TurnoutSignal_Signal, gen_RDM_ConnectionPoint_RDMElement},
    metadata=None
)
