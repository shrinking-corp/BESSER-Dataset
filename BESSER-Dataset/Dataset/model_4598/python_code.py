...
class DOT_PolygonNodeShape(ComplexNodeShape):
    ...
    def __init__(self, sides: int, skew: int, distortion: int, isRegular: bool, orientation: int):
        self.sides = sides
        self.skew = skew
...
class DOT_DirectedArc(Arc):
    ...
    def __init__(self, tail_lp: float, head_lp: float, DOT_DirectedArc49: "DOT_ArrowShape" = None, DOT_DirectedArc: "DOT_ArrowShape" = None, DOT_DirectedArc44: "DOT_Label" = None, DOT_DirectedArc46: "DOT_Label" = None):
...
class DOT_SubGraph(Nodelike):
    ...
    def __init__(self, labelloc: str, owner: set["DOT_Nodelike"] = None, SubGraph: "DOT_Nodelike" = None):
...
class DOT_Arc(GraphElement):
    ...
    def __init__(self, decorate: bool, constraint: bool, group: str, minlen: int, sameHead: str, sameTail: str, Arc: "DOT_Layer" = None, Arc22: "DOT_Nodelike" = None, referredBy: "DOT_Nodelike" = None, arcs: set["DOT_Layer"] = None, DOT_Arc: "DOT_Nodelike" = None, refers: "DOT_Nodelike" = None, Arc20: "DOT_Nodelike" = None, DOT_Arc40: "DOT_Nodelike" = None):
...
class DOT_Layer(GraphElement):
    ...
    def __init__(self, layerSeparator: str, Layer: "DOT_Graph" = None, layers: set["DOT_Nodelike"] = None, layers15: set["DOT_Arc"] = None, Layer28: "DOT_Nodelike" = None, Layer37: "DOT_Arc" = None, layers17: "DOT_Graph" = None):
...
class DOT_Graph(GraphElement):
    ...
    def __init__(self, type: str, rankDir: str, labeljust: str, labelloc: str, concentrate: bool, boundingBox: str, compound: bool, nodeSeparation: float, ordering: str, size: str, ratio: str, center: bool, graph: set["DOT_Nodelike"] = None, graph11: set["DOT_Layer"] = None, Graph25: "DOT_Nodelike" = None, Graph: "DOT_Layer" = None):
        self.type = type
...
class DOT_GraphElement(ABC):
    ...
    def __init__(self, color: str, name: str, style: str, GraphElement: "DOT_Label" = None, element: "DOT_Label" = None):
        self.color = color
        self.name = name
        self.style = style
