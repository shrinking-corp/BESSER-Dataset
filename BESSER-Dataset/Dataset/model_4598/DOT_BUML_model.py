...
# Classes
DOT_Label = Class(name="DOT_Label", is_abstract=True)
DOT_GraphElement = Class(name="DOT_GraphElement", is_abstract=True)
DOT_SimpleLabel = Class(name="DOT_SimpleLabel")
Label = Class(name="Label")
DOT_ComplexLabel = Class(name="DOT_ComplexLabel")
DOT_Compartment = Class(name="DOT_Compartment", is_abstract=True)
DOT_Anchor = Class(name="DOT_Anchor")
DOT_VerticalCompartment = Class(name="DOT_VerticalCompartment")
Compartment = Class(name="Compartment")
DOT_HorizontalCompartment = Class(name="DOT_HorizontalCompartment")
DOT_SimpleCompartment = Class(name="DOT_SimpleCompartment")
DOT_Graph = Class(name="DOT_Graph")
GraphElement = Class(name="GraphElement")
DOT_Nodelike = Class(name="DOT_Nodelike", is_abstract=True)
DOT_Layer = Class(name="DOT_Layer")
DOT_Arc = Class(name="DOT_Arc", is_abstract=True)
Nodelike = Class(name="Nodelike")
DOT_Node = Class(name="DOT_Node")
DOT_NodeShape = Class(name="DOT_NodeShape", is_abstract=True)
DOT_SubGraph = Class(name="DOT_SubGraph")
DOT_DirectedArc = Class(name="DOT_DirectedArc")
Arc = Class(name="Arc")
DOT_ArrowShape = Class(name="DOT_ArrowShape")
DOT_UndirectedArc = Class(name="DOT_UndirectedArc")
DOT_Shape = Class(name="DOT_Shape", is_abstract=True)
Shape = Class(name="Shape")
DOT_SimpleNodeShape = Class(name="DOT_SimpleNodeShape")
NodeShape = Class(name="NodeShape")
DOT_PointNodeShape = Class(name="DOT_PointNodeShape")
DOT_ComplexNodeShape = Class(name="DOT_ComplexNodeShape", is_abstract=True)
DOT_RecordNodeShape = Class(name="DOT_RecordNodeShape")
DOT_PolygonNodeShape = Class(name="DOT_PolygonNodeShape")
ComplexNodeShape = Class(name="ComplexNodeShape")
DOT_MNodeShape = Class(name="DOT_MNodeShape")
...
DOT_GraphElement.attributes={DOT_GraphElement_style, DOT_GraphElement_color, DOT_GraphElement_name}
...
DOT_Graph.attributes={DOT_Graph_ratio, DOT_Graph_compound, DOT_Graph_labelloc, DOT_Graph_size, DOT_Graph_center, DOT_Graph_nodeSeparation, DOT_Graph_ordering, DOT_Graph_type, DOT_Graph_rankDir, DOT_Graph_boundingBox, DOT_Graph_concentrate, DOT_Graph_labeljust}
...
DOT_Arc.attributes={DOT_Arc_group, DOT_Arc_sameTail, DOT_Arc_sameHead, DOT_Arc_constraint, DOT_Arc_minlen, DOT_Arc_decorate}
...
DOT_Node.attributes={DOT_Node_fontname, DOT_Node_width, DOT_Node_fontsize, DOT_Node_height, DOT_Node_fixedSize}
...
DOT_ArrowShape.attributes={DOT_ArrowShape_size, DOT_ArrowShape_clipping, DOT_ArrowShape_isPlain}
...
DOT_Shape.attributes={DOT_Shape_height, DOT_Shape_peripheries, DOT_Shape_width}
...
DOT_PolygonNodeShape.attributes={DOT_PolygonNodeShape_isRegular, DOT_PolygonNodeShape_skew, DOT_PolygonNodeShape_orientation, DOT_PolygonNodeShape_distortion, DOT_PolygonNodeShape_sides}
...
domain_model = DomainModel(
    name="DOT",
    types={DOT_Label, DOT_GraphElement, DOT_SimpleLabel, Label, DOT_ComplexLabel, DOT_Compartment, DOT_Anchor, DOT_VerticalCompartment, Compartment, DOT_HorizontalCompartment, DOT_SimpleCompartment, DOT_Graph, GraphElement, DOT_Nodelike, DOT_Layer, DOT_Arc, Nodelike, DOT_Node, DOT_NodeShape, DOT_SubGraph, DOT_DirectedArc, Arc, DOT_ArrowShape, DOT_UndirectedArc, DOT_Shape, Shape, DOT_SimpleNodeShape, NodeShape, DOT_PointNodeShape, DOT_ComplexNodeShape, DOT_RecordNodeShape, DOT_PolygonNodeShape, ComplexNodeShape, DOT_MNodeShape},
    associations={element0, compartments1, complexLabel2, compartments4, anchor5, nodes9, layers10, nodes12, arcs14, source6, label8, referredBy21, graph23, layers26, nodes29, shape31, fromNode32, graph16, owner18, refers19, ltail39, arrowHead42, headlabel43, taillabel45, arrowTail48, toNode34, layers36, lhead38, bottomlabel53, toplabel51},
    generalizations={gen_DOT_SimpleLabel_Label, gen_DOT_ComplexLabel_Label, gen_DOT_VerticalCompartment_Compartment, gen_DOT_HorizontalCompartment_Compartment, gen_DOT_SimpleCompartment_Compartment, gen_DOT_Graph_GraphElement, gen_DOT_Layer_GraphElement, gen_DOT_SubGraph_Nodelike, gen_DOT_Node_Nodelike, gen_DOT_Arc_GraphElement, gen_DOT_Nodelike_GraphElement, gen_DOT_DirectedArc_Arc, gen_DOT_UndirectedArc_Arc, gen_DOT_Shape_GraphElement, gen_DOT_NodeShape_Shape, gen_DOT_SimpleNodeShape_NodeShape, gen_DOT_PointNodeShape_NodeShape, gen_DOT_ComplexNodeShape_NodeShape, gen_DOT_RecordNodeShape_ComplexNodeShape, gen_DOT_ArrowShape_Shape, gen_DOT_PolygonNodeShape_ComplexNodeShape, gen_DOT_MNodeShape_ComplexNodeShape},
    metadata=None
)
