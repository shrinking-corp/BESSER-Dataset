...
# Classes
containment_C = Class(name="containment_C")
containment_G = Class(name="containment_G")
containment_Named = Class(name="containment_Named")
containment_F = Class(name="containment_F")
containment_A = Class(name="containment_A")
Named = Class(name="Named")
containment_B = Class(name="containment_B")
containment_E = Class(name="containment_E")
containment_H = Class(name="containment_H")
...
domain_model = DomainModel(
    name="containment",
    types={containment_C, containment_G, containment_Named, containment_F, containment_A, Named, containment_B, containment_E, containment_H},
    associations={cs3, gs5, bs0, es1, fs7, hs9},
    generalizations={gen_containment_C_Named, gen_containment_E_Named, gen_containment_A_Named, gen_containment_B_Named, gen_containment_F_Named, gen_containment_G_Named, gen_containment_H_Named},
    metadata=None
)
