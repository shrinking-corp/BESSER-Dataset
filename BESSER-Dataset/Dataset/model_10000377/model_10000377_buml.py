...
Student.attributes={Student_mail_ID, Student_name, Student_reg_Num}
...
domain_model = DomainModel(
    name="_2f4f070d_7dc1_459d_af6a_e00342e4a616",
    types={SignUp_UseCase, Login_UseCase, Upload_Materials_UseCase, View___Modify_the_Uploaded_Materials_UseCase, Manage_Student___Faculty_List_UseCase, View_The_Uploaded_Materials_UseCase, Post_Questions_UseCase, View_Questions_And_Post_Answers_UseCase, Logout_UseCase, Student, Faculty, Admin, Class_, Student_Actor, Faculty__Actor, Admin_Actor},
    associations={Student_SignUp, Student_Login, Admin_Manage_Student___Faculty_List, Teacher_SignUp, Teacher_Login, Teacher_Upload_Materials, Admin_View___Modify_the_Uploaded_Materials, Teacher_View___Modify_the_Uploaded_Materials, Student_View_The_Uploaded_Materials, Student_Post_Questions, Teacher_View_Questions_And_Post_Answers, Student_Logout, Teacher_Logout, Admin_Logout, Student_Faculty, Student_Admin, Faculty_Admin},
    generalizations={},
    metadata=None
)
