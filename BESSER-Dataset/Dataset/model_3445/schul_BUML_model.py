...
# Classes
schul_Classroom = Class(name="schul_Classroom")
schul_Student = Class(name="schul_Student")
schul_Diagram = Class(name="schul_Diagram")
schul_School = Class(name="schul_School")
...
domain_model = DomainModel(
    name="schul",
    types={schul_Classroom, schul_Student, schul_Diagram, schul_School},
