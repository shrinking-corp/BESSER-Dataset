...
class core_COREContribution:
    ...
    def __init__(self, relativeWeight: int, core_COREContribution: "core_COREImpactModel" = None, COREContribution: "core_COREImpactModelElement" = None, outgoing: "core_COREImpactModelElement" = None, incoming: "core_COREImpactModelElement" = None, COREContribution63: "core_COREImpactModelElement" = None):
...
class core_COREImpactModelElement(COREModelElement):
    ...
    def __init__(self, offset: float, scalingFactor: float, core_COREImpactModelElement: "core_COREImpactModel" = None, source: set["core_COREContribution"] = None, COREImpactModelElement: "core_COREContribution" = None, COREImpactModelElement82: "core_COREContribution" = None, impacts: set["core_COREContribution"] = None, core_COREImpactModelElement45: "core_COREInterface" = None):
        self.offset = offset
...
class core_COREFeature(COREModelElement):
    ...
    def __init__(self, parentRelationship: str, core_COREFeature28: "core_COREFeature" = None, core_COREFeature26: set["core_COREFeature"] = None, core_COREFeature31: "core_COREFeature" = None, core_COREFeature29: set["core_COREFeature"] = None, COREFeature: "core_COREModel" = None, realizes: set["core_COREModel"] = None, core_COREFeature: set["core_COREReuse"] = None, COREFeature22: "core_COREFeature" = None, parent: set["core_COREFeature"] = None, COREFeature25: "core_COREFeature" = None, children: "core_COREFeature" = None, core_COREFeature93: "core_COREFeatureImpact" = None, core_COREFeature66: "core_COREConfiguration" = None, core_COREFeature69: "core_COREConfiguration" = None, core_COREFeature36: "core_COREInterface" = None, core_COREFeature75: "core_COREFeatureModel" = None, core_COREFeature78: "core_COREFeatureModel" = None):
