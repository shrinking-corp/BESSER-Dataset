...
core_COREImpactModelElement = Class(name="core_COREImpactModelElement")
...
core_COREFeatureImpact = Class(name="core_COREFeatureImpact")
...
core_COREModelElement.attributes={core_COREModelElement_partiality, core_COREModelElement_visibility}
...
core_COREImpactModelElement.attributes={core_COREImpactModelElement_scalingFactor, core_COREImpactModelElement_offset}
...
domain_model = DomainModel(
    name="core",
    types={core_COREModel, CORENamedElement, core_COREModelReuse, core_COREBinding, core_COREModelElement, core_COREFeature, core_COREConcern, core_COREImpactModel, COREModel, core_COREImpactModelElement, core_LayoutContainerMap, core_COREContribution, core_COREInterface, core_COREFeatureModel, COREModelElement, core_COREReuse, core_CORECompositionSpecification, core_COREMapping, core_CORENamedElement, core_COREConfiguration, core_COREPattern, core_COREWeightedMapping, core_COREImpactModelBinding, core_LayoutMap, core_EObject, core_LayoutElement, core_COREFeatureImpact, COREImpactModelElement, core_COREModelCompositionSpecification, COREVisibilityType, COREPartialityType, COREFeatureRelationshipType},
    associations={requires27, excludes30, modelReuses0, modelElements1, realizes3, concern4, impactModelElements5, layouts6, contributions8, models10, interface11, featureModel12, impactModel14, realizedBy17, reuses19, children21, parent24, outgoing61, incoming62, selected64, reexposed67, extendedConfigurations71, reuse32, selectable34, customizable37, usable40, impacted43, defaults46, reusedConcern48, configurations51, selectedConfiguration54, modelReuses57, extends59, features73, root76, reuse79, source80, impacts81, key83, value84, key86, value89, represents92},
    generalizations={gen_core_COREModel_CORENamedElement, gen_core_COREModelElement_CORENamedElement, gen_core_COREImpactModel_COREModel, gen_core_COREConcern_CORENamedElement, gen_core_COREFeature_COREModelElement, gen_core_COREReuse_CORENamedElement, gen_core_COREImpactModelElement_COREModelElement, gen_core_COREFeatureModel_COREModel, gen_core_COREFeatureImpact_COREImpactModelElement},
    metadata=None
)
