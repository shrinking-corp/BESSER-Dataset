...
def test_hyp_coreimpactmodelelement_is_not_abstract():
    assert not inspect.isabstract(COREImpactModelElement)


def test_hyp_coreimpactmodelelement_constructor_exists():
    assert callable(COREImpactModelElement.__init__)


def test_hyp_coreimpactmodelelement_constructor_args():
    sig = inspect.signature(COREImpactModelElement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_core_corefeatureimpact_is_not_abstract():
    assert not inspect.isabstract(core_COREFeatureImpact)


def test_hyp_core_corefeatureimpact_constructor_exists():
    assert callable(core_COREFeatureImpact.__init__)


def test_hyp_core_corefeatureimpact_constructor_args():
...
def test_hyp_core_corefeatureimpact_relativeFeatureWeight_setter(instance):
...
def test_hyp_core_coreimpactmodelelement_scalingFactor_setter(instance):
...
@given(instance=core_COREImpactModelElement_strategy)
def test_hyp_core_coreimpactmodelelement_offset_setter(instance):
