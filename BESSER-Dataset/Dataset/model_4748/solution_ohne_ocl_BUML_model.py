...
# Classes
solution_WebApplication = Class(name="solution_WebApplication")
solution_Entity = Class(name="solution_Entity")
solution_WebPage = Class(name="solution_WebPage", is_abstract=True)
solution_StaticPage = Class(name="solution_StaticPage")
solution_Attribute = Class(name="solution_Attribute")
solution_Link = Class(name="solution_Link", is_abstract=True)
solution_NonContextualLink = Class(name="solution_NonContextualLink")
WebPage = Class(name="WebPage")
solution_DynamicPage = Class(name="solution_DynamicPage", is_abstract=True)
solution_EntityPage = Class(name="solution_EntityPage")
DynamicPage = Class(name="DynamicPage")
solution_IndexPage = Class(name="solution_IndexPage")
solution_CreatePage = Class(name="solution_CreatePage")
EditablePage = Class(name="EditablePage")
solution_Relationship = Class(name="solution_Relationship")
solution_UpdatePage = Class(name="solution_UpdatePage")
solution_DeletePage = Class(name="solution_DeletePage")
Link = Class(name="Link")
solution_ContextualLink = Class(name="solution_ContextualLink")
solution_EditablePage = Class(name="solution_EditablePage", is_abstract=True)
...
solution_Attribute.attributes={solution_Attribute_dataType, solution_Attribute_name}
...
domain_model = DomainModel(
    name="solution",
    types={solution_WebApplication, solution_Entity, solution_WebPage, solution_StaticPage, solution_Attribute, solution_Link, solution_NonContextualLink, WebPage, solution_DynamicPage, solution_EntityPage, DynamicPage, solution_IndexPage, solution_CreatePage, EditablePage, solution_Relationship, solution_UpdatePage, solution_DeletePage, Link, solution_ContextualLink, solution_EditablePage, EntityPage, DataType},
    associations={entities0, webpages1, homePage3, links17, homeLink19, entity21, innerPages23, attributes5, id7, relationships10, source11, target12, opposite15, target25, information28, returnPage30},
