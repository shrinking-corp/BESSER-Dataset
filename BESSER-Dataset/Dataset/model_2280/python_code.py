...
class fenix_CourseLoad:
    ...
    def __init__(self, type: str, totalQuantity: int, unitQuantity: int, id: str, name: str, description: str, fenix_CourseLoad10: "fenix_CourseLoad" = None, fenix_CourseLoad8: "fenix_CourseLoad" = None, fenix_CourseLoad12: "fenix_Capacity" = None, fenix_CourseLoad17: "fenix_scheduleOfCourse" = None, fenix_CourseLoad: "fenix_Shift" = None, fenix_CourseLoad7: "fenix_LessonPeriod" = None):
        self.type = type
...
class fenix_LessonPeriod:
    ...
    def __init__(self, start: str, end: str, fenix_LessonPeriod14: "fenix_scheduleOfCourse" = None, fenix_LessonPeriod: "fenix_Shift" = None, fenix_LessonPeriod6: "fenix_CourseLoad" = None):
        self.start = start
        self.end = end
...
class fenix_Shift:
    ...
    def __init__(self, name: str, types: str, fenix_Shift20: "fenix_scheduleOfCourse" = None, fenix_Shift: "fenix_Occupation" = None, fenix_Shift2: set["fenix_LessonPeriod"] = None, fenix_Shift4: set["fenix_CourseLoad"] = None):
        self.name = name
        self.types = types
