...
# Classes
fenix_Shift = Class(name="fenix_Shift")
fenix_Occupation = Class(name="fenix_Occupation")
fenix_LessonPeriod = Class(name="fenix_LessonPeriod")
fenix_CourseLoad = Class(name="fenix_CourseLoad")
fenix_Capacity = Class(name="fenix_Capacity")
fenix_scheduleOfCourse = Class(name="fenix_scheduleOfCourse")
...
fenix_Shift.attributes={fenix_Shift_name, fenix_Shift_types}
...
fenix_CourseLoad.attributes={fenix_CourseLoad_totalQuantity, fenix_CourseLoad_name, fenix_CourseLoad_description, fenix_CourseLoad_id, fenix_CourseLoad_unitQuantity, fenix_CourseLoad_type}
...
domain_model = DomainModel(
    name="fenix",
    types={fenix_Shift, fenix_Occupation, fenix_LessonPeriod, fenix_CourseLoad, fenix_Capacity, fenix_scheduleOfCourse},
    associations={occupation0, lessons1, rooms3, room5, topLevelSpace9, capacity11, lessonPeriods13, courseLoads15, shifts18},
    generalizations={},
    metadata=None
)
