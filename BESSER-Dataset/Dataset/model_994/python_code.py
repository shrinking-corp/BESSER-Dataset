...
class graph_Pattern_Matching_Master_Project_Graph:
    ...
    def __init__(self, direct: bool, name: str, Graph: "graph_Pattern_Matching_Master_Project_Vertex" = None, Graph6: "graph_Pattern_Matching_Master_Project_Edge" = None, graph: set["graph_Pattern_Matching_Master_Project_Edge"] = None, graph2: set["graph_Pattern_Matching_Master_Project_Vertex"] = None):
        self.direct = direct
        self.name = name
        self.Graph = Graph
        self.Graph6 = Graph6
