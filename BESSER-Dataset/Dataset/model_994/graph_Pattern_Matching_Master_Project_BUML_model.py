...
# Classes
graph_Pattern_Matching_Master_Project_Entry = Class(name="graph_Pattern_Matching_Master_Project_Entry")
graph_Pattern_Matching_Master_Project_Graph = Class(name="graph_Pattern_Matching_Master_Project_Graph")
graph_Pattern_Matching_Master_Project_Edge = Class(name="graph_Pattern_Matching_Master_Project_Edge")
graph_Pattern_Matching_Master_Project_Vertex = Class(name="graph_Pattern_Matching_Master_Project_Vertex")
...
graph_Pattern_Matching_Master_Project_Entry.attributes={graph_Pattern_Matching_Master_Project_Entry_value, graph_Pattern_Matching_Master_Project_Entry_key}
...
domain_model = DomainModel(
    ...
    types={graph_Pattern_Matching_Master_Project_Entry, graph_Pattern_Matching_Master_Project_Graph, graph_Pattern_Matching_Master_Project_Edge, graph_Pattern_Matching_Master_Project_Vertex},
    associations={graph3, entries4, graph5, source7, target9, entries12, edges0, vertices1},
    generalizations={},
    metadata=None
)
