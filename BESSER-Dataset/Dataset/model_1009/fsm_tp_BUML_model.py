...
fsm_tp_FSM = Class(name="fsm_tp_FSM")
fsm_tp_State = Class(name="fsm_tp_State")
fsm_tp_Transition = Class(name="fsm_tp_Transition")
fsm_tp_InitialState = Class(name="fsm_tp_InitialState")
...
fsm_tp_State.attributes={fsm_tp_State_name, fsm_tp_State_isFinal}
...
domain_model = DomainModel(
    name="fsm_tp",
    types={State, fsm_tp_FSM, fsm_tp_State, fsm_tp_Transition, fsm_tp_InitialState},
    associations={target8, state0, transition1, initialstate3, source5},
