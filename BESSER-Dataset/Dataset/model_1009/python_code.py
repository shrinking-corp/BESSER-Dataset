...
class fsm_tp_Transition:
    ...
    def __init__(self, trigger: str, name: str, fsm_tp_Transition9: "fsm_tp_State" = None, fsm_tp_Transition: "fsm_tp_FSM" = None, fsm_tp_Transition6: "fsm_tp_State" = None):
...
class fsm_tp_State:
    ...
    def __init__(self, name: str, isFinal: bool, fsm_tp_State10: "fsm_tp_Transition" = None, fsm_tp_State: "fsm_tp_FSM" = None, fsm_tp_State7: "fsm_tp_Transition" = None):
        self.name = name
