...
class myDsl_RestException:
    ...
    def __init__(self, statusCode: str, message: str, myDsl_RestException: "myDsl_RestExceptionList" = None, myDsl_RestException152: "myDsl_ExceptionMapper" = None):
...
class myDsl_Block:
    ...
    def __init__(self, code: str, myDsl_Block47: "myDsl_Resource" = None, myDsl_Block65: "myDsl_Resource" = None, myDsl_Block: "myDsl_Resource" = None, myDsl_Block96: "myDsl_Service" = None, myDsl_Block59: "myDsl_Resource" = None, myDsl_Block76: "myDsl_Service" = None, myDsl_Block81: "myDsl_Service" = None, myDsl_Block90: "myDsl_Service" = None, myDsl_Block105: "myDsl_ValidationService" = None, myDsl_Block111: "myDsl_DataAccessObject" = None, myDsl_Block126: "myDsl_DataAccessObject" = None, myDsl_Block132: "myDsl_DataAccessObject" = None, myDsl_Block117: "myDsl_DataAccessObject" = None):
        self.code = code
...
class myDsl_Service:
    ...
    def __init__(self, deleteby: str, name: str, findby: str, updateby: str, myDsl_Service: "myDsl_RestAPI" = None, myDsl_Service32: "myDsl_Resource" = None, myDsl_Service95: "myDsl_Block" = None, myDsl_Service69: set["myDsl_DataAccessObject"] = None, myDsl_Service72: "myDsl_DataModel" = None, myDsl_Service75: "myDsl_Block" = None, myDsl_Service78: "myDsl_DataModelMethodConclusion" = None, myDsl_Service80: "myDsl_Block" = None, myDsl_Service83: "myDsl_DataModelMethodConclusion" = None, myDsl_Service86: "myDsl_DataModel" = None, myDsl_Service89: "myDsl_Block" = None, myDsl_Service92: "myDsl_DataModelMethodConclusion" = None, myDsl_Service98: "myDsl_RestExceptionList" = None):
...
class myDsl_Resource:
    ...
    def __init__(self, findby: str, updateby: str, deleteby: str, name: str, myDsl_Resource: "myDsl_RestAPI" = None, myDsl_Resource46: "myDsl_Block" = None, myDsl_Resource49: "myDsl_RestModelMethodConclusion" = None, myDsl_Resource64: "myDsl_Block" = None, myDsl_Resource31: set["myDsl_Service"] = None, myDsl_Resource34: "myDsl_ExceptionMapper" = None, myDsl_Resource37: "myDsl_RestModel" = None, myDsl_Resource40: "myDsl_ValidationService" = None, myDsl_Resource42: "myDsl_Block" = None, myDsl_Resource44: "myDsl_RestModelMethodConclusion" = None, myDsl_Resource52: "myDsl_RestModel" = None, myDsl_Resource55: "myDsl_ValidationService" = None, myDsl_Resource58: "myDsl_Block" = None, myDsl_Resource61: "myDsl_RestModelMethodConclusion" = None, myDsl_Resource67: "myDsl_RestExceptionList" = None):
        self.findby = findby
        self.updateby = updateby
        self.deleteby = deleteby
        self.name = name
...
class myDsl_Feature:
    ...
    def __init__(self, many: bool, name: str, myDsl_Feature: "myDsl_DataModel" = None, myDsl_Feature19: "myDsl_RestModel" = None, myDsl_Feature28: "myDsl_Type" = None):
        self.many = many
        self.name = name
...
class myDsl_DataModel(Type):
    ...
    def __init__(self, id: str, myDsl_DataModel: "myDsl_DataModel" = None, myDsl_DataModel11: "myDsl_DataModel" = None, myDsl_DataModel14: set["myDsl_Feature"] = None, myDsl_DataModel23: "myDsl_Transformation" = None, myDsl_DataModel73: "myDsl_Service" = None, myDsl_DataModel87: "myDsl_Service" = None, myDsl_DataModel108: "myDsl_DataAccessObject" = None, myDsl_DataModel123: "myDsl_DataAccessObject" = None, myDsl_DataModel138: "myDsl_DataModelMethodConclusion" = None):
        self.id = id
...
class myDsl_RestModel(Type):
    ...
    def __init__(self, id: str, self1: str, myDsl_RestModel: "myDsl_RestModel" = None, myDsl_RestModel15: "myDsl_RestModel" = None, myDsl_RestModel18: set["myDsl_Feature"] = None, myDsl_RestModel26: "myDsl_Transformation" = None, myDsl_RestModel38: "myDsl_Resource" = None, myDsl_RestModel53: "myDsl_Resource" = None, myDsl_RestModel102: "myDsl_ValidationService" = None, myDsl_RestModel144: "myDsl_RestModelMethodConclusion" = None):
        self.id = id
        self.self1 = self1
...
class myDsl_DataAccessObject:
    ...
    def __init__(self, name: str, findby: str, updateby: str, deleteby: str, myDsl_DataAccessObject: "myDsl_RestAPI" = None, myDsl_DataAccessObject110: "myDsl_Block" = None, myDsl_DataAccessObject70: "myDsl_Service" = None, myDsl_DataAccessObject107: "myDsl_DataModel" = None, myDsl_DataAccessObject119: "myDsl_DataModelMethodConclusion" = None, myDsl_DataAccessObject122: "myDsl_DataModel" = None, myDsl_DataAccessObject125: "myDsl_Block" = None, myDsl_DataAccessObject128: "myDsl_DataModelMethodConclusion" = None, myDsl_DataAccessObject131: "myDsl_Block" = None, myDsl_DataAccessObject134: "myDsl_RestExceptionList" = None, myDsl_DataAccessObject113: "myDsl_DataModelMethodConclusion" = None, myDsl_DataAccessObject116: "myDsl_Block" = None):
        self.name = name
        self.findby = findby
        self.updateby = updateby
        self.deleteby = deleteby
