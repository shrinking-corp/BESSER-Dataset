...
# Classes
myDsl_DataAccessObject = Class(name="myDsl_DataAccessObject")
myDsl_ExceptionMapper = Class(name="myDsl_ExceptionMapper")
myDsl_PrimitiveType = Class(name="myDsl_PrimitiveType")
Type = Class(name="Type")
myDsl_DataModel = Class(name="myDsl_DataModel")
myDsl_Feature = Class(name="myDsl_Feature")
myDsl_RestModel = Class(name="myDsl_RestModel")
myDsl_DomainModel = Class(name="myDsl_DomainModel")
myDsl_Type = Class(name="myDsl_Type")
myDsl_RestAPI = Class(name="myDsl_RestAPI")
myDsl_Resource = Class(name="myDsl_Resource")
myDsl_Service = Class(name="myDsl_Service")
myDsl_ModelMapper = Class(name="myDsl_ModelMapper")
myDsl_Transformation = Class(name="myDsl_Transformation")
myDsl_ValidationService = Class(name="myDsl_ValidationService")
myDsl_Block = Class(name="myDsl_Block")
myDsl_RestModelMethodConclusion = Class(name="myDsl_RestModelMethodConclusion")
myDsl_RestExceptionList = Class(name="myDsl_RestExceptionList")
myDsl_DataModelMethodConclusion = Class(name="myDsl_DataModelMethodConclusion")
myDsl_RestException = Class(name="myDsl_RestException")
myDsl_BaseException = Class(name="myDsl_BaseException")
...
myDsl_DataAccessObject.attributes={myDsl_DataAccessObject_updateby, myDsl_DataAccessObject_deleteby, myDsl_DataAccessObject_name, myDsl_DataAccessObject_findby}
...
myDsl_Resource.attributes={myDsl_Resource_findby, myDsl_Resource_updateby, myDsl_Resource_deleteby, myDsl_Resource_name}
...
myDsl_RestException.attributes={myDsl_RestException_statusCode, myDsl_RestException_message}
...
domain_model = DomainModel(
    name="myDsl",
    types={myDsl_DataAccessObject, myDsl_ExceptionMapper, myDsl_PrimitiveType, Type, myDsl_DataModel, myDsl_Feature, myDsl_RestModel, myDsl_DomainModel, myDsl_Type, myDsl_RestAPI, myDsl_Resource, myDsl_Service, myDsl_ModelMapper, myDsl_Transformation, myDsl_ValidationService, myDsl_Block, myDsl_RestModelMethodConclusion, myDsl_RestExceptionList, myDsl_DataModelMethodConclusion, myDsl_RestException, myDsl_BaseException, RestStatusCode},
    associations={dao7, exceptionMapper9, superType12, features13, superType16, features17, elements0, apis1, resource3, service5, findMethod45, findConclusion48, updateRestModel51, updateValService54, updateMethod57, updateConclusion60, deleteMethod63, transformation20, dataModel21, restModel24, type27, service30, exceptionMapper33, createRestModel36, createValService39, createMethod41, createConclusion43, deleteMethod94, exception497, restModel100, block103, createDataModel106, createMethod109, exception466, dao68, createDataModel71, createMethod74, createConclusion77, findMethod79, findConclusion82, updateDataModel85, updateMethod88, updateConclusion91, exception145, exception148, restException150, baseException153, createConclusion112, findMethod115, findConclusion118, updateDataModel121, updateMethod124, updateConclusion127, deleteMethod130, exceptions133, dataModel136, exceptions139, restModel142},
    generalizations={gen_myDsl_PrimitiveType_Type, gen_myDsl_DataModel_Type, gen_myDsl_RestModel_Type, gen_myDsl_ModelMapper_Type},
    metadata=None
)
