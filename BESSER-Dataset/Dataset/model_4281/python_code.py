...
class bowling_Playerlist:
    ...
    def __init__(self, name: str, playerlist: set["bowling_Player"] = None, playerlist12: "bowling_Tournament" = None, Playerlist: "bowling_Player" = None, Playerlist18: "bowling_Tournament" = None):
        self.name = name
...
class bowling_Game:
    ...
    def __init__(self, date: date, frames: int, game5: "bowling_Matchup" = None, Game7: "bowling_Matchup" = None, Game: "bowling_Player" = None, game: "bowling_Player" = None):
        self.date = date
        self.frames = frames
        self.game5 = game5
        self.Game7 = Game7
...
class bowling_Tournament:
    ...
    def __init__(self, title: str, type: str, Tournament: "bowling_Matchup" = None, Tournament13: "bowling_Playerlist" = None, tournament: set["bowling_Matchup"] = None, tournament17: "bowling_Playerlist" = None):
        self.title = title
        self.type = type
...
class bowling_Player:
    ...
    def __init__(self, firstname: str, lastname: str, street: str, streetnumber: int, city: str, dateOfBirth: date, height: float, isProfessional: bool, Player10: "bowling_Playerlist" = None, player: set["bowling_Game"] = None, player2: "bowling_Playerlist" = None, Player: "bowling_Game" = None):
