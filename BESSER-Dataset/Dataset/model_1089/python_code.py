...
class petrinet_Arc:
    ...
    def __init__(self, weight: int, kind: str, petrinet_Arc: "petrinet_PetriNet" = None, Arc: "petrinet_Node" = None, Arc5: "petrinet_Node" = None, outgoings: "petrinet_Node" = None, incomings: "petrinet_Node" = None):
        self.weight = weight
        self.kind = kind
...
class petrinet_Node:
    ...
    def __init__(self, name: str, petrinet_Node: "petrinet_PetriNet" = None, source: "petrinet_Arc" = None, target: "petrinet_Arc" = None, Node: "petrinet_Arc" = None, Node8: "petrinet_Arc" = None):
        self.name = name
