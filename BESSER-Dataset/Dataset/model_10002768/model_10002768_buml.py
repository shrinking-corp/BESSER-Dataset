...
Order.attributes={Order_total, Order_shipTo, Order_status, Order_shipped, Order_ordered, Order_number}
...
domain_model = DomainModel(
    name="d7a47b9b_bc7a_4932_bf7b_0313fef6aa87",
    types={LineItem, Product, Customer, Payment, ShoppingCart, Account, WebUser, Order, UserState, OrderStatus},
