...
types_Branch = Class(name="types_Branch")
Element = Class(name="Element")
types_Field = Class(name="types_Field")
types_Case = Class(name="types_Case")
types_Char = Class(name="types_Char")
types_Collection = Class(name="types_Collection", is_abstract=True)
Type = Class(name="Type")
types_Double = Class(name="types_Double")
FloatingPoint = Class(name="FloatingPoint")
types_Enum = Class(name="types_Enum")
types_Float = Class(name="types_Float")
types_FloatingPoint = Class(name="types_FloatingPoint", is_abstract=True)
types_Int = Class(name="types_Int", is_abstract=True)
types_Key = Class(name="types_Key")
types_UnsignedInt = Class(name="types_UnsignedInt", is_abstract=True)
...
types_Sequence = Class(name="types_Sequence")
types_Short = Class(name="types_Short")
types_SignedInt = Class(name="types_SignedInt", is_abstract=True)
Int = Class(name="Int")
types_Simple = Class(name="types_Simple", is_abstract=True)
types_String = Class(name="types_String")
types_Struct = Class(name="types_Struct")
...
types_Union = Class(name="types_Union")
types_WChar = Class(name="types_WChar")
types_WString = Class(name="types_WString")
types_DataLib = Class(name="types_DataLib")
...
types_Enum.attributes={types_Enum_literals, types_Enum_name}
...
domain_model = DomainModel(
    name="types",
    types={types_Array, Collection, types_Type, types_Boolean, Simple, types_Branch, Element, types_Field, types_Case, types_Char, types_Collection, Type, types_Double, FloatingPoint, types_Enum, types_Float, types_FloatingPoint, types_Int, types_Key, types_UnsignedInt, types_Long, SignedInt, types_LongDouble, types_LongLong, types_Octet, types_Sequence, types_Short, types_SignedInt, Int, types_Simple, types_String, types_Struct, types_Typedef, types_ULong, UnsignedInt, types_ULongLong, types_UShort, types_Union, types_WChar, types_WString, types_DataLib, OpenDDSLib},
    associations={field7, subtype0, field1, cases2, type4, subtype9, fields11, keys13, type16, branches18, switch20, default23, types26},
    generalizations={gen_types_Array_Collection, gen_types_Boolean_Simple, gen_types_Branch_Element, gen_types_Case_Element, gen_types_Char_Simple, gen_types_Collection_Type, gen_types_Double_FloatingPoint, gen_types_Enum_Simple, gen_types_Field_Element, gen_types_Float_FloatingPoint, gen_types_FloatingPoint_Simple, gen_types_Int_Simple, gen_types_Key_Element, gen_types_UnsignedInt_Int, gen_types_Long_SignedInt, gen_types_LongDouble_FloatingPoint, gen_types_LongLong_SignedInt, gen_types_Octet_Simple, gen_types_Sequence_Collection, gen_types_Short_SignedInt, gen_types_SignedInt_Int, gen_types_Simple_Type, gen_types_String_Collection, gen_types_Struct_Type, gen_types_Type_Element, gen_types_Typedef_Type, gen_types_ULong_UnsignedInt, gen_types_ULongLong_UnsignedInt, gen_types_UShort_UnsignedInt, gen_types_Union_Type, gen_types_WChar_Simple, gen_types_WString_Collection, gen_types_DataLib_OpenDDSLib},
    metadata=None
)
