...
# Classes
automaticexperiment_Scenario = Class(name="automaticexperiment_Scenario")
automaticexperiment_ModifiableParameter = Class(name="automaticexperiment_ModifiableParameter")
automaticexperiment_AutomaticExperiment = Class(name="automaticexperiment_AutomaticExperiment")
Identifiable = Class(name="Identifiable")
automaticexperiment_EStructuralFeature = Class(name="automaticexperiment_EStructuralFeature")
...
automaticexperiment_ModifiableParameter.attributes={automaticexperiment_ModifiableParameter_featureName, automaticexperiment_ModifiableParameter_upperBound, automaticexperiment_ModifiableParameter_targetURI, automaticexperiment_ModifiableParameter_initialValue, automaticexperiment_ModifiableParameter_step, automaticexperiment_ModifiableParameter_lowerBound}
...
automaticexperiment_AutomaticExperiment.attributes={automaticexperiment_AutomaticExperiment_reInit, automaticexperiment_AutomaticExperiment_errorFunction, automaticexperiment_AutomaticExperiment_tolerance, automaticexperiment_AutomaticExperiment_errorAnalysisAlgorithm, automaticexperiment_AutomaticExperiment_maximumNumberOfIterations, automaticexperiment_AutomaticExperiment_referanceDataDir}
...
domain_model = DomainModel(
    ...
    types={automaticexperiment_Scenario, automaticexperiment_ModifiableParameter, automaticexperiment_AutomaticExperiment, Identifiable, automaticexperiment_EStructuralFeature},
