...
class petrinet_Transition:
    ...
    def __init__(self, name: str, trg10: set["petrinet_PTArc"] = None, src13: set["petrinet_TPArc"] = None, petrinet_Transition: "petrinet_Petrinet" = None, Transition: "petrinet_PTArc" = None, Transition19: "petrinet_TPArc" = None):
        self.name = name
...
class petrinet_Place:
    ...
    def __init__(self, name: str, src: set["petrinet_PTArc"] = None, trg: set["petrinet_TPArc"] = None, petrinet_Place: "petrinet_Petrinet" = None, petrinet_Place6: set["petrinet_Token"] = None, Place: "petrinet_PTArc" = None, Place22: "petrinet_TPArc" = None):
        self.name = name
