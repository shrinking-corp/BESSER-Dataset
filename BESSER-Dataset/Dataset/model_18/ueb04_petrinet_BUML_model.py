...
domain_model = DomainModel(
    name="petrinet",
    types={petrinet_PTArc, petrinet_TPArc, petrinet_Petrinet, petrinet_Place, petrinet_Transition, petrinet_Arc, petrinet_Token, Arc},
    associations={out7, in_8, in_9, out12, places0, transitions1, arcs3, tokens5, src15, trg16, src17, trg20},
