...
# Classes
missionsDSL_Robot = Class(name="missionsDSL_Robot")
missionsDSL_Mission = Class(name="missionsDSL_Mission")
missionsDSL_Condition = Class(name="missionsDSL_Condition")
missionsDSL_Action = Class(name="missionsDSL_Action")
missionsDSL_NewMissions = Class(name="missionsDSL_NewMissions")
missionsDSL_Value = Class(name="missionsDSL_Value")
...
missionsDSL_Robot.attributes={missionsDSL_Robot_slowSpeed, missionsDSL_Robot_maxAngle, missionsDSL_Robot_defaultSpeed, missionsDSL_Robot_minAngle, missionsDSL_Robot_refreshRate, missionsDSL_Robot_slaveAddress}
...
missionsDSL_Mission.attributes={missionsDSL_Mission_priority, missionsDSL_Mission_type, missionsDSL_Mission_name}
...
missionsDSL_Value.attributes={missionsDSL_Value_bool, missionsDSL_Value_integer, missionsDSL_Value_color}
...
domain_model = DomainModel(
    name="missionsDSL",
    types={missionsDSL_Robot, missionsDSL_Mission, missionsDSL_Condition, missionsDSL_Action, missionsDSL_NewMissions, missionsDSL_Value, MissionType, Sensor, Relation, EV3_ACTION, Color},
