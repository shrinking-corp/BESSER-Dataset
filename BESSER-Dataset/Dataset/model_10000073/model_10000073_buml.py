...
Customer_phoneVeified: Property = Property(name="phoneVeified", type=BooleanType)
Customer_emailVerified: Property = Property(name="emailVerified", type=BooleanType)
Customer.attributes={Customer_email, Customer_address, Customer_emailVerified, Customer_phone, Customer_phoneVeified}
...
Account.attributes={Account_closed, Account_isClosed, Account_billingAddress, Account_open}
...
WebUser_userType: Property = Property(name="userType", type=IntegerType)
WebUser.attributes={WebUser_login, WebUser_state, WebUser_password, WebUser_userType}
...
Order.attributes={Order_total, Order_shipped, Order_ordered, Order_number, Order_shipTo, Order_status}
...
domain_model = DomainModel(
    name="_0a5eb989_3e79_49b1_853b_00e8921c0349",
    types={Customer, Payment, ShoppingCart, Account, WebUser, Order, LineItem, Product, UserState, OrderStatus},
    associations={Account_Payment, WebUser_ShoppingCart, WebUser_Customer, Customer_Account, Account_ShoppingCart, ShoppingCart_LineItem, Payment_Order, Product_LineItem, Order_LineItem, Account_Order},
    generalizations={},
    metadata=None
)
