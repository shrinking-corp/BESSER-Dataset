...
class Order:
    ...
    def __init__(self, number: int, ordered: date, shipped: bool, shipTo: str, total: float, status: OrderStatus, payment19: "Payment" = None, items14: set["LineItem"] = None, account17: "Account" = None):
        self.number = number
...
class WebUser:
    ...
    def __init__(self, login: str, password: str, state: UserState, userType: int, shoppingCart2: "ShoppingCart" = None, customer4: "Customer" = None):
        self.login = login
    ...
    @userType.setter
    def userType(self, userType: int):
...
class Account:
    ...
    def __init__(self, billingAddress: str, open: date, closed: date, isClosed: bool, cart8: "ShoppingCart" = None, order16: set["Order"] = None, p0: set["Payment"] = None, customer7: "Customer" = None):
...
class ShoppingCart:
    ...
    def __init__(self, creationDate: date, account9: "Account" = None, items10: "LineItem" = None, webUser3: "WebUser" = None):
...
class Customer:
    ...
    def __init__(self, address: str, phone: str, email: str, phoneVeified: bool, emailVerified: bool, webUser5: "WebUser" = None, account6: "Account" = None):
        self.address = address
        self.phone = phone
        self.email = email
        self.phoneVeified = phoneVeified
        ...
        pass
    @property
    def phoneVeified(self):
        return self.__phoneVeified
    @phoneVeified.setter
    def phoneVeified(self, phoneVeified: bool):
        self.__phoneVeified = phoneVeified
    ...
    def emailVerified(self, emailVerified: bool):
