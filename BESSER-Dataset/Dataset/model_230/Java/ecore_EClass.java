...
public class ecore_EClass extends EClassifier {
    ...
    public ecore_EClass(
        boolean abstract,        boolean interface        ArrayList<ecore_EReference> ecore_ereferences,        ArrayList<ecore_EReference> ecore_ereferences,        ArrayList<ecore_EAttribute> ecore_eattributes,        ArrayList<ecore_EReference> ecore_ereferences,        ArrayList<ecore_EAttribute> ecore_eattributes,        ArrayList<ecore_EClass> ecore_eclasss    ) {
        this.abstract = abstract;
        this.interface = interface;
