...
ecore_EObject.methods={ecore_EObject_m_eResource, ecore_EObject_m_eCrossReferences, ecore_EObject_m_eGet, ecore_EObject_m_eInvoke, ecore_EObject_m_eIsProxy, ecore_EObject_m_eGet, ecore_EObject_m_eUnset, ecore_EObject_m_eClass, ecore_EObject_m_eContainmentFeature, ecore_EObject_m_eContents, ecore_EObject_m_eAllContents, ecore_EObject_m_eSet, ecore_EObject_m_eContainer, ecore_EObject_m_eContainingFeature, ecore_EObject_m_eIsSet}
...
ecore_EStructuralFeature.attributes={ecore_EStructuralFeature_volatile, ecore_EStructuralFeature_changeable, ecore_EStructuralFeature_unsettable, ecore_EStructuralFeature_defaultValueLiteral, ecore_EStructuralFeature_transient, ecore_EStructuralFeature_derived, ecore_EStructuralFeature_defaultValue}
...
ecore_ETypedElement.attributes={ecore_ETypedElement_unique, ecore_ETypedElement_upperBound, ecore_ETypedElement_ordered, ecore_ETypedElement_lowerBound}
...
domain_model = DomainModel(
    name="ecore",
    types={ecore_EAttribute, EStructuralFeature, ecore_EAnnotation, EModelElement, ecore_EStringToStringMapEntry, ecore_EModelElement, ecore_EObject, ecore_EClass, EClassifier, ecore_EGenericType, ecore_EClassifier, ENamedElement, ecore_EPackage, ecore_EDataType, ecore_EEnum, EDataType, ecore_EEnumLiteral, ecore_EFactory, ecore_ENamedElement, ecore_EOperation, ecore_EStructuralFeature, ETypedElement, ecore_ETypeParameter, ecore_EParameter, ecore_EReference, ecore_ETypedElement},
    associations={details0, eModelElement1, contents2, references4, eSuperTypes8, eGenericSuperTypes12, eAllGenericSuperTypes14, ePackage17, eLiterals18, eEnum19, ePackage20, eAnnotations22, eOperations9, eStructuralFeatures10, eContainingClass23, eTypeParameters24, eParameters25, eGenericExceptions26, eFactoryInstance29, eClassifiers30, eSubpackages33, eSuperPackage36, eOperation38, eContainingClass42, eType44, eGenericType45, eOpposite41, eUpperBound49, eTypeArguments52, eRawType54, eLowerBound58, eTypeParameter60, eClassifier63, eBounds66},
