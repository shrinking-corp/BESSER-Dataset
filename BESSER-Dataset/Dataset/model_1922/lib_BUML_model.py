...
# Classes
libraryElement_AdapterFBType = Class(name="libraryElement_AdapterFBType")
libraryElement_Algorithm = Class(name="libraryElement_Algorithm", is_abstract=True)
INamedElement = Class(name="INamedElement")
libraryElement_Application = Class(name="libraryElement_Application")
libraryElement_FBNetwork = Class(name="libraryElement_FBNetwork")
libraryElement_BasicFBType = Class(name="libraryElement_BasicFBType")
FBType = Class(name="FBType")
libraryElement_ECC = Class(name="libraryElement_ECC")
libraryElement_VarDeclaration = Class(name="libraryElement_VarDeclaration")
libraryElement_CompilerInfo = Class(name="libraryElement_CompilerInfo")
libraryElement_Compiler = Class(name="libraryElement_Compiler")
libraryElement_AdapterDeclaration = Class(name="libraryElement_AdapterDeclaration")
VarDeclaration = Class(name="VarDeclaration")
libraryElement_AdapterFB = Class(name="libraryElement_AdapterFB")
libraryElement_AdapterTypePaletteEntry = Class(name="libraryElement_AdapterTypePaletteEntry")
libraryElement_AdapterType = Class(name="libraryElement_AdapterType")
DataType = Class(name="DataType")
libraryElement_Connection = Class(name="libraryElement_Connection", is_abstract=True)
ConfigurableObject = Class(name="ConfigurableObject")
libraryElement_IInterfaceElement = Class(name="libraryElement_IInterfaceElement", is_abstract=True)
libraryElement_Device = Class(name="libraryElement_Device")
...
libraryElement_Link = Class(name="libraryElement_Link")
libraryElement_DeviceType = Class(name="libraryElement_DeviceType")
CompilableType = Class(name="CompilableType")
libraryElement_ResourceTypeName = Class(name="libraryElement_ResourceTypeName")
libraryElement_ECAction = Class(name="libraryElement_ECAction")
libraryElement_Event = Class(name="libraryElement_Event")
libraryElement_ECState = Class(name="libraryElement_ECState")
libraryElement_ECTransition = Class(name="libraryElement_ECTransition")
libraryElement_Resource = Class(name="libraryElement_Resource")
IInterfaceElement = Class(name="IInterfaceElement")
libraryElement_With = Class(name="libraryElement_With")
libraryElement_FB = Class(name="libraryElement_FB")
FBNetworkElement = Class(name="FBNetworkElement")
libraryElement_FBNetworkElement = Class(name="libraryElement_FBNetworkElement")
libraryElement_InterfaceList = Class(name="libraryElement_InterfaceList")
libraryElement_Mapping = Class(name="libraryElement_Mapping")
libraryElement_SubApp = Class(name="libraryElement_SubApp")
libraryElement_FBType = Class(name="libraryElement_FBType")
libraryElement_InputPrimitive = Class(name="libraryElement_InputPrimitive")
Primitive = Class(name="Primitive")
libraryElement_Service = Class(name="libraryElement_Service")
libraryElement_Identification = Class(name="libraryElement_Identification")
libraryElement_Segment = Class(name="libraryElement_Segment")
libraryElement_OtherAlgorithm = Class(name="libraryElement_OtherAlgorithm")
TextAlgorithm = Class(name="TextAlgorithm")
libraryElement_OutputPrimitive = Class(name="libraryElement_OutputPrimitive")
libraryElement_Parameter = Class(name="libraryElement_Parameter")
libraryElement_ResourceType = Class(name="libraryElement_ResourceType")
libraryElement_ServiceSequence = Class(name="libraryElement_ServiceSequence")
libraryElement_ServiceTransaction = Class(name="libraryElement_ServiceTransaction")
libraryElement_ServiceInterfaceFBType = Class(name="libraryElement_ServiceInterfaceFBType")
libraryElement_DataConnection = Class(name="libraryElement_DataConnection")
libraryElement_EventConnection = Class(name="libraryElement_EventConnection")
libraryElement_AdapterConnection = Class(name="libraryElement_AdapterConnection")
libraryElement_SubAppType = Class(name="libraryElement_SubAppType")
CompositeFBType = Class(name="CompositeFBType")
libraryElement_AutomationSystem = Class(name="libraryElement_AutomationSystem")
LibraryElement = Class(name="LibraryElement")
libraryElement_STAlgorithm = Class(name="libraryElement_STAlgorithm")
libraryElement_VarInitialization = Class(name="libraryElement_VarInitialization")
libraryElement_VersionInfo = Class(name="libraryElement_VersionInfo")
libraryElement_LibraryElement = Class(name="libraryElement_LibraryElement")
libraryElement_PaletteEntry = Class(name="libraryElement_PaletteEntry")
libraryElement_CompilableType = Class(name="libraryElement_CompilableType")
libraryElement_ConfigurableObject = Class(name="libraryElement_ConfigurableObject")
libraryElement_Palette = Class(name="libraryElement_Palette")
libraryElement_SystemConfiguration = Class(name="libraryElement_SystemConfiguration")
libraryElement_TextAlgorithm = Class(name="libraryElement_TextAlgorithm", is_abstract=True)
Algorithm = Class(name="Algorithm")
Connection = Class(name="Connection")
libraryElement_ServiceInterface = Class(name="libraryElement_ServiceInterface")
libraryElement_DataType = Class(name="libraryElement_DataType")
libraryElement_Value = Class(name="libraryElement_Value")
libraryElement_CompositeFBType = Class(name="libraryElement_CompositeFBType")
libraryElement_INamedElement = Class(name="libraryElement_INamedElement", is_abstract=True)
libraryElement_ResourceTypeFB = Class(name="libraryElement_ResourceTypeFB")
FB = Class(name="FB")
libraryElement_I4DIACElement = Class(name="libraryElement_I4DIACElement", is_abstract=True)
libraryElement_Annotation = Class(name="libraryElement_Annotation")
libraryElement_SegmentType = Class(name="libraryElement_SegmentType")
I4DIACElement = Class(name="I4DIACElement")
libraryElement_AdapterEvent = Class(name="libraryElement_AdapterEvent")
Event = Class(name="Event")
libraryElement_TypedConfigureableObject = Class(name="libraryElement_TypedConfigureableObject")
libraryElement_Primitive = Class(name="libraryElement_Primitive")
libraryElement_PositionableElement = Class(name="libraryElement_PositionableElement")
libraryElement_Color = Class(name="libraryElement_Color")
libraryElement_ColorizableElement = Class(name="libraryElement_ColorizableElement")
libraryElement_IVarElement = Class(name="libraryElement_IVarElement", is_abstract=True)
...
libraryElement_FBNetwork_m_getFBNamed: Method = Method(name="getFBNamed", parameters={Parameter(name='libraryElement_name', type=StringType)}, type=StringType)
libraryElement_FBNetwork_m_getSubAppNamed: Method = Method(name="getSubAppNamed", parameters={Parameter(name='libraryElement_name', type=StringType)}, type=StringType)
libraryElement_FBNetwork_m_getElementNamed: Method = Method(name="getElementNamed", parameters={Parameter(name='libraryElement_name', type=StringType)}, type=FBNetworkElement)
libraryElement_FBNetwork_m_addConnection: Method = Method(name="addConnection", parameters={Parameter(name='libraryElement_connection', type=StringType)})
libraryElement_FBNetwork_m_removeConnection: Method = Method(name="removeConnection", parameters={Parameter(name='libraryElement_connection', type=StringType)})
...
libraryElement_FBNetwork.methods={libraryElement_FBNetwork_m_getElementNamed, libraryElement_FBNetwork_m_isSubApplicationNetwork, libraryElement_FBNetwork_m_isResourceNetwork, libraryElement_FBNetwork_m_getSubAppNamed, libraryElement_FBNetwork_m_isCFBTypeNetwork, libraryElement_FBNetwork_m_getAutomationSystem, libraryElement_FBNetwork_m_getFBNamed, libraryElement_FBNetwork_m_getApplication, libraryElement_FBNetwork_m_addConnection, libraryElement_FBNetwork_m_isApplicationNetwork, libraryElement_FBNetwork_m_removeConnection}
...
libraryElement_CompilerInfo.attributes={libraryElement_CompilerInfo_header, libraryElement_CompilerInfo_classdef}
...
libraryElement_Compiler.attributes={libraryElement_Compiler_version, libraryElement_Compiler_vendor, libraryElement_Compiler_language, libraryElement_Compiler_product}
...
libraryElement_AdapterFB.methods={libraryElement_AdapterFB_m_isPlug, libraryElement_AdapterFB_m_getType, libraryElement_AdapterFB_m_isSocket}
...
libraryElement_AdapterType.methods={libraryElement_AdapterType_m_getInterfaceList, libraryElement_AdapterType_m_getPlugType, libraryElement_AdapterType_m_getSocketType}
...
libraryElement_Connection.attributes={libraryElement_Connection_resTypeConnection, libraryElement_Connection_brokenConnection, libraryElement_Connection_dx2, libraryElement_Connection_dy, libraryElement_Connection_dx1}
libraryElement_Connection.methods={libraryElement_Connection_m_checkIfConnectionBroken, libraryElement_Connection_m_getSourceElement, libraryElement_Connection_m_isResourceConnection, libraryElement_Connection_m_getDestinationElement, libraryElement_Connection_m_getFBNetwork}
...
libraryElement_IInterfaceElement.attributes={libraryElement_IInterfaceElement_isInput, libraryElement_IInterfaceElement_typeName}
...
libraryElement_Device_m_getResourceNamed: Method = Method(name="getResourceNamed", parameters={Parameter(name='libraryElement_name', type=StringType)}, type=StringType)
libraryElement_Device.attributes={libraryElement_Device_profile}
libraryElement_Device.methods={libraryElement_Device_m_getAutomationSystem, libraryElement_Device_m_getResourceNamed, libraryElement_Device_m_getType, libraryElement_Device_m_getSystemConfiguration}
...
libraryElement_Resource.attributes={libraryElement_Resource_y, libraryElement_Resource_x, libraryElement_Resource_deviceTypeResource}
...
libraryElement_FBNetworkElement_m_getInterfaceElement: Method = Method(name="getInterfaceElement", parameters={Parameter(name='libraryElement_name', type=StringType)}, type=IInterfaceElement)
...
libraryElement_FBNetworkElement.methods={libraryElement_FBNetworkElement_m_getFbNetwork, libraryElement_FBNetworkElement_m_isMapped, libraryElement_FBNetworkElement_m_getInterfaceElement, libraryElement_FBNetworkElement_m_getResource, libraryElement_FBNetworkElement_m_checkConnections, libraryElement_FBNetworkElement_m_getOpposite}
...
libraryElement_InterfaceList_m_getEvent: Method = Method(name="getEvent", parameters={Parameter(name='libraryElement_name', type=StringType)}, type=StringType)
libraryElement_InterfaceList_m_getVariable: Method = Method(name="getVariable", parameters={Parameter(name='libraryElement_name', type=StringType)}, type=VarDeclaration)
libraryElement_InterfaceList_m_getInterfaceElement: Method = Method(name="getInterfaceElement", parameters={Parameter(name='libraryElement_name', type=StringType)}, type=IInterfaceElement)
...
libraryElement_InterfaceList.methods={libraryElement_InterfaceList_m_getFBNetworkElement, libraryElement_InterfaceList_m_getEvent, libraryElement_InterfaceList_m_getVariable, libraryElement_InterfaceList_m_getAllInterfaceElements, libraryElement_InterfaceList_m_getInterfaceElement}
...
libraryElement_Identification.attributes={libraryElement_Identification_type, libraryElement_Identification_standard, libraryElement_Identification_description, libraryElement_Identification_function, libraryElement_Identification_classification, libraryElement_Identification_applicationDomain}
...
libraryElement_Parameter.attributes={libraryElement_Parameter_name, libraryElement_Parameter_comment, libraryElement_Parameter_value}
...
libraryElement_DataConnection.methods={libraryElement_DataConnection_m_getSource, libraryElement_DataConnection_m_getDestination}
...
libraryElement_EventConnection.methods={libraryElement_EventConnection_m_getDestination, libraryElement_EventConnection_m_getSource}
...
libraryElement_AdapterConnection.methods={libraryElement_AdapterConnection_m_getDestination, libraryElement_AdapterConnection_m_getSource}
...
libraryElement_AutomationSystem_m_getDeviceNamed: Method = Method(name="getDeviceNamed", parameters={Parameter(name='libraryElement_name', type=StringType)}, type=StringType)
libraryElement_AutomationSystem_m_getApplicationNamed: Method = Method(name="getApplicationNamed", parameters={Parameter(name='libraryElement_name', type=StringType)}, type=StringType)
libraryElement_AutomationSystem.attributes={libraryElement_AutomationSystem_project}
libraryElement_AutomationSystem.methods={libraryElement_AutomationSystem_m_getDeviceNamed, libraryElement_AutomationSystem_m_getApplicationNamed}
...
libraryElement_VersionInfo.attributes={libraryElement_VersionInfo_version, libraryElement_VersionInfo_remarks, libraryElement_VersionInfo_author, libraryElement_VersionInfo_organization, libraryElement_VersionInfo_date}
...
libraryElement_ConfigurableObject_m_setParameter: Method = Method(name="setParameter", parameters={Parameter(name='libraryElement_parameterName', type=StringType), Parameter(name='libraryElement_value', type=StringType)})
libraryElement_ConfigurableObject_m_getParameter: Method = Method(name="getParameter", parameters={Parameter(name='libraryElement_parameterName', type=StringType)}, type=StringType)
...
libraryElement_SystemConfiguration_m_getSegmentNamed: Method = Method(name="getSegmentNamed", parameters={Parameter(name='libraryElement_name', type=StringType)}, type=StringType)
libraryElement_SystemConfiguration_m_getDeviceNamed: Method = Method(name="getDeviceNamed", parameters={Parameter(name='libraryElement_name', type=StringType)}, type=StringType)
libraryElement_SystemConfiguration.methods={libraryElement_SystemConfiguration_m_getSegmentNamed, libraryElement_SystemConfiguration_m_getDeviceNamed, libraryElement_SystemConfiguration_m_getAutomationSystem}
...
libraryElement_I4DIACElement_m_createAnnotation: Method = Method(name="createAnnotation", parameters={Parameter(name='libraryElement_name', type=StringType)}, type=StringType)
libraryElement_I4DIACElement_m_removeAnnotation: Method = Method(name="removeAnnotation", parameters={Parameter(name='libraryElement_annotation', type=StringType)})
libraryElement_I4DIACElement.methods={libraryElement_I4DIACElement_m_removeAnnotation, libraryElement_I4DIACElement_m_createAnnotation}
...
libraryElement_Annotation.attributes={libraryElement_Annotation_name, libraryElement_Annotation_servity}
...
libraryElement_TypedConfigureableObject.methods={libraryElement_TypedConfigureableObject_m_getTypeName, libraryElement_TypedConfigureableObject_m_getType}
...
libraryElement_Primitive.attributes={libraryElement_Primitive_event, libraryElement_Primitive_parameters}
...
libraryElement_PositionableElement.attributes={libraryElement_PositionableElement_x, libraryElement_PositionableElement_y}
...
libraryElement_Color.attributes={libraryElement_Color_blue, libraryElement_Color_green, libraryElement_Color_red}
...
with_48: BinaryAssociation = BinaryAssociation(
    name="with_48",
    ends={
...
from_79: BinaryAssociation = BinaryAssociation(
    name="from_79",
    ends={
...
domain_model = DomainModel(
    name="libraryElement",
    types={libraryElement_AdapterFBType, libraryElement_Algorithm, INamedElement, libraryElement_Application, libraryElement_FBNetwork, libraryElement_BasicFBType, FBType, libraryElement_ECC, libraryElement_VarDeclaration, libraryElement_CompilerInfo, libraryElement_Compiler, libraryElement_AdapterDeclaration, VarDeclaration, libraryElement_AdapterFB, libraryElement_AdapterTypePaletteEntry, libraryElement_AdapterType, DataType, libraryElement_Connection, ConfigurableObject, libraryElement_IInterfaceElement, libraryElement_Device, TypedConfigureableObject, PositionableElement, ColorizableElement, IVarElement, libraryElement_Link, libraryElement_DeviceType, CompilableType, libraryElement_ResourceTypeName, libraryElement_ECAction, libraryElement_Event, libraryElement_ECState, libraryElement_ECTransition, libraryElement_Resource, IInterfaceElement, libraryElement_With, libraryElement_FB, FBNetworkElement, libraryElement_FBNetworkElement, libraryElement_InterfaceList, libraryElement_Mapping, libraryElement_SubApp, libraryElement_FBType, libraryElement_InputPrimitive, Primitive, libraryElement_Service, libraryElement_Identification, libraryElement_Segment, libraryElement_OtherAlgorithm, TextAlgorithm, libraryElement_OutputPrimitive, libraryElement_Parameter, libraryElement_ResourceType, libraryElement_ServiceSequence, libraryElement_ServiceTransaction, libraryElement_ServiceInterfaceFBType, libraryElement_DataConnection, libraryElement_EventConnection, libraryElement_AdapterConnection, libraryElement_SubAppType, CompositeFBType, libraryElement_AutomationSystem, LibraryElement, libraryElement_STAlgorithm, libraryElement_VarInitialization, libraryElement_VersionInfo, libraryElement_LibraryElement, libraryElement_PaletteEntry, libraryElement_CompilableType, libraryElement_ConfigurableObject, libraryElement_Palette, libraryElement_SystemConfiguration, libraryElement_TextAlgorithm, Algorithm, Connection, libraryElement_ServiceInterface, libraryElement_DataType, libraryElement_Value, libraryElement_CompositeFBType, libraryElement_INamedElement, libraryElement_ResourceTypeFB, FB, libraryElement_I4DIACElement, libraryElement_Annotation, libraryElement_SegmentType, I4DIACElement, libraryElement_AdapterEvent, Event, libraryElement_TypedConfigureableObject, libraryElement_Primitive, libraryElement_PositionableElement, libraryElement_Color, libraryElement_ColorizableElement, libraryElement_IVarElement, Language},
    associations={adapterFBType2, fBNetwork3, eCC4, algorithm5, internalVars7, compiler9, adapterFB0, paletteEntry1, source10, destination11, inConnections14, varDeclaration16, resourceTypeName18, resource20, fBNetwork22, algorithm25, output27, eCState29, eCTransition31, start33, resource13, source42, destination43, conditionEvent45, with_48, eCAction36, outTransitions39, inTransitions40, interface50, mapping51, subAppNetwork53, interfaceList55, plugs59, sockets62, eventInputs65, service57, segment77, device78, from_79, to82, eventOutputs68, inputVars71, outputVars74, varDeclaration90, fBNetwork92, supportedFBTypes95, varDeclarations98, outConnections100, serviceTransaction102, inputPrimitive103, outputPrimitive105, fBNetwork85, device88, networkElements107, dataConnections110, eventConnections112, adapterConnections114, varInitialization124, withs126, variables127, versionInfo128, identification129, paletteEntry131, compilerInfo132, application116, mapping118, palette121, systemConfiguration122, inputConnections137, outputConnections139, type142, value143, parameter134, fBNetwork135, links150, annotations152, devices145, segments147, varDeclaration153, adapterType155, adapterDeclaration158, rightInterface160, leftInterface162, serviceSequence165, interface170, color172, varDeclarations173, paletteEntry168, adapterDecl169},
    generalizations={gen_libraryElement_Algorithm_INamedElement, gen_libraryElement_Application_INamedElement, gen_libraryElement_BasicFBType_FBType, gen_libraryElement_AdapterDeclaration_VarDeclaration, gen_libraryElement_AdapterType_DataType, gen_libraryElement_Connection_ConfigurableObject, gen_libraryElement_Device_TypedConfigureableObject, gen_libraryElement_Device_PositionableElement, gen_libraryElement_Device_ColorizableElement, gen_libraryElement_Device_IVarElement, gen_libraryElement_DeviceType_CompilableType, gen_libraryElement_Event_IInterfaceElement, gen_libraryElement_FB_FBNetworkElement, gen_libraryElement_FBNetworkElement_TypedConfigureableObject, gen_libraryElement_FBNetworkElement_PositionableElement, gen_libraryElement_ECState_INamedElement, gen_libraryElement_ECState_PositionableElement, gen_libraryElement_ECTransition_PositionableElement, gen_libraryElement_SubApp_FBNetworkElement, gen_libraryElement_FBType_CompilableType, gen_libraryElement_InputPrimitive_Primitive, gen_libraryElement_Link_ConfigurableObject, gen_libraryElement_OtherAlgorithm_TextAlgorithm, gen_libraryElement_OutputPrimitive_Primitive, gen_libraryElement_Resource_TypedConfigureableObject, gen_libraryElement_Resource_IVarElement, gen_libraryElement_ResourceType_CompilableType, gen_libraryElement_Segment_TypedConfigureableObject, gen_libraryElement_Segment_PositionableElement, gen_libraryElement_Segment_ColorizableElement, gen_libraryElement_ServiceSequence_INamedElement, gen_libraryElement_ServiceInterfaceFBType_FBType, gen_libraryElement_SubAppType_CompositeFBType, gen_libraryElement_AutomationSystem_LibraryElement, gen_libraryElement_STAlgorithm_TextAlgorithm, gen_libraryElement_LibraryElement_INamedElement, gen_libraryElement_CompilableType_LibraryElement, gen_libraryElement_ConfigurableObject_INamedElement, gen_libraryElement_VarDeclaration_IInterfaceElement, gen_libraryElement_TextAlgorithm_Algorithm, gen_libraryElement_DataConnection_Connection, gen_libraryElement_EventConnection_Connection, gen_libraryElement_AdapterConnection_Connection, gen_libraryElement_ServiceInterface_INamedElement, gen_libraryElement_IInterfaceElement_INamedElement, gen_libraryElement_CompositeFBType_FBType, gen_libraryElement_INamedElement_I4DIACElement, gen_libraryElement_ResourceTypeFB_FB, gen_libraryElement_SegmentType_CompilableType, gen_libraryElement_SystemConfiguration_I4DIACElement, gen_libraryElement_AdapterFBType_FBType, gen_libraryElement_AdapterEvent_Event, gen_libraryElement_Service_I4DIACElement, gen_libraryElement_TypedConfigureableObject_ConfigurableObject, gen_libraryElement_AdapterFB_FB},
    metadata=None
)
