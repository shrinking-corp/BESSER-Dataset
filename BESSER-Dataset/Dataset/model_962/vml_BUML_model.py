...
vml_Diagram = Class(name="vml_Diagram")
...
vml_Pie.attributes={vml_Pie_title, vml_Pie_ID}
...
domain_model = DomainModel(
    name="vml",
    types={vml_Slice, vml_Model, vml_Diagram, vml_Pie, vml_Graph, vml_Node, vml_Edge},
    associations={graph3, slices5, diagrams0, pies1, nodes7, edges9, outgoing11, incoming12, source14, target15},
    generalizations={},
    metadata=None
)
