...
class vml_Pie:
    ...
    def __init__(self, ID: str, title: str, vml_Pie6: set["vml_Slice"] = None, vml_Pie: "vml_Diagram" = None):
        self.ID = ID
        self.title = title
...
class vml_Diagram:
    ...
    def __init__(self, title: str, vml_Diagram4: set["vml_Graph"] = None, vml_Diagram: "vml_Model" = None, vml_Diagram2: set["vml_Pie"] = None):
        self.title = title
