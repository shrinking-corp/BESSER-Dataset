...
# Classes
PK461726_A461726 = Class(name="PK461726_A461726")
PK461726_B461726 = Class(name="PK461726_B461726")
...
bs0: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="as_", type=PK461726_B461726, multiplicity=Multiplicity(0, 9999))
    }
)
...
domain_model = DomainModel(
    name="PK461726",
    types={PK461726_A461726, PK461726_B461726},
    associations={bs0, as_1},
    generalizations={},
    metadata=None
)
