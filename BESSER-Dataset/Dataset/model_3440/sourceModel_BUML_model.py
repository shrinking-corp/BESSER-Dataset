...
# Classes
SourceModel_Container = Class(name="SourceModel_Container")
SourceModel_Person = Class(name="SourceModel_Person", is_abstract=True)
SourceModel_Student = Class(name="SourceModel_Student")
Person = Class(name="Person")
SourceModel_Professor = Class(name="SourceModel_Professor")
SourceModel_MasterStudent = Class(name="SourceModel_MasterStudent")
Student = Class(name="Student")
SourceModel_BachelorStudent = Class(name="SourceModel_BachelorStudent")
