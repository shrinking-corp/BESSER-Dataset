...
class model_Bounds:
    ...
    def __init__(self, y: int, width: int, height: int, x: int, model_Bounds: "model_DiagramModelObject" = None):
        self.y = y
        self.width = width
        self.height = height
        self.x = x
    ...
    def setSize(self, model_width, model_height):
        # TODO: Implement setSize method
        pass

    def setLocation(self, model_x, model_y):
...
class DiagramModelObject:
    ...
    pass
class model_DiagramModelImage(DiagramModelImageProvider, BorderObject, DiagramModelObject):
...
class model_Connectable(DiagramModelComponent):
    ...
    def __init__(self, model_Connectable14: set["model_DiagramModelConnection"] = None, model_Connectable: set["model_DiagramModelConnection"] = None, model_Connectable22: "model_DiagramModelConnection" = None, model_Connectable25: "model_DiagramModelConnection" = None):
...
class DiagramModelContainer:
    ...
    pass
class model_DiagramModelArchimateObject(DiagramModelContainer, TextPosition, DiagramModelArchimateComponent, DiagramModelObject):
...
class model_DiagramModelObject(Connectable, FontAttribute, TextAlignment, LineObject):
    ...
    def setBounds(self, model_height, model_width, model_x, model_y):
...
class Adapter:
    ...
    pass
class model_DiagramModelComponent(Nameable, Cloneable, Identifier, ArchimateModelObject, Adapter):
...
class Properties:
    ...
    pass
class model_SketchModelSticky(DiagramModelObject, DiagramModelContainer, TextPosition, TextContent, Properties):
...
class model_DiagramModelGroup(DiagramModelContainer, Documentable, DiagramModelObject, Properties):
    ...
    pass
class model_DiagramModelConnection(FontAttribute, Connectable, LineObject, Properties, Documentable):

    def __init__(self, text: str, textPosition: int, type: int, model_DiagramModelConnection15: "model_Connectable" = None, model_DiagramModelConnection: "model_Connectable" = None, model_DiagramModelConnection21: "model_Connectable" = None, model_DiagramModelConnection24: "model_Connectable" = None, model_DiagramModelConnection27: set["model_DiagramModelBendpoint"] = None):
        self.text = text
        self.textPosition = textPosition
        self.type = type
...
class model_SketchModelActor(Documentable, DiagramModelObject, Properties):
    ...
    pass
class model_ArchimateConcept(Documentable, ArchimateModelObject, Cloneable, Properties):
...
class model_Adapter(ABC):
    ...
    def setAdapter(self, model_object, model_adapter):
