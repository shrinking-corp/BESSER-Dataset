...
class library_Lendable(ABC):
    ...
    def __init__(self, copies: int, Lendable: "library_Borrower" = None, borrowing: set["library_Borrower"] = None):
        self.copies = copies
...
class library_IncBook(CirculatingItem):
    ...
    def __init__(self, title: str, pages: int, books: set["library_Writer"] = None, IncBook: "library_Writer" = None):
        self.title = title
        self.pages = pages
