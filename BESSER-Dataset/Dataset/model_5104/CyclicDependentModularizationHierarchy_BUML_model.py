...
# Classes
testPackage_AnotherType = Class(name="testPackage_AnotherType")
testPackage_SubType = Class(name="testPackage_SubType")
SuperType = Class(name="SuperType")
testPackage_AnotherType2 = Class(name="testPackage_AnotherType2")
testPackage_SuperType = Class(name="testPackage_SuperType")
...
domain_model = DomainModel(
    name="testPackage",
    types={testPackage_AnotherType, testPackage_SubType, SuperType, testPackage_AnotherType2, testPackage_SuperType},
