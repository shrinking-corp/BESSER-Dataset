...
class Sleeper:
    ...
    def __init__(self, builder: TrainBuilder_Interface, sleeperTrain: str, trainBuilder16: set["TrainBuilder_Interface"] = None, trainBuilder4: "TrainBuilder_Interface" = None):
...
class InterCity:
    ...
    def __init__(self, builder: TrainBuilder_Interface, interCityTrain: str, trainBuilder14: set["TrainBuilder_Interface"] = None, trainBuilder6: "TrainBuilder_Interface" = None):
        self.builder = builder
...
class Commutator:
    ...
    def __init__(self, builder: TrainBuilder_Interface, commutatorTrain: str, trainBuilder18: set["TrainBuilder_Interface"] = None, trainBuilder8: "TrainBuilder_Interface" = None):
        self.builder = builder
...
class Service:
    ...
    def __init__(self, type: ServiceType_Interface, arrivalDateTime: str, departureDateTime: str, serviceName: str, serviceId: int, route10: "Route" = None, trainStats13: "TrainStats" = None, serviceTypeFactory0: set["ServiceTypeFactory"] = None):
        self.type = type
