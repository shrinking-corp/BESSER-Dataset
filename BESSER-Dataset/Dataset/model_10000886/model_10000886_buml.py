...
Customer.attributes={Customer_customerName, Customer_customerID, Customer_phoneNumber}
...
Order.attributes={Order_date, Order_creditCardDetails, Order_orderID, Order_time, Order_orderNotes}
...
Pizza.attributes={Pizza_isVegetarian, Pizza_price}
...
Sides.attributes={Sides_name, Sides_isVegetarian, Sides_price}
...
Address.attributes={Address_Line_2, Address_County, Address_Line1, Address_City}
...
MealDeal.attributes={MealDeal_description, MealDeal_isVegetarian, MealDeal_price, MealDeal_name}
...
domain_model = DomainModel(
    name="_6bb78e6e_7df3_4e71_8ecf_bac7e7130e23",
    types={Customer, Order, GPSLocation, Pizza, Toppings, Sides, Address, Base, MealDeal},
    associations={Pizza_Base, Order_Pizza, Order_GPS_Location, Pizza_Toppings, Order_Customer, Order_Sides, Customer_Address, MealDeal_Sides, MealDeal_Pizza, Order_MealDeal, Order_Address},
    generalizations={},
    metadata=None
)
