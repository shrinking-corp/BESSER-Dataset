...
# Classes
location_Location = Class(name="location_Location")
location_Area = Class(name="location_Area")
...
location_Location_m_containsPoint: Method = Method(name="containsPoint", parameters={Parameter(name='location_point', type=StringType)}, type=BooleanType)
location_Location_m_locate: Method = Method(name="locate", parameters={Parameter(name='location_point', type=StringType)}, type=StringType)
location_Location_m_getCoordinates: Method = Method(name="getCoordinates", parameters={}, type=StringType)
location_Location.attributes={location_Location_longitude, location_Location_name, location_Location_comments, location_Location_description, location_Location_street, location_Location_postalCode, location_Location_country, location_Location_altitudeMode, location_Location_city, location_Location_altitude, location_Location_latitude, location_Location_state, location_Location_phoneNumber}
location_Location.methods={location_Location_m_containsPoint, location_Location_m_getAddress, location_Location_m_locate, location_Location_m_getCoordinates}
...
location_Area_m_containsPoint: Method = Method(name="containsPoint", parameters={Parameter(name='location_point', type=StringType)}, type=BooleanType)
location_Area.attributes={location_Area_name, location_Area_comments, location_Area_boundary}
location_Area.methods={location_Area_m_getAreaMeasurement, location_Area_m_containsPoint}
