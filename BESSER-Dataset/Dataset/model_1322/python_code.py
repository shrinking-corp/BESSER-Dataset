...
class stateMachine_FieldState:
    ...
    def __init__(self, state: str, stateMachine_FieldState: "stateMachine_State" = None, stateMachine_FieldState23: "stateMachine_DocumentField" = None):
        self.state = state
...
class stateMachine_Role:
    ...
    def __init__(self, name: str, stateMachine_Role30: "stateMachine_TransSet" = None, stateMachine_Role: "stateMachine_StateMachine" = None):
        self.name = name
...
class stateMachine_DocumentField:
    ...
    def __init__(self, name: str, stateMachine_DocumentField: "stateMachine_StateMachine" = None, stateMachine_DocumentField24: "stateMachine_FieldState" = None):
        self.name = name
...
class stateMachine_State:
    ...
    def __init__(self, name: str, stateMachine_State11: set["stateMachine_Trans"] = None, stateMachine_State13: set["stateMachine_FieldState"] = None, stateMachine_State15: set["stateMachine_TransSet"] = None, stateMachine_State21: "stateMachine_Trans" = None, stateMachine_State: "stateMachine_StateMachine" = None, stateMachine_State5: "stateMachine_StateMachine" = None):
        self.name = name
...
class stateMachine_Event:
    ...
    def __init__(self, name: str, stateMachine_Event18: "stateMachine_Trans" = None, stateMachine_Event: "stateMachine_StateMachine" = None):
        self.name = name
...
class stateMachine_StateMachine:
    ...
    def __init__(self, name: str, package: str, stateMachine_StateMachine9: set["stateMachine_Role"] = None, stateMachine_StateMachine: set["stateMachine_Event"] = None, stateMachine_StateMachine2: set["stateMachine_State"] = None, stateMachine_StateMachine4: "stateMachine_State" = None, stateMachine_StateMachine7: set["stateMachine_DocumentField"] = None):
        self.name = name
