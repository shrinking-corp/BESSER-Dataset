...
@given(instance=application_Mashup_strategy)
def test_hyp_application_mashup_keepDeletedItemsList_setter(instance):
...
def test_application_Mashup_backupDataSet_value_roundtrip():
    instance = application_Mashup(backupDataSet="sample_text", backupIntervall="sample_text", cacheAttachments="sample_text", cacheDataSet="sample_text", cacheDelay="sample_text", keepDeletedItemsList="sample_text", sourceIdentCounter="sample_text", workingDirectory="sample_text")
...
def test_application_Mashup_keepDeletedItemsList_value_roundtrip():
    instance = application_Mashup(backupDataSet="sample_text", backupIntervall="sample_text", cacheAttachments="sample_text", cacheDataSet="sample_text", cacheDelay="sample_text", keepDeletedItemsList="sample_text", sourceIdentCounter="sample_text", workingDirectory="sample_text")
...
def test_assoc_configurableMashups32_link_reassign_clear():
    ...
    b1 = application_Mashup(backupDataSet="sample_text", backupIntervall="sample_text", cacheAttachments="sample_text", cacheDataSet="sample_text", cacheDelay="sample_text", keepDeletedItemsList="sample_text", sourceIdentCounter="sample_text", workingDirectory="sample_text")
    b2 = application_Mashup(backupDataSet="sample_text_2", backupIntervall="sample_text_2", cacheAttachments="sample_text_2", cacheDataSet="sample_text_2", cacheDelay="sample_text_2", keepDeletedItemsList="sample_text_2", sourceIdentCounter="sample_text_2", workingDirectory="sample_text_2")
...
def test_assoc_interfaces6_link_reassign_clear():
    a = application_Mashup(backupDataSet="sample_text", backupIntervall="sample_text", cacheAttachments="sample_text", cacheDataSet="sample_text", cacheDelay="sample_text", keepDeletedItemsList="sample_text", sourceIdentCounter="sample_text", workingDirectory="sample_text")
    b1 = application_Interface(frontEndCaching="sample_text", urlSuffix="sample_text")
    b2 = application_Interface(frontEndCaching="sample_text_2", urlSuffix="sample_text_2")
...
application_Mashup_strategy = st.builds(application_Mashup, backupDataSet=safe_text, backupIntervall=safe_text, cacheAttachments=safe_text, cacheDataSet=safe_text, cacheDelay=safe_text, keepDeletedItemsList=safe_text, sourceIdentCounter=safe_text, workingDirectory=safe_text)
@given(instance=application_Mashup_strategy)
@settings(max_examples=25)
