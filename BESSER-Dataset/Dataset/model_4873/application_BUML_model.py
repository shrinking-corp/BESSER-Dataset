...
application_Persistency = Class(name="application_Persistency")
application_DataSet = Class(name="application_DataSet")
application_Mashup = Class(name="application_Mashup")
Source = Class(name="Source")
application_MappingRule = Class(name="application_MappingRule")
application_Interface = Class(name="application_Interface", is_abstract=True)
application_MashupAdmin = Class(name="application_MashupAdmin")
application_Source = Class(name="application_Source")
application_Configuration = Class(name="application_Configuration")
application_Property = Class(name="application_Property")
application_XMLFile = Class(name="application_XMLFile")
Persistency = Class(name="Persistency")
application_Database = Class(name="application_Database")
application_OCLRestrictedProperty = Class(name="application_OCLRestrictedProperty")
Property_ = Class(name="Property")
application_MashupContainer = Class(name="application_MashupContainer")
application_Security = Class(name="application_Security", is_abstract=True)
application_RESTInterface = Class(name="application_RESTInterface")
Interface = Class(name="Interface")
application_FEEDInterface = Class(name="application_FEEDInterface")
application_OAuthConfig = Class(name="application_OAuthConfig")
Security = Class(name="Security")
application_OAuthClientConfig = Class(name="application_OAuthClientConfig")
application_OAuthAdmin = Class(name="application_OAuthAdmin")
application_ApplicationKeyConfig = Class(name="application_ApplicationKeyConfig")
application_OAuthClientScope = Class(name="application_OAuthClientScope")
application_ConfigurableElement = Class(name="application_ConfigurableElement", is_abstract=True)
...
application_Mashup_m_getSourceWithIdent: Method = Method(name="getSourceWithIdent", parameters={Parameter(name='application_ident', type=StringType)}, type=Source)
application_Mashup.attributes={application_Mashup_backupDataSet, application_Mashup_cacheDataSet, application_Mashup_workingDirectory, application_Mashup_cacheAttachments, application_Mashup_backupIntervall, application_Mashup_sourceIdentCounter, application_Mashup_cacheDelay, application_Mashup_keepDeletedItemsList}
application_Mashup.methods={application_Mashup_m_getNewSourceIdent, application_Mashup_m_getSourceWithIdent}
...
application_MashupAdmin.attributes={application_MashupAdmin_isConfigurationAdmin, application_MashupAdmin_id, application_MashupAdmin_localIdent, application_MashupAdmin_provider, application_MashupAdmin_profileImage, application_MashupAdmin_name, application_MashupAdmin_email}
...
application_Source.attributes={application_Source_activeState, application_Source_removeDataOnStop, application_Source_state, application_Source_bundleId, application_Source_updateRound, application_Source_logLevel}
application_Source.methods={application_Source_m_pause, application_Source_m_getLogLevelIntValue, application_Source_m_start, application_Source_m_stop}
...
application_Property.attributes={application_Property_helpText, application_Property_Value, application_Property_required, application_Property_propertyType, application_Property_changeable, application_Property_Key, application_Property_possibleValues, application_Property_hidden}
application_Property.methods={application_Property_m_isValueList, application_Property_m_getMaxValue, application_Property_m_getMinValue, application_Property_m_getListOfValues, application_Property_m_isValueRange}
...
application_MashupContainer_m_setNewIdentFor: Method = Method(name="setNewIdentFor", parameters={Parameter(name='application_configurableElement', type=StringType)})
application_MashupContainer_m_getNewIdentNumber: Method = Method(name="getNewIdentNumber", parameters={}, type=StringType)
application_MashupContainer_m_getMashupWithIdent: Method = Method(name="getMashupWithIdent", parameters={Parameter(name='application_ident', type=StringType)}, type=StringType)
application_MashupContainer_m_getSourceConfigurationWithIdent: Method = Method(name="getSourceConfigurationWithIdent", parameters={Parameter(name='application_ident', type=StringType)}, type=Source)
application_MashupContainer.attributes={application_MashupContainer_createAccountsAtLoginTry, application_MashupContainer_immediateSave, application_MashupContainer_backupConfiguration, application_MashupContainer_identCounter, application_MashupContainer_backupIntervall}
application_MashupContainer.methods={application_MashupContainer_m_getMashupWithIdent, application_MashupContainer_m_setNewIdentFor, application_MashupContainer_m_getSourceConfigurationWithIdent, application_MashupContainer_m_getConfigurationAdmins, application_MashupContainer_m_getNewIdentNumber}
...
application_FEEDInterface.attributes={application_FEEDInterface_feedType, application_FEEDInterface_allowMetaTagFiltering, application_FEEDInterface_allowTypeFiltering, application_FEEDInterface_allowPersonFiltering, application_FEEDInterface_allowOrganisationFiltering, application_FEEDInterface_feedTitle, application_FEEDInterface_language, application_FEEDInterface_allowTagFiltering, application_FEEDInterface_allowCategoryFiltering}
...
application_OAuthClientConfig.attributes={application_OAuthClientConfig_accessTokenCreationDate, application_OAuthClientConfig_name, application_OAuthClientConfig_code, application_OAuthClientConfig_clientSecret, application_OAuthClientConfig_accessTokenExpirationDate, application_OAuthClientConfig_accessToken, application_OAuthClientConfig_description, application_OAuthClientConfig_redirectionURL, application_OAuthClientConfig_forbiddenMetaTags, application_OAuthClientConfig_clientID, application_OAuthClientConfig_allowedMetaTags, application_OAuthClientConfig_refreshToken, application_OAuthClientConfig_oAuthScopeLevel, application_OAuthClientConfig_grantType, application_OAuthClientConfig_type}
...
application_ApplicationKeyConfig_m_hasApplicationKey: Method = Method(name="hasApplicationKey", parameters={Parameter(name='application_applicationKey', type=StringType)}, type=StringType)
...
application_OAuthClientScope.attributes={application_OAuthClientScope_positivePerson, application_OAuthClientScope_maximumAge, application_OAuthClientScope_allowContents, application_OAuthClientScope_negativeCategory, application_OAuthClientScope_positiveTag, application_OAuthClientScope_allowPersons, application_OAuthClientScope_positiveMetaTag, application_OAuthClientScope_negativePerson, application_OAuthClientScope_negativeMetaTag, application_OAuthClientScope_positiveOrganisation, application_OAuthClientScope_positiveCategory, application_OAuthClientScope_allowOrganisations, application_OAuthClientScope_identSpecification, application_OAuthClientScope_negativeTag, application_OAuthClientScope_negativeOrganisation}
...
application_ConfigurableElement_m_getProperty: Method = Method(name="getProperty", parameters={Parameter(name='application_key', type=StringType)}, type=Property_)
application_ConfigurableElement_m_addProperty: Method = Method(name="addProperty", parameters={Parameter(name='application_value', type=StringType), Parameter(name='application_key', type=StringType)})
application_ConfigurableElement_m_addProperty: Method = Method(name="addProperty", parameters={Parameter(name='application_property', type=StringType)})
application_ConfigurableElement_m_getPropertyValue: Method = Method(name="getPropertyValue", parameters={Parameter(name='application_key', type=StringType)}, type=StringType)
application_ConfigurableElement_m_isPropertyTrue: Method = Method(name="isPropertyTrue", parameters={Parameter(name='application_key', type=StringType)}, type=BooleanType)
application_ConfigurableElement_m_getPropertyValueElseDefault: Method = Method(name="getPropertyValueElseDefault", parameters={Parameter(name='application_defaultValue', type=StringType), Parameter(name='application_key', type=StringType)}, type=StringType)
application_ConfigurableElement_m_isPropertyTrueElseDefault: Method = Method(name="isPropertyTrueElseDefault", parameters={Parameter(name='application_key', type=StringType), Parameter(name='application_defaultValue', type=StringType)}, type=BooleanType)
application_ConfigurableElement_m_removeProperty: Method = Method(name="removeProperty", parameters={Parameter(name='application_key', type=StringType)})
application_ConfigurableElement.attributes={application_ConfigurableElement_description, application_ConfigurableElement_changeable, application_ConfigurableElement_ident, application_ConfigurableElement_name, application_ConfigurableElement_hidden, application_ConfigurableElement_configurationImage}
application_ConfigurableElement.methods={application_ConfigurableElement_m_isPropertyTrue, application_ConfigurableElement_m_removeProperty, application_ConfigurableElement_m_getPropertyValueElseDefault, application_ConfigurableElement_m_isPropertyTrueElseDefault, application_ConfigurableElement_m_getPropertyValue, application_ConfigurableElement_m_addProperty, application_ConfigurableElement_m_getProperty, application_ConfigurableElement_m_addProperty}
...
domain_model = DomainModel(
    name="application",
    types={ConfigurableElement, application_Persistency, application_DataSet, application_Mashup, Source, application_MappingRule, application_Interface, application_MashupAdmin, application_Source, application_Configuration, application_Property, application_XMLFile, Persistency, application_Database, application_OCLRestrictedProperty, Property_, application_MashupContainer, application_Security, application_RESTInterface, Interface, application_FEEDInterface, application_OAuthConfig, Security, application_OAuthClientConfig, application_OAuthAdmin, application_ApplicationKeyConfig, application_OAuthClientScope, application_ConfigurableElement, SourceState, SourceActiveStates, PropertyTypes},
    associations={persistency0, dataSet1, mashup3, mappingRules4, sources5, interfaces6, mashupAdmins8, properties9, mashups10, allMashupAdmins12, defaultMashups14, sourceConfigurations17, interfaceConfigurations20, security22, mashup23, interface25, clients27, admins28, clientScope30, configurableMashups32, configuration34},
    generalizations={gen_application_Source_ConfigurableElement, gen_application_Mashup_Source, gen_application_XMLFile_Persistency, gen_application_Database_Persistency, gen_application_OCLRestrictedProperty_Property, gen_application_Interface_ConfigurableElement, gen_application_RESTInterface_Interface, gen_application_FEEDInterface_Interface, gen_application_OAuthConfig_Security, gen_application_ApplicationKeyConfig_Security},
    metadata=None
)
