...
mpl_VariableRefrence = Class(name="mpl_VariableRefrence")
mpl_ExpressionStatement = Class(name="mpl_ExpressionStatement")
mpl_ArithmeticExpression = Class(name="mpl_ArithmeticExpression")
...
domain_model = DomainModel(
    name="mpl",
    types={mpl_Program, mpl_VariableDeclaration, mpl_Statement, mpl_Variable, mpl_Expression, mpl_VariableRefrence, mpl_ExpressionStatement, mpl_ArithmeticExpression, Expression, mpl_AtomicExpression, mpl_LiteralValue, AtomicExpression, mpl_AddExpression, ArithmeticExpression, mpl_Assignment, Statement},
    associations={variabledeclarations0, statement1, variable3, rightHandSide5, leftHandSide6, expression8, operand210, operand112, variable15},
    generalizations={gen_mpl_ExpressionStatement_Statement, gen_mpl_ArithmeticExpression_Expression, gen_mpl_AtomicExpression_Expression, gen_mpl_LiteralValue_AtomicExpression, gen_mpl_VariableRefrence_AtomicExpression, gen_mpl_AddExpression_ArithmeticExpression, gen_mpl_Assignment_Statement},
    metadata=None
)
