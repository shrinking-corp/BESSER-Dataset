...
class bowling_Matchup:
    ...
    def __init__(self, name: str, bowling_Matchup3: set["bowling_Game"] = None, bowling_Matchup: "bowling_Tournament" = None):
        self.name = name
...
class bowling_Tournament:
    ...
    def __init__(self, type: str, name: str, bowling_Tournament11: "bowling_Alley" = None, bowling_Tournament: set["bowling_Matchup"] = None):
        self.type = type
        self.name = name
...
class bowling_Game:
    ...
    def __init__(self, frames: int, bowling_Game: "bowling_Matchup" = None, bowling_Game5: "bowling_Player" = None):
        self.frames = frames
...
class bowling_League:
    ...
    def __init__(self, name: str, bowling_League8: "bowling_Alley" = None, bowling_League: set["bowling_Player"] = None):
        self.name = name
...
class bowling_Player:
    ...
    def __init__(self, name: str, dateOfBirth: date, height: float, isProfessional: bool, bowling_Player6: "bowling_Game" = None, bowling_Player: "bowling_League" = None):
        self.name = name
