...
# Classes
commons_ResourceAware = Class(name="commons_ResourceAware", is_abstract=True)
commons_Positionable = Class(name="commons_Positionable", is_abstract=True)
commons_AppManifest = Class(name="commons_AppManifest")
...
commons_PersonInfo = Class(name="commons_PersonInfo")
Identifiable = Class(name="Identifiable")
commons_PhotoIdContainer = Class(name="commons_PhotoIdContainer", is_abstract=True)
Imageable = Class(name="Imageable")
commons_NameContainer = Class(name="commons_NameContainer", is_abstract=True)
Nameable = Class(name="Nameable")
commons_Timestamped = Class(name="commons_Timestamped", is_abstract=True)
commons_Identifiable = Class(name="commons_Identifiable", is_abstract=True)
commons_Sluggable = Class(name="commons_Sluggable", is_abstract=True)
commons_Nameable = Class(name="commons_Nameable", is_abstract=True)
commons_Imageable = Class(name="commons_Imageable", is_abstract=True)
commons_Informer = Class(name="commons_Informer", is_abstract=True)
commons_Describable = Class(name="commons_Describable", is_abstract=True)
commons_BundleAware = Class(name="commons_BundleAware", is_abstract=True)
commons_JavaClassLinked = Class(name="commons_JavaClassLinked", is_abstract=True)
commons_EClassLinked = Class(name="commons_EClassLinked", is_abstract=True)
commons_EClass = Class(name="commons_EClass")
commons_SchemaVersionable = Class(name="commons_SchemaVersionable", is_abstract=True)
commons_EFactoryLinked = Class(name="commons_EFactoryLinked", is_abstract=True)
commons_NsPrefixable = Class(name="commons_NsPrefixable", is_abstract=True)
commons_WebAddress = Class(name="commons_WebAddress")
commons_AddedMany = Class(name="commons_AddedMany")
commons_RemovedMany = Class(name="commons_RemovedMany")
commons_Added = Class(name="commons_Added")
commons_ModelNotification = Class(name="commons_ModelNotification", is_abstract=True)
commons_EObject = Class(name="commons_EObject")
commons_AttributeSet = Class(name="commons_AttributeSet")
commons_AttributeUnset = Class(name="commons_AttributeUnset")
commons_Removed = Class(name="commons_Removed")
commons_ObjectNotification = Class(name="commons_ObjectNotification", is_abstract=True)
commons_AttributeNotification = Class(name="commons_AttributeNotification")
commons_EAttribute = Class(name="commons_EAttribute")
commons_ProgressMonitor = Class(name="commons_ProgressMonitor", is_abstract=True)
commons_ObjectsNotification = Class(name="commons_ObjectsNotification", is_abstract=True)
commons_EObjectLinked = Class(name="commons_EObjectLinked", is_abstract=True)
commons_Parentable = Class(name="commons_Parentable", is_abstract=True)
commons_CategoryLike = Class(name="commons_CategoryLike", is_abstract=True)
NsPrefixable = Class(name="NsPrefixable")
commons_CategoryInfo = Class(name="commons_CategoryInfo")
commons_ShellProgressMonitor = Class(name="commons_ShellProgressMonitor")
ProgressMonitor = Class(name="ProgressMonitor")
commons_EventBusProgressMonitor = Class(name="commons_EventBusProgressMonitor")
commons_ProgressMonitorWrapper = Class(name="commons_ProgressMonitorWrapper")
commons_StyleConfiguration = Class(name="commons_StyleConfiguration", is_abstract=True)
commons_Expandable = Class(name="commons_Expandable", is_abstract=True)
commons_Colorable = Class(name="commons_Colorable", is_abstract=True)
commons_Translatable = Class(name="commons_Translatable", is_abstract=True)
commons_TranslationEntry = Class(name="commons_TranslationEntry")
commons_Translation = Class(name="commons_Translation")
commons_TranslationMessageEntry = Class(name="commons_TranslationMessageEntry")
commons_TranslationManager = Class(name="commons_TranslationManager")
commons_PersonLike = Class(name="commons_PersonLike", is_abstract=True)
commons_Person = Class(name="commons_Person")
commons_PhoneNumber = Class(name="commons_PhoneNumber")
commons_Email = Class(name="commons_Email")
commons_PostalAddress = Class(name="commons_PostalAddress")
commons_Organization = Class(name="commons_Organization")
SchemaVersionable = Class(name="SchemaVersionable")
commons_PersonCatalog = Class(name="commons_PersonCatalog")
commons_CanonicalSluggable = Class(name="commons_CanonicalSluggable", is_abstract=True)
commons_TwitterAccessible = Class(name="commons_TwitterAccessible", is_abstract=True)
commons_TwitterIdentity = Class(name="commons_TwitterIdentity", is_abstract=True)
commons_FacebookIdentity = Class(name="commons_FacebookIdentity")
commons_FacebookAccessible = Class(name="commons_FacebookAccessible")
commons_Geolocation = Class(name="commons_Geolocation")
commons_ThingInfo = Class(name="commons_ThingInfo")
commons_GeneralSysConfig = Class(name="commons_GeneralSysConfig", is_abstract=True)
SysConfig = Class(name="SysConfig")
commons_Revisionable = Class(name="commons_Revisionable", is_abstract=True)
commons_SysConfig = Class(name="commons_SysConfig", is_abstract=True)
Timestamped = Class(name="Timestamped")
commons_MongoSysConfig = Class(name="commons_MongoSysConfig", is_abstract=True)
commons_CustomerRole = Class(name="commons_CustomerRole")
...
commons_ResourceAware.attributes={commons_ResourceAware_resourceType, commons_ResourceAware_resourceName, commons_ResourceAware_resourceUri}
...
commons_AppManifest.attributes={commons_AppManifest_domainStg, commons_AppManifest_shipmentLogoUriTemplate, commons_AppManifest_generalEmail, commons_AppManifest_headTitle, commons_AppManifest_generalEmailStg, commons_AppManifest_organizationAddress, commons_AppManifest_reminderPeriodStr, commons_AppManifest_title, commons_AppManifest_kursDollarPaypal, commons_AppManifest_domainPrd, commons_AppManifest_wwwUsed, commons_AppManifest_letterClosing, commons_AppManifest_organizationName, commons_AppManifest_reminderSchedule, commons_AppManifest_generalEmailDev, commons_AppManifest_reminderPeriod, commons_AppManifest_headNote, commons_AppManifest_defaultTimeZoneId, commons_AppManifest_generalEmailPrd, commons_AppManifest_description, commons_AppManifest_footnote, commons_AppManifest_defaultCurrencyCode, commons_AppManifest_letterSalutation, commons_AppManifest_kursDollarDpex, commons_AppManifest_defaultCategoryUName, commons_AppManifest_domainDev, commons_AppManifest_organizationPhoneNumbers, commons_AppManifest_domain, commons_AppManifest_supportEmail, commons_AppManifest_summary, commons_AppManifest_defaultTimeZone, commons_AppManifest_defaultCurrency, commons_AppManifest_defaultVariation, commons_AppManifest_defaultCountryCode, commons_AppManifest_defaultLanguageTag, commons_AppManifest_reminderScheduleStr, commons_AppManifest_emailLogoUriTemplate, commons_AppManifest_defaultStyle}
...
commons_JavaClassLinked_m_resolveJavaClass: Method = Method(name="resolveJavaClass", parameters={Parameter(name='commons_bundle', type=StringType)})
commons_JavaClassLinked.attributes={commons_JavaClassLinked_javaClass, commons_JavaClassLinked_javaClassStatus, commons_JavaClassLinked_javaClassName}
...
commons_EClassLinked_m_resolveEClass: Method = Method(name="resolveEClass", parameters={Parameter(name='commons_eClassMap', type=StringType)})
commons_EClassLinked.attributes={commons_EClassLinked_ePackageName, commons_EClassLinked_ePackageNsPrefix, commons_EClassLinked_eClassStatus, commons_EClassLinked_eClassName}
...
commons_WebAddress.attributes={commons_WebAddress_secureImagesUri, commons_WebAddress_secureJsUri, commons_WebAddress_jsUri, commons_WebAddress_secureBaseUri, commons_WebAddress_secureSkinUri, commons_WebAddress_basePath, commons_WebAddress_apiPath, commons_WebAddress_imagesUri, commons_WebAddress_skinUri, commons_WebAddress_baseUri}
commons_WebAddress.methods={commons_WebAddress_m_getApiUri, commons_WebAddress_m_getSecureApiUri}
...
commons_AttributeNotification.attributes={commons_AttributeNotification_object, commons_AttributeNotification_oldValue, commons_AttributeNotification_newValue}
...
commons_ProgressMonitor_m_beginTask: Method = Method(name="beginTask", parameters={Parameter(name='commons_totalWork', type=StringType), Parameter(name='commons_name', type=StringType)})
commons_ProgressMonitor_m_done: Method = Method(name="done", parameters={})
commons_ProgressMonitor_m_internalWorked: Method = Method(name="internalWorked", parameters={Parameter(name='commons_work', type=StringType)})
commons_ProgressMonitor_m_subTask: Method = Method(name="subTask", parameters={Parameter(name='commons_name', type=StringType)})
commons_ProgressMonitor_m_worked: Method = Method(name="worked", parameters={Parameter(name='commons_work', type=StringType)})
commons_ProgressMonitor_m_done: Method = Method(name="done", parameters={Parameter(name='commons_status', type=StringType)})
commons_ProgressMonitor_m_worked: Method = Method(name="worked", parameters={Parameter(name='commons_work', type=StringType), Parameter(name='commons_status', type=StringType)})
commons_ProgressMonitor.attributes={commons_ProgressMonitor_canceled, commons_ProgressMonitor_taskName}
commons_ProgressMonitor.methods={commons_ProgressMonitor_m_subTask, commons_ProgressMonitor_m_worked, commons_ProgressMonitor_m_beginTask, commons_ProgressMonitor_m_done, commons_ProgressMonitor_m_internalWorked, commons_ProgressMonitor_m_done, commons_ProgressMonitor_m_worked}
...
commons_CategoryLike.attributes={commons_CategoryLike_color, commons_CategoryLike_slugPath, commons_CategoryLike_categoryCount, commons_CategoryLike_level, commons_CategoryLike_imageId}
...
commons_CategoryInfo_m_getEffectiveName: Method = Method(name="getEffectiveName", parameters={Parameter(name='commons_curLanguageTag', type=StringType)}, type=StringType)
commons_CategoryInfo.attributes={commons_CategoryInfo_googleFormalId, commons_CategoryInfo_primaryUri}
...
commons_EventBusProgressMonitor.attributes={commons_EventBusProgressMonitor_trackingId, commons_EventBusProgressMonitor_eventBus}
...
commons_Expandable_m_expand: Method = Method(name="expand", parameters={Parameter(name='commons_scope', type=StringType)})
...
commons_Translatable.attributes={commons_Translatable_language, commons_Translatable_originalLanguage, commons_Translatable_translationState}
...
commons_TranslationMessageEntry.attributes={commons_TranslationMessageEntry_value, commons_TranslationMessageEntry_key}

# commons_TranslationManager class attributes and methods
commons_TranslationManager_m_translate: Method = Method(name="translate", parameters={Parameter(name='commons_targetLanguage', type=StringType), Parameter(name='commons_entity', type=StringType)})
...
commons_PersonLike.methods={commons_PersonLike_m_getGender, commons_PersonLike_m_getPhotoId, commons_PersonLike_m_getId, commons_PersonLike_m_getSlug, commons_PersonLike_m_getEmail, commons_PersonLike_m_getName}
...
commons_Person_m_hasEmail: Method = Method(name="hasEmail", parameters={Parameter(name='commons_email', type=StringType)}, type=BooleanType)
commons_Person_m_putEmail: Method = Method(name="putEmail", parameters={Parameter(name='commons_email', type=StringType)}, type=StringType)
commons_Person.attributes={commons_Person_debitCurrency, commons_Person_folder, commons_Person_ipAddress, commons_Person_firstName, commons_Person_debitBalance, commons_Person_managerRole, commons_Person_timeZone, commons_Person_schemaVersion, commons_Person_googlePlusId, commons_Person_lastIpAddress, commons_Person_lastTimeSynchronizeWithZendesk, commons_Person_signupSourceType, commons_Person_gender, commons_Person_passwordResetExpiryTime, commons_Person_customerRole, commons_Person_verificationTime, commons_Person_religion, commons_Person_zendeskUserId, commons_Person_archivalStatus, commons_Person_birthDay, commons_Person_timeZoneId, commons_Person_passwordResetCode, commons_Person_publicationStatus, commons_Person_googleUsername, commons_Person_language, commons_Person_memberRole, commons_Person_validationTime, commons_Person_customerRoleEditTime, commons_Person_verifyCode, commons_Person_currencyCode, commons_Person_clientAccessToken, commons_Person_activationTime, commons_Person_type, commons_Person_birthDate, commons_Person_securityRoleIds, commons_Person_virtualMail, commons_Person_referrerType, commons_Person_signupSource, commons_Person_currency, commons_Person_accountStatus, commons_Person_newsletterSubscriptionTime, commons_Person_birthMonth, commons_Person_socialSharingEnabled, commons_Person_birthYear, commons_Person_referrerId, commons_Person_lastName, commons_Person_nickname, commons_Person_password, commons_Person_zendeskIntegration, commons_Person_lastLoginTime, commons_Person_newsletterSubscriptionEnabled}
commons_Person.methods={commons_Person_m_hasEmail, commons_Person_m_putEmail}
...
commons_PhoneNumber.attributes={commons_PhoneNumber_phoneNumber, commons_PhoneNumber_validationTime, commons_PhoneNumber_primary}
...
commons_Email.attributes={commons_Email_validationTime, commons_Email_primary, commons_Email_email}
...
commons_PostalAddress.attributes={commons_PostalAddress_primaryShipping, commons_PostalAddress_homePhones, commons_PostalAddress_city, commons_PostalAddress_validationTime, commons_PostalAddress_phones, commons_PostalAddress_primaryHomePhone, commons_PostalAddress_postalCode, commons_PostalAddress_mobiles, commons_PostalAddress_country, commons_PostalAddress_primaryPhone, commons_PostalAddress_primaryMobile, commons_PostalAddress_workPhones, commons_PostalAddress_primaryBilling, commons_PostalAddress_organization, commons_PostalAddress_province, commons_PostalAddress_primaryEmail, commons_PostalAddress_description, commons_PostalAddress_primary, commons_PostalAddress_district, commons_PostalAddress_primaryWorkPhone, commons_PostalAddress_countryCode, commons_PostalAddress_street, commons_PostalAddress_emails, commons_PostalAddress_jneAreaCode, commons_PostalAddress_schemaVersion}
...
commons_Organization.attributes={commons_Organization_facebookId, commons_Organization_twitterAccessTokenSecret, commons_Organization_twitterScreenName, commons_Organization_facebookUserName, commons_Organization_twitterAccessToken, commons_Organization_facebookAccessToken, commons_Organization_twitterId, commons_Organization_website, commons_Organization_schemaVersion, commons_Organization_facebookPageUri, commons_Organization_blackBerryPin}
...
commons_TwitterAccessible.attributes={commons_TwitterAccessible_twitterAccessTokenSecret, commons_TwitterAccessible_twitterAccessToken}
...
commons_TwitterIdentity.attributes={commons_TwitterIdentity_twitterId, commons_TwitterIdentity_twitterScreenName}
...
commons_Geolocation.attributes={commons_Geolocation_elevation, commons_Geolocation_latitude, commons_Geolocation_longitude}
...
commons_Revisionable.attributes={commons_Revisionable_guid, commons_Revisionable_revision}
...
commons_CustomerRole.attributes={commons_CustomerRole_agentSalesReportEnabled, commons_CustomerRole_dropshipEnabled, commons_CustomerRole_historySalesOrderEnabled, commons_CustomerRole_salesOrderReportEnabled, commons_CustomerRole_status, commons_CustomerRole_paymentGatewayEnabled, commons_CustomerRole_bookingEnabled, commons_CustomerRole_bookingExpiryTimeInMinutes, commons_CustomerRole_transactionHistoryEnabled, commons_CustomerRole_schemaVersion, commons_CustomerRole_reviewReminderEnabled, commons_CustomerRole_readOnly, commons_CustomerRole_quickShopEnabled, commons_CustomerRole_zendeskIntegration, commons_CustomerRole_zendeskOrganizationId}
...
domain_model = DomainModel(
    name="commons",
    types={commons_ResourceAware, commons_Positionable, commons_AppManifest, Positionable, ResourceAware, BundleAware, Expandable, PhotoIdContainer, Sluggable, NameContainer, PersonLike, commons_PersonInfo, Identifiable, commons_PhotoIdContainer, Imageable, commons_NameContainer, Nameable, commons_Timestamped, commons_Identifiable, commons_Sluggable, commons_Nameable, commons_Imageable, commons_Informer, commons_Describable, commons_BundleAware, commons_JavaClassLinked, commons_EClassLinked, commons_EClass, commons_SchemaVersionable, commons_EFactoryLinked, commons_NsPrefixable, commons_WebAddress, commons_AddedMany, commons_RemovedMany, commons_Added, commons_ModelNotification, commons_EObject, commons_AttributeSet, commons_AttributeUnset, commons_Removed, commons_ObjectNotification, commons_AttributeNotification, commons_EAttribute, commons_ProgressMonitor, commons_ObjectsNotification, commons_EObjectLinked, commons_Parentable, commons_CategoryLike, NsPrefixable, commons_CategoryInfo, commons_ShellProgressMonitor, ProgressMonitor, commons_EventBusProgressMonitor, commons_ProgressMonitorWrapper, commons_StyleConfiguration, commons_Expandable, commons_Colorable, commons_Translatable, commons_TranslationEntry, commons_Translation, commons_TranslationMessageEntry, commons_TranslationManager, commons_PersonLike, commons_Person, commons_PhoneNumber, commons_Email, commons_PostalAddress, commons_Organization, SchemaVersionable, commons_PersonCatalog, commons_CanonicalSluggable, commons_TwitterAccessible, commons_TwitterIdentity, commons_FacebookIdentity, commons_FacebookAccessible, commons_Geolocation, commons_ThingInfo, commons_GeneralSysConfig, SysConfig, commons_Revisionable, commons_SysConfig, Timestamped, commons_MongoSysConfig, commons_CustomerRole, Describable, ResourceType, Gender, EClassStatus, JavaClassStatus, PublicationStatus, ProgressStatus, AccountStatus, ArchivalStatus, TranslationState, ExpansionState, SignupSourceType, GenericStatus, TenantSource, EntityKind, CustomerRoleStatus},
    associations={eClass0, container1, attribute2, parents4, delegate5, value8, translations6, messages7, phoneNumbers11, emails12, mobileNumbers14, addresses17, organizations19, people21},
    generalizations={gen_commons_AppManifest_Positionable, gen_commons_AppManifest_ResourceAware, gen_commons_AppManifest_BundleAware, gen_commons_AppManifest_Expandable, gen_commons_PersonInfo_PhotoIdContainer, gen_commons_PersonInfo_Sluggable, gen_commons_PersonInfo_NameContainer, gen_commons_PersonInfo_PersonLike, gen_commons_PersonInfo_Identifiable, gen_commons_PhotoIdContainer_Imageable, gen_commons_NameContainer_Nameable, gen_commons_WebAddress_Positionable, gen_commons_WebAddress_BundleAware, gen_commons_WebAddress_ResourceAware, gen_commons_WebAddress_Expandable, gen_commons_CategoryLike_Identifiable, gen_commons_CategoryLike_NsPrefixable, gen_commons_CategoryLike_NameContainer, gen_commons_CategoryLike_Positionable, gen_commons_CategoryLike_Sluggable, gen_commons_CategoryLike_Imageable, gen_commons_ShellProgressMonitor_ProgressMonitor, gen_commons_EventBusProgressMonitor_ProgressMonitor, gen_commons_ProgressMonitorWrapper_ProgressMonitor, gen_commons_PostalAddress_NameContainer, gen_commons_PostalAddress_Identifiable, gen_commons_PostalAddress_SchemaVersionable, gen_commons_CanonicalSluggable_Sluggable, gen_commons_ThingInfo_NameContainer, gen_commons_ThingInfo_Identifiable, gen_commons_ThingInfo_Sluggable, gen_commons_ThingInfo_Imageable, gen_commons_GeneralSysConfig_Expandable, gen_commons_GeneralSysConfig_SysConfig, gen_commons_Organization_Identifiable, gen_commons_Organization_SchemaVersionable, gen_commons_Organization_NameContainer, gen_commons_SysConfig_Timestamped, gen_commons_CustomerRole_Identifiable, gen_commons_CustomerRole_SchemaVersionable, gen_commons_CustomerRole_NameContainer, gen_commons_CustomerRole_Timestamped, gen_commons_CustomerRole_Describable},
    metadata=None
)
