...
# Classes
profile_PlatformProfile = Class(name="profile_PlatformProfile")
profile_Resource = Class(name="profile_Resource")
profile_Constraint = Class(name="profile_Constraint")
...
profile_Resource.attributes={profile_Resource_name, profile_Resource_type, profile_Resource_weight}
...
profile_Constraint.attributes={profile_Constraint_isDerivation, profile_Constraint_type, profile_Constraint_operation, profile_Constraint_bound}
