...
domain_model = DomainModel(
    name="fsm",
    types={fsm_FSM, fsm_State, fsm_System, fsm_Transition, fsm_Buffer},
    associations={ownedStates0, inputBuffer3, outputBuffer4, initialState6, currentState7, incoming10, outgoing12, fsm14, outgoingFSM15, incomingFSM17, tgt19, src21, fsm23, ownedFsms25, ownedTransitions1, ownedBuffers27},
    generalizations={},
    metadata=None
)
