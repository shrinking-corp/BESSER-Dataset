...
# Classes
entitymm_Model = Class(name="entitymm_Model")
entitymm_Type = Class(name="entitymm_Type", is_abstract=True)
entitymm_Attribute = Class(name="entitymm_Attribute")
entitymm_Entity = Class(name="entitymm_Entity")
entitymm_PrimitiveType = Class(name="entitymm_PrimitiveType")
...
entitymm_Entity.attributes={entitymm_Entity_isPersistent, entitymm_Entity_desc, entitymm_Entity_size}
...
domain_model = DomainModel(
    name="entitymm",
    types={entitymm_Model, entitymm_Type, entitymm_Attribute, entitymm_Entity, entitymm_PrimitiveType, Type},
    associations={attributes3, types0, entity1, type2},
