...
class GraphMetaM_Edge:
    ...
    def __init__(self, async_: bool, localPriority: int, rName: str, name: str, GraphMetaM_Edge: "GraphMetaM_Graph" = None, incoming: "GraphMetaM_Vertex" = None, outgoing: "GraphMetaM_Vertex" = None, Edge: "GraphMetaM_Vertex" = None, Edge8: "GraphMetaM_Vertex" = None):
        self.async_ = async_
...
class GraphMetaM_Vertex:
    ...
    def __init__(self, cycles: int, globalPriority: int, activity: str, rName: str, type: str, name: str, GraphMetaM_Vertex: "GraphMetaM_Graph" = None, Vertex: "GraphMetaM_Edge" = None, Vertex5: "GraphMetaM_Edge" = None, target: set["GraphMetaM_Edge"] = None, source: set["GraphMetaM_Edge"] = None):
        self.cycles = cycles
