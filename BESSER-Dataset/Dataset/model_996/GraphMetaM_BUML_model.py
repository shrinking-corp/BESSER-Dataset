...
# Classes
GraphMetaM_Graph = Class(name="GraphMetaM_Graph")
GraphMetaM_Vertex = Class(name="GraphMetaM_Vertex")
GraphMetaM_Edge = Class(name="GraphMetaM_Edge")
GraphMetaM_Model = Class(name="GraphMetaM_Model")
...
GraphMetaM_Graph.attributes={GraphMetaM_Graph_name, GraphMetaM_Graph_rName, GraphMetaM_Graph_cycles}
...
GraphMetaM_Vertex.attributes={GraphMetaM_Vertex_globalPriority, GraphMetaM_Vertex_name, GraphMetaM_Vertex_activity, GraphMetaM_Vertex_type, GraphMetaM_Vertex_rName, GraphMetaM_Vertex_cycles}

# GraphMetaM_Edge class attributes and methods
GraphMetaM_Edge_async_: Property = Property(name="async_", type=BooleanType)
...
GraphMetaM_Edge.attributes={GraphMetaM_Edge_localPriority, GraphMetaM_Edge_rName, GraphMetaM_Edge_name, GraphMetaM_Edge_async_}
...
domain_model = DomainModel(
    ...
    associations={vertex0, edge1, target3, source4, incoming6, outgoing7, graph9},
    generalizations={},
    metadata=None
)
