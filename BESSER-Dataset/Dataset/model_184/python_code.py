...
class lit_petriNets_Place:
    ...
    def __init__(self, name: str, Place27: "lit_petriNets_TPArc" = None, Place: "lit_petriNets_Net" = None, places: "lit_petriNets_Net" = None, dst: set["lit_petriNets_TPArc"] = None, src: set["lit_petriNets_PTArc"] = None, Place19: "lit_petriNets_PTArc" = None):
        self.name = name
