...
ecore_EClass.methods={ecore_EClass_m_getFeatureCount, ecore_EClass_m_getEStructuralFeature, ecore_EClass_m_getEStructuralFeature, ecore_EClass_m_isSuperTypeOf, ecore_EClass_m_getFeatureID}
...
ecore_EStructuralFeature.attributes={ecore_EStructuralFeature_defaultValueLiteral, ecore_EStructuralFeature_derived, ecore_EStructuralFeature_changeable, ecore_EStructuralFeature_volatile, ecore_EStructuralFeature_defaultValue, ecore_EStructuralFeature_unsettable, ecore_EStructuralFeature_transient}
...
domain_model = DomainModel(
    name="ecore",
    types={ecore_EAttribute, EStructuralFeature, ecore_EDataType, ecore_EClass, EClassifier, ecore_EOperation, ecore_EReference, ecore_EStructuralFeature, ecore_EPackage, ecore_EClassifier, ENamedElement, ecore_EEnum, EDataType, ecore_EEnumLiteral, ecore_ENamedElement, ETypedElement, ecore_EParameter, ecore_ETypedElement, ecore_EStringToStringMapEntry},
    associations={eAttributeType0, eSuperTypes2, eOperations3, eAllAttributes4, eAllReferences7, eReferences9, eAttributes12, eAllContainments15, eAllOperations18, eAllStructuralFeatures20, eAllSuperTypes23, eIDAttribute25, eStructuralFeatures28, eLiterals31, eEnum32, eContainingClass33, eParameters34, eExceptions35, eClassifiers37, eSubpackages39, ePackage30, eOpposite47, eReferenceType49, eKeys52, eContainingClass55, eType57, eSuperPackage42, eOperation44},
    generalizations={gen_ecore_EAttribute_EStructuralFeature, gen_ecore_EClass_EClassifier, gen_ecore_EClassifier_ENamedElement, gen_ecore_EEnum_EDataType, gen_ecore_EEnumLiteral_ENamedElement, gen_ecore_EOperation_ETypedElement, gen_ecore_EPackage_ENamedElement, gen_ecore_EDataType_EClassifier, gen_ecore_EStructuralFeature_ETypedElement, gen_ecore_ETypedElement_ENamedElement, gen_ecore_EParameter_ETypedElement, gen_ecore_EReference_EStructuralFeature},
    metadata=None
)
