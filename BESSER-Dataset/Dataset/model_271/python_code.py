...
class ecore_EClassifier(ENamedElement):
    ...
    def __init__(self, instanceClassName: str, instanceClass: str, defaultValue: str, instanceTypeName: str, ecore_EClassifier: "ecore_EOperation" = None, EClassifier: "ecore_EPackage" = None, eClassifiers: "ecore_EPackage" = None, ecore_EClassifier58: "ecore_ETypedElement" = None):
...
class ecore_EPackage(ENamedElement):
    ...
    def __init__(self, nsURI: str, nsPrefix: str, ePackage: set["ecore_EClassifier"] = None, EPackage40: "ecore_EPackage" = None, eSuperPackage: set["ecore_EPackage"] = None, EPackage: "ecore_EClassifier" = None, EPackage43: "ecore_EPackage" = None, eSubpackages: "ecore_EPackage" = None):
        self.nsURI = nsURI
...
class ecore_EAttribute(EStructuralFeature):
    ...
    def __init__(self, iD: bool, ecore_EAttribute: "ecore_EDataType" = None, ecore_EAttribute6: "ecore_EClass" = None, ecore_EAttribute14: "ecore_EClass" = None, ecore_EAttribute27: "ecore_EClass" = None, ecore_EAttribute54: "ecore_EReference" = None):
        self.iD = iD
