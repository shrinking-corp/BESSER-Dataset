...
@given(instance=Users_strategy)
def test_hyp_users_role_id_setter(instance):
...
def test_Users_name_value_roundtrip():
    instance = Users(name="sample_text", role_id="sample_text")
    assert instance.name == "sample_text"
    instance.name = "sample_text_2"
    assert instance.name == "sample_text_2"


def test_Users_role_id_value_roundtrip():
    instance = Users(name="sample_text", role_id="sample_text")
    assert instance.role_id == "sample_text"
    instance.role_id = "sample_text_2"
    assert instance.role_id == "sample_text_2"
...
def test_assoc_User_Administrator_link_reassign_clear():
    a = Users(name="sample_text", role_id="sample_text")
...
Users_strategy = st.builds(Users, name=safe_text, role_id=safe_text)
@given(instance=Users_strategy)
@settings(max_examples=25)
