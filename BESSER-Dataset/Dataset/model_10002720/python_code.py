...
class Advertiesment:
    ...
    def __init__(self, advertiesment_id: int, advertiser_id: str, start_date: str, end_date: str, owner3: "Advertiser" = None):
    ...
    def owner3(self, value):
        ...
        old_value = getattr(self, f"_Advertiesment__owner3", None)
        self.__owner3 = value
...
class Request:
    ...
    def __init__(self, request_type: str, request_id: int, request_details: str, requser_id: str, user7: "Users" = None):
...
class Requirement:
    ...
    def __init__(self, requirement_location: str, user_id: str, requirement_type: str, req_description: str, user11: set["Reg_User"] = None):
...
class Administrator:
    ...
    def __init__(self, admin_name: str, password: str, employee1: set["Users"] = None):
...
class Advertiser:
    ...
    def __init__(self, advertiser_id: str, advertiesment_id: str, adds2: set["Advertiesment"] = None):
        self.advertiser_id = advertiser_id
        self.advertiesment_id = advertiesment_id
    ...
    def adds2(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Advertiser__adds2", None)
...
class Users:
    ...
    def __init__(self, role_id: str, name: str, administrator0: "Administrator" = None, request6: set["Request"] = None):
    ...
    def administrator0(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Users__administrator0", None)
    ...
    def request6(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Users__request6", None)
...
class Property:
    ...
    def __init__(self, property_id: str, property_type: str, address: str, location: str, management12: set["Management"] = None, payment17: "Payment" = None, owner4: "Seller" = None, user8: "Buyer" = None):
        self.property_id = property_id
