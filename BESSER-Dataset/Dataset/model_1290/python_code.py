...
class StateMachineHyperedges_Transition:
    ...
    def __init__(self, name: str, incoming: set["StateMachineHyperedges_StateVertex"] = None, StateMachineHyperedges_Transition: "StateMachineHyperedges_StateMachine" = None, Transition: "StateMachineHyperedges_StateVertex" = None, Transition5: "StateMachineHyperedges_StateVertex" = None, StateMachineHyperedges_Transition7: "StateMachineHyperedges_Event" = None, outgoing: set["StateMachineHyperedges_StateVertex"] = None):
        self.name = name
...
class StateMachineHyperedges_StateVertex(ABC):
    ...
    def __init__(self, name: str, StateVertex10: "StateMachineHyperedges_Transition" = None, StateMachineHyperedges_StateVertex: "StateMachineHyperedges_StateMachine" = None, sources: set["StateMachineHyperedges_Transition"] = None, targets: set["StateMachineHyperedges_Transition"] = None, StateVertex: "StateMachineHyperedges_Transition" = None):
        self.name = name
