...
domain_model = DomainModel(
    ...
    types={StateMachineHyperedges_InitialState, StateVertex, StateMachineHyperedges_SimpleState, StateMachineHyperedges_FinalState, StateMachineHyperedges_StateMachine, StateMachineHyperedges_StateVertex, StateMachineHyperedges_Transition, StateMachineHyperedges_Event},
    associations={targets9, states0, transitions1, outgoing3, incoming4, trigger6, sources8},
