...
domain_model = DomainModel(
    name="statechart",
    types={statechart_StateMachineRoot, IDBase, statechart_StateMachine, statechart_Action, StateVertex, statechart_Transition, statechart_State, statechart_CompositeState, State, statechart_StateVertex, statechart_Event, statechart_StateAction, statechart_Guard, statechart_TransitionAction, Action, NameBase, statechart_DO, StateAction, statechart_ENTRY, statechart_EXIT, statechart_Label},
    associations={subStateMachines0, InitialStateMachine1, statemachine_container4, calledByAction5, InitialState6, state_container8, internalTransitions10, transitions2, top3, actions14, subVertexes15, deferrableEvents12, transSM_container18, transS_container20, trigger22, guard23, stateMachineCall16, source25, target27, evt_container29, action24, act_container33, sv_container35, outgoing36, gua_container31, action_container41, incoming38, label40},
    generalizations={gen_statechart_StateMachineRoot_IDBase, gen_statechart_StateMachine_IDBase, gen_statechart_State_StateVertex, gen_statechart_CompositeState_State, gen_statechart_Action_IDBase, gen_statechart_Transition_IDBase, gen_statechart_Event_IDBase, gen_statechart_Guard_IDBase, gen_statechart_TransitionAction_Action, gen_statechart_StateVertex_IDBase, gen_statechart_StateVertex_NameBase, gen_statechart_StateAction_Action, gen_statechart_DO_StateAction, gen_statechart_ENTRY_StateAction, gen_statechart_EXIT_StateAction, gen_statechart_Label_IDBase},
    metadata=None
)
