...
class statechart_Transition(IDBase):
    ...
    def __init__(self, description: str, Transition11: "statechart_State" = None, Transition: "statechart_StateMachine" = None, transitions: "statechart_StateMachine" = None, internalTransitions: "statechart_State" = None, evt_container: "statechart_Event" = None, gua_container: "statechart_Guard" = None, outgoing: "statechart_StateVertex" = None, incoming: "statechart_StateVertex" = None, Transition30: "statechart_Event" = None, act_container: "statechart_TransitionAction" = None, Transition34: "statechart_TransitionAction" = None, Transition37: "statechart_StateVertex" = None, Transition32: "statechart_Guard" = None, Transition39: "statechart_StateVertex" = None):
...
class statechart_StateMachine(IDBase):
    ...
    def __init__(self, name: str, statechart_StateMachine: "statechart_StateMachineRoot" = None, subStateMachines: "statechart_StateMachineRoot" = None, stateMachineCall: set["statechart_Action"] = None, statechart_StateMachine7: "statechart_State" = None, StateMachine9: "statechart_State" = None, transSM_container: set["statechart_Transition"] = None, state_container: set["statechart_State"] = None, StateMachine: "statechart_StateMachineRoot" = None, StateMachine19: "statechart_Transition" = None, StateMachine17: "statechart_Action" = None):
        self.name = name
