...
bowling_Referee = Class(name="bowling_Referee")
bowling_PlayerToPointsMap = Class(name="bowling_PlayerToPointsMap")
bowling_RefereeToGamesMap = Class(name="bowling_RefereeToGamesMap")
bowling_Game = Class(name="bowling_Game")
bowling_Area = Class(name="bowling_Area")
bowling_Fan = Class(name="bowling_Fan")
bowling_Merchandise = Class(name="bowling_Merchandise")
...
bowling_Tournament.attributes={bowling_Tournament_receivesTrophy, bowling_Tournament_matchDays, bowling_Tournament_priceMoney, bowling_Tournament_type}
...
bowling_Player_m_validate: Method = Method(name="validate", parameters={Parameter(name='bowling_context', type=StringType), Parameter(name='bowling_chain', type=StringType)}, type=BooleanType)
bowling_Player.attributes={bowling_Player_name, bowling_Player_gender, bowling_Player_eMails, bowling_Player_height, bowling_Player_playedTournamentTypes, bowling_Player_dateOfBirth, bowling_Player_winLossRatio, bowling_Player_numberOfVictories, bowling_Player_isProfessional}
...
bowling_Fan.attributes={bowling_Fan_gender, bowling_Fan_name, bowling_Fan_dateOfBirth, bowling_Fan_hasSeasonTicket, bowling_Fan_moneySpentOnTickets, bowling_Fan_eMails, bowling_Fan_numberOfTournamentsVisited}
...
bowling_Merchandise.attributes={bowling_Merchandise_name, bowling_Merchandise_serialNumber, bowling_Merchandise_price}
...
domain_model = DomainModel(
    name="bowling",
    types={bowling_Tournament, bowling_Matchup, bowling_Player, bowling_League, bowling_Referee, bowling_PlayerToPointsMap, bowling_RefereeToGamesMap, bowling_Game, bowling_Area, bowling_Fan, bowling_Merchandise, TournamentType, Gender},
    associations={matchups1, players0, key13, league16, key18, playerPoints2, players4, referees7, games9, matchup10, player11, value21, areas25, tournaments26, favouritePlayer29, fanMerchandise31, favouriteMerchandise33, visitedTournaments36},
    generalizations={},
    metadata=None
)
