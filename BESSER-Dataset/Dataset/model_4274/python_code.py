...
class bowling_Fan:
    ...
    def __init__(self, moneySpentOnTickets: float, name: str, dateOfBirth: date, hasSeasonTicket: bool, eMails: str, gender: str, numberOfTournamentsVisited: int, bowling_Fan: "bowling_Player" = None, bowling_Fan32: set["bowling_Merchandise"] = None, bowling_Fan34: "bowling_Merchandise" = None, bowling_Fan37: set["bowling_Tournament"] = None):
...
class bowling_PlayerToPointsMap:
    ...
    def __init__(self, value: str, bowling_PlayerToPointsMap14: "bowling_Player" = None, bowling_PlayerToPointsMap: "bowling_Tournament" = None):
        self.value = value
...
class bowling_Player:
    ...
    def __init__(self, name: str, dateOfBirth: date, height: float, isProfessional: bool, eMails: str, numberOfVictories: int, playedTournamentTypes: str, winLossRatio: str, gender: str, bowling_Player: "bowling_League" = None, bowling_Player15: "bowling_PlayerToPointsMap" = None, bowling_Player6: "bowling_Tournament" = None, bowling_Player12: "bowling_Game" = None, bowling_Player30: "bowling_Fan" = None):
        self.name = name
        self.dateOfBirth = dateOfBirth
        self.height = height
    ...
    def validate(self, bowling_context, bowling_chain) :
