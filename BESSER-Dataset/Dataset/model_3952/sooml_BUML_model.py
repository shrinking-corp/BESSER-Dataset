...
# Classes
sooml_Class = Class(name="sooml_Class")
sooml_NamedElement = Class(name="sooml_NamedElement", is_abstract=True)
sooml_StateMachine = Class(name="sooml_StateMachine")
sooml_Operation = Class(name="sooml_Operation")
sooml_Package = Class(name="sooml_Package")
NamedElement = Class(name="NamedElement")
sooml_EntryOperation = Class(name="sooml_EntryOperation")
sooml_Action = Class(name="sooml_Action", is_abstract=True)
sooml_Guard = Class(name="sooml_Guard", is_abstract=True)
sooml_Event = Class(name="sooml_Event")
sooml_StructuralFeature = Class(name="sooml_StructuralFeature", is_abstract=True)
sooml_Attribute = Class(name="sooml_Attribute")
StructuralFeature = Class(name="StructuralFeature")
sooml_Reference = Class(name="sooml_Reference")
sooml_Parameter = Class(name="sooml_Parameter")
sooml_State = Class(name="sooml_State")
sooml_Transition = Class(name="sooml_Transition")
sooml_CallReferenceOperationAction = Class(name="sooml_CallReferenceOperationAction")
CallOperationAction = Class(name="CallOperationAction")
sooml_CallOperationAction = Class(name="sooml_CallOperationAction", is_abstract=True)
Action = Class(name="Action")
sooml_ParameterBinding = Class(name="sooml_ParameterBinding")
sooml_IsInStateCondition = Class(name="sooml_IsInStateCondition", is_abstract=True)
Guard = Class(name="Guard")
sooml_ReferenceIsInStateCondition = Class(name="sooml_ReferenceIsInStateCondition")
IsInStateCondition = Class(name="IsInStateCondition")
sooml_ParameterIsInStateCondition = Class(name="sooml_ParameterIsInStateCondition")
sooml_CallParameterOperationAction = Class(name="sooml_CallParameterOperationAction")
sooml_ReferenceAssignmentAction = Class(name="sooml_ReferenceAssignmentAction")
...
stateMachine6: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="class_", type=sooml_StateMachine, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
...
domain_model = DomainModel(
    name="sooml",
    types={sooml_Class, sooml_NamedElement, sooml_StateMachine, sooml_Operation, sooml_Package, NamedElement, sooml_EntryOperation, sooml_Action, sooml_Guard, sooml_Event, sooml_StructuralFeature, sooml_Attribute, StructuralFeature, sooml_Reference, sooml_Parameter, sooml_State, sooml_Transition, sooml_CallReferenceOperationAction, CallOperationAction, sooml_CallOperationAction, Action, sooml_ParameterBinding, sooml_IsInStateCondition, Guard, sooml_ReferenceIsInStateCondition, IsInStateCondition, sooml_ParameterIsInStateCondition, sooml_CallParameterOperationAction, sooml_ReferenceAssignmentAction, DataType},
    associations={classes0, packages2, parentPackage4, stateMachine6, operations7, transitions23, entryOperation25, actions27, guard29, event31, target33, operation36, features9, type11, opposite14, parameter16, class_18, states19, initialState20, parameter59, callObjectViaReference61, classType39, calledOperation42, parameter44, structuralFeatureBinding46, parameterBinding49, inState52, calledOperation54, reference57, callObjectViaParameter63, parameter65, reference67},
    generalizations={gen_sooml_Class_NamedElement, gen_sooml_Package_NamedElement, gen_sooml_Attribute_StructuralFeature, gen_sooml_Reference_StructuralFeature, gen_sooml_Operation_NamedElement, gen_sooml_StructuralFeature_NamedElement, gen_sooml_State_NamedElement, gen_sooml_ParameterIsInStateCondition_IsInStateCondition, gen_sooml_CallReferenceOperationAction_CallOperationAction, gen_sooml_Parameter_NamedElement, gen_sooml_CallOperationAction_Action, gen_sooml_IsInStateCondition_Guard, gen_sooml_ReferenceIsInStateCondition_IsInStateCondition, gen_sooml_CallParameterOperationAction_CallOperationAction, gen_sooml_ReferenceAssignmentAction_Action},
    metadata=None
)
