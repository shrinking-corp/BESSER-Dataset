...
public class ORDB4ORA_StructuredType extends Datatype {
    ...
    public ORDB4ORA_StructuredType(
        boolean is_instantiable,        String Name,        boolean is_final    ) {
        super(
        );
    ...
    public ORDB4ORA_StructuredType(
        boolean is_instantiable,        String Name,        boolean is_final        ArrayList<ORDB4ORA_Attribute> ordb4ora_attributes    ) {
        this.is_instantiable = is_instantiable;
        this.Name = Name;
        this.is_final = is_final;
