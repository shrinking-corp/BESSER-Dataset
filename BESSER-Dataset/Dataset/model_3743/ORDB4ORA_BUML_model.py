...
ORDB4ORA_BuiltInCharacterType.attributes={ORDB4ORA_BuiltInCharacterType_Semantic, ORDB4ORA_BuiltInCharacterType_Descriptor, ORDB4ORA_BuiltInCharacterType_Size_Min, ORDB4ORA_BuiltInCharacterType_Size_Def, ORDB4ORA_BuiltInCharacterType_Size_Max}
...
ORDB4ORA_BuiltInNumberType.attributes={ORDB4ORA_BuiltInNumberType_Descriptor, ORDB4ORA_BuiltInNumberType_Scale_Max, ORDB4ORA_BuiltInNumberType_Precision_Mn, ORDB4ORA_BuiltInNumberType_Precision_Max, ORDB4ORA_BuiltInNumberType_Scale_Min}
...
ORDB4ORA_LongAndRawType.attributes={ORDB4ORA_LongAndRawType_Size_Min, ORDB4ORA_LongAndRawType_Size_Max, ORDB4ORA_LongAndRawType_Descriptor}
...
ORDB4ORA_DatetimeType.attributes={ORDB4ORA_DatetimeType_Descriptor, ORDB4ORA_DatetimeType_DayPrecision_Def, ORDB4ORA_DatetimeType_SecondPrecision_Max, ORDB4ORA_DatetimeType_SecondPrecision_Min, ORDB4ORA_DatetimeType_YearPrecision_Def, ORDB4ORA_DatetimeType_SecondPrecision_Def, ORDB4ORA_DatetimeType_YearPrecision_Max, ORDB4ORA_DatetimeType_DayPrecision_Min, ORDB4ORA_DatetimeType_DayPrecision_Max, ORDB4ORA_DatetimeType_YearPrecision_Min}
...
ORDB4ORA_ROWIDType.attributes={ORDB4ORA_ROWIDType_Size_Min, ORDB4ORA_ROWIDType_Descriptor, ORDB4ORA_ROWIDType_Size_Max}
...
ORDB4ORA_RowFeature.attributes={ORDB4ORA_RowFeature_key, ORDB4ORA_RowFeature_value}
...
ORDB4ORA_Trigger.attributes={ORDB4ORA_Trigger_Event, ORDB4ORA_Trigger_Action, ORDB4ORA_Trigger_Body, ORDB4ORA_Trigger_Name}
...
domain_model = DomainModel(
    name="ORDB4ORA",
    types={ORDB4ORA_ANSICharacterType, ANSIType, ORDB4ORA_ANSINumberType, SuppliedType, ORDB4ORA_Attribute, StructuralComponent, ORDB4ORA_StructuredType, ORDB4ORA_BasicDataType, Datatype, ORDB4ORA_BuiltInCharacterType, BuiltInType, ORDB4ORA_ANSIType, BasicDataType, ORDB4ORA_AnyType, ORDB4ORA_BuiltInType, ORDB4ORA_CharacterFeature, Feature, ORDB4ORA_Check, Restriction, ORDB4ORA_Column, ORDB4ORA_Table, ORDB4ORA_Datatype, ORDB4ORA_Model, ORDB4ORA_DatetimeFeature, ORDB4ORA_BuiltInNumberType, ORDB4ORA_Feature, ORDB4ORA_ForeignKey, ORDB4ORA_Function, Operation, ORDB4ORA_IntervalFeature, ORDB4ORA_LOBType, ORDB4ORA_LongAndRawType, ORDB4ORA_DatetimeType, Parameter_, ORDB4ORA_Operation, ORDB4ORA_Package, ORDB4ORA_NestedTableType, ORDB4ORA_NotNull, ORDB4ORA_NumberFeature, ORDB4ORA_MediaType, ORDB4ORA_Method, ORDB4ORA_MethodParameter, ORDB4ORA_Parameter, ORDB4ORA_PrimaryKey, ORDB4ORA_Procedure, ORDB4ORA_ROWIDType, ORDB4ORA_OperationParameter, ORDB4ORA_Restriction, ORDB4ORA_StructuralComponent, ORDB4ORA_RowFeature, ORDB4ORA_SpacialType, ORDB4ORA_StoredNestedTable, ORDB4ORA_TypedTable, ORDB4ORA_RawFeature, ORDB4ORA_ReferenceType, Table, ORDB4ORA_Unique, ORDB4ORA_Varray, ORDB4ORA_SuppliedType, ORDB4ORA_XMLType, ORDB4ORA_Trigger, ORDB4ORA_DerivedTable, ORDB4ORA_View, DerivedTable, ANSICharacterTypes, BuiltInCharacterSemantics, BuiltInCharacterTypes, BuiltInDatetimeTypes, BuiltInLOBType, ANSINumberTypes, BuiltInROWIDType, BuiltNumberTypes, CharacterFeatures, BuiltInLongAndRawTypes, IntervalFeatures, DatetimeFeatures, ParameterMode, NumberFeatures, ONDELETEActions, SuppliedMediaTypes, RowFeatures, SuppliedSpacialTypes, RawFeatures, SuppliedAnyTypes, TriggerEvent, SuppliedXMLTypes, TriggerActionTime},
    associations={structured0, table1, model2, reference3, Return4, returnType11, method14, datatype15, table16, operation19, package21, Type23, override6, structured7, parameters9, package29, operation31, operations33, model35, Type38, operationParameters25, model26, Type40, attributes41, table42, attribute44, typed45, Type46, features48, restrictions50, attribute51, method52, typed55, supertype58, storedNested73, structuredType74, Type77, restriction60, columns62, model64, triggers67, updateColumns69, table71, tables79, components81},
    generalizations={gen_ORDB4ORA_ANSICharacterType_ANSIType, gen_ORDB4ORA_ANSINumberType_ANSIType, gen_ORDB4ORA_AnyType_SuppliedType, gen_ORDB4ORA_Attribute_StructuralComponent, gen_ORDB4ORA_BasicDataType_Datatype, gen_ORDB4ORA_BuiltInCharacterType_BuiltInType, gen_ORDB4ORA_ANSIType_BasicDataType, gen_ORDB4ORA_BuiltInType_BasicDataType, gen_ORDB4ORA_CharacterFeature_Feature, gen_ORDB4ORA_Check_Restriction, gen_ORDB4ORA_Column_StructuralComponent, gen_ORDB4ORA_DatetimeFeature_Feature, gen_ORDB4ORA_BuiltInNumberType_BuiltInType, gen_ORDB4ORA_ForeignKey_Restriction, gen_ORDB4ORA_Function_Operation, gen_ORDB4ORA_IntervalFeature_Feature, gen_ORDB4ORA_LOBType_BuiltInType, gen_ORDB4ORA_LongAndRawType_BuiltInType, gen_ORDB4ORA_DatetimeType_BuiltInType, gen_ORDB4ORA_MethodParameter_Parameter, gen_ORDB4ORA_NestedTableType_Datatype, gen_ORDB4ORA_NotNull_Restriction, gen_ORDB4ORA_NumberFeature_Feature, gen_ORDB4ORA_MediaType_SuppliedType, gen_ORDB4ORA_OperationParameter_Parameter, gen_ORDB4ORA_PrimaryKey_Restriction, gen_ORDB4ORA_Procedure_Operation, gen_ORDB4ORA_RowFeature_Feature, gen_ORDB4ORA_SpacialType_SuppliedType, gen_ORDB4ORA_StructuredType_Datatype, gen_ORDB4ORA_ROWIDType_BuiltInType, gen_ORDB4ORA_RawFeature_Feature, gen_ORDB4ORA_ReferenceType_Datatype, gen_ORDB4ORA_TypedTable_Table, gen_ORDB4ORA_Unique_Restriction, gen_ORDB4ORA_Varray_Datatype, gen_ORDB4ORA_SuppliedType_BasicDataType, gen_ORDB4ORA_XMLType_SuppliedType, gen_ORDB4ORA_DerivedTable_Table, gen_ORDB4ORA_View_DerivedTable},
    metadata=None
)
