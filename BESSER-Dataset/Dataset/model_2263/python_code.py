...
class school_Student:
    ...
    def __init__(self, name: str, students: "school_SchoolClass" = None, Student: "school_SchoolClass" = None):
        self.name = name
...
class school_SchoolClass:
    ...
    def __init__(self, code: str, SchoolClass19: "school_Student" = None, SchoolClass: "school_Course" = None, schoolClasses: "school_Year" = None, schoolClass: set["school_Student"] = None, schoolClass15: set["school_Course"] = None, school_SchoolClass: "school_Teacher" = None, school_SchoolClass26: "school_Teacher" = None, SchoolClass30: "school_Year" = None):
        self.code = code
...
class school_Teacher:
    ...
    def __init__(self, name: str, teachers: "school_School" = None, teacher: set["school_Course"] = None, Teacher: "school_Course" = None, Teacher8: "school_School" = None, school_Teacher: "school_SchoolClass" = None, school_Teacher25: "school_SchoolClass" = None):
        self.name = name
...
class school_School:
    ...
    def __init__(self, name: str, address: str, School: "school_Course" = None, School21: "school_Teacher" = None, school: set["school_Year"] = None, school7: set["school_Teacher"] = None, school10: set["school_Course"] = None, School28: "school_Year" = None):
        self.name = name
...
class school_Course:
    ...
    def __init__(self, subject: str, weight: int, courses: "school_School" = None, Course23: "school_Teacher" = None, courses2: "school_Teacher" = None, courses4: "school_SchoolClass" = None, Course: "school_School" = None, Course16: "school_SchoolClass" = None):
