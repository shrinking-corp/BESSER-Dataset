...
myDsl_Define = Class(name="myDsl_Define")
Greeting = Class(name="Greeting")
myDsl_Lambda = Class(name="myDsl_Lambda")
myDsl_Square = Class(name="myDsl_Square")
myDsl_Conditional = Class(name="myDsl_Conditional")
...
domain_model = DomainModel(
    name="myDsl",
    types={myDsl_Model, myDsl_Greeting, myDsl_Define, Greeting, myDsl_Lambda, myDsl_Square, myDsl_Conditional, myDsl_Operation},
