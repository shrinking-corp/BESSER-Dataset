...
# Classes
qVTcDataDependencyGraph_ClassNode = Class(name="qVTcDataDependencyGraph_ClassNode")
Node = Class(name="Node")
qVTcDataDependencyGraph_DataTypeNode = Class(name="qVTcDataDependencyGraph_DataTypeNode")
qVTcDataDependencyGraph_EObject = Class(name="qVTcDataDependencyGraph_EObject")
qVTcDataDependencyGraph_DependencyEdge = Class(name="qVTcDataDependencyGraph_DependencyEdge")
Edge = Class(name="Edge")
qVTcDataDependencyGraph_Edge = Class(name="qVTcDataDependencyGraph_Edge")
Element = Class(name="Element")
qVTcDataDependencyGraph_Node = Class(name="qVTcDataDependencyGraph_Node")
qVTcDataDependencyGraph_Element = Class(name="qVTcDataDependencyGraph_Element", is_abstract=True)
qVTcDataDependencyGraph_Graph = Class(name="qVTcDataDependencyGraph_Graph")
qVTcDataDependencyGraph_MappingNode = Class(name="qVTcDataDependencyGraph_MappingNode")
qVTcDataDependencyGraph_ReferenceEdge = Class(name="qVTcDataDependencyGraph_ReferenceEdge")
qVTcDataDependencyGraph_ContainmentEdge = Class(name="qVTcDataDependencyGraph_ContainmentEdge")
...
qVTcDataDependencyGraph_DependencyEdge.attributes={qVTcDataDependencyGraph_DependencyEdge_multiple, qVTcDataDependencyGraph_DependencyEdge_direction, qVTcDataDependencyGraph_DependencyEdge_derived}
...
domain_model = DomainModel(
    ...
    types={qVTcDataDependencyGraph_ClassNode, Node, qVTcDataDependencyGraph_DataTypeNode, qVTcDataDependencyGraph_EObject, qVTcDataDependencyGraph_DependencyEdge, Edge, qVTcDataDependencyGraph_Edge, Element, qVTcDataDependencyGraph_Node, qVTcDataDependencyGraph_Element, qVTcDataDependencyGraph_Graph, qVTcDataDependencyGraph_MappingNode, qVTcDataDependencyGraph_ReferenceEdge, qVTcDataDependencyGraph_ContainmentEdge, Model, DependencyDirection},
    associations={incoming11, outgoing12, qvtAstNode14, attribute0, type1, target4, source5, referredProperty7, graph9, elements10},
    generalizations={gen_qVTcDataDependencyGraph_Node_Element, gen_qVTcDataDependencyGraph_ClassNode_Node, gen_qVTcDataDependencyGraph_DataTypeNode_Node, gen_qVTcDataDependencyGraph_DependencyEdge_Edge, gen_qVTcDataDependencyGraph_Edge_Element, gen_qVTcDataDependencyGraph_MappingNode_Node, gen_qVTcDataDependencyGraph_ReferenceEdge_Edge, gen_qVTcDataDependencyGraph_ContainmentEdge_Edge},
    metadata=None
)
