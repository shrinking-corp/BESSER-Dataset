...
def test_hyp_families_membermale_test_setter(instance):
...
def test_Families_MemberMale_test_value_roundtrip():
    instance = Families_MemberMale(test="sample_text")
...
Families_MemberMale_strategy = st.builds(Families_MemberMale, test=safe_text)
@given(instance=Families_MemberMale_strategy)
@settings(max_examples=25)
