...
Y_attY1: Property = Property(name="attY1", type=StringType)
Y.attributes={Y_attY, Y_attY1}
...
R_A: BinaryAssociation = BinaryAssociation(
    name="R_A",
    ends={
        Property(name="aR4", type=A, multiplicity=Multiplicity(0, 1)),
...
domain_model = DomainModel(
    name="_KLtxYOm3EeiV94kHgjpOMg",
    types={Y, C, A, C3, R, Z, C2, B},
