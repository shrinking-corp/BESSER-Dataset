...
def test_hyp_y_constructor_args():
    ...
    params = list(sig.parameters.keys())
    assert "attY1" in params, "Missing parameter 'attY1'"
...
def test_hyp_y_attY1_setter(instance):
    original = instance.attY1
    instance.attY1 = original
    assert instance.attY1 == original
...
def test_Y_attY_value_roundtrip():
    instance = Y(attY="sample_text", attY1="sample_text")
    assert instance.attY == "sample_text"
    instance.attY = "sample_text_2"
    assert instance.attY == "sample_text_2"


def test_Y_attY1_value_roundtrip():
    instance = Y(attY="sample_text", attY1="sample_text")
    assert instance.attY1 == "sample_text"
    instance.attY1 = "sample_text_2"
    assert instance.attY1 == "sample_text_2"
...
Y_strategy = st.builds(Y, attY=safe_text, attY1=safe_text)
@given(instance=Y_strategy)
@settings(max_examples=25)
