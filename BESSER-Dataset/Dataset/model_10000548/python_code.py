...
class subject:
    ...
    def __init__(self, subjectid: str, subjectName: str):
...
class department:
    ...
    def __init__(self, id: str, name: str, director: str, address: str):
        self.id = id
        self.name = name
...
class students:
    ...
    def __init__(self, name: str, gender: str, birthdate: date, address: str, id: str):
        self.name = name
        self.gender = gender
