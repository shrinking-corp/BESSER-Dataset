...
Department.attributes={Department_course, Department_teachers__, Department_hod, Department_students__}
...
students_gender: Property = Property(name="gender", type=StringType)
students_birthdate: Property = Property(name="birthdate", type=DateType)
students_address: Property = Property(name="address", type=StringType)
students_id: Property = Property(name="id", type=StringType)
students.attributes={students_birthdate, students_gender, students_id, students_address, students_name}

# department class attributes and methods
department_id: Property = Property(name="id", type=StringType)
department_name: Property = Property(name="name", type=StringType)
department_director: Property = Property(name="director", type=StringType)
department_address: Property = Property(name="address", type=StringType)
department.attributes={department_name, department_director, department_address, department_id}
...
subject.attributes={subject_subjectid, subject_subjectName}
...
domain_model = DomainModel(
    name="_4331536b_eef4_4e89_ba01_a20230d504db",
    types={Student, Employee_Interface, Teacher, HOD, Department, Course, Authentication, Access_Information, Attendance, Subject, Admin, students, department, subject, administrator},
