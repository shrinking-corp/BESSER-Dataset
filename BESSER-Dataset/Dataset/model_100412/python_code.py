...
class smach_InitStraightState(SMACHState):
    ...
    pass
class smach_ServiceState(SMACHState, ServiceClient):
...
class smach_SMACHTransition:
    ...
    def __init__(self, name: str, smach_SMACHTransition: "smach_SMACHStateMachine" = None, smach_SMACHTransition11: "smach_SMACHState" = None, smach_SMACHTransition8: "smach_SMACHState" = None):
        self.name = name
...
class smach_SMACHState:
    ...
    def __init__(self, goal: str, goal_type: str, remap_overwrite: str, smach_SMACHState: "smach_SMACHStateMachine" = None, smach_SMACHState12: "smach_SMACHTransition" = None, smach_SMACHState9: "smach_SMACHTransition" = None):
        self.goal = goal
...
class smach_SMACHStateMachine(Node):
    ...
    def __init__(self, SkillInterface: bool, smach_SMACHStateMachine: set["smach_SMACHState"] = None, smach_SMACHStateMachine2: set["smach_SMACHTransition"] = None, smach_SMACHStateMachine4: set["smach_FinalState"] = None, smach_SMACHStateMachine6: set["smach_InitActionState"] = None):
