...
domain_model = DomainModel(
    name="smach",
    types={smach_SMACHStateMachine, Node, smach_SMACHState, smach_SMACHTransition, smach_FinalState, smach_InitActionState, smach_ActionState, ActionClient, SMACHState, smach_ServiceState, ServiceClient, smach_InitStraightState, SMACHStateOutcomes, SMACHGoalTypes},
    associations={states0, transitions1, finalStates3, initialStates5, Target10, Source7},
    generalizations={gen_smach_SMACHStateMachine_Node, gen_smach_ActionState_ActionClient, gen_smach_ActionState_SMACHState, gen_smach_ServiceState_ServiceClient, gen_smach_ServiceState_SMACHState, gen_smach_FinalState_SMACHState, gen_smach_InitStraightState_SMACHState, gen_smach_InitActionState_SMACHState},
    metadata=None
)
