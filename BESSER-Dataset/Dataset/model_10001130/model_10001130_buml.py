...
Food.attributes={Food_prepared, Food_price, Food_served, Food_name, Food_food_id}
...
Staff.attributes={Staff_type, Staff_name, Staff_staffId}
...
Booking.attributes={Booking_startTime, Booking_date, Booking_customer_name, Booking_contact_no, Booking_reservedTables, Booking_booking_id, Booking_endTime, Booking_email_id}
...
domain_model = DomainModel(
    name="_896e3676_b291_49d7_b6cd_6bd0279c2c5a",
    types={Order, Food, Staff, Waiter, Chef, StaffUI, CustomerUI, ReservationManagementSystem, Booking, Table, Report},
