...
class Booking:
    ...
    def __init__(self, reservedTables: str, customer_name: str, contact_no: int, email_id: str, booking_id: int, date: date, startTime: str, endTime: str, ReservationManagementSystem_Booking_17: "ReservationManagementSystem" = None, reservedBy13: set["Table"] = None):
