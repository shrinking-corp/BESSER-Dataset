...
class Customer:
    ...
    def __init__(self, Cellphone: str, Address: str, PostCode: int, FullName: str, CreditCard: str, Order_Customer_115: set["Order"] = None):
...
class Order:
    ...
    def __init__(self, Restaurant: Restaurant, ItemList: MenuItem, Customer: Customer, Order_MenuItem_010: set["MenuItem"] = None, OrderController_Order_119: set["OrderController"] = None, Order_Restaurant_012: "Restaurant" = None, Order_Customer_014: "Customer" = None):
        self.Restaurant = Restaurant
