...
# Classes
mm1_Member = Class(name="mm1_Member")
mm1_Book = Class(name="mm1_Book")
mm1_Film = Class(name="mm1_Film")
mm1_Library = Class(name="mm1_Library")
...
domain_model = DomainModel(
    name="mm1",
    types={mm1_Member, mm1_Book, mm1_Film, mm1_Library},
    associations={members0, books1, films3, bookLoans5, filmLoans8},
    generalizations={},
    metadata=None
)
