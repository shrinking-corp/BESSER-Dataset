...
class mm1_Library:
    ...
    def __init__(self, name: str, mm1_Library: set["mm1_Member"] = None, mm1_Library2: set["mm1_Book"] = None, mm1_Library4: set["mm1_Film"] = None):
        self.name = name
...
class mm1_Book:
    ...
    def __init__(self, name: str, mm1_Book: "mm1_Library" = None, mm1_Book7: "mm1_Member" = None):
        self.name = name
...
class mm1_Member:
    ...
    def __init__(self, name: str, mm1_Member: "mm1_Library" = None, mm1_Member6: set["mm1_Book"] = None, mm1_Member9: set["mm1_Film"] = None):
        self.name = name
