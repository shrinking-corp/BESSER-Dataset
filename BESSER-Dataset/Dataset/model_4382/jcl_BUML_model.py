...
# Classes
jcl_commons_NamedElement = Class(name="jcl_commons_NamedElement")
jcl_commons_PhraseableElement = Class(name="jcl_commons_PhraseableElement")
jcl_commons_CommentableElement = Class(name="jcl_commons_CommentableElement", is_abstract=True)
jcl_commons_IncompleteElement = Class(name="jcl_commons_IncompleteElement", is_abstract=True)
Water = Class(name="Water")
jcl_parameters_Parameter = Class(name="jcl_parameters_Parameter", is_abstract=True)
jcl_parameters_Display = Class(name="jcl_parameters_Display")
Parameter_ = Class(name="Parameter")
jcl_parameters_JobClass = Class(name="jcl_parameters_JobClass")
jcl_parameters_MessageClass = Class(name="jcl_parameters_MessageClass")
jcl_parameters_Password = Class(name="jcl_parameters_Password")
jcl_parameters_Priority = Class(name="jcl_parameters_Priority")
jcl_parameters_UserID = Class(name="jcl_parameters_UserID")
jcl_parameters_MessageLevel = Class(name="jcl_parameters_MessageLevel")
jcl_parameters_TypeRun = Class(name="jcl_parameters_TypeRun")
jcl_parameters_AddressSpace = Class(name="jcl_parameters_AddressSpace")
parameters_Parameter = Class(name="parameters_Parameter")
commons_ProcedureStepElement = Class(name="commons_ProcedureStepElement")
jcl_commons_ProcedureStepElement = Class(name="jcl_commons_ProcedureStepElement", is_abstract=True)
jcl_parameters_AccountInfo = Class(name="jcl_parameters_AccountInfo")
Literal = Class(name="Literal")
jcl_parameters_Argument = Class(name="jcl_parameters_Argument")
jcl_parameters_Condition = Class(name="jcl_parameters_Condition")
Condition = Class(name="Condition")
jcl_parameters_DatasetName = Class(name="jcl_parameters_DatasetName")
jcl_parameters_Other = Class(name="jcl_parameters_Other")
commons_NamedElement = Class(name="commons_NamedElement")
jcl_statements_Statement = Class(name="jcl_statements_Statement", is_abstract=True)
members_Member = Class(name="members_Member")
jcl_statements_Execute = Class(name="jcl_statements_Execute", is_abstract=True)
Statement = Class(name="Statement")
jcl_statements_StatementContainer = Class(name="jcl_statements_StatementContainer", is_abstract=True)
jcl_statements_Condition = Class(name="jcl_statements_Condition")
...
jcl_parameters_Bytes = Class(name="jcl_parameters_Bytes")
jcl_statements_DataDefinition = Class(name="jcl_statements_DataDefinition")
jcl_statements_Set = Class(name="jcl_statements_Set")
jcl_statements_Input = Class(name="jcl_statements_Input")
jcl_statements_Output = Class(name="jcl_statements_Output")
jcl_statements_JCLLibrary = Class(name="jcl_statements_JCLLibrary")
jcl_statements_Control = Class(name="jcl_statements_Control")
EndControl = Class(name="EndControl")
jcl_statements_Include = Class(name="jcl_statements_Include")
jcl_statements_Command = Class(name="jcl_statements_Command")
jcl_statements_ExecuteProgram = Class(name="jcl_statements_ExecuteProgram")
Execute = Class(name="Execute")
jcl_statements_ExecuteProcedure = Class(name="jcl_statements_ExecuteProcedure")
jcl_statements_EndControl = Class(name="jcl_statements_EndControl")
jcl_containers_JCLRoot = Class(name="jcl_containers_JCLRoot")
Member = Class(name="Member")
jcl_containers_JobUnit = Class(name="jcl_containers_JobUnit")
containers_JCLRoot = Class(name="containers_JCLRoot")
commons_IncompleteElement = Class(name="commons_IncompleteElement")
ExecuteProgram = Class(name="ExecuteProgram")
jcl_expressions_Expression = Class(name="jcl_expressions_Expression", is_abstract=True)
jcl_expressions_RelationalExpression = Class(name="jcl_expressions_RelationalExpression")
ConditionalAndExpressionChild = Class(name="ConditionalAndExpressionChild")
Expression = Class(name="Expression")
RelationOperator = Class(name="RelationOperator")
jcl_expressions_ConditionalExpression = Class(name="jcl_expressions_ConditionalExpression", is_abstract=True)
jcl_expressions_ConditionalOrExpression = Class(name="jcl_expressions_ConditionalOrExpression")
...
Or = Class(name="Or")
jcl_expressions_ConditionalOrExpressionChild = Class(name="jcl_expressions_ConditionalOrExpressionChild", is_abstract=True)
jcl_expressions_ConditionalAndExpression = Class(name="jcl_expressions_ConditionalAndExpression")
And = Class(name="And")
jcl_expressions_ConditionalAndExpressionChild = Class(name="jcl_expressions_ConditionalAndExpressionChild", is_abstract=True)
jcl_expressions_RelationalExpressionChild = Class(name="jcl_expressions_RelationalExpressionChild", is_abstract=True)
jcl_expressions_UnaryExpressionChild = Class(name="jcl_expressions_UnaryExpressionChild", is_abstract=True)
jcl_expressions_UnaryExpression = Class(name="jcl_expressions_UnaryExpression")
UnaryExpressionChild = Class(name="UnaryExpressionChild")
RelationalExpressionChild = Class(name="RelationalExpressionChild")
jcl_expressions_NestedExpression = Class(name="jcl_expressions_NestedExpression")
PrimaryExpression = Class(name="PrimaryExpression")
jcl_expressions_PrimaryExpression = Class(name="jcl_expressions_PrimaryExpression", is_abstract=True)
jcl_expressions_Abend = Class(name="jcl_expressions_Abend")
expressions_PrimaryExpression = Class(name="expressions_PrimaryExpression")
IdentifierReference = Class(name="IdentifierReference")
jcl_expressions_Run = Class(name="jcl_expressions_Run")
jcl_operators_Operator = Class(name="jcl_operators_Operator", is_abstract=True)
PhraseableElement = Class(name="PhraseableElement")
jcl_operators_GreaterThan = Class(name="jcl_operators_GreaterThan")
jcl_operators_GreaterEqual = Class(name="jcl_operators_GreaterEqual")
jcl_operators_Equal = Class(name="jcl_operators_Equal")
jcl_operators_LessThan = Class(name="jcl_operators_LessThan")
jcl_operators_LessEqual = Class(name="jcl_operators_LessEqual")
jcl_operators_NotEqual = Class(name="jcl_operators_NotEqual")
UnaryOperator = Class(name="UnaryOperator")
jcl_operators_RelationOperator = Class(name="jcl_operators_RelationOperator", is_abstract=True)
jcl_operators_Negate = Class(name="jcl_operators_Negate")
jcl_operators_LogicOperator = Class(name="jcl_operators_LogicOperator")
jcl_operators_And = Class(name="jcl_operators_And")
LogicOperator = Class(name="LogicOperator")
jcl_operators_Or = Class(name="jcl_operators_Or")
jcl_literals_Literal = Class(name="jcl_literals_Literal", is_abstract=True)
jcl_literals_IntegerLiteral = Class(name="jcl_literals_IntegerLiteral")
literals_Literal = Class(name="literals_Literal")
conditions_ReturnCode = Class(name="conditions_ReturnCode")
jcl_literals_StringLiteral = Class(name="jcl_literals_StringLiteral")
jcl_literals_SpecialLiteral = Class(name="jcl_literals_SpecialLiteral")
jcl_references_Reference = Class(name="jcl_references_Reference", is_abstract=True)
Reference = Class(name="Reference")
jcl_references_ElementReference = Class(name="jcl_references_ElementReference", is_abstract=True)
ReferenceableElement = Class(name="ReferenceableElement")
jcl_references_IdentifierReference = Class(name="jcl_references_IdentifierReference")
references_ElementReference = Class(name="references_ElementReference")
jcl_references_ReferenceableElement = Class(name="jcl_references_ReferenceableElement", is_abstract=True)
jcl_conditions_Condition = Class(name="jcl_conditions_Condition", is_abstract=True)
jcl_conditions_Even = Class(name="jcl_conditions_Even")
PrimaryCondition = Class(name="PrimaryCondition")
jcl_conditions_Only = Class(name="jcl_conditions_Only")
jcl_conditions_PrimaryCondition = Class(name="jcl_conditions_PrimaryCondition", is_abstract=True)
jcl_conditions_NestedCondition = Class(name="jcl_conditions_NestedCondition")
jcl_operators_UnaryOperator = Class(name="jcl_operators_UnaryOperator", is_abstract=True)
Operator = Class(name="Operator")
jcl_conditions_RelationalCondition = Class(name="jcl_conditions_RelationalCondition")
conditions_PrimaryCondition = Class(name="conditions_PrimaryCondition")
ReturnCode = Class(name="ReturnCode")
jcl_conditions_ReturnCode = Class(name="jcl_conditions_ReturnCode", is_abstract=True)
jcl_procedures_Procedure = Class(name="jcl_procedures_Procedure")
jcl_members_Member = Class(name="jcl_members_Member", is_abstract=True)
jcl_waters_Water = Class(name="jcl_waters_Water")
...
jcl_parameters_Password.attributes={jcl_parameters_Password_new, jcl_parameters_Password_old}
...
jcl_parameters_MessageLevel.attributes={jcl_parameters_MessageLevel_messages, jcl_parameters_MessageLevel_statements}
...
domain_model = DomainModel(
    name="jcl",
    types={jcl_commons_NamedElement, jcl_commons_PhraseableElement, jcl_commons_CommentableElement, jcl_commons_IncompleteElement, Water, jcl_parameters_Parameter, jcl_parameters_Display, Parameter_, jcl_parameters_JobClass, jcl_parameters_MessageClass, jcl_parameters_Password, jcl_parameters_Priority, jcl_parameters_UserID, jcl_parameters_MessageLevel, jcl_parameters_TypeRun, jcl_parameters_AddressSpace, parameters_Parameter, commons_ProcedureStepElement, jcl_commons_ProcedureStepElement, jcl_parameters_AccountInfo, Literal, jcl_parameters_Argument, jcl_parameters_Condition, Condition, jcl_parameters_DatasetName, jcl_parameters_Other, commons_NamedElement, jcl_statements_Statement, members_Member, jcl_statements_Execute, Statement, jcl_statements_StatementContainer, jcl_statements_Condition, statements_StatementContainer, statements_Statement, jcl_parameters_Bytes, jcl_statements_DataDefinition, jcl_statements_Set, jcl_statements_Input, jcl_statements_Output, jcl_statements_JCLLibrary, jcl_statements_Control, EndControl, jcl_statements_Include, jcl_statements_Command, jcl_statements_ExecuteProgram, Execute, jcl_statements_ExecuteProcedure, jcl_statements_EndControl, jcl_containers_JCLRoot, Member, jcl_containers_JobUnit, containers_JCLRoot, commons_IncompleteElement, ExecuteProgram, jcl_expressions_Expression, jcl_expressions_RelationalExpression, ConditionalAndExpressionChild, Expression, RelationOperator, jcl_expressions_ConditionalExpression, jcl_expressions_ConditionalOrExpression, ConditionalExpression, ConditionalOrExpressionChild, Or, jcl_expressions_ConditionalOrExpressionChild, jcl_expressions_ConditionalAndExpression, And, jcl_expressions_ConditionalAndExpressionChild, jcl_expressions_RelationalExpressionChild, jcl_expressions_UnaryExpressionChild, jcl_expressions_UnaryExpression, UnaryExpressionChild, RelationalExpressionChild, jcl_expressions_NestedExpression, PrimaryExpression, jcl_expressions_PrimaryExpression, jcl_expressions_Abend, expressions_PrimaryExpression, IdentifierReference, jcl_expressions_Run, jcl_operators_Operator, PhraseableElement, jcl_operators_GreaterThan, jcl_operators_GreaterEqual, jcl_operators_Equal, jcl_operators_LessThan, jcl_operators_LessEqual, jcl_operators_NotEqual, UnaryOperator, jcl_operators_RelationOperator, jcl_operators_Negate, jcl_operators_LogicOperator, jcl_operators_And, LogicOperator, jcl_operators_Or, jcl_literals_Literal, jcl_literals_IntegerLiteral, literals_Literal, conditions_ReturnCode, jcl_literals_StringLiteral, jcl_literals_SpecialLiteral, jcl_references_Reference, Reference, jcl_references_ElementReference, ReferenceableElement, jcl_references_IdentifierReference, references_ElementReference, jcl_references_ReferenceableElement, jcl_conditions_Condition, jcl_conditions_Even, PrimaryCondition, jcl_conditions_Only, jcl_conditions_PrimaryCondition, jcl_conditions_NestedCondition, jcl_operators_UnaryOperator, Operator, jcl_conditions_RelationalCondition, conditions_PrimaryCondition, ReturnCode, jcl_conditions_ReturnCode, jcl_procedures_Procedure, jcl_members_Member, jcl_waters_Water, AdressSpaceEnum, TypeRunEnum},
    associations={waters0, values1, condition2, parameters3, statements4, elseStatements5, endControl9, members10, parameters11, accountInfos13, executes16, condition7, relationOperators19, children21, orOperators22, children24, andOperators25, child27, children18, expression30, step32, step33, operator28, next35, target36, relationOperator39, returnCode41, conditions37},
    generalizations={gen_jcl_parameters_Display_Parameter, gen_jcl_parameters_JobClass_Parameter, gen_jcl_parameters_MessageClass_Parameter, gen_jcl_parameters_Password_Parameter, gen_jcl_parameters_Priority_Parameter, gen_jcl_parameters_UserID_Parameter, gen_jcl_parameters_MessageLevel_Parameter, gen_jcl_parameters_TypeRun_Parameter, gen_jcl_parameters_AddressSpace_parameters_Parameter, gen_jcl_parameters_AddressSpace_commons_ProcedureStepElement, gen_jcl_parameters_AccountInfo_parameters_Parameter, gen_jcl_parameters_AccountInfo_commons_ProcedureStepElement, gen_jcl_parameters_Argument_parameters_Parameter, gen_jcl_parameters_Argument_commons_ProcedureStepElement, gen_jcl_parameters_Condition_parameters_Parameter, gen_jcl_parameters_Condition_commons_ProcedureStepElement, gen_jcl_parameters_DatasetName_Parameter, gen_jcl_parameters_Other_parameters_Parameter, gen_jcl_parameters_Other_commons_NamedElement, gen_jcl_parameters_Other_commons_ProcedureStepElement, gen_jcl_statements_Statement_commons_NamedElement, gen_jcl_statements_Statement_members_Member, gen_jcl_statements_Execute_Statement, gen_jcl_statements_Condition_statements_StatementContainer, gen_jcl_statements_Condition_statements_Statement, gen_jcl_parameters_Bytes_Parameter, gen_jcl_statements_DataDefinition_statements_Statement, gen_jcl_statements_DataDefinition_commons_ProcedureStepElement, gen_jcl_statements_Set_Statement, gen_jcl_statements_Input_Statement, gen_jcl_statements_Output_Statement, gen_jcl_statements_JCLLibrary_Statement, gen_jcl_statements_Control_Statement, gen_jcl_statements_Include_Statement, gen_jcl_statements_Command_Statement, gen_jcl_statements_ExecuteProgram_Execute, gen_jcl_statements_ExecuteProcedure_Execute, gen_jcl_statements_EndControl_Statement, gen_jcl_containers_JobUnit_commons_NamedElement, gen_jcl_containers_JobUnit_containers_JCLRoot, gen_jcl_containers_JobUnit_commons_IncompleteElement, gen_jcl_expressions_RelationalExpression_ConditionalAndExpressionChild, gen_jcl_expressions_ConditionalExpression_Expression, gen_jcl_expressions_ConditionalOrExpression_ConditionalExpression, gen_jcl_expressions_ConditionalOrExpressionChild_ConditionalExpression, gen_jcl_expressions_ConditionalAndExpression_ConditionalOrExpressionChild, gen_jcl_expressions_ConditionalAndExpressionChild_ConditionalOrExpressionChild, gen_jcl_expressions_RelationalExpressionChild_ConditionalAndExpressionChild, gen_jcl_expressions_UnaryExpressionChild_RelationalExpressionChild, gen_jcl_expressions_UnaryExpression_RelationalExpressionChild, gen_jcl_expressions_NestedExpression_PrimaryExpression, gen_jcl_expressions_PrimaryExpression_UnaryExpressionChild, gen_jcl_expressions_Abend_expressions_PrimaryExpression, gen_jcl_expressions_Abend_commons_ProcedureStepElement, gen_jcl_expressions_Run_expressions_PrimaryExpression, gen_jcl_expressions_Run_commons_ProcedureStepElement, gen_jcl_operators_Operator_PhraseableElement, gen_jcl_operators_GreaterThan_RelationOperator, gen_jcl_operators_GreaterEqual_RelationOperator, gen_jcl_operators_Equal_RelationOperator, gen_jcl_operators_LessThan_RelationOperator, gen_jcl_operators_LessEqual_RelationOperator, gen_jcl_operators_NotEqual_RelationOperator, gen_jcl_operators_RelationOperator_Operator, gen_jcl_operators_Negate_UnaryOperator, gen_jcl_operators_LogicOperator_Operator, gen_jcl_operators_And_LogicOperator, gen_jcl_operators_Or_LogicOperator, gen_jcl_literals_IntegerLiteral_literals_Literal, gen_jcl_literals_IntegerLiteral_expressions_PrimaryExpression, gen_jcl_literals_IntegerLiteral_conditions_ReturnCode, gen_jcl_literals_StringLiteral_Literal, gen_jcl_literals_SpecialLiteral_Literal, gen_jcl_references_ElementReference_Reference, gen_jcl_references_IdentifierReference_references_ElementReference, gen_jcl_references_IdentifierReference_expressions_PrimaryExpression, gen_jcl_references_IdentifierReference_conditions_ReturnCode, gen_jcl_conditions_Even_PrimaryCondition, gen_jcl_conditions_Only_PrimaryCondition, gen_jcl_conditions_PrimaryCondition_Condition, gen_jcl_conditions_NestedCondition_PrimaryCondition, gen_jcl_operators_UnaryOperator_Operator, gen_jcl_conditions_RelationalCondition_conditions_PrimaryCondition, gen_jcl_conditions_RelationalCondition_references_ElementReference, gen_jcl_procedures_Procedure_containers_JCLRoot, gen_jcl_procedures_Procedure_commons_NamedElement, gen_jcl_procedures_Procedure_members_Member},
    metadata=None
)
