...
class WebUser:
    ...
    def __init__(self, login: str, password: str, state: UserState, shoppincart9: "ShoppinCart" = None, customer6: "Customer" = None):
        self.login = login
...
class Account:
    ...
    def __init__(self, closed: date, isClosed: bool, billingAddress: str, open: date, customer11: "Customer" = None, cart16: "ShoppinCart" = None, payment0: set["Payment"] = None, order4: set["Order"] = None):
        self.closed = closed
...
class ShoppinCart:
    ...
    def __init__(self, creationDate: date, account17: "Account" = None, items18: set["LineItem"] = None, shoppinCart20: "ShoppinCart" = None, shoppinCart21: "ShoppinCart" = None, webuser8: "WebUser" = None):
...
class Customer:
    ...
    def __init__(self, address: str, phone: str, email: str, acc10: "Account" = None, webuser7: "WebUser" = None):
