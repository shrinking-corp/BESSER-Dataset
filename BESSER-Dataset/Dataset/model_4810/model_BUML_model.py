...
model_Service = Class(name="model_Service")
model_App = Class(name="model_App")
model_Param = Class(name="model_Param")
...
model_Service.attributes={model_Service_methodName, model_Service_name, model_Service_acceptedParams}

# model_App class attributes and methods
model_App_m_auth: Method = Method(name="auth", parameters={Parameter(name='model_login', type=StringType), Parameter(name='model_password', type=StringType)})
model_App_m_service: Method = Method(name="service", parameters={Parameter(name='model_service', type=StringType), Parameter(name='model_token', type=StringType), Parameter(name='model_params', type=StringType)})
model_App_m_authSuccess: Method = Method(name="authSuccess", parameters={Parameter(name='model_token', type=StringType)})
model_App_m_authFailure: Method = Method(name="authFailure", parameters={})
model_App_m_result: Method = Method(name="result", parameters={Parameter(name='model_result', type=StringType)})
model_App.methods={model_App_m_result, model_App_m_authSuccess, model_App_m_service, model_App_m_auth, model_App_m_authFailure}
