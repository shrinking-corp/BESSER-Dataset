...
def test_hyp_caninos_has_attribute():
...
def test_hyp_empresa_has_buscarCaninos():
...
def test_hyp_empresa_has_Promedio_canino():
...
def test_hyp_empresa_has_Cantidad_razaCanina():
...
def test_hyp_calcular_promedio_edad_perros_usecase_is_not_abstract():
    assert not inspect.isabstract(Calcular_promedio_edad_perros_UseCase)


def test_hyp_calcular_promedio_edad_perros_usecase_constructor_exists():
    assert callable(Calcular_promedio_edad_perros_UseCase.__init__)


def test_hyp_calcular_promedio_edad_perros_usecase_constructor_args():
    sig = inspect.signature(Calcular_promedio_edad_perros_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_calcular_cantidad_por_raza_usecase_is_not_abstract():
    assert not inspect.isabstract(Calcular_cantidad_por_raza_UseCase)


def test_hyp_calcular_cantidad_por_raza_usecase_constructor_exists():
    assert callable(Calcular_cantidad_por_raza_UseCase.__init__)


def test_hyp_calcular_cantidad_por_raza_usecase_constructor_args():
    sig = inspect.signature(Calcular_cantidad_por_raza_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_buscar_perro_por_nombre_usecase_is_not_abstract():
    assert not inspect.isabstract(Buscar_perro_por_nombre_UseCase)


def test_hyp_buscar_perro_por_nombre_usecase_constructor_exists():
    assert callable(Buscar_perro_por_nombre_UseCase.__init__)


def test_hyp_buscar_perro_por_nombre_usecase_constructor_args():
    sig = inspect.signature(Buscar_perro_por_nombre_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ir_al_ultimo_usecase_is_not_abstract():
    assert not inspect.isabstract(Ir_al_ultimo_UseCase)


def test_hyp_ir_al_ultimo_usecase_constructor_exists():
    assert callable(Ir_al_ultimo_UseCase.__init__)


def test_hyp_ir_al_ultimo_usecase_constructor_args():
    sig = inspect.signature(Ir_al_ultimo_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ir_al_primero_usecase_is_not_abstract():
    assert not inspect.isabstract(Ir_al_primero_UseCase)


def test_hyp_ir_al_primero_usecase_constructor_exists():
    assert callable(Ir_al_primero_UseCase.__init__)


def test_hyp_ir_al_primero_usecase_constructor_args():
    sig = inspect.signature(Ir_al_primero_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_anterior_usecase_is_not_abstract():
    assert not inspect.isabstract(Anterior_UseCase)


def test_hyp_anterior_usecase_constructor_exists():
    assert callable(Anterior_UseCase.__init__)


def test_hyp_anterior_usecase_constructor_args():
    sig = inspect.signature(Anterior_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_avanzar_usecase_is_not_abstract():
    assert not inspect.isabstract(Avanzar_UseCase)


def test_hyp_avanzar_usecase_constructor_exists():
    assert callable(Avanzar_UseCase.__init__)


def test_hyp_avanzar_usecase_constructor_args():
    sig = inspect.signature(Avanzar_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_interfaz_veterinaria_usecase_is_not_abstract():
    assert not inspect.isabstract(Interfaz_veterinaria_UseCase)


def test_hyp_interfaz_veterinaria_usecase_constructor_exists():
    assert callable(Interfaz_veterinaria_UseCase.__init__)


def test_hyp_interfaz_veterinaria_usecase_constructor_args():
...
@given(instance=Caninos_strategy)
def test_hyp_caninos_attribute_setter(instance):
...
@given(instance=Empresa_strategy)
def test_hyp_empresa_buscarCaninos_setter(instance):
...
@given(instance=Empresa_strategy)
def test_hyp_empresa_Promedio_canino_setter(instance):
...
@given(instance=Empresa_strategy)
def test_hyp_empresa_Cantidad_razaCanina_setter(instance):
