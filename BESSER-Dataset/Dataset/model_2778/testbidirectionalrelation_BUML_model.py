...
domain_model = DomainModel(
    ...
    types={testbidirectionalrelation_ConceptC, testbidirectionalrelation_ConceptD, testbidirectionalrelation_ConceptE, testbidirectionalrelation_ConceptF, testbidirectionalrelation_ConceptG, testbidirectionalrelation_ConceptA, testbidirectionalrelation_ConceptB},
    associations={conceptc1, conceptd3, concepte5, conceptf7, conceptg9, conceptc11, conceptb12, concepte13, conceptd14, conceptg15, conceptf16, conceptb0},
    generalizations={},
    metadata=None
)
