...
class training_Training:
    ...
    def __init__(self, title: str, Training: "training_Session" = None, canProvide: set["training_Trainer"] = None, training: "training_Session" = None, Training14: "training_Trainer" = None, training_Training: "training_TrainingOrganization" = None):
        self.title = title
...
class training_Session:
    ...
    def __init__(self, name: str, date: date, training_Session: "training_Trainer" = None, training_Session3: set["training_Person"] = None, session: "training_Training" = None, Session: "training_Training" = None, training_Session8: "training_TrainingOrganization" = None):
        self.name = name
        self.date = date
