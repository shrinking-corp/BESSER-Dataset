...
# Classes
model3_Class1 = Class(name="model3_Class1")
Class2 = Class(name="Class2")
model3_MetaRef = Class(name="model3_MetaRef")
model3_EPackage = Class(name="model3_EPackage")
model3_EClass = Class(name="model3_EClass")
model3_EReference = Class(name="model3_EReference")
model3_Polygon = Class(name="model3_Polygon")
model3_PolygonWithDuplicates = Class(name="model3_PolygonWithDuplicates")
model3_NodeA = Class(name="model3_NodeA")
model3_NodeB = Class(name="model3_NodeB")
model3_NodeC = Class(name="model3_NodeC")
model3_NodeE = Class(name="model3_NodeE")
model3_Image = Class(name="model3_Image")
model3_File = Class(name="model3_File")
model3_ClassWithIDAttribute = Class(name="model3_ClassWithIDAttribute")
model3_ClassWithJavaClassAttribute = Class(name="model3_ClassWithJavaClassAttribute")
model3_ClassWithJavaObjectAttribute = Class(name="model3_ClassWithJavaObjectAttribute")
model3_ClassWithTransientContainment = Class(name="model3_ClassWithTransientContainment")
model3_EdgeTarget = Class(name="model3_EdgeTarget")
model3_Edge = Class(name="model3_Edge")
model3_NodeF = Class(name="model3_NodeF")
EdgeTarget = Class(name="EdgeTarget")
model3_NodeD = Class(name="model3_NodeD")
model3_subpackage_Class2 = Class(name="model3_subpackage_Class2")
subpackage_model3_Class1 = Class(name="subpackage_model3_Class1")
model3_Diagram = Class(name="model3_Diagram")
...
class20: BinaryAssociation = BinaryAssociation(
    name="class20",
    ends={
        Property(name="Class2", type=model3_Class1, multiplicity=Multiplicity(1, 1)),
        Property(name="class1", type=Class2, multiplicity=Multiplicity(0, 9999))
    }
)
...
domain_model = DomainModel(
    name="model3",
    types={model3_Class1, Class2, model3_MetaRef, model3_EPackage, model3_EClass, model3_EReference, model3_Polygon, model3_PolygonWithDuplicates, model3_NodeA, model3_NodeB, model3_NodeC, model3_NodeE, model3_Image, model3_File, model3_ClassWithIDAttribute, model3_ClassWithJavaClassAttribute, model3_ClassWithJavaObjectAttribute, model3_ClassWithTransientContainment, model3_EdgeTarget, model3_Edge, model3_NodeF, EdgeTarget, model3_NodeD, model3_subpackage_Class2, subpackage_model3_Class1, model3_Diagram},
    associations={class20, ePackageRef1, eClassRef2, eReferenceRef4, children7, otherNodes9, children12, parent14, children17, parent33, otherNodes37, oppositeNode40, mainNode43, otherNodes45, transientChild49, transientChildren51, persistentChild54, persistentChildren57, outgoingEdges59, incomingEdges60, parent20, otherNodes24, oppositeNodes27, children30, class168, sourceNode62, targetNode63, edges65, edgeTargets66},
