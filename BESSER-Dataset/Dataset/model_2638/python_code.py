...
class model3_Class1:
    ...
    def __init__(self, additionalValue: str, class1: set["Class2"] = None):
        self.additionalValue = additionalValue
        self.class1 = class1 if class1 is not None else set()
        
        pass
    @property
    def additionalValue(self):
    ...
    def class1(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_model3_Class1__class1", None)
        self.__class1 = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "Class2"):
                    opp_val = getattr(item, "Class2", None)
                    
                    if opp_val == self:
                        setattr(item, "Class2", None)
...
class model3_NodeD:
    ...
    def __init__(self, name: str, NodeD35: "model3_NodeD" = None, children34: "model3_NodeD" = None, NodeD38: "model3_NodeD" = None, oppositeNode: set["model3_NodeD"] = None, NodeD42: "model3_NodeD" = None, otherNodes41: "model3_NodeD" = None, NodeD: "model3_NodeD" = None, parent31: set["model3_NodeD"] = None):
        self.name = name
