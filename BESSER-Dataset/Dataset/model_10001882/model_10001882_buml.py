...
pembeli.attributes={pembeli_name, pembeli_id, pembeli_shippinginfo, pembeli_mail, pembeli_address, pembeli_password, pembeli_username}
...
Cart.attributes={Cart_quantity, Cart_date, Cart_cartid, Cart_productid}
...
Order.attributes={Order_dateorder, Order_status, Order_shippingid, Order_customerid, Order_datedeliver, Order_orderid}
...
Orderdetail.attributes={Orderdetail_orderid, Orderdetail_productid, Orderdetail_quantity, Orderdetail_cost, Orderdetail_total}
...
Shippinginfo.attributes={Shippinginfo_type, Shippinginfo_total, Shippinginfo_cost, Shippinginfo_region, Shippinginfo_shippingid}
...
Produk.attributes={Produk_name, Produk_productid, Produk_desc, Produk_idkategori, Produk_price}
...
Kategori.attributes={Kategori_name, Kategori_productid, Kategori_desc, Kategori_idkategori}
...
penjual.attributes={penjual_mail, penjual_id, penjual_username, penjual_name, penjual_password, penjual_bank, penjual_bussinessname, penjual_address, penjual_shippinginfo}
...
barang.attributes={barang_id_kategori, barang_nama_barang, barang_id, barang_harga_barang, barang_deskripsi_barang}
...
kategori.attributes={kategori_id, kategori_deskripsi_kategori, kategori_nama_kategori}
...
vendor.attributes={vendor_bussinessname, vendor_mail, vendor_shippinginfo, vendor_id, vendor_id_role, vendor_address, vendor_bank, vendor_name, vendor_username, vendor_password}
...
pembeli1.attributes={pembeli1_mail, pembeli1_id_role, pembeli1_username, pembeli1_password, pembeli1_name, pembeli1_id, pembeli1_address}
...
role.attributes={role_deskripsi_role, role_id, role_nama_role}
...
order_dateorder: Property = Property(name="dateorder", type=StringType)
order_status: Property = Property(name="status", type=StringType)
order.attributes={order_order_id, order_id_user, order_status, order_dateorder}
...
orderdetail_total: Property = Property(name="total", type=StringType)
orderdetail.attributes={orderdetail_barang_id, orderdetail_order_id, orderdetail_total}
