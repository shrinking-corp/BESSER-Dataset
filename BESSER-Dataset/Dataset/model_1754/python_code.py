...
class simpleany_Description:
    ...
    def __init__(self, keyword: str, mixed: str, simpleany_Description3: "simpleany_Description" = None, simpleany_Description1: set["simpleany_Description"] = None, simpleany_Description: "simpleany_BookType" = None):
