...
# Classes
simpleany_DocumentRoot = Class(name="simpleany_DocumentRoot")
simpleany_BookType = Class(name="simpleany_BookType")
simpleany_Description = Class(name="simpleany_Description")
simpleany_EStringToStringMapEntry = Class(name="simpleany_EStringToStringMapEntry")
simpleany_LibraryType = Class(name="simpleany_LibraryType")
...
simpleany_Description.attributes={simpleany_Description_mixed, simpleany_Description_keyword}
...
domain_model = DomainModel(
    name="simpleany",
    types={simpleany_DocumentRoot, simpleany_BookType, simpleany_Description, simpleany_EStringToStringMapEntry, simpleany_LibraryType},
    associations={description2, description0, xMLNSPrefixMap4, xSISchemaLocation5, library8, book10},
    generalizations={},
    metadata=None
)
