...
# Classes
GraphWiki_Wiki = Class(name="GraphWiki_Wiki")
GraphWiki_IndexGraph = Class(name="GraphWiki_IndexGraph")
GraphWiki_CategoryGraph = Class(name="GraphWiki_CategoryGraph")
GraphWiki_ArticleGraph = Class(name="GraphWiki_ArticleGraph")
GraphWiki_ClassificationGraph = Class(name="GraphWiki_ClassificationGraph")
GraphWiki_Node = Class(name="GraphWiki_Node")
GraphWiki_Edge = Class(name="GraphWiki_Edge")
GraphWiki_Revision = Class(name="GraphWiki_Revision")
GraphWiki_Graph = Class(name="GraphWiki_Graph")
...
GraphWiki_Node.attributes={GraphWiki_Node_title, GraphWiki_Node_node_id, GraphWiki_Node_editions, GraphWiki_Node_node_namespace, GraphWiki_Node_visits, GraphWiki_Node_type}
...
GraphWiki_Revision.attributes={GraphWiki_Revision_date, GraphWiki_Revision_user, GraphWiki_Revision_text_id}
...
domain_model = DomainModel(
    ...
    associations={graphIndex0, graphCategories1, graphArticles3, graphClassification5, nodes7, edges9, revisions11, nodes13, edges15, lastRevision18, revisions21, from_22, to25, node28},
    generalizations={gen_GraphWiki_ClassificationGraph_Graph, gen_GraphWiki_IndexGraph_Graph, gen_GraphWiki_CategoryGraph_Graph, gen_GraphWiki_ArticleGraph_Graph},
    metadata=None
)
