...
class classes_Class:
    ...
    def __init__(self, name: str, Class: "classes_ClassDiagram" = None, Class9: "classes_Reference" = None, classes_Class11: "classes_Reference" = None, cls: set["classes_Attribute"] = None, cls3: set["classes_Reference"] = None, classes: "classes_ClassDiagram" = None, classes_Class: "classes_Attribute" = None, Class7: "classes_Attribute" = None):
        self.name = name
        self.Class = Class
        self.Class9 = Class9
