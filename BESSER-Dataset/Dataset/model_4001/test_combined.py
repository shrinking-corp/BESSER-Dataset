...
def test_hyp_classes_reference_is_not_abstract():
    assert not inspect.isabstract(classes_Reference)


def test_hyp_classes_reference_constructor_exists():
    assert callable(classes_Reference.__init__)


def test_hyp_classes_reference_constructor_args():
...
def test_hyp_classes_classdiagram_is_not_abstract():
    assert not inspect.isabstract(classes_ClassDiagram)


def test_hyp_classes_classdiagram_constructor_exists():
    assert callable(classes_ClassDiagram.__init__)


def test_hyp_classes_classdiagram_constructor_args():
...
def test_hyp_classes_reference_name_setter(instance):
...
def test_hyp_classes_attribute_type_setter(instance):
...
def test_hyp_classes_classdiagram_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
