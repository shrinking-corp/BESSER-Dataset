...
# Classes
classes_ClassDiagram = Class(name="classes_ClassDiagram")
classes_Class = Class(name="classes_Class")
classes_Attribute = Class(name="classes_Attribute")
classes_Reference = Class(name="classes_Reference")
...
domain_model = DomainModel(
    ...
    associations={classes0, cls8, target10, attributes1, references2, diagram4, _primary_key5, cls6},
    generalizations={},
    metadata=None
)
