...
domain_model = DomainModel(
    name="_8b9ac5ae_182d_47ec_8533_49e42d50bcdb",
    types={Home_Security, Camera_sensor, Event_Log, Light_Sensor, Lock_doors_sensors, Server, Temperature_sensor},
    associations={Home_Security_Light_Sensor, Home_Security_Doors, Home_Security_Temperature_sensor, Home_Security_Server, Home_Security_Camera, Home_Security_Event_Log},
    generalizations={},
    metadata=None
)
