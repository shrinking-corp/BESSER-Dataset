...
# Classes
graph_GShapeElement = Class(name="graph_GShapeElement", is_abstract=True)
GModelElement = Class(name="GModelElement")
GBoundsAware = Class(name="GBoundsAware")
graph_GGraph = Class(name="graph_GGraph")
GModelRoot = Class(name="GModelRoot")
graph_GLayoutOptions = Class(name="graph_GLayoutOptions")
graph_GModelRoot = Class(name="graph_GModelRoot")
graph_GBounds = Class(name="graph_GBounds")
graph_GNode = Class(name="graph_GNode")
GShapeElement = Class(name="GShapeElement")
graph_GModelElement = Class(name="graph_GModelElement", is_abstract=True)
GEdgeLayoutable = Class(name="GEdgeLayoutable")
GLayouting = Class(name="GLayouting")
graph_GEdge = Class(name="graph_GEdge")
graph_GPoint = Class(name="graph_GPoint")
graph_GCompartment = Class(name="graph_GCompartment")
graph_GLabel = Class(name="graph_GLabel")
GAlignable = Class(name="GAlignable")
graph_GIssueMarker = Class(name="graph_GIssueMarker")
graph_GIssue = Class(name="graph_GIssue")
graph_GPort = Class(name="graph_GPort")
graph_GButton = Class(name="graph_GButton")
graph_GBoundsAware = Class(name="graph_GBoundsAware", is_abstract=True)
graph_GDimension = Class(name="graph_GDimension")
graph_GHtmlRoot = Class(name="graph_GHtmlRoot")
graph_GPreRenderedElement = Class(name="graph_GPreRenderedElement")
graph_GEdgeLayoutable = Class(name="graph_GEdgeLayoutable", is_abstract=True)
graph_GEdgePlacement = Class(name="graph_GEdgePlacement")
graph_GLayouting = Class(name="graph_GLayouting", is_abstract=True)
graph_GAlignable = Class(name="graph_GAlignable")
...
graph_GLayoutOptions.attributes={graph_GLayoutOptions_paddingBottom, graph_GLayoutOptions_paddingFactor, graph_GLayoutOptions_minHeight, graph_GLayoutOptions_paddingTop, graph_GLayoutOptions_resizeContainer, graph_GLayoutOptions_paddingRight, graph_GLayoutOptions_paddingLeft, graph_GLayoutOptions_vGap, graph_GLayoutOptions_hGap, graph_GLayoutOptions_hAlign, graph_GLayoutOptions_vAlign, graph_GLayoutOptions_minWidth}
...
graph_GBounds.attributes={graph_GBounds_x, graph_GBounds_y, graph_GBounds_width, graph_GBounds_height}
...
graph_GModelElement.attributes={graph_GModelElement_type, graph_GModelElement_id, graph_GModelElement_cssClasses, graph_GModelElement_trace}
...
graph_GEdge.attributes={graph_GEdge_targetId, graph_GEdge_sourceId, graph_GEdge_routerKind}
...
graph_GDimension.attributes={graph_GDimension_width, graph_GDimension_height}
...
graph_GEdgePlacement.attributes={graph_GEdgePlacement_position, graph_GEdgePlacement_offset, graph_GEdgePlacement_side, graph_GEdgePlacement_rotate}
...
domain_model = DomainModel(
    name="graph",
    types={graph_GShapeElement, GModelElement, GBoundsAware, graph_GGraph, GModelRoot, graph_GLayoutOptions, graph_GModelRoot, graph_GBounds, graph_GNode, GShapeElement, graph_GModelElement, GEdgeLayoutable, GLayouting, graph_GEdge, graph_GPoint, graph_GCompartment, graph_GLabel, GAlignable, graph_GIssueMarker, graph_GIssue, graph_GPort, graph_GButton, graph_GBoundsAware, graph_GDimension, graph_GHtmlRoot, graph_GPreRenderedElement, graph_GEdgeLayoutable, graph_GEdgePlacement, graph_GLayouting, graph_GAlignable, GSeverity},
    associations={layoutOptions5, canvasBounds6, children1, parent3, size16, routingPoints7, source8, target10, issues13, position14, edgePlacement18, layoutOptions19, alignment21},
    generalizations={gen_graph_GShapeElement_GModelElement, gen_graph_GShapeElement_GBoundsAware, gen_graph_GGraph_GModelRoot, gen_graph_GGraph_GBoundsAware, gen_graph_GModelRoot_GModelElement, gen_graph_GNode_GShapeElement, gen_graph_GNode_GEdgeLayoutable, gen_graph_GNode_GLayouting, gen_graph_GEdge_GModelElement, gen_graph_GCompartment_GShapeElement, gen_graph_GCompartment_GLayouting, gen_graph_GLabel_GAlignable, gen_graph_GLabel_GEdgeLayoutable, gen_graph_GLabel_GShapeElement, gen_graph_GIssueMarker_GShapeElement, gen_graph_GPort_GShapeElement, gen_graph_GButton_GShapeElement, gen_graph_GHtmlRoot_GModelRoot, gen_graph_GPreRenderedElement_GModelElement},
    metadata=None
)
