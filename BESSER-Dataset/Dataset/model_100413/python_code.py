...
class smachDSL_ActionState:
    ...
    def __init__(self, name: str, smachDSL_ActionState8: "smachDSL_ActionClient" = None, smachDSL_ActionState11: set["smachDSL_Transition"] = None, smachDSL_ActionState: "smachDSL_StateMachine" = None, smachDSL_ActionState14: "smachDSL_Transition" = None):
        self.name = name
...
class smachDSL_StateMachine:
    ...
    def __init__(self, name: str, smachDSL_StateMachine2: set["smachDSL_ActionClient"] = None, smachDSL_StateMachine: "smachDSL_PrimitivePackage" = None, smachDSL_StateMachine4: set["smachDSL_ServiceClient"] = None, smachDSL_StateMachine6: set["smachDSL_ActionState"] = None):
        self.name = name
