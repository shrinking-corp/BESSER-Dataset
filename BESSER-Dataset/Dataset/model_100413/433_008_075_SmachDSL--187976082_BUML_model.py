...
# Classes
smachDSL_ActionClient = Class(name="smachDSL_ActionClient")
smachDSL_PrimitivePackage = Class(name="smachDSL_PrimitivePackage")
smachDSL_StateMachine = Class(name="smachDSL_StateMachine")
smachDSL_Test = Class(name="smachDSL_Test")
smachDSL_Transition = Class(name="smachDSL_Transition")
smachDSL_ServiceClient = Class(name="smachDSL_ServiceClient")
smachDSL_ActionState = Class(name="smachDSL_ActionState")
...
smachDSL_ActionClient.attributes={smachDSL_ActionClient_actionname, smachDSL_ActionClient_actiontype, smachDSL_ActionClient_name}
...
smachDSL_ServiceClient.attributes={smachDSL_ServiceClient_name, smachDSL_ServiceClient_servicesrv, smachDSL_ServiceClient_servicename}
...
domain_model = DomainModel(
    name="smachDSL",
    types={smachDSL_ActionClient, smachDSL_PrimitivePackage, smachDSL_StateMachine, smachDSL_Test, smachDSL_Transition, smachDSL_ServiceClient, smachDSL_ActionState},
    associations={actionclients1, statemachines0, clientname7, transitions10, serviceclients3, actionsstates5, state12},
    generalizations={},
    metadata=None
)
