...
# Classes
simpletest_A = Class(name="simpletest_A")
N = Class(name="N")
simpletest_L = Class(name="simpletest_L")
simpletest_N = Class(name="simpletest_N", is_abstract=True)
simpletest_X = Class(name="simpletest_X")
simpletest_B = Class(name="simpletest_B")
...
as_3: BinaryAssociation = BinaryAssociation(
    name="as_3",
    ends={
...
domain_model = DomainModel(
    name="simpletest",
    types={simpletest_A, N, simpletest_L, simpletest_N, simpletest_X, simpletest_B},
    associations={ls1, as_3, a5, b8, bs0},
    generalizations={gen_simpletest_A_N, gen_simpletest_B_N, gen_simpletest_L_N},
    metadata=None
)
