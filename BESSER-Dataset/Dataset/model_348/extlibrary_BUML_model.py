...
extlibrary_Connection = Class(name="extlibrary_Connection")
...
domain_model = DomainModel(
    name="extlibrary",
    types={extlibrary_Writer, extlibrary_Library, Addressable, extlibrary_Employee, extlibrary_Book, CirculatingItem, extlibrary_CirculatingItem, Item, Lendable, extlibrary_Periodical, extlibrary_AudioVisualItem, extlibrary_BookOnTape, AudioVisualItem, extlibrary_Person, extlibrary_VideoCassette, extlibrary_Borrower, extlibrary_Item, extlibrary_Connection, Person, extlibrary_Lendable, extlibrary_Addressable, BookCategory},
    associations={author0, writers1, employees2, borrowers18, reader19, author20, borrowers4, stock6, books8, branches11, parentBranch13, con15, books17, cast23, borrowed25, manager27, tar29, src32},
    generalizations={gen_extlibrary_Library_Addressable, gen_extlibrary_Book_CirculatingItem, gen_extlibrary_CirculatingItem_Item, gen_extlibrary_CirculatingItem_Lendable, gen_extlibrary_Periodical_Item, gen_extlibrary_AudioVisualItem_CirculatingItem, gen_extlibrary_BookOnTape_AudioVisualItem, gen_extlibrary_VideoCassette_AudioVisualItem, gen_extlibrary_Writer_Person, gen_extlibrary_Borrower_Person, gen_extlibrary_Person_Addressable, gen_extlibrary_Employee_Person},
    metadata=None
)
