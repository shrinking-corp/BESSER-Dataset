...
class Logo_Expression:
    ...
    def __init__(self, Logo_Expression: "Logo_Back" = None, Logo_Expression3: "Logo_Forward" = None, Logo_Expression5: "Logo_Left" = None, Logo_Expression7: "Logo_Right" = None):
