...
Logo_Expression_m_eval: Method = Method(name="eval", parameters={Parameter(name='Logo_context', type=StringType)})
...
domain_model = DomainModel(
    name="Logo",
    types={Logo_LogoProgram, Logo_Primitive, Logo_Back, Primitive, Logo_Expression, Logo_Forward, Logo_Left, Logo_Right, Logo_PenDown, Logo_PenUp, Logo_Clear},
    associations={primitives0, steps1, steps2, angle4, angle6},
    generalizations={gen_Logo_Back_Primitive, gen_Logo_Forward_Primitive, gen_Logo_Left_Primitive, gen_Logo_Right_Primitive, gen_Logo_PenDown_Primitive, gen_Logo_PenUp_Primitive, gen_Logo_Clear_Primitive},
    metadata=None
)
