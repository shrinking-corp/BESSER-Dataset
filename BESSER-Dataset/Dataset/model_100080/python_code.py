...
class builds_BuildPlan(BuildElement):
    ...
    def __init__(self, info: str, selected: bool, summary: str, state: str, status: str, description: str, flags: str, health: int, id: str, builds_BuildPlan: "builds_Build" = None, builds_BuildPlan27: "builds_Build" = None, containingBuildPlan: set["builds_ParameterDefinition"] = None, builds_BuildPlan31: set["builds_HealthReport"] = None, builds_BuildPlan19: "builds_BuildServer" = None, BuildPlan: "builds_BuildPlan" = None, parent: set["builds_BuildPlan"] = None, BuildPlan25: "builds_BuildPlan" = None, children: "builds_BuildPlan" = None, BuildPlan48: "builds_ParameterDefinition" = None, builds_BuildPlan36: "builds_BuildModel" = None, builds_BuildPlan50: "builds_BuildParameterDefinition" = None):
        self.info = info
...
class builds_TestResult:
    ...
    def __init__(self, duration: str, failCount: int, passCount: int, ignoredCount: int, errorCount: int, TestResult: "builds_Build" = None, result: set["builds_TestSuite"] = None, testResult: "builds_Build" = None, TestResult55: "builds_TestSuite" = None):
        self.duration = duration
