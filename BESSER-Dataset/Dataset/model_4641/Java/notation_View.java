...
public class notation_View extends EModelElement {
    ...
    public notation_View(
        boolean visible,        String type,        boolean mutable        ArrayList<notation_Node> notation_nodes,        ArrayList<notation_Edge> notation_edges,        ArrayList<notation_Node> notation_nodes,        ArrayList<notation_Edge> notation_edges    ) {
        this.visible = visible;
        this.type = type;
        this.mutable = mutable;
