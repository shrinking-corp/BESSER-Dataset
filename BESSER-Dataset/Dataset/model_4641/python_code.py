...
class notation_PageStyle(Style):
    ...
    def __init__(self, pageHeight: int, pageX: int, pageY: int, pageWidth: int):
...
class notation_Edge(View):
    ...
    def __init__(self, sourceEdges: "notation_View" = None, targetEdges: "notation_View" = None, Edge: "notation_View" = None, notation_Edge28: "notation_Diagram" = None, notation_Edge31: "notation_Diagram" = None, notation_Edge: "notation_Bendpoints" = None, notation_Edge5: "notation_Anchor" = None, notation_Edge7: "notation_Anchor" = None, Edge13: "notation_View" = None):
