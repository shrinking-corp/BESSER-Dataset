...
# Classes
notation_Edge = Class(name="notation_Edge")
View = Class(name="View")
notation_View = Class(name="notation_View", is_abstract=True)
notation_FillStyle = Class(name="notation_FillStyle")
Style = Class(name="Style")
notation_LineStyle = Class(name="notation_LineStyle")
notation_FontStyle = Class(name="notation_FontStyle")
notation_TitleStyle = Class(name="notation_TitleStyle")
notation_SortingStyle = Class(name="notation_SortingStyle")
notation_Bendpoints = Class(name="notation_Bendpoints", is_abstract=True)
notation_Anchor = Class(name="notation_Anchor", is_abstract=True)
notation_Node = Class(name="notation_Node")
notation_LayoutConstraint = Class(name="notation_LayoutConstraint", is_abstract=True)
notation_Style = Class(name="notation_Style", is_abstract=True)
notation_IdentityAnchor = Class(name="notation_IdentityAnchor")
Anchor = Class(name="Anchor")
notation_RoutingStyle = Class(name="notation_RoutingStyle")
RoundedCornersStyle = Class(name="RoundedCornersStyle")
notation_EObject = Class(name="notation_EObject")
notation_DescriptionStyle = Class(name="notation_DescriptionStyle")
notation_Size = Class(name="notation_Size")
LayoutConstraint = Class(name="LayoutConstraint")
notation_Location = Class(name="notation_Location")
notation_Bounds = Class(name="notation_Bounds")
Location = Class(name="Location")
Size = Class(name="Size")
notation_Ratio = Class(name="notation_Ratio")
notation_Diagram = Class(name="notation_Diagram")
notation_RelativeBendpoints = Class(name="notation_RelativeBendpoints")
Bendpoints = Class(name="Bendpoints")
EModelElement = Class(name="EModelElement")
notation_DrawerStyle = Class(name="notation_DrawerStyle")
notation_PropertiesSetStyle = Class(name="notation_PropertiesSetStyle")
NamedStyle = Class(name="NamedStyle")
notation_GuideStyle = Class(name="notation_GuideStyle")
notation_Guide = Class(name="notation_Guide")
notation_Image = Class(name="notation_Image")
notation_CanonicalStyle = Class(name="notation_CanonicalStyle")
notation_ShapeStyle = Class(name="notation_ShapeStyle")
FontStyle = Class(name="FontStyle")
DescriptionStyle = Class(name="DescriptionStyle")
FillStyle = Class(name="FillStyle")
notation_NodeEntry = Class(name="notation_NodeEntry")
LineStyle = Class(name="LineStyle")
notation_ConnectorStyle = Class(name="notation_ConnectorStyle")
RoutingStyle = Class(name="RoutingStyle")
notation_PageStyle = Class(name="notation_PageStyle")
notation_FilteringStyle = Class(name="notation_FilteringStyle")
notation_DiagramStyle = Class(name="notation_DiagramStyle")
PageStyle = Class(name="PageStyle")
GuideStyle = Class(name="GuideStyle")
notation_ImageStyle = Class(name="notation_ImageStyle")
notation_ImageBufferStyle = Class(name="notation_ImageBufferStyle")
ImageStyle = Class(name="ImageStyle")
notation_ListValueStyle = Class(name="notation_ListValueStyle")
notation_NamedStyle = Class(name="notation_NamedStyle")
notation_StringObjectConverter = Class(name="notation_StringObjectConverter", is_abstract=True)
notation_StringToPropertyValueMapEntry = Class(name="notation_StringToPropertyValueMapEntry")
notation_PropertyValue = Class(name="notation_PropertyValue")
StringObjectConverter = Class(name="StringObjectConverter")
notation_EDataType = Class(name="notation_EDataType")
notation_SingleValueStyle = Class(name="notation_SingleValueStyle")
DataTypeStyle = Class(name="DataTypeStyle")
notation_HintedDiagramLinkStyle = Class(name="notation_HintedDiagramLinkStyle")
DiagramLinkStyle = Class(name="DiagramLinkStyle")
notation_DiagramLinkStyle = Class(name="notation_DiagramLinkStyle")
notation_MultiDiagramLinkStyle = Class(name="notation_MultiDiagramLinkStyle")
notation_DataTypeStyle = Class(name="notation_DataTypeStyle")
notation_IntValueStyle = Class(name="notation_IntValueStyle")
notation_IntListValueStyle = Class(name="notation_IntListValueStyle")
notation_BooleanValueStyle = Class(name="notation_BooleanValueStyle")
notation_DoubleValueStyle = Class(name="notation_DoubleValueStyle")
notation_DoubleListValueStyle = Class(name="notation_DoubleListValueStyle")
notation_StringValueStyle = Class(name="notation_StringValueStyle")
notation_StringListValueStyle = Class(name="notation_StringListValueStyle")
notation_EObjectValueStyle = Class(name="notation_EObjectValueStyle")
notation_EObjectListValueStyle = Class(name="notation_EObjectListValueStyle")
notation_ByteArrayValueStyle = Class(name="notation_ByteArrayValueStyle")
notation_BooleanListValueStyle = Class(name="notation_BooleanListValueStyle")
notation_BasicCompartment = Class(name="notation_BasicCompartment")
DecorationNode = Class(name="DecorationNode")
DrawerStyle = Class(name="DrawerStyle")
notation_BasicSemanticCompartment = Class(name="notation_BasicSemanticCompartment")
notation_SemanticListCompartment = Class(name="notation_SemanticListCompartment")
BasicSemanticCompartment = Class(name="BasicSemanticCompartment")
notation_TextStyle = Class(name="notation_TextStyle")
notation_LineTypeStyle = Class(name="notation_LineTypeStyle")
notation_ArrowStyle = Class(name="notation_ArrowStyle")
notation_Shape = Class(name="notation_Shape")
Node = Class(name="Node")
ShapeStyle = Class(name="ShapeStyle")
notation_Compartment = Class(name="notation_Compartment")
BasicCompartment = Class(name="BasicCompartment")
CanonicalStyle = Class(name="CanonicalStyle")
TitleStyle = Class(name="TitleStyle")
notation_ListCompartment = Class(name="notation_ListCompartment")
SortingStyle = Class(name="SortingStyle")
FilteringStyle = Class(name="FilteringStyle")
notation_Connector = Class(name="notation_Connector")
Edge = Class(name="Edge")
ConnectorStyle = Class(name="ConnectorStyle")
notation_StandardDiagram = Class(name="notation_StandardDiagram")
Diagram = Class(name="Diagram")
DiagramStyle = Class(name="DiagramStyle")
notation_DecorationNode = Class(name="notation_DecorationNode")
BasicDecorationNode = Class(name="BasicDecorationNode")
notation_BasicDecorationNode = Class(name="notation_BasicDecorationNode")
notation_RoundedCornersStyle = Class(name="notation_RoundedCornersStyle")

# notation_Edge class attributes and methods
notation_Edge_m_createBendpoints: Method = Method(name="createBendpoints", parameters={Parameter(name='notation_eClass', type=StringType)}, type=StringType)
notation_Edge_m_createSourceAnchor: Method = Method(name="createSourceAnchor", parameters={Parameter(name='notation_eClass', type=StringType)}, type=StringType)
notation_Edge_m_createTargetAnchor: Method = Method(name="createTargetAnchor", parameters={Parameter(name='notation_eClass', type=StringType)}, type=StringType)
notation_Edge.methods={notation_Edge_m_createSourceAnchor, notation_Edge_m_createBendpoints, notation_Edge_m_createTargetAnchor}
...
notation_View_m_getStyle: Method = Method(name="getStyle", parameters={Parameter(name='notation_eClass', type=StringType)}, type=Style)
notation_View_m_createChild: Method = Method(name="createChild", parameters={Parameter(name='notation_eClass', type=StringType)}, type=StringType)
notation_View_m_createStyle: Method = Method(name="createStyle", parameters={Parameter(name='notation_eClass', type=StringType)}, type=Style)
notation_View_m_getNamedStyle: Method = Method(name="getNamedStyle", parameters={Parameter(name='notation_eClass', type=StringType), Parameter(name='notation_name', type=StringType)}, type=StringType)
...
notation_FillStyle.attributes={notation_FillStyle_transparency, notation_FillStyle_fillColor, notation_FillStyle_gradient}
...
notation_FontStyle.attributes={notation_FontStyle_italic, notation_FontStyle_strikeThrough, notation_FontStyle_fontName, notation_FontStyle_bold, notation_FontStyle_underline, notation_FontStyle_fontColor, notation_FontStyle_fontHeight}
...
notation_Node_m_createLayoutConstraint: Method = Method(name="createLayoutConstraint", parameters={Parameter(name='notation_eClass', type=StringType)}, type=StringType)
...
notation_RoutingStyle.attributes={notation_RoutingStyle_jumpLinkStatus, notation_RoutingStyle_routing, notation_RoutingStyle_jumpLinksReverse, notation_RoutingStyle_avoidObstructions, notation_RoutingStyle_closestDistance, notation_RoutingStyle_jumpLinkType, notation_RoutingStyle_smoothness}
...
notation_Diagram_m_createEdge: Method = Method(name="createEdge", parameters={Parameter(name='notation_eClass', type=StringType)}, type=StringType)
...
notation_PropertiesSetStyle_m_getProperty: Method = Method(name="getProperty", parameters={Parameter(name='notation_propertyName', type=StringType)}, type=StringType)
notation_PropertiesSetStyle_m_setProperty: Method = Method(name="setProperty", parameters={Parameter(name='notation_newValue', type=StringType), Parameter(name='notation_propertyName', type=StringType)}, type=BooleanType)
notation_PropertiesSetStyle_m_createProperty: Method = Method(name="createProperty", parameters={Parameter(name='notation_initialValue', type=StringType), Parameter(name='notation_instanceType', type=StringType), Parameter(name='notation_propertyName', type=StringType)}, type=BooleanType)
notation_PropertiesSetStyle_m_removeProperty: Method = Method(name="removeProperty", parameters={Parameter(name='notation_propertyName', type=StringType)}, type=BooleanType)
notation_PropertiesSetStyle_m_hasProperty: Method = Method(name="hasProperty", parameters={Parameter(name='notation_propertyName', type=StringType)}, type=BooleanType)
notation_PropertiesSetStyle_m_createProperty: Method = Method(name="createProperty", parameters={Parameter(name='notation_initialValue', type=StringType), Parameter(name='notation_propertyName', type=StringType)}, type=BooleanType)
notation_PropertiesSetStyle.methods={notation_PropertiesSetStyle_m_setProperty, notation_PropertiesSetStyle_m_createProperty, notation_PropertiesSetStyle_m_createProperty, notation_PropertiesSetStyle_m_getProperty, notation_PropertiesSetStyle_m_removeProperty, notation_PropertiesSetStyle_m_hasProperty}
...
notation_PageStyle.attributes={notation_PageStyle_pageY, notation_PageStyle_pageWidth, notation_PageStyle_pageHeight, notation_PageStyle_pageX}
...
notation_StringObjectConverter_m_getStringFromObject: Method = Method(name="getStringFromObject", parameters={Parameter(name='notation_objectValue', type=StringType)}, type=StringType)
notation_StringObjectConverter_m_getObjectFromString: Method = Method(name="getObjectFromString", parameters={Parameter(name='notation_stringValue', type=StringType)}, type=StringType)
...
notation_PropertyValue_m_setValue: Method = Method(name="setValue", parameters={Parameter(name='notation_newValue', type=StringType)})
...
notation_SingleValueStyle_m_setValue: Method = Method(name="setValue", parameters={Parameter(name='notation_newValue', type=StringType)})
...
domain_model = DomainModel(
    name="notation",
    types={notation_Edge, View, notation_View, notation_FillStyle, Style, notation_LineStyle, notation_FontStyle, notation_TitleStyle, notation_SortingStyle, notation_Bendpoints, notation_Anchor, notation_Node, notation_LayoutConstraint, notation_Style, notation_IdentityAnchor, Anchor, notation_RoutingStyle, RoundedCornersStyle, notation_EObject, notation_DescriptionStyle, notation_Size, LayoutConstraint, notation_Location, notation_Bounds, Location, Size, notation_Ratio, notation_Diagram, notation_RelativeBendpoints, Bendpoints, EModelElement, notation_DrawerStyle, notation_PropertiesSetStyle, NamedStyle, notation_GuideStyle, notation_Guide, notation_Image, notation_CanonicalStyle, notation_ShapeStyle, FontStyle, DescriptionStyle, FillStyle, notation_NodeEntry, LineStyle, notation_ConnectorStyle, RoutingStyle, notation_PageStyle, notation_FilteringStyle, notation_DiagramStyle, PageStyle, GuideStyle, notation_ImageStyle, notation_ImageBufferStyle, ImageStyle, notation_ListValueStyle, notation_NamedStyle, notation_StringObjectConverter, notation_StringToPropertyValueMapEntry, notation_PropertyValue, StringObjectConverter, notation_EDataType, notation_SingleValueStyle, DataTypeStyle, notation_HintedDiagramLinkStyle, DiagramLinkStyle, notation_DiagramLinkStyle, notation_MultiDiagramLinkStyle, notation_DataTypeStyle, notation_IntValueStyle, notation_IntListValueStyle, notation_BooleanValueStyle, notation_DoubleValueStyle, notation_DoubleListValueStyle, notation_StringValueStyle, notation_StringListValueStyle, notation_EObjectValueStyle, notation_EObjectListValueStyle, notation_ByteArrayValueStyle, notation_BooleanListValueStyle, notation_BasicCompartment, DecorationNode, DrawerStyle, notation_BasicSemanticCompartment, notation_SemanticListCompartment, BasicSemanticCompartment, notation_TextStyle, notation_LineTypeStyle, notation_ArrowStyle, notation_Shape, Node, ShapeStyle, notation_Compartment, BasicCompartment, CanonicalStyle, TitleStyle, notation_ListCompartment, SortingStyle, FilteringStyle, notation_Connector, Edge, ConnectorStyle, notation_StandardDiagram, Diagram, DiagramStyle, notation_DecorationNode, BasicDecorationNode, notation_BasicDecorationNode, notation_RoundedCornersStyle, Filtering, Routing, Smoothness, JumpLinkStatus, JumpLinkType, Sorting, Alignment, SortingDirection, MeasurementUnit, GradientStyle, TextAlignment, LineType, ArrowType},
    associations={source0, target1, bendpoints3, sourceAnchor4, targetAnchor6, layoutConstraint9, sortedObjects10, targetEdges12, persistedChildren14, styles16, element18, diagram21, transientChildren23, sourceEdges11, persistedEdges26, TransientEdges29, horizontalGuides32, verticalGuides33, nodeMap36, key38, filteredObjects41, cropBound43, imageBuffer44, propertiesMap45, value46, instanceType48, diagramLink56, instanceType50, eObjectValue52, eObjectListValue54, diagramLinks58},
    generalizations={gen_notation_Edge_View, gen_notation_FillStyle_Style, gen_notation_LineStyle_Style, gen_notation_FontStyle_Style, gen_notation_TitleStyle_Style, gen_notation_SortingStyle_Style, gen_notation_Node_View, gen_notation_IdentityAnchor_Anchor, gen_notation_RoutingStyle_RoundedCornersStyle, gen_notation_DescriptionStyle_Style, gen_notation_Size_LayoutConstraint, gen_notation_Location_LayoutConstraint, gen_notation_Bounds_Location, gen_notation_Bounds_Size, gen_notation_Ratio_LayoutConstraint, gen_notation_RelativeBendpoints_Bendpoints, gen_notation_Diagram_View, gen_notation_View_EModelElement, gen_notation_DrawerStyle_Style, gen_notation_GuideStyle_Style, gen_notation_CanonicalStyle_Style, gen_notation_ShapeStyle_FontStyle, gen_notation_ShapeStyle_DescriptionStyle, gen_notation_ShapeStyle_FillStyle, gen_notation_ShapeStyle_LineStyle, gen_notation_ShapeStyle_RoundedCornersStyle, gen_notation_ConnectorStyle_RoutingStyle, gen_notation_ConnectorStyle_LineStyle, gen_notation_PageStyle_Style, gen_notation_FilteringStyle_Style, gen_notation_DiagramStyle_PageStyle, gen_notation_DiagramStyle_GuideStyle, gen_notation_DiagramStyle_DescriptionStyle, gen_notation_ImageStyle_Style, gen_notation_ImageBufferStyle_ImageStyle, gen_notation_ListValueStyle_DataTypeStyle, gen_notation_PropertiesSetStyle_NamedStyle, gen_notation_NamedStyle_Style, gen_notation_PropertyValue_StringObjectConverter, gen_notation_SingleValueStyle_DataTypeStyle, gen_notation_HintedDiagramLinkStyle_DiagramLinkStyle, gen_notation_HintedDiagramLinkStyle_Style, gen_notation_DiagramLinkStyle_Style, gen_notation_MultiDiagramLinkStyle_Style, gen_notation_DataTypeStyle_NamedStyle, gen_notation_DataTypeStyle_StringObjectConverter, gen_notation_IntValueStyle_NamedStyle, gen_notation_IntListValueStyle_NamedStyle, gen_notation_BooleanValueStyle_NamedStyle, gen_notation_DoubleValueStyle_NamedStyle, gen_notation_DoubleListValueStyle_NamedStyle, gen_notation_StringValueStyle_NamedStyle, gen_notation_StringListValueStyle_NamedStyle, gen_notation_EObjectValueStyle_NamedStyle, gen_notation_EObjectListValueStyle_NamedStyle, gen_notation_ByteArrayValueStyle_NamedStyle, gen_notation_BooleanListValueStyle_NamedStyle, gen_notation_BasicCompartment_DecorationNode, gen_notation_BasicCompartment_DrawerStyle, gen_notation_BasicSemanticCompartment_BasicDecorationNode, gen_notation_BasicSemanticCompartment_DrawerStyle, gen_notation_SemanticListCompartment_BasicSemanticCompartment, gen_notation_SemanticListCompartment_SortingStyle, gen_notation_SemanticListCompartment_FilteringStyle, gen_notation_SemanticListCompartment_TitleStyle, gen_notation_TextStyle_Style, gen_notation_LineTypeStyle_Style, gen_notation_ArrowStyle_Style, gen_notation_Shape_Node, gen_notation_Shape_ShapeStyle, gen_notation_Compartment_BasicCompartment, gen_notation_Compartment_CanonicalStyle, gen_notation_Compartment_TitleStyle, gen_notation_ListCompartment_BasicCompartment, gen_notation_ListCompartment_SortingStyle, gen_notation_ListCompartment_FilteringStyle, gen_notation_ListCompartment_TitleStyle, gen_notation_Connector_Edge, gen_notation_Connector_ConnectorStyle, gen_notation_StandardDiagram_Diagram, gen_notation_StandardDiagram_DiagramStyle, gen_notation_DecorationNode_BasicDecorationNode, gen_notation_BasicDecorationNode_Node, gen_notation_RoundedCornersStyle_Style},
    metadata=None
)
