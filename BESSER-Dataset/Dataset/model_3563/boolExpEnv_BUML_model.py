...
# Classes
boolExpEnv_Exp = Class(name="boolExpEnv_Exp", is_abstract=True)
boolExpEnv_Fals = Class(name="boolExpEnv_Fals")
boolExpEnv_Not = Class(name="boolExpEnv_Not")
boolExpEnv_And = Class(name="boolExpEnv_And")
BinExp = Class(name="BinExp")
boolExpEnv_Or = Class(name="boolExpEnv_Or")
boolExpEnv_VarRef = Class(name="boolExpEnv_VarRef")
boolExpEnv_BinExp = Class(name="boolExpEnv_BinExp", is_abstract=True)
Exp = Class(name="Exp")
boolExpEnv_Lit = Class(name="boolExpEnv_Lit", is_abstract=True)
boolExpEnv_Tru = Class(name="boolExpEnv_Tru")
Lit = Class(name="Lit")
...
domain_model = DomainModel(
    name="boolExpEnv",
    types={boolExpEnv_Exp, boolExpEnv_Fals, boolExpEnv_Not, boolExpEnv_And, BinExp, boolExpEnv_Or, boolExpEnv_VarRef, boolExpEnv_BinExp, Exp, boolExpEnv_Lit, boolExpEnv_Tru, Lit},
    associations={exp4, lhs0, rhs1},
    generalizations={gen_boolExpEnv_Fals_Lit, gen_boolExpEnv_Not_Exp, gen_boolExpEnv_And_BinExp, gen_boolExpEnv_Or_BinExp, gen_boolExpEnv_VarRef_Exp, gen_boolExpEnv_BinExp_Exp, gen_boolExpEnv_Lit_Exp, gen_boolExpEnv_Tru_Lit},
    metadata=None
)
