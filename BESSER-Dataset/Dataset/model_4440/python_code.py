...
class roverDSL_Motor:
    ...
    def __init__(self, m: str, roverDSL_Motor: "roverDSL_ForwardAction" = None, roverDSL_Motor47: "roverDSL_RotateAction" = None, roverDSL_Motor52: "roverDSL_StopAction" = None, roverDSL_Motor54: "roverDSL_SAccelerationAction" = None, roverDSL_Motor59: "roverDSL_SSpeedAction" = None, roverDSL_Motor66: "roverDSL_FreeAction" = None):
        self.m = m
...
class roverDSL_Static:
    ...
    def __init__(self, name: str, roverDSL_Static12: "roverDSL_ValueExpression" = None, roverDSL_Static: "roverDSL_Robot" = None):
        self.name = name
...
class roverDSL_BehaviorName:
    ...
    def __init__(self, name: str, roverDSL_BehaviorName16: "roverDSL_Implementation" = None, roverDSL_BehaviorName: "roverDSL_Robot" = None):
        self.name = name
