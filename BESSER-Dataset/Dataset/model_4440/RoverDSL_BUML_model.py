...
# Classes
roverDSL_Robot = Class(name="roverDSL_Robot")
roverDSL_BehaviorName = Class(name="roverDSL_BehaviorName")
roverDSL_Global = Class(name="roverDSL_Global")
roverDSL_Static = Class(name="roverDSL_Static")
roverDSL_ValueExpression = Class(name="roverDSL_ValueExpression")
roverDSL_Implementation = Class(name="roverDSL_Implementation")
roverDSL_SubRoutine = Class(name="roverDSL_SubRoutine")
roverDSL_Expression = Class(name="roverDSL_Expression")
roverDSL_ValExpr = Class(name="roverDSL_ValExpr")
Expression = Class(name="Expression")
roverDSL_IFExpression = Class(name="roverDSL_IFExpression")
roverDSL_WHILEExpression = Class(name="roverDSL_WHILEExpression")
roverDSL_Motor = Class(name="roverDSL_Motor")
roverDSL_AssignExpression = Class(name="roverDSL_AssignExpression")
roverDSL_Action = Class(name="roverDSL_Action")
roverDSL_ForwardAction = Class(name="roverDSL_ForwardAction")
Action = Class(name="Action")
roverDSL_RotateAction = Class(name="roverDSL_RotateAction")
roverDSL_StopAction = Class(name="roverDSL_StopAction")
roverDSL_SAccelerationAction = Class(name="roverDSL_SAccelerationAction")
roverDSL_SSpeedAction = Class(name="roverDSL_SSpeedAction")
roverDSL_SubRoutineAction = Class(name="roverDSL_SubRoutineAction")
roverDSL_SoundAction = Class(name="roverDSL_SoundAction")
roverDSL_FreeAction = Class(name="roverDSL_FreeAction")
roverDSL_BNotExpr = Class(name="roverDSL_BNotExpr")
ValueExpression = Class(name="ValueExpression")
roverDSL_BVLiteral = Class(name="roverDSL_BVLiteral")
roverDSL_BBLiteral = Class(name="roverDSL_BBLiteral")
roverDSL_BVarLiteral = Class(name="roverDSL_BVarLiteral")
roverDSL_BSensorLiteral = Class(name="roverDSL_BSensorLiteral")
roverDSL_BVBracket = Class(name="roverDSL_BVBracket")
roverDSL_ColorLiteral = Class(name="roverDSL_ColorLiteral")
roverDSL_MeasureAction = Class(name="roverDSL_MeasureAction")
roverDSL_ShowAction = Class(name="roverDSL_ShowAction")
roverDSL_ExpressionBinOp = Class(name="roverDSL_ExpressionBinOp")
roverDSL_ExpressionBinComp = Class(name="roverDSL_ExpressionBinComp")
...
roverDSL_BVLiteral.attributes={roverDSL_BVLiteral_neg, roverDSL_BVLiteral_aValue}
...
roverDSL_ShowAction.attributes={roverDSL_ShowAction_sensor, roverDSL_ShowAction_string}
...
for_14: BinaryAssociation = BinaryAssociation(
    name="for_14",
    ends={
...
global_40: BinaryAssociation = BinaryAssociation(
    name="global_40",
    ends={
...
domain_model = DomainModel(
    name="roverDSL",
    types={roverDSL_Robot, roverDSL_BehaviorName, roverDSL_Global, roverDSL_Static, roverDSL_ValueExpression, roverDSL_Implementation, roverDSL_SubRoutine, roverDSL_Expression, roverDSL_ValExpr, Expression, roverDSL_IFExpression, roverDSL_WHILEExpression, roverDSL_Motor, roverDSL_AssignExpression, roverDSL_Action, roverDSL_ForwardAction, Action, roverDSL_RotateAction, roverDSL_StopAction, roverDSL_SAccelerationAction, roverDSL_SSpeedAction, roverDSL_SubRoutineAction, roverDSL_SoundAction, roverDSL_FreeAction, roverDSL_BNotExpr, ValueExpression, roverDSL_BVLiteral, roverDSL_BBLiteral, roverDSL_BVarLiteral, roverDSL_BSensorLiteral, roverDSL_BVBracket, roverDSL_ColorLiteral, roverDSL_MeasureAction, roverDSL_ShowAction, roverDSL_ExpressionBinOp, roverDSL_ExpressionBinComp, Sensor, EMotor, Sound, BBinaryOp, CompareOp, Color},
    associations={behaviorOrder0, globals1, statics3, stopBehaviour5, behaviors7, subRoutines9, value11, for_14, controlCheck17, expressions20, expressions22, vExpr25, c27, t29, e32, global_40, v42, motor45, motor46, degrees48, motor51, motor53, v55, motor58, v60, c35, b37, motor65, sub67, bsub69, routine63, left71, right73, left76, right78},
    generalizations={gen_roverDSL_ValExpr_Expression, gen_roverDSL_IFExpression_Expression, gen_roverDSL_WHILEExpression_Expression, gen_roverDSL_AssignExpression_Expression, gen_roverDSL_Action_Expression, gen_roverDSL_ForwardAction_Action, gen_roverDSL_RotateAction_Action, gen_roverDSL_StopAction_Action, gen_roverDSL_SAccelerationAction_Action, gen_roverDSL_SSpeedAction_Action, gen_roverDSL_SubRoutineAction_Action, gen_roverDSL_SoundAction_Action, gen_roverDSL_FreeAction_Action, gen_roverDSL_BNotExpr_ValueExpression, gen_roverDSL_BVLiteral_ValueExpression, gen_roverDSL_BBLiteral_ValueExpression, gen_roverDSL_BVarLiteral_ValueExpression, gen_roverDSL_BSensorLiteral_ValueExpression, gen_roverDSL_BVBracket_ValueExpression, gen_roverDSL_ColorLiteral_ValueExpression, gen_roverDSL_MeasureAction_Action, gen_roverDSL_ShowAction_Action, gen_roverDSL_ExpressionBinOp_ValueExpression, gen_roverDSL_ExpressionBinComp_ValueExpression},
    metadata=None
)
