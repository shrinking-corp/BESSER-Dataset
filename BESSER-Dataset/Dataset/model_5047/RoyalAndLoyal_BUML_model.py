...
RandL_LoyaltyProgram_m_addTransaction: Method = Method(name="addTransaction", parameters={Parameter(name='RandL_servId', type=StringType), Parameter(name='RandL_amnt', type=StringType), Parameter(name='RandL_accNr', type=StringType), Parameter(name='RandL_pName', type=StringType), Parameter(name='RandL_d', type=StringType)})
...
RandL_LoyaltyProgram.methods={RandL_LoyaltyProgram_m_addService, RandL_LoyaltyProgram_m_getServices, RandL_LoyaltyProgram_m_selectPopularPartners, RandL_LoyaltyProgram_m_getServices, RandL_LoyaltyProgram_m_addTransaction, RandL_LoyaltyProgram_m_enrollAndCreateCustomer, RandL_LoyaltyProgram_m_enroll}
...
RandL_Service.attributes={RandL_Service_serviceNr, RandL_Service_condition, RandL_Service_pointsEarned, RandL_Service_description, RandL_Service_pointsBurned}
...
RandL_Date.methods={RandL_Date_m_isEqual, RandL_Date_m_fromYMD, RandL_Date_m_isBefore, RandL_Date_m_isAfter}
...
RandL_TransactionReport.attributes={RandL_TransactionReport_totalBurned, RandL_TransactionReport_name, RandL_TransactionReport_balance, RandL_TransactionReport_number, RandL_TransactionReport_totalEarned}
...
RandL_TransactionReportLine.attributes={RandL_TransactionReportLine_amount, RandL_TransactionReportLine_partnerName, RandL_TransactionReportLine_points, RandL_TransactionReportLine_serviceDesc}
...
RandL_Customer.attributes={RandL_Customer_gender, RandL_Customer_title, RandL_Customer_name, RandL_Customer_age, RandL_Customer_isMale}
...
domain_model = DomainModel(
    ...
    associations={program0, deliveredServices15, programs17, availableServices1, Membership2, date3, account4, generatedBy5, card8, usedServices10, Membership11, transactions13, until19, from_21, lines24, card25, goodThru27, validFrom30, myLevel33, owner35, Membership36, transactions38, ref_RandL_LoyaltyProgram66, ref_RandL_Earning69, currentLevel41, card43, account46, programs49, participants50, ref_RandL_Customer52, ref_RandL_Date54, ref_RandL_CustomerCard57, ref_RandL_Membership60, ref_RandL_Service63, programs94, cards96, ref_RandL_LoyaltyAccount71, ref_RandL_ServiceLevel74, ref_RandL_TransactionReport77, ref_RandL_ProgramPartner80, ref_RandL_Burning82, ref_RandL_TransactionReportLine84, partner86, transactions87, level89, dateOfBirth91, memberships115, memberships98, date101, transaction104, report107, partners108, levels110, participants112},
