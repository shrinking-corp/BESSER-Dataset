...
public class RandL_Container_RandL  {
    ...
    public RandL_Container_RandL(
        ArrayList<RandL_LoyaltyAccount> randl_loyaltyaccounts,        ArrayList<RandL_LoyaltyProgram> randl_loyaltyprograms,        ArrayList<RandL_Service> randl_services,        ArrayList<RandL_TransactionReportLine> randl_transactionreportlines,        ArrayList<RandL_Date> randl_dates,        ArrayList<RandL_Customer> randl_customers,        ArrayList<RandL_ServiceLevel> randl_servicelevels,        ArrayList<RandL_ProgramPartner> randl_programpartners,        ArrayList<RandL_TransactionReport> randl_transactionreports,        ArrayList<RandL_Earning> randl_earnings,        ArrayList<RandL_Membership> randl_memberships,        ArrayList<RandL_CustomerCard> randl_customercards,        ArrayList<RandL_Burning> randl_burnings    ) {
