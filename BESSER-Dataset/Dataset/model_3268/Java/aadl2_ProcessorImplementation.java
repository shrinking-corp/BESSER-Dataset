...
public class aadl2_ProcessorImplementation extends ProcessorClassifier, ComponentImplementation {
    ...
    public aadl2_ProcessorImplementation(
        ArrayList<aadl2_BusSubcomponent> aadl2_bussubcomponents,        ArrayList<aadl2_VirtualBusSubcomponent> aadl2_virtualbussubcomponents,        ArrayList<aadl2_VirtualProcessorSubcomponent> aadl2_virtualprocessorsubcomponents,        ArrayList<aadl2_MemorySubcomponent> aadl2_memorysubcomponents    ) {
