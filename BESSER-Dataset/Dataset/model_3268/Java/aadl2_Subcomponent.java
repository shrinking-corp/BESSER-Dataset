...
public class aadl2_Subcomponent extends StructuralFeature, Context, FlowElement, ArrayableElement, ModalElement {
    ...
    public aadl2_Subcomponent(
        String allModes        ArrayList<aadl2_ComponentImplementationReference> aadl2_componentimplementationreferences,        ArrayList<aadl2_PrototypeBinding> aadl2_prototypebindings,        ArrayList<aadl2_ModeBinding> aadl2_modebindings    ) {
        this.allModes = allModes;
