...
def test_assoc_actual387_link_reassign_clear():
...
def test_assoc_baseUnit820_link_reassign_clear():
    a = aadl2_UnitLiteral()
    b1 = aadl2_UnitLiteral()
    b2 = aadl2_UnitLiteral()
    _safe_set(a, 'aadl2_UnitLiteral819', b1)
    assert _is_linked(a, 'aadl2_UnitLiteral819', b1)
    if hasattr(b1, 'aadl2_UnitLiteral821'):
        assert _is_linked(b1, 'aadl2_UnitLiteral821', a)
    _safe_set(a, 'aadl2_UnitLiteral819', b2)
    assert _is_linked(a, 'aadl2_UnitLiteral819', b2)
    if hasattr(b1, 'aadl2_UnitLiteral821'):
        assert not _is_linked(b1, 'aadl2_UnitLiteral821', a)
    if hasattr(b2, 'aadl2_UnitLiteral821'):
        assert _is_linked(b2, 'aadl2_UnitLiteral821', a)
    _safe_set(a, 'aadl2_UnitLiteral819', None)
    assert not _is_linked(a, 'aadl2_UnitLiteral819', b2)
    if hasattr(b2, 'aadl2_UnitLiteral821'):
        assert not _is_linked(b2, 'aadl2_UnitLiteral821', a)


def test_assoc_binding388_link_reassign_clear():
    a = aadl2_ComponentPrototypeActual(category="sample_text")
    b1 = aadl2_PrototypeBinding()
    b2 = aadl2_PrototypeBinding()
    _safe_set(a, 'aadl2_ComponentPrototypeActual389', {b1})
    assert _is_linked(a, 'aadl2_ComponentPrototypeActual389', b1)
    if hasattr(b1, 'aadl2_PrototypeBinding390'):
        assert _is_linked(b1, 'aadl2_PrototypeBinding390', a)
    _safe_set(a, 'aadl2_ComponentPrototypeActual389', {b2})
    assert _is_linked(a, 'aadl2_ComponentPrototypeActual389', b2)
    if hasattr(b1, 'aadl2_PrototypeBinding390'):
        assert not _is_linked(b1, 'aadl2_PrototypeBinding390', a)
    if hasattr(b2, 'aadl2_PrototypeBinding390'):
        assert _is_linked(b2, 'aadl2_PrototypeBinding390', a)
    _safe_set(a, 'aadl2_ComponentPrototypeActual389', set())
    assert not _is_linked(a, 'aadl2_ComponentPrototypeActual389', b2)
    if hasattr(b2, 'aadl2_PrototypeBinding390'):
        assert not _is_linked(b2, 'aadl2_PrototypeBinding390', a)
...
def test_assoc_classifier285_link_reassign_clear():
    ...
    _safe_set(a, 'aadl2_Subcomponent286', b1)
    assert _is_linked(a, 'aadl2_Subcomponent286', b1)
    if hasattr(b1, 'aadl2_ComponentClassifier287'):
        assert _is_linked(b1, 'aadl2_ComponentClassifier287', a)
    _safe_set(a, 'aadl2_Subcomponent286', b2)
    assert _is_linked(a, 'aadl2_Subcomponent286', b2)
    if hasattr(b1, 'aadl2_ComponentClassifier287'):
        assert not _is_linked(b1, 'aadl2_ComponentClassifier287', a)
    if hasattr(b2, 'aadl2_ComponentClassifier287'):
        assert _is_linked(b2, 'aadl2_ComponentClassifier287', a)
    _safe_set(a, 'aadl2_Subcomponent286', None)
    assert not _is_linked(a, 'aadl2_Subcomponent286', b2)
    if hasattr(b2, 'aadl2_ComponentClassifier287'):
        assert not _is_linked(b2, 'aadl2_ComponentClassifier287', a)


def test_assoc_classifier402_link_reassign_clear():
    ...
    _safe_set(a, 'aadl2_ComponentClassifier403', b1)
    assert _is_linked(a, 'aadl2_ComponentClassifier403', b1)
    if hasattr(b1, 'aadl2_AccessSpecification'):
        assert _is_linked(b1, 'aadl2_AccessSpecification', a)
    _safe_set(a, 'aadl2_ComponentClassifier403', b2)
    assert _is_linked(a, 'aadl2_ComponentClassifier403', b2)
    if hasattr(b1, 'aadl2_AccessSpecification'):
    ...
    _safe_set(a, 'aadl2_ComponentClassifier403', None)
    assert not _is_linked(a, 'aadl2_ComponentClassifier403', b2)
    if hasattr(b2, 'aadl2_AccessSpecification'):
        assert not _is_linked(b2, 'aadl2_AccessSpecification', a)


def test_assoc_classifier407_link_reassign_clear():
    ...
    if hasattr(b1, 'aadl2_ComponentClassifier408'):
        assert _is_linked(b1, 'aadl2_ComponentClassifier408', a)
    _safe_set(a, 'aadl2_PortSpecification', b2)
    assert _is_linked(a, 'aadl2_PortSpecification', b2)
    if hasattr(b1, 'aadl2_ComponentClassifier408'):
        assert not _is_linked(b1, 'aadl2_ComponentClassifier408', a)
    if hasattr(b2, 'aadl2_ComponentClassifier408'):
        assert _is_linked(b2, 'aadl2_ComponentClassifier408', a)
    _safe_set(a, 'aadl2_PortSpecification', None)
    assert not _is_linked(a, 'aadl2_PortSpecification', b2)
    if hasattr(b2, 'aadl2_ComponentClassifier408'):
        assert not _is_linked(b2, 'aadl2_ComponentClassifier408', a)


def test_assoc_classifier825_link_reassign_clear():
    a = aadl2_Classifier(noAnnexes="sample_text", noProperties="sample_text", noPrototypes="sample_text")
    b1 = aadl2_ClassifierValue()
    b2 = aadl2_ClassifierValue()
    _safe_set(a, 'aadl2_Classifier826', b1)
    assert _is_linked(a, 'aadl2_Classifier826', b1)
    if hasattr(b1, 'aadl2_ClassifierValue'):
        assert _is_linked(b1, 'aadl2_ClassifierValue', a)
    _safe_set(a, 'aadl2_Classifier826', b2)
    assert _is_linked(a, 'aadl2_Classifier826', b2)
    if hasattr(b1, 'aadl2_ClassifierValue'):
    ...
    _safe_set(a, 'aadl2_Classifier826', None)
    assert not _is_linked(a, 'aadl2_Classifier826', b2)
    if hasattr(b2, 'aadl2_ClassifierValue'):
...
def test_assoc_classifierReference877_link_reassign_clear():
    a = aadl2_MetaclassReference(annexName="sample_text", metaclassName="sample_text")
    b1 = aadl2_ClassifierType()
    b2 = aadl2_ClassifierType()
    _safe_set(a, 'aadl2_MetaclassReference878', b1)
    assert _is_linked(a, 'aadl2_MetaclassReference878', b1)
    if hasattr(b1, 'aadl2_ClassifierType'):
        assert _is_linked(b1, 'aadl2_ClassifierType', a)
    _safe_set(a, 'aadl2_MetaclassReference878', b2)
    assert _is_linked(a, 'aadl2_MetaclassReference878', b2)
    if hasattr(b1, 'aadl2_ClassifierType'):
    ...
    _safe_set(a, 'aadl2_MetaclassReference878', None)
    assert not _is_linked(a, 'aadl2_MetaclassReference878', b2)
    if hasattr(b2, 'aadl2_ClassifierType'):
        assert not _is_linked(b2, 'aadl2_ClassifierType', a)


def test_assoc_componentPrototype404_link_reassign_clear():
    a = aadl2_ComponentPrototype(array="sample_text")
    b1 = aadl2_AccessSpecification(category="sample_text", kind="sample_text")
    b2 = aadl2_AccessSpecification(category="sample_text_2", kind="sample_text_2")
    _safe_set(a, 'aadl2_ComponentPrototype406', b1)
    assert _is_linked(a, 'aadl2_ComponentPrototype406', b1)
    if hasattr(b1, 'aadl2_AccessSpecification405'):
        assert _is_linked(b1, 'aadl2_AccessSpecification405', a)
    _safe_set(a, 'aadl2_ComponentPrototype406', b2)
    assert _is_linked(a, 'aadl2_ComponentPrototype406', b2)
    if hasattr(b1, 'aadl2_AccessSpecification405'):
        assert not _is_linked(b1, 'aadl2_AccessSpecification405', a)
    if hasattr(b2, 'aadl2_AccessSpecification405'):
        assert _is_linked(b2, 'aadl2_AccessSpecification405', a)
    _safe_set(a, 'aadl2_ComponentPrototype406', None)
    assert not _is_linked(a, 'aadl2_ComponentPrototype406', b2)
    if hasattr(b2, 'aadl2_AccessSpecification405'):
        assert not _is_linked(b2, 'aadl2_AccessSpecification405', a)


def test_assoc_componentPrototype409_link_reassign_clear():
    a = aadl2_PortSpecification(category="sample_text", direction="sample_text", in_="sample_text", out="sample_text")
    b1 = aadl2_ComponentPrototype(array="sample_text")
    b2 = aadl2_ComponentPrototype(array="sample_text_2")
    _safe_set(a, 'aadl2_PortSpecification410', b1)
    assert _is_linked(a, 'aadl2_PortSpecification410', b1)
    if hasattr(b1, 'aadl2_ComponentPrototype411'):
        assert _is_linked(b1, 'aadl2_ComponentPrototype411', a)
    _safe_set(a, 'aadl2_PortSpecification410', b2)
    assert _is_linked(a, 'aadl2_PortSpecification410', b2)
    if hasattr(b1, 'aadl2_ComponentPrototype411'):
        assert not _is_linked(b1, 'aadl2_ComponentPrototype411', a)
    if hasattr(b2, 'aadl2_ComponentPrototype411'):
        assert _is_linked(b2, 'aadl2_ComponentPrototype411', a)
    _safe_set(a, 'aadl2_PortSpecification410', None)
    assert not _is_linked(a, 'aadl2_PortSpecification410', b2)
    if hasattr(b2, 'aadl2_ComponentPrototype411'):
        assert not _is_linked(b2, 'aadl2_ComponentPrototype411', a)
...
def test_assoc_constrainingClassifier263_link_reassign_clear():
    a = aadl2_FeaturePrototype(direction="sample_text", in_="sample_text", out="sample_text")
    b1 = aadl2_ComponentClassifier(derivedModes="sample_text", noFlows="sample_text", noModes="sample_text")
    b2 = aadl2_ComponentClassifier(derivedModes="sample_text_2", noFlows="sample_text_2", noModes="sample_text_2")
    _safe_set(a, 'aadl2_FeaturePrototype264', b1)
    assert _is_linked(a, 'aadl2_FeaturePrototype264', b1)
    if hasattr(b1, 'aadl2_ComponentClassifier265'):
        assert _is_linked(b1, 'aadl2_ComponentClassifier265', a)
    _safe_set(a, 'aadl2_FeaturePrototype264', b2)
    assert _is_linked(a, 'aadl2_FeaturePrototype264', b2)
    if hasattr(b1, 'aadl2_ComponentClassifier265'):
        assert not _is_linked(b1, 'aadl2_ComponentClassifier265', a)
    if hasattr(b2, 'aadl2_ComponentClassifier265'):
        assert _is_linked(b2, 'aadl2_ComponentClassifier265', a)
    _safe_set(a, 'aadl2_FeaturePrototype264', None)
    assert not _is_linked(a, 'aadl2_FeaturePrototype264', b2)
    if hasattr(b2, 'aadl2_ComponentClassifier265'):
        assert not _is_linked(b2, 'aadl2_ComponentClassifier265', a)
...
def test_assoc_dataClassifier346_link_reassign_clear():
    a = aadl2_PortProxy(direction="sample_text", in_="sample_text", out="sample_text")
    b1 = aadl2_DataClassifier()
    b2 = aadl2_DataClassifier()
    _safe_set(a, 'aadl2_PortProxy347', b1)
    assert _is_linked(a, 'aadl2_PortProxy347', b1)
    if hasattr(b1, 'aadl2_DataClassifier348'):
        assert _is_linked(b1, 'aadl2_DataClassifier348', a)
    _safe_set(a, 'aadl2_PortProxy347', b2)
    assert _is_linked(a, 'aadl2_PortProxy347', b2)
    if hasattr(b1, 'aadl2_DataClassifier348'):
        assert not _is_linked(b1, 'aadl2_DataClassifier348', a)
    if hasattr(b2, 'aadl2_DataClassifier348'):
        assert _is_linked(b2, 'aadl2_DataClassifier348', a)
    _safe_set(a, 'aadl2_PortProxy347', None)
    assert not _is_linked(a, 'aadl2_PortProxy347', b2)
    if hasattr(b2, 'aadl2_DataClassifier348'):
        assert not _is_linked(b2, 'aadl2_DataClassifier348', a)
...
def test_assoc_derivedMode291_link_reassign_clear():
    a = aadl2_Mode(derived="sample_text", initial="sample_text")
    b1 = aadl2_ModeBinding()
    b2 = aadl2_ModeBinding()
    _safe_set(a, 'aadl2_Mode293', b1)
    assert _is_linked(a, 'aadl2_Mode293', b1)
    if hasattr(b1, 'aadl2_ModeBinding292'):
        assert _is_linked(b1, 'aadl2_ModeBinding292', a)
    _safe_set(a, 'aadl2_Mode293', b2)
    assert _is_linked(a, 'aadl2_Mode293', b2)
    if hasattr(b1, 'aadl2_ModeBinding292'):
        assert not _is_linked(b1, 'aadl2_ModeBinding292', a)
    if hasattr(b2, 'aadl2_ModeBinding292'):
        assert _is_linked(b2, 'aadl2_ModeBinding292', a)
    _safe_set(a, 'aadl2_Mode293', None)
    assert not _is_linked(a, 'aadl2_Mode293', b2)
    if hasattr(b2, 'aadl2_ModeBinding292'):
        assert not _is_linked(b2, 'aadl2_ModeBinding292', a)
...
def test_assoc_destination310_link_reassign_clear():
    a = aadl2_Connection(bidirectional="sample_text")
    b1 = aadl2_ConnectedElement()
    b2 = aadl2_ConnectedElement()
    _safe_set(a, 'aadl2_Connection311', b1)
    assert _is_linked(a, 'aadl2_Connection311', b1)
    if hasattr(b1, 'aadl2_ConnectedElement'):
        assert _is_linked(b1, 'aadl2_ConnectedElement', a)
    _safe_set(a, 'aadl2_Connection311', b2)
    assert _is_linked(a, 'aadl2_Connection311', b2)
    if hasattr(b1, 'aadl2_ConnectedElement'):
    ...
    _safe_set(a, 'aadl2_Connection311', None)
    assert not _is_linked(a, 'aadl2_Connection311', b2)
    if hasattr(b2, 'aadl2_ConnectedElement'):
...
def test_assoc_extended326_link_reassign_clear():
    a = aadl2_ComponentImplementation(noCalls="sample_text", noConnections="sample_text", noSubcomponents="sample_text")
    b1 = aadl2_ImplementationExtension()
    b2 = aadl2_ImplementationExtension()
    _safe_set(a, 'aadl2_ComponentImplementation328', b1)
    assert _is_linked(a, 'aadl2_ComponentImplementation328', b1)
    if hasattr(b1, 'aadl2_ImplementationExtension327'):
        assert _is_linked(b1, 'aadl2_ImplementationExtension327', a)
    _safe_set(a, 'aadl2_ComponentImplementation328', b2)
    assert _is_linked(a, 'aadl2_ComponentImplementation328', b2)
    if hasattr(b1, 'aadl2_ImplementationExtension327'):
        assert not _is_linked(b1, 'aadl2_ImplementationExtension327', a)
    if hasattr(b2, 'aadl2_ImplementationExtension327'):
        assert _is_linked(b2, 'aadl2_ImplementationExtension327', a)
    _safe_set(a, 'aadl2_ComponentImplementation328', None)
    assert not _is_linked(a, 'aadl2_ComponentImplementation328', b2)
    if hasattr(b2, 'aadl2_ImplementationExtension327'):
        assert not _is_linked(b2, 'aadl2_ImplementationExtension327', a)


def test_assoc_factor822_link_reassign_clear():
    a = aadl2_UnitLiteral()
    b1 = aadl2_NumberValue()
    b2 = aadl2_NumberValue()
    _safe_set(a, 'aadl2_UnitLiteral823', b1)
    assert _is_linked(a, 'aadl2_UnitLiteral823', b1)
    if hasattr(b1, 'aadl2_NumberValue824'):
        assert _is_linked(b1, 'aadl2_NumberValue824', a)
    _safe_set(a, 'aadl2_UnitLiteral823', b2)
    assert _is_linked(a, 'aadl2_UnitLiteral823', b2)
    if hasattr(b1, 'aadl2_NumberValue824'):
        assert not _is_linked(b1, 'aadl2_NumberValue824', a)
    if hasattr(b2, 'aadl2_NumberValue824'):
        assert _is_linked(b2, 'aadl2_NumberValue824', a)
    _safe_set(a, 'aadl2_UnitLiteral823', None)
    assert not _is_linked(a, 'aadl2_UnitLiteral823', b2)
    if hasattr(b2, 'aadl2_NumberValue824'):
        assert not _is_linked(b2, 'aadl2_NumberValue824', a)
...
def test_assoc_implementationReference279_link_reassign_clear():
    a = aadl2_Subcomponent(allModes="sample_text")
    b1 = aadl2_ComponentImplementationReference()
    b2 = aadl2_ComponentImplementationReference()
    _safe_set(a, 'aadl2_Subcomponent280', {b1})
    assert _is_linked(a, 'aadl2_Subcomponent280', b1)
    if hasattr(b1, 'aadl2_ComponentImplementationReference281'):
        assert _is_linked(b1, 'aadl2_ComponentImplementationReference281', a)
    _safe_set(a, 'aadl2_Subcomponent280', {b2})
    assert _is_linked(a, 'aadl2_Subcomponent280', b2)
    if hasattr(b1, 'aadl2_ComponentImplementationReference281'):
        assert not _is_linked(b1, 'aadl2_ComponentImplementationReference281', a)
    if hasattr(b2, 'aadl2_ComponentImplementationReference281'):
        assert _is_linked(b2, 'aadl2_ComponentImplementationReference281', a)
    _safe_set(a, 'aadl2_Subcomponent280', set())
    assert not _is_linked(a, 'aadl2_Subcomponent280', b2)
    if hasattr(b2, 'aadl2_ComponentImplementationReference281'):
        assert not _is_linked(b2, 'aadl2_ComponentImplementationReference281', a)


def test_assoc_implemented329_link_reassign_clear():
    a = aadl2_ComponentType(noFeatures="sample_text")
    b1 = aadl2_Realization()
    b2 = aadl2_Realization()
    _safe_set(a, 'aadl2_ComponentType331', b1)
    assert _is_linked(a, 'aadl2_ComponentType331', b1)
    if hasattr(b1, 'aadl2_Realization330'):
        assert _is_linked(b1, 'aadl2_Realization330', a)
    _safe_set(a, 'aadl2_ComponentType331', b2)
    assert _is_linked(a, 'aadl2_ComponentType331', b2)
    if hasattr(b1, 'aadl2_Realization330'):
        assert not _is_linked(b1, 'aadl2_Realization330', a)
    if hasattr(b2, 'aadl2_Realization330'):
        assert _is_linked(b2, 'aadl2_Realization330', a)
    _safe_set(a, 'aadl2_ComponentType331', None)
    assert not _is_linked(a, 'aadl2_ComponentType331', b2)
    if hasattr(b2, 'aadl2_Realization330'):
        assert not _is_linked(b2, 'aadl2_Realization330', a)


def test_assoc_importedUnit366_link_reassign_clear():
...
def test_assoc_inEnd299_link_reassign_clear():
    a = aadl2_FlowImplementation(kind="sample_text")
    b1 = aadl2_FlowEnd()
    b2 = aadl2_FlowEnd()
    _safe_set(a, 'aadl2_FlowImplementation300', b1)
    assert _is_linked(a, 'aadl2_FlowImplementation300', b1)
    if hasattr(b1, 'aadl2_FlowEnd301'):
        assert _is_linked(b1, 'aadl2_FlowEnd301', a)
    _safe_set(a, 'aadl2_FlowImplementation300', b2)
    assert _is_linked(a, 'aadl2_FlowImplementation300', b2)
    if hasattr(b1, 'aadl2_FlowEnd301'):
        assert not _is_linked(b1, 'aadl2_FlowEnd301', a)
    if hasattr(b2, 'aadl2_FlowEnd301'):
        assert _is_linked(b2, 'aadl2_FlowEnd301', a)
    _safe_set(a, 'aadl2_FlowImplementation300', None)
    assert not _is_linked(a, 'aadl2_FlowImplementation300', b2)
    if hasattr(b2, 'aadl2_FlowEnd301'):
        assert not _is_linked(b2, 'aadl2_FlowEnd301', a)
...
def test_assoc_namedElementReference889_link_reassign_clear():
    a = aadl2_MetaclassReference(annexName="sample_text", metaclassName="sample_text")
    b1 = aadl2_ReferenceType()
    b2 = aadl2_ReferenceType()
    _safe_set(a, 'aadl2_MetaclassReference890', b1)
    assert _is_linked(a, 'aadl2_MetaclassReference890', b1)
    if hasattr(b1, 'aadl2_ReferenceType'):
        assert _is_linked(b1, 'aadl2_ReferenceType', a)
    _safe_set(a, 'aadl2_MetaclassReference890', b2)
    assert _is_linked(a, 'aadl2_MetaclassReference890', b2)
    if hasattr(b1, 'aadl2_ReferenceType'):
    ...
    _safe_set(a, 'aadl2_MetaclassReference890', None)
    assert not _is_linked(a, 'aadl2_MetaclassReference890', b2)
    if hasattr(b2, 'aadl2_ReferenceType'):
...
def test_assoc_outEnd302_link_reassign_clear():
    a = aadl2_FlowImplementation(kind="sample_text")
    b1 = aadl2_FlowEnd()
    b2 = aadl2_FlowEnd()
    _safe_set(a, 'aadl2_FlowImplementation303', b1)
    assert _is_linked(a, 'aadl2_FlowImplementation303', b1)
    if hasattr(b1, 'aadl2_FlowEnd304'):
        assert _is_linked(b1, 'aadl2_FlowEnd304', a)
    _safe_set(a, 'aadl2_FlowImplementation303', b2)
    assert _is_linked(a, 'aadl2_FlowImplementation303', b2)
    if hasattr(b1, 'aadl2_FlowEnd304'):
        assert not _is_linked(b1, 'aadl2_FlowEnd304', a)
    if hasattr(b2, 'aadl2_FlowEnd304'):
        assert _is_linked(b2, 'aadl2_FlowEnd304', a)
    _safe_set(a, 'aadl2_FlowImplementation303', None)
    assert not _is_linked(a, 'aadl2_FlowImplementation303', b2)
    if hasattr(b2, 'aadl2_FlowEnd304'):
        assert not _is_linked(b2, 'aadl2_FlowEnd304', a)
...
def test_assoc_ownedAnnexLibrary363_link_reassign_clear():
    a = aadl2_PackageSection(noAnnexes="sample_text", noProperties="sample_text")
    b1 = aadl2_AnnexLibrary()
    b2 = aadl2_AnnexLibrary()
    _safe_set(a, 'aadl2_PackageSection364', {b1})
    assert _is_linked(a, 'aadl2_PackageSection364', b1)
    if hasattr(b1, 'aadl2_AnnexLibrary365'):
        assert _is_linked(b1, 'aadl2_AnnexLibrary365', a)
    _safe_set(a, 'aadl2_PackageSection364', {b2})
    assert _is_linked(a, 'aadl2_PackageSection364', b2)
    if hasattr(b1, 'aadl2_AnnexLibrary365'):
        assert not _is_linked(b1, 'aadl2_AnnexLibrary365', a)
    if hasattr(b2, 'aadl2_AnnexLibrary365'):
        assert _is_linked(b2, 'aadl2_AnnexLibrary365', a)
    _safe_set(a, 'aadl2_PackageSection364', set())
    assert not _is_linked(a, 'aadl2_PackageSection364', b2)
    if hasattr(b2, 'aadl2_AnnexLibrary365'):
        assert not _is_linked(b2, 'aadl2_AnnexLibrary365', a)
...
def test_assoc_ownedBusAccess424_link_reassign_clear():
    a = aadl2_BusAccess(virtual="sample_text")
    b1 = aadl2_AbstractType()
    b2 = aadl2_AbstractType()
    _safe_set(a, 'aadl2_BusAccess425', b1)
    assert _is_linked(a, 'aadl2_BusAccess425', b1)
    if hasattr(b1, 'aadl2_AbstractType'):
        assert _is_linked(b1, 'aadl2_AbstractType', a)
    _safe_set(a, 'aadl2_BusAccess425', b2)
    assert _is_linked(a, 'aadl2_BusAccess425', b2)
    if hasattr(b1, 'aadl2_AbstractType'):
        assert not _is_linked(b1, 'aadl2_AbstractType', a)
    if hasattr(b2, 'aadl2_AbstractType'):
        assert _is_linked(b2, 'aadl2_AbstractType', a)
    _safe_set(a, 'aadl2_BusAccess425', None)
    assert not _is_linked(a, 'aadl2_BusAccess425', b2)
    if hasattr(b2, 'aadl2_AbstractType'):
        assert not _is_linked(b2, 'aadl2_AbstractType', a)


def test_assoc_ownedBusAccess498_link_reassign_clear():
    a = aadl2_BusAccess(virtual="sample_text")
    b1 = aadl2_BusType()
    b2 = aadl2_BusType()
    _safe_set(a, 'aadl2_BusAccess499', b1)
    assert _is_linked(a, 'aadl2_BusAccess499', b1)
    if hasattr(b1, 'aadl2_BusType'):
        assert _is_linked(b1, 'aadl2_BusType', a)
    _safe_set(a, 'aadl2_BusAccess499', b2)
    assert _is_linked(a, 'aadl2_BusAccess499', b2)
    if hasattr(b1, 'aadl2_BusType'):
        assert not _is_linked(b1, 'aadl2_BusType', a)
    if hasattr(b2, 'aadl2_BusType'):
        assert _is_linked(b2, 'aadl2_BusType', a)
    _safe_set(a, 'aadl2_BusAccess499', None)
    assert not _is_linked(a, 'aadl2_BusAccess499', b2)
    if hasattr(b2, 'aadl2_BusType'):
        assert not _is_linked(b2, 'aadl2_BusType', a)


def test_assoc_ownedBusAccess532_link_reassign_clear():
    a = aadl2_BusAccess(virtual="sample_text")
    b1 = aadl2_DeviceType()
    b2 = aadl2_DeviceType()
    _safe_set(a, 'aadl2_BusAccess534', b1)
    assert _is_linked(a, 'aadl2_BusAccess534', b1)
    if hasattr(b1, 'aadl2_DeviceType533'):
        assert _is_linked(b1, 'aadl2_DeviceType533', a)
    _safe_set(a, 'aadl2_BusAccess534', b2)
    assert _is_linked(a, 'aadl2_BusAccess534', b2)
    if hasattr(b1, 'aadl2_DeviceType533'):
        assert not _is_linked(b1, 'aadl2_DeviceType533', a)
    if hasattr(b2, 'aadl2_DeviceType533'):
        assert _is_linked(b2, 'aadl2_DeviceType533', a)
    _safe_set(a, 'aadl2_BusAccess534', None)
    assert not _is_linked(a, 'aadl2_BusAccess534', b2)
    if hasattr(b2, 'aadl2_DeviceType533'):
        assert not _is_linked(b2, 'aadl2_DeviceType533', a)


def test_assoc_ownedBusAccess549_link_reassign_clear():
    a = aadl2_BusAccess(virtual="sample_text")
    b1 = aadl2_MemoryType()
    b2 = aadl2_MemoryType()
    _safe_set(a, 'aadl2_BusAccess550', b1)
    assert _is_linked(a, 'aadl2_BusAccess550', b1)
    if hasattr(b1, 'aadl2_MemoryType'):
        assert _is_linked(b1, 'aadl2_MemoryType', a)
    _safe_set(a, 'aadl2_BusAccess550', b2)
    assert _is_linked(a, 'aadl2_BusAccess550', b2)
    if hasattr(b1, 'aadl2_MemoryType'):
        assert not _is_linked(b1, 'aadl2_MemoryType', a)
    if hasattr(b2, 'aadl2_MemoryType'):
        assert _is_linked(b2, 'aadl2_MemoryType', a)
    _safe_set(a, 'aadl2_BusAccess550', None)
    assert not _is_linked(a, 'aadl2_BusAccess550', b2)
    if hasattr(b2, 'aadl2_MemoryType'):
        assert not _is_linked(b2, 'aadl2_MemoryType', a)


def test_assoc_ownedBusAccess600_link_reassign_clear():
    a = aadl2_BusAccess(virtual="sample_text")
    b1 = aadl2_SystemType()
    b2 = aadl2_SystemType()
    _safe_set(a, 'aadl2_BusAccess601', b1)
    assert _is_linked(a, 'aadl2_BusAccess601', b1)
    if hasattr(b1, 'aadl2_SystemType'):
        assert _is_linked(b1, 'aadl2_SystemType', a)
    _safe_set(a, 'aadl2_BusAccess601', b2)
    assert _is_linked(a, 'aadl2_BusAccess601', b2)
    if hasattr(b1, 'aadl2_SystemType'):
        assert not _is_linked(b1, 'aadl2_SystemType', a)
    if hasattr(b2, 'aadl2_SystemType'):
        assert _is_linked(b2, 'aadl2_SystemType', a)
    _safe_set(a, 'aadl2_BusAccess601', None)
    assert not _is_linked(a, 'aadl2_BusAccess601', b2)
    if hasattr(b2, 'aadl2_SystemType'):
        assert not _is_linked(b2, 'aadl2_SystemType', a)


def test_assoc_ownedBusAccess660_link_reassign_clear():
    a = aadl2_BusAccess(virtual="sample_text")
    b1 = aadl2_ProcessorType()
    b2 = aadl2_ProcessorType()
    _safe_set(a, 'aadl2_BusAccess662', b1)
    assert _is_linked(a, 'aadl2_BusAccess662', b1)
    if hasattr(b1, 'aadl2_ProcessorType661'):
        assert _is_linked(b1, 'aadl2_ProcessorType661', a)
    _safe_set(a, 'aadl2_BusAccess662', b2)
    assert _is_linked(a, 'aadl2_BusAccess662', b2)
    if hasattr(b1, 'aadl2_ProcessorType661'):
        assert not _is_linked(b1, 'aadl2_ProcessorType661', a)
    if hasattr(b2, 'aadl2_ProcessorType661'):
        assert _is_linked(b2, 'aadl2_ProcessorType661', a)
    _safe_set(a, 'aadl2_BusAccess662', None)
    assert not _is_linked(a, 'aadl2_BusAccess662', b2)
    if hasattr(b2, 'aadl2_ProcessorType661'):
        assert not _is_linked(b2, 'aadl2_ProcessorType661', a)


def test_assoc_ownedBusAccess775_link_reassign_clear():
    a = aadl2_BusAccess(virtual="sample_text")
    b1 = aadl2_VirtualBusType()
    b2 = aadl2_VirtualBusType()
    _safe_set(a, 'aadl2_BusAccess777', b1)
    assert _is_linked(a, 'aadl2_BusAccess777', b1)
    if hasattr(b1, 'aadl2_VirtualBusType776'):
        assert _is_linked(b1, 'aadl2_VirtualBusType776', a)
    _safe_set(a, 'aadl2_BusAccess777', b2)
    assert _is_linked(a, 'aadl2_BusAccess777', b2)
    if hasattr(b1, 'aadl2_VirtualBusType776'):
        assert not _is_linked(b1, 'aadl2_VirtualBusType776', a)
    if hasattr(b2, 'aadl2_VirtualBusType776'):
        assert _is_linked(b2, 'aadl2_VirtualBusType776', a)
    _safe_set(a, 'aadl2_BusAccess777', None)
    assert not _is_linked(a, 'aadl2_BusAccess777', b2)
    if hasattr(b2, 'aadl2_VirtualBusType776'):
        assert not _is_linked(b2, 'aadl2_VirtualBusType776', a)


def test_assoc_ownedBusAccess794_link_reassign_clear():
    a = aadl2_BusAccess(virtual="sample_text")
    b1 = aadl2_VirtualProcessorType()
    b2 = aadl2_VirtualProcessorType()
    _safe_set(a, 'aadl2_BusAccess796', b1)
    assert _is_linked(a, 'aadl2_BusAccess796', b1)
    if hasattr(b1, 'aadl2_VirtualProcessorType795'):
        assert _is_linked(b1, 'aadl2_VirtualProcessorType795', a)
    _safe_set(a, 'aadl2_BusAccess796', b2)
    assert _is_linked(a, 'aadl2_BusAccess796', b2)
    if hasattr(b1, 'aadl2_VirtualProcessorType795'):
        assert not _is_linked(b1, 'aadl2_VirtualProcessorType795', a)
    if hasattr(b2, 'aadl2_VirtualProcessorType795'):
        assert _is_linked(b2, 'aadl2_VirtualProcessorType795', a)
    _safe_set(a, 'aadl2_BusAccess796', None)
    assert not _is_linked(a, 'aadl2_BusAccess796', b2)
    if hasattr(b2, 'aadl2_VirtualProcessorType795'):
        assert not _is_linked(b2, 'aadl2_VirtualProcessorType795', a)


def test_assoc_ownedClassifier358_link_reassign_clear():
    a = aadl2_PackageSection(noAnnexes="sample_text", noProperties="sample_text")
    b1 = aadl2_Classifier(noAnnexes="sample_text", noProperties="sample_text", noPrototypes="sample_text")
    b2 = aadl2_Classifier(noAnnexes="sample_text_2", noProperties="sample_text_2", noPrototypes="sample_text_2")
    _safe_set(a, 'aadl2_PackageSection359', {b1})
    assert _is_linked(a, 'aadl2_PackageSection359', b1)
    if hasattr(b1, 'aadl2_Classifier360'):
        assert _is_linked(b1, 'aadl2_Classifier360', a)
    _safe_set(a, 'aadl2_PackageSection359', {b2})
    assert _is_linked(a, 'aadl2_PackageSection359', b2)
    if hasattr(b1, 'aadl2_Classifier360'):
        assert not _is_linked(b1, 'aadl2_Classifier360', a)
    if hasattr(b2, 'aadl2_Classifier360'):
        assert _is_linked(b2, 'aadl2_Classifier360', a)
    _safe_set(a, 'aadl2_PackageSection359', set())
    assert not _is_linked(a, 'aadl2_PackageSection359', b2)
    if hasattr(b2, 'aadl2_Classifier360'):
        assert not _is_linked(b2, 'aadl2_Classifier360', a)
...
def test_assoc_ownedComponentTypeRename356_link_reassign_clear():
    a = aadl2_PackageSection(noAnnexes="sample_text", noProperties="sample_text")
...
def test_assoc_ownedFeatureGroupTypeRename361_link_reassign_clear():
    a = aadl2_PackageSection(noAnnexes="sample_text", noProperties="sample_text")
    b1 = aadl2_FeatureGroupTypeRename()
    b2 = aadl2_FeatureGroupTypeRename()
    _safe_set(a, 'aadl2_PackageSection362', {b1})
    assert _is_linked(a, 'aadl2_PackageSection362', b1)
    if hasattr(b1, 'aadl2_FeatureGroupTypeRename'):
        assert _is_linked(b1, 'aadl2_FeatureGroupTypeRename', a)
    _safe_set(a, 'aadl2_PackageSection362', {b2})
    assert _is_linked(a, 'aadl2_PackageSection362', b2)
    if hasattr(b1, 'aadl2_FeatureGroupTypeRename'):
    ...
    _safe_set(a, 'aadl2_PackageSection362', set())
    assert not _is_linked(a, 'aadl2_PackageSection362', b2)
    if hasattr(b2, 'aadl2_FeatureGroupTypeRename'):
...
def test_assoc_ownedFlowSegment297_link_reassign_clear():
    a = aadl2_FlowImplementation(kind="sample_text")
    b1 = aadl2_FlowSegment()
    b2 = aadl2_FlowSegment()
    _safe_set(a, 'aadl2_FlowImplementation298', {b1})
    assert _is_linked(a, 'aadl2_FlowImplementation298', b1)
    if hasattr(b1, 'aadl2_FlowSegment'):
        assert _is_linked(b1, 'aadl2_FlowSegment', a)
    _safe_set(a, 'aadl2_FlowImplementation298', {b2})
    assert _is_linked(a, 'aadl2_FlowImplementation298', b2)
    if hasattr(b1, 'aadl2_FlowSegment'):
        assert not _is_linked(b1, 'aadl2_FlowSegment', a)
    if hasattr(b2, 'aadl2_FlowSegment'):
        assert _is_linked(b2, 'aadl2_FlowSegment', a)
    _safe_set(a, 'aadl2_FlowImplementation298', set())
    assert not _is_linked(a, 'aadl2_FlowImplementation298', b2)
    if hasattr(b2, 'aadl2_FlowSegment'):
...
def test_assoc_ownedModeBinding277_link_reassign_clear():
    a = aadl2_Subcomponent(allModes="sample_text")
    b1 = aadl2_ModeBinding()
    b2 = aadl2_ModeBinding()
    _safe_set(a, 'aadl2_Subcomponent278', {b1})
    assert _is_linked(a, 'aadl2_Subcomponent278', b1)
    if hasattr(b1, 'aadl2_ModeBinding'):
        assert _is_linked(b1, 'aadl2_ModeBinding', a)
    _safe_set(a, 'aadl2_Subcomponent278', {b2})
    assert _is_linked(a, 'aadl2_Subcomponent278', b2)
    if hasattr(b1, 'aadl2_ModeBinding'):
        assert not _is_linked(b1, 'aadl2_ModeBinding', a)
    if hasattr(b2, 'aadl2_ModeBinding'):
        assert _is_linked(b2, 'aadl2_ModeBinding', a)
    _safe_set(a, 'aadl2_Subcomponent278', set())
    assert not _is_linked(a, 'aadl2_Subcomponent278', b2)
    if hasattr(b2, 'aadl2_ModeBinding'):
...
def test_assoc_ownedPackageRename355_link_reassign_clear():
    a = aadl2_PackageSection(noAnnexes="sample_text", noProperties="sample_text")
...
def test_assoc_ownedProperty844_link_reassign_clear():
    a = aadl2_Property(emptyListDefault="sample_text", inherit="sample_text")
    b1 = aadl2_PropertySet()
    b2 = aadl2_PropertySet()
    _safe_set(a, 'aadl2_Property846', b1)
    assert _is_linked(a, 'aadl2_Property846', b1)
    if hasattr(b1, 'aadl2_PropertySet845'):
        assert _is_linked(b1, 'aadl2_PropertySet845', a)
    _safe_set(a, 'aadl2_Property846', b2)
    assert _is_linked(a, 'aadl2_Property846', b2)
    if hasattr(b1, 'aadl2_PropertySet845'):
        assert not _is_linked(b1, 'aadl2_PropertySet845', a)
    if hasattr(b2, 'aadl2_PropertySet845'):
        assert _is_linked(b2, 'aadl2_PropertySet845', a)
    _safe_set(a, 'aadl2_Property846', None)
    assert not _is_linked(a, 'aadl2_Property846', b2)
    if hasattr(b2, 'aadl2_PropertySet845'):
        assert not _is_linked(b2, 'aadl2_PropertySet845', a)
...
def test_assoc_ownedPropertyExpression835_link_reassign_clear():
    a = aadl2_Operation(op="sample_text")
    b1 = aadl2_PropertyExpression()
    b2 = aadl2_PropertyExpression()
    _safe_set(a, 'aadl2_Operation', {b1})
    assert _is_linked(a, 'aadl2_Operation', b1)
    if hasattr(b1, 'aadl2_PropertyExpression836'):
        assert _is_linked(b1, 'aadl2_PropertyExpression836', a)
    _safe_set(a, 'aadl2_Operation', {b2})
    assert _is_linked(a, 'aadl2_Operation', b2)
    if hasattr(b1, 'aadl2_PropertyExpression836'):
        assert not _is_linked(b1, 'aadl2_PropertyExpression836', a)
    if hasattr(b2, 'aadl2_PropertyExpression836'):
        assert _is_linked(b2, 'aadl2_PropertyExpression836', a)
    _safe_set(a, 'aadl2_Operation', set())
    assert not _is_linked(a, 'aadl2_Operation', b2)
    if hasattr(b2, 'aadl2_PropertyExpression836'):
        assert not _is_linked(b2, 'aadl2_PropertyExpression836', a)
...
def test_assoc_ownedPrototypeBinding271_link_reassign_clear():
    a = aadl2_Subcomponent(allModes="sample_text")
    b1 = aadl2_PrototypeBinding()
    b2 = aadl2_PrototypeBinding()
    _safe_set(a, 'aadl2_Subcomponent272', {b1})
    assert _is_linked(a, 'aadl2_Subcomponent272', b1)
    if hasattr(b1, 'aadl2_PrototypeBinding273'):
        assert _is_linked(b1, 'aadl2_PrototypeBinding273', a)
    _safe_set(a, 'aadl2_Subcomponent272', {b2})
    assert _is_linked(a, 'aadl2_Subcomponent272', b2)
    if hasattr(b1, 'aadl2_PrototypeBinding273'):
        assert not _is_linked(b1, 'aadl2_PrototypeBinding273', a)
    if hasattr(b2, 'aadl2_PrototypeBinding273'):
        assert _is_linked(b2, 'aadl2_PrototypeBinding273', a)
    _safe_set(a, 'aadl2_Subcomponent272', set())
    assert not _is_linked(a, 'aadl2_Subcomponent272', b2)
    if hasattr(b2, 'aadl2_PrototypeBinding273'):
        assert not _is_linked(b2, 'aadl2_PrototypeBinding273', a)
...
def test_assoc_ownedSubprogramCallSequence421_link_reassign_clear():
    a = aadl2_BehavioredImplementation()
    b1 = aadl2_SubprogramCallSequence()
    b2 = aadl2_SubprogramCallSequence()
    _safe_set(a, 'aadl2_BehavioredImplementation422', {b1})
    assert _is_linked(a, 'aadl2_BehavioredImplementation422', b1)
    if hasattr(b1, 'aadl2_SubprogramCallSequence423'):
        assert _is_linked(b1, 'aadl2_SubprogramCallSequence423', a)
    _safe_set(a, 'aadl2_BehavioredImplementation422', {b2})
    assert _is_linked(a, 'aadl2_BehavioredImplementation422', b2)
    if hasattr(b1, 'aadl2_SubprogramCallSequence423'):
        assert not _is_linked(b1, 'aadl2_SubprogramCallSequence423', a)
    if hasattr(b2, 'aadl2_SubprogramCallSequence423'):
        assert _is_linked(b2, 'aadl2_SubprogramCallSequence423', a)
    _safe_set(a, 'aadl2_BehavioredImplementation422', set())
    assert not _is_linked(a, 'aadl2_BehavioredImplementation422', b2)
    if hasattr(b2, 'aadl2_SubprogramCallSequence423'):
        assert not _is_linked(b2, 'aadl2_SubprogramCallSequence423', a)
...
def test_assoc_parentMode288_link_reassign_clear():
    a = aadl2_Mode(derived="sample_text", initial="sample_text")
    b1 = aadl2_ModeBinding()
    b2 = aadl2_ModeBinding()
    _safe_set(a, 'aadl2_Mode290', b1)
    assert _is_linked(a, 'aadl2_Mode290', b1)
    if hasattr(b1, 'aadl2_ModeBinding289'):
        assert _is_linked(b1, 'aadl2_ModeBinding289', a)
    _safe_set(a, 'aadl2_Mode290', b2)
    assert _is_linked(a, 'aadl2_Mode290', b2)
    if hasattr(b1, 'aadl2_ModeBinding289'):
        assert not _is_linked(b1, 'aadl2_ModeBinding289', a)
    if hasattr(b2, 'aadl2_ModeBinding289'):
        assert _is_linked(b2, 'aadl2_ModeBinding289', a)
    _safe_set(a, 'aadl2_Mode290', None)
    assert not _is_linked(a, 'aadl2_Mode290', b2)
    if hasattr(b2, 'aadl2_ModeBinding289'):
        assert not _is_linked(b2, 'aadl2_ModeBinding289', a)


def test_assoc_parsedAnnexLibrary351_link_reassign_clear():
...
def test_assoc_parsedAnnexSubclause352_link_reassign_clear():
    ...
    if hasattr(b1, 'aadl2_AnnexSubclause353'):
        assert _is_linked(b1, 'aadl2_AnnexSubclause353', a)
    _safe_set(a, 'aadl2_DefaultAnnexSubclause', b2)
    assert _is_linked(a, 'aadl2_DefaultAnnexSubclause', b2)
    if hasattr(b1, 'aadl2_AnnexSubclause353'):
        assert not _is_linked(b1, 'aadl2_AnnexSubclause353', a)
    if hasattr(b2, 'aadl2_AnnexSubclause353'):
        assert _is_linked(b2, 'aadl2_AnnexSubclause353', a)
    _safe_set(a, 'aadl2_DefaultAnnexSubclause', None)
    assert not _is_linked(a, 'aadl2_DefaultAnnexSubclause', b2)
    if hasattr(b2, 'aadl2_AnnexSubclause353'):
        assert not _is_linked(b2, 'aadl2_AnnexSubclause353', a)
...
def test_assoc_prototype274_link_reassign_clear():
    a = aadl2_Subcomponent(allModes="sample_text")
    b1 = aadl2_ComponentPrototype(array="sample_text")
    b2 = aadl2_ComponentPrototype(array="sample_text_2")
    _safe_set(a, 'aadl2_Subcomponent275', b1)
    assert _is_linked(a, 'aadl2_Subcomponent275', b1)
    if hasattr(b1, 'aadl2_ComponentPrototype276'):
        assert _is_linked(b1, 'aadl2_ComponentPrototype276', a)
    _safe_set(a, 'aadl2_Subcomponent275', b2)
    assert _is_linked(a, 'aadl2_Subcomponent275', b2)
    if hasattr(b1, 'aadl2_ComponentPrototype276'):
        assert not _is_linked(b1, 'aadl2_ComponentPrototype276', a)
    if hasattr(b2, 'aadl2_ComponentPrototype276'):
        assert _is_linked(b2, 'aadl2_ComponentPrototype276', a)
    _safe_set(a, 'aadl2_Subcomponent275', None)
    assert not _is_linked(a, 'aadl2_Subcomponent275', b2)
    if hasattr(b2, 'aadl2_ComponentPrototype276'):
        assert not _is_linked(b2, 'aadl2_ComponentPrototype276', a)


def test_assoc_prototype412_link_reassign_clear():
    ...
    if hasattr(b1, 'aadl2_FeaturePrototype413'):
        assert _is_linked(b1, 'aadl2_FeaturePrototype413', a)
    _safe_set(a, 'aadl2_FeaturePrototypeReference', b2)
    assert _is_linked(a, 'aadl2_FeaturePrototypeReference', b2)
    if hasattr(b1, 'aadl2_FeaturePrototype413'):
        assert not _is_linked(b1, 'aadl2_FeaturePrototype413', a)
    if hasattr(b2, 'aadl2_FeaturePrototype413'):
        assert _is_linked(b2, 'aadl2_FeaturePrototype413', a)
    _safe_set(a, 'aadl2_FeaturePrototypeReference', None)
    assert not _is_linked(a, 'aadl2_FeaturePrototypeReference', b2)
    if hasattr(b2, 'aadl2_FeaturePrototype413'):
        assert not _is_linked(b2, 'aadl2_FeaturePrototype413', a)
...
def test_assoc_refined283_link_reassign_clear():
    a = aadl2_Subcomponent(allModes="sample_text")
    b1 = aadl2_Subcomponent(allModes="sample_text")
    b2 = aadl2_Subcomponent(allModes="sample_text_2")
    _safe_set(a, 'aadl2_Subcomponent282', b1)
    assert _is_linked(a, 'aadl2_Subcomponent282', b1)
    if hasattr(b1, 'aadl2_Subcomponent284'):
        assert _is_linked(b1, 'aadl2_Subcomponent284', a)
    _safe_set(a, 'aadl2_Subcomponent282', b2)
    assert _is_linked(a, 'aadl2_Subcomponent282', b2)
    if hasattr(b1, 'aadl2_Subcomponent284'):
        assert not _is_linked(b1, 'aadl2_Subcomponent284', a)
    if hasattr(b2, 'aadl2_Subcomponent284'):
        assert _is_linked(b2, 'aadl2_Subcomponent284', a)
    _safe_set(a, 'aadl2_Subcomponent282', None)
    assert not _is_linked(a, 'aadl2_Subcomponent282', b2)
    if hasattr(b2, 'aadl2_Subcomponent284'):
        assert not _is_linked(b2, 'aadl2_Subcomponent284', a)


def test_assoc_refined316_link_reassign_clear():
    a = aadl2_Connection(bidirectional="sample_text")
    b1 = aadl2_Connection(bidirectional="sample_text")
    b2 = aadl2_Connection(bidirectional="sample_text_2")
    _safe_set(a, 'aadl2_Connection315', b1)
    assert _is_linked(a, 'aadl2_Connection315', b1)
    if hasattr(b1, 'aadl2_Connection317'):
        assert _is_linked(b1, 'aadl2_Connection317', a)
    _safe_set(a, 'aadl2_Connection315', b2)
    assert _is_linked(a, 'aadl2_Connection315', b2)
    if hasattr(b1, 'aadl2_Connection317'):
        assert not _is_linked(b1, 'aadl2_Connection317', a)
    if hasattr(b2, 'aadl2_Connection317'):
        assert _is_linked(b2, 'aadl2_Connection317', a)
    _safe_set(a, 'aadl2_Connection315', None)
    assert not _is_linked(a, 'aadl2_Connection315', b2)
    if hasattr(b2, 'aadl2_Connection317'):
        assert not _is_linked(b2, 'aadl2_Connection317', a)
...
def test_assoc_renamedComponentType381_link_reassign_clear():
    a = aadl2_ComponentTypeRename(category="sample_text")
    b1 = aadl2_ComponentType(noFeatures="sample_text")
    b2 = aadl2_ComponentType(noFeatures="sample_text_2")
    _safe_set(a, 'aadl2_ComponentTypeRename382', b1)
    assert _is_linked(a, 'aadl2_ComponentTypeRename382', b1)
    if hasattr(b1, 'aadl2_ComponentType383'):
        assert _is_linked(b1, 'aadl2_ComponentType383', a)
    _safe_set(a, 'aadl2_ComponentTypeRename382', b2)
    assert _is_linked(a, 'aadl2_ComponentTypeRename382', b2)
    if hasattr(b1, 'aadl2_ComponentType383'):
        assert not _is_linked(b1, 'aadl2_ComponentType383', a)
    if hasattr(b2, 'aadl2_ComponentType383'):
        assert _is_linked(b2, 'aadl2_ComponentType383', a)
    _safe_set(a, 'aadl2_ComponentTypeRename382', None)
    assert not _is_linked(a, 'aadl2_ComponentTypeRename382', b2)
    if hasattr(b2, 'aadl2_ComponentType383'):
        assert not _is_linked(b2, 'aadl2_ComponentType383', a)


def test_assoc_renamedPackage368_link_reassign_clear():
    a = aadl2_PackageRename(renameAll="sample_text")
    b1 = aadl2_AadlPackage()
    b2 = aadl2_AadlPackage()
    _safe_set(a, 'aadl2_PackageRename369', b1)
    assert _is_linked(a, 'aadl2_PackageRename369', b1)
    if hasattr(b1, 'aadl2_AadlPackage'):
        assert _is_linked(b1, 'aadl2_AadlPackage', a)
    _safe_set(a, 'aadl2_PackageRename369', b2)
    assert _is_linked(a, 'aadl2_PackageRename369', b2)
    if hasattr(b1, 'aadl2_AadlPackage'):
        assert not _is_linked(b1, 'aadl2_AadlPackage', a)
    if hasattr(b2, 'aadl2_AadlPackage'):
        assert _is_linked(b2, 'aadl2_AadlPackage', a)
    _safe_set(a, 'aadl2_PackageRename369', None)
    assert not _is_linked(a, 'aadl2_PackageRename369', b2)
    if hasattr(b2, 'aadl2_AadlPackage'):
...
def test_assoc_source312_link_reassign_clear():
    a = aadl2_Connection(bidirectional="sample_text")
    b1 = aadl2_ConnectedElement()
    b2 = aadl2_ConnectedElement()
    _safe_set(a, 'aadl2_Connection313', b1)
    assert _is_linked(a, 'aadl2_Connection313', b1)
    if hasattr(b1, 'aadl2_ConnectedElement314'):
        assert _is_linked(b1, 'aadl2_ConnectedElement314', a)
    _safe_set(a, 'aadl2_Connection313', b2)
    assert _is_linked(a, 'aadl2_Connection313', b2)
    if hasattr(b1, 'aadl2_ConnectedElement314'):
        assert not _is_linked(b1, 'aadl2_ConnectedElement314', a)
    if hasattr(b2, 'aadl2_ConnectedElement314'):
        assert _is_linked(b2, 'aadl2_ConnectedElement314', a)
    _safe_set(a, 'aadl2_Connection313', None)
    assert not _is_linked(a, 'aadl2_Connection313', b2)
    if hasattr(b2, 'aadl2_ConnectedElement314'):
        assert not _is_linked(b2, 'aadl2_ConnectedElement314', a)
...
def test_assoc_specification294_link_reassign_clear():
    a = aadl2_FlowSpecification(kind="sample_text")
    b1 = aadl2_FlowImplementation(kind="sample_text")
    b2 = aadl2_FlowImplementation(kind="sample_text_2")
    _safe_set(a, 'aadl2_FlowSpecification296', b1)
    assert _is_linked(a, 'aadl2_FlowSpecification296', b1)
    if hasattr(b1, 'aadl2_FlowImplementation295'):
        assert _is_linked(b1, 'aadl2_FlowImplementation295', a)
    _safe_set(a, 'aadl2_FlowSpecification296', b2)
    assert _is_linked(a, 'aadl2_FlowSpecification296', b2)
    if hasattr(b1, 'aadl2_FlowImplementation295'):
        assert not _is_linked(b1, 'aadl2_FlowImplementation295', a)
    if hasattr(b2, 'aadl2_FlowImplementation295'):
        assert _is_linked(b2, 'aadl2_FlowImplementation295', a)
    _safe_set(a, 'aadl2_FlowSpecification296', None)
    assert not _is_linked(a, 'aadl2_FlowSpecification296', b2)
    if hasattr(b2, 'aadl2_FlowImplementation295'):
        assert not _is_linked(b2, 'aadl2_FlowImplementation295', a)


def test_assoc_subcomponentType269_link_reassign_clear():
    a = aadl2_Subcomponent(allModes="sample_text")
...
def test_assoc_subcomponentType391_link_reassign_clear():
    a = aadl2_ComponentPrototypeActual(category="sample_text")
    b1 = aadl2_SubcomponentType()
    b2 = aadl2_SubcomponentType()
    _safe_set(a, 'aadl2_ComponentPrototypeActual392', b1)
    assert _is_linked(a, 'aadl2_ComponentPrototypeActual392', b1)
    if hasattr(b1, 'aadl2_SubcomponentType393'):
        assert _is_linked(b1, 'aadl2_SubcomponentType393', a)
    _safe_set(a, 'aadl2_ComponentPrototypeActual392', b2)
    assert _is_linked(a, 'aadl2_ComponentPrototypeActual392', b2)
    if hasattr(b1, 'aadl2_SubcomponentType393'):
        assert not _is_linked(b1, 'aadl2_SubcomponentType393', a)
    if hasattr(b2, 'aadl2_SubcomponentType393'):
        assert _is_linked(b2, 'aadl2_SubcomponentType393', a)
    _safe_set(a, 'aadl2_ComponentPrototypeActual392', None)
    assert not _is_linked(a, 'aadl2_ComponentPrototypeActual392', b2)
    if hasattr(b2, 'aadl2_SubcomponentType393'):
        assert not _is_linked(b2, 'aadl2_SubcomponentType393', a)


def test_assoc_subprogramCall419_link_reassign_clear():
    a = aadl2_BehavioredImplementation()
    ...
    if hasattr(b1, 'aadl2_SubprogramCall420'):
        assert _is_linked(b1, 'aadl2_SubprogramCall420', a)
    _safe_set(a, 'aadl2_BehavioredImplementation', {b2})
    assert _is_linked(a, 'aadl2_BehavioredImplementation', b2)
    if hasattr(b1, 'aadl2_SubprogramCall420'):
        assert not _is_linked(b1, 'aadl2_SubprogramCall420', a)
    if hasattr(b2, 'aadl2_SubprogramCall420'):
        assert _is_linked(b2, 'aadl2_SubprogramCall420', a)
    _safe_set(a, 'aadl2_BehavioredImplementation', set())
    assert not _is_linked(a, 'aadl2_BehavioredImplementation', b2)
    if hasattr(b2, 'aadl2_SubprogramCall420'):
        assert not _is_linked(b2, 'aadl2_SubprogramCall420', a)
...
def test_assoc_unit818_link_reassign_clear():
    a = aadl2_UnitLiteral()
    b1 = aadl2_NumberValue()
    b2 = aadl2_NumberValue()
