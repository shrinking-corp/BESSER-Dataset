...
class aadl2_PortSpecification(FeaturePrototypeActual):
    ...
    def __init__(self, direction: str, category: str, in_: str, out: str, aadl2_PortSpecification: "aadl2_ComponentClassifier" = None, aadl2_PortSpecification410: "aadl2_ComponentPrototype" = None):
...
class aadl2_BusAccess(Access):
    ...
    def __init__(self, virtual: str, aadl2_BusAccess: "aadl2_FeatureGroupType" = None, aadl2_BusAccess242: "aadl2_BusFeatureClassifier" = None, aadl2_BusAccess425: "aadl2_AbstractType" = None, aadl2_BusAccess534: "aadl2_DeviceType" = None, aadl2_BusAccess499: "aadl2_BusType" = None, aadl2_BusAccess550: "aadl2_MemoryType" = None, aadl2_BusAccess601: "aadl2_SystemType" = None, aadl2_BusAccess662: "aadl2_ProcessorType" = None, aadl2_BusAccess777: "aadl2_VirtualBusType" = None, aadl2_BusAccess796: "aadl2_VirtualProcessorType" = None):
...
class CallContext:
    ...
    pass
class aadl2_AbstractType(AbstractClassifier, ComponentType, CallContext):
...
class aadl2_DataPrototype(ComponentPrototype, Data, DataSubcomponentType):
    ...
    pass
class aadl2_SubprogramPrototype(ComponentPrototype, SubprogramSubcomponentType, Subprogram):
...
class VirtualBus:
    ...
    pass
class aadl2_VirtualBusPrototype(ComponentPrototype, VirtualBus, VirtualBusSubcomponentType):
...
class Memory:
    ...
    pass
class aadl2_MemoryPrototype(Memory, ComponentPrototype, MemorySubcomponentType):
...
class Processor:
    ...
    pass
class aadl2_ProcessorPrototype(ComponentPrototype, ProcessorSubcomponentType, Processor):
...
class Device:
    ...
    pass
class aadl2_DevicePrototype(ComponentPrototype, Device, DeviceSubcomponentType):
...
class aadl2_VirtualProcessorSubcomponent(Subcomponent, VirtualProcessor):
    ...
    pass
class aadl2_VirtualBusSubcomponent(AccessConnectionEnd, VirtualBus, Subcomponent):
...
class aadl2_ThreadSubcomponent(Subcomponent, Thread):
    ...
    pass
class aadl2_SubprogramGroupSubcomponent(AccessConnectionEnd, Subcomponent, SubprogramGroup, CallContext):
...
class AbstractSubcomponentType:
    ...
    pass
class aadl2_AbstractPrototype(AbstractSubcomponentType, ProcessSubcomponentType, VirtualBusSubcomponentType, SubprogramGroupSubcomponentType, BusSubcomponentType, MemorySubcomponentType, SystemSubcomponentType, ThreadSubcomponentType, ComponentPrototype, ThreadGroupSubcomponentType, VirtualProcessorSubcomponentType, DataSubcomponentType, DeviceSubcomponentType, ProcessorSubcomponentType, SubprogramSubcomponentType, Abstract):
...
class aadl2_DeviceSubcomponent(Device, Subcomponent):
    ...
    pass
class aadl2_DataSubcomponent(AccessConnectionEnd, Data, Subcomponent, PortConnectionEnd, ParameterConnectionEnd):
...
class aadl2_FeaturePrototype(Prototype):
    ...
    def __init__(self, direction: str, in_: str, out: str, aadl2_FeaturePrototype: "aadl2_AbstractFeature" = None, aadl2_FeaturePrototype264: "aadl2_ComponentClassifier" = None, aadl2_FeaturePrototype413: "aadl2_FeaturePrototypeReference" = None):
        self.direction = direction
        self.in_ = in_
        self.out = out
...
class aadl2_AbstractFeature(TriggerPort, DirectedFeature):
    ...
    pass
class aadl2_PortProxy(TriggerPort, FeatureConnectionEnd, PortConnectionEnd, ProcessorFeature):

    def __init__(self, direction: str, in_: str, out: str, aadl2_PortProxy: "aadl2_ComponentImplementation" = None, aadl2_PortProxy347: "aadl2_DataClassifier" = None):
        self.direction = direction
        self.in_ = in_
        self.out = out
...
class aadl2_FeatureGroup(Context, DirectedFeature, FeatureGroupConnectionEnd, CallContext):

    def __init__(self, inverse: str, aadl2_FeatureGroup200: "aadl2_FeatureType" = None, aadl2_FeatureGroup202: "aadl2_FeatureGroupType" = None, aadl2_FeatureGroup204: "aadl2_FeatureGroupPrototype" = None, aadl2_FeatureGroup: "aadl2_ComponentType" = None, aadl2_FeatureGroup228: "aadl2_FeatureGroupType" = None):
...
class aadl2_FlowSpecification(FlowElement, FlowFeature, ModalPath):
    ...
    def __init__(self, kind: str, aadl2_FlowSpecification183: "aadl2_FlowSpecification" = None, aadl2_FlowSpecification181: "aadl2_FlowSpecification" = None, aadl2_FlowSpecification185: "aadl2_FlowEnd" = None, aadl2_FlowSpecification187: "aadl2_FlowEnd" = None, aadl2_FlowSpecification: "aadl2_ComponentType" = None, aadl2_FlowSpecification296: "aadl2_FlowImplementation" = None):
        self.kind = kind
...
class ComponentClassifier:
    ...
    pass
class aadl2_ProcessorClassifier(ComponentClassifier, ProcessorSubcomponentType, Processor):

    pass
class aadl2_ThreadGroupClassifier(ThreadGroupSubcomponentType, ComponentClassifier, ThreadGroup):

    pass
class aadl2_SubprogramGroupClassifier(ComponentClassifier, SubprogramGroup, SubprogramGroupSubcomponentType):

    pass
class aadl2_DataClassifier(ComponentClassifier, Data, DataSubcomponentType):

    pass
class aadl2_SubprogramClassifier(ComponentClassifier, SubprogramSubcomponentType, Subprogram):

    pass
class aadl2_AbstractClassifier(AbstractSubcomponentType, ProcessSubcomponentType, VirtualBusSubcomponentType, BusSubcomponentType, SubprogramGroupSubcomponentType, MemorySubcomponentType, SystemSubcomponentType, ThreadSubcomponentType, ThreadGroupSubcomponentType, ComponentClassifier, VirtualProcessorSubcomponentType, DataSubcomponentType, DeviceSubcomponentType, ProcessorSubcomponentType, SubprogramSubcomponentType, Abstract):
...
class aadl2_DeviceClassifier(DeviceSubcomponentType, Device, ComponentClassifier):
    ...
    pass
class aadl2_BusClassifier(ComponentClassifier, BusSubcomponentType, Bus):

    pass
class aadl2_ProcessClassifier(ComponentClassifier, Process, ProcessSubcomponentType):
...
class aadl2_MemoryClassifier(Memory, ComponentClassifier, MemorySubcomponentType):
    ...
    pass
class aadl2_VirtualBusClassifier(ComponentClassifier, VirtualBus, VirtualBusSubcomponentType):

    pass
class aadl2_ComponentType(ComponentClassifier):

    def __init__(self, noFeatures: str, aadl2_ComponentType198: "aadl2_TypeExtension" = None, aadl2_ComponentType161: set["aadl2_FlowSpecification"] = None, aadl2_ComponentType163: "aadl2_TypeExtension" = None, aadl2_ComponentType165: set["aadl2_FeatureGroup"] = None, aadl2_ComponentType: "aadl2_ComponentImplementation" = None, aadl2_ComponentType167: set["aadl2_AbstractFeature"] = None, aadl2_ComponentType156: set["aadl2_Feature"] = None, aadl2_ComponentType159: "aadl2_ComponentType" = None, aadl2_ComponentType157: "aadl2_ComponentType" = None, aadl2_ComponentType331: "aadl2_Realization" = None, aadl2_ComponentType383: "aadl2_ComponentTypeRename" = None):
...
class aadl2_ComponentImplementation(ComponentClassifier):
    ...
    def __init__(self, noSubcomponents: str, noConnections: str, noCalls: str, aadl2_ComponentImplementation106: set["aadl2_FlowImplementation"] = None, aadl2_ComponentImplementation108: set["aadl2_Connection"] = None, aadl2_ComponentImplementation110: "aadl2_ImplementationExtension" = None, aadl2_ComponentImplementation112: "aadl2_Realization" = None, aadl2_ComponentImplementation114: set["aadl2_EndToEndFlow"] = None, aadl2_ComponentImplementation116: set["aadl2_AbstractSubcomponent"] = None, aadl2_ComponentImplementation118: set["aadl2_AccessConnection"] = None, aadl2_ComponentImplementation120: set["aadl2_ParameterConnection"] = None, aadl2_ComponentImplementation: "aadl2_ComponentImplementationReference" = None, aadl2_ComponentImplementation132: set["aadl2_EventSource"] = None, aadl2_ComponentImplementation134: set["aadl2_EventDataSource"] = None, aadl2_ComponentImplementation136: set["aadl2_PortProxy"] = None, aadl2_ComponentImplementation99: "aadl2_ComponentType" = None, aadl2_ComponentImplementation101: set["aadl2_Subcomponent"] = None, aadl2_ComponentImplementation104: "aadl2_ComponentImplementation" = None, aadl2_ComponentImplementation102: "aadl2_ComponentImplementation" = None, aadl2_ComponentImplementation138: set["aadl2_SubprogramProxy"] = None, aadl2_ComponentImplementation122: set["aadl2_PortConnection"] = None, aadl2_ComponentImplementation124: set["aadl2_FeatureConnection"] = None, aadl2_ComponentImplementation126: set["aadl2_FeatureGroupConnection"] = None, aadl2_ComponentImplementation128: set["aadl2_ProcessorFeature"] = None, aadl2_ComponentImplementation130: set["aadl2_InternalFeature"] = None, aadl2_ComponentImplementation328: "aadl2_ImplementationExtension" = None):
...
class StructuralFeature:
    ...
    pass
class aadl2_Feature(StructuralFeature, ArrayableElement, FeatureConnectionEnd):
...
class aadl2_FlowFeature(StructuralFeature, Flow):
    ...
    pass
class aadl2_InternalFeature(StructuralFeature, TriggerPort, PortConnectionEnd, FeatureConnectionEnd):
...
class ClassifierFeature:
    ...
    pass
class aadl2_FlowImplementation(ModalPath, ClassifierFeature, Flow):
...
class aadl2_Subcomponent(StructuralFeature, Context, FlowElement, ArrayableElement, ModalElement):
    ...
    def __init__(self, allModes: str, aadl2_Subcomponent: "aadl2_ComponentImplementation" = None, aadl2_Subcomponent278: set["aadl2_ModeBinding"] = None, aadl2_Subcomponent280: set["aadl2_ComponentImplementationReference"] = None, aadl2_Subcomponent284: "aadl2_Subcomponent" = None, aadl2_Subcomponent282: "aadl2_Subcomponent" = None, aadl2_Subcomponent270: "aadl2_SubcomponentType" = None, aadl2_Subcomponent272: set["aadl2_PrototypeBinding"] = None, aadl2_Subcomponent275: "aadl2_ComponentPrototype" = None, aadl2_Subcomponent286: "aadl2_ComponentClassifier" = None):
...
class aadl2_ComponentTypeRename(NamedElement):
    ...
    def __init__(self, category: str, aadl2_ComponentTypeRename382: "aadl2_ComponentType" = None, aadl2_ComponentTypeRename: "aadl2_PackageSection" = None):
        self.category = category
...
class aadl2_NamedElement(Element):
    ...
    def __init__(self, name: str, qualifiedName: str, aadl2_NamedElement33: "aadl2_Classifier" = None, aadl2_NamedElement45: "aadl2_Namespace" = None, aadl2_NamedElement48: "aadl2_Namespace" = None, aadl2_NamedElement82: "aadl2_ContainmentPathElement" = None, aadl2_NamedElement: set["aadl2_PropertyAssociation"] = None):
        self.name = name
    ...
    def getPropertyValues(self, aadl2_propertySetName, aadl2_propertyName) :
...
class aadl2_PropertyAssociation(Element):
    ...
    def __init__(self, append: str, constant: str, aadl2_PropertyAssociation12: set["aadl2_ModalPropertyValue"] = None, aadl2_PropertyAssociation: "aadl2_NamedElement" = None, aadl2_PropertyAssociation6: "aadl2_Property" = None, aadl2_PropertyAssociation8: set["aadl2_ContainedNamedElement"] = None, aadl2_PropertyAssociation10: set["aadl2_Classifier"] = None):
        self.append = append
...
class aadl2_MetaclassReference(PropertyOwner):
    ...
    def __init__(self, annexName: str, metaclassName: str, aadl2_MetaclassReference: "aadl2_Property" = None, aadl2_MetaclassReference890: "aadl2_ReferenceType" = None, aadl2_MetaclassReference878: "aadl2_ClassifierType" = None):
        self.annexName = annexName
...
class aadl2_Classifier(Type, Namespace):
    ...
    def __init__(self, noPrototypes: str, noAnnexes: str, noProperties: str, featuringClassifier: set["aadl2_ClassifierFeature"] = None, aadl2_Classifier32: set["aadl2_NamedElement"] = None, specific: set["aadl2_Generalization_"] = None, aadl2_Classifier19: "aadl2_Property" = None, Classifier: "aadl2_ClassifierFeature" = None, aadl2_Classifier51: "aadl2_Generalization_" = None, Classifier53: "aadl2_Generalization_" = None, aadl2_Classifier37: "aadl2_Classifier" = None, aadl2_Classifier35: set["aadl2_Classifier"] = None, aadl2_Classifier39: set["aadl2_AnnexSubclause"] = None, aadl2_Classifier41: set["aadl2_Prototype"] = None, aadl2_Classifier43: set["aadl2_PrototypeBinding"] = None, aadl2_Classifier: "aadl2_PropertyAssociation" = None, aadl2_Classifier66: "aadl2_RefinableElement" = None, aadl2_Classifier177: "aadl2_Feature" = None, aadl2_Classifier360: "aadl2_PackageSection" = None, aadl2_Classifier826: "aadl2_ClassifierValue" = None):
...
class aadl2_Element(ABC):
    ...
    def __init__(self, aadl2_Element3: set["aadl2_Comment"] = None, aadl2_Element55: "aadl2_DirectedRelationship" = None, aadl2_Element58: "aadl2_DirectedRelationship" = None, aadl2_Element60: "aadl2_Relationship" = None, aadl2_Element: "aadl2_Element" = None, aadl2_Element0: set["aadl2_Element"] = None):
