...
class frameweb_VocabularyEntity(Classifier):
    ...
    pass
class frameweb_Association(Relationship, Classifier):

    def __init__(self, isDerived: str, Association56: "frameweb_Property" = None, frameweb_Association: set["frameweb_Type"] = None, association: set["frameweb_Property"] = None, owningAssociation: set["frameweb_Property"] = None, frameweb_Association63: set["frameweb_Property"] = None, Association: "frameweb_Property" = None):
    ...
    def association_ends(self, frameweb_diagnostics, frameweb_context) :
    ...
    def ends_must_be_typed(self, frameweb_diagnostics, frameweb_context) :
        # TODO: Implement ends_must_be_typed method
        pass

    def specialized_end_types(self, frameweb_context, frameweb_diagnostics) :
        # TODO: Implement specialized_end_types method
        pass

    def binary_associations(self, frameweb_context, frameweb_diagnostics) :
...
class frameweb_Property(DeploymentTarget, ConnectableElement, StructuralFeature):
    ...
    def derived_union_is_derived(self, frameweb_context, frameweb_diagnostics) :
        # TODO: Implement derived_union_is_derived method
        pass

    def subsetting_context_conforms(self, frameweb_context, frameweb_diagnostics) :
    ...
    def redefined_property_inherited(self, frameweb_context, frameweb_diagnostics) :
...
class frameweb_TagLib(Package):
    ...
    def __init__(self, prefix: str, frameweb_TagLib5: "frameweb_Template" = None, frameweb_TagLib: "frameweb_Page" = None):
        self.prefix = prefix
...
class frameweb_IRI(Property):
    ...
    def __init__(self, iri: str, iriVersion: str, frameweb_IRI66: "frameweb_VocabularyEntity" = None, frameweb_IRI: "frameweb_Vocabulary" = None, frameweb_IRI28: "frameweb_Vocabulary" = None):
        self.iri = iri
