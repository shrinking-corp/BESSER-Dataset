...
public class aadl2_ProcessorImplementation extends ComponentImplementation, ProcessorClassifier {
    ...
    public aadl2_ProcessorImplementation(
        ArrayList<aadl2_MemorySubcomponent> aadl2_memorysubcomponents,        ArrayList<aadl2_VirtualProcessorSubcomponent> aadl2_virtualprocessorsubcomponents,        ArrayList<aadl2_BusSubcomponent> aadl2_bussubcomponents,        ArrayList<aadl2_VirtualBusSubcomponent> aadl2_virtualbussubcomponents    ) {
