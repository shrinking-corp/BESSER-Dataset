...
public class aadl2_Classifier extends Namespace, Type {
    ...
    public aadl2_Classifier(
        String noAnnexes,        String noPrototypes,        String noProperties        ArrayList<aadl2_PrototypeBinding> aadl2_prototypebindings,        ArrayList<aadl2_ClassifierFeature> aadl2_classifierfeatures,        ArrayList<aadl2_NamedElement> aadl2_namedelements    ) {
        this.noAnnexes = noAnnexes;
        this.noPrototypes = noPrototypes;
        this.noProperties = noProperties;
