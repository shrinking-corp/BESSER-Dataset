...
class ptnet_Font:
    ...
    def __init__(self, decoration: str, family: str, rotation: str, size: str, style: str, align: str, weight: str, Font: "ptnet_AnnotationGraphics" = None, font: "ptnet_AnnotationGraphics" = None):
...
class ptnet_Line:
    ...
    def __init__(self, shape: str, width: str, color: str, style: str, Line: "ptnet_NodeGraphics" = None, Line55: "ptnet_AnnotationGraphics" = None, line: "ptnet_NodeGraphics" = None, line67: "ptnet_ArcGraphics" = None, line70: "ptnet_AnnotationGraphics" = None, Line76: "ptnet_ArcGraphics" = None):
        self.shape = shape
        self.width = width
        self.color = color
        self.style = style
...
class ptnet_Fill:
    ...
    def __init__(self, color: str, gradientcolor: str, gradientrotation: str, image: str, Fill: "ptnet_NodeGraphics" = None, fill: "ptnet_NodeGraphics" = None, Fill52: "ptnet_AnnotationGraphics" = None, fill62: "ptnet_AnnotationGraphics" = None):
        self.color = color
