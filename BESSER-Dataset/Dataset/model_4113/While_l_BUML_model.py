...
# Classes
while_l_Function = Class(name="while_l_Function")
while_l_Definition = Class(name="while_l_Definition")
while_l_Input = Class(name="while_l_Input")
while_l_Commands = Class(name="while_l_Commands")
while_l_Output = Class(name="while_l_Output")
while_l_Command = Class(name="while_l_Command")
while_l_Wh = Class(name="while_l_Wh")
while_l_Program = Class(name="while_l_Program")
while_l_ExprEq = Class(name="while_l_ExprEq")
while_l_ExprSimple = Class(name="while_l_ExprSimple")
while_l_ExprAnd = Class(name="while_l_ExprAnd")
while_l_ExprOr = Class(name="while_l_ExprOr")
while_l_ExprCons = Class(name="while_l_ExprCons")
while_l_EObject = Class(name="while_l_EObject")
while_l_If = Class(name="while_l_If")
while_l_Expr = Class(name="while_l_Expr")
while_l_Nop = Class(name="while_l_Nop")
while_l_Affect = Class(name="while_l_Affect")
while_l_For = Class(name="while_l_For")
while_l_While = Class(name="while_l_While")
while_l_ExprList = Class(name="while_l_ExprList")
while_l_ExprHd = Class(name="while_l_ExprHd")
while_l_ExprTl = Class(name="while_l_ExprTl")
while_l_ExprSym = Class(name="while_l_ExprSym")
while_l_ExprNot = Class(name="while_l_ExprNot")
...
while_l_ExprSimple.attributes={while_l_ExprSimple_sym, while_l_ExprSimple_nameFunction, while_l_ExprSimple_str, while_l_ExprSimple_varSimple}
...
domain_model = DomainModel(
    name="while_l",
    types={while_l_Function, while_l_Definition, while_l_Input, while_l_Commands, while_l_Output, while_l_Command, while_l_Wh, while_l_Program, while_l_ExprEq, while_l_ExprSimple, while_l_ExprAnd, while_l_ExprOr, while_l_ExprCons, while_l_EObject, while_l_If, while_l_Expr, while_l_Nop, while_l_Affect, while_l_For, while_l_While, while_l_ExprList, while_l_ExprHd, while_l_ExprTl, while_l_ExprSym, while_l_ExprNot},
    associations={elements0, functions1, definition3, input5, commands7, output9, commands11, expr29, cmds31, expr34, exprEq37, vars39, arg141, arg243, arg146, arg248, cmd13, expr15, commands116, commands219, exprs22, expr24, cmds26, arg166, arg269, arg151, arg253, arg56, arg58, arg60, arg262, arg164},
    generalizations={},
    metadata=None
)
