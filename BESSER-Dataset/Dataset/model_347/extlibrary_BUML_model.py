...
domain_model = DomainModel(
    name="extlibrary",
    types={extlibrary_Book, CirculatingItem, extlibrary_Writer, extlibrary_Library, Addressable, extlibrary_Employee, extlibrary_Borrower, extlibrary_Item, extlibrary_Lendable, extlibrary_CirculatingItem, Item, Lendable, extlibrary_Periodical, extlibrary_AudioVisualItem, extlibrary_BookOnTape, AudioVisualItem, extlibrary_VideoCassette, extlibrary_Person, Person, extlibrary_Addressable, BookCategory},
    associations={author0, writers1, employees2, borrowers4, stock6, books8, branches11, parentBranch13, books20, borrowers21, reader22, author24, cast27, borrowed29, casts15, readers17, manager31},
