...
class extlibrary_Person(Addressable):
    ...
    def __init__(self, firstName: str, lastName: str, extlibrary_Person23: "extlibrary_BookOnTape" = None, extlibrary_Person28: "extlibrary_VideoCassette" = None, extlibrary_Person: "extlibrary_Library" = None, extlibrary_Person19: "extlibrary_Library" = None):
...
class extlibrary_Writer(Person):
    ...
    def __init__(self, name: str, extlibrary_Writer: "extlibrary_Library" = None, author: set["extlibrary_Book"] = None, extlibrary_Writer26: "extlibrary_BookOnTape" = None, Writer: "extlibrary_Book" = None):
        self.name = name
