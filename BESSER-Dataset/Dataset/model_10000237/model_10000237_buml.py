...
domain_model = DomainModel(
    name="_1e148f8f_1ecb_46d5_97a6_9097e182a801",
    ...
    associations={Admin_Login, Admin_Logout, Instructor_Logout, Student_Logout, Instructor_Login, Login_Student, Login_Add_Student, Login_Add_Instructor, Login_Add_Course, Login_Add_Evalutaions_Assignments_Exams, Login_Generate_Report, Login_Register_drop_course, Login_View_Grades, Submit_Exam_Assignment_Login, Question_Answer, Course_Exam, School_Admin_Course, Student_Course, Exam_Question},
    generalizations={},
    metadata=None
)
