...
class simpleworld_Thing(NamedElement):
    ...
    def __init__(self, id: int, simpleworld_Thing: "simpleworld_World" = None, fromThing: set["simpleworld_RelatedTo"] = None, Thing: "simpleworld_RelatedTo" = None, simpleworld_Thing4: "simpleworld_RelatedTo" = None):
        self.id = id
