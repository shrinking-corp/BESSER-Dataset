...
# Classes
simpleworld_Thing = Class(name="simpleworld_Thing")
NamedElement = Class(name="NamedElement")
simpleworld_RelatedTo = Class(name="simpleworld_RelatedTo")
simpleworld_NamedElement = Class(name="simpleworld_NamedElement", is_abstract=True)
simpleworld_World = Class(name="simpleworld_World")
...
domain_model = DomainModel(
    name="simpleworld",
    types={simpleworld_Thing, NamedElement, simpleworld_RelatedTo, simpleworld_NamedElement, simpleworld_World},
