...
class bintree_BinTreeNode:
    ...
    def __init__(self, data: str, bintree_BinTreeNode0: "bintree_BinTreeNode" = None, bintree_BinTreeNode: "bintree_BinTreeNode" = None, bintree_BinTreeNode4: "bintree_BinTreeNode" = None, bintree_BinTreeNode2: "bintree_BinTreeNode" = None, bintree_BinTreeNode7: "bintree_BinTreeNode" = None, bintree_BinTreeNode5: "bintree_BinTreeNode" = None):
        self.data = data
