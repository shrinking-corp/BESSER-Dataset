...
# Classes
testSubpackages1_root_class1 = Class(name="testSubpackages1_root_class1")
class3 = Class(name="class3")
testSubpackages1_root_testSubpackages1_subpackage1_class2 = Class(name="testSubpackages1_root_testSubpackages1_subpackage1_class2")
testSubpackages1_root_testSubpackages1_subpackage3_class4 = Class(name="testSubpackages1_root_testSubpackages1_subpackage3_class4")
testSubpackages1_root_testSubpackages1_subpackage2_class3 = Class(name="testSubpackages1_root_testSubpackages1_subpackage2_class3")
