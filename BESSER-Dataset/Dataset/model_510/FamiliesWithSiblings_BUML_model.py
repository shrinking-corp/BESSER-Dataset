...
# Classes
FamiliesWithSiblings_FamilyRegister = Class(name="FamiliesWithSiblings_FamilyRegister")
FamiliesWithSiblings_Family = Class(name="FamiliesWithSiblings_Family")
FamiliesWithSiblings_FamilyMember = Class(name="FamiliesWithSiblings_FamilyMember")
...
domain_model = DomainModel(
    ...
    types={FamiliesWithSiblings_FamilyRegister, FamiliesWithSiblings_Family, FamiliesWithSiblings_FamilyMember},
