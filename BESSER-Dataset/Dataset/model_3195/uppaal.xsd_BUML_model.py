...
# Classes
Uppaal_DeclarationType = Class(name="Uppaal_DeclarationType")
Uppaal_DocumentRoot = Class(name="Uppaal_DocumentRoot")
Uppaal_EStringToStringMapEntry = Class(name="Uppaal_EStringToStringMapEntry")
Uppaal_ImportsType = Class(name="Uppaal_ImportsType")
Uppaal_InitType = Class(name="Uppaal_InitType")
Uppaal_InstantiationType = Class(name="Uppaal_InstantiationType")
Uppaal_LabelType = Class(name="Uppaal_LabelType")
Uppaal_LocationType = Class(name="Uppaal_LocationType")
Uppaal_NailType = Class(name="Uppaal_NailType")
Uppaal_NameType = Class(name="Uppaal_NameType")
Uppaal_NtaType = Class(name="Uppaal_NtaType")
Uppaal_ParameterType = Class(name="Uppaal_ParameterType")
Uppaal_SourceType = Class(name="Uppaal_SourceType")
Uppaal_SystemType = Class(name="Uppaal_SystemType")
Uppaal_TargetType = Class(name="Uppaal_TargetType")
Uppaal_TransitionType = Class(name="Uppaal_TransitionType")
Uppaal_TemplateType = Class(name="Uppaal_TemplateType")
...
Uppaal_DocumentRoot.attributes={Uppaal_DocumentRoot_committed, Uppaal_DocumentRoot_mixed, Uppaal_DocumentRoot_urgent}
...
Uppaal_LabelType.attributes={Uppaal_LabelType_x, Uppaal_LabelType_y, Uppaal_LabelType_kind, Uppaal_LabelType_mixed}
...
Uppaal_LocationType.attributes={Uppaal_LocationType_urgent, Uppaal_LocationType_id, Uppaal_LocationType_color, Uppaal_LocationType_x, Uppaal_LocationType_y, Uppaal_LocationType_committed}
...
Uppaal_NameType.attributes={Uppaal_NameType_x, Uppaal_NameType_mixed, Uppaal_NameType_y}
...
Uppaal_TransitionType.attributes={Uppaal_TransitionType_id, Uppaal_TransitionType_color, Uppaal_TransitionType_y, Uppaal_TransitionType_x}
...
domain_model = DomainModel(
    name="Uppaal",
    types={Uppaal_DeclarationType, Uppaal_DocumentRoot, Uppaal_EStringToStringMapEntry, Uppaal_ImportsType, Uppaal_InitType, Uppaal_InstantiationType, Uppaal_LabelType, Uppaal_LocationType, Uppaal_NailType, Uppaal_NameType, Uppaal_NtaType, Uppaal_ParameterType, Uppaal_SourceType, Uppaal_SystemType, Uppaal_TargetType, Uppaal_TransitionType, Uppaal_TemplateType},
    associations={xMLNSPrefixMap0, xSISchemaLocation1, declaration4, imports6, init8, label12, location14, nail16, name18, nta20, parameter22, source24, system26, target28, instantiation10, transition32, name34, label37, template30, imports40, declaration43, template46, instantiation49, system52, name55, parameter58, declaration61, location64, init67, transition70, source73, target76, label79, nail82},
    generalizations={},
    metadata=None
)
