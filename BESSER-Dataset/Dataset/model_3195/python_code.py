...
class Uppaal_TransitionType:
    ...
    def __init__(self, color: str, id: str, x: str, y: str, Uppaal_TransitionType: "Uppaal_DocumentRoot" = None, Uppaal_TransitionType72: "Uppaal_TemplateType" = None, Uppaal_TransitionType74: "Uppaal_SourceType" = None, Uppaal_TransitionType77: "Uppaal_TargetType" = None, Uppaal_TransitionType80: set["Uppaal_LabelType"] = None, Uppaal_TransitionType83: set["Uppaal_NailType"] = None):
        self.color = color
        self.id = id
        self.x = x
        self.y = y
...
class Uppaal_SystemType:
    ...
    def __init__(self, mixed: str, Uppaal_SystemType54: "Uppaal_NtaType" = None, Uppaal_SystemType: "Uppaal_DocumentRoot" = None):
        self.mixed = mixed
...
class Uppaal_ParameterType:
    ...
    def __init__(self, mixed: str, x: str, y: str, Uppaal_ParameterType60: "Uppaal_TemplateType" = None, Uppaal_ParameterType: "Uppaal_DocumentRoot" = None):
        self.mixed = mixed
        self.x = x
        self.y = y
...
class Uppaal_NameType:
    ...
    def __init__(self, mixed: str, x: str, y: str, Uppaal_NameType36: "Uppaal_LocationType" = None, Uppaal_NameType57: "Uppaal_TemplateType" = None, Uppaal_NameType: "Uppaal_DocumentRoot" = None):
        self.mixed = mixed
        self.x = x
        self.y = y
...
class Uppaal_LocationType:
    ...
    def __init__(self, urgent: str, committed: str, color: str, id: str, x: str, y: str, Uppaal_LocationType35: "Uppaal_NameType" = None, Uppaal_LocationType38: set["Uppaal_LabelType"] = None, Uppaal_LocationType66: "Uppaal_TemplateType" = None, Uppaal_LocationType: "Uppaal_DocumentRoot" = None):
        self.urgent = urgent
...
class Uppaal_LabelType:
    ...
    def __init__(self, mixed: str, kind: str, x: str, y: str, Uppaal_LabelType39: "Uppaal_LocationType" = None, Uppaal_LabelType: "Uppaal_DocumentRoot" = None, Uppaal_LabelType81: "Uppaal_TransitionType" = None):
        self.mixed = mixed
        self.kind = kind
        self.x = x
        self.y = y
...
class Uppaal_InstantiationType:
    ...
    def __init__(self, mixed: str, Uppaal_InstantiationType51: "Uppaal_NtaType" = None, Uppaal_InstantiationType: "Uppaal_DocumentRoot" = None):
        self.mixed = mixed
...
class Uppaal_InitType:
    ...
    def __init__(self, ref: str, Uppaal_InitType69: "Uppaal_TemplateType" = None, Uppaal_InitType: "Uppaal_DocumentRoot" = None):
        self.ref = ref
...
class Uppaal_ImportsType:
    ...
    def __init__(self, mixed: str, Uppaal_ImportsType42: "Uppaal_NtaType" = None, Uppaal_ImportsType: "Uppaal_DocumentRoot" = None):
        self.mixed = mixed
...
class Uppaal_DocumentRoot:
    ...
    def __init__(self, mixed: str, committed: str, urgent: str, Uppaal_DocumentRoot31: set["Uppaal_TemplateType"] = None, Uppaal_DocumentRoot: set["Uppaal_EStringToStringMapEntry"] = None, Uppaal_DocumentRoot2: set["Uppaal_EStringToStringMapEntry"] = None, Uppaal_DocumentRoot5: set["Uppaal_DeclarationType"] = None, Uppaal_DocumentRoot7: set["Uppaal_ImportsType"] = None, Uppaal_DocumentRoot9: set["Uppaal_InitType"] = None, Uppaal_DocumentRoot13: set["Uppaal_LabelType"] = None, Uppaal_DocumentRoot15: set["Uppaal_LocationType"] = None, Uppaal_DocumentRoot17: set["Uppaal_NailType"] = None, Uppaal_DocumentRoot19: set["Uppaal_NameType"] = None, Uppaal_DocumentRoot21: set["Uppaal_NtaType"] = None, Uppaal_DocumentRoot23: set["Uppaal_ParameterType"] = None, Uppaal_DocumentRoot25: set["Uppaal_SourceType"] = None, Uppaal_DocumentRoot27: set["Uppaal_SystemType"] = None, Uppaal_DocumentRoot29: set["Uppaal_TargetType"] = None, Uppaal_DocumentRoot11: set["Uppaal_InstantiationType"] = None, Uppaal_DocumentRoot33: set["Uppaal_TransitionType"] = None):
        self.mixed = mixed
        self.committed = committed
        self.urgent = urgent
...
class Uppaal_DeclarationType:
    ...
    def __init__(self, mixed: str, Uppaal_DeclarationType45: "Uppaal_NtaType" = None, Uppaal_DeclarationType63: "Uppaal_TemplateType" = None, Uppaal_DeclarationType: "Uppaal_DocumentRoot" = None):
        self.mixed = mixed
