...
# Classes
units_av_av_UnitCarryingElement = Class(name="units_av_av_UnitCarryingElement")
units_av_av_Unit = Class(name="units_av_av_Unit")
units_av_av_UnitRepository = Class(name="units_av_av_UnitRepository")
units_av_av_UnitMultiplication = Class(name="units_av_av_UnitMultiplication")
Unit = Class(name="Unit")
units_av_av_UnitPower = Class(name="units_av_av_UnitPower")
units_av_av_UnitLiteral = Class(name="units_av_av_UnitLiteral")
units_av_av_AdviceAdvice = Class(name="units_av_av_AdviceAdvice")
units_av_av_EObject = Class(name="units_av_av_EObject")
units_av_av_GlobalScopeGlobalScope = Class(name="units_av_av_GlobalScopeGlobalScope")
units_av_av_PerJoinPointScopePerJoinPointScope = Class(name="units_av_av_PerJoinPointScopePerJoinPointScope")
units_av_av_Advice = Class(name="units_av_av_Advice")
units_av_av_GlobalScope = Class(name="units_av_av_GlobalScope")
units_av_av_PerJoinPointScope = Class(name="units_av_av_PerJoinPointScope")
units_av_av_BaseUnit = Class(name="units_av_av_BaseUnit")
...
domain_model = DomainModel(
    name="units_av_av",
    types={units_av_av_UnitCarryingElement, units_av_av_Unit, units_av_av_UnitRepository, units_av_av_UnitMultiplication, Unit, units_av_av_UnitPower, units_av_av_UnitLiteral, units_av_av_AdviceAdvice, units_av_av_EObject, units_av_av_GlobalScopeGlobalScope, units_av_av_PerJoinPointScopePerJoinPointScope, units_av_av_Advice, units_av_av_GlobalScope, units_av_av_PerJoinPointScope, units_av_av_BaseUnit},
    associations={unit0, units1, units2, unit4, baseUnit6, children8, scopedObject9, scopedObject11, children13, scopedObject15, scopedObject17},
    generalizations={gen_units_av_av_UnitMultiplication_Unit, gen_units_av_av_UnitPower_Unit, gen_units_av_av_UnitLiteral_Unit},
    metadata=None
)
