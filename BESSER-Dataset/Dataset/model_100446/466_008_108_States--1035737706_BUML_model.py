...
# Classes
states_Module = Class(name="states_Module")
states_Event = Class(name="states_Event")
states_State = Class(name="states_State")
states_Transition = Class(name="states_Transition")
states_Statemachine = Class(name="states_Statemachine")
states_SimpleState = Class(name="states_SimpleState")
State = Class(name="State")
states_CompoundState = Class(name="states_CompoundState")
...
states_Statemachine.attributes={states_Statemachine_name, states_Statemachine_value, states_Statemachine_initial}
...
domain_model = DomainModel(
    name="states",
    types={states_Module, states_Event, states_State, states_Transition, states_Statemachine, states_SimpleState, State, states_CompoundState},
    associations={machines0, events1, states3, transitions5, machine7, event9, state12},
    generalizations={gen_states_CompoundState_State, gen_states_SimpleState_State},
    metadata=None
)
