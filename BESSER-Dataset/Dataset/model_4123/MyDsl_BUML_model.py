...
myDsl_Program = Class(name="myDsl_Program")
...
myDsl_Nill = Class(name="myDsl_Nill")
myDsl_ABin = Class(name="myDsl_ABin")
myDsl_Affectation = Class(name="myDsl_Affectation")
myDsl_Variable = Class(name="myDsl_Variable")
...
myDsl_Nop = Class(name="myDsl_Nop")
...
myDsl_AccSucc = Class(name="myDsl_AccSucc")
myDsl_ElemSimple = Class(name="myDsl_ElemSimple")
myDsl_Lexpr = Class(name="myDsl_Lexpr")
myDsl_COMPARATEUR = Class(name="myDsl_COMPARATEUR")
myDsl_OpConstructeur = Class(name="myDsl_OpConstructeur")
myDsl_OpAccSucc = Class(name="myDsl_OpAccSucc")
...
myDsl_Input_in_: Property = Property(name="in_", type=StringType)
myDsl_Input.attributes={myDsl_Input_in_}
...
myDsl_Not_not_: Property = Property(name="not_", type=StringType)
myDsl_Not.attributes={myDsl_Not_not_}
...
domain_model = DomainModel(
    name="myDsl",
    types={myDsl_Commande, myDsl_EObject, myDsl_Program, myDsl_Fonction, myDsl_Input, myDsl_Commandes, myDsl_Output, myDsl_Nill, myDsl_ABin, myDsl_Affectation, myDsl_Variable, myDsl_Expression, myDsl_If, myDsl_While, myDsl_For, myDsl_ForEach, myDsl_Nop, myDsl_Condition, myDsl_ExprSimple, myDsl_Not, Condition, myDsl_AccSucc, myDsl_ElemSimple, myDsl_Lexpr, myDsl_COMPARATEUR, myDsl_OpConstructeur, myDsl_OpAccSucc},
    associations={commande7, commandes9, commande12, fonctions0, in_1, commandes3, out5, exprs45, nil47, variable49, abin52, variable14, elm15, cond17, cmdsIf19, cmdsElse22, cond25, cmdsWh27, cond30, cmdsFor32, elem35, ensemble37, cmdsFor40, cond43, expr87, accsucc54, elemSimple56, e158, lexpr61, lexpr63, e166, comp69, e271, op74, e176, e279, op82, expr84},
