...
class ptnet_Fill:
    ...
    def __init__(self, color: str, gradientcolor: str, gradientrotation: str, image: str, Fill52: "ptnet_AnnotationGraphics" = None, fill62: "ptnet_AnnotationGraphics" = None, fill: "ptnet_NodeGraphics" = None, Fill: "ptnet_NodeGraphics" = None):
        self.color = color
...
class ptnet_PnObject(ABC):
    ...
    def __init__(self, id: str, PnObject23: "ptnet_Name" = None, PnObject: "ptnet_Page" = None, containerNamePnObject: "ptnet_Name" = None, containerPnObject: set["ptnet_ToolInfo"] = None, objects: "ptnet_Page" = None, PnObject28: "ptnet_ToolInfo" = None):
        self.id = id
...
class ptnet_PetriNet:
    ...
    def __init__(self, id: str, type: str, containerNamePetriNet: "ptnet_Name" = None, containerPetriNet6: set["ptnet_ToolInfo"] = None, nets: "ptnet_PetriNetDoc" = None, PetriNet: "ptnet_PetriNetDoc" = None, containerPetriNet: set["ptnet_Page"] = None, PetriNet20: "ptnet_Name" = None, PetriNet10: "ptnet_Page" = None, PetriNet25: "ptnet_ToolInfo" = None):
        self.id = id
        self.type = type
...
class ptnet_PetriNetDoc:
    ...
    def __init__(self, xmlns: str, PetriNetDoc: "ptnet_PetriNet" = None, containerPetriNetDoc: set["ptnet_PetriNet"] = None):
        self.xmlns = xmlns
...
class ptnet_VariableValues:
    ...
    def __init__(self, values: float, ptnet_VariableValues157: "ptnet_Variable" = None, ptnet_VariableValues: "ptnet_Study" = None):
        self.values = values
...
class ptnet_Measure:
    ...
    def __init__(self, name: str, ptnet_Measure117: "ptnet_EvaluationType" = None, ptnet_Measure: "ptnet_EvaluationList" = None, ptnet_Measure114: "ptnet_ArithmeticExpression" = None):
        self.name = name
...
class ptnet_Line:
    ...
    def __init__(self, color: str, shape: str, width: str, style: str, Line55: "ptnet_AnnotationGraphics" = None, line: "ptnet_NodeGraphics" = None, line67: "ptnet_ArcGraphics" = None, line70: "ptnet_AnnotationGraphics" = None, Line: "ptnet_NodeGraphics" = None, Line76: "ptnet_ArcGraphics" = None):
        self.color = color
        self.shape = shape
        self.width = width
        self.style = style
