...
# Classes
ptnet_PTMarking = Class(name="ptnet_PTMarking")
Annotation = Class(name="Annotation")
ptnet_Name = Class(name="ptnet_Name")
ptnet_ToolInfo = Class(name="ptnet_ToolInfo")
PnObject = Class(name="PnObject")
ptnet_Place = Class(name="ptnet_Place")
ptnet_PTArcAnnotation = Class(name="ptnet_PTArcAnnotation")
ptnet_Arc = Class(name="ptnet_Arc")
ptnet_PetriNetDoc = Class(name="ptnet_PetriNetDoc")
ptnet_PetriNet = Class(name="ptnet_PetriNet")
ptnet_Page = Class(name="ptnet_Page")
ptnet_PnObject = Class(name="ptnet_PnObject", is_abstract=True)
ptnet_NodeGraphics = Class(name="ptnet_NodeGraphics")
Graphics = Class(name="Graphics")
ptnet_Position = Class(name="ptnet_Position")
ptnet_Dimension = Class(name="ptnet_Dimension")
ptnet_Fill = Class(name="ptnet_Fill")
ptnet_Label = Class(name="ptnet_Label", is_abstract=True)
ptnet_AnyObject = Class(name="ptnet_AnyObject", is_abstract=True)
ptnet_Coordinate = Class(name="ptnet_Coordinate", is_abstract=True)
Coordinate = Class(name="Coordinate")
ptnet_ArcGraphics = Class(name="ptnet_ArcGraphics")
ptnet_Line = Class(name="ptnet_Line")
ptnet_Node = Class(name="ptnet_Node", is_abstract=True)
ptnet_Graphics = Class(name="ptnet_Graphics", is_abstract=True)
ptnet_Offset = Class(name="ptnet_Offset")
ptnet_AnnotationGraphics = Class(name="ptnet_AnnotationGraphics")
ptnet_Font = Class(name="ptnet_Font")
ptnet_Annotation = Class(name="ptnet_Annotation", is_abstract=True)
PlaceNode = Class(name="PlaceNode")
TransitionNode = Class(name="TransitionNode")
ptnet_Transition = Class(name="ptnet_Transition")
ptnet_PlaceNode = Class(name="ptnet_PlaceNode", is_abstract=True)
Node = Class(name="Node")
ptnet_RefPlace = Class(name="ptnet_RefPlace")
ptnet_TransitionNode = Class(name="ptnet_TransitionNode", is_abstract=True)
ptnet_RefTransition = Class(name="ptnet_RefTransition")
Transition = Class(name="Transition")
ptnet_LogicalExpression = Class(name="ptnet_LogicalExpression", is_abstract=True)
ptnet_GSPNArc = Class(name="ptnet_GSPNArc")
Arc = Class(name="Arc")
ptnet_Attribute = Class(name="ptnet_Attribute", is_abstract=True)
Label = Class(name="Label")
ptnet_GSPNTransition = Class(name="ptnet_GSPNTransition")
ptnet_Uniform = Class(name="ptnet_Uniform")
ptnet_Gamma = Class(name="ptnet_Gamma")
ptnet_Weibull = Class(name="ptnet_Weibull")
ptnet_ArithmeticExpression = Class(name="ptnet_ArithmeticExpression", is_abstract=True)
ptnet_GSPNImmediateTransition = Class(name="ptnet_GSPNImmediateTransition")
GSPNTransition = Class(name="GSPNTransition")
ptnet_GSPNTimedTransition = Class(name="ptnet_GSPNTimedTransition")
ptnet_Distribution = Class(name="ptnet_Distribution", is_abstract=True)
ptnet_Deterministic = Class(name="ptnet_Deterministic")
Distribution = Class(name="Distribution")
ptnet_Exponential = Class(name="ptnet_Exponential")
ptnet_Gaussian = Class(name="ptnet_Gaussian")
ptnet_Expression = Class(name="ptnet_Expression", is_abstract=True)
ptnet_ValueExpression = Class(name="ptnet_ValueExpression")
ArithmeticExpression = Class(name="ArithmeticExpression")
ptnet_MarkingExpression = Class(name="ptnet_MarkingExpression")
Expression = Class(name="Expression")
ptnet_EvaluationList = Class(name="ptnet_EvaluationList")
ptnet_Study = Class(name="ptnet_Study")
ptnet_Measure = Class(name="ptnet_Measure")
ptnet_VariableValues = Class(name="ptnet_VariableValues")
ptnet_EvaluationType = Class(name="ptnet_EvaluationType", is_abstract=True)
ptnet_OpTrue = Class(name="ptnet_OpTrue")
LogicalExpression = Class(name="LogicalExpression")
ptnet_OpFalse = Class(name="ptnet_OpFalse")
ptnet_ComparisonOperator = Class(name="ptnet_ComparisonOperator", is_abstract=True)
ptnet_ArithmeticBinaryOperator = Class(name="ptnet_ArithmeticBinaryOperator", is_abstract=True)
ptnet_OpSum = Class(name="ptnet_OpSum")
ArithmeticBinaryOperator = Class(name="ArithmeticBinaryOperator")
ptnet_OpMinus = Class(name="ptnet_OpMinus")
ptnet_OpMultiply = Class(name="ptnet_OpMultiply")
ptnet_OpDivide = Class(name="ptnet_OpDivide")
ptnet_IfThenElse = Class(name="ptnet_IfThenElse")
ptnet_SteadyState = Class(name="ptnet_SteadyState")
EvaluationType = Class(name="EvaluationType")
ptnet_InstantOfTime = Class(name="ptnet_InstantOfTime")
ptnet_IntervalOfTime = Class(name="ptnet_IntervalOfTime")
ptnet_BooleanExpression = Class(name="ptnet_BooleanExpression")
ptnet_OpEqual = Class(name="ptnet_OpEqual")
ComparisonOperator = Class(name="ComparisonOperator")
ptnet_OpGreater = Class(name="ptnet_OpGreater")
ptnet_OpLess = Class(name="ptnet_OpLess")
ptnet_OpGreaterEqual = Class(name="ptnet_OpGreaterEqual")
ptnet_OpLessEqual = Class(name="ptnet_OpLessEqual")
ptnet_OpNot = Class(name="ptnet_OpNot")
ptnet_OpAnd = Class(name="ptnet_OpAnd")
BooleanExpression = Class(name="BooleanExpression")
ptnet_OpOr = Class(name="ptnet_OpOr")
ptnet_VariableExpression = Class(name="ptnet_VariableExpression")
ptnet_IntervalOfTimeAveraged = Class(name="ptnet_IntervalOfTimeAveraged")
ptnet_Variable = Class(name="ptnet_Variable")
...
ptnet_ToolInfo.attributes={ptnet_ToolInfo_version, ptnet_ToolInfo_tool, ptnet_ToolInfo_formattedXMLBuffer, ptnet_ToolInfo_toolInfoGrammarURI}
...
ptnet_Fill.attributes={ptnet_Fill_gradientcolor, ptnet_Fill_image, ptnet_Fill_color, ptnet_Fill_gradientrotation}
...
ptnet_Line.attributes={ptnet_Line_width, ptnet_Line_shape, ptnet_Line_style, ptnet_Line_color}
...
ptnet_Font.attributes={ptnet_Font_family, ptnet_Font_weight, ptnet_Font_style, ptnet_Font_rotation, ptnet_Font_decoration, ptnet_Font_size, ptnet_Font_align}
...
ptnet_Uniform.attributes={ptnet_Uniform_Upper, ptnet_Uniform_Lower}
...
ptnet_Weibull.attributes={ptnet_Weibull_Alpha, ptnet_Weibull_Beta}
...
ptnet_GSPNImmediateTransition.attributes={ptnet_GSPNImmediateTransition_Priority, ptnet_GSPNImmediateTransition_Weight}
...
domain_model = DomainModel(
    name="ptnet",
    types={ptnet_PTMarking, Annotation, ptnet_Name, ptnet_ToolInfo, PnObject, ptnet_Place, ptnet_PTArcAnnotation, ptnet_Arc, ptnet_PetriNetDoc, ptnet_PetriNet, ptnet_Page, ptnet_PnObject, ptnet_NodeGraphics, Graphics, ptnet_Position, ptnet_Dimension, ptnet_Fill, ptnet_Label, ptnet_AnyObject, ptnet_Coordinate, Coordinate, ptnet_ArcGraphics, ptnet_Line, ptnet_Node, ptnet_Graphics, ptnet_Offset, ptnet_AnnotationGraphics, ptnet_Font, ptnet_Annotation, PlaceNode, TransitionNode, ptnet_Transition, ptnet_PlaceNode, Node, ptnet_RefPlace, ptnet_TransitionNode, ptnet_RefTransition, Transition, ptnet_LogicalExpression, ptnet_GSPNArc, Arc, ptnet_Attribute, Label, ptnet_GSPNTransition, ptnet_Uniform, ptnet_Gamma, ptnet_Weibull, ptnet_ArithmeticExpression, ptnet_GSPNImmediateTransition, GSPNTransition, ptnet_GSPNTimedTransition, ptnet_Distribution, ptnet_Deterministic, Distribution, ptnet_Exponential, ptnet_Gaussian, ptnet_Expression, ptnet_ValueExpression, ArithmeticExpression, ptnet_MarkingExpression, Expression, ptnet_EvaluationList, ptnet_Study, ptnet_Measure, ptnet_VariableValues, ptnet_EvaluationType, ptnet_OpTrue, LogicalExpression, ptnet_OpFalse, ptnet_ComparisonOperator, ptnet_ArithmeticBinaryOperator, ptnet_OpSum, ArithmeticBinaryOperator, ptnet_OpMinus, ptnet_OpMultiply, ptnet_OpDivide, ptnet_IfThenElse, ptnet_SteadyState, EvaluationType, ptnet_InstantOfTime, ptnet_IntervalOfTime, ptnet_BooleanExpression, ptnet_OpEqual, ComparisonOperator, ptnet_OpGreater, ptnet_OpLess, ptnet_OpGreaterEqual, ptnet_OpLessEqual, ptnet_OpNot, ptnet_OpAnd, BooleanExpression, ptnet_OpOr, ptnet_VariableExpression, ptnet_IntervalOfTimeAveraged, ptnet_Variable, PNType, CSS2Color, Gradient, LineShape, FontAlign, FontDecoration, CSS2FontFamily, CSS2FontSize, CSS2FontStyle, CSS2FontWeight, GSPNTransitionType, GSPNArcType, LineStyle},
    associations={name4, toolspecifics5, containerPetriNetDoc7, containerPlace0, containerArc1, nets2, pages3, containerNamePetriNet19, containerNamePnObject21, objects8, containerPetriNet9, nodegraphics11, name13, toolspecifics15, containerPage17, position34, dimension35, fill36, containerPetriNet24, containerPnObject26, containerLabel29, toolInfoModel31, toolspecifics32, containerArcGraphics43, line37, containerNode39, containerPage40, containerPNodeGraphics44, containerAnnotationGraphics46, containerDNodeGraphics47, font56, offset49, fill50, line53, containerAnnotationGraphics61, containerAnnotation58, containerNodeGraphics59, containerNodeGraphics64, containerArcGraphics66, containerAnnotationGraphics69, source79, target81, arcgraphics83, inscription85, positions72, line74, containerArc77, InArcs87, OutArcs89, nodegraphics91, containerAnnotationGraphics93, initialMarking98, ref99, referencingPlaces95, referencingTransitions96, Guard105, ref100, annotationgraphics101, containerToolInfo103, MultiplicityFunction106, Distribution107, evaluationType116, place118, studies108, measures109, vars111, rewardFunction113, ifFalse129, expression1132, expression2134, expression1119, expression2121, condition124, ifTrue126, instant144, intervalBegin146, expression1137, expression2139, expression142, variable158, intervalEnd148, intervalBegin151, intervalEnd153, variable156},
    generalizations={gen_ptnet_PTMarking_Annotation, gen_ptnet_Page_PnObject, gen_ptnet_PTArcAnnotation_Annotation, gen_ptnet_Name_Annotation, gen_ptnet_NodeGraphics_Graphics, gen_ptnet_Position_Coordinate, gen_ptnet_AnnotationGraphics_Graphics, gen_ptnet_Offset_Coordinate, gen_ptnet_Dimension_Coordinate, gen_ptnet_ArcGraphics_Graphics, gen_ptnet_Arc_PnObject, gen_ptnet_Node_PnObject, gen_ptnet_Place_PlaceNode, gen_ptnet_RefTransition_TransitionNode, gen_ptnet_Transition_TransitionNode, gen_ptnet_PlaceNode_Node, gen_ptnet_TransitionNode_Node, gen_ptnet_GSPNTransition_Transition, gen_ptnet_GSPNArc_Arc, gen_ptnet_RefPlace_PlaceNode, gen_ptnet_Attribute_Label, gen_ptnet_Annotation_Label, gen_ptnet_Uniform_Distribution, gen_ptnet_Gamma_Distribution, gen_ptnet_Weibull_Distribution, gen_ptnet_GSPNImmediateTransition_GSPNTransition, gen_ptnet_GSPNTimedTransition_GSPNTransition, gen_ptnet_Deterministic_Distribution, gen_ptnet_Exponential_Distribution, gen_ptnet_Gaussian_Distribution, gen_ptnet_ValueExpression_ArithmeticExpression, gen_ptnet_MarkingExpression_ArithmeticExpression, gen_ptnet_ArithmeticExpression_Expression, gen_ptnet_LogicalExpression_Expression, gen_ptnet_OpTrue_LogicalExpression, gen_ptnet_OpFalse_LogicalExpression, gen_ptnet_ComparisonOperator_LogicalExpression, gen_ptnet_ArithmeticBinaryOperator_ArithmeticExpression, gen_ptnet_OpSum_ArithmeticBinaryOperator, gen_ptnet_OpMinus_ArithmeticBinaryOperator, gen_ptnet_OpMultiply_ArithmeticBinaryOperator, gen_ptnet_OpDivide_ArithmeticBinaryOperator, gen_ptnet_IfThenElse_ArithmeticExpression, gen_ptnet_SteadyState_EvaluationType, gen_ptnet_InstantOfTime_EvaluationType, gen_ptnet_IntervalOfTime_EvaluationType, gen_ptnet_BooleanExpression_LogicalExpression, gen_ptnet_OpEqual_ComparisonOperator, gen_ptnet_OpGreater_ComparisonOperator, gen_ptnet_OpLess_ComparisonOperator, gen_ptnet_OpGreaterEqual_ComparisonOperator, gen_ptnet_OpLessEqual_ComparisonOperator, gen_ptnet_OpNot_LogicalExpression, gen_ptnet_OpAnd_BooleanExpression, gen_ptnet_OpOr_BooleanExpression, gen_ptnet_VariableExpression_ArithmeticExpression, gen_ptnet_IntervalOfTimeAveraged_EvaluationType},
    metadata=None
)
