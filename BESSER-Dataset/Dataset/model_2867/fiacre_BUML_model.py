...
# Classes
fiacre_Program = Class(name="fiacre_Program")
fiacre_LocalVariable = Class(name="fiacre_LocalVariable")
fiacre_ParamPortDecl = Class(name="fiacre_ParamPortDecl")
fiacre_LocalPortDecl = Class(name="fiacre_LocalPortDecl")
fiacre_Statement = Class(name="fiacre_Statement", is_abstract=True)
fiacre_TypeDecl = Class(name="fiacre_TypeDecl")
fiacre_Type = Class(name="fiacre_Type", is_abstract=True)
fiacre_ChannelDecl = Class(name="fiacre_ChannelDecl")
fiacre_Channel = Class(name="fiacre_Channel", is_abstract=True)
fiacre_ComponentDecl = Class(name="fiacre_ComponentDecl")
NodeDecl = Class(name="NodeDecl")
fiacre_Composition = Class(name="fiacre_Composition", is_abstract=True)
fiacre_Priority = Class(name="fiacre_Priority")
fiacre_ProcessDecl = Class(name="fiacre_ProcessDecl")
fiacre_State = Class(name="fiacre_State")
fiacre_Transition = Class(name="fiacre_Transition")
fiacre_PortDecl = Class(name="fiacre_PortDecl", is_abstract=True)
Variable = Class(name="Variable")
fiacre_Declaration = Class(name="fiacre_Declaration", is_abstract=True)
fiacre_NodeDecl = Class(name="fiacre_NodeDecl", is_abstract=True)
Declaration = Class(name="Declaration")
fiacre_ArgumentVariable = Class(name="fiacre_ArgumentVariable")
fiacre_Arg = Class(name="fiacre_Arg", is_abstract=True)
Arg = Class(name="Arg")
fiacre_NullStmt = Class(name="fiacre_NullStmt")
Statement = Class(name="Statement")
fiacre_Assignment = Class(name="fiacre_Assignment", is_abstract=True)
fiacre_Communication = Class(name="fiacre_Communication", is_abstract=True)
fiacre_WhileStmt = Class(name="fiacre_WhileStmt")
fiacre_IfStmt = Class(name="fiacre_IfStmt")
fiacre_Exp = Class(name="fiacre_Exp", is_abstract=True)
fiacre_Par = Class(name="fiacre_Par")
Composition = Class(name="Composition")
fiacre_InterfacedComp = Class(name="fiacre_InterfacedComp")
fiacre_Instance = Class(name="fiacre_Instance")
fiacre_DeterministicAssignment = Class(name="fiacre_DeterministicAssignment")
Assignment = Class(name="Assignment")
fiacre_SingleAssignment = Class(name="fiacre_SingleAssignment")
fiacre_NonDeterministicAssignment = Class(name="fiacre_NonDeterministicAssignment")
fiacre_Pattern = Class(name="fiacre_Pattern", is_abstract=True)
fiacre_UnExp = Class(name="fiacre_UnExp")
Exp = Class(name="Exp")
fiacre_BinExp = Class(name="fiacre_BinExp")
fiacre_Select = Class(name="fiacre_Select")
fiacre_To = Class(name="fiacre_To")
fiacre_Wait = Class(name="fiacre_Wait")
fiacre_MinBound = Class(name="fiacre_MinBound", is_abstract=True)
fiacre_MaxBound = Class(name="fiacre_MaxBound", is_abstract=True)
fiacre_Variable = Class(name="fiacre_Variable", is_abstract=True)
fiacre_ArrayElem = Class(name="fiacre_ArrayElem")
fiacre_RecordElem = Class(name="fiacre_RecordElem")
fiacre_InlineQueue = Class(name="fiacre_InlineQueue")
InlineCollection = Class(name="InlineCollection")
fiacre_BasicType = Class(name="fiacre_BasicType", is_abstract=True)
Type = Class(name="Type")
fiacre_BoolType = Class(name="fiacre_BoolType")
BasicType = Class(name="BasicType")
fiacre_NatType = Class(name="fiacre_NatType")
fiacre_IntType = Class(name="fiacre_IntType")
fiacre_Interval = Class(name="fiacre_Interval")
fiacre_Record = Class(name="fiacre_Record")
fiacre_Field = Class(name="fiacre_Field")
LabeledType = Class(name="LabeledType")
fiacre_Array = Class(name="fiacre_Array")
fiacre_Queue = Class(name="fiacre_Queue")
fiacre_NatLiteral = Class(name="fiacre_NatLiteral")
Literal = Class(name="Literal")
fiacre_BoolLiteral = Class(name="fiacre_BoolLiteral")
fiacre_VarRef = Class(name="fiacre_VarRef")
Pattern = Class(name="Pattern")
fiacre_InlineArray = Class(name="fiacre_InlineArray")
fiacre_InlineRecord = Class(name="fiacre_InlineRecord")
fiacre_ValuedField = Class(name="fiacre_ValuedField")
fiacre_Synchronization = Class(name="fiacre_Synchronization")
Communication = Class(name="Communication")
fiacre_Reception = Class(name="fiacre_Reception")
fiacre_Emission = Class(name="fiacre_Emission")
fiacre_Seq = Class(name="fiacre_Seq")
PortDecl = Class(name="PortDecl")
fiacre_TypeId = Class(name="fiacre_TypeId")
fiacre_Profile = Class(name="fiacre_Profile")
Channel = Class(name="Channel")
fiacre_ConstrPattern = Class(name="fiacre_ConstrPattern")
fiacre_ArrayPattern = Class(name="fiacre_ArrayPattern")
fiacre_FieldPattern = Class(name="fiacre_FieldPattern")
fiacre_AnyPattern = Class(name="fiacre_AnyPattern")
fiacre_Literal = Class(name="fiacre_Literal", is_abstract=True)
fiacre_CaseStmt = Class(name="fiacre_CaseStmt")
fiacre_Rule = Class(name="fiacre_Rule")
fiacre_RefArg = Class(name="fiacre_RefArg")
fiacre_ConstantDecl = Class(name="fiacre_ConstantDecl")
fiacre_ConstrExp = Class(name="fiacre_ConstrExp")
fiacre_Union = Class(name="fiacre_Union")
fiacre_Constr = Class(name="fiacre_Constr")
fiacre_LabeledType = Class(name="fiacre_LabeledType", is_abstract=True)
fiacre_FiniteBound = Class(name="fiacre_FiniteBound")
MinBound = Class(name="MinBound")
MaxBound = Class(name="MaxBound")
fiacre_InfiniteBound = Class(name="fiacre_InfiniteBound")
fiacre_CondExp = Class(name="fiacre_CondExp")
fiacre_Foreach = Class(name="fiacre_Foreach")
fiacre_ConstantRef = Class(name="fiacre_ConstantRef")
fiacre_InlineCollection = Class(name="fiacre_InlineCollection", is_abstract=True)
...
fiacre_PortDecl_in_: Property = Property(name="in_", type=BooleanType)
...
fiacre_PortDecl.attributes={fiacre_PortDecl_in_, fiacre_PortDecl_out, fiacre_PortDecl_name}
...
fiacre_ArgumentVariable.attributes={fiacre_ArgumentVariable_read, fiacre_ArgumentVariable_ref, fiacre_ArgumentVariable_write}
...
fiacre_FiniteBound.attributes={fiacre_FiniteBound_strict, fiacre_FiniteBound_val}
...
is_13: BinaryAssociation = BinaryAssociation(
    name="is_13",
    ends={
...
is_14: BinaryAssociation = BinaryAssociation(
    name="is_14",
    ends={
...
else_57: BinaryAssociation = BinaryAssociation(
    name="else_57",
    ends={
...
domain_model = DomainModel(
    name="fiacre",
    types={fiacre_Program, fiacre_LocalVariable, fiacre_ParamPortDecl, fiacre_LocalPortDecl, fiacre_Statement, fiacre_TypeDecl, fiacre_Type, fiacre_ChannelDecl, fiacre_Channel, fiacre_ComponentDecl, NodeDecl, fiacre_Composition, fiacre_Priority, fiacre_ProcessDecl, fiacre_State, fiacre_Transition, fiacre_PortDecl, Variable, fiacre_Declaration, fiacre_NodeDecl, Declaration, fiacre_ArgumentVariable, fiacre_Arg, Arg, fiacre_NullStmt, Statement, fiacre_Assignment, fiacre_Communication, fiacre_WhileStmt, fiacre_IfStmt, fiacre_Exp, fiacre_Par, Composition, fiacre_InterfacedComp, fiacre_Instance, fiacre_DeterministicAssignment, Assignment, fiacre_SingleAssignment, fiacre_NonDeterministicAssignment, fiacre_Pattern, fiacre_UnExp, Exp, fiacre_BinExp, fiacre_Select, fiacre_To, fiacre_Wait, fiacre_MinBound, fiacre_MaxBound, fiacre_Variable, fiacre_ArrayElem, fiacre_RecordElem, fiacre_InlineQueue, InlineCollection, fiacre_BasicType, Type, fiacre_BoolType, BasicType, fiacre_NatType, fiacre_IntType, fiacre_Interval, fiacre_Record, fiacre_Field, LabeledType, fiacre_Array, fiacre_Queue, fiacre_NatLiteral, Literal, fiacre_BoolLiteral, fiacre_VarRef, Pattern, fiacre_InlineArray, fiacre_InlineRecord, fiacre_ValuedField, fiacre_Synchronization, Communication, fiacre_Reception, fiacre_Emission, fiacre_Seq, PortDecl, fiacre_TypeId, fiacre_Profile, Channel, fiacre_ConstrPattern, fiacre_ArrayPattern, fiacre_FieldPattern, fiacre_AnyPattern, fiacre_Literal, fiacre_CaseStmt, fiacre_Rule, fiacre_RefArg, fiacre_ConstantDecl, fiacre_ConstrExp, fiacre_Union, fiacre_Constr, fiacre_LabeledType, fiacre_FiniteBound, MinBound, MaxBound, fiacre_InfiniteBound, fiacre_CondExp, fiacre_Foreach, fiacre_ConstantRef, fiacre_InlineCollection, UnOp, BinOp},
    associations={var5, port7, localPort9, initAction11, is_13, is_14, body15, priority16, state18, transition19, channel21, declaration0, root1, arg3, type26, arg28, port30, composition33, syncPort36, from_39, action42, port45, condition47, body49, condition52, then54, else_57, initializer23, arg25, assignment67, lhs68, condition69, lhs72, rhs75, exp78, right80, left82, statement60, dest62, mini64, maxi65, decl85, array86, index88, record91, mini93, maxi95, field98, size99, type101, value113, value114, pattern117, where119, arg122, statement124, mini126, maxi129, type132, inf135, type104, size106, decl109, type111, arg144, index146, array148, record151, rule153, exp154, lhs157, action160, ref163, type165, value167, sup138, arg141, constr143, elem172, type174, cond176, iff178, ift181, body184, decl170, iter186},
    generalizations={gen_fiacre_TypeDecl_Declaration, gen_fiacre_ChannelDecl_Declaration, gen_fiacre_ComponentDecl_NodeDecl, gen_fiacre_ProcessDecl_NodeDecl, gen_fiacre_ArgumentVariable_Variable, gen_fiacre_NodeDecl_Declaration, gen_fiacre_Exp_Arg, gen_fiacre_NullStmt_Statement, gen_fiacre_Assignment_Statement, gen_fiacre_Communication_Statement, gen_fiacre_WhileStmt_Statement, gen_fiacre_IfStmt_Statement, gen_fiacre_LocalVariable_Variable, gen_fiacre_Par_Composition, gen_fiacre_Instance_Composition, gen_fiacre_DeterministicAssignment_Assignment, gen_fiacre_NonDeterministicAssignment_Assignment, gen_fiacre_UnExp_Exp, gen_fiacre_BinExp_Exp, gen_fiacre_Select_Statement, gen_fiacre_To_Statement, gen_fiacre_Wait_Statement, gen_fiacre_ArrayElem_Exp, gen_fiacre_RecordElem_Exp, gen_fiacre_InlineQueue_InlineCollection, gen_fiacre_BasicType_Type, gen_fiacre_BoolType_BasicType, gen_fiacre_NatType_BasicType, gen_fiacre_IntType_BasicType, gen_fiacre_Interval_Type, gen_fiacre_Record_Type, gen_fiacre_Field_LabeledType, gen_fiacre_Array_Type, gen_fiacre_Queue_Type, gen_fiacre_NatLiteral_Literal, gen_fiacre_BoolLiteral_Literal, gen_fiacre_VarRef_Pattern, gen_fiacre_VarRef_Exp, gen_fiacre_InlineArray_InlineCollection, gen_fiacre_InlineRecord_Exp, gen_fiacre_Synchronization_Communication, gen_fiacre_Reception_Communication, gen_fiacre_Emission_Communication, gen_fiacre_Seq_Statement, gen_fiacre_LocalPortDecl_PortDecl, gen_fiacre_ParamPortDecl_PortDecl, gen_fiacre_TypeId_Type, gen_fiacre_Profile_Channel, gen_fiacre_ConstrPattern_Pattern, gen_fiacre_ArrayPattern_Pattern, gen_fiacre_FieldPattern_Pattern, gen_fiacre_AnyPattern_Pattern, gen_fiacre_Literal_Exp, gen_fiacre_Literal_Pattern, gen_fiacre_CaseStmt_Statement, gen_fiacre_RefArg_Arg, gen_fiacre_ConstantDecl_Declaration, gen_fiacre_ConstrExp_Exp, gen_fiacre_Union_Type, gen_fiacre_Constr_LabeledType, gen_fiacre_FiniteBound_MinBound, gen_fiacre_FiniteBound_MaxBound, gen_fiacre_InfiniteBound_MaxBound, gen_fiacre_CondExp_Exp, gen_fiacre_Foreach_Statement, gen_fiacre_ConstantRef_Exp, gen_fiacre_ConstantRef_Pattern, gen_fiacre_InlineCollection_Exp},
    metadata=None
)
