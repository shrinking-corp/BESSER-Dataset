...
def test_hyp_hexample_1_rhs_y_is_not_abstract():
    assert not inspect.isabstract(hExample_1_RHS_Y)


def test_hyp_hexample_1_rhs_y_constructor_exists():
    assert callable(hExample_1_RHS_Y.__init__)


def test_hyp_hexample_1_rhs_y_constructor_args():
...
def test_hyp_hexample_1_rhs_x_is_not_abstract():
    assert not inspect.isabstract(hExample_1_RHS_X)


def test_hyp_hexample_1_rhs_x_constructor_exists():
    assert callable(hExample_1_RHS_X.__init__)


def test_hyp_hexample_1_rhs_x_constructor_args():
...
def test_hyp_hexample_1_rhs_y_label_setter(instance):
