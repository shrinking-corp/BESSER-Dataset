...
# Classes
bookstore_Model = Class(name="bookstore_Model")
bookstore_Ent = Class(name="bookstore_Ent")
bookstore_Person = Class(name="bookstore_Person")
Ent = Class(name="Ent")
bookstore_Dvd = Class(name="bookstore_Dvd")
bookstore_Cd = Class(name="bookstore_Cd")
bookstore_Book = Class(name="bookstore_Book")
bookstore_Magazine = Class(name="bookstore_Magazine")
...
bookstore_Book.attributes={bookstore_Book_title, bookstore_Book_pages}
...
domain_model = DomainModel(
    name="bookstore",
    types={bookstore_Model, bookstore_Ent, bookstore_Person, Ent, bookstore_Dvd, bookstore_Cd, bookstore_Book, bookstore_Magazine},
    associations={ent0, actor10, book12, writer15, sequel19, artiesten21, manWife2, sequel4, writer5, writer8},
    generalizations={gen_bookstore_Person_Ent, gen_bookstore_Dvd_Ent, gen_bookstore_Cd_Ent, gen_bookstore_Book_Ent, gen_bookstore_Magazine_Ent},
    metadata=None
)
