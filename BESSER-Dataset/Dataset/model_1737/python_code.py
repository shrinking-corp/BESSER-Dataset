...
class bookstore_Book(Ent):
    ...
    def __init__(self, title: str, pages: int, bookstore_Book14: "bookstore_Dvd" = None, bookstore_Book: "bookstore_Book" = None, bookstore_Book3: "bookstore_Book" = None, bookstore_Book6: "bookstore_Person" = None):
        self.title = title
        self.pages = pages
...
class bookstore_Person(Ent):
    ...
    def __init__(self, voornaam: str, achternaam: str, bookstore_Person11: "bookstore_Dvd" = None, bookstore_Person17: "bookstore_Dvd" = None, bookstore_Person22: "bookstore_Cd" = None, bookstore_Person: "bookstore_Person" = None, bookstore_Person1: "bookstore_Person" = None, bookstore_Person7: "bookstore_Book" = None, bookstore_Person9: "bookstore_Magazine" = None):
