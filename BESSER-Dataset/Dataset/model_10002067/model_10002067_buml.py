...
ModelTraint.attributes={ModelTraint_indiceWagonCourant, ModelTraint_listeWagon__, ModelTraint_indiceJoueurCourant, ModelTraint_cellule____, ModelTraint_joueurs__}
...
Wagon_isInWagon: Property = Property(name="isInWagon", type=BooleanType)
Wagon.attributes={Wagon_isInWagon, Wagon_numeroWagon, Wagon_modele}

# Joueur class attributes and methods
Joueur_model: Property = Property(name="model", type=ModelTraint)
Joueur_wagon: Property = Property(name="wagon", type=Wagon)
...
Joueur.attributes={Joueur_x_y, Joueur_wagon, Joueur_nomJoueur, Joueur_model, Joueur_a_b}
...
Controleur.attributes={Controleur_vue, Controleur_modeletrain}
...
domain_model = DomainModel(
    name="_mcZiIGOwEem8rNlhyjeRRw",
    types={ModelTraint, Observable, Wagon, Joueur, Cellule, Obsever_Interface, Vue, Controleur},
