...
class ModelTraint:
    ...
    def __init__(self, cellule____: Cellule, joueurs__: Joueur, indiceWagonCourant: int, indiceJoueurCourant: int, listeWagon__: Wagon, cellule1: "Cellule" = None, joueurs2: set["Joueur"] = None, wagons4: set["Wagon"] = None):
