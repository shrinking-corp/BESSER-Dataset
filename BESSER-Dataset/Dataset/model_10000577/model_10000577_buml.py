...
GameView.attributes={GameView_dealButton, GameView_showStrategy, GameView_bet, GameView_splitButton, GameView_doubleButton, GameView_standButton, GameView_hitButton}
...
PlayerView.attributes={PlayerView_player, PlayerView_busted, PlayerView_moneyBox, PlayerView_cardTotal, PlayerView_cardLabels, PlayerView_status}
...
BlackjackGame.attributes={BlackjackGame_bet, BlackjackGame_deck, BlackjackGame_dealer, BlackjackGame_player}
...
Card.attributes={Card_rank, Card_Count, Card_valueSoft, Card_suit, Card_valueHard, Card_name, Card_avatar}
...
domain_model = DomainModel(
    name="_4742df23_d930_438b_aea8_9a8ec2fcec22",
    ...
    associations={LoginView_Profile2, GameLauncher_LoginView, Profile_Blackjack, Blackjack_GameView, Blackjack_Strategy, PlayerView_GameView, Player_Blackjack, Dealer_Blackjack, Blackjack_Deck, BasePlayer_PlayerView, Dealer_Hand, Player_Hand, Hand_Card, Deck_Card, Player_Profile},
    generalizations={},
    metadata=None
)
