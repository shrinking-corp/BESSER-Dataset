...
# Classes
arithmetics_Module = Class(name="arithmetics_Module")
arithmetics_Import = Class(name="arithmetics_Import")
arithmetics_DeclaredParameter = Class(name="arithmetics_DeclaredParameter")
arithmetics_Expression = Class(name="arithmetics_Expression")
arithmetics_AbstractDefinition = Class(name="arithmetics_AbstractDefinition")
arithmetics_Evaluation = Class(name="arithmetics_Evaluation")
arithmetics_Plus = Class(name="arithmetics_Plus")
Expression = Class(name="Expression")
arithmetics_Minus = Class(name="arithmetics_Minus")
arithmetics_Multi = Class(name="arithmetics_Multi")
arithmetics_Div = Class(name="arithmetics_Div")
arithmetics_Statement = Class(name="arithmetics_Statement")
arithmetics_Definition = Class(name="arithmetics_Definition")
Statement = Class(name="Statement")
AbstractDefinition = Class(name="AbstractDefinition")
arithmetics_NumberLiteral = Class(name="arithmetics_NumberLiteral")
arithmetics_FunctionCall = Class(name="arithmetics_FunctionCall")
...
domain_model = DomainModel(
    name="arithmetics",
    types={arithmetics_Module, arithmetics_Import, arithmetics_DeclaredParameter, arithmetics_Expression, arithmetics_AbstractDefinition, arithmetics_Evaluation, arithmetics_Plus, Expression, arithmetics_Minus, arithmetics_Multi, arithmetics_Div, arithmetics_Statement, arithmetics_Definition, Statement, AbstractDefinition, arithmetics_NumberLiteral, arithmetics_FunctionCall},
    associations={args3, expr4, expression6, left8, right10, left13, right15, left18, right20, left23, imports0, statements1, right25, func28, args29},
    generalizations={gen_arithmetics_DeclaredParameter_AbstractDefinition, gen_arithmetics_Evaluation_Statement, gen_arithmetics_Plus_Expression, gen_arithmetics_Minus_Expression, gen_arithmetics_Multi_Expression, gen_arithmetics_Div_Expression, gen_arithmetics_Definition_Statement, gen_arithmetics_Definition_AbstractDefinition, gen_arithmetics_NumberLiteral_Expression, gen_arithmetics_FunctionCall_Expression},
    metadata=None
)
