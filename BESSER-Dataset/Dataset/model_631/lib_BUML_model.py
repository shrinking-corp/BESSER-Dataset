...
# Classes
library_AbstractPerson = Class(name="library_AbstractPerson", is_abstract=True)
library_Loan = Class(name="library_Loan")
AbstractPerson = Class(name="AbstractPerson")
library_UoD = Class(name="library_UoD")
...
domain_model = DomainModel(
    name="library",
    types={library_AbstractPerson, library_Loan, AbstractPerson, library_UoD, library_Library, library_Person, library_Author, library_Book},
    associations={author5, books7, loans10, borrower12, book15, allLibraries0, allPersons1, allAuthors3},
