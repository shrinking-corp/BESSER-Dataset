...
class dsl_State:
    ...
    def __init__(self, name: str, dsl_State41: "dsl_Action" = None, dsl_State19: "dsl_Trigger" = None, dsl_State: "dsl_Resource" = None, dsl_State110: "dsl_State_Object" = None):
        self.name = name
...
class dsl_AppMetaData:
    ...
    def __init__(self, appID: str, dsl_AppMetaData5: "dsl_Specification" = None, dsl_AppMetaData: "dsl_RunTimeModel" = None):
        self.appID = appID
