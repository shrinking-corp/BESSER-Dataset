...
domain_model = DomainModel(
    name="dsl",
    types={dsl_RunTimeModel, dsl_EnvironmentMetaData, dsl_AppMetaData, dsl_State, dsl_Resource, dsl_Element, dsl_Action, dsl_Specification, dsl_Trigger, dsl_IfDoSpec, dsl_ElseIfDoSpec, dsl_ElseDoSpec, dsl_EqualElement, dsl_LargerElement, dsl_LargerEqualElement, dsl_SmallerElement, dsl_OrElement, Element, dsl_AndElement, dsl_DiffElement, dsl_MinusElement, dsl_MultiplicationElement, dsl_DivisionElement, dsl_ModuloElement, dsl_SmallerEqualElement, dsl_PlusElement, dsl_Number_Object, dsl_Boolean_Object, dsl_Resource_Object, dsl_State_Object, dsl_NegateElement},
    associations={envData0, appData1, resource14, state17, condition20, action22, condition24, action27, action30, resources33, resource36, states3, state39, specification4, trigger6, ifdo8, elseIfDo10, elseDo12, right54, left57, right59, left62, right64, left67, right69, left42, right44, left47, right49, left52, left87, right89, left92, right94, left97, right99, left102, left72, right74, left77, right79, left82, right84, right104, value107, value109, exp111},
    generalizations={gen_dsl_EqualElement_Element, gen_dsl_LargerElement_Element, gen_dsl_LargerEqualElement_Element, gen_dsl_SmallerElement_Element, gen_dsl_OrElement_Element, gen_dsl_AndElement_Element, gen_dsl_DiffElement_Element, gen_dsl_MinusElement_Element, gen_dsl_MultiplicationElement_Element, gen_dsl_DivisionElement_Element, gen_dsl_ModuloElement_Element, gen_dsl_SmallerEqualElement_Element, gen_dsl_PlusElement_Element, gen_dsl_Number_Object_Element, gen_dsl_Boolean_Object_Element, gen_dsl_Resource_Object_Element, gen_dsl_State_Object_Element, gen_dsl_NegateElement_Element},
    metadata=None
)
