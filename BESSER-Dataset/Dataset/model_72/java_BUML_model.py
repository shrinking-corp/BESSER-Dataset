...
java_Manifest = Class(name="java_Manifest")
...
java_BlockComment = Class(name="java_BlockComment")
...
java_Javadoc = Class(name="java_Javadoc")
...
java_LineComment = Class(name="java_LineComment")
java_ManifestAttribute = Class(name="java_ManifestAttribute")
java_ManifestEntry = Class(name="java_ManifestEntry")
...
java_PackageAccess = Class(name="java_PackageAccess")
...
java_TextElement = Class(name="java_TextElement")
...
java_UnresolvedAnnotationDeclaration = Class(name="java_UnresolvedAnnotationDeclaration")
AnnotationTypeDeclaration = Class(name="AnnotationTypeDeclaration")
UnresolvedItem = Class(name="UnresolvedItem")
java_UnresolvedAnnotationTypeMemberDeclaration = Class(name="java_UnresolvedAnnotationTypeMemberDeclaration")
AnnotationTypeMemberDeclaration = Class(name="AnnotationTypeMemberDeclaration")
java_UnresolvedClassDeclaration = Class(name="java_UnresolvedClassDeclaration")
ClassDeclaration = Class(name="ClassDeclaration")
java_UnresolvedEnumDeclaration = Class(name="java_UnresolvedEnumDeclaration")
EnumDeclaration = Class(name="EnumDeclaration")
java_UnresolvedInterfaceDeclaration = Class(name="java_UnresolvedInterfaceDeclaration")
InterfaceDeclaration = Class(name="InterfaceDeclaration")
java_UnresolvedLabeledStatement = Class(name="java_UnresolvedLabeledStatement")
LabeledStatement = Class(name="LabeledStatement")
java_UnresolvedMethodDeclaration = Class(name="java_UnresolvedMethodDeclaration")
MethodDeclaration = Class(name="MethodDeclaration")
java_UnresolvedSingleVariableDeclaration = Class(name="java_UnresolvedSingleVariableDeclaration")
SingleVariableDeclaration = Class(name="SingleVariableDeclaration")
java_WildCardType = Class(name="java_WildCardType")
java_UnresolvedType = Class(name="java_UnresolvedType")
java_UnresolvedTypeDeclaration = Class(name="java_UnresolvedTypeDeclaration")
java_UnresolvedVariableDeclarationFragment = Class(name="java_UnresolvedVariableDeclarationFragment")
...
java_Modifier.attributes={java_Modifier_transient, java_Modifier_visibility, java_Modifier_volatile, java_Modifier_inheritance, java_Modifier_static, java_Modifier_native, java_Modifier_strictfp, java_Modifier_synchronized}
...
domain_model = DomainModel(
    name="java",
    types={ASTNode, java_AbstractMethodDeclaration, BodyDeclaration, java_Block, java_SingleVariableDeclaration, java_TypeAccess, java_TypeParameter, java_MethodRef, java_AbstractMethodInvocation, java_AbstractVariablesContainer, java_VariableDeclarationFragment, java_Annotation, java_AnnotationMemberValuePair, java_Archive, NamedElement, java_Expression, java_ClassFile, java_Manifest, java_AssertStatement, Statement, java_AbstractTypeDeclaration, Type, java_BodyDeclaration, java_Comment, java_ASTNode, java_Package, java_AbstractTypeQualifiedExpression, Expression, java_AnnotationTypeMemberDeclaration, java_ArrayLengthAccess, java_AnnotationTypeDeclaration, AbstractTypeDeclaration, java_AnonymousClassDeclaration, java_ClassInstanceCreation, java_ArrayAccess, java_ArrayCreation, java_ArrayInitializer, java_CompilationUnit, java_Modifier, java_BooleanLiteral, java_ArrayType, java_Assignment, AbstractMethodInvocation, java_BlockComment, Comment, java_Statement, java_BreakStatement, java_LabeledStatement, java_CastExpression, java_CatchClause, java_CharacterLiteral, java_ConstructorDeclaration, AbstractMethodDeclaration, java_ConditionalExpression, java_ConstructorInvocation, java_ClassDeclaration, TypeDeclaration, java_EnumConstantDeclaration, VariableDeclaration, java_EnumDeclaration, java_ExpressionStatement, java_ImportDeclaration, java_ContinueStatement, java_DoStatement, java_EmptyStatement, java_EnhancedForStatement, java_IfStatement, java_NamedElement, java_InfixExpression, java_FieldAccess, java_SingleVariableAccess, java_FieldDeclaration, AbstractVariablesContainer, java_ForStatement, java_Initializer, java_InstanceofExpression, java_InterfaceDeclaration, java_Javadoc, java_MemberRef, java_MethodDeclaration, java_TagElement, java_LineComment, java_ManifestAttribute, java_ManifestEntry, java_Model, java_Type, java_UnresolvedItem, java_MethodInvocation, java_MethodRefParameter, java_VariableDeclarationStatement, java_VariableDeclarationExpression, java_NamespaceAccess, NamespaceAccess, java_ParameterizedType, java_ParenthesizedExpression, java_NumberLiteral, java_NullLiteral, java_PackageAccess, java_PrimitiveTypeBoolean, PrimitiveType, java_PrimitiveTypeByte, java_PrimitiveTypeChar, java_PrimitiveTypeDouble, java_PrimitiveTypeShort, java_PrimitiveTypeFloat, java_PrimitiveTypeInt, java_PrimitiveTypeLong, java_PrimitiveTypeVoid, java_ReturnStatement, java_PostfixExpression, java_PrefixExpression, java_PrimitiveType, java_StringLiteral, java_SuperConstructorInvocation, java_SuperFieldAccess, AbstractTypeQualifiedExpression, java_SuperMethodInvocation, java_SwitchCase, java_VariableDeclaration, java_TextElement, java_ThisExpression, java_ThrowStatement, java_TryStatement, java_SwitchStatement, java_SynchronizedStatement, java_TypeDeclarationStatement, java_TypeLiteral, java_UnresolvedItemAccess, java_TypeDeclaration, java_UnresolvedAnnotationDeclaration, AnnotationTypeDeclaration, UnresolvedItem, java_UnresolvedAnnotationTypeMemberDeclaration, AnnotationTypeMemberDeclaration, java_UnresolvedClassDeclaration, ClassDeclaration, java_UnresolvedEnumDeclaration, EnumDeclaration, java_UnresolvedInterfaceDeclaration, InterfaceDeclaration, java_UnresolvedLabeledStatement, LabeledStatement, java_UnresolvedMethodDeclaration, MethodDeclaration, java_UnresolvedSingleVariableDeclaration, SingleVariableDeclaration, java_WildCardType, java_UnresolvedType, java_UnresolvedTypeDeclaration, java_UnresolvedVariableDeclarationFragment, VariableDeclarationFragment, java_WhileStatement, AssignmentKind, InheritanceKind, InfixExpressionKind, PostfixExpressionKind, PrefixExpressionKind, VisibilityKind},
    associations={body0, parameters1, thrownExceptions2, typeParameters4, usagesInDocComments6, usages7, qualifier23, type25, fragments27, type28, method9, values30, arguments10, classFiles32, manifest33, typeArguments11, message35, bodyDeclarations14, expression37, commentsBeforeBody15, commentsAfterBody16, package19, superInterfaces20, member47, expressions73, value49, array76, default52, type54, usages57, bodyDeclarations58, classInstanceCreation60, array61, index63, dimensions66, comments40, initializer68, originalCompilationUnit42, type70, originalClassFile44, abstractTypeDeclaration85, annotations86, anonymousClassDeclarationOwner88, modifier90, elementType78, leftHandSide80, rightHandSide82, package109, anonymousClassDeclaration111, expression113, statements91, label93, expression94, type96, exception99, body101, type103, attachedSource106, type115, elseExpression118, expression120, thenExpression123, superClass126, parameter151, anonymousClassDeclaration153, arguments154, enumConstants157, commentList128, imports131, package133, types136, label139, expression141, body143, body146, expression148, expression176, thenStatement178, elseStatement181, importedElement184, rightOperand185, expression159, field161, expression162, expression165, updaters167, initializers170, body173, body193, rightOperand195, leftOperand197, leftOperand187, extendedOperands190, attributes210, member213, qualifier214, returnType217, redefinedMethodDeclaration220, redefinitions222, tags200, body201, usagesInBreakStatements203, usagesInContinueStatements204, mainAttributes206, entryAttributes208, type232, ownedElements235, orphanTypes237, unresolvedItems238, expression224, method226, qualifier228, parameters230, bodyDeclaration249, singleVariableDeclaration251, variableDeclarationStatement254, variableDeclarationExpression256, usagesInImports258, compilationUnits240, classFiles243, archives246, package272, qualifier275, type276, typeArguments278, expression281, ownedElements259, model261, ownedPackages264, package268, usagesInPackageAccess270, expression287, operand283, operand285, enhancedForStatement303, expression304, field306, variable289, qualifier290, modifier293, type295, annotations297, methodDeclaration300, catchClause302, fragments320, expression323, body325, finally_327, expression308, expression310, statements312, body315, expression317, declaration339, type341, bounds343, catchClauses330, usagesInTypeAccess333, type334, qualifier335, typeParameters337, element346, qualifier348, variablesContainer358, modifier359, annotations361, bound363, initializer351, usageInVariableAccess353, modifier354, annotations356, expression365, body367},
    generalizations={gen_java_AbstractMethodInvocation_ASTNode, gen_java_AbstractMethodDeclaration_BodyDeclaration, gen_java_AbstractVariablesContainer_ASTNode, gen_java_Annotation_Expression, gen_java_Archive_NamedElement, gen_java_AssertStatement_Statement, gen_java_AbstractTypeDeclaration_BodyDeclaration, gen_java_AbstractTypeDeclaration_Type, gen_java_AbstractTypeQualifiedExpression_Expression, gen_java_ArrayLengthAccess_Expression, gen_java_AnnotationTypeDeclaration_AbstractTypeDeclaration, gen_java_AnnotationTypeMemberDeclaration_BodyDeclaration, gen_java_AnonymousClassDeclaration_ASTNode, gen_java_ArrayAccess_Expression, gen_java_ArrayCreation_Expression, gen_java_ArrayInitializer_Expression, gen_java_AnnotationMemberValuePair_NamedElement, gen_java_BooleanLiteral_Expression, gen_java_ArrayType_Type, gen_java_Assignment_Expression, gen_java_BodyDeclaration_NamedElement, gen_java_ClassInstanceCreation_Expression, gen_java_ClassInstanceCreation_AbstractMethodInvocation, gen_java_BlockComment_Comment, gen_java_Block_Statement, gen_java_BreakStatement_Statement, gen_java_CastExpression_Expression, gen_java_CatchClause_Statement, gen_java_CharacterLiteral_Expression, gen_java_ClassFile_NamedElement, gen_java_Comment_ASTNode, gen_java_CompilationUnit_NamedElement, gen_java_ConstructorDeclaration_AbstractMethodDeclaration, gen_java_ConditionalExpression_Expression, gen_java_ConstructorInvocation_Statement, gen_java_ConstructorInvocation_AbstractMethodInvocation, gen_java_ClassDeclaration_TypeDeclaration, gen_java_EnumConstantDeclaration_BodyDeclaration, gen_java_EnumConstantDeclaration_VariableDeclaration, gen_java_EnumDeclaration_AbstractTypeDeclaration, gen_java_Expression_ASTNode, gen_java_ExpressionStatement_Statement, gen_java_ContinueStatement_Statement, gen_java_DoStatement_Statement, gen_java_EmptyStatement_Statement, gen_java_EnhancedForStatement_Statement, gen_java_IfStatement_Statement, gen_java_ImportDeclaration_ASTNode, gen_java_InfixExpression_Expression, gen_java_FieldAccess_Expression, gen_java_FieldDeclaration_BodyDeclaration, gen_java_FieldDeclaration_AbstractVariablesContainer, gen_java_ForStatement_Statement, gen_java_Initializer_BodyDeclaration, gen_java_InstanceofExpression_Expression, gen_java_InterfaceDeclaration_TypeDeclaration, gen_java_Javadoc_Comment, gen_java_MemberRef_ASTNode, gen_java_MethodDeclaration_AbstractMethodDeclaration, gen_java_LabeledStatement_NamedElement, gen_java_LabeledStatement_Statement, gen_java_LineComment_Comment, gen_java_MethodInvocation_Expression, gen_java_MethodInvocation_AbstractMethodInvocation, gen_java_MethodRef_ASTNode, gen_java_MethodRefParameter_ASTNode, gen_java_NamedElement_ASTNode, gen_java_NamespaceAccess_ASTNode, gen_java_Modifier_ASTNode, gen_java_PackageAccess_NamespaceAccess, gen_java_ParameterizedType_Type, gen_java_ParenthesizedExpression_Expression, gen_java_NumberLiteral_Expression, gen_java_NullLiteral_Expression, gen_java_Package_NamedElement, gen_java_PrimitiveTypeBoolean_PrimitiveType, gen_java_PrimitiveTypeByte_PrimitiveType, gen_java_PrimitiveTypeChar_PrimitiveType, gen_java_PrimitiveTypeDouble_PrimitiveType, gen_java_PrimitiveTypeShort_PrimitiveType, gen_java_PrimitiveTypeFloat_PrimitiveType, gen_java_PrimitiveTypeInt_PrimitiveType, gen_java_PrimitiveTypeLong_PrimitiveType, gen_java_PrimitiveTypeVoid_PrimitiveType, gen_java_ReturnStatement_Statement, gen_java_SingleVariableAccess_Expression, gen_java_PostfixExpression_Expression, gen_java_PrefixExpression_Expression, gen_java_PrimitiveType_Type, gen_java_Statement_ASTNode, gen_java_StringLiteral_Expression, gen_java_SuperConstructorInvocation_Statement, gen_java_SuperConstructorInvocation_AbstractMethodInvocation, gen_java_SuperFieldAccess_AbstractTypeQualifiedExpression, gen_java_SuperMethodInvocation_AbstractTypeQualifiedExpression, gen_java_SuperMethodInvocation_AbstractMethodInvocation, gen_java_SwitchCase_Statement, gen_java_SingleVariableDeclaration_VariableDeclaration, gen_java_TextElement_ASTNode, gen_java_ThisExpression_AbstractTypeQualifiedExpression, gen_java_ThrowStatement_Statement, gen_java_TryStatement_Statement, gen_java_SwitchStatement_Statement, gen_java_SynchronizedStatement_Statement, gen_java_TagElement_ASTNode, gen_java_TypeDeclarationStatement_Statement, gen_java_TypeLiteral_Expression, gen_java_TypeParameter_Type, gen_java_UnresolvedItem_NamedElement, gen_java_Type_NamedElement, gen_java_TypeAccess_Expression, gen_java_TypeAccess_NamespaceAccess, gen_java_TypeDeclaration_AbstractTypeDeclaration, gen_java_UnresolvedAnnotationDeclaration_AnnotationTypeDeclaration, gen_java_UnresolvedAnnotationDeclaration_UnresolvedItem, gen_java_UnresolvedAnnotationTypeMemberDeclaration_AnnotationTypeMemberDeclaration, gen_java_UnresolvedAnnotationTypeMemberDeclaration_UnresolvedItem, gen_java_UnresolvedClassDeclaration_ClassDeclaration, gen_java_UnresolvedClassDeclaration_UnresolvedItem, gen_java_UnresolvedEnumDeclaration_EnumDeclaration, gen_java_UnresolvedEnumDeclaration_UnresolvedItem, gen_java_UnresolvedInterfaceDeclaration_InterfaceDeclaration, gen_java_UnresolvedInterfaceDeclaration_UnresolvedItem, gen_java_UnresolvedLabeledStatement_LabeledStatement, gen_java_UnresolvedLabeledStatement_UnresolvedItem, gen_java_UnresolvedMethodDeclaration_MethodDeclaration, gen_java_UnresolvedMethodDeclaration_UnresolvedItem, gen_java_UnresolvedSingleVariableDeclaration_SingleVariableDeclaration, gen_java_UnresolvedSingleVariableDeclaration_UnresolvedItem, gen_java_UnresolvedItemAccess_Expression, gen_java_UnresolvedItemAccess_NamespaceAccess, gen_java_VariableDeclarationFragment_VariableDeclaration, gen_java_VariableDeclarationStatement_Statement, gen_java_VariableDeclarationStatement_AbstractVariablesContainer, gen_java_WildCardType_Type, gen_java_UnresolvedType_Type, gen_java_UnresolvedType_UnresolvedItem, gen_java_UnresolvedTypeDeclaration_AbstractTypeDeclaration, gen_java_UnresolvedTypeDeclaration_UnresolvedItem, gen_java_UnresolvedVariableDeclarationFragment_VariableDeclarationFragment, gen_java_UnresolvedVariableDeclarationFragment_UnresolvedItem, gen_java_VariableDeclaration_NamedElement, gen_java_VariableDeclarationExpression_Expression, gen_java_VariableDeclarationExpression_AbstractVariablesContainer, gen_java_WhileStatement_Statement},
    metadata=None
)
