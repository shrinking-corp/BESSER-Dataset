...
class wikidb116_version116_math:
    ...
    def __init__(self, math_html_conservativeness: int, math_outputhash: str, math_inputhash: str, math_html: str, math_mathml: str):
    ...
    @property
    def math_html_conservativeness(self):
...
class wikidb116_version116_oldimage:
    ...
    def __init__(self, oi_sha1: str, oi_description: str, oi_size: str, oi_name: str, oi_timestamp: str, oi_minor_mime: str, oi_user_text: str, oi_archive_name: str, oi_height: str, oi_bits: str, oi_metadata: str, oi_user: str, oi_major_mime: str, oi_width: str, oi_media_type: str, oi_deleted: int):
...
class wikidb116_version116_logging:
    ...
    def __init__(self, log_deleted: int, log_user_text: str, log_type: str, log_id: str, log_comment: str, log_params: str, log_namespace: str, log_action: str, log_timestamp: str, log_page: str, log_title: str, log_user: str):
...
class wikidb116_version116_tag_summary:
    ...
    def __init__(self, ts_tags: str, ts_rc_id: str, ts_rev_id: str, ts_log_id: str):
...
class wikidb116_version116_site_stats:
    ...
    def __init__(self, ss_row_id: str, ss_active_users: str, ss_users: str, ss_total_views: str, ss_images: str, ss_total_pages: str, ss_total_edits: str, ss_good_articles: str, ss_admins: str):
...
class wikidb116_version116_querycachetwo:
    ...
    def __init__(self, qcc_value: str, qcc_titletwo: str, qcc_namespace: str, qcc_title: str, qcc_type: str, qcc_namespacetwo: str):
...
class wikidb116_version116_revision:
    ...
    def __init__(self, rev_deleted: int, rev_timestamp: str, rev_len: str, rev_minor_edit: int, rev_comment: str, rev_user: str, rev_id: str, rev_user_text: str, rev_page: str, rev_text_id: str, rev_parent_id: str):
...
class wikidb116_version116_image:
    ...
    def __init__(self, img_name: str, img_user: str, img_bits: str, img_minor_mime: str, img_description: str, img_height: str, img_major_mime: str, img_size: str, img_metadata: str, img_media_type: str, img_timestamp: str, img_user_text: str, img_width: str, img_sha1: str):
...
class wikidb116_version116_user:
    ...
    def __init__(self, user_editcount: str, user_email: str, user_newpassword: str, user_email_token: str, user_email_token_expires: str, user_name: str, user_token: str, user_real_name: str, user_touched: str, user_email_authenticated: str, user_newpass_time: str, user_options: str, user_password: str, user_registration: str, user_id: str):
    ...
    @property
    def user_email_authenticated(self):
    ...
    @property
    def user_email_token_expires(self):
...
class wikidb116_version116_filearchive:
    ...
    def __init__(self, fa_height: str, fa_deleted: int, fa_metadata: str, fa_description: str, fa_deleted_reason: str, fa_archive_name: str, fa_name: str, fa_media_type: str, fa_storage_key: str, fa_bits: str, fa_id: str, fa_size: str, fa_user: str, fa_timestamp: str, fa_deleted_user: str, fa_minor_mime: str, fa_storage_group: str, fa_user_text: str, fa_major_mime: str, fa_deleted_timestamp: str, fa_width: str):
...
class wikidb116_version116_watchlist:
    ...
    @property
    def wl_notificationtimestamp(self):
...
class wikidb116_version116_trackbacks:
    ...
    def __init__(self, tb_id: str, tb_page: str, tb_name: str, tb_title: str, tb_url: str, tb_ex: str):
        self.tb_id = tb_id
