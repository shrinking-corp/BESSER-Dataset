...
public class wikidb116_version116_page  {
    ...
    public wikidb116_version116_page(
        String page_len,        float page_random,        String page_counter,        String page_title,        int page_is_new,        String page_id,        int page_is_redirect,        String page_latest,        String page_namespace,        String page_restrictions,        String page_touched    ) {
