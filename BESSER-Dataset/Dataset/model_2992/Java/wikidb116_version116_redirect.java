...
public class wikidb116_version116_redirect  {
    ...
    public wikidb116_version116_redirect(
        String rd_from,        String rd_namespace,        String rd_fragment,        String rd_title,        String rd_interwiki    ) {
