...
class Product:
    ...
    def __init__(self, name: str, description: str, defined: float, lineItems12: set["LineItem"] = None):
        self.name = name
    ...
    @defined.setter
    def defined(self, defined: float):
...
class LineItem:
    ...
    def __init__(self, price: float, quantity: int, sc11: "ShoppingCart" = None, product13: "Product" = None, order15: "Order" = None):
        self.price = price
