...
Order.attributes={Order_total, Order_shipped, Order_number, Order_ordered, Order_shipTo, Order_status}
...
Product_defined: Property = Property(name="defined", type=FloatType)
Product.attributes={Product_description, Product_name, Product_defined}
...
domain_model = DomainModel(
    name="_0ece0aed_fa44_4eeb_a07a_8727c571c08b",
    types={Customer, Payment, ShoppingCart, Account, WebUser, Order, LineItem, Product, OrderStatus, UserState},
