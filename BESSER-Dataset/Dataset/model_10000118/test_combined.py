...
def test_hyp_product_constructor_args():
    ...
    assert "defined" in params, "Missing parameter 'defined'"
...
@given(instance=Product_strategy)
def test_hyp_product_defined_setter(instance):
    original = instance.defined
    instance.defined = original
    assert instance.defined == original
...
def test_Product_defined_value_roundtrip():
    instance = Product(defined=3.14, description="sample_text", name="sample_text")
    assert instance.defined == 3.14
    instance.defined = 9.99
    assert instance.defined == 9.99
...
def test_assoc_Product_LineItem_link_reassign_clear():
    a = Product(defined=3.14, description="sample_text", name="sample_text")
...
Product_strategy = st.builds(Product, defined=st.floats(allow_nan=False, allow_infinity=False), description=safe_text, name=safe_text)
@given(instance=Product_strategy)
@settings(max_examples=25)
