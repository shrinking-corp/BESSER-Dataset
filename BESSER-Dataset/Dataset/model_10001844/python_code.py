...
class A1:
    ...
    def __init__(self, b: bool, c: B1, d: int, b16: set["B1"] = None):
        self.b = b
        self.c = c
        self.d = d
        self.b16 = b16 if b16 is not None else set()
    ...
    def b16(self, value):
        ...
        old_value = getattr(self, f"_A1__b16", None)
        self.__b16 = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "a17"):
                    opp_val = getattr(item, "a17", None)
                    
                    if opp_val == self:
                        setattr(item, "a17", None)
