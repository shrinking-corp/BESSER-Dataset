...
Employee.attributes={Employee_managerId, Employee_employeeId, Employee_jobLevel, Employee_employeeName, Employee_noOfLeaves, Employee_leavesTaken, Employee_password}
...
LeaveApplication.attributes={LeaveApplication_applicationId, LeaveApplication_fromDate, LeaveApplication_toDate, LeaveApplication_employeeId, LeaveApplication_reason, LeaveApplication_approverComments, LeaveApplication_status}
...
domain_model = DomainModel(
    name="_2bdcefb5_4b4d_4c3a_8f9b_f46dcf5551d6",
    ...
    associations={Employee_Approver_Jobs, Admin_CreateUser, Admin_Update_Calendar, Application_SendNotification, Credit_Leaves_Application, Application_AutoApproval, Application_GenerateSummary, User_Login, User_Query_Eligibility, User_Query_Leave_Balance, User_Query_Leave_History, Employee_Apply_Leave, Employee_Leave_Request_Status},
    generalizations={},
    metadata=None
)
