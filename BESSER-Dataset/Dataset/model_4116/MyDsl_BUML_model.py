...
myDsl_Programme = Class(name="myDsl_Programme")
myDsl_Fonction = Class(name="myDsl_Fonction")
myDsl_Input = Class(name="myDsl_Input")
myDsl_Commandes = Class(name="myDsl_Commandes")
myDsl_Output = Class(name="myDsl_Output")
myDsl_Expr = Class(name="myDsl_Expr")
myDsl_Commande = Class(name="myDsl_Commande")
myDsl_AffectVar = Class(name="myDsl_AffectVar")
myDsl_While = Class(name="myDsl_While")
myDsl_For = Class(name="myDsl_For")
myDsl_If = Class(name="myDsl_If")
myDsl_Foreach = Class(name="myDsl_Foreach")
myDsl_Vars = Class(name="myDsl_Vars")
myDsl_Exprs = Class(name="myDsl_Exprs")
myDsl_ExprOr = Class(name="myDsl_ExprOr")
myDsl_ExprNot = Class(name="myDsl_ExprNot")
myDsl_ExprNotNot = Class(name="myDsl_ExprNotNot")
myDsl_ExprAnd = Class(name="myDsl_ExprAnd")
myDsl_ExprSimple = Class(name="myDsl_ExprSimple")
myDsl_Cons = Class(name="myDsl_Cons")
myDsl_Liste = Class(name="myDsl_Liste")
myDsl_Hd = Class(name="myDsl_Hd")
myDsl_Tl = Class(name="myDsl_Tl")
myDsl_SymboleEx = Class(name="myDsl_SymboleEx")
myDsl_LExpr = Class(name="myDsl_LExpr")
myDsl_ExprNotDo = Class(name="myDsl_ExprNotDo")
myDsl_ExprEq = Class(name="myDsl_ExprEq")
...
myDsl_Input.attributes={myDsl_Input_var2, myDsl_Input_var1}
...
myDsl_Output.attributes={myDsl_Output_var2, myDsl_Output_var1}
...
myDsl_Vars.attributes={myDsl_Vars_var3, myDsl_Vars_var2}
...
myDsl_ExprSimple.attributes={myDsl_ExprSimple_vide, myDsl_ExprSimple_symbole, myDsl_ExprSimple_variable}
...
domain_model = DomainModel(
    name="myDsl",
    types={myDsl_Model, myDsl_Programme, myDsl_Fonction, myDsl_Input, myDsl_Commandes, myDsl_Output, myDsl_Expr, myDsl_Commande, myDsl_AffectVar, myDsl_While, myDsl_For, myDsl_If, myDsl_Foreach, myDsl_Vars, myDsl_Exprs, myDsl_ExprOr, myDsl_ExprNot, myDsl_ExprNotNot, myDsl_ExprAnd, myDsl_ExprSimple, myDsl_Cons, myDsl_Liste, myDsl_Hd, myDsl_Tl, myDsl_SymboleEx, myDsl_LExpr, myDsl_ExprNotDo, myDsl_ExprEq},
    associations={programme0, fonct1, in_3, com5, out7, exp228, com330, exp333, com436, exp439, com542, com645, exp548, exp651, com754, com19, com211, affectVar14, whileC16, forC18, ifC20, foreachC22, var124, exp26, le279, le382, le485, le588, expLe91, expO94, expO296, expN99, expN2101, exprNotNot104, exprS57, exprS260, expA63, expS65, cons67, liste69, hd71, tl73, symbolEx75, le177, exprNotDo106, expEq1108, expEq2110, expS1113, expS2116, expR119},
    generalizations={},
    metadata=None
)
