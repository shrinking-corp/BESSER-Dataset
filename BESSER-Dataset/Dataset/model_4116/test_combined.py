...
def test_hyp_mydsl_expreq_is_not_abstract():
    assert not inspect.isabstract(myDsl_ExprEq)


def test_hyp_mydsl_expreq_constructor_exists():
    assert callable(myDsl_ExprEq.__init__)


def test_hyp_mydsl_expreq_constructor_args():
    sig = inspect.signature(myDsl_ExprEq.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mydsl_exprnotdo_is_not_abstract():
    assert not inspect.isabstract(myDsl_ExprNotDo)


def test_hyp_mydsl_exprnotdo_constructor_exists():
    assert callable(myDsl_ExprNotDo.__init__)


def test_hyp_mydsl_exprnotdo_constructor_args():
...
def test_hyp_mydsl_symboleex_is_not_abstract():
    assert not inspect.isabstract(myDsl_SymboleEx)


def test_hyp_mydsl_symboleex_constructor_exists():
    assert callable(myDsl_SymboleEx.__init__)


def test_hyp_mydsl_symboleex_constructor_args():
...
def test_hyp_mydsl_tl_is_not_abstract():
    assert not inspect.isabstract(myDsl_Tl)


def test_hyp_mydsl_tl_constructor_exists():
    assert callable(myDsl_Tl.__init__)


def test_hyp_mydsl_tl_constructor_args():
    sig = inspect.signature(myDsl_Tl.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mydsl_hd_is_not_abstract():
    assert not inspect.isabstract(myDsl_Hd)


def test_hyp_mydsl_hd_constructor_exists():
    assert callable(myDsl_Hd.__init__)


def test_hyp_mydsl_hd_constructor_args():
    sig = inspect.signature(myDsl_Hd.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mydsl_liste_is_not_abstract():
    assert not inspect.isabstract(myDsl_Liste)


def test_hyp_mydsl_liste_constructor_exists():
    assert callable(myDsl_Liste.__init__)


def test_hyp_mydsl_liste_constructor_args():
    sig = inspect.signature(myDsl_Liste.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mydsl_cons_is_not_abstract():
    assert not inspect.isabstract(myDsl_Cons)


def test_hyp_mydsl_cons_constructor_exists():
    assert callable(myDsl_Cons.__init__)


def test_hyp_mydsl_cons_constructor_args():
...
def test_hyp_mydsl_exprand_is_not_abstract():
    assert not inspect.isabstract(myDsl_ExprAnd)


def test_hyp_mydsl_exprand_constructor_exists():
    assert callable(myDsl_ExprAnd.__init__)


def test_hyp_mydsl_exprand_constructor_args():
    sig = inspect.signature(myDsl_ExprAnd.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mydsl_exprnotnot_is_not_abstract():
    assert not inspect.isabstract(myDsl_ExprNotNot)


def test_hyp_mydsl_exprnotnot_constructor_exists():
    assert callable(myDsl_ExprNotNot.__init__)


def test_hyp_mydsl_exprnotnot_constructor_args():
    sig = inspect.signature(myDsl_ExprNotNot.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mydsl_exprnot_is_not_abstract():
    assert not inspect.isabstract(myDsl_ExprNot)


def test_hyp_mydsl_exprnot_constructor_exists():
    assert callable(myDsl_ExprNot.__init__)


def test_hyp_mydsl_exprnot_constructor_args():
    sig = inspect.signature(myDsl_ExprNot.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mydsl_expror_is_not_abstract():
    assert not inspect.isabstract(myDsl_ExprOr)


def test_hyp_mydsl_expror_constructor_exists():
    assert callable(myDsl_ExprOr.__init__)


def test_hyp_mydsl_expror_constructor_args():
...
def test_hyp_mydsl_affectvar_is_not_abstract():
    assert not inspect.isabstract(myDsl_AffectVar)


def test_hyp_mydsl_affectvar_constructor_exists():
    assert callable(myDsl_AffectVar.__init__)


def test_hyp_mydsl_affectvar_constructor_args():
...
def test_hyp_mydsl_programme_is_not_abstract():
    assert not inspect.isabstract(myDsl_Programme)


def test_hyp_mydsl_programme_constructor_exists():
    assert callable(myDsl_Programme.__init__)


def test_hyp_mydsl_programme_constructor_args():
...
def test_hyp_mydsl_symboleex_p_setter(instance):
    original = instance.p
    instance.p = original
...
def test_hyp_mydsl_exprsimple_vide_setter(instance):
...
@given(instance=myDsl_ExprSimple_strategy)
def test_hyp_mydsl_exprsimple_symbole_setter(instance):
...
@given(instance=myDsl_ExprSimple_strategy)
def test_hyp_mydsl_exprsimple_variable_setter(instance):
...
def test_hyp_mydsl_vars_var3_setter(instance):
...
@given(instance=myDsl_Vars_strategy)
def test_hyp_mydsl_vars_var2_setter(instance):
...
def test_hyp_mydsl_commande_nop_setter(instance):
...
def test_hyp_mydsl_output_var2_setter(instance):
    original = instance.var2
    instance.var2 = original
    assert instance.var2 == original
...
@given(instance=myDsl_Output_strategy)
def test_hyp_mydsl_output_var1_setter(instance):
...
def test_hyp_mydsl_input_var1_setter(instance):
    original = instance.var1
    instance.var1 = original
    assert instance.var1 == original
...
@given(instance=myDsl_Input_strategy)
def test_hyp_mydsl_input_var2_setter(instance):
    original = instance.var2
    instance.var2 = original
    assert instance.var2 == original
...
def test_hyp_mydsl_fonction_symbole_setter(instance):
    original = instance.symbole
    instance.symbole = original
    assert instance.symbole == original
