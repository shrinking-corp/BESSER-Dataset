...
class myDsl_SymboleEx:
    ...
    def __init__(self, p: str, myDsl_SymboleEx89: "myDsl_LExpr" = None, myDsl_SymboleEx: "myDsl_ExprSimple" = None):
        self.p = p
...
class myDsl_Fonction:
    ...
    def __init__(self, symbole: str, myDsl_Fonction: "myDsl_Programme" = None, myDsl_Fonction4: "myDsl_Input" = None, myDsl_Fonction6: "myDsl_Commandes" = None, myDsl_Fonction8: "myDsl_Output" = None):
        self.symbole = symbole
