...
ecore_EClass.methods={ecore_EClass_m_isSuperTypeOf, ecore_EClass_m_getEStructuralFeature, ecore_EClass_m_getFeatureID, ecore_EClass_m_getFeatureCount, ecore_EClass_m_getEStructuralFeature}
...
ecore_EObject.methods={ecore_EObject_m_eResource, ecore_EObject_m_eGet, ecore_EObject_m_eAllContents, ecore_EObject_m_eCrossReferences, ecore_EObject_m_eIsSet, ecore_EObject_m_eUnset, ecore_EObject_m_eContainingFeature, ecore_EObject_m_eClass, ecore_EObject_m_eIsProxy, ecore_EObject_m_eGet, ecore_EObject_m_eSet, ecore_EObject_m_eContainer, ecore_EObject_m_eContents, ecore_EObject_m_eContainmentFeature}
...
ecore_ETypedElement.attributes={ecore_ETypedElement_required, ecore_ETypedElement_lowerBound, ecore_ETypedElement_upperBound, ecore_ETypedElement_many, ecore_ETypedElement_unique, ecore_ETypedElement_ordered}
...
domain_model = DomainModel(
    name="ecore",
    types={ecore_EAnnotation, ecore_EClass, EClassifier, EModelElement, ecore_EStringToStringMapEntry, ecore_EModelElement, ecore_EObject, ecore_EGenericType, ecore_EClassifier, ENamedElement, ecore_EOperation, ecore_EAttribute, ecore_EStructuralFeature, ecore_EReference, ecore_EDataType, ecore_EPackage, ecore_ETypeParameter, ecore_ENamedElement, ecore_EFactory, ecore_ETypedElement, EObject, ecore_EClassifier_Wildcard, ETypedElement, ecore_EParameter, ecore_EStructuralFeature_Wildcard, EStructuralFeature, ecore_EEnum, EDataType, ecore_EEnumLiteral},
    associations={details0, eModelElement1, contents2, references4, eIDAttribute32, eGenericSuperTypes35, eAllGenericSuperTypes37, eSuperTypes8, eOperations9, eAllAttributes10, eStructuralFeatures12, eAllReferences14, eReferences16, eAttributes19, eAllContainments22, eAllOperations25, eAllStructuralFeatures27, eAllSuperTypes30, ePackage51, ePackage40, eTypeParameters41, eFactoryInstance42, eSubpackages44, eSuperPackage47, eClassifiers49, eExceptions78, eGenericExceptions81, eContainingClass84, eBounds53, eUpperBound57, eTypeArguments60, eRawType62, eLowerBound66, eTypeParameter68, eClassifier71, eTypeParameters74, eParameters77, eOpposite97, eReferenceType99, eKeys102, eType85, eGenericType87, eOperation90, eAttributeType92, eContainingClass94, eLiterals105, eEnum106, eAnnotations107},
    generalizations={gen_ecore_EClass_EClassifier, gen_ecore_EAnnotation_EModelElement, gen_ecore_EClassifier_ENamedElement, gen_ecore_EFactory_EModelElement, gen_ecore_EDataType_EClassifier, gen_ecore_ETypeParameter_ENamedElement, gen_ecore_ENamedElement_EModelElement, gen_ecore_EPackage_ENamedElement, gen_ecore_ETypedElement_ENamedElement, gen_ecore_EGenericType_EObject, gen_ecore_EOperation_ETypedElement, gen_ecore_EReference_EStructuralFeature, gen_ecore_EParameter_ETypedElement, gen_ecore_EAttribute_EStructuralFeature, gen_ecore_EStructuralFeature_ETypedElement, gen_ecore_EEnum_EDataType, gen_ecore_EEnumLiteral_ENamedElement, gen_ecore_EModelElement_EObject},
    metadata=None
)
