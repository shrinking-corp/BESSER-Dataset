...
class types_NonArrayType:
    ...
    pass
class c_sharp_types_ReferenceType(types_Type, types_NonArrayType):
...
class operators_AdditiveOperator:
    ...
    pass
class c_sharp_operators_Subtraction(operators_AdditiveOperator, operators_UnaryOperator):

    pass
class c_sharp_operators_Addition(operators_AdditiveOperator, operators_UnaryOperator):
...
class c_sharp_modifiers_Modifier(ABC):
    ...
    pass
class c_sharp_types_PointerType(types_Type, types_NonArrayType):
...
class c_sharp_classes_Class(common_NamedElement, namespaces_TypeDeclaration):
    ...
    pass
class c_sharp_classes_Method(common_NamedElement, classes_ClassMemberDeclaration):
