...
# Classes
c_sharp_common_NamedElement = Class(name="c_sharp_common_NamedElement", is_abstract=True)
c_sharp_common_NamespaceOrTypeName = Class(name="c_sharp_common_NamespaceOrTypeName")
Identifier = Class(name="Identifier")
c_sharp_common_Identifier = Class(name="c_sharp_common_Identifier")
common_NamedElement = Class(name="common_NamedElement")
expressions_PrimaryNoArrayCreationExpression = Class(name="expressions_PrimaryNoArrayCreationExpression")
c_sharp_namespaces_CompilationUnit = Class(name="c_sharp_namespaces_CompilationUnit")
...
c_sharp_namespaces_UsingDirective = Class(name="c_sharp_namespaces_UsingDirective")
NamedElement = Class(name="NamedElement")
c_sharp_classes_Class = Class(name="c_sharp_classes_Class")
namespaces_TypeDeclaration = Class(name="namespaces_TypeDeclaration")
Attributes = Class(name="Attributes")
Modifier = Class(name="Modifier")
ClassBase = Class(name="ClassBase")
ClassMemberDeclaration = Class(name="ClassMemberDeclaration")
c_sharp_classes_ClassBase = Class(name="c_sharp_classes_ClassBase")
ClassOrInterfaceOrDelegateOrEnumType = Class(name="ClassOrInterfaceOrDelegateOrEnumType")
c_sharp_classes_ClassMemberDeclaration = Class(name="c_sharp_classes_ClassMemberDeclaration", is_abstract=True)
c_sharp_classes_Method = Class(name="c_sharp_classes_Method")
Type = Class(name="Type")
FormalParameterList = Class(name="FormalParameterList")
Block = Class(name="Block")
c_sharp_classes_FormalParameterList = Class(name="c_sharp_classes_FormalParameterList")
FixedParameter = Class(name="FixedParameter")
NamespaceOrTypeName = Class(name="NamespaceOrTypeName")
c_sharp_namespaces_NamespaceMemberDeclaration = Class(name="c_sharp_namespaces_NamespaceMemberDeclaration", is_abstract=True)
c_sharp_namespaces_Namespace = Class(name="c_sharp_namespaces_Namespace")
NamespaceBody = Class(name="NamespaceBody")
c_sharp_namespaces_NamespaceBody = Class(name="c_sharp_namespaces_NamespaceBody")
c_sharp_namespaces_TypeDeclaration = Class(name="c_sharp_namespaces_TypeDeclaration", is_abstract=True)
namespaces_NamespaceMemberDeclaration = Class(name="namespaces_NamespaceMemberDeclaration")
classes_ClassMemberDeclaration = Class(name="classes_ClassMemberDeclaration")
c_sharp_classes_Block = Class(name="c_sharp_classes_Block")
Statement = Class(name="Statement")
c_sharp_classes_VariableInitializer = Class(name="c_sharp_classes_VariableInitializer", is_abstract=True)
c_sharp_classes_ConstantDeclaration = Class(name="c_sharp_classes_ConstantDeclaration")
ConstantDeclarator = Class(name="ConstantDeclarator")
c_sharp_classes_FieldDeclaration = Class(name="c_sharp_classes_FieldDeclaration")
VariableDeclarator = Class(name="VariableDeclarator")
c_sharp_arrays_StackallocInitializer = Class(name="c_sharp_arrays_StackallocInitializer")
VariableInitializer = Class(name="VariableInitializer")
Expression = Class(name="Expression")
c_sharp_arrays_ArrayInitializer = Class(name="c_sharp_arrays_ArrayInitializer")
ParameterArray = Class(name="ParameterArray")
c_sharp_classes_FixedParameter = Class(name="c_sharp_classes_FixedParameter")
Ref = Class(name="Ref")
Out = Class(name="Out")
c_sharp_classes_ParameterArray = Class(name="c_sharp_classes_ParameterArray")
Params = Class(name="Params")
ArrayType = Class(name="ArrayType")
AttributeTarget = Class(name="AttributeTarget")
c_sharp_attributes_AttributeTarget = Class(name="c_sharp_attributes_AttributeTarget")
Event = Class(name="Event")
Return = Class(name="Return")
c_sharp_attributes_Attribute = Class(name="c_sharp_attributes_Attribute")
AttributeArguments = Class(name="AttributeArguments")
c_sharp_attributes_AttributeArguments = Class(name="c_sharp_attributes_AttributeArguments")
ExpressionList = Class(name="ExpressionList")
NamedArgumentList = Class(name="NamedArgumentList")
c_sharp_attributes_NamedArgumentList = Class(name="c_sharp_attributes_NamedArgumentList")
NamedArgument = Class(name="NamedArgument")
c_sharp_attributes_NamedArgument = Class(name="c_sharp_attributes_NamedArgument")
c_sharp_statements_Statement = Class(name="c_sharp_statements_Statement", is_abstract=True)
c_sharp_statements_LabeledStatement = Class(name="c_sharp_statements_LabeledStatement")
statements_Statement = Class(name="statements_Statement")
c_sharp_arrays_ArrayType = Class(name="c_sharp_arrays_ArrayType")
NonArrayType = Class(name="NonArrayType")
RankSpecifier = Class(name="RankSpecifier")
c_sharp_arrays_RankSpecifier = Class(name="c_sharp_arrays_RankSpecifier")
c_sharp_attributes_GlobalAttributes = Class(name="c_sharp_attributes_GlobalAttributes")
GlobalAttributeTarget = Class(name="GlobalAttributeTarget")
Attribute = Class(name="Attribute")
c_sharp_attributes_GlobalAttributeTarget = Class(name="c_sharp_attributes_GlobalAttributeTarget")
c_sharp_attributes_Attributes = Class(name="c_sharp_attributes_Attributes")
StatementExpression = Class(name="StatementExpression")
c_sharp_statements_SelectionStatement = Class(name="c_sharp_statements_SelectionStatement", is_abstract=True)
c_sharp_statements_IfStatement = Class(name="c_sharp_statements_IfStatement")
SelectionStatement = Class(name="SelectionStatement")
StatementExpressionList = Class(name="StatementExpressionList")
c_sharp_statements_DeclarationStatement = Class(name="c_sharp_statements_DeclarationStatement")
VariableDeclaration = Class(name="VariableDeclaration")
LocalConstantDeclaration = Class(name="LocalConstantDeclaration")
c_sharp_statements_SwitchStatement = Class(name="c_sharp_statements_SwitchStatement")
c_sharp_statements_EmbeddedStatement = Class(name="c_sharp_statements_EmbeddedStatement", is_abstract=True)
c_sharp_statements_SimpleEmbeddedStatement = Class(name="c_sharp_statements_SimpleEmbeddedStatement")
EmbeddedStatement = Class(name="EmbeddedStatement")
Unsafe = Class(name="Unsafe")
SwitchSection = Class(name="SwitchSection")
c_sharp_statements_SwitchSection = Class(name="c_sharp_statements_SwitchSection")
c_sharp_statements_EmptyStatement = Class(name="c_sharp_statements_EmptyStatement")
SwitchLabel = Class(name="SwitchLabel")
c_sharp_statements_ExpressionStatement = Class(name="c_sharp_statements_ExpressionStatement")
c_sharp_statements_SwitchLabel = Class(name="c_sharp_statements_SwitchLabel")
Default = Class(name="Default")
Case = Class(name="Case")
c_sharp_statements_IterationStatement = Class(name="c_sharp_statements_IterationStatement", is_abstract=True)
c_sharp_statements_WhileStatement = Class(name="c_sharp_statements_WhileStatement")
IterationStatement = Class(name="IterationStatement")
c_sharp_statements_DoStatement = Class(name="c_sharp_statements_DoStatement")
c_sharp_statements_ForStatement = Class(name="c_sharp_statements_ForStatement")
...
c_sharp_statements_ForeachStatement = Class(name="c_sharp_statements_ForeachStatement")
c_sharp_statements_ForInitializer = Class(name="c_sharp_statements_ForInitializer", is_abstract=True)
c_sharp_statements_JumpStatement = Class(name="c_sharp_statements_JumpStatement", is_abstract=True)
c_sharp_statements_BreakStatement = Class(name="c_sharp_statements_BreakStatement")
JumpStatement = Class(name="JumpStatement")
c_sharp_statements_ContinueStatement = Class(name="c_sharp_statements_ContinueStatement")
c_sharp_statements_GotoStatement = Class(name="c_sharp_statements_GotoStatement")
c_sharp_statements_ReturnStatement = Class(name="c_sharp_statements_ReturnStatement")
c_sharp_statements_ThrowStatement = Class(name="c_sharp_statements_ThrowStatement")
c_sharp_statements_TryStatement = Class(name="c_sharp_statements_TryStatement")
c_sharp_statements_ResourceAcquisition = Class(name="c_sharp_statements_ResourceAcquisition", is_abstract=True)
c_sharp_statements_UsingStatement = Class(name="c_sharp_statements_UsingStatement")
ResourceAcquisition = Class(name="ResourceAcquisition")
FinallyClause = Class(name="FinallyClause")
c_sharp_statements_SpecificCatchClause = Class(name="c_sharp_statements_SpecificCatchClause")
c_sharp_statements_GeneralCatchClause = Class(name="c_sharp_statements_GeneralCatchClause")
c_sharp_statements_FinallyClause = Class(name="c_sharp_statements_FinallyClause")
c_sharp_statements_CheckedStatement = Class(name="c_sharp_statements_CheckedStatement")
c_sharp_statements_UncheckedStatement = Class(name="c_sharp_statements_UncheckedStatement")
c_sharp_statements_LockStatement = Class(name="c_sharp_statements_LockStatement")
c_sharp_statements_FixedStatement = Class(name="c_sharp_statements_FixedStatement")
PointerType = Class(name="PointerType")
FixedPointerDeclarator = Class(name="FixedPointerDeclarator")
c_sharp_statements_FixedPointerDeclarator = Class(name="c_sharp_statements_FixedPointerDeclarator")
c_sharp_statements_VariableDeclaration = Class(name="c_sharp_statements_VariableDeclaration")
statements_ForInitializer = Class(name="statements_ForInitializer")
statements_ResourceAcquisition = Class(name="statements_ResourceAcquisition")
c_sharp_expressions_StatementExpression = Class(name="c_sharp_expressions_StatementExpression", is_abstract=True)
c_sharp_expressions_StatementExpressionList = Class(name="c_sharp_expressions_StatementExpressionList")
c_sharp_statements_VariableDeclarator = Class(name="c_sharp_statements_VariableDeclarator")
c_sharp_statements_LocalConstantDeclaration = Class(name="c_sharp_statements_LocalConstantDeclaration")
c_sharp_statements_ConstantDeclarator = Class(name="c_sharp_statements_ConstantDeclarator")
c_sharp_expressions_BaseAccess = Class(name="c_sharp_expressions_BaseAccess")
PrimaryNoArrayCreationExpression = Class(name="PrimaryNoArrayCreationExpression")
c_sharp_expressions_Expression = Class(name="c_sharp_expressions_Expression", is_abstract=True)
classes_VariableInitializer = Class(name="classes_VariableInitializer")
c_sharp_expressions_ExpressionList = Class(name="c_sharp_expressions_ExpressionList")
c_sharp_expressions_Argument = Class(name="c_sharp_expressions_Argument")
c_sharp_expressions_ArgumentList = Class(name="c_sharp_expressions_ArgumentList")
Argument = Class(name="Argument")
c_sharp_expressions_PrimaryExpression = Class(name="c_sharp_expressions_PrimaryExpression", is_abstract=True)
c_sharp_expressions_PrimaryNoArrayCreationExpression = Class(name="c_sharp_expressions_PrimaryNoArrayCreationExpression", is_abstract=True)
PrimaryExpression = Class(name="PrimaryExpression")
c_sharp_expressions_PrimaryExtendedExpressionType = Class(name="c_sharp_expressions_PrimaryExtendedExpressionType", is_abstract=True)
c_sharp_expressions_MemberAccess = Class(name="c_sharp_expressions_MemberAccess")
PrimaryExtendedExpressionType = Class(name="PrimaryExtendedExpressionType")
SimpleType = Class(name="SimpleType")
c_sharp_expressions_ElementAccess = Class(name="c_sharp_expressions_ElementAccess")
c_sharp_expressions_InvocationExpression = Class(name="c_sharp_expressions_InvocationExpression")
expressions_PrimaryExtendedExpressionType = Class(name="expressions_PrimaryExtendedExpressionType")
expressions_StatementExpression = Class(name="expressions_StatementExpression")
ArgumentList = Class(name="ArgumentList")
c_sharp_expressions_PostIncrementExpression = Class(name="c_sharp_expressions_PostIncrementExpression")
c_sharp_expressions_PostDecrementExpression = Class(name="c_sharp_expressions_PostDecrementExpression")
c_sharp_expressions_PointerMemberAccess = Class(name="c_sharp_expressions_PointerMemberAccess")
...
c_sharp_expressions_ObjectCreationExpression = Class(name="c_sharp_expressions_ObjectCreationExpression")
c_sharp_expressions_ArrayCreationExpression = Class(name="c_sharp_expressions_ArrayCreationExpression")
ArrayInitializer = Class(name="ArrayInitializer")
c_sharp_expressions_ParenthesizedExpression = Class(name="c_sharp_expressions_ParenthesizedExpression")
c_sharp_expressions_UnaryExpression = Class(name="c_sharp_expressions_UnaryExpression")
...
c_sharp_expressions_CastExpression = Class(name="c_sharp_expressions_CastExpression")
AddressOfExpression = Class(name="AddressOfExpression")
c_sharp_expressions_ConditionalExpression = Class(name="c_sharp_expressions_ConditionalExpression")
ConditionalOrExpression = Class(name="ConditionalOrExpression")
c_sharp_expressions_AssignmentExpression = Class(name="c_sharp_expressions_AssignmentExpression")
expressions_Expression = Class(name="expressions_Expression")
AssignmentOperator = Class(name="AssignmentOperator")
c_sharp_expressions_TypeOfExpression = Class(name="c_sharp_expressions_TypeOfExpression")
c_sharp_expressions_DelegateCreationExpression = Class(name="c_sharp_expressions_DelegateCreationExpression")
c_sharp_expressions_CheckedExpression = Class(name="c_sharp_expressions_CheckedExpression")
c_sharp_expressions_UncheckedExpression = Class(name="c_sharp_expressions_UncheckedExpression")
c_sharp_expressions_SizeOfExpression = Class(name="c_sharp_expressions_SizeOfExpression")
c_sharp_expressions_PreIncrementExpression = Class(name="c_sharp_expressions_PreIncrementExpression")
c_sharp_expressions_PreDecrementExpression = Class(name="c_sharp_expressions_PreDecrementExpression")
GreaterThan = Class(name="GreaterThan")
GreaterThanOrEqual = Class(name="GreaterThanOrEqual")
c_sharp_expressions_EqualityExpression = Class(name="c_sharp_expressions_EqualityExpression")
RelationalExpression = Class(name="RelationalExpression")
c_sharp_expressions_AddressOfExpression = Class(name="c_sharp_expressions_AddressOfExpression")
c_sharp_expressions_MultiplicativeExpression = Class(name="c_sharp_expressions_MultiplicativeExpression")
Division = Class(name="Division")
Remainder = Class(name="Remainder")
c_sharp_expressions_AdditiveExpression = Class(name="c_sharp_expressions_AdditiveExpression")
MultiplicativeExpression = Class(name="MultiplicativeExpression")
c_sharp_expressions_ShiftExpression = Class(name="c_sharp_expressions_ShiftExpression")
RightShift = Class(name="RightShift")
LeftShift = Class(name="LeftShift")
AdditiveExpression = Class(name="AdditiveExpression")
c_sharp_expressions_RelationalExpression = Class(name="c_sharp_expressions_RelationalExpression")
ShiftExpression = Class(name="ShiftExpression")
LessThan = Class(name="LessThan")
LessThanOrEqual = Class(name="LessThanOrEqual")
c_sharp_types_Int = Class(name="c_sharp_types_Int")
c_sharp_types_UInt = Class(name="c_sharp_types_UInt")
c_sharp_types_Long = Class(name="c_sharp_types_Long")
c_sharp_types_ULong = Class(name="c_sharp_types_ULong")
c_sharp_types_Char = Class(name="c_sharp_types_Char")
c_sharp_types_Float = Class(name="c_sharp_types_Float")
Equal = Class(name="Equal")
NotEqual = Class(name="NotEqual")
c_sharp_expressions_AndExpression = Class(name="c_sharp_expressions_AndExpression")
EqualityExpression = Class(name="EqualityExpression")
And = Class(name="And")
c_sharp_expressions_ExclusiveOrExpression = Class(name="c_sharp_expressions_ExclusiveOrExpression")
AndExpression = Class(name="AndExpression")
ExclusiveOr = Class(name="ExclusiveOr")
c_sharp_expressions_InclusiveOrExpression = Class(name="c_sharp_expressions_InclusiveOrExpression")
ExclusiveOrExpression = Class(name="ExclusiveOrExpression")
InclusiveOr = Class(name="InclusiveOr")
c_sharp_expressions_ConditionalAndExpression = Class(name="c_sharp_expressions_ConditionalAndExpression")
InclusiveOrExpression = Class(name="InclusiveOrExpression")
ConditionalAnd = Class(name="ConditionalAnd")
c_sharp_expressions_ConditionalOrExpression = Class(name="c_sharp_expressions_ConditionalOrExpression")
ConditionalAndExpression = Class(name="ConditionalAndExpression")
ConditionalOr = Class(name="ConditionalOr")
c_sharp_types_Type = Class(name="c_sharp_types_Type", is_abstract=True)
c_sharp_types_NonArrayType = Class(name="c_sharp_types_NonArrayType", is_abstract=True)
c_sharp_types_ReferenceType = Class(name="c_sharp_types_ReferenceType", is_abstract=True)
types_NonArrayType = Class(name="types_NonArrayType")
types_Type = Class(name="types_Type")
c_sharp_types_SimpleType = Class(name="c_sharp_types_SimpleType", is_abstract=True)
c_sharp_types_Void = Class(name="c_sharp_types_Void")
c_sharp_types_Decimal = Class(name="c_sharp_types_Decimal")
c_sharp_types_Bool = Class(name="c_sharp_types_Bool")
c_sharp_types_SByte = Class(name="c_sharp_types_SByte")
c_sharp_types_Byte = Class(name="c_sharp_types_Byte")
c_sharp_types_Short = Class(name="c_sharp_types_Short")
c_sharp_types_UShort = Class(name="c_sharp_types_UShort")
c_sharp_literals_NullLiteral = Class(name="c_sharp_literals_NullLiteral")
c_sharp_literals_This = Class(name="c_sharp_literals_This")
c_sharp_literals_CharacterLiteral = Class(name="c_sharp_literals_CharacterLiteral")
c_sharp_literals_StringLiteral = Class(name="c_sharp_literals_StringLiteral")
c_sharp_types_Double = Class(name="c_sharp_types_Double")
c_sharp_types_Object = Class(name="c_sharp_types_Object")
c_sharp_types_String = Class(name="c_sharp_types_String")
c_sharp_types_ClassOrInterfaceOrDelegateOrEnumType = Class(name="c_sharp_types_ClassOrInterfaceOrDelegateOrEnumType")
ReferenceType = Class(name="ReferenceType")
c_sharp_types_PointerType = Class(name="c_sharp_types_PointerType")
c_sharp_modifiers_Modifier = Class(name="c_sharp_modifiers_Modifier", is_abstract=True)
c_sharp_modifiers_Abstract = Class(name="c_sharp_modifiers_Abstract")
c_sharp_modifiers_Extern = Class(name="c_sharp_modifiers_Extern")
c_sharp_modifiers_Internal = Class(name="c_sharp_modifiers_Internal")
c_sharp_modifiers_New = Class(name="c_sharp_modifiers_New")
c_sharp_modifiers_OverrideModifier = Class(name="c_sharp_modifiers_OverrideModifier")
c_sharp_modifiers_Private = Class(name="c_sharp_modifiers_Private")
c_sharp_modifiers_Protected = Class(name="c_sharp_modifiers_Protected")
c_sharp_modifiers_Public = Class(name="c_sharp_modifiers_Public")
c_sharp_modifiers_Partial = Class(name="c_sharp_modifiers_Partial")
c_sharp_modifiers_ReadOnly = Class(name="c_sharp_modifiers_ReadOnly")
c_sharp_modifiers_Sealed = Class(name="c_sharp_modifiers_Sealed")
c_sharp_modifiers_Static = Class(name="c_sharp_modifiers_Static")
c_sharp_modifiers_Unsafe = Class(name="c_sharp_modifiers_Unsafe")
c_sharp_modifiers_Virtual = Class(name="c_sharp_modifiers_Virtual")
c_sharp_modifiers_Volatile = Class(name="c_sharp_modifiers_Volatile")
c_sharp_literals_Literal = Class(name="c_sharp_literals_Literal", is_abstract=True)
c_sharp_literals_BooleanLiteral = Class(name="c_sharp_literals_BooleanLiteral")
Literal = Class(name="Literal")
c_sharp_literals_DecimalIntegerLiteral = Class(name="c_sharp_literals_DecimalIntegerLiteral")
c_sharp_literals_HexadecimalIntegerLiteral = Class(name="c_sharp_literals_HexadecimalIntegerLiteral")
c_sharp_literals_RealLiteral = Class(name="c_sharp_literals_RealLiteral")
c_sharp_operators_MinusMinus = Class(name="c_sharp_operators_MinusMinus")
UnaryModificationOperator = Class(name="UnaryModificationOperator")
c_sharp_operators_Negate = Class(name="c_sharp_operators_Negate")
c_sharp_operators_PlusPlus = Class(name="c_sharp_operators_PlusPlus")
c_sharp_operators_LeftShift = Class(name="c_sharp_operators_LeftShift")
ShiftOperator = Class(name="ShiftOperator")
c_sharp_operators_RightShift = Class(name="c_sharp_operators_RightShift")
c_sharp_keywords_Out = Class(name="c_sharp_keywords_Out")
c_sharp_keywords_Ref = Class(name="c_sharp_keywords_Ref")
c_sharp_keywords_Params = Class(name="c_sharp_keywords_Params")
c_sharp_keywords_Case = Class(name="c_sharp_keywords_Case")
c_sharp_keywords_Default = Class(name="c_sharp_keywords_Default")
c_sharp_keywords_Return = Class(name="c_sharp_keywords_Return")
c_sharp_keywords_Event = Class(name="c_sharp_keywords_Event")
c_sharp_operators_Operator = Class(name="c_sharp_operators_Operator", is_abstract=True)
c_sharp_operators_AdditiveOperator = Class(name="c_sharp_operators_AdditiveOperator", is_abstract=True)
Operator = Class(name="Operator")
c_sharp_operators_AssignmentOperator = Class(name="c_sharp_operators_AssignmentOperator", is_abstract=True)
c_sharp_operators_EqualityOperator = Class(name="c_sharp_operators_EqualityOperator", is_abstract=True)
c_sharp_operators_MultiplicativeOperator = Class(name="c_sharp_operators_MultiplicativeOperator", is_abstract=True)
c_sharp_operators_RelationOperator = Class(name="c_sharp_operators_RelationOperator", is_abstract=True)
c_sharp_operators_ShiftOperator = Class(name="c_sharp_operators_ShiftOperator", is_abstract=True)
c_sharp_operators_UnaryOperator = Class(name="c_sharp_operators_UnaryOperator", is_abstract=True)
c_sharp_operators_UnaryModificationOperator = Class(name="c_sharp_operators_UnaryModificationOperator", is_abstract=True)
c_sharp_operators_Assignment = Class(name="c_sharp_operators_Assignment")
c_sharp_operators_AssignmentAnd = Class(name="c_sharp_operators_AssignmentAnd")
c_sharp_operators_AssignmentDivision = Class(name="c_sharp_operators_AssignmentDivision")
c_sharp_operators_AssignmentExclusiveOr = Class(name="c_sharp_operators_AssignmentExclusiveOr")
c_sharp_operators_AssignmentMinus = Class(name="c_sharp_operators_AssignmentMinus")
c_sharp_operators_AssignmentModulo = Class(name="c_sharp_operators_AssignmentModulo")
c_sharp_operators_AssignmentMultiplication = Class(name="c_sharp_operators_AssignmentMultiplication")
c_sharp_operators_AssignmentLeftShift = Class(name="c_sharp_operators_AssignmentLeftShift")
c_sharp_operators_AssignmentOr = Class(name="c_sharp_operators_AssignmentOr")
c_sharp_operators_AssignmentPlus = Class(name="c_sharp_operators_AssignmentPlus")
c_sharp_operators_AssignmentRightShift = Class(name="c_sharp_operators_AssignmentRightShift")
c_sharp_operators_AssignmentUnsignedRightShift = Class(name="c_sharp_operators_AssignmentUnsignedRightShift")
c_sharp_operators_Equal = Class(name="c_sharp_operators_Equal")
EqualityOperator = Class(name="EqualityOperator")
c_sharp_operators_NotEqual = Class(name="c_sharp_operators_NotEqual")
c_sharp_operators_GreaterThan = Class(name="c_sharp_operators_GreaterThan")
RelationOperator = Class(name="RelationOperator")
c_sharp_operators_GreaterThanOrEqual = Class(name="c_sharp_operators_GreaterThanOrEqual")
c_sharp_operators_LessThan = Class(name="c_sharp_operators_LessThan")
c_sharp_operators_LessThanOrEqual = Class(name="c_sharp_operators_LessThanOrEqual")
c_sharp_operators_Addition = Class(name="c_sharp_operators_Addition")
...
c_sharp_operators_Subtraction = Class(name="c_sharp_operators_Subtraction")
c_sharp_operators_Division = Class(name="c_sharp_operators_Division")
MultiplicativeOperator = Class(name="MultiplicativeOperator")
c_sharp_operators_Multiplication = Class(name="c_sharp_operators_Multiplication")
c_sharp_operators_Remainder = Class(name="c_sharp_operators_Remainder")
c_sharp_operators_Complement = Class(name="c_sharp_operators_Complement")
UnaryOperator = Class(name="UnaryOperator")
c_sharp_operators_UnsignedRightShift = Class(name="c_sharp_operators_UnsignedRightShift")
c_sharp_operators_And = Class(name="c_sharp_operators_And")
c_sharp_operators_ExclusiveOr = Class(name="c_sharp_operators_ExclusiveOr")
c_sharp_operators_InclusiveOr = Class(name="c_sharp_operators_InclusiveOr")
c_sharp_operators_ConditionalAnd = Class(name="c_sharp_operators_ConditionalAnd")
c_sharp_operators_ConditionalOr = Class(name="c_sharp_operators_ConditionalOr")
...
return_101: BinaryAssociation = BinaryAssociation(
    name="return_101",
    ends={
...
and_399: BinaryAssociation = BinaryAssociation(
    name="and_399",
    ends={
...
domain_model = DomainModel(
    name="c_sharp",
    types={c_sharp_common_NamedElement, c_sharp_common_NamespaceOrTypeName, Identifier, c_sharp_common_Identifier, common_NamedElement, expressions_PrimaryNoArrayCreationExpression, c_sharp_namespaces_CompilationUnit, UsingDirective, GlobalAttributes, NamespaceMemberDeclaration, c_sharp_namespaces_UsingDirective, NamedElement, c_sharp_classes_Class, namespaces_TypeDeclaration, Attributes, Modifier, ClassBase, ClassMemberDeclaration, c_sharp_classes_ClassBase, ClassOrInterfaceOrDelegateOrEnumType, c_sharp_classes_ClassMemberDeclaration, c_sharp_classes_Method, Type, FormalParameterList, Block, c_sharp_classes_FormalParameterList, FixedParameter, NamespaceOrTypeName, c_sharp_namespaces_NamespaceMemberDeclaration, c_sharp_namespaces_Namespace, NamespaceBody, c_sharp_namespaces_NamespaceBody, c_sharp_namespaces_TypeDeclaration, namespaces_NamespaceMemberDeclaration, classes_ClassMemberDeclaration, c_sharp_classes_Block, Statement, c_sharp_classes_VariableInitializer, c_sharp_classes_ConstantDeclaration, ConstantDeclarator, c_sharp_classes_FieldDeclaration, VariableDeclarator, c_sharp_arrays_StackallocInitializer, VariableInitializer, Expression, c_sharp_arrays_ArrayInitializer, ParameterArray, c_sharp_classes_FixedParameter, Ref, Out, c_sharp_classes_ParameterArray, Params, ArrayType, AttributeTarget, c_sharp_attributes_AttributeTarget, Event, Return, c_sharp_attributes_Attribute, AttributeArguments, c_sharp_attributes_AttributeArguments, ExpressionList, NamedArgumentList, c_sharp_attributes_NamedArgumentList, NamedArgument, c_sharp_attributes_NamedArgument, c_sharp_statements_Statement, c_sharp_statements_LabeledStatement, statements_Statement, c_sharp_arrays_ArrayType, NonArrayType, RankSpecifier, c_sharp_arrays_RankSpecifier, c_sharp_attributes_GlobalAttributes, GlobalAttributeTarget, Attribute, c_sharp_attributes_GlobalAttributeTarget, c_sharp_attributes_Attributes, StatementExpression, c_sharp_statements_SelectionStatement, c_sharp_statements_IfStatement, SelectionStatement, StatementExpressionList, c_sharp_statements_DeclarationStatement, VariableDeclaration, LocalConstantDeclaration, c_sharp_statements_SwitchStatement, c_sharp_statements_EmbeddedStatement, c_sharp_statements_SimpleEmbeddedStatement, EmbeddedStatement, Unsafe, SwitchSection, c_sharp_statements_SwitchSection, c_sharp_statements_EmptyStatement, SwitchLabel, c_sharp_statements_ExpressionStatement, c_sharp_statements_SwitchLabel, Default, Case, c_sharp_statements_IterationStatement, c_sharp_statements_WhileStatement, IterationStatement, c_sharp_statements_DoStatement, c_sharp_statements_ForStatement, ForInitializer, SpecificCatchClause, GeneralCatchClause, c_sharp_statements_ForeachStatement, c_sharp_statements_ForInitializer, c_sharp_statements_JumpStatement, c_sharp_statements_BreakStatement, JumpStatement, c_sharp_statements_ContinueStatement, c_sharp_statements_GotoStatement, c_sharp_statements_ReturnStatement, c_sharp_statements_ThrowStatement, c_sharp_statements_TryStatement, c_sharp_statements_ResourceAcquisition, c_sharp_statements_UsingStatement, ResourceAcquisition, FinallyClause, c_sharp_statements_SpecificCatchClause, c_sharp_statements_GeneralCatchClause, c_sharp_statements_FinallyClause, c_sharp_statements_CheckedStatement, c_sharp_statements_UncheckedStatement, c_sharp_statements_LockStatement, c_sharp_statements_FixedStatement, PointerType, FixedPointerDeclarator, c_sharp_statements_FixedPointerDeclarator, c_sharp_statements_VariableDeclaration, statements_ForInitializer, statements_ResourceAcquisition, c_sharp_expressions_StatementExpression, c_sharp_expressions_StatementExpressionList, c_sharp_statements_VariableDeclarator, c_sharp_statements_LocalConstantDeclaration, c_sharp_statements_ConstantDeclarator, c_sharp_expressions_BaseAccess, PrimaryNoArrayCreationExpression, c_sharp_expressions_Expression, classes_VariableInitializer, c_sharp_expressions_ExpressionList, c_sharp_expressions_Argument, c_sharp_expressions_ArgumentList, Argument, c_sharp_expressions_PrimaryExpression, c_sharp_expressions_PrimaryNoArrayCreationExpression, PrimaryExpression, c_sharp_expressions_PrimaryExtendedExpressionType, c_sharp_expressions_MemberAccess, PrimaryExtendedExpressionType, SimpleType, c_sharp_expressions_ElementAccess, c_sharp_expressions_InvocationExpression, expressions_PrimaryExtendedExpressionType, expressions_StatementExpression, ArgumentList, c_sharp_expressions_PostIncrementExpression, c_sharp_expressions_PostDecrementExpression, c_sharp_expressions_PointerMemberAccess, PreIncrementExpression, PreDecrementExpression, CastExpression, c_sharp_expressions_ObjectCreationExpression, c_sharp_expressions_ArrayCreationExpression, ArrayInitializer, c_sharp_expressions_ParenthesizedExpression, c_sharp_expressions_UnaryExpression, MemberAccess, Addition, Subtraction, Negate, Complement, Multiplication, UnaryExpression, c_sharp_expressions_CastExpression, AddressOfExpression, c_sharp_expressions_ConditionalExpression, ConditionalOrExpression, c_sharp_expressions_AssignmentExpression, expressions_Expression, AssignmentOperator, c_sharp_expressions_TypeOfExpression, c_sharp_expressions_DelegateCreationExpression, c_sharp_expressions_CheckedExpression, c_sharp_expressions_UncheckedExpression, c_sharp_expressions_SizeOfExpression, c_sharp_expressions_PreIncrementExpression, c_sharp_expressions_PreDecrementExpression, GreaterThan, GreaterThanOrEqual, c_sharp_expressions_EqualityExpression, RelationalExpression, c_sharp_expressions_AddressOfExpression, c_sharp_expressions_MultiplicativeExpression, Division, Remainder, c_sharp_expressions_AdditiveExpression, MultiplicativeExpression, c_sharp_expressions_ShiftExpression, RightShift, LeftShift, AdditiveExpression, c_sharp_expressions_RelationalExpression, ShiftExpression, LessThan, LessThanOrEqual, c_sharp_types_Int, c_sharp_types_UInt, c_sharp_types_Long, c_sharp_types_ULong, c_sharp_types_Char, c_sharp_types_Float, Equal, NotEqual, c_sharp_expressions_AndExpression, EqualityExpression, And, c_sharp_expressions_ExclusiveOrExpression, AndExpression, ExclusiveOr, c_sharp_expressions_InclusiveOrExpression, ExclusiveOrExpression, InclusiveOr, c_sharp_expressions_ConditionalAndExpression, InclusiveOrExpression, ConditionalAnd, c_sharp_expressions_ConditionalOrExpression, ConditionalAndExpression, ConditionalOr, c_sharp_types_Type, c_sharp_types_NonArrayType, c_sharp_types_ReferenceType, types_NonArrayType, types_Type, c_sharp_types_SimpleType, c_sharp_types_Void, c_sharp_types_Decimal, c_sharp_types_Bool, c_sharp_types_SByte, c_sharp_types_Byte, c_sharp_types_Short, c_sharp_types_UShort, c_sharp_literals_NullLiteral, c_sharp_literals_This, c_sharp_literals_CharacterLiteral, c_sharp_literals_StringLiteral, c_sharp_types_Double, c_sharp_types_Object, c_sharp_types_String, c_sharp_types_ClassOrInterfaceOrDelegateOrEnumType, ReferenceType, c_sharp_types_PointerType, c_sharp_modifiers_Modifier, c_sharp_modifiers_Abstract, c_sharp_modifiers_Extern, c_sharp_modifiers_Internal, c_sharp_modifiers_New, c_sharp_modifiers_OverrideModifier, c_sharp_modifiers_Private, c_sharp_modifiers_Protected, c_sharp_modifiers_Public, c_sharp_modifiers_Partial, c_sharp_modifiers_ReadOnly, c_sharp_modifiers_Sealed, c_sharp_modifiers_Static, c_sharp_modifiers_Unsafe, c_sharp_modifiers_Virtual, c_sharp_modifiers_Volatile, c_sharp_literals_Literal, c_sharp_literals_BooleanLiteral, Literal, c_sharp_literals_DecimalIntegerLiteral, c_sharp_literals_HexadecimalIntegerLiteral, c_sharp_literals_RealLiteral, c_sharp_operators_MinusMinus, UnaryModificationOperator, c_sharp_operators_Negate, c_sharp_operators_PlusPlus, c_sharp_operators_LeftShift, ShiftOperator, c_sharp_operators_RightShift, c_sharp_keywords_Out, c_sharp_keywords_Ref, c_sharp_keywords_Params, c_sharp_keywords_Case, c_sharp_keywords_Default, c_sharp_keywords_Return, c_sharp_keywords_Event, c_sharp_operators_Operator, c_sharp_operators_AdditiveOperator, Operator, c_sharp_operators_AssignmentOperator, c_sharp_operators_EqualityOperator, c_sharp_operators_MultiplicativeOperator, c_sharp_operators_RelationOperator, c_sharp_operators_ShiftOperator, c_sharp_operators_UnaryOperator, c_sharp_operators_UnaryModificationOperator, c_sharp_operators_Assignment, c_sharp_operators_AssignmentAnd, c_sharp_operators_AssignmentDivision, c_sharp_operators_AssignmentExclusiveOr, c_sharp_operators_AssignmentMinus, c_sharp_operators_AssignmentModulo, c_sharp_operators_AssignmentMultiplication, c_sharp_operators_AssignmentLeftShift, c_sharp_operators_AssignmentOr, c_sharp_operators_AssignmentPlus, c_sharp_operators_AssignmentRightShift, c_sharp_operators_AssignmentUnsignedRightShift, c_sharp_operators_Equal, EqualityOperator, c_sharp_operators_NotEqual, c_sharp_operators_GreaterThan, RelationOperator, c_sharp_operators_GreaterThanOrEqual, c_sharp_operators_LessThan, c_sharp_operators_LessThanOrEqual, c_sharp_operators_Addition, operators_AdditiveOperator, operators_UnaryOperator, c_sharp_operators_Subtraction, c_sharp_operators_Division, MultiplicativeOperator, c_sharp_operators_Multiplication, c_sharp_operators_Remainder, c_sharp_operators_Complement, UnaryOperator, c_sharp_operators_UnsignedRightShift, c_sharp_operators_And, c_sharp_operators_ExclusiveOr, c_sharp_operators_InclusiveOr, c_sharp_operators_ConditionalAnd, c_sharp_operators_ConditionalOr},
    associations={parts0, usingDirectives1, globalAttributes2, namespaceMemberDeclaration4, attributes16, modifiers17, classBase19, classMemberDeclarations21, types23, attributes24, modifiers26, returnType29, interfaceType31, formalParameterList34, block36, fixedParameter38, namespaceOrTypeName6, namespaceName7, namespaceBody9, usingDirectives11, namespaceMemberDeclaration13, statement62, attributes63, modifiers65, type68, constantDeclarator71, attributes73, modifiers75, type78, variableDeclarator81, type83, expression85, variableInitializer87, parameterArray39, attributes41, ref43, out45, type47, identifier50, attributes53, params55, arrayType57, identifier59, attributeTarget96, attribute97, event100, return_101, type103, namespaceOrTypeName106, attributeArguments108, expressionList110, namedArgumentList111, namedArgument113, identifier114, expression116, nonArrayType88, rankSpecifier89, globalAttributeTarget91, attribute92, identifier94, statementExpression128, expression129, forInitializer157, expression158, statementExpressionList161, embeddedStatement163, statement119, variableDeclaration121, embeddedStatement131, localConstantDeclaration122, expression133, unsafe124, switchSection135, block125, switchLabel137, statement138, default141, case142, expression144, expression147, embeddedStatement149, embeddedStatement152, expression154, specificCatchClause194, generalCatchClause196, type166, identifier168, expression171, embeddedStatement174, default177, case179, expression182, identifier185, expression188, expression190, block192, resourceAcquisition221, finallyClause198, classType200, identifier202, block205, block208, block210, block212, block214, expression216, embeddedStatement218, embeddedStatement222, pointerType225, fixedPointerDeclarator226, embeddedStatement228, identifier231, expression233, type236, statementExpression250, VariableDeclarator238, VariableInitializer241, type243, constantDeclarator245, expression248, identifier270, expressionList272, identifier274, expression252, out254, ref256, expression259, argument262, simpleType263, identifier264, expressionList267, argumentList269, preIncrementExpression314, preDecrementExpression316, castExpression318, type277, argumentList279, type282, arrayType284, expressionList287, rankSpecifier290, arrayInitializer293, expression295, memberAccess297, primaryExpression298, primaryExtendedExpressionType300, addition302, subtraction304, negate306, complement308, multiplication310, unaryExpression312, unaryExpression348, type350, unaryExpression352, addressOfExpression320, expression322, conditionalOrExpression324, unaryExpression326, assignmentOperator328, expression330, type333, delegateType335, expression337, expression340, expression342, type344, unaryExpression346, greaterThan389, greaterThanOrEqual391, relationalExpression393, unaryExpression355, unaryExpression357, multiplication359, division362, remainder364, multiplicativeExpression366, addition367, subtraction370, rightShift373, leftShift374, remainder376, additiveExpression379, shiftExpression381, type382, lessThan385, lessThanOrEqual387, equal394, notEqual396, equalityExpression398, and_399, andExpression401, exclusiveOr402, exclusiveOrExpression404, inclusiveOr405, inclusiveOrExpression407, conditionalAnd408, conditionalAndExpression410, conditionalOr411, namespaceOrTypeName413, simpleType415, referenceType417},
    generalizations={gen_c_sharp_common_Identifier_common_NamedElement, gen_c_sharp_common_Identifier_expressions_PrimaryNoArrayCreationExpression, gen_c_sharp_namespaces_UsingDirective_NamedElement, gen_c_sharp_classes_Class_namespaces_TypeDeclaration, gen_c_sharp_classes_Class_common_NamedElement, gen_c_sharp_classes_Method_classes_ClassMemberDeclaration, gen_c_sharp_classes_Method_common_NamedElement, gen_c_sharp_namespaces_Namespace_NamespaceMemberDeclaration, gen_c_sharp_namespaces_TypeDeclaration_namespaces_NamespaceMemberDeclaration, gen_c_sharp_namespaces_TypeDeclaration_classes_ClassMemberDeclaration, gen_c_sharp_classes_ConstantDeclaration_ClassMemberDeclaration, gen_c_sharp_classes_FieldDeclaration_ClassMemberDeclaration, gen_c_sharp_arrays_StackallocInitializer_VariableInitializer, gen_c_sharp_arrays_ArrayInitializer_VariableInitializer, gen_c_sharp_statements_LabeledStatement_statements_Statement, gen_c_sharp_statements_LabeledStatement_common_NamedElement, gen_c_sharp_arrays_ArrayType_Type, gen_c_sharp_statements_SelectionStatement_EmbeddedStatement, gen_c_sharp_statements_IfStatement_SelectionStatement, gen_c_sharp_statements_DeclarationStatement_Statement, gen_c_sharp_statements_SwitchStatement_SelectionStatement, gen_c_sharp_statements_EmbeddedStatement_Statement, gen_c_sharp_statements_SimpleEmbeddedStatement_EmbeddedStatement, gen_c_sharp_statements_EmptyStatement_EmbeddedStatement, gen_c_sharp_statements_ExpressionStatement_EmbeddedStatement, gen_c_sharp_statements_IterationStatement_EmbeddedStatement, gen_c_sharp_statements_WhileStatement_IterationStatement, gen_c_sharp_statements_DoStatement_IterationStatement, gen_c_sharp_statements_ForStatement_IterationStatement, gen_c_sharp_statements_ForeachStatement_IterationStatement, gen_c_sharp_statements_JumpStatement_EmbeddedStatement, gen_c_sharp_statements_BreakStatement_JumpStatement, gen_c_sharp_statements_ContinueStatement_JumpStatement, gen_c_sharp_statements_GotoStatement_JumpStatement, gen_c_sharp_statements_ReturnStatement_JumpStatement, gen_c_sharp_statements_ThrowStatement_JumpStatement, gen_c_sharp_statements_TryStatement_EmbeddedStatement, gen_c_sharp_statements_UsingStatement_EmbeddedStatement, gen_c_sharp_statements_CheckedStatement_EmbeddedStatement, gen_c_sharp_statements_UncheckedStatement_EmbeddedStatement, gen_c_sharp_statements_LockStatement_EmbeddedStatement, gen_c_sharp_statements_FixedStatement_EmbeddedStatement, gen_c_sharp_statements_VariableDeclaration_statements_ForInitializer, gen_c_sharp_statements_VariableDeclaration_statements_ResourceAcquisition, gen_c_sharp_expressions_StatementExpressionList_ForInitializer, gen_c_sharp_statements_VariableDeclarator_NamedElement, gen_c_sharp_statements_ConstantDeclarator_NamedElement, gen_c_sharp_expressions_BaseAccess_PrimaryNoArrayCreationExpression, gen_c_sharp_expressions_Expression_classes_VariableInitializer, gen_c_sharp_expressions_Expression_statements_ResourceAcquisition, gen_c_sharp_expressions_PrimaryNoArrayCreationExpression_PrimaryExpression, gen_c_sharp_expressions_MemberAccess_PrimaryExtendedExpressionType, gen_c_sharp_expressions_ElementAccess_PrimaryExtendedExpressionType, gen_c_sharp_expressions_InvocationExpression_expressions_PrimaryExtendedExpressionType, gen_c_sharp_expressions_InvocationExpression_expressions_StatementExpression, gen_c_sharp_expressions_PostIncrementExpression_expressions_PrimaryExtendedExpressionType, gen_c_sharp_expressions_PostIncrementExpression_expressions_StatementExpression, gen_c_sharp_expressions_PostDecrementExpression_expressions_PrimaryExtendedExpressionType, gen_c_sharp_expressions_PostDecrementExpression_expressions_StatementExpression, gen_c_sharp_expressions_PointerMemberAccess_PrimaryExtendedExpressionType, gen_c_sharp_expressions_ObjectCreationExpression_expressions_PrimaryNoArrayCreationExpression, gen_c_sharp_expressions_ObjectCreationExpression_expressions_StatementExpression, gen_c_sharp_expressions_ArrayCreationExpression_PrimaryExpression, gen_c_sharp_expressions_ParenthesizedExpression_PrimaryNoArrayCreationExpression, gen_c_sharp_expressions_ConditionalExpression_Expression, gen_c_sharp_expressions_AssignmentExpression_expressions_Expression, gen_c_sharp_expressions_AssignmentExpression_expressions_StatementExpression, gen_c_sharp_expressions_TypeOfExpression_PrimaryNoArrayCreationExpression, gen_c_sharp_expressions_DelegateCreationExpression_PrimaryNoArrayCreationExpression, gen_c_sharp_expressions_CheckedExpression_PrimaryNoArrayCreationExpression, gen_c_sharp_expressions_UncheckedExpression_PrimaryNoArrayCreationExpression, gen_c_sharp_expressions_SizeOfExpression_PrimaryNoArrayCreationExpression, gen_c_sharp_expressions_PreIncrementExpression_StatementExpression, gen_c_sharp_expressions_PreDecrementExpression_StatementExpression, gen_c_sharp_types_Int_SimpleType, gen_c_sharp_types_UInt_SimpleType, gen_c_sharp_types_Long_SimpleType, gen_c_sharp_types_ULong_SimpleType, gen_c_sharp_types_Char_SimpleType, gen_c_sharp_types_Float_SimpleType, gen_c_sharp_types_ReferenceType_types_NonArrayType, gen_c_sharp_types_ReferenceType_types_Type, gen_c_sharp_types_SimpleType_types_Type, gen_c_sharp_types_SimpleType_types_NonArrayType, gen_c_sharp_types_Void_SimpleType, gen_c_sharp_types_Decimal_SimpleType, gen_c_sharp_types_Bool_SimpleType, gen_c_sharp_types_SByte_SimpleType, gen_c_sharp_types_Byte_SimpleType, gen_c_sharp_types_Short_SimpleType, gen_c_sharp_types_UShort_SimpleType, gen_c_sharp_literals_NullLiteral_Literal, gen_c_sharp_literals_This_Literal, gen_c_sharp_literals_CharacterLiteral_Literal, gen_c_sharp_literals_StringLiteral_Literal, gen_c_sharp_types_Double_SimpleType, gen_c_sharp_types_Object_SimpleType, gen_c_sharp_types_String_SimpleType, gen_c_sharp_types_ClassOrInterfaceOrDelegateOrEnumType_ReferenceType, gen_c_sharp_types_PointerType_types_Type, gen_c_sharp_types_PointerType_types_NonArrayType, gen_c_sharp_modifiers_Abstract_Modifier, gen_c_sharp_modifiers_Extern_Modifier, gen_c_sharp_modifiers_Internal_Modifier, gen_c_sharp_modifiers_New_Modifier, gen_c_sharp_modifiers_OverrideModifier_Modifier, gen_c_sharp_modifiers_Private_Modifier, gen_c_sharp_modifiers_Protected_Modifier, gen_c_sharp_modifiers_Public_Modifier, gen_c_sharp_modifiers_Partial_Modifier, gen_c_sharp_modifiers_ReadOnly_Modifier, gen_c_sharp_modifiers_Sealed_Modifier, gen_c_sharp_modifiers_Static_Modifier, gen_c_sharp_modifiers_Unsafe_Modifier, gen_c_sharp_modifiers_Virtual_Modifier, gen_c_sharp_modifiers_Volatile_Modifier, gen_c_sharp_literals_Literal_PrimaryNoArrayCreationExpression, gen_c_sharp_literals_BooleanLiteral_Literal, gen_c_sharp_literals_DecimalIntegerLiteral_Literal, gen_c_sharp_literals_HexadecimalIntegerLiteral_Literal, gen_c_sharp_literals_RealLiteral_Literal, gen_c_sharp_operators_MinusMinus_UnaryModificationOperator, gen_c_sharp_operators_Negate_UnaryOperator, gen_c_sharp_operators_PlusPlus_UnaryModificationOperator, gen_c_sharp_operators_LeftShift_ShiftOperator, gen_c_sharp_operators_RightShift_ShiftOperator, gen_c_sharp_operators_AdditiveOperator_Operator, gen_c_sharp_operators_AssignmentOperator_Operator, gen_c_sharp_operators_EqualityOperator_Operator, gen_c_sharp_operators_MultiplicativeOperator_Operator, gen_c_sharp_operators_RelationOperator_Operator, gen_c_sharp_operators_ShiftOperator_Operator, gen_c_sharp_operators_UnaryOperator_Operator, gen_c_sharp_operators_UnaryModificationOperator_Operator, gen_c_sharp_operators_Assignment_AssignmentOperator, gen_c_sharp_operators_AssignmentAnd_AssignmentOperator, gen_c_sharp_operators_AssignmentDivision_AssignmentOperator, gen_c_sharp_operators_AssignmentExclusiveOr_AssignmentOperator, gen_c_sharp_operators_AssignmentMinus_AssignmentOperator, gen_c_sharp_operators_AssignmentModulo_AssignmentOperator, gen_c_sharp_operators_AssignmentMultiplication_AssignmentOperator, gen_c_sharp_operators_AssignmentLeftShift_AssignmentOperator, gen_c_sharp_operators_AssignmentOr_AssignmentOperator, gen_c_sharp_operators_AssignmentPlus_AssignmentOperator, gen_c_sharp_operators_AssignmentRightShift_AssignmentOperator, gen_c_sharp_operators_AssignmentUnsignedRightShift_AssignmentOperator, gen_c_sharp_operators_Equal_EqualityOperator, gen_c_sharp_operators_NotEqual_EqualityOperator, gen_c_sharp_operators_GreaterThan_RelationOperator, gen_c_sharp_operators_GreaterThanOrEqual_RelationOperator, gen_c_sharp_operators_LessThan_RelationOperator, gen_c_sharp_operators_LessThanOrEqual_RelationOperator, gen_c_sharp_operators_Addition_operators_AdditiveOperator, gen_c_sharp_operators_Addition_operators_UnaryOperator, gen_c_sharp_operators_Subtraction_operators_AdditiveOperator, gen_c_sharp_operators_Subtraction_operators_UnaryOperator, gen_c_sharp_operators_Division_MultiplicativeOperator, gen_c_sharp_operators_Multiplication_MultiplicativeOperator, gen_c_sharp_operators_Remainder_MultiplicativeOperator, gen_c_sharp_operators_Complement_UnaryOperator, gen_c_sharp_operators_UnsignedRightShift_ShiftOperator, gen_c_sharp_operators_And_UnaryOperator, gen_c_sharp_operators_ExclusiveOr_UnaryOperator, gen_c_sharp_operators_InclusiveOr_UnaryOperator, gen_c_sharp_operators_ConditionalAnd_UnaryOperator, gen_c_sharp_operators_ConditionalOr_UnaryOperator},
    metadata=None
)
