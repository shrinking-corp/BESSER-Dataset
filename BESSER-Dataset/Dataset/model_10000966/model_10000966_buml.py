...
ASK_QUERIES_UseCase = Class(name="ASK_QUERIES_UseCase")
RESPONSE_QUERIES_UseCase = Class(name="RESPONSE_QUERIES_UseCase")
...
CHATBOT_Actor = Class(name="CHATBOT_Actor")
...
Customer.attributes={Customer_id, Customer_mailid, Customer_name, Customer_phoneno, Customer_address}
...
Order.attributes={Order_quantity, Order_list, Order_item}
...
Product.attributes={Product_name, Product_id, Product_type}
...
# ASK_QUERIES_UseCase class attributes and methods

# RESPONSE_QUERIES_UseCase class attributes and methods
...
# CHATBOT_Actor class attributes and methods
...
CREATES_THE_WEBSITE_WEB_DEVELOPER: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="wEB_DEVELOPER0", type=CHATBOT_Actor, multiplicity=Multiplicity(0, 1)),
        Property(name="cREATES_THE_WEBSITE1", type=RESPONSE_QUERIES_UseCase, multiplicity=Multiplicity(0, 1))
    }
)
CUSTOMER_VISITS_THE_WEBSITE: BinaryAssociation = BinaryAssociation(
    name="CUSTOMER_VISITS_THE_WEBSITE",
    ends={
        Property(name="vISITS_THE_WEBSITE2", type=ASK_QUERIES_UseCase, multiplicity=Multiplicity(0, 1)),
...
domain_model = DomainModel(
    name="_75d50938_f890_41b7_ae70_ab3149987760",
    types={Customer, Order, Product, Warehouse, Transaction, Shipment, Customercare, Feedback, Cancelorder, CUSTOMER_Actor, ASK_QUERIES_UseCase, RESPONSE_QUERIES_UseCase, SELECTS_THE_ITEMS_SERVICE_UseCase, ADDS_ITEMS_SERVICE_TO_CART_UseCase, SELECTS_THE_MODE_OF_PAYMENT_UseCase, PAYS_THE_BILL_UseCase, DELIVERS_THE_PRODUCT_UseCase, SUPPORT_AND_FEEDBACK_UseCase, CHATBOT_Actor, ADMINISTRATOR_Actor, MAINTAINS_THE_PRODUCTS_SERVICES_UseCase},
    associations={MAINTAINS_THE_PRODUCTS_SERVICES_ADMINISTRATOR, SUPPORT_AND_FEEDBACK_ADMINISTRATOR, ORDER_PRODUCT, CREATES_THE_WEBSITE_WEB_DEVELOPER, CUSTOMER_VISITS_THE_WEBSITE, CUSTOMER_SELECTS_THE_ITEMS_SERVICE, CUSTOMER_ADDS_ITEMS_SERVICE_TO_CART, CUSTOMER_SELECTS_THE_MODE_OF_PAYMENT, CUSTOMER_PAYS_THE_BILL, CUSTOMER_SUPPORT_AND_FEEDBACK, SELECTS_THE_MODE_OF_PAYMENT_ADMINISTRATOR, PAYS_THE_BILL_ADMINISTRATOR, DELIVERS_THE_PRODUCT_ADMINISTRATOR, Customer_Customercare, Warehouse_Shipment, Product_Warehouse},
    generalizations={},
    metadata=None
)
