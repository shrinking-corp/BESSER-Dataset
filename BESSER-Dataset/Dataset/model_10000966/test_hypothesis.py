...
def test_chatbot_actor_is_not_abstract():
    assert not inspect.isabstract(CHATBOT_Actor)


def test_chatbot_actor_constructor_exists():
    assert callable(CHATBOT_Actor.__init__)


def test_chatbot_actor_constructor_args():
...
def test_response_queries_usecase_is_not_abstract():
    assert not inspect.isabstract(RESPONSE_QUERIES_UseCase)


def test_response_queries_usecase_constructor_exists():
    assert callable(RESPONSE_QUERIES_UseCase.__init__)


def test_response_queries_usecase_constructor_args():
    sig = inspect.signature(RESPONSE_QUERIES_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_ask_queries_usecase_is_not_abstract():
    assert not inspect.isabstract(ASK_QUERIES_UseCase)


def test_ask_queries_usecase_constructor_exists():
    assert callable(ASK_QUERIES_UseCase.__init__)


def test_ask_queries_usecase_constructor_args():
