...
class typesystem_Unit:
    ...
    def __init__(self, scale: int, wildcard: bool, typesystem_Unit: "typesystem_NumericType" = None, typesystem_Unit12: "typesystem_UnitDenominator" = None, typesystem_Unit10: "typesystem_UnitNumerator" = None, typesystem_Unit15: "typesystem_NumericLiteral" = None):
        self.scale = scale
    ...
    def evaluate(self, typesystem_n, typesystem_operator) :
