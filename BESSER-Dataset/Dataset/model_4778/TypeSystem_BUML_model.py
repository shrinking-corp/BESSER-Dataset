...
typesystem_DataType_m_evaluate: Method = Method(name="evaluate", parameters={Parameter(name='typesystem_operator', type=StringType), Parameter(name='typesystem_other', type=StringType)}, type=StringType)
...
typesystem_Unit_m_isEquivalentTo: Method = Method(name="isEquivalentTo", parameters={Parameter(name='typesystem_ignoreScale', type=StringType), Parameter(name='typesystem_other', type=StringType)}, type=BooleanType)
...
domain_model = DomainModel(
    name="typesystem",
    types={typesystem_InvalidDataType, DataType, typesystem_AnyDataType, typesystem_UnitType, typesystem_DataType, typesystem_IntegerType, typesystem_ComplexType, typesystem_GaussianType, typesystem_BooleanType, typesystem_StringType, typesystem_ArrayType, typesystem_ArrayDimension, typesystem_TensorType, ArrayType, typesystem_PrimitiveType, typesystem_NumericType, PrimitiveType, typesystem_Unit, typesystem_RealType, NumericType, typesystem_UnitDenominator, typesystem_UnitProduct, typesystem_UnitFactor, UnitProduct, typesystem_Literal, Expression, typesystem_NumericLiteral, Literal, typesystem_Expression, typesystem_RealLiteral, typesystem_UnitNumerator, NumericLiteral, typesystem_IntegerLiteral, typesystem_BooleanLiteral, typesystem_StringLiteral, OperatorKind},
    associations={elementType1, definedElementType2, dimensions5, unit0, denominator11, factors13, size7, numerator9, unit14},
    generalizations={gen_typesystem_InvalidDataType_DataType, gen_typesystem_AnyDataType_DataType, gen_typesystem_UnitType_DataType, gen_typesystem_IntegerType_NumericType, gen_typesystem_ComplexType_NumericType, gen_typesystem_GaussianType_NumericType, gen_typesystem_BooleanType_PrimitiveType, gen_typesystem_StringType_PrimitiveType, gen_typesystem_ArrayType_DataType, gen_typesystem_TensorType_ArrayType, gen_typesystem_PrimitiveType_DataType, gen_typesystem_NumericType_PrimitiveType, gen_typesystem_RealType_NumericType, gen_typesystem_UnitNumerator_UnitProduct, gen_typesystem_UnitDenominator_UnitProduct, gen_typesystem_Literal_Expression, gen_typesystem_NumericLiteral_Literal, gen_typesystem_RealLiteral_NumericLiteral, gen_typesystem_IntegerLiteral_NumericLiteral, gen_typesystem_BooleanLiteral_Literal, gen_typesystem_StringLiteral_Literal},
    metadata=None
)
