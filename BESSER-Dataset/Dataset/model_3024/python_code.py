...
class dbl_RhsExpression(ABC):
    ...
    def __init__(self, dbl_RhsExpression200: "dbl_AtLeastOneExpr" = None, dbl_RhsExpression202: "dbl_ArbitraryExpr" = None, dbl_RhsExpression204: "dbl_AlternativeExpr" = None, dbl_RhsExpression: "dbl_TsRule" = None, dbl_RhsExpression198: "dbl_RuntimeExpr" = None, dbl_RhsExpression207: "dbl_AlternativeExpr" = None, dbl_RhsExpression194: "dbl_SequenceExpr" = None, dbl_RhsExpression196: "dbl_OptionalExpr" = None):
...
class ExpandableElement:
    ...
    pass
class dbl_TypeAccess(ElementAccess, ExpandableElement):
...
class dbl_Expression(Construct):
    ...
    pass
class dbl_VariableAccess(ElementAccess, ExpandableElement):
...
class dbl_Import:
    ...
    def __init__(self, file: str, dbl_Import4: "dbl_Model" = None, dbl_Import: "dbl_Model" = None):
        self.file = file
...
class dbl_ExtensibleElement:
    ...
    def __init__(self, objectIsExtensionInstance: bool, dbl_ExtensibleElement: "dbl_EmbeddableExtensionsContainer" = None, dbl_ExtensibleElement22: "dbl_ModifierExtensionsContainer" = None):
        ...
        pass
    @property
    def objectIsExtensionInstance(self):
...
class dbl_Variable(Statement, ModifierExtensionsContainer, AbstractVariable):

    def __init__(self, control: bool, clazz: bool, dbl_Variable: "dbl_Module" = None, dbl_Variable48: "dbl_ClassSimilar" = None, dbl_Variable32: "dbl_Annotation" = None, dbl_Variable88: "dbl_Expression" = None, dbl_Variable139: "dbl_ForEachStatement" = None):
...
class dbl_Annotation(NamedElement):
    ...
    pass
class dbl_Procedure(TypedElement, AnnotatableElement, NamedElement, CodeBlock):
...
class dbl_Pattern(NamedElement):
    ...
    def __init__(self, top: bool, dbl_Pattern: "dbl_ReferencePropertyType" = None, dbl_Pattern254: "dbl_IdResolution" = None, dbl_Pattern256: "dbl_Parameter" = None, dbl_Pattern259: "dbl_CodeBlock" = None, dbl_Pattern274: "dbl_IncludePattern" = None):
        self.top = top
...
class dbl_TsRule(NamedElement, ReferableRhsType):
