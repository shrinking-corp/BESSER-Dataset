...
dbl_Classifier = Class(name="dbl_Classifier", is_abstract=True)
dbl_ClassAugment = Class(name="dbl_ClassAugment")
dbl_ExtensionDefinition = Class(name="dbl_ExtensionDefinition")
dbl_Annotation = Class(name="dbl_Annotation")
dbl_Procedure = Class(name="dbl_Procedure")
dbl_Variable = Class(name="dbl_Variable")
dbl_IdResolution = Class(name="dbl_IdResolution")
dbl_EmbeddableExtensionsContainer = Class(name="dbl_EmbeddableExtensionsContainer", is_abstract=True)
dbl_ExtensibleElement = Class(name="dbl_ExtensibleElement")
dbl_ModifierExtensionsContainer = Class(name="dbl_ModifierExtensionsContainer", is_abstract=True)
...
dbl_ListDimension = Class(name="dbl_ListDimension")
...
dbl_SimpleAnnotation = Class(name="dbl_SimpleAnnotation")
Type = Class(name="Type")
dbl_KeyValuePair = Class(name="dbl_KeyValuePair")
dbl_VariableAccess = Class(name="dbl_VariableAccess")
dbl_Expression = Class(name="dbl_Expression")
dbl_AnnotatableElement = Class(name="dbl_AnnotatableElement", is_abstract=True)
ReferableRhsType = Class(name="ReferableRhsType")
dbl_NativeBinding = Class(name="dbl_NativeBinding")
dbl_ClassSimilar = Class(name="dbl_ClassSimilar", is_abstract=True)
ModifierExtensionsContainer = Class(name="ModifierExtensionsContainer")
dbl_Clazz = Class(name="dbl_Clazz")
dbl_Interface = Class(name="dbl_Interface")
dbl_StartCodeBlock = Class(name="dbl_StartCodeBlock")
dbl_AnnotationApplication = Class(name="dbl_AnnotationApplication")
...
dbl_CompositeStatement = Class(name="dbl_CompositeStatement")
dbl_SimpleStatement = Class(name="dbl_SimpleStatement")
dbl_ExpressionStatement = Class(name="dbl_ExpressionStatement")
SimpleStatement = Class(name="SimpleStatement")
dbl_StatementExpression = Class(name="dbl_StatementExpression")
dbl_Assignment = Class(name="dbl_Assignment")
dbl_DeprecatedProcedureCallStatement = Class(name="dbl_DeprecatedProcedureCallStatement")
ExpressionStatement = Class(name="ExpressionStatement")
dbl_ProcedureCall = Class(name="dbl_ProcedureCall")
...
dbl_CodeBlock = Class(name="dbl_CodeBlock")
Construct = Class(name="Construct")
dbl_Statement = Class(name="dbl_Statement")
dbl_SetStatement = Class(name="dbl_SetStatement", is_abstract=True)
dbl_RemoveFromSet = Class(name="dbl_RemoveFromSet")
SetStatement = Class(name="SetStatement")
dbl_AddToSet = Class(name="dbl_AddToSet")
dbl_ArgumentExpression = Class(name="dbl_ArgumentExpression")
dbl_EmptySet = Class(name="dbl_EmptySet")
...
dbl_ForEachStatement = Class(name="dbl_ForEachStatement")
...
dbl_SetOp = Class(name="dbl_SetOp", is_abstract=True)
dbl_SizeOfSet = Class(name="dbl_SizeOfSet")
SetOp = Class(name="SetOp")
dbl_FirstInSet = Class(name="dbl_FirstInSet")
dbl_LastInSet = Class(name="dbl_LastInSet")
dbl_Contains = Class(name="dbl_Contains")
dbl_IndexOf = Class(name="dbl_IndexOf")
dbl_ObjectAt = Class(name="dbl_ObjectAt")
dbl_BeforeInSet = Class(name="dbl_BeforeInSet")
dbl_AfterInSet = Class(name="dbl_AfterInSet")
dbl_DepIdentifiableElement = Class(name="dbl_DepIdentifiableElement", is_abstract=True)
...
dbl_EvalExpr = Class(name="dbl_EvalExpr")
...
dbl_NamedExtensible = Class(name="dbl_NamedExtensible")
...
dbl_TextualSyntaxDef = Class(name="dbl_TextualSyntaxDef")
dbl_Mapping = Class(name="dbl_Mapping")
dbl_ExtensionRule = Class(name="dbl_ExtensionRule")
dbl_TsRule = Class(name="dbl_TsRule")
dbl_ReferableRhsType = Class(name="dbl_ReferableRhsType", is_abstract=True)
dbl_RhsExpression = Class(name="dbl_RhsExpression", is_abstract=True)
dbl_RuntimeExpr = Class(name="dbl_RuntimeExpr")
dbl_AtLeastOneExpr = Class(name="dbl_AtLeastOneExpr")
dbl_ArbitraryExpr = Class(name="dbl_ArbitraryExpr")
dbl_AlternativeExpr = Class(name="dbl_AlternativeExpr")
dbl_TerminalExpr = Class(name="dbl_TerminalExpr")
dbl_PropertyBindingExpr = Class(name="dbl_PropertyBindingExpr")
dbl_PropertyType = Class(name="dbl_PropertyType", is_abstract=True)
dbl_IdPropertyType = Class(name="dbl_IdPropertyType")
PropertyType = Class(name="PropertyType")
dbl_IntPropertyType = Class(name="dbl_IntPropertyType")
dbl_StringPropertyType = Class(name="dbl_StringPropertyType")
dbl_BooleanPropertyType = Class(name="dbl_BooleanPropertyType")
dbl_RuleExpr = Class(name="dbl_RuleExpr")
dbl_SequenceExpr = Class(name="dbl_SequenceExpr")
RhsExpression = Class(name="RhsExpression")
dbl_OptionalExpr = Class(name="dbl_OptionalExpr")
dbl_MetaExpr = Class(name="dbl_MetaExpr")
dbl_TargetStatement = Class(name="dbl_TargetStatement")
dbl_MappingStatement = Class(name="dbl_MappingStatement")
dbl_SetGenContextStatement = Class(name="dbl_SetGenContextStatement")
dbl_ResetGenContextStatement = Class(name="dbl_ResetGenContextStatement")
dbl_SaveGenStatement = Class(name="dbl_SaveGenStatement")
dbl_ResumeGenStatement = Class(name="dbl_ResumeGenStatement")
dbl_FixedMappingPart = Class(name="dbl_FixedMappingPart")
MappingPart = Class(name="MappingPart")
dbl_StructuredPropertyType = Class(name="dbl_StructuredPropertyType")
dbl_CompositePropertyType = Class(name="dbl_CompositePropertyType")
StructuredPropertyType = Class(name="StructuredPropertyType")
dbl_ReferencePropertyType = Class(name="dbl_ReferencePropertyType")
dbl_Pattern = Class(name="dbl_Pattern")
dbl_MappingPart = Class(name="dbl_MappingPart", is_abstract=True)
dbl_ExpandSection = Class(name="dbl_ExpandSection")
...
dbl_ExpandableElement = Class(name="dbl_ExpandableElement")
dbl_TestStatement = Class(name="dbl_TestStatement")
dbl_DynamicMappingPart = Class(name="dbl_DynamicMappingPart")
dbl_ExpandExpression = Class(name="dbl_ExpandExpression")
dbl_ExpandStatement = Class(name="dbl_ExpandStatement")
dbl_IncludePattern = Class(name="dbl_IncludePattern")
dbl_PotentiallyHiddenIdElements = Class(name="dbl_PotentiallyHiddenIdElements")
dbl_FindContainer = Class(name="dbl_FindContainer")
dbl_ConsiderIdElements = Class(name="dbl_ConsiderIdElements")
...
domain_model = DomainModel(
    name="dbl",
    types={NamedElement, EmbeddableExtensionsContainer, dbl_Classifier, dbl_ClassAugment, dbl_ExtensionDefinition, dbl_Annotation, dbl_Procedure, dbl_Variable, dbl_IdResolution, dbl_EmbeddableExtensionsContainer, dbl_ExtensibleElement, dbl_ModifierExtensionsContainer, dbl_Type, dbl_TypedElement, dbl_PrimitiveType, dbl_ListDimension, dbl_IdExpr, TypedElement, dbl_Construct, NamedExtensible, dbl_Model, dbl_Import, dbl_Module, dbl_VoidType, PrimitiveType, dbl_IntType, dbl_BoolType, dbl_DoubleType, dbl_StringType, CodeBlock, AnnotatableElement, dbl_Parameter, dbl_SimpleAnnotation, Type, dbl_KeyValuePair, dbl_VariableAccess, dbl_Expression, dbl_AnnotatableElement, ReferableRhsType, dbl_NativeBinding, dbl_ClassSimilar, ModifierExtensionsContainer, dbl_Clazz, dbl_Interface, dbl_StartCodeBlock, dbl_AnnotationApplication, Classifier, ClassSimilar, dbl_Constructor, dbl_AbstractVariable, AbstractVariable, dbl_CompositeStatement, dbl_SimpleStatement, dbl_ExpressionStatement, SimpleStatement, dbl_StatementExpression, dbl_Assignment, dbl_DeprecatedProcedureCallStatement, ExpressionStatement, dbl_ProcedureCall, StatementExpression, dbl_Return, dbl_WaitUntil, dbl_Terminate, dbl_Yield, dbl_Wait, dbl_Reactivate, dbl_ActivateObject, Statement, dbl_NamedElement, ExpandableElement, dbl_CodeBlock, Construct, dbl_Statement, dbl_SetStatement, dbl_RemoveFromSet, SetStatement, dbl_AddToSet, dbl_ArgumentExpression, dbl_EmptySet, dbl_IfStatement, CompositeStatement, dbl_WhileStatement, dbl_BreakStatement, dbl_ContinueStatement, dbl_ForEachStatement, dbl_Advance, dbl_Print, dbl_BinaryOperator, dbl_UnaryOperator, dbl_And, BinaryOperator, dbl_Or, dbl_Greater, dbl_GreaterEqual, dbl_Less, dbl_LessEqual, dbl_NotEqual, dbl_Equal, dbl_InstanceOf, dbl_Plus, dbl_Minus, dbl_Mul, dbl_Mod, dbl_Div, dbl_Neg, UnaryOperator, dbl_Not, dbl_Cast, dbl_CreateObject, L1Expr, dbl_NullLiteral, dbl_L1Expr, Expression, dbl_MeLiteral, PredefinedId, dbl_SuperLiteral, dbl_MetaLiteral, dbl_TypeLiteral, dbl_SetOp, dbl_SizeOfSet, SetOp, dbl_FirstInSet, dbl_LastInSet, dbl_Contains, dbl_IndexOf, dbl_ObjectAt, dbl_BeforeInSet, dbl_AfterInSet, dbl_DepIdentifiableElement, dbl_PredefinedId, dbl_TimeLiteral, dbl_ActiveLiteral, dbl_StringLiteral, dbl_IntLiteral, dbl_TrueLiteral, dbl_FalseLiteral, dbl_DoubleLiteral, dbl_ElementAccess, dbl_EvalExpr, ElementAccess, dbl_MetaAccess, VariableAccess, dbl_TypeAccess, dbl_NamedExtensible, ExtensibleElement, dbl_ClassContentExtension, dbl_ModuleContentExtension, dbl_TextualSyntaxDef, dbl_Mapping, dbl_ExtensionRule, dbl_TsRule, dbl_ReferableRhsType, dbl_RhsExpression, dbl_RuntimeExpr, dbl_AtLeastOneExpr, dbl_ArbitraryExpr, dbl_AlternativeExpr, dbl_TerminalExpr, dbl_PropertyBindingExpr, dbl_PropertyType, dbl_IdPropertyType, PropertyType, dbl_IntPropertyType, dbl_StringPropertyType, dbl_BooleanPropertyType, dbl_RuleExpr, dbl_SequenceExpr, RhsExpression, dbl_OptionalExpr, dbl_MetaExpr, dbl_TargetStatement, dbl_MappingStatement, dbl_SetGenContextStatement, dbl_ResetGenContextStatement, dbl_SaveGenStatement, dbl_ResumeGenStatement, dbl_FixedMappingPart, MappingPart, dbl_StructuredPropertyType, dbl_CompositePropertyType, StructuredPropertyType, dbl_ReferencePropertyType, dbl_Pattern, dbl_MappingPart, dbl_ExpandSection, dbl_CodeQuoteExpression, dbl_QuotedCode, dbl_QuotedExpression, QuotedCode, dbl_QuotedStatements, dbl_QuotedClassContent, dbl_QuotedModuleContent, Module, dbl_ExpandableElement, dbl_TestStatement, dbl_DynamicMappingPart, dbl_ExpandExpression, dbl_ExpandStatement, dbl_IncludePattern, dbl_PotentiallyHiddenIdElements, dbl_FindContainer, dbl_ConsiderIdElements, BindingExprOpKind},
    associations={model3, classifiers6, classAugments8, extensionDefs10, annotationDefs12, procedures14, variables16, idRes18, extensions20, modifierExtensions21, primitiveType23, listDims24, classifierTypeExpr26, imports0, modules1, parameters28, keyValuePairs35, key37, value39, annotationApplications41, simpleAnnotations43, bindings45, attributes47, methods49, superClass52, implementedInterfaces54, initialBlock56, finalBlock58, keys30, annotationDef33, constructor70, baseConstructorArguments72, parameters75, augmentedClass78, methods81, superInterfaces85, actionsBlock61, reportBlock64, clearBlock67, expression91, variable92, value94, procedureCall97, procedureAccess99, value101, condition103, objectAccess105, initialValue87, statements90, object113, set115, atIndex118, condition119, ifCaseBlock121, elifCondition124, elifCaseBlock127, elseCaseBlock130, condition133, whileBlock135, iteratorVariableDefinition138, objectAccess107, time109, outputs111, op1149, op2151, op154, iteratorVariableReference140, iterableExpression143, forBlock146, expr156, set158, idExpr173, abstractSyntaxDef175, textualSyntaxDef178, mappingDef180, extensionRule182, newRules184, parentIdExpr161, rhs186, referencedElement163, predefinedId165, arguments167, arguments170, expression197, expression199, expression201, left203, right205, propertyType208, rule209, instantiableMetaClass188, firstNewRule191, sequence193, expression195, metaObject216, expr219, codeBlock221, parts223, exprs225, context228, variable230, variable232, type212, idResolutionPattern213, parts214, codeBlock243, quotedCode245, expression246, statements248, expandExpression250, patterns252, context255, codeBlock258, expr234, metaObject236, metaObject238, location240, pattern273, context275, codeBlock261, variableBinding263, containerBlock265, elseBlock268, elementsQuery271},
    generalizations={gen_dbl_Module_NamedElement, gen_dbl_Module_EmbeddableExtensionsContainer, gen_dbl_ListDimension_TypedElement, gen_dbl_Construct_NamedExtensible, gen_dbl_VoidType_PrimitiveType, gen_dbl_IntType_PrimitiveType, gen_dbl_BoolType_PrimitiveType, gen_dbl_DoubleType_PrimitiveType, gen_dbl_StringType_PrimitiveType, gen_dbl_Procedure_NamedElement, gen_dbl_Procedure_TypedElement, gen_dbl_Procedure_CodeBlock, gen_dbl_Procedure_AnnotatableElement, gen_dbl_PrimitiveType_Type, gen_dbl_Classifier_Type, gen_dbl_Classifier_NamedElement, gen_dbl_Classifier_ReferableRhsType, gen_dbl_ClassSimilar_EmbeddableExtensionsContainer, gen_dbl_ClassSimilar_ModifierExtensionsContainer, gen_dbl_SimpleAnnotation_NamedElement, gen_dbl_Annotation_NamedElement, gen_dbl_StartCodeBlock_CodeBlock, gen_dbl_Clazz_Classifier, gen_dbl_Clazz_ClassSimilar, gen_dbl_ClassAugment_ClassSimilar, gen_dbl_Interface_Classifier, gen_dbl_AbstractVariable_NamedElement, gen_dbl_AbstractVariable_TypedElement, gen_dbl_Variable_AbstractVariable, gen_dbl_Statement_Construct, gen_dbl_CompositeStatement_Statement, gen_dbl_SimpleStatement_Statement, gen_dbl_ExpressionStatement_SimpleStatement, gen_dbl_Assignment_SimpleStatement, gen_dbl_DeprecatedProcedureCallStatement_ExpressionStatement, gen_dbl_ProcedureCall_StatementExpression, gen_dbl_Return_SimpleStatement, gen_dbl_WaitUntil_SimpleStatement, gen_dbl_Terminate_SimpleStatement, gen_dbl_Yield_SimpleStatement, gen_dbl_Wait_SimpleStatement, gen_dbl_Reactivate_SimpleStatement, gen_dbl_ActivateObject_SimpleStatement, gen_dbl_Variable_Statement, gen_dbl_Variable_ModifierExtensionsContainer, gen_dbl_Parameter_AbstractVariable, gen_dbl_NamedElement_ExpandableElement, gen_dbl_CodeBlock_Construct, gen_dbl_SetStatement_SimpleStatement, gen_dbl_RemoveFromSet_SetStatement, gen_dbl_AddToSet_SetStatement, gen_dbl_EmptySet_SetStatement, gen_dbl_IfStatement_CompositeStatement, gen_dbl_WhileStatement_CompositeStatement, gen_dbl_BreakStatement_SimpleStatement, gen_dbl_ContinueStatement_SimpleStatement, gen_dbl_ForEachStatement_CompositeStatement, gen_dbl_Advance_SimpleStatement, gen_dbl_Print_SimpleStatement, gen_dbl_BinaryOperator_Expression, gen_dbl_UnaryOperator_Expression, gen_dbl_And_BinaryOperator, gen_dbl_Or_BinaryOperator, gen_dbl_Greater_BinaryOperator, gen_dbl_GreaterEqual_BinaryOperator, gen_dbl_Less_BinaryOperator, gen_dbl_LessEqual_BinaryOperator, gen_dbl_NotEqual_BinaryOperator, gen_dbl_Equal_BinaryOperator, gen_dbl_InstanceOf_BinaryOperator, gen_dbl_Plus_BinaryOperator, gen_dbl_Minus_BinaryOperator, gen_dbl_Mul_BinaryOperator, gen_dbl_Mod_BinaryOperator, gen_dbl_Div_BinaryOperator, gen_dbl_Neg_UnaryOperator, gen_dbl_Not_UnaryOperator, gen_dbl_Cast_UnaryOperator, gen_dbl_Cast_TypedElement, gen_dbl_CreateObject_L1Expr, gen_dbl_CreateObject_TypedElement, gen_dbl_NullLiteral_L1Expr, gen_dbl_Expression_Construct, gen_dbl_L1Expr_Expression, gen_dbl_MeLiteral_PredefinedId, gen_dbl_SuperLiteral_PredefinedId, gen_dbl_MetaLiteral_PredefinedId, gen_dbl_TypeLiteral_PredefinedId, gen_dbl_SetOp_PredefinedId, gen_dbl_SizeOfSet_SetOp, gen_dbl_FirstInSet_SetOp, gen_dbl_LastInSet_SetOp, gen_dbl_Contains_SetOp, gen_dbl_IndexOf_SetOp, gen_dbl_ObjectAt_SetOp, gen_dbl_BeforeInSet_SetOp, gen_dbl_AfterInSet_SetOp, gen_dbl_TimeLiteral_L1Expr, gen_dbl_ActiveLiteral_L1Expr, gen_dbl_StringLiteral_L1Expr, gen_dbl_IntLiteral_L1Expr, gen_dbl_TrueLiteral_L1Expr, gen_dbl_FalseLiteral_L1Expr, gen_dbl_DoubleLiteral_L1Expr, gen_dbl_ElementAccess_Expression, gen_dbl_EvalExpr_Expression, gen_dbl_VariableAccess_ElementAccess, gen_dbl_VariableAccess_ExpandableElement, gen_dbl_MetaAccess_VariableAccess, gen_dbl_TypeAccess_ElementAccess, gen_dbl_TypeAccess_ExpandableElement, gen_dbl_NamedExtensible_ExtensibleElement, gen_dbl_NamedExtensible_NamedElement, gen_dbl_ClassContentExtension_NamedExtensible, gen_dbl_ModuleContentExtension_NamedExtensible, gen_dbl_ExtensionDefinition_NamedElement, gen_dbl_ReferableRhsType_NamedElement, gen_dbl_TsRule_NamedElement, gen_dbl_TsRule_ReferableRhsType, gen_dbl_IdExpr_L1Expr, gen_dbl_RuntimeExpr_RhsExpression, gen_dbl_AtLeastOneExpr_RhsExpression, gen_dbl_ArbitraryExpr_RhsExpression, gen_dbl_AlternativeExpr_RhsExpression, gen_dbl_TerminalExpr_RhsExpression, gen_dbl_PropertyBindingExpr_NamedElement, gen_dbl_PropertyBindingExpr_RhsExpression, gen_dbl_RuleExpr_RhsExpression, gen_dbl_IdPropertyType_PropertyType, gen_dbl_IntPropertyType_PropertyType, gen_dbl_StringPropertyType_PropertyType, gen_dbl_BooleanPropertyType_PropertyType, gen_dbl_ExtensionRule_NamedElement, gen_dbl_SequenceExpr_RhsExpression, gen_dbl_OptionalExpr_RhsExpression, gen_dbl_MetaExpr_Expression, gen_dbl_TargetStatement_Statement, gen_dbl_MappingStatement_Statement, gen_dbl_SetGenContextStatement_SimpleStatement, gen_dbl_ResetGenContextStatement_SimpleStatement, gen_dbl_SaveGenStatement_SimpleStatement, gen_dbl_ResumeGenStatement_SimpleStatement, gen_dbl_FixedMappingPart_MappingPart, gen_dbl_StructuredPropertyType_PropertyType, gen_dbl_CompositePropertyType_StructuredPropertyType, gen_dbl_ReferencePropertyType_StructuredPropertyType, gen_dbl_Mapping_CodeBlock, gen_dbl_ExpandSection_CompositeStatement, gen_dbl_CodeQuoteExpression_Expression, gen_dbl_QuotedExpression_QuotedCode, gen_dbl_QuotedStatements_QuotedCode, gen_dbl_QuotedClassContent_QuotedCode, gen_dbl_QuotedClassContent_ClassSimilar, gen_dbl_QuotedModuleContent_QuotedCode, gen_dbl_QuotedModuleContent_Module, gen_dbl_TestStatement_Statement, gen_dbl_Pattern_NamedElement, gen_dbl_DynamicMappingPart_MappingPart, gen_dbl_ExpandExpression_StatementExpression, gen_dbl_ExpandExpression_Expression, gen_dbl_ExpandStatement_Statement, gen_dbl_IncludePattern_Statement, gen_dbl_PotentiallyHiddenIdElements_Statement, gen_dbl_FindContainer_Statement, gen_dbl_ConsiderIdElements_Statement},
    metadata=None
)
