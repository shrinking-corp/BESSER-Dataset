...
def test_hyp_namedextensible_is_not_abstract():
    assert not inspect.isabstract(NamedExtensible)


def test_hyp_namedextensible_constructor_exists():
    assert callable(NamedExtensible.__init__)


def test_hyp_namedextensible_constructor_args():
...
def test_hyp_dbl_listdimension_is_not_abstract():
    assert not inspect.isabstract(dbl_ListDimension)


def test_hyp_dbl_listdimension_constructor_exists():
    assert callable(dbl_ListDimension.__init__)


def test_hyp_dbl_listdimension_constructor_args():
...
def test_hyp_dbl_namedextensible_is_not_abstract():
    assert not inspect.isabstract(dbl_NamedExtensible)


def test_hyp_dbl_namedextensible_constructor_exists():
    assert callable(dbl_NamedExtensible.__init__)


def test_hyp_dbl_namedextensible_constructor_args():
...
def test_hyp_dbl_listdimension_size_setter(instance):
...
def test_hyp_dbl_extensibleelement_objectIsExtensionInstance_setter(instance):
