...
class tutorial_Member:
    ...
    def __init__(self, name: str, members: "tutorial_Library" = None, tutorial_Member: set["tutorial_Loan"] = None, Member: "tutorial_Library" = None, tutorial_Member12: set["tutorial_Book"] = None, tutorial_Member19: "tutorial_Loan" = None):
        self.name = name
