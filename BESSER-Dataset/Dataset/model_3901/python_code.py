...
class bpmnprof_StandardLoopCharacteristics(LoopCharacteristics):
    ...
    def StandardLoopCharacteristicstestBefore(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement StandardLoopCharacteristicstestBefore method
        pass

    def StandardLoopCharacteristicsloopCondition(self, bpmnprof_diagnostics, bpmnprof_context) :
...
class bpmnprof_AdHocSubProcess(SubProcess):
    ...
    def AdHocSubProcesscancelRemainingInstances(self, bpmnprof_context, bpmnprof_diagnostics) :
...
class bpmnprof_SubConversation(ConversationNode):
    ...
    def SubConversationconnectedelements(self, bpmnprof_context, bpmnprof_diagnostics) :
...
class bpmnprof_CallConversation(ConversationNode):
    ...
    def CallConversationcalledCollaborationRef(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement CallConversationcalledCollaborationRef method
        pass

    def CallConversationparticipantAssociations(self, bpmnprof_context, bpmnprof_diagnostics) :
...
class bpmnprof_GlobalConversation(BPMNCollaboration):
    ...
    def __init__(self):
        ...
        pass
    def GlobalConversationcontainedelements(self, bpmnprof_context, bpmnprof_diagnostics) :
...
class bpmnprof_BusinessRuleTask(Task):
    ...
    def BusinessRuleTaskimplementation(self, bpmnprof_context, bpmnprof_diagnostics) :
...
class bpmnprof_ScriptTask(Task):
    ...
    def ScriptTaskscriptFormat(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement ScriptTaskscriptFormat method
        pass

    def ScriptTaskscript(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement ScriptTaskscript method
        pass

class bpmnprof_UserTask(Task):

    def __init__(self, implementation: str, bpmnprof_UserTask: "bpmnprof_OpaqueAction" = None, bpmnprof_UserTask591: set["bpmnprof_Rendering"] = None):
        self.implementation = implementation
    ...
    def UserTaskrenderings(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement UserTaskrenderings method
        pass

    def UserTaskimplementation(self, bpmnprof_context, bpmnprof_diagnostics) :
...
class bpmnprof_CallActivity(BPMNActivity):
    ...
    def CallActivitycalledElementRefvalues(self, bpmnprof_diagnostics, bpmnprof_context) :
...
class bpmnprof_DataOutputAssociation(DataAssociation):
    ...
    def __init__(self, bpmnprof_DataOutputAssociation470: "bpmnprof_CatchEvent" = None, bpmnprof_DataOutputAssociation: "bpmnprof_BPMNActivity" = None):
    ...
    def dataOutputAssociationtarget(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement dataOutputAssociationtarget method
        pass

    def dataOutputAssociationsource(self, bpmnprof_context, bpmnprof_diagnostics) :
...
class bpmnprof_DataInputAssociation(DataAssociation):
    ...
    def dataInputAssociationtarget(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement dataInputAssociationtarget method
        pass

    def dataInputAssociationsource(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement dataInputAssociationsource method
        pass

class bpmnprof_BoundaryEvent(CatchEvent):

    def __init__(self, cancelActivity: str, bpmnprof_BoundaryEvent463: "bpmnprof_BPMNActivity" = None, bpmnprof_BoundaryEvent: "bpmnprof_BPMNActivity" = None):
    ...
    def boundaryEventattachedToRef(self, bpmnprof_context, bpmnprof_diagnostics) :
...
class bpmnprof_ThrowEvent(BPMNEvent):
    ...
    def ThrowEventeventDefinitionRefs(self, bpmnprof_diagnostics, bpmnprof_context) :
...
class bpmnprof_CatchEvent(BPMNEvent):
    ...
    def catchEventeventDefinitionsRefs(self, bpmnprof_context, bpmnprof_diagnostics) :
...
class bpmnprof_ConditionalEventDefinition(EventDefinition):
    ...
    def conditionalEventDefinitioncondition(self, bpmnprof_diagnostics, bpmnprof_context) :
...
class bpmnprof_GlobalUserTask(GlobalTask):
    ...
    def GlobalUserTaskimplementation(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement GlobalUserTaskimplementation method
        pass

    def GlobalUserTaskrenderings(self, bpmnprof_diagnostics, bpmnprof_context) :
...
class bpmnprof_GlobalScriptTask(GlobalTask):
    ...
    def GlobalScriptTaskscriptFormat(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement GlobalScriptTaskscriptFormat method
        pass

    def GlobalScriptTaskscript(self, bpmnprof_context, bpmnprof_diagnostics) :
...
class bpmnprof_GlobalBusinessRuleTask(GlobalTask):
    ...
    def GlobalBusinessRuleTaskimplementation(self, bpmnprof_diagnostics, bpmnprof_context) :
...
class bpmnprof_ResourceAssignmentExpression(BPMNExpression):
    ...
    def ResourceAssignmentExpressionexpression(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement ResourceAssignmentExpressionexpression method
        pass

class bpmnprof_FormalExpression(BPMNExpression):

    def __init__(self, bpmnprof_FormalExpression378: "bpmnprof_ItemDefinition" = None, bpmnprof_FormalExpression: "bpmnprof_CorrelationPropertyRetrievalExpression" = None, bpmnprof_FormalExpression393: "bpmnprof_CorrelationPropertyBinding" = None, bpmnprof_FormalExpression491: "bpmnprof_DataAssociation" = None, bpmnprof_FormalExpression621: "bpmnprof_ComplexBehaviorDefinition" = None):
    ...
    def FormalExpressionevaluatesToTypeRef(self, bpmnprof_diagnostics, bpmnprof_context) :
...
class bpmnprof_ConversationNode(InteractionNode):
    ...
    def __init__(self, bpmnprof_ConversationNode345: "bpmnprof_InformationFlow" = None, bpmnprof_ConversationNode348: set["bpmnprof_MessageFlow"] = None, bpmnprof_ConversationNode351: set["bpmnprof_CorrelationKey"] = None, bpmnprof_ConversationNode354: set["bpmnprof_Participant"] = None, bpmnprof_ConversationNode: "bpmnprof_BPMNCollaboration" = None, bpmnprof_ConversationNode601: "bpmnprof_SubConversation" = None):
    ...
    def ConversationNodeparticipantRefs(self, bpmnprof_diagnostics, bpmnprof_context) :
...
class bpmnprof_Escalation(ItemDefinition):
    ...
    def EscalationstructureRef(self, bpmnprof_context, bpmnprof_diagnostics) :
...
class bpmnprof_Resource(ItemDefinition):
    ...
    def ResourceresourceParameters(self, bpmnprof_diagnostics, bpmnprof_context) :
...
class bpmnprof_BPMNSignal(ItemDefinition):
    ...
    def BPMNSignalstructureRef(self, bpmnprof_diagnostics, bpmnprof_context) :
...
class bpmnprof_BPMNMessage(ItemDefinition):
    ...
    def __init__(self, bpmnprof_BPMNMessage: "bpmnprof_BPMNOperation" = None, bpmnprof_BPMNMessage246: "bpmnprof_BPMNOperation" = None, bpmnprof_BPMNMessage250: "bpmnprof_ItemDefinition" = None, bpmnprof_BPMNMessage374: "bpmnprof_CorrelationPropertyRetrievalExpression" = None, bpmnprof_BPMNMessage343: "bpmnprof_MessageFlow" = None, bpmnprof_BPMNMessage532: "bpmnprof_MessageEventDefinition" = None, bpmnprof_BPMNMessage632: "bpmnprof_SendTask" = None, bpmnprof_BPMNMessage644: "bpmnprof_ReceiveTask" = None):
    ...
    def MessageitemRef(self, bpmnprof_diagnostics, bpmnprof_context) :
...
class bpmnprof_DataOutput(ItemAwareElement):
    ...
    def __init__(self, isCollection: str, bpmnprof_DataOutput: "bpmnprof_InputOutputSpecification" = None, bpmnprof_DataOutput222: "bpmnprof_OutputSet" = None, bpmnprof_DataOutput225: "bpmnprof_OutputSet" = None, bpmnprof_DataOutput203: "bpmnprof_OutputPin" = None, bpmnprof_DataOutput205: "bpmnprof_Parameter" = None, bpmnprof_DataOutput208: "bpmnprof_ActivityParameterNode" = None, dataOutputRefs: set["bpmnprof_OutputSet"] = None, bpmnprof_DataOutput212: set["bpmnprof_OutputSet"] = None, bpmnprof_DataOutput215: set["bpmnprof_OutputSet"] = None, DataOutput: "bpmnprof_OutputSet" = None, bpmnprof_DataOutput671: "bpmnprof_MultiInstanceLoopCharacteristics" = None):
    ...
    def DataOutputitemSubjectRef(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement DataOutputitemSubjectRef method
        pass

    def DataOutputnotation(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement DataOutputnotation method
        pass

class bpmnprof_DataInput(ItemAwareElement):

    def __init__(self, isCollection: str, bpmnprof_DataInput: "bpmnprof_InputOutputSpecification" = None, bpmnprof_DataInput169: "bpmnprof_InputPin" = None, bpmnprof_DataInput171: "bpmnprof_Parameter" = None, bpmnprof_DataInput173: "bpmnprof_ActivityParameterNode" = None, dataInputRefs: set["bpmnprof_InputSet"] = None, optionalInputRefs: set["bpmnprof_InputSet"] = None, whileExecutingInputRefs: set["bpmnprof_InputSet"] = None, DataInput: "bpmnprof_InputSet" = None, DataInput199: "bpmnprof_InputSet" = None, DataInput201: "bpmnprof_InputSet" = None, bpmnprof_DataInput674: "bpmnprof_MultiInstanceLoopCharacteristics" = None):
        self.isCollection = isCollection
    ...
    def DataInputitemSubjectRef(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement DataInputitemSubjectRef method
        pass

    def DataInputAssociation(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement DataInputAssociation method
        pass

    def DataInputnotation(self, bpmnprof_context, bpmnprof_diagnostics) :
...
class bpmnprof_ItemDefinition(RootElement):
    ...
    def __init__(self, itemKind: str, isCollection: str, bpmnprof_ItemDefinition: "bpmnprof_ItemAwareElement" = None, bpmnprof_ItemDefinition187: "bpmnprof_Class" = None, bpmnprof_ItemDefinition190: "bpmnprof_Element" = None, bpmnprof_ItemDefinition193: "bpmnprof_Import" = None, bpmnprof_ItemDefinition251: "bpmnprof_BPMNMessage" = None, bpmnprof_ItemDefinition379: "bpmnprof_FormalExpression" = None, bpmnprof_ItemDefinition366: "bpmnprof_CorrelationProperty" = None, bpmnprof_ItemDefinition421: "bpmnprof_ResourceParameter" = None, bpmnprof_ItemDefinition583: "bpmnprof_DataStore" = None):
    ...
    def ItemDefinitionstructureRef(self, bpmnprof_context, bpmnprof_diagnostics) :
...
class bpmnprof_PartnerEntity(RootElement):
    ...
    def PartnerEntityparticipantRef(self, bpmnprof_diagnostics, bpmnprof_context) :
...
class bpmnprof_BPMNInterface(RootElement):
    ...
    def BPMNInterfaceoperations(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement BPMNInterfaceoperations method
        pass

    def Interfaceoperationmultiplicity(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement Interfaceoperationmultiplicity method
        pass

    def InterfaceownedOperation(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement InterfaceownedOperation method
        pass

    def BPMNInterfacecallableElements(self, bpmnprof_diagnostics, bpmnprof_context) :
...
class bpmnprof_PartnerRole(RootElement):
    ...
    def PartnerRoleparticipantRef(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement PartnerRoleparticipantRef method
        pass

class bpmnprof_CallableElement(RootElement):

    def __init__(self, bpmnprof_CallableElement150: "bpmnprof_InputOutputSpecification" = None, bpmnprof_CallableElement152: set["bpmnprof_BPMNInterface"] = None, bpmnprof_CallableElement154: set["bpmnprof_InputOutputBinding"] = None, bpmnprof_CallableElement: "bpmnprof_Behavior" = None, bpmnprof_CallableElement236: "bpmnprof_BPMNInterface" = None, bpmnprof_CallableElement617: "bpmnprof_CallActivity" = None):
    ...
    def CallableEelementsupportedInterfaceRefs(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement CallableEelementsupportedInterfaceRefs method
        pass

    def CallableElementresources(self, bpmnprof_context, bpmnprof_diagnostics) :
...
class bpmnprof_BPMNCollaboration(RootElement):
    ...
    def __init__(self, isClosed: str, bpmnprof_BPMNCollaboration: "bpmnprof_BPMNProcess" = None, bpmnprof_BPMNCollaboration265: set["bpmnprof_ParticipantAssociation"] = None, collaboration: set["bpmnprof_ConversationLink"] = None, bpmnprof_BPMNCollaboration276: set["bpmnprof_CorrelationKey"] = None, bpmnprof_BPMNCollaboration278: set["bpmnprof_Participant"] = None, bpmnprof_BPMNCollaboration268: set["bpmnprof_MessageFlowAssociation"] = None, bpmnprof_BPMNCollaboration270: set["bpmnprof_MessageFlow"] = None, bpmnprof_BPMNCollaboration272: "bpmnprof_Collaboration" = None, bpmnprof_BPMNCollaboration274: set["bpmnprof_ConversationNode"] = None, BPMNCollaboration: "bpmnprof_ConversationLink" = None, bpmnprof_BPMNCollaboration605: "bpmnprof_CallConversation" = None):
    ...
    def Collaborationparticipants(self, bpmnprof_diagnostics, bpmnprof_context) :
...
class FlowElementsContainer:
    ...
    pass
class bpmnprof_SubProcess(BPMNActivity, FlowElementsContainer):
    ...
    def SubProcesstriggeredByEvent(self, bpmnprof_diagnostics, bpmnprof_context) :
...
class bpmnprof_GlobalTask(CallableElement):
    ...
    def GlobalTasksupportedInterfaceRefs(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement GlobalTasksupportedInterfaceRefs method
        pass

class bpmnprof_BPMNProcess(CallableElement, FlowElementsContainer):

    def __init__(self, processType: str, isClosed: str, isExecutable: str, bpmnprof_BPMNProcess140: "bpmnprof_Monitoring" = None, bpmnprof_BPMNProcess144: "bpmnprof_BPMNProcess" = None, bpmnprof_BPMNProcess142: "bpmnprof_BPMNProcess" = None, bpmnprof_BPMNProcess146: set["bpmnprof_BPMNProperty"] = None, process: set["bpmnprof_ResourceRole"] = None, bpmnprof_BPMNProcess: "bpmnprof_Auditing" = None, bpmnprof_BPMNProcess134: "bpmnprof_BPMNCollaboration" = None, bpmnprof_BPMNProcess136: "bpmnprof_Activity" = None, bpmnprof_BPMNProcess138: set["bpmnprof_CorrelationSubscription"] = None, bpmnprof_BPMNProcess293: "bpmnprof_Participant" = None, BPMNProcess: "bpmnprof_ResourceRole" = None):
    ...
    def ProcessflowElements(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement ProcessflowElements method
        pass

    def Processproperties(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement Processproperties method
        pass

    def Processsupports(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement Processsupports method
        pass

    def ProcesssupportedInterfaceRefs(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement ProcesssupportedInterfaceRefs method
        pass

    def ProcesslaneSets(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement ProcesslaneSets method
        pass

class bpmnprof_BPMNProperty(ItemAwareElement):

    def __init__(self, bpmnprof_BPMNProperty: "bpmnprof_BPMNProcess" = None, bpmnprof_BPMNProperty398: "bpmnprof_DataStoreNode" = None, bpmnprof_BPMNProperty400: "bpmnprof_Property" = None, bpmnprof_BPMNProperty478: "bpmnprof_BPMNEvent" = None, bpmnprof_BPMNProperty447: "bpmnprof_BPMNActivity" = None):
    ...
    def BPMNPropertyapply(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement BPMNPropertyapply method
        pass

    def Propertynotation(self, bpmnprof_diagnostics, bpmnprof_context) :
...
class bpmnprof_ExtensionAttributeDefinition:
    ...
    def __init__(self, type: str, isReference: str, bpmnprof_ExtensionAttributeDefinition: "bpmnprof_ExtensionAttributeValue" = None, bpmnprof_ExtensionAttributeDefinition31: "bpmnprof_Property" = None, bpmnprof_ExtensionAttributeDefinition38: "bpmnprof_ExtensionDefinition" = None):
        self.type = type
...
class bpmnprof_BPMNAssociation(BPMNArtifact):
    ...
    def AssociationEnd(self, bpmnprof_diagnostics, bpmnprof_context) :
...
class bpmnprof_ResourceParameter(BaseElement):
    ...
    def __init__(self, isRequired: str, bpmnprof_ResourceParameter417: "bpmnprof_Property" = None, bpmnprof_ResourceParameter420: "bpmnprof_ItemDefinition" = None, bpmnprof_ResourceParameter: "bpmnprof_Resource" = None, bpmnprof_ResourceParameter427: "bpmnprof_ResourceParameterBinding" = None):
    ...
    def ResourceParameterisRequired(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement ResourceParameterisRequired method
        pass

    def ResourceParametertype(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement ResourceParametertype method
        pass

    def ResourceParameterowner(self, bpmnprof_diagnostics, bpmnprof_context) :
...
class bpmnprof_BPMNOperation(BaseElement):
    ...
    def __init__(self, bpmnprof_BPMNOperation260: "bpmnprof_InputOutputBinding" = None, bpmnprof_BPMNOperation: "bpmnprof_BPMNInterface" = None, bpmnprof_BPMNOperation238: "bpmnprof_Operation" = None, bpmnprof_BPMNOperation240: "bpmnprof_Element" = None, bpmnprof_BPMNOperation243: "bpmnprof_BPMNMessage" = None, bpmnprof_BPMNOperation245: "bpmnprof_BPMNMessage" = None, bpmnprof_BPMNOperation248: set["bpmnprof_Error"] = None, bpmnprof_BPMNOperation535: "bpmnprof_MessageEventDefinition" = None, bpmnprof_BPMNOperation638: "bpmnprof_SendTask" = None, bpmnprof_BPMNOperation650: "bpmnprof_ReceiveTask" = None, bpmnprof_BPMNOperation655: "bpmnprof_ServiceTask" = None):
    ...
    def BPMNOperationerrorRefs(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement BPMNOperationerrorRefs method
        pass

    def BPMNOperationinMessageRef(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement BPMNOperationinMessageRef method
        pass

    def BPMNOperationowner(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement BPMNOperationowner method
        pass

    def BPMNOperationoutMessageRef(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement BPMNOperationoutMessageRef method
        pass

class bpmnprof_InputSet(BaseElement):

    def __init__(self, bpmnprof_InputSet: "bpmnprof_InputOutputSpecification" = None, InputSet: "bpmnprof_DataInput" = None, InputSet176: "bpmnprof_DataInput" = None, InputSet178: "bpmnprof_DataInput" = None, inputSetWithOptional: set["bpmnprof_DataInput"] = None, inputSetWithWhileExecuting: set["bpmnprof_DataInput"] = None, inputSetRefs: set["bpmnprof_DataInput"] = None, bpmnprof_InputSet196: "bpmnprof_ParameterSet" = None, bpmnprof_InputSet254: "bpmnprof_InputOutputBinding" = None):
    ...
    def InputSetdataInputRefs(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement InputSetdataInputRefs method
        pass

    def InputSetoptionalInputRefs(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement InputSetoptionalInputRefs method
        pass

    def InputSetwhileExecutingInputRefs(self, bpmnprof_context, bpmnprof_diagnostics) :
...
class bpmnprof_ResourceRole(BaseElement):
    ...
    def ResourceRoleisRequired(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement ResourceRoleisRequired method
        pass

    def ResourceRoleresourceParameterBindings(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement ResourceRoleresourceParameterBindings method
        pass

    def ResourceRoleresourceRef(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement ResourceRoleresourceRef method
        pass

    def ResourceRoleprocess(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement ResourceRoleprocess method
        pass

    def ResourceRoleowner(self, bpmnprof_diagnostics, bpmnprof_context) :
...
class bpmnprof_ResourceParameterBinding(BaseElement):
    ...
    def ResourceParameterBindingexpression(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement ResourceParameterBindingexpression method
        pass

    def ResourceParameterBindingparameterRef(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement ResourceParameterBindingparameterRef method
        pass

class bpmnprof_OutputSet(BaseElement):

    def __init__(self, bpmnprof_OutputSet: "bpmnprof_InputOutputSpecification" = None, bpmnprof_OutputSet257: "bpmnprof_InputOutputBinding" = None, bpmnprof_OutputSet221: set["bpmnprof_DataOutput"] = None, bpmnprof_OutputSet224: set["bpmnprof_DataOutput"] = None, OutputSet: "bpmnprof_DataOutput" = None, bpmnprof_OutputSet213: "bpmnprof_DataOutput" = None, bpmnprof_OutputSet216: "bpmnprof_DataOutput" = None, bpmnprof_OutputSet218: "bpmnprof_ParameterSet" = None, outputSetRefs: set["bpmnprof_DataOutput"] = None):
    ...
    def OutputSetoptionalOutputRefs(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement OutputSetoptionalOutputRefs method
        pass

    def OutputSetwhileExecutingOutputRefs(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement OutputSetwhileExecutingOutputRefs method
        pass

    def OutputSetdataOutputRefs(self, bpmnprof_diagnostics, bpmnprof_context) :
...
class bpmnprof_LaneSet(BaseElement):
    ...
    def __init__(self, LaneSet: "bpmnprof_FlowElementsContainer" = None, LaneSet75: "bpmnprof_Lane" = None, bpmnprof_LaneSet: "bpmnprof_ActivityPartition" = None, laneSet: set["bpmnprof_Lane"] = None, bpmnprof_LaneSet56: set["bpmnprof_Lane"] = None, laneSets: "bpmnprof_FlowElementsContainer" = None, bpmnprof_LaneSet73: "bpmnprof_Lane" = None, bpmnprof_LaneSet613: "bpmnprof_SubProcess" = None):
    ...
    def LaneSet(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement LaneSet method
        pass

    def LaneSetflowElementsContainer(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement LaneSetflowElementsContainer method
        pass

    def LaneSetparentLane(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement LaneSetparentLane method
        pass

    def LaneSetlanes(self, bpmnprof_diagnostics, bpmnprof_context) :
...
class bpmnprof_MessageFlow(BaseElement):
    ...
    def __init__(self, bpmnprof_MessageFlow349: "bpmnprof_ConversationNode" = None, bpmnprof_MessageFlow: "bpmnprof_BPMNCollaboration" = None, bpmnprof_MessageFlow329: "bpmnprof_MessageFlowAssociation" = None, bpmnprof_MessageFlow332: "bpmnprof_MessageFlowAssociation" = None, bpmnprof_MessageFlow334: "bpmnprof_InformationFlow" = None, bpmnprof_MessageFlow336: "bpmnprof_InteractionNode" = None, bpmnprof_MessageFlow339: "bpmnprof_InteractionNode" = None, bpmnprof_MessageFlow342: "bpmnprof_BPMNMessage" = None):
    ...
    def MessageFlowsourceRef(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement MessageFlowsourceRef method
        pass

    def MessageFlowtargetRef(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement MessageFlowtargetRef method
        pass

    def MessageFlowmessageRef(self, bpmnprof_diagnostics, bpmnprof_context) :
...
class bpmnprof_ItemAwareElement(BaseElement):
    ...
    def ItemAwareElementdataState(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement ItemAwareElementdataState method
        pass

class bpmnprof_Lane(BaseElement):

    def __init__(self, lanes: "bpmnprof_LaneSet" = None, Lane: "bpmnprof_LaneSet" = None, bpmnprof_Lane: "bpmnprof_LaneSet" = None, bpmnprof_Lane60: "bpmnprof_ActivityPartition" = None, bpmnprof_Lane63: "bpmnprof_Element" = None, bpmnprof_Lane66: set["bpmnprof_FlowNode"] = None, bpmnprof_Lane69: "bpmnprof_BaseElement" = None, bpmnprof_Lane72: "bpmnprof_LaneSet" = None):
        self.lanes = lanes
        self.Lane = Lane
    ...
    def LanechildLaneSet(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement LanechildLaneSet method
        pass

    def LanelaneSet(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement LanelaneSet method
        pass

    def LaneflowNodeRefs(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement LaneflowNodeRefs method
        pass

    def LanepartitionElementRef(self, bpmnprof_context, bpmnprof_diagnostics) :
...
class bpmnprof_MessageFlowAssociation(BaseElement):
    ...
    def MessageFlowAssociationinnerMessageFlowRef(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement MessageFlowAssociationinnerMessageFlowRef method
        pass

    def MessageFlowAssociationouterMessageFlowRef(self, bpmnprof_diagnostics, bpmnprof_context) :
...
class bpmnprof_Definitions(BaseElement):
    ...
    def __init__(self, targetNamespace: str, expressionLanguage: str, typeLanguage: str, exporter: str, exporterVersion: str, Definitions: "bpmnprof_RootElement" = None, bpmnprof_Definitions: "bpmnprof_Package" = None, bpmnprof_Definitions103: set["bpmnprof_BPMNExtension"] = None, bpmnprof_Definitions105: set["bpmnprof_Import"] = None, bpmnprof_Definitions107: set["bpmnprof_BPMNRelationship"] = None, definition: set["bpmnprof_RootElement"] = None, bpmnprof_Definitions119: "bpmnprof_Import" = None, bpmnprof_Definitions130: "bpmnprof_BPMNRelationship" = None):
...
class bpmnprof_Participant(BaseElement):
    ...
    def __init__(self, bpmnprof_Participant284: "bpmnprof_ParticipantAssociation" = None, bpmnprof_Participant287: "bpmnprof_ParticipantAssociation" = None, bpmnprof_Participant: "bpmnprof_BPMNCollaboration" = None, bpmnprof_Participant355: "bpmnprof_ConversationNode" = None, bpmnprof_Participant289: "bpmnprof_Property" = None, bpmnprof_Participant292: "bpmnprof_BPMNProcess" = None, bpmnprof_Participant295: "bpmnprof_ParticipantMultiplicity" = None, participantRef: set["bpmnprof_PartnerEntity"] = None, participantRef298: set["bpmnprof_PartnerRole"] = None, bpmnprof_Participant300: set["bpmnprof_BPMNInterface"] = None, Participant: "bpmnprof_PartnerEntity" = None, Participant323: "bpmnprof_PartnerRole" = None):
    ...
    def Participantownership(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement Participantownership method
        pass

    def Participantrealizationsupplier(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement Participantrealizationsupplier method
        pass

    def ParticipantmultiplicityMaximum(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement ParticipantmultiplicityMaximum method
        pass

    def participantpartnerRoleRef(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement participantpartnerRoleRef method
        pass

    def participantpartnerEntityRef(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement participantpartnerEntityRef method
        pass

    def ParticipantinterfaceRefs(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement ParticipantinterfaceRefs method
        pass

    def ParticipantmultiplicityMinimum(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement ParticipantmultiplicityMinimum method
        pass

    def Participanttype(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement Participanttype method
        pass

    def ParticipantprocessRef(self, bpmnprof_context, bpmnprof_diagnostics) :
...
class bpmnprof_DataAssociation(BaseElement):
    ...
    def DataAssociationtransformation(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement DataAssociationtransformation method
        pass

    def DataAssociationtarget(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement DataAssociationtarget method
        pass

    def DataAssociationsource(self, bpmnprof_diagnostics, bpmnprof_context) :
...
class bpmnprof_ParticipantAssociation(BaseElement):
    ...
    def __init__(self, bpmnprof_ParticipantAssociation280: "bpmnprof_Dependency" = None, bpmnprof_ParticipantAssociation283: "bpmnprof_Participant" = None, bpmnprof_ParticipantAssociation286: "bpmnprof_Participant" = None, bpmnprof_ParticipantAssociation: "bpmnprof_BPMNCollaboration" = None, bpmnprof_ParticipantAssociation608: "bpmnprof_CallConversation" = None):
    ...
    def ParticipantAssociationinnerParticipantRef(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement ParticipantAssociationinnerParticipantRef method
        pass

    def ParticipantAssociationouterParticipantRef(self, bpmnprof_context, bpmnprof_diagnostics) :
...
class bpmnprof_BPMNRelationship(BaseElement):
    ...
    def __init__(self, type: str, direction: str, bpmnprof_BPMNRelationship121: "bpmnprof_Constraint" = None, bpmnprof_BPMNRelationship123: set["bpmnprof_Element"] = None, bpmnprof_BPMNRelationship126: set["bpmnprof_Element"] = None, bpmnprof_BPMNRelationship: "bpmnprof_Definitions" = None, bpmnprof_BPMNRelationship129: "bpmnprof_Definitions" = None):
        self.type = type
...
class FlowElement:
    ...
    pass
class bpmnprof_DataStoreReference(FlowElement, ItemAwareElement):

    pass
class bpmnprof_DataObjectReference(FlowElement, ItemAwareElement):
    ...
    def DataObjectRefsourcetarget(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement DataObjectRefsourcetarget method
        pass

    def DataObjectRefdataState(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement DataObjectRefdataState method
        pass

class bpmnprof_DataObject(FlowElement, ItemAwareElement):

    def __init__(self, isCollection: str, bpmnprof_DataObject: "bpmnprof_DataObjectReference" = None, bpmnprof_DataObject577: "bpmnprof_DataStoreNode" = None):
        self.isCollection = isCollection
    ...
    def DataObjectdataState(self, bpmnprof_diagnostics, bpmnprof_context) :
...
class bpmnprof_BPMNActivity(FlowNode):
    ...
    def __init__(self, isForCompensation: str, startQuantity: str, completionQuantity: str, bpmnprof_BPMNActivity440: "bpmnprof_Action" = None, bpmnprof_BPMNActivity: "bpmnprof_CompensateEventDefinition" = None, bpmnprof_BPMNActivity464: "bpmnprof_BoundaryEvent" = None, bpmnprof_BPMNActivity443: "bpmnprof_Class" = None, bpmnprof_BPMNActivity446: set["bpmnprof_BPMNProperty"] = None, bpmnprof_BPMNActivity449: "bpmnprof_SequenceFlow" = None, bpmnprof_BPMNActivity452: set["bpmnprof_BoundaryEvent"] = None, bpmnprof_BPMNActivity454: set["bpmnprof_DataInputAssociation"] = None, bpmnprof_BPMNActivity456: set["bpmnprof_DataOutputAssociation"] = None, bpmnprof_BPMNActivity458: "bpmnprof_LoopCharacteristics" = None, bpmnprof_BPMNActivity460: set["bpmnprof_ResourceRole"] = None):
    ...
    def BPMNActivitycontainer(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement BPMNActivitycontainer method
        pass

    def BPMNActivityloopCharacteristics(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement BPMNActivityloopCharacteristics method
        pass

    def BPMNActivityresources(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement BPMNActivityresources method
        pass

    def BPMNActivitydefault(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement BPMNActivitydefault method
        pass

    def BPMNActivityproperties(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement BPMNActivityproperties method
        pass

    def BPMNActivityboundaryEventsRefs(self, bpmnprof_context, bpmnprof_diagnostics) :
...
class bpmnprof_ExclusiveGateway(Gateway):
    ...
    def exclusiveGatewaydefault(self, bpmnprof_diagnostics, bpmnprof_context) :
...
class bpmnprof_SequenceFlow(FlowElement):
    ...
    def __init__(self, isImmediate: str, bpmnprof_SequenceFlow: "bpmnprof_InclusiveGateway" = None, bpmnprof_SequenceFlow77: "bpmnprof_ControlFlow" = None, bpmnprof_SequenceFlow79: "bpmnprof_BPMNExpression" = None, bpmnprof_SequenceFlow89: "bpmnprof_ComplexGateway" = None, bpmnprof_SequenceFlow98: "bpmnprof_ExclusiveGateway" = None, bpmnprof_SequenceFlow450: "bpmnprof_BPMNActivity" = None):
    ...
    def SequenceFlowsourceRef(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement SequenceFlowsourceRef method
        pass

    def SequenceFlowtargetRef(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement SequenceFlowtargetRef method
        pass

    def SequenceFlowconditionExpression(self, bpmnprof_context, bpmnprof_diagnostics) :
...
class bpmnprof_ComplexGateway(NonExclusiveGateway):
    ...
    def complexGatewayactivationCondition(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement complexGatewayactivationCondition method
        pass

    def complexGatewaydefault(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement complexGatewaydefault method
        pass

    def complexGatewayjoinSpec(self, bpmnprof_context, bpmnprof_diagnostics) :
...
class bpmnprof_InclusiveGateway(NonExclusiveGateway):
    ...
    def inclusiveGatewaydefault(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement inclusiveGatewaydefault method
        pass

class bpmnprof_Documentation(BaseElement):

    def __init__(self, textFormat: str, text: str, bpmnprof_Documentation: "bpmnprof_BaseElement" = None, bpmnprof_Documentation33: "bpmnprof_Comment" = None):
        self.textFormat = textFormat
        self.text = text
...
class bpmnprof_ReceiveTask(Task):
    ...
    def __init__(self, implementation: str, instantiate: str, bpmnprof_ReceiveTask649: "bpmnprof_BPMNOperation" = None, bpmnprof_ReceiveTask: "bpmnprof_BPMNMessage" = None, bpmnprof_ReceiveTask646: "bpmnprof_AcceptEventAction" = None):
        self.implementation = implementation
        self.instantiate = instantiate
    ...
    def ReceiveTaskoperationRef(self, bpmnprof_context, bpmnprof_diagnostics) :
...
class bpmnprof_MultiInstanceLoopCharacteristics(LoopCharacteristics):
    ...
    def __init__(self, behavior: str, isSequential: str, bpmnprof_MultiInstanceLoopCharacteristics673: "bpmnprof_DataInput" = None, bpmnprof_MultiInstanceLoopCharacteristics676: "bpmnprof_EventDefinition" = None, bpmnprof_MultiInstanceLoopCharacteristics679: "bpmnprof_EventDefinition" = None, bpmnprof_MultiInstanceLoopCharacteristics682: set["bpmnprof_ComplexBehaviorDefinition"] = None, bpmnprof_MultiInstanceLoopCharacteristics: "bpmnprof_BPMNExpression" = None, bpmnprof_MultiInstanceLoopCharacteristics659: "bpmnprof_BPMNExpression" = None, bpmnprof_MultiInstanceLoopCharacteristics662: "bpmnprof_ExpansionRegion" = None, bpmnprof_MultiInstanceLoopCharacteristics664: "bpmnprof_ItemAwareElement" = None, bpmnprof_MultiInstanceLoopCharacteristics667: "bpmnprof_ItemAwareElement" = None, bpmnprof_MultiInstanceLoopCharacteristics670: "bpmnprof_DataOutput" = None):
    ...
    def MultiinstanceLoopCharacteristicstarget(self, bpmnprof_diagnostics, bpmnprof_context) :
...
class bpmnprof_ServiceTask(Task):
    ...
    def ServiceTaskinputSet(self, bpmnprof_context, bpmnprof_diagnostics) :
        # TODO: Implement ServiceTaskinputSet method
        pass

    def ServiceTaskoperationRef(self, bpmnprof_diagnostics, bpmnprof_context) :
        # TODO: Implement ServiceTaskoperationRef method
        pass

    def ServiceTaskoutputSet(self, bpmnprof_context, bpmnprof_diagnostics) :
...
class bpmnprof_SendTask(Task):
    ...
    def SendTaskoperationRef(self, bpmnprof_context, bpmnprof_diagnostics) :
