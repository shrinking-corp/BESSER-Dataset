...
# Classes
bpmnprof_BaseElement = Class(name="bpmnprof_BaseElement", is_abstract=True)
bpmnprof_ExtensionAttributeValue = Class(name="bpmnprof_ExtensionAttributeValue")
bpmnprof_Element = Class(name="bpmnprof_Element")
bpmnprof_Documentation = Class(name="bpmnprof_Documentation")
bpmnprof_InclusiveGateway = Class(name="bpmnprof_InclusiveGateway")
NonExclusiveGateway = Class(name="NonExclusiveGateway")
bpmnprof_SequenceFlow = Class(name="bpmnprof_SequenceFlow")
bpmnprof_NonExclusiveGateway = Class(name="bpmnprof_NonExclusiveGateway", is_abstract=True)
Gateway = Class(name="Gateway")
bpmnprof_JoinNode = Class(name="bpmnprof_JoinNode")
bpmnprof_ForkNode = Class(name="bpmnprof_ForkNode")
bpmnprof_Gateway = Class(name="bpmnprof_Gateway", is_abstract=True)
FlowNode = Class(name="FlowNode")
bpmnprof_ControlNode = Class(name="bpmnprof_ControlNode")
bpmnprof_ActivityGroup = Class(name="bpmnprof_ActivityGroup")
bpmnprof_FlowNode = Class(name="bpmnprof_FlowNode", is_abstract=True)
FlowElement = Class(name="FlowElement")
bpmnprof_ActivityNode = Class(name="bpmnprof_ActivityNode")
bpmnprof_FlowElement = Class(name="bpmnprof_FlowElement", is_abstract=True)
BaseElement = Class(name="BaseElement")
bpmnprof_Auditing = Class(name="bpmnprof_Auditing")
bpmnprof_Monitoring = Class(name="bpmnprof_Monitoring")
bpmnprof_CategoryValue = Class(name="bpmnprof_CategoryValue")
bpmnprof_FlowElementsContainer = Class(name="bpmnprof_FlowElementsContainer", is_abstract=True)
bpmnprof_ExtensionDefinition = Class(name="bpmnprof_ExtensionDefinition")
bpmnprof_BPMNAssociation = Class(name="bpmnprof_BPMNAssociation")
bpmnprof_Slot = Class(name="bpmnprof_Slot")
bpmnprof_ExtensionAttributeDefinition = Class(name="bpmnprof_ExtensionAttributeDefinition")
bpmnprof_Property = Class(name="bpmnprof_Property")
bpmnprof_Comment = Class(name="bpmnprof_Comment")
bpmnprof_Stereotype = Class(name="bpmnprof_Stereotype")
BPMNArtifact = Class(name="BPMNArtifact")
bpmnprof_Dependency = Class(name="bpmnprof_Dependency")
bpmnprof_BPMNArtifact = Class(name="bpmnprof_BPMNArtifact", is_abstract=True)
bpmnprof_Class = Class(name="bpmnprof_Class")
bpmnprof_EnumerationLiteral = Class(name="bpmnprof_EnumerationLiteral")
bpmnprof_LaneSet = Class(name="bpmnprof_LaneSet")
bpmnprof_ActivityPartition = Class(name="bpmnprof_ActivityPartition")
bpmnprof_Lane = Class(name="bpmnprof_Lane")
bpmnprof_ParallelGateway = Class(name="bpmnprof_ParallelGateway")
bpmnprof_ComplexGateway = Class(name="bpmnprof_ComplexGateway")
bpmnprof_ControlFlow = Class(name="bpmnprof_ControlFlow")
bpmnprof_BPMNExpression = Class(name="bpmnprof_BPMNExpression")
bpmnprof_OpaqueExpression = Class(name="bpmnprof_OpaqueExpression")
bpmnprof_EventBasedGateway = Class(name="bpmnprof_EventBasedGateway")
bpmnprof_StructuredActivityNode = Class(name="bpmnprof_StructuredActivityNode")
bpmnprof_InterruptibleActivityRegion = Class(name="bpmnprof_InterruptibleActivityRegion")
bpmnprof_ExclusiveGateway = Class(name="bpmnprof_ExclusiveGateway")
bpmnprof_DecisionNode = Class(name="bpmnprof_DecisionNode")
bpmnprof_MergeNode = Class(name="bpmnprof_MergeNode")
bpmnprof_Constraint = Class(name="bpmnprof_Constraint")
bpmnprof_RootElement = Class(name="bpmnprof_RootElement", is_abstract=True)
bpmnprof_PackageableElement = Class(name="bpmnprof_PackageableElement")
bpmnprof_Definitions = Class(name="bpmnprof_Definitions")
bpmnprof_Package = Class(name="bpmnprof_Package")
bpmnprof_BPMNExtension = Class(name="bpmnprof_BPMNExtension")
bpmnprof_Import = Class(name="bpmnprof_Import")
bpmnprof_BPMNRelationship = Class(name="bpmnprof_BPMNRelationship")
bpmnprof_PackageImport = Class(name="bpmnprof_PackageImport")
bpmnprof_BPMNProperty = Class(name="bpmnprof_BPMNProperty")
bpmnprof_ResourceRole = Class(name="bpmnprof_ResourceRole")
bpmnprof_BPMNProcess = Class(name="bpmnprof_BPMNProcess")
CallableElement = Class(name="CallableElement")
FlowElementsContainer = Class(name="FlowElementsContainer")
bpmnprof_BPMNCollaboration = Class(name="bpmnprof_BPMNCollaboration")
bpmnprof_Activity = Class(name="bpmnprof_Activity")
bpmnprof_CorrelationSubscription = Class(name="bpmnprof_CorrelationSubscription")
bpmnprof_CallableElement = Class(name="bpmnprof_CallableElement", is_abstract=True)
RootElement = Class(name="RootElement")
bpmnprof_Behavior = Class(name="bpmnprof_Behavior")
bpmnprof_InputOutputSpecification = Class(name="bpmnprof_InputOutputSpecification")
bpmnprof_BPMNInterface = Class(name="bpmnprof_BPMNInterface")
bpmnprof_InputOutputBinding = Class(name="bpmnprof_InputOutputBinding")
bpmnprof_Action = Class(name="bpmnprof_Action")
bpmnprof_DataInput = Class(name="bpmnprof_DataInput")
bpmnprof_DataOutput = Class(name="bpmnprof_DataOutput")
bpmnprof_InputSet = Class(name="bpmnprof_InputSet")
bpmnprof_OutputSet = Class(name="bpmnprof_OutputSet")
ItemAwareElement = Class(name="ItemAwareElement")
bpmnprof_ItemDefinition = Class(name="bpmnprof_ItemDefinition")
bpmnprof_InputPin = Class(name="bpmnprof_InputPin")
bpmnprof_Parameter = Class(name="bpmnprof_Parameter")
bpmnprof_ActivityParameterNode = Class(name="bpmnprof_ActivityParameterNode")
bpmnprof_ItemAwareElement = Class(name="bpmnprof_ItemAwareElement", is_abstract=True)
bpmnprof_DataState = Class(name="bpmnprof_DataState")
bpmnprof_TypedElement = Class(name="bpmnprof_TypedElement")
bpmnprof_State = Class(name="bpmnprof_State")
bpmnprof_ParameterSet = Class(name="bpmnprof_ParameterSet")
bpmnprof_OutputPin = Class(name="bpmnprof_OutputPin")
bpmnprof_Interface = Class(name="bpmnprof_Interface")
bpmnprof_BPMNOperation = Class(name="bpmnprof_BPMNOperation")
bpmnprof_Operation = Class(name="bpmnprof_Operation")
bpmnprof_BPMNMessage = Class(name="bpmnprof_BPMNMessage")
bpmnprof_Error = Class(name="bpmnprof_Error")
ItemDefinition = Class(name="ItemDefinition")
bpmnprof_Participant = Class(name="bpmnprof_Participant")
bpmnprof_ParticipantAssociation = Class(name="bpmnprof_ParticipantAssociation")
bpmnprof_ConversationLink = Class(name="bpmnprof_ConversationLink")
bpmnprof_MessageFlowAssociation = Class(name="bpmnprof_MessageFlowAssociation")
bpmnprof_MessageFlow = Class(name="bpmnprof_MessageFlow")
bpmnprof_Collaboration = Class(name="bpmnprof_Collaboration")
bpmnprof_ConversationNode = Class(name="bpmnprof_ConversationNode", is_abstract=True)
bpmnprof_CorrelationKey = Class(name="bpmnprof_CorrelationKey")
bpmnprof_MultiplicityElement = Class(name="bpmnprof_MultiplicityElement")
bpmnprof_ParticipantMultiplicity = Class(name="bpmnprof_ParticipantMultiplicity")
bpmnprof_PartnerEntity = Class(name="bpmnprof_PartnerEntity")
bpmnprof_PartnerRole = Class(name="bpmnprof_PartnerRole")
bpmnprof_InteractionNode = Class(name="bpmnprof_InteractionNode", is_abstract=True)
bpmnprof_InstanceSpecification = Class(name="bpmnprof_InstanceSpecification")
bpmnprof_CorrelationProperty = Class(name="bpmnprof_CorrelationProperty")
bpmnprof_CorrelationPropertyRetrievalExpression = Class(name="bpmnprof_CorrelationPropertyRetrievalExpression")
bpmnprof_FormalExpression = Class(name="bpmnprof_FormalExpression")
BPMNExpression = Class(name="BPMNExpression")
bpmnprof_InformationFlow = Class(name="bpmnprof_InformationFlow")
InteractionNode = Class(name="InteractionNode")
bpmnprof_DataStoreNode = Class(name="bpmnprof_DataStoreNode")
bpmnprof_CorrelationPropertyBinding = Class(name="bpmnprof_CorrelationPropertyBinding")
bpmnprof_ResourceAssignmentExpression = Class(name="bpmnprof_ResourceAssignmentExpression")
bpmnprof_Resource = Class(name="bpmnprof_Resource")
bpmnprof_ResourceParameterBinding = Class(name="bpmnprof_ResourceParameterBinding")
bpmnprof_ResourceParameter = Class(name="bpmnprof_ResourceParameter")
bpmnprof_GlobalTask = Class(name="bpmnprof_GlobalTask")
bpmnprof_OpaqueBehavior = Class(name="bpmnprof_OpaqueBehavior")
bpmnprof_GlobalBusinessRuleTask = Class(name="bpmnprof_GlobalBusinessRuleTask")
bpmnprof_GlobalScriptTask = Class(name="bpmnprof_GlobalScriptTask")
GlobalTask = Class(name="GlobalTask")
bpmnprof_CompensateEventDefinition = Class(name="bpmnprof_CompensateEventDefinition")
EventDefinition = Class(name="EventDefinition")
bpmnprof_BPMNActivity = Class(name="bpmnprof_BPMNActivity", is_abstract=True)
bpmnprof_CallEvent = Class(name="bpmnprof_CallEvent")
bpmnprof_EventDefinition = Class(name="bpmnprof_EventDefinition", is_abstract=True)
bpmnprof_Event = Class(name="bpmnprof_Event")
bpmnprof_CatchEvent = Class(name="bpmnprof_CatchEvent", is_abstract=True)
BPMNEvent = Class(name="BPMNEvent")
bpmnprof_AcceptEventAction = Class(name="bpmnprof_AcceptEventAction")
bpmnprof_InitialNode = Class(name="bpmnprof_InitialNode")
bpmnprof_BPMNEvent = Class(name="bpmnprof_BPMNEvent", is_abstract=True)
bpmnprof_BoundaryEvent = Class(name="bpmnprof_BoundaryEvent")
bpmnprof_DataInputAssociation = Class(name="bpmnprof_DataInputAssociation")
bpmnprof_DataOutputAssociation = Class(name="bpmnprof_DataOutputAssociation")
bpmnprof_LoopCharacteristics = Class(name="bpmnprof_LoopCharacteristics", is_abstract=True)
CatchEvent = Class(name="CatchEvent")
bpmnprof_ObjectFlow = Class(name="bpmnprof_ObjectFlow")
bpmnprof_Assignment = Class(name="bpmnprof_Assignment")
DataAssociation = Class(name="DataAssociation")
bpmnprof_DataAssociation = Class(name="bpmnprof_DataAssociation", is_abstract=True)
bpmnprof_TimerEventDefinition = Class(name="bpmnprof_TimerEventDefinition")
bpmnprof_ChangeEvent = Class(name="bpmnprof_ChangeEvent")
bpmnprof_SignalEventDefinition = Class(name="bpmnprof_SignalEventDefinition")
bpmnprof_BPMNSignal = Class(name="bpmnprof_BPMNSignal")
bpmnprof_EscalationEventDefinition = Class(name="bpmnprof_EscalationEventDefinition")
bpmnprof_Escalation = Class(name="bpmnprof_Escalation")
bpmnprof_StartEvent = Class(name="bpmnprof_StartEvent")
bpmnprof_ConditionalEventDefinition = Class(name="bpmnprof_ConditionalEventDefinition")
bpmnprof_LinkEventDefinition = Class(name="bpmnprof_LinkEventDefinition")
bpmnprof_EndEvent = Class(name="bpmnprof_EndEvent")
ThrowEvent = Class(name="ThrowEvent")
bpmnprof_FinalNode = Class(name="bpmnprof_FinalNode")
bpmnprof_ThrowEvent = Class(name="bpmnprof_ThrowEvent", is_abstract=True)
bpmnprof_CallOperationAction = Class(name="bpmnprof_CallOperationAction")
bpmnprof_FlowFinalNode = Class(name="bpmnprof_FlowFinalNode")
bpmnprof_MessageEventDefinition = Class(name="bpmnprof_MessageEventDefinition")
bpmnprof_IntermediateCatchEvent = Class(name="bpmnprof_IntermediateCatchEvent")
bpmnprof_IntermediateThrowEvent = Class(name="bpmnprof_IntermediateThrowEvent")
bpmnprof_SendObjectAction = Class(name="bpmnprof_SendObjectAction")
bpmnprof_TerminateEventDefinition = Class(name="bpmnprof_TerminateEventDefinition")
bpmnprof_ImplicitThrowEvent = Class(name="bpmnprof_ImplicitThrowEvent")
bpmnprof_CancelEventDefinition = Class(name="bpmnprof_CancelEventDefinition")
bpmnprof_TextAnnotation = Class(name="bpmnprof_TextAnnotation")
bpmnprof_ErrorEventDefinition = Class(name="bpmnprof_ErrorEventDefinition")
bpmnprof_DataObject = Class(name="bpmnprof_DataObject")
bpmnprof_DataStore = Class(name="bpmnprof_DataStore")
bpmnprof_Category = Class(name="bpmnprof_Category")
bpmnprof_Enumeration = Class(name="bpmnprof_Enumeration")
bpmnprof_Group = Class(name="bpmnprof_Group")
bpmnprof_DataObjectReference = Class(name="bpmnprof_DataObjectReference")
bpmnprof_Rendering = Class(name="bpmnprof_Rendering")
bpmnprof_Task = Class(name="bpmnprof_Task")
BPMNActivity = Class(name="BPMNActivity")
bpmnprof_Image = Class(name="bpmnprof_Image")
bpmnprof_HumanPerformer = Class(name="bpmnprof_HumanPerformer")
Performer = Class(name="Performer")
bpmnprof_Performer = Class(name="bpmnprof_Performer")
ResourceRole = Class(name="ResourceRole")
bpmnprof_GlobalUserTask = Class(name="bpmnprof_GlobalUserTask")
bpmnprof_DataStoreReference = Class(name="bpmnprof_DataStoreReference")
bpmnprof_UserTask = Class(name="bpmnprof_UserTask")
Task = Class(name="Task")
bpmnprof_OpaqueAction = Class(name="bpmnprof_OpaqueAction")
bpmnprof_GlobalConversation = Class(name="bpmnprof_GlobalConversation")
BPMNCollaboration = Class(name="BPMNCollaboration")
bpmnprof_CallConversation = Class(name="bpmnprof_CallConversation")
bpmnprof_CollaborationUse = Class(name="bpmnprof_CollaborationUse")
bpmnprof_GlobalManualTask = Class(name="bpmnprof_GlobalManualTask")
bpmnprof_ManualTask = Class(name="bpmnprof_ManualTask")
bpmnprof_PotentialOwner = Class(name="bpmnprof_PotentialOwner")
HumanPerformer = Class(name="HumanPerformer")
bpmnprof_SubConversation = Class(name="bpmnprof_SubConversation")
ConversationNode = Class(name="ConversationNode")
bpmnprof_BusinessRuleTask = Class(name="bpmnprof_BusinessRuleTask")
bpmnprof_ComplexBehaviorDefinition = Class(name="bpmnprof_ComplexBehaviorDefinition")
bpmnprof_AdHocSubProcess = Class(name="bpmnprof_AdHocSubProcess")
SubProcess = Class(name="SubProcess")
bpmnprof_Conversation = Class(name="bpmnprof_Conversation")
bpmnprof_SubProcess = Class(name="bpmnprof_SubProcess")
bpmnprof_CallActivity = Class(name="bpmnprof_CallActivity")
bpmnprof_CallBehaviorAction = Class(name="bpmnprof_CallBehaviorAction")
bpmnprof_Transaction = Class(name="bpmnprof_Transaction")
bpmnprof_StandardLoopCharacteristics = Class(name="bpmnprof_StandardLoopCharacteristics")
LoopCharacteristics = Class(name="LoopCharacteristics")
bpmnprof_ScriptTask = Class(name="bpmnprof_ScriptTask")
bpmnprof_SendTask = Class(name="bpmnprof_SendTask")
bpmnprof_ServiceTask = Class(name="bpmnprof_ServiceTask")
bpmnprof_MultiInstanceLoopCharacteristics = Class(name="bpmnprof_MultiInstanceLoopCharacteristics")
bpmnprof_LoopNode = Class(name="bpmnprof_LoopNode")
bpmnprof_ReceiveTask = Class(name="bpmnprof_ReceiveTask")
bpmnprof_ExpansionRegion = Class(name="bpmnprof_ExpansionRegion")
...
bpmnprof_InclusiveGateway_m_inclusiveGatewaydefault: Method = Method(name="inclusiveGatewaydefault", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
...
bpmnprof_SequenceFlow_m_SequenceFlowconditionExpression: Method = Method(name="SequenceFlowconditionExpression", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_SequenceFlow_m_SequenceFlowsourceRef: Method = Method(name="SequenceFlowsourceRef", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_SequenceFlow_m_SequenceFlowtargetRef: Method = Method(name="SequenceFlowtargetRef", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_SequenceFlow.attributes={bpmnprof_SequenceFlow_isImmediate}
bpmnprof_SequenceFlow.methods={bpmnprof_SequenceFlow_m_SequenceFlowtargetRef, bpmnprof_SequenceFlow_m_SequenceFlowsourceRef, bpmnprof_SequenceFlow_m_SequenceFlowconditionExpression}
...
bpmnprof_BPMNAssociation_m_AssociationEnd: Method = Method(name="AssociationEnd", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
...
bpmnprof_LaneSet_m_LaneSetflowElementsContainer: Method = Method(name="LaneSetflowElementsContainer", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_LaneSet_m_LaneSet: Method = Method(name="LaneSet", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_LaneSet_m_LaneSetlanes: Method = Method(name="LaneSetlanes", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_LaneSet_m_LaneSetparentLane: Method = Method(name="LaneSetparentLane", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_LaneSet.methods={bpmnprof_LaneSet_m_LaneSetflowElementsContainer, bpmnprof_LaneSet_m_LaneSetparentLane, bpmnprof_LaneSet_m_LaneSetlanes, bpmnprof_LaneSet_m_LaneSet}

# bpmnprof_ActivityPartition class attributes and methods

# bpmnprof_Lane class attributes and methods
bpmnprof_Lane_m_LanelaneSet: Method = Method(name="LanelaneSet", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_Lane_m_LanechildLaneSet: Method = Method(name="LanechildLaneSet", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_Lane_m_LanepartitionElementRef: Method = Method(name="LanepartitionElementRef", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_Lane_m_LaneflowNodeRefs: Method = Method(name="LaneflowNodeRefs", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_Lane.methods={bpmnprof_Lane_m_LaneflowNodeRefs, bpmnprof_Lane_m_LanechildLaneSet, bpmnprof_Lane_m_LanelaneSet, bpmnprof_Lane_m_LanepartitionElementRef}

# bpmnprof_ParallelGateway class attributes and methods

# bpmnprof_ComplexGateway class attributes and methods
bpmnprof_ComplexGateway_m_complexGatewaydefault: Method = Method(name="complexGatewaydefault", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_ComplexGateway_m_complexGatewayactivationCondition: Method = Method(name="complexGatewayactivationCondition", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_ComplexGateway_m_complexGatewayjoinSpec: Method = Method(name="complexGatewayjoinSpec", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
...
bpmnprof_ExclusiveGateway_m_exclusiveGatewaydefault: Method = Method(name="exclusiveGatewaydefault", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
...
bpmnprof_Definitions.attributes={bpmnprof_Definitions_targetNamespace, bpmnprof_Definitions_exporterVersion, bpmnprof_Definitions_expressionLanguage, bpmnprof_Definitions_typeLanguage, bpmnprof_Definitions_exporter}
...
bpmnprof_BPMNRelationship.attributes={bpmnprof_BPMNRelationship_type, bpmnprof_BPMNRelationship_direction}

# bpmnprof_PackageImport class attributes and methods

# bpmnprof_BPMNProperty class attributes and methods
bpmnprof_BPMNProperty_m_Propertynotation: Method = Method(name="Propertynotation", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_BPMNProperty_m_BPMNPropertyapply: Method = Method(name="BPMNPropertyapply", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_BPMNProperty.methods={bpmnprof_BPMNProperty_m_BPMNPropertyapply, bpmnprof_BPMNProperty_m_Propertynotation}

# bpmnprof_ResourceRole class attributes and methods
bpmnprof_ResourceRole_m_ResourceRoleowner: Method = Method(name="ResourceRoleowner", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_ResourceRole_m_ResourceRoleresourceRef: Method = Method(name="ResourceRoleresourceRef", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_ResourceRole_m_ResourceRoleresourceParameterBindings: Method = Method(name="ResourceRoleresourceParameterBindings", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_ResourceRole_m_ResourceRoleisRequired: Method = Method(name="ResourceRoleisRequired", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_ResourceRole_m_ResourceRoleprocess: Method = Method(name="ResourceRoleprocess", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_ResourceRole.methods={bpmnprof_ResourceRole_m_ResourceRoleisRequired, bpmnprof_ResourceRole_m_ResourceRoleresourceRef, bpmnprof_ResourceRole_m_ResourceRoleowner, bpmnprof_ResourceRole_m_ResourceRoleresourceParameterBindings, bpmnprof_ResourceRole_m_ResourceRoleprocess}
...
bpmnprof_BPMNProcess_m_ProcesssupportedInterfaceRefs: Method = Method(name="ProcesssupportedInterfaceRefs", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_BPMNProcess_m_Processsupports: Method = Method(name="Processsupports", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_BPMNProcess_m_Processproperties: Method = Method(name="Processproperties", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_BPMNProcess_m_ProcesslaneSets: Method = Method(name="ProcesslaneSets", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_BPMNProcess_m_ProcessflowElements: Method = Method(name="ProcessflowElements", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
...
bpmnprof_BPMNProcess.methods={bpmnprof_BPMNProcess_m_Processproperties, bpmnprof_BPMNProcess_m_Processsupports, bpmnprof_BPMNProcess_m_ProcesslaneSets, bpmnprof_BPMNProcess_m_ProcessflowElements, bpmnprof_BPMNProcess_m_ProcesssupportedInterfaceRefs}
...
bpmnprof_BPMNCollaboration_m_Collaborationparticipants: Method = Method(name="Collaborationparticipants", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
...
bpmnprof_CallableElement_m_CallableEelementsupportedInterfaceRefs: Method = Method(name="CallableEelementsupportedInterfaceRefs", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_CallableElement_m_CallableElementresources: Method = Method(name="CallableElementresources", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
...
bpmnprof_BPMNInterface_m_Interfaceoperationmultiplicity: Method = Method(name="Interfaceoperationmultiplicity", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_BPMNInterface_m_InterfaceownedOperation: Method = Method(name="InterfaceownedOperation", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_BPMNInterface_m_BPMNInterfacecallableElements: Method = Method(name="BPMNInterfacecallableElements", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_BPMNInterface_m_BPMNInterfaceoperations: Method = Method(name="BPMNInterfaceoperations", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
...
bpmnprof_DataInput_m_DataInputnotation: Method = Method(name="DataInputnotation", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_DataInput_m_DataInputitemSubjectRef: Method = Method(name="DataInputitemSubjectRef", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_DataInput_m_DataInputAssociation: Method = Method(name="DataInputAssociation", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
...
bpmnprof_DataOutput_m_DataOutputnotation: Method = Method(name="DataOutputnotation", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_DataOutput_m_DataOutputitemSubjectRef: Method = Method(name="DataOutputitemSubjectRef", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
...
bpmnprof_InputSet_m_InputSetdataInputRefs: Method = Method(name="InputSetdataInputRefs", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_InputSet_m_InputSetoptionalInputRefs: Method = Method(name="InputSetoptionalInputRefs", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_InputSet_m_InputSetwhileExecutingInputRefs: Method = Method(name="InputSetwhileExecutingInputRefs", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
...
bpmnprof_OutputSet_m_OutputSetdataOutputRefs: Method = Method(name="OutputSetdataOutputRefs", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_OutputSet_m_OutputSetoptionalOutputRefs: Method = Method(name="OutputSetoptionalOutputRefs", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_OutputSet_m_OutputSetwhileExecutingOutputRefs: Method = Method(name="OutputSetwhileExecutingOutputRefs", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_OutputSet.methods={bpmnprof_OutputSet_m_OutputSetdataOutputRefs, bpmnprof_OutputSet_m_OutputSetoptionalOutputRefs, bpmnprof_OutputSet_m_OutputSetwhileExecutingOutputRefs}
...
bpmnprof_ItemDefinition_m_ItemDefinitionstructureRef: Method = Method(name="ItemDefinitionstructureRef", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
...
bpmnprof_ItemAwareElement_m_ItemAwareElementdataState: Method = Method(name="ItemAwareElementdataState", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
...
bpmnprof_BPMNOperation_m_BPMNOperationerrorRefs: Method = Method(name="BPMNOperationerrorRefs", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_BPMNOperation_m_BPMNOperationowner: Method = Method(name="BPMNOperationowner", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_BPMNOperation_m_BPMNOperationinMessageRef: Method = Method(name="BPMNOperationinMessageRef", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_BPMNOperation_m_BPMNOperationoutMessageRef: Method = Method(name="BPMNOperationoutMessageRef", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_BPMNOperation.methods={bpmnprof_BPMNOperation_m_BPMNOperationoutMessageRef, bpmnprof_BPMNOperation_m_BPMNOperationerrorRefs, bpmnprof_BPMNOperation_m_BPMNOperationinMessageRef, bpmnprof_BPMNOperation_m_BPMNOperationowner}

# bpmnprof_Operation class attributes and methods

# bpmnprof_BPMNMessage class attributes and methods
bpmnprof_BPMNMessage_m_MessageitemRef: Method = Method(name="MessageitemRef", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
...
bpmnprof_Participant_m_Participantownership: Method = Method(name="Participantownership", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_Participant_m_ParticipantprocessRef: Method = Method(name="ParticipantprocessRef", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_Participant_m_ParticipantmultiplicityMaximum: Method = Method(name="ParticipantmultiplicityMaximum", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_Participant_m_participantpartnerEntityRef: Method = Method(name="participantpartnerEntityRef", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_Participant_m_participantpartnerRoleRef: Method = Method(name="participantpartnerRoleRef", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_Participant_m_ParticipantinterfaceRefs: Method = Method(name="ParticipantinterfaceRefs", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_Participant_m_Participanttype: Method = Method(name="Participanttype", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_Participant_m_ParticipantmultiplicityMinimum: Method = Method(name="ParticipantmultiplicityMinimum", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_Participant_m_Participantrealizationsupplier: Method = Method(name="Participantrealizationsupplier", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_Participant.methods={bpmnprof_Participant_m_ParticipantinterfaceRefs, bpmnprof_Participant_m_Participantrealizationsupplier, bpmnprof_Participant_m_ParticipantmultiplicityMaximum, bpmnprof_Participant_m_Participantownership, bpmnprof_Participant_m_ParticipantprocessRef, bpmnprof_Participant_m_participantpartnerRoleRef, bpmnprof_Participant_m_participantpartnerEntityRef, bpmnprof_Participant_m_Participanttype, bpmnprof_Participant_m_ParticipantmultiplicityMinimum}

# bpmnprof_ParticipantAssociation class attributes and methods
bpmnprof_ParticipantAssociation_m_ParticipantAssociationinnerParticipantRef: Method = Method(name="ParticipantAssociationinnerParticipantRef", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_ParticipantAssociation_m_ParticipantAssociationouterParticipantRef: Method = Method(name="ParticipantAssociationouterParticipantRef", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
...
bpmnprof_MessageFlowAssociation_m_MessageFlowAssociationinnerMessageFlowRef: Method = Method(name="MessageFlowAssociationinnerMessageFlowRef", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_MessageFlowAssociation_m_MessageFlowAssociationouterMessageFlowRef: Method = Method(name="MessageFlowAssociationouterMessageFlowRef", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
...
bpmnprof_MessageFlow_m_MessageFlowsourceRef: Method = Method(name="MessageFlowsourceRef", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_MessageFlow_m_MessageFlowtargetRef: Method = Method(name="MessageFlowtargetRef", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_MessageFlow_m_MessageFlowmessageRef: Method = Method(name="MessageFlowmessageRef", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_MessageFlow.methods={bpmnprof_MessageFlow_m_MessageFlowtargetRef, bpmnprof_MessageFlow_m_MessageFlowmessageRef, bpmnprof_MessageFlow_m_MessageFlowsourceRef}

# bpmnprof_Collaboration class attributes and methods

# bpmnprof_ConversationNode class attributes and methods
bpmnprof_ConversationNode_m_ConversationNodeparticipantRefs: Method = Method(name="ConversationNodeparticipantRefs", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
...
bpmnprof_PartnerEntity_m_PartnerEntityparticipantRef: Method = Method(name="PartnerEntityparticipantRef", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
...
bpmnprof_PartnerRole_m_PartnerRoleparticipantRef: Method = Method(name="PartnerRoleparticipantRef", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
...
bpmnprof_FormalExpression_m_FormalExpressionevaluatesToTypeRef: Method = Method(name="FormalExpressionevaluatesToTypeRef", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
...
bpmnprof_ResourceAssignmentExpression_m_ResourceAssignmentExpressionexpression: Method = Method(name="ResourceAssignmentExpressionexpression", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
...
bpmnprof_Resource_m_ResourceresourceParameters: Method = Method(name="ResourceresourceParameters", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
...
bpmnprof_ResourceParameterBinding_m_ResourceParameterBindingexpression: Method = Method(name="ResourceParameterBindingexpression", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_ResourceParameterBinding_m_ResourceParameterBindingparameterRef: Method = Method(name="ResourceParameterBindingparameterRef", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_ResourceParameterBinding.methods={bpmnprof_ResourceParameterBinding_m_ResourceParameterBindingparameterRef, bpmnprof_ResourceParameterBinding_m_ResourceParameterBindingexpression}
...
bpmnprof_ResourceParameter_m_ResourceParametertype: Method = Method(name="ResourceParametertype", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_ResourceParameter_m_ResourceParameterisRequired: Method = Method(name="ResourceParameterisRequired", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_ResourceParameter_m_ResourceParameterowner: Method = Method(name="ResourceParameterowner", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_ResourceParameter.attributes={bpmnprof_ResourceParameter_isRequired}
bpmnprof_ResourceParameter.methods={bpmnprof_ResourceParameter_m_ResourceParameterisRequired, bpmnprof_ResourceParameter_m_ResourceParameterowner, bpmnprof_ResourceParameter_m_ResourceParametertype}

# bpmnprof_GlobalTask class attributes and methods
bpmnprof_GlobalTask_m_GlobalTasksupportedInterfaceRefs: Method = Method(name="GlobalTasksupportedInterfaceRefs", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
...
bpmnprof_GlobalBusinessRuleTask_m_GlobalBusinessRuleTaskimplementation: Method = Method(name="GlobalBusinessRuleTaskimplementation", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
...
bpmnprof_GlobalScriptTask_m_GlobalScriptTaskscript: Method = Method(name="GlobalScriptTaskscript", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_GlobalScriptTask_m_GlobalScriptTaskscriptFormat: Method = Method(name="GlobalScriptTaskscriptFormat", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_GlobalScriptTask.attributes={bpmnprof_GlobalScriptTask_script, bpmnprof_GlobalScriptTask_scriptFormat}
bpmnprof_GlobalScriptTask.methods={bpmnprof_GlobalScriptTask_m_GlobalScriptTaskscript, bpmnprof_GlobalScriptTask_m_GlobalScriptTaskscriptFormat}
...
bpmnprof_BPMNActivity_m_BPMNActivityproperties: Method = Method(name="BPMNActivityproperties", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_BPMNActivity_m_BPMNActivitydefault: Method = Method(name="BPMNActivitydefault", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_BPMNActivity_m_BPMNActivityboundaryEventsRefs: Method = Method(name="BPMNActivityboundaryEventsRefs", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_BPMNActivity_m_BPMNActivityloopCharacteristics: Method = Method(name="BPMNActivityloopCharacteristics", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_BPMNActivity_m_BPMNActivityresources: Method = Method(name="BPMNActivityresources", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_BPMNActivity_m_BPMNActivitycontainer: Method = Method(name="BPMNActivitycontainer", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_BPMNActivity.attributes={bpmnprof_BPMNActivity_startQuantity, bpmnprof_BPMNActivity_completionQuantity, bpmnprof_BPMNActivity_isForCompensation}
bpmnprof_BPMNActivity.methods={bpmnprof_BPMNActivity_m_BPMNActivityboundaryEventsRefs, bpmnprof_BPMNActivity_m_BPMNActivityresources, bpmnprof_BPMNActivity_m_BPMNActivitycontainer, bpmnprof_BPMNActivity_m_BPMNActivitydefault, bpmnprof_BPMNActivity_m_BPMNActivityproperties, bpmnprof_BPMNActivity_m_BPMNActivityloopCharacteristics}
...
bpmnprof_CatchEvent_m_catchEventeventDefinitionsRefs: Method = Method(name="catchEventeventDefinitionsRefs", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
...
bpmnprof_BoundaryEvent_m_boundaryEventattachedToRef: Method = Method(name="boundaryEventattachedToRef", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
...
bpmnprof_DataInputAssociation_m_dataInputAssociationsource: Method = Method(name="dataInputAssociationsource", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_DataInputAssociation_m_dataInputAssociationtarget: Method = Method(name="dataInputAssociationtarget", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_DataInputAssociation.methods={bpmnprof_DataInputAssociation_m_dataInputAssociationsource, bpmnprof_DataInputAssociation_m_dataInputAssociationtarget}

# bpmnprof_DataOutputAssociation class attributes and methods
bpmnprof_DataOutputAssociation_m_dataOutputAssociationsource: Method = Method(name="dataOutputAssociationsource", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_DataOutputAssociation_m_dataOutputAssociationtarget: Method = Method(name="dataOutputAssociationtarget", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
...
bpmnprof_DataAssociation_m_DataAssociationtarget: Method = Method(name="DataAssociationtarget", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_DataAssociation_m_DataAssociationsource: Method = Method(name="DataAssociationsource", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_DataAssociation_m_DataAssociationtransformation: Method = Method(name="DataAssociationtransformation", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_DataAssociation.methods={bpmnprof_DataAssociation_m_DataAssociationsource, bpmnprof_DataAssociation_m_DataAssociationtarget, bpmnprof_DataAssociation_m_DataAssociationtransformation}
...
bpmnprof_BPMNSignal_m_BPMNSignalstructureRef: Method = Method(name="BPMNSignalstructureRef", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
...
bpmnprof_Escalation_m_EscalationstructureRef: Method = Method(name="EscalationstructureRef", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
...
bpmnprof_ConditionalEventDefinition_m_conditionalEventDefinitioncondition: Method = Method(name="conditionalEventDefinitioncondition", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
...
bpmnprof_ThrowEvent_m_ThrowEventeventDefinitionRefs: Method = Method(name="ThrowEventeventDefinitionRefs", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
...
bpmnprof_TextAnnotation.attributes={bpmnprof_TextAnnotation_textFormat, bpmnprof_TextAnnotation_text}
...
bpmnprof_DataObject_m_DataObjectdataState: Method = Method(name="DataObjectdataState", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
...
bpmnprof_DataStore.attributes={bpmnprof_DataStore_isUnlimited, bpmnprof_DataStore_capacity}
...
bpmnprof_DataObjectReference_m_DataObjectRefdataState: Method = Method(name="DataObjectRefdataState", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_DataObjectReference_m_DataObjectRefsourcetarget: Method = Method(name="DataObjectRefsourcetarget", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
...
bpmnprof_GlobalUserTask_m_GlobalUserTaskrenderings: Method = Method(name="GlobalUserTaskrenderings", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_GlobalUserTask_m_GlobalUserTaskimplementation: Method = Method(name="GlobalUserTaskimplementation", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
...
bpmnprof_UserTask_m_UserTaskimplementation: Method = Method(name="UserTaskimplementation", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_UserTask_m_UserTaskrenderings: Method = Method(name="UserTaskrenderings", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
...
bpmnprof_GlobalConversation_m_GlobalConversationcontainedelements: Method = Method(name="GlobalConversationcontainedelements", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
...
bpmnprof_CallConversation_m_CallConversationcalledCollaborationRef: Method = Method(name="CallConversationcalledCollaborationRef", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_CallConversation_m_CallConversationparticipantAssociations: Method = Method(name="CallConversationparticipantAssociations", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_CallConversation.methods={bpmnprof_CallConversation_m_CallConversationcalledCollaborationRef, bpmnprof_CallConversation_m_CallConversationparticipantAssociations}
...
bpmnprof_SubConversation_m_SubConversationconnectedelements: Method = Method(name="SubConversationconnectedelements", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
...
bpmnprof_BusinessRuleTask_m_BusinessRuleTaskimplementation: Method = Method(name="BusinessRuleTaskimplementation", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
...
bpmnprof_AdHocSubProcess_m_AdHocSubProcesscancelRemainingInstances: Method = Method(name="AdHocSubProcesscancelRemainingInstances", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_AdHocSubProcess.attributes={bpmnprof_AdHocSubProcess_cancelRemainingInstances, bpmnprof_AdHocSubProcess_ordering}
...
bpmnprof_SubProcess_m_SubProcesstriggeredByEvent: Method = Method(name="SubProcesstriggeredByEvent", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
...
bpmnprof_CallActivity_m_CallActivitycalledElementRefvalues: Method = Method(name="CallActivitycalledElementRefvalues", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
...
bpmnprof_StandardLoopCharacteristics_m_StandardLoopCharacteristicstestBefore: Method = Method(name="StandardLoopCharacteristicstestBefore", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_StandardLoopCharacteristics_m_StandardLoopCharacteristicsloopCondition: Method = Method(name="StandardLoopCharacteristicsloopCondition", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_StandardLoopCharacteristics.attributes={bpmnprof_StandardLoopCharacteristics_testBefore, bpmnprof_StandardLoopCharacteristics_loopMaximum}
...
bpmnprof_ScriptTask_m_ScriptTaskscriptFormat: Method = Method(name="ScriptTaskscriptFormat", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_ScriptTask_m_ScriptTaskscript: Method = Method(name="ScriptTaskscript", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
...
bpmnprof_SendTask_m_SendTaskoperationRef: Method = Method(name="SendTaskoperationRef", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
...
bpmnprof_ServiceTask_m_ServiceTaskinputSet: Method = Method(name="ServiceTaskinputSet", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_ServiceTask_m_ServiceTaskoutputSet: Method = Method(name="ServiceTaskoutputSet", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_ServiceTask_m_ServiceTaskoperationRef: Method = Method(name="ServiceTaskoperationRef", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
bpmnprof_ServiceTask.attributes={bpmnprof_ServiceTask_implementation}
bpmnprof_ServiceTask.methods={bpmnprof_ServiceTask_m_ServiceTaskoperationRef, bpmnprof_ServiceTask_m_ServiceTaskoutputSet, bpmnprof_ServiceTask_m_ServiceTaskinputSet}
...
bpmnprof_MultiInstanceLoopCharacteristics_m_MultiinstanceLoopCharacteristicstarget: Method = Method(name="MultiinstanceLoopCharacteristicstarget", parameters={Parameter(name='bpmnprof_diagnostics', type=StringType), Parameter(name='bpmnprof_context', type=StringType)}, type=BooleanType)
bpmnprof_MultiInstanceLoopCharacteristics.attributes={bpmnprof_MultiInstanceLoopCharacteristics_isSequential, bpmnprof_MultiInstanceLoopCharacteristics_behavior}
...
bpmnprof_ReceiveTask_m_ReceiveTaskoperationRef: Method = Method(name="ReceiveTaskoperationRef", parameters={Parameter(name='bpmnprof_context', type=StringType), Parameter(name='bpmnprof_diagnostics', type=StringType)}, type=BooleanType)
...
domain_model = DomainModel(
    name="bpmnprof",
    types={bpmnprof_BaseElement, bpmnprof_ExtensionAttributeValue, bpmnprof_Element, bpmnprof_Documentation, bpmnprof_InclusiveGateway, NonExclusiveGateway, bpmnprof_SequenceFlow, bpmnprof_NonExclusiveGateway, Gateway, bpmnprof_JoinNode, bpmnprof_ForkNode, bpmnprof_Gateway, FlowNode, bpmnprof_ControlNode, bpmnprof_ActivityGroup, bpmnprof_FlowNode, FlowElement, bpmnprof_ActivityNode, bpmnprof_FlowElement, BaseElement, bpmnprof_Auditing, bpmnprof_Monitoring, bpmnprof_CategoryValue, bpmnprof_FlowElementsContainer, bpmnprof_ExtensionDefinition, bpmnprof_BPMNAssociation, bpmnprof_Slot, bpmnprof_ExtensionAttributeDefinition, bpmnprof_Property, bpmnprof_Comment, bpmnprof_Stereotype, BPMNArtifact, bpmnprof_Dependency, bpmnprof_BPMNArtifact, bpmnprof_Class, bpmnprof_EnumerationLiteral, bpmnprof_LaneSet, bpmnprof_ActivityPartition, bpmnprof_Lane, bpmnprof_ParallelGateway, bpmnprof_ComplexGateway, bpmnprof_ControlFlow, bpmnprof_BPMNExpression, bpmnprof_OpaqueExpression, bpmnprof_EventBasedGateway, bpmnprof_StructuredActivityNode, bpmnprof_InterruptibleActivityRegion, bpmnprof_ExclusiveGateway, bpmnprof_DecisionNode, bpmnprof_MergeNode, bpmnprof_Constraint, bpmnprof_RootElement, bpmnprof_PackageableElement, bpmnprof_Definitions, bpmnprof_Package, bpmnprof_BPMNExtension, bpmnprof_Import, bpmnprof_BPMNRelationship, bpmnprof_PackageImport, bpmnprof_BPMNProperty, bpmnprof_ResourceRole, bpmnprof_BPMNProcess, CallableElement, FlowElementsContainer, bpmnprof_BPMNCollaboration, bpmnprof_Activity, bpmnprof_CorrelationSubscription, bpmnprof_CallableElement, RootElement, bpmnprof_Behavior, bpmnprof_InputOutputSpecification, bpmnprof_BPMNInterface, bpmnprof_InputOutputBinding, bpmnprof_Action, bpmnprof_DataInput, bpmnprof_DataOutput, bpmnprof_InputSet, bpmnprof_OutputSet, ItemAwareElement, bpmnprof_ItemDefinition, bpmnprof_InputPin, bpmnprof_Parameter, bpmnprof_ActivityParameterNode, bpmnprof_ItemAwareElement, bpmnprof_DataState, bpmnprof_TypedElement, bpmnprof_State, bpmnprof_ParameterSet, bpmnprof_OutputPin, bpmnprof_Interface, bpmnprof_BPMNOperation, bpmnprof_Operation, bpmnprof_BPMNMessage, bpmnprof_Error, ItemDefinition, bpmnprof_Participant, bpmnprof_ParticipantAssociation, bpmnprof_ConversationLink, bpmnprof_MessageFlowAssociation, bpmnprof_MessageFlow, bpmnprof_Collaboration, bpmnprof_ConversationNode, bpmnprof_CorrelationKey, bpmnprof_MultiplicityElement, bpmnprof_ParticipantMultiplicity, bpmnprof_PartnerEntity, bpmnprof_PartnerRole, bpmnprof_InteractionNode, bpmnprof_InstanceSpecification, bpmnprof_CorrelationProperty, bpmnprof_CorrelationPropertyRetrievalExpression, bpmnprof_FormalExpression, BPMNExpression, bpmnprof_InformationFlow, InteractionNode, bpmnprof_DataStoreNode, bpmnprof_CorrelationPropertyBinding, bpmnprof_ResourceAssignmentExpression, bpmnprof_Resource, bpmnprof_ResourceParameterBinding, bpmnprof_ResourceParameter, bpmnprof_GlobalTask, bpmnprof_OpaqueBehavior, bpmnprof_GlobalBusinessRuleTask, bpmnprof_GlobalScriptTask, GlobalTask, bpmnprof_CompensateEventDefinition, EventDefinition, bpmnprof_BPMNActivity, bpmnprof_CallEvent, bpmnprof_EventDefinition, bpmnprof_Event, bpmnprof_CatchEvent, BPMNEvent, bpmnprof_AcceptEventAction, bpmnprof_InitialNode, bpmnprof_BPMNEvent, bpmnprof_BoundaryEvent, bpmnprof_DataInputAssociation, bpmnprof_DataOutputAssociation, bpmnprof_LoopCharacteristics, CatchEvent, bpmnprof_ObjectFlow, bpmnprof_Assignment, DataAssociation, bpmnprof_DataAssociation, bpmnprof_TimerEventDefinition, bpmnprof_ChangeEvent, bpmnprof_SignalEventDefinition, bpmnprof_BPMNSignal, bpmnprof_EscalationEventDefinition, bpmnprof_Escalation, bpmnprof_StartEvent, bpmnprof_ConditionalEventDefinition, bpmnprof_LinkEventDefinition, bpmnprof_EndEvent, ThrowEvent, bpmnprof_FinalNode, bpmnprof_ThrowEvent, bpmnprof_CallOperationAction, bpmnprof_FlowFinalNode, bpmnprof_MessageEventDefinition, bpmnprof_IntermediateCatchEvent, bpmnprof_IntermediateThrowEvent, bpmnprof_SendObjectAction, bpmnprof_TerminateEventDefinition, bpmnprof_ImplicitThrowEvent, bpmnprof_CancelEventDefinition, bpmnprof_TextAnnotation, bpmnprof_ErrorEventDefinition, bpmnprof_DataObject, bpmnprof_DataStore, bpmnprof_Category, bpmnprof_Enumeration, bpmnprof_Group, bpmnprof_DataObjectReference, bpmnprof_Rendering, bpmnprof_Task, BPMNActivity, bpmnprof_Image, bpmnprof_HumanPerformer, Performer, bpmnprof_Performer, ResourceRole, bpmnprof_GlobalUserTask, bpmnprof_DataStoreReference, bpmnprof_UserTask, Task, bpmnprof_OpaqueAction, bpmnprof_GlobalConversation, BPMNCollaboration, bpmnprof_CallConversation, bpmnprof_CollaborationUse, bpmnprof_GlobalManualTask, bpmnprof_ManualTask, bpmnprof_PotentialOwner, HumanPerformer, bpmnprof_SubConversation, ConversationNode, bpmnprof_BusinessRuleTask, bpmnprof_ComplexBehaviorDefinition, bpmnprof_AdHocSubProcess, SubProcess, bpmnprof_Conversation, bpmnprof_SubProcess, bpmnprof_CallActivity, bpmnprof_CallBehaviorAction, bpmnprof_Transaction, bpmnprof_StandardLoopCharacteristics, LoopCharacteristics, bpmnprof_ScriptTask, bpmnprof_SendTask, bpmnprof_ServiceTask, bpmnprof_MultiInstanceLoopCharacteristics, bpmnprof_LoopNode, bpmnprof_ReceiveTask, bpmnprof_ExpansionRegion, AssociationDirection, EventBasedGatewayType, GatewayDirection, RelationshipDirection, ItemKind, ProcessType, AdHocOrdering, MultiInstanceBehavior},
    associations={extensionValues13, base_Element14, documentation16, default0, base_JoinNode1, base_ForkNode2, base_ControlNode4, base_ActivityGroup5, base_ActivityNode7, auditing8, monitoring9, _categoryValueRef11, container12, extensionDefinitions18, outgoing20, incoming21, base_Slot23, valueRef25, extensionAttributeDefinition28, base_Property30, base_Comment32, base_Stereotype34, extensionAttributeDefinitions36, base_Dependency39, targetRef40, sourceRef41, base_Class43, base_Class45, base_EnumerationLiteral48, categorizedFlowElements49, laneSets50, flowElements51, laneSet74, base_ActivityPartition53, lanes54, parentLane55, flowElementsContainer57, base_ActivityPartition59, _partitionElement62, flowNodeRefs65, partitionElementRef68, childLaneSet71, base_ControlFlow76, conditionExpression78, base_OpaqueExpression80, base_ForkNode82, base_StructuredActivityNode84, base_InterruptibleActivityRegion86, default88, activationCondition90, base_DecisionNode93, base_MergeNode94, base_Constraint120, targets122, default96, sources125, base_PackageableElement99, definition100, base_Package101, extensions102, imports104, relationships106, rootElements108, base_Stereotype109, definition112, base_PackageImport115, definitions117, monitoring139, supports143, properties145, resources147, definition128, auditing131, definitionalCollaborationRef133, base_Activity135, correlationSubscriptions137, base_Behavior148, ioSpecification149, supportedInterfaceRefs151, ioBinding153, base_Behavior155, base_Action158, dataInputs160, dataOutputs162, inputSets164, outputSets166, itemSubjectRef182, base_InputPin168, base_Parameter170, base_ActivityParameterNode172, inputSetRefs174, inputSetWithOptional175, inputSetWithWhileExecuting177, dataState179, optionalInputRefs197, base_TypedElement180, whileExecutingInputRefs198, dataInputRefs200, base_State184, base_Class186, structureRef189, import_192, base_ParameterSet195, optionalOutputRefs220, whileExecutingOutputRefs223, base_OutputPin202, base_Parameter204, base_ActivityParameterNode207, outputSetRefs210, outputSetWithOptional211, outputSetWithWhileExecuting214, base_ParameterSet217, dataOutputRefs226, base_Interface227, implementationRef229, operations232, callableElements234, inputDataRef252, base_Operation237, implementationRef239, inMessageRef242, outMessageRef244, errorRef247, itemRef249, correlationKeys275, participants277, outputDataRef255, base_Dependency279, innerParticipantRef282, operationRef258, outerParticipantRef285, base_Dependency261, participantAssociations264, conversationLinks266, messageFlowAssociations267, messageFlows269, base_Collaboration271, conversations273, base_Property288, incomingConversationLinks307, collaboration310, base_Dependency311, targetRef313, sourceRef314, base_MultiplicityElement316, processRef291, participantMultiplicity294, partnerEntityRef296, partnerRoleRef297, interfaceRefs299, base_Element302, outgoingConversationLinks304, base_Dependency324, innerMessageFlowRef327, outerMessageFlowRef330, base_InstanceSpecification318, participantRef319, base_Class320, participantRef322, base_Class356, correlationPropertyRef359, base_Property361, type364, correlationPropertyRetrievalExpression367, base_Dependency369, messageRef372, messagePath375, base_InformationFlow333, sourceRef335, targetRef338, messageRef341, base_InformationFlow344, messageFlowRefs347, correlationKeys350, participantRefs353, correlationPropertyRef394, base_DataStoreNode397, umlProperty399, evaluatesToTypeRef377, base_Class380, correlationKeyRef383, correlationPropertyBinding386, base_Property388, dataPath391, base_Property402, resourceAssignmentExpression404, resourceRef406, resourceParameterBindings408, process410, base_Property416, type419, expression411, resourceParameters414, base_OpaqueBehavior431, resources432, base_Slot422, parameterRef425, expression428, base_Action439, activityRef435, base_CallEvent436, base_Event438, attachedToRef462, base_AcceptEventAction465, base_InitialNode466, dataOutputAssociation468, eventClass471, activityClass442, properties445, default448, boundaryEventRefs451, dataInputAssociations453, dataOutputAssociations455, loopCharacteristics457, resources459, base_ObjectFlow482, sourceRef483, targetRef486, transformation489, assignment492, base_Dependency494, _eventDefinitions473, properties476, eventDefinitionRefs479, base_CallEvent507, timeCycle510, timeDate512, timeDuration515, base_ChangeEvent518, signalRef520, from_497, to500, base_StructuredActivityNode503, escalationRef506, messageRef531, operationRef533, base_CallEvent536, base_ChangeEvent539, condition541, _target545, base_CallEvent521, base_FinalNode524, base_CallOperationAction525, base_FlowFinalNode526, dataInputAssociation528, base_CallEvent553, base_SendObjectAction556, base_CallEvent557, base_CallEvent559, base_Comment561, source547, base_CallEvent549, errorRef551, dataObjectRef572, base_DataStoreNode573, base_DataStoreNode576, base_Enumeration563, categoryValue564, base_ActivityPartition567, _categoryValueRef569, base_OpaqueAction589, renderings590, ioSpecification592, base_Image594, base_Class579, itemSubjectRef581, _dataStore584, base_DataStoreNode586, _collaborationUse602, calledCollaborationRef603, participantAssociations606, renderings596, base_OpaqueAction598, conversationNodes600, base_OpaqueAction618, condition620, event622, base_ControlFlow624, base_StructuredActivityNode609, hasLaneSets611, base_CallBehaviorAction614, calledElementRef615, messageRef631, base_CallOperationAction633, operationRef636, completionCondition627, base_OpaqueAction629, operationRef648, base_CallOperationAction651, operationRef653, base_LoopNode639, loopCondition640, messageRef643, base_AcceptEventAction645, inputDataItem672, oneBehaviorEventRef675, noneBehaviorEventRef678, complexBehaviorDefinition681, loopCardinality656, completionCondition658, base_ExpansionRegion661, loopDataInputRef663, loopDataOutputRef666, outputDataItem669},
    generalizations={gen_bpmnprof_InclusiveGateway_NonExclusiveGateway, gen_bpmnprof_NonExclusiveGateway_Gateway, gen_bpmnprof_Gateway_FlowNode, gen_bpmnprof_FlowNode_FlowElement, gen_bpmnprof_FlowElement_BaseElement, gen_bpmnprof_Documentation_BaseElement, gen_bpmnprof_BPMNAssociation_BPMNArtifact, gen_bpmnprof_BPMNArtifact_BaseElement, gen_bpmnprof_Auditing_BaseElement, gen_bpmnprof_Monitoring_BaseElement, gen_bpmnprof_CategoryValue_BaseElement, gen_bpmnprof_FlowElementsContainer_BaseElement, gen_bpmnprof_LaneSet_BaseElement, gen_bpmnprof_SequenceFlow_FlowElement, gen_bpmnprof_Lane_BaseElement, gen_bpmnprof_ParallelGateway_NonExclusiveGateway, gen_bpmnprof_ComplexGateway_NonExclusiveGateway, gen_bpmnprof_BPMNExpression_BaseElement, gen_bpmnprof_EventBasedGateway_Gateway, gen_bpmnprof_ExclusiveGateway_Gateway, gen_bpmnprof_RootElement_BaseElement, gen_bpmnprof_Definitions_BaseElement, gen_bpmnprof_BPMNRelationship_BaseElement, gen_bpmnprof_BPMNProcess_CallableElement, gen_bpmnprof_BPMNProcess_FlowElementsContainer, gen_bpmnprof_CallableElement_RootElement, gen_bpmnprof_InputOutputSpecification_BaseElement, gen_bpmnprof_DataInput_ItemAwareElement, gen_bpmnprof_ItemAwareElement_BaseElement, gen_bpmnprof_DataState_BaseElement, gen_bpmnprof_ItemDefinition_RootElement, gen_bpmnprof_InputSet_BaseElement, gen_bpmnprof_DataOutput_ItemAwareElement, gen_bpmnprof_OutputSet_BaseElement, gen_bpmnprof_BPMNInterface_RootElement, gen_bpmnprof_BPMNOperation_BaseElement, gen_bpmnprof_InputOutputBinding_BaseElement, gen_bpmnprof_BPMNMessage_ItemDefinition, gen_bpmnprof_Error_ItemDefinition, gen_bpmnprof_ParticipantAssociation_BaseElement, gen_bpmnprof_Participant_BaseElement, gen_bpmnprof_BPMNCollaboration_RootElement, gen_bpmnprof_ConversationLink_BaseElement, gen_bpmnprof_ParticipantMultiplicity_BaseElement, gen_bpmnprof_PartnerEntity_RootElement, gen_bpmnprof_MessageFlow_BaseElement, gen_bpmnprof_PartnerRole_RootElement, gen_bpmnprof_MessageFlowAssociation_BaseElement, gen_bpmnprof_CorrelationKey_BaseElement, gen_bpmnprof_CorrelationProperty_BaseElement, gen_bpmnprof_CorrelationPropertyRetrievalExpression_BaseElement, gen_bpmnprof_FormalExpression_BPMNExpression, gen_bpmnprof_ConversationNode_InteractionNode, gen_bpmnprof_BPMNProperty_ItemAwareElement, gen_bpmnprof_ResourceRole_BaseElement, gen_bpmnprof_CorrelationSubscription_BaseElement, gen_bpmnprof_CorrelationPropertyBinding_BaseElement, gen_bpmnprof_ResourceAssignmentExpression_BPMNExpression, gen_bpmnprof_Resource_ItemDefinition, gen_bpmnprof_ResourceParameter_BaseElement, gen_bpmnprof_GlobalTask_CallableElement, gen_bpmnprof_GlobalBusinessRuleTask_GlobalTask, gen_bpmnprof_ResourceParameterBinding_BaseElement, gen_bpmnprof_GlobalScriptTask_GlobalTask, gen_bpmnprof_CompensateEventDefinition_EventDefinition, gen_bpmnprof_EventDefinition_RootElement, gen_bpmnprof_BPMNActivity_FlowNode, gen_bpmnprof_CatchEvent_BPMNEvent, gen_bpmnprof_BPMNEvent_FlowNode, gen_bpmnprof_BoundaryEvent_CatchEvent, gen_bpmnprof_Assignment_BaseElement, gen_bpmnprof_DataOutputAssociation_DataAssociation, gen_bpmnprof_DataAssociation_BaseElement, gen_bpmnprof_Escalation_ItemDefinition, gen_bpmnprof_TimerEventDefinition_EventDefinition, gen_bpmnprof_SignalEventDefinition_EventDefinition, gen_bpmnprof_DataInputAssociation_DataAssociation, gen_bpmnprof_LoopCharacteristics_BaseElement, gen_bpmnprof_EscalationEventDefinition_EventDefinition, gen_bpmnprof_StartEvent_CatchEvent, gen_bpmnprof_ConditionalEventDefinition_EventDefinition, gen_bpmnprof_LinkEventDefinition_EventDefinition, gen_bpmnprof_BPMNSignal_ItemDefinition, gen_bpmnprof_EndEvent_ThrowEvent, gen_bpmnprof_ThrowEvent_BPMNEvent, gen_bpmnprof_MessageEventDefinition_EventDefinition, gen_bpmnprof_IntermediateCatchEvent_CatchEvent, gen_bpmnprof_IntermediateThrowEvent_ThrowEvent, gen_bpmnprof_TerminateEventDefinition_EventDefinition, gen_bpmnprof_ImplicitThrowEvent_ThrowEvent, gen_bpmnprof_CancelEventDefinition_EventDefinition, gen_bpmnprof_TextAnnotation_BPMNArtifact, gen_bpmnprof_ErrorEventDefinition_EventDefinition, gen_bpmnprof_DataObject_FlowElement, gen_bpmnprof_DataObject_ItemAwareElement, gen_bpmnprof_DataStore_RootElement, gen_bpmnprof_Category_RootElement, gen_bpmnprof_Group_BPMNArtifact, gen_bpmnprof_DataObjectReference_FlowElement, gen_bpmnprof_DataObjectReference_ItemAwareElement, gen_bpmnprof_Task_BPMNActivity, gen_bpmnprof_Rendering_BaseElement, gen_bpmnprof_HumanPerformer_Performer, gen_bpmnprof_Performer_ResourceRole, gen_bpmnprof_GlobalUserTask_GlobalTask, gen_bpmnprof_DataStoreReference_FlowElement, gen_bpmnprof_DataStoreReference_ItemAwareElement, gen_bpmnprof_UserTask_Task, gen_bpmnprof_GlobalConversation_BPMNCollaboration, gen_bpmnprof_CallConversation_ConversationNode, gen_bpmnprof_GlobalManualTask_GlobalTask, gen_bpmnprof_ManualTask_Task, gen_bpmnprof_PotentialOwner_HumanPerformer, gen_bpmnprof_SubConversation_ConversationNode, gen_bpmnprof_BusinessRuleTask_Task, gen_bpmnprof_ComplexBehaviorDefinition_BaseElement, gen_bpmnprof_AdHocSubProcess_SubProcess, gen_bpmnprof_Conversation_ConversationNode, gen_bpmnprof_SubProcess_BPMNActivity, gen_bpmnprof_SubProcess_FlowElementsContainer, gen_bpmnprof_CallActivity_BPMNActivity, gen_bpmnprof_Transaction_SubProcess, gen_bpmnprof_StandardLoopCharacteristics_LoopCharacteristics, gen_bpmnprof_ScriptTask_Task, gen_bpmnprof_SendTask_Task, gen_bpmnprof_ServiceTask_Task, gen_bpmnprof_MultiInstanceLoopCharacteristics_LoopCharacteristics, gen_bpmnprof_ReceiveTask_Task},
    metadata=None
)
