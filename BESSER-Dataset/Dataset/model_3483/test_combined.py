...
def test_fm_Attribute_comment_value_roundtrip():
    instance = fm_Attribute(comment="sample_text", description="sample_text", id="sample_text", name="sample_text", type="sample_text", value="sample_text")
...
def test_assoc_attributes12_link_reassign_clear():
    ...
    b1 = fm_Attribute(comment="sample_text", description="sample_text", id="sample_text", name="sample_text", type="sample_text", value="sample_text")
    b2 = fm_Attribute(comment="sample_text_2", description="sample_text_2", id="sample_text_2", name="sample_text_2", type="sample_text_2", value="sample_text_2")
...
fm_Attribute_strategy = st.builds(fm_Attribute, comment=safe_text, description=safe_text, id=safe_text, name=safe_text, type=safe_text, value=safe_text)
@given(instance=fm_Attribute_strategy)
