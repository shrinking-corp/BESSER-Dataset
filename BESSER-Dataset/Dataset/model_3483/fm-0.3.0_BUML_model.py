...
fm_Group.attributes={fm_Group_xor, fm_Group_upper, fm_Group_description, fm_Group_or_, fm_Group_comment, fm_Group_lower}
...
fm_Attribute.attributes={fm_Attribute_id, fm_Attribute_name, fm_Attribute_description, fm_Attribute_type, fm_Attribute_comment, fm_Attribute_value}
...
fm_Feature.attributes={fm_Feature_lower, fm_Feature_root, fm_Feature_id, fm_Feature_description, fm_Feature_cloneable, fm_Feature_comment, fm_Feature_mandatory, fm_Feature_orphan, fm_Feature_optional, fm_Feature_name, fm_Feature_upper}
...
fm_Constraint.attributes={fm_Constraint_value, fm_Constraint_description, fm_Constraint_language, fm_Constraint_comment}
...
domain_model = DomainModel(
    name="fm",
    types={fm_FeatureModel, fm_Group, fm_Attribute, fm_Feature, fm_Constraint, fm_EObject, AttributeType},
    associations={parentGroup10, attributes12, features14, groups16, featureModel18, root0, orphans1, constraints4, parent6, parentFeature9, parent21, features23, feature25, featureModel27},
    generalizations={},
    metadata=None
)
