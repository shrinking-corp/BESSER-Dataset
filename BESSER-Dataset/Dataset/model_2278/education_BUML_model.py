...
# Classes
edu_Course = Class(name="edu_Course")
edu_Student = Class(name="edu_Student")
edu_Take_Course = Class(name="edu_Take_Course")
...
edu_Student.attributes={edu_Student_id, edu_Student_name, edu_Student_date_of_birth}
