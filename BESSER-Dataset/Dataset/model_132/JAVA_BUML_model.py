...
domain_model = DomainModel(
    name="JAVA",
    types={JAVA_ClassDeclaration, TypeDeclaration, JAVA_TypeAccess, JAVA_Type, JAVA_NamedElement, ASTNode, JAVA_ASTNode, AbstractTypeDeclaration, JAVA_BodyDeclaration, JAVA_Expression, JAVA_FieldDeclaration, Expression, JAVA_TypeDeclaration, JAVA_InterfaceDeclaration, JAVA_Package, NamedElement, JAVA_AbstractTypeDeclaration, BodyDeclaration, Type},
    associations={typeAccess9, superClass0, fields1, type3, ownedElements5, superInterfaces6},
    generalizations={gen_JAVA_ClassDeclaration_TypeDeclaration, gen_JAVA_Type_NamedElement, gen_JAVA_NamedElement_ASTNode, gen_JAVA_TypeDeclaration_AbstractTypeDeclaration, gen_JAVA_BodyDeclaration_NamedElement, gen_JAVA_Expression_ASTNode, gen_JAVA_FieldDeclaration_BodyDeclaration, gen_JAVA_TypeAccess_Expression, gen_JAVA_InterfaceDeclaration_TypeDeclaration, gen_JAVA_Package_NamedElement, gen_JAVA_AbstractTypeDeclaration_BodyDeclaration, gen_JAVA_AbstractTypeDeclaration_Type},
    metadata=None
)
