...
library_BaseResource.attributes={library_BaseResource_summaryDisplay, library_BaseResource_longName, library_BaseResource_shortName, library_BaseResource_expressionName, library_BaseResource_detailDisplay}
...
library_Parameter.attributes={library_Parameter_name, library_Parameter_expressionName, library_Parameter_description, library_Parameter_modifiable, library_Parameter_value}
...
library_ExpressionResult.attributes={library_ExpressionResult_targetKindHint, library_ExpressionResult_targetRange, library_ExpressionResult_targetIntervalHint}
...
library_ProductInfo.attributes={library_ProductInfo_endOfSupportDate, library_ProductInfo_availableDate, library_ProductInfo_underDevelopmentDate, library_ProductInfo_salesCode, library_ProductInfo_endOfSalesDate, library_ProductInfo_productCode}
...
domain_model = DomainModel(
    name="library",
    types={library_BaseResource, Base, library_Unit, library_BaseExpressionResult, library_Lifecycle, library_NetXResource, library_Metric, library_Expression, library_Tolerance, library_Protocol, library_Component, library_DiagramInfo, library_MultiImage, library_Equipment, Component, library_Parameter, library_EquipmentRelationship, library_EquipmentGroup, library_EObject, library_ExpressionResult, BaseExpressionResult, library_Function, library_FunctionRelationship, library_LastEvaluationExpressionResult, library_Value, library_Library, library_NodeType, library_MetricSource, library_Meta, BaseResource, library_MetricValueRange, library_ProductInfo, library_Vendor, Company, LevelKind, RangeKind, RedundancyType, StateType},
    associations={lifecycle1, resourceRefs2, metricRefs3, capacityExpressionRef5, utilizationExpressionRef7, toleranceRefs10, unitRef0, allResources16, diagrams18, icons20, protocolRefs12, parameterRefs14, equipmentRelationshipRefs26, allEquipments29, equipments23, equipmentGroups24, diagrams31, equipmentGroupResources34, expressionRefs37, equipmentRefs40, parameterRefs43, allEquipmentResources46, allEquipments49, evaluationObject52, targetResource54, functions59, functionRelationshipRefs60, allFunctions63, targetValues56, functions65, nodeTypes67, equipments69, metrics72, metricSources75, parameters77, units86, version89, componentRef91, metricRef92, tolerances80, expressions83, forecastCapacityValues103, forecastValues106, trendedValues109, functions112, equipments115, metricValueRanges95, capacityValues97, utilizationValues100, equipmentRef118, licensedFunctionRef120, expressionRef126, nodeTypeRef123, products132, icons129},
    generalizations={gen_library_BaseResource_Base, gen_library_Component_Base, gen_library_Equipment_Component, gen_library_EquipmentGroup_Base, gen_library_Expression_Base, gen_library_ExpressionResult_BaseExpressionResult, gen_library_Function_Component, gen_library_LastEvaluationExpressionResult_BaseExpressionResult, gen_library_NetXResource_BaseResource, gen_library_NodeType_Base, gen_library_ProductInfo_Base, gen_library_Parameter_Base, gen_library_Tolerance_Base, gen_library_Unit_Base, gen_library_Vendor_Company},
    metadata=None
)
