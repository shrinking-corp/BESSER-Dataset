...
domain_model = DomainModel(
    name="TestPackage",
    types={TestPackage_TestInterface, TestPackage_SuperClass, TestPackage_UberClass, TestPackage_SubPackage_SubTestClass, TestPackage_SubPackage_SubTestInterface, TestPackage_TestClass, SuperClass, UberClass, TestEnum, SubTestEnum},
    associations={},
