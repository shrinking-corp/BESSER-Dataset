...
diva_EnumVariable_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_visitor', type=StringType), Parameter(name='diva_context', type=StringType)})
...
diva_NotTerm_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_visitor', type=StringType), Parameter(name='diva_context', type=StringType)})
...
diva_Configuration_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_visitor', type=StringType)})
...
diva_EnumVariableValue_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_visitor', type=StringType), Parameter(name='diva_context', type=StringType)})
...
diva_BoolVariableValue_m_accept: Method = Method(name="accept", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_visitor', type=StringType)})
...
diva_visitors_Visitor_m_visitAndTerm: Method = Method(name="visitAndTerm", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
...
diva_visitors_Visitor_m_visitProperty: Method = Method(name="visitProperty", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
...
diva_visitors_Visitor_m_visitVariant: Method = Method(name="visitVariant", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
...
diva_visitors_Visitor_m_visitAnnotation: Method = Method(name="visitAnnotation", parameters={Parameter(name='diva_context', type=StringType), Parameter(name='diva_node', type=StringType)})
diva_visitors_Visitor_m_visitSimulationModel: Method = Method(name="visitSimulationModel", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
...
diva_visitors_Visitor.methods={diva_visitors_Visitor_m_visitBaseModel, diva_visitors_Visitor_m_visitEnumVariable, diva_visitors_Visitor_m_visitBoolVariableValue, diva_visitors_Visitor_m_visitBooleanVariable, diva_visitors_Visitor_m_visitPriorityRule, diva_visitors_Visitor_m_visitConfiguration, diva_visitors_Visitor_m_visitConfigVariant, diva_visitors_Visitor_m_visitInvariant, diva_visitors_Visitor_m_visitAnnotation, diva_visitors_Visitor_m_visitVariantExpression, diva_visitors_Visitor_m_visitSimulationModel, diva_visitors_Visitor_m_visitBooleanTerm, diva_visitors_Visitor_m_visitContextExpression, diva_visitors_Visitor_m_visitOrTerm, diva_visitors_Visitor_m_visitPriority, diva_visitors_Visitor_m_visitAndTerm, diva_visitors_Visitor_m_visitContext, diva_visitors_Visitor_m_visitExpression, diva_visitors_Visitor_m_visitPropertyValue, diva_visitors_Visitor_m_visitVariabilityModel, diva_visitors_Visitor_m_visitPropertyPriority, diva_visitors_Visitor_m_visitNotTerm, diva_visitors_Visitor_m_visitEnumTerm, diva_visitors_Visitor_m_visitEnumVariableValue, diva_visitors_Visitor_m_visitEnumLiteral, diva_visitors_Visitor_m_visitScenario, diva_visitors_Visitor_m_visitAspectModel, diva_visitors_Visitor_m_visitDimension, diva_visitors_Visitor_m_visitScore, diva_visitors_Visitor_m_visitVariantTerm, diva_visitors_Visitor_m_visitMultiplicityConstraint, diva_visitors_Visitor_m_visitVariant, diva_visitors_Visitor_m_visitProperty}
...
diva_visitors_TopDownVisitor_m_visitContextExpression: Method = Method(name="visitContextExpression", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
...
diva_visitors_TopDownVisitor_m_visitContext: Method = Method(name="visitContext", parameters={Parameter(name='diva_node', type=StringType), Parameter(name='diva_context', type=StringType)})
...
diva_visitors_TopDownVisitor.methods={diva_visitors_TopDownVisitor_m_visitBaseModel, diva_visitors_TopDownVisitor_m_visitMultiplicityConstraint, diva_visitors_TopDownVisitor_m_visitPriorityRule, diva_visitors_TopDownVisitor_m_visitExpression, diva_visitors_TopDownVisitor_m_visitPropertyValue, diva_visitors_TopDownVisitor_m_visitVariantExpression, diva_visitors_TopDownVisitor_m_visitInvariant, diva_visitors_TopDownVisitor_m_visitScenario, diva_visitors_TopDownVisitor_m_visitPropertyPriority, diva_visitors_TopDownVisitor_m_visitSimulationModel, diva_visitors_TopDownVisitor_m_visitAspectModel, diva_visitors_TopDownVisitor_m_visitBooleanVariable, diva_visitors_TopDownVisitor_m_visitProperty, diva_visitors_TopDownVisitor_m_visitEnumVariableValue, diva_visitors_TopDownVisitor_m_visitPriority, diva_visitors_TopDownVisitor_m_visitVariabilityModel, diva_visitors_TopDownVisitor_m_visitNotTerm, diva_visitors_TopDownVisitor_m_visitOrTerm, diva_visitors_TopDownVisitor_m_visitAnnotation, diva_visitors_TopDownVisitor_m_visitConfiguration, diva_visitors_TopDownVisitor_m_visitVariantTerm, diva_visitors_TopDownVisitor_m_visitVariant, diva_visitors_TopDownVisitor_m_visitEnumTerm, diva_visitors_TopDownVisitor_m_visitAndTerm, diva_visitors_TopDownVisitor_m_visitContext, diva_visitors_TopDownVisitor_m_visitContextExpression, diva_visitors_TopDownVisitor_m_visitConfigVariant, diva_visitors_TopDownVisitor_m_visitBooleanTerm, diva_visitors_TopDownVisitor_m_visitBoolVariableValue, diva_visitors_TopDownVisitor_m_visitEnumVariable, diva_visitors_TopDownVisitor_m_visitScore, diva_visitors_TopDownVisitor_m_visitEnumLiteral, diva_visitors_TopDownVisitor_m_visitDimension}
...
domain_model = DomainModel(
    name="diva",
    types={diva_BaseModel, diva_Variable, diva_Property, diva_Dimension, diva_Rule, diva_Constraint, diva_VariabilityModel, DiVAModelElement, Model, diva_AspectModel, diva_SimulationModel, diva_Invariant, Constraint, diva_Expression, NamedElement, diva_Model, diva_Term, diva_AndTerm, NaryTerm, diva_OrTerm, diva_EnumVariable, Variable, diva_EnumLiteral, diva_BooleanVariable, diva_VariantTerm, diva_Variant, diva_VariableTerm, diva_EnumTerm, VariableTerm, diva_NotTerm, Term, diva_NaryTerm, diva_NamedElement, diva_BooleanTerm, diva_MultiplicityConstraint, Expression, diva_PropertyValue, diva_VariantExpression, diva_ContextExpression, diva_PropertyPriority, diva_PriorityRule, Rule, diva_Annotation, Visitable, diva_DiVAModelElement, diva_VariableValue, diva_Configuration, diva_Priority, ScoredElement, diva_Scenario, diva_Context, diva_ScoredElement, diva_Score, diva_ConfigVariant, diva_EnumVariableValue, diva_BoolVariableValue, VariableValue, diva_visitors_Visitable, diva_visitors_Visitor, diva_visitors_TopDownVisitor, Verdict},
    associations={base0, context1, property3, dimension5, rule7, constraint9, simulation11, expression12, literal13, variant17, variable18, term14, term15, model22, type24, value20, constraints38, term40, propertyValue25, dependency27, available29, required31, variant34, property35, context43, priority45, available53, property47, property50, variable59, configuration60, oracle62, priority65, annotation56, scenario57, model58, context72, score75, variant67, variant69, literal85, property76, property79, variable82},
    generalizations={gen_diva_VariabilityModel_DiVAModelElement, gen_diva_BaseModel_Model, gen_diva_AspectModel_Model, gen_diva_Invariant_Constraint, gen_diva_Variable_NamedElement, gen_diva_Model_DiVAModelElement, gen_diva_BooleanVariable_Variable, gen_diva_Term_DiVAModelElement, gen_diva_AndTerm_NaryTerm, gen_diva_OrTerm_NaryTerm, gen_diva_EnumVariable_Variable, gen_diva_VariantTerm_Term, gen_diva_VariableTerm_Term, gen_diva_EnumTerm_VariableTerm, gen_diva_NotTerm_Term, gen_diva_NaryTerm_Term, gen_diva_NamedElement_DiVAModelElement, gen_diva_Constraint_NamedElement, gen_diva_Variant_NamedElement, gen_diva_BooleanTerm_VariableTerm, gen_diva_Rule_NamedElement, gen_diva_EnumLiteral_NamedElement, gen_diva_Expression_DiVAModelElement, gen_diva_ContextExpression_Expression, gen_diva_Dimension_NamedElement, gen_diva_Property_NamedElement, gen_diva_PropertyValue_DiVAModelElement, gen_diva_VariantExpression_Expression, gen_diva_PriorityRule_Rule, gen_diva_Annotation_Visitable, gen_diva_DiVAModelElement_Visitable, gen_diva_PropertyPriority_DiVAModelElement, gen_diva_MultiplicityConstraint_Constraint, gen_diva_Configuration_ScoredElement, gen_diva_SimulationModel_DiVAModelElement, gen_diva_Context_NamedElement, gen_diva_ScoredElement_DiVAModelElement, gen_diva_Score_DiVAModelElement, gen_diva_ConfigVariant_ScoredElement, gen_diva_Scenario_NamedElement, gen_diva_EnumVariableValue_VariableValue, gen_diva_Priority_DiVAModelElement, gen_diva_VariableValue_DiVAModelElement, gen_diva_BoolVariableValue_VariableValue},
    metadata=None
)
