...
class diva_visitors_TopDownVisitor(ABC):
    ...
    def visitProperty(self, diva_node, diva_context):
    ...
    def visitAspectModel(self, diva_node, diva_context):
...
class diva_visitors_Visitor(ABC):
    ...
    def visitVariantExpression(self, diva_node, diva_context):
        # TODO: Implement visitVariantExpression method
        pass
    ...
    def visitMultiplicityConstraint(self, diva_node, diva_context):
        # TODO: Implement visitMultiplicityConstraint method
        pass
...
class diva_Configuration(ScoredElement):
    ...
    def __init__(self, verdict: str, diva_Configuration68: set["diva_ConfigVariant"] = None, diva_Configuration: "diva_Context" = None):
...
class diva_Variant(NamedElement):
    ...
    def __init__(self, diva_Variant71: "diva_ConfigVariant" = None, diva_Variant: "diva_VariantTerm" = None, diva_Variant23: "diva_AspectModel" = None, variant: "diva_Dimension" = None, diva_Variant26: set["diva_PropertyValue"] = None, diva_Variant28: "diva_VariantExpression" = None, diva_Variant30: "diva_ContextExpression" = None, diva_Variant32: "diva_ContextExpression" = None, Variant: "diva_Dimension" = None):
...
class diva_Context(NamedElement):
    ...
    def __init__(self, verdict: str, diva_Context66: set["diva_Priority"] = None, diva_Context74: "diva_Scenario" = None, diva_Context: set["diva_VariableValue"] = None, diva_Context61: set["diva_Configuration"] = None, diva_Context63: "diva_VariantExpression" = None):
        self.verdict = verdict
...
class diva_VariabilityModel(DiVAModelElement):
    ...
    def __init__(self, VariabilityModel: "diva_SimulationModel" = None, diva_VariabilityModel: "diva_BaseModel" = None, diva_VariabilityModel2: set["diva_Variable"] = None, diva_VariabilityModel4: set["diva_Property"] = None, diva_VariabilityModel6: set["diva_Dimension"] = None, diva_VariabilityModel8: set["diva_Rule"] = None, diva_VariabilityModel10: set["diva_Constraint"] = None, model: "diva_SimulationModel" = None):
...
class diva_Dimension(NamedElement):
    ...
    def __init__(self, upper: str, lower: str, diva_Dimension: "diva_VariabilityModel" = None, Dimension: "diva_Variant" = None, diva_Dimension39: set["diva_MultiplicityConstraint"] = None, type: set["diva_Variant"] = None, diva_Dimension36: set["diva_Property"] = None):
        self.upper = upper
        self.lower = lower
