...
class tree_Node:
    ...
    def __init__(self, anAttribute: int, anAttribute2: int, anAttribute3: int, anAttribute4: int, name: str, Node5: "tree_Node" = None, child: "tree_Node" = None, tree_Node8: "tree_Node" = None, tree_Node6: set["tree_Node"] = None, tree_Node: "tree_Tree" = None, Node: "tree_Node" = None, parent: set["tree_Node"] = None):
