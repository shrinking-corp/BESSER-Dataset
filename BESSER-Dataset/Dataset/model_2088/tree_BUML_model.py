...
# Classes
tree_Tree = Class(name="tree_Tree")
tree_Node = Class(name="tree_Node")
...
tree_Node.attributes={tree_Node_anAttribute3, tree_Node_anAttribute4, tree_Node_anAttribute2, tree_Node_anAttribute, tree_Node_name}
...
domain_model = DomainModel(
    ...
    associations={parent4, aReference7, root0, child2},
    generalizations={},
    metadata=None
)
