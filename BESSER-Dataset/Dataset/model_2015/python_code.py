...
class trace_DebugTraceRegion:
    ...
    def __init__(self, label: str, myOffset: int, myLength: int, myLineNumber: int, myEndLineNumber: int, myEndOffset: int, trace_DebugTraceRegion0: set["trace_DebugTraceRegion"] = None, trace_DebugTraceRegion3: set["trace_DebugLocationData"] = None, trace_DebugTraceRegion: "trace_DebugTraceRegion" = None):
        self.label = label
