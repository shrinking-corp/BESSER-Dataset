...
def test_trace_DebugTraceRegion_label_value_roundtrip():
    instance = trace_DebugTraceRegion(label="sample_text", myEndLineNumber=7, myEndOffset=7, myLength=7, myLineNumber=7, myOffset=7)
    assert instance.label == "sample_text"
    instance.label = "sample_text_2"
    assert instance.label == "sample_text_2"
...
def test_assoc_associations2_link_reassign_clear():
    a = trace_DebugTraceRegion(label="sample_text", myEndLineNumber=7, myEndOffset=7, myLength=7, myLineNumber=7, myOffset=7)
...
def test_assoc_nestedRegions1_link_reassign_clear():
    a = trace_DebugTraceRegion(label="sample_text", myEndLineNumber=7, myEndOffset=7, myLength=7, myLineNumber=7, myOffset=7)
    b1 = trace_DebugTraceRegion(label="sample_text", myEndLineNumber=7, myEndOffset=7, myLength=7, myLineNumber=7, myOffset=7)
    b2 = trace_DebugTraceRegion(label="sample_text_2", myEndLineNumber=13, myEndOffset=13, myLength=13, myLineNumber=13, myOffset=13)
...
trace_DebugTraceRegion_strategy = st.builds(trace_DebugTraceRegion, label=safe_text, myEndLineNumber=st.integers(), myEndOffset=st.integers(), myLength=st.integers(), myLineNumber=st.integers(), myOffset=st.integers())
@given(instance=trace_DebugTraceRegion_strategy)
@settings(max_examples=25)
