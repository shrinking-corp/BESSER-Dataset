...
# Classes
projectDsl_Company = Class(name="projectDsl_Company")
projectDsl_Employees = Class(name="projectDsl_Employees")
projectDsl_Project = Class(name="projectDsl_Project")
projectDsl_Employee = Class(name="projectDsl_Employee")
projectDsl_Task = Class(name="projectDsl_Task")
...
projectDsl_Project.attributes={projectDsl_Project_name, projectDsl_Project_type}
...
projectDsl_Employee.attributes={projectDsl_Employee_height, projectDsl_Employee_name, projectDsl_Employee_weight}
...
projectDsl_Task.attributes={projectDsl_Task_name, projectDsl_Task_type}
