...
def test_scraper_actor_is_not_abstract():
    assert not inspect.isabstract(Scraper_Actor)


def test_scraper_actor_constructor_exists():
    assert callable(Scraper_Actor.__init__)


def test_scraper_actor_constructor_args():
...
def test_settings_state_actor_is_not_abstract():
    assert not inspect.isabstract(Settings_state_Actor)


def test_settings_state_actor_constructor_exists():
    assert callable(Settings_state_Actor.__init__)


def test_settings_state_actor_constructor_args():
    sig = inspect.signature(Settings_state_Actor.__init__)
    params = list(sig.parameters.keys())



def test_menu_state_actor_is_not_abstract():
    assert not inspect.isabstract(menu_state_Actor)


def test_menu_state_actor_constructor_exists():
    assert callable(menu_state_Actor.__init__)


def test_menu_state_actor_constructor_args():
