...
menu_state_Actor = Class(name="menu_state_Actor")
Settings_state_Actor = Class(name="Settings_state_Actor")
Actor4_Actor = Class(name="Actor4_Actor")
Class_ = Class(name="Class")
User_Actor = Class(name="User_Actor")
Scraper_Actor = Class(name="Scraper_Actor")
...
# menu_state_Actor class attributes and methods

# Settings_state_Actor class attributes and methods
...
# Scraper_Actor class attributes and methods
...
domain_model = DomainModel(
    name="_OJ_dcH8AEeqjCeBtMxTJVQ",
    types={ShoppingCartExample_LineItem, ShoppingCartExample_Account, ShoppingCartExample_Customer, Actor_Actor, player_Actor, menu_state_Actor, Settings_state_Actor, Actor4_Actor, Class_, User_Actor, Scraper_Actor, Interface_Interface, ShoppingCartExample_ShoppingCart, ShoppingCartExample_Order},
