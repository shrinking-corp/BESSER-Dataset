...
# Classes
Actions_BasicActions_OutputPin = Class(name="Actions_BasicActions_OutputPin")
Actions_BasicActions_Pin = Class(name="Actions_BasicActions_Pin", is_abstract=True)
BasicActions_TypedElement = Class(name="BasicActions_TypedElement")
BasicActions_MultiplicityElement = Class(name="BasicActions_MultiplicityElement")
Actions_BasicActions_MultiplicityElement = Class(name="Actions_BasicActions_MultiplicityElement", is_abstract=True)
Actions_BasicActions_TypedElement = Class(name="Actions_BasicActions_TypedElement", is_abstract=True)
Actions_BasicActions_ValuePin = Class(name="Actions_BasicActions_ValuePin")
ValueSpecification = Class(name="ValueSpecification")
Actions_BasicActions_ValueSpecification = Class(name="Actions_BasicActions_ValueSpecification", is_abstract=True)
Actions_BasicActions_InvocationAction = Class(name="Actions_BasicActions_InvocationAction", is_abstract=True)
Actions_BasicActions_Action = Class(name="Actions_BasicActions_Action", is_abstract=True)
NamedElement = Class(name="NamedElement")
Classifier = Class(name="Classifier")
InputPin = Class(name="InputPin")
OutputPin = Class(name="OutputPin")
Actions_BasicActions_NamedElement = Class(name="Actions_BasicActions_NamedElement", is_abstract=True)
Actions_BasicActions_Classifier = Class(name="Actions_BasicActions_Classifier", is_abstract=True)
Actions_BasicActions_OpaqueAction = Class(name="Actions_BasicActions_OpaqueAction")
Action = Class(name="Action")
Actions_BasicActions_InputPin = Class(name="Actions_BasicActions_InputPin")
Pin = Class(name="Pin")
Actions_BasicActions_Signal = Class(name="Actions_BasicActions_Signal")
Actions_IntermediateActions_BroadcastSignalAction = Class(name="Actions_IntermediateActions_BroadcastSignalAction")
Actions_IntermediateActions_SendObjectAction = Class(name="Actions_IntermediateActions_SendObjectAction")
Actions_IntermediateActions_CreateObjectAction = Class(name="Actions_IntermediateActions_CreateObjectAction")
Actions_BasicActions_CallAction = Class(name="Actions_BasicActions_CallAction", is_abstract=True)
InvocationAction = Class(name="InvocationAction")
Actions_BasicActions_CallBehaviorAction = Class(name="Actions_BasicActions_CallBehaviorAction")
CallAction = Class(name="CallAction")
Behavior = Class(name="Behavior")
Actions_BasicActions_Behavior = Class(name="Actions_BasicActions_Behavior", is_abstract=True)
Actions_BasicActions_CallOperationAction = Class(name="Actions_BasicActions_CallOperationAction")
Operation = Class(name="Operation")
Actions_BasicActions_Operation = Class(name="Actions_BasicActions_Operation")
Actions_BasicActions_SendSignalAction = Class(name="Actions_BasicActions_SendSignalAction")
Signal = Class(name="Signal")
Actions_IntermediateActions_StructuralFeature = Class(name="Actions_IntermediateActions_StructuralFeature", is_abstract=True)
Actions_IntermediateActions_ReadStructuralFeatureAction = Class(name="Actions_IntermediateActions_ReadStructuralFeatureAction")
StructuralFeatureAction = Class(name="StructuralFeatureAction")
Actions_IntermediateActions_WriteStructuralFeatureAction = Class(name="Actions_IntermediateActions_WriteStructuralFeatureAction", is_abstract=True)
Actions_IntermediateActions_DestroyObjectAction = Class(name="Actions_IntermediateActions_DestroyObjectAction")
Actions_IntermediateActions_TestIdentityAction = Class(name="Actions_IntermediateActions_TestIdentityAction")
Actions_IntermediateActions_ReadSelfAction = Class(name="Actions_IntermediateActions_ReadSelfAction")
Actions_IntermediateActions_ValueSpecificationAction = Class(name="Actions_IntermediateActions_ValueSpecificationAction")
Actions_IntermediateActions_StructuralFeatureAction = Class(name="Actions_IntermediateActions_StructuralFeatureAction", is_abstract=True)
StructuralFeature = Class(name="StructuralFeature")
Actions_IntermediateActions_ReadLinkAction = Class(name="Actions_IntermediateActions_ReadLinkAction")
LinkAction = Class(name="LinkAction")
Actions_IntermediateActions_WriteLinkAction = Class(name="Actions_IntermediateActions_WriteLinkAction", is_abstract=True)
Actions_IntermediateActions_CreateLinkAction = Class(name="Actions_IntermediateActions_CreateLinkAction")
WriteLinkAction = Class(name="WriteLinkAction")
Actions_IntermediateActions_LinkEndCreationData = Class(name="Actions_IntermediateActions_LinkEndCreationData")
Actions_IntermediateActions_Element = Class(name="Actions_IntermediateActions_Element", is_abstract=True)
Actions_IntermediateActions_DestroyLinkAction = Class(name="Actions_IntermediateActions_DestroyLinkAction")
Actions_IntermediateActions_AddStructuralFeatureValueAction = Class(name="Actions_IntermediateActions_AddStructuralFeatureValueAction")
WriteStructuralFeatureAction = Class(name="WriteStructuralFeatureAction")
Actions_IntermediateActions_RemoveStructuralFeatureValueAction = Class(name="Actions_IntermediateActions_RemoveStructuralFeatureValueAction")
Actions_IntermediateActions_ClearStructuralFeatureAction = Class(name="Actions_IntermediateActions_ClearStructuralFeatureAction")
Actions_IntermediateActions_LinkAction = Class(name="Actions_IntermediateActions_LinkAction")
LinkEndData = Class(name="LinkEndData")
Actions_IntermediateActions_LinkEndData = Class(name="Actions_IntermediateActions_LinkEndData", is_abstract=True)
Element = Class(name="Element")
Property_ = Class(name="Property")
QualifierValue = Class(name="QualifierValue")
Actions_IntermediateActions_Property = Class(name="Actions_IntermediateActions_Property")
Actions_CompleteActions_AcceptCallAction = Class(name="Actions_CompleteActions_AcceptCallAction")
AcceptEventAction = Class(name="AcceptEventAction")
Actions_CompleteActions_Trigger = Class(name="Actions_CompleteActions_Trigger")
Actions_CompleteActions_ReadExtendAction = Class(name="Actions_CompleteActions_ReadExtendAction")
Actions_CompleteActions_ReclassifyObjectAction = Class(name="Actions_CompleteActions_ReclassifyObjectAction")
Actions_IntermediateActions_LinkEndDestructionData = Class(name="Actions_IntermediateActions_LinkEndDestructionData")
Actions_CompleteActions_ReplyAction = Class(name="Actions_CompleteActions_ReplyAction")
Trigger = Class(name="Trigger")
Actions_CompleteActions_UnmarshallAction = Class(name="Actions_CompleteActions_UnmarshallAction")
Actions_CompleteActions_AcceptEventAction = Class(name="Actions_CompleteActions_AcceptEventAction")
Actions_CompleteActions_ReadLinkObjectEndAction = Class(name="Actions_CompleteActions_ReadLinkObjectEndAction")
Actions_CompleteActions_ReadLinkObjectEndQualifierAction = Class(name="Actions_CompleteActions_ReadLinkObjectEndQualifierAction")
Actions_CompleteActions_ReadlsClassifiedObjectAction = Class(name="Actions_CompleteActions_ReadlsClassifiedObjectAction")
Actions_CompleteActions_StartClassifierBehaviorAction = Class(name="Actions_CompleteActions_StartClassifierBehaviorAction")
Actions_CompleteActions_StartObjectBehaviorAction = Class(name="Actions_CompleteActions_StartObjectBehaviorAction")
Actions_CompleteActions_QualifierValue = Class(name="Actions_CompleteActions_QualifierValue")
Actions_StructuredActions_WriteVariableAction = Class(name="Actions_StructuredActions_WriteVariableAction")
Actions_StructuredActions_AddVariableValueAction = Class(name="Actions_StructuredActions_AddVariableValueAction")
WriteVariableAction = Class(name="WriteVariableAction")
Actions_StructuredActions_RemoveVariableValueAction = Class(name="Actions_StructuredActions_RemoveVariableValueAction")
Actions_StructuredActions_ClearVariableAction = Class(name="Actions_StructuredActions_ClearVariableAction")
Actions_CompleteActions_CreateLinkObjectAction = Class(name="Actions_CompleteActions_CreateLinkObjectAction")
CreateLinkAction = Class(name="CreateLinkAction")
Actions_CompleteActions_ReduceAction = Class(name="Actions_CompleteActions_ReduceAction")
Actions_StructuredActions_VariableAction = Class(name="Actions_StructuredActions_VariableAction", is_abstract=True)
Variable = Class(name="Variable")
Actions_StructuredActions_Variable = Class(name="Actions_StructuredActions_Variable")
Actions_StructuredActions_ReadVariableAction = Class(name="Actions_StructuredActions_ReadVariableAction")
VariableAction = Class(name="VariableAction")
Actions_StructuredActions_RaiseExceptionAction = Class(name="Actions_StructuredActions_RaiseExceptionAction")
Actions_StructuredActions_ActionInputPin = Class(name="Actions_StructuredActions_ActionInputPin")
...
Actions_BasicActions_OpaqueAction.attributes={Actions_BasicActions_OpaqueAction_body, Actions_BasicActions_OpaqueAction_language}
...
domain_model = DomainModel(
    name="Actions",
    types={Actions_BasicActions_OutputPin, Actions_BasicActions_Pin, BasicActions_TypedElement, BasicActions_MultiplicityElement, Actions_BasicActions_MultiplicityElement, Actions_BasicActions_TypedElement, Actions_BasicActions_ValuePin, ValueSpecification, Actions_BasicActions_ValueSpecification, Actions_BasicActions_InvocationAction, Actions_BasicActions_Action, NamedElement, Classifier, InputPin, OutputPin, Actions_BasicActions_NamedElement, Actions_BasicActions_Classifier, Actions_BasicActions_OpaqueAction, Action, Actions_BasicActions_InputPin, Pin, Actions_BasicActions_Signal, Actions_IntermediateActions_BroadcastSignalAction, Actions_IntermediateActions_SendObjectAction, Actions_IntermediateActions_CreateObjectAction, Actions_BasicActions_CallAction, InvocationAction, Actions_BasicActions_CallBehaviorAction, CallAction, Behavior, Actions_BasicActions_Behavior, Actions_BasicActions_CallOperationAction, Operation, Actions_BasicActions_Operation, Actions_BasicActions_SendSignalAction, Signal, Actions_IntermediateActions_StructuralFeature, Actions_IntermediateActions_ReadStructuralFeatureAction, StructuralFeatureAction, Actions_IntermediateActions_WriteStructuralFeatureAction, Actions_IntermediateActions_DestroyObjectAction, Actions_IntermediateActions_TestIdentityAction, Actions_IntermediateActions_ReadSelfAction, Actions_IntermediateActions_ValueSpecificationAction, Actions_IntermediateActions_StructuralFeatureAction, StructuralFeature, Actions_IntermediateActions_ReadLinkAction, LinkAction, Actions_IntermediateActions_WriteLinkAction, Actions_IntermediateActions_CreateLinkAction, WriteLinkAction, Actions_IntermediateActions_LinkEndCreationData, Actions_IntermediateActions_Element, Actions_IntermediateActions_DestroyLinkAction, Actions_IntermediateActions_AddStructuralFeatureValueAction, WriteStructuralFeatureAction, Actions_IntermediateActions_RemoveStructuralFeatureValueAction, Actions_IntermediateActions_ClearStructuralFeatureAction, Actions_IntermediateActions_LinkAction, LinkEndData, Actions_IntermediateActions_LinkEndData, Element, Property_, QualifierValue, Actions_IntermediateActions_Property, Actions_CompleteActions_AcceptCallAction, AcceptEventAction, Actions_CompleteActions_Trigger, Actions_CompleteActions_ReadExtendAction, Actions_CompleteActions_ReclassifyObjectAction, Actions_IntermediateActions_LinkEndDestructionData, Actions_CompleteActions_ReplyAction, Trigger, Actions_CompleteActions_UnmarshallAction, Actions_CompleteActions_AcceptEventAction, Actions_CompleteActions_ReadLinkObjectEndAction, Actions_CompleteActions_ReadLinkObjectEndQualifierAction, Actions_CompleteActions_ReadlsClassifiedObjectAction, Actions_CompleteActions_StartClassifierBehaviorAction, Actions_CompleteActions_StartObjectBehaviorAction, Actions_CompleteActions_QualifierValue, Actions_StructuredActions_WriteVariableAction, Actions_StructuredActions_AddVariableValueAction, WriteVariableAction, Actions_StructuredActions_RemoveVariableValueAction, Actions_StructuredActions_ClearVariableAction, Actions_CompleteActions_CreateLinkObjectAction, CreateLinkAction, Actions_CompleteActions_ReduceAction, Actions_StructuredActions_VariableAction, Variable, Actions_StructuredActions_Variable, Actions_StructuredActions_ReadVariableAction, VariableAction, Actions_StructuredActions_RaiseExceptionAction, Actions_StructuredActions_ActionInputPin},
    associations={value10, context0, input1, output3, inputValue5, outputValue7, signal24, target26, request28, argument11, result13, behavior15, operation16, target17, target20, signal22, structuralFeature53, object54, result57, value59, classifier31, result33, target36, result38, first40, second43, result46, result48, value50, result80, insertAt82, result61, insertAt64, removeAt66, result68, inputValue70, endData72, value74, end76, qualifier78, trigger103, returnInformation106, result108, classifier110, destroyAt84, returnInformation86, replyValue88, replyToCall91, object93, unmarshallType95, result98, result101, end135, object137, result140, object143, object113, oldClassifier115, newClassifier118, result121, object123, object126, object128, qualifier130, value132, value164, insertAt166, removeAt168, result145, qualifier148, result151, result153, collection155, reducer158, variable161, result162, exception170, fromAction172},
    generalizations={gen_Actions_BasicActions_OutputPin_Pin, gen_Actions_BasicActions_Pin_BasicActions_TypedElement, gen_Actions_BasicActions_Pin_BasicActions_MultiplicityElement, gen_Actions_BasicActions_ValuePin_InputPin, gen_Actions_BasicActions_InvocationAction_Action, gen_Actions_BasicActions_Action_NamedElement, gen_Actions_BasicActions_OpaqueAction_Action, gen_Actions_BasicActions_InputPin_Pin, gen_Actions_IntermediateActions_BroadcastSignalAction_InvocationAction, gen_Actions_IntermediateActions_SendObjectAction_InvocationAction, gen_Actions_IntermediateActions_CreateObjectAction_Action, gen_Actions_BasicActions_CallAction_InvocationAction, gen_Actions_BasicActions_CallBehaviorAction_CallAction, gen_Actions_BasicActions_SendSignalAction_InvocationAction, gen_Actions_IntermediateActions_ReadStructuralFeatureAction_StructuralFeatureAction, gen_Actions_IntermediateActions_WriteStructuralFeatureAction_StructuralFeatureAction, gen_Actions_IntermediateActions_DestroyObjectAction_Action, gen_Actions_IntermediateActions_TestIdentityAction_Action, gen_Actions_IntermediateActions_ReadSelfAction_Action, gen_Actions_IntermediateActions_ValueSpecificationAction_Action, gen_Actions_IntermediateActions_StructuralFeatureAction_Action, gen_Actions_IntermediateActions_ReadLinkAction_LinkAction, gen_Actions_IntermediateActions_WriteLinkAction_LinkAction, gen_Actions_IntermediateActions_CreateLinkAction_WriteLinkAction, gen_Actions_IntermediateActions_LinkEndCreationData_LinkEndData, gen_Actions_IntermediateActions_DestroyLinkAction_WriteLinkAction, gen_Actions_IntermediateActions_AddStructuralFeatureValueAction_WriteStructuralFeatureAction, gen_Actions_IntermediateActions_RemoveStructuralFeatureValueAction_WriteStructuralFeatureAction, gen_Actions_IntermediateActions_ClearStructuralFeatureAction_StructuralFeatureAction, gen_Actions_IntermediateActions_LinkAction_Action, gen_Actions_IntermediateActions_LinkEndData_Element, gen_Actions_CompleteActions_AcceptCallAction_AcceptEventAction, gen_Actions_CompleteActions_ReadExtendAction_Action, gen_Actions_IntermediateActions_LinkEndDestructionData_LinkEndData, gen_Actions_CompleteActions_ReplyAction_Action, gen_Actions_CompleteActions_UnmarshallAction_Action, gen_Actions_CompleteActions_AcceptEventAction_Action, gen_Actions_CompleteActions_ReadLinkObjectEndAction_Action, gen_Actions_CompleteActions_ReadLinkObjectEndQualifierAction_Action, gen_Actions_CompleteActions_ReclassifyObjectAction_Action, gen_Actions_CompleteActions_StartClassifierBehaviorAction_Action, gen_Actions_CompleteActions_StartObjectBehaviorAction_CallAction, gen_Actions_CompleteActions_QualifierValue_Element, gen_Actions_StructuredActions_WriteVariableAction_VariableAction, gen_Actions_StructuredActions_AddVariableValueAction_WriteVariableAction, gen_Actions_StructuredActions_RemoveVariableValueAction_WriteVariableAction, gen_Actions_StructuredActions_ClearVariableAction_VariableAction, gen_Actions_CompleteActions_CreateLinkObjectAction_CreateLinkAction, gen_Actions_CompleteActions_ReduceAction_Action, gen_Actions_StructuredActions_VariableAction_Action, gen_Actions_StructuredActions_ReadVariableAction_VariableAction, gen_Actions_StructuredActions_RaiseExceptionAction_Action, gen_Actions_StructuredActions_ActionInputPin_InputPin},
    metadata=None
)
