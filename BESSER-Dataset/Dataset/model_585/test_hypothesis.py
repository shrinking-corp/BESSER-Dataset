...
def test_assistantmvc_openview_multiplechoiceview_is_not_abstract():
    assert not inspect.isabstract(AssistantMVC_OpenView_MultipleChoiceView)


def test_assistantmvc_openview_multiplechoiceview_constructor_exists():
    assert callable(AssistantMVC_OpenView_MultipleChoiceView.__init__)


def test_assistantmvc_openview_multiplechoiceview_constructor_args():
