...
class Account:
    ...
    def __init__(self, billingAddress: str, open: date, closed: date, isClosed: bool, customer7: "Customer" = None, cart8: "ShoppingCart" = None, p0: set["Payment"] = None, order16: set["Order"] = None):
