...
class tutorial_Member:
    ...
    def __init__(self, name: str, tutorial_Member19: "tutorial_Loan" = None, Member: "tutorial_Library" = None, members: "tutorial_Library" = None, tutorial_Member: set["tutorial_Loan"] = None, tutorial_Member12: set["tutorial_Book"] = None):
        self.name = name
...
class tutorial_Book:
    ...
    def __init__(self, name: str, copies: str, Book: "tutorial_Library" = None, tutorial_Book16: "tutorial_Loan" = None, books: "tutorial_Library" = None, tutorial_Book: set["tutorial_Loan"] = None, tutorial_Book13: "tutorial_Member" = None):
        self.name = name
        self.copies = copies
        self.Book = Book
