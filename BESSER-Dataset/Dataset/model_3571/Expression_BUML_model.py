...
# Classes
expression_OperationCall = Class(name="expression_OperationCall")
...
expression_SyntaxElement = Class(name="expression_SyntaxElement")
expression_LetExpression = Class(name="expression_LetExpression")
Expression = Class(name="Expression")
expression_CastedExpression = Class(name="expression_CastedExpression")
expression_Identifier = Class(name="expression_Identifier")
expression_IfExpression = Class(name="expression_IfExpression")
expression_SwitchExpression = Class(name="expression_SwitchExpression")
expression_Case = Class(name="expression_Case")
expression_CollectionExpression = Class(name="expression_CollectionExpression")
expression_Literal = Class(name="expression_Literal")
expression_BooleanLiteral = Class(name="expression_BooleanLiteral")
Literal = Class(name="Literal")
expression_IntegerLiteral = Class(name="expression_IntegerLiteral")
expression_NullLiteral = Class(name="expression_NullLiteral")
expression_RealLiteral = Class(name="expression_RealLiteral")
expression_StringLiteral = Class(name="expression_StringLiteral")
expression_GlobalVarExpression = Class(name="expression_GlobalVarExpression")
expression_FeatureCall = Class(name="expression_FeatureCall")
expression_ListLiteral = Class(name="expression_ListLiteral")
expression_ConstructorCallExpression = Class(name="expression_ConstructorCallExpression")
expression_TypeSelectExpression = Class(name="expression_TypeSelectExpression")
expression_ChainExpression = Class(name="expression_ChainExpression")
expression_BooleanOperation = Class(name="expression_BooleanOperation")
...
expression_Identifier.attributes={expression_Identifier_cl, expression_Identifier_id}
...
domain_model = DomainModel(
    name="expression",
    types={expression_OperationCall, FeatureCall, expression_Expression, SyntaxElement, expression_SyntaxElement, expression_LetExpression, Expression, expression_CastedExpression, expression_Identifier, expression_IfExpression, expression_SwitchExpression, expression_Case, expression_CollectionExpression, expression_Literal, expression_BooleanLiteral, Literal, expression_IntegerLiteral, expression_NullLiteral, expression_RealLiteral, expression_StringLiteral, expression_GlobalVarExpression, expression_FeatureCall, expression_ListLiteral, expression_ConstructorCallExpression, expression_TypeSelectExpression, expression_ChainExpression, expression_BooleanOperation},
    associations={condition23, thenPar26, varExpr0, target1, type4, target5, condition8, thenPart10, elsePart13, switchExpr16, case18, defaultExpr20, exp40, params29, target31, type33, elements36, type38, id143, first45, next47, left50, right52},
    generalizations={gen_expression_OperationCall_Expression, gen_expression_OperationCall_FeatureCall, gen_expression_Expression_SyntaxElement, gen_expression_LetExpression_Expression, gen_expression_CastedExpression_Expression, gen_expression_IfExpression_Expression, gen_expression_SwitchExpression_Expression, gen_expression_Case_SyntaxElement, gen_expression_CollectionExpression_Expression, gen_expression_CollectionExpression_FeatureCall, gen_expression_Literal_Expression, gen_expression_BooleanLiteral_Literal, gen_expression_IntegerLiteral_Literal, gen_expression_NullLiteral_Literal, gen_expression_RealLiteral_Literal, gen_expression_StringLiteral_Literal, gen_expression_GlobalVarExpression_Expression, gen_expression_FeatureCall_Expression, gen_expression_ListLiteral_Expression, gen_expression_ConstructorCallExpression_Expression, gen_expression_TypeSelectExpression_Expression, gen_expression_TypeSelectExpression_FeatureCall, gen_expression_Identifier_SyntaxElement, gen_expression_ChainExpression_Expression, gen_expression_BooleanOperation_Expression},
    metadata=None
)
