...
# Classes
graph_Named = Class(name="graph_Named")
...
graph_Node.attributes={graph_Node_derivedOrNotExists, graph_Node_uri, graph_Node_type}
...
domain_model = DomainModel(
    ...
    associations={source3, target6, discoverBy9, nodes0, edges1},
