...
class graph_Edge(Named):
    ...
    def __init__(self, exact: bool, pathDiscoveredByHeuristic: str, graph_Edge4: "graph_Node" = None, graph_Edge7: "graph_Node" = None, graph_Edge10: "graph_Node" = None, graph_Edge: "graph_Graph" = None):
        self.exact = exact
    ...
    @property
    def pathDiscoveredByHeuristic(self):
...
class graph_Node(Named):
    ...
    def __init__(self, uri: str, type: str, derivedOrNotExists: bool, graph_Node5: "graph_Edge" = None, graph_Node8: "graph_Edge" = None, graph_Node11: "graph_Edge" = None, graph_Node: "graph_Graph" = None):
        self.uri = uri
        self.type = type
