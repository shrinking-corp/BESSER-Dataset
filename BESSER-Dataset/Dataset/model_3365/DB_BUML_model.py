...
# Classes
DB_Type = Class(name="DB_Type")
DB_ForeignKey = Class(name="DB_ForeignKey")
DB_NamedElement = Class(name="DB_NamedElement", is_abstract=True)
DB_Database = Class(name="DB_Database")
DB_DatabaseElement = Class(name="DB_DatabaseElement", is_abstract=True)
NamedElement = Class(name="NamedElement")
DB_Table = Class(name="DB_Table")
DatabaseElement = Class(name="DatabaseElement")
DB_Column = Class(name="DB_Column")
...
domain_model = DomainModel(
    name="DB",
    types={DB_Type, DB_ForeignKey, DB_NamedElement, DB_Database, DB_DatabaseElement, NamedElement, DB_Table, DatabaseElement, DB_Column},
    associations={primaryKeys2, type5, contents0, columns1, source7, target9},
    generalizations={gen_DB_Column_NamedElement, gen_DB_Type_DatabaseElement, gen_DB_ForeignKey_DatabaseElement, gen_DB_DatabaseElement_NamedElement, gen_DB_Table_DatabaseElement},
    metadata=None
)
