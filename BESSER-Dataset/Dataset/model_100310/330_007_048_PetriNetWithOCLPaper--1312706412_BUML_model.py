...
# Classes
PetriNetModel_ArcPT = Class(name="PetriNetModel_ArcPT")
PetriNetModel_ArcTP = Class(name="PetriNetModel_ArcTP")
...
domain_model = DomainModel(
    name="PetriNetModel",
    types={PetriNetModel_ArcPT, PetriNetModel_ArcTP, PetriNetModel_Place, PetriNetModel_PetriNet, PetriNetModel_Transition},
    associations={transition0, arcPT1, arcTP3, place5, preArc7, preArc25, postArc28, postArc10, transition13, place16, place19, transition22},
    generalizations={},
    metadata=None
)
