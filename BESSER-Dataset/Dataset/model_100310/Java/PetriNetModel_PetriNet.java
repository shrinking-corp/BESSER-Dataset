...
public class PetriNetModel_PetriNet  {
    ...
    public PetriNetModel_PetriNet(
        String name        ArrayList<PetriNetModel_ArcPT> petrinetmodel_arcpts,        ArrayList<PetriNetModel_Place> petrinetmodel_places,        ArrayList<PetriNetModel_ArcTP> petrinetmodel_arctps    ) {
        this.name = name;
