...
# Classes
yyaa_World = Class(name="yyaa_World")
yyaa_Thing = Class(name="yyaa_Thing")
NamedElement = Class(name="NamedElement")
yyaa_RelatedTo = Class(name="yyaa_RelatedTo")
yyaa_NamedElement = Class(name="yyaa_NamedElement", is_abstract=True)
yyaa_Alias = Class(name="yyaa_Alias")
...
relations1: BinaryAssociation = BinaryAssociation(
    name="relations1",
    ends={
        Property(name="RelatedTo", type=yyaa_Thing, multiplicity=Multiplicity(1, 1)),
        Property(name="fromThing", type=yyaa_RelatedTo, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
fromThing3: BinaryAssociation = BinaryAssociation(
    name="fromThing3",
    ends={
        Property(name="Thing", type=yyaa_RelatedTo, multiplicity=Multiplicity(1, 1)),
        Property(name="relations", type=yyaa_Thing, multiplicity=Multiplicity(0, 1))
    }
)
toThing4: BinaryAssociation = BinaryAssociation(
    name="toThing4",
    ends={
        Property(name="yyaa_Thing5", type=yyaa_RelatedTo, multiplicity=Multiplicity(1, 1)),
