...
relationworld_NamedElement = Class(name="relationworld_NamedElement")
...
relationworld_World_m_compare: Method = Method(name="compare", parameters={Parameter(name='relationworld_role2', type=StringType), Parameter(name='relationworld_role1', type=StringType)}, type=IntegerType)
...
relationworld_SourceNode.methods={relationworld_SourceNode_m_compare, relationworld_SourceNode_m_pred, relationworld_SourceNode_m_succ}
...
domain_model = DomainModel(
    name="relationworld",
    types={SourceNode, NamedElement, relationworld_ThingB, TargetNode, relationworld_RelatedTo, Arrow, relationworld_World, Category, relationworld_ThingA, relationworld_Arrow, relationworld_TargetNode, relationworld_Category, relationworld_SourceNode, relationworld_NamedElement, Scale},
    associations={thingA0, thingB1, source11, cible12, sources14, fleches16, targets19, thingsa3, thingsb5, relations8},
