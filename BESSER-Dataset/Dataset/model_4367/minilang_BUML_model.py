...
minilang_Program.attributes={minilang_Program_x, minilang_Program_angle, minilang_Program_distance, minilang_Program_y}
...
domain_model = DomainModel(
    name="minilang",
    types={minilang_Program, minilang_Method, minilang_Variable, minilang_Line, minilang_Block, minilang_Condition, minilang_GreaterThan, Condition, minilang_Value, minilang_Constant, Value, minilang_VariableRef, minilang_VariableAffect, minilang_Sum, BinaryOperation, minilang_Modulo, minilang_BinaryOperation, minilang_CallMethod, minilang_Move, minilang_RotateRight, minilang_RotateLeft, minilang_Statement, minilang_IfStmt, Statement, Cardinals},
    associations={methods0, mainMethod1, variables2, lines4, program6, thenBranch11, elseBranch13, condition16, left18, right19, variable22, variable24, value26, right29, left31, method34, block7, statements9},
    generalizations={gen_minilang_GreaterThan_Condition, gen_minilang_Constant_Value, gen_minilang_VariableRef_Value, gen_minilang_VariableAffect_Statement, gen_minilang_Sum_BinaryOperation, gen_minilang_Modulo_BinaryOperation, gen_minilang_BinaryOperation_Value, gen_minilang_CallMethod_Statement, gen_minilang_Move_Statement, gen_minilang_RotateRight_Statement, gen_minilang_RotateLeft_Statement, gen_minilang_IfStmt_Statement},
    metadata=None
)
