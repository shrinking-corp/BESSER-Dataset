...
class componentModel_ProvidedRole:
    ...
    def __init__(self, name: str, ProvidedRole: "componentModel_AssemblyContext" = None, componentModel_ProvidedRole68: "componentModel_ProvidedDelegationConnector" = None, componentModel_ProvidedRole: "componentModel_AssemblyConnector" = None, providedrole: "componentModel_AssemblyContext" = None, componentModel_ProvidedRole62: "componentModel_Interface" = None):
        self.name = name
...
class componentModel_AssemblyContext(AssemblyViewType):
    ...
    def __init__(self, name: str, assemblycontext: "componentModel_ProvidedRole" = None, assemblycontext28: "componentModel_RequiredRole" = None, componentModel_AssemblyContext: "componentModel_Component" = None, componentModel_AssemblyContext51: "componentModel_System" = None, AssemblyContext: "componentModel_RequiredRole" = None, AssemblyContext60: "componentModel_ProvidedRole" = None, componentModel_AssemblyContext71: "componentModel_CompositeComponent" = None):
        self.name = name
...
class componentModel_Interface:
    ...
    def __init__(self, name: str, componentModel_Interface13: "componentModel_InterfaceServiceMapTuple" = None, componentModel_Interface25: set["componentModel_Signature"] = None, componentModel_Interface65: "componentModel_ProvidedDelegationConnector" = None, componentModel_Interface39: "componentModel_RequiredDelegationConnector" = None, componentModel_Interface46: "componentModel_Service" = None, componentModel_Interface: "componentModel_Repository" = None, componentModel_Interface54: "componentModel_System" = None, componentModel_Interface58: "componentModel_RequiredRole" = None, componentModel_Interface63: "componentModel_ProvidedRole" = None):
        self.name = name
...
class componentModel_Component:
    ...
    def __init__(self, name: str, componentModel_Component6: set["componentModel_InterfaceServiceMapTuple"] = None, componentModel_Component8: set["componentModel_AssemblyConnector"] = None, componentModel_Component10: set["componentModel_DelegationConnector"] = None, componentModel_Component30: "componentModel_AssemblyContext" = None, componentModel_Component: "componentModel_Repository" = None, componentModel_Component4: "componentModel_ServiceEffectSpecification" = None):
        self.name = name
