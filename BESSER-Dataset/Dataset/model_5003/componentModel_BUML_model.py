...
# Classes
componentModel_SystemIndependentViewPoint = Class(name="componentModel_SystemIndependentViewPoint")
ViewPoint = Class(name="ViewPoint")
componentModel_Repository = Class(name="componentModel_Repository")
ViewType = Class(name="ViewType")
componentModel_Component = Class(name="componentModel_Component")
componentModel_Interface = Class(name="componentModel_Interface")
componentModel_ServiceEffectSpecification = Class(name="componentModel_ServiceEffectSpecification")
componentModel_InterfaceServiceMapTuple = Class(name="componentModel_InterfaceServiceMapTuple")
componentModel_AssemblyConnector = Class(name="componentModel_AssemblyConnector")
componentModel_DelegationConnector = Class(name="componentModel_DelegationConnector", is_abstract=True)
componentModel_Service = Class(name="componentModel_Service")
componentModel_Action = Class(name="componentModel_Action")
componentModel_Branch = Class(name="componentModel_Branch")
Action = Class(name="Action")
componentModel_Loop = Class(name="componentModel_Loop")
componentModel_ExternalCall = Class(name="componentModel_ExternalCall")
componentModel_InternalAction = Class(name="componentModel_InternalAction")
componentModel_Signature = Class(name="componentModel_Signature")
componentModel_ViewType = Class(name="componentModel_ViewType", is_abstract=True)
componentModel_AssemblyViewPoint = Class(name="componentModel_AssemblyViewPoint")
componentModel_AssemblyContext = Class(name="componentModel_AssemblyContext")
AssemblyViewType = Class(name="AssemblyViewType")
componentModel_ProvidedRole = Class(name="componentModel_ProvidedRole")
componentModel_RequiredRole = Class(name="componentModel_RequiredRole")
componentModel_RequiredDelegationConnector = Class(name="componentModel_RequiredDelegationConnector")
DelegationConnector = Class(name="DelegationConnector")
componentModel_Parameter = Class(name="componentModel_Parameter")
componentModel_Type = Class(name="componentModel_Type", is_abstract=True)
componentModel_System = Class(name="componentModel_System")
componentModel_ProvidedDelegationConnector = Class(name="componentModel_ProvidedDelegationConnector")
componentModel_ViewPoint = Class(name="componentModel_ViewPoint", is_abstract=True)
componentModel_CompositeComponent = Class(name="componentModel_CompositeComponent")
Component = Class(name="Component")
componentModel_AssemblyViewType = Class(name="componentModel_AssemblyViewType")
componentModel_DeploymentViewPoint = Class(name="componentModel_DeploymentViewPoint")
componentModel_RepositoryViewType = Class(name="componentModel_RepositoryViewType")
componentModel_EnvironmentViewType = Class(name="componentModel_EnvironmentViewType")
componentModel_AllocationViewType = Class(name="componentModel_AllocationViewType")
SimpleParameterType = Class(name="SimpleParameterType")
componentModel_ParameterTyp = Class(name="componentModel_ParameterTyp", is_abstract=True)
componentModel_Boolean = Class(name="componentModel_Boolean")
componentModel_Void = Class(name="componentModel_Void", is_abstract=True)
Type = Class(name="Type")
componentModel_Char = Class(name="componentModel_Char")
componentModel_Date = Class(name="componentModel_Date")
componentModel_Float = Class(name="componentModel_Float")
componentModel_List = Class(name="componentModel_List")
componentModel_Int = Class(name="componentModel_Int")
componentModel_Long = Class(name="componentModel_Long")
componentModel_Map = Class(name="componentModel_Map")
componentModel_String = Class(name="componentModel_String")
componentModel_Double = Class(name="componentModel_Double")
componentModel_ComplexParameterType = Class(name="componentModel_ComplexParameterType")
ParameterTyp = Class(name="ParameterTyp")
componentModel_SimpleParameterType = Class(name="componentModel_SimpleParameterType", is_abstract=True)
