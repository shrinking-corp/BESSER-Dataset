...
# Classes
go_SouceFile = Class(name="go_SouceFile")
go_PackageClause = Class(name="go_PackageClause")
go_ImportDecl = Class(name="go_ImportDecl")
go_TopLevelDecl = Class(name="go_TopLevelDecl")
go_Type = Class(name="go_Type")
go_TypeName = Class(name="go_TypeName")
go_MapType = Class(name="go_MapType")
go_ChannelType = Class(name="go_ChannelType")
go_ArrayLength = Class(name="go_ArrayLength")
go_ElementType = Class(name="go_ElementType")
go_Expression = Class(name="go_Expression")
go_TypeLit = Class(name="go_TypeLit")
go_identifier = Class(name="go_identifier")
go_TypeNameLinha = Class(name="go_TypeNameLinha")
go_QualifiedIdent = Class(name="go_QualifiedIdent")
go_TypeLitLinha = Class(name="go_TypeLitLinha")
go_StructType = Class(name="go_StructType")
go_PointerType = Class(name="go_PointerType")
go_FunctionType = Class(name="go_FunctionType")
go_InterfaceType = Class(name="go_InterfaceType")
Receiver = Class(name="Receiver")
go_ParameterList = Class(name="go_ParameterList")
go_ParameterDecl = Class(name="go_ParameterDecl")
go_FieldDecl = Class(name="go_FieldDecl")
go_IdentifierList = Class(name="go_IdentifierList")
go_EmbeddedField = Class(name="go_EmbeddedField")
go_Tag = Class(name="go_Tag")
go_string_lit = Class(name="go_string_lit")
go_Signature = Class(name="go_Signature")
go_Parameters = Class(name="go_Parameters")
go_Result = Class(name="go_Result")
go_Block = Class(name="go_Block")
go_StatementList = Class(name="go_StatementList")
go_Statement = Class(name="go_Statement")
go_Declaration = Class(name="go_Declaration")
go_ConstDecl = Class(name="go_ConstDecl")
go_TypeDecl = Class(name="go_TypeDecl")
go_VarDecl = Class(name="go_VarDecl")
go_topLevelDeclLinha = Class(name="go_topLevelDeclLinha")
go_MethodSpec = Class(name="go_MethodSpec")
go_MethodName = Class(name="go_MethodName")
go_InterfaceTypeName = Class(name="go_InterfaceTypeName")
go_KeyType = Class(name="go_KeyType")
go_TypeSpec = Class(name="go_TypeSpec")
go_AliasDecl = Class(name="go_AliasDecl")
TypeSpec = Class(name="TypeSpec")
go_TypeDef = Class(name="go_TypeDef")
go_VarSpec = Class(name="go_VarSpec")
go_FunctionName = Class(name="go_FunctionName")
go_FunctionBody = Class(name="go_FunctionBody")
go_Receiver = Class(name="go_Receiver")
go_ConstSpec = Class(name="go_ConstSpec")
go_ExpressionList = Class(name="go_ExpressionList")
go_Operand = Class(name="go_Operand")
go_Literal = Class(name="go_Literal")
go_OperandName = Class(name="go_OperandName")
go_BasicLit = Class(name="go_BasicLit")
go_float_lit = Class(name="go_float_lit")
go_rune_lit = Class(name="go_rune_lit")
go_ShortVarDecl = Class(name="go_ShortVarDecl")
go_FunctionDecl = Class(name="go_FunctionDecl")
go_MethodDecl = Class(name="go_MethodDecl")
go_ElementList = Class(name="go_ElementList")
go_KeyedElement = Class(name="go_KeyedElement")
go_Element = Class(name="go_Element")
go_Key = Class(name="go_Key")
OperandName = Class(name="OperandName")
go_PackageName = Class(name="go_PackageName")
go_CompositeLit = Class(name="go_CompositeLit")
Literal = Class(name="Literal")
go_LiteralType = Class(name="go_LiteralType")
go_LiteralValue = Class(name="go_LiteralValue")
go_LiteralTypeLinha = Class(name="go_LiteralTypeLinha")
go_ponto = Class(name="go_ponto")
go_cochetes = Class(name="go_cochetes")
go_Selector = Class(name="go_Selector")
go_TypeAssertion = Class(name="go_TypeAssertion")
go_Index = Class(name="go_Index")
go_FieldName = Class(name="go_FieldName")
go_FunctionLit = Class(name="go_FunctionLit")
go_PrimaryExpr = Class(name="go_PrimaryExpr")
go_PrimaryExprLinha = Class(name="go_PrimaryExprLinha")
go_Conversion = Class(name="go_Conversion")
go_MethodExpr = Class(name="go_MethodExpr")
go_Arguments = Class(name="go_Arguments")
go_UnaryExpr = Class(name="go_UnaryExpr")
go_ExpressionLinha = Class(name="go_ExpressionLinha")
go_binary_op = Class(name="go_binary_op")
go_Slice = Class(name="go_Slice")
go_decimals = Class(name="go_decimals")
go_ReceiverType = Class(name="go_ReceiverType")
go_IfStmt = Class(name="go_IfStmt")
go_SwitchStmt = Class(name="go_SwitchStmt")
go_SelectStmt = Class(name="go_SelectStmt")
go_ForStmt = Class(name="go_ForStmt")
go_DeferStmt = Class(name="go_DeferStmt")
SwitchStmt = Class(name="SwitchStmt")
go_LabeledStmt = Class(name="go_LabeledStmt")
go_SimpleStmt = Class(name="go_SimpleStmt")
go_GoStmt = Class(name="go_GoStmt")
go_ReturnStmt = Class(name="go_ReturnStmt")
go_BreakStmt = Class(name="go_BreakStmt")
go_ContinueStmt = Class(name="go_ContinueStmt")
go_GotoStmt = Class(name="go_GotoStmt")
go_ExpressionStmt = Class(name="go_ExpressionStmt")
go_SendStmt = Class(name="go_SendStmt")
go_IncDecStmt = Class(name="go_IncDecStmt")
go_Assignment = Class(name="go_Assignment")
go_Label = Class(name="go_Label")
go_Channel = Class(name="go_Channel")
go_TypeSwitchCase = Class(name="go_TypeSwitchCase")
go_TypeList = Class(name="go_TypeList")
go_Condition = Class(name="go_Condition")
go_ForClause = Class(name="go_ForClause")
go_RangeClause = Class(name="go_RangeClause")
go_switch_stmt_linha = Class(name="go_switch_stmt_linha")
go_ExprCaseClause = Class(name="go_ExprCaseClause")
go_ExprSwitchCase = Class(name="go_ExprSwitchCase")
go_TypeSwitchGuard = Class(name="go_TypeSwitchGuard")
go_TypeCaseClause = Class(name="go_TypeCaseClause")
go_PostStmt = Class(name="go_PostStmt")
go_InitStmt = Class(name="go_InitStmt")
go_CommClause = Class(name="go_CommClause")
go_CommCase = Class(name="go_CommCase")
go_RecvStmt = Class(name="go_RecvStmt")
go_RecvExpr = Class(name="go_RecvExpr")
go_exponent = Class(name="go_exponent")
go_imaginary_lit = Class(name="go_imaginary_lit")
go_ImportSpec = Class(name="go_ImportSpec")
go_ImportPath = Class(name="go_ImportPath")
float_lit = Class(name="float_lit")
...
go_string_lit.attributes={go_string_lit_interpreted_string_lit, go_string_lit_raw_string_lit}
...
go_binary_op.attributes={go_binary_op_add_op, go_binary_op_mul_op, go_binary_op_rel_op}
...
domain_model = DomainModel(
    name="go",
    types={go_SouceFile, go_PackageClause, go_ImportDecl, go_TopLevelDecl, go_Type, go_TypeName, go_MapType, go_ChannelType, go_ArrayLength, go_ElementType, go_Expression, go_TypeLit, go_identifier, go_TypeNameLinha, go_QualifiedIdent, go_TypeLitLinha, go_StructType, go_PointerType, go_FunctionType, go_InterfaceType, Receiver, go_ParameterList, go_ParameterDecl, go_FieldDecl, go_IdentifierList, go_EmbeddedField, go_Tag, go_string_lit, go_Signature, go_Parameters, go_Result, go_Block, go_StatementList, go_Statement, go_Declaration, go_ConstDecl, go_TypeDecl, go_VarDecl, go_topLevelDeclLinha, go_MethodSpec, go_MethodName, go_InterfaceTypeName, go_KeyType, go_TypeSpec, go_AliasDecl, TypeSpec, go_TypeDef, go_VarSpec, go_FunctionName, go_FunctionBody, go_Receiver, go_ConstSpec, go_ExpressionList, go_Operand, go_Literal, go_OperandName, go_BasicLit, go_float_lit, go_rune_lit, go_ShortVarDecl, go_FunctionDecl, go_MethodDecl, go_ElementList, go_KeyedElement, go_Element, go_Key, OperandName, go_PackageName, go_CompositeLit, Literal, go_LiteralType, go_LiteralValue, go_LiteralTypeLinha, go_ponto, go_cochetes, go_Selector, go_TypeAssertion, go_Index, go_FieldName, go_FunctionLit, go_PrimaryExpr, go_PrimaryExprLinha, go_Conversion, go_MethodExpr, go_Arguments, go_UnaryExpr, go_ExpressionLinha, go_binary_op, go_Slice, go_decimals, go_ReceiverType, go_IfStmt, go_SwitchStmt, go_SelectStmt, go_ForStmt, go_DeferStmt, SwitchStmt, go_LabeledStmt, go_SimpleStmt, go_GoStmt, go_ReturnStmt, go_BreakStmt, go_ContinueStmt, go_GotoStmt, go_ExpressionStmt, go_SendStmt, go_IncDecStmt, go_Assignment, go_Label, go_Channel, go_TypeSwitchCase, go_TypeList, go_Condition, go_ForClause, go_RangeClause, go_switch_stmt_linha, go_ExprCaseClause, go_ExprSwitchCase, go_TypeSwitchGuard, go_TypeCaseClause, go_PostStmt, go_InitStmt, go_CommClause, go_CommCase, go_RecvStmt, go_RecvExpr, go_exponent, go_imaginary_lit, go_ImportSpec, go_ImportPath, float_lit},
    associations={PackageClause0, ImportDecl1, TopLevelDecl3, MapType33, ChannelType35, ArrayLength37, ElementType39, TypeLitLinha42, Expression44, Type46, TypeName5, TypeLit6, Type9, identifier11, TypeNameLinha13, identifier15, TypeNameLinha19, QualifiedIdent21, TypeLitLinha23, StructType25, PointerType27, FunctionType29, InterfaceType31, Result72, Parameters74, Type77, ParameterList80, ParameterDecl82, IdentifierList84, FieldDecl49, IdentifierList51, Type53, EmbeddedField56, Tag58, TypeName60, string_lit63, Type65, Signature68, Parameters70, StatementList116, Statement117, ConstDecl119, TypeDecl120, VarDecl122, Declaration124, Type87, topLevelDeclLinha127, MethodSpec90, MethodName92, Signature94, InterfaceTypeName97, identifier99, TypeName102, KeyType105, ElementType107, Type110, ElementType113, Expression154, TypeSpec157, identifier159, Type162, VarSpec165, IdentifierList167, FunctionName129, Signature131, FunctionBody134, Receiver136, MethodName138, ConstSpec141, IdentifierList143, Type146, ExpressionList149, identifier151, Literal206, OperandName207, Expression209, BasicLit212, float_lit214, rune_lit216, string_lit218, Type170, ExpressionList173, IdentifierList176, ExpressionList178, FunctionName181, Signature183, FunctionBody186, identifier189, Block192, Receiver195, MethodName197, Signature200, FunctionBody203, ElementList249, KeyedElement251, Expression253, LiteralValue255, Key258, Element260, PackageName221, identifier223, LiteralType226, LiteralValue227, StructType229, LiteralTypeLinha232, ElementType234, MapType237, TypeName240, ArrayLength243, ElementType246, PrimaryExprLinha290, ponto292, cochetes294, Selector296, PrimaryExprLinha298, TypeAssertion301, Index303, PrimaryExprLinha305, FieldName263, Expression265, LiteralValue268, identifier271, Signature274, FunctionBody276, Operand279, PrimaryExprLinha281, Conversion283, MethodExpr285, Arguments287, UnaryExpr335, ExpressionLinha337, binary_op339, Expression341, ExpressionLinha345, PrimaryExpr347, UnaryExpr351, Slice308, identifier310, Slice313, decimals316, Type318, ExpressionList321, Type324, ReceiverType327, MethodName329, Type332, Block376, IfStmt379, SwitchStmt381, SelectStmt383, ForStmt385, DeferStmt387, Type353, Expression356, Declaration359, LabeledStmt362, SimpleStmt364, GoStmt366, ReturnStmt368, BreakStmt370, ContinueStmt372, GotoStmt374, Expression419, ExpressionList422, SimpleStmt425, Expression428, Block431, IfStmt435, ExpressionStmt389, SendStmt391, IncDecStmt393, Assignment395, ShortVarDecl397, Label400, Statement402, identifier405, Expression408, Channel411, Expression413, Expression416, TypeSwitchCase465, StatementList467, TypeList470, Type472, Condition475, ForClause477, RangeClause479, switch_stmt_linha437, ExprSwitchCase439, StatementList440, ExpressionList443, TypeSwitchGuard446, TypeCaseClause448, switch_stmt_linha451, Expression453, ExprCaseClause456, identifier459, PrimaryExpr462, PostStmt492, SimpleStmt494, SimpleStmt497, ExpressionList500, Block481, Expression484, InitStmt487, Condition489, Expression532, ExpressionList535, Label538, Label541, Label544, Expression547, IdentifierList503, Expression506, Expression509, CommClause512, CommCase514, StatementList516, SendStmt519, RecvStmt522, ExpressionList524, IdentifierList527, RecvExpr530, decimals567, exponent569, exponen571, decimals574, decimals577, float_lit579, PackageName550, identifier553, ImportSpec556, PackageName558, ImportPath561, string_lit563},
