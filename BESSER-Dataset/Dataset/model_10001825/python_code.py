...
class Course:
    ...
    def __init__(self, subjects__: Subject, duration: str, subject2: set["Subject"] = None, department1: "Department" = None):
...
class Department:
    ...
    def __init__(self, course: Course, students__: Student, teachers__: Teacher, hod: HOD, student4: set["Student"] = None, employee6: set["Employee_Interface"] = None, access_Information19: "Access_Information" = None, course0: "Course" = None):
        self.course = course
...
class Student:
    ...
    def __init__(self, Name: str, ID: str, department5: "Department" = None, Having_Attendance8: "Access_Information" = None, admin13: "Administrator" = None):
        self.Name = Name
        self.ID = ID
