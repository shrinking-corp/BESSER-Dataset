...
# Classes
research2_Phase = Class(name="research2_Phase")
research2_Researcher = Class(name="research2_Researcher")
research2_Write = Class(name="research2_Write")
research2_PublicationProcess = Class(name="research2_PublicationProcess")
Named = Class(name="Named")
research2_ReviewNote = Class(name="research2_ReviewNote")
Labelled = Class(name="Labelled")
research2_Review = Class(name="research2_Review")
research2_Paper = Class(name="research2_Paper")
research2_Skill = Class(name="research2_Skill")
research2_Position = Class(name="research2_Position")
research2_Paragraph = Class(name="research2_Paragraph")
research2_Progress = Class(name="research2_Progress")
research2_Keyword = Class(name="research2_Keyword")
Counted = Class(name="Counted")
research2_PublicationSystem = Class(name="research2_PublicationSystem")
research2_Named = Class(name="research2_Named", is_abstract=True)
research2_Counted = Class(name="research2_Counted", is_abstract=True)
research2_PublicationStructure = Class(name="research2_PublicationStructure")
research2_KnowledgeManager = Class(name="research2_KnowledgeManager")
research2_Labelled = Class(name="research2_Labelled", is_abstract=True)
...
research2_PublicationProcess.attributes={research2_PublicationProcess_minTime, research2_PublicationProcess_maxTime}
...
domain_model = DomainModel(
    name="research2",
    types={research2_Phase, research2_Researcher, research2_Write, research2_PublicationProcess, Named, research2_ReviewNote, Labelled, research2_Review, research2_Paper, research2_Skill, research2_Position, research2_Paragraph, research2_Progress, research2_Keyword, Counted, research2_PublicationSystem, research2_Named, research2_Counted, research2_PublicationStructure, research2_KnowledgeManager, research2_Labelled},
    associations={phases0, writes1, reviews16, reviews2, res_papers4, skills5, res_position7, paragraphs9, progress10, authors11, keywords12, citedBy14, knowledgeMan33, processView35, structuralView37, positions40, process18, paper20, paragraph22, reviewNote25, researchers28, papers30, parent44, kpapers46, allkeywords48},
    generalizations={gen_research2_PublicationProcess_Named, gen_research2_Paragraph_Named, gen_research2_ReviewNote_Named, gen_research2_Progress_Labelled, gen_research2_Paper_Named, gen_research2_Paragraph_Counted, gen_research2_PublicationSystem_Named, gen_research2_Write_Labelled, gen_research2_Review_Labelled, gen_research2_PublicationStructure_Named, gen_research2_Position_Named, gen_research2_Keyword_Named, gen_research2_KnowledgeManager_Named},
    metadata=None
)
