...
domain_model = DomainModel(
    name="dslComponent",
    types={dslComponent_WTComponents, dslComponent_StateMachine, dslComponent_Vertex, dslComponent_Edge, DocumElt, dslComponent_Subsystem, dslComponent_SimpleState, Vertex, dslComponent_InitialState, dslComponent_ControlSubsystem, dslComponent_Component, dslComponent_DocumElt, dslComponent_InPort, Port, dslComponent_OutPort, dslComponent_Port},
    associations={machines10, states12, transitions14, outgoing16, incoming17, source19, target20, subsystems0, beh1, machines22, components3, subsystems6, ports8},
