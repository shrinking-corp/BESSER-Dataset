...
def test_chess_has_publicAttribute():
    assert hasattr(Chess, "publicAttribute")
    descriptor = None
...
def test_chess_has_privateAttribute():
    assert hasattr(Chess, "privateAttribute")
    descriptor = None
    for klass in Chess.__mro__:
        if "privateAttribute" in klass.__dict__:
            descriptor = klass.__dict__["privateAttribute"]
...
def test_chess_has_packageAttribute():
    assert hasattr(Chess, "packageAttribute")
    descriptor = None
    for klass in Chess.__mro__:
        if "packageAttribute" in klass.__dict__:
            descriptor = klass.__dict__["packageAttribute"]
...
def test_chess_has_protectedAttribute():
    assert hasattr(Chess, "protectedAttribute")
    descriptor = None
    for klass in Chess.__mro__:
        if "protectedAttribute" in klass.__dict__:
            descriptor = klass.__dict__["protectedAttribute"]
...
def test_chess_has_field():
    assert hasattr(Chess, "field")
    descriptor = None
    for klass in Chess.__mro__:
...
@given(instance=Chess_strategy)
def test_chess_publicAttribute_setter(instance):
    original = instance.publicAttribute
    instance.publicAttribute = original
    assert instance.publicAttribute == original
...
@given(instance=Chess_strategy)
def test_chess_privateAttribute_setter(instance):
    original = instance.privateAttribute
    instance.privateAttribute = original
    assert instance.privateAttribute == original
...
@given(instance=Chess_strategy)
def test_chess_packageAttribute_setter(instance):
    original = instance.packageAttribute
    instance.packageAttribute = original
    assert instance.packageAttribute == original
...
@given(instance=Chess_strategy)
def test_chess_protectedAttribute_setter(instance):
    original = instance.protectedAttribute
    instance.protectedAttribute = original
    assert instance.protectedAttribute == original
...
@given(instance=Chess_strategy)
def test_chess_field_setter(instance):
