...
Chess_publicAttribute: Property = Property(name="publicAttribute", type=FloatType)
Chess_privateAttribute: Property = Property(name="privateAttribute", type=IntegerType)
Chess_protectedAttribute: Property = Property(name="protectedAttribute", type=StringType)
Chess_packageAttribute: Property = Property(name="packageAttribute", type=StringType)
Chess_field: Property = Property(name="field", type=StringType)
Chess.attributes={Chess_protectedAttribute, Chess_publicAttribute, Chess_privateAttribute, Chess_field, Chess_packageAttribute}
...
ClassC.attributes={ClassC_privateAttribute, ClassC_packageAttribute, ClassC_protectedAttribute, ClassC_publicAttribute}
...
domain_model = DomainModel(
    name="c2648885_57f2_4e3f_8708_0f87d7370164",
    types={BankAccount, Chess, ClassB, ClassC, ClassD, ClassE, ClassF, ClassG, ClassJ, ClassH, ClassK, ClassL, ClassM, ClassN, ClassP, InterfaceO_Interface, ClassQ, ClassR, ClassS, ClassT, ClassU, ClassV},
    associations={ClassD_ClassECopy, ClassD_ClassECopyCopy, ClassD_ClassE},
    generalizations={},
    metadata=None
)
