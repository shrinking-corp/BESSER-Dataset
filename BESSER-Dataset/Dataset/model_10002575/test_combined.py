...
def test_hyp_chess_publicAttribute_setter(instance):
    original = instance.publicAttribute
    instance.publicAttribute = original
    assert instance.publicAttribute == original
...
@given(instance=Chess_strategy)
def test_hyp_chess_privateAttribute_setter(instance):
    original = instance.privateAttribute
    instance.privateAttribute = original
    assert instance.privateAttribute == original
...
@given(instance=Chess_strategy)
def test_hyp_chess_packageAttribute_setter(instance):
    original = instance.packageAttribute
    instance.packageAttribute = original
    assert instance.packageAttribute == original
...
@given(instance=Chess_strategy)
def test_hyp_chess_protectedAttribute_setter(instance):
    original = instance.protectedAttribute
    instance.protectedAttribute = original
    assert instance.protectedAttribute == original
...
@given(instance=Chess_strategy)
def test_hyp_chess_field_setter(instance):
...
def test_Chess_field_value_roundtrip():
    instance = Chess(field="sample_text", packageAttribute="sample_text", privateAttribute=7, protectedAttribute="sample_text", publicAttribute=3.14)
    assert instance.field == "sample_text"
    instance.field = "sample_text_2"
    assert instance.field == "sample_text_2"


def test_Chess_packageAttribute_value_roundtrip():
    instance = Chess(field="sample_text", packageAttribute="sample_text", privateAttribute=7, protectedAttribute="sample_text", publicAttribute=3.14)
...
def test_Chess_privateAttribute_value_roundtrip():
    instance = Chess(field="sample_text", packageAttribute="sample_text", privateAttribute=7, protectedAttribute="sample_text", publicAttribute=3.14)
...
def test_Chess_protectedAttribute_value_roundtrip():
    instance = Chess(field="sample_text", packageAttribute="sample_text", privateAttribute=7, protectedAttribute="sample_text", publicAttribute=3.14)
...
def test_Chess_publicAttribute_value_roundtrip():
    instance = Chess(field="sample_text", packageAttribute="sample_text", privateAttribute=7, protectedAttribute="sample_text", publicAttribute=3.14)
...
Chess_strategy = st.builds(Chess, field=safe_text, packageAttribute=safe_text, privateAttribute=st.integers(), protectedAttribute=safe_text, publicAttribute=st.floats(allow_nan=False, allow_infinity=False))
@given(instance=Chess_strategy)
@settings(max_examples=25)
