...
library_Community = Class(name="library_Community")
library_Review = Class(name="library_Review")
library_Chapter = Class(name="library_Chapter")
library_Opinion = Class(name="library_Opinion")
library_CommunityRole = Class(name="library_CommunityRole")
...
library_Review.attributes={library_Review_positive, library_Review_title}
...
domain_model = DomainModel(
    name="library",
    types={library_Library, library_Writer, library_Book, library_Community, library_Review, library_Chapter, library_Opinion, library_CommunityRole, BookCategory},
    associations={writers0, books1, communities3, author10, reviews11, chapters12, opinions14, book17, writer19, book21, books4, brochures5, opinions8, participates9, roles24, library26, community27, participants29},
    generalizations={},
    metadata=None
)
