...
class oclstates_Statemachine:
    ...
    def __init__(self, name: str, value: int, initial: bool, oclstates_Statemachine: "oclstates_Module" = None, oclstates_Statemachine2: set["oclstates_Event"] = None, oclstates_Statemachine4: set["oclstates_State"] = None, oclstates_Statemachine9: "oclstates_State" = None, oclstates_Statemachine11: "oclstates_CompoundState" = None):
        self.name = name
        self.value = value
        self.initial = initial
