...
# Classes
oclstates_Transition = Class(name="oclstates_Transition")
oclstates_Module = Class(name="oclstates_Module")
oclstates_Statemachine = Class(name="oclstates_Statemachine")
oclstates_Event = Class(name="oclstates_Event")
oclstates_State = Class(name="oclstates_State")
oclstates_SimpleState = Class(name="oclstates_SimpleState")
State = Class(name="State")
oclstates_CompoundState = Class(name="oclstates_CompoundState")
...
oclstates_Statemachine.attributes={oclstates_Statemachine_initial, oclstates_Statemachine_name, oclstates_Statemachine_value}
...
domain_model = DomainModel(
    name="oclstates",
    types={oclstates_Transition, oclstates_Module, oclstates_Statemachine, oclstates_Event, oclstates_State, oclstates_SimpleState, State, oclstates_CompoundState},
    associations={machines0, events1, states3, transitions5, statemachine7, machine10, event12, state15},
