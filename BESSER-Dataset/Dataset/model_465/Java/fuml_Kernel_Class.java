...
public class fuml_Kernel_Class extends BehavioredClassifier {
    ...
    public fuml_Kernel_Class(
        boolean active        ArrayList<Kernel_Class> kernel_classs,        ArrayList<Kernel_Property> kernel_propertys,        ArrayList<Kernel_Classifier> kernel_classifiers,        ArrayList<Kernel_Operation> kernel_operations    ) {
        this.active = active;
