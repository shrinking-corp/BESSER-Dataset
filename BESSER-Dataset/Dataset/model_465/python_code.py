...
class fuml_CompleteActions_ReadIsClassifiedObjectAction(Action):
    ...
    def __init__(self, direct: bool, fuml_CompleteActions_ReadIsClassifiedObjectAction272: "BasicActions_OutputPin" = None, fuml_CompleteActions_ReadIsClassifiedObjectAction275: "BasicActions_InputPin" = None, fuml_CompleteActions_ReadIsClassifiedObjectAction: "Kernel_Classifier" = None):
        self.direct = direct
...
class fuml_Kernel_Class(BehavioredClassifier):
    ...
    def __init__(self, active: bool, fuml_Kernel_Class108: set["Communications_Reception"] = None, class_: set["Kernel_Property"] = None, class_105: set["Kernel_Operation"] = None, fuml_Kernel_Class: set["Kernel_Class"] = None, fuml_Kernel_Class110: set["Kernel_Classifier"] = None):
        self.active = active
...
class fuml_Kernel_Property(StructuralFeature):
    ...
    def __init__(self, derived: bool, derivedUnion: bool, aggregation: str, composite: bool, ownedAttribute: "Kernel_DataType" = None, ownedEnd: "Kernel_Association" = None, memberEnd: "Kernel_Association" = None, ownedAttribute65: "Kernel_Class" = None, fuml_Kernel_Property: "Kernel_Property" = None):
...
class fuml_Kernel_ElementImport(Element):
    ...
    def __init__(self, visibility: str, alias: str, elementImport: "Kernel_Namespace" = None, fuml_Kernel_ElementImport: "Kernel_PackageableElement" = None):
...
class fuml_Kernel_NamedElement(Element):
    ...
    def __init__(self, name: str, visibility: str, qualifiedName: str, ownedMember: "Kernel_Namespace" = None):
        self.name = name
        self.visibility = visibility
...
class fuml_Kernel_Operation(BehavioralFeature):
    ...
    def __init__(self, ordered: bool, query: bool, unique: bool, lower: int, upper: int, ownedOperation: "Kernel_Class" = None, fuml_Kernel_Operation: set["Kernel_Operation"] = None, fuml_Kernel_Operation89: "Kernel_Type" = None):
        self.ordered = ordered
        self.query = query
        self.unique = unique
        self.lower = lower
...
class fuml_Kernel_Association(Classifier):
    ...
    def __init__(self, derived: bool, association: set["Kernel_Property"] = None, fuml_Kernel_Association72: set["Kernel_Property"] = None, owningAssociation: set["Kernel_Property"] = None, fuml_Kernel_Association: set["Kernel_Type"] = None):
        self.derived = derived
...
class fuml_BasicBehaviors_Behavior(Class):
    ...
    def __init__(self, reentrant: bool, fuml_BasicBehaviors_Behavior3: "BasicBehaviors_BehavioredClassifier" = None, method: "Kernel_BehavioralFeature" = None, fuml_BasicBehaviors_Behavior: set["Kernel_Parameter"] = None):
