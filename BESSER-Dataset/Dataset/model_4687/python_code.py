...
class Model_Expression(Predicate):
    ...
    def __init__(self, operator: str, Model_Expression71: "Model_Predicate" = None, Model_Expression: "Model_Predicate" = None):
...
class Model_DEVS(ABC):
    ...
    def __init__(self, name: str, Model_DEVS: "Model_DEVS" = None, Model_DEVS0: "Model_DEVS" = None, Model_DEVS3: set["Model_IPort"] = None, Model_DEVS5: set["Model_OPort"] = None, Model_DEVS24: "Model_Port" = None, Model_DEVS16: "Model_CoupledDEVS" = None):
        self.name = name
