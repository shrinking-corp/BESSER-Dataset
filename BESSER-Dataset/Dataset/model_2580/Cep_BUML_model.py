...
events_Event.attributes={events_Event_type, events_Event_isProcessed, events_Event_timestamp}
...
domain_model = DomainModel(
    name="events",
    types={events_EventModel, events_EventPattern, events_Automaton, events_AtomicEventPattern, EventPattern, events_ComplexEventPattern, events_ComplexEventOperator, events_Timewindow, events_EventPatternReference, events_AbstractMultiplicity, events_Event, events_EventSource, events_OR, ComplexEventOperator, events_NEG, events_FOLLOWS, events_AND, events_Multiplicity, AbstractMultiplicity, events_Infinite, events_AtLeastOne},
    associations={eventPatterns0, eventModel1, automaton2, operator3, timewindow4, containedEventPatterns6, eventPattern8, multiplicity11, source13},
