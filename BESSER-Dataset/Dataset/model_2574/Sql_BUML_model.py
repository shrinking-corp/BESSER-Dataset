...
sql_Limit.attributes={sql_Limit_l1, sql_Limit_l2}
...
sql_OpFunctionCast.attributes={sql_OpFunctionCast_p, sql_OpFunctionCast_type, sql_OpFunctionCast_p2}
...
sql_ScalarOperand.attributes={sql_ScalarOperand_sotime, sql_ScalarOperand_sostr, sql_ScalarOperand_sodt, sql_ScalarOperand_soUInt, sql_ScalarOperand_soint, sql_ScalarOperand_sodate, sql_ScalarOperand_sodbl}
...
in_126: BinaryAssociation = BinaryAssociation(
    name="in_126",
    ends={
...
domain_model = DomainModel(
    name="sql",
    types={sql_OrTable, sql_OrExpr, sql_OrGroupByColumn, sql_OrOrderByColumn, PivotForClause, sql_ColumnOrAlias, OrColumn, sql_Model, sql_SelectQuery, sql_FetchFirst, sql_UnsignedValue, sql_Offset, sql_Limit, sql_SelectSubSet, sql_Select, SelectQuery, sql_OrColumn, sql_TableFull, sql_SubQueryOperand, sql_FromValues, sql_PivotTable, sql_UnpivotTable, sql_Values, sql_FromValuesColumns, sql_FromValuesColumnNames, sql_Operands, sql_DbObjectName, sql_DbObjectNameAll, sql_ColumnFull, sql_FromTable, OrTable, sql_TableOrAlias, sql_FromTableJoin, sql_JoinCondition, sql_UsingCols, sql_PivotInClause, sql_PivotFunction, sql_UnpivotInClauseArgs, sql_PivotColumns, sql_UnpivotInClause, sql_UnpivotInClauseArg, UnpivotInClauseArgs, sql_ColumnNames, FromValuesColumnNames, sql_Rows, sql_Row, Rows, sql_RowValues, sql_RowValue, RowValues, sql_PivotFunctions, sql_PivotForClause, OrExpr, sql_ExprGroup, sql_XExpr, sql_InOper, sql_ExistsOper, sql_Between, sql_Like, sql_Pivots, PivotColumns, sql_PivotCol, PivotFunction, Pivots, ColumnFull, UsingCols, PivotCol, TableFull, sql_OrderByColumnFull, OrOrderByColumn, sql_GroupByColumnFull, OrGroupByColumn, sql_OpFunction, sql_FullExpression, sql_LikeOperand, sql_OpFunctionCast, sql_POperand, sql_OperandListGroup, sql_Comparison, sql_Prms, sql_JRParameter, Prms, sql_SQLCaseOperand, sql_ExpOperand, sql_ScalarOperand, sql_OpFunctionArg, sql_FunctionAnalytical, sql_AnalyticClause, sql_OperandList, OpFunctionArgAgregate, sql_Operand, sql_ColumnOperand, sql_FunctionExtract, sql_WindowingClause, sql_WindowingClauseBetween, WindowingClause, sql_WindowingClauseOperandPreceding, sql_WindowingClauseOperandFollowing, sql_AnalyticExprArg, sql_OrderByClauseArgs, sql_OrderByClauseArg, OrderByClauseArgs, sql_AnalyticExprArgs, QueryPartitionClause, sql_QueryPartitionClause, sql_OrderByClause, RowValue, OperandList, sql_SQLCaseWhens, sql_SqlCaseWhen, SQLCaseWhens, AnalyticExprArgs, sql_OpFunctionArgOperand, OpFunctionArg, sql_OpFunctionArgAgregate, sql_abc, sql_UnipivotInClause, UnpivotInClause, sql_uicargs, sql_pvcs, sql_pcols, sql_tbls, sql_OpList, sql_IntegerValue, sql_Col, sql_Plus, Operands, sql_Minus, sql_Concat, sql_Multiply, sql_Division, sql_OBCArgs, sql_AExpArgs, sql_OpFList, sql_WhenList, EXTRACT_VALUES, XFunction},
    associations={tbl8, whereExpression10, groupByEntry12, havingEntry14, orderByEntry17, lim19, offset21, fetchFirst23, entries26, query0, fetchFirst1, query2, op3, cols6, entries50, tfull53, sq55, values57, pivot59, unpivot61, tblAlias63, values66, c68, fvCols70, ce28, colAlias30, dbAllCols32, entries34, table36, fjoin38, onTable40, joinExpr43, joinCond46, useCols48, pin84, sq86, args89, pcols91, pfor93, inop96, pcols98, rows72, entries74, rowValues76, entries78, pfun80, pfor82, entries114, efrag117, expgroup119, exp122, xexp124, in_126, exists128, op1130, between133, like135, cfuls100, entries103, colOrder105, entries107, colGrBy109, gbFunction112, op2152, fop2154, fcast157, fparam159, op2161, op3164, subquery167, opList170, comp137, expr139, col142, prm145, entries147, op2149, func201, sqlcase204, param206, eparam209, scalar211, args213, fan215, operand217, subquery172, opList175, opGroup178, op1180, left183, right185, column188, xop191, subq193, fcast196, fext199, winc226, wcoP228, wcoF229, exp231, expr233, args236, col238, args240, anClause220, abc222, obc224, expr258, when261, expr263, texp265, eexp268, ce242, colAlias245, op248, op249, cfull252, sel255, entries273, args274, entries276, entries278, entries279, entries281, entries271, entries291, entries283, entries285, entries287, entries289},
    generalizations={gen_sql_OrColumn_PivotForClause, gen_sql_ColumnOrAlias_OrColumn, gen_sql_Select_SelectQuery, gen_sql_ColumnFull_PivotForClause, gen_sql_FromTable_OrTable, gen_sql_UnpivotInClauseArg_UnpivotInClauseArgs, gen_sql_ColumnNames_FromValuesColumnNames, gen_sql_Row_Rows, gen_sql_RowValue_RowValues, gen_sql_FullExpression_OrExpr, gen_sql_Pivots_PivotColumns, gen_sql_PivotCol_PivotFunction, gen_sql_PivotCol_PivotColumns, gen_sql_PivotCol_Pivots, gen_sql_DbObjectName_ColumnFull, gen_sql_DbObjectName_UsingCols, gen_sql_DbObjectName_PivotCol, gen_sql_DbObjectName_TableFull, gen_sql_OrderByColumnFull_OrOrderByColumn, gen_sql_GroupByColumnFull_OrGroupByColumn, gen_sql_JRParameter_Prms, gen_sql_Operands_OpFunctionArgAgregate, gen_sql_WindowingClauseBetween_WindowingClause, gen_sql_WindowingClauseOperandPreceding_WindowingClause, gen_sql_OrderByClauseArg_OrderByClauseArgs, gen_sql_ScalarOperand_RowValue, gen_sql_ScalarOperand_OperandList, gen_sql_SqlCaseWhen_SQLCaseWhens, gen_sql_AnalyticExprArgs_QueryPartitionClause, gen_sql_AnalyticExprArg_AnalyticExprArgs, gen_sql_OpFunctionArgOperand_OpFunctionArg, gen_sql_abc_FromValuesColumnNames, gen_sql_UnipivotInClause_UnpivotInClause, gen_sql_uicargs_UnpivotInClauseArgs, gen_sql_pvcs_Pivots, gen_sql_pcols_PivotCol, gen_sql_tbls_TableFull, gen_sql_OpList_OperandList, gen_sql_Col_ColumnFull, gen_sql_Plus_Operands, gen_sql_Minus_Operands, gen_sql_Concat_Operands, gen_sql_Multiply_Operands, gen_sql_Division_Operands, gen_sql_OBCArgs_OrderByClauseArgs, gen_sql_AExpArgs_AnalyticExprArgs, gen_sql_OpFList_OpFunctionArg, gen_sql_WhenList_SQLCaseWhens},
    metadata=None
)
