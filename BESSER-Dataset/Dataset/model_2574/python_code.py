...
class sql_OpFunction:
    ...
    def __init__(self, fname: str, star: str, sql_OpFunction214: "sql_OpFunctionArg" = None, sql_OpFunction216: "sql_FunctionAnalytical" = None, sql_OpFunction: "sql_GroupByColumnFull" = None, sql_OpFunction156: "sql_LikeOperand" = None, sql_OpFunction203: "sql_Operand" = None):
        self.fname = fname
        self.star = star
...
class sql_OrderByColumnFull(OrOrderByColumn):
    ...
    def __init__(self, colOrderInt: str, direction: str, sql_OrderByColumnFull: "sql_OrOrderByColumn" = None, sql_OrderByColumnFull106: "sql_ColumnFull" = None):
...
class sql_ExistsOper:
    ...
    def __init__(self, op: str, sql_ExistsOper173: "sql_SubQueryOperand" = None, sql_ExistsOper176: "sql_OperandListGroup" = None, sql_ExistsOper: "sql_FullExpression" = None):
        self.op = op
...
class sql_FullExpression(OrExpr):
    ...
    def __init__(self, c: str, notPrm: str, isnull: str, sql_FullExpression: "sql_OrExpr" = None, sql_FullExpression118: "sql_FullExpression" = None, sql_FullExpression116: "sql_FullExpression" = None, sql_FullExpression120: "sql_ExprGroup" = None, sql_FullExpression123: "sql_FullExpression" = None, sql_FullExpression121: "sql_FullExpression" = None, sql_FullExpression125: "sql_XExpr" = None, sql_FullExpression127: "sql_InOper" = None, sql_FullExpression129: "sql_ExistsOper" = None, sql_FullExpression131: "sql_Operands" = None, sql_FullExpression134: "sql_Between" = None, sql_FullExpression136: "sql_Like" = None, sql_FullExpression138: "sql_Comparison" = None):
        self.c = c
        self.notPrm = notPrm
        self.isnull = isnull
...
class sql_PivotInClause:
    ...
    def __init__(self, pinany: str, sql_PivotInClause: "sql_PivotTable" = None, sql_PivotInClause87: "sql_SubQueryOperand" = None, sql_PivotInClause90: "sql_UnpivotInClauseArgs" = None):
        self.pinany = pinany
...
class sql_FromTableJoin:
    ...
    def __init__(self, join: str, sql_FromTableJoin47: "sql_JoinCondition" = None, sql_FromTableJoin: "sql_FromTable" = None, sql_FromTableJoin41: "sql_TableOrAlias" = None, sql_FromTableJoin44: "sql_OrExpr" = None):
        self.join = join
...
class sql_TableOrAlias:
    ...
    def __init__(self, alias: str, sql_TableOrAlias54: "sql_TableFull" = None, sql_TableOrAlias56: "sql_SubQueryOperand" = None, sql_TableOrAlias58: "sql_FromValues" = None, sql_TableOrAlias60: "sql_PivotTable" = None, sql_TableOrAlias62: "sql_UnpivotTable" = None, sql_TableOrAlias64: "sql_DbObjectName" = None, sql_TableOrAlias: "sql_FromTable" = None, sql_TableOrAlias42: "sql_FromTableJoin" = None):
        self.alias = alias
...
class sql_DbObjectName(TableFull, ColumnFull, PivotCol, UsingCols):

    def __init__(self, dbname: str, sql_DbObjectName52: "sql_UsingCols" = None, sql_DbObjectName65: "sql_TableOrAlias" = None, sql_DbObjectName: "sql_ColumnOrAlias" = None, sql_DbObjectName247: "sql_AnalyticExprArg" = None, sql_DbObjectName280: "sql_pcols" = None, sql_DbObjectName282: "sql_tbls" = None, sql_DbObjectName272: "sql_Col" = None):
        self.dbname = dbname
...
class sql_Select(SelectQuery):
    ...
    def __init__(self, select: str, sql_Select9: "sql_OrTable" = None, sql_Select11: "sql_OrExpr" = None, sql_Select13: "sql_OrGroupByColumn" = None, sql_Select15: "sql_OrExpr" = None, sql_Select18: "sql_OrOrderByColumn" = None, sql_Select20: "sql_Limit" = None, sql_Select22: "sql_Offset" = None, sql_Select24: "sql_FetchFirst" = None, sql_Select: "sql_SelectSubSet" = None, sql_Select4: set["sql_SelectSubSet"] = None, sql_Select7: "sql_OrColumn" = None):
        self.select = select
...
class sql_FetchFirst:
    ...
    def __init__(self, row: str, sql_FetchFirst25: "sql_Select" = None, sql_FetchFirst: "sql_UnsignedValue" = None):
        self.row = row
