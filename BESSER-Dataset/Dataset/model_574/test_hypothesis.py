...
def test_assistantmvc_openview_has_question():
    assert hasattr(AssistantMVC_OpenView, "question")
    descriptor = None
    for klass in AssistantMVC_OpenView.__mro__:
...
@given(instance=AssistantMVC_OpenView_strategy)
def test_assistantmvc_openview_question_setter(instance):
