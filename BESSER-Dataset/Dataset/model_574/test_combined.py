...
def test_hyp_assistantmvc_openview_question_setter(instance):
...
def test_AssistantMVC_OpenView_question_value_roundtrip():
    instance = AssistantMVC_OpenView(question="sample_text")
...
AssistantMVC_OpenView_strategy = st.builds(AssistantMVC_OpenView, question=safe_text)
@given(instance=AssistantMVC_OpenView_strategy)
@settings(max_examples=25)
