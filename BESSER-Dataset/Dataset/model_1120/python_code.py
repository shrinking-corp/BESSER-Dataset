...
class MMInterModel_Event(Element):
    ...
    def __init__(self, type: str, model: str, MMInterModel_Event: "MMInterModel_Model" = None, MMInterModel_Event45: set["MMInterModel_Transition"] = None, MMInterModel_Event30: "MMInterModel_Transition" = None):
        self.type = type
        self.model = model
...
class MMInterModel_Attribute(Element):
    ...
    def __init__(self, isArray: bool, arraySize: int, model: str, component: str, defaultValue: str, lowerBound: int, upperBound: int, type: str, MMInterModel_Attribute: "MMInterModel_Model" = None, MMInterModel_Attribute11: "MMInterModel_Component" = None, MMInterModel_Attribute43: set["MMInterModel_StringEnumeration"] = None):
...
class MMInterModel_Transition(Element):
    ...
    def __init__(self, action: str, stateMachine: str, MMInterModel_Transition: "MMInterModel_StateMachine" = None, MMInterModel_Transition23: "MMInterModel_State" = None, MMInterModel_Transition26: "MMInterModel_State" = None, MMInterModel_Transition46: "MMInterModel_Event" = None, MMInterModel_Transition29: "MMInterModel_Event" = None, MMInterModel_Transition32: set["MMInterModel_Guard"] = None, MMInterModel_Transition35: "MMInterModel_State" = None, MMInterModel_Transition38: "MMInterModel_State" = None):
        self.action = action
        self.stateMachine = stateMachine
