...
# Classes
MMInterModel_Element = Class(name="MMInterModel_Element")
MMInterModel_Transition = Class(name="MMInterModel_Transition")
MMInterModel_State = Class(name="MMInterModel_State")
MMInterModel_Model = Class(name="MMInterModel_Model")
Element = Class(name="Element")
MMInterModel_Component = Class(name="MMInterModel_Component")
MMInterModel_Attribute = Class(name="MMInterModel_Attribute")
MMInterModel_Event = Class(name="MMInterModel_Event")
MMInterModel_StateConfiguration = Class(name="MMInterModel_StateConfiguration")
MMInterModel_StateMachine = Class(name="MMInterModel_StateMachine")
MMInterModel_StringEnumeration = Class(name="MMInterModel_StringEnumeration")
MMInterModel_Guard = Class(name="MMInterModel_Guard")
...
MMInterModel_Element.attributes={MMInterModel_Element_name, MMInterModel_Element_id}
...
MMInterModel_Transition.attributes={MMInterModel_Transition_stateMachine, MMInterModel_Transition_action}
...
MMInterModel_State.attributes={MMInterModel_State_stateNumber, MMInterModel_State_duringBehaviour, MMInterModel_State_stateConfiguration, MMInterModel_State_stateMachine, MMInterModel_State_exitBehaviour, MMInterModel_State_entryBehaviour}
...
MMInterModel_Component.attributes={MMInterModel_Component_numberOfSpares, MMInterModel_Component_model}
...
MMInterModel_Attribute.attributes={MMInterModel_Attribute_lowerBound, MMInterModel_Attribute_arraySize, MMInterModel_Attribute_model, MMInterModel_Attribute_defaultValue, MMInterModel_Attribute_upperBound, MMInterModel_Attribute_component, MMInterModel_Attribute_type, MMInterModel_Attribute_isArray}
...
MMInterModel_Event.attributes={MMInterModel_Event_type, MMInterModel_Event_model}
...
MMInterModel_StateConfiguration.attributes={MMInterModel_StateConfiguration_model, MMInterModel_StateConfiguration_condition, MMInterModel_StateConfiguration_negation, MMInterModel_StateConfiguration_configOperator}
...
MMInterModel_StateMachine.attributes={MMInterModel_StateMachine_type, MMInterModel_StateMachine_component, MMInterModel_StateMachine_superState}
...
MMInterModel_Guard.attributes={MMInterModel_Guard_transition, MMInterModel_Guard_specification}
...
domain_model = DomainModel(
    name="MMInterModel",
    types={MMInterModel_Element, MMInterModel_Transition, MMInterModel_State, MMInterModel_Model, Element, MMInterModel_Component, MMInterModel_Attribute, MMInterModel_Event, MMInterModel_StateConfiguration, MMInterModel_StateMachine, MMInterModel_StringEnumeration, MMInterModel_Guard},
    associations={transitions15, states17, initialState19, source22, target25, components0, globalVariables1, events3, stateConfigurations5, normalBehaviour7, localVariables9, failurePatterns12, enumerationLiterals42, transitionsTriggeredByEvent44, configurationStates47, subConfigurations51, event28, guard31, incomingTransitions33, outgoingTransitions36, subMachines39},
    generalizations={gen_MMInterModel_StateMachine_Element, gen_MMInterModel_Transition_Element, gen_MMInterModel_Model_Element, gen_MMInterModel_Component_Element, gen_MMInterModel_StringEnumeration_Element, gen_MMInterModel_Event_Element, gen_MMInterModel_StateConfiguration_Element, gen_MMInterModel_State_Element, gen_MMInterModel_Attribute_Element, gen_MMInterModel_Guard_Element},
    metadata=None
)
