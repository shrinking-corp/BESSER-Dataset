...
# Classes
ioT_Declaration = Class(name="ioT_Declaration")
ioT_Program = Class(name="ioT_Program")
ioT_Model = Class(name="ioT_Model")
ioT_ExternalDeclaration = Class(name="ioT_ExternalDeclaration")
ioT_Config = Class(name="ioT_Config")
ioT_Device = Class(name="ioT_Device")
ioT_Address = Class(name="ioT_Address")
ioT_Expression = Class(name="ioT_Expression")
ioT_TIMEUNIT = Class(name="ioT_TIMEUNIT")
ioT_ControllerDevice = Class(name="ioT_ControllerDevice")
Device = Class(name="Device")
ioT_IoTDevice = Class(name="ioT_IoTDevice")
ioT_WifiStatement = Class(name="ioT_WifiStatement")
ioT_ConnectStatement = Class(name="ioT_ConnectStatement")
ioT_VarOrList = Class(name="ioT_VarOrList")
ioT_ListenStatement = Class(name="ioT_ListenStatement")
ioT_Loop = Class(name="ioT_Loop")
ioT_ExpressionRight = Class(name="ioT_ExpressionRight")
ioT_ConnectionConfig = Class(name="ioT_ConnectionConfig")
ioT_ReadSensor = Class(name="ioT_ReadSensor")
ioT_SENSOR = Class(name="ioT_SENSOR")
ioT_Block = Class(name="ioT_Block")
ExpressionRight = Class(name="ExpressionRight")
ioT_ExternalRight = Class(name="ioT_ExternalRight")
ioT_Command = Class(name="ioT_Command")
ioT_Action = Class(name="ioT_Action")
Command = Class(name="Command")
ioT_ExpressionLeft = Class(name="ioT_ExpressionLeft")
ExpressionLeft = Class(name="ExpressionLeft")
ioT_BoolExpression = Class(name="ioT_BoolExpression")
Expression = Class(name="Expression")
ioT_Bool = Class(name="ioT_Bool")
ioT_IntExpression = Class(name="ioT_IntExpression")
ioT_ReadVariable = Class(name="ioT_ReadVariable")
ioT_Variable = Class(name="ioT_Variable")
ioT_ReadConnection = Class(name="ioT_ReadConnection")
ioT_ExternalOf = Class(name="ioT_ExternalOf")
ioT_HOURS = Class(name="ioT_HOURS")
ioT_DAYS = Class(name="ioT_DAYS")
ioT_WEEKS = Class(name="ioT_WEEKS")
ioT_ClearListAction = Class(name="ioT_ClearListAction")
Action = Class(name="Action")
ioT_LEDAction = Class(name="ioT_LEDAction")
ioT_ArrowCommand = Class(name="ioT_ArrowCommand")
ioT_ElseBlock = Class(name="ioT_ElseBlock")
ioT_Comparison = Class(name="ioT_Comparison")
ioT_ComparisonOp = Class(name="ioT_ComparisonOp")
ioT_DeviceConfig = Class(name="ioT_DeviceConfig")
Config = Class(name="Config")
ioT_IpAddress = Class(name="ioT_IpAddress")
Address = Class(name="Address")
ioT_WindowsSerialAddress = Class(name="ioT_WindowsSerialAddress")
ioT_UnixSerialAddress = Class(name="ioT_UnixSerialAddress")
VarOrList = Class(name="VarOrList")
ioT_PyList = Class(name="ioT_PyList")
ioT_MILLISECONDS = Class(name="ioT_MILLISECONDS")
TIMEUNIT = Class(name="TIMEUNIT")
ioT_SECONDS = Class(name="ioT_SECONDS")
ioT_MINUTES = Class(name="ioT_MINUTES")
ioT_OR = Class(name="ioT_OR")
Comparison = Class(name="Comparison")
ioT_AND = Class(name="ioT_AND")
ioT_VarAccess = Class(name="ioT_VarAccess")
ioT_LIGHTSENSOR = Class(name="ioT_LIGHTSENSOR")
SENSOR = Class(name="SENSOR")
ioT_TEMPERATURE = Class(name="ioT_TEMPERATURE")
ioT_HUMIDITY = Class(name="ioT_HUMIDITY")
ioT_ToVar = Class(name="ioT_ToVar")
ioT_AddToList = Class(name="ioT_AddToList")
ioT_SendCommand = Class(name="ioT_SendCommand")
ioT_IfStatement = Class(name="ioT_IfStatement")
ioT_EQ = Class(name="ioT_EQ")
ioT_NE = Class(name="ioT_NE")
ioT_True = Class(name="ioT_True")
Bool = Class(name="Bool")
ioT_False = Class(name="ioT_False")
ioT_EQL = Class(name="ioT_EQL")
ioT_ItemVariable = Class(name="ioT_ItemVariable")
ioT_ItemInt = Class(name="ioT_ItemInt")
ioT_ItemBool = Class(name="ioT_ItemBool")
ioT_GT = Class(name="ioT_GT")
ComparisonOp = Class(name="ComparisonOp")
ioT_LT = Class(name="ioT_LT")
ioT_LE = Class(name="ioT_LE")
ioT_GE = Class(name="ioT_GE")
...
ioT_Declaration.attributes={ioT_Declaration_key, ioT_Declaration_value}
...
ioT_ListenStatement.attributes={ioT_ListenStatement_ip, ioT_ListenStatement_port}
...
domain_model = DomainModel(
    name="ioT",
    types={ioT_Declaration, ioT_Program, ioT_Model, ioT_ExternalDeclaration, ioT_Config, ioT_Device, ioT_Address, ioT_Expression, ioT_TIMEUNIT, ioT_ControllerDevice, Device, ioT_IoTDevice, ioT_WifiStatement, ioT_ConnectStatement, ioT_VarOrList, ioT_ListenStatement, ioT_Loop, ioT_ExpressionRight, ioT_ConnectionConfig, ioT_ReadSensor, ioT_SENSOR, ioT_Block, ExpressionRight, ioT_ExternalRight, ioT_Command, ioT_Action, Command, ioT_ExpressionLeft, ExpressionLeft, ioT_BoolExpression, Expression, ioT_Bool, ioT_IntExpression, ioT_ReadVariable, ioT_Variable, ioT_ReadConnection, ioT_ExternalOf, ioT_HOURS, ioT_DAYS, ioT_WEEKS, ioT_ClearListAction, Action, ioT_LEDAction, ioT_ArrowCommand, ioT_ElseBlock, ioT_Comparison, ioT_ComparisonOp, ioT_DeviceConfig, Config, ioT_IpAddress, Address, ioT_WindowsSerialAddress, ioT_UnixSerialAddress, VarOrList, ioT_PyList, ioT_MILLISECONDS, TIMEUNIT, ioT_SECONDS, ioT_MINUTES, ioT_OR, Comparison, ioT_AND, ioT_VarAccess, ioT_LIGHTSENSOR, SENSOR, ioT_TEMPERATURE, ioT_HUMIDITY, ioT_ToVar, ioT_AddToList, ioT_SendCommand, ioT_IfStatement, ioT_EQ, ioT_NE, ioT_True, Bool, ioT_False, ioT_EQL, ioT_ItemVariable, ioT_ItemInt, ioT_ItemBool, ioT_GT, ComparisonOp, ioT_LT, ioT_LE, ioT_GE},
    associations={declarations5, program7, externalDeclarations0, configs1, devices3, address26, configuration28, timeVal31, wifiStatements9, connectStatements11, variables13, listenStatements15, loops17, body19, connectionConfig21, device23, sensor46, commands47, timeUnit33, command35, value37, value38, source39, method41, target43, list56, method49, commands51, value53, elseBlock73, left76, right78, left81, left57, right58, variableName61, variable63, list65, target67, condition69, commands70, right83, left86, op88, right90, value93, value95},
    generalizations={gen_ioT_ControllerDevice_Device, gen_ioT_IoTDevice_Device, gen_ioT_ReadSensor_ExpressionLeft, gen_ioT_Block_ExpressionRight, gen_ioT_ExternalRight_ExpressionRight, gen_ioT_Action_Command, gen_ioT_Expression_ExpressionLeft, gen_ioT_BoolExpression_Expression, gen_ioT_IntExpression_Expression, gen_ioT_ReadVariable_ExpressionLeft, gen_ioT_ReadConnection_ExpressionLeft, gen_ioT_ExternalOf_ExpressionLeft, gen_ioT_MINUTES_TIMEUNIT, gen_ioT_HOURS_TIMEUNIT, gen_ioT_DAYS_TIMEUNIT, gen_ioT_WEEKS_TIMEUNIT, gen_ioT_ClearListAction_Action, gen_ioT_LEDAction_Action, gen_ioT_ArrowCommand_Command, gen_ioT_DeviceConfig_Config, gen_ioT_ConnectionConfig_Config, gen_ioT_IpAddress_Address, gen_ioT_WindowsSerialAddress_Address, gen_ioT_UnixSerialAddress_Address, gen_ioT_Variable_VarOrList, gen_ioT_PyList_VarOrList, gen_ioT_MILLISECONDS_TIMEUNIT, gen_ioT_SECONDS_TIMEUNIT, gen_ioT_OR_Comparison, gen_ioT_AND_Comparison, gen_ioT_VarAccess_Expression, gen_ioT_LIGHTSENSOR_SENSOR, gen_ioT_TEMPERATURE_SENSOR, gen_ioT_HUMIDITY_SENSOR, gen_ioT_ToVar_ExpressionRight, gen_ioT_AddToList_ExpressionRight, gen_ioT_SendCommand_ExpressionRight, gen_ioT_IfStatement_Command, gen_ioT_EQ_ComparisonOp, gen_ioT_NE_ComparisonOp, gen_ioT_True_Bool, gen_ioT_False_Bool, gen_ioT_EQL_Comparison, gen_ioT_ItemVariable_Comparison, gen_ioT_ItemInt_Comparison, gen_ioT_ItemBool_Comparison, gen_ioT_GT_ComparisonOp, gen_ioT_LT_ComparisonOp, gen_ioT_LE_ComparisonOp, gen_ioT_GE_ComparisonOp},
    metadata=None
)
