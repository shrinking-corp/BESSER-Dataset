...
class ioT_ConnectionConfig(Config):
    ...
    def __init__(self, type: str, ioT_ConnectionConfig30: "ioT_ConnectStatement" = None, ioT_ConnectionConfig: "ioT_WifiStatement" = None):
        self.type = type
...
class ioT_ListenStatement:
    ...
    def __init__(self, ip: str, port: int, ioT_ListenStatement: "ioT_Program" = None, ioT_ListenStatement20: "ioT_ExpressionRight" = None):
        self.ip = ip
        self.port = port
...
class ioT_Device:
    ...
    def __init__(self, name: str, ioT_Device8: "ioT_Program" = None, ioT_Device: "ioT_Model" = None, ioT_Device25: "ioT_ConnectStatement" = None, ioT_Device40: "ioT_ReadConnection" = None, ioT_Device68: "ioT_SendCommand" = None):
        self.name = name
...
class ioT_Config:
    ...
    def __init__(self, name: str, ioT_Config6: set["ioT_Declaration"] = None, ioT_Config: "ioT_Model" = None):
        self.name = name
