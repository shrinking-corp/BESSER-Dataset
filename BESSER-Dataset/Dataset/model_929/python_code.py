...
class uma_WorkProductDescriptor(Descriptor):
    ...
    def __init__(self, activityEntryState: str, activityExitState: str, uma_WorkProductDescriptor164: "uma_WorkProduct" = None, WorkProductDescriptor: "uma_WorkProductDescriptor" = None, impacts: set["uma_WorkProductDescriptor"] = None, uma_WorkProductDescriptor: "uma_RoleDescriptor" = None, uma_WorkProductDescriptor159: "uma_RoleDescriptor" = None, uma_WorkProductDescriptor184: "uma_TaskDescriptor" = None, uma_WorkProductDescriptor187: "uma_TaskDescriptor" = None, uma_WorkProductDescriptor190: "uma_TaskDescriptor" = None, uma_WorkProductDescriptor193: "uma_TaskDescriptor" = None, WorkProductDescriptor170: "uma_WorkProductDescriptor" = None, impactedBy: set["uma_WorkProductDescriptor"] = None, uma_WorkProductDescriptor173: "uma_WorkProductDescriptor" = None, uma_WorkProductDescriptor171: set["uma_WorkProductDescriptor"] = None, uma_WorkProductDescriptor296: "uma_ProcessComponentInterface" = None):
...
class uma_Ellipse(GraphicPrimitive):
    ...
    def __init__(self, endAngle: str, radiusX: str, radiusY: str, rotation: str, startAngle: str, uma_Ellipse: "uma_Point" = None):
...
class uma_SemanticModelBridge(DiagramElement):
    ...
    def __init__(self, presentation: str, namespace: "uma_Diagram" = None, SemanticModelBridge: "uma_GraphElement" = None, semanticModel: "uma_GraphElement" = None, SemanticModelBridge108: "uma_Diagram" = None):
...
class uma_WorkProductDescription(ContentDescription):
    ...
    def __init__(self, impactOfNotHaving: str, reasonsForNotNeeding: str, externalId: str, purpose: str):
...
class uma_Point:
    ...
    def __init__(self, x: str, y: str, uma_Point85: "uma_DiagramLink" = None, uma_Point: "uma_GraphElement" = None, uma_Point101: "uma_GraphEdge" = None, uma_Point103: "uma_Diagram" = None, uma_Point116: "uma_Ellipse" = None, uma_Point114: "uma_Polyline" = None):
        self.x = x
        self.y = y
...
class uma_MethodPlugin(Package, MethodUnit):
    ...
    def __init__(self, userChangeable: str, uma_MethodPlugin303: "uma_MethodPlugin" = None, uma_MethodPlugin301: set["uma_MethodPlugin"] = None, uma_MethodPlugin310: "uma_MethodConfiguration" = None, uma_MethodPlugin: set["uma_MethodPackage"] = None, uma_MethodPlugin326: "uma_MethodLibrary" = None):
...
class uma_ContentDescription(MethodUnit):
    ...
    def __init__(self, keyConsiderations: str, mainDescription: str, uma_ContentDescription: "uma_DescribableElement" = None, uma_ContentDescription14: set["uma_Section"] = None):
...
class uma_Activity(WorkDefinition, WorkBreakdownElement, VariabilityElement):
    ...
    def __init__(self, isEnactable: str, superActivities: set["uma_BreakdownElement"] = None, uma_Activity: set["uma_Roadmap"] = None, uma_Activity120: set["uma_SupportingMaterial"] = None, uma_Activity123: set["uma_Checklist"] = None, uma_Activity126: set["uma_Concept"] = None, uma_Activity129: set["uma_Example"] = None, uma_Activity132: set["uma_Guideline"] = None, uma_Activity135: set["uma_ReusableAsset"] = None, Activity: "uma_BreakdownElement" = None, uma_Activity209: "uma_Practice" = None, uma_Activity250: "uma_Discipline" = None):
...
class uma_Section(VariabilityElement):
    ...
    def __init__(self, sectionName: str, sectionDescription: str, uma_Section: "uma_ContentDescription" = None, uma_Section17: "uma_Section" = None, uma_Section15: set["uma_Section"] = None, uma_Section20: "uma_Section" = None, uma_Section18: "uma_Section" = None, uma_Section199: "uma_TaskDescriptor" = None):
...
class uma_DiagramElement(MethodElement):
    ...
    def __init__(self, isVisible: str, DiagramElement97: "uma_Reference" = None, contained: "uma_GraphElement" = None, referenced: set["uma_Reference"] = None, uma_DiagramElement: set["uma_Property"] = None, DiagramElement: "uma_GraphElement" = None):
...
class uma_MethodPackage(MethodElement, Package):
    ...
    def __init__(self, global_: str, uma_MethodPackage: "uma_MethodPackage" = None, uma_MethodPackage67: set["uma_MethodPackage"] = None, uma_MethodPackage71: "uma_MethodPackage" = None, uma_MethodPackage69: set["uma_MethodPackage"] = None, uma_MethodPackage313: "uma_MethodConfiguration" = None, uma_MethodPackage300: "uma_MethodPlugin" = None):
