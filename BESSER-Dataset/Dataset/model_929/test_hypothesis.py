...
def test_uma_transition_is_not_abstract():
    assert not inspect.isabstract(uma_Transition)


def test_uma_transition_constructor_exists():
    assert callable(uma_Transition.__init__)


def test_uma_transition_constructor_args():
    sig = inspect.signature(uma_Transition.__init__)
    params = list(sig.parameters.keys())



def test_uma_vertex_is_not_abstract():
    assert not inspect.isabstract(uma_Vertex)


def test_uma_vertex_constructor_exists():
    assert callable(uma_Vertex.__init__)


def test_uma_vertex_constructor_args():
    sig = inspect.signature(uma_Vertex.__init__)
    params = list(sig.parameters.keys())



def test_uma_region_is_not_abstract():
    assert not inspect.isabstract(uma_Region)


def test_uma_region_constructor_exists():
    assert callable(uma_Region.__init__)


def test_uma_region_constructor_args():
...
def test_uma_pseudostate_is_not_abstract():
    assert not inspect.isabstract(uma_PseudoState)


def test_uma_pseudostate_constructor_exists():
    assert callable(uma_PseudoState.__init__)


def test_uma_pseudostate_constructor_args():
    sig = inspect.signature(uma_PseudoState.__init__)
    params = list(sig.parameters.keys())



def test_uma_state_is_not_abstract():
    assert not inspect.isabstract(uma_State)


def test_uma_state_constructor_exists():
    assert callable(uma_State.__init__)


def test_uma_state_constructor_args():
...
def test_uma_processdescription_has_externalId():
    assert hasattr(uma_ProcessDescription, "externalId")
    descriptor = None
...
def test_uma_workproductdescription_has_externalId():
    assert hasattr(uma_WorkProductDescription, "externalId")
    descriptor = None
...
def test_uma_statemachine_is_not_abstract():
    assert not inspect.isabstract(uma_StateMachine)


def test_uma_statemachine_constructor_exists():
    assert callable(uma_StateMachine.__init__)


def test_uma_statemachine_constructor_args():
...
def test_uma_describableelement_has_presentationName():
    assert hasattr(uma_DescribableElement, "presentationName")
    descriptor = None
    for klass in uma_DescribableElement.__mro__:
...
@given(instance=uma_ProcessDescription_strategy)
def test_uma_processdescription_externalId_setter(instance):
...
@given(instance=uma_WorkProductDescription_strategy)
def test_uma_workproductdescription_externalId_setter(instance):
    original = instance.externalId
    instance.externalId = original
    assert instance.externalId == original
...
@given(instance=uma_DescribableElement_strategy)
def test_uma_describableelement_presentationName_setter(instance):
