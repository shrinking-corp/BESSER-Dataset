...
uma_MethodElement.attributes={uma_MethodElement_guid, uma_MethodElement_orderingGuide, uma_MethodElement_briefDescription, uma_MethodElement_suppressed}
...
uma_WorkProductDescription.attributes={uma_WorkProductDescription_purpose, uma_WorkProductDescription_reasonsForNotNeeding, uma_WorkProductDescription_impactOfNotHaving, uma_WorkProductDescription_externalId}
...
uma_BreakdownElement.attributes={uma_BreakdownElement_prefix, uma_BreakdownElement_isOptional, uma_BreakdownElement_isPlanned, uma_BreakdownElement_hasMultipleOccurrences}
...
uma_Ellipse.attributes={uma_Ellipse_rotation, uma_Ellipse_radiusY, uma_Ellipse_startAngle, uma_Ellipse_radiusX, uma_Ellipse_endAngle}
...
uma_DeliveryProcessDescription.attributes={uma_DeliveryProcessDescription_scale, uma_DeliveryProcessDescription_projectMemberExpertise, uma_DeliveryProcessDescription_estimatingTechnique, uma_DeliveryProcessDescription_projectCharacteristics, uma_DeliveryProcessDescription_typeOfContract, uma_DeliveryProcessDescription_riskLevel}
...
uma_MethodUnit.attributes={uma_MethodUnit_changeDescription, uma_MethodUnit_version, uma_MethodUnit_changeDate, uma_MethodUnit_authors}
...
domain_model = DomainModel(
    name="uma",
    types={uma_Classifier, Type, uma_Type, PackageableElement, uma_Element, uma_NamedElement, Element, uma_PackageableElement, NamedElement, uma_Package, Namespace, uma_Constraint, MethodElement, uma_ContentElement, DescribableElement, VariabilityElement, uma_SupportingMaterial, uma_Concept, uma_Checklist, uma_Guideline, uma_Example, uma_ReusableAsset, uma_DescribableElement, Classifier, uma_ContentDescription, uma_Namespace, uma_MethodElement, uma_Role, ContentElement, uma_WorkProduct, uma_Report, uma_Template, uma_ToolMentor, uma_EstimationConsiderations, uma_Task, WorkDefinition, MethodUnit, uma_Section, uma_WorkDefinition, Section, uma_Guidance, uma_Artifact, WorkProduct, uma_Deliverable, uma_Outcome, uma_MethodPackage, Package, uma_ContentPackage, MethodPackage, uma_Step, uma_DeliverableDescription, uma_RoleDescription, uma_TaskDescription, uma_GuidanceDescription, uma_PracticeDescription, uma_Point, uma_ArtifactDescription, WorkProductDescription, uma_WorkProductDescription, ContentDescription, uma_DiagramLink, uma_GraphConnector, uma_SemanticModelBridge, uma_Reference, uma_Property, uma_Diagram, GraphElement, uma_GraphEdge, uma_GraphElement, DiagramElement, uma_DiagramElement, GraphNode, uma_GraphNode, uma_SimpleSemanticModelElement, SemanticModelBridge, uma_UMASemanticModelBridge, uma_CoreSemanticModelBridge, uma_LeafElement, uma_TextElement, LeafElement, uma_Image, uma_GraphicPrimitive, uma_Polyline, GraphicPrimitive, uma_Dimension, uma_Activity, WorkBreakdownElement, uma_BreakdownElement, uma_Roadmap, uma_WorkBreakdownElement, BreakdownElement, uma_Ellipse, uma_PlanningData, uma_Milestone, uma_Iteration, Activity, uma_Phase, uma_TeamProfile, uma_RoleDescriptor, Descriptor, uma_WorkOrder, ProcessElement, uma_ProcessElement, uma_Descriptor, uma_WorkProductDescriptor, uma_CompositeRole, RoleDescriptor, uma_BreakdownElementDescription, uma_ActivityDescription, BreakdownElementDescription, uma_DeliveryProcessDescription, ProcessDescription, uma_TaskDescriptor, uma_ProcessDescription, ActivityDescription, uma_DescriptorDescription, Guidance, uma_Whitepaper, Concept, uma_TermDefinition, uma_Practice, uma_State, Vertex, uma_Region, uma_StateMachine, uma_Vertex, uma_Transition, uma_ContentCategory, uma_RoleSet, uma_Domain, uma_WorkProductType, uma_DisciplineGrouping, uma_Tool, uma_RoleSetGrouping, uma_CustomCategory, uma_PseudoState, uma_Discipline, ContentCategory, uma_Process, uma_CapabilityPattern, uma_MethodConfiguration, uma_ProcessPlanningTemplate, uma_ProcessComponent, ProcessPackage, uma_ProcessComponentInterface, uma_ProcessPackage, uma_DeliveryProcess, Process, uma_VariabilityElement, uma_MethodUnit, uma_ProcessComponentDescriptor, uma_MethodPlugin, uma_ProcessFamily, MethodConfiguration, uma_MethodLibrary, WorkOrderType, PseudoStateKind, VariabilityType},
    associations={ownedRules0, supportingMaterials1, conceptsAndPapers2, checklists4, guidelines6, examples8, assets10, presentation12, sections13, subSections16, predecessor19, modifies21, responsibleFor22, reports25, templates27, toolMentors29, estimationConsiderations31, performedBy33, mandatoryInput35, output38, additionallyPerformedBy41, estimationConsiderations52, precondition55, postcondition57, containerArtifact61, containedArtifacts63, deliveredWorkProducts65, reusedPackages68, childPackages70, contentElements72, optionalInput44, steps47, toolMentors49, link76, anchorage77, semanticModel79, container81, reference82, property83, viewport84, graphElement86, diagram88, graphElement89, graphEdge91, graphElement92, position74, contained75, anchor98, waypoints100, viewpoint102, diagramLink104, namespace106, size109, element110, element112, diagram94, referenced96, center115, breakdownElements117, roadmaps118, supportingMaterials119, checklists122, concepts125, examples128, guidelines131, reusableAssets134, waypoints113, presentedAfter139, presentedBefore141, planningData143, superActivities145, teamRoles146, superTeam148, subTeam150, linkToPredecessor137, pred160, WorkProduct163, impactedBy167, Role152, modifies155, responsibleFor157, Task174, additionallyPerformedBy176, assistedBy179, externalInput182, mandatoryInput185, optionalInput188, output191, performedPrimarilyBy194, selectedSteps197, aggregatedRoles200, impacts169, deliverableParts172, subPractices203, WorkProduct210, Region212, submachine213, container215, outgoing217, incoming218, Vertex220, Transition223, State226, StateMachine229, Region231, WorkDefinition234, container236, source239, contentReferences204, activityReferences207, tasks243, subdiscipline246, referenceWorkflows248, roles251, workProducts253, subdomains256, workProducts258, disciplines260, toolMentors262, roleSets264, target241, communicationsMaterials272, includesPatterns275, defaultContext276, validContext278, basedOnProcesses281, interfaces283, process284, processElements287, diagrams288, interfaceSpecifications291, categorizedElements266, subCategories268, educationMaterials270, bases302, variabilityBasedOnElement305, copyrightStatement306, methodPluginSelection308, methodPackageSelection311, processViews314, defaultView317, baseConfigurations321, interfaceIO294, ProcessComponent297, methodPackages299, predefinedConfigurations327, deliveryProcesses323, methodPlugins325},
    generalizations={gen_uma_Classifier_Type, gen_uma_Type_PackageableElement, gen_uma_NamedElement_Element, gen_uma_PackageableElement_NamedElement, gen_uma_Package_Namespace, gen_uma_Constraint_MethodElement, gen_uma_ContentElement_DescribableElement, gen_uma_ContentElement_VariabilityElement, gen_uma_DescribableElement_MethodElement, gen_uma_DescribableElement_Classifier, gen_uma_Package_PackageableElement, gen_uma_Namespace_NamedElement, gen_uma_MethodElement_PackageableElement, gen_uma_Section_VariabilityElement, gen_uma_Role_ContentElement, gen_uma_WorkProduct_ContentElement, gen_uma_Task_ContentElement, gen_uma_Task_WorkDefinition, gen_uma_ContentDescription_MethodUnit, gen_uma_WorkDefinition_MethodElement, gen_uma_Step_Section, gen_uma_Step_WorkDefinition, gen_uma_Guidance_ContentElement, gen_uma_Artifact_WorkProduct, gen_uma_Deliverable_WorkProduct, gen_uma_Outcome_WorkProduct, gen_uma_MethodPackage_MethodElement, gen_uma_MethodPackage_Package, gen_uma_ContentPackage_MethodPackage, gen_uma_DeliverableDescription_WorkProductDescription, gen_uma_RoleDescription_ContentDescription, gen_uma_TaskDescription_ContentDescription, gen_uma_GuidanceDescription_ContentDescription, gen_uma_PracticeDescription_ContentDescription, gen_uma_ArtifactDescription_WorkProductDescription, gen_uma_WorkProductDescription_ContentDescription, gen_uma_DiagramElement_MethodElement, gen_uma_DiagramLink_DiagramElement, gen_uma_GraphConnector_GraphElement, gen_uma_SemanticModelBridge_DiagramElement, gen_uma_GraphElement_DiagramElement, gen_uma_Property_DiagramElement, gen_uma_GraphEdge_GraphElement, gen_uma_Diagram_GraphNode, gen_uma_GraphNode_GraphElement, gen_uma_SimpleSemanticModelElement_SemanticModelBridge, gen_uma_UMASemanticModelBridge_SemanticModelBridge, gen_uma_CoreSemanticModelBridge_SemanticModelBridge, gen_uma_LeafElement_DiagramElement, gen_uma_TextElement_LeafElement, gen_uma_Image_LeafElement, gen_uma_GraphicPrimitive_LeafElement, gen_uma_Polyline_GraphicPrimitive, gen_uma_Reference_DiagramElement, gen_uma_Activity_WorkBreakdownElement, gen_uma_Activity_VariabilityElement, gen_uma_Activity_WorkDefinition, gen_uma_WorkBreakdownElement_BreakdownElement, gen_uma_Ellipse_GraphicPrimitive, gen_uma_Milestone_WorkBreakdownElement, gen_uma_Iteration_Activity, gen_uma_Phase_Activity, gen_uma_TeamProfile_BreakdownElement, gen_uma_RoleDescriptor_Descriptor, gen_uma_BreakdownElement_ProcessElement, gen_uma_WorkOrder_ProcessElement, gen_uma_ProcessElement_DescribableElement, gen_uma_PlanningData_ProcessElement, gen_uma_Descriptor_BreakdownElement, gen_uma_WorkProductDescriptor_Descriptor, gen_uma_CompositeRole_RoleDescriptor, gen_uma_BreakdownElementDescription_ContentDescription, gen_uma_ActivityDescription_BreakdownElementDescription, gen_uma_DeliveryProcessDescription_ProcessDescription, gen_uma_TaskDescriptor_WorkBreakdownElement, gen_uma_TaskDescriptor_Descriptor, gen_uma_ProcessDescription_ActivityDescription, gen_uma_DescriptorDescription_BreakdownElementDescription, gen_uma_Concept_Guidance, gen_uma_Checklist_Guidance, gen_uma_Example_Guidance, gen_uma_Guideline_Guidance, gen_uma_Report_Guidance, gen_uma_Template_Guidance, gen_uma_SupportingMaterial_Guidance, gen_uma_ToolMentor_Guidance, gen_uma_Whitepaper_Concept, gen_uma_TermDefinition_Guidance, gen_uma_Practice_Guidance, gen_uma_ReusableAsset_Guidance, gen_uma_State_Vertex, gen_uma_StateMachine_WorkDefinition, gen_uma_EstimationConsiderations_Guidance, gen_uma_ContentCategory_ContentElement, gen_uma_RoleSet_ContentCategory, gen_uma_Domain_ContentCategory, gen_uma_WorkProductType_ContentCategory, gen_uma_DisciplineGrouping_ContentCategory, gen_uma_Tool_ContentCategory, gen_uma_RoleSetGrouping_ContentCategory, gen_uma_CustomCategory_ContentCategory, gen_uma_PseudoState_Vertex, gen_uma_Discipline_ContentCategory, gen_uma_Process_Activity, gen_uma_CapabilityPattern_Process, gen_uma_ProcessPlanningTemplate_Process, gen_uma_Roadmap_Guidance, gen_uma_ProcessComponent_ProcessPackage, gen_uma_ProcessComponent_MethodUnit, gen_uma_ProcessPackage_MethodPackage, gen_uma_ProcessComponentInterface_BreakdownElement, gen_uma_DeliveryProcess_Process, gen_uma_VariabilityElement_MethodElement, gen_uma_MethodUnit_MethodElement, gen_uma_MethodConfiguration_MethodUnit, gen_uma_ProcessComponentDescriptor_Descriptor, gen_uma_MethodPlugin_MethodUnit, gen_uma_MethodPlugin_Package, gen_uma_ProcessFamily_MethodConfiguration, gen_uma_MethodLibrary_MethodUnit, gen_uma_MethodLibrary_Package},
    metadata=None
)
