...
class company_SalesOrder(Order):
    ...
    def __init__(self, id: int, SalesOrder: "company_Customer" = None, company_SalesOrder: "company_Company" = None, salesOrders: "company_Customer" = None):
        self.id = id
...
class company_PurchaseOrder(Order):
    ...
    def __init__(self, date: date, purchaseOrders: "company_Supplier" = None, company_PurchaseOrder: "company_Company" = None, PurchaseOrder: "company_Supplier" = None):
        self.date = date
...
class company_Supplier(Addressable):
    ...
    def __init__(self, preferred: bool, Supplier: "company_PurchaseOrder" = None, company_Supplier: "company_Company" = None, supplier: set["company_PurchaseOrder"] = None):
