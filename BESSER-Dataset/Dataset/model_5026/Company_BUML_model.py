...
# Classes
company_Addressable = Class(name="company_Addressable", is_abstract=True)
company_Company = Class(name="company_Company")
Addressable = Class(name="Addressable")
company_Category = Class(name="company_Category")
company_Order = Class(name="company_Order")
company_OrderDetail = Class(name="company_OrderDetail")
company_Product = Class(name="company_Product")
Order = Class(name="Order")
company_Supplier = Class(name="company_Supplier")
company_Customer = Class(name="company_Customer")
company_PurchaseOrder = Class(name="company_PurchaseOrder")
company_SalesOrder = Class(name="company_SalesOrder")
...
company_Addressable.attributes={company_Addressable_city, company_Addressable_name, company_Addressable_street}
...
company_Product.attributes={company_Product_name, company_Product_price, company_Product_vat, company_Product_description}
...
domain_model = DomainModel(
    name="company",
    types={company_Addressable, company_Company, Addressable, company_Category, company_Order, company_OrderDetail, company_Product, Order, company_Supplier, company_Customer, company_PurchaseOrder, company_SalesOrder, VAT},
    associations={categories0, purchaseOrders9, salesOrders10, orderDetails11, order12, product13, supplier15, suppliers1, customers3, purchaseOrders5, salesOrders7, orderDetails22, customer16, categories18, products20},
