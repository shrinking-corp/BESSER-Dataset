...
# Classes
basecs_AnnotationCS = Class(name="basecs_AnnotationCS")
AnnotationElementCS = Class(name="AnnotationElementCS")
basecs_ModelElementCS = Class(name="basecs_ModelElementCS", is_abstract=True)
basecs_ModelElementRefCS = Class(name="basecs_ModelElementRefCS")
basecs_AnnotationElementCS = Class(name="basecs_AnnotationElementCS", is_abstract=True)
NamedElementCS = Class(name="NamedElementCS")
basecs_DetailCS = Class(name="basecs_DetailCS")
basecs_AttributeCS = Class(name="basecs_AttributeCS")
StructuralFeatureCS = Class(name="StructuralFeatureCS")
basecs_ClassCS = Class(name="basecs_ClassCS")
ClassifierCS = Class(name="ClassifierCS")
NamespaceCS = Class(name="NamespaceCS")
basecs_TypedRefCS = Class(name="basecs_TypedRefCS", is_abstract=True)
basecs_OperationCS = Class(name="basecs_OperationCS")
basecs_StructuralFeatureCS = Class(name="basecs_StructuralFeatureCS", is_abstract=True)
basecs_ClassifierCS = Class(name="basecs_ClassifierCS", is_abstract=True)
TypeCS = Class(name="TypeCS")
TemplateableElementCS = Class(name="TemplateableElementCS")
basecs_PackageCS = Class(name="basecs_PackageCS")
basecs_ConstraintCS = Class(name="basecs_ConstraintCS")
basecs_SpecificationCS = Class(name="basecs_SpecificationCS")
basecs_DataTypeCS = Class(name="basecs_DataTypeCS")
basecs_EnumerationLiteralCS = Class(name="basecs_EnumerationLiteralCS")
basecs_DocumentationCS = Class(name="basecs_DocumentationCS")
basecs_ElementCS = Class(name="basecs_ElementCS", is_abstract=True)
VisitableCS = Class(name="VisitableCS")
basecs_ElementRefCS = Class(name="basecs_ElementRefCS", is_abstract=True)
PivotableElementCS = Class(name="PivotableElementCS")
basecs_EnumerationCS = Class(name="basecs_EnumerationCS")
basecs_ImportCS = Class(name="basecs_ImportCS")
basecs_PathNameCS = Class(name="basecs_PathNameCS")
basecs_Namespace = Class(name="basecs_Namespace")
basecs_LambdaTypeCS = Class(name="basecs_LambdaTypeCS")
TypedRefCS = Class(name="TypedRefCS")
Nameable = Class(name="Nameable")
basecs_LibraryCS = Class(name="basecs_LibraryCS")
ElementRefCS = Class(name="ElementRefCS")
basecs_Element = Class(name="basecs_Element")
basecs_MultiplicityBoundsCS = Class(name="basecs_MultiplicityBoundsCS")
MultiplicityCS = Class(name="MultiplicityCS")
basecs_MultiplicityCS = Class(name="basecs_MultiplicityCS", is_abstract=True)
ElementCS = Class(name="ElementCS")
basecs_MultiplicityStringCS = Class(name="basecs_MultiplicityStringCS")
basecs_NamedElementCS = Class(name="basecs_NamedElementCS", is_abstract=True)
ModelElementCS = Class(name="ModelElementCS")
basecs_NamespaceCS = Class(name="basecs_NamespaceCS", is_abstract=True)
FeatureCS = Class(name="FeatureCS")
basecs_FeatureCS = Class(name="basecs_FeatureCS", is_abstract=True)
TypedElementCS = Class(name="TypedElementCS")
basecs_ParameterCS = Class(name="basecs_ParameterCS")
PackageOwnerCS = Class(name="PackageOwnerCS")
basecs_PackageOwnerCS = Class(name="basecs_PackageOwnerCS", is_abstract=True)
basecs_PathElementCS = Class(name="basecs_PathElementCS")
Pivotable = Class(name="Pivotable")
basecs_EClassifier = Class(name="basecs_EClassifier")
basecs_PathElementWithURICS = Class(name="basecs_PathElementWithURICS")
PathElementCS = Class(name="PathElementCS")
basecs_PivotableElementCS = Class(name="basecs_PivotableElementCS", is_abstract=True)
basecs_PrimitiveTypeRefCS = Class(name="basecs_PrimitiveTypeRefCS")
basecs_ReferenceCS = Class(name="basecs_ReferenceCS")
basecs_Property = Class(name="basecs_Property")
basecs_RootCS = Class(name="basecs_RootCS", is_abstract=True)
basecs_RootPackageCS = Class(name="basecs_RootPackageCS")
RootCS = Class(name="RootCS")
basecs_TemplateBindingCS = Class(name="basecs_TemplateBindingCS")
basecs_TypedTypeRefCS = Class(name="basecs_TypedTypeRefCS")
basecs_TemplateParameterSubstitutionCS = Class(name="basecs_TemplateParameterSubstitutionCS")
basecs_TemplateParameterCS = Class(name="basecs_TemplateParameterCS", is_abstract=True)
basecs_TemplateSignatureCS = Class(name="basecs_TemplateSignatureCS")
basecs_TypeRefCS = Class(name="basecs_TypeRefCS", is_abstract=True)
basecs_TemplateableElementCS = Class(name="basecs_TemplateableElementCS", is_abstract=True)
basecs_TuplePartCS = Class(name="basecs_TuplePartCS")
basecs_TupleTypeCS = Class(name="basecs_TupleTypeCS")
basecs_TypeCS = Class(name="basecs_TypeCS", is_abstract=True)
basecs_TypeParameterCS = Class(name="basecs_TypeParameterCS")
TemplateParameterCS = Class(name="TemplateParameterCS")
basecs_TypedElementCS = Class(name="basecs_TypedElementCS", is_abstract=True)
TypeRefCS = Class(name="TypeRefCS")
basecs_Type = Class(name="basecs_Type")
basecs_VisitableCS = Class(name="basecs_VisitableCS", is_abstract=True)
basecs_WildcardTypeRefCS = Class(name="basecs_WildcardTypeRefCS")
...
basecs_ModelElementCS.attributes={basecs_ModelElementCS_originalXmiId, basecs_ModelElementCS_csi}
...
basecs_ClassifierCS.attributes={basecs_ClassifierCS_instanceClassName, basecs_ClassifierCS_qualifier}
...
basecs_PackageCS_m_getClassifier: Method = Method(name="getClassifier", parameters={Parameter(name='basecs_name', type=StringType)}, type=ClassifierCS)
...
basecs_MultiplicityBoundsCS.attributes={basecs_MultiplicityBoundsCS_upperBound, basecs_MultiplicityBoundsCS_lowerBound}
...
basecs_MultiplicityCS.methods={basecs_MultiplicityCS_m_getUpper, basecs_MultiplicityCS_m_getLower}
...
basecs_TypedElementCS.attributes={basecs_TypedElementCS_qualifier, basecs_TypedElementCS_optional}
...
domain_model = DomainModel(
    name="basecs",
    types={basecs_AnnotationCS, AnnotationElementCS, basecs_ModelElementCS, basecs_ModelElementRefCS, basecs_AnnotationElementCS, NamedElementCS, basecs_DetailCS, basecs_AttributeCS, StructuralFeatureCS, basecs_ClassCS, ClassifierCS, NamespaceCS, basecs_TypedRefCS, basecs_OperationCS, basecs_StructuralFeatureCS, basecs_ClassifierCS, TypeCS, TemplateableElementCS, basecs_PackageCS, basecs_ConstraintCS, basecs_SpecificationCS, basecs_DataTypeCS, basecs_EnumerationLiteralCS, basecs_DocumentationCS, basecs_ElementCS, VisitableCS, basecs_ElementRefCS, PivotableElementCS, basecs_EnumerationCS, basecs_ImportCS, basecs_PathNameCS, basecs_Namespace, basecs_LambdaTypeCS, TypedRefCS, Nameable, basecs_LibraryCS, ElementRefCS, basecs_Element, basecs_MultiplicityBoundsCS, MultiplicityCS, basecs_MultiplicityCS, ElementCS, basecs_MultiplicityStringCS, basecs_NamedElementCS, ModelElementCS, basecs_NamespaceCS, FeatureCS, basecs_FeatureCS, TypedElementCS, basecs_ParameterCS, PackageOwnerCS, basecs_PackageOwnerCS, basecs_PathElementCS, Pivotable, basecs_EClassifier, basecs_PathElementWithURICS, PathElementCS, basecs_PivotableElementCS, basecs_PrimitiveTypeRefCS, basecs_ReferenceCS, basecs_Property, basecs_RootCS, basecs_RootPackageCS, RootCS, basecs_TemplateBindingCS, basecs_TypedTypeRefCS, basecs_TemplateParameterSubstitutionCS, basecs_TemplateParameterCS, basecs_TemplateSignatureCS, basecs_TypeRefCS, basecs_TemplateableElementCS, basecs_TuplePartCS, basecs_TupleTypeCS, basecs_TypeCS, basecs_TypeParameterCS, TemplateParameterCS, basecs_TypedElementCS, TypeRefCS, basecs_Type, basecs_VisitableCS, basecs_WildcardTypeRefCS, IteratorKind},
    associations={ownedContent0, ownedReference1, ownedDetail3, ownedSuperType4, ownedOperation5, ownedMetaType7, owner10, ownedConstraint11, specification12, messageSpecification14, literals17, logicalParent19, ownedLiterals20, ownedProperty6, pathName22, namespace23, ownedContextType25, ownedParameterType27, ownedResultType30, package33, ownedAnnotation35, pathName38, element41, ownedParameter44, ownedException46, ownedPrecondition48, ownedPostcondition51, ownedBodyExpression54, ownedType57, ownedNestedPackage59, owner60, pathName62, element63, elementType65, owningClass43, path67, element68, context71, pivot74, opposite76, keys77, ownedImport80, ownedLibrary82, owner85, ownedDefaultExpression87, owningTemplateBindableElement89, ownedParameterSubstitution90, owningTemplateSignature91, owningTemplateBinding92, ownedActualParameter93, owningTemplateElement94, ownedTemplateParameter95, ownedTemplateSignature96, ownedParts98, ownedExtends99, ownedSuper101, ownedType104, multiplicity106, pathName108, type110, ownedTemplateBinding112, extends114, super116},
    generalizations={gen_basecs_AnnotationCS_AnnotationElementCS, gen_basecs_AnnotationElementCS_NamedElementCS, gen_basecs_AttributeCS_StructuralFeatureCS, gen_basecs_ClassCS_ClassifierCS, gen_basecs_ClassCS_NamespaceCS, gen_basecs_ClassifierCS_NamedElementCS, gen_basecs_ClassifierCS_TypeCS, gen_basecs_ClassifierCS_TemplateableElementCS, gen_basecs_ConstraintCS_NamedElementCS, gen_basecs_DataTypeCS_ClassifierCS, gen_basecs_DataTypeCS_NamespaceCS, gen_basecs_DetailCS_NamedElementCS, gen_basecs_DocumentationCS_AnnotationElementCS, gen_basecs_ElementCS_VisitableCS, gen_basecs_ElementRefCS_PivotableElementCS, gen_basecs_EnumerationCS_ClassifierCS, gen_basecs_EnumerationCS_NamespaceCS, gen_basecs_EnumerationLiteralCS_NamedElementCS, gen_basecs_FeatureCS_TypedElementCS, gen_basecs_ImportCS_NamespaceCS, gen_basecs_LambdaTypeCS_TypedRefCS, gen_basecs_LambdaTypeCS_TemplateableElementCS, gen_basecs_LambdaTypeCS_Nameable, gen_basecs_LibraryCS_NamespaceCS, gen_basecs_ModelElementCS_PivotableElementCS, gen_basecs_ModelElementRefCS_ElementRefCS, gen_basecs_MultiplicityBoundsCS_MultiplicityCS, gen_basecs_MultiplicityCS_ElementCS, gen_basecs_MultiplicityStringCS_MultiplicityCS, gen_basecs_NamedElementCS_ModelElementCS, gen_basecs_NamedElementCS_Nameable, gen_basecs_NamespaceCS_NamedElementCS, gen_basecs_OperationCS_FeatureCS, gen_basecs_OperationCS_TemplateableElementCS, gen_basecs_PackageCS_PackageOwnerCS, gen_basecs_PackageCS_NamespaceCS, gen_basecs_PackageOwnerCS_ModelElementCS, gen_basecs_ParameterCS_TypedElementCS, gen_basecs_PathElementCS_ElementCS, gen_basecs_PathElementCS_Pivotable, gen_basecs_PathElementWithURICS_PathElementCS, gen_basecs_PathNameCS_Pivotable, gen_basecs_PivotableElementCS_ElementCS, gen_basecs_PivotableElementCS_Pivotable, gen_basecs_PrimitiveTypeRefCS_TypedRefCS, gen_basecs_PrimitiveTypeRefCS_Nameable, gen_basecs_ReferenceCS_StructuralFeatureCS, gen_basecs_RootCS_ModelElementCS, gen_basecs_RootPackageCS_PackageOwnerCS, gen_basecs_RootPackageCS_RootCS, gen_basecs_SpecificationCS_ModelElementCS, gen_basecs_PathNameCS_ElementCS, gen_basecs_TemplateBindingCS_ElementRefCS, gen_basecs_TemplateParameterCS_NamedElementCS, gen_basecs_TemplateParameterSubstitutionCS_ModelElementCS, gen_basecs_TemplateSignatureCS_ModelElementCS, gen_basecs_TemplateableElementCS_ElementCS, gen_basecs_TuplePartCS_TypedElementCS, gen_basecs_TupleTypeCS_TypedRefCS, gen_basecs_TupleTypeCS_Nameable, gen_basecs_TypeCS_ModelElementCS, gen_basecs_TypeParameterCS_TemplateParameterCS, gen_basecs_TypeParameterCS_TypeCS, gen_basecs_TypeRefCS_ElementRefCS, gen_basecs_TypedElementCS_NamedElementCS, gen_basecs_StructuralFeatureCS_FeatureCS, gen_basecs_TypedRefCS_TypeRefCS, gen_basecs_TypedTypeRefCS_TypedRefCS, gen_basecs_WildcardTypeRefCS_TypeRefCS},
    metadata=None
)
