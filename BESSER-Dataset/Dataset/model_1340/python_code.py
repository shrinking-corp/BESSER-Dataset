...
class PackageOwnerCS:
    ...
    pass
class basecs_RootPackageCS(PackageOwnerCS, RootCS):
...
class Nameable:
    ...
    pass
class basecs_NamedElementCS(ModelElementCS, Nameable):
...
class TypedRefCS:
    ...
    pass
class basecs_PrimitiveTypeRefCS(TypedRefCS, Nameable):
...
class basecs_TupleTypeCS(TypedRefCS, Nameable):
...
class TemplateableElementCS:
    ...
    pass
class basecs_LambdaTypeCS(TemplateableElementCS, TypedRefCS, Nameable):
...
class TypeCS:
    ...
    pass
class basecs_TypeParameterCS(TypeCS, TemplateParameterCS):
...
class basecs_OperationCS(TemplateableElementCS, FeatureCS):
    ...
    def __init__(self, OperationCS: "basecs_ClassCS" = None, owner45: set["basecs_ParameterCS"] = None, basecs_OperationCS: set["basecs_TypedRefCS"] = None, basecs_OperationCS49: set["basecs_ConstraintCS"] = None, basecs_OperationCS52: set["basecs_ConstraintCS"] = None, basecs_OperationCS55: set["basecs_SpecificationCS"] = None, OperationCS61: "basecs_ParameterCS" = None, ownedOperation: "basecs_ClassCS" = None):
...
class NamespaceCS:
    ...
    pass
class basecs_PackageCS(NamespaceCS, PackageOwnerCS):
    ...
    def getClassifier(self, basecs_name) :
...
class ClassifierCS:
    ...
    pass
class basecs_EnumerationCS(NamespaceCS, ClassifierCS):
...
class basecs_DataTypeCS(NamespaceCS, ClassifierCS):

    pass
class basecs_ClassCS(NamespaceCS, ClassifierCS):
...
class basecs_TypedElementCS(NamedElementCS):
    ...
    def __init__(self, optional: bool, qualifier: str, basecs_TypedElementCS: "basecs_TypedRefCS" = None):
...
class basecs_TemplateParameterCS(NamedElementCS):
    ...
    pass
class basecs_ClassifierCS(TypeCS, NamedElementCS, TemplateableElementCS):

    def __init__(self, instanceClassName: str, qualifier: str, basecs_ClassifierCS: set["basecs_ConstraintCS"] = None, ownedType: "basecs_PackageCS" = None, ClassifierCS: "basecs_PackageCS" = None):
