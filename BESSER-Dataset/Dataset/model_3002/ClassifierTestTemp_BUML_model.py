...
domain_model = DomainModel(
    name="TestPackage",
    types={TestPackage_TestClass, SuperClass, UberClass, TestPackage_TestInterface, TestPackage_SubPackage_SubTestClass, TestPackage_SubPackage_SubTestInterface, TestPackage_SuperClass, TestPackage_UberClass, SubTestEnum, TestEnum},
    associations={},
