...
# Classes
amethyst_PropertyDeclaration = Class(name="amethyst_PropertyDeclaration")
amethyst_Module = Class(name="amethyst_Module")
amethyst_Import = Class(name="amethyst_Import")
amethyst_Statement = Class(name="amethyst_Statement")
amethyst_Symbol = Class(name="amethyst_Symbol")
Statement = Class(name="Statement")
amethyst_TagDeclaration = Class(name="amethyst_TagDeclaration")
amethyst_ClassType = Class(name="amethyst_ClassType")
amethyst_TagLoopExpression = Class(name="amethyst_TagLoopExpression")
amethyst_TagAttribute = Class(name="amethyst_TagAttribute")
amethyst_EObject = Class(name="amethyst_EObject")
amethyst_Expression = Class(name="amethyst_Expression")
amethyst_TagExpression = Class(name="amethyst_TagExpression")
amethyst_SymbolReference = Class(name="amethyst_SymbolReference")
Expression = Class(name="Expression")
amethyst_Literal = Class(name="amethyst_Literal")
amethyst_CharLiteral = Class(name="amethyst_CharLiteral")
Literal = Class(name="Literal")
amethyst_StringLiteral = Class(name="amethyst_StringLiteral")
amethyst_IntLiteral = Class(name="amethyst_IntLiteral")
amethyst_FloatLiteral = Class(name="amethyst_FloatLiteral")
amethyst_BooleanLiteral = Class(name="amethyst_BooleanLiteral")
amethyst_NullLiteral = Class(name="amethyst_NullLiteral")
amethyst_RangeLiteral = Class(name="amethyst_RangeLiteral")
amethyst_AbstractType = Class(name="amethyst_AbstractType")
amethyst_Type = Class(name="amethyst_Type")
AbstractType = Class(name="AbstractType")
amethyst_PrimitiveType = Class(name="amethyst_PrimitiveType")
Type = Class(name="Type")
amethyst_CharType = Class(name="amethyst_CharType")
PrimitiveType = Class(name="PrimitiveType")
amethyst_StringType = Class(name="amethyst_StringType")
amethyst_IntType = Class(name="amethyst_IntType")
amethyst_FloatType = Class(name="amethyst_FloatType")
amethyst_BooleanType = Class(name="amethyst_BooleanType")
amethyst_DefinitionType = Class(name="amethyst_DefinitionType")
amethyst_AnyType = Class(name="amethyst_AnyType")
amethyst_ArrayType = Class(name="amethyst_ArrayType")
amethyst_ClassDeclaration = Class(name="amethyst_ClassDeclaration")
amethyst_VariableDeclaration = Class(name="amethyst_VariableDeclaration")
Symbol = Class(name="Symbol")
amethyst_CaseStatement = Class(name="amethyst_CaseStatement")
amethyst_DefinitionDeclaration = Class(name="amethyst_DefinitionDeclaration")
amethyst_ParameterDeclaration = Class(name="amethyst_ParameterDeclaration")
amethyst_TagLoopInitializerDeclaration = Class(name="amethyst_TagLoopInitializerDeclaration")
amethyst_IfStatement = Class(name="amethyst_IfStatement")
amethyst_ElseIfStatement = Class(name="amethyst_ElseIfStatement")
amethyst_ElseStatement = Class(name="amethyst_ElseStatement")
amethyst_CaseElseStatement = Class(name="amethyst_CaseElseStatement")
amethyst_WhenStatement = Class(name="amethyst_WhenStatement")
amethyst_WhileStatement = Class(name="amethyst_WhileStatement")
amethyst_ForStatement = Class(name="amethyst_ForStatement")
amethyst_ForInitializerDeclaration = Class(name="amethyst_ForInitializerDeclaration")
amethyst_BreakStatement = Class(name="amethyst_BreakStatement")
amethyst_NextStatement = Class(name="amethyst_NextStatement")
amethyst_ReturnStatement = Class(name="amethyst_ReturnStatement")
amethyst_JsCodeStatement = Class(name="amethyst_JsCodeStatement")
amethyst_AssignmentExpression = Class(name="amethyst_AssignmentExpression")
amethyst_IndexAccessExpression = Class(name="amethyst_IndexAccessExpression")
amethyst_CallExpression = Class(name="amethyst_CallExpression")
amethyst_MemberAccessExpression = Class(name="amethyst_MemberAccessExpression")
amethyst_OrExpression = Class(name="amethyst_OrExpression")
amethyst_AndExpression = Class(name="amethyst_AndExpression")
amethyst_RelationalExpression = Class(name="amethyst_RelationalExpression")
amethyst_EqualityExpression = Class(name="amethyst_EqualityExpression")
amethyst_ShiftExpression = Class(name="amethyst_ShiftExpression")
amethyst_AdditiveExpression = Class(name="amethyst_AdditiveExpression")
amethyst_MultiplicativeExpression = Class(name="amethyst_MultiplicativeExpression")
amethyst_MatchingExpression = Class(name="amethyst_MatchingExpression")
amethyst_InExpression = Class(name="amethyst_InExpression")
amethyst_UnaryMinusExpression = Class(name="amethyst_UnaryMinusExpression")
amethyst_NotExpression = Class(name="amethyst_NotExpression")
amethyst_TypeCastExpression = Class(name="amethyst_TypeCastExpression")
amethyst_NewExpression = Class(name="amethyst_NewExpression")
amethyst_SuperExpression = Class(name="amethyst_SuperExpression")
amethyst_SelfExpression = Class(name="amethyst_SelfExpression")
amethyst_ParenthisedExpression = Class(name="amethyst_ParenthisedExpression")
amethyst_NumberRangeLiteral = Class(name="amethyst_NumberRangeLiteral")
RangeLiteral = Class(name="RangeLiteral")
amethyst_CharRangeLiteral = Class(name="amethyst_CharRangeLiteral")
...
domain_model = DomainModel(
    name="amethyst",
    types={amethyst_PropertyDeclaration, amethyst_Module, amethyst_Import, amethyst_Statement, amethyst_Symbol, Statement, amethyst_TagDeclaration, amethyst_ClassType, amethyst_TagLoopExpression, amethyst_TagAttribute, amethyst_EObject, amethyst_Expression, amethyst_TagExpression, amethyst_SymbolReference, Expression, amethyst_Literal, amethyst_CharLiteral, Literal, amethyst_StringLiteral, amethyst_IntLiteral, amethyst_FloatLiteral, amethyst_BooleanLiteral, amethyst_NullLiteral, amethyst_RangeLiteral, amethyst_AbstractType, amethyst_Type, AbstractType, amethyst_PrimitiveType, Type, amethyst_CharType, PrimitiveType, amethyst_StringType, amethyst_IntType, amethyst_FloatType, amethyst_BooleanType, amethyst_DefinitionType, amethyst_AnyType, amethyst_ArrayType, amethyst_ClassDeclaration, amethyst_VariableDeclaration, Symbol, amethyst_CaseStatement, amethyst_DefinitionDeclaration, amethyst_ParameterDeclaration, amethyst_TagLoopInitializerDeclaration, amethyst_IfStatement, amethyst_ElseIfStatement, amethyst_ElseStatement, amethyst_CaseElseStatement, amethyst_WhenStatement, amethyst_WhileStatement, amethyst_ForStatement, amethyst_ForInitializerDeclaration, amethyst_BreakStatement, amethyst_NextStatement, amethyst_ReturnStatement, amethyst_JsCodeStatement, amethyst_AssignmentExpression, amethyst_IndexAccessExpression, amethyst_CallExpression, amethyst_MemberAccessExpression, amethyst_OrExpression, amethyst_AndExpression, amethyst_RelationalExpression, amethyst_EqualityExpression, amethyst_ShiftExpression, amethyst_AdditiveExpression, amethyst_MultiplicativeExpression, amethyst_MatchingExpression, amethyst_InExpression, amethyst_UnaryMinusExpression, amethyst_NotExpression, amethyst_TypeCastExpression, amethyst_NewExpression, amethyst_SuperExpression, amethyst_SelfExpression, amethyst_ParenthisedExpression, amethyst_NumberRangeLiteral, RangeLiteral, amethyst_CharRangeLiteral},
    associations={imports0, declarations1, type3, loopExpression4, attributes6, children8, initializer10, iterable12, exp14, expression27, propertyRef16, expression18, symbolRef21, type23, typeRef24, type26, params30, type32, statements35, type38, superType41, methods43, properties46, tag49, type52, expression55, condition58, statements60, elseStatement63, condition66, statements68, elseStatement71, statements74, left111, value76, whenStatements78, elseStatement81, statements84, condition86, statements88, condition91, statements93, initializer96, iterable98, statements101, expression104, left106, right108, index113, left116, args118, left121, right123, left126, right128, left131, right133, left136, right138, left141, right143, left146, typeRef177, right148, left151, right153, left156, right158, left161, right163, left166, right168, expression171, expression173, expression175, type180, args182, expression185, start187, end188, start191, end192},
    generalizations={gen_amethyst_Symbol_Statement, gen_amethyst_Expression_Statement, gen_amethyst_SymbolReference_Expression, gen_amethyst_Literal_Expression, gen_amethyst_CharLiteral_Literal, gen_amethyst_StringLiteral_Literal, gen_amethyst_IntLiteral_Literal, gen_amethyst_FloatLiteral_Literal, gen_amethyst_BooleanLiteral_Literal, gen_amethyst_NullLiteral_Literal, gen_amethyst_RangeLiteral_Literal, gen_amethyst_Type_AbstractType, gen_amethyst_PrimitiveType_Type, gen_amethyst_CharType_PrimitiveType, gen_amethyst_StringType_PrimitiveType, gen_amethyst_IntType_PrimitiveType, gen_amethyst_FloatType_PrimitiveType, gen_amethyst_BooleanType_PrimitiveType, gen_amethyst_DefinitionType_PrimitiveType, gen_amethyst_AnyType_PrimitiveType, gen_amethyst_ArrayType_AbstractType, gen_amethyst_ClassType_Type, gen_amethyst_VariableDeclaration_Symbol, gen_amethyst_CaseStatement_Statement, gen_amethyst_DefinitionDeclaration_Symbol, gen_amethyst_ParameterDeclaration_Symbol, gen_amethyst_ClassDeclaration_Symbol, gen_amethyst_PropertyDeclaration_Symbol, gen_amethyst_TagLoopInitializerDeclaration_Symbol, gen_amethyst_IfStatement_Statement, gen_amethyst_ElseIfStatement_Statement, gen_amethyst_ElseStatement_Statement, gen_amethyst_CaseElseStatement_Statement, gen_amethyst_WhenStatement_Statement, gen_amethyst_WhileStatement_Statement, gen_amethyst_ForStatement_Statement, gen_amethyst_ForInitializerDeclaration_Symbol, gen_amethyst_BreakStatement_Statement, gen_amethyst_NextStatement_Statement, gen_amethyst_ReturnStatement_Statement, gen_amethyst_JsCodeStatement_Statement, gen_amethyst_AssignmentExpression_Expression, gen_amethyst_IndexAccessExpression_Expression, gen_amethyst_CallExpression_Expression, gen_amethyst_MemberAccessExpression_Expression, gen_amethyst_OrExpression_Expression, gen_amethyst_AndExpression_Expression, gen_amethyst_RelationalExpression_Expression, gen_amethyst_EqualityExpression_Expression, gen_amethyst_ShiftExpression_Expression, gen_amethyst_AdditiveExpression_Expression, gen_amethyst_MultiplicativeExpression_Expression, gen_amethyst_MatchingExpression_Expression, gen_amethyst_InExpression_Expression, gen_amethyst_UnaryMinusExpression_Expression, gen_amethyst_NotExpression_Expression, gen_amethyst_TypeCastExpression_Expression, gen_amethyst_NewExpression_Expression, gen_amethyst_SuperExpression_Expression, gen_amethyst_SelfExpression_Expression, gen_amethyst_ParenthisedExpression_Expression, gen_amethyst_NumberRangeLiteral_RangeLiteral, gen_amethyst_CharRangeLiteral_RangeLiteral},
    metadata=None
)
