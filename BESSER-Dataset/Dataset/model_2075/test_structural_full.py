...
OverlappingTree_Child_strategy = st.builds(OverlappingTree_Child)
...
OverlappingTree_NodeKind_strategy = st.builds(OverlappingTree_NodeKind)
...
OverlappingTree_Tree_strategy = st.builds(OverlappingTree_Tree)
