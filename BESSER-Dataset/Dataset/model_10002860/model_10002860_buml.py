...
Service.attributes={Service_type, Service_serviceName, Service_departureDateTime, Service_serviceId, Service_arrivalDateTime}
...
TrainStats.attributes={TrainStats_humidityAvg, TrainStats_fuelAvg, TrainStats_passengerCount, TrainStats_tempAvg, TrainStats_trainService}
...
Coach.attributes={Coach_capacity, Coach_humidity, Coach_totalPassengers, Coach_temprature, Coach_coachType}
...
Route.attributes={Route_source, Route_destination, Route_stops, Route_routeId}
...
domain_model = DomainModel(
    name="e37cd88c_19b7_4609_bc68_ce61a3a80e6e",
