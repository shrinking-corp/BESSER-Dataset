...
public class SQL2003_ROW extends ConstructedType {
    ...
    private List<SQL2003_ROW> sql2003_rows;
    ...
    public SQL2003_ROW(
        ...
        this.sql2003_rows = new ArrayList<>();
        this.sql2003_fields = new ArrayList<>();
    }

    public SQL2003_ROW(
        ArrayList<SQL2003_ROW> sql2003_rows,        ArrayList<SQL2003_Field> sql2003_fields    ) {
        this.sql2003_rows = sql2003_rows;
    ...
    public List<SQL2003_ROW> getSql2003_rows() {
        return sql2003_rows;
    }

    public void addSql2003_row(Sql2003_row sql2003_row) {
        this.sql2003_rows.add(sql2003_row);
    }
