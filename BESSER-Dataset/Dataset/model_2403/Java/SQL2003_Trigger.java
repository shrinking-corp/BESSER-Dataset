...
public class SQL2003_Trigger  {
    ...
    public SQL2003_Trigger(
        String event,        String actionTime,        String triggeredAction,        String name    ) {
        this.event = event;
    ...
    public SQL2003_Trigger(
        String event,        String actionTime,        String triggeredAction,        String name        ArrayList<SQL2003_StructuralComponent> sql2003_structuralcomponents    ) {
        this.event = event;
        this.actionTime = actionTime;
        this.triggeredAction = triggeredAction;
        this.name = name;
