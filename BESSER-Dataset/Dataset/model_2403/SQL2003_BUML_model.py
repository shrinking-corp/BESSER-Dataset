...
# Classes
SQL2003_ARRAY = Class(name="SQL2003_ARRAY")
CollectionType = Class(name="CollectionType")
SQL2003_Attribute = Class(name="SQL2003_Attribute")
StructuralComponent = Class(name="StructuralComponent")
SQL2003_StructuredType = Class(name="SQL2003_StructuredType")
SQL2003_BaseTable = Class(name="SQL2003_BaseTable")
Table = Class(name="Table")
SQL2003_BehaviouralComponent = Class(name="SQL2003_BehaviouralComponent", is_abstract=True)
SQL2003_Schema = Class(name="SQL2003_Schema")
SQL2003_ParameterWithMode = Class(name="SQL2003_ParameterWithMode")
SQL2003_BinaryStringType = Class(name="SQL2003_BinaryStringType")
PredefinedType = Class(name="PredefinedType")
SQL2003_BooleanType = Class(name="SQL2003_BooleanType")
SQL2003_DataType = Class(name="SQL2003_DataType", is_abstract=True)
SQL2003_Column = Class(name="SQL2003_Column")
SQL2003_Table = Class(name="SQL2003_Table", is_abstract=True)
SQL2003_ColumnConstraint = Class(name="SQL2003_ColumnConstraint", is_abstract=True)
Restriction = Class(name="Restriction")
SQL2003_ConstructedType = Class(name="SQL2003_ConstructedType", is_abstract=True)
DataType = Class(name="DataType")
SQL2003_DatetimeFeature = Class(name="SQL2003_DatetimeFeature")
Feature = Class(name="Feature")
SQL2003_DatetimeType = Class(name="SQL2003_DatetimeType")
SQL2003_DerivedTable = Class(name="SQL2003_DerivedTable")
SQL2003_DistinctType = Class(name="SQL2003_DistinctType")
UserDefinedType = Class(name="UserDefinedType")
SQL2003_PredefinedType = Class(name="SQL2003_PredefinedType", is_abstract=True)
SQL2003_CharacterStringType = Class(name="SQL2003_CharacterStringType")
SQL2003_CollectionType = Class(name="SQL2003_CollectionType", is_abstract=True)
ConstructedType = Class(name="ConstructedType")
SQL2003_IntervalFeature = Class(name="SQL2003_IntervalFeature")
SQL2003_IntervalType = Class(name="SQL2003_IntervalType")
SQL2003_MULTISET = Class(name="SQL2003_MULTISET")
SQL2003_Method = Class(name="SQL2003_Method")
SQL2003_Feature = Class(name="SQL2003_Feature", is_abstract=True)
SQL2003_Field = Class(name="SQL2003_Field")
SQL2003_ROW = Class(name="SQL2003_ROW")
SQL2003_Function = Class(name="SQL2003_Function")
BehaviouralComponent = Class(name="BehaviouralComponent")
SQL2003_NotNull = Class(name="SQL2003_NotNull")
ColumnConstraint = Class(name="ColumnConstraint")
SQL2003_NumericFeature = Class(name="SQL2003_NumericFeature")
SQL2003_NumericType = Class(name="SQL2003_NumericType")
SQL2003_Parameter = Class(name="SQL2003_Parameter", is_abstract=True)
SQL2003_MethodParameter = Class(name="SQL2003_MethodParameter")
Parameter_ = Class(name="Parameter")
SQL2003_PrimaryKey = Class(name="SQL2003_PrimaryKey")
UniqueConstraint = Class(name="UniqueConstraint")
SQL2003_Procedure = Class(name="SQL2003_Procedure")
SQL2003_ReferenceType = Class(name="SQL2003_ReferenceType")
SQL2003_ReferentialConstraint = Class(name="SQL2003_ReferentialConstraint")
TableConstraint = Class(name="TableConstraint")
SQL2003_UniqueConstraint = Class(name="SQL2003_UniqueConstraint")
SQL2003_Restriction = Class(name="SQL2003_Restriction", is_abstract=True)
SQL2003_StructuralComponent = Class(name="SQL2003_StructuralComponent", is_abstract=True)
SQL2003_View = Class(name="SQL2003_View")
SQL2003_TypedTable = Class(name="SQL2003_TypedTable")
SQL2003_StringFeature = Class(name="SQL2003_StringFeature")
SQL2003_TableCheckConstraint = Class(name="SQL2003_TableCheckConstraint")
SQL2003_TableConstraint = Class(name="SQL2003_TableConstraint", is_abstract=True)
BaseTable = Class(name="BaseTable")
SQL2003_UserDefinedType = Class(name="SQL2003_UserDefinedType", is_abstract=True)
SQL2003_Trigger = Class(name="SQL2003_Trigger")
DerivedTable = Class(name="DerivedTable")
SQL2003_XMLType = Class(name="SQL2003_XMLType")
...
SQL2003_BehaviouralComponent.attributes={SQL2003_BehaviouralComponent_name, SQL2003_BehaviouralComponent_body}
...
SQL2003_IntervalFeature.attributes={SQL2003_IntervalFeature_key, SQL2003_IntervalFeature_value}
...
SQL2003_ReferentialConstraint.attributes={SQL2003_ReferentialConstraint_match, SQL2003_ReferentialConstraint_delete_action, SQL2003_ReferentialConstraint_update_action}
...
SQL2003_Trigger.attributes={SQL2003_Trigger_triggeredAction, SQL2003_Trigger_name, SQL2003_Trigger_event, SQL2003_Trigger_actionTime}
...
domain_model = DomainModel(
    name="SQL2003",
    types={SQL2003_ARRAY, CollectionType, SQL2003_Attribute, StructuralComponent, SQL2003_StructuredType, SQL2003_BaseTable, Table, SQL2003_BehaviouralComponent, SQL2003_Schema, SQL2003_ParameterWithMode, SQL2003_BinaryStringType, PredefinedType, SQL2003_BooleanType, SQL2003_DataType, SQL2003_Column, SQL2003_Table, SQL2003_ColumnConstraint, Restriction, SQL2003_ConstructedType, DataType, SQL2003_DatetimeFeature, Feature, SQL2003_DatetimeType, SQL2003_DerivedTable, SQL2003_DistinctType, UserDefinedType, SQL2003_PredefinedType, SQL2003_CharacterStringType, SQL2003_CollectionType, ConstructedType, SQL2003_IntervalFeature, SQL2003_IntervalType, SQL2003_MULTISET, SQL2003_Method, SQL2003_Feature, SQL2003_Field, SQL2003_ROW, SQL2003_Function, BehaviouralComponent, SQL2003_NotNull, ColumnConstraint, SQL2003_NumericFeature, SQL2003_NumericType, SQL2003_Parameter, SQL2003_MethodParameter, Parameter_, SQL2003_PrimaryKey, UniqueConstraint, SQL2003_Procedure, SQL2003_ReferenceType, SQL2003_ReferentialConstraint, TableConstraint, SQL2003_UniqueConstraint, SQL2003_Restriction, SQL2003_StructuralComponent, SQL2003_View, SQL2003_TypedTable, SQL2003_StringFeature, SQL2003_TableCheckConstraint, SQL2003_TableConstraint, BaseTable, SQL2003_UserDefinedType, SQL2003_Trigger, DerivedTable, SQL2003_XMLType, BinaryStringTypes, BooleanTypes, DatetimeFeatures, DatetimeTypes, CharacterStringTypes, IntervalFeatures, IntervalTypes, MatchTypes, NumericRadix, NumericFeatures, NumericTypes, ParameterMode, Multiplier, ReferentialAction, StringFeatures, TriggerActionTime, TriggerEvent, Unit, XMLTypes},
    associations={structured0, schema1, parametersWithMode2, super_type4, type5, table7, schema8, source_type10, return_type13, override16, structured17, features11, row12, type24, return_type19, parameters22, method23, is_source_of27, super_type29, fields31, sub_types33, type35, references36, table37, columns39, behaviouralComponent26, type48, views50, restrictions51, features53, super_type57, attributes59, methods60, typed63, schema65, behaviouralComponents41, datatypes43, tables45, table76, updateColumns78, structured80, supertable83, subtables86, columns67, views68, triggers71, restrictions73, tables88, components90},
    generalizations={gen_SQL2003_ARRAY_CollectionType, gen_SQL2003_Attribute_StructuralComponent, gen_SQL2003_BaseTable_Table, gen_SQL2003_BinaryStringType_PredefinedType, gen_SQL2003_BooleanType_PredefinedType, gen_SQL2003_Column_StructuralComponent, gen_SQL2003_ColumnConstraint_Restriction, gen_SQL2003_ConstructedType_DataType, gen_SQL2003_DatetimeFeature_Feature, gen_SQL2003_DatetimeType_PredefinedType, gen_SQL2003_DerivedTable_Table, gen_SQL2003_DistinctType_UserDefinedType, gen_SQL2003_CharacterStringType_PredefinedType, gen_SQL2003_CollectionType_ConstructedType, gen_SQL2003_IntervalFeature_Feature, gen_SQL2003_IntervalType_PredefinedType, gen_SQL2003_MULTISET_CollectionType, gen_SQL2003_Field_StructuralComponent, gen_SQL2003_Function_BehaviouralComponent, gen_SQL2003_NotNull_ColumnConstraint, gen_SQL2003_NumericFeature_Feature, gen_SQL2003_NumericType_PredefinedType, gen_SQL2003_MethodParameter_Parameter, gen_SQL2003_PrimaryKey_UniqueConstraint, gen_SQL2003_Procedure_BehaviouralComponent, gen_SQL2003_ROW_ConstructedType, gen_SQL2003_ReferenceType_ConstructedType, gen_SQL2003_ReferentialConstraint_TableConstraint, gen_SQL2003_ParameterWithMode_Parameter, gen_SQL2003_PredefinedType_DataType, gen_SQL2003_StringFeature_Feature, gen_SQL2003_StructuredType_UserDefinedType, gen_SQL2003_TableCheckConstraint_TableConstraint, gen_SQL2003_TableConstraint_Restriction, gen_SQL2003_TypedTable_BaseTable, gen_SQL2003_UniqueConstraint_TableConstraint, gen_SQL2003_UserDefinedType_DataType, gen_SQL2003_View_DerivedTable, gen_SQL2003_XMLType_PredefinedType},
    metadata=None
)
