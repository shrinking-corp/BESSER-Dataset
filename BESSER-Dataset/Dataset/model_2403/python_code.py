...
class SQL2003_Trigger:
    ...
    def __init__(self, name: str, event: str, actionTime: str, triggeredAction: str, triggers: "SQL2003_Table" = None, SQL2003_Trigger: set["SQL2003_StructuralComponent"] = None, Trigger: "SQL2003_Table" = None):
        self.name = name
        self.event = event
...
class SQL2003_Method:
    ...
    def __init__(self, name: str, body: str, Method: "SQL2003_MethodParameter" = None, SQL2003_Method: "SQL2003_Method" = None, SQL2003_Method15: "SQL2003_Method" = None, methods: "SQL2003_StructuredType" = None, SQL2003_Method20: "SQL2003_DataType" = None, method: set["SQL2003_MethodParameter"] = None, Method62: "SQL2003_StructuredType" = None):
        self.name = name
        self.body = body
        self.Method = Method
...
class SQL2003_Table(ABC):
    ...
    def __init__(self, name: str, Table: "SQL2003_Column" = None, Table38: "SQL2003_Restriction" = None, tables: "SQL2003_Schema" = None, Table47: "SQL2003_Schema" = None, Table77: "SQL2003_Trigger" = None, table: set["SQL2003_Column"] = None, tables69: set["SQL2003_View"] = None, table72: set["SQL2003_Trigger"] = None, table74: set["SQL2003_Restriction"] = None, Table89: "SQL2003_View" = None):
        self.name = name
        self.Table = Table
...
class SQL2003_Schema:
    ...
    def __init__(self, name: str, Schema: "SQL2003_BehaviouralComponent" = None, Schema9: "SQL2003_DataType" = None, Schema66: "SQL2003_Table" = None, schema: set["SQL2003_BehaviouralComponent"] = None, schema44: set["SQL2003_DataType"] = None, schema46: set["SQL2003_Table"] = None):
        self.name = name
        self.Schema = Schema
