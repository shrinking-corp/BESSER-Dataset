...
def test_hyp_listaencadeada_is_not_abstract():
    assert not inspect.isabstract(ListaEncadeada)


def test_hyp_listaencadeada_constructor_exists():
    assert callable(ListaEncadeada.__init__)


def test_hyp_listaencadeada_constructor_args():
    sig = inspect.signature(ListaEncadeada.__init__)
    params = list(sig.parameters.keys())
...
ListaEncadeada_strategy = st.builds(
    ListaEncadeada,
    attribute=
        safe_text
)
...
def test_hyp_listaencadeada_attribute_setter(instance):
...
def test_ListaEncadeada_attribute_value_roundtrip():
    instance = ListaEncadeada(attribute="sample_text")
...
def test_assoc_User_Group_link_reassign_clear():
    a = ListaEncadeada(attribute="sample_text")
    b1 = Group()
    b2 = Group()
...
ListaEncadeada_strategy = st.builds(ListaEncadeada, attribute=safe_text)
@given(instance=ListaEncadeada_strategy)
@settings(max_examples=25)
