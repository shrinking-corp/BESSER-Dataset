...
# Classes
ListaEncadeada = Class(name="ListaEncadeada")
...
# ListaEncadeada class attributes and methods
ListaEncadeada_attribute: Property = Property(name="attribute", type=StringType)
ListaEncadeada.attributes={ListaEncadeada_attribute}
...
User_Myprofile: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="user1", type=ListaEncadeada, multiplicity=Multiplicity(1, 1))
    }
)
User_Post: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="user3", type=ListaEncadeada, multiplicity=Multiplicity(1, 1))
    }
)
User_Login: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="user5", type=ListaEncadeada, multiplicity=Multiplicity(1, 1))
    }
)
User_Group: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="user7", type=ListaEncadeada, multiplicity=Multiplicity(1, 1))
    }
)
User_Message: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="user9", type=ListaEncadeada, multiplicity=Multiplicity(1, 1))
    }
)

# Domain Model
domain_model = DomainModel(
    name="_6a0cb62b_9058_444e_a02c_d6a264c9a166",
    types={ListaEncadeada, Friend, Login, Profile, Post, Group, Message},
