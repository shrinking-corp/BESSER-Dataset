...
def test_listaencadeada_is_not_abstract():
    assert not inspect.isabstract(ListaEncadeada)


def test_listaencadeada_constructor_exists():
    assert callable(ListaEncadeada.__init__)


def test_listaencadeada_constructor_args():
    sig = inspect.signature(ListaEncadeada.__init__)
    params = list(sig.parameters.keys())
    assert "attribute" in params, "Missing parameter 'attribute'"

def test_listaencadeada_has_attribute():
    assert hasattr(ListaEncadeada, "attribute")
    descriptor = None
    for klass in ListaEncadeada.__mro__:
...
@given(instance=ListaEncadeada_strategy)
def test_listaencadeada_attribute_setter(instance):
