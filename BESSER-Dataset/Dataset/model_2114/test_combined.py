...
def test_hyp_securitytest_webcomponent_is_not_abstract():
    assert not inspect.isabstract(securityTest_WebComponent)


def test_hyp_securitytest_webcomponent_constructor_exists():
    assert callable(securityTest_WebComponent.__init__)


def test_hyp_securitytest_webcomponent_constructor_args():
...
def test_hyp_securitytest_authsetting_is_not_abstract():
    assert not inspect.isabstract(securityTest_AuthSetting)


def test_hyp_securitytest_authsetting_constructor_exists():
    assert callable(securityTest_AuthSetting.__init__)


def test_hyp_securitytest_authsetting_constructor_args():
...
def test_hyp_securitytest_note_is_not_abstract():
    assert not inspect.isabstract(securityTest_Note)


def test_hyp_securitytest_note_constructor_exists():
    assert callable(securityTest_Note.__init__)


def test_hyp_securitytest_note_constructor_args():
...
def test_hyp_securitytest_attack_is_not_abstract():
    assert not inspect.isabstract(securityTest_Attack)


def test_hyp_securitytest_attack_constructor_exists():
    assert callable(securityTest_Attack.__init__)


def test_hyp_securitytest_attack_constructor_args():
...
def test_hyp_securitytest_targetofevaluation_is_not_abstract():
    assert not inspect.isabstract(securityTest_TargetOfEvaluation)


def test_hyp_securitytest_targetofevaluation_constructor_exists():
    assert callable(securityTest_TargetOfEvaluation.__init__)


def test_hyp_securitytest_targetofevaluation_constructor_args():
...
def test_hyp_securitytest_input_is_not_abstract():
    assert not inspect.isabstract(securityTest_Input)


def test_hyp_securitytest_input_constructor_exists():
    assert callable(securityTest_Input.__init__)


def test_hyp_securitytest_input_constructor_args():
...
def test_hyp_securitytest_test_is_not_abstract():
    assert not inspect.isabstract(securityTest_Test)


def test_hyp_securitytest_test_constructor_exists():
    assert callable(securityTest_Test.__init__)


def test_hyp_securitytest_test_constructor_args():
...
def test_hyp_eseverity_exists():
    # Check that the Enumeration exists
    assert ESeverity is not None

def test_hyp_eseverity_has_all_literals():
...
def test_hyp_eattackmethod_exists():
    # Check that the Enumeration exists
    assert EAttackMethod is not None

def test_hyp_eattackmethod_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_securitytest_webcomponent_path_setter(instance):
...
def test_hyp_securitytest_authsetting_loginTargetURL_setter(instance):
...
@given(instance=securityTest_AuthSetting_strategy)
def test_hyp_securitytest_authsetting_loginMessagePattern_setter(instance):
...
@given(instance=securityTest_AuthSetting_strategy)
def test_hyp_securitytest_authsetting_passwordParam_setter(instance):
...
@given(instance=securityTest_AuthSetting_strategy)
def test_hyp_securitytest_authsetting_roles_setter(instance):
...
@given(instance=securityTest_AuthSetting_strategy)
def test_hyp_securitytest_authsetting_usernameParam_setter(instance):
...
@given(instance=securityTest_AuthSetting_strategy)
def test_hyp_securitytest_authsetting_logoutMessagePattern_setter(instance):
...
def test_hyp_securitytest_note_noteText_setter(instance):
...
def test_hyp_securitytest_attack_severity_setter(instance):
...
@given(instance=securityTest_Attack_strategy)
def test_hyp_securitytest_attack_name_setter(instance):
...
def test_hyp_securitytest_targetofevaluation_ip_setter(instance):
...
@given(instance=securityTest_TargetOfEvaluation_strategy)
def test_hyp_securitytest_targetofevaluation_protocol_setter(instance):
...
@given(instance=securityTest_TargetOfEvaluation_strategy)
def test_hyp_securitytest_targetofevaluation_domain_setter(instance):
...
@given(instance=securityTest_TargetOfEvaluation_strategy)
def test_hyp_securitytest_targetofevaluation_port_setter(instance):
...
def test_hyp_securitytest_input_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_securitytest_test_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=securityTest_Test_strategy)
def test_hyp_securitytest_test_id_setter(instance):
...
@given(instance=securityTest_Test_strategy)
def test_hyp_securitytest_test_date_setter(instance):
...
@given(instance=securityTest_Test_strategy)
def test_hyp_securitytest_test_severity_setter(instance):
    original = instance.severity
    instance.severity = original
    assert instance.severity == original
