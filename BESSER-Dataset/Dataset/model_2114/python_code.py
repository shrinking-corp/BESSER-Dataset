...
class securityTest_WebComponent:
    ...
    def __init__(self, path: str, securityTest_WebComponent11: "securityTest_WebComponent" = None, securityTest_WebComponent9: set["securityTest_WebComponent"] = None, securityTest_WebComponent13: set["securityTest_Input"] = None, securityTest_WebComponent: "securityTest_TargetOfEvaluation" = None):
        self.path = path
...
class securityTest_Attack:
    ...
    def __init__(self, name: str, severity: str, securityTest_Attack16: "securityTest_Input" = None, securityTest_Attack: "securityTest_Test" = None):
        self.name = name
...
class securityTest_Test:
    ...
    def __init__(self, id: str, date: date, name: str, severity: str, securityTest_Test: "securityTest_TargetOfEvaluation" = None, securityTest_Test2: set["securityTest_Attack"] = None, securityTest_Test4: "securityTest_Note" = None, securityTest_Test6: "securityTest_AuthSetting" = None):
        self.id = id
        self.date = date
        self.name = name
        self.severity = severity
