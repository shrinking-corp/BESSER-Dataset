...
# Classes
securityTest_Test = Class(name="securityTest_Test")
securityTest_Input = Class(name="securityTest_Input")
securityTest_TargetOfEvaluation = Class(name="securityTest_TargetOfEvaluation")
securityTest_Attack = Class(name="securityTest_Attack")
securityTest_Note = Class(name="securityTest_Note")
securityTest_AuthSetting = Class(name="securityTest_AuthSetting")
securityTest_WebComponent = Class(name="securityTest_WebComponent")
...
securityTest_Test.attributes={securityTest_Test_id, securityTest_Test_date, securityTest_Test_name, securityTest_Test_severity}
...
securityTest_TargetOfEvaluation.attributes={securityTest_TargetOfEvaluation_domain, securityTest_TargetOfEvaluation_protocol, securityTest_TargetOfEvaluation_port, securityTest_TargetOfEvaluation_ip}
...
securityTest_Attack.attributes={securityTest_Attack_severity, securityTest_Attack_name}
...
securityTest_AuthSetting.attributes={securityTest_AuthSetting_usernameParam, securityTest_AuthSetting_passwordParam, securityTest_AuthSetting_roles, securityTest_AuthSetting_logoutMessagePattern, securityTest_AuthSetting_loginMessagePattern, securityTest_AuthSetting_loginTargetURL}
...
domain_model = DomainModel(
    name="securityTest",
    types={securityTest_Test, securityTest_Input, securityTest_TargetOfEvaluation, securityTest_Attack, securityTest_Note, securityTest_AuthSetting, securityTest_WebComponent, ESeverity, EAttackMethod},
    associations={targetLinks10, inputs12, attacks14, scope0, possibleAttacks1, note3, authSetting5, components7},
    generalizations={},
    metadata=None
)
