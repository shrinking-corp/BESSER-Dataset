...
class simplerdbms_Key(RModelElement):
    ...
    def __init__(self, isPrimary: bool, Key: "simplerdbms_Column" = None, simplerdbms_Key: "simplerdbms_ForeignKey" = None, Key22: "simplerdbms_Table" = None, keys: "simplerdbms_Table" = None, keys13: set["simplerdbms_Column"] = None):
