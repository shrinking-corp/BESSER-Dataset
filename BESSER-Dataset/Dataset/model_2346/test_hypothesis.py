...
def test_simplerdbms_key_has_isPrimary():
    assert hasattr(simplerdbms_Key, "isPrimary")
    descriptor = None
    for klass in simplerdbms_Key.__mro__:
...
@given(instance=simplerdbms_Key_strategy)
def test_simplerdbms_key_isPrimary_setter(instance):
