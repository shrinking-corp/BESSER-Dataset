...
# Classes
SMTlib2extended_Instance = Class(name="SMTlib2extended_Instance")
NamedElement = Class(name="NamedElement")
SMTlib2extended_Predicate = Class(name="SMTlib2extended_Predicate")
Variable = Class(name="Variable")
SMTlib2extended_Bitvector = Class(name="SMTlib2extended_Bitvector")
SMTlib2extended_VariableExpression = Class(name="SMTlib2extended_VariableExpression")
Expression = Class(name="Expression")
SMTlib2extended_ConstExpression = Class(name="SMTlib2extended_ConstExpression", is_abstract=True)
SMTlib2extended_ConstBooleanExpression = Class(name="SMTlib2extended_ConstBooleanExpression")
ConstExpression = Class(name="ConstExpression")
SMTlib2extended_ConstIntegerExpression = Class(name="SMTlib2extended_ConstIntegerExpression")
SMTlib2extended_BitstringExpression = Class(name="SMTlib2extended_BitstringExpression")
SMTlib2extended_NAryExpression = Class(name="SMTlib2extended_NAryExpression")
SMTlib2extended_AndExpression = Class(name="SMTlib2extended_AndExpression")
NAryExpression = Class(name="NAryExpression")
SMTlib2extended_OrExpression = Class(name="SMTlib2extended_OrExpression")
SMTlib2extended_ConcatExpression = Class(name="SMTlib2extended_ConcatExpression")
SMTlib2extended_Variable = Class(name="SMTlib2extended_Variable")
SMTlib2extended_Expression = Class(name="SMTlib2extended_Expression")
SMTlib2extended_NamedElement = Class(name="SMTlib2extended_NamedElement")
SMTlib2extended_MulExpression = Class(name="SMTlib2extended_MulExpression")
SMTlib2extended_ModExpression = Class(name="SMTlib2extended_ModExpression")
SMTlib2extended_EqualsExpression = Class(name="SMTlib2extended_EqualsExpression")
SMTlib2extended_GreaterExpression = Class(name="SMTlib2extended_GreaterExpression")
SMTlib2extended_GreaterEqualsExpression = Class(name="SMTlib2extended_GreaterEqualsExpression")
SMTlib2extended_ImpliesExpression = Class(name="SMTlib2extended_ImpliesExpression")
SMTlib2extended_LessExpression = Class(name="SMTlib2extended_LessExpression")
SMTlib2extended_LessEqualsExpression = Class(name="SMTlib2extended_LessEqualsExpression")
SMTlib2extended_NandExpression = Class(name="SMTlib2extended_NandExpression")
SMTlib2extended_UnaryExpression = Class(name="SMTlib2extended_UnaryExpression")
SMTlib2extended_NotExpression = Class(name="SMTlib2extended_NotExpression")
UnaryExpression = Class(name="UnaryExpression")
SMTlib2extended_OneHotExpression = Class(name="SMTlib2extended_OneHotExpression")
SMTlib2extended_ExtractIndexExpression = Class(name="SMTlib2extended_ExtractIndexExpression")
SMTlib2extended_BvNotExpression = Class(name="SMTlib2extended_BvNotExpression")
SMTlib2extended_BvOrExpression = Class(name="SMTlib2extended_BvOrExpression")
SMTlib2extended_BvAndExpression = Class(name="SMTlib2extended_BvAndExpression")
SMTlib2extended_BvXorExpression = Class(name="SMTlib2extended_BvXorExpression")
SMTlib2extended_IteExpression = Class(name="SMTlib2extended_IteExpression")
SMTlib2extended_BinaryExpression = Class(name="SMTlib2extended_BinaryExpression")
SMTlib2extended_CardExpression = Class(name="SMTlib2extended_CardExpression")
SMTlib2extended_AddExpression = Class(name="SMTlib2extended_AddExpression")
BinaryExpression = Class(name="BinaryExpression")
SMTlib2extended_DivExpression = Class(name="SMTlib2extended_DivExpression")
SMTlib2extended_SubExpression = Class(name="SMTlib2extended_SubExpression")
SMTlib2extended_CardEqExpression = Class(name="SMTlib2extended_CardEqExpression")
CardExpression = Class(name="CardExpression")
SMTlib2extended_CardGeExpression = Class(name="SMTlib2extended_CardGeExpression")
SMTlib2extended_CardGtExpression = Class(name="SMTlib2extended_CardGtExpression")
SMTlib2extended_CardLeExpression = Class(name="SMTlib2extended_CardLeExpression")
SMTlib2extended_CardLtExpression = Class(name="SMTlib2extended_CardLtExpression")
...
SMTlib2extended_ConstIntegerExpression.attributes={SMTlib2extended_ConstIntegerExpression_width, SMTlib2extended_ConstIntegerExpression_value}
...
SMTlib2extended_ExtractIndexExpression.attributes={SMTlib2extended_ExtractIndexExpression_start, SMTlib2extended_ExtractIndexExpression_end}
...
domain_model = DomainModel(
    ...
    types={SMTlib2extended_Instance, NamedElement, SMTlib2extended_Predicate, Variable, SMTlib2extended_Bitvector, SMTlib2extended_VariableExpression, Expression, SMTlib2extended_ConstExpression, SMTlib2extended_ConstBooleanExpression, ConstExpression, SMTlib2extended_ConstIntegerExpression, SMTlib2extended_BitstringExpression, SMTlib2extended_NAryExpression, SMTlib2extended_AndExpression, NAryExpression, SMTlib2extended_OrExpression, SMTlib2extended_ConcatExpression, SMTlib2extended_Variable, SMTlib2extended_Expression, SMTlib2extended_NamedElement, SMTlib2extended_MulExpression, SMTlib2extended_ModExpression, SMTlib2extended_EqualsExpression, SMTlib2extended_GreaterExpression, SMTlib2extended_GreaterEqualsExpression, SMTlib2extended_ImpliesExpression, SMTlib2extended_LessExpression, SMTlib2extended_LessEqualsExpression, SMTlib2extended_NandExpression, SMTlib2extended_UnaryExpression, SMTlib2extended_NotExpression, UnaryExpression, SMTlib2extended_OneHotExpression, SMTlib2extended_ExtractIndexExpression, SMTlib2extended_BvNotExpression, SMTlib2extended_BvOrExpression, SMTlib2extended_BvAndExpression, SMTlib2extended_BvXorExpression, SMTlib2extended_IteExpression, SMTlib2extended_BinaryExpression, SMTlib2extended_CardExpression, SMTlib2extended_AddExpression, BinaryExpression, SMTlib2extended_DivExpression, SMTlib2extended_SubExpression, SMTlib2extended_CardEqExpression, CardExpression, SMTlib2extended_CardGeExpression, SMTlib2extended_CardGtExpression, SMTlib2extended_CardLeExpression, SMTlib2extended_CardLtExpression},
    associations={variable3, expressions5, variables0, assertions1, expr12, condition14, thenexpr16, elseexpr19, lhs7, rhs9, expressions22},
    generalizations={gen_SMTlib2extended_Variable_NamedElement, gen_SMTlib2extended_Predicate_Variable, gen_SMTlib2extended_Bitvector_Variable, gen_SMTlib2extended_Expression_NamedElement, gen_SMTlib2extended_VariableExpression_Expression, gen_SMTlib2extended_ConstExpression_Expression, gen_SMTlib2extended_ConstBooleanExpression_ConstExpression, gen_SMTlib2extended_ConstIntegerExpression_ConstExpression, gen_SMTlib2extended_BitstringExpression_ConstExpression, gen_SMTlib2extended_NAryExpression_Expression, gen_SMTlib2extended_AndExpression_NAryExpression, gen_SMTlib2extended_OrExpression_NAryExpression, gen_SMTlib2extended_ConcatExpression_NAryExpression, gen_SMTlib2extended_MulExpression_BinaryExpression, gen_SMTlib2extended_ModExpression_BinaryExpression, gen_SMTlib2extended_EqualsExpression_BinaryExpression, gen_SMTlib2extended_GreaterExpression_BinaryExpression, gen_SMTlib2extended_GreaterEqualsExpression_BinaryExpression, gen_SMTlib2extended_ImpliesExpression_BinaryExpression, gen_SMTlib2extended_LessExpression_BinaryExpression, gen_SMTlib2extended_LessEqualsExpression_BinaryExpression, gen_SMTlib2extended_NandExpression_BinaryExpression, gen_SMTlib2extended_UnaryExpression_Expression, gen_SMTlib2extended_NotExpression_UnaryExpression, gen_SMTlib2extended_OneHotExpression_UnaryExpression, gen_SMTlib2extended_ExtractIndexExpression_UnaryExpression, gen_SMTlib2extended_BvNotExpression_UnaryExpression, gen_SMTlib2extended_BvOrExpression_BinaryExpression, gen_SMTlib2extended_BvAndExpression_BinaryExpression, gen_SMTlib2extended_BvXorExpression_BinaryExpression, gen_SMTlib2extended_IteExpression_Expression, gen_SMTlib2extended_BinaryExpression_Expression, gen_SMTlib2extended_CardExpression_Expression, gen_SMTlib2extended_AddExpression_BinaryExpression, gen_SMTlib2extended_DivExpression_BinaryExpression, gen_SMTlib2extended_SubExpression_BinaryExpression, gen_SMTlib2extended_CardEqExpression_CardExpression, gen_SMTlib2extended_CardGeExpression_CardExpression, gen_SMTlib2extended_CardGtExpression_CardExpression, gen_SMTlib2extended_CardLeExpression_CardExpression, gen_SMTlib2extended_CardLtExpression_CardExpression},
    metadata=None
)
