...
class tutorial_Library:
    ...
    def __init__(self, name: str, tutorial_Library: set["tutorial_Loan"] = None, library3: set["tutorial_Member"] = None, Library: "tutorial_Book" = None, Library8: "tutorial_Member" = None, library: set["tutorial_Book"] = None):
        self.name = name
