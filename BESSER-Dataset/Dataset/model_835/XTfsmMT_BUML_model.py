...
tfsm_TFSM.methods={tfsm_TFSM_m_initialize, tfsm_TFSM_m_changeCurrentState}
...
domain_model = DomainModel(
    ...
    generalizations={gen_tfsm_TFSM_NamedElement, gen_tfsm_Transition_NamedElement, gen_tfsm_Guard_NamedElement, gen_tfsm_TemporalGuard_Guard, gen_tfsm_EventGuard_Guard, gen_tfsm_FSMEvent_NamedElement, gen_tfsm_State_NamedElement, gen_tfsm_TimedSystem_NamedElement, gen_tfsm_EvaluateGuard_Guard, gen_tfsm_FSMClock_NamedElement},
    metadata=None
)
