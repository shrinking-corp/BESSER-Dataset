...
class errorstm_AbstractState(ABC):
    ...
    def __init__(self, name: str, AbstractState: "errorstm_Transition" = None, AbstractState2: "errorstm_Transition" = None, to: set["errorstm_Transition"] = None, from_: set["errorstm_Transition"] = None, errorstm_AbstractState: set["errorstm_Action"] = None, errorstm_AbstractState8: "errorstm_CompositeState" = None):
        self.name = name
    ...
    def from_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_errorstm_AbstractState__from_", None)
...
class errorstm_Transition:
    ...
    def __init__(self, event: str, guard: str, name: str, errorstm_Transition: "errorstm_CompositeState" = None, outgoing: "errorstm_AbstractState" = None, incoming: "errorstm_AbstractState" = None, Transition: "errorstm_AbstractState" = None, Transition5: "errorstm_AbstractState" = None):
        self.event = event
        self.guard = guard
        self.name = name
