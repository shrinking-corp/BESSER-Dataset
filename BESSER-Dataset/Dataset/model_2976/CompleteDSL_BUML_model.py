...
# Classes
CompleteDSLPckg_StringLit = Class(name="CompleteDSLPckg_StringLit")
CompleteDSLPckg_BoolLit = Class(name="CompleteDSLPckg_BoolLit")
CompleteDSLPckg_ArithmeticExpression = Class(name="CompleteDSLPckg_ArithmeticExpression")
CompleteDSLPckg_RelationalExpression = Class(name="CompleteDSLPckg_RelationalExpression")
CompleteDSLPckg_Expression = Class(name="CompleteDSLPckg_Expression", is_abstract=True)
CompleteDSLPckg_Literal = Class(name="CompleteDSLPckg_Literal", is_abstract=True)
Expression = Class(name="Expression")
CompleteDSLPckg_IntegerLit = Class(name="CompleteDSLPckg_IntegerLit")
Literal = Class(name="Literal")
CompleteDSLPckg_Assignation = Class(name="CompleteDSLPckg_Assignation")
CompleteDSLPckg_ConsoleOutput = Class(name="CompleteDSLPckg_ConsoleOutput")
CompleteDSLPckg_Println = Class(name="CompleteDSLPckg_Println")
ConsoleOutput = Class(name="ConsoleOutput")
CompleteDSLPckg_Print = Class(name="CompleteDSLPckg_Print")
CompleteDSLPckg_Wait = Class(name="CompleteDSLPckg_Wait")
CompleteDSLPckg_VarRef = Class(name="CompleteDSLPckg_VarRef")
CompleteDSLPckg_Block = Class(name="CompleteDSLPckg_Block")
CompleteDSLPckg_Statement = Class(name="CompleteDSLPckg_Statement", is_abstract=True)
CompleteDSLPckg_Conditional = Class(name="CompleteDSLPckg_Conditional")
Statement = Class(name="Statement")
CompleteDSLPckg_Loop = Class(name="CompleteDSLPckg_Loop")
CompleteDSLPckg_VarDecl = Class(name="CompleteDSLPckg_VarDecl")
CompleteDSLPckg_Trigger = Class(name="CompleteDSLPckg_Trigger")
CompleteDSLPckg_Pseudostate = Class(name="CompleteDSLPckg_Pseudostate", is_abstract=True)
CompleteDSLPckg_InitialState = Class(name="CompleteDSLPckg_InitialState")
...
CompleteDSLPckg_AbstractState = Class(name="CompleteDSLPckg_AbstractState", is_abstract=True)
...
CompleteDSLPckg_NamedElement = Class(name="CompleteDSLPckg_NamedElement")
CompleteDSLPckg_NotTrigger = Class(name="CompleteDSLPckg_NotTrigger")
Trigger = Class(name="Trigger")
CompleteDSLPckg_AndTrigger = Class(name="CompleteDSLPckg_AndTrigger")
CompleteDSLPckg_OrTrigger = Class(name="CompleteDSLPckg_OrTrigger")
...
domain_model = DomainModel(
    ...
    types={CompleteDSLPckg_StringLit, CompleteDSLPckg_BoolLit, CompleteDSLPckg_ArithmeticExpression, CompleteDSLPckg_RelationalExpression, CompleteDSLPckg_Expression, CompleteDSLPckg_Literal, Expression, CompleteDSLPckg_IntegerLit, Literal, CompleteDSLPckg_Assignation, CompleteDSLPckg_ConsoleOutput, CompleteDSLPckg_Println, ConsoleOutput, CompleteDSLPckg_Print, CompleteDSLPckg_Wait, CompleteDSLPckg_VarRef, CompleteDSLPckg_Block, CompleteDSLPckg_Statement, CompleteDSLPckg_Conditional, Statement, CompleteDSLPckg_Loop, CompleteDSLPckg_VarDecl, CompleteDSLPckg_Trigger, CompleteDSLPckg_Pseudostate, CompleteDSLPckg_InitialState, Pseudostate, CompleteDSLPckg_FinalState, State, CompleteDSLPckg_StateMachine, NamedElement, CompleteDSLPckg_Region, CompleteDSLPckg_AbstractState, CompleteDSLPckg_Transition, CompleteDSLPckg_State, AbstractState, CompleteDSLPckg_NamedElement, CompleteDSLPckg_NotTrigger, Trigger, CompleteDSLPckg_AndTrigger, CompleteDSLPckg_OrTrigger, ArithmeticOperator, RelationalOperator},
    associations={left0, right1, left4, right6, expr20, varRef22, expression24, statements9, condition10, body12, guard15, body17, entryAction44, doAction46, exitAction49, trigger52, target54, source57, regions27, subvertex28, transitions30, ownerStateMachine32, incoming35, outgoing38, ownerRegion41, trigger60, left62, right64, left67, right69},
    generalizations={gen_CompleteDSLPckg_StringLit_Literal, gen_CompleteDSLPckg_BoolLit_Literal, gen_CompleteDSLPckg_ArithmeticExpression_Expression, gen_CompleteDSLPckg_RelationalExpression_Expression, gen_CompleteDSLPckg_Literal_Expression, gen_CompleteDSLPckg_IntegerLit_Literal, gen_CompleteDSLPckg_Assignation_Statement, gen_CompleteDSLPckg_ConsoleOutput_Statement, gen_CompleteDSLPckg_Println_ConsoleOutput, gen_CompleteDSLPckg_Print_ConsoleOutput, gen_CompleteDSLPckg_Wait_Statement, gen_CompleteDSLPckg_VarRef_Expression, gen_CompleteDSLPckg_Conditional_Statement, gen_CompleteDSLPckg_Loop_Statement, gen_CompleteDSLPckg_VarDecl_Statement, gen_CompleteDSLPckg_Transition_NamedElement, gen_CompleteDSLPckg_Pseudostate_AbstractState, gen_CompleteDSLPckg_InitialState_Pseudostate, gen_CompleteDSLPckg_FinalState_State, gen_CompleteDSLPckg_StateMachine_NamedElement, gen_CompleteDSLPckg_Region_NamedElement, gen_CompleteDSLPckg_AbstractState_NamedElement, gen_CompleteDSLPckg_State_AbstractState, gen_CompleteDSLPckg_NotTrigger_Trigger, gen_CompleteDSLPckg_AndTrigger_Trigger, gen_CompleteDSLPckg_OrTrigger_Trigger},
    metadata=None
)
