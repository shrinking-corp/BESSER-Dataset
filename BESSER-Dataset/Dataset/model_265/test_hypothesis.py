...
def test_ecore_eclassifier_has_classifierID():
    assert hasattr(ecore_EClassifier, "classifierID")
    descriptor = None
    for klass in ecore_EClassifier.__mro__:
        if "classifierID" in klass.__dict__:
            descriptor = klass.__dict__["classifierID"]
            break
    assert isinstance(descriptor, property)
...
def test_ecore_eoperation_has_operationID():
    assert hasattr(ecore_EOperation, "operationID")
    descriptor = None
    for klass in ecore_EOperation.__mro__:
...
def test_ecore_estructuralfeature_has_featureID():
    assert hasattr(ecore_EStructuralFeature, "featureID")
    descriptor = None
    for klass in ecore_EStructuralFeature.__mro__:
...
@given(instance=ecore_EClassifier_strategy)
def test_ecore_eclassifier_classifierID_setter(instance):
...
@given(instance=ecore_EOperation_strategy)
def test_ecore_eoperation_operationID_setter(instance):
...
@given(instance=ecore_EStructuralFeature_strategy)
def test_ecore_estructuralfeature_featureID_setter(instance):
