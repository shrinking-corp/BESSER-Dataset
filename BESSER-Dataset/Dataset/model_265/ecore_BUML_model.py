...
ecore_EObject.methods={ecore_EObject_m_eContainer, ecore_EObject_m_eContainingFeature, ecore_EObject_m_eAllContents, ecore_EObject_m_eIsSet, ecore_EObject_m_eUnset, ecore_EObject_m_eResource, ecore_EObject_m_eContents, ecore_EObject_m_eClass, ecore_EObject_m_eCrossReferences, ecore_EObject_m_eSet, ecore_EObject_m_eGet, ecore_EObject_m_eGet, ecore_EObject_m_eIsProxy, ecore_EObject_m_eInvoke, ecore_EObject_m_eContainmentFeature}
...
ecore_EClass_m_getFeatureType: Method = Method(name="getFeatureType", parameters={Parameter(name='ecore_feature', type=StringType)}, type=EClassifier)
ecore_EClass.attributes={ecore_EClass_abstract, ecore_EClass_interface}
ecore_EClass.methods={ecore_EClass_m_getOperationID, ecore_EClass_m_getEStructuralFeature, ecore_EClass_m_getOverride, ecore_EClass_m_getFeatureType, ecore_EClass_m_getFeatureCount, ecore_EClass_m_isSuperTypeOf, ecore_EClass_m_getOperationCount, ecore_EClass_m_getFeatureID, ecore_EClass_m_getEStructuralFeature, ecore_EClass_m_getEOperation}
...
ecore_EStructuralFeature.attributes={ecore_EStructuralFeature_derived, ecore_EStructuralFeature_transient, ecore_EStructuralFeature_unsettable, ecore_EStructuralFeature_defaultValueLiteral, ecore_EStructuralFeature_featureID, ecore_EStructuralFeature_volatile, ecore_EStructuralFeature_changeable, ecore_EStructuralFeature_defaultValue}
...
ecore_EClassifier.attributes={ecore_EClassifier_classifierID, ecore_EClassifier_instanceClass, ecore_EClassifier_defaultValue}
...
ecore_ETypedElement.attributes={ecore_ETypedElement_lowerBound, ecore_ETypedElement_unique, ecore_ETypedElement_required, ecore_ETypedElement_many, ecore_ETypedElement_ordered, ecore_ETypedElement_upperBound}
...
domain_model = DomainModel(
    name="ecore",
    types={ecore_EAttribute, EStructuralFeature, ecore_EDataType, ecore_EStringToStringMapEntry, ecore_EModelElement, ecore_EObject, ecore_EClass, EClassifier, ecore_EStructuralFeature, ecore_EAnnotation, EModelElement, ecore_EReference, ecore_EOperation, ecore_EClassifier, ENamedElement, ecore_EPackage, ecore_EEnumLiteral, ecore_EFactory, ecore_EEnum, EDataType, ecore_ENamedElement, ETypedElement, ecore_EParameter, ecore_ETypedElement, ecore_EGenericType, ecore_ETypeParameter},
    associations={eAttributeType0, details1, eModelElement2, contents3, references5, eStructuralFeatures8, eReferences11, eSuperTypes14, eOperations16, eContainments18, eCrossReferences21, eAllAttributes24, eAttributes9, eAllReferences27, eAllContainments30, eAllOperations33, eAllStructuralFeatures35, eAllSuperTypes38, eIDAttribute40, ePackage43, eLiterals44, eEnum45, ePackage46, eAnnotations48, eFactoryInstance53, eClassifiers54, eSubPackages57, eSuperPackage60, eContainingClass49, eParameters50, eExceptions51, eKeys70, eOperation62, eOpposite65, eReferenceType67, eContainingClass73, eType75, eUpperBound78, eTypeArguments80, eRawType82, eLowerBound86, eTypeParameter88, eClassifier90, eBounds93},
