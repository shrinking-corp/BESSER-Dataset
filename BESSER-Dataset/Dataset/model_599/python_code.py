...
class presentation_StructuredViewer(ContentViewer):
    ...
    def __init__(self, group2: str, useHashlookup: str, presentation_StructuredViewer202: set["presentation_ViewerFilter"] = None, presentation_StructuredViewer: set["presentation_ViewerComparator"] = None, presentation_StructuredViewer200: set["presentation_IElementComparer"] = None, presentation_StructuredViewer204: set["presentation_ViewerSorter"] = None):
        self.group2 = group2
...
class presentation_Shell(Decorations):
    ...
    def __init__(self, minimumSize: str, group5: str, alpha: str, fullScreen: str, imeInputMode: str, presentation_Shell: "presentation_Shell" = None, presentation_Shell194: set["presentation_Shell"] = None, presentation_Shell261: "presentation_ToolTip" = None):
...
class presentation_ObjectDataProvider(AbstractDataProvider):
    ...
    def __init__(self, methodName: str, group1: str, presentation_ObjectDataProvider: set["presentation_Class"] = None, presentation_ObjectDataProvider180: set["presentation_EObject"] = None, presentation_ObjectDataProvider183: set["presentation_List"] = None):
...
class presentation_GridData:
    ...
    def __init__(self, mixed: str, exclude: str, grabExcessHorizontalSpace: str, grabExcessVerticalSpace: str, heightHint: str, horizontalAlignment: str, horizontalIndent: str, horizontalSpan: str, minimumHeight: str, minimumWidth: str, verticalAlignment: str, verticalIndent: str, verticalSpan: str, widthHint: str):
        self.mixed = mixed
        self.exclude = exclude
...
class presentation_StackLayout(Layout):
    ...
    def __init__(self, group: str, marginHeight: str, marginWidth: str, presentation_StackLayout: set["presentation_Control"] = None):
        self.group = group
...
class presentation_GridLayout(Layout):
    ...
    def __init__(self, marginBottom: str, marginHeight: str, horizontalSpacing: str, makeColumnsEqualWidth: str, marginLeft: str, marginRight: str, marginTop: str, marginWidth: str, numColumns: str, verticalSpacing: str):
...
class presentation_FormLayout(Layout):
    ...
    def __init__(self, spacing: str, marginBottom: str, marginHeight: str, marginLeft: str, marginRight: str, marginTop: str, marginWidth: str):
...
class presentation_RowLayout(Layout):
    ...
    def __init__(self, marginBottom: str, center: str, fill: str, justify: str, marginHeight: str, marginLeft: str, marginRight: str, marginTop: str, marginWidth: str, pack: str, spacing: str, type: str, wrap: str):
        self.marginBottom = marginBottom
        self.center = center
        self.fill = fill
...
class presentation_TableColumn(Item):
    ...
    def __init__(self, group: str, alignment: str, moveable: str, resizable: str, toolTipText: str, width: str, presentation_TableColumn224: "presentation_Table" = None, presentation_TableColumn: "presentation_Table" = None, presentation_TableColumn234: set["presentation_Table"] = None, presentation_TableColumn232: set["presentation_Element"] = None, presentation_TableColumn250: "presentation_TableViewerColumn" = None):
        self.group = group
        self.alignment = alignment
...
class presentation_ExpandItem(Item):
    ...
    def __init__(self, group: str, expanded: str, height: str, presentation_ExpandItem137: set["presentation_Control"] = None, presentation_ExpandItem: "presentation_ExpandBar" = None, presentation_ExpandItem134: set["presentation_ExpandBar"] = None):
        self.group = group
...
class presentation_ToolItem(Item):
    ...
    def __init__(self, group: str, bounds: str, disabledImage: str, enabled: str, hotImage: str, selection: str, toolTipText: str, width: str, presentation_ToolItem255: set["presentation_Control"] = None, presentation_ToolItem: "presentation_ToolBar" = None, presentation_ToolItem258: set["presentation_ToolBar"] = None):
        self.group = group
        self.bounds = bounds
...
class presentation_MenuItem(Item):
    ...
    def __init__(self, accelerator: str, enabled: str, group: str, selection: str, presentation_MenuItem: "presentation_Menu" = None, presentation_MenuItem159: "presentation_Menu" = None, presentation_MenuItem162: "presentation_Menu" = None, presentation_MenuItem170: set["presentation_Menu"] = None, presentation_MenuItem173: set["presentation_ICommand"] = None, presentation_MenuItem176: set["presentation_Menu"] = None):
...
class presentation_CoolItem(Item):
    ...
    def __init__(self, group: str, bounds: str, minimumSize: str, preferredSize: str, size: str, presentation_CoolItem: "presentation_CoolBar" = None, presentation_CoolItem88: set["presentation_CoolBar"] = None, presentation_CoolItem91: set["presentation_Control"] = None):
        self.group = group
        self.bounds = bounds
        self.minimumSize = minimumSize
...
class presentation_ControlEditor:
    ...
    def __init__(self, mixed: str, group: str, grabHorizontal: str, grabVertical: str, horizontalAlignment: str, minimumHeight: str, minimumWidth: str, verticalAlignment: str, presentation_ControlEditor: set["presentation_Control"] = None):
        self.mixed = mixed
        self.group = group
...
class presentation_Text(Scrollable):
    ...
    def __init__(self, message: str, orientation: str, caretLocation: str, doubleClickEnabled: str, echoChar: str, editable: str, lineDelimiter: str, selection: str, selectionText: str, tabs: str, text: str, textLimit: str, topIndex: str):
        self.message = message
...
class presentation_List(Scrollable):
    ...
    def __init__(self, topIndex: str, group2: str, items: str, selection: str, selectionIndices: str, presentation_List: "presentation_ListViewer" = None, presentation_List184: "presentation_ObjectDataProvider" = None):
        self.topIndex = topIndex
        self.group2 = group2
        self.items = items
        self.selection = selection
...
class presentation_StyledText(Canvas):
    ...
    def __init__(self, group4: str, ranges: str, selection: str, selectionBackground: str, selectionRanges: str, alignment: str, bidiColoring: str, blockSelection: str, caretOffset: str, doubleClickEnabled: str, editable: str, horizontalIndex: str, horizontalPixel: str, indent: str, justify: str, lineDelimiter: str, lineSpacing: str, orientation: str, selectionForeground: str, selectionText: str, tabs: str, text: str, textLimit: str, topIndex: str, topPixel: str, wordWrap: str, presentation_StyledText207: set["presentation_StyleRange"] = None, presentation_StyledText210: set["presentation_StyledTextContent"] = None, presentation_StyledText: set["presentation_StyleRange"] = None):
        self.group4 = group4
        self.ranges = ranges
        self.selection = selection
...
class presentation_CheckboxTableViewer(TableViewer):
    ...
    def __init__(self, allChecked: str, group5: str, allGrayed: str, presentation_CheckboxTableViewer37: set["presentation_EObject"] = None, presentation_CheckboxTableViewer: set["presentation_EObject"] = None, presentation_CheckboxTableViewer35: set["presentation_ICheckStateProvider"] = None):
        self.allChecked = allChecked
        self.group5 = group5
...
class presentation_TableItem(Item):
    ...
    def __init__(self, group: str, texts: str, checked: str, grayed: str, imageIndent: str, presentation_TableItem: "presentation_Cell" = None, presentation_TableItem227: "presentation_Table" = None, presentation_TableItem230: "presentation_Table" = None, presentation_TableItem241: set["presentation_Table"] = None, presentation_TableItem237: "presentation_TableEditor" = None, presentation_TableItem239: set["presentation_Collection"] = None, presentation_TableItem244: set["presentation_Collection"] = None):
        self.group = group
        self.texts = texts
...
class presentation_Control(Widget):
    ...
    def __init__(self, group: str, toolTipText: str, visible: str, background: str, backgroundImage: str, bounds: str, capture: str, dragDetect: str, enabled: str, font: str, foreground: str, handle: str, location: str, redraw: str, size: str, presentation_Control98: "presentation_CTabFolder" = None, presentation_Control113: "presentation_CTabItem" = None, presentation_Control120: "presentation_Dialog" = None, presentation_Control138: "presentation_ExpandItem" = None, presentation_Control: "presentation_CellEditor" = None, presentation_Control65: "presentation_Composite" = None, presentation_Control80: set["presentation_EObject"] = None, presentation_Control68: "presentation_Composite" = None, presentation_Control76: set["presentation_Menu"] = None, presentation_Control78: set["presentation_Cursor"] = None, presentation_Control83: set["presentation_Accessible"] = None, presentation_Control85: "presentation_ControlEditor" = None, presentation_Control92: "presentation_CoolItem" = None, presentation_Control220: "presentation_TabItem" = None, presentation_Control140: "presentation_FormAttachment" = None, presentation_Control186: "presentation_SashForm" = None, presentation_Control197: "presentation_StackLayout" = None, presentation_Control301: "presentation_Viewer" = None, presentation_Control256: "presentation_ToolItem" = None):
        self.group = group
        self.toolTipText = toolTipText
...
class presentation_Tracker(Widget):
    ...
    def __init__(self, rectangles: str, group: str, stippled: str, presentation_Tracker: set["presentation_Cursor"] = None):
...
class presentation_Menu(Widget):
    ...
    def __init__(self, enabled: str, handle: str, visible: str, group: str, presentation_Menu118: "presentation_Decorations" = None, presentation_Menu: "presentation_Control" = None, presentation_Menu156: set["presentation_MenuItem"] = None, presentation_Menu158: set["presentation_MenuItem"] = None, presentation_Menu161: set["presentation_MenuItem"] = None, presentation_Menu165: "presentation_Menu" = None, presentation_Menu163: set["presentation_Menu"] = None, presentation_Menu167: set["presentation_Decorations"] = None, presentation_Menu171: "presentation_MenuItem" = None, presentation_Menu177: "presentation_MenuItem" = None):
        self.enabled = enabled
        self.handle = handle
        self.visible = visible
        self.group = group
...
class presentation_Caret(Widget):
    ...
    def __init__(self, location: str, size: str, group: str, bounds: str, font: str, image: str, visible: str, presentation_Caret: "presentation_Canvas" = None, presentation_Caret21: set["presentation_Canvas"] = None):
        self.location = location
        self.size = size
        self.group = group
        self.bounds = bounds
...
class presentation_Scale(Control):
    ...
    def __init__(self, selection: str, increment: str, maximum: str, minimum: str, pageIncrement: str):
        self.selection = selection
        self.increment = increment
        self.maximum = maximum
        self.minimum = minimum
...
class presentation_Button(Control):
    ...
    def __init__(self, grayed: str, image: str, group1: str, alignment: str, selection: str, text: str, presentation_Button: set["presentation_ICommand"] = None, presentation_Button115: "presentation_Decorations" = None):
        self.grayed = grayed
        self.image = image
        self.group1 = group1
        self.alignment = alignment
...
class presentation_Table(Composite):
    ...
    def __init__(self, group3: str, columnOrder: str, selectionIndices: str, headerVisible: str, itemCount: str, linesVisible: str, sortDirection: str, topIndex: str, presentation_Table223: set["presentation_TableColumn"] = None, presentation_Table: set["presentation_TableColumn"] = None, presentation_Table235: "presentation_TableColumn" = None, presentation_Table226: set["presentation_TableItem"] = None, presentation_Table229: set["presentation_TableItem"] = None, presentation_Table242: "presentation_TableItem" = None, presentation_Table248: "presentation_TableViewer" = None):
        self.group3 = group3
...
class presentation_Spinner(Composite):
    ...
    def __init__(self, text: str, textLimit: str, digits: str, increment: str, maximum: str, minimum: str, pageIncrement: str, selection: str):
        self.text = text
        self.textLimit = textLimit
        self.digits = digits
        self.increment = increment
...
class presentation_CoolBar(Composite):
    ...
    def __init__(self, itemSizes: str, group3: str, itemOrder: str, wrapIndices: str, locked: str, presentation_CoolBar: set["presentation_CoolItem"] = None, presentation_CoolBar89: "presentation_CoolItem" = None):
...
class presentation_Combo(Composite):
    ...
    def __init__(self, listVisible: str, orientation: str, group3: str, items: str, selection: str, text: str, textLimit: str, visibleItemCount: str):
...
class presentation_Binding:
    ...
    def __init__(self, mixed: str, group: str, elementName: str, path: str, xPath: str, presentation_Binding10: set["presentation_EObject"] = None, presentation_Binding13: set["presentation_Widget"] = None, presentation_Binding: set["presentation_EObject"] = None):
        self.mixed = mixed
        self.group = group
...
class presentation_Widget(ABC):
    ...
    def __init__(self, mixed: str, activateEvent: str, armEvent: str, focusOutEvent: str, hardKeyDownEvent: str, hardKeyUpEvent: str, helpEvent: str, closeEvent: str, collapseEvent: str, dataContext: str, deactivateEvent: str, defaultSelectionEvent: str, deiconifyEvent: str, disposeEvent: str, dragDetectEvent: str, eraseItemEvent: str, expandEvent: str, focusInEvent: str, mouseHoverEvent: str, mouseMoveEvent: str, mouseUpEvent: str, mouseWheelEvent: str, hideEvent: str, iconifyEvent: str, imeCompositionEvent: str, keyDownEvent: str, keyUpEvent: str, measureItemEvent: str, menuDetectEvent: str, modifyEvent: str, mouseDoubleClickEvent: str, mouseDownEvent: str, mouseEnterEvent: str, mouseExitEvent: str, verifyEvent: str, moveEvent: str, paintEvent: str, paintItemEvent: str, resizeEvent: str, selectionEvent: str, setDataEvent: str, showEvent: str, style: str, traverseEvent: str, presentation_Widget: "presentation_Binding" = None):
        self.mixed = mixed
...
class presentation_XMLDataProvider(AbstractDataProvider):
    ...
    def __init__(self, group1: str, xPath: str, presentation_XMLDataProvider306: set["presentation_URL"] = None, presentation_XMLDataProvider: set["presentation_Document"] = None):
        self.group1 = group1
        self.xPath = xPath
...
class presentation_Viewer(ABC):
    ...
    def __init__(self, mixed: str, group: str, presentation_Viewer298: set["presentation_ISelection"] = None, presentation_Viewer300: set["presentation_Control"] = None, presentation_Viewer: set["presentation_EObject"] = None):
        self.mixed = mixed
        self.group = group
...
class presentation_TreeColumn(Item):
    ...
    def __init__(self, alignment: str, moveable: str, resizable: str, group: str, toolTipText: str, width: str, presentation_TreeColumn: "presentation_Tree" = None, presentation_TreeColumn271: "presentation_Tree" = None, presentation_TreeColumn282: set["presentation_Tree"] = None):
        self.alignment = alignment
        self.moveable = moveable
        self.resizable = resizable
        self.group = group
...
class presentation_Tree(Composite):
    ...
    def __init__(self, columnOrder: str, group3: str, headerVisible: str, itemCount: str, linesVisible: str, sortDirection: str, presentation_Tree273: set["presentation_TreeItem"] = None, presentation_Tree: set["presentation_TreeColumn"] = None, presentation_Tree268: set["presentation_TreeItem"] = None, presentation_Tree270: set["presentation_TreeColumn"] = None, presentation_Tree276: set["presentation_TreeItem"] = None, presentation_Tree279: set["presentation_TreeItem"] = None, presentation_Tree283: "presentation_TreeColumn" = None, presentation_Tree292: "presentation_TreeItem" = None, presentation_Tree294: "presentation_TreeViewer" = None):
        self.columnOrder = columnOrder
        self.group3 = group3
        self.headerVisible = headerVisible
        self.itemCount = itemCount
