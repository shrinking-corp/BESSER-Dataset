...
public class presentation_ObjectDataProvider extends AbstractDataProvider {
    ...
    public presentation_ObjectDataProvider(
        String methodName,        String group1        ArrayList<presentation_List> presentation_lists,        ArrayList<presentation_EObject> presentation_eobjects,        ArrayList<presentation_Class> presentation_classs    ) {
        this.methodName = methodName;
        this.group1 = group1;
