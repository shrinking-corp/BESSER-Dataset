...
public class presentation_TabItem extends Item {
    ...
    public presentation_TabItem(
        String toolTipText,        String bounds,        String group    ) {
        super(
        );
    ...
    public presentation_TabItem(
        String toolTipText,        String bounds,        String group        ArrayList<presentation_TabFolder> presentation_tabfolders,        ArrayList<presentation_Control> presentation_controls    ) {
        this.toolTipText = toolTipText;
        this.bounds = bounds;
        this.group = group;
