...
public class presentation_TitleAreaDialog extends TrayDialog {
    ...
    public presentation_TitleAreaDialog(
        String title,        String errorMessage,        String message,        String titleImage,        String group3    ) {
        super(
        );
        this.title = title;
    ...
    public presentation_TitleAreaDialog(
        String title,        String errorMessage,        String message,        String titleImage,        String group3        ArrayList<presentation_RGB> presentation_rgbs    ) {
        this.title = title;
        this.errorMessage = errorMessage;
        this.message = message;
        this.titleImage = titleImage;
