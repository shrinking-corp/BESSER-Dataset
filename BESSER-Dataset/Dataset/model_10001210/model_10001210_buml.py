...
Documents.attributes={Documents_tab_counter, Documents_file, Documents_data, Documents_file_name}
...
domain_model = DomainModel(
    name="_93a8c899_545c_4569_a636_4a5ae50f0db3",
    types={Value, Null, String, Bool, Number, Array, Visitor, Json, Documents, Print, ArrPrint},
    associations={},
    generalizations={},
    metadata=None
)
