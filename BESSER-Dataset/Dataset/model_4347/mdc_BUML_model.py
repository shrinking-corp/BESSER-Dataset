...
mdc_Chatbot.attributes={mdc_Chatbot_name, mdc_Chatbot_token}
...
domain_model = DomainModel(
    name="mdc",
    types={mdc_Chatbot, mdc_State, mdc_StationaryState, mdc_TransactionalState, State, mdc_TransactionalStateImpl, TransactionalState, mdc_StationaryStateImpl, StationaryState},
    associations={states0, initState1, transitions3, errorState6},
