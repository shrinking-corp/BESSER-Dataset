...
class javaMM_Model:
    ...
    def __init__(self, name: str, javaMM_Model244: set["javaMM_ClassFile"] = None, javaMM_Model247: set["javaMM_Archive"] = None, model: set["javaMM_Package"] = None, javaMM_Model: set["javaMM_Type"] = None, javaMM_Model239: set["javaMM_UnresolvedItem"] = None, javaMM_Model241: set["javaMM_CompilationUnit"] = None, Model: "javaMM_Package" = None):
        self.name = name
...
class javaMM_CompilationUnit(NamedElement):
    ...
    def __init__(self, originalFilePath: str, javaMM_CompilationUnit: "javaMM_ASTNode" = None, javaMM_CompilationUnit108: "javaMM_ClassFile" = None, javaMM_CompilationUnit134: "javaMM_Package" = None, javaMM_CompilationUnit129: set["javaMM_Comment"] = None, javaMM_CompilationUnit132: set["javaMM_ImportDeclaration"] = None, javaMM_CompilationUnit137: set["javaMM_AbstractTypeDeclaration"] = None, javaMM_CompilationUnit242: "javaMM_Model" = None):
...
class javaMM_AbstractTypeDeclaration(Type, BodyDeclaration):
    ...
    def __init__(self, ownedElements: "javaMM_Package" = None, javaMM_AbstractTypeDeclaration21: set["javaMM_TypeAccess"] = None, abstractTypeDeclaration: set["javaMM_BodyDeclaration"] = None, javaMM_AbstractTypeDeclaration: set["javaMM_Comment"] = None, javaMM_AbstractTypeDeclaration17: set["javaMM_Comment"] = None, AbstractTypeDeclaration: "javaMM_BodyDeclaration" = None, javaMM_AbstractTypeDeclaration105: "javaMM_ClassFile" = None, javaMM_AbstractTypeDeclaration138: "javaMM_CompilationUnit" = None, AbstractTypeDeclaration260: "javaMM_Package" = None, javaMM_AbstractTypeDeclaration340: "javaMM_TypeDeclarationStatement" = None):
...
class javaMM_SingleVariableDeclaration(VariableDeclaration):
    ...
    def __init__(self, varargs: bool, SingleVariableDeclaration: "javaMM_AbstractMethodDeclaration" = None, SingleVariableDeclaration152: "javaMM_EnhancedForStatement" = None, SingleVariableDeclaration100: "javaMM_CatchClause" = None, SingleVariableDeclaration253: "javaMM_Modifier" = None, singleVariableDeclaration: "javaMM_Modifier" = None, javaMM_SingleVariableDeclaration: "javaMM_TypeAccess" = None, javaMM_SingleVariableDeclaration298: set["javaMM_Annotation"] = None, parameters: "javaMM_AbstractMethodDeclaration" = None, exception: "javaMM_CatchClause" = None, parameter: "javaMM_EnhancedForStatement" = None):
        self.varargs = varargs
