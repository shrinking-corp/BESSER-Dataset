...
# Classes
javaMM_SingleVariableDeclaration = Class(name="javaMM_SingleVariableDeclaration")
javaMM_TypeAccess = Class(name="javaMM_TypeAccess")
javaMM_TypeParameter = Class(name="javaMM_TypeParameter")
javaMM_AbstractMethodDeclaration = Class(name="javaMM_AbstractMethodDeclaration", is_abstract=True)
BodyDeclaration = Class(name="BodyDeclaration")
javaMM_Block = Class(name="javaMM_Block")
javaMM_MethodRef = Class(name="javaMM_MethodRef")
javaMM_AbstractMethodInvocation = Class(name="javaMM_AbstractMethodInvocation", is_abstract=True)
ASTNode = Class(name="ASTNode")
javaMM_Expression = Class(name="javaMM_Expression", is_abstract=True)
javaMM_Package = Class(name="javaMM_Package")
javaMM_AbstractTypeQualifiedExpression = Class(name="javaMM_AbstractTypeQualifiedExpression", is_abstract=True)
Expression = Class(name="Expression")
javaMM_AbstractTypeDeclaration = Class(name="javaMM_AbstractTypeDeclaration", is_abstract=True)
Type = Class(name="Type")
javaMM_BodyDeclaration = Class(name="javaMM_BodyDeclaration", is_abstract=True)
javaMM_Comment = Class(name="javaMM_Comment", is_abstract=True)
javaMM_ClassFile = Class(name="javaMM_ClassFile")
javaMM_Manifest = Class(name="javaMM_Manifest")
javaMM_AssertStatement = Class(name="javaMM_AssertStatement")
Statement = Class(name="Statement")
javaMM_AbstractVariablesContainer = Class(name="javaMM_AbstractVariablesContainer", is_abstract=True)
javaMM_VariableDeclarationFragment = Class(name="javaMM_VariableDeclarationFragment")
javaMM_Annotation = Class(name="javaMM_Annotation")
javaMM_AnnotationMemberValuePair = Class(name="javaMM_AnnotationMemberValuePair")
javaMM_Archive = Class(name="javaMM_Archive")
NamedElement = Class(name="NamedElement")
javaMM_ASTNode = Class(name="javaMM_ASTNode", is_abstract=True)
javaMM_CompilationUnit = Class(name="javaMM_CompilationUnit")
javaMM_AnnotationTypeMemberDeclaration = Class(name="javaMM_AnnotationTypeMemberDeclaration")
javaMM_AnnotationTypeDeclaration = Class(name="javaMM_AnnotationTypeDeclaration")
AbstractTypeDeclaration = Class(name="AbstractTypeDeclaration")
javaMM_ArrayLengthAccess = Class(name="javaMM_ArrayLengthAccess")
javaMM_AnonymousClassDeclaration = Class(name="javaMM_AnonymousClassDeclaration")
javaMM_ClassInstanceCreation = Class(name="javaMM_ClassInstanceCreation")
javaMM_ArrayAccess = Class(name="javaMM_ArrayAccess")
javaMM_ArrayCreation = Class(name="javaMM_ArrayCreation")
javaMM_ArrayInitializer = Class(name="javaMM_ArrayInitializer")
javaMM_ArrayType = Class(name="javaMM_ArrayType")
javaMM_Assignment = Class(name="javaMM_Assignment")
javaMM_CastExpression = Class(name="javaMM_CastExpression")
javaMM_Modifier = Class(name="javaMM_Modifier")
javaMM_BooleanLiteral = Class(name="javaMM_BooleanLiteral")
javaMM_BlockComment = Class(name="javaMM_BlockComment")
Comment = Class(name="Comment")
javaMM_Statement = Class(name="javaMM_Statement", is_abstract=True)
javaMM_BreakStatement = Class(name="javaMM_BreakStatement")
javaMM_LabeledStatement = Class(name="javaMM_LabeledStatement")
AbstractMethodInvocation = Class(name="AbstractMethodInvocation")
javaMM_CatchClause = Class(name="javaMM_CatchClause")
javaMM_CharacterLiteral = Class(name="javaMM_CharacterLiteral")
javaMM_ConstructorDeclaration = Class(name="javaMM_ConstructorDeclaration")
AbstractMethodDeclaration = Class(name="AbstractMethodDeclaration")
javaMM_ConditionalExpression = Class(name="javaMM_ConditionalExpression")
javaMM_ConstructorInvocation = Class(name="javaMM_ConstructorInvocation")
javaMM_ClassDeclaration = Class(name="javaMM_ClassDeclaration")
TypeDeclaration = Class(name="TypeDeclaration")
javaMM_ImportDeclaration = Class(name="javaMM_ImportDeclaration")
javaMM_EmptyStatement = Class(name="javaMM_EmptyStatement")
javaMM_EnhancedForStatement = Class(name="javaMM_EnhancedForStatement")
javaMM_ContinueStatement = Class(name="javaMM_ContinueStatement")
javaMM_DoStatement = Class(name="javaMM_DoStatement")
javaMM_FieldAccess = Class(name="javaMM_FieldAccess")
javaMM_SingleVariableAccess = Class(name="javaMM_SingleVariableAccess")
javaMM_EnumConstantDeclaration = Class(name="javaMM_EnumConstantDeclaration")
VariableDeclaration = Class(name="VariableDeclaration")
javaMM_EnumDeclaration = Class(name="javaMM_EnumDeclaration")
javaMM_ExpressionStatement = Class(name="javaMM_ExpressionStatement")
javaMM_FieldDeclaration = Class(name="javaMM_FieldDeclaration")
AbstractVariablesContainer = Class(name="AbstractVariablesContainer")
javaMM_ForStatement = Class(name="javaMM_ForStatement")
javaMM_InfixExpression = Class(name="javaMM_InfixExpression")
javaMM_IfStatement = Class(name="javaMM_IfStatement")
javaMM_NamedElement = Class(name="javaMM_NamedElement", is_abstract=True)
javaMM_InterfaceDeclaration = Class(name="javaMM_InterfaceDeclaration")
javaMM_Javadoc = Class(name="javaMM_Javadoc")
javaMM_TagElement = Class(name="javaMM_TagElement")
javaMM_Initializer = Class(name="javaMM_Initializer")
javaMM_InstanceofExpression = Class(name="javaMM_InstanceofExpression")
javaMM_MethodDeclaration = Class(name="javaMM_MethodDeclaration")
javaMM_LineComment = Class(name="javaMM_LineComment")
javaMM_ManifestAttribute = Class(name="javaMM_ManifestAttribute")
javaMM_ManifestEntry = Class(name="javaMM_ManifestEntry")
javaMM_MemberRef = Class(name="javaMM_MemberRef")
javaMM_MethodRefParameter = Class(name="javaMM_MethodRefParameter")
javaMM_MethodInvocation = Class(name="javaMM_MethodInvocation")
javaMM_VariableDeclarationStatement = Class(name="javaMM_VariableDeclarationStatement")
javaMM_VariableDeclarationExpression = Class(name="javaMM_VariableDeclarationExpression")
javaMM_Model = Class(name="javaMM_Model")
javaMM_Type = Class(name="javaMM_Type", is_abstract=True)
javaMM_UnresolvedItem = Class(name="javaMM_UnresolvedItem")
javaMM_NamespaceAccess = Class(name="javaMM_NamespaceAccess", is_abstract=True)
javaMM_NumberLiteral = Class(name="javaMM_NumberLiteral")
javaMM_NullLiteral = Class(name="javaMM_NullLiteral")
javaMM_PackageAccess = Class(name="javaMM_PackageAccess")
javaMM_ParenthesizedExpression = Class(name="javaMM_ParenthesizedExpression")
NamespaceAccess = Class(name="NamespaceAccess")
javaMM_ParameterizedType = Class(name="javaMM_ParameterizedType")
javaMM_VariableDeclaration = Class(name="javaMM_VariableDeclaration", is_abstract=True)
javaMM_PostfixExpression = Class(name="javaMM_PostfixExpression")
javaMM_PrefixExpression = Class(name="javaMM_PrefixExpression")
javaMM_PrimitiveType = Class(name="javaMM_PrimitiveType")
javaMM_PrimitiveTypeBoolean = Class(name="javaMM_PrimitiveTypeBoolean")
PrimitiveType = Class(name="PrimitiveType")
javaMM_PrimitiveTypeByte = Class(name="javaMM_PrimitiveTypeByte")
javaMM_PrimitiveTypeChar = Class(name="javaMM_PrimitiveTypeChar")
javaMM_PrimitiveTypeDouble = Class(name="javaMM_PrimitiveTypeDouble")
javaMM_PrimitiveTypeShort = Class(name="javaMM_PrimitiveTypeShort")
javaMM_PrimitiveTypeFloat = Class(name="javaMM_PrimitiveTypeFloat")
javaMM_PrimitiveTypeInt = Class(name="javaMM_PrimitiveTypeInt")
javaMM_PrimitiveTypeLong = Class(name="javaMM_PrimitiveTypeLong")
javaMM_PrimitiveTypeVoid = Class(name="javaMM_PrimitiveTypeVoid")
javaMM_ReturnStatement = Class(name="javaMM_ReturnStatement")
javaMM_SuperMethodInvocation = Class(name="javaMM_SuperMethodInvocation")
javaMM_SwitchCase = Class(name="javaMM_SwitchCase")
javaMM_StringLiteral = Class(name="javaMM_StringLiteral")
javaMM_SuperConstructorInvocation = Class(name="javaMM_SuperConstructorInvocation")
javaMM_SuperFieldAccess = Class(name="javaMM_SuperFieldAccess")
AbstractTypeQualifiedExpression = Class(name="AbstractTypeQualifiedExpression")
javaMM_SwitchStatement = Class(name="javaMM_SwitchStatement")
javaMM_SynchronizedStatement = Class(name="javaMM_SynchronizedStatement")
javaMM_TextElement = Class(name="javaMM_TextElement")
javaMM_ThisExpression = Class(name="javaMM_ThisExpression")
javaMM_ThrowStatement = Class(name="javaMM_ThrowStatement")
javaMM_TryStatement = Class(name="javaMM_TryStatement")
javaMM_UnresolvedItemAccess = Class(name="javaMM_UnresolvedItemAccess")
javaMM_UnresolvedAnnotationDeclaration = Class(name="javaMM_UnresolvedAnnotationDeclaration")
AnnotationTypeDeclaration = Class(name="AnnotationTypeDeclaration")
UnresolvedItem = Class(name="UnresolvedItem")
javaMM_UnresolvedAnnotationTypeMemberDeclaration = Class(name="javaMM_UnresolvedAnnotationTypeMemberDeclaration")
AnnotationTypeMemberDeclaration = Class(name="AnnotationTypeMemberDeclaration")
javaMM_TypeDeclaration = Class(name="javaMM_TypeDeclaration", is_abstract=True)
javaMM_TypeDeclarationStatement = Class(name="javaMM_TypeDeclarationStatement")
javaMM_TypeLiteral = Class(name="javaMM_TypeLiteral")
javaMM_UnresolvedClassDeclaration = Class(name="javaMM_UnresolvedClassDeclaration")
ClassDeclaration = Class(name="ClassDeclaration")
javaMM_UnresolvedEnumDeclaration = Class(name="javaMM_UnresolvedEnumDeclaration")
EnumDeclaration = Class(name="EnumDeclaration")
javaMM_UnresolvedInterfaceDeclaration = Class(name="javaMM_UnresolvedInterfaceDeclaration")
InterfaceDeclaration = Class(name="InterfaceDeclaration")
javaMM_UnresolvedLabeledStatement = Class(name="javaMM_UnresolvedLabeledStatement")
LabeledStatement = Class(name="LabeledStatement")
javaMM_UnresolvedMethodDeclaration = Class(name="javaMM_UnresolvedMethodDeclaration")
MethodDeclaration = Class(name="MethodDeclaration")
javaMM_UnresolvedSingleVariableDeclaration = Class(name="javaMM_UnresolvedSingleVariableDeclaration")
SingleVariableDeclaration = Class(name="SingleVariableDeclaration")
javaMM_UnresolvedType = Class(name="javaMM_UnresolvedType")
javaMM_UnresolvedTypeDeclaration = Class(name="javaMM_UnresolvedTypeDeclaration")
javaMM_UnresolvedVariableDeclarationFragment = Class(name="javaMM_UnresolvedVariableDeclarationFragment")
VariableDeclarationFragment = Class(name="VariableDeclarationFragment")
javaMM_WildCardType = Class(name="javaMM_WildCardType")
javaMM_WhileStatement = Class(name="javaMM_WhileStatement")
...
javaMM_AbstractTypeDeclaration_m_implements: Method = Method(name="implements", parameters={Parameter(name='javaMM_type', type=StringType)}, type=StringType)
...
javaMM_Modifier.attributes={javaMM_Modifier_static, javaMM_Modifier_transient, javaMM_Modifier_visibility, javaMM_Modifier_strictfp, javaMM_Modifier_inheritance, javaMM_Modifier_native, javaMM_Modifier_volatile, javaMM_Modifier_synchronized}
...
javaMM_MethodDeclaration.methods={javaMM_MethodDeclaration_m_isToString, javaMM_MethodDeclaration_m_isHashcode, javaMM_MethodDeclaration_m_isEquals, javaMM_MethodDeclaration_m_isFinalize, javaMM_MethodDeclaration_m_isCompareTo, javaMM_MethodDeclaration_m_isClone}
...
# OCL Constraints
allImportsAreUsed: Constraint = Constraint(
    name="allImportsAreUsed",
    context=javaMM_ImportDeclaration,
    expression="context ImportDeclaration inv: NamedElement.allInstances()->exists(ne |ne = self.importedElement andne.originalCompilationUnit = self.originalCompilationUnit)",
    language="OCL"
)
notReservedWord: Constraint = Constraint(
    name="notReservedWord",
    context=javaMM_NamedElement,
    expression="context NamedElement inv: self.name <> 'var' andself.name <> '_' andself.name <> 'strictfp' andself.name <> 'assert' andself.name <> 'enum'",
    language="OCL"
)
shouldStartWithUpperCase: Constraint = Constraint(
    name="shouldStartWithUpperCase",
    context=javaMM_TypeDeclaration,
    expression="context TypeDeclaration inv: self.name.at(1) = self.name.at(1).toUpperCase()",
    language="OCL"
)
shouldStartWithLowerCase: Constraint = Constraint(
    name="shouldStartWithLowerCase",
    context=javaMM_MethodDeclaration,
    expression="context MethodDeclaration inv: self.name.at(1).toLowerCase() = self.name.at(1)",
    language="OCL"
)
doesNotCallFinalize: Constraint = Constraint(
    name="doesNotCallFinalize",
    context=javaMM_MethodInvocation,
    expression="context MethodInvocation inv: self.method <> null implies not (self.method.name = 'finalize' andself.method.parameters->isEmpty())",
    language="OCL"
)
doesNotCallExit: Constraint = Constraint(
    name="doesNotCallExit",
    context=javaMM_MethodInvocation,
    expression="context MethodInvocation inv: self.method <> null implies not (self.method.name = 'exit' andself.method.parameters->size() = 1 andself.method.parameters->first().type.type.oclIsTypeOf(PrimitiveTypeInt))",
    language="OCL"
)
doesNotCallRunFinalizers: Constraint = Constraint(
    name="doesNotCallRunFinalizers",
    context=javaMM_MethodInvocation,
    expression="context MethodInvocation inv: self.method <> null implies not (self.method.name = 'runFinalizersOnExit' andself.method.parameters->size() = 1 andself.method.parameters->first().type.type.oclIsTypeOf(PrimitiveTypeBoolean))",
    language="OCL"
)
canBeLocal: Constraint = Constraint(
    name="canBeLocal",
    context=javaMM_AbstractMethodDeclaration,
    expression="context AbstractMethodDeclaration inv: self.modifier <> null and not self.modifier.isLocal impliesself.usages->exists(m | m.originalClassFile <> self.originalClassFile)",
    language="OCL"
)
localMethodIsUsed: Constraint = Constraint(
    name="localMethodIsUsed",
    context=javaMM_AbstractMethodDeclaration,
    expression="context AbstractMethodDeclaration inv: (self.modifier <> null and self.modifier.isLocal) implies self.usages->notEmpty()",
    language="OCL"
)
parametersEffectivelyFinal: Constraint = Constraint(
    name="parametersEffectivelyFinal",
    context=javaMM_AbstractMethodDeclaration,
    expression="context AbstractMethodDeclaration inv: (self._'body' <> null and self.parameters->notEmpty()) implies (self._'body'.statements ->selectByKind(ExpressionStatement) ->collect(expression) ->selectByKind(Assignment) ->select(assignment |assignment.leftHandSide.oclIsKindOf(SingleVariableAccess) andassignment.operator = AssignmentKind_ASSIGN andassignment.leftHandSide.oclIsKindOf(SingleVariableAccess) andself.parameters->excludes(assignment.leftHandSide.oclAsType(SingleVariableAccess).variable)) ->isEmpty())",
    language="OCL"
)
noRedundantAssignment: Constraint = Constraint(
    name="noRedundantAssignment",
    context=javaMM_Assignment,
    expression="context Assignment inv: self.operator = AssignmentKind_ASSIGN implies self.leftHandSide <> self.rightHandSide",
    language="OCL"
)
variableIsUsed: Constraint = Constraint(
    name="variableIsUsed",
    context=javaMM_VariableDeclarationFragment,
    expression="context VariableDeclaration inv: self.usageInVariableAccess->notEmpty()",
    language="OCL"
)
publicVariableIsFinal: Constraint = Constraint(
    name="publicVariableIsFinal",
    context=javaMM_VariableDeclarationStatement,
    expression="context VariableDeclarationStatement inv: self.modifier.visibility = VisibilityKind_public implies self.modifier.inheritance = InheritanceKind_final",
    language="OCL"
)
publicVariableIsFinal1: Constraint = Constraint(
    name="publicVariableIsFinal1",
    context=javaMM_VariableDeclarationExpression,
    expression="context VariableDeclarationExpression inv: self.modifier.visibility = VisibilityKind_public implies self.modifier.inheritance = InheritanceKind_final",
    language="OCL"
)
exceptionIsUsed: Constraint = Constraint(
    name="exceptionIsUsed",
    context=javaMM_CatchClause,
    expression="context CatchClause inv: self.exception.usageInVariableAccess->notEmpty()",
    language="OCL"
)
doesNotCatchDubiousExceptions: Constraint = Constraint(
    name="doesNotCatchDubiousExceptions",
    context=javaMM_CatchClause,
    expression="context CatchClause inv: self.exception.type.type.name <> 'IllegalMonitorStateException'",
    language="OCL"
)
emptyBlockIsDocumented: Constraint = Constraint(
    name="emptyBlockIsDocumented",
    context=javaMM_Block,
    expression="context Block inv: self.statements->isEmpty() implies self.comments->notEmpty()",
    language="OCL"
)
moreThan3Cases: Constraint = Constraint(
    name="moreThan3Cases",
    context=javaMM_SwitchStatement,
    expression="context SwitchStatement inv: self.statements->size() > 3",
    language="OCL"
)
noRedundantSuperCall: Constraint = Constraint(
    name="noRedundantSuperCall",
    context=javaMM_SuperConstructorInvocation,
    expression="context SuperConstructorInvocation inv: self.arguments->notEmpty()",
    language="OCL"
)
noDeadCode: Constraint = Constraint(
    name="noDeadCode",
    context=javaMM_IfStatement,
    expression="context IfStatement inv: not self.expression.oclIsKindOf(TypeLiteral)",
    language="OCL"
)
noUselessControlFlow: Constraint = Constraint(
    name="noUselessControlFlow",
    context=javaMM_IfStatement,
    expression="context IfStatement inv: not self.thenStatement.oclIsTypeOf(EmptyStatement) and(self.elseStatement <> null implies not self.elseStatement.oclIsTypeOf(EmptyStatement))",
    language="OCL"
)
publicFieldsOnlyInPOJO: Constraint = Constraint(
    name="publicFieldsOnlyInPOJO",
    context=javaMM_ClassDeclaration,
    expression="context ClassDeclaration inv: self.getPublicFields->notEmpty() implies self.bodyDeclarations->select(oclIsKindOf(MethodDeclaration))->collect(oclAsType(MethodDeclaration))->select(md | (md.modifier = null or md.modifier._'static') and not (md.isEquals or md.isHashcode or md.isToStringor md.isFinalize or md.isClone or md.isCompareTo))->isEmpty()",
    language="OCL"
)
hashCodeAndEquals: Constraint = Constraint(
    name="hashCodeAndEquals",
    context=javaMM_ClassDeclaration,
    expression="context ClassDeclaration inv: let hasEq : Boolean = getMethods->exists(isEquals),hasHc : Boolean = getMethods->exists(isHashcode)in(hasEq implies hasHc) and(hasHc implies hasEq)",
    language="OCL"
)
noCovariantEquals: Constraint = Constraint(
    name="noCovariantEquals",
    context=javaMM_ClassDeclaration,
    expression="context ClassDeclaration inv: getMethods->exists(method |method.name = 'equals' andmethod.modifier <> null andmethod.modifier.visibility = VisibilityKind_public andmethod.returnType.type.oclIsTypeOf(PrimitiveTypeBoolean)) implies getMethods->exists(isEquals)",
    language="OCL"
)
noCovariantCompareTo: Constraint = Constraint(
    name="noCovariantCompareTo",
    context=javaMM_ClassDeclaration,
    expression="context ClassDeclaration inv: getMethods->exists(method |method.name = 'compareTo' andmethod.modifier <> null andmethod.modifier.visibility = VisibilityKind_public andmethod.returnType.type.oclIsTypeOf(PrimitiveTypeInt)) implies getMethods->exists(isCompareTo)",
    language="OCL"
)
equalsAndCompareTo: Constraint = Constraint(
    name="equalsAndCompareTo",
    context=javaMM_ClassDeclaration,
    expression="context ClassDeclaration inv: getMethods->exists(isCompareTo) implies getMethods->exists(isEquals)",
    language="OCL"
)
cloneInCloneable: Constraint = Constraint(
    name="cloneInCloneable",
    context=javaMM_ClassDeclaration,
    expression="context ClassDeclaration inv: self.implements('Cloneable') implies self.getMethods->exists(isClone)",
    language="OCL"
)
serialUIDInSerializableClass: Constraint = Constraint(
    name="serialUIDInSerializableClass",
    context=javaMM_ClassDeclaration,
    expression="context ClassDeclaration inv: self.implements('Serializable') implies (self.bodyDeclarations->selectByKind(FieldDeclaration) ->exists(bd |bd.name = 'serialVersionUID' andbd.modifier._'static' andbd.modifier.inheritance = InheritanceKind_final andbd.type.type.oclIsTypeOf(PrimitiveTypeLong)))",
    language="OCL"
)
noRedundantInterfaceImpl: Constraint = Constraint(
    name="noRedundantInterfaceImpl",
    context=javaMM_ClassDeclaration,
    expression="context ClassDeclaration inv: (self.superInterfaces <> null andself.superClass <> null andself.superClass.type.oclIsKindOf(ClassDeclaration) andself.superClass.type.oclAsType(ClassDeclaration).superInterfaces <> null) implies (self.superInterfaces->exists(tIface |self.superClass.type.oclIsKindOf(AbstractTypeDeclaration) implies (self.superClass.type.oclAsType(AbstractTypeDeclaration).superInterfaces->includes(tIface))))",
    language="OCL"
)
comparatorImplementsSerializable: Constraint = Constraint(
    name="comparatorImplementsSerializable",
    context=javaMM_ClassDeclaration,
    expression="context ClassDeclaration inv: self.implements('Comparator') implies self.implements('Serializable')",
    language="OCL"
)
noObscuredVariables: Constraint = Constraint(
    name="noObscuredVariables",
    context=javaMM_ClassDeclaration,
    expression="context ClassDeclaration inv: let fields = self.bodyDeclarations->selectByKind(FieldDeclaration) inself.bodyDeclarations->selectByKind(AbstractMethodDeclaration) ->forAll(md | md._'body' <> null implies md._'body'.statements ->selectByKind(VariableDeclaration) ->forAll(vd | fields->forAll(fd | fd.name <> vd.name)))",
    language="OCL"
)
noRedundantComparison: Constraint = Constraint(
    name="noRedundantComparison",
    context=javaMM_InfixExpression,
    expression="context InfixExpression inv: self.leftOperand <> self.rightOperand",
    language="OCL"
)
equalsNotOnLiterals: Constraint = Constraint(
    name="equalsNotOnLiterals",
    context=javaMM_InfixExpression,
    expression="context InfixExpression inv: operatorIsEquality implies (self.leftOperand.oclIsTypeOf(self.rightOperand.oclType()) and(not (self.leftOperand.oclIsTypeOf(StringLiteral) orself.leftOperand.oclIsTypeOf(NumberLiteral) orself.leftOperand.oclIsTypeOf(CharacterLiteral) orself.leftOperand.oclIsTypeOf(BooleanLiteral) orself.leftOperand.oclIsTypeOf(NullLiteral) orself.leftOperand.oclIsTypeOf(TypeLiteral))))",
    language="OCL"
)
equalsNotOnStrings: Constraint = Constraint(
    name="equalsNotOnStrings",
    context=javaMM_InfixExpression,
    expression="context InfixExpression inv: operatorIsEquality implies (not(self.leftOperand.oclIsTypeOf(StringLiteral) orself.rightOperand.oclIsTypeOf(StringLiteral)))",
    language="OCL"
)
hasStatements: Constraint = Constraint(
    name="hasStatements",
    context=javaMM_SynchronizedStatement,
    expression="context SynchronizedStatement inv: self._'body'.statements->notEmpty()",
    language="OCL"
)
...
domain_model = DomainModel(
    name="javaMM",
    types={javaMM_SingleVariableDeclaration, javaMM_TypeAccess, javaMM_TypeParameter, javaMM_AbstractMethodDeclaration, BodyDeclaration, javaMM_Block, javaMM_MethodRef, javaMM_AbstractMethodInvocation, ASTNode, javaMM_Expression, javaMM_Package, javaMM_AbstractTypeQualifiedExpression, Expression, javaMM_AbstractTypeDeclaration, Type, javaMM_BodyDeclaration, javaMM_Comment, javaMM_ClassFile, javaMM_Manifest, javaMM_AssertStatement, Statement, javaMM_AbstractVariablesContainer, javaMM_VariableDeclarationFragment, javaMM_Annotation, javaMM_AnnotationMemberValuePair, javaMM_Archive, NamedElement, javaMM_ASTNode, javaMM_CompilationUnit, javaMM_AnnotationTypeMemberDeclaration, javaMM_AnnotationTypeDeclaration, AbstractTypeDeclaration, javaMM_ArrayLengthAccess, javaMM_AnonymousClassDeclaration, javaMM_ClassInstanceCreation, javaMM_ArrayAccess, javaMM_ArrayCreation, javaMM_ArrayInitializer, javaMM_ArrayType, javaMM_Assignment, javaMM_CastExpression, javaMM_Modifier, javaMM_BooleanLiteral, javaMM_BlockComment, Comment, javaMM_Statement, javaMM_BreakStatement, javaMM_LabeledStatement, AbstractMethodInvocation, javaMM_CatchClause, javaMM_CharacterLiteral, javaMM_ConstructorDeclaration, AbstractMethodDeclaration, javaMM_ConditionalExpression, javaMM_ConstructorInvocation, javaMM_ClassDeclaration, TypeDeclaration, javaMM_ImportDeclaration, javaMM_EmptyStatement, javaMM_EnhancedForStatement, javaMM_ContinueStatement, javaMM_DoStatement, javaMM_FieldAccess, javaMM_SingleVariableAccess, javaMM_EnumConstantDeclaration, VariableDeclaration, javaMM_EnumDeclaration, javaMM_ExpressionStatement, javaMM_FieldDeclaration, AbstractVariablesContainer, javaMM_ForStatement, javaMM_InfixExpression, javaMM_IfStatement, javaMM_NamedElement, javaMM_InterfaceDeclaration, javaMM_Javadoc, javaMM_TagElement, javaMM_Initializer, javaMM_InstanceofExpression, javaMM_MethodDeclaration, javaMM_LineComment, javaMM_ManifestAttribute, javaMM_ManifestEntry, javaMM_MemberRef, javaMM_MethodRefParameter, javaMM_MethodInvocation, javaMM_VariableDeclarationStatement, javaMM_VariableDeclarationExpression, javaMM_Model, javaMM_Type, javaMM_UnresolvedItem, javaMM_NamespaceAccess, javaMM_NumberLiteral, javaMM_NullLiteral, javaMM_PackageAccess, javaMM_ParenthesizedExpression, NamespaceAccess, javaMM_ParameterizedType, javaMM_VariableDeclaration, javaMM_PostfixExpression, javaMM_PrefixExpression, javaMM_PrimitiveType, javaMM_PrimitiveTypeBoolean, PrimitiveType, javaMM_PrimitiveTypeByte, javaMM_PrimitiveTypeChar, javaMM_PrimitiveTypeDouble, javaMM_PrimitiveTypeShort, javaMM_PrimitiveTypeFloat, javaMM_PrimitiveTypeInt, javaMM_PrimitiveTypeLong, javaMM_PrimitiveTypeVoid, javaMM_ReturnStatement, javaMM_SuperMethodInvocation, javaMM_SwitchCase, javaMM_StringLiteral, javaMM_SuperConstructorInvocation, javaMM_SuperFieldAccess, AbstractTypeQualifiedExpression, javaMM_SwitchStatement, javaMM_SynchronizedStatement, javaMM_TextElement, javaMM_ThisExpression, javaMM_ThrowStatement, javaMM_TryStatement, javaMM_UnresolvedItemAccess, javaMM_UnresolvedAnnotationDeclaration, AnnotationTypeDeclaration, UnresolvedItem, javaMM_UnresolvedAnnotationTypeMemberDeclaration, AnnotationTypeMemberDeclaration, javaMM_TypeDeclaration, javaMM_TypeDeclarationStatement, javaMM_TypeLiteral, javaMM_UnresolvedClassDeclaration, ClassDeclaration, javaMM_UnresolvedEnumDeclaration, EnumDeclaration, javaMM_UnresolvedInterfaceDeclaration, InterfaceDeclaration, javaMM_UnresolvedLabeledStatement, LabeledStatement, javaMM_UnresolvedMethodDeclaration, MethodDeclaration, javaMM_UnresolvedSingleVariableDeclaration, SingleVariableDeclaration, javaMM_UnresolvedType, javaMM_UnresolvedTypeDeclaration, javaMM_UnresolvedVariableDeclarationFragment, VariableDeclarationFragment, javaMM_WildCardType, javaMM_WhileStatement, AssignmentKind, InfixExpressionKind, VisibilityKind, InheritanceKind, PostfixExpressionKind, PrefixExpressionKind},
    associations={parameters1, thrownExceptions2, body0, typeParameters4, usagesInDocComments6, usages7, method9, arguments10, typeArguments11, package19, superInterfaces20, bodyDeclarations14, commentsBeforeBody15, commentsAfterBody16, classFiles32, manifest33, qualifier23, type25, fragments27, type28, values30, default52, type54, message35, expression37, comments40, originalCompilationUnit42, originalClassFile44, member47, value49, expressions73, usages57, bodyDeclarations58, classInstanceCreation60, array61, index63, dimensions66, initializer68, type70, abstractTypeDeclaration85, annotations86, array76, elementType78, leftHandSide80, rightHandSide82, expression94, anonymousClassDeclarationOwner88, modifier90, statements91, label93, anonymousClassDeclaration111, expression113, type96, exception99, body101, type103, attachedSource106, package109, type115, elseExpression118, expression120, thenExpression123, package133, superClass126, commentList128, imports131, body146, expression148, types136, label139, expression141, body143, expression159, field161, parameter151, anonymousClassDeclaration153, arguments154, enumConstants157, initializers170, body173, expression162, expression165, updaters167, importedElement184, expression176, thenStatement178, elseStatement181, rightOperand195, leftOperand197, rightOperand185, leftOperand187, extendedOperands190, body193, tags200, body201, usagesInBreakStatements203, usagesInContinueStatements204, mainAttributes206, entryAttributes208, attributes210, member213, qualifier214, qualifier228, parameters230, type232, returnType217, redefinedMethodDeclaration220, redefinitions222, expression224, method226, singleVariableDeclaration251, variableDeclarationStatement254, variableDeclarationExpression256, ownedElements235, orphanTypes237, unresolvedItems238, compilationUnits240, classFiles243, archives246, bodyDeclaration249, usagesInImports258, ownedElements259, model261, ownedPackages264, package268, type276, typeArguments278, expression281, usagesInPackageAccess270, package272, qualifier275, variable289, qualifier290, operand283, operand285, expression287, field306, expression308, modifier293, type295, annotations297, methodDeclaration300, catchClause302, enhancedForStatement303, expression304, body325, finally_327, catchClauses330, expression310, statements312, body315, expression317, fragments320, expression323, element346, qualifier348, usagesInTypeAccess333, type334, qualifier335, typeParameters337, declaration339, type341, bounds343, modifier354, annotations356, initializer351, usageInVariableAccess353, annotations361, bound363, variablesContainer358, modifier359, expression365, body367},
    constraints={allImportsAreUsed, notReservedWord, shouldStartWithUpperCase, shouldStartWithLowerCase, doesNotCallFinalize, doesNotCallExit, doesNotCallRunFinalizers, canBeLocal, localMethodIsUsed, parametersEffectivelyFinal, noRedundantAssignment, variableIsUsed, publicVariableIsFinal, publicVariableIsFinal1, exceptionIsUsed, doesNotCatchDubiousExceptions, emptyBlockIsDocumented, moreThan3Cases, noRedundantSuperCall, noDeadCode, noUselessControlFlow, publicFieldsOnlyInPOJO, hashCodeAndEquals, noCovariantEquals, noCovariantCompareTo, equalsAndCompareTo, cloneInCloneable, serialUIDInSerializableClass, noRedundantInterfaceImpl, comparatorImplementsSerializable, noObscuredVariables, noRedundantComparison, equalsNotOnLiterals, equalsNotOnStrings, hasStatements},
    generalizations={gen_javaMM_AbstractMethodDeclaration_BodyDeclaration, gen_javaMM_AbstractMethodInvocation_ASTNode, gen_javaMM_AbstractTypeDeclaration_BodyDeclaration, gen_javaMM_AbstractTypeDeclaration_Type, gen_javaMM_AssertStatement_Statement, gen_javaMM_AbstractTypeQualifiedExpression_Expression, gen_javaMM_AbstractVariablesContainer_ASTNode, gen_javaMM_Annotation_Expression, gen_javaMM_Archive_NamedElement, gen_javaMM_AnnotationMemberValuePair_NamedElement, gen_javaMM_AnnotationTypeDeclaration_AbstractTypeDeclaration, gen_javaMM_AnnotationTypeMemberDeclaration_BodyDeclaration, gen_javaMM_ArrayInitializer_Expression, gen_javaMM_ArrayLengthAccess_Expression, gen_javaMM_AnonymousClassDeclaration_ASTNode, gen_javaMM_ArrayAccess_Expression, gen_javaMM_ArrayCreation_Expression, gen_javaMM_ArrayType_Type, gen_javaMM_Assignment_Expression, gen_javaMM_BodyDeclaration_NamedElement, gen_javaMM_CastExpression_Expression, gen_javaMM_BooleanLiteral_Expression, gen_javaMM_BlockComment_Comment, gen_javaMM_Block_Statement, gen_javaMM_BreakStatement_Statement, gen_javaMM_ClassInstanceCreation_Expression, gen_javaMM_ClassInstanceCreation_AbstractMethodInvocation, gen_javaMM_CatchClause_Statement, gen_javaMM_CharacterLiteral_Expression, gen_javaMM_ClassFile_NamedElement, gen_javaMM_ConstructorDeclaration_AbstractMethodDeclaration, gen_javaMM_ConditionalExpression_Expression, gen_javaMM_ConstructorInvocation_Statement, gen_javaMM_ConstructorInvocation_AbstractMethodInvocation, gen_javaMM_ClassDeclaration_TypeDeclaration, gen_javaMM_Comment_ASTNode, gen_javaMM_CompilationUnit_NamedElement, gen_javaMM_EmptyStatement_Statement, gen_javaMM_EnhancedForStatement_Statement, gen_javaMM_ContinueStatement_Statement, gen_javaMM_DoStatement_Statement, gen_javaMM_FieldAccess_Expression, gen_javaMM_EnumConstantDeclaration_BodyDeclaration, gen_javaMM_EnumConstantDeclaration_VariableDeclaration, gen_javaMM_EnumDeclaration_AbstractTypeDeclaration, gen_javaMM_Expression_ASTNode, gen_javaMM_ExpressionStatement_Statement, gen_javaMM_FieldDeclaration_BodyDeclaration, gen_javaMM_FieldDeclaration_AbstractVariablesContainer, gen_javaMM_ForStatement_Statement, gen_javaMM_InfixExpression_Expression, gen_javaMM_IfStatement_Statement, gen_javaMM_ImportDeclaration_ASTNode, gen_javaMM_InterfaceDeclaration_TypeDeclaration, gen_javaMM_Javadoc_Comment, gen_javaMM_Initializer_BodyDeclaration, gen_javaMM_InstanceofExpression_Expression, gen_javaMM_MethodDeclaration_AbstractMethodDeclaration, gen_javaMM_LabeledStatement_NamedElement, gen_javaMM_LabeledStatement_Statement, gen_javaMM_LineComment_Comment, gen_javaMM_MemberRef_ASTNode, gen_javaMM_MethodRefParameter_ASTNode, gen_javaMM_MethodInvocation_Expression, gen_javaMM_MethodInvocation_AbstractMethodInvocation, gen_javaMM_MethodRef_ASTNode, gen_javaMM_NamedElement_ASTNode, gen_javaMM_Modifier_ASTNode, gen_javaMM_NamespaceAccess_ASTNode, gen_javaMM_NumberLiteral_Expression, gen_javaMM_NullLiteral_Expression, gen_javaMM_Package_NamedElement, gen_javaMM_ParenthesizedExpression_Expression, gen_javaMM_PackageAccess_NamespaceAccess, gen_javaMM_ParameterizedType_Type, gen_javaMM_SingleVariableAccess_Expression, gen_javaMM_SingleVariableDeclaration_VariableDeclaration, gen_javaMM_PostfixExpression_Expression, gen_javaMM_PrefixExpression_Expression, gen_javaMM_PrimitiveType_Type, gen_javaMM_PrimitiveTypeBoolean_PrimitiveType, gen_javaMM_PrimitiveTypeByte_PrimitiveType, gen_javaMM_PrimitiveTypeChar_PrimitiveType, gen_javaMM_PrimitiveTypeDouble_PrimitiveType, gen_javaMM_PrimitiveTypeShort_PrimitiveType, gen_javaMM_PrimitiveTypeFloat_PrimitiveType, gen_javaMM_PrimitiveTypeInt_PrimitiveType, gen_javaMM_PrimitiveTypeLong_PrimitiveType, gen_javaMM_PrimitiveTypeVoid_PrimitiveType, gen_javaMM_ReturnStatement_Statement, gen_javaMM_SuperMethodInvocation_AbstractTypeQualifiedExpression, gen_javaMM_SuperMethodInvocation_AbstractMethodInvocation, gen_javaMM_SwitchCase_Statement, gen_javaMM_Statement_ASTNode, gen_javaMM_StringLiteral_Expression, gen_javaMM_SuperConstructorInvocation_Statement, gen_javaMM_SuperConstructorInvocation_AbstractMethodInvocation, gen_javaMM_SuperFieldAccess_AbstractTypeQualifiedExpression, gen_javaMM_Type_NamedElement, gen_javaMM_SwitchStatement_Statement, gen_javaMM_SynchronizedStatement_Statement, gen_javaMM_TagElement_ASTNode, gen_javaMM_TextElement_ASTNode, gen_javaMM_ThisExpression_AbstractTypeQualifiedExpression, gen_javaMM_ThrowStatement_Statement, gen_javaMM_TryStatement_Statement, gen_javaMM_UnresolvedItemAccess_Expression, gen_javaMM_UnresolvedItemAccess_NamespaceAccess, gen_javaMM_UnresolvedAnnotationDeclaration_AnnotationTypeDeclaration, gen_javaMM_UnresolvedAnnotationDeclaration_UnresolvedItem, gen_javaMM_UnresolvedAnnotationTypeMemberDeclaration_AnnotationTypeMemberDeclaration, gen_javaMM_UnresolvedAnnotationTypeMemberDeclaration_UnresolvedItem, gen_javaMM_TypeAccess_Expression, gen_javaMM_TypeAccess_NamespaceAccess, gen_javaMM_TypeDeclaration_AbstractTypeDeclaration, gen_javaMM_TypeDeclarationStatement_Statement, gen_javaMM_TypeLiteral_Expression, gen_javaMM_TypeParameter_Type, gen_javaMM_UnresolvedItem_NamedElement, gen_javaMM_UnresolvedClassDeclaration_ClassDeclaration, gen_javaMM_UnresolvedClassDeclaration_UnresolvedItem, gen_javaMM_UnresolvedEnumDeclaration_EnumDeclaration, gen_javaMM_UnresolvedEnumDeclaration_UnresolvedItem, gen_javaMM_UnresolvedInterfaceDeclaration_InterfaceDeclaration, gen_javaMM_UnresolvedInterfaceDeclaration_UnresolvedItem, gen_javaMM_UnresolvedLabeledStatement_LabeledStatement, gen_javaMM_UnresolvedLabeledStatement_UnresolvedItem, gen_javaMM_UnresolvedMethodDeclaration_MethodDeclaration, gen_javaMM_UnresolvedMethodDeclaration_UnresolvedItem, gen_javaMM_UnresolvedSingleVariableDeclaration_SingleVariableDeclaration, gen_javaMM_UnresolvedSingleVariableDeclaration_UnresolvedItem, gen_javaMM_UnresolvedType_Type, gen_javaMM_UnresolvedType_UnresolvedItem, gen_javaMM_UnresolvedTypeDeclaration_AbstractTypeDeclaration, gen_javaMM_UnresolvedTypeDeclaration_UnresolvedItem, gen_javaMM_UnresolvedVariableDeclarationFragment_VariableDeclarationFragment, gen_javaMM_UnresolvedVariableDeclarationFragment_UnresolvedItem, gen_javaMM_VariableDeclaration_NamedElement, gen_javaMM_VariableDeclarationExpression_Expression, gen_javaMM_VariableDeclarationExpression_AbstractVariablesContainer, gen_javaMM_WildCardType_Type, gen_javaMM_VariableDeclarationFragment_VariableDeclaration, gen_javaMM_VariableDeclarationStatement_Statement, gen_javaMM_VariableDeclarationStatement_AbstractVariablesContainer, gen_javaMM_WhileStatement_Statement},
    metadata=None
)
