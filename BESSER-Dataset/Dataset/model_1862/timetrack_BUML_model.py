...
timetrack_User.attributes={timetrack_User_sap_name, timetrack_User_name, timetrack_User_sap_password, timetrack_User_password}
...
timetrack_TimeEntry.attributes={timetrack_TimeEntry_duration, timetrack_TimeEntry_till, timetrack_TimeEntry_from_, timetrack_TimeEntry_day, timetrack_TimeEntry_factured, timetrack_TimeEntry_notes, timetrack_TimeEntry_sync_date}
...
domain_model = DomainModel(
    ...
    associations={listBook3, listTimeEntry5, listProject8, user0, project1},
    generalizations={},
    metadata=None
)
