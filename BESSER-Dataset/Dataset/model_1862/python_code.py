...
class timetrack_TimeEntry:
    ...
    def __init__(self, day: date, from_: date, till: date, duration: date, factured: bool, notes: str, sync_date: date, timetrack_TimeEntry7: "timetrack_Library" = None, timetrack_TimeEntry: "timetrack_User" = None, timetrack_TimeEntry2: "timetrack_Project" = None):
        self.day = day
        self.from_ = from_
        self.till = till
...
class timetrack_Project:
    ...
    def __init__(self, number: str, name: str, timetrack_Project10: "timetrack_Library" = None, timetrack_Project: "timetrack_TimeEntry" = None):
        self.number = number
        self.name = name
