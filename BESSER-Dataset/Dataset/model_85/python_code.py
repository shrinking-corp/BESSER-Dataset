...
class java_ClassFile(NamedElement):
    ...
    def __init__(self, originalFilePath: str, java_ClassFile45: "java_ASTNode" = None, java_ClassFile103: "java_AbstractTypeDeclaration" = None, java_ClassFile106: "java_CompilationUnit" = None, java_ClassFile109: "java_Package" = None, java_ClassFile: "java_Archive" = None, java_ClassFile245: "java_Model" = None):
...
class java_MethodDeclaration(AbstractMethodDeclaration):
    ...
    def __init__(self, extraArrayDimensions: int, MethodDeclaration222: "java_MethodDeclaration" = None, redefinedMethodDeclaration: set["java_MethodDeclaration"] = None, java_MethodDeclaration: "java_TypeAccess" = None, MethodDeclaration: "java_MethodDeclaration" = None, redefinitions: "java_MethodDeclaration" = None):
        self.extraArrayDimensions = extraArrayDimensions
...
class java_Model:
    ...
    def __init__(self, name: str, model: set["java_Package"] = None, Model: "java_Package" = None, java_Model: set["java_Type"] = None, java_Model239: set["java_UnresolvedItem"] = None, java_Model241: set["java_CompilationUnit"] = None, java_Model244: set["java_ClassFile"] = None, java_Model247: set["java_Archive"] = None):
        self.name = name
...
class java_ImportDeclaration(ASTNode):
    ...
    def __init__(self, static: bool, java_ImportDeclaration184: "java_NamedElement" = None, java_ImportDeclaration: "java_CompilationUnit" = None):
        self.static = static
