...
def test_hyp_classdiagram_model_is_not_abstract():
    assert not inspect.isabstract(ClassDiagram_Model)


def test_hyp_classdiagram_model_constructor_exists():
    assert callable(ClassDiagram_Model.__init__)


def test_hyp_classdiagram_model_constructor_args():
...
def test_hyp_classdiagram_operation_is_not_abstract():
    assert not inspect.isabstract(ClassDiagram_Operation)


def test_hyp_classdiagram_operation_constructor_exists():
    assert callable(ClassDiagram_Operation.__init__)


def test_hyp_classdiagram_operation_constructor_args():
    sig = inspect.signature(ClassDiagram_Operation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_classdiagram_typedelement_is_not_abstract():
    assert not inspect.isabstract(ClassDiagram_TypedElement)


def test_hyp_classdiagram_typedelement_constructor_exists():
    assert callable(ClassDiagram_TypedElement.__init__)


def test_hyp_classdiagram_typedelement_constructor_args():
...
def test_hyp_classdiagram_parameter_is_not_abstract():
    assert not inspect.isabstract(ClassDiagram_Parameter)


def test_hyp_classdiagram_parameter_constructor_exists():
    assert callable(ClassDiagram_Parameter.__init__)


def test_hyp_classdiagram_parameter_constructor_args():
...
def test_hyp_classdiagram_structuralfeature_is_not_abstract():
    assert not inspect.isabstract(ClassDiagram_StructuralFeature)


def test_hyp_classdiagram_structuralfeature_constructor_exists():
    assert callable(ClassDiagram_StructuralFeature.__init__)


def test_hyp_classdiagram_structuralfeature_constructor_args():
...
def test_hyp_classdiagram_primitivetype_is_not_abstract():
    assert not inspect.isabstract(ClassDiagram_PrimitiveType)


def test_hyp_classdiagram_primitivetype_constructor_exists():
    assert callable(ClassDiagram_PrimitiveType.__init__)


def test_hyp_classdiagram_primitivetype_constructor_args():
...
def test_hyp_classdiagram_parameter_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_classdiagram_structuralfeature_visibility_setter(instance):
...
@given(instance=ClassDiagram_StructuralFeature_strategy)
def test_hyp_classdiagram_structuralfeature_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
