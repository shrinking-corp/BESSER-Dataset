...
ClassDiagram_StructuralFeature = Class(name="ClassDiagram_StructuralFeature", is_abstract=True)
TypedElement = Class(name="TypedElement")
ClassDiagram_TypedElement = Class(name="ClassDiagram_TypedElement")
ClassDiagram_PrimitiveType = Class(name="ClassDiagram_PrimitiveType")
ClassDiagram_Operation = Class(name="ClassDiagram_Operation")
StructuralFeature = Class(name="StructuralFeature")
ClassDiagram_Parameter = Class(name="ClassDiagram_Parameter")
ClassDiagram_Model = Class(name="ClassDiagram_Model")
ClassDiagram_Classifier = Class(name="ClassDiagram_Classifier")
...
domain_model = DomainModel(
    name="ClassDiagram",
    types={ClassDiagram_Class, Classifier, ClassDiagram_StructuralFeature, TypedElement, ClassDiagram_TypedElement, ClassDiagram_PrimitiveType, ClassDiagram_Operation, StructuralFeature, ClassDiagram_Parameter, ClassDiagram_Model, ClassDiagram_Classifier, ClassDiagram_Attribute},
    associations={features1, parents3, childs5, owner7, type9, params11, paramOf12, classifiers0},
