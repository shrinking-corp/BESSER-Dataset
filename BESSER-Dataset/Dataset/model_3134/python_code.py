...
class ClassDiagram_Classifier:
    ...
    def __init__(self, name: str, ClassDiagram_Classifier10: "ClassDiagram_TypedElement" = None, ClassDiagram_Classifier: "ClassDiagram_Model" = None):
        self.name = name
...
class ClassDiagram_StructuralFeature(TypedElement):
    ...
    def __init__(self, visibility: str, name: str, StructuralFeature: "ClassDiagram_Class" = None, features: "ClassDiagram_Class" = None):
