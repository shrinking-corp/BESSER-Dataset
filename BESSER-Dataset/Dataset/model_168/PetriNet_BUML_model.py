...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={PetriNet_Element, PetriNet_PetriNet, Element, Place, Transition, Arc, PetriNet_Place, TransToPlaceArc, PlaceToTransArc, PetriNet, PetriNet_Transition, PetriNet_TransToPlaceArc, PetriNet_NonReferencedClass, PetriNet_WeightedArc, PetriNet_Arc, PetriNet_PlaceToTransArc},
    associations={places0, transitions1, arcs3, incoming5, outgoing6, net7, source14, target16, source18, target21, incoming8, outgoing11},
