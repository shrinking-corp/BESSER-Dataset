...
class uma_WorkProductDescriptor(Descriptor):
    ...
    def __init__(self, outputFrom: str, deliverableParts: str, activityEntryState: str, activityExitState: str, workProduct: str, responsibleRole: str, group2: str, externalInputTo: str, impactedBy: str, impacts: str, mandatoryInputTo: str, optionalInputTo: str, uma_WorkProductDescriptor: "uma_ProcessComponentInterface" = None):
...
class uma_Process(Activity):
    ...
    def __init__(self, defaultContext: str, validContext: str, diagramURI: str, includesPattern: str, uma_Process: "uma_ProcessComponent" = None):
...
class uma_ProcessComponentInterface(BreakdownElement):
    ...
    def __init__(self, group2: str, uma_ProcessComponentInterface45: set["uma_WorkProductDescriptor"] = None, uma_ProcessComponentInterface: "uma_ProcessComponent" = None, uma_ProcessComponentInterface43: set["uma_TaskDescriptor"] = None):
        self.group2 = group2
...
class uma_TaskDescriptor(WorkBreakdownElement):
    ...
    def __init__(self, assistedBy: str, externalInput: str, mandatoryInput: str, optionalInput: str, output: str, task: str, group3: str, performedPrimarilyBy: str, additionallyPerformedBy: str, isSynchronizedWithSource: str, uma_TaskDescriptor: "uma_ProcessComponentInterface" = None, uma_TaskDescriptor51: set["uma_Section"] = None):
...
class uma_WorkProduct(ContentElement):
    ...
    def __init__(self, template: str, toolMentor: str, group2: str, estimate: str, estimationConsiderations: str, report: str):
...
class uma_MethodUnit(MethodElement):
    ...
    def __init__(self, authors: str, changeDate: str, changeDescription: str, version: str, copyright: str):
        self.authors = authors
        self.changeDate = changeDate
        self.changeDescription = changeDescription
        self.version = version
...
class uma_MethodElement(PackageableElement):
    ...
    def __init__(self, briefDescription: str, id: str, orderingGuide: str, presentationName: str, group: str, suppressed: str, uma_MethodElement: set["uma_Constraint"] = None, uma_MethodElement25: set["uma_MethodElementProperty"] = None):
...
class uma_PlanningData(ProcessElement):
    ...
    def __init__(self, startDate: str, finishDate: str, rank: str):
