...
coCoMM_DecisionRule = Class(name="coCoMM_DecisionRule")
...
coCoMM_SelectionStateDR = Class(name="coCoMM_SelectionStateDR")
DecisionRule = Class(name="DecisionRule")
coCoMM_HardLimitDR = Class(name="coCoMM_HardLimitDR")
...
coCoMM_OptimizationDR = Class(name="coCoMM_OptimizationDR")
...
domain_model = DomainModel(
    name="coCoMM",
    types={coCoMM_FeatureModel, coCoMM_Feature, coCoMM_CrossTreeConstraint, coCoMM_AttributeType, coCoMM_AttributeTypeElement, coCoMM_FeatureAttributeElement, coCoMM_TreeConstraint, coCoMM_FeatureAttribute, coCoMM_DecisionRule, coCoMM_Project, coCoMM_Stakeholder, coCoMM_CMConstraintExpression, coCoMM_SelectionStateDR, DecisionRule, coCoMM_HardLimitDR, coCoMM_CTConstraintExpression, coCoMM_CoCo, coCoMM_CrossModelConstraint, coCoMM_OptimizationDR, coCoMM_Config, coCoMM_HardLimitDRExpression, TreeConstraintType, DataType, CMConstraintType, CTConstraintType, DROptimizationOp, DRHardLimitOp, DRType, DRSelectionStateType, ConfigType},
    associations={root0, ctConstraints1, children10, independentAttrType14, elements15, featureAttributes17, attrType20, elements23, treeConstraints3, featureModel5, featureAttributes8, decisionRules31, attributeTypes33, project36, stakeholders38, expressions40, featureModel42, feature44, expressions25, featureModels27, cmConstraints29, attrType51, decisionRules53, configs56, stakeholder58, expressions47, attrType48, features64, expressions68, features70, expressions74, features61},
