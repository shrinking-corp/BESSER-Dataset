...
# Classes
fsm_FiniteStateMachine = Class(name="fsm_FiniteStateMachine")
...
fsm_FiniteStateMachine_m_initializeModel: Method = Method(name="initializeModel", parameters={Parameter(name='fsm_args', type=StringType)})
fsm_FiniteStateMachine.attributes={fsm_FiniteStateMachine_unprocessedString, fsm_FiniteStateMachine_name, fsm_FiniteStateMachine_producedString, fsm_FiniteStateMachine_consummedString}
fsm_FiniteStateMachine.methods={fsm_FiniteStateMachine_m_main, fsm_FiniteStateMachine_m_initializeModel}
...
fsm_Transition.attributes={fsm_Transition_name, fsm_Transition_output, fsm_Transition_input}
...
domain_model = DomainModel(
    ...
    associations={states0, currentState1, outgoingTransitions4, target6},
    generalizations={},
    metadata=None
)
