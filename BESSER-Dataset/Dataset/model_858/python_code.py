...
class fsm_Transition:
    ...
    def __init__(self, name: str, input: str, output: str, fsm_Transition: "fsm_State" = None, fsm_Transition7: "fsm_State" = None):
        self.name = name
        self.input = input
        self.output = output
...
class fsm_State:
    ...
    def __init__(self, name: str, isInitialState: bool, fsm_State: "fsm_FiniteStateMachine" = None, fsm_State3: "fsm_FiniteStateMachine" = None, fsm_State5: set["fsm_Transition"] = None, fsm_State8: "fsm_Transition" = None):
        self.name = name
