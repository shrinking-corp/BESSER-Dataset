...
# Classes
umlstatemachineselect_StateMachine = Class(name="umlstatemachineselect_StateMachine")
Behavior = Class(name="Behavior")
umlstatemachineselect_Region = Class(name="umlstatemachineselect_Region")
umlstatemachineselect_State = Class(name="umlstatemachineselect_State")
umlstatemachineselect_PseudoState = Class(name="umlstatemachineselect_PseudoState")
umlstatemachineselect_Transition = Class(name="umlstatemachineselect_Transition")
umlstatemachineselect_Behavior = Class(name="umlstatemachineselect_Behavior")
umlstatemachineselect_Constraint = Class(name="umlstatemachineselect_Constraint")
umlstatemachineselect_Trigger = Class(name="umlstatemachineselect_Trigger")
umlstatemachineselect_Vertex = Class(name="umlstatemachineselect_Vertex", is_abstract=True)
umlstatemachineselect_ConnectionPointReference = Class(name="umlstatemachineselect_ConnectionPointReference")
umlstatemachineselect_FinalState = Class(name="umlstatemachineselect_FinalState")
State = Class(name="State")
Vertex = Class(name="Vertex")
umlstatemachineselect_Event = Class(name="umlstatemachineselect_Event")
...
umlstatemachineselect_State.attributes={umlstatemachineselect_State_isOrthogonal, umlstatemachineselect_State_isSimple, umlstatemachineselect_State_isComposite, umlstatemachineselect_State_isSubmachineState}
...
domain_model = DomainModel(
    ...
    types={umlstatemachineselect_StateMachine, Behavior, umlstatemachineselect_Region, umlstatemachineselect_State, umlstatemachineselect_PseudoState, umlstatemachineselect_Transition, umlstatemachineselect_Behavior, umlstatemachineselect_Constraint, umlstatemachineselect_Trigger, umlstatemachineselect_Vertex, umlstatemachineselect_ConnectionPointReference, umlstatemachineselect_FinalState, State, Vertex, umlstatemachineselect_Event, TransitionKind, PseudostateKind},
    associations={region0, submachineState1, connectionPoint2, stateMachine4, transition6, state8, container11, outgoing13, incoming15, container17, target19, source21, effect23, guard24, trigger26, subvertex5, region28, connection30, submachine32, entry34, exit36, doActivity39, stateInvariant42, deferrableTrigger45, stateMachine48, state50, entry52, exit53, event56},
    generalizations={gen_umlstatemachineselect_StateMachine_Behavior, gen_umlstatemachineselect_FinalState_State, gen_umlstatemachineselect_PseudoState_Vertex, gen_umlstatemachineselect_ConnectionPointReference_Vertex, gen_umlstatemachineselect_State_Vertex},
    metadata=None
)
