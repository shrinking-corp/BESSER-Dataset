...
class umlstatemachineselect_Transition:
    ...
    def __init__(self, kind: str, Transition: "umlstatemachineselect_Region" = None, Transition14: "umlstatemachineselect_Vertex" = None, Transition16: "umlstatemachineselect_Vertex" = None, transition: "umlstatemachineselect_Region" = None, incoming: "umlstatemachineselect_Vertex" = None, outgoing: "umlstatemachineselect_Vertex" = None, umlstatemachineselect_Transition: "umlstatemachineselect_Behavior" = None, umlstatemachineselect_Transition25: "umlstatemachineselect_Constraint" = None, umlstatemachineselect_Transition27: set["umlstatemachineselect_Trigger"] = None):
        self.kind = kind
...
class umlstatemachineselect_State(Vertex):
    ...
    def __init__(self, isComposite: bool, isOrthogonal: bool, isSimple: bool, isSubmachineState: bool, State: "umlstatemachineselect_StateMachine" = None, State10: "umlstatemachineselect_Region" = None, state: set["umlstatemachineselect_Region"] = None, state31: set["umlstatemachineselect_ConnectionPointReference"] = None, submachineState: "umlstatemachineselect_StateMachine" = None, umlstatemachineselect_State: "umlstatemachineselect_Behavior" = None, umlstatemachineselect_State37: "umlstatemachineselect_Behavior" = None, umlstatemachineselect_State40: "umlstatemachineselect_Behavior" = None, umlstatemachineselect_State43: "umlstatemachineselect_Constraint" = None, umlstatemachineselect_State46: set["umlstatemachineselect_Trigger"] = None, State51: "umlstatemachineselect_ConnectionPointReference" = None):
