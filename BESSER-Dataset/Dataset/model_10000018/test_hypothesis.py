...
def test_server_actor_is_not_abstract():
    assert not inspect.isabstract(Server_Actor)


def test_server_actor_constructor_exists():
    assert callable(Server_Actor.__init__)


def test_server_actor_constructor_args():
    sig = inspect.signature(Server_Actor.__init__)
    params = list(sig.parameters.keys())



def test_splash_screen_loading_actor_is_not_abstract():
    assert not inspect.isabstract(Splash_Screen_Loading_Actor)


def test_splash_screen_loading_actor_constructor_exists():
    assert callable(Splash_Screen_Loading_Actor.__init__)


def test_splash_screen_loading_actor_constructor_args():
