...
Splash_Screen_Loading_Actor = Class(name="Splash_Screen_Loading_Actor")
Server_Actor = Class(name="Server_Actor")
...
# Splash_Screen_Loading_Actor class attributes and methods

# Server_Actor class attributes and methods
...
domain_model = DomainModel(
    name="_03736215_ef06_40b0_99bc_dfa8bdb4d35b",
    types={ShoppingCartExample_ShoppingCart, ShoppingCartExample_Order, ShoppingCartExample_LineItem, ShoppingCartExample_Account, ShoppingCartExample_Customer, Splash_Screen_Loading_Actor, Server_Actor},
