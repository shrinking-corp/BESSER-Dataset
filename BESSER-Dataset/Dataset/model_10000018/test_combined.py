...
def test_hyp_server_actor_is_not_abstract():
    assert not inspect.isabstract(Server_Actor)


def test_hyp_server_actor_constructor_exists():
    assert callable(Server_Actor.__init__)


def test_hyp_server_actor_constructor_args():
    sig = inspect.signature(Server_Actor.__init__)
    params = list(sig.parameters.keys())



def test_hyp_splash_screen_loading_actor_is_not_abstract():
    assert not inspect.isabstract(Splash_Screen_Loading_Actor)


def test_hyp_splash_screen_loading_actor_constructor_exists():
    assert callable(Splash_Screen_Loading_Actor.__init__)


def test_hyp_splash_screen_loading_actor_constructor_args():
    sig = inspect.signature(Splash_Screen_Loading_Actor.__init__)
    params = list(sig.parameters.keys())
...
Server_Actor_strategy = st.builds(
    Server_Actor,
)
Splash_Screen_Loading_Actor_strategy = st.builds(
    Splash_Screen_Loading_Actor,
)
...
Server_Actor_strategy = st.builds(Server_Actor)
@given(instance=Server_Actor_strategy)
@settings(max_examples=25)
def test_Server_Actor_instantiation(instance):
    assert isinstance(instance, Server_Actor)
...
Splash_Screen_Loading_Actor_strategy = st.builds(Splash_Screen_Loading_Actor)
@given(instance=Splash_Screen_Loading_Actor_strategy)
@settings(max_examples=25)
def test_Splash_Screen_Loading_Actor_instantiation(instance):
    assert isinstance(instance, Splash_Screen_Loading_Actor)
