...
class entities_Field:
    ...
    def __init__(self, name: str, entities_Field: "entities_Entity" = None, entities_Field11: "entities_AssignmentStatement" = None, entities_Field13: "entities_FieldType" = None, entities_Field17: "entities_FieldRef" = None):
        self.name = name
