...
entities_Field = Class(name="entities_Field")
entities_Statement = Class(name="entities_Statement")
entities_Expression = Class(name="entities_Expression")
entities_AssignmentStatement = Class(name="entities_AssignmentStatement")
Statement = Class(name="Statement")
entities_PrintStatement = Class(name="entities_PrintStatement")
entities_FieldType = Class(name="entities_FieldType")
entities_StringConstant = Class(name="entities_StringConstant")
entities_BoolConstant = Class(name="entities_BoolConstant")
entities_FieldRef = Class(name="entities_FieldRef")
...
entities_IntConstant = Class(name="entities_IntConstant")
...
domain_model = DomainModel(
    name="entities",
    types={entities_Model, entities_Entity, entities_Field, entities_Statement, entities_Expression, entities_AssignmentStatement, Statement, entities_PrintStatement, entities_FieldType, entities_StringConstant, entities_BoolConstant, entities_FieldRef, entities_BasicType, FieldType, entities_EntityType, entities_IntConstant, Expression},
    associations={entities0, superType2, fields4, statements6, expr8, assignee10, type12, field16, entity14},
    generalizations={gen_entities_AssignmentStatement_Statement, gen_entities_PrintStatement_Statement, gen_entities_StringConstant_Expression, gen_entities_BoolConstant_Expression, gen_entities_FieldRef_Expression, gen_entities_BasicType_FieldType, gen_entities_EntityType_FieldType, gen_entities_IntConstant_Expression},
    metadata=None
)
