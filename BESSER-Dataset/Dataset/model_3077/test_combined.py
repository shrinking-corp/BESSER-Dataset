...
def test_hyp_entities_intconstant_is_not_abstract():
    assert not inspect.isabstract(entities_IntConstant)


def test_hyp_entities_intconstant_constructor_exists():
    assert callable(entities_IntConstant.__init__)


def test_hyp_entities_intconstant_constructor_args():
...
def test_hyp_fieldtype_is_not_abstract():
    assert not inspect.isabstract(FieldType)


def test_hyp_fieldtype_constructor_exists():
    assert callable(FieldType.__init__)


def test_hyp_fieldtype_constructor_args():
...
def test_hyp_entities_fieldref_is_not_abstract():
    assert not inspect.isabstract(entities_FieldRef)


def test_hyp_entities_fieldref_constructor_exists():
    assert callable(entities_FieldRef.__init__)


def test_hyp_entities_fieldref_constructor_args():
    sig = inspect.signature(entities_FieldRef.__init__)
    params = list(sig.parameters.keys())



def test_hyp_entities_boolconstant_is_not_abstract():
    assert not inspect.isabstract(entities_BoolConstant)


def test_hyp_entities_boolconstant_constructor_exists():
    assert callable(entities_BoolConstant.__init__)


def test_hyp_entities_boolconstant_constructor_args():
...
def test_hyp_entities_stringconstant_is_not_abstract():
    assert not inspect.isabstract(entities_StringConstant)


def test_hyp_entities_stringconstant_constructor_exists():
    assert callable(entities_StringConstant.__init__)


def test_hyp_entities_stringconstant_constructor_args():
...
def test_hyp_entities_fieldtype_is_not_abstract():
    assert not inspect.isabstract(entities_FieldType)


def test_hyp_entities_fieldtype_constructor_exists():
    assert callable(entities_FieldType.__init__)


def test_hyp_entities_fieldtype_constructor_args():
...
def test_hyp_entities_printstatement_is_not_abstract():
    assert not inspect.isabstract(entities_PrintStatement)


def test_hyp_entities_printstatement_constructor_exists():
    assert callable(entities_PrintStatement.__init__)


def test_hyp_entities_printstatement_constructor_args():
    sig = inspect.signature(entities_PrintStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_entities_assignmentstatement_is_not_abstract():
    assert not inspect.isabstract(entities_AssignmentStatement)


def test_hyp_entities_assignmentstatement_constructor_exists():
    assert callable(entities_AssignmentStatement.__init__)


def test_hyp_entities_assignmentstatement_constructor_args():
    sig = inspect.signature(entities_AssignmentStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_entities_expression_is_not_abstract():
    assert not inspect.isabstract(entities_Expression)


def test_hyp_entities_expression_constructor_exists():
    assert callable(entities_Expression.__init__)


def test_hyp_entities_expression_constructor_args():
    sig = inspect.signature(entities_Expression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_entities_statement_is_not_abstract():
    assert not inspect.isabstract(entities_Statement)


def test_hyp_entities_statement_constructor_exists():
    assert callable(entities_Statement.__init__)


def test_hyp_entities_statement_constructor_args():
    sig = inspect.signature(entities_Statement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_entities_field_is_not_abstract():
    assert not inspect.isabstract(entities_Field)


def test_hyp_entities_field_constructor_exists():
    assert callable(entities_Field.__init__)


def test_hyp_entities_field_constructor_args():
...
def test_hyp_entities_intconstant_value_setter(instance):
...
def test_hyp_entities_boolconstant_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_entities_stringconstant_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_entities_field_name_setter(instance):
