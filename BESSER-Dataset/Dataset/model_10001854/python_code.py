...
class CertificatesOfDepositAccount:
...
class TransferTransaction:
    ...
    def __init__(self, targetAccount: Account, sourceAccount: Account):
    ...
    def sourceAccount(self, sourceAccount: Account):
    ...
    def targetAccount(self, targetAccount: Account):
...
class Login:
    ...
    def __init__(self, username: str, password: str, securityQuestion: str, securityAnswer: str, lastLoginTime: date, customer5: "Customer" = None):
...
class Transaction:
    ...
    def __init__(self, id: int, type: TransactionType, transactionTime: date, amount: float, account3: "Account" = None):
        self.id = id
        self.type = type
...
class Account:
    ...
    def __init__(self, accountNo: str, type: AccountType, balance: float, c0: "Customer" = None, transactions2: set["Transaction"] = None):
    ...
    def type(self):
        return self.__type
    @type.setter
    def type(self, type: AccountType):
        self.__type = type
    ...
    def c0(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Account__c0", None)
        self.__c0 = value
    ...
    def transactions2(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Account__transactions2", None)
...
class Customer:
    ...
    def __init__(self, name: str, dateOfBirth: date, address: str, phoneNumber: str, emailAddress: str, login4: "Login" = None, a1: set["Account"] = None):
        self.name = name
