...
class HomePage:
    ...
    def __init__(self, likeorunlike: bool, __status: str, __friendStatus: str, user3: "User" = None):
...
class User:
    ...
    def __init__(self, _F: Friend, __M: Message, _P: Photos, friend0: "Friend" = None, homePage2: "HomePage" = None, message4: "Message" = None, photos6: "Photos" = None):
        self._F = _F
        self.__M = __M
        self._P = _P
