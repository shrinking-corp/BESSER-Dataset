...
class ecore_EClassifier(ENamedElement):
    ...
    def __init__(self, instanceClass: str, defaultValue: str, instanceTypeName: str, instanceClassName: str, eClassifiers: "ecore_EPackage" = None, ecore_EClassifier: set["ecore_ETypeParameter"] = None, ecore_EClassifier104: "ecore_EGenericType" = None, ecore_EClassifier95: "ecore_EGenericType" = None, ecore_EClassifier56: "ecore_EOperation" = None, EClassifier: "ecore_EPackage" = None, ecore_EClassifier83: "ecore_ETypedElement" = None):
