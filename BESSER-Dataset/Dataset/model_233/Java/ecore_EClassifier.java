...
public class ecore_EClassifier extends ENamedElement {
    ...
    public ecore_EClassifier(
        String instanceTypeName,        String instanceClass,        String instanceClassName,        String defaultValue    ) {
        super(
        );
    ...
    public ecore_EClassifier(
        String instanceTypeName,        String instanceClass,        String instanceClassName,        String defaultValue        ArrayList<ecore_ETypeParameter> ecore_etypeparameters    ) {
        this.instanceTypeName = instanceTypeName;
        this.instanceClass = instanceClass;
        this.instanceClassName = instanceClassName;
        this.defaultValue = defaultValue;
