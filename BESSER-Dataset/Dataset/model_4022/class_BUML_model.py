...
# Classes
classmm_NamedElt = Class(name="classmm_NamedElt")
classmm_Classifier = Class(name="classmm_Classifier")
NamedElt = Class(name="NamedElt")
classmm_DataType = Class(name="classmm_DataType")
Classifier = Class(name="Classifier")
classmm_Class = Class(name="classmm_Class")
classmm_Attribute = Class(name="classmm_Attribute")
classmm_Parameter = Class(name="classmm_Parameter")
classmm_Package = Class(name="classmm_Package")
classmm_Method = Class(name="classmm_Method")
...
classmm_Class.attributes={classmm_Class_isAbstract, classmm_Class_visibility}
...
domain_model = DomainModel(
    name="classmm",
    types={classmm_NamedElt, classmm_Classifier, NamedElt, classmm_DataType, Classifier, classmm_Class, classmm_Attribute, classmm_Parameter, classmm_Package, classmm_Method, Visibility},
    associations={att0, methods4, type6, owner7, classes8, owner10, params12, type14, owner16, super2, package3},
    generalizations={gen_classmm_Classifier_NamedElt, gen_classmm_DataType_Classifier, gen_classmm_Class_Classifier, gen_classmm_Attribute_NamedElt, gen_classmm_Package_NamedElt, gen_classmm_Method_NamedElt, gen_classmm_Parameter_NamedElt},
    metadata=None
)
