...
# Classes
pmtest_D = Class(name="pmtest_D")
pmtest_B = Class(name="pmtest_B")
A = Class(name="A")
pmtest_C = Class(name="pmtest_C")
pmtest_A = Class(name="pmtest_A")
...
domain_model = DomainModel(
    name="pmtest",
    types={pmtest_D, pmtest_B, A, pmtest_C, pmtest_A},
