...
public class extlibrary_Library extends Addressable {
    ...
    public extlibrary_Library(
        String name,        String people        ArrayList<extlibrary_Library> extlibrary_librarys,        ArrayList<extlibrary_Book> extlibrary_books,        ArrayList<extlibrary_Writer> extlibrary_writers    ) {
        this.name = name;
        this.people = people;
