...
class notation_View(NotationElement):
    ...
    def __init__(self, viewType: str, viewDetails: str, notation_View: set["notation_Node"] = None, notation_View2: "notation_EObject" = None, View: "notation_Edge" = None, View10: "notation_Edge" = None, source: set["notation_Edge"] = None, target: set["notation_Edge"] = None):
