...
notation_Note = Class(name="notation_Note")
...
notation_MindMapNode = Class(name="notation_MindMapNode")
...
notation_NotationElement.attributes={notation_NotationElement_idBeforeRemoval, notation_NotationElement_id}
...
notation_MindMapNode.attributes={notation_MindMapNode_hasChildren, notation_MindMapNode_side, notation_MindMapNode_expanded}
...
domain_model = DomainModel(
    name="notation",
    types={notation_Node, notation_EObject, notation_NotationElement, notation_View, NotationElement, notation_Diagram, notation_Edge, View, notation_Bounds, notation_Note, Node, notation_LayoutConstraint, notation_Location, LayoutConstraint, Location, notation_MindMapNode},
    associations={persistentChildren0, diagrammableElement1, source8, target9, sourceEdges3, targetEdges4, layoutConstraint6, persistentEdges11},
    generalizations={gen_notation_View_NotationElement, gen_notation_Edge_View, gen_notation_Diagram_View, gen_notation_Node_View, gen_notation_Bounds_Location, gen_notation_Note_Node, gen_notation_Location_NotationElement, gen_notation_Location_LayoutConstraint, gen_notation_MindMapNode_Node},
    metadata=None
)
