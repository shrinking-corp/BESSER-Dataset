...
model_types_ImportType.attributes={model_types_ImportType_referenceURL, model_types_ImportType_modelInterpreterId, model_types_ImportType_autoresolve, model_types_ImportType_url}
...
model_values_Point.attributes={model_values_Point_x, model_values_Point_y, model_values_Point_z}
...
model_values_FunctionPlot.attributes={model_values_FunctionPlot_stepValue, model_values_FunctionPlot_initialValue, model_values_FunctionPlot_xAxisLabel, model_values_FunctionPlot_finalValue, model_values_FunctionPlot_title, model_values_FunctionPlot_yAxisLabel}
...
model_values_Image.attributes={model_values_Image_format, model_values_Image_name, model_values_Image_data, model_values_Image_reference}
...
model_datasources_SimpleQuery.attributes={model_datasources_SimpleQuery_countQuery, model_datasources_SimpleQuery_query}
...
model_datasources_RunnableQuery.attributes={model_datasources_RunnableQuery_booleanOperator, model_datasources_RunnableQuery_queryPath, model_datasources_RunnableQuery_targetVariablePath}
...
model_datasources_QueryResults_m_getValue: Method = Method(name="getValue", parameters={Parameter(name='model_row', type=StringType), Parameter(name='model_field', type=StringType)}, type=StringType)
...
referencedVariables34: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="Variable35", type=model_types_Type, multiplicity=Multiplicity(1, 1)),
...
types130: BinaryAssociation = BinaryAssociation(
    name="types130",
    ends={
        Property(name="Type131", type=model_variables_Variable, multiplicity=Multiplicity(1, 1)),
...
domain_model = DomainModel(
    name="model",
    types={model_GeppettoModel, Variable, model_GeppettoLibrary, model_Tag, Node, Type, model_LibraryManager, model_ExperimentState, model_VariableValue, Pointer, Value, DataSource, Query, model_Node, ISynchable, model_ExternalDomainModel, DomainModel_, model_StringToStringMap, model_ISynchable, model_types_Type, VisualType, types_model_DomainModel, model_types_VisualType, model_DomainModel, model_ModelFormat, Composite, model_types_PointerType, model_types_QuantityType, Quantity, model_types_ParameterType, model_types_StateVariableType, model_types_DynamicsType, Dynamics, model_types_ArgumentType, Argument, model_types_ExpressionType, Expression, VisualValue, model_types_ImportType, model_types_CompositeType, Text, model_types_URLType, URL, model_types_PointType, Point, model_types_ArrayType, ArrayValue, model_types_CompositeVisualType, VisualGroup, model_types_ConnectionType, model_types_HTMLType, HTML, model_types_JSONType, JSON, model_types_TextType, model_types_SimpleArrayType, AArrayValue, model_types_MetadataType, model_values_Value, model_values_Composite, StringToValueMap, model_values_StringToValueMap, model_values_Quantity, model_values_PhysicalQuantity, Unit, model_values_Unit, model_values_TimeSeries, model_types_SimpleType, model_types_ImageType, Image, model_values_URL, model_values_HTML, model_values_Pointer, PointerElement, model_values_PointerElement, model_values_Point, model_values_Dynamics, PhysicalQuantity, model_values_MDTimeSeries, model_values_MetadataValue, model_values_Text, MetadataValue, FunctionPlot, model_values_Argument, model_values_Expression, model_values_VisualValue, VisualGroupElement, model_values_Collada, model_values_OBJ, model_values_Sphere, model_values_Cylinder, Function, model_values_FunctionPlot, model_values_Function, model_values_SkeletonTransformation, model_values_VisualGroupElement, model_values_VisualGroup, model_values_Connection, model_values_ArrayElement, model_values_Particles, model_values_SkeletonAnimation, SkeletonTransformation, model_values_ImportValue, model_values_Metadata, model_values_JSON, model_values_GenericArray, model_values_StringArray, model_values_IntArray, model_values_ArrayValue, ArrayElement, model_values_Image, TypeToValueMap, model_variables_TypeToValueMap, model_datasources_DataSource, DataSourceLibraryConfiguration, model_values_DoubleArray, model_values_AArrayValue, model_variables_Variable, model_datasources_Query, QueryMatchingCriteria, model_datasources_ProcessQuery, datasources_model_StringToStringMap, model_datasources_SimpleQuery, model_datasources_CompoundQuery, datasources_model_GeppettoLibrary, model_datasources_DataSourceLibraryConfiguration, AQueryResult, model_datasources_RunnableQuery, model_datasources_AQueryResult, model_datasources_QueryResult, model_datasources_SerializableQueryResult, model_datasources_QueryMatchingCriteria, model_datasources_CompoundRefQuery, model_datasources_QueryResults, FileFormat, Connectivity, ImageFormat, BooleanOperator},
    associations={variables0, libraries1, tags3, tags9, types11, sharedTypes13, libraries16, recordedVariables18, setParameters19, pointer22, value24, dataSources5, queries7, superType30, visualType32, referencedVariables34, domainModel36, tags27, format29, variables39, defaultValue41, defaultValue43, defaultValue45, defaultValue46, defaultValue48, defaultValue50, defaultValue51, defaultValue38, defaultValue55, defaultValue56, defaultValue57, arrayType58, defaultValue60, variables62, visualGroups64, variables66, defaultValue52, defaultValue53, defaultValue54, defaultValue72, value73, value74, unit76, defaultValue68, defaultValue71, elements81, point82, variable85, type87, initialCondition90, unit77, value79, arguments93, expression95, functionPlot98, groupElements100, position101, dynamics91, skeletonTransformationSeries108, parameter109, visualGroupElements111, a113, b115, position118, distal104, particles106, value124, elements126, initialValue120, elements123, types130, initialValues132, position134, key137, value139, libraryConfigurations142, anonymousTypes128, library154, matchingCriteria156, returnType157, parameters160, queryChain161, queries143, dependenciesLibrary146, targetLibrary148, fetchVariableQuery151, results165, type166, queryChain163},
    generalizations={gen_model_GeppettoLibrary_Node, gen_model_Node_ISynchable, gen_model_ExternalDomainModel_DomainModel, gen_model_types_Type_Node, gen_model_Tag_ISynchable, gen_model_types_VisualType_Type, gen_model_types_PointerType_Type, gen_model_types_QuantityType_Type, gen_model_types_ParameterType_Type, gen_model_types_StateVariableType_Type, gen_model_types_DynamicsType_Type, gen_model_types_ArgumentType_Type, gen_model_types_ExpressionType_Type, gen_model_types_ImportType_Type, gen_model_types_CompositeType_Type, gen_model_types_URLType_Type, gen_model_types_PointType_Type, gen_model_types_ArrayType_Type, gen_model_types_CompositeVisualType_VisualType, gen_model_types_ConnectionType_Type, gen_model_types_HTMLType_Type, gen_model_types_JSONType_Type, gen_model_types_TextType_Type, gen_model_types_SimpleArrayType_Type, gen_model_types_MetadataType_Type, gen_model_values_Value_ISynchable, gen_model_values_Composite_Value, gen_model_values_Quantity_Value, gen_model_values_PhysicalQuantity_Quantity, gen_model_values_Unit_Value, gen_model_values_TimeSeries_Value, gen_model_types_SimpleType_Type, gen_model_types_ImageType_Type, gen_model_values_URL_MetadataValue, gen_model_values_HTML_MetadataValue, gen_model_values_Pointer_Value, gen_model_values_Point_Value, gen_model_values_Dynamics_Value, gen_model_values_MDTimeSeries_Value, gen_model_values_MetadataValue_Value, gen_model_values_Text_MetadataValue, gen_model_values_Argument_Value, gen_model_values_Expression_Value, gen_model_values_VisualValue_Value, gen_model_values_Collada_VisualValue, gen_model_values_OBJ_VisualValue, gen_model_values_Sphere_VisualValue, gen_model_values_Cylinder_VisualValue, gen_model_values_Function_Value, gen_model_values_VisualGroupElement_Node, gen_model_values_VisualGroup_Node, gen_model_values_Connection_Value, gen_model_values_ArrayElement_Value, gen_model_values_Particles_Value, gen_model_values_SkeletonAnimation_VisualValue, gen_model_values_ImportValue_Value, gen_model_values_Metadata_MetadataValue, gen_model_values_JSON_MetadataValue, gen_model_values_GenericArray_AArrayValue, gen_model_values_StringArray_AArrayValue, gen_model_values_IntArray_AArrayValue, gen_model_values_ArrayValue_Value, gen_model_values_Image_Value, gen_model_datasources_DataSource_Node, gen_model_values_DoubleArray_AArrayValue, gen_model_values_AArrayValue_Value, gen_model_variables_Variable_Node, gen_model_datasources_Query_Node, gen_model_datasources_ProcessQuery_Query, gen_model_datasources_SimpleQuery_Query, gen_model_datasources_CompoundQuery_Query, gen_model_datasources_QueryResult_AQueryResult, gen_model_datasources_SerializableQueryResult_AQueryResult, gen_model_datasources_CompoundRefQuery_Query},
    metadata=None
)
