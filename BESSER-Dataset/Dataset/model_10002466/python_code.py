...
class Customercare:
    ...
    def __init__(self, no: int, address: str, customer27: set["Client"] = None):
        self.no = no
...
class Warehouse:
    ...
    def __init__(self, database: str, location: str, shipment28: set["Shipment"] = None, product31: set["Piece"] = None):
...
class Piece:
    ...
    def __init__(self, name: str, id: int, type: str, oRDER25: set["Commande"] = None, warehouse30: set["Warehouse"] = None):
        self.name = name
        self.id = id
        self.type = type
    ...
    def warehouse30(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Piece__warehouse30", None)
    ...
    def oRDER25(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Piece__oRDER25", None)
...
class Commande:
    ...
    def __init__(self, item: str, quantity: int, list: str, pRODUCT24: set["Piece"] = None):
        self.item = item
        self.quantity = quantity
        self.list = list
    ...
    def pRODUCT24(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Commande__pRODUCT24", None)
...
class Client:
    ...
    def __init__(self, name: str, id: int, mailid: str, address: str, phoneno: int, customercare26: set["Customercare"] = None):
        self.name = name
        self.id = id
        self.mailid = mailid
        self.address = address
    ...
    def customercare26(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Client__customercare26", None)
