...
def test_piece_has_id():
    assert hasattr(Piece, "id")
    descriptor = None
...
def test_piece_has_type():
    assert hasattr(Piece, "type")
    descriptor = None
    for klass in Piece.__mro__:
...
def test_commande_has_list():
    assert hasattr(Commande, "list")
    descriptor = None
...
def test_commande_has_quantity():
    assert hasattr(Commande, "quantity")
    descriptor = None
    for klass in Commande.__mro__:
        if "quantity" in klass.__dict__:
            descriptor = klass.__dict__["quantity"]
...
def test_commande_has_item():
    assert hasattr(Commande, "item")
    descriptor = None
    for klass in Commande.__mro__:
        if "item" in klass.__dict__:
            descriptor = klass.__dict__["item"]
...
def test_client_has_phoneno():
    assert hasattr(Client, "phoneno")
    descriptor = None
    for klass in Client.__mro__:
        if "phoneno" in klass.__dict__:
            descriptor = klass.__dict__["phoneno"]
...
def test_client_has_mailid():
    assert hasattr(Client, "mailid")
    descriptor = None
    for klass in Client.__mro__:
...
@given(instance=Piece_strategy)
def test_piece_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
@given(instance=Piece_strategy)
def test_piece_type_setter(instance):
...
@given(instance=Commande_strategy)
def test_commande_list_setter(instance):
...
@given(instance=Commande_strategy)
def test_commande_quantity_setter(instance):
    original = instance.quantity
    instance.quantity = original
    assert instance.quantity == original
...
@given(instance=Commande_strategy)
def test_commande_item_setter(instance):
    original = instance.item
    instance.item = original
    assert instance.item == original
...
@given(instance=Client_strategy)
def test_client_phoneno_setter(instance):
    original = instance.phoneno
    instance.phoneno = original
    assert instance.phoneno == original
...
@given(instance=Client_strategy)
def test_client_mailid_setter(instance):
