...
Client_mailid: Property = Property(name="mailid", type=StringType)
Client_address: Property = Property(name="address", type=StringType)
Client_phoneno: Property = Property(name="phoneno", type=IntegerType)
Client.attributes={Client_mailid, Client_phoneno, Client_id, Client_name, Client_address}

# Commande class attributes and methods
Commande_item: Property = Property(name="item", type=StringType)
Commande_quantity: Property = Property(name="quantity", type=IntegerType)
Commande_list: Property = Property(name="list", type=StringType)
Commande.attributes={Commande_quantity, Commande_item, Commande_list}

# Piece class attributes and methods
Piece_name: Property = Property(name="name", type=StringType)
Piece_id: Property = Property(name="id", type=IntegerType)
Piece_type: Property = Property(name="type", type=StringType)
Piece.attributes={Piece_id, Piece_type, Piece_name}
...
Transaction.attributes={Transaction_cashondelivery, Transaction_creditcard, Transaction_debitcard}
...
ORDER_PRODUCT: BinaryAssociation = BinaryAssociation(
    name="ORDER_PRODUCT",
    ends={
        Property(name="pRODUCT24", type=Piece, multiplicity=Multiplicity(1, 9999)),
        Property(name="oRDER25", type=Commande, multiplicity=Multiplicity(1, 9999))
    }
)
Customer_Customercare: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="customer27", type=Client, multiplicity=Multiplicity(1, 9999))
    }
)
...
Product_Warehouse: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="product31", type=Piece, multiplicity=Multiplicity(0, 9999))
    }
)

# Domain Model
domain_model = DomainModel(
    name="b676791e_c1ea_4ad6_83c5_895bbdeb1dcb",
    types={CUSTOMER_Actor, VISITS_THE_WEBSITE_UseCase, CREATES_THE_WEBSITE_UseCase, SELECTS_THE_ITEMS_SERVICE_UseCase, ADDS_ITEMS_SERVICE_TO_CART_UseCase, SELECTS_THE_MODE_OF_PAYMENT_UseCase, PAYS_THE_BILL_UseCase, DELIVERS_THE_PRODUCT_UseCase, SUPPORT_AND_FEEDBACK_UseCase, WEB_DEVELOPER_Actor, ADMINISTRATOR_Actor, MAINTAINS_THE_PRODUCTS_SERVICES_UseCase, Client, Commande, Piece, Warehouse, Transaction, Shipment, Customercare, Feedback, Cancelorder},
