...
class javaMM_NamedElement(ASTNode):
    ...
    def __init__(self, proxy: bool, name: str, NamedElement: "javaMM_ImportDeclaration" = None, javaMM_NamedElement: "javaMM_MemberRef" = None, importedElement: set["javaMM_ImportDeclaration"] = None):
        self.proxy = proxy
        self.name = name
...
class javaMM_Comment(ASTNode):
    ...
    def __init__(self, prefixOfParent: bool, content: str, enclosedByParent: bool, javaMM_Comment: "javaMM_AbstractTypeDeclaration" = None, javaMM_Comment18: "javaMM_AbstractTypeDeclaration" = None, javaMM_Comment41: "javaMM_ASTNode" = None, javaMM_Comment130: "javaMM_CompilationUnit" = None):
...
class javaMM_SingleVariableDeclaration(VariableDeclaration):
    ...
    def __init__(self, varargs: bool, SingleVariableDeclaration: "javaMM_AbstractMethodDeclaration" = None, SingleVariableDeclaration100: "javaMM_CatchClause" = None, SingleVariableDeclaration152: "javaMM_EnhancedForStatement" = None, SingleVariableDeclaration253: "javaMM_Modifier" = None, parameters: "javaMM_AbstractMethodDeclaration" = None, singleVariableDeclaration: "javaMM_Modifier" = None, javaMM_SingleVariableDeclaration: "javaMM_TypeAccess" = None, javaMM_SingleVariableDeclaration298: set["javaMM_Annotation"] = None, exception: "javaMM_CatchClause" = None, parameter: "javaMM_EnhancedForStatement" = None):
        self.varargs = varargs
