...
def test_assoc_in_14_link_reassign_clear():
    ...
    if hasattr(b1, 'petrinet_PTArc16'):
        assert _is_linked(b1, 'petrinet_PTArc16', a)
    _safe_set(a, 'petrinet_Transition15', {b2})
    assert _is_linked(a, 'petrinet_Transition15', b2)
    if hasattr(b1, 'petrinet_PTArc16'):
        assert not _is_linked(b1, 'petrinet_PTArc16', a)
    if hasattr(b2, 'petrinet_PTArc16'):
        assert _is_linked(b2, 'petrinet_PTArc16', a)
    _safe_set(a, 'petrinet_Transition15', set())
    assert not _is_linked(a, 'petrinet_Transition15', b2)
    if hasattr(b2, 'petrinet_PTArc16'):
        assert not _is_linked(b2, 'petrinet_PTArc16', a)
...
def test_assoc_out11_link_reassign_clear():
    a = petrinet_Transition(name="sample_text")
    b1 = petrinet_TPArc()
    b2 = petrinet_TPArc()
    _safe_set(a, 'petrinet_Transition12', {b1})
    assert _is_linked(a, 'petrinet_Transition12', b1)
    if hasattr(b1, 'petrinet_TPArc13'):
        assert _is_linked(b1, 'petrinet_TPArc13', a)
    _safe_set(a, 'petrinet_Transition12', {b2})
    assert _is_linked(a, 'petrinet_Transition12', b2)
    if hasattr(b1, 'petrinet_TPArc13'):
        assert not _is_linked(b1, 'petrinet_TPArc13', a)
    if hasattr(b2, 'petrinet_TPArc13'):
        assert _is_linked(b2, 'petrinet_TPArc13', a)
    _safe_set(a, 'petrinet_Transition12', set())
    assert not _is_linked(a, 'petrinet_Transition12', b2)
    if hasattr(b2, 'petrinet_TPArc13'):
        assert not _is_linked(b2, 'petrinet_TPArc13', a)
...
def test_assoc_out7_link_reassign_clear():
    ...
    b1 = petrinet_PTArc()
    b2 = petrinet_PTArc()
    _safe_set(a, 'petrinet_Place8', {b1})
    assert _is_linked(a, 'petrinet_Place8', b1)
    if hasattr(b1, 'petrinet_PTArc'):
        assert _is_linked(b1, 'petrinet_PTArc', a)
    _safe_set(a, 'petrinet_Place8', {b2})
    assert _is_linked(a, 'petrinet_Place8', b2)
    if hasattr(b1, 'petrinet_PTArc'):
        assert not _is_linked(b1, 'petrinet_PTArc', a)
    if hasattr(b2, 'petrinet_PTArc'):
        assert _is_linked(b2, 'petrinet_PTArc', a)
    _safe_set(a, 'petrinet_Place8', set())
    assert not _is_linked(a, 'petrinet_Place8', b2)
    if hasattr(b2, 'petrinet_PTArc'):
...
def test_assoc_source17_link_reassign_clear():
    ...
    b1 = petrinet_PTArc()
    b2 = petrinet_PTArc()
    _safe_set(a, 'petrinet_Place19', b1)
    assert _is_linked(a, 'petrinet_Place19', b1)
    if hasattr(b1, 'petrinet_PTArc18'):
        assert _is_linked(b1, 'petrinet_PTArc18', a)
    _safe_set(a, 'petrinet_Place19', b2)
    assert _is_linked(a, 'petrinet_Place19', b2)
    if hasattr(b1, 'petrinet_PTArc18'):
        assert not _is_linked(b1, 'petrinet_PTArc18', a)
    if hasattr(b2, 'petrinet_PTArc18'):
        assert _is_linked(b2, 'petrinet_PTArc18', a)
    _safe_set(a, 'petrinet_Place19', None)
    assert not _is_linked(a, 'petrinet_Place19', b2)
    if hasattr(b2, 'petrinet_PTArc18'):
        assert not _is_linked(b2, 'petrinet_PTArc18', a)
...
def test_assoc_source23_link_reassign_clear():
    ...
    b1 = petrinet_TPArc()
    b2 = petrinet_TPArc()
    _safe_set(a, 'petrinet_Transition25', b1)
    assert _is_linked(a, 'petrinet_Transition25', b1)
    if hasattr(b1, 'petrinet_TPArc24'):
        assert _is_linked(b1, 'petrinet_TPArc24', a)
    _safe_set(a, 'petrinet_Transition25', b2)
    assert _is_linked(a, 'petrinet_Transition25', b2)
    if hasattr(b1, 'petrinet_TPArc24'):
        assert not _is_linked(b1, 'petrinet_TPArc24', a)
    if hasattr(b2, 'petrinet_TPArc24'):
        assert _is_linked(b2, 'petrinet_TPArc24', a)
    _safe_set(a, 'petrinet_Transition25', None)
    assert not _is_linked(a, 'petrinet_Transition25', b2)
    if hasattr(b2, 'petrinet_TPArc24'):
        assert not _is_linked(b2, 'petrinet_TPArc24', a)
...
def test_assoc_target20_link_reassign_clear():
    ...
    b1 = petrinet_PTArc()
    b2 = petrinet_PTArc()
    _safe_set(a, 'petrinet_Transition22', b1)
    assert _is_linked(a, 'petrinet_Transition22', b1)
    if hasattr(b1, 'petrinet_PTArc21'):
        assert _is_linked(b1, 'petrinet_PTArc21', a)
    _safe_set(a, 'petrinet_Transition22', b2)
    assert _is_linked(a, 'petrinet_Transition22', b2)
    if hasattr(b1, 'petrinet_PTArc21'):
        assert not _is_linked(b1, 'petrinet_PTArc21', a)
    if hasattr(b2, 'petrinet_PTArc21'):
        assert _is_linked(b2, 'petrinet_PTArc21', a)
    _safe_set(a, 'petrinet_Transition22', None)
    assert not _is_linked(a, 'petrinet_Transition22', b2)
    if hasattr(b2, 'petrinet_PTArc21'):
        assert not _is_linked(b2, 'petrinet_PTArc21', a)
...
def test_assoc_target26_link_reassign_clear():
    ...
    b1 = petrinet_TPArc()
    b2 = petrinet_TPArc()
    _safe_set(a, 'petrinet_Place28', b1)
    assert _is_linked(a, 'petrinet_Place28', b1)
    if hasattr(b1, 'petrinet_TPArc27'):
        assert _is_linked(b1, 'petrinet_TPArc27', a)
    _safe_set(a, 'petrinet_Place28', b2)
    assert _is_linked(a, 'petrinet_Place28', b2)
    if hasattr(b1, 'petrinet_TPArc27'):
        assert not _is_linked(b1, 'petrinet_TPArc27', a)
    if hasattr(b2, 'petrinet_TPArc27'):
        assert _is_linked(b2, 'petrinet_TPArc27', a)
    _safe_set(a, 'petrinet_Place28', None)
    assert not _is_linked(a, 'petrinet_Place28', b2)
    if hasattr(b2, 'petrinet_TPArc27'):
        assert not _is_linked(b2, 'petrinet_TPArc27', a)
