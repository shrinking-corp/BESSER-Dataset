...
class PagosPim_TerminalValue(Expression):
    ...
    def __init__(self, value: str, method: str, PagosPim_TerminalValue: "PagosPim_LogicalExpression" = None, PagosPim_TerminalValue74: "PagosPim_LogicalExpression" = None, PagosPim_TerminalValue82: "PagosPim_EObject" = None, PagosPim_TerminalValue85: "PagosPim_Attribute" = None):
        self.value = value
        self.method = method
...
class PagosPim_Add(Expression):
    ...
    def __init__(self, operator: str, PagosPim_Add90: "PagosPim_Expression" = None, PagosPim_Add: "PagosPim_Expression" = None):
...
class PagosPim_LogicalExpression:
    ...
    def __init__(self, logicalOperator: str, literal: str, conOper: str, PagosPim_LogicalExpression71: "PagosPim_TerminalValue" = None, PagosPim_LogicalExpression73: "PagosPim_TerminalValue" = None, PagosPim_LogicalExpression77: "PagosPim_LogicalExpression" = None, PagosPim_LogicalExpression75: "PagosPim_LogicalExpression" = None, PagosPim_LogicalExpression: "PagosPim_IfCondition" = None):
...
class PagosPim_Return:
    ...
    def __init__(self, type: str, PagosPim_Return69: "PagosPim_ElseSegment" = None, PagosPim_Return: set["PagosPim_Expression"] = None, PagosPim_Return49: "PagosPim_Body" = None, PagosPim_Return60: "PagosPim_IfCondition" = None):
        self.type = type
...
class Control:
    ...
    pass
class PagosPim_Input(Attribute, Control):
...
class PagosPim_Attribute(AttributeDefinition):
    ...
    def __init__(self, isIndex: str, PagosPim_Attribute: "PagosPim_GenericComponent" = None, PagosPim_Attribute29: "PagosPim_Expression" = None, PagosPim_Attribute36: "PagosPim_Operation" = None, PagosPim_Attribute86: "PagosPim_TerminalValue" = None):
...
class PagosPim_GenericComponent:
    ...
    def __init__(self, name: str, PagosPim_GenericComponent: set["PagosPim_Attribute"] = None, PagosPim_GenericComponent25: set["PagosPim_Relation"] = None, PagosPim_GenericComponent27: set["PagosPim_Operation"] = None, PagosPim_GenericComponent41: "PagosPim_Relation" = None):
        self.name = name
...
class PagosPim_ViewComponent(GenericComponent):
    ...
    def __init__(self, title: str, PagosPim_ViewComponent17: set["PagosPim_SubComponent"] = None, PagosPim_ViewComponent19: set["PagosPim_Control"] = None, PagosPim_ViewComponent21: set["PagosPim_FrontService"] = None, PagosPim_ViewComponent: "PagosPim_Application" = None):
        self.title = title
...
class PagosPim_Action(Control, Operation):
    ...
    pass
class PagosPim_Output(Attribute, Control):
...
class PagosPim_Application:
    ...
    def __init__(self, name: str, PagosPim_Application: set["PagosPim_LogicComponent"] = None, PagosPim_Application2: set["PagosPim_ServerService"] = None, PagosPim_Application4: set["PagosPim_DataLayerComponent"] = None, PagosPim_Application6: set["PagosPim_DaoComponent"] = None, PagosPim_Application8: set["PagosPim_ViewComponent"] = None):
        self.name = name
