...
# Classes
PagosPim_Application = Class(name="PagosPim_Application")
PagosPim_LogicComponent = Class(name="PagosPim_LogicComponent")
PagosPim_ServerService = Class(name="PagosPim_ServerService")
PagosPim_DataLayerComponent = Class(name="PagosPim_DataLayerComponent")
PagosPim_FrontService = Class(name="PagosPim_FrontService")
PagosPim_Output = Class(name="PagosPim_Output")
Operation = Class(name="Operation")
GenericComponent = Class(name="GenericComponent")
PagosPim_SubComponent = Class(name="PagosPim_SubComponent")
PagosPim_GenericComponent = Class(name="PagosPim_GenericComponent")
PagosPim_Attribute = Class(name="PagosPim_Attribute")
PagosPim_Relation = Class(name="PagosPim_Relation")
PagosPim_Operation = Class(name="PagosPim_Operation")
PagosPim_DaoComponent = Class(name="PagosPim_DaoComponent")
PagosPim_ViewComponent = Class(name="PagosPim_ViewComponent")
PagosPim_Control = Class(name="PagosPim_Control")
PagosPim_Input = Class(name="PagosPim_Input")
Control = Class(name="Control")
Attribute = Class(name="Attribute")
PagosPim_AttributeDefinition = Class(name="PagosPim_AttributeDefinition", is_abstract=True)
PagosPim_EObject = Class(name="PagosPim_EObject")
PagosPim_Return = Class(name="PagosPim_Return")
PagosPim_IfBlock = Class(name="PagosPim_IfBlock")
PagosPim_IfCondition = Class(name="PagosPim_IfCondition")
PagosPim_ElseSegment = Class(name="PagosPim_ElseSegment")
PagosPim_ProgramIfExpression = Class(name="PagosPim_ProgramIfExpression")
PagosPim_LogicalExpression = Class(name="PagosPim_LogicalExpression")
PagosPim_NewEClass21 = Class(name="PagosPim_NewEClass21")
AttributeDefinition = Class(name="AttributeDefinition")
PagosPim_Expression = Class(name="PagosPim_Expression")
PagosPim_ParameterList = Class(name="PagosPim_ParameterList")
PagosPim_Body = Class(name="PagosPim_Body")
PagosPim_Parameter = Class(name="PagosPim_Parameter")
Expression = Class(name="Expression")
PagosPim_Add = Class(name="PagosPim_Add")
PagosPim_Mult = Class(name="PagosPim_Mult")
PagosPim_TerminalValue = Class(name="PagosPim_TerminalValue")
PagosPim_Action = Class(name="PagosPim_Action")
PagosPim_Field = Class(name="PagosPim_Field")
...
PagosPim_Relation.attributes={PagosPim_Relation_name, PagosPim_Relation_cardinality, PagosPim_Relation_type}
...
PagosPim_AttributeDefinition.attributes={PagosPim_AttributeDefinition_type, PagosPim_AttributeDefinition_name}
...
PagosPim_LogicalExpression.attributes={PagosPim_LogicalExpression_literal, PagosPim_LogicalExpression_logicalOperator, PagosPim_LogicalExpression_conOper}
...
PagosPim_TerminalValue.attributes={PagosPim_TerminalValue_method, PagosPim_TerminalValue_value}
...
domain_model = DomainModel(
    name="PagosPim",
    types={PagosPim_Application, PagosPim_LogicComponent, PagosPim_ServerService, PagosPim_DataLayerComponent, PagosPim_FrontService, PagosPim_Output, Operation, GenericComponent, PagosPim_SubComponent, PagosPim_GenericComponent, PagosPim_Attribute, PagosPim_Relation, PagosPim_Operation, PagosPim_DaoComponent, PagosPim_ViewComponent, PagosPim_Control, PagosPim_Input, Control, Attribute, PagosPim_AttributeDefinition, PagosPim_EObject, PagosPim_Return, PagosPim_IfBlock, PagosPim_IfCondition, PagosPim_ElseSegment, PagosPim_ProgramIfExpression, PagosPim_LogicalExpression, PagosPim_NewEClass21, AttributeDefinition, PagosPim_Expression, PagosPim_ParameterList, PagosPim_Body, PagosPim_Parameter, Expression, PagosPim_Add, PagosPim_Mult, PagosPim_TerminalValue, PagosPim_Action, PagosPim_Field, Relation, DataTypes, Cardinality, LogicalCononnector, AddOper, MultOper, RelationType, LogicalOperator},
    associations={logicalComponents0, serverservice1, datalayercomponents3, service9, serviceCalls11, serves13, subcomponents16, controls18, frontservices20, attributes23, relations24, operations26, daocomponent5, views7, targetComponent39, complexType42, expression43, ifblock45, returnExp47, ifcondition50, elsesegment52, ifexpression54, logicalexpressions56, returnBlock58, innerIf61, innerIfBlocks64, expression28, parameterList30, body32, attributes34, parameters37, expression78, parent81, attribute84, leftExp87, rightExp89, rightExp92, leftExp94, expression67, leftTerm70, rightTerm72, moreExpressions76, service108, relatesTo97, mapsTo100, extendsData103, fields106},
    generalizations={gen_PagosPim_Output_Control, gen_PagosPim_Output_Attribute, gen_PagosPim_FrontService_Operation, gen_PagosPim_ViewComponent_GenericComponent, gen_PagosPim_Input_Control, gen_PagosPim_Input_Attribute, gen_PagosPim_Attribute_AttributeDefinition, gen_PagosPim_TerminalValue_Expression, gen_PagosPim_Add_Expression, gen_PagosPim_Mult_Expression, gen_PagosPim_Parameter_AttributeDefinition, gen_PagosPim_ServerService_GenericComponent, gen_PagosPim_SubComponent_Relation, gen_PagosPim_Action_Control, gen_PagosPim_Action_Operation, gen_PagosPim_Field_Attribute, gen_PagosPim_LogicComponent_GenericComponent, gen_PagosPim_DataLayerComponent_GenericComponent, gen_PagosPim_DaoComponent_GenericComponent},
    metadata=None
)
