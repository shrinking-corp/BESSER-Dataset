...
def test_hyp_pagospim_terminalvalue_is_not_abstract():
    assert not inspect.isabstract(PagosPim_TerminalValue)


def test_hyp_pagospim_terminalvalue_constructor_exists():
    assert callable(PagosPim_TerminalValue.__init__)


def test_hyp_pagospim_terminalvalue_constructor_args():
...
def test_hyp_pagospim_add_is_not_abstract():
    assert not inspect.isabstract(PagosPim_Add)


def test_hyp_pagospim_add_constructor_exists():
    assert callable(PagosPim_Add.__init__)


def test_hyp_pagospim_add_constructor_args():
...
def test_hyp_pagospim_mult_is_not_abstract():
    assert not inspect.isabstract(PagosPim_Mult)


def test_hyp_pagospim_mult_constructor_exists():
    assert callable(PagosPim_Mult.__init__)


def test_hyp_pagospim_mult_constructor_args():
...
def test_hyp_pagospim_body_is_not_abstract():
    assert not inspect.isabstract(PagosPim_Body)


def test_hyp_pagospim_body_constructor_exists():
    assert callable(PagosPim_Body.__init__)


def test_hyp_pagospim_body_constructor_args():
    sig = inspect.signature(PagosPim_Body.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pagospim_parameterlist_is_not_abstract():
    assert not inspect.isabstract(PagosPim_ParameterList)


def test_hyp_pagospim_parameterlist_constructor_exists():
    assert callable(PagosPim_ParameterList.__init__)


def test_hyp_pagospim_parameterlist_constructor_args():
    sig = inspect.signature(PagosPim_ParameterList.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pagospim_expression_is_not_abstract():
    assert not inspect.isabstract(PagosPim_Expression)


def test_hyp_pagospim_expression_constructor_exists():
    assert callable(PagosPim_Expression.__init__)


def test_hyp_pagospim_expression_constructor_args():
...
def test_hyp_pagospim_parameter_is_not_abstract():
    assert not inspect.isabstract(PagosPim_Parameter)


def test_hyp_pagospim_parameter_constructor_exists():
    assert callable(PagosPim_Parameter.__init__)


def test_hyp_pagospim_parameter_constructor_args():
    sig = inspect.signature(PagosPim_Parameter.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pagospim_neweclass21_is_not_abstract():
    assert not inspect.isabstract(PagosPim_NewEClass21)


def test_hyp_pagospim_neweclass21_constructor_exists():
    assert callable(PagosPim_NewEClass21.__init__)


def test_hyp_pagospim_neweclass21_constructor_args():
    sig = inspect.signature(PagosPim_NewEClass21.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pagospim_logicalexpression_is_not_abstract():
    assert not inspect.isabstract(PagosPim_LogicalExpression)


def test_hyp_pagospim_logicalexpression_constructor_exists():
    assert callable(PagosPim_LogicalExpression.__init__)


def test_hyp_pagospim_logicalexpression_constructor_args():
...
def test_hyp_pagospim_programifexpression_is_not_abstract():
    assert not inspect.isabstract(PagosPim_ProgramIfExpression)


def test_hyp_pagospim_programifexpression_constructor_exists():
    assert callable(PagosPim_ProgramIfExpression.__init__)


def test_hyp_pagospim_programifexpression_constructor_args():
    sig = inspect.signature(PagosPim_ProgramIfExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pagospim_elsesegment_is_not_abstract():
    assert not inspect.isabstract(PagosPim_ElseSegment)


def test_hyp_pagospim_elsesegment_constructor_exists():
    assert callable(PagosPim_ElseSegment.__init__)


def test_hyp_pagospim_elsesegment_constructor_args():
    sig = inspect.signature(PagosPim_ElseSegment.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pagospim_ifcondition_is_not_abstract():
    assert not inspect.isabstract(PagosPim_IfCondition)


def test_hyp_pagospim_ifcondition_constructor_exists():
    assert callable(PagosPim_IfCondition.__init__)


def test_hyp_pagospim_ifcondition_constructor_args():
    sig = inspect.signature(PagosPim_IfCondition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pagospim_ifblock_is_not_abstract():
    assert not inspect.isabstract(PagosPim_IfBlock)


def test_hyp_pagospim_ifblock_constructor_exists():
    assert callable(PagosPim_IfBlock.__init__)


def test_hyp_pagospim_ifblock_constructor_args():
    sig = inspect.signature(PagosPim_IfBlock.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pagospim_return_is_not_abstract():
    assert not inspect.isabstract(PagosPim_Return)


def test_hyp_pagospim_return_constructor_exists():
    assert callable(PagosPim_Return.__init__)


def test_hyp_pagospim_return_constructor_args():
...
def test_hyp_pagospim_eobject_is_not_abstract():
    assert not inspect.isabstract(PagosPim_EObject)


def test_hyp_pagospim_eobject_constructor_exists():
    assert callable(PagosPim_EObject.__init__)


def test_hyp_pagospim_eobject_constructor_args():
    sig = inspect.signature(PagosPim_EObject.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pagospim_attributedefinition_is_not_abstract():
    assert not inspect.isabstract(PagosPim_AttributeDefinition)


def test_hyp_pagospim_attributedefinition_constructor_exists():
    assert callable(PagosPim_AttributeDefinition.__init__)


def test_hyp_pagospim_attributedefinition_constructor_args():
...
def test_hyp_pagospim_field_is_not_abstract():
    assert not inspect.isabstract(PagosPim_Field)


def test_hyp_pagospim_field_constructor_exists():
    assert callable(PagosPim_Field.__init__)


def test_hyp_pagospim_field_constructor_args():
...
def test_hyp_pagospim_input_is_not_abstract():
    assert not inspect.isabstract(PagosPim_Input)


def test_hyp_pagospim_input_constructor_exists():
    assert callable(PagosPim_Input.__init__)


def test_hyp_pagospim_input_constructor_args():
    sig = inspect.signature(PagosPim_Input.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pagospim_control_is_not_abstract():
    assert not inspect.isabstract(PagosPim_Control)


def test_hyp_pagospim_control_constructor_exists():
    assert callable(PagosPim_Control.__init__)


def test_hyp_pagospim_control_constructor_args():
...
def test_hyp_pagospim_operation_is_not_abstract():
    assert not inspect.isabstract(PagosPim_Operation)


def test_hyp_pagospim_operation_constructor_exists():
    assert callable(PagosPim_Operation.__init__)


def test_hyp_pagospim_operation_constructor_args():
...
def test_hyp_pagospim_relation_is_not_abstract():
    assert not inspect.isabstract(PagosPim_Relation)


def test_hyp_pagospim_relation_constructor_exists():
    assert callable(PagosPim_Relation.__init__)


def test_hyp_pagospim_relation_constructor_args():
...
def test_hyp_pagospim_attribute_is_not_abstract():
    assert not inspect.isabstract(PagosPim_Attribute)


def test_hyp_pagospim_attribute_constructor_exists():
    assert callable(PagosPim_Attribute.__init__)


def test_hyp_pagospim_attribute_constructor_args():
...
def test_hyp_pagospim_genericcomponent_is_not_abstract():
    assert not inspect.isabstract(PagosPim_GenericComponent)


def test_hyp_pagospim_genericcomponent_constructor_exists():
    assert callable(PagosPim_GenericComponent.__init__)


def test_hyp_pagospim_genericcomponent_constructor_args():
...
def test_hyp_pagospim_subcomponent_is_not_abstract():
    assert not inspect.isabstract(PagosPim_SubComponent)


def test_hyp_pagospim_subcomponent_constructor_exists():
    assert callable(PagosPim_SubComponent.__init__)


def test_hyp_pagospim_subcomponent_constructor_args():
    sig = inspect.signature(PagosPim_SubComponent.__init__)
    params = list(sig.parameters.keys())



def test_hyp_genericcomponent_is_not_abstract():
    assert not inspect.isabstract(GenericComponent)


def test_hyp_genericcomponent_constructor_exists():
    assert callable(GenericComponent.__init__)


def test_hyp_genericcomponent_constructor_args():
    sig = inspect.signature(GenericComponent.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pagospim_viewcomponent_is_not_abstract():
    assert not inspect.isabstract(PagosPim_ViewComponent)


def test_hyp_pagospim_viewcomponent_constructor_exists():
    assert callable(PagosPim_ViewComponent.__init__)


def test_hyp_pagospim_viewcomponent_constructor_args():
...
def test_hyp_pagospim_daocomponent_is_not_abstract():
    assert not inspect.isabstract(PagosPim_DaoComponent)


def test_hyp_pagospim_daocomponent_constructor_exists():
    assert callable(PagosPim_DaoComponent.__init__)


def test_hyp_pagospim_daocomponent_constructor_args():
...
def test_hyp_pagospim_action_is_not_abstract():
    assert not inspect.isabstract(PagosPim_Action)


def test_hyp_pagospim_action_constructor_exists():
    assert callable(PagosPim_Action.__init__)


def test_hyp_pagospim_action_constructor_args():
    sig = inspect.signature(PagosPim_Action.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pagospim_output_is_not_abstract():
    assert not inspect.isabstract(PagosPim_Output)


def test_hyp_pagospim_output_constructor_exists():
    assert callable(PagosPim_Output.__init__)


def test_hyp_pagospim_output_constructor_args():
    sig = inspect.signature(PagosPim_Output.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pagospim_frontservice_is_not_abstract():
    assert not inspect.isabstract(PagosPim_FrontService)


def test_hyp_pagospim_frontservice_constructor_exists():
    assert callable(PagosPim_FrontService.__init__)


def test_hyp_pagospim_frontservice_constructor_args():
...
def test_hyp_pagospim_datalayercomponent_is_not_abstract():
    assert not inspect.isabstract(PagosPim_DataLayerComponent)


def test_hyp_pagospim_datalayercomponent_constructor_exists():
    assert callable(PagosPim_DataLayerComponent.__init__)


def test_hyp_pagospim_datalayercomponent_constructor_args():
    sig = inspect.signature(PagosPim_DataLayerComponent.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pagospim_serverservice_is_not_abstract():
    assert not inspect.isabstract(PagosPim_ServerService)


def test_hyp_pagospim_serverservice_constructor_exists():
    assert callable(PagosPim_ServerService.__init__)


def test_hyp_pagospim_serverservice_constructor_args():
    sig = inspect.signature(PagosPim_ServerService.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pagospim_logiccomponent_is_not_abstract():
    assert not inspect.isabstract(PagosPim_LogicComponent)


def test_hyp_pagospim_logiccomponent_constructor_exists():
    assert callable(PagosPim_LogicComponent.__init__)


def test_hyp_pagospim_logiccomponent_constructor_args():
...
def test_hyp_pagospim_application_is_not_abstract():
    assert not inspect.isabstract(PagosPim_Application)


def test_hyp_pagospim_application_constructor_exists():
    assert callable(PagosPim_Application.__init__)


def test_hyp_pagospim_application_constructor_args():
...
def test_hyp_addoper_exists():
    # Check that the Enumeration exists
    assert AddOper is not None

def test_hyp_addoper_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_logicalcononnector_exists():
    # Check that the Enumeration exists
    assert LogicalCononnector is not None

def test_hyp_logicalcononnector_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_multoper_exists():
    # Check that the Enumeration exists
    assert MultOper is not None

def test_hyp_multoper_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_pagospim_terminalvalue_method_setter(instance):
...
@given(instance=PagosPim_TerminalValue_strategy)
def test_hyp_pagospim_terminalvalue_value_setter(instance):
...
def test_hyp_pagospim_add_operator_setter(instance):
...
def test_hyp_pagospim_mult_operator_setter(instance):
    original = instance.operator
    instance.operator = original
    assert instance.operator == original
...
def test_hyp_pagospim_logicalexpression_conOper_setter(instance):
...
@given(instance=PagosPim_LogicalExpression_strategy)
def test_hyp_pagospim_logicalexpression_logicalOperator_setter(instance):
...
@given(instance=PagosPim_LogicalExpression_strategy)
def test_hyp_pagospim_logicalexpression_literal_setter(instance):
...
def test_hyp_pagospim_return_type_setter(instance):
...
def test_hyp_pagospim_attributedefinition_name_setter(instance):
...
@given(instance=PagosPim_AttributeDefinition_strategy)
def test_hyp_pagospim_attributedefinition_type_setter(instance):
    original = instance.type
    instance.type = original
    assert instance.type == original
...
def test_hyp_pagospim_control_label_setter(instance):
...
def test_hyp_pagospim_operation_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_pagospim_relation_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=PagosPim_Relation_strategy)
def test_hyp_pagospim_relation_type_setter(instance):
    original = instance.type
    instance.type = original
    assert instance.type == original
...
@given(instance=PagosPim_Relation_strategy)
def test_hyp_pagospim_relation_cardinality_setter(instance):
...
def test_hyp_pagospim_attribute_isIndex_setter(instance):
...
def test_hyp_pagospim_genericcomponent_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_pagospim_viewcomponent_title_setter(instance):
...
def test_hyp_pagospim_frontservice_fullName_setter(instance):
...
def test_hyp_pagospim_logiccomponent_persistible_setter(instance):
...
def test_hyp_pagospim_application_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
