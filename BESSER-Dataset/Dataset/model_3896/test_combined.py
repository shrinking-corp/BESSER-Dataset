...
def test_hyp_isinitsetter_is_not_abstract():
    assert not inspect.isabstract(IsInitSetter)


def test_hyp_isinitsetter_constructor_exists():
    assert callable(IsInitSetter.__init__)


def test_hyp_isinitsetter_constructor_args():
    sig = inspect.signature(IsInitSetter.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_isnotinitsetter_is_not_abstract():
    assert not inspect.isabstract(workflow_IsNotInitSetter)


def test_hyp_workflow_isnotinitsetter_constructor_exists():
    assert callable(workflow_IsNotInitSetter.__init__)


def test_hyp_workflow_isnotinitsetter_constructor_args():
    sig = inspect.signature(workflow_IsNotInitSetter.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nsetter_is_not_abstract():
    assert not inspect.isabstract(Nsetter)


def test_hyp_nsetter_constructor_exists():
    assert callable(Nsetter.__init__)


def test_hyp_nsetter_constructor_args():
    sig = inspect.signature(Nsetter.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_isinitsetter_is_not_abstract():
    assert not inspect.isabstract(workflow_IsInitSetter)


def test_hyp_workflow_isinitsetter_constructor_exists():
    assert callable(workflow_IsInitSetter.__init__)


def test_hyp_workflow_isinitsetter_constructor_args():
    sig = inspect.signature(workflow_IsInitSetter.__init__)
    params = list(sig.parameters.keys())



def test_hyp_setter_is_not_abstract():
    assert not inspect.isabstract(Setter)


def test_hyp_setter_constructor_exists():
    assert callable(Setter.__init__)


def test_hyp_setter_constructor_args():
    sig = inspect.signature(Setter.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_nsetter_is_not_abstract():
    assert not inspect.isabstract(workflow_Nsetter)


def test_hyp_workflow_nsetter_constructor_exists():
    assert callable(workflow_Nsetter.__init__)


def test_hyp_workflow_nsetter_constructor_args():
    sig = inspect.signature(workflow_Nsetter.__init__)
    params = list(sig.parameters.keys())



def test_hyp_simpletask_is_not_abstract():
    assert not inspect.isabstract(SimpleTask)


def test_hyp_simpletask_constructor_exists():
    assert callable(SimpleTask.__init__)


def test_hyp_simpletask_constructor_args():
    sig = inspect.signature(SimpleTask.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_librarytask_is_not_abstract():
    assert not inspect.isabstract(workflow_LibraryTask)


def test_hyp_workflow_librarytask_constructor_exists():
    assert callable(workflow_LibraryTask.__init__)


def test_hyp_workflow_librarytask_constructor_args():
...
def test_hyp_abstracttask_is_not_abstract():
    assert not inspect.isabstract(AbstractTask)


def test_hyp_abstracttask_constructor_exists():
    assert callable(AbstractTask.__init__)


def test_hyp_abstracttask_constructor_args():
    sig = inspect.signature(AbstractTask.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_basetask_is_not_abstract():
    assert not inspect.isabstract(workflow_BaseTask)


def test_hyp_workflow_basetask_constructor_exists():
    assert callable(workflow_BaseTask.__init__)


def test_hyp_workflow_basetask_constructor_args():
    sig = inspect.signature(workflow_BaseTask.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_simpletask_is_not_abstract():
    assert not inspect.isabstract(workflow_SimpleTask)


def test_hyp_workflow_simpletask_constructor_exists():
    assert callable(workflow_SimpleTask.__init__)


def test_hyp_workflow_simpletask_constructor_args():
    sig = inspect.signature(workflow_SimpleTask.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_customtask_is_not_abstract():
    assert not inspect.isabstract(workflow_CustomTask)


def test_hyp_workflow_customtask_constructor_exists():
    assert callable(workflow_CustomTask.__init__)


def test_hyp_workflow_customtask_constructor_args():
...
def test_hyp_taskinput_is_not_abstract():
    assert not inspect.isabstract(TaskInput)


def test_hyp_taskinput_constructor_exists():
    assert callable(TaskInput.__init__)


def test_hyp_taskinput_constructor_args():
    sig = inspect.signature(TaskInput.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_connection_is_not_abstract():
    assert not inspect.isabstract(workflow_Connection)


def test_hyp_workflow_connection_constructor_exists():
    assert callable(workflow_Connection.__init__)


def test_hyp_workflow_connection_constructor_args():
    sig = inspect.signature(workflow_Connection.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_setter_is_not_abstract():
    assert not inspect.isabstract(workflow_Setter)


def test_hyp_workflow_setter_constructor_exists():
    assert callable(workflow_Setter.__init__)


def test_hyp_workflow_setter_constructor_args():
...
def test_hyp_workflow_taskinput_is_not_abstract():
    assert not inspect.isabstract(workflow_TaskInput)


def test_hyp_workflow_taskinput_constructor_exists():
    assert callable(workflow_TaskInput.__init__)


def test_hyp_workflow_taskinput_constructor_args():
...
def test_hyp_workflow_input_is_not_abstract():
    assert not inspect.isabstract(workflow_Input)


def test_hyp_workflow_input_constructor_exists():
    assert callable(workflow_Input.__init__)


def test_hyp_workflow_input_constructor_args():
    sig = inspect.signature(workflow_Input.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_output_is_not_abstract():
    assert not inspect.isabstract(workflow_Output)


def test_hyp_workflow_output_constructor_exists():
    assert callable(workflow_Output.__init__)


def test_hyp_workflow_output_constructor_args():
    sig = inspect.signature(workflow_Output.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_libraryfunction_is_not_abstract():
    assert not inspect.isabstract(workflow_LibraryFunction)


def test_hyp_workflow_libraryfunction_constructor_exists():
    assert callable(workflow_LibraryFunction.__init__)


def test_hyp_workflow_libraryfunction_constructor_args():
...
def test_hyp_workflow_abstracttask_is_not_abstract():
    assert not inspect.isabstract(workflow_AbstractTask)


def test_hyp_workflow_abstracttask_constructor_exists():
    assert callable(workflow_AbstractTask.__init__)


def test_hyp_workflow_abstracttask_constructor_args():
...
def test_hyp_workflow_namedelement_is_not_abstract():
    assert not inspect.isabstract(workflow_NamedElement)


def test_hyp_workflow_namedelement_constructor_exists():
    assert callable(workflow_NamedElement.__init__)


def test_hyp_workflow_namedelement_constructor_args():
...
def test_hyp_workflow_typedelement_is_not_abstract():
    assert not inspect.isabstract(workflow_TypedElement)


def test_hyp_workflow_typedelement_constructor_exists():
    assert callable(workflow_TypedElement.__init__)


def test_hyp_workflow_typedelement_constructor_args():
...
def test_hyp_workflow_taskoutput_is_not_abstract():
    assert not inspect.isabstract(workflow_TaskOutput)


def test_hyp_workflow_taskoutput_constructor_exists():
    assert callable(workflow_TaskOutput.__init__)


def test_hyp_workflow_taskoutput_constructor_args():
...
def test_hyp_workflow_customtask_runner_setter(instance):
...
def test_hyp_workflow_workflow_language_setter(instance):
...
def test_hyp_workflow_libraryfunction_function_setter(instance):
...
def test_hyp_workflow_abstracttask_status_setter(instance):
...
def test_hyp_workflow_namedelement_name_setter(instance):
...
def test_hyp_workflow_typedelement_typeAsString_setter(instance):
...
@given(instance=workflow_TypedElement_strategy)
def test_hyp_workflow_typedelement_valueAsString_setter(instance):
