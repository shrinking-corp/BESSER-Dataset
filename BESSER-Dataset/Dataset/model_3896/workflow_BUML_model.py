...
# Classes
workflow_TaskOutput = Class(name="workflow_TaskOutput")
workflow_TypedElement = Class(name="workflow_TypedElement")
workflow_NamedElement = Class(name="workflow_NamedElement")
workflow_AbstractTask = Class(name="workflow_AbstractTask", is_abstract=True)
NamedElement = Class(name="NamedElement")
workflow_TaskInput = Class(name="workflow_TaskInput", is_abstract=True)
workflow_Workflow = Class(name="workflow_Workflow")
workflow_Setter = Class(name="workflow_Setter")
TaskInput = Class(name="TaskInput")
workflow_Connection = Class(name="workflow_Connection")
workflow_CustomTask = Class(name="workflow_CustomTask")
workflow_SimpleTask = Class(name="workflow_SimpleTask", is_abstract=True)
AbstractTask = Class(name="AbstractTask")
workflow_BaseTask = Class(name="workflow_BaseTask")
TypedElement = Class(name="TypedElement")
workflow_LibraryFunction = Class(name="workflow_LibraryFunction")
workflow_Output = Class(name="workflow_Output")
workflow_Input = Class(name="workflow_Input")
workflow_LibraryTask = Class(name="workflow_LibraryTask")
SimpleTask = Class(name="SimpleTask")
workflow_Nsetter = Class(name="workflow_Nsetter")
Setter = Class(name="Setter")
workflow_IsInitSetter = Class(name="workflow_IsInitSetter")
Nsetter = Class(name="Nsetter")
workflow_IsNotInitSetter = Class(name="workflow_IsNotInitSetter")
...
workflow_TypedElement.attributes={workflow_TypedElement_valueAsString, workflow_TypedElement_typeAsString}
...
domain_model = DomainModel(
    name="workflow",
    types={workflow_TaskOutput, workflow_TypedElement, workflow_NamedElement, workflow_AbstractTask, NamedElement, workflow_TaskInput, workflow_Workflow, workflow_Setter, TaskInput, workflow_Connection, workflow_CustomTask, workflow_SimpleTask, AbstractTask, workflow_BaseTask, TypedElement, workflow_LibraryFunction, workflow_Output, workflow_Input, workflow_LibraryTask, SimpleTask, workflow_Nsetter, Setter, workflow_IsInitSetter, Nsetter, workflow_IsNotInitSetter, IsInitSetter, TaskStatus, Language},
    associations={inputs0, outputs1, libraryfunction8, baseTask10, functions12, taskoutput15, children3, outputs5, inputs6},
    generalizations={gen_workflow_AbstractTask_NamedElement, gen_workflow_LibraryTask_SimpleTask, gen_workflow_Workflow_NamedElement, gen_workflow_Setter_TypedElement, gen_workflow_Setter_TaskInput, gen_workflow_Connection_TaskInput, gen_workflow_CustomTask_SimpleTask, gen_workflow_SimpleTask_AbstractTask, gen_workflow_BaseTask_AbstractTask, gen_workflow_TaskOutput_NamedElement, gen_workflow_TaskOutput_TypedElement, gen_workflow_TaskInput_NamedElement, gen_workflow_LibraryFunction_NamedElement, gen_workflow_Nsetter_Setter, gen_workflow_IsInitSetter_Nsetter, gen_workflow_IsNotInitSetter_IsInitSetter, gen_workflow_Input_TypedElement, gen_workflow_Input_NamedElement, gen_workflow_Output_NamedElement, gen_workflow_Output_TypedElement},
    metadata=None
)
