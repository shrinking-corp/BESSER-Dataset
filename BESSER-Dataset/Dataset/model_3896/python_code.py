...
class workflow_LibraryFunction(NamedElement):
    ...
    def __init__(self, function: str, workflow_LibraryFunction9: "workflow_LibraryTask" = None, workflow_LibraryFunction14: "workflow_Workflow" = None, workflow_LibraryFunction: set["workflow_Output"] = None, workflow_LibraryFunction7: set["workflow_Input"] = None):
...
class workflow_Input(NamedElement, TypedElement):
...
class workflow_Output(NamedElement, TypedElement):
...
class workflow_TaskOutput(NamedElement, TypedElement):
