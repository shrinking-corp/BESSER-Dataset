...
# Classes
TypeD_A = Class(name="TypeD_A")
TypeD_B = Class(name="TypeD_B")
TypeD_C = Class(name="TypeD_C")
TypeD_AElementName = Class(name="TypeD_AElementName")
TypeD_BElementName = Class(name="TypeD_BElementName")
