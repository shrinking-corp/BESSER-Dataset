...
class cpu_CPU:
    ...
    def __init__(self, dmaChannel: str, pcb: pcb_PCB, previousInstruction: cpu_ExecutableInstruction, log: str, shutdown: bool, idleTime: int, cache: memory_Memory, executeTime: int, numProcesses: int, register: memory_Memory, cpuids: int, cpuid: int, dmaChannel8: "cpu_DMAChannel" = None, driver11: "driver_Driver" = None):
