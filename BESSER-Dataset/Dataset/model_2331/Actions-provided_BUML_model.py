...
# Classes
ActionsProv_OutputPin = Class(name="ActionsProv_OutputPin")
ActionsProv_OpaqueAction = Class(name="ActionsProv_OpaqueAction")
Action = Class(name="Action")
Pin = Class(name="Pin")
ActionsProv_Pin = Class(name="ActionsProv_Pin", is_abstract=True)
ActionsProv_ValuePin = Class(name="ActionsProv_ValuePin")
InputPin = Class(name="InputPin")
ActionsProv_InvocationAction = Class(name="ActionsProv_InvocationAction", is_abstract=True)
ActionsProv_CallAction = Class(name="ActionsProv_CallAction", is_abstract=True)
InvocationAction = Class(name="InvocationAction")
ActionsProv_Action = Class(name="ActionsProv_Action", is_abstract=True)
ActionsProv_SendObjectAction = Class(name="ActionsProv_SendObjectAction")
ActionsProv_InputPin = Class(name="ActionsProv_InputPin")
ActionsProv_CallBehaviorAction = Class(name="ActionsProv_CallBehaviorAction")
CallAction = Class(name="CallAction")
ActionsProv_CallOperationAction = Class(name="ActionsProv_CallOperationAction")
ActionsProv_SendSignalAction = Class(name="ActionsProv_SendSignalAction")
ActionsProv_BroadcastSignalAction = Class(name="ActionsProv_BroadcastSignalAction")
ActionsProv_CreateObjectAction = Class(name="ActionsProv_CreateObjectAction")
ActionsProv_DestroyObjectAction = Class(name="ActionsProv_DestroyObjectAction")
ActionsProv_TestIdentityAction = Class(name="ActionsProv_TestIdentityAction")
ActionsProv_ReadSelfAction = Class(name="ActionsProv_ReadSelfAction")
ActionsProv_ValueSpecificationAction = Class(name="ActionsProv_ValueSpecificationAction")
ActionsProv_StructuralFeatureAction = Class(name="ActionsProv_StructuralFeatureAction", is_abstract=True)
ActionsProv_ReadStructuralFeatureAction = Class(name="ActionsProv_ReadStructuralFeatureAction")
StructuralFeatureAction = Class(name="StructuralFeatureAction")
ActionsProv_WriteStructuralFeatureAction = Class(name="ActionsProv_WriteStructuralFeatureAction", is_abstract=True)
WriteStructuralFeatureAction = Class(name="WriteStructuralFeatureAction")
ActionsProv_RemoveStructuralFeatureValueAction = Class(name="ActionsProv_RemoveStructuralFeatureValueAction")
ActionsProv_ClearStructuralFeatureAction = Class(name="ActionsProv_ClearStructuralFeatureAction")
ActionsProv_LinkAction = Class(name="ActionsProv_LinkAction")
ActionsProv_LinkEndData = Class(name="ActionsProv_LinkEndData", is_abstract=True)
ActionsProv_AddStructuralFeatureValueAction = Class(name="ActionsProv_AddStructuralFeatureValueAction")
LinkAction = Class(name="LinkAction")
ActionsProv_WriteLinkAction = Class(name="ActionsProv_WriteLinkAction", is_abstract=True)
ActionsProv_CreateLinkAction = Class(name="ActionsProv_CreateLinkAction")
WriteLinkAction = Class(name="WriteLinkAction")
ActionsProv_LinkEndCreationData = Class(name="ActionsProv_LinkEndCreationData")
LinkEndData = Class(name="LinkEndData")
ActionsProv_DestroyLinkAction = Class(name="ActionsProv_DestroyLinkAction")
ActionsProv_LinkEndDestructionData = Class(name="ActionsProv_LinkEndDestructionData")
ActionsProv_QualifierValue = Class(name="ActionsProv_QualifierValue")
ActionsProv_ReadLinkAction = Class(name="ActionsProv_ReadLinkAction")
ActionsProv_UnmarshallAction = Class(name="ActionsProv_UnmarshallAction")
ActionsProv_AcceptEventAction = Class(name="ActionsProv_AcceptEventAction")
ActionsProv_AcceptCallAction = Class(name="ActionsProv_AcceptCallAction")
AcceptEventAction = Class(name="AcceptEventAction")
ActionsProv_ReadExtendAction = Class(name="ActionsProv_ReadExtendAction")
ActionsProv_ReplyAction = Class(name="ActionsProv_ReplyAction")
ActionsProv_ReadlsClassifiedObjectAction = Class(name="ActionsProv_ReadlsClassifiedObjectAction")
ActionsProv_StartClassifierBehaviorAction = Class(name="ActionsProv_StartClassifierBehaviorAction")
ActionsProv_StartObjectBehaviorAction = Class(name="ActionsProv_StartObjectBehaviorAction")
ActionsProv_ReadLinkObjectEndAction = Class(name="ActionsProv_ReadLinkObjectEndAction")
ActionsProv_ReclassifyObjectAction = Class(name="ActionsProv_ReclassifyObjectAction")
ActionsProv_ReadLinkObjectEndQualifierAction = Class(name="ActionsProv_ReadLinkObjectEndQualifierAction")
ActionsProv_CreateLinkObjectAction = Class(name="ActionsProv_CreateLinkObjectAction")
CreateLinkAction = Class(name="CreateLinkAction")
ActionsProv_ReduceAction = Class(name="ActionsProv_ReduceAction")
ActionsProv_VariableAction = Class(name="ActionsProv_VariableAction", is_abstract=True)
ActionsProv_ReadVariableAction = Class(name="ActionsProv_ReadVariableAction")
VariableAction = Class(name="VariableAction")
ActionsProv_AddVariableValueAction = Class(name="ActionsProv_AddVariableValueAction")
WriteVariableAction = Class(name="WriteVariableAction")
ActionsProv_RemoveVariableValueAction = Class(name="ActionsProv_RemoveVariableValueAction")
ActionsProv_ClearVariableAction = Class(name="ActionsProv_ClearVariableAction")
ActionsProv_RaiseExceptionAction = Class(name="ActionsProv_RaiseExceptionAction")
ActionsProv_ActionInputPin = Class(name="ActionsProv_ActionInputPin")
ActionsProv_WriteVariableAction = Class(name="ActionsProv_WriteVariableAction")
...
ActionsProv_OpaqueAction.attributes={ActionsProv_OpaqueAction_language, ActionsProv_OpaqueAction_body}
...
domain_model = DomainModel(
    name="ActionsProv",
    types={ActionsProv_OutputPin, ActionsProv_OpaqueAction, Action, Pin, ActionsProv_Pin, ActionsProv_ValuePin, InputPin, ActionsProv_InvocationAction, ActionsProv_CallAction, InvocationAction, ActionsProv_Action, ActionsProv_SendObjectAction, ActionsProv_InputPin, ActionsProv_CallBehaviorAction, CallAction, ActionsProv_CallOperationAction, ActionsProv_SendSignalAction, ActionsProv_BroadcastSignalAction, ActionsProv_CreateObjectAction, ActionsProv_DestroyObjectAction, ActionsProv_TestIdentityAction, ActionsProv_ReadSelfAction, ActionsProv_ValueSpecificationAction, ActionsProv_StructuralFeatureAction, ActionsProv_ReadStructuralFeatureAction, StructuralFeatureAction, ActionsProv_WriteStructuralFeatureAction, WriteStructuralFeatureAction, ActionsProv_RemoveStructuralFeatureValueAction, ActionsProv_ClearStructuralFeatureAction, ActionsProv_LinkAction, ActionsProv_LinkEndData, ActionsProv_AddStructuralFeatureValueAction, LinkAction, ActionsProv_WriteLinkAction, ActionsProv_CreateLinkAction, WriteLinkAction, ActionsProv_LinkEndCreationData, LinkEndData, ActionsProv_DestroyLinkAction, ActionsProv_LinkEndDestructionData, ActionsProv_QualifierValue, ActionsProv_ReadLinkAction, ActionsProv_UnmarshallAction, ActionsProv_AcceptEventAction, ActionsProv_AcceptCallAction, AcceptEventAction, ActionsProv_ReadExtendAction, ActionsProv_ReplyAction, ActionsProv_ReadlsClassifiedObjectAction, ActionsProv_StartClassifierBehaviorAction, ActionsProv_StartObjectBehaviorAction, ActionsProv_ReadLinkObjectEndAction, ActionsProv_ReclassifyObjectAction, ActionsProv_ReadLinkObjectEndQualifierAction, ActionsProv_CreateLinkObjectAction, CreateLinkAction, ActionsProv_ReduceAction, ActionsProv_VariableAction, ActionsProv_ReadVariableAction, VariableAction, ActionsProv_AddVariableValueAction, WriteVariableAction, ActionsProv_RemoveVariableValueAction, ActionsProv_ClearVariableAction, ActionsProv_RaiseExceptionAction, ActionsProv_ActionInputPin, ActionsProv_WriteVariableAction},
    associations={output1, inputValue3, outputValue5, argument8, result10, target16, input0, request18, target12, target14, result21, target23, result25, first27, second30, result35, object37, result39, result33, insertAt46, removeAt48, result50, inputValue52, endData54, value56, value41, result43, result61, insertAt63, destroyAt65, qualifier59, replyValue69, object72, result74, result77, returnInformation79, result81, returnInformation67, object83, result85, object87, object90, object92, value94, object102, result104, result107, result109, collection111, object97, result99, value116, insertAt118, removeAt120, exception122, fromAction124, result114},
    generalizations={gen_ActionsProv_OpaqueAction_Action, gen_ActionsProv_InputPin_Pin, gen_ActionsProv_OutputPin_Pin, gen_ActionsProv_ValuePin_InputPin, gen_ActionsProv_InvocationAction_Action, gen_ActionsProv_CallAction_InvocationAction, gen_ActionsProv_SendObjectAction_InvocationAction, gen_ActionsProv_CallBehaviorAction_CallAction, gen_ActionsProv_SendSignalAction_InvocationAction, gen_ActionsProv_BroadcastSignalAction_InvocationAction, gen_ActionsProv_CreateObjectAction_Action, gen_ActionsProv_DestroyObjectAction_Action, gen_ActionsProv_TestIdentityAction_Action, gen_ActionsProv_ReadSelfAction_Action, gen_ActionsProv_ValueSpecificationAction_Action, gen_ActionsProv_StructuralFeatureAction_Action, gen_ActionsProv_ReadStructuralFeatureAction_StructuralFeatureAction, gen_ActionsProv_WriteStructuralFeatureAction_StructuralFeatureAction, gen_ActionsProv_AddStructuralFeatureValueAction_WriteStructuralFeatureAction, gen_ActionsProv_RemoveStructuralFeatureValueAction_WriteStructuralFeatureAction, gen_ActionsProv_ClearStructuralFeatureAction_StructuralFeatureAction, gen_ActionsProv_LinkAction_Action, gen_ActionsProv_ReadLinkAction_LinkAction, gen_ActionsProv_WriteLinkAction_LinkAction, gen_ActionsProv_CreateLinkAction_WriteLinkAction, gen_ActionsProv_LinkEndCreationData_LinkEndData, gen_ActionsProv_DestroyLinkAction_WriteLinkAction, gen_ActionsProv_LinkEndDestructionData_LinkEndData, gen_ActionsProv_UnmarshallAction_Action, gen_ActionsProv_AcceptEventAction_Action, gen_ActionsProv_AcceptCallAction_AcceptEventAction, gen_ActionsProv_ReadExtendAction_Action, gen_ActionsProv_ReplyAction_Action, gen_ActionsProv_StartClassifierBehaviorAction_Action, gen_ActionsProv_StartObjectBehaviorAction_CallAction, gen_ActionsProv_ReadLinkObjectEndAction_Action, gen_ActionsProv_ReclassifyObjectAction_Action, gen_ActionsProv_ReadLinkObjectEndQualifierAction_Action, gen_ActionsProv_CreateLinkObjectAction_CreateLinkAction, gen_ActionsProv_ReduceAction_Action, gen_ActionsProv_VariableAction_Action, gen_ActionsProv_ReadVariableAction_VariableAction, gen_ActionsProv_AddVariableValueAction_WriteVariableAction, gen_ActionsProv_RemoveVariableValueAction_WriteVariableAction, gen_ActionsProv_ClearVariableAction_VariableAction, gen_ActionsProv_RaiseExceptionAction_Action, gen_ActionsProv_ActionInputPin_InputPin, gen_ActionsProv_WriteVariableAction_VariableAction},
    metadata=None
)
