...
# Enumerations
mypackage_UserState: Enumeration = Enumeration(
    name="mypackage_UserState",
    literals={
            
    }
)

mypackage2_OrderStatus: Enumeration = Enumeration(
    name="mypackage2_OrderStatus",
    literals={
...
Customer.attributes={Customer_email, Customer_phone, Customer_address}
...
Account.attributes={Account_open, Account_billingAddress, Account_isClosed, Account_closed}
...
WebUser_state: Property = Property(name="state", type=mypackage_UserState)
...
Order_status: Property = Property(name="status", type=mypackage2_OrderStatus)
Order.attributes={Order_shipTo, Order_shipped, Order_status, Order_number, Order_total, Order_ordered}
...
domain_model = DomainModel(
    name="_46f7f4a5_4f41_468a_bd6a_6259428724be",
    types={Customer, Payment, ShoppinCart, Account, WebUser, Order, LineItem, Product, MyActor_Actor, Admin_Actor, Webuser_Actor, AjoutProduit_UseCase, MyClass2, mypackage_UserState, mypackage2_OrderStatus},
    associations={Account_Payment, Payment_Order, Account_Order, WebUser_Customer, ShoppinCart_WebUser, Customer_Account, Product_LineItem, Account_ShoppinCart, ShoppinCart_LineItem, association2, Order_LineItem},
    generalizations={},
    metadata=None
)
