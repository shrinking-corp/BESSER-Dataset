...
class mypackage_UserState(Enum):
    pass
class mypackage2_OrderStatus(Enum):
    pass
...
class LineItem:
    ...
    def __init__(self, quantity: int, price: float, product13: "Product" = None, sc19: "ShoppinCart" = None, lineitem15: set["Order"] = None):
...
class Order:
    ...
    def __init__(self, number: int, ordered: date, shipped: bool, shipTo: str, total: float, status: mypackage2_OrderStatus, order3: set["Payment"] = None, account5: "Account" = None, items14: set["LineItem"] = None):
        self.number = number
    ...
    @status.setter
    def status(self, status: mypackage2_OrderStatus):
...
class WebUser:
    ...
    def __init__(self, login: str, password: str, state: mypackage_UserState, customer6: "Customer" = None, shoppincart9: "ShoppinCart" = None):
        self.login = login
    ...
    def state(self):
        return self.__state
    @state.setter
    def state(self, state: mypackage_UserState):
        self.__state = state
...
class ShoppinCart:
    ...
    def __init__(self, creationDate: date, webuser8: "WebUser" = None, account17: "Account" = None, items18: set["LineItem"] = None):
