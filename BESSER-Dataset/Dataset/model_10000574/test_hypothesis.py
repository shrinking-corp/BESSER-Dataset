...
def test_mypackage2_orderstatus_exists():
    # Check that the Enumeration exists
    assert mypackage2_OrderStatus is not None

def test_mypackage2_orderstatus_has_all_literals():
...
def test_mypackage_userstate_exists():
    # Check that the Enumeration exists
    assert mypackage_UserState is not None

def test_mypackage_userstate_has_all_literals():
    # Collect the names of literals in this Enumeration
