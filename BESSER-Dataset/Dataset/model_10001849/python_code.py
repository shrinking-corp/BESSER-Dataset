...
class RadixClient:
    ...
    def __init__(self, redisUrl: str, password: str, state: UserState, shoppingCart2: "ShoppingCart" = None, redisClient19: "RedisStateStore" = None):
...
class ShoppingCart:
    ...
    def __init__(self, creationDate: date, account7: "Redis" = None, webUser3: "RadixClient" = None, items8: "LineItem" = None):
...
class Payment:
    ...
    def __init__(self, paidDate: date, total: float, details: str, acc1: "Redis" = None, order16: "Order" = None):
