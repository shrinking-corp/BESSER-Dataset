...
class lit_petriNets_Place:
    ...
    def __init__(self, name: str, Place: "lit_petriNets_Net" = None, Place17: "lit_petriNets_PTArc" = None, places: "lit_petriNets_Net" = None, src: set["lit_petriNets_PTArc"] = None, dst: set["lit_petriNets_TPArc"] = None, Place25: "lit_petriNets_TPArc" = None):
        self.name = name
        self.Place = Place
...
class lit_petriNets_Transition:
    ...
    def __init__(self, name: str, Transition: "lit_petriNets_Net" = None, src14: set["lit_petriNets_TPArc"] = None, transitions: "lit_petriNets_Net" = None, dst11: set["lit_petriNets_PTArc"] = None, Transition19: "lit_petriNets_PTArc" = None, Transition22: "lit_petriNets_TPArc" = None):
        self.name = name
