...
class description_TreeItemMappingContainer:
    ...
    pass
class tree_description_TreeItemMapping(description_StyleUpdater, description_TreeItemUpdater, description_TreeItemMappingContainer, description_TreeMapping):

    def __init__(self, domainClass: str, preconditionExpression: str, semanticCandidatesExpression: str, tree_description_TreeItemMapping: set["TreeItemMapping"] = None, tree_description_TreeItemMapping21: set["TreeItemMapping"] = None, tree_description_TreeItemMapping24: "TreeItemMapping" = None, mapping: "TreeItemDeletionTool" = None, tree_description_TreeItemMapping28: set["TreeItemCreationTool"] = None, tree_description_TreeItemMapping31: set["TreeItemDragTool"] = None, tree_description_TreeItemMapping33: set["TreePopupMenu"] = None):
...
class DTreeItemContainer:
    ...
    pass
class tree_DTreeItem(DTreeItemContainer, DTreeElement):

    def __init__(self, expanded: bool, DTreeItem: "tree_DTreeItemContainer" = None, tree_DTreeItem: "tree_TreeItemStyle" = None, tree_DTreeItem10: "StyleUpdater" = None, tree_DTreeItem12: "TreeItemUpdater" = None, tree_DTreeItem7: "TreeItemMapping" = None, ownedTreeItems: "tree_DTreeItemContainer" = None):
...
class tree_description_TreeItemDragTool(tool_MappingBasedToolDescription, description_TreeItemTool):
    ...
    def __init__(self, dragSourceType: str, tree_description_TreeItemDragTool44: "tool_ElementDropVariable" = None, tree_description_TreeItemDragTool46: "tool_ContainerViewVariable" = None, tree_description_TreeItemDragTool48: set["TreeItemMappingContainer"] = None, tree_description_TreeItemDragTool50: "PrecedingSiblingsVariables" = None, tree_description_TreeItemDragTool: "tool_DropContainerVariable" = None, tree_description_TreeItemDragTool41: "tool_DropContainerVariable" = None):
