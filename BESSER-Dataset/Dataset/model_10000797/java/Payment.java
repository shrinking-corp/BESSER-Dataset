...
public class Payment  {
    ...
    public Payment(
        String pay_mode,        String pay_amount,        int pay_id,        String card_no,        String ex_date    ) {
    ...
    public Payment(
        String pay_mode,        String pay_amount,        int pay_id,        String card_no,        String ex_date        ArrayList<Reg_User> reg_users    ) {
        this.pay_mode = pay_mode;
        this.pay_amount = pay_amount;
        this.pay_id = pay_id;
        this.card_no = card_no;
