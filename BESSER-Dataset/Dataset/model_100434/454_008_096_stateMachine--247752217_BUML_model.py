...
stateMachine_DocumentField = Class(name="stateMachine_DocumentField")
stateMachine_Role = Class(name="stateMachine_Role")
stateMachine_StateMachine = Class(name="stateMachine_StateMachine")
stateMachine_Trans = Class(name="stateMachine_Trans")
stateMachine_FieldState = Class(name="stateMachine_FieldState")
stateMachine_TransSet = Class(name="stateMachine_TransSet")
...
stateMachine_StateMachine.attributes={stateMachine_StateMachine_package, stateMachine_StateMachine_name}
...
domain_model = DomainModel(
    name="stateMachine",
    types={stateMachine_Event, stateMachine_State, stateMachine_DocumentField, stateMachine_Role, stateMachine_StateMachine, stateMachine_Trans, stateMachine_FieldState, stateMachine_TransSet, EFieldState},
    associations={eventList0, stateList1, initial3, fieldList6, roleList8, transList10, fieldState12, transSetList14, event16, target19, fieldRef22, transList25, firedBy28},
    generalizations={},
    metadata=None
)
