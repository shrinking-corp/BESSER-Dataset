...
class component_Port(WrapperObject):
    ...
    def findPort(self, component_diagram, component_originalPortString) :
...
class component_ConnectorProfile(IPropertyMap, WrapperObject):
    ...
    @property
    def outportSerializerType(self):
...
class component_Component(IPropertyMap, WrapperObject):
    ...
    def __init__(self, instanceNameL: str, venderL: str, descriptionL: str, categoryL: str, typeNameL: str, versionL: str, pathId: str, outportDirection: str, compositeTypeL: str, componentId: str, required: bool, startUp: str, shutDown: str, activation: str, deActivation: str, resetting: str, initialize: str, finalize: str, component_Component: "component_SystemDiagram" = None, component_Component8: set["component_ConfigurationSet"] = None, component_Component10: "component_ConfigurationSet" = None, component_Component13: set["component_Port"] = None, component_Component6: "component_SystemDiagram" = None, component_Component24: "component_ExecutionContext" = None, component_Component26: set["component_ExecutionContext"] = None, component_Component29: set["component_ExecutionContext"] = None, component_Component32: "component_ContextHandler" = None, component_Component34: "component_ContextHandler" = None, component_Component37: "component_SystemDiagram" = None, component_Component15: set["component_InPort"] = None, component_Component17: set["component_OutPort"] = None, component_Component19: set["component_ServicePort"] = None, component_Component22: "component_Component" = None, component_Component20: set["component_Component"] = None, component_Component41: "component_ExecutionContext" = None, component_Component44: "component_ExecutionContext" = None):
    ...
    def updateConfigurationSetR(self, component_configSet, component_isActive) :
    ...
    def updateConfigurationSetListR(self, component_list, component_activeConfigurationSet, component_originallist) :
