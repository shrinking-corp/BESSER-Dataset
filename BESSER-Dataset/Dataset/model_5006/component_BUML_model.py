...
# Classes
component_SystemDiagram = Class(name="component_SystemDiagram")
ModelElement = Class(name="ModelElement")
IPropertyMap = Class(name="IPropertyMap")
component_Component = Class(name="component_Component", is_abstract=True)
component_ConfigurationSet = Class(name="component_ConfigurationSet")
component_Port = Class(name="component_Port")
component_InPort = Class(name="component_InPort")
WrapperObject = Class(name="WrapperObject")
component_ExecutionContext = Class(name="component_ExecutionContext")
component_ContextHandler = Class(name="component_ContextHandler")
component_ComponentSpecification = Class(name="component_ComponentSpecification")
component_OutPort = Class(name="component_OutPort")
component_ServicePort = Class(name="component_ServicePort")
IAdaptable = Class(name="IAdaptable")
Component = Class(name="Component")
component_PortSynchronizer = Class(name="component_PortSynchronizer")
component_ConnectorProfile = Class(name="component_ConnectorProfile")
Port = Class(name="Port")
component_PortConnector = Class(name="component_PortConnector", is_abstract=True)
component_NameValue = Class(name="component_NameValue")
component_IPropertyMap = Class(name="component_IPropertyMap", is_abstract=True)
component_EIntegerObjectToPointMapEntry = Class(name="component_EIntegerObjectToPointMapEntry")
component_CorbaComponent = Class(name="component_CorbaComponent")
CorbaWrapperObject = Class(name="CorbaWrapperObject")
component_CorbaPortSynchronizer = Class(name="component_CorbaPortSynchronizer")
PortSynchronizer = Class(name="PortSynchronizer")
component_CorbaConnectorProfile = Class(name="component_CorbaConnectorProfile")
ConnectorProfile = Class(name="ConnectorProfile")
component_CorbaConfigurationSet = Class(name="component_CorbaConfigurationSet")
ConfigurationSet = Class(name="ConfigurationSet")
component_CorbaExecutionContext = Class(name="component_CorbaExecutionContext")
ExecutionContext = Class(name="ExecutionContext")
component_CorbaContextHandler = Class(name="component_CorbaContextHandler")
ContextHandler = Class(name="ContextHandler")
component_CorbaObserver = Class(name="component_CorbaObserver")
CorbaObserver = Class(name="CorbaObserver")
component_CorbaStatusObserver = Class(name="component_CorbaStatusObserver")
component_CorbaLogObserver = Class(name="component_CorbaLogObserver")
...
component_SystemDiagram_m_setSynchronizeInterval: Method = Method(name="setSynchronizeInterval", parameters={Parameter(name='component_milliSecond', type=StringType)})
component_SystemDiagram_m_addPropertyChangeListener: Method = Method(name="addPropertyChangeListener", parameters={Parameter(name='component_listener', type=StringType)})
component_SystemDiagram_m_removePropertyChangeListener: Method = Method(name="removePropertyChangeListener", parameters={Parameter(name='component_listener', type=StringType)})
component_SystemDiagram.attributes={component_SystemDiagram_ConnectorProcessing, component_SystemDiagram_systemId, component_SystemDiagram_updateDate, component_SystemDiagram_kind, component_SystemDiagram_creationDate}
component_SystemDiagram.methods={component_SystemDiagram_m_removePropertyChangeListener, component_SystemDiagram_m_addPropertyChangeListener, component_SystemDiagram_m_setSynchronizeInterval}
...
component_Component_m_setComponentsR: Method = Method(name="setComponentsR", parameters={Parameter(name='component_componentList', type=StringType)}, type=BooleanType)
component_Component_m_addComponentsR: Method = Method(name="addComponentsR", parameters={Parameter(name='component_componentList', type=StringType)}, type=BooleanType)
component_Component_m_removeComponentR: Method = Method(name="removeComponentR", parameters={Parameter(name='component_component', type=StringType)}, type=BooleanType)
component_Component_m_setExportedPorts: Method = Method(name="setExportedPorts", parameters={Parameter(name='component_values', type=StringType)}, type=BooleanType)
component_Component_m_updateConfigurationSetR: Method = Method(name="updateConfigurationSetR", parameters={Parameter(name='component_isActive', type=StringType), Parameter(name='component_configSet', type=StringType)}, type=BooleanType)
component_Component_m_updateConfigurationSetListR: Method = Method(name="updateConfigurationSetListR", parameters={Parameter(name='component_originallist', type=StringType), Parameter(name='component_list', type=StringType), Parameter(name='component_activeConfigurationSet', type=StringType)}, type=BooleanType)
...
component_Component.attributes={component_Component_deActivation, component_Component_shutDown, component_Component_required, component_Component_venderL, component_Component_initialize, component_Component_categoryL, component_Component_instanceNameL, component_Component_typeNameL, component_Component_finalize, component_Component_outportDirection, component_Component_compositeTypeL, component_Component_descriptionL, component_Component_pathId, component_Component_startUp, component_Component_resetting, component_Component_componentId, component_Component_activation, component_Component_versionL}
component_Component.methods={component_Component_m_hasComponentAction, component_Component_m_addComponentsR, component_Component_m_inOnlineSystemDiagram, component_Component_m_getAllComponents, component_Component_m_setExportedPorts, component_Component_m_updateConfigurationSetListR, component_Component_m_removeComponentR, component_Component_m_isCompositeComponent, component_Component_m_updateConfigurationSetR, component_Component_m_getPath, component_Component_m_isGroupingCompositeComponent, component_Component_m_setComponentsR}
...
component_Port_m_findPort: Method = Method(name="findPort", parameters={Parameter(name='component_diagram', type=StringType), Parameter(name='component_originalPortString', type=StringType)}, type=StringType)
component_Port_m_validateTargetConnector: Method = Method(name="validateTargetConnector", parameters={Parameter(name='component_target', type=StringType)}, type=BooleanType)
component_Port_m_validateSourceConnector: Method = Method(name="validateSourceConnector", parameters={Parameter(name='component_source', type=StringType)}, type=BooleanType)
component_Port_m_disconnectAll: Method = Method(name="disconnectAll", parameters={})
component_Port.attributes={component_Port_allowAnyInterfaceType, component_Port_subscriptionType, component_Port_allowAnySubscriptionType, component_Port_originalPortString, component_Port_nameL, component_Port_allowAnyDataflowType, component_Port_interfaces, component_Port_dataType, component_Port_dataflowType, component_Port_interfaceType, component_Port_allowAnyDataType}
component_Port.methods={component_Port_m_validateTargetConnector, component_Port_m_validateSourceConnector, component_Port_m_findPort, component_Port_m_disconnectAll}
...
component_ExecutionContext_m_setRateR: Method = Method(name="setRateR", parameters={Parameter(name='component_rate', type=StringType)}, type=BooleanType)
component_ExecutionContext_m_addComponentR: Method = Method(name="addComponentR", parameters={Parameter(name='component_comp', type=StringType)}, type=BooleanType)
component_ExecutionContext_m_removeComponentR: Method = Method(name="removeComponentR", parameters={Parameter(name='component_comp', type=StringType)}, type=BooleanType)
component_ExecutionContext_m_containsComponent: Method = Method(name="containsComponent", parameters={Parameter(name='component_comp', type=StringType)}, type=BooleanType)
component_ExecutionContext_m_isOwner: Method = Method(name="isOwner", parameters={Parameter(name='component_comp', type=StringType)}, type=BooleanType)
...
component_ExecutionContext.attributes={component_ExecutionContext_stateL, component_ExecutionContext_kindL, component_ExecutionContext_rateL}
component_ExecutionContext.methods={component_ExecutionContext_m_removeComponentR, component_ExecutionContext_m_setRateR, component_ExecutionContext_m_isOwner, component_ExecutionContext_m_getKindName, component_ExecutionContext_m_getId, component_ExecutionContext_m_containsComponent, component_ExecutionContext_m_addComponentR, component_ExecutionContext_m_getStateName}

# component_ContextHandler class attributes and methods
component_ContextHandler_m_setContext: Method = Method(name="setContext", parameters={Parameter(name='component_ec', type=StringType), Parameter(name='component_id', type=StringType)}, type=StringType)
component_ContextHandler_m_getContext: Method = Method(name="getContext", parameters={Parameter(name='component_id', type=StringType)}, type=StringType)
component_ContextHandler_m_getId: Method = Method(name="getId", parameters={Parameter(name='component_ec', type=StringType)}, type=StringType)
component_ContextHandler_m_removeContext: Method = Method(name="removeContext", parameters={Parameter(name='component_id', type=StringType)}, type=StringType)
component_ContextHandler_m_removeId: Method = Method(name="removeId", parameters={Parameter(name='component_ec', type=StringType)}, type=StringType)
...
component_ContextHandler.methods={component_ContextHandler_m_getContext, component_ContextHandler_m_keys, component_ContextHandler_m_clear, component_ContextHandler_m_removeId, component_ContextHandler_m_getType, component_ContextHandler_m_sync, component_ContextHandler_m_getId, component_ContextHandler_m_getOwnerContexts, component_ContextHandler_m_setContext, component_ContextHandler_m_values, component_ContextHandler_m_removeContext}
...
component_ComponentSpecification.attributes={component_ComponentSpecification_specUnLoad, component_ComponentSpecification_aliasName, component_ComponentSpecification_rtcType}
...
component_PortSynchronizer_m_disconnect: Method = Method(name="disconnect", parameters={Parameter(name='component_conn_id', type=StringType)}, type=BooleanType)
component_PortSynchronizer_m_disconnect: Method = Method(name="disconnect", parameters={Parameter(name='component_conn_prof', type=StringType)}, type=BooleanType)
...
component_ConnectorProfile.attributes={component_ConnectorProfile_skipCount, component_ConnectorProfile_skipCountAvailable, component_ConnectorProfile_timestampPolicy, component_ConnectorProfile_targetString, component_ConnectorProfile_inportSerializerType, component_ConnectorProfile_pushRate, component_ConnectorProfile_sourceString, component_ConnectorProfile_outportBufferLength, component_ConnectorProfile_outportSerializerType, component_ConnectorProfile_outportBufferEmptyPolicy, component_ConnectorProfile_subscriptionType, component_ConnectorProfile_interfaceType, component_ConnectorProfile_inportBufferWriteTimeout, component_ConnectorProfile_subscriptionTypeAvailable, component_ConnectorProfile_inportBufferFullPolicy, component_ConnectorProfile_pushPolicyAvailable, component_ConnectorProfile_inportBufferReadTimeout, component_ConnectorProfile_dataType, component_ConnectorProfile_outportBufferReadTimeout, component_ConnectorProfile_connectorId, component_ConnectorProfile_pushIntervalAvailable, component_ConnectorProfile_outportBufferWriteTimeout, component_ConnectorProfile_outportBufferFullPolicy, component_ConnectorProfile_inportBufferEmptyPolicy, component_ConnectorProfile_isReverse, component_ConnectorProfile_inportBufferLength, component_ConnectorProfile_dataflowType, component_ConnectorProfile_name, component_ConnectorProfile_pushPolicy}
...
component_PortConnector.methods={component_PortConnector_m_deleteConnectorR, component_PortConnector_m_createConnectorR}
...
component_NameValue.attributes={component_NameValue_name, component_NameValue_typeName, component_NameValue_value}

# component_IPropertyMap class attributes and methods
component_IPropertyMap_m_getProperty: Method = Method(name="getProperty", parameters={Parameter(name='component_key', type=StringType)}, type=StringType)
component_IPropertyMap_m_setProperty: Method = Method(name="setProperty", parameters={Parameter(name='component_key', type=StringType), Parameter(name='component_value', type=StringType)})
component_IPropertyMap_m_removeProperty: Method = Method(name="removeProperty", parameters={Parameter(name='component_key', type=StringType)}, type=StringType)
...
component_IPropertyMap.methods={component_IPropertyMap_m_setProperty, component_IPropertyMap_m_removeProperty, component_IPropertyMap_m_getPropertyKeys, component_IPropertyMap_m_getPropertyMap, component_IPropertyMap_m_getProperty}
...
component_CorbaComponent_m_getExecutionContextState: Method = Method(name="getExecutionContextState", parameters={Parameter(name='component_ec', type=StringType)}, type=IntegerType)
...
component_CorbaComponent_m_getExecutionContextStateName: Method = Method(name="getExecutionContextStateName", parameters={Parameter(name='component_ec', type=StringType)}, type=StringType)
...
component_CorbaComponent_m_attachPortEventObserver: Method = Method(name="attachPortEventObserver", parameters={Parameter(name='component_observer', type=StringType)})
component_CorbaComponent_m_detatchPortEventObserver: Method = Method(name="detatchPortEventObserver", parameters={Parameter(name='component_observer', type=StringType)})
component_CorbaComponent.attributes={component_CorbaComponent_rTCComponentProfile, component_CorbaComponent_rTCExecutionContexts, component_CorbaComponent_rTCRTObjects, component_CorbaComponent_sDOConfiguration, component_CorbaComponent_componentState, component_CorbaComponent_ior, component_CorbaComponent_sDOOrganization, component_CorbaComponent_rTCParticipationContexts}
component_CorbaComponent.methods={component_CorbaComponent_m_getExecutionContextStateName, component_CorbaComponent_m_activateR, component_CorbaComponent_m_activateAll, component_CorbaComponent_m_deactivateR, component_CorbaComponent_m_resetR, component_CorbaComponent_m_getExecutionContextState, component_CorbaComponent_m_detatchPortEventObserver, component_CorbaComponent_m_getExecutionContextStateName, component_CorbaComponent_m_supportedCorbaObserver, component_CorbaComponent_m_startAll, component_CorbaComponent_m_stopAll, component_CorbaComponent_m_getComponentStateName, component_CorbaComponent_m_stopR, component_CorbaComponent_m_startR, component_CorbaComponent_m_attachPortEventObserver, component_CorbaComponent_m_deactivateAll, component_CorbaComponent_m_finalizeR, component_CorbaComponent_m_exitR, component_CorbaComponent_m_getExecutionContextState, component_CorbaComponent_m_getCorbaObjectInterface}
...
component_CorbaExecutionContext_m_activateR: Method = Method(name="activateR", parameters={Parameter(name='component_comp', type=StringType)}, type=IntegerType)
component_CorbaExecutionContext_m_deactivateR: Method = Method(name="deactivateR", parameters={Parameter(name='component_comp', type=StringType)}, type=IntegerType)
component_CorbaExecutionContext_m_resetR: Method = Method(name="resetR", parameters={Parameter(name='component_comp', type=StringType)}, type=IntegerType)
component_CorbaExecutionContext_m_getComponentState: Method = Method(name="getComponentState", parameters={Parameter(name='component_comp', type=StringType)}, type=IntegerType)
component_CorbaExecutionContext_m_getComponentStateName: Method = Method(name="getComponentStateName", parameters={Parameter(name='component_comp', type=StringType)}, type=StringType)
component_CorbaExecutionContext.attributes={component_CorbaExecutionContext_rtcExecutionContextProfile}
component_CorbaExecutionContext.methods={component_CorbaExecutionContext_m_getComponentStateName, component_CorbaExecutionContext_m_getComponentState, component_CorbaExecutionContext_m_resetR, component_CorbaExecutionContext_m_startR, component_CorbaExecutionContext_m_stopR, component_CorbaExecutionContext_m_activateR, component_CorbaExecutionContext_m_deactivateR}
...
component_CorbaObserver_m_attachComponent: Method = Method(name="attachComponent", parameters={Parameter(name='component_component', type=StringType)}, type=BooleanType)
...
component_CorbaObserver.methods={component_CorbaObserver_m_detachComponent, component_CorbaObserver_m_attachComponent, component_CorbaObserver_m_deactivate, component_CorbaObserver_m_finish, component_CorbaObserver_m_activate}
...
domain_model = DomainModel(
    name="component",
    types={component_SystemDiagram, ModelElement, IPropertyMap, component_Component, component_ConfigurationSet, component_Port, component_InPort, WrapperObject, component_ExecutionContext, component_ContextHandler, component_ComponentSpecification, component_OutPort, component_ServicePort, IAdaptable, Component, component_PortSynchronizer, component_ConnectorProfile, Port, component_PortConnector, component_NameValue, component_IPropertyMap, component_EIntegerObjectToPointMapEntry, component_CorbaComponent, CorbaWrapperObject, component_CorbaPortSynchronizer, PortSynchronizer, component_CorbaConnectorProfile, ConnectorProfile, component_CorbaConfigurationSet, ConfigurationSet, component_CorbaExecutionContext, ExecutionContext, component_CorbaContextHandler, ContextHandler, component_CorbaObserver, CorbaObserver, component_CorbaStatusObserver, component_CorbaLogObserver, SystemDiagramKind},
    associations={components0, configurationSets7, activeConfigurationSet9, ports12, parentSystemDiagram2, compositeComponent4, primaryExecutionContext23, executionContexts25, participationContexts28, executionContextHandler31, participationContextHandler33, childSystemDiagram36, inports14, outports16, serviceports18, components21, owner39, participants42, synchronizer47, connectorProfiles49, configurationData45, connectorProfile51, routingConstraint53, source55, target58, statusObserver61, logObserver62},
    generalizations={gen_component_SystemDiagram_ModelElement, gen_component_SystemDiagram_IPropertyMap, gen_component_Component_WrapperObject, gen_component_Component_IPropertyMap, gen_component_ContextHandler_IAdaptable, gen_component_ConfigurationSet_WrapperObject, gen_component_ComponentSpecification_Component, gen_component_ExecutionContext_WrapperObject, gen_component_ExecutionContext_IPropertyMap, gen_component_InPort_Port, gen_component_OutPort_Port, gen_component_ServicePort_Port, gen_component_PortSynchronizer_IPropertyMap, gen_component_PortConnector_WrapperObject, gen_component_NameValue_WrapperObject, gen_component_Port_WrapperObject, gen_component_ConnectorProfile_WrapperObject, gen_component_ConnectorProfile_IPropertyMap, gen_component_IPropertyMap_IAdaptable, gen_component_CorbaComponent_Component, gen_component_CorbaComponent_CorbaWrapperObject, gen_component_CorbaPortSynchronizer_CorbaWrapperObject, gen_component_CorbaPortSynchronizer_PortSynchronizer, gen_component_CorbaConnectorProfile_ConnectorProfile, gen_component_CorbaConfigurationSet_ConfigurationSet, gen_component_CorbaExecutionContext_ExecutionContext, gen_component_CorbaExecutionContext_CorbaWrapperObject, gen_component_CorbaContextHandler_ContextHandler, gen_component_CorbaObserver_IPropertyMap, gen_component_CorbaObserver_IAdaptable, gen_component_CorbaStatusObserver_CorbaObserver, gen_component_CorbaLogObserver_CorbaObserver},
    metadata=None
)
