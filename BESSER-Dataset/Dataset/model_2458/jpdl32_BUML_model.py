...
# Classes
jpdl32_ActionType = Class(name="jpdl32_ActionType")
jpdl32_CancelTimerType = Class(name="jpdl32_CancelTimerType")
jpdl32_ConditionType = Class(name="jpdl32_ConditionType")
jpdl32_AssignmentType = Class(name="jpdl32_AssignmentType")
Delegation = Class(name="Delegation")
jpdl32_ScriptType = Class(name="jpdl32_ScriptType")
jpdl32_CreateTimerType = Class(name="jpdl32_CreateTimerType")
jpdl32_DecisionType = Class(name="jpdl32_DecisionType")
jpdl32_Delegation = Class(name="jpdl32_Delegation")
jpdl32_EventType = Class(name="jpdl32_EventType")
jpdl32_ExceptionHandlerType = Class(name="jpdl32_ExceptionHandlerType")
jpdl32_TransitionType = Class(name="jpdl32_TransitionType")
jpdl32_DocumentRoot = Class(name="jpdl32_DocumentRoot")
jpdl32_EStringToStringMapEntry = Class(name="jpdl32_EStringToStringMapEntry")
jpdl32_NodeType = Class(name="jpdl32_NodeType")
jpdl32_EndStateType = Class(name="jpdl32_EndStateType")
jpdl32_ForkType = Class(name="jpdl32_ForkType")
jpdl32_JoinType = Class(name="jpdl32_JoinType")
jpdl32_MailType = Class(name="jpdl32_MailType")
jpdl32_MailNodeType = Class(name="jpdl32_MailNodeType")
jpdl32_TaskType = Class(name="jpdl32_TaskType")
jpdl32_ProcessDefinitionType = Class(name="jpdl32_ProcessDefinitionType")
jpdl32_ProcessStateType = Class(name="jpdl32_ProcessStateType")
jpdl32_StartStateType = Class(name="jpdl32_StartStateType")
jpdl32_StateType = Class(name="jpdl32_StateType")
jpdl32_SuperStateType = Class(name="jpdl32_SuperStateType")
jpdl32_SwimlaneType = Class(name="jpdl32_SwimlaneType")
jpdl32_VariableType = Class(name="jpdl32_VariableType")
jpdl32_TaskNodeType = Class(name="jpdl32_TaskNodeType")
jpdl32_TimerType = Class(name="jpdl32_TimerType")
jpdl32_ReminderType = Class(name="jpdl32_ReminderType")
jpdl32_SubProcessType = Class(name="jpdl32_SubProcessType")
...
jpdl32_ActionType_async_: Property = Property(name="async_", type=StringType)
jpdl32_ActionType_class_: Property = Property(name="class_", type=StringType)
...
jpdl32_ActionType.attributes={jpdl32_ActionType_expression, jpdl32_ActionType_mixed, jpdl32_ActionType_configType, jpdl32_ActionType_refName, jpdl32_ActionType_any, jpdl32_ActionType_async_, jpdl32_ActionType_acceptPropagatedEvents, jpdl32_ActionType_class_, jpdl32_ActionType_name}
...
jpdl32_ConditionType.attributes={jpdl32_ConditionType_mixed, jpdl32_ConditionType_group, jpdl32_ConditionType_any, jpdl32_ConditionType_expression}
...
jpdl32_AssignmentType.attributes={jpdl32_AssignmentType_actorId, jpdl32_AssignmentType_pooledActors, jpdl32_AssignmentType_expression}
...
jpdl32_ScriptType.attributes={jpdl32_ScriptType_mixed, jpdl32_ScriptType_acceptPropagatedEvents, jpdl32_ScriptType_any, jpdl32_ScriptType_name}
...
jpdl32_CreateTimerType.attributes={jpdl32_CreateTimerType_repeat, jpdl32_CreateTimerType_transition, jpdl32_CreateTimerType_name, jpdl32_CreateTimerType_duedate}

# jpdl32_DecisionType class attributes and methods
jpdl32_DecisionType_async_: Property = Property(name="async_", type=StringType)
...
jpdl32_DecisionType.attributes={jpdl32_DecisionType_name, jpdl32_DecisionType_async_, jpdl32_DecisionType_group, jpdl32_DecisionType_expression, jpdl32_DecisionType_description}
...
jpdl32_Delegation_class_: Property = Property(name="class_", type=StringType)
jpdl32_Delegation_configType: Property = Property(name="configType", type=StringType)
jpdl32_Delegation.attributes={jpdl32_Delegation_mixed, jpdl32_Delegation_any, jpdl32_Delegation_class_, jpdl32_Delegation_configType}
...
jpdl32_EventType.attributes={jpdl32_EventType_type, jpdl32_EventType_actionElements}
...
jpdl32_TransitionType.attributes={jpdl32_TransitionType_group, jpdl32_TransitionType_description, jpdl32_TransitionType_to, jpdl32_TransitionType_name}
...
jpdl32_DocumentRoot.attributes={jpdl32_DocumentRoot_template, jpdl32_DocumentRoot_recipients, jpdl32_DocumentRoot_text, jpdl32_DocumentRoot_to, jpdl32_DocumentRoot_mixed, jpdl32_DocumentRoot_description, jpdl32_DocumentRoot_subject}

# jpdl32_EStringToStringMapEntry class attributes and methods

# jpdl32_NodeType class attributes and methods
jpdl32_NodeType_async_: Property = Property(name="async_", type=StringType)
...
jpdl32_NodeType.attributes={jpdl32_NodeType_nodeContentElements, jpdl32_NodeType_async_, jpdl32_NodeType_name, jpdl32_NodeType_description}
...
jpdl32_EndStateType.attributes={jpdl32_EndStateType_description, jpdl32_EndStateType_endCompleteProcess, jpdl32_EndStateType_name, jpdl32_EndStateType_group}
...
jpdl32_ForkType_async_: Property = Property(name="async_", type=StringType)
jpdl32_ForkType_name: Property = Property(name="name", type=StringType)
jpdl32_ForkType.attributes={jpdl32_ForkType_group, jpdl32_ForkType_description, jpdl32_ForkType_async_, jpdl32_ForkType_name}

# jpdl32_JoinType class attributes and methods
jpdl32_JoinType_async_: Property = Property(name="async_", type=StringType)
...
jpdl32_JoinType.attributes={jpdl32_JoinType_nodeContentElements, jpdl32_JoinType_description, jpdl32_JoinType_name, jpdl32_JoinType_async_}
...
jpdl32_MailType_async_: Property = Property(name="async_", type=StringType)
...
jpdl32_MailType.attributes={jpdl32_MailType_text, jpdl32_MailType_name, jpdl32_MailType_to, jpdl32_MailType_template, jpdl32_MailType_group, jpdl32_MailType_text1, jpdl32_MailType_async_, jpdl32_MailType_actors, jpdl32_MailType_subject1, jpdl32_MailType_subject}

# jpdl32_MailNodeType class attributes and methods
jpdl32_MailNodeType_actors: Property = Property(name="actors", type=StringType)
jpdl32_MailNodeType_async_: Property = Property(name="async_", type=StringType)
...
jpdl32_MailNodeType.attributes={jpdl32_MailNodeType_async_, jpdl32_MailNodeType_template, jpdl32_MailNodeType_description, jpdl32_MailNodeType_subject, jpdl32_MailNodeType_text, jpdl32_MailNodeType_group, jpdl32_MailNodeType_name, jpdl32_MailNodeType_subject1, jpdl32_MailNodeType_text1, jpdl32_MailNodeType_to, jpdl32_MailNodeType_actors}
...
jpdl32_TaskType.attributes={jpdl32_TaskType_blocking, jpdl32_TaskType_description, jpdl32_TaskType_signalling, jpdl32_TaskType_description1, jpdl32_TaskType_duedate, jpdl32_TaskType_name, jpdl32_TaskType_swimlane, jpdl32_TaskType_group, jpdl32_TaskType_priority, jpdl32_TaskType_notify}
...
jpdl32_ProcessDefinitionType.attributes={jpdl32_ProcessDefinitionType_group, jpdl32_ProcessDefinitionType_description, jpdl32_ProcessDefinitionType_name}
...
jpdl32_ProcessStateType_async_: Property = Property(name="async_", type=StringType)
...
jpdl32_ProcessStateType.attributes={jpdl32_ProcessStateType_group, jpdl32_ProcessStateType_binding, jpdl32_ProcessStateType_async_, jpdl32_ProcessStateType_description, jpdl32_ProcessStateType_name}
...
jpdl32_StartStateType.attributes={jpdl32_StartStateType_group, jpdl32_StartStateType_description, jpdl32_StartStateType_name}
...
jpdl32_StateType_async_: Property = Property(name="async_", type=StringType)
jpdl32_StateType_name: Property = Property(name="name", type=StringType)
jpdl32_StateType.attributes={jpdl32_StateType_nodeContentElements, jpdl32_StateType_async_, jpdl32_StateType_name, jpdl32_StateType_description}
...
jpdl32_SuperStateType_async_: Property = Property(name="async_", type=StringType)
jpdl32_SuperStateType_name: Property = Property(name="name", type=StringType)
jpdl32_SuperStateType.attributes={jpdl32_SuperStateType_async_, jpdl32_SuperStateType_name, jpdl32_SuperStateType_group, jpdl32_SuperStateType_description}
...
jpdl32_VariableType.attributes={jpdl32_VariableType_name, jpdl32_VariableType_access, jpdl32_VariableType_any, jpdl32_VariableType_mappedName}
...
jpdl32_TaskNodeType_async_: Property = Property(name="async_", type=StringType)
...
jpdl32_TaskNodeType.attributes={jpdl32_TaskNodeType_signal, jpdl32_TaskNodeType_async_, jpdl32_TaskNodeType_endTasks, jpdl32_TaskNodeType_description, jpdl32_TaskNodeType_name, jpdl32_TaskNodeType_group, jpdl32_TaskNodeType_createTasks}
...
jpdl32_TimerType.attributes={jpdl32_TimerType_name, jpdl32_TimerType_repeat, jpdl32_TimerType_duedate, jpdl32_TimerType_transition}
...
domain_model = DomainModel(
    name="jpdl32",
    types={jpdl32_ActionType, jpdl32_CancelTimerType, jpdl32_ConditionType, jpdl32_AssignmentType, Delegation, jpdl32_ScriptType, jpdl32_CreateTimerType, jpdl32_DecisionType, jpdl32_Delegation, jpdl32_EventType, jpdl32_ExceptionHandlerType, jpdl32_TransitionType, jpdl32_DocumentRoot, jpdl32_EStringToStringMapEntry, jpdl32_NodeType, jpdl32_EndStateType, jpdl32_ForkType, jpdl32_JoinType, jpdl32_MailType, jpdl32_MailNodeType, jpdl32_TaskType, jpdl32_ProcessDefinitionType, jpdl32_ProcessStateType, jpdl32_StartStateType, jpdl32_StateType, jpdl32_SuperStateType, jpdl32_SwimlaneType, jpdl32_VariableType, jpdl32_TaskNodeType, jpdl32_TimerType, jpdl32_ReminderType, jpdl32_SubProcessType, BooleanType, BindingType, ConfigType, PriorityTypeMember0, SignalType, TypeTypeMember1},
    associations={script1, action0, handler3, event4, exceptionHandler6, transition8, controller21, createTimer24, xMLNSPrefixMap10, xSISchemaLocation11, action14, assignment17, cancelTimer19, node46, decision27, endState30, event32, exceptionHandler35, fork38, join40, mail42, mailNode44, task63, processDefinition48, processState50, script52, startState55, state57, superState59, swimlane61, variable72, taskNode65, timer67, transition69, createTimer86, cancelTimer89, event74, exceptionHandler77, action80, script83, event104, exceptionHandler107, mail92, action95, script98, script101, transition125, timer110, transition113, event116, exceptionHandler119, timer122, timer134, transition137, event128, exceptionHandler131, action140, script143, transition164, createTimer146, cancelTimer149, mail152, event155, exceptionHandler158, timer161, state176, taskNode179, superState182, swimlane167, startState170, node173, endState197, mailNode200, processState185, fork188, join191, decision194, task224, action203, script206, createTimer209, cancelTimer212, mail215, event218, exceptionHandler221, subProcess227, variable229, event232, exceptionHandler235, timer238, transition241, task244, event256, exceptionHandler259, timer262, transition247, event250, exceptionHandler253, state271, taskNode274, superState278, transition265, node268, event298, exceptionHandler301, timer304, processState280, fork283, join286, decision289, endState292, mailNode295, event316, exceptionHandler319, timer322, transition307, assignment310, task313, event334, timer337, reminder340, transition325, assignment328, controller331, cancelTimer351, mail354, action342, script345, createTimer348, cancelTimer368, mail371, exceptionHandler374, condition357, action359, script362, createTimer365},
