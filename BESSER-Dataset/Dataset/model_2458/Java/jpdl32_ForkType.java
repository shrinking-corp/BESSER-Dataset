...
public class jpdl32_ForkType  {
    ...
    public jpdl32_ForkType(
        String description,        String name,        String group,        String async_    ) {
    ...
    public jpdl32_ForkType(
        String description,        String name,        String group,        String async_        ArrayList<jpdl32_TransitionType> jpdl32_transitiontypes,        ArrayList<jpdl32_ScriptType> jpdl32_scripttypes,        ArrayList<jpdl32_EventType> jpdl32_eventtypes,        ArrayList<jpdl32_ExceptionHandlerType> jpdl32_exceptionhandlertypes    ) {
        this.description = description;
        this.name = name;
        this.group = group;
        this.async_ = async_;
