...
public class jpdl32_StateType  {
    ...
    public jpdl32_StateType(
        String async_,        String name,        String nodeContentElements,        String description    ) {
        this.async_ = async_;
        this.name = name;
    ...
    public jpdl32_StateType(
        String async_,        String name,        String nodeContentElements,        String description        ArrayList<jpdl32_EventType> jpdl32_eventtypes,        ArrayList<jpdl32_ExceptionHandlerType> jpdl32_exceptionhandlertypes,        ArrayList<jpdl32_TransitionType> jpdl32_transitiontypes    ) {
        this.async_ = async_;
        this.name = name;
        this.nodeContentElements = nodeContentElements;
        this.description = description;
