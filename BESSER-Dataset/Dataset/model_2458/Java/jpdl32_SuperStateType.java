...
public class jpdl32_SuperStateType  {
    ...
    public jpdl32_SuperStateType(
        String name,        String description,        String group,        String async_    ) {
        this.name = name;
    ...
    public jpdl32_SuperStateType(
        String name,        String description,        String group,        String async_        ArrayList<jpdl32_EndStateType> jpdl32_endstatetypes,        ArrayList<jpdl32_StateType> jpdl32_statetypes,        ArrayList<jpdl32_ExceptionHandlerType> jpdl32_exceptionhandlertypes,        ArrayList<jpdl32_NodeType> jpdl32_nodetypes,        ArrayList<jpdl32_TransitionType> jpdl32_transitiontypes,        ArrayList<jpdl32_DecisionType> jpdl32_decisiontypes,        ArrayList<jpdl32_JoinType> jpdl32_jointypes,        ArrayList<jpdl32_MailNodeType> jpdl32_mailnodetypes,        ArrayList<jpdl32_EventType> jpdl32_eventtypes,        ArrayList<jpdl32_ProcessStateType> jpdl32_processstatetypes,        ArrayList<jpdl32_ForkType> jpdl32_forktypes    ) {
        this.name = name;
        this.description = description;
        this.group = group;
        this.async_ = async_;
