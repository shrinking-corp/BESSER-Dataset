...
public class jpdl32_TaskNodeType  {
    ...
    public jpdl32_TaskNodeType(
        String signal,        String group,        String createTasks,        String endTasks,        String name,        String async_,        String description    ) {
        this.signal = signal;
        this.group = group;
    ...
    public jpdl32_TaskNodeType(
        String signal,        String group,        String createTasks,        String endTasks,        String name,        String async_,        String description        ArrayList<jpdl32_ExceptionHandlerType> jpdl32_exceptionhandlertypes,        ArrayList<jpdl32_TransitionType> jpdl32_transitiontypes,        ArrayList<jpdl32_TaskType> jpdl32_tasktypes,        ArrayList<jpdl32_EventType> jpdl32_eventtypes    ) {
        this.signal = signal;
        this.group = group;
        this.createTasks = createTasks;
        this.endTasks = endTasks;
