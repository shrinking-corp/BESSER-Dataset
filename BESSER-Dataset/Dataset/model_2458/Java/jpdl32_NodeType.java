...
public class jpdl32_NodeType  {
    ...
    public jpdl32_NodeType(
        String description,        String nodeContentElements,        String async_,        String name        ArrayList<jpdl32_ExceptionHandlerType> jpdl32_exceptionhandlertypes,        ArrayList<jpdl32_TransitionType> jpdl32_transitiontypes,        ArrayList<jpdl32_EventType> jpdl32_eventtypes    ) {
        this.description = description;
        this.nodeContentElements = nodeContentElements;
        this.async_ = async_;
        this.name = name;
