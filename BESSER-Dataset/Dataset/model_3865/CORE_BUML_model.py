...
domain_model = DomainModel(
    name="core",
    types={core_COREModel, CORENamedElement, core_COREModelReuse, core_COREModelElement, core_COREFeature, core_COREConcern, core_COREImpactModel, COREModel, core_COREImpactNode, core_LayoutContainerMap, core_COREBinding, core_CORECompositionSpecification, core_COREMapping, core_CORENamedElement, core_COREContribution, core_COREInterface, core_COREFeatureModel, COREModelElement, core_COREReuse, core_COREPattern, core_COREConcernConfiguration, core_COREConfiguration, core_COREReuseConfiguration, core_COREFeatureImpactNode, COREImpactNode, core_COREWeightedMapping, core_COREModelCompositionSpecification, core_COREImpactModelBinding, COREConfiguration, core_LayoutMap, core_EObject, core_LayoutElement, COREFeatureRelationshipType, COREVisibilityType, COREPartialityType},
    associations={modelReuses0, modelElements1, realizes3, coreConcern4, impactModelElements5, layouts6, reuses19, children21, parent24, requires27, excludes30, contributions8, models10, interface11, featureModel12, impactModel14, realizedBy17, outgoing54, incoming55, selected57, features60, root63, configurations66, defaultConfiguration68, selectable32, customizable35, usable38, impacted41, defaults44, reusedConcern46, configurations49, selectedConfiguration51, key80, value83, represents86, weightedMappings88, reusedConfiguration90, reuse93, reuse71, source74, impacts75, key77, value78},
    generalizations={gen_core_COREModel_CORENamedElement, gen_core_COREImpactModel_COREModel, gen_core_COREModelElement_CORENamedElement, gen_core_COREConcern_CORENamedElement, gen_core_COREFeature_COREModelElement, gen_core_COREImpactNode_COREModelElement, gen_core_COREFeatureModel_COREModel, gen_core_COREReuse_CORENamedElement, gen_core_COREFeatureImpactNode_COREImpactNode, gen_core_COREConcernConfiguration_COREConfiguration, gen_core_COREReuseConfiguration_COREConfiguration},
    metadata=None
)
