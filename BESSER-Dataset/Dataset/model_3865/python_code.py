...
class core_COREImpactNode(COREModelElement):
    ...
    def __init__(self, scalingFactor: float, offset: float, source: set["core_COREContribution"] = None, impacts: set["core_COREContribution"] = None, core_COREImpactNode43: "core_COREInterface" = None, COREImpactNode: "core_COREContribution" = None, COREImpactNode76: "core_COREContribution" = None, core_COREImpactNode: "core_COREImpactModel" = None):
...
class core_COREFeature(COREModelElement):
    ...
    def __init__(self, parentRelationship: str, realizes: set["core_COREModel"] = None, core_COREFeature59: "core_COREConfiguration" = None, core_COREFeature62: "core_COREFeatureModel" = None, core_COREFeature65: "core_COREFeatureModel" = None, core_COREFeature34: "core_COREInterface" = None, core_COREFeature87: "core_COREFeatureImpactNode" = None, COREFeature: "core_COREModel" = None, core_COREFeature: set["core_COREReuse"] = None, COREFeature22: "core_COREFeature" = None, parent: set["core_COREFeature"] = None, COREFeature25: "core_COREFeature" = None, children: "core_COREFeature" = None, core_COREFeature28: "core_COREFeature" = None, core_COREFeature26: set["core_COREFeature"] = None, core_COREFeature31: "core_COREFeature" = None, core_COREFeature29: set["core_COREFeature"] = None):
...
class core_COREModelElement(CORENamedElement):
    ...
    def __init__(self, partiality: str, visibility: str, core_COREModelElement37: "core_COREInterface" = None, core_COREModelElement40: "core_COREInterface" = None, core_COREModelElement: "core_COREModel" = None):
