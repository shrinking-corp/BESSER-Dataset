...
# Classes
viewers_TreeViewerInput = Class(name="viewers_TreeViewerInput")
viewers_TreeViewerElement = Class(name="viewers_TreeViewerElement")
viewers_ViewerInputs = Class(name="viewers_ViewerInputs")
viewers_ListViewerInput = Class(name="viewers_ListViewerInput")
viewers_ListViewerElement = Class(name="viewers_ListViewerElement")
viewers_TableViewerInput = Class(name="viewers_TableViewerInput")
viewers_TableViewerElement = Class(name="viewers_TableViewerElement")
...
domain_model = DomainModel(
    name="viewers",
    types={viewers_TreeViewerInput, viewers_TreeViewerElement, viewers_ViewerInputs, viewers_ListViewerInput, viewers_ListViewerElement, viewers_TableViewerInput, viewers_TableViewerElement},
    associations={elements2, children4, listInputs6, elements0, elements1, tableInputs8, treeInputs11},
    generalizations={},
    metadata=None
)
