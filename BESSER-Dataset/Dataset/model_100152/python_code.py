...
class connection_xml_TdXmlElementType(ElementType):
    ...
    def __init__(self, javaType: str, connection_xml_TdXmlElementType85: "xml_TdXmlContent" = None, connection_xml_TdXmlElementType: "xml_connection_EObject" = None, connection_xml_TdXmlElementType83: "xml_TdXmlSchema" = None):
...
class connection_XMLFileNode:
    ...
    def __init__(self, XMLPath: str, RelatedColumn: str, DefaultValue: str, Attribute: str, Order: int, Type: str, connection_XMLFileNode71: "connection_Concept" = None, connection_XMLFileNode74: "connection_Concept" = None, connection_XMLFileNode77: "connection_Concept" = None, connection_XMLFileNode: "connection_XmlFileConnection" = None, connection_XMLFileNode40: "connection_XmlFileConnection" = None, connection_XMLFileNode43: "connection_XmlFileConnection" = None):
...
class connection_XmlXPathLoopDescriptor:
    ...
    def __init__(self, LimitBoucle: str, AbsoluteXPathQuery: str, schema53: set["connection_SchemaTarget"] = None, XmlXPathLoopDescriptor: "connection_XmlFileConnection" = None, XmlXPathLoopDescriptor45: "connection_SchemaTarget" = None, schema: "connection_XmlFileConnection" = None):
...
class connection_LDAPSchemaConnection(Connection):
    ...
    def __init__(self, EncryptionMethodName: str, Value: str, SavePassword: bool, Aliases: str, Referrals: str, CountLimit: str, TimeOutLimit: str, BaseDNs: str, GetBaseDNsFromRoot: bool, ReturnAttributes: str, SelectedDN: str, Host: str, Port: str, Protocol: str, Filter: str, Separator: str, UseAdvanced: bool, StorePath: str, UseLimit: bool, UseAuthen: bool, BindPrincipal: str, BindPassword: str, LimitValue: int):
...
class connection_SAPConnection(Connection):
    ...
    def __init__(self, Host: str, Username: str, Password: str, Client: str, SystemNumber: str, Language: str, currentFucntion: str, connection13: set["connection_SAPFunctionUnit"] = None, connection15: set["connection_SAPIDocUnit"] = None, SAPConnection28: "connection_SAPIDocUnit" = None, SAPConnection: "connection_SAPFunctionUnit" = None):
        self.Host = Host
        self.Username = Username
        self.Password = Password
        self.Client = Client
...
class connection_DatabaseConnection(Connection):
    ...
    def __init__(self, DriverJarPath: str, DriverClass: str, URL: str, dbVersionString: str, Port: str, Username: str, Password: str, ServerName: str, DatasourceName: str, FileFieldName: str, SID: str, DatabaseType: str, cdcTypeMode: str, SQLMode: bool, UiSchema: str, SqlSynthax: str, StringQuote: str, NullChar: str, DbmsId: str, ProductId: str, DBRootPath: str, AdditionalParams: str, StandardSQL: bool, SystemSQL: bool, connection11: "connection_CDCConnection" = None, DatabaseConnection: "connection_CDCConnection" = None):
...
class connection_FileConnection(Connection):
    ...
    def __init__(self, EscapeType: str, EscapeChar: str, TextEnclosure: str, CsvOption: bool, Server: str, FilePath: str, Format: str, Encoding: str, FieldSeparatorValue: str, RowSeparatorType: str, RowSeparatorValue: str, TextIdentifier: str, UseHeader: bool, HeaderValue: str, UseFooter: bool, FooterValue: str, UseLimit: bool, LimitValue: str, FirstLineCaption: bool, RemoveEmptyRow: bool):
...
class connection_MDMConnection(Connection):
    ...
    def __init__(self, Port: str, Server: str, Universe: str, Datamodel: str, Datacluster: str, protocol: str, context: str, Username: str, Password: str, connection_MDMConnection: set["connection_Concept"] = None):
        self.Port = Port
        self.Server = Server
...
class connection_AbstractMetadataObject(ModelElement):
    ...
    def __init__(self, comment: str, label: str, readOnly: bool, synchronised: bool, divergency: bool, properties: str, id: str):
...
class connection_Connection(softwaredeployment_DataProvider, AbstractMetadataObject):
    ...
    def __init__(self, ContextMode: bool, ContextId: str, version: str, connection_Connection: "connection_Metadata" = None, connection: "connection_QueriesConnection" = None, connection_Connection8: "connection_MetadataTable" = None, Connection: "connection_QueriesConnection" = None):
...
class connection_SAPFunctionParameterColumn(AbstractMetadataObject):
    ...
    def __init__(self, ParameterType: str, StructureOrTableName: str, DataType: str, Length: str, Value: str, SAPFunctionParameterColumn: "connection_SAPFunctionParameterTable" = None, columns: "connection_SAPFunctionParameterTable" = None):
...
class connection_SAPFunctionUnit(AbstractMetadataObject):
    ...
    def __init__(self, OutputType: str, OutputTableName: str, SAPFunctionUnit: "connection_SAPConnection" = None, functionUnit26: "connection_SAPTestInputParameterTable" = None, functionUnit: "connection_InputSAPFunctionParameterTable" = None, functionUnit18: "connection_OutputSAPFunctionParameterTable" = None, connection_SAPFunctionUnit: "connection_MetadataTable" = None, Funtions: "connection_SAPConnection" = None, connection_SAPFunctionUnit23: set["connection_MetadataTable"] = None, SAPFunctionUnit32: "connection_InputSAPFunctionParameterTable" = None, SAPFunctionUnit66: "connection_SAPTestInputParameterTable" = None, SAPFunctionUnit34: "connection_OutputSAPFunctionParameterTable" = None):
...
class connection_CDCType(AbstractMetadataObject):
    ...
    def __init__(self, journalName: str, linkDB: str, connection_CDCType: "connection_CDCConnection" = None, connection_CDCType61: set["connection_SubscriberTable"] = None, connection_CDCType63: "connection_CDCConnection" = None):
...
class connection_MetadataColumn(record_Field, AbstractMetadataObject):
    ...
    def __init__(self, sourceType: str, defaultValue: str, talendType: str, key: bool, nullable: bool, originalField: str, pattern: str, displayField: str, connection_MetadataColumn: "connection_MetadataTable" = None, connection_MetadataColumn5: "connection_MetadataTable" = None):
