...
connection_MetadataColumn.attributes={connection_MetadataColumn_talendType, connection_MetadataColumn_pattern, connection_MetadataColumn_displayField, connection_MetadataColumn_originalField, connection_MetadataColumn_key, connection_MetadataColumn_sourceType, connection_MetadataColumn_nullable, connection_MetadataColumn_defaultValue}
...
connection_MetadataTable.attributes={connection_MetadataTable_attachedCDC, connection_MetadataTable_sourceName, connection_MetadataTable_activatedCDC, connection_MetadataTable_tableType}
...
connection_Connection.attributes={connection_Connection_ContextMode, connection_Connection_ContextId, connection_Connection_version}
...
connection_MDMConnection.attributes={connection_MDMConnection_Datamodel, connection_MDMConnection_Username, connection_MDMConnection_Password, connection_MDMConnection_Universe, connection_MDMConnection_context, connection_MDMConnection_protocol, connection_MDMConnection_Datacluster, connection_MDMConnection_Port, connection_MDMConnection_Server}
...
connection_FileConnection.attributes={connection_FileConnection_LimitValue, connection_FileConnection_CsvOption, connection_FileConnection_RowSeparatorType, connection_FileConnection_FooterValue, connection_FileConnection_EscapeChar, connection_FileConnection_UseLimit, connection_FileConnection_FilePath, connection_FileConnection_UseHeader, connection_FileConnection_Encoding, connection_FileConnection_TextEnclosure, connection_FileConnection_TextIdentifier, connection_FileConnection_EscapeType, connection_FileConnection_FirstLineCaption, connection_FileConnection_RowSeparatorValue, connection_FileConnection_Format, connection_FileConnection_HeaderValue, connection_FileConnection_UseFooter, connection_FileConnection_Server, connection_FileConnection_RemoveEmptyRow, connection_FileConnection_FieldSeparatorValue}
...
connection_Concept.attributes={connection_Concept_LoopLimit, connection_Concept_LoopExpression, connection_Concept_inputModel}
...
connection_DatabaseConnection.attributes={connection_DatabaseConnection_Password, connection_DatabaseConnection_DatasourceName, connection_DatabaseConnection_FileFieldName, connection_DatabaseConnection_NullChar, connection_DatabaseConnection_SID, connection_DatabaseConnection_DbmsId, connection_DatabaseConnection_DriverJarPath, connection_DatabaseConnection_DatabaseType, connection_DatabaseConnection_UiSchema, connection_DatabaseConnection_dbVersionString, connection_DatabaseConnection_URL, connection_DatabaseConnection_ServerName, connection_DatabaseConnection_cdcTypeMode, connection_DatabaseConnection_Port, connection_DatabaseConnection_StringQuote, connection_DatabaseConnection_AdditionalParams, connection_DatabaseConnection_DriverClass, connection_DatabaseConnection_ProductId, connection_DatabaseConnection_SqlSynthax, connection_DatabaseConnection_SQLMode, connection_DatabaseConnection_Username, connection_DatabaseConnection_StandardSQL, connection_DatabaseConnection_DBRootPath, connection_DatabaseConnection_SystemSQL}
...
connection_SAPConnection.attributes={connection_SAPConnection_Host, connection_SAPConnection_Client, connection_SAPConnection_Username, connection_SAPConnection_Language, connection_SAPConnection_currentFucntion, connection_SAPConnection_SystemNumber, connection_SAPConnection_Password}
...
connection_SAPIDocUnit.attributes={connection_SAPIDocUnit_htmlFile, connection_SAPIDocUnit_useHtmlOutput, connection_SAPIDocUnit_gatewayService, connection_SAPIDocUnit_useXmlOutput, connection_SAPIDocUnit_xmlFile, connection_SAPIDocUnit_programId}
...
connection_SAPFunctionParameterColumn.attributes={connection_SAPFunctionParameterColumn_ParameterType, connection_SAPFunctionParameterColumn_DataType, connection_SAPFunctionParameterColumn_Length, connection_SAPFunctionParameterColumn_Value, connection_SAPFunctionParameterColumn_StructureOrTableName}
...
connection_XmlFileConnection.attributes={connection_XmlFileConnection_outputFilePath, connection_XmlFileConnection_Guess, connection_XmlFileConnection_MaskXPattern, connection_XmlFileConnection_Encoding, connection_XmlFileConnection_XsdFilePath, connection_XmlFileConnection_XmlFilePath, connection_XmlFileConnection_inputModel}
...
connection_LdifFileConnection.attributes={connection_LdifFileConnection_UseLimit, connection_LdifFileConnection_FilePath, connection_LdifFileConnection_Server, connection_LdifFileConnection_value, connection_LdifFileConnection_LimitEntry}
...
connection_FileExcelConnection.attributes={connection_FileExcelConnection_SheetName, connection_FileExcelConnection_firstColumn, connection_FileExcelConnection_lastColumn, connection_FileExcelConnection_thousandSeparator, connection_FileExcelConnection_advancedSpearator, connection_FileExcelConnection_selectAllSheets, connection_FileExcelConnection_decimalSeparator, connection_FileExcelConnection_sheetList, connection_FileExcelConnection_sheetColumns}
...
connection_XMLFileNode.attributes={connection_XMLFileNode_Attribute, connection_XMLFileNode_Type, connection_XMLFileNode_RelatedColumn, connection_XMLFileNode_DefaultValue, connection_XMLFileNode_Order, connection_XMLFileNode_XMLPath}
...
connection_WSDLSchemaConnection.attributes={connection_WSDLSchemaConnection_useProxy, connection_WSDLSchemaConnection_UserName, connection_WSDLSchemaConnection_Value, connection_WSDLSchemaConnection_portName, connection_WSDLSchemaConnection_proxyPassword, connection_WSDLSchemaConnection_methodName, connection_WSDLSchemaConnection_parameters, connection_WSDLSchemaConnection_serverNameSpace, connection_WSDLSchemaConnection_timeOut, connection_WSDLSchemaConnection_EndpointURI, connection_WSDLSchemaConnection_Encoding, connection_WSDLSchemaConnection_proxyUser, connection_WSDLSchemaConnection_proxyHost, connection_WSDLSchemaConnection_Password, connection_WSDLSchemaConnection_portNameSpace, connection_WSDLSchemaConnection_WSDL, connection_WSDLSchemaConnection_serverName, connection_WSDLSchemaConnection_needAuth, connection_WSDLSchemaConnection_proxyPort, connection_WSDLSchemaConnection_isInputModel}
...
connection_LDAPSchemaConnection.attributes={connection_LDAPSchemaConnection_BindPassword, connection_LDAPSchemaConnection_Value, connection_LDAPSchemaConnection_EncryptionMethodName, connection_LDAPSchemaConnection_CountLimit, connection_LDAPSchemaConnection_Host, connection_LDAPSchemaConnection_Aliases, connection_LDAPSchemaConnection_StorePath, connection_LDAPSchemaConnection_ReturnAttributes, connection_LDAPSchemaConnection_SelectedDN, connection_LDAPSchemaConnection_LimitValue, connection_LDAPSchemaConnection_SavePassword, connection_LDAPSchemaConnection_Protocol, connection_LDAPSchemaConnection_Port, connection_LDAPSchemaConnection_TimeOutLimit, connection_LDAPSchemaConnection_Separator, connection_LDAPSchemaConnection_Referrals, connection_LDAPSchemaConnection_BaseDNs, connection_LDAPSchemaConnection_UseAuthen, connection_LDAPSchemaConnection_BindPrincipal, connection_LDAPSchemaConnection_UseAdvanced, connection_LDAPSchemaConnection_UseLimit, connection_LDAPSchemaConnection_Filter, connection_LDAPSchemaConnection_GetBaseDNsFromRoot}
...
connection_WSDLParameter.attributes={connection_WSDLParameter_source, connection_WSDLParameter_Element, connection_WSDLParameter_ParameterInfo, connection_WSDLParameter_ParameterInfoParent, connection_WSDLParameter_Expression, connection_WSDLParameter_Column}
...
connection_SalesforceSchemaConnection.attributes={connection_SalesforceSchemaConnection_useAlphbet, connection_SalesforceSchemaConnection_proxyUsername, connection_SalesforceSchemaConnection_proxyPort, connection_SalesforceSchemaConnection_queryCondition, connection_SalesforceSchemaConnection_password, connection_SalesforceSchemaConnection_userName, connection_SalesforceSchemaConnection_useProxy, connection_SalesforceSchemaConnection_timeOut, connection_SalesforceSchemaConnection_webServiceUrl, connection_SalesforceSchemaConnection_moduleName, connection_SalesforceSchemaConnection_proxyHost, connection_SalesforceSchemaConnection_proxyPassword, connection_SalesforceSchemaConnection_useCustomModuleName, connection_SalesforceSchemaConnection_useHttpProxy, connection_SalesforceSchemaConnection_batchSize}
...
connection_HL7Connection.attributes={connection_HL7Connection_EndChar, connection_HL7Connection_StartChar, connection_HL7Connection_outputFilePath}
...
connection_HL7FileNode.attributes={connection_HL7FileNode_Order, connection_HL7FileNode_RelatedColumn, connection_HL7FileNode_FilePath, connection_HL7FileNode_DefaultValue, connection_HL7FileNode_Attribute, connection_HL7FileNode_Repeatable}
...
connection_HeaderFooterConnection.attributes={connection_HeaderFooterConnection_libraries, connection_HeaderFooterConnection_mainCode, connection_HeaderFooterConnection_imports, connection_HeaderFooterConnection_isHeader}
...
connection_FTPConnection.attributes={connection_FTPConnection_FTPS, connection_FTPConnection_Method, connection_FTPConnection_Port, connection_FTPConnection_Username, connection_FTPConnection_Host, connection_FTPConnection_KeystoreFile, connection_FTPConnection_KeystorePassword, connection_FTPConnection_Usesocks, connection_FTPConnection_Proxyuser, connection_FTPConnection_Mode, connection_FTPConnection_CustomEncode, connection_FTPConnection_Password, connection_FTPConnection_Ecoding, connection_FTPConnection_Proxypassword, connection_FTPConnection_Proxyhost, connection_FTPConnection_Proxyport, connection_FTPConnection_SFTP}
...
connection_relational_TdSqlDataType.attributes={connection_relational_TdSqlDataType_caseSensitive, connection_relational_TdSqlDataType_javaDataType, connection_relational_TdSqlDataType_unsignedAttribute, connection_relational_TdSqlDataType_autoIncrement, connection_relational_TdSqlDataType_searchable, connection_relational_TdSqlDataType_nullable, connection_relational_TdSqlDataType_localTypeName}
...
connection_xml_TdXmlElementType.methods={connection_xml_TdXmlElementType_m_getContentType, connection_xml_TdXmlElementType_m_setContentType}
...
domain_model = DomainModel(
    name="connection",
    types={connection_MetadataColumn, record_Field, connection_MetadataTable, connection_Metadata, AbstractMetadataObject, connection_Connection, softwaredeployment_DataProvider, connection_QueriesConnection, core_Class, connection_AbstractMetadataObject, ModelElement, connection_DelimitedFileConnection, FileConnection, connection_PositionalFileConnection, connection_EbcdicConnection, connection_MDMConnection, connection_FileConnection, Connection, connection_Concept, connection_DatabaseConnection, connection_SAPConnection, connection_SAPFunctionUnit, connection_SAPIDocUnit, connection_CDCConnection, connection_SAPFunctionParameterColumn, connection_InputSAPFunctionParameterTable, connection_OutputSAPFunctionParameterTable, connection_SAPTestInputParameterTable, SAPFunctionParameterTable, connection_RegexpFileConnection, connection_XmlFileConnection, connection_XmlXPathLoopDescriptor, connection_SAPFunctionParameterTable, connection_Query, connection_LdifFileConnection, connection_FileExcelConnection, connection_XMLFileNode, connection_SchemaTarget, connection_GenericSchemaConnection, connection_WSDLSchemaConnection, connection_LDAPSchemaConnection, connection_CDCType, connection_WSDLParameter, connection_SalesforceSchemaConnection, TdTable, connection_ConceptTarget, connection_SubscriberTable, connection_HL7Connection, connection_HL7FileNode, connection_HeaderFooterConnection, connection_FTPConnection, connection_relational_TdTable, MetadataTable, relational_Table, connection_relational_TdView, connection_GenericPackage, Package, connection_relational_TdTrigger, Trigger, connection_relational_TdProcedure, Procedure, connection_softwaredeployment_TdDataManager, DataManager, connection_softwaredeployment_TdSoftwareSystem, SoftwareSystem, connection_softwaredeployment_TdMachine, Machine, relational_View, connection_relational_TdColumn, MetadataColumn, relational_TdSqlDataType, connection_relational_TdSqlDataType, SQLSimpleType, xml_TdXmlContent, connection_xml_TdXmlContent, Content, xml_TdXmlElementType, connection_xml_TdXmlSchema, Schema, connection_xml_TdXmlElementType, ElementType, xml_connection_EObject, xml_TdXmlSchema, FileFormat, FieldSeparator, Escape, RowSeparator, MDMConnectionProtocol, DevelopmentStatus},
    associations={table2, connections0, queries1, columns3, connection6, schemas9, Funtions12, IDocs14, cdcConns10, TestInputParameterTable25, connection27, InputParameterTable16, OutputParameterTable17, MetadataTable19, connection21, tables22, columns30, functionUnit31, functionUnit33, schema35, ParameterTable29, connection46, query47, queries49, group37, root38, loop41, schema44, connection51, schemaTargets52, connection58, cdcTypes59, parameterValue54, outputParameter55, functionUnit65, subscribers60, cdcConnection62, root79, conceptTargets67, group69, root72, loop75, schema78, sqlDataType80, xmlContent84, xmlElements86, xsdElementDeclaration81, ownedDocument82},
    generalizations={gen_connection_MetadataColumn_AbstractMetadataObject, gen_connection_MetadataColumn_record_Field, gen_connection_Metadata_AbstractMetadataObject, gen_connection_Connection_AbstractMetadataObject, gen_connection_Connection_softwaredeployment_DataProvider, gen_connection_MetadataTable_AbstractMetadataObject, gen_connection_MetadataTable_core_Class, gen_connection_AbstractMetadataObject_ModelElement, gen_connection_DelimitedFileConnection_FileConnection, gen_connection_PositionalFileConnection_FileConnection, gen_connection_EbcdicConnection_FileConnection, gen_connection_MDMConnection_Connection, gen_connection_FileConnection_Connection, gen_connection_DatabaseConnection_Connection, gen_connection_SAPConnection_Connection, gen_connection_SAPFunctionUnit_AbstractMetadataObject, gen_connection_SAPIDocUnit_AbstractMetadataObject, gen_connection_SAPFunctionParameterColumn_AbstractMetadataObject, gen_connection_SAPFunctionParameterTable_AbstractMetadataObject, gen_connection_InputSAPFunctionParameterTable_SAPFunctionParameterTable, gen_connection_OutputSAPFunctionParameterTable_SAPFunctionParameterTable, gen_connection_RegexpFileConnection_FileConnection, gen_connection_XmlFileConnection_Connection, gen_connection_Query_AbstractMetadataObject, gen_connection_LdifFileConnection_Connection, gen_connection_FileExcelConnection_FileConnection, gen_connection_WSDLSchemaConnection_Connection, gen_connection_GenericSchemaConnection_Connection, gen_connection_LDAPSchemaConnection_Connection, gen_connection_CDCType_AbstractMetadataObject, gen_connection_SalesforceSchemaConnection_Connection, gen_connection_SubscriberTable_TdTable, gen_connection_SAPTestInputParameterTable_SAPFunctionParameterTable, gen_connection_Concept_TdTable, gen_connection_HL7Connection_FileConnection, gen_connection_HeaderFooterConnection_Connection, gen_connection_FTPConnection_Connection, gen_connection_relational_TdTable_MetadataTable, gen_connection_relational_TdTable_relational_Table, gen_connection_relational_TdView_MetadataTable, gen_connection_GenericPackage_Package, gen_connection_relational_TdTrigger_Trigger, gen_connection_relational_TdProcedure_Procedure, gen_connection_softwaredeployment_TdDataManager_DataManager, gen_connection_softwaredeployment_TdSoftwareSystem_SoftwareSystem, gen_connection_softwaredeployment_TdMachine_Machine, gen_connection_relational_TdView_relational_View, gen_connection_relational_TdColumn_MetadataColumn, gen_connection_relational_TdSqlDataType_SQLSimpleType, gen_connection_xml_TdXmlContent_Content, gen_connection_xml_TdXmlSchema_Schema, gen_connection_xml_TdXmlElementType_ElementType},
    metadata=None
)
