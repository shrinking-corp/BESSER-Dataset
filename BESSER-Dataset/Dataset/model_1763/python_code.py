...
class emftest_Author:
    ...
    def writeBook(self, emftest_type, emftest_pages, emftest_title) :
        # TODO: Implement writeBook method
        pass

class emftest_Book(ABC):

    def __init__(self, title: str, pages: int, emftest_Book: set["emftest_Author"] = None, emftest_Book2: "emftest_BookCollection" = None, emftest_Book7: "emftest_Author" = None):
        self.title = title
        self.pages = pages
