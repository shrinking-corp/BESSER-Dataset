...
# Classes
emftest_Book = Class(name="emftest_Book", is_abstract=True)
emftest_Author = Class(name="emftest_Author")
emftest_ChildBook = Class(name="emftest_ChildBook")
Book = Class(name="Book")
emftest_ParentBook = Class(name="emftest_ParentBook")
emftest_BookCollection = Class(name="emftest_BookCollection")
emftest_Library = Class(name="emftest_Library")
...
emftest_Author_m_writeBook: Method = Method(name="writeBook", parameters={Parameter(name='emftest_title', type=StringType), Parameter(name='emftest_type', type=StringType), Parameter(name='emftest_pages', type=StringType)}, type=Book)
...
domain_model = DomainModel(
    name="emftest",
    types={emftest_Book, emftest_Author, emftest_ChildBook, Book, emftest_ParentBook, emftest_BookCollection, emftest_Library, BookType},
    associations={authors0, books1, collections3, books5},
    generalizations={gen_emftest_ChildBook_Book, gen_emftest_ParentBook_Book},
    metadata=None
)
