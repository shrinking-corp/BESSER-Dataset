...
class Post:
    ...
    def __init__(self, privateMode: bool, nLikes: int, nComments: int, nShares: int, owner: User, page10: "Page" = None, user5: "User" = None, group6: "Team" = None, hashTags8: "HashTags" = None):
...
class Team:
    ...
    def user1(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Team__user1", None)
    ...
    def post7(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Team__post7", None)
        self.__post7 = value
...
class User:
    ...
    def __init__(self, name: str, username: str, phone: str, password: str, gender: str, pages: str, team: str, group0: "Team" = None, page2: "Page" = None, post4: "Post" = None):
        self.name = name
