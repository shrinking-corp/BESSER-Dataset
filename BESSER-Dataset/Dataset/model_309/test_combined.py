...
def test_hyp_library_book_constructor_args():
    ...
    assert "borrowed" in params, "Missing parameter 'borrowed'"
...
@given(instance=library_Book_strategy)
def test_hyp_library_book_borrowed_setter(instance):
    original = instance.borrowed
    instance.borrowed = original
    assert instance.borrowed == original
...
def test_library_Book_borrowed_value_roundtrip():
    instance = library_Book(borrowed=True, category="sample_text", pages=7, title="sample_text")
    assert instance.borrowed == True
    instance.borrowed = False
    assert instance.borrowed == False
...
def test_assoc_author0_link_reassign_clear():
    ...
    b1 = library_Book(borrowed=True, category="sample_text", pages=7, title="sample_text")
    b2 = library_Book(borrowed=False, category="sample_text_2", pages=13, title="sample_text_2")
...
library_Book_strategy = st.builds(library_Book, borrowed=st.booleans(), category=safe_text, pages=st.integers(), title=safe_text)
@given(instance=library_Book_strategy)
