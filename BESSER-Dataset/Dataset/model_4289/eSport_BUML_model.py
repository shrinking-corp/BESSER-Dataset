...
# Classes
eSport_Player = Class(name="eSport_Player")
Person = Class(name="Person")
eSport_Capacity = Class(name="eSport_Capacity")
eSport_Person = Class(name="eSport_Person", is_abstract=True)
eSport_Team = Class(name="eSport_Team")
eSport_Coach = Class(name="eSport_Coach")
eSport_Tournament = Class(name="eSport_Tournament")
eSport_Country = Class(name="eSport_Country")
eSport_Zone = Class(name="eSport_Zone")
eSport_FinalStage = Class(name="eSport_FinalStage")
eSport_GroupStage = Class(name="eSport_GroupStage")
eSport_Qualification = Class(name="eSport_Qualification")
eSport_League = Class(name="eSport_League")
eSport_Match = Class(name="eSport_Match")
eSport_Group = Class(name="eSport_Group")
eSport_Root = Class(name="eSport_Root")
...
eSport_Tournament.attributes={eSport_Tournament_type, eSport_Tournament_name, eSport_Tournament_year, eSport_Tournament_size}
...
eSport_GroupStage.attributes={eSport_GroupStage_type, eSport_GroupStage_meetingsWithOtherGroups, eSport_GroupStage_maxNbGames, eSport_GroupStage_meetingsInSameGroup}
...
eSport_League.attributes={eSport_League_name, eSport_League_size, eSport_League_season, eSport_League_year}
...
eSport_Match.attributes={eSport_Match_type, eSport_Match_loserWins}
...
domain_model = DomainModel(
    name="eSport",
    types={eSport_Player, Person, eSport_Capacity, eSport_Person, eSport_Team, eSport_Coach, eSport_Tournament, eSport_Country, eSport_Zone, eSport_FinalStage, eSport_GroupStage, eSport_Qualification, eSport_League, eSport_Match, eSport_Group, eSport_Root, CapacityType, Position, TournamentType, GroupStageType, MatchType, Season},
    associations={zone12, groupstage14, qualifiesFor16, country18, team0, team1, countries3, allowedZones4, finalstages6, groupstages7, qualifiesFor9, qualifiesFrom10, matchsWon42, matchsLost43, finalstages45, capacities20, tournaments21, zone22, persons25, tournaments26, leagues28, countries29, teams32, players35, coach36, zone38, groups40, groupstage57, matchs59, teams61, groups64, tournament66, group48, finalstage50, teamWinner53, teamLoser55, zones85, tournaments86, leagues88, teams90, persons92, league68, matchs71, tournament73, teams75, tournamentFrom78, tournamentTo80, leagueFrom82, qualifications95, countries97},
