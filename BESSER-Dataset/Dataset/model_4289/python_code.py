...
class eSport_League:
    ...
    def __init__(self, size: int, year: int, season: str, name: str, leagues: "eSport_Zone" = None, league: "eSport_GroupStage" = None, leagueFrom: set["eSport_Qualification"] = None, eSport_League: "eSport_Root" = None, League70: "eSport_GroupStage" = None, League: "eSport_Zone" = None, League84: "eSport_Qualification" = None):
        self.size = size
        self.year = year
        self.season = season
        self.name = name
...
class eSport_Qualification:
    ...
    def __init__(self, name: str, Qualification17: "eSport_League" = None, Qualification: "eSport_Tournament" = None, Qualification11: "eSport_Tournament" = None, qualifiesFor: "eSport_Tournament" = None, qualifiesFrom: "eSport_Tournament" = None, qualifiesFor83: "eSport_League" = None, eSport_Qualification: "eSport_Root" = None):
        self.name = name
...
class eSport_GroupStage:
    ...
    def __init__(self, type: str, maxNbGames: int, meetingsInSameGroup: int, meetingsWithOtherGroups: int, GroupStage15: "eSport_League" = None, groupstage69: "eSport_League" = None, GroupStage: "eSport_Tournament" = None, GroupStage58: "eSport_Group" = None, groupstage: set["eSport_Group"] = None, groupstages: "eSport_Tournament" = None):
        self.type = type
    ...
    @property
    def meetingsWithOtherGroups(self):
...
class eSport_Zone:
    ...
    def __init__(self, name: str, Zone13: "eSport_League" = None, eSport_Zone: "eSport_Root" = None, Zone: "eSport_Tournament" = None, Zone24: "eSport_Country" = None, allowedZones: set["eSport_Tournament"] = None, zone: set["eSport_League"] = None, zone30: set["eSport_Country"] = None, zone33: set["eSport_Team"] = None, Zone39: "eSport_Team" = None):
        self.name = name
        self.Zone13 = Zone13
...
class eSport_Tournament:
    ...
    def __init__(self, name: str, size: int, type: str, year: int, eSport_Tournament: "eSport_Root" = None, tournaments: set["eSport_Country"] = None, tournaments5: set["eSport_Zone"] = None, tournament: set["eSport_FinalStage"] = None, tournament8: set["eSport_GroupStage"] = None, tournamentFrom: "eSport_Qualification" = None, tournamentTo: set["eSport_Qualification"] = None, Tournament: "eSport_Country" = None, Tournament27: "eSport_Zone" = None, Tournament67: "eSport_GroupStage" = None, Tournament74: "eSport_FinalStage" = None, Tournament79: "eSport_Qualification" = None, Tournament81: "eSport_Qualification" = None):
        self.name = name
        self.size = size
        self.type = type
        self.year = year
...
class eSport_Person(ABC):
    ...
    def __init__(self, name: str, age: int, description: str, eSport_Person94: "eSport_Root" = None, persons: "eSport_Country" = None, eSport_Person: set["eSport_Capacity"] = None, Person: "eSport_Country" = None):
        self.name = name
        self.age = age
