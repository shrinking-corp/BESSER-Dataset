...
# Classes
school_ClassGroup = Class(name="school_ClassGroup")
school_Student = Class(name="school_Student")
school_Teacher = Class(name="school_Teacher")
school_ClassLevel = Class(name="school_ClassLevel")
school_Room = Class(name="school_Room")
school_SchoolYear = Class(name="school_SchoolYear")
school_NewEClass7 = Class(name="school_NewEClass7")
school_store = Class(name="school_store")
...
school_Room_m_AffectTeacher: Method = Method(name="AffectTeacher", parameters={Parameter(name='school_t', type=StringType)}, type=StringType)
...
domain_model = DomainModel(
    name="school",
    types={school_ClassGroup, school_Student, school_Teacher, school_ClassLevel, school_Room, school_SchoolYear, school_NewEClass7, school_store},
    associations={eleves0, prof1, niveau3, salle5, room7, ecole10, eleves12, niveau15},
    generalizations={},
    metadata=None
)
