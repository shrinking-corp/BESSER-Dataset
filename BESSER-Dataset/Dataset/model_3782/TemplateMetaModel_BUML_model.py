...
# Classes
product_Product = Class(name="product_Product")
product_ProductImplementationElements = Class(name="product_ProductImplementationElements")
product_ProductFeaturesConfiguration = Class(name="product_ProductFeaturesConfiguration")
product_ProductDomainModels = Class(name="product_ProductDomainModels")
product_ProductContainer = Class(name="product_ProductContainer")
product_ProductFragmentContainer = Class(name="product_ProductFragmentContainer")
product_ProductResourcesContainer = Class(name="product_ProductResourcesContainer")
product_ProductComponent = Class(name="product_ProductComponent")
product_ProductFolder = Class(name="product_ProductFolder")
product_ProductFile = Class(name="product_ProductFile")
product_ProductTemplate = Class(name="product_ProductTemplate")
product_ProductEntity = Class(name="product_ProductEntity")
ProductEntity = Class(name="ProductEntity")
product_ProductClass = Class(name="product_ProductClass")
product_ProductAspect = Class(name="product_ProductAspect")
product_ProductFeatureConfiguration = Class(name="product_ProductFeatureConfiguration")
product_ProductDomainModel = Class(name="product_ProductDomainModel")
product_ProductFragment = Class(name="product_ProductFragment")
...
product_ProductFeaturesConfiguration.attributes={product_ProductFeaturesConfiguration_attribute, product_ProductFeaturesConfiguration_name}
...
product_ProductEntity.attributes={product_ProductEntity_name, product_ProductEntity_path}
...
product_ProductFeatureConfiguration.attributes={product_ProductFeatureConfiguration_attribute, product_ProductFeatureConfiguration_min, product_ProductFeatureConfiguration_isSelected, product_ProductFeatureConfiguration_max, product_ProductFeatureConfiguration_name}
...
domain_model = DomainModel(
    name="product",
    types={product_Product, product_ProductImplementationElements, product_ProductFeaturesConfiguration, product_ProductDomainModels, product_ProductContainer, product_ProductFragmentContainer, product_ProductResourcesContainer, product_ProductComponent, product_ProductFolder, product_ProductFile, product_ProductTemplate, product_ProductEntity, ProductEntity, product_ProductClass, product_ProductAspect, product_ProductFeatureConfiguration, product_ProductDomainModel, product_ProductFragment},
    associations={productImplementationElements0, productFeatures1, domainModels3, containers5, fragmentContainers7, resourceContainers9, components11, folders13, files15, templates17, files23, templates26, subComponents30, subFolders33, files35, classes19, aspects21, fragments41, features43, features46, domainModel48, templates38},
    generalizations={gen_product_ProductClass_ProductEntity, gen_product_ProductAspect_ProductEntity, gen_product_ProductFile_ProductEntity, gen_product_ProductFolder_ProductEntity, gen_product_ProductComponent_ProductEntity, gen_product_ProductTemplate_ProductEntity, gen_product_ProductFragment_ProductEntity},
    metadata=None
)
