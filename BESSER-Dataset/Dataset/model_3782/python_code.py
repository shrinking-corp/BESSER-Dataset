...
class product_ProductFeaturesConfiguration:
    ...
    def __init__(self, attribute: str, name: str, product_ProductFeaturesConfiguration: "product_Product" = None, product_ProductFeaturesConfiguration44: set["product_ProductFeatureConfiguration"] = None):
        self.attribute = attribute
        self.name = name
