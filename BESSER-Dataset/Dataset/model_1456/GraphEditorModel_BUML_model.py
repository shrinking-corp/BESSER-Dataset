...
# Classes
grapheditormodel_Edge = Class(name="grapheditormodel_Edge")
grapheditormodel_Graph = Class(name="grapheditormodel_Graph")
grapheditormodel_Node = Class(name="grapheditormodel_Node")
...
domain_model = DomainModel(
    ...
    types={grapheditormodel_Edge, grapheditormodel_Graph, grapheditormodel_Node},
    associations={OutGoingEdges7, IncomingEdges9, GraphNodes0, Start1, End4, Target12, Source15},
    generalizations={},
    metadata=None
)
