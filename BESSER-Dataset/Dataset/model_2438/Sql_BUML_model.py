...
sql_EObject = Class(name="sql_EObject")
...
sql_Column.attributes={sql_Column_type, sql_Column_name, sql_Column_isNotNull}
...
domain_model = DomainModel(
    ...
    associations={database0, tables1, facts3, col5, localColumns6, foreignTable8, foreignColumns11},
    generalizations={},
    metadata=None
)
