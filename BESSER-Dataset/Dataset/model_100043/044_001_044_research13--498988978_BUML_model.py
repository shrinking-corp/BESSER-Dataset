...
# Classes
research13_Phase = Class(name="research13_Phase")
research13_Researcher = Class(name="research13_Researcher")
research13_Write = Class(name="research13_Write")
research13_Review = Class(name="research13_Review")
research13_Paper = Class(name="research13_Paper")
research13_Skill = Class(name="research13_Skill")
research13_PublicationProcess = Class(name="research13_PublicationProcess")
Named = Class(name="Named")
Counted = Class(name="Counted")
research13_ReviewNote = Class(name="research13_ReviewNote")
Labelled = Class(name="Labelled")
research13_Position = Class(name="research13_Position")
research13_Collaboration = Class(name="research13_Collaboration")
research13_Paragraph = Class(name="research13_Paragraph")
research13_Progress = Class(name="research13_Progress")
research13_PaperKeyword = Class(name="research13_PaperKeyword")
research13_KnowledgeManager = Class(name="research13_KnowledgeManager")
research13_PublicationSystem = Class(name="research13_PublicationSystem")
research13_PublicationStructure = Class(name="research13_PublicationStructure")
research13_Keyword = Class(name="research13_Keyword")
research13_Named = Class(name="research13_Named", is_abstract=True)
research13_Counted = Class(name="research13_Counted", is_abstract=True)
research13_Labelled = Class(name="research13_Labelled", is_abstract=True)
...
research13_Researcher.attributes={research13_Researcher_name, research13_Researcher_forName}
...
research13_PublicationProcess.attributes={research13_PublicationProcess_minTime, research13_PublicationProcess_maxTime}
...
domain_model = DomainModel(
    name="research13",
    types={research13_Phase, research13_Researcher, research13_Write, research13_Review, research13_Paper, research13_Skill, research13_PublicationProcess, Named, Counted, research13_ReviewNote, Labelled, research13_Position, research13_Collaboration, research13_Paragraph, research13_Progress, research13_PaperKeyword, research13_KnowledgeManager, research13_PublicationSystem, research13_PublicationStructure, research13_Keyword, research13_Named, research13_Counted, research13_Labelled},
    associations={phases0, writes1, reviews2, res_papers4, skills5, reviews19, process21, res_position7, collaborations9, paragraphs11, progress12, authors13, keywords14, citedBy17, researchers31, papers33, knowledgeMan36, paper23, paragraph25, reviewNote28, parent47, kpapers49, allkeywords51, processView38, structuralView40, positions43, keyword54, col_paper57},
    generalizations={gen_research13_PublicationProcess_Named, gen_research13_Paragraph_Counted, gen_research13_Paragraph_Named, gen_research13_ReviewNote_Named, gen_research13_Progress_Labelled, gen_research13_Paper_Named, gen_research13_PublicationSystem_Named, gen_research13_Write_Labelled, gen_research13_Review_Labelled, gen_research13_PublicationStructure_Named, gen_research13_Keyword_Named, gen_research13_KnowledgeManager_Named, gen_research13_Position_Named},
    metadata=None
)
