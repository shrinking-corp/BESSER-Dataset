...
class research13_PaperKeyword:
    ...
    def __init__(self, weight: int, research13_PaperKeyword55: "research13_Keyword" = None, research13_PaperKeyword: "research13_Paper" = None):
        self.weight = weight
...
class research13_Collaboration:
    ...
    def __init__(self, ratio: int, research13_Collaboration58: "research13_Paper" = None, research13_Collaboration: "research13_Researcher" = None):
        self.ratio = ratio
...
class research13_Progress(Labelled):
    ...
    def __init__(self, percent: int, research13_Progress: "research13_PublicationProcess" = None, Progress: "research13_Paper" = None, progress: "research13_Paper" = None):
...
class research13_Position(Named):
    ...
    def __init__(self, description: str, research13_Position48: "research13_Position" = None, research13_Position46: "research13_Position" = None, research13_Position45: "research13_PublicationSystem" = None, research13_Position: "research13_Researcher" = None):
...
class research13_Paragraph(Named, Counted):
    ...
    def __init__(self, content: str, research13_Paragraph27: "research13_Write" = None, research13_Paragraph20: set["research13_ReviewNote"] = None, research13_Paragraph: "research13_Paper" = None):
...
class research13_ReviewNote(Named):
    ...
    def __init__(self, content: str, research13_ReviewNote30: "research13_Review" = None, research13_ReviewNote: "research13_Paragraph" = None):
        self.content = content
...
class research13_PublicationProcess(Named):
    ...
    def __init__(self, minTime: int, maxTime: int, research13_PublicationProcess39: "research13_PublicationSystem" = None, research13_PublicationProcess: set["research13_Phase"] = None, research13_PublicationProcess22: "research13_Progress" = None):
...
class research13_Review(Labelled):
    ...
    def __init__(self, date: date, research13_Review29: "research13_ReviewNote" = None, research13_Review: "research13_Researcher" = None):
        self.date = date
...
class research13_Write(Labelled):
    ...
    def __init__(self, timeSpent: int, research13_Write26: "research13_Paragraph" = None, research13_Write: "research13_Researcher" = None):
