...
class researchvc_Paragraph(Named, Counted):
...
class researchvc_Researcher:
    ...
    def __init__(self, name: str, forName: str, researchvc_Researcher: set["researchvc_Write"] = None, researchvc_Researcher2: set["researchvc_Review"] = None, authors: set["researchvc_Paper"] = None, Researcher: "researchvc_Paper" = None, researchvc_Researcher22: "researchvc_PublicationStructure" = None, researchvc_Researcher5: set["researchvc_Skill"] = None):
        self.name = name
