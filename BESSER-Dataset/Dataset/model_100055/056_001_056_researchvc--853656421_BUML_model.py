...
domain_model = DomainModel(
    name="researchvc",
    types={researchvc_Researcher, researchvc_Write, researchvc_Review, researchvc_Paper, researchvc_Paragraph, researchvc_PaperKeyword, Counted, researchvc_ReviewNote, Labelled, researchvc_PublicationStructure, researchvc_Skill, researchvc_Keyword, Named, researchvc_Named, researchvc_Counted, researchvc_Labelled},
    associations={writes0, reviews1, res_papers3, paragraphs6, authors7, keywords8, citedBy11, reviews13, paragraph15, reviewNote18, researchers21, papers23, skills4, allKeyWords26, keyword28},
    generalizations={gen_researchvc_Paragraph_Counted, gen_researchvc_Paragraph_Named, gen_researchvc_ReviewNote_Named, gen_researchvc_Write_Labelled, gen_researchvc_Review_Labelled, gen_researchvc_PublicationStructure_Named, gen_researchvc_Paper_Named, gen_researchvc_Keyword_Named},
    metadata=None
)
