...
# Classes
operators_UnaryOperatorCallExp = Class(name="operators_UnaryOperatorCallExp")
operators_PrimitiveExp = Class(name="operators_PrimitiveExp", is_abstract=True)
operators_StringExp = Class(name="operators_StringExp")
PrimitiveExp = Class(name="PrimitiveExp")
operators_BooleanExp = Class(name="operators_BooleanExp")
operators_NumericExp = Class(name="operators_NumericExp", is_abstract=True)
operators_RealExp = Class(name="operators_RealExp")
NumericExp = Class(name="NumericExp")
operators_OclExpression = Class(name="operators_OclExpression", is_abstract=True)
operators_OperatorCallExp = Class(name="operators_OperatorCallExp", is_abstract=True)
OclExpression = Class(name="OclExpression")
operators_BinaryOperatorCallExp = Class(name="operators_BinaryOperatorCallExp")
OperatorCallExp = Class(name="OperatorCallExp")
operators_IntegerExp = Class(name="operators_IntegerExp")
...
domain_model = DomainModel(
    name="operators",
    types={operators_UnaryOperatorCallExp, operators_PrimitiveExp, operators_StringExp, PrimitiveExp, operators_BooleanExp, operators_NumericExp, operators_RealExp, NumericExp, operators_OclExpression, operators_OperatorCallExp, OclExpression, operators_BinaryOperatorCallExp, OperatorCallExp, operators_IntegerExp},
    associations={argument1, source4, source0},
    generalizations={gen_operators_UnaryOperatorCallExp_OperatorCallExp, gen_operators_PrimitiveExp_OclExpression, gen_operators_StringExp_PrimitiveExp, gen_operators_BooleanExp_PrimitiveExp, gen_operators_NumericExp_PrimitiveExp, gen_operators_RealExp_NumericExp, gen_operators_OperatorCallExp_OclExpression, gen_operators_BinaryOperatorCallExp_OperatorCallExp, gen_operators_IntegerExp_NumericExp},
    metadata=None
)
