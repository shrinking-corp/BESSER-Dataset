...
# Classes
atlext_ATL_LocatedElement = Class(name="atlext_ATL_LocatedElement")
atlext_ATL_OutPatternElement = Class(name="atlext_ATL_OutPatternElement")
atlext_ATL_Callable = Class(name="atlext_ATL_Callable")
...
atlext_ATL_Helper = Class(name="atlext_ATL_Helper")
...
atlext_OCL_PropertyCallExp = Class(name="atlext_OCL_PropertyCallExp")
...
atlext_OCL_OclExpression = Class(name="atlext_OCL_OclExpression")
...
atlext_ATL_LocatedElement.attributes={atlext_ATL_LocatedElement_fileLocation, atlext_ATL_LocatedElement_fileObject}
...
polymorphicCalledBy11: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="PropertyCallExp12", type=atlext_ATL_ContextHelper, multiplicity=Multiplicity(1, 1)),
...
domain_model = DomainModel(
    name="atlext",
    types={atlext_ATL_LocatedElement, atlext_ATL_OutPatternElement, atlext_ATL_Callable, PropertyCallExp, CallableParameter, atlext_ATL_CallableParameter, ATL_atlext_Type, VariableDeclaration, atlext_ATL_ContextHelper, atlext_ATL_Helper, atlext_ATL_Binding, RuleResolutionInfo, atlext_ATL_RuleResolutionInfo, MatchedRule, ATL_atlext_EObject, StringToStringMap, atlext_ATL_StringToStringMap, atlext_ATL_MatchedRule, atlext_OCL_PropertyCallExp, OCL_atlext_EObject, Callable, ContextHelper, atlext_OCL_OperationCallExp, ResolveTempResolution, atlext_OCL_ResolveTempResolution, OutPatternElement, atlext_OCL_JavaBody, OclExpression, atlext_OCL_GetAppliedStereotypesBody, JavaBody, atlext_OCL_TypedElement, OCL_atlext_Type, atlext_OCL_VariableDeclaration, TypedElement, atlext_OCL_OclExpression},
    associations={calledBy3, callableParameters4, staticType6, paramDeclaration7, contextType9, polymorphicCalledBy11, inferredReturnType13, staticReturnType15, writtenFeature18, leftType20, resolvedBy23, rule25, problems0, annotations1, noCastedType32, usedFeature34, receptorType35, staticResolver38, dynamicResolvers40, resolveTempResolvedBy41, element42, allInvolvedRules26, inferredType29, staticType30},
    generalizations={gen_atlext_OCL_ResolveTempResolution_RuleResolutionInfo, gen_atlext_OCL_JavaBody_OclExpression, gen_atlext_OCL_GetAppliedStereotypesBody_JavaBody, gen_atlext_OCL_VariableDeclaration_TypedElement, gen_atlext_OCL_OclExpression_TypedElement},
    metadata=None
)
