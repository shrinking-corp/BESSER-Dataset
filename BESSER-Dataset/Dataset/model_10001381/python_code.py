...
class Post:
    ...
    def __init__(self, privateMode: bool, nLikes: int, nComments: int, nShares: int, owner: User, user5: "User" = None, group6: "Team" = None, hashTags8: "HashTags" = None, page10: "Page" = None):
