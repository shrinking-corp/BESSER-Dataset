...
class statemachine_State(ABC):
    ...
    def __init__(self, name: str, statemachine_State: "statemachine_StateMachine" = None, statemachine_State7: "statemachine_Transition" = None, statemachine_State10: "statemachine_Transition" = None, statemachine_State12: set["statemachine_Resource"] = None, statemachine_State15: "statemachine_Composite" = None):
        self.name = name
...
class statemachine_Transition:
    ...
    def __init__(self, Id: int, duration: int, statemachine_Transition: "statemachine_StateMachine" = None, statemachine_Transition6: "statemachine_State" = None, statemachine_Transition9: "statemachine_State" = None):
        self.Id = Id
