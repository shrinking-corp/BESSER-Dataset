...
statemachine_Resource = Class(name="statemachine_Resource")
statemachine_StateMachine = Class(name="statemachine_StateMachine")
statemachine_Initial = Class(name="statemachine_Initial")
State = Class(name="State")
statemachine_Simple = Class(name="statemachine_Simple")
statemachine_Composite = Class(name="statemachine_Composite")
...
domain_model = DomainModel(
    name="statemachine",
    types={statemachine_Transition, statemachine_State, statemachine_Resource, statemachine_StateMachine, statemachine_Initial, State, statemachine_Simple, statemachine_Composite},
    associations={transitions0, states1, es_parte_de3, source5, target8, tiene11, es_parte_de14},
    generalizations={gen_statemachine_Initial_State, gen_statemachine_Simple_State, gen_statemachine_Composite_State},
    metadata=None
)
