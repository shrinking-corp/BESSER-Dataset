...
class uma_WorkOrder:
    ...
    def __init__(self, properties: str, value: str, id: str, linkType: str, uma_WorkOrder: "uma_WorkBreakdownElement" = None):
...
class uma_ProcessComponent(ProcessPackage):
    ...
    def __init__(self, authors: str, changeDate: str, copyright: str, changeDescription: str, version: str, uma_ProcessComponent: "uma_ProcessComponentInterface" = None, uma_ProcessComponent41: "uma_Process" = None):
...
class uma_WorkBreakdownElement(BreakdownElement):
    ...
    def __init__(self, isEventDriven: str, isOngoing: str, group2: str, isRepeatable: str, uma_WorkBreakdownElement: set["uma_WorkOrder"] = None):
...
class uma_DisciplineGrouping(ContentCategory):
    ...
    def __init__(self, discipline: str, group2: str):
...
class uma_TaskDescriptor(WorkBreakdownElement):
    ...
    def __init__(self, mandatoryInput: str, optionalInput: str, output: str, isSynchronizedWithSource: str, task: str, group3: str, performedPrimarilyBy: str, additionallyPerformedBy: str, assistedBy: str, externalInput: str, uma_TaskDescriptor: "uma_ProcessComponentInterface" = None, uma_TaskDescriptor51: set["uma_Section"] = None):
...
class uma_Activity(WorkBreakdownElement):
    ...
    def __init__(self, isEnactable: str, variabilityBasedOnElement: str, variabilityType: str, roadmap: str, precondition: str, postcondition: str, group3: str, uma_Activity: set["uma_BreakdownElement"] = None):
...
class uma_MethodPlugin(MethodUnit):
    ...
    def __init__(self, referencedMethodPlugin: str, supporting: str, userChangeable: str, uma_MethodPlugin: "uma_DocumentRoot" = None, uma_MethodPlugin35: set["uma_MethodPackage"] = None, uma_MethodPlugin28: "uma_MethodLibrary" = None):
...
class uma_DescribableElement(MethodElement):
    ...
    def __init__(self, isAbstract: str, nodeicon: str, shapeicon: str, fulfill: str, uma_DescribableElement: "uma_ContentDescription" = None):
...
class uma_MethodPackage(MethodElement):
    ...
    def __init__(self, global_: str, group1: str, reusedPackage: str, uma_MethodPackage36: "uma_MethodPlugin" = None, uma_MethodPackage: "uma_MethodPackage" = None, uma_MethodPackage32: set["uma_MethodPackage"] = None):
...
class uma_MethodElement(PackageableElement):
    ...
    def __init__(self, id: str, orderingGuide: str, presentationName: str, suppressed: str, group: str, briefDescription: str, uma_MethodElement: set["uma_Constraint"] = None, uma_MethodElement25: set["uma_MethodElementProperty"] = None):
        self.id = id
...
class uma_Task(ContentElement):
    ...
    def __init__(self, optionalInput: str, estimate: str, estimationConsiderations: str, toolMentor: str, precondition: str, postcondition: str, performedBy: str, group2: str, mandatoryInput: str, output: str, additionallyPerformedBy: str):
        self.optionalInput = optionalInput
        self.estimate = estimate
        self.estimationConsiderations = estimationConsiderations
        self.toolMentor = toolMentor
...
class uma_WorkProductDescriptor(Descriptor):
    ...
    def __init__(self, activityExitState: str, workProduct: str, responsibleRole: str, group2: str, externalInputTo: str, impactedBy: str, impacts: str, mandatoryInputTo: str, optionalInputTo: str, outputFrom: str, deliverableParts: str, activityEntryState: str, uma_WorkProductDescriptor: "uma_ProcessComponentInterface" = None):
