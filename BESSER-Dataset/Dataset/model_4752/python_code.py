...
class edd_TreeElement:
    ...
    def __init__(self, index: str, name: str, edd_TreeElement: "edd_TreeElement" = None, edd_TreeElement3: set["edd_TreeElement"] = None, edd_TreeElement7: "edd_Block" = None):
        self.index = index
        self.name = name
...
class edd_Block:
    ...
    def __init__(self, name: str, edd_Block: "edd_Model" = None, edd_Block6: set["edd_TreeElement"] = None):
        self.name = name
