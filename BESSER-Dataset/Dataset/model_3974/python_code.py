...
class l2_Utility:
    ...
    def is_utility(self, l2_diagnostics, l2_context) :
...
class l2_Send:
    ...
    def client_operation_sends_supplier_signal(self, l2_diagnostics, l2_context) :
...
class l2_Realization:
    ...
    def cannot_be_implementationClass(self, l2_context, l2_diagnostics) :
...
class l2_ImplementationClass:
    ...
    def cannot_be_realization(self, l2_context, l2_diagnostics) :
...
class l2_Implement:
    ...
    def implements_specification(self, l2_diagnostics, l2_context) :
