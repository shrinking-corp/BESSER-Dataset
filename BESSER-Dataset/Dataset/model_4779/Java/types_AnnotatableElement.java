...
public class types_AnnotatableElement  {
    ...
    private types_AnnotatableElement types_annotatableelement;
    ...
    public types_AnnotatableElement getTypes_annotatableelement() {
        return types_annotatableelement;
    }

    public void setTypes_annotatableelement(types_AnnotatableElement types_annotatableelement) {
        this.types_annotatableelement = types_annotatableelement;
    }
