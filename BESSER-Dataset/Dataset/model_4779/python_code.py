...
class types_AnnotatableElement:
    ...
    def getAnnotationOfType(self, types_typeName) :
...
class types_Declaration(NamedElement, AnnotatableElement, MetaComposite):
...
class types_Type(Declaration):
    ...
    def __init__(self, abstract: bool, visible: bool, types_Type9: "types_TypedElement" = None, types_Type: set["types_TypeSpecifier"] = None, types_Type15: "types_TypeSpecifier" = None, types_Type24: "types_TypeParameter" = None):
...
class types_TypedDeclaration(TypedElement, Declaration):

    pass
class types_Package(DomainElement, Declaration):
