...
types_Declaration = Class(name="types_Declaration", is_abstract=True)
types_Type = Class(name="types_Type")
types_Package = Class(name="types_Package")
types_Parameter = Class(name="types_Parameter")
types_Property = Class(name="types_Property")
types_Expression = Class(name="types_Expression", is_abstract=True)
TypedElement = Class(name="TypedElement")
types_TypedElement = Class(name="types_TypedElement", is_abstract=True)
types_TypeSpecifier = Class(name="types_TypeSpecifier")
...
types_Enumerator = Class(name="types_Enumerator")
types_PrimitiveType = Class(name="types_PrimitiveType")
Type = Class(name="Type")
types_ComplexType = Class(name="types_ComplexType")
types_Event = Class(name="types_Event")
types_EnumerationType = Class(name="types_EnumerationType")
ComplexType = Class(name="ComplexType")
types_Domain = Class(name="types_Domain")
types_TypeAlias = Class(name="types_TypeAlias")
types_Annotation = Class(name="types_Annotation")
types_AnnotationType = Class(name="types_AnnotationType")
types_TypeParameter = Class(name="types_TypeParameter")
types_GenericElement = Class(name="types_GenericElement")
types_ArrayTypeSpecifier = Class(name="types_ArrayTypeSpecifier")
TypeSpecifier = Class(name="TypeSpecifier")
types_EObject = Class(name="types_EObject")
types_TypedDeclaration = Class(name="types_TypedDeclaration")
types_MetaComposite = Class(name="types_MetaComposite")
types_AnnotatableElement = Class(name="types_AnnotatableElement")
...
types_Declaration.attributes={types_Declaration_static, types_Declaration_id}
...
types_Parameter.attributes={types_Parameter_optional, types_Parameter_varArgs}
...
types_AnnotatableElement_m_getAnnotationOfType: Method = Method(name="getAnnotationOfType", parameters={Parameter(name='types_typeName', type=StringType)}, type=StringType)
...
import_2: BinaryAssociation = BinaryAssociation(
    name="import_2",
    ends={
...
domain_model = DomainModel(
    name="types",
    types={Declaration, DomainElement, types_Declaration, types_Type, types_Package, types_Parameter, types_Property, types_Expression, TypedElement, types_TypedElement, types_TypeSpecifier, NamedElement, AnnotatableElement, MetaComposite, types_Operation, TypedDeclaration, GenericElement, types_Enumerator, types_PrimitiveType, Type, types_ComplexType, types_Event, types_EnumerationType, ComplexType, types_Domain, types_TypeAlias, types_Annotation, types_AnnotationType, types_TypeParameter, types_GenericElement, types_ArrayTypeSpecifier, TypeSpecifier, types_EObject, types_TypedDeclaration, types_MetaComposite, types_AnnotatableElement, Direction},
    associations={member0, import_2, parameters5, initialValue6, owningOperation7, type8, typeSpecifier10, superTypes4, enumerator19, features20, owningEnumeration22, type13, typeArguments17, typeParameters25, type27, arguments28, bound23, properties36, targets39, annotations31, annotationInfo34, metaFeatures41},
    generalizations={gen_types_Package_Declaration, gen_types_Package_DomainElement, gen_types_Type_Declaration, gen_types_Property_TypedDeclaration, gen_types_Parameter_TypedElement, gen_types_Parameter_NamedElement, gen_types_Parameter_AnnotatableElement, gen_types_Declaration_NamedElement, gen_types_Declaration_AnnotatableElement, gen_types_Declaration_MetaComposite, gen_types_Operation_TypedDeclaration, gen_types_Operation_GenericElement, gen_types_PrimitiveType_Type, gen_types_ComplexType_Type, gen_types_ComplexType_GenericElement, gen_types_Enumerator_TypedDeclaration, gen_types_Event_TypedDeclaration, gen_types_EnumerationType_ComplexType, gen_types_TypeAlias_TypedDeclaration, gen_types_TypeAlias_Type, gen_types_TypeParameter_Type, gen_types_GenericElement_NamedElement, gen_types_ArrayTypeSpecifier_TypeSpecifier, gen_types_AnnotationType_Type, gen_types_TypedDeclaration_Declaration, gen_types_TypedDeclaration_TypedElement},
    metadata=None
)
