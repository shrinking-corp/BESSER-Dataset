...
# Classes
psample_Package = Class(name="psample_Package")
Type = Class(name="Type")
psample_Interface = Class(name="psample_Interface")
psample_Function = Class(name="psample_Function")
Member = Class(name="Member")
psample_Variable = Class(name="psample_Variable")
psample_Type = Class(name="psample_Type", is_abstract=True)
Object = Class(name="Object")
psample_TypedElement = Class(name="psample_TypedElement", is_abstract=True)
psample_Object = Class(name="psample_Object", is_abstract=True)
psample_Class = Class(name="psample_Class")
TypedElement = Class(name="TypedElement")
psample_Member = Class(name="psample_Member", is_abstract=True)
psample_PrimitiveTypeVariable = Class(name="psample_PrimitiveTypeVariable")
...
domain_model = DomainModel(
    name="psample",
    types={psample_Package, Type, psample_Interface, psample_Function, Member, psample_Variable, psample_Type, Object, psample_TypedElement, psample_Object, psample_Class, TypedElement, psample_Member, psample_PrimitiveTypeVariable, Visibility, PrimitiveTypes},
    associations={typedelement0, member1, primitivetype2},
    generalizations={gen_psample_Member_Type, gen_psample_PrimitiveTypeVariable_Type, gen_psample_Interface_TypedElement, gen_psample_Function_Member, gen_psample_Variable_Member, gen_psample_Type_Object, gen_psample_TypedElement_Object, gen_psample_Class_TypedElement},
    metadata=None
)
