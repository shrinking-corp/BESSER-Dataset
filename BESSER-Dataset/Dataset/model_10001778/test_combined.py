...
def test_hyp_call_students_for_attendance_external_is_not_abstract():
    assert not inspect.isabstract(call_students_for_attendance_external)


def test_hyp_call_students_for_attendance_external_constructor_exists():
    assert callable(call_students_for_attendance_external.__init__)


def test_hyp_call_students_for_attendance_external_constructor_args():
...
def test_hyp_admin_technician_actor_is_not_abstract():
    assert not inspect.isabstract(admin_technician_Actor)


def test_hyp_admin_technician_actor_constructor_exists():
    assert callable(admin_technician_Actor.__init__)


def test_hyp_admin_technician_actor_constructor_args():
...
def test_hyp_student_attendance_at_inu_component_is_not_abstract():
    assert not inspect.isabstract(Student_Attendance_at_INU_Component)


def test_hyp_student_attendance_at_inu_component_constructor_exists():
    assert callable(Student_Attendance_at_INU_Component.__init__)


def test_hyp_student_attendance_at_inu_component_constructor_args():
    sig = inspect.signature(Student_Attendance_at_INU_Component.__init__)
    params = list(sig.parameters.keys())



def test_hyp_teachers_actor_is_not_abstract():
    assert not inspect.isabstract(Teachers_Actor)


def test_hyp_teachers_actor_constructor_exists():
    assert callable(Teachers_Actor.__init__)


def test_hyp_teachers_actor_constructor_args():
