...
class ocl_exp_EIteratorExp(ELoopExp):
    ...
    def __init__(self, kind: str, ELoopExp22: "ocl_exp_EOclExpression" = None, ELoopExp: "ocl_exp_EVariable" = None):
        self.kind = kind
...
class ocl_exp_EVariable:
    ...
    def __init__(self, name: str, iterator: "ELoopExp" = None, initializedElement: "EOclExpression" = None):
        self.name = name
    ...
    def initializedElement(self, value):
        ...
        if old_value is not None:
            if hasattr(old_value, "EOclExpression18"):
                opp_val = getattr(old_value, "EOclExpression18", None)
                if opp_val == self:
                    setattr(old_value, "EOclExpression18", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "EOclExpression18"):
                opp_val = getattr(value, "EOclExpression18", None)
                setattr(value, "EOclExpression18", self)
    ...
    def parentCall(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "EOclExpression33"):
                    opp_val = getattr(item, "EOclExpression33", None)
                    
                    if opp_val == self:
                        setattr(item, "EOclExpression33", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "EOclExpression33"):
                    ...
                    setattr(item, "EOclExpression33", self)
...
class ocl_dm_EAssociationEnd:
    ...
    def __init__(self, name: str, mult: str, ocl_dm_EAssociationEnd5: "EAssociationEnd" = None, ocl_dm_EAssociationEnd: "EEntity" = None):
        self.name = name
        self.mult = mult
...
class ocl_type_EMessageType(EClassifier):
    ...
    def __init__(self, referredOperation: str, ocl_type_EMessageType: "ESignal" = None, EClassifier36: "ocl_type_ECollectionType" = None, EClassifier: "ocl_exp_ETypeExp" = None):
        self.referredOperation = referredOperation
...
class ocl_dm_EEntity(EClassifier):
    ...
    def __init__(self, name: str, ocl_dm_EEntity: set["EAssociationEnd"] = None, ocl_dm_EEntity2: set["EAttribute"] = None, EClassifier36: "ocl_type_ECollectionType" = None, EClassifier: "ocl_exp_ETypeExp" = None):
        self.name = name
