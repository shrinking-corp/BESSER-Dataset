...
# Classes
trace_Failure = Class(name="trace_Failure")
trace_FunctionCall = Class(name="trace_FunctionCall")
trace_ArrayValue = Class(name="trace_ArrayValue")
Value = Class(name="Value")
trace_Value = Class(name="trace_Value")
trace_Assignment = Class(name="trace_Assignment")
Step = Class(name="Step")
trace_LocationOnly = Class(name="trace_LocationOnly")
trace_NameToValueMap = Class(name="trace_NameToValueMap")
trace_SimpleValue = Class(name="trace_SimpleValue")
trace_FunctionReturn = Class(name="trace_FunctionReturn")
trace_Location = Class(name="trace_Location")
trace_Trace = Class(name="trace_Trace")
trace_UnionValue = Class(name="trace_UnionValue")
StructValue = Class(name="StructValue")
trace_Step = Class(name="trace_Step")
trace_StructValue = Class(name="trace_StructValue")
trace_Output = Class(name="trace_Output")
...
trace_FunctionCall.attributes={trace_FunctionCall_id, trace_FunctionCall_displayName}
...
trace_Value_m_getValue: Method = Method(name="getValue", parameters={Parameter(name='trace_expression', type=StringType)}, type=Value)
trace_Value_m_getChildrenCount: Method = Method(name="getChildrenCount", parameters={}, type=StringType)
trace_Value_m_getUserFriendlyRepresentation: Method = Method(name="getUserFriendlyRepresentation", parameters={Parameter(name='trace_abridged', type=StringType)}, type=StringType)
trace_Value_m_compare: Method = Method(name="compare", parameters={Parameter(name='trace_parentPath', type=StringType), Parameter(name='trace_old', type=StringType)})
trace_Value_m_listChildren: Method = Method(name="listChildren", parameters={Parameter(name='trace_requestedExpression', type=StringType)})
trace_Value.attributes={trace_Value_type}
trace_Value.methods={trace_Value_m_listChildren, trace_Value_m_getValue, trace_Value_m_getUserFriendlyRepresentation, trace_Value_m_getChildrenCount, trace_Value_m_compare}
...
trace_Assignment_m_getValue: Method = Method(name="getValue", parameters={Parameter(name='trace_expression', type=StringType)}, type=Value)
trace_Assignment_m_getType: Method = Method(name="getType", parameters={}, type=StringType)
trace_Assignment.attributes={trace_Assignment_baseName, trace_Assignment_displayName, trace_Assignment_assignmentType, trace_Assignment_id}
...
trace_Step_m_interpret: Method = Method(name="interpret", parameters={Parameter(name='trace_context', type=StringType)}, type=StringType)
trace_Step.attributes={trace_Step_number, trace_Step_thread, trace_Step_hidden}
...
domain_model = DomainModel(
    name="trace",
    types={trace_Failure, trace_FunctionCall, trace_ArrayValue, Value, trace_Value, trace_Assignment, Step, trace_LocationOnly, trace_NameToValueMap, trace_SimpleValue, trace_FunctionReturn, trace_Location, trace_Trace, trace_UnionValue, StructValue, trace_Step, trace_StructValue, trace_Output},
    associations={value1, values0, value3, values6, steps8, location5},
    generalizations={gen_trace_Failure_Step, gen_trace_FunctionCall_Step, gen_trace_ArrayValue_Value, gen_trace_Assignment_Step, gen_trace_LocationOnly_Step, gen_trace_SimpleValue_Value, gen_trace_FunctionReturn_Step, gen_trace_UnionValue_StructValue, gen_trace_StructValue_Value, gen_trace_Output_Step},
    metadata=None
)
