...
# Classes
ER_Feature = Class(name="ER_Feature", is_abstract=True)
ER_Attribute = Class(name="ER_Attribute")
Feature = Class(name="Feature")
ER_WeakReference = Class(name="ER_WeakReference")
Reference = Class(name="Reference")
ER_StrongReference = Class(name="ER_StrongReference")
ER_NamedElement = Class(name="ER_NamedElement", is_abstract=True)
ER_Reference = Class(name="ER_Reference", is_abstract=True)
ER_ERModel = Class(name="ER_ERModel")
NamedElement = Class(name="NamedElement")
ER_EntityType = Class(name="ER_EntityType")
...
domain_model = DomainModel(
    name="ER",
    types={ER_Feature, ER_Attribute, Feature, ER_WeakReference, Reference, ER_StrongReference, ER_NamedElement, ER_Reference, ER_ERModel, NamedElement, ER_EntityType},
    associations={features1, type3, entities0},
    generalizations={gen_ER_EntityType_NamedElement, gen_ER_Feature_NamedElement, gen_ER_Attribute_Feature, gen_ER_WeakReference_Reference, gen_ER_StrongReference_Reference, gen_ER_Reference_Feature, gen_ER_ERModel_NamedElement},
    metadata=None
)
