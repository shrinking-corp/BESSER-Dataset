...
class ddsm_ZookeeperCluster(PeerToPeerPlatform):
    ...
    def __init__(self, initLimit: int, tickTime: int, syncLimit: int):
...
class ddsm_DDSM:
    ...
    def __init__(self, description: str, modelId: str, ddsm_DDSM46: set["ddsm_Property"] = None, ddsm_DDSM49: set["ddsm_Resource"] = None, ddsm_DDSM52: set["ddsm_Artifact"] = None, ddsm_DDSM: set["ddsm_CloudElement"] = None):
...
class ddsm_Artifact:
    ...
    def __init__(self, artifactPath: str, arguments: str, resources: str, language: str, ddsm_Artifact10: "ddsm_Resource" = None, ddsm_Artifact13: "ddsm_Resource" = None, ddsm_Artifact16: "ddsm_Resource" = None, ddsm_Artifact19: "ddsm_Resource" = None, ddsm_Artifact: "ddsm_Resource" = None, ddsm_Artifact7: "ddsm_Resource" = None, ddsm_Artifact53: "ddsm_DDSM" = None):
...
class ddsm_RequiredExecutionPlatform(ExecutionPlatform):
    ...
    def __init__(self, isMandatory: bool, ddsm_RequiredExecutionPlatform: "ddsm_InternalComponent" = None, ddsm_RequiredExecutionPlatform38: "ddsm_ExecutionBinding" = None, ddsm_RequiredExecutionPlatform60: "ddsm_PeerToPeerPlatform" = None, ddsm_RequiredExecutionPlatform62: "ddsm_MasterSlavePlatform" = None, ddsm_RequiredExecutionPlatform65: "ddsm_MasterSlavePlatform" = None):
...
class ddsm_Resource:
    ...
    def __init__(self, resourceId: str, ddsm_Resource9: "ddsm_Artifact" = None, ddsm_Resource12: "ddsm_Artifact" = None, ddsm_Resource15: "ddsm_Artifact" = None, ddsm_Resource18: "ddsm_Artifact" = None, ddsm_Resource: "ddsm_CloudElement" = None, ddsm_Resource4: "ddsm_Artifact" = None, ddsm_Resource6: "ddsm_Artifact" = None, ddsm_Resource50: "ddsm_DDSM" = None):
