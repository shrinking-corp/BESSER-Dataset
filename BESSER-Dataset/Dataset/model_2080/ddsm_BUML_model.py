...
# Classes
ddsm_CloudElement = Class(name="ddsm_CloudElement", is_abstract=True)
ddsm_Resource = Class(name="ddsm_Resource")
ddsm_Component = Class(name="ddsm_Component", is_abstract=True)
CloudElement = Class(name="CloudElement")
ddsm_ProvidedPort = Class(name="ddsm_ProvidedPort")
ddsm_ProvidedExecutionPlatform = Class(name="ddsm_ProvidedExecutionPlatform")
ddsm_InternalComponent = Class(name="ddsm_InternalComponent")
Component = Class(name="Component")
ddsm_RequiredPort = Class(name="ddsm_RequiredPort")
ddsm_RequiredExecutionPlatform = Class(name="ddsm_RequiredExecutionPlatform")
ddsm_ExecutionPlatform = Class(name="ddsm_ExecutionPlatform", is_abstract=True)
ddsm_Port = Class(name="ddsm_Port", is_abstract=True)
ddsm_Property = Class(name="ddsm_Property")
ddsm_Artifact = Class(name="ddsm_Artifact")
ddsm_ExecutionBinding = Class(name="ddsm_ExecutionBinding")
ddsm_ExternalComponent = Class(name="ddsm_ExternalComponent")
ddsm_Provider = Class(name="ddsm_Provider")
ddsm_VM = Class(name="ddsm_VM")
ExternalComponent = Class(name="ExternalComponent")
Port = Class(name="Port")
ExecutionPlatform = Class(name="ExecutionPlatform")
ddsm_Relationship = Class(name="ddsm_Relationship")
ddsm_ClientNode = Class(name="ddsm_ClientNode")
InternalComponent = Class(name="InternalComponent")
ddsm_JobSubmission = Class(name="ddsm_JobSubmission")
ddsm_Crontab = Class(name="ddsm_Crontab")
ddsm_StormCluster = Class(name="ddsm_StormCluster")
MasterSlavePlatform = Class(name="MasterSlavePlatform")
ddsm_DDSM = Class(name="ddsm_DDSM")
ddsm_CassandraCluster = Class(name="ddsm_CassandraCluster")
ddsm_PeerNode = Class(name="ddsm_PeerNode")
ddsm_PeersQuorum = Class(name="ddsm_PeersQuorum")
ddsm_PeerToPeerPlatform = Class(name="ddsm_PeerToPeerPlatform")
ddsm_MasterSlavePlatform = Class(name="ddsm_MasterSlavePlatform")
ddsm_SparkCluster = Class(name="ddsm_SparkCluster")
ddsm_MasterNode = Class(name="ddsm_MasterNode")
ddsm_SlaveNode = Class(name="ddsm_SlaveNode")
ddsm_ZookeeperCluster = Class(name="ddsm_ZookeeperCluster")
PeerToPeerPlatform = Class(name="PeerToPeerPlatform")
ddsm_HDFSCluster = Class(name="ddsm_HDFSCluster")
ddsm_KafkaCluster = Class(name="ddsm_KafkaCluster")
ddsm_YarnCluster = Class(name="ddsm_YarnCluster")
...
ddsm_Artifact.attributes={ddsm_Artifact_language, ddsm_Artifact_arguments, ddsm_Artifact_artifactPath, ddsm_Artifact_resources}
...
ddsm_ExternalComponent.attributes={ddsm_ExternalComponent_login, ddsm_ExternalComponent_location, ddsm_ExternalComponent_endPoint, ddsm_ExternalComponent_region, ddsm_ExternalComponent_password, ddsm_ExternalComponent_serviceType}
...
ddsm_VM.attributes={ddsm_VM_imageId, ddsm_VM_instances, ddsm_VM_maxStorage, ddsm_VM_os, ddsm_VM_securityGroup, ddsm_VM_minCores, ddsm_VM_genericSize, ddsm_VM_sshKey, ddsm_VM_maxCores, ddsm_VM_is64os, ddsm_VM_providerSpecificTypeName, ddsm_VM_minRam, ddsm_VM_maxRam, ddsm_VM_publicAddress, ddsm_VM_minStorage, ddsm_VM_privateKey, ddsm_VM_publicPorts}
...
ddsm_JobSubmission.attributes={ddsm_JobSubmission_applicationArguments, ddsm_JobSubmission_mainClass, ddsm_JobSubmission_artifactUrl}
...
ddsm_Crontab.attributes={ddsm_Crontab_month, ddsm_Crontab_hour, ddsm_Crontab_dayOfWeek, ddsm_Crontab_dayOfMonth, ddsm_Crontab_min}
...
ddsm_StormCluster.attributes={ddsm_StormCluster_cpuCapacity, ddsm_StormCluster_workerStartTimeout, ddsm_StormCluster_memoryCapacity, ddsm_StormCluster_taskTimeout, ddsm_StormCluster_queueSize, ddsm_StormCluster_retryInterval, ddsm_StormCluster_heartbeatFrequency, ddsm_StormCluster_supervisorFrequency, ddsm_StormCluster_monitorFrequency, ddsm_StormCluster_retryTimes}
...
ddsm_SparkCluster.attributes={ddsm_SparkCluster_driverCores, ddsm_SparkCluster_maxResultSize, ddsm_SparkCluster_UIPort, ddsm_SparkCluster_sparkExecutorMemory, ddsm_SparkCluster_driverMemory}
...
ddsm_ZookeeperCluster.attributes={ddsm_ZookeeperCluster_syncLimit, ddsm_ZookeeperCluster_initLimit, ddsm_ZookeeperCluster_tickTime}
...
domain_model = DomainModel(
    name="ddsm",
    types={ddsm_CloudElement, ddsm_Resource, ddsm_Component, CloudElement, ddsm_ProvidedPort, ddsm_ProvidedExecutionPlatform, ddsm_InternalComponent, Component, ddsm_RequiredPort, ddsm_RequiredExecutionPlatform, ddsm_ExecutionPlatform, ddsm_Port, ddsm_Property, ddsm_Artifact, ddsm_ExecutionBinding, ddsm_ExternalComponent, ddsm_Provider, ddsm_VM, ExternalComponent, Port, ExecutionPlatform, ddsm_Relationship, ddsm_ClientNode, InternalComponent, ddsm_JobSubmission, ddsm_Crontab, ddsm_StormCluster, MasterSlavePlatform, ddsm_DDSM, ddsm_CassandraCluster, ddsm_PeerNode, ddsm_PeersQuorum, ddsm_PeerToPeerPlatform, ddsm_MasterSlavePlatform, ddsm_SparkCluster, ddsm_MasterNode, ddsm_SlaveNode, ddsm_ZookeeperCluster, PeerToPeerPlatform, ddsm_HDFSCluster, ddsm_KafkaCluster, ddsm_YarnCluster, VMSize, ProviderType, Language},
    associations={start8, stop11, destroy14, install17, providedport20, providedexecutionplatform21, requiredport23, requiredexecutionplatform24, resource0, property1, download3, configure5, providedport32, requiredport34, requiredexecutionplatform37, providedexecutionplatform39, provider42, owner26, owner29, properties45, resources48, artifacts51, submits54, hasSchedule55, cloudelement43, belongsToQuorum58, requiresPeerVm59, requiresMasterVm61, requiresSlaveVm63, hasMaster57},
    generalizations={gen_ddsm_Component_CloudElement, gen_ddsm_InternalComponent_Component, gen_ddsm_ExecutionPlatform_CloudElement, gen_ddsm_Port_CloudElement, gen_ddsm_ExecutionBinding_CloudElement, gen_ddsm_ExternalComponent_Component, gen_ddsm_Provider_CloudElement, gen_ddsm_VM_ExternalComponent, gen_ddsm_RequiredPort_Port, gen_ddsm_ProvidedPort_Port, gen_ddsm_RequiredExecutionPlatform_ExecutionPlatform, gen_ddsm_ProvidedExecutionPlatform_ExecutionPlatform, gen_ddsm_Relationship_CloudElement, gen_ddsm_ClientNode_InternalComponent, gen_ddsm_StormCluster_MasterSlavePlatform, gen_ddsm_CassandraCluster_PeerToPeerPlatform, gen_ddsm_PeerNode_InternalComponent, gen_ddsm_PeersQuorum_InternalComponent, gen_ddsm_PeerToPeerPlatform_InternalComponent, gen_ddsm_MasterSlavePlatform_InternalComponent, gen_ddsm_SparkCluster_MasterSlavePlatform, gen_ddsm_JobSubmission_CloudElement, gen_ddsm_MasterNode_InternalComponent, gen_ddsm_SlaveNode_InternalComponent, gen_ddsm_ZookeeperCluster_PeerToPeerPlatform, gen_ddsm_HDFSCluster_MasterSlavePlatform, gen_ddsm_KafkaCluster_PeerToPeerPlatform, gen_ddsm_YarnCluster_MasterSlavePlatform},
    metadata=None
)
