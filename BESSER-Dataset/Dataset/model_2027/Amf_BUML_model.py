...
# Classes
amf_Network = Class(name="amf_Network")
amf_Channel = Class(name="amf_Channel")
amf_Statemachine = Class(name="amf_Statemachine")
amf_State = Class(name="amf_State")
amf_Transition = Class(name="amf_Transition")
...
domain_model = DomainModel(
    name="amf",
    types={amf_Network, amf_Channel, amf_Statemachine, amf_State, amf_Transition, Event, TypeOfChannel},
    associations={channel13, target16, channel0, statemachine1, initialstate3, state5, transition8, source10},
    generalizations={},
    metadata=None
)
