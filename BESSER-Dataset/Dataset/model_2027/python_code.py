...
class amf_Transition:
    ...
    def __init__(self, event: str, amf_Transition14: "amf_Channel" = None, amf_Transition17: "amf_State" = None, amf_Transition: "amf_Statemachine" = None, amf_Transition11: "amf_State" = None):
        self.event = event
...
class amf_State:
    ...
    def __init__(self, name: str, amf_State18: "amf_Transition" = None, amf_State: "amf_Statemachine" = None, amf_State7: "amf_Statemachine" = None, amf_State12: "amf_Transition" = None):
        self.name = name
...
class amf_Channel:
    ...
    def __init__(self, Type: str, name: str, amf_Channel15: "amf_Transition" = None, amf_Channel: "amf_Network" = None):
        self.Type = Type
        self.name = name
