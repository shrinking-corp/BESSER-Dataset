...
class tutorial_Loan:
    ...
    def __init__(self, date: date, tutorial_Loan8: "tutorial_Book" = None, tutorial_Loan: "tutorial_Library" = None, tutorial_Loan10: "tutorial_Member" = None):
        self.date = date
...
class tutorial_Book:
    ...
    def __init__(self, copies: str, name: str, books: "tutorial_Library" = None, tutorial_Book: "tutorial_Loan" = None, Book: "tutorial_Library" = None):
        self.copies = copies
        self.name = name
        self.books = books
...
class tutorial_Library:
    ...
    def __init__(self, name: str, Library: "tutorial_Book" = None, Library6: "tutorial_Member" = None, library: set["tutorial_Book"] = None, tutorial_Library: set["tutorial_Loan"] = None, library3: set["tutorial_Member"] = None):
        self.name = name
