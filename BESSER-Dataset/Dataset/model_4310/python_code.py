...
class metricDSL_Metric:
    ...
    def __init__(self, name: str, metricDSL_Metric6: "metricDSL_StepwiseMetric" = None, metricDSL_Metric10: "metricDSL_RatioMetric" = None, metricDSL_Metric13: "metricDSL_RatioMetric" = None, metricDSL_Metric: "metricDSL_MetricModel" = None, metricDSL_Metric22: "metricDSL_MetricAndWeight" = None):
        self.name = name
