...
# Classes
metricDSL_MetricModel = Class(name="metricDSL_MetricModel")
metricDSL_Metric = Class(name="metricDSL_Metric")
metricDSL_BoundAndWeight = Class(name="metricDSL_BoundAndWeight")
metricDSL_RatioMetric = Class(name="metricDSL_RatioMetric")
metricDSL_ExternalMetric = Class(name="metricDSL_ExternalMetric")
Metric = Class(name="Metric")
metricDSL_InternalMetric = Class(name="metricDSL_InternalMetric")
metricDSL_Number = Class(name="metricDSL_Number")
metricDSL_MetricDefinition = Class(name="metricDSL_MetricDefinition")
metricDSL_Parameter = Class(name="metricDSL_Parameter")
Number = Class(name="Number")
metricDSL_Constant = Class(name="metricDSL_Constant")
metricDSL_WeightedMetric = Class(name="metricDSL_WeightedMetric")
MetricDefinition = Class(name="MetricDefinition")
metricDSL_MetricAndWeight = Class(name="metricDSL_MetricAndWeight")
metricDSL_StepwiseMetric = Class(name="metricDSL_StepwiseMetric")
...
domain_model = DomainModel(
    name="metricDSL",
    types={metricDSL_MetricModel, metricDSL_Metric, metricDSL_BoundAndWeight, metricDSL_RatioMetric, metricDSL_ExternalMetric, Metric, metricDSL_InternalMetric, metricDSL_Number, metricDSL_MetricDefinition, metricDSL_Parameter, Number, metricDSL_Constant, metricDSL_WeightedMetric, MetricDefinition, metricDSL_MetricAndWeight, metricDSL_StepwiseMetric},
    associations={innerMetric5, steps7, nominatorMetric9, denominatorMetric11, metrics0, parameter1, definition2, weights4, upperBound14, weight17, metric20, weight23},
    generalizations={gen_metricDSL_RatioMetric_MetricDefinition, gen_metricDSL_ExternalMetric_Metric, gen_metricDSL_InternalMetric_Metric, gen_metricDSL_Parameter_Number, gen_metricDSL_Constant_Number, gen_metricDSL_WeightedMetric_MetricDefinition, gen_metricDSL_StepwiseMetric_MetricDefinition},
    metadata=None
)
