...
card_Card.attributes={card_Card_rank, card_Card_suit}
...
player_Deck.attributes={player_Deck_numberofShuffles, player_Deck_remainofDeck, player_Deck_deck_size, player_Deck_hand_size}
...
domain_model = DomainModel(
    name="_N6ujUAuYEeihOuC11hdjgA",
    types={card_Card, player_Player, player_Deck, Comparable_Interface, Card, poker_Game, poker_GameRun},
    associations={},
    generalizations={},
    metadata=None
)
