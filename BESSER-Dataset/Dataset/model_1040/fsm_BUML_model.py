...
fsm_NotTrigger = Class(name="fsm_NotTrigger")
Trigger = Class(name="Trigger")
fsm_AndTrigger = Class(name="fsm_AndTrigger")
fsm_OrTrigger = Class(name="fsm_OrTrigger")
...
fsm_Block = Class(name="fsm_Block")
...
fsm_Integer = Class(name="fsm_Integer")
Literal = Class(name="Literal")
fsm_Boolean = Class(name="fsm_Boolean")
fsm_Real = Class(name="fsm_Real")
fsm_String = Class(name="fsm_String")
fsm_Condition = Class(name="fsm_Condition")
fsm_FinalState = Class(name="fsm_FinalState")
State = Class(name="State")
fsm_Context = Class(name="fsm_Context")
Statement = Class(name="Statement")
fsm_Loop = Class(name="fsm_Loop")
fsm_Expression = Class(name="fsm_Expression", is_abstract=True)
fsm_VarRef = Class(name="fsm_VarRef")
...
domain_model = DomainModel(
    name="fsm",
    types={fsm_StateMachine, fsm_Region, fsm_AbstractState, fsm_Transition, fsm_State, fsm_Statement, fsm_Constraint, fsm_NotTrigger, Trigger, fsm_AndTrigger, fsm_OrTrigger, fsm_Pseudostate, fsm_InitialState, Pseudostate, fsm_Fork, fsm_Join, fsm_DeepHistory, fsm_ShallowHistory, fsm_Junction, AbstractState, fsm_Block, fsm_Trigger, fsm_Conditional, fsm_VarDecl, fsm_Assignation, fsm_RelationalExpression, Expression, fsm_ArithmeticExpression, fsm_Literal, fsm_Integer, Literal, fsm_Boolean, fsm_Real, fsm_String, fsm_Condition, fsm_FinalState, State, fsm_Context, Statement, fsm_Loop, fsm_Expression, fsm_VarRef},
    associations={regions0, subvertex1, transitions2, stateMachine4, incoming5, outgoing6, effect18, guard20, trigger22, left24, right26, left29, right31, region8, doActivity9, ownedRegions10, trigger12, target14, source16, guard41, body43, guard45, expr48, expr50, left52, right54, left57, right59, context34, statements36, body39},
    generalizations={gen_fsm_NotTrigger_Trigger, gen_fsm_AndTrigger_Trigger, gen_fsm_OrTrigger_Trigger, gen_fsm_Pseudostate_AbstractState, gen_fsm_InitialState_Pseudostate, gen_fsm_Fork_Pseudostate, gen_fsm_Join_Pseudostate, gen_fsm_DeepHistory_Pseudostate, gen_fsm_ShallowHistory_Pseudostate, gen_fsm_Junction_Pseudostate, gen_fsm_State_AbstractState, gen_fsm_Conditional_Statement, gen_fsm_VarDecl_Statement, gen_fsm_Assignation_Statement, gen_fsm_RelationalExpression_Expression, gen_fsm_ArithmeticExpression_Expression, gen_fsm_Literal_Expression, gen_fsm_Integer_Literal, gen_fsm_Boolean_Literal, gen_fsm_Real_Literal, gen_fsm_String_Literal, gen_fsm_Condition_Pseudostate, gen_fsm_FinalState_State, gen_fsm_Block_Statement, gen_fsm_Loop_Statement, gen_fsm_VarRef_Literal},
    metadata=None
)
