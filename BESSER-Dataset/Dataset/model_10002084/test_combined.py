...
def test_hyp_eventtype_EventTypeId_setter(instance):
...
@given(instance=EventType_strategy)
def test_hyp_eventtype_Type_setter(instance):
...
def test_hyp_event_MaxNumberOfPlayers_setter(instance):
...
@given(instance=Event_strategy)
def test_hyp_event_Address_setter(instance):
...
@given(instance=Event_strategy)
def test_hyp_event_CurrentNumberOfPlayers_setter(instance):
...
@given(instance=Event_strategy)
def test_hyp_event_DateTime_setter(instance):
