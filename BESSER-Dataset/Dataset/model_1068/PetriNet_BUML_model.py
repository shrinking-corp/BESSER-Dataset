...
domain_model = DomainModel(
    name="PetriNet",
    types={PetriNet_LocatedElement, PetriNet_Place, TransitionToPlace, PlaceToTransition, PetriNet_Transition, PetriNet_Arc, PetriNet_PlaceToTransition, Place, Transition, PetriNet_NamedElement, LocatedElement, PetriNet_PetriNet, NamedElement, Element, Arc, PetriNet_Element, PetriNet, PetriNet_TransitionToPlace},
    associations={incomingArc4, outgoingArc5, incomingArc6, outgoingArc9, net12, from_14, to15, elements0, arcs1, net3, from_16, to19},
    generalizations={gen_PetriNet_Place_Element, gen_PetriNet_Transition_Element, gen_PetriNet_Arc_NamedElement, gen_PetriNet_PlaceToTransition_Arc, gen_PetriNet_NamedElement_LocatedElement, gen_PetriNet_PetriNet_NamedElement, gen_PetriNet_Element_NamedElement, gen_PetriNet_TransitionToPlace_Arc},
    metadata=None
)
