...
# Classes
flowgraph_Stmt = Class(name="flowgraph_Stmt", is_abstract=True)
Item = Class(name="Item")
flowgraph_Expr = Class(name="flowgraph_Expr")
flowgraph_Item = Class(name="flowgraph_Item", is_abstract=True)
flowgraph_Return = Class(name="flowgraph_Return")
flowgraph_Method = Class(name="flowgraph_Method")
Block = Class(name="Block")
flowgraph_Exit = Class(name="flowgraph_Exit")
flowgraph_Var = Class(name="flowgraph_Var")
flowgraph_SimpleStmt = Class(name="flowgraph_SimpleStmt")
Stmt = Class(name="Stmt")
FlowInstr = Class(name="FlowInstr")
flowgraph_Block = Class(name="flowgraph_Block")
flowgraph_If = Class(name="flowgraph_If")
Conditional = Class(name="Conditional")
flowgraph_Param = Class(name="flowgraph_Param")
Var = Class(name="Var")
flowgraph_Loop = Class(name="flowgraph_Loop")
flowgraph_Conditional = Class(name="flowgraph_Conditional", is_abstract=True)
flowgraph_JumpStmt = Class(name="flowgraph_JumpStmt", is_abstract=True)
flowgraph_Label = Class(name="flowgraph_Label")
flowgraph_Break = Class(name="flowgraph_Break")
JumpStmt = Class(name="JumpStmt")
flowgraph_Continue = Class(name="flowgraph_Continue")
flowgraph_FlowInstr = Class(name="flowgraph_FlowInstr", is_abstract=True)
...
flowgraph_SimpleStmt.attributes={flowgraph_SimpleStmt_type, flowgraph_SimpleStmt_functionAccess, flowgraph_SimpleStmt_valiableAccess}
...
# Relationships
else_3: BinaryAssociation = BinaryAssociation(
    name="else_3",
    ends={
...
def_17: BinaryAssociation = BinaryAssociation(
    name="def_17",
    ends={
...
definers23: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="def_", type=flowgraph_FlowInstr, multiplicity=Multiplicity(0, 9999))
    }
)
...
domain_model = DomainModel(
    name="flowgraph",
    types={flowgraph_Stmt, Item, flowgraph_Expr, flowgraph_Item, flowgraph_Return, flowgraph_Method, Block, flowgraph_Exit, flowgraph_Var, flowgraph_SimpleStmt, Stmt, FlowInstr, flowgraph_Block, flowgraph_If, Conditional, flowgraph_Param, Var, flowgraph_Loop, flowgraph_Conditional, flowgraph_JumpStmt, flowgraph_Label, flowgraph_Break, JumpStmt, flowgraph_Continue, flowgraph_FlowInstr},
    associations={else_3, exit6, vars7, stmts0, cfPrev15, then1, def_17, use19, dfNext22, definers23, users25, method27, body8, expr10, label11, cfNext13, stmt28, jumps30},
    generalizations={gen_flowgraph_Stmt_Item, gen_flowgraph_Expr_FlowInstr, gen_flowgraph_Return_Stmt, gen_flowgraph_Return_FlowInstr, gen_flowgraph_Method_Block, gen_flowgraph_Method_FlowInstr, gen_flowgraph_SimpleStmt_Stmt, gen_flowgraph_SimpleStmt_FlowInstr, gen_flowgraph_Block_Stmt, gen_flowgraph_If_Conditional, gen_flowgraph_Var_Item, gen_flowgraph_Param_Var, gen_flowgraph_Exit_FlowInstr, gen_flowgraph_Label_Stmt, gen_flowgraph_Loop_Conditional, gen_flowgraph_Conditional_Stmt, gen_flowgraph_JumpStmt_Stmt, gen_flowgraph_JumpStmt_FlowInstr, gen_flowgraph_Break_JumpStmt, gen_flowgraph_Continue_JumpStmt, gen_flowgraph_FlowInstr_Item},
    metadata=None
)
