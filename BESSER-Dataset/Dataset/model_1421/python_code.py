...
class statemachine_State:
    ...
    def __init__(self, name: str, statemachine_State9: set["statemachine_Command"] = None, statemachine_State: "statemachine_Statemachine" = None, statemachine_State12: set["statemachine_Transition"] = None, statemachine_State18: "statemachine_Transition" = None):
        self.name = name
...
class statemachine_Command:
    ...
    def __init__(self, code: str, name: str, statemachine_Command: "statemachine_Statemachine" = None, statemachine_Command10: "statemachine_State" = None):
        self.code = code
        self.name = name
