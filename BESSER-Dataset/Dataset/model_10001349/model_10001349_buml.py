...
Package_Allowance.attributes={Package_Allowance_emp_id, Package_Allowance_id, Package_Allowance_Effectivedate}
...
Package_Attendance.attributes={Package_Attendance_timeout, Package_Attendance_id, Package_Attendance_empid, Package_Attendance_timein}
...
Package_Employee.attributes={Package_Employee_leavegroup, Package_Employee_empid, Package_Employee_depid, Package_Employee_post, Package_Employee_id, Package_Employee_shift, Package_Employee_usergroup}
...
Package_EmployeeSalary.attributes={Package_EmployeeSalary_attribute, Package_EmployeeSalary_attribute2}
...
Package_OT_Requests.attributes={Package_OT_Requests_OTType, Package_OT_Requests_id, Package_OT_Requests_EmpID, Package_OT_Requests_OtDay}
...
Package_User_groups.attributes={Package_User_groups_attribute3, Package_User_groups_attribute2, Package_User_groups_attribute}
...
Package_Users.attributes={Package_Users_email, Package_Users_id, Package_Users_firstname, Package_Users_password, Package_Users_lastname}
...
Class_Diagram_for_Propsed_System_Allowance.attributes={Class_Diagram_for_Propsed_System_Allowance_emp_id, Class_Diagram_for_Propsed_System_Allowance_id, Class_Diagram_for_Propsed_System_Allowance_effectivedate, Class_Diagram_for_Propsed_System_Allowance_amount}
...
Class_Diagram_for_Propsed_System_Attendance.attributes={Class_Diagram_for_Propsed_System_Attendance_timein, Class_Diagram_for_Propsed_System_Attendance_empid, Class_Diagram_for_Propsed_System_Attendance_timeout, Class_Diagram_for_Propsed_System_Attendance_id}

# Class_Diagram_for_Propsed_System_DeuctionTypes class attributes and methods
Class_Diagram_for_Propsed_System_DeuctionTypes_date_add: Property = Property(name="date_add", type=StringType)
...
Class_Diagram_for_Propsed_System_DeuctionTypes.attributes={Class_Diagram_for_Propsed_System_DeuctionTypes_date_add, Class_Diagram_for_Propsed_System_DeuctionTypes_id, Class_Diagram_for_Propsed_System_DeuctionTypes_type}
...
Class_Diagram_for_Propsed_System_AllowanceTypes_date_added: Property = Property(name="date_added", type=Class_Diagram_for_Propsed_System_UserUpdates)
...
Class_Diagram_for_Propsed_System_Deductions_id: Property = Property(name="id", type=StringType)
...
Class_Diagram_for_Propsed_System_Departments.attributes={Class_Diagram_for_Propsed_System_Departments_depname, Class_Diagram_for_Propsed_System_Departments_id}

# Class_Diagram_for_Propsed_System_Shifts class attributes and methods
Class_Diagram_for_Propsed_System_Shifts_id: Property = Property(name="id", type=StringType)
...
Class_Diagram_for_Propsed_System_Shifts.attributes={Class_Diagram_for_Propsed_System_Shifts_endtime, Class_Diagram_for_Propsed_System_Shifts_id, Class_Diagram_for_Propsed_System_Shifts_starttime, Class_Diagram_for_Propsed_System_Shifts_shiftaname}
...
Class_Diagram_for_Propsed_System_Posts_department: Property = Property(name="department", type=IntegerType)
Class_Diagram_for_Propsed_System_Posts.attributes={Class_Diagram_for_Propsed_System_Posts_name, Class_Diagram_for_Propsed_System_Posts_department, Class_Diagram_for_Propsed_System_Posts_id}

# Class_Diagram_for_Propsed_System_Employee class attributes and methods
Class_Diagram_for_Propsed_System_Employee_empid: Property = Property(name="empid", type=StringType)
Class_Diagram_for_Propsed_System_Employee_depid: Property = Property(name="depid", type=IntegerType)
Class_Diagram_for_Propsed_System_Employee_post: Property = Property(name="post", type=StringType)
Class_Diagram_for_Propsed_System_Employee_shift: Property = Property(name="shift", type=StringType)
...
Class_Diagram_for_Propsed_System_Employee.attributes={Class_Diagram_for_Propsed_System_Employee_shift, Class_Diagram_for_Propsed_System_Employee_id, Class_Diagram_for_Propsed_System_Employee_post, Class_Diagram_for_Propsed_System_Employee_empid, Class_Diagram_for_Propsed_System_Employee_depid, Class_Diagram_for_Propsed_System_Employee_user_id, Class_Diagram_for_Propsed_System_Employee_mobile, Class_Diagram_for_Propsed_System_Employee_leavegroup, Class_Diagram_for_Propsed_System_Employee_usergroup}
...
Class_Diagram_for_Propsed_System_EmployeeParoll_basicslaray: Property = Property(name="basicslaray", type=IntegerType)
Class_Diagram_for_Propsed_System_EmployeeParoll_empid3: Property = Property(name="empid3", type=IntegerType)
Class_Diagram_for_Propsed_System_EmployeeParoll_otamount: Property = Property(name="otamount", type=IntegerType)
Class_Diagram_for_Propsed_System_EmployeeParoll_doyamount: Property = Property(name="doyamount", type=IntegerType)
Class_Diagram_for_Propsed_System_EmployeeParoll_epf: Property = Property(name="epf", type=IntegerType)
Class_Diagram_for_Propsed_System_EmployeeParoll_etf: Property = Property(name="etf", type=StringType)
Class_Diagram_for_Propsed_System_EmployeeParoll.attributes={Class_Diagram_for_Propsed_System_EmployeeParoll_empid3, Class_Diagram_for_Propsed_System_EmployeeParoll_empid, Class_Diagram_for_Propsed_System_EmployeeParoll_etf, Class_Diagram_for_Propsed_System_EmployeeParoll_id, Class_Diagram_for_Propsed_System_EmployeeParoll_doyamount, Class_Diagram_for_Propsed_System_EmployeeParoll_basicslaray, Class_Diagram_for_Propsed_System_EmployeeParoll_epf, Class_Diagram_for_Propsed_System_EmployeeParoll_otamount}

# Class_Diagram_for_Propsed_System_EmployeeSalary class attributes and methods
Class_Diagram_for_Propsed_System_EmployeeSalary_attribute: Property = Property(name="attribute", type=StringType)
Class_Diagram_for_Propsed_System_EmployeeSalary_attribute2: Property = Property(name="attribute2", type=StringType)
Class_Diagram_for_Propsed_System_EmployeeSalary.attributes={Class_Diagram_for_Propsed_System_EmployeeSalary_attribute2, Class_Diagram_for_Propsed_System_EmployeeSalary_attribute}
...
Class_Diagram_for_Propsed_System_EPF_effectve_date: Property = Property(name="effectve_date", type=Class_Diagram_for_Propsed_System_UserUpdates)
Class_Diagram_for_Propsed_System_EPF.attributes={Class_Diagram_for_Propsed_System_EPF_id, Class_Diagram_for_Propsed_System_EPF_precentage, Class_Diagram_for_Propsed_System_EPF_effectve_date}

# Class_Diagram_for_Propsed_System_Event class attributes and methods
Class_Diagram_for_Propsed_System_Event_id: Property = Property(name="id", type=StringType)
...
Class_Diagram_for_Propsed_System_Event.attributes={Class_Diagram_for_Propsed_System_Event_type, Class_Diagram_for_Propsed_System_Event_id, Class_Diagram_for_Propsed_System_Event_date, Class_Diagram_for_Propsed_System_Event_eventname}
...
Class_Diagram_for_Propsed_System_Leave_Taken_start_date: Property = Property(name="start_date", type=Class_Diagram_for_Propsed_System_UserUpdates)
...
Class_Diagram_for_Propsed_System_Leave_Taken.attributes={Class_Diagram_for_Propsed_System_Leave_Taken_enddate, Class_Diagram_for_Propsed_System_Leave_Taken_empid, Class_Diagram_for_Propsed_System_Leave_Taken_id, Class_Diagram_for_Propsed_System_Leave_Taken_status, Class_Diagram_for_Propsed_System_Leave_Taken_leavetype, Class_Diagram_for_Propsed_System_Leave_Taken_start_date}
...
Class_Diagram_for_Propsed_System_LeaveProfiles.attributes={Class_Diagram_for_Propsed_System_LeaveProfiles_id, Class_Diagram_for_Propsed_System_LeaveProfiles_anual, Class_Diagram_for_Propsed_System_LeaveProfiles_casual, Class_Diagram_for_Propsed_System_LeaveProfiles_name}
...
Class_Diagram_for_Propsed_System_OT_Requests.attributes={Class_Diagram_for_Propsed_System_OT_Requests_OtDay, Class_Diagram_for_Propsed_System_OT_Requests_OTType, Class_Diagram_for_Propsed_System_OT_Requests_EmpID, Class_Diagram_for_Propsed_System_OT_Requests_id}

# Class_Diagram_for_Propsed_System_User_groups class attributes and methods
Class_Diagram_for_Propsed_System_User_groups_attribute: Property = Property(name="attribute", type=StringType)
Class_Diagram_for_Propsed_System_User_groups_attribute2: Property = Property(name="attribute2", type=StringType)
Class_Diagram_for_Propsed_System_User_groups_attribute3: Property = Property(name="attribute3", type=StringType)
Class_Diagram_for_Propsed_System_User_groups.attributes={Class_Diagram_for_Propsed_System_User_groups_attribute2, Class_Diagram_for_Propsed_System_User_groups_attribute3, Class_Diagram_for_Propsed_System_User_groups_attribute}
...
Class_Diagram_for_Propsed_System_Users_firstname: Property = Property(name="firstname", type=IntegerType)
Class_Diagram_for_Propsed_System_Users_lastname: Property = Property(name="lastname", type=IntegerType)
Class_Diagram_for_Propsed_System_Users_email: Property = Property(name="email", type=IntegerType)
Class_Diagram_for_Propsed_System_Users_password: Property = Property(name="password", type=IntegerType)
Class_Diagram_for_Propsed_System_Users.attributes={Class_Diagram_for_Propsed_System_Users_id, Class_Diagram_for_Propsed_System_Users_password, Class_Diagram_for_Propsed_System_Users_email, Class_Diagram_for_Propsed_System_Users_lastname, Class_Diagram_for_Propsed_System_Users_firstname}

# Class_Diagram_for_Propsed_System_UserUpdates class attributes and methods
Class_Diagram_for_Propsed_System_UserUpdates_id: Property = Property(name="id", type=StringType)
Class_Diagram_for_Propsed_System_UserUpdates_user_id: Property = Property(name="user_id", type=StringType)
Class_Diagram_for_Propsed_System_UserUpdates_attribute3: Property = Property(name="attribute3", type=StringType)
Class_Diagram_for_Propsed_System_UserUpdates.attributes={Class_Diagram_for_Propsed_System_UserUpdates_user_id, Class_Diagram_for_Propsed_System_UserUpdates_attribute3, Class_Diagram_for_Propsed_System_UserUpdates_id}
...
Class_Diagram_for_Propsed_System_Advances.attributes={Class_Diagram_for_Propsed_System_Advances_amount, Class_Diagram_for_Propsed_System_Advances_empid, Class_Diagram_for_Propsed_System_Advances_id, Class_Diagram_for_Propsed_System_Advances_remain, Class_Diagram_for_Propsed_System_Advances_installments}

# Class_Diagram_for_Propsed_System_Messages class attributes and methods
Class_Diagram_for_Propsed_System_Messages_id: Property = Property(name="id", type=StringType)
...
Class_Diagram_for_Propsed_System_Messages_msg: Property = Property(name="msg", type=IntegerType)
Class_Diagram_for_Propsed_System_Messages_read_recipt: Property = Property(name="read_recipt", type=StringType)
Class_Diagram_for_Propsed_System_Messages.attributes={Class_Diagram_for_Propsed_System_Messages_sender, Class_Diagram_for_Propsed_System_Messages_reciever, Class_Diagram_for_Propsed_System_Messages_id, Class_Diagram_for_Propsed_System_Messages_read_recipt, Class_Diagram_for_Propsed_System_Messages_msg}
...
Class_Diagram_for_Propsed_System_User_Permissions.attributes={Class_Diagram_for_Propsed_System_User_Permissions_permissions, Class_Diagram_for_Propsed_System_User_Permissions_module, Class_Diagram_for_Propsed_System_User_Permissions_id}
...
Class_Diagram_for_Propsed_System_ETF_effectivedate: Property = Property(name="effectivedate", type=StringType)
Class_Diagram_for_Propsed_System_ETF.attributes={Class_Diagram_for_Propsed_System_ETF_effectivedate, Class_Diagram_for_Propsed_System_ETF_id, Class_Diagram_for_Propsed_System_ETF_precentage}
...
domain_model = DomainModel(
    ...
    associations={View_personal_detais_Actor, Request_Loan_and_advances_Actor, View_Reports_Admin, Actor_UseCase, Actor_UseCase2, Actor_UseCase3, Actor_UseCase4, Actor_UseCase5, Admin_Set_advances_status, Admin_View_leave_Rquest, Admin_View_Employee_Time_Records, Clark_Generate_Paysheet, Clark_Add_Employee_Time_Records, Users_Employee, Attendance_Employee, Employee_OT_Requests, Employee_Shifts, Employee_Leave_Taken, Employee_EmployeeSalary, Allowance_Employee, Employee_Messages, Employee_LeaveProfiles, Employee_Posts, Departments_Employee, Employee_EmployeeParoll, Employee_User_groups, User_groups_User_Permissions, Employee_Advances, Users_Employee1, Attendance_Employee1, Employee_OT_Requests1, Employee_Shifts1, Employee_Leave_Taken1, Employee_EmployeeSalary1, Allowance_Employee1, Employee_Messages1, Admin_Issue_and_Check_Appraislas, Admin_View_Pay_Sheet_History, Admin_Approve_Employee_Pay_sheets, Admin_Set_Leave_status, Clark_Add_Employee_profile, Clark_Add_New_department, Clark_View_Reports, Clark_View_Employee_profiles, Clark_Add_new_company_Events, Employee_LeaveProfiles1, Employee_Posts1, Departments_Employee1, Employee_EmployeeParoll1, Employee_User_groups1, User_groups_User_Permissions1, Employee_Advances1, Employee_Deductions},
    generalizations={},
    metadata=None
)
