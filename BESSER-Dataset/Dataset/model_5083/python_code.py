...
class testall_Interface(ABC):
    ...
    def __init__(self, name: str, signature: str, testall_Interface: set["testall_Binding"] = None, testall_Interface8: "testall_Binding" = None, testall_Interface11: "testall_Binding" = None):
        self.name = name
...
class testall_Content:
    ...
    def __init__(self, expression: str, language: str, testall_Content13: "testall_AbstractComponent" = None, testall_Content: "testall_AbstractComponent" = None):
...
class testall_AbstractComponent(ABC):
    ...
    def __init__(self, name: str, testall_AbstractComponent14: "testall_Content" = None, testall_AbstractComponent: "testall_Content" = None, testall_AbstractComponent2: set["testall_Required"] = None, testall_AbstractComponent4: set["testall_Provided"] = None):
        self.name = name
