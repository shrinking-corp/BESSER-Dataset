...
# Classes
testall_AbstractComponent = Class(name="testall_AbstractComponent", is_abstract=True)
testall_Binding = Class(name="testall_Binding")
Interface = Class(name="Interface")
testall_Component = Class(name="testall_Component")
AbstractComponent = Class(name="AbstractComponent")
testall_Content = Class(name="testall_Content")
testall_Required = Class(name="testall_Required")
testall_Provided = Class(name="testall_Provided")
testall_Interface = Class(name="testall_Interface", is_abstract=True)
...
testall_Interface.attributes={testall_Interface_signature, testall_Interface_name}
...
domain_model = DomainModel(
    name="testall",
    types={testall_AbstractComponent, testall_Binding, Interface, testall_Component, AbstractComponent, testall_Content, testall_Required, testall_Provided, testall_Interface},
    associations={bindings5, from_6, to9, contentParent12, content0, requiredInterfaces1, providedInterfaces3, subComponents16},
