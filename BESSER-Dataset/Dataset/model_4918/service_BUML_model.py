...
service_Selection.attributes={service_Selection_limit, service_Selection_selected, service_Selection_distinct}
...
domain_model = DomainModel(
    name="service",
    types={service_Services, service_Service, NamedElement, service_EntityOrView, service_Selection, service_BusinessOperation, FormalParameterList, service_Feature, service_Association, service_Order, service_Variable, service_ServiceFeatureReference, Variable, service_Asc, Order, service_Desc, service_Predicate, OperationResultTypes},
    associations={services0, serves1, selections3, operations4, usedBy6, fields7, joins8, ordering12, path14, feature16, uses18, filter10},
    generalizations={gen_service_Service_NamedElement, gen_service_Selection_NamedElement, gen_service_Selection_FormalParameterList, gen_service_ServiceFeatureReference_Variable, gen_service_Asc_Order, gen_service_Desc_Order, gen_service_BusinessOperation_NamedElement},
    metadata=None
)
