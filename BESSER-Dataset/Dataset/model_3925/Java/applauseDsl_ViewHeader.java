...
public class applauseDsl_ViewHeader  {
    ...
    private applauseDsl_DetailsView applausedsl_detailsview;
    ...
    public applauseDsl_DetailsView getApplausedsl_detailsview() {
        return applausedsl_detailsview;
    }

    public void setApplausedsl_detailsview(applauseDsl_DetailsView applausedsl_detailsview) {
        this.applausedsl_detailsview = applausedsl_detailsview;
    }
    public applauseDsl_ScalarExpression getApplausedsl_scalarexpression() {
        return applausedsl_scalarexpression;
    }
