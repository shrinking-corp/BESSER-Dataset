...
# Classes
applauseDsl_VariableDeclaration = Class(name="applauseDsl_VariableDeclaration")
applauseDsl_TypeDescription = Class(name="applauseDsl_TypeDescription")
applauseDsl_Type = Class(name="applauseDsl_Type")
applauseDsl_ApplauseModel = Class(name="applauseDsl_ApplauseModel")
applauseDsl_Application = Class(name="applauseDsl_Application")
applauseDsl_ModelElement = Class(name="applauseDsl_ModelElement")
applauseDsl_NavigationBarItem = Class(name="applauseDsl_NavigationBarItem")
ModelElement = Class(name="ModelElement")
applauseDsl_ScalarExpression = Class(name="applauseDsl_ScalarExpression")
applauseDsl_SimpleType = Class(name="applauseDsl_SimpleType")
Type = Class(name="Type")
applauseDsl_Parameter = Class(name="applauseDsl_Parameter")
VariableDeclaration = Class(name="VariableDeclaration")
applauseDsl_ObjectReference = Class(name="applauseDsl_ObjectReference")
Expression = Class(name="Expression")
ScalarExpression = Class(name="ScalarExpression")
CollectionExpression = Class(name="CollectionExpression")
applauseDsl_Expression = Class(name="applauseDsl_Expression")
applauseDsl_CollectionExpression = Class(name="applauseDsl_CollectionExpression")
applauseDsl_StringLiteral = Class(name="applauseDsl_StringLiteral")
applauseDsl_PredefinedParameter = Class(name="applauseDsl_PredefinedParameter")
applauseDsl_SectionId = Class(name="applauseDsl_SectionId")
PredefinedParameter = Class(name="PredefinedParameter")
applauseDsl_StringFunction = Class(name="applauseDsl_StringFunction")
applauseDsl_CollectionLiteral = Class(name="applauseDsl_CollectionLiteral")
applauseDsl_CollectionFunction = Class(name="applauseDsl_CollectionFunction")
applauseDsl_ViewCall = Class(name="applauseDsl_ViewCall")
applauseDsl_Button = Class(name="applauseDsl_Button")
applauseDsl_View = Class(name="applauseDsl_View")
applauseDsl_Entity = Class(name="applauseDsl_Entity")
applauseDsl_Property = Class(name="applauseDsl_Property")
applauseDsl_ContentProvider = Class(name="applauseDsl_ContentProvider")
applauseDsl_ProviderConstruction = Class(name="applauseDsl_ProviderConstruction")
applauseDsl_SectionCell = Class(name="applauseDsl_SectionCell")
applauseDsl_SectionedView = Class(name="applauseDsl_SectionedView")
View = Class(name="View")
applauseDsl_ViewForAllSections = Class(name="applauseDsl_ViewForAllSections")
applauseDsl_ViewSection = Class(name="applauseDsl_ViewSection")
applauseDsl_TableView = Class(name="applauseDsl_TableView")
SectionedView = Class(name="SectionedView")
applauseDsl_DetailsView = Class(name="applauseDsl_DetailsView")
applauseDsl_ViewHeader = Class(name="applauseDsl_ViewHeader")
applauseDsl_WebView = Class(name="applauseDsl_WebView")
applauseDsl_CustomView = Class(name="applauseDsl_CustomView")
applauseDsl_ActionDelegate = Class(name="applauseDsl_ActionDelegate")
ViewAction = Class(name="ViewAction")
applauseDsl_CollectionIterator = Class(name="applauseDsl_CollectionIterator")
applauseDsl_ViewAction = Class(name="applauseDsl_ViewAction")
applauseDsl_ExternalOpen = Class(name="applauseDsl_ExternalOpen")
applauseDsl_StringConcat = Class(name="applauseDsl_StringConcat")
StringFunction = Class(name="StringFunction")
applauseDsl_StringReplace = Class(name="applauseDsl_StringReplace")
applauseDsl_StringUrlConform = Class(name="applauseDsl_StringUrlConform")
applauseDsl_StringSplit = Class(name="applauseDsl_StringSplit")
CollectionFunction = Class(name="CollectionFunction")
applauseDsl_Constant = Class(name="applauseDsl_Constant")
...
applauseDsl_ContentProvider.attributes={applauseDsl_ContentProvider_html, applauseDsl_ContentProvider_xml, applauseDsl_ContentProvider_many, applauseDsl_ContentProvider_resolver, applauseDsl_ContentProvider_name}
...
domain_model = DomainModel(
    name="applauseDsl",
    types={applauseDsl_VariableDeclaration, applauseDsl_TypeDescription, applauseDsl_Type, applauseDsl_ApplauseModel, applauseDsl_Application, applauseDsl_ModelElement, applauseDsl_NavigationBarItem, ModelElement, applauseDsl_ScalarExpression, applauseDsl_SimpleType, Type, applauseDsl_Parameter, VariableDeclaration, applauseDsl_ObjectReference, Expression, ScalarExpression, CollectionExpression, applauseDsl_Expression, applauseDsl_CollectionExpression, applauseDsl_StringLiteral, applauseDsl_PredefinedParameter, applauseDsl_SectionId, PredefinedParameter, applauseDsl_StringFunction, applauseDsl_CollectionLiteral, applauseDsl_CollectionFunction, applauseDsl_ViewCall, applauseDsl_Button, applauseDsl_View, applauseDsl_Entity, applauseDsl_Property, applauseDsl_ContentProvider, applauseDsl_ProviderConstruction, applauseDsl_SectionCell, applauseDsl_SectionedView, View, applauseDsl_ViewForAllSections, applauseDsl_ViewSection, applauseDsl_TableView, SectionedView, applauseDsl_DetailsView, applauseDsl_ViewHeader, applauseDsl_WebView, applauseDsl_CustomView, applauseDsl_ActionDelegate, ViewAction, applauseDsl_CollectionIterator, applauseDsl_ViewAction, applauseDsl_ExternalOpen, applauseDsl_StringConcat, StringFunction, applauseDsl_StringReplace, applauseDsl_StringUrlConform, applauseDsl_StringSplit, CollectionFunction, applauseDsl_Constant, CellType, Position},
    associations={type7, application0, elements1, icon3, triggers4, description8, object10, tail12, items14, appicon16, splash19, mainview22, buttons24, title26, icon29, view32, argument55, predefinedParameter57, title59, extends36, buttons61, properties37, description39, parameter42, type44, url47, selection50, provider53, subtitle90, details93, image96, title99, cells102, actions64, content67, superView70, forAllSections72, sections74, header76, header77, forAllSections79, sections82, content85, title87, collection132, title104, provider107, cells110, iterator113, text115, details118, image121, query124, action127, buttonAction129, match149, replacement152, url134, view136, provider139, action142, values145, value147, value155, value157, delimiter159, value162},
    generalizations={gen_applauseDsl_VariableDeclaration_ModelElement, gen_applauseDsl_NavigationBarItem_ModelElement, gen_applauseDsl_Type_ModelElement, gen_applauseDsl_SimpleType_Type, gen_applauseDsl_Parameter_VariableDeclaration, gen_applauseDsl_ObjectReference_Expression, gen_applauseDsl_ObjectReference_ScalarExpression, gen_applauseDsl_ObjectReference_CollectionExpression, gen_applauseDsl_StringLiteral_Expression, gen_applauseDsl_StringLiteral_ScalarExpression, gen_applauseDsl_SectionId_PredefinedParameter, gen_applauseDsl_StringFunction_Expression, gen_applauseDsl_StringFunction_ScalarExpression, gen_applauseDsl_CollectionLiteral_Expression, gen_applauseDsl_CollectionLiteral_CollectionExpression, gen_applauseDsl_CollectionFunction_Expression, gen_applauseDsl_CollectionFunction_CollectionExpression, gen_applauseDsl_View_ModelElement, gen_applauseDsl_Entity_Type, gen_applauseDsl_Property_VariableDeclaration, gen_applauseDsl_ContentProvider_ModelElement, gen_applauseDsl_SectionedView_View, gen_applauseDsl_TableView_SectionedView, gen_applauseDsl_DetailsView_SectionedView, gen_applauseDsl_WebView_View, gen_applauseDsl_CustomView_View, gen_applauseDsl_ActionDelegate_ViewAction, gen_applauseDsl_CollectionIterator_VariableDeclaration, gen_applauseDsl_ExternalOpen_ViewAction, gen_applauseDsl_ViewCall_ViewAction, gen_applauseDsl_StringConcat_StringFunction, gen_applauseDsl_StringReplace_StringFunction, gen_applauseDsl_StringUrlConform_StringFunction, gen_applauseDsl_StringSplit_CollectionFunction, gen_applauseDsl_Constant_VariableDeclaration},
    metadata=None
)
