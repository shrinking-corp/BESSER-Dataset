...
# Classes
cfg_cfg = Class(name="cfg_cfg")
cfg_node = Class(name="cfg_node")
cfg_edge = Class(name="cfg_edge")
cfg_startnode = Class(name="cfg_startnode")
node = Class(name="node")
cfg_endnode = Class(name="cfg_endnode")
...
domain_model = DomainModel(
    ...
    associations={nodes0, edges1, EReference13, incoming6, outgoing7, target9, EReference010, source13},
