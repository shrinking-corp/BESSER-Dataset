...
class Joueur:
    ...
    def __init__(self, model: ModelTraint, wagon: Wagon, nomJoueur: str, x_y: int, a_b: int, modelTrant3: "ModelTraint" = None):
        self.model = model
        self.wagon = wagon
...
class Wagon:
    ...
    def __init__(self, modele: ModelTraint, numeroWagon: int, isInWagon: bool, modelTrant5: set["ModelTraint"] = None):
        self.modele = modele
        self.numeroWagon = numeroWagon
        self.isInWagon = isInWagon
    ...
    @property
    def isInWagon(self):
        return self.__isInWagon
    @isInWagon.setter
    def isInWagon(self, isInWagon: bool):
        self.__isInWagon = isInWagon
...
class ModelTraint:
    ...
    def __init__(self, listeWagon__: Wagon, cellule____: Cellule, joueurs__: Joueur, indiceWagonCourant: int, indiceJoueurCourant: int, cellule1: "Cellule" = None, joueurs2: set["Joueur"] = None, wagons4: set["Wagon"] = None):
