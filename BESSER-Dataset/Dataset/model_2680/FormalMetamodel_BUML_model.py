...
# Classes
formalmetamodel_FormalModel = Class(name="formalmetamodel_FormalModel")
formalmetamodel_A = Class(name="formalmetamodel_A")
AA = Class(name="AA")
formalmetamodel_B = Class(name="formalmetamodel_B")
formalmetamodel_C = Class(name="formalmetamodel_C")
formalmetamodel_AA = Class(name="formalmetamodel_AA", is_abstract=True)
...
as_9: BinaryAssociation = BinaryAssociation(
    name="as_9",
    ends={
...
domain_model = DomainModel(
    ...
    types={formalmetamodel_FormalModel, formalmetamodel_A, AA, formalmetamodel_B, formalmetamodel_C, formalmetamodel_AA},
    associations={ba1, bb5, ab0, bs7, as_9, cs12, cs15, ca17},
