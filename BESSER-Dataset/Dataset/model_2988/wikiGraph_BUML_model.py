...
# Classes
wiki_Wiki = Class(name="wiki_Wiki")
wiki_IndexGraph = Class(name="wiki_IndexGraph")
wiki_CategoryGraph = Class(name="wiki_CategoryGraph")
wiki_ArticleGraph = Class(name="wiki_ArticleGraph")
wiki_ClassificationGraph = Class(name="wiki_ClassificationGraph")
wiki_Node = Class(name="wiki_Node")
wiki_Edge = Class(name="wiki_Edge")
wiki_Revision = Class(name="wiki_Revision")
wiki_Graph = Class(name="wiki_Graph")
...
wiki_Node.attributes={wiki_Node_visits, wiki_Node_type, wiki_Node_node_id, wiki_Node_editions, wiki_Node_node_namespace, wiki_Node_title}
...
from_26: BinaryAssociation = BinaryAssociation(
    name="from_26",
    ends={
...
domain_model = DomainModel(
    name="wiki",
    types={wiki_Wiki, wiki_IndexGraph, wiki_CategoryGraph, wiki_ArticleGraph, wiki_ClassificationGraph, wiki_Node, wiki_Edge, wiki_Revision, wiki_Graph, Graph},
    associations={lastRevision18, graphIndex0, graphCategories1, graphArticles3, graphClassification5, nodes7, edges9, revisions11, noderefs13, edgerefs15, revisions21, node22, to23, from_26},
