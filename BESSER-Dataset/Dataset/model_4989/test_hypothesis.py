...
def test_simulink_property_is_not_abstract():
    assert not inspect.isabstract(simulink_Property)


def test_simulink_property_constructor_exists():
    assert callable(simulink_Property.__init__)


def test_simulink_property_constructor_args():
...
def test_simulink_property_has_value():
    assert hasattr(simulink_Property, "value")
    descriptor = None
    for klass in simulink_Property.__mro__:
        if "value" in klass.__dict__:
            descriptor = klass.__dict__["value"]
            break
    assert isinstance(descriptor, property)

def test_simulink_property_has_type():
    assert hasattr(simulink_Property, "type")
    descriptor = None
    for klass in simulink_Property.__mro__:
...
def test_simulink_property_has_name():
    assert hasattr(simulink_Property, "name")
    descriptor = None
    for klass in simulink_Property.__mro__:
...
def test_simulink_property_has_source():
    assert hasattr(simulink_Property, "source")
    descriptor = None
    for klass in simulink_Property.__mro__:
...
@given(instance=simulink_Property_strategy)
def test_simulink_property_value_setter(instance):
...
@given(instance=simulink_Property_strategy)
def test_simulink_property_type_setter(instance):
...
@given(instance=simulink_Property_strategy)
def test_simulink_property_name_setter(instance):
...
@given(instance=simulink_Property_strategy)
def test_simulink_property_source_setter(instance):
