...
simulink_Property = Class(name="simulink_Property")
...
simulink_Property.attributes={simulink_Property_type, simulink_Property_name, simulink_Property_source, simulink_Property_value}
...
simulink_SimulinkModel.attributes={simulink_SimulinkModel_library, simulink_SimulinkModel_version, simulink_SimulinkModel_file}
...
domain_model = DomainModel(
    name="simulink",
    types={simulink_SimulinkElement, simulink_IdentifierReference, simulink_Block, SimulinkElement, simulink_Property, simulink_Port, simulink_Trigger, simulink_SubSystem, simulink_LibraryLinkReference, simulink_PortBlock, Port, simulink_Enable, simulink_InPort, simulink_OutPort, simulink_BusSelector, BusSpecification, simulink_BusSignalMapping, simulink_BusSpecification, simulink_BusCreator, simulink_Goto, VirtualBlock, simulink_SingleConnection, simulink_Connection, InPort, simulink_MultiConnection, Connection, simulink_OutPortBlock, PortBlock, simulink_InPortBlock, simulink_From, simulink_VirtualBlock, Block, simulink_SimulinkModel, simulink_ModelReference, simulink_TriggerBlock, InPortBlock, simulink_EnableBlock, simulink_SimulinkReference, simulink_GotoTagVisibility, SimulinkReference, PropertyType, EnableStates, TriggerType, TagVisibility, PropertySource},
    associations={simulinkRef0, properties1, ports2, trigger3, parent11, sourceBlock13, sourceBlockRef15, container17, portBlock18, enabler5, inports7, outports9, mappings22, busCreator23, connection19, connection20, from_21, contains26, connections28, parent30, to31, port33, fromBlocks24, gotoBlock25, gotoBlock37, subBlocks38, referencedModel41, element35, modelRef43, selector46, mappingFrom47, mappingTo49},
    generalizations={gen_simulink_Block_SimulinkElement, gen_simulink_Port_SimulinkElement, gen_simulink_Enable_InPort, gen_simulink_BusSelector_BusSpecification, gen_simulink_BusCreator_BusSpecification, gen_simulink_Goto_VirtualBlock, gen_simulink_InPort_Port, gen_simulink_OutPort_Port, gen_simulink_Connection_SimulinkElement, gen_simulink_Trigger_InPort, gen_simulink_MultiConnection_Connection, gen_simulink_SingleConnection_Connection, gen_simulink_PortBlock_VirtualBlock, gen_simulink_OutPortBlock_PortBlock, gen_simulink_InPortBlock_PortBlock, gen_simulink_VirtualBlock_Block, gen_simulink_From_VirtualBlock, gen_simulink_SimulinkModel_SimulinkElement, gen_simulink_SubSystem_Block, gen_simulink_ModelReference_Block, gen_simulink_TriggerBlock_InPortBlock, gen_simulink_EnableBlock_InPortBlock, gen_simulink_GotoTagVisibility_VirtualBlock, gen_simulink_LibraryLinkReference_SimulinkReference, gen_simulink_IdentifierReference_SimulinkReference, gen_simulink_BusSpecification_Block},
    metadata=None
)
