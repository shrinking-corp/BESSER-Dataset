...
class simulink_Property:
    ...
    def __init__(self, name: str, type: str, value: str, source: str, simulink_Property: "simulink_Block" = None):
        self.name = name
        self.type = type
        self.value = value
        self.source = source
...
class simulink_SimulinkModel(SimulinkElement):
    ...
    def __init__(self, file: str, library: bool, version: str, simulink_SimulinkModel: set["simulink_Block"] = None, simulink_SimulinkModel42: "simulink_ModelReference" = None):
        self.file = file
...
class simulink_SimulinkElement(ABC):
    ...
    def __init__(self, name: str, simulink_SimulinkElement36: "simulink_SimulinkReference" = None, simulink_SimulinkElement: "simulink_IdentifierReference" = None):
        self.name = name
