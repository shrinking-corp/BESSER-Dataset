...
# Classes
co2_CO2System = Class(name="co2_CO2System")
co2_PackageDeclaration = Class(name="co2_PackageDeclaration")
Process = Class(name="Process")
co2_DelimitedProcess = Class(name="co2_DelimitedProcess")
co2_Process = Class(name="co2_Process")
co2_EmptyProcess = Class(name="co2_EmptyProcess")
co2_Sum = Class(name="co2_Sum")
co2_Prefix = Class(name="co2_Prefix")
co2_IfThenElse = Class(name="co2_IfThenElse")
co2_Expression = Class(name="co2_Expression")
co2_ProcessCall = Class(name="co2_ProcessCall")
co2_HonestyDeclaration = Class(name="co2_HonestyDeclaration")
co2_ContractsAndProcessesDeclaration = Class(name="co2_ContractsAndProcessesDeclaration")
co2_Import = Class(name="co2_Import")
co2_ProcessDefinition = Class(name="co2_ProcessDefinition")
co2_ContractDefinition = Class(name="co2_ContractDefinition")
co2_Variable = Class(name="co2_Variable")
co2_ParallelProcesses = Class(name="co2_ParallelProcesses")
co2_Tell = Class(name="co2_Tell")
Prefix = Class(name="Prefix")
co2_VariableDeclaration = Class(name="co2_VariableDeclaration")
co2_Contract = Class(name="co2_Contract")
co2_Retract = Class(name="co2_Retract")
co2_DoOutput = Class(name="co2_DoOutput")
co2_IntAction = Class(name="co2_IntAction")
co2_TimeoutProcess = Class(name="co2_TimeoutProcess")
co2_SendGroup = Class(name="co2_SendGroup")
co2_Send = Class(name="co2_Send")
SendGroup = Class(name="SendGroup")
co2_ReceiveGroup = Class(name="co2_ReceiveGroup")
co2_Receive = Class(name="co2_Receive")
ReceiveGroup = Class(name="ReceiveGroup")
co2_Input = Class(name="co2_Input")
co2_DoInput = Class(name="co2_DoInput")
co2_ExtAction = Class(name="co2_ExtAction")
co2_Ask = Class(name="co2_Ask")
co2_Tau = Class(name="co2_Tau")
co2_TellAndReturn = Class(name="co2_TellAndReturn")
co2_Session = Class(name="co2_Session")
co2_TellAndWait = Class(name="co2_TellAndWait")
co2_BooleanLiteral = Class(name="co2_BooleanLiteral")
co2_Placeholder = Class(name="co2_Placeholder")
co2_Type = Class(name="co2_Type")
VariableDeclaration = Class(name="VariableDeclaration")
co2_EmptyContract = Class(name="co2_EmptyContract")
Contract = Class(name="Contract")
co2_IntSum = Class(name="co2_IntSum")
co2_SwitchCase = Class(name="co2_SwitchCase")
co2_Case = Class(name="co2_Case")
co2_NumberLiteral = Class(name="co2_NumberLiteral")
Expression = Class(name="Expression")
co2_StringLiteral = Class(name="co2_StringLiteral")
co2_AndExpression = Class(name="co2_AndExpression")
co2_Comparison = Class(name="co2_Comparison")
co2_Equals = Class(name="co2_Equals")
co2_Plus = Class(name="co2_Plus")
co2_Minus = Class(name="co2_Minus")
co2_ExtSum = Class(name="co2_ExtSum")
co2_Action = Class(name="co2_Action")
co2_ActionType = Class(name="co2_ActionType")
Action = Class(name="Action")
co2_RetractedProcess = Class(name="co2_RetractedProcess")
co2_OrExpression = Class(name="co2_OrExpression")
co2_BoolPlaceholder = Class(name="co2_BoolPlaceholder")
co2_StringPlaceholder = Class(name="co2_StringPlaceholder")
co2_IntType = Class(name="co2_IntType")
Type = Class(name="Type")
co2_StringType = Class(name="co2_StringType")
co2_BooleanType = Class(name="co2_BooleanType")
co2_SessionType = Class(name="co2_SessionType")
co2_ContractReference = Class(name="co2_ContractReference")
co2_UnitActionType = Class(name="co2_UnitActionType")
ActionType = Class(name="ActionType")
co2_IntActionType = Class(name="co2_IntActionType")
co2_StringActionType = Class(name="co2_StringActionType")
co2_MultiOrDiv = Class(name="co2_MultiOrDiv")
co2_BooleanNegation = Class(name="co2_BooleanNegation")
co2_ArithmeticSigned = Class(name="co2_ArithmeticSigned")
co2_VariableReference = Class(name="co2_VariableReference")
co2_IntPlaceholder = Class(name="co2_IntPlaceholder")
...
co2_PackageDeclaration.attributes={co2_PackageDeclaration_single, co2_PackageDeclaration_name}
...
co2_ProcessDefinition.attributes={co2_ProcessDefinition_name, co2_ProcessDefinition_withoutRestrictions}
...
if_24: BinaryAssociation = BinaryAssociation(
    name="if_24",
    ends={
...
domain_model = DomainModel(
    name="co2",
    types={co2_CO2System, co2_PackageDeclaration, Process, co2_DelimitedProcess, co2_Process, co2_EmptyProcess, co2_Sum, co2_Prefix, co2_IfThenElse, co2_Expression, co2_ProcessCall, co2_HonestyDeclaration, co2_ContractsAndProcessesDeclaration, co2_Import, co2_ProcessDefinition, co2_ContractDefinition, co2_Variable, co2_ParallelProcesses, co2_Tell, Prefix, co2_VariableDeclaration, co2_Contract, co2_Retract, co2_DoOutput, co2_IntAction, co2_TimeoutProcess, co2_SendGroup, co2_Send, SendGroup, co2_ReceiveGroup, co2_Receive, ReceiveGroup, co2_Input, co2_DoInput, co2_ExtAction, co2_Ask, co2_Tau, co2_TellAndReturn, co2_Session, co2_TellAndWait, co2_BooleanLiteral, co2_Placeholder, co2_Type, VariableDeclaration, co2_EmptyContract, Contract, co2_IntSum, co2_SwitchCase, co2_Case, co2_NumberLiteral, Expression, co2_StringLiteral, co2_AndExpression, co2_Comparison, co2_Equals, co2_Plus, co2_Minus, co2_ExtSum, co2_Action, co2_ActionType, Action, co2_RetractedProcess, co2_OrExpression, co2_BoolPlaceholder, co2_StringPlaceholder, co2_IntType, Type, co2_StringType, co2_BooleanType, co2_SessionType, co2_ContractReference, co2_UnitActionType, ActionType, co2_IntActionType, co2_StringActionType, co2_MultiOrDiv, co2_BooleanNegation, co2_ArithmeticSigned, co2_VariableReference, co2_IntPlaceholder, Placeholder},
    associations={package0, processes16, freeNames18, process21, prefixes23, if_24, then25, else_28, reference31, honesty1, contractsAndProcessesDeclaration3, processes5, contracts7, processes9, params12, process14, params33, next36, session39, contract40, contractReference42, session45, session47, actionName49, timeoutValue72, value74, tProcess77, next80, action82, value85, session88, inputs91, timeoutValue92, next95, value51, session54, actionName56, variable58, session61, session63, process64, session67, process69, type120, type121, contract124, contractReference127, contract130, actions133, actions98, variable101, session104, exp107, cases109, defaultProc111, match114, caseProc117, left148, right150, left153, right155, left158, right160, left163, right165, left168, actions135, type137, next138, process141, left143, right145, ref184, right170, left173, right175, expression178, expression180, ref182},
    generalizations={gen_co2_ParallelProcesses_Process, gen_co2_EmptyProcess_Process, gen_co2_Sum_Process, gen_co2_IfThenElse_Process, gen_co2_ProcessCall_Process, gen_co2_Tell_Prefix, gen_co2_Retract_Prefix, gen_co2_DoOutput_Prefix, gen_co2_SendGroup_Process, gen_co2_Send_SendGroup, gen_co2_ReceiveGroup_Process, gen_co2_Receive_ReceiveGroup, gen_co2_DoInput_Prefix, gen_co2_Ask_Prefix, gen_co2_Tau_Prefix, gen_co2_TellAndReturn_Process, gen_co2_TellAndWait_Process, gen_co2_BooleanLiteral_Expression, gen_co2_Placeholder_Expression, gen_co2_Variable_VariableDeclaration, gen_co2_Session_VariableDeclaration, gen_co2_EmptyContract_Contract, gen_co2_IntSum_Contract, gen_co2_SwitchCase_Process, gen_co2_NumberLiteral_Expression, gen_co2_StringLiteral_Expression, gen_co2_AndExpression_Expression, gen_co2_Comparison_Expression, gen_co2_Equals_Expression, gen_co2_Plus_Expression, gen_co2_Minus_Expression, gen_co2_ExtSum_Contract, gen_co2_IntAction_Action, gen_co2_ExtAction_Action, gen_co2_RetractedProcess_Process, gen_co2_OrExpression_Expression, gen_co2_BoolPlaceholder_Placeholder, gen_co2_StringPlaceholder_Placeholder, gen_co2_IntType_Type, gen_co2_StringType_Type, gen_co2_BooleanType_Type, gen_co2_SessionType_Type, gen_co2_ContractReference_Contract, gen_co2_UnitActionType_ActionType, gen_co2_IntActionType_ActionType, gen_co2_StringActionType_ActionType, gen_co2_MultiOrDiv_Expression, gen_co2_BooleanNegation_Expression, gen_co2_ArithmeticSigned_Expression, gen_co2_VariableReference_Expression, gen_co2_IntPlaceholder_Placeholder},
    metadata=None
)
