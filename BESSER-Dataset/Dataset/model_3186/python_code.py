...
class co2_Equals(Expression):
    ...
    def __init__(self, op: str, co2_Equals: "co2_Expression" = None, co2_Equals161: "co2_Expression" = None):
        self.op = op
...
class co2_VariableDeclaration:
    ...
    def __init__(self, name: str, co2_VariableDeclaration48: "co2_DoOutput" = None, co2_VariableDeclaration: "co2_Tell" = None, co2_VariableDeclaration46: "co2_Retract" = None, co2_VariableDeclaration90: "co2_Send" = None, co2_VariableDeclaration55: "co2_DoInput" = None, co2_VariableDeclaration62: "co2_Ask" = None, co2_VariableDeclaration106: "co2_Input" = None, co2_VariableDeclaration183: "co2_VariableReference" = None):
        self.name = name
...
class co2_ProcessDefinition:
    ...
    def __init__(self, withoutRestrictions: bool, name: str, co2_ProcessDefinition32: "co2_ProcessCall" = None, co2_ProcessDefinition: "co2_HonestyDeclaration" = None, co2_ProcessDefinition11: "co2_ContractsAndProcessesDeclaration" = None, co2_ProcessDefinition13: set["co2_Variable"] = None, co2_ProcessDefinition15: "co2_ParallelProcesses" = None):
...
class co2_TellAndWait(Process):
    ...
    def __init__(self, timeout: bool, co2_TellAndWait73: "co2_TimeoutProcess" = None, co2_TellAndWait: "co2_Session" = None, co2_TellAndWait70: "co2_Process" = None):
        self.timeout = timeout
