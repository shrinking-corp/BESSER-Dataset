...
class UML_Attribute:
    ...
    def __init__(self, name: str, Attribute: "UML_Class" = None, Attribute18: "UML_Classifier" = None, attribute: "UML_Class" = None, typeOf: "UML_Classifier" = None):
        self.name = name
...
class UML_Class(Classifier):
    ...
    def __init__(self, kind: str, owner: set["UML_Attribute"] = None, Class23: "UML_Association" = None, Class25: "UML_Association" = None, Class: "UML_Class" = None, subclass: "UML_Class" = None, Class8: "UML_Class" = None, general: set["UML_Class"] = None, source: set["UML_Association"] = None, destination: set["UML_Association"] = None, Class14: "UML_Attribute" = None):
        self.kind = kind
...
class UML_Association:
    ...
    def __init__(self, name: str, Association: "UML_Package" = None, association: "UML_Package" = None, sourceOf: "UML_Class" = None, destinationOf: "UML_Class" = None, Association10: "UML_Class" = None, Association12: "UML_Class" = None):
        self.name = name
...
class UML_Classifier(ABC):
    ...
    def __init__(self, name: str, Classifier: "UML_Package" = None, type: set["UML_Attribute"] = None, classifier: "UML_Package" = None, Classifier16: "UML_Attribute" = None):
        self.name = name
...
class UML_Package:
    ...
    def __init__(self, name: str, namespace: set["UML_Classifier"] = None, namespace2: set["UML_Association"] = None, Package: "UML_Classifier" = None, Package21: "UML_Association" = None):
        self.name = name
