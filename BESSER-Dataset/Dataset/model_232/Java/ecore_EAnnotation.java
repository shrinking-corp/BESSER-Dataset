...
public class ecore_EAnnotation extends EModelElement {
    ...
    public ecore_EAnnotation(
        String source        ArrayList<ecore_EObject> ecore_eobjects,        ArrayList<ecore_EObject> ecore_eobjects,        ArrayList<ecore_EStringToStringMapEntry> ecore_estringtostringmapentrys    ) {
        this.source = source;
