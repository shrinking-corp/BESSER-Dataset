...
Order.attributes={Order_shipTo, Order_number, Order_ordered, Order_shipped, Order_status, Order_total}
...
domain_model = DomainModel(
    name="_9d2f25e7_46e5_474b_a747_a73dfca0d6cf",
    types={Customer, Payment, ShoppingCart, Account, WebUser, Order, LineItem, Product, UserState, OrderStatus},
    associations={WebUser_ShoppingCart, WebUser_Customer, Account_Payment, Customer_Account, Account_ShoppingCart, ShoppingCart_LineItem, Product_LineItem, Order_LineItem, Account_Order, Payment_Order},
    generalizations={},
    metadata=None
)
