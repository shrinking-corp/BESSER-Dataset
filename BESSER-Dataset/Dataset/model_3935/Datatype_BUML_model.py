...
# Classes
datatype_Constraint = Class(name="datatype_Constraint")
datatype_Entity = Class(name="datatype_Entity")
Type = Class(name="Type")
datatype_Property = Class(name="datatype_Property")
datatype_Presence = Class(name="datatype_Presence")
datatype_ConstraintRule = Class(name="datatype_ConstraintRule")
datatype_PropertyType = Class(name="datatype_PropertyType")
datatype_PropertyAttribute = Class(name="datatype_PropertyAttribute", is_abstract=True)
datatype_PrimitivePropertyType = Class(name="datatype_PrimitivePropertyType")
PropertyType = Class(name="PropertyType")
datatype_ObjectPropertyType = Class(name="datatype_ObjectPropertyType")
datatype_Type = Class(name="datatype_Type")
ComplexPrimitivePropertyType = Class(name="ComplexPrimitivePropertyType")
datatype_Enum = Class(name="datatype_Enum")
datatype_EnumLiteral = Class(name="datatype_EnumLiteral")
Model = Class(name="Model")
datatype_BooleanPropertyAttribute = Class(name="datatype_BooleanPropertyAttribute")
PropertyAttribute = Class(name="PropertyAttribute")
datatype_EnumLiteralPropertyAttribute = Class(name="datatype_EnumLiteralPropertyAttribute")
datatype_ComplexPrimitivePropertyType = Class(name="datatype_ComplexPrimitivePropertyType")
datatype_DictionaryPropertyType = Class(name="datatype_DictionaryPropertyType")
...
datatype_Property.attributes={datatype_Property_multiplicity, datatype_Property_name, datatype_Property_description}
...
domain_model = DomainModel(
    name="datatype",
    types={datatype_Constraint, datatype_Entity, Type, datatype_Property, datatype_Presence, datatype_ConstraintRule, datatype_PropertyType, datatype_PropertyAttribute, datatype_PrimitivePropertyType, PropertyType, datatype_ObjectPropertyType, datatype_Type, ComplexPrimitivePropertyType, datatype_Enum, datatype_EnumLiteral, Model, datatype_BooleanPropertyAttribute, PropertyAttribute, datatype_EnumLiteralPropertyAttribute, datatype_ComplexPrimitivePropertyType, datatype_DictionaryPropertyType, PrimitiveType, ConstraintIntervalType, BooleanPropertyAttributeType, EnumLiteralPropertyAttributeType},
    associations={superType1, properties2, presence4, constraintRule6, type8, propertyAttributes10, type12, keyType18, valueType20, enums13, value14, Constraints16},
    generalizations={gen_datatype_Entity_Type, gen_datatype_PrimitivePropertyType_PropertyType, gen_datatype_ObjectPropertyType_PropertyType, gen_datatype_DictionaryPropertyType_ComplexPrimitivePropertyType, gen_datatype_Enum_Type, gen_datatype_Type_Model, gen_datatype_BooleanPropertyAttribute_PropertyAttribute, gen_datatype_EnumLiteralPropertyAttribute_PropertyAttribute, gen_datatype_ComplexPrimitivePropertyType_PropertyType},
    metadata=None
)
