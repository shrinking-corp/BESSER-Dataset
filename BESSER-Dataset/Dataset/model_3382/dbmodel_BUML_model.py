...
domain_model = DomainModel(
    name="model",
    types={model_Table, model_Column, model_Constraint, model_Diagram},
    associations={columns0, sourceConstraints1, targetConstraint3, TableDiagram6, Source8, Target11},
    generalizations={},
    metadata=None
)
