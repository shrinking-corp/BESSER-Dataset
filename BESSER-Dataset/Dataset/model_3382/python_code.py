...
class model_Table:
    ...
    def __init__(self, name: str, model_Table7: "model_Diagram" = None, model_Table10: "model_Constraint" = None, model_Table13: "model_Constraint" = None, model_Table: set["model_Column"] = None, model_Table2: set["model_Constraint"] = None, model_Table4: set["model_Constraint"] = None):
        self.name = name
