...
domain_model = DomainModel(
    name="DocBook",
    types={DocBook_Article, DocBook_TitledElement, TitledElement, DocBook_Sect1, DocBook_Section, DocBook_Para, Section, DocBook_Sect2, DocBook_DocBook, DocBook_Book},
    associations={articles1, sections_13, paras5, sections_26, books0},
