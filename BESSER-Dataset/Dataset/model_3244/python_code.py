...
class remes_ExitConditionalSubEdge(Edge, FromSubModeEdge, ToConditionalConnectorEdge):
    ...
    pass
class remes_EntryConditionalTopEdge(Edge, FromCompositeModeEdge, ToConditionalConnectorEdge):
...
class ToSubModeEdge:
    ...
    pass
class remes_EntryInitEdge(InitEdge, ToSubModeEdge, FromCompositeModeInitEdge):
