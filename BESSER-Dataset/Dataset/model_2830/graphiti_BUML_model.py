...
styles_TextStyleRegion = Class(name="styles_TextStyleRegion")
...
mm_styles_TextStyleRegion = Class(name="mm_styles_TextStyleRegion")
styles_TextStyle = Class(name="styles_TextStyle")
...
mm_styles_TextStyle = Class(name="mm_styles_TextStyle")
...
mm_pictograms_Diagram.attributes={mm_pictograms_Diagram_snapToGrid, mm_pictograms_Diagram_name, mm_pictograms_Diagram_verticalGridUnit, mm_pictograms_Diagram_version, mm_pictograms_Diagram_diagramTypeId, mm_pictograms_Diagram_gridUnit, mm_pictograms_Diagram_showGuides}
...
mm_algorithms_Image.attributes={mm_algorithms_Image_stretchV, mm_algorithms_Image_id, mm_algorithms_Image_stretchH, mm_algorithms_Image_proportional}
...
mm_algorithms_GraphicsAlgorithm.attributes={mm_algorithms_GraphicsAlgorithm_x, mm_algorithms_GraphicsAlgorithm_width, mm_algorithms_GraphicsAlgorithm_y, mm_algorithms_GraphicsAlgorithm_height}
...
mm_styles_Style.attributes={mm_styles_Style_stretchH, mm_styles_Style_id, mm_styles_Style_horizontalAlignment, mm_styles_Style_proportional, mm_styles_Style_verticalAlignment, mm_styles_Style_stretchV, mm_styles_Style_description, mm_styles_Style_angle, mm_styles_Style_rotation}
...
mm_algorithms_AbstractText.attributes={mm_algorithms_AbstractText_horizontalAlignment, mm_algorithms_AbstractText_value, mm_algorithms_AbstractText_rotation, mm_algorithms_AbstractText_angle, mm_algorithms_AbstractText_verticalAlignment}
...
mm_styles_Font.attributes={mm_styles_Font_name, mm_styles_Font_size, mm_styles_Font_bold, mm_styles_Font_italic}
...
mm_styles_AbstractStyle.attributes={mm_styles_AbstractStyle_lineVisible, mm_styles_AbstractStyle_lineWidth, mm_styles_AbstractStyle_lineStyle, mm_styles_AbstractStyle_transparency, mm_styles_AbstractStyle_filled}
...
mm_styles_Point.attributes={mm_styles_Point_before, mm_styles_Point_x, mm_styles_Point_y, mm_styles_Point_after}
...
adaptedGradientColoredAreas51: BinaryAssociation = BinaryAssociation(
    name="adaptedGradientColoredAreas51",
    ends={
...
styleRegions49: BinaryAssociation = BinaryAssociation(
    name="styleRegions49",
    ends={
        Property(name="styles_TextStyleRegion", type=mm_algorithms_AbstractText, multiplicity=Multiplicity(1, 1)),
        Property(name="mm_algorithms_AbstractText50", type=styles_TextStyleRegion, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
renderingStyle60: BinaryAssociation = BinaryAssociation(
    name="renderingStyle60",
    ends={
        Property(name="styles_RenderingStyle", type=mm_styles_AbstractStyle, multiplicity=Multiplicity(1, 1)),
        Property(name="mm_styles_AbstractStyle61", type=styles_RenderingStyle, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
color62: BinaryAssociation = BinaryAssociation(
    name="color62",
    ends={
        Property(name="styles_Color63", type=mm_styles_GradientColoredLocation, multiplicity=Multiplicity(1, 1)),
        Property(name="mm_styles_GradientColoredLocation", type=styles_Color, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
start64: BinaryAssociation = BinaryAssociation(
    name="start64",
    ends={
...
end65: BinaryAssociation = BinaryAssociation(
    name="end65",
    ends={
        Property(name="styles_GradientColoredLocation67", type=mm_styles_GradientColoredArea, multiplicity=Multiplicity(1, 1)),
        Property(name="mm_styles_GradientColoredArea66", type=styles_GradientColoredLocation, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
gradientColor68: BinaryAssociation = BinaryAssociation(
    name="gradientColor68",
    ends={
...
adaptedGradientColoredAreas69: BinaryAssociation = BinaryAssociation(
    name="adaptedGradientColoredAreas69",
    ends={
...
font52: BinaryAssociation = BinaryAssociation(
    name="font52",
    ends={
        Property(name="styles_Font53", type=mm_styles_Style, multiplicity=Multiplicity(1, 1)),
        Property(name="mm_styles_Style", type=styles_Font, multiplicity=Multiplicity(0, 1))
    }
)
styleContainer54: BinaryAssociation = BinaryAssociation(
    name="styleContainer54",
    ends={
...
background55: BinaryAssociation = BinaryAssociation(
    name="background55",
    ends={
        Property(name="styles_Color56", type=mm_styles_AbstractStyle, multiplicity=Multiplicity(1, 1)),
        Property(name="mm_styles_AbstractStyle", type=styles_Color, multiplicity=Multiplicity(0, 1))
    }
)
foreground57: BinaryAssociation = BinaryAssociation(
    name="foreground57",
    ends={
        Property(name="styles_Color59", type=mm_styles_AbstractStyle, multiplicity=Multiplicity(1, 1)),
        Property(name="mm_styles_AbstractStyle58", type=styles_Color, multiplicity=Multiplicity(0, 1))
    }
)
font70: BinaryAssociation = BinaryAssociation(
    name="font70",
    ends={
        Property(name="styles_Font71", type=mm_styles_TextStyle, multiplicity=Multiplicity(1, 1)),
        Property(name="mm_styles_TextStyle", type=styles_Font, multiplicity=Multiplicity(0, 1))
    }
)
foreground72: BinaryAssociation = BinaryAssociation(
    name="foreground72",
    ends={
        Property(name="styles_Color74", type=mm_styles_TextStyle, multiplicity=Multiplicity(1, 1)),
        Property(name="mm_styles_TextStyle73", type=styles_Color, multiplicity=Multiplicity(0, 1))
    }
)
background75: BinaryAssociation = BinaryAssociation(
    name="background75",
    ends={
        Property(name="styles_Color77", type=mm_styles_TextStyle, multiplicity=Multiplicity(1, 1)),
        Property(name="mm_styles_TextStyle76", type=styles_Color, multiplicity=Multiplicity(0, 1))
    }
)
underlineColor78: BinaryAssociation = BinaryAssociation(
    name="underlineColor78",
    ends={
        Property(name="styles_Color80", type=mm_styles_TextStyle, multiplicity=Multiplicity(1, 1)),
        Property(name="mm_styles_TextStyle79", type=styles_Color, multiplicity=Multiplicity(0, 1))
    }
)
strikeoutColor81: BinaryAssociation = BinaryAssociation(
    name="strikeoutColor81",
    ends={
        Property(name="styles_Color83", type=mm_styles_TextStyle, multiplicity=Multiplicity(1, 1)),
        Property(name="mm_styles_TextStyle82", type=styles_Color, multiplicity=Multiplicity(0, 1))
    }
)
style84: BinaryAssociation = BinaryAssociation(
    name="style84",
    ends={
...
domain_model = DomainModel(
    name="mm",
    types={mm_PropertyContainer, mm_GraphicsAlgorithmContainer, PropertyContainer, mm_StyleContainer, styles_Style, mm_pictograms_Shape, AnchorContainer, ContainerShape, mm_pictograms_ContainerShape, Shape, mm_Property, PictogramLink, mm_pictograms_PictogramElement, GraphicsAlgorithmContainer, GraphicsAlgorithm, mm_pictograms_Connection, Anchor, Diagram, mm_pictograms_Diagram, pictograms_ContainerShape, StyleContainer, Connection, styles_Color, styles_Font, mm_pictograms_BoxRelativeAnchor, mm_pictograms_ChopboxAnchor, mm_pictograms_ConnectionDecorator, mm_pictograms_FreeFormConnection, mm_pictograms_ManhattanConnection, mm_pictograms_PictogramLink, pictograms_mm_EObject, ConnectionDecorator, mm_pictograms_Anchor, PictogramElement, mm_pictograms_AnchorContainer, mm_pictograms_FixPointAnchor, AdvancedAnchor, styles_Point, mm_algorithms_Polyline, mm_algorithms_Ellipse, mm_algorithms_Text, AbstractText, mm_algorithms_Polygon, Polyline, mm_algorithms_Rectangle, mm_algorithms_RoundedRectangle, mm_algorithms_Image, mm_pictograms_AdvancedAnchor, mm_pictograms_CurvedConnection, styles_PrecisionPoint, mm_pictograms_CompositeConnection, CurvedConnection, mm_algorithms_GraphicsAlgorithm, styles_AbstractStyle, mm_algorithms_MultiText, mm_styles_RenderingStyle, styles_AdaptedGradientColoredAreas, mm_styles_Style, mm_algorithms_PlatformGraphicsAlgorithm, mm_algorithms_AbstractText, styles_TextStyleRegion, styles_RenderingStyle, mm_styles_GradientColoredLocation, mm_styles_GradientColoredArea, styles_GradientColoredLocation, mm_styles_GradientColoredAreas, styles_GradientColoredArea, mm_styles_AdaptedGradientColoredAreas, styles_GradientColoredAreas, mm_styles_Font, styles_mm_StyleContainer, mm_styles_AbstractStyle, mm_styles_TextStyleRegion, styles_TextStyle, mm_styles_Point, mm_styles_Color, mm_styles_PrecisionPoint, mm_styles_TextStyle, LineStyle, Orientation, LocationType, UnderlineStyle},
    associations={properties0, styles1, container2, children3, pictogramLinks8, graphicsAlgorithm10, link11, start14, end15, connections4, colors5, fonts6, location29, connection30, bendpoints32, pictogramElement34, businessObjects35, parent17, connectionDecorators18, parent19, outgoingConnections20, incomingConnections22, referencedGraphicsAlgorithm24, anchors26, style44, points45, controlPoints36, children37, graphicsAlgorithmChildren38, parentGraphicsAlgorithm40, pictogramElement42, adaptedGradientColoredAreas51, font47, styleRegions49, renderingStyle60, color62, start64, end65, gradientColor68, adaptedGradientColoredAreas69, font52, styleContainer54, background55, foreground57, font70, foreground72, background75, underlineColor78, strikeoutColor81, style84},
    generalizations={gen_mm_GraphicsAlgorithmContainer_PropertyContainer, gen_mm_pictograms_Shape_AnchorContainer, gen_mm_pictograms_ContainerShape_Shape, gen_mm_pictograms_PictogramElement_GraphicsAlgorithmContainer, gen_mm_pictograms_Connection_AnchorContainer, gen_mm_pictograms_Diagram_pictograms_ContainerShape, gen_mm_pictograms_Diagram_StyleContainer, gen_mm_pictograms_BoxRelativeAnchor_AdvancedAnchor, gen_mm_pictograms_ChopboxAnchor_Anchor, gen_mm_pictograms_ConnectionDecorator_Shape, gen_mm_pictograms_FreeFormConnection_Connection, gen_mm_pictograms_ManhattanConnection_Connection, gen_mm_pictograms_PictogramLink_PropertyContainer, gen_mm_pictograms_Anchor_PictogramElement, gen_mm_pictograms_AnchorContainer_PictogramElement, gen_mm_pictograms_FixPointAnchor_AdvancedAnchor, gen_mm_algorithms_Polyline_GraphicsAlgorithm, gen_mm_algorithms_Ellipse_GraphicsAlgorithm, gen_mm_algorithms_Text_AbstractText, gen_mm_algorithms_Polygon_Polyline, gen_mm_algorithms_Rectangle_GraphicsAlgorithm, gen_mm_algorithms_RoundedRectangle_GraphicsAlgorithm, gen_mm_algorithms_Image_GraphicsAlgorithm, gen_mm_pictograms_AdvancedAnchor_Anchor, gen_mm_pictograms_CurvedConnection_Connection, gen_mm_pictograms_CompositeConnection_Connection, gen_mm_algorithms_GraphicsAlgorithm_GraphicsAlgorithmContainer, gen_mm_algorithms_GraphicsAlgorithm_styles_AbstractStyle, gen_mm_algorithms_MultiText_AbstractText, gen_mm_styles_Style_StyleContainer, gen_mm_styles_Style_styles_AbstractStyle, gen_mm_algorithms_PlatformGraphicsAlgorithm_GraphicsAlgorithm, gen_mm_algorithms_AbstractText_GraphicsAlgorithm},
    metadata=None
)
