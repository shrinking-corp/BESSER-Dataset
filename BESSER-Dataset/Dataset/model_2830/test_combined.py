...
@given(instance=mm_styles_Style_strategy)
def test_hyp_mm_styles_style_rotation_setter(instance):
...
@given(instance=mm_algorithms_AbstractText_strategy)
def test_hyp_mm_algorithms_abstracttext_rotation_setter(instance):
    original = instance.rotation
    instance.rotation = original
    assert instance.rotation == original
...
def test_mm_algorithms_AbstractText_angle_value_roundtrip():
    instance = mm_algorithms_AbstractText(angle="sample_text", horizontalAlignment="sample_text", rotation="sample_text", value="sample_text", verticalAlignment="sample_text")
...
def test_mm_algorithms_AbstractText_rotation_value_roundtrip():
    instance = mm_algorithms_AbstractText(angle="sample_text", horizontalAlignment="sample_text", rotation="sample_text", value="sample_text", verticalAlignment="sample_text")
...
def test_mm_styles_Style_angle_value_roundtrip():
    instance = mm_styles_Style(angle="sample_text", description="sample_text", horizontalAlignment="sample_text", id="sample_text", proportional="sample_text", rotation="sample_text", stretchH="sample_text", stretchV="sample_text", verticalAlignment="sample_text")
    assert instance.angle == "sample_text"
    instance.angle = "sample_text_2"
    assert instance.angle == "sample_text_2"
...
def test_mm_styles_Style_rotation_value_roundtrip():
    instance = mm_styles_Style(angle="sample_text", description="sample_text", horizontalAlignment="sample_text", id="sample_text", proportional="sample_text", rotation="sample_text", stretchH="sample_text", stretchV="sample_text", verticalAlignment="sample_text")
    assert instance.rotation == "sample_text"
    instance.rotation = "sample_text_2"
    assert instance.rotation == "sample_text_2"
...
def test_assoc_adaptedGradientColoredAreas69_link_reassign_clear():
...
def test_assoc_background55_link_reassign_clear():
    ...
    if hasattr(b1, 'styles_Color56'):
        assert _is_linked(b1, 'styles_Color56', a)
    _safe_set(a, 'mm_styles_AbstractStyle', b2)
    assert _is_linked(a, 'mm_styles_AbstractStyle', b2)
    if hasattr(b1, 'styles_Color56'):
        assert not _is_linked(b1, 'styles_Color56', a)
    if hasattr(b2, 'styles_Color56'):
        assert _is_linked(b2, 'styles_Color56', a)
    _safe_set(a, 'mm_styles_AbstractStyle', None)
    assert not _is_linked(a, 'mm_styles_AbstractStyle', b2)
    if hasattr(b2, 'styles_Color56'):
        assert not _is_linked(b2, 'styles_Color56', a)


def test_assoc_background75_link_reassign_clear():
    a = mm_styles_TextStyle(strikeout=True, underline=True, underlineStyle="sample_text")
    b1 = styles_Color()
    b2 = styles_Color()
    _safe_set(a, 'mm_styles_TextStyle76', b1)
    assert _is_linked(a, 'mm_styles_TextStyle76', b1)
    if hasattr(b1, 'styles_Color77'):
        assert _is_linked(b1, 'styles_Color77', a)
    _safe_set(a, 'mm_styles_TextStyle76', b2)
    assert _is_linked(a, 'mm_styles_TextStyle76', b2)
    if hasattr(b1, 'styles_Color77'):
        assert not _is_linked(b1, 'styles_Color77', a)
    if hasattr(b2, 'styles_Color77'):
        assert _is_linked(b2, 'styles_Color77', a)
    _safe_set(a, 'mm_styles_TextStyle76', None)
    assert not _is_linked(a, 'mm_styles_TextStyle76', b2)
    if hasattr(b2, 'styles_Color77'):
        assert not _is_linked(b2, 'styles_Color77', a)


def test_assoc_color62_link_reassign_clear():
...
def test_assoc_font47_link_reassign_clear():
    a = mm_algorithms_AbstractText(angle="sample_text", horizontalAlignment="sample_text", rotation="sample_text", value="sample_text", verticalAlignment="sample_text")
    b1 = styles_Font()
    b2 = styles_Font()
...
def test_assoc_font52_link_reassign_clear():
    a = mm_styles_Style(angle="sample_text", description="sample_text", horizontalAlignment="sample_text", id="sample_text", proportional="sample_text", rotation="sample_text", stretchH="sample_text", stretchV="sample_text", verticalAlignment="sample_text")
    b1 = styles_Font()
    b2 = styles_Font()
    _safe_set(a, 'mm_styles_Style', b1)
    assert _is_linked(a, 'mm_styles_Style', b1)
    if hasattr(b1, 'styles_Font53'):
        assert _is_linked(b1, 'styles_Font53', a)
    _safe_set(a, 'mm_styles_Style', b2)
    assert _is_linked(a, 'mm_styles_Style', b2)
    if hasattr(b1, 'styles_Font53'):
        assert not _is_linked(b1, 'styles_Font53', a)
    if hasattr(b2, 'styles_Font53'):
        assert _is_linked(b2, 'styles_Font53', a)
    _safe_set(a, 'mm_styles_Style', None)
    assert not _is_linked(a, 'mm_styles_Style', b2)
    if hasattr(b2, 'styles_Font53'):
        assert not _is_linked(b2, 'styles_Font53', a)


def test_assoc_font70_link_reassign_clear():
    a = mm_styles_TextStyle(strikeout=True, underline=True, underlineStyle="sample_text")
    b1 = styles_Font()
    b2 = styles_Font()
    _safe_set(a, 'mm_styles_TextStyle', b1)
    assert _is_linked(a, 'mm_styles_TextStyle', b1)
    if hasattr(b1, 'styles_Font71'):
        assert _is_linked(b1, 'styles_Font71', a)
    _safe_set(a, 'mm_styles_TextStyle', b2)
    assert _is_linked(a, 'mm_styles_TextStyle', b2)
    if hasattr(b1, 'styles_Font71'):
        assert not _is_linked(b1, 'styles_Font71', a)
    if hasattr(b2, 'styles_Font71'):
        assert _is_linked(b2, 'styles_Font71', a)
    _safe_set(a, 'mm_styles_TextStyle', None)
    assert not _is_linked(a, 'mm_styles_TextStyle', b2)
    if hasattr(b2, 'styles_Font71'):
        assert not _is_linked(b2, 'styles_Font71', a)
...
def test_assoc_foreground57_link_reassign_clear():
    a = mm_styles_AbstractStyle(filled="sample_text", lineStyle="sample_text", lineVisible="sample_text", lineWidth="sample_text", transparency="sample_text")
    b1 = styles_Color()
    b2 = styles_Color()
    _safe_set(a, 'mm_styles_AbstractStyle58', b1)
    assert _is_linked(a, 'mm_styles_AbstractStyle58', b1)
    if hasattr(b1, 'styles_Color59'):
        assert _is_linked(b1, 'styles_Color59', a)
    _safe_set(a, 'mm_styles_AbstractStyle58', b2)
    assert _is_linked(a, 'mm_styles_AbstractStyle58', b2)
    if hasattr(b1, 'styles_Color59'):
        assert not _is_linked(b1, 'styles_Color59', a)
    if hasattr(b2, 'styles_Color59'):
        assert _is_linked(b2, 'styles_Color59', a)
    _safe_set(a, 'mm_styles_AbstractStyle58', None)
    assert not _is_linked(a, 'mm_styles_AbstractStyle58', b2)
    if hasattr(b2, 'styles_Color59'):
        assert not _is_linked(b2, 'styles_Color59', a)


def test_assoc_foreground72_link_reassign_clear():
    a = mm_styles_TextStyle(strikeout=True, underline=True, underlineStyle="sample_text")
    b1 = styles_Color()
    b2 = styles_Color()
    _safe_set(a, 'mm_styles_TextStyle73', b1)
    assert _is_linked(a, 'mm_styles_TextStyle73', b1)
    if hasattr(b1, 'styles_Color74'):
        assert _is_linked(b1, 'styles_Color74', a)
    _safe_set(a, 'mm_styles_TextStyle73', b2)
    assert _is_linked(a, 'mm_styles_TextStyle73', b2)
    if hasattr(b1, 'styles_Color74'):
        assert not _is_linked(b1, 'styles_Color74', a)
    if hasattr(b2, 'styles_Color74'):
        assert _is_linked(b2, 'styles_Color74', a)
    _safe_set(a, 'mm_styles_TextStyle73', None)
    assert not _is_linked(a, 'mm_styles_TextStyle73', b2)
    if hasattr(b2, 'styles_Color74'):
        assert not _is_linked(b2, 'styles_Color74', a)


def test_assoc_gradientColor68_link_reassign_clear():
...
def test_assoc_renderingStyle60_link_reassign_clear():
    a = mm_styles_AbstractStyle(filled="sample_text", lineStyle="sample_text", lineVisible="sample_text", lineWidth="sample_text", transparency="sample_text")
    b1 = styles_RenderingStyle()
    b2 = styles_RenderingStyle()
    _safe_set(a, 'mm_styles_AbstractStyle61', b1)
    assert _is_linked(a, 'mm_styles_AbstractStyle61', b1)
    if hasattr(b1, 'styles_RenderingStyle'):
        assert _is_linked(b1, 'styles_RenderingStyle', a)
    _safe_set(a, 'mm_styles_AbstractStyle61', b2)
    assert _is_linked(a, 'mm_styles_AbstractStyle61', b2)
    if hasattr(b1, 'styles_RenderingStyle'):
    ...
    _safe_set(a, 'mm_styles_AbstractStyle61', None)
    assert not _is_linked(a, 'mm_styles_AbstractStyle61', b2)
    if hasattr(b2, 'styles_RenderingStyle'):
        assert not _is_linked(b2, 'styles_RenderingStyle', a)


def test_assoc_strikeoutColor81_link_reassign_clear():
    a = mm_styles_TextStyle(strikeout=True, underline=True, underlineStyle="sample_text")
    b1 = styles_Color()
    b2 = styles_Color()
    _safe_set(a, 'mm_styles_TextStyle82', b1)
    assert _is_linked(a, 'mm_styles_TextStyle82', b1)
    if hasattr(b1, 'styles_Color83'):
        assert _is_linked(b1, 'styles_Color83', a)
    _safe_set(a, 'mm_styles_TextStyle82', b2)
    assert _is_linked(a, 'mm_styles_TextStyle82', b2)
    if hasattr(b1, 'styles_Color83'):
        assert not _is_linked(b1, 'styles_Color83', a)
    if hasattr(b2, 'styles_Color83'):
        assert _is_linked(b2, 'styles_Color83', a)
    _safe_set(a, 'mm_styles_TextStyle82', None)
    assert not _is_linked(a, 'mm_styles_TextStyle82', b2)
    if hasattr(b2, 'styles_Color83'):
        assert not _is_linked(b2, 'styles_Color83', a)
...
def test_assoc_style84_link_reassign_clear():
...
def test_assoc_styleContainer54_link_reassign_clear():
    a = mm_styles_Style(angle="sample_text", description="sample_text", horizontalAlignment="sample_text", id="sample_text", proportional="sample_text", rotation="sample_text", stretchH="sample_text", stretchV="sample_text", verticalAlignment="sample_text")
...
def test_assoc_styleRegions49_link_reassign_clear():
    a = mm_algorithms_AbstractText(angle="sample_text", horizontalAlignment="sample_text", rotation="sample_text", value="sample_text", verticalAlignment="sample_text")
    b1 = styles_TextStyleRegion()
    b2 = styles_TextStyleRegion()
    _safe_set(a, 'mm_algorithms_AbstractText50', {b1})
    assert _is_linked(a, 'mm_algorithms_AbstractText50', b1)
    if hasattr(b1, 'styles_TextStyleRegion'):
        assert _is_linked(b1, 'styles_TextStyleRegion', a)
    _safe_set(a, 'mm_algorithms_AbstractText50', {b2})
    assert _is_linked(a, 'mm_algorithms_AbstractText50', b2)
    if hasattr(b1, 'styles_TextStyleRegion'):
    ...
    _safe_set(a, 'mm_algorithms_AbstractText50', set())
    assert not _is_linked(a, 'mm_algorithms_AbstractText50', b2)
    if hasattr(b2, 'styles_TextStyleRegion'):
        assert not _is_linked(b2, 'styles_TextStyleRegion', a)


def test_assoc_underlineColor78_link_reassign_clear():
    a = mm_styles_TextStyle(strikeout=True, underline=True, underlineStyle="sample_text")
    b1 = styles_Color()
    b2 = styles_Color()
    _safe_set(a, 'mm_styles_TextStyle79', b1)
    assert _is_linked(a, 'mm_styles_TextStyle79', b1)
    if hasattr(b1, 'styles_Color80'):
        assert _is_linked(b1, 'styles_Color80', a)
    _safe_set(a, 'mm_styles_TextStyle79', b2)
    assert _is_linked(a, 'mm_styles_TextStyle79', b2)
    if hasattr(b1, 'styles_Color80'):
        assert not _is_linked(b1, 'styles_Color80', a)
    if hasattr(b2, 'styles_Color80'):
        assert _is_linked(b2, 'styles_Color80', a)
    _safe_set(a, 'mm_styles_TextStyle79', None)
    assert not _is_linked(a, 'mm_styles_TextStyle79', b2)
    if hasattr(b2, 'styles_Color80'):
        assert not _is_linked(b2, 'styles_Color80', a)
...
mm_algorithms_AbstractText_strategy = st.builds(mm_algorithms_AbstractText, angle=safe_text, horizontalAlignment=safe_text, rotation=safe_text, value=safe_text, verticalAlignment=safe_text)
@given(instance=mm_algorithms_AbstractText_strategy)
@settings(max_examples=25)
...
mm_styles_Style_strategy = st.builds(mm_styles_Style, angle=safe_text, description=safe_text, horizontalAlignment=safe_text, id=safe_text, proportional=safe_text, rotation=safe_text, stretchH=safe_text, stretchV=safe_text, verticalAlignment=safe_text)
@given(instance=mm_styles_Style_strategy)
@settings(max_examples=25)
