...
class Property:
    ...
    def __init__(self, address: str, location: str, property_id: str, property_type: str, owner4: "Seller" = None, user8: "Buyer" = None, management12: set["Management"] = None, payment17: "Payment" = None):
        self.address = address
        self.location = location
        self.property_id = property_id
