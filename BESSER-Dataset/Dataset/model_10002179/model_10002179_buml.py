...
Feedback_cashondelivery: Property = Property(name="cashondelivery", type=IntegerType)
Feedback_debitcard: Property = Property(name="debitcard", type=IntegerType)
Feedback_creditcard: Property = Property(name="creditcard", type=IntegerType)
Feedback.attributes={Feedback_creditcard, Feedback_cashondelivery, Feedback_debitcard}
...
Cancelorder.attributes={Cancelorder_item}
...
Customer.attributes={Customer_address, Customer_mailid, Customer_id, Customer_name}
...
Warehouse_Shipment: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="shipment26", type=Shipment, multiplicity=Multiplicity(0, 9999)),
        Property(name="warehouse27", type=Warehouse, multiplicity=Multiplicity(1, 9999))
    }
)
Product_Warehouse: BinaryAssociation = BinaryAssociation(
    name="Product_Warehouse",
    ends={
        Property(name="warehouse28", type=Warehouse, multiplicity=Multiplicity(1, 9999)),
        Property(name="product29", type=Product, multiplicity=Multiplicity(0, 9999))
    }
)

# Domain Model
domain_model = DomainModel(
    name="_ufhgYO3vEemVV_B95cpSSw",
    types={Order, Product, Warehouse, Feedback, Shipment, Cancelorder, CUSTOMER_Actor, VISITS_THE_WEBSITE_UseCase, CREATES_THE_WEBSITE_UseCase, SELECTS_THE_ITEMS_SERVICE_UseCase, ADDS_ITEMS_SERVICE_TO_CART_UseCase, SELECTS_THE_MODE_OF_PAYMENT_UseCase, PAYS_THE_BILL_UseCase, DELIVERS_THE_PRODUCT_UseCase, SUPPORT_AND_FEEDBACK_UseCase, WEB_DEVELOPER_Actor, ADMINISTRATOR_Actor, MAINTAINS_THE_PRODUCTS_SERVICES_UseCase, Customer},
    associations={CREATES_THE_WEBSITE_WEB_DEVELOPER, CUSTOMER_VISITS_THE_WEBSITE, CUSTOMER_SELECTS_THE_ITEMS_SERVICE, CUSTOMER_ADDS_ITEMS_SERVICE_TO_CART, CUSTOMER_SELECTS_THE_MODE_OF_PAYMENT, CUSTOMER_PAYS_THE_BILL, CUSTOMER_SUPPORT_AND_FEEDBACK, SELECTS_THE_MODE_OF_PAYMENT_ADMINISTRATOR, PAYS_THE_BILL_ADMINISTRATOR, DELIVERS_THE_PRODUCT_ADMINISTRATOR, MAINTAINS_THE_PRODUCTS_SERVICES_ADMINISTRATOR, SUPPORT_AND_FEEDBACK_ADMINISTRATOR, ORDER_PRODUCT, Warehouse_Shipment, Product_Warehouse},
    generalizations={},
    metadata=None
)
