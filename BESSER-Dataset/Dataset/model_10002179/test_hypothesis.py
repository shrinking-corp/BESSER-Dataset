...
def test_feedback_has_creditcard():
    assert hasattr(Feedback, "creditcard")
    descriptor = None
...
def test_feedback_has_cashondelivery():
    assert hasattr(Feedback, "cashondelivery")
    descriptor = None
    for klass in Feedback.__mro__:
...
def test_feedback_has_debitcard():
    assert hasattr(Feedback, "debitcard")
    descriptor = None
    for klass in Feedback.__mro__:
...
@given(instance=Feedback_strategy)
def test_feedback_creditcard_setter(instance):
...
@given(instance=Feedback_strategy)
def test_feedback_cashondelivery_setter(instance):
...
@given(instance=Feedback_strategy)
def test_feedback_debitcard_setter(instance):
