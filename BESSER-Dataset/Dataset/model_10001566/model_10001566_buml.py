...
User.attributes={User_Email, User_DepartmentID, User_Firstname, User_Position, User_TitleID, User_Linkedin_link, User_About, User_Hiredate, User_Phone, User_Google_plus_link, User_Lastname, User_Password, User_Dateofbirth, User_Username, User_UserID, User_Active, User_Facebook_link, User_Settings, User_Roles___}
...
Project.attributes={Project_PorjectID, Project_Author, Project_Description, Project_Title, Project_Subscriptions___, Project_Deadline, Project_Activities___, Project_PriorityID, Project_Attachments___, Project_Assignee, Project_Team___, Project_ProjectManager, Project_Comments___, Project_Created, Project_StatusID}
...
Activity.attributes={Activity_Seen, Activity_ActivityType, Activity_NewValue, Activity_User, Activity_ActivitySubType, Activity_PrevValue, Activity_ActivityID, Activity_Project}
...
Comment.attributes={Comment_Created, Comment_CommentID, Comment_Content, Comment_Project, Comment_User}
...
Attachment.attributes={Attachment_Path, Attachment_Name, Attachment_Size, Attachment_AttachmentID, Attachment_Project, Attachment_Created, Attachment_Extension, Attachment_User}
