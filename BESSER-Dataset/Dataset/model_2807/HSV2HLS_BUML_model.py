...
# Classes
HSV2HLS_HSVNode = Class(name="HSV2HLS_HSVNode")
HSV2HLS_HLSNode = Class(name="HSV2HLS_HLSNode")
HSV2HLS_HSVNode2HLSNode = Class(name="HSV2HLS_HSVNode2HLSNode")
...
HSV2HLS_HSVNode2HLSNode.attributes={HSV2HLS_HSVNode2HLSNode_name, HSV2HLS_HSVNode2HLSNode_rgb}
...
domain_model = DomainModel(
    name="HSV2HLS",
    types={HSV2HLS_HSVNode, HSV2HLS_HLSNode, HSV2HLS_HSVNode2HLSNode},
    associations={children3, hsv5, hls6, parent1},
    generalizations={},
    metadata=None
)
