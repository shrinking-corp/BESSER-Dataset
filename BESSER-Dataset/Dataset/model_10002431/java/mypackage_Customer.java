...
public class mypackage_Customer  {
    ...
    public mypackage_Customer(
        LocalDate dateOfBirth,        String name,        String address,        String phoneNumber,        String emailAddress    ) {
    ...
    public mypackage_Customer(
        LocalDate dateOfBirth,        String name,        String address,        String phoneNumber,        String emailAddress        ArrayList<account_Account> account_accounts    ) {
        this.dateOfBirth = dateOfBirth;
        this.name = name;
        this.address = address;
        this.phoneNumber = phoneNumber;
