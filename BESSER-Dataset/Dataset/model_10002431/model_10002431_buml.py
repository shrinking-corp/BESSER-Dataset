...
transaction_Transaction.attributes={transaction_Transaction_type, transaction_Transaction_transactionTime, transaction_Transaction_id, transaction_Transaction_amount}
...
mypackage_Login.attributes={mypackage_Login_lastLoginTime, mypackage_Login_username, mypackage_Login_password, mypackage_Login_securityAnswer, mypackage_Login_securityQuestion}
...
mypackage_Customer.attributes={mypackage_Customer_dateOfBirth, mypackage_Customer_address, mypackage_Customer_emailAddress, mypackage_Customer_name, mypackage_Customer_phoneNumber}
...
domain_model = DomainModel(
    name="b29deb5b_ea79_4a19_a7c9_5cf1d86ea279",
