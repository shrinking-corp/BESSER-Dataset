...
public class jpdl31_ProcessDefinitionType  {
    ...
    public jpdl31_ProcessDefinitionType(
        String quantity,        String name,        String group    ) {
    ...
    public jpdl31_ProcessDefinitionType(
        String quantity,        String name,        String group        ArrayList<jpdl31_ExceptionHandlerType> jpdl31_exceptionhandlertypes,        ArrayList<jpdl31_DecisionType> jpdl31_decisiontypes,        ArrayList<jpdl31_CreateTimerType> jpdl31_createtimertypes,        ArrayList<jpdl31_NodeType> jpdl31_nodetypes,        ArrayList<jpdl31_ScriptType> jpdl31_scripttypes,        ArrayList<jpdl31_CancelTimerType> jpdl31_canceltimertypes,        ArrayList<jpdl31_EventType> jpdl31_eventtypes,        ArrayList<jpdl31_ActionType> jpdl31_actiontypes,        ArrayList<jpdl31_ForkType> jpdl31_forktypes,        ArrayList<jpdl31_EndStateType> jpdl31_endstatetypes    ) {
        this.quantity = quantity;
        this.name = name;
        this.group = group;
