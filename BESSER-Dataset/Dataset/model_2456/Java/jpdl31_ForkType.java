...
public class jpdl31_ForkType  {
    ...
    public jpdl31_ForkType(
        String group,        String name,        String async_        ArrayList<jpdl31_EventType> jpdl31_eventtypes,        ArrayList<jpdl31_ScriptType> jpdl31_scripttypes,        ArrayList<jpdl31_ExceptionHandlerType> jpdl31_exceptionhandlertypes    ) {
        this.group = group;
        this.name = name;
        this.async_ = async_;
