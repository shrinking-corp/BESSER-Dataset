...
public class jpdl31_TransitionType  {
    ...
    public jpdl31_TransitionType(
        String group,        String name,        String to        ArrayList<jpdl31_CreateTimerType> jpdl31_createtimertypes,        ArrayList<jpdl31_CancelTimerType> jpdl31_canceltimertypes,        ArrayList<jpdl31_ActionType> jpdl31_actiontypes,        ArrayList<jpdl31_ScriptType> jpdl31_scripttypes,        ArrayList<jpdl31_ExceptionHandlerType> jpdl31_exceptionhandlertypes    ) {
        this.group = group;
        this.name = name;
        this.to = to;
