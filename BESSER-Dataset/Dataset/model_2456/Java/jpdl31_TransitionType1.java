...
public class jpdl31_TransitionType1  {
    ...
    public jpdl31_TransitionType1(
        String name,        String to,        String group    ) {
        this.name = name;
        this.to = to;
        this.group = group;
    ...
    public jpdl31_TransitionType1(
        String name,        String to,        String group        ArrayList<jpdl31_ActionType> jpdl31_actiontypes,        ArrayList<jpdl31_CreateTimerType> jpdl31_createtimertypes,        ArrayList<jpdl31_ConditionType> jpdl31_conditiontypes,        ArrayList<jpdl31_ScriptType> jpdl31_scripttypes,        ArrayList<jpdl31_ExceptionHandlerType> jpdl31_exceptionhandlertypes,        ArrayList<jpdl31_CancelTimerType> jpdl31_canceltimertypes    ) {
        this.name = name;
        this.to = to;
        this.group = group;
