...
public class jpdl31_ProcessStateType  {
    ...
    public jpdl31_ProcessStateType(
        String group,        String name,        String async_        ArrayList<jpdl31_ExceptionHandlerType> jpdl31_exceptionhandlertypes,        ArrayList<jpdl31_EventType> jpdl31_eventtypes    ) {
        this.group = group;
        this.name = name;
        this.async_ = async_;
