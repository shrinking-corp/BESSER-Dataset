...
public class jpdl31_DocumentRoot  {
    ...
    public jpdl31_DocumentRoot(
        String mixed        ArrayList<jpdl31_ExceptionHandlerType> jpdl31_exceptionhandlertypes,        ArrayList<jpdl31_Delegation> jpdl31_delegations,        ArrayList<jpdl31_AssignmentType> jpdl31_assignmenttypes,        ArrayList<jpdl31_EventType> jpdl31_eventtypes,        ArrayList<jpdl31_CreateTimerType> jpdl31_createtimertypes,        ArrayList<jpdl31_ActionType> jpdl31_actiontypes,        ArrayList<jpdl31_CancelTimerType> jpdl31_canceltimertypes,        ArrayList<jpdl31_DecisionType> jpdl31_decisiontypes,        ArrayList<jpdl31_ScriptType> jpdl31_scripttypes    ) {
        this.mixed = mixed;
