...
# Classes
research101_PublicationProcess = Class(name="research101_PublicationProcess")
Named = Class(name="Named")
research101_Phase = Class(name="research101_Phase")
research101_Researcher = Class(name="research101_Researcher")
research101_Write = Class(name="research101_Write")
research101_Review = Class(name="research101_Review")
research101_Paper = Class(name="research101_Paper")
research101_Skill = Class(name="research101_Skill")
research101_Position = Class(name="research101_Position")
research101_Collaboration = Class(name="research101_Collaboration")
research101_Paragraph = Class(name="research101_Paragraph")
research101_Progress = Class(name="research101_Progress")
research101_PaperKeyword = Class(name="research101_PaperKeyword")
Counted = Class(name="Counted")
research101_ReviewNote = Class(name="research101_ReviewNote")
Labelled = Class(name="Labelled")
research101_PublicationStructure = Class(name="research101_PublicationStructure")
research101_KnowledgeManager = Class(name="research101_KnowledgeManager")
research101_PublicationSystem = Class(name="research101_PublicationSystem")
research101_Named = Class(name="research101_Named", is_abstract=True)
research101_Counted = Class(name="research101_Counted", is_abstract=True)
research101_Labelled = Class(name="research101_Labelled", is_abstract=True)
research101_Keyword = Class(name="research101_Keyword")
...
research101_PublicationProcess.attributes={research101_PublicationProcess_minTime, research101_PublicationProcess_maxTime}
...
domain_model = DomainModel(
    name="research101",
    types={research101_PublicationProcess, Named, research101_Phase, research101_Researcher, research101_Write, research101_Review, research101_Paper, research101_Skill, research101_Position, research101_Collaboration, research101_Paragraph, research101_Progress, research101_PaperKeyword, Counted, research101_ReviewNote, Labelled, research101_PublicationStructure, research101_KnowledgeManager, research101_PublicationSystem, research101_Named, research101_Counted, research101_Labelled, research101_Keyword},
    associations={phases0, writes1, reviews2, res_papers4, skills5, res_position7, collaborations9, paragraph25, paragraphs11, progress12, authors13, keywords14, citedBy17, reviews19, process21, paper23, reviewNote28, researchers31, papers33, knowledgeMan36, processView38, structuralView40, positions43, parent47, kpapers49, allkeywords51, keyword54, col_paper57},
    generalizations={gen_research101_Paper_Named, gen_research101_PublicationProcess_Named, gen_research101_Review_Labelled, gen_research101_Paragraph_Counted, gen_research101_Paragraph_Named, gen_research101_ReviewNote_Named, gen_research101_Progress_Labelled, gen_research101_Write_Labelled, gen_research101_Position_Named, gen_research101_PublicationStructure_Named, gen_research101_PublicationSystem_Named, gen_research101_Keyword_Named, gen_research101_KnowledgeManager_Named},
    metadata=None
)
