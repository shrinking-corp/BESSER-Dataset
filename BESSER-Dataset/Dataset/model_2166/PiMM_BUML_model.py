...
# Classes
pimm_AbstractActor = Class(name="pimm_AbstractActor", is_abstract=True)
AbstractVertex = Class(name="AbstractVertex")
pimm_DataInputPort = Class(name="pimm_DataInputPort")
pimm_DataOutputPort = Class(name="pimm_DataOutputPort")
pimm_ConfigOutputPort = Class(name="pimm_ConfigOutputPort")
pimm_PiGraph = Class(name="pimm_PiGraph")
AbstractActor = Class(name="AbstractActor")
pimm_Parameterizable = Class(name="pimm_Parameterizable", is_abstract=True)
PiMMVisitable = Class(name="PiMMVisitable")
pimm_ConfigInputPort = Class(name="pimm_ConfigInputPort")
pimm_AbstractVertex = Class(name="pimm_AbstractVertex", is_abstract=True)
Parameterizable = Class(name="Parameterizable")
pimm_Fifo = Class(name="pimm_Fifo")
pimm_Parameter = Class(name="pimm_Parameter")
pimm_Dependency = Class(name="pimm_Dependency")
pimm_Actor = Class(name="pimm_Actor")
ExecutableActor = Class(name="ExecutableActor")
pimm_Refinement = Class(name="pimm_Refinement")
pimm_Port = Class(name="pimm_Port", is_abstract=True)
DataPort = Class(name="DataPort")
Port = Class(name="Port")
DataOutputPort = Class(name="DataOutputPort")
ISetter = Class(name="ISetter")
pimm_DataInputInterface = Class(name="pimm_DataInputInterface")
InterfaceActor = Class(name="InterfaceActor")
pimm_DataOutputInterface = Class(name="pimm_DataOutputInterface")
pimm_ConfigInputInterface = Class(name="pimm_ConfigInputInterface")
Parameter_ = Class(name="Parameter")
pimm_ConfigOutputInterface = Class(name="pimm_ConfigOutputInterface")
pimm_Expression = Class(name="pimm_Expression")
pimm_ISetter = Class(name="pimm_ISetter", is_abstract=True)
pimm_Delay = Class(name="pimm_Delay")
pimm_InterfaceActor = Class(name="pimm_InterfaceActor")
pimm_FunctionPrototype = Class(name="pimm_FunctionPrototype")
pimm_FunctionParameter = Class(name="pimm_FunctionParameter")
pimm_DataPort = Class(name="pimm_DataPort", is_abstract=True)
pimm_BroadcastActor = Class(name="pimm_BroadcastActor")
pimm_JoinActor = Class(name="pimm_JoinActor")
pimm_ForkActor = Class(name="pimm_ForkActor")
pimm_RoundBufferActor = Class(name="pimm_RoundBufferActor")
pimm_ExecutableActor = Class(name="pimm_ExecutableActor", is_abstract=True)
pimm_visitor_PiMMVisitable = Class(name="pimm_visitor_PiMMVisitable", is_abstract=True)
pimm_visitor_PiMMVisitor = Class(name="pimm_visitor_PiMMVisitor", is_abstract=True)
pimm_HRefinement = Class(name="pimm_HRefinement")
...
pimm_PiGraph.methods={pimm_PiGraph_m_getVerticesNames, pimm_PiGraph_m_getParametersNames, pimm_PiGraph_m_getAllParameters, pimm_PiGraph_m_getActors}
...
pimm_Parameter.methods={pimm_Parameter_m_isLocallyStatic, pimm_Parameter_m_isDependent}
...
pimm_FunctionParameter.attributes={pimm_FunctionParameter_direction, pimm_FunctionParameter_name, pimm_FunctionParameter_type, pimm_FunctionParameter_isConfigurationParameter}
...
pimm_visitor_PiMMVisitable_m_accept: Method = Method(name="accept", parameters={Parameter(name='pimm_subject', type=StringType)})
...
pimm_visitor_PiMMVisitor_m_visit: Method = Method(name="visit", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitDelay: Method = Method(name="visitDelay", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitDependency: Method = Method(name="visitDependency", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitExpression: Method = Method(name="visitExpression", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitFifo: Method = Method(name="visitFifo", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitInterfaceActor: Method = Method(name="visitInterfaceActor", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitISetter: Method = Method(name="visitISetter", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitParameter: Method = Method(name="visitParameter", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitParameterizable: Method = Method(name="visitParameterizable", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitPiGraph: Method = Method(name="visitPiGraph", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitPort: Method = Method(name="visitPort", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitRefinement: Method = Method(name="visitRefinement", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitFunctionParameter: Method = Method(name="visitFunctionParameter", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitFunctionPrototype: Method = Method(name="visitFunctionPrototype", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitHRefinement: Method = Method(name="visitHRefinement", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitDataPort: Method = Method(name="visitDataPort", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitBroadcastActor: Method = Method(name="visitBroadcastActor", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitJoinActor: Method = Method(name="visitJoinActor", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitForkActor: Method = Method(name="visitForkActor", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitRoundBufferActor: Method = Method(name="visitRoundBufferActor", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitExecutableActor: Method = Method(name="visitExecutableActor", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitAbstractActor: Method = Method(name="visitAbstractActor", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitAbstractVertex: Method = Method(name="visitAbstractVertex", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitActor: Method = Method(name="visitActor", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitConfigInputInterface: Method = Method(name="visitConfigInputInterface", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitConfigInputPort: Method = Method(name="visitConfigInputPort", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitConfigOutputInterface: Method = Method(name="visitConfigOutputInterface", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitConfigOutputPort: Method = Method(name="visitConfigOutputPort", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitDataInputInterface: Method = Method(name="visitDataInputInterface", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitDataInputPort: Method = Method(name="visitDataInputPort", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitDataOutputInterface: Method = Method(name="visitDataOutputInterface", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor_m_visitDataOutputPort: Method = Method(name="visitDataOutputPort", parameters={Parameter(name='pimm_subject', type=StringType)})
pimm_visitor_PiMMVisitor.methods={pimm_visitor_PiMMVisitor_m_visitAbstractActor, pimm_visitor_PiMMVisitor_m_visitDataInputPort, pimm_visitor_PiMMVisitor_m_visitForkActor, pimm_visitor_PiMMVisitor_m_visitExecutableActor, pimm_visitor_PiMMVisitor_m_visitDataOutputPort, pimm_visitor_PiMMVisitor_m_visitActor, pimm_visitor_PiMMVisitor_m_visitDataInputInterface, pimm_visitor_PiMMVisitor_m_visitFifo, pimm_visitor_PiMMVisitor_m_visit, pimm_visitor_PiMMVisitor_m_visitFunctionParameter, pimm_visitor_PiMMVisitor_m_visitInterfaceActor, pimm_visitor_PiMMVisitor_m_visitConfigOutputInterface, pimm_visitor_PiMMVisitor_m_visitRoundBufferActor, pimm_visitor_PiMMVisitor_m_visitParameter, pimm_visitor_PiMMVisitor_m_visitConfigOutputPort, pimm_visitor_PiMMVisitor_m_visitISetter, pimm_visitor_PiMMVisitor_m_visitRefinement, pimm_visitor_PiMMVisitor_m_visitDataPort, pimm_visitor_PiMMVisitor_m_visitFunctionPrototype, pimm_visitor_PiMMVisitor_m_visitJoinActor, pimm_visitor_PiMMVisitor_m_visitConfigInputInterface, pimm_visitor_PiMMVisitor_m_visitDelay, pimm_visitor_PiMMVisitor_m_visitConfigInputPort, pimm_visitor_PiMMVisitor_m_visitAbstractVertex, pimm_visitor_PiMMVisitor_m_visitPiGraph, pimm_visitor_PiMMVisitor_m_visitDependency, pimm_visitor_PiMMVisitor_m_visitPort, pimm_visitor_PiMMVisitor_m_visitBroadcastActor, pimm_visitor_PiMMVisitor_m_visitHRefinement, pimm_visitor_PiMMVisitor_m_visitExpression, pimm_visitor_PiMMVisitor_m_visitDataOutputInterface, pimm_visitor_PiMMVisitor_m_visitParameterizable}
...
domain_model = DomainModel(
    name="pimm",
    types={pimm_AbstractActor, AbstractVertex, pimm_DataInputPort, pimm_DataOutputPort, pimm_ConfigOutputPort, pimm_PiGraph, AbstractActor, pimm_Parameterizable, PiMMVisitable, pimm_ConfigInputPort, pimm_AbstractVertex, Parameterizable, pimm_Fifo, pimm_Parameter, pimm_Dependency, pimm_Actor, ExecutableActor, pimm_Refinement, pimm_Port, DataPort, Port, DataOutputPort, ISetter, pimm_DataInputInterface, InterfaceActor, pimm_DataOutputInterface, pimm_ConfigInputInterface, Parameter_, pimm_ConfigOutputInterface, pimm_Expression, pimm_ISetter, pimm_Delay, pimm_InterfaceActor, pimm_FunctionPrototype, pimm_FunctionParameter, pimm_DataPort, pimm_BroadcastActor, pimm_JoinActor, pimm_ForkActor, pimm_RoundBufferActor, pimm_ExecutableActor, pimm_visitor_PiMMVisitable, pimm_visitor_PiMMVisitor, pimm_HRefinement, Refinement, Direction, PortMemoryAnnotation},
    associations={dataInputPorts1, dataOutputPorts2, configOutputPorts4, configInputPorts0, vertices6, fifos8, parameters10, dependencies12, refinement14, incomingFifo15, outgoingFifo16, incomingDependency18, graphPort23, graphPort24, expression27, setter29, getter30, sourcePort19, targetPort20, delay21, loopPrototype36, initPrototype37, parameters40, expression42, outgoingDependencies31, expression33},
    generalizations={gen_pimm_AbstractActor_AbstractVertex, gen_pimm_PiGraph_AbstractActor, gen_pimm_Parameterizable_PiMMVisitable, gen_pimm_AbstractVertex_Parameterizable, gen_pimm_Actor_ExecutableActor, gen_pimm_Port_PiMMVisitable, gen_pimm_DataInputPort_DataPort, gen_pimm_DataOutputPort_DataPort, gen_pimm_ConfigInputPort_Port, gen_pimm_ConfigOutputPort_DataOutputPort, gen_pimm_ConfigOutputPort_ISetter, gen_pimm_Fifo_PiMMVisitable, gen_pimm_InterfaceActor_AbstractActor, gen_pimm_DataInputInterface_InterfaceActor, gen_pimm_DataOutputInterface_InterfaceActor, gen_pimm_ConfigInputInterface_Parameter, gen_pimm_ConfigOutputInterface_InterfaceActor, gen_pimm_Refinement_PiMMVisitable, gen_pimm_Parameter_AbstractVertex, gen_pimm_Parameter_ISetter, gen_pimm_Dependency_PiMMVisitable, gen_pimm_FunctionPrototype_PiMMVisitable, gen_pimm_FunctionParameter_PiMMVisitable, gen_pimm_DataPort_Port, gen_pimm_BroadcastActor_ExecutableActor, gen_pimm_JoinActor_ExecutableActor, gen_pimm_ForkActor_ExecutableActor, gen_pimm_RoundBufferActor_ExecutableActor, gen_pimm_ExecutableActor_AbstractActor, gen_pimm_Delay_Parameterizable, gen_pimm_Expression_PiMMVisitable, gen_pimm_HRefinement_Refinement},
    metadata=None
)
