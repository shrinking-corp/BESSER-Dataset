...
class tables_ForeignKey:
    ...
    def __init__(self, name: str, tables_ForeignKey: "tables_Table" = None, foreign_key: "tables_Column" = None, ForeignKey: "tables_Column" = None):
        self.name = name
...
class tables_Column:
    ...
    def __init__(self, name: str, type: str, column: "tables_ForeignKey" = None, Column10: "tables_ForeignKey" = None, Column: "tables_Table" = None, tables_Column: "tables_Table" = None, columns: "tables_Table" = None):
        self.name = name
        self.type = type
        self.column = column
...
class tables_Table:
    ...
    def __init__(self, name: str, tables_Table8: "tables_ForeignKey" = None, Table: "tables_Database" = None, table: set["tables_Column"] = None, tables: "tables_Database" = None, tables_Table: "tables_Column" = None, Table5: "tables_Column" = None):
        self.name = name
