...
# Classes
tables_Database = Class(name="tables_Database")
tables_Table = Class(name="tables_Table")
tables_Column = Class(name="tables_Column")
tables_ForeignKey = Class(name="tables_ForeignKey")
...
tables_Column.attributes={tables_Column_type, tables_Column_name}
...
domain_model = DomainModel(
    ...
    associations={tables0, columns1, database2, primary_key3, table4, foreign_key6, target7, column9},
    generalizations={},
    metadata=None
)
