...
# Classes
tests_TestCategoryAllProperty = Class(name="tests_TestCategoryAllProperty")
DObject = Class(name="DObject")
tests_TestCategoryReference = Class(name="tests_TestCategoryReference")
tests_TestCategoryIntrinsicArray = Class(name="tests_TestCategoryIntrinsicArray")
tests_TestCategoryCompositionArray = Class(name="tests_TestCategoryCompositionArray")
tests_TestCategoryReferenceArray = Class(name="tests_TestCategoryReferenceArray")
tests_TestCategoryComposition = Class(name="tests_TestCategoryComposition")
tests_TestCategoryBeanA = Class(name="tests_TestCategoryBeanA")
tests_EReferenceTest = Class(name="tests_EReferenceTest")
tests_TestCategoryBeanB = Class(name="tests_TestCategoryBeanB")
tests_ExternalTestType = Class(name="tests_ExternalTestType")
tests_TestCategoryBeanAbstract = Class(name="tests_TestCategoryBeanAbstract", is_abstract=True)
tests_TestCategoryBeanConcrete = Class(name="tests_TestCategoryBeanConcrete")
dmf_DObject = Class(name="dmf_DObject")
TestCategoryBeanAbstract = Class(name="TestCategoryBeanAbstract")
tests_TestCategoryBase = Class(name="tests_TestCategoryBase")
tests_TestCategoryExtends = Class(name="tests_TestCategoryExtends")
TestCategoryBase = Class(name="TestCategoryBase")
tests_TestParameter = Class(name="tests_TestParameter")
tests_TestMassParameters = Class(name="tests_TestMassParameters")
tests_TestCrossLinkedParametersWithCalculation = Class(name="tests_TestCrossLinkedParametersWithCalculation")
...
tests_TestCategoryAllProperty.attributes={tests_TestCategoryAllProperty_testResource, tests_TestCategoryAllProperty_testInt, tests_TestCategoryAllProperty_testEnum, tests_TestCategoryAllProperty_testString, tests_TestCategoryAllProperty_testFloat, tests_TestCategoryAllProperty_testBool}
...
tests_TestCategoryIntrinsicArray.attributes={tests_TestCategoryIntrinsicArray_testStringArrayDynamic, tests_TestCategoryIntrinsicArray_testStringArrayStatic}
...
domain_model = DomainModel(
    name="tests",
    types={tests_TestCategoryAllProperty, DObject, tests_TestCategoryReference, tests_TestCategoryIntrinsicArray, tests_TestCategoryCompositionArray, tests_TestCategoryReferenceArray, tests_TestCategoryComposition, tests_TestCategoryBeanA, tests_EReferenceTest, tests_TestCategoryBeanB, tests_ExternalTestType, tests_TestCategoryBeanAbstract, tests_TestCategoryBeanConcrete, dmf_DObject, TestCategoryBeanAbstract, tests_TestCategoryBase, tests_TestCategoryExtends, TestCategoryBase, tests_TestParameter, tests_TestMassParameters, tests_TestCrossLinkedParametersWithCalculation, EnumTestEnum},
    associations={testSubCategory0, testRefCategory1, testCompositionArrayDynamic3, testCompositionArrayStatic5, eReferenceTest19, testArray14, testReference16, testCategoryReferenceArrayDynamic8, mass18, testCategoryReferenceArrayStatic10},
    generalizations={gen_tests_TestCategoryAllProperty_DObject, gen_tests_TestCategoryReference_DObject, gen_tests_TestCategoryIntrinsicArray_DObject, gen_tests_TestCategoryCompositionArray_DObject, gen_tests_TestCategoryReferenceArray_DObject, gen_tests_TestCategoryComposition_DObject, gen_tests_TestCategoryBeanA_DObject, gen_tests_EReferenceTest_DObject, gen_tests_TestCategoryBeanB_DObject, gen_tests_TestCategoryBeanAbstract_DObject, gen_tests_TestCategoryBeanConcrete_dmf_DObject, gen_tests_TestCategoryBeanConcrete_TestCategoryBeanAbstract, gen_tests_TestCategoryBase_DObject, gen_tests_TestCategoryExtends_dmf_DObject, gen_tests_TestCategoryExtends_TestCategoryBase, gen_tests_TestParameter_DObject, gen_tests_TestMassParameters_DObject, gen_tests_TestCrossLinkedParametersWithCalculation_DObject},
    metadata=None
)
