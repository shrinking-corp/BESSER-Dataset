...
# Classes
SQL2003_V2_ARRAY = Class(name="SQL2003_V2_ARRAY")
CollectionType = Class(name="CollectionType")
SQL2003_V2_Attribute = Class(name="SQL2003_V2_Attribute")
StructuralComponent = Class(name="StructuralComponent")
SQL2003_V2_StructuredType = Class(name="SQL2003_V2_StructuredType")
SQL2003_V2_BaseTable = Class(name="SQL2003_V2_BaseTable")
Table = Class(name="Table")
SQL2003_V2_BehaviouralComponent = Class(name="SQL2003_V2_BehaviouralComponent", is_abstract=True)
SQL2003_V2_Schema = Class(name="SQL2003_V2_Schema")
SQL2003_V2_ParameterWithMode = Class(name="SQL2003_V2_ParameterWithMode")
SQL2003_V2_BinaryStringType = Class(name="SQL2003_V2_BinaryStringType")
PredefinedType = Class(name="PredefinedType")
SQL2003_V2_BooleanType = Class(name="SQL2003_V2_BooleanType")
SQL2003_V2_CharacterStringType = Class(name="SQL2003_V2_CharacterStringType")
SQL2003_V2_CollectionType = Class(name="SQL2003_V2_CollectionType", is_abstract=True)
ConstructedType = Class(name="ConstructedType")
SQL2003_V2_DataType = Class(name="SQL2003_V2_DataType", is_abstract=True)
SQL2003_V2_Column = Class(name="SQL2003_V2_Column")
SQL2003_V2_Table = Class(name="SQL2003_V2_Table", is_abstract=True)
SQL2003_V2_ColumnConstraint = Class(name="SQL2003_V2_ColumnConstraint", is_abstract=True)
Restriction = Class(name="Restriction")
SQL2003_V2_DatetimeFeature = Class(name="SQL2003_V2_DatetimeFeature")
Feature = Class(name="Feature")
SQL2003_V2_DatetimeType = Class(name="SQL2003_V2_DatetimeType")
SQL2003_V2_ConstructedType = Class(name="SQL2003_V2_ConstructedType", is_abstract=True)
DataType = Class(name="DataType")
SQL2003_V2_DerivedTable = Class(name="SQL2003_V2_DerivedTable")
SQL2003_V2_DistinctType = Class(name="SQL2003_V2_DistinctType")
UserDefinedType = Class(name="UserDefinedType")
SQL2003_V2_PredefinedType = Class(name="SQL2003_V2_PredefinedType", is_abstract=True)
SQL2003_V2_Feature = Class(name="SQL2003_V2_Feature", is_abstract=True)
SQL2003_V2_Field = Class(name="SQL2003_V2_Field")
SQL2003_V2_ROW = Class(name="SQL2003_V2_ROW")
SQL2003_V2_Function = Class(name="SQL2003_V2_Function")
BehaviouralComponent = Class(name="BehaviouralComponent")
SQL2003_V2_IntervalFeature = Class(name="SQL2003_V2_IntervalFeature")
SQL2003_V2_IntervalType = Class(name="SQL2003_V2_IntervalType")
SQL2003_V2_MULTISET = Class(name="SQL2003_V2_MULTISET")
SQL2003_V2_Method = Class(name="SQL2003_V2_Method")
SQL2003_V2_MethodParameter = Class(name="SQL2003_V2_MethodParameter")
Parameter_ = Class(name="Parameter")
SQL2003_V2_NotNull = Class(name="SQL2003_V2_NotNull")
ColumnConstraint = Class(name="ColumnConstraint")
SQL2003_V2_NumericFeature = Class(name="SQL2003_V2_NumericFeature")
SQL2003_V2_NumericType = Class(name="SQL2003_V2_NumericType")
SQL2003_V2_Parameter = Class(name="SQL2003_V2_Parameter", is_abstract=True)
SQL2003_V2_PrimaryKey = Class(name="SQL2003_V2_PrimaryKey")
UniqueConstraint = Class(name="UniqueConstraint")
SQL2003_V2_Procedure = Class(name="SQL2003_V2_Procedure")
SQL2003_V2_ReferenceType = Class(name="SQL2003_V2_ReferenceType")
SQL2003_V2_ReferentialConstraint = Class(name="SQL2003_V2_ReferentialConstraint")
TableConstraint = Class(name="TableConstraint")
SQL2003_V2_UniqueConstraint = Class(name="SQL2003_V2_UniqueConstraint")
SQL2003_V2_Restriction = Class(name="SQL2003_V2_Restriction", is_abstract=True)
SQL2003_V2_StructuralComponent = Class(name="SQL2003_V2_StructuralComponent", is_abstract=True)
SQL2003_V2_Domain = Class(name="SQL2003_V2_Domain")
SQL2003_V2_StringFeature = Class(name="SQL2003_V2_StringFeature")
SQL2003_V2_View = Class(name="SQL2003_V2_View")
SQL2003_V2_TypedTable = Class(name="SQL2003_V2_TypedTable")
SQL2003_V2_TableConstraint = Class(name="SQL2003_V2_TableConstraint", is_abstract=True)
SQL2003_V2_Trigger = Class(name="SQL2003_V2_Trigger")
SQL2003_V2_TriggerDescriptor = Class(name="SQL2003_V2_TriggerDescriptor")
SQL2003_V2_TableCheckConstraint = Class(name="SQL2003_V2_TableCheckConstraint")
SQL2003_V2_UserDefinedType = Class(name="SQL2003_V2_UserDefinedType", is_abstract=True)
BaseTable = Class(name="BaseTable")
SQL2003_V2_XMLType = Class(name="SQL2003_V2_XMLType")
...
SQL2003_V2_BehaviouralComponent.attributes={SQL2003_V2_BehaviouralComponent_body, SQL2003_V2_BehaviouralComponent_name}
...
SQL2003_V2_CharacterStringType.attributes={SQL2003_V2_CharacterStringType_descriptor, SQL2003_V2_CharacterStringType_length_def}
...
SQL2003_V2_ReferentialConstraint.attributes={SQL2003_V2_ReferentialConstraint_delete_action, SQL2003_V2_ReferentialConstraint_match, SQL2003_V2_ReferentialConstraint_update_action}
...
SQL2003_V2_Domain.attributes={SQL2003_V2_Domain_name, SQL2003_V2_Domain_default, SQL2003_V2_Domain_expression}
...
SQL2003_V2_StringFeature.attributes={SQL2003_V2_StringFeature_value, SQL2003_V2_StringFeature_key}
...
SQL2003_V2_TriggerDescriptor.attributes={SQL2003_V2_TriggerDescriptor_actionTime, SQL2003_V2_TriggerDescriptor_level, SQL2003_V2_TriggerDescriptor_triggeredAction, SQL2003_V2_TriggerDescriptor_event}
...
domain_model = DomainModel(
    name="SQL2003_V2",
    types={SQL2003_V2_ARRAY, CollectionType, SQL2003_V2_Attribute, StructuralComponent, SQL2003_V2_StructuredType, SQL2003_V2_BaseTable, Table, SQL2003_V2_BehaviouralComponent, SQL2003_V2_Schema, SQL2003_V2_ParameterWithMode, SQL2003_V2_BinaryStringType, PredefinedType, SQL2003_V2_BooleanType, SQL2003_V2_CharacterStringType, SQL2003_V2_CollectionType, ConstructedType, SQL2003_V2_DataType, SQL2003_V2_Column, SQL2003_V2_Table, SQL2003_V2_ColumnConstraint, Restriction, SQL2003_V2_DatetimeFeature, Feature, SQL2003_V2_DatetimeType, SQL2003_V2_ConstructedType, DataType, SQL2003_V2_DerivedTable, SQL2003_V2_DistinctType, UserDefinedType, SQL2003_V2_PredefinedType, SQL2003_V2_Feature, SQL2003_V2_Field, SQL2003_V2_ROW, SQL2003_V2_Function, BehaviouralComponent, SQL2003_V2_IntervalFeature, SQL2003_V2_IntervalType, SQL2003_V2_MULTISET, SQL2003_V2_Method, SQL2003_V2_MethodParameter, Parameter_, SQL2003_V2_NotNull, ColumnConstraint, SQL2003_V2_NumericFeature, SQL2003_V2_NumericType, SQL2003_V2_Parameter, SQL2003_V2_PrimaryKey, UniqueConstraint, SQL2003_V2_Procedure, SQL2003_V2_ReferenceType, SQL2003_V2_ReferentialConstraint, TableConstraint, SQL2003_V2_UniqueConstraint, SQL2003_V2_Restriction, SQL2003_V2_StructuralComponent, SQL2003_V2_Domain, SQL2003_V2_StringFeature, SQL2003_V2_View, SQL2003_V2_TypedTable, SQL2003_V2_TableConstraint, SQL2003_V2_Trigger, SQL2003_V2_TriggerDescriptor, SQL2003_V2_TableCheckConstraint, SQL2003_V2_UserDefinedType, BaseTable, SQL2003_V2_XMLType, DerivedTable, BooleanTypes, CharacterStringTypes, BinaryStringTypes, DatetimeFeatures, DatetimeTypes, IntervalFeatures, IntervalTypes, MatchTypes, Multiplier, NumericRadix, NumericFeatures, NumericTypes, ParameterMode, ReferentialAction, StringFeatures, TriggerActionTime, TriggerEvent, Unit, TriggerLevel, XMLTypes},
    associations={schema1, parametersWithMode2, structured0, super_type4, type5, table7, schema8, source_type10, features11, row12, return_type13, override16, structured17, return_type19, parameters22, method23, type24, is_source_of27, super_type29, fields31, sub_types33, behaviouralComponent26, type35, references36, table37, columns39, behaviouralComponents41, datatypes43, tables45, domains48, type50, super_type61, views52, restrictions53, features55, has_domain58, schema69, columns71, views72, attributes63, methods64, typed67, description78, restrictions75, updateColumns79, trigger81, supertable85, subtables88, structured82, components92, tables90, defines97, schema95},
    generalizations={gen_SQL2003_V2_ARRAY_CollectionType, gen_SQL2003_V2_Attribute_StructuralComponent, gen_SQL2003_V2_BaseTable_Table, gen_SQL2003_V2_BinaryStringType_PredefinedType, gen_SQL2003_V2_BooleanType_PredefinedType, gen_SQL2003_V2_CharacterStringType_PredefinedType, gen_SQL2003_V2_CollectionType_ConstructedType, gen_SQL2003_V2_Column_StructuralComponent, gen_SQL2003_V2_ColumnConstraint_Restriction, gen_SQL2003_V2_DatetimeFeature_Feature, gen_SQL2003_V2_DatetimeType_PredefinedType, gen_SQL2003_V2_ConstructedType_DataType, gen_SQL2003_V2_DerivedTable_Table, gen_SQL2003_V2_DistinctType_UserDefinedType, gen_SQL2003_V2_Field_StructuralComponent, gen_SQL2003_V2_Function_BehaviouralComponent, gen_SQL2003_V2_IntervalFeature_Feature, gen_SQL2003_V2_IntervalType_PredefinedType, gen_SQL2003_V2_MULTISET_CollectionType, gen_SQL2003_V2_MethodParameter_Parameter, gen_SQL2003_V2_NotNull_ColumnConstraint, gen_SQL2003_V2_NumericFeature_Feature, gen_SQL2003_V2_NumericType_PredefinedType, gen_SQL2003_V2_ParameterWithMode_Parameter, gen_SQL2003_V2_PredefinedType_DataType, gen_SQL2003_V2_PrimaryKey_UniqueConstraint, gen_SQL2003_V2_Procedure_BehaviouralComponent, gen_SQL2003_V2_ROW_ConstructedType, gen_SQL2003_V2_ReferentialConstraint_TableConstraint, gen_SQL2003_V2_ReferenceType_ConstructedType, gen_SQL2003_V2_StringFeature_Feature, gen_SQL2003_V2_StructuredType_UserDefinedType, gen_SQL2003_V2_TableConstraint_Restriction, gen_SQL2003_V2_Trigger_Restriction, gen_SQL2003_V2_TableCheckConstraint_TableConstraint, gen_SQL2003_V2_UniqueConstraint_TableConstraint, gen_SQL2003_V2_UserDefinedType_DataType, gen_SQL2003_V2_TypedTable_BaseTable, gen_SQL2003_V2_XMLType_PredefinedType, gen_SQL2003_V2_View_DerivedTable},
    metadata=None
)
