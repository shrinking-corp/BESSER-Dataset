...
class SQL2003_V2_TriggerDescriptor:
    ...
    def __init__(self, level: str, event: str, actionTime: str, triggeredAction: str, TriggerDescriptor: "SQL2003_V2_Trigger" = None, description: "SQL2003_V2_Trigger" = None):
        self.level = level
        self.event = event
...
class SQL2003_V2_Domain:
    ...
    def __init__(self, name: str, expression: str, default: str, has_domain: set["SQL2003_V2_StructuralComponent"] = None, domains: "SQL2003_V2_Schema" = None, Domain: "SQL2003_V2_Schema" = None, Domain59: "SQL2003_V2_StructuralComponent" = None):
        self.name = name
...
class SQL2003_V2_StructuralComponent(ABC):
    ...
    def __init__(self, name: str, StructuralComponent: "SQL2003_V2_Restriction" = None, SQL2003_V2_StructuralComponent80: "SQL2003_V2_Trigger" = None, StructuralComponent94: "SQL2003_V2_View" = None, StructuralComponent98: "SQL2003_V2_Domain" = None, SQL2003_V2_StructuralComponent: "SQL2003_V2_DataType" = None, components: set["SQL2003_V2_View"] = None, columns54: set["SQL2003_V2_Restriction"] = None, SQL2003_V2_StructuralComponent56: set["SQL2003_V2_Feature"] = None, defines: "SQL2003_V2_Domain" = None):
        self.name = name
...
class SQL2003_V2_Table(ABC):
    ...
    def __init__(self, name: str, Table: "SQL2003_V2_Column" = None, Table38: "SQL2003_V2_Restriction" = None, Table47: "SQL2003_V2_Schema" = None, tables: "SQL2003_V2_Schema" = None, table: set["SQL2003_V2_Column"] = None, tables73: set["SQL2003_V2_View"] = None, table76: set["SQL2003_V2_Restriction"] = None, Table91: "SQL2003_V2_View" = None):
        self.name = name
        self.Table = Table
...
class SQL2003_V2_Schema:
    ...
    def __init__(self, name: str, Schema: "SQL2003_V2_BehaviouralComponent" = None, Schema9: "SQL2003_V2_DataType" = None, schema: set["SQL2003_V2_BehaviouralComponent"] = None, schema44: set["SQL2003_V2_DataType"] = None, schema46: set["SQL2003_V2_Table"] = None, Schema70: "SQL2003_V2_Table" = None, Schema96: "SQL2003_V2_Domain" = None, schema49: set["SQL2003_V2_Domain"] = None):
        self.name = name
        self.Schema = Schema
...
class SQL2003_V2_StructuredType(UserDefinedType):
    ...
    def __init__(self, is_final: bool, is_instantiable: bool, StructuredType: "SQL2003_V2_Attribute" = None, StructuredType18: "SQL2003_V2_Method" = None, SQL2003_V2_StructuredType: "SQL2003_V2_ReferenceType" = None, structured: set["SQL2003_V2_Attribute"] = None, structured65: set["SQL2003_V2_Method"] = None, structured68: set["SQL2003_V2_TypedTable"] = None, StructuredType83: "SQL2003_V2_TypedTable" = None, SQL2003_V2_StructuredType62: "SQL2003_V2_StructuredType" = None, SQL2003_V2_StructuredType60: "SQL2003_V2_StructuredType" = None):
