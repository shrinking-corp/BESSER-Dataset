...
domain_model = DomainModel(
    name="d1a59d30_f4ac_4082_b6fe_1d743278615b",
    types={CPU, Processor, AcceleratorCard, Cache, RAM, Machine, Program, Instruction, Memory_Interface, T, DeviceCard, Card, Sound, GenericSound, Vendor1Adapter, Vendor2Adapter, Vendor1Sound, Vendor2Sound, ExtensionBoard, FastCard},
    associations={Machine_Memory, Vendor1Adapter_Vendor1Sound, Vendor2Adapter_Vendor2Sound, Machine_Card, AcceleratorCard_CPU, Processor_Memory, Program_Instruction, Machine_Processor, Processor_Program, Cache_RAM, ExtensionBoard_Card},
    generalizations={},
    metadata=None
)
