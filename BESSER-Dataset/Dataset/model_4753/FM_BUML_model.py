...
# Classes
fM_Leaf = Class(name="fM_Leaf")
Child = Class(name="Child")
fM_Node = Class(name="fM_Node")
fM_Rule = Class(name="fM_Rule")
fM_Formula = Class(name="fM_Formula")
fM_RuleElement = Class(name="fM_RuleElement")
Formula = Class(name="Formula")
fM_Var = Class(name="fM_Var")
fM_FeatureModel = Class(name="fM_FeatureModel")
fM_FeatureDiagram = Class(name="fM_FeatureDiagram")
fM_Constraints = Class(name="fM_Constraints")
fM_Child = Class(name="fM_Child")
...
fM_RuleElement.attributes={fM_RuleElement_open_operator, fM_RuleElement_close_operator}

# Formula class attributes and methods

# fM_Var class attributes and methods
fM_Var_not_: Property = Property(name="not_", type=BooleanType)
fM_Var_name: Property = Property(name="name", type=StringType)
fM_Var.attributes={fM_Var_name, fM_Var_not_}
...
fM_Child.attributes={fM_Child_mandatory, fM_Child_name}
...
domain_model = DomainModel(
    name="fM",
    types={fM_Leaf, Child, fM_Node, fM_Rule, fM_Formula, fM_RuleElement, Formula, fM_Var, fM_FeatureModel, fM_FeatureDiagram, fM_Constraints, fM_Child},
    associations={children5, rules7, elements9, left_side11, diagram0, constraints1, root3, right_side12},
