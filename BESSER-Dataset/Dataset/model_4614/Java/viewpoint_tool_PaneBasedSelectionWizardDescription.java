...
public class viewpoint_tool_PaneBasedSelectionWizardDescription extends AbstractToolDescription {
    ...
    public viewpoint_tool_PaneBasedSelectionWizardDescription(
        String childrenExpression,        String windowTitle,        String preSelectedCandidatesExpression,        String candidatesExpression,        String selectedValuesMessage,        String rootExpression,        boolean tree,        String windowImagePath,        String iconPath,        String message,        String choiceOfValuesMessage    ) {
        super(
        );
