...
def test_hyp_dview_is_not_abstract():
    assert not inspect.isabstract(DView)


def test_hyp_dview_constructor_exists():
    assert callable(DView.__init__)


def test_hyp_dview_constructor_args():
    sig = inspect.signature(DView.__init__)
    params = list(sig.parameters.keys())



def test_hyp_viewpoint_drepresentationcontainer_is_not_abstract():
    assert not inspect.isabstract(viewpoint_DRepresentationContainer)


def test_hyp_viewpoint_drepresentationcontainer_constructor_exists():
    assert callable(viewpoint_DRepresentationContainer.__init__)


def test_hyp_viewpoint_drepresentationcontainer_constructor_args():
...
def test_assoc_activatedViewpoints44_link_reassign_clear():
    ...
    if hasattr(b1, 'Viewpoint45'):
        assert _is_linked(b1, 'Viewpoint45', a)
    _safe_set(a, 'viewpoint_DAnalysisSessionEObject', {b2})
    assert _is_linked(a, 'viewpoint_DAnalysisSessionEObject', b2)
    if hasattr(b1, 'Viewpoint45'):
        assert not _is_linked(b1, 'Viewpoint45', a)
    if hasattr(b2, 'Viewpoint45'):
        assert _is_linked(b2, 'Viewpoint45', a)
    _safe_set(a, 'viewpoint_DAnalysisSessionEObject', set())
    assert not _is_linked(a, 'viewpoint_DAnalysisSessionEObject', b2)
    if hasattr(b2, 'Viewpoint45'):
        assert not _is_linked(b2, 'Viewpoint45', a)


def test_assoc_allRules207_link_reassign_clear():
...
def test_assoc_analyses46_link_reassign_clear():
    a = viewpoint_DAnalysisSessionEObject(controlledResources="sample_text", open=True, resources="sample_text", synchronizationStatus="sample_text")
    ...
    _safe_set(a, 'viewpoint_DAnalysisSessionEObject47', {b1})
    assert _is_linked(a, 'viewpoint_DAnalysisSessionEObject47', b1)
    if hasattr(b1, 'viewpoint_DAnalysis48'):
        assert _is_linked(b1, 'viewpoint_DAnalysis48', a)
    _safe_set(a, 'viewpoint_DAnalysisSessionEObject47', {b2})
    assert _is_linked(a, 'viewpoint_DAnalysisSessionEObject47', b2)
    if hasattr(b1, 'viewpoint_DAnalysis48'):
        assert not _is_linked(b1, 'viewpoint_DAnalysis48', a)
    if hasattr(b2, 'viewpoint_DAnalysis48'):
        assert _is_linked(b2, 'viewpoint_DAnalysis48', a)
    _safe_set(a, 'viewpoint_DAnalysisSessionEObject47', set())
    assert not _is_linked(a, 'viewpoint_DAnalysisSessionEObject47', b2)
    if hasattr(b2, 'viewpoint_DAnalysis48'):
        assert not _is_linked(b2, 'viewpoint_DAnalysis48', a)


def test_assoc_appliedOn98_link_reassign_clear():
    ...
    if hasattr(b1, 'description_viewpoint_EObject99'):
        assert _is_linked(b1, 'description_viewpoint_EObject99', a)
    ...
    if hasattr(b1, 'description_viewpoint_EObject99'):
        assert not _is_linked(b1, 'description_viewpoint_EObject99', a)
    if hasattr(b2, 'description_viewpoint_EObject99'):
        assert _is_linked(b2, 'description_viewpoint_EObject99', a)
    ...
    if hasattr(b2, 'description_viewpoint_EObject99'):
        assert not _is_linked(b2, 'description_viewpoint_EObject99', a)


def test_assoc_associatedColor103_link_reassign_clear():
...
def test_assoc_audits210_link_reassign_clear():
...
def test_assoc_colorSteps102_link_reassign_clear():
...
def test_assoc_container123_link_reassign_clear():
...
def test_assoc_container139_link_reassign_clear():
...
def test_assoc_container149_link_reassign_clear():
    ...
    if hasattr(b1, 'tool_SelectContainerVariable151'):
        assert _is_linked(b1, 'tool_SelectContainerVariable151', a)
    ...
    if hasattr(b1, 'tool_SelectContainerVariable151'):
        assert not _is_linked(b1, 'tool_SelectContainerVariable151', a)
    if hasattr(b2, 'tool_SelectContainerVariable151'):
        assert _is_linked(b2, 'tool_SelectContainerVariable151', a)
    ...
    if hasattr(b2, 'tool_SelectContainerVariable151'):
        assert not _is_linked(b2, 'tool_SelectContainerVariable151', a)


def test_assoc_containerVariable170_link_reassign_clear():
    ...
    if hasattr(b1, 'tool_ElementSelectVariable172'):
        assert _is_linked(b1, 'tool_ElementSelectVariable172', a)
    ...
    if hasattr(b1, 'tool_ElementSelectVariable172'):
        assert not _is_linked(b1, 'tool_ElementSelectVariable172', a)
    if hasattr(b2, 'tool_ElementSelectVariable172'):
        assert _is_linked(b2, 'tool_ElementSelectVariable172', a)
    ...
    if hasattr(b2, 'tool_ElementSelectVariable172'):
        assert not _is_linked(b2, 'tool_ElementSelectVariable172', a)


def test_assoc_containerView124_link_reassign_clear():
    a = viewpoint_tool_PasteDescription()
    b1 = tool_ContainerViewVariable()
    b2 = tool_ContainerViewVariable()
    _safe_set(a, 'viewpoint_tool_PasteDescription125', b1)
    assert _is_linked(a, 'viewpoint_tool_PasteDescription125', b1)
    if hasattr(b1, 'tool_ContainerViewVariable'):
        assert _is_linked(b1, 'tool_ContainerViewVariable', a)
    _safe_set(a, 'viewpoint_tool_PasteDescription125', b2)
    assert _is_linked(a, 'viewpoint_tool_PasteDescription125', b2)
    if hasattr(b1, 'tool_ContainerViewVariable'):
    ...
    _safe_set(a, 'viewpoint_tool_PasteDescription125', None)
    assert not _is_linked(a, 'viewpoint_tool_PasteDescription125', b2)
    if hasattr(b2, 'tool_ContainerViewVariable'):
        assert not _is_linked(b2, 'tool_ContainerViewVariable', a)


def test_assoc_containerView136_link_reassign_clear():
    a = viewpoint_tool_SelectionWizardDescription(iconPath="sample_text", windowImagePath="sample_text", windowTitle="sample_text")
    b1 = tool_ContainerViewVariable()
    b2 = tool_ContainerViewVariable()
    _safe_set(a, 'viewpoint_tool_SelectionWizardDescription137', b1)
    assert _is_linked(a, 'viewpoint_tool_SelectionWizardDescription137', b1)
    if hasattr(b1, 'tool_ContainerViewVariable138'):
        assert _is_linked(b1, 'tool_ContainerViewVariable138', a)
    _safe_set(a, 'viewpoint_tool_SelectionWizardDescription137', b2)
    assert _is_linked(a, 'viewpoint_tool_SelectionWizardDescription137', b2)
    if hasattr(b1, 'tool_ContainerViewVariable138'):
        assert not _is_linked(b1, 'tool_ContainerViewVariable138', a)
    if hasattr(b2, 'tool_ContainerViewVariable138'):
        assert _is_linked(b2, 'tool_ContainerViewVariable138', a)
    _safe_set(a, 'viewpoint_tool_SelectionWizardDescription137', None)
    assert not _is_linked(a, 'viewpoint_tool_SelectionWizardDescription137', b2)
    if hasattr(b2, 'tool_ContainerViewVariable138'):
        assert not _is_linked(b2, 'tool_ContainerViewVariable138', a)


def test_assoc_containerView146_link_reassign_clear():
    a = viewpoint_tool_PaneBasedSelectionWizardDescription(candidatesExpression="sample_text", childrenExpression="sample_text", choiceOfValuesMessage="sample_text", iconPath="sample_text", message="sample_text", preSelectedCandidatesExpression="sample_text", rootExpression="sample_text", selectedValuesMessage="sample_text", tree=True, windowImagePath="sample_text", windowTitle="sample_text")
    b1 = tool_ContainerViewVariable()
    b2 = tool_ContainerViewVariable()
    _safe_set(a, 'viewpoint_tool_PaneBasedSelectionWizardDescription147', b1)
    assert _is_linked(a, 'viewpoint_tool_PaneBasedSelectionWizardDescription147', b1)
    if hasattr(b1, 'tool_ContainerViewVariable148'):
        assert _is_linked(b1, 'tool_ContainerViewVariable148', a)
    _safe_set(a, 'viewpoint_tool_PaneBasedSelectionWizardDescription147', b2)
    assert _is_linked(a, 'viewpoint_tool_PaneBasedSelectionWizardDescription147', b2)
    if hasattr(b1, 'tool_ContainerViewVariable148'):
        assert not _is_linked(b1, 'tool_ContainerViewVariable148', a)
    if hasattr(b2, 'tool_ContainerViewVariable148'):
        assert _is_linked(b2, 'tool_ContainerViewVariable148', a)
    _safe_set(a, 'viewpoint_tool_PaneBasedSelectionWizardDescription147', None)
    assert not _is_linked(a, 'viewpoint_tool_PaneBasedSelectionWizardDescription147', b2)
    if hasattr(b2, 'tool_ContainerViewVariable148'):
        assert not _is_linked(b2, 'tool_ContainerViewVariable148', a)


def test_assoc_containerViewVariable160_link_reassign_clear():
    ...
    if hasattr(b1, 'tool_ContainerViewVariable162'):
        assert _is_linked(b1, 'tool_ContainerViewVariable162', a)
    ...
    if hasattr(b1, 'tool_ContainerViewVariable162'):
        assert not _is_linked(b1, 'tool_ContainerViewVariable162', a)
    if hasattr(b2, 'tool_ContainerViewVariable162'):
        assert _is_linked(b2, 'tool_ContainerViewVariable162', a)
    ...
    if hasattr(b2, 'tool_ContainerViewVariable162'):
        assert not _is_linked(b2, 'tool_ContainerViewVariable162', a)


def test_assoc_containerViewVariable167_link_reassign_clear():
    a = viewpoint_tool_RepresentationNavigationDescription(browseExpression="sample_text", navigationNameExpression="sample_text")
    b1 = tool_ContainerViewVariable()
    b2 = tool_ContainerViewVariable()
    _safe_set(a, 'viewpoint_tool_RepresentationNavigationDescription168', b1)
    assert _is_linked(a, 'viewpoint_tool_RepresentationNavigationDescription168', b1)
    if hasattr(b1, 'tool_ContainerViewVariable169'):
        assert _is_linked(b1, 'tool_ContainerViewVariable169', a)
    _safe_set(a, 'viewpoint_tool_RepresentationNavigationDescription168', b2)
    assert _is_linked(a, 'viewpoint_tool_RepresentationNavigationDescription168', b2)
    if hasattr(b1, 'tool_ContainerViewVariable169'):
        assert not _is_linked(b1, 'tool_ContainerViewVariable169', a)
    if hasattr(b2, 'tool_ContainerViewVariable169'):
        assert _is_linked(b2, 'tool_ContainerViewVariable169', a)
    _safe_set(a, 'viewpoint_tool_RepresentationNavigationDescription168', None)
    assert not _is_linked(a, 'viewpoint_tool_RepresentationNavigationDescription168', b2)
    if hasattr(b2, 'tool_ContainerViewVariable169'):
        assert not _is_linked(b2, 'tool_ContainerViewVariable169', a)


def test_assoc_copiedElement129_link_reassign_clear():
    a = viewpoint_tool_PasteDescription()
    ...
    if hasattr(b1, 'tool_ElementVariable131'):
        assert _is_linked(b1, 'tool_ElementVariable131', a)
    _safe_set(a, 'viewpoint_tool_PasteDescription130', b2)
    assert _is_linked(a, 'viewpoint_tool_PasteDescription130', b2)
    if hasattr(b1, 'tool_ElementVariable131'):
        assert not _is_linked(b1, 'tool_ElementVariable131', a)
    if hasattr(b2, 'tool_ElementVariable131'):
        assert _is_linked(b2, 'tool_ElementVariable131', a)
    _safe_set(a, 'viewpoint_tool_PasteDescription130', None)
    assert not _is_linked(a, 'viewpoint_tool_PasteDescription130', b2)
    if hasattr(b2, 'tool_ElementVariable131'):
        assert not _is_linked(b2, 'tool_ElementVariable131', a)


def test_assoc_copiedView126_link_reassign_clear():
    a = viewpoint_tool_PasteDescription()
    b1 = tool_ElementViewVariable()
    b2 = tool_ElementViewVariable()
    _safe_set(a, 'viewpoint_tool_PasteDescription127', b1)
    assert _is_linked(a, 'viewpoint_tool_PasteDescription127', b1)
    if hasattr(b1, 'tool_ElementViewVariable128'):
        assert _is_linked(b1, 'tool_ElementViewVariable128', a)
    _safe_set(a, 'viewpoint_tool_PasteDescription127', b2)
    assert _is_linked(a, 'viewpoint_tool_PasteDescription127', b2)
    if hasattr(b1, 'tool_ElementViewVariable128'):
        assert not _is_linked(b1, 'tool_ElementViewVariable128', a)
    if hasattr(b2, 'tool_ElementViewVariable128'):
        assert _is_linked(b2, 'tool_ElementViewVariable128', a)
    _safe_set(a, 'viewpoint_tool_PasteDescription127', None)
    assert not _is_linked(a, 'viewpoint_tool_PasteDescription127', b2)
    if hasattr(b2, 'tool_ElementViewVariable128'):
        assert not _is_linked(b2, 'tool_ElementViewVariable128', a)


def test_assoc_data112_link_reassign_clear():
    ...
    if hasattr(b1, 'description_viewpoint_EObject113'):
        assert _is_linked(b1, 'description_viewpoint_EObject113', a)
    _safe_set(a, 'viewpoint_description_AnnotationEntry', b2)
    assert _is_linked(a, 'viewpoint_description_AnnotationEntry', b2)
    if hasattr(b1, 'description_viewpoint_EObject113'):
        assert not _is_linked(b1, 'description_viewpoint_EObject113', a)
    if hasattr(b2, 'description_viewpoint_EObject113'):
        assert _is_linked(b2, 'description_viewpoint_EObject113', a)
    _safe_set(a, 'viewpoint_description_AnnotationEntry', None)
    assert not _is_linked(a, 'viewpoint_description_AnnotationEntry', b2)
    if hasattr(b2, 'description_viewpoint_EObject113'):
        assert not _is_linked(b2, 'description_viewpoint_EObject113', a)


def test_assoc_data41_link_reassign_clear():
    ...
    if hasattr(b1, 'viewpoint_EObject42'):
        assert _is_linked(b1, 'viewpoint_EObject42', a)
    _safe_set(a, 'viewpoint_DAnalysisCustomData', b2)
    assert _is_linked(a, 'viewpoint_DAnalysisCustomData', b2)
    if hasattr(b1, 'viewpoint_EObject42'):
        assert not _is_linked(b1, 'viewpoint_EObject42', a)
    if hasattr(b2, 'viewpoint_EObject42'):
        assert _is_linked(b2, 'viewpoint_EObject42', a)
    _safe_set(a, 'viewpoint_DAnalysisCustomData', None)
    assert not _is_linked(a, 'viewpoint_DAnalysisCustomData', b2)
    if hasattr(b2, 'viewpoint_EObject42'):
        assert not _is_linked(b2, 'viewpoint_EObject42', a)


def test_assoc_details87_link_reassign_clear():
...
def test_assoc_eAnnotations86_link_reassign_clear():
...
def test_assoc_element118_link_reassign_clear():
...
def test_assoc_element135_link_reassign_clear():
    a = viewpoint_tool_SelectionWizardDescription(iconPath="sample_text", windowImagePath="sample_text", windowTitle="sample_text")
    b1 = tool_ElementSelectVariable()
    b2 = tool_ElementSelectVariable()
...
def test_assoc_element144_link_reassign_clear():
    ...
    if hasattr(b1, 'tool_ElementSelectVariable145'):
        assert _is_linked(b1, 'tool_ElementSelectVariable145', a)
    ...
    if hasattr(b1, 'tool_ElementSelectVariable145'):
        assert not _is_linked(b1, 'tool_ElementSelectVariable145', a)
    if hasattr(b2, 'tool_ElementSelectVariable145'):
        assert _is_linked(b2, 'tool_ElementSelectVariable145', a)
    ...
    if hasattr(b2, 'tool_ElementSelectVariable145'):
        assert not _is_linked(b2, 'tool_ElementSelectVariable145', a)


def test_assoc_elementView119_link_reassign_clear():
    a = viewpoint_tool_ToolDescription(iconPath="sample_text")
    b1 = tool_ElementViewVariable()
    b2 = tool_ElementViewVariable()
    _safe_set(a, 'viewpoint_tool_ToolDescription120', b1)
    assert _is_linked(a, 'viewpoint_tool_ToolDescription120', b1)
    if hasattr(b1, 'tool_ElementViewVariable'):
        assert _is_linked(b1, 'tool_ElementViewVariable', a)
    _safe_set(a, 'viewpoint_tool_ToolDescription120', b2)
    assert _is_linked(a, 'viewpoint_tool_ToolDescription120', b2)
    if hasattr(b1, 'tool_ElementViewVariable'):
    ...
    _safe_set(a, 'viewpoint_tool_ToolDescription120', None)
    assert not _is_linked(a, 'viewpoint_tool_ToolDescription120', b2)
    if hasattr(b2, 'tool_ElementViewVariable'):
        assert not _is_linked(b2, 'tool_ElementViewVariable', a)


def test_assoc_elementsToSelect52_link_reassign_clear():
    a = viewpoint_UIState(inverseSelectionOrder=True)
    b1 = viewpoint_EObject()
    b2 = viewpoint_EObject()
    _safe_set(a, 'viewpoint_UIState53', {b1})
    assert _is_linked(a, 'viewpoint_UIState53', b1)
    if hasattr(b1, 'viewpoint_EObject54'):
        assert _is_linked(b1, 'viewpoint_EObject54', a)
    _safe_set(a, 'viewpoint_UIState53', {b2})
    assert _is_linked(a, 'viewpoint_UIState53', b2)
    if hasattr(b1, 'viewpoint_EObject54'):
    ...
    _safe_set(a, 'viewpoint_UIState53', set())
    assert not _is_linked(a, 'viewpoint_UIState53', b2)
    if hasattr(b2, 'viewpoint_EObject54'):
        assert not _is_linked(b2, 'viewpoint_EObject54', a)


def test_assoc_entries111_link_reassign_clear():
...
def test_assoc_extensions61_link_reassign_clear():
    a = viewpoint_description_Group(name="sample_text", version="sample_text")
    b1 = Extension()
    b2 = Extension()
    _safe_set(a, 'viewpoint_description_Group62', {b1})
    assert _is_linked(a, 'viewpoint_description_Group62', b1)
    if hasattr(b1, 'Extension'):
        assert _is_linked(b1, 'Extension', a)
    _safe_set(a, 'viewpoint_description_Group62', {b2})
    assert _is_linked(a, 'viewpoint_description_Group62', b2)
    if hasattr(b1, 'Extension'):
        assert not _is_linked(b1, 'Extension', a)
    if hasattr(b2, 'Extension'):
        assert _is_linked(b2, 'Extension', a)
    _safe_set(a, 'viewpoint_description_Group62', set())
    assert not _is_linked(a, 'viewpoint_description_Group62', b2)
    if hasattr(b2, 'Extension'):
        assert not _is_linked(b2, 'Extension', a)


def test_assoc_featureCustomizations92_link_reassign_clear():
...
def test_assoc_fixes211_link_reassign_clear():
    a = viewpoint_validation_ValidationRule(level="sample_text", message="sample_text")
    b1 = validation_ValidationFix()
    b2 = validation_ValidationFix()
    _safe_set(a, 'viewpoint_validation_ValidationRule212', {b1})
    assert _is_linked(a, 'viewpoint_validation_ValidationRule212', b1)
    if hasattr(b1, 'validation_ValidationFix'):
        assert _is_linked(b1, 'validation_ValidationFix', a)
    _safe_set(a, 'viewpoint_validation_ValidationRule212', {b2})
    assert _is_linked(a, 'viewpoint_validation_ValidationRule212', b2)
    if hasattr(b1, 'validation_ValidationFix'):
    ...
    _safe_set(a, 'viewpoint_validation_ValidationRule212', set())
    assert not _is_linked(a, 'viewpoint_validation_ValidationRule212', b2)
    if hasattr(b2, 'validation_ValidationFix'):
        assert not _is_linked(b2, 'validation_ValidationFix', a)


def test_assoc_initialOperation121_link_reassign_clear():
    a = viewpoint_tool_ToolDescription(iconPath="sample_text")
    b1 = tool_InitialOperation()
    b2 = tool_InitialOperation()
    _safe_set(a, 'viewpoint_tool_ToolDescription122', b1)
    assert _is_linked(a, 'viewpoint_tool_ToolDescription122', b1)
    if hasattr(b1, 'tool_InitialOperation'):
        assert _is_linked(b1, 'tool_InitialOperation', a)
    _safe_set(a, 'viewpoint_tool_ToolDescription122', b2)
    assert _is_linked(a, 'viewpoint_tool_ToolDescription122', b2)
    if hasattr(b1, 'tool_InitialOperation'):
    ...
    _safe_set(a, 'viewpoint_tool_ToolDescription122', None)
    assert not _is_linked(a, 'viewpoint_tool_ToolDescription122', b2)
    if hasattr(b2, 'tool_InitialOperation'):
        assert not _is_linked(b2, 'tool_InitialOperation', a)


def test_assoc_initialOperation132_link_reassign_clear():
    a = viewpoint_tool_PasteDescription()
    b1 = tool_InitialOperation()
    b2 = tool_InitialOperation()
    _safe_set(a, 'viewpoint_tool_PasteDescription133', b1)
    assert _is_linked(a, 'viewpoint_tool_PasteDescription133', b1)
    if hasattr(b1, 'tool_InitialOperation134'):
        assert _is_linked(b1, 'tool_InitialOperation134', a)
    _safe_set(a, 'viewpoint_tool_PasteDescription133', b2)
    assert _is_linked(a, 'viewpoint_tool_PasteDescription133', b2)
    if hasattr(b1, 'tool_InitialOperation134'):
        assert not _is_linked(b1, 'tool_InitialOperation134', a)
    if hasattr(b2, 'tool_InitialOperation134'):
        assert _is_linked(b2, 'tool_InitialOperation134', a)
    _safe_set(a, 'viewpoint_tool_PasteDescription133', None)
    assert not _is_linked(a, 'viewpoint_tool_PasteDescription133', b2)
    if hasattr(b2, 'tool_InitialOperation134'):
        assert not _is_linked(b2, 'tool_InitialOperation134', a)
...
def test_assoc_initialOperation141_link_reassign_clear():
    ...
    b1 = tool_InitialOperation()
    b2 = tool_InitialOperation()
    _safe_set(a, 'viewpoint_tool_SelectionWizardDescription142', b1)
    assert _is_linked(a, 'viewpoint_tool_SelectionWizardDescription142', b1)
    if hasattr(b1, 'tool_InitialOperation143'):
        assert _is_linked(b1, 'tool_InitialOperation143', a)
    _safe_set(a, 'viewpoint_tool_SelectionWizardDescription142', b2)
    assert _is_linked(a, 'viewpoint_tool_SelectionWizardDescription142', b2)
    if hasattr(b1, 'tool_InitialOperation143'):
    ...
    _safe_set(a, 'viewpoint_tool_SelectionWizardDescription142', None)
    assert not _is_linked(a, 'viewpoint_tool_SelectionWizardDescription142', b2)
    if hasattr(b2, 'tool_InitialOperation143'):
        assert not _is_linked(b2, 'tool_InitialOperation143', a)


def test_assoc_initialOperation152_link_reassign_clear():
    a = viewpoint_tool_PaneBasedSelectionWizardDescription(candidatesExpression="sample_text", childrenExpression="sample_text", choiceOfValuesMessage="sample_text", iconPath="sample_text", message="sample_text", preSelectedCandidatesExpression="sample_text", rootExpression="sample_text", selectedValuesMessage="sample_text", tree=True, windowImagePath="sample_text", windowTitle="sample_text")
    b1 = tool_InitialOperation()
    b2 = tool_InitialOperation()
    ...
    if hasattr(b1, 'tool_InitialOperation154'):
        assert _is_linked(b1, 'tool_InitialOperation154', a)
    ...
    if hasattr(b1, 'tool_InitialOperation154'):
        assert not _is_linked(b1, 'tool_InitialOperation154', a)
    if hasattr(b2, 'tool_InitialOperation154'):
        assert _is_linked(b2, 'tool_InitialOperation154', a)
    ...
    if hasattr(b2, 'tool_InitialOperation154'):
        assert not _is_linked(b2, 'tool_InitialOperation154', a)


def test_assoc_initialOperation157_link_reassign_clear():
    a = viewpoint_tool_RepresentationCreationDescription(browseExpression="sample_text", titleExpression="sample_text")
    b1 = tool_InitialOperation()
    b2 = tool_InitialOperation()
    _safe_set(a, 'viewpoint_tool_RepresentationCreationDescription158', b1)
    assert _is_linked(a, 'viewpoint_tool_RepresentationCreationDescription158', b1)
    if hasattr(b1, 'tool_InitialOperation159'):
        assert _is_linked(b1, 'tool_InitialOperation159', a)
    _safe_set(a, 'viewpoint_tool_RepresentationCreationDescription158', b2)
    assert _is_linked(a, 'viewpoint_tool_RepresentationCreationDescription158', b2)
    if hasattr(b1, 'tool_InitialOperation159'):
        assert not _is_linked(b1, 'tool_InitialOperation159', a)
    if hasattr(b2, 'tool_InitialOperation159'):
        assert _is_linked(b2, 'tool_InitialOperation159', a)
    _safe_set(a, 'viewpoint_tool_RepresentationCreationDescription158', None)
    assert not _is_linked(a, 'viewpoint_tool_RepresentationCreationDescription158', b2)
    if hasattr(b2, 'tool_InitialOperation159'):
        assert not _is_linked(b2, 'tool_InitialOperation159', a)


def test_assoc_initialOperation214_link_reassign_clear():
    ...
    if hasattr(b1, 'tool_InitialOperation215'):
        assert _is_linked(b1, 'tool_InitialOperation215', a)
    _safe_set(a, 'viewpoint_validation_ValidationFix', b2)
    assert _is_linked(a, 'viewpoint_validation_ValidationFix', b2)
    if hasattr(b1, 'tool_InitialOperation215'):
        assert not _is_linked(b1, 'tool_InitialOperation215', a)
    if hasattr(b2, 'tool_InitialOperation215'):
        assert _is_linked(b2, 'tool_InitialOperation215', a)
    _safe_set(a, 'viewpoint_validation_ValidationFix', None)
    assert not _is_linked(a, 'viewpoint_validation_ValidationFix', b2)
    if hasattr(b2, 'tool_InitialOperation215'):
        assert not _is_linked(b2, 'tool_InitialOperation215', a)


def test_assoc_labelColor115_link_reassign_clear():
...
def test_assoc_listeners197_link_reassign_clear():
...
def test_assoc_members51_link_reassign_clear():
...
def test_assoc_metamodel77_link_reassign_clear():
...
def test_assoc_metamodel80_link_reassign_clear():
    ...
    if hasattr(b1, 'description_viewpoint_EPackage81'):
        assert _is_linked(b1, 'description_viewpoint_EPackage81', a)
    ...
    if hasattr(b1, 'description_viewpoint_EPackage81'):
        assert not _is_linked(b1, 'description_viewpoint_EPackage81', a)
    if hasattr(b2, 'description_viewpoint_EPackage81'):
        assert _is_linked(b2, 'description_viewpoint_EPackage81', a)
    ...
    if hasattr(b2, 'description_viewpoint_EPackage81'):
        assert not _is_linked(b2, 'description_viewpoint_EPackage81', a)
...
def test_assoc_object196_link_reassign_clear():
...
def test_assoc_ownedAnnotationEntries23_link_reassign_clear():
    a = viewpoint_DRepresentation(name="sample_text")
    b1 = AnnotationEntry()
    b2 = AnnotationEntry()
    _safe_set(a, 'viewpoint_DRepresentation24', {b1})
    assert _is_linked(a, 'viewpoint_DRepresentation24', b1)
    if hasattr(b1, 'AnnotationEntry'):
        assert _is_linked(b1, 'AnnotationEntry', a)
    _safe_set(a, 'viewpoint_DRepresentation24', {b2})
    assert _is_linked(a, 'viewpoint_DRepresentation24', b2)
    if hasattr(b1, 'AnnotationEntry'):
        assert not _is_linked(b1, 'AnnotationEntry', a)
    if hasattr(b2, 'AnnotationEntry'):
        assert _is_linked(b2, 'AnnotationEntry', a)
    _safe_set(a, 'viewpoint_DRepresentation24', set())
    assert not _is_linked(a, 'viewpoint_DRepresentation24', b2)
    if hasattr(b2, 'AnnotationEntry'):
...
def test_assoc_ownedFeatureExtensions72_link_reassign_clear():
    ...
    if hasattr(b1, 'FeatureExtensionDescription74'):
        assert _is_linked(b1, 'FeatureExtensionDescription74', a)
    _safe_set(a, 'viewpoint_description_Viewpoint73', {b2})
    assert _is_linked(a, 'viewpoint_description_Viewpoint73', b2)
    if hasattr(b1, 'FeatureExtensionDescription74'):
        assert not _is_linked(b1, 'FeatureExtensionDescription74', a)
    if hasattr(b2, 'FeatureExtensionDescription74'):
        assert _is_linked(b2, 'FeatureExtensionDescription74', a)
    _safe_set(a, 'viewpoint_description_Viewpoint73', set())
    assert not _is_linked(a, 'viewpoint_description_Viewpoint73', b2)
    if hasattr(b2, 'FeatureExtensionDescription74'):
        assert not _is_linked(b2, 'FeatureExtensionDescription74', a)


def test_assoc_ownedJavaExtensions68_link_reassign_clear():
    a = viewpoint_description_Viewpoint(conflicts="sample_text", customizes="sample_text", icon="sample_text", modelFileExtension="sample_text", reuses="sample_text")
    b1 = JavaExtension()
    b2 = JavaExtension()
...
def test_assoc_ownedMMExtensions70_link_reassign_clear():
    a = viewpoint_description_Viewpoint(conflicts="sample_text", customizes="sample_text", icon="sample_text", modelFileExtension="sample_text", reuses="sample_text")
...
def test_assoc_ownedRepresentationElements19_link_reassign_clear():
...
def test_assoc_ownedRepresentationExtensions66_link_reassign_clear():
    a = viewpoint_description_Viewpoint(conflicts="sample_text", customizes="sample_text", icon="sample_text", modelFileExtension="sample_text", reuses="sample_text")
    b1 = RepresentationExtensionDescription()
    b2 = RepresentationExtensionDescription()
    _safe_set(a, 'viewpoint_description_Viewpoint67', {b1})
    assert _is_linked(a, 'viewpoint_description_Viewpoint67', b1)
    if hasattr(b1, 'RepresentationExtensionDescription'):
        assert _is_linked(b1, 'RepresentationExtensionDescription', a)
    _safe_set(a, 'viewpoint_description_Viewpoint67', {b2})
    assert _is_linked(a, 'viewpoint_description_Viewpoint67', b2)
    if hasattr(b1, 'RepresentationExtensionDescription'):
    ...
    _safe_set(a, 'viewpoint_description_Viewpoint67', set())
    assert not _is_linked(a, 'viewpoint_description_Viewpoint67', b2)
    if hasattr(b2, 'RepresentationExtensionDescription'):
...
def test_assoc_ownedRepresentations64_link_reassign_clear():
    a = viewpoint_description_Viewpoint(conflicts="sample_text", customizes="sample_text", icon="sample_text", modelFileExtension="sample_text", reuses="sample_text")
    b1 = RepresentationDescription()
    b2 = RepresentationDescription()
    _safe_set(a, 'viewpoint_description_Viewpoint65', {b1})
    assert _is_linked(a, 'viewpoint_description_Viewpoint65', b1)
    if hasattr(b1, 'RepresentationDescription'):
        assert _is_linked(b1, 'RepresentationDescription', a)
    _safe_set(a, 'viewpoint_description_Viewpoint65', {b2})
    assert _is_linked(a, 'viewpoint_description_Viewpoint65', b2)
    if hasattr(b1, 'RepresentationDescription'):
    ...
    _safe_set(a, 'viewpoint_description_Viewpoint65', set())
    assert not _is_linked(a, 'viewpoint_description_Viewpoint65', b2)
    if hasattr(b2, 'RepresentationDescription'):
        assert not _is_linked(b2, 'RepresentationDescription', a)


def test_assoc_ownedRepresentations78_link_reassign_clear():
    ...
    if hasattr(b1, 'RepresentationDescription79'):
        assert _is_linked(b1, 'RepresentationDescription79', a)
    ...
    if hasattr(b1, 'RepresentationDescription79'):
        assert not _is_linked(b1, 'RepresentationDescription79', a)
    if hasattr(b2, 'RepresentationDescription79'):
        assert _is_linked(b2, 'RepresentationDescription79', a)
    ...
    if hasattr(b2, 'RepresentationDescription79'):
        assert not _is_linked(b2, 'RepresentationDescription79', a)


def test_assoc_ownedRules203_link_reassign_clear():
    a = viewpoint_validation_ValidationSet(name="sample_text")
    b1 = validation_ValidationRule()
    b2 = validation_ValidationRule()
...
def test_assoc_ownedSessions49_link_reassign_clear():
    a = viewpoint_DAnalysisSessionEObject(controlledResources="sample_text", open=True, resources="sample_text", synchronizationStatus="sample_text")
    b1 = viewpoint_SessionManagerEObject()
    b2 = viewpoint_SessionManagerEObject()
    _safe_set(a, 'viewpoint_DAnalysisSessionEObject50', b1)
    assert _is_linked(a, 'viewpoint_DAnalysisSessionEObject50', b1)
    if hasattr(b1, 'viewpoint_SessionManagerEObject'):
        assert _is_linked(b1, 'viewpoint_SessionManagerEObject', a)
    _safe_set(a, 'viewpoint_DAnalysisSessionEObject50', b2)
    assert _is_linked(a, 'viewpoint_DAnalysisSessionEObject50', b2)
    if hasattr(b1, 'viewpoint_SessionManagerEObject'):
    ...
    _safe_set(a, 'viewpoint_DAnalysisSessionEObject50', None)
    assert not _is_linked(a, 'viewpoint_DAnalysisSessionEObject50', b2)
    if hasattr(b2, 'viewpoint_SessionManagerEObject'):
        assert not _is_linked(b2, 'viewpoint_SessionManagerEObject', a)


def test_assoc_ownedTemplates75_link_reassign_clear():
    a = viewpoint_description_Viewpoint(conflicts="sample_text", customizes="sample_text", icon="sample_text", modelFileExtension="sample_text", reuses="sample_text")
...
def test_assoc_representationDescription155_link_reassign_clear():
    a = viewpoint_tool_RepresentationCreationDescription(browseExpression="sample_text", titleExpression="sample_text")
    b1 = RepresentationDescription()
    b2 = RepresentationDescription()
    ...
    if hasattr(b1, 'RepresentationDescription156'):
        assert _is_linked(b1, 'RepresentationDescription156', a)
    ...
    if hasattr(b1, 'RepresentationDescription156'):
        assert not _is_linked(b1, 'RepresentationDescription156', a)
    if hasattr(b2, 'RepresentationDescription156'):
        assert _is_linked(b2, 'RepresentationDescription156', a)
    ...
    if hasattr(b2, 'RepresentationDescription156'):
        assert not _is_linked(b2, 'RepresentationDescription156', a)


def test_assoc_representationDescription165_link_reassign_clear():
    a = viewpoint_tool_RepresentationNavigationDescription(browseExpression="sample_text", navigationNameExpression="sample_text")
    b1 = RepresentationDescription()
    b2 = RepresentationDescription()
    ...
    if hasattr(b1, 'RepresentationDescription166'):
        assert _is_linked(b1, 'RepresentationDescription166', a)
    ...
    if hasattr(b1, 'RepresentationDescription166'):
        assert not _is_linked(b1, 'RepresentationDescription166', a)
    if hasattr(b2, 'RepresentationDescription166'):
        assert _is_linked(b2, 'RepresentationDescription166', a)
    ...
    if hasattr(b2, 'RepresentationDescription166'):
        assert not _is_linked(b2, 'RepresentationDescription166', a)


def test_assoc_representationElements20_link_reassign_clear():
    a = viewpoint_DRepresentationElement(name="sample_text")
    b1 = viewpoint_DRepresentation(name="sample_text")
    b2 = viewpoint_DRepresentation(name="sample_text_2")
    _safe_set(a, 'viewpoint_DRepresentationElement22', b1)
    assert _is_linked(a, 'viewpoint_DRepresentationElement22', b1)
    if hasattr(b1, 'viewpoint_DRepresentation21'):
        assert _is_linked(b1, 'viewpoint_DRepresentation21', a)
    _safe_set(a, 'viewpoint_DRepresentationElement22', b2)
    assert _is_linked(a, 'viewpoint_DRepresentationElement22', b2)
    if hasattr(b1, 'viewpoint_DRepresentation21'):
        assert not _is_linked(b1, 'viewpoint_DRepresentation21', a)
    if hasattr(b2, 'viewpoint_DRepresentation21'):
        assert _is_linked(b2, 'viewpoint_DRepresentation21', a)
    _safe_set(a, 'viewpoint_DRepresentationElement22', None)
    assert not _is_linked(a, 'viewpoint_DRepresentationElement22', b2)
    if hasattr(b2, 'viewpoint_DRepresentation21'):
        assert not _is_linked(b2, 'viewpoint_DRepresentation21', a)


def test_assoc_representationNameVariable163_link_reassign_clear():
    a = viewpoint_tool_RepresentationCreationDescription(browseExpression="sample_text", titleExpression="sample_text")
...
def test_assoc_representationNameVariable173_link_reassign_clear():
    a = viewpoint_tool_RepresentationNavigationDescription(browseExpression="sample_text", navigationNameExpression="sample_text")
    b1 = tool_NameVariable()
    b2 = tool_NameVariable()
    ...
    if hasattr(b1, 'tool_NameVariable175'):
        assert _is_linked(b1, 'tool_NameVariable175', a)
    ...
    if hasattr(b1, 'tool_NameVariable175'):
        assert not _is_linked(b1, 'tool_NameVariable175', a)
    if hasattr(b2, 'tool_NameVariable175'):
        assert _is_linked(b2, 'tool_NameVariable175', a)
    ...
    if hasattr(b2, 'tool_NameVariable175'):
        assert not _is_linked(b2, 'tool_NameVariable175', a)


def test_assoc_reusedRules204_link_reassign_clear():
    a = viewpoint_validation_ValidationSet(name="sample_text")
    b1 = validation_ValidationRule()
    b2 = validation_ValidationRule()
    _safe_set(a, 'viewpoint_validation_ValidationSet205', {b1})
    assert _is_linked(a, 'viewpoint_validation_ValidationSet205', b1)
    if hasattr(b1, 'validation_ValidationRule206'):
        assert _is_linked(b1, 'validation_ValidationRule206', a)
    _safe_set(a, 'viewpoint_validation_ValidationSet205', {b2})
    assert _is_linked(a, 'viewpoint_validation_ValidationSet205', b2)
    if hasattr(b1, 'validation_ValidationRule206'):
        assert not _is_linked(b1, 'validation_ValidationRule206', a)
    if hasattr(b2, 'validation_ValidationRule206'):
        assert _is_linked(b2, 'validation_ValidationRule206', a)
    _safe_set(a, 'viewpoint_validation_ValidationSet205', set())
    assert not _is_linked(a, 'viewpoint_validation_ValidationSet205', b2)
    if hasattr(b2, 'validation_ValidationRule206'):
        assert not _is_linked(b2, 'validation_ValidationRule206', a)
...
def test_assoc_semanticElements27_link_reassign_clear():
    a = viewpoint_DRepresentationElement(name="sample_text")
    b1 = viewpoint_EObject()
    b2 = viewpoint_EObject()
    _safe_set(a, 'viewpoint_DRepresentationElement28', {b1})
    assert _is_linked(a, 'viewpoint_DRepresentationElement28', b1)
    if hasattr(b1, 'viewpoint_EObject29'):
        assert _is_linked(b1, 'viewpoint_EObject29', a)
    _safe_set(a, 'viewpoint_DRepresentationElement28', {b2})
    assert _is_linked(a, 'viewpoint_DRepresentationElement28', b2)
    if hasattr(b1, 'viewpoint_EObject29'):
        assert not _is_linked(b1, 'viewpoint_EObject29', a)
    if hasattr(b2, 'viewpoint_EObject29'):
        assert _is_linked(b2, 'viewpoint_EObject29', a)
    _safe_set(a, 'viewpoint_DRepresentationElement28', set())
    assert not _is_linked(a, 'viewpoint_DRepresentationElement28', b2)
    if hasattr(b2, 'viewpoint_EObject29'):
        assert not _is_linked(b2, 'viewpoint_EObject29', a)


def test_assoc_systemColorsPalette57_link_reassign_clear():
    a = viewpoint_description_Group(name="sample_text", version="sample_text")
    b1 = SytemColorsPalette()
    b2 = SytemColorsPalette()
    _safe_set(a, 'viewpoint_description_Group58', b1)
    assert _is_linked(a, 'viewpoint_description_Group58', b1)
    if hasattr(b1, 'SytemColorsPalette'):
        assert _is_linked(b1, 'SytemColorsPalette', a)
    _safe_set(a, 'viewpoint_description_Group58', b2)
    assert _is_linked(a, 'viewpoint_description_Group58', b2)
    if hasattr(b1, 'SytemColorsPalette'):
        assert not _is_linked(b1, 'SytemColorsPalette', a)
    if hasattr(b2, 'SytemColorsPalette'):
        assert _is_linked(b2, 'SytemColorsPalette', a)
    _safe_set(a, 'viewpoint_description_Group58', None)
    assert not _is_linked(a, 'viewpoint_description_Group58', b2)
    if hasattr(b2, 'SytemColorsPalette'):
        assert not _is_linked(b2, 'SytemColorsPalette', a)


def test_assoc_uiState25_link_reassign_clear():
    a = viewpoint_UIState(inverseSelectionOrder=True)
    b1 = viewpoint_DRepresentation(name="sample_text")
    b2 = viewpoint_DRepresentation(name="sample_text_2")
...
def test_assoc_userColorsPalettes59_link_reassign_clear():
    a = viewpoint_description_Group(name="sample_text", version="sample_text")
    b1 = UserColorsPalette()
    b2 = UserColorsPalette()
    _safe_set(a, 'viewpoint_description_Group60', {b1})
    assert _is_linked(a, 'viewpoint_description_Group60', b1)
    if hasattr(b1, 'UserColorsPalette'):
        assert _is_linked(b1, 'UserColorsPalette', a)
    _safe_set(a, 'viewpoint_description_Group60', {b2})
    assert _is_linked(a, 'viewpoint_description_Group60', b2)
    if hasattr(b1, 'UserColorsPalette'):
        assert not _is_linked(b1, 'UserColorsPalette', a)
    if hasattr(b2, 'UserColorsPalette'):
        assert _is_linked(b2, 'UserColorsPalette', a)
    _safe_set(a, 'viewpoint_description_Group60', set())
    assert not _is_linked(a, 'viewpoint_description_Group60', b2)
    if hasattr(b2, 'UserColorsPalette'):
        assert not _is_linked(b2, 'UserColorsPalette', a)


def test_assoc_validationSet63_link_reassign_clear():
    a = viewpoint_description_Viewpoint(conflicts="sample_text", customizes="sample_text", icon="sample_text", modelFileExtension="sample_text", reuses="sample_text")
...
def test_assoc_value100_link_reassign_clear():
    ...
    if hasattr(b1, 'description_viewpoint_EObject101'):
        assert _is_linked(b1, 'description_viewpoint_EObject101', a)
    ...
    if hasattr(b1, 'description_viewpoint_EObject101'):
        assert not _is_linked(b1, 'description_viewpoint_EObject101', a)
    if hasattr(b2, 'description_viewpoint_EObject101'):
        assert _is_linked(b2, 'description_viewpoint_EObject101', a)
    ...
    if hasattr(b2, 'description_viewpoint_EObject101'):
        assert not _is_linked(b2, 'description_viewpoint_EObject101', a)


def test_assoc_valueType114_link_reassign_clear():
