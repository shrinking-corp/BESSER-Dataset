...
class education_School:
    ...
    def __init__(self, name: str, address: str, phone: str, education_School: set["education_Student"] = None, education_School14: "education_Course" = None, education_School2: set["education_Course"] = None, education_School5: "education_Student" = None):
        self.name = name
...
class education_Course:
    ...
    def __init__(self, name: str, education_Course13: "education_School" = None, education_Course: "education_School" = None, education_Course8: "education_Student" = None, education_Course10: set["education_Student"] = None):
        self.name = name
