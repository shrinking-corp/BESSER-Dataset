...
public class Name  {
    ...
    private DOM_ThisExpression dom_thisexpression;




    private DOM_SimpleType dom_simpletype;
    ...
    public DOM_ThisExpression getDom_thisexpression() {
        return dom_thisexpression;
    }

    public void setDom_thisexpression(DOM_ThisExpression dom_thisexpression) {
        this.dom_thisexpression = dom_thisexpression;
    }
    public DOM_SimpleType getDom_simpletype() {
        return dom_simpletype;
    }

    public void setDom_simpletype(DOM_SimpleType dom_simpletype) {
        this.dom_simpletype = dom_simpletype;
    }
