...
def test_hyp_test2_test22_b_is_not_abstract():
    assert not inspect.isabstract(test2_test22_B)


def test_hyp_test2_test22_b_constructor_exists():
    assert callable(test2_test22_B.__init__)


def test_hyp_test2_test22_b_constructor_args():
...
def test_hyp_test2_a_is_not_abstract():
    assert not inspect.isabstract(test2_A)


def test_hyp_test2_a_constructor_exists():
    assert callable(test2_A.__init__)


def test_hyp_test2_a_constructor_args():
...
def test_hyp_test2_test22_b_nb_setter(instance):
...
@given(instance=test2_test22_B_strategy)
def test_hyp_test2_test22_b_nb2_setter(instance):
