...
# Classes
subsetUnion_Container = Class(name="subsetUnion_Container")
subsetUnion_Element = Class(name="subsetUnion_Element")
subsetUnion_Element_Level6 = Class(name="subsetUnion_Element_Level6")
subsetUnion_Element_Level7 = Class(name="subsetUnion_Element_Level7")
subsetUnion_Element_Level8 = Class(name="subsetUnion_Element_Level8")
subsetUnion_Element_Level9 = Class(name="subsetUnion_Element_Level9")
subsetUnion_Element_Level10 = Class(name="subsetUnion_Element_Level10")
Element = Class(name="Element")
subsetUnion_Element_Level1 = Class(name="subsetUnion_Element_Level1")
subsetUnion_Element_Level2 = Class(name="subsetUnion_Element_Level2")
subsetUnion_Element_Level3 = Class(name="subsetUnion_Element_Level3")
subsetUnion_Element_Level4 = Class(name="subsetUnion_Element_Level4")
subsetUnion_Element_Level5 = Class(name="subsetUnion_Element_Level5")
...
domain_model = DomainModel(
    name="subsetUnion",
    types={subsetUnion_Container, subsetUnion_Element, subsetUnion_Element_Level6, subsetUnion_Element_Level7, subsetUnion_Element_Level8, subsetUnion_Element_Level9, subsetUnion_Element_Level10, Element, subsetUnion_Element_Level1, subsetUnion_Element_Level2, subsetUnion_Element_Level3, subsetUnion_Element_Level4, subsetUnion_Element_Level5},
    associations={subset611, subset713, subset815, subset917, subset1019, unionBag0, subset11, subset23, subset35, subset47, subset59},
