...
wh_Definition.attributes={wh_Definition_input, wh_Definition_output}
...
domain_model = DomainModel(
    name="wh",
    types={wh_Definition, wh_Wh, wh_Program, wh_Commands, wh_Command},
    associations={definition1, elements0, command3, commands5},
    generalizations={},
    metadata=None
)
