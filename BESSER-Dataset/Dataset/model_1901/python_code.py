...
class fIDL_VectorType(Type):
    ...
    def __init__(self, nullable: bool, fIDL_VectorType: "fIDL_Type" = None, fIDL_VectorType60: "fIDL_Constant" = None):
        self.nullable = nullable
...
class fIDL_Constant:
    ...
    def __init__(self, ci: str, fIDL_Constant: "fIDL_ConstDeclaration" = None, fIDL_Constant56: "fIDL_ArrayType" = None, fIDL_Constant61: "fIDL_VectorType" = None, fIDL_Constant63: "fIDL_StringType" = None, fIDL_Constant43: "fIDL_StructField" = None):
        self.ci = ci
...
class fIDL_InterfaceDeclaration(Declaration):
    ...
    pass
class fIDL_ConstDeclaration(Declaration, InterfaceMember):

    pass
class fIDL_Declaration:

    def __init__(self, name: str, fIDL_Declaration: "fIDL_AttributedDeclaration" = None, fIDL_Declaration65: "fIDL_RequestType" = None, fIDL_Declaration51: "fIDL_IdentifierType" = None):
        self.name = name
...
class fIDL_Parameter:
    ...
    def __init__(self, name: str, fIDL_Parameter: "fIDL_ParameterList" = None, fIDL_Parameter30: "fIDL_Type" = None):
        self.name = name
...
class fIDL_InterfaceParameters:
    ...
    def __init__(self, name: str, resultName: str, fIDL_InterfaceParameters23: "fIDL_ParameterList" = None, fIDL_InterfaceParameters25: "fIDL_ParameterList" = None, fIDL_InterfaceParameters: "fIDL_InterfaceMethod" = None):
        self.name = name
...
class fIDL_Expression(Literal, EnumMemberValue):
