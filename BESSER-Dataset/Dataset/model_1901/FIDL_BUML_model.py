...
# Classes
fIDL_File = Class(name="fIDL_File")
fIDL_LibraryHeader = Class(name="fIDL_LibraryHeader")
File = Class(name="File")
fIDL_Using = Class(name="fIDL_Using")
fIDL_AttributedDeclaration = Class(name="fIDL_AttributedDeclaration")
fIDL_InterfaceMember = Class(name="fIDL_InterfaceMember")
fIDL_InterfaceMethod = Class(name="fIDL_InterfaceMethod")
fIDL_Expression = Class(name="fIDL_Expression")
fIDL_InterfaceParameters = Class(name="fIDL_InterfaceParameters")
fIDL_ParameterList = Class(name="fIDL_ParameterList")
fIDL_Parameter = Class(name="fIDL_Parameter")
fIDL_StructDeclaration = Class(name="fIDL_StructDeclaration")
fIDL_StructMember = Class(name="fIDL_StructMember")
fIDL_Attribute = Class(name="fIDL_Attribute")
fIDL_Declaration = Class(name="fIDL_Declaration")
fIDL_ConstDeclaration = Class(name="fIDL_ConstDeclaration")
Declaration = Class(name="Declaration")
InterfaceMember = Class(name="InterfaceMember")
fIDL_Type = Class(name="fIDL_Type")
fIDL_Constant = Class(name="fIDL_Constant")
fIDL_EnumDeclaration = Class(name="fIDL_EnumDeclaration")
fIDL_IntegerType = Class(name="fIDL_IntegerType")
fIDL_EnumMember = Class(name="fIDL_EnumMember")
fIDL_EnumMemberValue = Class(name="fIDL_EnumMemberValue")
fIDL_InterfaceDeclaration = Class(name="fIDL_InterfaceDeclaration")
fIDL_VectorType = Class(name="fIDL_VectorType")
fIDL_StringType = Class(name="fIDL_StringType")
fIDL_HandleType = Class(name="fIDL_HandleType")
fIDL_RequestType = Class(name="fIDL_RequestType")
fIDL_PrimitiveType = Class(name="fIDL_PrimitiveType")
PrimitiveType = Class(name="PrimitiveType")
fIDL_Literal = Class(name="fIDL_Literal")
Constant = Class(name="Constant")
fIDL_StructField = Class(name="fIDL_StructField")
fIDL_UnionDeclaration = Class(name="fIDL_UnionDeclaration")
fIDL_UnionMember = Class(name="fIDL_UnionMember")
fIDL_UnionField = Class(name="fIDL_UnionField")
UnionMember = Class(name="UnionMember")
fIDL_IdentifierType = Class(name="fIDL_IdentifierType")
Type = Class(name="Type")
fIDL_ArrayType = Class(name="fIDL_ArrayType")
fIDL_Uint8Type = Class(name="fIDL_Uint8Type")
fIDL_Uint16Type = Class(name="fIDL_Uint16Type")
fIDL_Uint32Type = Class(name="fIDL_Uint32Type")
fIDL_Uint64Type = Class(name="fIDL_Uint64Type")
fIDL_BooleanLiteral = Class(name="fIDL_BooleanLiteral")
Expression = Class(name="Expression")
fIDL_NumberLiteral = Class(name="fIDL_NumberLiteral")
fIDL_StringLiteral = Class(name="fIDL_StringLiteral")
EnumMemberValue = Class(name="EnumMemberValue")
Literal = Class(name="Literal")
fIDL_StatusType = Class(name="fIDL_StatusType")
fIDL_BooleanType = Class(name="fIDL_BooleanType")
fIDL_Float32Type = Class(name="fIDL_Float32Type")
fIDL_Float64Type = Class(name="fIDL_Float64Type")
fIDL_Int8Type = Class(name="fIDL_Int8Type")
IntegerType = Class(name="IntegerType")
fIDL_Int16Type = Class(name="fIDL_Int16Type")
fIDL_Int32Type = Class(name="fIDL_Int32Type")
fIDL_Int64Type = Class(name="fIDL_Int64Type")
...
fIDL_InterfaceParameters.attributes={fIDL_InterfaceParameters_name, fIDL_InterfaceParameters_resultName}
...
fIDL_Attribute.attributes={fIDL_Attribute_name, fIDL_Attribute_value}
...
fIDL_HandleType.attributes={fIDL_HandleType_nullable, fIDL_HandleType_type}
...
domain_model = DomainModel(
    name="fIDL",
    types={fIDL_File, fIDL_LibraryHeader, File, fIDL_Using, fIDL_AttributedDeclaration, fIDL_InterfaceMember, fIDL_InterfaceMethod, fIDL_Expression, fIDL_InterfaceParameters, fIDL_ParameterList, fIDL_Parameter, fIDL_StructDeclaration, fIDL_StructMember, fIDL_Attribute, fIDL_Declaration, fIDL_ConstDeclaration, Declaration, InterfaceMember, fIDL_Type, fIDL_Constant, fIDL_EnumDeclaration, fIDL_IntegerType, fIDL_EnumMember, fIDL_EnumMemberValue, fIDL_InterfaceDeclaration, fIDL_VectorType, fIDL_StringType, fIDL_HandleType, fIDL_RequestType, fIDL_PrimitiveType, PrimitiveType, fIDL_Literal, Constant, fIDL_StructField, fIDL_UnionDeclaration, fIDL_UnionMember, fIDL_UnionField, UnionMember, fIDL_IdentifierType, Type, fIDL_ArrayType, fIDL_Uint8Type, fIDL_Uint16Type, fIDL_Uint32Type, fIDL_Uint64Type, fIDL_BooleanLiteral, Expression, fIDL_NumberLiteral, fIDL_StringLiteral, EnumMemberValue, Literal, fIDL_StatusType, fIDL_BooleanType, fIDL_Float32Type, fIDL_Float64Type, fIDL_Int8Type, IntegerType, fIDL_Int16Type, fIDL_Int32Type, fIDL_Int64Type},
    associations={usings0, declarations1, superInterfaces16, members17, ordinal19, method20, parameters22, result24, parameters27, type29, members32, attributes3, declaration5, type7, value8, type10, members11, value13, type52, constraint54, type57, constraint59, constraint62, ref64, field33, constant35, type38, value41, members44, fields46, type48, ref50},
    generalizations={gen_fIDL_LibraryHeader_File, gen_fIDL_InterfaceMethod_InterfaceMember, gen_fIDL_StructDeclaration_Declaration, gen_fIDL_ConstDeclaration_Declaration, gen_fIDL_ConstDeclaration_InterfaceMember, gen_fIDL_EnumDeclaration_Declaration, gen_fIDL_InterfaceDeclaration_Declaration, gen_fIDL_VectorType_Type, gen_fIDL_StringType_Type, gen_fIDL_HandleType_Type, gen_fIDL_RequestType_Type, gen_fIDL_PrimitiveType_Type, gen_fIDL_IntegerType_PrimitiveType, gen_fIDL_Literal_Constant, gen_fIDL_UnionDeclaration_Declaration, gen_fIDL_UnionField_UnionMember, gen_fIDL_IdentifierType_Type, gen_fIDL_ArrayType_Type, gen_fIDL_Uint8Type_IntegerType, gen_fIDL_Uint16Type_IntegerType, gen_fIDL_Uint32Type_IntegerType, gen_fIDL_Uint64Type_IntegerType, gen_fIDL_BooleanLiteral_Expression, gen_fIDL_NumberLiteral_Expression, gen_fIDL_StringLiteral_Expression, gen_fIDL_Expression_EnumMemberValue, gen_fIDL_Expression_Literal, gen_fIDL_StatusType_PrimitiveType, gen_fIDL_BooleanType_PrimitiveType, gen_fIDL_Float32Type_PrimitiveType, gen_fIDL_Float64Type_PrimitiveType, gen_fIDL_Int8Type_IntegerType, gen_fIDL_Int16Type_IntegerType, gen_fIDL_Int32Type_IntegerType, gen_fIDL_Int64Type_IntegerType},
    metadata=None
)
