...
class FSM_AbstractState(ABC):
    ...
    def __init__(self, name: str, envs: str, FSM_AbstractState: "FSM_StateMachine" = None, FSM_AbstractState4: set["FSM_Transition"] = None, FSM_AbstractState7: set["FSM_Transition"] = None):
        self.name = name
        self.envs = envs
