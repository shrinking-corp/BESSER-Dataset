...
@given(instance=spinefm_ActionModel_Action_strategy)
def test_hyp_spinefm_actionmodel_action_type_setter(instance):
...
@given(instance=spinefm_ProcessModel_ContextManager_strategy)
@settings(max_examples=30)
def test_hyp_spinefm_processmodel_contextmanager_createnewcontextcloningcps_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
