...
micro_Attribute.attributes={micro_Attribute_name, micro_Attribute_isId, micro_Attribute_isMany, micro_Attribute_isGenerated}
...
domain_model = DomainModel(
    name="micro",
    types={micro_Model, micro_MicroserviceArchitecture, NamedElement, micro_Service, micro_Event, micro_Saga, micro_Attribute, micro_AggregateService, Service, micro_Operation, micro_API, micro_ViewService, micro_NamedElement, micro_Command, micro_Info, micro_Step, micro_Data, micro_ReferenceAttribute, Attribute, micro_PrimitiveTypeAttribute, CRUDOperation, AttributePrimitiveValue, CommandType},
    associations={services0, publish9, Saga10, attributes1, aggregateService2, operation3, api4, models5, replicateServices7, api23, dto25, model12, aggregateService14, events16, commands17, infos19, replyInfo21, api22, ModelToView41, api28, commands30, Steps32, Data35, model37, type39},
    generalizations={gen_micro_Model_NamedElement, gen_micro_MicroserviceArchitecture_NamedElement, gen_micro_Service_NamedElement, gen_micro_AggregateService_Service, gen_micro_ViewService_Service, gen_micro_Operation_NamedElement, gen_micro_Info_NamedElement, gen_micro_API_NamedElement, gen_micro_Command_NamedElement, gen_micro_Event_NamedElement, gen_micro_Step_NamedElement, gen_micro_Saga_NamedElement, gen_micro_Data_NamedElement, gen_micro_ReferenceAttribute_Attribute, gen_micro_PrimitiveTypeAttribute_Attribute},
    metadata=None
)
