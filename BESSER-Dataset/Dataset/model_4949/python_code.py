...
class micro_AggregateService(Service):
    ...
    def __init__(self, AggregateService: "micro_Model" = None, aggregateService: set["micro_Operation"] = None, micro_AggregateService: "micro_API" = None, aggregateService6: set["micro_Model"] = None, micro_AggregateService8: "micro_ViewService" = None, AggregateService15: "micro_Operation" = None):
...
class micro_Operation(NamedElement):
    ...
    def __init__(self, operationType: str, isMethodController: bool, micro_Operation: "micro_Event" = None, micro_Operation11: "micro_Saga" = None, Operation: "micro_AggregateService" = None, micro_Operation13: "micro_Model" = None, operation: "micro_AggregateService" = None):
