...
# Classes
testscenario_M = Class(name="testscenario_M")
testscenario_L = Class(name="testscenario_L")
M = Class(name="M")
testscenario_K = Class(name="testscenario_K")
L = Class(name="L")
testscenario_I = Class(name="testscenario_I")
testscenario_H = Class(name="testscenario_H")
testscenario_G = Class(name="testscenario_G")
H = Class(name="H")
testscenario_F = Class(name="testscenario_F")
testscenario_E = Class(name="testscenario_E")
K = Class(name="K")
D = Class(name="D")
C = Class(name="C")
F = Class(name="F")
G = Class(name="G")
I = Class(name="I")
testscenario_D = Class(name="testscenario_D")
B = Class(name="B")
testscenario_C = Class(name="testscenario_C")
A = Class(name="A")
testscenario_B = Class(name="testscenario_B")
testscenario_A = Class(name="testscenario_A")
...
domain_model = DomainModel(
    name="testscenario",
    types={testscenario_M, testscenario_L, M, testscenario_K, L, testscenario_I, testscenario_H, testscenario_G, H, testscenario_F, testscenario_E, K, D, C, F, G, I, testscenario_D, B, testscenario_C, A, testscenario_B, testscenario_A},
    associations={},
    generalizations={gen_testscenario_L_M, gen_testscenario_K_L, gen_testscenario_G_H, gen_testscenario_E_K, gen_testscenario_E_D, gen_testscenario_E_C, gen_testscenario_E_F, gen_testscenario_E_G, gen_testscenario_E_I, gen_testscenario_D_B, gen_testscenario_C_A, gen_testscenario_B_A},
    metadata=None
)
