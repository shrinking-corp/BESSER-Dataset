...
Product.attributes={Product_id, Product_description, Product_name}
...
Order.attributes={Order_shippingAddress, Order_id, Order_finalTotal, Order_status}
...
Customer.attributes={Customer_emailAddress, Customer_login, Customer_lastname, Customer_isBan, Customer_id, Customer_firstname, Customer_password}
...
association8: BinaryAssociation = BinaryAssociation(
    name="association8",
    ends={
        Property(name="item2", type=Item, multiplicity=Multiplicity(1, 9999)),
...
domain_model = DomainModel(
    name="_1f95feba_870d_4bbc_b379_8d49254da1c6",
    types={ShoppingCart, Item, Product, Account, Payment, Order, Customer, OrderStatus},
    associations={association2, association8},
    generalizations={},
    metadata=None
)
