...
entities_SimpleProperty = Class(name="entities_SimpleProperty")
Property_ = Class(name="Property")
entities_ReferenceProperty = Class(name="entities_ReferenceProperty")
...
domain_model = DomainModel(
    name="entities",
    types={entities_Entity, entities_Property, entities_SimpleProperty, Property_, entities_ReferenceProperty, entities_Model},
