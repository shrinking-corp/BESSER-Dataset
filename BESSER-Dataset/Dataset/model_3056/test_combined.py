...
def test_hyp_entities_referenceproperty_is_not_abstract():
    assert not inspect.isabstract(entities_ReferenceProperty)


def test_hyp_entities_referenceproperty_constructor_exists():
    assert callable(entities_ReferenceProperty.__init__)


def test_hyp_entities_referenceproperty_constructor_args():
...
def test_hyp_entities_referenceproperty_many_setter(instance):
...
def test_hyp_entities_simpleproperty_type_setter(instance):
