...
school_Faculty = Class(name="school_Faculty")
school_CourseOfStudy = Class(name="school_CourseOfStudy")
school_Course = Class(name="school_Course")
school_Student = Class(name="school_Student")
school_Teacher = Class(name="school_Teacher")
school_CourseResult = Class(name="school_CourseResult")
school_Query = Class(name="school_Query")
school_Where = Class(name="school_Where")
school_BooleanExpr = Class(name="school_BooleanExpr")
school_SchoolDatabase = Class(name="school_SchoolDatabase")
...
school_Course.attributes={school_Course_name, school_Course_courseNumber}
...
school_Student.attributes={school_Student_studentNumber, school_Student_name}
...
and_36: BinaryAssociation = BinaryAssociation(
    name="and_36",
    ends={
...
or_39: BinaryAssociation = BinaryAssociation(
    name="or_39",
    ends={
...
domain_model = DomainModel(
    name="school",
    types={school_School, school_Faculty, school_CourseOfStudy, school_Course, school_Student, school_Teacher, school_CourseResult, school_Query, school_Where, school_BooleanExpr, school_SchoolDatabase, SchoolElement},
    associations={faculty0, courseofstudy1, course3, student5, teacher7, courseofstudy9, course10, enrolledStudent16, taughtBy18, courseresult19, enrolledIn20, courseofstudy21, teaches23, student25, course27, student29, where31, booleanexpr33, and_36, or_39, faculty13, student14, query43, school41},
    generalizations={},
    metadata=None
)
