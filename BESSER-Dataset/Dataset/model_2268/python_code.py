...
class school_Query:
    ...
    def __init__(self, type: str, school_Query: "school_Student" = None, school_Query32: "school_Where" = None, school_Query45: "school_SchoolDatabase" = None):
        self.type = type
...
class school_CourseResult:
    ...
    def __init__(self, grade: str, school_CourseResult: "school_Student" = None, courseresult: "school_Course" = None, CourseResult: "school_Course" = None):
        self.grade = grade
...
class school_Teacher:
    ...
    def __init__(self, name: str, taughtBy: set["school_Course"] = None, school_Teacher: "school_School" = None, Teacher: "school_Course" = None):
        self.name = name
...
class school_Student:
    ...
    def __init__(self, name: str, studentNumber: str, student: "school_CourseOfStudy" = None, school_Student26: "school_CourseResult" = None, school_Student30: "school_Query" = None, Student: "school_CourseOfStudy" = None, school_Student: "school_School" = None, Student17: "school_Course" = None, enrolledStudent: set["school_Course"] = None):
        self.name = name
...
class school_Course:
    ...
    def __init__(self, name: str, courseNumber: str, Course24: "school_Teacher" = None, Course28: "school_CourseResult" = None, school_Course: "school_School" = None, school_Course12: "school_CourseOfStudy" = None, enrolledIn: set["school_Student"] = None, teaches: "school_Teacher" = None, course: set["school_CourseResult"] = None, Course: "school_Student" = None):
        self.name = name
...
class school_CourseOfStudy:
    ...
    def __init__(self, name: str, courseofstudy: "school_Faculty" = None, courseofstudy15: set["school_Student"] = None, school_CourseOfStudy: "school_School" = None, CourseOfStudy: "school_Faculty" = None, school_CourseOfStudy11: set["school_Course"] = None, CourseOfStudy22: "school_Student" = None):
        self.name = name
...
class school_Faculty:
    ...
    def __init__(self, name: str, Faculty: "school_CourseOfStudy" = None, school_Faculty: "school_School" = None, faculty: set["school_CourseOfStudy"] = None):
        self.name = name
...
class school_School:
    ...
    def __init__(self, name: str, school_School42: "school_SchoolDatabase" = None, school_School: set["school_Faculty"] = None, school_School2: set["school_CourseOfStudy"] = None, school_School4: set["school_Course"] = None, school_School6: set["school_Student"] = None, school_School8: set["school_Teacher"] = None):
        self.name = name
