...
# Classes
model_FSM = Class(name="model_FSM")
model_Buffer = Class(name="model_Buffer")
model_System = Class(name="model_System")
...
model_Transition.attributes={model_Transition_trigger, model_Transition_name, model_Transition_action}
...
domain_model = DomainModel(
    name="model",
    types={model_FSM, model_Buffer, model_System, model_State, model_Transition},
    associations={ownedTransitions1, inputBuffer3, outputBuffer4, initialState6, incoming7, outgoing9, fsm11, outgoingFSM12, incomingFSM14, tgt16, src18, fsm20, ownedFsms22, ownedStates0, ownedBuffers24},
    generalizations={},
    metadata=None
)
