...
walid = Class(name="walid", is_abstract=True)
...
# walid class attributes and methods
...
domain_model = DomainModel(
    name="e5b1d356_c21a_4081_bce3_a0791cae9b6c",
    types={CPU, Processor, AcceleratorCard, Cache, RAM, Machine, Program, Instruction, Memory_Interface, walid, Card, Sound, GenericSound, Vendor1Adapter, Vendor2Adapter, Vendor1Sound, Vendor2Sound, ExtensionBoard, FastCard},
