...
PetriNets_Transition.methods={PetriNets_Transition_m_ins, PetriNets_Transition_m_net, PetriNets_Transition_m_outs}
...
domain_model = DomainModel(
    name="PetriNets",
    types={PetriNets_Place, PetriNets_Transition, PetriNets_PetriNet},
    associations={},
    generalizations={},
    metadata=None
)
