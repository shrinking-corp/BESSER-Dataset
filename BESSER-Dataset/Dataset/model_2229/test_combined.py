...
def test_hyp_studyprograms_individualstudyplan_is_not_abstract():
    assert not inspect.isabstract(studyprograms_IndividualStudyPlan)


def test_hyp_studyprograms_individualstudyplan_constructor_exists():
    assert callable(studyprograms_IndividualStudyPlan.__init__)


def test_hyp_studyprograms_individualstudyplan_constructor_args():
...
def test_hyp_studyprograms_individualstudyplan_studentNo_setter(instance):
