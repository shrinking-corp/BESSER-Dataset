...
def test_studyprograms_individualstudyplan_is_not_abstract():
    assert not inspect.isabstract(studyprograms_IndividualStudyPlan)


def test_studyprograms_individualstudyplan_constructor_exists():
    assert callable(studyprograms_IndividualStudyPlan.__init__)


def test_studyprograms_individualstudyplan_constructor_args():
    sig = inspect.signature(studyprograms_IndividualStudyPlan.__init__)
    params = list(sig.parameters.keys())
    assert "studentNo" in params, "Missing parameter 'studentNo'"

def test_studyprograms_individualstudyplan_has_studentNo():
    assert hasattr(studyprograms_IndividualStudyPlan, "studentNo")
    descriptor = None
    for klass in studyprograms_IndividualStudyPlan.__mro__:
...
studyprograms_IndividualStudyPlan_strategy = st.builds(
    studyprograms_IndividualStudyPlan,
    studentNo=
        safe_text
)
...
@given(instance=studyprograms_IndividualStudyPlan_strategy)
def test_studyprograms_individualstudyplan_studentNo_setter(instance):
