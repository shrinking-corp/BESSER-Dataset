...
# Classes
StructuredTree_BranchKind = Class(name="StructuredTree_BranchKind")
StructuredTree_LeafKind = Class(name="StructuredTree_LeafKind")
NodeKind = Class(name="NodeKind")
StructuredTree_Tree = Class(name="StructuredTree_Tree")
StructuredTree_NodeKind = Class(name="StructuredTree_NodeKind")
...
domain_model = DomainModel(
    name="StructuredTree",
    types={StructuredTree_BranchKind, StructuredTree_LeafKind, NodeKind, StructuredTree_Tree, StructuredTree_NodeKind},
    associations={tree1, parent2, children3, root0},
