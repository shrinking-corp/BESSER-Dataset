...
# Classes
kwas_Top = Class(name="kwas_Top")
kwas_Tree = Class(name="kwas_Tree", is_abstract=True)
kwas_Bin = Class(name="kwas_Bin")
Tree = Class(name="Tree")
kwas_Leaf = Class(name="kwas_Leaf")
...
kwas_Tree.attributes={kwas_Tree_labelI, kwas_Tree_valsS, kwas_Tree_valsI, kwas_Tree_labelS}
