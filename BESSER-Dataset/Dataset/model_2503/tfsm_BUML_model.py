...
# Classes
tfsm_TimedFSM = Class(name="tfsm_TimedFSM")
FSM = Class(name="FSM")
tfsm_Clock = Class(name="tfsm_Clock")
tfsm_TimedState = Class(name="tfsm_TimedState")
State = Class(name="State")
tfsm_ClockConstraintOperation = Class(name="tfsm_ClockConstraintOperation", is_abstract=True)
tfsm_TimedTransition = Class(name="tfsm_TimedTransition")
Transition = Class(name="Transition")
tfsm_ClockReset = Class(name="tfsm_ClockReset")
tfsm_ClockConstraint = Class(name="tfsm_ClockConstraint", is_abstract=True)
ClockConstraintOperation = Class(name="ClockConstraintOperation")
tfsm_LowerClockConstraint = Class(name="tfsm_LowerClockConstraint")
ClockConstraint = Class(name="ClockConstraint")
tfsm_LowerEqualClockConstraint = Class(name="tfsm_LowerEqualClockConstraint")
tfsm_UpperClockConstraint = Class(name="tfsm_UpperClockConstraint")
tfsm_UpperEqualClockConstraint = Class(name="tfsm_UpperEqualClockConstraint")
tfsm_AndClockConstraint = Class(name="tfsm_AndClockConstraint")
BinaryClockConstraint = Class(name="BinaryClockConstraint")
tfsm_OrClockConstraint = Class(name="tfsm_OrClockConstraint")
tfsm_BinaryClockConstraint = Class(name="tfsm_BinaryClockConstraint", is_abstract=True)
tfsm_TimedFinalState = Class(name="tfsm_TimedFinalState")
FinalState = Class(name="FinalState")
TimedState = Class(name="TimedState")
tfsm_TimedInitialState = Class(name="tfsm_TimedInitialState")
...
domain_model = DomainModel(
    name="tfsm",
    types={tfsm_TimedFSM, FSM, tfsm_Clock, tfsm_TimedState, State, tfsm_ClockConstraintOperation, tfsm_TimedTransition, Transition, tfsm_ClockReset, tfsm_ClockConstraint, ClockConstraintOperation, tfsm_LowerClockConstraint, ClockConstraint, tfsm_LowerEqualClockConstraint, tfsm_UpperClockConstraint, tfsm_UpperEqualClockConstraint, tfsm_AndClockConstraint, BinaryClockConstraint, tfsm_OrClockConstraint, tfsm_BinaryClockConstraint, tfsm_TimedFinalState, FinalState, TimedState, tfsm_TimedInitialState, InitialState},
    associations={clocks0, stateguard1, clockresets2, transitionguard3, clock6, clock8, left11, right13},
    generalizations={gen_tfsm_TimedFSM_FSM, gen_tfsm_TimedState_State, gen_tfsm_TimedTransition_Transition, gen_tfsm_ClockConstraint_ClockConstraintOperation, gen_tfsm_LowerClockConstraint_ClockConstraint, gen_tfsm_LowerEqualClockConstraint_ClockConstraint, gen_tfsm_UpperClockConstraint_ClockConstraint, gen_tfsm_UpperEqualClockConstraint_ClockConstraint, gen_tfsm_AndClockConstraint_BinaryClockConstraint, gen_tfsm_OrClockConstraint_BinaryClockConstraint, gen_tfsm_BinaryClockConstraint_ClockConstraintOperation, gen_tfsm_TimedFinalState_FinalState, gen_tfsm_TimedFinalState_TimedState, gen_tfsm_TimedInitialState_TimedState, gen_tfsm_TimedInitialState_InitialState},
    metadata=None
)
