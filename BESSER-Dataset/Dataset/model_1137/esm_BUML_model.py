...
# Classes
esm_EndState = Class(name="esm_EndState")
State = Class(name="State")
esm_EObject = Class(name="esm_EObject")
esm_Machine = Class(name="esm_Machine")
esm_State = Class(name="esm_State")
esm_Transition = Class(name="esm_Transition")
...
domain_model = DomainModel(
    name="esm",
    types={esm_EndState, State, esm_EObject, esm_Machine, esm_State, esm_Transition},
    associations={incoming3, outgoing4, actionImpl6, source8, target9, states0, transitions1},
