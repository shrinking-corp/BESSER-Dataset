...
class esm_Transition:
    ...
    def __init__(self, action: str, Transition: "esm_State" = None, Transition5: "esm_State" = None, esm_Transition7: "esm_EObject" = None, outgoing: "esm_State" = None, incoming: "esm_State" = None, esm_Transition: "esm_Machine" = None):
        self.action = action
...
class esm_State:
    ...
    def __init__(self, name: str, target: set["esm_Transition"] = None, source: set["esm_Transition"] = None, State: "esm_Transition" = None, State10: "esm_Transition" = None, esm_State: "esm_Machine" = None):
        self.name = name
