...
# Classes
oclstdlib_OclInvalid = Class(name="oclstdlib_OclInvalid", is_abstract=True)
OclVoid = Class(name="OclVoid")
oclstdlib_OclLambda = Class(name="oclstdlib_OclLambda", is_abstract=True)
oclstdlib_Bag = Class(name="oclstdlib_Bag", is_abstract=True)
oclstdlib_Collection = Class(name="oclstdlib_Collection", is_abstract=True)
OclAny = Class(name="OclAny")
oclstdlib_OclAny = Class(name="oclstdlib_OclAny", is_abstract=True)
oclstdlib_OclComparable = Class(name="oclstdlib_OclComparable", is_abstract=True)
oclstdlib_OclElement = Class(name="oclstdlib_OclElement", is_abstract=True)
oclstdlib_OclMessage = Class(name="oclstdlib_OclMessage", is_abstract=True)
oclstdlib_OclState = Class(name="oclstdlib_OclState", is_abstract=True)
oclstdlib_OclSummable = Class(name="oclstdlib_OclSummable", is_abstract=True)
oclstdlib_OclTuple = Class(name="oclstdlib_OclTuple", is_abstract=True)
oclstdlib_OclType = Class(name="oclstdlib_OclType", is_abstract=True)
OclElement = Class(name="OclElement")
oclstdlib_OclVoid = Class(name="oclstdlib_OclVoid", is_abstract=True)
oclstdlib_OrderedCollection = Class(name="oclstdlib_OrderedCollection", is_abstract=True)
oclstdlib_OrderedSet = Class(name="oclstdlib_OrderedSet", is_abstract=True)
oclstdlib_Sequence = Class(name="oclstdlib_Sequence", is_abstract=True)
oclstdlib_Set = Class(name="oclstdlib_Set", is_abstract=True)
oclstdlib_UniqueCollection = Class(name="oclstdlib_UniqueCollection", is_abstract=True)
...
domain_model = DomainModel(
    name="oclstdlib",
    types={oclstdlib_OclInvalid, OclVoid, oclstdlib_OclLambda, oclstdlib_Bag, oclstdlib_Collection, OclAny, oclstdlib_OclAny, oclstdlib_OclComparable, oclstdlib_OclElement, oclstdlib_OclMessage, oclstdlib_OclState, oclstdlib_OclSummable, oclstdlib_OclTuple, oclstdlib_OclType, OclElement, oclstdlib_OclVoid, oclstdlib_OrderedCollection, oclstdlib_OrderedSet, oclstdlib_Sequence, oclstdlib_Set, oclstdlib_UniqueCollection},
    associations={oclContainer1, oclContents3},
    generalizations={gen_oclstdlib_OclInvalid_OclVoid, gen_oclstdlib_OclLambda_OclAny, gen_oclstdlib_Collection_OclAny, gen_oclstdlib_OclComparable_OclAny, gen_oclstdlib_OclElement_OclAny, gen_oclstdlib_OclMessage_OclAny, gen_oclstdlib_OclState_OclAny, gen_oclstdlib_OclSummable_OclAny, gen_oclstdlib_OclTuple_OclAny, gen_oclstdlib_OclType_OclElement, gen_oclstdlib_OclVoid_OclAny},
    metadata=None
)
