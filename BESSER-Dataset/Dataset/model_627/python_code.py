...
class model_Writer:
    ...
    def __init__(self, Pseudonym: bool, firstName: str, lastName: str, EMail: str, BirthDate: date, Writer: "model_Library" = None, writers: set["model_Book"] = None, writers6: "model_Library" = None, Writer8: "model_Book" = None):
...
class model_Library:
    ...
    def __init__(self, name: str, library: set["model_Writer"] = None, model_Library: set["model_Book"] = None, Library: "model_Writer" = None, model_Library3: "model_Librarian" = None):
        self.name = name
