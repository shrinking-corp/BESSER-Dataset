...
model_Writer_m_validate: Method = Method(name="validate", parameters={Parameter(name='model_diagnostic', type=StringType), Parameter(name='model_context', type=StringType)}, type=BooleanType)
model_Writer.attributes={model_Writer_Pseudonym, model_Writer_BirthDate, model_Writer_lastName, model_Writer_firstName, model_Writer_EMail}
...
model_Book_m_validate: Method = Method(name="validate", parameters={Parameter(name='model_context', type=StringType), Parameter(name='model_diagnostic', type=StringType)}, type=BooleanType)
...
model_Librarian_m_validate: Method = Method(name="validate", parameters={Parameter(name='model_diagnostic', type=StringType), Parameter(name='model_context', type=StringType)}, type=BooleanType)
...
domain_model = DomainModel(
    name="model",
    types={model_Library, model_Writer, model_Book, model_Computer, model_Mainboard, model_PowerBlock, model_Container, model_Content, model_TableWithMultiplicity, model_TableContent, model_Librarian, model_TableContentWithValidation, model_TableWithoutMultiplicity, model_TableWithUnique, model_TableContentWithInnerChild2, model_TableContentWithInnerChild, model_TableWithoutMultiplicityConcrete, model_TableContentWithoutValidation, TableContent},
    associations={writers0, books1, books4, library5, writers7, mainboard9, powerBlock10, contents12, librarian2, content14, content16, innerChild18, innerChild20, content22, content13},
    generalizations={gen_model_TableContentWithValidation_TableContent, gen_model_TableContentWithInnerChild2_TableContent, gen_model_TableContentWithInnerChild_TableContent, gen_model_TableContentWithoutValidation_TableContent},
    metadata=None
)
