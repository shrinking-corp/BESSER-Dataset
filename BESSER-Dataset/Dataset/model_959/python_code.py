...
class simplegraph_Node:
    ...
    def __init__(self, name: str, source: set["simplegraph_Edge"] = None, target: set["simplegraph_Edge"] = None, Node: "simplegraph_Edge" = None, Node6: "simplegraph_Edge" = None, simplegraph_Node: "simplegraph_Graph" = None):
        self.name = name
