...
# Classes
statediagram_StateDiagram = Class(name="statediagram_StateDiagram")
statediagram_State = Class(name="statediagram_State")
statediagram_Transition = Class(name="statediagram_Transition")
...
statediagram_State.attributes={statediagram_State_isInitial, statediagram_State_name}
