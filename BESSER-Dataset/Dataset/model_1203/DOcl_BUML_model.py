...
# Classes
docl_Module = Class(name="docl_Module")
docl_OclModel = Class(name="docl_OclModel")
docl_OclExpression = Class(name="docl_OclExpression")
docl_Import = Class(name="docl_Import")
docl_ModuleElement = Class(name="docl_ModuleElement")
docl_URI_ = Class(name="docl_URI_")
docl_Query = Class(name="docl_Query")
ModuleElement = Class(name="ModuleElement")
docl_OclModelElementExp = Class(name="docl_OclModelElementExp")
OclType = Class(name="OclType")
docl_LocalVariable = Class(name="docl_LocalVariable")
docl_Iterator = Class(name="docl_Iterator")
docl_OclType = Class(name="docl_OclType")
docl_TuplePart = Class(name="docl_TuplePart")
docl_PrimitiveExp = Class(name="docl_PrimitiveExp")
OclExpression = Class(name="OclExpression")
docl_NumberLiteralExp = Class(name="docl_NumberLiteralExp")
PrimitiveExp = Class(name="PrimitiveExp")
docl_StringLiteralExp = Class(name="docl_StringLiteralExp")
docl_BooleanLiteralExp = Class(name="docl_BooleanLiteralExp")
docl_UnlimitedNaturalLiteralExp = Class(name="docl_UnlimitedNaturalLiteralExp")
docl_InvalidLiteralExp = Class(name="docl_InvalidLiteralExp")
docl_NullLiteralExp = Class(name="docl_NullLiteralExp")
docl_IfExp = Class(name="docl_IfExp")
docl_EqOpCallExp = Class(name="docl_EqOpCallExp")
docl_ComOpCallExp = Class(name="docl_ComOpCallExp")
docl_EnvType = Class(name="docl_EnvType")
docl_LambdaType = Class(name="docl_LambdaType")
docl_MapType = Class(name="docl_MapType")
docl_TupleType = Class(name="docl_TupleType")
docl_OclAnyType = Class(name="docl_OclAnyType")
docl_SetType = Class(name="docl_SetType")
docl_SequenceType = Class(name="docl_SequenceType")
docl_OrderedSetType = Class(name="docl_OrderedSetType")
docl_BagType = Class(name="docl_BagType")
docl_RealType = Class(name="docl_RealType")
docl_IntegerType = Class(name="docl_IntegerType")
docl_BooleanType = Class(name="docl_BooleanType")
docl_StringType = Class(name="docl_StringType")
docl_BoolOpCallExp = Class(name="docl_BoolOpCallExp")
docl_IteratorExp = Class(name="docl_IteratorExp")
docl_AddOpCallExp = Class(name="docl_AddOpCallExp")
docl_MulOpCallExp = Class(name="docl_MulOpCallExp")
docl_NavigationExp = Class(name="docl_NavigationExp")
docl_CollectionOpCallExp = Class(name="docl_CollectionOpCallExp")
docl_IterateExp = Class(name="docl_IterateExp")
docl_NavigationOrAttributeCall = Class(name="docl_NavigationOrAttributeCall")
docl_OperationCall = Class(name="docl_OperationCall")
docl_LambdaExp = Class(name="docl_LambdaExp")
docl_TupleExp = Class(name="docl_TupleExp")
docl_ElseIfThenExp = Class(name="docl_ElseIfThenExp")
docl_SelfExp = Class(name="docl_SelfExp")
docl_NestedExp = Class(name="docl_NestedExp")
...
else_42: BinaryAssociation = BinaryAssociation(
    name="else_42",
    ends={
...
domain_model = DomainModel(
    name="docl",
    types={docl_Module, docl_OclModel, docl_OclExpression, docl_Import, docl_ModuleElement, docl_URI_, docl_Query, ModuleElement, docl_OclModelElementExp, OclType, docl_LocalVariable, docl_Iterator, docl_OclType, docl_TuplePart, docl_PrimitiveExp, OclExpression, docl_NumberLiteralExp, PrimitiveExp, docl_StringLiteralExp, docl_BooleanLiteralExp, docl_UnlimitedNaturalLiteralExp, docl_InvalidLiteralExp, docl_NullLiteralExp, docl_IfExp, docl_EqOpCallExp, docl_ComOpCallExp, docl_EnvType, docl_LambdaType, docl_MapType, docl_TupleType, docl_OclAnyType, docl_SetType, docl_SequenceType, docl_OrderedSetType, docl_BagType, docl_RealType, docl_IntegerType, docl_BooleanType, docl_StringType, docl_BoolOpCallExp, docl_IteratorExp, docl_AddOpCallExp, docl_MulOpCallExp, docl_NavigationExp, docl_CollectionOpCallExp, docl_IterateExp, docl_NavigationOrAttributeCall, docl_OperationCall, docl_LambdaExp, docl_TupleExp, docl_ElseIfThenExp, docl_SelfExp, docl_NestedExp},
    associations={source0, body10, input1, imports4, elements6, uri8, ifThen39, else_42, model45, variable11, in_14, target17, model19, type22, type23, initExp26, type29, init31, condition34, then36, source65, source67, argsTypes47, returnType49, keyType52, valueType54, elementType57, elementType59, elementType61, elementType63, iterators87, source69, source71, source73, source75, arguments77, iterators79, result81, body84, body89, arguments92, expression94, parts96, condition98, then100, exp103},
    generalizations={gen_docl_Query_ModuleElement, gen_docl_OclModelElementExp_OclType, gen_docl_PrimitiveExp_OclExpression, gen_docl_NumberLiteralExp_PrimitiveExp, gen_docl_StringLiteralExp_PrimitiveExp, gen_docl_BooleanLiteralExp_PrimitiveExp, gen_docl_UnlimitedNaturalLiteralExp_PrimitiveExp, gen_docl_InvalidLiteralExp_PrimitiveExp, gen_docl_NullLiteralExp_PrimitiveExp, gen_docl_IfExp_OclExpression, gen_docl_EqOpCallExp_OclExpression, gen_docl_ComOpCallExp_OclExpression, gen_docl_EnvType_OclType, gen_docl_LambdaType_OclType, gen_docl_MapType_OclType, gen_docl_TupleType_OclType, gen_docl_OclAnyType_OclType, gen_docl_SetType_OclType, gen_docl_SequenceType_OclType, gen_docl_OrderedSetType_OclType, gen_docl_BagType_OclType, gen_docl_RealType_OclType, gen_docl_IntegerType_OclType, gen_docl_BooleanType_OclType, gen_docl_StringType_OclType, gen_docl_BoolOpCallExp_OclExpression, gen_docl_IteratorExp_OclExpression, gen_docl_AddOpCallExp_OclExpression, gen_docl_MulOpCallExp_OclExpression, gen_docl_NavigationExp_OclExpression, gen_docl_CollectionOpCallExp_OclExpression, gen_docl_IterateExp_OclExpression, gen_docl_NavigationOrAttributeCall_OclExpression, gen_docl_OperationCall_OclExpression, gen_docl_LambdaExp_OclExpression, gen_docl_TupleExp_OclExpression, gen_docl_ElseIfThenExp_OclExpression, gen_docl_SelfExp_OclExpression, gen_docl_NestedExp_OclExpression},
    metadata=None
)
