...
class cloudml_VMInstance(ExternalComponentInstance):
    ...
    def __init__(self, publicAddress: str, id: str, cloudml_VMInstance59: "cloudml_Cloud" = None, cloudml_VMInstance61: set["cloudml_VMPortInstance"] = None, cloudml_VMInstance: "cloudml_CloudMLModel" = None):
...
class cloudml_ExternalComponentInstance(ComponentInstance):
    ...
    def __init__(self, ips: str, cloudml_ExternalComponentInstance97: set["cloudml_VMPortInstance"] = None, cloudml_ExternalComponentInstance: "cloudml_CloudMLModel" = None):
        self.ips = ips
...
class cloudml_ExternalComponent(Component):
    ...
    def __init__(self, endPoint: str, login: str, passwd: str, location: str, serviceType: str, Region: str, cloudml_ExternalComponent91: "cloudml_Provider" = None, cloudml_ExternalComponent94: set["cloudml_VMPort"] = None, cloudml_ExternalComponent: "cloudml_CloudMLModel" = None):
...
class cloudml_VM(ExternalComponent):
    ...
    def __init__(self, minRam: int, maxRam: int, minCores: int, maxCores: int, minStorage: int, maxStorage: int, os: str, is64os: bool, imageId: str, securityGroup: str, sshKey: str, privateKey: str, groupName: str, providerSpecificTypeName: str, cloudml_VM31: set["cloudml_VMPort"] = None, cloudml_VM: "cloudml_CloudMLModel" = None):
        self.minRam = minRam
        self.maxRam = maxRam
