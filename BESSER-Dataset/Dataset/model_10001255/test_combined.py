...
from python_code import (
    DefaultAuthorizationGroupSteps,
...
def test_hyp_defaultauthorizationgroupsteps_is_not_abstract():
    assert not inspect.isabstract(DefaultAuthorizationGroupSteps)


def test_hyp_defaultauthorizationgroupsteps_constructor_exists():
    assert callable(DefaultAuthorizationGroupSteps.__init__)


def test_hyp_defaultauthorizationgroupsteps_constructor_args():
    sig = inspect.signature(DefaultAuthorizationGroupSteps.__init__)
...
DefaultAuthorizationGroupSteps_strategy = st.builds(
    DefaultAuthorizationGroupSteps,
)
...
DefaultAuthorizationGroupSteps_strategy = st.builds(DefaultAuthorizationGroupSteps)
@given(instance=DefaultAuthorizationGroupSteps_strategy)
@settings(max_examples=25)
def test_DefaultAuthorizationGroupSteps_instantiation(instance):
    assert isinstance(instance, DefaultAuthorizationGroupSteps)
