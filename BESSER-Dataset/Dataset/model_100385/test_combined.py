...
def test_hyp_resourceimport_is_not_abstract():
    assert not inspect.isabstract(ResourceImport)


def test_hyp_resourceimport_constructor_exists():
    assert callable(ResourceImport.__init__)


def test_hyp_resourceimport_constructor_args():
    sig = inspect.signature(ResourceImport.__init__)
    params = list(sig.parameters.keys())



def test_hyp_scxmlxt_domaindataimport_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_DomainDataImport)


def test_hyp_scxmlxt_domaindataimport_constructor_exists():
    assert callable(scxmlxt_DomainDataImport.__init__)


def test_hyp_scxmlxt_domaindataimport_constructor_args():
    sig = inspect.signature(scxmlxt_DomainDataImport.__init__)
    params = list(sig.parameters.keys())



def test_hyp_scxmlxt_domainmodelimport_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_DomainModelImport)


def test_hyp_scxmlxt_domainmodelimport_constructor_exists():
    assert callable(scxmlxt_DomainModelImport.__init__)


def test_hyp_scxmlxt_domainmodelimport_constructor_args():
    sig = inspect.signature(scxmlxt_DomainModelImport.__init__)
    params = list(sig.parameters.keys())



def test_hyp_intliteral_is_not_abstract():
    assert not inspect.isabstract(IntLiteral)


def test_hyp_intliteral_constructor_exists():
    assert callable(IntLiteral.__init__)


def test_hyp_intliteral_constructor_args():
    sig = inspect.signature(IntLiteral.__init__)
    params = list(sig.parameters.keys())



def test_hyp_scxmlxt_delayliteral_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_DelayLiteral)


def test_hyp_scxmlxt_delayliteral_constructor_exists():
    assert callable(scxmlxt_DelayLiteral.__init__)


def test_hyp_scxmlxt_delayliteral_constructor_args():
...
def test_hyp_scxmlxt_eobject_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_EObject)


def test_hyp_scxmlxt_eobject_constructor_exists():
    assert callable(scxmlxt_EObject.__init__)


def test_hyp_scxmlxt_eobject_constructor_args():
    sig = inspect.signature(scxmlxt_EObject.__init__)
    params = list(sig.parameters.keys())



def test_hyp_scxmlxt_eobjectreference_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_EObjectReference)


def test_hyp_scxmlxt_eobjectreference_constructor_exists():
    assert callable(scxmlxt_EObjectReference.__init__)


def test_hyp_scxmlxt_eobjectreference_constructor_args():
    sig = inspect.signature(scxmlxt_EObjectReference.__init__)
    params = list(sig.parameters.keys())



def test_hyp_resourceuriliteral_is_not_abstract():
    assert not inspect.isabstract(ResourceUriLiteral)


def test_hyp_resourceuriliteral_constructor_exists():
    assert callable(ResourceUriLiteral.__init__)


def test_hyp_resourceuriliteral_constructor_args():
    sig = inspect.signature(ResourceUriLiteral.__init__)
    params = list(sig.parameters.keys())



def test_hyp_scxmlxt_eobjecturiliteral_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_EObjectUriLiteral)


def test_hyp_scxmlxt_eobjecturiliteral_constructor_exists():
    assert callable(scxmlxt_EObjectUriLiteral.__init__)


def test_hyp_scxmlxt_eobjecturiliteral_constructor_args():
...
def test_hyp_abstracturiliteral_is_not_abstract():
    assert not inspect.isabstract(AbstractUriLiteral)


def test_hyp_abstracturiliteral_constructor_exists():
    assert callable(AbstractUriLiteral.__init__)


def test_hyp_abstracturiliteral_constructor_args():
    sig = inspect.signature(AbstractUriLiteral.__init__)
    params = list(sig.parameters.keys())



def test_hyp_scxmlxt_resourceuriliteral_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_ResourceUriLiteral)


def test_hyp_scxmlxt_resourceuriliteral_constructor_exists():
    assert callable(scxmlxt_ResourceUriLiteral.__init__)


def test_hyp_scxmlxt_resourceuriliteral_constructor_args():
...
def test_hyp_scxmlxt_uriliteral_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_UriLiteral)


def test_hyp_scxmlxt_uriliteral_constructor_exists():
    assert callable(scxmlxt_UriLiteral.__init__)


def test_hyp_scxmlxt_uriliteral_constructor_args():
...
def test_hyp_scxmlxt_varref_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_VarRef)


def test_hyp_scxmlxt_varref_constructor_exists():
    assert callable(scxmlxt_VarRef.__init__)


def test_hyp_scxmlxt_varref_constructor_args():
...
def test_hyp_scxmlxt_stringliteral_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_StringLiteral)


def test_hyp_scxmlxt_stringliteral_constructor_exists():
    assert callable(scxmlxt_StringLiteral.__init__)


def test_hyp_scxmlxt_stringliteral_constructor_args():
...
def test_hyp_scxmlxt_intliteral_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_IntLiteral)


def test_hyp_scxmlxt_intliteral_constructor_exists():
    assert callable(scxmlxt_IntLiteral.__init__)


def test_hyp_scxmlxt_intliteral_constructor_args():
...
def test_hyp_scxmlxt_abstracturiliteral_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_AbstractUriLiteral)


def test_hyp_scxmlxt_abstracturiliteral_constructor_exists():
    assert callable(scxmlxt_AbstractUriLiteral.__init__)


def test_hyp_scxmlxt_abstracturiliteral_constructor_args():
...
def test_hyp_scxmlxt_floatliteral_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_FloatLiteral)


def test_hyp_scxmlxt_floatliteral_constructor_exists():
    assert callable(scxmlxt_FloatLiteral.__init__)


def test_hyp_scxmlxt_floatliteral_constructor_args():
...
def test_hyp_scxmlxt_booleanliteral_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_BooleanLiteral)


def test_hyp_scxmlxt_booleanliteral_constructor_exists():
    assert callable(scxmlxt_BooleanLiteral.__init__)


def test_hyp_scxmlxt_booleanliteral_constructor_args():
...
def test_hyp_scxmlxt_literal_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_Literal)


def test_hyp_scxmlxt_literal_constructor_exists():
    assert callable(scxmlxt_Literal.__init__)


def test_hyp_scxmlxt_literal_constructor_args():
    sig = inspect.signature(scxmlxt_Literal.__init__)
    params = list(sig.parameters.keys())



def test_hyp_scxmlxt_scriptexpression_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_ScriptExpression)


def test_hyp_scxmlxt_scriptexpression_constructor_exists():
    assert callable(scxmlxt_ScriptExpression.__init__)


def test_hyp_scxmlxt_scriptexpression_constructor_args():
...
def test_hyp_scxmlxt_estepfilter_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_EStepFilter)


def test_hyp_scxmlxt_estepfilter_constructor_exists():
    assert callable(scxmlxt_EStepFilter.__init__)


def test_hyp_scxmlxt_estepfilter_constructor_args():
...
def test_hyp_scxmlxt_estep_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_EStep)


def test_hyp_scxmlxt_estep_constructor_exists():
    assert callable(scxmlxt_EStep.__init__)


def test_hyp_scxmlxt_estep_constructor_args():
...
def test_hyp_scxmlxt_epath_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_EPath)


def test_hyp_scxmlxt_epath_constructor_exists():
    assert callable(scxmlxt_EPath.__init__)


def test_hyp_scxmlxt_epath_constructor_args():
...
def test_hyp_scxmlxt_eclassifier_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_EClassifier)


def test_hyp_scxmlxt_eclassifier_constructor_exists():
    assert callable(scxmlxt_EClassifier.__init__)


def test_hyp_scxmlxt_eclassifier_constructor_args():
    sig = inspect.signature(scxmlxt_EClassifier.__init__)
    params = list(sig.parameters.keys())



def test_hyp_scxmlxt_typed_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_Typed)


def test_hyp_scxmlxt_typed_constructor_exists():
    assert callable(scxmlxt_Typed.__init__)


def test_hyp_scxmlxt_typed_constructor_args():
...
def test_hyp_scxmlxt_assignmentaction_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_AssignmentAction)


def test_hyp_scxmlxt_assignmentaction_constructor_exists():
    assert callable(scxmlxt_AssignmentAction.__init__)


def test_hyp_scxmlxt_assignmentaction_constructor_args():
    sig = inspect.signature(scxmlxt_AssignmentAction.__init__)
    params = list(sig.parameters.keys())



def test_hyp_scxmlxt_scriptaction_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_ScriptAction)


def test_hyp_scxmlxt_scriptaction_constructor_exists():
    assert callable(scxmlxt_ScriptAction.__init__)


def test_hyp_scxmlxt_scriptaction_constructor_args():
...
def test_hyp_scxmlxt_symbolicaction_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_SymbolicAction)


def test_hyp_scxmlxt_symbolicaction_constructor_exists():
    assert callable(scxmlxt_SymbolicAction.__init__)


def test_hyp_scxmlxt_symbolicaction_constructor_args():
...
def test_hyp_scxmlxt_expression_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_Expression)


def test_hyp_scxmlxt_expression_constructor_exists():
    assert callable(scxmlxt_Expression.__init__)


def test_hyp_scxmlxt_expression_constructor_args():
    sig = inspect.signature(scxmlxt_Expression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abstracttransitionevent_is_not_abstract():
    assert not inspect.isabstract(AbstractTransitionEvent)


def test_hyp_abstracttransitionevent_constructor_exists():
    assert callable(AbstractTransitionEvent.__init__)


def test_hyp_abstracttransitionevent_constructor_args():
    sig = inspect.signature(AbstractTransitionEvent.__init__)
    params = list(sig.parameters.keys())



def test_hyp_scxmlxt_enterevent_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_EnterEvent)


def test_hyp_scxmlxt_enterevent_constructor_exists():
    assert callable(scxmlxt_EnterEvent.__init__)


def test_hyp_scxmlxt_enterevent_constructor_args():
    sig = inspect.signature(scxmlxt_EnterEvent.__init__)
    params = list(sig.parameters.keys())



def test_hyp_scxmlxt_exitevent_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_ExitEvent)


def test_hyp_scxmlxt_exitevent_constructor_exists():
    assert callable(scxmlxt_ExitEvent.__init__)


def test_hyp_scxmlxt_exitevent_constructor_args():
    sig = inspect.signature(scxmlxt_ExitEvent.__init__)
    params = list(sig.parameters.keys())



def test_hyp_scxmlxt_transitionevent_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_TransitionEvent)


def test_hyp_scxmlxt_transitionevent_constructor_exists():
    assert callable(scxmlxt_TransitionEvent.__init__)


def test_hyp_scxmlxt_transitionevent_constructor_args():
...
def test_hyp_scxmlxt_timerevent_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_TimerEvent)


def test_hyp_scxmlxt_timerevent_constructor_exists():
    assert callable(scxmlxt_TimerEvent.__init__)


def test_hyp_scxmlxt_timerevent_constructor_args():
    sig = inspect.signature(scxmlxt_TimerEvent.__init__)
    params = list(sig.parameters.keys())



def test_hyp_scxmlxt_scriptevent_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_ScriptEvent)


def test_hyp_scxmlxt_scriptevent_constructor_exists():
    assert callable(scxmlxt_ScriptEvent.__init__)


def test_hyp_scxmlxt_scriptevent_constructor_args():
...
def test_hyp_scxmlxt_abstracttransitionevent_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_AbstractTransitionEvent)


def test_hyp_scxmlxt_abstracttransitionevent_constructor_exists():
    assert callable(scxmlxt_AbstractTransitionEvent.__init__)


def test_hyp_scxmlxt_abstracttransitionevent_constructor_args():
    sig = inspect.signature(scxmlxt_AbstractTransitionEvent.__init__)
    params = list(sig.parameters.keys())



def test_hyp_scxmlxt_symbolicevent_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_SymbolicEvent)


def test_hyp_scxmlxt_symbolicevent_constructor_exists():
    assert callable(scxmlxt_SymbolicEvent.__init__)


def test_hyp_scxmlxt_symbolicevent_constructor_args():
...
def test_hyp_scxmlxt_internaltransition_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_InternalTransition)


def test_hyp_scxmlxt_internaltransition_constructor_exists():
    assert callable(scxmlxt_InternalTransition.__init__)


def test_hyp_scxmlxt_internaltransition_constructor_args():
    sig = inspect.signature(scxmlxt_InternalTransition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_scxmlxt_transition_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_Transition)


def test_hyp_scxmlxt_transition_constructor_exists():
    assert callable(scxmlxt_Transition.__init__)


def test_hyp_scxmlxt_transition_constructor_args():
    sig = inspect.signature(scxmlxt_Transition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_scxmlxt_condition_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_Condition)


def test_hyp_scxmlxt_condition_constructor_exists():
    assert callable(scxmlxt_Condition.__init__)


def test_hyp_scxmlxt_condition_constructor_args():
...
def test_hyp_scxmlxt_event_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_Event)


def test_hyp_scxmlxt_event_constructor_exists():
    assert callable(scxmlxt_Event.__init__)


def test_hyp_scxmlxt_event_constructor_args():
    sig = inspect.signature(scxmlxt_Event.__init__)
    params = list(sig.parameters.keys())



def test_hyp_scxmlxt_vardef_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_VarDef)


def test_hyp_scxmlxt_vardef_constructor_exists():
    assert callable(scxmlxt_VarDef.__init__)


def test_hyp_scxmlxt_vardef_constructor_args():
...
def test_hyp_scxmlxt_abstracttransition_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_AbstractTransition)


def test_hyp_scxmlxt_abstracttransition_constructor_exists():
    assert callable(scxmlxt_AbstractTransition.__init__)


def test_hyp_scxmlxt_abstracttransition_constructor_args():
    sig = inspect.signature(scxmlxt_AbstractTransition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_scxmlxt_abstractstate_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_AbstractState)


def test_hyp_scxmlxt_abstractstate_constructor_exists():
    assert callable(scxmlxt_AbstractState.__init__)


def test_hyp_scxmlxt_abstractstate_constructor_args():
    sig = inspect.signature(scxmlxt_AbstractState.__init__)
    params = list(sig.parameters.keys())



def test_hyp_scxmlxt_action_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_Action)


def test_hyp_scxmlxt_action_constructor_exists():
    assert callable(scxmlxt_Action.__init__)


def test_hyp_scxmlxt_action_constructor_args():
    sig = inspect.signature(scxmlxt_Action.__init__)
    params = list(sig.parameters.keys())



def test_hyp_scxmlxt_initialtransition_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_InitialTransition)


def test_hyp_scxmlxt_initialtransition_constructor_exists():
    assert callable(scxmlxt_InitialTransition.__init__)


def test_hyp_scxmlxt_initialtransition_constructor_args():
    sig = inspect.signature(scxmlxt_InitialTransition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_scxmlxt_resourceimport_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_ResourceImport)


def test_hyp_scxmlxt_resourceimport_constructor_exists():
    assert callable(scxmlxt_ResourceImport.__init__)


def test_hyp_scxmlxt_resourceimport_constructor_args():
...
def test_hyp_scxmlxt_state_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_State)


def test_hyp_scxmlxt_state_constructor_exists():
    assert callable(scxmlxt_State.__init__)


def test_hyp_scxmlxt_state_constructor_args():
...
def test_hyp_scxmlxt_statemachine_is_not_abstract():
    assert not inspect.isabstract(scxmlxt_StateMachine)


def test_hyp_scxmlxt_statemachine_constructor_exists():
    assert callable(scxmlxt_StateMachine.__init__)


def test_hyp_scxmlxt_statemachine_constructor_args():
...
def test_hyp_scxmlxt_delayliteral_timeUnit_setter(instance):
...
def test_hyp_scxmlxt_eobjecturiliteral_uriFragment_setter(instance):
...
def test_hyp_scxmlxt_resourceuriliteral_resourceUri_setter(instance):
...
def test_hyp_scxmlxt_uriliteral_uriValue_setter(instance):
...
def test_hyp_scxmlxt_stringliteral_stringValue_setter(instance):
...
def test_hyp_scxmlxt_intliteral_intValue_setter(instance):
...
def test_hyp_scxmlxt_abstracturiliteral_uri_setter(instance):
...
def test_hyp_scxmlxt_floatliteral_floatValue_setter(instance):
...
def test_hyp_scxmlxt_booleanliteral_booleanValue_setter(instance):
...
def test_hyp_scxmlxt_scriptexpression_script_setter(instance):
...
def test_hyp_scxmlxt_estepfilter_freeVarName_setter(instance):
...
def test_hyp_scxmlxt_estep_featureName_setter(instance):
...
def test_hyp_scxmlxt_typed_many_setter(instance):
...
def test_hyp_scxmlxt_scriptaction_script_setter(instance):
    original = instance.script
    instance.script = original
    assert instance.script == original
...
def test_hyp_scxmlxt_symbolicaction_name_setter(instance):
...
def test_hyp_scxmlxt_scriptevent_script_setter(instance):
    original = instance.script
    instance.script = original
    assert instance.script == original
...
def test_hyp_scxmlxt_symbolicevent_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_scxmlxt_condition_script_setter(instance):
    original = instance.script
    instance.script = original
    assert instance.script == original
...
def test_hyp_scxmlxt_vardef_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_scxmlxt_resourceimport_importURI_setter(instance):
...
def test_hyp_scxmlxt_state_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
