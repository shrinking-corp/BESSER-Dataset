...
class connection_XmlXPathLoopDescriptor:
    ...
    def __init__(self, LimitBoucle: str, AbsoluteXPathQuery: str, XmlXPathLoopDescriptor33: "connection_SchemaTarget" = None, XmlXPathLoopDescriptor: "connection_XmlFileConnection" = None, schema: "connection_XmlFileConnection" = None, schema42: set["connection_SchemaTarget"] = None):
...
class connection_MDMConnection(Connection):
    ...
    def __init__(self, Server: str, Universe: str, Datamodel: str, Datacluster: str, Username: str, Password: str, Port: str, connection_MDMConnection: set["connection_Concept"] = None):
        self.Server = Server
...
class connection_SAPConnection(Connection):
    ...
    def __init__(self, currentFucntion: str, Host: str, Username: str, Password: str, Client: str, SystemNumber: str, Language: str, connection12: set["connection_SAPFunctionUnit"] = None, SAPConnection: "connection_SAPFunctionUnit" = None):
...
class connection_XmlFileConnection(Connection):
    ...
    def __init__(self, XsdFilePath: str, XmlFilePath: str, Guess: bool, MaskXPattern: str, Encoding: str, connection31: set["connection_XmlXPathLoopDescriptor"] = None, XmlFileConnection: "connection_XmlXPathLoopDescriptor" = None):
...
class connection_LDAPSchemaConnection(Connection):
    ...
    def __init__(self, Host: str, Port: str, BindPassword: str, LimitValue: int, EncryptionMethodName: str, Value: str, SavePassword: bool, Aliases: str, Referrals: str, CountLimit: str, TimeOutLimit: str, BaseDNs: str, GetBaseDNsFromRoot: bool, ReturnAttributes: str, Protocol: str, SelectedDN: str, Filter: str, Separator: str, UseAdvanced: bool, StorePath: str, UseLimit: bool, UseAuthen: bool, BindPrincipal: str):
        self.Host = Host
        self.Port = Port
...
class connection_LdifFileConnection(Connection):
    ...
    def __init__(self, UseLimit: bool, Server: str, value: str, FilePath: str, LimitEntry: int):
        self.UseLimit = UseLimit
        self.Server = Server
        self.value = value
...
class connection_WSDLSchemaConnection(Connection):
    ...
    def __init__(self, proxyPassword: str, Value: str, EndpointURI: str, Encoding: str, timeOut: int, WSDL: str, needAuth: bool, methodName: str, parameters: str, UserName: str, Password: str, useProxy: bool, proxyHost: str, proxyPort: str, proxyUser: str):
...
class connection_DatabaseConnection(Connection):
    ...
    def __init__(self, FileFieldName: str, Schema: str, SID: str, SqlSynthax: str, StringQuote: str, NullChar: str, DbmsId: str, ProductId: str, DBRootPath: str, AdditionalParams: str, StandardSQL: bool, SystemSQL: bool, DatabaseType: str, DriverJarPath: str, DriverClass: str, URL: str, dbVersionString: str, Port: str, Username: str, Password: str, ServerName: str, DatasourceName: str, cdcTypeMode: str, SQLMode: bool, DatabaseConnection: "connection_CDCConnection" = None, connection10: "connection_CDCConnection" = None):
...
class connection_FileConnection(Connection):
    ...
    def __init__(self, RowSeparatorType: str, RowSeparatorValue: str, TextIdentifier: str, UseHeader: bool, HeaderValue: str, UseFooter: bool, FooterValue: str, UseLimit: bool, LimitValue: str, FirstLineCaption: bool, RemoveEmptyRow: bool, EscapeType: str, EscapeChar: str, Server: str, FilePath: str, Format: str, Encoding: str, FieldSeparatorValue: str, TextEnclosure: str, CsvOption: bool):
...
class connection_SAPFunctionParameterColumn(AbstractMetadataObject):
    ...
    def __init__(self, Length: str, Description: str, Value: str, Name: str, ParameterType: str, StructureOrTableName: str, DataType: str, columns24: "connection_SAPFunctionParameterTable" = None, SAPFunctionParameterColumn: "connection_SAPFunctionParameterTable" = None):
        self.Length = Length
...
class connection_SAPFunctionUnit(AbstractMetadataObject):
    ...
    def __init__(self, Name: str, OutputType: str, OutputTableName: str, Document: str, SAPFunctionUnit: "connection_SAPConnection" = None, functionUnit: "connection_InputSAPFunctionParameterTable" = None, functionUnit15: "connection_OutputSAPFunctionParameterTable" = None, connection_SAPFunctionUnit: "connection_MetadataTable" = None, Funtions: "connection_SAPConnection" = None, SAPFunctionUnit27: "connection_InputSAPFunctionParameterTable" = None, connection_SAPFunctionUnit19: set["connection_MetadataTable"] = None, functionUnit22: "connection_SAPTestInputParameterTable" = None, SAPFunctionUnit29: "connection_OutputSAPFunctionParameterTable" = None, SAPFunctionUnit51: "connection_SAPTestInputParameterTable" = None):
        self.Name = Name
...
class connection_MetadataColumn(AbstractMetadataObject):
    ...
    def __init__(self, sourceType: str, defaultValue: str, talendType: str, key: bool, nullable: bool, length: str, precision: str, originalField: str, pattern: str, displayField: str, MetadataColumn: "connection_MetadataTable" = None, columns: "connection_MetadataTable" = None):
...
class connection_MetadataTable(AbstractMetadataObject):
    ...
    def __init__(self, sourceName: str, tableType: str, attachedCDC: bool, activatedCDC: bool, MetadataTable: "connection_Connection" = None, table: set["connection_MetadataColumn"] = None, tables: "connection_Connection" = None, MetadataTable5: "connection_MetadataColumn" = None, connection_MetadataTable: "connection_SAPFunctionUnit" = None, connection_MetadataTable20: "connection_SAPFunctionUnit" = None):
...
class connection_Connection(AbstractMetadataObject):
    ...
    def __init__(self, version: str, ContextMode: bool, ContextId: str, connection_Connection: "connection_Metadata" = None, connection: set["connection_MetadataTable"] = None, connection3: "connection_QueriesConnection" = None, Connection: "connection_MetadataTable" = None, Connection35: "connection_QueriesConnection" = None):
