...
connection_MetadataTable.attributes={connection_MetadataTable_sourceName, connection_MetadataTable_tableType, connection_MetadataTable_attachedCDC, connection_MetadataTable_activatedCDC}
...
connection_MetadataColumn_length: Property = Property(name="length", type=StringType)
connection_MetadataColumn_precision: Property = Property(name="precision", type=StringType)
...
connection_MetadataColumn.attributes={connection_MetadataColumn_defaultValue, connection_MetadataColumn_key, connection_MetadataColumn_sourceType, connection_MetadataColumn_displayField, connection_MetadataColumn_talendType, connection_MetadataColumn_pattern, connection_MetadataColumn_length, connection_MetadataColumn_originalField, connection_MetadataColumn_precision, connection_MetadataColumn_nullable}
...
connection_AbstractMetadataObject.attributes={connection_AbstractMetadataObject_properties, connection_AbstractMetadataObject_readOnly, connection_AbstractMetadataObject_id, connection_AbstractMetadataObject_comment, connection_AbstractMetadataObject_synchronised, connection_AbstractMetadataObject_divergency, connection_AbstractMetadataObject_label}
...
connection_FileConnection.attributes={connection_FileConnection_LimitValue, connection_FileConnection_FirstLineCaption, connection_FileConnection_HeaderValue, connection_FileConnection_FieldSeparatorValue, connection_FileConnection_TextEnclosure, connection_FileConnection_Encoding, connection_FileConnection_EscapeType, connection_FileConnection_RowSeparatorValue, connection_FileConnection_EscapeChar, connection_FileConnection_CsvOption, connection_FileConnection_FooterValue, connection_FileConnection_UseLimit, connection_FileConnection_Format, connection_FileConnection_UseHeader, connection_FileConnection_UseFooter, connection_FileConnection_FilePath, connection_FileConnection_Server, connection_FileConnection_RowSeparatorType, connection_FileConnection_RemoveEmptyRow, connection_FileConnection_TextIdentifier}
...
connection_MDMConnection.attributes={connection_MDMConnection_Port, connection_MDMConnection_Server, connection_MDMConnection_Username, connection_MDMConnection_Datamodel, connection_MDMConnection_Universe, connection_MDMConnection_Password, connection_MDMConnection_Datacluster}
...
connection_DatabaseConnection.attributes={connection_DatabaseConnection_Schema, connection_DatabaseConnection_SystemSQL, connection_DatabaseConnection_dbVersionString, connection_DatabaseConnection_SQLMode, connection_DatabaseConnection_StringQuote, connection_DatabaseConnection_cdcTypeMode, connection_DatabaseConnection_URL, connection_DatabaseConnection_AdditionalParams, connection_DatabaseConnection_DriverClass, connection_DatabaseConnection_DriverJarPath, connection_DatabaseConnection_Password, connection_DatabaseConnection_DatabaseType, connection_DatabaseConnection_FileFieldName, connection_DatabaseConnection_SqlSynthax, connection_DatabaseConnection_DatasourceName, connection_DatabaseConnection_StandardSQL, connection_DatabaseConnection_NullChar, connection_DatabaseConnection_Username, connection_DatabaseConnection_Port, connection_DatabaseConnection_ServerName, connection_DatabaseConnection_DbmsId, connection_DatabaseConnection_DBRootPath, connection_DatabaseConnection_SID, connection_DatabaseConnection_ProductId}
...
connection_SAPConnection.attributes={connection_SAPConnection_Client, connection_SAPConnection_Host, connection_SAPConnection_Language, connection_SAPConnection_SystemNumber, connection_SAPConnection_currentFucntion, connection_SAPConnection_Password, connection_SAPConnection_Username}
...
connection_SAPFunctionParameterColumn.attributes={connection_SAPFunctionParameterColumn_Description, connection_SAPFunctionParameterColumn_Length, connection_SAPFunctionParameterColumn_StructureOrTableName, connection_SAPFunctionParameterColumn_Name, connection_SAPFunctionParameterColumn_Value, connection_SAPFunctionParameterColumn_ParameterType, connection_SAPFunctionParameterColumn_DataType}
...
connection_LdifFileConnection.attributes={connection_LdifFileConnection_LimitEntry, connection_LdifFileConnection_FilePath, connection_LdifFileConnection_Server, connection_LdifFileConnection_value, connection_LdifFileConnection_UseLimit}
...
connection_XmlFileConnection.attributes={connection_XmlFileConnection_Guess, connection_XmlFileConnection_XsdFilePath, connection_XmlFileConnection_MaskXPattern, connection_XmlFileConnection_XmlFilePath, connection_XmlFileConnection_Encoding}
...
connection_LDAPSchemaConnection.attributes={connection_LDAPSchemaConnection_EncryptionMethodName, connection_LDAPSchemaConnection_Aliases, connection_LDAPSchemaConnection_ReturnAttributes, connection_LDAPSchemaConnection_BindPassword, connection_LDAPSchemaConnection_Protocol, connection_LDAPSchemaConnection_UseAdvanced, connection_LDAPSchemaConnection_SavePassword, connection_LDAPSchemaConnection_Host, connection_LDAPSchemaConnection_UseAuthen, connection_LDAPSchemaConnection_Filter, connection_LDAPSchemaConnection_TimeOutLimit, connection_LDAPSchemaConnection_Referrals, connection_LDAPSchemaConnection_Port, connection_LDAPSchemaConnection_Value, connection_LDAPSchemaConnection_BindPrincipal, connection_LDAPSchemaConnection_StorePath, connection_LDAPSchemaConnection_UseLimit, connection_LDAPSchemaConnection_GetBaseDNsFromRoot, connection_LDAPSchemaConnection_CountLimit, connection_LDAPSchemaConnection_SelectedDN, connection_LDAPSchemaConnection_BaseDNs, connection_LDAPSchemaConnection_Separator, connection_LDAPSchemaConnection_LimitValue}
...
connection_FileExcelConnection.attributes={connection_FileExcelConnection_advancedSpearator, connection_FileExcelConnection_SheetName, connection_FileExcelConnection_thousandSeparator, connection_FileExcelConnection_selectAllSheets, connection_FileExcelConnection_decimalSeparator, connection_FileExcelConnection_sheetColumns, connection_FileExcelConnection_firstColumn, connection_FileExcelConnection_sheetList, connection_FileExcelConnection_lastColumn}
...
connection_SalesforceSchemaConnection.attributes={connection_SalesforceSchemaConnection_useProxy, connection_SalesforceSchemaConnection_moduleName, connection_SalesforceSchemaConnection_useCustomModuleName, connection_SalesforceSchemaConnection_proxyUsername, connection_SalesforceSchemaConnection_userName, connection_SalesforceSchemaConnection_proxyHost, connection_SalesforceSchemaConnection_webServiceUrl, connection_SalesforceSchemaConnection_proxyPort, connection_SalesforceSchemaConnection_batchSize, connection_SalesforceSchemaConnection_useAlphbet, connection_SalesforceSchemaConnection_timeOut, connection_SalesforceSchemaConnection_queryCondition, connection_SalesforceSchemaConnection_useHttpProxy, connection_SalesforceSchemaConnection_proxyPassword, connection_SalesforceSchemaConnection_password}
...
connection_WSDLSchemaConnection.attributes={connection_WSDLSchemaConnection_methodName, connection_WSDLSchemaConnection_Password, connection_WSDLSchemaConnection_Encoding, connection_WSDLSchemaConnection_needAuth, connection_WSDLSchemaConnection_WSDL, connection_WSDLSchemaConnection_Value, connection_WSDLSchemaConnection_proxyPort, connection_WSDLSchemaConnection_useProxy, connection_WSDLSchemaConnection_proxyPassword, connection_WSDLSchemaConnection_parameters, connection_WSDLSchemaConnection_proxyUser, connection_WSDLSchemaConnection_EndpointURI, connection_WSDLSchemaConnection_proxyHost, connection_WSDLSchemaConnection_UserName, connection_WSDLSchemaConnection_timeOut}
...
connection_HL7Connection.attributes={connection_HL7Connection_EndChar, connection_HL7Connection_StartChar}
...
domain_model = DomainModel(
    name="connection",
    types={connection_Connection, connection_MetadataTable, connection_QueriesConnection, connection_MetadataColumn, connection_Metadata, AbstractMetadataObject, connection_AbstractMetadataObject, connection_FileConnection, Connection, connection_Concept, connection_DelimitedFileConnection, FileConnection, connection_PositionalFileConnection, connection_EbcdicConnection, connection_MDMConnection, connection_DatabaseConnection, connection_SAPFunctionUnit, connection_InputSAPFunctionParameterTable, connection_OutputSAPFunctionParameterTable, connection_CDCConnection, connection_SAPConnection, connection_SAPFunctionParameterTable, SAPFunctionParameterTable, connection_SAPTestInputParameterTable, connection_SAPFunctionParameterColumn, connection_Query, connection_LdifFileConnection, connection_RegexpFileConnection, connection_XmlFileConnection, connection_XmlXPathLoopDescriptor, connection_SchemaTarget, connection_GenericSchemaConnection, connection_LDAPSchemaConnection, connection_FileExcelConnection, connection_SalesforceSchemaConnection, connection_WSDLSchemaConnection, connection_SubscriberTable, MetadataTable, connection_ConceptTarget, connection_CDCType, connection_HL7Connection, DatabaseProperties, FileFormat, FieldSeparator, Escape, RowSeparator},
    associations={connections0, tables1, queries2, columns6, connection7, table4, schemas8, Funtions11, InputParameterTable13, OutputParameterTable14, MetadataTable16, connection17, cdcConns9, ParameterTable23, columns25, functionUnit26, tables18, TestInputParameterTable21, schema32, connection34, query36, queries38, functionUnit28, schema30, connection40, schemaTargets41, subscribers45, cdcConnection47, functionUnit50, conceptTargets52, schema54, connection43, cdcTypes44},
    generalizations={gen_connection_Connection_AbstractMetadataObject, gen_connection_MetadataColumn_AbstractMetadataObject, gen_connection_Metadata_AbstractMetadataObject, gen_connection_MetadataTable_AbstractMetadataObject, gen_connection_FileConnection_Connection, gen_connection_DelimitedFileConnection_FileConnection, gen_connection_PositionalFileConnection_FileConnection, gen_connection_EbcdicConnection_FileConnection, gen_connection_MDMConnection_Connection, gen_connection_DatabaseConnection_Connection, gen_connection_SAPFunctionUnit_AbstractMetadataObject, gen_connection_SAPConnection_Connection, gen_connection_SAPFunctionParameterTable_AbstractMetadataObject, gen_connection_InputSAPFunctionParameterTable_SAPFunctionParameterTable, gen_connection_SAPFunctionParameterColumn_AbstractMetadataObject, gen_connection_Query_AbstractMetadataObject, gen_connection_LdifFileConnection_Connection, gen_connection_OutputSAPFunctionParameterTable_SAPFunctionParameterTable, gen_connection_RegexpFileConnection_FileConnection, gen_connection_XmlFileConnection_Connection, gen_connection_GenericSchemaConnection_Connection, gen_connection_LDAPSchemaConnection_Connection, gen_connection_FileExcelConnection_FileConnection, gen_connection_SalesforceSchemaConnection_Connection, gen_connection_WSDLSchemaConnection_Connection, gen_connection_CDCType_AbstractMetadataObject, gen_connection_SubscriberTable_MetadataTable, gen_connection_SAPTestInputParameterTable_SAPFunctionParameterTable, gen_connection_Concept_MetadataTable, gen_connection_HL7Connection_FileConnection},
    metadata=None
)
