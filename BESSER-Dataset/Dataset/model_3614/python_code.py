...
class r1_ForEach(Expression):
    ...
    def __init__(self, scope: str, r1_ForEach69: "r1_Expression" = None, r1_ForEach: "r1_Expression" = None):
        self.scope = scope
...
class r1_Retrieve(Expression):
    ...
    def __init__(self, idProperty: str, scope: str, templateId: str, codeProperty: str, dataType: str, dateHighProperty: str, dateLowProperty: str, dateProperty: str, r1_Retrieve: "r1_Expression" = None, r1_Retrieve161: "r1_Expression" = None):
...
class r1_ValueSetRef(Expression):
    ...
    def __init__(self, name: str, libraryName: str, r1_ValueSetRef: "r1_InValueSet" = None):
        self.name = name
        self.libraryName = libraryName
...
class r1_Interval(Expression):
    ...
    def __init__(self, highClosed: str, lowClosed: str, r1_Interval: "r1_Expression" = None, r1_Interval99: "r1_Expression" = None, r1_Interval102: "r1_Expression" = None, r1_Interval105: "r1_Expression" = None):
