...
# Classes
r1_Abs = Class(name="r1_Abs")
UnaryExpression = Class(name="UnaryExpression")
r1_Add = Class(name="r1_Add")
BinaryExpression = Class(name="BinaryExpression")
r1_After = Class(name="r1_After")
r1_AggregateExpression = Class(name="r1_AggregateExpression", is_abstract=True)
Expression = Class(name="Expression")
r1_Expression = Class(name="r1_Expression", is_abstract=True)
r1_AliasRef = Class(name="r1_AliasRef")
r1_AllTrue = Class(name="r1_AllTrue")
AggregateExpression = Class(name="AggregateExpression")
r1_And = Class(name="r1_And")
r1_AnyTrue = Class(name="r1_AnyTrue")
r1_As = Class(name="r1_As")
r1_TypeSpecifier = Class(name="r1_TypeSpecifier", is_abstract=True)
r1_AliasedQuerySource = Class(name="r1_AliasedQuerySource")
Element = Class(name="Element")
r1_ByColumn = Class(name="r1_ByColumn")
SortByItem = Class(name="SortByItem")
r1_ByDirection = Class(name="r1_ByDirection")
r1_ByExpression = Class(name="r1_ByExpression")
r1_CalculateAge = Class(name="r1_CalculateAge")
r1_Avg = Class(name="r1_Avg")
r1_Before = Class(name="r1_Before")
r1_BinaryExpression = Class(name="r1_BinaryExpression")
r1_CaseItem = Class(name="r1_CaseItem")
r1_Ceiling = Class(name="r1_Ceiling")
r1_Coalesce = Class(name="r1_Coalesce")
NaryExpression = Class(name="NaryExpression")
r1_CalculateAgeAt = Class(name="r1_CalculateAgeAt")
r1_Case = Class(name="r1_Case")
r1_CodeSystemDef = Class(name="r1_CodeSystemDef")
r1_Collapse = Class(name="r1_Collapse")
r1_Combine = Class(name="r1_Combine")
r1_Code = Class(name="r1_Code")
r1_CodeSystemRef = Class(name="r1_CodeSystemRef")
r1_Contains = Class(name="r1_Contains")
r1_Convert = Class(name="r1_Convert")
r1_Count = Class(name="r1_Count")
r1_Concatenate = Class(name="r1_Concatenate")
r1_Concept = Class(name="r1_Concept")
r1_DateFrom = Class(name="r1_DateFrom")
r1_DateTime = Class(name="r1_DateTime")
r1_Current = Class(name="r1_Current")
r1_DefineClause = Class(name="r1_DefineClause")
r1_DifferenceBetween = Class(name="r1_DifferenceBetween")
r1_Distinct = Class(name="r1_Distinct")
r1_Divide = Class(name="r1_Divide")
r1_DurationBetween = Class(name="r1_DurationBetween")
r1_DateTimeComponentFrom = Class(name="r1_DateTimeComponentFrom")
r1_Ends = Class(name="r1_Ends")
r1_Equal = Class(name="r1_Equal")
r1_Except = Class(name="r1_Except")
r1_Exists = Class(name="r1_Exists")
r1_Expand = Class(name="r1_Expand")
r1_ExpressionDef = Class(name="r1_ExpressionDef")
r1_Element = Class(name="r1_Element", is_abstract=True)
r1_EObject = Class(name="r1_EObject")
r1_End = Class(name="r1_End")
r1_Filter = Class(name="r1_Filter")
r1_First = Class(name="r1_First")
r1_ExpressionRef = Class(name="r1_ExpressionRef")
r1_FunctionDef = Class(name="r1_FunctionDef")
ExpressionDef = Class(name="ExpressionDef")
r1_OperandDef = Class(name="r1_OperandDef")
r1_FunctionRef = Class(name="r1_FunctionRef")
ExpressionRef = Class(name="ExpressionRef")
r1_Greater = Class(name="r1_Greater")
r1_Floor = Class(name="r1_Floor")
r1_ForEach = Class(name="r1_ForEach")
r1_In = Class(name="r1_In")
r1_IncludedIn = Class(name="r1_IncludedIn")
r1_GreaterOrEqual = Class(name="r1_GreaterOrEqual")
r1_IdentifierRef = Class(name="r1_IdentifierRef")
r1_If = Class(name="r1_If")
r1_Indexer = Class(name="r1_Indexer")
r1_IndexOf = Class(name="r1_IndexOf")
r1_Instance = Class(name="r1_Instance")
r1_InstanceElement = Class(name="r1_InstanceElement")
r1_Includes = Class(name="r1_Includes")
r1_InCodeSystem = Class(name="r1_InCodeSystem")
r1_Interval = Class(name="r1_Interval")
r1_Intersect = Class(name="r1_Intersect")
r1_ValueSetRef = Class(name="r1_ValueSetRef")
r1_Is = Class(name="r1_Is")
r1_IsFalse = Class(name="r1_IsFalse")
r1_IsNull = Class(name="r1_IsNull")
r1_IsTrue = Class(name="r1_IsTrue")
r1_Last = Class(name="r1_Last")
r1_IntervalTypeSpecifier = Class(name="r1_IntervalTypeSpecifier")
TypeSpecifier = Class(name="TypeSpecifier")
r1_InValueSet = Class(name="r1_InValueSet")
r1_List = Class(name="r1_List")
r1_ListTypeSpecifier = Class(name="r1_ListTypeSpecifier")
r1_Literal = Class(name="r1_Literal")
r1_Length = Class(name="r1_Length")
r1_Less = Class(name="r1_Less")
r1_LessOrEqual = Class(name="r1_LessOrEqual")
r1_MaxValue = Class(name="r1_MaxValue")
r1_Median = Class(name="r1_Median")
r1_Meets = Class(name="r1_Meets")
r1_MeetsAfter = Class(name="r1_MeetsAfter")
r1_MeetsBefore = Class(name="r1_MeetsBefore")
r1_Ln = Class(name="r1_Ln")
r1_Log = Class(name="r1_Log")
r1_Lower = Class(name="r1_Lower")
r1_Matches = Class(name="r1_Matches")
r1_Max = Class(name="r1_Max")
r1_NamedTypeSpecifier = Class(name="r1_NamedTypeSpecifier")
r1_NaryExpression = Class(name="r1_NaryExpression", is_abstract=True)
r1_Negate = Class(name="r1_Negate")
r1_Not = Class(name="r1_Not")
r1_NotEqual = Class(name="r1_NotEqual")
r1_Min = Class(name="r1_Min")
r1_MinValue = Class(name="r1_MinValue")
r1_Mode = Class(name="r1_Mode")
r1_Modulo = Class(name="r1_Modulo")
r1_Multiply = Class(name="r1_Multiply")
r1_OperandRef = Class(name="r1_OperandRef")
r1_Or = Class(name="r1_Or")
r1_Overlaps = Class(name="r1_Overlaps")
r1_OverlapsAfter = Class(name="r1_OverlapsAfter")
r1_OverlapsBefore = Class(name="r1_OverlapsBefore")
r1_Now = Class(name="r1_Now")
r1_Null = Class(name="r1_Null")
r1_ParameterRef = Class(name="r1_ParameterRef")
r1_PopulationStdDev = Class(name="r1_PopulationStdDev")
r1_PopulationVariance = Class(name="r1_PopulationVariance")
r1_PositionOf = Class(name="r1_PositionOf")
r1_ParameterDef = Class(name="r1_ParameterDef")
r1_ProperContains = Class(name="r1_ProperContains")
r1_ProperIn = Class(name="r1_ProperIn")
r1_ProperIncludedIn = Class(name="r1_ProperIncludedIn")
r1_ProperIncludes = Class(name="r1_ProperIncludes")
r1_Property = Class(name="r1_Property")
r1_Power = Class(name="r1_Power")
r1_Predecessor = Class(name="r1_Predecessor")
r1_Query = Class(name="r1_Query")
r1_RelationshipClause = Class(name="r1_RelationshipClause", is_abstract=True)
r1_Quantity = Class(name="r1_Quantity")
AliasedQuerySource = Class(name="AliasedQuerySource")
r1_Retrieve = Class(name="r1_Retrieve")
r1_ReturnClause = Class(name="r1_ReturnClause")
r1_SortClause = Class(name="r1_SortClause")
r1_QueryDefineRef = Class(name="r1_QueryDefineRef")
r1_Round = Class(name="r1_Round")
r1_SameOrBefore = Class(name="r1_SameOrBefore")
r1_SingletonFrom = Class(name="r1_SingletonFrom")
r1_Sort = Class(name="r1_Sort")
r1_SortByItem = Class(name="r1_SortByItem", is_abstract=True)
r1_SameAs = Class(name="r1_SameAs")
r1_SameOrAfter = Class(name="r1_SameOrAfter")
r1_Split = Class(name="r1_Split")
r1_Start = Class(name="r1_Start")
r1_Starts = Class(name="r1_Starts")
r1_Subtract = Class(name="r1_Subtract")
r1_Successor = Class(name="r1_Successor")
r1_Sum = Class(name="r1_Sum")
r1_TernaryExpression = Class(name="r1_TernaryExpression")
r1_StdDev = Class(name="r1_StdDev")
r1_Substring = Class(name="r1_Substring")
r1_TimeFrom = Class(name="r1_TimeFrom")
r1_TimeOfDay = Class(name="r1_TimeOfDay")
r1_Time = Class(name="r1_Time")
r1_TupleElement = Class(name="r1_TupleElement")
r1_TupleElementDefinition = Class(name="r1_TupleElementDefinition")
r1_Times = Class(name="r1_Times")
r1_TimezoneFrom = Class(name="r1_TimezoneFrom")
r1_Today = Class(name="r1_Today")
r1_Truncate = Class(name="r1_Truncate")
r1_TruncatedDivide = Class(name="r1_TruncatedDivide")
r1_Tuple = Class(name="r1_Tuple")
r1_Union = Class(name="r1_Union")
r1_Upper = Class(name="r1_Upper")
r1_ValueSetDef = Class(name="r1_ValueSetDef")
r1_TupleTypeSpecifier = Class(name="r1_TupleTypeSpecifier")
r1_UnaryExpression = Class(name="r1_UnaryExpression", is_abstract=True)
r1_Variance = Class(name="r1_Variance")
r1_Width = Class(name="r1_Width")
r1_With = Class(name="r1_With")
RelationshipClause = Class(name="RelationshipClause")
r1_Without = Class(name="r1_Without")
r1_Xor = Class(name="r1_Xor")
...
r1_CodeSystemDef.attributes={r1_CodeSystemDef_accessLevel, r1_CodeSystemDef_name, r1_CodeSystemDef_id, r1_CodeSystemDef_version}
...
r1_Interval.attributes={r1_Interval_highClosed, r1_Interval_lowClosed}
...
r1_ParameterDef.attributes={r1_ParameterDef_parameterType, r1_ParameterDef_name, r1_ParameterDef_accessLevel}
...
r1_Quantity.attributes={r1_Quantity_unit, r1_Quantity_value}
...
r1_Retrieve.attributes={r1_Retrieve_dataType, r1_Retrieve_dateProperty, r1_Retrieve_templateId, r1_Retrieve_dateLowProperty, r1_Retrieve_idProperty, r1_Retrieve_codeProperty, r1_Retrieve_scope, r1_Retrieve_dateHighProperty}
...
r1_ValueSetDef.attributes={r1_ValueSetDef_accessLevel, r1_ValueSetDef_version, r1_ValueSetDef_id, r1_ValueSetDef_name}
...
else_12: BinaryAssociation = BinaryAssociation(
    name="else_12",
    ends={
...
else_79: BinaryAssociation = BinaryAssociation(
    name="else_79",
    ends={
...
return_151: BinaryAssociation = BinaryAssociation(
    name="return_151",
    ends={
...
domain_model = DomainModel(
    name="r1",
    types={r1_Abs, UnaryExpression, r1_Add, BinaryExpression, r1_After, r1_AggregateExpression, Expression, r1_Expression, r1_AliasRef, r1_AllTrue, AggregateExpression, r1_And, r1_AnyTrue, r1_As, r1_TypeSpecifier, r1_AliasedQuerySource, Element, r1_ByColumn, SortByItem, r1_ByDirection, r1_ByExpression, r1_CalculateAge, r1_Avg, r1_Before, r1_BinaryExpression, r1_CaseItem, r1_Ceiling, r1_Coalesce, NaryExpression, r1_CalculateAgeAt, r1_Case, r1_CodeSystemDef, r1_Collapse, r1_Combine, r1_Code, r1_CodeSystemRef, r1_Contains, r1_Convert, r1_Count, r1_Concatenate, r1_Concept, r1_DateFrom, r1_DateTime, r1_Current, r1_DefineClause, r1_DifferenceBetween, r1_Distinct, r1_Divide, r1_DurationBetween, r1_DateTimeComponentFrom, r1_Ends, r1_Equal, r1_Except, r1_Exists, r1_Expand, r1_ExpressionDef, r1_Element, r1_EObject, r1_End, r1_Filter, r1_First, r1_ExpressionRef, r1_FunctionDef, ExpressionDef, r1_OperandDef, r1_FunctionRef, ExpressionRef, r1_Greater, r1_Floor, r1_ForEach, r1_In, r1_IncludedIn, r1_GreaterOrEqual, r1_IdentifierRef, r1_If, r1_Indexer, r1_IndexOf, r1_Instance, r1_InstanceElement, r1_Includes, r1_InCodeSystem, r1_Interval, r1_Intersect, r1_ValueSetRef, r1_Is, r1_IsFalse, r1_IsNull, r1_IsTrue, r1_Last, r1_IntervalTypeSpecifier, TypeSpecifier, r1_InValueSet, r1_List, r1_ListTypeSpecifier, r1_Literal, r1_Length, r1_Less, r1_LessOrEqual, r1_MaxValue, r1_Median, r1_Meets, r1_MeetsAfter, r1_MeetsBefore, r1_Ln, r1_Log, r1_Lower, r1_Matches, r1_Max, r1_NamedTypeSpecifier, r1_NaryExpression, r1_Negate, r1_Not, r1_NotEqual, r1_Min, r1_MinValue, r1_Mode, r1_Modulo, r1_Multiply, r1_OperandRef, r1_Or, r1_Overlaps, r1_OverlapsAfter, r1_OverlapsBefore, r1_Now, r1_Null, r1_ParameterRef, r1_PopulationStdDev, r1_PopulationVariance, r1_PositionOf, r1_ParameterDef, r1_ProperContains, r1_ProperIn, r1_ProperIncludedIn, r1_ProperIncludes, r1_Property, r1_Power, r1_Predecessor, r1_Query, r1_RelationshipClause, r1_Quantity, AliasedQuerySource, r1_Retrieve, r1_ReturnClause, r1_SortClause, r1_QueryDefineRef, r1_Round, r1_SameOrBefore, r1_SingletonFrom, r1_Sort, r1_SortByItem, r1_SameAs, r1_SameOrAfter, r1_Split, r1_Start, r1_Starts, r1_Subtract, r1_Successor, r1_Sum, r1_TernaryExpression, r1_StdDev, r1_Substring, r1_TimeFrom, r1_TimeOfDay, r1_Time, r1_TupleElement, r1_TupleElementDefinition, r1_Times, r1_TimezoneFrom, r1_Today, r1_Truncate, r1_TruncatedDivide, r1_Tuple, r1_Union, r1_Upper, r1_ValueSetDef, r1_TupleTypeSpecifier, r1_UnaryExpression, r1_Variance, r1_Width, r1_With, RelationshipClause, r1_Without, r1_Xor, AccessModifier, DateTimePrecision, SortDirection},
    associations={source0, asTypeSpecifier3, expression1, operand4, expression6, caseItem10, else_12, when15, then18, comparand8, source22, system21, code27, toTypeSpecifier29, separator24, year31, hour39, minute42, second45, millisecond48, timezoneOffset51, month33, day36, expression54, expression57, annotation56, source59, condition61, element68, operand71, operand72, source64, source66, condition74, then76, else_79, source87, element89, element92, code82, codesystem84, low96, lowClosedExpression98, high101, highClosedExpression104, value93, valueset111, isTypeSpecifier113, pointType107, code109, typeSpecifier117, element119, elementType122, source115, operand124, operandTypeSpecifier126, default129, parameterTypeSpecifier131, pattern134, string136, source141, define143, relationship146, where148, source139, suchThat155, codes158, dateRange160, return_151, sort153, expression163, operand166, source171, by173, precision168, stringToSplit178, separator180, by175, startIndex185, length188, operand191, stringToSub183, second198, millisecond201, timezoneOffset204, hour193, minute195, element207, value208, type211, operand215, codeSystem217, element213},
    generalizations={gen_r1_Abs_UnaryExpression, gen_r1_Add_BinaryExpression, gen_r1_After_BinaryExpression, gen_r1_AggregateExpression_Expression, gen_r1_AliasRef_Expression, gen_r1_AllTrue_AggregateExpression, gen_r1_And_BinaryExpression, gen_r1_AnyTrue_AggregateExpression, gen_r1_As_UnaryExpression, gen_r1_AliasedQuerySource_Element, gen_r1_ByColumn_SortByItem, gen_r1_ByDirection_SortByItem, gen_r1_ByExpression_SortByItem, gen_r1_CalculateAge_UnaryExpression, gen_r1_Avg_AggregateExpression, gen_r1_Before_BinaryExpression, gen_r1_BinaryExpression_Expression, gen_r1_CaseItem_Element, gen_r1_Ceiling_UnaryExpression, gen_r1_Coalesce_NaryExpression, gen_r1_CalculateAgeAt_BinaryExpression, gen_r1_Case_Expression, gen_r1_CodeSystemDef_Element, gen_r1_CodeSystemRef_Expression, gen_r1_Collapse_UnaryExpression, gen_r1_Combine_Expression, gen_r1_Code_Expression, gen_r1_Contains_BinaryExpression, gen_r1_Convert_UnaryExpression, gen_r1_Count_AggregateExpression, gen_r1_Concatenate_NaryExpression, gen_r1_Concept_Expression, gen_r1_DateFrom_UnaryExpression, gen_r1_DateTime_Expression, gen_r1_Current_Expression, gen_r1_DefineClause_Element, gen_r1_DifferenceBetween_BinaryExpression, gen_r1_Distinct_UnaryExpression, gen_r1_Divide_BinaryExpression, gen_r1_DurationBetween_BinaryExpression, gen_r1_DateTimeComponentFrom_UnaryExpression, gen_r1_Ends_BinaryExpression, gen_r1_Equal_BinaryExpression, gen_r1_Except_BinaryExpression, gen_r1_Exists_UnaryExpression, gen_r1_Expand_UnaryExpression, gen_r1_Expression_Element, gen_r1_ExpressionDef_Element, gen_r1_End_UnaryExpression, gen_r1_Filter_Expression, gen_r1_First_Expression, gen_r1_ExpressionRef_Expression, gen_r1_FunctionDef_ExpressionDef, gen_r1_FunctionRef_ExpressionRef, gen_r1_Greater_BinaryExpression, gen_r1_Floor_UnaryExpression, gen_r1_ForEach_Expression, gen_r1_In_BinaryExpression, gen_r1_IncludedIn_BinaryExpression, gen_r1_GreaterOrEqual_BinaryExpression, gen_r1_IdentifierRef_Expression, gen_r1_If_Expression, gen_r1_Indexer_BinaryExpression, gen_r1_IndexOf_Expression, gen_r1_Instance_Expression, gen_r1_Includes_BinaryExpression, gen_r1_InCodeSystem_Expression, gen_r1_Interval_Expression, gen_r1_Intersect_BinaryExpression, gen_r1_Is_UnaryExpression, gen_r1_IsFalse_UnaryExpression, gen_r1_IsNull_UnaryExpression, gen_r1_IsTrue_UnaryExpression, gen_r1_Last_Expression, gen_r1_IntervalTypeSpecifier_TypeSpecifier, gen_r1_InValueSet_Expression, gen_r1_List_Expression, gen_r1_ListTypeSpecifier_TypeSpecifier, gen_r1_Literal_Expression, gen_r1_Length_UnaryExpression, gen_r1_Less_BinaryExpression, gen_r1_LessOrEqual_BinaryExpression, gen_r1_MaxValue_Expression, gen_r1_Median_AggregateExpression, gen_r1_Meets_BinaryExpression, gen_r1_MeetsAfter_BinaryExpression, gen_r1_MeetsBefore_BinaryExpression, gen_r1_Ln_UnaryExpression, gen_r1_Log_BinaryExpression, gen_r1_Lower_UnaryExpression, gen_r1_Matches_BinaryExpression, gen_r1_Max_AggregateExpression, gen_r1_Multiply_BinaryExpression, gen_r1_NamedTypeSpecifier_TypeSpecifier, gen_r1_NaryExpression_Expression, gen_r1_Negate_UnaryExpression, gen_r1_Not_UnaryExpression, gen_r1_NotEqual_BinaryExpression, gen_r1_Min_AggregateExpression, gen_r1_MinValue_Expression, gen_r1_Mode_AggregateExpression, gen_r1_Modulo_BinaryExpression, gen_r1_OperandRef_Expression, gen_r1_Or_BinaryExpression, gen_r1_Overlaps_BinaryExpression, gen_r1_OverlapsAfter_BinaryExpression, gen_r1_OverlapsBefore_BinaryExpression, gen_r1_Now_Expression, gen_r1_Null_Expression, gen_r1_OperandDef_Element, gen_r1_ParameterRef_Expression, gen_r1_PopulationStdDev_AggregateExpression, gen_r1_PopulationVariance_AggregateExpression, gen_r1_PositionOf_Expression, gen_r1_ParameterDef_Element, gen_r1_ProperContains_BinaryExpression, gen_r1_ProperIn_BinaryExpression, gen_r1_ProperIncludedIn_BinaryExpression, gen_r1_ProperIncludes_BinaryExpression, gen_r1_Property_Expression, gen_r1_Power_BinaryExpression, gen_r1_Predecessor_UnaryExpression, gen_r1_Query_Expression, gen_r1_Quantity_Expression, gen_r1_RelationshipClause_AliasedQuerySource, gen_r1_Retrieve_Expression, gen_r1_QueryDefineRef_Expression, gen_r1_ReturnClause_Element, gen_r1_Round_Expression, gen_r1_SameOrAfter_BinaryExpression, gen_r1_SameOrBefore_BinaryExpression, gen_r1_SingletonFrom_UnaryExpression, gen_r1_Sort_Expression, gen_r1_SameAs_BinaryExpression, gen_r1_Split_Expression, gen_r1_Start_UnaryExpression, gen_r1_Starts_BinaryExpression, gen_r1_SortByItem_Element, gen_r1_SortClause_Element, gen_r1_Subtract_BinaryExpression, gen_r1_Successor_UnaryExpression, gen_r1_Sum_AggregateExpression, gen_r1_TernaryExpression_Expression, gen_r1_StdDev_AggregateExpression, gen_r1_Substring_Expression, gen_r1_TimeFrom_UnaryExpression, gen_r1_TimeOfDay_Expression, gen_r1_Time_Expression, gen_r1_TupleElementDefinition_Element, gen_r1_Times_BinaryExpression, gen_r1_TimezoneFrom_UnaryExpression, gen_r1_Today_Expression, gen_r1_Truncate_UnaryExpression, gen_r1_TruncatedDivide_BinaryExpression, gen_r1_Tuple_Expression, gen_r1_UnaryExpression_Expression, gen_r1_Union_BinaryExpression, gen_r1_Upper_UnaryExpression, gen_r1_ValueSetDef_Element, gen_r1_TupleTypeSpecifier_TypeSpecifier, gen_r1_TypeSpecifier_Element, gen_r1_Variance_AggregateExpression, gen_r1_Width_UnaryExpression, gen_r1_With_RelationshipClause, gen_r1_Without_RelationshipClause, gen_r1_Xor_BinaryExpression, gen_r1_ValueSetRef_Expression},
    metadata=None
)
