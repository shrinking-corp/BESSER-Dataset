...
# Classes
out_RootOut = Class(name="out_RootOut", is_abstract=True)
out_D = Class(name="out_D")
RootOut = Class(name="RootOut")
out_E = Class(name="out_E")
out_RootContainer = Class(name="out_RootContainer")
...
domain_model = DomainModel(
    name="out",
    types={out_RootOut, out_D, RootOut, out_E, out_RootContainer},
    associations={refE0, refD2, refD4, elements7},
