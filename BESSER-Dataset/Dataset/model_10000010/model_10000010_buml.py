...
Account.attributes={Account_closed, Account_billingAddress, Account_isClosed, Account_open}
...
Order.attributes={Order_ordered, Order_shipped, Order_total, Order_status, Order_number, Order_shipTo}
...
domain_model = DomainModel(
    name="_01f98f2d_03a9_4998_90de_88d830d460e6",
    types={Customer, Payment, ShoppingCart, Account, WebUser, Order, LineItem, Product, UserState, OrderStatus},
    associations={Order_LineItem, Account_Order, Payment_Order, Account_Payment, WebUser_ShoppingCart, WebUser_Customer, Customer_Account, Account_ShoppingCart, ShoppingCart_LineItem, Product_LineItem},
    generalizations={},
    metadata=None
)
