...
class hello123_RelatedTo(NamedElement):
    ...
    def __init__(self, since: str, RelatedTo: "hello123_Thing" = None, hello123_RelatedTo: "hello123_Thing" = None, relations: "hello123_Thing" = None):
        self.since = since
...
class hello123_Thing(NamedElement):
    ...
    def __init__(self, id: int, hello123_Thing: "hello123_World" = None, fromThing: set["hello123_RelatedTo"] = None, hello123_Thing3: set["hello123_Property"] = None, hello123_Thing5: set["hello123_Foo"] = None, hello123_Thing11: "hello123_RelatedTo" = None, hello123_Thing7: set["hello123_Bar"] = None, Thing: "hello123_RelatedTo" = None):
        self.id = id
