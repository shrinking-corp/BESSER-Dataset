...
# Classes
hello123_World = Class(name="hello123_World")
hello123_Thing = Class(name="hello123_Thing")
NamedElement = Class(name="NamedElement")
hello123_RelatedTo = Class(name="hello123_RelatedTo")
hello123_Property = Class(name="hello123_Property")
hello123_Foo = Class(name="hello123_Foo")
hello123_Bar = Class(name="hello123_Bar")
hello123_NamedElement = Class(name="hello123_NamedElement", is_abstract=True)
hello123_Alias = Class(name="hello123_Alias")
...
hello123_Property.attributes={hello123_Property_value, hello123_Property_name}
...
domain_model = DomainModel(
    name="hello123",
    types={hello123_World, hello123_Thing, NamedElement, hello123_RelatedTo, hello123_Property, hello123_Foo, hello123_Bar, hello123_NamedElement, hello123_Alias},
