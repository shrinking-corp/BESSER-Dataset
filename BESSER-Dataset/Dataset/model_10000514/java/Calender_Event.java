...
public class Calender_Event  {
    ...
    public Calender_Event(
        None admin,        String time,        None volunteer,        String eventType,        String category,        String participantAmount,        None nomarlUser,        String description,        String date    ) {
        this.admin = admin;
        this.time = time;
    ...
    public Calender_Event(
        None admin,        String time,        None volunteer,        String eventType,        String category,        String participantAmount,        None nomarlUser,        String description,        String date        ArrayList<SuperAdmin> superadmins,        ArrayList<Volunteer> volunteers,        ArrayList<Admin> admins    ) {
        this.admin = admin;
        this.time = time;
        this.volunteer = volunteer;
        this.eventType = eventType;
