...
class Calender_Event:
    ...
    def __init__(self, eventType: str, participantAmount: str, volunteer: Volunteer, nomarlUser: Normal_user, admin: Admin, category: str, date: str, time: str, description: str, Add_Edit_View1: set["Volunteer"] = None, Add_Edit_View3: set["Admin"] = None, Add_Edit_View5: "Normal_user" = None, Add_Edit_Vew7: set["SuperAdmin"] = None):
