...
domain_model = DomainModel(
    name="kmLogo",
    types={kmLogo_ASM_Instruction, kmLogo_ASM_Primitive, Instruction, kmLogo_ASM_Back, Primitive, kmLogo_ASM_Constant, kmLogo_ASM_ProcCall, ProcDeclaration, Expression, kmLogo_ASM_Forward, kmLogo_ASM_Left, kmLogo_ASM_Right, kmLogo_ASM_PenDown, kmLogo_ASM_PenUp, kmLogo_ASM_Clear, kmLogo_ASM_Expression, kmLogo_ASM_BinaryExp, kmLogo_ASM_Repeat, kmLogo_ASM_While, kmLogo_ASM_Parameter, kmLogo_ASM_ParameterCall, kmLogo_ASM_ProcDeclaration, kmLogo_ASM_Plus, BinaryExp, Parameter_, kmLogo_ASM_Minus, kmLogo_ASM_Mult, ProcCall, kmLogo_ASM_Div, kmLogo_ASM_Equals, kmLogo_ASM_Greater, kmLogo_ASM_Lower, kmLogo_ASM_Block, kmLogo_ASM_LogoProgram, kmLogo_ASM_If, ControlStructure, Block, kmLogo_ASM_ControlStructure},
    associations={rhs9, actualArgs12, steps0, steps1, angle3, angle5, lhs7, condition25, block27, block29, declaration14, parameter31, args15, procCall16, instructions17, instructions33, instructions19, thenPart21, elsePart22},
    generalizations={gen_kmLogo_ASM_Primitive_Instruction, gen_kmLogo_ASM_Back_Primitive, gen_kmLogo_ASM_Constant_Expression, gen_kmLogo_ASM_ProcCall_Expression, gen_kmLogo_ASM_Forward_Primitive, gen_kmLogo_ASM_Left_Primitive, gen_kmLogo_ASM_Right_Primitive, gen_kmLogo_ASM_PenDown_Primitive, gen_kmLogo_ASM_PenUp_Primitive, gen_kmLogo_ASM_Clear_Primitive, gen_kmLogo_ASM_Expression_Instruction, gen_kmLogo_ASM_BinaryExp_Expression, gen_kmLogo_ASM_Repeat_ControlStructure, gen_kmLogo_ASM_While_ControlStructure, gen_kmLogo_ASM_ParameterCall_Expression, gen_kmLogo_ASM_ProcDeclaration_Instruction, gen_kmLogo_ASM_Plus_BinaryExp, gen_kmLogo_ASM_Minus_BinaryExp, gen_kmLogo_ASM_Mult_BinaryExp, gen_kmLogo_ASM_Div_BinaryExp, gen_kmLogo_ASM_Equals_BinaryExp, gen_kmLogo_ASM_Greater_BinaryExp, gen_kmLogo_ASM_Lower_BinaryExp, gen_kmLogo_ASM_Block_Instruction, gen_kmLogo_ASM_If_ControlStructure, gen_kmLogo_ASM_ControlStructure_Instruction},
    metadata=None
)
