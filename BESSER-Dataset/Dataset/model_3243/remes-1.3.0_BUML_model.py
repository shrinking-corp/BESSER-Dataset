...
remes_Variable.attributes={remes_Variable_vectorSize, remes_Variable_value, remes_Variable_writable, remes_Variable_readable, remes_Variable_global_, remes_Variable_type}
...
remes_Mode.methods={remes_Mode_m_findConstantByName, remes_Mode_m_findResourceByName, remes_Mode_m_findVariableByName}
...
remes_Constant.attributes={remes_Constant_global_, remes_Constant_value, remes_Constant_type}
...
domain_model = DomainModel(
    name="remes",
    types={remes_RemesDiagram, ControlPath, remes_Variable, remes_Mode, remes_ControlPath, remes_EntryPoint, remes_ExitPoint, remes_SubMode, remes_ConditionalConnector, remes_InitPoint, remes_CompositeEntryPoint, remes_CompositeExitPoint, remes_Resource, remes_Constant, remes_CompositeMode, Mode, LogicalRoot, remes_Point, ExitPoint, Point, remes_Edge, remes_WritePoint, EntryPoint, Referable, ActionRoot, remes_Referable, ResourceRoot, PrimitiveTypes, ResourceTypes},
    associations={exitPoint2, variables4, modes0, entryPoint1, subModes9, conditionalConnectors10, initPoint12, compositeEntryPoint13, compositeExitPoint14, resources5, constants7, parsedInvariant19, parent20, entryEdges22, writePoint16, parent18, composite28, composite30, parsedActionGuard32, container23, exitEdges24, container26, scope40, connectFrom34, connectTo36, parsedActionBody38, parsedExpression43, scope44, scope41},
    generalizations={gen_remes_Mode_ControlPath, gen_remes_CompositeMode_Mode, gen_remes_ConditionalConnector_ControlPath, gen_remes_InitPoint_ExitPoint, gen_remes_EntryPoint_Point, gen_remes_SubMode_Mode, gen_remes_CompositeEntryPoint_ExitPoint, gen_remes_CompositeExitPoint_EntryPoint, gen_remes_ExitPoint_Point, gen_remes_Variable_Referable, gen_remes_Resource_Referable, gen_remes_Constant_Referable, gen_remes_WritePoint_EntryPoint},
    metadata=None
)
