...
class remes_Edge:
    ...
    def __init__(self, actionGuard: str, actionBody: str, Edge: "remes_EntryPoint" = None, remes_Edge: "LogicalRoot" = None, Edge25: "remes_ExitPoint" = None, exitEdges: "remes_ExitPoint" = None, entryEdges: "remes_EntryPoint" = None, remes_Edge39: "ActionRoot" = None):
...
class remes_Constant(Referable):
    ...
    def __init__(self, type: str, value: str, global_: bool, Constant: "remes_Mode" = None, constants: "remes_Mode" = None):
        self.type = type
        self.value = value
...
class remes_Resource(Referable):
    ...
    def __init__(self, expression: str, type: str, Resource: "remes_Mode" = None, remes_Resource: "ResourceRoot" = None, resources: "remes_Mode" = None):
...
class remes_SubMode(Mode):
    ...
    def __init__(self, invariant: str, isUrgent: bool, remes_SubMode: "LogicalRoot" = None, subModes: "remes_CompositeMode" = None, SubMode: "remes_CompositeMode" = None):
...
class remes_ControlPath(ABC):
    ...
    def __init__(self, name: str, ControlPath: "remes_EntryPoint" = None, ControlPath27: "remes_ExitPoint" = None, container3: "remes_ExitPoint" = None, container: "remes_EntryPoint" = None):
        self.name = name
...
class remes_Variable(Referable):
    ...
    def __init__(self, value: str, type: str, vectorSize: int, global_: bool, readable: bool, writable: bool, variables: "remes_Mode" = None, Variable: "remes_Mode" = None):
        self.value = value
        self.type = type
...
class remes_Mode(ControlPath):
    ...
    def __init__(self, scope6: set["remes_Resource"] = None, scope8: set["remes_Constant"] = None, Mode: "remes_Variable" = None, Mode45: "remes_Constant" = None, Mode42: "remes_Resource" = None, scope: set["remes_Variable"] = None, remes_Mode: "remes_RemesDiagram" = None):
    ...
    def findVariableByName(self, remes_name) :
        # TODO: Implement findVariableByName method
        pass

    def findConstantByName(self, remes_name) :
        # TODO: Implement findConstantByName method
        pass

    def findResourceByName(self, remes_name) :
