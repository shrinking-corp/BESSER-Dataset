...
# Classes
classes_ValueSpecification = Class(name="classes_ValueSpecification", is_abstract=True)
TypedElement = Class(name="TypedElement")
classes_TypedElement = Class(name="classes_TypedElement")
NamedElement = Class(name="NamedElement")
classes_Type = Class(name="classes_Type", is_abstract=True)
classes_NamedElement = Class(name="classes_NamedElement", is_abstract=True)
Element = Class(name="Element")
classes_Namespace = Class(name="classes_Namespace", is_abstract=True)
classes_Element = Class(name="classes_Element", is_abstract=True)
classes_Comment = Class(name="classes_Comment")
classes_ElementImport = Class(name="classes_ElementImport")
classes_PackageImport = Class(name="classes_PackageImport")
classes_PackageableElement = Class(name="classes_PackageableElement", is_abstract=True)
classes_Package = Class(name="classes_Package")
Namespace = Class(name="Namespace")
PackageableElement = Class(name="PackageableElement")
classes_StructuralFeature = Class(name="classes_StructuralFeature", is_abstract=True)
Feature = Class(name="Feature")
MultiplicityElement = Class(name="MultiplicityElement")
classes_Feature = Class(name="classes_Feature", is_abstract=True)
RedefinableElement = Class(name="RedefinableElement")
classes_Classifier = Class(name="classes_Classifier", is_abstract=True)
classes_RedefinableElement = Class(name="classes_RedefinableElement", is_abstract=True)
Type = Class(name="Type")
classes_Generalization = Class(name="classes_Generalization")
classes_Property = Class(name="classes_Property")
...
classes_MultiplicityElement = Class(name="classes_MultiplicityElement")
classes_BehavioralFeature = Class(name="classes_BehavioralFeature", is_abstract=True)
classes_Parameter = Class(name="classes_Parameter")
classes_Operation = Class(name="classes_Operation")
BehavioralFeature = Class(name="BehavioralFeature")
classes_InstanceSpecification = Class(name="classes_InstanceSpecification")
classes_Slot = Class(name="classes_Slot")
classes_InstanceValue = Class(name="classes_InstanceValue")
ValueSpecification = Class(name="ValueSpecification")
classes_LiteralBoolean = Class(name="classes_LiteralBoolean")
LiteralSpecification = Class(name="LiteralSpecification")
classes_LiteralSpecification = Class(name="classes_LiteralSpecification", is_abstract=True)
classes_LiteralInteger = Class(name="classes_LiteralInteger")
classes_LiteralNull = Class(name="classes_LiteralNull")
classes_LiteralString = Class(name="classes_LiteralString")
classes_LiteralUnlimitedNatural = Class(name="classes_LiteralUnlimitedNatural")
classes_PrimitiveType = Class(name="classes_PrimitiveType")
DataType = Class(name="DataType")
classes_Enumeration = Class(name="classes_Enumeration")
classes_EnumerationLiteral = Class(name="classes_EnumerationLiteral")
...
classes_ValueSpecification.methods={classes_ValueSpecification_m_unlimitedValue, classes_ValueSpecification_m_booleanValue, classes_ValueSpecification_m_integerValue, classes_ValueSpecification_m_stringValue, classes_ValueSpecification_m_isComputable, classes_ValueSpecification_m_isNull}
...
classes_NamedElement.attributes={classes_NamedElement_qualifiedName, classes_NamedElement_visibility, classes_NamedElement_name}
...
classes_Property.attributes={classes_Property_composite, classes_Property_aggregation, classes_Property_derivedUnion, classes_Property_derived}
...
classes_MultiplicityElement.methods={classes_MultiplicityElement_m_lowerBound, classes_MultiplicityElement_m_upperBound}
...
classes_Operation.attributes={classes_Operation_lower, classes_Operation_ordered, classes_Operation_unique, classes_Operation_query, classes_Operation_upper}
...
classes_LiteralBoolean.methods={classes_LiteralBoolean_m_booleanValue, classes_LiteralBoolean_m_isComputable}
...
classes_LiteralNull.methods={classes_LiteralNull_m_isComputable, classes_LiteralNull_m_isNull}
...
classes_LiteralString.methods={classes_LiteralString_m_stringValue, classes_LiteralString_m_isComputable}
...
classes_LiteralUnlimitedNatural.methods={classes_LiteralUnlimitedNatural_m_unlimitedValue, classes_LiteralUnlimitedNatural_m_isComputable}
...
class_59: BinaryAssociation = BinaryAssociation(
    name="class_59",
    ends={
...
class_79: BinaryAssociation = BinaryAssociation(
    name="class_79",
    ends={
...
ownedAttribute98: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="class_", type=classes_Property, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
ownedOperation100: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="class_101", type=classes_Operation, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
domain_model = DomainModel(
    name="classes",
    types={classes_ValueSpecification, TypedElement, classes_TypedElement, NamedElement, classes_Type, classes_NamedElement, Element, classes_Namespace, classes_Element, classes_Comment, classes_ElementImport, classes_PackageImport, classes_PackageableElement, classes_Package, Namespace, PackageableElement, classes_StructuralFeature, Feature, MultiplicityElement, classes_Feature, RedefinableElement, classes_Classifier, classes_RedefinableElement, Type, classes_Generalization, classes_Property, StructuralFeature, classes_Association, classes_DataType, classes_Class, Classifier, classes_MultiplicityElement, classes_BehavioralFeature, classes_Parameter, classes_Operation, BehavioralFeature, classes_InstanceSpecification, classes_Slot, classes_InstanceValue, ValueSpecification, classes_LiteralBoolean, LiteralSpecification, classes_LiteralSpecification, classes_LiteralInteger, classes_LiteralNull, classes_LiteralString, classes_LiteralUnlimitedNatural, classes_PrimitiveType, DataType, classes_Enumeration, classes_EnumerationLiteral, InstanceSpecification, classes_Model, Package, VisibilityKind, AggregationKind, ParameterDirectionKind},
    associations={type0, namespace1, ownedElement3, owner5, ownedComment7, annotatedElement8, member11, elementImport12, packageImport13, importedMember15, ownedMember17, importedElement18, importingNamespace20, importedPackage22, importingNamespace23, packagedElement25, ownedType28, nestedPackage30, nestingPackage32, package34, featuringClassifier36, redefinedElement38, redefinitionContext39, generalization41, feature42, inheritedMember43, attribute46, general49, general51, specific53, owningAssociation55, association56, datatype58, class_59, opposite62, endType64, memberEnd66, navigableOwnedEnd67, ownedEnd70, ownedAttribute72, upperValue74, lowerValue75, ownedParameter78, class_79, redefinedOperation82, type83, classifier86, slot88, definingFeature89, value90, owningInstance93, instance94, ownedAttribute98, ownedLiteral96, enumeration97, ownedOperation100, superClass103, nestedClassifier104},
    generalizations={gen_classes_ValueSpecification_TypedElement, gen_classes_TypedElement_NamedElement, gen_classes_NamedElement_Element, gen_classes_Namespace_NamedElement, gen_classes_ElementImport_Element, gen_classes_PackageableElement_NamedElement, gen_classes_PackageImport_Element, gen_classes_Package_Namespace, gen_classes_Package_PackageableElement, gen_classes_Type_PackageableElement, gen_classes_StructuralFeature_Feature, gen_classes_StructuralFeature_MultiplicityElement, gen_classes_StructuralFeature_TypedElement, gen_classes_Feature_RedefinableElement, gen_classes_RedefinableElement_NamedElement, gen_classes_Classifier_Namespace, gen_classes_Classifier_Type, gen_classes_Generalization_Element, gen_classes_Property_StructuralFeature, gen_classes_Association_Classifier, gen_classes_DataType_Classifier, gen_classes_MultiplicityElement_Element, gen_classes_BehavioralFeature_Feature, gen_classes_Parameter_MultiplicityElement, gen_classes_Parameter_TypedElement, gen_classes_Operation_BehavioralFeature, gen_classes_InstanceSpecification_NamedElement, gen_classes_Slot_Element, gen_classes_InstanceValue_ValueSpecification, gen_classes_LiteralBoolean_LiteralSpecification, gen_classes_LiteralSpecification_ValueSpecification, gen_classes_LiteralInteger_LiteralSpecification, gen_classes_LiteralNull_LiteralSpecification, gen_classes_LiteralString_LiteralSpecification, gen_classes_LiteralUnlimitedNatural_LiteralSpecification, gen_classes_PrimitiveType_DataType, gen_classes_Enumeration_DataType, gen_classes_EnumerationLiteral_InstanceSpecification, gen_classes_Class_Classifier, gen_classes_Model_Package},
    metadata=None
)
