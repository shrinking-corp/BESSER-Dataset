...
class classes_Operation(BehavioralFeature):
    ...
    def Operation(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "class_101"):
                opp_val = getattr(old_value, "class_101", None)
                if isinstance(opp_val, set):
                    opp_val.discard(self)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "class_101"):
                opp_val = getattr(value, "class_101", None)
                if opp_val is None:
                    setattr(value, "class_101", set([self]))
                elif isinstance(opp_val, set):
                    opp_val.add(self)
...
class classes_Class(Classifier):
    ...
    def __init__(self, active: bool, Class80: "classes_Operation" = None, class_: set["classes_Property"] = None, class_101: set["classes_Operation"] = None, classes_Class: "classes_Class" = None, classes_Class102: set["classes_Class"] = None, classes_Class105: set["classes_Classifier"] = None, Class: "classes_Property" = None):
        self.active = active
        self.Class80 = Class80
        self.class_ = class_ if class_ is not None else set()
        self.class_101 = class_101 if class_101 is not None else set()
    ...
    @property
    def class_101(self):
        return self.__class_101

    @class_101.setter
    def class_101(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_classes_Class__class_101", None)
        self.__class_101 = value if value is not None else set()
    ...
    def class_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_classes_Class__class_", None)
...
class classes_Association(Classifier):
    ...
    def __init__(self, derived: bool, association: set["classes_Property"] = None, classes_Association68: set["classes_Property"] = None, owningAssociation: set["classes_Property"] = None, Association: "classes_Property" = None, Association57: "classes_Property" = None, classes_Association: set["classes_Type"] = None):
...
class classes_Property(StructuralFeature):
    ...
    def __init__(self, derived: bool, derivedUnion: bool, aggregation: str, composite: bool, Property: "classes_Association" = None, classes_Property69: "classes_Association" = None, Property71: "classes_Association" = None, Property73: "classes_DataType" = None, Property99: "classes_Class" = None, classes_Property: "classes_Classifier" = None, ownedEnd: "classes_Association" = None, memberEnd: "classes_Association" = None, ownedAttribute: "classes_DataType" = None, ownedAttribute60: "classes_Class" = None, classes_Property63: "classes_Property" = None, classes_Property61: "classes_Property" = None):
        self.derived = derived
...
class classes_Classifier(Type, Namespace):
    ...
    def __init__(self, abstract: bool, finalSpecialization: bool, classes_Classifier87: "classes_InstanceSpecification" = None, classes_Classifier106: "classes_Class" = None, Classifier: "classes_Feature" = None, classes_Classifier: "classes_RedefinableElement" = None, specific: set["classes_Generalization"] = None, featuringClassifier: set["classes_Feature"] = None, classes_Classifier44: set["classes_NamedElement"] = None, classes_Classifier47: set["classes_Property"] = None, classes_Classifier50: "classes_Classifier" = None, classes_Classifier48: set["classes_Classifier"] = None, classes_Classifier52: "classes_Generalization" = None, Classifier54: "classes_Generalization" = None):
        self.abstract = abstract
...
class classes_Package(PackageableElement, Namespace):
...
class classes_ElementImport(Element):
    ...
    def __init__(self, visibility: str, alias: str, ElementImport: "classes_Namespace" = None, classes_ElementImport: "classes_PackageableElement" = None, elementImport: "classes_Namespace" = None):
...
class classes_PackageImport(Element):
    ...
    def __init__(self, visibility: str, PackageImport: "classes_Namespace" = None, classes_PackageImport: "classes_Package" = None, packageImport: "classes_Namespace" = None):
        self.visibility = visibility
...
class classes_Generalization(Element):
    ...
    def __init__(self, substitutable: bool, Generalization: "classes_Classifier" = None, classes_Generalization: "classes_Classifier" = None, generalization: "classes_Classifier" = None):
...
class classes_NamedElement(Element):
    ...
    def __init__(self, qualifiedName: str, name: str, visibility: str, ownedMember: "classes_Namespace" = None, classes_NamedElement: "classes_Namespace" = None, NamedElement: "classes_Namespace" = None, classes_NamedElement45: "classes_Classifier" = None):
...
class classes_RedefinableElement(NamedElement):
    ...
    def __init__(self, leaf: bool, classes_RedefinableElement: "classes_RedefinableElement" = None, classes_RedefinableElement37: set["classes_RedefinableElement"] = None, classes_RedefinableElement40: set["classes_Classifier"] = None):
        self.leaf = leaf
...
class classes_StructuralFeature(TypedElement, Feature, MultiplicityElement):
