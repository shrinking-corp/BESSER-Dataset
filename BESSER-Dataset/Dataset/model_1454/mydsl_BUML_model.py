...
# Classes
mydsl_Graph = Class(name="mydsl_Graph")
mydsl_Edge = Class(name="mydsl_Edge")
mydsl_Node = Class(name="mydsl_Node")
...
mydsl_Edge.attributes={mydsl_Edge_label, mydsl_Edge_parsed_source, mydsl_Edge_parsed_target}
...
mydsl_Node.attributes={mydsl_Node_name, mydsl_Node_isInvisible, mydsl_Node_content}
...
domain_model = DomainModel(
    ...
    associations={subgraphs4, target6, source9, edges0, nodes1},
    generalizations={},
    metadata=None
)
