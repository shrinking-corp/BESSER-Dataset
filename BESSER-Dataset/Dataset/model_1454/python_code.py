...
class mydsl_Node:
    ...
    def __init__(self, isInvisible: bool, content: str, name: str, mydsl_Node8: "mydsl_Edge" = None, mydsl_Node11: "mydsl_Edge" = None, mydsl_Node: "mydsl_Graph" = None):
...
class mydsl_Edge:
    ...
    def __init__(self, label: str, parsed_target: str, parsed_source: str, mydsl_Edge7: "mydsl_Node" = None, mydsl_Edge10: "mydsl_Node" = None, mydsl_Edge: "mydsl_Graph" = None):
        self.label = label
...
class mydsl_Graph:
    ...
    def __init__(self, name: str, mydsl_Graph5: "mydsl_Graph" = None, mydsl_Graph3: set["mydsl_Graph"] = None, mydsl_Graph: set["mydsl_Edge"] = None, mydsl_Graph2: set["mydsl_Node"] = None):
        self.name = name
