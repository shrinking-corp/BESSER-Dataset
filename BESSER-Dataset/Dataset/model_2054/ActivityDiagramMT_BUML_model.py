...
activitydiagram_Expression = Class(name="activitydiagram_Expression")
...
activitydiagram_Activity_m_main: Method = Method(name="main", parameters={Parameter(name='activitydiagram_value', type=StringType)})
activitydiagram_Activity_m_execute: Method = Method(name="execute", parameters={Parameter(name='activitydiagram_c', type=StringType)})
...
activitydiagram_Activity.methods={activitydiagram_Activity_m_main, activitydiagram_Activity_m_writeTrace, activitydiagram_Activity_m_printTrace, activitydiagram_Activity_m_writeToFile, activitydiagram_Activity_m_getBooleanVariableValue, activitydiagram_Activity_m_getVariableValue, activitydiagram_Activity_m_execute, activitydiagram_Activity_m_getIntegerVariableValue, activitydiagram_Activity_m_reset, activitydiagram_Activity_m_getVariable}
...
activitydiagram_ActivityNode_m_execute: Method = Method(name="execute", parameters={Parameter(name='activitydiagram_c', type=StringType)})
...
activitydiagram_ActivityNode.methods={activitydiagram_ActivityNode_m_terminate, activitydiagram_ActivityNode_m_addTokens, activitydiagram_ActivityNode_m_sendOffers, activitydiagram_ActivityNode_m_hasOffers, activitydiagram_ActivityNode_m_isReady, activitydiagram_ActivityNode_m_takeOfferdTokens, activitydiagram_ActivityNode_m_execute, activitydiagram_ActivityNode_m_removeToken}
...
activitydiagram_ActivityEdge.methods={activitydiagram_ActivityEdge_m_sendOffer, activitydiagram_ActivityEdge_m_hasOffer, activitydiagram_ActivityEdge_m_takeOfferedTokens}
...
activitydiagram_Variable_m_execute: Method = Method(name="execute", parameters={Parameter(name='activitydiagram_c', type=StringType)})
activitydiagram_Variable_m_init: Method = Method(name="init", parameters={Parameter(name='activitydiagram_c', type=StringType)})
...
activitydiagram_BooleanVariable_m_execute: Method = Method(name="execute", parameters={Parameter(name='activitydiagram_c', type=StringType)})
...
activitydiagram_OpaqueAction_m_execute: Method = Method(name="execute", parameters={Parameter(name='activitydiagram_c', type=StringType)})
...
activitydiagram_Expression_m_execute: Method = Method(name="execute", parameters={Parameter(name='activitydiagram_c', type=StringType)})
...
activitydiagram_NamedElement_m_execute: Method = Method(name="execute", parameters={Parameter(name='activitydiagram_c', type=StringType)})
...
activitydiagram_InitialNode_m_execute: Method = Method(name="execute", parameters={Parameter(name='activitydiagram_c', type=StringType)})
...
activitydiagram_ActivityFinalNode_m_execute: Method = Method(name="execute", parameters={Parameter(name='activitydiagram_c', type=StringType)})
...
activitydiagram_ForkNode_m_execute: Method = Method(name="execute", parameters={Parameter(name='activitydiagram_c', type=StringType)})
activitydiagram_ForkNode.methods={activitydiagram_ForkNode_m_execute}

# activitydiagram_JoinNode class attributes and methods
activitydiagram_JoinNode_m_execute: Method = Method(name="execute", parameters={Parameter(name='activitydiagram_c', type=StringType)})
...
activitydiagram_MergeNode_m_execute: Method = Method(name="execute", parameters={Parameter(name='activitydiagram_c', type=StringType)})
...
activitydiagram_IntegerVariable_m_execute: Method = Method(name="execute", parameters={Parameter(name='activitydiagram_c', type=StringType)})
...
activitydiagram_DecisionNode_m_execute: Method = Method(name="execute", parameters={Parameter(name='activitydiagram_c', type=StringType)})
...
activitydiagram_IntegerComparisonExpression_m_execute: Method = Method(name="execute", parameters={Parameter(name='activitydiagram_c', type=StringType)})
...
activitydiagram_BooleanUnaryExpression_m_execute: Method = Method(name="execute", parameters={Parameter(name='activitydiagram_c', type=StringType)})
...
activitydiagram_BooleanBinaryExpression_m_execute: Method = Method(name="execute", parameters={Parameter(name='activitydiagram_c', type=StringType)})
...
activitydiagram_IntegerCalculationExpression_m_execute: Method = Method(name="execute", parameters={Parameter(name='activitydiagram_c', type=StringType)})
...
activitydiagram_Token_m_transfer: Method = Method(name="transfer", parameters={Parameter(name='activitydiagram_holder', type=StringType)}, type=StringType)
...
activitydiagram_Token.methods={activitydiagram_Token_m_withdraw, activitydiagram_Token_m_isWithdrawn, activitydiagram_Token_m_transfer}
...
offers15: BinaryAssociation = BinaryAssociation(
    name="offers15",
    ends={
        Property(name="activitydiagram_Offer", type=activitydiagram_ActivityEdge, multiplicity=Multiplicity(1, 1)),
        Property(name="activitydiagram_ActivityEdge16", type=activitydiagram_Offer, multiplicity=Multiplicity(0, 9999))
    }
)
...
expressions18: BinaryAssociation = BinaryAssociation(
    name="expressions18",
    ends={
...
initialValue19: BinaryAssociation = BinaryAssociation(
    name="initialValue19",
    ends={
...
currentValue21: BinaryAssociation = BinaryAssociation(
    name="currentValue21",
    ends={
        Property(name="activitydiagram_Value23", type=activitydiagram_Variable, multiplicity=Multiplicity(1, 1)),
        Property(name="activitydiagram_Variable22", type=activitydiagram_Value, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
...
operand125: BinaryAssociation = BinaryAssociation(
    name="operand125",
    ends={
        Property(name="activitydiagram_IntegerVariable27", type=activitydiagram_IntegerExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="activitydiagram_IntegerExpression26", type=activitydiagram_IntegerVariable, multiplicity=Multiplicity(0, 1))
    }
)
assignee30: BinaryAssociation = BinaryAssociation(
    name="assignee30",
    ends={
        Property(name="activitydiagram_IntegerVariable31", type=activitydiagram_IntegerCalculationExpression, multiplicity=Multiplicity(1, 1)),
...
assignee32: BinaryAssociation = BinaryAssociation(
    name="assignee32",
    ends={
        Property(name="activitydiagram_BooleanVariable33", type=activitydiagram_IntegerComparisonExpression, multiplicity=Multiplicity(1, 1)),
...
operand34: BinaryAssociation = BinaryAssociation(
    name="operand34",
    ends={
        Property(name="activitydiagram_BooleanVariable35", type=activitydiagram_BooleanUnaryExpression, multiplicity=Multiplicity(1, 1)),
...
operand136: BinaryAssociation = BinaryAssociation(
    name="operand136",
    ends={
        Property(name="activitydiagram_BooleanVariable37", type=activitydiagram_BooleanBinaryExpression, multiplicity=Multiplicity(1, 1)),
...
operand238: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="activitydiagram_BooleanBinaryExpression39", type=activitydiagram_BooleanVariable, multiplicity=Multiplicity(1, 1))
    }
)
value41: BinaryAssociation = BinaryAssociation(
    name="value41",
    ends={
        Property(name="activitydiagram_Value42", type=activitydiagram_InputValue, multiplicity=Multiplicity(1, 1)),
...
assignee28: BinaryAssociation = BinaryAssociation(
    name="assignee28",
    ends={
        Property(name="activitydiagram_BooleanVariable29", type=activitydiagram_BooleanExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="activitydiagram_BooleanExpression", type=activitydiagram_BooleanVariable, multiplicity=Multiplicity(1, 1))
    }
)
inputValues46: BinaryAssociation = BinaryAssociation(
    name="inputValues46",
    ends={
        Property(name="activitydiagram_InputValue47", type=activitydiagram_Input, multiplicity=Multiplicity(1, 1)),
        Property(name="activitydiagram_Input", type=activitydiagram_InputValue, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
offeredTokens48: BinaryAssociation = BinaryAssociation(
    name="offeredTokens48",
    ends={
        Property(name="activitydiagram_Token", type=activitydiagram_Offer, multiplicity=Multiplicity(1, 1)),
        Property(name="activitydiagram_Offer49", type=activitydiagram_Token, multiplicity=Multiplicity(0, 9999))
    }
)
holder50: BinaryAssociation = BinaryAssociation(
    name="holder50",
    ends={
        Property(name="activitydiagram_ActivityNode", type=activitydiagram_Token, multiplicity=Multiplicity(1, 1)),
        Property(name="activitydiagram_Token51", type=activitydiagram_ActivityNode, multiplicity=Multiplicity(0, 1))
    }
)
output52: BinaryAssociation = BinaryAssociation(
    name="output52",
    ends={
...
activity53: BinaryAssociation = BinaryAssociation(
    name="activity53",
    ends={
        Property(name="activitydiagram_Activity55", type=activitydiagram_Context, multiplicity=Multiplicity(1, 1)),
        Property(name="activitydiagram_Context54", type=activitydiagram_Activity, multiplicity=Multiplicity(0, 1))
    }
)
parent57: BinaryAssociation = BinaryAssociation(
    name="parent57",
    ends={
        Property(name="activitydiagram_Context58", type=activitydiagram_Context, multiplicity=Multiplicity(1, 1)),
        Property(name="activitydiagram_Context56", type=activitydiagram_Context, multiplicity=Multiplicity(0, 1))
    }
)
inputValues59: BinaryAssociation = BinaryAssociation(
    name="inputValues59",
    ends={
        Property(name="activitydiagram_InputValue61", type=activitydiagram_Context, multiplicity=Multiplicity(1, 1)),
        Property(name="activitydiagram_Context60", type=activitydiagram_InputValue, multiplicity=Multiplicity(0, 9999))
    }
)
node62: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="activitydiagram_Context63", type=activitydiagram_JoinNode, multiplicity=Multiplicity(0, 1))
    }
)
...
variable43: BinaryAssociation = BinaryAssociation(
    name="variable43",
    ends={
        Property(name="activitydiagram_Variable45", type=activitydiagram_InputValue, multiplicity=Multiplicity(1, 1)),
        Property(name="activitydiagram_InputValue44", type=activitydiagram_Variable, multiplicity=Multiplicity(1, 1))
    }
)
...
domain_model = DomainModel(
    ...
    types={activitydiagram_Activity, NamedElement, activitydiagram_ActivityNode, activitydiagram_ActivityEdge, activitydiagram_Variable, activitydiagram_Offer, activitydiagram_ControlFlow, ActivityEdge, activitydiagram_BooleanVariable, activitydiagram_ControlNode, ActivityNode, activitydiagram_ExecutableNode, activitydiagram_Action, ExecutableNode, activitydiagram_OpaqueAction, Action, activitydiagram_Expression, activitydiagram_NamedElement, activitydiagram_InitialNode, ControlNode, activitydiagram_FinalNode, activitydiagram_ActivityFinalNode, FinalNode, activitydiagram_ForkNode, activitydiagram_JoinNode, activitydiagram_MergeNode, activitydiagram_Value, activitydiagram_IntegerVariable, Variable, activitydiagram_BooleanValue, Value, activitydiagram_IntegerValue, activitydiagram_IntegerExpression, Expression, activitydiagram_BooleanExpression, activitydiagram_DecisionNode, activitydiagram_IntegerComparisonExpression, activitydiagram_BooleanUnaryExpression, BooleanExpression, activitydiagram_BooleanBinaryExpression, activitydiagram_InputValue, activitydiagram_IntegerCalculationExpression, IntegerExpression, activitydiagram_Token, activitydiagram_Context, activitydiagram_Trace, activitydiagram_ForkedToken, Token, activitydiagram_ControlToken, activitydiagram_Input, IntegerCalculationOperator, IntegerComparisonOperator, BooleanUnaryOperator, BooleanBinaryOperator},
    associations={nodes0, inputs4, outgoing7, incoming8, activity10, source11, target13, edges1, locals2, offers15, guard17, expressions18, initialValue19, currentValue21, operand224, operand125, assignee30, assignee32, operand34, operand136, operand238, value41, assignee28, inputValues46, offeredTokens48, holder50, output52, activity53, parent57, inputValues59, node62, executedNodes64, baseToken67, variable43},
    generalizations={gen_activitydiagram_Activity_NamedElement, gen_activitydiagram_ActivityNode_NamedElement, gen_activitydiagram_ActivityEdge_NamedElement, gen_activitydiagram_ControlFlow_ActivityEdge, gen_activitydiagram_ControlNode_ActivityNode, gen_activitydiagram_ExecutableNode_ActivityNode, gen_activitydiagram_Action_ExecutableNode, gen_activitydiagram_OpaqueAction_Action, gen_activitydiagram_InitialNode_ControlNode, gen_activitydiagram_FinalNode_ControlNode, gen_activitydiagram_ActivityFinalNode_FinalNode, gen_activitydiagram_ForkNode_ControlNode, gen_activitydiagram_JoinNode_ControlNode, gen_activitydiagram_MergeNode_ControlNode, gen_activitydiagram_IntegerVariable_Variable, gen_activitydiagram_BooleanVariable_Variable, gen_activitydiagram_BooleanValue_Value, gen_activitydiagram_IntegerValue_Value, gen_activitydiagram_IntegerExpression_Expression, gen_activitydiagram_BooleanExpression_Expression, gen_activitydiagram_DecisionNode_ControlNode, gen_activitydiagram_IntegerComparisonExpression_IntegerExpression, gen_activitydiagram_BooleanUnaryExpression_BooleanExpression, gen_activitydiagram_BooleanBinaryExpression_BooleanExpression, gen_activitydiagram_IntegerCalculationExpression_IntegerExpression, gen_activitydiagram_ForkedToken_Token, gen_activitydiagram_ControlToken_Token},
    metadata=None
)
