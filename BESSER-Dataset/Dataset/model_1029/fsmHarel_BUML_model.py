...
trigger28: BinaryAssociation = BinaryAssociation(
    name="trigger28",
    ends={
        Property(name="fsm_Trigger29", type=fsm_NotTrigger, multiplicity=Multiplicity(1, 1)),
...
left30: BinaryAssociation = BinaryAssociation(
    name="left30",
    ends={
        Property(name="fsm_Trigger31", type=fsm_AndTrigger, multiplicity=Multiplicity(1, 1)),
...
right32: BinaryAssociation = BinaryAssociation(
    name="right32",
    ends={
        Property(name="fsm_Trigger34", type=fsm_AndTrigger, multiplicity=Multiplicity(1, 1)),
        Property(name="fsm_AndTrigger33", type=fsm_Trigger, multiplicity=Multiplicity(1, 1))
    }
)
left35: BinaryAssociation = BinaryAssociation(
    name="left35",
    ends={
        Property(name="fsm_Trigger36", type=fsm_OrTrigger, multiplicity=Multiplicity(1, 1)),
...
right37: BinaryAssociation = BinaryAssociation(
    name="right37",
    ends={
        Property(name="fsm_Trigger39", type=fsm_OrTrigger, multiplicity=Multiplicity(1, 1)),
        Property(name="fsm_OrTrigger38", type=fsm_Trigger, multiplicity=Multiplicity(1, 1))
    }
)
...
statements40: BinaryAssociation = BinaryAssociation(
    name="statements40",
    ends={
        Property(name="fsm_Statement42", type=fsm_Program, multiplicity=Multiplicity(1, 1)),
        Property(name="fsm_Program41", type=fsm_Statement, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
domain_model = DomainModel(
    name="fsm",
    types={fsm_StateMachine, NamedElement, fsm_Region, fsm_AbstractState, fsm_Transition, fsm_State, AbstractState, fsm_Program, fsm_Trigger, fsm_Statement, fsm_Constraint, fsm_NotTrigger, Trigger, fsm_AndTrigger, fsm_OrTrigger, fsm_Pseudostate, fsm_InitialState, Pseudostate, fsm_Fork, fsm_Join, fsm_DeepHistory, fsm_ShallowHistory, fsm_Junction, fsm_Conditional, fsm_FinalState, State, Statement, fsm_NamedElement},
    associations={regions0, subvertex1, transitions2, ownerState4, incoming5, outgoing6, ownerRegion8, doActivity9, entry10, trigger18, target20, source22, effect24, guard26, trigger28, left30, right32, left35, right37, exit13, ownedRegions16, statements40},
    generalizations={gen_fsm_StateMachine_NamedElement, gen_fsm_Region_NamedElement, gen_fsm_AbstractState_NamedElement, gen_fsm_State_AbstractState, gen_fsm_NotTrigger_Trigger, gen_fsm_AndTrigger_Trigger, gen_fsm_OrTrigger_Trigger, gen_fsm_Pseudostate_AbstractState, gen_fsm_InitialState_Pseudostate, gen_fsm_Fork_Pseudostate, gen_fsm_Join_Pseudostate, gen_fsm_DeepHistory_Pseudostate, gen_fsm_ShallowHistory_Pseudostate, gen_fsm_Junction_Pseudostate, gen_fsm_Conditional_Pseudostate, gen_fsm_FinalState_State, gen_fsm_Program_Statement, gen_fsm_Transition_NamedElement},
    metadata=None
)
