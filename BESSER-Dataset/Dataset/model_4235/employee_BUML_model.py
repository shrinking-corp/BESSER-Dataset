...
employee_Employee.attributes={employee_Employee_hireDate, employee_Employee_name, employee_Employee_age, employee_Employee_salary}
...
domain_model = DomainModel(
    name="employee",
    types={employee_Department, employee_Employee},
