...
class mgraph_MEdge:
    ...
    def __init__(self, name: str, MEdge: "mgraph_MGraph" = None, to: "mgraph_MNode" = None, from_: "mgraph_MNode" = None, edges: "mgraph_MGraph" = None, MEdge11: "mgraph_MNode" = None, MEdge13: "mgraph_MNode" = None):
        self.name = name
        self.MEdge = MEdge
        self.to = to
        self.from_ = from_
...
class mgraph_MNode:
    ...
    def __init__(self, name: str, MNode: "mgraph_MGraph" = None, MNode4: "mgraph_MEdge" = None, MNode6: "mgraph_MEdge" = None, nodes: "mgraph_MGraph" = None, outGoing: set["mgraph_MEdge"] = None, inComing: set["mgraph_MEdge"] = None):
        self.name = name
        self.MNode = MNode
        self.MNode4 = MNode4
        self.MNode6 = MNode6
