...
Registration.attributes={Registration_userName, Registration_fname, Registration_password, Registration_lname}
...
domain_model = DomainModel(
    name="_82cfe2d7_a264_47ef_8f5f_3495a72eaafd",
    types={User, Profile, Post, Group, Message, Friend, Page, Registration, Login, Class_},
    associations={User_Group, User_Registeration, User_Message, User_Friends, User_Pages, User_Myprofile, User_Post, User_Login},
    generalizations={},
    metadata=None
)
