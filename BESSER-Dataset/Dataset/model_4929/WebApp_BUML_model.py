...
# Classes
webapp_Collection = Class(name="webapp_Collection")
webapp_AbstractView = Class(name="webapp_AbstractView", is_abstract=True)
webapp_Model = Class(name="webapp_Model")
webapp_Attribute = Class(name="webapp_Attribute")
webapp_Reference = Class(name="webapp_Reference")
webapp_NamedElement = Class(name="webapp_NamedElement")
webapp_Application = Class(name="webapp_Application")
NamedElement = Class(name="NamedElement")
webapp_Router = Class(name="webapp_Router")
webapp_ModelView = Class(name="webapp_ModelView")
AbstractView = Class(name="AbstractView")
webapp_Operation = Class(name="webapp_Operation")
webapp_Parameter = Class(name="webapp_Parameter")
webapp_RouterMapping = Class(name="webapp_RouterMapping")
webapp_Video = Class(name="webapp_Video")
webapp_Gallery = Class(name="webapp_Gallery")
webapp_ImagesBlock = Class(name="webapp_ImagesBlock")
webapp_TextArea = Class(name="webapp_TextArea")
FormWidget = Class(name="FormWidget")
webapp_Spinner = Class(name="webapp_Spinner")
webapp_CheckBox = Class(name="webapp_CheckBox")
webapp_StaticView = Class(name="webapp_StaticView")
webapp_Section = Class(name="webapp_Section")
webapp_Widget = Class(name="webapp_Widget", is_abstract=True)
webapp_Form = Class(name="webapp_Form")
Widget = Class(name="Widget")
webapp_FormWidget = Class(name="webapp_FormWidget", is_abstract=True)
...
webapp_Table.attributes={webapp_Table_bordered, webapp_Table_striped, webapp_Table_rowNames, webapp_Table_columnNames}
...
domain_model = DomainModel(
    name="webapp",
    types={webapp_Collection, webapp_AbstractView, webapp_Model, webapp_Attribute, webapp_Reference, webapp_NamedElement, webapp_Application, NamedElement, webapp_Router, webapp_ModelView, AbstractView, webapp_Operation, webapp_Parameter, webapp_RouterMapping, webapp_Video, webapp_Gallery, webapp_ImagesBlock, webapp_TextArea, FormWidget, webapp_Spinner, webapp_CheckBox, webapp_StaticView, webapp_Section, webapp_Widget, webapp_Form, Widget, webapp_FormWidget, webapp_Table, webapp_Text},
    associations={router0, collections1, views3, models5, attributes7, references8, mappings22, application23, view25, operations27, application30, collection32, operations10, application12, type13, parameters16, model18, application20, form40, sections34, widgets35, view36, section37, formWidgets39},
    generalizations={gen_webapp_Model_NamedElement, gen_webapp_Application_NamedElement, gen_webapp_AbstractView_NamedElement, gen_webapp_ModelView_AbstractView, gen_webapp_Attribute_NamedElement, gen_webapp_Reference_NamedElement, gen_webapp_Operation_NamedElement, gen_webapp_Parameter_NamedElement, gen_webapp_Collection_NamedElement, gen_webapp_Router_NamedElement, gen_webapp_Video_Widget, gen_webapp_Gallery_Widget, gen_webapp_ImagesBlock_Widget, gen_webapp_TextArea_FormWidget, gen_webapp_Spinner_FormWidget, gen_webapp_CheckBox_FormWidget, gen_webapp_StaticView_AbstractView, gen_webapp_Form_Widget, gen_webapp_Table_Widget, gen_webapp_Text_Widget},
    metadata=None
)
