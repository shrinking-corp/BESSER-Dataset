...
class petrinetDsl_Transaction:
    ...
    def __init__(self, name: str, petrinetDsl_Transaction11: set["petrinetDsl_AssureStatement"] = None, petrinetDsl_Transaction13: set["petrinetDsl_TakeStatement"] = None, petrinetDsl_Transaction15: set["petrinetDsl_PutStatement"] = None, petrinetDsl_Transaction: "petrinetDsl_PetriNet" = None):
        self.name = name
...
class petrinetDsl_Place:
    ...
    def __init__(self, name: str, petrinetDsl_Place: "petrinetDsl_PetriNet" = None, petrinetDsl_Place6: set["petrinetDsl_Storage"] = None, petrinetDsl_Place21: "petrinetDsl_AssureStatement" = None, petrinetDsl_Place27: "petrinetDsl_TakeStatement" = None, petrinetDsl_Place33: "petrinetDsl_PutStatement" = None):
        self.name = name
...
class petrinetDsl_Resource:
    ...
    def __init__(self, name: str, petrinetDsl_Resource: "petrinetDsl_PetriNet" = None, petrinetDsl_Resource9: "petrinetDsl_Storage" = None, petrinetDsl_Resource18: "petrinetDsl_AssureStatement" = None, petrinetDsl_Resource24: "petrinetDsl_TakeStatement" = None, petrinetDsl_Resource30: "petrinetDsl_PutStatement" = None):
        self.name = name
...
class petrinetDsl_PutStatement:
    ...
    def __init__(self, count: int, petrinetDsl_PutStatement: "petrinetDsl_Transaction" = None, petrinetDsl_PutStatement29: "petrinetDsl_Resource" = None, petrinetDsl_PutStatement32: "petrinetDsl_Place" = None):
        self.count = count
