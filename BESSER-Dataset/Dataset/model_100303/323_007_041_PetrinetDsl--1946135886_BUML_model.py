...
# Classes
petrinetDsl_AssureStatement = Class(name="petrinetDsl_AssureStatement")
petrinetDsl_TakeStatement = Class(name="petrinetDsl_TakeStatement")
petrinetDsl_PutStatement = Class(name="petrinetDsl_PutStatement")
petrinetDsl_PetriNet = Class(name="petrinetDsl_PetriNet")
petrinetDsl_Resource = Class(name="petrinetDsl_Resource")
petrinetDsl_Place = Class(name="petrinetDsl_Place")
petrinetDsl_Transaction = Class(name="petrinetDsl_Transaction")
petrinetDsl_Storage = Class(name="petrinetDsl_Storage")
...
petrinetDsl_Storage.attributes={petrinetDsl_Storage_count, petrinetDsl_Storage_capacity}
...
domain_model = DomainModel(
    name="petrinetDsl",
    types={petrinetDsl_AssureStatement, petrinetDsl_TakeStatement, petrinetDsl_PutStatement, petrinetDsl_PetriNet, petrinetDsl_Resource, petrinetDsl_Place, petrinetDsl_Transaction, petrinetDsl_Storage},
    associations={assureStatements10, takeStatements12, putStatements14, resources0, places1, transactions3, storages5, resourceRef7, resourceRef16, placeRef19, resourceRef22, placeRef25, resourceRef28, placeRef31},
    generalizations={},
    metadata=None
)
