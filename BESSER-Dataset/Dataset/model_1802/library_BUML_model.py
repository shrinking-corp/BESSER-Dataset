...
library_BaseResource.attributes={library_BaseResource_summaryDisplay, library_BaseResource_shortName, library_BaseResource_longName, library_BaseResource_expressionName, library_BaseResource_detailDisplay}
...
library_Parameter.attributes={library_Parameter_value, library_Parameter_description, library_Parameter_modifiable, library_Parameter_expressionName, library_Parameter_name}
...
library_Equipment.attributes={library_Equipment_redundancy, library_Equipment_state, library_Equipment_position, library_Equipment_count, library_Equipment_equipmentCode}
...
library_ProductInfo.attributes={library_ProductInfo_availableDate, library_ProductInfo_endOfSupportDate, library_ProductInfo_salesCode, library_ProductInfo_endOfSalesDate, library_ProductInfo_productCode, library_ProductInfo_underDevelopmentDate}
...
domain_model = DomainModel(
    name="library",
    types={library_NetXResource, library_BaseExpressionResult, library_BaseResource, Base, library_Unit, library_Component, library_Lifecycle, library_DiagramInfo, library_Metric, library_MultiImage, library_Expression, library_Tolerance, library_Protocol, library_Parameter, library_Equipment, Component, library_EquipmentGroup, library_EquipmentRelationship, library_Value, library_EObject, library_ExpressionResult, BaseExpressionResult, library_Library, library_Function, library_FunctionRelationship, library_LastEvaluationExpressionResult, library_NodeType, library_MetricSource, library_Meta, BaseResource, library_MetricValueRange, library_ProductInfo, library_Vendor, Company, LevelKind, RangeKind, RedundancyType, StateType},
    associations={resourceRefs2, unitRef0, lifecycle1, diagrams18, metricRefs3, icons20, capacityExpressionRef5, utilizationExpressionRef7, toleranceRefs10, protocolRefs12, parameterRefs14, allResources16, equipments23, equipmentGroups24, equipmentRelationshipRefs26, allEquipments29, allEquipments49, diagrams31, equipmentGroupResources34, expressionRefs37, equipmentRefs40, parameterRefs43, allEquipmentResources46, targetResource54, targetValues56, evaluationObject52, functions59, functionRelationshipRefs60, allFunctions63, tolerances80, expressions83, units86, functions65, nodeTypes67, equipments69, metrics72, metricSources75, parameters77, capacityValues97, version89, componentRef91, metricRef92, metricValueRanges95, functions112, equipments115, utilizationValues100, forecastCapacityValues103, forecastValues106, trendedValues109, equipmentRef118, licensedFunctionRef120, nodeTypeRef123, icons129, expressionRef126, products132},
