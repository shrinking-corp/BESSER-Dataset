...
public class library_Library  {
    ...
    public library_Library(
        String protocols,        String name        ArrayList<library_Expression> library_expressions,        ArrayList<library_Metric> library_metrics,        ArrayList<library_Parameter> library_parameters,        ArrayList<library_Unit> library_units,        ArrayList<library_Tolerance> library_tolerances,        ArrayList<library_NodeType> library_nodetypes,        ArrayList<library_Equipment> library_equipments,        ArrayList<library_Function> library_functions    ) {
        this.protocols = protocols;
        this.name = name;
