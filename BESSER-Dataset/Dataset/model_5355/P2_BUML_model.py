...
# Classes
p2_DocumentRoot = Class(name="p2_DocumentRoot")
p2_EStringToStringMapEntry = Class(name="p2_EStringToStringMapEntry")
p2_TargetType = Class(name="p2_TargetType")
p2_LocationsType = Class(name="p2_LocationsType")
p2_LocationType = Class(name="p2_LocationType")
p2_UnitType = Class(name="p2_UnitType")
p2_RepositoryType = Class(name="p2_RepositoryType")
p2_IMetadataRepositoryManager = Class(name="p2_IMetadataRepositoryManager", is_abstract=True)
p2_IMetadataRepository = Class(name="p2_IMetadataRepository", is_abstract=True)
p2_IArtifactRepositoryManager = Class(name="p2_IArtifactRepositoryManager", is_abstract=True)
...
p2_TargetType.methods={p2_TargetType_m_artifactRepositoryManager, p2_TargetType_m_metadataRepositoryManager}
...
p2_LocationType.attributes={p2_LocationType_includeMode, p2_LocationType_includeAllPlatforms, p2_LocationType_includeConfigurePhase, p2_LocationType_includeSource, p2_LocationType_type}
p2_LocationType.methods={p2_LocationType_m_metadataRepository, p2_LocationType_m_artifactRepository}
...
domain_model = DomainModel(
    name="p2",
    types={p2_DocumentRoot, p2_EStringToStringMapEntry, p2_TargetType, p2_LocationsType, p2_LocationType, p2_UnitType, p2_RepositoryType, p2_IMetadataRepositoryManager, p2_IMetadataRepository, p2_IArtifactRepositoryManager, p2_IArtifactRepository, UnitVerificationState},
    associations={xMLNSPrefixMap0, xSISchemaLocation1, target4, location6, unit7, repository9, locations11},
    generalizations={},
    metadata=None
)
