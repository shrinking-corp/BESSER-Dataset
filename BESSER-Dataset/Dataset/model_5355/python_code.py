...
class p2_LocationType:
    ...
    def __init__(self, includeAllPlatforms: str, includeConfigurePhase: str, includeMode: str, includeSource: str, type: str, p2_LocationType: "p2_LocationsType" = None, p2_LocationType8: set["p2_UnitType"] = None, p2_LocationType10: "p2_RepositoryType" = None):
        ...
        pass
    @property
    def includeConfigurePhase(self):
    ...
    def artifactRepository(self) :
        # TODO: Implement artifactRepository method
        pass

    def metadataRepository(self) :
...
class p2_TargetType:
    ...
    def __init__(self, name: str, sequenceNumber: str, p2_TargetType: "p2_DocumentRoot" = None, p2_TargetType12: "p2_LocationsType" = None):
        self.name = name
    ...
    def metadataRepositoryManager(self) :
        # TODO: Implement metadataRepositoryManager method
        pass

    def artifactRepositoryManager(self) :
