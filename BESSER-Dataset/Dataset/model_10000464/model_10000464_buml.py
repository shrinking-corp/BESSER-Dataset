...
Order.attributes={Order_Total, Order_UserID, Order_OrderID, Order_DicountLvl, Order_Date}
...
Membership_Card.attributes={Membership_Card_DiscountLVL, Membership_Card_ID}
...
OrderItem.attributes={OrderItem_OrderID, OrderItem_Completed, OrderItem_ItemName, OrderItem_RemaningTime, OrderItem_OrderItemID}
...
Menu.attributes={Menu_Price, Menu_Availability, Menu_MenuItem, Menu_Category}
...
Bookings.attributes={Bookings_People, Bookings_TableNo, Bookings_BookingID, Bookings_CustomerName, Bookings_Phone, Bookings_Time, Bookings_Date}
...
Users.attributes={Users_UserID, Users_UserLevel, Users_UserName}
...
domain_model = DomainModel(
    name="_399762a0_c1fc_44f5_a26e_c8546b9ce423",
    types={Table, Order, Membership_Card, ViewOrder, OrderItem, Menu, Bookings, BookedTables, Users},
    associations={Membership_Card_Order, Order_Table, Table_Bookings, Order_Menu, ViewOrder_OrderItem, OrderItem_Order, Order_Users, BookedTables_Table},
    generalizations={},
    metadata=None
)
