...
class BookedTables:
    ...
    def __init__(self, TableNo: int, BookingID: int, table14: "Table" = None, bookings4: "Bookings" = None):
...
class Order:
    ...
    def __init__(self, OrderID: int, Date: date, UserID: int, Total: float, DicountLvl: int, users12: "Users" = None, membership_Card1: "Membership_Card" = None, table2: "Table" = None, orderItem11: set["OrderItem"] = None):
        self.OrderID = OrderID
        self.Date = Date
        self.UserID = UserID
        self.Total = Total
...
class Table:
    ...
    def __init__(self, TableNo: int, Occupied: int, bookedTables15: set["BookedTables"] = None, order3: set["Order"] = None):
        self.TableNo = TableNo
