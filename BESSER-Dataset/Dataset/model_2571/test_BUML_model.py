...
# Classes
testpackage_User = Class(name="testpackage_User")
NamedElement = Class(name="NamedElement")
testpackage_Group = Class(name="testpackage_Group")
testpackage_NamedElement = Class(name="testpackage_NamedElement", is_abstract=True)
...
testpackage_Group_m_isMember: Method = Method(name="isMember", parameters={Parameter(name='testpackage_user', type=StringType)}, type=BooleanType)
