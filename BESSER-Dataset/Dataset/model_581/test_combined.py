...
def test_hyp_assistantmvc_style_is_not_abstract():
    assert not inspect.isabstract(AssistantMVC_Style)


def test_hyp_assistantmvc_style_constructor_exists():
    assert callable(AssistantMVC_Style.__init__)


def test_hyp_assistantmvc_style_constructor_args():
    sig = inspect.signature(AssistantMVC_Style.__init__)
    params = list(sig.parameters.keys())
...
AssistantMVC_Style_strategy = st.builds(
    AssistantMVC_Style,
    type=
        safe_text,
    age=
...
@given(instance=AssistantMVC_Style_strategy)
def test_hyp_assistantmvc_style_type_setter(instance):
...
@given(instance=AssistantMVC_Style_strategy)
def test_hyp_assistantmvc_style_age_setter(instance):
...
def test_AssistantMVC_Style_age_value_roundtrip():
    instance = AssistantMVC_Style(age=7, type="sample_text")
    assert instance.age == 7
    instance.age = 13
    assert instance.age == 13


def test_AssistantMVC_Style_type_value_roundtrip():
    instance = AssistantMVC_Style(age=7, type="sample_text")
...
def test_assoc_style9_link_reassign_clear():
    a = AssistantMVC_View(fontColor="sample_text", fontName="sample_text")
    b1 = AssistantMVC_Style(age=7, type="sample_text")
    b2 = AssistantMVC_Style(age=13, type="sample_text_2")
    _safe_set(a, 'AssistantMVC_View10', {b1})
    assert _is_linked(a, 'AssistantMVC_View10', b1)
    if hasattr(b1, 'AssistantMVC_Style'):
        assert _is_linked(b1, 'AssistantMVC_Style', a)
    _safe_set(a, 'AssistantMVC_View10', {b2})
    assert _is_linked(a, 'AssistantMVC_View10', b2)
    if hasattr(b1, 'AssistantMVC_Style'):
        assert not _is_linked(b1, 'AssistantMVC_Style', a)
    if hasattr(b2, 'AssistantMVC_Style'):
        assert _is_linked(b2, 'AssistantMVC_Style', a)
    _safe_set(a, 'AssistantMVC_View10', set())
    assert not _is_linked(a, 'AssistantMVC_View10', b2)
    if hasattr(b2, 'AssistantMVC_Style'):
        assert not _is_linked(b2, 'AssistantMVC_Style', a)
...
AssistantMVC_Style_strategy = st.builds(AssistantMVC_Style, age=st.integers(), type=safe_text)
@given(instance=AssistantMVC_Style_strategy)
@settings(max_examples=25)
def test_AssistantMVC_Style_instantiation(instance):
    assert isinstance(instance, AssistantMVC_Style)
