...
# Classes
xpdl_DataTypeType = Class(name="xpdl_DataTypeType")
xpdl_DeclaredTypeType = Class(name="xpdl_DeclaredTypeType")
xpdl_SchemaTypeType = Class(name="xpdl_SchemaTypeType")
xpdl_ExternalReferenceType = Class(name="xpdl_ExternalReferenceType")
xpdl_BasicTypeType = Class(name="xpdl_BasicTypeType")
XpdlTypeType = Class(name="XpdlTypeType")
ExtendedAnnotationType = Class(name="ExtendedAnnotationType")
xpdl_ExtendedAttributesType = Class(name="xpdl_ExtendedAttributesType")
xpdl_ExtendedAttributeType = Class(name="xpdl_ExtendedAttributeType")
Extensible = Class(name="Extensible")
xpdl_Extensible = Class(name="xpdl_Extensible", is_abstract=True)
xpdl_ExternalPackages = Class(name="xpdl_ExternalPackages")
xpdl_ExternalPackage = Class(name="xpdl_ExternalPackage")
xpdl_XSDSchema = Class(name="xpdl_XSDSchema")
xpdl_ScriptType = Class(name="xpdl_ScriptType")
xpdl_FormalParametersType = Class(name="xpdl_FormalParametersType")
xpdl_FormalParameterType = Class(name="xpdl_FormalParameterType")
xpdl_TypeDeclarationsType = Class(name="xpdl_TypeDeclarationsType")
xpdl_TypeDeclarationType = Class(name="xpdl_TypeDeclarationType")
xpdl_extensions_ExtendedAnnotationType = Class(name="xpdl_extensions_ExtendedAnnotationType")
XSDAnnotation = Class(name="XSDAnnotation")
xpdl_XpdlTypeType = Class(name="xpdl_XpdlTypeType", is_abstract=True)
...
xpdl_ExternalReferenceType.attributes={xpdl_ExternalReferenceType_xref, xpdl_ExternalReferenceType_namespace, xpdl_ExternalReferenceType_location}
...
xpdl_ExtendedAttributeType.attributes={xpdl_ExtendedAttributeType_mixed, xpdl_ExtendedAttributeType_name, xpdl_ExtendedAttributeType_any, xpdl_ExtendedAttributeType_group, xpdl_ExtendedAttributeType_value}
...
xpdl_ExternalPackages_m_getExternalPackage: Method = Method(name="getExternalPackage", parameters={Parameter(name='xpdl_packageId', type=StringType)}, type=StringType)
...
xpdl_ExternalPackage.attributes={xpdl_ExternalPackage_id, xpdl_ExternalPackage_name, xpdl_ExternalPackage_href}
...
xpdl_ScriptType.attributes={xpdl_ScriptType_grammar, xpdl_ScriptType_type, xpdl_ScriptType_version}

# xpdl_FormalParametersType class attributes and methods
xpdl_FormalParametersType_m_addFormalParameter: Method = Method(name="addFormalParameter", parameters={Parameter(name='xpdl_parameter', type=StringType)})
xpdl_FormalParametersType_m_getFormalParameter: Method = Method(name="getFormalParameter", parameters={Parameter(name='xpdl_parameterId', type=StringType)}, type=StringType)
...
xpdl_FormalParameterType.attributes={xpdl_FormalParameterType_description, xpdl_FormalParameterType_id, xpdl_FormalParameterType_mode, xpdl_FormalParameterType_name}

# xpdl_TypeDeclarationsType class attributes and methods
xpdl_TypeDeclarationsType_m_getTypeDeclaration: Method = Method(name="getTypeDeclaration", parameters={Parameter(name='xpdl_typeId', type=StringType)}, type=StringType)
...
xpdl_TypeDeclarationType.attributes={xpdl_TypeDeclarationType_id, xpdl_TypeDeclarationType_description, xpdl_TypeDeclarationType_name}
xpdl_TypeDeclarationType.methods={xpdl_TypeDeclarationType_m_getDataType, xpdl_TypeDeclarationType_m_getSchema}
...
domain_model = DomainModel(
    name="xpdl",
    types={xpdl_DataTypeType, xpdl_DeclaredTypeType, xpdl_SchemaTypeType, xpdl_ExternalReferenceType, xpdl_BasicTypeType, XpdlTypeType, ExtendedAnnotationType, xpdl_ExtendedAttributesType, xpdl_ExtendedAttributeType, Extensible, xpdl_Extensible, xpdl_ExternalPackages, xpdl_ExternalPackage, xpdl_XSDSchema, xpdl_ScriptType, xpdl_FormalParametersType, xpdl_FormalParameterType, xpdl_TypeDeclarationsType, xpdl_TypeDeclarationType, xpdl_extensions_ExtendedAnnotationType, XSDAnnotation, xpdl_XpdlTypeType, ModeType, TypeType},
    associations={basicType0, declaredType1, schemaType3, externalReference5, extendedAnnotation8, extendedAttribute7, externalPackage12, extendedAttributes10, dataType14, schema17, formalParameter13, basicType20, declaredType23, schemaType26, externalReference29, typeDeclaration19},
    generalizations={gen_xpdl_BasicTypeType_XpdlTypeType, gen_xpdl_DeclaredTypeType_XpdlTypeType, gen_xpdl_ExternalPackage_Extensible, gen_xpdl_ExternalReferenceType_XpdlTypeType, gen_xpdl_SchemaTypeType_XpdlTypeType, gen_xpdl_TypeDeclarationType_Extensible, gen_xpdl_extensions_ExtendedAnnotationType_XSDAnnotation},
    metadata=None
)
