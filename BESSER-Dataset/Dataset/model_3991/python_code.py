...
class xpdl_TypeDeclarationsType:
    ...
    def getTypeDeclaration(self, xpdl_typeId) :
...
class xpdl_FormalParametersType:
    ...
    def addFormalParameter(self, xpdl_parameter):
        # TODO: Implement addFormalParameter method
        pass

    def getFormalParameter(self, xpdl_parameterId) :
...
class xpdl_ExternalPackages:
    ...
    def getExternalPackage(self, xpdl_packageId) :
...
class xpdl_TypeDeclarationType(Extensible):
    ...
    def __init__(self, description: str, id: str, name: str, xpdl_TypeDeclarationType21: "xpdl_BasicTypeType" = None, xpdl_TypeDeclarationType24: "xpdl_DeclaredTypeType" = None, xpdl_TypeDeclarationType27: "xpdl_SchemaTypeType" = None, xpdl_TypeDeclarationType30: "xpdl_ExternalReferenceType" = None, xpdl_TypeDeclarationType: "xpdl_TypeDeclarationsType" = None):
        self.description = description
        self.id = id
        self.name = name
...
class xpdl_DataTypeType:
    ...
    def __init__(self, carnotType: str, xpdl_DataTypeType: "xpdl_BasicTypeType" = None, xpdl_DataTypeType2: "xpdl_DeclaredTypeType" = None, xpdl_DataTypeType4: "xpdl_SchemaTypeType" = None, xpdl_DataTypeType6: "xpdl_ExternalReferenceType" = None, xpdl_DataTypeType16: "xpdl_FormalParameterType" = None):
