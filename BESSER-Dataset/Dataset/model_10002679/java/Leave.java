...
public class Leave  {
    ...
    public Leave(
        LocalDate Leave_ApplyDate,        String Leave_Title,        int Emp_Id,        LocalDate Leave_StartDate,        int Leave_NoOfDays,        String Leave_Status,        String Leave_detail,        LocalDate Leave_EndDate,        int leave_id    ) {
