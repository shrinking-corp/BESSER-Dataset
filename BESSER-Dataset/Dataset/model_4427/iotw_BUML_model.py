...
# Classes
iotw_StateSchema = Class(name="iotw_StateSchema")
iotw_StateComponent = Class(name="iotw_StateComponent", is_abstract=True)
iotw_Component = Class(name="iotw_Component", is_abstract=True)
iotw_Connection = Class(name="iotw_Connection")
iotw_Mainboard = Class(name="iotw_Mainboard", is_abstract=True)
iotw_IODevice = Class(name="iotw_IODevice", is_abstract=True)
Device = Class(name="Device")
Component = Class(name="Component")
iotw_Device = Class(name="iotw_Device", is_abstract=True)
iotw_ArduinoWiFiESP8266WeMosD1 = Class(name="iotw_ArduinoWiFiESP8266WeMosD1")
Mainboard = Class(name="Mainboard")
iotw_InputDevice = Class(name="iotw_InputDevice", is_abstract=True)
IODevice = Class(name="IODevice")
iotw_OutputDevice = Class(name="iotw_OutputDevice", is_abstract=True)
iotw_Connectivity = Class(name="iotw_Connectivity", is_abstract=True)
iotw_ArduinoUNOR3 = Class(name="iotw_ArduinoUNOR3")
iotw_Keypad4x4 = Class(name="iotw_Keypad4x4")
InputDevice = Class(name="InputDevice")
iotw_CDS = Class(name="iotw_CDS")
iotw_LED = Class(name="iotw_LED")
iotw_Button = Class(name="iotw_Button")
iotw_LM35 = Class(name="iotw_LM35")
iotw_DHT11 = Class(name="iotw_DHT11")
iotw_BluetoothHC06 = Class(name="iotw_BluetoothHC06")
Connectivity = Class(name="Connectivity")
iotw_WifiESP8266 = Class(name="iotw_WifiESP8266")
OutputDevice = Class(name="OutputDevice")
iotw_I2CLCD = Class(name="iotw_I2CLCD")
iotw_Buzzer = Class(name="iotw_Buzzer")
iotw_StateFrame = Class(name="iotw_StateFrame")
StateComponent = Class(name="StateComponent")
iotw_Decision = Class(name="iotw_Decision")
iotw_StartPoint = Class(name="iotw_StartPoint")
iotw_EndPoint = Class(name="iotw_EndPoint")
...
iotw_Mainboard_m_addDevice: Method = Method(name="addDevice", parameters={Parameter(name='iotw_device', type=StringType)})
iotw_Mainboard_m_removeDevice: Method = Method(name="removeDevice", parameters={Parameter(name='iotw_device', type=StringType)})
...
iotw_Mainboard_m_modifyPin: Method = Method(name="modifyPin", parameters={Parameter(name='iotw_pin', type=StringType)})
iotw_Mainboard_m_findPin: Method = Method(name="findPin", parameters={Parameter(name='iotw_pin', type=StringType)}, type=StringType)
iotw_Mainboard.attributes={iotw_Mainboard_name}
iotw_Mainboard.methods={iotw_Mainboard_m_removeDevice, iotw_Mainboard_m_addDevice, iotw_Mainboard_m_findPin, iotw_Mainboard_m_getPinConnecteds, iotw_Mainboard_m_modifyPin, iotw_Mainboard_m_getPins}
...
iotw_Device_m_modifyPin: Method = Method(name="modifyPin", parameters={Parameter(name='iotw_pin', type=StringType)})
...
iotw_Device.methods={iotw_Device_m_getPins, iotw_Device_m_getPinConnecteds, iotw_Device_m_modifyPin}
...
iotw_ArduinoWiFiESP8266WeMosD1.attributes={iotw_ArduinoWiFiESP8266WeMosD1_pinD2, iotw_ArduinoWiFiESP8266WeMosD1_gateway, iotw_ArduinoWiFiESP8266WeMosD1_ssid, iotw_ArduinoWiFiESP8266WeMosD1_pinD0, iotw_ArduinoWiFiESP8266WeMosD1_pinD8, iotw_ArduinoWiFiESP8266WeMosD1_subnet, iotw_ArduinoWiFiESP8266WeMosD1_dns, iotw_ArduinoWiFiESP8266WeMosD1_pinD6, iotw_ArduinoWiFiESP8266WeMosD1_password, iotw_ArduinoWiFiESP8266WeMosD1_pinD7, iotw_ArduinoWiFiESP8266WeMosD1_pinD1, iotw_ArduinoWiFiESP8266WeMosD1_pinSDA, iotw_ArduinoWiFiESP8266WeMosD1_pinA0, iotw_ArduinoWiFiESP8266WeMosD1_wifiMode, iotw_ArduinoWiFiESP8266WeMosD1_baud, iotw_ArduinoWiFiESP8266WeMosD1_pinD3, iotw_ArduinoWiFiESP8266WeMosD1_pinSCL, iotw_ArduinoWiFiESP8266WeMosD1_pinD4, iotw_ArduinoWiFiESP8266WeMosD1_ip, iotw_ArduinoWiFiESP8266WeMosD1_pinD5}
...
iotw_ArduinoUNOR3.attributes={iotw_ArduinoUNOR3_pin10, iotw_ArduinoUNOR3_pinA5, iotw_ArduinoUNOR3_pinA1, iotw_ArduinoUNOR3_pinA2, iotw_ArduinoUNOR3_pin3, iotw_ArduinoUNOR3_pin5, iotw_ArduinoUNOR3_pin0, iotw_ArduinoUNOR3_pin8, iotw_ArduinoUNOR3_pinA4, iotw_ArduinoUNOR3_pin13, iotw_ArduinoUNOR3_pinA3, iotw_ArduinoUNOR3_pin11, iotw_ArduinoUNOR3_pin7, iotw_ArduinoUNOR3_pin1, iotw_ArduinoUNOR3_pin2, iotw_ArduinoUNOR3_pin9, iotw_ArduinoUNOR3_pin12, iotw_ArduinoUNOR3_pin4, iotw_ArduinoUNOR3_pin6, iotw_ArduinoUNOR3_pinA0}
...
iotw_Keypad4x4_m_getButton: Method = Method(name="getButton", parameters={Parameter(name='iotw_name', type=StringType)}, type=StringType)
iotw_Keypad4x4.attributes={iotw_Keypad4x4_nameButtonHash, iotw_Keypad4x4_pin5, iotw_Keypad4x4_pin3, iotw_Keypad4x4_nameButton7, iotw_Keypad4x4_nameButton8, iotw_Keypad4x4_pin8, iotw_Keypad4x4_nameButtonB, iotw_Keypad4x4_pin1, iotw_Keypad4x4_keys, iotw_Keypad4x4_nameButtonA, iotw_Keypad4x4_pin2, iotw_Keypad4x4_pin7, iotw_Keypad4x4_nameButton4, iotw_Keypad4x4_nameButtonAsterisk, iotw_Keypad4x4_pin6, iotw_Keypad4x4_nameButton6, iotw_Keypad4x4_nameButtonC, iotw_Keypad4x4_nameButton0, iotw_Keypad4x4_nameButton9, iotw_Keypad4x4_pin4, iotw_Keypad4x4_nameButtonD, iotw_Keypad4x4_nameButton5, iotw_Keypad4x4_cols, iotw_Keypad4x4_rows, iotw_Keypad4x4_nameButton3, iotw_Keypad4x4_nameButton1, iotw_Keypad4x4_nameButton2}
...
iotw_CDS.attributes={iotw_CDS_pinGND, iotw_CDS_pinD0, iotw_CDS_pinVcc}
...
iotw_DHT11.attributes={iotw_DHT11_pinData, iotw_DHT11_pinVcc, iotw_DHT11_pinGND}
...
iotw_BluetoothHC06.attributes={iotw_BluetoothHC06_pinGND, iotw_BluetoothHC06_pinRXD, iotw_BluetoothHC06_pinVCC, iotw_BluetoothHC06_pinTXD}
...
iotw_WifiESP8266.attributes={iotw_WifiESP8266_protocol, iotw_WifiESP8266_pinTX, iotw_WifiESP8266_iP, iotw_WifiESP8266_idConnection, iotw_WifiESP8266_pinVcc, iotw_WifiESP8266_connectedChannel, iotw_WifiESP8266_baud, iotw_WifiESP8266_sSID_ST, iotw_WifiESP8266_password_ST, iotw_WifiESP8266_password_AccessPoint, iotw_WifiESP8266_sSID_AccessPoint, iotw_WifiESP8266_pinRX, iotw_WifiESP8266_port, iotw_WifiESP8266_pinGND, iotw_WifiESP8266_pinCHPD, iotw_WifiESP8266_mode}
...
iotw_I2CLCD.attributes={iotw_I2CLCD_pinGND, iotw_I2CLCD_pinSDA, iotw_I2CLCD_pinVcc, iotw_I2CLCD_type, iotw_I2CLCD_pinSCL}
...
iotw_Buzzer.attributes={iotw_Buzzer_pin2, iotw_Buzzer_Tone, iotw_Buzzer_pin1, iotw_Buzzer_Time}
...
domain_model = DomainModel(
    name="iotw",
    types={iotw_StateSchema, iotw_StateComponent, iotw_Component, iotw_Connection, iotw_Mainboard, iotw_IODevice, Device, Component, iotw_Device, iotw_ArduinoWiFiESP8266WeMosD1, Mainboard, iotw_InputDevice, IODevice, iotw_OutputDevice, iotw_Connectivity, iotw_ArduinoUNOR3, iotw_Keypad4x4, InputDevice, iotw_CDS, iotw_LED, iotw_Button, iotw_LM35, iotw_DHT11, iotw_BluetoothHC06, Connectivity, iotw_WifiESP8266, OutputDevice, iotw_I2CLCD, iotw_Buzzer, iotw_StateFrame, StateComponent, iotw_Decision, iotw_StartPoint, iotw_EndPoint, ListBaud, ConnectionKind, RouterKind, WifiMode, WifiIDConnection, ListConnectionChannel, ListProtocol, I2CLCDType, ESP8266WiFiMode},
    associations={stateSchema4, components5, source0, target1, mainboard13, connnections6, incomings7, outgoings10, devices14},
    generalizations={gen_iotw_IODevice_Device, gen_iotw_StateComponent_Component, gen_iotw_Device_Component, gen_iotw_ArduinoWiFiESP8266WeMosD1_Mainboard, gen_iotw_InputDevice_IODevice, gen_iotw_OutputDevice_IODevice, gen_iotw_Connectivity_Device, gen_iotw_ArduinoUNOR3_Mainboard, gen_iotw_Keypad4x4_InputDevice, gen_iotw_CDS_InputDevice, gen_iotw_Button_InputDevice, gen_iotw_LM35_InputDevice, gen_iotw_DHT11_InputDevice, gen_iotw_BluetoothHC06_Connectivity, gen_iotw_WifiESP8266_Connectivity, gen_iotw_LED_OutputDevice, gen_iotw_I2CLCD_OutputDevice, gen_iotw_Buzzer_OutputDevice, gen_iotw_StateFrame_StateComponent, gen_iotw_Decision_StateComponent, gen_iotw_StartPoint_StateComponent, gen_iotw_EndPoint_StateComponent},
    metadata=None
)
