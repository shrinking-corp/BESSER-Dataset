...
def test_assoc_generalizations1_link_reassign_clear():
    ...
    _safe_set(a, 'simpleUML_UMLClass2', {b1})
    assert _is_linked(a, 'simpleUML_UMLClass2', b1)
    if hasattr(b1, 'simpleUML_Generalization'):
        assert _is_linked(b1, 'simpleUML_Generalization', a)
    _safe_set(a, 'simpleUML_UMLClass2', {b2})
    assert _is_linked(a, 'simpleUML_UMLClass2', b2)
    if hasattr(b1, 'simpleUML_Generalization'):
    ...
    _safe_set(a, 'simpleUML_UMLClass2', set())
    assert not _is_linked(a, 'simpleUML_UMLClass2', b2)
    if hasattr(b2, 'simpleUML_Generalization'):
...
def test_assoc_reference3_link_reassign_clear():
    ...
    if hasattr(b1, 'simpleUML_Generalization4'):
        assert _is_linked(b1, 'simpleUML_Generalization4', a)
    _safe_set(a, 'simpleUML_UMLClass5', b2)
    assert _is_linked(a, 'simpleUML_UMLClass5', b2)
    if hasattr(b1, 'simpleUML_Generalization4'):
        assert not _is_linked(b1, 'simpleUML_Generalization4', a)
    if hasattr(b2, 'simpleUML_Generalization4'):
        assert _is_linked(b2, 'simpleUML_Generalization4', a)
    _safe_set(a, 'simpleUML_UMLClass5', None)
    assert not _is_linked(a, 'simpleUML_UMLClass5', b2)
    if hasattr(b2, 'simpleUML_Generalization4'):
        assert not _is_linked(b2, 'simpleUML_Generalization4', a)
