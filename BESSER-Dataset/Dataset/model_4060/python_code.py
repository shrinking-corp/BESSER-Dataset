...
class myumlclassdiagram_Method(NamedElement):
    ...
    def __init__(self, Returns: str, Visibility: str, Method: "myumlclassdiagram_Class" = None, Owner6: set["myumlclassdiagram_Parameter"] = None, Method10: "myumlclassdiagram_Parameter" = None, Methods: "myumlclassdiagram_Class" = None):
