...
# Classes
myumlclassdiagram_Class = Class(name="myumlclassdiagram_Class")
myumlclassdiagram_Attribute = Class(name="myumlclassdiagram_Attribute")
myumlclassdiagram_Method = Class(name="myumlclassdiagram_Method")
myumlclassdiagram_NamedElement = Class(name="myumlclassdiagram_NamedElement", is_abstract=True)
myumlclassdiagram_Parameter = Class(name="myumlclassdiagram_Parameter")
myumlclassdiagram_Package = Class(name="myumlclassdiagram_Package")
...
domain_model = DomainModel(
    ...
    types={myumlclassdiagram_Class, myumlclassdiagram_Attribute, myumlclassdiagram_Method, myumlclassdiagram_NamedElement, myumlclassdiagram_Parameter, myumlclassdiagram_Package, NamedElement, EType, EVisibility, EReturnType},
    associations={Classes0, Attributes1, Methods2, Owner4, Parameters5, Owner9, Owner7},
    generalizations={gen_myumlclassdiagram_Class_NamedElement, gen_myumlclassdiagram_Attribute_NamedElement, gen_myumlclassdiagram_Method_NamedElement, gen_myumlclassdiagram_Package_NamedElement, gen_myumlclassdiagram_Parameter_NamedElement},
    metadata=None
)
