...
public class Leave  {
    ...
    public Leave(
        int Leave_NoOfDays,        int leave_id,        String Leave_detail,        String Leave_Status,        LocalDate Leave_ApplyDate,        int Emp_Id,        String Leave_Title,        LocalDate Leave_StartDate,        LocalDate Leave_EndDate    ) {
