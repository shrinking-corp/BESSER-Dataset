...
# Classes
geneology_Geneology = Class(name="geneology_Geneology")
geneology_Family = Class(name="geneology_Family")
geneology_Member = Class(name="geneology_Member")
...
geneology_Member.attributes={geneology_Member_female, geneology_Member_name}
...
domain_model = DomainModel(
    ...
    associations={families0, geneology1, members2, family3},
    generalizations={},
    metadata=None
)
