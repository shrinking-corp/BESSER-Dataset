...
class Company_Category:
    ...
    def __init__(self, name: str, Category: "Company_Topic" = None, Company_Category20: "Company_CompanyModel" = None, Company_Category: "Company_Project" = None, category: set["Company_Topic"] = None):
        self.name = name
