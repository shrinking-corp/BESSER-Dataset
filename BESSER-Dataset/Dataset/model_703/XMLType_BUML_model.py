...
type_XMLTypeDocumentRoot.attributes={type_XMLTypeDocumentRoot_mixed, type_XMLTypeDocumentRoot_text, type_XMLTypeDocumentRoot_comment, type_XMLTypeDocumentRoot_cDATA}
...
domain_model = DomainModel(
    name="type",
    types={type_AnyType, type_EDataType, type_ProcessingInstruction, type_SimpleAnyType, AnyType, type_XMLTypeDocumentRoot, type_EStringToStringMapEntry},
    associations={instanceType0, processingInstruction5, xMLNSPrefixMap1, xSISchemaLocation2},
