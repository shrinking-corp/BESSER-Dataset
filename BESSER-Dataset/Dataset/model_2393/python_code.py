...
class sQL_Table:
    ...
    def __init__(self, name: str, sQL_Table: "sQL_DataBase" = None, sQL_Table2: set["sQL_Column"] = None, sQL_Table4: "sQL_PrimaryKey" = None, sQL_Table6: set["sQL_ForeignKey"] = None, sQL_Table15: "sQL_ForeignKey" = None):
        self.name = name
