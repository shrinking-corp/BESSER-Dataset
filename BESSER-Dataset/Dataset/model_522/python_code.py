...
class Families_Member:
    ...
    def __init__(self, firstName: str, Families_Member3: "Families_Family" = None, Families_Member: "Families_Family" = None, Families_Member6: "Families_Family" = None, Families_Member9: "Families_Family" = None):
