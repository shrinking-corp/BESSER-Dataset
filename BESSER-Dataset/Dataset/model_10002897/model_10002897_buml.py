...
Card.attributes={Card_SPADES_SUIT, Card_faceUp, Card_JACK, Card_NINE, Card_cardBack, Card_location, Card_FOUR, Card_cardSuit, Card_QUEEN, Card_CLUBS_SUIT, Card_INVALID_NUMBER, Card_deckNumber, Card_DIAMONDS_SUIT, Card_TEN, Card_ACE, Card_fullCardNumber, Card_FIVE, Card_HEARTS_SUIT, Card_cardColor, Card_SEVEN, Card_THREE, Card_cardNumber, Card_KING, Card_INVALID_SUIT, Card_cardHighlighted, Card_image, Card_cardImageString, Card_highlighted, Card_EIGHT, Card_SIX, Card_TWO}
...
ChangeAppearance.attributes={ChangeAppearance_backgroundLabel, ChangeAppearance_backgrounds, ChangeAppearance_backgroundNumber, ChangeAppearance_FRS_BACKGROUND, ChangeAppearance_decks, ChangeAppearance_FRS_DECK, ChangeAppearance_exited, ChangeAppearance_ok, ChangeAppearance_cardBackLabel, ChangeAppearance_NUM_BACKGROUNDS, ChangeAppearance_deckNumber, ChangeAppearance_NUM_DECKS}
...
ChangeOptions.attributes={ChangeOptions_hard, ChangeOptions_timerCheck, ChangeOptions_ok, ChangeOptions_exited, ChangeOptions_drawCount, ChangeOptions_difficulty, ChangeOptions_medium, ChangeOptions_easy, ChangeOptions_animation, ChangeOptions_sounds, ChangeOptions_winSoundsCheck, ChangeOptions_winAnimationCheck, ChangeOptions_drawOne, ChangeOptions_drawThree, ChangeOptions_timer}
...
DealDeck.attributes={DealDeck_redealable, DealDeck_MEDIUM_THROUGH_LIMIT, DealDeck_EASY_THROUGH_LIMIT, DealDeck_numTimesThroughDeck, DealDeck_drawCount, DealDeck_DRAW_THREE_THROUGH_LIMIT, DealDeck_difficulty, DealDeck_HARD_THROUGH_LIMIT, DealDeck_deckThroughLimit, DealDeck_DRAW_ONE_THROUGH_LIMIT}
...
FireworksDisplay.attributes={FireworksDisplay_SET_DELAY, FireworksDisplay_y, FireworksDisplay_random, FireworksDisplay_FIREWORKS_TIME, FireworksDisplay_colors, FireworksDisplay_yy, FireworksDisplay_NUM_FIREWORKS, FireworksDisplay_timer, FireworksDisplay_xx, FireworksDisplay_num, FireworksDisplay_x, FireworksDisplay_startValue, FireworksDisplay_numSets, FireworksDisplay_FIREWORKS_SIZE}
...
FourRowSolitaire.attributes={FourRowSolitaire_newGame, FourRowSolitaire_helpMenu, FourRowSolitaire_options, FourRowSolitaire_version, FourRowSolitaire_game, FourRowSolitaire_menuBar, FourRowSolitaire_appearance, FourRowSolitaire_exit, FourRowSolitaire_about, FourRowSolitaire_checkUpdate, FourRowSolitaire_help, FourRowSolitaire_hint, FourRowSolitaire_undo, FourRowSolitaire_statistics}
...
SolitaireBoard.attributes={SolitaireBoard_RESET_STATS, SolitaireBoard_GAME_LOST, SolitaireBoard_timerToRun, SolitaireBoard_GAME_WON, SolitaireBoard_difficulty, SolitaireBoard_winSoundsStatus, SolitaireBoard_winAnimationStatus, SolitaireBoard_timerCount, SolitaireBoard_statusBar, SolitaireBoard_newDifficulty, SolitaireBoard_deckNumber, SolitaireBoard_newDrawCount, SolitaireBoard_numCardsInDiscardView, SolitaireBoard_backgroundNumber, SolitaireBoard_timer, SolitaireBoard_GAME_SAVED, SolitaireBoard_timerToRunNextGame, SolitaireBoard_drawCount, SolitaireBoard_timerLabel, SolitaireBoard_numCards, SolitaireBoard_DO_NOTHING}
...
SolitaireLayout.attributes={SolitaireLayout_COLUMN_FOUR, SolitaireLayout_aceSpades, SolitaireLayout_discardPile, SolitaireLayout_COLUMN_THREE, SolitaireLayout_colThree, SolitaireLayout_COLUMN_TWO, SolitaireLayout_CELL_TWO, SolitaireLayout_cellFour, SolitaireLayout_CELL_FOUR, SolitaireLayout_aceHearts, SolitaireLayout_aceClubs, SolitaireLayout_deck, SolitaireLayout_COLUMEN_ONE, SolitaireLayout_DISCARD_PILE, SolitaireLayout_DIAMONDS_ACE_PILE, SolitaireLayout_CELL_ONE, SolitaireLayout_DECK, SolitaireLayout_cellTwo, SolitaireLayout_HEARTS_ACE_PILE, SolitaireLayout_colFour, SolitaireLayout_SPADES_ACE_PILE, SolitaireLayout_aceDiamonds, SolitaireLayout_CLUBS_ACE_PILE, SolitaireLayout_colTwo, SolitaireLayout_colOne, SolitaireLayout_cellOne, SolitaireLayout_CELL_THREE, SolitaireLayout_cellThree}
...
SolitairePanel.attributes={SolitairePanel_background, SolitairePanel_backgroundNumber}
...
domain_model = DomainModel(
    name="e761a736_ea61_4d94_a0cb_48097a85aa94",
