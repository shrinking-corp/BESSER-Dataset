...
# Classes
myMath_Div = Class(name="myMath_Div")
myMath_MathExp = Class(name="myMath_MathExp")
myMath_Expression = Class(name="myMath_Expression")
myMath_Add = Class(name="myMath_Add")
Expression = Class(name="Expression")
myMath_Sub = Class(name="myMath_Sub")
myMath_Mult = Class(name="myMath_Mult")
myMath_Num = Class(name="myMath_Num")
...
domain_model = DomainModel(
    name="myMath",
    types={myMath_Div, myMath_MathExp, myMath_Expression, myMath_Add, Expression, myMath_Sub, myMath_Mult, myMath_Num},
    associations={right13, left16, exp0, left1, right3, left6, right8, left11, right18},
    generalizations={gen_myMath_Div_Expression, gen_myMath_Add_Expression, gen_myMath_Sub_Expression, gen_myMath_Mult_Expression, gen_myMath_Num_Expression},
    metadata=None
)
