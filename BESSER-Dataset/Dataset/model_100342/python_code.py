...
class automata_Transition:
    ...
    def __init__(self, token: str, name: str, automata_Transition10: "automata_State" = None, automata_Transition13: "automata_State" = None, automata_Transition: "automata_Automata" = None):
        self.token = token
        self.name = name
...
class automata_State:
    ...
    def __init__(self, name: str, automata_State11: "automata_Transition" = None, automata_State14: "automata_Transition" = None, automata_State17: "automata_Initial" = None, automata_State: "automata_Automata" = None, automata_State23: "automata_Current" = None, automata_State20: "automata_Final" = None):
        self.name = name
