...
domain_model = DomainModel(
    name="automata",
    types={automata_Automata, automata_Current, automata_Initial, automata_State, automata_Final, automata_Transition},
    associations={current0, initial1, finals7, source9, target12, state15, states3, transitions5, state21, state18},
    generalizations={},
    metadata=None
)
