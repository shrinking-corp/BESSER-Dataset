...
class aggregator_p2_IRepository(IAdaptable):
    ...
    def setProperty(self, aggregator_key, aggregator_value) :
...
class aggregator_p2_IMetadataRepository(p2_IRepository, p2_IQueryable):
    ...
    def addReference(self, aggregator_options, aggregator_location, aggregator_type, aggregator_nickname):
...
class aggregator_p2_IQueryable(ABC):
    ...
    def __init__(self):
        ...
        pass
    def query(self, aggregator_progress, aggregator_query, aggregator_collector) :
...
class aggregator_p2_InstallableUnit(IInstallableUnit):
    ...
    def __init__(self, aggregator_p2_InstallableUnit: set["ArtifactKey"] = None, aggregator_p2_InstallableUnit54: set["ProvidedCapability"] = None, aggregator_p2_InstallableUnit56: set["RequiredCapability"] = None, aggregator_p2_InstallableUnit64: set["TouchpointData"] = None, aggregator_p2_InstallableUnit58: set["RequiredCapability"] = None, aggregator_p2_InstallableUnit61: set["Property"] = None):
...
class EnabledStatusProvider:
    ...
    pass
class aggregator_MappedUnit(EnabledStatusProvider, InstallableUnitRequest):
    ...
    def getRequiredCapability(self) :
...
class aggregator_Contact:
    ...
    def __init__(self, name: str, email: str, contacts: "aggregator_Aggregator" = None, aggregator_Contact: "aggregator_Aggregator" = None, Contact: "aggregator_Aggregator" = None, aggregator_Contact26: "aggregator_Contribution" = None):
        self.name = name
        self.email = email
...
class aggregator_Configuration(EnabledStatusProvider):
    ...
    def __init__(self, operatingSystem: str, windowSystem: str, architecture: str, aggregator_Configuration33: "aggregator_MappedUnit" = None, aggregator_Configuration36: "aggregator_ValidConfigurationsRule" = None, aggregator_Configuration: "aggregator_Aggregator" = None):
...
class aggregator_MetadataRepositoryReference(EnabledStatusProvider, InfosProvider, StatusProvider):
    ...
    def __init__(self, location: str, nature: str, aggregator_MetadataRepositoryReference38: "MetadataRepository" = None, aggregator_MetadataRepositoryReference: "aggregator_Aggregator" = None):
        self.location = location
        self.nature = nature
...
class aggregator_MapRule(InstallableUnitRequest, DescriptionProvider):
    ...
    pass
class aggregator_Contribution(EnabledStatusProvider, InfosProvider, StatusProvider, DescriptionProvider):

    def __init__(self, label: str, aggregator_Contribution25: set["aggregator_Contact"] = None, aggregator_Contribution28: set["aggregator_MavenMapping"] = None, aggregator_Contribution: "aggregator_Aggregator" = None, aggregator_Contribution22: set["aggregator_MappedRepository"] = None):
        self.label = label
...
class aggregator_p2view_MetadataRepositoryStructuredView:
    ...
    def __init__(self, loaded: bool, name: str, aggregator_p2view_MetadataRepositoryStructuredView71: "Properties" = None, aggregator_p2view_MetadataRepositoryStructuredView73: "MetadataRepository" = None, aggregator_p2view_MetadataRepositoryStructuredView: "InstallableUnits" = None):
        self.loaded = loaded
        self.name = name
