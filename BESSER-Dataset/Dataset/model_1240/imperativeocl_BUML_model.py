...
imperativeocl_Variable = Class(name="imperativeocl_Variable")
...
imperativeocl_OclExpression = Class(name="imperativeocl_OclExpression")
...
imperativeocl_Class = Class(name="imperativeocl_Class")
...
imperativeocl_Type = Class(name="imperativeocl_Type")
...
domain_model = DomainModel(
    name="imperativeocl",
    types={imperativeocl_VariableInitExp, imperativeocl_Variable, imperativeocl_WhileExp, imperativeocl_ComputeExp, imperativeocl_AssignExp, ImperativeExpression, imperativeocl_OclExpression, imperativeocl_BlockExp, imperativeocl_SwitchExp, CallExp, imperativeocl_AltExp, imperativeocl_ContinueExp, imperativeocl_ForExp, ImperativeLoopExp, imperativeocl_Typedef, Class_, imperativeocl_InstantiationExp, imperativeocl_Class, imperativeocl_DictionaryType, CollectionType, imperativeocl_UnlinkExp, imperativeocl_ReturnExp, imperativeocl_BreakExp, imperativeocl_TryExp, imperativeocl_CatchExp, imperativeocl_RaiseExp, imperativeocl_Type, imperativeocl_ImperativeLoopExp, LoopExp, imperativeocl_ImperativeIterateExp, imperativeocl_ImperativeExpression, OclExpression, imperativeocl_UnpackExp, imperativeocl_DictLiteralExp, LiteralExp, imperativeocl_DictLiteralPart, Element, imperativeocl_TemplateParameterType, Type, imperativeocl_LogExp, OperationCallExp, imperativeocl_AssertExp, imperativeocl_OrderedTupleType, imperativeocl_OrderedTupleLiteralExp, imperativeocl_OrderedTupleLiteralPart, imperativeocl_ListType, SeverityKind},
    associations={referredVariable13, condition14, body16, returnedElement19, body21, condition24, value0, left1, defaultValue4, body7, alternativePart9, elsePart10, argument42, base45, condition47, instantiatedClass50, extent51, argument54, body27, target30, item32, value35, tryBody37, catchClause39, exception41, assertion70, condition73, target75, targetVariable77, source79, keyType57, part59, key60, value63, condition66, log68, elementType82, part84, value85, body88, exception91},
    generalizations={gen_imperativeocl_VariableInitExp_ImperativeExpression, gen_imperativeocl_WhileExp_ImperativeExpression, gen_imperativeocl_ComputeExp_ImperativeExpression, gen_imperativeocl_AltExp_ImperativeExpression, gen_imperativeocl_AssignExp_ImperativeExpression, gen_imperativeocl_BlockExp_ImperativeExpression, gen_imperativeocl_SwitchExp_CallExp, gen_imperativeocl_SwitchExp_ImperativeExpression, gen_imperativeocl_ContinueExp_ImperativeExpression, gen_imperativeocl_ForExp_ImperativeLoopExp, gen_imperativeocl_Typedef_Class, gen_imperativeocl_InstantiationExp_ImperativeExpression, gen_imperativeocl_DictionaryType_CollectionType, gen_imperativeocl_UnlinkExp_ImperativeExpression, gen_imperativeocl_ReturnExp_ImperativeExpression, gen_imperativeocl_BreakExp_ImperativeExpression, gen_imperativeocl_TryExp_ImperativeExpression, gen_imperativeocl_RaiseExp_ImperativeExpression, gen_imperativeocl_ImperativeLoopExp_LoopExp, gen_imperativeocl_ImperativeLoopExp_ImperativeExpression, gen_imperativeocl_ImperativeIterateExp_ImperativeLoopExp, gen_imperativeocl_ImperativeExpression_OclExpression, gen_imperativeocl_UnpackExp_ImperativeExpression, gen_imperativeocl_DictLiteralExp_LiteralExp, gen_imperativeocl_DictLiteralPart_Element, gen_imperativeocl_TemplateParameterType_Type, gen_imperativeocl_LogExp_OperationCallExp, gen_imperativeocl_LogExp_ImperativeExpression, gen_imperativeocl_AssertExp_ImperativeExpression, gen_imperativeocl_OrderedTupleType_Class, gen_imperativeocl_OrderedTupleLiteralExp_LiteralExp, gen_imperativeocl_OrderedTupleLiteralPart_Element, gen_imperativeocl_ListType_CollectionType, gen_imperativeocl_CatchExp_ImperativeExpression},
    metadata=None
)
