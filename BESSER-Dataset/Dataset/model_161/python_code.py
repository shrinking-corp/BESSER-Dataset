...
class PetriNetModel_Node(PObject):
    ...
    def __init__(self, name: str, source: set["PetriNetModel_Arc"] = None, Node: "PetriNetModel_Arc" = None, Node7: "PetriNetModel_Arc" = None, target: set["PetriNetModel_Arc"] = None):
        self.name = name
