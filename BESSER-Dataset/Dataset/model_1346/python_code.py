...
class essentialOCLCST_PathNameCS(TypeLiteralExpCS, TypeCS):
    ...
    pass
class essentialOCLCST_SimpleNameCS(TypeLiteralExpCS, VariableExpCS, TypeCS, CollectionLiteralExpCS):

    def __init__(self, value: str, essentialOCLCST_SimpleNameCS50: set["essentialOCLCST_CollectionLiteralPartCS"] = None, essentialOCLCST_SimpleNameCS60: "essentialOCLCST_VariableCS" = None, essentialOCLCST_SimpleNameCS48: "essentialOCLCST_PathNameCS" = None, essentialOCLCST_SimpleNameCS: "essentialOCLCST_CollectionTypeCS" = None):
        self.value = value
...
class essentialOCLCST_CollectionTypeCS(TypeCS, TypeLiteralExpCS, CollectionLiteralExpCS):
