...
# Classes
soa_Import = Class(name="soa_Import")
soa_Model = Class(name="soa_Model")
soa_Exceptions = Class(name="soa_Exceptions")
soa_Service = Class(name="soa_Service")
soa_Entities = Class(name="soa_Entities")
soa_Comment = Class(name="soa_Comment")
soa_Enum = Class(name="soa_Enum")
Entities = Class(name="Entities")
soa_Entity = Class(name="soa_Entity")
soa_Feature = Class(name="soa_Feature")
soa_Architecture = Class(name="soa_Architecture")
soa_Module = Class(name="soa_Module")
soa_GenericListFeature = Class(name="soa_GenericListFeature")
soa_Exception = Class(name="soa_Exception")
soa_Operation = Class(name="soa_Operation")
soa_FeatureType = Class(name="soa_FeatureType")
soa_EntitiesFeature = Class(name="soa_EntitiesFeature")
FeatureType = Class(name="FeatureType")
soa_PrimitiveFeature = Class(name="soa_PrimitiveFeature")
...
soa_Module.attributes={soa_Module_name, soa_Module_event, soa_Module_version}
...
soa_Exception.attributes={soa_Exception_msg, soa_Exception_name}
...
domain_model = DomainModel(
    name="soa",
    types={soa_Import, soa_Model, soa_Exceptions, soa_Service, soa_Entities, soa_Comment, soa_Enum, Entities, soa_Entity, soa_Feature, soa_Architecture, soa_Module, soa_GenericListFeature, soa_Exception, soa_Operation, soa_FeatureType, soa_EntitiesFeature, FeatureType, soa_PrimitiveFeature, PrimitiveType},
    associations={module0, imports1, model3, exceptions5, services7, entities9, features11, type18, exceptions20, operations22, featuresInput24, featuresOutput27, featureComment12, type14, type16, exceptionts30},
    generalizations={gen_soa_Enum_Entities, gen_soa_Entity_Entities, gen_soa_GenericListFeature_FeatureType, gen_soa_EntitiesFeature_FeatureType, gen_soa_PrimitiveFeature_FeatureType},
    metadata=None
)
