...
UmlTrace_Class_strategy = st.builds(UmlTrace_Class)
...
UmlTrace_EClass0_strategy = st.builds(UmlTrace_EClass0)
...
UmlTrace_TraceElement_strategy = st.builds(UmlTrace_TraceElement)
