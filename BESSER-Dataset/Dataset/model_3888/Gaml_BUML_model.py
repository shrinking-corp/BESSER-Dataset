...
# Classes
gaml_Entry = Class(name="gaml_Entry")
gaml_StandaloneBlock = Class(name="gaml_StandaloneBlock")
Entry = Class(name="Entry")
gaml_ExperimentFileStructure = Class(name="gaml_ExperimentFileStructure")
gaml_HeadlessExperiment = Class(name="gaml_HeadlessExperiment")
gaml_Facet = Class(name="gaml_Facet")
gaml_Block = Class(name="gaml_Block")
gaml_StringEvaluator = Class(name="gaml_StringEvaluator")
gaml_Expression = Class(name="gaml_Expression")
gaml_Model = Class(name="gaml_Model")
VarDefinition = Class(name="VarDefinition")
gaml_Pragma = Class(name="gaml_Pragma")
gaml_Import = Class(name="gaml_Import")
gaml_Statement = Class(name="gaml_Statement")
gaml_S_Reflex = Class(name="gaml_S_Reflex")
gaml_S_Definition = Class(name="gaml_S_Definition")
ActionDefinition = Class(name="ActionDefinition")
gaml_ActionArguments = Class(name="gaml_ActionArguments")
gaml_S_Assignment = Class(name="gaml_S_Assignment")
gaml_S_DirectAssignment = Class(name="gaml_S_DirectAssignment")
S_Assignment = Class(name="S_Assignment")
gaml_S_Set = Class(name="gaml_S_Set")
gaml_S_Equations = Class(name="gaml_S_Equations")
EquationDefinition = Class(name="EquationDefinition")
gaml_S_Solve = Class(name="gaml_S_Solve")
gaml_S_Display = Class(name="gaml_S_Display")
gaml_S_Global = Class(name="gaml_S_Global")
Statement = Class(name="Statement")
gaml_S_Species = Class(name="gaml_S_Species")
S_Declaration = Class(name="S_Declaration")
TypeDefinition = Class(name="TypeDefinition")
gaml_S_Experiment = Class(name="gaml_S_Experiment")
gaml_S_Do = Class(name="gaml_S_Do")
gaml_S_Loop = Class(name="gaml_S_Loop")
gaml_S_If = Class(name="gaml_S_If")
gaml_EObject = Class(name="gaml_EObject")
gaml_S_Other = Class(name="gaml_S_Other")
gaml_S_Return = Class(name="gaml_S_Return")
gaml_S_Declaration = Class(name="gaml_S_Declaration")
gaml_speciesOrGridDisplayStatement = Class(name="gaml_speciesOrGridDisplayStatement")
gaml_Parameters = Class(name="gaml_Parameters")
Expression = Class(name="Expression")
gaml_ExpressionList = Class(name="gaml_ExpressionList")
gaml_ArgumentDefinition = Class(name="gaml_ArgumentDefinition")
gaml_GamlDefinition = Class(name="gaml_GamlDefinition")
gaml_EquationDefinition = Class(name="gaml_EquationDefinition")
GamlDefinition = Class(name="GamlDefinition")
gaml_TypeDefinition = Class(name="gaml_TypeDefinition")
gaml_ActionDefinition = Class(name="gaml_ActionDefinition")
gaml_UnitFakeDefinition = Class(name="gaml_UnitFakeDefinition")
gaml_TypeFakeDefinition = Class(name="gaml_TypeFakeDefinition")
gaml_ActionFakeDefinition = Class(name="gaml_ActionFakeDefinition")
gaml_SkillFakeDefinition = Class(name="gaml_SkillFakeDefinition")
gaml_VarFakeDefinition = Class(name="gaml_VarFakeDefinition")
gaml_ArgumentPair = Class(name="gaml_ArgumentPair")
gaml_Function = Class(name="gaml_Function")
gaml_TypeInfo = Class(name="gaml_TypeInfo")
gaml_VariableRef = Class(name="gaml_VariableRef")
gaml_VarDefinition = Class(name="gaml_VarDefinition")
gaml_Point = Class(name="gaml_Point")
gaml_Parameter = Class(name="gaml_Parameter")
gaml_UnitName = Class(name="gaml_UnitName")
gaml_TypeRef = Class(name="gaml_TypeRef")
gaml_SkillRef = Class(name="gaml_SkillRef")
gaml_EquationFakeDefinition = Class(name="gaml_EquationFakeDefinition")
gaml_TerminalExpression = Class(name="gaml_TerminalExpression")
gaml_S_Action = Class(name="gaml_S_Action")
S_Definition = Class(name="S_Definition")
gaml_ActionRef = Class(name="gaml_ActionRef")
gaml_S_Var = Class(name="gaml_S_Var")
gaml_Pair = Class(name="gaml_Pair")
gaml_EquationRef = Class(name="gaml_EquationRef")
gaml_If = Class(name="gaml_If")
gaml_IntLiteral = Class(name="gaml_IntLiteral")
TerminalExpression = Class(name="TerminalExpression")
gaml_DoubleLiteral = Class(name="gaml_DoubleLiteral")
gaml_Cast = Class(name="gaml_Cast")
gaml_ColorLiteral = Class(name="gaml_ColorLiteral")
gaml_Binary = Class(name="gaml_Binary")
gaml_StringLiteral = Class(name="gaml_StringLiteral")
gaml_BooleanLiteral = Class(name="gaml_BooleanLiteral")
gaml_Unit = Class(name="gaml_Unit")
gaml_ReservedLiteral = Class(name="gaml_ReservedLiteral")
gaml_Unary = Class(name="gaml_Unary")
gaml_Access = Class(name="gaml_Access")
gaml_Array = Class(name="gaml_Array")
...
gaml_HeadlessExperiment.attributes={gaml_HeadlessExperiment_firstFacet, gaml_HeadlessExperiment_importURI, gaml_HeadlessExperiment_name, gaml_HeadlessExperiment_key}
...
domain_model = DomainModel(
    name="gaml",
    types={gaml_Entry, gaml_StandaloneBlock, Entry, gaml_ExperimentFileStructure, gaml_HeadlessExperiment, gaml_Facet, gaml_Block, gaml_StringEvaluator, gaml_Expression, gaml_Model, VarDefinition, gaml_Pragma, gaml_Import, gaml_Statement, gaml_S_Reflex, gaml_S_Definition, ActionDefinition, gaml_ActionArguments, gaml_S_Assignment, gaml_S_DirectAssignment, S_Assignment, gaml_S_Set, gaml_S_Equations, EquationDefinition, gaml_S_Solve, gaml_S_Display, gaml_S_Global, Statement, gaml_S_Species, S_Declaration, TypeDefinition, gaml_S_Experiment, gaml_S_Do, gaml_S_Loop, gaml_S_If, gaml_EObject, gaml_S_Other, gaml_S_Return, gaml_S_Declaration, gaml_speciesOrGridDisplayStatement, gaml_Parameters, Expression, gaml_ExpressionList, gaml_ArgumentDefinition, gaml_GamlDefinition, gaml_EquationDefinition, GamlDefinition, gaml_TypeDefinition, gaml_ActionDefinition, gaml_UnitFakeDefinition, gaml_TypeFakeDefinition, gaml_ActionFakeDefinition, gaml_SkillFakeDefinition, gaml_VarFakeDefinition, gaml_ArgumentPair, gaml_Function, gaml_TypeInfo, gaml_VariableRef, gaml_VarDefinition, gaml_Point, gaml_Parameter, gaml_UnitName, gaml_TypeRef, gaml_SkillRef, gaml_EquationFakeDefinition, gaml_TerminalExpression, gaml_S_Action, S_Definition, gaml_ActionRef, gaml_S_Var, gaml_Pair, gaml_EquationRef, gaml_If, gaml_IntLiteral, TerminalExpression, gaml_DoubleLiteral, gaml_Cast, gaml_ColorLiteral, gaml_Binary, gaml_StringLiteral, gaml_BooleanLiteral, gaml_Unit, gaml_ReservedLiteral, gaml_Unary, gaml_Access, gaml_Array},
    associations={function10, exp13, facets14, block16, block0, expr1, pragmas2, imports3, block5, statements8, tkey29, args31, value33, equations35, expr19, facets22, block25, else_28, expr46, block49, left53, params37, args38, type40, default43, first72, second75, right56, action58, parameters60, args63, type66, exprs68, ref71, exprs82, z84, ref86, ref87, parameter88, ref91, ref92, ref93, ifFalse78, args80},
    generalizations={gen_gaml_StandaloneBlock_Entry, gen_gaml_Import_VarDefinition, gen_gaml_ExperimentFileStructure_Entry, gen_gaml_StringEvaluator_Entry, gen_gaml_Model_Entry, gen_gaml_Model_VarDefinition, gen_gaml_S_Reflex_S_Declaration, gen_gaml_S_Definition_S_Declaration, gen_gaml_S_Definition_ActionDefinition, gen_gaml_S_Assignment_Statement, gen_gaml_S_DirectAssignment_S_Assignment, gen_gaml_S_Set_S_Assignment, gen_gaml_S_Equations_Statement, gen_gaml_S_Equations_EquationDefinition, gen_gaml_S_Solve_Statement, gen_gaml_S_Display_Statement, gen_gaml_S_Global_Statement, gen_gaml_S_Species_Statement, gen_gaml_S_Species_S_Declaration, gen_gaml_S_Species_TypeDefinition, gen_gaml_S_Experiment_Statement, gen_gaml_S_Experiment_VarDefinition, gen_gaml_S_Do_Statement, gen_gaml_S_Loop_S_Declaration, gen_gaml_S_If_Statement, gen_gaml_S_Other_Statement, gen_gaml_S_Return_Statement, gen_gaml_S_Declaration_Statement, gen_gaml_S_Declaration_VarDefinition, gen_gaml_speciesOrGridDisplayStatement_Statement, gen_gaml_Parameters_Expression, gen_gaml_ArgumentDefinition_VarDefinition, gen_gaml_Facet_VarDefinition, gen_gaml_EquationDefinition_GamlDefinition, gen_gaml_TypeDefinition_GamlDefinition, gen_gaml_TypeDefinition_ActionDefinition, gen_gaml_VarDefinition_GamlDefinition, gen_gaml_ActionDefinition_GamlDefinition, gen_gaml_UnitFakeDefinition_GamlDefinition, gen_gaml_TypeFakeDefinition_TypeDefinition, gen_gaml_ActionFakeDefinition_ActionDefinition, gen_gaml_SkillFakeDefinition_GamlDefinition, gen_gaml_VarFakeDefinition_VarDefinition, gen_gaml_ArgumentPair_Expression, gen_gaml_Function_Expression, gen_gaml_ExpressionList_Expression, gen_gaml_VariableRef_Expression, gen_gaml_Point_Expression, gen_gaml_Parameter_Expression, gen_gaml_UnitName_Expression, gen_gaml_TypeRef_Expression, gen_gaml_SkillRef_Expression, gen_gaml_EquationFakeDefinition_EquationDefinition, gen_gaml_TerminalExpression_Expression, gen_gaml_S_Action_S_Definition, gen_gaml_ActionRef_Expression, gen_gaml_S_Var_S_Definition, gen_gaml_Pair_Expression, gen_gaml_EquationRef_Expression, gen_gaml_If_Expression, gen_gaml_IntLiteral_TerminalExpression, gen_gaml_DoubleLiteral_TerminalExpression, gen_gaml_Cast_Expression, gen_gaml_ColorLiteral_TerminalExpression, gen_gaml_Binary_Expression, gen_gaml_StringLiteral_TerminalExpression, gen_gaml_BooleanLiteral_TerminalExpression, gen_gaml_Unit_Expression, gen_gaml_ReservedLiteral_TerminalExpression, gen_gaml_Unary_Expression, gen_gaml_Access_Expression, gen_gaml_Array_Expression},
    metadata=None
)
