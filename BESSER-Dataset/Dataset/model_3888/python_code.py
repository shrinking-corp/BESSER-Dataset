...
class gaml_S_If(Statement):
    ...
    pass
class gaml_S_Species(Statement, TypeDefinition, S_Declaration):
...
class gaml_ActionFakeDefinition(ActionDefinition):
    ...
    pass
class gaml_S_Definition(ActionDefinition, S_Declaration):
...
class gaml_Statement:
    ...
    def __init__(self, key: str, firstFacet: str, gaml_Statement: "gaml_Block" = None, gaml_Statement20: "gaml_Expression" = None, gaml_Statement23: set["gaml_Facet"] = None, gaml_Statement26: "gaml_Block" = None):
        self.key = key
...
class VarDefinition:
    ...
    pass
class gaml_S_Declaration(VarDefinition, Statement):

    pass
class gaml_VarFakeDefinition(VarDefinition):

    pass
class gaml_S_Experiment(VarDefinition, Statement):
...
class gaml_Expression:
    ...
    def __init__(self, op: str, gaml_Expression12: "gaml_Block" = None, gaml_Expression79: "gaml_If" = None, gaml_Expression: "gaml_StringEvaluator" = None, gaml_Expression30: "gaml_S_Definition" = None, gaml_Expression34: "gaml_S_Assignment" = None, gaml_Expression21: "gaml_Statement" = None, gaml_Expression48: "gaml_Facet" = None, gaml_Expression54: "gaml_Expression" = None, gaml_Expression52: "gaml_Expression" = None, gaml_Expression42: "gaml_ArgumentDefinition" = None, gaml_Expression45: "gaml_ArgumentDefinition" = None, gaml_Expression74: "gaml_TypeInfo" = None, gaml_Expression77: "gaml_TypeInfo" = None, gaml_Expression57: "gaml_Expression" = None, gaml_Expression55: "gaml_Expression" = None, gaml_Expression59: "gaml_Function" = None, gaml_Expression70: "gaml_ExpressionList" = None, gaml_Expression85: "gaml_Point" = None):
        self.op = op
...
class gaml_HeadlessExperiment:
    ...
    def __init__(self, key: str, firstFacet: str, name: str, importURI: str, gaml_HeadlessExperiment: "gaml_ExperimentFileStructure" = None, gaml_HeadlessExperiment15: set["gaml_Facet"] = None, gaml_HeadlessExperiment17: "gaml_Block" = None):
        self.key = key
        self.firstFacet = firstFacet
        self.name = name
        self.importURI = importURI
...
class gaml_Model(VarDefinition, Entry):
