...
class projectPlanning_Employee:
    ...
    def __init__(self, name: str, hasResource: int, projectPlanning_Employee26: "projectPlanning_Assignment" = None, projectPlanning_Employee: "projectPlanning_ProjectPlan" = None, projectPlanning_Employee13: set["projectPlanning_Capability"] = None, projectPlanning_Employee16: set["projectPlanning_Rating"] = None):
        self.name = name
