...
# Classes
projectPlanning_ProjectPlan = Class(name="projectPlanning_ProjectPlan")
projectPlanning_Capability = Class(name="projectPlanning_Capability")
projectPlanning_Employee = Class(name="projectPlanning_Employee")
projectPlanning_Project = Class(name="projectPlanning_Project")
projectPlanning_Rating = Class(name="projectPlanning_Rating")
projectPlanning_Assignment = Class(name="projectPlanning_Assignment")
...
projectPlanning_Employee.attributes={projectPlanning_Employee_hasResource, projectPlanning_Employee_name}
...
domain_model = DomainModel(
    ...
    associations={capabilities0, employees1, projects3, ratings5, requiresCapabilities9, hasCapabilities12, ratings15, capability18, project21, employee24, assignments7},
    generalizations={},
    metadata=None
)
