...
class esper2Maude_SelectEntry:
    ...
    def __init__(self, alias: str, groupOp: str, esper2Maude_SelectEntry78: "esper2Maude_Field" = None, esper2Maude_SelectEntry: "esper2Maude_NonLastSelectEntry" = None, esper2Maude_SelectEntry76: "esper2Maude_LastSelectEntry" = None):
        self.alias = alias
...
class esper2Maude_LogicalOperator:
    ...
    def __init__(self, and_: str, or_: str, esper2Maude_LogicalOperator: "esper2Maude_FilterFrom" = None, esper2Maude_LogicalOperator71: "esper2Maude_FilterOperator" = None):
        self.and_ = and_
        self.or_ = or_
...
class esper2Maude_Schema:
    ...
    def __init__(self, name: str, esper2Maude_Schema4: "esper2Maude_EventProperty" = None, esper2Maude_Schema6: set["esper2Maude_EventProperty"] = None, esper2Maude_Schema: "esper2Maude_Model" = None):
        self.name = name
...
class esper2Maude_WhereFilter:
    ...
    def __init__(self, timer: str, num: int, esper2Maude_WhereFilter47: "esper2Maude_FollowedBy" = None, esper2Maude_WhereFilter22: "esper2Maude_FilterOperator" = None, esper2Maude_WhereFilter: "esper2Maude_FilterEvent" = None, esper2Maude_WhereFilter20: "esper2Maude_FilterOperator" = None, esper2Maude_WhereFilter25: "esper2Maude_FilterEvent" = None):
        self.timer = timer
        self.num = num
...
class esper2Maude_FilterFrom:
    ...
    def __init__(self, eventVariable: str, eventName: str, esper2Maude_FilterFrom38: "esper2Maude_FilterEvent" = None, esper2Maude_FilterFrom58: "esper2Maude_Every" = None, esper2Maude_FilterFrom: "esper2Maude_Pattern" = None, esper2Maude_FilterFrom28: "esper2Maude_FollowedBy" = None, esper2Maude_FilterFrom31: "esper2Maude_FilterFrom" = None, esper2Maude_FilterFrom29: "esper2Maude_FilterFrom" = None, esper2Maude_FilterFrom33: "esper2Maude_LogicalOperator" = None, esper2Maude_FilterFrom36: "esper2Maude_FilterFrom" = None, esper2Maude_FilterFrom34: "esper2Maude_FilterFrom" = None):
        self.eventVariable = eventVariable
        self.eventName = eventName
