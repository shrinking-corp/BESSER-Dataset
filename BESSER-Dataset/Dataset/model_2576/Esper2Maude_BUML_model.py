...
# Classes
esper2Maude_Event = Class(name="esper2Maude_Event")
esper2Maude_NonLastSelectEntry = Class(name="esper2Maude_NonLastSelectEntry")
esper2Maude_LastSelectEntry = Class(name="esper2Maude_LastSelectEntry")
esper2Maude_FilterFrom = Class(name="esper2Maude_FilterFrom")
esper2Maude_Window = Class(name="esper2Maude_Window")
esper2Maude_WhereFilter = Class(name="esper2Maude_WhereFilter")
esper2Maude_FilterEvent = Class(name="esper2Maude_FilterEvent")
esper2Maude_FilterOperator = Class(name="esper2Maude_FilterOperator")
esper2Maude_Model = Class(name="esper2Maude_Model")
esper2Maude_Schema = Class(name="esper2Maude_Schema")
esper2Maude_Pattern = Class(name="esper2Maude_Pattern")
esper2Maude_EventProperty = Class(name="esper2Maude_EventProperty")
esper2Maude_SubFilterFollowedBy = Class(name="esper2Maude_SubFilterFollowedBy")
esper2Maude_Every = Class(name="esper2Maude_Every")
esper2Maude_FilterPart = Class(name="esper2Maude_FilterPart")
esper2Maude_FollowedBy = Class(name="esper2Maude_FollowedBy")
esper2Maude_LogicalOperator = Class(name="esper2Maude_LogicalOperator")
esper2Maude_ComparisonOperator = Class(name="esper2Maude_ComparisonOperator")
esper2Maude_Field = Class(name="esper2Maude_Field")
esper2Maude_SelectEntry = Class(name="esper2Maude_SelectEntry")
...
esper2Maude_Window.attributes={esper2Maude_Window_typeTime, esper2Maude_Window_num, esper2Maude_Window_typeBatch}
...
esper2Maude_WhereFilter.attributes={esper2Maude_WhereFilter_num, esper2Maude_WhereFilter_timer}
...
esper2Maude_Pattern.attributes={esper2Maude_Pattern_num, esper2Maude_Pattern_name}
...
esper2Maude_EventProperty.attributes={esper2Maude_EventProperty_type, esper2Maude_EventProperty_name}
...
esper2Maude_SubFilterFollowedBy.attributes={esper2Maude_SubFilterFollowedBy_eventName, esper2Maude_SubFilterFollowedBy_eventVariable}
...
esper2Maude_Every.attributes={esper2Maude_Every_eventName, esper2Maude_Every_eventVariable}
...
esper2Maude_FilterPart.attributes={esper2Maude_FilterPart_eventPropName, esper2Maude_FilterPart_dec, esper2Maude_FilterPart_eventVariable, esper2Maude_FilterPart_f, esper2Maude_FilterPart_str, esper2Maude_FilterPart_num, esper2Maude_FilterPart_neg, esper2Maude_FilterPart_t}

# esper2Maude_FollowedBy class attributes and methods

# esper2Maude_LogicalOperator class attributes and methods
esper2Maude_LogicalOperator_and_: Property = Property(name="and_", type=StringType)
esper2Maude_LogicalOperator_or_: Property = Property(name="or_", type=StringType)
esper2Maude_LogicalOperator.attributes={esper2Maude_LogicalOperator_and_, esper2Maude_LogicalOperator_or_}
...
esper2Maude_ComparisonOperator.attributes={esper2Maude_ComparisonOperator_le, esper2Maude_ComparisonOperator_lt, esper2Maude_ComparisonOperator_gt, esper2Maude_ComparisonOperator_eq, esper2Maude_ComparisonOperator_ge, esper2Maude_ComparisonOperator_neq}
...
esper2Maude_SelectEntry.attributes={esper2Maude_SelectEntry_alias, esper2Maude_SelectEntry_groupOp}
...
domain_model = DomainModel(
    name="esper2Maude",
    types={esper2Maude_Event, esper2Maude_NonLastSelectEntry, esper2Maude_LastSelectEntry, esper2Maude_FilterFrom, esper2Maude_Window, esper2Maude_WhereFilter, esper2Maude_FilterEvent, esper2Maude_FilterOperator, esper2Maude_Model, esper2Maude_Schema, esper2Maude_Pattern, esper2Maude_EventProperty, esper2Maude_SubFilterFollowedBy, esper2Maude_Every, esper2Maude_FilterPart, esper2Maude_FollowedBy, esper2Maude_LogicalOperator, esper2Maude_ComparisonOperator, esper2Maude_Field, esper2Maude_SelectEntry},
    associations={props5, event8, selectEntries10, selectEntry12, fromFilter14, win16, filterEventL18, filterOpL19, schemas0, patterns1, prop3, filter37, left40, right42, whereFilter45, filter48, every51, filter53, filterFrom56, filterLeftHandSide59, filterOp61, filterRightHandSide64, filterOpR21, filterEventR24, followedBy27, left30, op32, right35, comparison67, logical69, field77, entry72, entry74},
    generalizations={},
    metadata=None
)
