...
# Classes
grammar_features_AbstractSuperclass = Class(name="grammar_features_AbstractSuperclass", is_abstract=True)
grammar_features_ConcreteSubclassA = Class(name="grammar_features_ConcreteSubclassA")
AbstractSuperclass = Class(name="AbstractSuperclass")
grammar_features_ConcreteSubclassB = Class(name="grammar_features_ConcreteSubclassB")
grammar_features_OptionalContainment = Class(name="grammar_features_OptionalContainment")
grammar_features_X = Class(name="grammar_features_X")
grammar_features_MandatoryContainment = Class(name="grammar_features_MandatoryContainment")
grammar_features_PlusContainment = Class(name="grammar_features_PlusContainment")
grammar_features_StarContainment = Class(name="grammar_features_StarContainment")
grammar_features_OptionalNonContainment = Class(name="grammar_features_OptionalNonContainment")
grammar_features_MandatoryNonContainment = Class(name="grammar_features_MandatoryNonContainment")
grammar_features_PlusNonContainment = Class(name="grammar_features_PlusNonContainment")
grammar_features_Root = Class(name="grammar_features_Root")
grammar_features_Child = Class(name="grammar_features_Child", is_abstract=True)
grammar_features_AlternativeSyntax = Class(name="grammar_features_AlternativeSyntax")
Child = Class(name="Child")
grammar_features_StarPrefix = Class(name="grammar_features_StarPrefix")
grammar_features_PlusPrefix = Class(name="grammar_features_PlusPrefix")
grammar_features_StarNonContainment = Class(name="grammar_features_StarNonContainment")
grammar_features_CompoundStar = Class(name="grammar_features_CompoundStar")
grammar_features_CompoundPlus = Class(name="grammar_features_CompoundPlus")
grammar_features_CompoundOptional = Class(name="grammar_features_CompoundOptional")
grammar_features_ClassWithAttributes = Class(name="grammar_features_ClassWithAttributes")
grammar_features_SecondRoot = Class(name="grammar_features_SecondRoot")
grammar_features_OptionalPrefix = Class(name="grammar_features_OptionalPrefix")
...
domain_model = DomainModel(
    ...
    types={grammar_features_AbstractSuperclass, grammar_features_ConcreteSubclassA, AbstractSuperclass, grammar_features_ConcreteSubclassB, grammar_features_OptionalContainment, grammar_features_X, grammar_features_MandatoryContainment, grammar_features_PlusContainment, grammar_features_StarContainment, grammar_features_OptionalNonContainment, grammar_features_MandatoryNonContainment, grammar_features_PlusNonContainment, grammar_features_Root, grammar_features_Child, grammar_features_AlternativeSyntax, Child, grammar_features_StarPrefix, grammar_features_PlusPrefix, grammar_features_StarNonContainment, grammar_features_CompoundStar, grammar_features_CompoundPlus, grammar_features_CompoundOptional, grammar_features_ClassWithAttributes, grammar_features_SecondRoot, grammar_features_OptionalPrefix},
    associations={reference1, reference2, reference4, reference6, reference8, reference10, reference12, children0, reference14},
    generalizations={gen_grammar_features_AbstractSuperclass_Child, gen_grammar_features_ConcreteSubclassA_AbstractSuperclass, gen_grammar_features_ConcreteSubclassB_AbstractSuperclass, gen_grammar_features_OptionalContainment_Child, gen_grammar_features_MandatoryContainment_Child, gen_grammar_features_PlusContainment_Child, gen_grammar_features_StarContainment_Child, gen_grammar_features_OptionalNonContainment_Child, gen_grammar_features_MandatoryNonContainment_Child, gen_grammar_features_PlusNonContainment_Child, gen_grammar_features_AlternativeSyntax_Child, gen_grammar_features_StarPrefix_Child, gen_grammar_features_PlusPrefix_Child, gen_grammar_features_StarNonContainment_Child, gen_grammar_features_CompoundStar_Child, gen_grammar_features_CompoundPlus_Child, gen_grammar_features_CompoundOptional_Child, gen_grammar_features_ClassWithAttributes_Child, gen_grammar_features_OptionalPrefix_Child},
    metadata=None
)
