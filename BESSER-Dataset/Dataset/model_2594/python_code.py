...
class grammar_features_X:
    ...
    def __init__(self, name: str, grammar_features_X: "grammar_features_OptionalContainment" = None, grammar_features_X3: "grammar_features_MandatoryContainment" = None, grammar_features_X5: "grammar_features_PlusContainment" = None, grammar_features_X7: "grammar_features_StarContainment" = None, grammar_features_X9: "grammar_features_OptionalNonContainment" = None, grammar_features_X11: "grammar_features_MandatoryNonContainment" = None, grammar_features_X13: "grammar_features_PlusNonContainment" = None, grammar_features_X15: "grammar_features_StarNonContainment" = None):
        self.name = name
