...
class minioclcs_LetExpCS(PrimaryExpCS):
    ...
    pass
class minioclcs_NameExpCS(NavigationExpCS, PrimaryExpCS):
...
class minioclcs_EqualityExpCS(ExpCS):
    ...
    def __init__(self, opName: str, minioclcs_EqualityExpCS42: "minioclcs_CallExpCS" = None, minioclcs_EqualityExpCS: "minioclcs_EqualityExpCS" = None, minioclcs_EqualityExpCS39: "minioclcs_EqualityExpCS" = None):
        self.opName = opName
...
class minioclcs_OperationCS(CSTrace):
    ...
    def __init__(self, name: str, minioclcs_OperationCS22: set["minioclcs_ParameterCS"] = None, minioclcs_OperationCS24: "minioclcs_PathNameCS" = None, minioclcs_OperationCS27: "minioclcs_ExpCS" = None, minioclcs_OperationCS: "minioclcs_ClassCS" = None):
        self.name = name
...
class minioclcs_ClassCS(CSTrace):
    ...
    def __init__(self, name: str, minioclcs_ClassCS: "minioclcs_PackageCS" = None, minioclcs_ClassCS11: "minioclcs_PathNameCS" = None, minioclcs_ClassCS13: set["minioclcs_PropertyCS"] = None, minioclcs_ClassCS15: set["minioclcs_OperationCS"] = None):
        self.name = name
