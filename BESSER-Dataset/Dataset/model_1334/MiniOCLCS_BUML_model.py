...
# Classes
minioclcs_RootCS = Class(name="minioclcs_RootCS")
CSTrace = Class(name="CSTrace")
minioclcs_ImportCS = Class(name="minioclcs_ImportCS")
minioclcs_PackageCS = Class(name="minioclcs_PackageCS")
minioclcs_ConstraintsDefCS = Class(name="minioclcs_ConstraintsDefCS")
minioclcs_ClassCS = Class(name="minioclcs_ClassCS")
minioclcs_PathNameCS = Class(name="minioclcs_PathNameCS")
minioclcs_PropertyCS = Class(name="minioclcs_PropertyCS")
minioclcs_OperationCS = Class(name="minioclcs_OperationCS")
minioclcs_MultiplicityCS = Class(name="minioclcs_MultiplicityCS")
minioclcs_ParameterCS = Class(name="minioclcs_ParameterCS")
minioclcs_ExpCS = Class(name="minioclcs_ExpCS")
minioclcs_InvariantCS = Class(name="minioclcs_InvariantCS")
minioclcs_EqualityExpCS = Class(name="minioclcs_EqualityExpCS")
ExpCS = Class(name="ExpCS")
EqualityExpCS = Class(name="EqualityExpCS")
minioclcs_NavigationExpCS = Class(name="minioclcs_NavigationExpCS")
minioclcs_PrimaryExpCS = Class(name="minioclcs_PrimaryExpCS")
CallExpCS = Class(name="CallExpCS")
minioclcs_SelfExpCS = Class(name="minioclcs_SelfExpCS")
PrimaryExpCS = Class(name="PrimaryExpCS")
minioclcs_LoopExpCS = Class(name="minioclcs_LoopExpCS")
NavigationExpCS = Class(name="NavigationExpCS")
minioclcs_IteratorVarCS = Class(name="minioclcs_IteratorVarCS")
minioclcs_CollectExpCS = Class(name="minioclcs_CollectExpCS")
LoopExpCS = Class(name="LoopExpCS")
minioclcs_IterateExpCS = Class(name="minioclcs_IterateExpCS")
minioclcs_AccVarCS = Class(name="minioclcs_AccVarCS")
minioclcs_NameExpCS = Class(name="minioclcs_NameExpCS")
minioclcs_RoundedBracketClauseCS = Class(name="minioclcs_RoundedBracketClauseCS")
minioclcs_CallExpCS = Class(name="minioclcs_CallExpCS")
minioclcs_BooleanLiteralExpCS = Class(name="minioclcs_BooleanLiteralExpCS")
minioclcs_NullLiteralExpCS = Class(name="minioclcs_NullLiteralExpCS")
minioclcs_CollectionLiteralExpCS = Class(name="minioclcs_CollectionLiteralExpCS")
minioclcs_CollectionLiteralPartCS = Class(name="minioclcs_CollectionLiteralPartCS")
minioclcs_LetExpCS = Class(name="minioclcs_LetExpCS")
minioclcs_LetVarCS = Class(name="minioclcs_LetVarCS")
minioclcs_PathElementCS = Class(name="minioclcs_PathElementCS")
minioclcs_EClass = Class(name="minioclcs_EClass")
minioclcs_BooleanExpCS = Class(name="minioclcs_BooleanExpCS")
BooleanLiteralExpCS = Class(name="BooleanLiteralExpCS")
minioclcs_LiteralExpCS = Class(name="minioclcs_LiteralExpCS")
minioclcs_IntLiteralExpCS = Class(name="minioclcs_IntLiteralExpCS")
LiteralExpCS = Class(name="LiteralExpCS")
minioclcs_CSTrace = Class(name="minioclcs_CSTrace", is_abstract=True)
minioclcs_EObject = Class(name="minioclcs_EObject")
...
minioclcs_ImportCS.attributes={minioclcs_ImportCS_uri, minioclcs_ImportCS_alias}
...
minioclcs_MultiplicityCS.attributes={minioclcs_MultiplicityCS_lowerInt, minioclcs_MultiplicityCS_opt, minioclcs_MultiplicityCS_upperMult, minioclcs_MultiplicityCS_upperInt, minioclcs_MultiplicityCS_mult, minioclcs_MultiplicityCS_mandatory}
...
domain_model = DomainModel(
    name="minioclcs",
    types={minioclcs_RootCS, CSTrace, minioclcs_ImportCS, minioclcs_PackageCS, minioclcs_ConstraintsDefCS, minioclcs_ClassCS, minioclcs_PathNameCS, minioclcs_PropertyCS, minioclcs_OperationCS, minioclcs_MultiplicityCS, minioclcs_ParameterCS, minioclcs_ExpCS, minioclcs_InvariantCS, minioclcs_EqualityExpCS, ExpCS, EqualityExpCS, minioclcs_NavigationExpCS, minioclcs_PrimaryExpCS, CallExpCS, minioclcs_SelfExpCS, PrimaryExpCS, minioclcs_LoopExpCS, NavigationExpCS, minioclcs_IteratorVarCS, minioclcs_CollectExpCS, LoopExpCS, minioclcs_IterateExpCS, minioclcs_AccVarCS, minioclcs_NameExpCS, minioclcs_RoundedBracketClauseCS, minioclcs_CallExpCS, minioclcs_BooleanLiteralExpCS, minioclcs_NullLiteralExpCS, minioclcs_CollectionLiteralExpCS, minioclcs_CollectionLiteralPartCS, minioclcs_LetExpCS, minioclcs_LetVarCS, minioclcs_PathElementCS, minioclcs_EClass, minioclcs_BooleanExpCS, BooleanLiteralExpCS, minioclcs_LiteralExpCS, minioclcs_IntLiteralExpCS, LiteralExpCS, minioclcs_CSTrace, minioclcs_EObject, CollectionKindCS},
    associations={imports0, packages1, constraints3, packages6, classes8, extends10, properties12, typeRef16, multiplicity19, params21, resultRef23, body26, typeRef28, typeRef31, invariants34, exp36, left40, operations14, source44, navExp46, itVar48, exp49, itType52, accVar55, accType56, accInitExp59, expName62, roundedBrackets64, args66, right41, parts69, first70, last73, letVars76, inExp77, typeRef80, initExp83, pathElements86, elementName88, ast90},
    generalizations={gen_minioclcs_RootCS_CSTrace, gen_minioclcs_ImportCS_CSTrace, gen_minioclcs_PackageCS_CSTrace, gen_minioclcs_ClassCS_CSTrace, gen_minioclcs_MultiplicityCS_CSTrace, gen_minioclcs_OperationCS_CSTrace, gen_minioclcs_ParameterCS_CSTrace, gen_minioclcs_ConstraintsDefCS_CSTrace, gen_minioclcs_InvariantCS_CSTrace, gen_minioclcs_ExpCS_CSTrace, gen_minioclcs_EqualityExpCS_ExpCS, gen_minioclcs_PropertyCS_CSTrace, gen_minioclcs_CallExpCS_EqualityExpCS, gen_minioclcs_PrimaryExpCS_CallExpCS, gen_minioclcs_SelfExpCS_PrimaryExpCS, gen_minioclcs_NavigationExpCS_CSTrace, gen_minioclcs_LoopExpCS_NavigationExpCS, gen_minioclcs_CollectExpCS_LoopExpCS, gen_minioclcs_IteratorVarCS_CSTrace, gen_minioclcs_IterateExpCS_LoopExpCS, gen_minioclcs_AccVarCS_CSTrace, gen_minioclcs_NameExpCS_PrimaryExpCS, gen_minioclcs_NameExpCS_NavigationExpCS, gen_minioclcs_RoundedBracketClauseCS_CSTrace, gen_minioclcs_IntLiteralExpCS_LiteralExpCS, gen_minioclcs_BooleanLiteralExpCS_LiteralExpCS, gen_minioclcs_NullLiteralExpCS_LiteralExpCS, gen_minioclcs_CollectionLiteralExpCS_LiteralExpCS, gen_minioclcs_CollectionLiteralPartCS_CSTrace, gen_minioclcs_LetExpCS_PrimaryExpCS, gen_minioclcs_LetVarCS_CSTrace, gen_minioclcs_PathNameCS_CSTrace, gen_minioclcs_PathElementCS_CSTrace, gen_minioclcs_BooleanExpCS_BooleanLiteralExpCS, gen_minioclcs_LiteralExpCS_PrimaryExpCS},
    metadata=None
)
