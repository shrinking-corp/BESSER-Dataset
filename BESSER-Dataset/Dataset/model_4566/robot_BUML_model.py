...
robot_Findable = Class(name="robot_Findable", is_abstract=True)
robot_Simulacra = Class(name="robot_Simulacra", is_abstract=True)
robot_DeviceListener = Class(name="robot_DeviceListener", is_abstract=True)
robot_Storable = Class(name="robot_Storable", is_abstract=True)
robot_Roboid = Class(name="robot_Roboid")
robot_Control = Class(name="robot_Control")
...
robot_Device = Class(name="robot_Device", is_abstract=True)
robot_Channel = Class(name="robot_Channel", is_abstract=True)
robot_Protocol = Class(name="robot_Protocol")
robot_MotoringDevice = Class(name="robot_MotoringDevice", is_abstract=True)
ChannelDevice = Class(name="ChannelDevice")
robot_Sensor = Class(name="robot_Sensor")
SensoryDevice = Class(name="SensoryDevice")
robot_Effector = Class(name="robot_Effector")
MotoringDevice = Class(name="MotoringDevice")
robot_ChannelDevice = Class(name="robot_ChannelDevice", is_abstract=True)
Device = Class(name="Device")
robot_SensoryDevice = Class(name="robot_SensoryDevice", is_abstract=True)
robot_Port = Class(name="robot_Port")
robot_LinearChannel = Class(name="robot_LinearChannel")
Channel = Class(name="Channel")
robot_CommandChannel = Class(name="robot_CommandChannel")
robot_Command = Class(name="robot_Command")
robot_AudioChannel = Class(name="robot_AudioChannel")
robot_VoiceChannel = Class(name="robot_VoiceChannel")
robot_ColorChannel = Class(name="robot_ColorChannel")
robot_TextChannel = Class(name="robot_TextChannel")
robot_MatrixChannel = Class(name="robot_MatrixChannel")
LinearChannel = Class(name="LinearChannel")
robot_FileChannel = Class(name="robot_FileChannel")
robot_Event = Class(name="robot_Event")
...
robot_NamedElement_m_equalsContents: Method = Method(name="equalsContents", parameters={Parameter(name='robot_obj', type=StringType)}, type=BooleanType)
robot_NamedElement_m_getFullName: Method = Method(name="getFullName", parameters={}, type=StringType)
robot_NamedElement.attributes={robot_NamedElement_comment, robot_NamedElement_literal, robot_NamedElement_name}
robot_NamedElement.methods={robot_NamedElement_m_equalsContents, robot_NamedElement_m_getFullName, robot_NamedElement_m_getChildren, robot_NamedElement_m_getParent}

# robot_Findable class attributes and methods
robot_Findable_m_findDevice: Method = Method(name="findDevice", parameters={Parameter(name='robot_name', type=StringType)}, type=StringType)
robot_Findable_m_findRoboid: Method = Method(name="findRoboid", parameters={Parameter(name='robot_name', type=StringType)}, type=StringType)
...
robot_Simulacra_m_setDeviceMap: Method = Method(name="setDeviceMap", parameters={Parameter(name='robot_isMaster', type=StringType), Parameter(name='robot_deviceMap', type=StringType), Parameter(name='robot_index', type=StringType)}, type=IntegerType)
robot_Simulacra_m_setPayload: Method = Method(name="setPayload", parameters={Parameter(name='robot_isMaster', type=StringType), Parameter(name='robot_simulacrum', type=StringType)})
robot_Simulacra_m_getSimulacrum: Method = Method(name="getSimulacrum", parameters={Parameter(name='robot_deviceMap', type=StringType), Parameter(name='robot_payload', type=StringType)})
...
robot_Simulacra.methods={robot_Simulacra_m_setPayload, robot_Simulacra_m_canSend, robot_Simulacra_m_updateDeviceState, robot_Simulacra_m_setDeviceMap, robot_Simulacra_m_getSimulacrum, robot_Simulacra_m_isReceived}

# robot_DeviceListener class attributes and methods
robot_DeviceListener_m_effectPerformed: Method = Method(name="effectPerformed", parameters={Parameter(name='robot_device', type=StringType)})
robot_DeviceListener_m_commandPerformed: Method = Method(name="commandPerformed", parameters={Parameter(name='robot_device', type=StringType)})
robot_DeviceListener_m_stateChanged: Method = Method(name="stateChanged", parameters={Parameter(name='robot_device', type=StringType)})
robot_DeviceListener_m_handleEvent: Method = Method(name="handleEvent", parameters={Parameter(name='robot_device', type=StringType)})
robot_DeviceListener.methods={robot_DeviceListener_m_effectPerformed, robot_DeviceListener_m_stateChanged, robot_DeviceListener_m_handleEvent, robot_DeviceListener_m_commandPerformed}
...
robot_Roboid_m_collectAllDevices: Method = Method(name="collectAllDevices", parameters={Parameter(name='robot_devices', type=StringType)}, type=StringType)
robot_Roboid.attributes={robot_Roboid_version, robot_Roboid_address, robot_Roboid_id, robot_Roboid_provider, robot_Roboid_uid}
...
robot_Robot_m_collectAllDevices: Method = Method(name="collectAllDevices", parameters={Parameter(name='robot_devices', type=StringType)}, type=StringType)
robot_Robot_m_collectAllDeviceNames: Method = Method(name="collectAllDeviceNames", parameters={Parameter(name='robot_names', type=StringType)}, type=StringType)
robot_Robot_m_collectAllActiveDeviceNames: Method = Method(name="collectAllActiveDeviceNames", parameters={Parameter(name='robot_names', type=StringType)}, type=StringType)
robot_Robot.attributes={robot_Robot_version, robot_Robot_standard, robot_Robot_provider}
robot_Robot.methods={robot_Robot_m_collectAllDevices, robot_Robot_m_getProtocol, robot_Robot_m_collectAllDeviceNames, robot_Robot_m_collectAllActiveDeviceNames}
...
robot_Device_m_write: Method = Method(name="write", parameters={Parameter(name='robot_data', type=StringType)}, type=BooleanType)
robot_Device_m_write: Method = Method(name="write", parameters={Parameter(name='robot_index', type=StringType), Parameter(name='robot_data', type=StringType)}, type=BooleanType)
robot_Device_m_write: Method = Method(name="write", parameters={Parameter(name='robot_data', type=StringType)}, type=BooleanType)
robot_Device_m_write: Method = Method(name="write", parameters={Parameter(name='robot_data', type=StringType)}, type=BooleanType)
robot_Device_m_write: Method = Method(name="write", parameters={Parameter(name='robot_index', type=StringType), Parameter(name='robot_data', type=StringType)}, type=BooleanType)
robot_Device_m_write: Method = Method(name="write", parameters={Parameter(name='robot_data', type=StringType)}, type=BooleanType)
robot_Device_m_write: Method = Method(name="write", parameters={Parameter(name='robot_text', type=StringType)}, type=BooleanType)
robot_Device_m_write: Method = Method(name="write", parameters={Parameter(name='robot_text', type=StringType), Parameter(name='robot_index', type=StringType)}, type=BooleanType)
robot_Device_m_write: Method = Method(name="write", parameters={Parameter(name='robot_text', type=StringType)}, type=BooleanType)
robot_Device_m_write: Method = Method(name="write", parameters={Parameter(name='robot_imageData', type=StringType)}, type=BooleanType)
robot_Device_m_writeInt: Method = Method(name="writeInt", parameters={Parameter(name='robot_data', type=StringType), Parameter(name='robot_index', type=StringType)}, type=BooleanType)
robot_Device_m_writeInt: Method = Method(name="writeInt", parameters={Parameter(name='robot_data', type=StringType)}, type=BooleanType)
robot_Device_m_writeFloat: Method = Method(name="writeFloat", parameters={Parameter(name='robot_data', type=StringType)}, type=BooleanType)
robot_Device_m_writeFloat: Method = Method(name="writeFloat", parameters={Parameter(name='robot_data', type=StringType), Parameter(name='robot_index', type=StringType)}, type=BooleanType)
robot_Device_m_writeFloat: Method = Method(name="writeFloat", parameters={Parameter(name='robot_data', type=StringType)}, type=BooleanType)
robot_Device_m_writeString: Method = Method(name="writeString", parameters={Parameter(name='robot_text', type=StringType)}, type=BooleanType)
robot_Device_m_writeString: Method = Method(name="writeString", parameters={Parameter(name='robot_text', type=StringType), Parameter(name='robot_index', type=StringType)}, type=BooleanType)
robot_Device_m_writeString: Method = Method(name="writeString", parameters={Parameter(name='robot_text', type=StringType)}, type=BooleanType)
robot_Device_m_writeImageData: Method = Method(name="writeImageData", parameters={Parameter(name='robot_imageData', type=StringType)}, type=BooleanType)
robot_Device_m_writeImageData: Method = Method(name="writeImageData", parameters={Parameter(name='robot_imageData', type=StringType), Parameter(name='robot_index', type=StringType)}, type=BooleanType)
robot_Device_m_writeImageData: Method = Method(name="writeImageData", parameters={Parameter(name='robot_imageData', type=StringType)}, type=BooleanType)
robot_Device_m_read: Method = Method(name="read", parameters={}, type=IntegerType)
robot_Device_m_write: Method = Method(name="write", parameters={Parameter(name='robot_imageData', type=StringType), Parameter(name='robot_index', type=StringType)}, type=BooleanType)
robot_Device_m_write: Method = Method(name="write", parameters={Parameter(name='robot_imageData', type=StringType)}, type=BooleanType)
robot_Device_m_writeInt: Method = Method(name="writeInt", parameters={Parameter(name='robot_data', type=StringType)}, type=BooleanType)
robot_Device_m_getMinString: Method = Method(name="getMinString", parameters={}, type=StringType)
robot_Device_m_read: Method = Method(name="read", parameters={Parameter(name='robot_data', type=StringType)}, type=IntegerType)
...
robot_Device_m_readInt: Method = Method(name="readInt", parameters={Parameter(name='robot_index', type=StringType)}, type=FloatType)
...
robot_Device_m_readInt: Method = Method(name="readInt", parameters={Parameter(name='robot_data', type=StringType)}, type=IntegerType)
robot_Device_m_getRootRoboid: Method = Method(name="getRootRoboid", parameters={}, type=StringType)
robot_Device_m_isDataTypeOf: Method = Method(name="isDataTypeOf", parameters={Parameter(name='robot_device', type=StringType)}, type=BooleanType)
robot_Device_m_readFloat: Method = Method(name="readFloat", parameters={}, type=FloatType)
robot_Device_m_readFloat: Method = Method(name="readFloat", parameters={Parameter(name='robot_index', type=StringType)}, type=FloatType)
robot_Device_m_readFloat: Method = Method(name="readFloat", parameters={Parameter(name='robot_data', type=StringType)}, type=IntegerType)
robot_Device_m_readString: Method = Method(name="readString", parameters={}, type=StringType)
robot_Device_m_readString: Method = Method(name="readString", parameters={Parameter(name='robot_index', type=StringType)}, type=StringType)
robot_Device_m_readString: Method = Method(name="readString", parameters={Parameter(name='robot_text', type=StringType)}, type=IntegerType)
robot_Device_m_readImageData: Method = Method(name="readImageData", parameters={}, type=StringType)
robot_Device_m_readImageData: Method = Method(name="readImageData", parameters={Parameter(name='robot_index', type=StringType)}, type=StringType)
robot_Device_m_readImageData: Method = Method(name="readImageData", parameters={Parameter(name='robot_imageData', type=StringType)}, type=IntegerType)
...
robot_Device_m_addDeviceListener: Method = Method(name="addDeviceListener", parameters={Parameter(name='robot_listener', type=StringType)})
robot_Device_m_read: Method = Method(name="read", parameters={Parameter(name='robot_index', type=StringType)}, type=IntegerType)
robot_Device_m_removeDeviceListener: Method = Method(name="removeDeviceListener", parameters={Parameter(name='robot_listener', type=StringType)})
robot_Device_m_read: Method = Method(name="read", parameters={Parameter(name='robot_data', type=StringType)}, type=IntegerType)
...
robot_Device.attributes={robot_Device_dataSize, robot_Device_min, robot_Device_max, robot_Device_proxy, robot_Device_access, robot_Device_dataType, robot_Device_default}
robot_Device.methods={robot_Device_m_readFloat, robot_Device_m_write, robot_Device_m_writeString, robot_Device_m_getDefaultFloat, robot_Device_m_getMaxString, robot_Device_m_readImageData, robot_Device_m_getRootRoboid, robot_Device_m_write, robot_Device_m_read, robot_Device_m_write, robot_Device_m_setFired, robot_Device_m_addDeviceListener, robot_Device_m_writeImageData, robot_Device_m_readString, robot_Device_m_writeImageData, robot_Device_m_read, robot_Device_m_writeInt, robot_Device_m_write, robot_Device_m_write, robot_Device_m_read, robot_Device_m_write, robot_Device_m_write, robot_Device_m_readFloat, robot_Device_m_removeDeviceListener, robot_Device_m_write, robot_Device_m_getMin, robot_Device_m_write, robot_Device_m_getDeviceListeners, robot_Device_m_readInt, robot_Device_m_writeInt, robot_Device_m_getDefaultImageData, robot_Device_m_isDataTypeOf, robot_Device_m_writeString, robot_Device_m_writeString, robot_Device_m_read, robot_Device_m_writeFloat, robot_Device_m_write, robot_Device_m_write, robot_Device_m_getMaxFloat, robot_Device_m_read, robot_Device_m_getDefaultString, robot_Device_m_readInt, robot_Device_m_write, robot_Device_m_writeImageData, robot_Device_m_getMax, robot_Device_m_write, robot_Device_m_readString, robot_Device_m_readImageData, robot_Device_m_readInt, robot_Device_m_read, robot_Device_m_setEvent, robot_Device_m_getMinFloat, robot_Device_m_readFloat, robot_Device_m_readString, robot_Device_m_getDefault, robot_Device_m_writeFloat, robot_Device_m_e, robot_Device_m_writeInt, robot_Device_m_writeFloat, robot_Device_m_getMinString, robot_Device_m_readImageData}
...
robot_Protocol_m_setSimulacrum: Method = Method(name="setSimulacrum", parameters={Parameter(name='robot_simulacrum', type=StringType), Parameter(name='robot_isMaster', type=StringType)})
...
robot_Protocol.attributes={robot_Protocol_version, robot_Protocol_remainingBuffer, robot_Protocol_bufferSize}
robot_Protocol.methods={robot_Protocol_m_setEvents, robot_Protocol_m_clearBuffer, robot_Protocol_m_setSimulacrum, robot_Protocol_m_getBufferId, robot_Protocol_m_getSimulacrum}
...
robot_Effector.attributes={robot_Effector_sustain, robot_Effector_throttle}
...
robot_SensoryDevice_m_removeReceptor: Method = Method(name="removeReceptor", parameters={Parameter(name='robot_receptor', type=StringType)})
robot_SensoryDevice_m_addReceptor: Method = Method(name="addReceptor", parameters={Parameter(name='robot_receptor', type=StringType)})
robot_SensoryDevice.methods={robot_SensoryDevice_m_addReceptor, robot_SensoryDevice_m_removeReceptor}
...
domain_model = DomainModel(
    name="robot",
    types={robot_NamedElement, robot_Findable, robot_Simulacra, robot_DeviceListener, robot_Storable, robot_Roboid, robot_Control, Simulacra, robot_Robot, NamedElement, Storable, Findable, robot_Device, robot_Channel, robot_Protocol, robot_MotoringDevice, ChannelDevice, robot_Sensor, SensoryDevice, robot_Effector, MotoringDevice, robot_ChannelDevice, Device, robot_SensoryDevice, robot_Port, robot_LinearChannel, Channel, robot_CommandChannel, robot_Command, robot_AudioChannel, robot_VoiceChannel, robot_ColorChannel, robot_TextChannel, robot_MatrixChannel, LinearChannel, robot_FileChannel, robot_Event, LinearMode, AudioMode, ColorMode, IoMode, DataType, AccessType},
    associations={roboids0, controls1, devices8, hostRoboid11, channels13, roboids4, protocol6, proxyFor16, receptors17, proxyFor30, devices31, proxyFor20, proxyFor23, proxyFor25, receptors26},
    generalizations={gen_robot_Roboid_NamedElement, gen_robot_Roboid_Storable, gen_robot_Roboid_Simulacra, gen_robot_Roboid_Findable, gen_robot_Robot_NamedElement, gen_robot_Robot_Storable, gen_robot_Robot_Findable, gen_robot_Control_NamedElement, gen_robot_Protocol_NamedElement, gen_robot_Device_NamedElement, gen_robot_Device_Storable, gen_robot_Device_Simulacra, gen_robot_MotoringDevice_ChannelDevice, gen_robot_Sensor_SensoryDevice, gen_robot_Effector_MotoringDevice, gen_robot_ChannelDevice_Device, gen_robot_SensoryDevice_Device, gen_robot_Port_ChannelDevice, gen_robot_Channel_NamedElement, gen_robot_LinearChannel_Channel, gen_robot_CommandChannel_Channel, gen_robot_Command_MotoringDevice, gen_robot_AudioChannel_Channel, gen_robot_VoiceChannel_Channel, gen_robot_ColorChannel_Channel, gen_robot_TextChannel_Channel, gen_robot_MatrixChannel_LinearChannel, gen_robot_FileChannel_Channel, gen_robot_Event_SensoryDevice},
    metadata=None
)
