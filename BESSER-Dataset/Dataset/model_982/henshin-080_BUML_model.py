...
henshin_DescribedElement = Class(name="henshin_DescribedElement", is_abstract=True)
...
henshin_AmalgamationUnit = Class(name="henshin_AmalgamationUnit")
henshin_CountedUnit = Class(name="henshin_CountedUnit")
...
henshin_TransformationSystem_m_findUnitByName: Method = Method(name="findUnitByName", parameters={Parameter(name='henshin_unitName', type=StringType)}, type=StringType)
henshin_TransformationSystem_m_findRuleByName: Method = Method(name="findRuleByName", parameters={Parameter(name='henshin_ruleName', type=StringType)}, type=StringType)
henshin_TransformationSystem.methods={henshin_TransformationSystem_m_findUnitByName, henshin_TransformationSystem_m_findRuleByName}
...
henshin_Rule_m_getNodeByName: Method = Method(name="getNodeByName", parameters={Parameter(name='henshin_nodename', type=StringType), Parameter(name='henshin_isLhs', type=StringType)}, type=StringType)
...
henshin_Rule.methods={henshin_Rule_m_containsMapping, henshin_Rule_m_getNodeByName}
...
henshin_Graph_m_findNodesByType: Method = Method(name="findNodesByType", parameters={Parameter(name='henshin_nodeType', type=StringType)}, type=StringType)
henshin_Graph_m_findEdgesByType: Method = Method(name="findEdgesByType", parameters={Parameter(name='henshin_edgeType', type=StringType)}, type=StringType)
henshin_Graph.methods={henshin_Graph_m_findNodesByType, henshin_Graph_m_findEdgesByType, henshin_Graph_m_getContainerRule, henshin_Graph_m_removeNode, henshin_Graph_m_removeEdge}
...
henshin_TransformationUnit_m_getParameterByName: Method = Method(name="getParameterByName", parameters={Parameter(name='henshin_parametername', type=StringType)}, type=StringType)
henshin_TransformationUnit.attributes={henshin_TransformationUnit_activated}
henshin_TransformationUnit.methods={henshin_TransformationUnit_m_getParameterByName, henshin_TransformationUnit_m_getSubUnits}
...
henshin_Node_m_findIncomingEdgesByType: Method = Method(name="findIncomingEdgesByType", parameters={Parameter(name='henshin_edgeType', type=StringType)}, type=StringType)
henshin_Node_m_findOutgoingEdgesByType: Method = Method(name="findOutgoingEdgesByType", parameters={Parameter(name='henshin_edgeType', type=StringType)}, type=StringType)
henshin_Node_m_findAttributeByType: Method = Method(name="findAttributeByType", parameters={Parameter(name='henshin_attributeType', type=StringType)}, type=StringType)
henshin_Node_m_findOutgoingEdgeByType: Method = Method(name="findOutgoingEdgeByType", parameters={Parameter(name='henshin_edgeType', type=StringType), Parameter(name='henshin_targetNode', type=StringType)}, type=StringType)
henshin_Node_m_findIncomingEdgeByType: Method = Method(name="findIncomingEdgeByType", parameters={Parameter(name='henshin_sourceNode', type=StringType), Parameter(name='henshin_edgeType', type=StringType)}, type=StringType)
henshin_Node.methods={henshin_Node_m_findAttributeByType, henshin_Node_m_findOutgoingEdgesByType, henshin_Node_m_findIncomingEdgeByType, henshin_Node_m_findIncomingEdgesByType, henshin_Node_m_findOutgoingEdgeByType}
...
if_56: BinaryAssociation = BinaryAssociation(
    name="if_56",
    ends={
...
else_61: BinaryAssociation = BinaryAssociation(
    name="else_61",
    ends={
...
domain_model = DomainModel(
    name="henshin",
    types={henshin_AttributeCondition, henshin_NamedElement, henshin_DescribedElement, henshin_TransformationSystem, DescribedElement, NamedElement, henshin_Rule, henshin_EPackage, henshin_Graph, henshin_TransformationUnit, TransformationUnit, henshin_Mapping, henshin_Parameter, henshin_Node, henshin_Edge, henshin_Formula, henshin_GraphElement, GraphElement, henshin_EClass, henshin_Attribute, henshin_EAttribute, henshin_EReference, henshin_ParameterMapping, henshin_IndependentUnit, henshin_SequentialUnit, henshin_ConditionalUnit, henshin_PriorityUnit, henshin_AmalgamationUnit, henshin_CountedUnit, henshin_NestedCondition, Formula, henshin_UnaryFormula, henshin_BinaryFormula, henshin_And, BinaryFormula, henshin_Or, henshin_Xor, henshin_Not, UnaryFormula},
    associations={attributeConditions11, rules0, imports1, instances2, transformationUnits4, lhs6, rhs8, mappings12, transformationSystem14, rule15, unit17, nodes18, edges19, formula21, origin23, image25, parameters49, type28, attributes30, graph31, incoming32, outgoing34, allEdges36, type38, node39, source41, target43, type45, graph47, parameterMappings50, subUnits52, subUnits54, if_56, then58, else_61, subUnits64, kernelRule66, multiRules68, lhsMappings71, rhsMappings74, subUnit77, conclusion79, mappings81, child84, right88, source91, target93, left86},
    generalizations={gen_henshin_TransformationSystem_DescribedElement, gen_henshin_TransformationSystem_NamedElement, gen_henshin_Rule_TransformationUnit, gen_henshin_AttributeCondition_DescribedElement, gen_henshin_AttributeCondition_NamedElement, gen_henshin_Parameter_DescribedElement, gen_henshin_Parameter_NamedElement, gen_henshin_Graph_NamedElement, gen_henshin_Node_NamedElement, gen_henshin_Node_GraphElement, gen_henshin_Edge_GraphElement, gen_henshin_TransformationUnit_DescribedElement, gen_henshin_TransformationUnit_NamedElement, gen_henshin_IndependentUnit_TransformationUnit, gen_henshin_SequentialUnit_TransformationUnit, gen_henshin_ConditionalUnit_TransformationUnit, gen_henshin_PriorityUnit_TransformationUnit, gen_henshin_AmalgamationUnit_TransformationUnit, gen_henshin_CountedUnit_TransformationUnit, gen_henshin_NestedCondition_Formula, gen_henshin_UnaryFormula_Formula, gen_henshin_BinaryFormula_Formula, gen_henshin_And_BinaryFormula, gen_henshin_Or_BinaryFormula, gen_henshin_Xor_BinaryFormula, gen_henshin_Not_UnaryFormula},
    metadata=None
)
