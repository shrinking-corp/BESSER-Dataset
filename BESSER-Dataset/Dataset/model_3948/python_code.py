...
class PathExp_Internal(State):
    ...
    def __init__(self, attr: int, State10: "PathExp_Transition" = None, State: "PathExp_PathExp" = None, State8: "PathExp_Transition" = None):
        self.attr = attr
...
class PathExp_Final(State):
    ...
    def __init__(self, bool_attr: bool, State10: "PathExp_Transition" = None, State: "PathExp_PathExp" = None, State8: "PathExp_Transition" = None):
