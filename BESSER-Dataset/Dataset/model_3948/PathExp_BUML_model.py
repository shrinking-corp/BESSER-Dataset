...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={PathExp, PathExp_Transition, PathExp_Initial, PathExp_Final, PathExp_Internal, PathExp_Element, PathExp_PathExp, Element, State, Transition, PathExp_State},
    associations={outgoing4, owner6, source7, target9, states0, transitions1, incoming2},
    generalizations={gen_PathExp_Transition_Element, gen_PathExp_Initial_State, gen_PathExp_Final_State, gen_PathExp_Internal_State, gen_PathExp_PathExp_Element},
    metadata=None
)
