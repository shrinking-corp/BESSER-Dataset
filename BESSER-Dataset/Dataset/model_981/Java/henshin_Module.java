...
public class henshin_Module extends NamedElement {
    ...
    private boolean nullValueMatching;
    ...
    public henshin_Module(
        boolean nullValueMatching        ArrayList<henshin_Module> henshin_modules    ) {
        this.nullValueMatching = nullValueMatching;
    ...
    public void setNullvaluematching(boolean nullValueMatching) {
        this.nullValueMatching = nullValueMatching;
    }
