...
Core_CompilationUnit = Class(name="Core_CompilationUnit")
...
Core_IField.attributes={Core_IField_constant, Core_IField_isTransient, Core_IField_isEnumConstant, Core_IField_isVolatile, Core_IField_typeSignature}
...
domain_model = DomainModel(
    name="Core",
    types={Core_IJavaProject, Core_IPackageFragmentRoot, IJavaElement, Core_IJavaElement, Core_PhysicalElement, Core_IJavaModel, PhysicalElement, Core_ISourceReference, Core_ISourceRange, Core_IMember, Core_IPackageFragment, Core_BinaryPackageFragmentRoot, IPackageFragmentRoot, Core_SourcePackageFragmentRoot, Core_IClassFile, Core_ICompilationUnit, Core_ITypeRoot, ISourceReference, ITypeRoot, Core_IType, Core_IImportDeclaration, Core_CompilationUnit, Core_Parameter, IMember, Core_IInitializer, Core_IField, Core_IMethod, Core_ITypeParameter, Modifiers},
    associations={javaProjects0, externalPackageFragmentRoots1, packageFragmentRoots3, externalPackageFragmentRoots6, requiredProjects10, type29, sourceRange32, javadocRange33, packageFragments12, packageFragmentRoot13, classFiles14, compilationUnits15, allType17, imports19, types21, primary25, ast27, parameters49, nameRange35, initializers38, fields40, methods42, types45, typeParameters47},
    generalizations={gen_Core_IJavaProject_IJavaElement, gen_Core_IJavaProject_PhysicalElement, gen_Core_IPackageFragmentRoot_IJavaElement, gen_Core_IPackageFragmentRoot_PhysicalElement, gen_Core_IJavaModel_PhysicalElement, gen_Core_IImportDeclaration_IJavaElement, gen_Core_IImportDeclaration_ISourceReference, gen_Core_IMember_IJavaElement, gen_Core_IMember_ISourceReference, gen_Core_BinaryPackageFragmentRoot_IPackageFragmentRoot, gen_Core_SourcePackageFragmentRoot_IPackageFragmentRoot, gen_Core_IPackageFragment_IJavaElement, gen_Core_IPackageFragment_PhysicalElement, gen_Core_ITypeRoot_IJavaElement, gen_Core_ITypeRoot_ISourceReference, gen_Core_ITypeRoot_PhysicalElement, gen_Core_ICompilationUnit_ITypeRoot, gen_Core_IClassFile_ITypeRoot, gen_Core_IMethod_IMember, gen_Core_IType_IMember, gen_Core_ITypeParameter_IJavaElement, gen_Core_ITypeParameter_ISourceReference, gen_Core_IInitializer_IMember, gen_Core_IField_IMember},
    metadata=None
)
