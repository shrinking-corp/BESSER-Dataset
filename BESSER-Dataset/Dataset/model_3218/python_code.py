...
class Core_IField(IMember):
    ...
    def __init__(self, isVolatile: str, isTransient: str, constant: str, isEnumConstant: str, typeSignature: str, Core_IField: "Core_IType" = None):
...
class Core_IMethod(IMember):
    ...
    def __init__(self, returnType: str, isConstructor: str, isMainMethod: str, exceptionTypes: str, Core_IMethod50: set["Core_Parameter"] = None, Core_IMethod: "Core_IType" = None):
...
class Core_IClassFile(ITypeRoot):
    ...
    def __init__(self, isClass: str, isInterface: str, Core_IClassFile30: "Core_IType" = None, Core_IClassFile: "Core_IPackageFragment" = None):
...
class Core_ISourceRange:
    ...
    def __init__(self, length: str, offset: str, Core_ISourceRange: "Core_ISourceReference" = None, Core_ISourceRange34: "Core_IMember" = None, Core_ISourceRange37: "Core_IMember" = None):
        self.length = length
        self.offset = offset
...
class Core_IPackageFragment(IJavaElement, PhysicalElement):
    ...
    def __init__(self, isDefaultPackage: str, IPackageFragment: "Core_IPackageFragmentRoot" = None, packageFragments: "Core_IPackageFragmentRoot" = None, Core_IPackageFragment: set["Core_IClassFile"] = None, Core_IPackageFragment16: set["Core_ICompilationUnit"] = None):
