...
def test_hyp_library_fiction_is_not_abstract():
    assert not inspect.isabstract(library_Fiction)


def test_hyp_library_fiction_constructor_exists():
    assert callable(library_Fiction.__init__)


def test_hyp_library_fiction_constructor_args():
...
def test_hyp_library_nonfiction_is_not_abstract():
    assert not inspect.isabstract(library_NonFiction)


def test_hyp_library_nonfiction_constructor_exists():
    assert callable(library_NonFiction.__init__)


def test_hyp_library_nonfiction_constructor_args():
...
def test_hyp_library_fiction_Name_setter(instance):
...
def test_hyp_library_nonfiction_Name_setter(instance):
    original = instance.Name
    instance.Name = original
    assert instance.Name == original
...
@given(instance=library_Book_strategy)
def test_hyp_library_book_genre_setter(instance):
