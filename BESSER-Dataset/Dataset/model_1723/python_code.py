...
class library_Fiction:
    ...
    def __init__(self, Name: str, library_Fiction: "library_Library" = None, library_Fiction9: set["library_Book"] = None):
        self.Name = Name
...
class library_NonFiction:
    ...
    def __init__(self, Name: str, library_NonFiction: set["library_Book"] = None, library_NonFiction5: "library_Library" = None):
        self.Name = Name
...
class library_Book:
    ...
    def __init__(self, genre: str, Name: str, library_Book: "library_NonFiction" = None, library_Book2: "library_Library" = None, library_Book10: "library_Fiction" = None):
        self.genre = genre
        self.Name = Name
