...
public class mypackage_Customer  {
    ...
    public mypackage_Customer(
        String emailAddress,        String phoneNumber,        String name,        String address,        LocalDate dateOfBirth    ) {
    ...
    public mypackage_Customer(
        String emailAddress,        String phoneNumber,        String name,        String address,        LocalDate dateOfBirth        ArrayList<account_Account> account_accounts    ) {
        this.emailAddress = emailAddress;
        this.phoneNumber = phoneNumber;
        this.name = name;
        this.address = address;
