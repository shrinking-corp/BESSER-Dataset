...
Menu.attributes={Menu_starter, Menu_specialCourse, Menu_mainCourse, Menu_desert}
...
Drinks.attributes={Drinks_spirits, Drinks_beer, Drinks_cocktail, Drinks_wine, Drinks_softDrink}
...
domain_model = DomainModel(
    name="d0e2156f_9061_40bd_b7ac_50a0bfe6506b",
    types={Input_Order_external, Alerted_to_Serve_drinks_external, Alerted_to_Serve_Food_external, Print_bill_external, Bill, Payment, Table, Order, Menu, Drinks, Discount, Input_Order_UseCase, Order_food_UseCase, Alerted_to_Prepare_food_UseCase, Alerted_to_Serve_drinks_UseCase, Alerted_to_Serve_Food_UseCase, Print_bill_UseCase, Alerted_to_Prepare_drinks_UseCase, Pay_for_food_UseCase, Grant_discount_UseCase, Input_payment_details_UseCase, Change_Order_UseCase, View_statistics_UseCase, Diner_Actor, Waiter_Actor, Kitchen_Staff_Actor, Bar_Staff_Actor, Management_Actor, _Component, Order_food_UseCase1, Pay_for_food_UseCase1, Input_payment_details_external, Alerted_to_Prepare_food_external, Alerted_to_Prepare_drinks_external, Grant_discount_external, View_statistics_external},
    associations={Order_Menu, Order_Drinks, Bill_Discount, Diner_Order_food, Diner_Pay_for_food, Waiter_Input_Order, Waiter_Alerted_to_Serve_drinks, Waiter_Alerted_to_Serve_Food, Bill_Payment, Bill_Table, Bill_Order, Waiter_Print_bill, Waiter_Input_payment_details, Kitchen_Staff_Alerted_to_Prepare_food, Bar_Staff_Alerted_to_Prepare_drinks, Management_Grant_discount, Management_View_statistics, Waiter_Input_Order2},
    generalizations={},
    metadata=None
)
