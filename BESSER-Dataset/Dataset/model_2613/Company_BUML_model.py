...
# Classes
Company_Person = Class(name="Company_Person", is_abstract=True)
Company_Project = Class(name="Company_Project", is_abstract=True)
Company_ServiceLine = Class(name="Company_ServiceLine")
Company_Company = Class(name="Company_Company")
Company_CompanyModel = Class(name="Company_CompanyModel")
Company_Unit = Class(name="Company_Unit")
Division = Class(name="Division")
Company_Employee = Class(name="Company_Employee")
Person = Class(name="Person")
Company_Client = Class(name="Company_Client")
Company_Address = Class(name="Company_Address")
Company_Division = Class(name="Company_Division", is_abstract=True)
Company_Category = Class(name="Company_Category")
Company_European = Class(name="Company_European")
Project = Class(name="Project")
Company_National = Class(name="Company_National")
Company_Topic = Class(name="Company_Topic")
...
Company_Person.attributes={Company_Person_firstname, Company_Person_lastname}
...
domain_model = DomainModel(
    name="Company",
    types={Company_Person, Company_Project, Company_ServiceLine, Company_Company, Company_CompanyModel, Company_Unit, Division, Company_Employee, Person, Company_Client, Company_Address, Company_Division, Company_Category, Company_European, Project, Company_National, Company_Topic, type},
    associations={assignedTo0, employed1, persons3, company16, categories18, topics21, address23, division26, projects5, address8, lines10, related12, topics14, category15},
    generalizations={gen_Company_Unit_Division, gen_Company_ServiceLine_Division, gen_Company_Employee_Person, gen_Company_Client_Person, gen_Company_European_Project, gen_Company_National_Project},
    metadata=None
)
