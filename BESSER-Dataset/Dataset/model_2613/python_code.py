...
class Company_Topic:
    ...
    def __init__(self, id: str, Company_Topic: "Company_CompanyModel" = None, Topic: "Company_Category" = None, topics: "Company_Category" = None):
        self.id = id
...
class Company_Category:
    ...
    def __init__(self, name: str, Company_Category20: "Company_CompanyModel" = None, Company_Category: "Company_Project" = None, category: set["Company_Topic"] = None, Category: "Company_Topic" = None):
        self.name = name
...
class Company_Division(ABC):
    ...
    def __init__(self, name: str, Company_Division28: "Company_CompanyModel" = None, Company_Division: "Company_Company" = None):
        self.name = name
...
class Company_Address:
    ...
    def __init__(self, city: str, completeAddress: str, Company_Address25: "Company_CompanyModel" = None, Company_Address: "Company_Company" = None):
        self.city = city
...
class Company_Company:
    ...
    def __init__(self, name: str, Company_Company: set["Company_Person"] = None, Company_Company17: "Company_CompanyModel" = None, Company_Company6: set["Company_Project"] = None, Company_Company9: "Company_Address" = None, Company_Company11: set["Company_Division"] = None):
        self.name = name
