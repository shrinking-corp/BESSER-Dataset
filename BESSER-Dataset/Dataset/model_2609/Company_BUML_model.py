...
Company_Person.attributes={Company_Person_lastname, Company_Person_firstname, Company_Person_position}
...
domain_model = DomainModel(
    name="Company",
    types={Company_Person, Company_Project, Company_ServiceLine, Company_Company, Company_Division, Company_Category, Company_European, Project, Company_National, Company_Topic, Company_CompanyModel, Company_Unit, Division, Company_Address, type},
    associations={assignedTo0, employed1, persons3, projects5, lines10, related12, topics14, category15, company16, categories18, topics21, address23, division26, address8},
