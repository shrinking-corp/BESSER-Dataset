...
R_A: BinaryAssociation = BinaryAssociation(
    name="R_A",
    ends={
        Property(name="aR8", type=A, multiplicity=Multiplicity(0, 9999)),
...
domain_model = DomainModel(
    name="_7NOXMMUeEeeWu_SLkciAbg",
    types={A1, B1, C1, Y, A, R, B, Z, C, C2, C3},
    associations={A_B, B_C, B_C2, A_B2, R_A},
    generalizations={},
    metadata=None
)
