...
def test_hyp_extendedfamilies_family_noOfChildren_setter(instance):
...
@given(instance=ExtendedFamilies_Family_strategy)
def test_hyp_extendedfamilies_family_singleParent_setter(instance):
...
def test_ExtendedFamilies_Family_lastName_value_roundtrip():
    instance = ExtendedFamilies_Family(lastName="sample_text", noOfChildren=7, singleParent=True)
...
def test_ExtendedFamilies_Family_singleParent_value_roundtrip():
    instance = ExtendedFamilies_Family(lastName="sample_text", noOfChildren=7, singleParent=True)
    assert instance.singleParent == True
    instance.singleParent = False
    assert instance.singleParent == False
...
def test_assoc_family1_link_reassign_clear():
    a = ExtendedFamilies_Person(firstName="sample_text")
    b1 = ExtendedFamilies_Family(lastName="sample_text", noOfChildren=7, singleParent=True)
    b2 = ExtendedFamilies_Family(lastName="sample_text_2", noOfChildren=13, singleParent=False)
...
ExtendedFamilies_Family_strategy = st.builds(ExtendedFamilies_Family, lastName=safe_text, noOfChildren=st.integers(), singleParent=st.booleans())
@given(instance=ExtendedFamilies_Family_strategy)
