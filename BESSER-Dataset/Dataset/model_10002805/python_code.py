...
class MyUseCase_UseCase:

    pass


class MyActor2_Actor:
...
class Account:
    ...
    def __init__(self, billingAddress: str, open: date, closed: date, isClosed: bool, customer11: "Customer" = None, cart16: "ShoppingCart" = None, payment0: set["Payment"] = None, order4: set["Order"] = None):
