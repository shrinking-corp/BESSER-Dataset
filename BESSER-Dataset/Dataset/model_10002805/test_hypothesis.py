...
def test_myusecase_usecase_is_not_abstract():
    assert not inspect.isabstract(MyUseCase_UseCase)


def test_myusecase_usecase_constructor_exists():
    assert callable(MyUseCase_UseCase.__init__)


def test_myusecase_usecase_constructor_args():
    sig = inspect.signature(MyUseCase_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_myactor2_actor_is_not_abstract():
    assert not inspect.isabstract(MyActor2_Actor)


def test_myactor2_actor_constructor_exists():
    assert callable(MyActor2_Actor.__init__)


def test_myactor2_actor_constructor_args():
