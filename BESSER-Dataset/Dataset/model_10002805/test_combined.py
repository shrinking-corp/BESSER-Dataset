...
def test_hyp_myusecase_usecase_is_not_abstract():
    assert not inspect.isabstract(MyUseCase_UseCase)


def test_hyp_myusecase_usecase_constructor_exists():
    assert callable(MyUseCase_UseCase.__init__)


def test_hyp_myusecase_usecase_constructor_args():
    sig = inspect.signature(MyUseCase_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myactor2_actor_is_not_abstract():
    assert not inspect.isabstract(MyActor2_Actor)


def test_hyp_myactor2_actor_constructor_exists():
    assert callable(MyActor2_Actor.__init__)


def test_hyp_myactor2_actor_constructor_args():
    sig = inspect.signature(MyActor2_Actor.__init__)
    params = list(sig.parameters.keys())
...
MyUseCase_UseCase_strategy = st.builds(
    MyUseCase_UseCase,
)
MyActor2_Actor_strategy = st.builds(
    MyActor2_Actor,
)
...
MyActor2_Actor_strategy = st.builds(MyActor2_Actor)
@given(instance=MyActor2_Actor_strategy)
@settings(max_examples=25)
def test_MyActor2_Actor_instantiation(instance):
    assert isinstance(instance, MyActor2_Actor)
...
MyUseCase_UseCase_strategy = st.builds(MyUseCase_UseCase)
@given(instance=MyUseCase_UseCase_strategy)
@settings(max_examples=25)
def test_MyUseCase_UseCase_instantiation(instance):
    assert isinstance(instance, MyUseCase_UseCase)
