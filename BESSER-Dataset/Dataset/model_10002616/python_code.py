...
class Management:
    ...
    def __init__(self, specialoffers: str, suggetions: str, property11: "Property" = None):
        self.specialoffers = specialoffers
        self.suggetions = suggetions
        self.property11 = property11
    ...
    @property
    def property11(self):
        return self.__property11
    @property11.setter
    def property11(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Management__property11", None)
        self.__property11 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "management10"):
                opp_val = getattr(old_value, "management10", None)
                if isinstance(opp_val, set):
                    opp_val.discard(self)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "management10"):
                opp_val = getattr(value, "management10", None)
                if opp_val is None:
                    setattr(value, "management10", set([self]))
...
class Payment:
    ...
    def __init__(self, pay_id: int, pay_mode: str, card_no: str, ex_date: str, pay_amount: str, reg_User12: set["Reg_User"] = None, property14: set["Property"] = None):
        self.pay_id = pay_id
        self.pay_mode = pay_mode
        self.card_no = card_no
        self.ex_date = ex_date
        self.pay_amount = pay_amount
        self.reg_User12 = reg_User12 if reg_User12 is not None else set()
        self.property14 = property14 if property14 is not None else set()
    ...
    @property
    def property14(self):
        return self.__property14
    @property14.setter
    def property14(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Payment__property14", None)
        self.__property14 = value if value is not None else set()
    ...
    @property
    def reg_User12(self):
        return self.__reg_User12
    @reg_User12.setter
    def reg_User12(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Payment__reg_User12", None)
        self.__reg_User12 = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "payment13"):
                    opp_val = getattr(item, "payment13", None)
                    
                    if opp_val == self:
                        setattr(item, "payment13", None)
...
class Advertiser:
    ...
    def __init__(self, advertiser_id: str, advertiesment_id: str):
...
class Reg_User:
    ...
    def __init__(self, username: str, password: str, Address: str, requirement8: set["Requirement"] = None, payment13: "Payment" = None):
    ...
    def payment13(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Reg_User__payment13", None)
        self.__payment13 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "reg_User12"):
                opp_val = getattr(old_value, "reg_User12", None)
                if isinstance(opp_val, set):
                    opp_val.discard(self)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "reg_User12"):
                opp_val = getattr(value, "reg_User12", None)
                if opp_val is None:
                    setattr(value, "reg_User12", set([self]))
                elif isinstance(opp_val, set):
                    opp_val.add(self)
...
class User:
    ...
    def __init__(self, email: str, location: str, request4: set["Request"] = None, administrator0: "Administrator" = None):
        self.email = email
...
class Property:
    ...
    def __init__(self, property_id: str, property_type: str, address: str, location: str, owner2: "Seller" = None, user6: "Buyer" = None, management10: set["Management"] = None, payment15: "Payment" = None):
        self.property_id = property_id
        ...
        self.owner2 = owner2
        self.user6 = user6
        self.management10 = management10 if management10 is not None else set()
    ...
    @property
    def management10(self):
        return self.__management10
    @management10.setter
    def management10(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Property__management10", None)
        self.__management10 = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "property11"):
                    opp_val = getattr(item, "property11", None)
                    
                    if opp_val == self:
                        setattr(item, "property11", None)
    ...
    def payment15(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Property__payment15", None)
        self.__payment15 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "property14"):
                opp_val = getattr(old_value, "property14", None)
                if isinstance(opp_val, set):
                    opp_val.discard(self)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "property14"):
                opp_val = getattr(value, "property14", None)
                if opp_val is None:
                    setattr(value, "property14", set([self]))
                elif isinstance(opp_val, set):
                    opp_val.add(self)
