...
Payment.attributes={Payment_pay_mode, Payment_pay_id, Payment_ex_date, Payment_card_no, Payment_pay_amount}
...
Request.attributes={Request_request_id, Request_request_details, Request_request_type, Request_requser_id}
...
Property_Management: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="management10", type=Management, multiplicity=Multiplicity(0, 9999)),
        Property(name="property11", type=Property_, multiplicity=Multiplicity(1, 1))
    }
)
Payment_Reg_User: BinaryAssociation = BinaryAssociation(
    name="Payment_Reg_User",
    ends={
        Property(name="reg_User12", type=Reg_User, multiplicity=Multiplicity(1, 9999)),
...
Payment_Property: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="property14", type=Property_, multiplicity=Multiplicity(0, 9999)),
...
domain_model = DomainModel(
    name="c761fe21_73a6_410d_92a9_c9810f6ef59f",
    types={Property_, User, Reg_User, Unreg_User, Advertiser, Buyer, Seller, Administrator, Payment, Requirement, Request, Management},
    associations={Property_Seller, User_Request, Property_Buyer, Reg_User_Requirement, Property_Management, Payment_Reg_User, Payment_Property, User_Administrator},
    generalizations={},
    metadata=None
)
