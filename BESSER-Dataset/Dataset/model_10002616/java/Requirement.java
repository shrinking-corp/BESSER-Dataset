...
public class Requirement  {
    ...
    public Requirement(
        String user_id,        String requirement_type,        String requirement_location,        String req_description    ) {
    ...
    public Requirement(
        String user_id,        String requirement_type,        String requirement_location,        String req_description        ArrayList<Reg_User> reg_users    ) {
        this.user_id = user_id;
        this.requirement_type = requirement_type;
        this.requirement_location = requirement_location;
        this.req_description = req_description;
