...
# Classes
gfsm_Transition = Class(name="gfsm_Transition")
gfsm_BooleanExpression = Class(name="gfsm_BooleanExpression", is_abstract=True)
gfsm_FSM = Class(name="gfsm_FSM")
IntExpression = Class(name="IntExpression")
gfsm_IntExpression = Class(name="gfsm_IntExpression", is_abstract=True)
gfsm_IntAdd = Class(name="gfsm_IntAdd")
IntBinaryExpression = Class(name="IntBinaryExpression")
gfsm_IntMult = Class(name="gfsm_IntMult")
gfsm_IntNeg = Class(name="gfsm_IntNeg")
gfsm_State = Class(name="gfsm_State")
gfsm_IntOperation = Class(name="gfsm_IntOperation", is_abstract=True)
gfsm_FinalState = Class(name="gfsm_FinalState")
State = Class(name="State")
gfsm_InitialState = Class(name="gfsm_InitialState")
gfsm_IntBinaryExpression = Class(name="gfsm_IntBinaryExpression", is_abstract=True)
gfsm_IntVarRef = Class(name="gfsm_IntVarRef")
gfsm_ConstExpr = Class(name="gfsm_ConstExpr")
gfsm_IntVarAssign = Class(name="gfsm_IntVarAssign")
IntOperation = Class(name="IntOperation")
gfsm_IntBlock = Class(name="gfsm_IntBlock")
gfsm_BooleanEqual = Class(name="gfsm_BooleanEqual")
BooleanCompareExpression = Class(name="BooleanCompareExpression")
gfsm_BooleanOr = Class(name="gfsm_BooleanOr")
BooleanBinaryExpression = Class(name="BooleanBinaryExpression")
gfsm_BooleanAnd = Class(name="gfsm_BooleanAnd")
gfsm_BooleanGreaterThan = Class(name="gfsm_BooleanGreaterThan")
gfsm_BooleanBinaryExpression = Class(name="gfsm_BooleanBinaryExpression", is_abstract=True)
BooleanExpression = Class(name="BooleanExpression")
gfsm_BooleanCompareExpression = Class(name="gfsm_BooleanCompareExpression", is_abstract=True)
...
outgoingtransitions11: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_", type=gfsm_Transition, multiplicity=Multiplicity(0, 9999))
    }
)
...
domain_model = DomainModel(
    name="gfsm",
    types={gfsm_Transition, gfsm_BooleanExpression, gfsm_FSM, IntExpression, gfsm_IntExpression, gfsm_IntAdd, IntBinaryExpression, gfsm_IntMult, gfsm_IntNeg, gfsm_State, gfsm_IntOperation, gfsm_FinalState, State, gfsm_InitialState, gfsm_IntBinaryExpression, gfsm_IntVarRef, gfsm_ConstExpr, gfsm_IntVarAssign, IntOperation, gfsm_IntBlock, gfsm_BooleanEqual, BooleanCompareExpression, gfsm_BooleanOr, BooleanBinaryExpression, gfsm_BooleanAnd, gfsm_BooleanGreaterThan, gfsm_BooleanBinaryExpression, BooleanExpression, gfsm_BooleanCompareExpression},
    associations={guard0, fsm1, expression123, expression224, from_2, to3, inExpression5, outExpression6, fsm9, outgoingtransitions11, incommingtransitions12, states14, transitions16, initialstate19, currentState20, expression27, expression29, operations31, boolExpression133, boolExpression235, expression138, expression240},
    generalizations={gen_gfsm_IntBinaryExpression_IntExpression, gen_gfsm_IntAdd_IntBinaryExpression, gen_gfsm_IntMult_IntBinaryExpression, gen_gfsm_IntNeg_IntExpression, gen_gfsm_FinalState_State, gen_gfsm_InitialState_State, gen_gfsm_IntVarRef_IntExpression, gen_gfsm_ConstExpr_IntExpression, gen_gfsm_IntVarAssign_IntOperation, gen_gfsm_IntBlock_IntOperation, gen_gfsm_BooleanEqual_BooleanCompareExpression, gen_gfsm_BooleanOr_BooleanBinaryExpression, gen_gfsm_BooleanAnd_BooleanBinaryExpression, gen_gfsm_BooleanGreaterThan_BooleanCompareExpression, gen_gfsm_BooleanBinaryExpression_BooleanExpression, gen_gfsm_BooleanCompareExpression_BooleanExpression},
    metadata=None
)
