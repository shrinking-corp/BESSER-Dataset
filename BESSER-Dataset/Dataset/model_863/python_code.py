...
class gfsm_State:
    ...
    def __init__(self, name: str, State: "gfsm_Transition" = None, State4: "gfsm_Transition" = None, gfsm_State: "gfsm_IntOperation" = None, gfsm_State7: "gfsm_IntOperation" = None, states: "gfsm_FSM" = None, from_: set["gfsm_Transition"] = None, to: set["gfsm_Transition"] = None, State15: "gfsm_FSM" = None, gfsm_State22: "gfsm_FSM" = None):
        self.name = name
        self.State = State
        self.State4 = State4
    ...
    def from_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_gfsm_State__from_", None)
...
class gfsm_FSM:
    ...
    def __init__(self, name: str, FSM: "gfsm_Transition" = None, FSM10: "gfsm_State" = None, fsm: set["gfsm_State"] = None, fsm17: set["gfsm_Transition"] = None, gfsm_FSM: "gfsm_InitialState" = None, gfsm_FSM21: "gfsm_State" = None):
        self.name = name
        self.FSM = FSM
        self.FSM10 = FSM10
