...
def test_hyp_gfsm_booleancompareexpression_is_not_abstract():
    assert not inspect.isabstract(gfsm_BooleanCompareExpression)


def test_hyp_gfsm_booleancompareexpression_constructor_exists():
    assert callable(gfsm_BooleanCompareExpression.__init__)


def test_hyp_gfsm_booleancompareexpression_constructor_args():
    sig = inspect.signature(gfsm_BooleanCompareExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_gfsm_booleanbinaryexpression_is_not_abstract():
    assert not inspect.isabstract(gfsm_BooleanBinaryExpression)


def test_hyp_gfsm_booleanbinaryexpression_constructor_exists():
    assert callable(gfsm_BooleanBinaryExpression.__init__)


def test_hyp_gfsm_booleanbinaryexpression_constructor_args():
    sig = inspect.signature(gfsm_BooleanBinaryExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_booleanbinaryexpression_is_not_abstract():
    assert not inspect.isabstract(BooleanBinaryExpression)


def test_hyp_booleanbinaryexpression_constructor_exists():
    assert callable(BooleanBinaryExpression.__init__)


def test_hyp_booleanbinaryexpression_constructor_args():
    sig = inspect.signature(BooleanBinaryExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_gfsm_booleanand_is_not_abstract():
    assert not inspect.isabstract(gfsm_BooleanAnd)


def test_hyp_gfsm_booleanand_constructor_exists():
    assert callable(gfsm_BooleanAnd.__init__)


def test_hyp_gfsm_booleanand_constructor_args():
    sig = inspect.signature(gfsm_BooleanAnd.__init__)
    params = list(sig.parameters.keys())



def test_hyp_gfsm_booleanor_is_not_abstract():
    assert not inspect.isabstract(gfsm_BooleanOr)


def test_hyp_gfsm_booleanor_constructor_exists():
    assert callable(gfsm_BooleanOr.__init__)


def test_hyp_gfsm_booleanor_constructor_args():
    sig = inspect.signature(gfsm_BooleanOr.__init__)
    params = list(sig.parameters.keys())



def test_hyp_booleancompareexpression_is_not_abstract():
    assert not inspect.isabstract(BooleanCompareExpression)


def test_hyp_booleancompareexpression_constructor_exists():
    assert callable(BooleanCompareExpression.__init__)


def test_hyp_booleancompareexpression_constructor_args():
    sig = inspect.signature(BooleanCompareExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_gfsm_booleangreaterthan_is_not_abstract():
    assert not inspect.isabstract(gfsm_BooleanGreaterThan)


def test_hyp_gfsm_booleangreaterthan_constructor_exists():
    assert callable(gfsm_BooleanGreaterThan.__init__)


def test_hyp_gfsm_booleangreaterthan_constructor_args():
    sig = inspect.signature(gfsm_BooleanGreaterThan.__init__)
    params = list(sig.parameters.keys())



def test_hyp_gfsm_booleanequal_is_not_abstract():
    assert not inspect.isabstract(gfsm_BooleanEqual)


def test_hyp_gfsm_booleanequal_constructor_exists():
    assert callable(gfsm_BooleanEqual.__init__)


def test_hyp_gfsm_booleanequal_constructor_args():
...
def test_hyp_gfsm_intblock_is_not_abstract():
    assert not inspect.isabstract(gfsm_IntBlock)


def test_hyp_gfsm_intblock_constructor_exists():
    assert callable(gfsm_IntBlock.__init__)


def test_hyp_gfsm_intblock_constructor_args():
    sig = inspect.signature(gfsm_IntBlock.__init__)
    params = list(sig.parameters.keys())



def test_hyp_gfsm_intvarassign_is_not_abstract():
    assert not inspect.isabstract(gfsm_IntVarAssign)


def test_hyp_gfsm_intvarassign_constructor_exists():
    assert callable(gfsm_IntVarAssign.__init__)


def test_hyp_gfsm_intvarassign_constructor_args():
...
def test_hyp_gfsm_intoperation_is_not_abstract():
    assert not inspect.isabstract(gfsm_IntOperation)


def test_hyp_gfsm_intoperation_constructor_exists():
    assert callable(gfsm_IntOperation.__init__)


def test_hyp_gfsm_intoperation_constructor_args():
...
def test_hyp_intbinaryexpression_is_not_abstract():
    assert not inspect.isabstract(IntBinaryExpression)


def test_hyp_intbinaryexpression_constructor_exists():
    assert callable(IntBinaryExpression.__init__)


def test_hyp_intbinaryexpression_constructor_args():
    sig = inspect.signature(IntBinaryExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_gfsm_intmult_is_not_abstract():
    assert not inspect.isabstract(gfsm_IntMult)


def test_hyp_gfsm_intmult_constructor_exists():
    assert callable(gfsm_IntMult.__init__)


def test_hyp_gfsm_intmult_constructor_args():
    sig = inspect.signature(gfsm_IntMult.__init__)
    params = list(sig.parameters.keys())



def test_hyp_gfsm_intadd_is_not_abstract():
    assert not inspect.isabstract(gfsm_IntAdd)


def test_hyp_gfsm_intadd_constructor_exists():
    assert callable(gfsm_IntAdd.__init__)


def test_hyp_gfsm_intadd_constructor_args():
    sig = inspect.signature(gfsm_IntAdd.__init__)
    params = list(sig.parameters.keys())



def test_hyp_gfsm_intexpression_is_not_abstract():
    assert not inspect.isabstract(gfsm_IntExpression)


def test_hyp_gfsm_intexpression_constructor_exists():
    assert callable(gfsm_IntExpression.__init__)


def test_hyp_gfsm_intexpression_constructor_args():
...
def test_hyp_gfsm_intvarref_is_not_abstract():
    assert not inspect.isabstract(gfsm_IntVarRef)


def test_hyp_gfsm_intvarref_constructor_exists():
    assert callable(gfsm_IntVarRef.__init__)


def test_hyp_gfsm_intvarref_constructor_args():
...
def test_hyp_gfsm_intbinaryexpression_is_not_abstract():
    assert not inspect.isabstract(gfsm_IntBinaryExpression)


def test_hyp_gfsm_intbinaryexpression_constructor_exists():
    assert callable(gfsm_IntBinaryExpression.__init__)


def test_hyp_gfsm_intbinaryexpression_constructor_args():
    sig = inspect.signature(gfsm_IntBinaryExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_gfsm_intneg_is_not_abstract():
    assert not inspect.isabstract(gfsm_IntNeg)


def test_hyp_gfsm_intneg_constructor_exists():
    assert callable(gfsm_IntNeg.__init__)


def test_hyp_gfsm_intneg_constructor_args():
    sig = inspect.signature(gfsm_IntNeg.__init__)
    params = list(sig.parameters.keys())



def test_hyp_gfsm_constexpr_is_not_abstract():
    assert not inspect.isabstract(gfsm_ConstExpr)


def test_hyp_gfsm_constexpr_constructor_exists():
    assert callable(gfsm_ConstExpr.__init__)


def test_hyp_gfsm_constexpr_constructor_args():
...
def test_hyp_gfsm_fsm_is_not_abstract():
    assert not inspect.isabstract(gfsm_FSM)


def test_hyp_gfsm_fsm_constructor_exists():
    assert callable(gfsm_FSM.__init__)


def test_hyp_gfsm_fsm_constructor_args():
...
def test_hyp_gfsm_booleanexpression_is_not_abstract():
    assert not inspect.isabstract(gfsm_BooleanExpression)


def test_hyp_gfsm_booleanexpression_constructor_exists():
    assert callable(gfsm_BooleanExpression.__init__)


def test_hyp_gfsm_booleanexpression_constructor_args():
...
def test_hyp_gfsm_intvarassign_name_setter(instance):
...
def test_hyp_gfsm_intvarref_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_gfsm_constexpr_value_setter(instance):
...
def test_hyp_gfsm_fsm_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
