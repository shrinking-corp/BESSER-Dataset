...
class workflow_WorkflowNode(WorkflowElement):
    ...
    def __init__(self, isStart: bool, isFinish: bool, WorkflowNode: "workflow_Workflow" = None, nodes: "workflow_Workflow" = None, node: set["workflow_OutputPort"] = None, node8: set["workflow_InputPort"] = None, WorkflowNode18: "workflow_InputPort" = None, WorkflowNode22: "workflow_OutputPort" = None):
