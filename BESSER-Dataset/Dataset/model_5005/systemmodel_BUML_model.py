...
# Classes
systemmodel_SMElement = Class(name="systemmodel_SMElement", is_abstract=True)
systemmodel_SystemModel = Class(name="systemmodel_SystemModel")
SMElement = Class(name="SMElement")
systemmodel_Block = Class(name="systemmodel_Block", is_abstract=True)
systemmodel_Signal = Class(name="systemmodel_Signal")
systemmodel_DataType = Class(name="systemmodel_DataType", is_abstract=True)
systemmodel_Inport = Class(name="systemmodel_Inport")
systemmodel_Outport = Class(name="systemmodel_Outport")
Port = Class(name="Port")
systemmodel_UnitDelay = Class(name="systemmodel_UnitDelay")
Block = Class(name="Block")
systemmodel_Sum = Class(name="systemmodel_Sum")
systemmodel_InputBlock = Class(name="systemmodel_InputBlock")
InterfaceBlock = Class(name="InterfaceBlock")
systemmodel_Saturation = Class(name="systemmodel_Saturation")
systemmodel_OutputBlock = Class(name="systemmodel_OutputBlock")
systemmodel_InterfaceBlock = Class(name="systemmodel_InterfaceBlock", is_abstract=True)
systemmodel_GainBlock = Class(name="systemmodel_GainBlock")
systemmodel_Port = Class(name="systemmodel_Port", is_abstract=True)
systemmodel_MatrixType = Class(name="systemmodel_MatrixType")
DataType = Class(name="DataType")
systemmodel_VectorType = Class(name="systemmodel_VectorType")
systemmodel_ScalarType = Class(name="systemmodel_ScalarType")
...
systemmodel_MatrixType.attributes={systemmodel_MatrixType_rows, systemmodel_MatrixType_columns}
...
domain_model = DomainModel(
    name="systemmodel",
    types={systemmodel_SMElement, systemmodel_SystemModel, SMElement, systemmodel_Block, systemmodel_Signal, systemmodel_DataType, systemmodel_Inport, systemmodel_Outport, Port, systemmodel_UnitDelay, Block, systemmodel_Sum, systemmodel_InputBlock, InterfaceBlock, systemmodel_Saturation, systemmodel_OutputBlock, systemmodel_InterfaceBlock, systemmodel_GainBlock, systemmodel_Port, systemmodel_MatrixType, DataType, systemmodel_VectorType, systemmodel_ScalarType},
    associations={blocks0, signals1, dataTypes3, inports5, outports6, type18, srcPort8, dstPort10, inSignal12, parentBlock13, outSignals14, parentBlock16},
    generalizations={gen_systemmodel_SystemModel_SMElement, gen_systemmodel_Block_SMElement, gen_systemmodel_Signal_SMElement, gen_systemmodel_Port_SMElement, gen_systemmodel_Inport_Port, gen_systemmodel_Outport_Port, gen_systemmodel_UnitDelay_Block, gen_systemmodel_Sum_Block, gen_systemmodel_InputBlock_InterfaceBlock, gen_systemmodel_Saturation_Block, gen_systemmodel_OutputBlock_InterfaceBlock, gen_systemmodel_InterfaceBlock_Block, gen_systemmodel_GainBlock_Block, gen_systemmodel_DataType_SMElement, gen_systemmodel_MatrixType_DataType, gen_systemmodel_VectorType_DataType, gen_systemmodel_ScalarType_DataType},
    metadata=None
)
