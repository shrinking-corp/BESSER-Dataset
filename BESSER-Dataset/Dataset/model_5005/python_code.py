...
class systemmodel_Block(SMElement):
    ...
    def __init__(self, sequenceNumber: int, systemmodel_Block: "systemmodel_SystemModel" = None, parentBlock: set["systemmodel_Inport"] = None, parentBlock7: set["systemmodel_Outport"] = None, Block: "systemmodel_Inport" = None, Block17: "systemmodel_Outport" = None):
