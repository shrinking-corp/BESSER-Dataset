...
class miniJava_TypeRef:
    ...
    def compare(self, miniJava_other):
...
class miniJava_OutputStream:
    ...
    def miniJava_OutputStream(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "miniJava_State169"):
                opp_val = getattr(old_value, "miniJava_State169", None)
                if opp_val == self:
                    setattr(old_value, "miniJava_State169", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "miniJava_State169"):
                opp_val = getattr(value, "miniJava_State169", None)
                setattr(value, "miniJava_State169", self)
...
class miniJava_ArrayInstance:
    ...
    def __init__(self, size: str, miniJava_ArrayInstance: "miniJava_State" = None, miniJava_ArrayInstance199: set["miniJava_Value"] = None, miniJava_ArrayInstance204: "miniJava_ArrayRefValue" = None):
        self.size = size
        self.miniJava_ArrayInstance = miniJava_ArrayInstance
        self.miniJava_ArrayInstance199 = miniJava_ArrayInstance199 if miniJava_ArrayInstance199 is not None else set()
        self.miniJava_ArrayInstance204 = miniJava_ArrayInstance204
    ...
    def miniJava_ArrayInstance204(self, value):
        ...
        self.__miniJava_ArrayInstance204 = value
    ...
    def miniJava_ArrayInstance(self, value):
        ...
        if value is not None:
            if hasattr(value, "miniJava_State171"):
                ...
                if opp_val is None:
                    setattr(value, "miniJava_State171", set([self]))
                elif isinstance(opp_val, set):
                    opp_val.add(self)

    @property
    def miniJava_ArrayInstance199(self):
        return self.__miniJava_ArrayInstance199

    @miniJava_ArrayInstance199.setter
    def miniJava_ArrayInstance199(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_miniJava_ArrayInstance__miniJava_ArrayInstance199", None)
        self.__miniJava_ArrayInstance199 = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "miniJava_Value200"):
                    opp_val = getattr(item, "miniJava_Value200", None)
                    
                    if opp_val == self:
                        setattr(item, "miniJava_Value200", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "miniJava_Value200"):
                    ...
                    setattr(item, "miniJava_Value200", self)
...
class miniJava_Frame:
    ...
    def __init__(self, miniJava_Frame: "miniJava_State" = None, miniJava_Frame173: "miniJava_Call" = None, miniJava_Frame175: "miniJava_ObjectInstance" = None, Frame: "miniJava_Frame" = None, parentFrame: "miniJava_Frame" = None, Frame181: "miniJava_Frame" = None, childFrame: "miniJava_Frame" = None, miniJava_Frame183: "miniJava_Context" = None, miniJava_Frame186: "miniJava_Value" = None):
        self.miniJava_Frame = miniJava_Frame
        self.miniJava_Frame173 = miniJava_Frame173
        self.miniJava_Frame175 = miniJava_Frame175
        self.Frame = Frame
        self.parentFrame = parentFrame
        self.Frame181 = Frame181
        self.childFrame = childFrame
        self.miniJava_Frame183 = miniJava_Frame183
        self.miniJava_Frame186 = miniJava_Frame186
        
        pass
    @property
    def miniJava_Frame183(self):
        return self.__miniJava_Frame183

    @miniJava_Frame183.setter
    def miniJava_Frame183(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_miniJava_Frame__miniJava_Frame183", None)
        self.__miniJava_Frame183 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "miniJava_Context184"):
                opp_val = getattr(old_value, "miniJava_Context184", None)
                if opp_val == self:
                    setattr(old_value, "miniJava_Context184", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "miniJava_Context184"):
                opp_val = getattr(value, "miniJava_Context184", None)
                setattr(value, "miniJava_Context184", self)

    @property
    def miniJava_Frame173(self):
        return self.__miniJava_Frame173

    @miniJava_Frame173.setter
    def miniJava_Frame173(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_miniJava_Frame__miniJava_Frame173", None)
        self.__miniJava_Frame173 = value
    ...
    def miniJava_Frame175(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "miniJava_ObjectInstance176"):
                opp_val = getattr(old_value, "miniJava_ObjectInstance176", None)
                if opp_val == self:
                    setattr(old_value, "miniJava_ObjectInstance176", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "miniJava_ObjectInstance176"):
                opp_val = getattr(value, "miniJava_ObjectInstance176", None)
                setattr(value, "miniJava_ObjectInstance176", self)

    @property
    def Frame181(self):
        return self.__Frame181

    @Frame181.setter
    def Frame181(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_miniJava_Frame__Frame181", None)
        self.__Frame181 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "childFrame"):
                opp_val = getattr(old_value, "childFrame", None)
                if opp_val == self:
                    setattr(old_value, "childFrame", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "childFrame"):
                opp_val = getattr(value, "childFrame", None)
                setattr(value, "childFrame", self)

    @property
    def childFrame(self):
        return self.__childFrame

    @childFrame.setter
    def childFrame(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_miniJava_Frame__childFrame", None)
        self.__childFrame = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "Frame181"):
                opp_val = getattr(old_value, "Frame181", None)
                if opp_val == self:
                    setattr(old_value, "Frame181", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "Frame181"):
                opp_val = getattr(value, "Frame181", None)
                setattr(value, "Frame181", self)
    ...
    def Frame(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_miniJava_Frame__Frame", None)
        self.__Frame = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "parentFrame"):
                opp_val = getattr(old_value, "parentFrame", None)
                if opp_val == self:
                    setattr(old_value, "parentFrame", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "parentFrame"):
                opp_val = getattr(value, "parentFrame", None)
                setattr(value, "parentFrame", self)
    ...
    def miniJava_Frame(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "miniJava_State165"):
                opp_val = getattr(old_value, "miniJava_State165", None)
                if opp_val == self:
                    setattr(old_value, "miniJava_State165", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "miniJava_State165"):
                opp_val = getattr(value, "miniJava_State165", None)
                setattr(value, "miniJava_State165", self)

    @property
    def miniJava_Frame186(self):
        return self.__miniJava_Frame186

    @miniJava_Frame186.setter
    def miniJava_Frame186(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_miniJava_Frame__miniJava_Frame186", None)
        self.__miniJava_Frame186 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "miniJava_Value187"):
                opp_val = getattr(old_value, "miniJava_Value187", None)
                if opp_val == self:
                    setattr(old_value, "miniJava_Value187", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "miniJava_Value187"):
                opp_val = getattr(value, "miniJava_Value187", None)
                setattr(value, "miniJava_Value187", self)
    ...
    def parentFrame(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_miniJava_Frame__parentFrame", None)
        self.__parentFrame = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "Frame"):
                opp_val = getattr(old_value, "Frame", None)
                if opp_val == self:
                    setattr(old_value, "Frame", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "Frame"):
                opp_val = getattr(value, "Frame", None)
                setattr(value, "Frame", self)

    def findCurrentFrame(self) :
        # TODO: Implement findCurrentFrame method
        pass

    def findCurrentContext(self) :
...
class miniJava_ObjectRefValue(Value):
    ...
    def miniJava_ObjectRefValue(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "miniJava_ObjectInstance202"):
                opp_val = getattr(old_value, "miniJava_ObjectInstance202", None)
                if opp_val == self:
                    setattr(old_value, "miniJava_ObjectInstance202", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "miniJava_ObjectInstance202"):
                opp_val = getattr(value, "miniJava_ObjectInstance202", None)
                setattr(value, "miniJava_ObjectInstance202", self)
...
class miniJava_Value:
    ...
    def __init__(self, miniJava_Value: "miniJava_SymbolBinding" = None, miniJava_Value163: "miniJava_FieldBinding" = None, miniJava_Value187: "miniJava_Frame" = None, miniJava_Value200: "miniJava_ArrayInstance" = None):
        self.miniJava_Value = miniJava_Value
        self.miniJava_Value163 = miniJava_Value163
        self.miniJava_Value187 = miniJava_Value187
        self.miniJava_Value200 = miniJava_Value200
    ...
    def miniJava_Value(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "miniJava_SymbolBinding155"):
                opp_val = getattr(old_value, "miniJava_SymbolBinding155", None)
                if opp_val == self:
                    setattr(old_value, "miniJava_SymbolBinding155", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "miniJava_SymbolBinding155"):
                opp_val = getattr(value, "miniJava_SymbolBinding155", None)
                setattr(value, "miniJava_SymbolBinding155", self)

    @property
    def miniJava_Value200(self):
        return self.__miniJava_Value200

    @miniJava_Value200.setter
    def miniJava_Value200(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_miniJava_Value__miniJava_Value200", None)
        self.__miniJava_Value200 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "miniJava_ArrayInstance199"):
                opp_val = getattr(old_value, "miniJava_ArrayInstance199", None)
                if isinstance(opp_val, set):
                    opp_val.discard(self)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "miniJava_ArrayInstance199"):
                opp_val = getattr(value, "miniJava_ArrayInstance199", None)
                if opp_val is None:
                    setattr(value, "miniJava_ArrayInstance199", set([self]))
                elif isinstance(opp_val, set):
                    opp_val.add(self)

    @property
    def miniJava_Value187(self):
        return self.__miniJava_Value187

    @miniJava_Value187.setter
    def miniJava_Value187(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_miniJava_Value__miniJava_Value187", None)
        self.__miniJava_Value187 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "miniJava_Frame186"):
                opp_val = getattr(old_value, "miniJava_Frame186", None)
                if opp_val == self:
                    setattr(old_value, "miniJava_Frame186", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "miniJava_Frame186"):
                opp_val = getattr(value, "miniJava_Frame186", None)
                setattr(value, "miniJava_Frame186", self)

    @property
    def miniJava_Value163(self):
        return self.__miniJava_Value163

    @miniJava_Value163.setter
    def miniJava_Value163(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_miniJava_Value__miniJava_Value163", None)
        self.__miniJava_Value163 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "miniJava_FieldBinding162"):
                opp_val = getattr(old_value, "miniJava_FieldBinding162", None)
                if opp_val == self:
                    setattr(old_value, "miniJava_FieldBinding162", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "miniJava_FieldBinding162"):
                opp_val = getattr(value, "miniJava_FieldBinding162", None)
                setattr(value, "miniJava_FieldBinding162", self)
...
class miniJava_Context:
    ...
    def __init__(self, miniJava_Context: set["miniJava_SymbolBinding"] = None, Context: "miniJava_Context" = None, childContext: "miniJava_Context" = None, Context153: "miniJava_Context" = None, parentContext: "miniJava_Context" = None, miniJava_Context184: "miniJava_Frame" = None):
        self.miniJava_Context = miniJava_Context if miniJava_Context is not None else set()
        self.Context = Context
        self.childContext = childContext
        self.Context153 = Context153
        self.parentContext = parentContext
        self.miniJava_Context184 = miniJava_Context184
        
        pass
    @property
    def parentContext(self):
        return self.__parentContext

    @parentContext.setter
    def parentContext(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_miniJava_Context__parentContext", None)
        self.__parentContext = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "Context153"):
                opp_val = getattr(old_value, "Context153", None)
                if opp_val == self:
                    setattr(old_value, "Context153", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "Context153"):
                opp_val = getattr(value, "Context153", None)
                setattr(value, "Context153", self)
    ...
    @property
    def Context153(self):
        return self.__Context153

    @Context153.setter
    def Context153(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_miniJava_Context__Context153", None)
        self.__Context153 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "parentContext"):
                opp_val = getattr(old_value, "parentContext", None)
                if opp_val == self:
                    setattr(old_value, "parentContext", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "parentContext"):
                opp_val = getattr(value, "parentContext", None)
                setattr(value, "parentContext", self)

    @property
    def miniJava_Context184(self):
        return self.__miniJava_Context184

    @miniJava_Context184.setter
    def miniJava_Context184(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_miniJava_Context__miniJava_Context184", None)
        self.__miniJava_Context184 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "miniJava_Frame183"):
                opp_val = getattr(old_value, "miniJava_Frame183", None)
                if opp_val == self:
                    setattr(old_value, "miniJava_Frame183", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "miniJava_Frame183"):
                opp_val = getattr(value, "miniJava_Frame183", None)
                setattr(value, "miniJava_Frame183", self)

    @property
    def childContext(self):
        return self.__childContext

    @childContext.setter
    def childContext(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_miniJava_Context__childContext", None)
        self.__childContext = value
    ...
    def Context(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_miniJava_Context__Context", None)
        self.__Context = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "childContext"):
                opp_val = getattr(old_value, "childContext", None)
                if opp_val == self:
                    setattr(old_value, "childContext", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "childContext"):
                opp_val = getattr(value, "childContext", None)
                setattr(value, "childContext", self)

    def findBinding(self, miniJava_symbol) :
...
class miniJava_BoolConstant(Expression):
    ...
    def evaluateExpression(self, miniJava_state) :
...
class miniJava_NewObject(Expression):
    ...
    def __init__(self, miniJava_NewObject: "miniJava_Class" = None, miniJava_NewObject140: set["miniJava_Expression"] = None, miniJava_NewObject189: "miniJava_NewCall" = None):
        ...
        self.miniJava_NewObject189 = miniJava_NewObject189
        
        pass
    @property
    def miniJava_NewObject189(self):
        return self.__miniJava_NewObject189

    @miniJava_NewObject189.setter
    def miniJava_NewObject189(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_miniJava_NewObject__miniJava_NewObject189", None)
        self.__miniJava_NewObject189 = value
...
class miniJava_MethodCall(Expression):
    ...
    def __init__(self, miniJava_MethodCall: "miniJava_Expression" = None, miniJava_MethodCall132: "miniJava_Method" = None, miniJava_MethodCall135: set["miniJava_Expression"] = None, miniJava_MethodCall191: "miniJava_MethodCall2" = None):
        ...
        self.miniJava_MethodCall191 = miniJava_MethodCall191
    ...
    @property
    def miniJava_MethodCall191(self):
        return self.__miniJava_MethodCall191

    @miniJava_MethodCall191.setter
    def miniJava_MethodCall191(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_miniJava_MethodCall__miniJava_MethodCall191", None)
        self.__miniJava_MethodCall191 = value
...
class miniJava_SuperiorOrEqual(Expression):
    ...
    def __init__(self, miniJava_SuperiorOrEqual76: "miniJava_Expression" = None, miniJava_SuperiorOrEqual: "miniJava_Expression" = None):
...
class miniJava_Statement:
    ...
    def evaluateStatement(self, miniJava_state):
...
class miniJava_Assignment(Statement):
    ...
    def __init__(self, miniJava_Assignment: "miniJava_ForStatement" = None, miniJava_Assignment48: "miniJava_Assignee" = None, miniJava_Assignment50: "miniJava_Expression" = None, miniJava_Assignment40: "miniJava_ForStatement" = None):
...
class miniJava_Expression(Assignee, Statement):
    ...
    def __init__(self, miniJava_Expression: "miniJava_Field" = None, miniJava_Expression18: "miniJava_PrintStatement" = None, miniJava_Expression20: "miniJava_Return" = None, miniJava_Expression22: "miniJava_IfStatement" = None, miniJava_Expression30: "miniJava_WhileStatement" = None, miniJava_Expression51: "miniJava_Assignment" = None, miniJava_Expression37: "miniJava_ForStatement" = None, miniJava_Expression54: "miniJava_Or" = None, miniJava_Expression57: "miniJava_Or" = None, miniJava_Expression59: "miniJava_And" = None, miniJava_Expression62: "miniJava_And" = None, miniJava_Expression64: "miniJava_Equality" = None, miniJava_Expression67: "miniJava_Equality" = None, miniJava_Expression69: "miniJava_Inequality" = None, miniJava_Expression72: "miniJava_Inequality" = None, miniJava_Expression77: "miniJava_SuperiorOrEqual" = None, miniJava_Expression79: "miniJava_InferiorOrEqual" = None, miniJava_Expression82: "miniJava_InferiorOrEqual" = None, miniJava_Expression84: "miniJava_Superior" = None, miniJava_Expression87: "miniJava_Superior" = None, miniJava_Expression89: "miniJava_Inferior" = None, miniJava_Expression92: "miniJava_Inferior" = None, miniJava_Expression94: "miniJava_Plus" = None, miniJava_Expression97: "miniJava_Plus" = None, miniJava_Expression99: "miniJava_Minus" = None, miniJava_Expression74: "miniJava_SuperiorOrEqual" = None, miniJava_Expression104: "miniJava_Multiplication" = None, miniJava_Expression107: "miniJava_Multiplication" = None, miniJava_Expression109: "miniJava_Division" = None, miniJava_Expression112: "miniJava_Division" = None, miniJava_Expression114: "miniJava_ArrayAccess" = None, miniJava_Expression117: "miniJava_ArrayAccess" = None, miniJava_Expression119: "miniJava_ArrayLength" = None, miniJava_Expression121: "miniJava_Not" = None, miniJava_Expression123: "miniJava_Neg" = None, miniJava_Expression102: "miniJava_Minus" = None, miniJava_Expression130: "miniJava_MethodCall" = None, miniJava_Expression136: "miniJava_MethodCall" = None, miniJava_Expression141: "miniJava_NewObject" = None, miniJava_Expression125: "miniJava_FieldAccess" = None, miniJava_Expression146: "miniJava_NewArray" = None):
...
class miniJava_Block(Statement):
    ...
    def __init__(self, miniJava_Block: "miniJava_Method" = None, miniJava_Block16: set["miniJava_Statement"] = None, miniJava_Block25: "miniJava_IfStatement" = None, miniJava_Block28: "miniJava_IfStatement" = None, miniJava_Block33: "miniJava_WhileStatement" = None, miniJava_Block43: "miniJava_ForStatement" = None):
    ...
    def evaluateStatementKeepContext(self, miniJava_state):
...
class miniJava_Method(Member):
    ...
    def call(self, miniJava_state):
        # TODO: Implement call method
        pass

    def findOverride(self, miniJava_c) :
...
class miniJava_Class(TypeDeclaration):
    ...
    def __init__(self, abstract: bool, miniJava_Class: "miniJava_Class" = None, miniJava_Class9: "miniJava_Class" = None, miniJava_Class138: "miniJava_NewObject" = None, miniJava_Class197: "miniJava_ObjectInstance" = None):
        self.abstract = abstract
        self.miniJava_Class = miniJava_Class
        self.miniJava_Class9 = miniJava_Class9
        self.miniJava_Class138 = miniJava_Class138
        self.miniJava_Class197 = miniJava_Class197
    ...
    @property
    def miniJava_Class197(self):
        return self.__miniJava_Class197

    @miniJava_Class197.setter
    def miniJava_Class197(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_miniJava_Class__miniJava_Class197", None)
        self.__miniJava_Class197 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "miniJava_ObjectInstance196"):
                opp_val = getattr(old_value, "miniJava_ObjectInstance196", None)
                if opp_val == self:
                    setattr(old_value, "miniJava_ObjectInstance196", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "miniJava_ObjectInstance196"):
                opp_val = getattr(value, "miniJava_ObjectInstance196", None)
                setattr(value, "miniJava_ObjectInstance196", self)
...
class miniJava_State:
    ...
    def __init__(self, miniJava_State: "miniJava_Program" = None, miniJava_State165: "miniJava_Frame" = None, miniJava_State167: set["miniJava_ObjectInstance"] = None, miniJava_State169: "miniJava_OutputStream" = None, miniJava_State171: set["miniJava_ArrayInstance"] = None):
        self.miniJava_State = miniJava_State
        self.miniJava_State165 = miniJava_State165
        self.miniJava_State167 = miniJava_State167 if miniJava_State167 is not None else set()
        self.miniJava_State169 = miniJava_State169
        self.miniJava_State171 = miniJava_State171 if miniJava_State171 is not None else set()
        
        pass
    @property
    def miniJava_State165(self):
        return self.__miniJava_State165

    @miniJava_State165.setter
    def miniJava_State165(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_miniJava_State__miniJava_State165", None)
        self.__miniJava_State165 = value
    ...
    def miniJava_State169(self, value):
        ...
        self.__miniJava_State169 = value
    ...
    def miniJava_State167(self, value):
        ...
        self.__miniJava_State167 = value if value is not None else set()
    ...
    def miniJava_State171(self, value):
        ...
        self.__miniJava_State171 = value if value is not None else set()
    ...
    def println(self, miniJava_string):
        # TODO: Implement println method
        pass

    def pushNewFrame(self, miniJava_c, miniJava_receiver, miniJava_newContext):
...
class miniJava_Program:
    ...
    def initialize(self, miniJava_args):
