...
# Classes
miniJava_Program = Class(name="miniJava_Program")
miniJava_Import = Class(name="miniJava_Import")
miniJava_TypeDeclaration = Class(name="miniJava_TypeDeclaration")
miniJava_State = Class(name="miniJava_State")
NamedElement = Class(name="NamedElement")
miniJava_Interface = Class(name="miniJava_Interface")
miniJava_Member = Class(name="miniJava_Member")
miniJava_Class = Class(name="miniJava_Class")
TypeDeclaration = Class(name="TypeDeclaration")
TypedDeclaration = Class(name="TypedDeclaration")
miniJava_Method = Class(name="miniJava_Method")
Member = Class(name="Member")
miniJava_Parameter = Class(name="miniJava_Parameter")
miniJava_Block = Class(name="miniJava_Block")
Symbol = Class(name="Symbol")
miniJava_Field = Class(name="miniJava_Field")
miniJava_Expression = Class(name="miniJava_Expression")
Statement = Class(name="Statement")
miniJava_Statement = Class(name="miniJava_Statement")
miniJava_PrintStatement = Class(name="miniJava_PrintStatement")
miniJava_Return = Class(name="miniJava_Return")
miniJava_IfStatement = Class(name="miniJava_IfStatement")
miniJava_WhileStatement = Class(name="miniJava_WhileStatement")
miniJava_ForStatement = Class(name="miniJava_ForStatement")
miniJava_Assignment = Class(name="miniJava_Assignment")
miniJava_TypeRef = Class(name="miniJava_TypeRef")
miniJava_SingleTypeRef = Class(name="miniJava_SingleTypeRef")
TypeRef = Class(name="TypeRef")
miniJava_ClassRef = Class(name="miniJava_ClassRef")
SingleTypeRef = Class(name="SingleTypeRef")
miniJava_NamedElement = Class(name="miniJava_NamedElement")
miniJava_TypedDeclaration = Class(name="miniJava_TypedDeclaration")
miniJava_Symbol = Class(name="miniJava_Symbol")
miniJava_VariableDeclaration = Class(name="miniJava_VariableDeclaration")
Assignee = Class(name="Assignee")
miniJava_Assignee = Class(name="miniJava_Assignee")
miniJava_BooleanTypeRef = Class(name="miniJava_BooleanTypeRef")
miniJava_StringTypeRef = Class(name="miniJava_StringTypeRef")
miniJava_VoidTypeRef = Class(name="miniJava_VoidTypeRef")
miniJava_Or = Class(name="miniJava_Or")
Expression = Class(name="Expression")
miniJava_And = Class(name="miniJava_And")
miniJava_Equality = Class(name="miniJava_Equality")
miniJava_Inequality = Class(name="miniJava_Inequality")
miniJava_ArrayTypeRef = Class(name="miniJava_ArrayTypeRef")
miniJava_SuperiorOrEqual = Class(name="miniJava_SuperiorOrEqual")
miniJava_IntegerTypeRef = Class(name="miniJava_IntegerTypeRef")
miniJava_InferiorOrEqual = Class(name="miniJava_InferiorOrEqual")
miniJava_Superior = Class(name="miniJava_Superior")
miniJava_Inferior = Class(name="miniJava_Inferior")
miniJava_Plus = Class(name="miniJava_Plus")
miniJava_Minus = Class(name="miniJava_Minus")
miniJava_Division = Class(name="miniJava_Division")
miniJava_ArrayAccess = Class(name="miniJava_ArrayAccess")
miniJava_ArrayLength = Class(name="miniJava_ArrayLength")
miniJava_Not = Class(name="miniJava_Not")
miniJava_Neg = Class(name="miniJava_Neg")
miniJava_FieldAccess = Class(name="miniJava_FieldAccess")
miniJava_Multiplication = Class(name="miniJava_Multiplication")
miniJava_MethodCall = Class(name="miniJava_MethodCall")
miniJava_StringConstant = Class(name="miniJava_StringConstant")
miniJava_IntConstant = Class(name="miniJava_IntConstant")
miniJava_BoolConstant = Class(name="miniJava_BoolConstant")
miniJava_This = Class(name="miniJava_This")
miniJava_Super = Class(name="miniJava_Super")
miniJava_Null = Class(name="miniJava_Null")
miniJava_NewObject = Class(name="miniJava_NewObject")
miniJava_NewArray = Class(name="miniJava_NewArray")
miniJava_Context = Class(name="miniJava_Context")
miniJava_SymbolBinding = Class(name="miniJava_SymbolBinding")
miniJava_Value = Class(name="miniJava_Value")
miniJava_IntegerValue = Class(name="miniJava_IntegerValue")
Value = Class(name="Value")
miniJava_FieldBinding = Class(name="miniJava_FieldBinding")
miniJava_StringValue = Class(name="miniJava_StringValue")
miniJava_BooleanValue = Class(name="miniJava_BooleanValue")
miniJava_SymbolRef = Class(name="miniJava_SymbolRef")
miniJava_Frame = Class(name="miniJava_Frame")
miniJava_ObjectInstance = Class(name="miniJava_ObjectInstance")
miniJava_ArrayInstance = Class(name="miniJava_ArrayInstance")
miniJava_Call = Class(name="miniJava_Call")
miniJava_NullValue = Class(name="miniJava_NullValue")
miniJava_OutputStream = Class(name="miniJava_OutputStream")
miniJava_MethodCall2 = Class(name="miniJava_MethodCall2")
miniJava_ObjectRefValue = Class(name="miniJava_ObjectRefValue")
miniJava_ArrayRefValue = Class(name="miniJava_ArrayRefValue")
miniJava_NewCall = Class(name="miniJava_NewCall")
...
miniJava_Program_m_initialize: Method = Method(name="initialize", parameters={Parameter(name='miniJava_args', type=StringType)})
...
miniJava_Program.methods={miniJava_Program_m_main, miniJava_Program_m_execute, miniJava_Program_m_initialize}
...
miniJava_State_m_println: Method = Method(name="println", parameters={Parameter(name='miniJava_string', type=StringType)})
...
miniJava_State_m_pushNewFrame: Method = Method(name="pushNewFrame", parameters={Parameter(name='miniJava_newContext', type=StringType), Parameter(name='miniJava_c', type=StringType), Parameter(name='miniJava_receiver', type=StringType)})
miniJava_State_m_popCurrentFrame: Method = Method(name="popCurrentFrame", parameters={})
miniJava_State.methods={miniJava_State_m_findCurrentContext, miniJava_State_m_popCurrentContext, miniJava_State_m_pushNewFrame, miniJava_State_m_println, miniJava_State_m_pushNewContext, miniJava_State_m_popCurrentFrame, miniJava_State_m_findCurrentFrame}
...
miniJava_Method_m_call: Method = Method(name="call", parameters={Parameter(name='miniJava_state', type=StringType)})
miniJava_Method_m_findOverride: Method = Method(name="findOverride", parameters={Parameter(name='miniJava_c', type=StringType)}, type=StringType)
...
miniJava_Parameter_m_compare: Method = Method(name="compare", parameters={Parameter(name='miniJava_other', type=StringType)})
miniJava_Parameter.methods={miniJava_Parameter_m_compare}

# miniJava_Block class attributes and methods
miniJava_Block_m_evaluateStatementKeepContext: Method = Method(name="evaluateStatementKeepContext", parameters={Parameter(name='miniJava_state', type=StringType)})
miniJava_Block_m_evaluateStatement: Method = Method(name="evaluateStatement", parameters={Parameter(name='miniJava_state', type=StringType)})
miniJava_Block.methods={miniJava_Block_m_evaluateStatement, miniJava_Block_m_evaluateStatementKeepContext}
...
miniJava_Expression_m_evaluateStatement: Method = Method(name="evaluateStatement", parameters={Parameter(name='miniJava_state', type=StringType)})
miniJava_Expression_m_evaluateExpression: Method = Method(name="evaluateExpression", parameters={Parameter(name='miniJava_state', type=StringType)}, type=StringType)
...
miniJava_Statement_m_evaluateStatement: Method = Method(name="evaluateStatement", parameters={Parameter(name='miniJava_state', type=StringType)})
miniJava_Statement.methods={miniJava_Statement_m_evaluateStatement}

# miniJava_PrintStatement class attributes and methods
miniJava_PrintStatement_m_evaluateStatement: Method = Method(name="evaluateStatement", parameters={Parameter(name='miniJava_state', type=StringType)})
miniJava_PrintStatement.methods={miniJava_PrintStatement_m_evaluateStatement}

# miniJava_Return class attributes and methods
miniJava_Return_m_evaluateStatement: Method = Method(name="evaluateStatement", parameters={Parameter(name='miniJava_state', type=StringType)})
miniJava_Return.methods={miniJava_Return_m_evaluateStatement}

# miniJava_IfStatement class attributes and methods
miniJava_IfStatement_m_evaluateStatement: Method = Method(name="evaluateStatement", parameters={Parameter(name='miniJava_state', type=StringType)})
...
miniJava_WhileStatement_m_evaluateStatement: Method = Method(name="evaluateStatement", parameters={Parameter(name='miniJava_state', type=StringType)})
...
miniJava_ForStatement_m_evaluateStatement: Method = Method(name="evaluateStatement", parameters={Parameter(name='miniJava_state', type=StringType)})
miniJava_ForStatement.methods={miniJava_ForStatement_m_evaluateStatement}

# miniJava_Assignment class attributes and methods
miniJava_Assignment_m_evaluateStatement: Method = Method(name="evaluateStatement", parameters={Parameter(name='miniJava_state', type=StringType)})
miniJava_Assignment.methods={miniJava_Assignment_m_evaluateStatement}

# miniJava_TypeRef class attributes and methods
miniJava_TypeRef_m_compare: Method = Method(name="compare", parameters={Parameter(name='miniJava_other', type=StringType)})
...
miniJava_ClassRef_m_compare: Method = Method(name="compare", parameters={Parameter(name='miniJava_other', type=StringType)})
...
miniJava_Or_m_evaluateExpression: Method = Method(name="evaluateExpression", parameters={Parameter(name='miniJava_state', type=StringType)}, type=StringType)
miniJava_Or.methods={miniJava_Or_m_evaluateExpression}

# Expression class attributes and methods

# miniJava_And class attributes and methods
miniJava_And_m_evaluateExpression: Method = Method(name="evaluateExpression", parameters={Parameter(name='miniJava_state', type=StringType)}, type=StringType)
miniJava_And.methods={miniJava_And_m_evaluateExpression}

# miniJava_Equality class attributes and methods
miniJava_Equality_m_evaluateExpression: Method = Method(name="evaluateExpression", parameters={Parameter(name='miniJava_state', type=StringType)}, type=StringType)
miniJava_Equality.methods={miniJava_Equality_m_evaluateExpression}

# miniJava_Inequality class attributes and methods
miniJava_Inequality_m_evaluateExpression: Method = Method(name="evaluateExpression", parameters={Parameter(name='miniJava_state', type=StringType)}, type=StringType)
...
miniJava_SuperiorOrEqual_m_evaluateExpression: Method = Method(name="evaluateExpression", parameters={Parameter(name='miniJava_state', type=StringType)}, type=StringType)
...
miniJava_InferiorOrEqual_m_evaluateExpression: Method = Method(name="evaluateExpression", parameters={Parameter(name='miniJava_state', type=StringType)}, type=StringType)
...
miniJava_Superior_m_evaluateExpression: Method = Method(name="evaluateExpression", parameters={Parameter(name='miniJava_state', type=StringType)}, type=StringType)
miniJava_Superior.methods={miniJava_Superior_m_evaluateExpression}

# miniJava_Inferior class attributes and methods
miniJava_Inferior_m_evaluateExpression: Method = Method(name="evaluateExpression", parameters={Parameter(name='miniJava_state', type=StringType)}, type=StringType)
miniJava_Inferior.methods={miniJava_Inferior_m_evaluateExpression}

# miniJava_Plus class attributes and methods
miniJava_Plus_m_evaluateExpression: Method = Method(name="evaluateExpression", parameters={Parameter(name='miniJava_state', type=StringType)}, type=StringType)
miniJava_Plus.methods={miniJava_Plus_m_evaluateExpression}

# miniJava_Minus class attributes and methods
miniJava_Minus_m_evaluateExpression: Method = Method(name="evaluateExpression", parameters={Parameter(name='miniJava_state', type=StringType)}, type=StringType)
miniJava_Minus.methods={miniJava_Minus_m_evaluateExpression}

# miniJava_Division class attributes and methods
miniJava_Division_m_evaluateExpression: Method = Method(name="evaluateExpression", parameters={Parameter(name='miniJava_state', type=StringType)}, type=StringType)
miniJava_Division.methods={miniJava_Division_m_evaluateExpression}

# miniJava_ArrayAccess class attributes and methods
miniJava_ArrayAccess_m_evaluateExpression: Method = Method(name="evaluateExpression", parameters={Parameter(name='miniJava_state', type=StringType)}, type=StringType)
miniJava_ArrayAccess.methods={miniJava_ArrayAccess_m_evaluateExpression}

# miniJava_ArrayLength class attributes and methods
miniJava_ArrayLength_m_evaluateExpression: Method = Method(name="evaluateExpression", parameters={Parameter(name='miniJava_state', type=StringType)}, type=StringType)
miniJava_ArrayLength.methods={miniJava_ArrayLength_m_evaluateExpression}

# miniJava_Not class attributes and methods
miniJava_Not_m_evaluateExpression: Method = Method(name="evaluateExpression", parameters={Parameter(name='miniJava_state', type=StringType)}, type=StringType)
miniJava_Not.methods={miniJava_Not_m_evaluateExpression}

# miniJava_Neg class attributes and methods
miniJava_Neg_m_evaluateExpression: Method = Method(name="evaluateExpression", parameters={Parameter(name='miniJava_state', type=StringType)}, type=StringType)
miniJava_Neg.methods={miniJava_Neg_m_evaluateExpression}

# miniJava_FieldAccess class attributes and methods
miniJava_FieldAccess_m_evaluateExpression: Method = Method(name="evaluateExpression", parameters={Parameter(name='miniJava_state', type=StringType)}, type=StringType)
...
miniJava_Multiplication_m_evaluateExpression: Method = Method(name="evaluateExpression", parameters={Parameter(name='miniJava_state', type=StringType)}, type=StringType)
...
miniJava_MethodCall_m_evaluateExpression: Method = Method(name="evaluateExpression", parameters={Parameter(name='miniJava_state', type=StringType)}, type=StringType)
...
miniJava_StringConstant_m_evaluateExpression: Method = Method(name="evaluateExpression", parameters={Parameter(name='miniJava_state', type=StringType)}, type=StringType)
...
miniJava_IntConstant_m_evaluateExpression: Method = Method(name="evaluateExpression", parameters={Parameter(name='miniJava_state', type=StringType)}, type=StringType)
...
miniJava_BoolConstant_m_evaluateExpression: Method = Method(name="evaluateExpression", parameters={Parameter(name='miniJava_state', type=StringType)}, type=StringType)
...
miniJava_This_m_evaluateExpression: Method = Method(name="evaluateExpression", parameters={Parameter(name='miniJava_state', type=StringType)}, type=StringType)
...
miniJava_Null_m_evaluateExpression: Method = Method(name="evaluateExpression", parameters={Parameter(name='miniJava_state', type=StringType)}, type=StringType)
miniJava_Null.methods={miniJava_Null_m_evaluateExpression}

# miniJava_NewObject class attributes and methods
miniJava_NewObject_m_evaluateExpression: Method = Method(name="evaluateExpression", parameters={Parameter(name='miniJava_state', type=StringType)}, type=StringType)
miniJava_NewObject.methods={miniJava_NewObject_m_evaluateExpression}

# miniJava_NewArray class attributes and methods
miniJava_NewArray_m_evaluateExpression: Method = Method(name="evaluateExpression", parameters={Parameter(name='miniJava_state', type=StringType)}, type=StringType)
...
miniJava_Context_m_findBinding: Method = Method(name="findBinding", parameters={Parameter(name='miniJava_symbol', type=StringType)}, type=StringType)
miniJava_Context_m_findCurrentContext: Method = Method(name="findCurrentContext", parameters={}, type=StringType)
miniJava_Context.methods={miniJava_Context_m_findBinding, miniJava_Context_m_findCurrentContext, miniJava_Context_m_createChildContext}
...
miniJava_Value.methods={miniJava_Value_m_customToString, miniJava_Value_m_copy}
...
miniJava_StringValue.methods={miniJava_StringValue_m_customToString, miniJava_StringValue_m_copy}
...
miniJava_SymbolRef_m_evaluateExpression: Method = Method(name="evaluateExpression", parameters={Parameter(name='miniJava_state', type=StringType)}, type=StringType)
...
miniJava_Frame.methods={miniJava_Frame_m_findCurrentFrame, miniJava_Frame_m_findCurrentContext}
...
miniJava_ObjectRefValue.methods={miniJava_ObjectRefValue_m_copy, miniJava_ObjectRefValue_m_customToString}
...
value154: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="miniJava_SymbolBinding155", type=miniJava_Value, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
symbol156: BinaryAssociation = BinaryAssociation(
    name="symbol156",
    ends={
        Property(name="miniJava_Symbol158", type=miniJava_SymbolBinding, multiplicity=Multiplicity(1, 1)),
        Property(name="miniJava_SymbolBinding157", type=miniJava_Symbol, multiplicity=Multiplicity(1, 1))
    }
)
field159: BinaryAssociation = BinaryAssociation(
    name="field159",
    ends={
        Property(name="miniJava_Field160", type=miniJava_FieldBinding, multiplicity=Multiplicity(1, 1)),
...
value161: BinaryAssociation = BinaryAssociation(
    name="value161",
    ends={
        Property(name="miniJava_Value163", type=miniJava_FieldBinding, multiplicity=Multiplicity(1, 1)),
        Property(name="miniJava_FieldBinding162", type=miniJava_Value, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
...
rootFrame164: BinaryAssociation = BinaryAssociation(
    name="rootFrame164",
    ends={
        Property(name="miniJava_Frame", type=miniJava_State, multiplicity=Multiplicity(1, 1)),
        Property(name="miniJava_State165", type=miniJava_Frame, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
objectsHeap166: BinaryAssociation = BinaryAssociation(
    name="objectsHeap166",
    ends={
        Property(name="miniJava_ObjectInstance", type=miniJava_State, multiplicity=Multiplicity(1, 1)),
        Property(name="miniJava_State167", type=miniJava_ObjectInstance, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
outputStream168: BinaryAssociation = BinaryAssociation(
    name="outputStream168",
    ends={
        Property(name="miniJava_OutputStream", type=miniJava_State, multiplicity=Multiplicity(1, 1)),
        Property(name="miniJava_State169", type=miniJava_OutputStream, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
arraysHeap170: BinaryAssociation = BinaryAssociation(
    name="arraysHeap170",
    ends={
        Property(name="miniJava_ArrayInstance", type=miniJava_State, multiplicity=Multiplicity(1, 1)),
        Property(name="miniJava_State171", type=miniJava_ArrayInstance, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
call172: BinaryAssociation = BinaryAssociation(
    name="call172",
    ends={
        Property(name="miniJava_Call", type=miniJava_Frame, multiplicity=Multiplicity(1, 1)),
        Property(name="miniJava_Frame173", type=miniJava_Call, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
instance174: BinaryAssociation = BinaryAssociation(
    name="instance174",
    ends={
        Property(name="miniJava_ObjectInstance176", type=miniJava_Frame, multiplicity=Multiplicity(1, 1)),
        Property(name="miniJava_Frame175", type=miniJava_ObjectInstance, multiplicity=Multiplicity(0, 1))
    }
)
childFrame178: BinaryAssociation = BinaryAssociation(
    name="childFrame178",
    ends={
...
parentFrame180: BinaryAssociation = BinaryAssociation(
    name="parentFrame180",
    ends={
        Property(name="Frame181", type=miniJava_Frame, multiplicity=Multiplicity(1, 1)),
        Property(name="childFrame", type=miniJava_Frame, multiplicity=Multiplicity(0, 1))
    }
)
rootContext182: BinaryAssociation = BinaryAssociation(
    name="rootContext182",
    ends={
        Property(name="miniJava_Context184", type=miniJava_Frame, multiplicity=Multiplicity(1, 1)),
        Property(name="miniJava_Frame183", type=miniJava_Context, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
returnValue185: BinaryAssociation = BinaryAssociation(
    name="returnValue185",
    ends={
        Property(name="miniJava_Value187", type=miniJava_Frame, multiplicity=Multiplicity(1, 1)),
        Property(name="miniJava_Frame186", type=miniJava_Value, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
new188: BinaryAssociation = BinaryAssociation(
    name="new188",
    ends={
        Property(name="miniJava_NewObject189", type=miniJava_NewCall, multiplicity=Multiplicity(1, 1)),
        Property(name="miniJava_NewCall", type=miniJava_NewObject, multiplicity=Multiplicity(1, 1))
    }
)
methodcall190: BinaryAssociation = BinaryAssociation(
    name="methodcall190",
    ends={
        Property(name="miniJava_MethodCall191", type=miniJava_MethodCall2, multiplicity=Multiplicity(1, 1)),
        Property(name="miniJava_MethodCall2", type=miniJava_MethodCall, multiplicity=Multiplicity(1, 1))
    }
)
fieldbindings192: BinaryAssociation = BinaryAssociation(
    name="fieldbindings192",
    ends={
        Property(name="miniJava_FieldBinding194", type=miniJava_ObjectInstance, multiplicity=Multiplicity(1, 1)),
        Property(name="miniJava_ObjectInstance193", type=miniJava_FieldBinding, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
type195: BinaryAssociation = BinaryAssociation(
    name="type195",
    ends={
        Property(name="miniJava_Class197", type=miniJava_ObjectInstance, multiplicity=Multiplicity(1, 1)),
        Property(name="miniJava_ObjectInstance196", type=miniJava_Class, multiplicity=Multiplicity(1, 1))
    }
)
value198: BinaryAssociation = BinaryAssociation(
    name="value198",
    ends={
        Property(name="miniJava_Value200", type=miniJava_ArrayInstance, multiplicity=Multiplicity(1, 1)),
        Property(name="miniJava_ArrayInstance199", type=miniJava_Value, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
instance201: BinaryAssociation = BinaryAssociation(
    name="instance201",
    ends={
        Property(name="miniJava_ObjectInstance202", type=miniJava_ObjectRefValue, multiplicity=Multiplicity(1, 1)),
        Property(name="miniJava_ObjectRefValue", type=miniJava_ObjectInstance, multiplicity=Multiplicity(0, 1))
    }
)
instance203: BinaryAssociation = BinaryAssociation(
    name="instance203",
    ends={
        Property(name="miniJava_ArrayInstance204", type=miniJava_ArrayRefValue, multiplicity=Multiplicity(1, 1)),
...
domain_model = DomainModel(
    name="miniJava",
    types={miniJava_Program, miniJava_Import, miniJava_TypeDeclaration, miniJava_State, NamedElement, miniJava_Interface, miniJava_Member, miniJava_Class, TypeDeclaration, TypedDeclaration, miniJava_Method, Member, miniJava_Parameter, miniJava_Block, Symbol, miniJava_Field, miniJava_Expression, Statement, miniJava_Statement, miniJava_PrintStatement, miniJava_Return, miniJava_IfStatement, miniJava_WhileStatement, miniJava_ForStatement, miniJava_Assignment, miniJava_TypeRef, miniJava_SingleTypeRef, TypeRef, miniJava_ClassRef, SingleTypeRef, miniJava_NamedElement, miniJava_TypedDeclaration, miniJava_Symbol, miniJava_VariableDeclaration, Assignee, miniJava_Assignee, miniJava_BooleanTypeRef, miniJava_StringTypeRef, miniJava_VoidTypeRef, miniJava_Or, Expression, miniJava_And, miniJava_Equality, miniJava_Inequality, miniJava_ArrayTypeRef, miniJava_SuperiorOrEqual, miniJava_IntegerTypeRef, miniJava_InferiorOrEqual, miniJava_Superior, miniJava_Inferior, miniJava_Plus, miniJava_Minus, miniJava_Division, miniJava_ArrayAccess, miniJava_ArrayLength, miniJava_Not, miniJava_Neg, miniJava_FieldAccess, miniJava_Multiplication, miniJava_MethodCall, miniJava_StringConstant, miniJava_IntConstant, miniJava_BoolConstant, miniJava_This, miniJava_Super, miniJava_Null, miniJava_NewObject, miniJava_NewArray, miniJava_Context, miniJava_SymbolBinding, miniJava_Value, miniJava_IntegerValue, Value, miniJava_FieldBinding, miniJava_StringValue, miniJava_BooleanValue, miniJava_SymbolRef, miniJava_Frame, miniJava_ObjectInstance, miniJava_ArrayInstance, miniJava_Call, miniJava_NullValue, miniJava_OutputStream, miniJava_MethodCall2, miniJava_ObjectRefValue, miniJava_ArrayRefValue, miniJava_NewCall, Call, AccessLevel},
    associations={imports0, classes1, state3, implements5, members7, superClass10, params11, body12, defaultValue14, statements15, expression17, expression19, expression21, thenBlock23, elseBlock26, condition29, block31, declaration34, referencedClass44, typeRef46, assignee47, value49, condition35, progression38, block41, left53, right55, left58, right60, left63, right65, left68, right70, typeRef52, right75, left78, right80, left83, right85, left88, right90, left93, right95, left98, left73, left103, right105, left108, right110, object113, index115, array118, expression120, expression122, right100, receiver129, method131, args134, type137, args139, receiver124, field126, symbol147, bindings148, parentContext150, childContext152, value154, symbol156, field159, value161, type142, size144, rootFrame164, objectsHeap166, outputStream168, arraysHeap170, call172, instance174, childFrame178, parentFrame180, rootContext182, returnValue185, new188, methodcall190, fieldbindings192, type195, value198, instance201, instance203},
    generalizations={gen_miniJava_TypeDeclaration_NamedElement, gen_miniJava_Class_TypeDeclaration, gen_miniJava_Interface_TypeDeclaration, gen_miniJava_Member_TypedDeclaration, gen_miniJava_Method_Member, gen_miniJava_Parameter_Symbol, gen_miniJava_Field_Member, gen_miniJava_Block_Statement, gen_miniJava_PrintStatement_Statement, gen_miniJava_Return_Statement, gen_miniJava_IfStatement_Statement, gen_miniJava_WhileStatement_Statement, gen_miniJava_ForStatement_Statement, gen_miniJava_SingleTypeRef_TypeRef, gen_miniJava_ClassRef_SingleTypeRef, gen_miniJava_TypedDeclaration_NamedElement, gen_miniJava_Symbol_TypedDeclaration, gen_miniJava_VariableDeclaration_Symbol, gen_miniJava_VariableDeclaration_Assignee, gen_miniJava_Assignment_Statement, gen_miniJava_Expression_Statement, gen_miniJava_Expression_Assignee, gen_miniJava_BooleanTypeRef_SingleTypeRef, gen_miniJava_StringTypeRef_SingleTypeRef, gen_miniJava_VoidTypeRef_SingleTypeRef, gen_miniJava_Or_Expression, gen_miniJava_And_Expression, gen_miniJava_Equality_Expression, gen_miniJava_Inequality_Expression, gen_miniJava_ArrayTypeRef_TypeRef, gen_miniJava_SuperiorOrEqual_Expression, gen_miniJava_IntegerTypeRef_SingleTypeRef, gen_miniJava_InferiorOrEqual_Expression, gen_miniJava_Superior_Expression, gen_miniJava_Inferior_Expression, gen_miniJava_Plus_Expression, gen_miniJava_Minus_Expression, gen_miniJava_Division_Expression, gen_miniJava_ArrayAccess_Expression, gen_miniJava_ArrayLength_Expression, gen_miniJava_Not_Expression, gen_miniJava_Neg_Expression, gen_miniJava_FieldAccess_Expression, gen_miniJava_Multiplication_Expression, gen_miniJava_MethodCall_Expression, gen_miniJava_StringConstant_Expression, gen_miniJava_IntConstant_Expression, gen_miniJava_BoolConstant_Expression, gen_miniJava_This_Expression, gen_miniJava_Super_Expression, gen_miniJava_Null_Expression, gen_miniJava_NewObject_Expression, gen_miniJava_NewArray_Expression, gen_miniJava_IntegerValue_Value, gen_miniJava_StringValue_Value, gen_miniJava_BooleanValue_Value, gen_miniJava_SymbolRef_Expression, gen_miniJava_NullValue_Value, gen_miniJava_MethodCall2_Call, gen_miniJava_ObjectRefValue_Value, gen_miniJava_ArrayRefValue_Value, gen_miniJava_NewCall_Call},
    metadata=None
)
