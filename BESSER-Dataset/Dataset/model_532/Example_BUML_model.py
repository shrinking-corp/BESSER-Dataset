...
# Classes
Example_Pet = Class(name="Example_Pet", is_abstract=True)
Example_Member = Class(name="Example_Member", is_abstract=True)
Member = Class(name="Member")
Example_Family = Class(name="Example_Family")
Example_Parent = Class(name="Example_Parent")
Example_Son = Class(name="Example_Son")
Example_Daughter = Class(name="Example_Daughter")
Example_Dog = Class(name="Example_Dog")
Pet = Class(name="Pet")
Example_Cat = Class(name="Example_Cat")
Example_RaceDog = Class(name="Example_RaceDog")
Dog = Class(name="Dog")
Example_HuntingDog = Class(name="Example_HuntingDog")
...
domain_model = DomainModel(
    name="Example",
    types={Example_Pet, Example_Member, Member, Example_Family, Example_Parent, Example_Son, Example_Daughter, Example_Dog, Pet, Example_Cat, Example_RaceDog, Dog, Example_HuntingDog},
    associations={daughters3, pets5, family6, family7, family9, parents0, sons1},
    generalizations={gen_Example_Parent_Member, gen_Example_Son_Member, gen_Example_Daughter_Member, gen_Example_Dog_Pet, gen_Example_Cat_Pet, gen_Example_RaceDog_Dog, gen_Example_HuntingDog_Dog},
    metadata=None
)
