...
# Classes
testoperationbody_Main = Class(name="testoperationbody_Main")
testoperationbody_ConceptA = Class(name="testoperationbody_ConceptA")
testoperationbody_ChildA = Class(name="testoperationbody_ChildA")
Parent = Class(name="Parent")
testoperationbody_ChildB = Class(name="testoperationbody_ChildB")
testoperationbody_Parent = Class(name="testoperationbody_Parent", is_abstract=True)
...
domain_model = DomainModel(
    ...
    types={testoperationbody_Main, testoperationbody_ConceptA, testoperationbody_ChildA, Parent, testoperationbody_ChildB, testoperationbody_Parent, EnumA},
    associations={listconcepta0, children4, singleconcepta1},
