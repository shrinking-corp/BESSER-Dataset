...
# Classes
uisut_UISUT = Class(name="uisut_UISUT")
UISUTElement = Class(name="UISUTElement")
uisut_UIStatemachine = Class(name="uisut_UIStatemachine")
uisut_ApplicationSystem = Class(name="uisut_ApplicationSystem")
uisut_Action = Class(name="uisut_Action")
uisut_UserTrigger = Class(name="uisut_UserTrigger")
UITrigger = Class(name="UITrigger")
uisut_ComponentTrigger = Class(name="uisut_ComponentTrigger")
uisut_AbstractState = Class(name="uisut_AbstractState", is_abstract=True)
uisut_UITransition = Class(name="uisut_UITransition")
uisut_UIDataVariable = Class(name="uisut_UIDataVariable")
uisut_UIState = Class(name="uisut_UIState")
AbstractState = Class(name="AbstractState")
uisut_UIControl = Class(name="uisut_UIControl")
uisut_UITrigger = Class(name="uisut_UITrigger", is_abstract=True)
uisut_UICondition = Class(name="uisut_UICondition")
uisut_UISUTElement = Class(name="uisut_UISUTElement", is_abstract=True)
uisut_InitialState = Class(name="uisut_InitialState")
uisut_FinalState = Class(name="uisut_FinalState")
...
uisut_UITransition.attributes={uisut_UITransition_actionStr, uisut_UITransition_triggerStr, uisut_UITransition_scriptStr, uisut_UITransition_guardStr}
...
uisut_UISUTElement.attributes={uisut_UISUTElement_name, uisut_UISUTElement_description, uisut_UISUTElement_id}
...
domain_model = DomainModel(
    name="uisut",
    types={uisut_UISUT, UISUTElement, uisut_UIStatemachine, uisut_ApplicationSystem, uisut_Action, uisut_UserTrigger, UITrigger, uisut_ComponentTrigger, uisut_AbstractState, uisut_UITransition, uisut_UIDataVariable, uisut_UIState, AbstractState, uisut_UIControl, uisut_UITrigger, uisut_UICondition, uisut_UISUTElement, uisut_InitialState, uisut_FinalState},
    associations={itsSTM0, itsUISUT1, itsAction23, guardedDataVariable25, itsState3, itsTransition5, itsDataVariable7, itsUIControl9, addedDataVariable10, deletedDataVariable13, itsTrgtState16, itsSrcState17, itsTrigger19, itsCondition21, itsInputDaa28, itsOutputData31, itsInTransition34, itsOutTransition35},
    generalizations={gen_uisut_UISUT_UISUTElement, gen_uisut_ApplicationSystem_UISUTElement, gen_uisut_UITrigger_UISUTElement, gen_uisut_UserTrigger_UITrigger, gen_uisut_ComponentTrigger_UITrigger, gen_uisut_UIStatemachine_UISUTElement, gen_uisut_UIState_AbstractState, gen_uisut_UITransition_UISUTElement, gen_uisut_UICondition_UISUTElement, gen_uisut_Action_UISUTElement, gen_uisut_UIControl_UISUTElement, gen_uisut_UIDataVariable_UISUTElement, gen_uisut_InitialState_AbstractState, gen_uisut_FinalState_AbstractState, gen_uisut_AbstractState_UISUTElement},
    metadata=None
)
