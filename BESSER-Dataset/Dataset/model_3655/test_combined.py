...
def test_hyp_company_bug418716_is_not_abstract():
    assert not inspect.isabstract(company_Bug418716)


def test_hyp_company_bug418716_constructor_exists():
    assert callable(company_Bug418716.__init__)


def test_hyp_company_bug418716_constructor_args():
...
def test_hyp_company_bug418716_AttributeWithoutInitital_setter(instance):
...
@given(instance=company_Bug418716_strategy)
def test_hyp_company_bug418716_AttributeWithInitital_setter(instance):
...
def test_company_Bug418716_AttributeWithInitital_value_roundtrip():
    instance = company_Bug418716(AttributeWithInitital=7, AttributeWithoutInitital=7)
    assert instance.AttributeWithInitital == 7
    instance.AttributeWithInitital = 13
    assert instance.AttributeWithInitital == 13


def test_company_Bug418716_AttributeWithoutInitital_value_roundtrip():
    instance = company_Bug418716(AttributeWithInitital=7, AttributeWithoutInitital=7)
    assert instance.AttributeWithoutInitital == 7
    instance.AttributeWithoutInitital = 13
    assert instance.AttributeWithoutInitital == 13
...
company_Bug418716_strategy = st.builds(company_Bug418716, AttributeWithInitital=st.integers(), AttributeWithoutInitital=st.integers())
@given(instance=company_Bug418716_strategy)
