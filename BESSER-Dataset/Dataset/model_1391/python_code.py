...
class HSM_Transition:
    ...
    def __init__(self, trigger: str, effect: str, ownedTransition: "HSM_StateMachine" = None, HSM_Transition10: "HSM_CompositeState" = None, HSM_Transition17: "HSM_CompositeState" = None, Transition: "HSM_StateMachine" = None, HSM_Transition: "HSM_State" = None, HSM_Transition5: "HSM_State" = None):
...
class HSM_State:
    ...
    def __init__(self, name: str, HSM_State14: "HSM_CompositeState" = None, State: "HSM_StateMachine" = None, HSM_State: "HSM_CompositeState" = None, ownedState: "HSM_StateMachine" = None, HSM_State3: "HSM_Transition" = None, HSM_State6: "HSM_Transition" = None):
        self.name = name
