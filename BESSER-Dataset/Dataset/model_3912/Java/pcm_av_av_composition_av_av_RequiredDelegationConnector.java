...
public class pcm_av_av_composition_av_av_RequiredDelegationConnector extends DelegationConnector {
    ...
    public pcm_av_av_composition_av_av_RequiredDelegationConnector(
    ) {
        super(
        );
    }
