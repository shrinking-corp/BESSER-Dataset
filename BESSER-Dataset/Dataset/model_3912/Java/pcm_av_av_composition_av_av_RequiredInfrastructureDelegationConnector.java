...
public class pcm_av_av_composition_av_av_RequiredInfrastructureDelegationConnector extends DelegationConnector {
    ...
    public pcm_av_av_composition_av_av_RequiredInfrastructureDelegationConnector(
    ) {
        super(
        );
    }
