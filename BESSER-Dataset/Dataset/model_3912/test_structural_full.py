...
def test_pcm_av_av_entity_av_av_NamedElement_entityName_value_roundtrip():
    instance = pcm_av_av_entity_av_av_NamedElement(entityName="sample_text")
    assert instance.entityName == "sample_text"
    instance.entityName = "sample_text_2"
    assert instance.entityName == "sample_text_2"


def test_pcm_av_av_parameter_av_av_CharacterisedVariable_characterisationType_value_roundtrip():
    instance = pcm_av_av_parameter_av_av_CharacterisedVariable(characterisationType="sample_text")
...
def test_pcm_av_av_parameter_av_av_VariableCharacterisation_type_value_roundtrip():
    instance = pcm_av_av_parameter_av_av_VariableCharacterisation(type="sample_text")
    assert instance.type == "sample_text"
    instance.type = "sample_text_2"
    assert instance.type == "sample_text_2"


def test_pcm_av_av_protocol_av_av_Protocol_protocolTypeID_value_roundtrip():
    instance = pcm_av_av_protocol_av_av_Protocol(protocolTypeID="sample_text")
...
def test_pcm_av_av_reliability_av_av_FailureOccurrenceDescription_failureProbability_value_roundtrip():
    instance = pcm_av_av_reliability_av_av_FailureOccurrenceDescription(failureProbability=3.14)
    assert instance.failureProbability == 3.14
    instance.failureProbability = 9.99
    assert instance.failureProbability == 9.99


def test_pcm_av_av_repository_av_av_ExceptionType_exceptionMessage_value_roundtrip():
    instance = pcm_av_av_repository_av_av_ExceptionType(exceptionMessage="sample_text", exceptionName="sample_text")
...
def test_pcm_av_av_repository_av_av_ExceptionType_exceptionName_value_roundtrip():
    instance = pcm_av_av_repository_av_av_ExceptionType(exceptionMessage="sample_text", exceptionName="sample_text")
...
def test_pcm_av_av_repository_av_av_ImplementationComponentType_componentType_value_roundtrip():
    instance = pcm_av_av_repository_av_av_ImplementationComponentType(componentType="sample_text")
    assert instance.componentType == "sample_text"
    instance.componentType = "sample_text_2"
    assert instance.componentType == "sample_text_2"


def test_pcm_av_av_repository_av_av_Parameter_modifier__Parameter_value_roundtrip():
    instance = pcm_av_av_repository_av_av_Parameter(modifier__Parameter="sample_text", parameterName="sample_text")
...
def test_pcm_av_av_repository_av_av_Parameter_parameterName_value_roundtrip():
    instance = pcm_av_av_repository_av_av_Parameter(modifier__Parameter="sample_text", parameterName="sample_text")
...
def test_pcm_av_av_repository_av_av_PrimitiveDataType_type_value_roundtrip():
    instance = pcm_av_av_repository_av_av_PrimitiveDataType(type="sample_text")
    assert instance.type == "sample_text"
    instance.type = "sample_text_2"
    assert instance.type == "sample_text_2"


def test_pcm_av_av_repository_av_av_Repository_repositoryDescription_value_roundtrip():
    instance = pcm_av_av_repository_av_av_Repository(repositoryDescription="sample_text")
...
def test_pcm_av_av_repository_av_av_RequiredCharacterisation_type_value_roundtrip():
    instance = pcm_av_av_repository_av_av_RequiredCharacterisation(type="sample_text")
    assert instance.type == "sample_text"
    instance.type = "sample_text_2"
    assert instance.type == "sample_text_2"


def test_pcm_av_av_resourceenvironment_av_av_CommunicationLinkResourceSpecification_failureProbability_value_roundtrip():
    instance = pcm_av_av_resourceenvironment_av_av_CommunicationLinkResourceSpecification(failureProbability=3.14)
    assert instance.failureProbability == 3.14
    instance.failureProbability = 9.99
    assert instance.failureProbability == 9.99


def test_pcm_av_av_resourceenvironment_av_av_ProcessingResourceSpecification_MTTF_value_roundtrip():
    instance = pcm_av_av_resourceenvironment_av_av_ProcessingResourceSpecification(MTTF=3.14, MTTR=3.14, numberOfReplicas=7, requiredByContainer=True)
    assert instance.MTTF == 3.14
    instance.MTTF = 9.99
    assert instance.MTTF == 9.99


def test_pcm_av_av_resourceenvironment_av_av_ProcessingResourceSpecification_MTTR_value_roundtrip():
    instance = pcm_av_av_resourceenvironment_av_av_ProcessingResourceSpecification(MTTF=3.14, MTTR=3.14, numberOfReplicas=7, requiredByContainer=True)
...
def test_pcm_av_av_resourceenvironment_av_av_ProcessingResourceSpecification_numberOfReplicas_value_roundtrip():
    instance = pcm_av_av_resourceenvironment_av_av_ProcessingResourceSpecification(MTTF=3.14, MTTR=3.14, numberOfReplicas=7, requiredByContainer=True)
...
def test_pcm_av_av_resourceenvironment_av_av_ProcessingResourceSpecification_requiredByContainer_value_roundtrip():
    instance = pcm_av_av_resourceenvironment_av_av_ProcessingResourceSpecification(MTTF=3.14, MTTR=3.14, numberOfReplicas=7, requiredByContainer=True)
...
def test_pcm_av_av_resourcetype_av_av_ResourceSignature_resourceServiceId_value_roundtrip():
    instance = pcm_av_av_resourcetype_av_av_ResourceSignature(resourceServiceId=7)
    assert instance.resourceServiceId == 7
    instance.resourceServiceId = 13
    assert instance.resourceServiceId == 13


def test_pcm_av_av_seff_av_av_AcquireAction_timeout_value_roundtrip():
    instance = pcm_av_av_seff_av_av_AcquireAction(timeout=True, timeoutValue=3.14)
    assert instance.timeout == True
    instance.timeout = False
    assert instance.timeout == False


def test_pcm_av_av_seff_av_av_AcquireAction_timeoutValue_value_roundtrip():
    instance = pcm_av_av_seff_av_av_AcquireAction(timeout=True, timeoutValue=3.14)
...
def test_pcm_av_av_seff_av_av_ExternalCallAction_retryCount_value_roundtrip():
    instance = pcm_av_av_seff_av_av_ExternalCallAction(retryCount=7)
    assert instance.retryCount == 7
    instance.retryCount = 13
    assert instance.retryCount == 13


def test_pcm_av_av_seff_av_av_ProbabilisticBranchTransition_branchProbability_value_roundtrip():
    instance = pcm_av_av_seff_av_av_ProbabilisticBranchTransition(branchProbability=3.14)
    assert instance.branchProbability == 3.14
    instance.branchProbability = 9.99
    assert instance.branchProbability == 9.99


def test_pcm_av_av_seff_av_av_ServiceEffectSpecification_seffTypeID_value_roundtrip():
    instance = pcm_av_av_seff_av_av_ServiceEffectSpecification(seffTypeID="sample_text")
    assert instance.seffTypeID == "sample_text"
    instance.seffTypeID = "sample_text_2"
    assert instance.seffTypeID == "sample_text_2"


def test_pcm_av_av_usagemodel_av_av_BranchTransition_branchProbability_value_roundtrip():
    instance = pcm_av_av_usagemodel_av_av_BranchTransition(branchProbability=3.14)
    assert instance.branchProbability == 3.14
    instance.branchProbability = 9.99
    assert instance.branchProbability == 9.99


def test_pcm_av_av_usagemodel_av_av_ClosedWorkload_population_value_roundtrip():
    instance = pcm_av_av_usagemodel_av_av_ClosedWorkload(population=7)
    assert instance.population == 7
    instance.population = 13
    assert instance.population == 13


def test_pcm_av_av_usagemodel_av_av_EntryLevelSystemCall_priority_value_roundtrip():
    instance = pcm_av_av_usagemodel_av_av_EntryLevelSystemCall(priority=7)
    assert instance.priority == 7
    instance.priority = 13
    assert instance.priority == 13


def test_pcm_av_av_seff_av_av_AbstractInternalControlFlowAction_isa_AbstractAction():
    instance = pcm_av_av_seff_av_av_AbstractInternalControlFlowAction()
    assert isinstance(instance, AbstractAction)


def test_pcm_av_av_seff_av_av_GuardedBranchTransition_isa_AbstractBranchTransition():
    instance = pcm_av_av_seff_av_av_GuardedBranchTransition()
    assert isinstance(instance, AbstractBranchTransition)


def test_pcm_av_av_seff_av_av_ProbabilisticBranchTransition_isa_AbstractBranchTransition():
    instance = pcm_av_av_seff_av_av_ProbabilisticBranchTransition(branchProbability=3.14)
    assert isinstance(instance, AbstractBranchTransition)


def test_pcm_av_av_seff_av_av_AbstractLoopAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_av_av_seff_av_av_AbstractLoopAction()
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_av_av_seff_av_av_AcquireAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_av_av_seff_av_av_AcquireAction(timeout=True, timeoutValue=3.14)
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_av_av_seff_av_av_BranchAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_av_av_seff_av_av_BranchAction()
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_av_av_seff_av_av_ForkAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_av_av_seff_av_av_ForkAction()
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_av_av_seff_av_av_InternalAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_av_av_seff_av_av_InternalAction()
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_av_av_seff_av_av_ReleaseAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_av_av_seff_av_av_ReleaseAction()
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_av_av_seff_av_av_SetVariableAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_av_av_seff_av_av_SetVariableAction()
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_av_av_seff_av_av_StartAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_av_av_seff_av_av_StartAction()
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_av_av_seff_av_av_StopAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_av_av_seff_av_av_StopAction()
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_av_av_seff_reliability_av_av_RecoveryAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_av_av_seff_reliability_av_av_RecoveryAction()
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_av_av_seff_av_av_CollectionIteratorAction_isa_AbstractLoopAction():
    instance = pcm_av_av_seff_av_av_CollectionIteratorAction()
    assert isinstance(instance, AbstractLoopAction)


def test_pcm_av_av_seff_av_av_LoopAction_isa_AbstractLoopAction():
    instance = pcm_av_av_seff_av_av_LoopAction()
    assert isinstance(instance, AbstractLoopAction)


def test_pcm_av_av_usagemodel_av_av_Branch_isa_AbstractUserAction():
    instance = pcm_av_av_usagemodel_av_av_Branch()
    assert isinstance(instance, AbstractUserAction)


def test_pcm_av_av_usagemodel_av_av_Delay_isa_AbstractUserAction():
    instance = pcm_av_av_usagemodel_av_av_Delay()
    assert isinstance(instance, AbstractUserAction)


def test_pcm_av_av_usagemodel_av_av_EntryLevelSystemCall_isa_AbstractUserAction():
    instance = pcm_av_av_usagemodel_av_av_EntryLevelSystemCall(priority=7)
    assert isinstance(instance, AbstractUserAction)


def test_pcm_av_av_usagemodel_av_av_Loop_isa_AbstractUserAction():
    instance = pcm_av_av_usagemodel_av_av_Loop()
    assert isinstance(instance, AbstractUserAction)


def test_pcm_av_av_usagemodel_av_av_Start_isa_AbstractUserAction():
    instance = pcm_av_av_usagemodel_av_av_Start()
    assert isinstance(instance, AbstractUserAction)


def test_pcm_av_av_usagemodel_av_av_Stop_isa_AbstractUserAction():
    instance = pcm_av_av_usagemodel_av_av_Stop()
    assert isinstance(instance, AbstractUserAction)


def test_pcm_av_av_seff_av_av_CallReturnAction_isa_CallAction():
    instance = pcm_av_av_seff_av_av_CallReturnAction()
    assert isinstance(instance, CallAction)


def test_pcm_av_av_seff_performance_av_av_InfrastructureCall_isa_CallAction():
    instance = pcm_av_av_seff_performance_av_av_InfrastructureCall()
    assert isinstance(instance, CallAction)


def test_pcm_av_av_seff_performance_av_av_ResourceCall_isa_CallAction():
    instance = pcm_av_av_seff_performance_av_av_ResourceCall()
    assert isinstance(instance, CallAction)


def test_pcm_av_av_composition_av_av_AssemblyConnector_isa_Connector():
    instance = pcm_av_av_composition_av_av_AssemblyConnector()
    assert isinstance(instance, Connector)


def test_pcm_av_av_composition_av_av_AssemblyEventConnector_isa_Connector():
    instance = pcm_av_av_composition_av_av_AssemblyEventConnector()
    assert isinstance(instance, Connector)


def test_pcm_av_av_composition_av_av_AssemblyInfrastructureConnector_isa_Connector():
    instance = pcm_av_av_composition_av_av_AssemblyInfrastructureConnector()
    assert isinstance(instance, Connector)


def test_pcm_av_av_composition_av_av_DelegationConnector_isa_Connector():
    instance = pcm_av_av_composition_av_av_DelegationConnector()
    assert isinstance(instance, Connector)


def test_pcm_av_av_composition_av_av_EventChannelSinkConnector_isa_Connector():
    instance = pcm_av_av_composition_av_av_EventChannelSinkConnector()
    assert isinstance(instance, Connector)


def test_pcm_av_av_composition_av_av_EventChannelSourceConnector_isa_Connector():
    instance = pcm_av_av_composition_av_av_EventChannelSourceConnector()
    assert isinstance(instance, Connector)


def test_pcm_av_av_repository_av_av_PrimitiveDataType_isa_DataType():
    instance = pcm_av_av_repository_av_av_PrimitiveDataType(type="sample_text")
    assert isinstance(instance, DataType)


def test_pcm_av_av_composition_av_av_ProvidedDelegationConnector_isa_DelegationConnector():
    instance = pcm_av_av_composition_av_av_ProvidedDelegationConnector()
    assert isinstance(instance, DelegationConnector)


def test_pcm_av_av_composition_av_av_ProvidedInfrastructureDelegationConnector_isa_DelegationConnector():
    instance = pcm_av_av_composition_av_av_ProvidedInfrastructureDelegationConnector()
    assert isinstance(instance, DelegationConnector)


def test_pcm_av_av_composition_av_av_RequiredDelegationConnector_isa_DelegationConnector():
    instance = pcm_av_av_composition_av_av_RequiredDelegationConnector()
    assert isinstance(instance, DelegationConnector)


def test_pcm_av_av_composition_av_av_RequiredInfrastructureDelegationConnector_isa_DelegationConnector():
    instance = pcm_av_av_composition_av_av_RequiredInfrastructureDelegationConnector()
    assert isinstance(instance, DelegationConnector)


def test_pcm_av_av_composition_av_av_RequiredResourceDelegationConnector_isa_DelegationConnector():
    instance = pcm_av_av_composition_av_av_RequiredResourceDelegationConnector()
    assert isinstance(instance, DelegationConnector)


def test_pcm_av_av_composition_av_av_SinkDelegationConnector_isa_DelegationConnector():
    instance = pcm_av_av_composition_av_av_SinkDelegationConnector()
    assert isinstance(instance, DelegationConnector)


def test_pcm_av_av_composition_av_av_SourceDelegationConnector_isa_DelegationConnector():
    instance = pcm_av_av_composition_av_av_SourceDelegationConnector()
    assert isinstance(instance, DelegationConnector)


def test_pcm_av_av_allocation_av_av_Allocation_isa_Entity():
    instance = pcm_av_av_allocation_av_av_Allocation()
    assert isinstance(instance, Entity)


def test_pcm_av_av_allocation_av_av_AllocationContext_isa_Entity():
    instance = pcm_av_av_allocation_av_av_AllocationContext()
    assert isinstance(instance, Entity)


def test_pcm_av_av_composition_av_av_AssemblyContext_isa_Entity():
    instance = pcm_av_av_composition_av_av_AssemblyContext()
    assert isinstance(instance, Entity)


def test_pcm_av_av_composition_av_av_ComposedStructure_isa_Entity():
    instance = pcm_av_av_composition_av_av_ComposedStructure()
    assert isinstance(instance, Entity)


def test_pcm_av_av_composition_av_av_Connector_isa_Entity():
    instance = pcm_av_av_composition_av_av_Connector()
    assert isinstance(instance, Entity)


def test_pcm_av_av_composition_av_av_EventChannel_isa_Entity():
    instance = pcm_av_av_composition_av_av_EventChannel()
    assert isinstance(instance, Entity)


def test_pcm_av_av_entity_av_av_InterfaceProvidingEntity_isa_Entity():
    instance = pcm_av_av_entity_av_av_InterfaceProvidingEntity()
    assert isinstance(instance, Entity)


def test_pcm_av_av_entity_av_av_ResourceInterfaceProvidingEntity_isa_Entity():
    instance = pcm_av_av_entity_av_av_ResourceInterfaceProvidingEntity()
    assert isinstance(instance, Entity)


def test_pcm_av_av_entity_av_av_ResourceInterfaceRequiringEntity_isa_Entity():
    instance = pcm_av_av_entity_av_av_ResourceInterfaceRequiringEntity()
    assert isinstance(instance, Entity)


def test_pcm_av_av_qosannotations_av_av_QoSAnnotations_isa_Entity():
    instance = pcm_av_av_qosannotations_av_av_QoSAnnotations()
    assert isinstance(instance, Entity)


def test_pcm_av_av_reliability_av_av_FailureType_isa_Entity():
    instance = pcm_av_av_reliability_av_av_FailureType()
    assert isinstance(instance, Entity)


def test_pcm_av_av_repository_av_av_Interface_isa_Entity():
    instance = pcm_av_av_repository_av_av_Interface()
    assert isinstance(instance, Entity)


def test_pcm_av_av_repository_av_av_PassiveResource_isa_Entity():
    instance = pcm_av_av_repository_av_av_PassiveResource()
    assert isinstance(instance, Entity)


def test_pcm_av_av_repository_av_av_Repository_isa_Entity():
    instance = pcm_av_av_repository_av_av_Repository(repositoryDescription="sample_text")
    assert isinstance(instance, Entity)


def test_pcm_av_av_repository_av_av_Role_isa_Entity():
    instance = pcm_av_av_repository_av_av_Role()
    assert isinstance(instance, Entity)


def test_pcm_av_av_repository_av_av_Signature_isa_Entity():
    instance = pcm_av_av_repository_av_av_Signature()
    assert isinstance(instance, Entity)


def test_pcm_av_av_resourceenvironment_av_av_LinkingResource_isa_Entity():
    instance = pcm_av_av_resourceenvironment_av_av_LinkingResource()
    assert isinstance(instance, Entity)


def test_pcm_av_av_resourceenvironment_av_av_ResourceContainer_isa_Entity():
    instance = pcm_av_av_resourceenvironment_av_av_ResourceContainer()
    assert isinstance(instance, Entity)


def test_pcm_av_av_resourcetype_av_av_ResourceInterface_isa_Entity():
    instance = pcm_av_av_resourcetype_av_av_ResourceInterface()
    assert isinstance(instance, Entity)


def test_pcm_av_av_resourcetype_av_av_ResourceSignature_isa_Entity():
    instance = pcm_av_av_resourcetype_av_av_ResourceSignature(resourceServiceId=7)
    assert isinstance(instance, Entity)


def test_pcm_av_av_resourcetype_av_av_SchedulingPolicy_isa_Entity():
    instance = pcm_av_av_resourcetype_av_av_SchedulingPolicy()
    assert isinstance(instance, Entity)


def test_pcm_av_av_seff_av_av_AbstractAction_isa_Entity():
    instance = pcm_av_av_seff_av_av_AbstractAction()
    assert isinstance(instance, Entity)


def test_pcm_av_av_seff_av_av_AbstractBranchTransition_isa_Entity():
    instance = pcm_av_av_seff_av_av_AbstractBranchTransition()
    assert isinstance(instance, Entity)


def test_pcm_av_av_seff_reliability_av_av_FailureHandlingEntity_isa_Entity():
    instance = pcm_av_av_seff_reliability_av_av_FailureHandlingEntity()
    assert isinstance(instance, Entity)


def test_pcm_av_av_usagemodel_av_av_AbstractUserAction_isa_Entity():
    instance = pcm_av_av_usagemodel_av_av_AbstractUserAction()
    assert isinstance(instance, Entity)


def test_pcm_av_av_usagemodel_av_av_ScenarioBehaviour_isa_Entity():
    instance = pcm_av_av_usagemodel_av_av_ScenarioBehaviour()
    assert isinstance(instance, Entity)


def test_pcm_av_av_usagemodel_av_av_UsageScenario_isa_Entity():
    instance = pcm_av_av_usagemodel_av_av_UsageScenario()
    assert isinstance(instance, Entity)


def test_pcm_av_av_completions_av_av_DelegatingExternalCallAction_isa_ExternalCallAction():
    instance = pcm_av_av_completions_av_av_DelegatingExternalCallAction()
    assert isinstance(instance, ExternalCallAction)


def test_pcm_av_av_reliability_av_av_ExternalFailureOccurrenceDescription_isa_FailureOccurrenceDescription():
    instance = pcm_av_av_reliability_av_av_ExternalFailureOccurrenceDescription()
    assert isinstance(instance, FailureOccurrenceDescription)


def test_pcm_av_av_reliability_av_av_InternalFailureOccurrenceDescription_isa_FailureOccurrenceDescription():
    instance = pcm_av_av_reliability_av_av_InternalFailureOccurrenceDescription()
    assert isinstance(instance, FailureOccurrenceDescription)


def test_pcm_av_av_reliability_av_av_HardwareInducedFailureType_isa_FailureType():
    instance = pcm_av_av_reliability_av_av_HardwareInducedFailureType()
    assert isinstance(instance, FailureType)


def test_pcm_av_av_reliability_av_av_NetworkInducedFailureType_isa_FailureType():
    instance = pcm_av_av_reliability_av_av_NetworkInducedFailureType()
    assert isinstance(instance, FailureType)


def test_pcm_av_av_reliability_av_av_SoftwareInducedFailureType_isa_FailureType():
    instance = pcm_av_av_reliability_av_av_SoftwareInducedFailureType()
    assert isinstance(instance, FailureType)


def test_pcm_av_av_entity_av_av_Entity_isa_Identifier():
    instance = pcm_av_av_entity_av_av_Entity()
    assert isinstance(instance, Identifier)


def test_pcm_av_av_resourceenvironment_av_av_CommunicationLinkResourceSpecification_isa_Identifier():
    instance = pcm_av_av_resourceenvironment_av_av_CommunicationLinkResourceSpecification(failureProbability=3.14)
    assert isinstance(instance, Identifier)


def test_pcm_av_av_resourceenvironment_av_av_ProcessingResourceSpecification_isa_Identifier():
    instance = pcm_av_av_resourceenvironment_av_av_ProcessingResourceSpecification(MTTF=3.14, MTTR=3.14, numberOfReplicas=7, requiredByContainer=True)
    assert isinstance(instance, Identifier)


def test_pcm_av_av_seff_av_av_ResourceDemandingBehaviour_isa_Identifier():
    instance = pcm_av_av_seff_av_av_ResourceDemandingBehaviour()
    assert isinstance(instance, Identifier)


def test_pcm_av_av_seff_av_av_ResourceDemandingSEFF_isa_Identifier():
    instance = pcm_av_av_seff_av_av_ResourceDemandingSEFF()
    assert isinstance(instance, Identifier)


def test_pcm_av_av_repository_av_av_BasicComponent_isa_ImplementationComponentType():
    instance = pcm_av_av_repository_av_av_BasicComponent()
    assert isinstance(instance, ImplementationComponentType)


def test_pcm_av_av_repository_av_av_EventGroup_isa_Interface():
    instance = pcm_av_av_repository_av_av_EventGroup()
    assert isinstance(instance, Interface)


def test_pcm_av_av_repository_av_av_InfrastructureInterface_isa_Interface():
    instance = pcm_av_av_repository_av_av_InfrastructureInterface()
    assert isinstance(instance, Interface)


def test_pcm_av_av_repository_av_av_OperationInterface_isa_Interface():
    instance = pcm_av_av_repository_av_av_OperationInterface()
    assert isinstance(instance, Interface)


def test_pcm_av_av_repository_av_av_RepositoryComponent_isa_InterfaceProvidingRequiringEntity():
    instance = pcm_av_av_repository_av_av_RepositoryComponent()
    assert isinstance(instance, InterfaceProvidingRequiringEntity)


def test_pcm_av_av_repository_av_av_InnerDeclaration_isa_NamedElement():
    instance = pcm_av_av_repository_av_av_InnerDeclaration()
    assert isinstance(instance, NamedElement)


def test_pcm_av_av_resourceenvironment_av_av_ResourceEnvironment_isa_NamedElement():
    instance = pcm_av_av_resourceenvironment_av_av_ResourceEnvironment()
    assert isinstance(instance, NamedElement)


def test_pcm_av_av_completions_av_av_NetworkDemandParametricResourceDemand_isa_ParametricResourceDemand():
    instance = pcm_av_av_completions_av_av_NetworkDemandParametricResourceDemand()
    assert isinstance(instance, ParametricResourceDemand)


def test_pcm_av_av_repository_av_av_InfrastructureProvidedRole_isa_ProvidedRole():
    instance = pcm_av_av_repository_av_av_InfrastructureProvidedRole()
    assert isinstance(instance, ProvidedRole)


def test_pcm_av_av_repository_av_av_OperationProvidedRole_isa_ProvidedRole():
    instance = pcm_av_av_repository_av_av_OperationProvidedRole()
    assert isinstance(instance, ProvidedRole)


def test_pcm_av_av_repository_av_av_SinkRole_isa_ProvidedRole():
    instance = pcm_av_av_repository_av_av_SinkRole()
    assert isinstance(instance, ProvidedRole)


def test_pcm_av_av_core_av_av_PCMRandomVariable_isa_RandomVariable():
    instance = pcm_av_av_core_av_av_PCMRandomVariable()
    assert isinstance(instance, RandomVariable)


def test_pcm_av_av_repository_av_av_CompleteComponentType_isa_RepositoryComponent():
    instance = pcm_av_av_repository_av_av_CompleteComponentType()
    assert isinstance(instance, RepositoryComponent)


def test_pcm_av_av_repository_av_av_ImplementationComponentType_isa_RepositoryComponent():
    instance = pcm_av_av_repository_av_av_ImplementationComponentType(componentType="sample_text")
    assert isinstance(instance, RepositoryComponent)


def test_pcm_av_av_repository_av_av_ProvidesComponentType_isa_RepositoryComponent():
    instance = pcm_av_av_repository_av_av_ProvidesComponentType()
    assert isinstance(instance, RepositoryComponent)


def test_pcm_av_av_repository_av_av_InfrastructureRequiredRole_isa_RequiredRole():
    instance = pcm_av_av_repository_av_av_InfrastructureRequiredRole()
    assert isinstance(instance, RequiredRole)


def test_pcm_av_av_repository_av_av_OperationRequiredRole_isa_RequiredRole():
    instance = pcm_av_av_repository_av_av_OperationRequiredRole()
    assert isinstance(instance, RequiredRole)


def test_pcm_av_av_repository_av_av_SourceRole_isa_RequiredRole():
    instance = pcm_av_av_repository_av_av_SourceRole()
    assert isinstance(instance, RequiredRole)


def test_pcm_av_av_seff_av_av_ForkedBehaviour_isa_ResourceDemandingBehaviour():
    instance = pcm_av_av_seff_av_av_ForkedBehaviour()
    assert isinstance(instance, ResourceDemandingBehaviour)


def test_pcm_av_av_seff_av_av_ResourceDemandingInternalBehaviour_isa_ResourceDemandingBehaviour():
    instance = pcm_av_av_seff_av_av_ResourceDemandingInternalBehaviour()
    assert isinstance(instance, ResourceDemandingBehaviour)


def test_pcm_av_av_resourcetype_av_av_CommunicationLinkResourceType_isa_ResourceType():
    instance = pcm_av_av_resourcetype_av_av_CommunicationLinkResourceType()
    assert isinstance(instance, ResourceType)


def test_pcm_av_av_resourcetype_av_av_ProcessingResourceType_isa_ResourceType():
    instance = pcm_av_av_resourcetype_av_av_ProcessingResourceType()
    assert isinstance(instance, ResourceType)


def test_pcm_av_av_entity_av_av_ResourceProvidedRole_isa_Role():
    instance = pcm_av_av_entity_av_av_ResourceProvidedRole()
    assert isinstance(instance, Role)


def test_pcm_av_av_entity_av_av_ResourceRequiredRole_isa_Role():
    instance = pcm_av_av_entity_av_av_ResourceRequiredRole()
    assert isinstance(instance, Role)


def test_pcm_av_av_repository_av_av_ProvidedRole_isa_Role():
    instance = pcm_av_av_repository_av_av_ProvidedRole()
    assert isinstance(instance, Role)


def test_pcm_av_av_repository_av_av_RequiredRole_isa_Role():
    instance = pcm_av_av_repository_av_av_RequiredRole()
    assert isinstance(instance, Role)


def test_pcm_av_av_repository_av_av_EventType_isa_Signature():
    instance = pcm_av_av_repository_av_av_EventType()
    assert isinstance(instance, Signature)


def test_pcm_av_av_repository_av_av_InfrastructureSignature_isa_Signature():
    instance = pcm_av_av_repository_av_av_InfrastructureSignature()
    assert isinstance(instance, Signature)


def test_pcm_av_av_repository_av_av_OperationSignature_isa_Signature():
    instance = pcm_av_av_repository_av_av_OperationSignature()
    assert isinstance(instance, Signature)


def test_pcm_av_av_reliability_av_av_ResourceTimeoutFailureType_isa_SoftwareInducedFailureType():
    instance = pcm_av_av_reliability_av_av_ResourceTimeoutFailureType()
    assert isinstance(instance, SoftwareInducedFailureType)


def test_pcm_av_av_qos_performance_av_av_ComponentSpecifiedExecutionTime_isa_SpecifiedExecutionTime():
    instance = pcm_av_av_qos_performance_av_av_ComponentSpecifiedExecutionTime()
    assert isinstance(instance, SpecifiedExecutionTime)


def test_pcm_av_av_qos_performance_av_av_SystemSpecifiedExecutionTime_isa_SpecifiedExecutionTime():
    instance = pcm_av_av_qos_performance_av_av_SystemSpecifiedExecutionTime()
    assert isinstance(instance, SpecifiedExecutionTime)


def test_pcm_av_av_qos_performance_av_av_SpecifiedExecutionTime_isa_SpecifiedQoSAnnotation():
    instance = pcm_av_av_qos_performance_av_av_SpecifiedExecutionTime()
    assert isinstance(instance, SpecifiedQoSAnnotation)


def test_pcm_av_av_qos_reliability_av_av_SpecifiedReliabilityAnnotation_isa_SpecifiedQoSAnnotation():
    instance = pcm_av_av_qos_reliability_av_av_SpecifiedReliabilityAnnotation()
    assert isinstance(instance, SpecifiedQoSAnnotation)


def test_pcm_av_av_resourcetype_av_av_ResourceType_isa_UnitCarryingElement():
    instance = pcm_av_av_resourcetype_av_av_ResourceType()
    assert isinstance(instance, UnitCarryingElement)


def test_pcm_av_av_parameter_av_av_CharacterisedVariable_isa_Variable():
    instance = pcm_av_av_parameter_av_av_CharacterisedVariable(characterisationType="sample_text")
    assert isinstance(instance, Variable)


def test_pcm_av_av_usagemodel_av_av_ClosedWorkload_isa_Workload():
    instance = pcm_av_av_usagemodel_av_av_ClosedWorkload(population=7)
    assert isinstance(instance, Workload)


def test_pcm_av_av_usagemodel_av_av_OpenWorkload_isa_Workload():
    instance = pcm_av_av_usagemodel_av_av_OpenWorkload()
    assert isinstance(instance, Workload)


def test_pcm_av_av_entity_av_av_ComposedProvidingRequiringEntity_isa_composition_av_av_ComposedStructure():
    instance = pcm_av_av_entity_av_av_ComposedProvidingRequiringEntity()
    assert isinstance(instance, composition_av_av_ComposedStructure)


def test_pcm_av_av_completions_av_av_Completion_isa_entity_av_av_ComposedProvidingRequiringEntity():
    instance = pcm_av_av_completions_av_av_Completion()
    assert isinstance(instance, entity_av_av_ComposedProvidingRequiringEntity)


def test_pcm_av_av_repository_av_av_CompositeComponent_isa_entity_av_av_ComposedProvidingRequiringEntity():
    instance = pcm_av_av_repository_av_av_CompositeComponent()
    assert isinstance(instance, entity_av_av_ComposedProvidingRequiringEntity)


def test_pcm_av_av_subsystem_av_av_SubSystem_isa_entity_av_av_ComposedProvidingRequiringEntity():
    instance = pcm_av_av_subsystem_av_av_SubSystem()
    assert isinstance(instance, entity_av_av_ComposedProvidingRequiringEntity)


def test_pcm_av_av_system_av_av_System_isa_entity_av_av_ComposedProvidingRequiringEntity():
    instance = pcm_av_av_system_av_av_System()
    assert isinstance(instance, entity_av_av_ComposedProvidingRequiringEntity)


def test_pcm_av_av_entity_av_av_InterfaceRequiringEntity_isa_entity_av_av_Entity():
    instance = pcm_av_av_entity_av_av_InterfaceRequiringEntity()
    assert isinstance(instance, entity_av_av_Entity)


def test_pcm_av_av_repository_av_av_CollectionDataType_isa_entity_av_av_Entity():
    instance = pcm_av_av_repository_av_av_CollectionDataType()
    assert isinstance(instance, entity_av_av_Entity)


def test_pcm_av_av_repository_av_av_CompositeDataType_isa_entity_av_av_Entity():
    instance = pcm_av_av_repository_av_av_CompositeDataType()
    assert isinstance(instance, entity_av_av_Entity)


def test_pcm_av_av_resourcetype_av_av_ResourceType_isa_entity_av_av_Entity():
    instance = pcm_av_av_resourcetype_av_av_ResourceType()
    assert isinstance(instance, entity_av_av_Entity)


def test_pcm_av_av_system_av_av_System_isa_entity_av_av_Entity():
    instance = pcm_av_av_system_av_av_System()
    assert isinstance(instance, entity_av_av_Entity)


def test_pcm_av_av_entity_av_av_InterfaceProvidingRequiringEntity_isa_entity_av_av_InterfaceProvidingEntity():
    instance = pcm_av_av_entity_av_av_InterfaceProvidingRequiringEntity()
    assert isinstance(instance, entity_av_av_InterfaceProvidingEntity)


def test_pcm_av_av_entity_av_av_ComposedProvidingRequiringEntity_isa_entity_av_av_InterfaceProvidingRequiringEntity():
    instance = pcm_av_av_entity_av_av_ComposedProvidingRequiringEntity()
    assert isinstance(instance, entity_av_av_InterfaceProvidingRequiringEntity)


def test_pcm_av_av_entity_av_av_InterfaceProvidingRequiringEntity_isa_entity_av_av_InterfaceRequiringEntity():
    instance = pcm_av_av_entity_av_av_InterfaceProvidingRequiringEntity()
    assert isinstance(instance, entity_av_av_InterfaceRequiringEntity)


def test_pcm_av_av_entity_av_av_Entity_isa_entity_av_av_NamedElement():
    instance = pcm_av_av_entity_av_av_Entity()
    assert isinstance(instance, entity_av_av_NamedElement)


def test_pcm_av_av_entity_av_av_ResourceInterfaceProvidingRequiringEntity_isa_entity_av_av_ResourceInterfaceProvidingEntity():
    instance = pcm_av_av_entity_av_av_ResourceInterfaceProvidingRequiringEntity()
    assert isinstance(instance, entity_av_av_ResourceInterfaceProvidingEntity)


def test_pcm_av_av_resourcetype_av_av_ResourceType_isa_entity_av_av_ResourceInterfaceProvidingEntity():
    instance = pcm_av_av_resourcetype_av_av_ResourceType()
    assert isinstance(instance, entity_av_av_ResourceInterfaceProvidingEntity)


def test_pcm_av_av_entity_av_av_InterfaceRequiringEntity_isa_entity_av_av_ResourceInterfaceRequiringEntity():
    instance = pcm_av_av_entity_av_av_InterfaceRequiringEntity()
    assert isinstance(instance, entity_av_av_ResourceInterfaceRequiringEntity)


def test_pcm_av_av_entity_av_av_ResourceInterfaceProvidingRequiringEntity_isa_entity_av_av_ResourceInterfaceRequiringEntity():
    instance = pcm_av_av_entity_av_av_ResourceInterfaceProvidingRequiringEntity()
    assert isinstance(instance, entity_av_av_ResourceInterfaceRequiringEntity)


def test_pcm_av_av_repository_av_av_CollectionDataType_isa_repository_av_av_DataType():
    instance = pcm_av_av_repository_av_av_CollectionDataType()
    assert isinstance(instance, repository_av_av_DataType)


def test_pcm_av_av_repository_av_av_CompositeDataType_isa_repository_av_av_DataType():
    instance = pcm_av_av_repository_av_av_CompositeDataType()
    assert isinstance(instance, repository_av_av_DataType)


def test_pcm_av_av_completions_av_av_Completion_isa_repository_av_av_ImplementationComponentType():
    instance = pcm_av_av_completions_av_av_Completion()
    assert isinstance(instance, repository_av_av_ImplementationComponentType)


def test_pcm_av_av_repository_av_av_CompositeComponent_isa_repository_av_av_ImplementationComponentType():
    instance = pcm_av_av_repository_av_av_CompositeComponent()
    assert isinstance(instance, repository_av_av_ImplementationComponentType)


def test_pcm_av_av_subsystem_av_av_SubSystem_isa_repository_av_av_RepositoryComponent():
    instance = pcm_av_av_subsystem_av_av_SubSystem()
    assert isinstance(instance, repository_av_av_RepositoryComponent)


def test_pcm_av_av_seff_av_av_EmitEventAction_isa_seff_av_av_AbstractAction():
    instance = pcm_av_av_seff_av_av_EmitEventAction()
    assert isinstance(instance, seff_av_av_AbstractAction)


def test_pcm_av_av_seff_av_av_ExternalCallAction_isa_seff_av_av_AbstractAction():
    instance = pcm_av_av_seff_av_av_ExternalCallAction(retryCount=7)
    assert isinstance(instance, seff_av_av_AbstractAction)


def test_pcm_av_av_seff_av_av_InternalCallAction_isa_seff_av_av_AbstractInternalControlFlowAction():
    instance = pcm_av_av_seff_av_av_InternalCallAction()
    assert isinstance(instance, seff_av_av_AbstractInternalControlFlowAction)


def test_pcm_av_av_seff_av_av_EmitEventAction_isa_seff_av_av_CallAction():
    instance = pcm_av_av_seff_av_av_EmitEventAction()
    assert isinstance(instance, seff_av_av_CallAction)


def test_pcm_av_av_seff_av_av_InternalCallAction_isa_seff_av_av_CallAction():
    instance = pcm_av_av_seff_av_av_InternalCallAction()
    assert isinstance(instance, seff_av_av_CallAction)


def test_pcm_av_av_seff_av_av_ExternalCallAction_isa_seff_av_av_CallReturnAction():
    instance = pcm_av_av_seff_av_av_ExternalCallAction(retryCount=7)
    assert isinstance(instance, seff_av_av_CallReturnAction)


def test_pcm_av_av_seff_av_av_ResourceDemandingSEFF_isa_seff_av_av_ResourceDemandingBehaviour():
    instance = pcm_av_av_seff_av_av_ResourceDemandingSEFF()
    assert isinstance(instance, seff_av_av_ResourceDemandingBehaviour)


def test_pcm_av_av_seff_reliability_av_av_RecoveryActionBehaviour_isa_seff_av_av_ResourceDemandingBehaviour():
    instance = pcm_av_av_seff_reliability_av_av_RecoveryActionBehaviour()
    assert isinstance(instance, seff_av_av_ResourceDemandingBehaviour)


def test_pcm_av_av_seff_av_av_ResourceDemandingSEFF_isa_seff_av_av_ServiceEffectSpecification():
    instance = pcm_av_av_seff_av_av_ResourceDemandingSEFF()
    assert isinstance(instance, seff_av_av_ServiceEffectSpecification)


def test_pcm_av_av_seff_av_av_ExternalCallAction_isa_seff_reliability_av_av_FailureHandlingEntity():
    instance = pcm_av_av_seff_av_av_ExternalCallAction(retryCount=7)
    assert isinstance(instance, seff_reliability_av_av_FailureHandlingEntity)


def test_pcm_av_av_seff_reliability_av_av_RecoveryActionBehaviour_isa_seff_reliability_av_av_FailureHandlingEntity():
    instance = pcm_av_av_seff_reliability_av_av_RecoveryActionBehaviour()
    assert isinstance(instance, seff_reliability_av_av_FailureHandlingEntity)


def test_assoc_abstractBranchTransition_ResourceDemandingBehaviour347_link_reassign_clear():
    a = pcm_av_av_seff_av_av_ResourceDemandingBehaviour()
...
def test_assoc_abstractLoopAction_ResourceDemandingBehaviour345_link_reassign_clear():
    a = pcm_av_av_seff_av_av_ResourceDemandingBehaviour()
    b1 = AbstractLoopAction()
    b2 = AbstractLoopAction()
    _safe_set(a, 'bodyBehaviour_Loop346', b1)
    assert _is_linked(a, 'bodyBehaviour_Loop346', b1)
    if hasattr(b1, 'AbstractLoopAction'):
        assert _is_linked(b1, 'AbstractLoopAction', a)
    _safe_set(a, 'bodyBehaviour_Loop346', b2)
    assert _is_linked(a, 'bodyBehaviour_Loop346', b2)
    if hasattr(b1, 'AbstractLoopAction'):
        assert not _is_linked(b1, 'AbstractLoopAction', a)
    if hasattr(b2, 'AbstractLoopAction'):
        assert _is_linked(b2, 'AbstractLoopAction', a)
    _safe_set(a, 'bodyBehaviour_Loop346', None)
    assert not _is_linked(a, 'bodyBehaviour_Loop346', b2)
    if hasattr(b2, 'AbstractLoopAction'):
        assert not _is_linked(b2, 'AbstractLoopAction', a)


def test_assoc_action_ParametricResourceDemand425_link_reassign_clear():
    a = pcm_av_av_seff_performance_av_av_ParametricResourceDemand()
    ...
    if hasattr(b1, 'AbstractInternalControlFlowAction426'):
        assert _is_linked(b1, 'AbstractInternalControlFlowAction426', a)
    _safe_set(a, 'resourceDemand_Action', b2)
    assert _is_linked(a, 'resourceDemand_Action', b2)
    if hasattr(b1, 'AbstractInternalControlFlowAction426'):
        assert not _is_linked(b1, 'AbstractInternalControlFlowAction426', a)
    if hasattr(b2, 'AbstractInternalControlFlowAction426'):
        assert _is_linked(b2, 'AbstractInternalControlFlowAction426', a)
    _safe_set(a, 'resourceDemand_Action', None)
    assert not _is_linked(a, 'resourceDemand_Action', b2)
    if hasattr(b2, 'AbstractInternalControlFlowAction426'):
        assert not _is_linked(b2, 'AbstractInternalControlFlowAction426', a)


def test_assoc_action__InfrastructureCall408_link_reassign_clear():
    a = pcm_av_av_seff_performance_av_av_InfrastructureCall()
    b1 = AbstractInternalControlFlowAction()
    b2 = AbstractInternalControlFlowAction()
...
def test_assoc_action__ResourceCall412_link_reassign_clear():
    a = pcm_av_av_seff_performance_av_av_ResourceCall()
    b1 = AbstractInternalControlFlowAction()
    b2 = AbstractInternalControlFlowAction()
    _safe_set(a, 'resourceCall__Action', b1)
    assert _is_linked(a, 'resourceCall__Action', b1)
    if hasattr(b1, 'AbstractInternalControlFlowAction413'):
        assert _is_linked(b1, 'AbstractInternalControlFlowAction413', a)
    _safe_set(a, 'resourceCall__Action', b2)
    assert _is_linked(a, 'resourceCall__Action', b2)
    if hasattr(b1, 'AbstractInternalControlFlowAction413'):
        assert not _is_linked(b1, 'AbstractInternalControlFlowAction413', a)
    if hasattr(b2, 'AbstractInternalControlFlowAction413'):
        assert _is_linked(b2, 'AbstractInternalControlFlowAction413', a)
    _safe_set(a, 'resourceCall__Action', None)
    assert not _is_linked(a, 'resourceCall__Action', b2)
    if hasattr(b2, 'AbstractInternalControlFlowAction413'):
        assert not _is_linked(b2, 'AbstractInternalControlFlowAction413', a)


def test_assoc_actions_ScenarioBehaviour189_link_reassign_clear():
    a = pcm_av_av_usagemodel_av_av_ScenarioBehaviour()
    ...
    if hasattr(b1, 'AbstractUserAction190'):
        assert _is_linked(b1, 'AbstractUserAction190', a)
    _safe_set(a, 'scenarioBehaviour_AbstractUserAction', {b2})
    assert _is_linked(a, 'scenarioBehaviour_AbstractUserAction', b2)
    if hasattr(b1, 'AbstractUserAction190'):
        assert not _is_linked(b1, 'AbstractUserAction190', a)
    if hasattr(b2, 'AbstractUserAction190'):
        assert _is_linked(b2, 'AbstractUserAction190', a)
    _safe_set(a, 'scenarioBehaviour_AbstractUserAction', set())
    assert not _is_linked(a, 'scenarioBehaviour_AbstractUserAction', b2)
    if hasattr(b2, 'AbstractUserAction190'):
        assert not _is_linked(b2, 'AbstractUserAction190', a)


def test_assoc_activeResourceType_ActiveResourceSpecification476_link_reassign_clear():
    a = pcm_av_av_resourceenvironment_av_av_ProcessingResourceSpecification(MTTF=3.14, MTTR=3.14, numberOfReplicas=7, requiredByContainer=True)
    b1 = ProcessingResourceType()
    b2 = ProcessingResourceType()
    _safe_set(a, 'pcm_av_av_resourceenvironment_av_av_ProcessingResourceSpecification477', b1)
    assert _is_linked(a, 'pcm_av_av_resourceenvironment_av_av_ProcessingResourceSpecification477', b1)
    if hasattr(b1, 'ProcessingResourceType478'):
        assert _is_linked(b1, 'ProcessingResourceType478', a)
    _safe_set(a, 'pcm_av_av_resourceenvironment_av_av_ProcessingResourceSpecification477', b2)
    assert _is_linked(a, 'pcm_av_av_resourceenvironment_av_av_ProcessingResourceSpecification477', b2)
    if hasattr(b1, 'ProcessingResourceType478'):
        assert not _is_linked(b1, 'ProcessingResourceType478', a)
    if hasattr(b2, 'ProcessingResourceType478'):
        assert _is_linked(b2, 'ProcessingResourceType478', a)
    _safe_set(a, 'pcm_av_av_resourceenvironment_av_av_ProcessingResourceSpecification477', None)
    assert not _is_linked(a, 'pcm_av_av_resourceenvironment_av_av_ProcessingResourceSpecification477', b2)
    if hasattr(b2, 'ProcessingResourceType478'):
        assert not _is_linked(b2, 'ProcessingResourceType478', a)


def test_assoc_allocationContexts_Allocation504_link_reassign_clear():
    a = pcm_av_av_allocation_av_av_Allocation()
...
def test_assoc_allocation_AllocationContext496_link_reassign_clear():
    a = pcm_av_av_allocation_av_av_AllocationContext()
    b1 = Allocation()
    b2 = Allocation()
...
def test_assoc_assemblyContext_AllocationContext493_link_reassign_clear():
    a = pcm_av_av_allocation_av_av_AllocationContext()
    b1 = composition_av_av_AssemblyContext()
    b2 = composition_av_av_AssemblyContext()
    _safe_set(a, 'pcm_av_av_allocation_av_av_AllocationContext494', b1)
    assert _is_linked(a, 'pcm_av_av_allocation_av_av_AllocationContext494', b1)
    if hasattr(b1, 'composition_av_av_AssemblyContext495'):
        assert _is_linked(b1, 'composition_av_av_AssemblyContext495', a)
    _safe_set(a, 'pcm_av_av_allocation_av_av_AllocationContext494', b2)
    assert _is_linked(a, 'pcm_av_av_allocation_av_av_AllocationContext494', b2)
    if hasattr(b1, 'composition_av_av_AssemblyContext495'):
        assert not _is_linked(b1, 'composition_av_av_AssemblyContext495', a)
    if hasattr(b2, 'composition_av_av_AssemblyContext495'):
        assert _is_linked(b2, 'composition_av_av_AssemblyContext495', a)
    _safe_set(a, 'pcm_av_av_allocation_av_av_AllocationContext494', None)
    assert not _is_linked(a, 'pcm_av_av_allocation_av_av_AllocationContext494', b2)
    if hasattr(b2, 'composition_av_av_AssemblyContext495'):
        assert not _is_linked(b2, 'composition_av_av_AssemblyContext495', a)


def test_assoc_assemblyContext_ProvidedDelegationConnector71_link_reassign_clear():
    a = pcm_av_av_composition_av_av_ProvidedDelegationConnector()
    b1 = composition_av_av_AssemblyContext()
    b2 = composition_av_av_AssemblyContext()
    _safe_set(a, 'pcm_av_av_composition_av_av_ProvidedDelegationConnector72', b1)
    assert _is_linked(a, 'pcm_av_av_composition_av_av_ProvidedDelegationConnector72', b1)
    if hasattr(b1, 'composition_av_av_AssemblyContext73'):
        assert _is_linked(b1, 'composition_av_av_AssemblyContext73', a)
    _safe_set(a, 'pcm_av_av_composition_av_av_ProvidedDelegationConnector72', b2)
    assert _is_linked(a, 'pcm_av_av_composition_av_av_ProvidedDelegationConnector72', b2)
    if hasattr(b1, 'composition_av_av_AssemblyContext73'):
        assert not _is_linked(b1, 'composition_av_av_AssemblyContext73', a)
    if hasattr(b2, 'composition_av_av_AssemblyContext73'):
        assert _is_linked(b2, 'composition_av_av_AssemblyContext73', a)
    _safe_set(a, 'pcm_av_av_composition_av_av_ProvidedDelegationConnector72', None)
    assert not _is_linked(a, 'pcm_av_av_composition_av_av_ProvidedDelegationConnector72', b2)
    if hasattr(b2, 'composition_av_av_AssemblyContext73'):
        assert not _is_linked(b2, 'composition_av_av_AssemblyContext73', a)


def test_assoc_assemblyContext_RequiredDelegationConnector78_link_reassign_clear():
    a = pcm_av_av_composition_av_av_RequiredDelegationConnector()
    b1 = composition_av_av_AssemblyContext()
    b2 = composition_av_av_AssemblyContext()
    _safe_set(a, 'pcm_av_av_composition_av_av_RequiredDelegationConnector79', b1)
    assert _is_linked(a, 'pcm_av_av_composition_av_av_RequiredDelegationConnector79', b1)
    if hasattr(b1, 'composition_av_av_AssemblyContext80'):
        assert _is_linked(b1, 'composition_av_av_AssemblyContext80', a)
    _safe_set(a, 'pcm_av_av_composition_av_av_RequiredDelegationConnector79', b2)
    assert _is_linked(a, 'pcm_av_av_composition_av_av_RequiredDelegationConnector79', b2)
    if hasattr(b1, 'composition_av_av_AssemblyContext80'):
        assert not _is_linked(b1, 'composition_av_av_AssemblyContext80', a)
    if hasattr(b2, 'composition_av_av_AssemblyContext80'):
        assert _is_linked(b2, 'composition_av_av_AssemblyContext80', a)
    _safe_set(a, 'pcm_av_av_composition_av_av_RequiredDelegationConnector79', None)
    assert not _is_linked(a, 'pcm_av_av_composition_av_av_RequiredDelegationConnector79', b2)
    if hasattr(b2, 'composition_av_av_AssemblyContext80'):
        assert not _is_linked(b2, 'composition_av_av_AssemblyContext80', a)


def test_assoc_assemblyContexts__ComposedStructure39_link_reassign_clear():
    a = pcm_av_av_composition_av_av_ComposedStructure()
    b1 = composition_av_av_AssemblyContext()
    b2 = composition_av_av_AssemblyContext()
...
def test_assoc_assemblyEventConnector__FilterCondition21_link_reassign_clear():
    a = pcm_av_av_core_av_av_PCMRandomVariable()
    b1 = composition_av_av_AssemblyEventConnector()
    b2 = composition_av_av_AssemblyEventConnector()
...
def test_assoc_basicComponent_ServiceEffectSpecification360_link_reassign_clear():
    a = pcm_av_av_seff_av_av_ServiceEffectSpecification(seffTypeID="sample_text")
    b1 = BasicComponent()
    b2 = BasicComponent()
    ...
    if hasattr(b1, 'BasicComponent361'):
        assert _is_linked(b1, 'BasicComponent361', a)
    ...
    if hasattr(b1, 'BasicComponent361'):
        assert not _is_linked(b1, 'BasicComponent361', a)
    if hasattr(b2, 'BasicComponent361'):
        assert _is_linked(b2, 'BasicComponent361', a)
    ...
    if hasattr(b2, 'BasicComponent361'):
        assert not _is_linked(b2, 'BasicComponent361', a)


def test_assoc_branchTransition_ScenarioBehaviour186_link_reassign_clear():
    a = pcm_av_av_usagemodel_av_av_ScenarioBehaviour()
    b1 = BranchTransition()
    b2 = BranchTransition()
...
def test_assoc_branchTransitions_Branch194_link_reassign_clear():
    a = pcm_av_av_usagemodel_av_av_Branch()
    b1 = BranchTransition()
    b2 = BranchTransition()
    _safe_set(a, 'branch_BranchTransition', {b1})
    assert _is_linked(a, 'branch_BranchTransition', b1)
    if hasattr(b1, 'BranchTransition195'):
        assert _is_linked(b1, 'BranchTransition195', a)
    _safe_set(a, 'branch_BranchTransition', {b2})
    assert _is_linked(a, 'branch_BranchTransition', b2)
    if hasattr(b1, 'BranchTransition195'):
        assert not _is_linked(b1, 'BranchTransition195', a)
    if hasattr(b2, 'BranchTransition195'):
        assert _is_linked(b2, 'BranchTransition195', a)
    _safe_set(a, 'branch_BranchTransition', set())
    assert not _is_linked(a, 'branch_BranchTransition', b2)
    if hasattr(b2, 'BranchTransition195'):
        assert not _is_linked(b2, 'BranchTransition195', a)


def test_assoc_branch_BranchTransition191_link_reassign_clear():
    a = pcm_av_av_usagemodel_av_av_BranchTransition(branchProbability=3.14)
    b1 = Branch()
    b2 = Branch()
...
def test_assoc_branchedBehaviour_BranchTransition192_link_reassign_clear():
    a = pcm_av_av_usagemodel_av_av_BranchTransition(branchProbability=3.14)
    ...
    if hasattr(b1, 'ScenarioBehaviour193'):
        assert _is_linked(b1, 'ScenarioBehaviour193', a)
    _safe_set(a, 'branchTransition_ScenarioBehaviour', b2)
    assert _is_linked(a, 'branchTransition_ScenarioBehaviour', b2)
    if hasattr(b1, 'ScenarioBehaviour193'):
        assert not _is_linked(b1, 'ScenarioBehaviour193', a)
    if hasattr(b2, 'ScenarioBehaviour193'):
        assert _is_linked(b2, 'ScenarioBehaviour193', a)
    _safe_set(a, 'branchTransition_ScenarioBehaviour', None)
    assert not _is_linked(a, 'branchTransition_ScenarioBehaviour', b2)
    if hasattr(b2, 'ScenarioBehaviour193'):
        assert not _is_linked(b2, 'ScenarioBehaviour193', a)


def test_assoc_branches_Branch355_link_reassign_clear():
    a = pcm_av_av_seff_av_av_BranchAction()
    b1 = AbstractBranchTransition()
    b2 = AbstractBranchTransition()
    _safe_set(a, 'branchAction_AbstractBranchTransition', {b1})
    assert _is_linked(a, 'branchAction_AbstractBranchTransition', b1)
    if hasattr(b1, 'AbstractBranchTransition356'):
        assert _is_linked(b1, 'AbstractBranchTransition356', a)
    _safe_set(a, 'branchAction_AbstractBranchTransition', {b2})
    assert _is_linked(a, 'branchAction_AbstractBranchTransition', b2)
    if hasattr(b1, 'AbstractBranchTransition356'):
        assert not _is_linked(b1, 'AbstractBranchTransition356', a)
    if hasattr(b2, 'AbstractBranchTransition356'):
        assert _is_linked(b2, 'AbstractBranchTransition356', a)
    _safe_set(a, 'branchAction_AbstractBranchTransition', set())
    assert not _is_linked(a, 'branchAction_AbstractBranchTransition', b2)
    if hasattr(b2, 'AbstractBranchTransition356'):
        assert not _is_linked(b2, 'AbstractBranchTransition356', a)


def test_assoc_calledService_ExternalService380_link_reassign_clear():
    a = pcm_av_av_seff_av_av_ExternalCallAction(retryCount=7)
    b1 = OperationSignature()
    b2 = OperationSignature()
    _safe_set(a, 'pcm_av_av_seff_av_av_ExternalCallAction', b1)
    assert _is_linked(a, 'pcm_av_av_seff_av_av_ExternalCallAction', b1)
    if hasattr(b1, 'OperationSignature381'):
        assert _is_linked(b1, 'OperationSignature381', a)
    _safe_set(a, 'pcm_av_av_seff_av_av_ExternalCallAction', b2)
    assert _is_linked(a, 'pcm_av_av_seff_av_av_ExternalCallAction', b2)
    if hasattr(b1, 'OperationSignature381'):
        assert not _is_linked(b1, 'OperationSignature381', a)
    if hasattr(b2, 'OperationSignature381'):
        assert _is_linked(b2, 'OperationSignature381', a)
    _safe_set(a, 'pcm_av_av_seff_av_av_ExternalCallAction', None)
    assert not _is_linked(a, 'pcm_av_av_seff_av_av_ExternalCallAction', b2)
    if hasattr(b2, 'OperationSignature381'):
        assert not _is_linked(b2, 'OperationSignature381', a)


def test_assoc_closedWorkload_PCMRandomVariable11_link_reassign_clear():
    a = pcm_av_av_core_av_av_PCMRandomVariable()
    b1 = ClosedWorkload()
    b2 = ClosedWorkload()
...
def test_assoc_communicationLinkResourceSpecifcation_throughput_PCMRandomVariable25_link_reassign_clear():
    a = pcm_av_av_core_av_av_PCMRandomVariable()
...
def test_assoc_communicationLinkResourceSpecification_latency_PCMRandomVariable27_link_reassign_clear():
    a = pcm_av_av_core_av_av_PCMRandomVariable()
    b1 = CommunicationLinkResourceSpecification()
    b2 = CommunicationLinkResourceSpecification()
    ...
    if hasattr(b1, 'CommunicationLinkResourceSpecification28'):
        assert _is_linked(b1, 'CommunicationLinkResourceSpecification28', a)
    ...
    if hasattr(b1, 'CommunicationLinkResourceSpecification28'):
        assert not _is_linked(b1, 'CommunicationLinkResourceSpecification28', a)
    if hasattr(b2, 'CommunicationLinkResourceSpecification28'):
        assert _is_linked(b2, 'CommunicationLinkResourceSpecification28', a)
    ...
    if hasattr(b2, 'CommunicationLinkResourceSpecification28'):
        assert not _is_linked(b2, 'CommunicationLinkResourceSpecification28', a)


def test_assoc_communicationLinkResourceType_CommunicationLinkResourceSpecification485_link_reassign_clear():
    a = pcm_av_av_resourceenvironment_av_av_CommunicationLinkResourceSpecification(failureProbability=3.14)
    b1 = CommunicationLinkResourceType()
    b2 = CommunicationLinkResourceType()
    _safe_set(a, 'pcm_av_av_resourceenvironment_av_av_CommunicationLinkResourceSpecification', b1)
    assert _is_linked(a, 'pcm_av_av_resourceenvironment_av_av_CommunicationLinkResourceSpecification', b1)
    if hasattr(b1, 'CommunicationLinkResourceType486'):
        assert _is_linked(b1, 'CommunicationLinkResourceType486', a)
    _safe_set(a, 'pcm_av_av_resourceenvironment_av_av_CommunicationLinkResourceSpecification', b2)
    assert _is_linked(a, 'pcm_av_av_resourceenvironment_av_av_CommunicationLinkResourceSpecification', b2)
    if hasattr(b1, 'CommunicationLinkResourceType486'):
        assert not _is_linked(b1, 'CommunicationLinkResourceType486', a)
    if hasattr(b2, 'CommunicationLinkResourceType486'):
        assert _is_linked(b2, 'CommunicationLinkResourceType486', a)
    _safe_set(a, 'pcm_av_av_resourceenvironment_av_av_CommunicationLinkResourceSpecification', None)
    assert not _is_linked(a, 'pcm_av_av_resourceenvironment_av_av_CommunicationLinkResourceSpecification', b2)
    if hasattr(b2, 'CommunicationLinkResourceType486'):
        assert not _is_linked(b2, 'CommunicationLinkResourceType486', a)


def test_assoc_communicationLinkResourceType__NetworkInducedFailureType327_link_reassign_clear():
    a = pcm_av_av_reliability_av_av_NetworkInducedFailureType()
    b1 = CommunicationLinkResourceType()
    b2 = CommunicationLinkResourceType()
...
def test_assoc_componentParameterUsage_ImplementationComponentType214_link_reassign_clear():
    a = pcm_av_av_repository_av_av_ImplementationComponentType(componentType="sample_text")
    b1 = VariableUsage()
    b2 = VariableUsage()
    _safe_set(a, 'pcm_av_av_repository_av_av_ImplementationComponentType215', {b1})
    assert _is_linked(a, 'pcm_av_av_repository_av_av_ImplementationComponentType215', b1)
    if hasattr(b1, 'VariableUsage216'):
        assert _is_linked(b1, 'VariableUsage216', a)
    _safe_set(a, 'pcm_av_av_repository_av_av_ImplementationComponentType215', {b2})
    assert _is_linked(a, 'pcm_av_av_repository_av_av_ImplementationComponentType215', b2)
    if hasattr(b1, 'VariableUsage216'):
        assert not _is_linked(b1, 'VariableUsage216', a)
    if hasattr(b2, 'VariableUsage216'):
        assert _is_linked(b2, 'VariableUsage216', a)
    _safe_set(a, 'pcm_av_av_repository_av_av_ImplementationComponentType215', set())
    assert not _is_linked(a, 'pcm_av_av_repository_av_av_ImplementationComponentType215', b2)
    if hasattr(b2, 'VariableUsage216'):
        assert not _is_linked(b2, 'VariableUsage216', a)


def test_assoc_components__Repository227_link_reassign_clear():
    a = pcm_av_av_repository_av_av_Repository(repositoryDescription="sample_text")
    ...
    if hasattr(b1, 'RepositoryComponent228'):
        assert _is_linked(b1, 'RepositoryComponent228', a)
    _safe_set(a, 'repository__RepositoryComponent', {b2})
    assert _is_linked(a, 'repository__RepositoryComponent', b2)
    if hasattr(b1, 'RepositoryComponent228'):
        assert not _is_linked(b1, 'RepositoryComponent228', a)
    if hasattr(b2, 'RepositoryComponent228'):
        assert _is_linked(b2, 'RepositoryComponent228', a)
    _safe_set(a, 'repository__RepositoryComponent', set())
    assert not _is_linked(a, 'repository__RepositoryComponent', b2)
    if hasattr(b2, 'RepositoryComponent228'):
        assert not _is_linked(b2, 'RepositoryComponent228', a)


def test_assoc_connectors__ComposedStructure42_link_reassign_clear():
    a = pcm_av_av_composition_av_av_ComposedStructure()
    b1 = composition_av_av_Connector()
    b2 = composition_av_av_Connector()
...
def test_assoc_dataType__Parameter219_link_reassign_clear():
    a = pcm_av_av_repository_av_av_Parameter(modifier__Parameter="sample_text", parameterName="sample_text")
    b1 = DataType()
    b2 = DataType()
    _safe_set(a, 'pcm_av_av_repository_av_av_Parameter', b1)
    assert _is_linked(a, 'pcm_av_av_repository_av_av_Parameter', b1)
    if hasattr(b1, 'DataType'):
        assert _is_linked(b1, 'DataType', a)
    _safe_set(a, 'pcm_av_av_repository_av_av_Parameter', b2)
    assert _is_linked(a, 'pcm_av_av_repository_av_av_Parameter', b2)
    if hasattr(b1, 'DataType'):
        assert not _is_linked(b1, 'DataType', a)
    if hasattr(b2, 'DataType'):
        assert _is_linked(b2, 'DataType', a)
    _safe_set(a, 'pcm_av_av_repository_av_av_Parameter', None)
    assert not _is_linked(a, 'pcm_av_av_repository_av_av_Parameter', b2)
    if hasattr(b2, 'DataType'):
        assert not _is_linked(b2, 'DataType', a)


def test_assoc_dataTypes__Repository231_link_reassign_clear():
    a = pcm_av_av_repository_av_av_Repository(repositoryDescription="sample_text")
    b1 = DataType()
    b2 = DataType()
    _safe_set(a, 'repository__DataType', {b1})
    assert _is_linked(a, 'repository__DataType', b1)
    if hasattr(b1, 'DataType232'):
        assert _is_linked(b1, 'DataType232', a)
    _safe_set(a, 'repository__DataType', {b2})
    assert _is_linked(a, 'repository__DataType', b2)
    if hasattr(b1, 'DataType232'):
        assert not _is_linked(b1, 'DataType232', a)
    if hasattr(b2, 'DataType232'):
        assert _is_linked(b2, 'DataType232', a)
    _safe_set(a, 'repository__DataType', set())
    assert not _is_linked(a, 'repository__DataType', b2)
    if hasattr(b2, 'DataType232'):
        assert not _is_linked(b2, 'DataType232', a)


def test_assoc_delay_TimeSpecification24_link_reassign_clear():
    a = pcm_av_av_core_av_av_PCMRandomVariable()
    b1 = Delay()
    b2 = Delay()
...
def test_assoc_describedService__SEFF359_link_reassign_clear():
    a = pcm_av_av_seff_av_av_ServiceEffectSpecification(seffTypeID="sample_text")
    b1 = Signature()
    b2 = Signature()
    _safe_set(a, 'pcm_av_av_seff_av_av_ServiceEffectSpecification', b1)
    assert _is_linked(a, 'pcm_av_av_seff_av_av_ServiceEffectSpecification', b1)
    if hasattr(b1, 'Signature'):
        assert _is_linked(b1, 'Signature', a)
    _safe_set(a, 'pcm_av_av_seff_av_av_ServiceEffectSpecification', b2)
    assert _is_linked(a, 'pcm_av_av_seff_av_av_ServiceEffectSpecification', b2)
    if hasattr(b1, 'Signature'):
        assert not _is_linked(b1, 'Signature', a)
    if hasattr(b2, 'Signature'):
        assert _is_linked(b2, 'Signature', a)
    _safe_set(a, 'pcm_av_av_seff_av_av_ServiceEffectSpecification', None)
    assert not _is_linked(a, 'pcm_av_av_seff_av_av_ServiceEffectSpecification', b2)
    if hasattr(b2, 'Signature'):
        assert not _is_linked(b2, 'Signature', a)


def test_assoc_eventChannelSinkConnector__FilterCondition20_link_reassign_clear():
    a = pcm_av_av_core_av_av_PCMRandomVariable()
    b1 = composition_av_av_EventChannelSinkConnector()
    b2 = composition_av_av_EventChannelSinkConnector()
...
def test_assoc_eventChannel__AllocationContext497_link_reassign_clear():
    a = pcm_av_av_allocation_av_av_AllocationContext()
    b1 = composition_av_av_EventChannel()
    b2 = composition_av_av_EventChannel()
    _safe_set(a, 'pcm_av_av_allocation_av_av_AllocationContext498', b1)
    assert _is_linked(a, 'pcm_av_av_allocation_av_av_AllocationContext498', b1)
    if hasattr(b1, 'composition_av_av_EventChannel'):
        assert _is_linked(b1, 'composition_av_av_EventChannel', a)
    _safe_set(a, 'pcm_av_av_allocation_av_av_AllocationContext498', b2)
    assert _is_linked(a, 'pcm_av_av_allocation_av_av_AllocationContext498', b2)
    if hasattr(b1, 'composition_av_av_EventChannel'):
        assert not _is_linked(b1, 'composition_av_av_EventChannel', a)
    if hasattr(b2, 'composition_av_av_EventChannel'):
        assert _is_linked(b2, 'composition_av_av_EventChannel', a)
    _safe_set(a, 'pcm_av_av_allocation_av_av_AllocationContext498', None)
    assert not _is_linked(a, 'pcm_av_av_allocation_av_av_AllocationContext498', b2)
    if hasattr(b2, 'composition_av_av_EventChannel'):
        assert not _is_linked(b2, 'composition_av_av_EventChannel', a)


def test_assoc_eventChannel__ComposedStructure41_link_reassign_clear():
    a = pcm_av_av_composition_av_av_ComposedStructure()
    b1 = composition_av_av_EventChannel()
    b2 = composition_av_av_EventChannel()
...
def test_assoc_eventType__Parameter223_link_reassign_clear():
    a = pcm_av_av_repository_av_av_Parameter(modifier__Parameter="sample_text", parameterName="sample_text")
    b1 = EventType()
    b2 = EventType()
...
def test_assoc_externalFailureOccurrenceDescriptions__SpecifiedReliabilityAnnotation456_link_reassign_clear():
    a = pcm_av_av_qos_reliability_av_av_SpecifiedReliabilityAnnotation()
...
def test_assoc_failureHandlingAlternatives__RecoveryActionBehaviour427_link_reassign_clear():
    a = pcm_av_av_seff_reliability_av_av_RecoveryActionBehaviour()
    b1 = seff_reliability_av_av_RecoveryActionBehaviour()
    b2 = seff_reliability_av_av_RecoveryActionBehaviour()
    _safe_set(a, 'pcm_av_av_seff_reliability_av_av_RecoveryActionBehaviour', {b1})
    assert _is_linked(a, 'pcm_av_av_seff_reliability_av_av_RecoveryActionBehaviour', b1)
    if hasattr(b1, 'seff_reliability_av_av_RecoveryActionBehaviour'):
        assert _is_linked(b1, 'seff_reliability_av_av_RecoveryActionBehaviour', a)
    _safe_set(a, 'pcm_av_av_seff_reliability_av_av_RecoveryActionBehaviour', {b2})
    assert _is_linked(a, 'pcm_av_av_seff_reliability_av_av_RecoveryActionBehaviour', b2)
    if hasattr(b1, 'seff_reliability_av_av_RecoveryActionBehaviour'):
        assert not _is_linked(b1, 'seff_reliability_av_av_RecoveryActionBehaviour', a)
    if hasattr(b2, 'seff_reliability_av_av_RecoveryActionBehaviour'):
        assert _is_linked(b2, 'seff_reliability_av_av_RecoveryActionBehaviour', a)
    _safe_set(a, 'pcm_av_av_seff_reliability_av_av_RecoveryActionBehaviour', set())
    assert not _is_linked(a, 'pcm_av_av_seff_reliability_av_av_RecoveryActionBehaviour', b2)
    if hasattr(b2, 'seff_reliability_av_av_RecoveryActionBehaviour'):
        assert not _is_linked(b2, 'seff_reliability_av_av_RecoveryActionBehaviour', a)


def test_assoc_failureType__ExternalFailureOccurrenceDescription329_link_reassign_clear():
    a = pcm_av_av_reliability_av_av_ExternalFailureOccurrenceDescription()
    b1 = FailureType()
    b2 = FailureType()
    _safe_set(a, 'pcm_av_av_reliability_av_av_ExternalFailureOccurrenceDescription', b1)
    assert _is_linked(a, 'pcm_av_av_reliability_av_av_ExternalFailureOccurrenceDescription', b1)
    if hasattr(b1, 'FailureType330'):
        assert _is_linked(b1, 'FailureType330', a)
    _safe_set(a, 'pcm_av_av_reliability_av_av_ExternalFailureOccurrenceDescription', b2)
    assert _is_linked(a, 'pcm_av_av_reliability_av_av_ExternalFailureOccurrenceDescription', b2)
    if hasattr(b1, 'FailureType330'):
        assert not _is_linked(b1, 'FailureType330', a)
    if hasattr(b2, 'FailureType330'):
        assert _is_linked(b2, 'FailureType330', a)
    _safe_set(a, 'pcm_av_av_reliability_av_av_ExternalFailureOccurrenceDescription', None)
    assert not _is_linked(a, 'pcm_av_av_reliability_av_av_ExternalFailureOccurrenceDescription', b2)
    if hasattr(b2, 'FailureType330'):
        assert not _is_linked(b2, 'FailureType330', a)


def test_assoc_failureTypes__Repository230_link_reassign_clear():
    a = pcm_av_av_repository_av_av_Repository(repositoryDescription="sample_text")
    b1 = FailureType()
    b2 = FailureType()
...
def test_assoc_guardedBranchTransition_PCMRandomVariable18_link_reassign_clear():
    a = pcm_av_av_core_av_av_PCMRandomVariable()
...
def test_assoc_infrastructureCall__PCMRandomVariable14_link_reassign_clear():
    a = pcm_av_av_core_av_av_PCMRandomVariable()
    b1 = seff_performance_av_av_InfrastructureCall()
    b2 = seff_performance_av_av_InfrastructureCall()
...
def test_assoc_infrastructureSignature__Parameter220_link_reassign_clear():
    a = pcm_av_av_repository_av_av_Parameter(modifier__Parameter="sample_text", parameterName="sample_text")
...
def test_assoc_innerProvidedRole_ProvidedDelegationConnector67_link_reassign_clear():
    a = pcm_av_av_composition_av_av_ProvidedDelegationConnector()
    b1 = OperationProvidedRole()
    b2 = OperationProvidedRole()
    _safe_set(a, 'pcm_av_av_composition_av_av_ProvidedDelegationConnector', b1)
    assert _is_linked(a, 'pcm_av_av_composition_av_av_ProvidedDelegationConnector', b1)
    if hasattr(b1, 'OperationProvidedRole'):
        assert _is_linked(b1, 'OperationProvidedRole', a)
    _safe_set(a, 'pcm_av_av_composition_av_av_ProvidedDelegationConnector', b2)
    assert _is_linked(a, 'pcm_av_av_composition_av_av_ProvidedDelegationConnector', b2)
    if hasattr(b1, 'OperationProvidedRole'):
    ...
    _safe_set(a, 'pcm_av_av_composition_av_av_ProvidedDelegationConnector', None)
    assert not _is_linked(a, 'pcm_av_av_composition_av_av_ProvidedDelegationConnector', b2)
    if hasattr(b2, 'OperationProvidedRole'):
        assert not _is_linked(b2, 'OperationProvidedRole', a)


def test_assoc_innerRequiredRole_RequiredDelegationConnector74_link_reassign_clear():
    a = pcm_av_av_composition_av_av_RequiredDelegationConnector()
    b1 = OperationRequiredRole()
    b2 = OperationRequiredRole()
    _safe_set(a, 'pcm_av_av_composition_av_av_RequiredDelegationConnector', b1)
    assert _is_linked(a, 'pcm_av_av_composition_av_av_RequiredDelegationConnector', b1)
    if hasattr(b1, 'OperationRequiredRole'):
        assert _is_linked(b1, 'OperationRequiredRole', a)
    _safe_set(a, 'pcm_av_av_composition_av_av_RequiredDelegationConnector', b2)
    assert _is_linked(a, 'pcm_av_av_composition_av_av_RequiredDelegationConnector', b2)
    if hasattr(b1, 'OperationRequiredRole'):
    ...
    _safe_set(a, 'pcm_av_av_composition_av_av_RequiredDelegationConnector', None)
    assert not _is_linked(a, 'pcm_av_av_composition_av_av_RequiredDelegationConnector', b2)
    if hasattr(b2, 'OperationRequiredRole'):
        assert not _is_linked(b2, 'OperationRequiredRole', a)


def test_assoc_inputParameterUsages_EntryLevelSystemCall177_link_reassign_clear():
    a = pcm_av_av_usagemodel_av_av_EntryLevelSystemCall(priority=7)
    b1 = VariableUsage()
    b2 = VariableUsage()
    _safe_set(a, 'entryLevelSystemCall_InputParameterUsage', {b1})
    assert _is_linked(a, 'entryLevelSystemCall_InputParameterUsage', b1)
    if hasattr(b1, 'VariableUsage178'):
        assert _is_linked(b1, 'VariableUsage178', a)
    _safe_set(a, 'entryLevelSystemCall_InputParameterUsage', {b2})
    assert _is_linked(a, 'entryLevelSystemCall_InputParameterUsage', b2)
    if hasattr(b1, 'VariableUsage178'):
        assert not _is_linked(b1, 'VariableUsage178', a)
    if hasattr(b2, 'VariableUsage178'):
        assert _is_linked(b2, 'VariableUsage178', a)
    ...
    if hasattr(b2, 'VariableUsage178'):
        assert not _is_linked(b2, 'VariableUsage178', a)


def test_assoc_interArrivalTime_OpenWorkload200_link_reassign_clear():
    a = pcm_av_av_usagemodel_av_av_OpenWorkload()
...
def test_assoc_interface_RequiredCharacterisation241_link_reassign_clear():
    a = pcm_av_av_repository_av_av_RequiredCharacterisation(type="sample_text")
    b1 = Interface()
    b2 = Interface()
    _safe_set(a, 'requiredCharacterisations', b1)
    assert _is_linked(a, 'requiredCharacterisations', b1)
    if hasattr(b1, 'Interface242'):
        assert _is_linked(b1, 'Interface242', a)
    _safe_set(a, 'requiredCharacterisations', b2)
    assert _is_linked(a, 'requiredCharacterisations', b2)
    if hasattr(b1, 'Interface242'):
        assert not _is_linked(b1, 'Interface242', a)
    if hasattr(b2, 'Interface242'):
        assert _is_linked(b2, 'Interface242', a)
    _safe_set(a, 'requiredCharacterisations', None)
    assert not _is_linked(a, 'requiredCharacterisations', b2)
    if hasattr(b2, 'Interface242'):
        assert not _is_linked(b2, 'Interface242', a)


def test_assoc_interface__OperationSignature261_link_reassign_clear():
    a = pcm_av_av_repository_av_av_OperationSignature()
...
def test_assoc_interfaces__Repository229_link_reassign_clear():
    a = pcm_av_av_repository_av_av_Repository(repositoryDescription="sample_text")
    b1 = Interface()
    b2 = Interface()
...
def test_assoc_internalAction__InternalFailureOccurrenceDescription325_link_reassign_clear():
    a = pcm_av_av_reliability_av_av_InternalFailureOccurrenceDescription()
    b1 = InternalAction()
    b2 = InternalAction()
...
def test_assoc_internalFailureOccurrenceDescriptions__InternalAction402_link_reassign_clear():
    a = pcm_av_av_seff_av_av_InternalAction()
    ...
    if hasattr(b1, 'InternalFailureOccurrenceDescription403'):
        assert _is_linked(b1, 'InternalFailureOccurrenceDescription403', a)
    ...
    if hasattr(b1, 'InternalFailureOccurrenceDescription403'):
        assert not _is_linked(b1, 'InternalFailureOccurrenceDescription403', a)
    if hasattr(b2, 'InternalFailureOccurrenceDescription403'):
        assert _is_linked(b2, 'InternalFailureOccurrenceDescription403', a)
    ...
    if hasattr(b2, 'InternalFailureOccurrenceDescription403'):
        assert not _is_linked(b2, 'InternalFailureOccurrenceDescription403', a)


def test_assoc_latency_CommunicationLinkResourceSpecification487_link_reassign_clear():
    a = pcm_av_av_resourceenvironment_av_av_CommunicationLinkResourceSpecification(failureProbability=3.14)
    b1 = PCMRandomVariable()
    b2 = PCMRandomVariable()
    ...
    if hasattr(b1, 'PCMRandomVariable488'):
        assert _is_linked(b1, 'PCMRandomVariable488', a)
    ...
    if hasattr(b1, 'PCMRandomVariable488'):
        assert not _is_linked(b1, 'PCMRandomVariable488', a)
    if hasattr(b2, 'PCMRandomVariable488'):
        assert _is_linked(b2, 'PCMRandomVariable488', a)
    ...
    if hasattr(b2, 'PCMRandomVariable488'):
        assert not _is_linked(b2, 'PCMRandomVariable488', a)


def test_assoc_linkingResource_CommunicationLinkResourceSpecification483_link_reassign_clear():
    a = pcm_av_av_resourceenvironment_av_av_CommunicationLinkResourceSpecification(failureProbability=3.14)
    b1 = LinkingResource()
    b2 = LinkingResource()
    ...
    if hasattr(b1, 'LinkingResource484'):
        assert _is_linked(b1, 'LinkingResource484', a)
    ...
    if hasattr(b1, 'LinkingResource484'):
        assert not _is_linked(b1, 'LinkingResource484', a)
    if hasattr(b2, 'LinkingResource484'):
        assert _is_linked(b2, 'LinkingResource484', a)
    ...
    if hasattr(b2, 'LinkingResource484'):
        assert not _is_linked(b2, 'LinkingResource484', a)


def test_assoc_loopAction_PCMRandomVariable17_link_reassign_clear():
    a = pcm_av_av_core_av_av_PCMRandomVariable()
    b1 = LoopAction()
    b2 = LoopAction()
...
def test_assoc_loop_LoopIteration22_link_reassign_clear():
    a = pcm_av_av_core_av_av_PCMRandomVariable()
    b1 = Loop()
    b2 = Loop()
...
def test_assoc_loop_ScenarioBehaviour187_link_reassign_clear():
    a = pcm_av_av_usagemodel_av_av_ScenarioBehaviour()
    b1 = Loop()
    b2 = Loop()
    _safe_set(a, 'bodyBehaviour_Loop', b1)
    assert _is_linked(a, 'bodyBehaviour_Loop', b1)
    if hasattr(b1, 'Loop188'):
        assert _is_linked(b1, 'Loop188', a)
    _safe_set(a, 'bodyBehaviour_Loop', b2)
    assert _is_linked(a, 'bodyBehaviour_Loop', b2)
    if hasattr(b1, 'Loop188'):
        assert not _is_linked(b1, 'Loop188', a)
    if hasattr(b2, 'Loop188'):
        assert _is_linked(b2, 'Loop188', a)
    _safe_set(a, 'bodyBehaviour_Loop', None)
    assert not _is_linked(a, 'bodyBehaviour_Loop', b2)
    if hasattr(b2, 'Loop188'):
        assert not _is_linked(b2, 'Loop188', a)


def test_assoc_numberOfCalls__InfrastructureCall406_link_reassign_clear():
    a = pcm_av_av_seff_performance_av_av_InfrastructureCall()
    b1 = PCMRandomVariable()
    b2 = PCMRandomVariable()
    _safe_set(a, 'infrastructureCall__PCMRandomVariable', b1)
    assert _is_linked(a, 'infrastructureCall__PCMRandomVariable', b1)
    if hasattr(b1, 'PCMRandomVariable407'):
        assert _is_linked(b1, 'PCMRandomVariable407', a)
    _safe_set(a, 'infrastructureCall__PCMRandomVariable', b2)
    assert _is_linked(a, 'infrastructureCall__PCMRandomVariable', b2)
    if hasattr(b1, 'PCMRandomVariable407'):
        assert not _is_linked(b1, 'PCMRandomVariable407', a)
    if hasattr(b2, 'PCMRandomVariable407'):
        assert _is_linked(b2, 'PCMRandomVariable407', a)
    _safe_set(a, 'infrastructureCall__PCMRandomVariable', None)
    assert not _is_linked(a, 'infrastructureCall__PCMRandomVariable', b2)
    if hasattr(b2, 'PCMRandomVariable407'):
        assert not _is_linked(b2, 'PCMRandomVariable407', a)


def test_assoc_numberOfCalls__ResourceCall419_link_reassign_clear():
    a = pcm_av_av_seff_performance_av_av_ResourceCall()
    b1 = PCMRandomVariable()
    b2 = PCMRandomVariable()
    _safe_set(a, 'resourceCall__PCMRandomVariable', b1)
    assert _is_linked(a, 'resourceCall__PCMRandomVariable', b1)
    if hasattr(b1, 'PCMRandomVariable420'):
        assert _is_linked(b1, 'PCMRandomVariable420', a)
    _safe_set(a, 'resourceCall__PCMRandomVariable', b2)
    assert _is_linked(a, 'resourceCall__PCMRandomVariable', b2)
    if hasattr(b1, 'PCMRandomVariable420'):
        assert not _is_linked(b1, 'PCMRandomVariable420', a)
    if hasattr(b2, 'PCMRandomVariable420'):
        assert _is_linked(b2, 'PCMRandomVariable420', a)
    _safe_set(a, 'resourceCall__PCMRandomVariable', None)
    assert not _is_linked(a, 'resourceCall__PCMRandomVariable', b2)
    if hasattr(b2, 'PCMRandomVariable420'):
        assert not _is_linked(b2, 'PCMRandomVariable420', a)


def test_assoc_openWorkload_PCMRandomVariable23_link_reassign_clear():
    a = pcm_av_av_core_av_av_PCMRandomVariable()
    b1 = OpenWorkload()
    b2 = OpenWorkload()
...
def test_assoc_operationSignature__EntryLevelSystemCall173_link_reassign_clear():
    a = pcm_av_av_usagemodel_av_av_EntryLevelSystemCall(priority=7)
    b1 = OperationSignature()
    b2 = OperationSignature()
    _safe_set(a, 'pcm_av_av_usagemodel_av_av_EntryLevelSystemCall174', b1)
    assert _is_linked(a, 'pcm_av_av_usagemodel_av_av_EntryLevelSystemCall174', b1)
    if hasattr(b1, 'OperationSignature'):
        assert _is_linked(b1, 'OperationSignature', a)
    _safe_set(a, 'pcm_av_av_usagemodel_av_av_EntryLevelSystemCall174', b2)
    assert _is_linked(a, 'pcm_av_av_usagemodel_av_av_EntryLevelSystemCall174', b2)
    if hasattr(b1, 'OperationSignature'):
        assert not _is_linked(b1, 'OperationSignature', a)
    if hasattr(b2, 'OperationSignature'):
        assert _is_linked(b2, 'OperationSignature', a)
    _safe_set(a, 'pcm_av_av_usagemodel_av_av_EntryLevelSystemCall174', None)
    assert not _is_linked(a, 'pcm_av_av_usagemodel_av_av_EntryLevelSystemCall174', b2)
    if hasattr(b2, 'OperationSignature'):
        assert not _is_linked(b2, 'OperationSignature', a)


def test_assoc_operationSignature__Parameter221_link_reassign_clear():
    a = pcm_av_av_repository_av_av_Parameter(modifier__Parameter="sample_text", parameterName="sample_text")
    b1 = OperationSignature()
    b2 = OperationSignature()
    _safe_set(a, 'parameters__OperationSignature', b1)
    assert _is_linked(a, 'parameters__OperationSignature', b1)
    if hasattr(b1, 'OperationSignature222'):
        assert _is_linked(b1, 'OperationSignature222', a)
    _safe_set(a, 'parameters__OperationSignature', b2)
    assert _is_linked(a, 'parameters__OperationSignature', b2)
    if hasattr(b1, 'OperationSignature222'):
        assert not _is_linked(b1, 'OperationSignature222', a)
    if hasattr(b2, 'OperationSignature222'):
        assert _is_linked(b2, 'OperationSignature222', a)
    _safe_set(a, 'parameters__OperationSignature', None)
    assert not _is_linked(a, 'parameters__OperationSignature', b2)
    if hasattr(b2, 'OperationSignature222'):
        assert not _is_linked(b2, 'OperationSignature222', a)


def test_assoc_outerProvidedRole_ProvidedDelegationConnector68_link_reassign_clear():
    a = pcm_av_av_composition_av_av_ProvidedDelegationConnector()
    b1 = OperationProvidedRole()
    b2 = OperationProvidedRole()
    _safe_set(a, 'pcm_av_av_composition_av_av_ProvidedDelegationConnector69', b1)
    assert _is_linked(a, 'pcm_av_av_composition_av_av_ProvidedDelegationConnector69', b1)
    if hasattr(b1, 'OperationProvidedRole70'):
        assert _is_linked(b1, 'OperationProvidedRole70', a)
    _safe_set(a, 'pcm_av_av_composition_av_av_ProvidedDelegationConnector69', b2)
    assert _is_linked(a, 'pcm_av_av_composition_av_av_ProvidedDelegationConnector69', b2)
    if hasattr(b1, 'OperationProvidedRole70'):
        assert not _is_linked(b1, 'OperationProvidedRole70', a)
    if hasattr(b2, 'OperationProvidedRole70'):
        assert _is_linked(b2, 'OperationProvidedRole70', a)
    _safe_set(a, 'pcm_av_av_composition_av_av_ProvidedDelegationConnector69', None)
    assert not _is_linked(a, 'pcm_av_av_composition_av_av_ProvidedDelegationConnector69', b2)
    if hasattr(b2, 'OperationProvidedRole70'):
        assert not _is_linked(b2, 'OperationProvidedRole70', a)


def test_assoc_outerRequiredRole_RequiredDelegationConnector75_link_reassign_clear():
    a = pcm_av_av_composition_av_av_RequiredDelegationConnector()
    b1 = OperationRequiredRole()
    b2 = OperationRequiredRole()
    _safe_set(a, 'pcm_av_av_composition_av_av_RequiredDelegationConnector76', b1)
    assert _is_linked(a, 'pcm_av_av_composition_av_av_RequiredDelegationConnector76', b1)
    if hasattr(b1, 'OperationRequiredRole77'):
        assert _is_linked(b1, 'OperationRequiredRole77', a)
    _safe_set(a, 'pcm_av_av_composition_av_av_RequiredDelegationConnector76', b2)
    assert _is_linked(a, 'pcm_av_av_composition_av_av_RequiredDelegationConnector76', b2)
    if hasattr(b1, 'OperationRequiredRole77'):
        assert not _is_linked(b1, 'OperationRequiredRole77', a)
    if hasattr(b2, 'OperationRequiredRole77'):
        assert _is_linked(b2, 'OperationRequiredRole77', a)
    _safe_set(a, 'pcm_av_av_composition_av_av_RequiredDelegationConnector76', None)
    assert not _is_linked(a, 'pcm_av_av_composition_av_av_RequiredDelegationConnector76', b2)
    if hasattr(b2, 'OperationRequiredRole77'):
        assert not _is_linked(b2, 'OperationRequiredRole77', a)


def test_assoc_outputParameterUsages_EntryLevelSystemCall175_link_reassign_clear():
    a = pcm_av_av_usagemodel_av_av_EntryLevelSystemCall(priority=7)
    b1 = VariableUsage()
    b2 = VariableUsage()
    _safe_set(a, 'entryLevelSystemCall_OutputParameterUsage', {b1})
    assert _is_linked(a, 'entryLevelSystemCall_OutputParameterUsage', b1)
    if hasattr(b1, 'VariableUsage176'):
        assert _is_linked(b1, 'VariableUsage176', a)
    _safe_set(a, 'entryLevelSystemCall_OutputParameterUsage', {b2})
    assert _is_linked(a, 'entryLevelSystemCall_OutputParameterUsage', b2)
    if hasattr(b1, 'VariableUsage176'):
        assert not _is_linked(b1, 'VariableUsage176', a)
    if hasattr(b2, 'VariableUsage176'):
        assert _is_linked(b2, 'VariableUsage176', a)
    ...
    if hasattr(b2, 'VariableUsage176'):
        assert not _is_linked(b2, 'VariableUsage176', a)


def test_assoc_parameter240_link_reassign_clear():
    a = pcm_av_av_repository_av_av_RequiredCharacterisation(type="sample_text")
    b1 = Parameter()
    b2 = Parameter()
    _safe_set(a, 'pcm_av_av_repository_av_av_RequiredCharacterisation', b1)
    assert _is_linked(a, 'pcm_av_av_repository_av_av_RequiredCharacterisation', b1)
    if hasattr(b1, 'Parameter'):
        assert _is_linked(b1, 'Parameter', a)
    _safe_set(a, 'pcm_av_av_repository_av_av_RequiredCharacterisation', b2)
    assert _is_linked(a, 'pcm_av_av_repository_av_av_RequiredCharacterisation', b2)
    if hasattr(b1, 'Parameter'):
        assert not _is_linked(b1, 'Parameter', a)
    if hasattr(b2, 'Parameter'):
        assert _is_linked(b2, 'Parameter', a)
    _safe_set(a, 'pcm_av_av_repository_av_av_RequiredCharacterisation', None)
    assert not _is_linked(a, 'pcm_av_av_repository_av_av_RequiredCharacterisation', b2)
    if hasattr(b2, 'Parameter'):
        assert not _is_linked(b2, 'Parameter', a)


def test_assoc_parameter__ResourceSignature287_link_reassign_clear():
    a = pcm_av_av_resourcetype_av_av_ResourceSignature(resourceServiceId=7)
    b1 = Parameter()
    b2 = Parameter()
    _safe_set(a, 'resourceSignature__Parameter', b1)
    assert _is_linked(a, 'resourceSignature__Parameter', b1)
    if hasattr(b1, 'Parameter288'):
        assert _is_linked(b1, 'Parameter288', a)
    _safe_set(a, 'resourceSignature__Parameter', b2)
    assert _is_linked(a, 'resourceSignature__Parameter', b2)
    if hasattr(b1, 'Parameter288'):
        assert not _is_linked(b1, 'Parameter288', a)
    if hasattr(b2, 'Parameter288'):
        assert _is_linked(b2, 'Parameter288', a)
    _safe_set(a, 'resourceSignature__Parameter', None)
    assert not _is_linked(a, 'resourceSignature__Parameter', b2)
    if hasattr(b2, 'Parameter288'):
        assert not _is_linked(b2, 'Parameter288', a)
...
def test_assoc_parametricResourceDemand_PCMRandomVariable16_link_reassign_clear():
    a = pcm_av_av_core_av_av_PCMRandomVariable()
    b1 = seff_performance_av_av_ParametricResourceDemand()
    b2 = seff_performance_av_av_ParametricResourceDemand()
...
def test_assoc_parentCompleteComponentTypes213_link_reassign_clear():
    a = pcm_av_av_repository_av_av_ImplementationComponentType(componentType="sample_text")
    b1 = CompleteComponentType()
    b2 = CompleteComponentType()
    _safe_set(a, 'pcm_av_av_repository_av_av_ImplementationComponentType', {b1})
    assert _is_linked(a, 'pcm_av_av_repository_av_av_ImplementationComponentType', b1)
    if hasattr(b1, 'CompleteComponentType'):
        assert _is_linked(b1, 'CompleteComponentType', a)
    _safe_set(a, 'pcm_av_av_repository_av_av_ImplementationComponentType', {b2})
    assert _is_linked(a, 'pcm_av_av_repository_av_av_ImplementationComponentType', b2)
    if hasattr(b1, 'CompleteComponentType'):
    ...
    _safe_set(a, 'pcm_av_av_repository_av_av_ImplementationComponentType', set())
    assert not _is_linked(a, 'pcm_av_av_repository_av_av_ImplementationComponentType', b2)
    if hasattr(b2, 'CompleteComponentType'):
        assert not _is_linked(b2, 'CompleteComponentType', a)


def test_assoc_parentInterfaces__Interface233_link_reassign_clear():
    a = pcm_av_av_repository_av_av_Interface()
    b1 = Interface()
    b2 = Interface()
    _safe_set(a, 'pcm_av_av_repository_av_av_Interface', {b1})
    assert _is_linked(a, 'pcm_av_av_repository_av_av_Interface', b1)
    if hasattr(b1, 'Interface234'):
        assert _is_linked(b1, 'Interface234', a)
    _safe_set(a, 'pcm_av_av_repository_av_av_Interface', {b2})
    assert _is_linked(a, 'pcm_av_av_repository_av_av_Interface', b2)
    if hasattr(b1, 'Interface234'):
        assert not _is_linked(b1, 'Interface234', a)
    if hasattr(b2, 'Interface234'):
        assert _is_linked(b2, 'Interface234', a)
    _safe_set(a, 'pcm_av_av_repository_av_av_Interface', set())
    assert not _is_linked(a, 'pcm_av_av_repository_av_av_Interface', b2)
    if hasattr(b2, 'Interface234'):
        assert not _is_linked(b2, 'Interface234', a)


def test_assoc_parentProvidesComponentTypes278_link_reassign_clear():
    a = pcm_av_av_repository_av_av_CompleteComponentType()
    b1 = ProvidesComponentType()
    b2 = ProvidesComponentType()
    _safe_set(a, 'pcm_av_av_repository_av_av_CompleteComponentType', {b1})
    assert _is_linked(a, 'pcm_av_av_repository_av_av_CompleteComponentType', b1)
    if hasattr(b1, 'ProvidesComponentType'):
        assert _is_linked(b1, 'ProvidesComponentType', a)
    _safe_set(a, 'pcm_av_av_repository_av_av_CompleteComponentType', {b2})
    assert _is_linked(a, 'pcm_av_av_repository_av_av_CompleteComponentType', b2)
    if hasattr(b1, 'ProvidesComponentType'):
    ...
    _safe_set(a, 'pcm_av_av_repository_av_av_CompleteComponentType', set())
    assert not _is_linked(a, 'pcm_av_av_repository_av_av_CompleteComponentType', b2)
    if hasattr(b2, 'ProvidesComponentType'):
        assert not _is_linked(b2, 'ProvidesComponentType', a)


def test_assoc_passiveResource_BasicComponent211_link_reassign_clear():
    a = pcm_av_av_repository_av_av_BasicComponent()
    b1 = PassiveResource()
    b2 = PassiveResource()
    _safe_set(a, 'basicComponent_PassiveResource', {b1})
    assert _is_linked(a, 'basicComponent_PassiveResource', b1)
    if hasattr(b1, 'PassiveResource212'):
        assert _is_linked(b1, 'PassiveResource212', a)
    _safe_set(a, 'basicComponent_PassiveResource', {b2})
    assert _is_linked(a, 'basicComponent_PassiveResource', b2)
    if hasattr(b1, 'PassiveResource212'):
        assert not _is_linked(b1, 'PassiveResource212', a)
    if hasattr(b2, 'PassiveResource212'):
        assert _is_linked(b2, 'PassiveResource212', a)
    _safe_set(a, 'basicComponent_PassiveResource', set())
    assert not _is_linked(a, 'basicComponent_PassiveResource', b2)
    if hasattr(b2, 'PassiveResource212'):
        assert not _is_linked(b2, 'PassiveResource212', a)


def test_assoc_passiveResource_capacity_PCMRandomVariable12_link_reassign_clear():
    a = pcm_av_av_core_av_av_PCMRandomVariable()
    b1 = PassiveResource()
    b2 = PassiveResource()
...
def test_assoc_passiveresource_AcquireAction387_link_reassign_clear():
    a = pcm_av_av_seff_av_av_AcquireAction(timeout=True, timeoutValue=3.14)
    b1 = PassiveResource()
    b2 = PassiveResource()
    _safe_set(a, 'pcm_av_av_seff_av_av_AcquireAction', b1)
    assert _is_linked(a, 'pcm_av_av_seff_av_av_AcquireAction', b1)
    if hasattr(b1, 'PassiveResource388'):
        assert _is_linked(b1, 'PassiveResource388', a)
    _safe_set(a, 'pcm_av_av_seff_av_av_AcquireAction', b2)
    assert _is_linked(a, 'pcm_av_av_seff_av_av_AcquireAction', b2)
    if hasattr(b1, 'PassiveResource388'):
        assert not _is_linked(b1, 'PassiveResource388', a)
    if hasattr(b2, 'PassiveResource388'):
        assert _is_linked(b2, 'PassiveResource388', a)
    _safe_set(a, 'pcm_av_av_seff_av_av_AcquireAction', None)
    assert not _is_linked(a, 'pcm_av_av_seff_av_av_AcquireAction', b2)
    if hasattr(b2, 'PassiveResource388'):
        assert not _is_linked(b2, 'PassiveResource388', a)


def test_assoc_primaryBehaviour__RecoveryAction429_link_reassign_clear():
    a = pcm_av_av_seff_reliability_av_av_RecoveryAction()
    b1 = seff_reliability_av_av_RecoveryActionBehaviour()
    b2 = seff_reliability_av_av_RecoveryActionBehaviour()
    _safe_set(a, 'pcm_av_av_seff_reliability_av_av_RecoveryAction', b1)
    assert _is_linked(a, 'pcm_av_av_seff_reliability_av_av_RecoveryAction', b1)
    if hasattr(b1, 'seff_reliability_av_av_RecoveryActionBehaviour430'):
        assert _is_linked(b1, 'seff_reliability_av_av_RecoveryActionBehaviour430', a)
    _safe_set(a, 'pcm_av_av_seff_reliability_av_av_RecoveryAction', b2)
    assert _is_linked(a, 'pcm_av_av_seff_reliability_av_av_RecoveryAction', b2)
    if hasattr(b1, 'seff_reliability_av_av_RecoveryActionBehaviour430'):
        assert not _is_linked(b1, 'seff_reliability_av_av_RecoveryActionBehaviour430', a)
    if hasattr(b2, 'seff_reliability_av_av_RecoveryActionBehaviour430'):
        assert _is_linked(b2, 'seff_reliability_av_av_RecoveryActionBehaviour430', a)
    _safe_set(a, 'pcm_av_av_seff_reliability_av_av_RecoveryAction', None)
    assert not _is_linked(a, 'pcm_av_av_seff_reliability_av_av_RecoveryAction', b2)
    if hasattr(b2, 'seff_reliability_av_av_RecoveryActionBehaviour430'):
        assert not _is_linked(b2, 'seff_reliability_av_av_RecoveryActionBehaviour430', a)


def test_assoc_processingRate_ProcessingResourceSpecification479_link_reassign_clear():
    a = pcm_av_av_resourceenvironment_av_av_ProcessingResourceSpecification(MTTF=3.14, MTTR=3.14, numberOfReplicas=7, requiredByContainer=True)
    b1 = PCMRandomVariable()
    b2 = PCMRandomVariable()
...
def test_assoc_processingResourceSpecification_processingRate_PCMRandomVariable26_link_reassign_clear():
    a = pcm_av_av_core_av_av_PCMRandomVariable()
...
def test_assoc_processingResourceType__HardwareInducedFailureType323_link_reassign_clear():
    a = pcm_av_av_reliability_av_av_HardwareInducedFailureType()
    b1 = ProcessingResourceType()
    b2 = ProcessingResourceType()
...
def test_assoc_protocols__Interface235_link_reassign_clear():
    a = pcm_av_av_repository_av_av_Interface()
    b1 = Protocol()
    b2 = Protocol()
    _safe_set(a, 'pcm_av_av_repository_av_av_Interface236', {b1})
    assert _is_linked(a, 'pcm_av_av_repository_av_av_Interface236', b1)
    if hasattr(b1, 'Protocol'):
        assert _is_linked(b1, 'Protocol', a)
    _safe_set(a, 'pcm_av_av_repository_av_av_Interface236', {b2})
    assert _is_linked(a, 'pcm_av_av_repository_av_av_Interface236', b2)
    if hasattr(b1, 'Protocol'):
        assert not _is_linked(b1, 'Protocol', a)
    if hasattr(b2, 'Protocol'):
        assert _is_linked(b2, 'Protocol', a)
    _safe_set(a, 'pcm_av_av_repository_av_av_Interface236', set())
    assert not _is_linked(a, 'pcm_av_av_repository_av_av_Interface236', b2)
    if hasattr(b2, 'Protocol'):
        assert not _is_linked(b2, 'Protocol', a)


def test_assoc_providedRole_AssemblyConnector86_link_reassign_clear():
    a = pcm_av_av_composition_av_av_AssemblyConnector()
    b1 = OperationProvidedRole()
    b2 = OperationProvidedRole()
    _safe_set(a, 'pcm_av_av_composition_av_av_AssemblyConnector87', b1)
    assert _is_linked(a, 'pcm_av_av_composition_av_av_AssemblyConnector87', b1)
    if hasattr(b1, 'OperationProvidedRole88'):
        assert _is_linked(b1, 'OperationProvidedRole88', a)
    _safe_set(a, 'pcm_av_av_composition_av_av_AssemblyConnector87', b2)
    assert _is_linked(a, 'pcm_av_av_composition_av_av_AssemblyConnector87', b2)
    if hasattr(b1, 'OperationProvidedRole88'):
        assert not _is_linked(b1, 'OperationProvidedRole88', a)
    if hasattr(b2, 'OperationProvidedRole88'):
        assert _is_linked(b2, 'OperationProvidedRole88', a)
    _safe_set(a, 'pcm_av_av_composition_av_av_AssemblyConnector87', None)
    assert not _is_linked(a, 'pcm_av_av_composition_av_av_AssemblyConnector87', b2)
    if hasattr(b2, 'OperationProvidedRole88'):
        assert not _is_linked(b2, 'OperationProvidedRole88', a)


def test_assoc_providedRole_EntryLevelSystemCall171_link_reassign_clear():
    a = pcm_av_av_usagemodel_av_av_EntryLevelSystemCall(priority=7)
    b1 = OperationProvidedRole()
    b2 = OperationProvidedRole()
    _safe_set(a, 'pcm_av_av_usagemodel_av_av_EntryLevelSystemCall', b1)
    assert _is_linked(a, 'pcm_av_av_usagemodel_av_av_EntryLevelSystemCall', b1)
    if hasattr(b1, 'OperationProvidedRole172'):
        assert _is_linked(b1, 'OperationProvidedRole172', a)
    _safe_set(a, 'pcm_av_av_usagemodel_av_av_EntryLevelSystemCall', b2)
    assert _is_linked(a, 'pcm_av_av_usagemodel_av_av_EntryLevelSystemCall', b2)
    if hasattr(b1, 'OperationProvidedRole172'):
        assert not _is_linked(b1, 'OperationProvidedRole172', a)
    if hasattr(b2, 'OperationProvidedRole172'):
        assert _is_linked(b2, 'OperationProvidedRole172', a)
    _safe_set(a, 'pcm_av_av_usagemodel_av_av_EntryLevelSystemCall', None)
    assert not _is_linked(a, 'pcm_av_av_usagemodel_av_av_EntryLevelSystemCall', b2)
    if hasattr(b2, 'OperationProvidedRole172'):
        assert not _is_linked(b2, 'OperationProvidedRole172', a)


def test_assoc_providingAssemblyContext_AssemblyConnector83_link_reassign_clear():
    a = pcm_av_av_composition_av_av_AssemblyConnector()
    b1 = composition_av_av_AssemblyContext()
    b2 = composition_av_av_AssemblyContext()
    _safe_set(a, 'pcm_av_av_composition_av_av_AssemblyConnector84', b1)
    assert _is_linked(a, 'pcm_av_av_composition_av_av_AssemblyConnector84', b1)
    if hasattr(b1, 'composition_av_av_AssemblyContext85'):
        assert _is_linked(b1, 'composition_av_av_AssemblyContext85', a)
    _safe_set(a, 'pcm_av_av_composition_av_av_AssemblyConnector84', b2)
    assert _is_linked(a, 'pcm_av_av_composition_av_av_AssemblyConnector84', b2)
    if hasattr(b1, 'composition_av_av_AssemblyContext85'):
        assert not _is_linked(b1, 'composition_av_av_AssemblyContext85', a)
    if hasattr(b2, 'composition_av_av_AssemblyContext85'):
        assert _is_linked(b2, 'composition_av_av_AssemblyContext85', a)
    _safe_set(a, 'pcm_av_av_composition_av_av_AssemblyConnector84', None)
    assert not _is_linked(a, 'pcm_av_av_composition_av_av_AssemblyConnector84', b2)
    if hasattr(b2, 'composition_av_av_AssemblyContext85'):
        assert not _is_linked(b2, 'composition_av_av_AssemblyContext85', a)


def test_assoc_qosAnnotations_System457_link_reassign_clear():
    a = pcm_av_av_system_av_av_System()
    b1 = QoSAnnotations()
    b2 = QoSAnnotations()
    _safe_set(a, 'system_QoSAnnotations', {b1})
    assert _is_linked(a, 'system_QoSAnnotations', b1)
    if hasattr(b1, 'QoSAnnotations458'):
        assert _is_linked(b1, 'QoSAnnotations458', a)
    _safe_set(a, 'system_QoSAnnotations', {b2})
    assert _is_linked(a, 'system_QoSAnnotations', b2)
    if hasattr(b1, 'QoSAnnotations458'):
        assert not _is_linked(b1, 'QoSAnnotations458', a)
    if hasattr(b2, 'QoSAnnotations458'):
        assert _is_linked(b2, 'QoSAnnotations458', a)
    _safe_set(a, 'system_QoSAnnotations', set())
    assert not _is_linked(a, 'system_QoSAnnotations', b2)
    if hasattr(b2, 'QoSAnnotations458'):
        assert not _is_linked(b2, 'QoSAnnotations458', a)


def test_assoc_recoveryActionBehaviours__RecoveryAction431_link_reassign_clear():
    a = pcm_av_av_seff_reliability_av_av_RecoveryAction()
    b1 = seff_reliability_av_av_RecoveryActionBehaviour()
    b2 = seff_reliability_av_av_RecoveryActionBehaviour()
...
def test_assoc_recoveryAction__RecoveryActionBehaviour428_link_reassign_clear():
    a = pcm_av_av_seff_reliability_av_av_RecoveryActionBehaviour()
    b1 = seff_reliability_av_av_RecoveryAction()
    b2 = seff_reliability_av_av_RecoveryAction()
...
def test_assoc_repository__Interface238_link_reassign_clear():
    a = pcm_av_av_repository_av_av_Interface()
    b1 = Repository()
    b2 = Repository()
    _safe_set(a, 'interfaces__Repository', b1)
    assert _is_linked(a, 'interfaces__Repository', b1)
    if hasattr(b1, 'Repository239'):
        assert _is_linked(b1, 'Repository239', a)
    _safe_set(a, 'interfaces__Repository', b2)
    assert _is_linked(a, 'interfaces__Repository', b2)
    if hasattr(b1, 'Repository239'):
        assert not _is_linked(b1, 'Repository239', a)
    if hasattr(b2, 'Repository239'):
        assert _is_linked(b2, 'Repository239', a)
    _safe_set(a, 'interfaces__Repository', None)
    assert not _is_linked(a, 'interfaces__Repository', b2)
    if hasattr(b2, 'Repository239'):
        assert not _is_linked(b2, 'Repository239', a)


def test_assoc_requiredCharacterisations237_link_reassign_clear():
    a = pcm_av_av_repository_av_av_Interface()
...
def test_assoc_requiredResource_ParametricResourceDemand423_link_reassign_clear():
    a = pcm_av_av_seff_performance_av_av_ParametricResourceDemand()
    b1 = ProcessingResourceType()
    b2 = ProcessingResourceType()
    _safe_set(a, 'pcm_av_av_seff_performance_av_av_ParametricResourceDemand', b1)
    assert _is_linked(a, 'pcm_av_av_seff_performance_av_av_ParametricResourceDemand', b1)
    if hasattr(b1, 'ProcessingResourceType424'):
        assert _is_linked(b1, 'ProcessingResourceType424', a)
    _safe_set(a, 'pcm_av_av_seff_performance_av_av_ParametricResourceDemand', b2)
    assert _is_linked(a, 'pcm_av_av_seff_performance_av_av_ParametricResourceDemand', b2)
    if hasattr(b1, 'ProcessingResourceType424'):
        assert not _is_linked(b1, 'ProcessingResourceType424', a)
    if hasattr(b2, 'ProcessingResourceType424'):
        assert _is_linked(b2, 'ProcessingResourceType424', a)
    _safe_set(a, 'pcm_av_av_seff_performance_av_av_ParametricResourceDemand', None)
    assert not _is_linked(a, 'pcm_av_av_seff_performance_av_av_ParametricResourceDemand', b2)
    if hasattr(b2, 'ProcessingResourceType424'):
        assert not _is_linked(b2, 'ProcessingResourceType424', a)


def test_assoc_requiredRole_AssemblyConnector89_link_reassign_clear():
    a = pcm_av_av_composition_av_av_AssemblyConnector()
    b1 = OperationRequiredRole()
    b2 = OperationRequiredRole()
    _safe_set(a, 'pcm_av_av_composition_av_av_AssemblyConnector90', b1)
    assert _is_linked(a, 'pcm_av_av_composition_av_av_AssemblyConnector90', b1)
    if hasattr(b1, 'OperationRequiredRole91'):
        assert _is_linked(b1, 'OperationRequiredRole91', a)
    _safe_set(a, 'pcm_av_av_composition_av_av_AssemblyConnector90', b2)
    assert _is_linked(a, 'pcm_av_av_composition_av_av_AssemblyConnector90', b2)
    if hasattr(b1, 'OperationRequiredRole91'):
        assert not _is_linked(b1, 'OperationRequiredRole91', a)
    if hasattr(b2, 'OperationRequiredRole91'):
        assert _is_linked(b2, 'OperationRequiredRole91', a)
    _safe_set(a, 'pcm_av_av_composition_av_av_AssemblyConnector90', None)
    assert not _is_linked(a, 'pcm_av_av_composition_av_av_AssemblyConnector90', b2)
    if hasattr(b2, 'OperationRequiredRole91'):
        assert not _is_linked(b2, 'OperationRequiredRole91', a)


def test_assoc_requiredRole__InfrastructureCall409_link_reassign_clear():
    a = pcm_av_av_seff_performance_av_av_InfrastructureCall()
    b1 = InfrastructureRequiredRole()
    b2 = InfrastructureRequiredRole()
    _safe_set(a, 'pcm_av_av_seff_performance_av_av_InfrastructureCall410', b1)
    assert _is_linked(a, 'pcm_av_av_seff_performance_av_av_InfrastructureCall410', b1)
    if hasattr(b1, 'InfrastructureRequiredRole411'):
        assert _is_linked(b1, 'InfrastructureRequiredRole411', a)
    _safe_set(a, 'pcm_av_av_seff_performance_av_av_InfrastructureCall410', b2)
    assert _is_linked(a, 'pcm_av_av_seff_performance_av_av_InfrastructureCall410', b2)
    if hasattr(b1, 'InfrastructureRequiredRole411'):
        assert not _is_linked(b1, 'InfrastructureRequiredRole411', a)
    if hasattr(b2, 'InfrastructureRequiredRole411'):
        assert _is_linked(b2, 'InfrastructureRequiredRole411', a)
    _safe_set(a, 'pcm_av_av_seff_performance_av_av_InfrastructureCall410', None)
    assert not _is_linked(a, 'pcm_av_av_seff_performance_av_av_InfrastructureCall410', b2)
    if hasattr(b2, 'InfrastructureRequiredRole411'):
        assert not _is_linked(b2, 'InfrastructureRequiredRole411', a)


def test_assoc_requiringAssemblyContext_AssemblyConnector81_link_reassign_clear():
    a = pcm_av_av_composition_av_av_AssemblyConnector()
    b1 = composition_av_av_AssemblyContext()
    b2 = composition_av_av_AssemblyContext()
    _safe_set(a, 'pcm_av_av_composition_av_av_AssemblyConnector', b1)
    assert _is_linked(a, 'pcm_av_av_composition_av_av_AssemblyConnector', b1)
    if hasattr(b1, 'composition_av_av_AssemblyContext82'):
        assert _is_linked(b1, 'composition_av_av_AssemblyContext82', a)
    _safe_set(a, 'pcm_av_av_composition_av_av_AssemblyConnector', b2)
    assert _is_linked(a, 'pcm_av_av_composition_av_av_AssemblyConnector', b2)
    if hasattr(b1, 'composition_av_av_AssemblyContext82'):
        assert not _is_linked(b1, 'composition_av_av_AssemblyContext82', a)
    if hasattr(b2, 'composition_av_av_AssemblyContext82'):
        assert _is_linked(b2, 'composition_av_av_AssemblyContext82', a)
    _safe_set(a, 'pcm_av_av_composition_av_av_AssemblyConnector', None)
    assert not _is_linked(a, 'pcm_av_av_composition_av_av_AssemblyConnector', b2)
    if hasattr(b2, 'composition_av_av_AssemblyContext82'):
        assert not _is_linked(b2, 'composition_av_av_AssemblyContext82', a)


def test_assoc_resourceCall__PCMRandomVariable15_link_reassign_clear():
    a = pcm_av_av_core_av_av_PCMRandomVariable()
    b1 = seff_performance_av_av_ResourceCall()
    b2 = seff_performance_av_av_ResourceCall()
...
def test_assoc_resourceContainer_AllocationContext491_link_reassign_clear():
    a = pcm_av_av_allocation_av_av_AllocationContext()
    b1 = ResourceContainer()
    b2 = ResourceContainer()
    _safe_set(a, 'pcm_av_av_allocation_av_av_AllocationContext', b1)
    assert _is_linked(a, 'pcm_av_av_allocation_av_av_AllocationContext', b1)
    if hasattr(b1, 'ResourceContainer492'):
        assert _is_linked(b1, 'ResourceContainer492', a)
    _safe_set(a, 'pcm_av_av_allocation_av_av_AllocationContext', b2)
    assert _is_linked(a, 'pcm_av_av_allocation_av_av_AllocationContext', b2)
    if hasattr(b1, 'ResourceContainer492'):
        assert not _is_linked(b1, 'ResourceContainer492', a)
    if hasattr(b2, 'ResourceContainer492'):
        assert _is_linked(b2, 'ResourceContainer492', a)
    _safe_set(a, 'pcm_av_av_allocation_av_av_AllocationContext', None)
    assert not _is_linked(a, 'pcm_av_av_allocation_av_av_AllocationContext', b2)
    if hasattr(b2, 'ResourceContainer492'):
        assert not _is_linked(b2, 'ResourceContainer492', a)


def test_assoc_resourceContainer_ProcessingResourceSpecification481_link_reassign_clear():
    a = pcm_av_av_resourceenvironment_av_av_ProcessingResourceSpecification(MTTF=3.14, MTTR=3.14, numberOfReplicas=7, requiredByContainer=True)
    b1 = ResourceContainer()
    b2 = ResourceContainer()
...
def test_assoc_resourceInterface__ResourceSignature289_link_reassign_clear():
    a = pcm_av_av_resourcetype_av_av_ResourceSignature(resourceServiceId=7)
    ...
    if hasattr(b1, 'ResourceInterface290'):
        assert _is_linked(b1, 'ResourceInterface290', a)
    _safe_set(a, 'resourceSignatures__ResourceInterface', b2)
    assert _is_linked(a, 'resourceSignatures__ResourceInterface', b2)
    if hasattr(b1, 'ResourceInterface290'):
        assert not _is_linked(b1, 'ResourceInterface290', a)
    if hasattr(b2, 'ResourceInterface290'):
        assert _is_linked(b2, 'ResourceInterface290', a)
    _safe_set(a, 'resourceSignatures__ResourceInterface', None)
    assert not _is_linked(a, 'resourceSignatures__ResourceInterface', b2)
    if hasattr(b2, 'ResourceInterface290'):
        assert not _is_linked(b2, 'ResourceInterface290', a)


def test_assoc_resourceRequiredDelegationConnectors_ComposedStructure40_link_reassign_clear():
    a = pcm_av_av_composition_av_av_ComposedStructure()
    b1 = composition_av_av_ResourceRequiredDelegationConnector()
    b2 = composition_av_av_ResourceRequiredDelegationConnector()
...
def test_assoc_resourceRequiredRole__ResourceCall414_link_reassign_clear():
    a = pcm_av_av_seff_performance_av_av_ResourceCall()
    b1 = entity_av_av_ResourceRequiredRole()
    b2 = entity_av_av_ResourceRequiredRole()
    _safe_set(a, 'pcm_av_av_seff_performance_av_av_ResourceCall', b1)
    assert _is_linked(a, 'pcm_av_av_seff_performance_av_av_ResourceCall', b1)
    if hasattr(b1, 'entity_av_av_ResourceRequiredRole415'):
        assert _is_linked(b1, 'entity_av_av_ResourceRequiredRole415', a)
    _safe_set(a, 'pcm_av_av_seff_performance_av_av_ResourceCall', b2)
    assert _is_linked(a, 'pcm_av_av_seff_performance_av_av_ResourceCall', b2)
    if hasattr(b1, 'entity_av_av_ResourceRequiredRole415'):
        assert not _is_linked(b1, 'entity_av_av_ResourceRequiredRole415', a)
    if hasattr(b2, 'entity_av_av_ResourceRequiredRole415'):
        assert _is_linked(b2, 'entity_av_av_ResourceRequiredRole415', a)
    _safe_set(a, 'pcm_av_av_seff_performance_av_av_ResourceCall', None)
    assert not _is_linked(a, 'pcm_av_av_seff_performance_av_av_ResourceCall', b2)
    if hasattr(b2, 'entity_av_av_ResourceRequiredRole415'):
        assert not _is_linked(b2, 'entity_av_av_ResourceRequiredRole415', a)


def test_assoc_resourceSignature__Parameter224_link_reassign_clear():
    a = pcm_av_av_repository_av_av_Parameter(modifier__Parameter="sample_text", parameterName="sample_text")
...
def test_assoc_returnType__OperationSignature264_link_reassign_clear():
    a = pcm_av_av_repository_av_av_OperationSignature()
    b1 = DataType()
    b2 = DataType()
    _safe_set(a, 'pcm_av_av_repository_av_av_OperationSignature', b1)
    assert _is_linked(a, 'pcm_av_av_repository_av_av_OperationSignature', b1)
    if hasattr(b1, 'DataType265'):
        assert _is_linked(b1, 'DataType265', a)
    _safe_set(a, 'pcm_av_av_repository_av_av_OperationSignature', b2)
    assert _is_linked(a, 'pcm_av_av_repository_av_av_OperationSignature', b2)
    if hasattr(b1, 'DataType265'):
        assert not _is_linked(b1, 'DataType265', a)
    if hasattr(b2, 'DataType265'):
        assert _is_linked(b2, 'DataType265', a)
    _safe_set(a, 'pcm_av_av_repository_av_av_OperationSignature', None)
    assert not _is_linked(a, 'pcm_av_av_repository_av_av_OperationSignature', b2)
    if hasattr(b2, 'DataType265'):
        assert not _is_linked(b2, 'DataType265', a)


def test_assoc_role_ExternalService382_link_reassign_clear():
    a = pcm_av_av_seff_av_av_ExternalCallAction(retryCount=7)
    b1 = OperationRequiredRole()
    b2 = OperationRequiredRole()
    _safe_set(a, 'pcm_av_av_seff_av_av_ExternalCallAction383', b1)
    assert _is_linked(a, 'pcm_av_av_seff_av_av_ExternalCallAction383', b1)
    if hasattr(b1, 'OperationRequiredRole384'):
        assert _is_linked(b1, 'OperationRequiredRole384', a)
    _safe_set(a, 'pcm_av_av_seff_av_av_ExternalCallAction383', b2)
    assert _is_linked(a, 'pcm_av_av_seff_av_av_ExternalCallAction383', b2)
    if hasattr(b1, 'OperationRequiredRole384'):
        assert not _is_linked(b1, 'OperationRequiredRole384', a)
    if hasattr(b2, 'OperationRequiredRole384'):
        assert _is_linked(b2, 'OperationRequiredRole384', a)
    _safe_set(a, 'pcm_av_av_seff_av_av_ExternalCallAction383', None)
    assert not _is_linked(a, 'pcm_av_av_seff_av_av_ExternalCallAction383', b2)
    if hasattr(b2, 'OperationRequiredRole384'):
        assert not _is_linked(b2, 'OperationRequiredRole384', a)


def test_assoc_schedulingPolicy474_link_reassign_clear():
    a = pcm_av_av_resourceenvironment_av_av_ProcessingResourceSpecification(MTTF=3.14, MTTR=3.14, numberOfReplicas=7, requiredByContainer=True)
    b1 = SchedulingPolicy()
    b2 = SchedulingPolicy()
    _safe_set(a, 'pcm_av_av_resourceenvironment_av_av_ProcessingResourceSpecification', b1)
    assert _is_linked(a, 'pcm_av_av_resourceenvironment_av_av_ProcessingResourceSpecification', b1)
    if hasattr(b1, 'SchedulingPolicy475'):
        assert _is_linked(b1, 'SchedulingPolicy475', a)
    _safe_set(a, 'pcm_av_av_resourceenvironment_av_av_ProcessingResourceSpecification', b2)
    assert _is_linked(a, 'pcm_av_av_resourceenvironment_av_av_ProcessingResourceSpecification', b2)
    if hasattr(b1, 'SchedulingPolicy475'):
        assert not _is_linked(b1, 'SchedulingPolicy475', a)
    if hasattr(b2, 'SchedulingPolicy475'):
        assert _is_linked(b2, 'SchedulingPolicy475', a)
    _safe_set(a, 'pcm_av_av_resourceenvironment_av_av_ProcessingResourceSpecification', None)
    assert not _is_linked(a, 'pcm_av_av_resourceenvironment_av_av_ProcessingResourceSpecification', b2)
    if hasattr(b2, 'SchedulingPolicy475'):
        assert not _is_linked(b2, 'SchedulingPolicy475', a)


def test_assoc_serviceEffectSpecifications__BasicComponent210_link_reassign_clear():
    a = pcm_av_av_repository_av_av_BasicComponent()
...
def test_assoc_signature__InfrastructureCall404_link_reassign_clear():
    a = pcm_av_av_seff_performance_av_av_InfrastructureCall()
    b1 = InfrastructureSignature()
    b2 = InfrastructureSignature()
    _safe_set(a, 'pcm_av_av_seff_performance_av_av_InfrastructureCall', b1)
    assert _is_linked(a, 'pcm_av_av_seff_performance_av_av_InfrastructureCall', b1)
    if hasattr(b1, 'InfrastructureSignature405'):
        assert _is_linked(b1, 'InfrastructureSignature405', a)
    _safe_set(a, 'pcm_av_av_seff_performance_av_av_InfrastructureCall', b2)
    assert _is_linked(a, 'pcm_av_av_seff_performance_av_av_InfrastructureCall', b2)
    if hasattr(b1, 'InfrastructureSignature405'):
        assert not _is_linked(b1, 'InfrastructureSignature405', a)
    if hasattr(b2, 'InfrastructureSignature405'):
        assert _is_linked(b2, 'InfrastructureSignature405', a)
    _safe_set(a, 'pcm_av_av_seff_performance_av_av_InfrastructureCall', None)
    assert not _is_linked(a, 'pcm_av_av_seff_performance_av_av_InfrastructureCall', b2)
    if hasattr(b2, 'InfrastructureSignature405'):
        assert not _is_linked(b2, 'InfrastructureSignature405', a)


def test_assoc_signature__ResourceCall416_link_reassign_clear():
    a = pcm_av_av_seff_performance_av_av_ResourceCall()
    b1 = ResourceSignature()
    b2 = ResourceSignature()
    _safe_set(a, 'pcm_av_av_seff_performance_av_av_ResourceCall417', b1)
    assert _is_linked(a, 'pcm_av_av_seff_performance_av_av_ResourceCall417', b1)
    if hasattr(b1, 'ResourceSignature418'):
        assert _is_linked(b1, 'ResourceSignature418', a)
    _safe_set(a, 'pcm_av_av_seff_performance_av_av_ResourceCall417', b2)
    assert _is_linked(a, 'pcm_av_av_seff_performance_av_av_ResourceCall417', b2)
    if hasattr(b1, 'ResourceSignature418'):
        assert not _is_linked(b1, 'ResourceSignature418', a)
    if hasattr(b2, 'ResourceSignature418'):
        assert _is_linked(b2, 'ResourceSignature418', a)
    _safe_set(a, 'pcm_av_av_seff_performance_av_av_ResourceCall417', None)
    assert not _is_linked(a, 'pcm_av_av_seff_performance_av_av_ResourceCall417', b2)
    if hasattr(b2, 'ResourceSignature418'):
        assert not _is_linked(b2, 'ResourceSignature418', a)


def test_assoc_signatures__OperationInterface266_link_reassign_clear():
    a = pcm_av_av_repository_av_av_OperationInterface()
    b1 = OperationSignature()
    b2 = OperationSignature()
    _safe_set(a, 'interface__OperationSignature', {b1})
    assert _is_linked(a, 'interface__OperationSignature', b1)
    if hasattr(b1, 'OperationSignature267'):
        assert _is_linked(b1, 'OperationSignature267', a)
    _safe_set(a, 'interface__OperationSignature', {b2})
    assert _is_linked(a, 'interface__OperationSignature', b2)
    if hasattr(b1, 'OperationSignature267'):
        assert not _is_linked(b1, 'OperationSignature267', a)
    if hasattr(b2, 'OperationSignature267'):
        assert _is_linked(b2, 'OperationSignature267', a)
    _safe_set(a, 'interface__OperationSignature', set())
    assert not _is_linked(a, 'interface__OperationSignature', b2)
    if hasattr(b2, 'OperationSignature267'):
        assert not _is_linked(b2, 'OperationSignature267', a)


def test_assoc_softwareInducedFailureType__InternalFailureOccurrenceDescription326_link_reassign_clear():
    a = pcm_av_av_reliability_av_av_InternalFailureOccurrenceDescription()
...
def test_assoc_specification_ParametericResourceDemand421_link_reassign_clear():
    a = pcm_av_av_seff_performance_av_av_ParametricResourceDemand()
    b1 = PCMRandomVariable()
    b2 = PCMRandomVariable()
    ...
    if hasattr(b1, 'PCMRandomVariable422'):
        assert _is_linked(b1, 'PCMRandomVariable422', a)
    ...
    if hasattr(b1, 'PCMRandomVariable422'):
        assert not _is_linked(b1, 'PCMRandomVariable422', a)
    if hasattr(b2, 'PCMRandomVariable422'):
        assert _is_linked(b2, 'PCMRandomVariable422', a)
    ...
    if hasattr(b2, 'PCMRandomVariable422'):
        assert not _is_linked(b2, 'PCMRandomVariable422', a)


def test_assoc_specification_VariableCharacterisation319_link_reassign_clear():
    a = pcm_av_av_parameter_av_av_VariableCharacterisation(type="sample_text")
    b1 = PCMRandomVariable()
    b2 = PCMRandomVariable()
    _safe_set(a, 'variableCharacterisation_Specification', b1)
    assert _is_linked(a, 'variableCharacterisation_Specification', b1)
    if hasattr(b1, 'PCMRandomVariable320'):
        assert _is_linked(b1, 'PCMRandomVariable320', a)
    _safe_set(a, 'variableCharacterisation_Specification', b2)
    assert _is_linked(a, 'variableCharacterisation_Specification', b2)
    if hasattr(b1, 'PCMRandomVariable320'):
        assert not _is_linked(b1, 'PCMRandomVariable320', a)
    if hasattr(b2, 'PCMRandomVariable320'):
        assert _is_linked(b2, 'PCMRandomVariable320', a)
    _safe_set(a, 'variableCharacterisation_Specification', None)
    assert not _is_linked(a, 'variableCharacterisation_Specification', b2)
    if hasattr(b2, 'PCMRandomVariable320'):
        assert not _is_linked(b2, 'PCMRandomVariable320', a)


def test_assoc_specifiedExecutionTime_PCMRandomVariable19_link_reassign_clear():
    a = pcm_av_av_core_av_av_PCMRandomVariable()
    b1 = qos_performance_av_av_SpecifiedExecutionTime()
    b2 = qos_performance_av_av_SpecifiedExecutionTime()
...
def test_assoc_specifiedOutputParameterAbstractions_QoSAnnotations439_link_reassign_clear():
    a = pcm_av_av_qosannotations_av_av_QoSAnnotations()
    ...
    if hasattr(b1, 'SpecifiedOutputParameterAbstraction440'):
        assert _is_linked(b1, 'SpecifiedOutputParameterAbstraction440', a)
    ...
    if hasattr(b1, 'SpecifiedOutputParameterAbstraction440'):
        assert not _is_linked(b1, 'SpecifiedOutputParameterAbstraction440', a)
    if hasattr(b2, 'SpecifiedOutputParameterAbstraction440'):
        assert _is_linked(b2, 'SpecifiedOutputParameterAbstraction440', a)
    ...
    if hasattr(b2, 'SpecifiedOutputParameterAbstraction440'):
        assert not _is_linked(b2, 'SpecifiedOutputParameterAbstraction440', a)


def test_assoc_specifiedQoSAnnotations_QoSAnnotations442_link_reassign_clear():
    a = pcm_av_av_qosannotations_av_av_QoSAnnotations()
...
def test_assoc_specifiedReliabilityAnnotation__ExternalFailureOccurrenceDescription328_link_reassign_clear():
    a = pcm_av_av_reliability_av_av_ExternalFailureOccurrenceDescription()
    b1 = qos_reliability_av_av_SpecifiedReliabilityAnnotation()
    b2 = qos_reliability_av_av_SpecifiedReliabilityAnnotation()
...
def test_assoc_steps_Behaviour348_link_reassign_clear():
    ...
    if hasattr(b2, 'AbstractAction349'):
        assert not _is_linked(b2, 'AbstractAction349', a)


def test_assoc_system_Allocation501_link_reassign_clear():
    a = pcm_av_av_allocation_av_av_Allocation()
    b1 = System()
    b2 = System()
    _safe_set(a, 'pcm_av_av_allocation_av_av_Allocation502', b1)
    assert _is_linked(a, 'pcm_av_av_allocation_av_av_Allocation502', b1)
    if hasattr(b1, 'System503'):
        assert _is_linked(b1, 'System503', a)
    _safe_set(a, 'pcm_av_av_allocation_av_av_Allocation502', b2)
    assert _is_linked(a, 'pcm_av_av_allocation_av_av_Allocation502', b2)
    if hasattr(b1, 'System503'):
        assert not _is_linked(b1, 'System503', a)
    if hasattr(b2, 'System503'):
        assert _is_linked(b2, 'System503', a)
    _safe_set(a, 'pcm_av_av_allocation_av_av_Allocation502', None)
    assert not _is_linked(a, 'pcm_av_av_allocation_av_av_Allocation502', b2)
    if hasattr(b2, 'System503'):
        assert not _is_linked(b2, 'System503', a)


def test_assoc_system_QoSAnnotations441_link_reassign_clear():
    a = pcm_av_av_qosannotations_av_av_QoSAnnotations()
    b1 = System()
    b2 = System()
...
def test_assoc_targetResourceEnvironment_Allocation499_link_reassign_clear():
    a = pcm_av_av_allocation_av_av_Allocation()
    b1 = ResourceEnvironment()
    b2 = ResourceEnvironment()
    _safe_set(a, 'pcm_av_av_allocation_av_av_Allocation', b1)
    assert _is_linked(a, 'pcm_av_av_allocation_av_av_Allocation', b1)
    if hasattr(b1, 'ResourceEnvironment500'):
        assert _is_linked(b1, 'ResourceEnvironment500', a)
    _safe_set(a, 'pcm_av_av_allocation_av_av_Allocation', b2)
    assert _is_linked(a, 'pcm_av_av_allocation_av_av_Allocation', b2)
    if hasattr(b1, 'ResourceEnvironment500'):
        assert not _is_linked(b1, 'ResourceEnvironment500', a)
    if hasattr(b2, 'ResourceEnvironment500'):
        assert _is_linked(b2, 'ResourceEnvironment500', a)
    _safe_set(a, 'pcm_av_av_allocation_av_av_Allocation', None)
    assert not _is_linked(a, 'pcm_av_av_allocation_av_av_Allocation', b2)
    if hasattr(b2, 'ResourceEnvironment500'):
        assert not _is_linked(b2, 'ResourceEnvironment500', a)


def test_assoc_thinkTime_ClosedWorkload204_link_reassign_clear():
    a = pcm_av_av_usagemodel_av_av_ClosedWorkload(population=7)
    b1 = PCMRandomVariable()
    b2 = PCMRandomVariable()
    _safe_set(a, 'closedWorkload_PCMRandomVariable', b1)
    assert _is_linked(a, 'closedWorkload_PCMRandomVariable', b1)
    if hasattr(b1, 'PCMRandomVariable205'):
        assert _is_linked(b1, 'PCMRandomVariable205', a)
    _safe_set(a, 'closedWorkload_PCMRandomVariable', b2)
    assert _is_linked(a, 'closedWorkload_PCMRandomVariable', b2)
    if hasattr(b1, 'PCMRandomVariable205'):
        assert not _is_linked(b1, 'PCMRandomVariable205', a)
    if hasattr(b2, 'PCMRandomVariable205'):
        assert _is_linked(b2, 'PCMRandomVariable205', a)
    _safe_set(a, 'closedWorkload_PCMRandomVariable', None)
    assert not _is_linked(a, 'closedWorkload_PCMRandomVariable', b2)
    if hasattr(b2, 'PCMRandomVariable205'):
        assert not _is_linked(b2, 'PCMRandomVariable205', a)


def test_assoc_throughput_CommunicationLinkResourceSpecification489_link_reassign_clear():
    a = pcm_av_av_resourceenvironment_av_av_CommunicationLinkResourceSpecification(failureProbability=3.14)
    b1 = PCMRandomVariable()
    b2 = PCMRandomVariable()
    ...
    if hasattr(b1, 'PCMRandomVariable490'):
        assert _is_linked(b1, 'PCMRandomVariable490', a)
    ...
    if hasattr(b1, 'PCMRandomVariable490'):
        assert not _is_linked(b1, 'PCMRandomVariable490', a)
    if hasattr(b2, 'PCMRandomVariable490'):
        assert _is_linked(b2, 'PCMRandomVariable490', a)
    ...
    if hasattr(b2, 'PCMRandomVariable490'):
        assert not _is_linked(b2, 'PCMRandomVariable490', a)


def test_assoc_usageScenario_SenarioBehaviour184_link_reassign_clear():
    a = pcm_av_av_usagemodel_av_av_ScenarioBehaviour()
    b1 = UsageScenario()
    b2 = UsageScenario()
    _safe_set(a, 'scenarioBehaviour_UsageScenario', b1)
    assert _is_linked(a, 'scenarioBehaviour_UsageScenario', b1)
    if hasattr(b1, 'UsageScenario185'):
        assert _is_linked(b1, 'UsageScenario185', a)
    _safe_set(a, 'scenarioBehaviour_UsageScenario', b2)
    assert _is_linked(a, 'scenarioBehaviour_UsageScenario', b2)
    if hasattr(b1, 'UsageScenario185'):
        assert not _is_linked(b1, 'UsageScenario185', a)
    if hasattr(b2, 'UsageScenario185'):
        assert _is_linked(b2, 'UsageScenario185', a)
    _safe_set(a, 'scenarioBehaviour_UsageScenario', None)
    assert not _is_linked(a, 'scenarioBehaviour_UsageScenario', b2)
    if hasattr(b2, 'UsageScenario185'):
        assert not _is_linked(b2, 'UsageScenario185', a)


def test_assoc_variableCharacterisation_Specification13_link_reassign_clear():
    a = pcm_av_av_core_av_av_PCMRandomVariable()
...
composition_av_av_AssemblyContext_strategy = st.builds(composition_av_av_AssemblyContext)
...
composition_av_av_AssemblyEventConnector_strategy = st.builds(composition_av_av_AssemblyEventConnector)
...
composition_av_av_ComposedStructure_strategy = st.builds(composition_av_av_ComposedStructure)
...
composition_av_av_Connector_strategy = st.builds(composition_av_av_Connector)
...
composition_av_av_EventChannel_strategy = st.builds(composition_av_av_EventChannel)
...
composition_av_av_EventChannelSinkConnector_strategy = st.builds(composition_av_av_EventChannelSinkConnector)
...
composition_av_av_EventChannelSourceConnector_strategy = st.builds(composition_av_av_EventChannelSourceConnector)
...
composition_av_av_ResourceRequiredDelegationConnector_strategy = st.builds(composition_av_av_ResourceRequiredDelegationConnector)
...
entity_av_av_ComposedProvidingRequiringEntity_strategy = st.builds(entity_av_av_ComposedProvidingRequiringEntity)
...
entity_av_av_Entity_strategy = st.builds(entity_av_av_Entity)
...
entity_av_av_InterfaceProvidingEntity_strategy = st.builds(entity_av_av_InterfaceProvidingEntity)
...
entity_av_av_InterfaceProvidingRequiringEntity_strategy = st.builds(entity_av_av_InterfaceProvidingRequiringEntity)
...
entity_av_av_InterfaceRequiringEntity_strategy = st.builds(entity_av_av_InterfaceRequiringEntity)
...
entity_av_av_NamedElement_strategy = st.builds(entity_av_av_NamedElement)
...
entity_av_av_ResourceInterfaceProvidingEntity_strategy = st.builds(entity_av_av_ResourceInterfaceProvidingEntity)
...
entity_av_av_ResourceInterfaceRequiringEntity_strategy = st.builds(entity_av_av_ResourceInterfaceRequiringEntity)
...
entity_av_av_ResourceProvidedRole_strategy = st.builds(entity_av_av_ResourceProvidedRole)
...
entity_av_av_ResourceRequiredRole_strategy = st.builds(entity_av_av_ResourceRequiredRole)
...
parameter_av_av_pcm_av_av_AbstractNamedReference_strategy = st.builds(parameter_av_av_pcm_av_av_AbstractNamedReference)
...
pcm_av_av_Advice_strategy = st.builds(pcm_av_av_Advice)
...
pcm_av_av_AdviceAdvice_strategy = st.builds(pcm_av_av_AdviceAdvice)
...
pcm_av_av_DummyClass_strategy = st.builds(pcm_av_av_DummyClass)
...
pcm_av_av_EObject_strategy = st.builds(pcm_av_av_EObject)
...
pcm_av_av_GlobalScope_strategy = st.builds(pcm_av_av_GlobalScope)
...
pcm_av_av_GlobalScopeGlobalScope_strategy = st.builds(pcm_av_av_GlobalScopeGlobalScope)
...
pcm_av_av_PerJoinPointScope_strategy = st.builds(pcm_av_av_PerJoinPointScope)
...
pcm_av_av_PerJoinPointScopePerJoinPointScope_strategy = st.builds(pcm_av_av_PerJoinPointScopePerJoinPointScope)
...
pcm_av_av_allocation_av_av_Allocation_strategy = st.builds(pcm_av_av_allocation_av_av_Allocation)
...
pcm_av_av_allocation_av_av_AllocationContext_strategy = st.builds(pcm_av_av_allocation_av_av_AllocationContext)
...
pcm_av_av_completions_av_av_Completion_strategy = st.builds(pcm_av_av_completions_av_av_Completion)
...
pcm_av_av_completions_av_av_CompletionRepository_strategy = st.builds(pcm_av_av_completions_av_av_CompletionRepository)
...
pcm_av_av_completions_av_av_DelegatingExternalCallAction_strategy = st.builds(pcm_av_av_completions_av_av_DelegatingExternalCallAction)
...
pcm_av_av_completions_av_av_NetworkDemandParametricResourceDemand_strategy = st.builds(pcm_av_av_completions_av_av_NetworkDemandParametricResourceDemand)
...
pcm_av_av_composition_av_av_AssemblyConnector_strategy = st.builds(pcm_av_av_composition_av_av_AssemblyConnector)
...
pcm_av_av_composition_av_av_AssemblyContext_strategy = st.builds(pcm_av_av_composition_av_av_AssemblyContext)
...
pcm_av_av_composition_av_av_AssemblyEventConnector_strategy = st.builds(pcm_av_av_composition_av_av_AssemblyEventConnector)
...
pcm_av_av_composition_av_av_AssemblyInfrastructureConnector_strategy = st.builds(pcm_av_av_composition_av_av_AssemblyInfrastructureConnector)
...
pcm_av_av_composition_av_av_ComposedStructure_strategy = st.builds(pcm_av_av_composition_av_av_ComposedStructure)
...
pcm_av_av_composition_av_av_Connector_strategy = st.builds(pcm_av_av_composition_av_av_Connector)
...
pcm_av_av_composition_av_av_DelegationConnector_strategy = st.builds(pcm_av_av_composition_av_av_DelegationConnector)
...
pcm_av_av_composition_av_av_EventChannel_strategy = st.builds(pcm_av_av_composition_av_av_EventChannel)
...
pcm_av_av_composition_av_av_EventChannelSinkConnector_strategy = st.builds(pcm_av_av_composition_av_av_EventChannelSinkConnector)
...
pcm_av_av_composition_av_av_EventChannelSourceConnector_strategy = st.builds(pcm_av_av_composition_av_av_EventChannelSourceConnector)
...
pcm_av_av_composition_av_av_ProvidedDelegationConnector_strategy = st.builds(pcm_av_av_composition_av_av_ProvidedDelegationConnector)
...
pcm_av_av_composition_av_av_ProvidedInfrastructureDelegationConnector_strategy = st.builds(pcm_av_av_composition_av_av_ProvidedInfrastructureDelegationConnector)
...
pcm_av_av_composition_av_av_RequiredDelegationConnector_strategy = st.builds(pcm_av_av_composition_av_av_RequiredDelegationConnector)
...
pcm_av_av_composition_av_av_RequiredInfrastructureDelegationConnector_strategy = st.builds(pcm_av_av_composition_av_av_RequiredInfrastructureDelegationConnector)
...
pcm_av_av_composition_av_av_RequiredResourceDelegationConnector_strategy = st.builds(pcm_av_av_composition_av_av_RequiredResourceDelegationConnector)
...
pcm_av_av_composition_av_av_ResourceRequiredDelegationConnector_strategy = st.builds(pcm_av_av_composition_av_av_ResourceRequiredDelegationConnector)
...
pcm_av_av_composition_av_av_SinkDelegationConnector_strategy = st.builds(pcm_av_av_composition_av_av_SinkDelegationConnector)
...
pcm_av_av_composition_av_av_SourceDelegationConnector_strategy = st.builds(pcm_av_av_composition_av_av_SourceDelegationConnector)
...
pcm_av_av_core_av_av_PCMRandomVariable_strategy = st.builds(pcm_av_av_core_av_av_PCMRandomVariable)
...
pcm_av_av_entity_av_av_ComposedProvidingRequiringEntity_strategy = st.builds(pcm_av_av_entity_av_av_ComposedProvidingRequiringEntity)
...
pcm_av_av_entity_av_av_Entity_strategy = st.builds(pcm_av_av_entity_av_av_Entity)
...
pcm_av_av_entity_av_av_InterfaceProvidingEntity_strategy = st.builds(pcm_av_av_entity_av_av_InterfaceProvidingEntity)
...
pcm_av_av_entity_av_av_InterfaceProvidingRequiringEntity_strategy = st.builds(pcm_av_av_entity_av_av_InterfaceProvidingRequiringEntity)
...
pcm_av_av_entity_av_av_InterfaceRequiringEntity_strategy = st.builds(pcm_av_av_entity_av_av_InterfaceRequiringEntity)
...
pcm_av_av_entity_av_av_NamedElement_strategy = st.builds(pcm_av_av_entity_av_av_NamedElement, entityName=safe_text)
...
pcm_av_av_entity_av_av_ResourceInterfaceProvidingEntity_strategy = st.builds(pcm_av_av_entity_av_av_ResourceInterfaceProvidingEntity)
...
pcm_av_av_entity_av_av_ResourceInterfaceProvidingRequiringEntity_strategy = st.builds(pcm_av_av_entity_av_av_ResourceInterfaceProvidingRequiringEntity)
...
pcm_av_av_entity_av_av_ResourceInterfaceRequiringEntity_strategy = st.builds(pcm_av_av_entity_av_av_ResourceInterfaceRequiringEntity)
...
pcm_av_av_entity_av_av_ResourceProvidedRole_strategy = st.builds(pcm_av_av_entity_av_av_ResourceProvidedRole)
...
pcm_av_av_entity_av_av_ResourceRequiredRole_strategy = st.builds(pcm_av_av_entity_av_av_ResourceRequiredRole)
...
pcm_av_av_parameter_av_av_CharacterisedVariable_strategy = st.builds(pcm_av_av_parameter_av_av_CharacterisedVariable, characterisationType=safe_text)
...
pcm_av_av_parameter_av_av_VariableCharacterisation_strategy = st.builds(pcm_av_av_parameter_av_av_VariableCharacterisation, type=safe_text)
...
pcm_av_av_parameter_av_av_VariableUsage_strategy = st.builds(pcm_av_av_parameter_av_av_VariableUsage)
...
pcm_av_av_protocol_av_av_Protocol_strategy = st.builds(pcm_av_av_protocol_av_av_Protocol, protocolTypeID=safe_text)
...
pcm_av_av_qos_performance_av_av_ComponentSpecifiedExecutionTime_strategy = st.builds(pcm_av_av_qos_performance_av_av_ComponentSpecifiedExecutionTime)
...
pcm_av_av_qos_performance_av_av_SpecifiedExecutionTime_strategy = st.builds(pcm_av_av_qos_performance_av_av_SpecifiedExecutionTime)
...
pcm_av_av_qos_performance_av_av_SystemSpecifiedExecutionTime_strategy = st.builds(pcm_av_av_qos_performance_av_av_SystemSpecifiedExecutionTime)
...
pcm_av_av_qos_reliability_av_av_SpecifiedReliabilityAnnotation_strategy = st.builds(pcm_av_av_qos_reliability_av_av_SpecifiedReliabilityAnnotation)
...
pcm_av_av_qosannotations_av_av_QoSAnnotations_strategy = st.builds(pcm_av_av_qosannotations_av_av_QoSAnnotations)
...
pcm_av_av_qosannotations_av_av_SpecifiedOutputParameterAbstraction_strategy = st.builds(pcm_av_av_qosannotations_av_av_SpecifiedOutputParameterAbstraction)
...
pcm_av_av_qosannotations_av_av_SpecifiedQoSAnnotation_strategy = st.builds(pcm_av_av_qosannotations_av_av_SpecifiedQoSAnnotation)
...
pcm_av_av_reliability_av_av_ExternalFailureOccurrenceDescription_strategy = st.builds(pcm_av_av_reliability_av_av_ExternalFailureOccurrenceDescription)
...
pcm_av_av_reliability_av_av_FailureOccurrenceDescription_strategy = st.builds(pcm_av_av_reliability_av_av_FailureOccurrenceDescription, failureProbability=st.floats(allow_nan=False, allow_infinity=False))
...
pcm_av_av_reliability_av_av_FailureType_strategy = st.builds(pcm_av_av_reliability_av_av_FailureType)
...
pcm_av_av_reliability_av_av_HardwareInducedFailureType_strategy = st.builds(pcm_av_av_reliability_av_av_HardwareInducedFailureType)
...
pcm_av_av_reliability_av_av_InternalFailureOccurrenceDescription_strategy = st.builds(pcm_av_av_reliability_av_av_InternalFailureOccurrenceDescription)
...
pcm_av_av_reliability_av_av_NetworkInducedFailureType_strategy = st.builds(pcm_av_av_reliability_av_av_NetworkInducedFailureType)
...
pcm_av_av_reliability_av_av_ResourceTimeoutFailureType_strategy = st.builds(pcm_av_av_reliability_av_av_ResourceTimeoutFailureType)
...
pcm_av_av_reliability_av_av_SoftwareInducedFailureType_strategy = st.builds(pcm_av_av_reliability_av_av_SoftwareInducedFailureType)
...
pcm_av_av_repository_av_av_BasicComponent_strategy = st.builds(pcm_av_av_repository_av_av_BasicComponent)
...
pcm_av_av_repository_av_av_CollectionDataType_strategy = st.builds(pcm_av_av_repository_av_av_CollectionDataType)
...
pcm_av_av_repository_av_av_CompleteComponentType_strategy = st.builds(pcm_av_av_repository_av_av_CompleteComponentType)
...
pcm_av_av_repository_av_av_CompositeComponent_strategy = st.builds(pcm_av_av_repository_av_av_CompositeComponent)
...
pcm_av_av_repository_av_av_CompositeDataType_strategy = st.builds(pcm_av_av_repository_av_av_CompositeDataType)
...
pcm_av_av_repository_av_av_DataType_strategy = st.builds(pcm_av_av_repository_av_av_DataType)
...
pcm_av_av_repository_av_av_EventGroup_strategy = st.builds(pcm_av_av_repository_av_av_EventGroup)
...
pcm_av_av_repository_av_av_EventType_strategy = st.builds(pcm_av_av_repository_av_av_EventType)
...
pcm_av_av_repository_av_av_ExceptionType_strategy = st.builds(pcm_av_av_repository_av_av_ExceptionType, exceptionMessage=safe_text, exceptionName=safe_text)
...
pcm_av_av_repository_av_av_ImplementationComponentType_strategy = st.builds(pcm_av_av_repository_av_av_ImplementationComponentType, componentType=safe_text)
...
pcm_av_av_repository_av_av_InfrastructureInterface_strategy = st.builds(pcm_av_av_repository_av_av_InfrastructureInterface)
...
pcm_av_av_repository_av_av_InfrastructureProvidedRole_strategy = st.builds(pcm_av_av_repository_av_av_InfrastructureProvidedRole)
...
pcm_av_av_repository_av_av_InfrastructureRequiredRole_strategy = st.builds(pcm_av_av_repository_av_av_InfrastructureRequiredRole)
...
pcm_av_av_repository_av_av_InfrastructureSignature_strategy = st.builds(pcm_av_av_repository_av_av_InfrastructureSignature)
...
pcm_av_av_repository_av_av_InnerDeclaration_strategy = st.builds(pcm_av_av_repository_av_av_InnerDeclaration)
...
pcm_av_av_repository_av_av_Interface_strategy = st.builds(pcm_av_av_repository_av_av_Interface)
...
pcm_av_av_repository_av_av_OperationInterface_strategy = st.builds(pcm_av_av_repository_av_av_OperationInterface)
...
pcm_av_av_repository_av_av_OperationProvidedRole_strategy = st.builds(pcm_av_av_repository_av_av_OperationProvidedRole)
...
pcm_av_av_repository_av_av_OperationRequiredRole_strategy = st.builds(pcm_av_av_repository_av_av_OperationRequiredRole)
...
pcm_av_av_repository_av_av_OperationSignature_strategy = st.builds(pcm_av_av_repository_av_av_OperationSignature)
...
pcm_av_av_repository_av_av_Parameter_strategy = st.builds(pcm_av_av_repository_av_av_Parameter, modifier__Parameter=safe_text, parameterName=safe_text)
...
pcm_av_av_repository_av_av_PassiveResource_strategy = st.builds(pcm_av_av_repository_av_av_PassiveResource)
...
pcm_av_av_repository_av_av_PrimitiveDataType_strategy = st.builds(pcm_av_av_repository_av_av_PrimitiveDataType, type=safe_text)
...
pcm_av_av_repository_av_av_ProvidedRole_strategy = st.builds(pcm_av_av_repository_av_av_ProvidedRole)
...
pcm_av_av_repository_av_av_ProvidesComponentType_strategy = st.builds(pcm_av_av_repository_av_av_ProvidesComponentType)
...
pcm_av_av_repository_av_av_Repository_strategy = st.builds(pcm_av_av_repository_av_av_Repository, repositoryDescription=safe_text)
...
pcm_av_av_repository_av_av_RepositoryComponent_strategy = st.builds(pcm_av_av_repository_av_av_RepositoryComponent)
...
pcm_av_av_repository_av_av_RequiredCharacterisation_strategy = st.builds(pcm_av_av_repository_av_av_RequiredCharacterisation, type=safe_text)
...
pcm_av_av_repository_av_av_RequiredRole_strategy = st.builds(pcm_av_av_repository_av_av_RequiredRole)
...
pcm_av_av_repository_av_av_Role_strategy = st.builds(pcm_av_av_repository_av_av_Role)
...
pcm_av_av_repository_av_av_Signature_strategy = st.builds(pcm_av_av_repository_av_av_Signature)
...
pcm_av_av_repository_av_av_SinkRole_strategy = st.builds(pcm_av_av_repository_av_av_SinkRole)
...
pcm_av_av_repository_av_av_SourceRole_strategy = st.builds(pcm_av_av_repository_av_av_SourceRole)
...
pcm_av_av_resourceenvironment_av_av_CommunicationLinkResourceSpecification_strategy = st.builds(pcm_av_av_resourceenvironment_av_av_CommunicationLinkResourceSpecification, failureProbability=st.floats(allow_nan=False, allow_infinity=False))
...
pcm_av_av_resourceenvironment_av_av_LinkingResource_strategy = st.builds(pcm_av_av_resourceenvironment_av_av_LinkingResource)
...
pcm_av_av_resourceenvironment_av_av_ResourceContainer_strategy = st.builds(pcm_av_av_resourceenvironment_av_av_ResourceContainer)
...
pcm_av_av_resourceenvironment_av_av_ResourceEnvironment_strategy = st.builds(pcm_av_av_resourceenvironment_av_av_ResourceEnvironment)
...
pcm_av_av_resourcetype_av_av_CommunicationLinkResourceType_strategy = st.builds(pcm_av_av_resourcetype_av_av_CommunicationLinkResourceType)
...
pcm_av_av_resourcetype_av_av_ProcessingResourceType_strategy = st.builds(pcm_av_av_resourcetype_av_av_ProcessingResourceType)
...
pcm_av_av_resourcetype_av_av_ResourceInterface_strategy = st.builds(pcm_av_av_resourcetype_av_av_ResourceInterface)
...
pcm_av_av_resourcetype_av_av_ResourceRepository_strategy = st.builds(pcm_av_av_resourcetype_av_av_ResourceRepository)
...
pcm_av_av_resourcetype_av_av_ResourceSignature_strategy = st.builds(pcm_av_av_resourcetype_av_av_ResourceSignature, resourceServiceId=st.integers())
...
pcm_av_av_resourcetype_av_av_ResourceType_strategy = st.builds(pcm_av_av_resourcetype_av_av_ResourceType)
...
pcm_av_av_resourcetype_av_av_SchedulingPolicy_strategy = st.builds(pcm_av_av_resourcetype_av_av_SchedulingPolicy)
...
pcm_av_av_seff_av_av_AbstractAction_strategy = st.builds(pcm_av_av_seff_av_av_AbstractAction)
...
pcm_av_av_seff_av_av_AbstractBranchTransition_strategy = st.builds(pcm_av_av_seff_av_av_AbstractBranchTransition)
...
pcm_av_av_seff_av_av_AbstractInternalControlFlowAction_strategy = st.builds(pcm_av_av_seff_av_av_AbstractInternalControlFlowAction)
...
pcm_av_av_seff_av_av_AbstractLoopAction_strategy = st.builds(pcm_av_av_seff_av_av_AbstractLoopAction)
...
pcm_av_av_seff_av_av_AcquireAction_strategy = st.builds(pcm_av_av_seff_av_av_AcquireAction, timeout=st.booleans(), timeoutValue=st.floats(allow_nan=False, allow_infinity=False))
...
pcm_av_av_seff_av_av_BranchAction_strategy = st.builds(pcm_av_av_seff_av_av_BranchAction)
...
pcm_av_av_seff_av_av_CallAction_strategy = st.builds(pcm_av_av_seff_av_av_CallAction)
...
pcm_av_av_seff_av_av_CallReturnAction_strategy = st.builds(pcm_av_av_seff_av_av_CallReturnAction)
...
pcm_av_av_seff_av_av_CollectionIteratorAction_strategy = st.builds(pcm_av_av_seff_av_av_CollectionIteratorAction)
...
pcm_av_av_seff_av_av_EmitEventAction_strategy = st.builds(pcm_av_av_seff_av_av_EmitEventAction)
...
pcm_av_av_seff_av_av_ExternalCallAction_strategy = st.builds(pcm_av_av_seff_av_av_ExternalCallAction, retryCount=st.integers())
...
pcm_av_av_seff_av_av_ForkAction_strategy = st.builds(pcm_av_av_seff_av_av_ForkAction)
...
pcm_av_av_seff_av_av_ForkedBehaviour_strategy = st.builds(pcm_av_av_seff_av_av_ForkedBehaviour)
...
pcm_av_av_seff_av_av_GuardedBranchTransition_strategy = st.builds(pcm_av_av_seff_av_av_GuardedBranchTransition)
...
pcm_av_av_seff_av_av_InternalAction_strategy = st.builds(pcm_av_av_seff_av_av_InternalAction)
...
pcm_av_av_seff_av_av_InternalCallAction_strategy = st.builds(pcm_av_av_seff_av_av_InternalCallAction)
...
pcm_av_av_seff_av_av_LoopAction_strategy = st.builds(pcm_av_av_seff_av_av_LoopAction)
...
pcm_av_av_seff_av_av_ProbabilisticBranchTransition_strategy = st.builds(pcm_av_av_seff_av_av_ProbabilisticBranchTransition, branchProbability=st.floats(allow_nan=False, allow_infinity=False))
...
pcm_av_av_seff_av_av_ReleaseAction_strategy = st.builds(pcm_av_av_seff_av_av_ReleaseAction)
...
pcm_av_av_seff_av_av_ResourceDemandingBehaviour_strategy = st.builds(pcm_av_av_seff_av_av_ResourceDemandingBehaviour)
...
pcm_av_av_seff_av_av_ResourceDemandingInternalBehaviour_strategy = st.builds(pcm_av_av_seff_av_av_ResourceDemandingInternalBehaviour)
...
pcm_av_av_seff_av_av_ResourceDemandingSEFF_strategy = st.builds(pcm_av_av_seff_av_av_ResourceDemandingSEFF)
...
pcm_av_av_seff_av_av_ServiceEffectSpecification_strategy = st.builds(pcm_av_av_seff_av_av_ServiceEffectSpecification, seffTypeID=safe_text)
...
pcm_av_av_seff_av_av_SetVariableAction_strategy = st.builds(pcm_av_av_seff_av_av_SetVariableAction)
...
pcm_av_av_seff_av_av_StartAction_strategy = st.builds(pcm_av_av_seff_av_av_StartAction)
...
pcm_av_av_seff_av_av_StopAction_strategy = st.builds(pcm_av_av_seff_av_av_StopAction)
...
pcm_av_av_seff_av_av_SynchronisationPoint_strategy = st.builds(pcm_av_av_seff_av_av_SynchronisationPoint)
...
pcm_av_av_seff_performance_av_av_InfrastructureCall_strategy = st.builds(pcm_av_av_seff_performance_av_av_InfrastructureCall)
...
pcm_av_av_seff_performance_av_av_ParametricResourceDemand_strategy = st.builds(pcm_av_av_seff_performance_av_av_ParametricResourceDemand)
...
pcm_av_av_seff_performance_av_av_ResourceCall_strategy = st.builds(pcm_av_av_seff_performance_av_av_ResourceCall)
...
pcm_av_av_seff_reliability_av_av_FailureHandlingEntity_strategy = st.builds(pcm_av_av_seff_reliability_av_av_FailureHandlingEntity)
...
pcm_av_av_seff_reliability_av_av_RecoveryAction_strategy = st.builds(pcm_av_av_seff_reliability_av_av_RecoveryAction)
...
pcm_av_av_seff_reliability_av_av_RecoveryActionBehaviour_strategy = st.builds(pcm_av_av_seff_reliability_av_av_RecoveryActionBehaviour)
...
pcm_av_av_subsystem_av_av_SubSystem_strategy = st.builds(pcm_av_av_subsystem_av_av_SubSystem)
...
pcm_av_av_system_av_av_System_strategy = st.builds(pcm_av_av_system_av_av_System)
...
pcm_av_av_usagemodel_av_av_AbstractUserAction_strategy = st.builds(pcm_av_av_usagemodel_av_av_AbstractUserAction)
...
pcm_av_av_usagemodel_av_av_Branch_strategy = st.builds(pcm_av_av_usagemodel_av_av_Branch)
...
pcm_av_av_usagemodel_av_av_BranchTransition_strategy = st.builds(pcm_av_av_usagemodel_av_av_BranchTransition, branchProbability=st.floats(allow_nan=False, allow_infinity=False))
...
pcm_av_av_usagemodel_av_av_ClosedWorkload_strategy = st.builds(pcm_av_av_usagemodel_av_av_ClosedWorkload, population=st.integers())
...
pcm_av_av_usagemodel_av_av_Delay_strategy = st.builds(pcm_av_av_usagemodel_av_av_Delay)
...
pcm_av_av_usagemodel_av_av_EntryLevelSystemCall_strategy = st.builds(pcm_av_av_usagemodel_av_av_EntryLevelSystemCall, priority=st.integers())
...
pcm_av_av_usagemodel_av_av_Loop_strategy = st.builds(pcm_av_av_usagemodel_av_av_Loop)
...
pcm_av_av_usagemodel_av_av_OpenWorkload_strategy = st.builds(pcm_av_av_usagemodel_av_av_OpenWorkload)
...
pcm_av_av_usagemodel_av_av_ScenarioBehaviour_strategy = st.builds(pcm_av_av_usagemodel_av_av_ScenarioBehaviour)
...
pcm_av_av_usagemodel_av_av_Start_strategy = st.builds(pcm_av_av_usagemodel_av_av_Start)
...
pcm_av_av_usagemodel_av_av_Stop_strategy = st.builds(pcm_av_av_usagemodel_av_av_Stop)
...
pcm_av_av_usagemodel_av_av_UsageModel_strategy = st.builds(pcm_av_av_usagemodel_av_av_UsageModel)
...
pcm_av_av_usagemodel_av_av_UsageScenario_strategy = st.builds(pcm_av_av_usagemodel_av_av_UsageScenario)
...
pcm_av_av_usagemodel_av_av_UserData_strategy = st.builds(pcm_av_av_usagemodel_av_av_UserData)
...
pcm_av_av_usagemodel_av_av_Workload_strategy = st.builds(pcm_av_av_usagemodel_av_av_Workload)
...
qos_performance_av_av_SpecifiedExecutionTime_strategy = st.builds(qos_performance_av_av_SpecifiedExecutionTime)
...
qos_reliability_av_av_SpecifiedReliabilityAnnotation_strategy = st.builds(qos_reliability_av_av_SpecifiedReliabilityAnnotation)
...
repository_av_av_DataType_strategy = st.builds(repository_av_av_DataType)
...
repository_av_av_ImplementationComponentType_strategy = st.builds(repository_av_av_ImplementationComponentType)
...
repository_av_av_RepositoryComponent_strategy = st.builds(repository_av_av_RepositoryComponent)
...
seff_av_av_AbstractAction_strategy = st.builds(seff_av_av_AbstractAction)
...
seff_av_av_AbstractInternalControlFlowAction_strategy = st.builds(seff_av_av_AbstractInternalControlFlowAction)
...
seff_av_av_CallAction_strategy = st.builds(seff_av_av_CallAction)
...
seff_av_av_CallReturnAction_strategy = st.builds(seff_av_av_CallReturnAction)
...
seff_av_av_ResourceDemandingBehaviour_strategy = st.builds(seff_av_av_ResourceDemandingBehaviour)
...
seff_av_av_ServiceEffectSpecification_strategy = st.builds(seff_av_av_ServiceEffectSpecification)
...
seff_performance_av_av_InfrastructureCall_strategy = st.builds(seff_performance_av_av_InfrastructureCall)
...
seff_performance_av_av_ParametricResourceDemand_strategy = st.builds(seff_performance_av_av_ParametricResourceDemand)
...
seff_performance_av_av_ResourceCall_strategy = st.builds(seff_performance_av_av_ResourceCall)
...
seff_reliability_av_av_FailureHandlingEntity_strategy = st.builds(seff_reliability_av_av_FailureHandlingEntity)
...
seff_reliability_av_av_RecoveryAction_strategy = st.builds(seff_reliability_av_av_RecoveryAction)
...
seff_reliability_av_av_RecoveryActionBehaviour_strategy = st.builds(seff_reliability_av_av_RecoveryActionBehaviour)
