...
# Classes
codetaginfo_CodeTag = Class(name="codetaginfo_CodeTag")
codetaginfo_CodeTagContext = Class(name="codetaginfo_CodeTagContext")
codetaginfo_CodeTagInfo = Class(name="codetaginfo_CodeTagInfo")
codetaginfo_DocumentRoot = Class(name="codetaginfo_DocumentRoot")
codetaginfo_EStringToStringMapEntry = Class(name="codetaginfo_EStringToStringMapEntry")
...
codetaginfo_CodeTag.attributes={codetaginfo_CodeTag_type, codetaginfo_CodeTag_uuid, codetaginfo_CodeTag_name, codetaginfo_CodeTag_contents, codetaginfo_CodeTag_tag_begin, codetaginfo_CodeTag_tag_end, codetaginfo_CodeTag_group}
...
codetaginfo_CodeTagContext.attributes={codetaginfo_CodeTagContext_operation_name, codetaginfo_CodeTagContext_component_name, codetaginfo_CodeTagContext_group, codetaginfo_CodeTagContext_class_name}
