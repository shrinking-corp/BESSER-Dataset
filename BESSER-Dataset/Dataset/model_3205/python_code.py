...
class codetaginfo_CodeTag:
    ...
    def __init__(self, group: str, name: str, uuid: str, tag_begin: str, contents: str, tag_end: str, type: str, codetaginfo_CodeTag: set["codetaginfo_CodeTagContext"] = None, codetaginfo_CodeTag2: "codetaginfo_CodeTagInfo" = None):
        self.group = group
        self.name = name
        self.uuid = uuid
