...
# IOT class attributes and methods
IOT_Status: Property = Property(name="Status", type=BooleanType)
IOT_Update: Property = Property(name="Update", type=FloatType)
IOT.attributes={IOT_Update, IOT_Status}
...
HouseHolds.attributes={HouseHolds_Coffee, HouseHolds_WashingMachine, HouseHolds_Alarm, HouseHolds_DishWasher, HouseHolds_TimeID}
...
MicroPhone_System: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="system12", type=IOT, multiplicity=Multiplicity(1, 1)),
...
Sensor_System: BinaryAssociation = BinaryAssociation(
    name="Sensor_System",
    ends={
        Property(name="system16", type=IOT, multiplicity=Multiplicity(1, 1)),
...
System_HouseHolds: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="system19", type=IOT, multiplicity=Multiplicity(1, 1))
    }
)
HomeTheatre_System: BinaryAssociation = BinaryAssociation(
    name="HomeTheatre_System",
    ends={
        Property(name="system20", type=IOT, multiplicity=Multiplicity(1, 1)),
...
Home_Security_System_System: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="system22", type=IOT, multiplicity=Multiplicity(1, 1)),
...
domain_model = DomainModel(
    name="_I8iM8EKuEeqonN_RS9oRzw",
    types={IOT, Sensor, FireAlarm_Sensor, Motion_Sensor, PressureSensor, Home_Security_System, Alert, Door, Camera, Speakers, MicroPhone, Light, Start_Of_Day, End_Of_Day, TV, HomeTheatre, HouseHolds, Entertainment},
    associations={Sensor_Door, Door_Camera, HomeTheatre_TV, HomeTheatre_Speakers, HouseHolds_Start_Of_Day, HouseHolds_End_Of_Day, MicroPhone_System, Home_Security_System_Alert, Sensor_System, System_HouseHolds, HomeTheatre_System, Home_Security_System_System, TV_Entertainment, Speakers_Entertainment, HomeTheatre_Entertainment},
    generalizations={},
    metadata=None
)
