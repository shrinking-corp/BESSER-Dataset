...
class HouseHolds:
    ...
    def __init__(self, TimeID: str, Coffee: str, DishWasher: str, Alarm: str, WashingMachine: str, start_Of_Day8: "Start_Of_Day" = None, end_Of_Day10: "End_Of_Day" = None, system19: "IOT" = None):
        self.TimeID = TimeID
        self.Coffee = Coffee
...
class HomeTheatre:
    ...
    def __init__(self, HTID: str, tV4: "TV" = None, speakers6: "Speakers" = None, system20: "IOT" = None, entertainment28: "Entertainment" = None):
        self.HTID = HTID
        self.tV4 = tV4
...
class TV:
    ...
    def __init__(self, TVID: int, homeTheatre5: set["HomeTheatre"] = None, entertainment24: "Entertainment" = None):
        self.TVID = TVID
...
class MicroPhone:
    ...
    def __init__(self, MicID: str, system12: "IOT" = None):
        self.MicID = MicID
...
class Speakers:
    ...
    def __init__(self, SpeakerID: int, homeTheatre7: set["HomeTheatre"] = None, entertainment26: "Entertainment" = None):
...
class Home_Security_System:
    ...
    def __init__(self, UserID: int, alert14: "Alert" = None, system22: "IOT" = None):
        self.UserID = UserID
...
class Sensor:
    ...
    def __init__(self, SensorID: int, SensorType: int, door0: "Door" = None, system16: "IOT" = None):
...
class IOT:
    ...
    def microPhone13(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_IOT__microPhone13", None)
    ...
    def home_Security_System23(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_IOT__home_Security_System23", None)
    ...
    def sensor17(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_IOT__sensor17", None)
    ...
    def homeTheatre21(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_IOT__homeTheatre21", None)
    ...
    def houseHolds18(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_IOT__houseHolds18", None)
