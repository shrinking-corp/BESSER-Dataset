...
# Classes
testgramgen1_C = Class(name="testgramgen1_C")
testgramgen1_CNamedElement = Class(name="testgramgen1_CNamedElement", is_abstract=True)
testgramgen1_D = Class(name="testgramgen1_D")
testgramgen1_B = Class(name="testgramgen1_B")
testgramgen1_System = Class(name="testgramgen1_System")
testgramgen1_Component = Class(name="testgramgen1_Component")
testgramgen1_Node = Class(name="testgramgen1_Node", is_abstract=True)
testgramgen1_A = Class(name="testgramgen1_A")
Node = Class(name="Node")
CNamedElement = Class(name="CNamedElement")
testgramgen1_ProtoLink = Class(name="testgramgen1_ProtoLink")
Component = Class(name="Component")
testgramgen1_DerivedLink = Class(name="testgramgen1_DerivedLink")
ProtoLink = Class(name="ProtoLink")
testgramgen1_DerivedComponent = Class(name="testgramgen1_DerivedComponent")
...
domain_model = DomainModel(
    name="testgramgen1",
    types={testgramgen1_C, testgramgen1_CNamedElement, testgramgen1_D, testgramgen1_B, testgramgen1_System, testgramgen1_Component, testgramgen1_Node, testgramgen1_A, Node, CNamedElement, testgramgen1_ProtoLink, Component, testgramgen1_DerivedLink, ProtoLink, testgramgen1_DerivedComponent},
    associations={components0, anodes1, links3, src5, trg8, from_11, to13},
    generalizations={gen_testgramgen1_C_CNamedElement, gen_testgramgen1_C_Node, gen_testgramgen1_D_Node, gen_testgramgen1_B_Node, gen_testgramgen1_A_Node, gen_testgramgen1_Component_CNamedElement, gen_testgramgen1_ProtoLink_Component, gen_testgramgen1_DerivedLink_ProtoLink, gen_testgramgen1_DerivedLink_CNamedElement, gen_testgramgen1_DerivedComponent_Component},
    metadata=None
)
