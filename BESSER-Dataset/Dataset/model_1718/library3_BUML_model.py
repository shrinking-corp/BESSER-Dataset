...
Library3_BookType.attributes={Library3_BookType_isbn, Library3_BookType_title, Library3_BookType_author, Library3_BookType_name, Library3_BookType_pages}
...
Library3_CustomerType.attributes={Library3_CustomerType_lastName, Library3_CustomerType_borrowedBookId, Library3_CustomerType_firstName}
...
domain_model = DomainModel(
    name="Library3",
    types={Library3_BookType, Library3_BookInfoType, Library3_DocumentRoot, Library3_CustomerType, Library3_EStringToStringMapEntry, Library3_LibraryType},
    associations={bookInfo0, xMLNSPrefixMap1, xSISchemaLocation2, library5, book7, customer10},
    generalizations={},
    metadata=None
)
