...
class bootstrap_Section:
    ...
    def __init__(self, title: str, description: str, sections: "bootstrap_Page" = None, Section11: "bootstrap_Widget" = None, Section: "bootstrap_Page" = None, section: set["bootstrap_Widget"] = None):
        self.title = title
        self.description = description
...
class bootstrap_Page:
    ...
    def __init__(self, title: str, description: str, name: str, Page9: "bootstrap_Section" = None, Page: "bootstrap_Site" = None, page: set["bootstrap_Section"] = None, pages: "bootstrap_Site" = None):
        self.title = title
        self.description = description
        self.name = name
        self.Page9 = Page9
