...
bootstrap_Page.attributes={bootstrap_Page_description, bootstrap_Page_name, bootstrap_Page_title}
...
bootstrap_Table.attributes={bootstrap_Table_columnNames, bootstrap_Table_rowNames, bootstrap_Table_bordered, bootstrap_Table_striped}
...
domain_model = DomainModel(
    name="bootstrap",
    types={bootstrap_Site, bootstrap_Page, bootstrap_MainPage, bootstrap_Form, Widget, bootstrap_FormWidget, bootstrap_Table, bootstrap_Text, bootstrap_Video, bootstrap_Gallery, bootstrap_ImagesBlock, bootstrap_Section, bootstrap_Widget, bootstrap_TextArea, FormWidget, bootstrap_Spinner, bootstrap_CheckBox},
    associations={pages0, mainPage1, section10, formWidgets12, sections3, site4, site5, widgets7, page8, form13},
