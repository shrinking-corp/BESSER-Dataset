...
# Classes
anytype_A = Class(name="anytype_A")
anytype_B = Class(name="anytype_B")
anytype_C = Class(name="anytype_C")
anytype_TestAny = Class(name="anytype_TestAny")
anytype_EObject = Class(name="anytype_EObject")
...
anytype_A.attributes={anytype_A_name, anytype_A_lon, anytype_A_doub}
...
anytype_TestAny.attributes={anytype_TestAny_name, anytype_TestAny_any, anytype_TestAny_a, anytype_TestAny_myAny}
...
domain_model = DomainModel(
    name="anytype",
    types={anytype_A, anytype_B, anytype_C, anytype_TestAny, anytype_EObject},
