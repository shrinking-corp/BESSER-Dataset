...
ClassS = Class(name="ClassS", is_abstract=True)
ClassT = Class(name="ClassT")
ClassU = Class(name="ClassU")
ClassV = Class(name="ClassV", is_abstract=True)
...
domain_model = DomainModel(
    name="_8aede546_a87e_4a9c_8051_fae7fcf15e60",
    types={BankAccount, ClassA, ClassB, ClassC, ClassD, ClassE, ClassF, ClassG, ClassJ, ClassH, ClassK, ClassL, ClassM, ClassN, ClassP, InterfaceO_Interface, ClassQ, ClassR, ClassS, ClassT, ClassU, ClassV, Class_},
