...
public class Hotel_Guest_Actor  {
    ...
    private Search_Avalibility_UseCase search_avalibility_usecase;
    ...
    public Search_Avalibility_UseCase getSearch_avalibility_usecase() {
        return search_avalibility_usecase;
    }

    public void setSearch_avalibility_usecase(Search_Avalibility_UseCase search_avalibility_usecase) {
        this.search_avalibility_usecase = search_avalibility_usecase;
    }
