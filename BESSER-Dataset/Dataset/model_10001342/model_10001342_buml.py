...
Manager.attributes={Manager_Phone_No, Manager_Id, Manager_Name}
...
domain_model = DomainModel(
    name="_0zceoCN5EeisAYMSV00L2Q",
    types={Search_Avalibility_UseCase, Book_Room_UseCase, Cancel_Reservation_UseCase, Check_In_UseCase, Check_Out_UseCase, Food_Serving_UseCase, Menu_Preparation_UseCase, Room_Cleaning_UseCase, Hotel_Guest_Actor, Receptionist_Actor, Chef_Actor, HouseKeeping_Actor, Manager, Inventory, Customer},
