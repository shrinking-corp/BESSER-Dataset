...
simplepdl_Need = Class(name="simplepdl_Need")
simplepdl_WorkSequence = Class(name="simplepdl_WorkSequence")
simplepdl_NeedSet = Class(name="simplepdl_NeedSet")
...
domain_model = DomainModel(
    name="simplepdl",
    types={simplepdl_ProcessElement, simplepdl_WorkDefinition, ProcessElement, simplepdl_Process, simplepdl_Need, simplepdl_WorkSequence, simplepdl_NeedSet, simplepdl_Guidance, simplepdl_Ressource, WorkSequenceType},
    associations={processElements0, process1, ressource10, needSet11, linksToPredecessors2, linksToSuccessors3, needSets5, predecessor6, successor7, element9, needs13, wd14},
    generalizations={gen_simplepdl_WorkDefinition_ProcessElement, gen_simplepdl_Need_ProcessElement, gen_simplepdl_NeedSet_ProcessElement, gen_simplepdl_WorkSequence_ProcessElement, gen_simplepdl_Guidance_ProcessElement, gen_simplepdl_Ressource_ProcessElement},
    metadata=None
)
