...
class simplepdl_NeedSet(ProcessElement):
    ...
    def __init__(self, name: str, NeedSet12: "simplepdl_Need" = None, NeedSet: "simplepdl_WorkDefinition" = None, needSet: set["simplepdl_Need"] = None, needSets: "simplepdl_WorkDefinition" = None):
        self.name = name
...
class simplepdl_WorkSequence(ProcessElement):
    ...
    def __init__(self, linkType: str, WorkSequence: "simplepdl_WorkDefinition" = None, WorkSequence4: "simplepdl_WorkDefinition" = None, linksToSuccessors: "simplepdl_WorkDefinition" = None, linksToPredecessors: "simplepdl_WorkDefinition" = None):
...
class simplepdl_WorkDefinition(ProcessElement):
    ...
    def __init__(self, name: str, successor: set["simplepdl_WorkSequence"] = None, predecessor: set["simplepdl_WorkSequence"] = None, wd: set["simplepdl_NeedSet"] = None, WorkDefinition: "simplepdl_WorkSequence" = None, WorkDefinition8: "simplepdl_WorkSequence" = None, WorkDefinition15: "simplepdl_NeedSet" = None):
        self.name = name
