...
class Account:
    ...
    def __init__(self, billingAddress: str, open: date, closed: date, isClosed: bool, cart8: "ShoppingCart" = None, p0: set["Payment"] = None, customer7: "Customer" = None, order16: set["Order"] = None):
