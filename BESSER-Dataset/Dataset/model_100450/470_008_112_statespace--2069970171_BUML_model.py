...
statespace_StateSpace.attributes={statespace_StateSpace_transitionCount, statespace_StateSpace_layoutZoomLevel, statespace_StateSpace_layoutHideIndizes, statespace_StateSpace_layoutStateRepulsion, statespace_StateSpace_layoutHideLabels, statespace_StateSpace_maxStateDistance, statespace_StateSpace_layoutTransitionAttraction, statespace_StateSpace_allParameterKeys, statespace_StateSpace_stateCount}
statespace_StateSpace.methods={statespace_StateSpace_m_incTransitionCount, statespace_StateSpace_m_updateEqualityHelper, statespace_StateSpace_m_removeState}
...
statespace_State_m_getOutgoing: Method = Method(name="getOutgoing", parameters={Parameter(name='statespace_rule', type=StringType), Parameter(name='statespace_target', type=StringType), Parameter(name='statespace_paramIDs', type=StringType), Parameter(name='statespace_match', type=StringType)}, type=StringType)
statespace_State.attributes={statespace_State_open, statespace_State_goal, statespace_State_objectKeys, statespace_State_objectCount, statespace_State_derivedFrom, statespace_State_pruned, statespace_State_index, statespace_State_location, statespace_State_hashCode}
statespace_State.methods={statespace_State_m_isInitial, statespace_State_m_getOutgoing}
...
statespace_EqualityHelper_m_equals: Method = Method(name="equals", parameters={Parameter(name='statespace_model1', type=StringType), Parameter(name='statespace_model2', type=StringType)}, type=BooleanType)
...
statespace_Transition.attributes={statespace_Transition_match, statespace_Transition_parameterKeys, statespace_Transition_parameterCount}
...
statespace_Model.attributes={statespace_Model_objectCount, statespace_Model_objectKeys, statespace_Model_eGraph, statespace_Model_resource}
statespace_Model.methods={statespace_Model_m_updateObjectKeys, statespace_Model_m_getCopy, statespace_Model_m_collectMissingRootObjects}
...
statespace_Storage_m_getData: Method = Method(name="getData", parameters={Parameter(name='statespace_beginIndex', type=StringType), Parameter(name='statespace_endIndex', type=StringType)}, type=StringType)
statespace_Storage_m_setData: Method = Method(name="setData", parameters={Parameter(name='statespace_value', type=StringType), Parameter(name='statespace_beginIndex', type=StringType)})
statespace_Storage_m_setData: Method = Method(name="setData", parameters={Parameter(name='statespace_value', type=StringType), Parameter(name='statespace_endIndex', type=StringType), Parameter(name='statespace_beginIndex', type=StringType)})
statespace_Storage.attributes={statespace_Storage_data}
statespace_Storage.methods={statespace_Storage_m_setData, statespace_Storage_m_getData, statespace_Storage_m_getData, statespace_Storage_m_setData, statespace_Storage_m_setData}
...
domain_model = DomainModel(
    name="statespace",
    types={statespace_StateSpace, Storage, statespace_EStringToStringMapEntry, statespace_Rule, statespace_State, statespace_EqualityHelper, statespace_Transition, statespace_Model, statespace_EAttribute, statespace_EObjectIntegerMapEntry, statespace_EClass, statespace_Storage, statespace_EObject},
    associations={properties9, rules0, states1, initialStates2, openStates4, equalityHelper7, model15, incoming11, outgoing12, stateSpace14, ignoredAttributes28, objectHashCodes17, objectKeysMap19, source22, target24, rule26, identityTypes30, key32},
