...
class statespace_Storage:
    ...
    def getData(self, statespace_beginIndex, statespace_endIndex) :
...
class statespace_State(Storage):
    ...
    def __init__(self, index: int, hashCode: int, derivedFrom: int, open: bool, goal: bool, pruned: bool, location: str, objectCount: int, objectKeys: str, State: "statespace_StateSpace" = None, statespace_State: "statespace_StateSpace" = None, statespace_State6: "statespace_StateSpace" = None, statespace_State16: "statespace_Model" = None, target: set["statespace_Transition"] = None, source: set["statespace_Transition"] = None, states: "statespace_StateSpace" = None, State23: "statespace_Transition" = None, State25: "statespace_Transition" = None):
        self.index = index
    ...
    def getOutgoing(self, statespace_paramIDs, statespace_target, statespace_rule, statespace_match) :
...
class statespace_StateSpace(Storage):
    ...
    def __init__(self, stateCount: int, transitionCount: int, layoutZoomLevel: int, layoutStateRepulsion: int, layoutTransitionAttraction: int, layoutHideLabels: bool, layoutHideIndizes: bool, maxStateDistance: int, allParameterKeys: str, statespace_StateSpace10: set["statespace_EStringToStringMapEntry"] = None, statespace_StateSpace: set["statespace_Rule"] = None, stateSpace: set["statespace_State"] = None, statespace_StateSpace3: set["statespace_State"] = None, statespace_StateSpace5: set["statespace_State"] = None, statespace_StateSpace8: "statespace_EqualityHelper" = None, StateSpace: "statespace_State" = None):
