...
pascal_function_procedure_declaration = Class(name="pascal_function_procedure_declaration")
...
pascal_label_declaration = Class(name="pascal_label_declaration")
...
pascal_constant.attributes={pascal_constant_name, pascal_constant_opterator, pascal_constant_nil, pascal_constant_boolLiteral, pascal_constant_string}
...
not_59: BinaryAssociation = BinaryAssociation(
    name="not_59",
    ends={
...
domain_model = DomainModel(
    name="pascal",
    types={pascal_program, pascal_program_heading_block, pascal_type_definition_part, pascal_variable_declaration_part, pascal_constant_definition_part, pascal_function_procedure_declaration, pascal_statement_part, pascal_statement_sequence, pascal_statement, pascal_label, pascal_simple_statement, pascal_structured_statement, pascal_assignment_statement, pascal_function_designator, pascal_compound_statement, pascal_block, pascal_label_declaration, pascal_while_statement, pascal_expression_list, pascal_simple_expression, pascal_EObject, pascal_term, pascal_factor, pascal_number, pascal_variable, pascal_expression, pascal_abstraction_declaration, pascal_abstraction_heading, pascal_formal_parameter_list, pascal_formal_parameter_section, pascal_value_parameter_section, pascal_variable_parameter_section, pascal_identifier_list, pascal_parameter_type, pascal_record_type, pascal_any_number, pascal_field_list, pascal_constant, pascal_constant_definition, pascal_type_definition, pascal_type, pascal_simple_type, pascal_structured_type, pascal_unpacked_structured_type, pascal_record_section, pascal_variable_section, pascal_variable_identifier_list},
    associations={heading0, type5, variable7, constant9, abstraction11, statement13, sequence15, statements17, label19, simple21, structured23, assignment25, function27, compound29, block1, label3, while_stmt31, sequence33, expressions40, expressions42, terms44, factors46, variable47, number50, variable36, expression38, not_59, expressions61, functions64, procedures66, parameters69, heading70, block73, parameters76, value78, variable80, procedure82, function85, identifiers88, type90, function52, expression55, record120, type95, number98, fields122, labels100, number103, consts105, const107, types110, type112, simple114, structured116, type118, indentifiers92, sections124, identifiers126, type129, sections132, identifiers134, type136, expression139, statement142},
    generalizations={},
    metadata=None
)
