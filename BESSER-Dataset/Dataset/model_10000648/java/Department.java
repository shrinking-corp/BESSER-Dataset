...
public class Department  {
    ...
    public Department(
        None course,        None hod,        None students__,        None teachers__    ) {
        this.course = course;
        this.hod = hod;
    ...
    public Department(
        None course,        None hod,        None students__,        None teachers__        ArrayList<Student> students,        ArrayList<Employee_Interface> employee_interfaces    ) {
        this.course = course;
        this.hod = hod;
        this.students__ = students__;
        this.teachers__ = teachers__;
