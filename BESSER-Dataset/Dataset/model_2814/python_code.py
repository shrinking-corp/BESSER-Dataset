...
class geoff_style_Circle(Image):
    ...
    def __init__(self, radius: float, geoff_style_Circle: "Fill" = None, geoff_style_Circle37: "Stroke" = None, Image: "geoff_style_Style" = None):
        self.radius = radius
...
class geoff_style_Icon(Image):
    ...
    def __init__(self, src: str, Image: "geoff_style_Style" = None):
        self.src = src
...
class geoff_source_VectorSource(Source):
    ...
    def __init__(self, url: str, projection: str, format: str, geoff_source_VectorSource: set["source_geoff_Feature"] = None, Source: "geoff_layer_Layer" = None):
        self.url = url
...
class geoff_style_Text(Identifiable):
    ...
    def __init__(self, text: str, textAlign: str, textBaseLine: str, font: str, offsetX: float, offsetY: float, rotation: str, scale: str, geoff_style_Text: "Fill" = None, geoff_style_Text42: "Stroke" = None):
        self.text = text
...
class geoff_source_Source(Identifiable, Descriptive):
    ...
    pass
class geoff_GeoMap(Identifiable, Descriptive):
...
class geoff_Descriptive(ABC):
    ...
    def __init__(self, shortDescription: str, longDescription: str):
...
class geoff_interaction_Select(Interaction):
    ...
    def __init__(self, condition: str, multi: bool, Interaction: "geoff_GeoMap" = None):
