...
geoff_View = Class(name="geoff_View")
geoff_Script = Class(name="geoff_Script")
Interaction = Class(name="Interaction")
geoff_Location = Class(name="geoff_Location", is_abstract=True)
geoff_XYZLocation = Class(name="geoff_XYZLocation")
Location = Class(name="Location")
geoff_Identifiable = Class(name="geoff_Identifiable", is_abstract=True)
geoff_Descriptive = Class(name="geoff_Descriptive", is_abstract=True)
geoff_GeoMap = Class(name="geoff_GeoMap")
Identifiable = Class(name="Identifiable")
Descriptive = Class(name="Descriptive")
geoff_layer_Layer = Class(name="geoff_layer_Layer", is_abstract=True)
Source = Class(name="Source")
geoff_layer_TileLayer = Class(name="geoff_layer_TileLayer")
geoff_layer_VectorLayer = Class(name="geoff_layer_VectorLayer")
layer_geoff_StyleEntry = Class(name="layer_geoff_StyleEntry")
geoff_source_Source = Class(name="geoff_source_Source", is_abstract=True)
geoff_source_TileSource = Class(name="geoff_source_TileSource", is_abstract=True)
geoff_source_TileImage = Class(name="geoff_source_TileImage", is_abstract=True)
TileSource = Class(name="TileSource")
geoff_source_XYZ = Class(name="geoff_source_XYZ", is_abstract=True)
geoff_Feature = Class(name="geoff_Feature")
Geometry = Class(name="Geometry")
Style = Class(name="Style")
geoff_StringToStringMapEntry = Class(name="geoff_StringToStringMapEntry")
geoff_Color = Class(name="geoff_Color")
geoff_StyleEntry = Class(name="geoff_StyleEntry")
geoff_geom_Polygon = Class(name="geoff_geom_Polygon")
geoff_style_Style = Class(name="geoff_style_Style")
Image = Class(name="Image")
Fill = Class(name="Fill")
Stroke = Class(name="Stroke")
Text = Class(name="Text")
geoff_style_Image = Class(name="geoff_style_Image")
geoff_style_Icon = Class(name="geoff_style_Icon")
geoff_style_Fill = Class(name="geoff_style_Fill")
style_geoff_Color = Class(name="style_geoff_Color")
TileImage = Class(name="TileImage")
geoff_source_OSM = Class(name="geoff_source_OSM")
XYZ = Class(name="XYZ")
geoff_source_MapQuest = Class(name="geoff_source_MapQuest")
geoff_source_BingMaps = Class(name="geoff_source_BingMaps")
geoff_source_VectorSource = Class(name="geoff_source_VectorSource")
source_geoff_Feature = Class(name="source_geoff_Feature")
geoff_geom_Geometry = Class(name="geoff_geom_Geometry", is_abstract=True)
geoff_geom_SimpleGeometry = Class(name="geoff_geom_SimpleGeometry")
geoff_geom_Point = Class(name="geoff_geom_Point")
SimpleGeometry = Class(name="SimpleGeometry")
geom_geoff_Location = Class(name="geom_geoff_Location")
geoff_geom_LineString = Class(name="geoff_geom_LineString")
geoff_interaction_Interaction = Class(name="geoff_interaction_Interaction", is_abstract=True)
geoff_interaction_Select = Class(name="geoff_interaction_Select")
geoff_style_Stroke = Class(name="geoff_style_Stroke")
geoff_style_Circle = Class(name="geoff_style_Circle")
geoff_style_Text = Class(name="geoff_style_Text")
...
geoff_Script.attributes={geoff_Script_type, geoff_Script_context, geoff_Script_src}
...
geoff_Descriptive.attributes={geoff_Descriptive_longDescription, geoff_Descriptive_shortDescription}
...
geoff_StringToStringMapEntry.attributes={geoff_StringToStringMapEntry_key, geoff_StringToStringMapEntry_value}
...
geoff_Color.attributes={geoff_Color_alpha, geoff_Color_green, geoff_Color_red, geoff_Color_blue}
...
geoff_source_BingMaps.attributes={geoff_source_BingMaps_key, geoff_source_BingMaps_imagerySet}
...
geoff_source_VectorSource.attributes={geoff_source_VectorSource_format, geoff_source_VectorSource_projection, geoff_source_VectorSource_url}
...
geoff_style_Stroke.attributes={geoff_style_Stroke_miterLimit, geoff_style_Stroke_width, geoff_style_Stroke_lineJoin, geoff_style_Stroke_lineDash, geoff_style_Stroke_lineCap}
...
geoff_style_Text.attributes={geoff_style_Text_offsetY, geoff_style_Text_offsetX, geoff_style_Text_textBaseLine, geoff_style_Text_font, geoff_style_Text_textAlign, geoff_style_Text_rotation, geoff_style_Text_scale, geoff_style_Text_text}
...
domain_model = DomainModel(
    name="geoff",
    types={Layer, geoff_View, geoff_Script, Interaction, geoff_Location, geoff_XYZLocation, Location, geoff_Identifiable, geoff_Descriptive, geoff_GeoMap, Identifiable, Descriptive, geoff_layer_Layer, Source, geoff_layer_TileLayer, geoff_layer_VectorLayer, layer_geoff_StyleEntry, geoff_source_Source, geoff_source_TileSource, geoff_source_TileImage, TileSource, geoff_source_XYZ, geoff_Feature, Geometry, Style, geoff_StringToStringMapEntry, geoff_Color, geoff_StyleEntry, geoff_geom_Polygon, geoff_style_Style, Image, Fill, Stroke, Text, geoff_style_Image, geoff_style_Icon, geoff_style_Fill, style_geoff_Color, TileImage, geoff_source_OSM, XYZ, geoff_source_MapQuest, geoff_source_BingMaps, geoff_source_VectorSource, source_geoff_Feature, geoff_geom_Geometry, geoff_geom_SimpleGeometry, geoff_geom_Point, SimpleGeometry, geom_geoff_Location, geoff_geom_LineString, geoff_interaction_Interaction, geoff_interaction_Select, geoff_style_Stroke, geoff_style_Circle, geoff_style_Text, ScriptContext, RendererHint, SourceFormat, EventCondition},
    associations={layers0, view1, scripts3, interactions5, center7, source16, styles17, geometry9, style10, properties12, value14, coordinates20, coordinates22, image24, fill25, stroke27, text29, features18, coordinates19, color31, color32, fill34, stroke36, fill39, stroke41},
    generalizations={gen_geoff_View_Identifiable, gen_geoff_Location_Identifiable, gen_geoff_XYZLocation_Location, gen_geoff_GeoMap_Identifiable, gen_geoff_GeoMap_Descriptive, gen_geoff_Script_Identifiable, gen_geoff_layer_Layer_Identifiable, gen_geoff_layer_Layer_Descriptive, gen_geoff_layer_TileLayer_Layer, gen_geoff_layer_VectorLayer_Layer, gen_geoff_source_Source_Identifiable, gen_geoff_source_Source_Descriptive, gen_geoff_source_TileSource_Source, gen_geoff_source_TileImage_TileSource, gen_geoff_Feature_Identifiable, gen_geoff_Color_Identifiable, gen_geoff_geom_Polygon_SimpleGeometry, gen_geoff_style_Style_Identifiable, gen_geoff_style_Image_Identifiable, gen_geoff_style_Icon_Image, gen_geoff_style_Fill_Identifiable, gen_geoff_source_XYZ_TileImage, gen_geoff_source_OSM_XYZ, gen_geoff_source_MapQuest_XYZ, gen_geoff_source_BingMaps_XYZ, gen_geoff_source_VectorSource_Source, gen_geoff_geom_Geometry_Identifiable, gen_geoff_geom_SimpleGeometry_Geometry, gen_geoff_geom_Point_SimpleGeometry, gen_geoff_geom_LineString_SimpleGeometry, gen_geoff_interaction_Interaction_Identifiable, gen_geoff_interaction_Select_Interaction, gen_geoff_style_Stroke_Identifiable, gen_geoff_style_Circle_Image, gen_geoff_style_Text_Identifiable},
    metadata=None
)
