...
domain_model = DomainModel(
    name="PetriNet",
    types={PetriNet_PetriNet, PetriNet_Place, PetriNet_Transition, PetriNet_Arc, PetriNet_PlaceToTransArc, Arc, PetriNet_TransToPlaceArc},
    associations={places0, transitions1, arcs3, source5, target7, source10, target12},
