...
TimeUnit: Enumeration = Enumeration(
    ...
    literals={
			...
			EnumerationLiteral(name="microsend"),
...
stext_Type = Class(name="stext_Type")
...
stext_StatechartSpecification_namespace: Property = Property(name="namespace", type=StringType)
stext_StatechartSpecification.attributes={stext_StatechartSpecification_namespace}
...
stext_TimeEventSpec.attributes={stext_TimeEventSpec_type, stext_TimeEventSpec_unit, stext_TimeEventSpec_value}
...
# stext_Type class attributes and methods
...
definitionScopes4: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="stext_Scope", type=stext_StatechartSpecification, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_StatechartSpecification5", type=stext_Scope, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
scope6: BinaryAssociation = BinaryAssociation(
    name="scope6",
    ends={
        Property(name="stext_Scope8", type=stext_StateSpecification, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_StateSpecification7", type=stext_Scope, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
...
reaction9: BinaryAssociation = BinaryAssociation(
    name="reaction9",
    ends={
        Property(name="stext_TransitionReaction", type=stext_TransitionSpecification, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_TransitionSpecification10", type=stext_TransitionReaction, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
...
value12: BinaryAssociation = BinaryAssociation(
    name="value12",
    ends={
        Property(name="stext_Expression14", type=stext_EventDerivation, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_EventDerivation13", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
...
properties16: BinaryAssociation = BinaryAssociation(
    name="properties16",
    ends={
        Property(name="stext_ReactionProperties18", type=stext_TransitionReaction, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_TransitionReaction17", type=stext_ReactionProperties, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
properties19: BinaryAssociation = BinaryAssociation(
    name="properties19",
    ends={
        Property(name="stext_ReactionProperty", type=stext_ReactionProperties, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_ReactionProperties20", type=stext_ReactionProperty, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
entrypoint21: BinaryAssociation = BinaryAssociation(
    name="entrypoint21",
    ends={
...
exitpoint22: BinaryAssociation = BinaryAssociation(
    name="exitpoint22",
    ends={
...
expression25: BinaryAssociation = BinaryAssociation(
    name="expression25",
    ends={
        Property(name="stext_Expression27", type=stext_Assignment, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_Assignment26", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
event28: BinaryAssociation = BinaryAssociation(
    name="event28",
    ends={
        Property(name="stext_Event29", type=stext_EventRaising, multiplicity=Multiplicity(1, 1)),
...
value30: BinaryAssociation = BinaryAssociation(
    name="value30",
    ends={
        Property(name="stext_Expression32", type=stext_EventRaising, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_EventRaising31", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
type37: BinaryAssociation = BinaryAssociation(
    name="type37",
    ends={
        Property(name="stext_Type", type=stext_EventDefinition, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_EventDefinition", type=stext_Type, multiplicity=Multiplicity(0, 1))
    }
)
derivation38: BinaryAssociation = BinaryAssociation(
    name="derivation38",
    ends={
        Property(name="stext_EventDerivation40", type=stext_EventDefinition, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_EventDefinition39", type=stext_EventDerivation, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
type41: BinaryAssociation = BinaryAssociation(
    name="type41",
    ends={
        Property(name="stext_Type42", type=stext_VariableDefinition, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_VariableDefinition", type=stext_Type, multiplicity=Multiplicity(0, 1))
    }
)
initialValue43: BinaryAssociation = BinaryAssociation(
    name="initialValue43",
    ends={
        Property(name="stext_Expression45", type=stext_VariableDefinition, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_VariableDefinition44", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
...
value34: BinaryAssociation = BinaryAssociation(
    name="value34",
    ends={
        Property(name="stext_Event35", type=stext_EventValueReferenceExpression, multiplicity=Multiplicity(1, 1)),
...
leftOperand69: BinaryAssociation = BinaryAssociation(
    name="leftOperand69",
    ends={
        Property(name="stext_Expression70", type=stext_LogicalAndExpression, multiplicity=Multiplicity(1, 1)),
...
rightOperand71: BinaryAssociation = BinaryAssociation(
    name="rightOperand71",
    ends={
        Property(name="stext_Expression73", type=stext_LogicalAndExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_LogicalAndExpression72", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
operand74: BinaryAssociation = BinaryAssociation(
    name="operand74",
    ends={
        Property(name="stext_Expression75", type=stext_LogicalNotExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_LogicalNotExpression", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
leftOperand76: BinaryAssociation = BinaryAssociation(
    name="leftOperand76",
    ends={
        Property(name="stext_Expression77", type=stext_BitwiseXorExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_BitwiseXorExpression", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
paramTypes46: BinaryAssociation = BinaryAssociation(
    name="paramTypes46",
    ends={
        Property(name="stext_Type47", type=stext_Operation, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_Operation", type=stext_Type, multiplicity=Multiplicity(0, 9999))
    }
)
type48: BinaryAssociation = BinaryAssociation(
    name="type48",
    ends={
        Property(name="stext_Type50", type=stext_Operation, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_Operation49", type=stext_Type, multiplicity=Multiplicity(0, 1))
    }
)
triggers51: BinaryAssociation = BinaryAssociation(
    name="triggers51",
    ends={
...
guardExpression52: BinaryAssociation = BinaryAssociation(
    name="guardExpression52",
    ends={
        Property(name="stext_Expression54", type=stext_ReactionTrigger, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_ReactionTrigger53", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
actions55: BinaryAssociation = BinaryAssociation(
    name="actions55",
    ends={
...
condition56: BinaryAssociation = BinaryAssociation(
    name="condition56",
    ends={
        Property(name="stext_Expression57", type=stext_ConditionalExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_ConditionalExpression", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
trueCase58: BinaryAssociation = BinaryAssociation(
    name="trueCase58",
    ends={
        Property(name="stext_Expression60", type=stext_ConditionalExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_ConditionalExpression59", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
falseCase61: BinaryAssociation = BinaryAssociation(
    name="falseCase61",
    ends={
        Property(name="stext_Expression63", type=stext_ConditionalExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_ConditionalExpression62", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
leftOperand64: BinaryAssociation = BinaryAssociation(
    name="leftOperand64",
    ends={
        Property(name="stext_Expression65", type=stext_LogicalOrExpression, multiplicity=Multiplicity(1, 1)),
...
rightOperand66: BinaryAssociation = BinaryAssociation(
    name="rightOperand66",
    ends={
        Property(name="stext_Expression68", type=stext_LogicalOrExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_LogicalOrExpression67", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
leftOperand91: BinaryAssociation = BinaryAssociation(
    name="leftOperand91",
    ends={
        Property(name="stext_Expression92", type=stext_LogicalRelationExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_LogicalRelationExpression", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
rightOperand93: BinaryAssociation = BinaryAssociation(
    name="rightOperand93",
    ends={
        Property(name="stext_Expression95", type=stext_LogicalRelationExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_LogicalRelationExpression94", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
leftOperand96: BinaryAssociation = BinaryAssociation(
    name="leftOperand96",
    ends={
        Property(name="stext_Expression97", type=stext_ShiftExpression, multiplicity=Multiplicity(1, 1)),
...
rightOperand98: BinaryAssociation = BinaryAssociation(
    name="rightOperand98",
    ends={
        Property(name="stext_Expression100", type=stext_ShiftExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_ShiftExpression99", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
rightOperand78: BinaryAssociation = BinaryAssociation(
    name="rightOperand78",
    ends={
        Property(name="stext_Expression80", type=stext_BitwiseXorExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_BitwiseXorExpression79", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
leftOperand81: BinaryAssociation = BinaryAssociation(
    name="leftOperand81",
    ends={
        Property(name="stext_Expression82", type=stext_BitwiseOrExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_BitwiseOrExpression", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
rightOperand83: BinaryAssociation = BinaryAssociation(
    name="rightOperand83",
    ends={
        Property(name="stext_Expression85", type=stext_BitwiseOrExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_BitwiseOrExpression84", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
leftOperand86: BinaryAssociation = BinaryAssociation(
    name="leftOperand86",
    ends={
        Property(name="stext_Expression87", type=stext_BitwiseAndExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_BitwiseAndExpression", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
rightOperand88: BinaryAssociation = BinaryAssociation(
    name="rightOperand88",
    ends={
        Property(name="stext_Expression90", type=stext_BitwiseAndExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_BitwiseAndExpression89", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
leftOperand101: BinaryAssociation = BinaryAssociation(
    name="leftOperand101",
    ends={
        Property(name="stext_Expression102", type=stext_NumericalAddSubtractExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_NumericalAddSubtractExpression", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
rightOperand103: BinaryAssociation = BinaryAssociation(
    name="rightOperand103",
    ends={
        Property(name="stext_Expression105", type=stext_NumericalAddSubtractExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_NumericalAddSubtractExpression104", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
leftOperand106: BinaryAssociation = BinaryAssociation(
    name="leftOperand106",
    ends={
        Property(name="stext_Expression107", type=stext_NumericalMultiplyDivideExpression, multiplicity=Multiplicity(1, 1)),
...
rightOperand108: BinaryAssociation = BinaryAssociation(
    name="rightOperand108",
    ends={
        Property(name="stext_Expression110", type=stext_NumericalMultiplyDivideExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_NumericalMultiplyDivideExpression109", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
operand111: BinaryAssociation = BinaryAssociation(
    name="operand111",
    ends={
        Property(name="stext_Expression112", type=stext_NumericalUnaryExpression, multiplicity=Multiplicity(1, 1)),
...
operation114: BinaryAssociation = BinaryAssociation(
    name="operation114",
    ends={
        Property(name="stext_Operation115", type=stext_OperationCall, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_OperationCall", type=stext_Operation, multiplicity=Multiplicity(0, 1))
    }
)
args116: BinaryAssociation = BinaryAssociation(
    name="args116",
    ends={
        Property(name="stext_Expression118", type=stext_OperationCall, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_OperationCall117", type=stext_Expression, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
domain_model = DomainModel(
    name="stext",
    types={stext_StateSpecification, stext_TransitionRoot, stext_TransitionSpecification, stext_Scope, stext_Root, stext_DefRoot, stext_StatechartRoot, DefRoot, stext_StatechartSpecification, stext_StateRoot, stext_EventSpec, stext_RegularEventSpec, EventSpec, stext_Event, stext_TimeEventSpec, stext_BuiltinEventSpec, stext_TransitionReaction, stext_EventDerivation, stext_Expression, stext_LocalReaction, Declaration, Reaction, stext_ReactionProperties, stext_ReactionProperty, stext_EntryPointSpec, ReactionProperty, stext_Entrypoint, stext_ExitPointSpec, stext_Exitpoint, stext_EntryEvent, BuiltinEventSpec, stext_ExitEvent, stext_OnCycleEvent, stext_AlwaysEvent, stext_DefaultEvent, stext_Assignment, Statement, stext_Variable, stext_EventRaising, Event, stext_Type, stext_VariableDefinition, Variable, stext_ElementReferenceExpression, Expression, stext_Declaration, stext_EventValueReferenceExpression, stext_ActiveStateReferenceExpression, stext_RegularState, stext_Literal, stext_BoolLiteral, Literal, stext_IntLiteral, stext_RealLiteral, stext_HexLiteral, stext_SimpleScope, Scope, stext_InterfaceScope, stext_InternalScope, stext_EventDefinition, stext_LogicalNotExpression, stext_BitwiseXorExpression, stext_Operation, stext_ReactionTrigger, Trigger, stext_ReactionEffect, Effect, stext_Statement, stext_ConditionalExpression, stext_LogicalOrExpression, stext_LogicalAndExpression, stext_LogicalRelationExpression, stext_ShiftExpression, stext_BitwiseOrExpression, stext_BitwiseAndExpression, stext_NumericalAddSubtractExpression, stext_NumericalMultiplyDivideExpression, stext_NumericalUnaryExpression, stext_PrimitiveValueExpression, stext_OperationCall, TimeEventType, Direction, AdditiveOperator, MultiplicativeOperator, UnaryOperator, RelationalOperator, AssignmentOperator, ShiftOperator, TimeUnit},
    associations={def_2, def_3, definitionScopes4, scope6, roots0, def_1, event23, reaction9, condition11, value12, properties15, properties16, properties19, entrypoint21, exitpoint22, varRef24, expression25, event28, value30, type37, derivation38, type41, initialValue43, value33, value34, value36, leftOperand69, rightOperand71, operand74, leftOperand76, paramTypes46, type48, triggers51, guardExpression52, actions55, condition56, trueCase58, falseCase61, leftOperand64, rightOperand66, leftOperand91, rightOperand93, leftOperand96, rightOperand98, rightOperand78, leftOperand81, rightOperand83, leftOperand86, rightOperand88, leftOperand101, rightOperand103, leftOperand106, rightOperand108, operand111, value113, operation114, args116},
    generalizations={gen_stext_TransitionRoot_DefRoot, gen_stext_StatechartRoot_DefRoot, gen_stext_StateRoot_DefRoot, gen_stext_RegularEventSpec_EventSpec, gen_stext_TimeEventSpec_EventSpec, gen_stext_BuiltinEventSpec_EventSpec, gen_stext_LocalReaction_Declaration, gen_stext_LocalReaction_Reaction, gen_stext_TransitionReaction_Reaction, gen_stext_EntryPointSpec_ReactionProperty, gen_stext_ExitPointSpec_ReactionProperty, gen_stext_EntryEvent_BuiltinEventSpec, gen_stext_ExitEvent_BuiltinEventSpec, gen_stext_OnCycleEvent_BuiltinEventSpec, gen_stext_AlwaysEvent_BuiltinEventSpec, gen_stext_DefaultEvent_BuiltinEventSpec, gen_stext_Assignment_Statement, gen_stext_EventRaising_Statement, gen_stext_Expression_Statement, gen_stext_EventDefinition_Event, gen_stext_VariableDefinition_Variable, gen_stext_ElementReferenceExpression_Expression, gen_stext_EventValueReferenceExpression_Expression, gen_stext_ActiveStateReferenceExpression_Expression, gen_stext_BoolLiteral_Literal, gen_stext_IntLiteral_Literal, gen_stext_RealLiteral_Literal, gen_stext_HexLiteral_Literal, gen_stext_SimpleScope_Scope, gen_stext_InterfaceScope_Scope, gen_stext_InternalScope_Scope, gen_stext_LogicalAndExpression_Expression, gen_stext_LogicalNotExpression_Expression, gen_stext_BitwiseXorExpression_Expression, gen_stext_Operation_Declaration, gen_stext_Entrypoint_Declaration, gen_stext_Exitpoint_Declaration, gen_stext_ReactionTrigger_Trigger, gen_stext_ReactionEffect_Effect, gen_stext_ConditionalExpression_Expression, gen_stext_LogicalOrExpression_Expression, gen_stext_LogicalRelationExpression_Expression, gen_stext_ShiftExpression_Expression, gen_stext_BitwiseOrExpression_Expression, gen_stext_BitwiseAndExpression_Expression, gen_stext_NumericalAddSubtractExpression_Expression, gen_stext_NumericalMultiplyDivideExpression_Expression, gen_stext_NumericalUnaryExpression_Expression, gen_stext_PrimitiveValueExpression_Expression, gen_stext_OperationCall_Expression},
    metadata=None
)
