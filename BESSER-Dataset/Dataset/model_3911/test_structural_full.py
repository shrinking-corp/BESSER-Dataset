...
def test_pcm_pc_pc_entity_pc_pc_NamedElement_entityName_value_roundtrip():
    instance = pcm_pc_pc_entity_pc_pc_NamedElement(entityName="sample_text")
    assert instance.entityName == "sample_text"
    instance.entityName = "sample_text_2"
    assert instance.entityName == "sample_text_2"


def test_pcm_pc_pc_parameter_pc_pc_CharacterisedVariable_characterisationType_value_roundtrip():
    instance = pcm_pc_pc_parameter_pc_pc_CharacterisedVariable(characterisationType="sample_text")
...
def test_pcm_pc_pc_parameter_pc_pc_VariableCharacterisation_type_value_roundtrip():
    instance = pcm_pc_pc_parameter_pc_pc_VariableCharacterisation(type="sample_text")
    assert instance.type == "sample_text"
    instance.type = "sample_text_2"
    assert instance.type == "sample_text_2"


def test_pcm_pc_pc_protocol_pc_pc_Protocol_protocolTypeID_value_roundtrip():
    instance = pcm_pc_pc_protocol_pc_pc_Protocol(protocolTypeID="sample_text")
...
def test_pcm_pc_pc_reliability_pc_pc_FailureOccurrenceDescription_failureProbability_value_roundtrip():
    instance = pcm_pc_pc_reliability_pc_pc_FailureOccurrenceDescription(failureProbability=3.14)
    assert instance.failureProbability == 3.14
    instance.failureProbability = 9.99
    assert instance.failureProbability == 9.99


def test_pcm_pc_pc_repository_pc_pc_ExceptionType_exceptionMessage_value_roundtrip():
    instance = pcm_pc_pc_repository_pc_pc_ExceptionType(exceptionMessage="sample_text", exceptionName="sample_text")
...
def test_pcm_pc_pc_repository_pc_pc_ExceptionType_exceptionName_value_roundtrip():
    instance = pcm_pc_pc_repository_pc_pc_ExceptionType(exceptionMessage="sample_text", exceptionName="sample_text")
...
def test_pcm_pc_pc_repository_pc_pc_ImplementationComponentType_componentType_value_roundtrip():
    instance = pcm_pc_pc_repository_pc_pc_ImplementationComponentType(componentType="sample_text")
    assert instance.componentType == "sample_text"
    instance.componentType = "sample_text_2"
    assert instance.componentType == "sample_text_2"


def test_pcm_pc_pc_repository_pc_pc_Parameter_modifier__Parameter_value_roundtrip():
    instance = pcm_pc_pc_repository_pc_pc_Parameter(modifier__Parameter="sample_text", parameterName="sample_text")
...
def test_pcm_pc_pc_repository_pc_pc_Parameter_parameterName_value_roundtrip():
    instance = pcm_pc_pc_repository_pc_pc_Parameter(modifier__Parameter="sample_text", parameterName="sample_text")
...
def test_pcm_pc_pc_repository_pc_pc_PrimitiveDataType_type_value_roundtrip():
    instance = pcm_pc_pc_repository_pc_pc_PrimitiveDataType(type="sample_text")
    assert instance.type == "sample_text"
    instance.type = "sample_text_2"
    assert instance.type == "sample_text_2"


def test_pcm_pc_pc_repository_pc_pc_Repository_repositoryDescription_value_roundtrip():
    instance = pcm_pc_pc_repository_pc_pc_Repository(repositoryDescription="sample_text")
...
def test_pcm_pc_pc_repository_pc_pc_RequiredCharacterisation_type_value_roundtrip():
    instance = pcm_pc_pc_repository_pc_pc_RequiredCharacterisation(type="sample_text")
    assert instance.type == "sample_text"
    instance.type = "sample_text_2"
    assert instance.type == "sample_text_2"


def test_pcm_pc_pc_resourceenvironment_pc_pc_CommunicationLinkResourceSpecification_failureProbability_value_roundtrip():
    instance = pcm_pc_pc_resourceenvironment_pc_pc_CommunicationLinkResourceSpecification(failureProbability=3.14)
    assert instance.failureProbability == 3.14
    instance.failureProbability = 9.99
    assert instance.failureProbability == 9.99


def test_pcm_pc_pc_resourceenvironment_pc_pc_ProcessingResourceSpecification_MTTF_value_roundtrip():
    instance = pcm_pc_pc_resourceenvironment_pc_pc_ProcessingResourceSpecification(MTTF=3.14, MTTR=3.14, numberOfReplicas=7, requiredByContainer=True)
    assert instance.MTTF == 3.14
    instance.MTTF = 9.99
    assert instance.MTTF == 9.99


def test_pcm_pc_pc_resourceenvironment_pc_pc_ProcessingResourceSpecification_MTTR_value_roundtrip():
    instance = pcm_pc_pc_resourceenvironment_pc_pc_ProcessingResourceSpecification(MTTF=3.14, MTTR=3.14, numberOfReplicas=7, requiredByContainer=True)
...
def test_pcm_pc_pc_resourceenvironment_pc_pc_ProcessingResourceSpecification_numberOfReplicas_value_roundtrip():
    instance = pcm_pc_pc_resourceenvironment_pc_pc_ProcessingResourceSpecification(MTTF=3.14, MTTR=3.14, numberOfReplicas=7, requiredByContainer=True)
...
def test_pcm_pc_pc_resourceenvironment_pc_pc_ProcessingResourceSpecification_requiredByContainer_value_roundtrip():
    instance = pcm_pc_pc_resourceenvironment_pc_pc_ProcessingResourceSpecification(MTTF=3.14, MTTR=3.14, numberOfReplicas=7, requiredByContainer=True)
...
def test_pcm_pc_pc_resourcetype_pc_pc_ResourceSignature_resourceServiceId_value_roundtrip():
    instance = pcm_pc_pc_resourcetype_pc_pc_ResourceSignature(resourceServiceId=7)
    assert instance.resourceServiceId == 7
    instance.resourceServiceId = 13
    assert instance.resourceServiceId == 13


def test_pcm_pc_pc_seff_pc_pc_AcquireAction_timeout_value_roundtrip():
    instance = pcm_pc_pc_seff_pc_pc_AcquireAction(timeout=True, timeoutValue=3.14)
    assert instance.timeout == True
    instance.timeout = False
    assert instance.timeout == False


def test_pcm_pc_pc_seff_pc_pc_AcquireAction_timeoutValue_value_roundtrip():
    instance = pcm_pc_pc_seff_pc_pc_AcquireAction(timeout=True, timeoutValue=3.14)
...
def test_pcm_pc_pc_seff_pc_pc_ExternalCallAction_retryCount_value_roundtrip():
    instance = pcm_pc_pc_seff_pc_pc_ExternalCallAction(retryCount=7)
    assert instance.retryCount == 7
    instance.retryCount = 13
    assert instance.retryCount == 13


def test_pcm_pc_pc_seff_pc_pc_ProbabilisticBranchTransition_branchProbability_value_roundtrip():
    instance = pcm_pc_pc_seff_pc_pc_ProbabilisticBranchTransition(branchProbability=3.14)
    assert instance.branchProbability == 3.14
    instance.branchProbability = 9.99
    assert instance.branchProbability == 9.99


def test_pcm_pc_pc_seff_pc_pc_ServiceEffectSpecification_seffTypeID_value_roundtrip():
    instance = pcm_pc_pc_seff_pc_pc_ServiceEffectSpecification(seffTypeID="sample_text")
    assert instance.seffTypeID == "sample_text"
    instance.seffTypeID = "sample_text_2"
    assert instance.seffTypeID == "sample_text_2"


def test_pcm_pc_pc_usagemodel_pc_pc_BranchTransition_branchProbability_value_roundtrip():
    instance = pcm_pc_pc_usagemodel_pc_pc_BranchTransition(branchProbability=3.14)
    assert instance.branchProbability == 3.14
    instance.branchProbability = 9.99
    assert instance.branchProbability == 9.99


def test_pcm_pc_pc_usagemodel_pc_pc_ClosedWorkload_population_value_roundtrip():
    instance = pcm_pc_pc_usagemodel_pc_pc_ClosedWorkload(population=7)
    assert instance.population == 7
    instance.population = 13
    assert instance.population == 13


def test_pcm_pc_pc_usagemodel_pc_pc_EntryLevelSystemCall_priority_value_roundtrip():
    instance = pcm_pc_pc_usagemodel_pc_pc_EntryLevelSystemCall(priority=7)
    assert instance.priority == 7
    instance.priority = 13
    assert instance.priority == 13


def test_pcm_pc_pc_seff_pc_pc_AbstractInternalControlFlowAction_isa_AbstractAction():
    instance = pcm_pc_pc_seff_pc_pc_AbstractInternalControlFlowAction()
    assert isinstance(instance, AbstractAction)


def test_pcm_pc_pc_seff_pc_pc_GuardedBranchTransition_isa_AbstractBranchTransition():
    instance = pcm_pc_pc_seff_pc_pc_GuardedBranchTransition()
    assert isinstance(instance, AbstractBranchTransition)


def test_pcm_pc_pc_seff_pc_pc_ProbabilisticBranchTransition_isa_AbstractBranchTransition():
    instance = pcm_pc_pc_seff_pc_pc_ProbabilisticBranchTransition(branchProbability=3.14)
    assert isinstance(instance, AbstractBranchTransition)


def test_pcm_pc_pc_seff_pc_pc_AbstractLoopAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_pc_pc_seff_pc_pc_AbstractLoopAction()
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_pc_pc_seff_pc_pc_AcquireAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_pc_pc_seff_pc_pc_AcquireAction(timeout=True, timeoutValue=3.14)
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_pc_pc_seff_pc_pc_BranchAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_pc_pc_seff_pc_pc_BranchAction()
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_pc_pc_seff_pc_pc_ForkAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_pc_pc_seff_pc_pc_ForkAction()
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_pc_pc_seff_pc_pc_InternalAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_pc_pc_seff_pc_pc_InternalAction()
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_pc_pc_seff_pc_pc_ReleaseAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_pc_pc_seff_pc_pc_ReleaseAction()
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_pc_pc_seff_pc_pc_SetVariableAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_pc_pc_seff_pc_pc_SetVariableAction()
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_pc_pc_seff_pc_pc_StartAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_pc_pc_seff_pc_pc_StartAction()
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_pc_pc_seff_pc_pc_StopAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_pc_pc_seff_pc_pc_StopAction()
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_pc_pc_seff_reliability_pc_pc_RecoveryAction_isa_AbstractInternalControlFlowAction():
    instance = pcm_pc_pc_seff_reliability_pc_pc_RecoveryAction()
    assert isinstance(instance, AbstractInternalControlFlowAction)


def test_pcm_pc_pc_seff_pc_pc_CollectionIteratorAction_isa_AbstractLoopAction():
    instance = pcm_pc_pc_seff_pc_pc_CollectionIteratorAction()
    assert isinstance(instance, AbstractLoopAction)


def test_pcm_pc_pc_seff_pc_pc_LoopAction_isa_AbstractLoopAction():
    instance = pcm_pc_pc_seff_pc_pc_LoopAction()
    assert isinstance(instance, AbstractLoopAction)


def test_pcm_pc_pc_usagemodel_pc_pc_Branch_isa_AbstractUserAction():
    instance = pcm_pc_pc_usagemodel_pc_pc_Branch()
    assert isinstance(instance, AbstractUserAction)


def test_pcm_pc_pc_usagemodel_pc_pc_Delay_isa_AbstractUserAction():
    instance = pcm_pc_pc_usagemodel_pc_pc_Delay()
    assert isinstance(instance, AbstractUserAction)


def test_pcm_pc_pc_usagemodel_pc_pc_EntryLevelSystemCall_isa_AbstractUserAction():
    instance = pcm_pc_pc_usagemodel_pc_pc_EntryLevelSystemCall(priority=7)
    assert isinstance(instance, AbstractUserAction)


def test_pcm_pc_pc_usagemodel_pc_pc_Loop_isa_AbstractUserAction():
    instance = pcm_pc_pc_usagemodel_pc_pc_Loop()
    assert isinstance(instance, AbstractUserAction)


def test_pcm_pc_pc_usagemodel_pc_pc_Start_isa_AbstractUserAction():
    instance = pcm_pc_pc_usagemodel_pc_pc_Start()
    assert isinstance(instance, AbstractUserAction)


def test_pcm_pc_pc_usagemodel_pc_pc_Stop_isa_AbstractUserAction():
    instance = pcm_pc_pc_usagemodel_pc_pc_Stop()
    assert isinstance(instance, AbstractUserAction)


def test_pcm_pc_pc_seff_pc_pc_CallReturnAction_isa_CallAction():
    instance = pcm_pc_pc_seff_pc_pc_CallReturnAction()
    assert isinstance(instance, CallAction)


def test_pcm_pc_pc_seff_performance_pc_pc_InfrastructureCall_isa_CallAction():
    instance = pcm_pc_pc_seff_performance_pc_pc_InfrastructureCall()
    assert isinstance(instance, CallAction)


def test_pcm_pc_pc_seff_performance_pc_pc_ResourceCall_isa_CallAction():
    instance = pcm_pc_pc_seff_performance_pc_pc_ResourceCall()
    assert isinstance(instance, CallAction)


def test_pcm_pc_pc_composition_pc_pc_AssemblyConnector_isa_Connector():
    instance = pcm_pc_pc_composition_pc_pc_AssemblyConnector()
    assert isinstance(instance, Connector)


def test_pcm_pc_pc_composition_pc_pc_AssemblyEventConnector_isa_Connector():
    instance = pcm_pc_pc_composition_pc_pc_AssemblyEventConnector()
    assert isinstance(instance, Connector)


def test_pcm_pc_pc_composition_pc_pc_AssemblyInfrastructureConnector_isa_Connector():
    instance = pcm_pc_pc_composition_pc_pc_AssemblyInfrastructureConnector()
    assert isinstance(instance, Connector)


def test_pcm_pc_pc_composition_pc_pc_DelegationConnector_isa_Connector():
    instance = pcm_pc_pc_composition_pc_pc_DelegationConnector()
    assert isinstance(instance, Connector)


def test_pcm_pc_pc_composition_pc_pc_EventChannelSinkConnector_isa_Connector():
    instance = pcm_pc_pc_composition_pc_pc_EventChannelSinkConnector()
    assert isinstance(instance, Connector)


def test_pcm_pc_pc_composition_pc_pc_EventChannelSourceConnector_isa_Connector():
    instance = pcm_pc_pc_composition_pc_pc_EventChannelSourceConnector()
    assert isinstance(instance, Connector)


def test_pcm_pc_pc_repository_pc_pc_PrimitiveDataType_isa_DataType():
    instance = pcm_pc_pc_repository_pc_pc_PrimitiveDataType(type="sample_text")
    assert isinstance(instance, DataType)


def test_pcm_pc_pc_composition_pc_pc_ProvidedDelegationConnector_isa_DelegationConnector():
    instance = pcm_pc_pc_composition_pc_pc_ProvidedDelegationConnector()
    assert isinstance(instance, DelegationConnector)


def test_pcm_pc_pc_composition_pc_pc_ProvidedInfrastructureDelegationConnector_isa_DelegationConnector():
    instance = pcm_pc_pc_composition_pc_pc_ProvidedInfrastructureDelegationConnector()
    assert isinstance(instance, DelegationConnector)


def test_pcm_pc_pc_composition_pc_pc_RequiredDelegationConnector_isa_DelegationConnector():
    instance = pcm_pc_pc_composition_pc_pc_RequiredDelegationConnector()
    assert isinstance(instance, DelegationConnector)


def test_pcm_pc_pc_composition_pc_pc_RequiredInfrastructureDelegationConnector_isa_DelegationConnector():
    instance = pcm_pc_pc_composition_pc_pc_RequiredInfrastructureDelegationConnector()
    assert isinstance(instance, DelegationConnector)


def test_pcm_pc_pc_composition_pc_pc_RequiredResourceDelegationConnector_isa_DelegationConnector():
    instance = pcm_pc_pc_composition_pc_pc_RequiredResourceDelegationConnector()
    assert isinstance(instance, DelegationConnector)


def test_pcm_pc_pc_composition_pc_pc_SinkDelegationConnector_isa_DelegationConnector():
    instance = pcm_pc_pc_composition_pc_pc_SinkDelegationConnector()
    assert isinstance(instance, DelegationConnector)


def test_pcm_pc_pc_composition_pc_pc_SourceDelegationConnector_isa_DelegationConnector():
    instance = pcm_pc_pc_composition_pc_pc_SourceDelegationConnector()
    assert isinstance(instance, DelegationConnector)


def test_pcm_pc_pc_allocation_pc_pc_Allocation_isa_Entity():
    instance = pcm_pc_pc_allocation_pc_pc_Allocation()
    assert isinstance(instance, Entity)


def test_pcm_pc_pc_allocation_pc_pc_AllocationContext_isa_Entity():
    instance = pcm_pc_pc_allocation_pc_pc_AllocationContext()
    assert isinstance(instance, Entity)


def test_pcm_pc_pc_composition_pc_pc_AssemblyContext_isa_Entity():
    instance = pcm_pc_pc_composition_pc_pc_AssemblyContext()
    assert isinstance(instance, Entity)


def test_pcm_pc_pc_composition_pc_pc_ComposedStructure_isa_Entity():
    instance = pcm_pc_pc_composition_pc_pc_ComposedStructure()
    assert isinstance(instance, Entity)


def test_pcm_pc_pc_composition_pc_pc_Connector_isa_Entity():
    instance = pcm_pc_pc_composition_pc_pc_Connector()
    assert isinstance(instance, Entity)


def test_pcm_pc_pc_composition_pc_pc_EventChannel_isa_Entity():
    instance = pcm_pc_pc_composition_pc_pc_EventChannel()
    assert isinstance(instance, Entity)


def test_pcm_pc_pc_entity_pc_pc_InterfaceProvidingEntity_isa_Entity():
    instance = pcm_pc_pc_entity_pc_pc_InterfaceProvidingEntity()
    assert isinstance(instance, Entity)


def test_pcm_pc_pc_entity_pc_pc_ResourceInterfaceProvidingEntity_isa_Entity():
    instance = pcm_pc_pc_entity_pc_pc_ResourceInterfaceProvidingEntity()
    assert isinstance(instance, Entity)


def test_pcm_pc_pc_entity_pc_pc_ResourceInterfaceRequiringEntity_isa_Entity():
    instance = pcm_pc_pc_entity_pc_pc_ResourceInterfaceRequiringEntity()
    assert isinstance(instance, Entity)


def test_pcm_pc_pc_qosannotations_pc_pc_QoSAnnotations_isa_Entity():
    instance = pcm_pc_pc_qosannotations_pc_pc_QoSAnnotations()
    assert isinstance(instance, Entity)


def test_pcm_pc_pc_reliability_pc_pc_FailureType_isa_Entity():
    instance = pcm_pc_pc_reliability_pc_pc_FailureType()
    assert isinstance(instance, Entity)


def test_pcm_pc_pc_repository_pc_pc_Interface_isa_Entity():
    instance = pcm_pc_pc_repository_pc_pc_Interface()
    assert isinstance(instance, Entity)


def test_pcm_pc_pc_repository_pc_pc_PassiveResource_isa_Entity():
    instance = pcm_pc_pc_repository_pc_pc_PassiveResource()
    assert isinstance(instance, Entity)


def test_pcm_pc_pc_repository_pc_pc_Repository_isa_Entity():
    instance = pcm_pc_pc_repository_pc_pc_Repository(repositoryDescription="sample_text")
    assert isinstance(instance, Entity)


def test_pcm_pc_pc_repository_pc_pc_Role_isa_Entity():
    instance = pcm_pc_pc_repository_pc_pc_Role()
    assert isinstance(instance, Entity)


def test_pcm_pc_pc_repository_pc_pc_Signature_isa_Entity():
    instance = pcm_pc_pc_repository_pc_pc_Signature()
    assert isinstance(instance, Entity)


def test_pcm_pc_pc_resourceenvironment_pc_pc_LinkingResource_isa_Entity():
    instance = pcm_pc_pc_resourceenvironment_pc_pc_LinkingResource()
    assert isinstance(instance, Entity)


def test_pcm_pc_pc_resourceenvironment_pc_pc_ResourceContainer_isa_Entity():
    instance = pcm_pc_pc_resourceenvironment_pc_pc_ResourceContainer()
    assert isinstance(instance, Entity)


def test_pcm_pc_pc_resourcetype_pc_pc_ResourceInterface_isa_Entity():
    instance = pcm_pc_pc_resourcetype_pc_pc_ResourceInterface()
    assert isinstance(instance, Entity)


def test_pcm_pc_pc_resourcetype_pc_pc_ResourceSignature_isa_Entity():
    instance = pcm_pc_pc_resourcetype_pc_pc_ResourceSignature(resourceServiceId=7)
    assert isinstance(instance, Entity)


def test_pcm_pc_pc_resourcetype_pc_pc_SchedulingPolicy_isa_Entity():
    instance = pcm_pc_pc_resourcetype_pc_pc_SchedulingPolicy()
    assert isinstance(instance, Entity)


def test_pcm_pc_pc_seff_pc_pc_AbstractAction_isa_Entity():
    instance = pcm_pc_pc_seff_pc_pc_AbstractAction()
    assert isinstance(instance, Entity)


def test_pcm_pc_pc_seff_pc_pc_AbstractBranchTransition_isa_Entity():
    instance = pcm_pc_pc_seff_pc_pc_AbstractBranchTransition()
    assert isinstance(instance, Entity)


def test_pcm_pc_pc_seff_reliability_pc_pc_FailureHandlingEntity_isa_Entity():
    instance = pcm_pc_pc_seff_reliability_pc_pc_FailureHandlingEntity()
    assert isinstance(instance, Entity)


def test_pcm_pc_pc_usagemodel_pc_pc_AbstractUserAction_isa_Entity():
    instance = pcm_pc_pc_usagemodel_pc_pc_AbstractUserAction()
    assert isinstance(instance, Entity)


def test_pcm_pc_pc_usagemodel_pc_pc_ScenarioBehaviour_isa_Entity():
    instance = pcm_pc_pc_usagemodel_pc_pc_ScenarioBehaviour()
    assert isinstance(instance, Entity)


def test_pcm_pc_pc_usagemodel_pc_pc_UsageScenario_isa_Entity():
    instance = pcm_pc_pc_usagemodel_pc_pc_UsageScenario()
    assert isinstance(instance, Entity)


def test_pcm_pc_pc_completions_pc_pc_DelegatingExternalCallAction_isa_ExternalCallAction():
    instance = pcm_pc_pc_completions_pc_pc_DelegatingExternalCallAction()
    assert isinstance(instance, ExternalCallAction)


def test_pcm_pc_pc_reliability_pc_pc_ExternalFailureOccurrenceDescription_isa_FailureOccurrenceDescription():
    instance = pcm_pc_pc_reliability_pc_pc_ExternalFailureOccurrenceDescription()
    assert isinstance(instance, FailureOccurrenceDescription)


def test_pcm_pc_pc_reliability_pc_pc_InternalFailureOccurrenceDescription_isa_FailureOccurrenceDescription():
    instance = pcm_pc_pc_reliability_pc_pc_InternalFailureOccurrenceDescription()
    assert isinstance(instance, FailureOccurrenceDescription)


def test_pcm_pc_pc_reliability_pc_pc_HardwareInducedFailureType_isa_FailureType():
    instance = pcm_pc_pc_reliability_pc_pc_HardwareInducedFailureType()
    assert isinstance(instance, FailureType)


def test_pcm_pc_pc_reliability_pc_pc_NetworkInducedFailureType_isa_FailureType():
    instance = pcm_pc_pc_reliability_pc_pc_NetworkInducedFailureType()
    assert isinstance(instance, FailureType)


def test_pcm_pc_pc_reliability_pc_pc_SoftwareInducedFailureType_isa_FailureType():
    instance = pcm_pc_pc_reliability_pc_pc_SoftwareInducedFailureType()
    assert isinstance(instance, FailureType)


def test_pcm_pc_pc_entity_pc_pc_Entity_isa_Identifier():
    instance = pcm_pc_pc_entity_pc_pc_Entity()
    assert isinstance(instance, Identifier)


def test_pcm_pc_pc_resourceenvironment_pc_pc_CommunicationLinkResourceSpecification_isa_Identifier():
    instance = pcm_pc_pc_resourceenvironment_pc_pc_CommunicationLinkResourceSpecification(failureProbability=3.14)
    assert isinstance(instance, Identifier)


def test_pcm_pc_pc_resourceenvironment_pc_pc_ProcessingResourceSpecification_isa_Identifier():
    instance = pcm_pc_pc_resourceenvironment_pc_pc_ProcessingResourceSpecification(MTTF=3.14, MTTR=3.14, numberOfReplicas=7, requiredByContainer=True)
    assert isinstance(instance, Identifier)


def test_pcm_pc_pc_seff_pc_pc_ResourceDemandingBehaviour_isa_Identifier():
    instance = pcm_pc_pc_seff_pc_pc_ResourceDemandingBehaviour()
    assert isinstance(instance, Identifier)


def test_pcm_pc_pc_seff_pc_pc_ResourceDemandingSEFF_isa_Identifier():
    instance = pcm_pc_pc_seff_pc_pc_ResourceDemandingSEFF()
    assert isinstance(instance, Identifier)


def test_pcm_pc_pc_repository_pc_pc_BasicComponent_isa_ImplementationComponentType():
    instance = pcm_pc_pc_repository_pc_pc_BasicComponent()
    assert isinstance(instance, ImplementationComponentType)


def test_pcm_pc_pc_repository_pc_pc_EventGroup_isa_Interface():
    instance = pcm_pc_pc_repository_pc_pc_EventGroup()
    assert isinstance(instance, Interface)


def test_pcm_pc_pc_repository_pc_pc_InfrastructureInterface_isa_Interface():
    instance = pcm_pc_pc_repository_pc_pc_InfrastructureInterface()
    assert isinstance(instance, Interface)


def test_pcm_pc_pc_repository_pc_pc_OperationInterface_isa_Interface():
    instance = pcm_pc_pc_repository_pc_pc_OperationInterface()
    assert isinstance(instance, Interface)


def test_pcm_pc_pc_repository_pc_pc_RepositoryComponent_isa_InterfaceProvidingRequiringEntity():
    instance = pcm_pc_pc_repository_pc_pc_RepositoryComponent()
    assert isinstance(instance, InterfaceProvidingRequiringEntity)


def test_pcm_pc_pc_repository_pc_pc_InnerDeclaration_isa_NamedElement():
    instance = pcm_pc_pc_repository_pc_pc_InnerDeclaration()
    assert isinstance(instance, NamedElement)


def test_pcm_pc_pc_resourceenvironment_pc_pc_ResourceEnvironment_isa_NamedElement():
    instance = pcm_pc_pc_resourceenvironment_pc_pc_ResourceEnvironment()
    assert isinstance(instance, NamedElement)


def test_pcm_pc_pc_completions_pc_pc_NetworkDemandParametricResourceDemand_isa_ParametricResourceDemand():
    instance = pcm_pc_pc_completions_pc_pc_NetworkDemandParametricResourceDemand()
    assert isinstance(instance, ParametricResourceDemand)


def test_pcm_pc_pc_repository_pc_pc_InfrastructureProvidedRole_isa_ProvidedRole():
    instance = pcm_pc_pc_repository_pc_pc_InfrastructureProvidedRole()
    assert isinstance(instance, ProvidedRole)


def test_pcm_pc_pc_repository_pc_pc_OperationProvidedRole_isa_ProvidedRole():
    instance = pcm_pc_pc_repository_pc_pc_OperationProvidedRole()
    assert isinstance(instance, ProvidedRole)


def test_pcm_pc_pc_repository_pc_pc_SinkRole_isa_ProvidedRole():
    instance = pcm_pc_pc_repository_pc_pc_SinkRole()
    assert isinstance(instance, ProvidedRole)


def test_pcm_pc_pc_core_pc_pc_PCMRandomVariable_isa_RandomVariable():
    instance = pcm_pc_pc_core_pc_pc_PCMRandomVariable()
    assert isinstance(instance, RandomVariable)


def test_pcm_pc_pc_repository_pc_pc_CompleteComponentType_isa_RepositoryComponent():
    instance = pcm_pc_pc_repository_pc_pc_CompleteComponentType()
    assert isinstance(instance, RepositoryComponent)


def test_pcm_pc_pc_repository_pc_pc_ImplementationComponentType_isa_RepositoryComponent():
    instance = pcm_pc_pc_repository_pc_pc_ImplementationComponentType(componentType="sample_text")
    assert isinstance(instance, RepositoryComponent)


def test_pcm_pc_pc_repository_pc_pc_ProvidesComponentType_isa_RepositoryComponent():
    instance = pcm_pc_pc_repository_pc_pc_ProvidesComponentType()
    assert isinstance(instance, RepositoryComponent)


def test_pcm_pc_pc_repository_pc_pc_InfrastructureRequiredRole_isa_RequiredRole():
    instance = pcm_pc_pc_repository_pc_pc_InfrastructureRequiredRole()
    assert isinstance(instance, RequiredRole)


def test_pcm_pc_pc_repository_pc_pc_OperationRequiredRole_isa_RequiredRole():
    instance = pcm_pc_pc_repository_pc_pc_OperationRequiredRole()
    assert isinstance(instance, RequiredRole)


def test_pcm_pc_pc_repository_pc_pc_SourceRole_isa_RequiredRole():
    instance = pcm_pc_pc_repository_pc_pc_SourceRole()
    assert isinstance(instance, RequiredRole)


def test_pcm_pc_pc_seff_pc_pc_ForkedBehaviour_isa_ResourceDemandingBehaviour():
    instance = pcm_pc_pc_seff_pc_pc_ForkedBehaviour()
    assert isinstance(instance, ResourceDemandingBehaviour)


def test_pcm_pc_pc_seff_pc_pc_ResourceDemandingInternalBehaviour_isa_ResourceDemandingBehaviour():
    instance = pcm_pc_pc_seff_pc_pc_ResourceDemandingInternalBehaviour()
    assert isinstance(instance, ResourceDemandingBehaviour)


def test_pcm_pc_pc_resourcetype_pc_pc_CommunicationLinkResourceType_isa_ResourceType():
    instance = pcm_pc_pc_resourcetype_pc_pc_CommunicationLinkResourceType()
    assert isinstance(instance, ResourceType)


def test_pcm_pc_pc_resourcetype_pc_pc_ProcessingResourceType_isa_ResourceType():
    instance = pcm_pc_pc_resourcetype_pc_pc_ProcessingResourceType()
    assert isinstance(instance, ResourceType)


def test_pcm_pc_pc_entity_pc_pc_ResourceProvidedRole_isa_Role():
    instance = pcm_pc_pc_entity_pc_pc_ResourceProvidedRole()
    assert isinstance(instance, Role)


def test_pcm_pc_pc_entity_pc_pc_ResourceRequiredRole_isa_Role():
    instance = pcm_pc_pc_entity_pc_pc_ResourceRequiredRole()
    assert isinstance(instance, Role)


def test_pcm_pc_pc_repository_pc_pc_ProvidedRole_isa_Role():
    instance = pcm_pc_pc_repository_pc_pc_ProvidedRole()
    assert isinstance(instance, Role)


def test_pcm_pc_pc_repository_pc_pc_RequiredRole_isa_Role():
    instance = pcm_pc_pc_repository_pc_pc_RequiredRole()
    assert isinstance(instance, Role)


def test_pcm_pc_pc_repository_pc_pc_EventType_isa_Signature():
    instance = pcm_pc_pc_repository_pc_pc_EventType()
    assert isinstance(instance, Signature)


def test_pcm_pc_pc_repository_pc_pc_InfrastructureSignature_isa_Signature():
    instance = pcm_pc_pc_repository_pc_pc_InfrastructureSignature()
    assert isinstance(instance, Signature)


def test_pcm_pc_pc_repository_pc_pc_OperationSignature_isa_Signature():
    instance = pcm_pc_pc_repository_pc_pc_OperationSignature()
    assert isinstance(instance, Signature)


def test_pcm_pc_pc_reliability_pc_pc_ResourceTimeoutFailureType_isa_SoftwareInducedFailureType():
    instance = pcm_pc_pc_reliability_pc_pc_ResourceTimeoutFailureType()
    assert isinstance(instance, SoftwareInducedFailureType)


def test_pcm_pc_pc_qos_performance_pc_pc_ComponentSpecifiedExecutionTime_isa_SpecifiedExecutionTime():
    instance = pcm_pc_pc_qos_performance_pc_pc_ComponentSpecifiedExecutionTime()
    assert isinstance(instance, SpecifiedExecutionTime)


def test_pcm_pc_pc_qos_performance_pc_pc_SystemSpecifiedExecutionTime_isa_SpecifiedExecutionTime():
    instance = pcm_pc_pc_qos_performance_pc_pc_SystemSpecifiedExecutionTime()
    assert isinstance(instance, SpecifiedExecutionTime)


def test_pcm_pc_pc_qos_performance_pc_pc_SpecifiedExecutionTime_isa_SpecifiedQoSAnnotation():
    instance = pcm_pc_pc_qos_performance_pc_pc_SpecifiedExecutionTime()
    assert isinstance(instance, SpecifiedQoSAnnotation)


def test_pcm_pc_pc_qos_reliability_pc_pc_SpecifiedReliabilityAnnotation_isa_SpecifiedQoSAnnotation():
    instance = pcm_pc_pc_qos_reliability_pc_pc_SpecifiedReliabilityAnnotation()
    assert isinstance(instance, SpecifiedQoSAnnotation)


def test_pcm_pc_pc_resourcetype_pc_pc_ResourceType_isa_UnitCarryingElement():
    instance = pcm_pc_pc_resourcetype_pc_pc_ResourceType()
    assert isinstance(instance, UnitCarryingElement)


def test_pcm_pc_pc_parameter_pc_pc_CharacterisedVariable_isa_Variable():
    instance = pcm_pc_pc_parameter_pc_pc_CharacterisedVariable(characterisationType="sample_text")
    assert isinstance(instance, Variable)


def test_pcm_pc_pc_usagemodel_pc_pc_ClosedWorkload_isa_Workload():
    instance = pcm_pc_pc_usagemodel_pc_pc_ClosedWorkload(population=7)
    assert isinstance(instance, Workload)


def test_pcm_pc_pc_usagemodel_pc_pc_OpenWorkload_isa_Workload():
    instance = pcm_pc_pc_usagemodel_pc_pc_OpenWorkload()
    assert isinstance(instance, Workload)


def test_pcm_pc_pc_entity_pc_pc_ComposedProvidingRequiringEntity_isa_composition_pc_pc_ComposedStructure():
    instance = pcm_pc_pc_entity_pc_pc_ComposedProvidingRequiringEntity()
    assert isinstance(instance, composition_pc_pc_ComposedStructure)


def test_pcm_pc_pc_completions_pc_pc_Completion_isa_entity_pc_pc_ComposedProvidingRequiringEntity():
    instance = pcm_pc_pc_completions_pc_pc_Completion()
    assert isinstance(instance, entity_pc_pc_ComposedProvidingRequiringEntity)


def test_pcm_pc_pc_repository_pc_pc_CompositeComponent_isa_entity_pc_pc_ComposedProvidingRequiringEntity():
    instance = pcm_pc_pc_repository_pc_pc_CompositeComponent()
    assert isinstance(instance, entity_pc_pc_ComposedProvidingRequiringEntity)


def test_pcm_pc_pc_subsystem_pc_pc_SubSystem_isa_entity_pc_pc_ComposedProvidingRequiringEntity():
    instance = pcm_pc_pc_subsystem_pc_pc_SubSystem()
    assert isinstance(instance, entity_pc_pc_ComposedProvidingRequiringEntity)


def test_pcm_pc_pc_system_pc_pc_System_isa_entity_pc_pc_ComposedProvidingRequiringEntity():
    instance = pcm_pc_pc_system_pc_pc_System()
    assert isinstance(instance, entity_pc_pc_ComposedProvidingRequiringEntity)


def test_pcm_pc_pc_entity_pc_pc_InterfaceRequiringEntity_isa_entity_pc_pc_Entity():
    instance = pcm_pc_pc_entity_pc_pc_InterfaceRequiringEntity()
    assert isinstance(instance, entity_pc_pc_Entity)


def test_pcm_pc_pc_repository_pc_pc_CollectionDataType_isa_entity_pc_pc_Entity():
    instance = pcm_pc_pc_repository_pc_pc_CollectionDataType()
    assert isinstance(instance, entity_pc_pc_Entity)


def test_pcm_pc_pc_repository_pc_pc_CompositeDataType_isa_entity_pc_pc_Entity():
    instance = pcm_pc_pc_repository_pc_pc_CompositeDataType()
    assert isinstance(instance, entity_pc_pc_Entity)


def test_pcm_pc_pc_resourcetype_pc_pc_ResourceType_isa_entity_pc_pc_Entity():
    instance = pcm_pc_pc_resourcetype_pc_pc_ResourceType()
    assert isinstance(instance, entity_pc_pc_Entity)


def test_pcm_pc_pc_system_pc_pc_System_isa_entity_pc_pc_Entity():
    instance = pcm_pc_pc_system_pc_pc_System()
    assert isinstance(instance, entity_pc_pc_Entity)


def test_pcm_pc_pc_entity_pc_pc_InterfaceProvidingRequiringEntity_isa_entity_pc_pc_InterfaceProvidingEntity():
    instance = pcm_pc_pc_entity_pc_pc_InterfaceProvidingRequiringEntity()
    assert isinstance(instance, entity_pc_pc_InterfaceProvidingEntity)


def test_pcm_pc_pc_entity_pc_pc_ComposedProvidingRequiringEntity_isa_entity_pc_pc_InterfaceProvidingRequiringEntity():
    instance = pcm_pc_pc_entity_pc_pc_ComposedProvidingRequiringEntity()
    assert isinstance(instance, entity_pc_pc_InterfaceProvidingRequiringEntity)


def test_pcm_pc_pc_entity_pc_pc_InterfaceProvidingRequiringEntity_isa_entity_pc_pc_InterfaceRequiringEntity():
    instance = pcm_pc_pc_entity_pc_pc_InterfaceProvidingRequiringEntity()
    assert isinstance(instance, entity_pc_pc_InterfaceRequiringEntity)


def test_pcm_pc_pc_entity_pc_pc_Entity_isa_entity_pc_pc_NamedElement():
    instance = pcm_pc_pc_entity_pc_pc_Entity()
    assert isinstance(instance, entity_pc_pc_NamedElement)


def test_pcm_pc_pc_entity_pc_pc_ResourceInterfaceProvidingRequiringEntity_isa_entity_pc_pc_ResourceInterfaceProvidingEntity():
    instance = pcm_pc_pc_entity_pc_pc_ResourceInterfaceProvidingRequiringEntity()
    assert isinstance(instance, entity_pc_pc_ResourceInterfaceProvidingEntity)


def test_pcm_pc_pc_resourcetype_pc_pc_ResourceType_isa_entity_pc_pc_ResourceInterfaceProvidingEntity():
    instance = pcm_pc_pc_resourcetype_pc_pc_ResourceType()
    assert isinstance(instance, entity_pc_pc_ResourceInterfaceProvidingEntity)


def test_pcm_pc_pc_entity_pc_pc_InterfaceRequiringEntity_isa_entity_pc_pc_ResourceInterfaceRequiringEntity():
    instance = pcm_pc_pc_entity_pc_pc_InterfaceRequiringEntity()
    assert isinstance(instance, entity_pc_pc_ResourceInterfaceRequiringEntity)


def test_pcm_pc_pc_entity_pc_pc_ResourceInterfaceProvidingRequiringEntity_isa_entity_pc_pc_ResourceInterfaceRequiringEntity():
    instance = pcm_pc_pc_entity_pc_pc_ResourceInterfaceProvidingRequiringEntity()
    assert isinstance(instance, entity_pc_pc_ResourceInterfaceRequiringEntity)


def test_pcm_pc_pc_repository_pc_pc_CollectionDataType_isa_repository_pc_pc_DataType():
    instance = pcm_pc_pc_repository_pc_pc_CollectionDataType()
    assert isinstance(instance, repository_pc_pc_DataType)


def test_pcm_pc_pc_repository_pc_pc_CompositeDataType_isa_repository_pc_pc_DataType():
    instance = pcm_pc_pc_repository_pc_pc_CompositeDataType()
    assert isinstance(instance, repository_pc_pc_DataType)


def test_pcm_pc_pc_completions_pc_pc_Completion_isa_repository_pc_pc_ImplementationComponentType():
    instance = pcm_pc_pc_completions_pc_pc_Completion()
    assert isinstance(instance, repository_pc_pc_ImplementationComponentType)


def test_pcm_pc_pc_repository_pc_pc_CompositeComponent_isa_repository_pc_pc_ImplementationComponentType():
    instance = pcm_pc_pc_repository_pc_pc_CompositeComponent()
    assert isinstance(instance, repository_pc_pc_ImplementationComponentType)


def test_pcm_pc_pc_subsystem_pc_pc_SubSystem_isa_repository_pc_pc_RepositoryComponent():
    instance = pcm_pc_pc_subsystem_pc_pc_SubSystem()
    assert isinstance(instance, repository_pc_pc_RepositoryComponent)


def test_pcm_pc_pc_seff_pc_pc_EmitEventAction_isa_seff_pc_pc_AbstractAction():
    instance = pcm_pc_pc_seff_pc_pc_EmitEventAction()
    assert isinstance(instance, seff_pc_pc_AbstractAction)


def test_pcm_pc_pc_seff_pc_pc_ExternalCallAction_isa_seff_pc_pc_AbstractAction():
    instance = pcm_pc_pc_seff_pc_pc_ExternalCallAction(retryCount=7)
    assert isinstance(instance, seff_pc_pc_AbstractAction)


def test_pcm_pc_pc_seff_pc_pc_InternalCallAction_isa_seff_pc_pc_AbstractInternalControlFlowAction():
    instance = pcm_pc_pc_seff_pc_pc_InternalCallAction()
    assert isinstance(instance, seff_pc_pc_AbstractInternalControlFlowAction)


def test_pcm_pc_pc_seff_pc_pc_EmitEventAction_isa_seff_pc_pc_CallAction():
    instance = pcm_pc_pc_seff_pc_pc_EmitEventAction()
    assert isinstance(instance, seff_pc_pc_CallAction)


def test_pcm_pc_pc_seff_pc_pc_InternalCallAction_isa_seff_pc_pc_CallAction():
    instance = pcm_pc_pc_seff_pc_pc_InternalCallAction()
    assert isinstance(instance, seff_pc_pc_CallAction)


def test_pcm_pc_pc_seff_pc_pc_ExternalCallAction_isa_seff_pc_pc_CallReturnAction():
    instance = pcm_pc_pc_seff_pc_pc_ExternalCallAction(retryCount=7)
    assert isinstance(instance, seff_pc_pc_CallReturnAction)


def test_pcm_pc_pc_seff_pc_pc_ResourceDemandingSEFF_isa_seff_pc_pc_ResourceDemandingBehaviour():
    instance = pcm_pc_pc_seff_pc_pc_ResourceDemandingSEFF()
    assert isinstance(instance, seff_pc_pc_ResourceDemandingBehaviour)


def test_pcm_pc_pc_seff_reliability_pc_pc_RecoveryActionBehaviour_isa_seff_pc_pc_ResourceDemandingBehaviour():
    instance = pcm_pc_pc_seff_reliability_pc_pc_RecoveryActionBehaviour()
    assert isinstance(instance, seff_pc_pc_ResourceDemandingBehaviour)


def test_pcm_pc_pc_seff_pc_pc_ResourceDemandingSEFF_isa_seff_pc_pc_ServiceEffectSpecification():
    instance = pcm_pc_pc_seff_pc_pc_ResourceDemandingSEFF()
    assert isinstance(instance, seff_pc_pc_ServiceEffectSpecification)


def test_pcm_pc_pc_seff_pc_pc_ExternalCallAction_isa_seff_reliability_pc_pc_FailureHandlingEntity():
    instance = pcm_pc_pc_seff_pc_pc_ExternalCallAction(retryCount=7)
    assert isinstance(instance, seff_reliability_pc_pc_FailureHandlingEntity)


def test_pcm_pc_pc_seff_reliability_pc_pc_RecoveryActionBehaviour_isa_seff_reliability_pc_pc_FailureHandlingEntity():
    instance = pcm_pc_pc_seff_reliability_pc_pc_RecoveryActionBehaviour()
    assert isinstance(instance, seff_reliability_pc_pc_FailureHandlingEntity)


def test_assoc_abstractBranchTransition_ResourceDemandingBehaviour339_link_reassign_clear():
    a = pcm_pc_pc_seff_pc_pc_ResourceDemandingBehaviour()
...
def test_assoc_abstractLoopAction_ResourceDemandingBehaviour337_link_reassign_clear():
    a = pcm_pc_pc_seff_pc_pc_ResourceDemandingBehaviour()
    b1 = AbstractLoopAction()
    b2 = AbstractLoopAction()
    _safe_set(a, 'bodyBehaviour_Loop338', b1)
    assert _is_linked(a, 'bodyBehaviour_Loop338', b1)
    if hasattr(b1, 'AbstractLoopAction'):
        assert _is_linked(b1, 'AbstractLoopAction', a)
    _safe_set(a, 'bodyBehaviour_Loop338', b2)
    assert _is_linked(a, 'bodyBehaviour_Loop338', b2)
    if hasattr(b1, 'AbstractLoopAction'):
        assert not _is_linked(b1, 'AbstractLoopAction', a)
    if hasattr(b2, 'AbstractLoopAction'):
        assert _is_linked(b2, 'AbstractLoopAction', a)
    _safe_set(a, 'bodyBehaviour_Loop338', None)
    assert not _is_linked(a, 'bodyBehaviour_Loop338', b2)
    if hasattr(b2, 'AbstractLoopAction'):
        assert not _is_linked(b2, 'AbstractLoopAction', a)


def test_assoc_action_ParametricResourceDemand417_link_reassign_clear():
    a = pcm_pc_pc_seff_performance_pc_pc_ParametricResourceDemand()
    ...
    if hasattr(b1, 'AbstractInternalControlFlowAction418'):
        assert _is_linked(b1, 'AbstractInternalControlFlowAction418', a)
    _safe_set(a, 'resourceDemand_Action', b2)
    assert _is_linked(a, 'resourceDemand_Action', b2)
    if hasattr(b1, 'AbstractInternalControlFlowAction418'):
        assert not _is_linked(b1, 'AbstractInternalControlFlowAction418', a)
    if hasattr(b2, 'AbstractInternalControlFlowAction418'):
        assert _is_linked(b2, 'AbstractInternalControlFlowAction418', a)
    _safe_set(a, 'resourceDemand_Action', None)
    assert not _is_linked(a, 'resourceDemand_Action', b2)
    if hasattr(b2, 'AbstractInternalControlFlowAction418'):
        assert not _is_linked(b2, 'AbstractInternalControlFlowAction418', a)


def test_assoc_action__InfrastructureCall400_link_reassign_clear():
    a = pcm_pc_pc_seff_performance_pc_pc_InfrastructureCall()
    b1 = AbstractInternalControlFlowAction()
    b2 = AbstractInternalControlFlowAction()
...
def test_assoc_action__ResourceCall404_link_reassign_clear():
    a = pcm_pc_pc_seff_performance_pc_pc_ResourceCall()
    b1 = AbstractInternalControlFlowAction()
    b2 = AbstractInternalControlFlowAction()
    _safe_set(a, 'resourceCall__Action', b1)
    assert _is_linked(a, 'resourceCall__Action', b1)
    if hasattr(b1, 'AbstractInternalControlFlowAction405'):
        assert _is_linked(b1, 'AbstractInternalControlFlowAction405', a)
    _safe_set(a, 'resourceCall__Action', b2)
    assert _is_linked(a, 'resourceCall__Action', b2)
    if hasattr(b1, 'AbstractInternalControlFlowAction405'):
        assert not _is_linked(b1, 'AbstractInternalControlFlowAction405', a)
    if hasattr(b2, 'AbstractInternalControlFlowAction405'):
        assert _is_linked(b2, 'AbstractInternalControlFlowAction405', a)
    _safe_set(a, 'resourceCall__Action', None)
    assert not _is_linked(a, 'resourceCall__Action', b2)
    if hasattr(b2, 'AbstractInternalControlFlowAction405'):
        assert not _is_linked(b2, 'AbstractInternalControlFlowAction405', a)


def test_assoc_actions_ScenarioBehaviour181_link_reassign_clear():
    a = pcm_pc_pc_usagemodel_pc_pc_ScenarioBehaviour()
    ...
    if hasattr(b1, 'AbstractUserAction182'):
        assert _is_linked(b1, 'AbstractUserAction182', a)
    _safe_set(a, 'scenarioBehaviour_AbstractUserAction', {b2})
    assert _is_linked(a, 'scenarioBehaviour_AbstractUserAction', b2)
    if hasattr(b1, 'AbstractUserAction182'):
        assert not _is_linked(b1, 'AbstractUserAction182', a)
    if hasattr(b2, 'AbstractUserAction182'):
        assert _is_linked(b2, 'AbstractUserAction182', a)
    _safe_set(a, 'scenarioBehaviour_AbstractUserAction', set())
    assert not _is_linked(a, 'scenarioBehaviour_AbstractUserAction', b2)
    if hasattr(b2, 'AbstractUserAction182'):
        assert not _is_linked(b2, 'AbstractUserAction182', a)


def test_assoc_activeResourceType_ActiveResourceSpecification468_link_reassign_clear():
    a = pcm_pc_pc_resourceenvironment_pc_pc_ProcessingResourceSpecification(MTTF=3.14, MTTR=3.14, numberOfReplicas=7, requiredByContainer=True)
    b1 = ProcessingResourceType()
    b2 = ProcessingResourceType()
    _safe_set(a, 'pcm_pc_pc_resourceenvironment_pc_pc_ProcessingResourceSpecification469', b1)
    assert _is_linked(a, 'pcm_pc_pc_resourceenvironment_pc_pc_ProcessingResourceSpecification469', b1)
    if hasattr(b1, 'ProcessingResourceType470'):
        assert _is_linked(b1, 'ProcessingResourceType470', a)
    _safe_set(a, 'pcm_pc_pc_resourceenvironment_pc_pc_ProcessingResourceSpecification469', b2)
    assert _is_linked(a, 'pcm_pc_pc_resourceenvironment_pc_pc_ProcessingResourceSpecification469', b2)
    if hasattr(b1, 'ProcessingResourceType470'):
        assert not _is_linked(b1, 'ProcessingResourceType470', a)
    if hasattr(b2, 'ProcessingResourceType470'):
        assert _is_linked(b2, 'ProcessingResourceType470', a)
    _safe_set(a, 'pcm_pc_pc_resourceenvironment_pc_pc_ProcessingResourceSpecification469', None)
    assert not _is_linked(a, 'pcm_pc_pc_resourceenvironment_pc_pc_ProcessingResourceSpecification469', b2)
    if hasattr(b2, 'ProcessingResourceType470'):
        assert not _is_linked(b2, 'ProcessingResourceType470', a)


def test_assoc_allocationContexts_Allocation496_link_reassign_clear():
    a = pcm_pc_pc_allocation_pc_pc_Allocation()
...
def test_assoc_allocation_AllocationContext488_link_reassign_clear():
    a = pcm_pc_pc_allocation_pc_pc_AllocationContext()
    b1 = Allocation()
    b2 = Allocation()
...
def test_assoc_assemblyContext_AllocationContext485_link_reassign_clear():
    a = pcm_pc_pc_allocation_pc_pc_AllocationContext()
    b1 = composition_pc_pc_AssemblyContext()
    b2 = composition_pc_pc_AssemblyContext()
    _safe_set(a, 'pcm_pc_pc_allocation_pc_pc_AllocationContext486', b1)
    assert _is_linked(a, 'pcm_pc_pc_allocation_pc_pc_AllocationContext486', b1)
    if hasattr(b1, 'composition_pc_pc_AssemblyContext487'):
        assert _is_linked(b1, 'composition_pc_pc_AssemblyContext487', a)
    _safe_set(a, 'pcm_pc_pc_allocation_pc_pc_AllocationContext486', b2)
    assert _is_linked(a, 'pcm_pc_pc_allocation_pc_pc_AllocationContext486', b2)
    if hasattr(b1, 'composition_pc_pc_AssemblyContext487'):
        assert not _is_linked(b1, 'composition_pc_pc_AssemblyContext487', a)
    if hasattr(b2, 'composition_pc_pc_AssemblyContext487'):
        assert _is_linked(b2, 'composition_pc_pc_AssemblyContext487', a)
    _safe_set(a, 'pcm_pc_pc_allocation_pc_pc_AllocationContext486', None)
    assert not _is_linked(a, 'pcm_pc_pc_allocation_pc_pc_AllocationContext486', b2)
    if hasattr(b2, 'composition_pc_pc_AssemblyContext487'):
        assert not _is_linked(b2, 'composition_pc_pc_AssemblyContext487', a)


def test_assoc_assemblyContext_ProvidedDelegationConnector63_link_reassign_clear():
    a = pcm_pc_pc_composition_pc_pc_ProvidedDelegationConnector()
    b1 = composition_pc_pc_AssemblyContext()
    b2 = composition_pc_pc_AssemblyContext()
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_ProvidedDelegationConnector64', b1)
    assert _is_linked(a, 'pcm_pc_pc_composition_pc_pc_ProvidedDelegationConnector64', b1)
    if hasattr(b1, 'composition_pc_pc_AssemblyContext65'):
        assert _is_linked(b1, 'composition_pc_pc_AssemblyContext65', a)
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_ProvidedDelegationConnector64', b2)
    assert _is_linked(a, 'pcm_pc_pc_composition_pc_pc_ProvidedDelegationConnector64', b2)
    if hasattr(b1, 'composition_pc_pc_AssemblyContext65'):
        assert not _is_linked(b1, 'composition_pc_pc_AssemblyContext65', a)
    if hasattr(b2, 'composition_pc_pc_AssemblyContext65'):
        assert _is_linked(b2, 'composition_pc_pc_AssemblyContext65', a)
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_ProvidedDelegationConnector64', None)
    assert not _is_linked(a, 'pcm_pc_pc_composition_pc_pc_ProvidedDelegationConnector64', b2)
    if hasattr(b2, 'composition_pc_pc_AssemblyContext65'):
        assert not _is_linked(b2, 'composition_pc_pc_AssemblyContext65', a)


def test_assoc_assemblyContext_RequiredDelegationConnector70_link_reassign_clear():
    a = pcm_pc_pc_composition_pc_pc_RequiredDelegationConnector()
    b1 = composition_pc_pc_AssemblyContext()
    b2 = composition_pc_pc_AssemblyContext()
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_RequiredDelegationConnector71', b1)
    assert _is_linked(a, 'pcm_pc_pc_composition_pc_pc_RequiredDelegationConnector71', b1)
    if hasattr(b1, 'composition_pc_pc_AssemblyContext72'):
        assert _is_linked(b1, 'composition_pc_pc_AssemblyContext72', a)
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_RequiredDelegationConnector71', b2)
    assert _is_linked(a, 'pcm_pc_pc_composition_pc_pc_RequiredDelegationConnector71', b2)
    if hasattr(b1, 'composition_pc_pc_AssemblyContext72'):
        assert not _is_linked(b1, 'composition_pc_pc_AssemblyContext72', a)
    if hasattr(b2, 'composition_pc_pc_AssemblyContext72'):
        assert _is_linked(b2, 'composition_pc_pc_AssemblyContext72', a)
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_RequiredDelegationConnector71', None)
    assert not _is_linked(a, 'pcm_pc_pc_composition_pc_pc_RequiredDelegationConnector71', b2)
    if hasattr(b2, 'composition_pc_pc_AssemblyContext72'):
        assert not _is_linked(b2, 'composition_pc_pc_AssemblyContext72', a)


def test_assoc_assemblyContexts__ComposedStructure31_link_reassign_clear():
    a = pcm_pc_pc_composition_pc_pc_ComposedStructure()
    b1 = composition_pc_pc_AssemblyContext()
    b2 = composition_pc_pc_AssemblyContext()
...
def test_assoc_assemblyEventConnector__FilterCondition13_link_reassign_clear():
    a = pcm_pc_pc_core_pc_pc_PCMRandomVariable()
    b1 = composition_pc_pc_AssemblyEventConnector()
    b2 = composition_pc_pc_AssemblyEventConnector()
...
def test_assoc_basicComponent_ServiceEffectSpecification352_link_reassign_clear():
    a = pcm_pc_pc_seff_pc_pc_ServiceEffectSpecification(seffTypeID="sample_text")
    b1 = BasicComponent()
    b2 = BasicComponent()
    ...
    if hasattr(b1, 'BasicComponent353'):
        assert _is_linked(b1, 'BasicComponent353', a)
    ...
    if hasattr(b1, 'BasicComponent353'):
        assert not _is_linked(b1, 'BasicComponent353', a)
    if hasattr(b2, 'BasicComponent353'):
        assert _is_linked(b2, 'BasicComponent353', a)
    ...
    if hasattr(b2, 'BasicComponent353'):
        assert not _is_linked(b2, 'BasicComponent353', a)


def test_assoc_branchTransition_ScenarioBehaviour178_link_reassign_clear():
    a = pcm_pc_pc_usagemodel_pc_pc_ScenarioBehaviour()
    b1 = BranchTransition()
    b2 = BranchTransition()
...
def test_assoc_branchTransitions_Branch186_link_reassign_clear():
    a = pcm_pc_pc_usagemodel_pc_pc_Branch()
    b1 = BranchTransition()
    b2 = BranchTransition()
    _safe_set(a, 'branch_BranchTransition', {b1})
    assert _is_linked(a, 'branch_BranchTransition', b1)
    if hasattr(b1, 'BranchTransition187'):
        assert _is_linked(b1, 'BranchTransition187', a)
    _safe_set(a, 'branch_BranchTransition', {b2})
    assert _is_linked(a, 'branch_BranchTransition', b2)
    if hasattr(b1, 'BranchTransition187'):
        assert not _is_linked(b1, 'BranchTransition187', a)
    if hasattr(b2, 'BranchTransition187'):
        assert _is_linked(b2, 'BranchTransition187', a)
    _safe_set(a, 'branch_BranchTransition', set())
    assert not _is_linked(a, 'branch_BranchTransition', b2)
    if hasattr(b2, 'BranchTransition187'):
        assert not _is_linked(b2, 'BranchTransition187', a)


def test_assoc_branch_BranchTransition183_link_reassign_clear():
    a = pcm_pc_pc_usagemodel_pc_pc_BranchTransition(branchProbability=3.14)
    b1 = Branch()
    b2 = Branch()
...
def test_assoc_branchedBehaviour_BranchTransition184_link_reassign_clear():
    a = pcm_pc_pc_usagemodel_pc_pc_BranchTransition(branchProbability=3.14)
    ...
    if hasattr(b1, 'ScenarioBehaviour185'):
        assert _is_linked(b1, 'ScenarioBehaviour185', a)
    _safe_set(a, 'branchTransition_ScenarioBehaviour', b2)
    assert _is_linked(a, 'branchTransition_ScenarioBehaviour', b2)
    if hasattr(b1, 'ScenarioBehaviour185'):
        assert not _is_linked(b1, 'ScenarioBehaviour185', a)
    if hasattr(b2, 'ScenarioBehaviour185'):
        assert _is_linked(b2, 'ScenarioBehaviour185', a)
    _safe_set(a, 'branchTransition_ScenarioBehaviour', None)
    assert not _is_linked(a, 'branchTransition_ScenarioBehaviour', b2)
    if hasattr(b2, 'ScenarioBehaviour185'):
        assert not _is_linked(b2, 'ScenarioBehaviour185', a)


def test_assoc_branches_Branch347_link_reassign_clear():
    a = pcm_pc_pc_seff_pc_pc_BranchAction()
    b1 = AbstractBranchTransition()
    b2 = AbstractBranchTransition()
    _safe_set(a, 'branchAction_AbstractBranchTransition', {b1})
    assert _is_linked(a, 'branchAction_AbstractBranchTransition', b1)
    if hasattr(b1, 'AbstractBranchTransition348'):
        assert _is_linked(b1, 'AbstractBranchTransition348', a)
    _safe_set(a, 'branchAction_AbstractBranchTransition', {b2})
    assert _is_linked(a, 'branchAction_AbstractBranchTransition', b2)
    if hasattr(b1, 'AbstractBranchTransition348'):
        assert not _is_linked(b1, 'AbstractBranchTransition348', a)
    if hasattr(b2, 'AbstractBranchTransition348'):
        assert _is_linked(b2, 'AbstractBranchTransition348', a)
    _safe_set(a, 'branchAction_AbstractBranchTransition', set())
    assert not _is_linked(a, 'branchAction_AbstractBranchTransition', b2)
    if hasattr(b2, 'AbstractBranchTransition348'):
        assert not _is_linked(b2, 'AbstractBranchTransition348', a)


def test_assoc_calledService_ExternalService372_link_reassign_clear():
    a = pcm_pc_pc_seff_pc_pc_ExternalCallAction(retryCount=7)
    b1 = OperationSignature()
    b2 = OperationSignature()
    _safe_set(a, 'pcm_pc_pc_seff_pc_pc_ExternalCallAction', b1)
    assert _is_linked(a, 'pcm_pc_pc_seff_pc_pc_ExternalCallAction', b1)
    if hasattr(b1, 'OperationSignature373'):
        assert _is_linked(b1, 'OperationSignature373', a)
    _safe_set(a, 'pcm_pc_pc_seff_pc_pc_ExternalCallAction', b2)
    assert _is_linked(a, 'pcm_pc_pc_seff_pc_pc_ExternalCallAction', b2)
    if hasattr(b1, 'OperationSignature373'):
        assert not _is_linked(b1, 'OperationSignature373', a)
    if hasattr(b2, 'OperationSignature373'):
        assert _is_linked(b2, 'OperationSignature373', a)
    _safe_set(a, 'pcm_pc_pc_seff_pc_pc_ExternalCallAction', None)
    assert not _is_linked(a, 'pcm_pc_pc_seff_pc_pc_ExternalCallAction', b2)
    if hasattr(b2, 'OperationSignature373'):
        assert not _is_linked(b2, 'OperationSignature373', a)


def test_assoc_closedWorkload_PCMRandomVariable3_link_reassign_clear():
    a = pcm_pc_pc_core_pc_pc_PCMRandomVariable()
    b1 = ClosedWorkload()
    b2 = ClosedWorkload()
...
def test_assoc_communicationLinkResourceSpecifcation_throughput_PCMRandomVariable17_link_reassign_clear():
    a = pcm_pc_pc_core_pc_pc_PCMRandomVariable()
...
def test_assoc_communicationLinkResourceSpecification_latency_PCMRandomVariable19_link_reassign_clear():
    a = pcm_pc_pc_core_pc_pc_PCMRandomVariable()
    b1 = CommunicationLinkResourceSpecification()
    b2 = CommunicationLinkResourceSpecification()
    ...
    if hasattr(b1, 'CommunicationLinkResourceSpecification20'):
        assert _is_linked(b1, 'CommunicationLinkResourceSpecification20', a)
    ...
    if hasattr(b1, 'CommunicationLinkResourceSpecification20'):
        assert not _is_linked(b1, 'CommunicationLinkResourceSpecification20', a)
    if hasattr(b2, 'CommunicationLinkResourceSpecification20'):
        assert _is_linked(b2, 'CommunicationLinkResourceSpecification20', a)
    ...
    if hasattr(b2, 'CommunicationLinkResourceSpecification20'):
        assert not _is_linked(b2, 'CommunicationLinkResourceSpecification20', a)


def test_assoc_communicationLinkResourceType_CommunicationLinkResourceSpecification477_link_reassign_clear():
    a = pcm_pc_pc_resourceenvironment_pc_pc_CommunicationLinkResourceSpecification(failureProbability=3.14)
    b1 = CommunicationLinkResourceType()
    b2 = CommunicationLinkResourceType()
    _safe_set(a, 'pcm_pc_pc_resourceenvironment_pc_pc_CommunicationLinkResourceSpecification', b1)
    assert _is_linked(a, 'pcm_pc_pc_resourceenvironment_pc_pc_CommunicationLinkResourceSpecification', b1)
    if hasattr(b1, 'CommunicationLinkResourceType478'):
        assert _is_linked(b1, 'CommunicationLinkResourceType478', a)
    _safe_set(a, 'pcm_pc_pc_resourceenvironment_pc_pc_CommunicationLinkResourceSpecification', b2)
    assert _is_linked(a, 'pcm_pc_pc_resourceenvironment_pc_pc_CommunicationLinkResourceSpecification', b2)
    if hasattr(b1, 'CommunicationLinkResourceType478'):
        assert not _is_linked(b1, 'CommunicationLinkResourceType478', a)
    if hasattr(b2, 'CommunicationLinkResourceType478'):
        assert _is_linked(b2, 'CommunicationLinkResourceType478', a)
    _safe_set(a, 'pcm_pc_pc_resourceenvironment_pc_pc_CommunicationLinkResourceSpecification', None)
    assert not _is_linked(a, 'pcm_pc_pc_resourceenvironment_pc_pc_CommunicationLinkResourceSpecification', b2)
    if hasattr(b2, 'CommunicationLinkResourceType478'):
        assert not _is_linked(b2, 'CommunicationLinkResourceType478', a)


def test_assoc_communicationLinkResourceType__NetworkInducedFailureType319_link_reassign_clear():
    a = pcm_pc_pc_reliability_pc_pc_NetworkInducedFailureType()
    b1 = CommunicationLinkResourceType()
    b2 = CommunicationLinkResourceType()
...
def test_assoc_componentParameterUsage_ImplementationComponentType206_link_reassign_clear():
    a = pcm_pc_pc_repository_pc_pc_ImplementationComponentType(componentType="sample_text")
    b1 = VariableUsage()
    b2 = VariableUsage()
    _safe_set(a, 'pcm_pc_pc_repository_pc_pc_ImplementationComponentType207', {b1})
    assert _is_linked(a, 'pcm_pc_pc_repository_pc_pc_ImplementationComponentType207', b1)
    if hasattr(b1, 'VariableUsage208'):
        assert _is_linked(b1, 'VariableUsage208', a)
    _safe_set(a, 'pcm_pc_pc_repository_pc_pc_ImplementationComponentType207', {b2})
    assert _is_linked(a, 'pcm_pc_pc_repository_pc_pc_ImplementationComponentType207', b2)
    if hasattr(b1, 'VariableUsage208'):
        assert not _is_linked(b1, 'VariableUsage208', a)
    if hasattr(b2, 'VariableUsage208'):
        assert _is_linked(b2, 'VariableUsage208', a)
    _safe_set(a, 'pcm_pc_pc_repository_pc_pc_ImplementationComponentType207', set())
    assert not _is_linked(a, 'pcm_pc_pc_repository_pc_pc_ImplementationComponentType207', b2)
    if hasattr(b2, 'VariableUsage208'):
        assert not _is_linked(b2, 'VariableUsage208', a)


def test_assoc_components__Repository219_link_reassign_clear():
    a = pcm_pc_pc_repository_pc_pc_Repository(repositoryDescription="sample_text")
    ...
    if hasattr(b1, 'RepositoryComponent220'):
        assert _is_linked(b1, 'RepositoryComponent220', a)
    _safe_set(a, 'repository__RepositoryComponent', {b2})
    assert _is_linked(a, 'repository__RepositoryComponent', b2)
    if hasattr(b1, 'RepositoryComponent220'):
        assert not _is_linked(b1, 'RepositoryComponent220', a)
    if hasattr(b2, 'RepositoryComponent220'):
        assert _is_linked(b2, 'RepositoryComponent220', a)
    _safe_set(a, 'repository__RepositoryComponent', set())
    assert not _is_linked(a, 'repository__RepositoryComponent', b2)
    if hasattr(b2, 'RepositoryComponent220'):
        assert not _is_linked(b2, 'RepositoryComponent220', a)


def test_assoc_connectors__ComposedStructure34_link_reassign_clear():
    a = pcm_pc_pc_composition_pc_pc_ComposedStructure()
    b1 = composition_pc_pc_Connector()
    b2 = composition_pc_pc_Connector()
...
def test_assoc_dataType__Parameter211_link_reassign_clear():
    a = pcm_pc_pc_repository_pc_pc_Parameter(modifier__Parameter="sample_text", parameterName="sample_text")
    b1 = DataType()
    b2 = DataType()
    _safe_set(a, 'pcm_pc_pc_repository_pc_pc_Parameter', b1)
    assert _is_linked(a, 'pcm_pc_pc_repository_pc_pc_Parameter', b1)
    if hasattr(b1, 'DataType'):
        assert _is_linked(b1, 'DataType', a)
    _safe_set(a, 'pcm_pc_pc_repository_pc_pc_Parameter', b2)
    assert _is_linked(a, 'pcm_pc_pc_repository_pc_pc_Parameter', b2)
    if hasattr(b1, 'DataType'):
        assert not _is_linked(b1, 'DataType', a)
    if hasattr(b2, 'DataType'):
        assert _is_linked(b2, 'DataType', a)
    _safe_set(a, 'pcm_pc_pc_repository_pc_pc_Parameter', None)
    assert not _is_linked(a, 'pcm_pc_pc_repository_pc_pc_Parameter', b2)
    if hasattr(b2, 'DataType'):
        assert not _is_linked(b2, 'DataType', a)


def test_assoc_dataTypes__Repository223_link_reassign_clear():
    a = pcm_pc_pc_repository_pc_pc_Repository(repositoryDescription="sample_text")
    b1 = DataType()
    b2 = DataType()
    _safe_set(a, 'repository__DataType', {b1})
    assert _is_linked(a, 'repository__DataType', b1)
    if hasattr(b1, 'DataType224'):
        assert _is_linked(b1, 'DataType224', a)
    _safe_set(a, 'repository__DataType', {b2})
    assert _is_linked(a, 'repository__DataType', b2)
    if hasattr(b1, 'DataType224'):
        assert not _is_linked(b1, 'DataType224', a)
    if hasattr(b2, 'DataType224'):
        assert _is_linked(b2, 'DataType224', a)
    _safe_set(a, 'repository__DataType', set())
    assert not _is_linked(a, 'repository__DataType', b2)
    if hasattr(b2, 'DataType224'):
        assert not _is_linked(b2, 'DataType224', a)


def test_assoc_delay_TimeSpecification16_link_reassign_clear():
    a = pcm_pc_pc_core_pc_pc_PCMRandomVariable()
    b1 = Delay()
    b2 = Delay()
...
def test_assoc_describedService__SEFF351_link_reassign_clear():
    a = pcm_pc_pc_seff_pc_pc_ServiceEffectSpecification(seffTypeID="sample_text")
    b1 = Signature()
    b2 = Signature()
    _safe_set(a, 'pcm_pc_pc_seff_pc_pc_ServiceEffectSpecification', b1)
    assert _is_linked(a, 'pcm_pc_pc_seff_pc_pc_ServiceEffectSpecification', b1)
    if hasattr(b1, 'Signature'):
        assert _is_linked(b1, 'Signature', a)
    _safe_set(a, 'pcm_pc_pc_seff_pc_pc_ServiceEffectSpecification', b2)
    assert _is_linked(a, 'pcm_pc_pc_seff_pc_pc_ServiceEffectSpecification', b2)
    if hasattr(b1, 'Signature'):
        assert not _is_linked(b1, 'Signature', a)
    if hasattr(b2, 'Signature'):
        assert _is_linked(b2, 'Signature', a)
    _safe_set(a, 'pcm_pc_pc_seff_pc_pc_ServiceEffectSpecification', None)
    assert not _is_linked(a, 'pcm_pc_pc_seff_pc_pc_ServiceEffectSpecification', b2)
    if hasattr(b2, 'Signature'):
        assert not _is_linked(b2, 'Signature', a)


def test_assoc_eventChannelSinkConnector__FilterCondition12_link_reassign_clear():
    a = pcm_pc_pc_core_pc_pc_PCMRandomVariable()
    b1 = composition_pc_pc_EventChannelSinkConnector()
    b2 = composition_pc_pc_EventChannelSinkConnector()
...
def test_assoc_eventChannel__AllocationContext489_link_reassign_clear():
    a = pcm_pc_pc_allocation_pc_pc_AllocationContext()
    b1 = composition_pc_pc_EventChannel()
    b2 = composition_pc_pc_EventChannel()
    _safe_set(a, 'pcm_pc_pc_allocation_pc_pc_AllocationContext490', b1)
    assert _is_linked(a, 'pcm_pc_pc_allocation_pc_pc_AllocationContext490', b1)
    if hasattr(b1, 'composition_pc_pc_EventChannel'):
        assert _is_linked(b1, 'composition_pc_pc_EventChannel', a)
    _safe_set(a, 'pcm_pc_pc_allocation_pc_pc_AllocationContext490', b2)
    assert _is_linked(a, 'pcm_pc_pc_allocation_pc_pc_AllocationContext490', b2)
    if hasattr(b1, 'composition_pc_pc_EventChannel'):
        assert not _is_linked(b1, 'composition_pc_pc_EventChannel', a)
    if hasattr(b2, 'composition_pc_pc_EventChannel'):
        assert _is_linked(b2, 'composition_pc_pc_EventChannel', a)
    _safe_set(a, 'pcm_pc_pc_allocation_pc_pc_AllocationContext490', None)
    assert not _is_linked(a, 'pcm_pc_pc_allocation_pc_pc_AllocationContext490', b2)
    if hasattr(b2, 'composition_pc_pc_EventChannel'):
        assert not _is_linked(b2, 'composition_pc_pc_EventChannel', a)


def test_assoc_eventChannel__ComposedStructure33_link_reassign_clear():
    a = pcm_pc_pc_composition_pc_pc_ComposedStructure()
    b1 = composition_pc_pc_EventChannel()
    b2 = composition_pc_pc_EventChannel()
...
def test_assoc_eventType__Parameter215_link_reassign_clear():
    a = pcm_pc_pc_repository_pc_pc_Parameter(modifier__Parameter="sample_text", parameterName="sample_text")
    b1 = EventType()
    b2 = EventType()
...
def test_assoc_externalFailureOccurrenceDescriptions__SpecifiedReliabilityAnnotation448_link_reassign_clear():
    a = pcm_pc_pc_qos_reliability_pc_pc_SpecifiedReliabilityAnnotation()
...
def test_assoc_failureHandlingAlternatives__RecoveryActionBehaviour419_link_reassign_clear():
    a = pcm_pc_pc_seff_reliability_pc_pc_RecoveryActionBehaviour()
    b1 = seff_reliability_pc_pc_RecoveryActionBehaviour()
    b2 = seff_reliability_pc_pc_RecoveryActionBehaviour()
    _safe_set(a, 'pcm_pc_pc_seff_reliability_pc_pc_RecoveryActionBehaviour', {b1})
    assert _is_linked(a, 'pcm_pc_pc_seff_reliability_pc_pc_RecoveryActionBehaviour', b1)
    if hasattr(b1, 'seff_reliability_pc_pc_RecoveryActionBehaviour'):
        assert _is_linked(b1, 'seff_reliability_pc_pc_RecoveryActionBehaviour', a)
    _safe_set(a, 'pcm_pc_pc_seff_reliability_pc_pc_RecoveryActionBehaviour', {b2})
    assert _is_linked(a, 'pcm_pc_pc_seff_reliability_pc_pc_RecoveryActionBehaviour', b2)
    if hasattr(b1, 'seff_reliability_pc_pc_RecoveryActionBehaviour'):
        assert not _is_linked(b1, 'seff_reliability_pc_pc_RecoveryActionBehaviour', a)
    if hasattr(b2, 'seff_reliability_pc_pc_RecoveryActionBehaviour'):
        assert _is_linked(b2, 'seff_reliability_pc_pc_RecoveryActionBehaviour', a)
    _safe_set(a, 'pcm_pc_pc_seff_reliability_pc_pc_RecoveryActionBehaviour', set())
    assert not _is_linked(a, 'pcm_pc_pc_seff_reliability_pc_pc_RecoveryActionBehaviour', b2)
    if hasattr(b2, 'seff_reliability_pc_pc_RecoveryActionBehaviour'):
        assert not _is_linked(b2, 'seff_reliability_pc_pc_RecoveryActionBehaviour', a)


def test_assoc_failureType__ExternalFailureOccurrenceDescription321_link_reassign_clear():
    a = pcm_pc_pc_reliability_pc_pc_ExternalFailureOccurrenceDescription()
    b1 = FailureType()
    b2 = FailureType()
    _safe_set(a, 'pcm_pc_pc_reliability_pc_pc_ExternalFailureOccurrenceDescription', b1)
    assert _is_linked(a, 'pcm_pc_pc_reliability_pc_pc_ExternalFailureOccurrenceDescription', b1)
    if hasattr(b1, 'FailureType322'):
        assert _is_linked(b1, 'FailureType322', a)
    _safe_set(a, 'pcm_pc_pc_reliability_pc_pc_ExternalFailureOccurrenceDescription', b2)
    assert _is_linked(a, 'pcm_pc_pc_reliability_pc_pc_ExternalFailureOccurrenceDescription', b2)
    if hasattr(b1, 'FailureType322'):
        assert not _is_linked(b1, 'FailureType322', a)
    if hasattr(b2, 'FailureType322'):
        assert _is_linked(b2, 'FailureType322', a)
    _safe_set(a, 'pcm_pc_pc_reliability_pc_pc_ExternalFailureOccurrenceDescription', None)
    assert not _is_linked(a, 'pcm_pc_pc_reliability_pc_pc_ExternalFailureOccurrenceDescription', b2)
    if hasattr(b2, 'FailureType322'):
        assert not _is_linked(b2, 'FailureType322', a)


def test_assoc_failureTypes__Repository222_link_reassign_clear():
    a = pcm_pc_pc_repository_pc_pc_Repository(repositoryDescription="sample_text")
    b1 = FailureType()
    b2 = FailureType()
...
def test_assoc_guardedBranchTransition_PCMRandomVariable10_link_reassign_clear():
    a = pcm_pc_pc_core_pc_pc_PCMRandomVariable()
...
def test_assoc_infrastructureCall__PCMRandomVariable6_link_reassign_clear():
    a = pcm_pc_pc_core_pc_pc_PCMRandomVariable()
    b1 = seff_performance_pc_pc_InfrastructureCall()
    b2 = seff_performance_pc_pc_InfrastructureCall()
...
def test_assoc_infrastructureSignature__Parameter212_link_reassign_clear():
    a = pcm_pc_pc_repository_pc_pc_Parameter(modifier__Parameter="sample_text", parameterName="sample_text")
...
def test_assoc_innerProvidedRole_ProvidedDelegationConnector59_link_reassign_clear():
    a = pcm_pc_pc_composition_pc_pc_ProvidedDelegationConnector()
    b1 = OperationProvidedRole()
    b2 = OperationProvidedRole()
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_ProvidedDelegationConnector', b1)
    assert _is_linked(a, 'pcm_pc_pc_composition_pc_pc_ProvidedDelegationConnector', b1)
    if hasattr(b1, 'OperationProvidedRole'):
        assert _is_linked(b1, 'OperationProvidedRole', a)
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_ProvidedDelegationConnector', b2)
    assert _is_linked(a, 'pcm_pc_pc_composition_pc_pc_ProvidedDelegationConnector', b2)
    if hasattr(b1, 'OperationProvidedRole'):
    ...
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_ProvidedDelegationConnector', None)
    assert not _is_linked(a, 'pcm_pc_pc_composition_pc_pc_ProvidedDelegationConnector', b2)
    if hasattr(b2, 'OperationProvidedRole'):
        assert not _is_linked(b2, 'OperationProvidedRole', a)


def test_assoc_innerRequiredRole_RequiredDelegationConnector66_link_reassign_clear():
    a = pcm_pc_pc_composition_pc_pc_RequiredDelegationConnector()
    b1 = OperationRequiredRole()
    b2 = OperationRequiredRole()
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_RequiredDelegationConnector', b1)
    assert _is_linked(a, 'pcm_pc_pc_composition_pc_pc_RequiredDelegationConnector', b1)
    if hasattr(b1, 'OperationRequiredRole'):
        assert _is_linked(b1, 'OperationRequiredRole', a)
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_RequiredDelegationConnector', b2)
    assert _is_linked(a, 'pcm_pc_pc_composition_pc_pc_RequiredDelegationConnector', b2)
    if hasattr(b1, 'OperationRequiredRole'):
    ...
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_RequiredDelegationConnector', None)
    assert not _is_linked(a, 'pcm_pc_pc_composition_pc_pc_RequiredDelegationConnector', b2)
    if hasattr(b2, 'OperationRequiredRole'):
        assert not _is_linked(b2, 'OperationRequiredRole', a)


def test_assoc_inputParameterUsages_EntryLevelSystemCall169_link_reassign_clear():
    a = pcm_pc_pc_usagemodel_pc_pc_EntryLevelSystemCall(priority=7)
    b1 = VariableUsage()
    b2 = VariableUsage()
...
def test_assoc_interArrivalTime_OpenWorkload192_link_reassign_clear():
    a = pcm_pc_pc_usagemodel_pc_pc_OpenWorkload()
    ...
    if hasattr(b1, 'PCMRandomVariable193'):
        assert _is_linked(b1, 'PCMRandomVariable193', a)
    _safe_set(a, 'openWorkload_PCMRandomVariable', b2)
    assert _is_linked(a, 'openWorkload_PCMRandomVariable', b2)
    if hasattr(b1, 'PCMRandomVariable193'):
        assert not _is_linked(b1, 'PCMRandomVariable193', a)
    if hasattr(b2, 'PCMRandomVariable193'):
        assert _is_linked(b2, 'PCMRandomVariable193', a)
    _safe_set(a, 'openWorkload_PCMRandomVariable', None)
    assert not _is_linked(a, 'openWorkload_PCMRandomVariable', b2)
    if hasattr(b2, 'PCMRandomVariable193'):
        assert not _is_linked(b2, 'PCMRandomVariable193', a)


def test_assoc_interface_RequiredCharacterisation233_link_reassign_clear():
    a = pcm_pc_pc_repository_pc_pc_RequiredCharacterisation(type="sample_text")
    b1 = Interface()
    b2 = Interface()
...
def test_assoc_interface__OperationSignature253_link_reassign_clear():
    a = pcm_pc_pc_repository_pc_pc_OperationSignature()
...
def test_assoc_interfaces__Repository221_link_reassign_clear():
    a = pcm_pc_pc_repository_pc_pc_Repository(repositoryDescription="sample_text")
    b1 = Interface()
    b2 = Interface()
...
def test_assoc_internalAction__InternalFailureOccurrenceDescription317_link_reassign_clear():
    a = pcm_pc_pc_reliability_pc_pc_InternalFailureOccurrenceDescription()
    b1 = InternalAction()
    b2 = InternalAction()
...
def test_assoc_internalFailureOccurrenceDescriptions__InternalAction394_link_reassign_clear():
    a = pcm_pc_pc_seff_pc_pc_InternalAction()
    ...
    if hasattr(b1, 'InternalFailureOccurrenceDescription395'):
        assert _is_linked(b1, 'InternalFailureOccurrenceDescription395', a)
    ...
    if hasattr(b1, 'InternalFailureOccurrenceDescription395'):
        assert not _is_linked(b1, 'InternalFailureOccurrenceDescription395', a)
    if hasattr(b2, 'InternalFailureOccurrenceDescription395'):
        assert _is_linked(b2, 'InternalFailureOccurrenceDescription395', a)
    ...
    if hasattr(b2, 'InternalFailureOccurrenceDescription395'):
        assert not _is_linked(b2, 'InternalFailureOccurrenceDescription395', a)


def test_assoc_latency_CommunicationLinkResourceSpecification479_link_reassign_clear():
    a = pcm_pc_pc_resourceenvironment_pc_pc_CommunicationLinkResourceSpecification(failureProbability=3.14)
    b1 = PCMRandomVariable()
    b2 = PCMRandomVariable()
...
def test_assoc_linkingResource_CommunicationLinkResourceSpecification475_link_reassign_clear():
    a = pcm_pc_pc_resourceenvironment_pc_pc_CommunicationLinkResourceSpecification(failureProbability=3.14)
    b1 = LinkingResource()
    b2 = LinkingResource()
    ...
    if hasattr(b1, 'LinkingResource476'):
        assert _is_linked(b1, 'LinkingResource476', a)
    ...
    if hasattr(b1, 'LinkingResource476'):
        assert not _is_linked(b1, 'LinkingResource476', a)
    if hasattr(b2, 'LinkingResource476'):
        assert _is_linked(b2, 'LinkingResource476', a)
    ...
    if hasattr(b2, 'LinkingResource476'):
        assert not _is_linked(b2, 'LinkingResource476', a)


def test_assoc_loopAction_PCMRandomVariable9_link_reassign_clear():
    a = pcm_pc_pc_core_pc_pc_PCMRandomVariable()
    b1 = LoopAction()
    b2 = LoopAction()
...
def test_assoc_loop_LoopIteration14_link_reassign_clear():
    a = pcm_pc_pc_core_pc_pc_PCMRandomVariable()
    b1 = Loop()
    b2 = Loop()
...
def test_assoc_loop_ScenarioBehaviour179_link_reassign_clear():
    a = pcm_pc_pc_usagemodel_pc_pc_ScenarioBehaviour()
    b1 = Loop()
    b2 = Loop()
    _safe_set(a, 'bodyBehaviour_Loop', b1)
    assert _is_linked(a, 'bodyBehaviour_Loop', b1)
    if hasattr(b1, 'Loop180'):
        assert _is_linked(b1, 'Loop180', a)
    _safe_set(a, 'bodyBehaviour_Loop', b2)
    assert _is_linked(a, 'bodyBehaviour_Loop', b2)
    if hasattr(b1, 'Loop180'):
        assert not _is_linked(b1, 'Loop180', a)
    if hasattr(b2, 'Loop180'):
        assert _is_linked(b2, 'Loop180', a)
    _safe_set(a, 'bodyBehaviour_Loop', None)
    assert not _is_linked(a, 'bodyBehaviour_Loop', b2)
    if hasattr(b2, 'Loop180'):
        assert not _is_linked(b2, 'Loop180', a)


def test_assoc_numberOfCalls__InfrastructureCall398_link_reassign_clear():
    a = pcm_pc_pc_seff_performance_pc_pc_InfrastructureCall()
    b1 = PCMRandomVariable()
    b2 = PCMRandomVariable()
    _safe_set(a, 'infrastructureCall__PCMRandomVariable', b1)
    assert _is_linked(a, 'infrastructureCall__PCMRandomVariable', b1)
    if hasattr(b1, 'PCMRandomVariable399'):
        assert _is_linked(b1, 'PCMRandomVariable399', a)
    _safe_set(a, 'infrastructureCall__PCMRandomVariable', b2)
    assert _is_linked(a, 'infrastructureCall__PCMRandomVariable', b2)
    if hasattr(b1, 'PCMRandomVariable399'):
        assert not _is_linked(b1, 'PCMRandomVariable399', a)
    if hasattr(b2, 'PCMRandomVariable399'):
        assert _is_linked(b2, 'PCMRandomVariable399', a)
    _safe_set(a, 'infrastructureCall__PCMRandomVariable', None)
    assert not _is_linked(a, 'infrastructureCall__PCMRandomVariable', b2)
    if hasattr(b2, 'PCMRandomVariable399'):
        assert not _is_linked(b2, 'PCMRandomVariable399', a)


def test_assoc_numberOfCalls__ResourceCall411_link_reassign_clear():
    a = pcm_pc_pc_seff_performance_pc_pc_ResourceCall()
    b1 = PCMRandomVariable()
    b2 = PCMRandomVariable()
...
def test_assoc_openWorkload_PCMRandomVariable15_link_reassign_clear():
    a = pcm_pc_pc_core_pc_pc_PCMRandomVariable()
    b1 = OpenWorkload()
    b2 = OpenWorkload()
...
def test_assoc_operationSignature__EntryLevelSystemCall165_link_reassign_clear():
    a = pcm_pc_pc_usagemodel_pc_pc_EntryLevelSystemCall(priority=7)
    b1 = OperationSignature()
    b2 = OperationSignature()
    _safe_set(a, 'pcm_pc_pc_usagemodel_pc_pc_EntryLevelSystemCall166', b1)
    assert _is_linked(a, 'pcm_pc_pc_usagemodel_pc_pc_EntryLevelSystemCall166', b1)
    if hasattr(b1, 'OperationSignature'):
        assert _is_linked(b1, 'OperationSignature', a)
    _safe_set(a, 'pcm_pc_pc_usagemodel_pc_pc_EntryLevelSystemCall166', b2)
    assert _is_linked(a, 'pcm_pc_pc_usagemodel_pc_pc_EntryLevelSystemCall166', b2)
    if hasattr(b1, 'OperationSignature'):
        assert not _is_linked(b1, 'OperationSignature', a)
    if hasattr(b2, 'OperationSignature'):
        assert _is_linked(b2, 'OperationSignature', a)
    _safe_set(a, 'pcm_pc_pc_usagemodel_pc_pc_EntryLevelSystemCall166', None)
    assert not _is_linked(a, 'pcm_pc_pc_usagemodel_pc_pc_EntryLevelSystemCall166', b2)
    if hasattr(b2, 'OperationSignature'):
        assert not _is_linked(b2, 'OperationSignature', a)


def test_assoc_operationSignature__Parameter213_link_reassign_clear():
    a = pcm_pc_pc_repository_pc_pc_Parameter(modifier__Parameter="sample_text", parameterName="sample_text")
    b1 = OperationSignature()
    b2 = OperationSignature()
    _safe_set(a, 'parameters__OperationSignature', b1)
    assert _is_linked(a, 'parameters__OperationSignature', b1)
    if hasattr(b1, 'OperationSignature214'):
        assert _is_linked(b1, 'OperationSignature214', a)
    _safe_set(a, 'parameters__OperationSignature', b2)
    assert _is_linked(a, 'parameters__OperationSignature', b2)
    if hasattr(b1, 'OperationSignature214'):
        assert not _is_linked(b1, 'OperationSignature214', a)
    if hasattr(b2, 'OperationSignature214'):
        assert _is_linked(b2, 'OperationSignature214', a)
    _safe_set(a, 'parameters__OperationSignature', None)
    assert not _is_linked(a, 'parameters__OperationSignature', b2)
    if hasattr(b2, 'OperationSignature214'):
        assert not _is_linked(b2, 'OperationSignature214', a)


def test_assoc_outerProvidedRole_ProvidedDelegationConnector60_link_reassign_clear():
    a = pcm_pc_pc_composition_pc_pc_ProvidedDelegationConnector()
    b1 = OperationProvidedRole()
    b2 = OperationProvidedRole()
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_ProvidedDelegationConnector61', b1)
    assert _is_linked(a, 'pcm_pc_pc_composition_pc_pc_ProvidedDelegationConnector61', b1)
    if hasattr(b1, 'OperationProvidedRole62'):
        assert _is_linked(b1, 'OperationProvidedRole62', a)
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_ProvidedDelegationConnector61', b2)
    assert _is_linked(a, 'pcm_pc_pc_composition_pc_pc_ProvidedDelegationConnector61', b2)
    if hasattr(b1, 'OperationProvidedRole62'):
        assert not _is_linked(b1, 'OperationProvidedRole62', a)
    if hasattr(b2, 'OperationProvidedRole62'):
        assert _is_linked(b2, 'OperationProvidedRole62', a)
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_ProvidedDelegationConnector61', None)
    assert not _is_linked(a, 'pcm_pc_pc_composition_pc_pc_ProvidedDelegationConnector61', b2)
    if hasattr(b2, 'OperationProvidedRole62'):
        assert not _is_linked(b2, 'OperationProvidedRole62', a)


def test_assoc_outerRequiredRole_RequiredDelegationConnector67_link_reassign_clear():
    a = pcm_pc_pc_composition_pc_pc_RequiredDelegationConnector()
    b1 = OperationRequiredRole()
    b2 = OperationRequiredRole()
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_RequiredDelegationConnector68', b1)
    assert _is_linked(a, 'pcm_pc_pc_composition_pc_pc_RequiredDelegationConnector68', b1)
    if hasattr(b1, 'OperationRequiredRole69'):
        assert _is_linked(b1, 'OperationRequiredRole69', a)
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_RequiredDelegationConnector68', b2)
    assert _is_linked(a, 'pcm_pc_pc_composition_pc_pc_RequiredDelegationConnector68', b2)
    if hasattr(b1, 'OperationRequiredRole69'):
        assert not _is_linked(b1, 'OperationRequiredRole69', a)
    if hasattr(b2, 'OperationRequiredRole69'):
        assert _is_linked(b2, 'OperationRequiredRole69', a)
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_RequiredDelegationConnector68', None)
    assert not _is_linked(a, 'pcm_pc_pc_composition_pc_pc_RequiredDelegationConnector68', b2)
    if hasattr(b2, 'OperationRequiredRole69'):
        assert not _is_linked(b2, 'OperationRequiredRole69', a)


def test_assoc_outputParameterUsages_EntryLevelSystemCall167_link_reassign_clear():
    a = pcm_pc_pc_usagemodel_pc_pc_EntryLevelSystemCall(priority=7)
    b1 = VariableUsage()
    b2 = VariableUsage()
...
def test_assoc_parameter232_link_reassign_clear():
    a = pcm_pc_pc_repository_pc_pc_RequiredCharacterisation(type="sample_text")
    b1 = Parameter()
    b2 = Parameter()
    _safe_set(a, 'pcm_pc_pc_repository_pc_pc_RequiredCharacterisation', b1)
    assert _is_linked(a, 'pcm_pc_pc_repository_pc_pc_RequiredCharacterisation', b1)
    if hasattr(b1, 'Parameter'):
        assert _is_linked(b1, 'Parameter', a)
    _safe_set(a, 'pcm_pc_pc_repository_pc_pc_RequiredCharacterisation', b2)
    assert _is_linked(a, 'pcm_pc_pc_repository_pc_pc_RequiredCharacterisation', b2)
    if hasattr(b1, 'Parameter'):
        assert not _is_linked(b1, 'Parameter', a)
    if hasattr(b2, 'Parameter'):
        assert _is_linked(b2, 'Parameter', a)
    _safe_set(a, 'pcm_pc_pc_repository_pc_pc_RequiredCharacterisation', None)
    assert not _is_linked(a, 'pcm_pc_pc_repository_pc_pc_RequiredCharacterisation', b2)
    if hasattr(b2, 'Parameter'):
        assert not _is_linked(b2, 'Parameter', a)


def test_assoc_parameter__ResourceSignature279_link_reassign_clear():
    a = pcm_pc_pc_resourcetype_pc_pc_ResourceSignature(resourceServiceId=7)
    b1 = Parameter()
    b2 = Parameter()
    _safe_set(a, 'resourceSignature__Parameter', b1)
    assert _is_linked(a, 'resourceSignature__Parameter', b1)
    if hasattr(b1, 'Parameter280'):
        assert _is_linked(b1, 'Parameter280', a)
    _safe_set(a, 'resourceSignature__Parameter', b2)
    assert _is_linked(a, 'resourceSignature__Parameter', b2)
    if hasattr(b1, 'Parameter280'):
        assert not _is_linked(b1, 'Parameter280', a)
    if hasattr(b2, 'Parameter280'):
        assert _is_linked(b2, 'Parameter280', a)
    _safe_set(a, 'resourceSignature__Parameter', None)
    assert not _is_linked(a, 'resourceSignature__Parameter', b2)
    if hasattr(b2, 'Parameter280'):
        assert not _is_linked(b2, 'Parameter280', a)


def test_assoc_parameters__OperationSignature254_link_reassign_clear():
    a = pcm_pc_pc_repository_pc_pc_OperationSignature()
    b1 = Parameter()
    b2 = Parameter()
...
def test_assoc_parametricResourceDemand_PCMRandomVariable8_link_reassign_clear():
    a = pcm_pc_pc_core_pc_pc_PCMRandomVariable()
    b1 = seff_performance_pc_pc_ParametricResourceDemand()
    b2 = seff_performance_pc_pc_ParametricResourceDemand()
...
def test_assoc_parentCompleteComponentTypes205_link_reassign_clear():
    a = pcm_pc_pc_repository_pc_pc_ImplementationComponentType(componentType="sample_text")
    b1 = CompleteComponentType()
    b2 = CompleteComponentType()
    _safe_set(a, 'pcm_pc_pc_repository_pc_pc_ImplementationComponentType', {b1})
    assert _is_linked(a, 'pcm_pc_pc_repository_pc_pc_ImplementationComponentType', b1)
    if hasattr(b1, 'CompleteComponentType'):
        assert _is_linked(b1, 'CompleteComponentType', a)
    _safe_set(a, 'pcm_pc_pc_repository_pc_pc_ImplementationComponentType', {b2})
    assert _is_linked(a, 'pcm_pc_pc_repository_pc_pc_ImplementationComponentType', b2)
    if hasattr(b1, 'CompleteComponentType'):
    ...
    _safe_set(a, 'pcm_pc_pc_repository_pc_pc_ImplementationComponentType', set())
    assert not _is_linked(a, 'pcm_pc_pc_repository_pc_pc_ImplementationComponentType', b2)
    if hasattr(b2, 'CompleteComponentType'):
        assert not _is_linked(b2, 'CompleteComponentType', a)


def test_assoc_parentInterfaces__Interface225_link_reassign_clear():
    a = pcm_pc_pc_repository_pc_pc_Interface()
    b1 = Interface()
    b2 = Interface()
    _safe_set(a, 'pcm_pc_pc_repository_pc_pc_Interface', {b1})
    assert _is_linked(a, 'pcm_pc_pc_repository_pc_pc_Interface', b1)
    if hasattr(b1, 'Interface226'):
        assert _is_linked(b1, 'Interface226', a)
    _safe_set(a, 'pcm_pc_pc_repository_pc_pc_Interface', {b2})
    assert _is_linked(a, 'pcm_pc_pc_repository_pc_pc_Interface', b2)
    if hasattr(b1, 'Interface226'):
        assert not _is_linked(b1, 'Interface226', a)
    if hasattr(b2, 'Interface226'):
        assert _is_linked(b2, 'Interface226', a)
    _safe_set(a, 'pcm_pc_pc_repository_pc_pc_Interface', set())
    assert not _is_linked(a, 'pcm_pc_pc_repository_pc_pc_Interface', b2)
    if hasattr(b2, 'Interface226'):
        assert not _is_linked(b2, 'Interface226', a)


def test_assoc_parentProvidesComponentTypes270_link_reassign_clear():
    a = pcm_pc_pc_repository_pc_pc_CompleteComponentType()
    b1 = ProvidesComponentType()
    b2 = ProvidesComponentType()
    _safe_set(a, 'pcm_pc_pc_repository_pc_pc_CompleteComponentType', {b1})
    assert _is_linked(a, 'pcm_pc_pc_repository_pc_pc_CompleteComponentType', b1)
    if hasattr(b1, 'ProvidesComponentType'):
        assert _is_linked(b1, 'ProvidesComponentType', a)
    _safe_set(a, 'pcm_pc_pc_repository_pc_pc_CompleteComponentType', {b2})
    assert _is_linked(a, 'pcm_pc_pc_repository_pc_pc_CompleteComponentType', b2)
    if hasattr(b1, 'ProvidesComponentType'):
    ...
    _safe_set(a, 'pcm_pc_pc_repository_pc_pc_CompleteComponentType', set())
    assert not _is_linked(a, 'pcm_pc_pc_repository_pc_pc_CompleteComponentType', b2)
    if hasattr(b2, 'ProvidesComponentType'):
        assert not _is_linked(b2, 'ProvidesComponentType', a)


def test_assoc_passiveResource_BasicComponent203_link_reassign_clear():
    a = pcm_pc_pc_repository_pc_pc_BasicComponent()
    b1 = PassiveResource()
    b2 = PassiveResource()
    _safe_set(a, 'basicComponent_PassiveResource', {b1})
    assert _is_linked(a, 'basicComponent_PassiveResource', b1)
    if hasattr(b1, 'PassiveResource204'):
        assert _is_linked(b1, 'PassiveResource204', a)
    _safe_set(a, 'basicComponent_PassiveResource', {b2})
    assert _is_linked(a, 'basicComponent_PassiveResource', b2)
    if hasattr(b1, 'PassiveResource204'):
        assert not _is_linked(b1, 'PassiveResource204', a)
    if hasattr(b2, 'PassiveResource204'):
        assert _is_linked(b2, 'PassiveResource204', a)
    _safe_set(a, 'basicComponent_PassiveResource', set())
    assert not _is_linked(a, 'basicComponent_PassiveResource', b2)
    if hasattr(b2, 'PassiveResource204'):
        assert not _is_linked(b2, 'PassiveResource204', a)


def test_assoc_passiveResource_capacity_PCMRandomVariable4_link_reassign_clear():
    a = pcm_pc_pc_core_pc_pc_PCMRandomVariable()
    b1 = PassiveResource()
    b2 = PassiveResource()
...
def test_assoc_passiveresource_AcquireAction379_link_reassign_clear():
    a = pcm_pc_pc_seff_pc_pc_AcquireAction(timeout=True, timeoutValue=3.14)
    b1 = PassiveResource()
    b2 = PassiveResource()
    _safe_set(a, 'pcm_pc_pc_seff_pc_pc_AcquireAction', b1)
    assert _is_linked(a, 'pcm_pc_pc_seff_pc_pc_AcquireAction', b1)
    if hasattr(b1, 'PassiveResource380'):
        assert _is_linked(b1, 'PassiveResource380', a)
    _safe_set(a, 'pcm_pc_pc_seff_pc_pc_AcquireAction', b2)
    assert _is_linked(a, 'pcm_pc_pc_seff_pc_pc_AcquireAction', b2)
    if hasattr(b1, 'PassiveResource380'):
        assert not _is_linked(b1, 'PassiveResource380', a)
    if hasattr(b2, 'PassiveResource380'):
        assert _is_linked(b2, 'PassiveResource380', a)
    _safe_set(a, 'pcm_pc_pc_seff_pc_pc_AcquireAction', None)
    assert not _is_linked(a, 'pcm_pc_pc_seff_pc_pc_AcquireAction', b2)
    if hasattr(b2, 'PassiveResource380'):
        assert not _is_linked(b2, 'PassiveResource380', a)


def test_assoc_primaryBehaviour__RecoveryAction421_link_reassign_clear():
    a = pcm_pc_pc_seff_reliability_pc_pc_RecoveryAction()
    b1 = seff_reliability_pc_pc_RecoveryActionBehaviour()
    b2 = seff_reliability_pc_pc_RecoveryActionBehaviour()
    _safe_set(a, 'pcm_pc_pc_seff_reliability_pc_pc_RecoveryAction', b1)
    assert _is_linked(a, 'pcm_pc_pc_seff_reliability_pc_pc_RecoveryAction', b1)
    if hasattr(b1, 'seff_reliability_pc_pc_RecoveryActionBehaviour422'):
        assert _is_linked(b1, 'seff_reliability_pc_pc_RecoveryActionBehaviour422', a)
    _safe_set(a, 'pcm_pc_pc_seff_reliability_pc_pc_RecoveryAction', b2)
    assert _is_linked(a, 'pcm_pc_pc_seff_reliability_pc_pc_RecoveryAction', b2)
    if hasattr(b1, 'seff_reliability_pc_pc_RecoveryActionBehaviour422'):
        assert not _is_linked(b1, 'seff_reliability_pc_pc_RecoveryActionBehaviour422', a)
    if hasattr(b2, 'seff_reliability_pc_pc_RecoveryActionBehaviour422'):
        assert _is_linked(b2, 'seff_reliability_pc_pc_RecoveryActionBehaviour422', a)
    _safe_set(a, 'pcm_pc_pc_seff_reliability_pc_pc_RecoveryAction', None)
    assert not _is_linked(a, 'pcm_pc_pc_seff_reliability_pc_pc_RecoveryAction', b2)
    if hasattr(b2, 'seff_reliability_pc_pc_RecoveryActionBehaviour422'):
        assert not _is_linked(b2, 'seff_reliability_pc_pc_RecoveryActionBehaviour422', a)


def test_assoc_processingRate_ProcessingResourceSpecification471_link_reassign_clear():
    a = pcm_pc_pc_resourceenvironment_pc_pc_ProcessingResourceSpecification(MTTF=3.14, MTTR=3.14, numberOfReplicas=7, requiredByContainer=True)
    b1 = PCMRandomVariable()
    b2 = PCMRandomVariable()
    ...
    if hasattr(b1, 'PCMRandomVariable472'):
        assert _is_linked(b1, 'PCMRandomVariable472', a)
    ...
    if hasattr(b1, 'PCMRandomVariable472'):
        assert not _is_linked(b1, 'PCMRandomVariable472', a)
    if hasattr(b2, 'PCMRandomVariable472'):
        assert _is_linked(b2, 'PCMRandomVariable472', a)
    ...
    if hasattr(b2, 'PCMRandomVariable472'):
        assert not _is_linked(b2, 'PCMRandomVariable472', a)


def test_assoc_processingResourceSpecification_processingRate_PCMRandomVariable18_link_reassign_clear():
    a = pcm_pc_pc_core_pc_pc_PCMRandomVariable()
...
def test_assoc_processingResourceType__HardwareInducedFailureType315_link_reassign_clear():
    a = pcm_pc_pc_reliability_pc_pc_HardwareInducedFailureType()
    b1 = ProcessingResourceType()
    b2 = ProcessingResourceType()
...
def test_assoc_protocols__Interface227_link_reassign_clear():
    a = pcm_pc_pc_repository_pc_pc_Interface()
    b1 = Protocol()
    b2 = Protocol()
    _safe_set(a, 'pcm_pc_pc_repository_pc_pc_Interface228', {b1})
    assert _is_linked(a, 'pcm_pc_pc_repository_pc_pc_Interface228', b1)
    if hasattr(b1, 'Protocol'):
        assert _is_linked(b1, 'Protocol', a)
    _safe_set(a, 'pcm_pc_pc_repository_pc_pc_Interface228', {b2})
    assert _is_linked(a, 'pcm_pc_pc_repository_pc_pc_Interface228', b2)
    if hasattr(b1, 'Protocol'):
        assert not _is_linked(b1, 'Protocol', a)
    if hasattr(b2, 'Protocol'):
        assert _is_linked(b2, 'Protocol', a)
    _safe_set(a, 'pcm_pc_pc_repository_pc_pc_Interface228', set())
    assert not _is_linked(a, 'pcm_pc_pc_repository_pc_pc_Interface228', b2)
    if hasattr(b2, 'Protocol'):
        assert not _is_linked(b2, 'Protocol', a)


def test_assoc_providedRole_AssemblyConnector78_link_reassign_clear():
    a = pcm_pc_pc_composition_pc_pc_AssemblyConnector()
    b1 = OperationProvidedRole()
    b2 = OperationProvidedRole()
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_AssemblyConnector79', b1)
    assert _is_linked(a, 'pcm_pc_pc_composition_pc_pc_AssemblyConnector79', b1)
    if hasattr(b1, 'OperationProvidedRole80'):
        assert _is_linked(b1, 'OperationProvidedRole80', a)
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_AssemblyConnector79', b2)
    assert _is_linked(a, 'pcm_pc_pc_composition_pc_pc_AssemblyConnector79', b2)
    if hasattr(b1, 'OperationProvidedRole80'):
        assert not _is_linked(b1, 'OperationProvidedRole80', a)
    if hasattr(b2, 'OperationProvidedRole80'):
        assert _is_linked(b2, 'OperationProvidedRole80', a)
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_AssemblyConnector79', None)
    assert not _is_linked(a, 'pcm_pc_pc_composition_pc_pc_AssemblyConnector79', b2)
    if hasattr(b2, 'OperationProvidedRole80'):
        assert not _is_linked(b2, 'OperationProvidedRole80', a)


def test_assoc_providedRole_EntryLevelSystemCall163_link_reassign_clear():
    a = pcm_pc_pc_usagemodel_pc_pc_EntryLevelSystemCall(priority=7)
    b1 = OperationProvidedRole()
    b2 = OperationProvidedRole()
    _safe_set(a, 'pcm_pc_pc_usagemodel_pc_pc_EntryLevelSystemCall', b1)
    assert _is_linked(a, 'pcm_pc_pc_usagemodel_pc_pc_EntryLevelSystemCall', b1)
    if hasattr(b1, 'OperationProvidedRole164'):
        assert _is_linked(b1, 'OperationProvidedRole164', a)
    _safe_set(a, 'pcm_pc_pc_usagemodel_pc_pc_EntryLevelSystemCall', b2)
    assert _is_linked(a, 'pcm_pc_pc_usagemodel_pc_pc_EntryLevelSystemCall', b2)
    if hasattr(b1, 'OperationProvidedRole164'):
        assert not _is_linked(b1, 'OperationProvidedRole164', a)
    if hasattr(b2, 'OperationProvidedRole164'):
        assert _is_linked(b2, 'OperationProvidedRole164', a)
    _safe_set(a, 'pcm_pc_pc_usagemodel_pc_pc_EntryLevelSystemCall', None)
    assert not _is_linked(a, 'pcm_pc_pc_usagemodel_pc_pc_EntryLevelSystemCall', b2)
    if hasattr(b2, 'OperationProvidedRole164'):
        assert not _is_linked(b2, 'OperationProvidedRole164', a)


def test_assoc_providingAssemblyContext_AssemblyConnector75_link_reassign_clear():
    a = pcm_pc_pc_composition_pc_pc_AssemblyConnector()
    b1 = composition_pc_pc_AssemblyContext()
    b2 = composition_pc_pc_AssemblyContext()
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_AssemblyConnector76', b1)
    assert _is_linked(a, 'pcm_pc_pc_composition_pc_pc_AssemblyConnector76', b1)
    if hasattr(b1, 'composition_pc_pc_AssemblyContext77'):
        assert _is_linked(b1, 'composition_pc_pc_AssemblyContext77', a)
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_AssemblyConnector76', b2)
    assert _is_linked(a, 'pcm_pc_pc_composition_pc_pc_AssemblyConnector76', b2)
    if hasattr(b1, 'composition_pc_pc_AssemblyContext77'):
        assert not _is_linked(b1, 'composition_pc_pc_AssemblyContext77', a)
    if hasattr(b2, 'composition_pc_pc_AssemblyContext77'):
        assert _is_linked(b2, 'composition_pc_pc_AssemblyContext77', a)
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_AssemblyConnector76', None)
    assert not _is_linked(a, 'pcm_pc_pc_composition_pc_pc_AssemblyConnector76', b2)
    if hasattr(b2, 'composition_pc_pc_AssemblyContext77'):
        assert not _is_linked(b2, 'composition_pc_pc_AssemblyContext77', a)


def test_assoc_qosAnnotations_System449_link_reassign_clear():
    a = pcm_pc_pc_system_pc_pc_System()
    b1 = QoSAnnotations()
    b2 = QoSAnnotations()
    _safe_set(a, 'system_QoSAnnotations', {b1})
    assert _is_linked(a, 'system_QoSAnnotations', b1)
    if hasattr(b1, 'QoSAnnotations450'):
        assert _is_linked(b1, 'QoSAnnotations450', a)
    _safe_set(a, 'system_QoSAnnotations', {b2})
    assert _is_linked(a, 'system_QoSAnnotations', b2)
    if hasattr(b1, 'QoSAnnotations450'):
        assert not _is_linked(b1, 'QoSAnnotations450', a)
    if hasattr(b2, 'QoSAnnotations450'):
        assert _is_linked(b2, 'QoSAnnotations450', a)
    _safe_set(a, 'system_QoSAnnotations', set())
    assert not _is_linked(a, 'system_QoSAnnotations', b2)
    if hasattr(b2, 'QoSAnnotations450'):
        assert not _is_linked(b2, 'QoSAnnotations450', a)


def test_assoc_recoveryActionBehaviours__RecoveryAction423_link_reassign_clear():
    a = pcm_pc_pc_seff_reliability_pc_pc_RecoveryAction()
    b1 = seff_reliability_pc_pc_RecoveryActionBehaviour()
    b2 = seff_reliability_pc_pc_RecoveryActionBehaviour()
...
def test_assoc_recoveryAction__RecoveryActionBehaviour420_link_reassign_clear():
    a = pcm_pc_pc_seff_reliability_pc_pc_RecoveryActionBehaviour()
    b1 = seff_reliability_pc_pc_RecoveryAction()
    b2 = seff_reliability_pc_pc_RecoveryAction()
...
def test_assoc_repository__Interface230_link_reassign_clear():
    a = pcm_pc_pc_repository_pc_pc_Interface()
    b1 = Repository()
    b2 = Repository()
    _safe_set(a, 'interfaces__Repository', b1)
    assert _is_linked(a, 'interfaces__Repository', b1)
    if hasattr(b1, 'Repository231'):
        assert _is_linked(b1, 'Repository231', a)
    _safe_set(a, 'interfaces__Repository', b2)
    assert _is_linked(a, 'interfaces__Repository', b2)
    if hasattr(b1, 'Repository231'):
        assert not _is_linked(b1, 'Repository231', a)
    if hasattr(b2, 'Repository231'):
        assert _is_linked(b2, 'Repository231', a)
    _safe_set(a, 'interfaces__Repository', None)
    assert not _is_linked(a, 'interfaces__Repository', b2)
    if hasattr(b2, 'Repository231'):
        assert not _is_linked(b2, 'Repository231', a)


def test_assoc_requiredCharacterisations229_link_reassign_clear():
    a = pcm_pc_pc_repository_pc_pc_Interface()
...
def test_assoc_requiredResource_ParametricResourceDemand415_link_reassign_clear():
    a = pcm_pc_pc_seff_performance_pc_pc_ParametricResourceDemand()
    b1 = ProcessingResourceType()
    b2 = ProcessingResourceType()
    _safe_set(a, 'pcm_pc_pc_seff_performance_pc_pc_ParametricResourceDemand', b1)
    assert _is_linked(a, 'pcm_pc_pc_seff_performance_pc_pc_ParametricResourceDemand', b1)
    if hasattr(b1, 'ProcessingResourceType416'):
        assert _is_linked(b1, 'ProcessingResourceType416', a)
    _safe_set(a, 'pcm_pc_pc_seff_performance_pc_pc_ParametricResourceDemand', b2)
    assert _is_linked(a, 'pcm_pc_pc_seff_performance_pc_pc_ParametricResourceDemand', b2)
    if hasattr(b1, 'ProcessingResourceType416'):
        assert not _is_linked(b1, 'ProcessingResourceType416', a)
    if hasattr(b2, 'ProcessingResourceType416'):
        assert _is_linked(b2, 'ProcessingResourceType416', a)
    _safe_set(a, 'pcm_pc_pc_seff_performance_pc_pc_ParametricResourceDemand', None)
    assert not _is_linked(a, 'pcm_pc_pc_seff_performance_pc_pc_ParametricResourceDemand', b2)
    if hasattr(b2, 'ProcessingResourceType416'):
        assert not _is_linked(b2, 'ProcessingResourceType416', a)


def test_assoc_requiredRole_AssemblyConnector81_link_reassign_clear():
    a = pcm_pc_pc_composition_pc_pc_AssemblyConnector()
    b1 = OperationRequiredRole()
    b2 = OperationRequiredRole()
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_AssemblyConnector82', b1)
    assert _is_linked(a, 'pcm_pc_pc_composition_pc_pc_AssemblyConnector82', b1)
    if hasattr(b1, 'OperationRequiredRole83'):
        assert _is_linked(b1, 'OperationRequiredRole83', a)
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_AssemblyConnector82', b2)
    assert _is_linked(a, 'pcm_pc_pc_composition_pc_pc_AssemblyConnector82', b2)
    if hasattr(b1, 'OperationRequiredRole83'):
        assert not _is_linked(b1, 'OperationRequiredRole83', a)
    if hasattr(b2, 'OperationRequiredRole83'):
        assert _is_linked(b2, 'OperationRequiredRole83', a)
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_AssemblyConnector82', None)
    assert not _is_linked(a, 'pcm_pc_pc_composition_pc_pc_AssemblyConnector82', b2)
    if hasattr(b2, 'OperationRequiredRole83'):
        assert not _is_linked(b2, 'OperationRequiredRole83', a)


def test_assoc_requiredRole__InfrastructureCall401_link_reassign_clear():
    a = pcm_pc_pc_seff_performance_pc_pc_InfrastructureCall()
    b1 = InfrastructureRequiredRole()
    b2 = InfrastructureRequiredRole()
    _safe_set(a, 'pcm_pc_pc_seff_performance_pc_pc_InfrastructureCall402', b1)
    assert _is_linked(a, 'pcm_pc_pc_seff_performance_pc_pc_InfrastructureCall402', b1)
    if hasattr(b1, 'InfrastructureRequiredRole403'):
        assert _is_linked(b1, 'InfrastructureRequiredRole403', a)
    _safe_set(a, 'pcm_pc_pc_seff_performance_pc_pc_InfrastructureCall402', b2)
    assert _is_linked(a, 'pcm_pc_pc_seff_performance_pc_pc_InfrastructureCall402', b2)
    if hasattr(b1, 'InfrastructureRequiredRole403'):
        assert not _is_linked(b1, 'InfrastructureRequiredRole403', a)
    if hasattr(b2, 'InfrastructureRequiredRole403'):
        assert _is_linked(b2, 'InfrastructureRequiredRole403', a)
    _safe_set(a, 'pcm_pc_pc_seff_performance_pc_pc_InfrastructureCall402', None)
    assert not _is_linked(a, 'pcm_pc_pc_seff_performance_pc_pc_InfrastructureCall402', b2)
    if hasattr(b2, 'InfrastructureRequiredRole403'):
        assert not _is_linked(b2, 'InfrastructureRequiredRole403', a)


def test_assoc_requiringAssemblyContext_AssemblyConnector73_link_reassign_clear():
    a = pcm_pc_pc_composition_pc_pc_AssemblyConnector()
    b1 = composition_pc_pc_AssemblyContext()
    b2 = composition_pc_pc_AssemblyContext()
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_AssemblyConnector', b1)
    assert _is_linked(a, 'pcm_pc_pc_composition_pc_pc_AssemblyConnector', b1)
    if hasattr(b1, 'composition_pc_pc_AssemblyContext74'):
        assert _is_linked(b1, 'composition_pc_pc_AssemblyContext74', a)
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_AssemblyConnector', b2)
    assert _is_linked(a, 'pcm_pc_pc_composition_pc_pc_AssemblyConnector', b2)
    if hasattr(b1, 'composition_pc_pc_AssemblyContext74'):
        assert not _is_linked(b1, 'composition_pc_pc_AssemblyContext74', a)
    if hasattr(b2, 'composition_pc_pc_AssemblyContext74'):
        assert _is_linked(b2, 'composition_pc_pc_AssemblyContext74', a)
    _safe_set(a, 'pcm_pc_pc_composition_pc_pc_AssemblyConnector', None)
    assert not _is_linked(a, 'pcm_pc_pc_composition_pc_pc_AssemblyConnector', b2)
    if hasattr(b2, 'composition_pc_pc_AssemblyContext74'):
        assert not _is_linked(b2, 'composition_pc_pc_AssemblyContext74', a)


def test_assoc_resourceCall__PCMRandomVariable7_link_reassign_clear():
    a = pcm_pc_pc_core_pc_pc_PCMRandomVariable()
    b1 = seff_performance_pc_pc_ResourceCall()
    b2 = seff_performance_pc_pc_ResourceCall()
...
def test_assoc_resourceContainer_AllocationContext483_link_reassign_clear():
    a = pcm_pc_pc_allocation_pc_pc_AllocationContext()
    b1 = ResourceContainer()
    b2 = ResourceContainer()
    _safe_set(a, 'pcm_pc_pc_allocation_pc_pc_AllocationContext', b1)
    assert _is_linked(a, 'pcm_pc_pc_allocation_pc_pc_AllocationContext', b1)
    if hasattr(b1, 'ResourceContainer484'):
        assert _is_linked(b1, 'ResourceContainer484', a)
    _safe_set(a, 'pcm_pc_pc_allocation_pc_pc_AllocationContext', b2)
    assert _is_linked(a, 'pcm_pc_pc_allocation_pc_pc_AllocationContext', b2)
    if hasattr(b1, 'ResourceContainer484'):
        assert not _is_linked(b1, 'ResourceContainer484', a)
    if hasattr(b2, 'ResourceContainer484'):
        assert _is_linked(b2, 'ResourceContainer484', a)
    _safe_set(a, 'pcm_pc_pc_allocation_pc_pc_AllocationContext', None)
    assert not _is_linked(a, 'pcm_pc_pc_allocation_pc_pc_AllocationContext', b2)
    if hasattr(b2, 'ResourceContainer484'):
        assert not _is_linked(b2, 'ResourceContainer484', a)


def test_assoc_resourceContainer_ProcessingResourceSpecification473_link_reassign_clear():
    a = pcm_pc_pc_resourceenvironment_pc_pc_ProcessingResourceSpecification(MTTF=3.14, MTTR=3.14, numberOfReplicas=7, requiredByContainer=True)
    b1 = ResourceContainer()
    b2 = ResourceContainer()
    ...
    if hasattr(b1, 'ResourceContainer474'):
        assert _is_linked(b1, 'ResourceContainer474', a)
    ...
    if hasattr(b1, 'ResourceContainer474'):
        assert not _is_linked(b1, 'ResourceContainer474', a)
    if hasattr(b2, 'ResourceContainer474'):
        assert _is_linked(b2, 'ResourceContainer474', a)
    ...
    if hasattr(b2, 'ResourceContainer474'):
        assert not _is_linked(b2, 'ResourceContainer474', a)


def test_assoc_resourceInterface__ResourceSignature281_link_reassign_clear():
    a = pcm_pc_pc_resourcetype_pc_pc_ResourceSignature(resourceServiceId=7)
    ...
    if hasattr(b1, 'ResourceInterface282'):
        assert _is_linked(b1, 'ResourceInterface282', a)
    _safe_set(a, 'resourceSignatures__ResourceInterface', b2)
    assert _is_linked(a, 'resourceSignatures__ResourceInterface', b2)
    if hasattr(b1, 'ResourceInterface282'):
        assert not _is_linked(b1, 'ResourceInterface282', a)
    if hasattr(b2, 'ResourceInterface282'):
        assert _is_linked(b2, 'ResourceInterface282', a)
    _safe_set(a, 'resourceSignatures__ResourceInterface', None)
    assert not _is_linked(a, 'resourceSignatures__ResourceInterface', b2)
    if hasattr(b2, 'ResourceInterface282'):
        assert not _is_linked(b2, 'ResourceInterface282', a)


def test_assoc_resourceRequiredDelegationConnectors_ComposedStructure32_link_reassign_clear():
    a = pcm_pc_pc_composition_pc_pc_ComposedStructure()
    b1 = composition_pc_pc_ResourceRequiredDelegationConnector()
    b2 = composition_pc_pc_ResourceRequiredDelegationConnector()
...
def test_assoc_resourceRequiredRole__ResourceCall406_link_reassign_clear():
    a = pcm_pc_pc_seff_performance_pc_pc_ResourceCall()
    b1 = entity_pc_pc_ResourceRequiredRole()
    b2 = entity_pc_pc_ResourceRequiredRole()
    _safe_set(a, 'pcm_pc_pc_seff_performance_pc_pc_ResourceCall', b1)
    assert _is_linked(a, 'pcm_pc_pc_seff_performance_pc_pc_ResourceCall', b1)
    if hasattr(b1, 'entity_pc_pc_ResourceRequiredRole407'):
        assert _is_linked(b1, 'entity_pc_pc_ResourceRequiredRole407', a)
    _safe_set(a, 'pcm_pc_pc_seff_performance_pc_pc_ResourceCall', b2)
    assert _is_linked(a, 'pcm_pc_pc_seff_performance_pc_pc_ResourceCall', b2)
    if hasattr(b1, 'entity_pc_pc_ResourceRequiredRole407'):
        assert not _is_linked(b1, 'entity_pc_pc_ResourceRequiredRole407', a)
    if hasattr(b2, 'entity_pc_pc_ResourceRequiredRole407'):
        assert _is_linked(b2, 'entity_pc_pc_ResourceRequiredRole407', a)
    _safe_set(a, 'pcm_pc_pc_seff_performance_pc_pc_ResourceCall', None)
    assert not _is_linked(a, 'pcm_pc_pc_seff_performance_pc_pc_ResourceCall', b2)
    if hasattr(b2, 'entity_pc_pc_ResourceRequiredRole407'):
        assert not _is_linked(b2, 'entity_pc_pc_ResourceRequiredRole407', a)


def test_assoc_resourceSignature__Parameter216_link_reassign_clear():
    a = pcm_pc_pc_repository_pc_pc_Parameter(modifier__Parameter="sample_text", parameterName="sample_text")
...
def test_assoc_returnType__OperationSignature256_link_reassign_clear():
    a = pcm_pc_pc_repository_pc_pc_OperationSignature()
    b1 = DataType()
    b2 = DataType()
    _safe_set(a, 'pcm_pc_pc_repository_pc_pc_OperationSignature', b1)
    assert _is_linked(a, 'pcm_pc_pc_repository_pc_pc_OperationSignature', b1)
    if hasattr(b1, 'DataType257'):
        assert _is_linked(b1, 'DataType257', a)
    _safe_set(a, 'pcm_pc_pc_repository_pc_pc_OperationSignature', b2)
    assert _is_linked(a, 'pcm_pc_pc_repository_pc_pc_OperationSignature', b2)
    if hasattr(b1, 'DataType257'):
        assert not _is_linked(b1, 'DataType257', a)
    if hasattr(b2, 'DataType257'):
        assert _is_linked(b2, 'DataType257', a)
    _safe_set(a, 'pcm_pc_pc_repository_pc_pc_OperationSignature', None)
    assert not _is_linked(a, 'pcm_pc_pc_repository_pc_pc_OperationSignature', b2)
    if hasattr(b2, 'DataType257'):
        assert not _is_linked(b2, 'DataType257', a)


def test_assoc_role_ExternalService374_link_reassign_clear():
    a = pcm_pc_pc_seff_pc_pc_ExternalCallAction(retryCount=7)
    b1 = OperationRequiredRole()
    b2 = OperationRequiredRole()
    _safe_set(a, 'pcm_pc_pc_seff_pc_pc_ExternalCallAction375', b1)
    assert _is_linked(a, 'pcm_pc_pc_seff_pc_pc_ExternalCallAction375', b1)
    if hasattr(b1, 'OperationRequiredRole376'):
        assert _is_linked(b1, 'OperationRequiredRole376', a)
    _safe_set(a, 'pcm_pc_pc_seff_pc_pc_ExternalCallAction375', b2)
    assert _is_linked(a, 'pcm_pc_pc_seff_pc_pc_ExternalCallAction375', b2)
    if hasattr(b1, 'OperationRequiredRole376'):
        assert not _is_linked(b1, 'OperationRequiredRole376', a)
    if hasattr(b2, 'OperationRequiredRole376'):
        assert _is_linked(b2, 'OperationRequiredRole376', a)
    _safe_set(a, 'pcm_pc_pc_seff_pc_pc_ExternalCallAction375', None)
    assert not _is_linked(a, 'pcm_pc_pc_seff_pc_pc_ExternalCallAction375', b2)
    if hasattr(b2, 'OperationRequiredRole376'):
        assert not _is_linked(b2, 'OperationRequiredRole376', a)


def test_assoc_schedulingPolicy466_link_reassign_clear():
    a = pcm_pc_pc_resourceenvironment_pc_pc_ProcessingResourceSpecification(MTTF=3.14, MTTR=3.14, numberOfReplicas=7, requiredByContainer=True)
    b1 = SchedulingPolicy()
    b2 = SchedulingPolicy()
    _safe_set(a, 'pcm_pc_pc_resourceenvironment_pc_pc_ProcessingResourceSpecification', b1)
    assert _is_linked(a, 'pcm_pc_pc_resourceenvironment_pc_pc_ProcessingResourceSpecification', b1)
    if hasattr(b1, 'SchedulingPolicy467'):
        assert _is_linked(b1, 'SchedulingPolicy467', a)
    _safe_set(a, 'pcm_pc_pc_resourceenvironment_pc_pc_ProcessingResourceSpecification', b2)
    assert _is_linked(a, 'pcm_pc_pc_resourceenvironment_pc_pc_ProcessingResourceSpecification', b2)
    if hasattr(b1, 'SchedulingPolicy467'):
        assert not _is_linked(b1, 'SchedulingPolicy467', a)
    if hasattr(b2, 'SchedulingPolicy467'):
        assert _is_linked(b2, 'SchedulingPolicy467', a)
    _safe_set(a, 'pcm_pc_pc_resourceenvironment_pc_pc_ProcessingResourceSpecification', None)
    assert not _is_linked(a, 'pcm_pc_pc_resourceenvironment_pc_pc_ProcessingResourceSpecification', b2)
    if hasattr(b2, 'SchedulingPolicy467'):
        assert not _is_linked(b2, 'SchedulingPolicy467', a)


def test_assoc_serviceEffectSpecifications__BasicComponent202_link_reassign_clear():
    a = pcm_pc_pc_repository_pc_pc_BasicComponent()
...
def test_assoc_signature__InfrastructureCall396_link_reassign_clear():
    a = pcm_pc_pc_seff_performance_pc_pc_InfrastructureCall()
    b1 = InfrastructureSignature()
    b2 = InfrastructureSignature()
    _safe_set(a, 'pcm_pc_pc_seff_performance_pc_pc_InfrastructureCall', b1)
    assert _is_linked(a, 'pcm_pc_pc_seff_performance_pc_pc_InfrastructureCall', b1)
    if hasattr(b1, 'InfrastructureSignature397'):
        assert _is_linked(b1, 'InfrastructureSignature397', a)
    _safe_set(a, 'pcm_pc_pc_seff_performance_pc_pc_InfrastructureCall', b2)
    assert _is_linked(a, 'pcm_pc_pc_seff_performance_pc_pc_InfrastructureCall', b2)
    if hasattr(b1, 'InfrastructureSignature397'):
        assert not _is_linked(b1, 'InfrastructureSignature397', a)
    if hasattr(b2, 'InfrastructureSignature397'):
        assert _is_linked(b2, 'InfrastructureSignature397', a)
    _safe_set(a, 'pcm_pc_pc_seff_performance_pc_pc_InfrastructureCall', None)
    assert not _is_linked(a, 'pcm_pc_pc_seff_performance_pc_pc_InfrastructureCall', b2)
    if hasattr(b2, 'InfrastructureSignature397'):
        assert not _is_linked(b2, 'InfrastructureSignature397', a)


def test_assoc_signature__ResourceCall408_link_reassign_clear():
    a = pcm_pc_pc_seff_performance_pc_pc_ResourceCall()
    b1 = ResourceSignature()
    b2 = ResourceSignature()
    _safe_set(a, 'pcm_pc_pc_seff_performance_pc_pc_ResourceCall409', b1)
    assert _is_linked(a, 'pcm_pc_pc_seff_performance_pc_pc_ResourceCall409', b1)
    if hasattr(b1, 'ResourceSignature410'):
        assert _is_linked(b1, 'ResourceSignature410', a)
    _safe_set(a, 'pcm_pc_pc_seff_performance_pc_pc_ResourceCall409', b2)
    assert _is_linked(a, 'pcm_pc_pc_seff_performance_pc_pc_ResourceCall409', b2)
    if hasattr(b1, 'ResourceSignature410'):
        assert not _is_linked(b1, 'ResourceSignature410', a)
    if hasattr(b2, 'ResourceSignature410'):
        assert _is_linked(b2, 'ResourceSignature410', a)
    _safe_set(a, 'pcm_pc_pc_seff_performance_pc_pc_ResourceCall409', None)
    assert not _is_linked(a, 'pcm_pc_pc_seff_performance_pc_pc_ResourceCall409', b2)
    if hasattr(b2, 'ResourceSignature410'):
        assert not _is_linked(b2, 'ResourceSignature410', a)


def test_assoc_signatures__OperationInterface258_link_reassign_clear():
    a = pcm_pc_pc_repository_pc_pc_OperationInterface()
    b1 = OperationSignature()
    b2 = OperationSignature()
    _safe_set(a, 'interface__OperationSignature', {b1})
    assert _is_linked(a, 'interface__OperationSignature', b1)
    if hasattr(b1, 'OperationSignature259'):
        assert _is_linked(b1, 'OperationSignature259', a)
    _safe_set(a, 'interface__OperationSignature', {b2})
    assert _is_linked(a, 'interface__OperationSignature', b2)
    if hasattr(b1, 'OperationSignature259'):
        assert not _is_linked(b1, 'OperationSignature259', a)
    if hasattr(b2, 'OperationSignature259'):
        assert _is_linked(b2, 'OperationSignature259', a)
    _safe_set(a, 'interface__OperationSignature', set())
    assert not _is_linked(a, 'interface__OperationSignature', b2)
    if hasattr(b2, 'OperationSignature259'):
        assert not _is_linked(b2, 'OperationSignature259', a)


def test_assoc_softwareInducedFailureType__InternalFailureOccurrenceDescription318_link_reassign_clear():
    a = pcm_pc_pc_reliability_pc_pc_InternalFailureOccurrenceDescription()
...
def test_assoc_specification_ParametericResourceDemand413_link_reassign_clear():
    a = pcm_pc_pc_seff_performance_pc_pc_ParametricResourceDemand()
    b1 = PCMRandomVariable()
    b2 = PCMRandomVariable()
...
def test_assoc_specification_VariableCharacterisation311_link_reassign_clear():
    a = pcm_pc_pc_parameter_pc_pc_VariableCharacterisation(type="sample_text")
    b1 = PCMRandomVariable()
    b2 = PCMRandomVariable()
    _safe_set(a, 'variableCharacterisation_Specification', b1)
    assert _is_linked(a, 'variableCharacterisation_Specification', b1)
    if hasattr(b1, 'PCMRandomVariable312'):
        assert _is_linked(b1, 'PCMRandomVariable312', a)
    _safe_set(a, 'variableCharacterisation_Specification', b2)
    assert _is_linked(a, 'variableCharacterisation_Specification', b2)
    if hasattr(b1, 'PCMRandomVariable312'):
        assert not _is_linked(b1, 'PCMRandomVariable312', a)
    if hasattr(b2, 'PCMRandomVariable312'):
        assert _is_linked(b2, 'PCMRandomVariable312', a)
    _safe_set(a, 'variableCharacterisation_Specification', None)
    assert not _is_linked(a, 'variableCharacterisation_Specification', b2)
    if hasattr(b2, 'PCMRandomVariable312'):
        assert not _is_linked(b2, 'PCMRandomVariable312', a)


def test_assoc_specifiedExecutionTime_PCMRandomVariable11_link_reassign_clear():
    a = pcm_pc_pc_core_pc_pc_PCMRandomVariable()
    b1 = qos_performance_pc_pc_SpecifiedExecutionTime()
    b2 = qos_performance_pc_pc_SpecifiedExecutionTime()
...
def test_assoc_specifiedOutputParameterAbstractions_QoSAnnotations431_link_reassign_clear():
    a = pcm_pc_pc_qosannotations_pc_pc_QoSAnnotations()
    ...
    if hasattr(b1, 'SpecifiedOutputParameterAbstraction432'):
        assert _is_linked(b1, 'SpecifiedOutputParameterAbstraction432', a)
    ...
    if hasattr(b1, 'SpecifiedOutputParameterAbstraction432'):
        assert not _is_linked(b1, 'SpecifiedOutputParameterAbstraction432', a)
    if hasattr(b2, 'SpecifiedOutputParameterAbstraction432'):
        assert _is_linked(b2, 'SpecifiedOutputParameterAbstraction432', a)
    ...
    if hasattr(b2, 'SpecifiedOutputParameterAbstraction432'):
        assert not _is_linked(b2, 'SpecifiedOutputParameterAbstraction432', a)


def test_assoc_specifiedQoSAnnotations_QoSAnnotations434_link_reassign_clear():
    a = pcm_pc_pc_qosannotations_pc_pc_QoSAnnotations()
...
def test_assoc_specifiedReliabilityAnnotation__ExternalFailureOccurrenceDescription320_link_reassign_clear():
    a = pcm_pc_pc_reliability_pc_pc_ExternalFailureOccurrenceDescription()
    b1 = qos_reliability_pc_pc_SpecifiedReliabilityAnnotation()
    b2 = qos_reliability_pc_pc_SpecifiedReliabilityAnnotation()
...
def test_assoc_steps_Behaviour340_link_reassign_clear():
    ...
    if hasattr(b2, 'AbstractAction341'):
        assert not _is_linked(b2, 'AbstractAction341', a)


def test_assoc_system_Allocation493_link_reassign_clear():
    a = pcm_pc_pc_allocation_pc_pc_Allocation()
    b1 = System()
    b2 = System()
    _safe_set(a, 'pcm_pc_pc_allocation_pc_pc_Allocation494', b1)
    assert _is_linked(a, 'pcm_pc_pc_allocation_pc_pc_Allocation494', b1)
    if hasattr(b1, 'System495'):
        assert _is_linked(b1, 'System495', a)
    _safe_set(a, 'pcm_pc_pc_allocation_pc_pc_Allocation494', b2)
    assert _is_linked(a, 'pcm_pc_pc_allocation_pc_pc_Allocation494', b2)
    if hasattr(b1, 'System495'):
        assert not _is_linked(b1, 'System495', a)
    if hasattr(b2, 'System495'):
        assert _is_linked(b2, 'System495', a)
    _safe_set(a, 'pcm_pc_pc_allocation_pc_pc_Allocation494', None)
    assert not _is_linked(a, 'pcm_pc_pc_allocation_pc_pc_Allocation494', b2)
    if hasattr(b2, 'System495'):
        assert not _is_linked(b2, 'System495', a)


def test_assoc_system_QoSAnnotations433_link_reassign_clear():
    a = pcm_pc_pc_qosannotations_pc_pc_QoSAnnotations()
    b1 = System()
    b2 = System()
...
def test_assoc_targetResourceEnvironment_Allocation491_link_reassign_clear():
    a = pcm_pc_pc_allocation_pc_pc_Allocation()
    b1 = ResourceEnvironment()
    b2 = ResourceEnvironment()
    _safe_set(a, 'pcm_pc_pc_allocation_pc_pc_Allocation', b1)
    assert _is_linked(a, 'pcm_pc_pc_allocation_pc_pc_Allocation', b1)
    if hasattr(b1, 'ResourceEnvironment492'):
        assert _is_linked(b1, 'ResourceEnvironment492', a)
    _safe_set(a, 'pcm_pc_pc_allocation_pc_pc_Allocation', b2)
    assert _is_linked(a, 'pcm_pc_pc_allocation_pc_pc_Allocation', b2)
    if hasattr(b1, 'ResourceEnvironment492'):
        assert not _is_linked(b1, 'ResourceEnvironment492', a)
    if hasattr(b2, 'ResourceEnvironment492'):
        assert _is_linked(b2, 'ResourceEnvironment492', a)
    _safe_set(a, 'pcm_pc_pc_allocation_pc_pc_Allocation', None)
    assert not _is_linked(a, 'pcm_pc_pc_allocation_pc_pc_Allocation', b2)
    if hasattr(b2, 'ResourceEnvironment492'):
        assert not _is_linked(b2, 'ResourceEnvironment492', a)


def test_assoc_thinkTime_ClosedWorkload196_link_reassign_clear():
    a = pcm_pc_pc_usagemodel_pc_pc_ClosedWorkload(population=7)
    b1 = PCMRandomVariable()
    b2 = PCMRandomVariable()
...
def test_assoc_throughput_CommunicationLinkResourceSpecification481_link_reassign_clear():
    a = pcm_pc_pc_resourceenvironment_pc_pc_CommunicationLinkResourceSpecification(failureProbability=3.14)
    b1 = PCMRandomVariable()
    b2 = PCMRandomVariable()
...
def test_assoc_usageScenario_SenarioBehaviour176_link_reassign_clear():
    a = pcm_pc_pc_usagemodel_pc_pc_ScenarioBehaviour()
    b1 = UsageScenario()
    b2 = UsageScenario()
    _safe_set(a, 'scenarioBehaviour_UsageScenario', b1)
    assert _is_linked(a, 'scenarioBehaviour_UsageScenario', b1)
    if hasattr(b1, 'UsageScenario177'):
        assert _is_linked(b1, 'UsageScenario177', a)
    _safe_set(a, 'scenarioBehaviour_UsageScenario', b2)
    assert _is_linked(a, 'scenarioBehaviour_UsageScenario', b2)
    if hasattr(b1, 'UsageScenario177'):
        assert not _is_linked(b1, 'UsageScenario177', a)
    if hasattr(b2, 'UsageScenario177'):
        assert _is_linked(b2, 'UsageScenario177', a)
    _safe_set(a, 'scenarioBehaviour_UsageScenario', None)
    assert not _is_linked(a, 'scenarioBehaviour_UsageScenario', b2)
    if hasattr(b2, 'UsageScenario177'):
        assert not _is_linked(b2, 'UsageScenario177', a)


def test_assoc_variableCharacterisation_Specification5_link_reassign_clear():
    a = pcm_pc_pc_core_pc_pc_PCMRandomVariable()
...
composition_pc_pc_AssemblyContext_strategy = st.builds(composition_pc_pc_AssemblyContext)
...
composition_pc_pc_AssemblyEventConnector_strategy = st.builds(composition_pc_pc_AssemblyEventConnector)
...
composition_pc_pc_ComposedStructure_strategy = st.builds(composition_pc_pc_ComposedStructure)
...
composition_pc_pc_Connector_strategy = st.builds(composition_pc_pc_Connector)
...
composition_pc_pc_EventChannel_strategy = st.builds(composition_pc_pc_EventChannel)
...
composition_pc_pc_EventChannelSinkConnector_strategy = st.builds(composition_pc_pc_EventChannelSinkConnector)
...
composition_pc_pc_EventChannelSourceConnector_strategy = st.builds(composition_pc_pc_EventChannelSourceConnector)
...
composition_pc_pc_ResourceRequiredDelegationConnector_strategy = st.builds(composition_pc_pc_ResourceRequiredDelegationConnector)
...
entity_pc_pc_ComposedProvidingRequiringEntity_strategy = st.builds(entity_pc_pc_ComposedProvidingRequiringEntity)
...
entity_pc_pc_Entity_strategy = st.builds(entity_pc_pc_Entity)
...
entity_pc_pc_InterfaceProvidingEntity_strategy = st.builds(entity_pc_pc_InterfaceProvidingEntity)
...
entity_pc_pc_InterfaceProvidingRequiringEntity_strategy = st.builds(entity_pc_pc_InterfaceProvidingRequiringEntity)
...
entity_pc_pc_InterfaceRequiringEntity_strategy = st.builds(entity_pc_pc_InterfaceRequiringEntity)
...
entity_pc_pc_NamedElement_strategy = st.builds(entity_pc_pc_NamedElement)
...
entity_pc_pc_ResourceInterfaceProvidingEntity_strategy = st.builds(entity_pc_pc_ResourceInterfaceProvidingEntity)
...
entity_pc_pc_ResourceInterfaceRequiringEntity_strategy = st.builds(entity_pc_pc_ResourceInterfaceRequiringEntity)
...
entity_pc_pc_ResourceProvidedRole_strategy = st.builds(entity_pc_pc_ResourceProvidedRole)
...
entity_pc_pc_ResourceRequiredRole_strategy = st.builds(entity_pc_pc_ResourceRequiredRole)
...
parameter_pc_pc_pcm_pc_pc_AbstractNamedReference_strategy = st.builds(parameter_pc_pc_pcm_pc_pc_AbstractNamedReference)
...
pcm_pc_pc_DummyClass_strategy = st.builds(pcm_pc_pc_DummyClass)
...
pcm_pc_pc_EObject_strategy = st.builds(pcm_pc_pc_EObject)
...
pcm_pc_pc_Pointcut_strategy = st.builds(pcm_pc_pc_Pointcut)
...
pcm_pc_pc_PointcutPointcut_strategy = st.builds(pcm_pc_pc_PointcutPointcut)
...
pcm_pc_pc_allocation_pc_pc_Allocation_strategy = st.builds(pcm_pc_pc_allocation_pc_pc_Allocation)
...
pcm_pc_pc_allocation_pc_pc_AllocationContext_strategy = st.builds(pcm_pc_pc_allocation_pc_pc_AllocationContext)
...
pcm_pc_pc_completions_pc_pc_Completion_strategy = st.builds(pcm_pc_pc_completions_pc_pc_Completion)
...
pcm_pc_pc_completions_pc_pc_CompletionRepository_strategy = st.builds(pcm_pc_pc_completions_pc_pc_CompletionRepository)
...
pcm_pc_pc_completions_pc_pc_DelegatingExternalCallAction_strategy = st.builds(pcm_pc_pc_completions_pc_pc_DelegatingExternalCallAction)
...
pcm_pc_pc_completions_pc_pc_NetworkDemandParametricResourceDemand_strategy = st.builds(pcm_pc_pc_completions_pc_pc_NetworkDemandParametricResourceDemand)
...
pcm_pc_pc_composition_pc_pc_AssemblyConnector_strategy = st.builds(pcm_pc_pc_composition_pc_pc_AssemblyConnector)
...
pcm_pc_pc_composition_pc_pc_AssemblyContext_strategy = st.builds(pcm_pc_pc_composition_pc_pc_AssemblyContext)
...
pcm_pc_pc_composition_pc_pc_AssemblyEventConnector_strategy = st.builds(pcm_pc_pc_composition_pc_pc_AssemblyEventConnector)
...
pcm_pc_pc_composition_pc_pc_AssemblyInfrastructureConnector_strategy = st.builds(pcm_pc_pc_composition_pc_pc_AssemblyInfrastructureConnector)
...
pcm_pc_pc_composition_pc_pc_ComposedStructure_strategy = st.builds(pcm_pc_pc_composition_pc_pc_ComposedStructure)
...
pcm_pc_pc_composition_pc_pc_Connector_strategy = st.builds(pcm_pc_pc_composition_pc_pc_Connector)
...
pcm_pc_pc_composition_pc_pc_DelegationConnector_strategy = st.builds(pcm_pc_pc_composition_pc_pc_DelegationConnector)
...
pcm_pc_pc_composition_pc_pc_EventChannel_strategy = st.builds(pcm_pc_pc_composition_pc_pc_EventChannel)
...
pcm_pc_pc_composition_pc_pc_EventChannelSinkConnector_strategy = st.builds(pcm_pc_pc_composition_pc_pc_EventChannelSinkConnector)
...
pcm_pc_pc_composition_pc_pc_EventChannelSourceConnector_strategy = st.builds(pcm_pc_pc_composition_pc_pc_EventChannelSourceConnector)
...
pcm_pc_pc_composition_pc_pc_ProvidedDelegationConnector_strategy = st.builds(pcm_pc_pc_composition_pc_pc_ProvidedDelegationConnector)
...
pcm_pc_pc_composition_pc_pc_ProvidedInfrastructureDelegationConnector_strategy = st.builds(pcm_pc_pc_composition_pc_pc_ProvidedInfrastructureDelegationConnector)
...
pcm_pc_pc_composition_pc_pc_RequiredDelegationConnector_strategy = st.builds(pcm_pc_pc_composition_pc_pc_RequiredDelegationConnector)
...
pcm_pc_pc_composition_pc_pc_RequiredInfrastructureDelegationConnector_strategy = st.builds(pcm_pc_pc_composition_pc_pc_RequiredInfrastructureDelegationConnector)
...
pcm_pc_pc_composition_pc_pc_RequiredResourceDelegationConnector_strategy = st.builds(pcm_pc_pc_composition_pc_pc_RequiredResourceDelegationConnector)
...
pcm_pc_pc_composition_pc_pc_ResourceRequiredDelegationConnector_strategy = st.builds(pcm_pc_pc_composition_pc_pc_ResourceRequiredDelegationConnector)
...
pcm_pc_pc_composition_pc_pc_SinkDelegationConnector_strategy = st.builds(pcm_pc_pc_composition_pc_pc_SinkDelegationConnector)
...
pcm_pc_pc_composition_pc_pc_SourceDelegationConnector_strategy = st.builds(pcm_pc_pc_composition_pc_pc_SourceDelegationConnector)
...
pcm_pc_pc_core_pc_pc_PCMRandomVariable_strategy = st.builds(pcm_pc_pc_core_pc_pc_PCMRandomVariable)
...
pcm_pc_pc_entity_pc_pc_ComposedProvidingRequiringEntity_strategy = st.builds(pcm_pc_pc_entity_pc_pc_ComposedProvidingRequiringEntity)
...
pcm_pc_pc_entity_pc_pc_Entity_strategy = st.builds(pcm_pc_pc_entity_pc_pc_Entity)
...
pcm_pc_pc_entity_pc_pc_InterfaceProvidingEntity_strategy = st.builds(pcm_pc_pc_entity_pc_pc_InterfaceProvidingEntity)
...
pcm_pc_pc_entity_pc_pc_InterfaceProvidingRequiringEntity_strategy = st.builds(pcm_pc_pc_entity_pc_pc_InterfaceProvidingRequiringEntity)
...
pcm_pc_pc_entity_pc_pc_InterfaceRequiringEntity_strategy = st.builds(pcm_pc_pc_entity_pc_pc_InterfaceRequiringEntity)
...
pcm_pc_pc_entity_pc_pc_NamedElement_strategy = st.builds(pcm_pc_pc_entity_pc_pc_NamedElement, entityName=safe_text)
...
pcm_pc_pc_entity_pc_pc_ResourceInterfaceProvidingEntity_strategy = st.builds(pcm_pc_pc_entity_pc_pc_ResourceInterfaceProvidingEntity)
...
pcm_pc_pc_entity_pc_pc_ResourceInterfaceProvidingRequiringEntity_strategy = st.builds(pcm_pc_pc_entity_pc_pc_ResourceInterfaceProvidingRequiringEntity)
...
pcm_pc_pc_entity_pc_pc_ResourceInterfaceRequiringEntity_strategy = st.builds(pcm_pc_pc_entity_pc_pc_ResourceInterfaceRequiringEntity)
...
pcm_pc_pc_entity_pc_pc_ResourceProvidedRole_strategy = st.builds(pcm_pc_pc_entity_pc_pc_ResourceProvidedRole)
...
pcm_pc_pc_entity_pc_pc_ResourceRequiredRole_strategy = st.builds(pcm_pc_pc_entity_pc_pc_ResourceRequiredRole)
...
pcm_pc_pc_parameter_pc_pc_CharacterisedVariable_strategy = st.builds(pcm_pc_pc_parameter_pc_pc_CharacterisedVariable, characterisationType=safe_text)
...
pcm_pc_pc_parameter_pc_pc_VariableCharacterisation_strategy = st.builds(pcm_pc_pc_parameter_pc_pc_VariableCharacterisation, type=safe_text)
...
pcm_pc_pc_parameter_pc_pc_VariableUsage_strategy = st.builds(pcm_pc_pc_parameter_pc_pc_VariableUsage)
...
pcm_pc_pc_protocol_pc_pc_Protocol_strategy = st.builds(pcm_pc_pc_protocol_pc_pc_Protocol, protocolTypeID=safe_text)
...
pcm_pc_pc_qos_performance_pc_pc_ComponentSpecifiedExecutionTime_strategy = st.builds(pcm_pc_pc_qos_performance_pc_pc_ComponentSpecifiedExecutionTime)
...
pcm_pc_pc_qos_performance_pc_pc_SpecifiedExecutionTime_strategy = st.builds(pcm_pc_pc_qos_performance_pc_pc_SpecifiedExecutionTime)
...
pcm_pc_pc_qos_performance_pc_pc_SystemSpecifiedExecutionTime_strategy = st.builds(pcm_pc_pc_qos_performance_pc_pc_SystemSpecifiedExecutionTime)
...
pcm_pc_pc_qos_reliability_pc_pc_SpecifiedReliabilityAnnotation_strategy = st.builds(pcm_pc_pc_qos_reliability_pc_pc_SpecifiedReliabilityAnnotation)
...
pcm_pc_pc_qosannotations_pc_pc_QoSAnnotations_strategy = st.builds(pcm_pc_pc_qosannotations_pc_pc_QoSAnnotations)
...
pcm_pc_pc_qosannotations_pc_pc_SpecifiedOutputParameterAbstraction_strategy = st.builds(pcm_pc_pc_qosannotations_pc_pc_SpecifiedOutputParameterAbstraction)
...
pcm_pc_pc_qosannotations_pc_pc_SpecifiedQoSAnnotation_strategy = st.builds(pcm_pc_pc_qosannotations_pc_pc_SpecifiedQoSAnnotation)
...
pcm_pc_pc_reliability_pc_pc_ExternalFailureOccurrenceDescription_strategy = st.builds(pcm_pc_pc_reliability_pc_pc_ExternalFailureOccurrenceDescription)
...
pcm_pc_pc_reliability_pc_pc_FailureOccurrenceDescription_strategy = st.builds(pcm_pc_pc_reliability_pc_pc_FailureOccurrenceDescription, failureProbability=st.floats(allow_nan=False, allow_infinity=False))
...
pcm_pc_pc_reliability_pc_pc_FailureType_strategy = st.builds(pcm_pc_pc_reliability_pc_pc_FailureType)
...
pcm_pc_pc_reliability_pc_pc_HardwareInducedFailureType_strategy = st.builds(pcm_pc_pc_reliability_pc_pc_HardwareInducedFailureType)
...
pcm_pc_pc_reliability_pc_pc_InternalFailureOccurrenceDescription_strategy = st.builds(pcm_pc_pc_reliability_pc_pc_InternalFailureOccurrenceDescription)
...
pcm_pc_pc_reliability_pc_pc_NetworkInducedFailureType_strategy = st.builds(pcm_pc_pc_reliability_pc_pc_NetworkInducedFailureType)
...
pcm_pc_pc_reliability_pc_pc_ResourceTimeoutFailureType_strategy = st.builds(pcm_pc_pc_reliability_pc_pc_ResourceTimeoutFailureType)
...
pcm_pc_pc_reliability_pc_pc_SoftwareInducedFailureType_strategy = st.builds(pcm_pc_pc_reliability_pc_pc_SoftwareInducedFailureType)
...
pcm_pc_pc_repository_pc_pc_BasicComponent_strategy = st.builds(pcm_pc_pc_repository_pc_pc_BasicComponent)
...
pcm_pc_pc_repository_pc_pc_CollectionDataType_strategy = st.builds(pcm_pc_pc_repository_pc_pc_CollectionDataType)
...
pcm_pc_pc_repository_pc_pc_CompleteComponentType_strategy = st.builds(pcm_pc_pc_repository_pc_pc_CompleteComponentType)
...
pcm_pc_pc_repository_pc_pc_CompositeComponent_strategy = st.builds(pcm_pc_pc_repository_pc_pc_CompositeComponent)
...
pcm_pc_pc_repository_pc_pc_CompositeDataType_strategy = st.builds(pcm_pc_pc_repository_pc_pc_CompositeDataType)
...
pcm_pc_pc_repository_pc_pc_DataType_strategy = st.builds(pcm_pc_pc_repository_pc_pc_DataType)
...
pcm_pc_pc_repository_pc_pc_EventGroup_strategy = st.builds(pcm_pc_pc_repository_pc_pc_EventGroup)
...
pcm_pc_pc_repository_pc_pc_EventType_strategy = st.builds(pcm_pc_pc_repository_pc_pc_EventType)
...
pcm_pc_pc_repository_pc_pc_ExceptionType_strategy = st.builds(pcm_pc_pc_repository_pc_pc_ExceptionType, exceptionMessage=safe_text, exceptionName=safe_text)
...
pcm_pc_pc_repository_pc_pc_ImplementationComponentType_strategy = st.builds(pcm_pc_pc_repository_pc_pc_ImplementationComponentType, componentType=safe_text)
...
pcm_pc_pc_repository_pc_pc_InfrastructureInterface_strategy = st.builds(pcm_pc_pc_repository_pc_pc_InfrastructureInterface)
...
pcm_pc_pc_repository_pc_pc_InfrastructureProvidedRole_strategy = st.builds(pcm_pc_pc_repository_pc_pc_InfrastructureProvidedRole)
...
pcm_pc_pc_repository_pc_pc_InfrastructureRequiredRole_strategy = st.builds(pcm_pc_pc_repository_pc_pc_InfrastructureRequiredRole)
...
pcm_pc_pc_repository_pc_pc_InfrastructureSignature_strategy = st.builds(pcm_pc_pc_repository_pc_pc_InfrastructureSignature)
...
pcm_pc_pc_repository_pc_pc_InnerDeclaration_strategy = st.builds(pcm_pc_pc_repository_pc_pc_InnerDeclaration)
...
pcm_pc_pc_repository_pc_pc_Interface_strategy = st.builds(pcm_pc_pc_repository_pc_pc_Interface)
...
pcm_pc_pc_repository_pc_pc_OperationInterface_strategy = st.builds(pcm_pc_pc_repository_pc_pc_OperationInterface)
...
pcm_pc_pc_repository_pc_pc_OperationProvidedRole_strategy = st.builds(pcm_pc_pc_repository_pc_pc_OperationProvidedRole)
...
pcm_pc_pc_repository_pc_pc_OperationRequiredRole_strategy = st.builds(pcm_pc_pc_repository_pc_pc_OperationRequiredRole)
...
pcm_pc_pc_repository_pc_pc_OperationSignature_strategy = st.builds(pcm_pc_pc_repository_pc_pc_OperationSignature)
...
pcm_pc_pc_repository_pc_pc_Parameter_strategy = st.builds(pcm_pc_pc_repository_pc_pc_Parameter, modifier__Parameter=safe_text, parameterName=safe_text)
...
pcm_pc_pc_repository_pc_pc_PassiveResource_strategy = st.builds(pcm_pc_pc_repository_pc_pc_PassiveResource)
...
pcm_pc_pc_repository_pc_pc_PrimitiveDataType_strategy = st.builds(pcm_pc_pc_repository_pc_pc_PrimitiveDataType, type=safe_text)
...
pcm_pc_pc_repository_pc_pc_ProvidedRole_strategy = st.builds(pcm_pc_pc_repository_pc_pc_ProvidedRole)
...
pcm_pc_pc_repository_pc_pc_ProvidesComponentType_strategy = st.builds(pcm_pc_pc_repository_pc_pc_ProvidesComponentType)
...
pcm_pc_pc_repository_pc_pc_Repository_strategy = st.builds(pcm_pc_pc_repository_pc_pc_Repository, repositoryDescription=safe_text)
...
pcm_pc_pc_repository_pc_pc_RepositoryComponent_strategy = st.builds(pcm_pc_pc_repository_pc_pc_RepositoryComponent)
...
pcm_pc_pc_repository_pc_pc_RequiredCharacterisation_strategy = st.builds(pcm_pc_pc_repository_pc_pc_RequiredCharacterisation, type=safe_text)
...
pcm_pc_pc_repository_pc_pc_RequiredRole_strategy = st.builds(pcm_pc_pc_repository_pc_pc_RequiredRole)
...
pcm_pc_pc_repository_pc_pc_Role_strategy = st.builds(pcm_pc_pc_repository_pc_pc_Role)
...
pcm_pc_pc_repository_pc_pc_Signature_strategy = st.builds(pcm_pc_pc_repository_pc_pc_Signature)
...
pcm_pc_pc_repository_pc_pc_SinkRole_strategy = st.builds(pcm_pc_pc_repository_pc_pc_SinkRole)
...
pcm_pc_pc_repository_pc_pc_SourceRole_strategy = st.builds(pcm_pc_pc_repository_pc_pc_SourceRole)
...
pcm_pc_pc_resourceenvironment_pc_pc_CommunicationLinkResourceSpecification_strategy = st.builds(pcm_pc_pc_resourceenvironment_pc_pc_CommunicationLinkResourceSpecification, failureProbability=st.floats(allow_nan=False, allow_infinity=False))
...
pcm_pc_pc_resourceenvironment_pc_pc_LinkingResource_strategy = st.builds(pcm_pc_pc_resourceenvironment_pc_pc_LinkingResource)
...
pcm_pc_pc_resourceenvironment_pc_pc_ProcessingResourceSpecification_strategy = st.builds(pcm_pc_pc_resourceenvironment_pc_pc_ProcessingResourceSpecification, MTTF=st.floats(allow_nan=False, allow_infinity=False), MTTR=st.floats(allow_nan=False, allow_infinity=False), numberOfReplicas=st.integers(), requiredByContainer=st.booleans())
...
pcm_pc_pc_resourceenvironment_pc_pc_ResourceContainer_strategy = st.builds(pcm_pc_pc_resourceenvironment_pc_pc_ResourceContainer)
...
pcm_pc_pc_resourceenvironment_pc_pc_ResourceEnvironment_strategy = st.builds(pcm_pc_pc_resourceenvironment_pc_pc_ResourceEnvironment)
...
pcm_pc_pc_resourcetype_pc_pc_CommunicationLinkResourceType_strategy = st.builds(pcm_pc_pc_resourcetype_pc_pc_CommunicationLinkResourceType)
...
pcm_pc_pc_resourcetype_pc_pc_ProcessingResourceType_strategy = st.builds(pcm_pc_pc_resourcetype_pc_pc_ProcessingResourceType)
...
pcm_pc_pc_resourcetype_pc_pc_ResourceInterface_strategy = st.builds(pcm_pc_pc_resourcetype_pc_pc_ResourceInterface)
...
pcm_pc_pc_resourcetype_pc_pc_ResourceRepository_strategy = st.builds(pcm_pc_pc_resourcetype_pc_pc_ResourceRepository)
...
pcm_pc_pc_resourcetype_pc_pc_ResourceSignature_strategy = st.builds(pcm_pc_pc_resourcetype_pc_pc_ResourceSignature, resourceServiceId=st.integers())
...
pcm_pc_pc_resourcetype_pc_pc_ResourceType_strategy = st.builds(pcm_pc_pc_resourcetype_pc_pc_ResourceType)
...
pcm_pc_pc_resourcetype_pc_pc_SchedulingPolicy_strategy = st.builds(pcm_pc_pc_resourcetype_pc_pc_SchedulingPolicy)
...
pcm_pc_pc_seff_pc_pc_AbstractAction_strategy = st.builds(pcm_pc_pc_seff_pc_pc_AbstractAction)
...
pcm_pc_pc_seff_pc_pc_AbstractBranchTransition_strategy = st.builds(pcm_pc_pc_seff_pc_pc_AbstractBranchTransition)
...
pcm_pc_pc_seff_pc_pc_AbstractInternalControlFlowAction_strategy = st.builds(pcm_pc_pc_seff_pc_pc_AbstractInternalControlFlowAction)
...
pcm_pc_pc_seff_pc_pc_AbstractLoopAction_strategy = st.builds(pcm_pc_pc_seff_pc_pc_AbstractLoopAction)
...
pcm_pc_pc_seff_pc_pc_AcquireAction_strategy = st.builds(pcm_pc_pc_seff_pc_pc_AcquireAction, timeout=st.booleans(), timeoutValue=st.floats(allow_nan=False, allow_infinity=False))
...
pcm_pc_pc_seff_pc_pc_BranchAction_strategy = st.builds(pcm_pc_pc_seff_pc_pc_BranchAction)
...
pcm_pc_pc_seff_pc_pc_CallAction_strategy = st.builds(pcm_pc_pc_seff_pc_pc_CallAction)
...
pcm_pc_pc_seff_pc_pc_CallReturnAction_strategy = st.builds(pcm_pc_pc_seff_pc_pc_CallReturnAction)
...
pcm_pc_pc_seff_pc_pc_CollectionIteratorAction_strategy = st.builds(pcm_pc_pc_seff_pc_pc_CollectionIteratorAction)
...
pcm_pc_pc_seff_pc_pc_EmitEventAction_strategy = st.builds(pcm_pc_pc_seff_pc_pc_EmitEventAction)
...
pcm_pc_pc_seff_pc_pc_ExternalCallAction_strategy = st.builds(pcm_pc_pc_seff_pc_pc_ExternalCallAction, retryCount=st.integers())
...
pcm_pc_pc_seff_pc_pc_ForkAction_strategy = st.builds(pcm_pc_pc_seff_pc_pc_ForkAction)
...
pcm_pc_pc_seff_pc_pc_ForkedBehaviour_strategy = st.builds(pcm_pc_pc_seff_pc_pc_ForkedBehaviour)
...
pcm_pc_pc_seff_pc_pc_GuardedBranchTransition_strategy = st.builds(pcm_pc_pc_seff_pc_pc_GuardedBranchTransition)
...
pcm_pc_pc_seff_pc_pc_InternalAction_strategy = st.builds(pcm_pc_pc_seff_pc_pc_InternalAction)
...
pcm_pc_pc_seff_pc_pc_InternalCallAction_strategy = st.builds(pcm_pc_pc_seff_pc_pc_InternalCallAction)
...
pcm_pc_pc_seff_pc_pc_LoopAction_strategy = st.builds(pcm_pc_pc_seff_pc_pc_LoopAction)
...
pcm_pc_pc_seff_pc_pc_ProbabilisticBranchTransition_strategy = st.builds(pcm_pc_pc_seff_pc_pc_ProbabilisticBranchTransition, branchProbability=st.floats(allow_nan=False, allow_infinity=False))
...
pcm_pc_pc_seff_pc_pc_ReleaseAction_strategy = st.builds(pcm_pc_pc_seff_pc_pc_ReleaseAction)
...
pcm_pc_pc_seff_pc_pc_ResourceDemandingBehaviour_strategy = st.builds(pcm_pc_pc_seff_pc_pc_ResourceDemandingBehaviour)
...
pcm_pc_pc_seff_pc_pc_ResourceDemandingInternalBehaviour_strategy = st.builds(pcm_pc_pc_seff_pc_pc_ResourceDemandingInternalBehaviour)
...
pcm_pc_pc_seff_pc_pc_ResourceDemandingSEFF_strategy = st.builds(pcm_pc_pc_seff_pc_pc_ResourceDemandingSEFF)
...
pcm_pc_pc_seff_pc_pc_ServiceEffectSpecification_strategy = st.builds(pcm_pc_pc_seff_pc_pc_ServiceEffectSpecification, seffTypeID=safe_text)
...
pcm_pc_pc_seff_pc_pc_SetVariableAction_strategy = st.builds(pcm_pc_pc_seff_pc_pc_SetVariableAction)
...
pcm_pc_pc_seff_pc_pc_StartAction_strategy = st.builds(pcm_pc_pc_seff_pc_pc_StartAction)
...
pcm_pc_pc_seff_pc_pc_StopAction_strategy = st.builds(pcm_pc_pc_seff_pc_pc_StopAction)
...
pcm_pc_pc_seff_pc_pc_SynchronisationPoint_strategy = st.builds(pcm_pc_pc_seff_pc_pc_SynchronisationPoint)
...
pcm_pc_pc_seff_performance_pc_pc_InfrastructureCall_strategy = st.builds(pcm_pc_pc_seff_performance_pc_pc_InfrastructureCall)
...
pcm_pc_pc_seff_performance_pc_pc_ParametricResourceDemand_strategy = st.builds(pcm_pc_pc_seff_performance_pc_pc_ParametricResourceDemand)
...
pcm_pc_pc_seff_performance_pc_pc_ResourceCall_strategy = st.builds(pcm_pc_pc_seff_performance_pc_pc_ResourceCall)
...
pcm_pc_pc_seff_reliability_pc_pc_FailureHandlingEntity_strategy = st.builds(pcm_pc_pc_seff_reliability_pc_pc_FailureHandlingEntity)
...
pcm_pc_pc_seff_reliability_pc_pc_RecoveryAction_strategy = st.builds(pcm_pc_pc_seff_reliability_pc_pc_RecoveryAction)
...
pcm_pc_pc_seff_reliability_pc_pc_RecoveryActionBehaviour_strategy = st.builds(pcm_pc_pc_seff_reliability_pc_pc_RecoveryActionBehaviour)
...
pcm_pc_pc_subsystem_pc_pc_SubSystem_strategy = st.builds(pcm_pc_pc_subsystem_pc_pc_SubSystem)
...
pcm_pc_pc_system_pc_pc_System_strategy = st.builds(pcm_pc_pc_system_pc_pc_System)
...
pcm_pc_pc_usagemodel_pc_pc_AbstractUserAction_strategy = st.builds(pcm_pc_pc_usagemodel_pc_pc_AbstractUserAction)
...
pcm_pc_pc_usagemodel_pc_pc_Branch_strategy = st.builds(pcm_pc_pc_usagemodel_pc_pc_Branch)
...
pcm_pc_pc_usagemodel_pc_pc_BranchTransition_strategy = st.builds(pcm_pc_pc_usagemodel_pc_pc_BranchTransition, branchProbability=st.floats(allow_nan=False, allow_infinity=False))
...
pcm_pc_pc_usagemodel_pc_pc_ClosedWorkload_strategy = st.builds(pcm_pc_pc_usagemodel_pc_pc_ClosedWorkload, population=st.integers())
...
pcm_pc_pc_usagemodel_pc_pc_Delay_strategy = st.builds(pcm_pc_pc_usagemodel_pc_pc_Delay)
...
pcm_pc_pc_usagemodel_pc_pc_EntryLevelSystemCall_strategy = st.builds(pcm_pc_pc_usagemodel_pc_pc_EntryLevelSystemCall, priority=st.integers())
...
pcm_pc_pc_usagemodel_pc_pc_Loop_strategy = st.builds(pcm_pc_pc_usagemodel_pc_pc_Loop)
...
pcm_pc_pc_usagemodel_pc_pc_OpenWorkload_strategy = st.builds(pcm_pc_pc_usagemodel_pc_pc_OpenWorkload)
...
pcm_pc_pc_usagemodel_pc_pc_ScenarioBehaviour_strategy = st.builds(pcm_pc_pc_usagemodel_pc_pc_ScenarioBehaviour)
...
pcm_pc_pc_usagemodel_pc_pc_Start_strategy = st.builds(pcm_pc_pc_usagemodel_pc_pc_Start)
...
pcm_pc_pc_usagemodel_pc_pc_Stop_strategy = st.builds(pcm_pc_pc_usagemodel_pc_pc_Stop)
...
pcm_pc_pc_usagemodel_pc_pc_UsageModel_strategy = st.builds(pcm_pc_pc_usagemodel_pc_pc_UsageModel)
...
pcm_pc_pc_usagemodel_pc_pc_UsageScenario_strategy = st.builds(pcm_pc_pc_usagemodel_pc_pc_UsageScenario)
...
pcm_pc_pc_usagemodel_pc_pc_UserData_strategy = st.builds(pcm_pc_pc_usagemodel_pc_pc_UserData)
...
pcm_pc_pc_usagemodel_pc_pc_Workload_strategy = st.builds(pcm_pc_pc_usagemodel_pc_pc_Workload)
...
qos_performance_pc_pc_SpecifiedExecutionTime_strategy = st.builds(qos_performance_pc_pc_SpecifiedExecutionTime)
...
qos_reliability_pc_pc_SpecifiedReliabilityAnnotation_strategy = st.builds(qos_reliability_pc_pc_SpecifiedReliabilityAnnotation)
...
repository_pc_pc_DataType_strategy = st.builds(repository_pc_pc_DataType)
...
repository_pc_pc_ImplementationComponentType_strategy = st.builds(repository_pc_pc_ImplementationComponentType)
...
repository_pc_pc_RepositoryComponent_strategy = st.builds(repository_pc_pc_RepositoryComponent)
...
seff_pc_pc_AbstractAction_strategy = st.builds(seff_pc_pc_AbstractAction)
...
seff_pc_pc_AbstractInternalControlFlowAction_strategy = st.builds(seff_pc_pc_AbstractInternalControlFlowAction)
...
seff_pc_pc_CallAction_strategy = st.builds(seff_pc_pc_CallAction)
...
seff_pc_pc_CallReturnAction_strategy = st.builds(seff_pc_pc_CallReturnAction)
...
seff_pc_pc_ResourceDemandingBehaviour_strategy = st.builds(seff_pc_pc_ResourceDemandingBehaviour)
...
seff_pc_pc_ServiceEffectSpecification_strategy = st.builds(seff_pc_pc_ServiceEffectSpecification)
...
seff_performance_pc_pc_InfrastructureCall_strategy = st.builds(seff_performance_pc_pc_InfrastructureCall)
...
seff_performance_pc_pc_ParametricResourceDemand_strategy = st.builds(seff_performance_pc_pc_ParametricResourceDemand)
...
seff_performance_pc_pc_ResourceCall_strategy = st.builds(seff_performance_pc_pc_ResourceCall)
...
seff_reliability_pc_pc_FailureHandlingEntity_strategy = st.builds(seff_reliability_pc_pc_FailureHandlingEntity)
...
seff_reliability_pc_pc_RecoveryAction_strategy = st.builds(seff_reliability_pc_pc_RecoveryAction)
...
seff_reliability_pc_pc_RecoveryActionBehaviour_strategy = st.builds(seff_reliability_pc_pc_RecoveryActionBehaviour)
