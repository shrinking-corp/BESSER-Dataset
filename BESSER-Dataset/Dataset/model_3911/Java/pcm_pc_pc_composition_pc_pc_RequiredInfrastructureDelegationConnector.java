...
public class pcm_pc_pc_composition_pc_pc_RequiredInfrastructureDelegationConnector extends DelegationConnector {
    ...
    public pcm_pc_pc_composition_pc_pc_RequiredInfrastructureDelegationConnector(
    ) {
        super(
        );
    }
