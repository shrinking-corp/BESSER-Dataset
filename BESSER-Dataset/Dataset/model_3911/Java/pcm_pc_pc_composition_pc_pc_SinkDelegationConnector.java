...
public class pcm_pc_pc_composition_pc_pc_SinkDelegationConnector extends DelegationConnector {
    ...
    public pcm_pc_pc_composition_pc_pc_SinkDelegationConnector(
    ) {
        super(
        );
    }
