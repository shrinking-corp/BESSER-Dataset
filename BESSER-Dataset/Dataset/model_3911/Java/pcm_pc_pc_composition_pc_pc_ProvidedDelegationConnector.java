...
public class pcm_pc_pc_composition_pc_pc_ProvidedDelegationConnector extends DelegationConnector {
    ...
    public pcm_pc_pc_composition_pc_pc_ProvidedDelegationConnector(
    ) {
        super(
        );
    }
