...
public class pcm_pc_pc_composition_pc_pc_RequiredDelegationConnector extends DelegationConnector {
    ...
    public pcm_pc_pc_composition_pc_pc_RequiredDelegationConnector(
    ) {
        super(
        );
    }
