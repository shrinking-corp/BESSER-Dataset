...
public class pcm_pc_pc_composition_pc_pc_SourceDelegationConnector extends DelegationConnector {
    ...
    public pcm_pc_pc_composition_pc_pc_SourceDelegationConnector(
    ) {
        super(
        );
    }
