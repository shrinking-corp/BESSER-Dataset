...
notation_FontStyle.attributes={notation_FontStyle_bold, notation_FontStyle_fontHeight, notation_FontStyle_fontName, notation_FontStyle_underline, notation_FontStyle_fontColor, notation_FontStyle_strikeThrough, notation_FontStyle_italic}
...
notation_RoutingStyle.attributes={notation_RoutingStyle_jumpLinkType, notation_RoutingStyle_avoidObstructions, notation_RoutingStyle_jumpLinkStatus, notation_RoutingStyle_jumpLinksReverse, notation_RoutingStyle_closestDistance, notation_RoutingStyle_smoothness, notation_RoutingStyle_routing}
...
notation_PageStyle.attributes={notation_PageStyle_pageHeight, notation_PageStyle_pageX, notation_PageStyle_pageY, notation_PageStyle_pageWidth}
...
notation_PropertiesSetStyle_m_createProperty: Method = Method(name="createProperty", parameters={Parameter(name='notation_initialValue', type=StringType), Parameter(name='notation_propertyName', type=StringType), Parameter(name='notation_instanceType', type=StringType)}, type=BooleanType)
...
notation_PropertiesSetStyle.methods={notation_PropertiesSetStyle_m_hasProperty, notation_PropertiesSetStyle_m_createProperty, notation_PropertiesSetStyle_m_createProperty, notation_PropertiesSetStyle_m_removeProperty, notation_PropertiesSetStyle_m_setProperty, notation_PropertiesSetStyle_m_getProperty}
