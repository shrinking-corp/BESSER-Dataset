...
class BasicCompartment:
    ...
    pass
class notation_Compartment(TitleStyle, CanonicalStyle, BasicCompartment):
...
class notation_SemanticListCompartment(FilteringStyle, TitleStyle, BasicSemanticCompartment, SortingStyle):
    ...
    pass
class notation_ListCompartment(FilteringStyle, TitleStyle, BasicCompartment, SortingStyle):
...
class RoundedCornersStyle:
    ...
    pass
class notation_ShapeStyle(RoundedCornersStyle, DescriptionStyle, LineStyle, FontStyle, FillStyle):
