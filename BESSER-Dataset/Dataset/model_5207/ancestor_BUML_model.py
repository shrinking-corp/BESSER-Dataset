...
# Classes
ancestor_A = Class(name="ancestor_A")
ancestor_B = Class(name="ancestor_B")
ancestor_C = Class(name="ancestor_C")
ancestor_D = Class(name="ancestor_D")
...
ancestor_A.methods={ancestor_A_m_op2, ancestor_A_m_op1}
...
ancestor_B.methods={ancestor_B_m_op1, ancestor_B_m_op2}
