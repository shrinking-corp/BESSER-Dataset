...
ancestor_A_strategy = st.builds(ancestor_A)
...
ancestor_B_strategy = st.builds(ancestor_B)
...
ancestor_C_strategy = st.builds(ancestor_C)
...
ancestor_D_strategy = st.builds(ancestor_D)
