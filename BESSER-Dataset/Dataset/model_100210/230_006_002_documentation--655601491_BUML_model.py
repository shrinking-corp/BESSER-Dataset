...
Documentation_ParagraphValue = Class(name="Documentation_ParagraphValue", is_abstract=True)
Documentation_Book = Class(name="Documentation_Book")
Documentation_Section = Class(name="Documentation_Section")
Paragraph = Class(name="Paragraph")
Documentation_EmphasisValue = Class(name="Documentation_EmphasisValue")
Documentation_XRefValue = Class(name="Documentation_XRefValue")
Documentation_TextualValue = Class(name="Documentation_TextualValue")
ParagraphValue = Class(name="ParagraphValue")
Documentation_ItemizedListValue = Class(name="Documentation_ItemizedListValue")
Documentation_ItemizedListValueItem = Class(name="Documentation_ItemizedListValueItem")
Documentation_InformalTableValueRow = Class(name="Documentation_InformalTableValueRow")
Documentation_InformalTableValueEntry = Class(name="Documentation_InformalTableValueEntry")
Documentation_InformalTableValue = Class(name="Documentation_InformalTableValue")
Documentation_InformalTableValueGroup = Class(name="Documentation_InformalTableValueGroup")
Documentation_InformalTableValueHead = Class(name="Documentation_InformalTableValueHead")
Documentation_InformalTableValueBody = Class(name="Documentation_InformalTableValueBody")
...
domain_model = DomainModel(
    name="Documentation",
    types={Documentation_Paragraph, Documentation_ParagraphValue, Documentation_Book, Documentation_Section, Paragraph, Documentation_EmphasisValue, Documentation_XRefValue, Documentation_TextualValue, ParagraphValue, Documentation_ItemizedListValue, Documentation_ItemizedListValueItem, Documentation_InformalTableValueRow, Documentation_InformalTableValueEntry, Documentation_InformalTableValue, Documentation_InformalTableValueGroup, Documentation_InformalTableValueHead, Documentation_InformalTableValueBody},
    associations={content0, items8, values1, section3, linkend9, para5, rows16, rows18, entry21, tgroup11, thead12, tbody14},
    generalizations={gen_Documentation_ItemizedListValueItem_Paragraph, gen_Documentation_EmphasisValue_ParagraphValue, gen_Documentation_XRefValue_ParagraphValue, gen_Documentation_TextualValue_ParagraphValue, gen_Documentation_ItemizedListValue_ParagraphValue, gen_Documentation_InformalTableValue_ParagraphValue},
    metadata=None
)
