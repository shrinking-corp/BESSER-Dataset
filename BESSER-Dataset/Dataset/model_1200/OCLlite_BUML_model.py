...
# Classes
oCLlite_LocalVariable = Class(name="oCLlite_LocalVariable")
oCLlite_Iterator = Class(name="oCLlite_Iterator")
oCLlite_OclLType = Class(name="oCLlite_OclLType")
oCLlite_Module = Class(name="oCLlite_Module")
oCLlite_OclLModel = Class(name="oCLlite_OclLModel")
oCLlite_Import = Class(name="oCLlite_Import")
oCLlite_ModuleElement = Class(name="oCLlite_ModuleElement")
oCLlite_URI_ = Class(name="oCLlite_URI_")
oCLlite_Query = Class(name="oCLlite_Query")
ModuleElement = Class(name="ModuleElement")
oCLlite_OclLExpression = Class(name="oCLlite_OclLExpression")
oCLlite_NullLiteralExp = Class(name="oCLlite_NullLiteralExp")
oCLlite_IfExp = Class(name="oCLlite_IfExp")
oCLlite_OclLModelElementExp = Class(name="oCLlite_OclLModelElementExp")
OclLType = Class(name="OclLType")
oCLlite_CollectionExp = Class(name="oCLlite_CollectionExp")
OclLExpression = Class(name="OclLExpression")
oCLlite_BagExp = Class(name="oCLlite_BagExp")
CollectionExp = Class(name="CollectionExp")
oCLlite_SequenceExp = Class(name="oCLlite_SequenceExp")
oCLlite_SetExp = Class(name="oCLlite_SetExp")
oCLlite_OrderedSetExp = Class(name="oCLlite_OrderedSetExp")
oCLlite_MapExp = Class(name="oCLlite_MapExp")
oCLlite_MapElement = Class(name="oCLlite_MapElement")
oCLlite_TuplePart = Class(name="oCLlite_TuplePart")
oCLlite_PrimitiveExp = Class(name="oCLlite_PrimitiveExp")
oCLlite_NumberLiteralExp = Class(name="oCLlite_NumberLiteralExp")
PrimitiveExp = Class(name="PrimitiveExp")
oCLlite_StringLiteralExp = Class(name="oCLlite_StringLiteralExp")
oCLlite_BooleanLiteralExp = Class(name="oCLlite_BooleanLiteralExp")
oCLlite_UnlimitedNaturalLiteralExp = Class(name="oCLlite_UnlimitedNaturalLiteralExp")
oCLlite_InvalidLiteralExp = Class(name="oCLlite_InvalidLiteralExp")
oCLlite_RealType = Class(name="oCLlite_RealType")
oCLlite_IntegerType = Class(name="oCLlite_IntegerType")
oCLlite_BooleanType = Class(name="oCLlite_BooleanType")
oCLlite_StringType = Class(name="oCLlite_StringType")
oCLlite_BoolOpCallExp = Class(name="oCLlite_BoolOpCallExp")
oCLlite_EnvType = Class(name="oCLlite_EnvType")
oCLlite_LambdaType = Class(name="oCLlite_LambdaType")
oCLlite_MapType = Class(name="oCLlite_MapType")
oCLlite_TupleType = Class(name="oCLlite_TupleType")
oCLlite_OclLAnyType = Class(name="oCLlite_OclLAnyType")
oCLlite_SetType = Class(name="oCLlite_SetType")
oCLlite_SequenceType = Class(name="oCLlite_SequenceType")
oCLlite_OrderedSetType = Class(name="oCLlite_OrderedSetType")
oCLlite_BagType = Class(name="oCLlite_BagType")
oCLlite_OperationCall = Class(name="oCLlite_OperationCall")
oCLlite_LambdaExp = Class(name="oCLlite_LambdaExp")
oCLlite_TupleExp = Class(name="oCLlite_TupleExp")
oCLlite_ElseIfThenExp = Class(name="oCLlite_ElseIfThenExp")
oCLlite_EqOpCallExp = Class(name="oCLlite_EqOpCallExp")
oCLlite_ComOpCallExp = Class(name="oCLlite_ComOpCallExp")
oCLlite_AddOpCallExp = Class(name="oCLlite_AddOpCallExp")
oCLlite_MulOpCallExp = Class(name="oCLlite_MulOpCallExp")
oCLlite_NavigationExp = Class(name="oCLlite_NavigationExp")
oCLlite_CollectionOpCallExp = Class(name="oCLlite_CollectionOpCallExp")
oCLlite_IterateExp = Class(name="oCLlite_IterateExp")
oCLlite_IteratorExp = Class(name="oCLlite_IteratorExp")
oCLlite_NavigationOrAttributeCall = Class(name="oCLlite_NavigationOrAttributeCall")
oCLlite_SelfExp = Class(name="oCLlite_SelfExp")
oCLlite_NestedExp = Class(name="oCLlite_NestedExp")
...
oCLlite_URI_.attributes={oCLlite_URI__fragment_, oCLlite_URI__scheme, oCLlite_URI__authority}
...
else_51: BinaryAssociation = BinaryAssociation(
    name="else_51",
    ends={
...
domain_model = DomainModel(
    name="oCLlite",
    types={oCLlite_LocalVariable, oCLlite_Iterator, oCLlite_OclLType, oCLlite_Module, oCLlite_OclLModel, oCLlite_Import, oCLlite_ModuleElement, oCLlite_URI_, oCLlite_Query, ModuleElement, oCLlite_OclLExpression, oCLlite_NullLiteralExp, oCLlite_IfExp, oCLlite_OclLModelElementExp, OclLType, oCLlite_CollectionExp, OclLExpression, oCLlite_BagExp, CollectionExp, oCLlite_SequenceExp, oCLlite_SetExp, oCLlite_OrderedSetExp, oCLlite_MapExp, oCLlite_MapElement, oCLlite_TuplePart, oCLlite_PrimitiveExp, oCLlite_NumberLiteralExp, PrimitiveExp, oCLlite_StringLiteralExp, oCLlite_BooleanLiteralExp, oCLlite_UnlimitedNaturalLiteralExp, oCLlite_InvalidLiteralExp, oCLlite_RealType, oCLlite_IntegerType, oCLlite_BooleanType, oCLlite_StringType, oCLlite_BoolOpCallExp, oCLlite_EnvType, oCLlite_LambdaType, oCLlite_MapType, oCLlite_TupleType, oCLlite_OclLAnyType, oCLlite_SetType, oCLlite_SequenceType, oCLlite_OrderedSetType, oCLlite_BagType, oCLlite_OperationCall, oCLlite_LambdaExp, oCLlite_TupleExp, oCLlite_ElseIfThenExp, oCLlite_EqOpCallExp, oCLlite_ComOpCallExp, oCLlite_AddOpCallExp, oCLlite_MulOpCallExp, oCLlite_NavigationExp, oCLlite_CollectionOpCallExp, oCLlite_IterateExp, oCLlite_IteratorExp, oCLlite_NavigationOrAttributeCall, oCLlite_SelfExp, oCLlite_NestedExp},
    associations={variable11, in_14, target17, model19, type22, source0, input1, imports4, elements6, uri8, body10, condition43, then45, ifThen48, else_51, model54, type23, initExp26, parts29, mapElements31, key32, value35, type38, init40, elementType72, source74, argsTypes56, returnType58, keyType61, valueType63, elementType66, elementType68, elementType70, arguments101, expression103, parts105, source76, source78, source80, source82, source84, arguments86, iterators88, result90, body93, iterators96, body98, condition107, then109, exp112},
    generalizations={gen_oCLlite_Query_ModuleElement, gen_oCLlite_NullLiteralExp_PrimitiveExp, gen_oCLlite_IfExp_OclLExpression, gen_oCLlite_OclLModelElementExp_OclLType, gen_oCLlite_CollectionExp_OclLExpression, gen_oCLlite_BagExp_CollectionExp, gen_oCLlite_SequenceExp_CollectionExp, gen_oCLlite_SetExp_CollectionExp, gen_oCLlite_OrderedSetExp_CollectionExp, gen_oCLlite_MapExp_OclLExpression, gen_oCLlite_PrimitiveExp_OclLExpression, gen_oCLlite_NumberLiteralExp_PrimitiveExp, gen_oCLlite_StringLiteralExp_PrimitiveExp, gen_oCLlite_BooleanLiteralExp_PrimitiveExp, gen_oCLlite_UnlimitedNaturalLiteralExp_PrimitiveExp, gen_oCLlite_InvalidLiteralExp_PrimitiveExp, gen_oCLlite_RealType_OclLType, gen_oCLlite_IntegerType_OclLType, gen_oCLlite_BooleanType_OclLType, gen_oCLlite_StringType_OclLType, gen_oCLlite_BoolOpCallExp_OclLExpression, gen_oCLlite_EnvType_OclLType, gen_oCLlite_LambdaType_OclLType, gen_oCLlite_MapType_OclLType, gen_oCLlite_TupleType_OclLType, gen_oCLlite_OclLAnyType_OclLType, gen_oCLlite_SetType_OclLType, gen_oCLlite_SequenceType_OclLType, gen_oCLlite_OrderedSetType_OclLType, gen_oCLlite_BagType_OclLType, gen_oCLlite_NavigationOrAttributeCall_OclLExpression, gen_oCLlite_OperationCall_OclLExpression, gen_oCLlite_LambdaExp_OclLExpression, gen_oCLlite_TupleExp_OclLExpression, gen_oCLlite_EqOpCallExp_OclLExpression, gen_oCLlite_ComOpCallExp_OclLExpression, gen_oCLlite_AddOpCallExp_OclLExpression, gen_oCLlite_MulOpCallExp_OclLExpression, gen_oCLlite_NavigationExp_OclLExpression, gen_oCLlite_CollectionOpCallExp_OclLExpression, gen_oCLlite_IterateExp_OclLExpression, gen_oCLlite_IteratorExp_OclLExpression, gen_oCLlite_ElseIfThenExp_OclLExpression, gen_oCLlite_SelfExp_OclLExpression, gen_oCLlite_NestedExp_OclLExpression},
    metadata=None
)
