...
class DDL_ValuesCk:
    ...
    def __init__(self, logConjuntion: str, value: str, comparator: str, columnName: str, DDL_ValuesCk: "DDL_Ck" = None):
...
class DDL_Table(DataDefinition):
    ...
    def __init__(self, tableName: str, commentTable: str, DDL_Table10: set["DDL_Column"] = None, DDL_Table13: "DDL_Pk" = None, DDL_Table15: set["DDL_Fk"] = None, DDL_Table: "DDL_Fk" = None, DDL_Table18: set["DDL_Ck"] = None):
