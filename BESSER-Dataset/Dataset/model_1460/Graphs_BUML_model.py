...
# Classes
graphs_Graph = Class(name="graphs_Graph")
graphs_Node = Class(name="graphs_Node")
graphs_Edge = Class(name="graphs_Edge")
graphs_CompositeNode = Class(name="graphs_CompositeNode")
...
domain_model = DomainModel(
    name="graphs",
    types={graphs_Graph, graphs_Node, graphs_Edge, graphs_CompositeNode, Node},
    associations={nodes0, edges1, ends11, subGraph3, src5, tar8},
