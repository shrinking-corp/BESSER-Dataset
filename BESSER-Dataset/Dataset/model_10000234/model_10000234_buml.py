...
Employee.attributes={Employee_employeeId, Employee_managerId, Employee_jobLevel, Employee_password, Employee_employeeName, Employee_noOfLeaves, Employee_leavesTaken}
...
LeaveApplication.attributes={LeaveApplication_approverComments, LeaveApplication_employeeId, LeaveApplication_status, LeaveApplication_reason, LeaveApplication_applicationId, LeaveApplication_fromDate, LeaveApplication_toDate}
...
domain_model = DomainModel(
    name="_1dd13691_26af_4608_915e_e29853f03ea5",
    ...
    associations={User_Login, Credit_Leaves_Application, Application_AutoApproval, Application_GenerateSummary, User_Query_Eligibility, User_Query_Leave_Balance, User_Query_Leave_History, Employee_Apply_Leave, Employee_Leave_Request_Status, Employee_Approver_Jobs, Admin_CreateUser, Admin_Update_Calendar, Application_SendNotification},
    generalizations={},
    metadata=None
)
