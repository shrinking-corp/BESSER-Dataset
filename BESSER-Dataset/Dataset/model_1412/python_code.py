...
class trialStatemachine_Region:
    ...
    def __init__(self, history: str, trialStatemachine_Region13: "trialStatemachine_State" = None, trialStatemachine_Region16: "trialStatemachine_ComplexState" = None, trialStatemachine_Region: "trialStatemachine_State" = None, trialStatemachine_Region4: "trialStatemachine_ComplexState" = None, trialStatemachine_Region7: "trialStatemachine_State" = None, trialStatemachine_Region10: set["trialStatemachine_State"] = None):
...
class trialStatemachine_LabeledTransition:
    ...
    def __init__(self, id: str, trialStatemachine_LabeledTransition19: "trialStatemachine_State" = None, trialStatemachine_LabeledTransition22: "trialStatemachine_Action" = None, trialStatemachine_LabeledTransition: "trialStatemachine_State" = None):
        self.id = id
...
class trialStatemachine_State:
    ...
    def __init__(self, name: str, initialState: str, trialStatemachine_State14: "trialStatemachine_Region" = None, trialStatemachine_State20: "trialStatemachine_LabeledTransition" = None, trialStatemachine_State: set["trialStatemachine_LabeledTransition"] = None, trialStatemachine_State2: "trialStatemachine_Region" = None, trialStatemachine_State8: "trialStatemachine_Region" = None, trialStatemachine_State11: "trialStatemachine_Region" = None):
        self.name = name
