...
trialStatemachine_State.attributes={trialStatemachine_State_initialState, trialStatemachine_State_name}
...
domain_model = DomainModel(
    ...
    types={trialStatemachine_Statemachine, Region, trialStatemachine_Action, trialStatemachine_State, trialStatemachine_LabeledTransition, trialStatemachine_Region, trialStatemachine_ComplexState, State},
    associations={actions5, outgoings0, super1, region3, defaultHistory6, states9, initial12, super15, target18, action21},
