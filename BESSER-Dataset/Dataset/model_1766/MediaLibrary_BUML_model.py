...
# Classes
MediaLibrary_NamedElement = Class(name="MediaLibrary_NamedElement", is_abstract=True)
MediaLibrary_Tablet = Class(name="MediaLibrary_Tablet")
Device = Class(name="Device")
MediaLibrary_Ecosystem = Class(name="MediaLibrary_Ecosystem")
MediaLibrary_Library = Class(name="MediaLibrary_Library")
MediaLibrary_Device = Class(name="MediaLibrary_Device", is_abstract=True)
MediaLibrary_MediaSource = Class(name="MediaLibrary_MediaSource", is_abstract=True)
NamedElement = Class(name="NamedElement")
MediaLibrary_MediaCollection = Class(name="MediaLibrary_MediaCollection")
MediaLibrary_Artifact = Class(name="MediaLibrary_Artifact", is_abstract=True)
MediaLibrary_ExternalSource = Class(name="MediaLibrary_ExternalSource")
MediaSource = Class(name="MediaSource")
MediaLibrary_Store = Class(name="MediaLibrary_Store")
MediaLibrary_Computer = Class(name="MediaLibrary_Computer")
MediaLibrary_Smartphone = Class(name="MediaLibrary_Smartphone")
MediaLibrary_EReader = Class(name="MediaLibrary_EReader")
MediaLibrary_DurationArtifact = Class(name="MediaLibrary_DurationArtifact", is_abstract=True)
Artifact = Class(name="Artifact")
MediaLibrary_AudioBook = Class(name="MediaLibrary_AudioBook")
DurationArtifact = Class(name="DurationArtifact")
MediaLibrary_MusicTrack = Class(name="MediaLibrary_MusicTrack")
MediaLibrary_Video = Class(name="MediaLibrary_Video")
MediaLibrary_Image = Class(name="MediaLibrary_Image")
MediaLibrary_Ebook = Class(name="MediaLibrary_Ebook")
...
MediaLibrary_EReader.attributes={MediaLibrary_EReader_audioEnabled, MediaLibrary_EReader_videoEnabled}
...
domain_model = DomainModel(
    name="MediaLibrary",
    types={MediaLibrary_NamedElement, MediaLibrary_Tablet, Device, MediaLibrary_Ecosystem, MediaLibrary_Library, MediaLibrary_Device, MediaLibrary_MediaSource, NamedElement, MediaLibrary_MediaCollection, MediaLibrary_Artifact, MediaLibrary_ExternalSource, MediaSource, MediaLibrary_Store, MediaLibrary_Computer, MediaLibrary_Smartphone, MediaLibrary_EReader, MediaLibrary_DurationArtifact, Artifact, MediaLibrary_AudioBook, DurationArtifact, MediaLibrary_MusicTrack, MediaLibrary_Video, MediaLibrary_Image, MediaLibrary_Ebook, SourceType},
    associations={syncedDevices10, hostOf12, collections13, libraries0, devices1, mediaSources3, collections5, members7, host9, contents16, origin15},
    generalizations={gen_MediaLibrary_Device_NamedElement, gen_MediaLibrary_Tablet_Device, gen_MediaLibrary_Library_NamedElement, gen_MediaLibrary_MediaCollection_NamedElement, gen_MediaLibrary_ExternalSource_MediaSource, gen_MediaLibrary_Store_MediaSource, gen_MediaLibrary_Computer_Device, gen_MediaLibrary_Smartphone_Device, gen_MediaLibrary_EReader_Device, gen_MediaLibrary_Artifact_NamedElement, gen_MediaLibrary_DurationArtifact_Artifact, gen_MediaLibrary_AudioBook_DurationArtifact, gen_MediaLibrary_MusicTrack_DurationArtifact, gen_MediaLibrary_Video_DurationArtifact, gen_MediaLibrary_Image_Artifact, gen_MediaLibrary_Ebook_Artifact, gen_MediaLibrary_MediaSource_NamedElement},
    metadata=None
)
