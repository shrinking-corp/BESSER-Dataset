...
SpreadsheetMLSimplified_DateTimeType.attributes={SpreadsheetMLSimplified_DateTimeType_month, SpreadsheetMLSimplified_DateTimeType_hour, SpreadsheetMLSimplified_DateTimeType_second, SpreadsheetMLSimplified_DateTimeType_day, SpreadsheetMLSimplified_DateTimeType_year, SpreadsheetMLSimplified_DateTimeType_minute}
...
SpreadsheetMLSimplified_ColOrRowElement.attributes={SpreadsheetMLSimplified_ColOrRowElement_span, SpreadsheetMLSimplified_ColOrRowElement_hidden}
...
SpreadsheetMLSimplified_Cell.attributes={SpreadsheetMLSimplified_Cell_formula, SpreadsheetMLSimplified_Cell_arrayRange, SpreadsheetMLSimplified_Cell_hRef, SpreadsheetMLSimplified_Cell_mergeDown, SpreadsheetMLSimplified_Cell_mergeAcross}
...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={SpreadsheetMLSimplified_DateTimeType, SpreadsheetMLSimplified_ValueType, Data, SpreadsheetMLSimplified_StringValue, ValueType, SpreadsheetMLSimplified_NumberValue, SpreadsheetMLSimplified_DateTimeTypeValue, DateTimeType, SpreadsheetMLSimplified_BooleanValue, SpreadsheetMLSimplified_ErrorValue, SpreadsheetMLSimplified_Workbook, Worksheet, Workbook, SpreadsheetMLSimplified_ColOrRowElement, TableElement, Table, SpreadsheetMLSimplified_Table, Column, Row, SpreadsheetMLSimplified_Worksheet, SpreadsheetMLSimplified_TableElement, Cell, SpreadsheetMLSimplified_Column, ColOrRowElement, SpreadsheetMLSimplified_Row, SpreadsheetMLSimplified_Data, SpreadsheetMLSimplified_Cell},
    associations={vt_data0, value1, wb_worksheets2, ws_workbook3, ws_table4, t_worksheet5, t_cols7, t_rows8, r_cells13, c_table9, r_table11, c_data16, c_row14, d_cell18, value20},
    generalizations={gen_SpreadsheetMLSimplified_StringValue_ValueType, gen_SpreadsheetMLSimplified_NumberValue_ValueType, gen_SpreadsheetMLSimplified_DateTimeTypeValue_ValueType, gen_SpreadsheetMLSimplified_BooleanValue_ValueType, gen_SpreadsheetMLSimplified_ErrorValue_ValueType, gen_SpreadsheetMLSimplified_ColOrRowElement_TableElement, gen_SpreadsheetMLSimplified_Column_ColOrRowElement, gen_SpreadsheetMLSimplified_Row_ColOrRowElement, gen_SpreadsheetMLSimplified_Cell_TableElement},
    metadata=None
)
