...
# Classes
mathInterpeter_MathExp = Class(name="mathInterpeter_MathExp")
mathInterpeter_Exp = Class(name="mathInterpeter_Exp")
mathInterpeter_Primary = Class(name="mathInterpeter_Primary")
Exp = Class(name="Exp")
mathInterpeter_Parenthesis = Class(name="mathInterpeter_Parenthesis")
Primary = Class(name="Primary")
mathInterpeter_Number = Class(name="mathInterpeter_Number")
mathInterpeter_Mult = Class(name="mathInterpeter_Mult")
mathInterpeter_Div = Class(name="mathInterpeter_Div")
mathInterpeter_Plus = Class(name="mathInterpeter_Plus")
mathInterpeter_Minus = Class(name="mathInterpeter_Minus")
...
domain_model = DomainModel(
    name="mathInterpeter",
    types={mathInterpeter_MathExp, mathInterpeter_Exp, mathInterpeter_Primary, Exp, mathInterpeter_Parenthesis, Primary, mathInterpeter_Number, mathInterpeter_Mult, mathInterpeter_Div, mathInterpeter_Plus, mathInterpeter_Minus},
    associations={exp0, exp1, right10, left13, right15, left17, right19, left3, right5, left8},
    generalizations={gen_mathInterpeter_Primary_Exp, gen_mathInterpeter_Parenthesis_Primary, gen_mathInterpeter_Mult_Exp, gen_mathInterpeter_Div_Exp, gen_mathInterpeter_Number_Primary, gen_mathInterpeter_Plus_Exp, gen_mathInterpeter_Minus_Exp},
    metadata=None
)
