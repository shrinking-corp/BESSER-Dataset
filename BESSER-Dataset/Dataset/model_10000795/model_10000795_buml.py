...
Employee_position: Property = Property(name="position", type=StringType)
Employee_salary: Property = Property(name="salary", type=IntegerType)
Employee_yearsHere: Property = Property(name="yearsHere", type=IntegerType)
Employee.attributes={Employee_name, Employee_salary, Employee_position, Employee_yearsHere}
...
ClassA.attributes={ClassA_packageAttribute, ClassA_privateAttribute, ClassA_publicAttribute, ClassA_protectedAttribute}
...
ClassC.attributes={ClassC_packageAttribute, ClassC_privateAttribute, ClassC_publicAttribute, ClassC_protectedAttribute}
...
domain_model = DomainModel(
    name="_618bc0e9_e953_4b2f_9b66_37d762fe4d49",
    types={Employee, ClassA, ClassB, ClassC, ClassD, ClassE, ClassF, ClassG, ClassJ, ClassH, ClassK, ClassL, ClassM, ClassN, ClassP, InterfaceO_Interface, ClassQ, ClassR, ClassS, ClassT, ClassU, ClassV},
