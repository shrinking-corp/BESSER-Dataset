...
@given(instance=Employee_strategy)
def test_hyp_employee_yearsHere_setter(instance):
    original = instance.yearsHere
...
@given(instance=Employee_strategy)
def test_hyp_employee_position_setter(instance):
...
def test_Employee_name_value_roundtrip():
    instance = Employee(name="sample_text", position="sample_text", salary=7, yearsHere=7)
    assert instance.name == "sample_text"
    instance.name = "sample_text_2"
    assert instance.name == "sample_text_2"


def test_Employee_position_value_roundtrip():
    instance = Employee(name="sample_text", position="sample_text", salary=7, yearsHere=7)
...
def test_Employee_yearsHere_value_roundtrip():
    instance = Employee(name="sample_text", position="sample_text", salary=7, yearsHere=7)
    assert instance.yearsHere == 7
    instance.yearsHere = 13
    assert instance.yearsHere == 13
...
Employee_strategy = st.builds(Employee, name=safe_text, position=safe_text, salary=st.integers(), yearsHere=st.integers())
@given(instance=Employee_strategy)
@settings(max_examples=25)
