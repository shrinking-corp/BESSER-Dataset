...
# Classes
extendedPO2_Item = Class(name="extendedPO2_Item")
extendedPO2_Address = Class(name="extendedPO2_Address", is_abstract=True)
extendedPO2_Customer = Class(name="extendedPO2_Customer")
extendedPO2_USAddress = Class(name="extendedPO2_USAddress")
Address = Class(name="Address")
extendedPO2_PurchaseOrder = Class(name="extendedPO2_PurchaseOrder")
extendedPO2_Supplier = Class(name="extendedPO2_Supplier")
extendedPO2_GlobalAddress = Class(name="extendedPO2_GlobalAddress")
...
extendedPO2_Item.attributes={extendedPO2_Item_USPrice, extendedPO2_Item_comment, extendedPO2_Item_shipDate, extendedPO2_Item_quantity, extendedPO2_Item_partNum, extendedPO2_Item_productName}
...
extendedPO2_Address.attributes={extendedPO2_Address_name, extendedPO2_Address_country}
...
extendedPO2_USAddress.attributes={extendedPO2_USAddress_zip, extendedPO2_USAddress_state, extendedPO2_USAddress_street, extendedPO2_USAddress_city}
...
extendedPO2_PurchaseOrder.attributes={extendedPO2_PurchaseOrder_status, extendedPO2_PurchaseOrder_orderDate, extendedPO2_PurchaseOrder_comment, extendedPO2_PurchaseOrder_totalAmount}
...
domain_model = DomainModel(
    ...
    associations={items0, billTo1, shipTo2, previousOrder6, customer8, order9, orders10, orders12, customers14, pendingOrders16, shippedOrders19},
