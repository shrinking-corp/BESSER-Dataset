...
class extendedPO2_PurchaseOrder:
    ...
    def __init__(self, totalAmount: int, comment: str, orderDate: str, status: str, extendedPO2_PurchaseOrder3: "extendedPO2_Address" = None, extendedPO2_PurchaseOrder7: "extendedPO2_PurchaseOrder" = None, extendedPO2_PurchaseOrder5: "extendedPO2_PurchaseOrder" = None, orders: "extendedPO2_Customer" = None, PurchaseOrder: "extendedPO2_Item" = None, PurchaseOrder11: "extendedPO2_Customer" = None, extendedPO2_PurchaseOrder13: "extendedPO2_Supplier" = None, extendedPO2_PurchaseOrder18: "extendedPO2_Supplier" = None, extendedPO2_PurchaseOrder21: "extendedPO2_Supplier" = None, order: set["extendedPO2_Item"] = None, extendedPO2_PurchaseOrder: "extendedPO2_Address" = None):
...
class extendedPO2_Customer:
    ...
    def __init__(self, customerID: int, Customer: "extendedPO2_PurchaseOrder" = None, customer: set["extendedPO2_PurchaseOrder"] = None, extendedPO2_Customer: "extendedPO2_Supplier" = None):
...
class extendedPO2_Address(ABC):
    ...
    def __init__(self, name: str, country: str, extendedPO2_Address4: "extendedPO2_PurchaseOrder" = None, extendedPO2_Address: "extendedPO2_PurchaseOrder" = None):
        self.name = name
...
class extendedPO2_Item:
    ...
    def __init__(self, productName: str, quantity: int, USPrice: int, comment: str, shipDate: str, partNum: str, items: "extendedPO2_PurchaseOrder" = None, Item: "extendedPO2_PurchaseOrder" = None):
