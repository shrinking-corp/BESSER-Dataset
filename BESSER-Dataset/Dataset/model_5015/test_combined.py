...
def test_hyp_extendedpo2_supplier_is_not_abstract():
    assert not inspect.isabstract(extendedPO2_Supplier)


def test_hyp_extendedpo2_supplier_constructor_exists():
    assert callable(extendedPO2_Supplier.__init__)


def test_hyp_extendedpo2_supplier_constructor_args():
...
def test_hyp_extendedpo2_purchaseorder_is_not_abstract():
    assert not inspect.isabstract(extendedPO2_PurchaseOrder)


def test_hyp_extendedpo2_purchaseorder_constructor_exists():
    assert callable(extendedPO2_PurchaseOrder.__init__)


def test_hyp_extendedpo2_purchaseorder_constructor_args():
...
def test_hyp_extendedpo2_globaladdress_is_not_abstract():
    assert not inspect.isabstract(extendedPO2_GlobalAddress)


def test_hyp_extendedpo2_globaladdress_constructor_exists():
    assert callable(extendedPO2_GlobalAddress.__init__)


def test_hyp_extendedpo2_globaladdress_constructor_args():
...
def test_hyp_extendedpo2_usaddress_is_not_abstract():
    assert not inspect.isabstract(extendedPO2_USAddress)


def test_hyp_extendedpo2_usaddress_constructor_exists():
    assert callable(extendedPO2_USAddress.__init__)


def test_hyp_extendedpo2_usaddress_constructor_args():
...
def test_hyp_extendedpo2_customer_is_not_abstract():
    assert not inspect.isabstract(extendedPO2_Customer)


def test_hyp_extendedpo2_customer_constructor_exists():
    assert callable(extendedPO2_Customer.__init__)


def test_hyp_extendedpo2_customer_constructor_args():
...
def test_hyp_extendedpo2_address_is_not_abstract():
    assert not inspect.isabstract(extendedPO2_Address)


def test_hyp_extendedpo2_address_constructor_exists():
    assert callable(extendedPO2_Address.__init__)


def test_hyp_extendedpo2_address_constructor_args():
...
def test_hyp_extendedpo2_item_is_not_abstract():
    assert not inspect.isabstract(extendedPO2_Item)


def test_hyp_extendedpo2_item_constructor_exists():
    assert callable(extendedPO2_Item.__init__)


def test_hyp_extendedpo2_item_constructor_args():
...
def test_hyp_extendedpo2_supplier_name_setter(instance):
...
def test_hyp_extendedpo2_purchaseorder_totalAmount_setter(instance):
...
@given(instance=extendedPO2_PurchaseOrder_strategy)
def test_hyp_extendedpo2_purchaseorder_status_setter(instance):
...
@given(instance=extendedPO2_PurchaseOrder_strategy)
def test_hyp_extendedpo2_purchaseorder_comment_setter(instance):
...
@given(instance=extendedPO2_PurchaseOrder_strategy)
def test_hyp_extendedpo2_purchaseorder_orderDate_setter(instance):
...
def test_hyp_extendedpo2_globaladdress_location_setter(instance):
...
def test_hyp_extendedpo2_usaddress_street_setter(instance):
...
@given(instance=extendedPO2_USAddress_strategy)
def test_hyp_extendedpo2_usaddress_zip_setter(instance):
...
@given(instance=extendedPO2_USAddress_strategy)
def test_hyp_extendedpo2_usaddress_city_setter(instance):
...
@given(instance=extendedPO2_USAddress_strategy)
def test_hyp_extendedpo2_usaddress_state_setter(instance):
...
def test_hyp_extendedpo2_customer_customerID_setter(instance):
...
def test_hyp_extendedpo2_address_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=extendedPO2_Address_strategy)
def test_hyp_extendedpo2_address_country_setter(instance):
...
def test_hyp_extendedpo2_item_productName_setter(instance):
...
@given(instance=extendedPO2_Item_strategy)
def test_hyp_extendedpo2_item_USPrice_setter(instance):
...
@given(instance=extendedPO2_Item_strategy)
def test_hyp_extendedpo2_item_partNum_setter(instance):
...
@given(instance=extendedPO2_Item_strategy)
def test_hyp_extendedpo2_item_shipDate_setter(instance):
...
@given(instance=extendedPO2_Item_strategy)
def test_hyp_extendedpo2_item_comment_setter(instance):
    original = instance.comment
    instance.comment = original
    assert instance.comment == original
...
@given(instance=extendedPO2_Item_strategy)
def test_hyp_extendedpo2_item_quantity_setter(instance):
