...
trace_Any = Class(name="trace_Any", is_abstract=True)
trace_BoolAny = Class(name="trace_BoolAny")
Any = Class(name="Any")
trace_IntAny = Class(name="trace_IntAny")
trace_DecimalAny = Class(name="trace_DecimalAny")
trace_StringAny = Class(name="trace_StringAny")
trace_ObjectAny = Class(name="trace_ObjectAny")
...
domain_model = DomainModel(
    name="trace",
    types={trace_EObject, trace_Trace, trace_Any, trace_BoolAny, Any, trace_IntAny, trace_DecimalAny, trace_StringAny, trace_ObjectAny},
    associations={target1, rules3, sources0, value6},
