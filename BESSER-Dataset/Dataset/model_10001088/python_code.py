...
class WebUser:
    ...
    def __init__(self, state: UserState, login: str, password: str, shoppingCart2: "ShoppingCart" = None, customer4: "Customer" = None):
        self.state = state
        self.login = login
...
class Customer:
    ...
    def __init__(self, address: str, phone: str, email: str, city: str, name: str, webUser5: "WebUser" = None, account6: "Account" = None):
