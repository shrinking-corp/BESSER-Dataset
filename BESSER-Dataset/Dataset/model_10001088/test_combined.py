...
@given(instance=Customer_strategy)
def test_hyp_customer_city_setter(instance):
...
def test_Customer_address_value_roundtrip():
    instance = Customer(address="sample_text", city="sample_text", email="sample_text", name="sample_text", phone="sample_text")
    assert instance.address == "sample_text"
    instance.address = "sample_text_2"
    assert instance.address == "sample_text_2"


def test_Customer_city_value_roundtrip():
    instance = Customer(address="sample_text", city="sample_text", email="sample_text", name="sample_text", phone="sample_text")
...
def test_assoc_Customer_Account_link_reassign_clear():
    a = Customer(address="sample_text", city="sample_text", email="sample_text", name="sample_text", phone="sample_text")
    b1 = Account(billingAddress="sample_text", closed=date(2024, 1, 1), isClosed=True, open=date(2024, 1, 1))
    b2 = Account(billingAddress="sample_text_2", closed=date(2025, 6, 15), isClosed=False, open=date(2025, 6, 15))
...
Customer_strategy = st.builds(Customer, address=safe_text, city=safe_text, email=safe_text, name=safe_text, phone=safe_text)
@given(instance=Customer_strategy)
@settings(max_examples=25)
