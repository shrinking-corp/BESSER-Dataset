...
# Classes
cjsidl_description = Class(name="cjsidl_description")
cjsidl_references = Class(name="cjsidl_references")
cjsidl_declaredConstSet = Class(name="cjsidl_declaredConstSet")
cjsidl_declaredTypeSet = Class(name="cjsidl_declaredTypeSet")
cjsidl_messageSet = Class(name="cjsidl_messageSet")
cjsidl_internalEventSet = Class(name="cjsidl_internalEventSet")
cjsidl_protocolBehavior = Class(name="cjsidl_protocolBehavior")
cjsidl_refAttr = Class(name="cjsidl_refAttr")
cjsidl_jaus = Class(name="cjsidl_jaus")
cjsidl_EObject = Class(name="cjsidl_EObject")
cjsidl_serviceDef = Class(name="cjsidl_serviceDef")
cjsidl_declaredTypeSetRef = Class(name="cjsidl_declaredTypeSetRef")
cjsidl_typeDef = Class(name="cjsidl_typeDef")
cjsidl_typeReference = Class(name="cjsidl_typeReference")
cjsidl_scopedTypeId = Class(name="cjsidl_scopedTypeId")
cjsidl_messages = Class(name="cjsidl_messages")
cjsidl_messageDef = Class(name="cjsidl_messageDef")
cjsidl_messageRef = Class(name="cjsidl_messageRef")
cjsidl_messageScopedRef = Class(name="cjsidl_messageScopedRef")
cjsidl_declaredConstSetRef = Class(name="cjsidl_declaredConstSetRef")
cjsidl_constDef = Class(name="cjsidl_constDef")
cjsidl_startState = Class(name="cjsidl_startState")
cjsidl_state = Class(name="cjsidl_state")
cjsidl_defaultState = Class(name="cjsidl_defaultState")
cjsidl_entry = Class(name="cjsidl_entry")
cjsidl_exit = Class(name="cjsidl_exit")
cjsidl_transition = Class(name="cjsidl_transition")
cjsidl_eventDef = Class(name="cjsidl_eventDef")
cjsidl_stateMachine = Class(name="cjsidl_stateMachine")
cjsidl_transParams = Class(name="cjsidl_transParams")
cjsidl_transParam = Class(name="cjsidl_transParam")
cjsidl_scopedEventType = Class(name="cjsidl_scopedEventType")
cjsidl_guard = Class(name="cjsidl_guard")
cjsidl_defaultTransition = Class(name="cjsidl_defaultTransition")
cjsidl_actionList = Class(name="cjsidl_actionList")
cjsidl_sendActionList = Class(name="cjsidl_sendActionList")
cjsidl_nextState = Class(name="cjsidl_nextState")
cjsidl_pushTransition = Class(name="cjsidl_pushTransition")
cjsidl_popTransition = Class(name="cjsidl_popTransition")
cjsidl_guardParam = Class(name="cjsidl_guardParam")
cjsidl_guardAction = Class(name="cjsidl_guardAction")
cjsidl_internalTransition = Class(name="cjsidl_internalTransition")
cjsidl_simpleTransition = Class(name="cjsidl_simpleTransition")
cjsidl_simpleNumericType = Class(name="cjsidl_simpleNumericType")
cjsidl_arrayDef = Class(name="cjsidl_arrayDef")
cjsidl_recordDef = Class(name="cjsidl_recordDef")
cjsidl_listDef = Class(name="cjsidl_listDef")
cjsidl_variantDef = Class(name="cjsidl_variantDef")
cjsidl_sequenceDef = Class(name="cjsidl_sequenceDef")
cjsidl_fixedFieldDef = Class(name="cjsidl_fixedFieldDef")
cjsidl_varField = Class(name="cjsidl_varField")
cjsidl_action = Class(name="cjsidl_action")
cjsidl_bitfieldDef = Class(name="cjsidl_bitfieldDef")
cjsidl_fixedLenString = Class(name="cjsidl_fixedLenString")
cjsidl_varLenString = Class(name="cjsidl_varLenString")
cjsidl_varLenField = Class(name="cjsidl_varLenField")
cjsidl_varFormatField = Class(name="cjsidl_varFormatField")
cjsidl_headerDef = Class(name="cjsidl_headerDef")
cjsidl_bodyDef = Class(name="cjsidl_bodyDef")
cjsidl_footerDef = Class(name="cjsidl_footerDef")
cjsidl_containerDef = Class(name="cjsidl_containerDef")
cjsidl_containerRef = Class(name="cjsidl_containerRef")
cjsidl_headerRef = Class(name="cjsidl_headerRef")
cjsidl_headerScopedRef = Class(name="cjsidl_headerScopedRef")
cjsidl_bodyRef = Class(name="cjsidl_bodyRef")
cjsidl_bodyScopedRef = Class(name="cjsidl_bodyScopedRef")
cjsidl_footerRef = Class(name="cjsidl_footerRef")
cjsidl_footerScopedRef = Class(name="cjsidl_footerScopedRef")
cjsidl_constReference = Class(name="cjsidl_constReference")
cjsidl_scopedConstId = Class(name="cjsidl_scopedConstId")
cjsidl_scopedType = Class(name="cjsidl_scopedType")
cjsidl_declaredEventDef = Class(name="cjsidl_declaredEventDef")
cjsidl_valueSetDef = Class(name="cjsidl_valueSetDef")
cjsidl_taggedUnitsEnum = Class(name="cjsidl_taggedUnitsEnum")
cjsidl_subField = Class(name="cjsidl_subField")
cjsidl_scaledRangeDef = Class(name="cjsidl_scaledRangeDef")
cjsidl_valueRange = Class(name="cjsidl_valueRange")
cjsidl_formatEnumDef = Class(name="cjsidl_formatEnumDef")
containerDef = Class(name="containerDef")
cjsidl_valueSpec = Class(name="cjsidl_valueSpec")
cjsidl_taggedItemDef = Class(name="cjsidl_taggedItemDef")
...
cjsidl_declaredConstSet.attributes={cjsidl_declaredConstSet_constSetVersion, cjsidl_declaredConstSet_name, cjsidl_declaredConstSet_constName}
...
cjsidl_declaredTypeSet.attributes={cjsidl_declaredTypeSet_typeName, cjsidl_declaredTypeSet_name, cjsidl_declaredTypeSet_version}
...
cjsidl_messageSet.attributes={cjsidl_messageSet_inputComment, cjsidl_messageSet_comment, cjsidl_messageSet_outputComment}
...
cjsidl_typeReference.attributes={cjsidl_typeReference_name, cjsidl_typeReference_comment, cjsidl_typeReference_optional}
...
cjsidl_scopedTypeId.attributes={cjsidl_scopedTypeId_scopedName, cjsidl_scopedTypeId_comment, cjsidl_scopedTypeId_optional}
...
cjsidl_messageDef.attributes={cjsidl_messageDef_messageID, cjsidl_messageDef_name, cjsidl_messageDef_command}
...
cjsidl_declaredConstSetRef.attributes={cjsidl_declaredConstSetRef_name, cjsidl_declaredConstSetRef_comment}
...
cjsidl_constDef.attributes={cjsidl_constDef_comment, cjsidl_constDef_name, cjsidl_constDef_fieldUnits, cjsidl_constDef_constValue}
...
cjsidl_transition.attributes={cjsidl_transition_name, cjsidl_transition_type, cjsidl_transition_comment}
...
cjsidl_stateMachine.attributes={cjsidl_stateMachine_comment, cjsidl_stateMachine_name}
...
cjsidl_transParam.attributes={cjsidl_transParam_unsignedType, cjsidl_transParam_comment, cjsidl_transParam_name}
...
cjsidl_guard.attributes={cjsidl_guard_logicalOperator, cjsidl_guard_equiv, cjsidl_guard_comment}
...
cjsidl_guardAction_not_: Property = Property(name="not_", type=StringType)
cjsidl_guardAction_name: Property = Property(name="name", type=StringType)
cjsidl_guardAction.attributes={cjsidl_guardAction_name, cjsidl_guardAction_not_}
...
cjsidl_arrayDef.attributes={cjsidl_arrayDef_optional, cjsidl_arrayDef_comment, cjsidl_arrayDef_arraySize, cjsidl_arrayDef_name}
...
cjsidl_listDef.attributes={cjsidl_listDef_minCount, cjsidl_listDef_countComment, cjsidl_listDef_maxCount}
...
cjsidl_fixedFieldDef.attributes={cjsidl_fixedFieldDef_optional, cjsidl_fixedFieldDef_name, cjsidl_fixedFieldDef_fieldUnit, cjsidl_fixedFieldDef_comment}
...
cjsidl_varField.attributes={cjsidl_varField_comment, cjsidl_varField_optional, cjsidl_varField_name}
...
cjsidl_action.attributes={cjsidl_action_comment, cjsidl_action_name}
...
cjsidl_bitfieldDef.attributes={cjsidl_bitfieldDef_comment, cjsidl_bitfieldDef_type, cjsidl_bitfieldDef_optional, cjsidl_bitfieldDef_name}
...
cjsidl_fixedLenString.attributes={cjsidl_fixedLenString_optional, cjsidl_fixedLenString_comment, cjsidl_fixedLenString_upperLim, cjsidl_fixedLenString_name}
...
cjsidl_varLenString.attributes={cjsidl_varLenString_optional, cjsidl_varLenString_comment, cjsidl_varLenString_upperLim, cjsidl_varLenString_lowerLim, cjsidl_varLenString_name}
...
cjsidl_varLenField.attributes={cjsidl_varLenField_upperLim, cjsidl_varLenField_comment, cjsidl_varLenField_name, cjsidl_varLenField_optional, cjsidl_varLenField_lowerLim, cjsidl_varLenField_fieldFormat, cjsidl_varLenField_countComment}
...
cjsidl_varFormatField.attributes={cjsidl_varFormatField_name, cjsidl_varFormatField_countComment, cjsidl_varFormatField_units, cjsidl_varFormatField_optional, cjsidl_varFormatField_comment}
...
cjsidl_bodyDef.attributes={cjsidl_bodyDef_name, cjsidl_bodyDef_comment}
...
cjsidl_containerDef.attributes={cjsidl_containerDef_name, cjsidl_containerDef_optional, cjsidl_containerDef_comment}
...
cjsidl_containerRef.attributes={cjsidl_containerRef_name, cjsidl_containerRef_optional, cjsidl_containerRef_comment}
...
cjsidl_headerRef.attributes={cjsidl_headerRef_name, cjsidl_headerRef_comment}
...
cjsidl_subField.attributes={cjsidl_subField_name, cjsidl_subField_comment, cjsidl_subField_fromIndex, cjsidl_subField_toIndex}
...
cjsidl_scaledRangeDef.attributes={cjsidl_scaledRangeDef_interp, cjsidl_scaledRangeDef_function, cjsidl_scaledRangeDef_lowerLim, cjsidl_scaledRangeDef_upperLim}
...
cjsidl_valueRange.attributes={cjsidl_valueRange_lowerLim, cjsidl_valueRange_lowerLimit_type, cjsidl_valueRange_upperLimit_type, cjsidl_valueRange_upperLim, cjsidl_valueRange_comment}
...
cjsidl_formatEnumDef.attributes={cjsidl_formatEnumDef_fieldFormatStr, cjsidl_formatEnumDef_fieldFormat, cjsidl_formatEnumDef_index}
...
cjsidl_valueSpec.attributes={cjsidl_valueSpec_comment, cjsidl_valueSpec_name, cjsidl_valueSpec_value}
...
domain_model = DomainModel(
    name="cjsidl",
    types={cjsidl_description, cjsidl_references, cjsidl_declaredConstSet, cjsidl_declaredTypeSet, cjsidl_messageSet, cjsidl_internalEventSet, cjsidl_protocolBehavior, cjsidl_refAttr, cjsidl_jaus, cjsidl_EObject, cjsidl_serviceDef, cjsidl_declaredTypeSetRef, cjsidl_typeDef, cjsidl_typeReference, cjsidl_scopedTypeId, cjsidl_messages, cjsidl_messageDef, cjsidl_messageRef, cjsidl_messageScopedRef, cjsidl_declaredConstSetRef, cjsidl_constDef, cjsidl_startState, cjsidl_state, cjsidl_defaultState, cjsidl_entry, cjsidl_exit, cjsidl_transition, cjsidl_eventDef, cjsidl_stateMachine, cjsidl_transParams, cjsidl_transParam, cjsidl_scopedEventType, cjsidl_guard, cjsidl_defaultTransition, cjsidl_actionList, cjsidl_sendActionList, cjsidl_nextState, cjsidl_pushTransition, cjsidl_popTransition, cjsidl_guardParam, cjsidl_guardAction, cjsidl_internalTransition, cjsidl_simpleTransition, cjsidl_simpleNumericType, cjsidl_arrayDef, cjsidl_recordDef, cjsidl_listDef, cjsidl_variantDef, cjsidl_sequenceDef, cjsidl_fixedFieldDef, cjsidl_varField, cjsidl_action, cjsidl_bitfieldDef, cjsidl_fixedLenString, cjsidl_varLenString, cjsidl_varLenField, cjsidl_varFormatField, cjsidl_headerDef, cjsidl_bodyDef, cjsidl_footerDef, cjsidl_containerDef, cjsidl_containerRef, cjsidl_headerRef, cjsidl_headerScopedRef, cjsidl_bodyRef, cjsidl_bodyScopedRef, cjsidl_footerRef, cjsidl_footerScopedRef, cjsidl_constReference, cjsidl_scopedConstId, cjsidl_scopedType, cjsidl_declaredEventDef, cjsidl_valueSetDef, cjsidl_taggedUnitsEnum, cjsidl_subField, cjsidl_scaledRangeDef, cjsidl_valueRange, cjsidl_formatEnumDef, containerDef, cjsidl_valueSpec, cjsidl_taggedItemDef, UNIT, FIELD_FORMAT},
    associations={descr1, refs2, constSet4, typeSet6, messageSet8, internalEventSet10, protocolBehavior12, refInherit14, refClient16, importedNamespace19, set0, declaredConstSetRef29, declaredTypeSetRef32, typeDef34, typeRef36, scopedRef38, inputSet40, outputSet42, messageDefs45, typeRefs47, scopedRefs49, declaredConstSetRef22, constDef24, importedNamespace26, scoped70, state71, scoped74, startState77, defaultState80, states82, entryAction85, exitAction87, transitions89, defs51, descr54, header56, body59, footer62, ref65, stateMachine68, actions109, sendActions112, params115, type116, scopedEventType119, scoped121, params124, transGuard127, actions129, defaultTransition91, defaultState93, subState97, transition99, defaultTransition102, actions105, sendActions107, nextState150, nextState151, simpleTransition153, secondaryTransition156, param158, firstState160, scoped163, nextState166, guardAction169, sendActions132, destination135, transGuard138, actions141, sendActions144, destination147, constType185, importedNamespace187, messageDef190, arrayDef193, recordDef195, listDef197, variantDef199, sequenceDef201, fixedFieldDef203, varField205, param171, parameter174, actions177, actions179, param182, descr223, header226, body229, footer232, recordListSequenceVariant235, recordListSequenceVariant238, recordListSequenceVariant241, bitfieldDef207, fixedLenString209, varLenString211, varLenField213, varFormatField215, headerDef217, bodyDef219, footerDef221, name256, names259, type262, name265, names268, type271, name274, names277, type280, typeRef244, scopedRef246, typeRef248, scopedRef250, typeRef252, scopedRef254, upperLimRef291, upperLimScoped293, lowerLimRef295, lowerLimScoped298, upperLimRef301, upperLimScoped304, type307, valueRange310, type283, typeScoped284, type286, scopedEventType288, lowerLimRef315, lowerLimScoped318, upperLimRef321, upperLimScoped324, tag327, scopedTag330, type333, valueSetDef336, vtagField313, value350, subField353, lowerLimRef355, lowerLimScoped358, upperLimRef361, upperLimScoped364, scaledRangeDef338, countRange340, formatField342, constRef344, constScopedRef347, valueSet379, minCountRef382, minCountScoped385, maxCountRef388, maxCountScoped391, containerRef394, containerDef397, minCountRef400, lowerLimRef367, lowerLimScoped370, upperLimRef373, upperLimScoped376, arrayDef423, fieldDef426, variableFieldDef429, bitfieldDef432, fixedLengthStringDef435, variableLengthStringDef438, variableLengthFieldDef441, varFormatField444, typeReference447, scopedRef450, minCountScoped403, maxCountRef406, maxCountScoped409, itemList412, containerDef414, containerRef417, containerTypeList420, scopes468, ref471, name474, names477, type480, name483, names486, type489, constVal453, type456, typeRef459, scopedType462, scope465, ref492, name495, names498, type501},
    generalizations={gen_cjsidl_listDef_containerDef, gen_cjsidl_variantDef_containerDef, gen_cjsidl_recordDef_containerDef, gen_cjsidl_sequenceDef_containerDef},
    metadata=None
)
