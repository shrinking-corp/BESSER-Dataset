...
class HLSTree_HLSNode:
    ...
    def __init__(self, name: str, hls: str, HLSNode: "HLSTree_HLSNode" = None, children: "HLSTree_HLSNode" = None, HLSNode4: "HLSTree_HLSNode" = None, parent: set["HLSTree_HLSNode"] = None):
        self.name = name
        self.hls = hls
