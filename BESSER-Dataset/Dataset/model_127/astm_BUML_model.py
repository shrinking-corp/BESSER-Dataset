...
# Classes
astm_gastm_Scope = Class(name="astm_gastm_Scope")
DefinitionObject = Class(name="DefinitionObject")
Scope = Class(name="Scope")
astm_gastm_GASTMSyntaxObject = Class(name="astm_gastm_GASTMSyntaxObject", is_abstract=True)
GASTMObject = Class(name="GASTMObject")
astm_gastm_GASTMObject = Class(name="astm_gastm_GASTMObject")
astm_gastm_GASTMSourceObject = Class(name="astm_gastm_GASTMSourceObject", is_abstract=True)
astm_gastm_GASTMSemanticObject = Class(name="astm_gastm_GASTMSemanticObject", is_abstract=True)
astm_gastm_OtherSyntaxObject = Class(name="astm_gastm_OtherSyntaxObject", is_abstract=True)
astm_gastm_StorageSpecification = Class(name="astm_gastm_StorageSpecification", is_abstract=True)
astm_gastm_DataType = Class(name="astm_gastm_DataType", is_abstract=True)
astm_gastm_AccessKind = Class(name="astm_gastm_AccessKind")
astm_gastm_UnaryOperator = Class(name="astm_gastm_UnaryOperator", is_abstract=True)
astm_gastm_BinaryOperator = Class(name="astm_gastm_BinaryOperator", is_abstract=True)
astm_gastm_ActualParameter = Class(name="astm_gastm_ActualParameter", is_abstract=True)
astm_gastm_SourceFile = Class(name="astm_gastm_SourceFile")
GASTMSourceObject = Class(name="GASTMSourceObject")
astm_gastm_SourceLocation = Class(name="astm_gastm_SourceLocation")
SourceFile = Class(name="SourceFile")
astm_gastm_Project = Class(name="astm_gastm_Project")
...
astm_gastm_Definition = Class(name="astm_gastm_Definition", is_abstract=True)
DeclarationOrDefinition = Class(name="DeclarationOrDefinition")
Name = Class(name="Name")
TypeReference = Class(name="TypeReference")
astm_gastm_Declaration = Class(name="astm_gastm_Declaration", is_abstract=True)
...
astm_gastm_CompilationUnit = Class(name="astm_gastm_CompilationUnit")
OtherSyntaxObject = Class(name="OtherSyntaxObject")
ProgramScope = Class(name="ProgramScope")
astm_gastm_Name = Class(name="astm_gastm_Name")
astm_gastm_DeclarationOrDefinition = Class(name="astm_gastm_DeclarationOrDefinition", is_abstract=True)
astm_gastm_DataDefinition = Class(name="astm_gastm_DataDefinition", is_abstract=True)
Expression = Class(name="Expression")
astm_gastm_BitFieldDefinition = Class(name="astm_gastm_BitFieldDefinition")
DataDefinition = Class(name="DataDefinition")
Definition = Class(name="Definition")
astm_gastm_FunctionDeclaration = Class(name="astm_gastm_FunctionDeclaration")
...
astm_gastm_VariableDeclaration = Class(name="astm_gastm_VariableDeclaration")
astm_gastm_FunctionDefinition = Class(name="astm_gastm_FunctionDefinition")
FormalParameterDefinition = Class(name="FormalParameterDefinition")
Statement = Class(name="Statement")
FunctionScope = Class(name="FunctionScope")
astm_gastm_FunctionMemberAttributes = Class(name="astm_gastm_FunctionMemberAttributes")
VirtualSpecification = Class(name="VirtualSpecification")
astm_gastm_EntryDefinition = Class(name="astm_gastm_EntryDefinition")
DataType = Class(name="DataType")
astm_gastm_EnumType = Class(name="astm_gastm_EnumType")
EnumLiteralDefinition = Class(name="EnumLiteralDefinition")
astm_gastm_ConstructedType = Class(name="astm_gastm_ConstructedType", is_abstract=True)
astm_gastm_AggregateType = Class(name="astm_gastm_AggregateType", is_abstract=True)
astm_gastm_EnumLiteralDefinition = Class(name="astm_gastm_EnumLiteralDefinition")
astm_gastm_TypeDefinition = Class(name="astm_gastm_TypeDefinition")
astm_gastm_NamedTypeDefinition = Class(name="astm_gastm_NamedTypeDefinition")
TypeDefinition = Class(name="TypeDefinition")
NamedType = Class(name="NamedType")
astm_gastm_AggregateTypeDefinition = Class(name="astm_gastm_AggregateTypeDefinition")
AggregateType = Class(name="AggregateType")
astm_gastm_NameSpaceDefinition = Class(name="astm_gastm_NameSpaceDefinition")
NameSpaceType = Class(name="NameSpaceType")
astm_gastm_LabelDefinition = Class(name="astm_gastm_LabelDefinition")
LabelType = Class(name="LabelType")
astm_gastm_IncludeUnit = Class(name="astm_gastm_IncludeUnit")
astm_gastm_MacroCall = Class(name="astm_gastm_MacroCall")
MacroDefinition = Class(name="MacroDefinition")
astm_gastm_MacroDefinition = Class(name="astm_gastm_MacroDefinition")
astm_gastm_Comment = Class(name="astm_gastm_Comment")
astm_gastm_Type = Class(name="astm_gastm_Type", is_abstract=True)
GASTMSyntaxObject = Class(name="GASTMSyntaxObject")
astm_gastm_PrimitiveType = Class(name="astm_gastm_PrimitiveType", is_abstract=True)
astm_gastm_DeleteStatement = Class(name="astm_gastm_DeleteStatement")
astm_gastm_DeclarationOrDefinitionStatement = Class(name="astm_gastm_DeclarationOrDefinitionStatement")
astm_gastm_ExpressionStatement = Class(name="astm_gastm_ExpressionStatement")
AggregateScope = Class(name="AggregateScope")
astm_gastm_ArrayType = Class(name="astm_gastm_ArrayType")
ConstructedType = Class(name="ConstructedType")
Dimension = Class(name="Dimension")
astm_gastm_Dimension = Class(name="astm_gastm_Dimension")
astm_gastm_FunctionType = Class(name="astm_gastm_FunctionType")
Type = Class(name="Type")
FormalParameterType = Class(name="FormalParameterType")
astm_gastm_FormalParameterType = Class(name="astm_gastm_FormalParameterType", is_abstract=True)
astm_gastm_NamedType = Class(name="astm_gastm_NamedType")
astm_gastm_ClassType = Class(name="astm_gastm_ClassType")
DerivesFrom = Class(name="DerivesFrom")
astm_gastm_DerivesFrom = Class(name="astm_gastm_DerivesFrom")
astm_gastm_UnnamedTypeReference = Class(name="astm_gastm_UnnamedTypeReference")
astm_gastm_NamedTypeReference = Class(name="astm_gastm_NamedTypeReference")
astm_gastm_SwitchCase = Class(name="astm_gastm_SwitchCase")
astm_gastm_CaseBlock = Class(name="astm_gastm_CaseBlock")
astm_gastm_ReturnStatement = Class(name="astm_gastm_ReturnStatement")
astm_gastm_JumpStatement = Class(name="astm_gastm_JumpStatement")
astm_gastm_BreakStatement = Class(name="astm_gastm_BreakStatement")
LabelAccess = Class(name="LabelAccess")
astm_gastm_ContinueStatement = Class(name="astm_gastm_ContinueStatement")
astm_gastm_LabeledStatement = Class(name="astm_gastm_LabeledStatement")
LabelDefinition = Class(name="LabelDefinition")
astm_gastm_BlockStatement = Class(name="astm_gastm_BlockStatement")
BlockScope = Class(name="BlockScope")
astm_gastm_EmptyStatement = Class(name="astm_gastm_EmptyStatement")
astm_gastm_IfStatement = Class(name="astm_gastm_IfStatement")
astm_gastm_SwitchStatement = Class(name="astm_gastm_SwitchStatement")
SwitchCase = Class(name="SwitchCase")
astm_gastm_Expression = Class(name="astm_gastm_Expression", is_abstract=True)
astm_gastm_NameReference = Class(name="astm_gastm_NameReference", is_abstract=True)
astm_gastm_LoopStatement = Class(name="astm_gastm_LoopStatement")
astm_gastm_ForStatement = Class(name="astm_gastm_ForStatement", is_abstract=True)
LoopStatement = Class(name="LoopStatement")
astm_gastm_TryStatement = Class(name="astm_gastm_TryStatement")
CatchBlock = Class(name="CatchBlock")
astm_gastm_CatchBlock = Class(name="astm_gastm_CatchBlock")
astm_gastm_TypesCatchBlock = Class(name="astm_gastm_TypesCatchBlock")
astm_gastm_VariableCatchBlock = Class(name="astm_gastm_VariableCatchBlock")
astm_gastm_ThrowStatement = Class(name="astm_gastm_ThrowStatement")
astm_gastm_BinaryExpression = Class(name="astm_gastm_BinaryExpression")
astm_gastm_ArrayAccess = Class(name="astm_gastm_ArrayAccess")
astm_gastm_QualifiedIdentifierReference = Class(name="astm_gastm_QualifiedIdentifierReference", is_abstract=True)
NameReference = Class(name="NameReference")
IdentifierReference = Class(name="IdentifierReference")
astm_gastm_TypeQualifiedIdentifierReference = Class(name="astm_gastm_TypeQualifiedIdentifierReference")
astm_gastm_Literal = Class(name="astm_gastm_Literal")
astm_gastm_CastExpression = Class(name="astm_gastm_CastExpression")
astm_gastm_UnaryExpression = Class(name="astm_gastm_UnaryExpression")
ActualParameter = Class(name="ActualParameter")
astm_gastm_ActualParameterExpression = Class(name="astm_gastm_ActualParameterExpression")
astm_gastm_OperatorAssign = Class(name="astm_gastm_OperatorAssign")
BinaryOperator = Class(name="BinaryOperator")
astm_gastm_ConditionalExpression = Class(name="astm_gastm_ConditionalExpression")
astm_gastm_RangeExpression = Class(name="astm_gastm_RangeExpression")
astm_gastm_FunctionCallExpression = Class(name="astm_gastm_FunctionCallExpression")
astm_gastm_NameSpaceType = Class(name="astm_gastm_NameSpaceType")
astm_gastm_LabelType = Class(name="astm_gastm_LabelType")
astm_gastm_AggregateScope = Class(name="astm_gastm_AggregateScope")
astm_gastm_BlockScope = Class(name="astm_gastm_BlockScope")
astm_gastm_IdentifierReference = Class(name="astm_gastm_IdentifierReference")
astm_gastm_FormalParameterDefinition = Class(name="astm_gastm_FormalParameterDefinition")
astm_gastm_VirtualSpecification = Class(name="astm_gastm_VirtualSpecification", is_abstract=True)
astm_gastm_FormalParameterDeclaration = Class(name="astm_gastm_FormalParameterDeclaration")
astm_gastm_NewExpression = Class(name="astm_gastm_NewExpression")
astm_gastm_LabelAccess = Class(name="astm_gastm_LabelAccess")
astm_gastm_AnnotationExpression = Class(name="astm_gastm_AnnotationExpression")
astm_gastm_GlobalScope = Class(name="astm_gastm_GlobalScope")
astm_gastm_PreprocessorElement = Class(name="astm_gastm_PreprocessorElement", is_abstract=True)
astm_gastm_DefinitionObject = Class(name="astm_gastm_DefinitionObject", is_abstract=True)
astm_gastm_ProgramScope = Class(name="astm_gastm_ProgramScope")
astm_gastm_TypeReference = Class(name="astm_gastm_TypeReference", is_abstract=True)
astm_gastm_Statement = Class(name="astm_gastm_Statement", is_abstract=True)
astm_gastm_FunctionScope = Class(name="astm_gastm_FunctionScope")
astm_gastm_DefaultBlock = Class(name="astm_gastm_DefaultBlock")
astm_gastm_WhileStatement = Class(name="astm_gastm_WhileStatement")
astm_gastm_DoWhileStatement = Class(name="astm_gastm_DoWhileStatement")
astm_gastm_ForCheckBeforeStatement = Class(name="astm_gastm_ForCheckBeforeStatement")
ForStatement = Class(name="ForStatement")
astm_gastm_ForCheckAfterStatement = Class(name="astm_gastm_ForCheckAfterStatement")
astm_gastm_AggregateExpression = Class(name="astm_gastm_AggregateExpression")
astm_gastm_QualifiedOverPointer = Class(name="astm_gastm_QualifiedOverPointer")
QualifiedIdentifierReference = Class(name="QualifiedIdentifierReference")
astm_gastm_QualifiedOverData = Class(name="astm_gastm_QualifiedOverData")
astm_gastm_VariableDefinition = Class(name="astm_gastm_VariableDefinition")
astm_gastm_FunctionMemberAttribute = Class(name="astm_gastm_FunctionMemberAttribute")
astm_gastm_External = Class(name="astm_gastm_External")
StorageSpecification = Class(name="StorageSpecification")
astm_gastm_FunctionPersistent = Class(name="astm_gastm_FunctionPersistent")
astm_gastm_FileLocal = Class(name="astm_gastm_FileLocal")
astm_gastm_PerClassMember = Class(name="astm_gastm_PerClassMember")
astm_gastm_NoDef = Class(name="astm_gastm_NoDef")
astm_gastm_Virtual = Class(name="astm_gastm_Virtual")
astm_gastm_PureVirtual = Class(name="astm_gastm_PureVirtual")
astm_gastm_NonVirtual = Class(name="astm_gastm_NonVirtual")
astm_gastm_ExceptionType = Class(name="astm_gastm_ExceptionType")
astm_gastm_Void = Class(name="astm_gastm_Void")
PrimitiveType = Class(name="PrimitiveType")
astm_gastm_Byte = Class(name="astm_gastm_Byte")
astm_gastm_ShortInteger = Class(name="astm_gastm_ShortInteger")
astm_gastm_Integer = Class(name="astm_gastm_Integer")
astm_gastm_LongInteger = Class(name="astm_gastm_LongInteger")
astm_gastm_Float = Class(name="astm_gastm_Float")
astm_gastm_Double = Class(name="astm_gastm_Double")
astm_gastm_LongDouble = Class(name="astm_gastm_LongDouble")
astm_gastm_Character = Class(name="astm_gastm_Character")
astm_gastm_String = Class(name="astm_gastm_String")
astm_gastm_Boolean = Class(name="astm_gastm_Boolean")
astm_gastm_WideCharacter = Class(name="astm_gastm_WideCharacter")
astm_gastm_CollectionType = Class(name="astm_gastm_CollectionType")
astm_gastm_PointerType = Class(name="astm_gastm_PointerType")
astm_gastm_ReferenceType = Class(name="astm_gastm_ReferenceType")
astm_gastm_RangeType = Class(name="astm_gastm_RangeType")
astm_gastm_StructureType = Class(name="astm_gastm_StructureType")
astm_gastm_UnionType = Class(name="astm_gastm_UnionType")
astm_gastm_AnnotationType = Class(name="astm_gastm_AnnotationType")
astm_gastm_ByValueFormalParameterType = Class(name="astm_gastm_ByValueFormalParameterType")
astm_gastm_ByReferenceFormalParameterType = Class(name="astm_gastm_ByReferenceFormalParameterType")
astm_gastm_Public = Class(name="astm_gastm_Public")
AccessKind = Class(name="AccessKind")
astm_gastm_Protected = Class(name="astm_gastm_Protected")
astm_gastm_Private = Class(name="astm_gastm_Private")
astm_gastm_TerminateStatement = Class(name="astm_gastm_TerminateStatement")
astm_gastm_MissingActualParameter = Class(name="astm_gastm_MissingActualParameter")
astm_gastm_ByValueActualParameterExpression = Class(name="astm_gastm_ByValueActualParameterExpression")
ActualParameterExpression = Class(name="ActualParameterExpression")
astm_gastm_ByReferenceActualParameterExpression = Class(name="astm_gastm_ByReferenceActualParameterExpression")
astm_gastm_SpecificTriggerDefinition = Class(name="astm_gastm_SpecificTriggerDefinition")
astm_gastm_IntegerlLiteral = Class(name="astm_gastm_IntegerlLiteral")
Literal = Class(name="Literal")
astm_gastm_StringLiteral = Class(name="astm_gastm_StringLiteral")
astm_gastm_CharLiteral = Class(name="astm_gastm_CharLiteral")
astm_gastm_RealLiteral = Class(name="astm_gastm_RealLiteral")
astm_gastm_BooleanLiteral = Class(name="astm_gastm_BooleanLiteral")
astm_gastm_BitLiteral = Class(name="astm_gastm_BitLiteral")
astm_gastm_UnaryPlus = Class(name="astm_gastm_UnaryPlus")
UnaryOperator = Class(name="UnaryOperator")
astm_gastm_Negate = Class(name="astm_gastm_Negate")
astm_gastm_Not = Class(name="astm_gastm_Not")
astm_gastm_BitNot = Class(name="astm_gastm_BitNot")
astm_gastm_AddressOf = Class(name="astm_gastm_AddressOf")
astm_gastm_Deref = Class(name="astm_gastm_Deref")
astm_gastm_Increment = Class(name="astm_gastm_Increment")
astm_gastm_Decrement = Class(name="astm_gastm_Decrement")
astm_gastm_PostIncrement = Class(name="astm_gastm_PostIncrement")
astm_gastm_PostDecrement = Class(name="astm_gastm_PostDecrement")
astm_gastm_Add = Class(name="astm_gastm_Add")
astm_gastm_Subtract = Class(name="astm_gastm_Subtract")
astm_gastm_Multiply = Class(name="astm_gastm_Multiply")
astm_gastm_Divide = Class(name="astm_gastm_Divide")
astm_gastm_Modulus = Class(name="astm_gastm_Modulus")
astm_gastm_Exponent = Class(name="astm_gastm_Exponent")
astm_gastm_And = Class(name="astm_gastm_And")
astm_gastm_Or = Class(name="astm_gastm_Or")
astm_gastm_Equal = Class(name="astm_gastm_Equal")
astm_gastm_NotEqual = Class(name="astm_gastm_NotEqual")
astm_gastm_Greater = Class(name="astm_gastm_Greater")
astm_gastm_NotGreater = Class(name="astm_gastm_NotGreater")
astm_gastm_Less = Class(name="astm_gastm_Less")
astm_gastm_NotLess = Class(name="astm_gastm_NotLess")
astm_gastm_BitAnd = Class(name="astm_gastm_BitAnd")
astm_gastm_BitOr = Class(name="astm_gastm_BitOr")
astm_gastm_BitXor = Class(name="astm_gastm_BitXor")
astm_gastm_BitLeftShift = Class(name="astm_gastm_BitLeftShift")
astm_gastm_BitRightShift = Class(name="astm_gastm_BitRightShift")
astm_gastm_Assign = Class(name="astm_gastm_Assign")
AggregateTypeDefinition = Class(name="AggregateTypeDefinition")
astm_sastm_RDBCursorDefinition = Class(name="astm_sastm_RDBCursorDefinition")
astm_sastm_RDBIndex = Class(name="astm_sastm_RDBIndex")
astm_gastm_SpecificLessEqual = Class(name="astm_gastm_SpecificLessEqual")
astm_gastm_SpecificGreaterEqual = Class(name="astm_gastm_SpecificGreaterEqual")
astm_gastm_SpecificIn = Class(name="astm_gastm_SpecificIn")
astm_gastm_SpecificLike = Class(name="astm_gastm_SpecificLike")
astm_gastm_SpecificConcatString = Class(name="astm_gastm_SpecificConcatString")
astm_gastm_SpecificSelectStatement = Class(name="astm_gastm_SpecificSelectStatement")
astm_sastm_RDBDatabaseDefinition = Class(name="astm_sastm_RDBDatabaseDefinition")
RDBTableSpaceReference = Class(name="RDBTableSpaceReference")
astm_sastm_RDBTableSpaceReference = Class(name="astm_sastm_RDBTableSpaceReference")
astm_sastm_RDBUserDefinition = Class(name="astm_sastm_RDBUserDefinition")
NameSpaceDefinition = Class(name="NameSpaceDefinition")
astm_sastm_RDBTableSpaceDefinition = Class(name="astm_sastm_RDBTableSpaceDefinition")
astm_sastm_RDBTableDefinition = Class(name="astm_sastm_RDBTableDefinition")
...
astm_sastm_RDBColumnDefinition = Class(name="astm_sastm_RDBColumnDefinition")
RDBColumnType = Class(name="RDBColumnType")
astm_sastm_RDBViewDefinition = Class(name="astm_sastm_RDBViewDefinition")
RDBHostVariableReference = Class(name="RDBHostVariableReference")
astm_sastm_RDBIndexColumn = Class(name="astm_sastm_RDBIndexColumn")
IncludeUnit = Class(name="IncludeUnit")
astm_sastm_RDBTrigger = Class(name="astm_sastm_RDBTrigger")
gastm_OtherSyntaxObject = Class(name="gastm_OtherSyntaxObject")
gastm_Definition = Class(name="gastm_Definition")
astm_sastm_RDBConstraint = Class(name="astm_sastm_RDBConstraint")
astm_sastm_RDBCheckConstraint = Class(name="astm_sastm_RDBCheckConstraint")
astm_sastm_RDBRefIntegrity = Class(name="astm_sastm_RDBRefIntegrity")
RDBTableReference = Class(name="RDBTableReference")
astm_sastm_RDBUniqueKey = Class(name="astm_sastm_RDBUniqueKey")
astm_sastm_RDBConnectStatement = Class(name="astm_sastm_RDBConnectStatement")
NamedTypeDefinition = Class(name="NamedTypeDefinition")
astm_sastm_RDBSelectStatement = Class(name="astm_sastm_RDBSelectStatement")
RDBSelectExpression = Class(name="RDBSelectExpression")
astm_sastm_RDBOpenCursorStatement = Class(name="astm_sastm_RDBOpenCursorStatement")
RDBCursorStatement = Class(name="RDBCursorStatement")
astm_sastm_RDBFetchCursorStatement = Class(name="astm_sastm_RDBFetchCursorStatement")
astm_sastm_RDBInsertStatement = Class(name="astm_sastm_RDBInsertStatement")
astm_sastm_RDBHostVariableReference = Class(name="astm_sastm_RDBHostVariableReference")
astm_sastm_RDBModifyStatement = Class(name="astm_sastm_RDBModifyStatement", is_abstract=True)
astm_sastm_RDBUpdateStatement = Class(name="astm_sastm_RDBUpdateStatement")
RDBModifyStatement = Class(name="RDBModifyStatement")
astm_sastm_RDBCursorStatement = Class(name="astm_sastm_RDBCursorStatement", is_abstract=True)
astm_sastm_RDBColumnReference = Class(name="astm_sastm_RDBColumnReference")
astm_sastm_RDBDataBaseType = Class(name="astm_sastm_RDBDataBaseType")
astm_sastm_RDBUserType = Class(name="astm_sastm_RDBUserType")
astm_sastm_RDBTableSpaceType = Class(name="astm_sastm_RDBTableSpaceType")
astm_sastm_RDBTableType = Class(name="astm_sastm_RDBTableType")
astm_sastm_RDBViewType = Class(name="astm_sastm_RDBViewType")
astm_sastm_RDBCursorType = Class(name="astm_sastm_RDBCursorType")
astm_sastm_RDBColumnType = Class(name="astm_sastm_RDBColumnType", is_abstract=True)
astm_sastm_RDBSelectExpression = Class(name="astm_sastm_RDBSelectExpression")
astm_sastm_RDBTableReference = Class(name="astm_sastm_RDBTableReference")
astm_sastm_RDBTableAlias = Class(name="astm_sastm_RDBTableAlias")
astm_sastm_RDBFloat = Class(name="astm_sastm_RDBFloat")
astm_sastm_RDBDecimal = Class(name="astm_sastm_RDBDecimal")
astm_sastm_RDBNumber = Class(name="astm_sastm_RDBNumber")
astm_sastm_RDBLong = Class(name="astm_sastm_RDBLong")
astm_sastm_RDBChar = Class(name="astm_sastm_RDBChar")
astm_sastm_RDBVarchar = Class(name="astm_sastm_RDBVarchar")
astm_sastm_RDBString = Class(name="astm_sastm_RDBString")
astm_sastm_RDBRaw = Class(name="astm_sastm_RDBRaw")
astm_sastm_RDBDate = Class(name="astm_sastm_RDBDate")
astm_sastm_RDBTimestamp = Class(name="astm_sastm_RDBTimestamp")
astm_sastm_RDBRowid = Class(name="astm_sastm_RDBRowid")
astm_sastm_RDBBoolean = Class(name="astm_sastm_RDBBoolean")
astm_sastm_RDBBlob = Class(name="astm_sastm_RDBBlob")
astm_sastm_RDBInteger = Class(name="astm_sastm_RDBInteger")
astm_sastm_RDBInt = Class(name="astm_sastm_RDBInt")
astm_sastm_RDBReal = Class(name="astm_sastm_RDBReal")
astm_sastm_RDBCloseCursorStatement = Class(name="astm_sastm_RDBCloseCursorStatement")
astm_sastm_RDBHostVariableExpression = Class(name="astm_sastm_RDBHostVariableExpression")
astm_sastm_RDBClob = Class(name="astm_sastm_RDBClob")
astm_sastm_RDBNClob = Class(name="astm_sastm_RDBNClob")
astm_sastm_RDBBFile = Class(name="astm_sastm_RDBBFile")
astm_sastm_RDBDeleteStatement = Class(name="astm_sastm_RDBDeleteStatement")
...
astm_gastm_SourceLocation.attributes={astm_gastm_SourceLocation_startColumn, astm_gastm_SourceLocation_startLine, astm_gastm_SourceLocation_endColumn, astm_gastm_SourceLocation_endLine}
...
astm_gastm_FunctionMemberAttributes.attributes={astm_gastm_FunctionMemberAttributes_isFriend, astm_gastm_FunctionMemberAttributes_isInline, astm_gastm_FunctionMemberAttributes_isThisConst}
...
astm_gastm_MacroDefinition.attributes={astm_gastm_MacroDefinition_macroName, astm_gastm_MacroDefinition_body}
...
domain_model = DomainModel(
    name="astm",
    types={astm_gastm_Scope, DefinitionObject, Scope, astm_gastm_GASTMSyntaxObject, GASTMObject, astm_gastm_GASTMObject, astm_gastm_GASTMSourceObject, astm_gastm_GASTMSemanticObject, astm_gastm_OtherSyntaxObject, astm_gastm_StorageSpecification, astm_gastm_DataType, astm_gastm_AccessKind, astm_gastm_UnaryOperator, astm_gastm_BinaryOperator, astm_gastm_ActualParameter, astm_gastm_SourceFile, GASTMSourceObject, astm_gastm_SourceLocation, SourceFile, astm_gastm_Project, GASTMSemanticObject, CompilationUnit, GlobalScope, astm_gastm_Definition, DeclarationOrDefinition, Name, TypeReference, astm_gastm_Declaration, SourceLocation, PreprocessorElement, AnnotationExpression, astm_gastm_CompilationUnit, OtherSyntaxObject, ProgramScope, astm_gastm_Name, astm_gastm_DeclarationOrDefinition, astm_gastm_DataDefinition, Expression, astm_gastm_BitFieldDefinition, DataDefinition, Definition, astm_gastm_FunctionDeclaration, Declaration, FormalParameterDeclaration, FunctionMemberAttributes, astm_gastm_VariableDeclaration, astm_gastm_FunctionDefinition, FormalParameterDefinition, Statement, FunctionScope, astm_gastm_FunctionMemberAttributes, VirtualSpecification, astm_gastm_EntryDefinition, DataType, astm_gastm_EnumType, EnumLiteralDefinition, astm_gastm_ConstructedType, astm_gastm_AggregateType, astm_gastm_EnumLiteralDefinition, astm_gastm_TypeDefinition, astm_gastm_NamedTypeDefinition, TypeDefinition, NamedType, astm_gastm_AggregateTypeDefinition, AggregateType, astm_gastm_NameSpaceDefinition, NameSpaceType, astm_gastm_LabelDefinition, LabelType, astm_gastm_IncludeUnit, astm_gastm_MacroCall, MacroDefinition, astm_gastm_MacroDefinition, astm_gastm_Comment, astm_gastm_Type, GASTMSyntaxObject, astm_gastm_PrimitiveType, astm_gastm_DeleteStatement, astm_gastm_DeclarationOrDefinitionStatement, astm_gastm_ExpressionStatement, AggregateScope, astm_gastm_ArrayType, ConstructedType, Dimension, astm_gastm_Dimension, astm_gastm_FunctionType, Type, FormalParameterType, astm_gastm_FormalParameterType, astm_gastm_NamedType, astm_gastm_ClassType, DerivesFrom, astm_gastm_DerivesFrom, astm_gastm_UnnamedTypeReference, astm_gastm_NamedTypeReference, astm_gastm_SwitchCase, astm_gastm_CaseBlock, astm_gastm_ReturnStatement, astm_gastm_JumpStatement, astm_gastm_BreakStatement, LabelAccess, astm_gastm_ContinueStatement, astm_gastm_LabeledStatement, LabelDefinition, astm_gastm_BlockStatement, BlockScope, astm_gastm_EmptyStatement, astm_gastm_IfStatement, astm_gastm_SwitchStatement, SwitchCase, astm_gastm_Expression, astm_gastm_NameReference, astm_gastm_LoopStatement, astm_gastm_ForStatement, LoopStatement, astm_gastm_TryStatement, CatchBlock, astm_gastm_CatchBlock, astm_gastm_TypesCatchBlock, astm_gastm_VariableCatchBlock, astm_gastm_ThrowStatement, astm_gastm_BinaryExpression, astm_gastm_ArrayAccess, astm_gastm_QualifiedIdentifierReference, NameReference, IdentifierReference, astm_gastm_TypeQualifiedIdentifierReference, astm_gastm_Literal, astm_gastm_CastExpression, astm_gastm_UnaryExpression, ActualParameter, astm_gastm_ActualParameterExpression, astm_gastm_OperatorAssign, BinaryOperator, astm_gastm_ConditionalExpression, astm_gastm_RangeExpression, astm_gastm_FunctionCallExpression, astm_gastm_NameSpaceType, astm_gastm_LabelType, astm_gastm_AggregateScope, astm_gastm_BlockScope, astm_gastm_IdentifierReference, astm_gastm_FormalParameterDefinition, astm_gastm_VirtualSpecification, astm_gastm_FormalParameterDeclaration, astm_gastm_NewExpression, astm_gastm_LabelAccess, astm_gastm_AnnotationExpression, astm_gastm_GlobalScope, astm_gastm_PreprocessorElement, astm_gastm_DefinitionObject, astm_gastm_ProgramScope, astm_gastm_TypeReference, astm_gastm_Statement, astm_gastm_FunctionScope, astm_gastm_DefaultBlock, astm_gastm_WhileStatement, astm_gastm_DoWhileStatement, astm_gastm_ForCheckBeforeStatement, ForStatement, astm_gastm_ForCheckAfterStatement, astm_gastm_AggregateExpression, astm_gastm_QualifiedOverPointer, QualifiedIdentifierReference, astm_gastm_QualifiedOverData, astm_gastm_VariableDefinition, astm_gastm_FunctionMemberAttribute, astm_gastm_External, StorageSpecification, astm_gastm_FunctionPersistent, astm_gastm_FileLocal, astm_gastm_PerClassMember, astm_gastm_NoDef, astm_gastm_Virtual, astm_gastm_PureVirtual, astm_gastm_NonVirtual, astm_gastm_ExceptionType, astm_gastm_Void, PrimitiveType, astm_gastm_Byte, astm_gastm_ShortInteger, astm_gastm_Integer, astm_gastm_LongInteger, astm_gastm_Float, astm_gastm_Double, astm_gastm_LongDouble, astm_gastm_Character, astm_gastm_String, astm_gastm_Boolean, astm_gastm_WideCharacter, astm_gastm_CollectionType, astm_gastm_PointerType, astm_gastm_ReferenceType, astm_gastm_RangeType, astm_gastm_StructureType, astm_gastm_UnionType, astm_gastm_AnnotationType, astm_gastm_ByValueFormalParameterType, astm_gastm_ByReferenceFormalParameterType, astm_gastm_Public, AccessKind, astm_gastm_Protected, astm_gastm_Private, astm_gastm_TerminateStatement, astm_gastm_MissingActualParameter, astm_gastm_ByValueActualParameterExpression, ActualParameterExpression, astm_gastm_ByReferenceActualParameterExpression, astm_gastm_SpecificTriggerDefinition, astm_gastm_IntegerlLiteral, Literal, astm_gastm_StringLiteral, astm_gastm_CharLiteral, astm_gastm_RealLiteral, astm_gastm_BooleanLiteral, astm_gastm_BitLiteral, astm_gastm_UnaryPlus, UnaryOperator, astm_gastm_Negate, astm_gastm_Not, astm_gastm_BitNot, astm_gastm_AddressOf, astm_gastm_Deref, astm_gastm_Increment, astm_gastm_Decrement, astm_gastm_PostIncrement, astm_gastm_PostDecrement, astm_gastm_Add, astm_gastm_Subtract, astm_gastm_Multiply, astm_gastm_Divide, astm_gastm_Modulus, astm_gastm_Exponent, astm_gastm_And, astm_gastm_Or, astm_gastm_Equal, astm_gastm_NotEqual, astm_gastm_Greater, astm_gastm_NotGreater, astm_gastm_Less, astm_gastm_NotLess, astm_gastm_BitAnd, astm_gastm_BitOr, astm_gastm_BitXor, astm_gastm_BitLeftShift, astm_gastm_BitRightShift, astm_gastm_Assign, AggregateTypeDefinition, astm_sastm_RDBCursorDefinition, astm_sastm_RDBIndex, astm_gastm_SpecificLessEqual, astm_gastm_SpecificGreaterEqual, astm_gastm_SpecificIn, astm_gastm_SpecificLike, astm_gastm_SpecificConcatString, astm_gastm_SpecificSelectStatement, astm_sastm_RDBDatabaseDefinition, RDBTableSpaceReference, astm_sastm_RDBTableSpaceReference, astm_sastm_RDBUserDefinition, NameSpaceDefinition, astm_sastm_RDBTableSpaceDefinition, astm_sastm_RDBTableDefinition, RDBColumnReference, RDBColumnDefinition, RDBConstraint, RDBIndex, RDBTrigger, astm_sastm_RDBColumnDefinition, RDBColumnType, astm_sastm_RDBViewDefinition, RDBHostVariableReference, astm_sastm_RDBIndexColumn, IncludeUnit, astm_sastm_RDBTrigger, gastm_OtherSyntaxObject, gastm_Definition, astm_sastm_RDBConstraint, astm_sastm_RDBCheckConstraint, astm_sastm_RDBRefIntegrity, RDBTableReference, astm_sastm_RDBUniqueKey, astm_sastm_RDBConnectStatement, NamedTypeDefinition, astm_sastm_RDBSelectStatement, RDBSelectExpression, astm_sastm_RDBOpenCursorStatement, RDBCursorStatement, astm_sastm_RDBFetchCursorStatement, astm_sastm_RDBInsertStatement, astm_sastm_RDBHostVariableReference, astm_sastm_RDBModifyStatement, astm_sastm_RDBUpdateStatement, RDBModifyStatement, astm_sastm_RDBCursorStatement, astm_sastm_RDBColumnReference, astm_sastm_RDBDataBaseType, astm_sastm_RDBUserType, astm_sastm_RDBTableSpaceType, astm_sastm_RDBTableType, astm_sastm_RDBViewType, astm_sastm_RDBCursorType, astm_sastm_RDBColumnType, astm_sastm_RDBSelectExpression, astm_sastm_RDBTableReference, astm_sastm_RDBTableAlias, astm_sastm_RDBFloat, astm_sastm_RDBDecimal, astm_sastm_RDBNumber, astm_sastm_RDBLong, astm_sastm_RDBChar, astm_sastm_RDBVarchar, astm_sastm_RDBString, astm_sastm_RDBRaw, astm_sastm_RDBDate, astm_sastm_RDBTimestamp, astm_sastm_RDBRowid, astm_sastm_RDBBoolean, astm_sastm_RDBBlob, astm_sastm_RDBInteger, astm_sastm_RDBInt, astm_sastm_RDBReal, astm_sastm_RDBCloseCursorStatement, astm_sastm_RDBHostVariableExpression, astm_sastm_RDBClob, astm_sastm_RDBNClob, astm_sastm_RDBBFile, astm_sastm_RDBDeleteStatement},
    associations={definitionObject4, childScope5, inSourceFile0, files1, outerScope2, identifierName20, definitionType21, locationInfo7, preProcessorElements8, annotations10, fragments12, opensScope14, storageSpecifiers16, accessKind17, formalParameters45, body47, initialValue50, defRef23, identifierName24, declarationType27, formalParameters30, functionMemberAttributes31, returnType33, formalParameters35, body37, functionMemberAttributes39, opensScope42, virtualSpecifier44, enumLiterals73, baseType74, bitFieldSize51, value53, name55, definitionType57, aggregateType58, nameSpace59, body61, nameSpaceType64, labelName66, labelType68, file70, refersTo72, type103, operand105, declOrDefn107, members76, opensScope78, ranks80, lowBound81, highBound83, returnType86, parameterTypes88, type90, body92, derivesFrom93, accessKind94, className96, type99, name101, body136, caseExpressions138, expression109, target111, target113, target114, label116, statement117, subStatements120, opensScope122, condition124, thenBody126, elseBody129, switchExpression132, cases134, expressionType166, name168, refersTo170, returnValue140, condition142, body144, initBody147, iterationBody149, guardedStatement152, catchBlocks154, finalStatement156, body159, exceptions161, exceptionVariable163, exception164, operator197, leftOperand199, arrayName173, subscripts175, qualifiers178, member180, aggregateType182, member184, castType187, expression189, operator192, operand194, calledFunction220, actualParams222, rightOperand202, operator205, condition207, onTrueOperand209, onFalseOperand212, fromExpression215, toExpression217, value224, newType226, actualParams228, name231, definition233, annotationType236, memberValues238, body241, DefinedBy260, SelectExpression261, IndexColumn263, TableSpace243, Owns244, Table245, PrimKey247, Column248, Constraint250, Index252, Trigger254, name256, type258, IntoVariable279, Column265, body266, ForeignKey268, ParentKey270, ParentTable273, Column275, ConnectString277, SelectExpression278, Values298, Into300, BaseVariable302, IntoTable281, Columns283, Values286, Table289, Where291, Values294, Cursor296, Table317, Indicator304, Table307, Column309, Where312, Alias315},
    generalizations={gen_astm_gastm_Scope_GASTMSemanticObject, gen_astm_gastm_GASTMSyntaxObject_GASTMObject, gen_astm_gastm_SourceFile_GASTMSourceObject, gen_astm_gastm_SourceLocation_GASTMSourceObject, gen_astm_gastm_Project_GASTMSemanticObject, gen_astm_gastm_Definition_DeclarationOrDefinition, gen_astm_gastm_CompilationUnit_OtherSyntaxObject, gen_astm_gastm_Name_OtherSyntaxObject, gen_astm_gastm_DeclarationOrDefinition_DefinitionObject, gen_astm_gastm_DataDefinition_Definition, gen_astm_gastm_BitFieldDefinition_DataDefinition, gen_astm_gastm_Declaration_DeclarationOrDefinition, gen_astm_gastm_FunctionDeclaration_Declaration, gen_astm_gastm_VariableDeclaration_Declaration, gen_astm_gastm_FunctionDefinition_Definition, gen_astm_gastm_EntryDefinition_Definition, gen_astm_gastm_PrimitiveType_DataType, gen_astm_gastm_EnumType_DataType, gen_astm_gastm_ConstructedType_DataType, gen_astm_gastm_AggregateType_DataType, gen_astm_gastm_EnumLiteralDefinition_Definition, gen_astm_gastm_TypeDefinition_DefinitionObject, gen_astm_gastm_NamedTypeDefinition_TypeDefinition, gen_astm_gastm_AggregateTypeDefinition_TypeDefinition, gen_astm_gastm_NameSpaceDefinition_DefinitionObject, gen_astm_gastm_LabelDefinition_DefinitionObject, gen_astm_gastm_IncludeUnit_PreprocessorElement, gen_astm_gastm_MacroCall_PreprocessorElement, gen_astm_gastm_MacroDefinition_PreprocessorElement, gen_astm_gastm_Comment_PreprocessorElement, gen_astm_gastm_Type_GASTMSyntaxObject, gen_astm_gastm_DeleteStatement_Statement, gen_astm_gastm_DeclarationOrDefinitionStatement_Statement, gen_astm_gastm_ExpressionStatement_Statement, gen_astm_gastm_ArrayType_ConstructedType, gen_astm_gastm_Dimension_OtherSyntaxObject, gen_astm_gastm_FunctionType_Type, gen_astm_gastm_FormalParameterType_DataType, gen_astm_gastm_NamedType_DataType, gen_astm_gastm_ClassType_AggregateType, gen_astm_gastm_DerivesFrom_OtherSyntaxObject, gen_astm_gastm_UnnamedTypeReference_TypeReference, gen_astm_gastm_NamedTypeReference_TypeReference, gen_astm_gastm_SwitchCase_OtherSyntaxObject, gen_astm_gastm_CaseBlock_SwitchCase, gen_astm_gastm_ReturnStatement_Statement, gen_astm_gastm_JumpStatement_Statement, gen_astm_gastm_BreakStatement_Statement, gen_astm_gastm_ContinueStatement_Statement, gen_astm_gastm_LabeledStatement_Statement, gen_astm_gastm_BlockStatement_Statement, gen_astm_gastm_EmptyStatement_Statement, gen_astm_gastm_IfStatement_Statement, gen_astm_gastm_SwitchStatement_Statement, gen_astm_gastm_Expression_GASTMSyntaxObject, gen_astm_gastm_NameReference_Expression, gen_astm_gastm_LoopStatement_Statement, gen_astm_gastm_ForStatement_LoopStatement, gen_astm_gastm_TryStatement_Statement, gen_astm_gastm_CatchBlock_OtherSyntaxObject, gen_astm_gastm_TypesCatchBlock_CatchBlock, gen_astm_gastm_VariableCatchBlock_CatchBlock, gen_astm_gastm_ThrowStatement_Statement, gen_astm_gastm_BinaryExpression_Expression, gen_astm_gastm_ArrayAccess_Expression, gen_astm_gastm_QualifiedIdentifierReference_NameReference, gen_astm_gastm_TypeQualifiedIdentifierReference_NameReference, gen_astm_gastm_Literal_Expression, gen_astm_gastm_CastExpression_Expression, gen_astm_gastm_UnaryExpression_Expression, gen_astm_gastm_ActualParameterExpression_ActualParameter, gen_astm_gastm_OperatorAssign_BinaryOperator, gen_astm_gastm_ConditionalExpression_Expression, gen_astm_gastm_RangeExpression_Expression, gen_astm_gastm_FunctionCallExpression_Expression, gen_astm_gastm_NameSpaceType_Type, gen_astm_gastm_LabelType_Type, gen_astm_gastm_AggregateScope_Scope, gen_astm_gastm_BlockScope_Scope, gen_astm_gastm_IdentifierReference_NameReference, gen_astm_gastm_FormalParameterDefinition_DataDefinition, gen_astm_gastm_VirtualSpecification_OtherSyntaxObject, gen_astm_gastm_FormalParameterDeclaration_Declaration, gen_astm_gastm_NewExpression_Expression, gen_astm_gastm_LabelAccess_Expression, gen_astm_gastm_AnnotationExpression_Expression, gen_astm_gastm_GlobalScope_Scope, gen_astm_gastm_PreprocessorElement_GASTMSyntaxObject, gen_astm_gastm_DefinitionObject_GASTMSyntaxObject, gen_astm_gastm_ProgramScope_Scope, gen_astm_gastm_TypeReference_Type, gen_astm_gastm_Statement_GASTMSyntaxObject, gen_astm_gastm_FunctionScope_Scope, gen_astm_gastm_DefaultBlock_SwitchCase, gen_astm_gastm_WhileStatement_LoopStatement, gen_astm_gastm_DoWhileStatement_LoopStatement, gen_astm_gastm_ForCheckBeforeStatement_ForStatement, gen_astm_gastm_ForCheckAfterStatement_ForStatement, gen_astm_gastm_AggregateExpression_Expression, gen_astm_gastm_QualifiedOverPointer_QualifiedIdentifierReference, gen_astm_gastm_QualifiedOverData_QualifiedIdentifierReference, gen_astm_gastm_VariableDefinition_DataDefinition, gen_astm_gastm_FunctionMemberAttribute_OtherSyntaxObject, gen_astm_gastm_External_StorageSpecification, gen_astm_gastm_FunctionPersistent_StorageSpecification, gen_astm_gastm_FileLocal_StorageSpecification, gen_astm_gastm_PerClassMember_StorageSpecification, gen_astm_gastm_NoDef_StorageSpecification, gen_astm_gastm_Virtual_VirtualSpecification, gen_astm_gastm_PureVirtual_VirtualSpecification, gen_astm_gastm_NonVirtual_VirtualSpecification, gen_astm_gastm_ExceptionType_DataType, gen_astm_gastm_Void_PrimitiveType, gen_astm_gastm_Byte_PrimitiveType, gen_astm_gastm_ShortInteger_PrimitiveType, gen_astm_gastm_Integer_PrimitiveType, gen_astm_gastm_LongInteger_PrimitiveType, gen_astm_gastm_Float_PrimitiveType, gen_astm_gastm_Double_PrimitiveType, gen_astm_gastm_LongDouble_PrimitiveType, gen_astm_gastm_Character_PrimitiveType, gen_astm_gastm_String_PrimitiveType, gen_astm_gastm_Boolean_PrimitiveType, gen_astm_gastm_WideCharacter_PrimitiveType, gen_astm_gastm_CollectionType_ConstructedType, gen_astm_gastm_PointerType_ConstructedType, gen_astm_gastm_ReferenceType_ConstructedType, gen_astm_gastm_RangeType_ConstructedType, gen_astm_gastm_StructureType_AggregateType, gen_astm_gastm_UnionType_AggregateType, gen_astm_gastm_AnnotationType_AggregateType, gen_astm_gastm_ByValueFormalParameterType_FormalParameterType, gen_astm_gastm_ByReferenceFormalParameterType_FormalParameterType, gen_astm_gastm_Public_AccessKind, gen_astm_gastm_Protected_AccessKind, gen_astm_gastm_Private_AccessKind, gen_astm_gastm_TerminateStatement_Statement, gen_astm_gastm_MissingActualParameter_ActualParameter, gen_astm_gastm_ByValueActualParameterExpression_ActualParameterExpression, gen_astm_gastm_ByReferenceActualParameterExpression_ActualParameterExpression, gen_astm_gastm_SpecificTriggerDefinition_Definition, gen_astm_gastm_IntegerlLiteral_Literal, gen_astm_gastm_StringLiteral_Literal, gen_astm_gastm_CharLiteral_Literal, gen_astm_gastm_RealLiteral_Literal, gen_astm_gastm_BooleanLiteral_Literal, gen_astm_gastm_BitLiteral_Literal, gen_astm_gastm_UnaryPlus_UnaryOperator, gen_astm_gastm_Negate_UnaryOperator, gen_astm_gastm_Not_UnaryOperator, gen_astm_gastm_BitNot_UnaryOperator, gen_astm_gastm_AddressOf_UnaryOperator, gen_astm_gastm_Deref_UnaryOperator, gen_astm_gastm_Increment_UnaryOperator, gen_astm_gastm_Decrement_UnaryOperator, gen_astm_gastm_PostIncrement_UnaryOperator, gen_astm_gastm_PostDecrement_UnaryOperator, gen_astm_gastm_Add_BinaryOperator, gen_astm_gastm_Subtract_BinaryOperator, gen_astm_gastm_Multiply_BinaryOperator, gen_astm_gastm_Divide_BinaryOperator, gen_astm_gastm_Modulus_BinaryOperator, gen_astm_gastm_Exponent_BinaryOperator, gen_astm_gastm_And_BinaryOperator, gen_astm_gastm_Or_BinaryOperator, gen_astm_gastm_Equal_BinaryOperator, gen_astm_gastm_NotEqual_BinaryOperator, gen_astm_gastm_Greater_BinaryOperator, gen_astm_gastm_NotGreater_BinaryOperator, gen_astm_gastm_Less_BinaryOperator, gen_astm_gastm_NotLess_BinaryOperator, gen_astm_gastm_BitAnd_BinaryOperator, gen_astm_gastm_BitOr_BinaryOperator, gen_astm_gastm_BitXor_BinaryOperator, gen_astm_gastm_BitLeftShift_BinaryOperator, gen_astm_gastm_BitRightShift_BinaryOperator, gen_astm_gastm_Assign_BinaryOperator, gen_astm_sastm_RDBCursorDefinition_Definition, gen_astm_sastm_RDBIndex_OtherSyntaxObject, gen_astm_gastm_SpecificLessEqual_BinaryOperator, gen_astm_gastm_SpecificGreaterEqual_BinaryOperator, gen_astm_gastm_SpecificIn_BinaryOperator, gen_astm_gastm_SpecificLike_BinaryOperator, gen_astm_gastm_SpecificConcatString_BinaryOperator, gen_astm_gastm_SpecificSelectStatement_Statement, gen_astm_sastm_RDBDatabaseDefinition_Definition, gen_astm_sastm_RDBUserDefinition_Definition, gen_astm_sastm_RDBTableSpaceDefinition_Definition, gen_astm_sastm_RDBTableDefinition_Definition, gen_astm_sastm_RDBColumnDefinition_Definition, gen_astm_sastm_RDBViewDefinition_Definition, gen_astm_sastm_RDBIndexColumn_OtherSyntaxObject, gen_astm_sastm_RDBTrigger_gastm_OtherSyntaxObject, gen_astm_sastm_RDBTrigger_gastm_Definition, gen_astm_sastm_RDBConstraint_OtherSyntaxObject, gen_astm_sastm_RDBCheckConstraint_RDBConstraint, gen_astm_sastm_RDBRefIntegrity_RDBConstraint, gen_astm_sastm_RDBUniqueKey_RDBConstraint, gen_astm_sastm_RDBConnectStatement_Statement, gen_astm_sastm_RDBSelectStatement_Statement, gen_astm_sastm_RDBOpenCursorStatement_RDBCursorStatement, gen_astm_sastm_RDBFetchCursorStatement_RDBCursorStatement, gen_astm_sastm_RDBInsertStatement_Statement, gen_astm_sastm_RDBModifyStatement_Statement, gen_astm_sastm_RDBUpdateStatement_RDBModifyStatement, gen_astm_sastm_RDBCursorStatement_Statement, gen_astm_sastm_RDBColumnReference_IdentifierReference, gen_astm_sastm_RDBDataBaseType_DataType, gen_astm_sastm_RDBUserType_DataType, gen_astm_sastm_RDBTableSpaceType_DataType, gen_astm_sastm_RDBTableType_DataType, gen_astm_sastm_RDBViewType_DataType, gen_astm_sastm_RDBCursorType_DataType, gen_astm_sastm_RDBSelectExpression_Expression, gen_astm_sastm_RDBTableReference_IdentifierReference, gen_astm_sastm_RDBTableAlias_IdentifierReference, gen_astm_sastm_RDBFloat_RDBColumnType, gen_astm_sastm_RDBDecimal_RDBColumnType, gen_astm_sastm_RDBNumber_RDBColumnType, gen_astm_sastm_RDBLong_RDBColumnType, gen_astm_sastm_RDBChar_RDBColumnType, gen_astm_sastm_RDBVarchar_RDBColumnType, gen_astm_sastm_RDBString_RDBColumnType, gen_astm_sastm_RDBRaw_RDBColumnType, gen_astm_sastm_RDBDate_RDBColumnType, gen_astm_sastm_RDBTimestamp_RDBColumnType, gen_astm_sastm_RDBRowid_RDBColumnType, gen_astm_sastm_RDBBoolean_RDBColumnType, gen_astm_sastm_RDBColumnType_DataType, gen_astm_sastm_RDBInteger_RDBColumnType, gen_astm_sastm_RDBInt_RDBColumnType, gen_astm_sastm_RDBReal_RDBColumnType, gen_astm_sastm_RDBCloseCursorStatement_RDBCursorStatement, gen_astm_sastm_RDBHostVariableExpression_Expression, gen_astm_sastm_RDBBlob_RDBColumnType, gen_astm_sastm_RDBClob_RDBColumnType, gen_astm_sastm_RDBNClob_RDBColumnType, gen_astm_sastm_RDBBFile_RDBColumnType, gen_astm_sastm_RDBDeleteStatement_RDBModifyStatement},
    metadata=None
)
