...
def test_astm_sastm_rdbdeletestatement_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBDeleteStatement)


def test_astm_sastm_rdbdeletestatement_constructor_exists():
    assert callable(astm_sastm_RDBDeleteStatement.__init__)


def test_astm_sastm_rdbdeletestatement_constructor_args():
    sig = inspect.signature(astm_sastm_RDBDeleteStatement.__init__)
    params = list(sig.parameters.keys())



def test_astm_sastm_rdbupdatestatement_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBUpdateStatement)


def test_astm_sastm_rdbupdatestatement_constructor_exists():
    assert callable(astm_sastm_RDBUpdateStatement.__init__)


def test_astm_sastm_rdbupdatestatement_constructor_args():
    sig = inspect.signature(astm_sastm_RDBUpdateStatement.__init__)
    params = list(sig.parameters.keys())



def test_astm_sastm_rdbhostvariablereference_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBHostVariableReference)


def test_astm_sastm_rdbhostvariablereference_constructor_exists():
    assert callable(astm_sastm_RDBHostVariableReference.__init__)


def test_astm_sastm_rdbhostvariablereference_constructor_args():
...
def test_astm_sastm_rdbclosecursorstatement_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBCloseCursorStatement)


def test_astm_sastm_rdbclosecursorstatement_constructor_exists():
    assert callable(astm_sastm_RDBCloseCursorStatement.__init__)


def test_astm_sastm_rdbclosecursorstatement_constructor_args():
    sig = inspect.signature(astm_sastm_RDBCloseCursorStatement.__init__)
    params = list(sig.parameters.keys())



def test_astm_sastm_rdbfetchcursorstatement_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBFetchCursorStatement)


def test_astm_sastm_rdbfetchcursorstatement_constructor_exists():
    assert callable(astm_sastm_RDBFetchCursorStatement.__init__)


def test_astm_sastm_rdbfetchcursorstatement_constructor_args():
    sig = inspect.signature(astm_sastm_RDBFetchCursorStatement.__init__)
    params = list(sig.parameters.keys())



def test_astm_sastm_rdbopencursorstatement_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBOpenCursorStatement)


def test_astm_sastm_rdbopencursorstatement_constructor_exists():
    assert callable(astm_sastm_RDBOpenCursorStatement.__init__)


def test_astm_sastm_rdbopencursorstatement_constructor_args():
    sig = inspect.signature(astm_sastm_RDBOpenCursorStatement.__init__)
    params = list(sig.parameters.keys())



def test_rdbselectexpression_is_not_abstract():
    assert not inspect.isabstract(RDBSelectExpression)


def test_rdbselectexpression_constructor_exists():
    assert callable(RDBSelectExpression.__init__)


def test_rdbselectexpression_constructor_args():
...
def test_rdbtablereference_is_not_abstract():
    assert not inspect.isabstract(RDBTableReference)


def test_rdbtablereference_constructor_exists():
    assert callable(RDBTableReference.__init__)


def test_rdbtablereference_constructor_args():
...
def test_astm_sastm_rdbdatabasetype_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBDataBaseType)


def test_astm_sastm_rdbdatabasetype_constructor_exists():
    assert callable(astm_sastm_RDBDataBaseType.__init__)


def test_astm_sastm_rdbdatabasetype_constructor_args():
    sig = inspect.signature(astm_sastm_RDBDataBaseType.__init__)
    params = list(sig.parameters.keys())



def test_astm_sastm_rdbusertype_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBUserType)


def test_astm_sastm_rdbusertype_constructor_exists():
    assert callable(astm_sastm_RDBUserType.__init__)


def test_astm_sastm_rdbusertype_constructor_args():
    sig = inspect.signature(astm_sastm_RDBUserType.__init__)
    params = list(sig.parameters.keys())



def test_astm_sastm_rdbtablespacetype_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBTableSpaceType)


def test_astm_sastm_rdbtablespacetype_constructor_exists():
    assert callable(astm_sastm_RDBTableSpaceType.__init__)


def test_astm_sastm_rdbtablespacetype_constructor_args():
    sig = inspect.signature(astm_sastm_RDBTableSpaceType.__init__)
    params = list(sig.parameters.keys())



def test_astm_sastm_rdbcolumntype_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBColumnType)


def test_astm_sastm_rdbcolumntype_constructor_exists():
    assert callable(astm_sastm_RDBColumnType.__init__)


def test_astm_sastm_rdbcolumntype_constructor_args():
...
def test_astm_sastm_rdbviewtype_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBViewType)


def test_astm_sastm_rdbviewtype_constructor_exists():
    assert callable(astm_sastm_RDBViewType.__init__)


def test_astm_sastm_rdbviewtype_constructor_args():
...
def test_astm_sastm_rdbtabletype_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBTableType)


def test_astm_sastm_rdbtabletype_constructor_exists():
    assert callable(astm_sastm_RDBTableType.__init__)


def test_astm_sastm_rdbtabletype_constructor_args():
    sig = inspect.signature(astm_sastm_RDBTableType.__init__)
    params = list(sig.parameters.keys())



def test_astm_sastm_rdbcursortype_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBCursorType)


def test_astm_sastm_rdbcursortype_constructor_exists():
    assert callable(astm_sastm_RDBCursorType.__init__)


def test_astm_sastm_rdbcursortype_constructor_args():
...
def test_astm_sastm_rdbmodifystatement_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBModifyStatement)


def test_astm_sastm_rdbmodifystatement_constructor_exists():
    assert callable(astm_sastm_RDBModifyStatement.__init__)


def test_astm_sastm_rdbmodifystatement_constructor_args():
    sig = inspect.signature(astm_sastm_RDBModifyStatement.__init__)
    params = list(sig.parameters.keys())



def test_astm_sastm_rdbselectstatement_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBSelectStatement)


def test_astm_sastm_rdbselectstatement_constructor_exists():
    assert callable(astm_sastm_RDBSelectStatement.__init__)


def test_astm_sastm_rdbselectstatement_constructor_args():
...
def test_astm_sastm_rdbcursorstatement_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBCursorStatement)


def test_astm_sastm_rdbcursorstatement_constructor_exists():
    assert callable(astm_sastm_RDBCursorStatement.__init__)


def test_astm_sastm_rdbcursorstatement_constructor_args():
...
def test_astm_sastm_rdbinsertstatement_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBInsertStatement)


def test_astm_sastm_rdbinsertstatement_constructor_exists():
    assert callable(astm_sastm_RDBInsertStatement.__init__)


def test_astm_sastm_rdbinsertstatement_constructor_args():
    sig = inspect.signature(astm_sastm_RDBInsertStatement.__init__)
    params = list(sig.parameters.keys())



def test_astm_sastm_rdbconnectstatement_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBConnectStatement)


def test_astm_sastm_rdbconnectstatement_constructor_exists():
    assert callable(astm_sastm_RDBConnectStatement.__init__)


def test_astm_sastm_rdbconnectstatement_constructor_args():
...
def test_astm_sastm_rdbselectexpression_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBSelectExpression)


def test_astm_sastm_rdbselectexpression_constructor_exists():
    assert callable(astm_sastm_RDBSelectExpression.__init__)


def test_astm_sastm_rdbselectexpression_constructor_args():
    sig = inspect.signature(astm_sastm_RDBSelectExpression.__init__)
    params = list(sig.parameters.keys())



def test_astm_sastm_rdbhostvariableexpression_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBHostVariableExpression)


def test_astm_sastm_rdbhostvariableexpression_constructor_exists():
    assert callable(astm_sastm_RDBHostVariableExpression.__init__)


def test_astm_sastm_rdbhostvariableexpression_constructor_args():
...
def test_astm_sastm_rdbconstraint_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBConstraint)


def test_astm_sastm_rdbconstraint_constructor_exists():
    assert callable(astm_sastm_RDBConstraint.__init__)


def test_astm_sastm_rdbconstraint_constructor_args():
...
def test_astm_sastm_rdbtrigger_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBTrigger)


def test_astm_sastm_rdbtrigger_constructor_exists():
    assert callable(astm_sastm_RDBTrigger.__init__)


def test_astm_sastm_rdbtrigger_constructor_args():
...
def test_astm_sastm_rdbindexcolumn_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBIndexColumn)


def test_astm_sastm_rdbindexcolumn_constructor_exists():
    assert callable(astm_sastm_RDBIndexColumn.__init__)


def test_astm_sastm_rdbindexcolumn_constructor_args():
...
def test_astm_sastm_rdbindexcolumn_has_AscendingOrDescending():
    assert hasattr(astm_sastm_RDBIndexColumn, "AscendingOrDescending")
    descriptor = None
    for klass in astm_sastm_RDBIndexColumn.__mro__:
...
def test_astm_sastm_rdbviewdefinition_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBViewDefinition)


def test_astm_sastm_rdbviewdefinition_constructor_exists():
    assert callable(astm_sastm_RDBViewDefinition.__init__)


def test_astm_sastm_rdbviewdefinition_constructor_args():
...
def test_rdbtrigger_is_not_abstract():
    assert not inspect.isabstract(RDBTrigger)


def test_rdbtrigger_constructor_exists():
    assert callable(RDBTrigger.__init__)


def test_rdbtrigger_constructor_args():
    sig = inspect.signature(RDBTrigger.__init__)
    params = list(sig.parameters.keys())



def test_rdbindex_is_not_abstract():
    assert not inspect.isabstract(RDBIndex)


def test_rdbindex_constructor_exists():
    assert callable(RDBIndex.__init__)


def test_rdbindex_constructor_args():
...
def test_astm_sastm_rdbuniquekey_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBUniqueKey)


def test_astm_sastm_rdbuniquekey_constructor_exists():
    assert callable(astm_sastm_RDBUniqueKey.__init__)


def test_astm_sastm_rdbuniquekey_constructor_args():
    sig = inspect.signature(astm_sastm_RDBUniqueKey.__init__)
    params = list(sig.parameters.keys())



def test_astm_sastm_rdbrefintegrity_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBRefIntegrity)


def test_astm_sastm_rdbrefintegrity_constructor_exists():
    assert callable(astm_sastm_RDBRefIntegrity.__init__)


def test_astm_sastm_rdbrefintegrity_constructor_args():
    sig = inspect.signature(astm_sastm_RDBRefIntegrity.__init__)
    params = list(sig.parameters.keys())



def test_astm_sastm_rdbcheckconstraint_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBCheckConstraint)


def test_astm_sastm_rdbcheckconstraint_constructor_exists():
    assert callable(astm_sastm_RDBCheckConstraint.__init__)


def test_astm_sastm_rdbcheckconstraint_constructor_args():
...
def test_astm_sastm_rdbcheckconstraint_has_RDBConstraintText():
    assert hasattr(astm_sastm_RDBCheckConstraint, "RDBConstraintText")
    descriptor = None
    for klass in astm_sastm_RDBCheckConstraint.__mro__:
        if "RDBConstraintText" in klass.__dict__:
            descriptor = klass.__dict__["RDBConstraintText"]
            break
    assert isinstance(descriptor, property)

def test_astm_sastm_rdbcheckconstraint_has_RDBConstraintType():
    assert hasattr(astm_sastm_RDBCheckConstraint, "RDBConstraintType")
    descriptor = None
    for klass in astm_sastm_RDBCheckConstraint.__mro__:
...
def test_rdbcolumndefinition_is_not_abstract():
    assert not inspect.isabstract(RDBColumnDefinition)


def test_rdbcolumndefinition_constructor_exists():
    assert callable(RDBColumnDefinition.__init__)


def test_rdbcolumndefinition_constructor_args():
    sig = inspect.signature(RDBColumnDefinition.__init__)
    params = list(sig.parameters.keys())



def test_rdbcolumnreference_is_not_abstract():
    assert not inspect.isabstract(RDBColumnReference)


def test_rdbcolumnreference_constructor_exists():
    assert callable(RDBColumnReference.__init__)


def test_rdbcolumnreference_constructor_args():
    sig = inspect.signature(RDBColumnReference.__init__)
    params = list(sig.parameters.keys())



def test_astm_sastm_rdbtabledefinition_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBTableDefinition)


def test_astm_sastm_rdbtabledefinition_constructor_exists():
    assert callable(astm_sastm_RDBTableDefinition.__init__)


def test_astm_sastm_rdbtabledefinition_constructor_args():
    sig = inspect.signature(astm_sastm_RDBTableDefinition.__init__)
    params = list(sig.parameters.keys())



def test_astm_sastm_rdbtablespacedefinition_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBTableSpaceDefinition)


def test_astm_sastm_rdbtablespacedefinition_constructor_exists():
    assert callable(astm_sastm_RDBTableSpaceDefinition.__init__)


def test_astm_sastm_rdbtablespacedefinition_constructor_args():
...
def test_astm_sastm_rdbuserdefinition_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBUserDefinition)


def test_astm_sastm_rdbuserdefinition_constructor_exists():
    assert callable(astm_sastm_RDBUserDefinition.__init__)


def test_astm_sastm_rdbuserdefinition_constructor_args():
    sig = inspect.signature(astm_sastm_RDBUserDefinition.__init__)
    params = list(sig.parameters.keys())



def test_astm_sastm_rdbtablespacereference_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBTableSpaceReference)


def test_astm_sastm_rdbtablespacereference_constructor_exists():
    assert callable(astm_sastm_RDBTableSpaceReference.__init__)


def test_astm_sastm_rdbtablespacereference_constructor_args():
...
def test_astm_sastm_rdbdatabasedefinition_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBDatabaseDefinition)


def test_astm_sastm_rdbdatabasedefinition_constructor_exists():
    assert callable(astm_sastm_RDBDatabaseDefinition.__init__)


def test_astm_sastm_rdbdatabasedefinition_constructor_args():
...
def test_astm_sastm_rdbindex_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBIndex)


def test_astm_sastm_rdbindex_constructor_exists():
    assert callable(astm_sastm_RDBIndex.__init__)


def test_astm_sastm_rdbindex_constructor_args():
    sig = inspect.signature(astm_sastm_RDBIndex.__init__)
    params = list(sig.parameters.keys())
    assert "NotNull" in params, "Missing parameter 'NotNull'"
    assert "IsUnique" in params, "Missing parameter 'IsUnique'"

def test_astm_sastm_rdbindex_has_NotNull():
    assert hasattr(astm_sastm_RDBIndex, "NotNull")
    descriptor = None
    for klass in astm_sastm_RDBIndex.__mro__:
        if "NotNull" in klass.__dict__:
            descriptor = klass.__dict__["NotNull"]
            break
    assert isinstance(descriptor, property)

def test_astm_sastm_rdbindex_has_IsUnique():
    assert hasattr(astm_sastm_RDBIndex, "IsUnique")
    descriptor = None
    for klass in astm_sastm_RDBIndex.__mro__:
...
def test_astm_sastm_rdbcursordefinition_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBCursorDefinition)


def test_astm_sastm_rdbcursordefinition_constructor_exists():
    assert callable(astm_sastm_RDBCursorDefinition.__init__)


def test_astm_sastm_rdbcursordefinition_constructor_args():
...
def test_astm_gastm_integerlliteral_is_not_abstract():
    assert not inspect.isabstract(astm_gastm_IntegerlLiteral)


def test_astm_gastm_integerlliteral_constructor_exists():
    assert callable(astm_gastm_IntegerlLiteral.__init__)


def test_astm_gastm_integerlliteral_constructor_args():
...
def test_astm_sastm_rdbtablereference_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBTableReference)


def test_astm_sastm_rdbtablereference_constructor_exists():
    assert callable(astm_sastm_RDBTableReference.__init__)


def test_astm_sastm_rdbtablereference_constructor_args():
    sig = inspect.signature(astm_sastm_RDBTableReference.__init__)
    params = list(sig.parameters.keys())



def test_astm_sastm_rdbcolumnreference_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBColumnReference)


def test_astm_sastm_rdbcolumnreference_constructor_exists():
    assert callable(astm_sastm_RDBColumnReference.__init__)


def test_astm_sastm_rdbcolumnreference_constructor_args():
    sig = inspect.signature(astm_sastm_RDBColumnReference.__init__)
    params = list(sig.parameters.keys())



def test_astm_sastm_rdbtablealias_is_not_abstract():
    assert not inspect.isabstract(astm_sastm_RDBTableAlias)


def test_astm_sastm_rdbtablealias_constructor_exists():
    assert callable(astm_sastm_RDBTableAlias.__init__)


def test_astm_sastm_rdbtablealias_constructor_args():
...
@given(instance=astm_sastm_RDBIndexColumn_strategy)
def test_astm_sastm_rdbindexcolumn_AscendingOrDescending_setter(instance):
...
@given(instance=astm_sastm_RDBColumnDefinition_strategy)
def test_astm_sastm_rdbcolumndefinition_NotNull_setter(instance):
...
@given(instance=astm_sastm_RDBCheckConstraint_strategy)
def test_astm_sastm_rdbcheckconstraint_RDBConstraintText_setter(instance):
...
@given(instance=astm_sastm_RDBCheckConstraint_strategy)
def test_astm_sastm_rdbcheckconstraint_RDBConstraintType_setter(instance):
...
@given(instance=astm_sastm_RDBIndex_strategy)
def test_astm_sastm_rdbindex_NotNull_setter(instance):
    original = instance.NotNull
    instance.NotNull = original
    assert instance.NotNull == original
...
@given(instance=astm_sastm_RDBIndex_strategy)
def test_astm_sastm_rdbindex_IsUnique_setter(instance):
