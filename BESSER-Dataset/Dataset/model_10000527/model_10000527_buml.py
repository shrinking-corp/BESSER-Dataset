...
Order.attributes={Order_shipped, Order_number, Order_status, Order_total, Order_shipTo, Order_ordered}
...
domain_model = DomainModel(
    name="_405b055a_c1f9_4ebc_a70b_30a8685c5eea",
    types={Payment, ShoppingCart, Account, WebUser, Order, LineItem, Product, Customer, UserState, OrderStatus},
