...
# Classes
testFramework_IDENTIFIER = Class(name="testFramework_IDENTIFIER")
testFramework_LABEL = Class(name="testFramework_LABEL")
testFramework_Model = Class(name="testFramework_Model")
testFramework_Greeting = Class(name="testFramework_Greeting")
testFramework_FIRSTACTION = Class(name="testFramework_FIRSTACTION")
testFramework_TABLEACTION = Class(name="testFramework_TABLEACTION")
...
testFramework_Greeting.attributes={testFramework_Greeting_testcaseValue, testFramework_Greeting_summaryDetails}
...
domain_model = DomainModel(
    name="testFramework",
    types={testFramework_IDENTIFIER, testFramework_LABEL, testFramework_Model, testFramework_Greeting, testFramework_FIRSTACTION, testFramework_TABLEACTION},
    associations={identifierAction5, nextAction7, greetings0, action1, nextAction3},
    generalizations={},
    metadata=None
)
