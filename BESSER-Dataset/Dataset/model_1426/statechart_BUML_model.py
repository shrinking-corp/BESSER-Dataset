...
statechart_InitialState = Class(name="statechart_InitialState")
statechart_ModelElement = Class(name="statechart_ModelElement", is_abstract=True)
statechart_Transition = Class(name="statechart_Transition")
ModelElement = Class(name="ModelElement")
statechart_AbstractState = Class(name="statechart_AbstractState", is_abstract=True)
...
outgoing4: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_", type=statechart_Transition, multiplicity=Multiplicity(0, 9999))
    }
)
...
domain_model = DomainModel(
    name="statechart",
    types={statechart_Action, statechart_CompositeState, AbstractState, statechart_StateMachine, statechart_InitialState, statechart_ModelElement, statechart_Transition, ModelElement, statechart_AbstractState, statechart_SimpleState, statechart_FinalState, ActionKind},
    associations={to1, incoming3, outgoing4, actions6, states7, transitions9, state11, from_0},
    generalizations={gen_statechart_AbstractState_ModelElement, gen_statechart_CompositeState_AbstractState, gen_statechart_InitialState_AbstractState, gen_statechart_Transition_ModelElement, gen_statechart_SimpleState_AbstractState, gen_statechart_FinalState_AbstractState},
    metadata=None
)
