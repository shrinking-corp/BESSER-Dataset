...
class statechart_Transition(ModelElement):
    ...
    def __init__(self, event: str, guard: str, statechart_Transition: "statechart_CompositeState" = None, outgoing: "statechart_AbstractState" = None, incoming: "statechart_AbstractState" = None, Transition: "statechart_AbstractState" = None, Transition5: "statechart_AbstractState" = None):
        self.event = event
        self.guard = guard
