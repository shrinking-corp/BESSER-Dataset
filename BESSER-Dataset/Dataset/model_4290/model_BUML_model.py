...
# Classes
model_Innings = Class(name="model_Innings")
model_Team = Class(name="model_Team")
model_Over = Class(name="model_Over")
model_Player = Class(name="model_Player")
model_Ball = Class(name="model_Ball")
model_Game = Class(name="model_Game")
model_WicketBall = Class(name="model_WicketBall")
Ball = Class(name="Ball")
model_ExtraBall = Class(name="model_ExtraBall")
...
model_Innings_m_newOver: Method = Method(name="newOver", parameters={Parameter(name='model_bowler', type=StringType)}, type=StringType)
model_Innings.attributes={model_Innings_overCount, model_Innings_total, model_Innings_wicketsDown, model_Innings_noOvers, model_Innings_Summary}
...
model_Over.attributes={model_Over_isComplete, model_Over_validBalls, model_Over_runs, model_Over_BALLS_IN_OVER}
...
model_Player.attributes={model_Player_name, model_Player_runsScored, model_Player_noBallsFaced, model_Player_howOut, model_Player_noOversBowled}
...
model_Ball.attributes={model_Ball_switchEnds, model_Ball_runValue, model_Ball_runs}
...
model_ExtraBall.attributes={model_ExtraBall_extraType, model_ExtraBall_isValidBall}
...
domain_model = DomainModel(
    name="model",
    types={model_Innings, model_Team, model_Over, model_Player, model_Ball, model_Game, model_WicketBall, Ball, model_ExtraBall, BallType, HowOut, ExtraType},
    associations={innings0, team1, overs3, battingSide4, bowlingSide7, facingBat10, nonFacingBat12, balls15, innings16, bowler17, ballsFaced20, oversBowled21, wicketball23, players24, batsman18, assists27, playerOut29},
