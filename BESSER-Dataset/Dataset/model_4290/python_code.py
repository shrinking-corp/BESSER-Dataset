...
class model_Game:
    ...
    def __init__(self, venue: str, date: date, model_Game: set["model_Innings"] = None, model_Game2: set["model_Team"] = None):
        self.venue = venue
        self.date = date
...
class model_Player:
    ...
    def __init__(self, name: str, runsScored: int, noOversBowled: str, noBallsFaced: int, howOut: str, model_Player: "model_Innings" = None, model_Player14: "model_Innings" = None, Player: "model_Over" = None, batsman: set["model_Ball"] = None, bowler: set["model_Over"] = None, playerOut: "model_WicketBall" = None, model_Player26: "model_Team" = None, Player19: "model_Ball" = None, model_Player28: "model_WicketBall" = None, Player30: "model_WicketBall" = None):
        self.name = name
...
class model_Over:
    ...
    def __init__(self, runs: int, BALLS_IN_OVER: int, validBalls: int, isComplete: bool, Over: "model_Innings" = None, model_Over: set["model_Ball"] = None, overs: "model_Innings" = None, oversBowled: "model_Player" = None, Over22: "model_Player" = None):
        self.runs = runs
...
class model_Innings:
    ...
    def __init__(self, noOvers: int, total: int, wicketsDown: int, overCount: str, Summary: str, model_Innings: "model_Game" = None, innings: set["model_Over"] = None, model_Innings5: "model_Team" = None, model_Innings8: "model_Team" = None, model_Innings11: "model_Player" = None, model_Innings13: "model_Player" = None, Innings: "model_Over" = None):
