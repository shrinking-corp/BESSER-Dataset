...
public class viewpoint_UIState  {
    ...
    public viewpoint_UIState(
        String decorationImage,        boolean inverseSelectionOrder    ) {
    ...
    public viewpoint_UIState(
        String decorationImage,        boolean inverseSelectionOrder        ArrayList<viewpoint_EObject> viewpoint_eobjects    ) {
        this.decorationImage = decorationImage;
        this.inverseSelectionOrder = inverseSelectionOrder;
