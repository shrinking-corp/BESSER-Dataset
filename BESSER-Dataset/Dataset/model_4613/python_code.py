...
class viewpoint_tool_ExternalJavaAction(tool_ContainerModelOperation, tool_MenuItemDescription):
    ...
    def __init__(self, id: str, viewpoint_tool_ExternalJavaAction: set["tool_ExternalJavaActionParameter"] = None, tool_MenuItemDescription194: "viewpoint_tool_PopupMenu" = None, tool_MenuItemDescription: "viewpoint_tool_MenuItemDescriptionReference" = None):
        self.id = id
...
class viewpoint_tool_SelectionWizardDescription(description_SelectionDescription, tool_AbstractToolDescription):
    ...
    def __init__(self, iconPath: str, windowTitle: str, windowImagePath: str, viewpoint_tool_SelectionWizardDescription: "tool_ElementSelectVariable" = None, viewpoint_tool_SelectionWizardDescription146: "tool_ContainerViewVariable" = None, viewpoint_tool_SelectionWizardDescription149: "tool_SelectContainerVariable" = None, viewpoint_tool_SelectionWizardDescription151: "tool_InitialOperation" = None):
...
class viewpoint_tool_PaneBasedSelectionWizardDescription(AbstractToolDescription):
    ...
    def __init__(self, iconPath: str, childrenExpression: str, selectedValuesMessage: str, preSelectedCandidatesExpression: str, windowTitle: str, windowImagePath: str, message: str, choiceOfValuesMessage: str, candidatesExpression: str, tree: bool, rootExpression: str, viewpoint_tool_PaneBasedSelectionWizardDescription: "tool_ElementSelectVariable" = None, viewpoint_tool_PaneBasedSelectionWizardDescription156: "tool_ContainerViewVariable" = None, viewpoint_tool_PaneBasedSelectionWizardDescription159: "tool_SelectContainerVariable" = None, viewpoint_tool_PaneBasedSelectionWizardDescription162: "tool_InitialOperation" = None):
        self.iconPath = iconPath
...
class viewpoint_tool_RepresentationNavigationDescription(AbstractToolDescription):
    ...
    def __init__(self, browseExpression: str, navigationNameExpression: str, viewpoint_tool_RepresentationNavigationDescription183: "tool_NameVariable" = None, viewpoint_tool_RepresentationNavigationDescription: "RepresentationDescription" = None, viewpoint_tool_RepresentationNavigationDescription177: "tool_ContainerViewVariable" = None, viewpoint_tool_RepresentationNavigationDescription180: "tool_ElementSelectVariable" = None):
        self.browseExpression = browseExpression
...
class viewpoint_tool_PasteDescription(MappingBasedToolDescription):
    ...
    def __init__(self, viewpoint_tool_PasteDescription136: "tool_ElementViewVariable" = None, viewpoint_tool_PasteDescription139: "tool_ElementVariable" = None, viewpoint_tool_PasteDescription142: "tool_InitialOperation" = None, viewpoint_tool_PasteDescription: "tool_DropContainerVariable" = None, viewpoint_tool_PasteDescription134: "tool_ContainerViewVariable" = None):
...
class viewpoint_description_EAttributeCustomization(EStructuralFeatureCustomization):
    ...
    def __init__(self, attributeName: str, value: str, EStructuralFeatureCustomization: "viewpoint_description_VSMElementCustomization" = None, EStructuralFeatureCustomization103: "viewpoint_description_VSMElementCustomizationReuse" = None):
...
class viewpoint_description_EReferenceCustomization(EStructuralFeatureCustomization):
    ...
    def __init__(self, referenceName: str, viewpoint_description_EReferenceCustomization: "description_viewpoint_EObject" = None, EStructuralFeatureCustomization: "viewpoint_description_VSMElementCustomization" = None, EStructuralFeatureCustomization103: "viewpoint_description_VSMElementCustomizationReuse" = None):
...
class viewpoint_description_DecorationDescription(ABC):
    ...
    def __init__(self, preconditionExpression: str, imageExpression: str, tooltipExpression: str, name: str, position: str, distributionDirection: str):
...
class viewpoint_validation_ValidationRule(IdentifiedElement):
    ...
    def __init__(self, level: str, message: str, viewpoint_validation_ValidationRule221: set["validation_ValidationFix"] = None, viewpoint_validation_ValidationRule: set["validation_RuleAudit"] = None):
        self.level = level
        self.message = message
...
class viewpoint_description_ConditionalStyleDescription(ABC):
    ...
    def checkPredicate(self, viewpoint_containerVariable, viewpoint_viewVariable, viewpoint_modelElement) :
...
class viewpoint_DAnalysisSessionEObject:
    ...
    def __init__(self, synchronizationStatus: str, open: bool, resources: str, controlledResources: str, viewpoint_DAnalysisSessionEObject: set["Viewpoint"] = None, viewpoint_DAnalysisSessionEObject55: set["viewpoint_DAnalysis"] = None, viewpoint_DAnalysisSessionEObject58: "viewpoint_SessionManagerEObject" = None):
...
class viewpoint_description_SemanticBasedDecoration(DecorationDescription):
    ...
    def __init__(self, domainClass: str, DecorationDescription99: "viewpoint_description_DecorationDescriptionsSet" = None, DecorationDescription: "viewpoint_Decoration" = None):
        self.domainClass = domainClass
...
class viewpoint_UIState:
    ...
    def __init__(self, inverseSelectionOrder: bool, decorationImage: str, viewpoint_UIState: "viewpoint_DRepresentation" = None, viewpoint_UIState61: set["viewpoint_EObject"] = None):
        self.inverseSelectionOrder = inverseSelectionOrder
...
class viewpoint_Style(Customizable, DRefreshable):
    ...
    pass
class viewpoint_DRepresentationElement(DStylizable, DMappingBased, DSemanticDecorator, DRefreshable):

    def __init__(self, name: str, viewpoint_DRepresentationElement33: set["viewpoint_EObject"] = None, viewpoint_DRepresentationElement: "viewpoint_DRepresentation" = None, viewpoint_DRepresentationElement27: "viewpoint_DRepresentation" = None):
        self.name = name
...
class viewpoint_tool_ToolEntry(description_DocumentedElement, description_IdentifiedElement):
    ...
    pass
class viewpoint_description_Viewpoint(description_EndUserDocumentedElement, description_DocumentedElement, description_Component, description_IdentifiedElement):

    def __init__(self, icon: str, conflicts: str, reuses: str, customizes: str, modelFileExtension: str, viewpoint_description_Viewpoint: "validation_ValidationSet" = None, viewpoint_description_Viewpoint73: set["RepresentationDescription"] = None, viewpoint_description_Viewpoint76: set["RepresentationExtensionDescription"] = None, viewpoint_description_Viewpoint78: set["JavaExtension"] = None, viewpoint_description_Viewpoint80: set["MetamodelExtensionSetting"] = None, viewpoint_description_Viewpoint82: set["FeatureExtensionDescription"] = None, viewpoint_description_Viewpoint85: set["RepresentationTemplate"] = None):
        self.icon = icon
...
class viewpoint_DAnalysis:
    ...
    def __init__(self, semanticResources: str, version: str, viewpoint_DAnalysis56: "viewpoint_DAnalysisSessionEObject" = None, viewpoint_DAnalysis: "viewpoint_DAnalysis" = None, viewpoint_DAnalysis0: set["viewpoint_DAnalysis"] = None, viewpoint_DAnalysis3: set["viewpoint_EObject"] = None, viewpoint_DAnalysis5: set["DAnnotationEntry"] = None, viewpoint_DAnalysis7: set["viewpoint_DView"] = None, viewpoint_DAnalysis9: set["viewpoint_DView"] = None, viewpoint_DAnalysis12: set["viewpoint_DFeatureExtension"] = None):
