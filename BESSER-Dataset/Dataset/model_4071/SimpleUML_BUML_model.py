...
uml_PackageElement = Class(name="uml_PackageElement", is_abstract=True)
uml_PrimitiveDataType = Class(name="uml_PrimitiveDataType")
uml_UMLModelElement = Class(name="uml_UMLModelElement", is_abstract=True)
...
uml_UMLModelElement.attributes={uml_UMLModelElement_name, uml_UMLModelElement_kind}
...
domain_model = DomainModel(
    name="uml",
    types={uml_Package, uml_Attribute, UMLModelElement, uml_Class, uml_Classifier, uml_Association, PackageElement, Classifier, uml_PackageElement, uml_PrimitiveDataType, uml_UMLModelElement},
    associations={typeOpposite16, owner0, type1, destination2, source4, attributes6, forward7, general9, generalOpposite12, reverse14, elements18, namespace19},
    generalizations={gen_uml_Package_UMLModelElement, gen_uml_Attribute_UMLModelElement, gen_uml_Association_PackageElement, gen_uml_Class_Classifier, gen_uml_Classifier_PackageElement, gen_uml_PackageElement_UMLModelElement, gen_uml_PrimitiveDataType_Classifier},
    metadata=None
)
