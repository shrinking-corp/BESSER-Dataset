...
# Classes
conversation_Conversation = Class(name="conversation_Conversation")
conversation_State = Class(name="conversation_State")
conversation_Transition = Class(name="conversation_Transition")
conversation_Agent = Class(name="conversation_Agent")
conversation_Projection = Class(name="conversation_Projection")
conversation_RestService = Class(name="conversation_RestService")
conversation_Service = Class(name="conversation_Service")
conversation_TypeImport = Class(name="conversation_TypeImport")
conversation_AgentImport = Class(name="conversation_AgentImport")
conversation_View = Class(name="conversation_View")
conversation_StateMachine = Class(name="conversation_StateMachine")
conversation_PubliclySubscribable = Class(name="conversation_PubliclySubscribable")
conversation_PublishableByMe = Class(name="conversation_PublishableByMe", is_abstract=True)
conversation_Event = Class(name="conversation_Event", is_abstract=True)
conversation_Decision = Class(name="conversation_Decision")
State = Class(name="State")
conversation_SubscribableByOthers = Class(name="conversation_SubscribableByOthers", is_abstract=True)
conversation_PrivatePubSub = Class(name="conversation_PrivatePubSub")
conversation_PublishableByOthers = Class(name="conversation_PublishableByOthers", is_abstract=True)
conversation_PublicPubSub = Class(name="conversation_PublicPubSub")
...
conversation_Import = Class(name="conversation_Import")
conversation_ProjectionField = Class(name="conversation_ProjectionField")
Event = Class(name="Event")
conversation_SubscribableByMe = Class(name="conversation_SubscribableByMe", is_abstract=True)
conversation_PublicEvent = Class(name="conversation_PublicEvent", is_abstract=True)
conversation_PubliclyPublishable = Class(name="conversation_PubliclyPublishable")
...
conversation_Join = Class(name="conversation_Join")
conversation_Junction = Class(name="conversation_Junction")
...
conversation_Agent.attributes={conversation_Agent_accessRequirement, conversation_Agent_stateMachineType, conversation_Agent_name, conversation_Agent_connectionType}
...
domain_model = DomainModel(
    name="conversation",
    types={conversation_Conversation, conversation_State, conversation_Transition, conversation_Agent, conversation_Projection, conversation_RestService, conversation_Service, conversation_TypeImport, conversation_AgentImport, conversation_View, conversation_StateMachine, conversation_PubliclySubscribable, conversation_PublishableByMe, conversation_Event, conversation_Decision, State, conversation_SubscribableByOthers, conversation_PrivatePubSub, conversation_PublishableByOthers, conversation_PublicPubSub, PubliclyPublishable, PubliclySubscribable, Import, conversation_Import, conversation_ProjectionField, Event, conversation_SubscribableByMe, conversation_PublicEvent, conversation_PubliclyPublishable, SubscribableByMe, PublishableByOthers, PublicEvent, PublishableByMe, SubscribableByOthers, conversation_Join, conversation_Junction, StateMachineType, ConnectionType},
    associations={sendables16, parent18, projection19, initialState22, states23, parent25, agents0, definedTypes1, restServices2, services4, importedTypes6, importedAgents8, views10, definedTypes12, stateMachine14, triggers44, initialTransition27, refType29, transitions31, parent34, toState36, exCausedBy39, causedBy41, exTriggers42, agent51, type54, fieldMapping46, parent48, transition50, joins57, message58, fieldMapping61},
    generalizations={gen_conversation_Decision_State, gen_conversation_PublicPubSub_PubliclyPublishable, gen_conversation_PublicPubSub_PubliclySubscribable, gen_conversation_AgentImport_Import, gen_conversation_TypeImport_Import, gen_conversation_SubscribableByOthers_Event, gen_conversation_PublishableByOthers_Event, gen_conversation_SubscribableByMe_Event, gen_conversation_PublishableByMe_Event, gen_conversation_PublicEvent_Event, gen_conversation_PubliclyPublishable_SubscribableByMe, gen_conversation_PubliclyPublishable_PublishableByOthers, gen_conversation_PubliclyPublishable_PublicEvent, gen_conversation_PubliclySubscribable_PublishableByMe, gen_conversation_PubliclySubscribable_SubscribableByOthers, gen_conversation_PubliclySubscribable_PublicEvent, gen_conversation_PrivatePubSub_PublishableByMe, gen_conversation_PrivatePubSub_SubscribableByMe, gen_conversation_Join_State},
    metadata=None
)
