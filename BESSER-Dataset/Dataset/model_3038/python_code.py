...
class SubscribableByMe:
    ...
    pass
class conversation_PubliclyPublishable(PublicEvent, PublishableByOthers, SubscribableByMe):
...
class conversation_PublishableByOthers(Event):
    ...
    pass
class conversation_PrivatePubSub(PublishableByMe, SubscribableByMe):
...
class conversation_PublishableByMe(Event):
    ...
    pass
class conversation_PubliclySubscribable(PublicEvent, PublishableByMe, SubscribableByOthers):
...
class conversation_Agent:
    ...
    def __init__(self, stateMachineType: str, connectionType: str, accessRequirement: str, name: str, parent17: set["conversation_PubliclySubscribable"] = None, agents: "conversation_Conversation" = None, conversation_Agent20: "conversation_Projection" = None, Agent26: "conversation_StateMachine" = None, Agent: "conversation_Conversation" = None, conversation_Agent: set["conversation_Projection"] = None, parent15: "conversation_StateMachine" = None, conversation_Agent53: "conversation_AgentImport" = None, Agent49: "conversation_PubliclySubscribable" = None):
...
class conversation_Transition:
    ...
    def __init__(self, requiresExecution: bool, conversation_Transition45: "conversation_PublishableByMe" = None, conversation_Transition: "conversation_StateMachine" = None, conversation_Transition33: "conversation_State" = None, conversation_Transition37: "conversation_State" = None, conversation_Transition40: "conversation_SubscribableByOthers" = None, transition: "conversation_PrivatePubSub" = None, conversation_Transition43: "conversation_PublishableByOthers" = None, conversation_Transition47: "conversation_ProjectionField" = None, Transition: "conversation_PrivatePubSub" = None):
...
class conversation_State:
    ...
    def __init__(self, name: str, requiresExecution: bool, join: bool, conversation_State: "conversation_StateMachine" = None, State: "conversation_StateMachine" = None, conversation_State32: set["conversation_Transition"] = None, states: "conversation_StateMachine" = None, conversation_State38: "conversation_Transition" = None):
        self.name = name
        self.requiresExecution = requiresExecution
        self.join = join
...
class conversation_Conversation:
    ...
    def __init__(self, name: str, Conversation: "conversation_Agent" = None, parent: set["conversation_Agent"] = None, conversation_Conversation: set["conversation_Projection"] = None, conversation_Conversation3: set["conversation_RestService"] = None, conversation_Conversation5: set["conversation_Service"] = None, conversation_Conversation7: set["conversation_TypeImport"] = None, conversation_Conversation9: set["conversation_AgentImport"] = None, conversation_Conversation11: set["conversation_View"] = None):
        self.name = name
