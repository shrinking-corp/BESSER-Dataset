...
revision_PublicationPhase.attributes={revision_PublicationPhase_minTime, revision_PublicationPhase_name, revision_PublicationPhase_maxTime}
...
domain_model = DomainModel(
    name="revision",
    types={revision_Sequence, revision_Researcher, revision_PlaceHolderPP, revision_PublicationProcess, Named, revision_PublicationPhase, revision_Rule, revision_Review, revision_Paper, revision_PlaceHolderRs, revision_Paragraph, revision_Progress, Counted, revision_ReviewNote, revision_PlaceHolderRule, revision_Write, revision_PublicationStructure, revision_PublicationSystem, revision_Named, revision_Counted, revision_Labelled, revision_PlaceHolderRn, Labelled, PlaceHolder, revision_PlaceHolder, SequenceType},
    associations={publicationRules1, linksToSuccessors3, neededPerson5, rules6, placeholder9, successor11, predecessor14, phases0, reviews21, papers23, placeholder24, paragraphs26, progress27, authors28, reviews30, placeholder17, phaseParticipation19, writes20, reviewNote41, researchers44, papers46, processView49, structuralView51, placeholder32, process34, paper36, paragraph38},
    generalizations={gen_revision_PublicationProcess_Named, gen_revision_Paper_Named, gen_revision_Paragraph_Counted, gen_revision_Paragraph_Named, gen_revision_ReviewNote_Named, gen_revision_PublicationStructure_Named, gen_revision_Progress_Labelled, gen_revision_Write_Labelled, gen_revision_Review_Labelled, gen_revision_PlaceHolderRs_PlaceHolder, gen_revision_PlaceHolderRule_PlaceHolder, gen_revision_PlaceHolderRn_PlaceHolder, gen_revision_PlaceHolderPP_PlaceHolder},
    metadata=None
)
