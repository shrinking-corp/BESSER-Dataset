...
class revision_ReviewNote(Named):
    ...
    def __init__(self, content: str, revision_ReviewNote: "revision_Paragraph" = None, revision_ReviewNote43: "revision_Review" = None, revision_ReviewNote33: "revision_PlaceHolderRn" = None):
        self.content = content
...
class revision_PublicationProcess(Named):
    ...
    def __init__(self, minTime: int, maxTime: int, revision_PublicationProcess2: set["revision_Rule"] = None, revision_PublicationProcess: set["revision_PublicationPhase"] = None, revision_PublicationProcess50: "revision_PublicationSystem" = None, revision_PublicationProcess35: "revision_Progress" = None):
        self.minTime = minTime
        self.maxTime = maxTime
...
class revision_Researcher:
    ...
    def __init__(self, name: str, forName: str, position: str, Researcher: "revision_PublicationPhase" = None, revision_Researcher22: set["revision_Review"] = None, authors: set["revision_Paper"] = None, revision_Researcher25: "revision_PlaceHolderRs" = None, Researcher29: "revision_Paper" = None, neededPerson: set["revision_PublicationPhase"] = None, revision_Researcher: set["revision_Write"] = None, revision_Researcher45: "revision_PublicationStructure" = None):
        self.name = name
