...
# Classes
superimposed_OclExpression = Class(name="superimposed_OclExpression", is_abstract=True)
superimposed_VariableDeclaration = Class(name="superimposed_VariableDeclaration")
superimposed_OclType = Class(name="superimposed_OclType")
superimposed_VariableExp = Class(name="superimposed_VariableExp")
OclExpression = Class(name="OclExpression")
superimposed_OclUndefinedExp = Class(name="superimposed_OclUndefinedExp")
superimposed_LetExp = Class(name="superimposed_LetExp")
superimposed_PropertyCallExp = Class(name="superimposed_PropertyCallExp", is_abstract=True)
superimposed_OperationCallExp = Class(name="superimposed_OperationCallExp")
PropertyCallExp = Class(name="PropertyCallExp")
superimposed_CollectionOperationCallExp = Class(name="superimposed_CollectionOperationCallExp")
OperationCallExp = Class(name="OperationCallExp")
superimposed_NavigationCallExp = Class(name="superimposed_NavigationCallExp")
superimposed_IfExp = Class(name="superimposed_IfExp")
superimposed_OperatorCallExp = Class(name="superimposed_OperatorCallExp", is_abstract=True)
superimposed_BinaryOperatorCallExp = Class(name="superimposed_BinaryOperatorCallExp")
OperatorCallExp = Class(name="OperatorCallExp")
superimposed_UnaryOperatorCallExp = Class(name="superimposed_UnaryOperatorCallExp")
superimposed_LoopExp = Class(name="superimposed_LoopExp", is_abstract=True)
superimposed_IteratorExp = Class(name="superimposed_IteratorExp")
LoopExp = Class(name="LoopExp")
superimposed_Iterator = Class(name="superimposed_Iterator")
VariableDeclaration = Class(name="VariableDeclaration")
superimposed_PrimitiveExp = Class(name="superimposed_PrimitiveExp", is_abstract=True)
superimposed_StringExp = Class(name="superimposed_StringExp")
PrimitiveExp = Class(name="PrimitiveExp")
superimposed_BooleanExp = Class(name="superimposed_BooleanExp")
superimposed_NumericExp = Class(name="superimposed_NumericExp", is_abstract=True)
superimposed_RealExp = Class(name="superimposed_RealExp")
NumericExp = Class(name="NumericExp")
superimposed_IntegerExp = Class(name="superimposed_IntegerExp")
superimposed_OclModelElement = Class(name="superimposed_OclModelElement")
OclType = Class(name="OclType")
superimposed_OclModel = Class(name="superimposed_OclModel")
superimposed_CollectionExp = Class(name="superimposed_CollectionExp", is_abstract=True)
superimposed_SetExp = Class(name="superimposed_SetExp")
...
domain_model = DomainModel(
    name="superimposed",
    types={superimposed_OclExpression, superimposed_VariableDeclaration, superimposed_OclType, superimposed_VariableExp, OclExpression, superimposed_OclUndefinedExp, superimposed_LetExp, superimposed_PropertyCallExp, superimposed_OperationCallExp, PropertyCallExp, superimposed_CollectionOperationCallExp, OperationCallExp, superimposed_NavigationCallExp, superimposed_IfExp, superimposed_OperatorCallExp, superimposed_BinaryOperatorCallExp, OperatorCallExp, superimposed_UnaryOperatorCallExp, superimposed_LoopExp, superimposed_IteratorExp, LoopExp, superimposed_Iterator, VariableDeclaration, superimposed_PrimitiveExp, superimposed_StringExp, PrimitiveExp, superimposed_BooleanExp, superimposed_NumericExp, superimposed_RealExp, NumericExp, superimposed_IntegerExp, superimposed_OclModelElement, OclType, superimposed_OclModel, superimposed_CollectionExp, superimposed_SetExp, CollectionExp},
    associations={initExpression0, type1, varDcl3, source25, variable5, in_7, arguments10, thenExpression12, condition14, elseExpression17, source20, argument22, source27, body29, iteratorVar31, model32, elements33},
    generalizations={gen_superimposed_VariableExp_OclExpression, gen_superimposed_OclUndefinedExp_OclExpression, gen_superimposed_LetExp_OclExpression, gen_superimposed_PropertyCallExp_OclExpression, gen_superimposed_OperationCallExp_PropertyCallExp, gen_superimposed_CollectionOperationCallExp_OperationCallExp, gen_superimposed_NavigationCallExp_PropertyCallExp, gen_superimposed_IfExp_OclExpression, gen_superimposed_OperatorCallExp_OclExpression, gen_superimposed_BinaryOperatorCallExp_OperatorCallExp, gen_superimposed_UnaryOperatorCallExp_OperatorCallExp, gen_superimposed_LoopExp_PropertyCallExp, gen_superimposed_IteratorExp_LoopExp, gen_superimposed_Iterator_VariableDeclaration, gen_superimposed_PrimitiveExp_OclExpression, gen_superimposed_StringExp_PrimitiveExp, gen_superimposed_BooleanExp_PrimitiveExp, gen_superimposed_NumericExp_PrimitiveExp, gen_superimposed_RealExp_NumericExp, gen_superimposed_IntegerExp_NumericExp, gen_superimposed_OclType_OclExpression, gen_superimposed_OclModelElement_OclType, gen_superimposed_CollectionExp_OclExpression, gen_superimposed_SetExp_CollectionExp},
    metadata=None
)
