...
tfsm_TimedSystem_m_init: Method = Method(name="init", parameters={})
...
domain_model = DomainModel(
    name="tfsm",
    types={tfsm_State, tfsm_TFSM, NamedElement, tfsm_FSMEvent, tfsm_FSMClock, tfsm_Transition, tfsm_Guard, tfsm_NamedElement, tfsm_TemporalGuard, Guard, tfsm_EventGuard, tfsm_TimedSystem, tfsm_EvaluateGuard},
    associations={ownedStates0, initialState1, localEvents2, localClock4, ownedTransitions6, currentState8, target17, ownedGuard19, owningFSM11, outgoingTransitions12, incomingTransitions13, source15, sollicitingTransitions28, generatedEvents21, onClock24, triggeringEvent26, tfsms31, globalClocks33, globalEvents36},
    generalizations={gen_tfsm_TFSM_NamedElement, gen_tfsm_State_NamedElement, gen_tfsm_Transition_NamedElement, gen_tfsm_FSMClock_NamedElement, gen_tfsm_Guard_NamedElement, gen_tfsm_TemporalGuard_Guard, gen_tfsm_EventGuard_Guard, gen_tfsm_FSMEvent_NamedElement, gen_tfsm_TimedSystem_NamedElement, gen_tfsm_EvaluateGuard_Guard},
    metadata=None
)
