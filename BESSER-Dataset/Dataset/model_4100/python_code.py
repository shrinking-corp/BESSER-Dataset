...
class railway_Semaphore(RailwayElement):
    ...
    def __init__(self, signal: str, railway_Semaphore17: "railway_Route" = None, railway_Semaphore22: "railway_Route" = None, railway_Semaphore: "railway_Segment" = None):
        self.signal = signal
...
class railway_Switch(TrackElement):
    ...
    def __init__(self, currentPosition: str, target: set["railway_SwitchPosition"] = None, railway_Switch: "railway_TrackElement" = None, railway_Switch11: "railway_TrackElement" = None, Switch: "railway_SwitchPosition" = None, railway_Switch14: "railway_TrackElement" = None):
