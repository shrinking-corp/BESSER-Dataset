...
domain_model = DomainModel(
    name="railway",
    types={railway_Route, railway_Segment, TrackElement, railway_Semaphore, railway_TrackElement, RailwayElement, railway_Sensor, railway_Switch, railway_SwitchPosition, railway_RailwayElement, railway_RailwayContainer, railway_Region, Signal, Position},
    associations={from_13, semaphores0, neighbors1, monitoredBy3, connectsTo5, positions7, left8, right10, entry16, follows18, exit20, gathers23, target25, route26, monitors27, routes28, regions30, elements32, sensors35},
    generalizations={gen_railway_Route_RailwayElement, gen_railway_Segment_TrackElement, gen_railway_TrackElement_RailwayElement, gen_railway_Switch_TrackElement, gen_railway_Semaphore_RailwayElement, gen_railway_SwitchPosition_RailwayElement, gen_railway_Sensor_RailwayElement, gen_railway_Region_RailwayElement},
    metadata=None
)
