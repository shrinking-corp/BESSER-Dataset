...
def test_hyp_relational_enumeratedliteral_is_not_abstract():
    assert not inspect.isabstract(Relational_EnumeratedLiteral)


def test_hyp_relational_enumeratedliteral_constructor_exists():
    assert callable(Relational_EnumeratedLiteral.__init__)


def test_hyp_relational_enumeratedliteral_constructor_args():
...
def test_hyp_relational_enumerationtype_is_not_abstract():
    assert not inspect.isabstract(Relational_EnumerationType)


def test_hyp_relational_enumerationtype_constructor_exists():
    assert callable(Relational_EnumerationType.__init__)


def test_hyp_relational_enumerationtype_constructor_args():
    sig = inspect.signature(Relational_EnumerationType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_relational_primitivetype_is_not_abstract():
    assert not inspect.isabstract(Relational_PrimitiveType)


def test_hyp_relational_primitivetype_constructor_exists():
    assert callable(Relational_PrimitiveType.__init__)


def test_hyp_relational_primitivetype_constructor_args():
...
def test_hyp_relational_attribute_is_not_abstract():
    assert not inspect.isabstract(Relational_Attribute)


def test_hyp_relational_attribute_constructor_exists():
    assert callable(Relational_Attribute.__init__)


def test_hyp_relational_attribute_constructor_args():
...
def test_hyp_relational_candidatekey_is_not_abstract():
    assert not inspect.isabstract(Relational_CandidateKey)


def test_hyp_relational_candidatekey_constructor_exists():
    assert callable(Relational_CandidateKey.__init__)


def test_hyp_relational_candidatekey_constructor_args():
...
def test_hyp_relational_enumeratedliteral_name_setter(instance):
...
def test_hyp_relational_attribute_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=Relational_Attribute_strategy)
def test_hyp_relational_attribute_nullable_setter(instance):
...
@given(instance=Relational_Attribute_strategy)
def test_hyp_relational_attribute_multiplicity_setter(instance):
...
@given(instance=Relational_Attribute_strategy)
def test_hyp_relational_attribute_type_setter(instance):
...
def test_hyp_relational_candidatekey_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_relational_constraint_description_setter(instance):
...
@given(instance=Relational_Constraint_strategy)
def test_hyp_relational_constraint_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_relational_domain_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
