...
domainmodel_Feature_not_: Property = Property(name="not_", type=StringType)
...
domainmodel_Feature.attributes={domainmodel_Feature_key, domainmodel_Feature_not_, domainmodel_Feature_name}
