...
def test_hyp_domainmodel_feature_not__setter(instance):
...
@given(instance=domainmodel_Feature_strategy)
def test_hyp_domainmodel_feature_key_setter(instance):
...
def test_domainmodel_Feature_key_value_roundtrip():
    instance = domainmodel_Feature(key="sample_text", name="sample_text", not_="sample_text")
...
def test_domainmodel_Feature_not__value_roundtrip():
    instance = domainmodel_Feature(key="sample_text", name="sample_text", not_="sample_text")
...
def test_assoc_features3_link_reassign_clear():
    a = domainmodel_Feature(key="sample_text", name="sample_text", not_="sample_text")
...
def test_assoc_type5_link_reassign_clear():
    a = domainmodel_Type(name="sample_text")
    b1 = domainmodel_Feature(key="sample_text", name="sample_text", not_="sample_text")
    b2 = domainmodel_Feature(key="sample_text_2", name="sample_text_2", not_="sample_text_2")
...
domainmodel_Feature_strategy = st.builds(domainmodel_Feature, key=safe_text, name=safe_text, not_=safe_text)
@given(instance=domainmodel_Feature_strategy)
@settings(max_examples=25)
