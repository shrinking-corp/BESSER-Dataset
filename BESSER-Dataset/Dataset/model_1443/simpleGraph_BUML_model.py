...
# Classes
simpleGraph_Position = Class(name="simpleGraph_Position")
simpleGraph_Label = Class(name="simpleGraph_Label")
simpleGraph_Nail = Class(name="simpleGraph_Nail")
...
simpleGraph_GraphElement = Class(name="simpleGraph_GraphElement", is_abstract=True)
simpleGraph_Parameter = Class(name="simpleGraph_Parameter")
...
simpleGraph_GraphElement.attributes={simpleGraph_GraphElement_id, simpleGraph_GraphElement_generated}
...
simpleGraph_Parameter.attributes={simpleGraph_Parameter_key, simpleGraph_Parameter_value}
...
domain_model = DomainModel(
    name="simpleGraph",
    types={simpleGraph_Position, simpleGraph_Label, simpleGraph_Nail, simpleGraph_Graph, GraphElement, simpleGraph_Node, simpleGraph_Edge, simpleGraph_GraphElement, simpleGraph_Parameter, Position},
    associations={source4, target7, labels10, nails12, nodes0, edges1, parameters3, label14},
    generalizations={gen_simpleGraph_Position_GraphElement, gen_simpleGraph_Edge_GraphElement, gen_simpleGraph_Graph_GraphElement, gen_simpleGraph_Node_Position, gen_simpleGraph_Label_Position, gen_simpleGraph_Nail_Position},
    metadata=None
)
