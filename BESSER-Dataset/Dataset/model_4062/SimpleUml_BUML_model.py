...
SimpleUML_PackageElement = Class(name="SimpleUML_PackageElement")
...
domain_model = DomainModel(
    ...
    associations={type0, owner1, attribute2, general4, reverse5, forward6, source8, destination10, elements12, namespace13},
    generalizations={gen_SimpleUML_Classifier_PackageElement, gen_SimpleUML_Attribute_UMLModelElement, gen_SimpleUML_Class_Classifier, gen_SimpleUML_Association_PackageElement, gen_SimpleUML_PrimitiveDataType_Classifier, gen_SimpleUML_Package_UMLModelElement, gen_SimpleUML_PackageElement_UMLModelElement},
    metadata=None
)
