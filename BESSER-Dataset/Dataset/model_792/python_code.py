...
class fsm_Transition(NamedElement):
    ...
    def __init__(self, input: str, output: str, letterToMatch: str, outgoingTransition: "fsm_State" = None, incomingTransition: "fsm_State" = None, Transition: "fsm_State" = None, Transition8: "fsm_State" = None):
        self.input = input
        self.output = output
...
class fsm_State(NamedElement):
    ...
    def __init__(self, State10: "fsm_Transition" = None, State12: "fsm_Transition" = None, State: "fsm_FSM" = None, fsm_State: "fsm_FSM" = None, fsm_State4: "fsm_FSM" = None, ownedState: "fsm_FSM" = None, source: set["fsm_Transition"] = None, target: "fsm_Transition" = None):
