...
fsm_Transition.attributes={fsm_Transition_output, fsm_Transition_letterToMatch, fsm_Transition_input}
fsm_Transition.methods={fsm_Transition_m_callEffect, fsm_Transition_m_evaluateGuard, fsm_Transition_m_fire}
...
domain_model = DomainModel(
    name="fsm",
    types={fsm_FSM, NamedElement, fsm_State, fsm_Transition, fsm_NamedElement},
    associations={ownedState0, initialState1, currentState2, owningFSM5, outgoingTransition6, incomingTransition7, source9, target11},
    generalizations={gen_fsm_FSM_NamedElement, gen_fsm_State_NamedElement, gen_fsm_Transition_NamedElement},
    metadata=None
)
