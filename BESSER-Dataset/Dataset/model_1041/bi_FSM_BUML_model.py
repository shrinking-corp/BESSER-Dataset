...
FSM_StartState = Class(name="FSM_StartState")
AbstractState = Class(name="AbstractState")
FSM_State = Class(name="FSM_State")
FSM_EndState = Class(name="FSM_EndState")
...
domain_model = DomainModel(
    ...
    associations={src8, tar10, statemachine12, states0, transitions1, source3, target5, statemachine7},
