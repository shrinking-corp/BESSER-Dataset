...
class FSM_AbstractState(ABC):
    ...
    def __init__(self, name: str, envs: str, AbstractState9: "FSM_Transition" = None, AbstractState: "FSM_StateMachine" = None, src: set["FSM_Transition"] = None, tar: set["FSM_Transition"] = None, states: "FSM_StateMachine" = None, AbstractState11: "FSM_Transition" = None):
        self.name = name
        self.envs = envs
...
class FSM_StateMachine:
    ...
    def __init__(self, code: str, StateMachine13: "FSM_Transition" = None, statemachine: set["FSM_AbstractState"] = None, statemachine2: set["FSM_Transition"] = None, StateMachine: "FSM_AbstractState" = None):
        self.code = code
