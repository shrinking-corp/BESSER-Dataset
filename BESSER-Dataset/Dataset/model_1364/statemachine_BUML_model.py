...
statemachine_Transition.attributes={statemachine_Transition_targetLabel, statemachine_Transition_actionStatement, statemachine_Transition_label, statemachine_Transition_sourceLabel, statemachine_Transition_guardLabel, statemachine_Transition_actionLabel, statemachine_Transition_guardExpression}
...
domain_model = DomainModel(
    name="statemachine",
    types={statemachine_StateMachine, statemachine_Declaration, statemachine_StateMachineVariable, statemachine_Action, statemachine_NormalState, State, statemachine_Transition, Declaration, statemachine_State, statemachine_InitialState, statemachine_FinalState},
    associations={declarations0, machineVariables1, source3, target4, successors8, reachable11, entry13},
    generalizations={gen_statemachine_NormalState_State, gen_statemachine_Transition_Declaration, gen_statemachine_State_Declaration, gen_statemachine_InitialState_State, gen_statemachine_FinalState_State},
    metadata=None
)
