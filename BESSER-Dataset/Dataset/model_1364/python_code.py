...
class statemachine_State(Declaration):
    ...
    def __init__(self, id: int, label: str, statemachine_State9: "statemachine_State" = None, statemachine_State7: set["statemachine_State"] = None, statemachine_State12: "statemachine_State" = None, statemachine_State10: set["statemachine_State"] = None, statemachine_State: "statemachine_Transition" = None, statemachine_State6: "statemachine_Transition" = None):
        self.id = id
        self.label = label
