...
datatype_Property.attributes={datatype_Property_description, datatype_Property_multiplicity, datatype_Property_extension, datatype_Property_name}
...
domain_model = DomainModel(
    name="datatype",
    types={datatype_Property, datatype_Presence, datatype_Entity, Type, Model, datatype_BooleanPropertyAttribute, PropertyAttribute, datatype_ConstraintRule, datatype_PropertyType, datatype_PropertyAttribute, datatype_PrimitivePropertyType, PropertyType, datatype_ObjectPropertyType, datatype_Type, datatype_Constraint, datatype_Enum, datatype_EnumLiteral, datatype_EnumLiteralPropertyAttribute, datatype_ComplexPrimitivePropertyType, datatype_DictionaryPropertyType, ComplexPrimitivePropertyType, BooleanPropertyAttributeType, PrimitiveType, ConstraintIntervalType, EnumLiteralPropertyAttributeType},
    associations={properties2, presence4, superType1, constraintRule6, type8, propertyAttributes10, type12, enums13, value14, Constraints16, keyType18, valueType20},
    generalizations={gen_datatype_Entity_Type, gen_datatype_Type_Model, gen_datatype_BooleanPropertyAttribute_PropertyAttribute, gen_datatype_PrimitivePropertyType_PropertyType, gen_datatype_ObjectPropertyType_PropertyType, gen_datatype_Enum_Type, gen_datatype_EnumLiteralPropertyAttribute_PropertyAttribute, gen_datatype_ComplexPrimitivePropertyType_PropertyType, gen_datatype_DictionaryPropertyType_ComplexPrimitivePropertyType},
    metadata=None
)
