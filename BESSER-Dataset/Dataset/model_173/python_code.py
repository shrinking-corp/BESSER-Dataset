...
class highlevelnets_hlpn_ArcTP(Arc):
    ...
    def __init__(self, firstTimeConstraint: int, secondTimeConstraint: int, outArcs74: "Transition" = None, inArcs77: "Place" = None, highlevelnets_hlpn_ArcTP: "TokenVariadicExpression" = None, Arc: "highlevelnets_hlpn_HighLevelPetriNet" = None, Arc147: "highlevelnets_npndiagrams_NPNSymbolArcSN" = None):
        self.firstTimeConstraint = firstTimeConstraint
        self.secondTimeConstraint = secondTimeConstraint
        self.outArcs74 = outArcs74
        self.inArcs77 = inArcs77
        self.highlevelnets_hlpn_ArcTP = highlevelnets_hlpn_ArcTP
        
        pass
    @property
    def secondTimeConstraint(self):
    ...
    @property
    def inArcs77(self):
        return self.__inArcs77

    @inArcs77.setter
    def inArcs77(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_highlevelnets_hlpn_ArcTP__inArcs77", None)
        self.__inArcs77 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "Place78"):
                opp_val = getattr(old_value, "Place78", None)
                if opp_val == self:
                    setattr(old_value, "Place78", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "Place78"):
                opp_val = getattr(value, "Place78", None)
                setattr(value, "Place78", self)

    @property
    def outArcs74(self):
        return self.__outArcs74

    @outArcs74.setter
    def outArcs74(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_highlevelnets_hlpn_ArcTP__outArcs74", None)
        self.__outArcs74 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "Transition75"):
                opp_val = getattr(old_value, "Transition75", None)
                if opp_val == self:
                    setattr(old_value, "Transition75", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "Transition75"):
                opp_val = getattr(value, "Transition75", None)
                setattr(value, "Transition75", self)
    ...
    def highlevelnets_hlpn_ArcTP(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "TokenVariadicExpression80"):
                opp_val = getattr(old_value, "TokenVariadicExpression80", None)
                if opp_val == self:
                    setattr(old_value, "TokenVariadicExpression80", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "TokenVariadicExpression80"):
                opp_val = getattr(value, "TokenVariadicExpression80", None)
                setattr(value, "TokenVariadicExpression80", self)
...
class highlevelnets_tokentypes_TokenTypeElementNet(TokenType):
    ...
    def __init__(self, type10: set["ElementNetMarked"] = None, highlevelnets_tokentypes_TokenTypeElementNet: "HighLevelPetriNet" = None, type14: set["TokenNet"] = None, TokenType61: "highlevelnets_hlpn_Place" = None, TokenType34: "highlevelnets_tokenexpressions_TokenMultiSet" = None, TokenType: "highlevelnets_tokenexpressions_TokenMultisetExpression" = None):
...
class highlevelnets_tokenexpressions_MonomConstant(IEntityIdentifiable):
    ...
    def __init__(self, power: str, highlevelnets_tokenexpressions_MonomConstant: "Variable" = None, highlevelnets_tokenexpressions_MonomConstant51: "Token" = None):
        self.power = power
...
class highlevelnets_hlpn_Node(INetElement):
    ...
    def __init__(self, firstTimeConstraint: int, secondTimeConstraint: int, nodes: "HighLevelPetriNet" = None):
        self.firstTimeConstraint = firstTimeConstraint
        self.secondTimeConstraint = secondTimeConstraint
        self.nodes = nodes
    ...
    def nodes(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_highlevelnets_hlpn_Node__nodes", None)
        self.__nodes = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "HighLevelPetriNet84"):
                opp_val = getattr(old_value, "HighLevelPetriNet84", None)
                if opp_val == self:
                    setattr(old_value, "HighLevelPetriNet84", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "HighLevelPetriNet84"):
                opp_val = getattr(value, "HighLevelPetriNet84", None)
                setattr(value, "HighLevelPetriNet84", self)
