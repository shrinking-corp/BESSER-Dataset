...
def test_highlevelnets_hlpn_node_has_secondTimeConstraint():
    assert hasattr(highlevelnets_hlpn_Node, "secondTimeConstraint")
    descriptor = None
    for klass in highlevelnets_hlpn_Node.__mro__:
        if "secondTimeConstraint" in klass.__dict__:
            descriptor = klass.__dict__["secondTimeConstraint"]
            break
    assert isinstance(descriptor, property)

def test_highlevelnets_hlpn_node_has_firstTimeConstraint():
    assert hasattr(highlevelnets_hlpn_Node, "firstTimeConstraint")
    descriptor = None
    for klass in highlevelnets_hlpn_Node.__mro__:
...
def test_highlevelnets_hlpn_arctp_has_firstTimeConstraint():
    assert hasattr(highlevelnets_hlpn_ArcTP, "firstTimeConstraint")
    descriptor = None
    for klass in highlevelnets_hlpn_ArcTP.__mro__:
        if "firstTimeConstraint" in klass.__dict__:
            descriptor = klass.__dict__["firstTimeConstraint"]
            break
    assert isinstance(descriptor, property)

def test_highlevelnets_hlpn_arctp_has_secondTimeConstraint():
    assert hasattr(highlevelnets_hlpn_ArcTP, "secondTimeConstraint")
    descriptor = None
    for klass in highlevelnets_hlpn_ArcTP.__mro__:
        if "secondTimeConstraint" in klass.__dict__:
            descriptor = klass.__dict__["secondTimeConstraint"]
...
@given(instance=highlevelnets_hlpn_Node_strategy)
def test_highlevelnets_hlpn_node_secondTimeConstraint_setter(instance):
...
@given(instance=highlevelnets_hlpn_Node_strategy)
def test_highlevelnets_hlpn_node_firstTimeConstraint_setter(instance):
...
@given(instance=highlevelnets_hlpn_ArcTP_strategy)
def test_highlevelnets_hlpn_arctp_firstTimeConstraint_setter(instance):
    original = instance.firstTimeConstraint
    instance.firstTimeConstraint = original
    assert instance.firstTimeConstraint == original
...
@given(instance=highlevelnets_hlpn_ArcTP_strategy)
def test_highlevelnets_hlpn_arctp_secondTimeConstraint_setter(instance):
    original = instance.secondTimeConstraint
    instance.secondTimeConstraint = original
    assert instance.secondTimeConstraint == original
