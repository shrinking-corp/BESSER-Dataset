...
domain_model = DomainModel(
    name="PetriNets",
    types={PetriNets_Transition, PetriNets_Token, PetriNets_PetriNet, PetriNets_Place, PetriNet},
    associations={places0, trans1, net3, tokens4, outs10, place5, net7, ins9},
