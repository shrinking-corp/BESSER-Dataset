...
class ed2_EDD:
    ...
    def __init__(self, name: str, ed2_EDD2: set["ed2_TreeParent"] = None, ed2_EDD: set["ed2_TreeObject"] = None):
        self.name = name
...
class ed2_TreeObject:
    ...
    def __init__(self, index: str, name: str, type: str, ed2_TreeObject9: "ed2_TreeParent" = None, ed2_TreeObject: "ed2_EDD" = None):
        self.index = index
        self.name = name
        self.type = type
