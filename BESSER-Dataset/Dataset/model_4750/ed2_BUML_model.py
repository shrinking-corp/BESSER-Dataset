...
# Classes
ed2_TreeObject = Class(name="ed2_TreeObject")
ed2_TreeParent = Class(name="ed2_TreeParent")
ed2_TreeElement = Class(name="ed2_TreeElement", is_abstract=True)
ed2_Node = Class(name="ed2_Node")
TreeElement = Class(name="TreeElement")
ed2_Leaf = Class(name="ed2_Leaf")
ed2_EDD = Class(name="ed2_EDD")
ed2_ED2 = Class(name="ed2_ED2")
ed2_Model = Class(name="ed2_Model")
...
ed2_TreeObject.attributes={ed2_TreeObject_type, ed2_TreeObject_name, ed2_TreeObject_index}
...
ed2_TreeParent.attributes={ed2_TreeParent_type, ed2_TreeParent_index, ed2_TreeParent_name}
...
ed2_TreeElement.attributes={ed2_TreeElement_type, ed2_TreeElement_index, ed2_TreeElement_name}
...
domain_model = DomainModel(
    name="ed2",
    types={ed2_TreeObject, ed2_TreeParent, ed2_TreeElement, ed2_Node, TreeElement, ed2_Leaf, ed2_EDD, ed2_ED2, ed2_Model, TreeElementType},
    associations={treeObjects0, treeParents1, leaves3, nodes5, treeObjects7, treeParents11, treeElements13, ed214},
