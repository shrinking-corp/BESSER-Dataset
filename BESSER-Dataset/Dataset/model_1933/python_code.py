...
class domain_InfrastructureComponent:
    ...
    def __init__(self, uid: str, name: str, InfrastructureComponent: "domain_InfrastructureLayer" = None, domain_InfrastructureComponent: "domain_InfrastructureConnection" = None, domain_InfrastructureComponent582: "domain_InfrastructureConnection" = None, infrastructureComponent: "domain_InfrastructureLayer" = None):
        self.uid = uid
        self.name = name
...
class domain_InfrastructureLayer:
    ...
    def __init__(self, uid: str, name: str, InfrastructureLayer: "domain_Subsystem" = None, infrastructureLayer: "domain_Subsystem" = None, parent577: set["domain_InfrastructureComponent"] = None, InfrastructureLayer584: "domain_InfrastructureComponent" = None):
        self.uid = uid
        self.name = name
...
class domain_EnterpriseInfrastructure:
    ...
    def __init__(self, uid: str, EnterpriseInfrastructure: "domain_ApplicationInfrastructureLayer" = None, infarastructure: "domain_ApplicationInfrastructureLayer" = None, domain_EnterpriseInfrastructure564: "domain_EObject" = None, EnterpriseInfrastructure567: "domain_Datacenter" = None, parent561: set["domain_Datacenter"] = None, domain_EnterpriseInfrastructure: set["domain_InfrastructureConnection"] = None):
        self.uid = uid
...
class domain_InfrastructureConnection:
    ...
    def __init__(self, uid: str, domain_InfrastructureConnection579: "domain_InfrastructureComponent" = None, domain_InfrastructureConnection: "domain_EnterpriseInfrastructure" = None, domain_InfrastructureConnection581: "domain_InfrastructureComponent" = None):
        self.uid = uid
...
class ItemIcon:
    ...
    pass
class domain_SubMenu(ItemIcon, MenuElement):
...
class domain_DataControl:
    ...
    def __init__(self, uid: str, name: str, domain_DataControl454: "domain_OptionSelection" = None, DataControl: "domain_Controls" = None, domain_DataControl448: "domain_OptionSelection" = None, domain_DataControl: "domain_SourcesPointer" = None, domain_DataControl441: "domain_SourcesPointer" = None, domain_DataControl545: "domain_Dependency" = None, DataControl547: "domain_ArtificialField" = None, domain_DataControl502: "domain_PREInsertTrigger" = None, domain_DataControl490: "domain_TypePointer" = None, domain_DataControl493: "domain_TypePointer" = None, controls: "domain_Controls" = None, domain_DataControl498: "domain_PREQueryTrigger" = None, domain_DataControl500: "domain_POSTQueryTrigger" = None, domain_DataControl533: "domain_Relation" = None, domain_DataControl504: "domain_PREDeleteTrigger" = None, domain_DataControl506: "domain_POSTCreateTrigger" = None, domain_DataControl508: "domain_PREUpdateTrigger" = None, domain_DataControl510: "domain_CreateTrigger" = None, domain_DataControl512: "domain_InsertTrigger" = None, domain_DataControl514: "domain_UpdateTrigger" = None, domain_DataControl516: "domain_DeleteTrigger" = None, domain_DataControl518: "domain_SearchTrigger" = None, parent520: set["domain_ArtificialField"] = None, domain_DataControl522: "domain_ContextParameters" = None, domain_DataControl525: "domain_Orders" = None, domain_DataControl536: "domain_Relation" = None, domain_DataControl542: "domain_Dependency" = None):
        self.uid = uid
        self.name = name
...
class domain_ExpressionPart:
    ...
    def __init__(self, uid: str, order: int, expressionType: str, domain_ExpressionPart: "domain_ContextValue" = None, domain_ExpressionPart407: "domain_EObject" = None):
        self.uid = uid
        self.order = order
...
class domain_LinkToLabel:
    ...
    def __init__(self, uid: str, domain_LinkToLabel: "domain_CanvasView" = None, domain_LinkToLabel395: "domain_InputElement" = None, domain_LinkToLabel398: "domain_Label" = None):
        self.uid = uid
...
class domain_Controls:
    ...
    def __init__(self, uid: str, parent472: set["domain_DataControl"] = None, domain_Controls474: set["domain_Relation"] = None, formControl: "domain_FormDataControls" = None, domain_Controls: "domain_Root" = None, domain_Controls476: set["domain_Dependency"] = None, domain_Controls478: "domain_EObject" = None, Controls: "domain_FormDataControls" = None, Controls496: "domain_DataControl" = None):
        self.uid = uid
...
class domain_CanvasView:
    ...
    def __init__(self, uid: str, canvasView: "domain_ViewArea" = None, domain_CanvasView: "domain_LayerHolder" = None, domain_CanvasView384: set["domain_LinkToLabel"] = None, domain_CanvasView386: set["domain_LinkToMessage"] = None, domain_CanvasView388: "domain_EObject" = None, CanvasView: "domain_ViewArea" = None):
        self.uid = uid
...
class Orderable:
    ...
    pass
class domain_ViewArea(Orderable, ViewElement):

    def __init__(self, uid: str, name: str, ViewArea: "domain_CanvasView" = None, parent368: "domain_CanvasView" = None):
        self.uid = uid
        self.name = name
...
class domain_ViewPort(Orderable, ViewElement):
...
class domain_MenuView:
    ...
    def __init__(self, uid: str, MenuView: "domain_MenuDefinition" = None, domain_MenuView: set["domain_MenuFolder"] = None, menuView: "domain_MenuDefinition" = None, domain_MenuView589: "domain_EObject" = None):
        self.uid = uid
...
class FlexFields:
    ...
    pass
class domain_MenuItem(ItemIcon, FlexFields, MenuElement):
...
class domain_Button(ItemIcon, Uielement, MultiLangLabel):
...
class domain_Views:
    ...
    def __init__(self, uid: str, Views: "domain_FormView" = None, view: "domain_FormView" = None, domain_Views: set["domain_CanvasFrame"] = None, domain_Views354: set["domain_ViewInheritance"] = None, domain_Views356: set["domain_TabPagesInheritance"] = None, domain_Views358: set["domain_MenuDefinition"] = None, domain_Views360: "domain_EObject" = None):
        self.uid = uid
        self.Views = Views
        self.view = view
...
class domain_FormDataControls:
    ...
    def __init__(self, uid: str, name: str, domain_FormDataControls: "domain_Form" = None, FormDataControls: "domain_Controls" = None, parent380: "domain_Controls" = None):
        self.uid = uid
        self.name = name
...
class domain_Form:
    ...
    def __init__(self, uid: str, name: str, domain_Form344: "domain_FormView" = None, domain_Form346: "domain_FormDataControls" = None, domain_Form348: set["domain_FormParameter"] = None, domain_Form: "domain_UIPackage" = None):
        self.uid = uid
        self.name = name
...
class domain_Link:
    ...
    def __init__(self, uid: str, domain_Link: "domain_Assosiation" = None, domain_Link549: "domain_Attribute" = None, domain_Link552: "domain_Attribute" = None, domain_Link539: "domain_Relation" = None):
        self.uid = uid
...
class domain_Domain:
    ...
    def __init__(self, uid: str, parent: "domain_DomainArtifacts" = None, parent2: "domain_DomainTypes" = None, parent4: "domain_DomainApplications" = None, domain_Domain: "domain_EObject" = None, Domain: "domain_DomainArtifacts" = None, Domain20: "domain_DomainTypes" = None, Domain24: "domain_DomainApplications" = None):
        self.uid = uid
        self.parent = parent
...
class domain_TypesRepository:
    ...
    def __init__(self, uid: str, TypesRepository: "domain_DomainTypes" = None, parent322: "domain_Types" = None, typesrepository: "domain_DomainTypes" = None, domain_TypesRepository: "domain_EObject" = None, TypesRepository328: "domain_Types" = None):
        self.uid = uid
...
class domain_TypeDefinition:
    ...
    def __init__(self, uid: str, parent282: set["domain_TypeElement"] = None, typedefinition: "domain_Package" = None, domain_TypeDefinition: set["domain_RelationShip"] = None, domain_TypeDefinition286: "domain_EObject" = None, TypeDefinition: "domain_TypeElement" = None, TypeDefinition334: "domain_Package" = None):
        self.uid = uid
...
class domain_ModelMapper(ArtifactRef):
    ...
    def __init__(self, artifactExecutionString: str, name: str, artifactRoot: str, mappers249: "domain_Component" = None, domain_ModelMapper252: set["domain_MappingSpecifier"] = None, domain_ModelMapper254: set["domain_Query"] = None, domain_ModelMapper: "domain_DeploymentComponent" = None, ModelMapper: "domain_Component" = None):
        ...
        pass
    @property
    def artifactExecutionString(self):
...
class domain_DeploymentComponent:
    ...
    def __init__(self, uid: str, name: str, domain_DeploymentComponent: "domain_DeploymentComponents" = None, domain_DeploymentComponent209: "domain_ModelMapper" = None, domain_DeploymentComponent212: "domain_DeploymentComponent" = None, domain_DeploymentComponent210: "domain_DeploymentComponent" = None, domain_DeploymentComponent215: "domain_DeploymentStarStep" = None):
        self.uid = uid
        self.name = name
...
class domain_DeploymentComponents:
    ...
    def __init__(self, uid: str, domain_DeploymentComponents: "domain_DeploymentSequence" = None, domain_DeploymentComponents202: set["domain_DeploymentComponent"] = None, domain_DeploymentComponents204: "domain_DeploymentStarStep" = None, domain_DeploymentComponents206: "domain_EObject" = None):
        self.uid = uid
...
class domain_Infrastructure:
    ...
    def __init__(self, uid: str, name: str, infrastructure: "domain_Configuration" = None, Infrastructure243: "domain_Configuration" = None, domain_Infrastructure: "domain_Recipes" = None, Infrastructure: "domain_Recipe" = None, infrastructures: "domain_Recipe" = None):
        self.uid = uid
        self.name = name
...
class domain_Configuration:
    ...
    def __init__(self, uid: str, name: str, recipeConfig: "domain_Infrastructure" = None, domain_Configuration245: set["domain_Property"] = None, domain_Configuration247: set["domain_HashProperty"] = None, domain_Configuration: "domain_Recipes" = None, domain_Configuration227: "domain_ConfigExtension" = None, domain_Configuration230: "domain_ConfigExtension" = None, Configuration: "domain_Infrastructure" = None):
        self.uid = uid
        self.name = name
...
class domain_Recipe(UsingMappers):
    ...
    def __init__(self, uid: str, name: str, Recipe: "domain_Recipes" = None, recipe: "domain_Recipes" = None, parent220: set["domain_Ingredient"] = None, recipe222: set["domain_Infrastructure"] = None, domain_Recipe: "domain_DeploymentSequence" = None, Recipe232: "domain_Ingredient" = None, Recipe240: "domain_Infrastructure" = None):
        self.uid = uid
        self.name = name
        self.Recipe = Recipe
        self.recipe = recipe
...
class domain_CSSMapper(Mapper):
    ...
    def __init__(self, libraryUrl: str, fakePackageName: str, fakeTypeName: str, domain_CSSMapper: "domain_StylesPackage" = None, domain_CSSMapper180: "domain_StyleLibrary" = None):
        self.libraryUrl = libraryUrl
        self.fakePackageName = fakePackageName
        self.fakeTypeName = fakeTypeName
...
class domain_StyleLibrary:
    ...
    def __init__(self, name: str, uid: str, domain_StyleLibrary168: set["domain_StyleSet"] = None, domain_StyleLibrary: "domain_Styles" = None, domain_StyleLibrary181: "domain_CSSMapper" = None):
        self.name = name
        self.uid = uid
...
class domain_Group:
    ...
    def __init__(self, uid: str, name: str, domain_Group: "domain_Roles" = None, domain_Group157: "domain_Group" = None, domain_Group155: set["domain_Group"] = None, domain_Group159: set["domain_Role"] = None):
        self.uid = uid
        self.name = name
...
class Categorized:
    ...
    pass
class domain_TabCanvas(Categorized, DefaultCavas, CanvasFrame, MultiLangLabel):
...
class domain_Window(CanvasFrame, Secured, ViewPortHolder, Categorized, MultiLangLabel):

    pass
class domain_ViewElement(Categorized, NickNamed, StyleElement):

    pass
class domain_MenuDefinition(StyleElement, Categorized):
...
class domain_PopupCanvas(DefaultCavas, CanvasFrame, MultiLangLabel, ViewPortHolder, Categorized, FlexFields):
...
class domain_FlexField(Categorized, Context):
    ...
    pass
class domain_Canvas(DefaultCavas, CanvasFrame, ViewPortHolder, Categorized, MultiLangLabel):

    pass
class domain_Type(Categorized, TypeElement):

    pass
class domain_MenuElement(StyleElement, Orderable, EnabledUIItem, Categorized, MultiLangLabel):
...
class domain_Uielement(Orderable, StyleElement, MenuHolder, NickNamed, EnabledUIItem, Categorized, FlexFields):

    def __init__(self, uid: str, domain_Uielement461: "domain_Column" = None, domain_Uielement: "domain_ChildrenHolder" = None, domain_Uielement422: "domain_Context" = None, domain_Uielement425: "domain_Context" = None, domain_Uielement428: set["domain_AreaRef"] = None):
        self.uid = uid
...
class domain_RelationShip(Categorized):
    ...
    def __init__(self, uid: str, domain_RelationShip: "domain_TypeDefinition" = None, domain_RelationShip289: "domain_TypeElement" = None, domain_RelationShip292: "domain_TypeElement" = None):
        self.uid = uid
...
class domain_TabPage(Orderable, CanvasFrame, ViewPortHolder, Categorized, MultiLangLabel):
...
class domain_TypeMapper(TypePointer, Mapper):
...
class domain_ArtificialField(TypePointer):
    ...
    def __init__(self, uid: str, name: str, artificialFields: "domain_DataControl" = None, ArtificialField: "domain_DataControl" = None):
        self.uid = uid
        self.name = name
...
class domain_Recipes:
    ...
    def __init__(self, uid: str, Recipes: "domain_ApplicationRecipe" = None, parent185: "domain_Recipe" = None, domain_Recipes: set["domain_Configuration"] = None, domain_Recipes188: set["domain_Infrastructure"] = None, recipes190: "domain_ApplicationRecipe" = None, domain_Recipes193: "domain_DeploymentSequence" = None, domain_Recipes195: set["domain_ConfigExtension"] = None, domain_Recipes197: "domain_EObject" = None, Recipes218: "domain_Recipe" = None):
        self.uid = uid
...
class domain_ApplicationUIPackage:
    ...
    def __init__(self, name: str, uid: str, ApplicationUIPackage: "domain_ApplicationUILayer" = None, applicationUIPackages: "domain_ApplicationUILayer" = None, parent108: "domain_UIPackage" = None, ApplicationUIPackage338: "domain_UIPackage" = None):
        self.name = name
        self.uid = uid
...
class domain_Roles:
    ...
    def __init__(self, uid: str, roles: "domain_ApplicationRole" = None, domain_Roles: set["domain_Role"] = None, domain_Roles151: set["domain_Group"] = None, Roles: "domain_ApplicationRole" = None, domain_Roles153: "domain_EObject" = None):
        self.uid = uid
        self.roles = roles
...
class domain_Messages:
    ...
    def __init__(self, uid: str, messages: "domain_ApplicationMessages" = None, domain_Messages: set["domain_MessageLibrary"] = None, domain_Messages130: set["domain_Language"] = None, domain_Messages132: "domain_EObject" = None, Messages: "domain_ApplicationMessages" = None):
        self.uid = uid
...
class domain_ApplicationMessages:
    ...
    def __init__(self, uid: str, name: str, ApplicationMessages127: "domain_Messages" = None, ApplicationMessages: "domain_Application" = None, applicationMessages: "domain_Application" = None, parent88: "domain_Messages" = None):
        self.uid = uid
        self.name = name
...
class domain_ApplicationRole:
    ...
    def __init__(self, uid: str, name: str, ApplicationRole147: "domain_Roles" = None, ApplicationRole: "domain_Application" = None, applicationRole: "domain_Application" = None, parent92: "domain_Roles" = None):
        self.uid = uid
        self.name = name
...
class domain_Option:
    ...
    def __init__(self, uid: str, value: str, Option: "domain_Specifier" = None, options: "domain_Specifier" = None, domain_Option: "domain_MappingSpecifier" = None):
        self.uid = uid
        self.value = value
        self.Option = Option
...
class domain_Specifier:
    ...
    def __init__(self, uid: str, name: str, Specifier: "domain_Artifact" = None, specifiers: "domain_Artifact" = None, parent64: set["domain_Option"] = None, Specifier66: "domain_Option" = None, domain_Specifier: "domain_MappingSpecifier" = None):
        self.uid = uid
        self.name = name
...
class domain_Artifact:
    ...
    def __init__(self, template: str, uid: str, name: str, description: str, Artifact: "domain_Artifacts" = None, domain_Artifact: set["domain_GenerationHint"] = None, artifacts: "domain_Artifacts" = None, parent42: set["domain_ConfigVariable"] = None, parent44: set["domain_ConfigHash"] = None, parent46: set["domain_ModelQuery"] = None, parent48: set["domain_Specifier"] = None, Artifact52: "domain_ConfigVariable" = None, Artifact54: "domain_ConfigHash" = None, Artifact56: "domain_ModelQuery" = None, Artifact62: "domain_Specifier" = None, domain_Artifact277: "domain_ArtifactRef" = None):
...
class domain_Artifacts:
    ...
    def __init__(self, uid: str, Artifacts: "domain_DomainArtifact" = None, parent34: set["domain_Artifact"] = None, domain_Artifacts: "domain_EObject" = None, Artifacts40: "domain_Artifact" = None, artifact: "domain_DomainArtifact" = None):
        self.uid = uid
        self.Artifacts = Artifacts
...
class domain_Application:
    ...
    def __init__(self, uid: str, parent68: "domain_ApplicationRecipes" = None, Application: "domain_DomainApplication" = None, parent70: "domain_ApplicationMappers" = None, parent72: "domain_ApplicationUILayer" = None, parent74: "domain_ApplicationInfrastructureLayer" = None, parent76: "domain_ApplicationStyle" = None, parent78: "domain_ApplicationRole" = None, parent80: "domain_ApplicationMessages" = None, application: "domain_DomainApplication" = None, domain_Application: "domain_EObject" = None, Application86: "domain_ApplicationMessages" = None, Application90: "domain_ApplicationRole" = None, Application94: "domain_ApplicationStyle" = None, Application118: "domain_ApplicationMappers" = None, Application102: "domain_ApplicationUILayer" = None, Application110: "domain_ApplicationRecipes" = None, Application555: "domain_ApplicationInfrastructureLayer" = None):
        self.uid = uid
...
class domain_DomainArtifact:
    ...
    def __init__(self, uid: str, name: str, domainArtifact: "domain_DomainArtifacts" = None, parent32: "domain_Artifacts" = None, DomainArtifact: "domain_DomainArtifacts" = None, DomainArtifact36: "domain_Artifacts" = None, domain_DomainArtifact: "domain_ArtifactRef" = None):
        self.uid = uid
        self.name = name
...
class domain_ApplicationMappers(HTMLLayerHolder):
    ...
    def __init__(self, uid: str, name: str, parent120: set["domain_ApplicationMapper"] = None, ApplicationMappers124: "domain_ApplicationMapper" = None, ApplicationMappers: "domain_Application" = None, applicationMappers: "domain_Application" = None):
        self.uid = uid
        self.name = name
...
class domain_DomainArtifacts(HTMLLayerHolder):
    ...
    def __init__(self, uid: str, name: str, DomainArtifacts30: "domain_DomainArtifact" = None, DomainArtifacts: "domain_Domain" = None, domainArtifacts: "domain_Domain" = None, parent16: set["domain_DomainArtifact"] = None):
        self.uid = uid
        self.name = name
...
class domain_ApplicationStyle(HTMLLayerHolder):
    ...
    def __init__(self, uid: str, name: str, parent96: set["domain_StylesPackage"] = None, ApplicationStyle: "domain_Application" = None, applicationStyle: "domain_Application" = None, ApplicationStyle98: "domain_StylesPackage" = None):
        self.uid = uid
        self.name = name
...
class domain_MenuFolder(StyleElement, HTMLLayerHolder, ItemIcon, EnabledUIItem, Categorized, MultiLangLabel):

    def __init__(self, uid: str, name: str, extensionPoint: bool, domain_MenuFolder596: set["domain_MenuElement"] = None, domain_MenuFolder603: "domain_SubMenu" = None, domain_MenuFolder: "domain_MenuView" = None, domain_MenuFolder592: "domain_MenuHolder" = None, domain_MenuFolder594: "domain_MenuExtensionRef" = None):
        self.uid = uid
        self.name = name
...
class domain_Column(Orderable, HTMLLayerHolder, StyleElement, Categorized, MultiLangLabel):

    def __init__(self, uid: str, label: str, domain_Column: "domain_Uielement" = None, domain_Column463: "domain_Table" = None, domain_Column468: "domain_Tree" = None):
        self.uid = uid
        self.label = label
...
class domain_Types(HTMLLayerHolder):
    ...
    def __init__(self, uid: str, name: str, Types: "domain_TypesRepository" = None, typeDefinition: "domain_TypesRepository" = None, parent330: set["domain_Package"] = None, Types336: "domain_Package" = None):
        self.uid = uid
        self.name = name
        self.Types = Types
        self.typeDefinition = typeDefinition
...
class domain_Datacenter(HTMLLayerHolder):
    ...
    def __init__(self, uid: str, name: str, datacenters: "domain_EnterpriseInfrastructure" = None, parent569: set["domain_Subsystem"] = None, Datacenter571: "domain_Subsystem" = None, Datacenter: "domain_EnterpriseInfrastructure" = None):
        self.uid = uid
        self.name = name
...
class domain_Ingredient(HTMLLayerHolder, UsingMappers):

    def __init__(self, uid: str, name: str, layer: str, Ingredient236: "domain_Component" = None, Ingredient: "domain_Recipe" = None, ingredients: "domain_Recipe" = None, parent234: set["domain_Component"] = None):
        self.uid = uid
        self.name = name
        self.layer = layer
...
class domain_LayerHolder(HTMLLayerHolder, Uielement, ChildrenHolder):

    pass
class domain_Component(HTMLLayerHolder):

    def __init__(self, uid: str, name: str, componentRoot: str, Component250: "domain_ModelMapper" = None, components: "domain_Ingredient" = None, Component: "domain_Ingredient" = None, parent238: set["domain_ModelMapper"] = None):
        self.uid = uid
        self.name = name
...
class domain_DomainApplication:
    ...
    def __init__(self, uid: str, name: str, parent26: "domain_Application" = None, applications: "domain_DomainApplications" = None, domain_DomainApplication: "domain_GrantAccess" = None, DomainApplication: "domain_DomainApplications" = None, DomainApplication82: "domain_Application" = None):
        self.uid = uid
        self.name = name
...
class domain_GenerationHint:
    ...
    def __init__(self, uid: str, name: str, applyedClass: str, domain_GenerationHint50: "domain_Artifact" = None, domain_GenerationHint: "domain_Classifier" = None):
        self.uid = uid
        self.name = name
...
class domain_Classifier:
    ...
    def __init__(self, uid: str, details: str, domain_Classifier: "domain_Categorized" = None, domain_Classifier8: "domain_GenerationHint" = None, domain_Classifier417: "domain_StyleClass" = None):
        self.uid = uid
...
class domain_DomainApplications(HTMLLayerHolder):
    ...
    def __init__(self, uid: str, name: str, DomainApplications28: "domain_DomainApplication" = None, DomainApplications: "domain_Domain" = None, parent22: set["domain_DomainApplication"] = None, domainApplications: "domain_Domain" = None):
        self.uid = uid
        self.name = name
...
class domain_DomainTypes:
    ...
    def __init__(self, uid: str, name: str, parent18: "domain_TypesRepository" = None, DomainTypes: "domain_Domain" = None, domainTypes: "domain_Domain" = None, DomainTypes324: "domain_TypesRepository" = None):
        self.uid = uid
        self.name = name
