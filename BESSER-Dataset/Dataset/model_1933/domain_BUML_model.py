...
# Classes
domain_TypesRepository = Class(name="domain_TypesRepository")
domain_Domain = Class(name="domain_Domain")
domain_DomainArtifacts = Class(name="domain_DomainArtifacts")
domain_DomainTypes = Class(name="domain_DomainTypes")
domain_DomainApplications = Class(name="domain_DomainApplications")
domain_EObject = Class(name="domain_EObject")
domain_HTMLLayerHolder = Class(name="domain_HTMLLayerHolder")
domain_Categorized = Class(name="domain_Categorized")
domain_Classifier = Class(name="domain_Classifier")
domain_GenerationHint = Class(name="domain_GenerationHint")
domain_Secured = Class(name="domain_Secured")
domain_GrantAccess = Class(name="domain_GrantAccess")
domain_DomainApplication = Class(name="domain_DomainApplication")
domain_Role = Class(name="domain_Role")
HTMLLayerHolder = Class(name="HTMLLayerHolder")
domain_DomainArtifact = Class(name="domain_DomainArtifact")
domain_Application = Class(name="domain_Application")
domain_Artifacts = Class(name="domain_Artifacts")
domain_ORMEntity = Class(name="domain_ORMEntity")
DomainArtifact = Class(name="DomainArtifact")
domain_JPAService = Class(name="domain_JPAService")
domain_EJBService = Class(name="domain_EJBService")
domain_ContinuousIintegration = Class(name="domain_ContinuousIintegration")
domain_Artifact = Class(name="domain_Artifact")
domain_ConfigVariable = Class(name="domain_ConfigVariable")
domain_ConfigHash = Class(name="domain_ConfigHash")
domain_ModelQuery = Class(name="domain_ModelQuery")
domain_Specifier = Class(name="domain_Specifier")
domain_ApplicationRecipes = Class(name="domain_ApplicationRecipes")
domain_ApplicationMappers = Class(name="domain_ApplicationMappers")
domain_QueryParameter = Class(name="domain_QueryParameter")
domain_Option = Class(name="domain_Option")
domain_StylesPackage = Class(name="domain_StylesPackage")
domain_ApplicationUILayer = Class(name="domain_ApplicationUILayer")
domain_ApplicationInfrastructureLayer = Class(name="domain_ApplicationInfrastructureLayer")
domain_ApplicationStyle = Class(name="domain_ApplicationStyle")
domain_ApplicationRole = Class(name="domain_ApplicationRole")
domain_ApplicationMessages = Class(name="domain_ApplicationMessages")
domain_Messages = Class(name="domain_Messages")
domain_Roles = Class(name="domain_Roles")
domain_Styles = Class(name="domain_Styles")
domain_ApplicationUIPackage = Class(name="domain_ApplicationUIPackage")
domain_UIPackage = Class(name="domain_UIPackage")
domain_ApplicationRecipe = Class(name="domain_ApplicationRecipe")
domain_Recipes = Class(name="domain_Recipes")
domain_ApplicationMapper = Class(name="domain_ApplicationMapper")
domain_Mappers = Class(name="domain_Mappers")
domain_MethodPointer = Class(name="domain_MethodPointer")
TypePointer = Class(name="TypePointer")
domain_Operation = Class(name="domain_Operation")
domain_MessageLibrary = Class(name="domain_MessageLibrary")
domain_Language = Class(name="domain_Language")
Categorized = Class(name="Categorized")
domain_LanguageRef = Class(name="domain_LanguageRef")
domain_Message = Class(name="domain_Message")
domain_Translation = Class(name="domain_Translation")
domain_StyleSet = Class(name="domain_StyleSet")
domain_Group = Class(name="domain_Group")
domain_StyleLibrary = Class(name="domain_StyleLibrary")
domain_Mapper = Class(name="domain_Mapper")
domain_TypeMapper = Class(name="domain_TypeMapper")
Mapper = Class(name="Mapper")
domain_JavaMapper = Class(name="domain_JavaMapper")
TypeMapper = Class(name="TypeMapper")
domain_JavaScriptMapper = Class(name="domain_JavaScriptMapper")
domain_CSSMapper = Class(name="domain_CSSMapper")
domain_RoleMapper = Class(name="domain_RoleMapper")
domain_UsingMappers = Class(name="domain_UsingMappers")
domain_Recipe = Class(name="domain_Recipe")
domain_Configuration = Class(name="domain_Configuration")
domain_Infrastructure = Class(name="domain_Infrastructure")
domain_DeploymentSequence = Class(name="domain_DeploymentSequence")
domain_ConfigExtension = Class(name="domain_ConfigExtension")
domain_DeploymentComponents = Class(name="domain_DeploymentComponents")
domain_DeploymentComponent = Class(name="domain_DeploymentComponent")
domain_DeploymentStarStep = Class(name="domain_DeploymentStarStep")
domain_ModelMapper = Class(name="domain_ModelMapper")
UsingMappers = Class(name="UsingMappers")
domain_Ingredient = Class(name="domain_Ingredient")
domain_Component = Class(name="domain_Component")
domain_JavaComponent = Class(name="domain_JavaComponent")
Component = Class(name="Component")
domain_Property = Class(name="domain_Property")
domain_HashProperty = Class(name="domain_HashProperty")
ArtifactRef = Class(name="ArtifactRef")
domain_MappingSpecifier = Class(name="domain_MappingSpecifier")
domain_Query = Class(name="domain_Query")
domain_TypeDefinition = Class(name="domain_TypeDefinition")
domain_KeyValuePair = Class(name="domain_KeyValuePair")
domain_QueryVariable = Class(name="domain_QueryVariable")
domain_ArtifactRef = Class(name="domain_ArtifactRef")
domain_TypePointer = Class(name="domain_TypePointer")
domain_Package = Class(name="domain_Package")
domain_TypeElement = Class(name="domain_TypeElement")
domain_RelationShip = Class(name="domain_RelationShip")
domain_References = Class(name="domain_References")
RelationShip = Class(name="RelationShip")
domain_Assosiation = Class(name="domain_Assosiation")
domain_Link = Class(name="domain_Link")
domain_Attribute = Class(name="domain_Attribute")
domain_Primitive = Class(name="domain_Primitive")
TypeElement = Class(name="TypeElement")
domain_Type = Class(name="domain_Type")
domain_Generalization = Class(name="domain_Generalization")
domain_TypeReference = Class(name="domain_TypeReference")
Secured = Class(name="Secured")
domain_Parameter = Class(name="domain_Parameter")
domain_ReturnValue = Class(name="domain_ReturnValue")
domain_Enumarator = Class(name="domain_Enumarator")
domain_EnumAttribute = Class(name="domain_EnumAttribute")
domain_Types = Class(name="domain_Types")
domain_Form = Class(name="domain_Form")
domain_FormView = Class(name="domain_FormView")
domain_FormDataControls = Class(name="domain_FormDataControls")
domain_FormParameter = Class(name="domain_FormParameter")
domain_Views = Class(name="domain_Views")
domain_CanvasFrame = Class(name="domain_CanvasFrame")
domain_ViewInheritance = Class(name="domain_ViewInheritance")
domain_TabPagesInheritance = Class(name="domain_TabPagesInheritance")
domain_MenuDefinition = Class(name="domain_MenuDefinition")
domain_Orderable = Class(name="domain_Orderable")
domain_MultiLangLabel = Class(name="domain_MultiLangLabel")
domain_Context = Class(name="domain_Context")
StyleElement = Class(name="StyleElement")
domain_ViewPortHolder = Class(name="domain_ViewPortHolder")
domain_ViewElement = Class(name="domain_ViewElement")
domain_DefaultCavas = Class(name="domain_DefaultCavas")
NickNamed = Class(name="NickNamed")
domain_PopupCanvas = Class(name="domain_PopupCanvas")
...
domain_Canvas = Class(name="domain_Canvas")
domain_Window = Class(name="domain_Window")
domain_MenuView = Class(name="domain_MenuView")
domain_TabCanvas = Class(name="domain_TabCanvas")
domain_TabPage = Class(name="domain_TabPage")
Orderable = Class(name="Orderable")
domain_ViewPort = Class(name="domain_ViewPort")
ViewElement = Class(name="ViewElement")
domain_ViewPortTrigger = Class(name="domain_ViewPortTrigger")
domain_ViewArea = Class(name="domain_ViewArea")
domain_CanvasView = Class(name="domain_CanvasView")
Trigger = Class(name="Trigger")
domain_Controls = Class(name="domain_Controls")
domain_LayerHolder = Class(name="domain_LayerHolder")
domain_LinkToLabel = Class(name="domain_LinkToLabel")
domain_LinkToMessage = Class(name="domain_LinkToMessage")
domain_InputElement = Class(name="domain_InputElement")
domain_MessageElement = Class(name="domain_MessageElement")
domain_Label = Class(name="domain_Label")
domain_ChildrenHolder = Class(name="domain_ChildrenHolder")
domain_Uielement = Class(name="domain_Uielement")
domain_ContextParameter = Class(name="domain_ContextParameter")
domain_ContextValue = Class(name="domain_ContextValue")
domain_ExpressionPart = Class(name="domain_ExpressionPart")
domain_ContextParameters = Class(name="domain_ContextParameters")
ContextValue = Class(name="ContextValue")
ContextParameters = Class(name="ContextParameters")
domain_StyleElement = Class(name="domain_StyleElement")
domain_StyleClass = Class(name="domain_StyleClass")
domain_OptionSelection = Class(name="domain_OptionSelection")
InputElement = Class(name="InputElement")
domain_NickNamed = Class(name="domain_NickNamed")
domain_FlexFields = Class(name="domain_FlexFields")
domain_FlexField = Class(name="domain_FlexField")
Context = Class(name="Context")
domain_EnabledUIItem = Class(name="domain_EnabledUIItem")
EnabledUIItem = Class(name="EnabledUIItem")
MenuHolder = Class(name="MenuHolder")
domain_AreaRef = Class(name="domain_AreaRef")
domain_ItemIcon = Class(name="domain_ItemIcon")
domain_Formatable = Class(name="domain_Formatable")
domain_SourcesPointer = Class(name="domain_SourcesPointer")
Uielement = Class(name="Uielement")
domain_DataControl = Class(name="domain_DataControl")
SourcesPointer = Class(name="SourcesPointer")
domain_Selection = Class(name="domain_Selection")
domain_Date = Class(name="domain_Date")
domain_Button = Class(name="domain_Button")
ChildrenHolder = Class(name="ChildrenHolder")
domain_InputText = Class(name="domain_InputText")
Formatable = Class(name="Formatable")
domain_Password = Class(name="domain_Password")
domain_OutputText = Class(name="domain_OutputText")
domain_CheckBox = Class(name="domain_CheckBox")
domain_DropDownSelection = Class(name="domain_DropDownSelection")
OptionSelection = Class(name="OptionSelection")
domain_Image = Class(name="domain_Image")
domain_Relation = Class(name="domain_Relation")
ItemIcon = Class(name="ItemIcon")
domain_Column = Class(name="domain_Column")
domain_Table = Class(name="domain_Table")
domain_Menu = Class(name="domain_Menu")
domain_Tree = Class(name="domain_Tree")
domain_Root = Class(name="domain_Root")
domain_UpdateTrigger = Class(name="domain_UpdateTrigger")
domain_Dependency = Class(name="domain_Dependency")
domain_Trigger = Class(name="domain_Trigger")
MethodPointer = Class(name="MethodPointer")
domain_PREFormTrigger = Class(name="domain_PREFormTrigger")
domain_PREQueryTrigger = Class(name="domain_PREQueryTrigger")
domain_POSTQueryTrigger = Class(name="domain_POSTQueryTrigger")
domain_PREInsertTrigger = Class(name="domain_PREInsertTrigger")
domain_PREDeleteTrigger = Class(name="domain_PREDeleteTrigger")
domain_POSTCreateTrigger = Class(name="domain_POSTCreateTrigger")
domain_PREUpdateTrigger = Class(name="domain_PREUpdateTrigger")
domain_ProxiesList = Class(name="domain_ProxiesList")
domain_CreateTrigger = Class(name="domain_CreateTrigger")
ProxiesList = Class(name="ProxiesList")
domain_InsertTrigger = Class(name="domain_InsertTrigger")
domain_DeleteTrigger = Class(name="domain_DeleteTrigger")
domain_SearchTrigger = Class(name="domain_SearchTrigger")
domain_FormVariable = Class(name="domain_FormVariable")
domain_ArtificialField = Class(name="domain_ArtificialField")
domain_Orders = Class(name="domain_Orders")
domain_OrderBy = Class(name="domain_OrderBy")
domain_Datacenter = Class(name="domain_Datacenter")
domain_InfrastructureConnection = Class(name="domain_InfrastructureConnection")
domain_EnterpriseInfrastructure = Class(name="domain_EnterpriseInfrastructure")
domain_Server = Class(name="domain_Server")
InfrastructureComponent = Class(name="InfrastructureComponent")
domain_Subsystem = Class(name="domain_Subsystem")
domain_InfrastructureLayer = Class(name="domain_InfrastructureLayer")
domain_InfrastructureComponent = Class(name="domain_InfrastructureComponent")
domain_Router = Class(name="domain_Router")
domain_Hub = Class(name="domain_Hub")
domain_Storage = Class(name="domain_Storage")
domain_ServerClaster = Class(name="domain_ServerClaster")
domain_MenuFolder = Class(name="domain_MenuFolder")
domain_MenuHolder = Class(name="domain_MenuHolder")
domain_MenuExtensionRef = Class(name="domain_MenuExtensionRef")
domain_MenuElement = Class(name="domain_MenuElement")
domain_MenuItem = Class(name="domain_MenuItem")
MenuElement = Class(name="MenuElement")
domain_MenuExtensionPoint = Class(name="domain_MenuExtensionPoint")
MenuExtensionRef = Class(name="MenuExtensionRef")
domain_SubMenu = Class(name="domain_SubMenu")
domain_MenuSeparator = Class(name="domain_MenuSeparator")
...
domain_DomainArtifacts.attributes={domain_DomainArtifacts_name, domain_DomainArtifacts_uid}
...
domain_DomainApplications.attributes={domain_DomainApplications_name, domain_DomainApplications_uid}
...
domain_Classifier.attributes={domain_Classifier_details, domain_Classifier_uid}
...
domain_GenerationHint.attributes={domain_GenerationHint_name, domain_GenerationHint_applyedClass, domain_GenerationHint_uid}
...
domain_DomainApplication.attributes={domain_DomainApplication_name, domain_DomainApplication_uid}
...
domain_Artifact.attributes={domain_Artifact_name, domain_Artifact_template, domain_Artifact_description, domain_Artifact_uid}
...
domain_ConfigVariable.attributes={domain_ConfigVariable_name, domain_ConfigVariable_uid}
...
domain_ConfigHash.attributes={domain_ConfigHash_uid, domain_ConfigHash_name}
...
domain_ModelQuery.attributes={domain_ModelQuery_query, domain_ModelQuery_name, domain_ModelQuery_uid}
...
domain_Specifier.attributes={domain_Specifier_uid, domain_Specifier_name}
...
domain_ApplicationMappers.attributes={domain_ApplicationMappers_uid, domain_ApplicationMappers_name}
...
domain_StylesPackage.attributes={domain_StylesPackage_uid, domain_StylesPackage_name}
...
domain_ApplicationUILayer.attributes={domain_ApplicationUILayer_name, domain_ApplicationUILayer_uid}
...
domain_ApplicationInfrastructureLayer.attributes={domain_ApplicationInfrastructureLayer_name, domain_ApplicationInfrastructureLayer_uid}
...
domain_ApplicationRole.attributes={domain_ApplicationRole_uid, domain_ApplicationRole_name}
...
domain_ApplicationRecipe.attributes={domain_ApplicationRecipe_name, domain_ApplicationRecipe_uid}
...
domain_ApplicationMapper.attributes={domain_ApplicationMapper_uid, domain_ApplicationMapper_name}
...
domain_MessageLibrary.attributes={domain_MessageLibrary_uid, domain_MessageLibrary_name}
...
domain_Language.attributes={domain_Language_defaultLang, domain_Language_code, domain_Language_uid, domain_Language_lang}
...
domain_Message.attributes={domain_Message_uid, domain_Message_name}
...
domain_StyleSet.attributes={domain_StyleSet_uid, domain_StyleSet_name}
...
domain_StyleLibrary.attributes={domain_StyleLibrary_name, domain_StyleLibrary_uid}
...
domain_Mapper.attributes={domain_Mapper_serviceLayer, domain_Mapper_uid, domain_Mapper_uiLayer}
...
domain_JavaMapper.attributes={domain_JavaMapper_groupId, domain_JavaMapper_version, domain_JavaMapper_libraryName, domain_JavaMapper_artifactType, domain_JavaMapper_artifactId, domain_JavaMapper_mappedToClassName, domain_JavaMapper_mappedToPackageName}
...
domain_CSSMapper.attributes={domain_CSSMapper_fakeTypeName, domain_CSSMapper_fakePackageName, domain_CSSMapper_libraryUrl}
...
domain_Configuration.attributes={domain_Configuration_uid, domain_Configuration_name}
...
domain_Infrastructure.attributes={domain_Infrastructure_name, domain_Infrastructure_uid}
...
domain_DeploymentSequence.attributes={domain_DeploymentSequence_uid, domain_DeploymentSequence_name}
...
domain_ModelMapper.attributes={domain_ModelMapper_name, domain_ModelMapper_artifactExecutionString, domain_ModelMapper_artifactRoot}
...
domain_Ingredient.attributes={domain_Ingredient_name, domain_Ingredient_layer, domain_Ingredient_uid}
...
domain_Component.attributes={domain_Component_uid, domain_Component_componentRoot, domain_Component_name}
...
domain_JavaComponent.attributes={domain_JavaComponent_version, domain_JavaComponent_artifactId, domain_JavaComponent_groupId, domain_JavaComponent_basePackage}
...
domain_Property.attributes={domain_Property_uid, domain_Property_fakeName, domain_Property_value}
...
domain_HashProperty.attributes={domain_HashProperty_uid, domain_HashProperty_fakeName}
...
domain_KeyValuePair.attributes={domain_KeyValuePair_value, domain_KeyValuePair_key, domain_KeyValuePair_uid}
...
domain_Package.attributes={domain_Package_uid, domain_Package_name}
...
domain_Attribute.attributes={domain_Attribute_pk, domain_Attribute_uid, domain_Attribute_name}
...
domain_Parameter.attributes={domain_Parameter_uid, domain_Parameter_order, domain_Parameter_name}
...
domain_EnumAttribute.attributes={domain_EnumAttribute_uid, domain_EnumAttribute_value, domain_EnumAttribute_name}
...
domain_Form.attributes={domain_Form_uid, domain_Form_name}
...
domain_FormView.attributes={domain_FormView_name, domain_FormView_uid}
...
domain_MenuDefinition.attributes={domain_MenuDefinition_uid, domain_MenuDefinition_name}
...
domain_ViewPort.attributes={domain_ViewPort_name, domain_ViewPort_uid}
...
domain_ViewArea.attributes={domain_ViewArea_uid, domain_ViewArea_name}
...
domain_ContextParameter.attributes={domain_ContextParameter_uid, domain_ContextParameter_operation}
...
domain_ContextValue.attributes={domain_ContextValue_constant, domain_ContextValue_value, domain_ContextValue_uid}
...
domain_ExpressionPart.attributes={domain_ExpressionPart_order, domain_ExpressionPart_uid, domain_ExpressionPart_expressionType}
...
domain_DataControl.attributes={domain_DataControl_name, domain_DataControl_uid}
...
domain_Relation.attributes={domain_Relation_uid, domain_Relation_isTree, domain_Relation_name}
...
domain_Column.attributes={domain_Column_label, domain_Column_uid}
...
domain_Root.attributes={domain_Root_name, domain_Root_uid}
...
domain_FormVariable.attributes={domain_FormVariable_name, domain_FormVariable_uid}
...
domain_ArtificialField.attributes={domain_ArtificialField_uid, domain_ArtificialField_name}
...
domain_OrderBy.attributes={domain_OrderBy_order, domain_OrderBy_uid}
...
domain_InfrastructureComponent.attributes={domain_InfrastructureComponent_uid, domain_InfrastructureComponent_name}
...
domain_MenuFolder.attributes={domain_MenuFolder_uid, domain_MenuFolder_extensionPoint, domain_MenuFolder_name}
...
domain_MenuElement.attributes={domain_MenuElement_uid, domain_MenuElement_name}
...
domain_model = DomainModel(
    name="domain",
    types={domain_TypesRepository, domain_Domain, domain_DomainArtifacts, domain_DomainTypes, domain_DomainApplications, domain_EObject, domain_HTMLLayerHolder, domain_Categorized, domain_Classifier, domain_GenerationHint, domain_Secured, domain_GrantAccess, domain_DomainApplication, domain_Role, HTMLLayerHolder, domain_DomainArtifact, domain_Application, domain_Artifacts, domain_ORMEntity, DomainArtifact, domain_JPAService, domain_EJBService, domain_ContinuousIintegration, domain_Artifact, domain_ConfigVariable, domain_ConfigHash, domain_ModelQuery, domain_Specifier, domain_ApplicationRecipes, domain_ApplicationMappers, domain_QueryParameter, domain_Option, domain_StylesPackage, domain_ApplicationUILayer, domain_ApplicationInfrastructureLayer, domain_ApplicationStyle, domain_ApplicationRole, domain_ApplicationMessages, domain_Messages, domain_Roles, domain_Styles, domain_ApplicationUIPackage, domain_UIPackage, domain_ApplicationRecipe, domain_Recipes, domain_ApplicationMapper, domain_Mappers, domain_MethodPointer, TypePointer, domain_Operation, domain_MessageLibrary, domain_Language, Categorized, domain_LanguageRef, domain_Message, domain_Translation, domain_StyleSet, domain_Group, domain_StyleLibrary, domain_Mapper, domain_TypeMapper, Mapper, domain_JavaMapper, TypeMapper, domain_JavaScriptMapper, domain_CSSMapper, domain_RoleMapper, domain_UsingMappers, domain_Recipe, domain_Configuration, domain_Infrastructure, domain_DeploymentSequence, domain_ConfigExtension, domain_DeploymentComponents, domain_DeploymentComponent, domain_DeploymentStarStep, domain_ModelMapper, UsingMappers, domain_Ingredient, domain_Component, domain_JavaComponent, Component, domain_Property, domain_HashProperty, ArtifactRef, domain_MappingSpecifier, domain_Query, domain_TypeDefinition, domain_KeyValuePair, domain_QueryVariable, domain_ArtifactRef, domain_TypePointer, domain_Package, domain_TypeElement, domain_RelationShip, domain_References, RelationShip, domain_Assosiation, domain_Link, domain_Attribute, domain_Primitive, TypeElement, domain_Type, domain_Generalization, domain_TypeReference, Secured, domain_Parameter, domain_ReturnValue, domain_Enumarator, domain_EnumAttribute, domain_Types, domain_Form, domain_FormView, domain_FormDataControls, domain_FormParameter, domain_Views, domain_CanvasFrame, domain_ViewInheritance, domain_TabPagesInheritance, domain_MenuDefinition, domain_Orderable, domain_MultiLangLabel, domain_Context, StyleElement, domain_ViewPortHolder, domain_ViewElement, domain_DefaultCavas, NickNamed, domain_PopupCanvas, CanvasFrame, ViewPortHolder, DefaultCavas, MultiLangLabel, FlexFields, domain_Canvas, domain_Window, domain_MenuView, domain_TabCanvas, domain_TabPage, Orderable, domain_ViewPort, ViewElement, domain_ViewPortTrigger, domain_ViewArea, domain_CanvasView, Trigger, domain_Controls, domain_LayerHolder, domain_LinkToLabel, domain_LinkToMessage, domain_InputElement, domain_MessageElement, domain_Label, domain_ChildrenHolder, domain_Uielement, domain_ContextParameter, domain_ContextValue, domain_ExpressionPart, domain_ContextParameters, ContextValue, ContextParameters, domain_StyleElement, domain_StyleClass, domain_OptionSelection, InputElement, domain_NickNamed, domain_FlexFields, domain_FlexField, Context, domain_EnabledUIItem, EnabledUIItem, MenuHolder, domain_AreaRef, domain_ItemIcon, domain_Formatable, domain_SourcesPointer, Uielement, domain_DataControl, SourcesPointer, domain_Selection, domain_Date, domain_Button, ChildrenHolder, domain_InputText, Formatable, domain_Password, domain_OutputText, domain_CheckBox, domain_DropDownSelection, OptionSelection, domain_Image, domain_Relation, ItemIcon, domain_Column, domain_Table, domain_Menu, domain_Tree, domain_Root, domain_UpdateTrigger, domain_Dependency, domain_Trigger, MethodPointer, domain_PREFormTrigger, domain_PREQueryTrigger, domain_POSTQueryTrigger, domain_PREInsertTrigger, domain_PREDeleteTrigger, domain_POSTCreateTrigger, domain_PREUpdateTrigger, domain_ProxiesList, domain_CreateTrigger, ProxiesList, domain_InsertTrigger, domain_DeleteTrigger, domain_SearchTrigger, domain_FormVariable, domain_ArtificialField, domain_Orders, domain_OrderBy, domain_Datacenter, domain_InfrastructureConnection, domain_EnterpriseInfrastructure, domain_Server, InfrastructureComponent, domain_Subsystem, domain_InfrastructureLayer, domain_InfrastructureComponent, domain_Router, domain_Hub, domain_Storage, domain_ServerClaster, domain_MenuFolder, domain_MenuHolder, domain_MenuExtensionRef, domain_MenuElement, domain_MenuItem, MenuElement, domain_MenuExtensionPoint, MenuExtensionRef, domain_SubMenu, domain_MenuSeparator, PlatformLayers, Comparator, Order, RelationType, Orientation},
    associations={typesrepository17, domainArtifacts0, domainTypes1, domainApplications3, any5, classifiers6, hint7, grants9, applicationRef10, roleRef12, parent14, domainArtifact15, parent35, parent19, applications21, parent23, application25, parent27, parent29, artifact31, artifacts33, hints49, any37, parent39, configVariables41, configHashes43, modelQuery45, specifiers47, applicationRecipes67, parent51, parent53, parent55, parameters57, parent59, parent61, options63, parent65, stylesPackage95, applicationMappers69, applicationUILayer71, applicationInfrastructureLayer73, applicationStyle75, applicationRole77, applicationMessages79, parent81, any83, parent85, messages87, parent89, roles91, parent93, parent117, parent97, styles99, parent101, applicationUIPackages103, parent105, uipackage107, parent109, recipes111, recipes113, parent115, lang143, mappers119, mapper121, parent123, methodRef125, parent126, messageLibraries128, languages129, any131, libLanguages134, messages136, lang138, translatioins141, styles167, parent146, roles148, groups150, any152, group2Group156, group2Role158, parent161, libraries163, any164, role182, mappers169, parent171, any173, parent175, stylePackage178, styleLibrary179, mappers216, recipe184, configurations186, infrastructures187, parent189, deployment192, configExtension194, any196, deploymentComponents199, deplymentStep201, startSeq203, any205, mapper208, deploymentComponentLink211, firstStep213, parent235, parent217, ingredients219, infrastructures221, deployment223, source225, target228, parent231, components233, mappers237, recipe239, recipeConfig241, infrastructure242, properties244, hashProperties246, parent248, specifiers251, queries253, typeRef279, confVarRef255, confHashRef257, hash259, specifierRef261, valueRef263, modelQuery265, queryRef267, variables270, queryParamRef272, domainArtifactRef274, artifactRef275, packageRef278, types281, parent283, relationShips284, any285, source288, target291, links294, sourceProperty295, targetProperty297, many2manyHelper300, parent303, attributes304, operations306, parent308, parent309, parameters311, returnValue313, parent315, values318, parent320, typeDefinition321, parent323, any325, parent327, packages329, typedefinition332, parent335, parent337, forms339, any340, view343, datacontrols345, parameters347, view349, parent351, canvases352, viewInheritances353, tabPagesInheritances355, menus357, any359, multiLangLabel362, viewElement363, menuView364, viewPortTrigger366, source369, target372, source375, target377, formControl379, parent381, baseCanvas382, linkToLabels383, linkToMessages385, any387, source390, canvasView367, styleClass413, classifier415, target392, source394, target397, children399, refObj400, value402, expression404, objRef406, parameters409, style411, valueOptionPointer444, optionPointer447, fields418, enabled419, required421, readOnly424, refreshAreas427, icon429, area431, sourcePointer433, valuePointer434, sourceCast437, sourceCastDataControl439, displayOptionPointer442, optionCast449, optionCastDataControl452, selection455, initialOptionMessage457, controls471, relations473, element460, cols462, image464, cols466, parent469, root470, dependencies475, any477, typePointers480, preInsertTrigger501, preFormTrigger482, variables484, paramRef486, baseTypeRef489, baseType492, parent495, preQueryTrigger497, postQueryTrigger499, master531, preDeleteTrigger503, postCreateTrigger505, preUpdateTrigger507, create509, insert511, update513, remove515, search517, artificialFields519, defaultSearch521, defaultOrderBy524, orderRules526, refObj528, datacenters560, infrastructureConnections562, detail534, links537, master540, detail543, parent546, masterField548, detailField551, parent554, infarastructure556, parent558, any563, parent566, subsystems568, parent570, infrastructureLayer572, parent574, infrastructureComponent576, master578, detail580, parent583, servers585, menuFolders587, parent586, any588, menu591, extensionRef593, menuElements595, transition597, refreshAreas599, toSubmenu602},
    generalizations={gen_domain_DomainArtifacts_HTMLLayerHolder, gen_domain_DomainApplications_HTMLLayerHolder, gen_domain_ORMEntity_DomainArtifact, gen_domain_JPAService_DomainArtifact, gen_domain_EJBService_DomainArtifact, gen_domain_ContinuousIintegration_DomainArtifact, gen_domain_ApplicationStyle_HTMLLayerHolder, gen_domain_ApplicationUILayer_HTMLLayerHolder, gen_domain_ApplicationRecipes_HTMLLayerHolder, gen_domain_ApplicationMappers_HTMLLayerHolder, gen_domain_MethodPointer_TypePointer, gen_domain_MessageLibrary_Categorized, gen_domain_TypeMapper_Mapper, gen_domain_TypeMapper_TypePointer, gen_domain_JavaMapper_TypeMapper, gen_domain_JavaScriptMapper_TypeMapper, gen_domain_CSSMapper_Mapper, gen_domain_RoleMapper_Mapper, gen_domain_Component_HTMLLayerHolder, gen_domain_Recipe_UsingMappers, gen_domain_Ingredient_UsingMappers, gen_domain_Ingredient_HTMLLayerHolder, gen_domain_JavaComponent_Component, gen_domain_ModelMapper_ArtifactRef, gen_domain_RelationShip_Categorized, gen_domain_References_RelationShip, gen_domain_Generalization_RelationShip, gen_domain_Assosiation_RelationShip, gen_domain_Primitive_TypeElement, gen_domain_Type_TypeElement, gen_domain_Type_Categorized, gen_domain_TypeReference_TypeElement, gen_domain_TypeReference_TypePointer, gen_domain_Attribute_TypePointer, gen_domain_Attribute_Categorized, gen_domain_Operation_Secured, gen_domain_Operation_Categorized, gen_domain_Parameter_TypePointer, gen_domain_ReturnValue_TypePointer, gen_domain_Enumarator_TypeElement, gen_domain_Types_HTMLLayerHolder, gen_domain_FormParameter_TypePointer, gen_domain_CanvasFrame_StyleElement, gen_domain_ViewPortHolder_HTMLLayerHolder, gen_domain_ViewElement_StyleElement, gen_domain_ViewElement_Categorized, gen_domain_ViewElement_NickNamed, gen_domain_PopupCanvas_CanvasFrame, gen_domain_PopupCanvas_ViewPortHolder, gen_domain_PopupCanvas_DefaultCavas, gen_domain_PopupCanvas_MultiLangLabel, gen_domain_PopupCanvas_Categorized, gen_domain_PopupCanvas_FlexFields, gen_domain_Canvas_CanvasFrame, gen_domain_Canvas_ViewPortHolder, gen_domain_Canvas_DefaultCavas, gen_domain_Canvas_Categorized, gen_domain_Window_CanvasFrame, gen_domain_Window_ViewPortHolder, gen_domain_Window_MultiLangLabel, gen_domain_Window_Categorized, gen_domain_Window_Secured, gen_domain_MenuDefinition_StyleElement, gen_domain_MenuDefinition_Categorized, gen_domain_TabCanvas_CanvasFrame, gen_domain_TabCanvas_DefaultCavas, gen_domain_TabCanvas_MultiLangLabel, gen_domain_TabCanvas_Categorized, gen_domain_TabPage_CanvasFrame, gen_domain_TabPage_ViewPortHolder, gen_domain_TabPage_MultiLangLabel, gen_domain_TabPage_Categorized, gen_domain_TabPage_Orderable, gen_domain_ViewPort_ViewElement, gen_domain_ViewPort_Orderable, gen_domain_ViewArea_ViewElement, gen_domain_ViewArea_Orderable, gen_domain_Canvas_MultiLangLabel, gen_domain_ViewPortTrigger_Trigger, gen_domain_StyleClass_ContextValue, gen_domain_Context_ContextValue, gen_domain_Context_ContextParameters, gen_domain_OptionSelection_InputElement, gen_domain_FlexField_Context, gen_domain_FlexField_Categorized, gen_domain_Uielement_StyleElement, gen_domain_Uielement_NickNamed, gen_domain_Uielement_Categorized, gen_domain_Uielement_Orderable, gen_domain_Uielement_EnabledUIItem, gen_domain_Uielement_FlexFields, gen_domain_Uielement_MenuHolder, gen_domain_SourcesPointer_Uielement, gen_domain_InputElement_SourcesPointer, gen_domain_Selection_StyleElement, gen_domain_Date_InputElement, gen_domain_Date_Formatable, gen_domain_Button_Uielement, gen_domain_LayerHolder_Uielement, gen_domain_LayerHolder_ChildrenHolder, gen_domain_LayerHolder_HTMLLayerHolder, gen_domain_InputText_InputElement, gen_domain_InputText_Formatable, gen_domain_Password_InputElement, gen_domain_Password_Formatable, gen_domain_Label_Uielement, gen_domain_Label_MultiLangLabel, gen_domain_MessageElement_Uielement, gen_domain_MessageElement_MultiLangLabel, gen_domain_OutputText_InputElement, gen_domain_OutputText_Formatable, gen_domain_CheckBox_InputElement, gen_domain_DropDownSelection_OptionSelection, gen_domain_Image_InputElement, gen_domain_Button_MultiLangLabel, gen_domain_Button_ItemIcon, gen_domain_Column_StyleElement, gen_domain_Column_MultiLangLabel, gen_domain_Column_Categorized, gen_domain_Column_HTMLLayerHolder, gen_domain_Column_Orderable, gen_domain_Table_SourcesPointer, gen_domain_Table_HTMLLayerHolder, gen_domain_Table_MultiLangLabel, gen_domain_Menu_Uielement, gen_domain_Tree_SourcesPointer, gen_domain_Tree_HTMLLayerHolder, gen_domain_Tree_MultiLangLabel, gen_domain_UpdateTrigger_Trigger, gen_domain_UpdateTrigger_ProxiesList, gen_domain_Trigger_MethodPointer, gen_domain_Trigger_ContextParameters, gen_domain_PREFormTrigger_Trigger, gen_domain_PREQueryTrigger_Trigger, gen_domain_POSTQueryTrigger_Trigger, gen_domain_PREInsertTrigger_Trigger, gen_domain_PREDeleteTrigger_Trigger, gen_domain_POSTCreateTrigger_Trigger, gen_domain_PREUpdateTrigger_Trigger, gen_domain_CreateTrigger_Trigger, gen_domain_CreateTrigger_ProxiesList, gen_domain_InsertTrigger_Trigger, gen_domain_InsertTrigger_ProxiesList, gen_domain_DeleteTrigger_Trigger, gen_domain_DeleteTrigger_ProxiesList, gen_domain_SearchTrigger_Trigger, gen_domain_SearchTrigger_ProxiesList, gen_domain_FormVariable_TypePointer, gen_domain_ArtificialField_TypePointer, gen_domain_Server_InfrastructureComponent, gen_domain_Datacenter_HTMLLayerHolder, gen_domain_Router_InfrastructureComponent, gen_domain_Hub_InfrastructureComponent, gen_domain_Storage_InfrastructureComponent, gen_domain_ServerClaster_InfrastructureComponent, gen_domain_MenuElement_MultiLangLabel, gen_domain_MenuElement_StyleElement, gen_domain_MenuElement_Categorized, gen_domain_MenuElement_EnabledUIItem, gen_domain_MenuElement_Orderable, gen_domain_MenuFolder_HTMLLayerHolder, gen_domain_MenuFolder_EnabledUIItem, gen_domain_MenuFolder_Categorized, gen_domain_MenuFolder_StyleElement, gen_domain_MenuFolder_MultiLangLabel, gen_domain_MenuFolder_ItemIcon, gen_domain_MenuItem_MenuElement, gen_domain_MenuItem_ItemIcon, gen_domain_MenuItem_FlexFields, gen_domain_MenuExtensionPoint_MenuElement, gen_domain_MenuExtensionPoint_MenuExtensionRef, gen_domain_SubMenu_MenuElement, gen_domain_SubMenu_ItemIcon, gen_domain_MenuSeparator_MenuElement},
    metadata=None
)
