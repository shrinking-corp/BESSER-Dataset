...
domain_model = DomainModel(
    name="fsm",
    types={SuperState, fsm_Action, fsm_eAction, fsm_FSM, fsm_State, fsm_InitialState, fsm_SuperState, fsm_SteadyState, State, fsm_TransientState, fsm_Transition},
    associations={entry3, state0, intialState1, source9, src11, exit5, target7, outTrans12},
    generalizations={gen_fsm_State_SuperState, gen_fsm_InitialState_SuperState, gen_fsm_SteadyState_State, gen_fsm_TransientState_State},
    metadata=None
)
