...
p2_Requirement.attributes={p2_Requirement_versionRange, p2_Requirement_iD, p2_Requirement_name, p2_Requirement_type, p2_Requirement_optional, p2_Requirement_namespace, p2_Requirement_filter}
...
p2_Configuration.attributes={p2_Configuration_arch, p2_Configuration_wS, p2_Configuration_oS}
...
domain_model = DomainModel(
    name="p2",
    types={p2_ProfileDefinition, ModelElement, p2_Requirement, p2_Repository, p2_Configuration, p2_RepositoryList, RepositoryType, VersionSegment, RequirementType},
    associations={requirements0, repositories1, repositories3},
    generalizations={gen_p2_Requirement_ModelElement, gen_p2_ProfileDefinition_ModelElement, gen_p2_Configuration_ModelElement, gen_p2_RepositoryList_ModelElement, gen_p2_Repository_ModelElement},
    metadata=None
)
