...
# Classes
opposite1_Root = Class(name="opposite1_Root")
opposite1_AbstractSuperClass = Class(name="opposite1_AbstractSuperClass", is_abstract=True)
opposite1_ClassB = Class(name="opposite1_ClassB")
opposite1_ClassA = Class(name="opposite1_ClassA")
...
domain_model = DomainModel(
    name="opposite1",
    types={opposite1_Root, opposite1_AbstractSuperClass, opposite1_ClassB, opposite1_ClassA, AbstractSuperClass},
    associations={classes0, b1, a2},
    generalizations={gen_opposite1_ClassB_AbstractSuperClass, gen_opposite1_ClassA_AbstractSuperClass},
    metadata=None
)
