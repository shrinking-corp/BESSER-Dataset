...
# Classes
altarica_AbstractDeclaration = Class(name="altarica_AbstractDeclaration")
altarica_ConstantDefinition = Class(name="altarica_ConstantDefinition")
AbstractDeclaration = Class(name="AbstractDeclaration")
altarica_Constant = Class(name="altarica_Constant")
altarica_AbstractDefinitionConstant = Class(name="altarica_AbstractDefinitionConstant")
NonNavigableVariable = Class(name="NonNavigableVariable")
altarica_System = Class(name="altarica_System")
altarica_ExternalSpecification = Class(name="altarica_ExternalSpecification")
altarica_ExternalDirective = Class(name="altarica_ExternalDirective")
altarica_FlowSpecification = Class(name="altarica_FlowSpecification")
altarica_FlowDeclaration = Class(name="altarica_FlowDeclaration")
altarica_Flow = Class(name="altarica_Flow")
altarica_Expression = Class(name="altarica_Expression")
altarica_ExpressionConstant = Class(name="altarica_ExpressionConstant")
AbstractDefinitionConstant = Class(name="AbstractDefinitionConstant")
altarica_DomainConstant = Class(name="altarica_DomainConstant")
altarica_AbstractDomain = Class(name="altarica_AbstractDomain")
altarica_Domain = Class(name="altarica_Domain")
AbstractTypeRef = Class(name="AbstractTypeRef")
altarica_Range = Class(name="altarica_Range")
AbstractDomain = Class(name="AbstractDomain")
altarica_Enumeration = Class(name="altarica_Enumeration")
altarica_Literal = Class(name="altarica_Literal")
altarica_PrimitiveType = Class(name="altarica_PrimitiveType")
altarica_Node = Class(name="altarica_Node")
altarica_AbstractSpecification = Class(name="altarica_AbstractSpecification")
altarica_VariableAttribute = Class(name="altarica_VariableAttribute")
altarica_InitSpecification = Class(name="altarica_InitSpecification")
AbstractSpecification = Class(name="AbstractSpecification")
altarica_InitStatement = Class(name="altarica_InitStatement")
altarica_Affectation = Class(name="altarica_Affectation")
altarica_NodeInstance = Class(name="altarica_NodeInstance")
altarica_AssertSpecification = Class(name="altarica_AssertSpecification")
altarica_Assert = Class(name="altarica_Assert")
altarica_AbstractBooleanExpression = Class(name="altarica_AbstractBooleanExpression")
altarica_VectorSpecification = Class(name="altarica_VectorSpecification")
altarica_AbstractTypeRef = Class(name="altarica_AbstractTypeRef")
altarica_EventSpecification = Class(name="altarica_EventSpecification")
altarica_EventDeclaration = Class(name="altarica_EventDeclaration")
altarica_Event = Class(name="altarica_Event")
NavigableVariable = Class(name="NavigableVariable")
altarica_Priority = Class(name="altarica_Priority")
altarica_AbstractExpression = Class(name="altarica_AbstractExpression")
altarica_StateSpecification = Class(name="altarica_StateSpecification")
altarica_StateDeclaration = Class(name="altarica_StateDeclaration")
altarica_State = Class(name="altarica_State")
altarica_DomainRef = Class(name="altarica_DomainRef")
altarica_NodeInstanceSpecification = Class(name="altarica_NodeInstanceSpecification")
altarica_NodeInstanceDeclaration = Class(name="altarica_NodeInstanceDeclaration")
altarica_IfThenElse = Class(name="altarica_IfThenElse")
altarica_EObject = Class(name="altarica_EObject")
altarica_Vector = Class(name="altarica_Vector")
altarica_VectorParameter = Class(name="altarica_VectorParameter")
altarica_Cardinality = Class(name="altarica_Cardinality")
altarica_EventRef = Class(name="altarica_EventRef")
altarica_TransitionSpecification = Class(name="altarica_TransitionSpecification")
altarica_Transition = Class(name="altarica_Transition")
altarica_Switch = Class(name="altarica_Switch")
AbstractExpression = Class(name="AbstractExpression")
AbstractBooleanExpression = Class(name="AbstractBooleanExpression")
altarica_CaseExpression = Class(name="altarica_CaseExpression")
altarica_And = Class(name="altarica_And")
altarica_Or = Class(name="altarica_Or")
altarica_NavigableVariable = Class(name="altarica_NavigableVariable")
altarica_VariableRef = Class(name="altarica_VariableRef")
Expression = Class(name="Expression")
altarica_NonNavigableVariable = Class(name="altarica_NonNavigableVariable")
altarica_EBoolean = Class(name="altarica_EBoolean")
altarica_EString = Class(name="altarica_EString")
altarica_EInteger = Class(name="altarica_EInteger")
altarica_Addition = Class(name="altarica_Addition")
altarica_Minus = Class(name="altarica_Minus")
altarica_Multiplication = Class(name="altarica_Multiplication")
altarica_Division = Class(name="altarica_Division")
altarica_Upper = Class(name="altarica_Upper")
altarica_Imply = Class(name="altarica_Imply")
altarica_Equal = Class(name="altarica_Equal")
altarica_NotEqual = Class(name="altarica_NotEqual")
altarica_StrictLower = Class(name="altarica_StrictLower")
altarica_Lower = Class(name="altarica_Lower")
altarica_StrictUpper = Class(name="altarica_StrictUpper")
altarica_NestedQualifiedEventRef = Class(name="altarica_NestedQualifiedEventRef")
EventRef = Class(name="EventRef")
altarica_NestedQualifiedVariableRef = Class(name="altarica_NestedQualifiedVariableRef")
...
altarica_Node.attributes={altarica_Node_name, altarica_Node_isMain}
...
else_97: BinaryAssociation = BinaryAssociation(
    name="else_97",
    ends={
...
domain_model = DomainModel(
    name="altarica",
    types={altarica_AbstractDeclaration, altarica_ConstantDefinition, AbstractDeclaration, altarica_Constant, altarica_AbstractDefinitionConstant, NonNavigableVariable, altarica_System, altarica_ExternalSpecification, altarica_ExternalDirective, altarica_FlowSpecification, altarica_FlowDeclaration, altarica_Flow, altarica_Expression, altarica_ExpressionConstant, AbstractDefinitionConstant, altarica_DomainConstant, altarica_AbstractDomain, altarica_Domain, AbstractTypeRef, altarica_Range, AbstractDomain, altarica_Enumeration, altarica_Literal, altarica_PrimitiveType, altarica_Node, altarica_AbstractSpecification, altarica_VariableAttribute, altarica_InitSpecification, AbstractSpecification, altarica_InitStatement, altarica_Affectation, altarica_NodeInstance, altarica_AssertSpecification, altarica_Assert, altarica_AbstractBooleanExpression, altarica_VectorSpecification, altarica_AbstractTypeRef, altarica_EventSpecification, altarica_EventDeclaration, altarica_Event, NavigableVariable, altarica_Priority, altarica_AbstractExpression, altarica_StateSpecification, altarica_StateDeclaration, altarica_State, altarica_DomainRef, altarica_NodeInstanceSpecification, altarica_NodeInstanceDeclaration, altarica_IfThenElse, altarica_EObject, altarica_Vector, altarica_VectorParameter, altarica_Cardinality, altarica_EventRef, altarica_TransitionSpecification, altarica_Transition, altarica_Switch, AbstractExpression, AbstractBooleanExpression, altarica_CaseExpression, altarica_And, altarica_Or, altarica_NavigableVariable, altarica_VariableRef, Expression, altarica_NonNavigableVariable, altarica_EBoolean, altarica_EString, altarica_EInteger, altarica_Addition, altarica_Minus, altarica_Multiplication, altarica_Division, altarica_Upper, altarica_Imply, altarica_Equal, altarica_NotEqual, altarica_StrictLower, altarica_Lower, altarica_StrictUpper, altarica_NestedQualifiedEventRef, EventRef, altarica_NestedQualifiedVariableRef, VariableRef, PrimitiveTypeKind, FlowKind},
    associations={ownedDeclarations0, constant1, expression2, ownedDirectives19, ownedDeclarations20, ownedFlows21, ownedExpression4, domain6, domain7, lower9, upper11, ownedLiterals14, ownedSpecifications15, ownedInitStatements16, affectation17, ownedNodeInstances49, nodeType51, ownedAsserts54, ownedExpressions55, domain23, attribute25, ownedEventDeclarations27, ownedEvents28, attribute30, ownedPriority33, ownedExpression35, ownedStateDeclarations37, ownedStates38, domain40, attribute43, reference46, ownedNodeInstanceDeclarations48, condition87, body90, condition93, then95, else_97, ownedVectors57, ownedParameters58, cardinality60, eventParameter62, expression64, ownedTransitionTransitions67, ownedExpresion68, event71, ownedAffectations74, state77, ownedExpression80, ownedCases83, default84, leftOperand127, rightOperand129, leftOperand132, rightOperand134, operand101, variable103, variable105, leftOperand107, rightOperand109, leftOperand112, rightOperand114, leftOperand117, rightOperand119, leftOperand122, rightOperand124, leftOperand162, rightOperand164, leftOperand167, leftOperand137, rightOperand139, leftOperand142, rightOperand144, leftOperand147, rightOperand149, leftOperand152, rightOperand154, leftOperand157, rightOperand159, rightOperand169, target172, nestedVariable174, target177, nestedVariable179},
    generalizations={gen_altarica_ConstantDefinition_AbstractDeclaration, gen_altarica_Constant_NonNavigableVariable, gen_altarica_ExternalSpecification_AbstractSpecification, gen_altarica_FlowSpecification_AbstractSpecification, gen_altarica_ExpressionConstant_AbstractDefinitionConstant, gen_altarica_DomainConstant_AbstractDefinitionConstant, gen_altarica_Domain_AbstractDeclaration, gen_altarica_AbstractDomain_AbstractTypeRef, gen_altarica_Range_AbstractDomain, gen_altarica_Enumeration_AbstractDomain, gen_altarica_PrimitiveType_AbstractDomain, gen_altarica_Literal_NonNavigableVariable, gen_altarica_Node_AbstractDeclaration, gen_altarica_InitSpecification_AbstractSpecification, gen_altarica_NodeInstance_NavigableVariable, gen_altarica_AssertSpecification_AbstractSpecification, gen_altarica_VectorSpecification_AbstractSpecification, gen_altarica_Flow_NonNavigableVariable, gen_altarica_EventSpecification_AbstractSpecification, gen_altarica_Event_NavigableVariable, gen_altarica_StateSpecification_AbstractSpecification, gen_altarica_State_NonNavigableVariable, gen_altarica_DomainRef_AbstractTypeRef, gen_altarica_NodeInstanceSpecification_AbstractSpecification, gen_altarica_IfThenElse_AbstractExpression, gen_altarica_IfThenElse_AbstractBooleanExpression, gen_altarica_Expression_AbstractExpression, gen_altarica_TransitionSpecification_AbstractSpecification, gen_altarica_Switch_AbstractExpression, gen_altarica_Switch_AbstractBooleanExpression, gen_altarica_And_Expression, gen_altarica_Or_Expression, gen_altarica_Expression_AbstractBooleanExpression, gen_altarica_VariableRef_Expression, gen_altarica_NonNavigableVariable_NavigableVariable, gen_altarica_EBoolean_Expression, gen_altarica_EString_Expression, gen_altarica_EInteger_Expression, gen_altarica_Addition_Expression, gen_altarica_Minus_Expression, gen_altarica_Multiplication_Expression, gen_altarica_Division_Expression, gen_altarica_Upper_Expression, gen_altarica_Imply_Expression, gen_altarica_Equal_Expression, gen_altarica_NotEqual_Expression, gen_altarica_StrictLower_Expression, gen_altarica_Lower_Expression, gen_altarica_StrictUpper_Expression, gen_altarica_NestedQualifiedEventRef_EventRef, gen_altarica_NestedQualifiedVariableRef_VariableRef},
    metadata=None
)
