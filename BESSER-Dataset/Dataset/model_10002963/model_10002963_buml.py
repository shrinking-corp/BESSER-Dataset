...
MyClass11_MyClass12: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="myClass1210", type=MyClass12, multiplicity=Multiplicity(0, 1)),
        Property(name="myClass1111", type=MyClass11, multiplicity=Multiplicity(0, 1))
    }
)

# Domain Model
domain_model = DomainModel(
    name="eff0f1ce_38f4_44e2_9ee6_d9f948ac4eb3",
    types={MyClass, MyClass2, MyClass3, MyClass4, MyClass5, MyClass6, MyClass7, MyClass8, MyClass9, MyClass10, MyClass11, MyClass12},
    associations={association2, association3, association4, association5, association6, MyClass11_MyClass12},
    generalizations={},
    metadata=None
)
