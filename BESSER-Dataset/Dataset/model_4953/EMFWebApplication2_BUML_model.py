...
# Classes
webApplication_Named = Class(name="webApplication_Named")
webApplication_WebApplicationModel = Class(name="webApplication_WebApplicationModel")
Named = Class(name="Named")
Entity = Class(name="Entity")
DataSource = Class(name="DataSource")
Page = Class(name="Page")
webApplication_data_DataSource = Class(name="webApplication_data_DataSource")
webApplication_data_Entity = Class(name="webApplication_data_Entity")
Column = Class(name="Column")
RelatedEntity = Class(name="RelatedEntity")
webApplication_data_Column = Class(name="webApplication_data_Column")
webApplication_data_RelatedEntity = Class(name="webApplication_data_RelatedEntity")
webApplication_content_Page = Class(name="webApplication_content_Page")
Content = Class(name="Content")
Link = Class(name="Link")
Form = Class(name="Form")
webApplication_content_Content = Class(name="webApplication_content_Content", is_abstract=True)
webApplication_content_Form = Class(name="webApplication_content_Form")
webApplication_content_Link = Class(name="webApplication_content_Link")
webApplication_content_Menu = Class(name="webApplication_content_Menu")
webApplication_content_SingleContent = Class(name="webApplication_content_SingleContent")
webApplication_content_MultipleContent = Class(name="webApplication_content_MultipleContent")
webApplication_content_CRUDForm = Class(name="webApplication_content_CRUDForm")
Field = Class(name="Field")
webApplication_content_Field = Class(name="webApplication_content_Field")
...
webApplication_data_Entity.methods={webApplication_data_Entity_m_getPK, webApplication_data_Entity_m_getPKRelated}
...
webApplication_data_Column.attributes={webApplication_data_Column_type, webApplication_data_Column_PK, webApplication_data_Column_lenght}
...
webApplication_content_Menu.attributes={webApplication_content_Menu_url, webApplication_content_Menu_itemName, webApplication_content_Menu_order}
...
domain_model = DomainModel(
    name="webApplication",
    types={webApplication_Named, webApplication_WebApplicationModel, Named, Entity, DataSource, Page, webApplication_data_DataSource, webApplication_data_Entity, Column, RelatedEntity, webApplication_data_Column, webApplication_data_RelatedEntity, webApplication_content_Page, Content, Link, Form, webApplication_content_Content, webApplication_content_Form, webApplication_content_Link, webApplication_content_Menu, webApplication_content_SingleContent, webApplication_content_MultipleContent, webApplication_content_CRUDForm, Field, webApplication_content_Field, ColumnType, FieldType},
    associations={entities0, dataSources1, pages3, entity5, columns7, relates8, relatesTo13, contents15, links16, forms18, dataSource20, from_22, relatedEntities10, to24, fields27},
    generalizations={gen_webApplication_WebApplicationModel_Named, gen_webApplication_data_DataSource_Named, gen_webApplication_data_Entity_Named, gen_webApplication_data_Column_Named, gen_webApplication_data_RelatedEntity_Named, gen_webApplication_content_Page_Named, gen_webApplication_content_Content_Named, gen_webApplication_content_Form_Named, gen_webApplication_content_Link_Named, gen_webApplication_content_Menu_Content, gen_webApplication_content_SingleContent_Content, gen_webApplication_content_MultipleContent_Content, gen_webApplication_content_CRUDForm_Form, gen_webApplication_content_Field_Named},
    metadata=None
)
