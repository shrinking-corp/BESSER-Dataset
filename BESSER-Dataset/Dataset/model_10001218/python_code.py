...
class Estadio:
    ...
    def __init__(self, Nombre: str, Ubicacion: str, Capacidad: str, Terreno: str, Ubicacion1: str, Cod_equipo: str, Cod_Estadio: str, partido5: set["Partido"] = None):
        self.Nombre = Nombre
...
class Clasificacion:
    ...
    def __init__(self, GF: str, GC: str, DG: str, Puntos: str, Cod_Equipo: str, Posicion: str, JJ: str, JP: str, JE: str, JG: str, liga27: set["Liga"] = None):
        self.GF = GF
        self.GC = GC
        self.DG = DG
        self.Puntos = Puntos
