...
arduinoml_Brick = Class(name="arduinoml_Brick")
arduinoml_Action = Class(name="arduinoml_Action", is_abstract=True)
arduinoml_Transition = Class(name="arduinoml_Transition")
arduinoml_Actuator = Class(name="arduinoml_Actuator", is_abstract=True)
arduinoml_MultipleElementCondition = Class(name="arduinoml_MultipleElementCondition")
arduinoml_Sensor = Class(name="arduinoml_Sensor", is_abstract=True)
Brick = Class(name="Brick")
arduinoml_Condition = Class(name="arduinoml_Condition", is_abstract=True)
arduinoml_SingleElementCondition = Class(name="arduinoml_SingleElementCondition")
Condition = Class(name="Condition")
arduinoml_BinarySensor = Class(name="arduinoml_BinarySensor")
arduinoml_ValueElementCondition = Class(name="arduinoml_ValueElementCondition")
...
arduinoml_BinaryActuator = Class(name="arduinoml_BinaryActuator")
arduinoml_AnalogAction = Class(name="arduinoml_AnalogAction")
Action = Class(name="Action")
arduinoml_BinaryAction = Class(name="arduinoml_BinaryAction")
...
arduinoml_ValueElementCondition.attributes={arduinoml_ValueElementCondition_value, arduinoml_ValueElementCondition_comparator}
