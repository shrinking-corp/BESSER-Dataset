...
# Classes
nabla_NablaModule = Class(name="nabla_NablaModule")
nabla_Import = Class(name="nabla_Import")
nabla_ItemType = Class(name="nabla_ItemType")
nabla_Function = Class(name="nabla_Function")
nabla_OptDefinition = Class(name="nabla_OptDefinition")
nabla_SimpleVarDefinition = Class(name="nabla_SimpleVarDefinition")
nabla_VarGroupDeclaration = Class(name="nabla_VarGroupDeclaration")
nabla_TimeIteratorDefinition = Class(name="nabla_TimeIteratorDefinition")
nabla_Job = Class(name="nabla_Job")
nabla_SimpleVar = Class(name="nabla_SimpleVar")
nabla_Expression = Class(name="nabla_Expression")
nabla_MultipleConnectivity = Class(name="nabla_MultipleConnectivity")
Connectivity = Class(name="Connectivity")
nabla_SingleConnectivity = Class(name="nabla_SingleConnectivity")
nabla_Instruction = Class(name="nabla_Instruction")
nabla_Iterable = Class(name="nabla_Iterable")
nabla_IterationBlock = Class(name="nabla_IterationBlock")
Instruction = Class(name="Instruction")
nabla_BaseType = Class(name="nabla_BaseType")
nabla_Connectivity = Class(name="nabla_Connectivity")
nabla_Reduction = Class(name="nabla_Reduction")
nabla_Loop = Class(name="nabla_Loop")
Iterable = Class(name="Iterable")
nabla_Affectation = Class(name="nabla_Affectation")
nabla_ArgOrVarRef = Class(name="nabla_ArgOrVarRef")
nabla_If = Class(name="nabla_If")
nabla_ItemDefinition = Class(name="nabla_ItemDefinition")
nabla_Item = Class(name="nabla_Item")
nabla_SingleConnectivityCall = Class(name="nabla_SingleConnectivityCall")
nabla_SetDefinition = Class(name="nabla_SetDefinition")
nabla_MultipleConnectivityCall = Class(name="nabla_MultipleConnectivityCall")
nabla_Return = Class(name="nabla_Return")
nabla_Exit = Class(name="nabla_Exit")
nabla_Container = Class(name="nabla_Container")
nabla_SetRef = Class(name="nabla_SetRef")
Container = Class(name="Container")
nabla_SpaceIterator = Class(name="nabla_SpaceIterator")
IterationBlock = Class(name="IterationBlock")
nabla_SingletonDefinition = Class(name="nabla_SingletonDefinition")
nabla_Var = Class(name="nabla_Var")
nabla_InstructionBlock = Class(name="nabla_InstructionBlock")
nabla_Interval = Class(name="nabla_Interval")
nabla_ConnectivityCall = Class(name="nabla_ConnectivityCall")
nabla_ItemRef = Class(name="nabla_ItemRef")
ConnectivityCall = Class(name="ConnectivityCall")
nabla_TimeIterator = Class(name="nabla_TimeIterator")
ArgOrVar = Class(name="ArgOrVar")
nabla_TimeIteratorRef = Class(name="nabla_TimeIteratorRef")
nabla_CurrentTimeIteratorRef = Class(name="nabla_CurrentTimeIteratorRef")
TimeIteratorRef = Class(name="TimeIteratorRef")
nabla_InitTimeIteratorRef = Class(name="nabla_InitTimeIteratorRef")
nabla_NextTimeIteratorRef = Class(name="nabla_NextTimeIteratorRef")
nabla_ArgOrVar = Class(name="nabla_ArgOrVar")
Var = Class(name="Var")
nabla_ConnectivityVar = Class(name="nabla_ConnectivityVar")
nabla_FunctionOrReduction = Class(name="nabla_FunctionOrReduction")
nabla_Arg = Class(name="nabla_Arg")
FunctionOrReduction = Class(name="FunctionOrReduction")
nabla_IntConstant = Class(name="nabla_IntConstant")
Expression = Class(name="Expression")
nabla_ReductionCall = Class(name="nabla_ReductionCall")
nabla_Or = Class(name="nabla_Or")
nabla_And = Class(name="nabla_And")
nabla_Equality = Class(name="nabla_Equality")
nabla_Comparison = Class(name="nabla_Comparison")
nabla_Plus = Class(name="nabla_Plus")
nabla_Minus = Class(name="nabla_Minus")
nabla_Mul = Class(name="nabla_Mul")
nabla_ContractedIf = Class(name="nabla_ContractedIf")
nabla_Modulo = Class(name="nabla_Modulo")
nabla_Parenthesis = Class(name="nabla_Parenthesis")
nabla_UnaryMinus = Class(name="nabla_UnaryMinus")
nabla_Not = Class(name="nabla_Not")
nabla_RealConstant = Class(name="nabla_RealConstant")
nabla_BoolConstant = Class(name="nabla_BoolConstant")
nabla_MinConstant = Class(name="nabla_MinConstant")
nabla_MaxConstant = Class(name="nabla_MaxConstant")
nabla_FunctionCall = Class(name="nabla_FunctionCall")
nabla_Div = Class(name="nabla_Div")
nabla_BaseTypeConstant = Class(name="nabla_BaseTypeConstant")
nabla_VectorConstant = Class(name="nabla_VectorConstant")
nabla_Cardinality = Class(name="nabla_Cardinality")
...
nabla_Interval_from_: Property = Property(name="from_", type=IntegerType)
nabla_Interval.attributes={nabla_Interval_from_}
...
nabla_ItemRef.attributes={nabla_ItemRef_inc, nabla_ItemRef_dec}
...
else_55: BinaryAssociation = BinaryAssociation(
    name="else_55",
    ends={
...
domain_model = DomainModel(
    name="nabla",
    types={nabla_NablaModule, nabla_Import, nabla_ItemType, nabla_Function, nabla_OptDefinition, nabla_SimpleVarDefinition, nabla_VarGroupDeclaration, nabla_TimeIteratorDefinition, nabla_Job, nabla_SimpleVar, nabla_Expression, nabla_MultipleConnectivity, Connectivity, nabla_SingleConnectivity, nabla_Instruction, nabla_Iterable, nabla_IterationBlock, Instruction, nabla_BaseType, nabla_Connectivity, nabla_Reduction, nabla_Loop, Iterable, nabla_Affectation, nabla_ArgOrVarRef, nabla_If, nabla_ItemDefinition, nabla_Item, nabla_SingleConnectivityCall, nabla_SetDefinition, nabla_MultipleConnectivityCall, nabla_Return, nabla_Exit, nabla_Container, nabla_SetRef, Container, nabla_SpaceIterator, IterationBlock, nabla_SingletonDefinition, nabla_Var, nabla_InstructionBlock, nabla_Interval, nabla_ConnectivityCall, nabla_ItemRef, ConnectivityCall, nabla_TimeIterator, ArgOrVar, nabla_TimeIteratorRef, nabla_CurrentTimeIteratorRef, TimeIteratorRef, nabla_InitTimeIteratorRef, nabla_NextTimeIteratorRef, nabla_ArgOrVar, Var, nabla_ConnectivityVar, nabla_FunctionOrReduction, nabla_Arg, FunctionOrReduction, nabla_IntConstant, Expression, nabla_ReductionCall, nabla_Or, nabla_And, nabla_Equality, nabla_Comparison, nabla_Plus, nabla_Minus, nabla_Mul, nabla_ContractedIf, nabla_Modulo, nabla_Parenthesis, nabla_UnaryMinus, nabla_Not, nabla_RealConstant, nabla_BoolConstant, nabla_MinConstant, nabla_MaxConstant, nabla_FunctionCall, nabla_Div, nabla_BaseTypeConstant, nabla_VectorConstant, nabla_Cardinality, PrimitiveType},
    associations={imports0, itemTypes1, functions7, options9, definitions11, declarations13, iteration15, jobs17, variable19, value21, inTypes23, returnType26, instruction29, iterationBlock31, variable32, value35, type38, connectivities3, reductions5, instructions42, body44, left46, right47, condition50, then52, else_55, item58, value59, value61, expression62, target64, item66, counter68, container71, singletons73, variables40, index81, nbElems83, args86, connectivity87, connectivity89, target91, iterators94, cond96, target99, supports101, vars103, inArgs105, item75, value78, inTypes110, returnType113, seed116, type119, reduction122, arg124, target127, timeIterators129, spaceIterators132, indices135, else_146, body107, left149, right151, left154, right156, left159, right161, left164, right166, left169, right171, left174, right176, left179, sizes138, condition141, then143, Left184, right186, left189, right191, expression194, expression196, expression198, function200, right181, args202, type205, value207, values210, container212},
    generalizations={gen_nabla_MultipleConnectivity_Connectivity, gen_nabla_SingleConnectivity_Connectivity, gen_nabla_SimpleVarDefinition_Instruction, gen_nabla_VarGroupDeclaration_Instruction, gen_nabla_Loop_Iterable, gen_nabla_Loop_Instruction, gen_nabla_Affectation_Instruction, gen_nabla_If_Instruction, gen_nabla_ItemDefinition_Instruction, gen_nabla_SetDefinition_Instruction, gen_nabla_Return_Instruction, gen_nabla_Exit_Instruction, gen_nabla_SetRef_Container, gen_nabla_SpaceIterator_IterationBlock, gen_nabla_InstructionBlock_Instruction, gen_nabla_Interval_IterationBlock, gen_nabla_MultipleConnectivityCall_Container, gen_nabla_MultipleConnectivityCall_ConnectivityCall, gen_nabla_SingleConnectivityCall_ConnectivityCall, gen_nabla_TimeIterator_ArgOrVar, gen_nabla_CurrentTimeIteratorRef_TimeIteratorRef, gen_nabla_InitTimeIteratorRef_TimeIteratorRef, gen_nabla_NextTimeIteratorRef_TimeIteratorRef, gen_nabla_Var_ArgOrVar, gen_nabla_SimpleVar_Var, gen_nabla_ConnectivityVar_Var, gen_nabla_Function_FunctionOrReduction, gen_nabla_Reduction_FunctionOrReduction, gen_nabla_Arg_ArgOrVar, gen_nabla_IntConstant_Expression, gen_nabla_ReductionCall_Iterable, gen_nabla_ReductionCall_Expression, gen_nabla_ArgOrVarRef_Expression, gen_nabla_Or_Expression, gen_nabla_And_Expression, gen_nabla_Equality_Expression, gen_nabla_Comparison_Expression, gen_nabla_Plus_Expression, gen_nabla_Minus_Expression, gen_nabla_Mul_Expression, gen_nabla_ContractedIf_Expression, gen_nabla_Modulo_Expression, gen_nabla_Parenthesis_Expression, gen_nabla_UnaryMinus_Expression, gen_nabla_Not_Expression, gen_nabla_RealConstant_Expression, gen_nabla_BoolConstant_Expression, gen_nabla_MinConstant_Expression, gen_nabla_MaxConstant_Expression, gen_nabla_FunctionCall_Expression, gen_nabla_Div_Expression, gen_nabla_BaseTypeConstant_Expression, gen_nabla_VectorConstant_Expression, gen_nabla_Cardinality_Expression},
    metadata=None
)
