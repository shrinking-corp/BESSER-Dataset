...
class nabla_Equality(Expression):
    ...
    def __init__(self, op: str, nabla_Equality: "nabla_Expression" = None, nabla_Equality162: "nabla_Expression" = None):
        self.op = op
...
class nabla_Or(Expression):
    ...
    def __init__(self, op: str, nabla_Or: "nabla_Expression" = None, nabla_Or152: "nabla_Expression" = None):
        self.op = op
...
class nabla_FunctionOrReduction:
    ...
    def __init__(self, name: str, nabla_FunctionOrReduction: set["nabla_SimpleVar"] = None, nabla_FunctionOrReduction106: set["nabla_Arg"] = None, nabla_FunctionOrReduction108: "nabla_Instruction" = None):
        self.name = name
...
class nabla_Interval(IterationBlock):
    ...
    def __init__(self, from_: int, nabla_Interval: "nabla_SimpleVar" = None, nabla_Interval84: "nabla_Expression" = None):
        self.from_ = from_
...
class nabla_Item:
    ...
    def __init__(self, name: str, nabla_Item: "nabla_ItemDefinition" = None, nabla_Item67: "nabla_SpaceIterator" = None, nabla_Item93: "nabla_ItemRef" = None, nabla_Item77: "nabla_SingletonDefinition" = None):
        self.name = name
...
class Iterable:
    ...
    pass
class nabla_ReductionCall(Iterable, Expression):
...
class nabla_Connectivity:
    ...
    def __init__(self, name: str, nabla_Connectivity24: set["nabla_ItemType"] = None, nabla_Connectivity27: "nabla_ItemType" = None, nabla_Connectivity: "nabla_NablaModule" = None):
        self.name = name
...
class nabla_NablaModule:
    ...
    def __init__(self, name: str, nabla_NablaModule: set["nabla_Import"] = None, nabla_NablaModule2: set["nabla_ItemType"] = None, nabla_NablaModule8: set["nabla_Function"] = None, nabla_NablaModule10: set["nabla_OptDefinition"] = None, nabla_NablaModule12: set["nabla_SimpleVarDefinition"] = None, nabla_NablaModule14: set["nabla_VarGroupDeclaration"] = None, nabla_NablaModule16: "nabla_TimeIteratorDefinition" = None, nabla_NablaModule18: set["nabla_Job"] = None, nabla_NablaModule4: set["nabla_Connectivity"] = None, nabla_NablaModule6: set["nabla_Reduction"] = None):
        self.name = name
