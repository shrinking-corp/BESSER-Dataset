...
SmartHouse_House.attributes={SmartHouse_House_time, SmartHouse_House_name, SmartHouse_House_eprice, SmartHouse_House_outtemp}
...
SmartHouse_Room.attributes={SmartHouse_Room_temp, SmartHouse_Room_name, SmartHouse_Room_air, SmartHouse_Room_bright}
...
SmartHouse_WaterHeater.attributes={SmartHouse_WaterHeater_boost, SmartHouse_WaterHeater_on, SmartHouse_WaterHeater_temp}
...
SmartHouse_Window.attributes={SmartHouse_Window_name, SmartHouse_Window_opened, SmartHouse_Window_curtainOn}
...
SmartHouse_Projector.attributes={SmartHouse_Projector_brightness, SmartHouse_Projector_volume, SmartHouse_Projector_on}
...
domain_model = DomainModel(
    name="SmartHouse",
    types={SmartHouse_EV, SmartHouse_House, SmartHouse_Room, SmartHouse_Person, SmartHouse_WaterHeater, SmartHouse_Gate, SmartHouse_Security, SmartHouse_Cooker, SmartHouse_Window, SmartHouse_Heating, SmartHouse_Light, SmartHouse_AirConditioner, SmartHouse_Sensor, SmartHouse_Projector, SmartHouse_WashingMachine, SmartHouse_CoffeeMaker},
    associations={ev4, room0, member1, wh2, gate6, sec8, house10, house11, house13, cooker33, house15, house17, window19, heating20, light22, ac24, occupied26, sensor29, projector31, wm35, cm37, room39, room41, room43, room45},
    generalizations={},
    metadata=None
)
