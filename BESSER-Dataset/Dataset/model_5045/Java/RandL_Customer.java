...
public class RandL_Customer  {
    ...
    public RandL_Customer(
        String title,        String gender,        String isMale,        String age,        String name    ) {
        this.title = title;
        this.gender = gender;
        this.isMale = isMale;
        this.age = age;
    ...
    public RandL_Customer(
        String title,        String gender,        String isMale,        String age,        String name        ArrayList<RandL_CustomerCard> randl_customercards,        ArrayList<RandL_Membership> randl_memberships,        ArrayList<RandL_LoyaltyProgram> randl_loyaltyprograms    ) {
        this.title = title;
        this.gender = gender;
        this.isMale = isMale;
        this.age = age;
