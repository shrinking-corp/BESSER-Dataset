...
# Classes
testPackage_FirstSubClass = Class(name="testPackage_FirstSubClass")
FirstClass = Class(name="FirstClass")
testPackage_SecondSubClass = Class(name="testPackage_SecondSubClass")
SecondClass = Class(name="SecondClass")
testPackage_FirstClass = Class(name="testPackage_FirstClass")
testPackage_SecondClass = Class(name="testPackage_SecondClass")
...
domain_model = DomainModel(
    name="testPackage",
    types={testPackage_FirstSubClass, FirstClass, testPackage_SecondSubClass, SecondClass, testPackage_FirstClass, testPackage_SecondClass},
    associations={specializationReference1, testReference0},
