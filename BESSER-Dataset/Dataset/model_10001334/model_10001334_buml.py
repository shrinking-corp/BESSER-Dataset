...
Benutzer.attributes={Benutzer_Vorname, Benutzer_Info, Benutzer_Nachname, Benutzer_profilbild}
...
Beitrag.attributes={Beitrag_text, Beitrag_foto, Beitrag_video, Beitrag_privatph_re, Beitrag_Audio}
...
Registrieren.attributes={Registrieren_nachname, Registrieren_email, Registrieren_geburtsdatum, Registrieren_passwort, Registrieren_geschlecht, Registrieren_vorname}
...
Anmelden.attributes={Anmelden_passwort, Anmelden_email}
...
domain_model = DomainModel(
    name="_0eF90DrhEeqTDpmqRhKD9Q",
    types={Benutzer, Beitrag, Group, Ver_ffentlich, Privat, _unnamed, Freund, Hashtag, Registrieren, Anmelden, Kommentare},
