...
# Classes
cevinedit_LinkEClass = Class(name="cevinedit_LinkEClass")
Link = Class(name="Link")
cevinedit_CompartmentEReferenceCont = Class(name="cevinedit_CompartmentEReferenceCont")
cevinedit_AffixedEReferenceCont = Class(name="cevinedit_AffixedEReferenceCont")
cevinedit_LabelEAttribute = Class(name="cevinedit_LabelEAttribute")
cevinedit_LinkEReferenceNonCont = Class(name="cevinedit_LinkEReferenceNonCont")
cevinedit_CEViNEditRoot = Class(name="cevinedit_CEViNEditRoot")
cevinedit_Diagram = Class(name="cevinedit_Diagram")
cevinedit_PersonalizedElement = Class(name="cevinedit_PersonalizedElement", is_abstract=True)
cevinedit_NodeEClass = Class(name="cevinedit_NodeEClass")
PersonalizedElement = Class(name="PersonalizedElement")
cevinedit_Link = Class(name="cevinedit_Link", is_abstract=True)
...
cevinedit_LinkEClass.attributes={cevinedit_LinkEClass_source, cevinedit_LinkEClass_target}
...
cevinedit_CompartmentEReferenceCont.attributes={cevinedit_CompartmentEReferenceCont_collapsible, cevinedit_CompartmentEReferenceCont_layout}
...
cevinedit_Diagram.attributes={cevinedit_Diagram_name, cevinedit_Diagram_modelExtension}
...
cevinedit_PersonalizedElement.attributes={cevinedit_PersonalizedElement_icon, cevinedit_PersonalizedElement_name}
...
cevinedit_NodeEClass.attributes={cevinedit_NodeEClass_brightness, cevinedit_NodeEClass_borderWidth, cevinedit_NodeEClass_borderTexture, cevinedit_NodeEClass_labelFontStyle, cevinedit_NodeEClass_resizable, cevinedit_NodeEClass_label, cevinedit_NodeEClass_imagePath, cevinedit_NodeEClass_size, cevinedit_NodeEClass_figure, cevinedit_NodeEClass_listPointsPolygon, cevinedit_NodeEClass_borderColor, cevinedit_NodeEClass_backgroundColor, cevinedit_NodeEClass_labelPlacement}
...
cevinedit_Link.attributes={cevinedit_Link_color, cevinedit_Link_labelFontStyle, cevinedit_Link_targetDecoration, cevinedit_Link_texture, cevinedit_Link_label, cevinedit_Link_sourceDecoration, cevinedit_Link_width, cevinedit_Link_brightness}
...
domain_model = DomainModel(
    name="cevinedit",
    types={cevinedit_LinkEClass, Link, cevinedit_CompartmentEReferenceCont, cevinedit_AffixedEReferenceCont, cevinedit_LabelEAttribute, cevinedit_LinkEReferenceNonCont, cevinedit_CEViNEditRoot, cevinedit_Diagram, cevinedit_PersonalizedElement, cevinedit_NodeEClass, PersonalizedElement, cevinedit_Link, Placement, LayoutCompartment, Color, Texture, Brightness, FontStyle, NodeFigure, LinkFigure},
    associations={diagram0, containsElem1},
    generalizations={gen_cevinedit_LinkEClass_PersonalizedElement, gen_cevinedit_LinkEClass_Link, gen_cevinedit_CompartmentEReferenceCont_PersonalizedElement, gen_cevinedit_AffixedEReferenceCont_PersonalizedElement, gen_cevinedit_LabelEAttribute_PersonalizedElement, gen_cevinedit_LinkEReferenceNonCont_PersonalizedElement, gen_cevinedit_LinkEReferenceNonCont_Link, gen_cevinedit_NodeEClass_PersonalizedElement, gen_cevinedit_Link_PersonalizedElement},
    metadata=None
)
