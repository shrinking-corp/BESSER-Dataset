...
# Classes
amazoninformational_Order = Class(name="amazoninformational_Order")
amazoninformational_Product = Class(name="amazoninformational_Product")
amazoninformational_Package = Class(name="amazoninformational_Package")
amazoninformational_Customer = Class(name="amazoninformational_Customer")
amazoninformational_Payment = Class(name="amazoninformational_Payment")
amazoninformational_Shipment = Class(name="amazoninformational_Shipment")
amazoninformational_Invoice = Class(name="amazoninformational_Invoice")
...
amazoninformational_Order.attributes={amazoninformational_Order_totalAmount, amazoninformational_Order_status}
...
amazoninformational_Customer.attributes={amazoninformational_Customer_address, amazoninformational_Customer_consummedCredit, amazoninformational_Customer_inGoodStanding, amazoninformational_Customer_isVIP, amazoninformational_Customer_creditLimit}
...
domain_model = DomainModel(
    ...
    types={amazoninformational_Order, amazoninformational_Product, amazoninformational_Package, amazoninformational_Customer, amazoninformational_Payment, amazoninformational_Shipment, amazoninformational_Invoice},
    associations={products0, packages4, customer6, products8, order10, package11, order13, order15, payment17, shipment1, invoice2},
    generalizations={},
    metadata=None
)
