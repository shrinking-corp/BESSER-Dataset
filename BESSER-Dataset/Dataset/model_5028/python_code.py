...
class amazoninformational_Product:
    ...
    def __init__(self, onHand: int, amazoninformational_Product: "amazoninformational_Order" = None, amazoninformational_Product9: "amazoninformational_Package" = None):
        self.onHand = onHand
...
class amazoninformational_Order:
    ...
    def __init__(self, status: str, totalAmount: float, amazoninformational_Order: set["amazoninformational_Product"] = None, order5: set["amazoninformational_Package"] = None, amazoninformational_Order7: "amazoninformational_Customer" = None, Order: "amazoninformational_Package" = None, Order14: "amazoninformational_Shipment" = None, Order16: "amazoninformational_Invoice" = None, order: "amazoninformational_Shipment" = None, order3: "amazoninformational_Invoice" = None):
        self.status = status
