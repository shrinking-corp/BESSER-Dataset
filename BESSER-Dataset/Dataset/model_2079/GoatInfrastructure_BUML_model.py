...
# Classes
goatInfrastructure_TreeNode = Class(name="goatInfrastructure_TreeNode")
goatInfrastructure_Infrastructure = Class(name="goatInfrastructure_Infrastructure")
goatInfrastructure_SingleServer = Class(name="goatInfrastructure_SingleServer")
Infrastructure = Class(name="Infrastructure")
goatInfrastructure_Cluster = Class(name="goatInfrastructure_Cluster")
goatInfrastructure_Ring = Class(name="goatInfrastructure_Ring")
goatInfrastructure_Tree = Class(name="goatInfrastructure_Tree")
...
goatInfrastructure_Cluster.attributes={goatInfrastructure_Cluster_mid_assigner, goatInfrastructure_Cluster_nodes, goatInfrastructure_Cluster_registration, goatInfrastructure_Cluster_message_queue}
...
goatInfrastructure_Ring.attributes={goatInfrastructure_Ring_nodes, goatInfrastructure_Ring_mid_assigner, goatInfrastructure_Ring_registration}
...
domain_model = DomainModel(
    ...
    types={goatInfrastructure_TreeNode, goatInfrastructure_Infrastructure, goatInfrastructure_SingleServer, Infrastructure, goatInfrastructure_Cluster, goatInfrastructure_Ring, goatInfrastructure_Tree},
    associations={root0, children2},
    generalizations={gen_goatInfrastructure_SingleServer_Infrastructure, gen_goatInfrastructure_Cluster_Infrastructure, gen_goatInfrastructure_Ring_Infrastructure, gen_goatInfrastructure_Tree_Infrastructure},
    metadata=None
)
