...
def test_hyp_transaccion_is_not_abstract():
    assert not inspect.isabstract(Transaccion)


def test_hyp_transaccion_constructor_exists():
    assert callable(Transaccion.__init__)


def test_hyp_transaccion_constructor_args():
...
def test_hyp_transaccion_atributo1_setter(instance):
