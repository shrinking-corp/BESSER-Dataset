...
public class JavaSimplified_VariableDeclarationStatement extends TypedElement, NamedElement, Statement {
    ...
    public JavaSimplified_VariableDeclarationStatement(
    ) {
        super(
        );
    }
