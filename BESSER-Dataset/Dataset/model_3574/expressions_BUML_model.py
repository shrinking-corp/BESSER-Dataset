...
expressions_AddExpression = Class(name="expressions_AddExpression")
expressions_Expression = Class(name="expressions_Expression", is_abstract=True)
FileRegion = Class(name="FileRegion")
expressions_ConstExpression = Class(name="expressions_ConstExpression")
Expression = Class(name="Expression")
expressions_OrExpression = Class(name="expressions_OrExpression")
expressions_XOrExpression = Class(name="expressions_XOrExpression")
expressions_AndExpression = Class(name="expressions_AndExpression")
expressions_CharacterLiteral = Class(name="expressions_CharacterLiteral")
expressions_FloatingPointLiteral = Class(name="expressions_FloatingPointLiteral")
expressions_DoubleLiteral = Class(name="expressions_DoubleLiteral")
expressions_BooleanLiteral = Class(name="expressions_BooleanLiteral")
expressions_FixedPtLiteral = Class(name="expressions_FixedPtLiteral")
expressions_MultExpression = Class(name="expressions_MultExpression")
expressions_UnaryExpression = Class(name="expressions_UnaryExpression")
expressions_ScopeLiteral = Class(name="expressions_ScopeLiteral")
expressions_IdlTypeDcl = Class(name="expressions_IdlTypeDcl")
expressions_IntegerLiteral = Class(name="expressions_IntegerLiteral")
expressions_StringLiteral = Class(name="expressions_StringLiteral")
expressions_WideStringLiteral = Class(name="expressions_WideStringLiteral")
expressions_WideCharacterLiteral = Class(name="expressions_WideCharacterLiteral")
...
expressions_FixedPtLiteral.attributes={expressions_FixedPtLiteral_value, expressions_FixedPtLiteral_decimalPart, expressions_FixedPtLiteral_integerPart}
...
domain_model = DomainModel(
    name="expressions",
    types={expressions_ShiftExpression, expressions_AddExpression, expressions_Expression, FileRegion, expressions_ConstExpression, Expression, expressions_OrExpression, expressions_XOrExpression, expressions_AndExpression, expressions_CharacterLiteral, expressions_FloatingPointLiteral, expressions_DoubleLiteral, expressions_BooleanLiteral, expressions_FixedPtLiteral, expressions_MultExpression, expressions_UnaryExpression, expressions_ScopeLiteral, expressions_IdlTypeDcl, expressions_IntegerLiteral, expressions_StringLiteral, expressions_WideStringLiteral, expressions_WideCharacterLiteral, ShiftType, AddType, MultiType, UnaryType},
    associations={left16, right18, left21, expression0, left1, right3, left6, right8, left11, right13, right23, left26, right28, expr31, value33},
    generalizations={gen_expressions_ShiftExpression_Expression, gen_expressions_AddExpression_Expression, gen_expressions_Expression_FileRegion, gen_expressions_ConstExpression_Expression, gen_expressions_OrExpression_Expression, gen_expressions_XOrExpression_Expression, gen_expressions_AndExpression_Expression, gen_expressions_CharacterLiteral_Expression, gen_expressions_FloatingPointLiteral_Expression, gen_expressions_DoubleLiteral_Expression, gen_expressions_BooleanLiteral_Expression, gen_expressions_FixedPtLiteral_Expression, gen_expressions_MultExpression_Expression, gen_expressions_UnaryExpression_Expression, gen_expressions_ScopeLiteral_Expression, gen_expressions_IntegerLiteral_Expression, gen_expressions_StringLiteral_Expression, gen_expressions_WideStringLiteral_Expression, gen_expressions_WideCharacterLiteral_Expression},
    metadata=None
)
