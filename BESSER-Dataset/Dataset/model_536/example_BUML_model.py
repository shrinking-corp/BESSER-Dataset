...
domain_model = DomainModel(
    name="Example",
    types={Example_Family, Example_Cat, Example_RaceDog, Dog, Example_HuntingDog, Example_Parent, Example_Son, Example_Daughter, Example_Pet, Example_Member, Member, Example_Dog, Pet},
    associations={parents0, sons1, daughters3, pets5, family6, family7, family9},
    generalizations={gen_Example_Cat_Pet, gen_Example_RaceDog_Dog, gen_Example_HuntingDog_Dog, gen_Example_Parent_Member, gen_Example_Son_Member, gen_Example_Daughter_Member, gen_Example_Dog_Pet},
    metadata=None
)
