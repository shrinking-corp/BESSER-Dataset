...
state_State.attributes={state_State_name, state_State_duration}
...
domain_model = DomainModel(
    name="state",
    types={state_Node, state_Transition, state_TimeoutTransition, Transition, state_Condition, state_InitialNode, Node, state_FinalNode, state_ConditionalNode, state_State, state_StateMachine, state_Module},
    associations={outgoing1, source4, target7, incoming0, guard10, condition12, nodes14, transitions16, module19},
    generalizations={gen_state_TimeoutTransition_Transition, gen_state_InitialNode_Node, gen_state_FinalNode_Node, gen_state_ConditionalNode_Node, gen_state_State_Node},
    metadata=None
)
