...
class smarthome_Command:
    ...
    def __init__(self, command: str, smarthome_Command18: "smarthome_CommandConnection" = None, smarthome_Command: "smarthome_Item" = None):
...
class smarthome_State:
    ...
    def __init__(self, state: str, smarthome_State21: "smarthome_StateChangeConnection" = None, smarthome_State27: "smarthome_FilterConnection" = None, smarthome_State: "smarthome_Item" = None):
        self.state = state
...
class smarthome_Item(ABC):
    ...
    def __init__(self, name: str, smarthome_Item: "smarthome_SmartHome" = None, smarthome_Item15: "smarthome_CommandConnection" = None, smarthome_Item24: "smarthome_StateChangeConnection" = None, smarthome_Item30: "smarthome_FilterConnection" = None, smarthome_Item4: set["smarthome_State"] = None, smarthome_Item6: set["smarthome_Command"] = None):
        self.name = name
