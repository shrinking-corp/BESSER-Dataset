...
public class pivot_State extends Vertex, Namespace {
    ...
    public pivot_State(
        String isComposite,        String isSubmachineState,        String isOrthogonal,        String isSimple        ArrayList<pivot_Trigger> pivot_triggers,        ArrayList<pivot_Region> pivot_regions    ) {
        this.isComposite = isComposite;
        this.isSubmachineState = isSubmachineState;
        this.isOrthogonal = isOrthogonal;
        this.isSimple = isSimple;
