...
# Classes
kreq108c_Bbbb = Class(name="kreq108c_Bbbb")
kreq108c_Cccc = Class(name="kreq108c_Cccc")
kreq108c_Eeee = Class(name="kreq108c_Eeee")
kreq108c_Ffff = Class(name="kreq108c_Ffff")
Gggg = Class(name="Gggg")
kreq108c_Gggg = Class(name="kreq108c_Gggg", is_abstract=True)
...
domain_model = DomainModel(
    name="kreq108c",
    types={kreq108c_Bbbb, kreq108c_Cccc, kreq108c_Eeee, kreq108c_Ffff, Gggg, kreq108c_Gggg},
    associations={cs0, es1, fs3, varifedBy5, subFs9},
    generalizations={gen_kreq108c_Eeee_Gggg, gen_kreq108c_Ffff_Gggg},
    metadata=None
)
