...
# Classes
transitiongraph_TransitionGraph = Class(name="transitiongraph_TransitionGraph")
transitiongraph_State = Class(name="transitiongraph_State")
transitiongraph_Transition = Class(name="transitiongraph_Transition")
...
transitiongraph_Transition.attributes={transitiongraph_Transition_label, transitiongraph_Transition_probability}
...
domain_model = DomainModel(
    ...
    associations={states0, transitions1, outgoing3, incoming4, source6, target7},
    generalizations={},
    metadata=None
)
