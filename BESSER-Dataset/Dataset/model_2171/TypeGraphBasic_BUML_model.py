...
domain_model = DomainModel(
    name="TypeGraphBasic",
    types={TypeGraphBasic_TClass, TypeGraphBasic_TField, TypeGraphBasic_TFieldSignature, TypeGraphBasic_TFieldDefinition, TMember, TSignature, TypeGraphBasic_TMethod, TypeGraphBasic_TMethodSignature, TypeGraphBasic_TMethodDefinition, TypeGraphBasic_TSignature, TypeGraphBasic_TPackage, TypeGraphBasic_TMember, TypeGraphBasic_TypeGraph},
    associations={signatures9, hiding11, hiddenBy13, signature15, definitions17, field19, type20, access23, signatures25, parentClass1, childClasses3, signature5, package6, defines7, method42, definitions44, paramList47, containedClasses49, subpackage52, parent55, packages57, methods58, fields60, classes62, signature26, overriding30, overriddenBy32, overloading35, overloadedBy38, returnType40},
