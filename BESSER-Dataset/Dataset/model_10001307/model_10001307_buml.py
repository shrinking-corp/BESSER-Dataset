...
domain_model = DomainModel(
    ...
    associations={Sensor_Door, Door_Camera, HomeTheatre_TV, HomeTheatre_Speakers, HouseHolds_Start_Of_Day, HouseHolds_End_Of_Day, MicroPhone_System, Home_Security_System_Alert, Sensor_System, Home_Security_System_System, TV_Entertainment, Speakers_Entertainment, HomeTheatre_Entertainment, System_HouseHolds, HomeTheatre_System},
    generalizations={},
    metadata=None
)
