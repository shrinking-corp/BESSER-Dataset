...
public class ecore_EClass extends EClassifier {
    ...
    public ecore_EClass(
        boolean interface,        boolean abstract        ArrayList<ecore_EAttribute> ecore_eattributes,        ArrayList<ecore_EReference> ecore_ereferences,        ArrayList<ecore_EReference> ecore_ereferences,        ArrayList<ecore_EReference> ecore_ereferences,        ArrayList<ecore_EClass> ecore_eclasss,        ArrayList<ecore_EAttribute> ecore_eattributes    ) {
        this.interface = interface;
        this.abstract = abstract;
