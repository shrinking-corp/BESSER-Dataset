...
def test_hyp_terms_makelist_is_not_abstract():
    assert not inspect.isabstract(terms_MakeList)


def test_hyp_terms_makelist_constructor_exists():
    assert callable(terms_MakeList.__init__)


def test_hyp_terms_makelist_constructor_args():
    sig = inspect.signature(terms_MakeList.__init__)
    params = list(sig.parameters.keys())



def test_hyp_terms_emptylist_is_not_abstract():
    assert not inspect.isabstract(terms_EmptyList)


def test_hyp_terms_emptylist_constructor_exists():
    assert callable(terms_EmptyList.__init__)


def test_hyp_terms_emptylist_constructor_args():
    sig = inspect.signature(terms_EmptyList.__init__)
    params = list(sig.parameters.keys())



def test_hyp_terms_hlpnlist_is_not_abstract():
    assert not inspect.isabstract(terms_HLPNList)


def test_hyp_terms_hlpnlist_constructor_exists():
    assert callable(terms_HLPNList.__init__)


def test_hyp_terms_hlpnlist_constructor_args():
