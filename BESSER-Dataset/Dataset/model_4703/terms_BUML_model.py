...
# Classes
terms_Declaration = Class(name="terms_Declaration")
terms_Declarations = Class(name="terms_Declarations")
terms_TermsDeclaration = Class(name="terms_TermsDeclaration", is_abstract=True)
terms_HLPNList = Class(name="terms_HLPNList")
terms_EmptyList = Class(name="terms_EmptyList")
terms_MakeList = Class(name="terms_MakeList")
terms_Sort = Class(name="terms_Sort", is_abstract=True)
terms_MultisetSort = Class(name="terms_MultisetSort")
terms_NamedSort = Class(name="terms_NamedSort")
terms_VariableDecl = Class(name="terms_VariableDecl")
terms_ProductSort = Class(name="terms_ProductSort")
terms_Type = Class(name="terms_Type")
terms_All = Class(name="terms_All")
terms_Empty = Class(name="terms_Empty")
terms_Partition = Class(name="terms_Partition")
TermsDeclaration = Class(name="TermsDeclaration")
Sort = Class(name="Sort")
terms_Term = Class(name="terms_Term", is_abstract=True)
terms_Operator = Class(name="terms_Operator", is_abstract=True)
terms_NamedOperator = Class(name="terms_NamedOperator")
terms_HLMarking = Class(name="terms_HLMarking")
terms_Condition = Class(name="terms_Condition")
terms_HLAnnotation = Class(name="terms_HLAnnotation")
terms_PartitionElement = Class(name="terms_PartitionElement")
Term = Class(name="Term")
terms_Variable = Class(name="terms_Variable")
terms_BuiltInSort = Class(name="terms_BuiltInSort", is_abstract=True)
terms_BuiltInConstant = Class(name="terms_BuiltInConstant", is_abstract=True)
Operator = Class(name="Operator")
terms_MultisetOperator = Class(name="terms_MultisetOperator", is_abstract=True)
terms_Tuple = Class(name="terms_Tuple")
terms_SortDecl = Class(name="terms_SortDecl", is_abstract=True)
terms_BuiltInOperator = Class(name="terms_BuiltInOperator", is_abstract=True)
SortDecl = Class(name="SortDecl")
terms_UserSort = Class(name="terms_UserSort")
terms_OperatorDecl = Class(name="terms_OperatorDecl", is_abstract=True)
OperatorDecl = Class(name="OperatorDecl")
terms_UserOperator = Class(name="terms_UserOperator")
...
containerPartition12: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="def_", type=terms_Partition, multiplicity=Multiplicity(0, 1))
    }
)
...
containerNamedOperator22: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="def_23", type=terms_NamedOperator, multiplicity=Multiplicity(0, 1))
    }
)
...
def_47: BinaryAssociation = BinaryAssociation(
    name="def_47",
    ends={
...
domain_model = DomainModel(
    name="terms",
    types={terms_Declaration, terms_Declarations, terms_TermsDeclaration, terms_HLPNList, terms_EmptyList, terms_MakeList, terms_Sort, terms_MultisetSort, terms_NamedSort, terms_VariableDecl, terms_ProductSort, terms_Type, terms_All, terms_Empty, terms_Partition, TermsDeclaration, Sort, terms_Term, terms_Operator, terms_NamedOperator, terms_HLMarking, terms_Condition, terms_HLAnnotation, terms_PartitionElement, Term, terms_Variable, terms_BuiltInSort, terms_BuiltInConstant, Operator, terms_MultisetOperator, terms_Tuple, terms_SortDecl, terms_BuiltInOperator, SortDecl, terms_UserSort, terms_OperatorDecl, OperatorDecl, terms_UserOperator},
    associations={containerDeclaration1, declaration0, containerList13, containerEmptyList15, containerDeclarations2, multi3, containerNamedSort4, containerVariableDecl5, containerProductSort6, containerType7, containerAll9, containerEmpty10, containerPartition12, output32, input34, containerMakeList17, basis19, sort20, containerOperator21, containerNamedOperator22, containerHLMarking24, containerCondition26, containerHLAnnotation28, containerPartitionElement30, subterm31, sortdef44, sort37, containerNamedOperator39, variableDecl41, elementSort42, declaration46, def_47, parameters49, declaration52},
    generalizations={gen_terms_VariableDecl_TermsDeclaration, gen_terms_MultisetSort_Sort, gen_terms_Operator_Term, gen_terms_Variable_Term, gen_terms_BuiltInSort_Sort, gen_terms_ProductSort_Sort, gen_terms_BuiltInConstant_Operator, gen_terms_MultisetOperator_Operator, gen_terms_Tuple_Operator, gen_terms_SortDecl_TermsDeclaration, gen_terms_BuiltInOperator_Operator, gen_terms_NamedSort_SortDecl, gen_terms_UserSort_Sort, gen_terms_OperatorDecl_TermsDeclaration, gen_terms_NamedOperator_OperatorDecl, gen_terms_UserOperator_Operator},
    metadata=None
)
