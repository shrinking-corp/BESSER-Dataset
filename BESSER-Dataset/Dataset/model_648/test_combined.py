...
def test_hyp_mm4_medium_is_not_abstract():
    assert not inspect.isabstract(mm4_Medium)


def test_hyp_mm4_medium_constructor_exists():
    assert callable(mm4_Medium.__init__)


def test_hyp_mm4_medium_constructor_args():
...
def test_hyp_mm4_member_is_not_abstract():
    assert not inspect.isabstract(mm4_Member)


def test_hyp_mm4_member_constructor_exists():
    assert callable(mm4_Member.__init__)


def test_hyp_mm4_member_constructor_args():
...
def test_hyp_mm4_library_is_not_abstract():
    assert not inspect.isabstract(mm4_Library)


def test_hyp_mm4_library_constructor_exists():
    assert callable(mm4_Library.__init__)


def test_hyp_mm4_library_constructor_args():
...
def test_hyp_mm4_medium_type_setter(instance):
...
@given(instance=mm4_Medium_strategy)
def test_hyp_mm4_medium_name_setter(instance):
...
def test_hyp_mm4_member_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_mm4_library_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
