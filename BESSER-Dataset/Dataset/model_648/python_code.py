...
class mm4_Medium:
    ...
    def __init__(self, name: str, type: str, mm4_Medium5: "mm4_Member" = None, mm4_Medium: "mm4_Library" = None):
        self.name = name
        self.type = type
...
class mm4_Member:
    ...
    def __init__(self, name: str, mm4_Member4: set["mm4_Medium"] = None, mm4_Member: "mm4_Library" = None):
        self.name = name
