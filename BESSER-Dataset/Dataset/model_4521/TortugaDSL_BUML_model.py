...
# Classes
tortugaDSL_SENTENCE = Class(name="tortugaDSL_SENTENCE")
tortugaDSL_MOVE = Class(name="tortugaDSL_MOVE")
SENTENCE = Class(name="SENTENCE")
tortugaDSL_EXPRESSION = Class(name="tortugaDSL_EXPRESSION")
tortugaDSL_FORWARD = Class(name="tortugaDSL_FORWARD")
MOVE = Class(name="MOVE")
tortugaDSL_LEFT = Class(name="tortugaDSL_LEFT")
tortugaDSL_RIGHT = Class(name="tortugaDSL_RIGHT")
tortugaDSL_SET_X = Class(name="tortugaDSL_SET_X")
tortugaDSL_SET_Y = Class(name="tortugaDSL_SET_Y")
tortugaDSL_DRAWING_SENTENCE = Class(name="tortugaDSL_DRAWING_SENTENCE")
tortugaDSL_PENDOWN = Class(name="tortugaDSL_PENDOWN")
DRAWING_SENTENCE = Class(name="DRAWING_SENTENCE")
tortugaDSL_PENUP = Class(name="tortugaDSL_PENUP")
tortugaDSL_COLOREABLE = Class(name="tortugaDSL_COLOREABLE")
tortugaDSL_TortugaProgram = Class(name="tortugaDSL_TortugaProgram")
tortugaDSL_FONT_SPEC = Class(name="tortugaDSL_FONT_SPEC")
tortugaDSL_FONT_SIZE = Class(name="tortugaDSL_FONT_SIZE")
FONT_SPEC = Class(name="FONT_SPEC")
tortugaDSL_FONT_STYLE = Class(name="tortugaDSL_FONT_STYLE")
tortugaDSL_FontStyleValues = Class(name="tortugaDSL_FontStyleValues")
tortugaDSL_CLEAR = Class(name="tortugaDSL_CLEAR")
tortugaDSL_HOME = Class(name="tortugaDSL_HOME")
tortugaDSL_DRAW_STRING = Class(name="tortugaDSL_DRAW_STRING")
tortugaDSL_REFERENCIABLE = Class(name="tortugaDSL_REFERENCIABLE")
tortugaDSL_MAKE = Class(name="tortugaDSL_MAKE")
REFERENCIABLE = Class(name="REFERENCIABLE")
tortugaDSL_COLOR_SPEC = Class(name="tortugaDSL_COLOR_SPEC")
tortugaDSL_VARIABLE_REF = Class(name="tortugaDSL_VARIABLE_REF")
tortugaDSL_PENCOLOR = Class(name="tortugaDSL_PENCOLOR")
COLOREABLE = Class(name="COLOREABLE")
tortugaDSL_CANVAS_COLOR = Class(name="tortugaDSL_CANVAS_COLOR")
tortugaDSL_SUM = Class(name="tortugaDSL_SUM")
OPERATION = Class(name="OPERATION")
tortugaDSL_SUBTRACT = Class(name="tortugaDSL_SUBTRACT")
tortugaDSL_MULTIPLY = Class(name="tortugaDSL_MULTIPLY")
tortugaDSL_DIVIDE = Class(name="tortugaDSL_DIVIDE")
tortugaDSL_CONTROL_SENTENCES = Class(name="tortugaDSL_CONTROL_SENTENCES")
tortugaDSL_REPEAT = Class(name="tortugaDSL_REPEAT")
CONTROL_SENTENCES = Class(name="CONTROL_SENTENCES")
tortugaDSL_TO = Class(name="tortugaDSL_TO")
EXPRESSION = Class(name="EXPRESSION")
tortugaDSL_VALUE = Class(name="tortugaDSL_VALUE")
tortugaDSL_CONTENT = Class(name="tortugaDSL_CONTENT")
tortugaDSL_OPERATION = Class(name="tortugaDSL_OPERATION")
tortugaDSL_EQUALS = Class(name="tortugaDSL_EQUALS")
BOOLEAN_EXPRESSION = Class(name="BOOLEAN_EXPRESSION")
tortugaDSL_GREATER_THAN = Class(name="tortugaDSL_GREATER_THAN")
tortugaDSL_LESSER_THAN = Class(name="tortugaDSL_LESSER_THAN")
tortugaDSL_BOLD = Class(name="tortugaDSL_BOLD")
FontStyleValues = Class(name="FontStyleValues")
tortugaDSL_ITALIC = Class(name="tortugaDSL_ITALIC")
tortugaDSL_PLAIN = Class(name="tortugaDSL_PLAIN")
tortugaDSL_PARAM = Class(name="tortugaDSL_PARAM")
tortugaDSL_PROCEDURE_CALL = Class(name="tortugaDSL_PROCEDURE_CALL")
tortugaDSL_IF = Class(name="tortugaDSL_IF")
tortugaDSL_BOOLEAN_EXPRESSION = Class(name="tortugaDSL_BOOLEAN_EXPRESSION")
...
domain_model = DomainModel(
    name="tortugaDSL",
    types={tortugaDSL_SENTENCE, tortugaDSL_MOVE, SENTENCE, tortugaDSL_EXPRESSION, tortugaDSL_FORWARD, MOVE, tortugaDSL_LEFT, tortugaDSL_RIGHT, tortugaDSL_SET_X, tortugaDSL_SET_Y, tortugaDSL_DRAWING_SENTENCE, tortugaDSL_PENDOWN, DRAWING_SENTENCE, tortugaDSL_PENUP, tortugaDSL_COLOREABLE, tortugaDSL_TortugaProgram, tortugaDSL_FONT_SPEC, tortugaDSL_FONT_SIZE, FONT_SPEC, tortugaDSL_FONT_STYLE, tortugaDSL_FontStyleValues, tortugaDSL_CLEAR, tortugaDSL_HOME, tortugaDSL_DRAW_STRING, tortugaDSL_REFERENCIABLE, tortugaDSL_MAKE, REFERENCIABLE, tortugaDSL_COLOR_SPEC, tortugaDSL_VARIABLE_REF, tortugaDSL_PENCOLOR, COLOREABLE, tortugaDSL_CANVAS_COLOR, tortugaDSL_SUM, OPERATION, tortugaDSL_SUBTRACT, tortugaDSL_MULTIPLY, tortugaDSL_DIVIDE, tortugaDSL_CONTROL_SENTENCES, tortugaDSL_REPEAT, CONTROL_SENTENCES, tortugaDSL_TO, EXPRESSION, tortugaDSL_VALUE, tortugaDSL_CONTENT, tortugaDSL_OPERATION, tortugaDSL_EQUALS, BOOLEAN_EXPRESSION, tortugaDSL_GREATER_THAN, tortugaDSL_LESSER_THAN, tortugaDSL_BOLD, FontStyleValues, tortugaDSL_ITALIC, tortugaDSL_PLAIN, tortugaDSL_PARAM, tortugaDSL_PROCEDURE_CALL, tortugaDSL_IF, tortugaDSL_BOOLEAN_EXPRESSION},
    associations={sentences0, amount1, alpha12, size15, style17, value18, colorSpec2, red3, green6, blue9, targetVariable23, valOne25, valTwo28, commands31, times33, toVar20, var21, condition41, op142, op245, parameters35, to36, params38},
    generalizations={gen_tortugaDSL_MOVE_SENTENCE, gen_tortugaDSL_FORWARD_MOVE, gen_tortugaDSL_LEFT_MOVE, gen_tortugaDSL_RIGHT_MOVE, gen_tortugaDSL_SET_X_MOVE, gen_tortugaDSL_SET_Y_MOVE, gen_tortugaDSL_DRAWING_SENTENCE_SENTENCE, gen_tortugaDSL_PENDOWN_DRAWING_SENTENCE, gen_tortugaDSL_PENUP_DRAWING_SENTENCE, gen_tortugaDSL_COLOREABLE_DRAWING_SENTENCE, gen_tortugaDSL_FONT_SPEC_DRAWING_SENTENCE, gen_tortugaDSL_FONT_SIZE_FONT_SPEC, gen_tortugaDSL_FONT_STYLE_FONT_SPEC, gen_tortugaDSL_CLEAR_DRAWING_SENTENCE, gen_tortugaDSL_HOME_DRAWING_SENTENCE, gen_tortugaDSL_DRAW_STRING_DRAWING_SENTENCE, gen_tortugaDSL_MAKE_SENTENCE, gen_tortugaDSL_MAKE_REFERENCIABLE, gen_tortugaDSL_PENCOLOR_COLOREABLE, gen_tortugaDSL_CANVAS_COLOR_COLOREABLE, gen_tortugaDSL_SUM_OPERATION, gen_tortugaDSL_SUBTRACT_OPERATION, gen_tortugaDSL_MULTIPLY_OPERATION, gen_tortugaDSL_DIVIDE_OPERATION, gen_tortugaDSL_CONTROL_SENTENCES_SENTENCE, gen_tortugaDSL_REPEAT_CONTROL_SENTENCES, gen_tortugaDSL_TO_CONTROL_SENTENCES, gen_tortugaDSL_VARIABLE_REF_EXPRESSION, gen_tortugaDSL_VALUE_EXPRESSION, gen_tortugaDSL_CONTENT_SENTENCE, gen_tortugaDSL_OPERATION_SENTENCE, gen_tortugaDSL_EQUALS_BOOLEAN_EXPRESSION, gen_tortugaDSL_GREATER_THAN_BOOLEAN_EXPRESSION, gen_tortugaDSL_LESSER_THAN_BOOLEAN_EXPRESSION, gen_tortugaDSL_BOLD_FontStyleValues, gen_tortugaDSL_ITALIC_FontStyleValues, gen_tortugaDSL_PLAIN_FontStyleValues, gen_tortugaDSL_PARAM_REFERENCIABLE, gen_tortugaDSL_PROCEDURE_CALL_SENTENCE, gen_tortugaDSL_IF_CONTROL_SENTENCES},
    metadata=None
)
