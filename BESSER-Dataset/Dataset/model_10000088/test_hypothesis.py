...
def test_auto_events_scheduler__actor_is_not_abstract():
    assert not inspect.isabstract(Auto_Events_Scheduler__Actor)


def test_auto_events_scheduler__actor_constructor_exists():
    assert callable(Auto_Events_Scheduler__Actor.__init__)


def test_auto_events_scheduler__actor_constructor_args():
