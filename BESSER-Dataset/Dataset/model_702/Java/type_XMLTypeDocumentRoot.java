...
public class type_XMLTypeDocumentRoot  {
    ...
    public type_XMLTypeDocumentRoot(
        String comment,        String text,        String mixed,        String cDATA    ) {
    ...
    public type_XMLTypeDocumentRoot(
        String comment,        String text,        String mixed,        String cDATA        ArrayList<type_ProcessingInstruction> type_processinginstructions    ) {
        this.comment = comment;
        this.text = text;
        this.mixed = mixed;
        this.cDATA = cDATA;
