...
# Classes
graphpattern_GraphPattern = Class(name="graphpattern_GraphPattern")
PatternElement = Class(name="PatternElement")
graphpattern_NodePattern = Class(name="graphpattern_NodePattern")
graphpattern_Pattern = Class(name="graphpattern_Pattern")
graphpattern_DependencyGraph = Class(name="graphpattern_DependencyGraph")
graphpattern_SubGraph = Class(name="graphpattern_SubGraph")
GraphElement = Class(name="GraphElement")
graphpattern_EdgePattern = Class(name="graphpattern_EdgePattern")
graphpattern_EClass = Class(name="graphpattern_EClass")
graphpattern_AttributePattern = Class(name="graphpattern_AttributePattern")
graphpattern_Matching = Class(name="graphpattern_Matching", is_abstract=True)
graphpattern_Association = Class(name="graphpattern_Association")
graphpattern_EPackage = Class(name="graphpattern_EPackage")
graphpattern_EReference = Class(name="graphpattern_EReference")
graphpattern_EAttribute = Class(name="graphpattern_EAttribute")
graphpattern_EObject = Class(name="graphpattern_EObject")
graphpattern_Bundle = Class(name="graphpattern_Bundle")
Pattern = Class(name="Pattern")
graphpattern_Profile = Class(name="graphpattern_Profile")
graphpattern_Parameter = Class(name="graphpattern_Parameter")
graphpattern_Assignment = Class(name="graphpattern_Assignment")
graphpattern_PatternElement = Class(name="graphpattern_PatternElement", is_abstract=True)
Extendable = Class(name="Extendable")
graphpattern_EObjectList = Class(name="graphpattern_EObjectList")
graphpattern_DependencyNode = Class(name="graphpattern_DependencyNode")
graphpattern_DependencyEdge = Class(name="graphpattern_DependencyEdge")
graphpattern_GraphElement = Class(name="graphpattern_GraphElement", is_abstract=True)
graphpattern_Stereotype = Class(name="graphpattern_Stereotype")
graphpattern_ParameterBinding = Class(name="graphpattern_ParameterBinding", is_abstract=True)
graphpattern_ObjectBinding = Class(name="graphpattern_ObjectBinding")
ParameterBinding = Class(name="ParameterBinding")
graphpattern_ValueBinding = Class(name="graphpattern_ValueBinding")
graphpattern_Resource = Class(name="graphpattern_Resource", is_abstract=True)
graphpattern_Extendable = Class(name="graphpattern_Extendable", is_abstract=True)
...
graphpattern_NodePattern_m_getAttribute: Method = Method(name="getAttribute", parameters={Parameter(name='graphpattern_type', type=StringType)}, type=StringType)
graphpattern_NodePattern_m_getOutgoings: Method = Method(name="getOutgoings", parameters={Parameter(name='graphpattern_type', type=StringType)}, type=StringType)
graphpattern_NodePattern_m_getOutgoing: Method = Method(name="getOutgoing", parameters={Parameter(name='graphpattern_type', type=StringType)}, type=StringType)
graphpattern_NodePattern_m_getOutgoing: Method = Method(name="getOutgoing", parameters={Parameter(name='graphpattern_type', type=StringType), Parameter(name='graphpattern_target', type=StringType)}, type=StringType)
graphpattern_NodePattern_m_getOutgoing: Method = Method(name="getOutgoing", parameters={Parameter(name='graphpattern_target', type=StringType), Parameter(name='graphpattern_stereotype', type=StringType), Parameter(name='graphpattern_type', type=StringType)}, type=StringType)
graphpattern_NodePattern_m_getIncoming: Method = Method(name="getIncoming", parameters={Parameter(name='graphpattern_type', type=StringType)}, type=StringType)
graphpattern_NodePattern_m_getIncomings: Method = Method(name="getIncomings", parameters={Parameter(name='graphpattern_type', type=StringType)}, type=StringType)
graphpattern_NodePattern_m_getIncident: Method = Method(name="getIncident", parameters={}, type=StringType)
graphpattern_NodePattern_m_getIncident: Method = Method(name="getIncident", parameters={Parameter(name='graphpattern_adjacent', type=StringType)}, type=StringType)
graphpattern_NodePattern_m_removeIncident: Method = Method(name="removeIncident", parameters={}, type=StringType)
graphpattern_NodePattern_m_removeIncident: Method = Method(name="removeIncident", parameters={Parameter(name='graphpattern_node', type=StringType)}, type=StringType)
graphpattern_NodePattern_m_getAdjacent: Method = Method(name="getAdjacent", parameters={}, type=StringType)
graphpattern_NodePattern.methods={graphpattern_NodePattern_m_getIncident, graphpattern_NodePattern_m_getOutgoing, graphpattern_NodePattern_m_getIncoming, graphpattern_NodePattern_m_getOutgoing, graphpattern_NodePattern_m_getOutgoing, graphpattern_NodePattern_m_getIncident, graphpattern_NodePattern_m_getAttribute, graphpattern_NodePattern_m_removeIncident, graphpattern_NodePattern_m_getIncomings, graphpattern_NodePattern_m_getAdjacent, graphpattern_NodePattern_m_getOutgoings, graphpattern_NodePattern_m_removeIncident}

# graphpattern_Pattern class attributes and methods
graphpattern_Pattern_m_getPattern: Method = Method(name="getPattern", parameters={Parameter(name='graphpattern_name', type=StringType)}, type=Pattern)
graphpattern_Pattern_m_getParameter: Method = Method(name="getParameter", parameters={Parameter(name='graphpattern_name', type=StringType)}, type=StringType)
graphpattern_Pattern_m_getGraph: Method = Method(name="getGraph", parameters={Parameter(name='graphpattern_name', type=StringType)}, type=StringType)
graphpattern_Pattern_m_getAllGraphPatterns: Method = Method(name="getAllGraphPatterns", parameters={}, type=StringType)
graphpattern_Pattern.methods={graphpattern_Pattern_m_getPattern, graphpattern_Pattern_m_getGraph, graphpattern_Pattern_m_getAllGraphPatterns, graphpattern_Pattern_m_getParameter}
...
graphpattern_AttributePattern.attributes={graphpattern_AttributePattern_value, graphpattern_AttributePattern_variables, graphpattern_AttributePattern_constant}
...
graphpattern_Matching_m_add: Method = Method(name="add", parameters={Parameter(name='graphpattern_match', type=StringType)})
graphpattern_Matching_m_remove: Method = Method(name="remove", parameters={Parameter(name='graphpattern_match', type=StringType)}, type=BooleanType)
graphpattern_Matching_m_contains: Method = Method(name="contains", parameters={Parameter(name='graphpattern_match', type=StringType)}, type=BooleanType)
graphpattern_Matching_m_clear: Method = Method(name="clear", parameters={})
graphpattern_Matching.methods={graphpattern_Matching_m_size, graphpattern_Matching_m_contains, graphpattern_Matching_m_clear, graphpattern_Matching_m_iterator, graphpattern_Matching_m_remove, graphpattern_Matching_m_isEmpty, graphpattern_Matching_m_add}
...
graphpattern_Profile_m_getStereotype: Method = Method(name="getStereotype", parameters={Parameter(name='graphpattern_name', type=StringType)}, type=StringType)
graphpattern_Profile.attributes={graphpattern_Profile_name, graphpattern_Profile_id, graphpattern_Profile_description}
...
domain_model = DomainModel(
    name="graphpattern",
    types={graphpattern_GraphPattern, PatternElement, graphpattern_NodePattern, graphpattern_Pattern, graphpattern_DependencyGraph, graphpattern_SubGraph, GraphElement, graphpattern_EdgePattern, graphpattern_EClass, graphpattern_AttributePattern, graphpattern_Matching, graphpattern_Association, graphpattern_EPackage, graphpattern_EReference, graphpattern_EAttribute, graphpattern_EObject, graphpattern_Bundle, Pattern, graphpattern_Profile, graphpattern_Parameter, graphpattern_Assignment, graphpattern_PatternElement, Extendable, graphpattern_EObjectList, graphpattern_DependencyNode, graphpattern_DependencyEdge, graphpattern_GraphElement, graphpattern_Stereotype, graphpattern_ParameterBinding, graphpattern_ObjectBinding, ParameterBinding, graphpattern_ValueBinding, graphpattern_Resource, graphpattern_Extendable},
    associations={source16, nodes0, pattern1, dependencyGraph2, subgraphs3, outgoings5, type6, attributes8, matching9, incomings11, associations13, target15, domains29, opposite19, type20, type22, node23, matches25, node26, profiles28, graphs31, parameters32, assignments34, bundle36, patterns39, pattern41, content43, independent45, graph46, nodes48, edges51, outgoings53, incomings55, nodes58, source61, target63, source66, target68, profile69, parameter70, assignment71, pattern73, value75, elements77, subgraphs79, subgraphs81, graph82, stereotypes85, contents86, stereotypes88},
    generalizations={gen_graphpattern_GraphPattern_PatternElement, gen_graphpattern_NodePattern_GraphElement, gen_graphpattern_EdgePattern_GraphElement, gen_graphpattern_AttributePattern_GraphElement, gen_graphpattern_Bundle_Pattern, gen_graphpattern_Pattern_PatternElement, gen_graphpattern_PatternElement_Extendable, gen_graphpattern_Parameter_PatternElement, gen_graphpattern_GraphElement_PatternElement, gen_graphpattern_Association_PatternElement, gen_graphpattern_ObjectBinding_ParameterBinding, gen_graphpattern_ValueBinding_ParameterBinding, gen_graphpattern_SubGraph_PatternElement},
    metadata=None
)
