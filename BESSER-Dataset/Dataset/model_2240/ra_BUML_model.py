...
# Classes
model_CourseInstance = Class(name="model_CourseInstance")
model_Department = Class(name="model_Department")
model_Person = Class(name="model_Person")
model_Course = Class(name="model_Course")
model_Role = Class(name="model_Role")
model_Semester = Class(name="model_Semester")
model_CourseAllocation = Class(name="model_CourseAllocation")
...
model_Person.attributes={model_Person_faceUrl, model_Person_employmentFactor, model_Person_name, model_Person_email, model_Person_userName}
...
model_Course.attributes={model_Course_name, model_Course_fullName}
...
model_CourseAllocation.attributes={model_CourseAllocation_factor, model_CourseAllocation_explicitFactor}
...
domain_model = DomainModel(
    name="model",
    types={model_CourseInstance, model_Department, model_Person, model_Course, model_Role, model_Semester, model_CourseAllocation, SemesterKind},
    associations={courses11, employees0, courses1, roles3, semesters5, allocations7, requiredRoles8, course12, semester14, allocations15, person17, role18, course20},
    generalizations={},
    metadata=None
)
