...
class model_Semester:
    ...
    def __init__(self, year: str, kind: str, semester: set["model_CourseInstance"] = None, model_Semester: "model_Department" = None, Semester: "model_CourseInstance" = None):
        self.year = year
        self.kind = kind
