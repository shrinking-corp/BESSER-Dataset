...
def test_hyp_simpleclass_class_tipo_setter(instance):
...
def test_assoc_attrs1_link_reassign_clear():
    a = SimpleClass_Class(is_persistent="sample_text", tipo="sample_text")
    b1 = Attribute()
    b2 = Attribute()
...
SimpleClass_Class_strategy = st.builds(SimpleClass_Class, is_persistent=safe_text, tipo=safe_text)
@given(instance=SimpleClass_Class_strategy)
@settings(max_examples=25)
