...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={SimpleClass_Classifier, SimpleClass_Attribute, SimpleClass_Class, Classifier, Class_, Attribute, SimpleClass_PrimitiveDataType, SimpleClass_Association, EA, Vocabulary, Entity},
