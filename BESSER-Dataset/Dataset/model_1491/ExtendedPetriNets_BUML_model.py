...
# Classes
extendedPetriNets_PetriNet = Class(name="extendedPetriNets_PetriNet")
extendedPetriNets_Transition = Class(name="extendedPetriNets_Transition")
extendedPetriNets_InputArc = Class(name="extendedPetriNets_InputArc")
extendedPetriNets_OutputArc = Class(name="extendedPetriNets_OutputArc")
extendedPetriNets_Place = Class(name="extendedPetriNets_Place")
extendedPetriNets_InputPort = Class(name="extendedPetriNets_InputPort")
extendedPetriNets_OutputPort = Class(name="extendedPetriNets_OutputPort")
GenericPlace = Class(name="GenericPlace")
extendedPetriNets_GenericPlace = Class(name="extendedPetriNets_GenericPlace", is_abstract=True)
...
extendedPetriNets_GenericPlace.attributes={extendedPetriNets_GenericPlace_name, extendedPetriNets_GenericPlace_capacity, extendedPetriNets_GenericPlace_numberOfTokens}
...
domain_model = DomainModel(
    ...
    types={extendedPetriNets_PetriNet, extendedPetriNets_Transition, extendedPetriNets_InputArc, extendedPetriNets_OutputArc, extendedPetriNets_Place, extendedPetriNets_InputPort, extendedPetriNets_OutputPort, GenericPlace, extendedPetriNets_GenericPlace},
    associations={containsTransitions1, containsInputArcs3, containsOutputArcs5, InputArcToTransition7, InputArcFromPlace10, InputArcFromInputPort12, OutputArcFromTransition14, OutputArcToPlace17, OutputArcToOutputPort20, containsGenericPlaces0},
