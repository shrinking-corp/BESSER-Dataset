...
class Class_Class(Classifier):
    ...
    def __init__(self, isAbstract: bool, Class_Class: "Class_Class" = None, Class_Class2: set["Class_Class"] = None, owner: set["Class_Attribute"] = None, Class: "Class_Attribute" = None):
...
class Class_Attribute(NamedElt):
    ...
    def __init__(self, multiValued: bool, Attribute: "Class_Class" = None, Class_Attribute: "Class_Classifier" = None, att: "Class_Class" = None):
