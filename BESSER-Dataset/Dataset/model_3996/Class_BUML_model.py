...
# Classes
Class_Attribute = Class(name="Class_Attribute")
Class_NamedElt = Class(name="Class_NamedElt", is_abstract=True)
Class_Package = Class(name="Class_Package")
NamedElt = Class(name="NamedElt")
Class_Classifier = Class(name="Class_Classifier", is_abstract=True)
Class_DataType = Class(name="Class_DataType")
Classifier = Class(name="Classifier")
Class_Class = Class(name="Class_Class")
...
domain_model = DomainModel(
    name="Class",
    types={Class_Attribute, Class_NamedElt, Class_Package, NamedElt, Class_Classifier, Class_DataType, Classifier, Class_Class},
    associations={att4, type5, owner6, elems0, package1, supers3},
    generalizations={gen_Class_Attribute_NamedElt, gen_Class_Package_NamedElt, gen_Class_Classifier_NamedElt, gen_Class_DataType_Classifier, gen_Class_Class_Classifier},
    metadata=None
)
