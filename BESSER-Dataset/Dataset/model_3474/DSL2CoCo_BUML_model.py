...
myDsl_ParentChildConstraint = Class(name="myDsl_ParentChildConstraint")
myDsl_FeatureAttribute = Class(name="myDsl_FeatureAttribute")
myDsl_CrossTreeConstraint = Class(name="myDsl_CrossTreeConstraint")
myDsl_FM = Class(name="myDsl_FM")
myDsl_TreeConstraint = Class(name="myDsl_TreeConstraint")
myDsl_MandatoryTreeConstraint = Class(name="myDsl_MandatoryTreeConstraint")
TreeConstraint = Class(name="TreeConstraint")
myDsl_OptionalTreeConstraint = Class(name="myDsl_OptionalTreeConstraint")
myDsl_OrAlternativeTreeConstraint = Class(name="myDsl_OrAlternativeTreeConstraint")
...
myDsl_FeatureAttribute.attributes={myDsl_FeatureAttribute_maxValue, myDsl_FeatureAttribute_minValue, myDsl_FeatureAttribute_nullValue, myDsl_FeatureAttribute_attributeType, myDsl_FeatureAttribute_defaultValue}
...
domain_model = DomainModel(
    name="myDsl",
    types={myDsl_Feature, myDsl_ParentChildConstraint, myDsl_FeatureAttribute, myDsl_CrossTreeConstraint, myDsl_FM, myDsl_TreeConstraint, myDsl_MandatoryTreeConstraint, TreeConstraint, myDsl_OptionalTreeConstraint, myDsl_OrAlternativeTreeConstraint},
    ...
    generalizations={gen_myDsl_MandatoryTreeConstraint_TreeConstraint, gen_myDsl_OptionalTreeConstraint_TreeConstraint, gen_myDsl_OrAlternativeTreeConstraint_TreeConstraint},
    metadata=None
)
