...
# Classes
mission_NamedElement = Class(name="mission_NamedElement", is_abstract=True)
mission_Mission = Class(name="mission_Mission")
NamedElement = Class(name="NamedElement")
mission_Task = Class(name="mission_Task", is_abstract=True)
mission_TaskDependency = Class(name="mission_TaskDependency")
mission_Swarm = Class(name="mission_Swarm")
mission_Drone = Class(name="mission_Drone")
mission_Coordinate = Class(name="mission_Coordinate")
mission_ControlTask = Class(name="mission_ControlTask", is_abstract=True)
Task = Class(name="Task")
mission_Fork = Class(name="mission_Fork")
ControlTask = Class(name="ControlTask")
mission_Join = Class(name="mission_Join")
mission_PolygonTask = Class(name="mission_PolygonTask", is_abstract=True)
mission_PointTask = Class(name="mission_PointTask", is_abstract=True)
mission_LineTask = Class(name="mission_LineTask", is_abstract=True)
...
mission_Coordinate.attributes={mission_Coordinate_altitude, mission_Coordinate_longitude, mission_Coordinate_latitude}
...
from_11: BinaryAssociation = BinaryAssociation(
    name="from_11",
    ends={
...
domain_model = DomainModel(
    name="mission",
    types={mission_NamedElement, mission_Mission, NamedElement, mission_Task, mission_TaskDependency, mission_Swarm, mission_Drone, mission_Coordinate, mission_ControlTask, Task, mission_Fork, ControlTask, mission_Join, mission_PolygonTask, mission_PointTask, mission_LineTask},
    associations={tasks0, taskDependencies1, swarm3, drones5, home7, referencePosition9, from_11, to14, shell17, initialPosition19, point22, points24, initialPosition26},
    generalizations={gen_mission_Mission_NamedElement, gen_mission_Drone_NamedElement, gen_mission_Task_NamedElement, gen_mission_ControlTask_Task, gen_mission_Fork_ControlTask, gen_mission_Join_ControlTask, gen_mission_TaskDependency_NamedElement, gen_mission_PolygonTask_Task, gen_mission_PointTask_Task, gen_mission_LineTask_Task},
    metadata=None
)
