...
User.attributes={User_User_Password, User_User_Name, User_User_ID, User_User_Type}
...
System_order.attributes={System_order_Customer_ID, System_order_Time, System_order_Total, System_order_Order_ID, System_order_Delivery_Charges, System_order_Date, System_order_Payment_Option, System_order_Customer_Name}
...
Bank.attributes={Bank_Online_payment_ID_and_password, Bank_Account_type, Bank_Account_no}
...
Cash_on_delievery.attributes={Cash_on_delievery_Phone_number, Cash_on_delievery_Amount, Cash_on_delievery_Address, Cash_on_delievery_Customer_Name}
...
Food_Items.attributes={Food_Items_Items_Detail, Food_Items_Item_Name, Food_Items_Items_ID, Food_Items_Items_Price, Food_Items_item_photo, Food_Items_Items_Manage}
