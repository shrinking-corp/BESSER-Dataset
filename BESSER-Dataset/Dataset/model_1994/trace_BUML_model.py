...
trace_Trace_m_getRecordBySource: Method = Method(name="getRecordBySource", parameters={Parameter(name='trace_sourceObject', type=StringType), Parameter(name='trace_mapping', type=StringType)}, type=StringType)
trace_Trace_m_addRecordBySource: Method = Method(name="addRecordBySource", parameters={Parameter(name='trace_trace', type=StringType), Parameter(name='trace_sourceObject', type=StringType), Parameter(name='trace_mapping', type=StringType)})
...
trace_VarParameterValue.attributes={trace_VarParameterValue_kind, trace_VarParameterValue_name, trace_VarParameterValue_type}
...
domain_model = DomainModel(
    name="trace",
    types={trace_Trace, trace_EMappingParameters, trace_EMappingResults, trace_VarParameterValue, trace_EValue, MappingOperation, trace_EObject, trace_TraceRecord, trace_MappingOperationToTraceRecordMapEntry, trace_ObjectToTraceRecordMapEntry, trace_EMappingOperation, trace_EMappingContext, trace_ETuplePartValue, EValue, EDirectionKind},
    associations={context10, parameters12, result14, value16, value17, key20, runtimeMappingOperation22, traceRecords0, traceRecordMap1, sourceToTraceRecordMap3, targetToTraceRecordMap5, mappingOperation8, parameters38, result41, value44, modelElement25, intermediateElement27, collection31, value33, context35},
