...
class trace_EValue:
    ...
    def __init__(self, primitiveValue: str, oclObject: str, collectionType: str, trace_EValue: "trace_VarParameterValue" = None, trace_EValue26: "trace_EObject" = None, trace_EValue28: "trace_EObject" = None, trace_EValue32: "trace_EValue" = None, trace_EValue30: set["trace_EValue"] = None, trace_EValue34: "trace_ETuplePartValue" = None):
...
class trace_VarParameterValue:
    ...
    def __init__(self, kind: str, name: str, type: str, trace_VarParameterValue: "trace_EValue" = None, trace_VarParameterValue40: "trace_EMappingParameters" = None, trace_VarParameterValue43: "trace_EMappingResults" = None, trace_VarParameterValue37: "trace_EMappingContext" = None):
        self.kind = kind
        self.name = name
        self.type = type
...
class trace_Trace:
    ...
    def addRecordBySource(self, trace_sourceObject, trace_trace, trace_mapping):
