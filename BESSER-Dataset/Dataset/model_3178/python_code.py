...
class tym_MulOrDiv(Expression):
    ...
    def __init__(self, op: str, tym_MulOrDiv: "tym_Expression" = None, tym_MulOrDiv68: "tym_Expression" = None):
        self.op = op
...
class tym_Variable(AbstractElement):
    ...
    def __init__(self, vartype: str, name: str, tym_Variable: "tym_Variable" = None, tym_Variable73: "tym_VariableRef" = None, tym_Variable1: "tym_Variable" = None, tym_Variable4: "tym_EObject" = None, tym_Variable7: "tym_Function" = None):
...
class tym_Function:
    ...
    def __init__(self, return_: str, name: str, tym_Function: set["tym_Variable"] = None, tym_Function32: "tym_FunctionCall" = None, tym_Function9: "tym_FunctionBlock" = None):
