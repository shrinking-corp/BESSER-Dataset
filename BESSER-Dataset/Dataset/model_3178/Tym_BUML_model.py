...
# Classes
tym_Function = Class(name="tym_Function")
tym_FunctionBlock = Class(name="tym_FunctionBlock")
tym_Model = Class(name="tym_Model")
tym_EObject = Class(name="tym_EObject")
tym_AbstractElement = Class(name="tym_AbstractElement")
tym_Variable = Class(name="tym_Variable")
AbstractElement = Class(name="AbstractElement")
tym_Expression = Class(name="tym_Expression")
tym_Or = Class(name="tym_Or")
Expression = Class(name="Expression")
tym_And = Class(name="tym_And")
tym_PrintStatement = Class(name="tym_PrintStatement")
tym_TestStatement = Class(name="tym_TestStatement")
tym_Block = Class(name="tym_Block")
tym_LoopStatement = Class(name="tym_LoopStatement")
tym_Return = Class(name="tym_Return")
tym_FunctionCall = Class(name="tym_FunctionCall")
tym_Not = Class(name="tym_Not")
tym_Equality = Class(name="tym_Equality")
tym_Comparison = Class(name="tym_Comparison")
tym_Plus = Class(name="tym_Plus")
tym_Minus = Class(name="tym_Minus")
tym_MulOrDiv = Class(name="tym_MulOrDiv")
tym_IntConstant = Class(name="tym_IntConstant")
tym_StringConstant = Class(name="tym_StringConstant")
tym_BoolConstant = Class(name="tym_BoolConstant")
tym_VariableRef = Class(name="tym_VariableRef")

# tym_Function class attributes and methods
tym_Function_return_: Property = Property(name="return_", type=StringType)
tym_Function_name: Property = Property(name="name", type=StringType)
tym_Function.attributes={tym_Function_name, tym_Function_return_}
...
domain_model = DomainModel(
    name="tym",
    types={tym_Function, tym_FunctionBlock, tym_Model, tym_EObject, tym_AbstractElement, tym_Variable, AbstractElement, tym_Expression, tym_Or, Expression, tym_And, tym_PrintStatement, tym_TestStatement, tym_Block, tym_LoopStatement, tym_Return, tym_FunctionCall, tym_Not, tym_Equality, tym_Comparison, tym_Plus, tym_Minus, tym_MulOrDiv, tym_IntConstant, tym_StringConstant, tym_BoolConstant, tym_VariableRef},
    associations={variable2, expression3, params6, elements0, funcname31, params33, left35, right37, left40, body8, expression10, expression12, thenBlock14, elseBlock16, elements19, elements21, expression24, body26, expression29, left65, right67, right42, left45, right47, left50, right52, left55, right57, left60, right62, expression70, variable72},
    generalizations={gen_tym_Variable_AbstractElement, gen_tym_Or_Expression, gen_tym_And_Expression, gen_tym_PrintStatement_AbstractElement, gen_tym_TestStatement_AbstractElement, gen_tym_LoopStatement_AbstractElement, gen_tym_Return_AbstractElement, gen_tym_FunctionCall_AbstractElement, gen_tym_Not_Expression, gen_tym_Equality_Expression, gen_tym_Comparison_Expression, gen_tym_Plus_Expression, gen_tym_Minus_Expression, gen_tym_MulOrDiv_Expression, gen_tym_IntConstant_Expression, gen_tym_StringConstant_Expression, gen_tym_BoolConstant_Expression, gen_tym_VariableRef_Expression},
    metadata=None
)
