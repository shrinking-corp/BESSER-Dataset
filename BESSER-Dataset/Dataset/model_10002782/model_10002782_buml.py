...
User.attributes={User_DepartmentID, User_TitleID, User_Dateofbirth, User_Position, User_Active, User_Phone, User_Google_plus_link, User_Username, User_Firstname, User_Lastname, User_Password, User_Facebook_link, User_Hiredate, User_Email, User_UserID, User_Roles___, User_Settings, User_About, User_Linkedin_link}
...
Project.attributes={Project_PriorityID, Project_ProjectManager, Project_Comments___, Project_Title, Project_Activities___, Project_StatusID, Project_Created, Project_Attachments___, Project_Subscriptions___, Project_Description, Project_PorjectID, Project_Assignee, Project_Author, Project_Team___, Project_Deadline}
...
Activity.attributes={Activity_ActivityID, Activity_ActivitySubType, Activity_Seen, Activity_Project, Activity_ActivityType, Activity_PrevValue, Activity_NewValue, Activity_User}
...
Comment.attributes={Comment_Created, Comment_Project, Comment_User, Comment_Content, Comment_CommentID}
...
Attachment.attributes={Attachment_Size, Attachment_Extension, Attachment_Project, Attachment_Created, Attachment_Name, Attachment_User, Attachment_Path, Attachment_AttachmentID}
...
domain_model = DomainModel(
    name="d9ff006e_446e_4134_93e9_f0ce5921d27e",
