...
class HTML_BODY(HTMLElement):
    ...
    def __init__(self, background: str, bgcolor: str, text: str, link: str, alink: str, vlink: str, HTML_BODY: set["HTML_BODYElement"] = None, body: "HTML_HTML" = None, BODY: "HTML_HTML" = None):
        self.background = background
        self.bgcolor = bgcolor
        self.text = text
        self.link = link
