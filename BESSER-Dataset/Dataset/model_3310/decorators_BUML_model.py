...
# Classes
decorators_TestEdgeDecorator1 = Class(name="decorators_TestEdgeDecorator1")
EdgeDecorator = Class(name="EdgeDecorator")
decorators_TestGraphDecorator1 = Class(name="decorators_TestGraphDecorator1")
GraphDecorator = Class(name="GraphDecorator")
decorators_TestNodeDecorator1 = Class(name="decorators_TestNodeDecorator1")
NodeDecorator = Class(name="NodeDecorator")
decorators_TestScenarioGraphDecorator1 = Class(name="decorators_TestScenarioGraphDecorator1")
decorators_STEMTime = Class(name="decorators_STEMTime")
decorators_EdgeDecorator = Class(name="decorators_EdgeDecorator", is_abstract=True)
decorators_GraphDecorator = Class(name="decorators_GraphDecorator", is_abstract=True)
decorators_NodeDecorator = Class(name="decorators_NodeDecorator", is_abstract=True)
...
decorators_TestEdgeDecorator1.attributes={decorators_TestEdgeDecorator1_nodeBURI, decorators_TestEdgeDecorator1_edgeURI, decorators_TestEdgeDecorator1_nodeAURI}
...
decorators_TestScenarioGraphDecorator1.attributes={decorators_TestScenarioGraphDecorator1_booleanValue, decorators_TestScenarioGraphDecorator1_doubleValue, decorators_TestScenarioGraphDecorator1_stringValue, decorators_TestScenarioGraphDecorator1_intValue}
...
domain_model = DomainModel(
    name="decorators",
    types={decorators_TestEdgeDecorator1, EdgeDecorator, decorators_TestGraphDecorator1, GraphDecorator, decorators_TestNodeDecorator1, NodeDecorator, decorators_TestScenarioGraphDecorator1, decorators_STEMTime, decorators_EdgeDecorator, decorators_GraphDecorator, decorators_NodeDecorator},
    associations={sTEMTimeValue0},
    generalizations={gen_decorators_TestEdgeDecorator1_EdgeDecorator, gen_decorators_TestGraphDecorator1_GraphDecorator, gen_decorators_TestNodeDecorator1_NodeDecorator, gen_decorators_TestScenarioGraphDecorator1_GraphDecorator},
    metadata=None
)
