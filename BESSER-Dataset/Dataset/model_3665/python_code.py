...
class employee_Employee:
    ...
    def __init__(self, firstName: str, lastName: str, gender: str, salary: float, version: str, responsibilities: str, employee_Employee: "employee_Project" = None, Employee: "employee_PhoneNumber" = None, employee_Employee3: "employee_EmploymentPeriod" = None, employee_Employee5: "employee_Address" = None, employee_Employee7: "employee_JobTitle" = None, Employee10: "employee_Employee" = None, managedEmployees: "employee_Employee" = None, Employee13: "employee_Employee" = None, manager: set["employee_Employee"] = None, owner: set["employee_PhoneNumber"] = None, employee_Employee16: set["employee_Degree"] = None, employee_Employee18: set["employee_Project"] = None, employee_Employee21: set["employee_EmailAddress"] = None):
