...
# Classes
grudi_Person = Class(name="grudi_Person")
grudi_PersonInfo = Class(name="grudi_PersonInfo")
grudi_Team = Class(name="grudi_Team")
grudi_TeamLine = Class(name="grudi_TeamLine")
...
grudi_Person.attributes={grudi_Person_id, grudi_Person_gender, grudi_Person_versionNumber, grudi_Person_address, grudi_Person_email, grudi_Person_username, grudi_Person_phoneNumber, grudi_Person_password, grudi_Person_name}
...
grudi_PersonInfo.attributes={grudi_PersonInfo_phoneNumber, grudi_PersonInfo_userName, grudi_PersonInfo_id, grudi_PersonInfo_gender, grudi_PersonInfo_name}
...
grudi_Team.attributes={grudi_Team_name, grudi_Team_versionNumber, grudi_Team_id}
...
domain_model = DomainModel(
    ...
    associations={team1, person2, lines0},
    generalizations={},
    metadata=None
)
