...
class Company_Project:
    ...
    def __init__(self, name: str, budget: int, Project: "Company_Employee" = None, Project4: "Company_Department" = None, WorksOn_Project: set["Company_Employee"] = None, Controls_Project: "Company_Department" = None):
        self.name = name
        self.budget = budget
...
class Company_Department:
    ...
    def __init__(self, name: str, location: str, budget: int, Department: "Company_Employee" = None, WorksIn_Department: set["Company_Employee"] = None, Controls_Department: set["Company_Project"] = None, Department8: "Company_Project" = None):
        self.name = name
