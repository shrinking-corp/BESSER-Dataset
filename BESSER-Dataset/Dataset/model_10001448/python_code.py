...
class Event:
    ...
    def lineItems12(self, value):
        ...
        old_value = getattr(self, f"_Event__lineItems12", None)
        self.__lineItems12 = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "event13"):
                    opp_val = getattr(item, "event13", None)
                    
                    if opp_val == self:
                        setattr(item, "event13", None)
...
class LineItem:
    ...
    def __init__(self, quantity: int, price: float, sc11: "ShoppingCart" = None, event13: "Event" = None, order15: "Order" = None):
    ...
    @property
    def event13(self):
        return self.__event13
    @event13.setter
    def event13(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_LineItem__event13", None)
        self.__event13 = value
...
class Order:
    ...
    def __init__(self, number: int, ordered: date, total: float, status: OrderStatus, items14: set["LineItem"] = None, account17: "Account" = None, payment19: "Payment" = None):
        self.number = number
...
class ShoppingCart:
    ...
    def __init__(self, creationDate: date, webUser3: "WebUser" = None, account9: "Account" = None, items10: "LineItem" = None):
