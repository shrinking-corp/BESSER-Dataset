...
OrderStatus2: Enumeration = Enumeration(
    name="OrderStatus2",
    literals={
...
Order.attributes={Order_number, Order_ordered, Order_status, Order_total}
...
Event.attributes={Event_description, Event_name}
...
Product_LineItem: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="event13", type=Event, multiplicity=Multiplicity(1, 1))
    }
)
...
domain_model = DomainModel(
    name="_72TgQNKQEemr0Oy2Fixrzg",
    types={Customer, Payment, ShoppingCart, Account, WebUser, Order, LineItem, Event, UserState, OrderStatus, OrderStatus2},
