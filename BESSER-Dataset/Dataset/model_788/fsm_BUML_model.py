...
fsm_FSMException = Class(name="fsm_FSMException")
fsm_FSM = Class(name="fsm_FSM")
fsm_NonDeterminism = Class(name="fsm_NonDeterminism")
FSMException = Class(name="FSMException")
fsm_NoTransition = Class(name="fsm_NoTransition")
fsm_NoInitialStateException = Class(name="fsm_NoInitialStateException")

# fsm_State class attributes and methods
fsm_State_name: Property = Property(name="name", type=StringType)
fsm_State_m_step: Method = Method(name="step", parameters={Parameter(name='fsm_c', type=StringType)})
...
fsm_FSM.methods={fsm_FSM_m_run, fsm_FSM_m_reset}
...
domain_model = DomainModel(
    name="fsm",
    types={fsm_State, fsm_Transition, fsm_FSMException, fsm_FSM, fsm_NonDeterminism, FSMException, fsm_NoTransition, fsm_NoInitialStateException},
    associations={ownedState0, initialState1, currentState2, finalState5, transition8, fsmException10, owningFSM12, outgoingTransition13, target18, incomingTransition14, source16},
