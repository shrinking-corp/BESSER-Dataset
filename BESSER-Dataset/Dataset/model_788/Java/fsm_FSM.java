...
public class fsm_FSM  {
    ...
    private fsm_FSMException fsm_fsmexception;
    ...
    public fsm_FSM(
        ArrayList<fsm_Transition> fsm_transitions,        ArrayList<fsm_State> fsm_states,        ArrayList<fsm_State> fsm_states    ) {
    ...
    public fsm_FSMException getFsm_fsmexception() {
        return fsm_fsmexception;
    }

    public void setFsm_fsmexception(fsm_FSMException fsm_fsmexception) {
        this.fsm_fsmexception = fsm_fsmexception;
    }
