...
class fsm_Transition:
    ...
    def __init__(self, output: str, input: str, fsm_Transition: "fsm_FSM" = None, Transition: "fsm_State" = None, incomingTransition: "fsm_State" = None, Transition15: "fsm_State" = None, outgoingTransition: "fsm_State" = None):
        self.output = output
        self.input = input
...
class fsm_State:
    ...
    def __init__(self, name: str, State: "fsm_FSM" = None, fsm_State: "fsm_FSM" = None, fsm_State4: "fsm_FSM" = None, fsm_State7: "fsm_FSM" = None, ownedState: "fsm_FSM" = None, source: set["fsm_Transition"] = None, State19: "fsm_Transition" = None, target: set["fsm_Transition"] = None, State17: "fsm_Transition" = None):
        self.name = name
        self.State = State
