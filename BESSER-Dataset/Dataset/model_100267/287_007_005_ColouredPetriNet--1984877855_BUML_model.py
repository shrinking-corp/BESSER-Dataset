...
PetriNet_Type = Class(name="PetriNet_Type")
PetriNet_Token = Class(name="PetriNet_Token")
PetriNet_PrimitiveAttribute = Class(name="PetriNet_PrimitiveAttribute")
PetriNet_PlaceToTransArc = Class(name="PetriNet_PlaceToTransArc")
Arc = Class(name="Arc")
PetriNet_TransToPlaceArc = Class(name="PetriNet_TransToPlaceArc")
PetriNet_IdentifiableElement = Class(name="PetriNet_IdentifiableElement", is_abstract=True)
...
PetriNet_PrimitiveAttribute.attributes={PetriNet_PrimitiveAttribute_primType, PetriNet_PrimitiveAttribute_name}
...
PetriNet_IdentifiableElement.attributes={PetriNet_IdentifiableElement_author, PetriNet_IdentifiableElement_name}
...
domain_model = DomainModel(
    name="PetriNet",
    types={PetriNet_PetriNet, IdentifiableElement, PetriNet_Place, PetriNet_Transition, PetriNet_Arc, PetriNet_Type, PetriNet_Token, PetriNet_PrimitiveAttribute, PetriNet_PlaceToTransArc, Arc, PetriNet_TransToPlaceArc, PetriNet_IdentifiableElement},
    associations={places0, types5, transitions1, arcs3, components7, tokens9, type11, source14, target16, source19, target21},
    generalizations={gen_PetriNet_PetriNet_IdentifiableElement, gen_PetriNet_Place_IdentifiableElement, gen_PetriNet_PlaceToTransArc_Arc, gen_PetriNet_Transition_IdentifiableElement, gen_PetriNet_TransToPlaceArc_Arc},
    metadata=None
)
