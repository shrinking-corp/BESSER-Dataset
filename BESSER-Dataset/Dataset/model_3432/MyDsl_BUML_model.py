...
# Classes
myDsl_SchoolModel = Class(name="myDsl_SchoolModel")
myDsl_School = Class(name="myDsl_School")
myDsl_Person = Class(name="myDsl_Person")
myDsl_Student = Class(name="myDsl_Student")
Person = Class(name="Person")
myDsl_Teacher = Class(name="myDsl_Teacher")
...
domain_model = DomainModel(
    name="myDsl",
    types={myDsl_SchoolModel, myDsl_School, myDsl_Person, myDsl_Student, Person, myDsl_Teacher},
