...
class Element:
    ...
    pass
class uml_PackageableElement(NamedElement, Element):
...
class uml_Package(NamedElement, Element, PackageableElement):
    ...
    pass
class uml_Classifier(NamedElement, Element, Type):

    pass
class uml_Property(TypedElement, Element, Feature, NamedElement):
...
class uml_Operation(NamedElement, Element, Feature):
