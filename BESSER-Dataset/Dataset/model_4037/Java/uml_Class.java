...
public class uml_Class extends Classifier {
    ...
    public uml_Class(
        String isLeaf,        String isAbstract    ) {
        super(
        );
        this.isLeaf = isLeaf;
    ...
    public uml_Class(
        String isLeaf,        String isAbstract        ArrayList<uml_Operation> uml_operations,        ArrayList<uml_Classifier> uml_classifiers,        ArrayList<uml_Property> uml_propertys,        ArrayList<uml_Classifier> uml_classifiers    ) {
        this.isLeaf = isLeaf;
        this.isAbstract = isAbstract;
