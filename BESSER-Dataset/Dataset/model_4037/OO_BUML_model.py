...
uml_Class.attributes={uml_Class_isLeaf, uml_Class_isAbstract}
...
domain_model = DomainModel(
    name="uml",
    types={uml_Operation, Element, Feature, NamedElement, uml_Parameter, uml_Behavior, uml_Property, TypedElement, uml_Model, Package, uml_NamedElement, uml_Feature, uml_PackageableElement, uml_Class, Classifier, uml_Classifier, uml_Package, PackageableElement, Type, uml_TypedElement, uml_Type, uml_Element, Class_, uml_Dependency, VisibilityKind},
