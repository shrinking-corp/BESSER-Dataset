...
fair_Division.attributes={fair_Division_comments, fair_Division_description, fair_Division_name}
...
fair_Person.attributes={fair_Person_firstName, fair_Person_email, fair_Person_exhibitorNumber, fair_Person_zipCode, fair_Person_pin, fair_Person_city, fair_Person_state, fair_Person_lastName, fair_Person_phone, fair_Person_comments, fair_Person_salesOrder, fair_Person_street, fair_Person_name}
...
fair_Exhibit.attributes={fair_Exhibit_salesOrder, fair_Exhibit_number, fair_Exhibit_comments, fair_Exhibit_inAuction, fair_Exhibit_name, fair_Exhibit_award}
...
fair_Lot.attributes={fair_Lot_description, fair_Lot_comments, fair_Lot_name}
...
domain_model = DomainModel(
    name="fair",
    types={fair_Division, fair_Premises, fair_Person, fair_Exhibit, fair_Animal, fair_Fair, fair_YouthClub, fair_Lot, fair_Department, fair_Class, fair_YoungPerson, Person, Award},
    associations={divisions1, premises3, people5, animal7, exhibitor8, youthClubs0, division19, lots20, judges22, department24, lot11, contacts12, departments15, classes16, superintendents17, club31, exhibits26, class_27, parents29},
