...
# Classes
krendering_KPosition = Class(name="krendering_KPosition")
krendering_KPlacementData = Class(name="krendering_KPlacementData", is_abstract=True)
krendering_KAction = Class(name="krendering_KAction")
krendering_KEllipse = Class(name="krendering_KEllipse")
KContainerRendering = Class(name="KContainerRendering")
krendering_KRectangle = Class(name="krendering_KRectangle")
krendering_KRoundedRectangle = Class(name="krendering_KRoundedRectangle")
krendering_KPolyline = Class(name="krendering_KPolyline")
krendering_KRendering = Class(name="krendering_KRendering", is_abstract=True)
KGraphData = Class(name="KGraphData")
KStyleHolder = Class(name="KStyleHolder")
krendering_KContainerRendering = Class(name="krendering_KContainerRendering", is_abstract=True)
krendering_KDecoratorPlacementData = Class(name="krendering_KDecoratorPlacementData")
KPlacementData = Class(name="KPlacementData")
KRendering = Class(name="KRendering")
krendering_KPolygon = Class(name="krendering_KPolygon")
KPolyline = Class(name="KPolyline")
krendering_KImage = Class(name="krendering_KImage")
krendering_KStyle = Class(name="krendering_KStyle", is_abstract=True)
EMapPropertyHolder = Class(name="EMapPropertyHolder")
krendering_KRenderingLibrary = Class(name="krendering_KRenderingLibrary")
krendering_KStyleHolder = Class(name="krendering_KStyleHolder")
krendering_KRenderingRef = Class(name="krendering_KRenderingRef")
krendering_KChildArea = Class(name="krendering_KChildArea")
krendering_KText = Class(name="krendering_KText")
krendering_KPlacement = Class(name="krendering_KPlacement", is_abstract=True)
krendering_KArc = Class(name="krendering_KArc")
KPlacement = Class(name="KPlacement")
krendering_KGridPlacementData = Class(name="krendering_KGridPlacementData")
KAreaPlacementData = Class(name="KAreaPlacementData")
krendering_KAreaPlacementData = Class(name="krendering_KAreaPlacementData")
krendering_KGridPlacement = Class(name="krendering_KGridPlacement")
krendering_KLineWidth = Class(name="krendering_KLineWidth")
KStyle = Class(name="KStyle")
krendering_KCustomRendering = Class(name="krendering_KCustomRendering")
krendering_KColor = Class(name="krendering_KColor")
krendering_KLineStyle = Class(name="krendering_KLineStyle")
krendering_KVerticalAlignment = Class(name="krendering_KVerticalAlignment")
krendering_KHorizontalAlignment = Class(name="krendering_KHorizontalAlignment")
krendering_KXPosition = Class(name="krendering_KXPosition", is_abstract=True)
krendering_KLeftPosition = Class(name="krendering_KLeftPosition")
krendering_KRightPosition = Class(name="krendering_KRightPosition")
krendering_KTopPosition = Class(name="krendering_KTopPosition")
krendering_KBottomPosition = Class(name="krendering_KBottomPosition")
krendering_KYPosition = Class(name="krendering_KYPosition", is_abstract=True)
krendering_KForeground = Class(name="krendering_KForeground")
krendering_KColoring = Class(name="krendering_KColoring", is_abstract=True)
krendering_KSpline = Class(name="krendering_KSpline")
krendering_KFontBold = Class(name="krendering_KFontBold")
krendering_KFontItalic = Class(name="krendering_KFontItalic")
krendering_KFontName = Class(name="krendering_KFontName")
krendering_KFontSize = Class(name="krendering_KFontSize")
krendering_KRoundedBendsPolyline = Class(name="krendering_KRoundedBendsPolyline")
krendering_KRotation = Class(name="krendering_KRotation")
krendering_KBackground = Class(name="krendering_KBackground")
krendering_KPointPlacementData = Class(name="krendering_KPointPlacementData")
krendering_KLineCap = Class(name="krendering_KLineCap")
krendering_KInvisibility = Class(name="krendering_KInvisibility")
krendering_KShadow = Class(name="krendering_KShadow")
krendering_KTextUnderline = Class(name="krendering_KTextUnderline")
krendering_KTextStrikeout = Class(name="krendering_KTextStrikeout")
krendering_KLineJoin = Class(name="krendering_KLineJoin")
krendering_KStyleRef = Class(name="krendering_KStyleRef")

# krendering_KPosition class attributes and methods
krendering_KPosition_m_equals: Method = Method(name="equals", parameters={Parameter(name='krendering_other', type=StringType)}, type=BooleanType)
krendering_KPosition_m_setPositions: Method = Method(name="setPositions", parameters={Parameter(name='krendering_x', type=StringType), Parameter(name='krendering_y', type=StringType)}, type=StringType)
...
krendering_KAction.attributes={krendering_KAction_altPressed, krendering_KAction_ctrlCmdPressed, krendering_KAction_trigger, krendering_KAction_actionId, krendering_KAction_shiftPressed}
...
krendering_KRoundedRectangle.attributes={krendering_KRoundedRectangle_cornerHeight, krendering_KRoundedRectangle_cornerWidth}
...
krendering_KDecoratorPlacementData.attributes={krendering_KDecoratorPlacementData_yOffset, krendering_KDecoratorPlacementData_relative, krendering_KDecoratorPlacementData_width, krendering_KDecoratorPlacementData_height, krendering_KDecoratorPlacementData_rotateWithLine, krendering_KDecoratorPlacementData_absolute, krendering_KDecoratorPlacementData_xOffset}
...
krendering_KText.attributes={krendering_KText_editable, krendering_KText_text, krendering_KText_cursorSelectable}
...
krendering_KArc.attributes={krendering_KArc_startAngle, krendering_KArc_arcAngle, krendering_KArc_arcType}
...
krendering_KCustomRendering.attributes={krendering_KCustomRendering_figureObject, krendering_KCustomRendering_className, krendering_KCustomRendering_bundleName}
...
krendering_KColor_m_setColor: Method = Method(name="setColor", parameters={Parameter(name='krendering_blue', type=StringType), Parameter(name='krendering_red', type=StringType), Parameter(name='krendering_green', type=StringType)}, type=StringType)
krendering_KColor_m_setColor: Method = Method(name="setColor", parameters={Parameter(name='krendering_color', type=StringType)}, type=StringType)
krendering_KColor_m_setColor: Method = Method(name="setColor", parameters={Parameter(name='krendering_kColor', type=StringType)}, type=StringType)
krendering_KColor_m_equals: Method = Method(name="equals", parameters={Parameter(name='krendering_other', type=StringType)}, type=BooleanType)
krendering_KColor.attributes={krendering_KColor_red, krendering_KColor_green, krendering_KColor_blue}
krendering_KColor.methods={krendering_KColor_m_equals, krendering_KColor_m_setColor, krendering_KColor_m_setColor, krendering_KColor_m_setColor}
...
krendering_KLineStyle.attributes={krendering_KLineStyle_lineStyle, krendering_KLineStyle_dashOffset, krendering_KLineStyle_dashPattern}
...
krendering_KXPosition_m_equals: Method = Method(name="equals", parameters={Parameter(name='krendering_other', type=StringType)}, type=BooleanType)
krendering_KXPosition_m_setPosition: Method = Method(name="setPosition", parameters={Parameter(name='krendering_relative', type=StringType), Parameter(name='krendering_absolute', type=StringType)})
...
krendering_KYPosition_m_equals: Method = Method(name="equals", parameters={Parameter(name='krendering_other', type=StringType)}, type=BooleanType)
krendering_KYPosition_m_setPosition: Method = Method(name="setPosition", parameters={Parameter(name='krendering_absolute', type=StringType), Parameter(name='krendering_relative', type=StringType)})
krendering_KYPosition.attributes={krendering_KYPosition_relative, krendering_KYPosition_absolute}
...
krendering_KColoring_m_setColor: Method = Method(name="setColor", parameters={Parameter(name='krendering_green', type=StringType), Parameter(name='krendering_blue', type=StringType), Parameter(name='krendering_red', type=StringType)})
krendering_KColoring_m_setColor: Method = Method(name="setColor", parameters={Parameter(name='krendering_color', type=StringType)})
krendering_KColoring_m_setColor: Method = Method(name="setColor", parameters={Parameter(name='krendering_blue', type=StringType), Parameter(name='krendering_alpha', type=StringType), Parameter(name='krendering_red', type=StringType), Parameter(name='krendering_green', type=StringType)})
krendering_KColoring_m_setColor2: Method = Method(name="setColor2", parameters={Parameter(name='krendering_alpha', type=StringType), Parameter(name='krendering_color', type=StringType)})
krendering_KColoring_m_setColorCopyOf: Method = Method(name="setColorCopyOf", parameters={Parameter(name='krendering_kColor', type=StringType)})
krendering_KColoring_m_setColorCopyOf: Method = Method(name="setColorCopyOf", parameters={Parameter(name='krendering_kColor', type=StringType), Parameter(name='krendering_alpha', type=StringType)})
krendering_KColoring_m_setColorCopiedFrom: Method = Method(name="setColorCopiedFrom", parameters={Parameter(name='krendering_coloring', type=StringType)})
krendering_KColoring_m_setColorAndAlphaCopiedFrom: Method = Method(name="setColorAndAlphaCopiedFrom", parameters={Parameter(name='krendering_coloring', type=StringType)})
krendering_KColoring_m_setColor: Method = Method(name="setColor", parameters={Parameter(name='krendering_alpha', type=StringType), Parameter(name='krendering_color', type=StringType)})
krendering_KColoring_m_setColor2: Method = Method(name="setColor2", parameters={Parameter(name='krendering_color', type=StringType)})
krendering_KColoring_m_setTargetColor: Method = Method(name="setTargetColor", parameters={Parameter(name='krendering_color', type=StringType)})
krendering_KColoring_m_setTargetColor: Method = Method(name="setTargetColor", parameters={Parameter(name='krendering_red', type=StringType), Parameter(name='krendering_alpha', type=StringType), Parameter(name='krendering_blue', type=StringType), Parameter(name='krendering_green', type=StringType)})
krendering_KColoring_m_setTargetColor: Method = Method(name="setTargetColor", parameters={Parameter(name='krendering_alpha', type=StringType), Parameter(name='krendering_color', type=StringType)})
krendering_KColoring_m_setTargetColor2: Method = Method(name="setTargetColor2", parameters={Parameter(name='krendering_targetColor', type=StringType)})
krendering_KColoring_m_setTargetColor2: Method = Method(name="setTargetColor2", parameters={Parameter(name='krendering_targetColor', type=StringType), Parameter(name='krendering_targetAlpha', type=StringType)})
krendering_KColoring_m_setTargetColor: Method = Method(name="setTargetColor", parameters={Parameter(name='krendering_blue', type=StringType), Parameter(name='krendering_red', type=StringType), Parameter(name='krendering_green', type=StringType)})
krendering_KColoring_m_setTargetColorCopiedFrom: Method = Method(name="setTargetColorCopiedFrom", parameters={Parameter(name='krendering_coloring', type=StringType)})
krendering_KColoring_m_setTargetColorAndAlphaCopiedFrom: Method = Method(name="setTargetColorAndAlphaCopiedFrom", parameters={Parameter(name='krendering_coloring', type=StringType)})
krendering_KColoring_m_setGradientAngle2: Method = Method(name="setGradientAngle2", parameters={Parameter(name='krendering_angle', type=StringType)})
krendering_KColoring_m_setColors: Method = Method(name="setColors", parameters={Parameter(name='krendering_targetColor', type=StringType), Parameter(name='krendering_color', type=StringType)})
krendering_KColoring_m_setColors: Method = Method(name="setColors", parameters={Parameter(name='krendering_targetColor', type=StringType), Parameter(name='krendering_angle', type=StringType), Parameter(name='krendering_color', type=StringType)})
krendering_KColoring_m_setTargetColorCopyOf: Method = Method(name="setTargetColorCopyOf", parameters={Parameter(name='krendering_targetColor', type=StringType)})
krendering_KColoring_m_setTargetColorCopyOf: Method = Method(name="setTargetColorCopyOf", parameters={Parameter(name='krendering_targetColor', type=StringType), Parameter(name='krendering_targetAlpha', type=StringType)})
krendering_KColoring_m_setColors: Method = Method(name="setColors", parameters={Parameter(name='krendering_targetColor', type=StringType), Parameter(name='krendering_color', type=StringType), Parameter(name='krendering_targetAlpha', type=StringType), Parameter(name='krendering_angle', type=StringType), Parameter(name='krendering_alpha', type=StringType)})
krendering_KColoring_m_setColors: Method = Method(name="setColors", parameters={Parameter(name='krendering_targetColor', type=StringType), Parameter(name='krendering_color', type=StringType)})
krendering_KColoring_m_setColors: Method = Method(name="setColors", parameters={Parameter(name='krendering_angle', type=StringType), Parameter(name='krendering_color', type=StringType), Parameter(name='krendering_targetColor', type=StringType)})
krendering_KColoring_m_setColors: Method = Method(name="setColors", parameters={Parameter(name='krendering_alpha', type=StringType), Parameter(name='krendering_targetAlpha', type=StringType), Parameter(name='krendering_targetColor', type=StringType), Parameter(name='krendering_color', type=StringType)})
krendering_KColoring_m_setColors: Method = Method(name="setColors", parameters={Parameter(name='krendering_color', type=StringType), Parameter(name='krendering_alpha', type=StringType), Parameter(name='krendering_targetColor', type=StringType), Parameter(name='krendering_targetAlpha', type=StringType)})
krendering_KColoring_m_setColors: Method = Method(name="setColors", parameters={Parameter(name='krendering_targetAlpha', type=StringType), Parameter(name='krendering_alpha', type=StringType), Parameter(name='krendering_color', type=StringType), Parameter(name='krendering_targetColor', type=StringType), Parameter(name='krendering_angle', type=StringType)})
krendering_KColoring_m_setColorsCopiesOf: Method = Method(name="setColorsCopiesOf", parameters={Parameter(name='krendering_targetColor', type=StringType), Parameter(name='krendering_color', type=StringType)})
krendering_KColoring_m_setColorsCopiesOf: Method = Method(name="setColorsCopiesOf", parameters={Parameter(name='krendering_color', type=StringType), Parameter(name='krendering_targetColor', type=StringType), Parameter(name='krendering_angle', type=StringType)})
krendering_KColoring_m_setColorsCopiesOf: Method = Method(name="setColorsCopiesOf", parameters={Parameter(name='krendering_targetAlpha', type=StringType), Parameter(name='krendering_color', type=StringType), Parameter(name='krendering_alpha', type=StringType), Parameter(name='krendering_targetColor', type=StringType)})
krendering_KColoring_m_setColorsCopiedFrom: Method = Method(name="setColorsCopiedFrom", parameters={Parameter(name='krendering_coloring', type=StringType)})
krendering_KColoring_m_setColorsAlphasGradientAngleCopiedFrom: Method = Method(name="setColorsAlphasGradientAngleCopiedFrom", parameters={Parameter(name='krendering_coloring', type=StringType)})
krendering_KColoring_m_equals: Method = Method(name="equals", parameters={Parameter(name='krendering_other', type=StringType)}, type=BooleanType)
krendering_KColoring_m_setColorsCopiesOf: Method = Method(name="setColorsCopiesOf", parameters={Parameter(name='krendering_targetAlpha', type=StringType), Parameter(name='krendering_angle', type=StringType), Parameter(name='krendering_alpha', type=StringType), Parameter(name='krendering_targetColor', type=StringType), Parameter(name='krendering_color', type=StringType)})
krendering_KColoring.attributes={krendering_KColoring_alpha, krendering_KColoring_gradientAngle, krendering_KColoring_targetAlpha}
krendering_KColoring.methods={krendering_KColoring_m_setColors, krendering_KColoring_m_setTargetColor2, krendering_KColoring_m_setColor, krendering_KColoring_m_setColors, krendering_KColoring_m_setColorsCopiesOf, krendering_KColoring_m_setColors, krendering_KColoring_m_setColors, krendering_KColoring_m_setColor2, krendering_KColoring_m_setColor, krendering_KColoring_m_setTargetColor, krendering_KColoring_m_setColor, krendering_KColoring_m_setColors, krendering_KColoring_m_setColorCopyOf, krendering_KColoring_m_setColors, krendering_KColoring_m_setColors, krendering_KColoring_m_setTargetColor, krendering_KColoring_m_setColors, krendering_KColoring_m_setTargetColorCopiedFrom, krendering_KColoring_m_setTargetColorCopyOf, krendering_KColoring_m_setColorsAlphasGradientAngleCopiedFrom, krendering_KColoring_m_setColor, krendering_KColoring_m_setColorsCopiesOf, krendering_KColoring_m_setColor2, krendering_KColoring_m_setTargetColor, krendering_KColoring_m_setTargetColor2, krendering_KColoring_m_setColorCopyOf, krendering_KColoring_m_equals, krendering_KColoring_m_setColorsCopiesOf, krendering_KColoring_m_setGradientAngle2, krendering_KColoring_m_setColorsCopiesOf, krendering_KColoring_m_setTargetColor, krendering_KColoring_m_setTargetColorAndAlphaCopiedFrom, krendering_KColoring_m_setTargetColorCopyOf, krendering_KColoring_m_setColorsCopiedFrom, krendering_KColoring_m_setColorAndAlphaCopiedFrom, krendering_KColoring_m_setColorCopiedFrom}
...
krendering_KPointPlacementData.attributes={krendering_KPointPlacementData_verticalMargin, krendering_KPointPlacementData_horizontalAlignment, krendering_KPointPlacementData_horizontalMargin, krendering_KPointPlacementData_minHeight, krendering_KPointPlacementData_minWidth, krendering_KPointPlacementData_verticalAlignment}
...
domain_model = DomainModel(
    name="krendering",
    types={krendering_KPosition, krendering_KPlacementData, krendering_KAction, krendering_KEllipse, KContainerRendering, krendering_KRectangle, krendering_KRoundedRectangle, krendering_KPolyline, krendering_KRendering, KGraphData, KStyleHolder, krendering_KContainerRendering, krendering_KDecoratorPlacementData, KPlacementData, KRendering, krendering_KPolygon, KPolyline, krendering_KImage, krendering_KStyle, EMapPropertyHolder, krendering_KRenderingLibrary, krendering_KStyleHolder, krendering_KRenderingRef, krendering_KChildArea, krendering_KText, krendering_KPlacement, krendering_KArc, KPlacement, krendering_KGridPlacementData, KAreaPlacementData, krendering_KAreaPlacementData, krendering_KGridPlacement, krendering_KLineWidth, KStyle, krendering_KCustomRendering, krendering_KColor, krendering_KLineStyle, krendering_KVerticalAlignment, krendering_KHorizontalAlignment, krendering_KXPosition, krendering_KLeftPosition, krendering_KRightPosition, krendering_KTopPosition, krendering_KBottomPosition, krendering_KYPosition, krendering_KForeground, krendering_KColoring, krendering_KSpline, krendering_KFontBold, krendering_KFontItalic, krendering_KFontName, krendering_KFontSize, krendering_KRoundedBendsPolyline, krendering_KRotation, krendering_KBackground, krendering_KPointPlacementData, krendering_KLineCap, krendering_KInvisibility, krendering_KShadow, krendering_KTextUnderline, krendering_KTextStrikeout, krendering_KLineJoin, krendering_KStyleRef, HorizontalAlignment, VerticalAlignment, LineStyle, Trigger, LineCap, Underline, LineJoin, Arc},
    associations={parent0, placementData1, actions2, points4, clipShape8, children10, junctionPointRendering5, renderings12, rendering13, childPlacement11, topLeft15, bottomRight17, topLeft20, bottomRight22, color25, targetColor26, rotationAnchor29, referencePoint31, styles33, color35, color37, styleHolder39, color41},
    generalizations={gen_krendering_KEllipse_KContainerRendering, gen_krendering_KRectangle_KContainerRendering, gen_krendering_KRoundedRectangle_KContainerRendering, gen_krendering_KPolyline_KContainerRendering, gen_krendering_KRendering_KGraphData, gen_krendering_KRendering_KStyleHolder, gen_krendering_KDecoratorPlacementData_KPlacementData, gen_krendering_KContainerRendering_KRendering, gen_krendering_KPolygon_KPolyline, gen_krendering_KImage_KContainerRendering, gen_krendering_KStyle_EMapPropertyHolder, gen_krendering_KRenderingLibrary_KGraphData, gen_krendering_KRenderingRef_KRendering, gen_krendering_KChildArea_KRendering, gen_krendering_KText_KRendering, gen_krendering_KArc_KContainerRendering, gen_krendering_KGridPlacement_KPlacement, gen_krendering_KGridPlacementData_KAreaPlacementData, gen_krendering_KAreaPlacementData_KPlacementData, gen_krendering_KLineWidth_KStyle, gen_krendering_KCustomRendering_KContainerRendering, gen_krendering_KLineStyle_KStyle, gen_krendering_KVerticalAlignment_KStyle, gen_krendering_KHorizontalAlignment_KStyle, gen_krendering_KColoring_KStyle, gen_krendering_KSpline_KPolyline, gen_krendering_KFontBold_KStyle, gen_krendering_KFontItalic_KStyle, gen_krendering_KFontName_KStyle, gen_krendering_KFontSize_KStyle, gen_krendering_KRoundedBendsPolyline_KPolyline, gen_krendering_KRotation_KStyle, gen_krendering_KPointPlacementData_KPlacementData, gen_krendering_KLineCap_KStyle, gen_krendering_KInvisibility_KStyle, gen_krendering_KShadow_KStyle, gen_krendering_KTextUnderline_KStyle, gen_krendering_KTextStrikeout_KStyle, gen_krendering_KLineJoin_KStyle, gen_krendering_KStyleRef_KStyle},
    metadata=None
)
