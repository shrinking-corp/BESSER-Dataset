...
class petriNet_Arc:
    ...
    def __init__(self, weight: int, kind: str, arcs: "petriNet_PetriNet" = None, Arc: "petriNet_PetriNet" = None, Arc5: "petriNet_Node" = None, Arc7: "petriNet_Node" = None, incomings: "petriNet_Node" = None, outgoings: "petriNet_Node" = None):
        self.weight = weight
        self.kind = kind
        self.arcs = arcs
        self.Arc = Arc
...
class petriNet_PetriNet:
    ...
    def __init__(self, name: str, PetriNet13: "petriNet_Arc" = None, net: set["petriNet_Node"] = None, net2: set["petriNet_Arc"] = None, PetriNet: "petriNet_Node" = None):
        self.name = name
