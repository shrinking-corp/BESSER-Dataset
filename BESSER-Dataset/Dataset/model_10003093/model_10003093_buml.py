...
Staff.attributes={Staff_staff_Id, Staff_jobType, Staff_contact, Staff_name}
...
Report.attributes={Report_orders, Report_totalSales, Report_profit}
...
Booking.attributes={Booking_reservedTables, Booking_date, Booking_name, Booking_type, Booking_booking_Id, Booking_contact}
...
Table.attributes={Table_numSeats, Table_table_Id, Table_occupied, Table_specialRequest, Table_order}
...
Food.attributes={Food_price, Food_served, Food_prepared, Food_name, Food_food_Id, Food_description, Food_type}
...
domain_model = DomainModel(
    name="fe1b83ee_adf6_4109_9cca_8f1890b5f61d",
    types={Manager, Waiter, Chef, Staff, RMS, Report, Booking, Table, Order, Food},
    associations={Order_Table, Table_Booking, RMS_Booking, Staff_RMS, Report_RMS, Order_Food},
    generalizations={},
    metadata=None
)
