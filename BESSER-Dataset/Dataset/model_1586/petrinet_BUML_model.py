...
domain_model = DomainModel(
    name="petrinet",
    types={petrinet_Token, petrinet_Petrinet, petrinet_Node, petrinet_Arc, petrinet_Transition, Node, petrinet_Place},
    associations={nodes0, arcs1, in_3, out4, source6, target7, tokens9},
