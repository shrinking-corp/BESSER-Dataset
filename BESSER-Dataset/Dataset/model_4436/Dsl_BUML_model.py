...
dsl_Task.attributes={dsl_Task_ignoreBehavior, dsl_Task_name, dsl_Task_action}
...
domain_model = DomainModel(
    name="dsl",
    types={dsl_Mission, dsl_Task, dsl_SensorType, dsl_Ignorables, dsl_ColorSensor, SensorType, dsl_TouchSensor, dsl_UltrasonicSensor, Actions, Directions, TouchSensorSides, Colors, CompareOperator},
