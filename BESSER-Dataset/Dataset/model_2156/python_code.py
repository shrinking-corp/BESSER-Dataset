...
class SkillGraph_Node:
    ...
    def __init__(self, category: str, name: str, programPath: str, SkillGraph_Node4: "SkillGraph_Graph" = None, node: set["SkillGraph_Equation"] = None, SkillGraph_Node8: set["SkillGraph_Edge"] = None, SkillGraph_Node11: "SkillGraph_Node" = None, SkillGraph_Node9: set["SkillGraph_Node"] = None, node13: set["SkillGraph_Requirement"] = None, Node: "SkillGraph_Requirement" = None, Node16: "SkillGraph_Equation" = None, SkillGraph_Node: "SkillGraph_Graph" = None, SkillGraph_Node19: "SkillGraph_Edge" = None, SkillGraph_Node22: "SkillGraph_Edge" = None):
...
class SkillGraph_Parameter:
    ...
    def __init__(self, name: str, abbreviation: str, unit: str, defaultValue: str, variable: bool, Parameter: "SkillGraph_Graph" = None, parameterList: "SkillGraph_Graph" = None):
        self.name = name
