...
# Classes
SkillGraph_Parameter = Class(name="SkillGraph_Parameter")
SkillGraph_Graph = Class(name="SkillGraph_Graph")
SkillGraph_Equation = Class(name="SkillGraph_Equation")
SkillGraph_Edge = Class(name="SkillGraph_Edge")
SkillGraph_Requirement = Class(name="SkillGraph_Requirement")
SkillGraph_Node = Class(name="SkillGraph_Node")
...
SkillGraph_Parameter.attributes={SkillGraph_Parameter_unit, SkillGraph_Parameter_defaultValue, SkillGraph_Parameter_variable, SkillGraph_Parameter_name, SkillGraph_Parameter_abbreviation}
...
SkillGraph_Requirement.attributes={SkillGraph_Requirement_type, SkillGraph_Requirement_comment, SkillGraph_Requirement_term}
...
SkillGraph_Node.attributes={SkillGraph_Node_category, SkillGraph_Node_programPath, SkillGraph_Node_name}
...
domain_model = DomainModel(
    name="SkillGraph",
    types={SkillGraph_Parameter, SkillGraph_Graph, SkillGraph_Equation, SkillGraph_Edge, SkillGraph_Requirement, SkillGraph_Node, Category, Type},
    associations={rootNode2, parameterList5, equations6, childEdges7, parentNodes10, requirements12, node14, node15, graph0, nodes1, parentNode17, childNode20},
    generalizations={},
    metadata=None
)
