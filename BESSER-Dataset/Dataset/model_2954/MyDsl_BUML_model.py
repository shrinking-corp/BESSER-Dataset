...
myDsl_JAVAID = Class(name="myDsl_JAVAID")
myDsl_Interface = Class(name="myDsl_Interface")
...
domain_model = DomainModel(
    name="myDsl",
    types={myDsl_Model, myDsl_Type, myDsl_TypeDef, Type, myDsl_JAVAID, myDsl_Interface, myDsl_Attribute},
    associations={types0, mappedType1, superInterface3, attributes4, type6},
    generalizations={gen_myDsl_TypeDef_Type, gen_myDsl_Interface_Type, gen_myDsl_Attribute_Type},
    metadata=None
)
