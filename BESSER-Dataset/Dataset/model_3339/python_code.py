...
class JavaSimplified_Method(Feature):
    ...
    def __init__(self, exceptions: str, JavaSimplified_Method48: set["JavaSimplified_Statement"] = None, JavaSimplified_Method51: "JavaSimplified_Type" = None, JavaSimplified_Method: "JavaSimplified_JavaClass" = None, JavaSimplified_Method46: set["JavaSimplified_Parameter"] = None):
...
class Statement:
    ...
    pass
class JavaSimplified_VariableDeclarationStatement(TypedElement, Statement, NamedElement):
...
class JavaSimplified_Assignment(Expression):
    ...
    def __init__(self, operator: str, JavaSimplified_Assignment2: "JavaSimplified_Expression" = None, JavaSimplified_Assignment: "JavaSimplified_Expression" = None):
        self.operator = operator
...
class JavaSimplified_Expression(StringElement):
    ...
    pass
class JavaSimplified_Feature(StringElement, CommentedElement, NamedElement):
