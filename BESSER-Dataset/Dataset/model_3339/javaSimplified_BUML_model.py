...
JavaSimplified_Name = Class(name="JavaSimplified_Name")
JavaSimplified_IfStatement = Class(name="JavaSimplified_IfStatement")
JavaSimplified_Statement = Class(name="JavaSimplified_Statement")
JavaSimplified_InfixExpression = Class(name="JavaSimplified_InfixExpression")
JavaSimplified_JavaClass = Class(name="JavaSimplified_JavaClass")
JavaSimplified_CommentedElement = Class(name="JavaSimplified_CommentedElement", is_abstract=True)
JavaSimplified_CommentStatement = Class(name="JavaSimplified_CommentStatement")
Statement = Class(name="Statement")
JavaSimplified_ExpressionStatement = Class(name="JavaSimplified_ExpressionStatement")
JavaSimplified_Feature = Class(name="JavaSimplified_Feature")
CommentedElement = Class(name="CommentedElement")
NamedElement = Class(name="NamedElement")
JavaSimplified_Field = Class(name="JavaSimplified_Field")
TypedElement = Class(name="TypedElement")
Feature = Class(name="Feature")
JavaSimplified_FieldAccess = Class(name="JavaSimplified_FieldAccess")
JavaSimplified_MethodCall = Class(name="JavaSimplified_MethodCall")
JavaSimplified_MethodInvocation = Class(name="JavaSimplified_MethodInvocation")
...
JavaSimplified_JavaModel = Class(name="JavaSimplified_JavaModel")
JavaSimplified_Literal = Class(name="JavaSimplified_Literal")
...
JavaSimplified_StringElement = Class(name="JavaSimplified_StringElement", is_abstract=True)
JavaSimplified_ThisExpression = Class(name="JavaSimplified_ThisExpression")
JavaSimplified_TypedElement = Class(name="JavaSimplified_TypedElement", is_abstract=True)
JavaSimplified_VariableDeclarationStatement = Class(name="JavaSimplified_VariableDeclarationStatement")
...
domain_model = DomainModel(
    name="JavaSimplified",
    types={JavaSimplified_CastExpression, JavaSimplified_Type, JavaSimplified_ClassInstanceCreation, JavaSimplified_Comment, StringElement, JavaSimplified_Assignment, Expression, JavaSimplified_Expression, JavaSimplified_Name, JavaSimplified_IfStatement, JavaSimplified_Statement, JavaSimplified_InfixExpression, JavaSimplified_JavaClass, JavaSimplified_CommentedElement, JavaSimplified_CommentStatement, Statement, JavaSimplified_ExpressionStatement, JavaSimplified_Feature, CommentedElement, NamedElement, JavaSimplified_Field, TypedElement, Feature, JavaSimplified_FieldAccess, JavaSimplified_MethodCall, JavaSimplified_MethodInvocation, JavaSimplified_NamedElement, JavaSimplified_Method, JavaSimplified_JavaModel, JavaSimplified_Literal, JavaSimplified_Parameter, JavaSimplified_ReturnStatement, JavaSimplified_StringElement, JavaSimplified_ThisExpression, JavaSimplified_TypedElement, JavaSimplified_VariableDeclarationStatement, AssignmentOperatorType, InfixOperatorType, LiteralType, VisibilityType},
    associations={expr21, expr4, type6, arguments8, className10, expr10, name22, expr24, ifst26, elsest28, expr131, expr233, comment13, comment14, expr16, expr18, expr20, statements47, returnType50, arguments53, childCall56, methodName58, object61, method63, name66, fields36, methods38, classes40, types42, parameters45, expr72, expr68, type70},
    generalizations={gen_JavaSimplified_CastExpression_Expression, gen_JavaSimplified_ClassInstanceCreation_Expression, gen_JavaSimplified_Comment_StringElement, gen_JavaSimplified_Assignment_Expression, gen_JavaSimplified_IfStatement_Statement, gen_JavaSimplified_InfixExpression_Expression, gen_JavaSimplified_JavaClass_CommentedElement, gen_JavaSimplified_JavaClass_NamedElement, gen_JavaSimplified_CommentStatement_Statement, gen_JavaSimplified_Expression_StringElement, gen_JavaSimplified_ExpressionStatement_Statement, gen_JavaSimplified_Feature_CommentedElement, gen_JavaSimplified_Feature_NamedElement, gen_JavaSimplified_Feature_StringElement, gen_JavaSimplified_Field_TypedElement, gen_JavaSimplified_Field_Feature, gen_JavaSimplified_FieldAccess_Expression, gen_JavaSimplified_MethodInvocation_Expression, gen_JavaSimplified_Name_Expression, gen_JavaSimplified_Literal_Expression, gen_JavaSimplified_Method_Feature, gen_JavaSimplified_Parameter_NamedElement, gen_JavaSimplified_Parameter_TypedElement, gen_JavaSimplified_ReturnStatement_Statement, gen_JavaSimplified_Statement_StringElement, gen_JavaSimplified_ThisExpression_Expression, gen_JavaSimplified_VariableDeclarationStatement_Statement, gen_JavaSimplified_VariableDeclarationStatement_TypedElement, gen_JavaSimplified_VariableDeclarationStatement_NamedElement},
    metadata=None
)
