...
class smach_SMACHTransition:
    ...
    def __init__(self, name: str, smach_SMACHTransition8: "smach_SMACHState" = None, smach_SMACHTransition11: "smach_SMACHState" = None, smach_SMACHTransition: "smach_SMACHStateMachine" = None):
        self.name = name
