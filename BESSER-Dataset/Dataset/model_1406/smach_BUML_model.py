...
# Classes
smach_SMACHStateMachine = Class(name="smach_SMACHStateMachine")
smach_ActionState = Class(name="smach_ActionState")
ActionClient = Class(name="ActionClient")
SMACHState = Class(name="SMACHState")
smach_ServiceState = Class(name="smach_ServiceState")
ServiceClient = Class(name="ServiceClient")
smach_InitStraightState = Class(name="smach_InitStraightState")
Node = Class(name="Node")
smach_SMACHState = Class(name="smach_SMACHState")
smach_SMACHTransition = Class(name="smach_SMACHTransition")
smach_FinalState = Class(name="smach_FinalState")
smach_InitActionState = Class(name="smach_InitActionState")
...
smach_SMACHState.attributes={smach_SMACHState_remap_overwrite, smach_SMACHState_goal_type, smach_SMACHState_goal}
...
domain_model = DomainModel(
    name="smach",
    types={smach_SMACHStateMachine, smach_ActionState, ActionClient, SMACHState, smach_ServiceState, ServiceClient, smach_InitStraightState, Node, smach_SMACHState, smach_SMACHTransition, smach_FinalState, smach_InitActionState, SMACHStateOutcomes, SMACHGoalTypes},
    associations={Source7, Target10, states0, transitions1, finalStates3, initialStates5},
    generalizations={gen_smach_ActionState_ActionClient, gen_smach_ActionState_SMACHState, gen_smach_ServiceState_ServiceClient, gen_smach_ServiceState_SMACHState, gen_smach_FinalState_SMACHState, gen_smach_InitStraightState_SMACHState, gen_smach_InitActionState_SMACHState, gen_smach_SMACHStateMachine_Node},
    metadata=None
)
