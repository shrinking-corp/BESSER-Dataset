...
class umlknes_Activity:
    ...
    def __init__(self, isReadOnly: bool, isSingleExecution: bool, Activity: "umlknes_ActivityNode" = None, Activity15: "umlknes_ActivityEdge" = None, activity: set["umlknes_ActivityNode"] = None, activity2: set["umlknes_ActivityEdge"] = None):
