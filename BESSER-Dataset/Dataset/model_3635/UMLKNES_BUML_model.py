...
# Classes
umlknes_Activity = Class(name="umlknes_Activity")
umlknes_ActivityNode = Class(name="umlknes_ActivityNode", is_abstract=True)
umlknes_ControlNode = Class(name="umlknes_ControlNode", is_abstract=True)
ActivityNode = Class(name="ActivityNode")
umlknes_ActivityFinalNode = Class(name="umlknes_ActivityFinalNode")
ControlNode = Class(name="ControlNode")
umlknes_InitialNode = Class(name="umlknes_InitialNode")
umlknes_ValueSpecification = Class(name="umlknes_ValueSpecification", is_abstract=True)
umlknes_ControlFlow = Class(name="umlknes_ControlFlow")
ActivityEdge = Class(name="ActivityEdge")
umlknes_DecisionNode = Class(name="umlknes_DecisionNode")
umlknes_Action = Class(name="umlknes_Action", is_abstract=True)
umlknes_AcceptEventAction = Class(name="umlknes_AcceptEventAction")
Action = Class(name="Action")
umlknes_Trigger = Class(name="umlknes_Trigger")
NamedElement = Class(name="NamedElement")
umlknes_ActivityEdge = Class(name="umlknes_ActivityEdge", is_abstract=True)
RedefinableElement = Class(name="RedefinableElement")
umlknes_Event = Class(name="umlknes_Event", is_abstract=True)
umlknes_ExecutionEvent = Class(name="umlknes_ExecutionEvent")
Event = Class(name="Event")
umlknes_CreationEvent = Class(name="umlknes_CreationEvent")
umlknes_DestructionEvent = Class(name="umlknes_DestructionEvent")
umlknes_OpaqueExpression = Class(name="umlknes_OpaqueExpression")
ValueSpecification = Class(name="ValueSpecification")
umlknes_RedefinableElement = Class(name="umlknes_RedefinableElement", is_abstract=True)
umlknes_NamedElement = Class(name="umlknes_NamedElement", is_abstract=True)
...
umlknes_Activity.attributes={umlknes_Activity_isSingleExecution, umlknes_Activity_isReadOnly}
...
domain_model = DomainModel(
    name="umlknes",
    types={umlknes_Activity, umlknes_ActivityNode, umlknes_ControlNode, ActivityNode, umlknes_ActivityFinalNode, ControlNode, umlknes_InitialNode, umlknes_ValueSpecification, umlknes_ControlFlow, ActivityEdge, umlknes_DecisionNode, umlknes_Action, umlknes_AcceptEventAction, Action, umlknes_Trigger, NamedElement, umlknes_ActivityEdge, RedefinableElement, umlknes_Event, umlknes_ExecutionEvent, Event, umlknes_CreationEvent, umlknes_DestructionEvent, umlknes_OpaqueExpression, ValueSpecification, umlknes_RedefinableElement, umlknes_NamedElement, VisibilityKind},
    associations={activity3, incoming4, outgoing6, redefinedElement9, target10, source12, activity14, weight16, guard17, trigger20, node0, edge1, event21},
    generalizations={gen_umlknes_ControlNode_ActivityNode, gen_umlknes_ActivityFinalNode_ControlNode, gen_umlknes_InitialNode_ControlNode, gen_umlknes_ActivityEdge_RedefinableElement, gen_umlknes_ControlFlow_ActivityEdge, gen_umlknes_DecisionNode_ControlNode, gen_umlknes_Action_ActivityNode, gen_umlknes_AcceptEventAction_Action, gen_umlknes_ValueSpecification_NamedElement, gen_umlknes_ActivityNode_RedefinableElement, gen_umlknes_ExecutionEvent_Event, gen_umlknes_CreationEvent_Event, gen_umlknes_DestructionEvent_Event, gen_umlknes_OpaqueExpression_ValueSpecification, gen_umlknes_RedefinableElement_NamedElement, gen_umlknes_Trigger_NamedElement},
    metadata=None
)
