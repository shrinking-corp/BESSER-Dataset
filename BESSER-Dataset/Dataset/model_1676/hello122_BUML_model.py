...
# Classes
hello122_Base = Class(name="hello122_Base")
hello122_Thing = Class(name="hello122_Thing")
hello122_Classoc = Class(name="hello122_Classoc")
hello122_Clazoc = Class(name="hello122_Clazoc")
hello122_Top = Class(name="hello122_Top")
NamedElement = Class(name="NamedElement")
hello122_Third = Class(name="hello122_Third")
hello122_RelatedTo = Class(name="hello122_RelatedTo")
hello122_NamedElement = Class(name="hello122_NamedElement", is_abstract=True)
hello122_Alias = Class(name="hello122_Alias")
hello122_Child = Class(name="hello122_Child")
...
domain_model = DomainModel(
    name="hello122",
    types={hello122_Base, hello122_Thing, hello122_Classoc, hello122_Clazoc, hello122_Top, NamedElement, hello122_Third, hello122_RelatedTo, hello122_NamedElement, hello122_Alias, hello122_Child},
    associations={things0, fromThing15, classocs1, clazocs3, tops5, foos7, classocs9, relations12, aliases14, toThing18, third21, base24, thing27, toThing30, fromThird33, childs36},
