...
class hello122_Thing(NamedElement):
    ...
    def __init__(self, id: int, hello122_Thing: "hello122_Base" = None, hello122_Thing17: "hello122_RelatedTo" = None, hello122_Thing8: set["hello122_Third"] = None, hello122_Thing10: set["hello122_Classoc"] = None, hello122_Thing13: set["hello122_RelatedTo"] = None, hello122_Thing20: "hello122_RelatedTo" = None, hello122_Thing29: "hello122_Classoc" = None, hello122_Thing32: "hello122_Clazoc" = None):
        self.id = id
...
class hello122_RelatedTo(NamedElement):
    ...
    def __init__(self, since: str, hello122_RelatedTo16: "hello122_Thing" = None, hello122_RelatedTo: "hello122_Thing" = None, hello122_RelatedTo19: "hello122_Thing" = None):
        self.since = since
