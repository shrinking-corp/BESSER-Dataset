...
@given(instance=Paper_Author_strategy)
def test_hyp_paper_author_name_setter(instance):
...
def test_Paper_Author_email_value_roundtrip():
    instance = Paper_Author(email="sample_text", name="sample_text")
    assert instance.email == "sample_text"
    instance.email = "sample_text_2"
    assert instance.email == "sample_text_2"


def test_Paper_Author_name_value_roundtrip():
    instance = Paper_Author(email="sample_text", name="sample_text")
...
def test_assoc_authors1_link_reassign_clear():
    ...
    b1 = Paper_Author(email="sample_text", name="sample_text")
    b2 = Paper_Author(email="sample_text_2", name="sample_text_2")
...
Paper_Author_strategy = st.builds(Paper_Author, email=safe_text, name=safe_text)
@given(instance=Paper_Author_strategy)
