...
def test_hyp_attachment_fileattachment_is_not_abstract():
    assert not inspect.isabstract(attachment_FileAttachment)


def test_hyp_attachment_fileattachment_constructor_exists():
    assert callable(attachment_FileAttachment.__init__)


def test_hyp_attachment_fileattachment_constructor_args():
    sig = inspect.signature(attachment_FileAttachment.__init__)
    params = list(sig.parameters.keys())



def test_hyp_model_rationale_audiocomment_is_not_abstract():
    assert not inspect.isabstract(model_rationale_AudioComment)


def test_hyp_model_rationale_audiocomment_constructor_exists():
    assert callable(model_rationale_AudioComment.__init__)


def test_hyp_model_rationale_audiocomment_constructor_args():
...
def test_hyp_requirement_workspace_is_not_abstract():
    assert not inspect.isabstract(requirement_Workspace)


def test_hyp_requirement_workspace_constructor_exists():
    assert callable(requirement_Workspace.__init__)


def test_hyp_requirement_workspace_constructor_args():
...
def test_hyp_model_requirement_workspace_is_not_abstract():
    assert not inspect.isabstract(model_requirement_Workspace)


def test_hyp_model_requirement_workspace_constructor_exists():
    assert callable(model_requirement_Workspace.__init__)


def test_hyp_model_requirement_workspace_constructor_args():
...
def test_hyp_fileattachmenttype_exists():
    # Check that the Enumeration exists
    assert FileAttachmentType is not None

def test_hyp_fileattachmenttype_has_all_literals():
    # Collect the names of literals in this Enumeration
...
@given(instance=model_bug_BugReport_strategy)
def test_hyp_model_bug_bugreport_done_setter(instance):
...
@given(instance=model_attachment_FileAttachment_strategy)
def test_hyp_model_attachment_fileattachment_fileType_setter(instance):
...
@given(instance=model_attachment_FileAttachment_strategy)
def test_hyp_model_attachment_fileattachment_uploading_setter(instance):
...
@given(instance=model_attachment_FileAttachment_strategy)
def test_hyp_model_attachment_fileattachment_downloading_setter(instance):
