...
class database_Column(NamedElement):
    ...
    def __init__(self, autoincrement: bool, inPrimaryKey: bool, inForeignKey: bool, nullable: bool, defaultValue: str, unique: bool, database_Column: set["database_Index"] = None, column: set["database_IndexElement"] = None, columns: "database_PrimaryKey" = None, database_Column8: set["database_ForeignKey"] = None, fkColumn: set["database_ForeignKeyElement"] = None, database_Column11: "database_Type" = None, columns13: "database_Sequence" = None, columns15: "database_Table" = None, Column35: "database_PrimaryKey" = None, Column: "database_Table" = None, Column46: "database_ForeignKeyElement" = None, database_Column49: "database_ForeignKeyElement" = None, Column51: "database_IndexElement" = None, Column55: "database_Sequence" = None):
