...
public class database_Table extends AbstractTable {
    ...
    public database_Table(
        ArrayList<database_Column> database_columns,        ArrayList<database_Index> database_indexs,        ArrayList<database_Constraint> database_constraints,        ArrayList<database_ForeignKey> database_foreignkeys    ) {
