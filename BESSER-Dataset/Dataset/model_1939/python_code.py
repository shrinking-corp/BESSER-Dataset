...
class addressbook_Address:
    ...
    def __init__(self, street: str, zip: str, city: str, type: str, Address: "addressbook_Person" = None, addressbook_Address: "addressbook_Country" = None, addressbook_Address7: "addressbook_FederalState" = None, addresses: "addressbook_Person" = None):
        self.street = street
        self.zip = zip
        self.city = city
        self.type = type
