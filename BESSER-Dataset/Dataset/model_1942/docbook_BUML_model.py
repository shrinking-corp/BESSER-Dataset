...
docbook_Subtitle = Class(name="docbook_Subtitle")
docbook_Author = Class(name="docbook_Author")
TitledElement = Class(name="TitledElement")
docbook_SectionMixedContent = Class(name="docbook_SectionMixedContent", is_abstract=True)
docbook_Title = Class(name="docbook_Title")
docbook_TitledElement = Class(name="docbook_TitledElement", is_abstract=True)
docbook_ParaMixedContent = Class(name="docbook_ParaMixedContent", is_abstract=True)
docbook_Para = Class(name="docbook_Para")
SectionMixedContent = Class(name="SectionMixedContent")
XMLElement = Class(name="XMLElement")
docbook_Bookinfo = Class(name="docbook_Bookinfo")
docbook_Chapter = Class(name="docbook_Chapter")
docbook_Emphasis = Class(name="docbook_Emphasis")
docbook_Ulink = Class(name="docbook_Ulink")
docbook_Link = Class(name="docbook_Link")
docbook_ProgramListing = Class(name="docbook_ProgramListing")
Para = Class(name="Para")
docbook_SimpleText = Class(name="docbook_SimpleText")
ParaMixedContent = Class(name="ParaMixedContent")
docbook_Figure = Class(name="docbook_Figure")
docbook_MediaObject = Class(name="docbook_MediaObject")
docbook_XMLElement = Class(name="docbook_XMLElement", is_abstract=True)
docbook_Tip = Class(name="docbook_Tip")
docbook_Section = Class(name="docbook_Section")
docbook_ImageObject = Class(name="docbook_ImageObject")
docbook_ImageData = Class(name="docbook_ImageData")
docbook_Warning = Class(name="docbook_Warning")
...
docbook_Author.attributes={docbook_Author_authorblug, docbook_Author_surname, docbook_Author_firstname, docbook_Author_honorific}
...
docbook_Bookinfo.attributes={docbook_Bookinfo_date, docbook_Bookinfo_pubdate}
...
docbook_ImageData.attributes={docbook_ImageData_fileref, docbook_ImageData_width, docbook_ImageData_depth}
...
domain_model = DomainModel(
    name="docbook",
    types={docbook_Book, docbook_Subtitle, docbook_Author, TitledElement, docbook_SectionMixedContent, docbook_Title, docbook_TitledElement, docbook_ParaMixedContent, docbook_Para, SectionMixedContent, XMLElement, docbook_Bookinfo, docbook_Chapter, docbook_Emphasis, docbook_Ulink, docbook_Link, docbook_ProgramListing, Para, docbook_SimpleText, ParaMixedContent, docbook_Figure, docbook_MediaObject, docbook_XMLElement, docbook_Tip, docbook_Section, docbook_ImageObject, docbook_ImageData, docbook_Warning},
    associations={book3, subtitle4, author6, bookinfo8, bookinfo10, book12, mixedContent14, titledElement16, content17, bookinfo0, chapter1, chapter22, section24, title25, para26, titleElement28, emphasis31, ulink33, link35, content37, content38, content18, content20, content42, figure44, content46, mediaObject47, content50, imageObject51, content40},
    generalizations={gen_docbook_Bookinfo_XMLElement, gen_docbook_Chapter_TitledElement, gen_docbook_Chapter_XMLElement, gen_docbook_Para_SectionMixedContent, gen_docbook_Book_XMLElement, gen_docbook_ParaMixedContent_SectionMixedContent, gen_docbook_ProgramListing_Para, gen_docbook_SimpleText_ParaMixedContent, gen_docbook_Figure_TitledElement, gen_docbook_Figure_ParaMixedContent, gen_docbook_Emphasis_ParaMixedContent, gen_docbook_Tip_Para, gen_docbook_Section_SectionMixedContent, gen_docbook_Section_TitledElement, gen_docbook_Section_XMLElement, gen_docbook_Ulink_ParaMixedContent, gen_docbook_Warning_Para, gen_docbook_Link_ParaMixedContent},
    metadata=None
)
