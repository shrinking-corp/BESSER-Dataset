...
class docbook_Bookinfo(XMLElement):
    ...
    def __init__(self, date: str, pubdate: str, bookinfo: "docbook_Book" = None, bookinfo5: "docbook_Subtitle" = None, bookinfo7: set["docbook_Author"] = None, Bookinfo9: "docbook_Author" = None, Bookinfo11: "docbook_Subtitle" = None, Bookinfo: "docbook_Book" = None):
        self.date = date
...
class TitledElement:
    ...
    pass
class docbook_Section(SectionMixedContent, XMLElement, TitledElement):

    pass
class docbook_Chapter(XMLElement, TitledElement):
