...
class PetriNets_Place(Node):
    ...
    def __init__(self, tokens: int, PetriNets_Place5: "PetriNets_Transition" = None, PetriNets_Place: "PetriNets_Transition" = None, PetriNets_Place11: "PetriNets_TPArc" = None, PetriNets_Place16: "PetriNets_PTArc" = None):
        self.tokens = tokens
...
class PetriNets_Node(ABC):
    ...
    def __init__(self, name: str, nodes: "PetriNets_PetriNet" = None, Node: "PetriNets_PetriNet" = None):
        self.name = name
        self.nodes = nodes
        self.Node = Node
...
class PetriNets_PetriNet:
    ...
    def __init__(self, bound: int, PetriNet: "PetriNets_Node" = None, net: set["PetriNets_Node"] = None, PetriNets_PetriNet: set["PetriNets_Arc"] = None):
        self.bound = bound
