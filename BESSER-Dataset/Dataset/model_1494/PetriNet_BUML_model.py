...
domain_model = DomainModel(
    name="PetriNets",
    types={PetriNets_Token, PetriNets_TPArc, Arc, PetriNets_PetriNet, PetriNets_Node, PetriNets_Arc, PetriNets_Place, Node, PetriNets_Transition, PetriNets_PTArc},
    associations={outputs3, net6, nodes0, arcs1, inputs2, input7, output9, output12, input14},
    generalizations={gen_PetriNets_TPArc_Arc, gen_PetriNets_Place_Node, gen_PetriNets_Transition_Node, gen_PetriNets_PTArc_Arc},
    metadata=None
)
