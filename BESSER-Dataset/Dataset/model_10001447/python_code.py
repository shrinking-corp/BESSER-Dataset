...
class tp2BMOexe3_A(ABC):

    def __init__(self, c: tp2BMOexe3_B, d: int, b: bool, b7: "tp2BMOexe3_B" = None):
        self.c = c
        self.d = d
        self.b = b
        self.b7 = b7
    ...
    def b7(self, value):
        ...
        old_value = getattr(self, f"_tp2BMOexe3_A__b7", None)
        self.__b7 = value
