...
class model_DiagramModelObject(FontAttribute, LineObject, DiagramModelComponent):
    ...
    def setBounds(self, model_x, model_width, model_y, model_height):
...
class model_SketchModelActor(DiagramModelObject, Properties, Documentable):
    ...
    pass
class model_DiagramModelConnection(LineObject, DiagramModelComponent, Documentable, Properties, FontAttribute):
...
class Nameable:
    ...
    pass
class model_ArchimateElement(Nameable, Documentable, Identifier, Cloneable, Properties, ArchimateModelElement):
...
class FolderContainer:
    ...
    pass
class model_ArchimateModel(Nameable, Identifier, ArchimateModelElement, Properties, FolderContainer):

    def __init__(self, purpose: str, file: str, version: str, model_ArchimateModel7: "model_ArchimateModelElement" = None, model_ArchimateModel: "model_Metadata" = None):
...
class model_Folder(Nameable, Documentable, Identifier, Properties, ArchimateModelElement, FolderContainer):

    def __init__(self, type: str, model_Folder9: set["model_EObject"] = None, model_Folder: "model_FolderContainer" = None):
        self.type = type
