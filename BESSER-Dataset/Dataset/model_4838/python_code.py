...
class contentfwk_PhysicalApplicationComponent(ApplicationComponent, Element):
    ...
    def __init__(self, credibilityCharacteristics: str, localizationCharacteristics: str, internationalizationCharacteristics: str, interoperabilityCharacteristics: str, scalabilityCharacteristics: str, portabilityCharacteristics: str, extensibilityCharacteristics: str, capacityCharacteristics: str, throughput: str, throughputPeriod: str, growth: str, growthPeriod: str, peakProfileShortTerm: str, peakProfileLongTerm: str, lifeCycleStatus: str, initialLiveDate: date, dateOfLastRelease: date, dateOfNextRelease: date, retirementDate: date, availabilityQualityCharacteristics: str, servicesTimes: str, manageabilityCharacteristics: str, serviceabilityCharacteristics: str, performanceCharacteristics: str, reliabilityCharacteristics: str, recoverabilityCharacteristics: str, locatabilityCharacteristics: str, securityCharacteristics: str, privacyCharacteristics: str, integrityCharacteristics: str, contentfwk_PhysicalApplicationComponent: "contentfwk_PhysicalTechnologyComponent" = None, PhysicalApplicationComponent: "contentfwk_LogicalApplicationComponent" = None, PhysicalApplicationComponent251: "contentfwk_Location" = None, contentfwk_PhysicalApplicationComponent272: "contentfwk_PhysicalDataComponent" = None, contentfwk_PhysicalApplicationComponent277: "contentfwk_ApplicationArchitecture" = None, isExtendedByPhysicalApplicationComponents: set["contentfwk_LogicalApplicationComponent"] = None, containsPhysicalApplicationComponents: set["contentfwk_Location"] = None, contentfwk_PhysicalApplicationComponent291: set["contentfwk_PhysicalDataComponent"] = None, contentfwk_PhysicalApplicationComponent294: set["contentfwk_PhysicalTechnologyComponent"] = None, contentfwk_PhysicalApplicationComponent298: "contentfwk_PhysicalApplicationComponent" = None, contentfwk_PhysicalApplicationComponent296: "contentfwk_PhysicalApplicationComponent" = None, contentfwk_PhysicalApplicationComponent289: "contentfwk_PhysicalApplicationComponent" = None, contentfwk_PhysicalApplicationComponent287: set["contentfwk_PhysicalApplicationComponent"] = None):
...
class contentfwk_Capability(Element):
    ...
    def __init__(self, businessValue: str, increments: str, contentfwk_Capability: "contentfwk_StrategicArchitecture" = None, deliversCapabilities: "contentfwk_WorkPackage" = None, Capability: "contentfwk_WorkPackage" = None):
...
class contentfwk_PhysicalTechnologyComponent(TechnologyComponent, Element):
    ...
    def __init__(self, productName: str, moduleName: str, vendor: str, version: str, contentfwk_PhysicalTechnologyComponent: "contentfwk_TechnologyArchitecture" = None, contentfwk_PhysicalTechnologyComponent192: set["contentfwk_PhysicalApplicationComponent"] = None, isRealizedByPhysicalTechnologyComponents: set["contentfwk_LogicalTechnologyComponent"] = None, PhysicalTechnologyComponent: "contentfwk_Location" = None, containsPhysicalTechnologyComponents: set["contentfwk_Location"] = None, contentfwk_PhysicalTechnologyComponent199: "contentfwk_PhysicalTechnologyComponent" = None, contentfwk_PhysicalTechnologyComponent197: "contentfwk_PhysicalTechnologyComponent" = None, contentfwk_PhysicalTechnologyComponent202: "contentfwk_PhysicalTechnologyComponent" = None, contentfwk_PhysicalTechnologyComponent200: set["contentfwk_PhysicalTechnologyComponent"] = None, PhysicalTechnologyComponent303: "contentfwk_LogicalTechnologyComponent" = None, contentfwk_PhysicalTechnologyComponent295: "contentfwk_PhysicalApplicationComponent" = None):
...
class contentfwk_Actor(Element):
    ...
    def __init__(self, FTEs: str, actorGoal: str, actorTasks: str, contentfwk_Actor: "contentfwk_BusinessArchitecture" = None, isSuppliedByActors: set["contentfwk_DataEntity"] = None, isConsumedByActors: set["contentfwk_DataEntity"] = None, Actor101: "contentfwk_DataEntity" = None, Actor103: "contentfwk_DataEntity" = None, isPerformedByActors: set["contentfwk_Function"] = None, contentfwk_Actor92: "contentfwk_Actor" = None, contentfwk_Actor90: set["contentfwk_Actor"] = None, Actor: "contentfwk_OrganizationUnit" = None, containsActors: "contentfwk_OrganizationUnit" = None, supportsActors: set["contentfwk_Function"] = None, isAssumedByActors: set["contentfwk_Role"] = None, involvesActors: set["contentfwk_Process"] = None, contentfwk_Actor81: set["contentfwk_Service"] = None, isResolvedByActors: set["contentfwk_Event"] = None, isGeneratedByActors: set["contentfwk_Event"] = None, containsActors86: "contentfwk_Location" = None, Actor170: "contentfwk_Process" = None, Actor94: "contentfwk_Role" = None, Actor134: "contentfwk_Function" = None, Actor146: "contentfwk_Function" = None, Actor231: "contentfwk_Event" = None, Actor234: "contentfwk_Event" = None, Actor245: "contentfwk_Location" = None, contentfwk_Actor315: "contentfwk_Service" = None):
        self.FTEs = FTEs
...
class contentfwk_OrganizationUnit(Element):
    ...
    def __init__(self, headcount: str, OrganizationUnit: "contentfwk_Driver" = None, contentfwk_OrganizationUnit: "contentfwk_BusinessArchitecture" = None, isProducedByOrganizationUnits: set["contentfwk_Product"] = None, containsOrganizationUnits: "contentfwk_Location" = None, isOwnedAndGovernedByOrganizationUnits: set["contentfwk_Service"] = None, belongsTo: set["contentfwk_Actor"] = None, isOwnedByUnit: set["contentfwk_Function"] = None, OrganizationUnit74: "contentfwk_Actor" = None, involvesOrganizationUnits: set["contentfwk_Process"] = None, motivatesOrganizationUnits: set["contentfwk_Driver"] = None, OrganizationUnit136: "contentfwk_Function" = None, OrganizationUnit161: "contentfwk_Process" = None, OrganizationUnit248: "contentfwk_Location" = None, OrganizationUnit204: "contentfwk_Product" = None, OrganizationUnit331: "contentfwk_Service" = None):
