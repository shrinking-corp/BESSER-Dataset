...
domain_model = DomainModel(
    name="fsm",
    types={fsm_Transition, fsm_Variable, fsm_NamedElement, fsm_StateMachine, NamedElement, fsm_State, fsm_CompositeState, fsm_FinalState, State, fsm_InitialState, fsm_Trigger, fsm_Pseudostate, fsm_Fork, Pseudostate, fsm_Join, fsm_Guard, fsm_Action, fsm_TimedTransition, Transition, fsm_Region, fsm_Choice},
    associations={transitions1, states0, parentState9, variables3, outgoing4, incoming6, stateMachine8, stateMachine15, target10, source12, trigger14, guard17, action19, regions21, states23, parent26},
    generalizations={gen_fsm_StateMachine_NamedElement, gen_fsm_State_NamedElement, gen_fsm_FinalState_State, gen_fsm_InitialState_State, gen_fsm_Transition_NamedElement, gen_fsm_Pseudostate_State, gen_fsm_Fork_Pseudostate, gen_fsm_Join_Pseudostate, gen_fsm_TimedTransition_Transition, gen_fsm_CompositeState_State, gen_fsm_Choice_Pseudostate},
    metadata=None
)
