...
class fsm_Action:
    ...
    def __init__(self, value: bool, variable: str, fsm_Action: "fsm_Transition" = None):
        self.value = value
...
class fsm_State(NamedElement):
    ...
    def __init__(self, finalTime: int, initialTime: int, State: "fsm_StateMachine" = None, fsm_State: "fsm_CompositeState" = None, source: set["fsm_Transition"] = None, target: set["fsm_Transition"] = None, states: "fsm_StateMachine" = None, State11: "fsm_Transition" = None, State13: "fsm_Transition" = None, fsm_State25: "fsm_Region" = None):
...
class fsm_Transition(NamedElement):
    ...
    def __init__(self, initialTime: int, finalTime: int, Transition: "fsm_StateMachine" = None, Transition5: "fsm_State" = None, Transition7: "fsm_State" = None, transitions: "fsm_StateMachine" = None, incoming: "fsm_State" = None, outgoing: "fsm_State" = None, fsm_Transition: "fsm_Trigger" = None, fsm_Transition18: "fsm_Guard" = None, fsm_Transition20: "fsm_Action" = None):
        self.initialTime = initialTime
        self.finalTime = finalTime
