...
public class database_Index extends NamedElement {
    ...
    public database_Index(
        int cardinality,        String indexType,        boolean unique,        String qualifier    ) {
        super(
        );
    ...
    public database_Index(
        int cardinality,        String indexType,        boolean unique,        String qualifier        ArrayList<database_IndexElement> database_indexelements    ) {
        this.cardinality = cardinality;
        this.indexType = indexType;
        this.unique = unique;
        this.qualifier = qualifier;
