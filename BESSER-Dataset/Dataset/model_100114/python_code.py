...
class database_Column(NamedElement):
    ...
    def __init__(self, autoincrement: bool, inPrimaryKey: bool, inForeignKey: bool, unique: bool, nullable: bool, defaultValue: str, Column: "database_AbstractTable" = None, database_Column: set["database_Index"] = None, column: set["database_IndexElement"] = None, columns: "database_PrimaryKey" = None, database_Column9: set["database_ForeignKey"] = None, fkColumn: set["database_ForeignKeyElement"] = None, database_Column12: "database_Type" = None, database_Column14: "database_Sequence" = None, columns16: "database_AbstractTable" = None, Column30: "database_PrimaryKey" = None, Column41: "database_ForeignKeyElement" = None, database_Column44: "database_ForeignKeyElement" = None, Column46: "database_IndexElement" = None):
...
class database_Index(NamedElement):
    ...
    def __init__(self, qualifier: str, unique: bool, cardinality: int, indexType: str, database_Index: "database_Column" = None, database_Index18: set["database_IndexElement"] = None, Index: "database_Table" = None, indexes: "database_Table" = None):
