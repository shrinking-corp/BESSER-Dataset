...
class Mouvement:
    ...
    pass
class droneDSL_Descendre(CommandeBasique, MD, Mouvement):

    pass
class droneDSL_Reculer(CommandeBasique, Mouvement, AR):

    pass
class droneDSL_Droite(Mouvement, CommandeBasique, GDr):

    pass
class droneDSL_Gauche(Mouvement, CommandeBasique, GDr):

    pass
class droneDSL_Avancer(CommandeBasique, Mouvement, AR):

    pass
class droneDSL_RotationDroite(CommandeBasique, Mouvement, RGRD):

    pass
class droneDSL_RotationGauche(CommandeBasique, Mouvement, RGRD):

    pass
class droneDSL_Parallele(Mouvement):

    pass
class droneDSL_Monter(Mouvement, CommandeBasique, MD):
