...
# Classes
droneDSL_Model = Class(name="droneDSL_Model")
droneDSL_Import = Class(name="droneDSL_Import")
droneDSL_Prologue = Class(name="droneDSL_Prologue")
droneDSL_Main = Class(name="droneDSL_Main")
droneDSL_FonctionDecl = Class(name="droneDSL_FonctionDecl")
droneDSL_Pourcent_vitesse_hauteur_max = Class(name="droneDSL_Pourcent_vitesse_hauteur_max")
droneDSL_PourcentConst = Class(name="droneDSL_PourcentConst")
droneDSL_Pourcent_vitesse_deplacement_max = Class(name="droneDSL_Pourcent_vitesse_deplacement_max")
droneDSL_Pourcent_vitesse_rotation_max = Class(name="droneDSL_Pourcent_vitesse_rotation_max")
droneDSL_Hauteur_max = Class(name="droneDSL_Hauteur_max")
droneDSL_SecondeConst = Class(name="droneDSL_SecondeConst")
droneDSL_Eloignement_max = Class(name="droneDSL_Eloignement_max")
SecondeExp = Class(name="SecondeExp")
PourcentExp = Class(name="PourcentExp")
droneDSL_SecondeDecl = Class(name="droneDSL_SecondeDecl")
VarDecl = Class(name="VarDecl")
droneDSL_PourcentDecl = Class(name="droneDSL_PourcentDecl")
droneDSL_VarDecl = Class(name="droneDSL_VarDecl")
droneDSL_RefSecondeVar = Class(name="droneDSL_RefSecondeVar")
droneDSL_RefPourcentVar = Class(name="droneDSL_RefPourcentVar")
droneDSL_PourcentExp = Class(name="droneDSL_PourcentExp")
droneDSL_SecondeExp = Class(name="droneDSL_SecondeExp")
droneDSL_Decoller = Class(name="droneDSL_Decoller")
DecollerAtterrir = Class(name="DecollerAtterrir")
droneDSL_Atterrir = Class(name="droneDSL_Atterrir")
droneDSL_Monter = Class(name="droneDSL_Monter")
Mouvement = Class(name="Mouvement")
CommandeBasique = Class(name="CommandeBasique")
MD = Class(name="MD")
droneDSL_Descendre = Class(name="droneDSL_Descendre")
droneDSL_Avancer = Class(name="droneDSL_Avancer")
AR = Class(name="AR")
droneDSL_Reculer = Class(name="droneDSL_Reculer")
droneDSL_Gauche = Class(name="droneDSL_Gauche")
GDr = Class(name="GDr")
droneDSL_Droite = Class(name="droneDSL_Droite")
droneDSL_RotationGauche = Class(name="droneDSL_RotationGauche")
RGRD = Class(name="RGRD")
droneDSL_RotationDroite = Class(name="droneDSL_RotationDroite")
droneDSL_Pause = Class(name="droneDSL_Pause")
droneDSL_Mouvement = Class(name="droneDSL_Mouvement")
droneDSL_DecollerAtterrir = Class(name="droneDSL_DecollerAtterrir")
droneDSL_CommandeBasique = Class(name="droneDSL_CommandeBasique")
droneDSL_EObject = Class(name="droneDSL_EObject")
droneDSL_FinDeMain = Class(name="droneDSL_FinDeMain")
droneDSL_FonctionCall = Class(name="droneDSL_FonctionCall")
droneDSL_FonctionCallInterne = Class(name="droneDSL_FonctionCallInterne")
FonctionCall = Class(name="FonctionCall")
droneDSL_FonctionCallExterne = Class(name="droneDSL_FonctionCallExterne")
droneDSL_MD = Class(name="droneDSL_MD")
droneDSL_GDr = Class(name="droneDSL_GDr")
droneDSL_RGRD = Class(name="droneDSL_RGRD")
droneDSL_AR = Class(name="droneDSL_AR")
droneDSL_Parallele = Class(name="droneDSL_Parallele")
droneDSL_Parallele2 = Class(name="droneDSL_Parallele2")
Parallele = Class(name="Parallele")
droneDSL_Parallele3 = Class(name="droneDSL_Parallele3")
droneDSL_Parallele4 = Class(name="droneDSL_Parallele4")
...
domain_model = DomainModel(
    ...
    associations={imports0, prologue1, m3, fonctions5, vitesse_verticale7, vitesse_deplacement8, vitesse_rotation10, hauteur_max12, eloignement_max13, vitesse_verticale15, vitesse_deplacement18, vitesse_rotation21, hauteur24, eloignement27, val30, val32, var34, var36, duree38, vitesse39, duree41, vitesse43, duree46, vitesse48, duree51, vitesse53, duree56, duree61, vitesse63, duree66, vitesse68, duree71, vitesse73, duree76, body78, ref80, vitesse58, decollage84, mainbody86, atterrissage89, fdm91, a93, b95, t98, c100, c102, d104, file82},
