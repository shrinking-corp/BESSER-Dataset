...
class classdiagram_Attribute:
    ...
    def __init__(self, name: str, is_primary: bool, classdiagram_Attribute8: "classdiagram_Classifier" = None, classdiagram_Attribute: "classdiagram_Class" = None):
        self.name = name
...
class classdiagram_Class(Classifier):
    ...
    def __init__(self, is_persistent: bool, classdiagram_Class6: "classdiagram_Class" = None, classdiagram_Class4: "classdiagram_Class" = None, classdiagram_Class12: "classdiagram_Association" = None, classdiagram_Class15: "classdiagram_Association" = None, classdiagram_Class: set["classdiagram_Attribute"] = None):
...
class classdiagram_Association:
    ...
    def __init__(self, name: str, classdiagram_Association11: "classdiagram_Class" = None, classdiagram_Association14: "classdiagram_Class" = None, classdiagram_Association: "classdiagram_Package" = None):
        self.name = name
...
class classdiagram_Classifier(ABC):
    ...
    def __init__(self, name: str, classdiagram_Classifier9: "classdiagram_Attribute" = None, classdiagram_Classifier: "classdiagram_Package" = None):
        self.name = name
