...
class Order:
    ...
    def __init__(self, status: OrderStatus, number: int, ordered: date, shipped: bool, shipTo: str, total: float, items14: set["LineItem"] = None, account17: "Account" = None, payment19: "Payment" = None):
        self.status = status
        self.number = number
