...
# Classes
klangexpr_Yield = Class(name="klangexpr_Yield")
klangexpr_VariableAssignment = Class(name="klangexpr_VariableAssignment")
klangexpr_Or = Class(name="klangexpr_Or")
BinaryOperator = Class(name="BinaryOperator")
klangexpr_And = Class(name="klangexpr_And")
klangexpr_Plus = Class(name="klangexpr_Plus")
klangexpr_Minus = Class(name="klangexpr_Minus")
klangexpr_Multiply = Class(name="klangexpr_Multiply")
klangexpr_Divide = Class(name="klangexpr_Divide")
klangexpr_LessThan = Class(name="klangexpr_LessThan")
klangexpr_Equal = Class(name="klangexpr_Equal")
klangexpr_GreaterThan = Class(name="klangexpr_GreaterThan")
klangexpr_Not = Class(name="klangexpr_Not")
UnaryOperator = Class(name="UnaryOperator")
klangexpr_BooleanLiteral = Class(name="klangexpr_BooleanLiteral")
Expression = Class(name="Expression")
klangexpr_DoubleLiteral = Class(name="klangexpr_DoubleLiteral")
klangexpr_StringLiteral = Class(name="klangexpr_StringLiteral")
klangexpr_VariableReference = Class(name="klangexpr_VariableReference")
klangexpr_UnaryOperator = Class(name="klangexpr_UnaryOperator")
Operator = Class(name="Operator")
klangexpr_WhileLoop = Class(name="klangexpr_WhileLoop")
Statement = Class(name="Statement")
klangexpr_BinaryOperator = Class(name="klangexpr_BinaryOperator")
klangexpr_Expression = Class(name="klangexpr_Expression")
klangexpr_Statement = Class(name="klangexpr_Statement")
klangexpr_If = Class(name="klangexpr_If")
klangexpr_ForeverLoop = Class(name="klangexpr_ForeverLoop")
klangexpr_UnaryMinus = Class(name="klangexpr_UnaryMinus")
klangexpr_ToDouble = Class(name="klangexpr_ToDouble")
klangexpr_ToInt = Class(name="klangexpr_ToInt")
klangexpr_Operator = Class(name="klangexpr_Operator", is_abstract=True)
klangexpr_Sleep = Class(name="klangexpr_Sleep")
klangexpr_SendMessage = Class(name="klangexpr_SendMessage")
klangexpr_LessThanOrEqual = Class(name="klangexpr_LessThanOrEqual")
klangexpr_GreaterThanOrEqual = Class(name="klangexpr_GreaterThanOrEqual")
klangexpr_FunctionCall = Class(name="klangexpr_FunctionCall")
klangexpr_IntegerLiteral = Class(name="klangexpr_IntegerLiteral")
...
domain_model = DomainModel(
    name="klangexpr",
    types={klangexpr_Yield, klangexpr_VariableAssignment, klangexpr_Or, BinaryOperator, klangexpr_And, klangexpr_Plus, klangexpr_Minus, klangexpr_Multiply, klangexpr_Divide, klangexpr_LessThan, klangexpr_Equal, klangexpr_GreaterThan, klangexpr_Not, UnaryOperator, klangexpr_BooleanLiteral, Expression, klangexpr_DoubleLiteral, klangexpr_StringLiteral, klangexpr_VariableReference, klangexpr_UnaryOperator, Operator, klangexpr_WhileLoop, Statement, klangexpr_BinaryOperator, klangexpr_Expression, klangexpr_Statement, klangexpr_If, klangexpr_ForeverLoop, klangexpr_UnaryMinus, klangexpr_ToDouble, klangexpr_ToInt, klangexpr_Operator, klangexpr_Sleep, klangexpr_SendMessage, klangexpr_LessThanOrEqual, klangexpr_GreaterThanOrEqual, klangexpr_FunctionCall, klangexpr_IntegerLiteral},
    associations={statements11, expression13, expression15, left17, predicate0, statements1, predicate3, ifBlock5, elseBlock8, duration24, right19, parameters22},
    generalizations={gen_klangexpr_Yield_Statement, gen_klangexpr_VariableAssignment_Statement, gen_klangexpr_Or_BinaryOperator, gen_klangexpr_And_BinaryOperator, gen_klangexpr_Plus_BinaryOperator, gen_klangexpr_Minus_BinaryOperator, gen_klangexpr_Multiply_BinaryOperator, gen_klangexpr_Divide_BinaryOperator, gen_klangexpr_LessThan_BinaryOperator, gen_klangexpr_Equal_BinaryOperator, gen_klangexpr_GreaterThan_BinaryOperator, gen_klangexpr_Not_UnaryOperator, gen_klangexpr_BooleanLiteral_Expression, gen_klangexpr_DoubleLiteral_Expression, gen_klangexpr_StringLiteral_Expression, gen_klangexpr_VariableReference_Expression, gen_klangexpr_UnaryOperator_Operator, gen_klangexpr_WhileLoop_Statement, gen_klangexpr_BinaryOperator_Operator, gen_klangexpr_If_Statement, gen_klangexpr_ForeverLoop_Statement, gen_klangexpr_UnaryMinus_UnaryOperator, gen_klangexpr_ToDouble_UnaryOperator, gen_klangexpr_ToInt_UnaryOperator, gen_klangexpr_Operator_Expression, gen_klangexpr_Sleep_Statement, gen_klangexpr_SendMessage_Statement, gen_klangexpr_LessThanOrEqual_BinaryOperator, gen_klangexpr_GreaterThanOrEqual_BinaryOperator, gen_klangexpr_FunctionCall_Expression, gen_klangexpr_FunctionCall_Statement, gen_klangexpr_IntegerLiteral_Expression},
    metadata=None
)
