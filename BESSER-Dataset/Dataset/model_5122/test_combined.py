...
def test_hyp_diva_cepable_is_not_abstract():
    assert not inspect.isabstract(diva_CEPable)


def test_hyp_diva_cepable_constructor_exists():
    assert callable(diva_CEPable.__init__)


def test_hyp_diva_cepable_constructor_args():
...
def test_hyp_cepable_is_not_abstract():
    assert not inspect.isabstract(CEPable)


def test_hyp_cepable_constructor_exists():
    assert callable(CEPable.__init__)


def test_hyp_cepable_constructor_args():
    sig = inspect.signature(CEPable.__init__)
    params = list(sig.parameters.keys())
...
def test_hyp_diva_cepable_query_setter(instance):
