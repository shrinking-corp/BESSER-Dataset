...
class diva_visitors_TopDownVisitor(ABC):
    ...
    def __init__(self):
        ...
        pass
    def visitScore(self, diva_context, diva_node):
    ...
    def visitNotTerm(self, diva_node, diva_context):
    ...
    def visitVariabilityModel(self, diva_context, diva_node):
    ...
    def visitSuitableConfiguration(self, diva_context, diva_node):
    ...
    def visitConfiguration(self, diva_context, diva_node):
    ...
    def visitPriorityRule(self, diva_context, diva_node):
    ...
    def visitDimension(self, diva_context, diva_node):
        # TODO: Implement visitDimension method
        pass

    def visitAnnotation(self, diva_node, diva_context):
...
class diva_visitors_Visitor(ABC):
    ...
    def visitEnumVariable(self, diva_node, diva_context):
        # TODO: Implement visitEnumVariable method
        pass
    ...
    def visitInvariant(self, diva_node, diva_context):
        # TODO: Implement visitInvariant method
        pass
    ...
    def visitConfigVariant(self, diva_node, diva_context):
        # TODO: Implement visitConfigVariant method
        pass
    ...
    def visitSimulationModel(self, diva_node, diva_context):
        # TODO: Implement visitSimulationModel method
        pass
    ...
    def visitContextExpression(self, diva_node, diva_context):
        # TODO: Implement visitContextExpression method
        pass
...
class diva_Expression(DiVAModelElement):
    ...
    def __init__(self, text: str, diva_Expression37: "diva_Term" = None, diva_Expression: "diva_Invariant" = None):
        self.text = text
...
class diva_EnumLiteral(NamedElement, CEPable):
    ...
    def __init__(self, diva_EnumLiteral19: "diva_EnumTerm" = None, diva_EnumLiteral: "diva_EnumVariable" = None, diva_EnumLiteral84: "diva_EnumVariableValue" = None):
...
class diva_Dimension(NamedElement):
    ...
    def __init__(self, upper: str, lower: str, type: set["diva_Variant"] = None, Dimension: "diva_Variant" = None, diva_Dimension32: set["diva_Property"] = None, diva_Dimension35: set["diva_MultiplicityConstraint"] = None, diva_Dimension: "diva_VariabilityModel" = None):
        self.upper = upper
        self.lower = lower
...
class diva_Property(NamedElement):
    ...
    def __init__(self, direction: str, diva_Property33: "diva_Dimension" = None, diva_Property47: "diva_PropertyValue" = None, diva_Property44: set["diva_PropertyLiteral"] = None, diva_Property50: "diva_PropertyPriority" = None, diva_Property76: "diva_Score" = None, diva_Property: "diva_VariabilityModel" = None, diva_Property79: "diva_Priority" = None):
