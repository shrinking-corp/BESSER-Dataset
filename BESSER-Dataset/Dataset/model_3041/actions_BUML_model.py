...
domain_model = DomainModel(
    name="actions",
    types={actions_Action, actions_ActionReference, PreGenerationAction, actions_StandAloneAction, actions_EObject, core_AbstractModelElement, core_ITopLevelElement, actions_PreGenerationAction, IContextVariable, actions_TimedConditionAction, rules_IRealTimeConsumer, actions_PostGenerationSequence, PostGenerationAction, actions_ThrowAction, actions_TermAction, actions_Term, actions_ReconfigurationAction, actions_SetDataAction, ReconfigurationAction, IValueFunction, IDataNodeFunction, actions_GetDataAction, actions_RemoveBagAction, DataBag, IArithmetricFunction, actions_ActivateFeatureAction, IFeature, FeatureVersion, actions_DeactivateFeatureAction, actions_SetPropertyAction, DataLeaf, ILogicFunction, Action, actions_PostGenerationAction, actions_PreGenerationSequence, actions_DependentAction, actions_GetPropertyAction, DependentAction, actions_GetRealTimeAction, actions_GetFeatureStateAction, DataElement, actions_FailAction, actions_TimeAction, ITimeConsumer},
    associations={action0, parameters1, action3, parameters5, action7, actions13, term14, values15, node16, node18, bag20, index21, feature23, version24, feature26, condition9, actions11, consumer31, property32, feature34, property28, value29},
    generalizations={gen_actions_ActionReference_PreGenerationAction, gen_actions_StandAloneAction_core_AbstractModelElement, gen_actions_StandAloneAction_core_ITopLevelElement, gen_actions_TimedConditionAction_core_AbstractModelElement, gen_actions_TimedConditionAction_core_ITopLevelElement, gen_actions_TimedConditionAction_rules_IRealTimeConsumer, gen_actions_PostGenerationSequence_PostGenerationAction, gen_actions_ThrowAction_PreGenerationAction, gen_actions_TermAction_PostGenerationAction, gen_actions_TermAction_PreGenerationAction, gen_actions_ReconfigurationAction_PreGenerationAction, gen_actions_SetDataAction_ReconfigurationAction, gen_actions_GetDataAction_PreGenerationAction, gen_actions_RemoveBagAction_ReconfigurationAction, gen_actions_ActivateFeatureAction_PostGenerationAction, gen_actions_ActivateFeatureAction_ReconfigurationAction, gen_actions_DeactivateFeatureAction_PostGenerationAction, gen_actions_DeactivateFeatureAction_ReconfigurationAction, gen_actions_SetPropertyAction_PostGenerationAction, gen_actions_PreGenerationAction_Action, gen_actions_PostGenerationAction_Action, gen_actions_PreGenerationSequence_PreGenerationAction, gen_actions_DependentAction_PostGenerationAction, gen_actions_GetPropertyAction_DependentAction, gen_actions_GetRealTimeAction_DependentAction, gen_actions_GetRealTimeAction_PreGenerationAction, gen_actions_GetFeatureStateAction_DependentAction, gen_actions_GetFeatureStateAction_PreGenerationAction, gen_actions_FailAction_PostGenerationAction, gen_actions_FailAction_PreGenerationAction, gen_actions_TimeAction_PreGenerationAction},
    metadata=None
)
