...
# Classes
minifsm_FSM = Class(name="minifsm_FSM")
minifsm_State = Class(name="minifsm_State")
minifsm_Transition = Class(name="minifsm_Transition")
minifsm_Initial = Class(name="minifsm_Initial")
State = Class(name="State")
minifsm_Terminal = Class(name="minifsm_Terminal")

# minifsm_FSM class attributes and methods
minifsm_FSM_currentEvent: Property = Property(name="currentEvent", type=StringType)
minifsm_FSM_m_handle: Method = Method(name="handle", parameters={Parameter(name='minifsm_event', type=StringType)})
...
domain_model = DomainModel(
    ...
    associations={states0, transitions1, currentState2, incoming5, outgoing7, fsm10},
