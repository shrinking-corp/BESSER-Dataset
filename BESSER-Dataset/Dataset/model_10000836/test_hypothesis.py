...
def test_stocknotice_is_not_abstract():
    assert not inspect.isabstract(StockNotice)


def test_stocknotice_constructor_exists():
    assert callable(StockNotice.__init__)


def test_stocknotice_constructor_args():
...
def test_stocknotice_has_Source():
    assert hasattr(StockNotice, "Source")
    descriptor = None
    for klass in StockNotice.__mro__:
        if "Source" in klass.__dict__:
            descriptor = klass.__dict__["Source"]
            break
    assert isinstance(descriptor, property)

def test_stocknotice_has_MatchedPrice():
    assert hasattr(StockNotice, "MatchedPrice")
    descriptor = None
    for klass in StockNotice.__mro__:
        if "MatchedPrice" in klass.__dict__:
            descriptor = klass.__dict__["MatchedPrice"]
            break
    assert isinstance(descriptor, property)

def test_stocknotice_has_ID():
    assert hasattr(StockNotice, "ID")
    descriptor = None
    for klass in StockNotice.__mro__:
...
def test_stocknotice_has_ProductName():
    assert hasattr(StockNotice, "ProductName")
    descriptor = None
    for klass in StockNotice.__mro__:
...
def test_stocknotice_has_ProductID():
    assert hasattr(StockNotice, "ProductID")
    descriptor = None
    for klass in StockNotice.__mro__:
...
@given(instance=StockNotice_strategy)
def test_stocknotice_Source_setter(instance):
...
@given(instance=StockNotice_strategy)
def test_stocknotice_MatchedPrice_setter(instance):
...
@given(instance=StockNotice_strategy)
def test_stocknotice_ID_setter(instance):
...
@given(instance=StockNotice_strategy)
def test_stocknotice_ProductName_setter(instance):
...
@given(instance=StockNotice_strategy)
def test_stocknotice_ProductID_setter(instance):
