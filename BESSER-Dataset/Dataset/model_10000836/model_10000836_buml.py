...
# Classes
StockNotice = Class(name="StockNotice")
...
# StockNotice class attributes and methods
StockNotice_ID: Property = Property(name="ID", type=FloatType)
StockNotice_ProductID: Property = Property(name="ProductID", type=StringType)
StockNotice_ProductName: Property = Property(name="ProductName", type=StringType)
StockNotice_MatchedPrice: Property = Property(name="MatchedPrice", type=StringType)
StockNotice_Source: Property = Property(name="Source", type=StringType)
StockNotice.attributes={StockNotice_ProductName, StockNotice_ID, StockNotice_ProductID, StockNotice_MatchedPrice, StockNotice_Source}
...
domain_model = DomainModel(
    name="_6699c3cb_c316_4db1_adcd_bff9350f60ef",
    types={StockNotice, ClassA, ClassB, ClassC, ClassD, ClassE, ClassF, ClassG, ClassJ, ClassH, ClassK, ClassL, ClassM, ClassN, ClassP, InterfaceO_Interface, ClassQ, ClassR, ClassS, ClassT, ClassU, ClassV},
    associations={ClassD_ClassECopyCopy, ClassD_ClassE, ClassD_ClassECopy},
    generalizations={},
    metadata=None
)
