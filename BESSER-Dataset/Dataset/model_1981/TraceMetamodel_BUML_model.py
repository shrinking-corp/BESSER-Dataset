...
# Classes
TraceMetamodel_TraceModel = Class(name="TraceMetamodel_TraceModel")
TraceMetamodel_TraceLink = Class(name="TraceMetamodel_TraceLink")
TraceMetamodel_TraceLinkEnd = Class(name="TraceMetamodel_TraceLinkEnd")
TraceMetamodel_EObject = Class(name="TraceMetamodel_EObject")
...
TraceMetamodel_TraceLink.attributes={TraceMetamodel_TraceLink_isPartial, TraceMetamodel_TraceLink_id, TraceMetamodel_TraceLink_trule, TraceMetamodel_TraceLink_name, TraceMetamodel_TraceLink_isNonInjective}
...
TraceMetamodel_TraceLinkEnd.attributes={TraceMetamodel_TraceLinkEnd_type, TraceMetamodel_TraceLinkEnd_name}
