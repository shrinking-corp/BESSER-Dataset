...
class List_Element:
    ...
    def __init__(self, name: str, value: int, List_Element: "List_List" = None, List_Element3: "List_List" = None, List_Element6: "List_List" = None, List_Element13: "List_List" = None, elementPointer: "SubTestPackage_SubTest" = None):
        self.name = name
        self.value = value
        ...
        self.elementPointer = elementPointer
    ...
    @property
    def elementPointer(self):
        return self.__elementPointer

    @elementPointer.setter
    def elementPointer(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_List_Element__elementPointer", None)
        self.__elementPointer = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "SubTest"):
                opp_val = getattr(old_value, "SubTest", None)
                if opp_val == self:
                    setattr(old_value, "SubTest", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "SubTest"):
                opp_val = getattr(value, "SubTest", None)
                setattr(value, "SubTest", self)
...
class List_TestPackage_Test:
    ...
    def __init__(self, value: int, List_TestPackage_Test18: "TestPackage_List_Element" = None, List_TestPackage_Test: "TestPackage_List_Element" = None):
        self.value = value
