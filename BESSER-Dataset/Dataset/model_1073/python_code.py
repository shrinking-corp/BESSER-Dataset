...
class petrinet_Node(ABC):
    ...
    def __init__(self, name: str, petrinet_Node8: "petrinet_Arc" = None, petrinet_Node11: "petrinet_Arc" = None, petrinet_Node13: "petrinet_PetriNet" = None, petrinet_Node16: set["petrinet_Arc"] = None, petrinet_Node19: set["petrinet_Arc"] = None, petrinet_Node: "petrinet_PetriNet" = None):
        self.name = name
