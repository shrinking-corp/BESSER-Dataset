...
domain_model = DomainModel(
    name="solution",
    types={solution_WebApplication, solution_Link, solution_NonContextualLink, solution_Entity, solution_WebPage, solution_StaticPage, solution_Attribute, solution_Relationship, WebPage, solution_DynamicPage, solution_EntityPage, DynamicPage, solution_IndexPage, solution_CreatePage, EditablePage, solution_UpdatePage, solution_DeletePage, Link, solution_ContextualLink, solution_EditablePage, EntityPage, DataType},
    associations={links17, homeLink19, entities0, webpages1, homePage3, attributes5, id7, relationships10, source11, target12, opposite15, entity21, innerPages23, target25, information28, returnPage30},
