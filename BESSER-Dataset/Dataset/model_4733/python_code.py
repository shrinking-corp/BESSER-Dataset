...
class solution_Relationship:
    ...
    def __init__(self, roleName: str, lowerBound: int, upperBound: int, relationships: "solution_Entity" = None, solution_Relationship: "solution_Entity" = None, solution_Relationship16: "solution_Relationship" = None, solution_Relationship14: "solution_Relationship" = None, Relationship: "solution_Entity" = None):
...
class solution_WebPage(ABC):
    ...
    def __init__(self, name: str, relativeUrl: str, solution_WebPage27: "solution_Link" = None, solution_WebPage18: set["solution_Link"] = None, solution_WebPage20: "solution_NonContextualLink" = None, solution_WebPage: "solution_WebApplication" = None):
        self.name = name
...
class solution_Entity:
    ...
    def __init__(self, name: str, solution_Entity13: "solution_Relationship" = None, solution_Entity22: "solution_DynamicPage" = None, solution_Entity29: "solution_ContextualLink" = None, solution_Entity: "solution_WebApplication" = None, solution_Entity6: set["solution_Attribute"] = None, solution_Entity8: "solution_Attribute" = None, source: set["solution_Relationship"] = None, Entity: "solution_Relationship" = None):
        self.name = name
...
class solution_Link(ABC):
    ...
    def __init__(self, name: str, solution_Link26: "solution_WebPage" = None, solution_Link: "solution_WebPage" = None):
        self.name = name
...
class solution_WebApplication:
    ...
    def creationDateBeforeGoLive(self) :
