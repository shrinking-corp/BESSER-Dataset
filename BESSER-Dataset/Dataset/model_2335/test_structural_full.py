...
def test_persons_Person_firstName_value_roundtrip():
    instance = persons_Person(firstName="sample_text", id="sample_text", lastName="sample_text")
...
persons_Person_strategy = st.builds(persons_Person, firstName=safe_text, id=safe_text, lastName=safe_text)
