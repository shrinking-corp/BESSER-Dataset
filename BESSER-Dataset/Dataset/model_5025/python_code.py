...
class model1_Product1:
    ...
    def __init__(self, name: str, vat: str, description: str, model1_Product1: "model1_Category" = None, Product1: "model1_OrderDetail" = None, product: set["model1_OrderDetail"] = None, model1_Product128: "model1_ProductToOrder" = None):
        self.name = name
        self.vat = vat
...
class model1_SalesOrder(Order):
    ...
    def __init__(self, id: int, SalesOrder: "model1_Customer" = None, model1_SalesOrder: "model1_Company" = None, salesOrders: "model1_Customer" = None, model1_SalesOrder31: "model1_ProductToOrder" = None):
        self.id = id
...
class model1_Address:
    ...
    def __init__(self, city: str, name: str, street: str):
        self.city = city
        self.name = name
        self.street = street
...
class OrderDetail:
    ...
    pass
class model1_OrderAddress(Address, Order, OrderDetail):
