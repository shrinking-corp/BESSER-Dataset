...
# Classes
fMS_FSM = Class(name="fMS_FSM")
fMS_State = Class(name="fMS_State")
fMS_Transition = Class(name="fMS_Transition")
fMS_InitState = Class(name="fMS_InitState")
State = Class(name="State")
fMS_FinalState = Class(name="fMS_FinalState")
...
domain_model = DomainModel(
    name="fMS",
    types={fMS_FSM, fMS_State, fMS_Transition, fMS_InitState, State, fMS_FinalState},
    associations={state0, transition1, stateStart3, stateEnd6},
