...
class fMS_State:
    ...
    def __init__(self, name: str, fMS_State: "fMS_FSM" = None, fMS_State5: "fMS_Transition" = None, fMS_State8: "fMS_Transition" = None):
        self.name = name
...
class fMS_FSM:
    ...
    def __init__(self, name: str, fMS_FSM: set["fMS_State"] = None, fMS_FSM2: set["fMS_Transition"] = None):
        self.name = name
