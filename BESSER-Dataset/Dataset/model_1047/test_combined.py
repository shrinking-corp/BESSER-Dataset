...
def test_hyp_fms_finalstate_is_not_abstract():
    assert not inspect.isabstract(fMS_FinalState)


def test_hyp_fms_finalstate_constructor_exists():
    assert callable(fMS_FinalState.__init__)


def test_hyp_fms_finalstate_constructor_args():
    sig = inspect.signature(fMS_FinalState.__init__)
    params = list(sig.parameters.keys())



def test_hyp_fms_initstate_is_not_abstract():
    assert not inspect.isabstract(fMS_InitState)


def test_hyp_fms_initstate_constructor_exists():
    assert callable(fMS_InitState.__init__)


def test_hyp_fms_initstate_constructor_args():
    sig = inspect.signature(fMS_InitState.__init__)
    params = list(sig.parameters.keys())



def test_hyp_fms_transition_is_not_abstract():
    assert not inspect.isabstract(fMS_Transition)


def test_hyp_fms_transition_constructor_exists():
    assert callable(fMS_Transition.__init__)


def test_hyp_fms_transition_constructor_args():
...
def test_hyp_fms_state_is_not_abstract():
    assert not inspect.isabstract(fMS_State)


def test_hyp_fms_state_constructor_exists():
    assert callable(fMS_State.__init__)


def test_hyp_fms_state_constructor_args():
...
def test_hyp_fms_fsm_is_not_abstract():
    assert not inspect.isabstract(fMS_FSM)


def test_hyp_fms_fsm_constructor_exists():
    assert callable(fMS_FSM.__init__)


def test_hyp_fms_fsm_constructor_args():
...
def test_hyp_fms_transition_name_setter(instance):
...
def test_hyp_fms_state_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_fms_fsm_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
