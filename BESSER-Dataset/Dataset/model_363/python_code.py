...
class library_Book:
    ...
    def __init__(self, title: str, Book: "library_Writer" = None, books: "library_Writer" = None, library_Book: "library_Library" = None):
        self.title = title
        self.Book = Book
        self.books = books
...
class library_Writer:
    ...
    def __init__(self, firstName: str, lastName: str, author: set["library_Book"] = None, Writer: "library_Book" = None, library_Writer: "library_Library" = None):
