...
# Classes
database_Scheme = Class(name="database_Scheme")
...
database_Column.attributes={database_Column_name, database_Column_NotNull, database_Column_type, database_Column_PrimaryKey}
