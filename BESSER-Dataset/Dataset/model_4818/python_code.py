...
class Adapter:
    ...
    pass
class model_ArchimateModelObject(Adapter, Identifier, Features, Nameable):

    def __init__(self):
        
        pass
    def getArchimateModel(self) :
        # TODO: Implement getArchimateModel method
        pass

class model_Feature:

    def __init__(self, value: str, name: str, model_Feature: "model_Features" = None):
        self.value = value
        self.name = name
...
class model_Property:
    ...
    def __init__(self, key: str, value: str, model_Property3: "model_Metadata" = None, model_Property: "model_Properties" = None):
        self.key = key
        self.value = value
...
class model_Bounds:
    ...
    def setLocation(self, model_y, model_x):
        # TODO: Implement setLocation method
        pass

    def setSize(self, model_height, model_width):
...
class model_DiagramModelArchimateComponent(Connectable):
    ...
    def addArchimateConceptToModel(self, model_parent):
        # TODO: Implement addArchimateConceptToModel method
        pass

    def setArchimateConcept(self, model_concept):
...
class DiagramModelContainer:
    ...
    pass
class model_DiagramModelArchimateObject(DiagramModelContainer, DiagramModelObject, TextPosition, DiagramModelArchimateComponent):
...
class model_DiagramModelObject(FontAttribute, TextAlignment, Connectable, LineObject):

    def __init__(self, alpha: int, fillColor: str, model_DiagramModelObject: "model_DiagramModelContainer" = None, model_DiagramModelObject20: "model_Bounds" = None):
        self.alpha = alpha
    ...
    def setBounds(self, model_x, model_height, model_width, model_y):
...
class model_TechnologyFunction(BehaviorElement, TechnologyElement):
    ...
    pass
class model_Path(TechnologyElement, ActiveStructureElement):
...
class Properties:
    ...
    pass
class model_DiagramModelNote(TextContent, DiagramModelObject, TextPosition, Properties, BorderType):

    pass
class model_SketchModelSticky(TextContent, DiagramModelObject, DiagramModelContainer, TextPosition, Properties):

    pass
class Documentable:

    pass
class model_DiagramModelGroup(DiagramModelObject, DiagramModelContainer, Documentable, TextPosition, Properties, BorderType):

    pass
class model_DiagramModelConnection(Connectable, LineObject, Documentable, FontAttribute, Properties):
...
class model_SketchModelActor(Documentable, DiagramModelObject, Properties):
    ...
    pass
class model_DiagramModelImage(DiagramModelImageProvider, DiagramModelObject, BorderObject, Documentable, Properties):
...
class ArchimateModelObject:
    ...
    pass
class model_DiagramModel(Documentable, Properties, ArchimateModelObject, DiagramModelContainer):
...
class model_ArchimateModel(Properties, ArchimateModelObject, FolderContainer):
    ...
    def getDefaultFolderForObject(self, model_object) :
...
class Cloneable:
    ...
    pass
class model_DiagramModelComponent(ArchimateModelObject, Adapter, Identifier, Nameable, Cloneable):

    def __init__(self):
        
        pass
    def getDiagramModel(self) :
...
class model_ArchimateConcept(Documentable, Properties, ArchimateModelObject, Cloneable):
