...
def test_model_bordertype_is_not_abstract():
    assert not inspect.isabstract(model_BorderType)


def test_model_bordertype_constructor_exists():
    assert callable(model_BorderType.__init__)


def test_model_bordertype_constructor_args():
    sig = inspect.signature(model_BorderType.__init__)
    params = list(sig.parameters.keys())
    assert "borderType" in params, "Missing parameter 'borderType'"

def test_model_bordertype_has_borderType():
    assert hasattr(model_BorderType, "borderType")
    descriptor = None
    for klass in model_BorderType.__mro__:
...
def test_model_diagrammodelobject_has_alpha():
    assert hasattr(model_DiagramModelObject, "alpha")
    descriptor = None
    for klass in model_DiagramModelObject.__mro__:
...
def test_model_associationrelationship_has_directed():
    assert hasattr(model_AssociationRelationship, "directed")
    descriptor = None
    for klass in model_AssociationRelationship.__mro__:
...
def test_strategybehaviorelement_is_not_abstract():
    assert not inspect.isabstract(StrategyBehaviorElement)


def test_strategybehaviorelement_constructor_exists():
    assert callable(StrategyBehaviorElement.__init__)


def test_strategybehaviorelement_constructor_args():
    sig = inspect.signature(StrategyBehaviorElement.__init__)
    params = list(sig.parameters.keys())



def test_model_valuestream_is_not_abstract():
    assert not inspect.isabstract(model_ValueStream)


def test_model_valuestream_constructor_exists():
    assert callable(model_ValueStream.__init__)


def test_model_valuestream_constructor_args():
...
def test_model_strategybehaviorelement_is_not_abstract():
    assert not inspect.isabstract(model_StrategyBehaviorElement)


def test_model_strategybehaviorelement_constructor_exists():
    assert callable(model_StrategyBehaviorElement.__init__)


def test_model_strategybehaviorelement_constructor_args():
...
def test_model_feature_has_name():
    assert hasattr(model_Feature, "name")
    descriptor = None
    for klass in model_Feature.__mro__:
        if "name" in klass.__dict__:
            descriptor = klass.__dict__["name"]
            break
    assert isinstance(descriptor, property)

def test_model_feature_has_value():
    assert hasattr(model_Feature, "value")
    descriptor = None
    for klass in model_Feature.__mro__:
...
def test_model_features_is_not_abstract():
    assert not inspect.isabstract(model_Features)


def test_model_features_constructor_exists():
    assert callable(model_Features.__init__)


def test_model_features_constructor_args():
...
@given(instance=model_BorderType_strategy)
def test_model_bordertype_borderType_setter(instance):
...
@given(instance=model_DiagramModelObject_strategy)
def test_model_diagrammodelobject_alpha_setter(instance):
...
@given(instance=model_AssociationRelationship_strategy)
def test_model_associationrelationship_directed_setter(instance):
...
@given(instance=model_Feature_strategy)
def test_model_feature_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=model_Feature_strategy)
def test_model_feature_value_setter(instance):
