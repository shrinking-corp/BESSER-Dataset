...
# Classes
rental_RentalAgency = Class(name="rental_RentalAgency")
rental_Address = Class(name="rental_Address")
rental_RentalObject = Class(name="rental_RentalObject")
rental_Customer = Class(name="rental_Customer")
rental_Rental = Class(name="rental_Rental")
rental_License = Class(name="rental_License")
rental_Car = Class(name="rental_Car")
RentalObject = Class(name="RentalObject")
rental_Device = Class(name="rental_Device")

# rental_RentalAgency class attributes and methods
rental_RentalAgency_name: Property = Property(name="name", type=StringType)
rental_RentalAgency_m_book: Method = Method(name="book", parameters={Parameter(name='rental_rentedObject', type=StringType), Parameter(name='rental_from_', type=StringType), Parameter(name='rental_customer', type=StringType), Parameter(name='rental_to', type=StringType)}, type=StringType)
rental_RentalAgency_m_isAvailable: Method = Method(name="isAvailable", parameters={Parameter(name='rental_rentedObject', type=StringType), Parameter(name='rental_to', type=StringType), Parameter(name='rental_from_', type=StringType)}, type=BooleanType)
...
rental_Address.attributes={rental_Address_city, rental_Address_streetName, rental_Address_streetType, rental_Address_number, rental_Address_zipCode}
...
rental_RentalObject_m_rent: Method = Method(name="rent", parameters={Parameter(name='rental_customer', type=StringType)}, type=StringType)
rental_RentalObject.attributes={rental_RentalObject_available, rental_RentalObject_ID, rental_RentalObject_name}
...
rental_Customer_m_addLicense: Method = Method(name="addLicense", parameters={Parameter(name='rental_license', type=StringType)})
...
rental_Device.attributes={rental_Device_serialNumber, rental_Device_width, rental_Device_length, rental_Device_height}
...
domain_model = DomainModel(
    name="rental",
    types={rental_RentalAgency, rental_Address, rental_RentalObject, rental_Customer, rental_Rental, rental_License, rental_Car, RentalObject, rental_Device, StreetType},
    associations={address0, objectsToRent1, customers2, rentals4, customer16, address6, licenses8, parentAgency9, parentAgency10, owner12, EReference014, rentedObject18, parentAgency20},
