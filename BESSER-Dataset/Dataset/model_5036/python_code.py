...
class rental_Rental:
    ...
    def __init__(self, startDate: date, endDate: date, rental_Rental19: "rental_RentalObject" = None, rentals: "rental_RentalAgency" = None, Rental: "rental_RentalAgency" = None, rental_Rental: "rental_Customer" = None):
...
class rental_Customer:
    ...
    def __init__(self, firstName: str, lastName: str, Customer: "rental_RentalAgency" = None, rental_Customer17: "rental_Rental" = None, rental_Customer: "rental_Address" = None, owner: set["rental_License"] = None, customers: "rental_RentalAgency" = None, Customer13: "rental_License" = None, rental_Customer15: "rental_License" = None):
    ...
    def addLicense(self, rental_license):
...
class rental_RentalObject:
    ...
    def __init__(self, ID: str, name: str, available: bool, rental_RentalObject: "rental_Rental" = None, RentalObject: "rental_RentalAgency" = None, objectsToRent: "rental_RentalAgency" = None):
        self.ID = ID
        self.name = name
...
class rental_RentalAgency:
    ...
    def __init__(self, name: str, rental_RentalAgency: "rental_Address" = None, RentalAgency21: "rental_Rental" = None, parentAgency: set["rental_RentalObject"] = None, parentAgency3: set["rental_Customer"] = None, parentAgency5: set["rental_Rental"] = None, RentalAgency: "rental_Customer" = None, RentalAgency11: "rental_RentalObject" = None):
        self.name = name
    ...
    def isAvailable(self, rental_from_, rental_to, rental_rentedObject) :
        # TODO: Implement isAvailable method
        pass

    def book(self, rental_customer, rental_rentedObject, rental_from_, rental_to) :
