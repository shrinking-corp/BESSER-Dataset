...
Package_fasdf_Component = Class(name="Package_fasdf_Component")
Package_T = Class(name="Package_T")
User_Kaktus_Actor = Class(name="User_Kaktus_Actor")
...
# Package_fasdf_Component class attributes and methods

# Package_T class attributes and methods

# User_Kaktus_Actor class attributes and methods
...
User_Login: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="user3", type=User_Kaktus_Actor, multiplicity=Multiplicity(0, 1))
    }
)
User_Book_Airline_Ticket: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="user5", type=User_Kaktus_Actor, multiplicity=Multiplicity(0, 1))
    }
)
User_Show_Ticket_History: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="user7", type=User_Kaktus_Actor, multiplicity=Multiplicity(0, 1))
    }
)
User_Cancel_Ticket: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="user9", type=User_Kaktus_Actor, multiplicity=Multiplicity(0, 1))
    }
)
User_Reschedule_Ticket: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="user11", type=User_Kaktus_Actor, multiplicity=Multiplicity(0, 1))
    }
)
