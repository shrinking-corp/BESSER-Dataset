...
class errors_ForeignError(Error):
    ...
    def __init__(self, porcent: str, errors_ForeignError6: set["errors_Column"] = None, errors_ForeignError8: "errors_Fk" = None, errors_ForeignError10: set["errors_Registry"] = None, errors_ForeignError: "errors_Table" = None, errors_ForeignError3: "errors_Table" = None):
        self.porcent = porcent
