...
errors_Column = Class(name="errors_Column")
errors_Fk = Class(name="errors_Fk")
errors_Registry = Class(name="errors_Registry")
errors_CheckError = Class(name="errors_CheckError")
errors_Ck = Class(name="errors_Ck")
...
domain_model = DomainModel(
    ...
    associations={ck11, table12, registriesCk15, errores0, tableCont1, tableRef2, fkColumns5, fk7, registriesFk9},
