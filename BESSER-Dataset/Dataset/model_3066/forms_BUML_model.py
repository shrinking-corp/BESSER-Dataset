...
forms_Form.attributes={forms_Form_welcomeForm, forms_Form_title, forms_Form_description}
...
domain_model = DomainModel(
    name="forms",
    types={forms_Entity, EntityModelElement, NamedElement, forms_Feature, forms_Literal, forms_Attribute, Feature, forms_Enumeration, forms_Relationship, forms_Condition, forms_TextField, AttributePageElement, forms_TextArea, forms_SelectionField, forms_EntityModel, forms_EntityModelElement, forms_NamedElement, forms_FormModel, forms_Form, forms_Page, forms_PageElement, forms_CompositeCondition, forms_AttributePageElement, PageElement, forms_List, RelationshipPageElement, forms_Table, forms_Column, forms_AttributeValueCondition, Condition, forms_RelationshipPageElement, forms_DateSelectionField, forms_TimeSelectionField, AttributeType, CompositeConditionType, ConditionType},
    associations={target8, opposite11, literals13, features0, id1, superType4, enumeration6, condition24, condition26, entityModelElements15, forms16, entity17, pages20, pageElements22, attribute30, composedConditions32, attribute34, columns29, relationship36, editingForm38},
    generalizations={gen_forms_Entity_EntityModelElement, gen_forms_Entity_NamedElement, gen_forms_Enumeration_EntityModelElement, gen_forms_Enumeration_NamedElement, gen_forms_Literal_NamedElement, gen_forms_Attribute_Feature, gen_forms_Relationship_Feature, gen_forms_Feature_NamedElement, gen_forms_TextField_AttributePageElement, gen_forms_TextArea_AttributePageElement, gen_forms_SelectionField_AttributePageElement, gen_forms_Form_NamedElement, gen_forms_AttributeValueCondition_Condition, gen_forms_CompositeCondition_Condition, gen_forms_AttributePageElement_PageElement, gen_forms_List_RelationshipPageElement, gen_forms_Table_RelationshipPageElement, gen_forms_Column_AttributePageElement, gen_forms_RelationshipPageElement_PageElement, gen_forms_DateSelectionField_AttributePageElement, gen_forms_TimeSelectionField_AttributePageElement},
    metadata=None
)
