...
Flight.attributes={Flight_arrivalTime, Flight_departureTime, Flight_id}
...
domain_model = DomainModel(
    name="_07684f30_e52c_4430_a8d0_ec017f89e3c4",
    types={Airline, Flight, Airport, Pilot, Aircraft, Company, CoPilot, Navigator, Captain, MaintenanceState, FlightState},
    associations={Aircraft_Pilot, Aircraft_CoPilot, Aircraft_Captain, Airline_Aircraft, Company_Pilot, Flights_Airport, Flights_Airport2, Airline_Flight, Flight_Aircraft},
    generalizations={},
    metadata=None
)
