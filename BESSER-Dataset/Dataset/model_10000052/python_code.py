...
class Aircraft:
    ...
    def __init__(self, state: MaintenanceState, flightState: FlightState, employs12: set["Pilot"] = None, requires14: set["CoPilot"] = None, requires16: set["Captain"] = None, owns1: set["Airline"] = None, uses11: set["Flight"] = None):
        self.state = state
