...
# Classes
core_IdentifiedElement = Class(name="core_IdentifiedElement", is_abstract=True)
core_ContractualElement = Class(name="core_ContractualElement", is_abstract=True)
IdentifiedElement = Class(name="IdentifiedElement")
core_Uncertainty = Class(name="core_Uncertainty")
core_StakeHolder = Class(name="core_StakeHolder")
core_EObject = Class(name="core_EObject")
core_Category = Class(name="core_Category")
core_ReferencedModelElements = Class(name="core_ReferencedModelElements", is_abstract=True)
core_Rationale = Class(name="core_Rationale")
core_Actor = Class(name="core_Actor")
core_Expression = Class(name="core_Expression")
core_SystemOverview = Class(name="core_SystemOverview")
core_RequirementsGroup = Class(name="core_RequirementsGroup")
core_VerificationActivity = Class(name="core_VerificationActivity")
core_VerifiableElement = Class(name="core_VerifiableElement", is_abstract=True)
ContractualElement = Class(name="ContractualElement")
core_Specification = Class(name="core_Specification")
VerifiableElement = Class(name="VerifiableElement")
core_Variable = Class(name="core_Variable")
core_Interaction = Class(name="core_Interaction")
core_Conflict = Class(name="core_Conflict")
core_ConstraintLanguagesSpecification = Class(name="core_ConstraintLanguagesSpecification")
core_Goal = Class(name="core_Goal")
core_SystemContext = Class(name="core_SystemContext")
core_AbstractRequirement = Class(name="core_AbstractRequirement", is_abstract=True)
core_Requirement = Class(name="core_Requirement")
AbstractRequirement = Class(name="AbstractRequirement")
core_Assumption = Class(name="core_Assumption")
Actor = Class(name="Actor")
core_RefExpressionCollectedModelElements = Class(name="core_RefExpressionCollectedModelElements")
ReferencedModelElements = Class(name="ReferencedModelElements")
core_Trace = Class(name="core_Trace")
core_FormalLanguageExpression = Class(name="core_FormalLanguageExpression")
core_RefUserSelectedModelElements = Class(name="core_RefUserSelectedModelElements")
core_ModelElementReference = Class(name="core_ModelElementReference")
core_RefDerivedModelElements = Class(name="core_RefDerivedModelElements")
core_TraceModelElementReference = Class(name="core_TraceModelElementReference")
ModelElementReference = Class(name="ModelElementReference")
RequirementsCoverageData = Class(name="RequirementsCoverageData")
core_RequirementsCoverageData = Class(name="core_RequirementsCoverageData")
...
core_IdentifiedElement.attributes={core_IdentifiedElement_description, core_IdentifiedElement_name, core_IdentifiedElement_id}
...
core_ContractualElement.attributes={core_ContractualElement_originDate, core_ContractualElement_droppingReason, core_ContractualElement_sources, core_ContractualElement_satisfactionLevel, core_ContractualElement_timeCriticality, core_ContractualElement_dropped, core_ContractualElement_scheduleDate}
...
core_Uncertainty.attributes={core_Uncertainty_riskIndex, core_Uncertainty_maturityIndex, core_Uncertainty_costsImpact, core_Uncertainty_volatility, core_Uncertainty_precedence, core_Uncertainty_propRiskIndex, core_Uncertainty_scheduleImpact}
...
core_Actor.attributes={core_Actor_email, core_Actor_phoneNumber, core_Actor_address}
...
core_VerificationActivity.attributes={core_VerificationActivity_verificationMethod, core_VerificationActivity_passed}
...
core_Trace_m_modelElementReference: Method = Method(name="modelElementReference", parameters={Parameter(name='core_modelElement', type=StringType)}, type=StringType)
...
core_ModelElementReference.attributes={core_ModelElementReference_verifies, core_ModelElementReference_satisfactionLevel, core_ModelElementReference_weight, core_ModelElementReference_reason}
...
core_TraceModelElementReference_m_merge: Method = Method(name="merge", parameters={Parameter(name='core_modelElementReference', type=StringType)})
...
core_RequirementsCoverageData.attributes={core_RequirementsCoverageData_nbRequirements, core_RequirementsCoverageData_verificationLevel}
...
requirements100: BinaryAssociation = BinaryAssociation(
    name="requirements100",
    ends={
...
requirement103: BinaryAssociation = BinaryAssociation(
    name="requirement103",
    ends={
        Property(name="AbstractRequirement104", type=core_VerificationActivity, multiplicity=Multiplicity(1, 1)),
        Property(name="verifiedBy", type=core_AbstractRequirement, multiplicity=Multiplicity(0, 1))
    }
)
externalRef105: BinaryAssociation = BinaryAssociation(
    name="externalRef105",
    ends={
        Property(name="core_EObject107", type=core_VerificationActivity, multiplicity=Multiplicity(1, 1)),
        Property(name="core_VerificationActivity106", type=core_EObject, multiplicity=Multiplicity(0, 9999))
    }
)
imageRequirement101: BinaryAssociation = BinaryAssociation(
    name="imageRequirement101",
    ends={
        Property(name="Requirement102", type=core_Assumption, multiplicity=Multiplicity(1, 1)),
        Property(name="imageAssumption", type=core_Requirement, multiplicity=Multiplicity(0, 1))
    }
)
modelElementReferences109: BinaryAssociation = BinaryAssociation(
    name="modelElementReferences109",
    ends={
...
modelElement110: BinaryAssociation = BinaryAssociation(
    name="modelElement110",
    ends={
        Property(name="core_EObject111", type=core_ModelElementReference, multiplicity=Multiplicity(1, 1)),
...
specifications113: BinaryAssociation = BinaryAssociation(
    name="specifications113",
    ends={
        Property(name="core_Specification114", type=core_Trace, multiplicity=Multiplicity(1, 1)),
        Property(name="core_Trace", type=core_Specification, multiplicity=Multiplicity(0, 9999))
    }
)
queryExpression108: BinaryAssociation = BinaryAssociation(
    name="queryExpression108",
    ends={
...
feature115: BinaryAssociation = BinaryAssociation(
    name="feature115",
    ends={
        Property(name="core_EObject117", type=core_Variable, multiplicity=Multiplicity(1, 1)),
        Property(name="core_Variable116", type=core_EObject, multiplicity=Multiplicity(1, 1))
    }
)
contract118: BinaryAssociation = BinaryAssociation(
    name="contract118",
    ends={
        Property(name="ContractualElement119", type=core_Rationale, multiplicity=Multiplicity(1, 1)),
...
domain_model = DomainModel(
    name="core",
    types={core_IdentifiedElement, core_ContractualElement, IdentifiedElement, core_Uncertainty, core_StakeHolder, core_EObject, core_Category, core_ReferencedModelElements, core_Rationale, core_Actor, core_Expression, core_SystemOverview, core_RequirementsGroup, core_VerificationActivity, core_VerifiableElement, ContractualElement, core_Specification, VerifiableElement, core_Variable, core_Interaction, core_Conflict, core_ConstraintLanguagesSpecification, core_Goal, core_SystemContext, core_AbstractRequirement, core_Requirement, AbstractRequirement, core_Assumption, Actor, core_RefExpressionCollectedModelElements, ReferencedModelElements, core_Trace, core_FormalLanguageExpression, core_RefUserSelectedModelElements, core_ModelElementReference, core_RefDerivedModelElements, core_TraceModelElementReference, ModelElementReference, RequirementsCoverageData, core_RequirementsCoverageData, Direction, RiskKind, VerificationMethod, AssumptionType, VariableType, AgregationType},
    associations={agents11, derivedFrom14, changeUncertainty0, stakeholders1, evolvedTo3, tracedTo5, category7, satisfiedBy9, rationales17, contactInformation18, expression20, condition22, modes25, actors28, systOverview30, requirementGroups32, verificationActivities33, systemBoundary52, globalSystem54, actors57, systemBoundary60, systemModes63, images66, interactions69, entity71, conflicts74, conflicts35, constraintLanguagesSpecification37, goals75, specifies39, primaryActors42, goals45, systemToBe47, contexts50, requirements78, specification79, containedRequirements81, verifiedBy82, group83, assignedVariable85, conditionVariables88, refinedBY92, assumptions93, imageAssumption95, contractualElements76, rationales77, derivations98, requirements100, requirement103, externalRef105, imageRequirement101, modelElementReferences109, modelElement110, parent112, specifications113, queryExpression108, feature115, contract118},
    generalizations={gen_core_ContractualElement_IdentifiedElement, gen_core_Uncertainty_IdentifiedElement, gen_core_VerifiableElement_ContractualElement, gen_core_Specification_VerifiableElement, gen_core_SystemContext_IdentifiedElement, gen_core_Actor_IdentifiedElement, gen_core_Interaction_IdentifiedElement, gen_core_Goal_ContractualElement, gen_core_Conflict_IdentifiedElement, gen_core_SystemOverview_ContractualElement, gen_core_AbstractRequirement_VerifiableElement, gen_core_Requirement_AbstractRequirement, gen_core_StakeHolder_Actor, gen_core_RequirementsGroup_VerifiableElement, gen_core_Assumption_AbstractRequirement, gen_core_VerificationActivity_IdentifiedElement, gen_core_RefExpressionCollectedModelElements_ReferencedModelElements, gen_core_ModelElementReference_IdentifiedElement, gen_core_Trace_ReferencedModelElements, gen_core_RefUserSelectedModelElements_ReferencedModelElements, gen_core_ReferencedModelElements_IdentifiedElement, gen_core_RefDerivedModelElements_ReferencedModelElements, gen_core_Rationale_IdentifiedElement, gen_core_TraceModelElementReference_ModelElementReference, gen_core_TraceModelElementReference_RequirementsCoverageData, gen_core_RequirementsCoverageData_IdentifiedElement, gen_core_Variable_IdentifiedElement},
    metadata=None
)
