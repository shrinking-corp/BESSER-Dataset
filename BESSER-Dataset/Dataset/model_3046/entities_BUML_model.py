...
# Classes
entities_DomainModel = Class(name="entities_DomainModel")
entities_Entity = Class(name="entities_Entity")
entities_Feature = Class(name="entities_Feature")
...
domain_model = DomainModel(
    name="entities",
    types={entities_DomainModel, entities_Entity, entities_Feature},
    associations={entities0, superType2, features4, type6},
    generalizations={},
    metadata=None
)
