...
class entities_Entity:
    ...
    def __init__(self, name: str, entities_Entity: "entities_DomainModel" = None, entities_Entity3: "entities_Entity" = None, entities_Entity1: "entities_Entity" = None, entities_Entity5: set["entities_Feature"] = None, entities_Entity8: "entities_Feature" = None):
        self.name = name
