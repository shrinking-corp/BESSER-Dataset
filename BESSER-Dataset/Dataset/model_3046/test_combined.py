...
def test_hyp_entities_feature_is_not_abstract():
    assert not inspect.isabstract(entities_Feature)


def test_hyp_entities_feature_constructor_exists():
    assert callable(entities_Feature.__init__)


def test_hyp_entities_feature_constructor_args():
...
def test_hyp_entities_domainmodel_is_not_abstract():
    assert not inspect.isabstract(entities_DomainModel)


def test_hyp_entities_domainmodel_constructor_exists():
    assert callable(entities_DomainModel.__init__)


def test_hyp_entities_domainmodel_constructor_args():
...
def test_hyp_entities_feature_name_setter(instance):
...
@given(instance=entities_Feature_strategy)
def test_hyp_entities_feature_many_setter(instance):
