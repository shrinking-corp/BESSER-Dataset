...
class guigraph_Transition(GuiGraphNode, rules_IRealTimeConsumer):
...
class guigraph_ConditionActionTransition(Transition):
    ...
    @property
    def applicationConditionText(self):
