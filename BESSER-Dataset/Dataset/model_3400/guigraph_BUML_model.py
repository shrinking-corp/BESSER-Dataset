...
guigraph_Page = Class(name="guigraph_Page")
...
guigraph_Transition.attributes={guigraph_Transition_faultProbability, guigraph_Transition_timeMin, guigraph_Transition_rate, guigraph_Transition_timeMax, guigraph_Transition_terminates, guigraph_Transition_faultImpact, guigraph_Transition_timingType}
...
domain_model = DomainModel(
    name="guigraph",
    types={guigraph_Arc, guigraph_GuiGraph, AbstractModelElement, guigraph_ConditionActionTransition, Transition, guigraph_PreGenerationSequence, guigraph_GuiGraphNode, guigraph_TimerTransition, Predicate, ITimeConsumer, guigraph_Page, GuiGraph, guigraph_Widget, guigraph_Form, Widget, Place, guigraph_Transition, GuiGraphNode, rules_IRealTimeConsumer, guigraph_NoWidgetNode, guigraph_Place, guigraph_StandardArc, Arc, guigraph_InhibitorArc, guigraph_PageTransition, TimingType},
    associations={arcs0, applicationCondition7, actions9, nodes1, invariant3, consumer11, source12, target15, children6, page18},
    generalizations={gen_guigraph_GuiGraph_AbstractModelElement, gen_guigraph_ConditionActionTransition_Transition, gen_guigraph_TimerTransition_Transition, gen_guigraph_Arc_AbstractModelElement, gen_guigraph_Page_GuiGraph, gen_guigraph_Widget_AbstractModelElement, gen_guigraph_Form_Widget, gen_guigraph_Form_Place, gen_guigraph_Transition_GuiGraphNode, gen_guigraph_Transition_rules_IRealTimeConsumer, gen_guigraph_GuiGraphNode_AbstractModelElement, gen_guigraph_NoWidgetNode_Place, gen_guigraph_Place_GuiGraphNode, gen_guigraph_StandardArc_Arc, gen_guigraph_InhibitorArc_Arc, gen_guigraph_PageTransition_Transition},
    metadata=None
)
