...
# Classes
roc_Action = Class(name="roc_Action")
roc_Speed = Class(name="roc_Speed")
roc_EObject = Class(name="roc_EObject")
roc_CompleteAction = Class(name="roc_CompleteAction")
roc_SingleAction = Class(name="roc_SingleAction")
roc_DirectedAction = Class(name="roc_DirectedAction")
roc_Program = Class(name="roc_Program")
roc_Movement = Class(name="roc_Movement")
roc_Motion = Class(name="roc_Motion")
roc_LeftRightDirectedAction = Class(name="roc_LeftRightDirectedAction")
roc_LeftRightDirection = Class(name="roc_LeftRightDirection")
roc_FullDirectedAction = Class(name="roc_FullDirectedAction")
roc_Direction = Class(name="roc_Direction")
...
roc_Speed.attributes={roc_Speed_FAST, roc_Speed_SLOWEST, roc_Speed_FULL, roc_Speed_SLOW, roc_Speed_NORMAL}
...
roc_Direction.attributes={roc_Direction_UP, roc_Direction_LEFT, roc_Direction_DOWN, roc_Direction_RIGHT}
...
domain_model = DomainModel(
    name="roc",
    types={roc_Action, roc_Speed, roc_EObject, roc_CompleteAction, roc_SingleAction, roc_DirectedAction, roc_Program, roc_Movement, roc_Motion, roc_LeftRightDirectedAction, roc_LeftRightDirection, roc_FullDirectedAction, roc_Direction, Intensity, DurationUnit},
    associations={action3, speed5, actionHolder7, movements0, motions1, actionName9, direction11},
    generalizations={},
    metadata=None
)
