...
class roc_Direction:
    ...
    def __init__(self, RIGHT: str, UP: str, DOWN: str, LEFT: str):
        self.RIGHT = RIGHT
        self.UP = UP
        self.DOWN = DOWN
        self.LEFT = LEFT
...
class roc_Motion:
    ...
    def __init__(self, duration: str, durationUnit: str, roc_Motion4: "roc_Action" = None, roc_Motion6: "roc_Speed" = None, roc_Motion: "roc_Movement" = None):
