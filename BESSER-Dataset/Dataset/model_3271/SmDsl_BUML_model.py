...
# Classes
smDsl_State = Class(name="smDsl_State")
smDsl_Event = Class(name="smDsl_Event")
smDsl_Command = Class(name="smDsl_Command")
smDsl_EventHandlingDescription = Class(name="smDsl_EventHandlingDescription")
smDsl_Model = Class(name="smDsl_Model")
smDsl_EventsSection = Class(name="smDsl_EventsSection")
smDsl_CommandsSection = Class(name="smDsl_CommandsSection")
...
smDsl_State.attributes={smDsl_State_name, smDsl_State_initial}
...
domain_model = DomainModel(
    name="smDsl",
    types={smDsl_State, smDsl_Event, smDsl_Command, smDsl_EventHandlingDescription, smDsl_Model, smDsl_EventsSection, smDsl_CommandsSection},
    associations={states3, events5, commands7, entryCommands9, eventHandlingDescriptions12, exitCommands14, event17, commands20, targetState23, eventsSection0, commandsSection1},
    generalizations={},
    metadata=None
)
