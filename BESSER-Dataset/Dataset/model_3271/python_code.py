...
class smDsl_Model:
    ...
    def __init__(self, name: str, smDsl_Model4: set["smDsl_State"] = None, smDsl_Model: "smDsl_EventsSection" = None, smDsl_Model2: "smDsl_CommandsSection" = None):
        self.name = name
...
class smDsl_Command:
    ...
    def __init__(self, name: str, smDsl_Command: "smDsl_CommandsSection" = None, smDsl_Command11: "smDsl_State" = None, smDsl_Command16: "smDsl_State" = None, smDsl_Command22: "smDsl_EventHandlingDescription" = None):
        self.name = name
...
class smDsl_Event:
    ...
    def __init__(self, name: str, smDsl_Event: "smDsl_EventsSection" = None, smDsl_Event19: "smDsl_EventHandlingDescription" = None):
        self.name = name
