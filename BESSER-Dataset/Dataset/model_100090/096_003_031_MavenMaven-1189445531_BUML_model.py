...
MavenMaven_Mapper.attributes={MavenMaven_Mapper_from_, MavenMaven_Mapper_classpathref, MavenMaven_Mapper_type, MavenMaven_Mapper_classname, MavenMaven_Mapper_to, MavenMaven_Mapper_classpath}
...
MavenMaven_InExcludes.attributes={MavenMaven_InExcludes_name, MavenMaven_InExcludes_unless, MavenMaven_InExcludes_ifCondition}
...
MavenMaven_PreDefinedTask.attributes={MavenMaven_PreDefinedTask_taskname, MavenMaven_PreDefinedTask_description, MavenMaven_PreDefinedTask_id}
...
MavenMaven_FormatTstamp.attributes={MavenMaven_FormatTstamp_offset, MavenMaven_FormatTstamp_locale, MavenMaven_FormatTstamp_property, MavenMaven_FormatTstamp_pattern, MavenMaven_FormatTstamp_unit}
...
MavenMaven_Javac.attributes={MavenMaven_Javac_destdir, MavenMaven_Javac_debug, MavenMaven_Javac_optimize, MavenMaven_Javac_srcdir, MavenMaven_Javac_deprecation, MavenMaven_Javac_fork}
...
MavenMaven_Javadoc.attributes={MavenMaven_Javadoc_author, MavenMaven_Javadoc_defaultexcludes, MavenMaven_Javadoc_packagenames, MavenMaven_Javadoc_destdir, MavenMaven_Javadoc_sourcepath, MavenMaven_Javadoc_windowtitle, MavenMaven_Javadoc_use, MavenMaven_Javadoc_version}
...
MavenMaven_Jar.attributes={MavenMaven_Jar_compress, MavenMaven_Jar_manifest, MavenMaven_Jar_jarfile, MavenMaven_Jar_basedir, MavenMaven_Jar_encoding}
...
MavenMaven_Copy.attributes={MavenMaven_Copy_tofile, MavenMaven_Copy_presservelastmodified, MavenMaven_Copy_filtering, MavenMaven_Copy_todir, MavenMaven_Copy_overwrite, MavenMaven_Copy_file, MavenMaven_Copy_flatten, MavenMaven_Copy_includeEmptyDirs}
...
MavenMaven_Delete.attributes={MavenMaven_Delete_defaultexcludes, MavenMaven_Delete_failonerror, MavenMaven_Delete_excludesfile, MavenMaven_Delete_excludes, MavenMaven_Delete_dir, MavenMaven_Delete_quiet, MavenMaven_Delete_verbose, MavenMaven_Delete_includes, MavenMaven_Delete_file, MavenMaven_Delete_includesfile, MavenMaven_Delete_includeEmptyDirs}
...
domain_model = DomainModel(
    name="MavenMaven",
    types={PrePostGoal, MavenMaven_Xmlns, MavenMaven_Project, Xmlns, Goal, Path, AntProperty, AntTaskDef, MavenMaven_PreGoal, MavenMaven_PostGoal, MavenMaven_AntProperty, ContentsGoal, MavenMaven_AntPropertyName, MavenMaven_AntPropertyValue, AntPropertyName, MavenMaven_AntPropertyLocation, MavenMaven_AntPropertyFile, MavenMaven_AntPropertyEnv, MavenMaven_JellyCommand, MavenMaven_JellySet, JellyCommand, MavenMaven_AbstractGoal, MavenMaven_ContentsGoal, MavenMaven_AttainGoal, MavenMaven_PrePostGoal, AbstractGoal, MavenMaven_Filter, MavenMaven_FiltersFile, MavenMaven_PathElement, MavenMaven_Goal, PreGoal, PostGoal, MavenMaven_Pattern, MavenMaven_Basic, Pattern, MavenMaven_Mapper, Basic, MavenMaven_InExcludes, MavenMaven_Includes, InExcludes, MavenMaven_Excludes, MavenMaven_IncludesFile, MavenMaven_ExcludesFile, MavenMaven_FileList, FileSet, MavenMaven_ClassPath, MavenMaven_Set, MavenMaven_PatternSet, Set, MavenMaven_FileSet, PatternSet, Includes, Excludes, MavenMaven_FilterSet, Filter, FiltersFile, MavenMaven_Path, PathElement, MavenMaven_MiscellaneousTask, MavenMaven_Echo, MiscellaneousTask, MavenMaven_Tstamp, MavenMaven_Task, FormatTstamp, MavenMaven_AntTaskDef, MavenMaven_NewTask, Task, Attribut, MavenMaven_Attribut, MavenMaven_PreDefinedTask, MavenMaven_ExecutionTask, PreDefinedTask, MavenMaven_Exec, ExecutionTask, MavenMaven_Java, ClassPath, MavenMaven_ArchiveTask, MavenMaven_FormatTstamp, MavenMaven_CompileTask, MavenMaven_Javac, CompileTask, MavenMaven_DocumentationTask, MavenMaven_Javadoc, DocumentationTask, MavenMaven_Jar, ArchiveTask, MavenMaven_FileTask, MavenMaven_Mkdir, FileTask, MavenMaven_Copy, FilterSet, Mapper, MavenMaven_Delete},
    associations={prePostGoals9, goals11, xmlns0, default1, path3, properties5, taskdefs7, centralGoal17, centralGoal19, contentsGoal14, attainGoal15, preGoal21, postGoal22, fileset37, pathElement39, inexcludes24, patternset25, include26, exclude28, filter30, filtersfile31, path33, pathElement35, classPath48, fileset41, format49, taskName44, attributes46, inExcludes50, classPath52, fileset55, filterset57, mapper59},
    generalizations={gen_MavenMaven_PreGoal_PrePostGoal, gen_MavenMaven_PostGoal_PrePostGoal, gen_MavenMaven_AntProperty_ContentsGoal, gen_MavenMaven_AntPropertyName_AntProperty, gen_MavenMaven_AntPropertyValue_AntPropertyName, gen_MavenMaven_AntPropertyLocation_AntPropertyName, gen_MavenMaven_AntPropertyFile_AntProperty, gen_MavenMaven_AntPropertyEnv_AntProperty, gen_MavenMaven_JellyCommand_ContentsGoal, gen_MavenMaven_JellySet_JellyCommand, gen_MavenMaven_AttainGoal_ContentsGoal, gen_MavenMaven_PrePostGoal_AbstractGoal, gen_MavenMaven_Filter_Basic, gen_MavenMaven_FiltersFile_Basic, gen_MavenMaven_PathElement_Basic, gen_MavenMaven_Goal_AbstractGoal, gen_MavenMaven_Basic_Pattern, gen_MavenMaven_Mapper_Basic, gen_MavenMaven_InExcludes_Basic, gen_MavenMaven_Includes_InExcludes, gen_MavenMaven_Excludes_InExcludes, gen_MavenMaven_IncludesFile_InExcludes, gen_MavenMaven_ExcludesFile_InExcludes, gen_MavenMaven_FileList_Basic, gen_MavenMaven_ClassPath_Set, gen_MavenMaven_Set_Pattern, gen_MavenMaven_PatternSet_Set, gen_MavenMaven_FileSet_Set, gen_MavenMaven_FilterSet_Set, gen_MavenMaven_Path_Set, gen_MavenMaven_MiscellaneousTask_PreDefinedTask, gen_MavenMaven_Echo_MiscellaneousTask, gen_MavenMaven_Tstamp_MiscellaneousTask, gen_MavenMaven_Task_ContentsGoal, gen_MavenMaven_AntTaskDef_ContentsGoal, gen_MavenMaven_NewTask_Task, gen_MavenMaven_PreDefinedTask_Task, gen_MavenMaven_ExecutionTask_PreDefinedTask, gen_MavenMaven_Exec_ExecutionTask, gen_MavenMaven_Java_ExecutionTask, gen_MavenMaven_CompileTask_PreDefinedTask, gen_MavenMaven_Javac_CompileTask, gen_MavenMaven_DocumentationTask_PreDefinedTask, gen_MavenMaven_Javadoc_DocumentationTask, gen_MavenMaven_ArchiveTask_PreDefinedTask, gen_MavenMaven_Jar_ArchiveTask, gen_MavenMaven_FileTask_PreDefinedTask, gen_MavenMaven_Mkdir_FileTask, gen_MavenMaven_Copy_FileTask, gen_MavenMaven_Delete_FileTask},
    metadata=None
)
