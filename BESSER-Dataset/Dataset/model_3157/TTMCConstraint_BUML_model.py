...
# Classes
TTMCConstraint_Type = Class(name="TTMCConstraint_Type")
TTMCConstraint_DefinableDeclaration = Class(name="TTMCConstraint_DefinableDeclaration", is_abstract=True)
Declaration = Class(name="Declaration")
TTMCConstraint_FieldDeclaration = Class(name="TTMCConstraint_FieldDeclaration")
TTMCConstraint_LetDeclaration = Class(name="TTMCConstraint_LetDeclaration")
DefinableDeclaration = Class(name="DefinableDeclaration")
TTMCConstraint_NamedElement = Class(name="TTMCConstraint_NamedElement", is_abstract=True)
TTMCConstraint_ParametricElement = Class(name="TTMCConstraint_ParametricElement", is_abstract=True)
TTMCConstraint_ParameterDeclaration = Class(name="TTMCConstraint_ParameterDeclaration")
TTMCConstraint_ParametrizedElement = Class(name="TTMCConstraint_ParametrizedElement")
TTMCConstraint_Expression = Class(name="TTMCConstraint_Expression", is_abstract=True)
TTMCConstraint_ConstraintSpecification = Class(name="TTMCConstraint_ConstraintSpecification")
NamedElement = Class(name="NamedElement")
ParametricElement = Class(name="ParametricElement")
TTMCConstraint_TypeDeclaration = Class(name="TTMCConstraint_TypeDeclaration")
TTMCConstraint_ConstantDeclaration = Class(name="TTMCConstraint_ConstantDeclaration")
TTMCConstraint_FunctionDeclaration = Class(name="TTMCConstraint_FunctionDeclaration")
TTMCConstraint_BasicConstraintDefinition = Class(name="TTMCConstraint_BasicConstraintDefinition")
TTMCConstraint_Declaration = Class(name="TTMCConstraint_Declaration", is_abstract=True)
TTMCConstraint_FunctionTypeDefinition = Class(name="TTMCConstraint_FunctionTypeDefinition")
TTMCConstraint_ArrayTypeDefinition = Class(name="TTMCConstraint_ArrayTypeDefinition")
TTMCConstraint_TypeReference = Class(name="TTMCConstraint_TypeReference")
Type = Class(name="Type")
TTMCConstraint_TypeDefinition = Class(name="TTMCConstraint_TypeDefinition")
TTMCConstraint_BasicTypeDefinition = Class(name="TTMCConstraint_BasicTypeDefinition", is_abstract=True)
TypeDefinition = Class(name="TypeDefinition")
TTMCConstraint_IntegerTypeDefinition = Class(name="TTMCConstraint_IntegerTypeDefinition")
BasicTypeDefinition = Class(name="BasicTypeDefinition")
TTMCConstraint_NaturalTypeDefinition = Class(name="TTMCConstraint_NaturalTypeDefinition")
TTMCConstraint_BooleanTypeDefinition = Class(name="TTMCConstraint_BooleanTypeDefinition")
TTMCConstraint_RealTypeDefinition = Class(name="TTMCConstraint_RealTypeDefinition")
TTMCConstraint_SubrangeTypeDefinition = Class(name="TTMCConstraint_SubrangeTypeDefinition")
TTMCConstraint_SubTypeDefinition = Class(name="TTMCConstraint_SubTypeDefinition")
TTMCConstraint_EnumerationTypeDefinition = Class(name="TTMCConstraint_EnumerationTypeDefinition")
TTMCConstraint_EnumerationLiteralDefinition = Class(name="TTMCConstraint_EnumerationLiteralDefinition")
TTMCConstraint_BooleanExpression = Class(name="TTMCConstraint_BooleanExpression", is_abstract=True)
TTMCConstraint_QuantifierExpression = Class(name="TTMCConstraint_QuantifierExpression", is_abstract=True)
UnaryExpression = Class(name="UnaryExpression")
TTMCConstraint_TemporalExpression = Class(name="TTMCConstraint_TemporalExpression", is_abstract=True)
TTMCConstraint_TemporalPathExpression = Class(name="TTMCConstraint_TemporalPathExpression", is_abstract=True)
TemporalExpression = Class(name="TemporalExpression")
TTMCConstraint_TemporalStateExpression = Class(name="TTMCConstraint_TemporalStateExpression", is_abstract=True)
TTMCConstraint_LiteralExpression = Class(name="TTMCConstraint_LiteralExpression", is_abstract=True)
TTMCConstraint_ArithmeticLiteralExpression = Class(name="TTMCConstraint_ArithmeticLiteralExpression", is_abstract=True)
...
TTMCConstraint_TupleTypeDefinition = Class(name="TTMCConstraint_TupleTypeDefinition")
TTMCConstraint_RecordTypeDefinition = Class(name="TTMCConstraint_RecordTypeDefinition")
TTMCConstraint_ConstraintDefinition = Class(name="TTMCConstraint_ConstraintDefinition", is_abstract=True)
ConstraintDefinition = Class(name="ConstraintDefinition")
TTMCConstraint_NullaryExpression = Class(name="TTMCConstraint_NullaryExpression", is_abstract=True)
Expression = Class(name="Expression")
TTMCConstraint_UnaryExpression = Class(name="TTMCConstraint_UnaryExpression", is_abstract=True)
TTMCConstraint_BinaryExpression = Class(name="TTMCConstraint_BinaryExpression", is_abstract=True)
TTMCConstraint_MultiaryExpression = Class(name="TTMCConstraint_MultiaryExpression", is_abstract=True)
TTMCConstraint_PredicateExpression = Class(name="TTMCConstraint_PredicateExpression", is_abstract=True)
TTMCConstraint_ArithmeticExpression = Class(name="TTMCConstraint_ArithmeticExpression", is_abstract=True)
TTMCConstraint_AccessExpression = Class(name="TTMCConstraint_AccessExpression", is_abstract=True)
TTMCConstraint_ReferenceExpression = Class(name="TTMCConstraint_ReferenceExpression")
TTMCConstraint_IfThenElseExpression = Class(name="TTMCConstraint_IfThenElseExpression")
TTMCConstraint_IntegerLiteralExpression = Class(name="TTMCConstraint_IntegerLiteralExpression")
ArithmeticLiteralExpression = Class(name="ArithmeticLiteralExpression")
TTMCConstraint_DecimalLiteralExpression = Class(name="TTMCConstraint_DecimalLiteralExpression")
TTMCConstraint_RationalLiteralExpression = Class(name="TTMCConstraint_RationalLiteralExpression")
TTMCConstraint_BooleanLiteralExpression = Class(name="TTMCConstraint_BooleanLiteralExpression", is_abstract=True)
BooleanExpression = Class(name="BooleanExpression")
TTMCConstraint_TrueExpression = Class(name="TTMCConstraint_TrueExpression")
BooleanLiteralExpression = Class(name="BooleanLiteralExpression")
TTMCConstraint_FalseExpression = Class(name="TTMCConstraint_FalseExpression")
TTMCConstraint_ArrayLiteralExpression = Class(name="TTMCConstraint_ArrayLiteralExpression")
TTMCConstraint_FunctionLiteralExpression = Class(name="TTMCConstraint_FunctionLiteralExpression")
TTMCConstraint_RecordLiteralExpression = Class(name="TTMCConstraint_RecordLiteralExpression")
TTMCConstraint_FieldAssignment = Class(name="TTMCConstraint_FieldAssignment")
TTMCConstraint_EnumerationLiteralExpression = Class(name="TTMCConstraint_EnumerationLiteralExpression")
TTMCConstraint_TupleLiteralExpression = Class(name="TTMCConstraint_TupleLiteralExpression")
TTMCConstraint_ComparisionExpression = Class(name="TTMCConstraint_ComparisionExpression", is_abstract=True)
TTMCConstraint_GreaterExpression = Class(name="TTMCConstraint_GreaterExpression")
ComparisionExpression = Class(name="ComparisionExpression")
TTMCConstraint_GreaterEqualExpression = Class(name="TTMCConstraint_GreaterEqualExpression")
TTMCConstraint_LessExpression = Class(name="TTMCConstraint_LessExpression")
TTMCConstraint_LessEqualExpression = Class(name="TTMCConstraint_LessEqualExpression")
TTMCConstraint_AddExpression = Class(name="TTMCConstraint_AddExpression")
TTMCConstraint_SubtractExpression = Class(name="TTMCConstraint_SubtractExpression")
TTMCConstraint_MultiplyExpression = Class(name="TTMCConstraint_MultiplyExpression")
TTMCConstraint_DivideExpression = Class(name="TTMCConstraint_DivideExpression")
TTMCConstraint_LetExpression = Class(name="TTMCConstraint_LetExpression")
TTMCConstraint_EqualExpression = Class(name="TTMCConstraint_EqualExpression")
BinaryExpression = Class(name="BinaryExpression")
TTMCConstraint_ImplyExpression = Class(name="TTMCConstraint_ImplyExpression")
TTMCConstraint_OrExpression = Class(name="TTMCConstraint_OrExpression")
MultiaryExpression = Class(name="MultiaryExpression")
TTMCConstraint_AndExpression = Class(name="TTMCConstraint_AndExpression")
TTMCConstraint_ReleaseExpression = Class(name="TTMCConstraint_ReleaseExpression")
TemporalPathExpression = Class(name="TemporalPathExpression")
TTMCConstraint_UntilExpression = Class(name="TTMCConstraint_UntilExpression")
TTMCConstraint_NotExpression = Class(name="TTMCConstraint_NotExpression")
TTMCConstraint_ForallExpression = Class(name="TTMCConstraint_ForallExpression")
QuantifierExpression = Class(name="QuantifierExpression")
TTMCConstraint_ExistsExpression = Class(name="TTMCConstraint_ExistsExpression")
TTMCConstraint_GloballyExpression = Class(name="TTMCConstraint_GloballyExpression")
TTMCConstraint_FinallyExpression = Class(name="TTMCConstraint_FinallyExpression")
TTMCConstraint_NextExpression = Class(name="TTMCConstraint_NextExpression")
TTMCConstraint_TemporalForallExpression = Class(name="TTMCConstraint_TemporalForallExpression")
TemporalStateExpression = Class(name="TemporalStateExpression")
TTMCConstraint_TemporalExistsExpression = Class(name="TTMCConstraint_TemporalExistsExpression")
TTMCConstraint_InExpression = Class(name="TTMCConstraint_InExpression")
PredicateExpression = Class(name="PredicateExpression")
TTMCConstraint_PrimedExpression = Class(name="TTMCConstraint_PrimedExpression")
TTMCConstraint_EquivalenceExpression = Class(name="TTMCConstraint_EquivalenceExpression", is_abstract=True)
TTMCConstraint_EqualityExpression = Class(name="TTMCConstraint_EqualityExpression")
EquivalenceExpression = Class(name="EquivalenceExpression")
TTMCConstraint_InequalityExpression = Class(name="TTMCConstraint_InequalityExpression")
TTMCConstraint_DivExpression = Class(name="TTMCConstraint_DivExpression")
TTMCConstraint_ModExpression = Class(name="TTMCConstraint_ModExpression")
TTMCConstraint_UnaryMinusExpression = Class(name="TTMCConstraint_UnaryMinusExpression")
TTMCConstraint_UnaryPlusExpression = Class(name="TTMCConstraint_UnaryPlusExpression")
TTMCConstraint_FunctionAccessExpression = Class(name="TTMCConstraint_FunctionAccessExpression")
AccessExpression = Class(name="AccessExpression")
ParametrizedElement = Class(name="ParametrizedElement")
TTMCConstraint_ArrayAccessExpression = Class(name="TTMCConstraint_ArrayAccessExpression")
TTMCConstraint_TupleAccessExpression = Class(name="TTMCConstraint_TupleAccessExpression")
TTMCConstraint_RecordAccessExpression = Class(name="TTMCConstraint_RecordAccessExpression")
...
else_71: BinaryAssociation = BinaryAssociation(
    name="else_71",
    ends={
...
domain_model = DomainModel(
    name="TTMCConstraint",
    types={TTMCConstraint_Type, TTMCConstraint_DefinableDeclaration, Declaration, TTMCConstraint_FieldDeclaration, TTMCConstraint_LetDeclaration, DefinableDeclaration, TTMCConstraint_NamedElement, TTMCConstraint_ParametricElement, TTMCConstraint_ParameterDeclaration, TTMCConstraint_ParametrizedElement, TTMCConstraint_Expression, TTMCConstraint_ConstraintSpecification, NamedElement, ParametricElement, TTMCConstraint_TypeDeclaration, TTMCConstraint_ConstantDeclaration, TTMCConstraint_FunctionDeclaration, TTMCConstraint_BasicConstraintDefinition, TTMCConstraint_Declaration, TTMCConstraint_FunctionTypeDefinition, TTMCConstraint_ArrayTypeDefinition, TTMCConstraint_TypeReference, Type, TTMCConstraint_TypeDefinition, TTMCConstraint_BasicTypeDefinition, TypeDefinition, TTMCConstraint_IntegerTypeDefinition, BasicTypeDefinition, TTMCConstraint_NaturalTypeDefinition, TTMCConstraint_BooleanTypeDefinition, TTMCConstraint_RealTypeDefinition, TTMCConstraint_SubrangeTypeDefinition, TTMCConstraint_SubTypeDefinition, TTMCConstraint_EnumerationTypeDefinition, TTMCConstraint_EnumerationLiteralDefinition, TTMCConstraint_BooleanExpression, TTMCConstraint_QuantifierExpression, UnaryExpression, TTMCConstraint_TemporalExpression, TTMCConstraint_TemporalPathExpression, TemporalExpression, TTMCConstraint_TemporalStateExpression, TTMCConstraint_LiteralExpression, TTMCConstraint_ArithmeticLiteralExpression, NullaryExpression, LiteralExpression, ArithmeticExpression, TTMCConstraint_TupleTypeDefinition, TTMCConstraint_RecordTypeDefinition, TTMCConstraint_ConstraintDefinition, ConstraintDefinition, TTMCConstraint_NullaryExpression, Expression, TTMCConstraint_UnaryExpression, TTMCConstraint_BinaryExpression, TTMCConstraint_MultiaryExpression, TTMCConstraint_PredicateExpression, TTMCConstraint_ArithmeticExpression, TTMCConstraint_AccessExpression, TTMCConstraint_ReferenceExpression, TTMCConstraint_IfThenElseExpression, TTMCConstraint_IntegerLiteralExpression, ArithmeticLiteralExpression, TTMCConstraint_DecimalLiteralExpression, TTMCConstraint_RationalLiteralExpression, TTMCConstraint_BooleanLiteralExpression, BooleanExpression, TTMCConstraint_TrueExpression, BooleanLiteralExpression, TTMCConstraint_FalseExpression, TTMCConstraint_ArrayLiteralExpression, TTMCConstraint_FunctionLiteralExpression, TTMCConstraint_RecordLiteralExpression, TTMCConstraint_FieldAssignment, TTMCConstraint_EnumerationLiteralExpression, TTMCConstraint_TupleLiteralExpression, TTMCConstraint_ComparisionExpression, TTMCConstraint_GreaterExpression, ComparisionExpression, TTMCConstraint_GreaterEqualExpression, TTMCConstraint_LessExpression, TTMCConstraint_LessEqualExpression, TTMCConstraint_AddExpression, TTMCConstraint_SubtractExpression, TTMCConstraint_MultiplyExpression, TTMCConstraint_DivideExpression, TTMCConstraint_LetExpression, TTMCConstraint_EqualExpression, BinaryExpression, TTMCConstraint_ImplyExpression, TTMCConstraint_OrExpression, MultiaryExpression, TTMCConstraint_AndExpression, TTMCConstraint_ReleaseExpression, TemporalPathExpression, TTMCConstraint_UntilExpression, TTMCConstraint_NotExpression, TTMCConstraint_ForallExpression, QuantifierExpression, TTMCConstraint_ExistsExpression, TTMCConstraint_GloballyExpression, TTMCConstraint_FinallyExpression, TTMCConstraint_NextExpression, TTMCConstraint_TemporalForallExpression, TemporalStateExpression, TTMCConstraint_TemporalExistsExpression, TTMCConstraint_InExpression, PredicateExpression, TTMCConstraint_PrimedExpression, TTMCConstraint_EquivalenceExpression, TTMCConstraint_EqualityExpression, EquivalenceExpression, TTMCConstraint_InequalityExpression, TTMCConstraint_DivExpression, TTMCConstraint_ModExpression, TTMCConstraint_UnaryMinusExpression, TTMCConstraint_UnaryPlusExpression, TTMCConstraint_FunctionAccessExpression, AccessExpression, ParametrizedElement, TTMCConstraint_ArrayAccessExpression, TTMCConstraint_TupleAccessExpression, TTMCConstraint_RecordAccessExpression},
    associations={type9, expression10, parameterDeclarations0, parameters1, typeDeclarations2, constantDeclarations3, functionDeclarations5, basicConstraintDefinitions7, parameterTypes28, returnType30, indexTypes33, type12, reference15, lowerBound17, upperBound19, parameterDeclaration22, expression24, literals27, elementType35, types38, fieldDeclarations40, expression41, operand43, leftOperand45, rightOperand47, operands50, operand52, declaration64, condition66, then68, else_71, returnType54, fieldAssignments56, value57, reference60, expressions62, letDeclarations74, expression75, type78},
    generalizations={gen_TTMCConstraint_DefinableDeclaration_Declaration, gen_TTMCConstraint_ParameterDeclaration_Declaration, gen_TTMCConstraint_FieldDeclaration_Declaration, gen_TTMCConstraint_LetDeclaration_DefinableDeclaration, gen_TTMCConstraint_ConstantDeclaration_DefinableDeclaration, gen_TTMCConstraint_ConstraintSpecification_NamedElement, gen_TTMCConstraint_ConstraintSpecification_ParametricElement, gen_TTMCConstraint_Declaration_NamedElement, gen_TTMCConstraint_FunctionTypeDefinition_TypeDefinition, gen_TTMCConstraint_ArrayTypeDefinition_TypeDefinition, gen_TTMCConstraint_FunctionDeclaration_DefinableDeclaration, gen_TTMCConstraint_FunctionDeclaration_ParametricElement, gen_TTMCConstraint_TypeDeclaration_NamedElement, gen_TTMCConstraint_TypeReference_Type, gen_TTMCConstraint_TypeDefinition_Type, gen_TTMCConstraint_BasicTypeDefinition_TypeDefinition, gen_TTMCConstraint_IntegerTypeDefinition_BasicTypeDefinition, gen_TTMCConstraint_NaturalTypeDefinition_BasicTypeDefinition, gen_TTMCConstraint_BooleanTypeDefinition_BasicTypeDefinition, gen_TTMCConstraint_RealTypeDefinition_BasicTypeDefinition, gen_TTMCConstraint_SubrangeTypeDefinition_TypeDefinition, gen_TTMCConstraint_SubTypeDefinition_TypeDefinition, gen_TTMCConstraint_SubTypeDefinition_ParametricElement, gen_TTMCConstraint_EnumerationTypeDefinition_TypeDefinition, gen_TTMCConstraint_EnumerationLiteralDefinition_NamedElement, gen_TTMCConstraint_BooleanExpression_Expression, gen_TTMCConstraint_QuantifierExpression_UnaryExpression, gen_TTMCConstraint_QuantifierExpression_ParametricElement, gen_TTMCConstraint_TemporalExpression_Expression, gen_TTMCConstraint_TemporalPathExpression_TemporalExpression, gen_TTMCConstraint_TemporalStateExpression_TemporalExpression, gen_TTMCConstraint_LiteralExpression_Expression, gen_TTMCConstraint_ArithmeticLiteralExpression_NullaryExpression, gen_TTMCConstraint_ArithmeticLiteralExpression_LiteralExpression, gen_TTMCConstraint_ArithmeticLiteralExpression_ArithmeticExpression, gen_TTMCConstraint_TupleTypeDefinition_TypeDefinition, gen_TTMCConstraint_RecordTypeDefinition_TypeDefinition, gen_TTMCConstraint_BasicConstraintDefinition_ConstraintDefinition, gen_TTMCConstraint_NullaryExpression_Expression, gen_TTMCConstraint_UnaryExpression_Expression, gen_TTMCConstraint_BinaryExpression_Expression, gen_TTMCConstraint_MultiaryExpression_Expression, gen_TTMCConstraint_PredicateExpression_Expression, gen_TTMCConstraint_ArithmeticExpression_Expression, gen_TTMCConstraint_AccessExpression_Expression, gen_TTMCConstraint_ReferenceExpression_NullaryExpression, gen_TTMCConstraint_IfThenElseExpression_Expression, gen_TTMCConstraint_IntegerLiteralExpression_ArithmeticLiteralExpression, gen_TTMCConstraint_DecimalLiteralExpression_ArithmeticLiteralExpression, gen_TTMCConstraint_RationalLiteralExpression_ArithmeticLiteralExpression, gen_TTMCConstraint_BooleanLiteralExpression_NullaryExpression, gen_TTMCConstraint_BooleanLiteralExpression_LiteralExpression, gen_TTMCConstraint_BooleanLiteralExpression_BooleanExpression, gen_TTMCConstraint_TrueExpression_BooleanLiteralExpression, gen_TTMCConstraint_FalseExpression_BooleanLiteralExpression, gen_TTMCConstraint_ArrayLiteralExpression_UnaryExpression, gen_TTMCConstraint_ArrayLiteralExpression_LiteralExpression, gen_TTMCConstraint_ArrayLiteralExpression_ParametricElement, gen_TTMCConstraint_FunctionLiteralExpression_UnaryExpression, gen_TTMCConstraint_FunctionLiteralExpression_LiteralExpression, gen_TTMCConstraint_FunctionLiteralExpression_ParametricElement, gen_TTMCConstraint_RecordLiteralExpression_LiteralExpression, gen_TTMCConstraint_EnumerationLiteralExpression_NullaryExpression, gen_TTMCConstraint_EnumerationLiteralExpression_LiteralExpression, gen_TTMCConstraint_TupleLiteralExpression_LiteralExpression, gen_TTMCConstraint_ComparisionExpression_PredicateExpression, gen_TTMCConstraint_ComparisionExpression_BinaryExpression, gen_TTMCConstraint_GreaterExpression_ComparisionExpression, gen_TTMCConstraint_GreaterEqualExpression_ComparisionExpression, gen_TTMCConstraint_LessExpression_ComparisionExpression, gen_TTMCConstraint_LessEqualExpression_ComparisionExpression, gen_TTMCConstraint_AddExpression_ArithmeticExpression, gen_TTMCConstraint_AddExpression_MultiaryExpression, gen_TTMCConstraint_SubtractExpression_ArithmeticExpression, gen_TTMCConstraint_SubtractExpression_BinaryExpression, gen_TTMCConstraint_MultiplyExpression_ArithmeticExpression, gen_TTMCConstraint_MultiplyExpression_MultiaryExpression, gen_TTMCConstraint_DivideExpression_ArithmeticExpression, gen_TTMCConstraint_DivideExpression_BinaryExpression, gen_TTMCConstraint_LetExpression_Expression, gen_TTMCConstraint_EqualExpression_BooleanExpression, gen_TTMCConstraint_EqualExpression_BinaryExpression, gen_TTMCConstraint_ImplyExpression_BooleanExpression, gen_TTMCConstraint_ImplyExpression_BinaryExpression, gen_TTMCConstraint_OrExpression_BooleanExpression, gen_TTMCConstraint_OrExpression_MultiaryExpression, gen_TTMCConstraint_AndExpression_BooleanExpression, gen_TTMCConstraint_AndExpression_MultiaryExpression, gen_TTMCConstraint_ReleaseExpression_TemporalPathExpression, gen_TTMCConstraint_ReleaseExpression_BinaryExpression, gen_TTMCConstraint_UntilExpression_TemporalPathExpression, gen_TTMCConstraint_UntilExpression_BinaryExpression, gen_TTMCConstraint_NotExpression_BooleanExpression, gen_TTMCConstraint_NotExpression_UnaryExpression, gen_TTMCConstraint_ForallExpression_QuantifierExpression, gen_TTMCConstraint_ExistsExpression_QuantifierExpression, gen_TTMCConstraint_GloballyExpression_TemporalPathExpression, gen_TTMCConstraint_GloballyExpression_UnaryExpression, gen_TTMCConstraint_FinallyExpression_TemporalPathExpression, gen_TTMCConstraint_FinallyExpression_UnaryExpression, gen_TTMCConstraint_NextExpression_TemporalPathExpression, gen_TTMCConstraint_NextExpression_UnaryExpression, gen_TTMCConstraint_TemporalForallExpression_TemporalStateExpression, gen_TTMCConstraint_TemporalForallExpression_UnaryExpression, gen_TTMCConstraint_TemporalExistsExpression_TemporalStateExpression, gen_TTMCConstraint_TemporalExistsExpression_UnaryExpression, gen_TTMCConstraint_InExpression_PredicateExpression, gen_TTMCConstraint_InExpression_UnaryExpression, gen_TTMCConstraint_PrimedExpression_UnaryExpression, gen_TTMCConstraint_EquivalenceExpression_PredicateExpression, gen_TTMCConstraint_EquivalenceExpression_BinaryExpression, gen_TTMCConstraint_EqualityExpression_EquivalenceExpression, gen_TTMCConstraint_InequalityExpression_EquivalenceExpression, gen_TTMCConstraint_DivExpression_ArithmeticExpression, gen_TTMCConstraint_DivExpression_BinaryExpression, gen_TTMCConstraint_ModExpression_ArithmeticExpression, gen_TTMCConstraint_ModExpression_BinaryExpression, gen_TTMCConstraint_UnaryMinusExpression_ArithmeticExpression, gen_TTMCConstraint_UnaryMinusExpression_UnaryExpression, gen_TTMCConstraint_UnaryPlusExpression_ArithmeticExpression, gen_TTMCConstraint_UnaryPlusExpression_UnaryExpression, gen_TTMCConstraint_FunctionAccessExpression_AccessExpression, gen_TTMCConstraint_FunctionAccessExpression_ParametrizedElement, gen_TTMCConstraint_ArrayAccessExpression_AccessExpression, gen_TTMCConstraint_ArrayAccessExpression_ParametrizedElement, gen_TTMCConstraint_TupleAccessExpression_AccessExpression, gen_TTMCConstraint_RecordAccessExpression_AccessExpression},
    metadata=None
)
