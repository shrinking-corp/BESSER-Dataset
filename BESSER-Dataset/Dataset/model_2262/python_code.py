...
class school_Year:
    ...
    def __init__(self, startingDate: int, Year12: "school_SchoolClass" = None, years: "school_School" = None, year: set["school_SchoolClass"] = None, Year: "school_School" = None):
...
class school_Teacher:
    ...
    def __init__(self, name: str, school_Teacher: "school_SchoolClass" = None, teachers: "school_School" = None, teacher: set["school_Course"] = None, school_Teacher25: "school_SchoolClass" = None, Teacher8: "school_School" = None, Teacher: "school_Course" = None):
        self.name = name
...
class school_School:
    ...
    def __init__(self, name: str, address: str, School21: "school_Teacher" = None, School28: "school_Year" = None, school: set["school_Year"] = None, School: "school_Course" = None, school7: set["school_Teacher"] = None, school10: set["school_Course"] = None):
        self.name = name
...
class school_Course:
    ...
    def __init__(self, subject: str, weight: int, courses4: "school_SchoolClass" = None, Course16: "school_SchoolClass" = None, Course23: "school_Teacher" = None, courses: "school_School" = None, courses2: "school_Teacher" = None, Course: "school_School" = None):
