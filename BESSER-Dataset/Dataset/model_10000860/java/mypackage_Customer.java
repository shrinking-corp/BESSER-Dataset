...
public class mypackage_Customer  {
    ...
    public mypackage_Customer(
        LocalDate dateOfBirth,        String address,        String phoneNumber,        String name,        String emailAddress    ) {
    ...
    public mypackage_Customer(
        LocalDate dateOfBirth,        String address,        String phoneNumber,        String name,        String emailAddress        ArrayList<account_Account> account_accounts    ) {
        this.dateOfBirth = dateOfBirth;
        this.address = address;
        this.phoneNumber = phoneNumber;
        this.name = name;
