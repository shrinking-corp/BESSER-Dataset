...
def test_hyp_sistem_peminjaman_dana_pegawai_is_not_abstract():
    assert not inspect.isabstract(Sistem_Peminjaman_Dana_Pegawai)


def test_hyp_sistem_peminjaman_dana_pegawai_constructor_exists():
    assert callable(Sistem_Peminjaman_Dana_Pegawai.__init__)


def test_hyp_sistem_peminjaman_dana_pegawai_constructor_args():
    sig = inspect.signature(Sistem_Peminjaman_Dana_Pegawai.__init__)
    params = list(sig.parameters.keys())



def test_hyp_transaksi_peminjaman_is_not_abstract():
    assert not inspect.isabstract(Transaksi_Peminjaman)


def test_hyp_transaksi_peminjaman_constructor_exists():
    assert callable(Transaksi_Peminjaman.__init__)


def test_hyp_transaksi_peminjaman_constructor_args():
...
def test_hyp_data_peminjaman_is_not_abstract():
    assert not inspect.isabstract(Data_Peminjaman)


def test_hyp_data_peminjaman_constructor_exists():
    assert callable(Data_Peminjaman.__init__)


def test_hyp_data_peminjaman_constructor_args():
...
def test_hyp_data_pegawai_is_not_abstract():
    assert not inspect.isabstract(Data_Pegawai)


def test_hyp_data_pegawai_constructor_exists():
    assert callable(Data_Pegawai.__init__)


def test_hyp_data_pegawai_constructor_args():
...
def test_hyp_transaksi_peminjaman_Namakaryawan_setter(instance):
...
@given(instance=Transaksi_Peminjaman_strategy)
def test_hyp_transaksi_peminjaman_jumlahpinjam_setter(instance):
...
@given(instance=Transaksi_Peminjaman_strategy)
def test_hyp_transaksi_peminjaman_NPK_setter(instance):
...
@given(instance=Transaksi_Peminjaman_strategy)
def test_hyp_transaksi_peminjaman_Tanggalpinjam_setter(instance):
...
@given(instance=Transaksi_Peminjaman_strategy)
def test_hyp_transaksi_peminjaman_keterangan_setter(instance):
...
@given(instance=Transaksi_Peminjaman_strategy)
def test_hyp_transaksi_peminjaman_Nopeminjaman_setter(instance):
...
@given(instance=Transaksi_Peminjaman_strategy)
def test_hyp_transaksi_peminjaman_NIK_setter(instance):
...
def test_hyp_data_peminjaman_NIK_setter(instance):
    original = instance.NIK
    instance.NIK = original
    assert instance.NIK == original
...
@given(instance=Data_Peminjaman_strategy)
def test_hyp_data_peminjaman_jumlahpinjam_setter(instance):
    original = instance.jumlahpinjam
    instance.jumlahpinjam = original
    assert instance.jumlahpinjam == original
...
@given(instance=Data_Peminjaman_strategy)
def test_hyp_data_peminjaman_NPK_setter(instance):
    original = instance.NPK
    instance.NPK = original
    assert instance.NPK == original
...
@given(instance=Data_Peminjaman_strategy)
def test_hyp_data_peminjaman_keterangan_setter(instance):
    original = instance.keterangan
    instance.keterangan = original
    assert instance.keterangan == original
...
@given(instance=Data_Peminjaman_strategy)
def test_hyp_data_peminjaman_Namakaryawan_setter(instance):
    original = instance.Namakaryawan
    instance.Namakaryawan = original
    assert instance.Namakaryawan == original
...
@given(instance=Data_Peminjaman_strategy)
def test_hyp_data_peminjaman_Tanggalpinjam_setter(instance):
    original = instance.Tanggalpinjam
    instance.Tanggalpinjam = original
    assert instance.Tanggalpinjam == original
...
def test_hyp_data_pegawai_alamat_setter(instance):
...
@given(instance=Data_Pegawai_strategy)
def test_hyp_data_pegawai_Namakaryawan_setter(instance):
    original = instance.Namakaryawan
    instance.Namakaryawan = original
    assert instance.Namakaryawan == original
...
@given(instance=Data_Pegawai_strategy)
def test_hyp_data_pegawai_NIK_setter(instance):
    original = instance.NIK
    instance.NIK = original
    assert instance.NIK == original
...
@given(instance=Data_Pegawai_strategy)
def test_hyp_data_pegawai_status_setter(instance):
...
@given(instance=Data_Pegawai_strategy)
def test_hyp_data_pegawai_tanggallahir_setter(instance):
...
@given(instance=Data_Pegawai_strategy)
def test_hyp_data_pegawai_tempatlahir_setter(instance):
...
def test_Data_Pegawai_NIK_value_roundtrip():
    instance = Data_Pegawai(NIK=7, Namakaryawan="sample_text", alamat="sample_text", status="sample_text", tanggallahir=date(2024, 1, 1), tempatlahir="sample_text")
    assert instance.NIK == 7
    instance.NIK = 13
    assert instance.NIK == 13


def test_Data_Pegawai_Namakaryawan_value_roundtrip():
    instance = Data_Pegawai(NIK=7, Namakaryawan="sample_text", alamat="sample_text", status="sample_text", tanggallahir=date(2024, 1, 1), tempatlahir="sample_text")
    assert instance.Namakaryawan == "sample_text"
    instance.Namakaryawan = "sample_text_2"
    assert instance.Namakaryawan == "sample_text_2"


def test_Data_Pegawai_alamat_value_roundtrip():
    instance = Data_Pegawai(NIK=7, Namakaryawan="sample_text", alamat="sample_text", status="sample_text", tanggallahir=date(2024, 1, 1), tempatlahir="sample_text")
...
def test_Data_Pegawai_status_value_roundtrip():
    instance = Data_Pegawai(NIK=7, Namakaryawan="sample_text", alamat="sample_text", status="sample_text", tanggallahir=date(2024, 1, 1), tempatlahir="sample_text")
...
def test_Data_Pegawai_tanggallahir_value_roundtrip():
    instance = Data_Pegawai(NIK=7, Namakaryawan="sample_text", alamat="sample_text", status="sample_text", tanggallahir=date(2024, 1, 1), tempatlahir="sample_text")
    assert instance.tanggallahir == date(2024, 1, 1)
    instance.tanggallahir = date(2025, 6, 15)
    assert instance.tanggallahir == date(2025, 6, 15)


def test_Data_Pegawai_tempatlahir_value_roundtrip():
    instance = Data_Pegawai(NIK=7, Namakaryawan="sample_text", alamat="sample_text", status="sample_text", tanggallahir=date(2024, 1, 1), tempatlahir="sample_text")
    assert instance.tempatlahir == "sample_text"
    instance.tempatlahir = "sample_text_2"
    assert instance.tempatlahir == "sample_text_2"


def test_Data_Peminjaman_NIK_value_roundtrip():
    instance = Data_Peminjaman(NIK=7, NPK=7, Namakaryawan="sample_text", Tanggalpinjam=date(2024, 1, 1), jumlahpinjam="sample_text", keterangan="sample_text")
    assert instance.NIK == 7
    instance.NIK = 13
    assert instance.NIK == 13


def test_Data_Peminjaman_NPK_value_roundtrip():
    instance = Data_Peminjaman(NIK=7, NPK=7, Namakaryawan="sample_text", Tanggalpinjam=date(2024, 1, 1), jumlahpinjam="sample_text", keterangan="sample_text")
    assert instance.NPK == 7
    instance.NPK = 13
    assert instance.NPK == 13


def test_Data_Peminjaman_Namakaryawan_value_roundtrip():
    instance = Data_Peminjaman(NIK=7, NPK=7, Namakaryawan="sample_text", Tanggalpinjam=date(2024, 1, 1), jumlahpinjam="sample_text", keterangan="sample_text")
    assert instance.Namakaryawan == "sample_text"
    instance.Namakaryawan = "sample_text_2"
    assert instance.Namakaryawan == "sample_text_2"
...
def test_Data_Peminjaman_Tanggalpinjam_value_roundtrip():
    instance = Data_Peminjaman(NIK=7, NPK=7, Namakaryawan="sample_text", Tanggalpinjam=date(2024, 1, 1), jumlahpinjam="sample_text", keterangan="sample_text")
    assert instance.Tanggalpinjam == date(2024, 1, 1)
    instance.Tanggalpinjam = date(2025, 6, 15)
    assert instance.Tanggalpinjam == date(2025, 6, 15)


def test_Data_Peminjaman_jumlahpinjam_value_roundtrip():
    instance = Data_Peminjaman(NIK=7, NPK=7, Namakaryawan="sample_text", Tanggalpinjam=date(2024, 1, 1), jumlahpinjam="sample_text", keterangan="sample_text")
    assert instance.jumlahpinjam == "sample_text"
    instance.jumlahpinjam = "sample_text_2"
    assert instance.jumlahpinjam == "sample_text_2"


def test_Data_Peminjaman_keterangan_value_roundtrip():
    instance = Data_Peminjaman(NIK=7, NPK=7, Namakaryawan="sample_text", Tanggalpinjam=date(2024, 1, 1), jumlahpinjam="sample_text", keterangan="sample_text")
...
def test_Transaksi_Peminjaman_NIK_value_roundtrip():
    instance = Transaksi_Peminjaman(NIK=7, NPK=7, Namakaryawan="sample_text", Nopeminjaman=7, Tanggalpinjam=date(2024, 1, 1), jumlahpinjam="sample_text", keterangan="sample_text")
    assert instance.NIK == 7
    instance.NIK = 13
    assert instance.NIK == 13


def test_Transaksi_Peminjaman_NPK_value_roundtrip():
    instance = Transaksi_Peminjaman(NIK=7, NPK=7, Namakaryawan="sample_text", Nopeminjaman=7, Tanggalpinjam=date(2024, 1, 1), jumlahpinjam="sample_text", keterangan="sample_text")
    assert instance.NPK == 7
    instance.NPK = 13
    assert instance.NPK == 13
...
def test_Transaksi_Peminjaman_Namakaryawan_value_roundtrip():
    instance = Transaksi_Peminjaman(NIK=7, NPK=7, Namakaryawan="sample_text", Nopeminjaman=7, Tanggalpinjam=date(2024, 1, 1), jumlahpinjam="sample_text", keterangan="sample_text")
    assert instance.Namakaryawan == "sample_text"
    instance.Namakaryawan = "sample_text_2"
    assert instance.Namakaryawan == "sample_text_2"
...
def test_Transaksi_Peminjaman_Nopeminjaman_value_roundtrip():
    instance = Transaksi_Peminjaman(NIK=7, NPK=7, Namakaryawan="sample_text", Nopeminjaman=7, Tanggalpinjam=date(2024, 1, 1), jumlahpinjam="sample_text", keterangan="sample_text")
    assert instance.Nopeminjaman == 7
    instance.Nopeminjaman = 13
    assert instance.Nopeminjaman == 13


def test_Transaksi_Peminjaman_Tanggalpinjam_value_roundtrip():
    instance = Transaksi_Peminjaman(NIK=7, NPK=7, Namakaryawan="sample_text", Nopeminjaman=7, Tanggalpinjam=date(2024, 1, 1), jumlahpinjam="sample_text", keterangan="sample_text")
    assert instance.Tanggalpinjam == date(2024, 1, 1)
    instance.Tanggalpinjam = date(2025, 6, 15)
    assert instance.Tanggalpinjam == date(2025, 6, 15)
...
def test_Transaksi_Peminjaman_jumlahpinjam_value_roundtrip():
    instance = Transaksi_Peminjaman(NIK=7, NPK=7, Namakaryawan="sample_text", Nopeminjaman=7, Tanggalpinjam=date(2024, 1, 1), jumlahpinjam="sample_text", keterangan="sample_text")
    assert instance.jumlahpinjam == "sample_text"
    instance.jumlahpinjam = "sample_text_2"
    assert instance.jumlahpinjam == "sample_text_2"
...
def test_Transaksi_Peminjaman_keterangan_value_roundtrip():
    instance = Transaksi_Peminjaman(NIK=7, NPK=7, Namakaryawan="sample_text", Nopeminjaman=7, Tanggalpinjam=date(2024, 1, 1), jumlahpinjam="sample_text", keterangan="sample_text")
    assert instance.keterangan == "sample_text"
    instance.keterangan = "sample_text_2"
    assert instance.keterangan == "sample_text_2"
...
Data_Pegawai_strategy = st.builds(Data_Pegawai, NIK=st.integers(), Namakaryawan=safe_text, alamat=safe_text, status=safe_text, tanggallahir=st.dates(), tempatlahir=safe_text)
@given(instance=Data_Pegawai_strategy)
@settings(max_examples=25)
...
Data_Peminjaman_strategy = st.builds(Data_Peminjaman, NIK=st.integers(), NPK=st.integers(), Namakaryawan=safe_text, Tanggalpinjam=st.dates(), jumlahpinjam=safe_text, keterangan=safe_text)
@given(instance=Data_Peminjaman_strategy)
@settings(max_examples=25)
...
Sistem_Peminjaman_Dana_Pegawai_strategy = st.builds(Sistem_Peminjaman_Dana_Pegawai)
...
Transaksi_Peminjaman_strategy = st.builds(Transaksi_Peminjaman, NIK=st.integers(), NPK=st.integers(), Namakaryawan=safe_text, Nopeminjaman=st.integers(), Tanggalpinjam=st.dates(), jumlahpinjam=safe_text, keterangan=safe_text)
@given(instance=Transaksi_Peminjaman_strategy)
@settings(max_examples=25)
