...
class mm_styles_AbstractStyle(ABC):
    ...
    def __init__(self, lineWidth: str, lineStyle: str, filled: str, lineVisible: str, transparency: str, mm_styles_AbstractStyle: "styles_Color" = None, mm_styles_AbstractStyle58: "styles_Color" = None, mm_styles_AbstractStyle61: "styles_RenderingStyle" = None):
...
class mm_pictograms_AdvancedAnchor(Anchor):
    ...
    def __init__(self, useAnchorLocationAsConnectionEndpoint: bool, Anchor: "mm_pictograms_Connection" = None, Anchor16: "mm_pictograms_Connection" = None, Anchor28: "mm_pictograms_AnchorContainer" = None):
...
class mm_algorithms_AbstractText(GraphicsAlgorithm):
    ...
    def __init__(self, horizontalAlignment: str, verticalAlignment: str, angle: str, value: str, rotation: str, mm_algorithms_AbstractText: "styles_Font" = None, mm_algorithms_AbstractText50: set["styles_TextStyleRegion"] = None, GraphicsAlgorithm39: "mm_algorithms_GraphicsAlgorithm" = None, GraphicsAlgorithm: "mm_pictograms_PictogramElement" = None, GraphicsAlgorithm41: "mm_algorithms_GraphicsAlgorithm" = None, GraphicsAlgorithm25: "mm_pictograms_Anchor" = None):
...
class mm_styles_Style(StyleContainer, styles_AbstractStyle):
    ...
    def __init__(self, id: str, rotation: str, description: str, horizontalAlignment: str, verticalAlignment: str, angle: str, stretchH: str, stretchV: str, proportional: str, mm_styles_Style: "styles_Font" = None, styles: "styles_mm_StyleContainer" = None):
        self.id = id
        self.rotation = rotation
