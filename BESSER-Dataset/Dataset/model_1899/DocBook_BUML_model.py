...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={DocBook_DocBook, Book, DocBook_Book, Article, DocBook_TitledElement, DocBook_Article, TitledElement, Sect1, DocBook_Section, Para, DocBook_Sect1, Section, Sect2, DocBook_Sect2, DocBook_Para},
