...
class ToConditionalConnectorEdge:
    ...
    pass
class remes_EntryConditionalTopInitEdge(FromCompositeModeInitEdge, ToConditionalConnectorEdge, InitEdge):
...
class remes_EntryEdge(ToSubModeEdge, Edge, FromCompositeModeEdge):
    ...
    pass
class remes_EntryInitEdge(FromCompositeModeInitEdge, ToSubModeEdge, InitEdge):

    pass
class FromConditionalConnectorEdge:

    pass
class remes_EntryConditionalSubEdge(FromConditionalConnectorEdge, Edge, ToSubModeEdge):
...
class remes_SubMode(Mode):
    ...
    def __init__(self, resourceClassA: str, resourceClassB: str, resourceClassC: str, invariant: str, isUrgent: str, SubMode: "remes_CompositeMode" = None, SubMode20: "remes_FromSubModeEdge" = None, connectTo23: set["remes_ToSubModeEdge"] = None, connectFrom25: set["remes_FromSubModeEdge"] = None, subModes: "remes_CompositeMode" = None, SubMode35: "remes_ToSubModeEdge" = None):
