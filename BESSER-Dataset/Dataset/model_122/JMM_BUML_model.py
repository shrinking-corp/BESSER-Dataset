...
# Classes
JMM_FieldDeclaration = Class(name="JMM_FieldDeclaration")
BodyDeclaration = Class(name="BodyDeclaration")
AbstractVariablesContainer = Class(name="AbstractVariablesContainer")
JMM_AnnotationTypeDeclaration = Class(name="JMM_AnnotationTypeDeclaration")
AbstractTypeDeclaration = Class(name="AbstractTypeDeclaration")
JMM_Model = Class(name="JMM_Model")
JMM_Package = Class(name="JMM_Package")
Expression = Class(name="Expression")
NamespaceAccess = Class(name="NamespaceAccess")
JMM_Type = Class(name="JMM_Type", is_abstract=True)
NamedElement = Class(name="NamedElement")
JMM_AbstractTypeDeclaration = Class(name="JMM_AbstractTypeDeclaration", is_abstract=True)
Type = Class(name="Type")
JMM_BodyDeclaration = Class(name="JMM_BodyDeclaration", is_abstract=True)
JMM_Modifier = Class(name="JMM_Modifier")
JMM_NamedElement = Class(name="JMM_NamedElement", is_abstract=True)
ASTNode = Class(name="ASTNode")
JMM_MethodDeclaration = Class(name="JMM_MethodDeclaration")
AbstractMethodDeclaration = Class(name="AbstractMethodDeclaration")
JMM_ConstructorDeclaration = Class(name="JMM_ConstructorDeclaration")
JMM_ClassDeclaration = Class(name="JMM_ClassDeclaration")
TypeDeclaration = Class(name="TypeDeclaration")
JMM_TypeAccess = Class(name="JMM_TypeAccess")
JMM_InterfaceDeclaration = Class(name="JMM_InterfaceDeclaration")
JMM_ASTNode = Class(name="JMM_ASTNode", is_abstract=True)
JMM_AbstractVariablesContainer = Class(name="JMM_AbstractVariablesContainer", is_abstract=True)
JMM_AbstractMethodDeclaration = Class(name="JMM_AbstractMethodDeclaration", is_abstract=True)
JMM_TypeDeclaration = Class(name="JMM_TypeDeclaration", is_abstract=True)
JMM_Expression = Class(name="JMM_Expression", is_abstract=True)
JMM_NamespaceAccess = Class(name="JMM_NamespaceAccess", is_abstract=True)
...
domain_model = DomainModel(
    name="JMM",
    types={JMM_FieldDeclaration, BodyDeclaration, AbstractVariablesContainer, JMM_AnnotationTypeDeclaration, AbstractTypeDeclaration, JMM_Model, JMM_Package, Expression, NamespaceAccess, JMM_Type, NamedElement, JMM_AbstractTypeDeclaration, Type, JMM_BodyDeclaration, JMM_Modifier, JMM_NamedElement, ASTNode, JMM_MethodDeclaration, AbstractMethodDeclaration, JMM_ConstructorDeclaration, JMM_ClassDeclaration, TypeDeclaration, JMM_TypeAccess, JMM_InterfaceDeclaration, JMM_ASTNode, JMM_AbstractVariablesContainer, JMM_AbstractMethodDeclaration, JMM_TypeDeclaration, JMM_Expression, JMM_NamespaceAccess, InheritanceKind},
    associations={ownedElements0, type2, ownedPackages5, ownedElements7, bodyDeclarations9, superInterfaces11, modifier14, superClass1},
    generalizations={gen_JMM_FieldDeclaration_BodyDeclaration, gen_JMM_FieldDeclaration_AbstractVariablesContainer, gen_JMM_AnnotationTypeDeclaration_AbstractTypeDeclaration, gen_JMM_TypeAccess_Expression, gen_JMM_TypeAccess_NamespaceAccess, gen_JMM_Package_NamedElement, gen_JMM_AbstractTypeDeclaration_BodyDeclaration, gen_JMM_AbstractTypeDeclaration_Type, gen_JMM_BodyDeclaration_NamedElement, gen_JMM_NamedElement_ASTNode, gen_JMM_Modifier_ASTNode, gen_JMM_Type_NamedElement, gen_JMM_MethodDeclaration_AbstractMethodDeclaration, gen_JMM_ConstructorDeclaration_AbstractMethodDeclaration, gen_JMM_ClassDeclaration_TypeDeclaration, gen_JMM_InterfaceDeclaration_TypeDeclaration, gen_JMM_AbstractVariablesContainer_ASTNode, gen_JMM_AbstractMethodDeclaration_BodyDeclaration, gen_JMM_TypeDeclaration_AbstractTypeDeclaration, gen_JMM_Expression_ASTNode, gen_JMM_NamespaceAccess_ASTNode},
    metadata=None
)
