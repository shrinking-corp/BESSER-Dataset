...
# Classes
metamodeloArquitecturaPila_Menu = Class(name="metamodeloArquitecturaPila_Menu")
metamodeloArquitecturaPila_Form = Class(name="metamodeloArquitecturaPila_Form")
metamodeloArquitecturaPila_GraphicalComponent = Class(name="metamodeloArquitecturaPila_GraphicalComponent", is_abstract=True)
metamodeloArquitecturaPila_SimpleComponent = Class(name="metamodeloArquitecturaPila_SimpleComponent", is_abstract=True)
metamodeloArquitecturaPila_MenuItem = Class(name="metamodeloArquitecturaPila_MenuItem")
metamodeloArquitecturaPila_Architecture = Class(name="metamodeloArquitecturaPila_Architecture")
metamodeloArquitecturaPila_View = Class(name="metamodeloArquitecturaPila_View")
metamodeloArquitecturaPila_BusinessModel = Class(name="metamodeloArquitecturaPila_BusinessModel")
metamodeloArquitecturaPila_Service = Class(name="metamodeloArquitecturaPila_Service")
metamodeloArquitecturaPila_ServiceType = Class(name="metamodeloArquitecturaPila_ServiceType")
metamodeloArquitecturaPila_BusinessLogic = Class(name="metamodeloArquitecturaPila_BusinessLogic")
metamodeloArquitecturaPila_TitleBar = Class(name="metamodeloArquitecturaPila_TitleBar")
metamodeloArquitecturaPila_Grid = Class(name="metamodeloArquitecturaPila_Grid")
ComplexComponent = Class(name="ComplexComponent")
metamodeloArquitecturaPila_TextArea = Class(name="metamodeloArquitecturaPila_TextArea")
metamodeloArquitecturaPila_Parameter = Class(name="metamodeloArquitecturaPila_Parameter")
metamodeloArquitecturaPila_Function = Class(name="metamodeloArquitecturaPila_Function")
metamodeloArquitecturaPila_Entity = Class(name="metamodeloArquitecturaPila_Entity")
metamodeloArquitecturaPila_DataType = Class(name="metamodeloArquitecturaPila_DataType")
metamodeloArquitecturaPila_Button = Class(name="metamodeloArquitecturaPila_Button")
SimpleComponent = Class(name="SimpleComponent")
metamodeloArquitecturaPila_Input = Class(name="metamodeloArquitecturaPila_Input")
metamodeloArquitecturaPila_Label = Class(name="metamodeloArquitecturaPila_Label")
GraphicalComponent = Class(name="GraphicalComponent")
metamodeloArquitecturaPila_ComplexComponent = Class(name="metamodeloArquitecturaPila_ComplexComponent", is_abstract=True)
metamodeloArquitecturaPila_DropdownList = Class(name="metamodeloArquitecturaPila_DropdownList")
metamodeloArquitecturaPila_ListItem = Class(name="metamodeloArquitecturaPila_ListItem")
metamodeloArquitecturaPila_Integer = Class(name="metamodeloArquitecturaPila_Integer")
DataType = Class(name="DataType")
metamodeloArquitecturaPila_Float = Class(name="metamodeloArquitecturaPila_Float")
metamodeloArquitecturaPila_Boolean = Class(name="metamodeloArquitecturaPila_Boolean")
metamodeloArquitecturaPila_String = Class(name="metamodeloArquitecturaPila_String")
metamodeloArquitecturaPila_Date = Class(name="metamodeloArquitecturaPila_Date")
metamodeloArquitecturaPila_Enum = Class(name="metamodeloArquitecturaPila_Enum")
metamodeloArquitecturaPila_Create = Class(name="metamodeloArquitecturaPila_Create")
ServiceType = Class(name="ServiceType")
metamodeloArquitecturaPila_Read = Class(name="metamodeloArquitecturaPila_Read")
metamodeloArquitecturaPila_Update = Class(name="metamodeloArquitecturaPila_Update")
metamodeloArquitecturaPila_Delete = Class(name="metamodeloArquitecturaPila_Delete")
metamodeloArquitecturaPila_Attribute = Class(name="metamodeloArquitecturaPila_Attribute")
metamodeloArquitecturaPila_Method = Class(name="metamodeloArquitecturaPila_Method")
metamodeloArquitecturaPila_Body = Class(name="metamodeloArquitecturaPila_Body")
metamodeloArquitecturaPila_FunctionBody = Class(name="metamodeloArquitecturaPila_FunctionBody")
metamodeloArquitecturaPila_Text = Class(name="metamodeloArquitecturaPila_Text")
Input = Class(name="Input")
metamodeloArquitecturaPila_Radio = Class(name="metamodeloArquitecturaPila_Radio")
metamodeloArquitecturaPila_Check = Class(name="metamodeloArquitecturaPila_Check")
metamodeloArquitecturaPila_Number = Class(name="metamodeloArquitecturaPila_Number")
metamodeloArquitecturaPila_DatePicker = Class(name="metamodeloArquitecturaPila_DatePicker")
metamodeloArquitecturaPila_Select = Class(name="metamodeloArquitecturaPila_Select")
...
metamodeloArquitecturaPila_Menu.attributes={metamodeloArquitecturaPila_Menu_name, metamodeloArquitecturaPila_Menu_id}
...
metamodeloArquitecturaPila_GraphicalComponent.attributes={metamodeloArquitecturaPila_GraphicalComponent_displayName, metamodeloArquitecturaPila_GraphicalComponent_length, metamodeloArquitecturaPila_GraphicalComponent_height, metamodeloArquitecturaPila_GraphicalComponent_name, metamodeloArquitecturaPila_GraphicalComponent_id}
...
domain_model = DomainModel(
    ...
    types={metamodeloArquitecturaPila_Menu, metamodeloArquitecturaPila_Form, metamodeloArquitecturaPila_GraphicalComponent, metamodeloArquitecturaPila_SimpleComponent, metamodeloArquitecturaPila_MenuItem, metamodeloArquitecturaPila_Architecture, metamodeloArquitecturaPila_View, metamodeloArquitecturaPila_BusinessModel, metamodeloArquitecturaPila_Service, metamodeloArquitecturaPila_ServiceType, metamodeloArquitecturaPila_BusinessLogic, metamodeloArquitecturaPila_TitleBar, metamodeloArquitecturaPila_Grid, ComplexComponent, metamodeloArquitecturaPila_TextArea, metamodeloArquitecturaPila_Parameter, metamodeloArquitecturaPila_Function, metamodeloArquitecturaPila_Entity, metamodeloArquitecturaPila_DataType, metamodeloArquitecturaPila_Button, SimpleComponent, metamodeloArquitecturaPila_Input, metamodeloArquitecturaPila_Label, GraphicalComponent, metamodeloArquitecturaPila_ComplexComponent, metamodeloArquitecturaPila_DropdownList, metamodeloArquitecturaPila_ListItem, metamodeloArquitecturaPila_Integer, DataType, metamodeloArquitecturaPila_Float, metamodeloArquitecturaPila_Boolean, metamodeloArquitecturaPila_String, metamodeloArquitecturaPila_Date, metamodeloArquitecturaPila_Enum, metamodeloArquitecturaPila_Create, ServiceType, metamodeloArquitecturaPila_Read, metamodeloArquitecturaPila_Update, metamodeloArquitecturaPila_Delete, metamodeloArquitecturaPila_Attribute, metamodeloArquitecturaPila_Method, metamodeloArquitecturaPila_Body, metamodeloArquitecturaPila_FunctionBody, metamodeloArquitecturaPila_Text, Input, metamodeloArquitecturaPila_Radio, metamodeloArquitecturaPila_Check, metamodeloArquitecturaPila_Number, metamodeloArquitecturaPila_DatePicker, metamodeloArquitecturaPila_Select},
    associations={title9, menu11, forms13, gComponents15, childs18, titleComponents20, items22, formComponents24, views0, businessModel1, services3, serviceTypes5, logic7, serviceType31, requestParams34, responseParam36, dispatcher39, entities41, dataTypes43, menuItemComponent27, items30, body61, functions63, entryParams66, returnParam69, attributes45, methods47, childrenEntities50, attType52, entryParams55, returnParam58, body72, paramType74},
    generalizations={gen_metamodeloArquitecturaPila_Grid_ComplexComponent, gen_metamodeloArquitecturaPila_TextArea_ComplexComponent, gen_metamodeloArquitecturaPila_Button_SimpleComponent, gen_metamodeloArquitecturaPila_Input_SimpleComponent, gen_metamodeloArquitecturaPila_Label_SimpleComponent, gen_metamodeloArquitecturaPila_SimpleComponent_GraphicalComponent, gen_metamodeloArquitecturaPila_ComplexComponent_GraphicalComponent, gen_metamodeloArquitecturaPila_DropdownList_SimpleComponent, gen_metamodeloArquitecturaPila_Integer_DataType, gen_metamodeloArquitecturaPila_Float_DataType, gen_metamodeloArquitecturaPila_Boolean_DataType, gen_metamodeloArquitecturaPila_String_DataType, gen_metamodeloArquitecturaPila_Date_DataType, gen_metamodeloArquitecturaPila_Enum_DataType, gen_metamodeloArquitecturaPila_Create_ServiceType, gen_metamodeloArquitecturaPila_Read_ServiceType, gen_metamodeloArquitecturaPila_Update_ServiceType, gen_metamodeloArquitecturaPila_Delete_ServiceType, gen_metamodeloArquitecturaPila_Text_Input, gen_metamodeloArquitecturaPila_Radio_Input, gen_metamodeloArquitecturaPila_Check_Input, gen_metamodeloArquitecturaPila_Number_Input, gen_metamodeloArquitecturaPila_DatePicker_Input, gen_metamodeloArquitecturaPila_Select_ComplexComponent},
    metadata=None
)
