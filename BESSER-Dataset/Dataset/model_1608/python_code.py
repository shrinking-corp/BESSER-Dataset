...
class pnmlcoremodel_Line:
    ...
    def __init__(self, color: str, shape: str, width: str, style: str, Line: "pnmlcoremodel_NodeGraphics" = None, line: "pnmlcoremodel_NodeGraphics" = None, line65: "pnmlcoremodel_ArcGraphics" = None, line68: "pnmlcoremodel_AnnotationGraphics" = None, Line53: "pnmlcoremodel_AnnotationGraphics" = None, Line74: "pnmlcoremodel_ArcGraphics" = None):
        self.color = color
        self.shape = shape
        self.width = width
        self.style = style
...
class pnmlcoremodel_PnObject(ABC):
    ...
    def __init__(self, id: str, objects: "pnmlcoremodel_Page" = None, PnObject21: "pnmlcoremodel_Name" = None, PnObject: "pnmlcoremodel_Page" = None, containerNamePnObject: "pnmlcoremodel_Name" = None, containerPnObject: set["pnmlcoremodel_ToolInfo"] = None, PnObject26: "pnmlcoremodel_ToolInfo" = None):
        self.id = id
...
class pnmlcoremodel_ToolInfo:
    ...
    def __init__(self, tool: str, version: str, formattedXMLBuffer: str, toolInfoGrammarURI: str, ToolInfo: "pnmlcoremodel_PetriNet" = None, ToolInfo14: "pnmlcoremodel_PnObject" = None, ToolInfo98: "pnmlcoremodel_AnyObject" = None, toolspecifics: "pnmlcoremodel_PetriNet" = None, toolspecifics25: "pnmlcoremodel_PnObject" = None, toolspecifics28: "pnmlcoremodel_Label" = None, containerToolInfo: "pnmlcoremodel_AnyObject" = None, ToolInfo31: "pnmlcoremodel_Label" = None):
        self.tool = tool
...
class pnmlcoremodel_Name(Annotation):
    ...
    def __init__(self, text: str, name: "pnmlcoremodel_PetriNet" = None, name20: "pnmlcoremodel_PnObject" = None, Name: "pnmlcoremodel_PetriNet" = None, Name12: "pnmlcoremodel_PnObject" = None):
        self.text = text
        self.name = name
        self.name20 = name20
        self.Name = Name
...
class pnmlcoremodel_PetriNet:
    ...
    def __init__(self, id: str, type: str, PetriNet18: "pnmlcoremodel_Name" = None, containerPetriNet: set["pnmlcoremodel_Page"] = None, containerNamePetriNet: "pnmlcoremodel_Name" = None, containerPetriNet4: set["pnmlcoremodel_ToolInfo"] = None, nets: "pnmlcoremodel_PetriNetDoc" = None, PetriNet8: "pnmlcoremodel_Page" = None, PetriNet23: "pnmlcoremodel_ToolInfo" = None, PetriNet: "pnmlcoremodel_PetriNetDoc" = None):
        self.id = id
        self.type = type
