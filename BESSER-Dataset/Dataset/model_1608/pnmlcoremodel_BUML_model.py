...
# Classes
pnmlcoremodel_PetriNetDoc = Class(name="pnmlcoremodel_PetriNetDoc")
pnmlcoremodel_PetriNet = Class(name="pnmlcoremodel_PetriNet")
pnmlcoremodel_NodeGraphics = Class(name="pnmlcoremodel_NodeGraphics")
Annotation = Class(name="Annotation")
pnmlcoremodel_Page = Class(name="pnmlcoremodel_Page")
pnmlcoremodel_Name = Class(name="pnmlcoremodel_Name")
pnmlcoremodel_ToolInfo = Class(name="pnmlcoremodel_ToolInfo")
PnObject = Class(name="PnObject")
pnmlcoremodel_PnObject = Class(name="pnmlcoremodel_PnObject", is_abstract=True)
pnmlcoremodel_Line = Class(name="pnmlcoremodel_Line")
pnmlcoremodel_Node = Class(name="pnmlcoremodel_Node", is_abstract=True)
pnmlcoremodel_Graphics = Class(name="pnmlcoremodel_Graphics", is_abstract=True)
pnmlcoremodel_Coordinate = Class(name="pnmlcoremodel_Coordinate", is_abstract=True)
Coordinate = Class(name="Coordinate")
pnmlcoremodel_ArcGraphics = Class(name="pnmlcoremodel_ArcGraphics")
pnmlcoremodel_Offset = Class(name="pnmlcoremodel_Offset")
pnmlcoremodel_AnnotationGraphics = Class(name="pnmlcoremodel_AnnotationGraphics")
pnmlcoremodel_Label = Class(name="pnmlcoremodel_Label", is_abstract=True)
pnmlcoremodel_AnyObject = Class(name="pnmlcoremodel_AnyObject", is_abstract=True)
Graphics = Class(name="Graphics")
pnmlcoremodel_Position = Class(name="pnmlcoremodel_Position")
pnmlcoremodel_Dimension = Class(name="pnmlcoremodel_Dimension")
pnmlcoremodel_Fill = Class(name="pnmlcoremodel_Fill")
pnmlcoremodel_Font = Class(name="pnmlcoremodel_Font")
pnmlcoremodel_Annotation = Class(name="pnmlcoremodel_Annotation", is_abstract=True)
pnmlcoremodel_Arc = Class(name="pnmlcoremodel_Arc")
TransitionNode = Class(name="TransitionNode")
pnmlcoremodel_Transition = Class(name="pnmlcoremodel_Transition")
pnmlcoremodel_Attribute = Class(name="pnmlcoremodel_Attribute", is_abstract=True)
Label = Class(name="Label")
pnmlcoremodel_PlaceNode = Class(name="pnmlcoremodel_PlaceNode", is_abstract=True)
Node = Class(name="Node")
pnmlcoremodel_RefPlace = Class(name="pnmlcoremodel_RefPlace")
pnmlcoremodel_TransitionNode = Class(name="pnmlcoremodel_TransitionNode", is_abstract=True)
pnmlcoremodel_RefTransition = Class(name="pnmlcoremodel_RefTransition")
pnmlcoremodel_Place = Class(name="pnmlcoremodel_Place")
...
pnmlcoremodel_ToolInfo.attributes={pnmlcoremodel_ToolInfo_tool, pnmlcoremodel_ToolInfo_version, pnmlcoremodel_ToolInfo_formattedXMLBuffer, pnmlcoremodel_ToolInfo_toolInfoGrammarURI}
...
pnmlcoremodel_Line.attributes={pnmlcoremodel_Line_width, pnmlcoremodel_Line_color, pnmlcoremodel_Line_style, pnmlcoremodel_Line_shape}
...
pnmlcoremodel_Fill.attributes={pnmlcoremodel_Fill_gradientcolor, pnmlcoremodel_Fill_color, pnmlcoremodel_Fill_gradientrotation, pnmlcoremodel_Fill_image}
...
pnmlcoremodel_Font.attributes={pnmlcoremodel_Font_style, pnmlcoremodel_Font_rotation, pnmlcoremodel_Font_family, pnmlcoremodel_Font_decoration, pnmlcoremodel_Font_size, pnmlcoremodel_Font_weight, pnmlcoremodel_Font_align}
...
domain_model = DomainModel(
    name="pnmlcoremodel",
    types={pnmlcoremodel_PetriNetDoc, pnmlcoremodel_PetriNet, pnmlcoremodel_NodeGraphics, Annotation, pnmlcoremodel_Page, pnmlcoremodel_Name, pnmlcoremodel_ToolInfo, PnObject, pnmlcoremodel_PnObject, pnmlcoremodel_Line, pnmlcoremodel_Node, pnmlcoremodel_Graphics, pnmlcoremodel_Coordinate, Coordinate, pnmlcoremodel_ArcGraphics, pnmlcoremodel_Offset, pnmlcoremodel_AnnotationGraphics, pnmlcoremodel_Label, pnmlcoremodel_AnyObject, Graphics, pnmlcoremodel_Position, pnmlcoremodel_Dimension, pnmlcoremodel_Fill, pnmlcoremodel_Font, pnmlcoremodel_Annotation, pnmlcoremodel_Arc, TransitionNode, pnmlcoremodel_Transition, pnmlcoremodel_Attribute, Label, pnmlcoremodel_PlaceNode, Node, pnmlcoremodel_RefPlace, pnmlcoremodel_TransitionNode, pnmlcoremodel_RefTransition, pnmlcoremodel_Place, PlaceNode, PNType, Gradient, LineShape, CSS2Color, FontAlign, FontDecoration, CSS2FontFamily, LineStyle, CSS2FontSize, CSS2FontStyle, CSS2FontWeight},
    associations={nets0, nodegraphics9, name11, toolspecifics13, containerPage15, containerNamePetriNet17, containerNamePnObject19, pages1, name2, toolspecifics3, containerPetriNetDoc5, objects6, containerPetriNet7, line35, containerNode37, containerPage38, containerPNodeGraphics41, containerArcGraphics43, containerAnnotationGraphics44, containerDNodeGraphics45, containerPetriNet22, containerPnObject24, containerLabel27, toolInfoModel29, toolspecifics30, position32, dimension33, fill34, containerNodeGraphics62, containerArcGraphics64, containerAnnotationGraphics67, offset47, fill48, line51, font54, containerAnnotation56, containerNodeGraphics57, containerAnnotationGraphics59, InArcs82, OutArcs84, nodegraphics86, containerAnnotationGraphics88, positions70, line72, containerArc75, source76, target78, arcgraphics80, ref93, ref94, annotationgraphics95, containerToolInfo97, referencingPlaces90, referencingTransitions91},
    generalizations={gen_pnmlcoremodel_Name_Annotation, gen_pnmlcoremodel_Page_PnObject, gen_pnmlcoremodel_Position_Coordinate, gen_pnmlcoremodel_Offset_Coordinate, gen_pnmlcoremodel_Dimension_Coordinate, gen_pnmlcoremodel_AnnotationGraphics_Graphics, gen_pnmlcoremodel_NodeGraphics_Graphics, gen_pnmlcoremodel_ArcGraphics_Graphics, gen_pnmlcoremodel_Arc_PnObject, gen_pnmlcoremodel_Node_PnObject, gen_pnmlcoremodel_RefTransition_TransitionNode, gen_pnmlcoremodel_Transition_TransitionNode, gen_pnmlcoremodel_RefPlace_PlaceNode, gen_pnmlcoremodel_Attribute_Label, gen_pnmlcoremodel_Annotation_Label, gen_pnmlcoremodel_PlaceNode_Node, gen_pnmlcoremodel_TransitionNode_Node, gen_pnmlcoremodel_Place_PlaceNode},
    metadata=None
)
