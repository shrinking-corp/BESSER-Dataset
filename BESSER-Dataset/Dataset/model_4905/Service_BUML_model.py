...
# Classes
Service_Tool = Class(name="Service_Tool")
Service_JavaService = Class(name="Service_JavaService")
...
Service_JavaService.attributes={Service_JavaService_option, Service_JavaService_name}
