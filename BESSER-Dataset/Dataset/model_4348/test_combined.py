...
def test_hyp_mensageiro_exists():
    # Check that the Enumeration exists
    assert Mensageiro is not None

def test_hyp_mensageiro_has_all_literals():
...
def test_hyp_nluservice_exists():
    # Check that the Enumeration exists
    assert NLUService is not None

def test_hyp_nluservice_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_mdc_state_sincmessages_changes_state(instance):
...
@given(instance=mdc_Chatbot_strategy)
def test_hyp_mdc_chatbot_nluService_setter(instance):
...
@given(instance=mdc_Chatbot_strategy)
def test_hyp_mdc_chatbot_tokenNluService_setter(instance):
...
@given(instance=mdc_Chatbot_strategy)
def test_hyp_mdc_chatbot_mensageiro_setter(instance):
...
def test_mdc_Chatbot_mensageiro_value_roundtrip():
    instance = mdc_Chatbot(mensageiro="sample_text", name="sample_text", nluService="sample_text", token="sample_text", tokenNluService="sample_text")
    assert instance.mensageiro == "sample_text"
    instance.mensageiro = "sample_text_2"
    assert instance.mensageiro == "sample_text_2"
...
def test_mdc_Chatbot_nluService_value_roundtrip():
    instance = mdc_Chatbot(mensageiro="sample_text", name="sample_text", nluService="sample_text", token="sample_text", tokenNluService="sample_text")
    assert instance.nluService == "sample_text"
    instance.nluService = "sample_text_2"
    assert instance.nluService == "sample_text_2"
...
def test_mdc_Chatbot_tokenNluService_value_roundtrip():
    instance = mdc_Chatbot(mensageiro="sample_text", name="sample_text", nluService="sample_text", token="sample_text", tokenNluService="sample_text")
    assert instance.tokenNluService == "sample_text"
    instance.tokenNluService = "sample_text_2"
    assert instance.tokenNluService == "sample_text_2"
...
def test_assoc_initState1_link_reassign_clear():
    a = mdc_StationaryState()
    b1 = mdc_Chatbot(mensageiro="sample_text", name="sample_text", nluService="sample_text", token="sample_text", tokenNluService="sample_text")
    b2 = mdc_Chatbot(mensageiro="sample_text_2", name="sample_text_2", nluService="sample_text_2", token="sample_text_2", tokenNluService="sample_text_2")
...
mdc_Chatbot_strategy = st.builds(mdc_Chatbot, mensageiro=safe_text, name=safe_text, nluService=safe_text, token=safe_text, tokenNluService=safe_text)
@given(instance=mdc_Chatbot_strategy)
@settings(max_examples=25)
