...
# Classes
lua_LastStatement = Class(name="lua_LastStatement")
lua_LastStatement_Return = Class(name="lua_LastStatement_Return")
LastStatement = Class(name="LastStatement")
lua_LastStatement_Break = Class(name="lua_LastStatement_Break")
lua_Statement_Block = Class(name="lua_Statement_Block")
Statement = Class(name="Statement")
lua_Statement_While = Class(name="lua_Statement_While")
lua_Chunk = Class(name="lua_Chunk")
lua_Block = Class(name="lua_Block")
Chunk = Class(name="Chunk")
lua_Statement = Class(name="lua_Statement")
lua_Statement_If_Then_Else_ElseIfPart = Class(name="lua_Statement_If_Then_Else_ElseIfPart")
lua_Statement_For_Numeric = Class(name="lua_Statement_For_Numeric")
lua_Expression = Class(name="lua_Expression")
lua_Statement_Repeat = Class(name="lua_Statement_Repeat")
lua_Statement_If_Then_Else = Class(name="lua_Statement_If_Then_Else")
lua_Statement_GlobalFunction_Declaration = Class(name="lua_Statement_GlobalFunction_Declaration")
lua_Function = Class(name="lua_Function")
lua_Statement_LocalFunction_Declaration = Class(name="lua_Statement_LocalFunction_Declaration")
lua_Statement_Local_Variable_Declaration = Class(name="lua_Statement_Local_Variable_Declaration")
lua_Statement_For_Generic = Class(name="lua_Statement_For_Generic")
lua_Expression_True = Class(name="lua_Expression_True")
lua_Expression_False = Class(name="lua_Expression_False")
lua_Expression_Number = Class(name="lua_Expression_Number")
lua_Expression_VarArgs = Class(name="lua_Expression_VarArgs")
lua_Expression_String = Class(name="lua_Expression_String")
lua_Expression_Function = Class(name="lua_Expression_Function")
lua_Statement_FunctioncallOrAssignment = Class(name="lua_Statement_FunctioncallOrAssignment")
Statement_FunctioncallOrAssignment = Class(name="Statement_FunctioncallOrAssignment")
lua_Expression_Nil = Class(name="lua_Expression_Nil")
Expression = Class(name="Expression")
lua_Field_AddEntryToTable_Brackets = Class(name="lua_Field_AddEntryToTable_Brackets")
Field = Class(name="Field")
lua_Field_AddEntryToTable = Class(name="lua_Field_AddEntryToTable")
lua_Field_AppendEntryToTable = Class(name="lua_Field_AppendEntryToTable")
lua_Expression_TableConstructor = Class(name="lua_Expression_TableConstructor")
lua_Field = Class(name="lua_Field")
lua_Functioncall_Arguments = Class(name="lua_Functioncall_Arguments")
lua_Statement_CallFunction = Class(name="lua_Statement_CallFunction")
lua_Expression_Or = Class(name="lua_Expression_Or")
lua_LastStatement_ReturnWithValue = Class(name="lua_LastStatement_ReturnWithValue")
LastStatement_Return = Class(name="LastStatement_Return")
lua_Statement_Assignment = Class(name="lua_Statement_Assignment")
lua_Statement_CallMemberFunction = Class(name="lua_Statement_CallMemberFunction")
lua_Expression_Larger_Equal = Class(name="lua_Expression_Larger_Equal")
lua_Expression_Smaller = Class(name="lua_Expression_Smaller")
lua_Expression_And = Class(name="lua_Expression_And")
lua_Expression_Larger = Class(name="lua_Expression_Larger")
lua_Expression_Not_Equal = Class(name="lua_Expression_Not_Equal")
lua_Expression_Concatenation = Class(name="lua_Expression_Concatenation")
lua_Expression_Plus = Class(name="lua_Expression_Plus")
lua_Expression_Smaller_Equal = Class(name="lua_Expression_Smaller_Equal")
lua_Expression_Equal = Class(name="lua_Expression_Equal")
lua_Expression_Division = Class(name="lua_Expression_Division")
lua_Expression_Modulo = Class(name="lua_Expression_Modulo")
lua_Expression_Minus = Class(name="lua_Expression_Minus")
lua_Expression_Multiplication = Class(name="lua_Expression_Multiplication")
lua_Expression_Invert = Class(name="lua_Expression_Invert")
lua_Expression_Exponentiation = Class(name="lua_Expression_Exponentiation")
lua_Expression_Negate = Class(name="lua_Expression_Negate")
lua_Expression_Length = Class(name="lua_Expression_Length")
lua_Expression_AccessArray = Class(name="lua_Expression_AccessArray")
lua_Expression_AccessMember = Class(name="lua_Expression_AccessMember")
lua_Expression_CallMemberFunction = Class(name="lua_Expression_CallMemberFunction")
lua_Expression_CallFunction = Class(name="lua_Expression_CallFunction")
lua_Expression_VariableName = Class(name="lua_Expression_VariableName")
lua_Environment = Class(name="lua_Environment")

# lua_LastStatement class attributes and methods
lua_LastStatement_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
lua_LastStatement.methods={lua_LastStatement_m_execute}

# lua_LastStatement_Return class attributes and methods
lua_LastStatement_Return_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Statement_Block_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
lua_Statement_Block.methods={lua_Statement_Block_m_execute}

# Statement class attributes and methods

# lua_Statement_While class attributes and methods
lua_Statement_While_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
lua_Statement_While.methods={lua_Statement_While_m_execute}

# lua_Chunk class attributes and methods
lua_Chunk_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
lua_Chunk.methods={lua_Chunk_m_execute}

# lua_Block class attributes and methods
lua_Block_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
lua_Block.methods={lua_Block_m_execute}

# Chunk class attributes and methods

# lua_Statement class attributes and methods
lua_Statement_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
lua_Statement.methods={lua_Statement_m_execute}

# lua_Statement_If_Then_Else_ElseIfPart class attributes and methods
lua_Statement_If_Then_Else_ElseIfPart_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Statement_For_Numeric_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Expression_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
lua_Expression.methods={lua_Expression_m_execute}

# lua_Statement_Repeat class attributes and methods
lua_Statement_Repeat_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
lua_Statement_Repeat.methods={lua_Statement_Repeat_m_execute}

# lua_Statement_If_Then_Else class attributes and methods
lua_Statement_If_Then_Else_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Statement_GlobalFunction_Declaration_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Function_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Statement_LocalFunction_Declaration_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Statement_Local_Variable_Declaration_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Statement_For_Generic_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Expression_True_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
lua_Expression_True.methods={lua_Expression_True_m_execute}

# lua_Expression_False class attributes and methods
lua_Expression_False_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Expression_Number_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Expression_VarArgs_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Expression_String_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Expression_Function_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Statement_FunctioncallOrAssignment_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Expression_Nil_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Field_AddEntryToTable_Brackets_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Field_AddEntryToTable_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Field_AppendEntryToTable_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Expression_TableConstructor_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
lua_Expression_TableConstructor.methods={lua_Expression_TableConstructor_m_execute}

# lua_Field class attributes and methods
lua_Field_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
lua_Field.methods={lua_Field_m_execute}

# lua_Functioncall_Arguments class attributes and methods
lua_Functioncall_Arguments_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Statement_CallFunction_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
lua_Statement_CallFunction.methods={lua_Statement_CallFunction_m_execute}

# lua_Expression_Or class attributes and methods
lua_Expression_Or_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
lua_Expression_Or.methods={lua_Expression_Or_m_execute}

# lua_LastStatement_ReturnWithValue class attributes and methods
lua_LastStatement_ReturnWithValue_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Statement_Assignment_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Statement_CallMemberFunction_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Expression_Larger_Equal_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Expression_Smaller_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
lua_Expression_Smaller.methods={lua_Expression_Smaller_m_execute}

# lua_Expression_And class attributes and methods
lua_Expression_And_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
lua_Expression_And.methods={lua_Expression_And_m_execute}

# lua_Expression_Larger class attributes and methods
lua_Expression_Larger_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
lua_Expression_Larger.methods={lua_Expression_Larger_m_execute}

# lua_Expression_Not_Equal class attributes and methods
lua_Expression_Not_Equal_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Expression_Concatenation_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Expression_Plus_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
lua_Expression_Plus.methods={lua_Expression_Plus_m_execute}

# lua_Expression_Smaller_Equal class attributes and methods
lua_Expression_Smaller_Equal_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Expression_Equal_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
lua_Expression_Equal.methods={lua_Expression_Equal_m_execute}

# lua_Expression_Division class attributes and methods
lua_Expression_Division_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
lua_Expression_Division.methods={lua_Expression_Division_m_execute}

# lua_Expression_Modulo class attributes and methods
lua_Expression_Modulo_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
lua_Expression_Modulo.methods={lua_Expression_Modulo_m_execute}

# lua_Expression_Minus class attributes and methods
lua_Expression_Minus_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
lua_Expression_Minus.methods={lua_Expression_Minus_m_execute}

# lua_Expression_Multiplication class attributes and methods
lua_Expression_Multiplication_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Expression_Invert_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
lua_Expression_Invert.methods={lua_Expression_Invert_m_execute}

# lua_Expression_Exponentiation class attributes and methods
lua_Expression_Exponentiation_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Expression_Negate_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
lua_Expression_Negate.methods={lua_Expression_Negate_m_execute}

# lua_Expression_Length class attributes and methods
lua_Expression_Length_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
lua_Expression_Length.methods={lua_Expression_Length_m_execute}

# lua_Expression_AccessArray class attributes and methods
lua_Expression_AccessArray_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Expression_AccessMember_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Expression_CallMemberFunction_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Expression_CallFunction_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Expression_VariableName_m_execute: Method = Method(name="execute", parameters={Parameter(name='lua_c', type=StringType)})
...
lua_Environment_m_putFunction: Method = Method(name="putFunction", parameters={Parameter(name='lua_f', type=StringType), Parameter(name='lua_s', type=StringType)})
lua_Environment_m_getFunction: Method = Method(name="getFunction", parameters={Parameter(name='lua_s', type=StringType)}, type=StringType)
lua_Environment_m_putVariable: Method = Method(name="putVariable", parameters={Parameter(name='lua_s', type=StringType), Parameter(name='lua_o', type=StringType)})
lua_Environment_m_putAllVariables: Method = Method(name="putAllVariables", parameters={Parameter(name='lua_v', type=StringType)})
lua_Environment_m_putAllFunctions: Method = Method(name="putAllFunctions", parameters={Parameter(name='lua_f', type=StringType)})
lua_Environment_m_pushAllValues: Method = Method(name="pushAllValues", parameters={Parameter(name='lua_v', type=StringType)})
...
lua_Environment_m_getVariable: Method = Method(name="getVariable", parameters={Parameter(name='lua_s', type=StringType)}, type=StringType)
lua_Environment_m_pushValue: Method = Method(name="pushValue", parameters={Parameter(name='lua_o', type=StringType)})
lua_Environment.methods={lua_Environment_m_putAllVariables, lua_Environment_m_putVariable, lua_Environment_m_getFunction, lua_Environment_m_pushAllValues, lua_Environment_m_getVariables, lua_Environment_m_putAllFunctions, lua_Environment_m_getFunctions, lua_Environment_m_putFunction, lua_Environment_m_pushValue, lua_Environment_m_popValue, lua_Environment_m_getVariable, lua_Environment_m_getValues}
...
domain_model = DomainModel(
    name="lua",
    types={lua_LastStatement, lua_LastStatement_Return, LastStatement, lua_LastStatement_Break, lua_Statement_Block, Statement, lua_Statement_While, lua_Chunk, lua_Block, Chunk, lua_Statement, lua_Statement_If_Then_Else_ElseIfPart, lua_Statement_For_Numeric, lua_Expression, lua_Statement_Repeat, lua_Statement_If_Then_Else, lua_Statement_GlobalFunction_Declaration, lua_Function, lua_Statement_LocalFunction_Declaration, lua_Statement_Local_Variable_Declaration, lua_Statement_For_Generic, lua_Expression_True, lua_Expression_False, lua_Expression_Number, lua_Expression_VarArgs, lua_Expression_String, lua_Expression_Function, lua_Statement_FunctioncallOrAssignment, Statement_FunctioncallOrAssignment, lua_Expression_Nil, Expression, lua_Field_AddEntryToTable_Brackets, Field, lua_Field_AddEntryToTable, lua_Field_AppendEntryToTable, lua_Expression_TableConstructor, lua_Field, lua_Functioncall_Arguments, lua_Statement_CallFunction, lua_Expression_Or, lua_LastStatement_ReturnWithValue, LastStatement_Return, lua_Statement_Assignment, lua_Statement_CallMemberFunction, lua_Expression_Larger_Equal, lua_Expression_Smaller, lua_Expression_And, lua_Expression_Larger, lua_Expression_Not_Equal, lua_Expression_Concatenation, lua_Expression_Plus, lua_Expression_Smaller_Equal, lua_Expression_Equal, lua_Expression_Division, lua_Expression_Modulo, lua_Expression_Minus, lua_Expression_Multiplication, lua_Expression_Invert, lua_Expression_Exponentiation, lua_Expression_Negate, lua_Expression_Length, lua_Expression_AccessArray, lua_Expression_AccessMember, lua_Expression_CallMemberFunction, lua_Expression_CallFunction, lua_Expression_VariableName, lua_Environment},
    associations={returnValue1, block3, statements0, ifExpression14, ifBlock16, elseIf19, elseBlock21, elseifExpression24, elseifBlock27, startExpr30, expression5, block6, block9, expression11, block43, function46, function47, untilExpr32, stepExpr35, block38, expressions41, initialValue49, arguments57, value59, indexExpression62, function51, fields53, body54, object71, arguments73, object76, arguments78, left81, returnValues64, variable66, values68, left91, right93, left96, right98, left101, right103, right83, left86, right88, left116, right118, left121, right123, left106, right108, left111, right113, left136, right138, left141, right143, left126, right128, left131, right133, exp155, left157, left146, right148, exp151, exp153, object167, arguments169, array172, index174, right159, object162, arguments164, object177, parent180},
    generalizations={gen_lua_LastStatement_Return_LastStatement, gen_lua_LastStatement_Break_LastStatement, gen_lua_Statement_Block_Statement, gen_lua_Statement_While_Statement, gen_lua_Block_Chunk, gen_lua_Statement_For_Numeric_Statement, gen_lua_Statement_Repeat_Statement, gen_lua_Statement_If_Then_Else_Statement, gen_lua_Statement_GlobalFunction_Declaration_Statement, gen_lua_Statement_LocalFunction_Declaration_Statement, gen_lua_Statement_Local_Variable_Declaration_Statement, gen_lua_Statement_For_Generic_Statement, gen_lua_Expression_True_Expression, gen_lua_Expression_False_Expression, gen_lua_Expression_Number_Expression, gen_lua_Expression_VarArgs_Expression, gen_lua_Expression_String_Expression, gen_lua_Expression_Function_Expression, gen_lua_Statement_FunctioncallOrAssignment_Statement, gen_lua_Expression_Statement_FunctioncallOrAssignment, gen_lua_Expression_Nil_Expression, gen_lua_Field_AddEntryToTable_Brackets_Field, gen_lua_Field_AddEntryToTable_Field, gen_lua_Field_AppendEntryToTable_Field, gen_lua_Expression_TableConstructor_Expression, gen_lua_Statement_CallFunction_Statement_FunctioncallOrAssignment, gen_lua_Expression_Or_Expression, gen_lua_LastStatement_ReturnWithValue_LastStatement_Return, gen_lua_Statement_Assignment_Statement_FunctioncallOrAssignment, gen_lua_Statement_CallMemberFunction_Statement_FunctioncallOrAssignment, gen_lua_Expression_Larger_Equal_Expression, gen_lua_Expression_Smaller_Expression, gen_lua_Expression_And_Expression, gen_lua_Expression_Larger_Expression, gen_lua_Expression_Not_Equal_Expression, gen_lua_Expression_Concatenation_Expression, gen_lua_Expression_Plus_Expression, gen_lua_Expression_Smaller_Equal_Expression, gen_lua_Expression_Equal_Expression, gen_lua_Expression_Division_Expression, gen_lua_Expression_Modulo_Expression, gen_lua_Expression_Minus_Expression, gen_lua_Expression_Multiplication_Expression, gen_lua_Expression_Invert_Expression, gen_lua_Expression_Exponentiation_Expression, gen_lua_Expression_Negate_Expression, gen_lua_Expression_Length_Expression, gen_lua_Expression_AccessArray_Expression, gen_lua_Expression_AccessMember_Expression, gen_lua_Expression_CallMemberFunction_Expression, gen_lua_Expression_CallFunction_Expression, gen_lua_Expression_VariableName_Expression},
    metadata=None
)
