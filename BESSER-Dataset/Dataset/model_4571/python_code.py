...
class lua_Block(Chunk):
    ...
    def __init__(self, lua_Block23: "lua_Statement_If_Then_Else" = None, lua_Block29: "lua_Statement_If_Then_Else_ElseIfPart" = None, lua_Block8: "lua_Statement_While" = None, lua_Block10: "lua_Statement_Repeat" = None, lua_Block2: "lua_LastStatement" = None, lua_Block4: "lua_Statement_Block" = None, lua_Block: set["lua_Statement"] = None, lua_Block18: "lua_Statement_If_Then_Else" = None, lua_Block45: "lua_Statement_For_Generic" = None, lua_Block40: "lua_Statement_For_Numeric" = None, lua_Block56: "lua_Function" = None):
...
class lua_Environment:
    ...
    def pushAllValues(self, lua_v):
        # TODO: Implement pushAllValues method
        pass

    def putVariable(self, lua_o, lua_s):
        # TODO: Implement putVariable method
        pass

    def getFunction(self, lua_s) :
    ...
    def putAllFunctions(self, lua_f):
        # TODO: Implement putAllFunctions method
        pass

    def pushValue(self, lua_o):
        # TODO: Implement pushValue method
        pass

    def putFunction(self, lua_s, lua_f):
    ...
    def putAllVariables(self, lua_v):
        # TODO: Implement putAllVariables method
        pass

    def getVariable(self, lua_s) :
...
class lua_Functioncall_Arguments:
    ...
    def __init__(self, lua_Functioncall_Arguments: set["lua_Expression"] = None, lua_Functioncall_Arguments75: "lua_Statement_CallMemberFunction" = None, lua_Functioncall_Arguments80: "lua_Statement_CallFunction" = None, lua_Functioncall_Arguments171: "lua_Expression_CallFunction" = None, lua_Functioncall_Arguments166: "lua_Expression_CallMemberFunction" = None):
...
class lua_Expression_Larger_Equal(Expression):
    ...
    def __init__(self, lua_Expression_Larger_Equal99: "lua_Expression" = None, lua_Expression_Larger_Equal: "lua_Expression" = None):
...
class lua_Expression_Smaller(Expression):
    ...
    def __init__(self, lua_Expression_Smaller: "lua_Expression" = None, lua_Expression_Smaller104: "lua_Expression" = None):
...
class lua_Expression_Or(Expression):
    ...
    def __init__(self, lua_Expression_Or84: "lua_Expression" = None, lua_Expression_Or: "lua_Expression" = None):
...
class lua_Expression_Division(Expression):
    ...
    def __init__(self, lua_Expression_Division: "lua_Expression" = None, lua_Expression_Division144: "lua_Expression" = None):
...
class lua_Statement_For_Generic(Statement):
    ...
    def __init__(self, names: str, lua_Statement_For_Generic44: "lua_Block" = None, lua_Statement_For_Generic: set["lua_Expression"] = None):
        self.names = names
...
class lua_Statement_If_Then_Else(Statement):
    ...
    def __init__(self, lua_Statement_If_Then_Else22: "lua_Block" = None, lua_Statement_If_Then_Else: "lua_Expression" = None, lua_Statement_If_Then_Else17: "lua_Block" = None, lua_Statement_If_Then_Else20: set["lua_Statement_If_Then_Else_ElseIfPart"] = None):
...
class lua_Statement_Repeat(Statement):
    ...
    def __init__(self, lua_Statement_Repeat: "lua_Block" = None, lua_Statement_Repeat12: "lua_Expression" = None):
...
class lua_Expression(Statement_FunctioncallOrAssignment):
    ...
    def __init__(self, lua_Expression26: "lua_Statement_If_Then_Else_ElseIfPart" = None, lua_Expression31: "lua_Statement_For_Numeric" = None, lua_Expression: "lua_Statement_While" = None, lua_Expression15: "lua_Statement_If_Then_Else" = None, lua_Expression100: "lua_Expression_Larger_Equal" = None, lua_Expression102: "lua_Expression_Smaller" = None, lua_Expression105: "lua_Expression_Smaller" = None, lua_Expression85: "lua_Expression_Or" = None, lua_Expression87: "lua_Expression_And" = None, lua_Expression90: "lua_Expression_And" = None, lua_Expression117: "lua_Expression_Not_Equal" = None, lua_Expression120: "lua_Expression_Not_Equal" = None, lua_Expression13: "lua_Statement_Repeat" = None, lua_Expression34: "lua_Statement_For_Numeric" = None, lua_Expression37: "lua_Statement_For_Numeric" = None, lua_Expression42: "lua_Statement_For_Generic" = None, lua_Expression50: "lua_Statement_Local_Variable_Declaration" = None, lua_Expression58: "lua_Functioncall_Arguments" = None, lua_Expression61: "lua_Field" = None, lua_Expression63: "lua_Field_AddEntryToTable_Brackets" = None, lua_Expression72: "lua_Statement_CallMemberFunction" = None, lua_Expression77: "lua_Statement_CallFunction" = None, lua_Expression82: "lua_Expression_Or" = None, lua_Expression65: "lua_LastStatement_ReturnWithValue" = None, lua_Expression67: "lua_Statement_Assignment" = None, lua_Expression70: "lua_Statement_Assignment" = None, lua_Expression92: "lua_Expression_Larger" = None, lua_Expression95: "lua_Expression_Larger" = None, lua_Expression97: "lua_Expression_Larger_Equal" = None, lua_Expression150: "lua_Expression_Modulo" = None, lua_Expression152: "lua_Expression_Negate" = None, lua_Expression154: "lua_Expression_Length" = None, lua_Expression168: "lua_Expression_CallFunction" = None, lua_Expression173: "lua_Expression_AccessArray" = None, lua_Expression122: "lua_Expression_Concatenation" = None, lua_Expression125: "lua_Expression_Concatenation" = None, lua_Expression107: "lua_Expression_Smaller_Equal" = None, lua_Expression110: "lua_Expression_Smaller_Equal" = None, lua_Expression112: "lua_Expression_Equal" = None, lua_Expression115: "lua_Expression_Equal" = None, lua_Expression137: "lua_Expression_Multiplication" = None, lua_Expression140: "lua_Expression_Multiplication" = None, lua_Expression142: "lua_Expression_Division" = None, lua_Expression145: "lua_Expression_Division" = None, lua_Expression127: "lua_Expression_Plus" = None, lua_Expression130: "lua_Expression_Plus" = None, lua_Expression132: "lua_Expression_Minus" = None, lua_Expression135: "lua_Expression_Minus" = None, lua_Expression156: "lua_Expression_Invert" = None, lua_Expression158: "lua_Expression_Exponentiation" = None, lua_Expression147: "lua_Expression_Modulo" = None, lua_Expression176: "lua_Expression_AccessArray" = None, lua_Expression161: "lua_Expression_Exponentiation" = None, lua_Expression163: "lua_Expression_CallMemberFunction" = None, lua_Expression178: "lua_Expression_AccessMember" = None):
...
class lua_Statement_If_Then_Else_ElseIfPart:
    ...
    def __init__(self, lua_Statement_If_Then_Else_ElseIfPart25: "lua_Expression" = None, lua_Statement_If_Then_Else_ElseIfPart28: "lua_Block" = None, lua_Statement_If_Then_Else_ElseIfPart: "lua_Statement_If_Then_Else" = None):
