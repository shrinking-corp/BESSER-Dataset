...
domain_model = DomainModel(
    name="library",
    types={library_Employee, library_Shelf, library_Library, library_Author, library_Book},
    associations={author1, shelves2, shelves3, books0, authors5, employees7, books10},
    generalizations={},
    metadata=None
)
