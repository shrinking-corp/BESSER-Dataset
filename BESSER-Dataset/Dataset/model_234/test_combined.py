...
def test_hyp_ecore_ememoclass_is_not_abstract():
    assert not inspect.isabstract(ecore_EMemoClass)


def test_hyp_ecore_ememoclass_constructor_exists():
    assert callable(ecore_EMemoClass.__init__)


def test_hyp_ecore_ememoclass_constructor_args():
    sig = inspect.signature(ecore_EMemoClass.__init__)
    params = list(sig.parameters.keys())
...
ecore_EMemoClass_strategy = st.builds(
    ecore_EMemoClass,
    instances=
        safe_text
)
...
@given(instance=ecore_EMemoClass_strategy)
def test_hyp_ecore_ememoclass_instances_setter(instance):
...
def test_ecore_EMemoClass_instances_value_roundtrip():
    instance = ecore_EMemoClass(instances="sample_text")
...
def test_ecore_EMemoClass_isa_EClass():
    instance = ecore_EMemoClass(instances="sample_text")
...
ecore_EMemoClass_strategy = st.builds(ecore_EMemoClass, instances=safe_text)
@given(instance=ecore_EMemoClass_strategy)
@settings(max_examples=25)
def test_ecore_EMemoClass_instantiation(instance):
    assert isinstance(instance, ecore_EMemoClass)
