...
class Department:
    ...
    def __init__(self, course: Course, students__: Student, teachers__: Teacher, hod: HOD, access_Information19: "Access_Information" = None, course0: "Course" = None, student4: set["Student"] = None, Teacher6: set["Teacher_Interface"] = None):
        self.course = course
        ...
        self.Teacher6 = Teacher6 if Teacher6 is not None else set()
    ...
    @property
    def Teacher6(self):
        return self.__Teacher6
    @Teacher6.setter
    def Teacher6(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Department__Teacher6", None)
        self.__Teacher6 = value if value is not None else set()
