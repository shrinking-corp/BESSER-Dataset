...
def test_hyp_graph_abstractnamedobject_is_not_abstract():
    assert not inspect.isabstract(graph_AbstractNamedObject)


def test_hyp_graph_abstractnamedobject_constructor_exists():
    assert callable(graph_AbstractNamedObject.__init__)


def test_hyp_graph_abstractnamedobject_constructor_args():
...
def test_hyp_abstractnamedobject_is_not_abstract():
    assert not inspect.isabstract(AbstractNamedObject)


def test_hyp_abstractnamedobject_constructor_exists():
    assert callable(AbstractNamedObject.__init__)


def test_hyp_abstractnamedobject_constructor_args():
...
def test_hyp_graph_abstractnamedobject_name_setter(instance):
