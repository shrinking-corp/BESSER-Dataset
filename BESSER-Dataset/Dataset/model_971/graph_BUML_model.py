...
graph_AbstractNamedObject = Class(name="graph_AbstractNamedObject", is_abstract=True)
...
domain_model = DomainModel(
    name="graph",
    types={graph_Graph, AbstractNamedObject, graph_AbstractNamedObject, graph_Node, graph_Edge},
    associations={nodes0, incomingEdges1, outgoingEdges2, source4, target5},
    generalizations={gen_graph_Graph_AbstractNamedObject, gen_graph_Node_AbstractNamedObject},
    metadata=None
)
