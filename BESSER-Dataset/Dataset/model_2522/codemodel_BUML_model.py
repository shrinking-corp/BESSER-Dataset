...
codemodel_CodeModel = Class(name="codemodel_CodeModel")
CMElement = Class(name="CMElement")
codemodel_Variable = Class(name="codemodel_Variable")
Statement = Class(name="Statement")
codemodel_D = Class(name="codemodel_D")
codemodel_E = Class(name="codemodel_E")
codemodel_Root = Class(name="codemodel_Root")
codemodel_expressions_VarExp = Class(name="codemodel_expressions_VarExp")
Expression = Class(name="Expression")
expressions_codemodel_Variable = Class(name="expressions_codemodel_Variable")
codemodel_expressions_BinExp = Class(name="codemodel_expressions_BinExp")
codemodel_statements_Statement = Class(name="codemodel_statements_Statement", is_abstract=True)
codemodel_statements_AsgnStmt = Class(name="codemodel_statements_AsgnStmt")
codemodel_statements_CompStmt = Class(name="codemodel_statements_CompStmt")
...
domain_model = DomainModel(
    name="codemodel",
    types={codemodel_CMElement, codemodel_CodeModel, CMElement, codemodel_Variable, Statement, codemodel_D, codemodel_E, codemodel_Root, codemodel_expressions_VarExp, Expression, expressions_codemodel_Variable, codemodel_expressions_BinExp, codemodel_statements_Statement, codemodel_statements_AsgnStmt, codemodel_statements_CompStmt, codemodel_expressions_Expression},
    associations={vars0, stmts1, refE3, variable5, left6, right7, leftExp10, rightExp12, statements15, elements4},
    generalizations={gen_codemodel_CodeModel_CMElement, gen_codemodel_Variable_CMElement, gen_codemodel_D_CMElement, gen_codemodel_E_CMElement, gen_codemodel_Root_CMElement, gen_codemodel_expressions_VarExp_Expression, gen_codemodel_expressions_BinExp_Expression, gen_codemodel_statements_Statement_CMElement, gen_codemodel_statements_AsgnStmt_Statement, gen_codemodel_statements_CompStmt_Statement, gen_codemodel_expressions_Expression_CMElement},
    metadata=None
)
