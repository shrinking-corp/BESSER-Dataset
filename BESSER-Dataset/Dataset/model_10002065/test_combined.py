...
def test_hyp_exceptions_is_not_abstract():
    assert not inspect.isabstract(Exceptions)


def test_hyp_exceptions_constructor_exists():
    assert callable(Exceptions.__init__)


def test_hyp_exceptions_constructor_args():
...
def test_hyp_binary_file_is_not_abstract():
    assert not inspect.isabstract(Binary_File)


def test_hyp_binary_file_constructor_exists():
    assert callable(Binary_File.__init__)


def test_hyp_binary_file_constructor_args():
...
def test_hyp_stuff_is_not_abstract():
    assert not inspect.isabstract(Stuff)


def test_hyp_stuff_constructor_exists():
    assert callable(Stuff.__init__)


def test_hyp_stuff_constructor_args():
...
@given(instance=Course_strategy)
def test_hyp_course_CInstructor_setter(instance):
...
@given(instance=Course_strategy)
def test_hyp_course_CCode_setter(instance):
...
@given(instance=Department_strategy)
def test_hyp_department_deptName_setter(instance):
...
def test_hyp_student_SGender_setter(instance):
...
@given(instance=Student_strategy)
def test_hyp_student_SAge_setter(instance):
...
def test_hyp_stuff_WorkHours_setter(instance):
...
@given(instance=Stuff_strategy)
def test_hyp_stuff_Salary_setter(instance):
...
@given(instance=Person_strategy)
def test_hyp_person_PhoneNum_setter(instance):
