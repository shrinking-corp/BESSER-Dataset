...
class bpmn2_CatchEvent(Event):
    ...
    def __init__(self, parallelMultiple: bool, bpmn2_CatchEvent286: set["bpmn2_EventDefinition"] = None, bpmn2_CatchEvent294: set["bpmn2_EventDefinition"] = None, bpmn2_CatchEvent288: set["bpmn2_DataOutputAssociation"] = None, bpmn2_CatchEvent291: set["bpmn2_DataOutput"] = None, bpmn2_CatchEvent: "bpmn2_OutputSet" = None):
...
class bpmn2_ChoreographyActivity(FlowNode):
    ...
    def __init__(self, loopType: str, bpmn2_ChoreographyActivity398: set["bpmn2_CorrelationKey"] = None, bpmn2_ChoreographyActivity: set["bpmn2_Participant"] = None, bpmn2_ChoreographyActivity395: "bpmn2_Participant" = None):
...
class bpmn2_Activity(FlowNode):
    ...
    def __init__(self, isForCompensation: bool, startQuantity: int, completionQuantity: int, bpmn2_Activity: "bpmn2_LoopCharacteristics" = None, bpmn2_Activity354: "bpmn2_CompensateEventDefinition" = None, bpmn2_Activity266: set["bpmn2_ResourceRole"] = None, bpmn2_Activity269: "bpmn2_SequenceFlow" = None, bpmn2_Activity272: set["bpmn2_Property"] = None, bpmn2_Activity275: "bpmn2_InputOutputSpecification" = None, attachedToRef: set["bpmn2_BoundaryEvent"] = None, bpmn2_Activity279: set["bpmn2_DataInputAssociation"] = None, bpmn2_Activity281: set["bpmn2_DataOutputAssociation"] = None, Activity: "bpmn2_BoundaryEvent" = None):
...
class bpmn2_SequenceFlow(FlowElement):
    ...
    def __init__(self, isImmediate: bool, SequenceFlow: "bpmn2_FlowNode" = None, SequenceFlow153: "bpmn2_FlowNode" = None, bpmn2_SequenceFlow: "bpmn2_Expression" = None, incoming: "bpmn2_FlowNode" = None, outgoing: "bpmn2_FlowNode" = None, bpmn2_SequenceFlow321: "bpmn2_ComplexGateway" = None, bpmn2_SequenceFlow323: "bpmn2_ExclusiveGateway" = None, bpmn2_SequenceFlow325: "bpmn2_InclusiveGateway" = None, bpmn2_SequenceFlow270: "bpmn2_Activity" = None):
...
class bpmn2_DataOutput(ItemAwareElement):
    ...
    def __init__(self, isCollection: bool, name: str, DataOutput: "bpmn2_OutputSet" = None, DataOutput71: "bpmn2_OutputSet" = None, DataOutput73: "bpmn2_OutputSet" = None, optionalOutputRefs: set["bpmn2_OutputSet"] = None, whileExecutingOutputRefs: set["bpmn2_OutputSet"] = None, dataOutputRefs: set["bpmn2_OutputSet"] = None, bpmn2_DataOutput: "bpmn2_InputOutputSpecification" = None, bpmn2_DataOutput292: "bpmn2_CatchEvent" = None, bpmn2_DataOutput436: "bpmn2_MultiInstanceLoopCharacteristics" = None):
...
class bpmn2_Property(ItemAwareElement):
    ...
    def __init__(self, name: str, bpmn2_Property: "bpmn2_Process" = None, bpmn2_Property297: "bpmn2_Event" = None, bpmn2_Property273: "bpmn2_Activity" = None):
        self.name = name
...
class bpmn2_DataInput(ItemAwareElement):
    ...
    def __init__(self, name: str, isCollection: bool, whileExecutingInputRefs: set["bpmn2_InputSet"] = None, dataInputRefs: set["bpmn2_InputSet"] = None, optionalInputRefs: set["bpmn2_InputSet"] = None, bpmn2_DataInput: "bpmn2_InputOutputSpecification" = None, DataInput: "bpmn2_InputSet" = None, DataInput55: "bpmn2_InputSet" = None, DataInput57: "bpmn2_InputSet" = None, bpmn2_DataInput343: "bpmn2_ThrowEvent" = None, bpmn2_DataInput433: "bpmn2_MultiInstanceLoopCharacteristics" = None):
        self.name = name
        self.isCollection = isCollection
...
class bpmn2_ExtensionAttributeDefinition:
    ...
    def __init__(self, name: str, type: str, isReference: bool, extensionAttributeDefinitions: "bpmn2_ExtensionDefinition" = None, ExtensionAttributeDefinition: "bpmn2_ExtensionDefinition" = None, bpmn2_ExtensionAttributeDefinition: "bpmn2_ExtensionAttributeValue" = None):
        self.name = name
        self.type = type
...
class bpmn2_ExtensionDefinition:
    ...
    def __init__(self, name: str, ExtensionDefinition: "bpmn2_ExtensionAttributeDefinition" = None, bpmn2_ExtensionDefinition: "bpmn2_BaseElement" = None, extensionDefinition: set["bpmn2_ExtensionAttributeDefinition"] = None, bpmn2_ExtensionDefinition332: "bpmn2_Extension" = None):
        self.name = name
...
class bpmn2_Definitions(BaseElement):
    ...
    def __init__(self, name: str, targetNamespace: str, expressionLanguage: str, typeLanguage: str, exporter: str, exporterVersion: str, bpmn2_Definitions: set["bpmn2_Import"] = None, bpmn2_Definitions475: set["bpmn2_Extension"] = None, bpmn2_Definitions478: set["bpmn2_Relationship"] = None, bpmn2_Definitions481: set["bpmn2_RootElement"] = None, bpmn2_Definitions483: set["bpmn2_BPMNDiagram"] = None):
        self.name = name
...
class bpmn2_LaneSet(BaseElement):
    ...
    def __init__(self, name: str, bpmn2_LaneSet143: "bpmn2_Lane" = None, bpmn2_LaneSet: "bpmn2_FlowElementsContainer" = None, bpmn2_LaneSet140: set["bpmn2_Lane"] = None):
        self.name = name
...
class bpmn2_CorrelationKey(BaseElement):
    ...
    def __init__(self, name: str, bpmn2_CorrelationKey: "bpmn2_Collaboration" = None, bpmn2_CorrelationKey236: set["bpmn2_CorrelationProperty"] = None, bpmn2_CorrelationKey234: "bpmn2_ConversationNode" = None, bpmn2_CorrelationKey255: "bpmn2_CorrelationSubscription" = None, bpmn2_CorrelationKey399: "bpmn2_ChoreographyActivity" = None):
        self.name = name
...
class bpmn2_ConversationLink(BaseElement):
    ...
    def __init__(self, name: str, ConversationLink: "bpmn2_InteractionNode" = None, ConversationLink202: "bpmn2_InteractionNode" = None, bpmn2_ConversationLink: "bpmn2_Collaboration" = None, outgoingConversationLinks: "bpmn2_InteractionNode" = None, incomingConversationLinks: "bpmn2_InteractionNode" = None):
        self.name = name
...
class bpmn2_OutputSet(BaseElement):
    ...
    def __init__(self, name: str, outputSetRefs: set["bpmn2_DataOutput"] = None, outputSetWithOptional: set["bpmn2_DataOutput"] = None, outputSetWithWhileExecuting: set["bpmn2_DataOutput"] = None, outputSetRefs75: set["bpmn2_InputSet"] = None, OutputSet78: "bpmn2_DataOutput" = None, OutputSet80: "bpmn2_DataOutput" = None, OutputSet82: "bpmn2_DataOutput" = None, bpmn2_OutputSet: "bpmn2_InputOutputSpecification" = None, OutputSet: "bpmn2_InputSet" = None, bpmn2_OutputSet88: "bpmn2_InputOutputBinding" = None, bpmn2_OutputSet284: "bpmn2_CatchEvent" = None):
        self.name = name
...
class bpmn2_CategoryValue(BaseElement):
    ...
    def __init__(self, value: str, CategoryValue: "bpmn2_FlowElement" = None, categoryValueRef: set["bpmn2_FlowElement"] = None, bpmn2_CategoryValue418: "bpmn2_Category" = None, bpmn2_CategoryValue: "bpmn2_Group" = None):
        self.value = value
...
class bpmn2_InputSet(BaseElement):
    ...
    def __init__(self, name: str, InputSet62: "bpmn2_DataInput" = None, InputSet64: "bpmn2_DataInput" = None, InputSet76: "bpmn2_OutputSet" = None, InputSet: "bpmn2_DataInput" = None, bpmn2_InputSet: "bpmn2_InputOutputSpecification" = None, inputSetRefs: set["bpmn2_DataInput"] = None, inputSetWithOptional: set["bpmn2_DataInput"] = None, inputSetWithWhileExecuting: set["bpmn2_DataInput"] = None, inputSetRefs59: set["bpmn2_OutputSet"] = None, bpmn2_InputSet85: "bpmn2_InputOutputBinding" = None, bpmn2_InputSet334: "bpmn2_ThrowEvent" = None):
        self.name = name
...
class bpmn2_ResourceRole(BaseElement):
    ...
    def __init__(self, name: str, bpmn2_ResourceRole93: "bpmn2_Resource" = None, bpmn2_ResourceRole95: set["bpmn2_ResourceParameterBinding"] = None, bpmn2_ResourceRole97: "bpmn2_ResourceAssignmentExpression" = None, bpmn2_ResourceRole123: "bpmn2_Process" = None, bpmn2_ResourceRole: "bpmn2_GlobalTask" = None, bpmn2_ResourceRole267: "bpmn2_Activity" = None):
        self.name = name
...
class bpmn2_Lane(BaseElement):
    ...
    def __init__(self, name: str, bpmn2_Lane142: "bpmn2_LaneSet" = None, bpmn2_Lane: "bpmn2_LaneSet" = None, bpmn2_Lane145: "bpmn2_BaseElement" = None, lanes: set["bpmn2_FlowNode"] = None, bpmn2_Lane149: "bpmn2_BaseElement" = None, Lane: "bpmn2_FlowNode" = None):
        self.name = name
...
class bpmn2_ItemDefinition(RootElement):
    ...
    def __init__(self, itemKind: str, isCollection: bool, bpmn2_ItemDefinition37: "bpmn2_Error" = None, bpmn2_ItemDefinition: "bpmn2_Message" = None, bpmn2_ItemDefinition31: "bpmn2_EObject" = None, bpmn2_ItemDefinition34: "bpmn2_Import" = None, bpmn2_ItemDefinition66: "bpmn2_ItemAwareElement" = None, bpmn2_ItemDefinition102: "bpmn2_ResourceParameter" = None, bpmn2_ItemDefinition241: "bpmn2_CorrelationProperty" = None, bpmn2_ItemDefinition352: "bpmn2_Escalation" = None, bpmn2_ItemDefinition252: "bpmn2_FormalExpression" = None, bpmn2_ItemDefinition378: "bpmn2_Signal" = None):
...
class bpmn2_Collaboration(RootElement):
    ...
    def __init__(self, name: str, isClosed: bool, bpmn2_Collaboration: "bpmn2_Process" = None, bpmn2_Collaboration162: set["bpmn2_Choreography"] = None, bpmn2_Collaboration164: set["bpmn2_Artifact"] = None, bpmn2_Collaboration171: "bpmn2_ConversationAssociation" = None, bpmn2_Collaboration173: set["bpmn2_Participant"] = None, bpmn2_Collaboration175: set["bpmn2_MessageFlow"] = None, bpmn2_Collaboration177: set["bpmn2_CorrelationKey"] = None, bpmn2_Collaboration179: set["bpmn2_ConversationNode"] = None, bpmn2_Collaboration181: set["bpmn2_ConversationLink"] = None, bpmn2_Collaboration167: set["bpmn2_ParticipantAssociation"] = None, bpmn2_Collaboration169: set["bpmn2_MessageFlowAssociation"] = None, bpmn2_Collaboration382: "bpmn2_CallConversation" = None):
        self.name = name
        self.isClosed = isClosed
...
class bpmn2_Message(RootElement):
    ...
    def __init__(self, name: str, bpmn2_Message: "bpmn2_Operation" = None, bpmn2_Message22: "bpmn2_Operation" = None, bpmn2_Message29: "bpmn2_ItemDefinition" = None, bpmn2_Message219: "bpmn2_MessageFlow" = None, bpmn2_Message246: "bpmn2_CorrelationPropertyRetrievalExpression" = None, bpmn2_Message464: "bpmn2_SendTask" = None, bpmn2_Message469: "bpmn2_ReceiveTask" = None, bpmn2_Message369: "bpmn2_MessageEventDefinition" = None):
        self.name = name
...
class bpmn2_CorrelationProperty(RootElement):
    ...
    def __init__(self, name: str, bpmn2_CorrelationProperty: "bpmn2_CorrelationKey" = None, bpmn2_CorrelationProperty238: set["bpmn2_CorrelationPropertyRetrievalExpression"] = None, bpmn2_CorrelationProperty240: "bpmn2_ItemDefinition" = None, bpmn2_CorrelationProperty263: "bpmn2_CorrelationPropertyBinding" = None):
        self.name = name
