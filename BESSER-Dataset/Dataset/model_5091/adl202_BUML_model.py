...
# Classes
adl202_Component = Class(name="adl202_Component")
adl202_Content = Class(name="adl202_Content")
adl202_Required = Class(name="adl202_Required")
adl202_Provided = Class(name="adl202_Provided")
adl202_BindingAttributes = Class(name="adl202_BindingAttributes")
Interface = Class(name="Interface")
adl202_Binding = Class(name="adl202_Binding")
adl202_Interface = Class(name="adl202_Interface", is_abstract=True)
...
adl202_Content.attributes={adl202_Content_expression, adl202_Content_language}
...
adl202_BindingAttributes.attributes={adl202_BindingAttributes_value, adl202_BindingAttributes_name}
...
domain_model = DomainModel(
    name="adl202",
    types={adl202_Component, adl202_Content, adl202_Required, adl202_Provided, adl202_BindingAttributes, Interface, adl202_Binding, adl202_Interface},
    associations={content0, requiredInterfaces1, providedInterfaces3, to10, attributes13, from_15, contentParent18, bindings21, simpleBindings24, bindings5, subComponents8},
