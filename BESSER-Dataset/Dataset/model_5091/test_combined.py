...
def test_hyp_adl202_interface_is_not_abstract():
    assert not inspect.isabstract(adl202_Interface)


def test_hyp_adl202_interface_constructor_exists():
    assert callable(adl202_Interface.__init__)


def test_hyp_adl202_interface_constructor_args():
...
def test_hyp_adl202_binding_is_not_abstract():
    assert not inspect.isabstract(adl202_Binding)


def test_hyp_adl202_binding_constructor_exists():
    assert callable(adl202_Binding.__init__)


def test_hyp_adl202_binding_constructor_args():
...
def test_hyp_adl202_bindingattributes_is_not_abstract():
    assert not inspect.isabstract(adl202_BindingAttributes)


def test_hyp_adl202_bindingattributes_constructor_exists():
    assert callable(adl202_BindingAttributes.__init__)


def test_hyp_adl202_bindingattributes_constructor_args():
...
def test_hyp_adl202_provided_is_not_abstract():
    assert not inspect.isabstract(adl202_Provided)


def test_hyp_adl202_provided_constructor_exists():
    assert callable(adl202_Provided.__init__)


def test_hyp_adl202_provided_constructor_args():
    sig = inspect.signature(adl202_Provided.__init__)
    params = list(sig.parameters.keys())



def test_hyp_adl202_required_is_not_abstract():
    assert not inspect.isabstract(adl202_Required)


def test_hyp_adl202_required_constructor_exists():
    assert callable(adl202_Required.__init__)


def test_hyp_adl202_required_constructor_args():
    sig = inspect.signature(adl202_Required.__init__)
    params = list(sig.parameters.keys())



def test_hyp_adl202_content_is_not_abstract():
    assert not inspect.isabstract(adl202_Content)


def test_hyp_adl202_content_constructor_exists():
    assert callable(adl202_Content.__init__)


def test_hyp_adl202_content_constructor_args():
...
def test_hyp_adl202_component_is_not_abstract():
    assert not inspect.isabstract(adl202_Component)


def test_hyp_adl202_component_constructor_exists():
    assert callable(adl202_Component.__init__)


def test_hyp_adl202_component_constructor_args():
...
def test_hyp_adl202_interface_name_setter(instance):
...
@given(instance=adl202_Interface_strategy)
def test_hyp_adl202_interface_signature_setter(instance):
...
def test_hyp_adl202_binding_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_adl202_bindingattributes_value_setter(instance):
...
@given(instance=adl202_BindingAttributes_strategy)
def test_hyp_adl202_bindingattributes_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_adl202_content_expression_setter(instance):
...
@given(instance=adl202_Content_strategy)
def test_hyp_adl202_content_language_setter(instance):
...
def test_hyp_adl202_component_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
