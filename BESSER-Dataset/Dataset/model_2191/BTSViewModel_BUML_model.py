...
# Classes
btsviewmodel_TreeNodeWrapper = Class(name="btsviewmodel_TreeNodeWrapper")
btsviewmodel_StatusMessage = Class(name="btsviewmodel_StatusMessage")
btsviewmodel_BTSObjectTypeTreeNode = Class(name="btsviewmodel_BTSObjectTypeTreeNode")
btsviewmodel_DBCollectionStatusInformation = Class(name="btsviewmodel_DBCollectionStatusInformation")
...
btsviewmodel_TreeNodeWrapper_m_addPropertyChangeListener: Method = Method(name="addPropertyChangeListener", parameters={Parameter(name='btsviewmodel_propertyChangeListener', type=StringType)})
btsviewmodel_TreeNodeWrapper_m_removePropertyChangeListener: Method = Method(name="removePropertyChangeListener", parameters={Parameter(name='btsviewmodel_propertyChangeListener', type=StringType)})
btsviewmodel_TreeNodeWrapper.attributes={btsviewmodel_TreeNodeWrapper_parentObject, btsviewmodel_TreeNodeWrapper_propertyChangeSupport, btsviewmodel_TreeNodeWrapper_object, btsviewmodel_TreeNodeWrapper_label, btsviewmodel_TreeNodeWrapper_childrenLoaded}
...
btsviewmodel_StatusMessage.attributes={btsviewmodel_StatusMessage_messageType, btsviewmodel_StatusMessage_message, btsviewmodel_StatusMessage_creationTime, btsviewmodel_StatusMessage_userId}
...
btsviewmodel_DBCollectionStatusInformation.attributes={btsviewmodel_DBCollectionStatusInformation_dbDocCount, btsviewmodel_DBCollectionStatusInformation_syncStatusFromRemote, btsviewmodel_DBCollectionStatusInformation_dbUpdateSeq, btsviewmodel_DBCollectionStatusInformation_dbPurgeSeq, btsviewmodel_DBCollectionStatusInformation_indexDocCount, btsviewmodel_DBCollectionStatusInformation_dbCollectionName, btsviewmodel_DBCollectionStatusInformation_syncStatusToRemote, btsviewmodel_DBCollectionStatusInformation_indexStatus, btsviewmodel_DBCollectionStatusInformation_dbDocDelCount, btsviewmodel_DBCollectionStatusInformation_indexUpdateSeq, btsviewmodel_DBCollectionStatusInformation_dbDiskSize}
...
domain_model = DomainModel(
    name="btsviewmodel",
    types={btsviewmodel_TreeNodeWrapper, btsviewmodel_StatusMessage, btsviewmodel_BTSObjectTypeTreeNode, btsviewmodel_DBCollectionStatusInformation, MessageType},
