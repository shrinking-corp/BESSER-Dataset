...
class btsviewmodel_DBCollectionStatusInformation:
    ...
    def __init__(self, syncStatusToRemote: str, syncStatusFromRemote: str, indexDocCount: str, indexStatus: str, dbDiskSize: str, dbDocDelCount: str, dbPurgeSeq: str, dbUpdateSeq: str, indexUpdateSeq: str, dbCollectionName: str, dbDocCount: str):
...
class btsviewmodel_TreeNodeWrapper:
    ...
    def removePropertyChangeListener(self, btsviewmodel_propertyChangeListener):
        # TODO: Implement removePropertyChangeListener method
        pass

    def addPropertyChangeListener(self, btsviewmodel_propertyChangeListener):
