...
def test_assoc_association9_link_reassign_clear():
    ...
    b1 = UML2_Association()
    b2 = UML2_Association()
    _safe_set(a, 'UML2_Property10', b1)
    assert _is_linked(a, 'UML2_Property10', b1)
    if hasattr(b1, 'UML2_Association'):
        assert _is_linked(b1, 'UML2_Association', a)
    _safe_set(a, 'UML2_Property10', b2)
    assert _is_linked(a, 'UML2_Property10', b2)
    if hasattr(b1, 'UML2_Association'):
        assert not _is_linked(b1, 'UML2_Association', a)
    if hasattr(b2, 'UML2_Association'):
        assert _is_linked(b2, 'UML2_Association', a)
    _safe_set(a, 'UML2_Property10', None)
    assert not _is_linked(a, 'UML2_Property10', b2)
    if hasattr(b2, 'UML2_Association'):
        assert not _is_linked(b2, 'UML2_Association', a)


def test_assoc_behavior76_link_reassign_clear():
    ...
    if hasattr(b1, 'UML2_Behavior77'):
        assert _is_linked(b1, 'UML2_Behavior77', a)
    _safe_set(a, 'UML2_OpaqueExpression', b2)
    assert _is_linked(a, 'UML2_OpaqueExpression', b2)
    if hasattr(b1, 'UML2_Behavior77'):
        assert not _is_linked(b1, 'UML2_Behavior77', a)
    if hasattr(b2, 'UML2_Behavior77'):
        assert _is_linked(b2, 'UML2_Behavior77', a)
    _safe_set(a, 'UML2_OpaqueExpression', None)
    assert not _is_linked(a, 'UML2_OpaqueExpression', b2)
    if hasattr(b2, 'UML2_Behavior77'):
        assert not _is_linked(b2, 'UML2_Behavior77', a)


def test_assoc_bodyCondition15_link_reassign_clear():
    a = UML2_Operation(isQuery=True)
    b1 = UML2_Constraint()
    b2 = UML2_Constraint()
    _safe_set(a, 'UML2_Operation16', b1)
    assert _is_linked(a, 'UML2_Operation16', b1)
    if hasattr(b1, 'UML2_Constraint'):
        assert _is_linked(b1, 'UML2_Constraint', a)
    _safe_set(a, 'UML2_Operation16', b2)
    assert _is_linked(a, 'UML2_Operation16', b2)
    if hasattr(b1, 'UML2_Constraint'):
        assert not _is_linked(b1, 'UML2_Constraint', a)
    if hasattr(b2, 'UML2_Constraint'):
        assert _is_linked(b2, 'UML2_Constraint', a)
    _safe_set(a, 'UML2_Operation16', None)
    assert not _is_linked(a, 'UML2_Operation16', b2)
    if hasattr(b2, 'UML2_Constraint'):
        assert not _is_linked(b2, 'UML2_Constraint', a)


def test_assoc_classifier34_link_reassign_clear():
    a = UML2_Classifier(isAbstract=True)
    b1 = UML2_CreateObjectAction()
    b2 = UML2_CreateObjectAction()
    _safe_set(a, 'UML2_Classifier35', b1)
    assert _is_linked(a, 'UML2_Classifier35', b1)
    if hasattr(b1, 'UML2_CreateObjectAction'):
        assert _is_linked(b1, 'UML2_CreateObjectAction', a)
    _safe_set(a, 'UML2_Classifier35', b2)
    assert _is_linked(a, 'UML2_Classifier35', b2)
    if hasattr(b1, 'UML2_CreateObjectAction'):
    ...
    _safe_set(a, 'UML2_Classifier35', None)
    assert not _is_linked(a, 'UML2_Classifier35', b2)
    if hasattr(b2, 'UML2_CreateObjectAction'):
        assert not _is_linked(b2, 'UML2_CreateObjectAction', a)


def test_assoc_classifier53_link_reassign_clear():
    a = UML2_Classifier(isAbstract=True)
    b1 = UML2_InstanceSpecification()
    b2 = UML2_InstanceSpecification()
    _safe_set(a, 'UML2_Classifier55', b1)
    assert _is_linked(a, 'UML2_Classifier55', b1)
    if hasattr(b1, 'UML2_InstanceSpecification54'):
        assert _is_linked(b1, 'UML2_InstanceSpecification54', a)
    _safe_set(a, 'UML2_Classifier55', b2)
    assert _is_linked(a, 'UML2_Classifier55', b2)
    if hasattr(b1, 'UML2_InstanceSpecification54'):
        assert not _is_linked(b1, 'UML2_InstanceSpecification54', a)
    if hasattr(b2, 'UML2_InstanceSpecification54'):
        assert _is_linked(b2, 'UML2_InstanceSpecification54', a)
    _safe_set(a, 'UML2_Classifier55', None)
    assert not _is_linked(a, 'UML2_Classifier55', b2)
    if hasattr(b2, 'UML2_InstanceSpecification54'):
        assert not _is_linked(b2, 'UML2_InstanceSpecification54', a)


def test_assoc_context_41_link_reassign_clear():
    a = UML2_Classifier(isAbstract=True)
    b1 = UML2_Action()
    b2 = UML2_Action()
    ...
    _safe_set(a, 'UML2_Classifier42', None)
    assert not _is_linked(a, 'UML2_Classifier42', b2)
    if hasattr(b2, 'UML2_Action'):
        assert not _is_linked(b2, 'UML2_Action', a)


def test_assoc_definingFeature22_link_reassign_clear():
...
def test_assoc_end80_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b1 = UML2_LinkEndData()
    b2 = UML2_LinkEndData()
    _safe_set(a, 'UML2_Property82', b1)
    assert _is_linked(a, 'UML2_Property82', b1)
    if hasattr(b1, 'UML2_LinkEndData81'):
        assert _is_linked(b1, 'UML2_LinkEndData81', a)
    _safe_set(a, 'UML2_Property82', b2)
    assert _is_linked(a, 'UML2_Property82', b2)
    if hasattr(b1, 'UML2_LinkEndData81'):
        assert not _is_linked(b1, 'UML2_LinkEndData81', a)
    if hasattr(b2, 'UML2_LinkEndData81'):
        assert _is_linked(b2, 'UML2_LinkEndData81', a)
    _safe_set(a, 'UML2_Property82', None)
    assert not _is_linked(a, 'UML2_Property82', b2)
    if hasattr(b2, 'UML2_LinkEndData81'):
        assert not _is_linked(b2, 'UML2_LinkEndData81', a)
...
def test_assoc_feature62_link_reassign_clear():
    ...
    _safe_set(a, 'UML2_Feature64', b1)
    assert _is_linked(a, 'UML2_Feature64', b1)
    if hasattr(b1, 'UML2_Classifier63'):
        assert _is_linked(b1, 'UML2_Classifier63', a)
    _safe_set(a, 'UML2_Feature64', b2)
    assert _is_linked(a, 'UML2_Feature64', b2)
    if hasattr(b1, 'UML2_Classifier63'):
        assert not _is_linked(b1, 'UML2_Classifier63', a)
    if hasattr(b2, 'UML2_Classifier63'):
        assert _is_linked(b2, 'UML2_Classifier63', a)
    _safe_set(a, 'UML2_Feature64', None)
    assert not _is_linked(a, 'UML2_Feature64', b2)
    if hasattr(b2, 'UML2_Classifier63'):
        assert not _is_linked(b2, 'UML2_Classifier63', a)


def test_assoc_featuringClassifier20_link_reassign_clear():
    a = UML2_Feature(isStatic=True)
    b1 = UML2_Classifier(isAbstract=True)
    b2 = UML2_Classifier(isAbstract=False)
    _safe_set(a, 'UML2_Feature', {b1})
    assert _is_linked(a, 'UML2_Feature', b1)
    if hasattr(b1, 'UML2_Classifier21'):
        assert _is_linked(b1, 'UML2_Classifier21', a)
    _safe_set(a, 'UML2_Feature', {b2})
    assert _is_linked(a, 'UML2_Feature', b2)
    if hasattr(b1, 'UML2_Classifier21'):
        assert not _is_linked(b1, 'UML2_Classifier21', a)
    if hasattr(b2, 'UML2_Classifier21'):
        assert _is_linked(b2, 'UML2_Classifier21', a)
    _safe_set(a, 'UML2_Feature', set())
    assert not _is_linked(a, 'UML2_Feature', b2)
    if hasattr(b2, 'UML2_Classifier21'):
        assert not _is_linked(b2, 'UML2_Classifier21', a)


def test_assoc_general43_link_reassign_clear():
    a = UML2_Classifier(isAbstract=True)
    b1 = UML2_Generalization()
    b2 = UML2_Generalization()
    _safe_set(a, 'UML2_Classifier45', b1)
    assert _is_linked(a, 'UML2_Classifier45', b1)
    if hasattr(b1, 'UML2_Generalization44'):
        assert _is_linked(b1, 'UML2_Generalization44', a)
    _safe_set(a, 'UML2_Classifier45', b2)
    assert _is_linked(a, 'UML2_Classifier45', b2)
    if hasattr(b1, 'UML2_Generalization44'):
        assert not _is_linked(b1, 'UML2_Generalization44', a)
    if hasattr(b2, 'UML2_Generalization44'):
        assert _is_linked(b2, 'UML2_Generalization44', a)
    _safe_set(a, 'UML2_Classifier45', None)
    assert not _is_linked(a, 'UML2_Classifier45', b2)
    if hasattr(b2, 'UML2_Generalization44'):
        assert not _is_linked(b2, 'UML2_Generalization44', a)
...
def test_assoc_generalization68_link_reassign_clear():
    ...
    b1 = UML2_Generalization()
    b2 = UML2_Generalization()
    _safe_set(a, 'UML2_Classifier69', {b1})
    assert _is_linked(a, 'UML2_Classifier69', b1)
    if hasattr(b1, 'UML2_Generalization70'):
        assert _is_linked(b1, 'UML2_Generalization70', a)
    _safe_set(a, 'UML2_Classifier69', {b2})
    assert _is_linked(a, 'UML2_Classifier69', b2)
    if hasattr(b1, 'UML2_Generalization70'):
        assert not _is_linked(b1, 'UML2_Generalization70', a)
    if hasattr(b2, 'UML2_Generalization70'):
        assert _is_linked(b2, 'UML2_Generalization70', a)
    _safe_set(a, 'UML2_Classifier69', set())
    assert not _is_linked(a, 'UML2_Classifier69', b2)
    if hasattr(b2, 'UML2_Generalization70'):
        assert not _is_linked(b2, 'UML2_Generalization70', a)


def test_assoc_importedElement28_link_reassign_clear():
...
def test_assoc_inheritedMember65_link_reassign_clear():
    a = UML2_NamedElement(name="sample_text", visibility="sample_text")
    b1 = UML2_Classifier(isAbstract=True)
    b2 = UML2_Classifier(isAbstract=False)
    _safe_set(a, 'UML2_NamedElement67', b1)
    assert _is_linked(a, 'UML2_NamedElement67', b1)
    if hasattr(b1, 'UML2_Classifier66'):
        assert _is_linked(b1, 'UML2_Classifier66', a)
    _safe_set(a, 'UML2_NamedElement67', b2)
    assert _is_linked(a, 'UML2_NamedElement67', b2)
    if hasattr(b1, 'UML2_Classifier66'):
        assert not _is_linked(b1, 'UML2_Classifier66', a)
    if hasattr(b2, 'UML2_Classifier66'):
        assert _is_linked(b2, 'UML2_Classifier66', a)
    _safe_set(a, 'UML2_NamedElement67', None)
    assert not _is_linked(a, 'UML2_NamedElement67', b2)
    if hasattr(b2, 'UML2_Classifier66'):
...
def test_assoc_memberEnd59_link_reassign_clear():
    ...
    b1 = UML2_Association()
    b2 = UML2_Association()
    _safe_set(a, 'UML2_Property61', b1)
    assert _is_linked(a, 'UML2_Property61', b1)
    if hasattr(b1, 'UML2_Association60'):
        assert _is_linked(b1, 'UML2_Association60', a)
    _safe_set(a, 'UML2_Property61', b2)
    assert _is_linked(a, 'UML2_Property61', b2)
    if hasattr(b1, 'UML2_Association60'):
        assert not _is_linked(b1, 'UML2_Association60', a)
    if hasattr(b2, 'UML2_Association60'):
        assert _is_linked(b2, 'UML2_Association60', a)
    _safe_set(a, 'UML2_Property61', None)
    assert not _is_linked(a, 'UML2_Property61', b2)
    if hasattr(b2, 'UML2_Association60'):
        assert not _is_linked(b2, 'UML2_Association60', a)
...
def test_assoc_ownedEnd56_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b1 = UML2_Association()
    b2 = UML2_Association()
...
def test_assoc_ownedParameter14_link_reassign_clear():
...
def test_assoc_ownedReception5_link_reassign_clear():
    a = UML2_Class(isActive=True)
    b1 = UML2_Reception()
    b2 = UML2_Reception()
    _safe_set(a, 'UML2_Class6', {b1})
    assert _is_linked(a, 'UML2_Class6', b1)
    if hasattr(b1, 'UML2_Reception'):
        assert _is_linked(b1, 'UML2_Reception', a)
    _safe_set(a, 'UML2_Class6', {b2})
    assert _is_linked(a, 'UML2_Class6', b2)
    if hasattr(b1, 'UML2_Reception'):
        assert not _is_linked(b1, 'UML2_Reception', a)
    if hasattr(b2, 'UML2_Reception'):
        assert _is_linked(b2, 'UML2_Reception', a)
    _safe_set(a, 'UML2_Class6', set())
    assert not _is_linked(a, 'UML2_Class6', b2)
    if hasattr(b2, 'UML2_Reception'):
...
def test_assoc_qualifier12_link_reassign_clear():
    ...
    if hasattr(b1, 'UML2_Property13'):
        assert _is_linked(b1, 'UML2_Property13', a)
    _safe_set(a, 'UML2_Property11', {b2})
    assert _is_linked(a, 'UML2_Property11', b2)
    if hasattr(b1, 'UML2_Property13'):
        assert not _is_linked(b1, 'UML2_Property13', a)
    if hasattr(b2, 'UML2_Property13'):
        assert _is_linked(b2, 'UML2_Property13', a)
    _safe_set(a, 'UML2_Property11', set())
    assert not _is_linked(a, 'UML2_Property11', b2)
    if hasattr(b2, 'UML2_Property13'):
        assert not _is_linked(b2, 'UML2_Property13', a)
...
def test_assoc_qualifier39_link_reassign_clear():
    ...
    _safe_set(a, 'UML2_Property40', b1)
    assert _is_linked(a, 'UML2_Property40', b1)
    if hasattr(b1, 'UML2_QualifierValue'):
        assert _is_linked(b1, 'UML2_QualifierValue', a)
    _safe_set(a, 'UML2_Property40', b2)
    assert _is_linked(a, 'UML2_Property40', b2)
    if hasattr(b1, 'UML2_QualifierValue'):
    ...
    _safe_set(a, 'UML2_Property40', None)
    assert not _is_linked(a, 'UML2_Property40', b2)
    if hasattr(b2, 'UML2_QualifierValue'):
        assert not _is_linked(b2, 'UML2_QualifierValue', a)


def test_assoc_structuralFeature29_link_reassign_clear():
    a = UML2_StructuralFeature(isReadOnly=True)
    b1 = UML2_StructuralFeatureAction()
    b2 = UML2_StructuralFeatureAction()
    _safe_set(a, 'UML2_StructuralFeature30', b1)
    assert _is_linked(a, 'UML2_StructuralFeature30', b1)
    if hasattr(b1, 'UML2_StructuralFeatureAction'):
        assert _is_linked(b1, 'UML2_StructuralFeatureAction', a)
    _safe_set(a, 'UML2_StructuralFeature30', b2)
    assert _is_linked(a, 'UML2_StructuralFeature30', b2)
    if hasattr(b1, 'UML2_StructuralFeatureAction'):
    ...
    _safe_set(a, 'UML2_StructuralFeature30', None)
    assert not _is_linked(a, 'UML2_StructuralFeature30', b2)
    if hasattr(b2, 'UML2_StructuralFeatureAction'):
        assert not _is_linked(b2, 'UML2_StructuralFeatureAction', a)


def test_assoc_subsettedProperty8_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b1 = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b2 = UML2_Property(aggregation="sample_text_2", isComposite=False, isDerived=False, isDerivedUnion=False)
