...
class tfsm_TimedSystem(NamedElement):
    ...
    def __init__(self, tfsm_TimedSystem34: set["tfsm_FSMEvent"] = None, tfsm_TimedSystem: set["tfsm_TFSM"] = None, tfsm_TimedSystem31: set["tfsm_FSMClock"] = None):
...
class tfsm_FSMClock(NamedElement):
    ...
    def __init__(self, tfsm_FSMClock: "tfsm_TFSM" = None, tfsm_FSMClock22: "tfsm_TemporalGuard" = None, tfsm_FSMClock32: "tfsm_TimedSystem" = None):
...
class tfsm_Transition(NamedElement):
    ...
    def __init__(self, action: str, tfsm_Transition: "tfsm_TFSM" = None, tfsm_Transition27: "tfsm_FSMEvent" = None, Transition: "tfsm_State" = None, Transition11: "tfsm_State" = None, outgoingTransitions: "tfsm_State" = None, incomingTransitions: "tfsm_State" = None, tfsm_Transition17: "tfsm_Guard" = None, tfsm_Transition19: set["tfsm_FSMEvent"] = None):
        self.action = action
...
class tfsm_State(NamedElement):
    ...
    def __init__(self, State: "tfsm_TFSM" = None, tfsm_State: "tfsm_TFSM" = None, ownedStates: "tfsm_TFSM" = None, source: set["tfsm_Transition"] = None, target: set["tfsm_Transition"] = None, State13: "tfsm_Transition" = None, State15: "tfsm_Transition" = None):
        self.State = State
...
class tfsm_FSMEvent(NamedElement):
    ...
    def __init__(self, tfsm_FSMEvent: "tfsm_TFSM" = None, tfsm_FSMEvent24: "tfsm_EventGuard" = None, tfsm_FSMEvent26: set["tfsm_Transition"] = None, tfsm_FSMEvent20: "tfsm_Transition" = None, tfsm_FSMEvent35: "tfsm_TimedSystem" = None):
