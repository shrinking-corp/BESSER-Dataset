...
Order.attributes={Order_number, Order_status, Order_ordered, Order_total, Order_shipTo, Order_shipped}
...
domain_model = DomainModel(
    name="d12494e0_946b_494e_bb75_0c634f84efb5",
    types={Customer, Payment, ShoppingCart, Account, WebUser, Order, LineItem, Product, MyActor_Actor, Admin_Actor, Webuser_Actor, AjoutProduit_UseCase, UserState, OrderStatus},
    associations={Account_Payment, Payment_Order, Account_Order, WebUser_Customer, ShoppinCart_WebUser, Customer_Account, Product_LineItem, Order_LineItem, Account_ShoppinCart, ShoppinCart_LineItem, association2},
    generalizations={},
    metadata=None
)
