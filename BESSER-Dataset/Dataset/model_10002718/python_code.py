...
class LineItem:
    ...
    def __init__(self, quantity: int, price: float, product13: "Product" = None, lineitem15: set["Order"] = None, sc19: "ShoppingCart" = None):
...
class WebUser:
    ...
    def __init__(self, login: str, password: str, state: UserState, customer6: "Customer" = None, shoppincart9: "ShoppingCart" = None):
        self.login = login
...
class Account:
    ...
    def __init__(self, billingAddress: str, open: date, closed: date, isClosed: bool, payment0: set["Payment"] = None, order4: set["Order"] = None, customer11: "Customer" = None, cart16: "ShoppingCart" = None):
...
class ShoppingCart:
    ...
    def webuser8(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_ShoppingCart__webuser8", None)
    ...
    def items18(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_ShoppingCart__items18", None)
    ...
    def account17(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_ShoppingCart__account17", None)
