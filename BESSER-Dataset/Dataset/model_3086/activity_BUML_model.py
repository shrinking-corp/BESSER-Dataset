...
# Classes
activity_AbstractActivity = Class(name="activity_AbstractActivity", is_abstract=True)
...
activity_ValueSpecification = Class(name="activity_ValueSpecification")
activity_ActivityNode = Class(name="activity_ActivityNode", is_abstract=True)
activity_ObjectFlow = Class(name="activity_ObjectFlow", is_abstract=True)
ActivityEdge = Class(name="ActivityEdge")
activity_ActivityPartition = Class(name="activity_ActivityPartition", is_abstract=True)
AbstractNamedElement = Class(name="AbstractNamedElement")
activity_AbstractAction = Class(name="activity_AbstractAction", is_abstract=True)
ActivityNode = Class(name="ActivityNode")
activity_InputPin = Class(name="activity_InputPin", is_abstract=True)
activity_OutputPin = Class(name="activity_OutputPin", is_abstract=True)
activity_AcceptEventAction = Class(name="activity_AcceptEventAction", is_abstract=True)
AbstractAction = Class(name="AbstractAction")
activity_ObjectNode = Class(name="activity_ObjectNode", is_abstract=True)
activity_IState = Class(name="activity_IState")
activity_AbstractBehavior = Class(name="activity_AbstractBehavior")
...
activity_ObjectNode.attributes={activity_ObjectNode_isControlType, activity_ObjectNode_ordering, activity_ObjectNode_kindOfNode}
...
domain_model = DomainModel(
    name="activity",
    types={activity_AbstractActivity, AbstractBehavior, TraceableElement, activity_ActivityEdge, ModelElement, activity_ValueSpecification, activity_ActivityNode, activity_ObjectFlow, ActivityEdge, activity_ActivityPartition, AbstractNamedElement, activity_AbstractAction, ActivityNode, activity_InputPin, activity_OutputPin, activity_AcceptEventAction, AbstractAction, activity_ObjectNode, activity_IState, activity_AbstractBehavior, activity_Pin, ObjectNode, Pin, ObjectNodeOrderingKind, ObjectNodeKind},
    associations={outgoing15, rate0, probability1, target4, source6, guard9, weight12, incoming18, inputs21, outputs22, upperBound24, inState26, selection28},
    generalizations={gen_activity_AbstractActivity_AbstractBehavior, gen_activity_AbstractActivity_TraceableElement, gen_activity_ActivityEdge_ModelElement, gen_activity_ObjectFlow_ActivityEdge, gen_activity_ActivityPartition_AbstractNamedElement, gen_activity_ActivityPartition_ModelElement, gen_activity_ActivityNode_AbstractNamedElement, gen_activity_AbstractAction_AbstractNamedElement, gen_activity_AbstractAction_ActivityNode, gen_activity_AcceptEventAction_AbstractAction, gen_activity_ObjectNode_ActivityNode, gen_activity_ObjectNode_AbstractNamedElement, gen_activity_Pin_ObjectNode, gen_activity_InputPin_Pin, gen_activity_OutputPin_Pin},
    metadata=None
)
