...
# Classes
mini_lang_IfStatement = Class(name="mini_lang_IfStatement")
Statement = Class(name="Statement")
mini_lang_Expression = Class(name="mini_lang_Expression", is_abstract=True)
mini_lang_AssignmentStatement = Class(name="mini_lang_AssignmentStatement")
mini_lang_ExpressionStatement = Class(name="mini_lang_ExpressionStatement")
mini_lang_ReturnStatement = Class(name="mini_lang_ReturnStatement")
mini_lang_ComparisonExpression = Class(name="mini_lang_ComparisonExpression", is_abstract=True)
Expression = Class(name="Expression")
mini_lang_NotEqualsExpression = Class(name="mini_lang_NotEqualsExpression")
ComparisonExpression = Class(name="ComparisonExpression")
mini_lang_EqualsExpression = Class(name="mini_lang_EqualsExpression")
mini_lang_FOLCallExpression = Class(name="mini_lang_FOLCallExpression")
mini_lang_NameExpression = Class(name="mini_lang_NameExpression")
mini_lang_MiniLang = Class(name="mini_lang_MiniLang")
mini_lang_Block = Class(name="mini_lang_Block")
mini_lang_Statement = Class(name="mini_lang_Statement", is_abstract=True)
...
domain_model = DomainModel(
    name="mini_lang",
    types={mini_lang_IfStatement, Statement, mini_lang_Expression, mini_lang_AssignmentStatement, mini_lang_ExpressionStatement, mini_lang_ReturnStatement, mini_lang_ComparisonExpression, Expression, mini_lang_NotEqualsExpression, ComparisonExpression, mini_lang_EqualsExpression, mini_lang_FOLCallExpression, mini_lang_NameExpression, mini_lang_MiniLang, mini_lang_Block, mini_lang_Statement},
    associations={condition3, ifBody4, lhs7, rhs9, expr12, expr14, lhs16, rhs18, condition21, target23, block0, statements1},
    generalizations={gen_mini_lang_IfStatement_Statement, gen_mini_lang_AssignmentStatement_Statement, gen_mini_lang_ExpressionStatement_Statement, gen_mini_lang_ReturnStatement_Statement, gen_mini_lang_ComparisonExpression_Expression, gen_mini_lang_NotEqualsExpression_ComparisonExpression, gen_mini_lang_EqualsExpression_ComparisonExpression, gen_mini_lang_FOLCallExpression_Expression, gen_mini_lang_NameExpression_Expression},
    metadata=None
)
