...
# Classes
book_Person = Class(name="book_Person")
book_Article = Class(name="book_Article")
book_DocBook = Class(name="book_DocBook")
...
domain_model = DomainModel(
    name="book",
    types={book_Person, book_Article, book_DocBook, book_Book},
    associations={editor2, author3, articles5, book7, author9, edited12, authored14, articles16, book0, docBook1},
    generalizations={},
    metadata=None
)
