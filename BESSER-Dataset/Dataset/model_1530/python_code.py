...
class tP1_EM_State:
    ...
    def __init__(self, name: str, tP1_EM_State: "tP1_EM_StateMachine" = None, tP1_EM_State5: "tP1_EM_StateMachine" = None, to: "tP1_EM_Transition" = None, State11: "tP1_EM_Transition" = None, from_: "tP1_EM_Transition" = None, State: "tP1_EM_Transition" = None):
        self.name = name
    ...
    def from_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_tP1_EM_State__from_", None)
        self.__from_ = value
...
class tP1_EM_Transition:
    ...
    def __init__(self, name: str, tP1_EM_Transition: "tP1_EM_StateMachine" = None, Transition: "tP1_EM_State" = None, outgoing: "tP1_EM_State" = None, Transition8: "tP1_EM_State" = None, incoming: "tP1_EM_State" = None):
        self.name = name
...
class tP1_EM_StateMachine:
    ...
    def __init__(self, name: str, tP1_EM_StateMachine: set["tP1_EM_Transition"] = None, tP1_EM_StateMachine2: set["tP1_EM_State"] = None, tP1_EM_StateMachine4: "tP1_EM_State" = None):
        self.name = name
