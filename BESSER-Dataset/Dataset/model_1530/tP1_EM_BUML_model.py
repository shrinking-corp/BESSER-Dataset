...
# Classes
tP1_EM_StateMachine = Class(name="tP1_EM_StateMachine")
tP1_EM_Transition = Class(name="tP1_EM_Transition")
tP1_EM_State = Class(name="tP1_EM_State")
...
outgoing7: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_", type=tP1_EM_Transition, multiplicity=Multiplicity(0, 1))
    }
)
...
domain_model = DomainModel(
    ...
    associations={transition0, state1, initialState3, incoming6, from_10, outgoing7, to9},
    generalizations={},
    metadata=None
)
