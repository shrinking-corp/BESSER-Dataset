...
class java_VariableDeclaration(NamedElement):
    ...
    def __init__(self, extraArrayDimensions: int, java_VariableDeclaration: "java_Expression" = None, variable: set["java_SingleVariableAccess"] = None, VariableDeclaration: "java_SingleVariableAccess" = None):
        self.extraArrayDimensions = extraArrayDimensions
...
class java_SingleVariableDeclaration(VariableDeclaration):
    ...
    def __init__(self, varargs: bool, SingleVariableDeclaration100: "java_CatchClause" = None, SingleVariableDeclaration: "java_AbstractMethodDeclaration" = None, SingleVariableDeclaration152: "java_EnhancedForStatement" = None, singleVariableDeclaration: "java_Modifier" = None, java_SingleVariableDeclaration: "java_TypeAccess" = None, SingleVariableDeclaration253: "java_Modifier" = None, java_SingleVariableDeclaration298: set["java_Annotation"] = None, parameters: "java_AbstractMethodDeclaration" = None, exception: "java_CatchClause" = None, parameter: "java_EnhancedForStatement" = None):
        self.varargs = varargs
