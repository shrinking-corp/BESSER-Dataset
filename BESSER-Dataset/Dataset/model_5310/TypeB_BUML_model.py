...
TypeB_AnotherElement.attributes={TypeB_AnotherElement_type, TypeB_AnotherElement_nameElement, TypeB_AnotherElement_additionalField, TypeB_AnotherElement_abstractBaseName}
...
domain_model = DomainModel(
    name="TypeB",
    types={ElementX, ElementR, TypeB_Element, TypeB_SubElement, TypeB_AnotherElement, TypeB_ListElement, Element, TypeB_ElementX, TypeB_ElementY, TypeB_ElementR, TypeB_ElementS},
    associations={xyElements1, rsElements3, elements0},
