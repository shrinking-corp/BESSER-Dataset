...
class LabelProvider:
    ...
    pass
class aggregator_p2view_RequirementWrapper(LabelProvider, IRequirement):
...
class aggregator_p2view_Category(IUPresentation):
    ...
    def __init__(self, aggregator_p2view_Category53: "Features" = None, aggregator_p2view_Category55: "Products" = None, aggregator_p2view_Category57: "Bundles" = None, aggregator_p2view_Category59: "Fragments" = None, aggregator_p2view_Category61: "IUDetails" = None, aggregator_p2view_Category: "Categories" = None, IUPresentation: "aggregator_p2view_InstallableUnits" = None):
...
class aggregator_p2view_Product(IUPresentationWithDetails):
    ...
    def __init__(self, aggregator_p2view_Product120: "Bundles" = None, aggregator_p2view_Product123: "Fragments" = None, aggregator_p2view_Product: "Features" = None):
...
class aggregator_InfosProvider:
    ...
    def __init__(self, warnings: str, infos: str, errors: str):
...
class aggregator_Contact:
    ...
    def __init__(self, email: str, name: str, aggregator_Contact: "aggregator_Aggregation" = None, Contact: "aggregator_Aggregation" = None, contacts: "aggregator_Aggregation" = None, aggregator_Contact16: "aggregator_Contribution" = None):
        self.email = email
        self.name = name
...
class aggregator_AvailableVersion:
    ...
    def __init__(self, filter: str, availableFrom: str, versionMatch: str, version: str, aggregator_AvailableVersion: "aggregator_AvailableVersionsHeader" = None, aggregator_AvailableVersion24: "aggregator_InstallableUnitRequest" = None):
        self.filter = filter
...
class DescriptionProvider:
    ...
    pass
class aggregator_MapRule(InstallableUnitRequest, EnabledStatusProvider, DescriptionProvider):

    pass
class aggregator_MappedRepository(IdentificationProvider, MetadataRepositoryReference, DescriptionProvider):

    def __init__(self, mirrorArtifacts: bool, categoryPrefix: str, aggregator_MappedRepository: "aggregator_Contribution" = None, aggregator_MappedRepository26: set["aggregator_Product"] = None, aggregator_MappedRepository28: set["aggregator_Bundle"] = None, aggregator_MappedRepository30: set["aggregator_Feature"] = None, aggregator_MappedRepository34: set["aggregator_MapRule"] = None, aggregator_MappedRepository32: set["aggregator_Category"] = None):
...
class aggregator_Aggregation(InfosProvider, StatusProvider, DescriptionProvider):
    ...
    def __init__(self, label: str, buildRoot: str, packedStrategy: str, sendmail: bool, type: str, mavenResult: bool, strictMavenVersions: bool, allowLegacySites: str, aggregator_Aggregation: set["aggregator_ValidationSet"] = None, aggregator_Aggregation2: set["aggregator_Configuration"] = None, aggregator_Aggregation7: "aggregator_Contact" = None, aggregator_Aggregation9: set["aggregator_MavenMapping"] = None, aggregator_Aggregation4: set["aggregator_CustomCategory"] = None, aggregation: set["aggregator_Contact"] = None, Aggregation: "aggregator_Contact" = None):
        self.label = label
...
class aggregator_Contribution(StatusProvider, DescriptionProvider, InfosProvider, EnabledStatusProvider, IdentificationProvider):
...
class aggregator_ValidationSet(StatusProvider, DescriptionProvider, InfosProvider, EnabledStatusProvider, IdentificationProvider):
