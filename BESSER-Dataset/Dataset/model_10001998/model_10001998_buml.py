...
domain_model = DomainModel(
    ...
    associations={client_view_status, client_logout, administrator_login, administrator_logout, administrator_create_user, administrator_search_user, technical_team_login_technical, technical_team_new_complaint_details, technical_team_find_out_fault, technical_team_send_to_admin, technical_team_logout_technician, client_register_complaint, client_login},
    generalizations={},
    metadata=None
)
