...
builds_Build.attributes={builds_Build_id, builds_Build_state, builds_Build_timestamp, builds_Build_label, builds_Build_buildNumber, builds_Build_displayName, builds_Build_status, builds_Build_summary, builds_Build_duration}
...
builds_BuildPlan.attributes={builds_BuildPlan_selected, builds_BuildPlan_status, builds_BuildPlan_info, builds_BuildPlan_description, builds_BuildPlan_id, builds_BuildPlan_health, builds_BuildPlan_summary, builds_BuildPlan_flags, builds_BuildPlan_state}
...
builds_TestResult.attributes={builds_TestResult_failCount, builds_TestResult_duration, builds_TestResult_ignoredCount, builds_TestResult_passCount, builds_TestResult_errorCount}
...
builds_BuildElement.attributes={builds_BuildElement_name, builds_BuildElement_url, builds_BuildElement_refreshDate, builds_BuildElement_operations, builds_BuildElement_elementStatus}
...
builds_ChangeArtifact.attributes={builds_ChangeArtifact_revision, builds_ChangeArtifact_editType, builds_ChangeArtifact_file, builds_ChangeArtifact_relativePath, builds_ChangeArtifact_prevRevision, builds_ChangeArtifact_dead}
...
builds_TestCase.attributes={builds_TestCase_message, builds_TestCase_stackTrace, builds_TestCase_skipped, builds_TestCase_status, builds_TestCase_className}
...
domain_model = DomainModel(
    name="builds",
    types={builds_ChangeSet, builds_StringToStringMap, builds_Artifact, BuildElement, builds_Build, builds_BuildPlan, builds_BuildServer, builds_TestResult, builds_User, builds_BuildCause, builds_BuildReference, builds_BuildElement, builds_ParameterDefinition, builds_HealthReport, builds_BuildModel, builds_Change, builds_ChangeArtifact, builds_TestSuite, builds_ChoiceParameterDefinition, ParameterDefinition, builds_BooleanParameterDefinition, builds_FileParameterDefinition, builds_PlanParameterDefinition, builds_PasswordParameterDefinition, builds_BuildParameterDefinition, builds_StringParameterDefinition, builds_TestElement, TestElement, builds_TestCase, TestCaseResult},
    associations={artifacts0, changeSet1, parent24, plan3, server5, testResult7, culprits8, cause10, build12, user14, attributes17, server18, children22, changes44, lastBuild26, parameterDefinitions29, healthReports30, servers32, plans34, builds37, artifacts40, author41, containingBuildPlan47, buildPlan49, build51, suites52, cases53, result54, suite56},
    generalizations={gen_builds_Artifact_BuildElement, gen_builds_Build_BuildElement, gen_builds_BuildPlan_BuildElement, gen_builds_BuildServer_BuildElement, gen_builds_User_BuildElement, gen_builds_ChoiceParameterDefinition_ParameterDefinition, gen_builds_BooleanParameterDefinition_ParameterDefinition, gen_builds_FileParameterDefinition_ParameterDefinition, gen_builds_PlanParameterDefinition_ParameterDefinition, gen_builds_PasswordParameterDefinition_ParameterDefinition, gen_builds_BuildParameterDefinition_ParameterDefinition, gen_builds_StringParameterDefinition_ParameterDefinition, gen_builds_TestSuite_TestElement, gen_builds_TestCase_TestElement},
    metadata=None
)
