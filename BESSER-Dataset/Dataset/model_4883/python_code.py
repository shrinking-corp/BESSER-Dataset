...
class builds_Change:
    ...
    def __init__(self, revision: str, message: str, date: str, builds_Change46: "builds_ChangeSet" = None, builds_Change: set["builds_ChangeArtifact"] = None, builds_Change42: "builds_User" = None):
        self.revision = revision
        self.message = message
        self.date = date
...
class builds_TestResult:
    ...
    def __init__(self, failCount: int, passCount: int, ignoredCount: int, errorCount: int, duration: str, TestResult: "builds_Build" = None, testResult: "builds_Build" = None, result: set["builds_TestSuite"] = None, TestResult55: "builds_TestSuite" = None):
...
class builds_Build(BuildElement):
    ...
    def __init__(self, id: str, buildNumber: int, timestamp: str, duration: str, displayName: str, state: str, status: str, label: str, summary: str, builds_Build: set["builds_Artifact"] = None, builds_Build2: "builds_ChangeSet" = None, builds_Build4: "builds_BuildPlan" = None, builds_Build6: "builds_BuildServer" = None, builds_Build28: "builds_BuildPlan" = None, builds_Build39: "builds_BuildModel" = None, Build: "builds_TestResult" = None, build: "builds_TestResult" = None, builds_Build9: set["builds_User"] = None, builds_Build11: set["builds_BuildCause"] = None):
        self.id = id
...
class builds_User(BuildElement):
    ...
    def __init__(self, id: str, email: str, builds_User43: "builds_Change" = None, builds_User: "builds_Build" = None, builds_User16: "builds_BuildCause" = None):
        self.id = id
        self.email = email
...
class builds_BuildPlan(BuildElement):
    ...
    def __init__(self, health: int, id: str, info: str, selected: bool, summary: str, state: str, status: str, description: str, flags: str, BuildPlan25: "builds_BuildPlan" = None, children: "builds_BuildPlan" = None, builds_BuildPlan: "builds_Build" = None, builds_BuildPlan27: "builds_Build" = None, containingBuildPlan: set["builds_ParameterDefinition"] = None, builds_BuildPlan31: set["builds_HealthReport"] = None, builds_BuildPlan36: "builds_BuildModel" = None, BuildPlan48: "builds_ParameterDefinition" = None, builds_BuildPlan50: "builds_BuildParameterDefinition" = None, builds_BuildPlan19: "builds_BuildServer" = None, BuildPlan: "builds_BuildPlan" = None, parent: set["builds_BuildPlan"] = None):
        self.health = health
        self.id = id
        self.info = info
