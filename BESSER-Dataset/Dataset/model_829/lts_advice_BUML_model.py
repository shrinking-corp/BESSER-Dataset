...
# Classes
lts_av_Transition = Class(name="lts_av_Transition")
lts_av_LTS = Class(name="lts_av_LTS")
lts_av_State = Class(name="lts_av_State")
lts_av_Advice = Class(name="lts_av_Advice")
lts_av_EObject = Class(name="lts_av_EObject")
lts_av_GlobalScope = Class(name="lts_av_GlobalScope")
lts_av_PerJoinPointScope = Class(name="lts_av_PerJoinPointScope")
...
lts_av_Transition.attributes={lts_av_Transition_output, lts_av_Transition_input}
...
domain_model = DomainModel(
    name="lts_av",
    types={lts_av_Transition, lts_av_LTS, lts_av_State, lts_av_Advice, lts_av_EObject, lts_av_GlobalScope, lts_av_PerJoinPointScope},
    associations={initialState1, currentState2, finalState5, owningLTS8, outgoingTransition9, incomingTransition10, ownedState0, source12, target14, children16, scopedObject17, scopedObject19},
    generalizations={},
    metadata=None
)
