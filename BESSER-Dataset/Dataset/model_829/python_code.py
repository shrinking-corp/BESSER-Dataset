...
class lts_av_State:
    ...
    def __init__(self, name: str, State13: "lts_av_Transition" = None, State15: "lts_av_Transition" = None, lts_av_State: "lts_av_LTS" = None, lts_av_State4: "lts_av_LTS" = None, lts_av_State7: "lts_av_LTS" = None, ownedState: "lts_av_LTS" = None, source: set["lts_av_Transition"] = None, target: set["lts_av_Transition"] = None, State: "lts_av_LTS" = None):
        self.name = name
...
class lts_av_LTS:
    ...
    def __init__(self, name: str, lts_av_LTS: "lts_av_State" = None, lts_av_LTS3: "lts_av_State" = None, lts_av_LTS6: set["lts_av_State"] = None, LTS: "lts_av_State" = None, owningLTS: set["lts_av_State"] = None):
        self.name = name
...
class lts_av_Transition:
    ...
    def __init__(self, input: str, output: str, outgoingTransition: "lts_av_State" = None, incomingTransition: "lts_av_State" = None, Transition: "lts_av_State" = None, Transition11: "lts_av_State" = None):
        self.input = input
        self.output = output
