...
metrics_RuleSetMetrics.attributes={metrics_RuleSetMetrics_totalNumberOfNodes, metrics_RuleSetMetrics_numberOfRules, metrics_RuleSetMetrics_totalNumberOfEdges, metrics_RuleSetMetrics_totalNumberOfAttributes}
...
domain_model = DomainModel(
    ...
    associations={rule3, ruleMetrics0, ruleSet1},
    generalizations={},
    metadata=None
)
