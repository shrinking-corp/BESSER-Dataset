...
class metrics_RuleMetrics:
    ...
    def __init__(self, numberOfNodes: int, numberOfEdges: int, numberOfAttributes: int, metrics_RuleMetrics4: "metrics_Rule" = None, metrics_RuleMetrics: "metrics_RuleSetMetrics" = None):
...
class metrics_RuleSetMetrics:
    ...
    @property
    def totalNumberOfAttributes(self):
    ...
    def findRuleMetrics(self, metrics_rule) :
        # TODO: Implement findRuleMetrics method
        pass

    def createPresentationString(self) :
