...
model_BookShelf = Class(name="model_BookShelf")
...
model_Book.attributes={model_Book_author, model_Book_avgRating, model_Book_name}
...
domain_model = DomainModel(
    name="model",
    types={model_DataBase, model_Book, model_BookShelf, model_Person},
    associations={friends4, books5, ownedBy6, people7, books9, presentIn0, shelves1},
    generalizations={},
    metadata=None
)
