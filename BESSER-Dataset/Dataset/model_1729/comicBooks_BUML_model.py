...
# Classes
comicBooks_Artist = Class(name="comicBooks_Artist")
comicBooks_Editor = Class(name="comicBooks_Editor")
comicBooks_Writer = Class(name="comicBooks_Writer")
comicBooks_Publisher = Class(name="comicBooks_Publisher")
comicBooks_Series = Class(name="comicBooks_Series")
comicBooks_ComicBookCollection = Class(name="comicBooks_ComicBookCollection")
comicBooks_Book = Class(name="comicBooks_Book")
...
domain_model = DomainModel(
    name="comicBooks",
    types={comicBooks_Artist, comicBooks_Editor, comicBooks_Writer, comicBooks_Publisher, comicBooks_Series, comicBooks_ComicBookCollection, comicBooks_Book},
    associations={artists1, editors3, writers5, publishingCompanies7, series9, booksPublished11, booksInSeries12, books0, booksEditorFor25, booksWriterFor27, artists14, editors15, writers16, coverArtist17, publisher19, seriesPartOf20, booksArtistFor21, booksCoverArtistFor23},
    generalizations={},
    metadata=None
)
