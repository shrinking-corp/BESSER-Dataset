...
# Classes
uml2CD_Element = Class(name="uml2CD_Element", is_abstract=True)
uml2CD_Comment = Class(name="uml2CD_Comment")
uml2CD_Relationship = Class(name="uml2CD_Relationship", is_abstract=True)
Element = Class(name="Element")
uml2CD_DirectRelationship = Class(name="uml2CD_DirectRelationship", is_abstract=True)
Relationship = Class(name="Relationship")
uml2CD_MultiplicityElement = Class(name="uml2CD_MultiplicityElement", is_abstract=True)
uml2CD_NamedElement = Class(name="uml2CD_NamedElement")
uml2CD_Namespace = Class(name="uml2CD_Namespace", is_abstract=True)
uml2CD_Dependency = Class(name="uml2CD_Dependency")
uml2CD_PackageableElement = Class(name="uml2CD_PackageableElement", is_abstract=True)
NamedElement = Class(name="NamedElement")
uml2CD_Package = Class(name="uml2CD_Package")
uml2CD_PackageImport = Class(name="uml2CD_PackageImport")
uml2CD_ElementImport = Class(name="uml2CD_ElementImport")
uml2CD_Constraint = Class(name="uml2CD_Constraint")
...
uml2CD_PackageMerge = Class(name="uml2CD_PackageMerge")
uml2CD_ValueSpecification = Class(name="uml2CD_ValueSpecification")
TypedElement = Class(name="TypedElement")
uml2CD_Parameter = Class(name="uml2CD_Parameter")
uml2CD_Property = Class(name="uml2CD_Property")
uml2CD_TypedElement = Class(name="uml2CD_TypedElement", is_abstract=True)
uml2CD_Typpee = Class(name="uml2CD_Typpee")
uml2CD_Generalization = Class(name="uml2CD_Generalization")
uml2CD_Classifier = Class(name="uml2CD_Classifier", is_abstract=True)
uml2CD_GeneralizationSet = Class(name="uml2CD_GeneralizationSet")
Typpee = Class(name="Typpee")
uml2CD_Feature = Class(name="uml2CD_Feature", is_abstract=True)
StructuralFeature = Class(name="StructuralFeature")
uml2CD_Class = Class(name="uml2CD_Class")
uml2CD_Substitution = Class(name="uml2CD_Substitution")
uml2CD_StructuralFeature = Class(name="uml2CD_StructuralFeature", is_abstract=True)
Feature = Class(name="Feature")
MultiplicityElement = Class(name="MultiplicityElement")
uml2CD_BehavioralFeature = Class(name="uml2CD_BehavioralFeature", is_abstract=True)
uml2CD_Operation = Class(name="uml2CD_Operation")
BehavioralFeature = Class(name="BehavioralFeature")
Classifier = Class(name="Classifier")
uml2CD_DataType = Class(name="uml2CD_DataType")
uml2CD_Association = Class(name="uml2CD_Association")
uml2CD_PrimitiveType = Class(name="uml2CD_PrimitiveType")
DataType = Class(name="DataType")
uml2CD_Enumeration = Class(name="uml2CD_Enumeration")
uml2CD_EnumerationLiteral = Class(name="uml2CD_EnumerationLiteral")
ValueSpecification = Class(name="ValueSpecification")
uml2CD_Abstraction = Class(name="uml2CD_Abstraction")
Dependency = Class(name="Dependency")
uml2CD_Usage = Class(name="uml2CD_Usage")
uml2CD_Realization = Class(name="uml2CD_Realization")
Abstraction = Class(name="Abstraction")
Realization = Class(name="Realization")
uml2CD_Interface = Class(name="uml2CD_Interface")
uml2CD_InterfaceRealization = Class(name="uml2CD_InterfaceRealization")
uml2CD_AssociationClass = Class(name="uml2CD_AssociationClass")
Association = Class(name="Association")
Class_ = Class(name="Class")
uml2CD_RedefinableElement = Class(name="uml2CD_RedefinableElement", is_abstract=True)
...
domain_model = DomainModel(
    name="uml2CD",
    types={uml2CD_Element, uml2CD_Comment, uml2CD_Relationship, Element, uml2CD_DirectRelationship, Relationship, uml2CD_MultiplicityElement, uml2CD_NamedElement, uml2CD_Namespace, uml2CD_Dependency, uml2CD_PackageableElement, NamedElement, uml2CD_Package, uml2CD_PackageImport, uml2CD_ElementImport, uml2CD_Constraint, DirectRelationship, PackageableElement, Namespace, uml2CD_PackageMerge, uml2CD_ValueSpecification, TypedElement, uml2CD_Parameter, uml2CD_Property, uml2CD_TypedElement, uml2CD_Typpee, uml2CD_Generalization, uml2CD_Classifier, uml2CD_GeneralizationSet, Typpee, uml2CD_Feature, StructuralFeature, uml2CD_Class, uml2CD_Substitution, uml2CD_StructuralFeature, Feature, MultiplicityElement, uml2CD_BehavioralFeature, uml2CD_Operation, BehavioralFeature, Classifier, uml2CD_DataType, uml2CD_Association, uml2CD_PrimitiveType, DataType, uml2CD_Enumeration, uml2CD_EnumerationLiteral, ValueSpecification, uml2CD_Abstraction, Dependency, uml2CD_Usage, uml2CD_Realization, Abstraction, Realization, uml2CD_Interface, uml2CD_InterfaceRealization, uml2CD_AssociationClass, Association, Class_, uml2CD_RedefinableElement, VisibilityKind, ParameterDirectionKind, AggregationKind},
    associations={source11, ownedComment0, owner2, ownedElement4, owningElement6, relatedElement8, target9, namespace14, supplierDependency15, clientDependency16, owningPackage18, importedMember19, packageImport21, elementImport22, ownedRule24, importedElement25, importingNamespace27, importedPackage28, importingNamespace29, nestingPackage32, nestedPackage35, packagedElement37, packageMerge38, feature62, lowerValue39, upperValue40, owningLower42, owningUpper43, owningConstraint45, owningParameter47, owningProperty48, type50, constrainedElement51, specification53, context55, general57, specific58, generalizationSet59, generalization61, Class63, powertypeExtent64, substitution66, featuringClassifier67, ownedParameter69, raisedException71, ownerFormalParam73, defaultValue74, redefinedOperation77, Class78, superClass81, nestedClassifier82, ownedOperation85, ownedAttribute87, defaultValue90, Class92, association94, owningAssociation95, qualifier98, associationEnd101, memberEnd103, ownedEnd105, ownedLiteral107, enumeration108, receivingPackage109, mergedPackage111, supplier113, client114, contract116, substitutingClassifier118, redefinedInterface121, contract122, generalization124, powertype126, redefinedElement129},
    generalizations={gen_uml2CD_Relationship_Element, gen_uml2CD_DirectRelationship_Relationship, gen_uml2CD_MultiplicityElement_Element, gen_uml2CD_NamedElement_Element, gen_uml2CD_PackageableElement_NamedElement, gen_uml2CD_Namespace_NamedElement, gen_uml2CD_ElementImport_DirectRelationship, gen_uml2CD_PackageImport_DirectRelationship, gen_uml2CD_Package_PackageableElement, gen_uml2CD_Package_Namespace, gen_uml2CD_ValueSpecification_TypedElement, gen_uml2CD_ValueSpecification_PackageableElement, gen_uml2CD_TypedElement_NamedElement, gen_uml2CD_Typpee_PackageableElement, gen_uml2CD_Constraint_PackageableElement, gen_uml2CD_Generalization_DirectRelationship, gen_uml2CD_Classifier_Typpee, gen_uml2CD_Classifier_Namespace, gen_uml2CD_Property_StructuralFeature, gen_uml2CD_StructuralFeature_Feature, gen_uml2CD_StructuralFeature_TypedElement, gen_uml2CD_StructuralFeature_MultiplicityElement, gen_uml2CD_BehavioralFeature_Feature, gen_uml2CD_BehavioralFeature_Namespace, gen_uml2CD_Parameter_TypedElement, gen_uml2CD_Parameter_MultiplicityElement, gen_uml2CD_Operation_BehavioralFeature, gen_uml2CD_Class_Classifier, gen_uml2CD_DataType_Classifier, gen_uml2CD_Association_Classifier, gen_uml2CD_Association_Relationship, gen_uml2CD_PrimitiveType_DataType, gen_uml2CD_Enumeration_DataType, gen_uml2CD_EnumerationLiteral_ValueSpecification, gen_uml2CD_PackageMerge_DirectRelationship, gen_uml2CD_Dependency_DirectRelationship, gen_uml2CD_Dependency_PackageableElement, gen_uml2CD_Abstraction_Dependency, gen_uml2CD_Usage_Dependency, gen_uml2CD_Realization_Abstraction, gen_uml2CD_Substitution_Realization, gen_uml2CD_Interface_Classifier, gen_uml2CD_InterfaceRealization_Realization, gen_uml2CD_AssociationClass_Association, gen_uml2CD_AssociationClass_Class, gen_uml2CD_RedefinableElement_Element},
    metadata=None
)
