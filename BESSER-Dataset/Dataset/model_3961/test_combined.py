...
def test_hyp_uml2cd_associationclass_is_not_abstract():
    assert not inspect.isabstract(uml2CD_AssociationClass)


def test_hyp_uml2cd_associationclass_constructor_exists():
    assert callable(uml2CD_AssociationClass.__init__)


def test_hyp_uml2cd_associationclass_constructor_args():
...
def test_hyp_uml2cd_interfacerealization_is_not_abstract():
    assert not inspect.isabstract(uml2CD_InterfaceRealization)


def test_hyp_uml2cd_interfacerealization_constructor_exists():
    assert callable(uml2CD_InterfaceRealization.__init__)


def test_hyp_uml2cd_interfacerealization_constructor_args():
...
def test_hyp_uml2cd_realization_is_not_abstract():
    assert not inspect.isabstract(uml2CD_Realization)


def test_hyp_uml2cd_realization_constructor_exists():
    assert callable(uml2CD_Realization.__init__)


def test_hyp_uml2cd_realization_constructor_args():
...
def test_hyp_uml2cd_usage_is_not_abstract():
    assert not inspect.isabstract(uml2CD_Usage)


def test_hyp_uml2cd_usage_constructor_exists():
    assert callable(uml2CD_Usage.__init__)


def test_hyp_uml2cd_usage_constructor_args():
    sig = inspect.signature(uml2CD_Usage.__init__)
    params = list(sig.parameters.keys())



def test_hyp_uml2cd_abstraction_is_not_abstract():
    assert not inspect.isabstract(uml2CD_Abstraction)


def test_hyp_uml2cd_abstraction_constructor_exists():
    assert callable(uml2CD_Abstraction.__init__)


def test_hyp_uml2cd_abstraction_constructor_args():
...
def test_hyp_uml2cd_interface_is_not_abstract():
    assert not inspect.isabstract(uml2CD_Interface)


def test_hyp_uml2cd_interface_constructor_exists():
    assert callable(uml2CD_Interface.__init__)


def test_hyp_uml2cd_interface_constructor_args():
...
def test_hyp_uml2cd_substitution_is_not_abstract():
    assert not inspect.isabstract(uml2CD_Substitution)


def test_hyp_uml2cd_substitution_constructor_exists():
    assert callable(uml2CD_Substitution.__init__)


def test_hyp_uml2cd_substitution_constructor_args():
...
def test_hyp_uml2cd_feature_is_not_abstract():
    assert not inspect.isabstract(uml2CD_Feature)


def test_hyp_uml2cd_feature_constructor_exists():
    assert callable(uml2CD_Feature.__init__)


def test_hyp_uml2cd_feature_constructor_args():
    sig = inspect.signature(uml2CD_Feature.__init__)
    params = list(sig.parameters.keys())



def test_hyp_typpee_is_not_abstract():
    assert not inspect.isabstract(Typpee)


def test_hyp_typpee_constructor_exists():
    assert callable(Typpee.__init__)


def test_hyp_typpee_constructor_args():
...
def test_hyp_uml2cd_structuralfeature_is_not_abstract():
    assert not inspect.isabstract(uml2CD_StructuralFeature)


def test_hyp_uml2cd_structuralfeature_constructor_exists():
    assert callable(uml2CD_StructuralFeature.__init__)


def test_hyp_uml2cd_structuralfeature_constructor_args():
...
def test_hyp_uml2cd_classifier_is_not_abstract():
    assert not inspect.isabstract(uml2CD_Classifier)


def test_hyp_uml2cd_classifier_constructor_exists():
    assert callable(uml2CD_Classifier.__init__)


def test_hyp_uml2cd_classifier_constructor_args():
...
def test_hyp_uml2cd_behavioralfeature_is_not_abstract():
    assert not inspect.isabstract(uml2CD_BehavioralFeature)


def test_hyp_uml2cd_behavioralfeature_constructor_exists():
    assert callable(uml2CD_BehavioralFeature.__init__)


def test_hyp_uml2cd_behavioralfeature_constructor_args():
...
def test_hyp_uml2cd_valuespecification_is_not_abstract():
    assert not inspect.isabstract(uml2CD_ValueSpecification)


def test_hyp_uml2cd_valuespecification_constructor_exists():
    assert callable(uml2CD_ValueSpecification.__init__)


def test_hyp_uml2cd_valuespecification_constructor_args():
    sig = inspect.signature(uml2CD_ValueSpecification.__init__)
    params = list(sig.parameters.keys())



def test_hyp_uml2cd_typpee_is_not_abstract():
    assert not inspect.isabstract(uml2CD_Typpee)


def test_hyp_uml2cd_typpee_constructor_exists():
    assert callable(uml2CD_Typpee.__init__)


def test_hyp_uml2cd_typpee_constructor_args():
    sig = inspect.signature(uml2CD_Typpee.__init__)
    params = list(sig.parameters.keys())



def test_hyp_directrelationship_is_not_abstract():
    assert not inspect.isabstract(DirectRelationship)


def test_hyp_directrelationship_constructor_exists():
    assert callable(DirectRelationship.__init__)


def test_hyp_directrelationship_constructor_args():
    sig = inspect.signature(DirectRelationship.__init__)
    params = list(sig.parameters.keys())



def test_hyp_uml2cd_packagemerge_is_not_abstract():
    assert not inspect.isabstract(uml2CD_PackageMerge)


def test_hyp_uml2cd_packagemerge_constructor_exists():
    assert callable(uml2CD_PackageMerge.__init__)


def test_hyp_uml2cd_packagemerge_constructor_args():
...
def test_hyp_uml2cd_elementimport_is_not_abstract():
    assert not inspect.isabstract(uml2CD_ElementImport)


def test_hyp_uml2cd_elementimport_constructor_exists():
    assert callable(uml2CD_ElementImport.__init__)


def test_hyp_uml2cd_elementimport_constructor_args():
...
def test_hyp_uml2cd_packageimport_is_not_abstract():
    assert not inspect.isabstract(uml2CD_PackageImport)


def test_hyp_uml2cd_packageimport_constructor_exists():
    assert callable(uml2CD_PackageImport.__init__)


def test_hyp_uml2cd_packageimport_constructor_args():
...
def test_hyp_uml2cd_typedelement_is_not_abstract():
    assert not inspect.isabstract(uml2CD_TypedElement)


def test_hyp_uml2cd_typedelement_constructor_exists():
    assert callable(uml2CD_TypedElement.__init__)


def test_hyp_uml2cd_typedelement_constructor_args():
    sig = inspect.signature(uml2CD_TypedElement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_uml2cd_packageableelement_is_not_abstract():
    assert not inspect.isabstract(uml2CD_PackageableElement)


def test_hyp_uml2cd_packageableelement_constructor_exists():
    assert callable(uml2CD_PackageableElement.__init__)


def test_hyp_uml2cd_packageableelement_constructor_args():
    sig = inspect.signature(uml2CD_PackageableElement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_uml2cd_dependency_is_not_abstract():
    assert not inspect.isabstract(uml2CD_Dependency)


def test_hyp_uml2cd_dependency_constructor_exists():
    assert callable(uml2CD_Dependency.__init__)


def test_hyp_uml2cd_dependency_constructor_args():
    sig = inspect.signature(uml2CD_Dependency.__init__)
    params = list(sig.parameters.keys())



def test_hyp_uml2cd_namespace_is_not_abstract():
    assert not inspect.isabstract(uml2CD_Namespace)


def test_hyp_uml2cd_namespace_constructor_exists():
    assert callable(uml2CD_Namespace.__init__)


def test_hyp_uml2cd_namespace_constructor_args():
...
def test_hyp_uml2cd_directrelationship_is_not_abstract():
    assert not inspect.isabstract(uml2CD_DirectRelationship)


def test_hyp_uml2cd_directrelationship_constructor_exists():
    assert callable(uml2CD_DirectRelationship.__init__)


def test_hyp_uml2cd_directrelationship_constructor_args():
...
def test_hyp_uml2cd_redefinableelement_is_not_abstract():
    assert not inspect.isabstract(uml2CD_RedefinableElement)


def test_hyp_uml2cd_redefinableelement_constructor_exists():
    assert callable(uml2CD_RedefinableElement.__init__)


def test_hyp_uml2cd_redefinableelement_constructor_args():
...
def test_hyp_uml2cd_multiplicityelement_is_not_abstract():
    assert not inspect.isabstract(uml2CD_MultiplicityElement)


def test_hyp_uml2cd_multiplicityelement_constructor_exists():
    assert callable(uml2CD_MultiplicityElement.__init__)


def test_hyp_uml2cd_multiplicityelement_constructor_args():
    sig = inspect.signature(uml2CD_MultiplicityElement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_uml2cd_relationship_is_not_abstract():
    assert not inspect.isabstract(uml2CD_Relationship)


def test_hyp_uml2cd_relationship_constructor_exists():
    assert callable(uml2CD_Relationship.__init__)


def test_hyp_uml2cd_relationship_constructor_args():
...
def test_hyp_uml2cd_element_is_not_abstract():
    assert not inspect.isabstract(uml2CD_Element)


def test_hyp_uml2cd_element_constructor_exists():
    assert callable(uml2CD_Element.__init__)


def test_hyp_uml2cd_element_constructor_args():
...
def test_hyp_uml2cd_parameter_direction_setter(instance):
...
def test_hyp_uml2cd_classifier_isAbstract_setter(instance):
...
def test_hyp_uml2cd_elementimport_visibility_setter(instance):
...
def test_hyp_uml2cd_packageimport_visibility_setter(instance):
    original = instance.visibility
    instance.visibility = original
    assert instance.visibility == original
...
def test_hyp_uml2cd_redefinableelement_isLeaf_setter(instance):
