...
class PhotosMetaModel_Bucket:
    ...
    def __init__(self, name: str, PhotosMetaModel_Bucket173: "PhotosMetaModel_Access" = None, PhotosMetaModel_Bucket175: set["PhotosMetaModel_File_a"] = None, PhotosMetaModel_Bucket177: set["PhotosMetaModel_Folder_a"] = None, PhotosMetaModel_Bucket: "PhotosMetaModel_AmazonSimpleStorageService" = None):
        self.name = name
...
class PhotosMetaModel_Album(Entities):
    ...
    def __init__(self, name: str, url: str, PhotosMetaModel_Album: "PhotosMetaModel_AlbumManagement" = None):
        self.name = name
        self.url = url
...
class PhotosMetaModel_Column_p:
    ...
    def __init__(self, name: str, PhotosMetaModel_Column_p: set["PhotosMetaModel_Constraint"] = None, PhotosMetaModel_Column_p57: "PhotosMetaModel_DataType" = None, PhotosMetaModel_Column_p83: "PhotosMetaModel_Table_p" = None, PhotosMetaModel_Column_p91: "PhotosMetaModel_Table_p" = None, PhotosMetaModel_Column_p78: "PhotosMetaModel_ForeignKey" = None):
        self.name = name
