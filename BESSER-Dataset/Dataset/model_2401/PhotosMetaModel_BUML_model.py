...
# Classes
PhotosMetaModel_Architecture = Class(name="PhotosMetaModel_Architecture")
PhotosMetaModel_Technology = Class(name="PhotosMetaModel_Technology")
PhotosMetaModel_Functionalities = Class(name="PhotosMetaModel_Functionalities")
PhotosMetaModel_Entities = Class(name="PhotosMetaModel_Entities")
PhotosMetaModel_NTier = Class(name="PhotosMetaModel_NTier")
PhotosMetaModel_Spring = Class(name="PhotosMetaModel_Spring")
PhotosMetaModel_PostgreSQL = Class(name="PhotosMetaModel_PostgreSQL")
PhotosMetaModel_SoftGallery = Class(name="PhotosMetaModel_SoftGallery")
PhotosMetaModel_Domain = Class(name="PhotosMetaModel_Domain")
PhotosMetaModel_Entity = Class(name="PhotosMetaModel_Entity")
PhotosMetaModel_Component = Class(name="PhotosMetaModel_Component")
PhotosMetaModel_Configuration = Class(name="PhotosMetaModel_Configuration")
PhotosMetaModel_RequestPart = Class(name="PhotosMetaModel_RequestPart")
PhotosMetaModel_PostMapping = Class(name="PhotosMetaModel_PostMapping")
RequestMapping = Class(name="RequestMapping")
PhotosMetaModel_GetMapping = Class(name="PhotosMetaModel_GetMapping")
PhotosMetaModel_PutMapping = Class(name="PhotosMetaModel_PutMapping")
PhotosMetaModel_React = Class(name="PhotosMetaModel_React")
PhotosMetaModel_AmazonWebServices = Class(name="PhotosMetaModel_AmazonWebServices")
PhotosMetaModel_SpringBootApplication = Class(name="PhotosMetaModel_SpringBootApplication")
PhotosMetaModel_Modules = Class(name="PhotosMetaModel_Modules")
PhotosMetaModel_Repository = Class(name="PhotosMetaModel_Repository")
PhotosMetaModel_RestController = Class(name="PhotosMetaModel_RestController")
PhotosMetaModel_RequestMapping = Class(name="PhotosMetaModel_RequestMapping")
PhotosMetaModel_ExceptionHandler = Class(name="PhotosMetaModel_ExceptionHandler")
PhotosMetaModel_Autowired = Class(name="PhotosMetaModel_Autowired")
PhotosMetaModel_Specification = Class(name="PhotosMetaModel_Specification")
PhotosMetaModel_Constraint = Class(name="PhotosMetaModel_Constraint")
PhotosMetaModel_DataType = Class(name="PhotosMetaModel_DataType")
PhotosMetaModel_SearchCriteria = Class(name="PhotosMetaModel_SearchCriteria")
PhotosMetaModel_Predicate = Class(name="PhotosMetaModel_Predicate")
PhotosMetaModel_Bean = Class(name="PhotosMetaModel_Bean")
PhotosMetaModel_EnableWebSecurity = Class(name="PhotosMetaModel_EnableWebSecurity")
PhotosMetaModel_EnableResourceServer = Class(name="PhotosMetaModel_EnableResourceServer")
PhotosMetaModel_EnableAuthorizationServer = Class(name="PhotosMetaModel_EnableAuthorizationServer")
PhotosMetaModel_Exception = Class(name="PhotosMetaModel_Exception")
PhotosMetaModel_DeleteMapping = Class(name="PhotosMetaModel_DeleteMapping")
PhotosMetaModel_Table_s = Class(name="PhotosMetaModel_Table_s")
PhotosMetaModel_NamedNativeQuery = Class(name="PhotosMetaModel_NamedNativeQuery")
PhotosMetaModel_Column_s = Class(name="PhotosMetaModel_Column_s")
PhotosMetaModel_Id = Class(name="PhotosMetaModel_Id")
PhotosMetaModel_GeneratedValue = Class(name="PhotosMetaModel_GeneratedValue")
PhotosMetaModel_Column_p = Class(name="PhotosMetaModel_Column_p")
PhotosMetaModel_Row = Class(name="PhotosMetaModel_Row")
PhotosMetaModel_Function_p = Class(name="PhotosMetaModel_Function_p")
PhotosMetaModel_Database = Class(name="PhotosMetaModel_Database")
PhotosMetaModel_Scheme = Class(name="PhotosMetaModel_Scheme")
PhotosMetaModel_EnableGlobalMethodSecurity = Class(name="PhotosMetaModel_EnableGlobalMethodSecurity")
PhotosMetaModel_Order_s = Class(name="PhotosMetaModel_Order_s")
PhotosMetaModel_Cluster = Class(name="PhotosMetaModel_Cluster")
PhotosMetaModel_Query = Class(name="PhotosMetaModel_Query")
PhotosMetaModel_Clause = Class(name="PhotosMetaModel_Clause")
PhotosMetaModel_ForeignKey = Class(name="PhotosMetaModel_ForeignKey")
PhotosMetaModel_Table_p = Class(name="PhotosMetaModel_Table_p")
PhotosMetaModel_Trigger = Class(name="PhotosMetaModel_Trigger")
PhotosMetaModel_View = Class(name="PhotosMetaModel_View")
PhotosMetaModel_Index_p = Class(name="PhotosMetaModel_Index_p")
PhotosMetaModel_Policy = Class(name="PhotosMetaModel_Policy")
PhotosMetaModel_Column = Class(name="PhotosMetaModel_Column")
PhotosMetaModel_Index = Class(name="PhotosMetaModel_Index")
PhotosMetaModel_User_d = Class(name="PhotosMetaModel_User_d")
Entities = Class(name="Entities")
PhotosMetaModel_User_p = Class(name="PhotosMetaModel_User_p")
PhotosMetaModel_Privilege = Class(name="PhotosMetaModel_Privilege")
PhotosMetaModel_AmazonSimpleStorageService = Class(name="PhotosMetaModel_AmazonSimpleStorageService")
PhotosMetaModel_AmazonElasticComputeCloud = Class(name="PhotosMetaModel_AmazonElasticComputeCloud")
PhotosMetaModel_Connection = Class(name="PhotosMetaModel_Connection")
PhotosMetaModel_Layer = Class(name="PhotosMetaModel_Layer")
PhotosMetaModel_Relation = Class(name="PhotosMetaModel_Relation")
PhotosMetaModel_AppAccess = Class(name="PhotosMetaModel_AppAccess")
Functionalities = Class(name="Functionalities")
PhotosMetaModel_ProfileManagement = Class(name="PhotosMetaModel_ProfileManagement")
PhotosMetaModel_AlbumManagement = Class(name="PhotosMetaModel_AlbumManagement")
PhotosMetaModel_PhotoActions = Class(name="PhotosMetaModel_PhotoActions")
PhotosMetaModel_Photo = Class(name="PhotosMetaModel_Photo")
PhotosMetaModel_Album = Class(name="PhotosMetaModel_Album")
PhotosMetaModel_BusinessLogicSegment = Class(name="PhotosMetaModel_BusinessLogicSegment")
PhotosMetaModel_Data = Class(name="PhotosMetaModel_Data")
PhotosMetaModel_DataSegment = Class(name="PhotosMetaModel_DataSegment")
PhotosMetaModel_AllowedToUse = Class(name="PhotosMetaModel_AllowedToUse")
Relation = Class(name="Relation")
PhotosMetaModel_SegmentStructure = Class(name="PhotosMetaModel_SegmentStructure")
PhotosMetaModel_View_a = Class(name="PhotosMetaModel_View_a")
PresentationSegment = Class(name="PresentationSegment")
PhotosMetaModel_Component_a = Class(name="PhotosMetaModel_Component_a")
PhotosMetaModel_Action_a = Class(name="PhotosMetaModel_Action_a")
PhotosMetaModel_Controller_a = Class(name="PhotosMetaModel_Controller_a")
BusinessLogicSegment = Class(name="BusinessLogicSegment")
PhotosMetaModel_Model_a = Class(name="PhotosMetaModel_Model_a")
PhotosMetaModel_REST = Class(name="PhotosMetaModel_REST")
Connection = Class(name="Connection")
PhotosMetaModel_PostgreSQLConnection = Class(name="PhotosMetaModel_PostgreSQLConnection")
PhotosMetaModel_AmazonS3API = Class(name="PhotosMetaModel_AmazonS3API")
PhotosMetaModel_Presentation = Class(name="PhotosMetaModel_Presentation")
Layer = Class(name="Layer")
PhotosMetaModel_PresentationSegment = Class(name="PhotosMetaModel_PresentationSegment")
PhotosMetaModel_BusinessLogic = Class(name="PhotosMetaModel_BusinessLogic")
PhotosMetaModel_BatchOperation = Class(name="PhotosMetaModel_BatchOperation")
PhotosMetaModel_Access = Class(name="PhotosMetaModel_Access")
PhotosMetaModel_File_a = Class(name="PhotosMetaModel_File_a")
PhotosMetaModel_Folder_a = Class(name="PhotosMetaModel_Folder_a")
PhotosMetaModel_Public = Class(name="PhotosMetaModel_Public")
Access = Class(name="Access")
PhotosMetaModel_ObjectsPublic = Class(name="PhotosMetaModel_ObjectsPublic")
PhotosMetaModel_BucketObjectsNotPublic = Class(name="PhotosMetaModel_BucketObjectsNotPublic")
PhotosMetaModel_OnlyAuthorized = Class(name="PhotosMetaModel_OnlyAuthorized")
PhotosMetaModel_Repository_a = Class(name="PhotosMetaModel_Repository_a")
PhotosMetaModel_Security_a = Class(name="PhotosMetaModel_Security_a")
PhotosMetaModel_PostgreSQL_a = Class(name="PhotosMetaModel_PostgreSQL_a")
DataSegment = Class(name="DataSegment")
PhotosMetaModel_AmazonS3Storage = Class(name="PhotosMetaModel_AmazonS3Storage")
PhotosMetaModel_Components = Class(name="PhotosMetaModel_Components")
Modules = Class(name="Modules")
PhotosMetaModel_ReactClasses = Class(name="PhotosMetaModel_ReactClasses")
PhotosMetaModel_ReactFunctions = Class(name="PhotosMetaModel_ReactFunctions")
PhotosMetaModel_Render = Class(name="PhotosMetaModel_Render")
ReactFunctions = Class(name="ReactFunctions")
PhotosMetaModel_Constructor = Class(name="PhotosMetaModel_Constructor")
PhotosMetaModel_LifeCycle = Class(name="PhotosMetaModel_LifeCycle")
PhotosMetaModel_Bucket = Class(name="PhotosMetaModel_Bucket")
PhotosMetaModel_Props = Class(name="PhotosMetaModel_Props")
PhotosMetaModel_State = Class(name="PhotosMetaModel_State")
PhotosMetaModel_CoreFunctions = Class(name="PhotosMetaModel_CoreFunctions")
PhotosMetaModel_Router = Class(name="PhotosMetaModel_Router")
Logic = Class(name="Logic")
PhotosMetaModel_Structure = Class(name="PhotosMetaModel_Structure")
PhotosMetaModel_ViewComponents = Class(name="PhotosMetaModel_ViewComponents")
UI = Class(name="UI")
PhotosMetaModel_Subcomponents = Class(name="PhotosMetaModel_Subcomponents")
PhotosMetaModel_Actions = Class(name="PhotosMetaModel_Actions")
PhotosMetaModel_MetaData = Class(name="PhotosMetaModel_MetaData")
PhotosMetaModel_ReactConfiguration = Class(name="PhotosMetaModel_ReactConfiguration")
PhotosMetaModel_ReactDOM = Class(name="PhotosMetaModel_ReactDOM")
ReactConfiguration = Class(name="ReactConfiguration")
PhotosMetaModel_Dependencies = Class(name="PhotosMetaModel_Dependencies")
PhotosMetaModel_Logic = Class(name="PhotosMetaModel_Logic")
Components = Class(name="Components")
PhotosMetaModel_UI = Class(name="PhotosMetaModel_UI")
PhotosMetaModel_Information = Class(name="PhotosMetaModel_Information")
PhotosMetaModel_Directories = Class(name="PhotosMetaModel_Directories")
PhotosMetaModel_Files = Class(name="PhotosMetaModel_Files")
PhotosMetaModel_Request = Class(name="PhotosMetaModel_Request")
Actions = Class(name="Actions")
PhotosMetaModel_Services = Class(name="PhotosMetaModel_Services")
PhotosMetaModel_Libraries = Class(name="PhotosMetaModel_Libraries")
...
PhotosMetaModel_User_d.attributes={PhotosMetaModel_User_d_username, PhotosMetaModel_User_d_first_name, PhotosMetaModel_User_d_password, PhotosMetaModel_User_d_last_name, PhotosMetaModel_User_d_email, PhotosMetaModel_User_d_profile_description}
...
PhotosMetaModel_User_p.attributes={PhotosMetaModel_User_p_password, PhotosMetaModel_User_p_username}
...
PhotosMetaModel_Album.attributes={PhotosMetaModel_Album_name, PhotosMetaModel_Album_url}
...
PhotosMetaModel_PostgreSQLConnection.attributes={PhotosMetaModel_PostgreSQLConnection_port, PhotosMetaModel_PostgreSQLConnection_username, PhotosMetaModel_PostgreSQLConnection_url, PhotosMetaModel_PostgreSQLConnection_password}
...
PhotosMetaModel_AmazonS3API.attributes={PhotosMetaModel_AmazonS3API_accessKey, PhotosMetaModel_AmazonS3API_bucketName, PhotosMetaModel_AmazonS3API_secretKey, PhotosMetaModel_AmazonS3API_endpointUrl}
...
PhotosMetaModel_Props.attributes={PhotosMetaModel_Props_dataType, PhotosMetaModel_Props_type}
...
PhotosMetaModel_ReactDOM.attributes={PhotosMetaModel_ReactDOM_isStruct, PhotosMetaModel_ReactDOM_isRoute, PhotosMetaModel_ReactDOM_isConstant}
...
PhotosMetaModel_Files.attributes={PhotosMetaModel_Files_type, PhotosMetaModel_Files_extension}
...
domain_model = DomainModel(
    ...
    types={PhotosMetaModel_Architecture, PhotosMetaModel_Technology, PhotosMetaModel_Functionalities, PhotosMetaModel_Entities, PhotosMetaModel_NTier, PhotosMetaModel_Spring, PhotosMetaModel_PostgreSQL, PhotosMetaModel_SoftGallery, PhotosMetaModel_Domain, PhotosMetaModel_Entity, PhotosMetaModel_Component, PhotosMetaModel_Configuration, PhotosMetaModel_RequestPart, PhotosMetaModel_PostMapping, RequestMapping, PhotosMetaModel_GetMapping, PhotosMetaModel_PutMapping, PhotosMetaModel_React, PhotosMetaModel_AmazonWebServices, PhotosMetaModel_SpringBootApplication, PhotosMetaModel_Modules, PhotosMetaModel_Repository, PhotosMetaModel_RestController, PhotosMetaModel_RequestMapping, PhotosMetaModel_ExceptionHandler, PhotosMetaModel_Autowired, PhotosMetaModel_Specification, PhotosMetaModel_Constraint, PhotosMetaModel_DataType, PhotosMetaModel_SearchCriteria, PhotosMetaModel_Predicate, PhotosMetaModel_Bean, PhotosMetaModel_EnableWebSecurity, PhotosMetaModel_EnableResourceServer, PhotosMetaModel_EnableAuthorizationServer, PhotosMetaModel_Exception, PhotosMetaModel_DeleteMapping, PhotosMetaModel_Table_s, PhotosMetaModel_NamedNativeQuery, PhotosMetaModel_Column_s, PhotosMetaModel_Id, PhotosMetaModel_GeneratedValue, PhotosMetaModel_Column_p, PhotosMetaModel_Row, PhotosMetaModel_Function_p, PhotosMetaModel_Database, PhotosMetaModel_Scheme, PhotosMetaModel_EnableGlobalMethodSecurity, PhotosMetaModel_Order_s, PhotosMetaModel_Cluster, PhotosMetaModel_Query, PhotosMetaModel_Clause, PhotosMetaModel_ForeignKey, PhotosMetaModel_Table_p, PhotosMetaModel_Trigger, PhotosMetaModel_View, PhotosMetaModel_Index_p, PhotosMetaModel_Policy, PhotosMetaModel_Column, PhotosMetaModel_Index, PhotosMetaModel_User_d, Entities, PhotosMetaModel_User_p, PhotosMetaModel_Privilege, PhotosMetaModel_AmazonSimpleStorageService, PhotosMetaModel_AmazonElasticComputeCloud, PhotosMetaModel_Connection, PhotosMetaModel_Layer, PhotosMetaModel_Relation, PhotosMetaModel_AppAccess, Functionalities, PhotosMetaModel_ProfileManagement, PhotosMetaModel_AlbumManagement, PhotosMetaModel_PhotoActions, PhotosMetaModel_Photo, PhotosMetaModel_Album, PhotosMetaModel_BusinessLogicSegment, PhotosMetaModel_Data, PhotosMetaModel_DataSegment, PhotosMetaModel_AllowedToUse, Relation, PhotosMetaModel_SegmentStructure, PhotosMetaModel_View_a, PresentationSegment, PhotosMetaModel_Component_a, PhotosMetaModel_Action_a, PhotosMetaModel_Controller_a, BusinessLogicSegment, PhotosMetaModel_Model_a, PhotosMetaModel_REST, Connection, PhotosMetaModel_PostgreSQLConnection, PhotosMetaModel_AmazonS3API, PhotosMetaModel_Presentation, Layer, PhotosMetaModel_PresentationSegment, PhotosMetaModel_BusinessLogic, PhotosMetaModel_BatchOperation, PhotosMetaModel_Access, PhotosMetaModel_File_a, PhotosMetaModel_Folder_a, PhotosMetaModel_Public, Access, PhotosMetaModel_ObjectsPublic, PhotosMetaModel_BucketObjectsNotPublic, PhotosMetaModel_OnlyAuthorized, PhotosMetaModel_Repository_a, PhotosMetaModel_Security_a, PhotosMetaModel_PostgreSQL_a, DataSegment, PhotosMetaModel_AmazonS3Storage, PhotosMetaModel_Components, Modules, PhotosMetaModel_ReactClasses, PhotosMetaModel_ReactFunctions, PhotosMetaModel_Render, ReactFunctions, PhotosMetaModel_Constructor, PhotosMetaModel_LifeCycle, PhotosMetaModel_Bucket, PhotosMetaModel_Props, PhotosMetaModel_State, PhotosMetaModel_CoreFunctions, PhotosMetaModel_Router, Logic, PhotosMetaModel_Structure, PhotosMetaModel_ViewComponents, UI, PhotosMetaModel_Subcomponents, PhotosMetaModel_Actions, PhotosMetaModel_MetaData, PhotosMetaModel_ReactConfiguration, PhotosMetaModel_ReactDOM, ReactConfiguration, PhotosMetaModel_Dependencies, PhotosMetaModel_Logic, Components, PhotosMetaModel_UI, PhotosMetaModel_Information, PhotosMetaModel_Directories, PhotosMetaModel_Files, PhotosMetaModel_Request, Actions, PhotosMetaModel_Services, PhotosMetaModel_Libraries},
    associations={domain0, architecture1, technology3, functionalities5, entities7, ntier9, spring11, postgresql13, repository30, restcontroller32, entity35, component37, configuration39, requestpart41, react15, amazonwebservices17, springbootapplication19, modules21, requestmapping23, exceptionhandler24, autowired26, specification28, constraint55, datatype56, searchcriteria58, specification60, bean62, enablewebsecurity64, enableresourceserver66, enableauthorizationserver68, exception43, table45, namednativequery47, column_s49, id51, generatedvalue53, column81, row84, foreignkey86, primaryKey89, inherit93, scheme95, table_postgresql96, enableglobalmethodsecurity70, order72, cluster74, clause76, column77, reference79, user_p114, policy117, datatype119, constraint121, view_postgresql99, index101, trigger103, storedprocedure105, execute107, privilege109, database111, albummanagement129, amazonsimplestorageservice131, amazonelasticcomputecloud133, connection135, layer137, relation139, sourceLayer141, targetLayer144, functionalities124, albummanagement126, photoactions127, BusinessLogicSegment154, dataSegment155, segmentstructure156, segmentstructure158, segmentstructure161, sourceLayer147, targetLayer150, presentationLayer153, batchoperation170, access172, file_a174, folder_a176, reactclasses164, modules165, bucket168, props185, state187, corefunctions190, metadata178, file_a180, reactfunctions183, directories192, files194, files196, request191},
    generalizations={gen_PhotosMetaModel_PostMapping_RequestMapping, gen_PhotosMetaModel_GetMapping_RequestMapping, gen_PhotosMetaModel_PutMapping_RequestMapping, gen_PhotosMetaModel_DeleteMapping_RequestMapping, gen_PhotosMetaModel_User_d_Entities, gen_PhotosMetaModel_AppAccess_Functionalities, gen_PhotosMetaModel_ProfileManagement_Functionalities, gen_PhotosMetaModel_AlbumManagement_Functionalities, gen_PhotosMetaModel_PhotoActions_Functionalities, gen_PhotosMetaModel_Photo_Entities, gen_PhotosMetaModel_Album_Entities, gen_PhotosMetaModel_Data_Layer, gen_PhotosMetaModel_AllowedToUse_Relation, gen_PhotosMetaModel_View_a_PresentationSegment, gen_PhotosMetaModel_Component_a_PresentationSegment, gen_PhotosMetaModel_Action_a_PresentationSegment, gen_PhotosMetaModel_Controller_a_BusinessLogicSegment, gen_PhotosMetaModel_Model_a_BusinessLogicSegment, gen_PhotosMetaModel_REST_Connection, gen_PhotosMetaModel_PostgreSQLConnection_Connection, gen_PhotosMetaModel_AmazonS3API_Connection, gen_PhotosMetaModel_Presentation_Layer, gen_PhotosMetaModel_BusinessLogic_Layer, gen_PhotosMetaModel_Public_Access, gen_PhotosMetaModel_ObjectsPublic_Access, gen_PhotosMetaModel_BucketObjectsNotPublic_Access, gen_PhotosMetaModel_OnlyAuthorized_Access, gen_PhotosMetaModel_Repository_a_BusinessLogicSegment, gen_PhotosMetaModel_Security_a_BusinessLogicSegment, gen_PhotosMetaModel_PostgreSQL_a_DataSegment, gen_PhotosMetaModel_AmazonS3Storage_DataSegment, gen_PhotosMetaModel_Components_Modules, gen_PhotosMetaModel_Render_ReactFunctions, gen_PhotosMetaModel_Constructor_ReactFunctions, gen_PhotosMetaModel_LifeCycle_ReactFunctions, gen_PhotosMetaModel_CoreFunctions_ReactFunctions, gen_PhotosMetaModel_Router_Logic, gen_PhotosMetaModel_Structure_Logic, gen_PhotosMetaModel_ViewComponents_UI, gen_PhotosMetaModel_Subcomponents_UI, gen_PhotosMetaModel_Actions_Modules, gen_PhotosMetaModel_ReactConfiguration_Modules, gen_PhotosMetaModel_ReactDOM_ReactConfiguration, gen_PhotosMetaModel_Dependencies_ReactConfiguration, gen_PhotosMetaModel_Logic_Components, gen_PhotosMetaModel_UI_Components, gen_PhotosMetaModel_Information_Modules, gen_PhotosMetaModel_Request_Actions, gen_PhotosMetaModel_Services_Actions, gen_PhotosMetaModel_Libraries_Modules},
    metadata=None
)
