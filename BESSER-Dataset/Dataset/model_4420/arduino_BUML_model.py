...
# Classes
arduino_Arduino = Class(name="arduino_Arduino")
arduino_GndPort = Class(name="arduino_GndPort")
arduino_RxPort = Class(name="arduino_RxPort")
arduino_Port3V3 = Class(name="arduino_Port3V3")
arduino_RstPort = Class(name="arduino_RstPort")
arduino_DigitalPort = Class(name="arduino_DigitalPort")
arduino_AnalogPort = Class(name="arduino_AnalogPort")
arduino_TxPort = Class(name="arduino_TxPort")
arduino_Port9V = Class(name="arduino_Port9V")
arduino_Port5V = Class(name="arduino_Port5V")
arduino_PortIO7 = Class(name="arduino_PortIO7")
arduino_PortVIN = Class(name="arduino_PortVIN")
arduino_AREFPort = Class(name="arduino_AREFPort")
arduino_Port = Class(name="arduino_Port")
Port = Class(name="Port")
arduino_Bench = Class(name="arduino_Bench")
...
arduino_Arduino_m_digitalIOMessage: Method = Method(name="digitalIOMessage", parameters={Parameter(name='arduino_data', type=StringType), Parameter(name='arduino_pin', type=StringType)})
arduino_Arduino_m_analogIOMessage: Method = Method(name="analogIOMessage", parameters={Parameter(name='arduino_data', type=StringType), Parameter(name='arduino_pin', type=StringType)})
arduino_Arduino_m_reportAnalogPin: Method = Method(name="reportAnalogPin", parameters={Parameter(name='arduino_pin', type=StringType), Parameter(name='arduino_mode', type=StringType)})
arduino_Arduino_m_reportDigitalPin: Method = Method(name="reportDigitalPin", parameters={Parameter(name='arduino_pin', type=StringType), Parameter(name='arduino_mode', type=StringType)})
arduino_Arduino_m_synchronizingArduinoModel: Method = Method(name="synchronizingArduinoModel", parameters={Parameter(name='arduino_pin', type=StringType)}, type=BooleanType)
arduino_Arduino_m_synchronizingArduinoHardware: Method = Method(name="synchronizingArduinoHardware", parameters={Parameter(name='arduino_pin', type=StringType)}, type=BooleanType)
arduino_Arduino_m_getAnalogicPort: Method = Method(name="getAnalogicPort", parameters={Parameter(name='arduino_pin', type=StringType)}, type=StringType)
arduino_Arduino_m_getDigitalPort: Method = Method(name="getDigitalPort", parameters={Parameter(name='arduino_pin', type=StringType)}, type=StringType)
arduino_Arduino_m_getAnalogicPort: Method = Method(name="getAnalogicPort", parameters={Parameter(name='arduino_pin', type=StringType)}, type=StringType)
arduino_Arduino_m_getDigitalPort: Method = Method(name="getDigitalPort", parameters={Parameter(name='arduino_pin', type=StringType)}, type=StringType)
...
arduino_Arduino_m_getDigitalPortFromChannel: Method = Method(name="getDigitalPortFromChannel", parameters={Parameter(name='arduino_channel', type=StringType)}, type=StringType)
arduino_Arduino_m_getAnalogicPortFromChannel: Method = Method(name="getAnalogicPortFromChannel", parameters={Parameter(name='arduino_channel', type=StringType)}, type=StringType)
arduino_Arduino.attributes={arduino_Arduino_comm, arduino_Arduino_firmataMode, arduino_Arduino_series, arduino_Arduino_status, arduino_Arduino_name, arduino_Arduino_kind, arduino_Arduino_ver, arduino_Arduino_label, arduino_Arduino_lockedPin, arduino_Arduino_board, arduino_Arduino_synchronizing}
arduino_Arduino.methods={arduino_Arduino_m_getAnalogicPort, arduino_Arduino_m_getPorts, arduino_Arduino_m_getDigitalPort, arduino_Arduino_m_reportAnalogPin, arduino_Arduino_m_getDigitalPort, arduino_Arduino_m_digitalIOMessage, arduino_Arduino_m_synchronizingArduinoModel, arduino_Arduino_m_getAnalogicPort, arduino_Arduino_m_synchronizingArduinoHardware, arduino_Arduino_m_getCommPorts, arduino_Arduino_m_getDigitalPortFromChannel, arduino_Arduino_m_reportDigitalPin, arduino_Arduino_m_analogIOMessage, arduino_Arduino_m_getAnalogicPortFromChannel}
...
arduino_Port.attributes={arduino_Port_channel, arduino_Port_report, arduino_Port_map, arduino_Port_name}
...
domain_model = DomainModel(
    name="arduino",
    types={arduino_Arduino, arduino_GndPort, arduino_RxPort, arduino_Port3V3, arduino_RstPort, arduino_DigitalPort, arduino_AnalogPort, arduino_TxPort, arduino_Port9V, arduino_Port5V, arduino_PortIO7, arduino_PortVIN, arduino_AREFPort, arduino_Port, Port, arduino_Bench, ARDUINO_VER_BRAND_NAME, ARDUINO_COMM, PIN_MAPPING, ARDUINO_BOARD_KIND, ARDUINO_BOARD_UID, ARDUINO_REPORT_MODE, ARDUINO_ATMEGA_168_SERIES, ARDUINO_STATUS_MODE, PIN_MODE, PWM_MODE, ARDUINO_FIRMWARE_MODE},
    associations={groundPorts5, rx7, pwm3V39, digitalPorts0, analogPorts1, tx3, pwm9V13, pwm5V15, io717, vin19, aref21, resetPort11, boards23},
    generalizations={gen_arduino_DigitalPort_Port, gen_arduino_RxPort_Port, gen_arduino_TxPort_Port, gen_arduino_GndPort_Port, gen_arduino_Port3V3_Port, gen_arduino_RstPort_Port, gen_arduino_Port5V_Port, gen_arduino_Port9V_Port, gen_arduino_PortIO7_Port, gen_arduino_AREFPort_Port, gen_arduino_PortVIN_Port, gen_arduino_AnalogPort_Port},
    metadata=None
)
