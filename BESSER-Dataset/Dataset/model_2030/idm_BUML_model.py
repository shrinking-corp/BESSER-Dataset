...
# Classes
idm_StateMachine = Class(name="idm_StateMachine")
idm_State = Class(name="idm_State")
idm_Transition = Class(name="idm_Transition")
...
outgoing6: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_", type=idm_State, multiplicity=Multiplicity(0, 9999))
    }
)
...
domain_model = DomainModel(
    name="idm",
    types={idm_StateMachine, idm_State, idm_Transition},
    associations={state0, transition1, from_3, to4, outgoing6, incoming7},
    generalizations={},
    metadata=None
)
