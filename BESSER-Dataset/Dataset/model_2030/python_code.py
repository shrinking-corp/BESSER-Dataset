...
class idm_Transition:
    ...
    def __init__(self, name: str, idm_Transition: "idm_StateMachine" = None, Transition: "idm_State" = None, Transition5: "idm_State" = None, from_: set["idm_State"] = None, to: set["idm_State"] = None):
        self.name = name
    ...
    def from_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_idm_Transition__from_", None)
