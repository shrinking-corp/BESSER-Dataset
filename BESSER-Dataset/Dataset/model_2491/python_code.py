...
class z8fsm_AbstractState(ABC):
    ...
    def __init__(self, id: str, z8fsm_AbstractState3: "z8fsm_AbstractState" = None, z8fsm_AbstractState1: set["z8fsm_AbstractState"] = None, z8fsm_AbstractState: "z8fsm_Region" = None):
        self.id = id
