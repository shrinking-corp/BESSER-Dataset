...
def test_hyp_imported_model_book_is_not_abstract():
    assert not inspect.isabstract(imported_model_Book)


def test_hyp_imported_model_book_constructor_exists():
    assert callable(imported_model_Book.__init__)


def test_hyp_imported_model_book_constructor_args():
...
def test_hyp_imported_model_library_is_not_abstract():
    assert not inspect.isabstract(imported_model_Library)


def test_hyp_imported_model_library_constructor_exists():
    assert callable(imported_model_Library.__init__)


def test_hyp_imported_model_library_constructor_args():
...
def test_hyp_imported_model_book_pages_setter(instance):
