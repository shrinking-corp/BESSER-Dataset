...
public class aadl2_ComponentClassifier extends Classifier {
    ...
    public aadl2_ComponentClassifier(
        String noModes,        String noFlows        ArrayList<aadl2_InternalEvent> aadl2_internalevents,        ArrayList<aadl2_ModeTransition> aadl2_modetransitions,        ArrayList<aadl2_ProcessorPort> aadl2_processorports,        ArrayList<aadl2_Mode> aadl2_modes    ) {
        this.noModes = noModes;
        this.noFlows = noFlows;
