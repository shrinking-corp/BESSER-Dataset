...
public class aadl2_Classifier extends Namespace, Type {
    ...
    public aadl2_Classifier(
        String noProperties,        String noAnnexes,        String noPrototypes        ArrayList<aadl2_NamedElement> aadl2_namedelements,        ArrayList<aadl2_ClassifierFeature> aadl2_classifierfeatures,        ArrayList<aadl2_PrototypeBinding> aadl2_prototypebindings    ) {
        this.noProperties = noProperties;
        this.noAnnexes = noAnnexes;
        this.noPrototypes = noPrototypes;
