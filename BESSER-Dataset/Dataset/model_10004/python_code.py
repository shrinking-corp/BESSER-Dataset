...
class CoachBusWithEDataType_Manager(Employee):
    ...
    def __init__(self, hasMBA: bool, Manager: "CoachBusWithEDataType_BookingOffice" = None, manager: "CoachBusWithEDataType_BookingOffice" = None):
        self.hasMBA = hasMBA
    ...
    def manager(self, value):
        ...
        old_value = getattr(self, f"_CoachBusWithEDataType_Manager__manager", None)
...
class CoachBusWithEDataType_VendingMachine:

    def __init__(self, number: int, VendingMachine: "CoachBusWithEDataType_BookingOffice" = None, VendingMachine23: "CoachBusWithEDataType_Ticket" = None, vm: set["CoachBusWithEDataType_Ticket"] = None, vms: "CoachBusWithEDataType_BookingOffice" = None):
        self.number = number
    ...
    def vms(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_CoachBusWithEDataType_VendingMachine__vms", None)
        self.__vms = value
    ...
    def vm(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_CoachBusWithEDataType_VendingMachine__vm", None)
    ...
    def VendingMachine(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_CoachBusWithEDataType_VendingMachine__VendingMachine", None)
    ...
    def VendingMachine23(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_CoachBusWithEDataType_VendingMachine__VendingMachine23", None)
...
class CoachBusWithEDataType_Passenger:
    ...
    def __init__(self, name: str, age: int, idCard: str, sex: str, Passenger20: "CoachBusWithEDataType_Ticket" = None, passengers: set["CoachBusWithEDataType_Trip"] = None, psg: set["CoachBusWithEDataType_Ticket"] = None, Passenger: "CoachBusWithEDataType_Trip" = None):
        self.name = name
        self.age = age
        self.idCard = idCard
        self.sex = sex
    ...
    def passengers(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_CoachBusWithEDataType_Passenger__passengers", None)
    ...
    def Passenger20(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_CoachBusWithEDataType_Passenger__Passenger20", None)
    ...
    def psg(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_CoachBusWithEDataType_Passenger__psg", None)
    ...
    def Passenger(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_CoachBusWithEDataType_Passenger__Passenger", None)
...
class CoachBusWithEDataType_Coach:
    ...
    def __init__(self, id: int, name: str, model: str, noOfSeats: int, Coach11: "CoachBusWithEDataType_SecurityGuard" = None, coach: set["CoachBusWithEDataType_SecurityGuard"] = None, coaches6: set["CoachBusWithEDataType_BookingOffice"] = None, Coach: "CoachBusWithEDataType_Trip" = None, coaches: set["CoachBusWithEDataType_Trip"] = None, Coach15: "CoachBusWithEDataType_BookingOffice" = None):
        self.id = id
        self.name = name
        self.model = model
    ...
    def Coach11(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_CoachBusWithEDataType_Coach__Coach11", None)
    ...
    def Coach(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_CoachBusWithEDataType_Coach__Coach", None)
        self.__Coach = value
    ...
    def coaches6(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_CoachBusWithEDataType_Coach__coaches6", None)
    ...
    def coaches(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_CoachBusWithEDataType_Coach__coaches", None)
    ...
    def Coach15(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_CoachBusWithEDataType_Coach__Coach15", None)
...
class CoachBusWithEDataType_Trip:
    ...
    def __init__(self, name: str, origin: str, destination: str, type: str, number: int, Trip8: "CoachBusWithEDataType_Passenger" = None, trips: set["CoachBusWithEDataType_Coach"] = None, trips2: set["CoachBusWithEDataType_Passenger"] = None, Trip: "CoachBusWithEDataType_Coach" = None):
        self.name = name
        self.origin = origin
    ...
    def Trip8(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_CoachBusWithEDataType_Trip__Trip8", None)
        self.__Trip8 = value
    ...
    def Trip(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_CoachBusWithEDataType_Trip__Trip", None)
        self.__Trip = value
    ...
    def trips2(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_CoachBusWithEDataType_Trip__trips2", None)
    ...
    def trips(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_CoachBusWithEDataType_Trip__trips", None)
...
class CoachBusWithEDataType_Ticket:
    ...
    def __init__(self, number: int, price: float, isRoundTrip: bool, tickets: "CoachBusWithEDataType_Passenger" = None, tickets22: "CoachBusWithEDataType_VendingMachine" = None, Ticket25: "CoachBusWithEDataType_VendingMachine" = None, Ticket: "CoachBusWithEDataType_Passenger" = None):
        self.number = number
        self.price = price
    ...
    def Ticket25(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_CoachBusWithEDataType_Ticket__Ticket25", None)
    ...
    def tickets(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_CoachBusWithEDataType_Ticket__tickets", None)
    ...
    def tickets22(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_CoachBusWithEDataType_Ticket__tickets22", None)
    ...
    def Ticket(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_CoachBusWithEDataType_Ticket__Ticket", None)
        self.__Ticket = value
...
class CoachBusWithEDataType_BookingOffice:

    def __init__(self, name: str, location: str, officeID: int, office: "CoachBusWithEDataType_Manager" = None, office18: set["CoachBusWithEDataType_VendingMachine"] = None, BookingOffice13: "CoachBusWithEDataType_Manager" = None, BookingOffice27: "CoachBusWithEDataType_VendingMachine" = None, BookingOffice: "CoachBusWithEDataType_Coach" = None, offices: set["CoachBusWithEDataType_Coach"] = None):
        self.name = name
    ...
    def BookingOffice27(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_CoachBusWithEDataType_BookingOffice__BookingOffice27", None)
    ...
    def office(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_CoachBusWithEDataType_BookingOffice__office", None)
        self.__office = value
    ...
    def offices(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_CoachBusWithEDataType_BookingOffice__offices", None)
    ...
    def office18(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_CoachBusWithEDataType_BookingOffice__office18", None)
    ...
    def BookingOffice13(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_CoachBusWithEDataType_BookingOffice__BookingOffice13", None)
    ...
    def BookingOffice(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_CoachBusWithEDataType_BookingOffice__BookingOffice", None)
...
class CoachBusWithEDataType_SecurityGuard(Employee):
    ...
    def __init__(self, shift: str, guards: "CoachBusWithEDataType_Coach" = None, SecurityGuard: "CoachBusWithEDataType_Coach" = None):
        self.shift = shift
        self.guards = guards
    ...
    def SecurityGuard(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_CoachBusWithEDataType_SecurityGuard__SecurityGuard", None)
    ...
    def guards(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_CoachBusWithEDataType_SecurityGuard__guards", None)
        self.__guards = value
