...
Order.attributes={Order_number, Order_status, Order_total, Order_shipTo, Order_shipped, Order_ordered}
...
domain_model = DomainModel(
    name="_11cc3b53_ad48_4528_8dbd_c225d19451c6",
    types={Customer, Payment, ShoppingCart, Account, WebUser, Order, LineItem, Product, UserState, OrderStatus},
    associations={Account_ShoppingCart, ShoppingCart_LineItem, Account_Payment, WebUser_ShoppingCart, WebUser_Customer, Customer_Account, Product_LineItem, Order_LineItem, Account_Order, Payment_Order},
    generalizations={},
    metadata=None
)
