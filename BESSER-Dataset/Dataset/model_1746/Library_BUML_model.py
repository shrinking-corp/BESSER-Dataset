...
library_LibraryContent = Class(name="library_LibraryContent", is_abstract=True)
...
library_LibraryContent.attributes={library_LibraryContent_author, library_LibraryContent_name}
