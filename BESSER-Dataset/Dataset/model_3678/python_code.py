...
class companies_department(CSTrace):
    ...
    def __init__(self, name: str, companies_department2: "companies_department_manager" = None, companies_department4: "companies_department_employees" = None, companies_department7: "companies_department" = None, companies_department5: set["companies_department"] = None, companies_department: "companies_company" = None):
        self.name = name
