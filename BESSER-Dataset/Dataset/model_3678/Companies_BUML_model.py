...
# Classes
companies_department_manager = Class(name="companies_department_manager")
companies_department_employees = Class(name="companies_department_employees")
companies_employee = Class(name="companies_employee")
companies_company = Class(name="companies_company")
CSTrace = Class(name="CSTrace")
companies_department = Class(name="companies_department")
companies_CSTrace = Class(name="companies_CSTrace", is_abstract=True)
companies_Visitable = Class(name="companies_Visitable")
...
companies_employee.attributes={companies_employee_salary, companies_employee_name, companies_employee_mentor, companies_employee_address}
...
domain_model = DomainModel(
    name="companies",
    types={companies_department_manager, companies_department_employees, companies_employee, companies_company, CSTrace, companies_department, companies_CSTrace, companies_Visitable},
    associations={department_manager1, department_employees3, deparment6, employee8, employee10, deparment0, ast13},
    generalizations={gen_companies_department_CSTrace, gen_companies_department_manager_CSTrace, gen_companies_department_employees_CSTrace, gen_companies_employee_CSTrace, gen_companies_company_CSTrace},
    metadata=None
)
