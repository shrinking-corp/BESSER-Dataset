...
# Classes
tbase_A = Class(name="tbase_A")
NamedElement = Class(name="NamedElement")
tbase_B = Class(name="tbase_B")
tbase_C = Class(name="tbase_C")
tbase_TRoot = Class(name="tbase_TRoot")
tbase_NamedElement = Class(name="tbase_NamedElement")
...
domain_model = DomainModel(
    name="tbase",
    types={tbase_A, NamedElement, tbase_B, tbase_C, tbase_TRoot, tbase_NamedElement},
