...
units_UnitLiteral = Class(name="units_UnitLiteral")
...
domain_model = DomainModel(
    name="units",
    types={units_UnitPower, units_UnitLiteral, units_UnitCarryingElement, units_BaseUnit, units_UnitRepository, units_Unit, units_UnitMultiplication, Unit},
    associations={units1, unit2, baseUnit4, unit6, units0},
    generalizations={gen_units_UnitPower_Unit, gen_units_UnitLiteral_Unit, gen_units_UnitMultiplication_Unit},
    metadata=None
)
