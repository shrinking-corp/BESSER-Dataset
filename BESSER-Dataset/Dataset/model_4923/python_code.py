...
class dsml_web_StringLengthValidator(Validator):
    ...
    def __init__(self, min: int, max: int, Validator: "dsml_web_Field" = None):
        self.min = min
        self.max = max
...
class dsml_web_RegexValidator(Validator):
    ...
    def __init__(self, regex: str, Validator: "dsml_web_Field" = None):
        self.regex = regex
...
class dsml_web_BetweenValidator(Validator):
    ...
    def __init__(self, valueL: int, valueG: int, Validator: "dsml_web_Field" = None):
        self.valueL = valueL
        self.valueG = valueG
...
class dsml_web_LessThanValidator(Validator):
    ...
    def __init__(self, value: int, Validator: "dsml_web_Field" = None):
        self.value = value
...
class dsml_web_TypeValidator(Validator):
    ...
    def __init__(self, type: str, Validator: "dsml_web_Field" = None):
        self.type = type
