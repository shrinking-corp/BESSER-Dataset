...
def test_hyp_address_has_country():
...
def test_hyp_address_has_suburb():
...
def test_hyp_address_has_street():
...
def test_hyp_address_has_postcode():
...
def test_hyp_address_has_state():
...
def test_hyp_address_instantiation(instance):
...
@given(instance=Address_strategy)
def test_hyp_address_suburb_setter(instance):
...
@given(instance=Address_strategy)
def test_hyp_address_postcode_setter(instance):
