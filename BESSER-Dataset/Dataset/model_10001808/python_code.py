...
class user_Provider:
    ...
    def __init__(self, providerId: str, displayName: str, email: str, photoURL: str, uid: str):
...
class user_Business:
    ...
    def __init__(self, id: datatypes_String, name: datatypes_String, category: str, website: str, email: str, phone: str, address: Address, adminUser: user_User, staffUsers: user_User, products: marketing_Product, avgRatings: datatypes_Number, tags: user_Tags):
        self.id = id
        self.name = name
