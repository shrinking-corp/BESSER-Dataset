...
connection_xml_TdXMLDocument = Class(name="connection_xml_TdXMLDocument")
...
connection_xml_TdXMLElement = Class(name="connection_xml_TdXMLElement")
xml_TdXMLDocument = Class(name="xml_TdXMLDocument")
xml_TdXMLContent = Class(name="xml_TdXMLContent")
connection_xml_TdXMLContent = Class(name="connection_xml_TdXMLContent")
xml_TdXMLElement = Class(name="xml_TdXMLElement")
...
connection_AbstractMetadataObject.attributes={connection_AbstractMetadataObject_readOnly, connection_AbstractMetadataObject_synchronised, connection_AbstractMetadataObject_label, connection_AbstractMetadataObject_comment, connection_AbstractMetadataObject_properties, connection_AbstractMetadataObject_id, connection_AbstractMetadataObject_divergency}
...
connection_MetadataColumn.attributes={connection_MetadataColumn_originalField, connection_MetadataColumn_talendType, connection_MetadataColumn_nullable, connection_MetadataColumn_pattern, connection_MetadataColumn_defaultValue, connection_MetadataColumn_key, connection_MetadataColumn_displayField, connection_MetadataColumn_sourceType}
...
connection_MetadataTable.attributes={connection_MetadataTable_tableType, connection_MetadataTable_sourceName, connection_MetadataTable_activatedCDC, connection_MetadataTable_attachedCDC}
...
connection_FileConnection.attributes={connection_FileConnection_CsvOption, connection_FileConnection_LimitValue, connection_FileConnection_FirstLineCaption, connection_FileConnection_UseFooter, connection_FileConnection_Encoding, connection_FileConnection_FieldSeparatorValue, connection_FileConnection_RemoveEmptyRow, connection_FileConnection_EscapeType, connection_FileConnection_FooterValue, connection_FileConnection_EscapeChar, connection_FileConnection_UseLimit, connection_FileConnection_RowSeparatorValue, connection_FileConnection_Server, connection_FileConnection_HeaderValue, connection_FileConnection_TextEnclosure, connection_FileConnection_Format, connection_FileConnection_FilePath, connection_FileConnection_TextIdentifier, connection_FileConnection_UseHeader, connection_FileConnection_RowSeparatorType}
...
connection_Concept.attributes={connection_Concept_LoopLimit, connection_Concept_LoopExpression}
...
connection_MDMConnection.attributes={connection_MDMConnection_Server, connection_MDMConnection_Username, connection_MDMConnection_Port, connection_MDMConnection_Password, connection_MDMConnection_Datacluster, connection_MDMConnection_Universe, connection_MDMConnection_Datamodel}
...
connection_DatabaseConnection.attributes={connection_DatabaseConnection_SQLMode, connection_DatabaseConnection_ProductId, connection_DatabaseConnection_SID, connection_DatabaseConnection_SqlSynthax, connection_DatabaseConnection_UiSchema, connection_DatabaseConnection_ServerName, connection_DatabaseConnection_dbVersionString, connection_DatabaseConnection_DatabaseType, connection_DatabaseConnection_NullChar, connection_DatabaseConnection_DriverJarPath, connection_DatabaseConnection_DbmsId, connection_DatabaseConnection_StringQuote, connection_DatabaseConnection_Password, connection_DatabaseConnection_cdcTypeMode, connection_DatabaseConnection_SystemSQL, connection_DatabaseConnection_Port, connection_DatabaseConnection_DBRootPath, connection_DatabaseConnection_AdditionalParams, connection_DatabaseConnection_URL, connection_DatabaseConnection_Username, connection_DatabaseConnection_FileFieldName, connection_DatabaseConnection_StandardSQL, connection_DatabaseConnection_DatasourceName, connection_DatabaseConnection_DriverClass}
...
connection_SAPConnection.attributes={connection_SAPConnection_Host, connection_SAPConnection_Password, connection_SAPConnection_SystemNumber, connection_SAPConnection_Language, connection_SAPConnection_Client, connection_SAPConnection_currentFucntion, connection_SAPConnection_Username}
...
connection_SAPFunctionUnit.attributes={connection_SAPFunctionUnit_OutputType, connection_SAPFunctionUnit_OutputTableName}
...
connection_XmlFileConnection.attributes={connection_XmlFileConnection_Guess, connection_XmlFileConnection_XsdFilePath, connection_XmlFileConnection_MaskXPattern, connection_XmlFileConnection_Encoding, connection_XmlFileConnection_XmlFilePath}
...
connection_SAPFunctionParameterColumn.attributes={connection_SAPFunctionParameterColumn_ParameterType, connection_SAPFunctionParameterColumn_StructureOrTableName, connection_SAPFunctionParameterColumn_Value, connection_SAPFunctionParameterColumn_DataType, connection_SAPFunctionParameterColumn_Length}
...
connection_LdifFileConnection.attributes={connection_LdifFileConnection_LimitEntry, connection_LdifFileConnection_UseLimit, connection_LdifFileConnection_FilePath, connection_LdifFileConnection_Server, connection_LdifFileConnection_value}
...
connection_LDAPSchemaConnection.attributes={connection_LDAPSchemaConnection_BindPrincipal, connection_LDAPSchemaConnection_UseAdvanced, connection_LDAPSchemaConnection_BindPassword, connection_LDAPSchemaConnection_Value, connection_LDAPSchemaConnection_SavePassword, connection_LDAPSchemaConnection_Host, connection_LDAPSchemaConnection_LimitValue, connection_LDAPSchemaConnection_UseLimit, connection_LDAPSchemaConnection_StorePath, connection_LDAPSchemaConnection_Aliases, connection_LDAPSchemaConnection_SelectedDN, connection_LDAPSchemaConnection_Filter, connection_LDAPSchemaConnection_GetBaseDNsFromRoot, connection_LDAPSchemaConnection_Port, connection_LDAPSchemaConnection_Protocol, connection_LDAPSchemaConnection_Separator, connection_LDAPSchemaConnection_EncryptionMethodName, connection_LDAPSchemaConnection_TimeOutLimit, connection_LDAPSchemaConnection_Referrals, connection_LDAPSchemaConnection_ReturnAttributes, connection_LDAPSchemaConnection_BaseDNs, connection_LDAPSchemaConnection_CountLimit, connection_LDAPSchemaConnection_UseAuthen}
...
connection_FileExcelConnection.attributes={connection_FileExcelConnection_SheetName, connection_FileExcelConnection_decimalSeparator, connection_FileExcelConnection_firstColumn, connection_FileExcelConnection_sheetList, connection_FileExcelConnection_sheetColumns, connection_FileExcelConnection_thousandSeparator, connection_FileExcelConnection_selectAllSheets, connection_FileExcelConnection_lastColumn, connection_FileExcelConnection_advancedSpearator}
...
connection_WSDLSchemaConnection.attributes={connection_WSDLSchemaConnection_Password, connection_WSDLSchemaConnection_needAuth, connection_WSDLSchemaConnection_UserName, connection_WSDLSchemaConnection_parameters, connection_WSDLSchemaConnection_Encoding, connection_WSDLSchemaConnection_proxyPort, connection_WSDLSchemaConnection_useProxy, connection_WSDLSchemaConnection_proxyPassword, connection_WSDLSchemaConnection_WSDL, connection_WSDLSchemaConnection_proxyUser, connection_WSDLSchemaConnection_proxyHost, connection_WSDLSchemaConnection_methodName, connection_WSDLSchemaConnection_timeOut, connection_WSDLSchemaConnection_Value, connection_WSDLSchemaConnection_EndpointURI}
...
connection_SalesforceSchemaConnection.attributes={connection_SalesforceSchemaConnection_proxyHost, connection_SalesforceSchemaConnection_userName, connection_SalesforceSchemaConnection_useProxy, connection_SalesforceSchemaConnection_batchSize, connection_SalesforceSchemaConnection_queryCondition, connection_SalesforceSchemaConnection_proxyUsername, connection_SalesforceSchemaConnection_proxyPassword, connection_SalesforceSchemaConnection_password, connection_SalesforceSchemaConnection_useHttpProxy, connection_SalesforceSchemaConnection_proxyPort, connection_SalesforceSchemaConnection_moduleName, connection_SalesforceSchemaConnection_useCustomModuleName, connection_SalesforceSchemaConnection_webServiceUrl, connection_SalesforceSchemaConnection_timeOut, connection_SalesforceSchemaConnection_useAlphbet}
...
connection_HL7Connection_EndChar: Property = Property(name="EndChar", type=IntegerType)
...
connection_relational_TdColumn_m_getContentType: Method = Method(name="getContentType", parameters={})
connection_relational_TdColumn_m_getJavaType: Method = Method(name="getJavaType", parameters={})
connection_relational_TdColumn.methods={connection_relational_TdColumn_m_getContentType, connection_relational_TdColumn_m_getJavaType, connection_relational_TdColumn_m_setContentType}
...
connection_relational_TdSqlDataType.attributes={connection_relational_TdSqlDataType_unsignedAttribute, connection_relational_TdSqlDataType_javaDataType, connection_relational_TdSqlDataType_autoIncrement, connection_relational_TdSqlDataType_searchable, connection_relational_TdSqlDataType_caseSensitive, connection_relational_TdSqlDataType_nullable, connection_relational_TdSqlDataType_localTypeName}

# connection_xml_TdXMLDocument class attributes and methods
connection_xml_TdXMLDocument_xsdFilePath: Property = Property(name="xsdFilePath", type=StringType)
connection_xml_TdXMLDocument.attributes={connection_xml_TdXMLDocument_xsdFilePath}
...
# connection_xml_TdXMLElement class attributes and methods
connection_xml_TdXMLElement_javaType: Property = Property(name="javaType", type=StringType)
connection_xml_TdXMLElement_m_setContentType: Method = Method(name="setContentType", parameters={Parameter(name='connection_contentType', type=StringType)})
connection_xml_TdXMLElement_m_getContentType: Method = Method(name="getContentType", parameters={})
connection_xml_TdXMLElement.attributes={connection_xml_TdXMLElement_javaType}
connection_xml_TdXMLElement.methods={connection_xml_TdXMLElement_m_getContentType, connection_xml_TdXMLElement_m_setContentType}

# xml_TdXMLDocument class attributes and methods

# xml_TdXMLContent class attributes and methods

# connection_xml_TdXMLContent class attributes and methods

# xml_TdXMLElement class attributes and methods
...
MetadataTable17: BinaryAssociation = BinaryAssociation(
    name="MetadataTable17",
    ends={
        Property(name="connection_MetadataTable18", type=connection_SAPFunctionUnit, multiplicity=Multiplicity(1, 1)),
...
tables20: BinaryAssociation = BinaryAssociation(
    name="tables20",
    ends={
        Property(name="connection_MetadataTable22", type=connection_SAPFunctionUnit, multiplicity=Multiplicity(1, 1)),
        Property(name="connection_SAPFunctionUnit21", type=connection_MetadataTable, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
InputParameterTable14: BinaryAssociation = BinaryAssociation(
    name="InputParameterTable14",
    ends={
...
OutputParameterTable15: BinaryAssociation = BinaryAssociation(
    name="OutputParameterTable15",
    ends={
        Property(name="OutputSAPFunctionParameterTable", type=connection_SAPFunctionUnit, multiplicity=Multiplicity(1, 1)),
        Property(name="functionUnit16", type=connection_OutputSAPFunctionParameterTable, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
schema31: BinaryAssociation = BinaryAssociation(
    name="schema31",
    ends={
        Property(name="XmlXPathLoopDescriptor", type=connection_XmlFileConnection, multiplicity=Multiplicity(1, 1)),
        Property(name="connection32", type=connection_XmlXPathLoopDescriptor, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
TestInputParameterTable23: BinaryAssociation = BinaryAssociation(
    name="TestInputParameterTable23",
    ends={
        Property(name="SAPTestInputParameterTable", type=connection_SAPFunctionUnit, multiplicity=Multiplicity(1, 1)),
        Property(name="functionUnit24", type=connection_SAPTestInputParameterTable, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
ParameterTable25: BinaryAssociation = BinaryAssociation(
    name="ParameterTable25",
    ends={
...
columns26: BinaryAssociation = BinaryAssociation(
    name="columns26",
    ends={
...
functionUnit27: BinaryAssociation = BinaryAssociation(
    name="functionUnit27",
    ends={
        Property(name="SAPFunctionUnit28", type=connection_InputSAPFunctionParameterTable, multiplicity=Multiplicity(1, 1)),
        Property(name="InputParameterTable", type=connection_SAPFunctionUnit, multiplicity=Multiplicity(0, 1))
    }
)
functionUnit29: BinaryAssociation = BinaryAssociation(
    name="functionUnit29",
    ends={
        Property(name="SAPFunctionUnit30", type=connection_OutputSAPFunctionParameterTable, multiplicity=Multiplicity(1, 1)),
        Property(name="OutputParameterTable", type=connection_SAPFunctionUnit, multiplicity=Multiplicity(0, 1))
    }
)
schema33: BinaryAssociation = BinaryAssociation(
    name="schema33",
    ends={
        Property(name="XmlXPathLoopDescriptor34", type=connection_SchemaTarget, multiplicity=Multiplicity(1, 1)),
        Property(name="schemaTargets", type=connection_XmlXPathLoopDescriptor, multiplicity=Multiplicity(0, 1))
    }
)
connection35: BinaryAssociation = BinaryAssociation(
    name="connection35",
    ends={
...
sqlDataType55: BinaryAssociation = BinaryAssociation(
    name="sqlDataType55",
    ends={
...
ownedDocument56: BinaryAssociation = BinaryAssociation(
    name="ownedDocument56",
    ends={
        Property(name="xml_TdXMLDocument", type=connection_xml_TdXMLElement, multiplicity=Multiplicity(1, 1)),
        Property(name="connection_xml_TdXMLElement", type=xml_TdXMLDocument, multiplicity=Multiplicity(0, 1))
    }
)
xmlContent57: BinaryAssociation = BinaryAssociation(
    name="xmlContent57",
    ends={
        Property(name="xml_TdXMLContent", type=connection_xml_TdXMLElement, multiplicity=Multiplicity(1, 1)),
        Property(name="connection_xml_TdXMLElement58", type=xml_TdXMLContent, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
xmlElements59: BinaryAssociation = BinaryAssociation(
    name="xmlElements59",
    ends={
        Property(name="xml_TdXMLElement", type=connection_xml_TdXMLContent, multiplicity=Multiplicity(1, 1)),
        Property(name="connection_xml_TdXMLContent", type=xml_TdXMLElement, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
domain_model = DomainModel(
    name="connection",
    types={connection_Metadata, AbstractMetadataObject, connection_Connection, connection_QueriesConnection, connection_AbstractMetadataObject, connection_MetadataColumn, connection_MetadataTable, connection_FileConnection, Connection, connection_Concept, connection_DelimitedFileConnection, FileConnection, connection_PositionalFileConnection, connection_EbcdicConnection, connection_MDMConnection, connection_DatabaseConnection, connection_CDCConnection, connection_SAPTestInputParameterTable, connection_SAPConnection, connection_SAPFunctionUnit, connection_InputSAPFunctionParameterTable, connection_OutputSAPFunctionParameterTable, connection_XmlFileConnection, connection_XmlXPathLoopDescriptor, connection_SAPFunctionParameterColumn, connection_SchemaTarget, connection_SAPFunctionParameterTable, SAPFunctionParameterTable, connection_RegexpFileConnection, connection_Query, connection_GenericSchemaConnection, connection_LdifFileConnection, connection_LDAPSchemaConnection, connection_FileExcelConnection, connection_WSDLSchemaConnection, connection_SalesforceSchemaConnection, connection_ConceptTarget, connection_HL7Connection, connection_CDCType, connection_SubscriberTable, TdTable, connection_relational_TdTrigger, connection_GenericPackage, connection_relational_TdTable, connection_relational_TdView, connection_relational_TdColumn, MetadataColumn, relational_TdSqlDataType, connection_relational_TdSqlDataType, connection_xml_TdXMLDocument, connection_relational_TdProcedure, connection_softwaredeployment_TdDataManager, connection_softwaredeployment_TdSoftwareSystem, connection_softwaredeployment_TdMachine, connection_xml_TdXMLElement, xml_TdXMLDocument, xml_TdXMLContent, connection_xml_TdXMLContent, xml_TdXMLElement, FileFormat, FieldSeparator, Escape, RowSeparator, DevelopmentStatus},
    associations={connections0, queries1, table2, columns3, connection6, schemas9, cdcConns10, MetadataTable17, connection19, tables20, Funtions12, InputParameterTable14, OutputParameterTable15, schema31, TestInputParameterTable23, ParameterTable25, columns26, functionUnit27, functionUnit29, schema33, connection35, query36, queries38, connection40, schemaTargets41, conceptTargets52, schema54, connection43, cdcTypes44, subscribers45, cdcConnection47, functionUnit50, sqlDataType55, ownedDocument56, xmlContent57, xmlElements59},
    generalizations={gen_connection_Metadata_AbstractMetadataObject, gen_connection_FileConnection_Connection, gen_connection_MDMConnection_Connection, gen_connection_DelimitedFileConnection_FileConnection, gen_connection_PositionalFileConnection_FileConnection, gen_connection_EbcdicConnection_FileConnection, gen_connection_DatabaseConnection_Connection, gen_connection_SAPConnection_Connection, gen_connection_SAPFunctionUnit_AbstractMetadataObject, gen_connection_XmlFileConnection_Connection, gen_connection_SAPFunctionParameterColumn_AbstractMetadataObject, gen_connection_SAPFunctionParameterTable_AbstractMetadataObject, gen_connection_InputSAPFunctionParameterTable_SAPFunctionParameterTable, gen_connection_OutputSAPFunctionParameterTable_SAPFunctionParameterTable, gen_connection_RegexpFileConnection_FileConnection, gen_connection_LdifFileConnection_Connection, gen_connection_Query_AbstractMetadataObject, gen_connection_GenericSchemaConnection_Connection, gen_connection_LDAPSchemaConnection_Connection, gen_connection_FileExcelConnection_FileConnection, gen_connection_WSDLSchemaConnection_Connection, gen_connection_SalesforceSchemaConnection_Connection, gen_connection_HL7Connection_FileConnection, gen_connection_CDCType_AbstractMetadataObject, gen_connection_SubscriberTable_TdTable, gen_connection_SAPTestInputParameterTable_SAPFunctionParameterTable, gen_connection_Concept_TdTable, gen_connection_relational_TdColumn_MetadataColumn},
    metadata=None
)
