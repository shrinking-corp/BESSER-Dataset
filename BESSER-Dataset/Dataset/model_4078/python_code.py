...
class umlMM_Class(Classifier):
    ...
    def __init__(self, kind: str, Class: "umlMM_Associaton" = None, Class6: "umlMM_Associaton" = None, destination: set["umlMM_Associaton"] = None, source: set["umlMM_Associaton"] = None, Owner: set["umlMM_Attribute"] = None, Class15: "umlMM_Attribute" = None):
        self.kind = kind
        self.Class = Class
        self.Class6 = Class6
...
class umlMM_Package:
    ...
    def __init__(self, name: str, namespace: set["umlMM_Associaton"] = None, namespace2: set["umlMM_Classifier"] = None, Package: "umlMM_Associaton" = None, Package19: "umlMM_Classifier" = None):
        self.name = name
