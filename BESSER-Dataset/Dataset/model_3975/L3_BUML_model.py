...
# Classes
l3_BuildComponent = Class(name="l3_BuildComponent")
l3_Component = Class(name="l3_Component")
l3_Metamodel = Class(name="l3_Metamodel")
l3_Model = Class(name="l3_Model")
l3_SystemModel = Class(name="l3_SystemModel")
