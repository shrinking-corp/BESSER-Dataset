...
def test_hyp_model_bookshelf_is_not_abstract():
    assert not inspect.isabstract(model_BookShelf)


def test_hyp_model_bookshelf_constructor_exists():
    assert callable(model_BookShelf.__init__)


def test_hyp_model_bookshelf_constructor_args():
...
def test_hyp_model_bookshelf_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_model_book_avgRating_setter(instance):
...
@given(instance=model_Book_strategy)
def test_hyp_model_book_author_setter(instance):
...
@given(instance=model_Book_strategy)
def test_hyp_model_book_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
