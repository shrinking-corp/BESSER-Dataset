...
behaviour_Statement = Class(name="behaviour_Statement", is_abstract=True)
behaviour_DeclarationStatement = Class(name="behaviour_DeclarationStatement")
behaviour_ReturnStatement = Class(name="behaviour_ReturnStatement")
behaviour_CallFunctionStatement = Class(name="behaviour_CallFunctionStatement")
behaviour_TryCatchStatement = Class(name="behaviour_TryCatchStatement")
behaviour_ExceptionStatement = Class(name="behaviour_ExceptionStatement")
behaviour_CondionalStatement = Class(name="behaviour_CondionalStatement")
Statement = Class(name="Statement")
behaviour_Expression = Class(name="behaviour_Expression", is_abstract=True)
behaviour_LoopStatement = Class(name="behaviour_LoopStatement")
behaviour_AssignmentStatement = Class(name="behaviour_AssignmentStatement")
behaviour_ArithmeticOperation = Class(name="behaviour_ArithmeticOperation", is_abstract=True)
BinaryExpression = Class(name="BinaryExpression")
behaviour_ComparisonOperator = Class(name="behaviour_ComparisonOperator", is_abstract=True)
behaviour_Plus = Class(name="behaviour_Plus")
ArithmeticOperation = Class(name="ArithmeticOperation")
behaviour_Equals = Class(name="behaviour_Equals")
ComparisonOperator = Class(name="ComparisonOperator")
behaviour_Literal = Class(name="behaviour_Literal")
Expression = Class(name="Expression")
behaviour_Variable = Class(name="behaviour_Variable")
behaviour_FunctionCall = Class(name="behaviour_FunctionCall")
behaviour_ReadLine = Class(name="behaviour_ReadLine")
behaviour_BinaryExpression = Class(name="behaviour_BinaryExpression", is_abstract=True)
...
behaviour_DeclarationStatement.attributes={behaviour_DeclarationStatement_varName, behaviour_DeclarationStatement_varType}
...
domain_model = DomainModel(
    name="behaviour",
    types={behaviour_Behaviour, behaviour_Function, behaviour_Statement, behaviour_DeclarationStatement, behaviour_ReturnStatement, behaviour_CallFunctionStatement, behaviour_TryCatchStatement, behaviour_ExceptionStatement, behaviour_CondionalStatement, Statement, behaviour_Expression, behaviour_LoopStatement, behaviour_AssignmentStatement, behaviour_ArithmeticOperation, BinaryExpression, behaviour_ComparisonOperator, behaviour_Plus, ArithmeticOperation, behaviour_Equals, ComparisonOperator, behaviour_Literal, Expression, behaviour_Variable, behaviour_FunctionCall, behaviour_ReadLine, behaviour_BinaryExpression},
    associations={functions0, entryFunction1, functionBody4, assignExpression18, initialExpression20, returnExpression22, arguments24, tryStatements26, catchStatements28, throwsExpression31, ifStatements6, elseStatements8, ifExpression11, loopExpression13, loopBodyStatements15, rightSideExpression37, arguments33, leftSideExpression35},
    generalizations={gen_behaviour_DeclarationStatement_Statement, gen_behaviour_ReturnStatement_Statement, gen_behaviour_CallFunctionStatement_Statement, gen_behaviour_TryCatchStatement_Statement, gen_behaviour_ExceptionStatement_Statement, gen_behaviour_CondionalStatement_Statement, gen_behaviour_LoopStatement_Statement, gen_behaviour_AssignmentStatement_Statement, gen_behaviour_ArithmeticOperation_BinaryExpression, gen_behaviour_ComparisonOperator_BinaryExpression, gen_behaviour_Plus_ArithmeticOperation, gen_behaviour_Equals_ComparisonOperator, gen_behaviour_Literal_Expression, gen_behaviour_Variable_Expression, gen_behaviour_FunctionCall_Expression, gen_behaviour_ReadLine_Expression, gen_behaviour_BinaryExpression_Expression},
    metadata=None
)
