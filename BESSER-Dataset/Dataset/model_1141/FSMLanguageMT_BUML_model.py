...
gemoc_FSM.methods={gemoc_FSM_m_setCurrentState, gemoc_FSM_m_initialize, gemoc_FSM_m_main, gemoc_FSM_m_print}
...
domain_model = DomainModel(
    ...
    associations={incoming3, outcoming4, fSM6, state9, src10, state0, transition1},
    generalizations={},
    metadata=None
)
