...
class gemoc_Transition:
    ...
    def __init__(self, name: str, trigger: str, Transition: "gemoc_State" = None, Transition5: "gemoc_State" = None, incoming: "gemoc_State" = None, outcoming: "gemoc_State" = None, gemoc_Transition: "gemoc_FSM" = None):
        self.name = name
...
class gemoc_State:
    ...
    def __init__(self, name: str, state: "gemoc_Transition" = None, src: "gemoc_Transition" = None, gemoc_State7: "gemoc_FSM" = None, State: "gemoc_Transition" = None, State11: "gemoc_Transition" = None, gemoc_State: "gemoc_FSM" = None):
        self.name = name
        self.state = state
        self.src = src
...
class gemoc_FSM:
    ...
    def __init__(self, name: bool, gemoc_FSM8: "gemoc_State" = None, gemoc_FSM: set["gemoc_State"] = None, gemoc_FSM2: set["gemoc_Transition"] = None):
        self.name = name
