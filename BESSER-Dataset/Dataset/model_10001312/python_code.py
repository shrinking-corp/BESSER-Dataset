...
class LineItem:
    ...
    def __init__(self, quantity: int, price: float, product13: "Product" = None, order15: "Order" = None, sc11: "ShoppingCart" = None):
...
class Account:
    ...
    def __init__(self, billingAddress: str, open: date, closed: date, isClosed: bool, p0: set["Payment"] = None, order16: set["Order"] = None, customer7: "Customer" = None, cart8: "ShoppingCart" = None):
