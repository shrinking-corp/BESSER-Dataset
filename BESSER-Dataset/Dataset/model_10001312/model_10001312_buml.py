...
Order.attributes={Order_shipped, Order_ordered, Order_number, Order_shipTo, Order_total, Order_status}
...
domain_model = DomainModel(
    name="__W9zgEwQEeqonN_RS9oRzw",
    types={Customer, Payment, ShoppingCart, Account, WebUser, Order, LineItem, Product, UserState, OrderStatus},
    associations={Account_Payment, Product_LineItem, Order_LineItem, Account_Order, Payment_Order, WebUser_ShoppingCart, WebUser_Customer, Customer_Account, Account_ShoppingCart, ShoppingCart_LineItem},
    generalizations={},
    metadata=None
)
