...
def test_hyp_art_distrib_node_is_not_abstract():
    assert not inspect.isabstract(art_distrib_Node)


def test_hyp_art_distrib_node_constructor_exists():
    assert callable(art_distrib_Node.__init__)


def test_hyp_art_distrib_node_constructor_args():
...
def test_hyp_art_distrib_node_uri_setter(instance):
...
def test_hyp_art_type_abstractport_uri_setter(instance):
    original = instance.uri
    instance.uri = original
    assert instance.uri == original
...
@given(instance=art_type_AbstractPort_strategy)
def test_hyp_art_type_abstractport_protocol_setter(instance):
