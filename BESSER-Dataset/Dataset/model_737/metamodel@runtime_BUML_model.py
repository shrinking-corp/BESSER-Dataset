...
# Classes
art_NamedElement = Class(name="art_NamedElement", is_abstract=True)
ComponentType = Class(name="ComponentType")
art_DataType = Class(name="art_DataType")
Group = Class(name="Group")
art_TypedElement = Class(name="art_TypedElement", is_abstract=True)
art_CardinalityElement = Class(name="art_CardinalityElement", is_abstract=True)
art_instance_ComponentInstance = Class(name="art_instance_ComponentInstance", is_abstract=True)
...
art_ModelElement = Class(name="art_ModelElement", is_abstract=True)
NamedElement = Class(name="NamedElement")
InstanceGroup = Class(name="InstanceGroup")
art_System = Class(name="art_System")
ModelElement = Class(name="ModelElement")
Node = Class(name="Node")
Service = Class(name="Service")
DelegationBinding = Class(name="DelegationBinding")
art_instance_Binding = Class(name="art_instance_Binding", is_abstract=True)
art_instance_TransmissionBinding = Class(name="art_instance_TransmissionBinding")
Binding = Class(name="Binding")
AbstractPort = Class(name="AbstractPort")
art_instance_DelegationBinding = Class(name="art_instance_DelegationBinding")
art_instance_AttributeInstance = Class(name="art_instance_AttributeInstance", is_abstract=True)
art_instance_ValuedAttribute = Class(name="art_instance_ValuedAttribute")
BasicAttribute = Class(name="BasicAttribute")
art_instance_DictionaryValuedAttribute = Class(name="art_instance_DictionaryValuedAttribute")
Entry = Class(name="Entry")
Dictionary = Class(name="Dictionary")
art_instance_Entry = Class(name="art_instance_Entry", is_abstract=True)
art_instance_DefaultEntry = Class(name="art_instance_DefaultEntry")
DictionaryDefaultValue = Class(name="DictionaryDefaultValue")
art_instance_OtherEntry = Class(name="art_instance_OtherEntry")
art_type_ComponentType = Class(name="art_type_ComponentType", is_abstract=True)
Attribute = Class(name="Attribute")
art_instance_PrimitiveInstance = Class(name="art_instance_PrimitiveInstance")
ComponentInstance = Class(name="ComponentInstance")
art_instance_CompositeInstance = Class(name="art_instance_CompositeInstance")
art_type_PrimitiveType = Class(name="art_type_PrimitiveType")
art_type_CompositeType = Class(name="art_type_CompositeType")
art_type_Service = Class(name="art_type_Service", is_abstract=True)
Operation = Class(name="Operation")
art_type_Operation = Class(name="art_type_Operation")
Parameter_ = Class(name="Parameter")
art_type_Parameter = Class(name="art_type_Parameter")
TypedElement = Class(name="TypedElement")
art_type_FunctionalService = Class(name="art_type_FunctionalService")
art_type_ControlService = Class(name="art_type_ControlService")
art_type_AbstractPort = Class(name="art_type_AbstractPort", is_abstract=True)
art_type_Port = Class(name="art_type_Port")
CardinalityElement = Class(name="CardinalityElement")
type_AbstractPort = Class(name="type_AbstractPort")
art_type_PortCollection = Class(name="art_type_PortCollection")
PortId = Class(name="PortId")
art_type_PortId = Class(name="art_type_PortId")
art_type_Attribute = Class(name="art_type_Attribute", is_abstract=True)
art_type_BasicAttribute = Class(name="art_type_BasicAttribute")
art_type_Dictionary = Class(name="art_type_Dictionary")
type_art_DataType = Class(name="type_art_DataType")
art_type_DictionaryDefaultValue = Class(name="art_type_DictionaryDefaultValue")
art_implem_ComponentImplementation = Class(name="art_implem_ComponentImplementation", is_abstract=True)
art_implem_FractalComponent = Class(name="art_implem_FractalComponent")
art_implem_OSGiComponent = Class(name="art_implem_OSGiComponent")
TypeGroup = Class(name="TypeGroup")
TypeImplementation = Class(name="TypeImplementation")
art_group_Group = Class(name="art_group_Group", is_abstract=True)
art_group_TypeGroup = Class(name="art_group_TypeGroup")
art_group_InstanceGroup = Class(name="art_group_InstanceGroup")
art_distrib_Node = Class(name="art_distrib_Node")
art_implem_TypeImplementation = Class(name="art_implem_TypeImplementation", is_abstract=True)
art_implem_OSGiType = Class(name="art_implem_OSGiType")
...
art_type_AbstractPort.attributes={art_type_AbstractPort_uri, art_type_AbstractPort_role, art_type_AbstractPort_protocol}
...
superComponent13: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="CompositeInstance", type=art_instance_ComponentInstance, multiplicity=Multiplicity(1, 1)),
...
groups20: BinaryAssociation = BinaryAssociation(
    name="groups20",
    ends={
        Property(name="InstanceGroup", type=art_instance_ComponentInstance, multiplicity=Multiplicity(1, 1)),
...
serverInstance23: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="ComponentInstance24", type=art_instance_Binding, multiplicity=Multiplicity(1, 1)),
...
server26: BinaryAssociation = BinaryAssociation(
    name="server26",
    ends={
        Property(name="AbstractPort28", type=art_instance_TransmissionBinding, multiplicity=Multiplicity(1, 1)),
        Property(name="art_instance_TransmissionBinding27", type=AbstractPort, multiplicity=Multiplicity(1, 1))
    }
)
source29: BinaryAssociation = BinaryAssociation(
    name="source29",
    ends={
        Property(name="AbstractPort30", type=art_instance_DelegationBinding, multiplicity=Multiplicity(1, 1)),
...
exported31: BinaryAssociation = BinaryAssociation(
    name="exported31",
    ends={
        Property(name="AbstractPort33", type=art_instance_DelegationBinding, multiplicity=Multiplicity(1, 1)),
        Property(name="art_instance_DelegationBinding32", type=AbstractPort, multiplicity=Multiplicity(1, 1))
    }
)
...
attribute36: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="art_instance_DictionaryValuedAttribute37", type=Dictionary, multiplicity=Multiplicity(1, 1))
    }
)
...
port39: BinaryAssociation = BinaryAssociation(
    name="port39",
    ends={
        Property(name="AbstractPort40", type=art_type_ComponentType, multiplicity=Multiplicity(1, 1)),
...
attribute41: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="art_type_ComponentType42", type=Attribute, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
subComponent21: BinaryAssociation = BinaryAssociation(
    name="subComponent21",
    ends={
        Property(name="ComponentInstance", type=art_instance_CompositeInstance, multiplicity=Multiplicity(1, 1)),
...
output48: BinaryAssociation = BinaryAssociation(
    name="output48",
    ends={
        Property(name="Parameter50", type=art_type_Operation, multiplicity=Multiplicity(1, 1)),
        Property(name="art_type_Operation49", type=Parameter_, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
service51: BinaryAssociation = BinaryAssociation(
    name="service51",
    ends={
        Property(name="Service52", type=art_type_AbstractPort, multiplicity=Multiplicity(1, 1)),
...
keys55: BinaryAssociation = BinaryAssociation(
    name="keys55",
    ends={
        Property(name="DictionaryDefaultValue57", type=art_type_Dictionary, multiplicity=Multiplicity(1, 1)),
        Property(name="art_type_Dictionary56", type=DictionaryDefaultValue, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
groups43: BinaryAssociation = BinaryAssociation(
    name="groups43",
    ends={
        Property(name="TypeGroup", type=art_type_ComponentType, multiplicity=Multiplicity(1, 1)),
...
implem44: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="art_type_ComponentType45", type=TypeImplementation, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
types58: BinaryAssociation = BinaryAssociation(
    name="types58",
    ends={
        Property(name="ComponentType59", type=art_group_TypeGroup, multiplicity=Multiplicity(1, 1)),
...
subGroups60: BinaryAssociation = BinaryAssociation(
    name="subGroups60",
    ends={
        Property(name="TypeGroup61", type=art_group_TypeGroup, multiplicity=Multiplicity(1, 1)),
...
instances62: BinaryAssociation = BinaryAssociation(
    name="instances62",
    ends={
        Property(name="ComponentInstance64", type=art_group_InstanceGroup, multiplicity=Multiplicity(1, 1)),
...
subGroups65: BinaryAssociation = BinaryAssociation(
    name="subGroups65",
    ends={
        Property(name="InstanceGroup66", type=art_group_InstanceGroup, multiplicity=Multiplicity(1, 1)),
...
components67: BinaryAssociation = BinaryAssociation(
    name="components67",
    ends={
        Property(name="ComponentInstance68", type=art_distrib_Node, multiplicity=Multiplicity(1, 1)),
...
domain_model = DomainModel(
    name="art",
    types={art_NamedElement, ComponentType, art_DataType, Group, art_TypedElement, art_CardinalityElement, art_instance_ComponentInstance, CompositeInstance, AttributeInstance, TransmissionBinding, ComponentImplementation, art_ModelElement, NamedElement, InstanceGroup, art_System, ModelElement, Node, Service, DelegationBinding, art_instance_Binding, art_instance_TransmissionBinding, Binding, AbstractPort, art_instance_DelegationBinding, art_instance_AttributeInstance, art_instance_ValuedAttribute, BasicAttribute, art_instance_DictionaryValuedAttribute, Entry, Dictionary, art_instance_Entry, art_instance_DefaultEntry, DictionaryDefaultValue, art_instance_OtherEntry, art_type_ComponentType, Attribute, art_instance_PrimitiveInstance, ComponentInstance, art_instance_CompositeInstance, art_type_PrimitiveType, art_type_CompositeType, art_type_Service, Operation, art_type_Operation, Parameter_, art_type_Parameter, TypedElement, art_type_FunctionalService, art_type_ControlService, art_type_AbstractPort, art_type_Port, CardinalityElement, type_AbstractPort, art_type_PortCollection, PortId, art_type_PortId, art_type_Attribute, art_type_BasicAttribute, art_type_Dictionary, type_art_DataType, art_type_DictionaryDefaultValue, art_implem_ComponentImplementation, art_implem_FractalComponent, art_implem_OSGiComponent, TypeGroup, TypeImplementation, art_group_Group, art_group_TypeGroup, art_group_InstanceGroup, art_distrib_Node, art_implem_TypeImplementation, art_implem_OSGiType, InstanceState, PortRole},
    associations={services1, types3, dataTypes5, groups7, type9, type11, superComponent13, attribute14, binding16, implem18, groups20, nodes0, delegation22, serverInstance23, client25, server26, source29, exported31, attribute34, entries35, attribute36, key38, port39, attribute41, subComponent21, operation46, input47, output48, service51, ids53, valueType54, keys55, groups43, implem44, types58, subGroups60, instances62, subGroups65, components67},
    generalizations={gen_art_DataType_ModelElement, gen_art_TypedElement_ModelElement, gen_art_CardinalityElement_ModelElement, gen_art_instance_ComponentInstance_ModelElement, gen_art_ModelElement_NamedElement, gen_art_System_ModelElement, gen_art_instance_TransmissionBinding_Binding, gen_art_instance_DelegationBinding_Binding, gen_art_instance_ValuedAttribute_AttributeInstance, gen_art_instance_DictionaryValuedAttribute_AttributeInstance, gen_art_instance_DefaultEntry_Entry, gen_art_instance_OtherEntry_Entry, gen_art_type_ComponentType_ModelElement, gen_art_instance_PrimitiveInstance_ComponentInstance, gen_art_instance_CompositeInstance_ComponentInstance, gen_art_type_PrimitiveType_ComponentType, gen_art_type_CompositeType_ComponentType, gen_art_type_Service_ModelElement, gen_art_type_Operation_ModelElement, gen_art_type_Parameter_TypedElement, gen_art_type_FunctionalService_Service, gen_art_type_ControlService_Service, gen_art_type_AbstractPort_NamedElement, gen_art_type_Port_CardinalityElement, gen_art_type_Port_type_AbstractPort, gen_art_type_PortCollection_AbstractPort, gen_art_type_PortId_NamedElement, gen_art_type_Attribute_TypedElement, gen_art_type_BasicAttribute_Attribute, gen_art_type_Dictionary_Attribute, gen_art_implem_FractalComponent_ComponentImplementation, gen_art_implem_OSGiComponent_ComponentImplementation, gen_art_group_Group_NamedElement, gen_art_group_TypeGroup_Group, gen_art_group_InstanceGroup_Group, gen_art_distrib_Node_NamedElement, gen_art_implem_OSGiType_TypeImplementation},
    metadata=None
)
