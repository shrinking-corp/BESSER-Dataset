...
def test_art_distrib_node_is_not_abstract():
    assert not inspect.isabstract(art_distrib_Node)


def test_art_distrib_node_constructor_exists():
    assert callable(art_distrib_Node.__init__)


def test_art_distrib_node_constructor_args():
    sig = inspect.signature(art_distrib_Node.__init__)
    params = list(sig.parameters.keys())
    assert "uri" in params, "Missing parameter 'uri'"

def test_art_distrib_node_has_uri():
    assert hasattr(art_distrib_Node, "uri")
    descriptor = None
    for klass in art_distrib_Node.__mro__:
...
def test_art_type_abstractport_has_uri():
    assert hasattr(art_type_AbstractPort, "uri")
    descriptor = None
...
def test_art_type_abstractport_has_protocol():
    assert hasattr(art_type_AbstractPort, "protocol")
    descriptor = None
    for klass in art_type_AbstractPort.__mro__:
...
art_distrib_Node_strategy = st.builds(
    art_distrib_Node,
    uri=
        safe_text
)
...
@given(instance=art_distrib_Node_strategy)
def test_art_distrib_node_uri_setter(instance):
...
@given(instance=art_type_AbstractPort_strategy)
def test_art_type_abstractport_uri_setter(instance):
    original = instance.uri
    instance.uri = original
    assert instance.uri == original
...
@given(instance=art_type_AbstractPort_strategy)
def test_art_type_abstractport_protocol_setter(instance):
