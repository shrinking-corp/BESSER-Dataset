...
class simpleUML_UMLClass:
    ...
    def __init__(self, umlName: str, simpleUML_UMLClass10: "simpleUML_Generalization" = None, simpleUML_UMLClass: "simpleUML_Model" = None, simpleUML_UMLClass3: "simpleUML_UMLClass" = None, simpleUML_UMLClass1: set["simpleUML_UMLClass"] = None, simpleUML_UMLClass5: set["simpleUML_Generalization"] = None, simpleUML_UMLClass7: set["simpleUML_UMLAttribute"] = None):
        self.umlName = umlName
