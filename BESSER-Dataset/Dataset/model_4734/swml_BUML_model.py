...
# Classes
swml_WebModel = Class(name="swml_WebModel")
...
swml_Entity = Class(name="swml_Entity")
swml_EnumTyp = Class(name="swml_EnumTyp")
swml_Attribute = Class(name="swml_Attribute")
swml_Reference = Class(name="swml_Reference")
swml_WebPage = Class(name="swml_WebPage", is_abstract=True)
swml_staticPage = Class(name="swml_staticPage")
swml_Literals = Class(name="swml_Literals")
swml_IndexPages = Class(name="swml_IndexPages")
swml_UpdatePage = Class(name="swml_UpdatePage")
EntityPages = Class(name="EntityPages")
swml_OK = Class(name="swml_OK")
swml_KO = Class(name="swml_KO")
swml_DeletePage = Class(name="swml_DeletePage")
swml_CreatePage = Class(name="swml_CreatePage")
swml_LinkKat2 = Class(name="swml_LinkKat2", is_abstract=True)
swml_LinkJoinNode = Class(name="swml_LinkJoinNode")
WebPage = Class(name="WebPage")
swml_LinkKat1 = Class(name="swml_LinkKat1", is_abstract=True)
swml_dynamicPage = Class(name="swml_dynamicPage", is_abstract=True)
swml_EntityPages = Class(name="swml_EntityPages")
dynamicPage = Class(name="dynamicPage")
swml_Links = Class(name="swml_Links", is_abstract=True)
swml_LinkParamater = Class(name="swml_LinkParamater")
swml_NonContextualLinks = Class(name="swml_NonContextualLinks")
LinkKat2 = Class(name="LinkKat2")
swml_ContextualLinks = Class(name="swml_ContextualLinks")
...
swml_Reference.attributes={swml_Reference_upperBound, swml_Reference_lowerBound, swml_Reference_rolename}
...
domain_model = DomainModel(
    name="swml",
    types={swml_WebModel, swml_HypertextModel, swml_ContentModel, swml_Enumeration, swml_Entity, swml_EnumTyp, swml_Attribute, swml_Reference, swml_WebPage, swml_staticPage, swml_Literals, swml_IndexPages, swml_UpdatePage, EntityPages, swml_OK, swml_KO, swml_DeletePage, swml_CreatePage, swml_LinkKat2, swml_LinkJoinNode, WebPage, swml_LinkKat1, swml_dynamicPage, swml_EntityPages, dynamicPage, swml_Links, swml_LinkParamater, swml_NonContextualLinks, LinkKat2, swml_ContextualLinks, LinkKat1, Links, Datentyp},
    associations={Child14, Enums16, Opposite20, RefTo22, hypertextmodels0, contentmodels1, Enumerations3, Entities5, EnumAttribute7, Attributes9, References11, WebPages27, homepage29, ownedLiteral25, InnerPage36, OKLink38, KOLink39, OKLink41, KOLink43, OKLink46, KOLink48, Link31, Links33, EntityType34, Link51, TargetPage52},
    generalizations={gen_swml_IndexPages_dynamicPage, gen_swml_UpdatePage_EntityPages, gen_swml_DeletePage_EntityPages, gen_swml_CreatePage_EntityPages, gen_swml_LinkJoinNode_WebPage, gen_swml_staticPage_WebPage, gen_swml_dynamicPage_WebPage, gen_swml_EntityPages_dynamicPage, gen_swml_NonContextualLinks_LinkKat2, gen_swml_ContextualLinks_LinkKat2, gen_swml_OK_LinkKat1, gen_swml_KO_LinkKat1, gen_swml_LinkKat1_Links, gen_swml_LinkKat2_Links},
    metadata=None
)
