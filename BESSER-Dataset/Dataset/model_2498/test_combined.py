...
def test_hyp_y2fsm_foo_is_not_abstract():
    assert not inspect.isabstract(y2fsm_Foo)


def test_hyp_y2fsm_foo_constructor_exists():
    assert callable(y2fsm_Foo.__init__)


def test_hyp_y2fsm_foo_constructor_args():
...
def test_hyp_y2fsm_abstractstate_is_not_abstract():
    assert not inspect.isabstract(y2fsm_AbstractState)


def test_hyp_y2fsm_abstractstate_constructor_exists():
    assert callable(y2fsm_AbstractState.__init__)


def test_hyp_y2fsm_abstractstate_constructor_args():
...
def test_hyp_y2fsm_region_is_not_abstract():
    assert not inspect.isabstract(y2fsm_Region)


def test_hyp_y2fsm_region_constructor_exists():
    assert callable(y2fsm_Region.__init__)


def test_hyp_y2fsm_region_constructor_args():
...
def test_hyp_y2fsm_foo_id_setter(instance):
...
def test_hyp_y2fsm_abstractstate_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
def test_hyp_y2fsm_region_name_setter(instance):
