...
# Classes
y2fsm_Region = Class(name="y2fsm_Region")
AbstractState = Class(name="AbstractState")
y2fsm_AbstractState = Class(name="y2fsm_AbstractState", is_abstract=True)
y2fsm_Foo = Class(name="y2fsm_Foo")
...
domain_model = DomainModel(
    name="y2fsm",
    types={y2fsm_Region, AbstractState, y2fsm_AbstractState, y2fsm_Foo},
