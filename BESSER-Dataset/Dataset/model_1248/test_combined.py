...
def test_hyp_mtl_documentedelement_is_not_abstract():
    assert not inspect.isabstract(mtl_DocumentedElement)


def test_hyp_mtl_documentedelement_constructor_exists():
    assert callable(mtl_DocumentedElement.__init__)


def test_hyp_mtl_documentedelement_constructor_args():
...
def test_hyp_mtl_documentation_is_not_abstract():
    assert not inspect.isabstract(mtl_Documentation)


def test_hyp_mtl_documentation_constructor_exists():
    assert callable(mtl_Documentation.__init__)


def test_hyp_mtl_documentation_constructor_args():
    sig = inspect.signature(mtl_Documentation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mtl_commentbody_is_not_abstract():
    assert not inspect.isabstract(mtl_CommentBody)


def test_hyp_mtl_commentbody_constructor_exists():
    assert callable(mtl_CommentBody.__init__)


def test_hyp_mtl_commentbody_constructor_args():
...
def test_hyp_mtl_epackage_is_not_abstract():
    assert not inspect.isabstract(mtl_EPackage)


def test_hyp_mtl_epackage_constructor_exists():
    assert callable(mtl_EPackage.__init__)


def test_hyp_mtl_epackage_constructor_args():
    sig = inspect.signature(mtl_EPackage.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mtl_parameterdocumentation_is_not_abstract():
    assert not inspect.isabstract(mtl_ParameterDocumentation)


def test_hyp_mtl_parameterdocumentation_constructor_exists():
    assert callable(mtl_ParameterDocumentation.__init__)


def test_hyp_mtl_parameterdocumentation_constructor_args():
...
def test_hyp_mtl_moduleelementdocumentation_is_not_abstract():
    assert not inspect.isabstract(mtl_ModuleElementDocumentation)


def test_hyp_mtl_moduleelementdocumentation_constructor_exists():
    assert callable(mtl_ModuleElementDocumentation.__init__)


def test_hyp_mtl_moduleelementdocumentation_constructor_args():
    sig = inspect.signature(mtl_ModuleElementDocumentation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mtl_moduledocumentation_is_not_abstract():
    assert not inspect.isabstract(mtl_ModuleDocumentation)


def test_hyp_mtl_moduledocumentation_constructor_exists():
    assert callable(mtl_ModuleDocumentation.__init__)


def test_hyp_mtl_moduledocumentation_constructor_args():
...
def test_hyp_mtl_eclassifier_is_not_abstract():
    assert not inspect.isabstract(mtl_EClassifier)


def test_hyp_mtl_eclassifier_constructor_exists():
    assert callable(mtl_EClassifier.__init__)


def test_hyp_mtl_eclassifier_constructor_args():
...
def test_hyp_mtl_initsection_is_not_abstract():
    assert not inspect.isabstract(mtl_InitSection)


def test_hyp_mtl_initsection_constructor_exists():
    assert callable(mtl_InitSection.__init__)


def test_hyp_mtl_initsection_constructor_args():
...
def test_hyp_mtl_queryinvocation_is_not_abstract():
    assert not inspect.isabstract(mtl_QueryInvocation)


def test_hyp_mtl_queryinvocation_constructor_exists():
    assert callable(mtl_QueryInvocation.__init__)


def test_hyp_mtl_queryinvocation_constructor_args():
    sig = inspect.signature(mtl_QueryInvocation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mtl_macroinvocation_is_not_abstract():
    assert not inspect.isabstract(mtl_MacroInvocation)


def test_hyp_mtl_macroinvocation_constructor_exists():
    assert callable(mtl_MacroInvocation.__init__)


def test_hyp_mtl_macroinvocation_constructor_args():
    sig = inspect.signature(mtl_MacroInvocation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mtl_block_is_not_abstract():
    assert not inspect.isabstract(mtl_Block)


def test_hyp_mtl_block_constructor_exists():
    assert callable(mtl_Block.__init__)


def test_hyp_mtl_block_constructor_args():
...
def test_hyp_mtl_templateexpression_is_not_abstract():
    assert not inspect.isabstract(mtl_TemplateExpression)


def test_hyp_mtl_templateexpression_constructor_exists():
    assert callable(mtl_TemplateExpression.__init__)


def test_hyp_mtl_templateexpression_constructor_args():
...
def test_hyp_mtl_templateinvocation_is_not_abstract():
    assert not inspect.isabstract(mtl_TemplateInvocation)


def test_hyp_mtl_templateinvocation_constructor_exists():
    assert callable(mtl_TemplateInvocation.__init__)


def test_hyp_mtl_templateinvocation_constructor_args():
...
def test_hyp_mtl_comment_is_not_abstract():
    assert not inspect.isabstract(mtl_Comment)


def test_hyp_mtl_comment_constructor_exists():
    assert callable(mtl_Comment.__init__)


def test_hyp_mtl_comment_constructor_args():
...
def test_hyp_mtl_forblock_is_not_abstract():
    assert not inspect.isabstract(mtl_ForBlock)


def test_hyp_mtl_forblock_constructor_exists():
    assert callable(mtl_ForBlock.__init__)


def test_hyp_mtl_forblock_constructor_args():
    sig = inspect.signature(mtl_ForBlock.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mtl_fileblock_is_not_abstract():
    assert not inspect.isabstract(mtl_FileBlock)


def test_hyp_mtl_fileblock_constructor_exists():
    assert callable(mtl_FileBlock.__init__)


def test_hyp_mtl_fileblock_constructor_args():
...
def test_hyp_mtl_letblock_is_not_abstract():
    assert not inspect.isabstract(mtl_LetBlock)


def test_hyp_mtl_letblock_constructor_exists():
    assert callable(mtl_LetBlock.__init__)


def test_hyp_mtl_letblock_constructor_args():
    sig = inspect.signature(mtl_LetBlock.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mtl_protectedareablock_is_not_abstract():
    assert not inspect.isabstract(mtl_ProtectedAreaBlock)


def test_hyp_mtl_protectedareablock_constructor_exists():
    assert callable(mtl_ProtectedAreaBlock.__init__)


def test_hyp_mtl_protectedareablock_constructor_args():
    sig = inspect.signature(mtl_ProtectedAreaBlock.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mtl_ifblock_is_not_abstract():
    assert not inspect.isabstract(mtl_IfBlock)


def test_hyp_mtl_ifblock_constructor_exists():
    assert callable(mtl_IfBlock.__init__)


def test_hyp_mtl_ifblock_constructor_args():
    sig = inspect.signature(mtl_IfBlock.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mtl_traceblock_is_not_abstract():
    assert not inspect.isabstract(mtl_TraceBlock)


def test_hyp_mtl_traceblock_constructor_exists():
    assert callable(mtl_TraceBlock.__init__)


def test_hyp_mtl_traceblock_constructor_args():
    sig = inspect.signature(mtl_TraceBlock.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mtl_moduleelement_is_not_abstract():
    assert not inspect.isabstract(mtl_ModuleElement)


def test_hyp_mtl_moduleelement_constructor_exists():
    assert callable(mtl_ModuleElement.__init__)


def test_hyp_mtl_moduleelement_constructor_args():
...
def test_hyp_mtl_typedmodel_is_not_abstract():
    assert not inspect.isabstract(mtl_TypedModel)


def test_hyp_mtl_typedmodel_constructor_exists():
    assert callable(mtl_TypedModel.__init__)


def test_hyp_mtl_typedmodel_constructor_args():
...
def test_hyp_mtl_template_is_not_abstract():
    assert not inspect.isabstract(mtl_Template)


def test_hyp_mtl_template_constructor_exists():
    assert callable(mtl_Template.__init__)


def test_hyp_mtl_template_constructor_args():
...
def test_hyp_mtl_query_is_not_abstract():
    assert not inspect.isabstract(mtl_Query)


def test_hyp_mtl_query_constructor_exists():
    assert callable(mtl_Query.__init__)


def test_hyp_mtl_query_constructor_args():
    sig = inspect.signature(mtl_Query.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mtl_macro_is_not_abstract():
    assert not inspect.isabstract(mtl_Macro)


def test_hyp_mtl_macro_constructor_exists():
    assert callable(mtl_Macro.__init__)


def test_hyp_mtl_macro_constructor_args():
...
def test_hyp_mtl_module_is_not_abstract():
    assert not inspect.isabstract(mtl_Module)


def test_hyp_mtl_module_constructor_exists():
    assert callable(mtl_Module.__init__)


def test_hyp_mtl_module_constructor_args():
...
def test_hyp_mtl_documentedelement_deprecated_setter(instance):
...
def test_hyp_mtl_commentbody_endPosition_setter(instance):
...
@given(instance=mtl_CommentBody_strategy)
def test_hyp_mtl_commentbody_value_setter(instance):
...
@given(instance=mtl_CommentBody_strategy)
def test_hyp_mtl_commentbody_startPosition_setter(instance):
...
def test_hyp_mtl_moduledocumentation_version_setter(instance):
...
@given(instance=mtl_ModuleDocumentation_strategy)
def test_hyp_mtl_moduledocumentation_author_setter(instance):
...
@given(instance=mtl_ModuleDocumentation_strategy)
def test_hyp_mtl_moduledocumentation_since_setter(instance):
...
def test_hyp_mtl_templateinvocation_super_setter(instance):
...
def test_hyp_mtl_fileblock_openMode_setter(instance):
...
def test_hyp_mtl_moduleelement_visibility_setter(instance):
...
def test_hyp_mtl_template_main_setter(instance):
...
def test_hyp_mtl_module_startHeaderPosition_setter(instance):
...
@given(instance=mtl_Module_strategy)
def test_hyp_mtl_module_endHeaderPosition_setter(instance):
