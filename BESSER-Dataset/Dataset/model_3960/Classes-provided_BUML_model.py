...
# Classes
ClassesProv_Element = Class(name="ClassesProv_Element", is_abstract=True)
ClassesProv_Type = Class(name="ClassesProv_Type", is_abstract=True)
ClassesProv_PackageMerge = Class(name="ClassesProv_PackageMerge")
ClassesProv_NamedElement = Class(name="ClassesProv_NamedElement", is_abstract=True)
Element = Class(name="Element")
ClassesProv_Namespace = Class(name="ClassesProv_Namespace")
ClassesProv_Dependency = Class(name="ClassesProv_Dependency")
NamedElement = Class(name="NamedElement")
ClassesProv_PackageableElement = Class(name="ClassesProv_PackageableElement")
ClassesProv_ElementImport = Class(name="ClassesProv_ElementImport")
ClassesProv_PackageImport = Class(name="ClassesProv_PackageImport")
ClassesProv_Constraint = Class(name="ClassesProv_Constraint")
DirectedRelationship = Class(name="DirectedRelationship")
ClassesProv_Package = Class(name="ClassesProv_Package")
Namespace = Class(name="Namespace")
PackageableElement = Class(name="PackageableElement")
ClassesProv_Expression = Class(name="ClassesProv_Expression")
ValueSpecification = Class(name="ValueSpecification")
ClassesProv_OpaqueExpression = Class(name="ClassesProv_OpaqueExpression")
ClassesProv_Relationship = Class(name="ClassesProv_Relationship", is_abstract=True)
ClassesProv_DirectedRelationship = Class(name="ClassesProv_DirectedRelationship", is_abstract=True)
Relationship = Class(name="Relationship")
ClassesProv_MultiplicityElement = Class(name="ClassesProv_MultiplicityElement", is_abstract=True)
ClassesProv_ValueSpecification = Class(name="ClassesProv_ValueSpecification", is_abstract=True)
TypedElement = Class(name="TypedElement")
ClassesProv_Slot = Class(name="ClassesProv_Slot")
ClassesProv_InstanceSpecification = Class(name="ClassesProv_InstanceSpecification")
ClassesProv_TypedElement = Class(name="ClassesProv_TypedElement", is_abstract=True)
RedefinableElement = Class(name="RedefinableElement")
Type = Class(name="Type")
ClassesProv_LiteralSpecification = Class(name="ClassesProv_LiteralSpecification", is_abstract=True)
ClassesProv_LiteralNull = Class(name="ClassesProv_LiteralNull")
LiteralSpecification = Class(name="LiteralSpecification")
ClassesProv_LiteralBoolean = Class(name="ClassesProv_LiteralBoolean")
ClassesProv_LiteralInteger = Class(name="ClassesProv_LiteralInteger")
ClassesProv_LiteralReal = Class(name="ClassesProv_LiteralReal")
ClassesProv_LiteralString = Class(name="ClassesProv_LiteralString")
ClassesProv_LiteralUnilimitedNatural = Class(name="ClassesProv_LiteralUnilimitedNatural")
ClassesProv_InstanceValue = Class(name="ClassesProv_InstanceValue")
ClassesProv_Classifier = Class(name="ClassesProv_Classifier", is_abstract=True)
ClassesProv_StructuralFeature = Class(name="ClassesProv_StructuralFeature", is_abstract=True)
ClassesProv_RedefinableElement = Class(name="ClassesProv_RedefinableElement", is_abstract=True)
ClassesProv_Association = Class(name="ClassesProv_Association")
ClassesProv_DataType = Class(name="ClassesProv_DataType")
ClassesProv_Interface = Class(name="ClassesProv_Interface")
ClassesProv_Feature = Class(name="ClassesProv_Feature", is_abstract=True)
ClassesProv_Property = Class(name="ClassesProv_Property")
ClassesProv_Generalization = Class(name="ClassesProv_Generalization")
ClassesProv_Substitution = Class(name="ClassesProv_Substitution")
ClassesProv_GeneralizationSet = Class(name="ClassesProv_GeneralizationSet")
Feature = Class(name="Feature")
MultiplicityElement = Class(name="MultiplicityElement")
StructuralFeature = Class(name="StructuralFeature")
ClassesProv_Class = Class(name="ClassesProv_Class")
Classifier = Class(name="Classifier")
ClassesProv_BehavioralFeature = Class(name="ClassesProv_BehavioralFeature", is_abstract=True)
ClassesProv_Parameter = Class(name="ClassesProv_Parameter")
ClassesProv_Operation = Class(name="ClassesProv_Operation")
BehavioralFeature = Class(name="BehavioralFeature")
ClassesProv_Usage = Class(name="ClassesProv_Usage")
Dependency = Class(name="Dependency")
ClassesProv_Abstraction = Class(name="ClassesProv_Abstraction")
ClassesProv_Realization = Class(name="ClassesProv_Realization")
Abstraction = Class(name="Abstraction")
Realization = Class(name="Realization")
ClassesProv_PrimitiveType = Class(name="ClassesProv_PrimitiveType")
DataType = Class(name="DataType")
ClassesProv_Enumeration = Class(name="ClassesProv_Enumeration")
ClassesProv_EnumerationLiteral = Class(name="ClassesProv_EnumerationLiteral")
InstanceSpecification = Class(name="InstanceSpecification")
ClassesProv_InterfaceRealization = Class(name="ClassesProv_InterfaceRealization")
ClassesProv_AssociationClass = Class(name="ClassesProv_AssociationClass")
...
ClassesProv_MultiplicityElement.attributes={ClassesProv_MultiplicityElement_upper, ClassesProv_MultiplicityElement_lower, ClassesProv_MultiplicityElement_isUnique, ClassesProv_MultiplicityElement_isOrdered}
...
ClassesProv_Property.attributes={ClassesProv_Property_default, ClassesProv_Property_isComposite, ClassesProv_Property_isDerivedUnion, ClassesProv_Property_isDerived, ClassesProv_Property_isID}
...
ClassesProv_Operation.attributes={ClassesProv_Operation_isOrdered, ClassesProv_Operation_isQuery, ClassesProv_Operation_upper, ClassesProv_Operation_lower, ClassesProv_Operation_isUnique}
...
class_131: BinaryAssociation = BinaryAssociation(
    name="class_131",
    ends={
...
class_190: BinaryAssociation = BinaryAssociation(
    name="class_190",
    ends={
...
domain_model = DomainModel(
    name="ClassesProv",
    types={ClassesProv_Element, ClassesProv_Type, ClassesProv_PackageMerge, ClassesProv_NamedElement, Element, ClassesProv_Namespace, ClassesProv_Dependency, NamedElement, ClassesProv_PackageableElement, ClassesProv_ElementImport, ClassesProv_PackageImport, ClassesProv_Constraint, DirectedRelationship, ClassesProv_Package, Namespace, PackageableElement, ClassesProv_Expression, ValueSpecification, ClassesProv_OpaqueExpression, ClassesProv_Relationship, ClassesProv_DirectedRelationship, Relationship, ClassesProv_MultiplicityElement, ClassesProv_ValueSpecification, TypedElement, ClassesProv_Slot, ClassesProv_InstanceSpecification, ClassesProv_TypedElement, RedefinableElement, Type, ClassesProv_LiteralSpecification, ClassesProv_LiteralNull, LiteralSpecification, ClassesProv_LiteralBoolean, ClassesProv_LiteralInteger, ClassesProv_LiteralReal, ClassesProv_LiteralString, ClassesProv_LiteralUnilimitedNatural, ClassesProv_InstanceValue, ClassesProv_Classifier, ClassesProv_StructuralFeature, ClassesProv_RedefinableElement, ClassesProv_Association, ClassesProv_DataType, ClassesProv_Interface, ClassesProv_Feature, ClassesProv_Property, ClassesProv_Generalization, ClassesProv_Substitution, ClassesProv_GeneralizationSet, Feature, MultiplicityElement, StructuralFeature, ClassesProv_Class, Classifier, ClassesProv_BehavioralFeature, ClassesProv_Parameter, ClassesProv_Operation, BehavioralFeature, ClassesProv_Usage, Dependency, ClassesProv_Abstraction, ClassesProv_Realization, Abstraction, Realization, ClassesProv_PrimitiveType, DataType, ClassesProv_Enumeration, ClassesProv_EnumerationLiteral, InstanceSpecification, ClassesProv_InterfaceRealization, ClassesProv_AssociationClass, Class_, Association},
    associations={ownedElement1, nestedPackage34, nestingPackage37, packagedElement39, ownedType42, packageMerge44, owner3, namespace5, clientDependency6, importedMember8, member10, ownedMember13, elementImport16, packageImport18, ownedRule20, importedElement22, importingNamespace25, importedPackage28, importingNamespace30, package72, operand75, relatedElement46, target48, source50, upperValue53, lowerValue54, owningUpper57, owningLower60, owningConstraint63, owningSlot66, owningInstanceSpec68, type70, redefinedElement105, redefinitionContext106, inheritedMember109, instance77, slot79, specification82, classifier85, context87, constrainedElement90, specification93, owningInstace96, value99, definingFeature102, defaultValue136, opposite140, subsettedProperty143, association145, owningAssociation147, dataType150, interface152, feature112, attribute114, redefinedClassifier117, general120, generalization122, substitution124, powertypeExtent126, featuringClassifier128, class_131, redefinedProperty134, precondition181, bodyCondition184, postcondition187, class_190, dataType193, interface196, qualifier155, associationEnd158, general160, specific163, generalizationSet166, ownedParameter169, raisedException170, ownedFormalParam173, defaultValue176, type179, client236, supplier239, mapping242, nestedClassifier199, ownedOperation202, superClass206, ownedAttribute208, navigableOwnedEnd211, memberEnd214, ownedEnd217, ownedAttribute220, ownedOperation223, ownedLiteral226, enumeration227, receivingPackage230, mergedPackage233, substitutingClassifier243, contract246, nestedClassifier249, redefinedInterface253, ownedAttribute255, ownedOperation258, contract261, powertype263, generalization266},
    generalizations={gen_ClassesProv_NamedElement_Element, gen_ClassesProv_Namespace_NamedElement, gen_ClassesProv_PackageableElement_NamedElement, gen_ClassesProv_ElementImport_DirectedRelationship, gen_ClassesProv_PackageImport_DirectedRelationship, gen_ClassesProv_Package_Namespace, gen_ClassesProv_Package_PackageableElement, gen_ClassesProv_Type_PackageableElement, gen_ClassesProv_Expression_ValueSpecification, gen_ClassesProv_OpaqueExpression_ValueSpecification, gen_ClassesProv_Relationship_Element, gen_ClassesProv_DirectedRelationship_Relationship, gen_ClassesProv_MultiplicityElement_Element, gen_ClassesProv_ValueSpecification_TypedElement, gen_ClassesProv_ValueSpecification_PackageableElement, gen_ClassesProv_TypedElement_NamedElement, gen_ClassesProv_Classifier_RedefinableElement, gen_ClassesProv_Classifier_Namespace, gen_ClassesProv_Classifier_Type, gen_ClassesProv_LiteralSpecification_ValueSpecification, gen_ClassesProv_LiteralNull_LiteralSpecification, gen_ClassesProv_LiteralBoolean_LiteralSpecification, gen_ClassesProv_LiteralInteger_LiteralSpecification, gen_ClassesProv_LiteralReal_LiteralSpecification, gen_ClassesProv_LiteralString_LiteralSpecification, gen_ClassesProv_LiteralUnilimitedNatural_LiteralSpecification, gen_ClassesProv_InstanceSpecification_PackageableElement, gen_ClassesProv_Constraint_PackageableElement, gen_ClassesProv_Slot_Element, gen_ClassesProv_RedefinableElement_NamedElement, gen_ClassesProv_Feature_RedefinableElement, gen_ClassesProv_StructuralFeature_Feature, gen_ClassesProv_StructuralFeature_MultiplicityElement, gen_ClassesProv_StructuralFeature_TypedElement, gen_ClassesProv_Property_StructuralFeature, gen_ClassesProv_Class_Classifier, gen_ClassesProv_Generalization_DirectedRelationship, gen_ClassesProv_BehavioralFeature_Feature, gen_ClassesProv_BehavioralFeature_Namespace, gen_ClassesProv_Parameter_TypedElement, gen_ClassesProv_Operation_BehavioralFeature, gen_ClassesProv_Usage_Dependency, gen_ClassesProv_Abstraction_Dependency, gen_ClassesProv_Realization_Abstraction, gen_ClassesProv_Substitution_Realization, gen_ClassesProv_Association_Relationship, gen_ClassesProv_Association_Classifier, gen_ClassesProv_DataType_Classifier, gen_ClassesProv_PrimitiveType_DataType, gen_ClassesProv_Enumeration_DataType, gen_ClassesProv_EnumerationLiteral_InstanceSpecification, gen_ClassesProv_PackageMerge_DirectedRelationship, gen_ClassesProv_Dependency_PackageableElement, gen_ClassesProv_Dependency_DirectedRelationship, gen_ClassesProv_Interface_Classifier, gen_ClassesProv_InterfaceRealization_Realization, gen_ClassesProv_AssociationClass_Class, gen_ClassesProv_AssociationClass_Association, gen_ClassesProv_GeneralizationSet_PackageableElement},
    metadata=None
)
