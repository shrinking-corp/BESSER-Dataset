...
AdminPanel = Class(name="AdminPanel")
...
Users.attributes={Users_UserLevel, Users_UserID, Users_UserName}
...
Order.attributes={Order_Date, Order_Total, Order_UserID, Order_DicountLvl, Order_OrderID}
...
OrderItem.attributes={OrderItem_ItemName, OrderItem_Completed, OrderItem_RemaningTime}
...
Menu.attributes={Menu_Availability, Menu_MenuItem, Menu_Price, Menu_Category}

# AdminPanel class attributes and methods
AdminPanel_UserID: Property = Property(name="UserID", type=IntegerType)
AdminPanel_UserName: Property = Property(name="UserName", type=StringType)
AdminPanel_UserLevel: Property = Property(name="UserLevel", type=IntegerType)
AdminPanel.attributes={AdminPanel_UserName, AdminPanel_UserLevel, AdminPanel_UserID}
...
Bookings_TableNo: Property = Property(name="TableNo", type=IntegerType)
Bookings_Date: Property = Property(name="Date", type=DateType)
Bookings_Time: Property = Property(name="Time", type=DateType)
Bookings.attributes={Bookings_People, Bookings_BookingID, Bookings_TableNo, Bookings_CustomerName, Bookings_Time, Bookings_Date, Bookings_Phone}
...
AdminPanel_Menu: BinaryAssociation = BinaryAssociation(
    name="AdminPanel_Menu",
    ends={
        Property(name="menu8", type=Menu, multiplicity=Multiplicity(0, 1)),
        Property(name="adminPanel9", type=AdminPanel, multiplicity=Multiplicity(0, 1))
    }
)
ViewOrder_OrderItem: BinaryAssociation = BinaryAssociation(
    name="ViewOrder_OrderItem",
    ends={
        Property(name="orderItem10", type=OrderItem, multiplicity=Multiplicity(1, 9999)),
        Property(name="viewOrder11", type=ViewOrder, multiplicity=Multiplicity(1, 1))
    }
)
OrderItem_Order: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="orderItem13", type=OrderItem, multiplicity=Multiplicity(1, 9999))
    }
)
Order_Users: BinaryAssociation = BinaryAssociation(
    name="Order_Users",
    ends={
        Property(name="users14", type=Users, multiplicity=Multiplicity(1, 1)),
        Property(name="order15", type=Order, multiplicity=Multiplicity(1, 9999))
    }
)
BookedTables_Table: BinaryAssociation = BinaryAssociation(
    name="BookedTables_Table",
    ends={
        Property(name="table16", type=Table, multiplicity=Multiplicity(1, 1)),
        Property(name="bookedTables17", type=BookedTables, multiplicity=Multiplicity(1, 9999))
    }
)

# Domain Model
domain_model = DomainModel(
    name="a44355a0_4d3b_4718_97e2_7a541255c15f",
    types={Users, Table, Order, Membership_Card, ViewOrder, OrderItem, Menu, AdminPanel, Bookings, BookedTables},
    associations={Membership_Card_Order, Order_Table, Table_Bookings, Order_Menu, AdminPanel_Menu, ViewOrder_OrderItem, OrderItem_Order, Order_Users, BookedTables_Table},
    generalizations={},
    metadata=None
)
