...
# Classes
a_ca1 = Class(name="a_ca1")
a_ca2 = Class(name="a_ca2")
a_b_cb1 = Class(name="a_b_cb1")
a_b_cb2 = Class(name="a_b_cb2")
a_d_cd1 = Class(name="a_d_cd1")
a_d_cd2 = Class(name="a_d_cd2")
a_e_ce1 = Class(name="a_e_ce1")
a_e_ce2 = Class(name="a_e_ce2")
a_c_cc1 = Class(name="a_c_cc1")
a_c_cc2 = Class(name="a_c_cc2")
