...
a_b_cb1_strategy = st.builds(a_b_cb1)
...
a_b_cb2_strategy = st.builds(a_b_cb2)
...
a_c_cc1_strategy = st.builds(a_c_cc1)
...
a_c_cc2_strategy = st.builds(a_c_cc2)
...
a_ca1_strategy = st.builds(a_ca1)
...
a_ca2_strategy = st.builds(a_ca2)
...
a_d_cd1_strategy = st.builds(a_d_cd1)
...
a_d_cd2_strategy = st.builds(a_d_cd2)
...
a_e_ce1_strategy = st.builds(a_e_ce1)
...
a_e_ce2_strategy = st.builds(a_e_ce2)
