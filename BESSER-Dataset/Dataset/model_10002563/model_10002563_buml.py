...
Customer.attributes={Customer_mailid, Customer_id, Customer_phoneno, Customer_name, Customer_address}
...
domain_model = DomainModel(
    name="c1ae07a5_0299_49ce_9e1b_594fec2a7736",
    types={CUSTOMER_Actor, VISITS_THE_WEBSITE_UseCase, CREATES_THE_WEBSITE_UseCase, SELECTS_THE_ITEMS_SERVICE_UseCase, ADDS_ITEMS_SERVICE_TO_CART_UseCase, SELECTS_THE_MODE_OF_PAYMENT_UseCase, PAYS_THE_BILL_UseCase, DELIVERS_THE_PRODUCT_UseCase, SUPPORT_AND_FEEDBACK_UseCase, CHATBOT_Actor, ADMINISTRATOR_Actor, MAINTAINS_THE_PRODUCTS_SERVICES_UseCase, Customer, Order, Product, Warehouse, Transaction, Shipment, Customercare, Feedback, Cancelorder},
