...
class Project:
    ...
    def __init__(self, Created: str, Deadline: str, StatusID: int, PriorityID: int, Author: User, ProjectManager: User, Assignee: User, Description: str, Team___: str, Subscriptions___: str, Comments___: str, Attachments___: str, Activities___: str, PorjectID: int, Title: str, User1: "User" = None, User3: "User" = None, User5: "User" = None, Activity8: set["Activity"] = None, Comment10: set["Comment"] = None, Attachment16: set["Attachment"] = None, User20: "User" = None):
        self.Created = Created
