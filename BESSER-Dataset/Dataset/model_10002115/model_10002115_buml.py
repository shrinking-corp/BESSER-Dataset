...
User.attributes={User_About, User_Password, User_Roles___, User_Phone, User_Position, User_Google_plus_link, User_Active, User_Settings, User_UserID, User_Username, User_Linkedin_link, User_Lastname, User_Email, User_Dateofbirth, User_TitleID, User_Hiredate, User_DepartmentID, User_Facebook_link, User_Firstname}
...
Project.attributes={Project_Activities___, Project_Description, Project_Subscriptions___, Project_Team___, Project_PorjectID, Project_Comments___, Project_Author, Project_Created, Project_Assignee, Project_ProjectManager, Project_StatusID, Project_Attachments___, Project_Deadline, Project_Title, Project_PriorityID}
...
Activity.attributes={Activity_User, Activity_Seen, Activity_ActivityID, Activity_ActivitySubType, Activity_ActivityType, Activity_NewValue, Activity_Project, Activity_PrevValue}
...
Attachment.attributes={Attachment_Extension, Attachment_AttachmentID, Attachment_Size, Attachment_Name, Attachment_Created, Attachment_Project, Attachment_User, Attachment_Path}
