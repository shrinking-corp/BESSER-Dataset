...
# Classes
statemachine_mk2_StateMachine = Class(name="statemachine_mk2_StateMachine")
statemachine_mk2_SimpleState = Class(name="statemachine_mk2_SimpleState")
statemachine_mk2_State = Class(name="statemachine_mk2_State", is_abstract=True)
statemachine_mk2_Transition = Class(name="statemachine_mk2_Transition")
statemachine_mk2_Event = Class(name="statemachine_mk2_Event")
statemachine_mk2_Final_state = Class(name="statemachine_mk2_Final_state")
statemachine_mk2_Composite_state = Class(name="statemachine_mk2_Composite_state")
...
domain_model = DomainModel(
    ...
    types={statemachine_mk2_StateMachine, statemachine_mk2_SimpleState, statemachine_mk2_State, statemachine_mk2_Transition, statemachine_mk2_Event, statemachine_mk2_Final_state, statemachine_mk2_Composite_state, State},
    associations={simple_states0, initial_state1, transitions3, causes23, substates26, events5, final_states7, composite_states9, outgoing11, incoming12, source14, target15, triggers17, possible_states20},
    generalizations={gen_statemachine_mk2_Composite_state_State, gen_statemachine_mk2_SimpleState_State, gen_statemachine_mk2_Final_state_State},
    metadata=None
)
