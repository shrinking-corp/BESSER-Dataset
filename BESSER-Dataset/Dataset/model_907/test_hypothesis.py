...
def test_spem_lifecyclespecification_is_not_abstract():
    assert not inspect.isabstract(spem_LifeCycleSpecification)


def test_spem_lifecyclespecification_constructor_exists():
    assert callable(spem_LifeCycleSpecification.__init__)


def test_spem_lifecyclespecification_constructor_args():
...
def test_spem_methodcontentelement_has_changeDescription():
    assert hasattr(spem_MethodContentElement, "changeDescription")
    descriptor = None
    for klass in spem_MethodContentElement.__mro__:
        if "changeDescription" in klass.__dict__:
            descriptor = klass.__dict__["changeDescription"]
            break
    assert isinstance(descriptor, property)

def test_spem_methodcontentelement_has_changeDate():
    assert hasattr(spem_MethodContentElement, "changeDate")
    descriptor = None
    for klass in spem_MethodContentElement.__mro__:
...
def test_spem_methodcontentelement_has_author():
    assert hasattr(spem_MethodContentElement, "author")
    descriptor = None
    for klass in spem_MethodContentElement.__mro__:
...
def test_spem_methodcontentelement_has_version():
    assert hasattr(spem_MethodContentElement, "version")
    descriptor = None
    for klass in spem_MethodContentElement.__mro__:
...
def test_spem_methodcontentelement_has_copyright():
    assert hasattr(spem_MethodContentElement, "copyright")
    descriptor = None
    for klass in spem_MethodContentElement.__mro__:
...
def test_spem_activity_has_howToStaff():
    assert hasattr(spem_Activity, "howToStaff")
    descriptor = None
    for klass in spem_Activity.__mro__:
...
def test_spem_guidance_has_attachment():
    assert hasattr(spem_Guidance, "attachment")
    descriptor = None
    for klass in spem_Guidance.__mro__:
...
def test_spem_workproductdefinition_has_impactOfNotHaving():
    assert hasattr(spem_WorkProductDefinition, "impactOfNotHaving")
    descriptor = None
    for klass in spem_WorkProductDefinition.__mro__:
        if "impactOfNotHaving" in klass.__dict__:
            descriptor = klass.__dict__["impactOfNotHaving"]
            break
    assert isinstance(descriptor, property)

def test_spem_workproductdefinition_has_reasonForNotNeeding():
    assert hasattr(spem_WorkProductDefinition, "reasonForNotNeeding")
    descriptor = None
    for klass in spem_WorkProductDefinition.__mro__:
...
def test_spem_workdefinitionparameter_has_name():
    assert hasattr(spem_WorkDefinitionParameter, "name")
    descriptor = None
...
def test_spem_workdefinitionparameter_has_optionality():
    assert hasattr(spem_WorkDefinitionParameter, "optionality")
    descriptor = None
    for klass in spem_WorkDefinitionParameter.__mro__:
...
def test_spem_workproductkind_is_not_abstract():
    assert not inspect.isabstract(spem_WorkProductKind)


def test_spem_workproductkind_constructor_exists():
    assert callable(spem_WorkProductKind.__init__)


def test_spem_workproductkind_constructor_args():
...
def test_spem_eobject_is_not_abstract():
    assert not inspect.isabstract(spem_EObject)


def test_spem_eobject_constructor_exists():
    assert callable(spem_EObject.__init__)


def test_spem_eobject_constructor_args():
...
def test_spem_methodplugin_has_supporting():
    assert hasattr(spem_MethodPlugin, "supporting")
    descriptor = None
    for klass in spem_MethodPlugin.__mro__:
        if "supporting" in klass.__dict__:
            descriptor = klass.__dict__["supporting"]
            break
    assert isinstance(descriptor, property)

def test_spem_methodplugin_has_userChangeable():
    assert hasattr(spem_MethodPlugin, "userChangeable")
    descriptor = None
    for klass in spem_MethodPlugin.__mro__:
...
def test_spem_processcomponent_has_copyright():
    assert hasattr(spem_ProcessComponent, "copyright")
    descriptor = None
    for klass in spem_ProcessComponent.__mro__:
        if "copyright" in klass.__dict__:
            descriptor = klass.__dict__["copyright"]
            break
    assert isinstance(descriptor, property)

def test_spem_processcomponent_has_changeDescription():
    assert hasattr(spem_ProcessComponent, "changeDescription")
    descriptor = None
    for klass in spem_ProcessComponent.__mro__:
        if "changeDescription" in klass.__dict__:
            descriptor = klass.__dict__["changeDescription"]
...
def test_spem_processcomponent_has_version():
    assert hasattr(spem_ProcessComponent, "version")
    descriptor = None
    for klass in spem_ProcessComponent.__mro__:
        if "version" in klass.__dict__:
            descriptor = klass.__dict__["version"]
...
def test_spem_processcomponent_has_changeDate():
    assert hasattr(spem_ProcessComponent, "changeDate")
    descriptor = None
    for klass in spem_ProcessComponent.__mro__:
        if "changeDate" in klass.__dict__:
            descriptor = klass.__dict__["changeDate"]
...
def test_spem_processcomponent_has_author():
    assert hasattr(spem_ProcessComponent, "author")
    descriptor = None
    for klass in spem_ProcessComponent.__mro__:
        if "author" in klass.__dict__:
            descriptor = klass.__dict__["author"]
...
@given(instance=spem_MethodContentElement_strategy)
def test_spem_methodcontentelement_changeDescription_setter(instance):
...
@given(instance=spem_MethodContentElement_strategy)
def test_spem_methodcontentelement_changeDate_setter(instance):
...
@given(instance=spem_MethodContentElement_strategy)
def test_spem_methodcontentelement_author_setter(instance):
...
@given(instance=spem_MethodContentElement_strategy)
def test_spem_methodcontentelement_version_setter(instance):
...
@given(instance=spem_MethodContentElement_strategy)
def test_spem_methodcontentelement_copyright_setter(instance):
...
@given(instance=spem_Activity_strategy)
def test_spem_activity_howToStaff_setter(instance):
...
@given(instance=spem_Guidance_strategy)
def test_spem_guidance_attachment_setter(instance):
...
@given(instance=spem_WorkProductDefinition_strategy)
def test_spem_workproductdefinition_impactOfNotHaving_setter(instance):
...
@given(instance=spem_WorkProductDefinition_strategy)
def test_spem_workproductdefinition_reasonForNotNeeding_setter(instance):
...
@given(instance=spem_WorkDefinitionParameter_strategy)
def test_spem_workdefinitionparameter_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=spem_WorkDefinitionParameter_strategy)
def test_spem_workdefinitionparameter_optionality_setter(instance):
...
@given(instance=spem_MethodPlugin_strategy)
def test_spem_methodplugin_supporting_setter(instance):
...
@given(instance=spem_MethodPlugin_strategy)
def test_spem_methodplugin_userChangeable_setter(instance):
...
@given(instance=spem_ProcessComponent_strategy)
def test_spem_processcomponent_copyright_setter(instance):
    original = instance.copyright
    instance.copyright = original
    assert instance.copyright == original
...
@given(instance=spem_ProcessComponent_strategy)
def test_spem_processcomponent_changeDescription_setter(instance):
    original = instance.changeDescription
    instance.changeDescription = original
    assert instance.changeDescription == original
...
@given(instance=spem_ProcessComponent_strategy)
def test_spem_processcomponent_version_setter(instance):
    original = instance.version
    instance.version = original
    assert instance.version == original
...
@given(instance=spem_ProcessComponent_strategy)
def test_spem_processcomponent_changeDate_setter(instance):
    original = instance.changeDate
    instance.changeDate = original
    assert instance.changeDate == original
...
@given(instance=spem_ProcessComponent_strategy)
def test_spem_processcomponent_author_setter(instance):
    original = instance.author
    instance.author = original
    assert instance.author == original
