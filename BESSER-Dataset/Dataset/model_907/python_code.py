...
class spem_uma_DeliveryProcess(Process):
    ...
    def __init__(self, scale: str, projectCharacteristics: str, riskLevel: str, estimatingTechnique: str, projectMemberExpertise: str, typeOfContract: str, spem_uma_DeliveryProcess: set["SupportingMaterial"] = None, spem_uma_DeliveryProcess214: set["SupportingMaterial"] = None, Process231: "spem_uma_ProcessPlanningTemplate" = None, Process: "spem_uma_Discipline" = None):
        self.scale = scale
...
class spem_MethodLibrary:
    ...
    def __init__(self, name: str, spem_MethodLibrary: set["spem_MethodPlugin"] = None, spem_MethodLibrary193: set["spem_MethodConfiguration"] = None, spem_MethodLibrary196: "spem_ToolDefinition" = None, spem_MethodLibrary199: "ConfigurationPackage" = None, spem_MethodLibrary201: set["spem_EObject"] = None):
        self.name = name
...
class spem_RoleDefinition(MethodContentElement):
    ...
    def __init__(self, synonym: str, spem_RoleDefinition: "spem_RoleUse" = None, spem_RoleDefinition104: set["spem_Qualification"] = None, spem_RoleDefinition117: "spem_Default_ResponsibilityAssignment" = None, spem_RoleDefinition115: "spem_Default_TaskDefinitionPerformer" = None, spem_RoleDefinition136: "spem_CompositeRole" = None):
...
class spem_WorkSequence(BreakdownElement):
    ...
    def __init__(self, linkKind: str, linkToSuccessor: "spem_WorkBreakdownElement" = None, linkToPredecessor: "spem_WorkBreakdownElement" = None, WorkSequence: "spem_WorkBreakdownElement" = None, WorkSequence9: "spem_WorkBreakdownElement" = None):
...
class spem_Step(DescribableElement, WorkDefinition, VariabilityElement):
    ...
    def __init__(self, name: str, spem_Step: "spem_TaskDefinition" = None, spem_Step92: "spem_Step" = None, spem_Step90: "spem_Step" = None, spem_Step134: "spem_TaskUse" = None):
        self.name = name
...
class spem_Activity(WorkBreakdownElement, WorkDefinition, VariabilityElement):
    ...
    def __init__(self, useKind: str, howToStaff: str, isEnactable: bool, spem_Activity26: set["spem_MethodConfiguration"] = None, spem_Activity30: "spem_Activity" = None, spem_Activity28: set["spem_Activity"] = None, spem_Activity34: "spem_ProcessPerformer" = None, spem_Activity: "spem_Activity" = None, spem_Activity13: "spem_Activity" = None, spem_Activity16: set["spem_BreakdownElement"] = None, spem_Activity19: set["spem_BreakdownElement"] = None, spem_Activity22: set["spem_ProcessParameter"] = None, spem_Activity24: "spem_MethodConfiguration" = None, spem_Activity147: "spem_ProcessComponent" = None):
...
class spem_WorkBreakdownElement(BreakdownElement):
    ...
    def __init__(self, isRepeatable: bool, isOngoing: bool, isEventDriven: bool, WorkBreakdownElement: "spem_WorkSequence" = None, WorkBreakdownElement12: "spem_WorkSequence" = None, successor: set["spem_WorkSequence"] = None, predecessor: set["spem_WorkSequence"] = None):
...
class spem_WorkProductPort(ProcessElement):
    ...
    def __init__(self, isOptional: bool, portKind: str, spem_WorkProductPort203: "spem_WorkProductDefinition" = None, spem_WorkProductPort206: "spem_WorkProductPortConnector" = None, spem_WorkProductPort: "spem_ProcessComponent" = None, spem_WorkProductPort154: "spem_ProcessComponentUse" = None):
...
class spem_WorkDefinitionParameter:
    ...
    def __init__(self, name: str, direction: str, optionality: str, spem_WorkDefinitionParameter: "spem_WorkDefinition" = None, spem_WorkDefinitionParameter3: "spem_WorkProductDefinition" = None):
        self.name = name
...
class spem_DescribableElement(ExtensibleElement):
    ...
    def __init__(self, presentationName: str, briefDescription: str, purpose: str, mainDescription: str, spem_DescribableElement67: set["EstimatingConsideration"] = None, spem_DescribableElement69: set["spem_Category"] = None, spem_DescribableElement: set["spem_Guidance"] = None, spem_DescribableElement59: set["spem_Metric"] = None, spem_DescribableElement62: "spem_DescribableElement" = None, spem_DescribableElement60: "spem_DescribableElement" = None, spem_DescribableElement65: "spem_DescribableElement" = None, spem_DescribableElement63: "spem_DescribableElement" = None):
