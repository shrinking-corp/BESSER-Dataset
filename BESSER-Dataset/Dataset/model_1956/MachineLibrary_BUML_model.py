...
# Classes
MachineLibrary_PMMachineLibrary = Class(name="MachineLibrary_PMMachineLibrary")
MachineLibrary_LabMachines = Class(name="MachineLibrary_LabMachines")
MachineLibrary_LabMachine = Class(name="MachineLibrary_LabMachine")
MachineLibrary_IBMWebsphereMQ = Class(name="MachineLibrary_IBMWebsphereMQ")
MachineLibrary_DPbase_Link = Class(name="MachineLibrary_DPbase_Link")
MachineLibrary_Link2 = Class(name="MachineLibrary_Link2")
MachineLibrary_NodeConfig = Class(name="MachineLibrary_NodeConfig")
MachineLibrary_LinkConfig = Class(name="MachineLibrary_LinkConfig")
MachineLibrary_WinCCLnk = Class(name="MachineLibrary_WinCCLnk")
MachineLibrary_TCPIP_Link = Class(name="MachineLibrary_TCPIP_Link")
MachineLibrary_Serial_Link = Class(name="MachineLibrary_Serial_Link")
MachineLibrary_FileTransfer_Link = Class(name="MachineLibrary_FileTransfer_Link")
MachineLibrary_Compac_Link = Class(name="MachineLibrary_Compac_Link")
MachineLibrary_DPbase_Node = Class(name="MachineLibrary_DPbase_Node")
MachineLibrary_Units = Class(name="MachineLibrary_Units")
MachineLibrary_Commands = Class(name="MachineLibrary_Commands")
MachineLibrary_NodePrograms = Class(name="MachineLibrary_NodePrograms")
MachineLibrary_Parameters = Class(name="MachineLibrary_Parameters")
MachineLibrary_CommunicationData = Class(name="MachineLibrary_CommunicationData")
MachineLibrary_NodeSpecialConfiguration = Class(name="MachineLibrary_NodeSpecialConfiguration")
MachineLibrary_NodeGeneral = Class(name="MachineLibrary_NodeGeneral")
MachineLibrary_NodeGeneralSpecial = Class(name="MachineLibrary_NodeGeneralSpecial")
MachineLibrary_NodeGeneral_Terminal = Class(name="MachineLibrary_NodeGeneral_Terminal")
MachineLibrary_NodeGeneral_PM2PM = Class(name="MachineLibrary_NodeGeneral_PM2PM")
MachineLibrary_NodeGeneral_RemotePM = Class(name="MachineLibrary_NodeGeneral_RemotePM")
MachineLibrary_NodeGeneral_WinCC2WinCC = Class(name="MachineLibrary_NodeGeneral_WinCC2WinCC")
MachineLibrary_NodeGeneral_AccuPycMeter = Class(name="MachineLibrary_NodeGeneral_AccuPycMeter")
MachineLibrary_NodeGeneral_RigakuXRF = Class(name="MachineLibrary_NodeGeneral_RigakuXRF")
MachineLibrary_UnitPrograms = Class(name="MachineLibrary_UnitPrograms")
MachineLibrary_Buttons = Class(name="MachineLibrary_Buttons")
MachineLibrary_UnitGeneral = Class(name="MachineLibrary_UnitGeneral")
MachineLibrary_UnitGeneralSpecial = Class(name="MachineLibrary_UnitGeneralSpecial")
MachineLibrary_UnitSpecialConfiguration = Class(name="MachineLibrary_UnitSpecialConfiguration")
MachineLibrary_UnitGeneralParameters = Class(name="MachineLibrary_UnitGeneralParameters")
MachineLibrary_WinCCAddTag = Class(name="MachineLibrary_WinCCAddTag")
MachineLibrary_Positions = Class(name="MachineLibrary_Positions")
MachineLibrary_StausBits = Class(name="MachineLibrary_StausBits")
MachineLibrary_PLCtoPmMatrix = Class(name="MachineLibrary_PLCtoPmMatrix")
MachineLibrary_UnitGeneral_Terminal = Class(name="MachineLibrary_UnitGeneral_Terminal")
MachineLibrary_UnitGeneral_HostPC = Class(name="MachineLibrary_UnitGeneral_HostPC")
MachineLibrary_UnitGeneral_Remote = Class(name="MachineLibrary_UnitGeneral_Remote")
MachineLibrary_UnitGeneral_PM2PM = Class(name="MachineLibrary_UnitGeneral_PM2PM")
MachineLibrary_UnitGeneral_AccPyc = Class(name="MachineLibrary_UnitGeneral_AccPyc")
MachineLibrary_UnitGeneral_SuperQ = Class(name="MachineLibrary_UnitGeneral_SuperQ")
MachineLibrary_UnitGeneral_RigakuXRF = Class(name="MachineLibrary_UnitGeneral_RigakuXRF")
MachineLibrary_UnitGeneral_Scanner = Class(name="MachineLibrary_UnitGeneral_Scanner")
MachineLibrary_Translate_Terminal = Class(name="MachineLibrary_Translate_Terminal")
MachineLibrary_OutputRequest_OBLFOES = Class(name="MachineLibrary_OutputRequest_OBLFOES")
MachineLibrary_TestRequest_OBLFOES = Class(name="MachineLibrary_TestRequest_OBLFOES")
MachineLibrary_RecalRequest_OBLFOES = Class(name="MachineLibrary_RecalRequest_OBLFOES")
MachineLibrary_ErrorMessage_OBLFOES = Class(name="MachineLibrary_ErrorMessage_OBLFOES")
MachineLibrary_GeneralParameter_SuperQXRF = Class(name="MachineLibrary_GeneralParameter_SuperQXRF")
MachineLibrary_UnitConfig_Terminal = Class(name="MachineLibrary_UnitConfig_Terminal")
MachineLibrary_UnitConfig_OBLF_OES = Class(name="MachineLibrary_UnitConfig_OBLF_OES")
MachineLibrary_UnitConfig_SuperQ_XRF = Class(name="MachineLibrary_UnitConfig_SuperQ_XRF")
MachineLibrary_UnitConfig_ARL_XRF_OES = Class(name="MachineLibrary_UnitConfig_ARL_XRF_OES")
MachineLibrary_UnitConfig_Host = Class(name="MachineLibrary_UnitConfig_Host")
MachineLibrary_History_AccuPycMeter = Class(name="MachineLibrary_History_AccuPycMeter")
MachineLibrary_SepByComma_Scanner = Class(name="MachineLibrary_SepByComma_Scanner")
MachineLibrary_CheckAddSID_PM2PM = Class(name="MachineLibrary_CheckAddSID_PM2PM")
MachineLibrary_GeneralSetting_ARL_XRF_OES = Class(name="MachineLibrary_GeneralSetting_ARL_XRF_OES")
MachineLibrary_PS_Process_Finished_ARL_XRF_OES = Class(name="MachineLibrary_PS_Process_Finished_ARL_XRF_OES")
MachineLibrary_File_Sample_ARL_XRF_OES = Class(name="MachineLibrary_File_Sample_ARL_XRF_OES")
MachineLibrary_ControlSamples_SuperQXRF = Class(name="MachineLibrary_ControlSamples_SuperQXRF")
MachineLibrary_Communication_SuperQXRF = Class(name="MachineLibrary_Communication_SuperQXRF")
MachineLibrary_CheckSampleRunTime_SuperQXRF = Class(name="MachineLibrary_CheckSampleRunTime_SuperQXRF")
MachineLibrary_CheckSample_SuperQXRF = Class(name="MachineLibrary_CheckSample_SuperQXRF")
MachineLibrary_CheckFilling_ARL_XRF_OES = Class(name="MachineLibrary_CheckFilling_ARL_XRF_OES")
MachineLibrary_ExecuteFiling_ARL_XRF_OES = Class(name="MachineLibrary_ExecuteFiling_ARL_XRF_OES")
MachineLibrary_CheckReqPrepUnit_ARL_XRF_OES = Class(name="MachineLibrary_CheckReqPrepUnit_ARL_XRF_OES")
MachineLibrary_ExePrepUnit_ARL_XRF_OES = Class(name="MachineLibrary_ExePrepUnit_ARL_XRF_OES")
MachineLibrary_CheckAskPrepUnit_ARL_XRF_OES = Class(name="MachineLibrary_CheckAskPrepUnit_ARL_XRF_OES")
MachineLibrary_ExeAskPrepUnit_ARL_XRF_OES = Class(name="MachineLibrary_ExeAskPrepUnit_ARL_XRF_OES")
MachineLibrary_DisableSCT_ARL_XRF_OES = Class(name="MachineLibrary_DisableSCT_ARL_XRF_OES")
MachineLibrary_Settings_ARL_XRF_OES = Class(name="MachineLibrary_Settings_ARL_XRF_OES")
MachineLibrary_Report_Host = Class(name="MachineLibrary_Report_Host")
MachineLibrary_WS_Update_Host = Class(name="MachineLibrary_WS_Update_Host")
MachineLibrary_Moved_Host = Class(name="MachineLibrary_Moved_Host")
MachineLibrary_InsertRemove_Host = Class(name="MachineLibrary_InsertRemove_Host")
MachineLibrary_OES_XRF_Condition = Class(name="MachineLibrary_OES_XRF_Condition")
MachineLibrary_CheckSampleRunTimeParams_SuperQXRF = Class(name="MachineLibrary_CheckSampleRunTimeParams_SuperQXRF")
MachineLibrary_InsertRemove_Entry_Host = Class(name="MachineLibrary_InsertRemove_Entry_Host")
MachineLibrary_InsertRemove_Types_Host = Class(name="MachineLibrary_InsertRemove_Types_Host")
MachineLibrary_InsertRemove_Keywords_Host = Class(name="MachineLibrary_InsertRemove_Keywords_Host")
MachineLibrary_CheckSampleConfig_SuperQXRF = Class(name="MachineLibrary_CheckSampleConfig_SuperQXRF")
MachineLibrary_HistoryConfig_AccuPyc = Class(name="MachineLibrary_HistoryConfig_AccuPyc")
MachineLibrary_StatusBit = Class(name="MachineLibrary_StatusBit")
MachineLibrary_SepByComma_Field_Scanner = Class(name="MachineLibrary_SepByComma_Field_Scanner")
MachineLibrary_SepByComma_ID_Scanner = Class(name="MachineLibrary_SepByComma_ID_Scanner")
MachineLibrary_CheckAddSID_Values_PM2PM = Class(name="MachineLibrary_CheckAddSID_Values_PM2PM")
MachineLibrary_Button = Class(name="MachineLibrary_Button")
MachineLibrary_Position = Class(name="MachineLibrary_Position")
MachineLibrary_UnitProgram = Class(name="MachineLibrary_UnitProgram")
MachineLibrary_UnitProgParameters = Class(name="MachineLibrary_UnitProgParameters")
MachineLibrary_Command = Class(name="MachineLibrary_Command")
MachineLibrary_NodeProgram = Class(name="MachineLibrary_NodeProgram")
MachineLibrary_ParamPrint = Class(name="MachineLibrary_ParamPrint")
MachineLibrary_Transfer = Class(name="MachineLibrary_Transfer")
MachineLibrary_PlainMove = Class(name="MachineLibrary_PlainMove")
MachineLibrary_Parameter = Class(name="MachineLibrary_Parameter")
MachineLibrary_RobotVarToBusyCodes = Class(name="MachineLibrary_RobotVarToBusyCodes")
MachineLibrary_RobotConfSendOrders = Class(name="MachineLibrary_RobotConfSendOrders")
MachineLibrary_RobotWinCCToRobots = Class(name="MachineLibrary_RobotWinCCToRobots")
MachineLibrary_RobotToWinccs = Class(name="MachineLibrary_RobotToWinccs")
MachineLibrary_RobotWarningONDelete = Class(name="MachineLibrary_RobotWarningONDelete")
MachineLibrary_RobotVarToErrorbits = Class(name="MachineLibrary_RobotVarToErrorbits")
MachineLibrary_RobotConfiguration = Class(name="MachineLibrary_RobotConfiguration")
MachineLibrary_TransferFileSection = Class(name="MachineLibrary_TransferFileSection")
MachineLibrary_PlainMoveEntrySend = Class(name="MachineLibrary_PlainMoveEntrySend")
MachineLibrary_RobotVarToErrorbit = Class(name="MachineLibrary_RobotVarToErrorbit")
MachineLibrary_RobotVarToBusycode = Class(name="MachineLibrary_RobotVarToBusycode")
MachineLibrary_RobotConfSendOrder = Class(name="MachineLibrary_RobotConfSendOrder")
MachineLibrary_RobotWinCCToRobot = Class(name="MachineLibrary_RobotWinCCToRobot")
MachineLibrary_RobotToWinCC = Class(name="MachineLibrary_RobotToWinCC")
...
MachineLibrary_PMMachineLibrary.attributes={MachineLibrary_PMMachineLibrary_libraryVersion, MachineLibrary_PMMachineLibrary_libraryVersionRemark}
...
MachineLibrary_LabMachine.attributes={MachineLibrary_LabMachine_createWinCCTags, MachineLibrary_LabMachine_driver, MachineLibrary_LabMachine_machineName, MachineLibrary_LabMachine_machineVersionNo, MachineLibrary_LabMachine_linkParamFile, MachineLibrary_LabMachine_linkParamSection, MachineLibrary_LabMachine_linkType, MachineLibrary_LabMachine_versionRemark}
...
MachineLibrary_IBMWebsphereMQ.attributes={MachineLibrary_IBMWebsphereMQ_readDynamicQueName, MachineLibrary_IBMWebsphereMQ_sendQueMgrName, MachineLibrary_IBMWebsphereMQ_maxDataSize, MachineLibrary_IBMWebsphereMQ_qName, MachineLibrary_IBMWebsphereMQ_sendBuffer, MachineLibrary_IBMWebsphereMQ_receiveBuffer, MachineLibrary_IBMWebsphereMQ_sendDynamicQueName, MachineLibrary_IBMWebsphereMQ_readQueName, MachineLibrary_IBMWebsphereMQ_sendQueName, MachineLibrary_IBMWebsphereMQ_readQueMgrName}
...
MachineLibrary_DPbase_Link.attributes={MachineLibrary_DPbase_Link_speed, MachineLibrary_DPbase_Link_maxNodes, MachineLibrary_DPbase_Link_cp_name}
...
MachineLibrary_NodeConfig.attributes={MachineLibrary_NodeConfig_nodeName, MachineLibrary_NodeConfig_simFileName, MachineLibrary_NodeConfig_nodeNo}
...
MachineLibrary_WinCCLnk.attributes={MachineLibrary_WinCCLnk_connectionName, MachineLibrary_WinCCLnk_updateCycle, MachineLibrary_WinCCLnk_canCreateTags, MachineLibrary_WinCCLnk_canModifyTag, MachineLibrary_WinCCLnk_updateCycle_Help}
...
MachineLibrary_TCPIP_Link.attributes={MachineLibrary_TCPIP_Link_receiveBuffer, MachineLibrary_TCPIP_Link_address_5, MachineLibrary_TCPIP_Link_address_4, MachineLibrary_TCPIP_Link_port, MachineLibrary_TCPIP_Link_address_3, MachineLibrary_TCPIP_Link_termChar, MachineLibrary_TCPIP_Link_address_2, MachineLibrary_TCPIP_Link_msgDelay, MachineLibrary_TCPIP_Link_maxDataSize, MachineLibrary_TCPIP_Link_sendBuffer, MachineLibrary_TCPIP_Link_address_1, MachineLibrary_TCPIP_Link_address_6, MachineLibrary_TCPIP_Link_protocol}
...
MachineLibrary_Serial_Link.attributes={MachineLibrary_Serial_Link_maxCharDelay, MachineLibrary_Serial_Link_port, MachineLibrary_Serial_Link_startChar, MachineLibrary_Serial_Link_params, MachineLibrary_Serial_Link_logging, MachineLibrary_Serial_Link_commConfig, MachineLibrary_Serial_Link_endChar, MachineLibrary_Serial_Link_bufferLenght}
...
MachineLibrary_FileTransfer_Link.attributes={MachineLibrary_FileTransfer_Link_translation, MachineLibrary_FileTransfer_Link_flagDelAfterReading, MachineLibrary_FileTransfer_Link_flagWriteAfterReading, MachineLibrary_FileTransfer_Link_flagToWriteWaitFor, MachineLibrary_FileTransfer_Link_delimiter, MachineLibrary_FileTransfer_Link_toWriteWaitFor, MachineLibrary_FileTransfer_Link_delimter, MachineLibrary_FileTransfer_Link_readPath, MachineLibrary_FileTransfer_Link_writePath, MachineLibrary_FileTransfer_Link_sendBuffer, MachineLibrary_FileTransfer_Link_maxDataLength, MachineLibrary_FileTransfer_Link_writeAfterReading, MachineLibrary_FileTransfer_Link_flagToWriteWaitForDeleted, MachineLibrary_FileTransfer_Link_timeoutwrite, MachineLibrary_FileTransfer_Link_pollTime, MachineLibrary_FileTransfer_Link_receiveBuffer}
...
MachineLibrary_Compac_Link.attributes={MachineLibrary_Compac_Link_port, MachineLibrary_Compac_Link_retry, MachineLibrary_Compac_Link_maxDataLength, MachineLibrary_Compac_Link_timeout, MachineLibrary_Compac_Link_params, MachineLibrary_Compac_Link_commConfig, MachineLibrary_Compac_Link_bcc, MachineLibrary_Compac_Link_splitLongMessage, MachineLibrary_Compac_Link_checksumCode, MachineLibrary_Compac_Link_checksum, MachineLibrary_Compac_Link_useNotACK_NAK, MachineLibrary_Compac_Link_useNotENQ, MachineLibrary_Compac_Link_bytecountcode, MachineLibrary_Compac_Link_byteCount}
...
MachineLibrary_Units.attributes={MachineLibrary_Units_internalUniNo, MachineLibrary_Units_unitName, MachineLibrary_Units_unitNo}
...
MachineLibrary_CommunicationData.attributes={MachineLibrary_CommunicationData_comSendDataAddress, MachineLibrary_CommunicationData_comSIDDataAddress, MachineLibrary_CommunicationData_comErrorDataAddress, MachineLibrary_CommunicationData_comSIDDataLength, MachineLibrary_CommunicationData_comProgressIndDataLength, MachineLibrary_CommunicationData_comRequestDataLength, MachineLibrary_CommunicationData_comRequestDataAddress, MachineLibrary_CommunicationData_comErrorDataLength, MachineLibrary_CommunicationData_comProgressIndDataAddress, MachineLibrary_CommunicationData_comSendDataLength}
...
MachineLibrary_NodeGeneral_Terminal.attributes={MachineLibrary_NodeGeneral_Terminal_maxYValue, MachineLibrary_NodeGeneral_Terminal_name_4, MachineLibrary_NodeGeneral_Terminal_customTimer2, MachineLibrary_NodeGeneral_Terminal_name_3, MachineLibrary_NodeGeneral_Terminal_name_5, MachineLibrary_NodeGeneral_Terminal_lenOfPlanID, MachineLibrary_NodeGeneral_Terminal_maxXValue, MachineLibrary_NodeGeneral_Terminal_displayTime, MachineLibrary_NodeGeneral_Terminal_keyBoardSignalCarrierPresent, MachineLibrary_NodeGeneral_Terminal_stationAuto, MachineLibrary_NodeGeneral_Terminal_steelCarrier, MachineLibrary_NodeGeneral_Terminal_name_2, MachineLibrary_NodeGeneral_Terminal_customTimer1, MachineLibrary_NodeGeneral_Terminal_signalCarrierPresent, MachineLibrary_NodeGeneral_Terminal_name_1, MachineLibrary_NodeGeneral_Terminal_stationType, MachineLibrary_NodeGeneral_Terminal_stationReady, MachineLibrary_NodeGeneral_Terminal_name_6, MachineLibrary_NodeGeneral_Terminal_terminalType, MachineLibrary_NodeGeneral_Terminal_maxScreens}
...
MachineLibrary_NodeGeneral_PM2PM.attributes={MachineLibrary_NodeGeneral_PM2PM_type, MachineLibrary_NodeGeneral_PM2PM_timeServer}
...
MachineLibrary_NodeGeneral_RemotePM.attributes={MachineLibrary_NodeGeneral_RemotePM_timeServer, MachineLibrary_NodeGeneral_RemotePM_system}
...
MachineLibrary_NodeGeneral_AccuPycMeter.attributes={MachineLibrary_NodeGeneral_AccuPycMeter_polling, MachineLibrary_NodeGeneral_AccuPycMeter_runTimout, MachineLibrary_NodeGeneral_AccuPycMeter_expectSampleWeight, MachineLibrary_NodeGeneral_AccuPycMeter_sendSampleWeight}
...
MachineLibrary_NodeGeneral_RigakuXRF.attributes={MachineLibrary_NodeGeneral_RigakuXRF_timeout, MachineLibrary_NodeGeneral_RigakuXRF_timeoutResponce, MachineLibrary_NodeGeneral_RigakuXRF_timerToSendStatus, MachineLibrary_NodeGeneral_RigakuXRF_bDoNotshiftAtExit}
...
MachineLibrary_UnitGeneralParameters.attributes={MachineLibrary_UnitGeneralParameters_comment_1, MachineLibrary_UnitGeneralParameters_defaultValue_1, MachineLibrary_UnitGeneralParameters_unit_1, MachineLibrary_UnitGeneralParameters_minValue_1, MachineLibrary_UnitGeneralParameters_KeyWord_1, MachineLibrary_UnitGeneralParameters_paraName_1, MachineLibrary_UnitGeneralParameters_seq_X, MachineLibrary_UnitGeneralParameters_UseWith_1, MachineLibrary_UnitGeneralParameters_maxValue_1, MachineLibrary_UnitGeneralParameters_visibleType_1, MachineLibrary_UnitGeneralParameters_canBeChange_1}
...
MachineLibrary_PLCtoPmMatrix.attributes={MachineLibrary_PLCtoPmMatrix_plcpmmatrixBit12, MachineLibrary_PLCtoPmMatrix_plcpmmatrixBit0, MachineLibrary_PLCtoPmMatrix_plcpmmatrixBit2, MachineLibrary_PLCtoPmMatrix_plcpmmatrixBit14, MachineLibrary_PLCtoPmMatrix_plcpmmatrixBit11, MachineLibrary_PLCtoPmMatrix_plcpmmatrixBit6, MachineLibrary_PLCtoPmMatrix_plcpmmatrixBit5, MachineLibrary_PLCtoPmMatrix_plcpmmatrixBit8, MachineLibrary_PLCtoPmMatrix_plcpmmatrixBit13, MachineLibrary_PLCtoPmMatrix_plcpmmatrixBit7, MachineLibrary_PLCtoPmMatrix_plcpmmatrixBit4, MachineLibrary_PLCtoPmMatrix_plcpmmatrixBit15, MachineLibrary_PLCtoPmMatrix_plcpmmatrixBit9, MachineLibrary_PLCtoPmMatrix_plcpmmatrixBit1, MachineLibrary_PLCtoPmMatrix_plcpmmatrixBit3, MachineLibrary_PLCtoPmMatrix_plcpmmatrixBit10}
...
MachineLibrary_UnitGeneral_Terminal.attributes={MachineLibrary_UnitGeneral_Terminal_station3, MachineLibrary_UnitGeneral_Terminal_station2, MachineLibrary_UnitGeneral_Terminal_station5, MachineLibrary_UnitGeneral_Terminal_station4, MachineLibrary_UnitGeneral_Terminal_thisStation, MachineLibrary_UnitGeneral_Terminal_station1}
...
MachineLibrary_UnitGeneral_HostPC.attributes={MachineLibrary_UnitGeneral_HostPC_maxIndex, MachineLibrary_UnitGeneral_HostPC_index, MachineLibrary_UnitGeneral_HostPC_writeDumyIfNoDataExist, MachineLibrary_UnitGeneral_HostPC_replyOnLink}
...
MachineLibrary_UnitGeneral_Remote.attributes={MachineLibrary_UnitGeneral_Remote_handshakeT, MachineLibrary_UnitGeneral_Remote_editWSDB, MachineLibrary_UnitGeneral_Remote_handshakeA, MachineLibrary_UnitGeneral_Remote_handshakeQ}
...
MachineLibrary_UnitGeneral_PM2PM.attributes={MachineLibrary_UnitGeneral_PM2PM_processFeedBack, MachineLibrary_UnitGeneral_PM2PM_sid_Mask}
...
MachineLibrary_UnitGeneral_AccPyc.attributes={MachineLibrary_UnitGeneral_AccPyc_minSampleWeight, MachineLibrary_UnitGeneral_AccPyc_cupWeight}
...
MachineLibrary_UnitGeneral_RigakuXRF.attributes={MachineLibrary_UnitGeneral_RigakuXRF_lastPoHAG_SIInstrument, MachineLibrary_UnitGeneral_RigakuXRF_lastPosAnalyHAG_SIg, MachineLibrary_UnitGeneral_RigakuXRF_lastPosInInstrument, MachineLibrary_UnitGeneral_RigakuXRF_separator}
...
MachineLibrary_UnitGeneral_Scanner.attributes={MachineLibrary_UnitGeneral_Scanner_forcedSampleType, MachineLibrary_UnitGeneral_Scanner_start, MachineLibrary_UnitGeneral_Scanner_fillWith, MachineLibrary_UnitGeneral_Scanner_preString, MachineLibrary_UnitGeneral_Scanner_registerSample, MachineLibrary_UnitGeneral_Scanner_length, MachineLibrary_UnitGeneral_Scanner_addString}
...
MachineLibrary_Translate_Terminal.attributes={MachineLibrary_Translate_Terminal_man_Busy, MachineLibrary_Translate_Terminal_auto_Busy, MachineLibrary_Translate_Terminal_man_Ready, MachineLibrary_Translate_Terminal_auto_Ready}
...
MachineLibrary_GeneralParameter_SuperQXRF.attributes={MachineLibrary_GeneralParameter_SuperQXRF_switchRemote, MachineLibrary_GeneralParameter_SuperQXRF_startList, MachineLibrary_GeneralParameter_SuperQXRF_listName}
...
MachineLibrary_Report_Host.attributes={MachineLibrary_Report_Host_sampleRemoved, MachineLibrary_Report_Host_stateChanged, MachineLibrary_Report_Host_maxType, MachineLibrary_Report_Host_fileName, MachineLibrary_Report_Host_sampleInsert, MachineLibrary_Report_Host_note, MachineLibrary_Report_Host_sampleMoved, MachineLibrary_Report_Host_internal, MachineLibrary_Report_Host_sendErrorWarningsMsgOnly, MachineLibrary_Report_Host_minType, MachineLibrary_Report_Host_note1, MachineLibrary_Report_Host_rawData, MachineLibrary_Report_Host_timeStamp, MachineLibrary_Report_Host_sendLifeMessages}
...
MachineLibrary_Moved_Host.attributes={MachineLibrary_Moved_Host_writePositionNameInFile, MachineLibrary_Moved_Host_pos0, MachineLibrary_Moved_Host_report_ALL, MachineLibrary_Moved_Host_type0}
...
MachineLibrary_OES_XRF_Condition.attributes={MachineLibrary_OES_XRF_Condition_comment, MachineLibrary_OES_XRF_Condition_paraName, MachineLibrary_OES_XRF_Condition_para, MachineLibrary_OES_XRF_Condition_seq_X}
...
MachineLibrary_InsertRemove_Types_Host.attributes={MachineLibrary_InsertRemove_Types_Host_typeValue, MachineLibrary_InsertRemove_Types_Host_typeNo}
...
MachineLibrary_InsertRemove_Keywords_Host.attributes={MachineLibrary_InsertRemove_Keywords_Host_keywordValue, MachineLibrary_InsertRemove_Keywords_Host_keywordKey}
...
MachineLibrary_CheckSampleConfig_SuperQXRF.attributes={MachineLibrary_CheckSampleConfig_SuperQXRF_sampleID, MachineLibrary_CheckSampleConfig_SuperQXRF_anaProg, MachineLibrary_CheckSampleConfig_SuperQXRF_minutes, MachineLibrary_CheckSampleConfig_SuperQXRF_seq_X, MachineLibrary_CheckSampleConfig_SuperQXRF_program, MachineLibrary_CheckSampleConfig_SuperQXRF_samples}
...
MachineLibrary_StatusBit.attributes={MachineLibrary_StatusBit_bitNo, MachineLibrary_StatusBit_bitName}
...
MachineLibrary_SepByComma_ID_Scanner.attributes={MachineLibrary_SepByComma_ID_Scanner_idValue, MachineLibrary_SepByComma_ID_Scanner_idSeq_X, MachineLibrary_SepByComma_ID_Scanner_idCharValue, MachineLibrary_SepByComma_ID_Scanner_idPrevValue}
...
MachineLibrary_Button.attributes={MachineLibrary_Button_buttonNo, MachineLibrary_Button_commandNo, MachineLibrary_Button_buttonText}
...
MachineLibrary_Position.attributes={MachineLibrary_Position_posIndex, MachineLibrary_Position_posExit, MachineLibrary_Position_posRemark, MachineLibrary_Position_posWarningOnDelete, MachineLibrary_Position_posName, MachineLibrary_Position_posNo}
...
MachineLibrary_Command.attributes={MachineLibrary_Command_commandNo, MachineLibrary_Command_commandProgParameter, MachineLibrary_Command_commandName}
...
MachineLibrary_NodeProgram.attributes={MachineLibrary_NodeProgram_programAddress, MachineLibrary_NodeProgram_programSection, MachineLibrary_NodeProgram_programName, MachineLibrary_NodeProgram_programNo, MachineLibrary_NodeProgram_programLenPerParam}
...
MachineLibrary_ParamPrint.attributes={MachineLibrary_ParamPrint_vertPosData, MachineLibrary_ParamPrint_horzPosLeftBorder, MachineLibrary_ParamPrint_fontHightHeader, MachineLibrary_ParamPrint_fontHightData, MachineLibrary_ParamPrint_vertPosHeader, MachineLibrary_ParamPrint_dateStamp, MachineLibrary_ParamPrint_horzPosValues, MachineLibrary_ParamPrint_vertLineSpace}
...
MachineLibrary_PlainMove.attributes={MachineLibrary_PlainMove_plainmovePreDefWS, MachineLibrary_PlainMove_plainmoveSID_REF, MachineLibrary_PlainMove_plainmoveType}
...
MachineLibrary_Parameter.attributes={MachineLibrary_Parameter_parameterMax, MachineLibrary_Parameter_parameterMin, MachineLibrary_Parameter_parameterType, MachineLibrary_Parameter_parameterParaLen, MachineLibrary_Parameter_parameterV0, MachineLibrary_Parameter_parameterV, MachineLibrary_Parameter_parameterT2, MachineLibrary_Parameter_parameterName, MachineLibrary_Parameter_parameterConfig, MachineLibrary_Parameter_parameterV1, MachineLibrary_Parameter_parameterT1}
...
MachineLibrary_RobotWarningONDelete.attributes={MachineLibrary_RobotWarningONDelete_robotErrBitWhenConfirmationIsNeededFor_PM, MachineLibrary_RobotWarningONDelete_robotExtraPos_1, MachineLibrary_RobotWarningONDelete_robotExtraUnit_2, MachineLibrary_RobotWarningONDelete_robotErrBitWhenConfirmationIsNeededFor_Robot}
...
MachineLibrary_RobotConfiguration.attributes={MachineLibrary_RobotConfiguration_robotID, MachineLibrary_RobotConfiguration_robotIPAddress, MachineLibrary_RobotConfiguration_robotSystemID, MachineLibrary_RobotConfiguration_robotActivate}
...
MachineLibrary_TransferFileSection.attributes={MachineLibrary_TransferFileSection_transferFile, MachineLibrary_TransferFileSection_transferSeq, MachineLibrary_TransferFileSection_transferSection}
...
MachineLibrary_PlainMoveEntrySend.attributes={MachineLibrary_PlainMoveEntrySend_plainmoveEntry, MachineLibrary_PlainMoveEntrySend_plainmoveSend, MachineLibrary_PlainMoveEntrySend_plainmoveSeq}
...
MachineLibrary_RobotVarToErrorbit.attributes={MachineLibrary_RobotVarToErrorbit_robotvartoerrorbitVar_X, MachineLibrary_RobotVarToErrorbit_robotvartoerrorbitSeq_X, MachineLibrary_RobotVarToErrorbit_robotvartoerrorbitInv_X, MachineLibrary_RobotVarToErrorbit_robotvartoerrorbitBit_X, MachineLibrary_RobotVarToErrorbit_robotvartoerrorbitType_X}
...
MachineLibrary_RobotVarToBusycode.attributes={MachineLibrary_RobotVarToBusycode_robotvartobusycodeUnit_X, MachineLibrary_RobotVarToBusycode_robotvartobusycodeType_X, MachineLibrary_RobotVarToBusycode_robotvartobusycodeSeq_X, MachineLibrary_RobotVarToBusycode_robotvartobusycodeVar_X, MachineLibrary_RobotVarToBusycode_robotvartobusycodeBit_X}
...
MachineLibrary_RobotConfSendOrder.attributes={MachineLibrary_RobotConfSendOrder_robotconfsendorderType_X, MachineLibrary_RobotConfSendOrder_robotconfsendorderSeq_X, MachineLibrary_RobotConfSendOrder_robotconfsendorderFrom_X, MachineLibrary_RobotConfSendOrder_robotconfsendorderVar_X}
...
MachineLibrary_RobotWinCCToRobot.attributes={MachineLibrary_RobotWinCCToRobot_robotwincctorobotFrom_X, MachineLibrary_RobotWinCCToRobot_robotwincctorobootType_X, MachineLibrary_RobotWinCCToRobot_robotwincctorobootSeq_X, MachineLibrary_RobotWinCCToRobot_robotwincctorobotTo_X}
...
MachineLibrary_RobotToWinCC.attributes={MachineLibrary_RobotToWinCC_robotToWinccSeq_X, MachineLibrary_RobotToWinCC_robotToWinccFrom_X, MachineLibrary_RobotToWinCC_robotToWinccTo_X, MachineLibrary_RobotToWinCC_robotToWinccType_X}
...
domain_model = DomainModel(
    name="MachineLibrary",
    types={MachineLibrary_PMMachineLibrary, MachineLibrary_LabMachines, MachineLibrary_LabMachine, MachineLibrary_IBMWebsphereMQ, MachineLibrary_DPbase_Link, MachineLibrary_Link2, MachineLibrary_NodeConfig, MachineLibrary_LinkConfig, MachineLibrary_WinCCLnk, MachineLibrary_TCPIP_Link, MachineLibrary_Serial_Link, MachineLibrary_FileTransfer_Link, MachineLibrary_Compac_Link, MachineLibrary_DPbase_Node, MachineLibrary_Units, MachineLibrary_Commands, MachineLibrary_NodePrograms, MachineLibrary_Parameters, MachineLibrary_CommunicationData, MachineLibrary_NodeSpecialConfiguration, MachineLibrary_NodeGeneral, MachineLibrary_NodeGeneralSpecial, MachineLibrary_NodeGeneral_Terminal, MachineLibrary_NodeGeneral_PM2PM, MachineLibrary_NodeGeneral_RemotePM, MachineLibrary_NodeGeneral_WinCC2WinCC, MachineLibrary_NodeGeneral_AccuPycMeter, MachineLibrary_NodeGeneral_RigakuXRF, MachineLibrary_UnitPrograms, MachineLibrary_Buttons, MachineLibrary_UnitGeneral, MachineLibrary_UnitGeneralSpecial, MachineLibrary_UnitSpecialConfiguration, MachineLibrary_UnitGeneralParameters, MachineLibrary_WinCCAddTag, MachineLibrary_Positions, MachineLibrary_StausBits, MachineLibrary_PLCtoPmMatrix, MachineLibrary_UnitGeneral_Terminal, MachineLibrary_UnitGeneral_HostPC, MachineLibrary_UnitGeneral_Remote, MachineLibrary_UnitGeneral_PM2PM, MachineLibrary_UnitGeneral_AccPyc, MachineLibrary_UnitGeneral_SuperQ, MachineLibrary_UnitGeneral_RigakuXRF, MachineLibrary_UnitGeneral_Scanner, MachineLibrary_Translate_Terminal, MachineLibrary_OutputRequest_OBLFOES, MachineLibrary_TestRequest_OBLFOES, MachineLibrary_RecalRequest_OBLFOES, MachineLibrary_ErrorMessage_OBLFOES, MachineLibrary_GeneralParameter_SuperQXRF, MachineLibrary_UnitConfig_Terminal, MachineLibrary_UnitConfig_OBLF_OES, MachineLibrary_UnitConfig_SuperQ_XRF, MachineLibrary_UnitConfig_ARL_XRF_OES, MachineLibrary_UnitConfig_Host, MachineLibrary_History_AccuPycMeter, MachineLibrary_SepByComma_Scanner, MachineLibrary_CheckAddSID_PM2PM, MachineLibrary_GeneralSetting_ARL_XRF_OES, MachineLibrary_PS_Process_Finished_ARL_XRF_OES, MachineLibrary_File_Sample_ARL_XRF_OES, MachineLibrary_ControlSamples_SuperQXRF, MachineLibrary_Communication_SuperQXRF, MachineLibrary_CheckSampleRunTime_SuperQXRF, MachineLibrary_CheckSample_SuperQXRF, MachineLibrary_CheckFilling_ARL_XRF_OES, MachineLibrary_ExecuteFiling_ARL_XRF_OES, MachineLibrary_CheckReqPrepUnit_ARL_XRF_OES, MachineLibrary_ExePrepUnit_ARL_XRF_OES, MachineLibrary_CheckAskPrepUnit_ARL_XRF_OES, MachineLibrary_ExeAskPrepUnit_ARL_XRF_OES, MachineLibrary_DisableSCT_ARL_XRF_OES, MachineLibrary_Settings_ARL_XRF_OES, MachineLibrary_Report_Host, MachineLibrary_WS_Update_Host, MachineLibrary_Moved_Host, MachineLibrary_InsertRemove_Host, MachineLibrary_OES_XRF_Condition, MachineLibrary_CheckSampleRunTimeParams_SuperQXRF, MachineLibrary_InsertRemove_Entry_Host, MachineLibrary_InsertRemove_Types_Host, MachineLibrary_InsertRemove_Keywords_Host, MachineLibrary_CheckSampleConfig_SuperQXRF, MachineLibrary_HistoryConfig_AccuPyc, MachineLibrary_StatusBit, MachineLibrary_SepByComma_Field_Scanner, MachineLibrary_SepByComma_ID_Scanner, MachineLibrary_CheckAddSID_Values_PM2PM, MachineLibrary_Button, MachineLibrary_Position, MachineLibrary_UnitProgram, MachineLibrary_UnitProgParameters, MachineLibrary_Command, MachineLibrary_NodeProgram, MachineLibrary_ParamPrint, MachineLibrary_Transfer, MachineLibrary_PlainMove, MachineLibrary_Parameter, MachineLibrary_RobotVarToBusyCodes, MachineLibrary_RobotConfSendOrders, MachineLibrary_RobotWinCCToRobots, MachineLibrary_RobotToWinccs, MachineLibrary_RobotWarningONDelete, MachineLibrary_RobotVarToErrorbits, MachineLibrary_RobotConfiguration, MachineLibrary_TransferFileSection, MachineLibrary_PlainMoveEntrySend, MachineLibrary_RobotVarToErrorbit, MachineLibrary_RobotVarToBusycode, MachineLibrary_RobotConfSendOrder, MachineLibrary_RobotWinCCToRobot, MachineLibrary_RobotToWinCC},
    associations={labMachines0, labMachine1, compac17, ibmWebSphereMQ19, dpBase21, links3, nodeConfig5, linkConfig7, winCCLnk9, tcpIP11, serial13, fileTransfer15, dpBaseNode23, units25, commands27, programs29, parameters31, communcationdata33, specialConfiguration35, nodeGeneral37, nodeGeneralSpecial39, terminal41, pm2PM43, remotePM45, wincc2WinCC47, accuPycDensityMeter49, rigakuXRF51, plctopmmatrix59, programs61, buttons63, unitGeneral65, unitGeneralSpecial67, unitSpecialConfiguration69, unitGeneralParameter71, addTag53, positions55, statusBits57, terminal73, hostPC75, remote77, pm2pm79, accPycMeter81, superQ83, rigakuXRF85, scanner87, translate_terminal105, outputRequest_OBLFOES107, testRequest_OBLFOES109, recalRequest_OBLFOES111, errorMessage_OBLFOES113, terminal_Config89, oblfOES_Config91, superQXRF_Config93, arlXRF_OES_Config95, host_Config97, accuPycMeter_History99, scanner_SepByComma101, pm2PM_checkAddSID103, generalSetting_ARL_XRF_OES141, ps_Process_Finished_ARL_XRF_OES143, generalParameter_SuperQXRF115, controlSamples_SuperQXRF117, communication_SuperQXRF119, checkSampleRunTime_SuperQXRF121, checkSample_OLFXRF123, checkFilling_ARL_XRF_OES125, executeFiling_ARL_XRF_OES127, checkReqPrepUnit_ARL_XRF_OES129, exePrepUnit_ARL_XRF_OES131, checkAskPrepUnit_ARL_XRF_OES133, exeAskPrepUnit_ARL_XRF_OES135, disableSCT_ARL_XRF_OES137, settings_ARL_XRF_OES139, condition163, file_Sample_ARL_XRF_OES145, report_Host147, ws_Update_Host149, moved_Host151, insert_Host153, remove_Host155, condition158, condition160, sampleTpyeParameters193, condition166, condition169, condition172, condition175, condition178, condition181, condition184, condition187, condition190, entry199, type201, keyword203, checkSampleConfig_SuperQXRF195, historyConfig_AccPyc197, position213, statusBit215, field205, id207, options209, button211, unitProgram221, parameters223, command217, program219, paramPrint227, transfer229, parameter225, robotVarToBusyCodes239, robotConfSendOrders241, robotWinCCToRobots243, robotToWinCCs245, robotWarningONDelete247, robotVarToErrorBits249, plainMove231, robotConfiguration233, transferFileSection235, plainmoveEntrySend237, robotVarToErrorbit259, robotVarToBusycode251, robotConfSendOrder253, robotWinCCToRobot255, robotToWinCC257},
    generalizations={},
    metadata=None
)
