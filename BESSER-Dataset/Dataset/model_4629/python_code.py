...
class model_Position:
    ...
    def __init__(self, x: float, y: float, model_Position18: "model_Line" = None, model_Position: "model_XYChild" = None):
        self.x = x
        self.y = y
...
class model_Dimension:
    ...
    def __init__(self, width: float, height: float, model_Dimension: "model_Symbol" = None, model_Dimension20: "model_Figure" = None, model_Dimension14: "model_XYChild" = None):
        self.width = width
        self.height = height
...
class model_Primitive(ABC):
    ...
    def __init__(self, name: str, model_Primitive37: "model_StackContainer" = None, model_Primitive29: "model_FigureContainer" = None, model_Primitive32: "model_Connection" = None, model_Primitive35: "model_Connection" = None, model_Primitive: "model_Symbol" = None, model_Primitive10: "model_Child" = None):
        self.name = name
...
class model_Symbol:
    ...
    def __init__(self, onInit: str, onDispose: str, onUpdate: str, scriptModules: str, backgroundColor: str, model_Symbol: "model_Primitive" = None, model_Symbol2: set["model_StringToStringMap"] = None, model_Symbol4: "model_Cursor" = None, model_Symbol6: "model_Dimension" = None, model_Symbol8: set["model_Connection"] = None):
        self.onInit = onInit
