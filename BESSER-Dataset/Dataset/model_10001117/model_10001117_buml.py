...
Restaurant.attributes={Restaurant_Menu, Restaurant_Name, Restaurant_Address, Restaurant_PostCode}
...
Food.attributes={Food_Vegetarian, Food_Price, Food_Calories}
...
Order.attributes={Order_Restaurant, Order_Customer, Order_ItemList}
...
Customer.attributes={Customer_CreditCard, Customer_FullName, Customer_Address, Customer_Cellphone, Customer_PostCode}
...
domain_model = DomainModel(
    name="_878816e5_23ce_4eae_870f_76c3221061de",
    types={Restaurant, MenuItem, FoodPackage, FoodItem, Food, Order, Customer, RestaurantController, OrderController},
    associations={RestaurantManager_Restaurant, OrderController_Order, MenuItem_FoodItem, MenuItem_FoodPackage, FoodItem_Food, FoodPackage_Food, Restaurant_MenuItem, Order_MenuItem, Order_Restaurant, Order_Customer},
    generalizations={},
    metadata=None
)
