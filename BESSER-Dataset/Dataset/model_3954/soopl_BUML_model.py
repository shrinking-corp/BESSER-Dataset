...
# Classes
soopl_NamedElement = Class(name="soopl_NamedElement", is_abstract=True)
soopl_Package = Class(name="soopl_Package")
NamedElement = Class(name="NamedElement")
soopl_Class = Class(name="soopl_Class")
soopl_Method = Class(name="soopl_Method")
soopl_SimpleTypeProperty = Class(name="soopl_SimpleTypeProperty")
Property_ = Class(name="Property")
soopl_ComplexTypeProperty = Class(name="soopl_ComplexTypeProperty")
soopl_Parameter = Class(name="soopl_Parameter")
soopl_TransitionMethod = Class(name="soopl_TransitionMethod")
Method_ = Class(name="Method")
soopl_Transition = Class(name="soopl_Transition")
soopl_Action = Class(name="soopl_Action", is_abstract=True)
soopl_Guard = Class(name="soopl_Guard", is_abstract=True)
soopl_Property = Class(name="soopl_Property", is_abstract=True)
soopl_StatefulClass = Class(name="soopl_StatefulClass")
Class_ = Class(name="Class")
soopl_StateImplementationClass = Class(name="soopl_StateImplementationClass")
soopl_StateClass = Class(name="soopl_StateClass")
soopl_CallMethodAction = Class(name="soopl_CallMethodAction", is_abstract=True)
Action = Class(name="Action")
soopl_ParameterBinding = Class(name="soopl_ParameterBinding")
soopl_IsInStateCondition = Class(name="soopl_IsInStateCondition", is_abstract=True)
Guard = Class(name="Guard")
soopl_PropertyIsInState = Class(name="soopl_PropertyIsInState")
IsInStateCondition = Class(name="IsInStateCondition")
soopl_SimpleTypeParameter = Class(name="soopl_SimpleTypeParameter")
Parameter_ = Class(name="Parameter")
soopl_ComplexTypeParameter = Class(name="soopl_ComplexTypeParameter")
soopl_CallMethodOfParameter = Class(name="soopl_CallMethodOfParameter")
soopl_AssignProperty = Class(name="soopl_AssignProperty")
soopl_ParameterIsInState = Class(name="soopl_ParameterIsInState")
soopl_CallMethodOfProperty = Class(name="soopl_CallMethodOfProperty")
...
soopl_Property.attributes={soopl_Property_lowerBound, soopl_Property_upperBound, soopl_Property_multiValued}
...
domain_model = DomainModel(
    name="soopl",
    types={soopl_NamedElement, soopl_Package, NamedElement, soopl_Class, soopl_Method, soopl_SimpleTypeProperty, Property_, soopl_ComplexTypeProperty, soopl_Parameter, soopl_TransitionMethod, Method_, soopl_Transition, soopl_Action, soopl_Guard, soopl_Property, soopl_StatefulClass, Class_, soopl_StateImplementationClass, soopl_StateClass, soopl_CallMethodAction, Action, soopl_ParameterBinding, soopl_IsInStateCondition, Guard, soopl_PropertyIsInState, IsInStateCondition, soopl_SimpleTypeParameter, Parameter_, soopl_ComplexTypeParameter, soopl_CallMethodOfParameter, soopl_AssignProperty, soopl_ParameterIsInState, soopl_CallMethodOfProperty, CallMethodAction, DataType},
    associations={classes0, packages2, parentPackage4, methods6, stateClass14, statefulClass16, entryMethod19, stateClass22, type25, opposite28, parameters30, transitions32, actions33, guard35, targetState37, properties8, superClass11, initialState13, classType40, calledMethod42, parameterBinding44, structuralFeatureBinding46, parameter49, inState52, parameter60, parameter62, property64, property54, parameter56, property58},
    generalizations={gen_soopl_Package_NamedElement, gen_soopl_Class_NamedElement, gen_soopl_StateClass_Class, gen_soopl_StateImplementationClass_Class, gen_soopl_SimpleTypeProperty_Property, gen_soopl_ComplexTypeProperty_Property, gen_soopl_Method_NamedElement, gen_soopl_TransitionMethod_Method, gen_soopl_Property_NamedElement, gen_soopl_StatefulClass_Class, gen_soopl_CallMethodAction_Action, gen_soopl_IsInStateCondition_Guard, gen_soopl_Parameter_NamedElement, gen_soopl_SimpleTypeParameter_Parameter, gen_soopl_ComplexTypeParameter_Parameter, gen_soopl_CallMethodOfParameter_CallMethodAction, gen_soopl_AssignProperty_Action, gen_soopl_PropertyIsInState_IsInStateCondition, gen_soopl_ParameterIsInState_IsInStateCondition, gen_soopl_CallMethodOfProperty_CallMethodAction},
    metadata=None
)
