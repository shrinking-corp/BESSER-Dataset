...
# Classes
mdsdassignment2_Num = Class(name="mdsdassignment2_Num")
mdsdassignment2_Add = Class(name="mdsdassignment2_Add")
mdsdassignment2_MathExp = Class(name="mdsdassignment2_MathExp")
mdsdassignment2_Exp = Class(name="mdsdassignment2_Exp")
mdsdassignment2_ExpOp = Class(name="mdsdassignment2_ExpOp")
mdsdassignment2_Parenthesis = Class(name="mdsdassignment2_Parenthesis")
ExpOp = Class(name="ExpOp")
mdsdassignment2_Sub = Class(name="mdsdassignment2_Sub")
mdsdassignment2_Mult = Class(name="mdsdassignment2_Mult")
mdsdassignment2_Div = Class(name="mdsdassignment2_Div")
...
domain_model = DomainModel(
    ...
    types={mdsdassignment2_Num, mdsdassignment2_Add, mdsdassignment2_MathExp, mdsdassignment2_Exp, mdsdassignment2_ExpOp, mdsdassignment2_Parenthesis, ExpOp, mdsdassignment2_Sub, mdsdassignment2_Mult, mdsdassignment2_Div},
    associations={exp9, left11, right13, exp0, left1, operator3, right7, left16, right18, left21, right23, left26, right28},
    generalizations={gen_mdsdassignment2_Num_ExpOp, gen_mdsdassignment2_Add_ExpOp, gen_mdsdassignment2_Parenthesis_ExpOp, gen_mdsdassignment2_Sub_ExpOp, gen_mdsdassignment2_Mult_ExpOp, gen_mdsdassignment2_Div_ExpOp},
    metadata=None
)
