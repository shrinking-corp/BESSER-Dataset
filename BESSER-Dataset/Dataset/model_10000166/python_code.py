...
class OrderItem:
    ...
    def __init__(self, OrderItemID: int, OrderID: int, ItemName: str, RemaningTime: date, Completed: int, viewOrder9: "ViewOrder" = None, order10: "Order" = None, menu6: "Menu" = None):
