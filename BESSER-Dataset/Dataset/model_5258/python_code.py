...
class HTML_IMG(BODYElement):
    ...
    def __init__(self, src: str, width: str, height: str, hspace: str, ismap: str, usemap: str, border: str, alt: str, align: str, vspace: str, BODYElement: "HTML_BODY" = None):
        self.src = src
        self.width = width
        self.height = height
        self.hspace = hspace
...
class HTML_INPUT:
    ...
    def __init__(self, align: str, src: str, inputValue: str, name: str, type: str, maxlength: str, size: str, checked: str):
        self.align = align
        self.src = src
