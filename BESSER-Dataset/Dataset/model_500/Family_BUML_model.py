...
# Classes
family_Member = Class(name="family_Member", is_abstract=True)
...
domain_model = DomainModel(
    ...
    associations={familyFather0, familyMother1, familySon3, familyDaughter5, father7, mother8, son10, daughter12},
    generalizations={},
    metadata=None
)
