...
class family_Family:
    ...
    def __init__(self, lastName: str, Family4: "family_Member" = None, Family6: "family_Member" = None, familyFather: "family_Member" = None, familyMother: "family_Member" = None, familySon: set["family_Member"] = None, Family: "family_Member" = None, Family2: "family_Member" = None, familyDaughter: set["family_Member"] = None):
...
class family_Member(ABC):
    ...
    def __init__(self, name: str, son: "family_Family" = None, daughter: "family_Family" = None, Member: "family_Family" = None, Member9: "family_Family" = None, Member11: "family_Family" = None, father: "family_Family" = None, mother: "family_Family" = None, Member13: "family_Family" = None):
        self.name = name
        self.son = son
