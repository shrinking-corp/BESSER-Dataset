...
class fsm_State(NamedElement):
    ...
    def __init__(self, State: "fsm_StateMachine" = None, fsm_State: "fsm_StateMachine" = None, ownedStates: "fsm_StateMachine" = None, source: set["fsm_Transition"] = None, target: set["fsm_Transition"] = None, State12: "fsm_Transition" = None, State14: "fsm_Transition" = None, fsm_State6: "fsm_StateMachine" = None):
        self.State = State
