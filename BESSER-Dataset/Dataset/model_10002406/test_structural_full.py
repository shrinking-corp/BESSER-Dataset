...
Blue_Sea_Cruise_Booking_Cancellation_Component_strategy = st.builds(Blue_Sea_Cruise_Booking_Cancellation_Component)
...
Cruise_Booking_Email_phone_external_strategy = st.builds(Cruise_Booking_Email_phone_external)
...
Cruise_Booking_Walkin_external_strategy = st.builds(Cruise_Booking_Walkin_external)
...
mt_K7ZUTEeqqGZh46IEtXQ_external_strategy = st.builds(mt_K7ZUTEeqqGZh46IEtXQ_external)
