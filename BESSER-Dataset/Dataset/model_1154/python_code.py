...
class model_Transition:
    ...
    def __init__(self, name: str, outgoing: "model_State" = None, model_Transition: "model_FSM" = None, Transition: "model_State" = None, Transition5: "model_State" = None, incoming: "model_State" = None):
        self.name = name
...
class model_State:
    ...
    def __init__(self, name: str, model_State: "model_FSM" = None, to: set["model_Transition"] = None, from_: set["model_Transition"] = None, State: "model_Transition" = None, State8: "model_Transition" = None):
        self.name = name
    ...
    def from_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_model_State__from_", None)
