...
# Classes
EvoCompany_Topic = Class(name="EvoCompany_Topic")
EvoCompany_Category = Class(name="EvoCompany_Category")
EvoCompany_Person = Class(name="EvoCompany_Person", is_abstract=True)
EvoCompany_Project = Class(name="EvoCompany_Project")
EvoCompany_Unit = Class(name="EvoCompany_Unit")
EvoCompany_Organisation = Class(name="EvoCompany_Organisation")
EvoCompany_Division = Class(name="EvoCompany_Division", is_abstract=True)
EvoCompany_CompanyModel = Class(name="EvoCompany_CompanyModel")
EvoCompany_Employee = Class(name="EvoCompany_Employee")
Person = Class(name="Person")
EvoCompany_Client = Class(name="EvoCompany_Client")
Division = Class(name="Division")
EvoCompany_ServiceLine = Class(name="EvoCompany_ServiceLine")
...
EvoCompany_Project.attributes={EvoCompany_Project_name, EvoCompany_Project_budget}
...
EvoCompany_Organisation.attributes={EvoCompany_Organisation_city, EvoCompany_Organisation_name, EvoCompany_Organisation_completeAddress}
...
domain_model = DomainModel(
    name="EvoCompany",
    types={EvoCompany_Topic, EvoCompany_Category, EvoCompany_Person, EvoCompany_Project, EvoCompany_Unit, EvoCompany_Organisation, EvoCompany_Division, EvoCompany_CompanyModel, EvoCompany_Employee, Person, EvoCompany_Client, Division, EvoCompany_ServiceLine},
    associations={related10, assignedTo0, employed1, persons3, projects5, lines8, topics12, category13, company14, categories16, topics18, division21},
