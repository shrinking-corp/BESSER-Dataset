...
class EvoCompany_Division(ABC):
    ...
    def __init__(self, name: str, EvoCompany_Division: "EvoCompany_Organisation" = None, EvoCompany_Division23: "EvoCompany_CompanyModel" = None):
        self.name = name
...
class EvoCompany_Organisation:
    ...
    def __init__(self, name: str, city: str, completeAddress: str, EvoCompany_Organisation: set["EvoCompany_Person"] = None, EvoCompany_Organisation6: set["EvoCompany_Project"] = None, EvoCompany_Organisation9: set["EvoCompany_Division"] = None, EvoCompany_Organisation15: "EvoCompany_CompanyModel" = None):
        self.name = name
        self.city = city
...
class EvoCompany_Project:
    ...
    def __init__(self, name: str, budget: int, EvoCompany_Project11: "EvoCompany_Topic" = None, EvoCompany_Project: "EvoCompany_Person" = None, EvoCompany_Project7: "EvoCompany_Organisation" = None):
        self.name = name
        self.budget = budget
...
class EvoCompany_Category:
    ...
    def __init__(self, name: str, category: set["EvoCompany_Topic"] = None, Category: "EvoCompany_Topic" = None, EvoCompany_Category: "EvoCompany_CompanyModel" = None):
        self.name = name
...
class EvoCompany_Topic:
    ...
    def __init__(self, id: str, EvoCompany_Topic: "EvoCompany_Project" = None, Topic: "EvoCompany_Category" = None, topics: "EvoCompany_Category" = None, EvoCompany_Topic20: "EvoCompany_CompanyModel" = None):
        self.id = id
