...
family_person.attributes={family_person_CPR, family_person_age, family_person_name}
...
domain_model = DomainModel(
    name="family",
    types={family_person, family_university, family_course, family_Family},
    associations={enrollment8, courses10, students12, members16, Members17, spouse1, parent3, children6},
    generalizations={},
    metadata=None
)
