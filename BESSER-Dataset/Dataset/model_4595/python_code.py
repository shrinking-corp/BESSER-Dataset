...
class dot_Attribute:
    ...
    def __init__(self, weight: int, dot_Attribute: "dot_UnDirectedEdge" = None, dot_Attribute18: "dot_DirectedEdge" = None):
        self.weight = weight
...
class dot_Node:
    ...
    def __init__(self, name: str, dot_Node: "dot_UnDirectedEdge" = None, dot_Node7: "dot_UnDirectedEdge" = None, dot_Node12: "dot_DirectedEdge" = None, dot_Node15: "dot_DirectedEdge" = None):
        self.name = name
