...
# Classes
dot_GraphModel = Class(name="dot_GraphModel")
dot_Graph = Class(name="dot_Graph")
dot_UndirectedGraph = Class(name="dot_UndirectedGraph")
Graph = Class(name="Graph")
dot_UnDirectedEdge = Class(name="dot_UnDirectedEdge")
dot_DirectedGraph = Class(name="dot_DirectedGraph")
dot_DirectedEdge = Class(name="dot_DirectedEdge")
...
domain_model = DomainModel(
    ...
    associations={graph0, edge1, edge2, src3, tgt5, attributes8, src10, tgt13, attributes16},
