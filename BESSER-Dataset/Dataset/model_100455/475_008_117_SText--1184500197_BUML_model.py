...
stext_Guard = Class(name="stext_Guard")
...
event11: BinaryAssociation = BinaryAssociation(
    name="event11",
    ends={
        Property(name="stext_Expression12", type=stext_RegularEventSpec, multiplicity=Multiplicity(1, 1)),
...
value13: BinaryAssociation = BinaryAssociation(
    name="value13",
    ends={
        Property(name="stext_Expression14", type=stext_TimeEventSpec, multiplicity=Multiplicity(1, 1)),
...
expression9: BinaryAssociation = BinaryAssociation(
    name="expression9",
    ends={
        Property(name="stext_Expression10", type=stext_Guard, multiplicity=Multiplicity(1, 1)),
...
value23: BinaryAssociation = BinaryAssociation(
    name="value23",
    ends={
        Property(name="stext_Expression25", type=stext_EventRaisingExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_EventRaisingExpression24", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
varRef26: BinaryAssociation = BinaryAssociation(
    name="varRef26",
    ends={
        Property(name="stext_Expression27", type=stext_AssignmentExpression, multiplicity=Multiplicity(1, 1)),
...
expression28: BinaryAssociation = BinaryAssociation(
    name="expression28",
    ends={
        Property(name="stext_Expression30", type=stext_AssignmentExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_AssignmentExpression29", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
condition31: BinaryAssociation = BinaryAssociation(
    name="condition31",
    ends={
        Property(name="stext_Expression32", type=stext_ConditionalExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_ConditionalExpression", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
trueCase33: BinaryAssociation = BinaryAssociation(
    name="trueCase33",
    ends={
        Property(name="stext_Expression35", type=stext_ConditionalExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_ConditionalExpression34", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
falseCase36: BinaryAssociation = BinaryAssociation(
    name="falseCase36",
    ends={
        Property(name="stext_Expression38", type=stext_ConditionalExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_ConditionalExpression37", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
...
guard16: BinaryAssociation = BinaryAssociation(
    name="guard16",
    ends={
        Property(name="stext_Guard18", type=stext_ReactionTrigger, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_ReactionTrigger17", type=stext_Guard, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
actions19: BinaryAssociation = BinaryAssociation(
    name="actions19",
    ends={
        Property(name="stext_Expression20", type=stext_ReactionEffect, multiplicity=Multiplicity(1, 1)),
...
event21: BinaryAssociation = BinaryAssociation(
    name="event21",
    ends={
        Property(name="stext_Expression22", type=stext_EventRaisingExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_EventRaisingExpression", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
rightOperand53: BinaryAssociation = BinaryAssociation(
    name="rightOperand53",
    ends={
        Property(name="stext_Expression55", type=stext_BitwiseXorExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_BitwiseXorExpression54", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
leftOperand56: BinaryAssociation = BinaryAssociation(
    name="leftOperand56",
    ends={
        Property(name="stext_Expression57", type=stext_BitwiseOrExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_BitwiseOrExpression", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
rightOperand58: BinaryAssociation = BinaryAssociation(
    name="rightOperand58",
    ends={
        Property(name="stext_Expression60", type=stext_BitwiseOrExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_BitwiseOrExpression59", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
leftOperand61: BinaryAssociation = BinaryAssociation(
    name="leftOperand61",
    ends={
        Property(name="stext_Expression62", type=stext_BitwiseAndExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_BitwiseAndExpression", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
rightOperand63: BinaryAssociation = BinaryAssociation(
    name="rightOperand63",
    ends={
        Property(name="stext_Expression65", type=stext_BitwiseAndExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_BitwiseAndExpression64", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
leftOperand66: BinaryAssociation = BinaryAssociation(
    name="leftOperand66",
    ends={
        Property(name="stext_Expression67", type=stext_LogicalRelationExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_LogicalRelationExpression", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
leftOperand39: BinaryAssociation = BinaryAssociation(
    name="leftOperand39",
    ends={
        Property(name="stext_Expression40", type=stext_LogicalOrExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_LogicalOrExpression", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
rightOperand41: BinaryAssociation = BinaryAssociation(
    name="rightOperand41",
    ends={
        Property(name="stext_Expression43", type=stext_LogicalOrExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_LogicalOrExpression42", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
leftOperand44: BinaryAssociation = BinaryAssociation(
    name="leftOperand44",
    ends={
        Property(name="stext_Expression45", type=stext_LogicalAndExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_LogicalAndExpression", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
rightOperand46: BinaryAssociation = BinaryAssociation(
    name="rightOperand46",
    ends={
        Property(name="stext_Expression48", type=stext_LogicalAndExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_LogicalAndExpression47", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
operand49: BinaryAssociation = BinaryAssociation(
    name="operand49",
    ends={
        Property(name="stext_Expression50", type=stext_LogicalNotExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_LogicalNotExpression", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
leftOperand51: BinaryAssociation = BinaryAssociation(
    name="leftOperand51",
    ends={
        Property(name="stext_Expression52", type=stext_BitwiseXorExpression, multiplicity=Multiplicity(1, 1)),
...
leftOperand81: BinaryAssociation = BinaryAssociation(
    name="leftOperand81",
    ends={
        Property(name="stext_Expression82", type=stext_NumericalMultiplyDivideExpression, multiplicity=Multiplicity(1, 1)),
...
rightOperand83: BinaryAssociation = BinaryAssociation(
    name="rightOperand83",
    ends={
        Property(name="stext_Expression85", type=stext_NumericalMultiplyDivideExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_NumericalMultiplyDivideExpression84", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
operand86: BinaryAssociation = BinaryAssociation(
    name="operand86",
    ends={
        Property(name="stext_Expression87", type=stext_NumericalUnaryExpression, multiplicity=Multiplicity(1, 1)),
...
rightOperand68: BinaryAssociation = BinaryAssociation(
    name="rightOperand68",
    ends={
        Property(name="stext_Expression70", type=stext_LogicalRelationExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_LogicalRelationExpression69", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
leftOperand71: BinaryAssociation = BinaryAssociation(
    name="leftOperand71",
    ends={
        Property(name="stext_Expression72", type=stext_ShiftExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_ShiftExpression", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
rightOperand73: BinaryAssociation = BinaryAssociation(
    name="rightOperand73",
    ends={
        Property(name="stext_Expression75", type=stext_ShiftExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_ShiftExpression74", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
leftOperand76: BinaryAssociation = BinaryAssociation(
    name="leftOperand76",
    ends={
        Property(name="stext_Expression77", type=stext_NumericalAddSubtractExpression, multiplicity=Multiplicity(1, 1)),
...
rightOperand78: BinaryAssociation = BinaryAssociation(
    name="rightOperand78",
    ends={
        Property(name="stext_Expression80", type=stext_NumericalAddSubtractExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_NumericalAddSubtractExpression79", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
value101: BinaryAssociation = BinaryAssociation(
    name="value101",
    ends={
        Property(name="stext_Expression102", type=stext_EventValueReferenceExpression, multiplicity=Multiplicity(1, 1)),
...
expression104: BinaryAssociation = BinaryAssociation(
    name="expression104",
    ends={
        Property(name="stext_Expression105", type=stext_ParenthesizedExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_ParenthesizedExpression", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
owner89: BinaryAssociation = BinaryAssociation(
    name="owner89",
    ends={
        Property(name="stext_Expression90", type=stext_FeatureCall, multiplicity=Multiplicity(1, 1)),
...
feature91: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="stext_FeatureCall92", type=stext_EObject, multiplicity=Multiplicity(0, 1))
    }
)
args93: BinaryAssociation = BinaryAssociation(
    name="args93",
    ends={
        Property(name="stext_Expression95", type=stext_FeatureCall, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_FeatureCall94", type=stext_Expression, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
reference96: BinaryAssociation = BinaryAssociation(
    name="reference96",
    ends={
        Property(name="stext_EObject97", type=stext_ElementReferenceExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_ElementReferenceExpression", type=stext_EObject, multiplicity=Multiplicity(0, 1))
    }
)
args98: BinaryAssociation = BinaryAssociation(
    name="args98",
    ends={
        Property(name="stext_Expression100", type=stext_ElementReferenceExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_ElementReferenceExpression99", type=stext_Expression, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
domain_model = DomainModel(
    name="stext",
    types={ScopedElement, stext_Scope, stext_TransitionReaction, stext_StatechartScope, Scope, stext_InterfaceScope, StatechartScope, NamedElement, stext_InternalScope, stext_EventDefinition, Event, stext_VariableDefinition, Variable, Property_, stext_Root, stext_DefRoot, stext_StatechartRoot, DefRoot, stext_StatechartSpecification, stext_StateRoot, stext_StateSpecification, stext_TransitionRoot, stext_TransitionSpecification, stext_RegularEventSpec, EventSpec, stext_TimeEventSpec, stext_BuiltinEventSpec, stext_EntryEvent, BuiltinEventSpec, stext_ExitEvent, stext_AlwaysEvent, Statement, stext_Literal, stext_BoolLiteral, Literal, stext_Expression, stext_OperationDefinition, Declaration, Operation, stext_LocalReaction, Reaction, stext_Guard, stext_EntryPointSpec, ReactionProperty, stext_ExitPointSpec, stext_EventSpec, stext_IntLiteral, stext_RealLiteral, stext_HexLiteral, stext_StringLiteral, stext_AssignmentExpression, stext_ConditionalExpression, stext_LogicalOrExpression, stext_SimpleScope, stext_ReactionTrigger, Trigger, stext_DefaultTrigger, stext_ReactionEffect, Effect, stext_EventRaisingExpression, Expression, stext_BitwiseOrExpression, stext_BitwiseAndExpression, stext_LogicalRelationExpression, stext_LogicalAndExpression, stext_LogicalNotExpression, stext_BitwiseXorExpression, stext_NumericalMultiplyDivideExpression, stext_NumericalUnaryExpression, stext_PrimitiveValueExpression, stext_FeatureCall, stext_ShiftExpression, stext_NumericalAddSubtractExpression, stext_ActiveStateReferenceExpression, stext_State, stext_ParenthesizedExpression, stext_EObject, stext_ElementReferenceExpression, stext_EventValueReferenceExpression, Direction, TimeEventType, ShiftOperator, AdditiveOperator, MultiplicativeOperator, UnaryOperator, RelationalOperator, TimeUnit, AssignmentOperator},
    associations={scope4, reaction6, roots0, def_1, def_2, def_3, event11, value13, initialValue8, expression9, value23, varRef26, expression28, condition31, trueCase33, falseCase36, triggers15, guard16, actions19, event21, rightOperand53, leftOperand56, rightOperand58, leftOperand61, rightOperand63, leftOperand66, leftOperand39, rightOperand41, leftOperand44, rightOperand46, operand49, leftOperand51, leftOperand81, rightOperand83, operand86, value88, rightOperand68, leftOperand71, rightOperand73, leftOperand76, rightOperand78, value101, value103, expression104, owner89, feature91, args93, reference96, args98},
    generalizations={gen_stext_StatechartSpecification_ScopedElement, gen_stext_StatechartScope_Scope, gen_stext_InterfaceScope_StatechartScope, gen_stext_InterfaceScope_NamedElement, gen_stext_InternalScope_StatechartScope, gen_stext_EventDefinition_Event, gen_stext_EventDefinition_Event, gen_stext_VariableDefinition_Variable, gen_stext_VariableDefinition_Property, gen_stext_StatechartRoot_DefRoot, gen_stext_StateRoot_DefRoot, gen_stext_TransitionRoot_DefRoot, gen_stext_RegularEventSpec_EventSpec, gen_stext_TimeEventSpec_EventSpec, gen_stext_BuiltinEventSpec_EventSpec, gen_stext_EntryEvent_BuiltinEventSpec, gen_stext_ExitEvent_BuiltinEventSpec, gen_stext_AlwaysEvent_BuiltinEventSpec, gen_stext_Expression_Statement, gen_stext_BoolLiteral_Literal, gen_stext_OperationDefinition_Declaration, gen_stext_OperationDefinition_Operation, gen_stext_LocalReaction_Declaration, gen_stext_LocalReaction_Reaction, gen_stext_TransitionReaction_Reaction, gen_stext_EntryPointSpec_ReactionProperty, gen_stext_ExitPointSpec_ReactionProperty, gen_stext_IntLiteral_Literal, gen_stext_RealLiteral_Literal, gen_stext_HexLiteral_Literal, gen_stext_StringLiteral_Literal, gen_stext_AssignmentExpression_Expression, gen_stext_ConditionalExpression_Expression, gen_stext_LogicalOrExpression_Expression, gen_stext_SimpleScope_Scope, gen_stext_ReactionTrigger_Trigger, gen_stext_DefaultTrigger_Trigger, gen_stext_ReactionEffect_Effect, gen_stext_EventRaisingExpression_Expression, gen_stext_BitwiseOrExpression_Expression, gen_stext_BitwiseAndExpression_Expression, gen_stext_LogicalRelationExpression_Expression, gen_stext_LogicalAndExpression_Expression, gen_stext_LogicalNotExpression_Expression, gen_stext_BitwiseXorExpression_Expression, gen_stext_NumericalMultiplyDivideExpression_Expression, gen_stext_NumericalUnaryExpression_Expression, gen_stext_PrimitiveValueExpression_Expression, gen_stext_FeatureCall_Expression, gen_stext_ShiftExpression_Expression, gen_stext_NumericalAddSubtractExpression_Expression, gen_stext_ActiveStateReferenceExpression_Expression, gen_stext_ParenthesizedExpression_Expression, gen_stext_ElementReferenceExpression_Expression, gen_stext_EventValueReferenceExpression_Expression},
    metadata=None
)
