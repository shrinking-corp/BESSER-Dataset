...
# Classes
sparrow_Process = Class(name="sparrow_Process")
sparrow_Expression = Class(name="sparrow_Expression")
sparrow_FBCLead = Class(name="sparrow_FBCLead")
Action = Class(name="Action")
sparrow_Dropfile = Class(name="sparrow_Dropfile")
sparrow_Try = Class(name="sparrow_Try")
sparrow_Catch = Class(name="sparrow_Catch")
sparrow_Finally = Class(name="sparrow_Finally")
sparrow_Action = Class(name="sparrow_Action")
sparrow_RestPart = Class(name="sparrow_RestPart")
sparrow_TrelloGET = Class(name="sparrow_TrelloGET")
sparrow_TrelloPUT = Class(name="sparrow_TrelloPUT")
sparrow_Doozle = Class(name="sparrow_Doozle")
sparrow_Rest = Class(name="sparrow_Rest")
sparrow_SlackPUT = Class(name="sparrow_SlackPUT")
sparrow_GooglecalPUT = Class(name="sparrow_GooglecalPUT")
sparrow_Copydata = Class(name="sparrow_Copydata")
sparrow_WriteCsv = Class(name="sparrow_WriteCsv")
sparrow_LoadCsv = Class(name="sparrow_LoadCsv")
sparrow_Fetch = Class(name="sparrow_Fetch")
sparrow_Callprocess = Class(name="sparrow_Callprocess")
sparrow_Updatedaudit = Class(name="sparrow_Updatedaudit")
sparrow_Sms = Class(name="sparrow_Sms")
sparrow_Transform = Class(name="sparrow_Transform")
...
sparrow_Expression.attributes={sparrow_Expression_operator, sparrow_Expression_lhs, sparrow_Expression_rhs}
...
sparrow_FBCLead.attributes={sparrow_FBCLead_value, sparrow_FBCLead_appSecret, sparrow_FBCLead_campaignId, sparrow_FBCLead_accessToken, sparrow_FBCLead_target, sparrow_FBCLead_accountId}
...
sparrow_TrelloGET.attributes={sparrow_TrelloGET_authtoken, sparrow_TrelloGET_value, sparrow_TrelloGET_target, sparrow_TrelloGET_useraccount, sparrow_TrelloGET_board, sparrow_TrelloGET_key}
...
sparrow_TrelloPUT.attributes={sparrow_TrelloPUT_list, sparrow_TrelloPUT_key, sparrow_TrelloPUT_useraccount, sparrow_TrelloPUT_source, sparrow_TrelloPUT_value, sparrow_TrelloPUT_authtoken}
...
sparrow_Doozle.attributes={sparrow_Doozle_value, sparrow_Doozle_target, sparrow_Doozle_on}
...
sparrow_Rest.attributes={sparrow_Rest_urldata, sparrow_Rest_parentName, sparrow_Rest_method, sparrow_Rest_ackdatato, sparrow_Rest_resourcedatafrom, sparrow_Rest_ackdata, sparrow_Rest_parentdata, sparrow_Rest_headerdata, sparrow_Rest_headerdatafrom, sparrow_Rest_postdatafrom, sparrow_Rest_url, sparrow_Rest_authtoken}
...
sparrow_SlackPUT.attributes={sparrow_SlackPUT_value, sparrow_SlackPUT_team, sparrow_SlackPUT_channel}
...
sparrow_GooglecalPUT.attributes={sparrow_GooglecalPUT_value, sparrow_GooglecalPUT_authstore, sparrow_GooglecalPUT_useraccount, sparrow_GooglecalPUT_source, sparrow_GooglecalPUT_key}
...
sparrow_Copydata.attributes={sparrow_Copydata_to, sparrow_Copydata_value, sparrow_Copydata_source}
...
sparrow_WriteCsv.attributes={sparrow_WriteCsv_source, sparrow_WriteCsv_delim, sparrow_WriteCsv_value, sparrow_WriteCsv_to}
...
sparrow_LoadCsv.attributes={sparrow_LoadCsv_delim, sparrow_LoadCsv_value, sparrow_LoadCsv_source, sparrow_LoadCsv_to}
...
sparrow_Fetch.attributes={sparrow_Fetch_value, sparrow_Fetch_source}
...
sparrow_Callprocess.attributes={sparrow_Callprocess_target, sparrow_Callprocess_datasource, sparrow_Callprocess_source, sparrow_Callprocess_value}
...
sparrow_Sms.attributes={sparrow_Sms_value, sparrow_Sms_target}
...
sparrow_Transform.attributes={sparrow_Transform_on, sparrow_Transform_value}
...
domain_model = DomainModel(
    name="sparrow",
    types={sparrow_Process, sparrow_Expression, sparrow_FBCLead, Action, sparrow_Dropfile, sparrow_Try, sparrow_Catch, sparrow_Finally, sparrow_Action, sparrow_RestPart, sparrow_TrelloGET, sparrow_TrelloPUT, sparrow_Doozle, sparrow_Rest, sparrow_SlackPUT, sparrow_GooglecalPUT, sparrow_Copydata, sparrow_WriteCsv, sparrow_LoadCsv, sparrow_Fetch, sparrow_Callprocess, sparrow_Updatedaudit, sparrow_Sms, sparrow_Transform},
    associations={action5, action7, action10, condition13, try_0, catch1, finally_3, parts15},
    generalizations={gen_sparrow_FBCLead_Action, gen_sparrow_Dropfile_Action, gen_sparrow_TrelloGET_Action, gen_sparrow_TrelloPUT_Action, gen_sparrow_Doozle_Action, gen_sparrow_Rest_Action, gen_sparrow_SlackPUT_Action, gen_sparrow_GooglecalPUT_Action, gen_sparrow_Copydata_Action, gen_sparrow_WriteCsv_Action, gen_sparrow_LoadCsv_Action, gen_sparrow_Fetch_Action, gen_sparrow_Callprocess_Action, gen_sparrow_Updatedaudit_Action, gen_sparrow_Sms_Action, gen_sparrow_Transform_Action},
    metadata=None
)
