...
class sparrow_Finally:
    ...
    def __init__(self, name: str, sparrow_Finally8: set["sparrow_Action"] = None, sparrow_Finally: "sparrow_Process" = None):
        self.name = name
...
class sparrow_Catch:
    ...
    def __init__(self, name: str, sparrow_Catch11: set["sparrow_Action"] = None, sparrow_Catch: "sparrow_Process" = None):
        self.name = name
...
class sparrow_Try:
    ...
    def __init__(self, name: str, sparrow_Try6: set["sparrow_Action"] = None, sparrow_Try: "sparrow_Process" = None):
        self.name = name
...
class sparrow_Sms(Action):
    ...
    def __init__(self, value: str, target: str):
        self.value = value
        self.target = target
...
class sparrow_Rest(Action):
    ...
    def __init__(self, postdatafrom: str, parentName: str, parentdata: str, ackdatato: str, ackdata: str, authtoken: str, url: str, method: str, resourcedatafrom: str, urldata: str, headerdatafrom: str, headerdata: str, sparrow_Rest: set["sparrow_RestPart"] = None):
...
class sparrow_Updatedaudit(Action):
    ...
    def __init__(self, logsink: str, value: str):
