...
class majordomo_NumberSensor(FloatSensor, RoomMountable):
    ...
    pass
class majordomo_SwitchSensor(BooleanSensor, RoomMountable):
...
class HouseMountable:
    ...
    pass
class majordomo_LampActor(FloatActor, RoomMountable, HouseMountable):
...
class majordomo_ClockSensor(FloatSensor, HouseMountable):
    ...
    pass
class majordomo_BoilerActor(BooleanActor, HouseMountable):

    pass
class majordomo_LightSensor(FloatSensor, RoomMountable, HouseMountable):
