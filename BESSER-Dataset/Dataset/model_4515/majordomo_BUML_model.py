...
# Classes
majordomo_Majordomo = Class(name="majordomo_Majordomo")
majordomo_House = Class(name="majordomo_House")
majordomo_Rule = Class(name="majordomo_Rule")
majordomo_Statement = Class(name="majordomo_Statement", is_abstract=True)
majordomo_Room = Class(name="majordomo_Room")
majordomo_Program = Class(name="majordomo_Program")
majordomo_Action = Class(name="majordomo_Action", is_abstract=True)
Extendable = Class(name="Extendable")
majordomo_Extendable = Class(name="majordomo_Extendable", is_abstract=True)
majordomo_Sensor = Class(name="majordomo_Sensor", is_abstract=True)
majordomo_Actor = Class(name="majordomo_Actor", is_abstract=True)
Extension = Class(name="Extension")
majordomo_RollerActor = Class(name="majordomo_RollerActor")
BooleanActor = Class(name="BooleanActor")
majordomo_RoofWindowActor = Class(name="majordomo_RoofWindowActor")
majordomo_BoilerActor = Class(name="majordomo_BoilerActor")
majordomo_RadiatorActor = Class(name="majordomo_RadiatorActor")
majordomo_RoomMountable = Class(name="majordomo_RoomMountable", is_abstract=True)
majordomo_HouseMountable = Class(name="majordomo_HouseMountable", is_abstract=True)
majordomo_BooleanSensor = Class(name="majordomo_BooleanSensor", is_abstract=True)
Sensor = Class(name="Sensor")
majordomo_FloatSensor = Class(name="majordomo_FloatSensor", is_abstract=True)
majordomo_Extension = Class(name="majordomo_Extension", is_abstract=True)
majordomo_LightSensor = Class(name="majordomo_LightSensor")
HouseMountable = Class(name="HouseMountable")
RoomMountable = Class(name="RoomMountable")
FloatSensor = Class(name="FloatSensor")
majordomo_TemperatureSensor = Class(name="majordomo_TemperatureSensor")
majordomo_RainSensor = Class(name="majordomo_RainSensor")
BooleanSensor = Class(name="BooleanSensor")
majordomo_SwitchSensor = Class(name="majordomo_SwitchSensor")
majordomo_NumberSensor = Class(name="majordomo_NumberSensor")
majordomo_ClockSensor = Class(name="majordomo_ClockSensor")
majordomo_LampActor = Class(name="majordomo_LampActor")
FloatActor = Class(name="FloatActor")
majordomo_CoffeeActor = Class(name="majordomo_CoffeeActor")
majordomo_BinaryOperation = Class(name="majordomo_BinaryOperation", is_abstract=True)
Statement = Class(name="Statement")
majordomo_NotOperation = Class(name="majordomo_NotOperation")
majordomo_CompareOperation = Class(name="majordomo_CompareOperation")
majordomo_BooleanActor = Class(name="majordomo_BooleanActor", is_abstract=True)
Actor = Class(name="Actor")
majordomo_FloatActor = Class(name="majordomo_FloatActor", is_abstract=True)
majordomo_FloatAction = Class(name="majordomo_FloatAction")
Action = Class(name="Action")
majordomo_BooleanAction = Class(name="majordomo_BooleanAction")
majordomo_StatementReference = Class(name="majordomo_StatementReference")
majordomo_PreparedStatement = Class(name="majordomo_PreparedStatement")
majordomo_PreparedValue = Class(name="majordomo_PreparedValue")
majordomo_PreparedActionSet = Class(name="majordomo_PreparedActionSet")
majordomo_ValueExpression = Class(name="majordomo_ValueExpression", is_abstract=True)
majordomo_BooleanSensorStatement = Class(name="majordomo_BooleanSensorStatement")
majordomo_ConstantValue = Class(name="majordomo_ConstantValue")
ValueExpression = Class(name="ValueExpression")
majordomo_SensorValue = Class(name="majordomo_SensorValue")
majordomo_ValueReference = Class(name="majordomo_ValueReference")
majordomo_ActionSetReference = Class(name="majordomo_ActionSetReference")
majordomo_BinaryAndOperation = Class(name="majordomo_BinaryAndOperation")
BinaryOperation = Class(name="BinaryOperation")
majordomo_BinaryOrOperation = Class(name="majordomo_BinaryOrOperation")
...
majordomo_BooleanActor_m_setValue: Method = Method(name="setValue", parameters={Parameter(name='majordomo_value', type=StringType)})
...
majordomo_FloatActor_m_setValue: Method = Method(name="setValue", parameters={Parameter(name='majordomo_value', type=StringType)})
...
domain_model = DomainModel(
    name="majordomo",
    types={majordomo_Majordomo, majordomo_House, majordomo_Rule, majordomo_Statement, majordomo_Room, majordomo_Program, majordomo_Action, Extendable, majordomo_Extendable, majordomo_Sensor, majordomo_Actor, Extension, majordomo_RollerActor, BooleanActor, majordomo_RoofWindowActor, majordomo_BoilerActor, majordomo_RadiatorActor, majordomo_RoomMountable, majordomo_HouseMountable, majordomo_BooleanSensor, Sensor, majordomo_FloatSensor, majordomo_Extension, majordomo_LightSensor, HouseMountable, RoomMountable, FloatSensor, majordomo_TemperatureSensor, majordomo_RainSensor, BooleanSensor, majordomo_SwitchSensor, majordomo_NumberSensor, majordomo_ClockSensor, majordomo_LampActor, FloatActor, majordomo_CoffeeActor, majordomo_BinaryOperation, Statement, majordomo_NotOperation, majordomo_CompareOperation, majordomo_BooleanActor, Actor, majordomo_FloatActor, majordomo_FloatAction, Action, majordomo_BooleanAction, majordomo_StatementReference, majordomo_PreparedStatement, majordomo_PreparedValue, majordomo_PreparedActionSet, majordomo_ValueExpression, majordomo_BooleanSensorStatement, majordomo_ConstantValue, ValueExpression, majordomo_SensorValue, majordomo_ValueReference, majordomo_ActionSetReference, majordomo_BinaryAndOperation, BinaryOperation, majordomo_BinaryOrOperation, Comparator},
    associations={ctx9, house0, statement11, rooms1, program3, actions12, sensors5, actors6, ctx8, actor15, left16, right18, statement21, actor14, ref29, constants30, preparedStatements32, preparedActionSets34, rules36, left23, right24, sensor27, sensor28, ctx49, value51, ref53, ctx39, statement40, ctx43, actions45, ref47},
    generalizations={gen_majordomo_Actor_Extension, gen_majordomo_House_Extendable, gen_majordomo_Room_Extendable, gen_majordomo_Sensor_Extension, gen_majordomo_RollerActor_RoomMountable, gen_majordomo_RollerActor_BooleanActor, gen_majordomo_RoofWindowActor_RoomMountable, gen_majordomo_RoofWindowActor_BooleanActor, gen_majordomo_BoilerActor_HouseMountable, gen_majordomo_BoilerActor_BooleanActor, gen_majordomo_RadiatorActor_RoomMountable, gen_majordomo_RadiatorActor_BooleanActor, gen_majordomo_BooleanSensor_Sensor, gen_majordomo_FloatSensor_Sensor, gen_majordomo_LightSensor_HouseMountable, gen_majordomo_LightSensor_RoomMountable, gen_majordomo_LightSensor_FloatSensor, gen_majordomo_TemperatureSensor_HouseMountable, gen_majordomo_TemperatureSensor_RoomMountable, gen_majordomo_TemperatureSensor_FloatSensor, gen_majordomo_RainSensor_HouseMountable, gen_majordomo_RainSensor_BooleanSensor, gen_majordomo_SwitchSensor_RoomMountable, gen_majordomo_SwitchSensor_BooleanSensor, gen_majordomo_NumberSensor_RoomMountable, gen_majordomo_NumberSensor_FloatSensor, gen_majordomo_ClockSensor_HouseMountable, gen_majordomo_ClockSensor_FloatSensor, gen_majordomo_LampActor_HouseMountable, gen_majordomo_LampActor_RoomMountable, gen_majordomo_LampActor_FloatActor, gen_majordomo_CoffeeActor_RoomMountable, gen_majordomo_CoffeeActor_BooleanActor, gen_majordomo_BinaryOperation_Statement, gen_majordomo_NotOperation_Statement, gen_majordomo_CompareOperation_Statement, gen_majordomo_BooleanActor_Actor, gen_majordomo_FloatActor_Actor, gen_majordomo_FloatAction_Action, gen_majordomo_BooleanAction_Action, gen_majordomo_StatementReference_Statement, gen_majordomo_BooleanSensorStatement_Statement, gen_majordomo_ConstantValue_ValueExpression, gen_majordomo_SensorValue_ValueExpression, gen_majordomo_ValueReference_ValueExpression, gen_majordomo_ActionSetReference_Action, gen_majordomo_BinaryAndOperation_BinaryOperation, gen_majordomo_BinaryOrOperation_BinaryOperation},
    metadata=None
)
