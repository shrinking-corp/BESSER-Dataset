...
def test_hyp_modify_attendance_external_is_not_abstract():
    assert not inspect.isabstract(Modify_attendance_external)


def test_hyp_modify_attendance_external_constructor_exists():
    assert callable(Modify_attendance_external.__init__)


def test_hyp_modify_attendance_external_constructor_args():
...
Modify_attendance_external_strategy = st.builds(Modify_attendance_external)
