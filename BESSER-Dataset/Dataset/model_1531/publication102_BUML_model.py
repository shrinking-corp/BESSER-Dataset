...
# Classes
publication102_Researcher = Class(name="publication102_Researcher")
publication102_Write = Class(name="publication102_Write")
publication102_Review = Class(name="publication102_Review")
publication102_Paper = Class(name="publication102_Paper")
publication102_Skill = Class(name="publication102_Skill")
publication102_Position = Class(name="publication102_Position")
publication102_Collaboration = Class(name="publication102_Collaboration")
Counted = Class(name="Counted")
publication102_ReviewNote = Class(name="publication102_ReviewNote")
Labelled = Class(name="Labelled")
publication102_PublicationStructure = Class(name="publication102_PublicationStructure")
publication102_KnowledgeManager = Class(name="publication102_KnowledgeManager")
Named = Class(name="Named")
publication102_Paragraph = Class(name="publication102_Paragraph")
publication102_PaperKeyword = Class(name="publication102_PaperKeyword")
publication102_Labelled = Class(name="publication102_Labelled", is_abstract=True)
publication102_Keyword = Class(name="publication102_Keyword")
publication102_Named = Class(name="publication102_Named", is_abstract=True)
publication102_Counted = Class(name="publication102_Counted", is_abstract=True)
...
domain_model = DomainModel(
    name="publication102",
    types={publication102_Researcher, publication102_Write, publication102_Review, publication102_Paper, publication102_Skill, publication102_Position, publication102_Collaboration, Counted, publication102_ReviewNote, Labelled, publication102_PublicationStructure, publication102_KnowledgeManager, Named, publication102_Paragraph, publication102_PaperKeyword, publication102_Labelled, publication102_Keyword, publication102_Named, publication102_Counted},
    associations={writes0, reviews1, res_papers3, skills4, res_position6, collaborations8, citedBy15, reviews17, paragraph19, reviewNote22, researchers25, papers27, knowledgeMan30, paragraphs10, authors11, keywords12, parent36, kpapers38, allkeywords40, keyword43, col_paper46, positions32},
    generalizations={gen_publication102_Paragraph_Counted, gen_publication102_Paragraph_Named, gen_publication102_ReviewNote_Named, gen_publication102_Write_Labelled, gen_publication102_Review_Labelled, gen_publication102_PublicationStructure_Named, gen_publication102_Paper_Named, gen_publication102_Position_Named, gen_publication102_Keyword_Named, gen_publication102_KnowledgeManager_Named},
    metadata=None
)
