...
Book.attributes={Book_title, Book_dueDate, Book_refNum, Book_author}
...
Magazine.attributes={Magazine_name, Magazine_location, Magazine_issueNum}
...
Patron.attributes={Patron_id, Patron_position, Patron_name}
...
Media.attributes={Media_type, Media_refNum}
...
Staff.attributes={Staff_name, Staff_id}
...
domain_model = DomainModel(
    name="_621c7123_16fa_4665_a93d_ac526eb3e1a5",
    types={Book, Magazine, Patron, Computer, Media, Staff},
    associations={Patron_Book, Patron_Magazine, Patron_Media, Patron_Computer, Staff_Book, Staff_Magazine, Staff_Media, Staff_Computer},
    generalizations={},
    metadata=None
)
