...
class Staff:
    ...
    def __init__(self, name: str, id: int, computer14: "Computer" = None, book8: "Book" = None, magazine10: "Magazine" = None, media12: "Media" = None):
        self.name = name
        self.id = id
...
class Computer:
    ...
    def __init__(self, compID: int, staff15: "Staff" = None, patron7: "Patron" = None):
        self.compID = compID
...
class Patron:
    ...
    def __init__(self, name: str, id: int, position: str, book0: "Book" = None, magazine2: "Magazine" = None, media4: "Media" = None, computer6: "Computer" = None):
        self.name = name
        self.id = id
...
class Book:
    ...
    def __init__(self, title: str, author: str, refNum: int, dueDate: str, patron1: "Patron" = None, staff9: "Staff" = None):
        self.title = title
        self.author = author
        self.refNum = refNum
