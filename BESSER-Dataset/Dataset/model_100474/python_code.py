...
class stm_GuardCall:
    ...
    def __init__(self, parameters: str, stm_GuardCall42: "stm_SelfEvent" = None, stm_GuardCall47: "stm_Guard" = None, stm_GuardCall: "stm_Transition" = None):
...
class stm_State:
    ...
    def __init__(self, name: str, stm_State8: set["stm_Command"] = None, stm_State11: "stm_Command" = None, stm_State14: "stm_Command" = None, stm_State18: "stm_State" = None, stm_State16: set["stm_State"] = None, stm_State20: set["stm_SelfEvent"] = None, stm_State22: set["stm_Transition"] = None, stm_State24: set["stm_Command"] = None, stm_State: "stm_Statemachine" = None, stm_State33: "stm_Transition" = None):
        self.name = name
...
class stm_Command:
    ...
    def __init__(self, name: str, stm_Command: "stm_Statemachine" = None, stm_Command9: "stm_State" = None, stm_Command12: "stm_State" = None, stm_Command15: "stm_State" = None, stm_Command25: "stm_State" = None, stm_Command36: "stm_Transition" = None, stm_Command45: "stm_SelfEvent" = None):
        self.name = name
...
class stm_Event:
    ...
    def __init__(self, name: str, stm_Event: "stm_Statemachine" = None, stm_Event28: "stm_Transition" = None, stm_Event39: "stm_SelfEvent" = None):
        self.name = name
