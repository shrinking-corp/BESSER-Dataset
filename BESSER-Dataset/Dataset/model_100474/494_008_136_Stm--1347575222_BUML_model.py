...
domain_model = DomainModel(
    name="stm",
    types={stm_Statemachine, stm_Event, stm_Command, stm_Guard, stm_SelfEvent, stm_Transition, stm_State, stm_Parameter, stm_GuardCall},
    associations={events0, commands1, guards3, entryActions7, doAction10, stopAction13, states17, selfEvents19, transitions21, exitActions23, event26, states5, state31, action34, event37, guard40, action43, guard46, parameters49, guard29},
    generalizations={},
    metadata=None
)
