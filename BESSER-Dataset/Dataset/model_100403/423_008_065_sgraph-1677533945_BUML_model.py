...
sgraph_State.attributes={sgraph_State_simple, sgraph_State_substatechartId, sgraph_State_orthogonal, sgraph_State_leaf, sgraph_State_subchart, sgraph_State_composite}
...
domain_model = DomainModel(
    name="sgraph",
    types={sgraph_Pseudostate, Vertex, sgraph_Vertex, NamedElement, sgraph_CompositeElement, SpecificationElement, Reaction, sgraph_Region, sgraph_Transition, sgraph_Variable, Declaration, sgraph_Event, sgraph_Choice, Pseudostate, sgraph_Statechart, ReactiveElement, ScopedElement, CompositeElement, DocumentedElement, sgraph_FinalState, RegularState, sgraph_Reaction, sgraph_Trigger, sgraph_Entry, sgraph_Exit, sgraph_ReactiveElement, sgraph_Declaration, sgraph_Scope, sgraph_Effect, sgraph_ReactionProperty, sgraph_SpecificationElement, sgraph_ScopedElement, sgraph_Synchronization, sgraph_State, sgraph_Statement, sgraph_RegularState, EntryKind, ChoiceKind},
    associations={vertices4, composite5, parentRegion0, incomingTransitions1, outgoingTransitions2, target6, source8, reactions10, localReactions11, trigger14, declarations20, events21, variables23, effect16, properties18, substatechart27, scopes25, regions28},
    generalizations={gen_sgraph_Pseudostate_Vertex, gen_sgraph_Vertex_NamedElement, gen_sgraph_Transition_SpecificationElement, gen_sgraph_Transition_Reaction, gen_sgraph_Region_NamedElement, gen_sgraph_Variable_Declaration, gen_sgraph_Event_Declaration, gen_sgraph_Choice_Pseudostate, gen_sgraph_Statechart_SpecificationElement, gen_sgraph_Statechart_ReactiveElement, gen_sgraph_Statechart_ScopedElement, gen_sgraph_Statechart_CompositeElement, gen_sgraph_Statechart_NamedElement, gen_sgraph_Transition_DocumentedElement, gen_sgraph_FinalState_RegularState, gen_sgraph_Statechart_DocumentedElement, gen_sgraph_Entry_Pseudostate, gen_sgraph_Exit_Pseudostate, gen_sgraph_Declaration_NamedElement, gen_sgraph_State_ScopedElement, gen_sgraph_State_RegularState, gen_sgraph_State_CompositeElement, gen_sgraph_State_DocumentedElement, gen_sgraph_Synchronization_Pseudostate, gen_sgraph_State_SpecificationElement, gen_sgraph_State_ReactiveElement, gen_sgraph_RegularState_Vertex},
    metadata=None
)
