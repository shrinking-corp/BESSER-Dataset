...
class SpecificationElement:
    ...
    pass
class sgraph_State(CompositeElement, ReactiveElement, DocumentedElement, RegularState, SpecificationElement, ScopedElement):
...
class sgraph_Region(NamedElement):
    ...
    def __init__(self, priority: int, parentRegion: set["sgraph_Vertex"] = None, regions: "sgraph_CompositeElement" = None, Region: "sgraph_Vertex" = None, Region29: "sgraph_CompositeElement" = None):
        self.priority = priority
...
class sgraph_Declaration(NamedElement):
    ...
    pass
class sgraph_Statechart(NamedElement, CompositeElement, ReactiveElement, DocumentedElement, SpecificationElement, ScopedElement):
