...
public class tfsmextended_TimedSystem extends NamedElement {
    ...
    public tfsmextended_TimedSystem(
        ArrayList<tfsmextended_FSMClock> tfsmextended_fsmclocks,        ArrayList<tfsmextended_FSMEvent> tfsmextended_fsmevents,        ArrayList<tfsmextended_TFSM> tfsmextended_tfsms    ) {
