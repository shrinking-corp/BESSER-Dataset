...
# Classes
employee_Company = Class(name="employee_Company")
NamedEntity = Class(name="NamedEntity")
employee_Department = Class(name="employee_Department")
employee_RichDepartment = Class(name="employee_RichDepartment")
Department = Class(name="Department")
employee_PoorDepartment = Class(name="employee_PoorDepartment")
employee_Employee = Class(name="employee_Employee")
employee_NamedEntity = Class(name="employee_NamedEntity")
...
employee_NamedEntity.attributes={employee_NamedEntity_wrongFeature, employee_NamedEntity_name}
...
domain_model = DomainModel(
    name="employee",
    types={employee_Company, NamedEntity, employee_Department, employee_RichDepartment, Department, employee_PoorDepartment, employee_Employee, employee_NamedEntity},
    associations={departments0, employees1},
    generalizations={gen_employee_Company_NamedEntity, gen_employee_RichDepartment_Department, gen_employee_PoorDepartment_Department, gen_employee_Department_NamedEntity, gen_employee_Employee_NamedEntity},
    metadata=None
)
