...
class pltest_Circle:
    ...
    def __init__(self, diameter: str, circumference: float, area: float, pltest_Circle: set["pltest_Red"] = None, pltest_Circle5: "pltest_WhatEver" = None):
...
class Child2:
    ...
    pass
class pltest_GrandGrandChildF(Child2, GrandChildD):
...
class Child1:
    ...
    pass
class pltest_GrandGrandChildE(Child1, GrandChildD):
...
class Common:
    ...
    pass
class pltest_Child2(Common, Child3, Interface):

    pass
class pltest_Child1(Common, Interface):
