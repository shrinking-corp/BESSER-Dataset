...
# Classes
pltest_Child1 = Class(name="pltest_Child1")
Common = Class(name="Common")
Interface = Class(name="Interface")
pltest_Child2 = Class(name="pltest_Child2")
Child3 = Class(name="Child3")
pltest_GrandChild = Class(name="pltest_GrandChild")
Child1 = Class(name="Child1")
pltest_Child3 = Class(name="pltest_Child3")
pltest_GrandChild2 = Class(name="pltest_GrandChild2")
Child2 = Class(name="Child2")
pltest_Base = Class(name="pltest_Base")
pltest_Common = Class(name="pltest_Common")
Base = Class(name="Base")
pltest_Interface = Class(name="pltest_Interface", is_abstract=True)
TestPackageableElement = Class(name="TestPackageableElement")
pltest_TestClass = Class(name="pltest_TestClass")
TestClassifier = Class(name="TestClassifier")
pltest_TestClassifier = Class(name="pltest_TestClassifier")
pltest_TestInterface = Class(name="pltest_TestInterface")
pltest_Red = Class(name="pltest_Red")
pltest_Circle = Class(name="pltest_Circle")
pltest_WhatEver = Class(name="pltest_WhatEver")
pltest_GrandChildD = Class(name="pltest_GrandChildD")
pltest_GrandGrandChildE = Class(name="pltest_GrandGrandChildE")
GrandChildD = Class(name="GrandChildD")
pltest_GrandGrandChildF = Class(name="pltest_GrandGrandChildF")
pltest_Numbers = Class(name="pltest_Numbers")
pltest_TestPackageableElement = Class(name="pltest_TestPackageableElement")
pltest_TestPackage = Class(name="pltest_TestPackage")
...
pltest_Circle.attributes={pltest_Circle_area, pltest_Circle_diameter, pltest_Circle_circumference}
...
pltest_Numbers.attributes={pltest_Numbers_bigInt, pltest_Numbers_int, pltest_Numbers_double, pltest_Numbers_long, pltest_Numbers_bigDecimal, pltest_Numbers_float}
...
domain_model = DomainModel(
    name="pltest",
    types={pltest_Child1, Common, Interface, pltest_Child2, Child3, pltest_GrandChild, Child1, pltest_Child3, pltest_GrandChild2, Child2, pltest_Base, pltest_Common, Base, pltest_Interface, TestPackageableElement, pltest_TestClass, TestClassifier, pltest_TestClassifier, pltest_TestInterface, pltest_Red, pltest_Circle, pltest_WhatEver, pltest_GrandChildD, pltest_GrandGrandChildE, GrandChildD, pltest_GrandGrandChildF, pltest_Numbers, pltest_TestPackageableElement, pltest_TestPackage},
    associations={a10, a21, ownedElements7, nestedClassifier10, red3, someRef4, owningPackage6},
    generalizations={gen_pltest_Child1_Common, gen_pltest_Child1_Interface, gen_pltest_Child2_Common, gen_pltest_Child2_Interface, gen_pltest_Child2_Child3, gen_pltest_GrandChild_Child1, gen_pltest_GrandChild_Child3, gen_pltest_GrandChild2_Child2, gen_pltest_Common_Base, gen_pltest_TestPackage_TestPackageableElement, gen_pltest_TestClass_TestClassifier, gen_pltest_TestInterface_TestClassifier, gen_pltest_TestClassifier_TestPackageableElement, gen_pltest_GrandChildD_Child3, gen_pltest_GrandGrandChildE_GrandChildD, gen_pltest_GrandGrandChildE_Child1, gen_pltest_GrandGrandChildF_GrandChildD, gen_pltest_GrandGrandChildF_Child2},
    metadata=None
)
