...
class shadowrun_Sichtverhaeltnisse(ABC):
    ...
    def __init__(self, Infrarot: str, Ultrasound: str, Restlichtverstaerkung: str):
...
class shadowrun_FernkampfwaffenModifikatoren(ABC):
    ...
    def __init__(self, Smartgun: str, Rueckstoss: int, lasterPointer: bool, Schalldaempfer: bool, Vergroesserung: int):
...
class shadowrun_GeldWert(ABC):
    ...
    def __init__(self, strassenIndex: float, verfuegbarkeit: str, wert: str):
...
class shadowrun_Schadenswiederstand(ABC):
    ...
    @property
    def ruestungsSchutzBalistisch(self):
...
class shadowrun_Feuerwaffe(AbstaktFernKampfwaffe):
    ...
    def __init__(self, kapazitaet: int, munitionstyp: str, modie: str, shadowrun_Feuerwaffe: "shadowrun_MunitionsBehealter" = None):
...
class shadowrun_PersonaFertigkeit:
    ...
    def __init__(self, stufe: int, shadowrun_PersonaFertigkeit50: "shadowrun_AbstraktFertigkeit" = None, shadowrun_PersonaFertigkeit: "shadowrun_AbstaktPersona" = None):
        self.stufe = stufe
...
class shadowrun_Munition(AbstaktGegenstand):
    ...
    def __init__(self, schadensTyp: str, power: int, niveau: int, shadowrun_Munition: "shadowrun_Reichweite" = None):
...
class shadowrun_AbstaktWaffe(AbstaktGegenstand):
    ...
    def __init__(self, schadenscode: str, shadowrun_AbstaktWaffe22: "shadowrun_Konzentration" = None, shadowrun_AbstaktWaffe24: "shadowrun_Spezialisierung" = None, shadowrun_AbstaktWaffe: "shadowrun_Fertigkeit" = None):
...
class shadowrun_Script(Beschreibbar):
    ...
    def getPlacements(self, shadowrun_Index):
        # TODO: Implement getPlacements method
        pass

    def getPlacementByName(self, shadowrun_ItemName):
        # TODO: Implement getPlacementByName method
        pass

class shadowrun_Spezies(Modifizierbar, Beschreibbar):
...
class shadowrun_PersonaGruppe(Beschreibbar):
    ...
    def getPersonaByName(self, shadowrun_ItemName):
        # TODO: Implement getPersonaByName method
        pass

    def getPersonas(self, shadowrun_Index):
        # TODO: Implement getPersonas method
        pass

    def getPersonaCount(self) :
...
class shadowrun_Placement(Beschreibbar):
    ...
    def getGruppeByName(self, shadowrun_ItemName):
...
class shadowrun_AbstraktModifikatoren(Modifizierbar, Beschreibbar, Quelle):

    pass
class GeldWert:

    pass
class shadowrun_Cyberware(koerpermods, GeldWert):

    pass
class shadowrun_BioWare(koerpermods, GeldWert):
...
class shadowrun_FertigkeitsGruppe(FK, Beschreibbar):
    ...
    pass
class shadowrun_AbstaktGegenstand(FK, Beschreibbar, Quelle, Legalitaet, GeldWert, Bemerkbar, Modifizierbar):

    def __init__(self, gewicht: float, raumKapazitaet: int, verbraucht: bool, inBenutzung: bool, tragbar: str, shadowrun_AbstaktGegenstand27: "shadowrun_Behaelter" = None, shadowrun_AbstaktGegenstand57: "shadowrun_GengenstandListe" = None, shadowrun_AbstaktGegenstand67: "shadowrun_WarenListe" = None, shadowrun_AbstaktGegenstand17: "shadowrun_AbstaktPersona" = None, shadowrun_AbstaktGegenstand: "shadowrun_AbstaktPersona" = None, shadowrun_AbstaktGegenstand9: "shadowrun_AbstaktPersona" = None, shadowrun_AbstaktGegenstand12: "shadowrun_AbstaktPersona" = None):
...
class shadowrun_Reichweite(Beschreibbar):
    ...
    def __init__(self, reichweiteKurz: int, reichweiteKurz1: int, reichweiteMittel: int, reichweiteMittel1: int, reichweiteWeit: int, reichweiteWeit1: int, reichweiteExtrem: int, reichweiteExtrem1: int, shadowrun_Reichweite59: "shadowrun_Reichweiten" = None, shadowrun_Reichweite: "shadowrun_AbstaktFernKampfwaffe" = None, shadowrun_Reichweite72: "shadowrun_Munition" = None):
...
class Essenz:
    ...
    pass
class shadowrun_AbstaktPersona(Beschreibbar, KoerperlicheAtribute, GeistigeAttribute, BodyIndex, BerechneteAttribute, Essenz):

    def __init__(self, KonsitutionBase: int, StaerkeBase: int, SchnelligkeitBase: int, InteligenzBase: int, CharismaBase: int, WillenskraftBase: int, ReaktionBase: int, ReaktionWBase: int, KampfpoolBase: int, EssenzBase: int, eigenGewicht: int, modsetter: str, shadowrun_AbstaktPersona14: set["shadowrun_AbstraktKleidung"] = None, shadowrun_AbstaktPersona30: "shadowrun_PersonaGruppe" = None, AbstaktPersona: "shadowrun_Cyberware" = None, AbstaktPersona52: "shadowrun_BioWare" = None, shadowrun_AbstaktPersona16: set["shadowrun_AbstaktGegenstand"] = None, shadowrun_AbstaktPersona19: "shadowrun_Spezies" = None, shadowrun_AbstaktPersona: set["shadowrun_PersonaFertigkeit"] = None, persona: set["shadowrun_Cyberware"] = None, persona4: set["shadowrun_BioWare"] = None, shadowrun_AbstaktPersona6: set["shadowrun_AbstaktGegenstand"] = None, shadowrun_AbstaktPersona8: "shadowrun_AbstaktGegenstand" = None, shadowrun_AbstaktPersona11: "shadowrun_AbstaktGegenstand" = None):
