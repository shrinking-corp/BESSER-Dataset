...
# Classes
mtm_di_Diagram = Class(name="mtm_di_Diagram", is_abstract=True)
mtm_di_DiagramElement = Class(name="mtm_di_DiagramElement", is_abstract=True)
mtm_di_ExtensionType = Class(name="mtm_di_ExtensionType")
mtm_di_Node = Class(name="mtm_di_Node", is_abstract=True)
mtm_di_Edge = Class(name="mtm_di_Edge", is_abstract=True)
DiagramElement = Class(name="DiagramElement")
mtm_di_Point = Class(name="mtm_di_Point")
mtm_di_Label = Class(name="mtm_di_Label", is_abstract=True)
Node = Class(name="Node")
mtm_di_Bounds = Class(name="mtm_di_Bounds")
mtm_di_LabeledEdge = Class(name="mtm_di_LabeledEdge", is_abstract=True)
Edge = Class(name="Edge")
mtm_di_LabeledShape = Class(name="mtm_di_LabeledShape", is_abstract=True)
Shape = Class(name="Shape")
mtm_di_Plane = Class(name="mtm_di_Plane", is_abstract=True)
mtm_di_Shape = Class(name="mtm_di_Shape", is_abstract=True)
mtm_di_Style = Class(name="mtm_di_Style", is_abstract=True)
mtm_di_DocumentRoot = Class(name="mtm_di_DocumentRoot")
mtm_di_EStringToStringMapEntry = Class(name="mtm_di_EStringToStringMapEntry")
...
mtm_di_Diagram.attributes={mtm_di_Diagram_id, mtm_di_Diagram_documentation, mtm_di_Diagram_resolution, mtm_di_Diagram_name}
...
mtm_di_DiagramElement.attributes={mtm_di_DiagramElement_id, mtm_di_DiagramElement_anyAttribute}
...
domain_model = DomainModel(
    name="mtm_di",
    types={mtm_di_Diagram, mtm_di_DiagramElement, mtm_di_ExtensionType, mtm_di_Node, mtm_di_Edge, DiagramElement, mtm_di_Point, mtm_di_Label, Node, mtm_di_Bounds, mtm_di_LabeledEdge, Edge, mtm_di_LabeledShape, Shape, mtm_di_Plane, mtm_di_Shape, mtm_di_Style, mtm_di_DocumentRoot, mtm_di_EStringToStringMapEntry},
    associations={extension0, waypoint1, bounds2, xSISchemaLocation8, diagramElement3, bounds5, xMLNSPrefixMap7, diagramElement11, diagram14, edge16, label19, labeledEdge22, labeledShape24, node26, plane28, shape31, style34},
    generalizations={gen_mtm_di_Node_DiagramElement, gen_mtm_di_Edge_DiagramElement, gen_mtm_di_Label_Node, gen_mtm_di_LabeledEdge_Edge, gen_mtm_di_LabeledShape_Shape, gen_mtm_di_Plane_Node, gen_mtm_di_Shape_Node},
    metadata=None
)
