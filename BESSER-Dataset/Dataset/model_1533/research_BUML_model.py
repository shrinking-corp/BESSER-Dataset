...
# Classes
research_Phase = Class(name="research_Phase")
research_Researcher = Class(name="research_Researcher")
research_Write = Class(name="research_Write")
research_PublicationProcess = Class(name="research_PublicationProcess")
Named = Class(name="Named")
research_ReviewNote = Class(name="research_ReviewNote")
Labelled = Class(name="Labelled")
research_Review = Class(name="research_Review")
research_Paper = Class(name="research_Paper")
research_Skill = Class(name="research_Skill")
research_Position = Class(name="research_Position")
research_Collaboration = Class(name="research_Collaboration")
research_Paragraph = Class(name="research_Paragraph")
research_Progress = Class(name="research_Progress")
research_PaperKeyword = Class(name="research_PaperKeyword")
Counted = Class(name="Counted")
research_KnowledgeManager = Class(name="research_KnowledgeManager")
research_PublicationSystem = Class(name="research_PublicationSystem")
research_PublicationStructure = Class(name="research_PublicationStructure")
research_Named = Class(name="research_Named", is_abstract=True)
research_Counted = Class(name="research_Counted", is_abstract=True)
research_Labelled = Class(name="research_Labelled", is_abstract=True)
research_Keyword = Class(name="research_Keyword")
...
domain_model = DomainModel(
    name="research",
    types={research_Phase, research_Researcher, research_Write, research_PublicationProcess, Named, research_ReviewNote, Labelled, research_Review, research_Paper, research_Skill, research_Position, research_Collaboration, research_Paragraph, research_Progress, research_PaperKeyword, Counted, research_KnowledgeManager, research_PublicationSystem, research_PublicationStructure, research_Named, research_Counted, research_Labelled, research_Keyword},
    associations={phases0, writes1, reviews19, process21, reviews2, res_papers4, skills5, res_position7, collaborations9, paragraphs11, progress12, authors13, keywords14, citedBy17, papers33, knowledgeMan36, processView38, structuralView40, positions43, paper23, paragraph25, reviewNote28, researchers31, keyword54, col_paper57, parent47, kpapers49, allkeywords51},
    generalizations={gen_research_PublicationProcess_Named, gen_research_Paragraph_Counted, gen_research_Paragraph_Named, gen_research_ReviewNote_Named, gen_research_Progress_Labelled, gen_research_Paper_Named, gen_research_PublicationSystem_Named, gen_research_Write_Labelled, gen_research_Review_Labelled, gen_research_PublicationStructure_Named, gen_research_Position_Named, gen_research_Keyword_Named, gen_research_KnowledgeManager_Named},
    metadata=None
)
