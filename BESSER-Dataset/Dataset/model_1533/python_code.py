...
class research_Keyword(Named):
    ...
    def __init__(self, description: str, research_Keyword56: "research_PaperKeyword" = None, research_Keyword: set["research_Paper"] = None, research_Keyword53: "research_KnowledgeManager" = None):
        self.description = description
