...
# Classes
addressbook_Electronic = Class(name="addressbook_Electronic")
Contact = Class(name="Contact")
addressbook_Office = Class(name="addressbook_Office")
addressbook_Contact = Class(name="addressbook_Contact", is_abstract=True)
addressbook_People = Class(name="addressbook_People")
addressbook_AddressBook = Class(name="addressbook_AddressBook")
addressbook_Repository = Class(name="addressbook_Repository")
addressbook_BookVersion = Class(name="addressbook_BookVersion")
...
addressbook_Repository_m_checkout: Method = Method(name="checkout", parameters={Parameter(name='addressbook_id', type=StringType)}, type=StringType)
addressbook_Repository_m_checkin: Method = Method(name="checkin", parameters={})
addressbook_Repository.methods={addressbook_Repository_m_checkin, addressbook_Repository_m_checkout}
...
domain_model = DomainModel(
    name="addressbook",
    types={addressbook_Electronic, Contact, addressbook_Office, addressbook_Contact, addressbook_People, addressbook_AddressBook, addressbook_Repository, addressbook_BookVersion},
