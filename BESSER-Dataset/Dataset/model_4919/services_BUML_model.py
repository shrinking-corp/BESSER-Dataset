...
# Classes
services_services_EndPoint = Class(name="services_services_EndPoint")
RootElement = Class(name="RootElement")
services_services_Interface = Class(name="services_services_Interface")
Operation = Class(name="Operation")
services_services_EObject = Class(name="services_services_EObject")
services_services_Operation = Class(name="services_services_Operation")
...
domain_model = DomainModel(
    ...
    associations={implementationRef1, operations0, inMessageRef3, outMessageRef4, errorRefs7, implementationRef9},
