...
class epo_PurchaseOrder:
    ...
    def __init__(self, comment: str, orderDate: str, status: str, totalAmount: int, epo_PurchaseOrder: "epo_Address" = None, epo_PurchaseOrder4: "epo_Address" = None, orders: "epo_Customer" = None, epo_PurchaseOrder9: "epo_PurchaseOrder" = None, epo_PurchaseOrder7: "epo_PurchaseOrder" = None, PurchaseOrder: "epo_Item" = None, order: set["epo_Item"] = None, epo_PurchaseOrder13: "epo_Supplier" = None, epo_PurchaseOrder16: "epo_Supplier" = None, epo_PurchaseOrder19: "epo_Supplier" = None, PurchaseOrder21: "epo_Customer" = None):
