...
epo_Item.attributes={epo_Item_productName, epo_Item_quantity, epo_Item_comment, epo_Item_partNum, epo_Item_shipDate, epo_Item_USPrice}
...
epo_PurchaseOrder.attributes={epo_PurchaseOrder_totalAmount, epo_PurchaseOrder_comment, epo_PurchaseOrder_status, epo_PurchaseOrder_orderDate}
...
epo_USAddress.attributes={epo_USAddress_zip, epo_USAddress_state, epo_USAddress_city, epo_USAddress_street}
...
domain_model = DomainModel(
    name="epo",
    types={epo_Item, epo_Address, epo_Customer, epo_Supplier, epo_PurchaseOrder, epo_USAddress, Address, epo_CanadianAddress, epo_GlobalAddress, GlobalLocation, epo_GlobalLocation, OrderStatus},
    associations={billTo2, shipTo3, customer6, previousOrder8, order0, items1, customers10, orders11, pendingOrders14, shippedOrders17, orders20},
    generalizations={gen_epo_USAddress_Address, gen_epo_CanadianAddress_Address, gen_epo_GlobalAddress_Address, gen_epo_GlobalAddress_GlobalLocation},
    metadata=None
)
