...
notation_HierarchicalNode = Class(name="notation_HierarchicalNode")
...
notation_RelativeBendPoint = Class(name="notation_RelativeBendPoint")
BendPoint = Class(name="BendPoint")
notation_AbsoluteBendPoint = Class(name="notation_AbsoluteBendPoint")
notation_Anchor = Class(name="notation_Anchor")
notation_BendPoint = Class(name="notation_BendPoint", is_abstract=True)
...
notation_Node.attributes={notation_Node_height, notation_Node_width, notation_Node_x, notation_Node_y}
...
notation_DiagramElement.attributes={notation_DiagramElement_persistent, notation_DiagramElement_visible}
...
notation_RelativeBendPoint.attributes={notation_RelativeBendPoint_sourceX, notation_RelativeBendPoint_targetY, notation_RelativeBendPoint_sourceY, notation_RelativeBendPoint_targetX}
...
notation_AbsoluteBendPoint.attributes={notation_AbsoluteBendPoint_x, notation_AbsoluteBendPoint_y}
...
domain_model = DomainModel(
    name="notation",
    types={notation_Node, DiagramElement, notation_Edge, notation_HierarchicalNode, notation_DiagramElement, Identifier, notation_EObject, notation_RelativeBendPoint, BendPoint, notation_AbsoluteBendPoint, notation_Anchor, notation_BendPoint, Node},
    associations={outgoing1, incoming2, parent4, source5, target6, parent8, model0, edges17, edge20, sourceAnchor10, targetAnchor11, bendPoints14, nodes15},
    generalizations={gen_notation_Node_DiagramElement, gen_notation_Edge_DiagramElement, gen_notation_DiagramElement_Identifier, gen_notation_RelativeBendPoint_BendPoint, gen_notation_AbsoluteBendPoint_BendPoint, gen_notation_HierarchicalNode_Node},
    metadata=None
)
