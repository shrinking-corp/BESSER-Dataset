...
class Post:
    ...
    def __init__(self, privateMode: bool, nLikes: int, nComments: int, nShares: int, owner: User, hashTags8: "HashTags" = None, page10: "Page" = None, user5: "User" = None, group6: "Group" = None):
...
class User:
    ...
    def __init__(self, name: str, username: str, email: str, password: str, gender: str, pages: str, groups: str, group0: "Group" = None, page2: "Page" = None, post4: "Post" = None):
        self.name = name
