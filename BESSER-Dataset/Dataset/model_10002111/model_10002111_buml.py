...
User.attributes={User_gender, User_pages, User_email, User_username, User_password, User_name, User_groups}
...
Group.attributes={Group_posts, Group_name, Group_admins, Group_members, Group_description, Group_nMembers}
...
Post.attributes={Post_owner, Post_nShares, Post_nComments, Post_privateMode, Post_nLikes}
...
Page.attributes={Page_posts, Page_nFans, Page_admin, Page_fans, Page_name, Page_description}
...
domain_model = DomainModel(
    name="_owjj8Dt2EeqTDpmqRhKD9Q",
    types={User, Group, User__, Post, Page, HashTags, User2_Interface},
    associations={Post_HashTags, Post_Page, User_Group2, User_Page, User_Post, Post_Group},
    generalizations={},
    metadata=None
)
