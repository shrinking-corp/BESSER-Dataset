...
class tfsm_State(NamedElement):
    ...
    def __init__(self, source: set["tfsm_Transition"] = None, target: set["tfsm_Transition"] = None, State11: "tfsm_Transition" = None, State13: "tfsm_Transition" = None, ownedState: "tfsm_TFSM" = None, State: "tfsm_TFSM" = None, tfsm_State: "tfsm_TFSM" = None):
