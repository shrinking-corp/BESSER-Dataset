...
# Classes
linkinher_E = Class(name="linkinher_E", is_abstract=True)
Named = Class(name="Named")
linkinher_N = Class(name="linkinher_N")
linkinher_Named = Class(name="linkinher_Named", is_abstract=True)
T = Class(name="T")
S = Class(name="S")
linkinher_L = Class(name="linkinher_L")
linkinher_M = Class(name="linkinher_M")
E = Class(name="E")
linkinher_K = Class(name="linkinher_K")
linkinher_X = Class(name="linkinher_X")
linkinher_T = Class(name="linkinher_T", is_abstract=True)
linkinher_S = Class(name="linkinher_S", is_abstract=True)
linkinher_C = Class(name="linkinher_C", is_abstract=True)
C = Class(name="C")
...
domain_model = DomainModel(
    name="linkinher",
    types={linkinher_E, Named, linkinher_N, linkinher_Named, T, S, linkinher_L, linkinher_M, E, linkinher_K, linkinher_X, linkinher_T, linkinher_S, linkinher_C, C},
    associations={net0, nes1, es4, nameds7, nx8, ns11},
    generalizations={gen_linkinher_E_Named, gen_linkinher_N_Named, gen_linkinher_N_T, gen_linkinher_N_S, gen_linkinher_M_E, gen_linkinher_K_C, gen_linkinher_S_Named, gen_linkinher_C_S, gen_linkinher_C_E, gen_linkinher_L_C, gen_linkinher_L_T},
    metadata=None
)
