...
Booking.attributes={Booking_Id, Booking_Date, Booking_Type, Booking_Description}
...
Customer.attributes={Customer_Mobile_no___Email, Customer_Id, Customer_Address, Customer_Name}
...
Admin.attributes={Admin_Id, Admin_Name, Admin_Password}
...
Room.attributes={Room_Room_number, Room_Room_description, Room_Room_type, Room_Room_Id}
...
Payment.attributes={Payment_Customer_s_Id, Payment_Payment_Date, Payment_Amount, Payment_Payment_Description}
...
Hotel.attributes={Hotel_Hotel_Name, Hotel_Hotel_Address, Hotel_Hotel_Rent, Hotel_Hotel_ID, Hotel_Hotel_Type}
...
Debit_Card.attributes={Debit_Card_Card_No_, Debit_Card_Pin_No_}
...
Credit_Card.attributes={Credit_Card_Card_No_, Credit_Card_Pin_No_}
...
domain_model = DomainModel(
    name="_HS8SwP4WEeiq1obLTi0emw",
    types={Booking, Customer, Admin, Room, Payment, Hotel, Debit_Card, Credit_Card},
    associations={Booking_Hotel, Customer_Hotel, Admin_Hotel, Payment_Booking, Payment_Room, Payment_Hotel, Admin_Booking, Admin_Room, Room_Hotel, Customer_Payment, Payment_Debit_Card, Payment_Credit_Card},
    generalizations={},
    metadata=None
)
