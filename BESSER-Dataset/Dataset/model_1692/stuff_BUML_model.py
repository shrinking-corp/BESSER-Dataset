...
# Classes
stuff_World = Class(name="stuff_World")
stuff_Stuff = Class(name="stuff_Stuff")
Thing = Class(name="Thing")
stuff_Foo = Class(name="stuff_Foo")
stuff_Thing = Class(name="stuff_Thing")
NamedElement = Class(name="NamedElement")
stuff_Baz = Class(name="stuff_Baz")
stuff_NamedElement = Class(name="stuff_NamedElement", is_abstract=True)
stuff_Bar = Class(name="stuff_Bar")
...
domain_model = DomainModel(
    name="stuff",
    types={stuff_World, stuff_Stuff, Thing, stuff_Foo, stuff_Thing, NamedElement, stuff_Baz, stuff_NamedElement, stuff_Bar},
    associations={things0, others2, foos4, bars5, src7, trg10, baz13},
    generalizations={gen_stuff_Stuff_Thing, gen_stuff_Bar_NamedElement, gen_stuff_Baz_NamedElement},
    metadata=None
)
