...
StateMachineDiagram_meta_Activity = Class(name="StateMachineDiagram_meta_Activity")
State = Class(name="State")
StateMachineDiagram_meta_Fragment = Class(name="StateMachineDiagram_meta_Fragment")
...
domain_model = DomainModel(
    ...
    types={StateMachineDiagram_meta_Application, StateMachineDiagram_meta_StateMachine, StateMachineDiagram_meta_Vertex, StateMachineDiagram_meta_Transition, StateMachineDiagram_meta_Pseudostate, Vertex, StateMachineDiagram_meta_State, StateMachineDiagram_meta_Activity, State, StateMachineDiagram_meta_Fragment, StateMachineDiagram_meta_Event},
    associations={statemachine0, vertex1, transition3, outgoing5, incoming6, souce8, target9, statemachine11},
