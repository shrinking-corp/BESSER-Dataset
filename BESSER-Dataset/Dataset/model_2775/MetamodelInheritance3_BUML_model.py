...
# Classes
MetamodelInheritance3_ChildC = Class(name="MetamodelInheritance3_ChildC")
BaseContaineeC = Class(name="BaseContaineeC")
MetamodelInheritance3_ChildD = Class(name="MetamodelInheritance3_ChildD")
ChildContaineeD = Class(name="ChildContaineeD")
MetamodelInheritance3_BaseContaineeA = Class(name="MetamodelInheritance3_BaseContaineeA")
