...
metrics_MappingRecordXLS.attributes={metrics_MappingRecordXLS_row, metrics_MappingRecordXLS_column}
...
metrics_IdentifierDataKind.attributes={metrics_IdentifierDataKind_objectName, metrics_IdentifierDataKind_objectAttribute}
...
metrics_MappingXLS.attributes={metrics_MappingXLS_sheetNumber, metrics_MappingXLS_headerRow, metrics_MappingXLS_columnHeaders, metrics_MappingXLS_firstDataRow}
...
metrics_Metric.attributes={metrics_Metric_measurementKind, metrics_Metric_measurementPoint, metrics_Metric_unitRef, metrics_Metric_name, metrics_Metric_description, metrics_Metric_metricCalculation}
...
metrics_MetricValueRange.attributes={metrics_MetricValueRange_kindHint, metrics_MetricValueRange_name, metrics_MetricValueRange_periodHint}
...
domain_model = DomainModel(
    name="metrics",
    types={metrics_DataKind, metrics_Mapping, metrics_MappingCSV, Mapping, metrics_MappingRDBMS, metrics_MappingRecord, metrics_MappingRecordXLS, MappingRecord, metrics_IdentifierDataKind, DataKind, metrics_MappingXLS, metrics_Metric, metrics_MappingStatistic, metrics_DateTimeRange, metrics_MetricSource, metrics_Value, metrics_ValueDataKind, metrics_MetricValueRange, KindHintType, ObjectNameType, ValueKindType},
    associations={columnDataKind3, failedRecords0, mappingDuration1, metricSourceRef6, metricRefs7, metricMapping8, metrics5, metricValues12, statistics9},
