...
class Graph_Node:
    ...
    def __init__(self, name: str, source: set["Graph_Edge"] = None, target: set["Graph_Edge"] = None, Node: "Graph_Edge" = None, Node6: "Graph_Edge" = None, Graph_Node: "Graph_Graph" = None):
        self.name = name
