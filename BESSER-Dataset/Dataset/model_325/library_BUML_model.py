...
library_Library.attributes={library_Library_address, library_Library_ages, library_Library_name}
...
domain_model = DomainModel(
    name="library",
    types={library_Employee, library_Library, library__cPfS4h9KEeeOINGRvT6ccg, library__cPfTBB9KEeeOINGRvT6ccg, library__cPfTDx9KEeeOINGRvT6ccg, library_Writer, library_Book, BookCategory},
    associations={employees0, writers1, books3, moreThan205, books8, authors10},
    generalizations={},
    metadata=None
)
