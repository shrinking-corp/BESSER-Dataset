...
class fsm_Transition:
    ...
    def __init__(self, Guard: str, Effect: str, fsm_Transition: "fsm_State" = None, fsm_Transition10: "fsm_SuperState" = None, outTrans: "fsm_SuperState" = None, Transition: "fsm_SuperState" = None):
        self.Guard = Guard
        self.Effect = Effect
...
class fsm_State(SuperState):
    ...
    def __init__(self, name: str, fsm_State4: "fsm_Action" = None, fsm_State6: "fsm_eAction" = None, fsm_State8: "fsm_Transition" = None, fsm_State: "fsm_FSM" = None):
        self.name = name
