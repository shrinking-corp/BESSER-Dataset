...
class ocltestmodel_MyClass:
    ...
    def __init__(self, static_sequence: str, collection_literals: str, boolean_unequal: bool, boolean_equal: bool, boolean_and: bool, integer_lessthan: bool, integer_greaterthan: bool, integer_greaterequals: bool, integer_lessequals: bool, boolean_implies: bool, boolean_not: bool, boolean_or: bool, boolean_xor: bool, boolean_toString: str, integer_multiplication: int, integer_addition: int, integer_subtraction: int, real_lessthan: bool, real_greaterthan: bool, real_greaterequals: bool, real_lessequals: bool, real_division: str, integer_division: float, integer_absolute: int, integer_maximum: int, integer_minimum: int, integer_modulo: int, integer_toString: str, real_multiplication: str, real_addition: str, real_subtraction: str, string_unequal: bool, string_equal: bool, string_greaterthan: bool, string_greaterequals: bool, real_absolute: str, real_maximum: str, real_minimum: str, real_floor: str, real_toString: str, string_addition: str, string_lessthan: bool, string_lessequals: bool, let3: int, unEmployed: bool, let: bool, integer_sequence: int, string_at: str, string_compareTo: str, string_concat: str, string_equalsIgnoreCase: bool, string_indexOf: str, string_lastIndexOf: str, string_replaceAll: str, string_size: str, let2: bool, orderedset_size: str, sequence_count: str, sequence_selectByKind: str, sequence_selectByType: str, tuple_literal: bool, _BooleanLiteralExp: bool, _RealLiteralExp: str, _NumberLiteralExp: str, _IntegerLiteralExp: str, _InfixExp_NOT_PASSING_DUE_TO_BUG_IN_OCLHELPER: str, _StringLiteralExp: str, _IfExp: str, _IfExp2: str, ocltestmodel_MyClass: "ocltestmodel_MyClass" = None, ocltestmodel_MyClass0: set["ocltestmodel_MyClass"] = None, ocltestmodel_MyClass4: "ocltestmodel_MyClass" = None, ocltestmodel_MyClass2: set["ocltestmodel_MyClass"] = None, ocltestmodel_MyClass7: "ocltestmodel_MyClass" = None, ocltestmodel_MyClass5: set["ocltestmodel_MyClass"] = None, ocltestmodel_MyClass16: "ocltestmodel_MyClass" = None, ocltestmodel_MyClass14: "ocltestmodel_MyClass" = None, ocltestmodel_MyClass10: "ocltestmodel_MyClass" = None, ocltestmodel_MyClass8: set["ocltestmodel_MyClass"] = None, ocltestmodel_MyClass13: "ocltestmodel_MyClass" = None, ocltestmodel_MyClass11: set["ocltestmodel_MyClass"] = None, ocltestmodel_MyClass19: "ocltestmodel_MyClass" = None, ocltestmodel_MyClass17: "ocltestmodel_MyClass" = None, ocltestmodel_MyClass22: "ocltestmodel_MyClass" = None, ocltestmodel_MyClass20: "ocltestmodel_MyClass" = None):
    ...
    @property
    def _InfixExp_NOT_PASSING_DUE_TO_BUG_IN_OCLHELPER(self):
    ...
    @property
    def integer_greaterequals(self):
    ...
    @property
    def integer_multiplication(self):
    ...
    @property
    def string_equalsIgnoreCase(self):
    ...
    @property
    def sequence_selectByKind(self):
    ...
    @property
    def sequence_selectByType(self):
