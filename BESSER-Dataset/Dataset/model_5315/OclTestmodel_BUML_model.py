...
# Classes
ocltestmodel_MyClass = Class(name="ocltestmodel_MyClass")
...
ocltestmodel_MyClass.attributes={ocltestmodel_MyClass__RealLiteralExp, ocltestmodel_MyClass_boolean_toString, ocltestmodel_MyClass_unEmployed, ocltestmodel_MyClass_sequence_count, ocltestmodel_MyClass_integer_subtraction, ocltestmodel_MyClass_integer_multiplication, ocltestmodel_MyClass_boolean_equal, ocltestmodel_MyClass_integer_maximum, ocltestmodel_MyClass_integer_greaterthan, ocltestmodel_MyClass_integer_lessequals, ocltestmodel_MyClass_string_addition, ocltestmodel_MyClass_sequence_selectByKind, ocltestmodel_MyClass__InfixExp_NOT_PASSING_DUE_TO_BUG_IN_OCLHELPER, ocltestmodel_MyClass_string_unequal, ocltestmodel_MyClass_integer_sequence, ocltestmodel_MyClass_let, ocltestmodel_MyClass_real_toString, ocltestmodel_MyClass_boolean_not, ocltestmodel_MyClass_real_multiplication, ocltestmodel_MyClass_real_division, ocltestmodel_MyClass_string_concat, ocltestmodel_MyClass_integer_toString, ocltestmodel_MyClass_integer_modulo, ocltestmodel_MyClass_real_floor, ocltestmodel_MyClass__NumberLiteralExp, ocltestmodel_MyClass_real_greaterequals, ocltestmodel_MyClass_integer_addition, ocltestmodel_MyClass_tuple_literal, ocltestmodel_MyClass_static_sequence, ocltestmodel_MyClass_real_maximum, ocltestmodel_MyClass__IntegerLiteralExp, ocltestmodel_MyClass_boolean_implies, ocltestmodel_MyClass_string_lessequals, ocltestmodel_MyClass_integer_absolute, ocltestmodel_MyClass_sequence_selectByType, ocltestmodel_MyClass_boolean_unequal, ocltestmodel_MyClass_let2, ocltestmodel_MyClass_boolean_xor, ocltestmodel_MyClass_string_greaterthan, ocltestmodel_MyClass_string_lessthan, ocltestmodel_MyClass_string_equal, ocltestmodel_MyClass_string_equalsIgnoreCase, ocltestmodel_MyClass_string_size, ocltestmodel_MyClass_integer_division, ocltestmodel_MyClass_orderedset_size, ocltestmodel_MyClass__IfExp2, ocltestmodel_MyClass_real_lessthan, ocltestmodel_MyClass_string_indexOf, ocltestmodel_MyClass_string_greaterequals, ocltestmodel_MyClass__BooleanLiteralExp, ocltestmodel_MyClass_boolean_or, ocltestmodel_MyClass_real_absolute, ocltestmodel_MyClass_real_lessequals, ocltestmodel_MyClass_integer_greaterequals, ocltestmodel_MyClass_string_compareTo, ocltestmodel_MyClass_real_addition, ocltestmodel_MyClass_collection_literals, ocltestmodel_MyClass_real_greaterthan, ocltestmodel_MyClass_let3, ocltestmodel_MyClass__StringLiteralExp, ocltestmodel_MyClass_string_lastIndexOf, ocltestmodel_MyClass_real_minimum, ocltestmodel_MyClass_boolean_and, ocltestmodel_MyClass__IfExp, ocltestmodel_MyClass_integer_minimum, ocltestmodel_MyClass_real_subtraction, ocltestmodel_MyClass_string_at, ocltestmodel_MyClass_string_replaceAll, ocltestmodel_MyClass_integer_lessthan}
...
domain_model = DomainModel(
    ...
    associations={orderedset1, set3, sequence6, orderedset_at15, bag9, orderedset_select12, _SelfExp18, _NullExp21},
    generalizations={},
    metadata=None
)
