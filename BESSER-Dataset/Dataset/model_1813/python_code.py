...
class DBLP_Organization:
    ...
    def __init__(self, name: str, DBLP_Organization27: "DBLP_Proceedings" = None, DBLP_Organization: "DBLP_InCollection" = None, DBLP_Organization15: "DBLP_InProceedings" = None):
        self.name = name
...
class DBLP_Publisher:
    ...
    def __init__(self, name: str, address: str, DBLP_Publisher: "DBLP_Book" = None, DBLP_Publisher10: "DBLP_InCollection" = None, DBLP_Publisher18: "DBLP_InProceedings" = None, DBLP_Publisher24: "DBLP_Proceedings" = None):
        self.name = name
        self.address = address
...
class DBLP_Proceedings(Record):
    ...
    def __init__(self, month: str, isbn: str, title: str, year: int, DBLP_Proceedings26: set["DBLP_Organization"] = None, DBLP_Proceedings: set["DBLP_Editor"] = None, DBLP_Proceedings23: "DBLP_Publisher" = None):
        self.month = month
        self.isbn = isbn
        self.title = title
        self.year = year
