...
DBLP_Article.attributes={DBLP_Article_year, DBLP_Article_number, DBLP_Article_title, DBLP_Article_volume, DBLP_Article_month, DBLP_Article_toPage, DBLP_Article_fromPage}
...
DBLP_Record.attributes={DBLP_Record_url, DBLP_Record_key, DBLP_Record_mdate, DBLP_Record_ee}
...
DBLP_Book.attributes={DBLP_Book_year, DBLP_Book_month, DBLP_Book_volume, DBLP_Book_edition, DBLP_Book_series, DBLP_Book_isbn, DBLP_Book_title}
...
DBLP_Publisher.attributes={DBLP_Publisher_address, DBLP_Publisher_name}
...
DBLP_InCollection.attributes={DBLP_InCollection_fromPage, DBLP_InCollection_year, DBLP_InCollection_month, DBLP_InCollection_toPage, DBLP_InCollection_bookTitle, DBLP_InCollection_title}
...
DBLP_PhDThesis.attributes={DBLP_PhDThesis_title, DBLP_PhDThesis_month, DBLP_PhDThesis_year}
...
DBLP_InProceedings.attributes={DBLP_InProceedings_year, DBLP_InProceedings_fromPage, DBLP_InProceedings_title, DBLP_InProceedings_bootitle, DBLP_InProceedings_month, DBLP_InProceedings_toPage}
...
DBLP_MastersThesis.attributes={DBLP_MastersThesis_year, DBLP_MastersThesis_title, DBLP_MastersThesis_month}
...
DBLP_Www.attributes={DBLP_Www_title, DBLP_Www_month, DBLP_Www_year}
...
domain_model = DomainModel(
    name="DBLP",
    types={DBLP_Article, Record, DBLP_Record, DBLP_Author, DBLP_Editor, DBLP_Journal, DBLP_Book, DBLP_Publisher, DBLP_InCollection, DBLP_PhDThesis, DBLP_Organization, DBLP_InProceedings, DBLP_MastersThesis, DBLP_School, DBLP_Proceedings, DBLP_Www},
    associations={authors0, editors5, journal1, records2, articles3, publisher4, sponsoredBy25, sponsoredBy6, publisher8, editors11, organization13, publisher16, school19, editors20, publisher22, school28, editors30},
    generalizations={gen_DBLP_Article_Record, gen_DBLP_Book_Record, gen_DBLP_InCollection_Record, gen_DBLP_PhDThesis_Record, gen_DBLP_InProceedings_Record, gen_DBLP_MastersThesis_Record, gen_DBLP_Proceedings_Record, gen_DBLP_Www_Record},
    metadata=None
)
