...
# Classes
cSharp_AttributeList = Class(name="cSharp_AttributeList")
cSharp_Attributes = Class(name="cSharp_Attributes")
cSharp_AttributeSection = Class(name="cSharp_AttributeSection")
AttributeSection = Class(name="AttributeSection")
cSharp_Attribute = Class(name="cSharp_Attribute")
cSharp_CompilationUnit = Class(name="cSharp_CompilationUnit")
cSharp_UsingDirective = Class(name="cSharp_UsingDirective")
cSharp_GlobalAttributes = Class(name="cSharp_GlobalAttributes")
cSharp_NamespaceMemberDeclaration = Class(name="cSharp_NamespaceMemberDeclaration")
cSharp_Identifier = Class(name="cSharp_Identifier")
cSharp_QualifiedIdentifier = Class(name="cSharp_QualifiedIdentifier")
cSharp_ArrayType = Class(name="cSharp_ArrayType")
cSharp_GlobalAttributeSection = Class(name="cSharp_GlobalAttributeSection")
cSharp_AttributeName = Class(name="cSharp_AttributeName")
cSharp_AttributeArguments = Class(name="cSharp_AttributeArguments")
cSharp_ExpressionList = Class(name="cSharp_ExpressionList")
cSharp_Expression = Class(name="cSharp_Expression")
...
cSharp_UnaryExpression = Class(name="cSharp_UnaryExpression")
cSharp_Expression2 = Class(name="cSharp_Expression2")
cSharp_PrimaryExpression = Class(name="cSharp_PrimaryExpression")
cSharp_NonArrayType = Class(name="cSharp_NonArrayType")
cSharp_BuiltInType = Class(name="cSharp_BuiltInType")
cSharp_Type = Class(name="cSharp_Type")
...
cSharp_VariableDeclarator = Class(name="cSharp_VariableDeclarator")
cSharp_ArrayInitializer = Class(name="cSharp_ArrayInitializer")
cSharp_ArgumentList = Class(name="cSharp_ArgumentList")
cSharp_TypeOrVoid = Class(name="cSharp_TypeOrVoid")
cSharp_PrimaryExpression2 = Class(name="cSharp_PrimaryExpression2")
cSharp_VariableInitializer = Class(name="cSharp_VariableInitializer")
cSharp_NamespaceBody = Class(name="cSharp_NamespaceBody")
cSharp_ClassDeclaration = Class(name="cSharp_ClassDeclaration")
cSharp_EventAccessorDeclarations = Class(name="cSharp_EventAccessorDeclarations")
cSharp_AccessorDeclarations = Class(name="cSharp_AccessorDeclarations")
cSharp_ConstantDeclarator = Class(name="cSharp_ConstantDeclarator")
cSharp_IntegralType = Class(name="cSharp_IntegralType")
BuiltInType = Class(name="BuiltInType")
ArrayType = Class(name="ArrayType")
cSharp_BuiltInClassType = Class(name="cSharp_BuiltInClassType")
ClassBase = Class(name="ClassBase")
cSharp_QualifiedIdentifierList = Class(name="cSharp_QualifiedIdentifierList")
cSharp_NamespaceDeclaration = Class(name="cSharp_NamespaceDeclaration")
cSharp_TypeDeclaration = Class(name="cSharp_TypeDeclaration")
cSharp_InterfaceIndexerDeclaration = Class(name="cSharp_InterfaceIndexerDeclaration")
cSharp_InterfacePropertyDeclaration = Class(name="cSharp_InterfacePropertyDeclaration")
cSharp_FormalParameterList = Class(name="cSharp_FormalParameterList")
cSharp_InterfaceDeclaration = Class(name="cSharp_InterfaceDeclaration")
cSharp_EnumDeclaration = Class(name="cSharp_EnumDeclaration")
cSharp_DelegateDeclaration = Class(name="cSharp_DelegateDeclaration")
cSharp_EnumBody = Class(name="cSharp_EnumBody")
cSharp_EnumMemberDeclaration = Class(name="cSharp_EnumMemberDeclaration")
cSharp_InterfaceBody = Class(name="cSharp_InterfaceBody")
cSharp_InterfaceMemberDeclaration = Class(name="cSharp_InterfaceMemberDeclaration")
cSharp_InterfaceMethodDeclaration = Class(name="cSharp_InterfaceMethodDeclaration")
cSharp_InterfaceEventDeclaration = Class(name="cSharp_InterfaceEventDeclaration")
cSharp_ClassBase = Class(name="cSharp_ClassBase")
cSharp_ClassBody = Class(name="cSharp_ClassBody")
cSharp_ClassMemberDeclaration = Class(name="cSharp_ClassMemberDeclaration")
cSharp_InterfaceAccessors = Class(name="cSharp_InterfaceAccessors")
cSharp_ConstructorInitializer = Class(name="cSharp_ConstructorInitializer")
ConstructorInitializer = Class(name="ConstructorInitializer")
cSharp_Argument = Class(name="cSharp_Argument")
cSharp_FieldDeclaration = Class(name="cSharp_FieldDeclaration")
cSharp_MethodDeclaration = Class(name="cSharp_MethodDeclaration")
cSharp_ConstantDeclaration = Class(name="cSharp_ConstantDeclaration")
cSharp_PropertyDeclaration = Class(name="cSharp_PropertyDeclaration")
cSharp_EventDeclaration = Class(name="cSharp_EventDeclaration")
cSharp_IndexerDeclaration = Class(name="cSharp_IndexerDeclaration")
cSharp_OperatorDeclaration = Class(name="cSharp_OperatorDeclaration")
cSharp_ConstructorDeclaration = Class(name="cSharp_ConstructorDeclaration")
cSharp_DestructorDeclaration = Class(name="cSharp_DestructorDeclaration")
cSharp_StaticConstructorDeclaration = Class(name="cSharp_StaticConstructorDeclaration")
cSharp_MaybeEmptyBlock = Class(name="cSharp_MaybeEmptyBlock")
cSharp_ConstructorDeclarator = Class(name="cSharp_ConstructorDeclarator")
cSharp_IndexerDeclarator = Class(name="cSharp_IndexerDeclarator")
cSharp_OperatorDeclarator = Class(name="cSharp_OperatorDeclarator")
cSharp_ConversionOperatorDeclarator = Class(name="cSharp_ConversionOperatorDeclarator")
OperatorDeclarator = Class(name="OperatorDeclarator")
cSharp_BinaryOperatorDeclarator = Class(name="cSharp_BinaryOperatorDeclarator")
cSharp_UnaryOperatorDeclarator = Class(name="cSharp_UnaryOperatorDeclarator")
cSharp_ParameterArray = Class(name="cSharp_ParameterArray")
cSharp_AddAccessorDeclaration = Class(name="cSharp_AddAccessorDeclaration")
cSharp_RemoveAccessorDeclaration = Class(name="cSharp_RemoveAccessorDeclaration")
cSharp_GetAccessorDeclaration = Class(name="cSharp_GetAccessorDeclaration")
cSharp_SetAccessorDeclaration = Class(name="cSharp_SetAccessorDeclaration")
cSharp_MethodHeader = Class(name="cSharp_MethodHeader")
cSharp_FixedParameters = Class(name="cSharp_FixedParameters")
FormalParameterList = Class(name="FormalParameterList")
cSharp_FixedParameter = Class(name="cSharp_FixedParameter")
DelegateDeclaration = Class(name="DelegateDeclaration")
cSharp_SelectionStatement = Class(name="cSharp_SelectionStatement")
cSharp_IterationStatement = Class(name="cSharp_IterationStatement")
cSharp_JumpStatement = Class(name="cSharp_JumpStatement")
cSharp_TryStatement = Class(name="cSharp_TryStatement")
cSharp_Statement = Class(name="cSharp_Statement")
cSharp_LabeledStatement = Class(name="cSharp_LabeledStatement")
cSharp_DeclarationStatment = Class(name="cSharp_DeclarationStatment")
cSharp_EmbeddedStatement = Class(name="cSharp_EmbeddedStatement")
cSharp_LocalVariableDeclaration = Class(name="cSharp_LocalVariableDeclaration")
cSharp_LocalconstantDeclaration = Class(name="cSharp_LocalconstantDeclaration")
cSharp_StatementExpression = Class(name="cSharp_StatementExpression")
cSharp_Block = Class(name="cSharp_Block")
cSharp_LockStatement = Class(name="cSharp_LockStatement")
cSharp_UsingStatement = Class(name="cSharp_UsingStatement")
cSharp_ResourceAquisition = Class(name="cSharp_ResourceAquisition")
cSharp_ReturnStatement = Class(name="cSharp_ReturnStatement")
cSharp_ThrowStatement = Class(name="cSharp_ThrowStatement")
cSharp_CatchClauses = Class(name="cSharp_CatchClauses")
cSharp_FinallyClause = Class(name="cSharp_FinallyClause")
cSharp_SpecificCatchClause = Class(name="cSharp_SpecificCatchClause")
cSharp_GeneralCatchclause = Class(name="cSharp_GeneralCatchclause")
cSharp_BreakStatement = Class(name="cSharp_BreakStatement")
cSharp_ContinueStatement = Class(name="cSharp_ContinueStatement")
cSharp_GotoStatement = Class(name="cSharp_GotoStatement")
cSharp_WhileStatement = Class(name="cSharp_WhileStatement")
cSharp_DoStatement = Class(name="cSharp_DoStatement")
cSharp_ForStatement = Class(name="cSharp_ForStatement")
cSharp_ForeachStatement = Class(name="cSharp_ForeachStatement")
cSharp_ForInitializer = Class(name="cSharp_ForInitializer")
cSharp_StatementExpressionList = Class(name="cSharp_StatementExpressionList")
cSharp_IfStatement = Class(name="cSharp_IfStatement")
cSharp_SwitchStatement = Class(name="cSharp_SwitchStatement")
cSharp_SwitchSection = Class(name="cSharp_SwitchSection")
cSharp_SwitchLabel = Class(name="cSharp_SwitchLabel")
cSharp_ElsePart = Class(name="cSharp_ElsePart")
...
cSharp_SByte = Class(name="cSharp_SByte")
IntegralType = Class(name="IntegralType")
cSharp_Byte = Class(name="cSharp_Byte")
cSharp_Short = Class(name="cSharp_Short")
cSharp_UShort = Class(name="cSharp_UShort")
cSharp_Int = Class(name="cSharp_Int")
cSharp_UInt = Class(name="cSharp_UInt")
cSharp_Long = Class(name="cSharp_Long")
cSharp_ULong = Class(name="cSharp_ULong")
cSharp_Char = Class(name="cSharp_Char")
cSharp_Bool = Class(name="cSharp_Bool")
cSharp_Decimal = Class(name="cSharp_Decimal")
cSharp_Float = Class(name="cSharp_Float")
cSharp_Double = Class(name="cSharp_Double")
cSharp_Object = Class(name="cSharp_Object")
BuiltInClassType = Class(name="BuiltInClassType")
cSharp_String = Class(name="cSharp_String")
cSharp_Void = Class(name="cSharp_Void")
...
cSharp_PrimaryExpression.attributes={cSharp_PrimaryExpression_literal, cSharp_PrimaryExpression_predefinedType, cSharp_PrimaryExpression_rankSpecifier}
...
cSharp_StatementExpression.attributes={cSharp_StatementExpression_incrimentDecrement, cSharp_StatementExpression_assignementOperator}
...
finally_575: BinaryAssociation = BinaryAssociation(
    name="finally_575",
    ends={
...
domain_model = DomainModel(
    name="cSharp",
    types={cSharp_AttributeList, cSharp_Attributes, cSharp_AttributeSection, AttributeSection, cSharp_Attribute, cSharp_CompilationUnit, cSharp_UsingDirective, cSharp_GlobalAttributes, cSharp_NamespaceMemberDeclaration, cSharp_Identifier, cSharp_QualifiedIdentifier, cSharp_ArrayType, cSharp_GlobalAttributeSection, cSharp_AttributeName, cSharp_AttributeArguments, cSharp_ExpressionList, cSharp_Expression, VariableInitializer, Argument, ResourceAquisition, cSharp_UnaryExpression, cSharp_Expression2, cSharp_PrimaryExpression, cSharp_NonArrayType, cSharp_BuiltInType, cSharp_Type, EventDeclaration, PropertyDeclaration, FieldDeclaration, ConstantDeclaration, cSharp_VariableDeclarator, cSharp_ArrayInitializer, cSharp_ArgumentList, cSharp_TypeOrVoid, cSharp_PrimaryExpression2, cSharp_VariableInitializer, cSharp_NamespaceBody, cSharp_ClassDeclaration, cSharp_EventAccessorDeclarations, cSharp_AccessorDeclarations, cSharp_ConstantDeclarator, cSharp_IntegralType, BuiltInType, ArrayType, cSharp_BuiltInClassType, ClassBase, cSharp_QualifiedIdentifierList, cSharp_NamespaceDeclaration, cSharp_TypeDeclaration, cSharp_InterfaceIndexerDeclaration, cSharp_InterfacePropertyDeclaration, cSharp_FormalParameterList, cSharp_InterfaceDeclaration, cSharp_EnumDeclaration, cSharp_DelegateDeclaration, cSharp_EnumBody, cSharp_EnumMemberDeclaration, cSharp_InterfaceBody, cSharp_InterfaceMemberDeclaration, cSharp_InterfaceMethodDeclaration, cSharp_InterfaceEventDeclaration, cSharp_ClassBase, cSharp_ClassBody, cSharp_ClassMemberDeclaration, cSharp_InterfaceAccessors, cSharp_ConstructorInitializer, ConstructorInitializer, cSharp_Argument, cSharp_FieldDeclaration, cSharp_MethodDeclaration, cSharp_ConstantDeclaration, cSharp_PropertyDeclaration, cSharp_EventDeclaration, cSharp_IndexerDeclaration, cSharp_OperatorDeclaration, cSharp_ConstructorDeclaration, cSharp_DestructorDeclaration, cSharp_StaticConstructorDeclaration, cSharp_MaybeEmptyBlock, cSharp_ConstructorDeclarator, cSharp_IndexerDeclarator, cSharp_OperatorDeclarator, cSharp_ConversionOperatorDeclarator, OperatorDeclarator, cSharp_BinaryOperatorDeclarator, cSharp_UnaryOperatorDeclarator, cSharp_ParameterArray, cSharp_AddAccessorDeclaration, cSharp_RemoveAccessorDeclaration, cSharp_GetAccessorDeclaration, cSharp_SetAccessorDeclaration, cSharp_MethodHeader, cSharp_FixedParameters, FormalParameterList, cSharp_FixedParameter, DelegateDeclaration, cSharp_SelectionStatement, cSharp_IterationStatement, cSharp_JumpStatement, cSharp_TryStatement, cSharp_Statement, cSharp_LabeledStatement, cSharp_DeclarationStatment, cSharp_EmbeddedStatement, cSharp_LocalVariableDeclaration, cSharp_LocalconstantDeclaration, cSharp_StatementExpression, cSharp_Block, cSharp_LockStatement, cSharp_UsingStatement, cSharp_ResourceAquisition, cSharp_ReturnStatement, cSharp_ThrowStatement, cSharp_CatchClauses, cSharp_FinallyClause, cSharp_SpecificCatchClause, cSharp_GeneralCatchclause, cSharp_BreakStatement, cSharp_ContinueStatement, cSharp_GotoStatement, cSharp_WhileStatement, cSharp_DoStatement, cSharp_ForStatement, cSharp_ForeachStatement, cSharp_ForInitializer, cSharp_StatementExpressionList, cSharp_IfStatement, cSharp_SwitchStatement, cSharp_SwitchSection, cSharp_SwitchLabel, cSharp_ElsePart, RemoveAccessorDeclaration, AddAccessorDeclaration, MaybeEmptyBlock, SetAccessorDeclaration, GetAccessorDeclaration, cSharp_SByte, IntegralType, cSharp_Byte, cSharp_Short, cSharp_UShort, cSharp_Int, cSharp_UInt, cSharp_Long, cSharp_ULong, cSharp_Char, cSharp_Bool, cSharp_Decimal, cSharp_Float, cSharp_Double, cSharp_Object, BuiltInClassType, cSharp_String, cSharp_Void, TypeOrVoid},
    associations={attributes11, attributes13, attribute14, usingDirectives0, globalAtt1, nameSpaces3, name5, usings7, globalAttSections9, exp265, ampExp67, ampExp271, equalityExp73, equalityExp277, attributes16, name19, attArguments21, expresionList23, expression25, expressions27, unary30, exp33, exp235, interExp37, interExp241, pipelineExp43, pipelineExp247, inExp49, inExp253, barExp55, barExp259, exp61, type117, unaryExp120, primaryExp122, nonArrayType124, expressionList126, relopExp79, relopExp283, buildInType85, shiftExp87, shiftExp291, operatorExp93, operatorExp297, multipExp99, multipExp2103, divExp105, divExp2109, modExp111, modExp2115, nonArray171, variableDeclarator174, variableDeclarators176, arrayInitializer129, arrayType131, arrayInitializer2133, tipo136, argumentList139, id141, expression144, typeOrVoid147, primaryExoression2149, id151, argumentList154, expressionList157, primaryExpression2161, variableInitalizer163, variableInitalizers165, qualifiedId168, qId217, nameBody220, usingDirectives222, nameSpaces225, qIdent179, eventAccessorDeclarations182, qualifiedId184, accDeclarate187, variable189, variables192, constDeclarator195, constDeclarators197, builtType200, qualified203, qID2206, id207, ids210, nameDeclaretion213, typeDeclaration215, type1271, interfaceIndexerDecla274, interProperty276, parameterList278, classDeclaration228, interfaceDeclaration230, enumDeclaration232, delegateDeclaration234, name236, intType239, enumBody241, enumDeclaration243, enumDeclarations245, att248, name251, exp254, name257, qIdentifiers260, interBody263, interfaceMemberDeclarations265, intermethodDeclaration267, interEventDeclaration269, classBase315, classBody317, classAtt319, classDeclaration322, interAccessors280, type282, name285, name288, interAccessor291, att294, newAtt297, otherAtt300, type303, name306, parameterList309, className312, className363, formalList366, constInitializer369, arg371, fieldDeclaration324, methodDeclaration326, constDeclaration328, propertyDeclaration330, eventDeclaration332, indexDeclaration334, typeDeclaration336, opDeclaration339, constructorDeclaration341, destructorDeclaration343, staticDeclaration345, name347, emptyBlock350, name352, emptyBlock355, constrDeclarator358, emptyBlock360, name402, indexerDeclarator405, accDeclaration407, args373, opDeclarator376, emptyBlock378, type381, firstType384, conversionName386, binType389, otherName391, secondType394, secondName397, otherType400, formalParameters450, parameterArray453, att455, type410, formalList413, qualifiedId416, att1419, addAccessor422, att424, removAccessor427, att429, getAcc432, att2434, setAcc437, methodHeader439, maybeEmpty441, typeOrVoid444, qualifiedIdentifier447, exp495, qIDs498, id501, array458, name461, fixParameter464, fixParameters465, Att468, type471, name474, name477, formalParameters480, type483, variableName486, variable489, name492, selectionStat536, iterationStat538, jumpStat540, tryStat542, ids504, labelStat507, declareStat508, embeddedStat510, localVariableDeclaration512, localCOnstant514, tipo516, constDeclarator519, constDeclarators522, id525, stat528, maybeEmpty531, statExp534, exp564, embeddedStat567, block544, lockStat546, usingStat548, resourcAquisition550, embeddedStat552, tipo555, variable558, variables561, returnStat611, throwStat613, expression615, expression618, block570, catchClauses573, finally_575, finallyClause577, block580, speciCatchClause583, genCatchClause585, specCatchClause587, block590, classType593, qualiId596, id599, block602, breakStat605, continueStat607, gotoStat609, statementExpressionList652, embeddedStatement654, localVariableDeclaration657, statementExpressionList660, list663, id621, expression624, whileStatement627, doStatement629, forStatement631, foreachStatement633, tipo635, id638, expression641, embeddedStatement644, forInitializer647, expression649, statement707, expression710, expression713, lists666, tipo669, argumentList672, primaryExpression675, unaryExpression678, expression681, embeddedStatement684, expression687, expression690, embeddedStatement693, ifStatement696, switchStatement698, expression700, switchSection703, switchlabel705, embeddedStatement716, elsePart719, embeddedStatement721, statement724},
    generalizations={gen_cSharp_AttributeList_AttributeSection, gen_cSharp_Expression_VariableInitializer, gen_cSharp_Expression_Argument, gen_cSharp_Expression_ResourceAquisition, gen_cSharp_Type_EventDeclaration, gen_cSharp_Type_PropertyDeclaration, gen_cSharp_Type_FieldDeclaration, gen_cSharp_Type_ConstantDeclaration, gen_cSharp_ArrayInitializer_VariableInitializer, gen_cSharp_IntegralType_BuiltInType, gen_cSharp_NonArrayType_ArrayType, gen_cSharp_BuiltInClassType_BuiltInType, gen_cSharp_BuiltInClassType_ClassBase, gen_cSharp_ArgumentList_ConstructorInitializer, gen_cSharp_ConversionOperatorDeclarator_OperatorDeclarator, gen_cSharp_BinaryOperatorDeclarator_OperatorDeclarator, gen_cSharp_UnaryOperatorDeclarator_OperatorDeclarator, gen_cSharp_FixedParameters_FormalParameterList, gen_cSharp_TypeOrVoid_DelegateDeclaration, gen_cSharp_LocalVariableDeclaration_ResourceAquisition, gen_cSharp_Block_RemoveAccessorDeclaration, gen_cSharp_Block_AddAccessorDeclaration, gen_cSharp_Block_MaybeEmptyBlock, gen_cSharp_MaybeEmptyBlock_SetAccessorDeclaration, gen_cSharp_MaybeEmptyBlock_GetAccessorDeclaration, gen_cSharp_SByte_IntegralType, gen_cSharp_Byte_IntegralType, gen_cSharp_Short_IntegralType, gen_cSharp_UShort_IntegralType, gen_cSharp_Int_IntegralType, gen_cSharp_UInt_IntegralType, gen_cSharp_Long_IntegralType, gen_cSharp_ULong_IntegralType, gen_cSharp_Char_IntegralType, gen_cSharp_Bool_BuiltInType, gen_cSharp_Decimal_BuiltInType, gen_cSharp_Float_BuiltInType, gen_cSharp_Double_BuiltInType, gen_cSharp_Object_BuiltInClassType, gen_cSharp_String_BuiltInClassType, gen_cSharp_Void_TypeOrVoid},
    metadata=None
)
