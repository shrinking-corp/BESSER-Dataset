...
class cSharp_MethodHeader:
    ...
    def __init__(self, modifier: str, cSharp_MethodHeader451: "cSharp_FormalParameterList" = None, cSharp_MethodHeader: "cSharp_MethodDeclaration" = None, cSharp_MethodHeader445: "cSharp_TypeOrVoid" = None, cSharp_MethodHeader448: "cSharp_QualifiedIdentifier" = None):
...
class cSharp_ConstructorDeclarator:
    ...
    pass
class cSharp_MaybeEmptyBlock(SetAccessorDeclaration, GetAccessorDeclaration):
...
class cSharp_ClassDeclaration:
    ...
    def __init__(self, classModifier: str, cSharp_ClassDeclaration: "cSharp_TypeDeclaration" = None, cSharp_ClassDeclaration316: "cSharp_ClassBase" = None, cSharp_ClassDeclaration318: "cSharp_ClassBody" = None, cSharp_ClassDeclaration313: "cSharp_Identifier" = None):
...
class EventDeclaration:
    ...
    pass
class cSharp_Type(ConstantDeclaration, PropertyDeclaration, EventDeclaration, FieldDeclaration):
...
class cSharp_ArrayInitializer(VariableInitializer):
    ...
    pass
class cSharp_Expression(VariableInitializer, ResourceAquisition, Argument):
