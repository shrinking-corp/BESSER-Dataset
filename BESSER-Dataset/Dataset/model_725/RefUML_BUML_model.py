...
# Classes
RefUML_Comment = Class(name="RefUML_Comment")
Element = Class(name="Element")
RefUML_Element = Class(name="RefUML_Element", is_abstract=True)
EModelElement = Class(name="EModelElement")
RefUML_Package = Class(name="RefUML_Package")
Namespace = Class(name="Namespace")
PackageableElement = Class(name="PackageableElement")
RefUML_Type = Class(name="RefUML_Type", is_abstract=True)
RefUML_PackageMerge = Class(name="RefUML_PackageMerge")
RefUML_PackageableElement = Class(name="RefUML_PackageableElement", is_abstract=True)
NamedElement = Class(name="NamedElement")
RefUML_NamedElement = Class(name="RefUML_NamedElement", is_abstract=True)
RefUML_DirectedRelationship = Class(name="RefUML_DirectedRelationship", is_abstract=True)
Relationship = Class(name="Relationship")
RefUML_Dependency = Class(name="RefUML_Dependency")
RefUML_Namespace = Class(name="RefUML_Namespace", is_abstract=True)
RefUML_StringExpression = Class(name="RefUML_StringExpression")
DirectedRelationship = Class(name="DirectedRelationship")
RefUML_Relationship = Class(name="RefUML_Relationship", is_abstract=True)
RefUML_ElementImport = Class(name="RefUML_ElementImport")
RefUML_PackageImport = Class(name="RefUML_PackageImport")
RefUML_Constraintx = Class(name="RefUML_Constraintx")
RefUML_ValueSpecification = Class(name="RefUML_ValueSpecification", is_abstract=True)
TypedElement = Class(name="TypedElement")
RefUML_TypedElement = Class(name="RefUML_TypedElement", is_abstract=True)
RefUML_Classifier = Class(name="RefUML_Classifier", is_abstract=True)
RedefinableElement = Class(name="RedefinableElement")
Type = Class(name="Type")
RefUML_Association = Class(name="RefUML_Association")
Classifier = Class(name="Classifier")
RefUML_Property = Class(name="RefUML_Property")
RefUML_Generalization = Class(name="RefUML_Generalization")
RefUML_GeneralizationSet = Class(name="RefUML_GeneralizationSet")
RefUML_Feature = Class(name="RefUML_Feature", is_abstract=True)
RefUML_RedefinableElement = Class(name="RefUML_RedefinableElement", is_abstract=True)
RefUML_MultiplicityElement = Class(name="RefUML_MultiplicityElement", is_abstract=True)
RefUML_OpaqueExpression = Class(name="RefUML_OpaqueExpression")
ValueSpecification = Class(name="ValueSpecification")
StructuralFeature = Class(name="StructuralFeature")
RefUML_DataType = Class(name="RefUML_DataType")
RefUML_Class = Class(name="RefUML_Class")
RefUML_Model = Class(name="RefUML_Model")
Package = Class(name="Package")
RefUML_StructuralFeature = Class(name="RefUML_StructuralFeature", is_abstract=True)
Feature = Class(name="Feature")
MultiplicityElement = Class(name="MultiplicityElement")
RefUML_Enumeration = Class(name="RefUML_Enumeration")
DataType = Class(name="DataType")
Expression = Class(name="Expression")
RefUML_Expression = Class(name="RefUML_Expression")
RefUML_EnumerationLiteral = Class(name="RefUML_EnumerationLiteral")
InstanceSpecification = Class(name="InstanceSpecification")
RefUML_InstanceSpecification = Class(name="RefUML_InstanceSpecification")
RefUML_Slot = Class(name="RefUML_Slot")
RefUML_LiteralString = Class(name="RefUML_LiteralString")
RefUML_PrimitiveType = Class(name="RefUML_PrimitiveType")
RefUML_LiteralSpecification = Class(name="RefUML_LiteralSpecification", is_abstract=True)
RefUML_LiteralInteger = Class(name="RefUML_LiteralInteger")
LiteralSpecification = Class(name="LiteralSpecification")
RefUML_LiteralNull = Class(name="RefUML_LiteralNull")
RefUML_InstanceValue = Class(name="RefUML_InstanceValue")
RefUML_LiteralBoolean = Class(name="RefUML_LiteralBoolean")
RefUML_LiteralUnlimitedNatural = Class(name="RefUML_LiteralUnlimitedNatural")
...
RefUML_Element_m_hasKeyword: Method = Method(name="hasKeyword", parameters={Parameter(name='RefUML_keyword', type=StringType)}, type=StringType)
...
RefUML_Element_m_getRelationships: Method = Method(name="getRelationships", parameters={Parameter(name='RefUML_eClass', type=StringType)}, type=StringType)
RefUML_Element_m_addKeyword: Method = Method(name="addKeyword", parameters={Parameter(name='RefUML_keyword', type=StringType)}, type=StringType)
RefUML_Element_m_removeKeyword: Method = Method(name="removeKeyword", parameters={Parameter(name='RefUML_keyword', type=StringType)}, type=StringType)
...
RefUML_Element_m_getApplicableStereotype: Method = Method(name="getApplicableStereotype", parameters={Parameter(name='RefUML_qualifiedName', type=StringType)})
RefUML_Element_m_getStereotypeApplications: Method = Method(name="getStereotypeApplications", parameters={}, type=StringType)
RefUML_Element_m_getRequiredStereotype: Method = Method(name="getRequiredStereotype", parameters={Parameter(name='RefUML_qualifiedName', type=StringType)})
RefUML_Element_m_getAppliedStereotype: Method = Method(name="getAppliedStereotype", parameters={Parameter(name='RefUML_qualifiedName', type=StringType)})
RefUML_Element_m_createEAnnotation: Method = Method(name="createEAnnotation", parameters={Parameter(name='RefUML_source', type=StringType)}, type=StringType)
...
RefUML_Element_m_getSourceDirectedRelationships: Method = Method(name="getSourceDirectedRelationships", parameters={Parameter(name='RefUML_eClass', type=StringType)}, type=StringType)
...
RefUML_Element_m_getTargetDirectedRelationships: Method = Method(name="getTargetDirectedRelationships", parameters={Parameter(name='RefUML_eClass', type=StringType)}, type=StringType)
...
RefUML_Element.methods={RefUML_Element_m_getRelationships, RefUML_Element_m_getRequiredStereotype, RefUML_Element_m_getTargetDirectedRelationships, RefUML_Element_m_removeKeyword, RefUML_Element_m_getStereotypeApplications, RefUML_Element_m_getAppliedStereotype, RefUML_Element_m_mustBeOwned, RefUML_Element_m_getSourceDirectedRelationships, RefUML_Element_m_getApplicableStereotype, RefUML_Element_m_addKeyword, RefUML_Element_m_hasKeyword, RefUML_Element_m_getSourceDirectedRelationships, RefUML_Element_m_destroy, RefUML_Element_m_getRelationships, RefUML_Element_m_getNearestPackage, RefUML_Element_m_getKeywords, RefUML_Element_m_getTargetDirectedRelationships, RefUML_Element_m_createEAnnotation, RefUML_Element_m_allOwnedElements, RefUML_Element_m_getModel}

# EModelElement class attributes and methods

# RefUML_Package class attributes and methods
RefUML_Package_m_createOwnedEnumeration: Method = Method(name="createOwnedEnumeration", parameters={Parameter(name='RefUML_name', type=StringType)}, type=StringType)
RefUML_Package_m_createOwnedPrimitiveType: Method = Method(name="createOwnedPrimitiveType", parameters={Parameter(name='RefUML_name', type=StringType)}, type=StringType)
RefUML_Package_m_createOwnedClass: Method = Method(name="createOwnedClass", parameters={Parameter(name='RefUML_isAbstract', type=StringType), Parameter(name='RefUML_name', type=StringType)}, type=StringType)
RefUML_Package_m_createOwnedInterface: Method = Method(name="createOwnedInterface", parameters={Parameter(name='RefUML_name', type=StringType)})
RefUML_Package_m_getAppliedProfile: Method = Method(name="getAppliedProfile", parameters={Parameter(name='RefUML_qualifiedName', type=StringType)})
RefUML_Package_m_getAppliedProfile: Method = Method(name="getAppliedProfile", parameters={Parameter(name='RefUML_qualifiedName', type=StringType), Parameter(name='RefUML_recurse', type=StringType)})
...
RefUML_Package_m_makesVisible: Method = Method(name="makesVisible", parameters={Parameter(name='RefUML_el', type=StringType)}, type=StringType)
RefUML_Package.methods={RefUML_Package_m_getAppliedProfile, RefUML_Package_m_createOwnedEnumeration, RefUML_Package_m_createOwnedClass, RefUML_Package_m_visibleMembers, RefUML_Package_m_isModelLibrary, RefUML_Package_m_createOwnedInterface, RefUML_Package_m_getAppliedProfile, RefUML_Package_m_createOwnedPrimitiveType, RefUML_Package_m_makesVisible}
...
RefUML_Type_m_conformsTo: Method = Method(name="conformsTo", parameters={Parameter(name='RefUML_other', type=StringType)}, type=StringType)
RefUML_Type_m_createAssociation: Method = Method(name="createAssociation", parameters={Parameter(name='RefUML_end1Type', type=StringType), Parameter(name='RefUML_end1Aggregation', type=StringType), Parameter(name='RefUML_end2Name', type=StringType), Parameter(name='RefUML_end1Upper', type=StringType), Parameter(name='RefUML_end2Aggregation', type=StringType), Parameter(name='RefUML_end2Upper', type=StringType), Parameter(name='RefUML_end2IsNavigable', type=StringType), Parameter(name='RefUML_end1Lower', type=StringType), Parameter(name='RefUML_end2Lower', type=StringType), Parameter(name='RefUML_end1Name', type=StringType), Parameter(name='RefUML_end1IsNavigable', type=StringType)}, type=StringType)
...
RefUML_NamedElement_m_isDistinguishableFrom: Method = Method(name="isDistinguishableFrom", parameters={Parameter(name='RefUML_ns', type=StringType), Parameter(name='RefUML_n', type=StringType)}, type=StringType)
...
RefUML_NamedElement_m_createDependency: Method = Method(name="createDependency", parameters={Parameter(name='RefUML_supplier', type=StringType)}, type=StringType)
RefUML_NamedElement_m_getLabel: Method = Method(name="getLabel", parameters={}, type=StringType)
RefUML_NamedElement_m_getLabel: Method = Method(name="getLabel", parameters={Parameter(name='RefUML_localize', type=StringType)}, type=StringType)
RefUML_NamedElement_m_createUsage: Method = Method(name="createUsage", parameters={Parameter(name='RefUML_supplier', type=StringType)})
...
RefUML_NamedElement.attributes={RefUML_NamedElement_qualifiedName, RefUML_NamedElement_name, RefUML_NamedElement_visibility}
RefUML_NamedElement.methods={RefUML_NamedElement_m_createUsage, RefUML_NamedElement_m_separator, RefUML_NamedElement_m_allOwningPackages, RefUML_NamedElement_m_getLabel, RefUML_NamedElement_m_allNamespaces, RefUML_NamedElement_m_getQualifiedName, RefUML_NamedElement_m_isDistinguishableFrom, RefUML_NamedElement_m_createDependency, RefUML_NamedElement_m_getLabel}
...
RefUML_Namespace_m_getNamesOfMember: Method = Method(name="getNamesOfMember", parameters={Parameter(name='RefUML_element', type=StringType)}, type=StringType)
RefUML_Namespace_m_createElementImport: Method = Method(name="createElementImport", parameters={Parameter(name='RefUML_element', type=StringType), Parameter(name='RefUML_visibility', type=StringType)}, type=StringType)
RefUML_Namespace_m_createPackageImport: Method = Method(name="createPackageImport", parameters={Parameter(name='RefUML_package_', type=StringType), Parameter(name='RefUML_visibility', type=StringType)}, type=StringType)
RefUML_Namespace_m_membersAreDistinguishable: Method = Method(name="membersAreDistinguishable", parameters={}, type=StringType)
RefUML_Namespace_m_importMembers: Method = Method(name="importMembers", parameters={Parameter(name='RefUML_imps', type=StringType)}, type=PackageableElement)
RefUML_Namespace_m_excludeCollisions: Method = Method(name="excludeCollisions", parameters={Parameter(name='RefUML_imps', type=StringType)}, type=PackageableElement)
RefUML_Namespace.methods={RefUML_Namespace_m_getImportedMembers, RefUML_Namespace_m_getImportedElements, RefUML_Namespace_m_createPackageImport, RefUML_Namespace_m_getNamesOfMember, RefUML_Namespace_m_membersAreDistinguishable, RefUML_Namespace_m_createElementImport, RefUML_Namespace_m_getImportedPackages, RefUML_Namespace_m_importMembers, RefUML_Namespace_m_excludeCollisions}
...
RefUML_ValueSpecification.methods={RefUML_ValueSpecification_m_booleanValue, RefUML_ValueSpecification_m_integerValue, RefUML_ValueSpecification_m_isNull, RefUML_ValueSpecification_m_stringValue, RefUML_ValueSpecification_m_isComputable, RefUML_ValueSpecification_m_unlimitedValue}
...
RefUML_Classifier_m_maySpecializeType: Method = Method(name="maySpecializeType", parameters={Parameter(name='RefUML_c', type=StringType)}, type=StringType)
...
RefUML_Classifier_m_inheritableMembers: Method = Method(name="inheritableMembers", parameters={Parameter(name='RefUML_c', type=StringType)}, type=NamedElement)
RefUML_Classifier_m_hasVisibilityOf: Method = Method(name="hasVisibilityOf", parameters={Parameter(name='RefUML_n', type=StringType)}, type=StringType)
RefUML_Classifier_m_conformsTo: Method = Method(name="conformsTo", parameters={Parameter(name='RefUML_other', type=StringType)}, type=StringType)
RefUML_Classifier_m_inherit: Method = Method(name="inherit", parameters={Parameter(name='RefUML_inhs', type=StringType)}, type=NamedElement)
RefUML_Classifier.attributes={RefUML_Classifier_isAbstract}
RefUML_Classifier.methods={RefUML_Classifier_m_hasVisibilityOf, RefUML_Classifier_m_hasKindAncestor, RefUML_Classifier_m_parents, RefUML_Classifier_m_allParents, RefUML_Classifier_m_maySpecializeType, RefUML_Classifier_m_hasCollectiveAncestor, RefUML_Classifier_m_hasQuantityOffspring, RefUML_Classifier_m_hasKindOffspring, RefUML_Classifier_m_hasFunctionalComplexInstances, RefUML_Classifier_m_inheritableMembers, RefUML_Classifier_m_hasQuantityInstances, RefUML_Classifier_m_getAllAttributes, RefUML_Classifier_m_hasCollectiveOffspring, RefUML_Classifier_m_conformsTo, RefUML_Classifier_m_inherit, RefUML_Classifier_m_hasQuantityAncestor, RefUML_Classifier_m_getGenerals, RefUML_Classifier_m_hasCollectiveInstances, RefUML_Classifier_m_getInheritedMembers, RefUML_Classifier_m_allFeatures}
...
RefUML_Association.methods={RefUML_Association_m_getEndTypes, RefUML_Association_m_isBinary}
...
RefUML_Property_m_setOpposite: Method = Method(name="setOpposite", parameters={Parameter(name='RefUML_newOpposite', type=StringType)})
RefUML_Property_m_unsetDefault: Method = Method(name="unsetDefault", parameters={})
RefUML_Property_m_setIsNavigable: Method = Method(name="setIsNavigable", parameters={Parameter(name='RefUML_isNavigable', type=StringType)})
RefUML_Property_m_getOtherEnd: Method = Method(name="getOtherEnd", parameters={}, type=StringType)
RefUML_Property_m_setBooleanDefaultValue: Method = Method(name="setBooleanDefaultValue", parameters={Parameter(name='RefUML_value', type=StringType)})
RefUML_Property_m_setIntegerDefaultValue: Method = Method(name="setIntegerDefaultValue", parameters={Parameter(name='RefUML_value', type=StringType)})
RefUML_Property_m_setStringDefaultValue: Method = Method(name="setStringDefaultValue", parameters={Parameter(name='RefUML_value', type=StringType)})
...
RefUML_Property_m_setDefault: Method = Method(name="setDefault", parameters={Parameter(name='RefUML_newDefault', type=StringType)})
RefUML_Property_m_setIsComposite: Method = Method(name="setIsComposite", parameters={Parameter(name='RefUML_newIsComposite', type=StringType)})
RefUML_Property_m_setUnlimitedNaturalDefaultValue: Method = Method(name="setUnlimitedNaturalDefaultValue", parameters={Parameter(name='RefUML_value', type=StringType)})
RefUML_Property_m_setNullDefaultValue: Method = Method(name="setNullDefaultValue", parameters={})
RefUML_Property_m_isAttribute: Method = Method(name="isAttribute", parameters={Parameter(name='RefUML_p', type=StringType)}, type=StringType)
...
RefUML_Property.attributes={RefUML_Property_default, RefUML_Property_aggregation, RefUML_Property_isComposite, RefUML_Property_isDerived, RefUML_Property_isDerivedUnion}
RefUML_Property.methods={RefUML_Property_m_isComposite, RefUML_Property_m_setStringDefaultValue, RefUML_Property_m_subsettingContext, RefUML_Property_m_getOtherEnd, RefUML_Property_m_setNullDefaultValue, RefUML_Property_m_isSetDefault, RefUML_Property_m_unsetDefault, RefUML_Property_m_isAttribute, RefUML_Property_m_setIsComposite, RefUML_Property_m_getDefault, RefUML_Property_m_setIntegerDefaultValue, RefUML_Property_m_setOpposite, RefUML_Property_m_setUnlimitedNaturalDefaultValue, RefUML_Property_m_isNavigable, RefUML_Property_m_getOpposite, RefUML_Property_m_setIsNavigable, RefUML_Property_m_setBooleanDefaultValue, RefUML_Property_m_setDefault}
...
RefUML_GeneralizationSet.attributes={RefUML_GeneralizationSet_isCovering, RefUML_GeneralizationSet_isDisjoint}
...
RefUML_RedefinableElement_m_isConsistentWith: Method = Method(name="isConsistentWith", parameters={Parameter(name='RefUML_redefinee', type=StringType)}, type=StringType)
RefUML_RedefinableElement_m_isRedefinitionContextValid: Method = Method(name="isRedefinitionContextValid", parameters={Parameter(name='RefUML_redefined', type=StringType)}, type=StringType)
...
RefUML_MultiplicityElement_m_setLower: Method = Method(name="setLower", parameters={Parameter(name='RefUML_newLower', type=StringType)})
RefUML_MultiplicityElement_m_is: Method = Method(name="is", parameters={Parameter(name='RefUML_upperbound', type=StringType), Parameter(name='RefUML_lowerbound', type=StringType)}, type=StringType)
RefUML_MultiplicityElement_m_setUpper: Method = Method(name="setUpper", parameters={Parameter(name='RefUML_newUpper', type=StringType)})
...
RefUML_MultiplicityElement_m_includesCardinality: Method = Method(name="includesCardinality", parameters={Parameter(name='RefUML_C', type=StringType)}, type=StringType)
RefUML_MultiplicityElement_m_includesMultiplicity: Method = Method(name="includesMultiplicity", parameters={Parameter(name='RefUML_M', type=StringType)}, type=StringType)
...
RefUML_MultiplicityElement_m_compatibleWith: Method = Method(name="compatibleWith", parameters={Parameter(name='RefUML_other', type=StringType)}, type=StringType)
RefUML_MultiplicityElement.attributes={RefUML_MultiplicityElement_isUnique, RefUML_MultiplicityElement_isOrdered, RefUML_MultiplicityElement_lower, RefUML_MultiplicityElement_upper}
RefUML_MultiplicityElement.methods={RefUML_MultiplicityElement_m_setLower, RefUML_MultiplicityElement_m_getLower, RefUML_MultiplicityElement_m_includesMultiplicity, RefUML_MultiplicityElement_m_upperBound, RefUML_MultiplicityElement_m_is, RefUML_MultiplicityElement_m_getUpper, RefUML_MultiplicityElement_m_isMultivalued, RefUML_MultiplicityElement_m_setUpper, RefUML_MultiplicityElement_m_includesCardinality, RefUML_MultiplicityElement_m_compatibleWith, RefUML_MultiplicityElement_m_lowerBound}
...
RefUML_OpaqueExpression.methods={RefUML_OpaqueExpression_m_isPositive, RefUML_OpaqueExpression_m_value, RefUML_OpaqueExpression_m_getResult, RefUML_OpaqueExpression_m_isNonNegative, RefUML_OpaqueExpression_m_isIntegral}
...
RefUML_DataType_m_createOwnedOperation: Method = Method(name="createOwnedOperation", parameters={Parameter(name='RefUML_name', type=StringType), Parameter(name='RefUML_parameterTypes', type=StringType), Parameter(name='RefUML_parameterNames', type=StringType), Parameter(name='RefUML_returnType', type=StringType)})
RefUML_DataType_m_createOwnedAttribute: Method = Method(name="createOwnedAttribute", parameters={Parameter(name='RefUML_type', type=StringType), Parameter(name='RefUML_upper', type=StringType), Parameter(name='RefUML_name', type=StringType), Parameter(name='RefUML_lower', type=StringType)}, type=StringType)
...
RefUML_Class_m_createOwnedOperation: Method = Method(name="createOwnedOperation", parameters={Parameter(name='RefUML_parameterTypes', type=StringType), Parameter(name='RefUML_parameterNames', type=StringType), Parameter(name='RefUML_returnType', type=StringType), Parameter(name='RefUML_name', type=StringType)})
...
ownedAttribute124: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="class_", type=RefUML_Property, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
domain_model = DomainModel(
    name="RefUML",
    types={RefUML_Comment, Element, RefUML_Element, EModelElement, RefUML_Package, Namespace, PackageableElement, RefUML_Type, RefUML_PackageMerge, RefUML_PackageableElement, NamedElement, RefUML_NamedElement, RefUML_DirectedRelationship, Relationship, RefUML_Dependency, RefUML_Namespace, RefUML_StringExpression, DirectedRelationship, RefUML_Relationship, RefUML_ElementImport, RefUML_PackageImport, RefUML_Constraintx, RefUML_ValueSpecification, TypedElement, RefUML_TypedElement, RefUML_Classifier, RedefinableElement, Type, RefUML_Association, Classifier, RefUML_Property, RefUML_Generalization, RefUML_GeneralizationSet, RefUML_Feature, RefUML_RedefinableElement, RefUML_MultiplicityElement, RefUML_OpaqueExpression, ValueSpecification, StructuralFeature, RefUML_DataType, RefUML_Class, RefUML_Model, Package, RefUML_StructuralFeature, Feature, MultiplicityElement, RefUML_Enumeration, DataType, Expression, RefUML_Expression, RefUML_EnumerationLiteral, InstanceSpecification, RefUML_InstanceSpecification, RefUML_Slot, RefUML_LiteralString, RefUML_PrimitiveType, RefUML_LiteralSpecification, RefUML_LiteralInteger, LiteralSpecification, RefUML_LiteralNull, RefUML_InstanceValue, RefUML_LiteralBoolean, RefUML_LiteralUnlimitedNatural, VisibilityKind, AggregationKind},
    associations={annotatedElement0, ownedComment6, ownedElement2, owner4, nestedPackage13, nestingPackage15, ownedType9, packageMerge10, packagedElement11, client22, source23, clientDependency17, namespace18, nameExpression19, supplier20, target25, relatedElement28, member34, importedMember36, ownedMember39, elementImport30, packageImport31, ownedRule33, importingNamespace47, constrainedElement49, specification51, context53, importedElement41, importingNamespace43, importedPackage45, package56, type55, memberEnd59, endType61, navigableOwnedEnd63, ownedEnd58, redefinedClassifier71, general74, attribute76, generalization65, powertypeExtent66, feature67, inheritedMember68, generalizationSet86, specific88, powertype90, redefinedElement80, redefinitionContext81, general84, generalization92, featuringClassifier94, upperValue96, lowerValue98, datatype102, class_101, subsettedProperty115, association117, redefinedProperty105, owningAssociation107, defaultValue108, opposite112, superClass122, ownedAttribute124, nestedClassifier119, ownedAttribute126, mergedPackage135, receivingPackage137, subExpression129, owningExpression131, operand133, slot143, specification144, ownedLiteral139, enumeration140, classifier141, definingFeature147, value148, owningInstance151, instance152},
    generalizations={gen_RefUML_Comment_Element, gen_RefUML_Element_EModelElement, gen_RefUML_Package_Namespace, gen_RefUML_Package_PackageableElement, gen_RefUML_PackageableElement_NamedElement, gen_RefUML_NamedElement_Element, gen_RefUML_DirectedRelationship_Relationship, gen_RefUML_Dependency_PackageableElement, gen_RefUML_Dependency_DirectedRelationship, gen_RefUML_Relationship_Element, gen_RefUML_Namespace_NamedElement, gen_RefUML_ElementImport_DirectedRelationship, gen_RefUML_Constraintx_PackageableElement, gen_RefUML_ValueSpecification_PackageableElement, gen_RefUML_ValueSpecification_TypedElement, gen_RefUML_PackageImport_DirectedRelationship, gen_RefUML_TypedElement_NamedElement, gen_RefUML_Type_PackageableElement, gen_RefUML_Classifier_Namespace, gen_RefUML_Classifier_RedefinableElement, gen_RefUML_Classifier_Type, gen_RefUML_Association_Classifier, gen_RefUML_Association_Relationship, gen_RefUML_GeneralizationSet_PackageableElement, gen_RefUML_RedefinableElement_NamedElement, gen_RefUML_Generalization_DirectedRelationship, gen_RefUML_MultiplicityElement_Element, gen_RefUML_Feature_RedefinableElement, gen_RefUML_OpaqueExpression_ValueSpecification, gen_RefUML_Property_StructuralFeature, gen_RefUML_Class_Classifier, gen_RefUML_Model_Package, gen_RefUML_StructuralFeature_Feature, gen_RefUML_StructuralFeature_TypedElement, gen_RefUML_StructuralFeature_MultiplicityElement, gen_RefUML_DataType_Classifier, gen_RefUML_PackageMerge_DirectedRelationship, gen_RefUML_Enumeration_DataType, gen_RefUML_StringExpression_Expression, gen_RefUML_Expression_ValueSpecification, gen_RefUML_Slot_Element, gen_RefUML_EnumerationLiteral_InstanceSpecification, gen_RefUML_InstanceSpecification_PackageableElement, gen_RefUML_LiteralString_LiteralSpecification, gen_RefUML_PrimitiveType_DataType, gen_RefUML_LiteralSpecification_ValueSpecification, gen_RefUML_LiteralInteger_LiteralSpecification, gen_RefUML_LiteralNull_LiteralSpecification, gen_RefUML_InstanceValue_ValueSpecification, gen_RefUML_LiteralBoolean_LiteralSpecification, gen_RefUML_LiteralUnlimitedNatural_LiteralSpecification},
    metadata=None
)
