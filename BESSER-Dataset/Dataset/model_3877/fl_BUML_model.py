...
domain_model = DomainModel(
    name="fl",
    types={fl_Binary, fl_Apply, Expr, fl_Expr, fl_Argument, fl_DocumentRoot, fl_EStringToStringMapEntry, fl_ProgramType, fl_Function, fl_IfThenElse, fl_Literal, Ops},
    associations={left1, arg0, right3, xMLNSPrefixMap6, xSISchemaLocation7, fragment10, program13, rhs15, ifExpr17, thenExpr19, elseExpr22, function25},
