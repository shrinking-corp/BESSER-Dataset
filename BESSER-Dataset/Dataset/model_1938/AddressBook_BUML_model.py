...
addressbook_Country = Class(name="addressbook_Country")
addressbook_Address = Class(name="addressbook_Address")
addressbook_FederalState = Class(name="addressbook_FederalState")
...
addressbook_Address.attributes={addressbook_Address_zip, addressbook_Address_street, addressbook_Address_type, addressbook_Address_city}
...
domain_model = DomainModel(
    ...
    associations={person8, federalStates10, addressBook11, persons0, countries1, addresses2, addressBook3, country4, federalState6, country14},
    generalizations={},
    metadata=None
)
