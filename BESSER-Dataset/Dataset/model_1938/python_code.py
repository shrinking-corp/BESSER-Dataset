...
class addressbook_FederalState:
    ...
    def __init__(self, name: str, FederalState: "addressbook_Country" = None, addressbook_FederalState: "addressbook_Address" = None, federalStates: "addressbook_Country" = None):
        self.name = name
...
class addressbook_Address:
    ...
    def __init__(self, type: str, street: str, zip: str, city: str, addresses: "addressbook_Person" = None, Address: "addressbook_Person" = None, addressbook_Address: "addressbook_Country" = None, addressbook_Address7: "addressbook_FederalState" = None):
        self.type = type
        self.street = street
        self.zip = zip
        self.city = city
...
class addressbook_Country:
    ...
    def __init__(self, name: str, country: set["addressbook_FederalState"] = None, addressbook_Country12: "addressbook_AddressBook" = None, addressbook_Country: "addressbook_AddressBook" = None, addressbook_Country5: "addressbook_Address" = None, Country: "addressbook_FederalState" = None):
        self.name = name
...
class addressbook_Person:
    ...
    def __init__(self, firstname: str, lastname: str, Person9: "addressbook_Address" = None, Person: "addressbook_AddressBook" = None, person: set["addressbook_Address"] = None, persons: "addressbook_AddressBook" = None):
