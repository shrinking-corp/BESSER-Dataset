...
class mitra_AnnotationPropertyDecl:
    ...
    def __init__(self, name: str, required: bool, mitra_AnnotationPropertyDecl193: "mitra_AnnotationProperty" = None, mitra_AnnotationPropertyDecl: "mitra_AnnotationDecl" = None, mitra_AnnotationPropertyDecl178: "mitra_PrimitiveType" = None, mitra_AnnotationPropertyDecl181: "mitra_Literal" = None):
        self.name = name
...
class mitra_AnnotationDecl:
    ...
    def __init__(self, name: str, targets: str, many: bool, required: bool, mitra_AnnotationDecl: "mitra_AnnotationsDefinition" = None, mitra_AnnotationDecl172: "mitra_PrimitiveType" = None, mitra_AnnotationDecl174: "mitra_Literal" = None, mitra_AnnotationDecl176: set["mitra_AnnotationPropertyDecl"] = None, mitra_AnnotationDecl185: "mitra_Annotation" = None):
        self.name = name
...
class mitra_NativeOperationInvocation(MethodInvocation):
    ...
    pass
class mitra_FeatureMethodInvocation(MethodInvocation, MetamodelFeature):

    pass
class Feature:

    pass
class mitra_FeatureField(Feature, MetamodelFeature):
...
class mitra_Feature:
    ...
    def __init__(self, name: str, mitra_Feature168: "mitra_StaticAccess" = None, mitra_Feature: "mitra_VariableAccess" = None):
        self.name = name
...
class TerminalExpression:
    ...
    pass
class mitra_VariableAccess(StatementExpression, TerminalExpression):
...
class mitra_ClassInstanceCreationExpression(StatementExpression, TerminalExpression):
...
class mitra_Literal(TerminalExpression):
    ...
    pass
class mitra_RuleInvocationSuper(StatementExpression, TerminalExpression):
...
class mitra_MathExpression(Expression):
    ...
    def __init__(self, op: str, mitra_MathExpression225: "mitra_Expression" = None, mitra_MathExpression: "mitra_Expression" = None):
        self.op = op
...
class mitra_ReferenceType(Type):
    ...
    def __init__(self, mitra_ReferenceType66: "mitra_EClassifier" = None, mitra_ReferenceType: "mitra_MetamodelDeclaration" = None):
...
class mitra_SimpleRuleReference(RuleReference):
    ...
    def __init__(self, mitra_SimpleRuleReference35: set["mitra_SimpleParameterReference"] = None, mitra_SimpleRuleReference37: set["mitra_SimpleParameterReference"] = None, mitra_SimpleRuleReference: "mitra_RuleDeclaration" = None, mitra_SimpleRuleReference22: "mitra_RuleDeclaration" = None, mitra_SimpleRuleReference25: "mitra_RuleDeclaration" = None):
...
class mitra_RuleDeclaration:
    ...
    def __init__(self, visibility: str, exec: str, traced: bool, stealth: bool, virtual: bool, multi: bool, name: str, mitra_RuleDeclaration: "mitra_Module" = None, mitra_RuleDeclaration13: set["mitra_Annotation"] = None, mitra_RuleDeclaration15: set["mitra_FormalParameter"] = None, mitra_RuleDeclaration27: "mitra_Trigger" = None, mitra_RuleDeclaration29: "mitra_JavaSpec" = None, mitra_RuleDeclaration31: "mitra_Block" = None, mitra_RuleDeclaration33: "mitra_RuleReference" = None, mitra_RuleDeclaration17: set["mitra_ReturnParameter"] = None, mitra_RuleDeclaration19: set["mitra_SimpleRuleReference"] = None, mitra_RuleDeclaration21: "mitra_SimpleRuleReference" = None, mitra_RuleDeclaration24: set["mitra_SimpleRuleReference"] = None, mitra_RuleDeclaration144: "mitra_RuleInvocation" = None):
...
class mitra_Module:
    ...
    def __init__(self, packageName: str, name: str, mitra_Module6: set["mitra_RuleDeclaration"] = None, mitra_Module: set["mitra_ModuleReference"] = None, mitra_Module2: set["mitra_MetamodelDeclaration"] = None, mitra_Module4: set["mitra_AnnotationsDefinition"] = None, mitra_Module9: "mitra_ModuleReference" = None):
