...
# Classes
mitra_Module = Class(name="mitra_Module")
mitra_ModuleReference = Class(name="mitra_ModuleReference")
mitra_MetamodelDeclaration = Class(name="mitra_MetamodelDeclaration")
mitra_AnnotationsDefinition = Class(name="mitra_AnnotationsDefinition")
mitra_Property = Class(name="mitra_Property")
mitra_Annotation = Class(name="mitra_Annotation")
mitra_FormalParameter = Class(name="mitra_FormalParameter")
mitra_RuleDeclaration = Class(name="mitra_RuleDeclaration")
mitra_JavaSpec = Class(name="mitra_JavaSpec")
mitra_Block = Class(name="mitra_Block")
mitra_RuleReference = Class(name="mitra_RuleReference")
RuleReference = Class(name="RuleReference")
mitra_SimpleParameterReference = Class(name="mitra_SimpleParameterReference")
mitra_QualifiedRuleReference = Class(name="mitra_QualifiedRuleReference")
mitra_QualifiedParameterReference = Class(name="mitra_QualifiedParameterReference")
mitra_ParameterReference = Class(name="mitra_ParameterReference")
ParameterReference = Class(name="ParameterReference")
mitra_ReturnParameter = Class(name="mitra_ReturnParameter")
mitra_Type = Class(name="mitra_Type")
mitra_SimpleRuleReference = Class(name="mitra_SimpleRuleReference")
mitra_TypedVarDeclaration = Class(name="mitra_TypedVarDeclaration")
mitra_Trigger = Class(name="mitra_Trigger")
mitra_PrimitiveType = Class(name="mitra_PrimitiveType")
mitra_Expression = Class(name="mitra_Expression")
mitra_Parameter = Class(name="mitra_Parameter")
Parameter_ = Class(name="Parameter")
mitra_ReferenceType = Class(name="mitra_ReferenceType")
Type = Class(name="Type")
mitra_EClassifier = Class(name="mitra_EClassifier")
mitra_LocalVariableDeclaration = Class(name="mitra_LocalVariableDeclaration")
mitra_VarDeclaration = Class(name="mitra_VarDeclaration")
mitra_CollectionType = Class(name="mitra_CollectionType")
Statement = Class(name="Statement")
mitra_BlockStatement = Class(name="mitra_BlockStatement")
mitra_Statement = Class(name="mitra_Statement")
BlockStatement = Class(name="BlockStatement")
mitra_ForUpdate = Class(name="mitra_ForUpdate")
mitra_LocalVariableDeclarationStatement = Class(name="mitra_LocalVariableDeclarationStatement")
mitra_ForStatement = Class(name="mitra_ForStatement")
mitra_LoopVariable = Class(name="mitra_LoopVariable")
VarDeclaration = Class(name="VarDeclaration")
mitra_InferredVarDeclaration = Class(name="mitra_InferredVarDeclaration")
mitra_ExpressionStatement = Class(name="mitra_ExpressionStatement")
mitra_StatementExpression = Class(name="mitra_StatementExpression")
mitra_EmptyStatement = Class(name="mitra_EmptyStatement")
mitra_ReturnStatement = Class(name="mitra_ReturnStatement")
mitra_IfStatement = Class(name="mitra_IfStatement")
mitra_WhileStatement = Class(name="mitra_WhileStatement")
mitra_DoStatement = Class(name="mitra_DoStatement")
mitra_ForInit = Class(name="mitra_ForInit")
mitra_TerminalExpression = Class(name="mitra_TerminalExpression")
Expression = Class(name="Expression")
mitra_BreakStatement = Class(name="mitra_BreakStatement")
mitra_ThrowStatement = Class(name="mitra_ThrowStatement")
mitra_TryStatement = Class(name="mitra_TryStatement")
mitra_Catch = Class(name="mitra_Catch")
mitra_RuleInvocationSuper = Class(name="mitra_RuleInvocationSuper")
mitra_Literal = Class(name="mitra_Literal")
TerminalExpression = Class(name="TerminalExpression")
mitra_StringLiteral = Class(name="mitra_StringLiteral")
Literal = Class(name="Literal")
mitra_IntLiteral = Class(name="mitra_IntLiteral")
mitra_RealLiteral = Class(name="mitra_RealLiteral")
mitra_BooleanLiteral = Class(name="mitra_BooleanLiteral")
mitra_NullLiteral = Class(name="mitra_NullLiteral")
mitra_ClassInstanceCreationExpression = Class(name="mitra_ClassInstanceCreationExpression")
StatementExpression = Class(name="StatementExpression")
mitra_RuleInvocation = Class(name="mitra_RuleInvocation")
mitra_Feature = Class(name="mitra_Feature")
mitra_MethodInvocation = Class(name="mitra_MethodInvocation")
Feature = Class(name="Feature")
mitra_FeatureMethodInvocation = Class(name="mitra_FeatureMethodInvocation")
MethodInvocation = Class(name="MethodInvocation")
MetamodelFeature = Class(name="MetamodelFeature")
mitra_NativeOperationInvocation = Class(name="mitra_NativeOperationInvocation")
mitra_MetamodelFeature = Class(name="mitra_MetamodelFeature")
mitra_FeatureField = Class(name="mitra_FeatureField")
mitra_VariableAccess = Class(name="mitra_VariableAccess")
mitra_StaticAccess = Class(name="mitra_StaticAccess")
mitra_Assignment = Class(name="mitra_Assignment")
mitra_AnnotationDecl = Class(name="mitra_AnnotationDecl")
mitra_AnnotationPropertyDecl = Class(name="mitra_AnnotationPropertyDecl")
mitra_AnnotationProperty = Class(name="mitra_AnnotationProperty")
mitra_UnaryCastExpression = Class(name="mitra_UnaryCastExpression")
mitra_IteratorExpression = Class(name="mitra_IteratorExpression")
mitra_BooleanExpression = Class(name="mitra_BooleanExpression")
mitra_EqualityExpression = Class(name="mitra_EqualityExpression")
mitra_RelationalExpression = Class(name="mitra_RelationalExpression")
mitra_MathExpression = Class(name="mitra_MathExpression")
mitra_UnaryBooleanExpression = Class(name="mitra_UnaryBooleanExpression")
mitra_UnaryMathExpression = Class(name="mitra_UnaryMathExpression")
mitra_InstanceOfExpression = Class(name="mitra_InstanceOfExpression")
...
mitra_MetamodelDeclaration.attributes={mitra_MetamodelDeclaration_name, mitra_MetamodelDeclaration_replaces, mitra_MetamodelDeclaration_type}
...
mitra_Property.attributes={mitra_Property_value, mitra_Property_name}
...
mitra_RuleDeclaration.attributes={mitra_RuleDeclaration_traced, mitra_RuleDeclaration_multi, mitra_RuleDeclaration_stealth, mitra_RuleDeclaration_visibility, mitra_RuleDeclaration_virtual, mitra_RuleDeclaration_exec, mitra_RuleDeclaration_name}
...
mitra_VariableAccess.attributes={mitra_VariableAccess_postfixOperator, mitra_VariableAccess_prefixOperator}
...
mitra_AnnotationDecl.attributes={mitra_AnnotationDecl_name, mitra_AnnotationDecl_required, mitra_AnnotationDecl_many, mitra_AnnotationDecl_targets}
...
with_50: BinaryAssociation = BinaryAssociation(
    name="with_50",
    ends={
...
domain_model = DomainModel(
    name="mitra",
    types={mitra_Module, mitra_ModuleReference, mitra_MetamodelDeclaration, mitra_AnnotationsDefinition, mitra_Property, mitra_Annotation, mitra_FormalParameter, mitra_RuleDeclaration, mitra_JavaSpec, mitra_Block, mitra_RuleReference, RuleReference, mitra_SimpleParameterReference, mitra_QualifiedRuleReference, mitra_QualifiedParameterReference, mitra_ParameterReference, ParameterReference, mitra_ReturnParameter, mitra_Type, mitra_SimpleRuleReference, mitra_TypedVarDeclaration, mitra_Trigger, mitra_PrimitiveType, mitra_Expression, mitra_Parameter, Parameter_, mitra_ReferenceType, Type, mitra_EClassifier, mitra_LocalVariableDeclaration, mitra_VarDeclaration, mitra_CollectionType, Statement, mitra_BlockStatement, mitra_Statement, BlockStatement, mitra_ForUpdate, mitra_LocalVariableDeclarationStatement, mitra_ForStatement, mitra_LoopVariable, VarDeclaration, mitra_InferredVarDeclaration, mitra_ExpressionStatement, mitra_StatementExpression, mitra_EmptyStatement, mitra_ReturnStatement, mitra_IfStatement, mitra_WhileStatement, mitra_DoStatement, mitra_ForInit, mitra_TerminalExpression, Expression, mitra_BreakStatement, mitra_ThrowStatement, mitra_TryStatement, mitra_Catch, mitra_RuleInvocationSuper, mitra_Literal, TerminalExpression, mitra_StringLiteral, Literal, mitra_IntLiteral, mitra_RealLiteral, mitra_BooleanLiteral, mitra_NullLiteral, mitra_ClassInstanceCreationExpression, StatementExpression, mitra_RuleInvocation, mitra_Feature, mitra_MethodInvocation, Feature, mitra_FeatureMethodInvocation, MethodInvocation, MetamodelFeature, mitra_NativeOperationInvocation, mitra_MetamodelFeature, mitra_FeatureField, mitra_VariableAccess, mitra_StaticAccess, mitra_Assignment, mitra_AnnotationDecl, mitra_AnnotationPropertyDecl, mitra_AnnotationProperty, mitra_UnaryCastExpression, mitra_IteratorExpression, mitra_BooleanExpression, mitra_EqualityExpression, mitra_RelationalExpression, mitra_MathExpression, mitra_UnaryBooleanExpression, mitra_UnaryMathExpression, mitra_InstanceOfExpression, VisibilityModifier, PrimitiveTypeSpec, ExecutionModifier, ParameterModifier, CollectionTypeSpec, RelationalOperator, MathOperator, UnaryMathOperator, BooleanOperator, EqualityOperator, AssignmentOperator, PPOperator, AnnotationTargetSpec},
    associations={imports0, metamodelDeclarations1, annotationDefinitions3, properties10, annotations12, formalParameters14, trigger26, vardecl45, ruleDeclarations5, javaSpec28, module7, triggerRules47, body30, with_50, ruleDeclaration32, parameterReferences34, returnReferences36, parameterReferences39, returnReferences40, returnParameters16, type43, implementedRules18, overriddenRule20, excludingRules23, eClassifier65, when53, properties55, annotations58, vardecl60, metamodelDeclaration63, localVariableDeclaration71, vardecl72, expression75, typePar67, statements69, statementExpression105, loopVariable107, expression108, type78, forInit111, forUpdate114, statementExpression80, expression81, expression83, trueStatement85, elseStatement87, expression90, statement92, statement95, expression97, statementExpressions100, varDeclarations102, statement117, vardecl120, expression123, tryBlock125, catches127, finallyBlock129, formalParameter132, block135, ruleDeclaration143, arguments145, type138, arguments140, expression161, type163, features166, arguments148, expression150, expression152, variable154, features156, default158, properties189, decl191, value194, lhs197, expression199, annotationDecls169, valuetype171, default173, propertyDecls175, type177, default180, decl183, values186, rhs224, type227, expression229, variable202, expression204, lhs207, rhs209, lhs212, rhs214, lhs217, rhs219, lhs222, expression232, expression234, expression236, type238},
    generalizations={gen_mitra_SimpleRuleReference_RuleReference, gen_mitra_QualifiedRuleReference_RuleReference, gen_mitra_SimpleParameterReference_ParameterReference, gen_mitra_QualifiedParameterReference_ParameterReference, gen_mitra_PrimitiveType_Type, gen_mitra_FormalParameter_Parameter, gen_mitra_ReturnParameter_Parameter, gen_mitra_ReferenceType_Type, gen_mitra_CollectionType_Type, gen_mitra_Block_Statement, gen_mitra_Statement_BlockStatement, gen_mitra_LocalVariableDeclarationStatement_BlockStatement, gen_mitra_ForStatement_Statement, gen_mitra_TypedVarDeclaration_VarDeclaration, gen_mitra_InferredVarDeclaration_VarDeclaration, gen_mitra_ExpressionStatement_Statement, gen_mitra_EmptyStatement_Statement, gen_mitra_ReturnStatement_Statement, gen_mitra_IfStatement_Statement, gen_mitra_WhileStatement_Statement, gen_mitra_DoStatement_Statement, gen_mitra_BreakStatement_Statement, gen_mitra_ThrowStatement_Statement, gen_mitra_TryStatement_Statement, gen_mitra_RuleInvocation_TerminalExpression, gen_mitra_RuleInvocationSuper_StatementExpression, gen_mitra_RuleInvocationSuper_TerminalExpression, gen_mitra_TerminalExpression_Expression, gen_mitra_Literal_TerminalExpression, gen_mitra_StringLiteral_Literal, gen_mitra_IntLiteral_Literal, gen_mitra_RealLiteral_Literal, gen_mitra_BooleanLiteral_Literal, gen_mitra_NullLiteral_Literal, gen_mitra_ClassInstanceCreationExpression_StatementExpression, gen_mitra_ClassInstanceCreationExpression_TerminalExpression, gen_mitra_RuleInvocation_StatementExpression, gen_mitra_MethodInvocation_Feature, gen_mitra_FeatureMethodInvocation_MethodInvocation, gen_mitra_FeatureMethodInvocation_MetamodelFeature, gen_mitra_NativeOperationInvocation_MethodInvocation, gen_mitra_FeatureField_Feature, gen_mitra_FeatureField_MetamodelFeature, gen_mitra_VariableAccess_StatementExpression, gen_mitra_VariableAccess_TerminalExpression, gen_mitra_StaticAccess_StatementExpression, gen_mitra_StaticAccess_TerminalExpression, gen_mitra_Assignment_StatementExpression, gen_mitra_UnaryCastExpression_Expression, gen_mitra_IteratorExpression_Expression, gen_mitra_BooleanExpression_Expression, gen_mitra_EqualityExpression_Expression, gen_mitra_RelationalExpression_Expression, gen_mitra_MathExpression_Expression, gen_mitra_UnaryBooleanExpression_Expression, gen_mitra_UnaryMathExpression_Expression, gen_mitra_InstanceOfExpression_Expression},
    metadata=None
)
