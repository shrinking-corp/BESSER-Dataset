...
petrinet_Arc.attributes={petrinet_Arc_name, petrinet_Arc_arcType, petrinet_Arc_weight}
...
domain_model = DomainModel(
    name="petrinet",
    types={petrinet_Place, petrinet_PetriNet, petrinet_Noeud, petrinet_Arc, petrinet_Transition, Noeud, ArcKindType},
