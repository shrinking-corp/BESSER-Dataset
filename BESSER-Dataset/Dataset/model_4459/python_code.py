...
class farrusco_StateOverride(Behavior):
    ...
    def __init__(self, fail_policy: int, runn_policy: int, succ_policy: int):
...
class farrusco_Robot:
    ...
    def __init__(self, Name: str, farrusco_Robot: set["farrusco_Node"] = None, farrusco_Robot2: set["farrusco_ActionChild"] = None, farrusco_Robot4: set["farrusco_Child"] = None, farrusco_Robot6: set["farrusco_Next"] = None):
        self.Name = Name
...
class farrusco_Behavior(Node):
    ...
    def __init__(self, Name: str, farrusco_Behavior20: "farrusco_ActionChild" = None, farrusco_Behavior: "farrusco_Child" = None, farrusco_Behavior11: "farrusco_Child" = None):
        self.Name = Name
