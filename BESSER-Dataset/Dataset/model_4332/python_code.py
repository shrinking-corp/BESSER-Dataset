...
class smm_DimensionalMeasurement(Measurement):
    ...
    def __init__(self, value: float, smm_DimensionalMeasurement69: "smm_CollectiveMeasurement" = None, smm_DimensionalMeasurement71: "smm_AggregatedMeasurement" = None, smm_DimensionalMeasurement: "smm_Grade" = None):
        self.value = value
...
class smm_CategoryRelationship(SmmRelationship):
    ...
    def __init__(self, name: str, inCategory: "smm_Category" = None, CategoryRelationship: "smm_Category" = None, CategoryRelationship16: "smm_Category" = None, outCategory: "smm_Category" = None):
        self.name = name
...
class smm_Category(SmmElement):
    ...
    def __init__(self, name: str, Category7: "smm_CategoryRelationship" = None, Category10: "smm_Category" = None, categoryElement: set["smm_Category"] = None, Category13: "smm_Category" = None, category: set["smm_Category"] = None, from_: set["smm_CategoryRelationship"] = None, to: set["smm_CategoryRelationship"] = None, category18: set["smm_Measure"] = None, Category20: "smm_Measure" = None, Category: "smm_CategoryRelationship" = None):
        self.name = name
...
class smm_Measurement(SmmElement):
    ...
    def __init__(self, error: str, Measurement: "smm_Measure" = None, measurement: "smm_Measure" = None, smm_Measurement: "smm_Observation" = None, from_41: set["smm_MeasurementRelationship"] = None, to43: set["smm_MeasurementRelationship"] = None, Measurement65: "smm_MeasurementRelationship" = None, Measurement67: "smm_MeasurementRelationship" = None):
        self.error = error
...
class smm_Measure(SmmElement):
    ...
    def __init__(self, library: str, name: str, Measure: "smm_Category" = None, categoryMeasure: set["smm_Category"] = None, Measure23: "smm_Measure" = None, equivalentTo: set["smm_Measure"] = None, Measure26: "smm_Measure" = None, equivalentFrom: set["smm_Measure"] = None, smm_Measure: "smm_Measure" = None, smm_Measure27: set["smm_Measure"] = None, measure: set["smm_Measurement"] = None, from_31: set["smm_MeasureRelationship"] = None, to33: set["smm_MeasureRelationship"] = None, characteristics: "smm_Characteristic" = None, Measure46: "smm_MeasureRelationship" = None, Measure48: "smm_MeasureRelationship" = None, Measure54: "smm_Characteristic" = None, Measure56: "smm_Scope" = None, measures: "smm_Scope" = None, Measure38: "smm_Measurement" = None):
...
class smm_Attribute(SmmElement):
    ...
    def __init__(self, value: str, tag: str, Attribute: "smm_SmmElement" = None, attribute: "smm_SmmElement" = None):
        self.value = value
        self.tag = tag
