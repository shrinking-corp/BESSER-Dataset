...
class application_ApplicationRealm:
    ...
    def __init__(self, uid: str, name: str, application_ApplicationRealm30: "application_Roles" = None, application_ApplicationRealm: "application_ApplicationRealms" = None):
        self.uid = uid
        self.name = name
...
class application_ApplicationInfrastructureLayers:
    ...
    def __init__(self, uid: str, name: str, application_ApplicationInfrastructureLayers16: set["application_ApplicationInfrastructureLayer"] = None, application_ApplicationInfrastructureLayers: "application_Application" = None):
        self.uid = uid
        self.name = name
...
class application_ApplicationLanguages:
    ...
    def __init__(self, uid: str, name: str, application_ApplicationLanguages24: set["application_Language"] = None, application_ApplicationLanguages: "application_ApplicationMessageLibraries" = None):
        self.uid = uid
        self.name = name
...
class application_ApplicationMappers:
    ...
    def __init__(self, name: str, uid: str, application_ApplicationMappers: "application_Application" = None, application_ApplicationMappers44: set["application_ApplicationMapper"] = None, application_ApplicationMappers46: set["application_MappingLayer"] = None):
        self.name = name
        self.uid = uid
...
class application_ApplicationRecipes:
    ...
    def __init__(self, uid: str, name: str, application_ApplicationRecipes: "application_Application" = None, application_ApplicationRecipes40: set["application_ApplicationRecipe"] = None):
        self.uid = uid
        self.name = name
...
class application_Application:
    ...
    def __init__(self, uid: str, name: str, application_Application: "application_ApplicationGroup" = None, application_Application2: "application_ApplicationRecipes" = None, application_Application4: "application_ApplicationMappers" = None, application_Application10: "application_ApplicationStyleLibraries" = None, application_Application12: "application_ApplicationRealms" = None, application_Application14: "application_ApplicationMessageLibraries" = None, application_Application6: "application_ApplicationUILayer" = None, application_Application8: "application_ApplicationInfrastructureLayers" = None):
        self.uid = uid
        self.name = name
