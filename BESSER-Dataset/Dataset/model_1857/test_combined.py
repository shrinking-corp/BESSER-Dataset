...
def test_hyp_application_recipes_is_not_abstract():
    assert not inspect.isabstract(application_Recipes)


def test_hyp_application_recipes_constructor_exists():
    assert callable(application_Recipes.__init__)


def test_hyp_application_recipes_constructor_args():
    sig = inspect.signature(application_Recipes.__init__)
    params = list(sig.parameters.keys())



def test_hyp_application_mappers_is_not_abstract():
    assert not inspect.isabstract(application_Mappers)


def test_hyp_application_mappers_constructor_exists():
    assert callable(application_Mappers.__init__)


def test_hyp_application_mappers_constructor_args():
    sig = inspect.signature(application_Mappers.__init__)
    params = list(sig.parameters.keys())



def test_hyp_application_mappinglayer_is_not_abstract():
    assert not inspect.isabstract(application_MappingLayer)


def test_hyp_application_mappinglayer_constructor_exists():
    assert callable(application_MappingLayer.__init__)


def test_hyp_application_mappinglayer_constructor_args():
    sig = inspect.signature(application_MappingLayer.__init__)
    params = list(sig.parameters.keys())



def test_hyp_application_applicationmapper_is_not_abstract():
    assert not inspect.isabstract(application_ApplicationMapper)


def test_hyp_application_applicationmapper_constructor_exists():
    assert callable(application_ApplicationMapper.__init__)


def test_hyp_application_applicationmapper_constructor_args():
...
def test_hyp_application_applicationrealm_is_not_abstract():
    assert not inspect.isabstract(application_ApplicationRealm)


def test_hyp_application_applicationrealm_constructor_exists():
    assert callable(application_ApplicationRealm.__init__)


def test_hyp_application_applicationrealm_constructor_args():
...
def test_hyp_application_applicationrecipe_is_not_abstract():
    assert not inspect.isabstract(application_ApplicationRecipe)


def test_hyp_application_applicationrecipe_constructor_exists():
    assert callable(application_ApplicationRecipe.__init__)


def test_hyp_application_applicationrecipe_constructor_args():
...
def test_hyp_application_form_is_not_abstract():
    assert not inspect.isabstract(application_Form)


def test_hyp_application_form_constructor_exists():
    assert callable(application_Form.__init__)


def test_hyp_application_form_constructor_args():
    sig = inspect.signature(application_Form.__init__)
    params = list(sig.parameters.keys())



def test_hyp_application_applicationuipackage_is_not_abstract():
    assert not inspect.isabstract(application_ApplicationUIPackage)


def test_hyp_application_applicationuipackage_constructor_exists():
    assert callable(application_ApplicationUIPackage.__init__)


def test_hyp_application_applicationuipackage_constructor_args():
...
def test_hyp_application_stylelibrary_is_not_abstract():
    assert not inspect.isabstract(application_StyleLibrary)


def test_hyp_application_stylelibrary_constructor_exists():
    assert callable(application_StyleLibrary.__init__)


def test_hyp_application_stylelibrary_constructor_args():
    sig = inspect.signature(application_StyleLibrary.__init__)
    params = list(sig.parameters.keys())



def test_hyp_application_applicationstyle_is_not_abstract():
    assert not inspect.isabstract(application_ApplicationStyle)


def test_hyp_application_applicationstyle_constructor_exists():
    assert callable(application_ApplicationStyle.__init__)


def test_hyp_application_applicationstyle_constructor_args():
...
def test_hyp_application_roles_is_not_abstract():
    assert not inspect.isabstract(application_Roles)


def test_hyp_application_roles_constructor_exists():
    assert callable(application_Roles.__init__)


def test_hyp_application_roles_constructor_args():
    sig = inspect.signature(application_Roles.__init__)
    params = list(sig.parameters.keys())



def test_hyp_application_applicationstylelibraries_is_not_abstract():
    assert not inspect.isabstract(application_ApplicationStyleLibraries)


def test_hyp_application_applicationstylelibraries_constructor_exists():
    assert callable(application_ApplicationStyleLibraries.__init__)


def test_hyp_application_applicationstylelibraries_constructor_args():
...
def test_hyp_application_applicationinfrastructurelayers_is_not_abstract():
    assert not inspect.isabstract(application_ApplicationInfrastructureLayers)


def test_hyp_application_applicationinfrastructurelayers_constructor_exists():
    assert callable(application_ApplicationInfrastructureLayers.__init__)


def test_hyp_application_applicationinfrastructurelayers_constructor_args():
...
def test_hyp_application_applicationuilayer_is_not_abstract():
    assert not inspect.isabstract(application_ApplicationUILayer)


def test_hyp_application_applicationuilayer_constructor_exists():
    assert callable(application_ApplicationUILayer.__init__)


def test_hyp_application_applicationuilayer_constructor_args():
...
def test_hyp_application_messagelibrary_is_not_abstract():
    assert not inspect.isabstract(application_MessageLibrary)


def test_hyp_application_messagelibrary_constructor_exists():
    assert callable(application_MessageLibrary.__init__)


def test_hyp_application_messagelibrary_constructor_args():
    sig = inspect.signature(application_MessageLibrary.__init__)
    params = list(sig.parameters.keys())



def test_hyp_application_language_is_not_abstract():
    assert not inspect.isabstract(application_Language)


def test_hyp_application_language_constructor_exists():
    assert callable(application_Language.__init__)


def test_hyp_application_language_constructor_args():
    sig = inspect.signature(application_Language.__init__)
    params = list(sig.parameters.keys())



def test_hyp_application_applicationlanguages_is_not_abstract():
    assert not inspect.isabstract(application_ApplicationLanguages)


def test_hyp_application_applicationlanguages_constructor_exists():
    assert callable(application_ApplicationLanguages.__init__)


def test_hyp_application_applicationlanguages_constructor_args():
...
def test_hyp_application_applicationmessagelibrary_is_not_abstract():
    assert not inspect.isabstract(application_ApplicationMessageLibrary)


def test_hyp_application_applicationmessagelibrary_constructor_exists():
    assert callable(application_ApplicationMessageLibrary.__init__)


def test_hyp_application_applicationmessagelibrary_constructor_args():
...
def test_hyp_application_enterpriseinfrastructure_is_not_abstract():
    assert not inspect.isabstract(application_EnterpriseInfrastructure)


def test_hyp_application_enterpriseinfrastructure_constructor_exists():
    assert callable(application_EnterpriseInfrastructure.__init__)


def test_hyp_application_enterpriseinfrastructure_constructor_args():
    sig = inspect.signature(application_EnterpriseInfrastructure.__init__)
    params = list(sig.parameters.keys())



def test_hyp_application_applicationinfrastructurelayer_is_not_abstract():
    assert not inspect.isabstract(application_ApplicationInfrastructureLayer)


def test_hyp_application_applicationinfrastructurelayer_constructor_exists():
    assert callable(application_ApplicationInfrastructureLayer.__init__)


def test_hyp_application_applicationinfrastructurelayer_constructor_args():
...
def test_hyp_application_applicationmessagelibraries_is_not_abstract():
    assert not inspect.isabstract(application_ApplicationMessageLibraries)


def test_hyp_application_applicationmessagelibraries_constructor_exists():
    assert callable(application_ApplicationMessageLibraries.__init__)


def test_hyp_application_applicationmessagelibraries_constructor_args():
...
def test_hyp_application_applicationrealms_is_not_abstract():
    assert not inspect.isabstract(application_ApplicationRealms)


def test_hyp_application_applicationrealms_constructor_exists():
    assert callable(application_ApplicationRealms.__init__)


def test_hyp_application_applicationrealms_constructor_args():
...
def test_hyp_application_applicationmappers_is_not_abstract():
    assert not inspect.isabstract(application_ApplicationMappers)


def test_hyp_application_applicationmappers_constructor_exists():
    assert callable(application_ApplicationMappers.__init__)


def test_hyp_application_applicationmappers_constructor_args():
...
def test_hyp_application_applicationrecipes_is_not_abstract():
    assert not inspect.isabstract(application_ApplicationRecipes)


def test_hyp_application_applicationrecipes_constructor_exists():
    assert callable(application_ApplicationRecipes.__init__)


def test_hyp_application_applicationrecipes_constructor_args():
...
def test_hyp_application_application_is_not_abstract():
    assert not inspect.isabstract(application_Application)


def test_hyp_application_application_constructor_exists():
    assert callable(application_Application.__init__)


def test_hyp_application_application_constructor_args():
...
def test_hyp_application_applicationgroup_is_not_abstract():
    assert not inspect.isabstract(application_ApplicationGroup)


def test_hyp_application_applicationgroup_constructor_exists():
    assert callable(application_ApplicationGroup.__init__)


def test_hyp_application_applicationgroup_constructor_args():
...
def test_hyp_application_applicationmapper_uid_setter(instance):
...
@given(instance=application_ApplicationMapper_strategy)
def test_hyp_application_applicationmapper_name_setter(instance):
...
def test_hyp_application_applicationrealm_uid_setter(instance):
    original = instance.uid
    instance.uid = original
    assert instance.uid == original
...
@given(instance=application_ApplicationRealm_strategy)
def test_hyp_application_applicationrealm_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_application_applicationrecipe_uid_setter(instance):
    original = instance.uid
    instance.uid = original
    assert instance.uid == original
...
@given(instance=application_ApplicationRecipe_strategy)
def test_hyp_application_applicationrecipe_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_application_applicationuipackage_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=application_ApplicationUIPackage_strategy)
def test_hyp_application_applicationuipackage_uid_setter(instance):
    original = instance.uid
    instance.uid = original
    assert instance.uid == original
...
def test_hyp_application_applicationstyle_uid_setter(instance):
    original = instance.uid
    instance.uid = original
    assert instance.uid == original
...
@given(instance=application_ApplicationStyle_strategy)
def test_hyp_application_applicationstyle_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_application_applicationstylelibraries_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=application_ApplicationStyleLibraries_strategy)
def test_hyp_application_applicationstylelibraries_uid_setter(instance):
    original = instance.uid
    instance.uid = original
    assert instance.uid == original
...
def test_hyp_application_applicationinfrastructurelayers_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=application_ApplicationInfrastructureLayers_strategy)
def test_hyp_application_applicationinfrastructurelayers_uid_setter(instance):
    original = instance.uid
    instance.uid = original
    assert instance.uid == original
...
def test_hyp_application_applicationuilayer_uid_setter(instance):
    original = instance.uid
    instance.uid = original
    assert instance.uid == original
...
@given(instance=application_ApplicationUILayer_strategy)
def test_hyp_application_applicationuilayer_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_application_applicationlanguages_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=application_ApplicationLanguages_strategy)
def test_hyp_application_applicationlanguages_uid_setter(instance):
    original = instance.uid
    instance.uid = original
    assert instance.uid == original
...
def test_hyp_application_applicationmessagelibrary_uid_setter(instance):
    original = instance.uid
    instance.uid = original
    assert instance.uid == original
...
@given(instance=application_ApplicationMessageLibrary_strategy)
def test_hyp_application_applicationmessagelibrary_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_application_applicationinfrastructurelayer_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=application_ApplicationInfrastructureLayer_strategy)
def test_hyp_application_applicationinfrastructurelayer_uid_setter(instance):
    original = instance.uid
    instance.uid = original
    assert instance.uid == original
...
def test_hyp_application_applicationmessagelibraries_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=application_ApplicationMessageLibraries_strategy)
def test_hyp_application_applicationmessagelibraries_uid_setter(instance):
    original = instance.uid
    instance.uid = original
    assert instance.uid == original
...
def test_hyp_application_applicationrealms_uid_setter(instance):
    original = instance.uid
    instance.uid = original
    assert instance.uid == original
...
@given(instance=application_ApplicationRealms_strategy)
def test_hyp_application_applicationrealms_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_application_applicationmappers_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=application_ApplicationMappers_strategy)
def test_hyp_application_applicationmappers_uid_setter(instance):
    original = instance.uid
    instance.uid = original
    assert instance.uid == original
...
def test_hyp_application_applicationrecipes_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=application_ApplicationRecipes_strategy)
def test_hyp_application_applicationrecipes_uid_setter(instance):
    original = instance.uid
    instance.uid = original
    assert instance.uid == original
...
def test_hyp_application_application_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=application_Application_strategy)
def test_hyp_application_application_uid_setter(instance):
    original = instance.uid
    instance.uid = original
    assert instance.uid == original
...
def test_hyp_application_applicationgroup_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=application_ApplicationGroup_strategy)
def test_hyp_application_applicationgroup_uid_setter(instance):
    original = instance.uid
    instance.uid = original
    assert instance.uid == original
