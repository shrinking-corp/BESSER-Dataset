...
# Classes
application_ApplicationGroup = Class(name="application_ApplicationGroup")
application_Application = Class(name="application_Application")
application_ApplicationRecipes = Class(name="application_ApplicationRecipes")
application_ApplicationMappers = Class(name="application_ApplicationMappers")
application_ApplicationRealms = Class(name="application_ApplicationRealms")
application_ApplicationMessageLibraries = Class(name="application_ApplicationMessageLibraries")
application_ApplicationInfrastructureLayer = Class(name="application_ApplicationInfrastructureLayer")
application_EnterpriseInfrastructure = Class(name="application_EnterpriseInfrastructure")
application_ApplicationMessageLibrary = Class(name="application_ApplicationMessageLibrary")
application_ApplicationLanguages = Class(name="application_ApplicationLanguages")
application_Language = Class(name="application_Language")
application_MessageLibrary = Class(name="application_MessageLibrary")
application_ApplicationUILayer = Class(name="application_ApplicationUILayer")
application_ApplicationInfrastructureLayers = Class(name="application_ApplicationInfrastructureLayers")
application_ApplicationStyleLibraries = Class(name="application_ApplicationStyleLibraries")
application_Roles = Class(name="application_Roles")
application_ApplicationStyle = Class(name="application_ApplicationStyle")
application_StyleLibrary = Class(name="application_StyleLibrary")
application_ApplicationUIPackage = Class(name="application_ApplicationUIPackage")
application_Form = Class(name="application_Form")
application_ApplicationRecipe = Class(name="application_ApplicationRecipe")
application_ApplicationRealm = Class(name="application_ApplicationRealm")
application_ApplicationMapper = Class(name="application_ApplicationMapper")
application_MappingLayer = Class(name="application_MappingLayer")
application_Mappers = Class(name="application_Mappers")
application_Recipes = Class(name="application_Recipes")
...
application_ApplicationGroup.attributes={application_ApplicationGroup_name, application_ApplicationGroup_uid}
...
application_Application.attributes={application_Application_name, application_Application_uid}
...
application_ApplicationMessageLibraries.attributes={application_ApplicationMessageLibraries_name, application_ApplicationMessageLibraries_uid}
...
application_ApplicationInfrastructureLayer.attributes={application_ApplicationInfrastructureLayer_name, application_ApplicationInfrastructureLayer_uid}
...
application_ApplicationLanguages.attributes={application_ApplicationLanguages_name, application_ApplicationLanguages_uid}
...
application_ApplicationUILayer.attributes={application_ApplicationUILayer_name, application_ApplicationUILayer_uid}
...
application_ApplicationInfrastructureLayers.attributes={application_ApplicationInfrastructureLayers_uid, application_ApplicationInfrastructureLayers_name}
...
application_ApplicationStyle.attributes={application_ApplicationStyle_uid, application_ApplicationStyle_name}
...
application_ApplicationUIPackage.attributes={application_ApplicationUIPackage_uid, application_ApplicationUIPackage_name}
...
application_ApplicationRecipe.attributes={application_ApplicationRecipe_name, application_ApplicationRecipe_uid}
...
application_ApplicationRealm.attributes={application_ApplicationRealm_name, application_ApplicationRealm_uid}
...
domain_model = DomainModel(
    name="application",
    types={application_ApplicationGroup, application_Application, application_ApplicationRecipes, application_ApplicationMappers, application_ApplicationRealms, application_ApplicationMessageLibraries, application_ApplicationInfrastructureLayer, application_EnterpriseInfrastructure, application_ApplicationMessageLibrary, application_ApplicationLanguages, application_Language, application_MessageLibrary, application_ApplicationUILayer, application_ApplicationInfrastructureLayers, application_ApplicationStyleLibraries, application_Roles, application_ApplicationStyle, application_StyleLibrary, application_ApplicationUIPackage, application_Form, application_ApplicationRecipe, application_ApplicationRealm, application_ApplicationMapper, application_MappingLayer, application_Mappers, application_Recipes},
    associations={applications0, applicationRecipes1, applicationMappers3, applicationStyle9, applicationRole11, applicationMessages13, infarastructureLayers15, infarastructures17, messageLibraries19, applicationLanguages21, languages23, libraries25, applicationUILayer5, applicationInfrastructureLayer7, roles29, styleLibraries31, libraries33, applicationUIPackages35, forms37, recipes39, realms27, mappers43, appLayers45, mapper47, recipes41},
    generalizations={},
    metadata=None
)
