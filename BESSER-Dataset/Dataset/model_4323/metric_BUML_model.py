...
metric_ConstraintMetric.attributes={metric_ConstraintMetric_usedLiterals, metric_ConstraintMetric_usedIterators, metric_ConstraintMetric_numberOfLetExpressions, metric_ConstraintMetric_numberOfIfExpressions, metric_ConstraintMetric_calledProperties, metric_ConstraintMetric_expressionCount, metric_ConstraintMetric_expressionDepth, metric_ConstraintMetric_calledOperations}
...
metric_ConstraintMetrics.methods={metric_ConstraintMetrics_m_getMinExpressionDepth, metric_ConstraintMetrics_m_getExpressionCount, metric_ConstraintMetrics_m_getAvgExpressionCount, metric_ConstraintMetrics_m_getMeanExpressionDepth, metric_ConstraintMetrics_m_getMeanExpressionCount, metric_ConstraintMetrics_m_getAvgExpressionDepth, metric_ConstraintMetrics_m_getMinExpressionCount, metric_ConstraintMetrics_m_getMaxExpressionDepth, metric_ConstraintMetrics_m_getMaxExpressionCount, metric_ConstraintMetrics_m_getConstraintCount}
