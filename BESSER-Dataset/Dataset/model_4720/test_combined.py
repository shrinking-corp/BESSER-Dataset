...
def test_hyp_rule_cellularautomata_is_not_abstract():
    assert not inspect.isabstract(rule_CellularAutomata)


def test_hyp_rule_cellularautomata_constructor_exists():
    assert callable(rule_CellularAutomata.__init__)


def test_hyp_rule_cellularautomata_constructor_args():
...
def test_hyp_rule_uminus_is_not_abstract():
    assert not inspect.isabstract(rule_UMinus)


def test_hyp_rule_uminus_constructor_exists():
    assert callable(rule_UMinus.__init__)


def test_hyp_rule_uminus_constructor_args():
    sig = inspect.signature(rule_UMinus.__init__)
    params = list(sig.parameters.keys())



def test_hyp_rule_not_is_not_abstract():
    assert not inspect.isabstract(rule_Not)


def test_hyp_rule_not_constructor_exists():
    assert callable(rule_Not.__init__)


def test_hyp_rule_not_constructor_args():
...
def test_hyp_rule_neighborsexpression_is_not_abstract():
    assert not inspect.isabstract(rule_NeighborsExpression)


def test_hyp_rule_neighborsexpression_constructor_exists():
    assert callable(rule_NeighborsExpression.__init__)


def test_hyp_rule_neighborsexpression_constructor_args():
    sig = inspect.signature(rule_NeighborsExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_rule_currentcellpopulation_is_not_abstract():
    assert not inspect.isabstract(rule_CurrentCellPopulation)


def test_hyp_rule_currentcellpopulation_constructor_exists():
    assert callable(rule_CurrentCellPopulation.__init__)


def test_hyp_rule_currentcellpopulation_constructor_args():
    sig = inspect.signature(rule_CurrentCellPopulation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_rule_conditional_is_not_abstract():
    assert not inspect.isabstract(rule_Conditional)


def test_hyp_rule_conditional_constructor_exists():
    assert callable(rule_Conditional.__init__)


def test_hyp_rule_conditional_constructor_args():
    sig = inspect.signature(rule_Conditional.__init__)
    params = list(sig.parameters.keys())



def test_hyp_rule_binaryexpression_is_not_abstract():
    assert not inspect.isabstract(rule_BinaryExpression)


def test_hyp_rule_binaryexpression_constructor_exists():
    assert callable(rule_BinaryExpression.__init__)


def test_hyp_rule_binaryexpression_constructor_args():
    sig = inspect.signature(rule_BinaryExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_rule_integerliteral_is_not_abstract():
    assert not inspect.isabstract(rule_IntegerLiteral)


def test_hyp_rule_integerliteral_constructor_exists():
    assert callable(rule_IntegerLiteral.__init__)


def test_hyp_rule_integerliteral_constructor_args():
...
def test_hyp_rule_unaryexpression_is_not_abstract():
    assert not inspect.isabstract(rule_UnaryExpression)


def test_hyp_rule_unaryexpression_constructor_exists():
    assert callable(rule_UnaryExpression.__init__)


def test_hyp_rule_unaryexpression_constructor_args():
...
def test_hyp_rule_minus_is_not_abstract():
    assert not inspect.isabstract(rule_Minus)


def test_hyp_rule_minus_constructor_exists():
    assert callable(rule_Minus.__init__)


def test_hyp_rule_minus_constructor_args():
    sig = inspect.signature(rule_Minus.__init__)
    params = list(sig.parameters.keys())



def test_hyp_rule_lower_is_not_abstract():
    assert not inspect.isabstract(rule_Lower)


def test_hyp_rule_lower_constructor_exists():
    assert callable(rule_Lower.__init__)


def test_hyp_rule_lower_constructor_args():
    sig = inspect.signature(rule_Lower.__init__)
    params = list(sig.parameters.keys())



def test_hyp_rule_div_is_not_abstract():
    assert not inspect.isabstract(rule_Div)


def test_hyp_rule_div_constructor_exists():
    assert callable(rule_Div.__init__)


def test_hyp_rule_div_constructor_args():
    sig = inspect.signature(rule_Div.__init__)
    params = list(sig.parameters.keys())



def test_hyp_rule_or_is_not_abstract():
    assert not inspect.isabstract(rule_Or)


def test_hyp_rule_or_constructor_exists():
    assert callable(rule_Or.__init__)


def test_hyp_rule_or_constructor_args():
    sig = inspect.signature(rule_Or.__init__)
    params = list(sig.parameters.keys())



def test_hyp_rule_and_is_not_abstract():
    assert not inspect.isabstract(rule_And)


def test_hyp_rule_and_constructor_exists():
    assert callable(rule_And.__init__)


def test_hyp_rule_and_constructor_args():
    sig = inspect.signature(rule_And.__init__)
    params = list(sig.parameters.keys())



def test_hyp_rule_mult_is_not_abstract():
    assert not inspect.isabstract(rule_Mult)


def test_hyp_rule_mult_constructor_exists():
    assert callable(rule_Mult.__init__)


def test_hyp_rule_mult_constructor_args():
    sig = inspect.signature(rule_Mult.__init__)
    params = list(sig.parameters.keys())



def test_hyp_rule_greater_is_not_abstract():
    assert not inspect.isabstract(rule_Greater)


def test_hyp_rule_greater_constructor_exists():
    assert callable(rule_Greater.__init__)


def test_hyp_rule_greater_constructor_args():
    sig = inspect.signature(rule_Greater.__init__)
    params = list(sig.parameters.keys())



def test_hyp_rule_equal_is_not_abstract():
    assert not inspect.isabstract(rule_Equal)


def test_hyp_rule_equal_constructor_exists():
    assert callable(rule_Equal.__init__)


def test_hyp_rule_equal_constructor_args():
    sig = inspect.signature(rule_Equal.__init__)
    params = list(sig.parameters.keys())



def test_hyp_rule_mod_is_not_abstract():
    assert not inspect.isabstract(rule_Mod)


def test_hyp_rule_mod_constructor_exists():
    assert callable(rule_Mod.__init__)


def test_hyp_rule_mod_constructor_args():
    sig = inspect.signature(rule_Mod.__init__)
    params = list(sig.parameters.keys())



def test_hyp_rule_add_is_not_abstract():
    assert not inspect.isabstract(rule_Add)


def test_hyp_rule_add_constructor_exists():
    assert callable(rule_Add.__init__)


def test_hyp_rule_add_constructor_args():
...
def test_hyp_rule_sum_is_not_abstract():
    assert not inspect.isabstract(rule_Sum)


def test_hyp_rule_sum_constructor_exists():
    assert callable(rule_Sum.__init__)


def test_hyp_rule_sum_constructor_args():
    sig = inspect.signature(rule_Sum.__init__)
    params = list(sig.parameters.keys())



def test_hyp_rule_size_is_not_abstract():
    assert not inspect.isabstract(rule_Size)


def test_hyp_rule_size_constructor_exists():
    assert callable(rule_Size.__init__)


def test_hyp_rule_size_constructor_args():
    sig = inspect.signature(rule_Size.__init__)
    params = list(sig.parameters.keys())



def test_hyp_rule_min_is_not_abstract():
    assert not inspect.isabstract(rule_Min)


def test_hyp_rule_min_constructor_exists():
    assert callable(rule_Min.__init__)


def test_hyp_rule_min_constructor_args():
    sig = inspect.signature(rule_Min.__init__)
    params = list(sig.parameters.keys())



def test_hyp_rule_max_is_not_abstract():
    assert not inspect.isabstract(rule_Max)


def test_hyp_rule_max_constructor_exists():
    assert callable(rule_Max.__init__)


def test_hyp_rule_max_constructor_args():
    sig = inspect.signature(rule_Max.__init__)
    params = list(sig.parameters.keys())



def test_hyp_rule_populationrange_is_not_abstract():
    assert not inspect.isabstract(rule_PopulationRange)


def test_hyp_rule_populationrange_constructor_exists():
    assert callable(rule_PopulationRange.__init__)


def test_hyp_rule_populationrange_constructor_args():
...
def test_hyp_rule_integerexpression_is_not_abstract():
    assert not inspect.isabstract(rule_IntegerExpression)


def test_hyp_rule_integerexpression_constructor_exists():
    assert callable(rule_IntegerExpression.__init__)


def test_hyp_rule_integerexpression_constructor_args():
    sig = inspect.signature(rule_IntegerExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_rule_rule_is_not_abstract():
    assert not inspect.isabstract(rule_Rule)


def test_hyp_rule_rule_constructor_exists():
    assert callable(rule_Rule.__init__)


def test_hyp_rule_rule_constructor_args():
...
def test_hyp_rule_integerliteral_val_setter(instance):
...
def test_hyp_rule_populationrange_lowerRange_setter(instance):
...
@given(instance=rule_PopulationRange_strategy)
def test_hyp_rule_populationrange_upperRange_setter(instance):
