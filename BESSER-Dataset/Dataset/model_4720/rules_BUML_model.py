...
# Classes
rule_Rule = Class(name="rule_Rule")
rule_IntegerExpression = Class(name="rule_IntegerExpression")
rule_PopulationRange = Class(name="rule_PopulationRange")
rule_Max = Class(name="rule_Max")
NeighborsExpression = Class(name="NeighborsExpression")
rule_Add = Class(name="rule_Add")
BinaryExpression = Class(name="BinaryExpression")
rule_UnaryExpression = Class(name="rule_UnaryExpression")
IntegerExpression = Class(name="IntegerExpression")
rule_And = Class(name="rule_And")
rule_Or = Class(name="rule_Or")
rule_Not = Class(name="rule_Not")
UnaryExpression = Class(name="UnaryExpression")
rule_Greater = Class(name="rule_Greater")
rule_Lower = Class(name="rule_Lower")
rule_IntegerLiteral = Class(name="rule_IntegerLiteral")
rule_Size = Class(name="rule_Size")
rule_NeighborsExpression = Class(name="rule_NeighborsExpression")
rule_Min = Class(name="rule_Min")
rule_BinaryExpression = Class(name="rule_BinaryExpression")
rule_Mult = Class(name="rule_Mult")
rule_Div = Class(name="rule_Div")
rule_Sum = Class(name="rule_Sum")
rule_CellularAutomata = Class(name="rule_CellularAutomata")
rule_Mod = Class(name="rule_Mod")
rule_UMinus = Class(name="rule_UMinus")
rule_Minus = Class(name="rule_Minus")
rule_Equal = Class(name="rule_Equal")
rule_Conditional = Class(name="rule_Conditional")
rule_CurrentCellPopulation = Class(name="rule_CurrentCellPopulation")
...
rule_PopulationRange.attributes={rule_PopulationRange_lowerRange, rule_PopulationRange_upperRange}
...
domain_model = DomainModel(
    name="rule",
    types={rule_Rule, rule_IntegerExpression, rule_PopulationRange, rule_Max, NeighborsExpression, rule_Add, BinaryExpression, rule_UnaryExpression, IntegerExpression, rule_And, rule_Or, rule_Not, UnaryExpression, rule_Greater, rule_Lower, rule_IntegerLiteral, rule_Size, rule_NeighborsExpression, rule_Min, rule_BinaryExpression, rule_Mult, rule_Div, rule_Sum, rule_CellularAutomata, rule_Mod, rule_UMinus, rule_Minus, rule_Equal, rule_Conditional, rule_CurrentCellPopulation},
    associations={nextVal0, filter1, target3, neighborsFilter13, left15, right17, rules20, ifTrueExpression5, ifFalseExpression7, condition10},
    generalizations={gen_rule_Max_NeighborsExpression, gen_rule_Add_BinaryExpression, gen_rule_UnaryExpression_IntegerExpression, gen_rule_And_BinaryExpression, gen_rule_Or_BinaryExpression, gen_rule_Not_UnaryExpression, gen_rule_Greater_BinaryExpression, gen_rule_Lower_BinaryExpression, gen_rule_Size_NeighborsExpression, gen_rule_NeighborsExpression_IntegerExpression, gen_rule_Min_NeighborsExpression, gen_rule_BinaryExpression_IntegerExpression, gen_rule_Mult_BinaryExpression, gen_rule_Div_BinaryExpression, gen_rule_Sum_NeighborsExpression, gen_rule_Mod_BinaryExpression, gen_rule_UMinus_UnaryExpression, gen_rule_Minus_BinaryExpression, gen_rule_Equal_BinaryExpression, gen_rule_IntegerLiteral_IntegerExpression, gen_rule_Conditional_IntegerExpression, gen_rule_CurrentCellPopulation_IntegerExpression},
    metadata=None
)
