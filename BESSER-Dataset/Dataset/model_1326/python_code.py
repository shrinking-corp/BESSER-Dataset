...
class state_StateMachine:
    ...
    def __init__(self, name: str, state_StateMachine17: set["state_Transition"] = None, state_StateMachine: set["state_Node"] = None):
        self.name = name
...
class state_Transition:
    ...
    def __init__(self, triggerEventName: str, state_Transition18: "state_StateMachine" = None, state_Transition: "state_Node" = None, state_Transition3: "state_Node" = None, state_Transition5: "state_Node" = None, state_Transition8: "state_Node" = None, state_Transition11: "state_Condition" = None):
