...
domain_model = DomainModel(
    name="state",
    types={state_Node, state_Transition, state_Condition, state_InitialNode, Node, state_FinalNode, state_ConditionalNode, state_State, state_StateMachine, state_TimeoutTransition, Transition},
    associations={transitions16, incoming0, outgoing1, source4, target7, guard10, condition12, nodes14},
