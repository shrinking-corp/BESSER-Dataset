...
class iTrace_Block:
    ...
    def __init__(self, startLine: int, endLine: int, blockNumber: int, startColumn: int, endColumn: int, Block: "iTrace_M2TLink" = None, Block17: "iTrace_Code" = None, blocks: "iTrace_Code" = None, targetBlocks: "iTrace_M2TLink" = None):
...
class iTrace_TraceLinkElement(ABC):
    ...
    def __init__(self, ref: str, name: str, type: str, elements: "iTrace_Model" = None, iTrace_TraceLinkElement: "iTrace_EObject" = None, TraceLinkElement: "iTrace_Model" = None):
        self.ref = ref
        self.name = name
        self.type = type
...
class iTrace_TraceLink(ABC):
    ...
    def __init__(self, createdOn: str, type: str, fromFileName: str, comment: str, createdBy: str, mode: str, technicalBinding: str, ruleName: str, TraceLink: "iTrace_iTraceModel" = None, traceLink: set["iTrace_SourceElement"] = None, traceLinks: "iTrace_iTraceModel" = None, TraceLink22: "iTrace_SourceElement" = None):
...
class iTrace_iTraceModel:
    ...
    def __init__(self, version: str, projectName: str, iTraceModel4: "iTrace_SpecificFeature" = None, iTraceModel: set["iTrace_TraceLink"] = None, iTraceModel2: set["iTrace_Artefact"] = None, iTraceModel7: "iTrace_TraceLink" = None, iTraceModel15: "iTrace_Artefact" = None, iTraceModel28: "iTrace_SpecificFeature" = None):
...
class iTrace_SpecificFeature:
    ...
    def __init__(self, groupName: str, SpecificFeature: "iTrace_iTraceModel" = None, specificFeatures: "iTrace_iTraceModel" = None, SpecificFeature25: "iTrace_Feature" = None, specificFeature: set["iTrace_Feature"] = None):
