...
# Classes
iTrace_SpecificFeature = Class(name="iTrace_SpecificFeature")
iTrace_iTraceModel = Class(name="iTrace_iTraceModel")
iTrace_TraceLink = Class(name="iTrace_TraceLink", is_abstract=True)
iTrace_Artefact = Class(name="iTrace_Artefact", is_abstract=True)
iTrace_SourceElement = Class(name="iTrace_SourceElement")
iTrace_TraceLinkElement = Class(name="iTrace_TraceLinkElement", is_abstract=True)
iTrace_Model = Class(name="iTrace_Model")
iTrace_EObject = Class(name="iTrace_EObject")
iTrace_M2MLink = Class(name="iTrace_M2MLink")
TraceLink = Class(name="TraceLink")
iTrace_TargetElement = Class(name="iTrace_TargetElement")
iTrace_M2TLink = Class(name="iTrace_M2TLink")
iTrace_Block = Class(name="iTrace_Block")
iTrace_Code = Class(name="iTrace_Code")
Artefact = Class(name="Artefact")
TraceLinkElement = Class(name="TraceLinkElement")
iTrace_Feature = Class(name="iTrace_Feature")
...
iTrace_TraceLink.attributes={iTrace_TraceLink_ruleName, iTrace_TraceLink_mode, iTrace_TraceLink_createdBy, iTrace_TraceLink_createdOn, iTrace_TraceLink_fromFileName, iTrace_TraceLink_technicalBinding, iTrace_TraceLink_type, iTrace_TraceLink_comment}
...
iTrace_Artefact.attributes={iTrace_Artefact_abstractionLevel, iTrace_Artefact_aspect, iTrace_Artefact_name, iTrace_Artefact_path}
...
iTrace_TraceLinkElement.attributes={iTrace_TraceLinkElement_ref, iTrace_TraceLinkElement_name, iTrace_TraceLinkElement_type}
...
iTrace_Block.attributes={iTrace_Block_startColumn, iTrace_Block_startLine, iTrace_Block_endColumn, iTrace_Block_endLine, iTrace_Block_blockNumber}
...
iTrace_Feature.attributes={iTrace_Feature_value, iTrace_Feature_attribute}
...
domain_model = DomainModel(
    name="iTrace",
    types={iTrace_SpecificFeature, iTrace_iTraceModel, iTrace_TraceLink, iTrace_Artefact, iTrace_SourceElement, iTrace_TraceLinkElement, iTrace_Model, iTrace_EObject, iTrace_M2MLink, TraceLink, iTrace_TargetElement, iTrace_M2TLink, iTrace_Block, iTrace_Code, Artefact, TraceLinkElement, iTrace_Feature, AbstractionLevel, Aspect, Mode, Type, ModelType},
    associations={specificFeatures3, traceLinks0, artefacts1, sourceElements5, iTraceModel6, model8, object9, targetElements10, targetBlocks12, iTraceModel14, blocks16, iTraceModel27, code18, traceLink19, elements20, traceLink21, traceLink23, specificFeature24, features26},
    generalizations={gen_iTrace_M2MLink_TraceLink, gen_iTrace_M2TLink_TraceLink, gen_iTrace_Code_Artefact, gen_iTrace_Model_Artefact, gen_iTrace_SourceElement_TraceLinkElement, gen_iTrace_TargetElement_TraceLinkElement},
    metadata=None
)
