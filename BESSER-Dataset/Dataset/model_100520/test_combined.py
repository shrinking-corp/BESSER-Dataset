...
def test_hyp_textualusecase_loopstatement_is_not_abstract():
    assert not inspect.isabstract(textualusecase_LoopStatement)


def test_hyp_textualusecase_loopstatement_constructor_exists():
    assert callable(textualusecase_LoopStatement.__init__)


def test_hyp_textualusecase_loopstatement_constructor_args():
    sig = inspect.signature(textualusecase_LoopStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_textualusecase_conditionalstatement_is_not_abstract():
    assert not inspect.isabstract(textualusecase_ConditionalStatement)


def test_hyp_textualusecase_conditionalstatement_constructor_exists():
    assert callable(textualusecase_ConditionalStatement.__init__)


def test_hyp_textualusecase_conditionalstatement_constructor_args():
...
def test_hyp_textualusecase_statement_is_not_abstract():
    assert not inspect.isabstract(textualusecase_Statement)


def test_hyp_textualusecase_statement_constructor_exists():
    assert callable(textualusecase_Statement.__init__)


def test_hyp_textualusecase_statement_constructor_args():
    sig = inspect.signature(textualusecase_Statement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_textualusecase_flowofevents_is_not_abstract():
    assert not inspect.isabstract(textualusecase_FlowOfEvents)


def test_hyp_textualusecase_flowofevents_constructor_exists():
    assert callable(textualusecase_FlowOfEvents.__init__)


def test_hyp_textualusecase_flowofevents_constructor_args():
...
def test_hyp_textualusecase_action_is_not_abstract():
    assert not inspect.isabstract(textualusecase_Action)


def test_hyp_textualusecase_action_constructor_exists():
    assert callable(textualusecase_Action.__init__)


def test_hyp_textualusecase_action_constructor_args():
...
def test_hyp_textualusecase_agent_is_not_abstract():
    assert not inspect.isabstract(textualusecase_Agent)


def test_hyp_textualusecase_agent_constructor_exists():
    assert callable(textualusecase_Agent.__init__)


def test_hyp_textualusecase_agent_constructor_args():
...
def test_hyp_flowofevents_is_not_abstract():
    assert not inspect.isabstract(FlowOfEvents)


def test_hyp_flowofevents_constructor_exists():
    assert callable(FlowOfEvents.__init__)


def test_hyp_flowofevents_constructor_args():
    sig = inspect.signature(FlowOfEvents.__init__)
    params = list(sig.parameters.keys())



def test_hyp_textualusecase_include_is_not_abstract():
    assert not inspect.isabstract(textualusecase_Include)


def test_hyp_textualusecase_include_constructor_exists():
    assert callable(textualusecase_Include.__init__)


def test_hyp_textualusecase_include_constructor_args():
    sig = inspect.signature(textualusecase_Include.__init__)
    params = list(sig.parameters.keys())



def test_hyp_textualusecase_condition_is_not_abstract():
    assert not inspect.isabstract(textualusecase_Condition)


def test_hyp_textualusecase_condition_constructor_exists():
    assert callable(textualusecase_Condition.__init__)


def test_hyp_textualusecase_condition_constructor_args():
...
def test_hyp_textualusecase_step_is_not_abstract():
    assert not inspect.isabstract(textualusecase_Step)


def test_hyp_textualusecase_step_constructor_exists():
    assert callable(textualusecase_Step.__init__)


def test_hyp_textualusecase_step_constructor_args():
...
def test_hyp_textualusecase_alternativeflow_is_not_abstract():
    assert not inspect.isabstract(textualusecase_AlternativeFlow)


def test_hyp_textualusecase_alternativeflow_constructor_exists():
    assert callable(textualusecase_AlternativeFlow.__init__)


def test_hyp_textualusecase_alternativeflow_constructor_args():
    sig = inspect.signature(textualusecase_AlternativeFlow.__init__)
    params = list(sig.parameters.keys())



def test_hyp_textualusecase_subject_is_not_abstract():
    assert not inspect.isabstract(textualusecase_Subject)


def test_hyp_textualusecase_subject_constructor_exists():
    assert callable(textualusecase_Subject.__init__)


def test_hyp_textualusecase_subject_constructor_args():
    sig = inspect.signature(textualusecase_Subject.__init__)
    params = list(sig.parameters.keys())



def test_hyp_textualusecase_actor_is_not_abstract():
    assert not inspect.isabstract(textualusecase_Actor)


def test_hyp_textualusecase_actor_constructor_exists():
    assert callable(textualusecase_Actor.__init__)


def test_hyp_textualusecase_actor_constructor_args():
    sig = inspect.signature(textualusecase_Actor.__init__)
    params = list(sig.parameters.keys())



def test_hyp_textualusecase_usecase_is_not_abstract():
    assert not inspect.isabstract(textualusecase_UseCase)


def test_hyp_textualusecase_usecase_constructor_exists():
    assert callable(textualusecase_UseCase.__init__)


def test_hyp_textualusecase_usecase_constructor_args():
...
def test_hyp_textualusecase_basicflow_is_not_abstract():
    assert not inspect.isabstract(textualusecase_BasicFlow)


def test_hyp_textualusecase_basicflow_constructor_exists():
    assert callable(textualusecase_BasicFlow.__init__)


def test_hyp_textualusecase_basicflow_constructor_args():
    sig = inspect.signature(textualusecase_BasicFlow.__init__)
    params = list(sig.parameters.keys())



def test_hyp_textualusecase_usecasemodel_is_not_abstract():
    assert not inspect.isabstract(textualusecase_UseCaseModel)


def test_hyp_textualusecase_usecasemodel_constructor_exists():
    assert callable(textualusecase_UseCaseModel.__init__)


def test_hyp_textualusecase_usecasemodel_constructor_args():
...
def test_hyp_textualusecase_flowofevents_name_setter(instance):
...
def test_hyp_textualusecase_action_description_setter(instance):
...
def test_hyp_textualusecase_agent_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_textualusecase_condition_expression_setter(instance):
...
def test_hyp_textualusecase_step_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_textualusecase_usecase_description_setter(instance):
    original = instance.description
    instance.description = original
    assert instance.description == original
...
@given(instance=textualusecase_UseCase_strategy)
def test_hyp_textualusecase_usecase_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
