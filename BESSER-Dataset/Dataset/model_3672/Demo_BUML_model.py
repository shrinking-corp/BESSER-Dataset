...
# Classes
Demo_Employee = Class(name="Demo_Employee")
Demo_Department = Class(name="Demo_Department")
Demo_Project = Class(name="Demo_Project")
...
Demo_Department.attributes={Demo_Department_name, Demo_Department_location, Demo_Department_budget}
...
domain_model = DomainModel(
    ...
    associations={WorksIn_employee2, Controls_project3, WorksOn_employee5, Controls_department7, WorksIn_department0, WorksOn_project1},
    generalizations={},
    metadata=None
)
