...
class Demo_Project:
    ...
    def __init__(self, name: bool, budget: int, Project4: "Demo_Department" = None, WorksOn_project: set["Demo_Employee"] = None, Controls_project: "Demo_Department" = None, Project: "Demo_Employee" = None):
        self.name = name
        self.budget = budget
...
class Demo_Department:
    ...
    def __init__(self, location: bool, budget: int, name: bool, WorksIn_department: set["Demo_Employee"] = None, Controls_department: set["Demo_Project"] = None, Department8: "Demo_Project" = None, Department: "Demo_Employee" = None):
...
class Demo_Employee:
    ...
    def __init__(self, name: bool, salary: int, Employee: "Demo_Department" = None, Employee6: "Demo_Project" = None, WorksIn_employee: set["Demo_Department"] = None, WorksOn_employee: set["Demo_Project"] = None):
        self.name = name
        self.salary = salary
