...
class becontent_CustomPager:
    ...
    def __init__(self, className: str, length: int, template: str, query: str, filter: str, order: str, _id_model: str, becontent_CustomPager61: "becontent_Form" = None, becontent_CustomPager: "becontent_EntityManagerPage" = None):
...
class becontent_Form(FormElement):
    ...
    def __init__(self, name: str, method: str, description: str, becontent_Form56: "becontent_DefinitionItem" = None, becontent_Form58: set["becontent_FormElement"] = None, becontent_Form60: "becontent_CustomPager" = None, becontent_Form63: set["becontent_Validation"] = None, becontent_Form: "becontent_EntityManagerPage" = None):
        self.name = name
        self.method = method
...
class becontent_ConditionalTemplate:
    ...
    def __init__(self, trueTemplate: str, falseTemplate: str, conditionExp: str, fieldName: str, _id_model: str, becontent_ConditionalTemplate: "becontent_Content" = None):
...
class becontent_EntityField(ABC):
    ...
    def __init__(self, isPresented: bool, isTextSearch: bool, isSearchPresentationHead: bool, isSearchPresentationBody: bool, becontent_EntityField: "becontent_Entity" = None):
        ...
        pass
    @property
    def isSearchPresentationHead(self):
    ...
    @property
    def isSearchPresentationBody(self):
...
class becontent_Entity(DefinitionItem):
    ...
    def __init__(self, name: str, variableName: str, isOwned: bool, presentationString: str, rssFilter: str, becontent_Entity26: "becontent_Channel" = None, becontent_Entity35: "becontent_Content" = None, becontent_Entity47: "becontent_JoinEntity" = None, becontent_Entity3: "becontent_Channel" = None, becontent_Entity5: "becontent_Handler" = None, becontent_Entity: set["becontent_EntityField"] = None, becontent_Entity8: "becontent_CustomRelation" = None, becontent_Entity11: "becontent_CustomRelation" = None, becontent_Entity18: "becontent_Reference" = None, becontent_Entity73: "becontent_RadioFromReference" = None, becontent_Entity71: "becontent_SelectFromReference" = None):
        self.name = name
...
class becontent_Handler(BeContentElement):
    ...
    def __init__(self, fileName: str, mainSkinWithPager: bool, mainSkinPagerLength: int, mainSkinPlaceholder: str, becontent_Handler28: set["becontent_ViewItem"] = None, becontent_Handler30: "becontent_Skin" = None, becontent_Handler32: "becontent_ViewItem" = None, becontent_Handler: "becontent_Entity" = None):
        self.fileName = fileName
...
class becontent_Channel(BeContentElement):
    ...
    def __init__(self, parameters: str, _id_model: str, becontent_Channel25: "becontent_Entity" = None, becontent_Channel: "becontent_Entity" = None):
...
class becontent_HierarchicalPosition(NotStructuredElement):
    ...
    def __init__(self, name: str, label: str, controlledField: str, referenceField: str, size: int):
        self.name = name
        self.label = label
        self.controlledField = controlledField
...
class becontent_Editor(NotStructuredElement):
    ...
    def __init__(self, columns: int, isMandatory: bool, name: str, label: str, rows: int):
...
class becontent_Validation:
    ...
    def __init__(self, condition: str, message: str, _id_model: str, becontent_Validation64: "becontent_Form" = None, becontent_Validation: "becontent_EntityManagerPage" = None, becontent_Validation66: "becontent_NotStructuredElement" = None, becontent_Validation68: "becontent_NotStructuredElement" = None):
