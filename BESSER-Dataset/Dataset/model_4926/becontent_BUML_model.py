...
# Classes
becontent_Channel = Class(name="becontent_Channel")
becontent_Handler = Class(name="becontent_Handler")
becontent_CustomEntity = Class(name="becontent_CustomEntity")
Entity = Class(name="Entity")
becontent_SystemEntity = Class(name="becontent_SystemEntity")
becontent_SystemEntityField = Class(name="becontent_SystemEntityField", is_abstract=True)
becontent_Relation = Class(name="becontent_Relation", is_abstract=True)
becontent_CustomRelation = Class(name="becontent_CustomRelation")
Relation = Class(name="Relation")
becontent_BeContentModel = Class(name="becontent_BeContentModel")
becontent_BeContentElement = Class(name="becontent_BeContentElement", is_abstract=True)
becontent_DefinitionItem = Class(name="becontent_DefinitionItem", is_abstract=True)
BeContentElement = Class(name="BeContentElement")
becontent_Entity = Class(name="becontent_Entity", is_abstract=True)
DefinitionItem = Class(name="DefinitionItem")
becontent_EntityField = Class(name="becontent_EntityField", is_abstract=True)
becontent_AttributeDate = Class(name="becontent_AttributeDate")
becontent_AttributeLongDate = Class(name="becontent_AttributeLongDate")
becontent_AttributeText = Class(name="becontent_AttributeText")
becontent_AttributePassword = Class(name="becontent_AttributePassword")
becontent_AttributePosition = Class(name="becontent_AttributePosition")
becontent_AttributeImage = Class(name="becontent_AttributeImage")
becontent_AttributeInteger = Class(name="becontent_AttributeInteger")
becontent_AttributeVarchar = Class(name="becontent_AttributeVarchar")
becontent_AttributeFile = Class(name="becontent_AttributeFile")
becontent_SystemRelation = Class(name="becontent_SystemRelation")
becontent_Reference = Class(name="becontent_Reference")
EntityField = Class(name="EntityField")
becontent_TypedAttribute = Class(name="becontent_TypedAttribute", is_abstract=True)
becontent_AttributeColor = Class(name="becontent_AttributeColor")
TypedAttribute = Class(name="TypedAttribute")
becontent_SystemAttributeImage = Class(name="becontent_SystemAttributeImage")
becontent_SystemAttributeInteger = Class(name="becontent_SystemAttributeInteger")
becontent_SystemAttributeVarchar = Class(name="becontent_SystemAttributeVarchar")
becontent_SystemAttributeFile = Class(name="becontent_SystemAttributeFile")
becontent_SystemAttributeFileToFolder = Class(name="becontent_SystemAttributeFileToFolder")
becontent_AttributeFileToFolder = Class(name="becontent_AttributeFileToFolder")
becontent_FileToFolderExtension = Class(name="becontent_FileToFolderExtension")
becontent_SystemReference = Class(name="becontent_SystemReference")
SystemEntityField = Class(name="SystemEntityField")
becontent_TypedSystemAttribute = Class(name="becontent_TypedSystemAttribute", is_abstract=True)
becontent_SystemAttributeColor = Class(name="becontent_SystemAttributeColor")
TypedSystemAttribute = Class(name="TypedSystemAttribute")
becontent_SystemAttributeDate = Class(name="becontent_SystemAttributeDate")
becontent_SystemAttributeLongDate = Class(name="becontent_SystemAttributeLongDate")
becontent_SystemAttributeText = Class(name="becontent_SystemAttributeText")
becontent_SystemAttributePassword = Class(name="becontent_SystemAttributePassword")
becontent_SystemAttributePosition = Class(name="becontent_SystemAttributePosition")
becontent_Skinlet = Class(name="becontent_Skinlet")
becontent_Content = Class(name="becontent_Content")
becontent_ViewItem = Class(name="becontent_ViewItem", is_abstract=True)
becontent_Skin = Class(name="becontent_Skin")
becontent_Template = Class(name="becontent_Template")
ViewItem = Class(name="ViewItem")
becontent_Parameter = Class(name="becontent_Parameter")
ContentCommand = Class(name="ContentCommand")
becontent_UnsetParameter = Class(name="becontent_UnsetParameter")
becontent_Copy = Class(name="becontent_Copy")
becontent_Propagate = Class(name="becontent_Propagate")
becontent_JoinEntity = Class(name="becontent_JoinEntity")
becontent_ContentCommand = Class(name="becontent_ContentCommand", is_abstract=True)
becontent_ConditionalTemplate = Class(name="becontent_ConditionalTemplate")
becontent_FormElement = Class(name="becontent_FormElement", is_abstract=True)
FormElement = Class(name="FormElement")
becontent_Trigger = Class(name="becontent_Trigger")
becontent_ApplyCommand = Class(name="becontent_ApplyCommand", is_abstract=True)
becontent_Apply = Class(name="becontent_Apply")
ApplyCommand = Class(name="ApplyCommand")
becontent_ApplyItem = Class(name="becontent_ApplyItem")
becontent_ApplyIndexed = Class(name="becontent_ApplyIndexed")
becontent_EntityManagerPage = Class(name="becontent_EntityManagerPage")
becontent_Form = Class(name="becontent_Form")
becontent_CustomPager = Class(name="becontent_CustomPager")
becontent_Validation = Class(name="becontent_Validation")
becontent_Text = Class(name="becontent_Text")
becontent_RadioButton = Class(name="becontent_RadioButton")
becontent_Checkbox = Class(name="becontent_Checkbox")
becontent_ExtendedForm = Class(name="becontent_ExtendedForm")
Form = Class(name="Form")
becontent_NotStructuredElement = Class(name="becontent_NotStructuredElement", is_abstract=True)
becontent_Section = Class(name="becontent_Section")
NotStructuredElement = Class(name="NotStructuredElement")
becontent_Link = Class(name="becontent_Link")
becontent_Password = Class(name="becontent_Password")
becontent_Select = Class(name="becontent_Select")
becontent_Textarea = Class(name="becontent_Textarea")
becontent_Editor = Class(name="becontent_Editor")
becontent_Image = Class(name="becontent_Image")
becontent_Color = Class(name="becontent_Color")
becontent_RelationManager = Class(name="becontent_RelationManager")
becontent_Date = Class(name="becontent_Date")
becontent_LongDate = Class(name="becontent_LongDate")
becontent_File = Class(name="becontent_File")
becontent_FileToFolder = Class(name="becontent_FileToFolder")
becontent_RadioFromReference = Class(name="becontent_RadioFromReference")
becontent_Year = Class(name="becontent_Year")
becontent_Position = Class(name="becontent_Position")
becontent_HierarchicalPosition = Class(name="becontent_HierarchicalPosition")
becontent_SelectFromReference = Class(name="becontent_SelectFromReference")
becontent_Hidden = Class(name="becontent_Hidden")
...
becontent_Handler.attributes={becontent_Handler_mainSkinWithPager, becontent_Handler_mainSkinPlaceholder, becontent_Handler_mainSkinPagerLength, becontent_Handler_fileName}
...
becontent_SystemEntityField.attributes={becontent_SystemEntityField_isTextSearch, becontent_SystemEntityField_isSearchPresentationBody, becontent_SystemEntityField_isPresented, becontent_SystemEntityField_isSearchPresentationHead}
...
becontent_Relation.attributes={becontent_Relation_variableName, becontent_Relation_name}
...
becontent_Entity.attributes={becontent_Entity_name, becontent_Entity_rssFilter, becontent_Entity_presentationString, becontent_Entity_variableName, becontent_Entity_isOwned}
...
becontent_EntityField.attributes={becontent_EntityField_isSearchPresentationBody, becontent_EntityField_isPresented, becontent_EntityField_isSearchPresentationHead, becontent_EntityField_isTextSearch}
...
becontent_Skinlet.attributes={becontent_Skinlet__id_model, becontent_Skinlet_template}
...
becontent_Content.attributes={becontent_Content_style, becontent_Content_joinCondition, becontent_Content_limit, becontent_Content_template, becontent_Content_orderFields, becontent_Content__id_model, becontent_Content_filter, becontent_Content_presentationFields}
...
becontent_Template.attributes={becontent_Template__id_model, becontent_Template_path}
...
becontent_ConditionalTemplate.attributes={becontent_ConditionalTemplate_trueTemplate, becontent_ConditionalTemplate__id_model, becontent_ConditionalTemplate_conditionExp, becontent_ConditionalTemplate_fieldName, becontent_ConditionalTemplate_falseTemplate}
...
becontent_Form.attributes={becontent_Form_method, becontent_Form_description, becontent_Form_name}
...
becontent_CustomPager.attributes={becontent_CustomPager_className, becontent_CustomPager_length, becontent_CustomPager_template, becontent_CustomPager__id_model, becontent_CustomPager_filter, becontent_CustomPager_order, becontent_CustomPager_query}
...
becontent_Validation.attributes={becontent_Validation__id_model, becontent_Validation_message, becontent_Validation_condition}
...
becontent_Text.attributes={becontent_Text_isMandatory, becontent_Text_size, becontent_Text_name, becontent_Text_maxLength, becontent_Text_label}
...
becontent_RadioButton.attributes={becontent_RadioButton_name, becontent_RadioButton_label, becontent_RadioButton_values}
...
becontent_Checkbox.attributes={becontent_Checkbox_value, becontent_Checkbox_label, becontent_Checkbox_isChecked, becontent_Checkbox_name}
...
becontent_Section.attributes={becontent_Section_name, becontent_Section_text}
...
becontent_Link.attributes={becontent_Link_name, becontent_Link_size, becontent_Link_label, becontent_Link_isMandatory, becontent_Link_maxLength}
...
becontent_Password.attributes={becontent_Password_isMandatory, becontent_Password_size, becontent_Password_label, becontent_Password_maxLength, becontent_Password_name}
...
becontent_Select.attributes={becontent_Select_values, becontent_Select_label, becontent_Select_isMandatory, becontent_Select_name}
...
becontent_Textarea.attributes={becontent_Textarea_label, becontent_Textarea_columns, becontent_Textarea_isMandatory, becontent_Textarea_rows, becontent_Textarea_name}
...
becontent_Editor.attributes={becontent_Editor_columns, becontent_Editor_isMandatory, becontent_Editor_rows, becontent_Editor_label, becontent_Editor_name}
...
becontent_Image.attributes={becontent_Image_label, becontent_Image_isMandatory, becontent_Image_name}
...
becontent_Color.attributes={becontent_Color_defaultColor, becontent_Color_label, becontent_Color_name}
...
becontent_RelationManager.attributes={becontent_RelationManager_label, becontent_RelationManager_orientation, becontent_RelationManager_restrictCondition, becontent_RelationManager_name}
...
becontent_LongDate.attributes={becontent_LongDate_label, becontent_LongDate_name, becontent_LongDate_isMandatory}
...
becontent_File.attributes={becontent_File_label, becontent_File_extension, becontent_File_extensionMessage, becontent_File_isMandatory, becontent_File_name}
...
becontent_FileToFolder.attributes={becontent_FileToFolder_extensionMessage, becontent_FileToFolder_extension, becontent_FileToFolder_label, becontent_FileToFolder_name, becontent_FileToFolder_isMandatory}
...
becontent_RadioFromReference.attributes={becontent_RadioFromReference_isMandatory, becontent_RadioFromReference_restrictCondition, becontent_RadioFromReference_label, becontent_RadioFromReference_name}
...
becontent_Year.attributes={becontent_Year_name, becontent_Year_end, becontent_Year_label, becontent_Year_start, becontent_Year_isMandatory}
...
becontent_Position.attributes={becontent_Position_name, becontent_Position_isMandatory, becontent_Position_controlledField, becontent_Position_label, becontent_Position_size}
...
becontent_HierarchicalPosition.attributes={becontent_HierarchicalPosition_referenceField, becontent_HierarchicalPosition_name, becontent_HierarchicalPosition_size, becontent_HierarchicalPosition_controlledField, becontent_HierarchicalPosition_label}
...
becontent_SelectFromReference.attributes={becontent_SelectFromReference_restrictCondition, becontent_SelectFromReference_label, becontent_SelectFromReference_name, becontent_SelectFromReference_isMandatory}
...
becontent_Hidden.attributes={becontent_Hidden_values, becontent_Hidden_name}
...
domain_model = DomainModel(
    name="becontent",
    types={becontent_Channel, becontent_Handler, becontent_CustomEntity, Entity, becontent_SystemEntity, becontent_SystemEntityField, becontent_Relation, becontent_CustomRelation, Relation, becontent_BeContentModel, becontent_BeContentElement, becontent_DefinitionItem, BeContentElement, becontent_Entity, DefinitionItem, becontent_EntityField, becontent_AttributeDate, becontent_AttributeLongDate, becontent_AttributeText, becontent_AttributePassword, becontent_AttributePosition, becontent_AttributeImage, becontent_AttributeInteger, becontent_AttributeVarchar, becontent_AttributeFile, becontent_SystemRelation, becontent_Reference, EntityField, becontent_TypedAttribute, becontent_AttributeColor, TypedAttribute, becontent_SystemAttributeImage, becontent_SystemAttributeInteger, becontent_SystemAttributeVarchar, becontent_SystemAttributeFile, becontent_SystemAttributeFileToFolder, becontent_AttributeFileToFolder, becontent_FileToFolderExtension, becontent_SystemReference, SystemEntityField, becontent_TypedSystemAttribute, becontent_SystemAttributeColor, TypedSystemAttribute, becontent_SystemAttributeDate, becontent_SystemAttributeLongDate, becontent_SystemAttributeText, becontent_SystemAttributePassword, becontent_SystemAttributePosition, becontent_Skinlet, becontent_Content, becontent_ViewItem, becontent_Skin, becontent_Template, ViewItem, becontent_Parameter, ContentCommand, becontent_UnsetParameter, becontent_Copy, becontent_Propagate, becontent_JoinEntity, becontent_ContentCommand, becontent_ConditionalTemplate, becontent_FormElement, FormElement, becontent_Trigger, becontent_ApplyCommand, becontent_Apply, ApplyCommand, becontent_ApplyItem, becontent_ApplyIndexed, becontent_EntityManagerPage, becontent_Form, becontent_CustomPager, becontent_Validation, becontent_Text, becontent_RadioButton, becontent_Checkbox, becontent_ExtendedForm, Form, becontent_NotStructuredElement, becontent_Section, NotStructuredElement, becontent_Link, becontent_Password, becontent_Select, becontent_Textarea, becontent_Editor, becontent_Image, becontent_Color, becontent_RelationManager, becontent_Date, becontent_LongDate, becontent_File, becontent_FileToFolder, becontent_RadioFromReference, becontent_Year, becontent_Position, becontent_HierarchicalPosition, becontent_SelectFromReference, becontent_Hidden, ContentStyle, ConditionalTemplateExpType, FormMethodType, ConditionType, OrientationType},
    associations={rss2, handler4, systemFields6, modelElements0, fields1, leftForeignkey7, rightForeignkey9, leftForeignkey12, rightForeignkey14, referredEntity17, fileExtensions22, fileExtensions19, referredEntity20, channel24, viewItems27, mainSkin29, mainSkinGetContent31, mainEntity34, joinEntities36, commands38, conditionalTemplate40, joinRule43, referredEntity45, mainEntity55, elements57, customPager59, validations62, viewItem48, forms50, customPagers51, validations53, firstElement65, secondElement67, referredEntity72, referredEntity70},
    generalizations={gen_becontent_CustomEntity_Entity, gen_becontent_SystemEntity_Entity, gen_becontent_Relation_DefinitionItem, gen_becontent_CustomRelation_Relation, gen_becontent_DefinitionItem_BeContentElement, gen_becontent_Entity_DefinitionItem, gen_becontent_AttributeDate_TypedAttribute, gen_becontent_AttributeLongDate_TypedAttribute, gen_becontent_AttributeText_TypedAttribute, gen_becontent_AttributePassword_TypedAttribute, gen_becontent_AttributePosition_TypedAttribute, gen_becontent_AttributeImage_TypedAttribute, gen_becontent_AttributeInteger_TypedAttribute, gen_becontent_AttributeVarchar_TypedAttribute, gen_becontent_AttributeFile_TypedAttribute, gen_becontent_SystemRelation_Relation, gen_becontent_Reference_EntityField, gen_becontent_TypedAttribute_EntityField, gen_becontent_AttributeColor_TypedAttribute, gen_becontent_SystemAttributeImage_TypedSystemAttribute, gen_becontent_SystemAttributeInteger_TypedSystemAttribute, gen_becontent_SystemAttributeVarchar_TypedSystemAttribute, gen_becontent_SystemAttributeFile_TypedSystemAttribute, gen_becontent_SystemAttributeFileToFolder_TypedSystemAttribute, gen_becontent_FileToFolderExtension_BeContentElement, gen_becontent_AttributeFileToFolder_TypedAttribute, gen_becontent_SystemReference_SystemEntityField, gen_becontent_TypedSystemAttribute_SystemEntityField, gen_becontent_SystemAttributeColor_TypedSystemAttribute, gen_becontent_SystemAttributeDate_TypedSystemAttribute, gen_becontent_SystemAttributeLongDate_TypedSystemAttribute, gen_becontent_SystemAttributeText_TypedSystemAttribute, gen_becontent_SystemAttributePassword_TypedSystemAttribute, gen_becontent_SystemAttributePosition_TypedSystemAttribute, gen_becontent_Skinlet_ViewItem, gen_becontent_Skin_ViewItem, gen_becontent_Content_ViewItem, gen_becontent_Channel_BeContentElement, gen_becontent_Handler_BeContentElement, gen_becontent_Template_ViewItem, gen_becontent_Parameter_ContentCommand, gen_becontent_UnsetParameter_ContentCommand, gen_becontent_Copy_ContentCommand, gen_becontent_Propagate_ContentCommand, gen_becontent_Form_FormElement, gen_becontent_Trigger_ContentCommand, gen_becontent_ApplyCommand_ContentCommand, gen_becontent_Apply_ApplyCommand, gen_becontent_ApplyItem_ApplyCommand, gen_becontent_ApplyIndexed_ApplyCommand, gen_becontent_EntityManagerPage_BeContentElement, gen_becontent_Text_NotStructuredElement, gen_becontent_RadioButton_NotStructuredElement, gen_becontent_Checkbox_NotStructuredElement, gen_becontent_ExtendedForm_Form, gen_becontent_NotStructuredElement_FormElement, gen_becontent_Section_NotStructuredElement, gen_becontent_Link_NotStructuredElement, gen_becontent_Password_NotStructuredElement, gen_becontent_Select_NotStructuredElement, gen_becontent_Textarea_NotStructuredElement, gen_becontent_Editor_NotStructuredElement, gen_becontent_Image_NotStructuredElement, gen_becontent_Color_NotStructuredElement, gen_becontent_RelationManager_NotStructuredElement, gen_becontent_Date_NotStructuredElement, gen_becontent_LongDate_NotStructuredElement, gen_becontent_File_NotStructuredElement, gen_becontent_FileToFolder_NotStructuredElement, gen_becontent_RadioFromReference_NotStructuredElement, gen_becontent_Year_NotStructuredElement, gen_becontent_Position_NotStructuredElement, gen_becontent_HierarchicalPosition_NotStructuredElement, gen_becontent_SelectFromReference_NotStructuredElement, gen_becontent_Hidden_NotStructuredElement},
    metadata=None
)
