...
di_BPMNLabelStyle = Class(name="di_BPMNLabelStyle")
di_EStringToStringMapEntry = Class(name="di_EStringToStringMapEntry")
di_BPMNDiagram = Class(name="di_BPMNDiagram")
di_BPMNEdge = Class(name="di_BPMNEdge")
di_BPMNLabel = Class(name="di_BPMNLabel")
Diagram = Class(name="Diagram")
di_BPMNPlane = Class(name="di_BPMNPlane")
di_BPMNShape = Class(name="di_BPMNShape")
di_DiagramElement = Class(name="di_DiagramElement")
LabeledEdge = Class(name="LabeledEdge")
di_BaseElement = Class(name="di_BaseElement")
Label = Class(name="Label")
Plane = Class(name="Plane")
LabeledShape = Class(name="LabeledShape")
Style = Class(name="Style")
di_Font = Class(name="di_Font")
...
di_BPMNShape.attributes={di_BPMNShape_isMessageVisible, di_BPMNShape_isExpanded, di_BPMNShape_isHorizontal, di_BPMNShape_participantBandKind, di_BPMNShape_isMarkerVisible}
...
domain_model = DomainModel(
    name="di",
    types={di_DocumentRoot, di_BPMNLabelStyle, di_EStringToStringMapEntry, di_BPMNDiagram, di_BPMNEdge, di_BPMNLabel, Diagram, di_BPMNPlane, di_BPMNShape, di_DiagramElement, LabeledEdge, di_BaseElement, Label, Plane, LabeledShape, Style, di_Font, ParticipantBandKind, MessageVisibleKind},
    associations={bPMNLabel8, bPMNLabelStyle10, xMLNSPrefixMap0, xSISchemaLocation1, bPMNDiagram4, bPMNEdge6, plane16, bPMNPlane12, bPMNShape14, bpmnElement25, sourceElement27, labelStyle19, label22, targetElement29, bpmnElement37, label40, labelStyle32, font35, bpmnElement43, choreographyActivityShape47},
    generalizations={gen_di_BPMNDiagram_Diagram, gen_di_BPMNEdge_LabeledEdge, gen_di_BPMNLabel_Label, gen_di_BPMNPlane_Plane, gen_di_BPMNShape_LabeledShape, gen_di_BPMNLabelStyle_Style},
    metadata=None
)
