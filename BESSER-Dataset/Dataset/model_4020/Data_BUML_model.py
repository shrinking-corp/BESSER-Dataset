...
# Classes
Data_Classe = Class(name="Data_Classe")
DeclarationType = Class(name="DeclarationType")
Data_Attribut = Class(name="Data_Attribut")
Data_DeclarationType = Class(name="Data_DeclarationType")
Data_Modele = Class(name="Data_Modele")
...
Data_Attribut.attributes={Data_Attribut_estTableau, Data_Attribut_nom, Data_Attribut_typeStr}
