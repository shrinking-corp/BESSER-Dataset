...
def test_types_jvminnertypereference_is_not_abstract():
    assert not inspect.isabstract(types_JvmInnerTypeReference)


def test_types_jvminnertypereference_constructor_exists():
    assert callable(types_JvmInnerTypeReference.__init__)


def test_types_jvminnertypereference_constructor_args():
...
def test_types_jvmoperation_has_native():
    assert hasattr(types_JvmOperation, "native")
    descriptor = None
...
def test_types_jvmoperation_has_synchronized():
    assert hasattr(types_JvmOperation, "synchronized")
    descriptor = None
    for klass in types_JvmOperation.__mro__:
...
def test_types_jvmoperation_has_strictFloatingPoint():
    assert hasattr(types_JvmOperation, "strictFloatingPoint")
    descriptor = None
    for klass in types_JvmOperation.__mro__:
...
def test_types_jvmoperation_has_default():
    assert hasattr(types_JvmOperation, "default")
    descriptor = None
    for klass in types_JvmOperation.__mro__:
...
def test_types_jvmfield_has_constantValue():
    assert hasattr(types_JvmField, "constantValue")
    descriptor = None
...
def test_types_jvmfield_has_constant():
    assert hasattr(types_JvmField, "constant")
    descriptor = None
    for klass in types_JvmField.__mro__:
...
def test_types_jvmfield_has_volatile():
    assert hasattr(types_JvmField, "volatile")
    descriptor = None
    for klass in types_JvmField.__mro__:
...
def test_types_jvmfield_has_transient():
    assert hasattr(types_JvmField, "transient")
    descriptor = None
    for klass in types_JvmField.__mro__:
...
def test_types_jvmunknowntypereference_has_qualifiedName():
    assert hasattr(types_JvmUnknownTypeReference, "qualifiedName")
    descriptor = None
...
def test_types_jvmmember_has_deprecated():
    assert hasattr(types_JvmMember, "deprecated")
    descriptor = None
...
def test_types_jvmgenerictype_has_strictFloatingPoint():
    assert hasattr(types_JvmGenericType, "strictFloatingPoint")
    descriptor = None
...
def test_types_jvmgenerictype_has_anonymous():
    assert hasattr(types_JvmGenericType, "anonymous")
    descriptor = None
    for klass in types_JvmGenericType.__mro__:
...
@given(instance=types_JvmOperation_strategy)
def test_types_jvmoperation_native_setter(instance):
...
@given(instance=types_JvmOperation_strategy)
def test_types_jvmoperation_synchronized_setter(instance):
...
@given(instance=types_JvmOperation_strategy)
def test_types_jvmoperation_strictFloatingPoint_setter(instance):
...
@given(instance=types_JvmOperation_strategy)
def test_types_jvmoperation_default_setter(instance):
...
@given(instance=types_JvmField_strategy)
def test_types_jvmfield_constantValue_setter(instance):
...
@given(instance=types_JvmField_strategy)
def test_types_jvmfield_constant_setter(instance):
...
@given(instance=types_JvmField_strategy)
def test_types_jvmfield_volatile_setter(instance):
...
@given(instance=types_JvmField_strategy)
def test_types_jvmfield_transient_setter(instance):
...
@given(instance=types_JvmUnknownTypeReference_strategy)
def test_types_jvmunknowntypereference_qualifiedName_setter(instance):
...
@given(instance=types_JvmMember_strategy)
def test_types_jvmmember_deprecated_setter(instance):
...
@given(instance=types_JvmGenericType_strategy)
def test_types_jvmgenerictype_strictFloatingPoint_setter(instance):
    original = instance.strictFloatingPoint
    instance.strictFloatingPoint = original
    assert instance.strictFloatingPoint == original
...
@given(instance=types_JvmGenericType_strategy)
def test_types_jvmgenerictype_anonymous_setter(instance):
...
@given(instance=types_JvmFeature_strategy)
@settings(max_examples=30)
def test_types_jvmfeature_isstatic_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
        instance.isStatic()
...
@given(instance=types_JvmDeclaredType_strategy)
@settings(max_examples=30)
def test_types_jvmdeclaredtype_isinstantiateable_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
...
@given(instance=types_JvmDeclaredType_strategy)
@settings(max_examples=30)
def test_types_jvmdeclaredtype_findallnestedtypesbyname_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
...
@given(instance=types_JvmDeclaredType_strategy)
@settings(max_examples=30)
def test_types_jvmdeclaredtype_islocal_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
        instance.isLocal()
