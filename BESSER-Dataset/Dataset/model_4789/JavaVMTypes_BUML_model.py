...
# Classes
types_JvmIdentifiableElement = Class(name="types_JvmIdentifiableElement", is_abstract=True)
types_JvmDeclaredType = Class(name="types_JvmDeclaredType", is_abstract=True)
JvmMember = Class(name="JvmMember")
types_JvmType = Class(name="types_JvmType", is_abstract=True)
JvmIdentifiableElement = Class(name="JvmIdentifiableElement")
types_JvmVoid = Class(name="types_JvmVoid")
JvmType = Class(name="JvmType")
types_JvmComponentType = Class(name="types_JvmComponentType", is_abstract=True)
types_JvmArrayType = Class(name="types_JvmArrayType")
types_JvmPrimitiveType = Class(name="types_JvmPrimitiveType")
JvmComponentType = Class(name="JvmComponentType")
types_JvmTypeParameterDeclarator = Class(name="types_JvmTypeParameterDeclarator", is_abstract=True)
types_JvmConstraintOwner = Class(name="types_JvmConstraintOwner", is_abstract=True)
types_JvmTypeConstraint = Class(name="types_JvmTypeConstraint", is_abstract=True)
types_JvmUpperBound = Class(name="types_JvmUpperBound")
JvmTypeConstraint = Class(name="JvmTypeConstraint")
types_JvmLowerBound = Class(name="types_JvmLowerBound")
types_JvmAnnotationType = Class(name="types_JvmAnnotationType")
JvmDeclaredType = Class(name="JvmDeclaredType")
types_JvmEnumerationType = Class(name="types_JvmEnumerationType")
types_JvmTypeReference = Class(name="types_JvmTypeReference", is_abstract=True)
types_JvmMember = Class(name="types_JvmMember", is_abstract=True)
types_JvmTypeParameter = Class(name="types_JvmTypeParameter")
JvmConstraintOwner = Class(name="JvmConstraintOwner")
types_JvmParameterizedTypeReference = Class(name="types_JvmParameterizedTypeReference")
JvmTypeReference = Class(name="JvmTypeReference")
types_JvmGenericArrayTypeReference = Class(name="types_JvmGenericArrayTypeReference")
types_JvmWildcardTypeReference = Class(name="types_JvmWildcardTypeReference")
types_JvmAnyTypeReference = Class(name="types_JvmAnyTypeReference")
types_JvmMultiTypeReference = Class(name="types_JvmMultiTypeReference")
JvmCompoundTypeReference = Class(name="JvmCompoundTypeReference")
JvmAnnotationTarget = Class(name="JvmAnnotationTarget")
types_JvmEnumerationLiteral = Class(name="types_JvmEnumerationLiteral")
JvmField = Class(name="JvmField")
types_JvmGenericType = Class(name="types_JvmGenericType")
JvmTypeParameterDeclarator = Class(name="JvmTypeParameterDeclarator")
types_JvmField = Class(name="types_JvmField")
JvmFeature = Class(name="JvmFeature")
types_JvmExecutable = Class(name="types_JvmExecutable", is_abstract=True)
types_JvmFormalParameter = Class(name="types_JvmFormalParameter")
types_JvmConstructor = Class(name="types_JvmConstructor")
JvmExecutable = Class(name="JvmExecutable")
types_JvmOperation = Class(name="types_JvmOperation")
types_JvmFeature = Class(name="types_JvmFeature", is_abstract=True)
types_JvmAnnotationTarget = Class(name="types_JvmAnnotationTarget", is_abstract=True)
types_JvmAnnotationReference = Class(name="types_JvmAnnotationReference")
types_JvmIntAnnotationValue = Class(name="types_JvmIntAnnotationValue")
JvmAnnotationValue = Class(name="JvmAnnotationValue")
types_JvmBooleanAnnotationValue = Class(name="types_JvmBooleanAnnotationValue")
types_JvmByteAnnotationValue = Class(name="types_JvmByteAnnotationValue")
types_JvmAnnotationValue = Class(name="types_JvmAnnotationValue", is_abstract=True)
types_JvmTypeAnnotationValue = Class(name="types_JvmTypeAnnotationValue")
types_JvmAnnotationAnnotationValue = Class(name="types_JvmAnnotationAnnotationValue")
types_JvmEnumAnnotationValue = Class(name="types_JvmEnumAnnotationValue")
types_JvmDelegateTypeReference = Class(name="types_JvmDelegateTypeReference")
types_JvmSpecializedTypeReference = Class(name="types_JvmSpecializedTypeReference", is_abstract=True)
types_JvmSynonymTypeReference = Class(name="types_JvmSynonymTypeReference")
types_JvmUnknownTypeReference = Class(name="types_JvmUnknownTypeReference")
types_JvmShortAnnotationValue = Class(name="types_JvmShortAnnotationValue")
types_JvmLongAnnotationValue = Class(name="types_JvmLongAnnotationValue")
types_JvmDoubleAnnotationValue = Class(name="types_JvmDoubleAnnotationValue")
types_JvmFloatAnnotationValue = Class(name="types_JvmFloatAnnotationValue")
types_JvmCharAnnotationValue = Class(name="types_JvmCharAnnotationValue")
types_JvmStringAnnotationValue = Class(name="types_JvmStringAnnotationValue")
types_JvmCompoundTypeReference = Class(name="types_JvmCompoundTypeReference", is_abstract=True)
types_JvmCustomAnnotationValue = Class(name="types_JvmCustomAnnotationValue")
types_EObject = Class(name="types_EObject")
types_JvmInnerTypeReference = Class(name="types_JvmInnerTypeReference")
...
types_JvmIdentifiableElement_m_getQualifiedName: Method = Method(name="getQualifiedName", parameters={Parameter(name='types_innerClassDelimiter', type=StringType)}, type=StringType)
...
types_JvmDeclaredType_m_findAllFeaturesByName: Method = Method(name="findAllFeaturesByName", parameters={Parameter(name='types_simpleName', type=StringType)})
...
types_JvmDeclaredType_m_findAllNestedTypesByName: Method = Method(name="findAllNestedTypesByName", parameters={Parameter(name='types_simpleName', type=StringType)})
...
types_JvmDeclaredType.attributes={types_JvmDeclaredType_static, types_JvmDeclaredType_abstract, types_JvmDeclaredType_packageName, types_JvmDeclaredType_final}
types_JvmDeclaredType.methods={types_JvmDeclaredType_m_isInstantiateable, types_JvmDeclaredType_m_isLocal, types_JvmDeclaredType_m_getDeclaredFields, types_JvmDeclaredType_m_getDeclaredConstructors, types_JvmDeclaredType_m_getAllNestedTypes, types_JvmDeclaredType_m_getExtendedClass, types_JvmDeclaredType_m_findAllFeaturesByName, types_JvmDeclaredType_m_getAllFeatures, types_JvmDeclaredType_m_getDeclaredOperations, types_JvmDeclaredType_m_getExtendedInterfaces, types_JvmDeclaredType_m_findAllNestedTypesByName}
...
types_JvmTypeConstraint_m_getQualifiedName: Method = Method(name="getQualifiedName", parameters={Parameter(name='types_innerClassDelimiter', type=StringType)}, type=StringType)
...
types_JvmTypeReference_m_accept: Method = Method(name="accept", parameters={Parameter(name='types_visitor', type=StringType)})
types_JvmTypeReference_m_accept: Method = Method(name="accept", parameters={Parameter(name='types_parameter', type=StringType), Parameter(name='types_visitor', type=StringType)})
...
types_JvmTypeReference_m_getQualifiedName: Method = Method(name="getQualifiedName", parameters={Parameter(name='types_innerClassDelimiter', type=StringType)}, type=StringType)
types_JvmTypeReference.methods={types_JvmTypeReference_m_getType, types_JvmTypeReference_m_getQualifiedName, types_JvmTypeReference_m_accept, types_JvmTypeReference_m_getIdentifier, types_JvmTypeReference_m_getQualifiedName, types_JvmTypeReference_m_getSimpleName, types_JvmTypeReference_m_accept}
...
types_JvmMember_m_internalSetIdentifier: Method = Method(name="internalSetIdentifier", parameters={Parameter(name='types_identifier', type=StringType)})
types_JvmMember.attributes={types_JvmMember_identifier, types_JvmMember_visibility, types_JvmMember_simpleName, types_JvmMember_deprecated}
...
types_JvmGenericType.attributes={types_JvmGenericType_anonymous, types_JvmGenericType_strictFloatingPoint, types_JvmGenericType_interface}
...
types_JvmField.attributes={types_JvmField_final, types_JvmField_constant, types_JvmField_static, types_JvmField_volatile, types_JvmField_transient, types_JvmField_constantValue}
types_JvmField.methods={types_JvmField_m_getConstantValueAsByte, types_JvmField_m_getConstantValueAsShort, types_JvmField_m_getConstantValueAsString, types_JvmField_m_getConstantValueAsDouble, types_JvmField_m_getConstantValueAsLong, types_JvmField_m_getConstantValueAsChar, types_JvmField_m_getConstantValueAsFloat, types_JvmField_m_getConstantValueAsBoolean, types_JvmField_m_getConstantValueAsInt}
...
types_JvmOperation.attributes={types_JvmOperation_default, types_JvmOperation_strictFloatingPoint, types_JvmOperation_native, types_JvmOperation_static, types_JvmOperation_synchronized, types_JvmOperation_final, types_JvmOperation_abstract}
...
domain_model = DomainModel(
    name="types",
    types={types_JvmIdentifiableElement, types_JvmDeclaredType, JvmMember, types_JvmType, JvmIdentifiableElement, types_JvmVoid, JvmType, types_JvmComponentType, types_JvmArrayType, types_JvmPrimitiveType, JvmComponentType, types_JvmTypeParameterDeclarator, types_JvmConstraintOwner, types_JvmTypeConstraint, types_JvmUpperBound, JvmTypeConstraint, types_JvmLowerBound, types_JvmAnnotationType, JvmDeclaredType, types_JvmEnumerationType, types_JvmTypeReference, types_JvmMember, types_JvmTypeParameter, JvmConstraintOwner, types_JvmParameterizedTypeReference, JvmTypeReference, types_JvmGenericArrayTypeReference, types_JvmWildcardTypeReference, types_JvmAnyTypeReference, types_JvmMultiTypeReference, JvmCompoundTypeReference, JvmAnnotationTarget, types_JvmEnumerationLiteral, JvmField, types_JvmGenericType, JvmTypeParameterDeclarator, types_JvmField, JvmFeature, types_JvmExecutable, types_JvmFormalParameter, types_JvmConstructor, JvmExecutable, types_JvmOperation, types_JvmFeature, types_JvmAnnotationTarget, types_JvmAnnotationReference, types_JvmIntAnnotationValue, JvmAnnotationValue, types_JvmBooleanAnnotationValue, types_JvmByteAnnotationValue, types_JvmAnnotationValue, types_JvmTypeAnnotationValue, types_JvmAnnotationAnnotationValue, types_JvmEnumAnnotationValue, types_JvmDelegateTypeReference, types_JvmSpecializedTypeReference, types_JvmSynonymTypeReference, types_JvmUnknownTypeReference, types_JvmShortAnnotationValue, types_JvmLongAnnotationValue, types_JvmDoubleAnnotationValue, types_JvmFloatAnnotationValue, types_JvmCharAnnotationValue, types_JvmStringAnnotationValue, types_JvmCompoundTypeReference, types_JvmCustomAnnotationValue, types_EObject, types_JvmInnerTypeReference, JvmParameterizedTypeReference, JvmVisibility},
    associations={componentType1, arrayType0, declarator4, typeParameters5, constraints6, typeReference7, owner9, superTypes2, members3, arguments11, type13, componentType15, type17, literals10, type21, parameters23, exceptions24, declaringType19, localClasses20, annotations34, annotation35, explicitValues37, operation40, returnType27, defaultValue29, parameterType31, values43, values45, values47, delegate49, equivalent51, type53, references55, values58, outer59},
    generalizations={gen_types_JvmDeclaredType_JvmMember, gen_types_JvmDeclaredType_JvmComponentType, gen_types_JvmType_JvmIdentifiableElement, gen_types_JvmVoid_JvmType, gen_types_JvmComponentType_JvmType, gen_types_JvmPrimitiveType_JvmComponentType, gen_types_JvmArrayType_JvmComponentType, gen_types_JvmUpperBound_JvmTypeConstraint, gen_types_JvmLowerBound_JvmTypeConstraint, gen_types_JvmAnnotationType_JvmDeclaredType, gen_types_JvmEnumerationType_JvmDeclaredType, gen_types_JvmTypeParameter_JvmComponentType, gen_types_JvmTypeParameter_JvmConstraintOwner, gen_types_JvmParameterizedTypeReference_JvmTypeReference, gen_types_JvmGenericArrayTypeReference_JvmTypeReference, gen_types_JvmWildcardTypeReference_JvmTypeReference, gen_types_JvmWildcardTypeReference_JvmConstraintOwner, gen_types_JvmAnyTypeReference_JvmTypeReference, gen_types_JvmMultiTypeReference_JvmCompoundTypeReference, gen_types_JvmMember_JvmAnnotationTarget, gen_types_JvmEnumerationLiteral_JvmField, gen_types_JvmGenericType_JvmDeclaredType, gen_types_JvmGenericType_JvmTypeParameterDeclarator, gen_types_JvmField_JvmFeature, gen_types_JvmExecutable_JvmFeature, gen_types_JvmExecutable_JvmTypeParameterDeclarator, gen_types_JvmConstructor_JvmExecutable, gen_types_JvmOperation_JvmExecutable, gen_types_JvmFeature_JvmMember, gen_types_JvmAnnotationTarget_JvmIdentifiableElement, gen_types_JvmIntAnnotationValue_JvmAnnotationValue, gen_types_JvmBooleanAnnotationValue_JvmAnnotationValue, gen_types_JvmByteAnnotationValue_JvmAnnotationValue, gen_types_JvmFormalParameter_JvmAnnotationTarget, gen_types_JvmTypeAnnotationValue_JvmAnnotationValue, gen_types_JvmAnnotationAnnotationValue_JvmAnnotationValue, gen_types_JvmEnumAnnotationValue_JvmAnnotationValue, gen_types_JvmDelegateTypeReference_JvmTypeReference, gen_types_JvmSpecializedTypeReference_JvmTypeReference, gen_types_JvmSynonymTypeReference_JvmCompoundTypeReference, gen_types_JvmUnknownTypeReference_JvmTypeReference, gen_types_JvmShortAnnotationValue_JvmAnnotationValue, gen_types_JvmLongAnnotationValue_JvmAnnotationValue, gen_types_JvmDoubleAnnotationValue_JvmAnnotationValue, gen_types_JvmFloatAnnotationValue_JvmAnnotationValue, gen_types_JvmCharAnnotationValue_JvmAnnotationValue, gen_types_JvmStringAnnotationValue_JvmAnnotationValue, gen_types_JvmCompoundTypeReference_JvmTypeReference, gen_types_JvmCustomAnnotationValue_JvmAnnotationValue, gen_types_JvmInnerTypeReference_JvmParameterizedTypeReference},
    metadata=None
)
