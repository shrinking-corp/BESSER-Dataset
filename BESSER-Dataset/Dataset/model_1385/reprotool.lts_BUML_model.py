...
# Classes
lts2_TransitionalState = Class(name="lts2_TransitionalState")
lts2_FinalState = Class(name="lts2_FinalState")
lts2_AbortState = Class(name="lts2_AbortState")
TransitionalState = Class(name="TransitionalState")
State = Class(name="State")
lts2_State = Class(name="lts2_State", is_abstract=True)
lts2_Transition = Class(name="lts2_Transition")
lts2_StateMachine = Class(name="lts2_StateMachine")
lts2_InitialState = Class(name="lts2_InitialState")
UseCaseStep = Class(name="UseCaseStep")
lts2_LTSGenerator = Class(name="lts2_LTSGenerator", is_abstract=True)
...
lts2_LTSGenerator_m_processUseCase: Method = Method(name="processUseCase", parameters={Parameter(name='lts2_useCase', type=StringType)})
...
domain_model = DomainModel(
    name="lts2",
    types={lts2_TransitionalState, lts2_FinalState, lts2_AbortState, TransitionalState, State, lts2_State, lts2_Transition, lts2_StateMachine, lts2_InitialState, UseCaseStep, lts2_LTSGenerator},
    associations={transitionalStates1, finalState3, abortState5, transitions7, targetState8, initialState0, relatedStep9, sourceState11, labelTransitionSystem12},
    generalizations={gen_lts2_InitialState_TransitionalState, gen_lts2_FinalState_State, gen_lts2_TransitionalState_State, gen_lts2_AbortState_State},
    metadata=None
)
