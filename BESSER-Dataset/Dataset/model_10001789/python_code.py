...
class B4:
    ...
    def __init__(self, attB: int, c4: set["C4"] = None, a9: "A4" = None):
        self.attB = attB
    ...
    def c4(self, value):
        ...
        old_value = getattr(self, f"_B4__c4", None)
    ...
    def a9(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_B4__a9", None)
        self.__a9 = value
...
class A4(ABC):
    ...
    def __init__(self, attA: str, r7: "R" = None, b8: set["B4"] = None):
        self.attA = attA
        self.r7 = r7
    ...
    def b8(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_A4__b8", None)
    ...
    def r7(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_A4__r7", None)
        self.__r7 = value
...
class C4(ABC):
    ...
    def __init__(self, attC1: int, attC2: bool, b5: "B4" = None):
        self.attC1 = attC1
        self.attC2 = attC2
        self.b5 = b5
    ...
    def b5(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_C4__b5", None)
        self.__b5 = value
