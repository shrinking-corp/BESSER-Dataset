...
JPA_Column.attributes={JPA_Column_type, JPA_Column_fetch, JPA_Column_name, JPA_Column_nullable}
...
JPA_OneToOne.attributes={JPA_OneToOne_updatable, JPA_OneToOne_referencedColumnName, JPA_OneToOne_name}
...
JPA_ManyToMany.attributes={JPA_ManyToMany_inverseJoinColumn, JPA_ManyToMany_name, JPA_ManyToMany_joinColumn}
