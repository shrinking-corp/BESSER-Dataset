...
domain_model = DomainModel(
    name="petrinet",
    types={petrinet_Petrinet, petrinet_Arc, petrinet_Transition, Node, petrinet_Place, petrinet_Node},
    associations={arcs1, incomming3, outgoing4, target6, source7, nodes0},
