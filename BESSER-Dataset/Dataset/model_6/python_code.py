...
class petrinet_Node(ABC):
    ...
    def __init__(self, name: str, target: set["petrinet_Arc"] = None, source: set["petrinet_Arc"] = None, Node: "petrinet_Arc" = None, Node8: "petrinet_Arc" = None, petrinet_Node: "petrinet_Petrinet" = None):
        self.name = name
