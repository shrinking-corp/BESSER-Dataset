...
public class Leave  {
    ...
    public Leave(
        LocalDate Leave_StartDate,        String Leave_detail,        int Emp_Id,        String Leave_Status,        LocalDate Leave_EndDate,        String Leave_Title,        int Leave_NoOfDays,        LocalDate Leave_ApplyDate,        int leave_id    ) {
