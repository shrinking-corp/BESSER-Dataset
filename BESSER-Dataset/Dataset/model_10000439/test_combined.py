...
def test_Doctor_address_value_roundtrip():
    instance = Doctor(address="sample_text", department="sample_text", docid=7, name="sample_text", phno="sample_text", specialization="sample_text")
...
def test_Patient_address_value_roundtrip():
    instance = Patient(address="sample_text", age=7, id=7, name="sample_text", roomno=7, sex="sample_text", telno="sample_text")
    assert instance.address == "sample_text"
    instance.address = "sample_text_2"
    assert instance.address == "sample_text_2"
...
def test_assoc_Doctor_Department_link_reassign_clear():
    a = Doctor(address="sample_text", department="sample_text", docid=7, name="sample_text", phno="sample_text", specialization="sample_text")
...
def test_assoc_Doctor_Patient_link_reassign_clear():
    a = Patient(address="sample_text", age=7, id=7, name="sample_text", roomno=7, sex="sample_text", telno="sample_text")
    b1 = Doctor(address="sample_text", department="sample_text", docid=7, name="sample_text", phno="sample_text", specialization="sample_text")
    b2 = Doctor(address="sample_text_2", department="sample_text_2", docid=13, name="sample_text_2", phno="sample_text_2", specialization="sample_text_2")
...
def test_assoc_Patient_Room_link_reassign_clear():
    ...
    b1 = Patient(address="sample_text", age=7, id=7, name="sample_text", roomno=7, sex="sample_text", telno="sample_text")
    b2 = Patient(address="sample_text_2", age=13, id=13, name="sample_text_2", roomno=13, sex="sample_text_2", telno="sample_text_2")
...
Doctor_strategy = st.builds(Doctor, address=safe_text, department=safe_text, docid=st.integers(), name=safe_text, phno=safe_text, specialization=safe_text)
@given(instance=Doctor_strategy)
@settings(max_examples=25)
...
Patient_strategy = st.builds(Patient, address=safe_text, age=st.integers(), id=st.integers(), name=safe_text, roomno=st.integers(), sex=safe_text, telno=safe_text)
@given(instance=Patient_strategy)
@settings(max_examples=25)
