...
# Classes
ex1_A = Class(name="ex1_A")
F = Class(name="F")
ex1_D = Class(name="ex1_D")
ex1_B = Class(name="ex1_B")
A = Class(name="A")
ex1_C = Class(name="ex1_C")
ex1_E = Class(name="ex1_E")
ex1_F = Class(name="ex1_F")
ex1_G = Class(name="ex1_G")
