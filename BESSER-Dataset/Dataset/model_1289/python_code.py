...
class StateMachineHyperedges_Transition:
    ...
    def __init__(self, name: str, Transition: "StateMachineHyperedges_StateVertex" = None, Transition5: "StateMachineHyperedges_StateVertex" = None, StateMachineHyperedges_Transition7: "StateMachineHyperedges_Event" = None, outgoing: set["StateMachineHyperedges_StateVertex"] = None, incoming: set["StateMachineHyperedges_StateVertex"] = None, StateMachineHyperedges_Transition: "StateMachineHyperedges_StateMachine" = None):
        self.name = name
...
class StateMachineHyperedges_StateVertex(ABC):
    ...
    def __init__(self, name: str, sources: set["StateMachineHyperedges_Transition"] = None, targets: set["StateMachineHyperedges_Transition"] = None, StateVertex: "StateMachineHyperedges_Transition" = None, StateVertex10: "StateMachineHyperedges_Transition" = None, StateMachineHyperedges_StateVertex: "StateMachineHyperedges_StateMachine" = None):
        self.name = name
