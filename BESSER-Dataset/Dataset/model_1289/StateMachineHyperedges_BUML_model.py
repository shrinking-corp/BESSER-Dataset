...
# Classes
StateMachineHyperedges_Event = Class(name="StateMachineHyperedges_Event")
StateMachineHyperedges_InitialState = Class(name="StateMachineHyperedges_InitialState")
StateVertex = Class(name="StateVertex")
StateMachineHyperedges_SimpleState = Class(name="StateMachineHyperedges_SimpleState")
StateMachineHyperedges_FinalState = Class(name="StateMachineHyperedges_FinalState")
StateMachineHyperedges_StateMachine = Class(name="StateMachineHyperedges_StateMachine")
StateMachineHyperedges_StateVertex = Class(name="StateMachineHyperedges_StateVertex", is_abstract=True)
StateMachineHyperedges_Transition = Class(name="StateMachineHyperedges_Transition")
...
domain_model = DomainModel(
    ...
    types={StateMachineHyperedges_Event, StateMachineHyperedges_InitialState, StateVertex, StateMachineHyperedges_SimpleState, StateMachineHyperedges_FinalState, StateMachineHyperedges_StateMachine, StateMachineHyperedges_StateVertex, StateMachineHyperedges_Transition},
    associations={outgoing3, incoming4, trigger6, sources8, targets9, states0, transitions1},
