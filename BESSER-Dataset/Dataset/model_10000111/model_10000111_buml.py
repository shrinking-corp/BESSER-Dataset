...
Order.attributes={Order_shipTo, Order_status, Order_total, Order_ordered, Order_shipped, Order_number}
...
domain_model = DomainModel(
    name="_0ea77851_3325_48cc_8dd3_c6e90d1e56af",
    types={Customer, Payment, ShoppingCart, Account, WebUser, Order, LineItem, Product, UserState, OrderStatus},
    associations={WebUser_Customer, Customer_Account, Account_ShoppingCart, ShoppingCart_LineItem, Product_LineItem, Order_LineItem, Account_Order, Payment_Order, Account_Payment, WebUser_ShoppingCart},
    generalizations={},
    metadata=None
)
