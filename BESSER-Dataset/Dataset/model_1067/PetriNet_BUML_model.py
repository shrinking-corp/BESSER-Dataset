...
incomingArc6: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="to7", type=PlaceToTransition, multiplicity=Multiplicity(1, 9999))
    }
)
outgoingArc9: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_10", type=TransitionToPlace, multiplicity=Multiplicity(1, 9999))
    }
)
...
from_16: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="outgoingArc17", type=Transition, multiplicity=Multiplicity(1, 1))
    }
)
to19: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="incomingArc20", type=Place, multiplicity=Multiplicity(1, 1))
    }
)
...
domain_model = DomainModel(
    name="PetriNet",
    types={Arc, PetriNet_Element, PetriNet, PetriNet_Place, TransitionToPlace, PetriNet_LocatedElement, PetriNet_NamedElement, LocatedElement, PetriNet_PetriNet, NamedElement, Element, PlaceToTransition, PetriNet_Transition, PetriNet_Arc, PetriNet_PlaceToTransition, Place, Transition, PetriNet_TransitionToPlace},
    associations={arcs1, net3, incomingArc4, elements0, outgoingArc5, incomingArc6, outgoingArc9, net12, from_14, to15, from_16, to19},
    generalizations={gen_PetriNet_Element_NamedElement, gen_PetriNet_Place_Element, gen_PetriNet_NamedElement_LocatedElement, gen_PetriNet_PetriNet_NamedElement, gen_PetriNet_Transition_Element, gen_PetriNet_Arc_NamedElement, gen_PetriNet_PlaceToTransition_Arc, gen_PetriNet_TransitionToPlace_Arc},
    metadata=None
)
