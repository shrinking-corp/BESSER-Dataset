...
domain_model = DomainModel(
    name="fsmcore",
    types={fsmcore_AbstractState, fsmcore_Transition, fsmcore_State, AbstractState, fsmcore_Program, fsmcore_Trigger, fsmcore_StateMachine, NamedElement, fsmcore_Region, fsmcore_Conditional, Statement, fsmcore_Loop, fsmcore_VarDecl, fsmcore_Pseudostate, fsmcore_FinalState, State, fsmcore_Constraint, fsmcore_NamedElement, fsmcore_Statement, PseudostateKind},
    associations={subvertex1, transitions2, incoming4, outgoing5, ownerRegion7, doActivity8, entry9, exit12, trigger15, target17, source19, regions0, guard21, statements23},
    generalizations={gen_fsmcore_AbstractState_NamedElement, gen_fsmcore_State_AbstractState, gen_fsmcore_Transition_NamedElement, gen_fsmcore_StateMachine_NamedElement, gen_fsmcore_Region_NamedElement, gen_fsmcore_Conditional_Statement, gen_fsmcore_Loop_Statement, gen_fsmcore_VarDecl_Statement, gen_fsmcore_Pseudostate_AbstractState, gen_fsmcore_FinalState_State},
    metadata=None
)
