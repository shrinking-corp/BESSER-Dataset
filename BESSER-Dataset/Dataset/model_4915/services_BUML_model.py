...
services_ServiceSecurityMgt = Class(name="services_ServiceSecurityMgt")
services_ServiceIncidentMgt = Class(name="services_ServiceIncidentMgt")
services_ServiceInterrest = Class(name="services_ServiceInterrest")
services_ServiceContract = Class(name="services_ServiceContract")
services_Service = Class(name="services_Service")
services_ServiceName = Class(name="services_ServiceName")
services_ServiceDescription = Class(name="services_ServiceDescription")
services_ServiceSupport = Class(name="services_ServiceSupport")
services_ServiceAdditional = Class(name="services_ServiceAdditional")
services_Parameter = Class(name="services_Parameter")
...
services_ServiceSecurityMgt.attributes={services_ServiceSecurityMgt_drPlanContact, services_ServiceSecurityMgt_drPlanRepository, services_ServiceSecurityMgt_drRecoveryPlan, services_ServiceSecurityMgt_securityRating}
...
services_ServiceIncidentMgt.attributes={services_ServiceIncidentMgt_maintenanceWindow, services_ServiceIncidentMgt_businessImpact, services_ServiceIncidentMgt_monitoring, services_ServiceIncidentMgt_maintenance}
...
services_ServiceContract.attributes={services_ServiceContract_wLA, services_ServiceContract_uC, services_ServiceContract_sLA, services_ServiceContract_oLA}
...
services_Service.attributes={services_Service_serviceCategory, services_Service_mostTopService, services_Service_serviceClass, services_Service_serviceKind, services_Service_ssDomain, services_Service_serviceCharacterCommon, services_Service_serviceSupport1}
...
services_ServiceName.attributes={services_ServiceName_identifier, services_ServiceName_name, services_ServiceName_index, services_ServiceName_alias}
...
services_ServiceDescription.attributes={services_ServiceDescription_serviceDescriptionCommon, services_ServiceDescription_serviceDescriptionNational}
...
services_ServiceAdditional.attributes={services_ServiceAdditional_report, services_ServiceAdditional_usageState, services_ServiceAdditional_kpi, services_ServiceAdditional_link, services_ServiceAdditional_lifeCycleState, services_ServiceAdditional_history, services_ServiceAdditional_costCenter}
...
domain_model = DomainModel(
    name="services",
    types={Service, services_EObject, services_CFSService, services_RFSService, services_ServiceProfile, services_CIID, services_ServiceSecurityMgt, services_ServiceIncidentMgt, services_ServiceInterrest, services_ServiceContract, services_Service, services_ServiceName, services_ServiceDescription, services_ServiceSupport, services_ServiceAdditional, services_Parameter, MaintenanceType, InterrestKindType, LifeCycleStateType, SecurityRatingType, ServiceClassType, ServiceKindType, UsageStateType},
    associations={elements0, elements1, serviceProfile3, serviceSecurityMgt8, serviceIncidentMgt10, ciID12, serviceInterrest14, serviceContracts16, serviceName5, serviceDescription6, serviceSupport18, serviceMisc20, services23, serviceParameters25},
