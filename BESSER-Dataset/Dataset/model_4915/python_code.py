...
class services_Service:
    ...
    def __init__(self, serviceClass: str, serviceKind: str, serviceSupport1: str, ssDomain: str, mostTopService: str, serviceCategory: str, serviceCharacterCommon: str, services_Service9: "services_ServiceSecurityMgt" = None, services_Service11: "services_ServiceIncidentMgt" = None, services_Service13: "services_CIID" = None, services_Service15: "services_ServiceInterrest" = None, services_Service17: set["services_ServiceContract"] = None, services_Service: "services_ServiceName" = None, services_Service7: "services_ServiceDescription" = None, services_Service19: "services_ServiceSupport" = None, services_Service21: "services_ServiceAdditional" = None, services_Service24: "services_Service" = None, services_Service22: set["services_Service"] = None):
...
class services_ServiceSecurityMgt:
    ...
    def __init__(self, securityRating: str, drPlanContact: str, drPlanRepository: str, drRecoveryPlan: str, services_ServiceSecurityMgt: "services_Service" = None):
