...
# Classes
test_Writer = Class(name="test_Writer")
test_Book = Class(name="test_Book")
test_Library = Class(name="test_Library")
...
test_Writer_m_validate: Method = Method(name="validate", parameters={Parameter(name='test_diagnostic', type=StringType), Parameter(name='test_context', type=StringType)}, type=BooleanType)
test_Writer.attributes={test_Writer_EMail, test_Writer_BirthDate, test_Writer_Pseudonym, test_Writer_lastName, test_Writer_firstName}
...
domain_model = DomainModel(
    name="test",
    types={test_Writer, test_Book, test_Library},
