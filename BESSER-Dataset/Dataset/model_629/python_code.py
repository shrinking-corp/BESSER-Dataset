...
class test_Writer:
    ...
    def __init__(self, firstName: str, lastName: str, EMail: str, BirthDate: date, Pseudonym: bool, Writer: "test_Library" = None, writers: set["test_Book"] = None, writers4: "test_Library" = None, Writer6: "test_Book" = None):
    ...
    def validate(self, test_diagnostic, test_context) :
