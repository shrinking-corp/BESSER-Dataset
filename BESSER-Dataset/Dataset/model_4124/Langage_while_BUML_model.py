...
# Classes
langage_while_Model = Class(name="langage_while_Model")
langage_while_Program = Class(name="langage_while_Program")
langage_while_Function = Class(name="langage_while_Function")
langage_while_SYMB = Class(name="langage_while_SYMB")
langage_while_Definition = Class(name="langage_while_Definition")
langage_while_Input = Class(name="langage_while_Input")
langage_while_Commands = Class(name="langage_while_Commands")
langage_while_Ifconfort = Class(name="langage_while_Ifconfort")
langage_while_Vars = Class(name="langage_while_Vars")
langage_while_Exprs = Class(name="langage_while_Exprs")
langage_while_Expr = Class(name="langage_while_Expr")
langage_while_Output = Class(name="langage_while_Output")
langage_while_VAR = Class(name="langage_while_VAR")
langage_while_Command = Class(name="langage_while_Command")
langage_while_Assign = Class(name="langage_while_Assign")
langage_while_While = Class(name="langage_while_While")
langage_while_For = Class(name="langage_while_For")
langage_while_If = Class(name="langage_while_If")
langage_while_Foreach = Class(name="langage_while_Foreach")
langage_while_LExpr = Class(name="langage_while_LExpr")
langage_while_ExprOr = Class(name="langage_while_ExprOr")
langage_while_ExprNot = Class(name="langage_while_ExprNot")
langage_while_ExprSimple = Class(name="langage_while_ExprSimple")
langage_while_ExprAnd = Class(name="langage_while_ExprAnd")
langage_while_ExprEq = Class(name="langage_while_ExprEq")
...
langage_while_VAR.attributes={langage_while_VAR_bv, langage_while_VAR_cf}
...
langage_while_ExprSimple.attributes={langage_while_ExprSimple_mot, langage_while_ExprSimple_nil}
...
def_8: BinaryAssociation = BinaryAssociation(
    name="def_8",
    ends={
...
for_27: BinaryAssociation = BinaryAssociation(
    name="for_27",
    ends={
...
domain_model = DomainModel(
    name="langage_while",
    types={langage_while_Model, langage_while_Program, langage_while_Function, langage_while_SYMB, langage_while_Definition, langage_while_Input, langage_while_Commands, langage_while_Ifconfort, langage_while_Vars, langage_while_Exprs, langage_while_Expr, langage_while_Output, langage_while_VAR, langage_while_Command, langage_while_Assign, langage_while_While, langage_while_For, langage_while_If, langage_while_Foreach, langage_while_LExpr, langage_while_ExprOr, langage_while_ExprNot, langage_while_ExprSimple, langage_while_ExprAnd, langage_while_ExprEq},
    associations={nn0, f1, pp4, name6, def_8, in_10, com12, ifc33, vs35, ex37, ex39, c41, ex44, c47, ex50, ct53, ce56, ex159, out14, v16, v18, c21, assign23, wh25, for_27, if_29, fore31, sym87, lex90, ex92, e95, exo198, exo2100, exn1103, ex262, c65, ex68, c71, vs74, ex77, exs80, exa82, v84, exn2105, exQ1108, exQ2110, exS1113, exS2116, ex119},
    generalizations={},
    metadata=None
)
