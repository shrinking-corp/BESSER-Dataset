...
def test_extlibrary_bookontape_has_minutesLength():
...
def test_extlibrary_videocassette_has_minutesLength():
...
@given(instance=extlibrary_BookOnTape_strategy)
def test_extlibrary_bookontape_minutesLength_setter(instance):
    original = instance.minutesLength
    instance.minutesLength = original
    assert instance.minutesLength == original
...
@given(instance=extlibrary_VideoCassette_strategy)
def test_extlibrary_videocassette_minutesLength_setter(instance):
    original = instance.minutesLength
    instance.minutesLength = original
    assert instance.minutesLength == original
