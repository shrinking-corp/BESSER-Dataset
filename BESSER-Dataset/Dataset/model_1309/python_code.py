...
class StateMachine_Transition(NamedElement):
    ...
    def __init__(self, isEnabled: bool, isFireable: bool, incomingTransitions: "StateMachine_State" = None, StateMachine_Transition23: "StateMachine_Trigger" = None, StateMachine_Transition: "StateMachine_StateMachine" = None, Transition: "StateMachine_State" = None, Transition18: "StateMachine_State" = None, outgoingTransitions: "StateMachine_State" = None, StateMachine_Transition26: set["StateMachine_Guard"] = None, StateMachine_Transition29: set["StateMachine_Action"] = None):
