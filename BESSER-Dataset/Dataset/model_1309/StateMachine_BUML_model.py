...
# Classes
StateMachine_StateMachineBehavioralModel = Class(name="StateMachine_StateMachineBehavioralModel")
...
StateMachine_RDMElement = Class(name="StateMachine_RDMElement")
StateMachine_Trigger = Class(name="StateMachine_Trigger", is_abstract=True)
StateMachine_Guard = Class(name="StateMachine_Guard", is_abstract=True)
StateMachine_Action = Class(name="StateMachine_Action", is_abstract=True)
StateMachine_Train = Class(name="StateMachine_Train")
StateMachine_ChangeSignalAllowedSpeed = Class(name="StateMachine_ChangeSignalAllowedSpeed")
StateMachine_Signal = Class(name="StateMachine_Signal")
StateMachine_ChangeTurnoutDirection = Class(name="StateMachine_ChangeTurnoutDirection")
StateMachine_Turnout = Class(name="StateMachine_Turnout")
StateMachine_ChangeTrainCurrentTrackElement = Class(name="StateMachine_ChangeTrainCurrentTrackElement")
StateMachine_TrackElement = Class(name="StateMachine_TrackElement")
StateMachine_TrainCurrentHeadingSpeed = Class(name="StateMachine_TrainCurrentHeadingSpeed")
GuardExpression = Class(name="GuardExpression")
StateMachine_TrainCurrentlyStandsOn = Class(name="StateMachine_TrainCurrentlyStandsOn")
StateMachine_TurnoutCurrentDirection = Class(name="StateMachine_TurnoutCurrentDirection")
StateMachine_SignalCurrentAllowedSpeed = Class(name="StateMachine_SignalCurrentAllowedSpeed")
StateMachine_CompositeState = Class(name="StateMachine_CompositeState")
State = Class(name="State")
StateMachine_NamedElement = Class(name="StateMachine_NamedElement", is_abstract=True)
StateMachine_ChangeTrainHeadingSpeed = Class(name="StateMachine_ChangeTrainHeadingSpeed")
ActionExpression = Class(name="ActionExpression")
StateMachine_TurnoutDirectionChanged = Class(name="StateMachine_TurnoutDirectionChanged")
StateMachine_NextTrackElementIs = Class(name="StateMachine_NextTrackElementIs")
StateMachine_RouteElement = Class(name="StateMachine_RouteElement")
StateMachine_TurnoutHasDesiredDirection = Class(name="StateMachine_TurnoutHasDesiredDirection")
StateMachine_TurnoutDesiredDirection = Class(name="StateMachine_TurnoutDesiredDirection")
StateMachine_ActionExpression = Class(name="StateMachine_ActionExpression")
Action = Class(name="Action")
StateMachine_GuardExpression = Class(name="StateMachine_GuardExpression")
Guard = Class(name="Guard")
StateMachine_TriggerExpression = Class(name="StateMachine_TriggerExpression")
Trigger = Class(name="Trigger")
StateMachine_TrainHeadingSpeedChanged = Class(name="StateMachine_TrainHeadingSpeedChanged")
TriggerExpression = Class(name="TriggerExpression")
StateMachine_TrainTrackElementChanged = Class(name="StateMachine_TrainTrackElementChanged")
StateMachine_SignalAllowedSpeedChanged = Class(name="StateMachine_SignalAllowedSpeedChanged")
...
StateMachine_Transition.attributes={StateMachine_Transition_isFireable, StateMachine_Transition_isEnabled}
...
domain_model = DomainModel(
    name="StateMachine",
    types={StateMachine_StateMachineBehavioralModel, StateMachine_StateMachine, NamedElement, StateMachine_State, StateMachine_Transition, StateMachine_RDMElement, StateMachine_Trigger, StateMachine_Guard, StateMachine_Action, StateMachine_Train, StateMachine_ChangeSignalAllowedSpeed, StateMachine_Signal, StateMachine_ChangeTurnoutDirection, StateMachine_Turnout, StateMachine_ChangeTrainCurrentTrackElement, StateMachine_TrackElement, StateMachine_TrainCurrentHeadingSpeed, GuardExpression, StateMachine_TrainCurrentlyStandsOn, StateMachine_TurnoutCurrentDirection, StateMachine_SignalCurrentAllowedSpeed, StateMachine_CompositeState, State, StateMachine_NamedElement, StateMachine_ChangeTrainHeadingSpeed, ActionExpression, StateMachine_TurnoutDirectionChanged, StateMachine_NextTrackElementIs, StateMachine_RouteElement, StateMachine_TurnoutHasDesiredDirection, StateMachine_TurnoutDesiredDirection, StateMachine_ActionExpression, Action, StateMachine_GuardExpression, Guard, StateMachine_TriggerExpression, Trigger, StateMachine_TrainHeadingSpeedChanged, TriggerExpression, StateMachine_TrainTrackElementChanged, StateMachine_SignalAllowedSpeedChanged},
    associations={statemachines0, states1, transitions3, referredObject14, outgoingTransitions16, incomingTransitions17, sourceState19, targetState20, trigger22, guard25, action28, triggers5, guards7, actions9, activeState11, train33, signal34, turnout35, train36, newTrackElements38, train40, train42, trackElements44, turnout47, statemachine31, signal58, turnout60, routeElement62, trackElement63, turnout66, desiredDirection68, signal49, train51, train53, trackElements55},
    generalizations={gen_StateMachine_StateMachine_NamedElement, gen_StateMachine_State_NamedElement, gen_StateMachine_Transition_NamedElement, gen_StateMachine_ChangeSignalAllowedSpeed_ActionExpression, gen_StateMachine_ChangeTurnoutDirection_ActionExpression, gen_StateMachine_ChangeTrainCurrentTrackElement_ActionExpression, gen_StateMachine_TrainCurrentHeadingSpeed_GuardExpression, gen_StateMachine_TrainCurrentlyStandsOn_GuardExpression, gen_StateMachine_TurnoutCurrentDirection_GuardExpression, gen_StateMachine_SignalCurrentAllowedSpeed_GuardExpression, gen_StateMachine_CompositeState_State, gen_StateMachine_Trigger_NamedElement, gen_StateMachine_Guard_NamedElement, gen_StateMachine_Action_NamedElement, gen_StateMachine_ChangeTrainHeadingSpeed_ActionExpression, gen_StateMachine_TurnoutDirectionChanged_TriggerExpression, gen_StateMachine_NextTrackElementIs_GuardExpression, gen_StateMachine_TurnoutHasDesiredDirection_GuardExpression, gen_StateMachine_ActionExpression_Action, gen_StateMachine_GuardExpression_Guard, gen_StateMachine_TriggerExpression_Trigger, gen_StateMachine_TrainHeadingSpeedChanged_TriggerExpression, gen_StateMachine_TrainTrackElementChanged_TriggerExpression, gen_StateMachine_SignalAllowedSpeedChanged_TriggerExpression},
    metadata=None
)
