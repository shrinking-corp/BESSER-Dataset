...
class hlcorestructure_Font:
    ...
    def __init__(self, decoration: str, family: str, rotation: str, align: str, size: str, style: str, weight: str, font: "hlcorestructure_AnnotationGraphics" = None, Font: "hlcorestructure_AnnotationGraphics" = None):
...
class hlcorestructure_Line:
    ...
    def __init__(self, style: str, color: str, shape: str, width: str, Line: "hlcorestructure_NodeGraphics" = None, Line56: "hlcorestructure_AnnotationGraphics" = None, Line77: "hlcorestructure_ArcGraphics" = None, line: "hlcorestructure_NodeGraphics" = None, line68: "hlcorestructure_ArcGraphics" = None, line71: "hlcorestructure_AnnotationGraphics" = None):
        self.style = style
        self.color = color
        self.shape = shape
        self.width = width
...
class hlcorestructure_Fill:
    ...
    def __init__(self, gradientcolor: str, gradientrotation: str, image: str, color: str, Fill: "hlcorestructure_NodeGraphics" = None, Fill53: "hlcorestructure_AnnotationGraphics" = None, fill: "hlcorestructure_NodeGraphics" = None, fill63: "hlcorestructure_AnnotationGraphics" = None):
...
class hlcorestructure_ToolInfo:
    ...
    def __init__(self, formattedXMLBuffer: str, toolInfoGrammarURI: str, tool: str, version: str, ToolInfo: "hlcorestructure_PetriNet" = None, ToolInfo17: "hlcorestructure_PnObject" = None, ToolInfo34: "hlcorestructure_Label" = None, toolspecifics: "hlcorestructure_PetriNet" = None, toolspecifics28: "hlcorestructure_PnObject" = None, toolspecifics31: "hlcorestructure_Label" = None, containerToolInfo: "hlcorestructure_AnyObject" = None, ToolInfo107: "hlcorestructure_AnyObject" = None):
...
class hlcorestructure_PetriNet:
    ...
    def __init__(self, id: str, type: str, PetriNet: "hlcorestructure_PetriNetDoc" = None, containerPetriNet: set["hlcorestructure_Page"] = None, containerNamePetriNet: "hlcorestructure_Name" = None, containerDeclarationPetriNet: set["hlcorestructure_Declaration"] = None, containerPetriNet4: set["hlcorestructure_ToolInfo"] = None, nets: "hlcorestructure_PetriNetDoc" = None, PetriNet9: "hlcorestructure_Page" = None, PetriNet21: "hlcorestructure_Name" = None, PetriNet26: "hlcorestructure_ToolInfo" = None, PetriNet122: "hlcorestructure_Declaration" = None):
        self.id = id
        self.type = type
