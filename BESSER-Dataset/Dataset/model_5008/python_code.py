...
class epo2_USAddress(Address):
    ...
    def __init__(self, zip: int, street: str, city: str, state: str):
        self.zip = zip
        self.street = street
        self.city = city
        self.state = state
...
class epo2_PurchaseOrder:
    ...
    def __init__(self, comment: str, orderDate: str, status: str, totalAmount: int, order: set["epo2_Item"] = None, epo2_PurchaseOrder: "epo2_Address" = None, epo2_PurchaseOrder4: "epo2_Address" = None, orders: "epo2_Customer" = None, epo2_PurchaseOrder9: "epo2_PurchaseOrder" = None, epo2_PurchaseOrder7: "epo2_PurchaseOrder" = None, PurchaseOrder: "epo2_Item" = None, epo2_PurchaseOrder13: "epo2_Supplier" = None, epo2_PurchaseOrder16: "epo2_Supplier" = None, epo2_PurchaseOrder19: "epo2_Supplier" = None, PurchaseOrder21: "epo2_Customer" = None):
...
class epo2_Item:
    ...
    def __init__(self, productName: str, quantity: int, USPrice: int, comment: str, shipDate: str, partNum: str, Item: "epo2_PurchaseOrder" = None, items: "epo2_PurchaseOrder" = None):
