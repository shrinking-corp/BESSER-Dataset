...
# Classes
xpdl2_BasicTypeType = Class(name="xpdl2_BasicTypeType")
XpdlTypeType = Class(name="XpdlTypeType")
xpdl2_DataTypeType = Class(name="xpdl2_DataTypeType")
xpdl2_SchemaTypeType = Class(name="xpdl2_SchemaTypeType")
xpdl2_ExternalReferenceType = Class(name="xpdl2_ExternalReferenceType")
xpdl2_ExpressionType = Class(name="xpdl2_ExpressionType")
xpdl2_DeclaredTypeType = Class(name="xpdl2_DeclaredTypeType")
xpdl2_ExtendedAttributesType = Class(name="xpdl2_ExtendedAttributesType")
xpdl2_ExtendedAttributeType = Class(name="xpdl2_ExtendedAttributeType")
ExtendedAnnotationType = Class(name="ExtendedAnnotationType")
xpdl2_Extensible = Class(name="xpdl2_Extensible", is_abstract=True)
xpdl2_ExternalPackages = Class(name="xpdl2_ExternalPackages")
xpdl2_ExternalPackage = Class(name="xpdl2_ExternalPackage")
Extensible = Class(name="Extensible")
xpdl2_FormalParameterType = Class(name="xpdl2_FormalParameterType")
xpdl2_LoopMultiInstanceType = Class(name="xpdl2_LoopMultiInstanceType")
xpdl2_FormalParametersType = Class(name="xpdl2_FormalParametersType")
xpdl2_LoopStandardType = Class(name="xpdl2_LoopStandardType")
xpdl2_LoopType = Class(name="xpdl2_LoopType")
xpdl2_XSDSchema = Class(name="xpdl2_XSDSchema")
LoopDataRefType = Class(name="LoopDataRefType")
xpdl2_TypeDeclarationType = Class(name="xpdl2_TypeDeclarationType")
xpdl2_ScriptType = Class(name="xpdl2_ScriptType")
xpdl2_TypeDeclarationsType = Class(name="xpdl2_TypeDeclarationsType")
xpdl2_extensions_ExtendedAnnotationType = Class(name="xpdl2_extensions_ExtendedAnnotationType")
XSDAnnotation = Class(name="XSDAnnotation")
xpdl2_XpdlTypeType = Class(name="xpdl2_XpdlTypeType", is_abstract=True)
xpdl2_extensions_LoopDataRefType = Class(name="xpdl2_extensions_LoopDataRefType")
...
xpdl2_ExternalReferenceType.attributes={xpdl2_ExternalReferenceType_xref, xpdl2_ExternalReferenceType_uuid, xpdl2_ExternalReferenceType_namespace, xpdl2_ExternalReferenceType_location}
...
xpdl2_ExpressionType.attributes={xpdl2_ExpressionType_any, xpdl2_ExpressionType_scriptGrammar, xpdl2_ExpressionType_scriptVersion, xpdl2_ExpressionType_scriptType, xpdl2_ExpressionType_group, xpdl2_ExpressionType_mixed}
...
xpdl2_ExtendedAttributeType.attributes={xpdl2_ExtendedAttributeType_any, xpdl2_ExtendedAttributeType_mixed, xpdl2_ExtendedAttributeType_value, xpdl2_ExtendedAttributeType_name, xpdl2_ExtendedAttributeType_group}
...
xpdl2_ExternalPackages_m_getExternalPackage: Method = Method(name="getExternalPackage", parameters={Parameter(name='xpdl2_packageId', type=StringType)}, type=StringType)
...
xpdl2_ExternalPackage.attributes={xpdl2_ExternalPackage_id, xpdl2_ExternalPackage_href, xpdl2_ExternalPackage_name}
...
xpdl2_FormalParameterType.attributes={xpdl2_FormalParameterType_mode, xpdl2_FormalParameterType_id, xpdl2_FormalParameterType_name, xpdl2_FormalParameterType_description}
...
xpdl2_FormalParametersType_m_getFormalParameter: Method = Method(name="getFormalParameter", parameters={Parameter(name='xpdl2_parameterId', type=StringType)}, type=StringType)
xpdl2_FormalParametersType_m_addFormalParameter: Method = Method(name="addFormalParameter", parameters={Parameter(name='xpdl2_parameter', type=StringType)})
...
xpdl2_TypeDeclarationType.attributes={xpdl2_TypeDeclarationType_description, xpdl2_TypeDeclarationType_name, xpdl2_TypeDeclarationType_id}
...
xpdl2_ScriptType.attributes={xpdl2_ScriptType_grammar, xpdl2_ScriptType_type, xpdl2_ScriptType_version}

# xpdl2_TypeDeclarationsType class attributes and methods
xpdl2_TypeDeclarationsType_m_getTypeDeclaration: Method = Method(name="getTypeDeclaration", parameters={Parameter(name='xpdl2_typeId', type=StringType)}, type=StringType)
...
xpdl2_extensions_LoopDataRefType.attributes={xpdl2_extensions_LoopDataRefType_inputItemRef, xpdl2_extensions_LoopDataRefType_outputItemRef, xpdl2_extensions_LoopDataRefType_loopCounterRef}
...
domain_model = DomainModel(
    name="xpdl2",
    types={xpdl2_BasicTypeType, XpdlTypeType, xpdl2_DataTypeType, xpdl2_SchemaTypeType, xpdl2_ExternalReferenceType, xpdl2_ExpressionType, xpdl2_DeclaredTypeType, xpdl2_ExtendedAttributesType, xpdl2_ExtendedAttributeType, ExtendedAnnotationType, xpdl2_Extensible, xpdl2_ExternalPackages, xpdl2_ExternalPackage, Extensible, xpdl2_FormalParameterType, xpdl2_LoopMultiInstanceType, xpdl2_FormalParametersType, xpdl2_LoopStandardType, xpdl2_LoopType, xpdl2_XSDSchema, LoopDataRefType, xpdl2_TypeDeclarationType, xpdl2_ScriptType, xpdl2_TypeDeclarationsType, xpdl2_extensions_ExtendedAnnotationType, XSDAnnotation, xpdl2_XpdlTypeType, xpdl2_extensions_LoopDataRefType, ModeType, TestTimeType, TypeType, LoopTypeType, MIFlowConditionType, MIOrderingType},
    associations={schemaType3, externalReference5, basicType0, declaredType1, extendedAttribute7, extendedAnnotation8, extendedAttributes10, externalPackage12, formalParameter13, dataType14, mICondition17, complexMIFlowCondition18, loopCondition23, loopStandard25, loopMultiInstance27, schema30, loopDataRef21, typeDeclaration32, basicType33, declaredType36, schemaType39, externalReference42},
    generalizations={gen_xpdl2_BasicTypeType_XpdlTypeType, gen_xpdl2_DeclaredTypeType_XpdlTypeType, gen_xpdl2_ExternalPackage_Extensible, gen_xpdl2_ExternalReferenceType_XpdlTypeType, gen_xpdl2_SchemaTypeType_XpdlTypeType, gen_xpdl2_TypeDeclarationType_Extensible, gen_xpdl2_extensions_ExtendedAnnotationType_XSDAnnotation},
    metadata=None
)
