...
def test_hyp_xpdl2_extensions_loopdatareftype_is_not_abstract():
    assert not inspect.isabstract(xpdl2_extensions_LoopDataRefType)


def test_hyp_xpdl2_extensions_loopdatareftype_constructor_exists():
    assert callable(xpdl2_extensions_LoopDataRefType.__init__)


def test_hyp_xpdl2_extensions_loopdatareftype_constructor_args():
...
def test_hyp_xpdl2_xpdltypetype_is_not_abstract():
    assert not inspect.isabstract(xpdl2_XpdlTypeType)


def test_hyp_xpdl2_xpdltypetype_constructor_exists():
    assert callable(xpdl2_XpdlTypeType.__init__)


def test_hyp_xpdl2_xpdltypetype_constructor_args():
...
def test_hyp_xpdl2_extensions_extendedannotationtype_is_not_abstract():
    assert not inspect.isabstract(xpdl2_extensions_ExtendedAnnotationType)


def test_hyp_xpdl2_extensions_extendedannotationtype_constructor_exists():
    assert callable(xpdl2_extensions_ExtendedAnnotationType.__init__)


def test_hyp_xpdl2_extensions_extendedannotationtype_constructor_args():
    sig = inspect.signature(xpdl2_extensions_ExtendedAnnotationType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_xpdl2_typedeclarationstype_is_not_abstract():
    assert not inspect.isabstract(xpdl2_TypeDeclarationsType)


def test_hyp_xpdl2_typedeclarationstype_constructor_exists():
    assert callable(xpdl2_TypeDeclarationsType.__init__)


def test_hyp_xpdl2_typedeclarationstype_constructor_args():
    sig = inspect.signature(xpdl2_TypeDeclarationsType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_xpdl2_scripttype_is_not_abstract():
    assert not inspect.isabstract(xpdl2_ScriptType)


def test_hyp_xpdl2_scripttype_constructor_exists():
    assert callable(xpdl2_ScriptType.__init__)


def test_hyp_xpdl2_scripttype_constructor_args():
...
def test_hyp_loopdatareftype_is_not_abstract():
    assert not inspect.isabstract(LoopDataRefType)


def test_hyp_loopdatareftype_constructor_exists():
    assert callable(LoopDataRefType.__init__)


def test_hyp_loopdatareftype_constructor_args():
    sig = inspect.signature(LoopDataRefType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_xpdl2_xsdschema_is_not_abstract():
    assert not inspect.isabstract(xpdl2_XSDSchema)


def test_hyp_xpdl2_xsdschema_constructor_exists():
    assert callable(xpdl2_XSDSchema.__init__)


def test_hyp_xpdl2_xsdschema_constructor_args():
    sig = inspect.signature(xpdl2_XSDSchema.__init__)
    params = list(sig.parameters.keys())



def test_hyp_xpdl2_looptype_is_not_abstract():
    assert not inspect.isabstract(xpdl2_LoopType)


def test_hyp_xpdl2_looptype_constructor_exists():
    assert callable(xpdl2_LoopType.__init__)


def test_hyp_xpdl2_looptype_constructor_args():
...
def test_hyp_xpdl2_loopstandardtype_is_not_abstract():
    assert not inspect.isabstract(xpdl2_LoopStandardType)


def test_hyp_xpdl2_loopstandardtype_constructor_exists():
    assert callable(xpdl2_LoopStandardType.__init__)


def test_hyp_xpdl2_loopstandardtype_constructor_args():
...
def test_hyp_xpdl2_formalparameterstype_is_not_abstract():
    assert not inspect.isabstract(xpdl2_FormalParametersType)


def test_hyp_xpdl2_formalparameterstype_constructor_exists():
    assert callable(xpdl2_FormalParametersType.__init__)


def test_hyp_xpdl2_formalparameterstype_constructor_args():
    sig = inspect.signature(xpdl2_FormalParametersType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_xpdl2_loopmultiinstancetype_is_not_abstract():
    assert not inspect.isabstract(xpdl2_LoopMultiInstanceType)


def test_hyp_xpdl2_loopmultiinstancetype_constructor_exists():
    assert callable(xpdl2_LoopMultiInstanceType.__init__)


def test_hyp_xpdl2_loopmultiinstancetype_constructor_args():
...
def test_hyp_xpdl2_formalparametertype_is_not_abstract():
    assert not inspect.isabstract(xpdl2_FormalParameterType)


def test_hyp_xpdl2_formalparametertype_constructor_exists():
    assert callable(xpdl2_FormalParameterType.__init__)


def test_hyp_xpdl2_formalparametertype_constructor_args():
...
def test_hyp_xpdl2_typedeclarationtype_is_not_abstract():
    assert not inspect.isabstract(xpdl2_TypeDeclarationType)


def test_hyp_xpdl2_typedeclarationtype_constructor_exists():
    assert callable(xpdl2_TypeDeclarationType.__init__)


def test_hyp_xpdl2_typedeclarationtype_constructor_args():
...
def test_hyp_xpdl2_externalpackage_is_not_abstract():
    assert not inspect.isabstract(xpdl2_ExternalPackage)


def test_hyp_xpdl2_externalpackage_constructor_exists():
    assert callable(xpdl2_ExternalPackage.__init__)


def test_hyp_xpdl2_externalpackage_constructor_args():
...
def test_hyp_xpdl2_externalpackages_is_not_abstract():
    assert not inspect.isabstract(xpdl2_ExternalPackages)


def test_hyp_xpdl2_externalpackages_constructor_exists():
    assert callable(xpdl2_ExternalPackages.__init__)


def test_hyp_xpdl2_externalpackages_constructor_args():
    sig = inspect.signature(xpdl2_ExternalPackages.__init__)
    params = list(sig.parameters.keys())



def test_hyp_xpdl2_extensible_is_not_abstract():
    assert not inspect.isabstract(xpdl2_Extensible)


def test_hyp_xpdl2_extensible_constructor_exists():
    assert callable(xpdl2_Extensible.__init__)


def test_hyp_xpdl2_extensible_constructor_args():
...
def test_hyp_xpdl2_extendedattributetype_is_not_abstract():
    assert not inspect.isabstract(xpdl2_ExtendedAttributeType)


def test_hyp_xpdl2_extendedattributetype_constructor_exists():
    assert callable(xpdl2_ExtendedAttributeType.__init__)


def test_hyp_xpdl2_extendedattributetype_constructor_args():
...
def test_hyp_xpdl2_extendedattributestype_is_not_abstract():
    assert not inspect.isabstract(xpdl2_ExtendedAttributesType)


def test_hyp_xpdl2_extendedattributestype_constructor_exists():
    assert callable(xpdl2_ExtendedAttributesType.__init__)


def test_hyp_xpdl2_extendedattributestype_constructor_args():
    sig = inspect.signature(xpdl2_ExtendedAttributesType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_xpdl2_expressiontype_is_not_abstract():
    assert not inspect.isabstract(xpdl2_ExpressionType)


def test_hyp_xpdl2_expressiontype_constructor_exists():
    assert callable(xpdl2_ExpressionType.__init__)


def test_hyp_xpdl2_expressiontype_constructor_args():
...
def test_hyp_xpdl2_datatypetype_is_not_abstract():
    assert not inspect.isabstract(xpdl2_DataTypeType)


def test_hyp_xpdl2_datatypetype_constructor_exists():
    assert callable(xpdl2_DataTypeType.__init__)


def test_hyp_xpdl2_datatypetype_constructor_args():
...
def test_hyp_xpdl2_schematypetype_is_not_abstract():
    assert not inspect.isabstract(xpdl2_SchemaTypeType)


def test_hyp_xpdl2_schematypetype_constructor_exists():
    assert callable(xpdl2_SchemaTypeType.__init__)


def test_hyp_xpdl2_schematypetype_constructor_args():
    sig = inspect.signature(xpdl2_SchemaTypeType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_xpdl2_externalreferencetype_is_not_abstract():
    assert not inspect.isabstract(xpdl2_ExternalReferenceType)


def test_hyp_xpdl2_externalreferencetype_constructor_exists():
    assert callable(xpdl2_ExternalReferenceType.__init__)


def test_hyp_xpdl2_externalreferencetype_constructor_args():
...
def test_hyp_xpdl2_declaredtypetype_is_not_abstract():
    assert not inspect.isabstract(xpdl2_DeclaredTypeType)


def test_hyp_xpdl2_declaredtypetype_constructor_exists():
    assert callable(xpdl2_DeclaredTypeType.__init__)


def test_hyp_xpdl2_declaredtypetype_constructor_args():
...
def test_hyp_xpdl2_basictypetype_is_not_abstract():
    assert not inspect.isabstract(xpdl2_BasicTypeType)


def test_hyp_xpdl2_basictypetype_constructor_exists():
    assert callable(xpdl2_BasicTypeType.__init__)


def test_hyp_xpdl2_basictypetype_constructor_args():
    sig = inspect.signature(xpdl2_BasicTypeType.__init__)
    params = list(sig.parameters.keys())
    assert "type" in params, "Missing parameter 'type'"


def test_hyp_miorderingtype_exists():
    # Check that the Enumeration exists
    assert MIOrderingType is not None

def test_hyp_miorderingtype_has_all_literals():
...
def test_hyp_testtimetype_exists():
    # Check that the Enumeration exists
    assert TestTimeType is not None

def test_hyp_testtimetype_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_looptypetype_exists():
    # Check that the Enumeration exists
    assert LoopTypeType is not None

def test_hyp_looptypetype_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_miflowconditiontype_exists():
    # Check that the Enumeration exists
    assert MIFlowConditionType is not None

def test_hyp_miflowconditiontype_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_xpdl2_extensions_loopdatareftype_outputItemRef_setter(instance):
...
@given(instance=xpdl2_extensions_LoopDataRefType_strategy)
def test_hyp_xpdl2_extensions_loopdatareftype_loopCounterRef_setter(instance):
...
@given(instance=xpdl2_extensions_LoopDataRefType_strategy)
def test_hyp_xpdl2_extensions_loopdatareftype_inputItemRef_setter(instance):
...
def test_hyp_xpdl2_scripttype_version_setter(instance):
...
@given(instance=xpdl2_ScriptType_strategy)
def test_hyp_xpdl2_scripttype_grammar_setter(instance):
...
@given(instance=xpdl2_ScriptType_strategy)
def test_hyp_xpdl2_scripttype_type_setter(instance):
...
def test_hyp_xpdl2_looptype_loopType_setter(instance):
...
def test_hyp_xpdl2_loopstandardtype_testTime_setter(instance):
...
@given(instance=xpdl2_LoopStandardType_strategy)
def test_hyp_xpdl2_loopstandardtype_loopMaximum_setter(instance):
...
def test_hyp_xpdl2_formalparameterstype_addformalparameter_changes_state(instance):
...
def test_hyp_xpdl2_loopmultiinstancetype_mIOrdering_setter(instance):
...
@given(instance=xpdl2_LoopMultiInstanceType_strategy)
def test_hyp_xpdl2_loopmultiinstancetype_mIFlowCondition_setter(instance):
...
def test_hyp_xpdl2_formalparametertype_description_setter(instance):
...
@given(instance=xpdl2_FormalParameterType_strategy)
def test_hyp_xpdl2_formalparametertype_mode_setter(instance):
...
@given(instance=xpdl2_FormalParameterType_strategy)
def test_hyp_xpdl2_formalparametertype_id_setter(instance):
...
@given(instance=xpdl2_FormalParameterType_strategy)
def test_hyp_xpdl2_formalparametertype_name_setter(instance):
...
def test_hyp_xpdl2_typedeclarationtype_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
@given(instance=xpdl2_TypeDeclarationType_strategy)
def test_hyp_xpdl2_typedeclarationtype_description_setter(instance):
    original = instance.description
    instance.description = original
    assert instance.description == original
...
@given(instance=xpdl2_TypeDeclarationType_strategy)
def test_hyp_xpdl2_typedeclarationtype_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_xpdl2_externalpackage_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=xpdl2_ExternalPackage_strategy)
def test_hyp_xpdl2_externalpackage_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
@given(instance=xpdl2_ExternalPackage_strategy)
def test_hyp_xpdl2_externalpackage_href_setter(instance):
...
def test_hyp_xpdl2_extendedattributetype_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=xpdl2_ExtendedAttributeType_strategy)
def test_hyp_xpdl2_extendedattributetype_any_setter(instance):
...
@given(instance=xpdl2_ExtendedAttributeType_strategy)
def test_hyp_xpdl2_extendedattributetype_mixed_setter(instance):
...
@given(instance=xpdl2_ExtendedAttributeType_strategy)
def test_hyp_xpdl2_extendedattributetype_value_setter(instance):
...
@given(instance=xpdl2_ExtendedAttributeType_strategy)
def test_hyp_xpdl2_extendedattributetype_group_setter(instance):
...
def test_hyp_xpdl2_expressiontype_scriptGrammar_setter(instance):
...
@given(instance=xpdl2_ExpressionType_strategy)
def test_hyp_xpdl2_expressiontype_any_setter(instance):
    original = instance.any
    instance.any = original
    assert instance.any == original
...
@given(instance=xpdl2_ExpressionType_strategy)
def test_hyp_xpdl2_expressiontype_mixed_setter(instance):
    original = instance.mixed
    instance.mixed = original
    assert instance.mixed == original
...
@given(instance=xpdl2_ExpressionType_strategy)
def test_hyp_xpdl2_expressiontype_scriptVersion_setter(instance):
...
@given(instance=xpdl2_ExpressionType_strategy)
def test_hyp_xpdl2_expressiontype_group_setter(instance):
    original = instance.group
    instance.group = original
    assert instance.group == original
...
@given(instance=xpdl2_ExpressionType_strategy)
def test_hyp_xpdl2_expressiontype_scriptType_setter(instance):
...
def test_hyp_xpdl2_datatypetype_carnotType_setter(instance):
...
def test_hyp_xpdl2_externalreferencetype_uuid_setter(instance):
...
@given(instance=xpdl2_ExternalReferenceType_strategy)
def test_hyp_xpdl2_externalreferencetype_location_setter(instance):
...
@given(instance=xpdl2_ExternalReferenceType_strategy)
def test_hyp_xpdl2_externalreferencetype_namespace_setter(instance):
...
@given(instance=xpdl2_ExternalReferenceType_strategy)
def test_hyp_xpdl2_externalreferencetype_xref_setter(instance):
...
def test_hyp_xpdl2_declaredtypetype_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
def test_hyp_xpdl2_basictypetype_type_setter(instance):
    original = instance.type
    instance.type = original
    assert instance.type == original
