...
# Classes
archimate_Concept = Class(name="archimate_Concept", is_abstract=True)
archimate_BusinessConcept = Class(name="archimate_BusinessConcept", is_abstract=True)
Concept = Class(name="Concept")
archimate_ApplicationConcept = Class(name="archimate_ApplicationConcept", is_abstract=True)
archimate_TechnologyConcept = Class(name="archimate_TechnologyConcept", is_abstract=True)
archimate_MotivationConcept = Class(name="archimate_MotivationConcept", is_abstract=True)
archimate_ImplementationAndMigrationConcept = Class(name="archimate_ImplementationAndMigrationConcept", is_abstract=True)
archimate_Passive = Class(name="archimate_Passive", is_abstract=True)
archimate_Behavior = Class(name="archimate_Behavior", is_abstract=True)
archimate_Active = Class(name="archimate_Active", is_abstract=True)
archimate_BusinessActor = Class(name="archimate_BusinessActor")
BusinessConcept = Class(name="BusinessConcept")
Active = Class(name="Active")
archimate_BusinessRole = Class(name="archimate_BusinessRole")
archimate_InfrastructureInterface = Class(name="archimate_InfrastructureInterface")
archimate_BusinessCollaboration = Class(name="archimate_BusinessCollaboration")
archimate_BusinessInterface = Class(name="archimate_BusinessInterface")
archimate_Location = Class(name="archimate_Location")
archimate_BusinessObject = Class(name="archimate_BusinessObject")
Passive = Class(name="Passive")
archimate_BusinessProcess = Class(name="archimate_BusinessProcess")
Behavior = Class(name="Behavior")
archimate_BusinessFunction = Class(name="archimate_BusinessFunction")
archimate_BusinessInteraction = Class(name="archimate_BusinessInteraction")
archimate_BusinessEvent = Class(name="archimate_BusinessEvent")
archimate_BusinessService = Class(name="archimate_BusinessService")
archimate_Representation = Class(name="archimate_Representation")
archimate_Meaning = Class(name="archimate_Meaning")
archimate_Value = Class(name="archimate_Value")
archimate_Product = Class(name="archimate_Product")
archimate_Contract = Class(name="archimate_Contract")
BusinessObject = Class(name="BusinessObject")
archimate_ApplicationComponent = Class(name="archimate_ApplicationComponent")
ApplicationConcept = Class(name="ApplicationConcept")
archimate_ApplicationCollaboration = Class(name="archimate_ApplicationCollaboration")
archimate_ApplicationInterface = Class(name="archimate_ApplicationInterface")
archimate_DataObject = Class(name="archimate_DataObject")
archimate_ApplicationFunction = Class(name="archimate_ApplicationFunction")
archimate_ApplicationInteraction = Class(name="archimate_ApplicationInteraction")
archimate_ApplicationService = Class(name="archimate_ApplicationService")
archimate_Node = Class(name="archimate_Node")
TechnologyConcept = Class(name="TechnologyConcept")
archimate_Device = Class(name="archimate_Device")
Node = Class(name="Node")
archimate_SystemSoftware = Class(name="archimate_SystemSoftware")
archimate_Network = Class(name="archimate_Network")
archimate_CommunicationPath = Class(name="archimate_CommunicationPath")
archimate_InfrastructureFunction = Class(name="archimate_InfrastructureFunction")
archimate_InfrastructureService = Class(name="archimate_InfrastructureService")
archimate_Artifact = Class(name="archimate_Artifact")
archimate_Stakeholder = Class(name="archimate_Stakeholder")
MotivationConcept = Class(name="MotivationConcept")
archimate_Driver = Class(name="archimate_Driver")
archimate_Assessment = Class(name="archimate_Assessment")
archimate_Goal = Class(name="archimate_Goal")
archimate_Requirement = Class(name="archimate_Requirement")
archimate_Constraint = Class(name="archimate_Constraint")
Requirement = Class(name="Requirement")
archimate_Principle = Class(name="archimate_Principle")
archimate_WorkPackage = Class(name="archimate_WorkPackage")
ImplementationAndMigrationConcept = Class(name="ImplementationAndMigrationConcept")
archimate_Deliverable = Class(name="archimate_Deliverable")
archimate_Plateau = Class(name="archimate_Plateau")
archimate_Gap = Class(name="archimate_Gap")
