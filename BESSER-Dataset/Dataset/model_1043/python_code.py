...
class MetaModel_EvolutionStyle:
    ...
    def __init__(self, name: str, MetaModel_EvolutionStyle2: "MetaModel_InitialState" = None, MetaModel_EvolutionStyle4: set["MetaModel_IntermidiateState"] = None, MetaModel_EvolutionStyle6: "MetaModel_FinalState" = None, MetaModel_EvolutionStyle: set["MetaModel_Transition"] = None):
        self.name = name
