...
# Classes
MetaModel_IntermidiateState = Class(name="MetaModel_IntermidiateState")
MetaModel_FinalState = Class(name="MetaModel_FinalState")
MetaModel_EvolutionStyle = Class(name="MetaModel_EvolutionStyle")
MetaModel_Transition = Class(name="MetaModel_Transition")
MetaModel_InitialState = Class(name="MetaModel_InitialState")
MetaModel_Operation = Class(name="MetaModel_Operation")
MetaModel_State = Class(name="MetaModel_State", is_abstract=True)
...
MetaModel_Transition.attributes={MetaModel_Transition_name, MetaModel_Transition_description}
...
MetaModel_Operation.attributes={MetaModel_Operation_time, MetaModel_Operation_cost, MetaModel_Operation_name}
...
domain_model = DomainModel(
    name="MetaModel",
    types={MetaModel_IntermidiateState, MetaModel_FinalState, MetaModel_EvolutionStyle, MetaModel_Transition, MetaModel_InitialState, MetaModel_Operation, MetaModel_State, State},
    associations={InitialArchitecture1, states3, finalArchitecture5, transitions0, operations7, source9, target11, next14, next17, prev20, prev23},
    generalizations={gen_MetaModel_InitialState_State, gen_MetaModel_IntermidiateState_State, gen_MetaModel_FinalState_State},
    metadata=None
)
