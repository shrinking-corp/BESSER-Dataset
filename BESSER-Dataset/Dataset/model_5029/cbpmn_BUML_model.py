...
cbpmn_DecisionCondition = Class(name="cbpmn_DecisionCondition")
...
cbpmn_Event = Class(name="cbpmn_Event")
...
cbpmn_DataObjectReference.attributes={cbpmn_DataObjectReference_name, cbpmn_DataObjectReference_higherBound, cbpmn_DataObjectReference_lowerBound}
...
domain_model = DomainModel(
    name="cbpmn",
    types={cbpmn_ProcessModel, cbpmn_Branch, cbpmn_DataObjectReference, cbpmn_DecisionCondition, cbpmn_FlowNode, cbpmn_DecisionGateway, SplitGateway, OCLConstraint, cbpmn_OCLConstraint, cbpmn_Activity, FlowNode, cbpmn_ParallelGateway, cbpmn_SplitGateway, cbpmn_EClass, cbpmn_ProcessInstance, cbpmn_Event, cbpmn_DataObject, EObject, cbpmn_FlowNodeInstance, cbpmn_EObject, ActivityType, EventType, DecisionType, GatewayType, DataObjectType, FlowNodeInstanceStatus},
    associations={inputs8, outputs10, invariabilityClauses13, entryConditions16, nodes18, conditions19, branch21, mainBranch0, processInvariants1, preConditions3, postConditions5, branches33, dataObjectClass35, processModel37, branch24, next26, previous29, trigger31, processInstance49, type50, executedNodes39, dataObjects40, nodeDef42, inputs43, outputs46},
    generalizations={gen_cbpmn_DecisionGateway_SplitGateway, gen_cbpmn_DecisionCondition_OCLConstraint, gen_cbpmn_Activity_FlowNode, gen_cbpmn_ParallelGateway_SplitGateway, gen_cbpmn_SplitGateway_FlowNode, gen_cbpmn_Event_FlowNode, gen_cbpmn_DataObject_EObject},
    metadata=None
)
