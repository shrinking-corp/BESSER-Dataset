...
class cbpmn_FlowNodeInstance:
    ...
    def __init__(self, status: str, executedNodes: "cbpmn_ProcessInstance" = None, FlowNodeInstance: "cbpmn_ProcessInstance" = None, cbpmn_FlowNodeInstance: "cbpmn_FlowNode" = None, cbpmn_FlowNodeInstance44: set["cbpmn_EObject"] = None, cbpmn_FlowNodeInstance47: set["cbpmn_EObject"] = None):
        self.status = status
...
class cbpmn_ProcessInstance:
    ...
    def __init__(self, id: str, cbpmn_ProcessInstance: "cbpmn_ProcessModel" = None, ProcessInstance: "cbpmn_FlowNodeInstance" = None, processInstance: set["cbpmn_FlowNodeInstance"] = None, cbpmn_ProcessInstance41: set["cbpmn_EObject"] = None):
        self.id = id
...
class cbpmn_Activity(FlowNode):
    ...
    def __init__(self, type: str, cbpmn_Activity9: set["cbpmn_DataObjectReference"] = None, cbpmn_Activity: set["cbpmn_OCLConstraint"] = None, cbpmn_Activity6: set["cbpmn_OCLConstraint"] = None, cbpmn_Activity11: set["cbpmn_DataObjectReference"] = None, cbpmn_Activity14: set["cbpmn_OCLConstraint"] = None):
        self.type = type
...
class cbpmn_OCLConstraint:
    ...
    def __init__(self, constraintName: str, constraintStr: str, cbpmn_OCLConstraint: "cbpmn_ProcessModel" = None, cbpmn_OCLConstraint4: "cbpmn_Activity" = None, cbpmn_OCLConstraint7: "cbpmn_Activity" = None, cbpmn_OCLConstraint32: "cbpmn_Event" = None, cbpmn_OCLConstraint15: "cbpmn_Activity" = None):
...
class cbpmn_DecisionGateway(SplitGateway):
    ...
    def addBranchWithCondition(self, cbpmn_default, cbpmn_branch, cbpmn_condition):
        # TODO: Implement addBranchWithCondition method
        pass

class cbpmn_FlowNode(ABC):

    def __init__(self, name: str, nodes: "cbpmn_Branch" = None, FlowNode27: "cbpmn_FlowNode" = None, previous: "cbpmn_FlowNode" = None, FlowNode30: "cbpmn_FlowNode" = None, next: "cbpmn_FlowNode" = None, cbpmn_FlowNode: "cbpmn_FlowNodeInstance" = None, FlowNode: "cbpmn_Branch" = None):
        self.name = name
        self.nodes = nodes
...
class cbpmn_DataObjectReference:
    ...
    def __init__(self, name: str, lowerBound: int, higherBound: int, cbpmn_DataObjectReference: "cbpmn_Activity" = None, cbpmn_DataObjectReference36: "cbpmn_EClass" = None, cbpmn_DataObjectReference12: "cbpmn_Activity" = None):
        self.name = name
