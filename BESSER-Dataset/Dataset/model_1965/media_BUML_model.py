...
# Classes
MediaPlayer_MediaApi = Class(name="MediaPlayer_MediaApi", is_abstract=True)
MediaPlayer_Playlist = Class(name="MediaPlayer_Playlist")
BaseObject = Class(name="BaseObject")
MediaPlayer_MediaObject = Class(name="MediaPlayer_MediaObject")
MediaPlayer_PlayLayer = Class(name="MediaPlayer_PlayLayer")
MediaPlayer_Library = Class(name="MediaPlayer_Library")
MediaPlayer_BaseObject = Class(name="MediaPlayer_BaseObject")

# MediaPlayer_MediaApi class attributes and methods
MediaPlayer_MediaApi_m_init: Method = Method(name="init", parameters={})
MediaPlayer_MediaApi_m_play: Method = Method(name="play", parameters={Parameter(name='MediaPlayer_playMe', type=StringType)})
MediaPlayer_MediaApi_m_pause: Method = Method(name="pause", parameters={Parameter(name='MediaPlayer_pauseMe', type=StringType)})
MediaPlayer_MediaApi_m_stop: Method = Method(name="stop", parameters={Parameter(name='MediaPlayer_stopMe', type=StringType)})
MediaPlayer_MediaApi_m_dispose: Method = Method(name="dispose", parameters={})
MediaPlayer_MediaApi_m_canPlay: Method = Method(name="canPlay", parameters={Parameter(name='MediaPlayer_media', type=StringType)}, type=BooleanType)
MediaPlayer_MediaApi_m_updateMediaObjectInfo: Method = Method(name="updateMediaObjectInfo", parameters={Parameter(name='MediaPlayer_updateMe', type=StringType)})
MediaPlayer_MediaApi.methods={MediaPlayer_MediaApi_m_dispose, MediaPlayer_MediaApi_m_pause, MediaPlayer_MediaApi_m_play, MediaPlayer_MediaApi_m_canPlay, MediaPlayer_MediaApi_m_stop, MediaPlayer_MediaApi_m_init, MediaPlayer_MediaApi_m_updateMediaObjectInfo}
...
MediaPlayer_Playlist.attributes={MediaPlayer_Playlist_repeat, MediaPlayer_Playlist_name}
...
MediaPlayer_MediaObject.attributes={MediaPlayer_MediaObject_state, MediaPlayer_MediaObject_title, MediaPlayer_MediaObject_artist, MediaPlayer_MediaObject_location, MediaPlayer_MediaObject_album, MediaPlayer_MediaObject_year}

# MediaPlayer_PlayLayer class attributes and methods
MediaPlayer_PlayLayer_m_registerApi: Method = Method(name="registerApi", parameters={Parameter(name='MediaPlayer_addMe', type=StringType)})
MediaPlayer_PlayLayer_m_unregisterApi: Method = Method(name="unregisterApi", parameters={Parameter(name='MediaPlayer_unregisterMe', type=StringType)})
...
MediaPlayer_BaseObject_m_addPropertyChangeListener: Method = Method(name="addPropertyChangeListener", parameters={Parameter(name='MediaPlayer_listener', type=StringType)})
MediaPlayer_BaseObject_m_removePropertyChangeListener: Method = Method(name="removePropertyChangeListener", parameters={Parameter(name='MediaPlayer_listener', type=StringType)})
MediaPlayer_BaseObject.attributes={MediaPlayer_BaseObject_id, MediaPlayer_BaseObject_propertyChangeSupport}
MediaPlayer_BaseObject.methods={MediaPlayer_BaseObject_m_removePropertyChangeListener, MediaPlayer_BaseObject_m_addPropertyChangeListener}
...
domain_model = DomainModel(
    name="MediaPlayer",
    types={MediaPlayer_MediaApi, MediaPlayer_Playlist, BaseObject, MediaPlayer_MediaObject, MediaPlayer_PlayLayer, MediaPlayer_Library, MediaPlayer_BaseObject, State},
