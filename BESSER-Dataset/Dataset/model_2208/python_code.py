...
class study_Specialization:
    ...
    def __init__(self, name: str, Specialization8: "study_Semester" = None, specialization: set["study_Semester"] = None, specializations: "study_Programme" = None, Specialization: "study_Programme" = None):
        self.name = name
...
class study_Semester:
    ...
    def __init__(self, year: int, Season: str, semester: set["study_SemesterCourse"] = None, semesters: "study_Programme" = None, semesters7: "study_Specialization" = None, Semester10: "study_Specialization" = None, Semester15: "study_SemesterCourse" = None, Semester: "study_Programme" = None):
        self.year = year
        self.Season = Season
...
class study_Programme:
    ...
    def __init__(self, name: str, code: str, duration: int, Programme: "study_Semester" = None, Programme12: "study_Specialization" = None, programme: set["study_Semester"] = None, programme2: set["study_Specialization"] = None, programs: "study_Department" = None, Programme22: "study_Department" = None):
        self.name = name
        self.code = code
...
class study_SemesterCourse:
    ...
    def __init__(self, mandatory: bool, SemesterCourse: "study_Semester" = None, study_SemesterCourse: "study_Course" = None, courses: "study_Semester" = None):
