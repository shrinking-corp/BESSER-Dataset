...
def test_study_SemesterCourse_mandatory_value_roundtrip():
    instance = study_SemesterCourse(mandatory=True)
...
def test_assoc_course13_link_reassign_clear():
    a = study_SemesterCourse(mandatory=True)
...
study_SemesterCourse_strategy = st.builds(study_SemesterCourse, mandatory=st.booleans())
@given(instance=study_SemesterCourse_strategy)
@settings(max_examples=25)
