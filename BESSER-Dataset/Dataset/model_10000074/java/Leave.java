...
public class Leave  {
    ...
    public Leave(
        LocalDate Leave_EndDate,        LocalDate Leave_ApplyDate,        String Leave_Status,        String Leave_detail,        int Leave_NoOfDays,        LocalDate Leave_StartDate,        String Leave_Title,        int leave_id,        int Emp_Id    ) {
