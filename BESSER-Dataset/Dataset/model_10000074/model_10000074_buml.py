...
Employee.attributes={Employee_Emp_DOB, Employee_Emp_ContactNo, Employee_Emp_Id, Employee_Emp_Position, Employee_Emp_Email, Employee_Emp_NIC, Employee_Emp_Address, Employee_Emp_Date_Of_Joint, Employee_Emp_Department, Employee_Emp_Salary, Employee_Emp_Name}
...
Salary.attributes={Salary_Emp_Id, Salary_OverTime, Salary_Sly_Netgross, Salary_Sly_Increment, Salary_Sly_Basic, Salary_Sly_Decrement}
...
Leave.attributes={Leave_Leave_NoOfDays, Leave_Emp_Id, Leave_Leave_ApplyDate, Leave_leave_id, Leave_Leave_StartDate, Leave_Leave_Title, Leave_Leave_EndDate, Leave_Leave_Status, Leave_Leave_detail}
...
domain_model = DomainModel(
    name="_0a61e8b8_9a0b_4b29_aaa2_7556acb1db95",
