...
# Classes
model_IEntity = Class(name="model_IEntity", is_abstract=True)
model_ContactCategory = Class(name="model_ContactCategory")
model_Payment = Class(name="model_Payment")
model_IDescribableEntity = Class(name="model_IDescribableEntity", is_abstract=True)
IEntity = Class(name="IEntity")
model_AbstractCategory = Class(name="model_AbstractCategory", is_abstract=True)
model_VoucherCategory = Class(name="model_VoucherCategory")
AbstractCategory = Class(name="AbstractCategory")
model_Address = Class(name="model_Address")
model_Contact = Class(name="model_Contact", is_abstract=True)
model_Invoice = Class(name="model_Invoice")
model_DocumentItem = Class(name="model_DocumentItem")
model_BankAccount = Class(name="model_BankAccount")
model_Creditor = Class(name="model_Creditor")
Contact = Class(name="Contact")
model_Debitor = Class(name="model_Debitor")
model_Document = Class(name="model_Document", is_abstract=True)
model_IndividualDocumentInfo = Class(name="model_IndividualDocumentInfo")
model_Product = Class(name="model_Product")
model_VAT = Class(name="model_VAT")
model_Shipping = Class(name="model_Shipping")
model_ItemListTypeCategory = Class(name="model_ItemListTypeCategory")
Document = Class(name="Document")
model_Order = Class(name="model_Order")
model_Letter = Class(name="model_Letter")
model_Offer = Class(name="model_Offer")
model_Dunning = Class(name="model_Dunning")
model_Credit = Class(name="model_Credit")
model_Delivery = Class(name="model_Delivery")
model_Confirmation = Class(name="model_Confirmation")
model_Proforma = Class(name="model_Proforma")
model_Voucher = Class(name="model_Voucher")
model_VoucherItem = Class(name="model_VoucherItem")
model_ItemAccountType = Class(name="model_ItemAccountType")
model_ProductBlockPrice = Class(name="model_ProductBlockPrice")
IDescribableEntity = Class(name="IDescribableEntity")
model_ProductCategory = Class(name="model_ProductCategory")
model_ProductOptions = Class(name="model_ProductOptions")
model_Role = Class(name="model_Role")
model_UserProperty = Class(name="model_UserProperty")
model_VATCategory = Class(name="model_VATCategory")
model_ShippingCategory = Class(name="model_ShippingCategory")
model_Tenant = Class(name="model_Tenant")
model_TextModule = Class(name="model_TextModule")
model_TextCategory = Class(name="model_TextCategory")
model_User = Class(name="model_User")
model_CEFACTCode = Class(name="model_CEFACTCode")
model_WebShop = Class(name="model_WebShop")
model_WebshopStateMapping = Class(name="model_WebshopStateMapping")
...
model_IEntity.attributes={model_IEntity_dateAdded, model_IEntity_id, model_IEntity_modifiedBy, model_IEntity_name, model_IEntity_deleted, model_IEntity_validTo, model_IEntity_validFrom, model_IEntity_modified}
...
model_Payment.attributes={model_Payment_unpaidText, model_Payment_discountValue, model_Payment_discountDays, model_Payment_depositText, model_Payment_description, model_Payment_code, model_Payment_paidText, model_Payment_netDays}
...
model_Address.attributes={model_Address_city, model_Address_zip, model_Address_countryCode, model_Address_street, model_Address_cityAddon, model_Address_manualAddress}
...
model_Contact.attributes={model_Contact_fax, model_Contact_vatNumberValid, model_Contact_contactType, model_Contact_birthday, model_Contact_firstName, model_Contact_email, model_Contact_gender, model_Contact_discount, model_Contact_customerNumber, model_Contact_gln, model_Contact_mobile, model_Contact_useNetGross, model_Contact_note, model_Contact_title, model_Contact_webshopName, model_Contact_website, model_Contact_vatNumber, model_Contact_reliability, model_Contact_mandateReference, model_Contact_company, model_Contact_supplierNumber, model_Contact_useSalesEqualizationTax, model_Contact_phone}
...
model_DocumentItem.attributes={model_DocumentItem_originQuantity, model_DocumentItem_weight, model_DocumentItem_description, model_DocumentItem_vestingPeriodStart, model_DocumentItem_optional, model_DocumentItem_tara, model_DocumentItem_itemType, model_DocumentItem_itemRebate, model_DocumentItem_price, model_DocumentItem_quantityUnit, model_DocumentItem_vestingPeriodEnd, model_DocumentItem_noVat, model_DocumentItem_posNr, model_DocumentItem_quantity, model_DocumentItem_itemNumber, model_DocumentItem_gtin, model_DocumentItem_picture}
...
model_BankAccount.attributes={model_BankAccount_bankCode, model_BankAccount_accountHolder, model_BankAccount_bankName, model_BankAccount_bic, model_BankAccount_iban}
...
model_Document.attributes={model_Document_documentDate, model_Document_billingType, model_Document_shippingAutoVat, model_Document_shippingValue, model_Document_odtPath, model_Document_totalValue, model_Document_dueDays, model_Document_progress, model_Document_serviceDate, model_Document_printTemplate, model_Document_pdfPath, model_Document_netGross, model_Document_addressFirstLine, model_Document_webshopDate, model_Document_message3, model_Document_customerRef, model_Document_paid, model_Document_paidValue, model_Document_transactionId, model_Document_message, model_Document_itemsRebate, model_Document_deposit, model_Document_printed, model_Document_message2, model_Document_vestingPeriodEnd, model_Document_orderDate, model_Document_consultant, model_Document_webshopId, model_Document_payDate, model_Document_vestingPeriodStart}
...
model_IndividualDocumentInfo.attributes={model_IndividualDocumentInfo_shippingAutoVat, model_IndividualDocumentInfo_noVatName, model_IndividualDocumentInfo_shippingDescription, model_IndividualDocumentInfo_noVatDescription, model_IndividualDocumentInfo_shippingVatDescription, model_IndividualDocumentInfo_paymentText, model_IndividualDocumentInfo_paymentName, model_IndividualDocumentInfo_paymentDescription, model_IndividualDocumentInfo_shippingVatValue, model_IndividualDocumentInfo_shippingValue, model_IndividualDocumentInfo_shippingName}
...
model_Product.attributes={model_Product_cdf01, model_Product_price5, model_Product_quantity, model_Product_block2, model_Product_weight, model_Product_price2, model_Product_webshopId, model_Product_block4, model_Product_block5, model_Product_sellingUnit, model_Product_itemNumber, model_Product_cdf03, model_Product_gtin, model_Product_block1, model_Product_price1, model_Product_price3, model_Product_block3, model_Product_picture, model_Product_costPrice, model_Product_price4, model_Product_cdf02, model_Product_quantityUnit}
...
model_VAT.attributes={model_VAT_salesEqualizationTax, model_VAT_description, model_VAT_taxValue}
...
model_Shipping.attributes={model_Shipping_code, model_Shipping_autoVat, model_Shipping_shippingValue}
...
model_Voucher.attributes={model_Voucher_doNotBook, model_Voucher_totalValue, model_Voucher_paidValue, model_Voucher_documentNumber, model_Voucher_voucherNumber, model_Voucher_voucherDate, model_Voucher_discounted, model_Voucher_voucherType}
...
model_VoucherItem.attributes={model_VoucherItem_posNr, model_VoucherItem_itemVoucherType, model_VoucherItem_price}
...
model_ProductOptions.attributes={model_ProductOptions_sequenceNumber, model_ProductOptions_attributeValue}
...
model_UserProperty_global_: Property = Property(name="global_", type=StringType)
model_UserProperty.attributes={model_UserProperty_value, model_UserProperty_user, model_UserProperty_global_, model_UserProperty_default}
...
model_CEFACTCode.attributes={model_CEFACTCode_name_de, model_CEFACTCode_code, model_CEFACTCode_target, model_CEFACTCode_abbreviation_en, model_CEFACTCode_abbreviation_de}
...
domain_model = DomainModel(
    name="model",
    types={model_IEntity, model_ContactCategory, model_Payment, model_IDescribableEntity, IEntity, model_AbstractCategory, model_VoucherCategory, AbstractCategory, model_Address, model_Contact, model_Invoice, model_DocumentItem, model_BankAccount, model_Creditor, Contact, model_Debitor, model_Document, model_IndividualDocumentInfo, model_Product, model_VAT, model_Shipping, model_ItemListTypeCategory, Document, model_Order, model_Letter, model_Offer, model_Dunning, model_Credit, model_Delivery, model_Confirmation, model_Proforma, model_Voucher, model_VoucherItem, model_ItemAccountType, model_ProductBlockPrice, IDescribableEntity, model_ProductCategory, model_ProductOptions, model_Role, model_UserProperty, model_VATCategory, model_ShippingCategory, model_Tenant, model_TextModule, model_TextCategory, model_User, model_CEFACTCode, model_WebShop, model_WebshopStateMapping, ShippingVatType, ReliabilityType, VoucherType, BillingType, ContactType, ItemType},
    associations={alternateContacts4, categories6, payment8, parent1, address2, deliveryContact16, invoiceReference19, items21, bankAccount10, additionalInfo12, billingContact13, product33, itemVat35, noVatReference23, payment25, shipping28, sourceDocument31, accountType41, vat43, category46, account38, items39, blockPrices58, category48, categories51, attributes53, vat55, roles67, category69, shippingVat60, categories63, categories65, tenant66, stateMapping71},
    generalizations={gen_model_IDescribableEntity_IEntity, gen_model_AbstractCategory_IEntity, gen_model_VoucherCategory_AbstractCategory, gen_model_Address_IEntity, gen_model_Contact_IEntity, gen_model_ContactCategory_AbstractCategory, gen_model_Creditor_Contact, gen_model_Debitor_Contact, gen_model_BankAccount_IEntity, gen_model_Document_IEntity, gen_model_DocumentItem_IEntity, gen_model_ItemAccountType_IEntity, gen_model_Payment_IEntity, gen_model_Invoice_Document, gen_model_Order_Document, gen_model_Letter_Document, gen_model_Offer_Document, gen_model_Dunning_Document, gen_model_Credit_Document, gen_model_Delivery_Document, gen_model_Confirmation_Document, gen_model_Proforma_Document, gen_model_Voucher_IEntity, gen_model_VoucherItem_IEntity, gen_model_ProductOptions_IEntity, gen_model_ProductBlockPrice_IEntity, gen_model_ProductCategory_AbstractCategory, gen_model_Shipping_IDescribableEntity, gen_model_Product_IDescribableEntity, gen_model_Role_IEntity, gen_model_UserProperty_IEntity, gen_model_VAT_IEntity, gen_model_ShippingCategory_AbstractCategory, gen_model_Tenant_IEntity, gen_model_TextModule_IEntity, gen_model_TextCategory_AbstractCategory, gen_model_IndividualDocumentInfo_IEntity, gen_model_User_IEntity, gen_model_VATCategory_AbstractCategory, gen_model_ItemListTypeCategory_AbstractCategory, gen_model_CEFACTCode_IEntity, gen_model_WebShop_IEntity, gen_model_WebshopStateMapping_IEntity},
    metadata=None
)
