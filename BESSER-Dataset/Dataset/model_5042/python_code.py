...
class model_Product(IDescribableEntity):
    ...
    def __init__(self, cdf01: str, cdf02: str, cdf03: str, block1: str, block2: str, block3: str, block4: str, block5: str, picture: str, itemNumber: str, price1: str, price2: str, price3: str, price4: str, price5: str, quantity: str, quantityUnit: str, sellingUnit: str, webshopId: str, weight: str, gtin: str, costPrice: str, model_Product: "model_DocumentItem" = None, model_Product59: set["model_ProductBlockPrice"] = None, model_Product52: "model_ProductCategory" = None, model_Product54: set["model_ProductOptions"] = None, model_Product56: "model_VAT" = None):
        self.cdf01 = cdf01
        self.cdf02 = cdf02
        self.cdf03 = cdf03
        self.block1 = block1
...
class model_Contact(IEntity):
    ...
    def __init__(self, gender: str, company: str, birthday: date, email: str, mobile: str, phone: str, fax: str, discount: str, note: str, reliability: str, customerNumber: str, title: str, firstName: str, useNetGross: str, vatNumber: str, vatNumberValid: str, website: str, webshopName: str, supplierNumber: str, mandateReference: str, gln: str, contactType: str, useSalesEqualizationTax: str, model_Contact5: "model_Contact" = None, model_Contact3: "model_Contact" = None, model_Contact7: "model_ContactCategory" = None, model_Contact9: "model_Payment" = None, model_Contact: "model_Address" = None, model_Contact18: "model_Document" = None, model_Contact11: "model_BankAccount" = None, model_Contact15: "model_Document" = None):
        self.gender = gender
    ...
    @property
    def useSalesEqualizationTax(self):
...
class model_DocumentItem(IEntity):
    ...
    def __init__(self, itemRebate: str, itemNumber: str, quantity: str, originQuantity: str, weight: str, tara: str, description: str, optional: str, picture: str, price: str, quantityUnit: str, gtin: str, posNr: str, noVat: str, itemType: str, vestingPeriodStart: date, vestingPeriodEnd: date, model_DocumentItem: "model_Document" = None, model_DocumentItem34: "model_Product" = None, model_DocumentItem36: "model_VAT" = None):
...
class model_UserProperty(IEntity):
    ...
    def __init__(self, value: str, user: str, default: str, global_: str):
        self.value = value
        self.user = user
...
class model_Document(IEntity):
    ...
    def __init__(self, customerRef: str, deposit: str, documentDate: date, dueDays: str, itemsRebate: str, message: str, message2: str, addressFirstLine: str, billingType: str, consultant: str, message3: str, netGross: str, odtPath: str, orderDate: date, paidValue: str, paid: str, payDate: date, pdfPath: str, printed: str, printTemplate: str, progress: str, serviceDate: date, shippingAutoVat: str, shippingValue: str, totalValue: str, transactionId: str, webshopDate: date, webshopId: str, vestingPeriodStart: date, vestingPeriodEnd: date, model_Document17: "model_Contact" = None, model_Document20: "model_Invoice" = None, model_Document22: set["model_DocumentItem"] = None, model_Document: "model_IndividualDocumentInfo" = None, model_Document14: "model_Contact" = None, model_Document24: "model_VAT" = None, model_Document26: "model_Payment" = None, model_Document29: "model_Shipping" = None, model_Document32: "model_Document" = None, model_Document30: "model_Document" = None):
...
class model_VoucherItem(IEntity):
    ...
    def __init__(self, price: str, posNr: str, itemVoucherType: str, model_VoucherItem42: "model_ItemAccountType" = None, model_VoucherItem44: "model_VAT" = None, model_VoucherItem: "model_Voucher" = None):
        self.price = price
        self.posNr = posNr
...
class model_VAT(IEntity):
    ...
    def __init__(self, description: str, taxValue: str, salesEqualizationTax: str, model_VAT37: "model_DocumentItem" = None, model_VAT: "model_Document" = None, model_VAT45: "model_VoucherItem" = None, model_VAT57: "model_Product" = None, model_VAT70: "model_VATCategory" = None, model_VAT62: "model_Shipping" = None):
        self.description = description
...
class model_IndividualDocumentInfo(IEntity):
    ...
    def __init__(self, paymentName: str, paymentText: str, paymentDescription: str, shippingName: str, shippingValue: str, shippingAutoVat: str, shippingDescription: str, shippingVatDescription: str, shippingVatValue: str, noVatName: str, noVatDescription: str, model_IndividualDocumentInfo: "model_Document" = None):
    ...
    @property
    def shippingVatDescription(self):
...
class model_User(IEntity):
    ...
    def __init__(self, password: str, userName: str, model_User68: set["model_Role"] = None, model_User: "model_Tenant" = None):
...
class model_ItemAccountType(IEntity):
    ...
    def __init__(self, value: str, model_ItemAccountType: "model_VoucherItem" = None, model_ItemAccountType47: "model_ItemListTypeCategory" = None):
        self.value = value
...
class model_Voucher(IEntity):
    ...
    def __init__(self, voucherNumber: str, paidValue: str, totalValue: str, voucherType: str, voucherDate: date, discounted: str, doNotBook: str, documentNumber: str, model_Voucher: "model_VoucherCategory" = None, model_Voucher40: set["model_VoucherItem"] = None):
