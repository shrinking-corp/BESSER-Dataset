...
class bpmn_Association(EModelElement):
    ...
    def __init__(self, direction: str, associations: "bpmn_Artifact" = None, Association: "bpmn_Artifact" = None, associations10: "bpmn_AssociationTarget" = None, Association12: "bpmn_AssociationTarget" = None):
...
class bpmn_BpmnDiagram(ArtifactsContainer, Identifiable):
    ...
    def __init__(self, author: str, title: str, bpmnDiagram: set["bpmn_Pool"] = None, bpmnDiagram15: set["bpmn_MessagingEdge"] = None, BpmnDiagram: "bpmn_MessagingEdge" = None, BpmnDiagram38: "bpmn_Pool" = None):
        self.author = author
        self.title = title
