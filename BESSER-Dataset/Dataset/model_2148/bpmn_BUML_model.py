...
# Classes
bpmn_Activity = Class(name="bpmn_Activity")
Vertex = Class(name="Vertex")
MessageVertex = Class(name="MessageVertex")
bpmn_Group = Class(name="bpmn_Group")
bpmn_Lane = Class(name="bpmn_Lane")
bpmn_SubProcess = Class(name="bpmn_SubProcess")
bpmn_Artifact = Class(name="bpmn_Artifact")
Identifiable = Class(name="Identifiable")
NamedBpmnObject = Class(name="NamedBpmnObject")
bpmn_Association = Class(name="bpmn_Association")
bpmn_ArtifactsContainer = Class(name="bpmn_ArtifactsContainer")
EModelElement = Class(name="EModelElement")
bpmn_Graph = Class(name="bpmn_Graph")
AssociationTarget = Class(name="AssociationTarget")
bpmn_AssociationTarget = Class(name="bpmn_AssociationTarget")
bpmn_BpmnDiagram = Class(name="bpmn_BpmnDiagram")
ArtifactsContainer = Class(name="ArtifactsContainer")
bpmn_Pool = Class(name="bpmn_Pool")
bpmn_MessagingEdge = Class(name="bpmn_MessagingEdge")
bpmn_DataObject = Class(name="bpmn_DataObject")
Artifact = Class(name="Artifact")
bpmn_MessageVertex = Class(name="bpmn_MessageVertex")
bpmn_Vertex = Class(name="bpmn_Vertex")
bpmn_SequenceEdge = Class(name="bpmn_SequenceEdge")
bpmn_Identifiable = Class(name="bpmn_Identifiable")
Graph = Class(name="Graph")
bpmn_NamedBpmnObject = Class(name="bpmn_NamedBpmnObject")
bpmn_TextAnnotation = Class(name="bpmn_TextAnnotation")
...
bpmn_Activity.attributes={bpmn_Activity_looping, bpmn_Activity_activityType}
...
bpmn_BpmnDiagram.attributes={bpmn_BpmnDiagram_title, bpmn_BpmnDiagram_author}
...
bpmn_NamedBpmnObject.attributes={bpmn_NamedBpmnObject_name, bpmn_NamedBpmnObject_ncname, bpmn_NamedBpmnObject_documentation}
...
domain_model = DomainModel(
    name="bpmn",
    types={bpmn_Activity, Vertex, MessageVertex, bpmn_Group, bpmn_Lane, bpmn_SubProcess, bpmn_Artifact, Identifiable, NamedBpmnObject, bpmn_Association, bpmn_ArtifactsContainer, EModelElement, bpmn_Graph, AssociationTarget, bpmn_AssociationTarget, bpmn_BpmnDiagram, ArtifactsContainer, bpmn_Pool, bpmn_MessagingEdge, bpmn_DataObject, Artifact, bpmn_MessageVertex, bpmn_Vertex, bpmn_SequenceEdge, bpmn_Identifiable, Graph, bpmn_NamedBpmnObject, bpmn_TextAnnotation, Activity, ActivityType, DirectionType, SequenceFlowConditionType},
    associations={groups0, lanes1, eventHandlerFor3, source7, associations4, artifactsContainer5, artifacts6, target9, associations11, pools13, messages14, vertices16, sequenceEdges17, activities19, activities20, pool22, incomingMessages25, outgoingMessages28, source31, target32, bpmnDiagram34, graph43, lanes35, bpmnDiagram37, source39, target41, eventHandlers44, outgoingEdges46, incomingEdges49, graph52},
    generalizations={gen_bpmn_Activity_Vertex, gen_bpmn_Activity_MessageVertex, gen_bpmn_Artifact_Identifiable, gen_bpmn_Artifact_NamedBpmnObject, gen_bpmn_ArtifactsContainer_NamedBpmnObject, gen_bpmn_Association_EModelElement, gen_bpmn_Graph_AssociationTarget, gen_bpmn_AssociationTarget_Identifiable, gen_bpmn_BpmnDiagram_Identifiable, gen_bpmn_BpmnDiagram_ArtifactsContainer, gen_bpmn_DataObject_Artifact, gen_bpmn_MessageVertex_NamedBpmnObject, gen_bpmn_MessageVertex_Identifiable, gen_bpmn_Graph_ArtifactsContainer, gen_bpmn_Group_Artifact, gen_bpmn_Identifiable_EModelElement, gen_bpmn_Lane_AssociationTarget, gen_bpmn_Lane_NamedBpmnObject, gen_bpmn_Pool_Graph, gen_bpmn_MessagingEdge_AssociationTarget, gen_bpmn_MessagingEdge_NamedBpmnObject, gen_bpmn_Pool_MessageVertex, gen_bpmn_SequenceEdge_AssociationTarget, gen_bpmn_SequenceEdge_NamedBpmnObject, gen_bpmn_TextAnnotation_Artifact, gen_bpmn_Vertex_AssociationTarget, gen_bpmn_SubProcess_Activity, gen_bpmn_SubProcess_Graph},
    metadata=None
)
