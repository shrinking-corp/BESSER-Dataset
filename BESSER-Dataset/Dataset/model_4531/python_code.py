...
class drone_FlightPerformance:
    ...
    def __init__(self, minTurnRate: float, maxClimbRate: float, maxDescendRate: float, positionHold: float, launchType: str, minSpeed: int, maxSpeed: int, minAcceleration: int, maxAcceleration: int, maxAltitude: int, maxTurnRate: float, maxPayload: int, maxFlightTime: int, maxFlightTimeWithMaxPayload: int, minOperatingTemperature: float, maxOperatingTemperature: float, drone_FlightPerformance: "drone_Drone" = None):
        ...
        pass
    @property
    def maxOperatingTemperature(self):
    ...
    @property
    def minOperatingTemperature(self):
    ...
    @property
    def maxFlightTimeWithMaxPayload(self):
...
class drone_Drone(NamedElement):
    ...
    def __init__(self, maxPowerConsumption: float, giro: bool, gps: bool, accelerometer: bool, magnetometer: bool, barometer: bool, communicationRange: float, dataRate: int, radioFrequency: int, onBoardObstacleAvoidance: bool, minVoltage: float, maxVoltage: float, drone_Drone6: set["drone_Processor"] = None, drone_Drone8: set["drone_Memory"] = None, drone_Drone: "drone_Size" = None, drone_Drone2: "drone_FlightPerformance" = None, drone_Drone4: set["drone_Battery"] = None, drone_Drone10: set["drone_Device"] = None, drone_Drone12: "drone_ROSDriver" = None):
    ...
    @property
    def onBoardObstacleAvoidance(self):
