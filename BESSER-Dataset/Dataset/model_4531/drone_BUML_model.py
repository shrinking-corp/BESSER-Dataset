...
drone_Processor = Class(name="drone_Processor")
drone_Drone = Class(name="drone_Drone")
NamedElement = Class(name="NamedElement")
drone_Memory = Class(name="drone_Memory")
drone_Size = Class(name="drone_Size")
drone_Device = Class(name="drone_Device")
drone_FlightPerformance = Class(name="drone_FlightPerformance")
drone_Battery = Class(name="drone_Battery")
drone_ROSDriver = Class(name="drone_ROSDriver")
drone_Parameter = Class(name="drone_Parameter")
drone_Action = Class(name="drone_Action")
...
drone_Drone.attributes={drone_Drone_maxPowerConsumption, drone_Drone_giro, drone_Drone_onBoardObstacleAvoidance, drone_Drone_accelerometer, drone_Drone_minVoltage, drone_Drone_gps, drone_Drone_radioFrequency, drone_Drone_dataRate, drone_Drone_barometer, drone_Drone_communicationRange, drone_Drone_magnetometer, drone_Drone_maxVoltage}
...
drone_Memory.attributes={drone_Memory_size, drone_Memory_subType, drone_Memory_type}
...
drone_Size.attributes={drone_Size_height, drone_Size_propellers, drone_Size_length, drone_Size_weight, drone_Size_width, drone_Size_propellerSize}
...
drone_FlightPerformance.attributes={drone_FlightPerformance_maxPayload, drone_FlightPerformance_launchType, drone_FlightPerformance_maxAltitude, drone_FlightPerformance_maxFlightTime, drone_FlightPerformance_minOperatingTemperature, drone_FlightPerformance_maxAcceleration, drone_FlightPerformance_maxClimbRate, drone_FlightPerformance_maxSpeed, drone_FlightPerformance_minTurnRate, drone_FlightPerformance_maxTurnRate, drone_FlightPerformance_maxOperatingTemperature, drone_FlightPerformance_maxFlightTimeWithMaxPayload, drone_FlightPerformance_maxDescendRate, drone_FlightPerformance_minSpeed, drone_FlightPerformance_positionHold, drone_FlightPerformance_minAcceleration}
...
drone_Battery.attributes={drone_Battery_rechargeTime, drone_Battery_cellType, drone_Battery_capacity, drone_Battery_voltage}
...
domain_model = DomainModel(
    name="drone",
    types={drone_NamedElement, drone_Processor, drone_Drone, NamedElement, drone_Memory, drone_Size, drone_Device, drone_FlightPerformance, drone_Battery, drone_ROSDriver, drone_Parameter, drone_Action, drone_Property, MemoryType, LaunchType},
    associations={processors5, memory7, size0, flightPerf1, batteries3, dataEquipment9, rosDriver11, parameters17, supportedActions13, properties15},
    generalizations={gen_drone_Drone_NamedElement, gen_drone_Processor_NamedElement, gen_drone_Memory_NamedElement, gen_drone_Property_NamedElement, gen_drone_ROSDriver_NamedElement, gen_drone_Battery_NamedElement, gen_drone_Device_NamedElement, gen_drone_Action_NamedElement},
    metadata=None
)
