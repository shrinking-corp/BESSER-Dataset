...
public class UML_14_Dependency extends Relationship {
    ...
    public UML_14_Dependency(
        ArrayList<UML_14_ModelElement> uml_14_modelelements,        ArrayList<UML_14_ModelElement> uml_14_modelelements    ) {
