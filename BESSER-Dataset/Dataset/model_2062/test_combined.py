...
def test_hyp_namedactivity_is_not_abstract():
    assert not inspect.isabstract(NamedActivity)


def test_hyp_namedactivity_constructor_exists():
    assert callable(NamedActivity.__init__)


def test_hyp_namedactivity_constructor_args():
...
def test_hyp_activitydiagram_namedactivity_is_not_abstract():
    assert not inspect.isabstract(activitydiagram_NamedActivity)


def test_hyp_activitydiagram_namedactivity_constructor_exists():
    assert callable(activitydiagram_NamedActivity.__init__)


def test_hyp_activitydiagram_namedactivity_constructor_args():
...
def test_hyp_activitydiagram_exp_is_not_abstract():
    assert not inspect.isabstract(activitydiagram_Exp)


def test_hyp_activitydiagram_exp_constructor_exists():
    assert callable(activitydiagram_Exp.__init__)


def test_hyp_activitydiagram_exp_constructor_args():
...
def test_hyp_activitydiagram_namedactivity_name_setter(instance):
