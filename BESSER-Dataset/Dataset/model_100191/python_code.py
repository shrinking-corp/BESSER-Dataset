...
class SQL2003_Trigger:
    ...
    def __init__(self, actionTime: str, triggeredAction: str, name: str, event: str, Trigger: "SQL2003_Table" = None, SQL2003_Trigger: set["SQL2003_StructuralComponent"] = None, triggers: "SQL2003_Table" = None):
...
class SQL2003_Method:
    ...
    def __init__(self, name: str, body: str, SQL2003_Method20: "SQL2003_DataType" = None, SQL2003_Method: "SQL2003_Method" = None, SQL2003_Method15: "SQL2003_Method" = None, methods: "SQL2003_StructuredType" = None, method: set["SQL2003_MethodParameter"] = None, Method: "SQL2003_MethodParameter" = None, Method62: "SQL2003_StructuredType" = None):
        self.name = name
        self.body = body
...
class SQL2003_Table(ABC):
    ...
    def __init__(self, name: str, Table: "SQL2003_Column" = None, Table38: "SQL2003_Restriction" = None, Table47: "SQL2003_Schema" = None, tables69: set["SQL2003_View"] = None, table72: set["SQL2003_Trigger"] = None, tables: "SQL2003_Schema" = None, Table89: "SQL2003_View" = None, table: set["SQL2003_Column"] = None, Table77: "SQL2003_Trigger" = None, table74: set["SQL2003_Restriction"] = None):
        self.name = name
        self.Table = Table
