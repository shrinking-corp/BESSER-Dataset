...
class sgraph_CompositeElement(ABC):
    ...
    pass
class sgraph_Transition(DocumentedElement, Reaction, SpecificationElement):

    def __init__(self, priority: int, Transition: "sgraph_Vertex" = None, incomingTransitions: "sgraph_Vertex" = None, outgoingTransitions: "sgraph_Vertex" = None, Transition3: "sgraph_Vertex" = None):
...
class sgraph_Region(NamedElement):
    ...
    def __init__(self, priority: int, Region: "sgraph_Vertex" = None, parentRegion: set["sgraph_Vertex"] = None, regions: "sgraph_CompositeElement" = None, Region29: "sgraph_CompositeElement" = None):
        self.priority = priority
        self.Region = Region
        self.parentRegion = parentRegion if parentRegion is not None else set()
        self.regions = regions
        self.Region29 = Region29
    ...
    @property
    def Region29(self):
        return self.__Region29

    @Region29.setter
    def Region29(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_sgraph_Region__Region29", None)
        self.__Region29 = value
...
class ReactiveElement:
    ...
    pass
class sgraph_State(ScopedElement, RegularState, DocumentedElement, ReactiveElement, CompositeElement, SpecificationElement):
...
class sgraph_Statechart(NamedElement, ScopedElement, DocumentedElement, ReactiveElement, CompositeElement, SpecificationElement):
