...
def test_user_has_privateAttribute():
    assert hasattr(User, "privateAttribute")
    descriptor = None
...
def test_user_has_packageAttribute():
    assert hasattr(User, "packageAttribute")
    descriptor = None
    for klass in User.__mro__:
...
def test_user_has_protectedAttribute():
    assert hasattr(User, "protectedAttribute")
    descriptor = None
    for klass in User.__mro__:
...
def test_user_has_publicAttribute():
    assert hasattr(User, "publicAttribute")
    descriptor = None
    for klass in User.__mro__:
...
@given(instance=User_strategy)
def test_user_privateAttribute_setter(instance):
...
@given(instance=User_strategy)
def test_user_packageAttribute_setter(instance):
...
@given(instance=User_strategy)
def test_user_protectedAttribute_setter(instance):
...
@given(instance=User_strategy)
def test_user_publicAttribute_setter(instance):
