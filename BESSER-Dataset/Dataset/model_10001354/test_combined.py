...
def test_hyp_user_privateAttribute_setter(instance):
...
@given(instance=User_strategy)
def test_hyp_user_packageAttribute_setter(instance):
...
@given(instance=User_strategy)
def test_hyp_user_protectedAttribute_setter(instance):
...
@given(instance=User_strategy)
def test_hyp_user_publicAttribute_setter(instance):
...
def test_User_packageAttribute_value_roundtrip():
    instance = User(packageAttribute="sample_text", privateAttribute=7, protectedAttribute="sample_text", publicAttribute=3.14)
    assert instance.packageAttribute == "sample_text"
    instance.packageAttribute = "sample_text_2"
    assert instance.packageAttribute == "sample_text_2"


def test_User_privateAttribute_value_roundtrip():
    instance = User(packageAttribute="sample_text", privateAttribute=7, protectedAttribute="sample_text", publicAttribute=3.14)
    assert instance.privateAttribute == 7
    instance.privateAttribute = 13
    assert instance.privateAttribute == 13
...
def test_User_protectedAttribute_value_roundtrip():
    instance = User(packageAttribute="sample_text", privateAttribute=7, protectedAttribute="sample_text", publicAttribute=3.14)
    assert instance.protectedAttribute == "sample_text"
    instance.protectedAttribute = "sample_text_2"
    assert instance.protectedAttribute == "sample_text_2"
...
def test_User_publicAttribute_value_roundtrip():
    instance = User(packageAttribute="sample_text", privateAttribute=7, protectedAttribute="sample_text", publicAttribute=3.14)
    assert instance.publicAttribute == 3.14
    instance.publicAttribute = 9.99
    assert instance.publicAttribute == 9.99
...
User_strategy = st.builds(User, packageAttribute=safe_text, privateAttribute=st.integers(), protectedAttribute=safe_text, publicAttribute=st.floats(allow_nan=False, allow_infinity=False))
@given(instance=User_strategy)
@settings(max_examples=25)
