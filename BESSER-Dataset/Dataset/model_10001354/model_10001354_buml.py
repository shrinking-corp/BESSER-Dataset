...
ClassA.attributes={ClassA_packageAttribute, ClassA_publicAttribute, ClassA_protectedAttribute, ClassA_privateAttribute}
...
User_publicAttribute: Property = Property(name="publicAttribute", type=FloatType)
User_privateAttribute: Property = Property(name="privateAttribute", type=IntegerType)
User_protectedAttribute: Property = Property(name="protectedAttribute", type=StringType)
User_packageAttribute: Property = Property(name="packageAttribute", type=StringType)
User.attributes={User_privateAttribute, User_packageAttribute, User_publicAttribute, User_protectedAttribute}
...
domain_model = DomainModel(
    name="_1qYm0GJqEeqK2M3E1LfZ7Q",
    types={BankAccount, ClassA, ClassB, ClassC, ClassD, ClassE, ClassF, ClassG, ClassJ, ClassH, ClassK, ClassL, ClassM, ClassN, ClassP, InterfaceO_Interface, ClassQ, ClassR, ClassS, ClassT, ClassU, ClassV, User, Admin, Client},
