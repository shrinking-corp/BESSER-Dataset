...
fsm_Block_m_evalStatement: Method = Method(name="evalStatement", parameters={Parameter(name='fsm_context', type=StringType)})
...
domain_model = DomainModel(
    name="fsm",
    types={fsm_StateMachine, NamedElement, fsm_Region, fsm_AbstractState, fsm_Transition, fsm_State, AbstractState, fsm_Block, fsm_Trigger, fsm_Pseudostate, fsm_InitialState, Pseudostate, fsm_FinalState, State, fsm_NamedElement},
    associations={exitAction13, regions0, subvertex1, transitions2, ownerStateMachine3, incoming4, outgoing5, ownerRegion7, entryAction9, doAction10, trigger16, target18, source20},
    generalizations={gen_fsm_StateMachine_NamedElement, gen_fsm_Region_NamedElement, gen_fsm_AbstractState_NamedElement, gen_fsm_State_AbstractState, gen_fsm_Transition_NamedElement, gen_fsm_Pseudostate_AbstractState, gen_fsm_InitialState_Pseudostate, gen_fsm_FinalState_State},
    metadata=None
)
