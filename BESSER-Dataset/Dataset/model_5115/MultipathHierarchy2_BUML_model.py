...
# Classes
testPackage_SuperSuperClass = Class(name="testPackage_SuperSuperClass")
testPackage_SuperClass = Class(name="testPackage_SuperClass")
SuperSuperClass = Class(name="SuperSuperClass")
testPackage_DerivedClass = Class(name="testPackage_DerivedClass")
