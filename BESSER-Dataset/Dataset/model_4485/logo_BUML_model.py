...
kmLogo_Literal = Class(name="kmLogo_Literal")
Expression = Class(name="Expression")
kmLogo_IntegerLit = Class(name="kmLogo_IntegerLit")
Literal = Class(name="Literal")
kmLogo_StringLit = Class(name="kmLogo_StringLit")
kmLogo_LogoProgram = Class(name="kmLogo_LogoProgram")
kmLogo_VarDecl = Class(name="kmLogo_VarDecl")
...
kmLogo_VarReference = Class(name="kmLogo_VarReference")
kmLogo_BoolLit = Class(name="kmLogo_BoolLit")
kmLogo_ArithmeticExpression = Class(name="kmLogo_ArithmeticExpression")
kmLogo_RelationalExpression = Class(name="kmLogo_RelationalExpression")
...
domain_model = DomainModel(
    name="kmLogo",
    types={kmLogo_Left, kmLogo_Right, kmLogo_PenDown, kmLogo_PenUp, kmLogo_Clear, kmLogo_Literal, Expression, kmLogo_IntegerLit, Literal, kmLogo_StringLit, kmLogo_LogoProgram, kmLogo_VarDecl, kmLogo_Instruction, kmLogo_Primitive, Instruction, kmLogo_Back, Primitive, kmLogo_Expression, kmLogo_Forward, kmLogo_VarReference, kmLogo_BoolLit, kmLogo_ArithmeticExpression, kmLogo_RelationalExpression, RelationalOperator, ArithmeticOperator},
    associations={steps4, angle6, angle8, variables0, instructions1, steps3, left15, right17, expression20, left10, right12},
    generalizations={gen_kmLogo_Left_Primitive, gen_kmLogo_Right_Primitive, gen_kmLogo_PenDown_Primitive, gen_kmLogo_PenUp_Primitive, gen_kmLogo_Clear_Primitive, gen_kmLogo_Literal_Expression, gen_kmLogo_IntegerLit_Literal, gen_kmLogo_StringLit_Literal, gen_kmLogo_Primitive_Instruction, gen_kmLogo_Back_Primitive, gen_kmLogo_Forward_Primitive, gen_kmLogo_VarReference_Expression, gen_kmLogo_VarDecl_Instruction, gen_kmLogo_BoolLit_Literal, gen_kmLogo_ArithmeticExpression_Expression, gen_kmLogo_RelationalExpression_Expression},
    metadata=None
)
