...
AuthenticationUserPassword = Class(name="AuthenticationUserPassword")
...
JavaCloseable = Class(name="JavaCloseable")
...
core_CatalogContainer_m_createConnection: Method = Method(name="createConnection", parameters={Parameter(name='core_factory', type=StringType), Parameter(name='core_user', type=StringType), Parameter(name='core_password', type=StringType)})
...
core_CatalogContainer.attributes={core_CatalogContainer_supportsGuestAccess, core_CatalogContainer_name, core_CatalogContainer_active}
core_CatalogContainer.methods={core_CatalogContainer_m_createConnection, core_CatalogContainer_m_removeSchema, core_CatalogContainer_m_removeTable, core_CatalogContainer_m_removeIndex, core_CatalogContainer_m_loadSchema, core_CatalogContainer_m_loadView, core_CatalogContainer_m_getCatalogContext, core_CatalogContainer_m_getMetaData, core_CatalogContainer_m_loadIndex, core_CatalogContainer_m_removeView, core_CatalogContainer_m_loadTable, core_CatalogContainer_m_createConnection}
...
core_ConnectionConfig.attributes={core_ConnectionConfig_version, core_ConnectionConfig_catalog, core_ConnectionConfig_persistent, core_ConnectionConfig_url, core_ConnectionConfig_vendor}
...
core_CatalogMetaData_m_getIndex: Method = Method(name="getIndex", parameters={Parameter(name='core_table', type=StringType), Parameter(name='core_index', type=StringType), Parameter(name='core_schema', type=StringType)}, type=StringType)
...
core_CatalogMetaData_m_getTable: Method = Method(name="getTable", parameters={Parameter(name='core_table', type=StringType), Parameter(name='core_schema', type=StringType)}, type=StringType)
core_CatalogMetaData_m_getTable: Method = Method(name="getTable", parameters={Parameter(name='core_table', type=StringType), Parameter(name='core_contextDescription', type=StringType)}, type=StringType)
core_CatalogMetaData_m_getView: Method = Method(name="getView", parameters={Parameter(name='core_schema', type=StringType), Parameter(name='core_table', type=StringType)}, type=StringType)
core_CatalogMetaData.methods={core_CatalogMetaData_m_getIndex, core_CatalogMetaData_m_getView, core_CatalogMetaData_m_getSchemas, core_CatalogMetaData_m_getTable, core_CatalogMetaData_m_getTable, core_CatalogMetaData_m_getSchema}

# core_Connection class attributes and methods
core_Connection_m_close: Method = Method(name="close", parameters={})
core_Connection_m_close: Method = Method(name="close", parameters={Parameter(name='core_stmt', type=StringType)})
core_Connection_m_close: Method = Method(name="close", parameters={Parameter(name='core_rs', type=StringType)})
...
core_Connection_m_createStatement: Method = Method(name="createStatement", parameters={Parameter(name='core_updatable', type=StringType), Parameter(name='core_native', type=StringType)}, type=StringType)
...
core_Connection_m_prepareStatement: Method = Method(name="prepareStatement", parameters={Parameter(name='core_native', type=StringType), Parameter(name='core_sql', type=StringType)}, type=StringType)
core_Connection_m_prepareStatement: Method = Method(name="prepareStatement", parameters={Parameter(name='core_native', type=StringType), Parameter(name='core_updatable', type=StringType), Parameter(name='core_sql', type=StringType)}, type=StringType)
...
core_Connection.methods={core_Connection_m_getCatalogGenerationStrategy, core_Connection_m_close, core_Connection_m_close, core_Connection_m_setCatalog, core_Connection_m_createStatement, core_Connection_m_createStatement, core_Connection_m_getCatalog, core_Connection_m_createStatement, core_Connection_m_getCatalogMetaData, core_Connection_m_prepareStatement, core_Connection_m_translate, core_Connection_m_close, core_Connection_m_prepareStatement, core_Connection_m_prepareStatement}

# ContextProvider class attributes and methods

# core_ConnectionCredentials class attributes and methods

# AuthenticationUserPassword class attributes and methods

# core_ConnectionManager class attributes and methods
core_ConnectionManager_m_createConnection: Method = Method(name="createConnection", parameters={Parameter(name='core_context', type=StringType)}, type=StringType)
...
core_ConnectionManager_m_createConnection: Method = Method(name="createConnection", parameters={Parameter(name='core_catalog', type=StringType), Parameter(name='core_password', type=StringType), Parameter(name='core_user', type=StringType)}, type=StringType)
...
core_DatabaseObjectDef_label: Property = Property(name="label", type=StringType)
core_DatabaseObjectDef.attributes={core_DatabaseObjectDef_label}

# core_DatabaseManager class attributes and methods
core_DatabaseManager_m_dropIndex: Method = Method(name="dropIndex", parameters={Parameter(name='core_index', type=StringType), Parameter(name='core_connection', type=StringType)})
core_DatabaseManager_m_createIndex: Method = Method(name="createIndex", parameters={Parameter(name='core_index', type=StringType), Parameter(name='core_name', type=StringType), Parameter(name='core_connection', type=StringType), Parameter(name='core_table', type=StringType)}, type=StringType)
core_DatabaseManager_m_createSchema: Method = Method(name="createSchema", parameters={Parameter(name='core_connection', type=StringType), Parameter(name='core_schema', type=StringType), Parameter(name='core_name', type=StringType)}, type=StringType)
core_DatabaseManager_m_createTable: Method = Method(name="createTable", parameters={Parameter(name='core_connection', type=StringType), Parameter(name='core_table', type=StringType), Parameter(name='core_schema', type=StringType), Parameter(name='core_name', type=StringType)}, type=StringType)
core_DatabaseManager_m_createView: Method = Method(name="createView", parameters={Parameter(name='core_name', type=StringType), Parameter(name='core_view', type=StringType), Parameter(name='core_connection', type=StringType), Parameter(name='core_schema', type=StringType)}, type=StringType)
core_DatabaseManager_m_dropSchema: Method = Method(name="dropSchema", parameters={Parameter(name='core_schema', type=StringType), Parameter(name='core_ignoreFailOnNonEmpty', type=StringType), Parameter(name='core_connection', type=StringType)})
...
core_DatabaseManager_m_dropView: Method = Method(name="dropView", parameters={Parameter(name='core_view', type=StringType), Parameter(name='core_connection', type=StringType)})
core_DatabaseManager_m_renameTable: Method = Method(name="renameTable", parameters={Parameter(name='core_newName', type=StringType), Parameter(name='core_connection', type=StringType), Parameter(name='core_table', type=StringType)})
core_DatabaseManager_m_renameIndex: Method = Method(name="renameIndex", parameters={Parameter(name='core_connection', type=StringType), Parameter(name='core_newName', type=StringType), Parameter(name='core_index', type=StringType)})
core_DatabaseManager_m_hasLogicals: Method = Method(name="hasLogicals", parameters={Parameter(name='core_connection', type=StringType), Parameter(name='core_table', type=StringType)}, type=BooleanType)
core_DatabaseManager_m_isStarted: Method = Method(name="isStarted", parameters={}, type=BooleanType)
core_DatabaseManager_m_start: Method = Method(name="start", parameters={})
core_DatabaseManager.methods={core_DatabaseManager_m_createSchema, core_DatabaseManager_m_dropSchema, core_DatabaseManager_m_isStarted, core_DatabaseManager_m_start, core_DatabaseManager_m_createTable, core_DatabaseManager_m_createIndex, core_DatabaseManager_m_dropTable, core_DatabaseManager_m_createView, core_DatabaseManager_m_renameTable, core_DatabaseManager_m_dropView, core_DatabaseManager_m_hasLogicals, core_DatabaseManager_m_renameIndex, core_DatabaseManager_m_dropIndex}
...
core_IndexColumnDef.attributes={core_IndexColumnDef_sequence, core_IndexColumnDef_ordering, core_IndexColumnDef_name}
...
core_PreparedStatement_m_setObject: Method = Method(name="setObject", parameters={Parameter(name='core_value', type=StringType), Parameter(name='core_position', type=StringType)})
core_PreparedStatement.methods={core_PreparedStatement_m_executeUpdate, core_PreparedStatement_m_setInt, core_PreparedStatement_m_setString, core_PreparedStatement_m_execute, core_PreparedStatement_m_setObject, core_PreparedStatement_m_executeQuery, core_PreparedStatement_m_clearParameters, core_PreparedStatement_m_addBatch}
...
core_Statement.methods={core_Statement_m_executeUpdate, core_Statement_m_clearBatch, core_Statement_m_executeBatch, core_Statement_m_close, core_Statement_m_addBatch, core_Statement_m_execute, core_Statement_m_executeQuery}

# JavaCloseable class attributes and methods
...
core_TableColumnDef.attributes={core_TableColumnDef_default, core_TableColumnDef_nullable, core_TableColumnDef_name}
...
gen_core_ConnectionCredentials_AuthenticationUserPassword = Generalization(general=AuthenticationUserPassword, specific=core_ConnectionCredentials)
gen_core_DatabaseContainer_Object = Generalization(general=Object, specific=core_DatabaseContainer)
...
gen_core_Statement_JavaCloseable = Generalization(general=JavaCloseable, specific=core_Statement)
...
domain_model = DomainModel(
    name="core",
    types={core_CatalogContainer, core_ConnectionConfig, core_CatalogGenerationStrategy, core_CatalogMetaData, core_Connection, ContextProvider, core_ConnectionCredentials, AuthenticationUserPassword, core_ConnectionManager, core_DatabaseContainer, Object, core_DatabaseObjectDef, core_DatabaseManager, core_DataSourceFactory, core_IndexDef, DatabaseObjectDef, core_IndexColumnDef, core_PreparedStatement, Statement, core_QualifiedName, core_SchemaDef, core_Statement, JavaCloseable, core_TableDef, core_TableColumnDef, core_ViewDef, TableDef, OrderingType},
    associations={connectionConfig0, generationStrategy1, credentials3, catalogContainers5, defaultCatalogContainer7, columns10, columns11},
    generalizations={gen_core_Connection_ContextProvider, gen_core_ConnectionCredentials_AuthenticationUserPassword, gen_core_DatabaseContainer_Object, gen_core_IndexDef_DatabaseObjectDef, gen_core_IndexColumnDef_DatabaseObjectDef, gen_core_PreparedStatement_Statement, gen_core_ViewDef_TableDef, gen_core_SchemaDef_DatabaseObjectDef, gen_core_Statement_JavaCloseable, gen_core_TableDef_DatabaseObjectDef, gen_core_TableColumnDef_DatabaseObjectDef},
    metadata=None
)
