...
class Profile:
    ...
    def __init__(self, f_Name: str, l_Name: str, user_Name: str, password: str, Profile_Attendance_08: "Attendance" = None):
        self.f_Name = f_Name
        self.l_Name = l_Name
        self.user_Name = user_Name
        self.password = password
        self.Profile_Attendance_08 = Profile_Attendance_08
    ...
    @property
    def Profile_Attendance_08(self):
        return self.__Profile_Attendance_08
    @Profile_Attendance_08.setter
    def Profile_Attendance_08(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Profile__Profile_Attendance_08", None)
        self.__Profile_Attendance_08 = value
...
class Mail:
    ...
    def __init__(self, sendBy: str, subject: str, emailID: str, sendTo: str, superAdmin19: "SuperAdmin" = None, admin21: "Admin" = None):
        self.sendBy = sendBy
...
class Attendance:
    ...
    def profile9(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "Profile_Attendance_08"):
                opp_val = getattr(old_value, "Profile_Attendance_08", None)
                if opp_val == self:
                    setattr(old_value, "Profile_Attendance_08", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "Profile_Attendance_08"):
                opp_val = getattr(value, "Profile_Attendance_08", None)
                setattr(value, "Profile_Attendance_08", self)
...
class Calender_Event:
    ...
    def __init__(self, category: str, date: str, time: str, description: str, eventType: str, participantAmount: str, volunteer: Volunteer, nomarlUser: Normal_user, admin: Admin, Add_Edit_View1: set["Volunteer"] = None, Add_Edit_View3: set["Admin"] = None, Add_Edit_View5: "Normal_user" = None, Add_Edit_Vew7: set["SuperAdmin"] = None):
