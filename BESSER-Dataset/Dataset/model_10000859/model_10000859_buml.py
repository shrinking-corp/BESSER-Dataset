...
Profile.attributes={Profile_f_Name, Profile_user_Name, Profile_password, Profile_l_Name}
...
SuperAdmin.attributes={SuperAdmin_userID, SuperAdmin_userName, SuperAdmin_password}
...
Normal_user.attributes={Normal_user_userID, Normal_user_userName, Normal_user_password}
...
Volunteer.attributes={Volunteer_userName, Volunteer_userID, Volunteer_password}
...
Calender_Event.attributes={Calender_Event_nomarlUser, Calender_Event_category, Calender_Event_time, Calender_Event_description, Calender_Event_volunteer, Calender_Event_admin, Calender_Event_date, Calender_Event_participantAmount, Calender_Event_eventType}
...
Attendance.attributes={Attendance_checkOutTime, Attendance_checkInTime, Attendance_attendanceID}
...
Payment.attributes={Payment_issuerName, Payment_cardType, Payment_cardNumber, Payment_amount, Payment_expiryDate}
...
Mail.attributes={Mail_sendTo, Mail_sendBy, Mail_subject, Mail_emailID}
...
Profile_Attendance: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="Profile_Attendance_08", type=Attendance, multiplicity=Multiplicity(0, 1)),
...
domain_model = DomainModel(
    name="_69614804_b188_4e30_8d70_536c0e9fd368",
