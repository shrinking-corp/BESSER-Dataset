...
class HTML_INPUT:
    ...
    def __init__(self, name: str, type: str, align: str, maxlength: str, size: str, checked: str, src: str, inputValue: str):
        self.name = name
        self.type = type
        self.align = align
...
class HTML_TD(TABLEElement):
    ...
    def __init__(self, valign: str, align: str, width: str, colspan: str, rowspan: str, tds: "TR" = None):
        self.valign = valign
        self.align = align
        self.width = width
...
class HTML_TABLE(TABLEElement):
    ...
    def __init__(self, width: str, cellspacing: str, cellpadding: str, border: str, table: set["TR"] = None):
        self.width = width
...
class HTML_IMG(BODYElement):
    ...
    def __init__(self, width: str, height: str, alt: str, align: str, vspace: str, src: str, hspace: str, ismap: str, usemap: str, border: str, BODYElement: "HTML_BODY" = None):
        self.width = width
        self.height = height
        self.alt = alt
        self.align = align
...
class HTML_AREA(BODYElement):
    ...
    def __init__(self, coords: str, ahref: str, shape: str, BODYElement: "HTML_BODY" = None):
        self.coords = coords
        self.ahref = ahref
        self.shape = shape
