...
# Classes
z5fsm_Region = Class(name="z5fsm_Region")
z5fsm_State = Class(name="z5fsm_State")
AbstractState = Class(name="AbstractState")
z5fsm_AbstractState = Class(name="z5fsm_AbstractState", is_abstract=True)
...
domain_model = DomainModel(
    name="z5fsm",
    types={z5fsm_Region, z5fsm_State, AbstractState, z5fsm_AbstractState},
