...
# Classes
root_RootClass = Class(name="root_RootClass")
NestedClass1 = Class(name="NestedClass1")
root_nestedPackage1_NestedClass1 = Class(name="root_nestedPackage1_NestedClass1")
root_noLiterals_NoLitClass = Class(name="root_noLiterals_NoLitClass")
