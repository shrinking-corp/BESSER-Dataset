...
class dot_Attribute(Statement):
    ...
    def __init__(self, name: str, value: str, dot_Attribute14: "dot_EdgeStatement" = None, dot_Attribute21: "dot_AttributeStatement" = None, dot_Attribute: "dot_NodeStatement" = None):
        self.name = name
        self.value = value
...
class dot_Node:
    ...
    def __init__(self, name: str, dot_Node19: "dot_EdgeTarget" = None, dot_Node: "dot_NodeStatement" = None, dot_Node7: "dot_Port" = None, dot_Node9: "dot_EdgeStatement" = None):
        self.name = name
