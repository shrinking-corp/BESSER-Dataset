...
domain_model = DomainModel(
    name="dot",
    types={dot_GraphvizModel, dot_NodeStatement, dot_Node, dot_Port, dot_EdgeStatement, dot_EdgeTarget, dot_Subgraph, dot_AttributeStatement, dot_Graph, dot_Statement, dot_Attribute, Statement, EdgeOperator, GraphType, AttributeType},
    associations={node3, attributes4, port6, sourceNode8, edgeTargets10, attributes12, targetSubgraph15, targetnode17, attributes20, graphs0, statements22, statements1},
