...
class gmfgraph_FigureGallery(Identity):
    ...
    def __init__(self, implementationBundle: str, gmfgraph_FigureGallery10: set["gmfgraph_RealFigure"] = None, gmfgraph_FigureGallery12: set["gmfgraph_FigureDescriptor"] = None, gmfgraph_FigureGallery: "gmfgraph_Canvas" = None):
...
class gmfgraph_RealFigure(AbstractFigure):
    ...
    def __init__(self, name: str, gmfgraph_RealFigure30: "gmfgraph_FigureAccessor" = None, gmfgraph_RealFigure: "gmfgraph_FigureGallery" = None, gmfgraph_RealFigure72: "gmfgraph_FigureRef" = None, gmfgraph_RealFigure98: set["gmfgraph_Figure"] = None):
        self.name = name
...
class gmfgraph_GridLayoutData(LayoutData):
    ...
    def __init__(self, verticalSpan: int, horizontalSpan: int, horizontalIndent: int, verticalAlignment: str, horizontalAlignment: str, grabExcessHorizontalSpace: bool, grabExcessVerticalSpace: bool, gmfgraph_GridLayoutData: "gmfgraph_Dimension" = None):
...
class gmfgraph_Dimension:
    ...
    def __init__(self, dx: int, dy: int, gmfgraph_Dimension: "gmfgraph_GridLayoutData" = None, gmfgraph_Dimension48: "gmfgraph_Figure" = None, gmfgraph_Dimension51: "gmfgraph_Figure" = None, gmfgraph_Dimension54: "gmfgraph_Figure" = None, gmfgraph_Dimension84: "gmfgraph_GridLayout" = None, gmfgraph_Dimension94: "gmfgraph_XYLayoutData" = None, gmfgraph_Dimension96: "gmfgraph_DefaultSizeFacet" = None, gmfgraph_Dimension87: "gmfgraph_GridLayout" = None, gmfgraph_Dimension89: "gmfgraph_BorderLayout" = None):
        self.dx = dx
        self.dy = dy
...
class gmfgraph_DiagramLabel(Node):
    ...
    def __init__(self, external: bool, elementIcon: bool, gmfgraph_DiagramLabel23: "gmfgraph_ChildAccess" = None, gmfgraph_DiagramLabel26: "gmfgraph_ChildAccess" = None, gmfgraph_DiagramLabel: "gmfgraph_Canvas" = None):
...
class gmfgraph_ChildAccess:
    ...
    def __init__(self, accessor: str, gmfgraph_ChildAccess24: "gmfgraph_DiagramLabel" = None, gmfgraph_ChildAccess27: "gmfgraph_DiagramLabel" = None, gmfgraph_ChildAccess: "gmfgraph_Node" = None, gmfgraph_ChildAccess21: "gmfgraph_Compartment" = None, gmfgraph_ChildAccess101: "gmfgraph_Figure" = None, accessors: "gmfgraph_FigureDescriptor" = None, ChildAccess: "gmfgraph_FigureDescriptor" = None):
        self.accessor = accessor
