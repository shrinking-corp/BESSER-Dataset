...
public class gmfgraph_GridLayoutData extends LayoutData {
    ...
    public gmfgraph_GridLayoutData(
        boolean grabExcessVerticalSpace,        int verticalSpan,        int horizontalIndent,        boolean grabExcessHorizontalSpace,        int horizontalSpan,        String verticalAlignment,        String horizontalAlignment    ) {
        super(
        );
