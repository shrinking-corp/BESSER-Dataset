...
public class gmfgraph_Canvas extends Identity {
    ...
    public gmfgraph_Canvas(
        ArrayList<gmfgraph_DiagramLabel> gmfgraph_diagramlabels,        ArrayList<gmfgraph_Node> gmfgraph_nodes,        ArrayList<gmfgraph_Connection> gmfgraph_connections,        ArrayList<gmfgraph_Compartment> gmfgraph_compartments    ) {
