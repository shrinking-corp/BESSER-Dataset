...
# Classes
genericTest_A = Class(name="genericTest_A")
genericTest_SomeType = Class(name="genericTest_SomeType")
genericTest_B = Class(name="genericTest_B")
genericTest_C = Class(name="genericTest_C")
genericTest_D = Class(name="genericTest_D")
genericTest_OtherType = Class(name="genericTest_OtherType")
