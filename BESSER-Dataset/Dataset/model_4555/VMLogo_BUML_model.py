...
# Classes
kmLogo_VM_Turtle = Class(name="kmLogo_VM_Turtle")
Point = Class(name="Point")
Segment = Class(name="Segment")
kmLogo_VM_Point = Class(name="kmLogo_VM_Point")
kmLogo_VM_Segment = Class(name="kmLogo_VM_Segment")
...
kmLogo_VM_Turtle.attributes={kmLogo_VM_Turtle_heading, kmLogo_VM_Turtle_penUp}
...
kmLogo_VM_Point.attributes={kmLogo_VM_Point_y, kmLogo_VM_Point_x}
