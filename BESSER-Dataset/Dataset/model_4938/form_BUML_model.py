...
# Classes
fml_Form = Class(name="fml_Form")
fml_Page = Class(name="fml_Page")
fml_DisplayElement = Class(name="fml_DisplayElement", is_abstract=True)
PageElement = Class(name="PageElement")
fml_Heading = Class(name="fml_Heading")
DisplayElement = Class(name="DisplayElement")
fml_TextParagraph = Class(name="fml_TextParagraph")
fml_List = Class(name="fml_List")
fml_ListItem = Class(name="fml_ListItem")
fml_InputElement = Class(name="fml_InputElement", is_abstract=True)
fml_TextInput = Class(name="fml_TextInput")
InputElement = Class(name="InputElement")
fml_SelectField = Class(name="fml_SelectField")
fml_PageElement = Class(name="fml_PageElement", is_abstract=True)
fml_SelectionItem = Class(name="fml_SelectionItem")
...
fml_Page.attributes={fml_Page_isWelcome, fml_Page_Title}
...
fml_Heading.attributes={fml_Heading_Text, fml_Heading_Level}
...
fml_TextInput.attributes={fml_TextInput_Content, fml_TextInput_Type, fml_TextInput_Label}
...
domain_model = DomainModel(
    name="fml",
    types={fml_Form, fml_Page, fml_DisplayElement, PageElement, fml_Heading, DisplayElement, fml_TextParagraph, fml_List, fml_ListItem, fml_InputElement, fml_TextInput, InputElement, fml_SelectField, fml_PageElement, fml_SelectionItem, TextInputType, SelectionType},
    associations={organized0, predecessor2, consists7, consists4, contained5, visibleIfSelected6, contained11, displayElementVisible13, consists8},
