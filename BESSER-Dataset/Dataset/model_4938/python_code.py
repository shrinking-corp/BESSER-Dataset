...
class fml_SelectionItem:
    ...
    def __init__(self, Text: str, preselected: bool, selected: bool, visibleIfSelected: set["fml_PageElement"] = None, SelectionItem10: "fml_SelectField" = None, SelectionItem: "fml_PageElement" = None, consists12: "fml_SelectField" = None):
        self.Text = Text
...
class fml_PageElement(ABC):
    ...
    def __init__(self, ID: str, PageElement14: "fml_SelectionItem" = None, PageElement: "fml_Page" = None, consists: "fml_Page" = None, displayElementVisible: set["fml_SelectionItem"] = None):
        self.ID = ID
...
class fml_SelectField(InputElement):
    ...
    def __init__(self, Label: str, Type: str, contained9: set["fml_SelectionItem"] = None, SelectField: "fml_SelectionItem" = None):
        self.Label = Label
        self.Type = Type
...
class fml_Page:
    ...
    def __init__(self, Title: str, isWelcome: bool, fml_Page: "fml_Form" = None, fml_Page3: "fml_Page" = None, fml_Page1: "fml_Page" = None, contained: set["fml_PageElement"] = None, Page: "fml_PageElement" = None):
        self.Title = Title
