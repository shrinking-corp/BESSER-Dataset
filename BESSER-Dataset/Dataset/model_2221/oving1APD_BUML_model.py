...
# Classes
oving1APD_Specialization = Class(name="oving1APD_Specialization")
oving1APD_Semester = Class(name="oving1APD_Semester")
oving1APD_Department = Class(name="oving1APD_Department")
oving1APD_StudyProgram = Class(name="oving1APD_StudyProgram")
oving1APD_Course = Class(name="oving1APD_Course")
oving1APD_Slot = Class(name="oving1APD_Slot")
...
oving1APD_Department.attributes={oving1APD_Department_shortName, oving1APD_Department_name}
...
oving1APD_Course.attributes={oving1APD_Course_name, oving1APD_Course_credit, oving1APD_Course_code, oving1APD_Course_level}
...
domain_model = DomainModel(
    name="oving1APD",
    types={oving1APD_Specialization, oving1APD_Semester, oving1APD_Department, oving1APD_StudyProgram, oving1APD_Course, oving1APD_Slot},
    associations={specialization2, semester3, department5, courseInSemester7, specialization9, studyProgram0, course1, semester32, slot11, hasCourse13, slot14, studyProgram16, specialization19, semester22, course24, studyProgram27, course30},
    generalizations={},
    metadata=None
)
