...
class oving1APD_Slot:
    ...
    def __init__(self, name: str, slot33: "oving1APD_Semester" = None, Slot: "oving1APD_Course" = None, Slot15: "oving1APD_Semester" = None, slot: "oving1APD_Course" = None):
        self.name = name
        self.slot33 = slot33
        self.Slot = Slot
        self.Slot15 = Slot15
...
class oving1APD_Course:
    ...
    def __init__(self, name: str, credit: float, code: str, level: int, hasCourse: set["oving1APD_Semester"] = None, course: "oving1APD_Specialization" = None, oving1APD_Course: "oving1APD_Department" = None, course12: "oving1APD_Slot" = None, Course: "oving1APD_Semester" = None, Course26: "oving1APD_Specialization" = None, Course31: "oving1APD_Slot" = None):
        self.name = name
        self.credit = credit
        self.code = code
        self.level = level
...
class oving1APD_StudyProgram:
    ...
    def __init__(self, shortName: str, name: str, studyProgram: set["oving1APD_Specialization"] = None, studyProgram4: "oving1APD_Semester" = None, studyProgram6: "oving1APD_Department" = None, StudyProgram: "oving1APD_Department" = None, StudyProgram18: "oving1APD_Semester" = None, StudyProgram29: "oving1APD_Specialization" = None):
...
class oving1APD_Department:
    ...
    def __init__(self, name: str, shortName: str, Department: "oving1APD_StudyProgram" = None, department: set["oving1APD_StudyProgram"] = None, oving1APD_Department: set["oving1APD_Course"] = None):
        self.name = name
        self.shortName = shortName
...
class oving1APD_Semester:
    ...
    def __init__(self, number: int, semester20: "oving1APD_Specialization" = None, Semester23: "oving1APD_Specialization" = None, Semester: "oving1APD_StudyProgram" = None, Semester8: "oving1APD_Course" = None, Semester34: "oving1APD_Slot" = None, courseInSemester: set["oving1APD_Course"] = None, semester: "oving1APD_Slot" = None, semester17: "oving1APD_StudyProgram" = None):
        self.number = number
...
class oving1APD_Specialization:
    ...
    def __init__(self, name: str, Specialization21: "oving1APD_Semester" = None, specialization: "oving1APD_Semester" = None, Specialization: "oving1APD_StudyProgram" = None, Specialization10: "oving1APD_Course" = None, specialization25: set["oving1APD_Course"] = None, specialization28: "oving1APD_StudyProgram" = None):
        self.name = name
