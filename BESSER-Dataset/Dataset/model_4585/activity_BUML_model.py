...
# Classes
activity_ActivityNode = Class(name="activity_ActivityNode", is_abstract=True)
activity_Activity = Class(name="activity_Activity")
activity_ActivityEdge = Class(name="activity_ActivityEdge", is_abstract=True)
activity_InterruptibleActivityRegion = Class(name="activity_InterruptibleActivityRegion")
activity_NamedElement = Class(name="activity_NamedElement", is_abstract=True)
activity_ActivityParameterNode = Class(name="activity_ActivityParameterNode")
activity_ActivityPartition = Class(name="activity_ActivityPartition")
activity_ActivityGroup = Class(name="activity_ActivityGroup", is_abstract=True)
Activity = Class(name="Activity")
NamedElement = Class(name="NamedElement")
ActivityGroup = Class(name="ActivityGroup")
activity_Pin = Class(name="activity_Pin", is_abstract=True)
ObjectNode = Class(name="ObjectNode")
activity_Object = Class(name="activity_Object")
activity_CentralBufferNode = Class(name="activity_CentralBufferNode")
activity_ControlNode = Class(name="activity_ControlNode", is_abstract=True)
ActivityNode = Class(name="ActivityNode")
activity_InitialNode = Class(name="activity_InitialNode")
ControlNode = Class(name="ControlNode")
activity_FinalNode = Class(name="activity_FinalNode", is_abstract=True)
activity_ForkNode = Class(name="activity_ForkNode")
activity_JoinNode = Class(name="activity_JoinNode")
activity_Connector = Class(name="activity_Connector")
activity_MergeNode = Class(name="activity_MergeNode")
activity_DecisionNode = Class(name="activity_DecisionNode")
activity_FlowFinalNode = Class(name="activity_FlowFinalNode")
FinalNode = Class(name="FinalNode")
activity_ActivityFinalNode = Class(name="activity_ActivityFinalNode")
activity_ExecutableNode = Class(name="activity_ExecutableNode", is_abstract=True)
activity_Action = Class(name="activity_Action")
ExecutableNode = Class(name="ExecutableNode")
activity_OutputPin = Class(name="activity_OutputPin")
activity_InputPin = Class(name="activity_InputPin")
activity_SendSignalAction = Class(name="activity_SendSignalAction")
activity_AcceptTimeEventAction = Class(name="activity_AcceptTimeEventAction")
activity_AcceptEventAction = Class(name="activity_AcceptEventAction")
Pin = Class(name="Pin")
activity_ObjectNode = Class(name="activity_ObjectNode", is_abstract=True)
activity_DataStoreNode = Class(name="activity_DataStoreNode")
activity_ControlFlow = Class(name="activity_ControlFlow")
ActivityEdge = Class(name="ActivityEdge")
activity_ObjectFlow = Class(name="activity_ObjectFlow")
activity_InterruptEdge = Class(name="activity_InterruptEdge")
...
domain_model = DomainModel(
    name="activity",
    types={activity_ActivityNode, activity_Activity, activity_ActivityEdge, activity_InterruptibleActivityRegion, activity_NamedElement, activity_ActivityParameterNode, activity_ActivityPartition, activity_ActivityGroup, Activity, NamedElement, ActivityGroup, activity_Pin, ObjectNode, activity_Object, activity_CentralBufferNode, activity_ControlNode, ActivityNode, activity_InitialNode, ControlNode, activity_FinalNode, activity_ForkNode, activity_JoinNode, activity_Connector, activity_MergeNode, activity_DecisionNode, activity_FlowFinalNode, FinalNode, activity_ActivityFinalNode, activity_ExecutableNode, activity_Action, ExecutableNode, activity_OutputPin, activity_InputPin, activity_SendSignalAction, activity_AcceptTimeEventAction, activity_AcceptEventAction, Pin, activity_ObjectNode, activity_DataStoreNode, activity_ControlFlow, ActivityEdge, activity_ObjectFlow, activity_InterruptEdge},
    associations={edges0, nodes1, activityparameternode3, activityPartion5, activityGroups7, inBorder9, target12, source13, incoming15, outgoing16, activityPartions19, connected22, output23, input24},
    generalizations={gen_activity_InterruptibleActivityRegion_ActivityGroup, gen_activity_ActivityGroup_Activity, gen_activity_ActivityParameterNode_Activity, gen_activity_ActivityEdge_NamedElement, gen_activity_ActivityNode_NamedElement, gen_activity_ActivityPartition_ActivityGroup, gen_activity_Pin_ObjectNode, gen_activity_Object_ObjectNode, gen_activity_CentralBufferNode_ObjectNode, gen_activity_ControlNode_ActivityNode, gen_activity_InitialNode_ControlNode, gen_activity_FinalNode_ControlNode, gen_activity_ForkNode_ControlNode, gen_activity_JoinNode_ControlNode, gen_activity_Connector_ControlNode, gen_activity_MergeNode_ControlNode, gen_activity_DecisionNode_ControlNode, gen_activity_FlowFinalNode_FinalNode, gen_activity_ActivityFinalNode_FinalNode, gen_activity_ExecutableNode_ActivityNode, gen_activity_Action_ExecutableNode, gen_activity_SendSignalAction_ExecutableNode, gen_activity_AcceptTimeEventAction_ExecutableNode, gen_activity_AcceptEventAction_ExecutableNode, gen_activity_InputPin_Pin, gen_activity_OutputPin_Pin, gen_activity_ObjectNode_ActivityNode, gen_activity_DataStoreNode_ObjectNode, gen_activity_ControlFlow_ActivityEdge, gen_activity_ObjectFlow_ActivityEdge, gen_activity_InterruptEdge_ActivityEdge},
    metadata=None
)
