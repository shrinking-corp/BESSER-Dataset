...
class spem_uma_DeliveryProcess(Process):
    ...
    def __init__(self, scale: str, projectCharacteristics: str, riskLevel: str, estimatingTechnique: str, projectMemberExpertise: str, typeOfContract: str, spem_uma_DeliveryProcess: set["SupportingMaterial"] = None, spem_uma_DeliveryProcess186: set["SupportingMaterial"] = None, Process203: "spem_uma_ProcessPlanningTemplate" = None, Process: "spem_uma_Discipline" = None):
        self.scale = scale
...
class spem_WorkProductPort(ProcessElement):
    ...
    def __init__(self, isOptional: bool, portKind: str, spem_WorkProductPort178: "spem_WorkProductPortConnector" = None, spem_WorkProductPort: "spem_ProcessComponent" = None, spem_WorkProductPort136: "spem_ProcessComponentUse" = None, spem_WorkProductPort175: "spem_WorkProductDefinition" = None):
...
class spem_Default_TaskDefinitionParameter(WorkDefinitionParameter):
    ...
    def __init__(self, optionality: str, name: str, spem_Default_TaskDefinitionParameter: "spem_TaskDefinition" = None, spem_Default_TaskDefinitionParameter98: "spem_WorkProductDefinition" = None):
...
class VariabilityElement:
    ...
    pass
class spem_MethodContentElement(VariabilityElement, MethodContentPackageableElement, DescribableElement):
...
class WorkDefinition:
    ...
    pass
class spem_Step(WorkDefinition, VariabilityElement, DescribableElement):
...
class spem_TaskDefinition(WorkDefinition, MethodContentElement):
    ...
    pass
class spem_Activity(WorkDefinition, VariabilityElement, WorkBreakdownElement):

    def __init__(self, useKind: str, isEnactable: bool, spem_Activity22: "spem_MethodConfiguration" = None, spem_Activity24: set["spem_MethodConfiguration"] = None, spem_Activity29: "spem_ProcessPerformer" = None, spem_Activity14: set["spem_BreakdownElement"] = None, spem_Activity17: set["spem_BreakdownElement"] = None, spem_Activity20: set["spem_ProcessParameter"] = None, spem_Activity: "spem_Activity" = None, spem_Activity11: "spem_Activity" = None, spem_Activity129: "spem_ProcessComponent" = None):
