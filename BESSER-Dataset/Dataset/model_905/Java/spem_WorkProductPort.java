...
public class spem_WorkProductPort extends ProcessElement {
    ...
    private spem_ProcessComponent spem_processcomponent;
    ...
    public spem_ProcessComponent getSpem_processcomponent() {
        return spem_processcomponent;
    }

    public void setSpem_processcomponent(spem_ProcessComponent spem_processcomponent) {
        this.spem_processcomponent = spem_processcomponent;
    }
