...
class timedAutomata_core_ComplexSystem(System):
    ...
    def __init__(self, operator: str, timedAutomata_core_ComplexSystem: "System" = None, timedAutomata_core_ComplexSystem218: "System" = None, System219: "timedAutomata_core_ComplexSystem" = None, System: "timedAutomata_core_SystemDefinition" = None, System216: "timedAutomata_core_ComplexSystem" = None):
...
class core_TAElement:
    ...
    pass
class timedAutomata_core_Template(base_Identifyable, core_TAElement, base_Nameable):
...
class timedAutomata_expressions_AssignmentExpression(Expression):
    ...
    def __init__(self, operator: str, timedAutomata_expressions_AssignmentExpression19: "expressions_Expression" = None, timedAutomata_expressions_AssignmentExpression: "expressions_Expression" = None):
        self.operator = operator
...
class timedAutomata_core_Selections(Position):
    ...
    pass
class timedAutomata_core_Edge(core_TAElement, Position):

    pass
class timedAutomata_core_Updates(Position):

    pass
class timedAutomata_core_Location(core_TAElement, Position):
