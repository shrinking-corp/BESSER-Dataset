...
public class timedAutomata_core_Template extends base_Identifyable, core_TAElement, base_Nameable {
    ...
    public timedAutomata_core_Template(
        ArrayList<Edge> edges,        ArrayList<declarations_Declaration> declarations_declarations    ) {
        this.edges = edges;
