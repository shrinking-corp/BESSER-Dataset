...
# Classes
arduinoDSL_Program = Class(name="arduinoDSL_Program")
arduinoDSL_EObject = Class(name="arduinoDSL_EObject")
arduinoDSL_Rule = Class(name="arduinoDSL_Rule")
arduinoDSL_BooleanExpression = Class(name="arduinoDSL_BooleanExpression")
arduinoDSL_RuleBody = Class(name="arduinoDSL_RuleBody")
arduinoDSL_NumberExpression = Class(name="arduinoDSL_NumberExpression")
arduinoDSL_BooleanExpressionBlock = Class(name="arduinoDSL_BooleanExpressionBlock")
BooleanExpression = Class(name="BooleanExpression")
arduinoDSL_BooleanOperator = Class(name="arduinoDSL_BooleanOperator")
arduinoDSL_CompareOperator = Class(name="arduinoDSL_CompareOperator")
arduinoDSL_NumberExpressionBlock = Class(name="arduinoDSL_NumberExpressionBlock")
NumberExpression = Class(name="NumberExpression")
arduinoDSL_Attribute = Class(name="arduinoDSL_Attribute")
Value = Class(name="Value")
arduinoDSL_Node = Class(name="arduinoDSL_Node")
arduinoDSL_Component = Class(name="arduinoDSL_Component")
arduinoDSL_Delta = Class(name="arduinoDSL_Delta")
arduinoDSL_BooleanLiteral = Class(name="arduinoDSL_BooleanLiteral")
arduinoDSL_NumberLiteral = Class(name="arduinoDSL_NumberLiteral")
arduinoDSL_State = Class(name="arduinoDSL_State")
arduinoDSL_SimpleStatement = Class(name="arduinoDSL_SimpleStatement")
arduinoDSL_Assignment = Class(name="arduinoDSL_Assignment")
SimpleStatement = Class(name="SimpleStatement")
arduinoDSL_Value = Class(name="arduinoDSL_Value")
arduinoDSL_VariableDeclaration = Class(name="arduinoDSL_VariableDeclaration")
arduinoDSL_Cast = Class(name="arduinoDSL_Cast")
arduinoDSL_VariableReference = Class(name="arduinoDSL_VariableReference")
arduinoDSL_NodeDefinition = Class(name="arduinoDSL_NodeDefinition")
arduinoDSL_Board = Class(name="arduinoDSL_Board")
arduinoDSL_ComponentBody = Class(name="arduinoDSL_ComponentBody")
arduinoDSL_Rate = Class(name="arduinoDSL_Rate")
arduinoDSL_Map = Class(name="arduinoDSL_Map")
arduinoDSL_Smoothing = Class(name="arduinoDSL_Smoothing")
arduinoDSL_Range = Class(name="arduinoDSL_Range")
arduinoDSL_AndOr = Class(name="arduinoDSL_AndOr")
arduinoDSL_Comparison = Class(name="arduinoDSL_Comparison")
arduinoDSL_And = Class(name="arduinoDSL_And")
BooleanOperator = Class(name="BooleanOperator")
arduinoDSL_Or = Class(name="arduinoDSL_Or")
arduinoDSL_Equals = Class(name="arduinoDSL_Equals")
CompareOperator = Class(name="CompareOperator")
arduinoDSL_NotEquals = Class(name="arduinoDSL_NotEquals")
arduinoDSL_GreaterThanEquals = Class(name="arduinoDSL_GreaterThanEquals")
arduinoDSL_SmallerThanEquals = Class(name="arduinoDSL_SmallerThanEquals")
arduinoDSL_Smaller = Class(name="arduinoDSL_Smaller")
arduinoDSL_Plus = Class(name="arduinoDSL_Plus")
arduinoDSL_Minus = Class(name="arduinoDSL_Minus")
arduinoDSL_Mult = Class(name="arduinoDSL_Mult")
arduinoDSL_Div = Class(name="arduinoDSL_Div")
arduinoDSL_Greater = Class(name="arduinoDSL_Greater")
arduinoDSL_Mod = Class(name="arduinoDSL_Mod")
arduinoDSL_IfStatement = Class(name="arduinoDSL_IfStatement")
arduinoDSL_ElseIfStatement = Class(name="arduinoDSL_ElseIfStatement")
arduinoDSL_ElseStatement = Class(name="arduinoDSL_ElseStatement")
arduinoDSL_VarRef = Class(name="arduinoDSL_VarRef")
...
arduinoDSL_Range.attributes={arduinoDSL_Range_low, arduinoDSL_Range_high}
...
in_38: BinaryAssociation = BinaryAssociation(
    name="in_38",
    ends={
...
else_90: BinaryAssociation = BinaryAssociation(
    name="else_90",
    ends={
...
else_101: BinaryAssociation = BinaryAssociation(
    name="else_101",
    ends={
...
domain_model = DomainModel(
    name="arduinoDSL",
    types={arduinoDSL_Program, arduinoDSL_EObject, arduinoDSL_Rule, arduinoDSL_BooleanExpression, arduinoDSL_RuleBody, arduinoDSL_NumberExpression, arduinoDSL_BooleanExpressionBlock, BooleanExpression, arduinoDSL_BooleanOperator, arduinoDSL_CompareOperator, arduinoDSL_NumberExpressionBlock, NumberExpression, arduinoDSL_Attribute, Value, arduinoDSL_Node, arduinoDSL_Component, arduinoDSL_Delta, arduinoDSL_BooleanLiteral, arduinoDSL_NumberLiteral, arduinoDSL_State, arduinoDSL_SimpleStatement, arduinoDSL_Assignment, SimpleStatement, arduinoDSL_Value, arduinoDSL_VariableDeclaration, arduinoDSL_Cast, arduinoDSL_VariableReference, arduinoDSL_NodeDefinition, arduinoDSL_Board, arduinoDSL_ComponentBody, arduinoDSL_Rate, arduinoDSL_Map, arduinoDSL_Smoothing, arduinoDSL_Range, arduinoDSL_AndOr, arduinoDSL_Comparison, arduinoDSL_And, BooleanOperator, arduinoDSL_Or, arduinoDSL_Equals, CompareOperator, arduinoDSL_NotEquals, arduinoDSL_GreaterThanEquals, arduinoDSL_SmallerThanEquals, arduinoDSL_Smaller, arduinoDSL_Plus, arduinoDSL_Minus, arduinoDSL_Mult, arduinoDSL_Div, arduinoDSL_Greater, arduinoDSL_Mod, arduinoDSL_IfStatement, arduinoDSL_ElseIfStatement, arduinoDSL_ElseStatement, arduinoDSL_VarRef, VariableReference},
    associations={program0, condition1, body2, block4, block6, name7, component8, attr10, statements12, value16, cast19, value20, board23, node24, attribute14, properties30, rate32, map34, smoothing36, in_38, out40, components27, left43, operator45, right47, left50, operator52, right54, left57, right59, left62, right64, left67, right69, left72, right74, left77, right79, condition82, statements84, elseif87, else_90, statements95, elseif98, else_101, statements104, ref106, cast108, value111, condition93},
    generalizations={gen_arduinoDSL_BooleanExpressionBlock_BooleanExpression, gen_arduinoDSL_NumberExpressionBlock_NumberExpression, gen_arduinoDSL_Attribute_Value, gen_arduinoDSL_Delta_Value, gen_arduinoDSL_NumberLiteral_Value, gen_arduinoDSL_Assignment_SimpleStatement, gen_arduinoDSL_Value_NumberExpression, gen_arduinoDSL_VariableDeclaration_SimpleStatement, gen_arduinoDSL_VariableReference_Value, gen_arduinoDSL_VariableReference_SimpleStatement, gen_arduinoDSL_AndOr_BooleanExpression, gen_arduinoDSL_Comparison_BooleanExpression, gen_arduinoDSL_And_BooleanOperator, gen_arduinoDSL_Or_BooleanOperator, gen_arduinoDSL_Equals_CompareOperator, gen_arduinoDSL_NotEquals_CompareOperator, gen_arduinoDSL_GreaterThanEquals_CompareOperator, gen_arduinoDSL_SmallerThanEquals_CompareOperator, gen_arduinoDSL_Smaller_CompareOperator, gen_arduinoDSL_Plus_NumberExpression, gen_arduinoDSL_Minus_NumberExpression, gen_arduinoDSL_Mult_NumberExpression, gen_arduinoDSL_Div_NumberExpression, gen_arduinoDSL_Greater_CompareOperator, gen_arduinoDSL_Mod_NumberExpression, gen_arduinoDSL_IfStatement_SimpleStatement, gen_arduinoDSL_ElseIfStatement_SimpleStatement, gen_arduinoDSL_ElseStatement_SimpleStatement, gen_arduinoDSL_VarRef_VariableReference},
    metadata=None
)
