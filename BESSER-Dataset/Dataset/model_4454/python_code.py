...
class arduinoDSL_Cast:
    ...
    def __init__(self, castType: str, arduinoDSL_Cast110: "arduinoDSL_VarRef" = None, arduinoDSL_Cast: "arduinoDSL_VariableDeclaration" = None):
...
class arduinoDSL_VariableDeclaration(SimpleStatement):
    ...
    def __init__(self, type: str, name: str, arduinoDSL_VariableDeclaration107: "arduinoDSL_VarRef" = None, arduinoDSL_VariableDeclaration: "arduinoDSL_Cast" = None, arduinoDSL_VariableDeclaration21: "arduinoDSL_EObject" = None):
        self.type = type
        self.name = name
...
class arduinoDSL_Component:
    ...
    def __init__(self, name: str, arduinoDSL_Component: "arduinoDSL_Attribute" = None, arduinoDSL_Component31: "arduinoDSL_ComponentBody" = None, arduinoDSL_Component29: "arduinoDSL_Node" = None):
        self.name = name
...
class Value:
    ...
    pass
class arduinoDSL_VariableReference(Value, SimpleStatement):
