...
def test_hyp_arduinodsl_varref_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_VarRef)


def test_hyp_arduinodsl_varref_constructor_exists():
    assert callable(arduinoDSL_VarRef.__init__)


def test_hyp_arduinodsl_varref_constructor_args():
    sig = inspect.signature(arduinoDSL_VarRef.__init__)
    params = list(sig.parameters.keys())



def test_hyp_compareoperator_is_not_abstract():
    assert not inspect.isabstract(CompareOperator)


def test_hyp_compareoperator_constructor_exists():
    assert callable(CompareOperator.__init__)


def test_hyp_compareoperator_constructor_args():
    sig = inspect.signature(CompareOperator.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_notequals_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_NotEquals)


def test_hyp_arduinodsl_notequals_constructor_exists():
    assert callable(arduinoDSL_NotEquals.__init__)


def test_hyp_arduinodsl_notequals_constructor_args():
    sig = inspect.signature(arduinoDSL_NotEquals.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_greaterthanequals_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_GreaterThanEquals)


def test_hyp_arduinodsl_greaterthanequals_constructor_exists():
    assert callable(arduinoDSL_GreaterThanEquals.__init__)


def test_hyp_arduinodsl_greaterthanequals_constructor_args():
    sig = inspect.signature(arduinoDSL_GreaterThanEquals.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_smaller_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_Smaller)


def test_hyp_arduinodsl_smaller_constructor_exists():
    assert callable(arduinoDSL_Smaller.__init__)


def test_hyp_arduinodsl_smaller_constructor_args():
    sig = inspect.signature(arduinoDSL_Smaller.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_smallerthanequals_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_SmallerThanEquals)


def test_hyp_arduinodsl_smallerthanequals_constructor_exists():
    assert callable(arduinoDSL_SmallerThanEquals.__init__)


def test_hyp_arduinodsl_smallerthanequals_constructor_args():
    sig = inspect.signature(arduinoDSL_SmallerThanEquals.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_greater_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_Greater)


def test_hyp_arduinodsl_greater_constructor_exists():
    assert callable(arduinoDSL_Greater.__init__)


def test_hyp_arduinodsl_greater_constructor_args():
    sig = inspect.signature(arduinoDSL_Greater.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_equals_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_Equals)


def test_hyp_arduinodsl_equals_constructor_exists():
    assert callable(arduinoDSL_Equals.__init__)


def test_hyp_arduinodsl_equals_constructor_args():
...
def test_hyp_arduinodsl_or_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_Or)


def test_hyp_arduinodsl_or_constructor_exists():
    assert callable(arduinoDSL_Or.__init__)


def test_hyp_arduinodsl_or_constructor_args():
    sig = inspect.signature(arduinoDSL_Or.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_and_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_And)


def test_hyp_arduinodsl_and_constructor_exists():
    assert callable(arduinoDSL_And.__init__)


def test_hyp_arduinodsl_and_constructor_args():
    sig = inspect.signature(arduinoDSL_And.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_range_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_Range)


def test_hyp_arduinodsl_range_constructor_exists():
    assert callable(arduinoDSL_Range.__init__)


def test_hyp_arduinodsl_range_constructor_args():
...
def test_hyp_arduinodsl_smoothing_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_Smoothing)


def test_hyp_arduinodsl_smoothing_constructor_exists():
    assert callable(arduinoDSL_Smoothing.__init__)


def test_hyp_arduinodsl_smoothing_constructor_args():
...
def test_hyp_arduinodsl_map_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_Map)


def test_hyp_arduinodsl_map_constructor_exists():
    assert callable(arduinoDSL_Map.__init__)


def test_hyp_arduinodsl_map_constructor_args():
    sig = inspect.signature(arduinoDSL_Map.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_rate_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_Rate)


def test_hyp_arduinodsl_rate_constructor_exists():
    assert callable(arduinoDSL_Rate.__init__)


def test_hyp_arduinodsl_rate_constructor_args():
...
def test_hyp_arduinodsl_componentbody_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_ComponentBody)


def test_hyp_arduinodsl_componentbody_constructor_exists():
    assert callable(arduinoDSL_ComponentBody.__init__)


def test_hyp_arduinodsl_componentbody_constructor_args():
...
def test_hyp_arduinodsl_board_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_Board)


def test_hyp_arduinodsl_board_constructor_exists():
    assert callable(arduinoDSL_Board.__init__)


def test_hyp_arduinodsl_board_constructor_args():
...
def test_hyp_arduinodsl_nodedefinition_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_NodeDefinition)


def test_hyp_arduinodsl_nodedefinition_constructor_exists():
    assert callable(arduinoDSL_NodeDefinition.__init__)


def test_hyp_arduinodsl_nodedefinition_constructor_args():
    sig = inspect.signature(arduinoDSL_NodeDefinition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_cast_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_Cast)


def test_hyp_arduinodsl_cast_constructor_exists():
    assert callable(arduinoDSL_Cast.__init__)


def test_hyp_arduinodsl_cast_constructor_args():
...
def test_hyp_arduinodsl_ifstatement_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_IfStatement)


def test_hyp_arduinodsl_ifstatement_constructor_exists():
    assert callable(arduinoDSL_IfStatement.__init__)


def test_hyp_arduinodsl_ifstatement_constructor_args():
    sig = inspect.signature(arduinoDSL_IfStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_elsestatement_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_ElseStatement)


def test_hyp_arduinodsl_elsestatement_constructor_exists():
    assert callable(arduinoDSL_ElseStatement.__init__)


def test_hyp_arduinodsl_elsestatement_constructor_args():
    sig = inspect.signature(arduinoDSL_ElseStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_elseifstatement_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_ElseIfStatement)


def test_hyp_arduinodsl_elseifstatement_constructor_exists():
    assert callable(arduinoDSL_ElseIfStatement.__init__)


def test_hyp_arduinodsl_elseifstatement_constructor_args():
    sig = inspect.signature(arduinoDSL_ElseIfStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_variabledeclaration_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_VariableDeclaration)


def test_hyp_arduinodsl_variabledeclaration_constructor_exists():
    assert callable(arduinoDSL_VariableDeclaration.__init__)


def test_hyp_arduinodsl_variabledeclaration_constructor_args():
...
def test_hyp_arduinodsl_assignment_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_Assignment)


def test_hyp_arduinodsl_assignment_constructor_exists():
    assert callable(arduinoDSL_Assignment.__init__)


def test_hyp_arduinodsl_assignment_constructor_args():
    sig = inspect.signature(arduinoDSL_Assignment.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_simplestatement_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_SimpleStatement)


def test_hyp_arduinodsl_simplestatement_constructor_exists():
    assert callable(arduinoDSL_SimpleStatement.__init__)


def test_hyp_arduinodsl_simplestatement_constructor_args():
    sig = inspect.signature(arduinoDSL_SimpleStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_state_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_State)


def test_hyp_arduinodsl_state_constructor_exists():
    assert callable(arduinoDSL_State.__init__)


def test_hyp_arduinodsl_state_constructor_args():
...
def test_hyp_arduinodsl_booleanliteral_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_BooleanLiteral)


def test_hyp_arduinodsl_booleanliteral_constructor_exists():
    assert callable(arduinoDSL_BooleanLiteral.__init__)


def test_hyp_arduinodsl_booleanliteral_constructor_args():
...
def test_hyp_arduinodsl_component_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_Component)


def test_hyp_arduinodsl_component_constructor_exists():
    assert callable(arduinoDSL_Component.__init__)


def test_hyp_arduinodsl_component_constructor_args():
...
def test_hyp_arduinodsl_variablereference_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_VariableReference)


def test_hyp_arduinodsl_variablereference_constructor_exists():
    assert callable(arduinoDSL_VariableReference.__init__)


def test_hyp_arduinodsl_variablereference_constructor_args():
    sig = inspect.signature(arduinoDSL_VariableReference.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_delta_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_Delta)


def test_hyp_arduinodsl_delta_constructor_exists():
    assert callable(arduinoDSL_Delta.__init__)


def test_hyp_arduinodsl_delta_constructor_args():
    sig = inspect.signature(arduinoDSL_Delta.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_numberliteral_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_NumberLiteral)


def test_hyp_arduinodsl_numberliteral_constructor_exists():
    assert callable(arduinoDSL_NumberLiteral.__init__)


def test_hyp_arduinodsl_numberliteral_constructor_args():
...
def test_hyp_arduinodsl_attribute_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_Attribute)


def test_hyp_arduinodsl_attribute_constructor_exists():
    assert callable(arduinoDSL_Attribute.__init__)


def test_hyp_arduinodsl_attribute_constructor_args():
    sig = inspect.signature(arduinoDSL_Attribute.__init__)
    params = list(sig.parameters.keys())



def test_hyp_numberexpression_is_not_abstract():
    assert not inspect.isabstract(NumberExpression)


def test_hyp_numberexpression_constructor_exists():
    assert callable(NumberExpression.__init__)


def test_hyp_numberexpression_constructor_args():
    sig = inspect.signature(NumberExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_value_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_Value)


def test_hyp_arduinodsl_value_constructor_exists():
    assert callable(arduinoDSL_Value.__init__)


def test_hyp_arduinodsl_value_constructor_args():
    sig = inspect.signature(arduinoDSL_Value.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_minus_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_Minus)


def test_hyp_arduinodsl_minus_constructor_exists():
    assert callable(arduinoDSL_Minus.__init__)


def test_hyp_arduinodsl_minus_constructor_args():
    sig = inspect.signature(arduinoDSL_Minus.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_div_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_Div)


def test_hyp_arduinodsl_div_constructor_exists():
    assert callable(arduinoDSL_Div.__init__)


def test_hyp_arduinodsl_div_constructor_args():
    sig = inspect.signature(arduinoDSL_Div.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_mult_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_Mult)


def test_hyp_arduinodsl_mult_constructor_exists():
    assert callable(arduinoDSL_Mult.__init__)


def test_hyp_arduinodsl_mult_constructor_args():
    sig = inspect.signature(arduinoDSL_Mult.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_mod_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_Mod)


def test_hyp_arduinodsl_mod_constructor_exists():
    assert callable(arduinoDSL_Mod.__init__)


def test_hyp_arduinodsl_mod_constructor_args():
    sig = inspect.signature(arduinoDSL_Mod.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_plus_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_Plus)


def test_hyp_arduinodsl_plus_constructor_exists():
    assert callable(arduinoDSL_Plus.__init__)


def test_hyp_arduinodsl_plus_constructor_args():
    sig = inspect.signature(arduinoDSL_Plus.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_numberexpressionblock_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_NumberExpressionBlock)


def test_hyp_arduinodsl_numberexpressionblock_constructor_exists():
    assert callable(arduinoDSL_NumberExpressionBlock.__init__)


def test_hyp_arduinodsl_numberexpressionblock_constructor_args():
    sig = inspect.signature(arduinoDSL_NumberExpressionBlock.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_compareoperator_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_CompareOperator)


def test_hyp_arduinodsl_compareoperator_constructor_exists():
    assert callable(arduinoDSL_CompareOperator.__init__)


def test_hyp_arduinodsl_compareoperator_constructor_args():
    sig = inspect.signature(arduinoDSL_CompareOperator.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_booleanoperator_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_BooleanOperator)


def test_hyp_arduinodsl_booleanoperator_constructor_exists():
    assert callable(arduinoDSL_BooleanOperator.__init__)


def test_hyp_arduinodsl_booleanoperator_constructor_args():
...
def test_hyp_arduinodsl_comparison_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_Comparison)


def test_hyp_arduinodsl_comparison_constructor_exists():
    assert callable(arduinoDSL_Comparison.__init__)


def test_hyp_arduinodsl_comparison_constructor_args():
    sig = inspect.signature(arduinoDSL_Comparison.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_andor_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_AndOr)


def test_hyp_arduinodsl_andor_constructor_exists():
    assert callable(arduinoDSL_AndOr.__init__)


def test_hyp_arduinodsl_andor_constructor_args():
    sig = inspect.signature(arduinoDSL_AndOr.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_booleanexpressionblock_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_BooleanExpressionBlock)


def test_hyp_arduinodsl_booleanexpressionblock_constructor_exists():
    assert callable(arduinoDSL_BooleanExpressionBlock.__init__)


def test_hyp_arduinodsl_booleanexpressionblock_constructor_args():
    sig = inspect.signature(arduinoDSL_BooleanExpressionBlock.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_numberexpression_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_NumberExpression)


def test_hyp_arduinodsl_numberexpression_constructor_exists():
    assert callable(arduinoDSL_NumberExpression.__init__)


def test_hyp_arduinodsl_numberexpression_constructor_args():
    sig = inspect.signature(arduinoDSL_NumberExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_rulebody_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_RuleBody)


def test_hyp_arduinodsl_rulebody_constructor_exists():
    assert callable(arduinoDSL_RuleBody.__init__)


def test_hyp_arduinodsl_rulebody_constructor_args():
    sig = inspect.signature(arduinoDSL_RuleBody.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_booleanexpression_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_BooleanExpression)


def test_hyp_arduinodsl_booleanexpression_constructor_exists():
    assert callable(arduinoDSL_BooleanExpression.__init__)


def test_hyp_arduinodsl_booleanexpression_constructor_args():
    sig = inspect.signature(arduinoDSL_BooleanExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_rule_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_Rule)


def test_hyp_arduinodsl_rule_constructor_exists():
    assert callable(arduinoDSL_Rule.__init__)


def test_hyp_arduinodsl_rule_constructor_args():
...
def test_hyp_arduinodsl_eobject_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_EObject)


def test_hyp_arduinodsl_eobject_constructor_exists():
    assert callable(arduinoDSL_EObject.__init__)


def test_hyp_arduinodsl_eobject_constructor_args():
    sig = inspect.signature(arduinoDSL_EObject.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_program_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_Program)


def test_hyp_arduinodsl_program_constructor_exists():
    assert callable(arduinoDSL_Program.__init__)


def test_hyp_arduinodsl_program_constructor_args():
    sig = inspect.signature(arduinoDSL_Program.__init__)
    params = list(sig.parameters.keys())



def test_hyp_arduinodsl_node_is_not_abstract():
    assert not inspect.isabstract(arduinoDSL_Node)


def test_hyp_arduinodsl_node_constructor_exists():
    assert callable(arduinoDSL_Node.__init__)


def test_hyp_arduinodsl_node_constructor_args():
...
def test_hyp_arduinodsl_range_high_setter(instance):
...
@given(instance=arduinoDSL_Range_strategy)
def test_hyp_arduinodsl_range_low_setter(instance):
...
def test_hyp_arduinodsl_smoothing_value_setter(instance):
...
def test_hyp_arduinodsl_rate_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_arduinodsl_componentbody_io_setter(instance):
...
@given(instance=arduinoDSL_ComponentBody_strategy)
def test_hyp_arduinodsl_componentbody_type_setter(instance):
...
@given(instance=arduinoDSL_ComponentBody_strategy)
def test_hyp_arduinodsl_componentbody_pin_setter(instance):
...
def test_hyp_arduinodsl_board_b_setter(instance):
    original = instance.b
    instance.b = original
...
def test_hyp_arduinodsl_cast_castType_setter(instance):
...
def test_hyp_arduinodsl_variabledeclaration_name_setter(instance):
...
@given(instance=arduinoDSL_VariableDeclaration_strategy)
def test_hyp_arduinodsl_variabledeclaration_type_setter(instance):
    original = instance.type
    instance.type = original
    assert instance.type == original
...
def test_hyp_arduinodsl_state_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_arduinodsl_booleanliteral_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_arduinodsl_component_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_arduinodsl_numberliteral_floatVal_setter(instance):
...
@given(instance=arduinoDSL_NumberLiteral_strategy)
def test_hyp_arduinodsl_numberliteral_intVal_setter(instance):
...
def test_hyp_arduinodsl_rule_type_setter(instance):
    original = instance.type
    instance.type = original
    assert instance.type == original
...
def test_hyp_arduinodsl_node_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
