...
class internalsm_TimeConstraintSpecification:
    ...
    def __init__(self, startTimestamp: str, stopTimestamp: str, id: str, expectedLength: str, internalsm_TimeConstraintSpecification: "internalsm_TimeConstraint" = None):
...
class internalsm_TimeConstraint:
    ...
    def __init__(self, type: str, internalsm_TimeConstraint29: "internalsm_TimeConstraintSpecification" = None, internalsm_TimeConstraint: "internalsm_State" = None):
        self.type = type
