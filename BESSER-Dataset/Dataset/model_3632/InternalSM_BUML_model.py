...
# Classes
internalsm_TimeConstraint = Class(name="internalsm_TimeConstraint")
internalsm_Event = Class(name="internalsm_Event")
internalsm_State = Class(name="internalsm_State")
internalsm_Transition = Class(name="internalsm_Transition")
internalsm_EventToken = Class(name="internalsm_EventToken")
internalsm_Guard = Class(name="internalsm_Guard")
internalsm_AtomicEventPattern = Class(name="internalsm_AtomicEventPattern")
internalsm_FinalState = Class(name="internalsm_FinalState")
State = Class(name="State")
internalsm_InitState = Class(name="internalsm_InitState")
internalsm_TrapState = Class(name="internalsm_TrapState")
internalsm_StateMachine = Class(name="internalsm_StateMachine")
internalsm_EventPattern = Class(name="internalsm_EventPattern")
internalsm_InternalExecutionModel = Class(name="internalsm_InternalExecutionModel")
internalsm_TimeConstraintSpecification = Class(name="internalsm_TimeConstraintSpecification")
...
internalsm_StateMachine.attributes={internalsm_StateMachine_priority, internalsm_StateMachine_context}
...
internalsm_TimeConstraintSpecification.attributes={internalsm_TimeConstraintSpecification_stopTimestamp, internalsm_TimeConstraintSpecification_startTimestamp, internalsm_TimeConstraintSpecification_id, internalsm_TimeConstraintSpecification_expectedLength}
...
domain_model = DomainModel(
    name="internalsm",
    types={internalsm_TimeConstraint, internalsm_Event, internalsm_State, internalsm_Transition, internalsm_EventToken, internalsm_Guard, internalsm_AtomicEventPattern, internalsm_FinalState, State, internalsm_InitState, internalsm_TrapState, internalsm_StateMachine, internalsm_EventPattern, internalsm_InternalExecutionModel, internalsm_TimeConstraintSpecification, NumericCompareOperator, TimeConstraintType, EventProcessingContext},
    associations={timeConstraints4, lastProcessedEvent5, preState7, outTransitions0, inTransitions1, eventTokens3, guard8, timeConstraintSpecification28, postState9, eventType11, states13, eventPattern15, stateMachines16, latestEvent18, eventTokens21, currentState23, recordedEvents25},
