...
# Classes
component_diagram_ComponentType = Class(name="component_diagram_ComponentType", is_abstract=True)
IDBase = Class(name="IDBase")
component_diagram_PortType = Class(name="component_diagram_PortType")
component_diagram_ComponentInstance = Class(name="component_diagram_ComponentInstance")
component_diagram_Connector = Class(name="component_diagram_Connector")
component_diagram_PortInstance = Class(name="component_diagram_PortInstance")
component_diagram_HardwareComponent = Class(name="component_diagram_HardwareComponent")
ComponentType = Class(name="ComponentType")
component_diagram_SoftwareComponent = Class(name="component_diagram_SoftwareComponent")
component_diagram_ElectronicDevice = Class(name="component_diagram_ElectronicDevice")
HardwareComponent = Class(name="HardwareComponent")
component_diagram_MechanicalDevice = Class(name="component_diagram_MechanicalDevice")
component_diagram_Actuator = Class(name="component_diagram_Actuator")
MechanicalDevice = Class(name="MechanicalDevice")
component_diagram_Sensor = Class(name="component_diagram_Sensor")
ElectronicDevice = Class(name="ElectronicDevice")
component_diagram_Architecture = Class(name="component_diagram_Architecture")
...
component_diagram_ComponentInstance.attributes={component_diagram_ComponentInstance_version, component_diagram_ComponentInstance_name}
...
domain_model = DomainModel(
    ...
    associations={port_types0, instance1, port2, connect3, outComponent4, inComponent6, type8, type29, component10, connectors11, ports13, instances15, port_type17, subcomponent20, parentcomponent23, inPorts25, outPorts27, component_type30, port_instance32},
    generalizations={gen_component_diagram_ComponentType_IDBase, gen_component_diagram_Connector_IDBase, gen_component_diagram_PortInstance_IDBase, gen_component_diagram_HardwareComponent_ComponentType, gen_component_diagram_SoftwareComponent_ComponentType, gen_component_diagram_ElectronicDevice_HardwareComponent, gen_component_diagram_MechanicalDevice_HardwareComponent, gen_component_diagram_Actuator_MechanicalDevice, gen_component_diagram_Sensor_ElectronicDevice, gen_component_diagram_Architecture_IDBase, gen_component_diagram_ComponentInstance_IDBase, gen_component_diagram_PortType_IDBase},
    metadata=None
)
