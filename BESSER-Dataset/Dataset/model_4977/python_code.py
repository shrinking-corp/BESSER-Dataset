...
class component_diagram_PortType(IDBase):
    ...
    def __init__(self, name: str, PortType: "component_diagram_ComponentType" = None, PortType9: "component_diagram_PortInstance" = None, component_diagram_PortType: "component_diagram_Architecture" = None, port_types: "component_diagram_ComponentType" = None, type33: set["component_diagram_PortInstance"] = None):
        self.name = name
...
class component_diagram_PortInstance(IDBase):
    ...
    def __init__(self, name: str, PortInstance: "component_diagram_Connector" = None, port: "component_diagram_Connector" = None, outPorts: "component_diagram_ComponentInstance" = None, inPorts: "component_diagram_ComponentInstance" = None, port_instance: "component_diagram_PortType" = None, component_diagram_PortInstance: "component_diagram_Architecture" = None, PortInstance28: "component_diagram_ComponentInstance" = None, PortInstance34: "component_diagram_PortType" = None, PortInstance26: "component_diagram_ComponentInstance" = None):
        self.name = name
...
class component_diagram_Connector(IDBase):
    ...
    def __init__(self, name: str, connect: set["component_diagram_PortInstance"] = None, Connector: "component_diagram_PortInstance" = None, component_diagram_Connector: "component_diagram_Architecture" = None):
        self.name = name
...
class component_diagram_ComponentType(IDBase):
    ...
    def __init__(self, name: str, component_type: set["component_diagram_PortType"] = None, type: set["component_diagram_ComponentInstance"] = None, ComponentType: "component_diagram_ComponentInstance" = None, component_diagram_ComponentType: "component_diagram_Architecture" = None, ComponentType31: "component_diagram_PortType" = None):
        self.name = name
