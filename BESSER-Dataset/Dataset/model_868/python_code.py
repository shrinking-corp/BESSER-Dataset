...
class statemachines_Transition(NamedElement):
    ...
    def __init__(self, kind: str, outgoingTransitions: "statemachines_Vertex" = None, incomingTransitions: "statemachines_Vertex" = None, statemachines_Transition: set["statemachines_Trigger"] = None, Transition31: "statemachines_Vertex" = None, Transition33: "statemachines_Vertex" = None, transitions: "statemachines_Region" = None, statemachines_Transition58: "statemachines_Behavior" = None, Transition: "statemachines_Region" = None):
        self.kind = kind
...
class statemachines_StateMachine(NamedElement):
    ...
    def __init__(self, StateMachine: "statemachines_Region" = None, statemachines_StateMachine: "statemachines_CustomSystem" = None, stateMachine: set["statemachines_Region"] = None):
