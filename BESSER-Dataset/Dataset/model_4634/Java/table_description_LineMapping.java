...
public class table_description_LineMapping extends description_StyleUpdater, description_TableMapping {
    ...
    public table_description_LineMapping(
        String headerLabelExpression,        String domainClass,        String semanticCandidatesExpression    ) {
        super(
        );
    ...
    public table_description_LineMapping(
        String headerLabelExpression,        String domainClass,        String semanticCandidatesExpression        ArrayList<LineMapping> linemappings,        ArrayList<LineMapping> linemappings,        ArrayList<LineMapping> linemappings,        ArrayList<CreateLineTool> createlinetools,        ArrayList<LineMapping> linemappings    ) {
        this.headerLabelExpression = headerLabelExpression;
        this.domainClass = domainClass;
        this.semanticCandidatesExpression = semanticCandidatesExpression;
