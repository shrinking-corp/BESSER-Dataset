...
class simulink_Goto(VirtualBlock):
    ...
    def __init__(self, tagVisibility: str, gotoTag: str, Goto: "simulink_From" = None, simulink_Goto: "simulink_GotoTagVisibility" = None, gotoBlock: set["simulink_From"] = None):
...
class simulink_BusSignalMapping:
    ...
    def __init__(self, mappingPath: str, incomplete: bool, mappings: "simulink_BusSelector" = None, simulink_BusSignalMapping: "simulink_OutPort" = None, simulink_BusSignalMapping52: "simulink_OutPort" = None, BusSignalMapping: "simulink_BusSelector" = None):
...
class simulink_BusSelector(BusSpecification):
    ...
    def __init__(self, outputAsBus: bool, BusSelector: "simulink_BusSignalMapping" = None, selector: set["simulink_BusSignalMapping"] = None, simulink_BusSelector: "simulink_BusSpecification" = None):
...
class simulink_SubSystem(Block):
    ...
    def __init__(self, tag: str, parent41: set["simulink_Block"] = None, SubSystem: "simulink_Block" = None):
        self.tag = tag
