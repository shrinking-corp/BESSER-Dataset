...
class be_jebouquine_entities_LigneCommande:
    ...
    def __init__(self, idLigneCommande: int, idLivre: int, idCommande: int, commande33: "be_jebouquine_entities_Commande" = None, livre14: "be_jebouquine_entities_Livre" = None):
...
class be_jebouquine_entities_Commande:
    ...
    def __init__(self, idcommande: int, dateCommande: date, idEtat: int, idClient: int, idLivraisonInfo: int, etatCommande24: "be_jebouquine_entities_EtatCommande" = None, ligneCommande32: set["be_jebouquine_entities_LigneCommande"] = None, livraisonInfo34: "be_jebouquine_entities_LivraisonType" = None, client13: "be_jebouquine_entities_Client" = None):
        self.idcommande = idcommande
...
class be_jebouquine_entities_Livre:
    ...
    def __init__(self, idLivre: int, titre: str, dateApparition: date, prix: float, quantiteEnStock: int, isbn: str, photoLivre: str, idLangue: int, idAuteur: int, idEditeur: int, idCategorie: int, editeur16: "be_jebouquine_entities_Editeur" = None, auteur18: set["be_jebouquine_entities_Auteur"] = None, categorie20: set["be_jebouquine_entities_Categorie"] = None, langue27: "be_jebouquine_entities_Langue" = None, commentaire28: set["be_jebouquine_entities_Commentaire"] = None, ligneCommande15: set["be_jebouquine_entities_LigneCommande"] = None):
        self.idLivre = idLivre
        self.titre = titre
...
class be_jebouquine_entities_Client:
    ...
    def __init__(self, idClient: int, nomClient: str, adresseClient: str, emailClient: str, telephoneClient: str, motDePasseClient: str, etatLogin: str, commentaire22: set["be_jebouquine_entities_Commentaire"] = None, commande12: set["be_jebouquine_entities_Commande"] = None):
        self.idClient = idClient
