...
public class be_jebouquine_entities_LivraisonType  {
    ...
    public be_jebouquine_entities_LivraisonType(
        String typeLivraison,        int idLivraison,        float prixLivraison    ) {
    ...
    public be_jebouquine_entities_LivraisonType(
        String typeLivraison,        int idLivraison,        float prixLivraison        ArrayList<be_jebouquine_entities_Commande> be_jebouquine_entities_commandes    ) {
        this.typeLivraison = typeLivraison;
        this.idLivraison = idLivraison;
        this.prixLivraison = prixLivraison;
