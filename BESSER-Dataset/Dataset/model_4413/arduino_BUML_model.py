...
domain_model = DomainModel(
    name="arduino",
    types={arduino_NamedElement, arduino_Project, NamedElement, arduino_Board, arduino_Block, arduino_Instruction, arduino_Sketch, arduino_Module, arduino_OutputModule, Module, arduino_Led, OutputModule, arduino_InputModule, arduino_PushButton, arduino_ModuleSet, InputModule, arduino_SetLed, ModuleSet, arduino_Control, Instruction, arduino_If, Control, arduino_Expression, arduino_While, arduino_ModuleGet, arduino_Delay, arduino_WaitFor, arduino_Constant, Expression, arduino_UnaryExpression, arduino_BinaryExpression, UnaryOperatorKind, BinaryOperatorKind},
    associations={block5, instructions7, board0, sketch1, modules3, value17, led19, block9, condition11, elseBlock12, condition15, module31, module20, value22, operand24, left26, right28},
    generalizations={gen_arduino_Project_NamedElement, gen_arduino_Sketch_NamedElement, gen_arduino_Board_NamedElement, gen_arduino_Module_NamedElement, gen_arduino_OutputModule_Module, gen_arduino_Led_OutputModule, gen_arduino_InputModule_Module, gen_arduino_ModuleSet_Instruction, gen_arduino_PushButton_InputModule, gen_arduino_SetLed_ModuleSet, gen_arduino_Control_Instruction, gen_arduino_If_Control, gen_arduino_While_Control, gen_arduino_ModuleGet_Expression, gen_arduino_Delay_Instruction, gen_arduino_WaitFor_Instruction, gen_arduino_Constant_Expression, gen_arduino_UnaryExpression_Expression, gen_arduino_BinaryExpression_Expression},
    metadata=None
)
