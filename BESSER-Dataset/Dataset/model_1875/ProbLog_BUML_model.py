...
# Classes
problog_Rule = Class(name="problog_Rule")
Statement = Class(name="Statement")
problog_LHS = Class(name="problog_LHS")
problog_RHS = Class(name="problog_RHS")
problog_Evidence = Class(name="problog_Evidence")
ProbLogStatement = Class(name="ProbLogStatement")
problog_Query = Class(name="problog_Query")
problog_Proposition = Class(name="problog_Proposition", is_abstract=True)
problog_Referable = Class(name="problog_Referable", is_abstract=True)
problog_ProbLogProgram = Class(name="problog_ProbLogProgram")
problog_Statement = Class(name="problog_Statement", is_abstract=True)
problog_Term = Class(name="problog_Term")
problog_ProbLogStatement = Class(name="problog_ProbLogStatement", is_abstract=True)
problog_TermInstance = Class(name="problog_TermInstance")
problog_Comment = Class(name="problog_Comment")
problog_Cheat = Class(name="problog_Cheat")
problog_ImportLibrary = Class(name="problog_ImportLibrary")
problog_Collection = Class(name="problog_Collection", is_abstract=True)
problog_Atom = Class(name="problog_Atom")
Referable = Class(name="Referable")
Annotatable = Class(name="Annotatable")
problog_Variable = Class(name="problog_Variable")
problog_AnnotatedReferable = Class(name="problog_AnnotatedReferable")
Proposition = Class(name="Proposition")
problog_ProbabilityMeasure = Class(name="problog_ProbabilityMeasure", is_abstract=True)
problog_Annotatable = Class(name="problog_Annotatable", is_abstract=True)
problog_ProbabilityLiteral = Class(name="problog_ProbabilityLiteral")
ProbabilityMeasure = Class(name="ProbabilityMeasure")
problog_ProbabilityFraction = Class(name="problog_ProbabilityFraction")
problog_PLList = Class(name="problog_PLList")
Collection = Class(name="Collection")
problog_PLTuple = Class(name="problog_PLTuple")
...
problog_ProbabilityFraction.attributes={problog_ProbabilityFraction_denominator, problog_ProbabilityFraction_nominator}
...
domain_model = DomainModel(
    name="problog",
    types={problog_Rule, Statement, problog_LHS, problog_RHS, problog_Evidence, ProbLogStatement, problog_Query, problog_Proposition, problog_Referable, problog_ProbLogProgram, problog_Statement, problog_Term, problog_ProbLogStatement, problog_TermInstance, problog_Comment, problog_Cheat, problog_ImportLibrary, problog_Collection, problog_Atom, Referable, Annotatable, problog_Variable, problog_AnnotatedReferable, Proposition, problog_ProbabilityMeasure, problog_Annotatable, problog_ProbabilityLiteral, ProbabilityMeasure, problog_ProbabilityFraction, problog_PLList, Collection, problog_PLTuple},
    associations={terms1, lhs3, rhs4, propositions6, statements0, subject13, template15, arguments17, conjunction8, probabilitymeasure10, annotates11, contents20},
    generalizations={gen_problog_Rule_Statement, gen_problog_Evidence_ProbLogStatement, gen_problog_Query_ProbLogStatement, gen_problog_Annotatable_Proposition, gen_problog_ProbLogStatement_Statement, gen_problog_TermInstance_Annotatable, gen_problog_TermInstance_Referable, gen_problog_Comment_Statement, gen_problog_Cheat_Statement, gen_problog_ImportLibrary_Statement, gen_problog_Collection_Referable, gen_problog_Atom_Referable, gen_problog_Atom_Annotatable, gen_problog_Variable_Referable, gen_problog_AnnotatedReferable_Proposition, gen_problog_ProbabilityLiteral_ProbabilityMeasure, gen_problog_ProbabilityFraction_ProbabilityMeasure, gen_problog_PLList_Collection, gen_problog_PLTuple_Collection},
    metadata=None
)
