...
def test_hyp_simplea_b_is_not_abstract():
    assert not inspect.isabstract(simplea_B)


def test_hyp_simplea_b_constructor_exists():
    assert callable(simplea_B.__init__)


def test_hyp_simplea_b_constructor_args():
    sig = inspect.signature(simplea_B.__init__)
    params = list(sig.parameters.keys())



def test_hyp_simplea_a_is_not_abstract():
    assert not inspect.isabstract(simplea_A)


def test_hyp_simplea_a_constructor_exists():
    assert callable(simplea_A.__init__)


def test_hyp_simplea_a_constructor_args():
...
def test_hyp_simplea_a_name_setter(instance):
