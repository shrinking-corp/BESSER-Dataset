...
def test_hyp_simpleexpressions_booleanliteral_is_not_abstract():
    assert not inspect.isabstract(simpleExpressions_BooleanLiteral)


def test_hyp_simpleexpressions_booleanliteral_constructor_exists():
    assert callable(simpleExpressions_BooleanLiteral.__init__)


def test_hyp_simpleexpressions_booleanliteral_constructor_args():
...
def test_hyp_simpleexpressions_booleanliteral_value_setter(instance):
...
def test_simpleExpressions_BooleanLiteral_value_value_roundtrip():
    instance = simpleExpressions_BooleanLiteral(value=True)
...
def test_simpleExpressions_BooleanLiteral_isa_Expression():
    instance = simpleExpressions_BooleanLiteral(value=True)
    assert isinstance(instance, Expression)
...
simpleExpressions_BooleanLiteral_strategy = st.builds(simpleExpressions_BooleanLiteral, value=st.booleans())
@given(instance=simpleExpressions_BooleanLiteral_strategy)
@settings(max_examples=25)
