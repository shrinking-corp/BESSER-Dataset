...
# Classes
simpleExpressions_Comparison = Class(name="simpleExpressions_Comparison")
simpleExpressions_IfCondition = Class(name="simpleExpressions_IfCondition")
simpleExpressions_Expression = Class(name="simpleExpressions_Expression")
simpleExpressions_NumberLiteral = Class(name="simpleExpressions_NumberLiteral")
Expression = Class(name="Expression")
simpleExpressions_BooleanLiteral = Class(name="simpleExpressions_BooleanLiteral")
simpleExpressions_MethodCall = Class(name="simpleExpressions_MethodCall")
simpleExpressions_OrExpression = Class(name="simpleExpressions_OrExpression")
simpleExpressions_AndExpression = Class(name="simpleExpressions_AndExpression")
simpleExpressions_NotExpression = Class(name="simpleExpressions_NotExpression")
...
domain_model = DomainModel(
    ...
    types={simpleExpressions_Comparison, simpleExpressions_IfCondition, simpleExpressions_Expression, simpleExpressions_NumberLiteral, Expression, simpleExpressions_BooleanLiteral, simpleExpressions_MethodCall, simpleExpressions_OrExpression, simpleExpressions_AndExpression, simpleExpressions_NotExpression},
    associations={left6, right8, left11, condition0, left1, right3, right13, expression16},
    generalizations={gen_simpleExpressions_Comparison_Expression, gen_simpleExpressions_NumberLiteral_Expression, gen_simpleExpressions_BooleanLiteral_Expression, gen_simpleExpressions_MethodCall_Expression, gen_simpleExpressions_OrExpression_Expression, gen_simpleExpressions_AndExpression_Expression, gen_simpleExpressions_NotExpression_Expression},
    metadata=None
)
