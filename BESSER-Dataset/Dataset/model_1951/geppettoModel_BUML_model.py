...
model_values_FunctionPlot.attributes={model_values_FunctionPlot_initialValue, model_values_FunctionPlot_title, model_values_FunctionPlot_stepValue, model_values_FunctionPlot_xAxisLabel, model_values_FunctionPlot_finalValue, model_values_FunctionPlot_yAxisLabel}
...
model_values_Image.attributes={model_values_Image_name, model_values_Image_data, model_values_Image_format, model_values_Image_reference}
...
model_values_VisualGroup.attributes={model_values_VisualGroup_type, model_values_VisualGroup_highSpectrumColor, model_values_VisualGroup_lowSpectrumColor}
...
types124: BinaryAssociation = BinaryAssociation(
    name="types124",
    ends={
        Property(name="Type125", type=model_variables_Variable, multiplicity=Multiplicity(1, 1)),
...
domain_model = DomainModel(
    name="model",
    types={model_GeppettoModel, Variable, model_GeppettoLibrary, Node, Type, model_LibraryManager, model_ExperimentState, model_VariableValue, Pointer, Value, model_Tag, DataSource, Query, model_Node, ISynchable, VisualType, types_model_DomainModel, model_types_VisualType, VisualValue, model_types_ImportType, model_types_CompositeType, model_DomainModel, model_ModelFormat, model_ExternalDomainModel, DomainModel_, model_StringToStringMap, model_ISynchable, model_types_Type, model_types_PointerType, model_types_QuantityType, Quantity, model_types_ParameterType, model_types_StateVariableType, model_types_DynamicsType, Dynamics, model_types_ArgumentType, Argument, model_types_ExpressionType, Composite, ArrayValue, model_types_CompositeVisualType, VisualGroup, model_types_ConnectionType, model_types_SimpleType, model_types_ImageType, Image, model_values_Value, model_values_Composite, StringToValueMap, Expression, model_types_HTMLType, HTML, model_types_TextType, Text, model_types_URLType, URL, model_types_PointType, Point, model_types_ArrayType, model_values_MetadataValue, model_values_Text, MetadataValue, model_values_URL, model_values_HTML, model_values_Pointer, PointerElement, model_values_PointerElement, model_values_Point, model_values_StringToValueMap, model_values_Quantity, model_values_PhysicalQuantity, Unit, model_values_Unit, model_values_TimeSeries, model_values_MDTimeSeries, model_values_Argument, model_values_Expression, model_values_VisualValue, VisualGroupElement, model_values_Collada, model_values_OBJ, model_values_Sphere, model_values_Cylinder, model_values_Particles, model_values_Dynamics, PhysicalQuantity, Function, model_values_FunctionPlot, model_values_Function, FunctionPlot, model_values_ArrayElement, model_values_ArrayValue, ArrayElement, model_values_Image, model_values_SkeletonAnimation, SkeletonTransformation, model_values_SkeletonTransformation, model_values_VisualGroupElement, model_values_VisualGroup, model_values_Connection, model_datasources_DataSource, DataSourceLibraryConfiguration, datasources_model_GeppettoLibrary, model_datasources_DataSourceLibraryConfiguration, model_datasources_Query, QueryMatchingCriteria, model_values_ImportValue, model_variables_Variable, TypeToValueMap, model_variables_TypeToValueMap, model_datasources_QueryResults, AQueryResult, model_datasources_RunnableQuery, model_datasources_AQueryResult, model_datasources_QueryResult, model_datasources_SerializableQueryResult, model_datasources_QueryMatchingCriteria, model_datasources_ProcessQuery, datasources_model_StringToStringMap, model_datasources_SimpleQuery, model_datasources_CompoundQuery, model_datasources_CompoundRefQuery, FileFormat, Connectivity, ImageFormat, BooleanOperator},
    associations={variables0, libraries1, tags9, types11, sharedTypes13, libraries16, recordedVariables18, setParameters19, pointer22, value24, tags3, dataSources5, queries7, superType30, visualType32, referencedVariables34, domainModel36, defaultValue38, tags27, format29, defaultValue41, defaultValue43, defaultValue45, defaultValue46, defaultValue48, defaultValue50, defaultValue51, variables39, defaultValue59, variables61, visualGroups63, variables65, defaultValue67, defaultValue70, defaultValue52, defaultValue53, defaultValue54, defaultValue55, defaultValue56, arrayType57, value77, elements79, point80, variable83, type85, value71, value72, unit74, unit75, groupElements98, position99, distal102, particles104, initialCondition88, dynamics89, arguments91, expression93, functionPlot96, b113, position116, initialValue118, elements121, skeletonTransformationSeries106, parameter107, visualGroupElements109, a111, value133, libraryConfigurations136, queries137, dependenciesLibrary140, targetLibrary142, fetchVariableQuery145, library148, anonymousTypes122, types124, initialValues126, position128, key131, results159, type160, matchingCriteria150, returnType151, parameters154, queryChain155, queryChain157},
    generalizations={gen_model_GeppettoLibrary_Node, gen_model_Node_ISynchable, gen_model_types_VisualType_Type, gen_model_types_ImportType_Type, gen_model_Tag_ISynchable, gen_model_ExternalDomainModel_DomainModel, gen_model_types_Type_Node, gen_model_types_PointerType_Type, gen_model_types_QuantityType_Type, gen_model_types_ParameterType_Type, gen_model_types_StateVariableType_Type, gen_model_types_DynamicsType_Type, gen_model_types_ArgumentType_Type, gen_model_types_CompositeType_Type, gen_model_types_ExpressionType_Type, gen_model_types_CompositeVisualType_VisualType, gen_model_types_ConnectionType_Type, gen_model_types_SimpleType_Type, gen_model_types_ImageType_Type, gen_model_values_Value_ISynchable, gen_model_values_Composite_Value, gen_model_types_HTMLType_Type, gen_model_types_TextType_Type, gen_model_types_URLType_Type, gen_model_types_PointType_Type, gen_model_types_ArrayType_Type, gen_model_values_MetadataValue_Value, gen_model_values_Text_MetadataValue, gen_model_values_URL_MetadataValue, gen_model_values_HTML_MetadataValue, gen_model_values_Pointer_Value, gen_model_values_Point_Value, gen_model_values_Quantity_Value, gen_model_values_PhysicalQuantity_Quantity, gen_model_values_Unit_Value, gen_model_values_TimeSeries_Value, gen_model_values_MDTimeSeries_Value, gen_model_values_Argument_Value, gen_model_values_Expression_Value, gen_model_values_VisualValue_Value, gen_model_values_Collada_VisualValue, gen_model_values_OBJ_VisualValue, gen_model_values_Sphere_VisualValue, gen_model_values_Cylinder_VisualValue, gen_model_values_Particles_Value, gen_model_values_Dynamics_Value, gen_model_values_Function_Value, gen_model_values_ArrayElement_Value, gen_model_values_ArrayValue_Value, gen_model_values_Image_Value, gen_model_values_SkeletonAnimation_VisualValue, gen_model_values_VisualGroupElement_Node, gen_model_values_VisualGroup_Node, gen_model_values_Connection_Value, gen_model_datasources_DataSource_Node, gen_model_datasources_Query_Node, gen_model_values_ImportValue_Value, gen_model_variables_Variable_Node, gen_model_datasources_QueryResult_AQueryResult, gen_model_datasources_SerializableQueryResult_AQueryResult, gen_model_datasources_ProcessQuery_Query, gen_model_datasources_SimpleQuery_Query, gen_model_datasources_CompoundQuery_Query, gen_model_datasources_CompoundRefQuery_Query},
    metadata=None
)
