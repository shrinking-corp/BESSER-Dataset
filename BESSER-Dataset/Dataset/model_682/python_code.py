...
class EMOF_Property(TypedElement, MultiplicityElement):
    ...
    def __init__(self, isDerived: str, isID: str, isReadOnly: str, default: str, isComposite: str, EMOF_Property: "Class" = None, EMOF_Property29: "Property" = None):
...
class EMOF_Class(Type):
    ...
    def __init__(self, isAbstract: str, EMOF_Class: set["Property"] = None, EMOF_Class2: set["Operation"] = None, EMOF_Class4: set["Class"] = None, Type23: "EMOF_Package" = None, Type: "EMOF_Operation" = None, Type35: "EMOF_TypedElement" = None):
