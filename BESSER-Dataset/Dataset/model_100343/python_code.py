...
class automaton_Parameter:
    ...
    def __init__(self, symbolicName: str, position: int, Parameter: "automaton_TypedTransition" = None, parameters: "automaton_TypedTransition" = None):
        self.symbolicName = symbolicName
...
class automaton_TimedZone(ABC):
    ...
    def __init__(self, time: str, automaton_TimedZone: "automaton_Automaton" = None, TimedZone: "automaton_State" = None, TimedZone41: "automaton_State" = None, inStateOf: "automaton_State" = None, outStateOf: "automaton_State" = None, automaton_TimedZone30: "automaton_EventToken" = None):
        self.time = time
...
class automaton_State:
    ...
    def __init__(self, label: str, automaton_State: "automaton_Automaton" = None, automaton_State37: "automaton_Event" = None, inState: set["automaton_TimedZone"] = None, outState: set["automaton_TimedZone"] = None, State52: "automaton_TimedZone" = None, State54: "automaton_TimedZone" = None, postState: set["automaton_Transition"] = None, preState: set["automaton_Transition"] = None, currentState: set["automaton_EventToken"] = None, State: "automaton_EventToken" = None, State43: "automaton_Transition" = None, State45: "automaton_Transition" = None):
        self.label = label
...
class automaton_Automaton:
    ...
    def __init__(self, eventPatternId: str, automaton_Automaton: "automaton_InternalModel" = None, automaton_Automaton5: "automaton_InternalModel" = None, automaton_Automaton16: "automaton_InitState" = None, automaton_Automaton18: set["automaton_FinalState"] = None, automaton_Automaton20: "automaton_TrapState" = None, automaton_Automaton9: set["automaton_State"] = None, automaton_Automaton11: set["automaton_EventToken"] = None, automaton_Automaton14: set["automaton_TimedZone"] = None):
