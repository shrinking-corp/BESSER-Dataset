...
domain_model = DomainModel(
    name="automaton",
    types={automaton_Event, automaton_EventToken, automaton_InternalModel, automaton_Automaton, automaton_InitState, automaton_FinalState, automaton_TrapState, automaton_State, automaton_TimedZone, automaton_ParameterTable, automaton_Transition, automaton_TypedTransition, Transition, automaton_Guard, State, automaton_Parameter, automaton_NegativeTransition, TypedTransition, automaton_EpsilonTransition, automaton_EventPattern, automaton_ParameterBinding, automaton_Within, TimedZone, automaton_HoldsFor, EventContext},
    associations={automata0, latestEvent1, enabledForTheLatestEvent3, eventTokensInModel6, initialState15, finalStates17, trapState19, states8, eventTokens10, timedZones13, timedZones28, parameterTable31, inTransitions32, outTransitions33, eventTokens35, currentState21, recordedEvents22, lastProcessed25, preState42, postState44, lastProcessedEvent36, inStateOf39, outStateOf40, transition50, inState51, guards46, parameters47, eventType49, transition55, parameterBindings57, eventToken58, outState53, parameterTable61},
    generalizations={gen_automaton_FinalState_State, gen_automaton_TrapState_State, gen_automaton_TypedTransition_Transition, gen_automaton_InitState_State, gen_automaton_NegativeTransition_TypedTransition, gen_automaton_EpsilonTransition_Transition, gen_automaton_Within_TimedZone, gen_automaton_HoldsFor_TimedZone},
    metadata=None
)
