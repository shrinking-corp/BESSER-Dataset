...
# Classes
ws_middleware_Middleware = Class(name="ws_middleware_Middleware", is_abstract=True)
VM = Class(name="VM")
ws_middleware_ServiceImpl = Class(name="ws_middleware_ServiceImpl")
ServiceDescription = Class(name="ServiceDescription")
ws_middleware_Stub = Class(name="ws_middleware_Stub")
ServiceImpl = Class(name="ServiceImpl")
ws_middleware_Repository = Class(name="ws_middleware_Repository")
ws_middleware_ServiceDescription = Class(name="ws_middleware_ServiceDescription", is_abstract=True)
ws_tree_Tree = Class(name="ws_tree_Tree")
Root = Class(name="Root")
Coordinator = Class(name="Coordinator")
Simulator = Class(name="Simulator")
Process = Class(name="Process")
ws_middleware_WebService = Class(name="ws_middleware_WebService")
Middleware = Class(name="Middleware")
Stub = Class(name="Stub")
Repository = Class(name="Repository")
ws_middleware_VM = Class(name="ws_middleware_VM")
Processor = Class(name="Processor")
ws_middleware_Processor = Class(name="ws_middleware_Processor")
ws_tree_BasicNode = Class(name="ws_tree_BasicNode", is_abstract=True)
ws_tree_Node = Class(name="ws_tree_Node", is_abstract=True)
ws_skeleton_Skeleton = Class(name="ws_skeleton_Skeleton")
Tree = Class(name="Tree")
ws_bundle_Bundle = Class(name="ws_bundle_Bundle")
Skeleton = Class(name="Skeleton")
ws_tree_Root = Class(name="ws_tree_Root")
Node = Class(name="Node")
BasicNode = Class(name="BasicNode")
ws_bundle_Process = Class(name="ws_bundle_Process")
ws_tree_Coordinator = Class(name="ws_tree_Coordinator")
ws_tree_CDEVSCoordinator = Class(name="ws_tree_CDEVSCoordinator")
ws_tree_PDEVSCoordinator = Class(name="ws_tree_PDEVSCoordinator")
ws_tree_FlatCoordinator = Class(name="ws_tree_FlatCoordinator")
ws_tree_NodeCoordinator = Class(name="ws_tree_NodeCoordinator")
ws_tree_P_Coordinator = Class(name="ws_tree_P_Coordinator")
ws_tree_Simulator = Class(name="ws_tree_Simulator", is_abstract=True)
ws_tree_CDEVSSimulator = Class(name="ws_tree_CDEVSSimulator")
ws_tree_PDEVSSimulator = Class(name="ws_tree_PDEVSSimulator")
ws_tree_P_Simulator = Class(name="ws_tree_P_Simulator")
...
ws_middleware_Middleware.methods={ws_middleware_Middleware_m_send, ws_middleware_Middleware_m_establish, ws_middleware_Middleware_m_bind}
...
ws_middleware_Repository.methods={ws_middleware_Repository_m_rebind, ws_middleware_Repository_m_lookup}
...
ws_middleware_VM.attributes={ws_middleware_VM_protocol, ws_middleware_VM_ID}
...
domain_model = DomainModel(
    name="ws",
    types={ws_middleware_Middleware, VM, ws_middleware_ServiceImpl, ServiceDescription, ws_middleware_Stub, ServiceImpl, ws_middleware_Repository, ws_middleware_ServiceDescription, ws_tree_Tree, Root, Coordinator, Simulator, Process, ws_middleware_WebService, Middleware, Stub, Repository, ws_middleware_VM, Processor, ws_middleware_Processor, ws_tree_BasicNode, ws_tree_Node, ws_skeleton_Skeleton, Tree, ws_bundle_Bundle, Skeleton, ws_tree_Root, Node, BasicNode, ws_bundle_Process, ws_tree_Coordinator, ws_tree_CDEVSCoordinator, ws_tree_PDEVSCoordinator, ws_tree_FlatCoordinator, ws_tree_NodeCoordinator, ws_tree_P_Coordinator, ws_tree_Simulator, ws_tree_CDEVSSimulator, ws_tree_PDEVSSimulator, ws_tree_P_Simulator},
    associations={impl7, services8, Root9, Coordinator10, uses0, process1, stubs3, registry4, processors6, tree17, rootskel18, Simulator12, skeleton21, Process22, child14, children15, nodes25, middleware26},
    generalizations={gen_ws_middleware_ServiceImpl_ServiceDescription, gen_ws_middleware_WebService_Middleware, gen_ws_tree_BasicNode_Node, gen_ws_tree_Root_Node, gen_ws_tree_Coordinator_BasicNode, gen_ws_tree_CDEVSCoordinator_Coordinator, gen_ws_tree_PDEVSCoordinator_Coordinator, gen_ws_tree_FlatCoordinator_Coordinator, gen_ws_tree_NodeCoordinator_Coordinator, gen_ws_tree_P_Coordinator_Coordinator, gen_ws_tree_Simulator_BasicNode, gen_ws_tree_CDEVSSimulator_Simulator, gen_ws_tree_PDEVSSimulator_Simulator, gen_ws_tree_P_Simulator_Simulator},
    metadata=None
)
