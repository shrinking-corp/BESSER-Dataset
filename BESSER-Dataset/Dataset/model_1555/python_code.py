...
class reviews_FileVersion(ReviewItem):
    ...
    def __init__(self, path: str, description: str, content: str, fileRevision: str, reviews_FileVersion59: "reviews_FileItem" = None, reviews_FileVersion: "reviews_FileItem" = None, reviews_FileVersion51: "reviews_FileItem" = None):
        self.path = path
...
class reviews_User:
    ...
    def __init__(self, id: str, email: str, displayName: str, reviews_User22: "reviews_Comment" = None, reviews_User33: "reviews_ReviewItem" = None, reviews_User36: "reviews_ReviewItem" = None, reviews_User: "reviews_Change" = None, reviews_User43: "reviews_Repository" = None, reviews_User47: "reviews_Repository" = None, reviews_User63: "reviews_UserApprovalsMap" = None, reviews_User72: "reviews_RequirementEntry" = None):
        self.id = id
        self.email = email
...
class reviews_CommentContainer(ABC):
    ...
    def __init__(self, item: set["reviews_Comment"] = None, reviews_CommentContainer3: set["reviews_Comment"] = None, reviews_CommentContainer6: set["reviews_Comment"] = None, reviews_CommentContainer: set["reviews_Comment"] = None, CommentContainer: "reviews_Comment" = None):
...
class reviews_Comment(Indexed, Dated):
    ...
    def __init__(self, description: str, id: str, draft: bool, title: str, reviews_Comment21: "reviews_User" = None, Comment: "reviews_CommentContainer" = None, reviews_Comment4: "reviews_CommentContainer" = None, reviews_Comment7: "reviews_CommentContainer" = None, reviews_Comment: "reviews_CommentContainer" = None, comments: "reviews_CommentContainer" = None, reviews_Comment25: "reviews_Comment" = None, reviews_Comment23: set["reviews_Comment"] = None, reviews_Comment27: set["reviews_Location"] = None, reviews_Comment29: "reviews_Review" = None):
        self.description = description
        self.id = id
        self.draft = draft
        self.title = title
