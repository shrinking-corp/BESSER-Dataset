...
Employee.attributes={Employee_Emp_DOB, Employee_Emp_Name, Employee_Emp_Position, Employee_Emp_Date_Of_Joint, Employee_Emp_Email, Employee_Emp_NIC, Employee_Emp_Salary, Employee_Emp_Id, Employee_Emp_ContactNo, Employee_Emp_Address, Employee_Emp_Department}
...
Salary.attributes={Salary_Sly_Decrement, Salary_Emp_Id, Salary_Sly_Increment, Salary_Sly_Basic, Salary_OverTime, Salary_Sly_Netgross}
...
Leave.attributes={Leave_Leave_NoOfDays, Leave_Leave_StartDate, Leave_Leave_Status, Leave_Leave_Title, Leave_leave_id, Leave_Leave_detail, Leave_Leave_ApplyDate, Leave_Leave_EndDate, Leave_Emp_Id}
...
domain_model = DomainModel(
    name="_6c4c160d_23b6_47d6_bcc3_172122972a18",
