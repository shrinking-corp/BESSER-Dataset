...
public class Leave  {
    ...
    public Leave(
        String Leave_Status,        LocalDate Leave_StartDate,        LocalDate Leave_ApplyDate,        int Emp_Id,        String Leave_detail,        String Leave_Title,        LocalDate Leave_EndDate,        int Leave_NoOfDays,        int leave_id    ) {
