...
domain_model = DomainModel(
    name="FeatureModel",
    types={FeatureModel_FeatureModel, NamedElement, FeatureModel_Comment, FeatureModel_Constraint, FeatureModel_Feature, FeatureModel_Group, FeatureModel_RequireConstraint, FeatureModel_ExcludeConstraint, Constraint, FeatureModel_NamedElement, GroupType},
    associations={comments0, constraints1, root3, groups5, requiredConstraints12, requireConstraints13, group15, excludeConstraintsA16, excludeConstraintsB17, requiredFeature19, feature20, element7, children10, excludedFeatureA22, excludedFeatureB24, features26},
    generalizations={gen_FeatureModel_FeatureModel_NamedElement, gen_FeatureModel_RequireConstraint_Constraint, gen_FeatureModel_Comment_NamedElement, gen_FeatureModel_Constraint_NamedElement, gen_FeatureModel_Feature_NamedElement, gen_FeatureModel_ExcludeConstraint_Constraint, gen_FeatureModel_Group_NamedElement},
    metadata=None
)
