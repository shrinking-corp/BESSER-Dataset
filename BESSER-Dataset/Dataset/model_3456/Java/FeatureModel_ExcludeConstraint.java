...
public class FeatureModel_ExcludeConstraint extends Constraint {
    ...
    public FeatureModel_ExcludeConstraint(
    ) {
        super(
        );
    ...
    public FeatureModel_ExcludeConstraint(
        ArrayList<FeatureModel_Feature> featuremodel_features,        ArrayList<FeatureModel_Feature> featuremodel_features    ) {
