...
class html_Page:
    ...
    def __init__(self, title: str, urlToSaveResponses: str, urlToGetData: str, urlToGetRelationResult: str, description: str, id: int, html_Page18: set["html_View"] = None, html_Page: "html_Container" = None):
        self.title = title
        ...
        pass
    @property
    def urlToGetRelationResult(self):
