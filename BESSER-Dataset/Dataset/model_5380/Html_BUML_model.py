...
html_View = Class(name="html_View")
html_Graph = Class(name="html_Graph")
html_Section = Class(name="html_Section")
html_FormElement = Class(name="html_FormElement", is_abstract=True)
html_Label = Class(name="html_Label")
FormElement = Class(name="FormElement")
html_Editable = Class(name="html_Editable", is_abstract=True)
...
html_SelectionList = Class(name="html_SelectionList", is_abstract=True)
html_SelectComplex = Class(name="html_SelectComplex")
html_ColumnOption = Class(name="html_ColumnOption")
html_Container = Class(name="html_Container")
html_Page = Class(name="html_Page")
...
html_Input.attributes={html_Input_maxLength, html_Input_step, html_Input_min, html_Input_checked, html_Input_max, html_Input_type}
...
html_Section.attributes={html_Section_id, html_Section_title}
...
html_FormElement.attributes={html_FormElement_id, html_FormElement_visible}
...
html_Label.attributes={html_Label_forText, html_Label_content}
...
html_TextArea.attributes={html_TextArea_rows, html_TextArea_maxLength}
...
html_Option.attributes={html_Option_content, html_Option_value}
...
html_ColumnOption.attributes={html_ColumnOption_value, html_ColumnOption_content}
...
html_Page.attributes={html_Page_urlToGetData, html_Page_urlToGetRelationResult, html_Page_urlToSaveResponses, html_Page_title, html_Page_description, html_Page_id}
...
domain_model = DomainModel(
    name="html",
    types={html_Input, Editable, html_View, html_Graph, html_Section, html_FormElement, html_Label, FormElement, html_Editable, html_TextArea, html_Select, SelectionList, html_Option, html_SelectionList, html_SelectComplex, html_ColumnOption, html_Container, html_Page, InputType, GraphType, SelectType},
    associations={label5, graphs0, sections1, formElements3, views17, options6, otherArea7, formElements9, columnsOptions12, options13, pages16},
    generalizations={gen_html_Input_Editable, gen_html_Label_FormElement, gen_html_Editable_FormElement, gen_html_TextArea_Editable, gen_html_Select_SelectionList, gen_html_SelectionList_Editable, gen_html_SelectComplex_SelectionList},
    metadata=None
)
