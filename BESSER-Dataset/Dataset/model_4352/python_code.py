...
class ecoreDiff_EStructuralFeature(ETypedElement):
    ...
    def __init__(self, changeable: bool, volatile: bool, transient: bool, defaultValueLiteral: str, unsettable: bool, derived: bool, ecoreDiff_EStructuralFeature74: "ecoreDiff_EObject" = None, ecoreDiff_EStructuralFeature: "ecoreDiff_EClass" = None, ecoreDiff_EStructuralFeature234: "ecoreDiff_ChangedEStructuralFeature" = None):
...
class ecoreDiff_EClassifier(ENamedElement):
    ...
    def __init__(self, instanceClassName: str, instanceTypeName: str, ecoreDiff_EClassifier: "ecoreDiff_EObject" = None, ecoreDiff_EClassifier19: set["ecoreDiff_ETypeParameter"] = None, ecoreDiff_EClassifier50: "ecoreDiff_EGenericType" = None, ecoreDiff_EClassifier58: "ecoreDiff_EOperation" = None, ecoreDiff_EClassifier29: "ecoreDiff_EPackage" = None, ecoreDiff_EClassifier129: "ecoreDiff_ChangedEClassifier" = None):
...
class ecoreDiff_EAnnotation(EModelElement):
    ...
    def __init__(self, source: str, ecoreDiff_EAnnotation: set["ecoreDiff_EStringToStringMapEntry"] = None, ecoreDiff_EAnnotation2: "ecoreDiff_EModelElement" = None, ecoreDiff_EAnnotation4: set["ecoreDiff_EObject"] = None, ecoreDiff_EAnnotation6: set["ecoreDiff_EObject"] = None, ecoreDiff_EAnnotation93: "ecoreDiff_ChangedEAnnotation" = None, ecoreDiff_EAnnotation86: "ecoreDiff_EModelElement" = None):
        self.source = source
