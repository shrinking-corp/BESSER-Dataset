...
# Classes
bombXML_Type = Class(name="bombXML_Type", is_abstract=True)
NamedElement = Class(name="NamedElement")
bombXML_DataType = Class(name="bombXML_DataType")
Type = Class(name="Type")
bombXML_Entity = Class(name="bombXML_Entity")
bombXML_Feature = Class(name="bombXML_Feature")
bombXML_EntityModel = Class(name="bombXML_EntityModel")
bombXML_NamedElement = Class(name="bombXML_NamedElement", is_abstract=True)
...
domain_model = DomainModel(
    name="bombXML",
    types={bombXML_Type, NamedElement, bombXML_DataType, Type, bombXML_Entity, bombXML_Feature, bombXML_EntityModel, bombXML_NamedElement, FeatureKind},
