...
mindmap_MainTopic = Class(name="mindmap_MainTopic")
mindmap_MindMap = Class(name="mindmap_MindMap")
mindmap_CentralTopic = Class(name="mindmap_CentralTopic")
mindmap_Topic = Class(name="mindmap_Topic", is_abstract=True)
mindmap_SubTopic = Class(name="mindmap_SubTopic")
...
domain_model = DomainModel(
    name="mindmap",
    types={Topic, mindmap_MainTopic, mindmap_MindMap, mindmap_CentralTopic, mindmap_Topic, mindmap_SubTopic},
    associations={maintopics1, topic0, subtopics3, subsubtopics6},
    generalizations={gen_mindmap_CentralTopic_Topic, gen_mindmap_MainTopic_Topic, gen_mindmap_SubTopic_Topic},
    metadata=None
)
