...
# Classes
dslComponent_WTComponents = Class(name="dslComponent_WTComponents")
dslComponent_Subsystem = Class(name="dslComponent_Subsystem")
dslComponent_ControlSubsystem = Class(name="dslComponent_ControlSubsystem")
dslComponent_Component = Class(name="dslComponent_Component")
dslComponent_StateMachine = Class(name="dslComponent_StateMachine")
dslComponent_Vertex = Class(name="dslComponent_Vertex", is_abstract=True)
dslComponent_Edge = Class(name="dslComponent_Edge")
DocumElt = Class(name="DocumElt")
dslComponent_SimpleState = Class(name="dslComponent_SimpleState")
Vertex = Class(name="Vertex")
dslComponent_InitialState = Class(name="dslComponent_InitialState")
dslComponent_DocumElt = Class(name="dslComponent_DocumElt", is_abstract=True)
dslComponent_Port = Class(name="dslComponent_Port", is_abstract=True)
dslComponent_InPort = Class(name="dslComponent_InPort")
Port = Class(name="Port")
dslComponent_OutPort = Class(name="dslComponent_OutPort")
...
dslComponent_Component.attributes={dslComponent_Component_id, dslComponent_Component_name}
...
domain_model = DomainModel(
    name="dslComponent",
    types={dslComponent_WTComponents, dslComponent_Subsystem, dslComponent_ControlSubsystem, dslComponent_Component, dslComponent_StateMachine, dslComponent_Vertex, dslComponent_Edge, DocumElt, dslComponent_SimpleState, Vertex, dslComponent_InitialState, dslComponent_DocumElt, dslComponent_Port, dslComponent_InPort, Port, dslComponent_OutPort},
    associations={subsystems0, beh1, components3, machines10, states12, transitions14, incoming16, outgoing17, source19, target20, machines22, subsystems6, ports8},
