...
# Classes
mathinterpreter_Model = Class(name="mathinterpreter_Model")
mathinterpreter_MathExpression = Class(name="mathinterpreter_MathExpression")
mathinterpreter_PMExpression = Class(name="mathinterpreter_PMExpression")
mathinterpreter_Number = Class(name="mathinterpreter_Number")
mathinterpreter_Positive = Class(name="mathinterpreter_Positive")
Number = Class(name="Number")
mathinterpreter_Negative = Class(name="mathinterpreter_Negative")
mathinterpreter_PMParenthesis = Class(name="mathinterpreter_PMParenthesis")
mathinterpreter_DefParenthesis = Class(name="mathinterpreter_DefParenthesis")
mathinterpreter_Pow = Class(name="mathinterpreter_Pow")
Power = Class(name="Power")
mathinterpreter_Function = Class(name="mathinterpreter_Function")
MathExpression = Class(name="MathExpression")
mathinterpreter_DefineExpr = Class(name="mathinterpreter_DefineExpr")
DefParenthesis = Class(name="DefParenthesis")
mathinterpreter_Variable = Class(name="mathinterpreter_Variable")
mathinterpreter_External = Class(name="mathinterpreter_External")
Primary = Class(name="Primary")
mathinterpreter_Primary = Class(name="mathinterpreter_Primary")
mathinterpreter_EObject = Class(name="mathinterpreter_EObject")
mathinterpreter_MDExpression = Class(name="mathinterpreter_MDExpression")
PMExpression = Class(name="PMExpression")
mathinterpreter_PowExpression = Class(name="mathinterpreter_PowExpression")
MDExpression = Class(name="MDExpression")
mathinterpreter_Power = Class(name="mathinterpreter_Power")
mathinterpreter_PlusMinus = Class(name="mathinterpreter_PlusMinus")
mathinterpreter_MultiplyDivide = Class(name="mathinterpreter_MultiplyDivide")
PowExpression = Class(name="PowExpression")
mathinterpreter_VariableName = Class(name="mathinterpreter_VariableName")
mathinterpreter_Plus = Class(name="mathinterpreter_Plus")
PlusMinus = Class(name="PlusMinus")
mathinterpreter_Minus = Class(name="mathinterpreter_Minus")
mathinterpreter_Multiply = Class(name="mathinterpreter_Multiply")
MultiplyDivide = Class(name="MultiplyDivide")
mathinterpreter_Divide = Class(name="mathinterpreter_Divide")
...
domain_model = DomainModel(
    ...
    types={mathinterpreter_Model, mathinterpreter_MathExpression, mathinterpreter_PMExpression, mathinterpreter_Number, mathinterpreter_Positive, Number, mathinterpreter_Negative, mathinterpreter_PMParenthesis, mathinterpreter_DefParenthesis, mathinterpreter_Pow, Power, mathinterpreter_Function, MathExpression, mathinterpreter_DefineExpr, DefParenthesis, mathinterpreter_Variable, mathinterpreter_External, Primary, mathinterpreter_Primary, mathinterpreter_EObject, mathinterpreter_MDExpression, PMExpression, mathinterpreter_PowExpression, MDExpression, mathinterpreter_Power, mathinterpreter_PlusMinus, mathinterpreter_MultiplyDivide, PowExpression, mathinterpreter_VariableName, mathinterpreter_Plus, PlusMinus, mathinterpreter_Minus, mathinterpreter_Multiply, MultiplyDivide, mathinterpreter_Divide},
    associations={mathexpression0, expression1, expression15, variables3, expression4, arguments7, left9, operator11, right13},
    generalizations={gen_mathinterpreter_Number_Primary, gen_mathinterpreter_Positive_Number, gen_mathinterpreter_Negative_Number, gen_mathinterpreter_PMParenthesis_Primary, gen_mathinterpreter_DefParenthesis_Primary, gen_mathinterpreter_Pow_Power, gen_mathinterpreter_Function_MathExpression, gen_mathinterpreter_DefineExpr_MathExpression, gen_mathinterpreter_DefineExpr_DefParenthesis, gen_mathinterpreter_External_Primary, gen_mathinterpreter_MDExpression_PMExpression, gen_mathinterpreter_PowExpression_MDExpression, gen_mathinterpreter_Primary_PowExpression, gen_mathinterpreter_VariableName_Primary, gen_mathinterpreter_Plus_PlusMinus, gen_mathinterpreter_Minus_PlusMinus, gen_mathinterpreter_Multiply_MultiplyDivide, gen_mathinterpreter_Divide_MultiplyDivide},
    metadata=None
)
