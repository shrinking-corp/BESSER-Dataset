...
model_ArchimateModel.methods={model_ArchimateModel_m_addDerivedRelationsFolder, model_ArchimateModel_m_getDefaultFolderForElement, model_ArchimateModel_m_getFolder, model_ArchimateModel_m_getDefaultDiagramModel, model_ArchimateModel_m_removeDerivedRelationsFolder, model_ArchimateModel_m_setDefaults, model_ArchimateModel_m_getDiagramModels}
...
model_DiagramModelObject_m_setBounds: Method = Method(name="setBounds", parameters={Parameter(name='model_width', type=StringType), Parameter(name='model_x', type=StringType), Parameter(name='model_y', type=StringType), Parameter(name='model_height', type=StringType)})
model_DiagramModelObject.attributes={model_DiagramModelObject_fillColor}
model_DiagramModelObject.methods={model_DiagramModelObject_m_setBounds, model_DiagramModelObject_m_removeConnection, model_DiagramModelObject_m_addConnection}
...
model_DiagramModelConnection.attributes={model_DiagramModelConnection_lineWidth, model_DiagramModelConnection_type, model_DiagramModelConnection_text, model_DiagramModelConnection_lineColor}
...
model_FontAttribute.attributes={model_FontAttribute_textPosition, model_FontAttribute_font, model_FontAttribute_fontColor, model_FontAttribute_textAlignment}
