...
class DiagramModelComponent:
    ...
    pass
class model_DiagramModelObject(DiagramModelComponent, FontAttribute):

    def __init__(self, fillColor: str, model_DiagramModelObject: "model_DiagramModelContainer" = None, model_DiagramModelObject16: set["model_DiagramModelConnection"] = None, model_DiagramModelObject18: set["model_DiagramModelConnection"] = None, model_DiagramModelObject22: "model_DiagramModelConnection" = None, model_DiagramModelObject14: "model_Bounds" = None, model_DiagramModelObject25: "model_DiagramModelConnection" = None):
    ...
    def setBounds(self, model_x, model_height, model_y, model_width):
...
class model_SketchModelActor(Documentable, Properties, DiagramModelObject):
    ...
    pass
class model_DiagramModelConnection(Documentable, DiagramModelComponent, Properties, FontAttribute):
...
class model_DiagramModelComponent(Cloneable, Identifier, Nameable, Adapter):
    ...
    pass
class model_ArchimateElement(ArchimateModelElement, Documentable, Identifier, Nameable, Cloneable, Properties):

    pass
class FolderContainer:

    pass
class model_Folder(FolderContainer, ArchimateModelElement, Documentable, Identifier, Nameable, Properties):
...
class model_ArchimateModel(FolderContainer, ArchimateModelElement, Identifier, Nameable, Properties):
