...
Employee.attributes={Employee_employeeId, Employee_managerId, Employee_leavesTaken, Employee_password, Employee_employeeName, Employee_jobLevel, Employee_noOfLeaves}
...
LeaveApplication.attributes={LeaveApplication_applicationId, LeaveApplication_toDate, LeaveApplication_employeeId, LeaveApplication_approverComments, LeaveApplication_status, LeaveApplication_fromDate, LeaveApplication_reason}
...
domain_model = DomainModel(
    name="e4c78e4b_c9e5_471f_8c0d_04445a010e53",
    types={CreateUser_UseCase, Update_Calendar_UseCase, Application_Actor, SendNotification_UseCase, Credit_Leaves_UseCase, AutoApproval_UseCase, GenerateSummary_UseCase, Employee, Query, EligibilityQuery, LeaveBalanceQuery, LeaveHistoryQuery, Login_UseCase, Employee_Actor, Change_Password_UseCase, Query_Eligibility_UseCase, Query_Leave_Balance_UseCase, Query_Leave_History_UseCase, Apply_Leave_UseCase, Leave_Request_Status_UseCase, Withdraw_Application_UseCase, Approver_Jobs_UseCase, Approve_RejectRequests_UseCase, Cancel_Leaves_UseCase, Admin_Actor, LeaveApplication, Request, ApplyLeaveRequest, WithdrawLeaveRequest, CancelLeaveRequest, LeaveStatusQuery, ApproveOrRejectStatus, LoginAction, CreateUserAction, UpdateCalendar, ApplicationUtils, LeaveStatus},
