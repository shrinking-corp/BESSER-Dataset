...
public class Company_CompanyModel  {
    ...
    public Company_CompanyModel(
        ArrayList<Company_Division> company_divisions,        ArrayList<Company_Company> company_companys,        ArrayList<Company_Topic> company_topics,        ArrayList<Company_Category> company_categorys    ) {
