...
def test_company_company_has_completeAddress():
    assert hasattr(Company_Company, "completeAddress")
    descriptor = None
    for klass in Company_Company.__mro__:
...
def test_company_company_has_city():
    assert hasattr(Company_Company, "city")
    descriptor = None
    for klass in Company_Company.__mro__:
...
@given(instance=Company_Company_strategy)
def test_company_company_completeAddress_setter(instance):
...
@given(instance=Company_Company_strategy)
def test_company_company_city_setter(instance):
