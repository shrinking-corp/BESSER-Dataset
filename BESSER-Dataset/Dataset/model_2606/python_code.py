...
class Company_Company:
    ...
    def __init__(self, name: str, city: str, completeAddress: str, Company_Company: set["Company_Person"] = None, Company_Company6: set["Company_Project"] = None, Company_Company9: set["Company_Division"] = None, Company_Company15: "Company_CompanyModel" = None):
        self.name = name
        self.city = city
...
class Company_Project(ABC):
    ...
    def __init__(self, name: str, Company_Project: "Company_Person" = None, Company_Project7: "Company_Company" = None, Company_Project11: "Company_Category" = None):
        self.name = name
