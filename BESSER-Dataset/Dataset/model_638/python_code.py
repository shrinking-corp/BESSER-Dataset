...
class libraryModel_ecore_LibraryModel:
    ...
    def __init__(self, LibraryModel: "libraryModel_ecore_Book" = None, LibraryModel5: "libraryModel_ecore_Author" = None, library: set["libraryModel_ecore_Book"] = None, library8: set["libraryModel_ecore_Author"] = None):
