...
# Classes
libraryModel_ecore_Book = Class(name="libraryModel_ecore_Book")
NamedElement = Class(name="NamedElement")
libraryModel_ecore_Author = Class(name="libraryModel_ecore_Author")
libraryModel_ecore_LibraryModel = Class(name="libraryModel_ecore_LibraryModel")
libraryModel_ecore_Picture = Class(name="libraryModel_ecore_Picture")
libraryModel_ecore_NamedElement = Class(name="libraryModel_ecore_NamedElement")
...
domain_model = DomainModel(
    ...
    types={libraryModel_ecore_Book, NamedElement, libraryModel_ecore_Author, libraryModel_ecore_LibraryModel, libraryModel_ecore_Picture, libraryModel_ecore_NamedElement},
    associations={authors0, library1, pictures2, library4, book6, authors7, book9},
