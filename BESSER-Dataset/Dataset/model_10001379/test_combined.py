...
def test_hyp__shipment_is_not_abstract():
    assert not inspect.isabstract(_Shipment)


def test_hyp__shipment_constructor_exists():
    assert callable(_Shipment.__init__)


def test_hyp__shipment_constructor_args():
...
def test_hyp__shipment_shipmentNumber_setter(instance):
...
@given(instance=_Shipment_strategy)
def test_hyp__shipment_orderId_setter(instance):
    original = instance.orderId
    instance.orderId = original
    assert instance.orderId == original
...
def test_hyp_farmer__email_setter(instance):
...
@given(instance=Farmer_strategy)
def test_hyp_farmer__address_setter(instance):
...
@given(instance=Farmer_strategy)
def test_hyp_farmer__username_setter(instance):
...
@given(instance=Farmer_strategy)
def test_hyp_farmer__usertypeid_setter(instance):
...
@given(instance=Farmer_strategy)
def test_hyp_farmer__logincredentialsid_setter(instance):
...
@given(instance=Farmer_strategy)
def test_hyp_farmer__phone_setter(instance):
...
def test_Farmer__address_value_roundtrip():
    instance = Farmer(_address="sample_text", _email="sample_text", _logincredentialsid=7, _phone=7, _username="sample_text", _usertypeid=7)
    assert instance._address == "sample_text"
    instance._address = "sample_text_2"
    assert instance._address == "sample_text_2"


def test_Farmer__email_value_roundtrip():
    instance = Farmer(_address="sample_text", _email="sample_text", _logincredentialsid=7, _phone=7, _username="sample_text", _usertypeid=7)
...
def test_Farmer__logincredentialsid_value_roundtrip():
    instance = Farmer(_address="sample_text", _email="sample_text", _logincredentialsid=7, _phone=7, _username="sample_text", _usertypeid=7)
...
def test_Farmer__phone_value_roundtrip():
    instance = Farmer(_address="sample_text", _email="sample_text", _logincredentialsid=7, _phone=7, _username="sample_text", _usertypeid=7)
...
def test_Farmer__username_value_roundtrip():
    instance = Farmer(_address="sample_text", _email="sample_text", _logincredentialsid=7, _phone=7, _username="sample_text", _usertypeid=7)
...
def test_Farmer__usertypeid_value_roundtrip():
    instance = Farmer(_address="sample_text", _email="sample_text", _logincredentialsid=7, _phone=7, _username="sample_text", _usertypeid=7)
...
def test__Product__description_value_roundtrip():
    instance = _Product(_description="sample_text", _name="sample_text", _price=7, _producttypeid=7, _stock=7)
...
def test__Shipment_orderId_value_roundtrip():
    instance = _Shipment(orderId=7, shipmentNumber=7)
    assert instance.orderId == 7
    instance.orderId = 13
    assert instance.orderId == 13


def test__Shipment_shipmentNumber_value_roundtrip():
    instance = _Shipment(orderId=7, shipmentNumber=7)
...
def test_assoc_Farmer__ProductType_link_reassign_clear():
    ...
    b1 = Farmer(_address="sample_text", _email="sample_text", _logincredentialsid=7, _phone=7, _username="sample_text", _usertypeid=7)
    b2 = Farmer(_address="sample_text_2", _email="sample_text_2", _logincredentialsid=13, _phone=13, _username="sample_text_2", _usertypeid=13)
...
def test_assoc_ProductType_Product_link_reassign_clear():
    a = _ProductType(_type="sample_text")
    b1 = _Product(_description="sample_text", _name="sample_text", _price=7, _producttypeid=7, _stock=7)
    b2 = _Product(_description="sample_text_2", _name="sample_text_2", _price=13, _producttypeid=13, _stock=13)
...
def test_assoc_Ratings_Customer_link_reassign_clear():
    a = _Shipment(orderId=7, shipmentNumber=7)
    b1 = Farmer(_address="sample_text", _email="sample_text", _logincredentialsid=7, _phone=7, _username="sample_text", _usertypeid=7)
    b2 = Farmer(_address="sample_text_2", _email="sample_text_2", _logincredentialsid=13, _phone=13, _username="sample_text_2", _usertypeid=13)
...
def test_assoc__Product__OrderDetails_link_reassign_clear():
    a = _Product(_description="sample_text", _name="sample_text", _price=7, _producttypeid=7, _stock=7)
    b1 = _OrderDetail(OrderId=7, _orderdate=date(2024, 1, 1), _productid=7, _quantity=7, _totalamount=7, _userid=7, paymentInfoId=7)
    b2 = _OrderDetail(OrderId=13, _orderdate=date(2025, 6, 15), _productid=13, _quantity=13, _totalamount=13, _userid=13, paymentInfoId=13)
    _safe_set(a, '_is_in6', {b1})
    assert _is_linked(a, '_is_in6', b1)
    if hasattr(b1, '_contains7'):
        assert _is_linked(b1, '_contains7', a)
    _safe_set(a, '_is_in6', {b2})
    assert _is_linked(a, '_is_in6', b2)
    if hasattr(b1, '_contains7'):
        assert not _is_linked(b1, '_contains7', a)
    if hasattr(b2, '_contains7'):
        assert _is_linked(b2, '_contains7', a)
    _safe_set(a, '_is_in6', set())
    assert not _is_linked(a, '_is_in6', b2)
    if hasattr(b2, '_contains7'):
        assert not _is_linked(b2, '_contains7', a)
...
Farmer_strategy = st.builds(Farmer, _address=safe_text, _email=safe_text, _logincredentialsid=st.integers(), _phone=st.integers(), _username=safe_text, _usertypeid=st.integers())
@given(instance=Farmer_strategy)
...
_Product_strategy = st.builds(_Product, _description=safe_text, _name=safe_text, _price=st.integers(), _producttypeid=st.integers(), _stock=st.integers())
@given(instance=_Product_strategy)
@settings(max_examples=25)
...
_Shipment_strategy = st.builds(_Shipment, orderId=st.integers(), shipmentNumber=st.integers())
@given(instance=_Shipment_strategy)
@settings(max_examples=25)
