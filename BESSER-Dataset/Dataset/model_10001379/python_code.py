...
class _OrderDetail:
    ...
    def __init__(self, _productid: int, _quantity: int, _orderdate: date, _totalamount: int, _userid: int, OrderId: int, paymentInfoId: int, _contains7: set["_Product"] = None, receives9: "Farmer" = None, _PaymentInfo11: "_PaymentInfo" = None):
...
class _ProductType:
    ...
    def __init__(self, _type: str, _has_products4: set["_Product"] = None, farmer13: "Farmer" = None):
        self._type = _type
    ...
    def farmer13(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"__ProductType__farmer13", None)
...
class _Product:
    ...
    def __init__(self, _name: str, _description: str, _stock: int, _price: int, _producttypeid: int, _type_of5: "_ProductType" = None, _is_in6: set["_OrderDetail"] = None):
        self._name = _name
    ...
    def _is_in6(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"__Product___is_in6", None)
...
class _Shipment:
    ...
    def __init__(self, shipmentNumber: int, orderId: int, _Delivers2: "Farmer" = None):
    ...
    def _Delivers2(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"__Shipment___Delivers2", None)
...
class Farmer:
    ...
    def __init__(self, _username: str, _address: str, _phone: int, _email: str, _usertypeid: int, _logincredentialsid: int, _logs_in_with1: "_LoginCredential" = None, _ships3: set["_Shipment"] = None, _orders8: set["_OrderDetail"] = None, _Add_Product_Type12: set["_ProductType"] = None):
    ...
    def _logs_in_with1(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Farmer___logs_in_with1", None)
    ...
    def _ships3(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Farmer___ships3", None)
    ...
    def _orders8(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Farmer___orders8", None)
    ...
    def _Add_Product_Type12(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Farmer___Add_Product_Type12", None)
...
class _LoginCredential:
    ...
    def __init__(self, _loginid: str, _password: str, _for0: "Farmer" = None):
