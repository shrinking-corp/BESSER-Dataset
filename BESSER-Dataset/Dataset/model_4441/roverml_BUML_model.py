...
# Classes
roverml_System = Class(name="roverml_System")
NamedElement = Class(name="NamedElement")
roverml_Program = Class(name="roverml_Program")
roverml_Rover = Class(name="roverml_Rover")
roverml_Component = Class(name="roverml_Component")
roverml_Block = Class(name="roverml_Block")
roverml_NamedElement = Class(name="roverml_NamedElement", is_abstract=True)
roverml_Sensor = Class(name="roverml_Sensor")
Component = Class(name="Component")
roverml_Actuator = Class(name="roverml_Actuator")
roverml_GPS = Class(name="roverml_GPS")
Sensor = Class(name="Sensor")
roverml_Compass = Class(name="roverml_Compass")
roverml_DistanceSensor = Class(name="roverml_DistanceSensor")
roverml_Motor = Class(name="roverml_Motor")
Actuator = Class(name="Actuator")
roverml_Light = Class(name="roverml_Light")
roverml_Transition = Class(name="roverml_Transition")
roverml_Velocity = Class(name="roverml_Velocity")
roverml_Command = Class(name="roverml_Command")
roverml_SetLightColor = Class(name="roverml_SetLightColor")
Command = Class(name="Command")
roverml_Wait = Class(name="roverml_Wait")
roverml_Time = Class(name="roverml_Time")
roverml_Move = Class(name="roverml_Move")
roverml_Length = Class(name="roverml_Length")
roverml_Rotate = Class(name="roverml_Rotate")
roverml_Angle = Class(name="roverml_Angle")
roverml_Terminate = Class(name="roverml_Terminate")
roverml_Repeat = Class(name="roverml_Repeat")
roverml_Triggered = Class(name="roverml_Triggered")
Transition = Class(name="Transition")
roverml_Regular = Class(name="roverml_Regular")
roverml_DistanceSensorTrigger = Class(name="roverml_DistanceSensorTrigger")
Triggered = Class(name="Triggered")
roverml_CompassTrigger = Class(name="roverml_CompassTrigger")
roverml_GPSTrigger = Class(name="roverml_GPSTrigger")
roverml_Position = Class(name="roverml_Position")
roverml_Quantity = Class(name="roverml_Quantity")
roverml_SingleQuantity = Class(name="roverml_SingleQuantity")
...
roverml_GPS.attributes={roverml_GPS_y, roverml_GPS_x}
...
roverml_Position.attributes={roverml_Position_y, roverml_Position_x}
...
domain_model = DomainModel(
    name="roverml",
    types={roverml_System, NamedElement, roverml_Program, roverml_Rover, roverml_Component, roverml_Block, roverml_NamedElement, roverml_Sensor, Component, roverml_Actuator, roverml_GPS, Sensor, roverml_Compass, roverml_DistanceSensor, roverml_Motor, Actuator, roverml_Light, roverml_Transition, roverml_Velocity, roverml_Command, roverml_SetLightColor, Command, roverml_Wait, roverml_Time, roverml_Move, roverml_Length, roverml_Rotate, roverml_Angle, roverml_Terminate, roverml_Repeat, roverml_Triggered, Transition, roverml_Regular, roverml_DistanceSensorTrigger, Triggered, roverml_CompassTrigger, roverml_GPSTrigger, roverml_Position, roverml_Quantity, roverml_SingleQuantity, Quantity, SingleQuantity, Colours, TimeUnits, VelocityUnits, LengthUnits, AngleUnits},
    associations={programs0, rovers1, components3, roverExec5, blocks8, transitions10, velocityUnits24, commands12, outgoingTransitions14, incomingTransitions15, components17, source20, target21, timeUnit23, compass36, lengthUnits25, angleUnits27, commands28, length30, distancesensor32, angles34, position38, gps39},
    generalizations={gen_roverml_System_NamedElement, gen_roverml_Rover_NamedElement, gen_roverml_Program_NamedElement, gen_roverml_Component_NamedElement, gen_roverml_Sensor_Component, gen_roverml_Actuator_Component, gen_roverml_GPS_Sensor, gen_roverml_Compass_Sensor, gen_roverml_DistanceSensor_Sensor, gen_roverml_Motor_Actuator, gen_roverml_Light_Actuator, gen_roverml_SetLightColor_Command, gen_roverml_Wait_Command, gen_roverml_Move_Command, gen_roverml_Rotate_Command, gen_roverml_Terminate_Command, gen_roverml_Repeat_Command, gen_roverml_Triggered_Transition, gen_roverml_Regular_Transition, gen_roverml_DistanceSensorTrigger_Triggered, gen_roverml_CompassTrigger_Triggered, gen_roverml_GPSTrigger_Triggered, gen_roverml_SingleQuantity_Quantity, gen_roverml_Position_Quantity, gen_roverml_Time_SingleQuantity, gen_roverml_Velocity_SingleQuantity, gen_roverml_Length_SingleQuantity, gen_roverml_Angle_SingleQuantity},
    metadata=None
)
