...
public class SimpleHierarchicalStateMachine_StateMachine  {
    ...
    public SimpleHierarchicalStateMachine_StateMachine(
        String name        ArrayList<SimpleHierarchicalStateMachine_Transition> simplehierarchicalstatemachine_transitions,        ArrayList<SimpleHierarchicalStateMachine_State> simplehierarchicalstatemachine_states    ) {
        this.name = name;
