...
def test_hyp_simplehierarchicalstatemachine_statemachine_name_setter(instance):
...
def test_SimpleHierarchicalStateMachine_StateMachine_name_value_roundtrip():
    instance = SimpleHierarchicalStateMachine_StateMachine(name="sample_text")
    assert instance.name == "sample_text"
    instance.name = "sample_text_2"
    assert instance.name == "sample_text_2"
...
def test_assoc_ownedState9_link_reassign_clear():
    a = SimpleHierarchicalStateMachine_StateMachine(name="sample_text")
    b1 = SimpleHierarchicalStateMachine_State(name="sample_text")
    b2 = SimpleHierarchicalStateMachine_State(name="sample_text_2")
    _safe_set(a, 'SimpleHierarchicalStateMachine_StateMachine', {b1})
    assert _is_linked(a, 'SimpleHierarchicalStateMachine_StateMachine', b1)
    if hasattr(b1, 'SimpleHierarchicalStateMachine_State10'):
        assert _is_linked(b1, 'SimpleHierarchicalStateMachine_State10', a)
    _safe_set(a, 'SimpleHierarchicalStateMachine_StateMachine', {b2})
    assert _is_linked(a, 'SimpleHierarchicalStateMachine_StateMachine', b2)
    if hasattr(b1, 'SimpleHierarchicalStateMachine_State10'):
        assert not _is_linked(b1, 'SimpleHierarchicalStateMachine_State10', a)
    if hasattr(b2, 'SimpleHierarchicalStateMachine_State10'):
        assert _is_linked(b2, 'SimpleHierarchicalStateMachine_State10', a)
    _safe_set(a, 'SimpleHierarchicalStateMachine_StateMachine', set())
    assert not _is_linked(a, 'SimpleHierarchicalStateMachine_StateMachine', b2)
    if hasattr(b2, 'SimpleHierarchicalStateMachine_State10'):
        assert not _is_linked(b2, 'SimpleHierarchicalStateMachine_State10', a)
...
def test_assoc_ownedTransition11_link_reassign_clear():
    ...
    b1 = SimpleHierarchicalStateMachine_StateMachine(name="sample_text")
    b2 = SimpleHierarchicalStateMachine_StateMachine(name="sample_text_2")
...
SimpleHierarchicalStateMachine_StateMachine_strategy = st.builds(SimpleHierarchicalStateMachine_StateMachine, name=safe_text)
@given(instance=SimpleHierarchicalStateMachine_StateMachine_strategy)
@settings(max_examples=25)
