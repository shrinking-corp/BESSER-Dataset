...
class SimpleHierarchicalStateMachine_StateMachine:
    ...
    def __init__(self, name: str, SimpleHierarchicalStateMachine_StateMachine: set["SimpleHierarchicalStateMachine_State"] = None, SimpleHierarchicalStateMachine_StateMachine12: set["SimpleHierarchicalStateMachine_Transition"] = None):
        self.name = name
        self.SimpleHierarchicalStateMachine_StateMachine = SimpleHierarchicalStateMachine_StateMachine if SimpleHierarchicalStateMachine_StateMachine is not None else set()
        self.SimpleHierarchicalStateMachine_StateMachine12 = SimpleHierarchicalStateMachine_StateMachine12 if SimpleHierarchicalStateMachine_StateMachine12 is not None else set()
    ...
    @property
    def SimpleHierarchicalStateMachine_StateMachine12(self):
        return self.__SimpleHierarchicalStateMachine_StateMachine12

    @SimpleHierarchicalStateMachine_StateMachine12.setter
    def SimpleHierarchicalStateMachine_StateMachine12(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_SimpleHierarchicalStateMachine_StateMachine__SimpleHierarchicalStateMachine_StateMachine12", None)
        self.__SimpleHierarchicalStateMachine_StateMachine12 = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "SimpleHierarchicalStateMachine_Transition13"):
                    opp_val = getattr(item, "SimpleHierarchicalStateMachine_Transition13", None)
                    
                    if opp_val == self:
                        setattr(item, "SimpleHierarchicalStateMachine_Transition13", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "SimpleHierarchicalStateMachine_Transition13"):
                    ...
                    setattr(item, "SimpleHierarchicalStateMachine_Transition13", self)
                    

    @property
    def SimpleHierarchicalStateMachine_StateMachine(self):
        return self.__SimpleHierarchicalStateMachine_StateMachine

    @SimpleHierarchicalStateMachine_StateMachine.setter
    def SimpleHierarchicalStateMachine_StateMachine(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_SimpleHierarchicalStateMachine_StateMachine__SimpleHierarchicalStateMachine_StateMachine", None)
        self.__SimpleHierarchicalStateMachine_StateMachine = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "SimpleHierarchicalStateMachine_State10"):
                    opp_val = getattr(item, "SimpleHierarchicalStateMachine_State10", None)
                    
                    if opp_val == self:
                        setattr(item, "SimpleHierarchicalStateMachine_State10", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "SimpleHierarchicalStateMachine_State10"):
                    ...
                    setattr(item, "SimpleHierarchicalStateMachine_State10", self)
