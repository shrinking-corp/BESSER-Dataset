...
# Classes
Logo_Primitive = Class(name="Logo_Primitive", is_abstract=True)
Instruction = Class(name="Instruction")
Logo_Forward = Class(name="Logo_Forward")
Primitive = Class(name="Primitive")
Logo_Expression = Class(name="Logo_Expression", is_abstract=True)
Logo_Back = Class(name="Logo_Back")
Logo_Left = Class(name="Logo_Left")
Logo_Right = Class(name="Logo_Right")
Logo_Literal = Class(name="Logo_Literal", is_abstract=True)
Expression = Class(name="Expression")
Logo_Integer = Class(name="Logo_Integer")
Literal = Class(name="Literal")
Logo_Void = Class(name="Logo_Void")
Logo_Double = Class(name="Logo_Double")
Logo_LogoProgram = Class(name="Logo_LogoProgram")
Logo_Instruction = Class(name="Logo_Instruction", is_abstract=True)
Logo_VarReference = Class(name="Logo_VarReference")
Logo_ControlStructure = Class(name="Logo_ControlStructure", is_abstract=True)
Logo_If = Class(name="Logo_If")
ControlStructure = Class(name="ControlStructure")
Logo_Block = Class(name="Logo_Block")
Logo_While = Class(name="Logo_While")
Logo_BinaryExpr = Class(name="Logo_BinaryExpr", is_abstract=True)
Logo_String = Class(name="Logo_String")
Logo_Boolean = Class(name="Logo_Boolean")
Logo_VarDecl = Class(name="Logo_VarDecl")
Logo_Procedure = Class(name="Logo_Procedure")
Logo_ProcedureCall = Class(name="Logo_ProcedureCall")
Logo_Assignation = Class(name="Logo_Assignation")
Logo_ArithmeticExpr = Class(name="Logo_ArithmeticExpr")
BinaryExpr = Class(name="BinaryExpr")
Logo_BooleanExpr = Class(name="Logo_BooleanExpr")
...
domain_model = DomainModel(
    name="Logo",
    types={Logo_Primitive, Instruction, Logo_Forward, Primitive, Logo_Expression, Logo_Back, Logo_Left, Logo_Right, Logo_Literal, Expression, Logo_Integer, Literal, Logo_Void, Logo_Double, Logo_LogoProgram, Logo_Instruction, Logo_VarReference, Logo_ControlStructure, Logo_If, ControlStructure, Logo_Block, Logo_While, Logo_BinaryExpr, Logo_String, Logo_Boolean, Logo_VarDecl, Logo_Procedure, Logo_ProcedureCall, Logo_Assignation, Logo_ArithmeticExpr, BinaryExpr, Logo_BooleanExpr, BooleanOperator, ArithmeticOperator},
    associations={steps1, steps2, angle4, angle6, instructions0, expr8, ref10, body12, condition13, instructions16, body19, guard21, leftExpr24, rightExpr26, body29, returnType31, ref33, ref35, expr37},
    generalizations={gen_Logo_Primitive_Instruction, gen_Logo_Forward_Primitive, gen_Logo_Back_Primitive, gen_Logo_Left_Primitive, gen_Logo_Right_Primitive, gen_Logo_Expression_Instruction, gen_Logo_Literal_Expression, gen_Logo_Integer_Literal, gen_Logo_Void_Literal, gen_Logo_Double_Literal, gen_Logo_VarReference_Expression, gen_Logo_ControlStructure_Instruction, gen_Logo_If_ControlStructure, gen_Logo_Block_ControlStructure, gen_Logo_While_ControlStructure, gen_Logo_BinaryExpr_Expression, gen_Logo_String_Literal, gen_Logo_Boolean_Literal, gen_Logo_VarDecl_Instruction, gen_Logo_Procedure_Instruction, gen_Logo_ProcedureCall_Expression, gen_Logo_Assignation_Instruction, gen_Logo_ArithmeticExpr_BinaryExpr, gen_Logo_BooleanExpr_BinaryExpr},
    metadata=None
)
