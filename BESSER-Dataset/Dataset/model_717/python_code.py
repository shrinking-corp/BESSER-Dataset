...
class uml_BehavioralFeature(Feature, Namespace):
    ...
    def __init__(self, isAbstract: str, uml_BehavioralFeature: set["uml_Parameter"] = None, uml_BehavioralFeature82: set["uml_Type"] = None):
...
class uml_Operation(BehavioralFeature):
    ...
    def __init__(self, isQuery: str, isOrdered: str, isUnique: str, lower: str, upper: str, ownedOperation: "uml_Class" = None, uml_Operation: "uml_Parameter" = None, uml_Operation78: "uml_Operation" = None, uml_Operation76: set["uml_Operation"] = None, Operation: "uml_Class" = None):
...
class uml_Parameter:
    ...
    def __init__(self, default: str, isException: str, isStream: str, uml_Parameter: "uml_Operation" = None, uml_Parameter72: "uml_ValueSpecification" = None, uml_Parameter80: "uml_BehavioralFeature" = None):
...
class uml_Feature(ABC):
    ...
    def __init__(self, isStatic: str, feature: set["uml_Classifier"] = None, Feature: "uml_Classifier" = None):
...
class uml_Property:
    ...
    def __init__(self, name: str, uml_Property64: "uml_Classifier" = None, uml_Property74: "uml_Class" = None, uml_Property93: "uml_Class" = None, uml_Property: "uml_Association" = None, uml_Property45: "uml_Association" = None, uml_Property51: "uml_Association" = None):
        self.name = name
...
class uml_Class(Classifier):
    ...
    def __init__(self, isActive: str, name: str, Class: "uml_Operation" = None, uml_Class: "uml_Property" = None, uml_Class92: set["uml_Property"] = None, uml_Class85: set["uml_Classifier"] = None, class_: set["uml_Operation"] = None, uml_Class90: "uml_Class" = None, uml_Class88: set["uml_Class"] = None, uml_Class95: set["uml_Generalization"] = None):
...
class uml_Classifier(Type):
    ...
    def __init__(self, isAbstract: str, substitutingClassifier: set["uml_Substitution"] = None, uml_Classifier63: set["uml_Property"] = None, Classifier: "uml_Feature" = None, Classifier69: "uml_Substitution" = None, uml_Classifier86: "uml_Class" = None, uml_Classifier98: "uml_Generalization" = None, uml_Classifier101: "uml_Generalization" = None, uml_Classifier67: "uml_Substitution" = None, featuringClassifier: set["uml_Feature"] = None, uml_Classifier: set["uml_NamedElement"] = None, uml_Classifier57: "uml_Classifier" = None, uml_Classifier55: set["uml_Classifier"] = None, uml_Classifier60: "uml_Classifier" = None, uml_Classifier58: set["uml_Classifier"] = None):
        self.isAbstract = isAbstract
...
class uml_Association(Classifier, Relationship):
    ...
    def __init__(self, isDerived: str, uml_Association: set["uml_Property"] = None, uml_Association44: set["uml_Property"] = None, uml_Association47: set["uml_Type"] = None, uml_Association50: set["uml_Property"] = None):
...
class uml_Package(PackageableElement):
    ...
    def __init__(self, name: str, uml_Package: set["uml_PackageableElement"] = None, package: set["uml_Type"] = None, Package: "uml_Type" = None, uml_Package37: "uml_PackageImport" = None):
        self.name = name
...
class uml_NamedElement(Element):
    ...
    def __init__(self, name: str, visibility: str, qualifiedName: str, client: set["uml_Dependency"] = None, ownedMember: "uml_Namespace" = None, NamedElement: "uml_Dependency" = None, uml_NamedElement: "uml_Dependency" = None, NamedElement31: "uml_Namespace" = None, uml_NamedElement26: "uml_Namespace" = None, uml_NamedElement54: "uml_Classifier" = None):
        self.name = name
        self.visibility = visibility
