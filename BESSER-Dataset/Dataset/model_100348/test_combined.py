...
def test_hyp_minuml1_activity_is_not_abstract():
    assert not inspect.isabstract(minuml1_Activity)


def test_hyp_minuml1_activity_constructor_exists():
    assert callable(minuml1_Activity.__init__)


def test_hyp_minuml1_activity_constructor_args():
    sig = inspect.signature(minuml1_Activity.__init__)
    params = list(sig.parameters.keys())
...
minuml1_Activity_strategy = st.builds(
    minuml1_Activity,
)
...
def test_minuml1_Activity_isa_StateMachine():
    instance = minuml1_Activity()
...
minuml1_Activity_strategy = st.builds(minuml1_Activity)
@given(instance=minuml1_Activity_strategy)
@settings(max_examples=25)
def test_minuml1_Activity_instantiation(instance):
    assert isinstance(instance, minuml1_Activity)
