...
domain_model = DomainModel(
    name="database",
    types={database_DataBase, database_Table, NamedElement, database_Column, database_Index, database_PrimaryKey, Index, database_NamedElement, database_Unique},
    associations={tables0, dataBase1, columns4, indexes6, primaryKey8, columns12, uniques10},
    generalizations={gen_database_Table_NamedElement, gen_database_PrimaryKey_Index, gen_database_Index_NamedElement, gen_database_Unique_Index, gen_database_Column_NamedElement},
    metadata=None
)
