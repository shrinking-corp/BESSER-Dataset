...
class database_Column(NamedElement):
    ...
    def __init__(self, collation: str, type: str, nullable: bool, default: str, length: int, database_Column: "database_Table" = None, database_Column14: "database_Index" = None):
