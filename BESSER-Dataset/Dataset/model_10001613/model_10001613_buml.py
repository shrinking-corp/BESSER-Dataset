...
E_G: BinaryAssociation = BinaryAssociation(
    name="E_G",
    ends={
        Property(name="g4", type=G, multiplicity=Multiplicity(0, 1)),
        Property(name="e5", type=E, multiplicity=Multiplicity(0, 1))
    }
)

# Domain Model
domain_model = DomainModel(
    name="_JNKD8OwTEei9dNtZPq67hQ",
    types={A, B, C, E, F, G},
    associations={A_B, B_C, E_G},
    generalizations={},
    metadata=None
)
