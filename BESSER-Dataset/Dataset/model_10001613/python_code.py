...
class E:
    ...
    def __init__(self, attE: str, g4: "G" = None):
        self.attE = attE
        self.g4 = g4
    ...
    def g4(self, value):
        ...
        old_value = getattr(self, f"_E__g4", None)
        self.__g4 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "e5"):
                opp_val = getattr(old_value, "e5", None)
                if opp_val == self:
                    setattr(old_value, "e5", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "e5"):
                opp_val = getattr(value, "e5", None)
                setattr(value, "e5", self)
