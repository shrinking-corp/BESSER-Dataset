...
public class Leave  {
    ...
    public Leave(
        String Leave_Title,        int Leave_NoOfDays,        String Leave_detail,        LocalDate Leave_EndDate,        int Emp_Id,        int leave_id,        LocalDate Leave_StartDate,        String Leave_Status,        LocalDate Leave_ApplyDate    ) {
