...
Employee.attributes={Employee_Emp_Email, Employee_Emp_DOB, Employee_Emp_ContactNo, Employee_Emp_Name, Employee_Emp_Id, Employee_Emp_Address, Employee_Emp_Date_Of_Joint, Employee_Emp_NIC, Employee_Emp_Position, Employee_Emp_Department, Employee_Emp_Salary}
...
Salary.attributes={Salary_Sly_Netgross, Salary_Sly_Basic, Salary_Emp_Id, Salary_Sly_Increment, Salary_Sly_Decrement, Salary_OverTime}
...
Leave.attributes={Leave_Leave_StartDate, Leave_leave_id, Leave_Leave_detail, Leave_Emp_Id, Leave_Leave_EndDate, Leave_Leave_NoOfDays, Leave_Leave_Status, Leave_Leave_Title, Leave_Leave_ApplyDate}
...
domain_model = DomainModel(
    name="_193df438_f918_424c_9169_d427c4407e87",
