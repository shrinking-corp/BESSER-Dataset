...
class Leave:
    ...
    def __init__(self, Leave_NoOfDays: int, Leave_Status: str, leave_id: int, Emp_Id: int, Leave_Title: str, Leave_detail: str, Leave_ApplyDate: date, Leave_StartDate: date, Leave_EndDate: date, employee1: "Employee" = None):
