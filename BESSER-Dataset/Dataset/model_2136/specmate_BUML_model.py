...
# Classes
model_base_INamed = Class(name="model_base_INamed", is_abstract=True)
model_base_IDescribed = Class(name="model_base_IDescribed", is_abstract=True)
model_base_IExternal = Class(name="model_base_IExternal")
model_base_ISpecmatePositionableModelObject = Class(name="model_base_ISpecmatePositionableModelObject", is_abstract=True)
model_base_IModelConnection = Class(name="model_base_IModelConnection")
IModelNode = Class(name="IModelNode")
model_base_IModelNode = Class(name="model_base_IModelNode")
ISpecmatePositionableModelObject = Class(name="ISpecmatePositionableModelObject")
IModelConnection = Class(name="IModelConnection")
model_base_IID = Class(name="model_base_IID", is_abstract=True)
model_base_IContentElement = Class(name="model_base_IContentElement", is_abstract=True)
base_IID = Class(name="base_IID")
base_INamed = Class(name="base_INamed")
base_IDescribed = Class(name="base_IDescribed")
base_IRecycled = Class(name="base_IRecycled")
model_base_IContainer = Class(name="model_base_IContainer", is_abstract=True)
IContentElement = Class(name="IContentElement")
model_base_ISpecmateModelObject = Class(name="model_base_ISpecmateModelObject", is_abstract=True)
base_IContainer = Class(name="base_IContainer")
base_ITracingElement = Class(name="base_ITracingElement")
model_base_Folder = Class(name="model_base_Folder")
ISpecmateModelObject = Class(name="ISpecmateModelObject")
model_base_IPositionable = Class(name="model_base_IPositionable", is_abstract=True)
model_requirements_CEGConnection = Class(name="model_requirements_CEGConnection")
model_base_ITracingElement = Class(name="model_base_ITracingElement")
ITracingElement = Class(name="ITracingElement")
model_base_IRecycled = Class(name="model_base_IRecycled", is_abstract=True)
model_requirements_Requirement = Class(name="model_requirements_Requirement")
base_ISpecmateModelObject = Class(name="base_ISpecmateModelObject")
base_IExternal = Class(name="base_IExternal")
model_requirements_CEGModel = Class(name="model_requirements_CEGModel")
model_requirements_CEGNode = Class(name="model_requirements_CEGNode")
model_testspecification_TestStep = Class(name="model_testspecification_TestStep")
base_IContentElement = Class(name="base_IContentElement")
model_processes_Process = Class(name="model_processes_Process")
model_processes_ProcessNode = Class(name="model_processes_ProcessNode", is_abstract=True)
model_processes_ProcessStep = Class(name="model_processes_ProcessStep")
ProcessNode = Class(name="ProcessNode")
model_testspecification_TestSpecification = Class(name="model_testspecification_TestSpecification")
IContainer = Class(name="IContainer")
model_testspecification_TestParameter = Class(name="model_testspecification_TestParameter")
ParameterAssignment = Class(name="ParameterAssignment")
model_testspecification_TestCase = Class(name="model_testspecification_TestCase")
base_IPositionable = Class(name="base_IPositionable")
model_testspecification_ParameterAssignment = Class(name="model_testspecification_ParameterAssignment")
TestParameter = Class(name="TestParameter")
model_testspecification_TestProcedure = Class(name="model_testspecification_TestProcedure")
Change = Class(name="Change")
model_history_Change = Class(name="model_history_Change")
model_administration_Status = Class(name="model_administration_Status")
model_processes_ProcessDecision = Class(name="model_processes_ProcessDecision")
model_processes_ProcessConnection = Class(name="model_processes_ProcessConnection")
model_processes_ProcessStart = Class(name="model_processes_ProcessStart")
model_processes_ProcessEnd = Class(name="model_processes_ProcessEnd")
model_history_History = Class(name="model_history_History")
HistoryEntry = Class(name="HistoryEntry")
model_history_HistoryEntry = Class(name="model_history_HistoryEntry")
model_export_Export = Class(name="model_export_Export")
INamed = Class(name="INamed")
model_administration_ProblemDetail = Class(name="model_administration_ProblemDetail")
model_batch_BatchOperation = Class(name="model_batch_BatchOperation")
Operation = Class(name="Operation")
model_batch_Operation = Class(name="model_batch_Operation")
...
model_base_IExternal.attributes={model_base_IExternal_live, model_base_IExternal_extId2, model_base_IExternal_extId, model_base_IExternal_source}
...
model_base_ISpecmatePositionableModelObject.attributes={model_base_ISpecmatePositionableModelObject_width, model_base_ISpecmatePositionableModelObject_height, model_base_ISpecmatePositionableModelObject_x, model_base_ISpecmatePositionableModelObject_y}
...
model_requirements_Requirement.attributes={model_requirements_Requirement_status, model_requirements_Requirement_implementingUnit, model_requirements_Requirement_implementingITTeam, model_requirements_Requirement_implementingBOTeam, model_requirements_Requirement_platform, model_requirements_Requirement_tac, model_requirements_Requirement_numberOfTests, model_requirements_Requirement_plannedRelease, model_requirements_Requirement_isRegressionRequirement}
...
model_requirements_CEGNode.attributes={model_requirements_CEGNode_type, model_requirements_CEGNode_condition, model_requirements_CEGNode_variable}
...
model_history_Change.attributes={model_history_Change_objectName, model_history_Change_isCreate, model_history_Change_oldValue, model_history_Change_objectType, model_history_Change_isDelete, model_history_Change_newValue, model_history_Change_feature}
...
model_processes_ProcessConnection.attributes={model_processes_ProcessConnection_labelX, model_processes_ProcessConnection_labelY, model_processes_ProcessConnection_condition}
...
model_history_HistoryEntry.attributes={model_history_HistoryEntry_timestamp, model_history_HistoryEntry_deletedObjects, model_history_HistoryEntry_user, model_history_HistoryEntry_comment}
...
model_administration_ProblemDetail.attributes={model_administration_ProblemDetail_ecode, model_administration_ProblemDetail_detail, model_administration_ProblemDetail_instance, model_administration_ProblemDetail_status}
...
source1: BinaryAssociation = BinaryAssociation(
    name="source1",
    ends={
        Property(name="IModelNode", type=model_base_IModelConnection, multiplicity=Multiplicity(1, 1)),
        Property(name="outgoingConnections", type=IModelNode, multiplicity=Multiplicity(0, 1))
    }
)
target2: BinaryAssociation = BinaryAssociation(
    name="target2",
    ends={
        Property(name="IModelNode3", type=model_base_IModelConnection, multiplicity=Multiplicity(1, 1)),
        Property(name="incomingConnections", type=IModelNode, multiplicity=Multiplicity(0, 1))
    }
)
outgoingConnections4: BinaryAssociation = BinaryAssociation(
    name="outgoingConnections4",
    ends={
        Property(name="IModelConnection", type=model_base_IModelNode, multiplicity=Multiplicity(1, 1)),
        Property(name="source", type=IModelConnection, multiplicity=Multiplicity(0, 9999))
    }
)
incomingConnections5: BinaryAssociation = BinaryAssociation(
    name="incomingConnections5",
    ends={
        Property(name="IModelConnection6", type=model_base_IModelNode, multiplicity=Multiplicity(1, 1)),
        Property(name="target", type=IModelConnection, multiplicity=Multiplicity(0, 9999))
    }
)
...
tracesTo7: BinaryAssociation = BinaryAssociation(
    name="tracesTo7",
    ends={
        Property(name="ITracingElement", type=model_base_ITracingElement, multiplicity=Multiplicity(1, 1)),
        Property(name="tracesFrom", type=ITracingElement, multiplicity=Multiplicity(0, 9999))
    }
)
tracesFrom8: BinaryAssociation = BinaryAssociation(
    name="tracesFrom8",
    ends={
        Property(name="ITracingElement9", type=model_base_ITracingElement, multiplicity=Multiplicity(1, 1)),
        Property(name="tracesTo", type=ITracingElement, multiplicity=Multiplicity(0, 9999))
    }
)
referencedTestParameters12: BinaryAssociation = BinaryAssociation(
    name="referencedTestParameters12",
    ends={
        Property(name="TestParameter13", type=model_testspecification_TestStep, multiplicity=Multiplicity(1, 1)),
        Property(name="model_testspecification_TestStep", type=TestParameter, multiplicity=Multiplicity(0, 9999))
    }
)
assignments10: BinaryAssociation = BinaryAssociation(
    name="assignments10",
    ends={
        Property(name="ParameterAssignment", type=model_testspecification_TestParameter, multiplicity=Multiplicity(1, 1)),
        Property(name="parameter", type=ParameterAssignment, multiplicity=Multiplicity(0, 9999))
    }
)
parameter11: BinaryAssociation = BinaryAssociation(
    name="parameter11",
    ends={
        Property(name="TestParameter", type=model_testspecification_ParameterAssignment, multiplicity=Multiplicity(1, 1)),
        Property(name="assignments", type=TestParameter, multiplicity=Multiplicity(0, 1))
    }
)
changes15: BinaryAssociation = BinaryAssociation(
    name="changes15",
    ends={
...
target17: BinaryAssociation = BinaryAssociation(
    name="target17",
    ends={
        Property(name="IContentElement18", type=model_batch_Operation, multiplicity=Multiplicity(1, 1)),
...
value19: BinaryAssociation = BinaryAssociation(
    name="value19",
    ends={
        Property(name="IContentElement21", type=model_batch_Operation, multiplicity=Multiplicity(1, 1)),
        Property(name="model_batch_Operation20", type=IContentElement, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
...
domain_model = DomainModel(
    name="model",
    types={model_base_INamed, model_base_IDescribed, model_base_IExternal, model_base_ISpecmatePositionableModelObject, model_base_IModelConnection, IModelNode, model_base_IModelNode, ISpecmatePositionableModelObject, IModelConnection, model_base_IID, model_base_IContentElement, base_IID, base_INamed, base_IDescribed, base_IRecycled, model_base_IContainer, IContentElement, model_base_ISpecmateModelObject, base_IContainer, base_ITracingElement, model_base_Folder, ISpecmateModelObject, model_base_IPositionable, model_requirements_CEGConnection, model_base_ITracingElement, ITracingElement, model_base_IRecycled, model_requirements_Requirement, base_ISpecmateModelObject, base_IExternal, model_requirements_CEGModel, model_requirements_CEGNode, model_testspecification_TestStep, base_IContentElement, model_processes_Process, model_processes_ProcessNode, model_processes_ProcessStep, ProcessNode, model_testspecification_TestSpecification, IContainer, model_testspecification_TestParameter, ParameterAssignment, model_testspecification_TestCase, base_IPositionable, model_testspecification_ParameterAssignment, TestParameter, model_testspecification_TestProcedure, Change, model_history_Change, model_administration_Status, model_processes_ProcessDecision, model_processes_ProcessConnection, model_processes_ProcessStart, model_processes_ProcessEnd, model_history_History, HistoryEntry, model_history_HistoryEntry, model_export_Export, INamed, model_administration_ProblemDetail, model_batch_BatchOperation, Operation, model_batch_Operation, NodeType, ParameterType, OperationType, ErrorCode},
    associations={source1, target2, outgoingConnections4, incomingConnections5, contents0, tracesTo7, tracesFrom8, referencedTestParameters12, assignments10, parameter11, changes15, entries14, operations16, target17, value19},
    generalizations={gen_model_base_ISpecmatePositionableModelObject_ISpecmateModelObject, gen_model_base_IModelConnection_ISpecmateModelObject, gen_model_base_IModelNode_ISpecmatePositionableModelObject, gen_model_base_IContentElement_base_IID, gen_model_base_IContentElement_base_INamed, gen_model_base_IContentElement_base_IDescribed, gen_model_base_IContentElement_base_IRecycled, gen_model_base_IContainer_IContentElement, gen_model_base_ISpecmateModelObject_base_IContainer, gen_model_base_ISpecmateModelObject_base_ITracingElement, gen_model_base_Folder_ISpecmateModelObject, gen_model_requirements_CEGNode_IModelNode, gen_model_requirements_CEGConnection_IModelConnection, gen_model_requirements_Requirement_base_ISpecmateModelObject, gen_model_requirements_Requirement_base_IExternal, gen_model_requirements_CEGModel_ISpecmateModelObject, gen_model_testspecification_TestStep_base_IContentElement, gen_model_testspecification_TestStep_base_IPositionable, gen_model_processes_Process_IContainer, gen_model_processes_ProcessNode_IModelNode, gen_model_processes_ProcessStep_ProcessNode, gen_model_testspecification_TestSpecification_IContainer, gen_model_testspecification_TestParameter_IContentElement, gen_model_testspecification_TestCase_base_IContainer, gen_model_testspecification_TestCase_base_IPositionable, gen_model_testspecification_ParameterAssignment_IContentElement, gen_model_testspecification_TestProcedure_base_IContainer, gen_model_testspecification_TestProcedure_base_IExternal, gen_model_processes_ProcessDecision_ProcessNode, gen_model_processes_ProcessConnection_IModelConnection, gen_model_processes_ProcessStart_ProcessNode, gen_model_processes_ProcessEnd_ProcessNode, gen_model_export_Export_INamed},
    metadata=None
)
