...
A1_allA: Property = Property(name="allA", type=StringType)
A1.attributes={A1_allA}
...
C1_att2: Property = Property(name="att2", type=BooleanType)
C1.attributes={C1_att2, C1_attC1}
...
domain_model = DomainModel(
    name="_789712f7_6a44_4e83_bb3b_6148a901014b",
    types={A, B, C, R, Z, Y, A1, B1, C1, C2, C11},
