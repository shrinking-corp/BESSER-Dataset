...
def test_oo_remove_empty_C_isa_B():
    instance = oo_remove_empty_C()
...
oo_remove_empty_A_strategy = st.builds(oo_remove_empty_A)
...
oo_remove_empty_B_strategy = st.builds(oo_remove_empty_B)
...
oo_remove_empty_C_strategy = st.builds(oo_remove_empty_C)
