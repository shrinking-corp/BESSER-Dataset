...
# Classes
ctmc_CTMC = Class(name="ctmc_CTMC")
ctmc_State = Class(name="ctmc_State")
ctmc_Label = Class(name="ctmc_Label")
ctmc_Transition = Class(name="ctmc_Transition")
...
ctmc_Transition.attributes={ctmc_Transition_name, ctmc_Transition_duration, ctmc_Transition_probability}
...
out2: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_", type=ctmc_Transition, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
to6: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="in_", type=ctmc_State, multiplicity=Multiplicity(1, 1))
    }
)
...
domain_model = DomainModel(
    name="ctmc",
    types={ctmc_CTMC, ctmc_State, ctmc_Label, ctmc_Transition},
    associations={states0, labels1, out2, in_3, from_5, to6, state8},
    generalizations={},
    metadata=None
)
