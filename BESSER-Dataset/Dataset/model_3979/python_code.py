...
class ctmc_Transition:
    ...
    def __init__(self, name: str, probability: float, duration: float, Transition: "ctmc_State" = None, Transition4: "ctmc_State" = None, out: "ctmc_State" = None, in_: "ctmc_State" = None):
        self.name = name
    ...
    def in_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_ctmc_Transition__in_", None)
        self.__in_ = value
...
class ctmc_State:
    ...
    def __init__(self, name: str, exitRate: float, ctmc_State: "ctmc_CTMC" = None, state: set["ctmc_Label"] = None, from_: set["ctmc_Transition"] = None, to: set["ctmc_Transition"] = None, State: "ctmc_Transition" = None, State7: "ctmc_Transition" = None, State9: "ctmc_Label" = None):
        self.name = name
