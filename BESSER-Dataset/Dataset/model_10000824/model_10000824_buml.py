...
Qaboos_Airways.attributes={Qaboos_Airways_Comp_Commercial_NO, Qaboos_Airways_Comp_location}
...
Passengers.attributes={Passengers_Passenger_Details, Passengers_passenger_name, Passengers_Passenger_TKT_No}
...
Flight.attributes={Flight_Flgt_NO, Flight_Flgt_Details}
...
Offers.attributes={Offers_Offer_Det, Offers_Offer_NO, Offers_Offer_Expiry_Date}
...
Child.attributes={Child_Child_Seat_Price, Child_Child_ID}
...
Seats.attributes={Seats_Seat_NO, Seats_Seat_Catoegry, Seats_Seat_ID}
...
Economy_Seats.attributes={Economy_Seats_Eco_Seat_Price, Economy_Seats_Eco_Seat_ID}
...
domain_model = DomainModel(
    name="_6508e918_17c5_426f_a0aa_46c227f024c0",
    ...
    associations={Customer_Enter_flight_Details, Customer_Check_Flights_Availability, Customer_Book_ticket, Customer_Enter_Passengers_Details, Customer_Confirm_booking, Customer_Make_Payment, Customer_Manage_Booking, Customer_Join__Qaboos_FPP_Club, Contact_Center_Agent_Update_Flight_Details, Qaboos_Airways_Flight, Qaboos_Airways_Passengers, Books, Checks, joins, Selects},
    generalizations={},
    metadata=None
)
