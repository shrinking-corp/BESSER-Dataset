...
# Classes
family_Person = Class(name="family_Person")
family_Address = Class(name="family_Address")
family_Car = Class(name="family_Car")
family_Family = Class(name="family_Family")
family_WealthyFamily = Class(name="family_WealthyFamily")
...
family_Person.attributes={family_Person_firstName, family_Person_sexe}
...
family_Family.attributes={family_Family_numberOfPets, family_Family_favoriteHolidayDestinations, family_Family_surname, family_Family_hasASwimmingPool}
...
domain_model = DomainModel(
    name="family",
    types={family_Person, family_Address, family_Car, family_Family, family_WealthyFamily, Family, Sexe},
