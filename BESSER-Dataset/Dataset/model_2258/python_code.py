...
class Courses_Answer:
    ...
    def __init__(self, id: int, text: str, pass_: bool, Courses_Answer: "Courses_Person" = None, Courses_Answer7: "Courses_Assignment" = None):
        self.id = id
        self.text = text
        self.pass_ = pass_
...
class Courses_Assignment:
    ...
    def __init__(self, name: str, description: str, mandatory: bool, Courses_Assignment: "Courses_Course" = None, Courses_Assignment6: set["Courses_Answer"] = None):
        self.name = name
