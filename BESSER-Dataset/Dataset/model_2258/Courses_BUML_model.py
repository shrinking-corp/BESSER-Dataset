...
Courses_Assignment = Class(name="Courses_Assignment")
Courses_Answer = Class(name="Courses_Answer")
...
Courses_Course.attributes={Courses_Course_name, Courses_Course_credit, Courses_Course_id}
...
Courses_Person.attributes={Courses_Person_role, Courses_Person_name, Courses_Person_id}
...
Courses_Assignment.attributes={Courses_Assignment_mandatory, Courses_Assignment_name, Courses_Assignment_description}
...
Courses_Answer_pass_: Property = Property(name="pass_", type=BooleanType)
Courses_Answer.attributes={Courses_Answer_text, Courses_Answer_id, Courses_Answer_pass_}
...
domain_model = DomainModel(
    ...
    associations={members0, assignments1, assignmentDelivery3, answer5},
    generalizations={},
    metadata=None
)
