...
class activitydiagram_ForkedToken(Token):
    ...
    def activitydiagram_ForkedToken(self, value):
        ...
        if old_value is not None:
            if hasattr(old_value, "activitydiagram_Token60"):
                opp_val = getattr(old_value, "activitydiagram_Token60", None)
                if opp_val == self:
                    setattr(old_value, "activitydiagram_Token60", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "activitydiagram_Token60"):
                opp_val = getattr(value, "activitydiagram_Token60", None)
                setattr(value, "activitydiagram_Token60", self)
...
class activitydiagram_SendSignalAction(Action):
    ...
    def activitydiagram_SendSignalAction(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "activitydiagram_Signal62"):
                opp_val = getattr(old_value, "activitydiagram_Signal62", None)
                if opp_val == self:
                    setattr(old_value, "activitydiagram_Signal62", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "activitydiagram_Signal62"):
                opp_val = getattr(value, "activitydiagram_Signal62", None)
                setattr(value, "activitydiagram_Signal62", self)
...
class activitydiagram_Activity(NamedElement):
    ...
    def __init__(self, inputValuePath: str, activity: set["activitydiagram_ActivityNode"] = None, activitydiagram_Activity: set["activitydiagram_ActivityEdge"] = None, activitydiagram_Activity3: set["activitydiagram_Variable"] = None, activitydiagram_Activity5: set["activitydiagram_Variable"] = None, activitydiagram_Activity8: "activitydiagram_Trace" = None, activitydiagram_Activity10: set["activitydiagram_Signal"] = None, Activity: "activitydiagram_ActivityNode" = None):
        ...
        self.activitydiagram_Activity10 = activitydiagram_Activity10 if activitydiagram_Activity10 is not None else set()
        self.Activity = Activity
        
        pass
    @property
    def inputValuePath(self):
    ...
    def activitydiagram_Activity10(self, value):
        ...
        self.__activitydiagram_Activity10 = value if value is not None else set()
...
class activitydiagram_Variable(ABC):
    ...
    def activitydiagram_Variable27(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "activitydiagram_Value28"):
                opp_val = getattr(old_value, "activitydiagram_Value28", None)
                if opp_val == self:
                    setattr(old_value, "activitydiagram_Value28", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "activitydiagram_Value28"):
                opp_val = getattr(value, "activitydiagram_Value28", None)
                setattr(value, "activitydiagram_Value28", self)
    ...
    def activitydiagram_Variable56(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "activitydiagram_InputValue55"):
                opp_val = getattr(old_value, "activitydiagram_InputValue55", None)
                if opp_val == self:
                    setattr(old_value, "activitydiagram_InputValue55", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "activitydiagram_InputValue55"):
                opp_val = getattr(value, "activitydiagram_InputValue55", None)
                setattr(value, "activitydiagram_InputValue55", self)

class activitydiagram_ActivityEdge(NamedElement):

    def __init__(self, activitydiagram_ActivityEdge: "activitydiagram_Activity" = None, ActivityEdge: "activitydiagram_ActivityNode" = None, ActivityEdge13: "activitydiagram_ActivityNode" = None, activitydiagram_ActivityEdge21: set["activitydiagram_Offer"] = None, outgoing: "activitydiagram_ActivityNode" = None, incoming: "activitydiagram_ActivityNode" = None):
        self.activitydiagram_ActivityEdge = activitydiagram_ActivityEdge
        self.ActivityEdge = ActivityEdge
        self.ActivityEdge13 = ActivityEdge13
        self.activitydiagram_ActivityEdge21 = activitydiagram_ActivityEdge21 if activitydiagram_ActivityEdge21 is not None else set()
    ...
    @property
    def ActivityEdge13(self):
        return self.__ActivityEdge13

    @ActivityEdge13.setter
    def ActivityEdge13(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_activitydiagram_ActivityEdge__ActivityEdge13", None)
        self.__ActivityEdge13 = value
    ...
    @property
    def activitydiagram_ActivityEdge21(self):
        return self.__activitydiagram_ActivityEdge21

    @activitydiagram_ActivityEdge21.setter
    def activitydiagram_ActivityEdge21(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_activitydiagram_ActivityEdge__activitydiagram_ActivityEdge21", None)
        self.__activitydiagram_ActivityEdge21 = value if value is not None else set()
...
class activitydiagram_ActivityNode(NamedElement):
    ...
    def __init__(self, running: bool, ActivityNode: "activitydiagram_Activity" = None, source: set["activitydiagram_ActivityEdge"] = None, target: set["activitydiagram_ActivityEdge"] = None, nodes: "activitydiagram_Activity" = None, ActivityNode49: "activitydiagram_Token" = None, activitydiagram_ActivityNode: "activitydiagram_Trace" = None, holder: set["activitydiagram_Token"] = None, ActivityNode17: "activitydiagram_ActivityEdge" = None, ActivityNode19: "activitydiagram_ActivityEdge" = None):
        self.running = running
        self.ActivityNode = ActivityNode
        self.source = source if source is not None else set()
        self.target = target if target is not None else set()
        self.nodes = nodes
        self.ActivityNode49 = ActivityNode49
    ...
    def target(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "ActivityEdge13"):
                    opp_val = getattr(item, "ActivityEdge13", None)
                    
                    if opp_val == self:
                        setattr(item, "ActivityEdge13", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "ActivityEdge13"):
                    ...
                    setattr(item, "ActivityEdge13", self)
                    

    @property
    def ActivityNode49(self):
        return self.__ActivityNode49

    @ActivityNode49.setter
    def ActivityNode49(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_activitydiagram_ActivityNode__ActivityNode49", None)
        self.__ActivityNode49 = value
    ...
    def activitydiagram_ActivityNode(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "activitydiagram_Trace51"):
                opp_val = getattr(old_value, "activitydiagram_Trace51", None)
                if isinstance(opp_val, set):
                    opp_val.discard(self)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "activitydiagram_Trace51"):
                opp_val = getattr(value, "activitydiagram_Trace51", None)
                if opp_val is None:
                    setattr(value, "activitydiagram_Trace51", set([self]))
                elif isinstance(opp_val, set):
                    opp_val.add(self)
