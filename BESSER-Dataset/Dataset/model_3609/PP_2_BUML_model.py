...
# Classes
pp2_PuppetManifest = Class(name="pp2_PuppetManifest")
pp2_DefinitionArgumentList = Class(name="pp2_DefinitionArgumentList")
pp2_DefinitionArgument = Class(name="pp2_DefinitionArgument")
pp2_CaseExpression = Class(name="pp2_CaseExpression")
Expression = Class(name="Expression")
pp2_Case = Class(name="pp2_Case")
ExpressionBlock = Class(name="ExpressionBlock")
pp2_Expression = Class(name="pp2_Expression")
pp2_ResourceBody = Class(name="pp2_ResourceBody")
pp2_AttributeOperations = Class(name="pp2_AttributeOperations")
pp2_AttributeOperation = Class(name="pp2_AttributeOperation")
pp2_ICollectQuery = Class(name="pp2_ICollectQuery", is_abstract=True)
pp2_VirtualCollectQuery = Class(name="pp2_VirtualCollectQuery")
UnaryExpression = Class(name="UnaryExpression")
ICollectQuery = Class(name="ICollectQuery")
pp2_ExportedCollectQuery = Class(name="pp2_ExportedCollectQuery")
pp2_HostClassDefinition = Class(name="pp2_HostClassDefinition")
Definition = Class(name="Definition")
pp2_LiteralExpression = Class(name="pp2_LiteralExpression", is_abstract=True)
pp2_Definition = Class(name="pp2_Definition")
pp2_LiteralBoolean = Class(name="pp2_LiteralBoolean")
pp2_LiteralUndef = Class(name="pp2_LiteralUndef")
pp2_LiteralDefault = Class(name="pp2_LiteralDefault")
pp2_LiteralRegex = Class(name="pp2_LiteralRegex")
pp2_LiteralName = Class(name="pp2_LiteralName")
pp2_VariableExpression = Class(name="pp2_VariableExpression")
pp2_RelationshipExpression = Class(name="pp2_RelationshipExpression")
BinaryOpExpression = Class(name="BinaryOpExpression")
pp2_AssignmentExpression = Class(name="pp2_AssignmentExpression")
BinaryExpression = Class(name="BinaryExpression")
pp2_IfExpression = Class(name="pp2_IfExpression")
pp2_LiteralNameOrReference = Class(name="pp2_LiteralNameOrReference")
LiteralExpression = Class(name="LiteralExpression")
pp2_ResourceExpression = Class(name="pp2_ResourceExpression")
pp2_ImportExpression = Class(name="pp2_ImportExpression")
pp2_IQuotedString = Class(name="pp2_IQuotedString", is_abstract=True)
pp2_LiteralList = Class(name="pp2_LiteralList")
pp2_LiteralHash = Class(name="pp2_LiteralHash")
pp2_HashEntry = Class(name="pp2_HashEntry")
pp2_BinaryExpression = Class(name="pp2_BinaryExpression", is_abstract=True)
pp2_ParameterizedExpression = Class(name="pp2_ParameterizedExpression", is_abstract=True)
pp2_NodeDefinition = Class(name="pp2_NodeDefinition")
pp2_AppendExpression = Class(name="pp2_AppendExpression")
pp2_OrExpression = Class(name="pp2_OrExpression")
pp2_AndExpression = Class(name="pp2_AndExpression")
pp2_RelationalExpression = Class(name="pp2_RelationalExpression")
pp2_EqualityExpression = Class(name="pp2_EqualityExpression")
pp2_ShiftExpression = Class(name="pp2_ShiftExpression")
pp2_AdditiveExpression = Class(name="pp2_AdditiveExpression")
pp2_MultiplicativeExpression = Class(name="pp2_MultiplicativeExpression")
pp2_MatchingExpression = Class(name="pp2_MatchingExpression")
pp2_InExpression = Class(name="pp2_InExpression")
pp2_AtExpression = Class(name="pp2_AtExpression")
ParameterizedExpression = Class(name="ParameterizedExpression")
pp2_CollectExpression = Class(name="pp2_CollectExpression")
pp2_SelectorExpression = Class(name="pp2_SelectorExpression")
pp2_SelectorEntry = Class(name="pp2_SelectorEntry")
pp2_FunctionCall = Class(name="pp2_FunctionCall")
WithLambdaExpression = Class(name="WithLambdaExpression")
pp2_BinaryOpExpression = Class(name="pp2_BinaryOpExpression", is_abstract=True)
pp2_DoubleQuotedString = Class(name="pp2_DoubleQuotedString")
StringExpression = Class(name="StringExpression")
IQuotedString = Class(name="IQuotedString")
pp2_TextExpression = Class(name="pp2_TextExpression", is_abstract=True)
pp2_SingleQuotedString = Class(name="pp2_SingleQuotedString")
pp2_StringExpression = Class(name="pp2_StringExpression", is_abstract=True)
pp2_UnquotedString = Class(name="pp2_UnquotedString")
pp2_InterpolatedVariable = Class(name="pp2_InterpolatedVariable")
pp2_VerbatimTE = Class(name="pp2_VerbatimTE")
TextExpression = Class(name="TextExpression")
pp2_ExpressionTE = Class(name="pp2_ExpressionTE")
pp2_UnaryExpression = Class(name="pp2_UnaryExpression", is_abstract=True)
pp2_UnaryMinusExpression = Class(name="pp2_UnaryMinusExpression")
pp2_UnaryNotExpression = Class(name="pp2_UnaryNotExpression")
pp2_ExpressionBlock = Class(name="pp2_ExpressionBlock", is_abstract=True)
pp2_ElseExpression = Class(name="pp2_ElseExpression")
pp2_ElseIfExpression = Class(name="pp2_ElseIfExpression")
IfExpression = Class(name="IfExpression")
pp2_VirtualNameOrReference = Class(name="pp2_VirtualNameOrReference")
pp2_ParenthesisedExpression = Class(name="pp2_ParenthesisedExpression")
pp2_ExprList = Class(name="pp2_ExprList")
pp2_JavaLambda = Class(name="pp2_JavaLambda")
Lambda = Class(name="Lambda")
pp2_RubyLambda = Class(name="pp2_RubyLambda")
pp2_SeparatorExpression = Class(name="pp2_SeparatorExpression")
pp2_VariableTE = Class(name="pp2_VariableTE")
pp2_LiteralClass = Class(name="pp2_LiteralClass")
pp2_UnlessExpression = Class(name="pp2_UnlessExpression")
pp2_Lambda = Class(name="pp2_Lambda", is_abstract=True)
pp2_NamedAccessExpression = Class(name="pp2_NamedAccessExpression")
pp2_MethodCall = Class(name="pp2_MethodCall")
pp2_WithLambdaExpression = Class(name="pp2_WithLambdaExpression")
...
pp2_DefinitionArgument.attributes={pp2_DefinitionArgument_argName, pp2_DefinitionArgument_op}
...
lambda_89: BinaryAssociation = BinaryAssociation(
    name="lambda_89",
    ends={
...
domain_model = DomainModel(
    name="pp2",
    types={pp2_PuppetManifest, pp2_DefinitionArgumentList, pp2_DefinitionArgument, pp2_CaseExpression, Expression, pp2_Case, ExpressionBlock, pp2_Expression, pp2_ResourceBody, pp2_AttributeOperations, pp2_AttributeOperation, pp2_ICollectQuery, pp2_VirtualCollectQuery, UnaryExpression, ICollectQuery, pp2_ExportedCollectQuery, pp2_HostClassDefinition, Definition, pp2_LiteralExpression, pp2_Definition, pp2_LiteralBoolean, pp2_LiteralUndef, pp2_LiteralDefault, pp2_LiteralRegex, pp2_LiteralName, pp2_VariableExpression, pp2_RelationshipExpression, BinaryOpExpression, pp2_AssignmentExpression, BinaryExpression, pp2_IfExpression, pp2_LiteralNameOrReference, LiteralExpression, pp2_ResourceExpression, pp2_ImportExpression, pp2_IQuotedString, pp2_LiteralList, pp2_LiteralHash, pp2_HashEntry, pp2_BinaryExpression, pp2_ParameterizedExpression, pp2_NodeDefinition, pp2_AppendExpression, pp2_OrExpression, pp2_AndExpression, pp2_RelationalExpression, pp2_EqualityExpression, pp2_ShiftExpression, pp2_AdditiveExpression, pp2_MultiplicativeExpression, pp2_MatchingExpression, pp2_InExpression, pp2_AtExpression, ParameterizedExpression, pp2_CollectExpression, pp2_SelectorExpression, pp2_SelectorEntry, pp2_FunctionCall, WithLambdaExpression, pp2_BinaryOpExpression, pp2_DoubleQuotedString, StringExpression, IQuotedString, pp2_TextExpression, pp2_SingleQuotedString, pp2_StringExpression, pp2_UnquotedString, pp2_InterpolatedVariable, pp2_VerbatimTE, TextExpression, pp2_ExpressionTE, pp2_UnaryExpression, pp2_UnaryMinusExpression, pp2_UnaryNotExpression, pp2_ExpressionBlock, pp2_ElseExpression, pp2_ElseIfExpression, IfExpression, pp2_VirtualNameOrReference, pp2_ParenthesisedExpression, pp2_ExprList, pp2_JavaLambda, Lambda, pp2_RubyLambda, pp2_SeparatorExpression, pp2_VariableTE, pp2_LiteralClass, pp2_UnlessExpression, pp2_Lambda, pp2_NamedAccessExpression, pp2_MethodCall, pp2_WithLambdaExpression},
    associations={arguments9, arguments10, puppetType12, value15, switchExpr18, cases20, values22, attributes0, nameExpr1, value3, attributes5, parent8, elements38, key39, value42, condExpr25, elseStatement27, resourceExpr30, resourceData32, values35, elements36, leftExpr52, rightExpr54, leftExpr57, parameters59, hostNames62, parentName64, classReference45, query47, attributes49, expressions73, stringPart75, expression76, expr67, statements69, expr71, lambda_89, expression78, condExpr80, elseStatement82, arguments85, methodExpr87},
    generalizations={gen_pp2_CaseExpression_Expression, gen_pp2_Case_ExpressionBlock, gen_pp2_PuppetManifest_ExpressionBlock, gen_pp2_VirtualCollectQuery_UnaryExpression, gen_pp2_VirtualCollectQuery_ICollectQuery, gen_pp2_ExportedCollectQuery_UnaryExpression, gen_pp2_ExportedCollectQuery_ICollectQuery, gen_pp2_HostClassDefinition_Definition, gen_pp2_Definition_ExpressionBlock, gen_pp2_LiteralBoolean_LiteralExpression, gen_pp2_LiteralUndef_LiteralExpression, gen_pp2_LiteralDefault_LiteralExpression, gen_pp2_LiteralRegex_LiteralExpression, gen_pp2_LiteralName_LiteralExpression, gen_pp2_VariableExpression_Expression, gen_pp2_RelationshipExpression_BinaryOpExpression, gen_pp2_AssignmentExpression_BinaryExpression, gen_pp2_IfExpression_ExpressionBlock, gen_pp2_LiteralExpression_Expression, gen_pp2_LiteralNameOrReference_LiteralExpression, gen_pp2_ResourceExpression_Expression, gen_pp2_ImportExpression_Expression, gen_pp2_LiteralList_LiteralExpression, gen_pp2_LiteralHash_LiteralExpression, gen_pp2_BinaryExpression_Expression, gen_pp2_ParameterizedExpression_Expression, gen_pp2_NodeDefinition_ExpressionBlock, gen_pp2_AppendExpression_BinaryExpression, gen_pp2_OrExpression_BinaryExpression, gen_pp2_AndExpression_BinaryExpression, gen_pp2_RelationalExpression_BinaryOpExpression, gen_pp2_EqualityExpression_BinaryOpExpression, gen_pp2_ShiftExpression_BinaryOpExpression, gen_pp2_AdditiveExpression_BinaryOpExpression, gen_pp2_MultiplicativeExpression_BinaryOpExpression, gen_pp2_MatchingExpression_BinaryOpExpression, gen_pp2_InExpression_BinaryOpExpression, gen_pp2_AtExpression_ParameterizedExpression, gen_pp2_CollectExpression_Expression, gen_pp2_SelectorExpression_ParameterizedExpression, gen_pp2_SelectorEntry_BinaryExpression, gen_pp2_FunctionCall_WithLambdaExpression, gen_pp2_BinaryOpExpression_BinaryExpression, gen_pp2_DoubleQuotedString_StringExpression, gen_pp2_DoubleQuotedString_IQuotedString, gen_pp2_SingleQuotedString_StringExpression, gen_pp2_SingleQuotedString_IQuotedString, gen_pp2_StringExpression_Expression, gen_pp2_UnquotedString_StringExpression, gen_pp2_InterpolatedVariable_Expression, gen_pp2_VerbatimTE_TextExpression, gen_pp2_UnaryExpression_Expression, gen_pp2_UnaryMinusExpression_UnaryExpression, gen_pp2_UnaryNotExpression_UnaryExpression, gen_pp2_ExpressionBlock_Expression, gen_pp2_ElseExpression_ExpressionBlock, gen_pp2_ElseIfExpression_IfExpression, gen_pp2_VirtualNameOrReference_LiteralExpression, gen_pp2_ParenthesisedExpression_Expression, gen_pp2_ExprList_Expression, gen_pp2_JavaLambda_Lambda, gen_pp2_RubyLambda_Lambda, gen_pp2_SeparatorExpression_Expression, gen_pp2_ExpressionTE_TextExpression, gen_pp2_VariableTE_TextExpression, gen_pp2_LiteralClass_LiteralExpression, gen_pp2_UnlessExpression_ExpressionBlock, gen_pp2_Lambda_ExpressionBlock, gen_pp2_NamedAccessExpression_BinaryExpression, gen_pp2_MethodCall_WithLambdaExpression, gen_pp2_WithLambdaExpression_ParameterizedExpression},
    metadata=None
)
