...
class pp2_UnquotedString(StringExpression):
    ...
    pass
class pp2_SingleQuotedString(StringExpression, IQuotedString):
...
class pp2_DoubleQuotedString(StringExpression, IQuotedString):
...
class pp2_DefinitionArgument:
    ...
    def __init__(self, argName: str, op: str, pp2_DefinitionArgument: "pp2_DefinitionArgumentList" = None, pp2_DefinitionArgument13: "pp2_Expression" = None, pp2_DefinitionArgument16: "pp2_Expression" = None):
