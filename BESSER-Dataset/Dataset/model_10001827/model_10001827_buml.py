...
Department.attributes={Department_departmentName, Department_doctorList, Department_departmentID, Department_nurseList}
...
Person.attributes={Person_address, Person_gender, Person_phoneNumber, Person_title, Person_name}
...
Patient.attributes={Patient_treatment, Patient_patientID}
...
inPatient.attributes={inPatient_inDate, inPatient_rooomNumber, inPatient_outDate}
...
Song_artist: Property = Property(name="artist", type=Artist)
Song.attributes={Song_title, Song_artist}
...
domain_model = DomainModel(
    name="_YNxZAFEUEemyf9F2UZM0TQ",
    types={Hospital, Department, Person, Patient, inPatient, outPatient, Employee, Manager, Doctor, Nurse, Song, Artist},
