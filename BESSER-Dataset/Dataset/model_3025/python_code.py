...
class dbl_Variable(ModifierExtensionsContainer, AbstractVariable, SimpleStatement):
    ...
    def __init__(self, control: bool, clazz: bool, dbl_Variable: "dbl_Module" = None, dbl_Variable68: "dbl_Expression" = None, dbl_Variable32: "dbl_ClassSimilar" = None):
...
class dbl_Clazz(LanguageConceptClassifier, Construct, ClassSimilar, Classifier):
    ...
    def __init__(self, active: bool, dbl_Clazz66: "dbl_ClassAugment" = None, dbl_Clazz: "dbl_SuperClassSpecification" = None, dbl_Clazz58: "dbl_Constructor" = None, dbl_Clazz60: set["dbl_NativeBinding"] = None):
        self.active = active
...
class dbl_Pattern(NamedElement):
    ...
    def __init__(self, top: bool, dbl_Pattern211: "dbl_Statement" = None, dbl_Pattern: "dbl_Parameter" = None):
        self.top = top
...
class dbl_Module(Construct, EmbeddableExtensionsContainer, NamedElement):
...
class dbl_TsRule(LanguageConstructClassifier, NamedElement):
    ...
    pass
class dbl_Procedure(LocalScope, TypedElement, NamedElement):
