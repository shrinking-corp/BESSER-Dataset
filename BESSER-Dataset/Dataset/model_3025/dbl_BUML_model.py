...
dbl_ClassPart = Class(name="dbl_ClassPart")
...
dbl_LanguageConstructClassifier = Class(name="dbl_LanguageConstructClassifier", is_abstract=True)
LanguageConstructClassifier = Class(name="LanguageConstructClassifier")
dbl_RhsExpression = Class(name="dbl_RhsExpression")
dbl_L3RhsExpr = Class(name="dbl_L3RhsExpr")
RhsExpression = Class(name="RhsExpression")
dbl_L2RhsExpr = Class(name="dbl_L2RhsExpr")
ElementAccess = Class(name="ElementAccess")
dbl_SequenceExpr = Class(name="dbl_SequenceExpr")
L2RhsExpr = Class(name="L2RhsExpr")
dbl_L1RhsExpr = Class(name="dbl_L1RhsExpr")
...
dbl_LanguageConceptClassifier = Class(name="dbl_LanguageConceptClassifier", is_abstract=True)
...
dbl_RhsClassifierExpr = Class(name="dbl_RhsClassifierExpr")
...
dbl_Procedure.attributes={dbl_Procedure_abstract, dbl_Procedure_clazz}
...
domain_model = DomainModel(
    name="dbl",
    types={dbl_Construct, dbl_ExpandExpr, dbl_ExtensibleElement, NamedElement, Construct, dbl_Procedure, dbl_Variable, dbl_EmbeddableExtensionsContainer, dbl_ModifierExtensionsContainer, dbl_Type, dbl_ArrayDimension, dbl_TypedElement, dbl_PrimitiveType, dbl_IdExpr, dbl_Expression, Type, dbl_VoidType, PrimitiveType, dbl_IntType, dbl_Model, dbl_Import, dbl_Module, EmbeddableExtensionsContainer, dbl_Classifier, dbl_ClassAugment, dbl_ExtensionDefinition, dbl_SuperClassSpecification, dbl_ClassPart, dbl_Clazz, Classifier, ClassSimilar, LanguageConceptClassifier, dbl_Constructor, dbl_BoolType, dbl_DoubleType, dbl_StringType, TypedElement, LocalScope, dbl_Parameter, dbl_NativeBinding, dbl_ClassSimilar, ModifierExtensionsContainer, dbl_LoopStatement, Statement, dbl_SimpleStatement, dbl_Assignment, dbl_VariableAccess, dbl_ProcedureCall, dbl_Return, dbl_WaitUntil, dbl_Terminate, dbl_Yield, dbl_Wait, dbl_Reactivate, dbl_ActivateObject, dbl_AbstractVariable, AbstractVariable, SimpleStatement, dbl_NamedElement, dbl_Statement, ExtensibleElement, dbl_LocalScopeStatement, dbl_ForStatement, LoopStatement, dbl_WhileStatement, dbl_SwitchStatement, dbl_SwitchCase, dbl_Advance, dbl_Print, dbl_IfStatement, dbl_LocalScope, dbl_Or, BinaryOperator, L8Expr, dbl_And, L7Expr, dbl_NotEqual, L6Expr, dbl_Equal, dbl_Greater, L5Expr, dbl_GreaterEqual, dbl_Less, dbl_LessEqual, dbl_InstanceOf, dbl_Plus, L4Expr, dbl_Minus, dbl_Mul, L3Expr, dbl_Mod, dbl_Div, dbl_Neg, UnaryOperator, L2Expr, dbl_Not, dbl_Cast, dbl_CreateObject, L1Expr, dbl_BreakStatement, dbl_ContinueStatement, dbl_L1Expr, Expression, dbl_L2Expr, dbl_L3Expr, dbl_L4Expr, dbl_L5Expr, dbl_L6Expr, dbl_L7Expr, dbl_L8Expr, dbl_L9Expr, dbl_BinaryOperator, dbl_UnaryOperator, dbl_PredefinedId, dbl_MeLiteral, PredefinedId, dbl_SuperLiteral, dbl_MetaLiteral, dbl_TypeLiteral, dbl_SizeOfArray, dbl_CallPart, dbl_ElementAccess, dbl_NullLiteral, dbl_TimeLiteral, dbl_ActiveLiteral, dbl_StringLiteral, dbl_IntLiteral, dbl_TrueLiteral, dbl_FalseLiteral, dbl_DoubleLiteral, dbl_ParseExpr, dbl_TextualSyntaxDef, dbl_Mapping, dbl_TsRule, dbl_LanguageConstructClassifier, LanguageConstructClassifier, dbl_RhsExpression, dbl_L3RhsExpr, RhsExpression, dbl_L2RhsExpr, ElementAccess, dbl_SequenceExpr, L2RhsExpr, dbl_L1RhsExpr, dbl_TerminalExpr, dbl_MetaAccess, L1RhsExpr, VariableAccess, dbl_TypeAccess, dbl_ClassContentExtension, dbl_ModuleContentExtension, dbl_LanguageConceptClassifier, dbl_IntPropertyType, dbl_StringPropertyType, dbl_BooleanPropertyType, dbl_StructuredPropertyType, dbl_CompositePropertyType, StructuredPropertyType, dbl_ReferencePropertyType, LocalScopeStatement, dbl_MappingPart, dbl_MetaExpr, dbl_TargetStatement, dbl_MappingStatement, dbl_PropertyBindingExpr, dbl_PropertyType, dbl_RhsClassifierExpr, dbl_IdPropertyType, PropertyType, dbl_ResumeGenStatement, dbl_FixedMappingPart, MappingPart, dbl_DynamicMappingPart, dbl_ExpandExpression, dbl_ExpandStatement, dbl_CodeQuoteExpression, dbl_QuotedCode, dbl_QuotedExpression, QuotedCode, dbl_QuotedStatements, dbl_SetGenContextStatement, dbl_ResetGenContextStatement, dbl_SaveGenStatement, dbl_TestStatement, dbl_QuotedClassContent, dbl_QuotedModuleContent, Module, dbl_Pattern},
    associations={expandExpr0, procedures13, variables15, extensions17, modifierExtensions18, arrayDimensions20, primitiveType21, typeArrayDimensions22, classifierType25, size27, imports1, modules2, model4, classifiers7, classAugments9, extensionDefs11, superClasses36, initialBlock38, finalBlock40, actionsBlock43, reportBlock46, clearBlock49, clazz52, constructorArguments54, constructor57, bindings59, parameters29, attributes31, methods33, variable70, value71, callIdExpr74, value76, condition78, objectAccess80, parameters61, augmentedClass64, initialValue67, statements95, termination97, increment99, body102, condition105, body107, variable110, cases112, defaultCase114, value117, body120, objectAccess82, time84, outputs86, condition88, trueCase90, falseCase92, op1123, op2125, op128, astPart133, parentIdExpr136, referencedElement138, predefinedId140, arrayIndex142, callPart145, callArguments147, idExpr150, expr130, abstractSyntaxDef154, textualSyntaxDef157, mappingDef159, startRule161, rules163, rhs166, sequence168, extendedConcept152, type172, parts174, metaObject176, expr179, body181, parts183, exprs185, propertyType170, classifier171, variable190, variable192, expr194, metaObject196, metaObject198, location200, quotedCode203, expression204, context188, body210, statements206, context208},
    generalizations={gen_dbl_ExtensibleElement_NamedElement, gen_dbl_ExtensibleElement_Construct, gen_dbl_PrimitiveType_Type, gen_dbl_VoidType_PrimitiveType, gen_dbl_IntType_PrimitiveType, gen_dbl_Module_NamedElement, gen_dbl_Module_EmbeddableExtensionsContainer, gen_dbl_Module_Construct, gen_dbl_ClassPart_LocalScope, gen_dbl_Clazz_Classifier, gen_dbl_Clazz_ClassSimilar, gen_dbl_Clazz_LanguageConceptClassifier, gen_dbl_Clazz_Construct, gen_dbl_BoolType_PrimitiveType, gen_dbl_DoubleType_PrimitiveType, gen_dbl_StringType_PrimitiveType, gen_dbl_Procedure_NamedElement, gen_dbl_Procedure_TypedElement, gen_dbl_Procedure_LocalScope, gen_dbl_Classifier_NamedElement, gen_dbl_Classifier_Type, gen_dbl_ClassSimilar_EmbeddableExtensionsContainer, gen_dbl_ClassSimilar_ModifierExtensionsContainer, gen_dbl_LoopStatement_Statement, gen_dbl_SimpleStatement_Statement, gen_dbl_Assignment_SimpleStatement, gen_dbl_ProcedureCall_SimpleStatement, gen_dbl_Return_SimpleStatement, gen_dbl_WaitUntil_SimpleStatement, gen_dbl_Terminate_SimpleStatement, gen_dbl_Yield_SimpleStatement, gen_dbl_Wait_SimpleStatement, gen_dbl_Reactivate_SimpleStatement, gen_dbl_ActivateObject_SimpleStatement, gen_dbl_ClassAugment_ClassSimilar, gen_dbl_AbstractVariable_NamedElement, gen_dbl_AbstractVariable_TypedElement, gen_dbl_Variable_AbstractVariable, gen_dbl_Variable_SimpleStatement, gen_dbl_Variable_ModifierExtensionsContainer, gen_dbl_Parameter_AbstractVariable, gen_dbl_Statement_ExtensibleElement, gen_dbl_LocalScopeStatement_SimpleStatement, gen_dbl_LocalScopeStatement_LocalScope, gen_dbl_ForStatement_LoopStatement, gen_dbl_ForStatement_LocalScope, gen_dbl_WhileStatement_LoopStatement, gen_dbl_SwitchStatement_SimpleStatement, gen_dbl_Advance_SimpleStatement, gen_dbl_Print_SimpleStatement, gen_dbl_IfStatement_Statement, gen_dbl_Or_BinaryOperator, gen_dbl_Or_L8Expr, gen_dbl_And_BinaryOperator, gen_dbl_And_L7Expr, gen_dbl_NotEqual_BinaryOperator, gen_dbl_NotEqual_L6Expr, gen_dbl_Equal_BinaryOperator, gen_dbl_Equal_L6Expr, gen_dbl_Greater_BinaryOperator, gen_dbl_Greater_L5Expr, gen_dbl_GreaterEqual_BinaryOperator, gen_dbl_GreaterEqual_L5Expr, gen_dbl_Less_BinaryOperator, gen_dbl_Less_L5Expr, gen_dbl_LessEqual_BinaryOperator, gen_dbl_LessEqual_L5Expr, gen_dbl_InstanceOf_BinaryOperator, gen_dbl_InstanceOf_L5Expr, gen_dbl_Plus_BinaryOperator, gen_dbl_Plus_L4Expr, gen_dbl_Minus_BinaryOperator, gen_dbl_Minus_L4Expr, gen_dbl_Mul_BinaryOperator, gen_dbl_Mul_L3Expr, gen_dbl_Mod_BinaryOperator, gen_dbl_Mod_L3Expr, gen_dbl_Div_BinaryOperator, gen_dbl_Div_L3Expr, gen_dbl_Neg_UnaryOperator, gen_dbl_Neg_L2Expr, gen_dbl_Not_UnaryOperator, gen_dbl_Not_L2Expr, gen_dbl_Cast_UnaryOperator, gen_dbl_Cast_TypedElement, gen_dbl_Cast_L2Expr, gen_dbl_CreateObject_L1Expr, gen_dbl_CreateObject_TypedElement, gen_dbl_BreakStatement_SimpleStatement, gen_dbl_ContinueStatement_SimpleStatement, gen_dbl_Expression_TypedElement, gen_dbl_Expression_ExtensibleElement, gen_dbl_L1Expr_Expression, gen_dbl_L2Expr_Expression, gen_dbl_L3Expr_Expression, gen_dbl_L4Expr_Expression, gen_dbl_L5Expr_Expression, gen_dbl_L6Expr_Expression, gen_dbl_L7Expr_Expression, gen_dbl_L8Expr_Expression, gen_dbl_L9Expr_Expression, gen_dbl_BinaryOperator_Expression, gen_dbl_UnaryOperator_Expression, gen_dbl_MeLiteral_PredefinedId, gen_dbl_SuperLiteral_PredefinedId, gen_dbl_MetaLiteral_PredefinedId, gen_dbl_TypeLiteral_PredefinedId, gen_dbl_SizeOfArray_PredefinedId, gen_dbl_IdExpr_L1Expr, gen_dbl_ElementAccess_Expression, gen_dbl_NullLiteral_L1Expr, gen_dbl_TimeLiteral_L1Expr, gen_dbl_ActiveLiteral_L1Expr, gen_dbl_StringLiteral_L1Expr, gen_dbl_IntLiteral_L1Expr, gen_dbl_TrueLiteral_L1Expr, gen_dbl_FalseLiteral_L1Expr, gen_dbl_DoubleLiteral_L1Expr, gen_dbl_ExpandExpr_Expression, gen_dbl_ParseExpr_Expression, gen_dbl_TextualSyntaxDef_ExtensibleElement, gen_dbl_LanguageConstructClassifier_NamedElement, gen_dbl_LanguageConstructClassifier_ExtensibleElement, gen_dbl_LanguageConceptClassifier_LanguageConstructClassifier, gen_dbl_TsRule_NamedElement, gen_dbl_TsRule_LanguageConstructClassifier, gen_dbl_L3RhsExpr_RhsExpression, gen_dbl_L2RhsExpr_RhsExpression, gen_dbl_VariableAccess_ElementAccess, gen_dbl_SequenceExpr_L2RhsExpr, gen_dbl_L1RhsExpr_RhsExpression, gen_dbl_TerminalExpr_L1RhsExpr, gen_dbl_MetaAccess_VariableAccess, gen_dbl_TypeAccess_ElementAccess, gen_dbl_ClassContentExtension_ExtensibleElement, gen_dbl_ModuleContentExtension_ExtensibleElement, gen_dbl_ExtensionDefinition_LanguageConceptClassifier, gen_dbl_ExtensionDefinition_ExtensibleElement, gen_dbl_IntPropertyType_PropertyType, gen_dbl_StringPropertyType_PropertyType, gen_dbl_BooleanPropertyType_PropertyType, gen_dbl_StructuredPropertyType_PropertyType, gen_dbl_CompositePropertyType_StructuredPropertyType, gen_dbl_ReferencePropertyType_StructuredPropertyType, gen_dbl_Mapping_LocalScopeStatement, gen_dbl_MetaExpr_Expression, gen_dbl_TargetStatement_Statement, gen_dbl_MappingStatement_Statement, gen_dbl_PropertyBindingExpr_NamedElement, gen_dbl_PropertyBindingExpr_L1RhsExpr, gen_dbl_RhsClassifierExpr_L1RhsExpr, gen_dbl_IdPropertyType_PropertyType, gen_dbl_ResumeGenStatement_SimpleStatement, gen_dbl_FixedMappingPart_MappingPart, gen_dbl_DynamicMappingPart_MappingPart, gen_dbl_ExpandExpression_Expression, gen_dbl_ExpandStatement_Statement, gen_dbl_CodeQuoteExpression_Expression, gen_dbl_QuotedExpression_QuotedCode, gen_dbl_QuotedStatements_QuotedCode, gen_dbl_SetGenContextStatement_SimpleStatement, gen_dbl_ResetGenContextStatement_SimpleStatement, gen_dbl_SaveGenStatement_SimpleStatement, gen_dbl_TestStatement_Statement, gen_dbl_QuotedClassContent_QuotedCode, gen_dbl_QuotedClassContent_ClassSimilar, gen_dbl_QuotedModuleContent_QuotedCode, gen_dbl_QuotedModuleContent_Module, gen_dbl_Pattern_NamedElement},
    metadata=None
)
