...
class express_Line:
    ...
    def __init__(self, text: str, express_Line: "express_ConstantVal" = None, express_Line52: "express_LocalVar" = None, express_Line112: "express_IfStatement" = None):
        self.text = text
...
class express_LocalVar:
    ...
    def __init__(self, varname: str, express_LocalVar: "express_Rule" = None, express_LocalVar48: "express_DataType" = None, express_LocalVar51: "express_Line" = None, express_LocalVar59: "express_FunctionExpression" = None, express_LocalVar74: "express_Function" = None):
...
class express_Function:
    ...
    def __init__(self, name: str, express_Function: "express_Schema" = None, express_Function70: set["express_ConstantVal"] = None, express_Function73: set["express_LocalVar"] = None, express_Function76: set["express_Statement"] = None, express_Function64: "express_ParameterList" = None, express_Function67: "express_DataType" = None):
        self.name = name
...
class express_Reference:
    ...
    def __init__(self, self1: bool, qualifier: str, name: str, optional: bool, express_Reference: "express_Entity" = None):
        self.self1 = self1
...
class express_Entity(ExpressConcept):
    ...
    def __init__(self, abstract: bool, express_Entity12: "express_Entity" = None, express_Entity10: set["express_Entity"] = None, express_Entity15: "express_Entity" = None, express_Entity13: set["express_Entity"] = None, express_Entity18: "express_Entity" = None, express_Entity16: set["express_Entity"] = None, express_Entity20: set["express_Attribute"] = None, express_Entity22: set["express_UniqueRule"] = None, express_Entity30: "express_Reference" = None, express_Entity: "express_Schema" = None):
...
class express_CaseStatement(Statement):
    ...
    def __init__(self, variable: str, express_CaseStatement: set["express_CaseAction"] = None, express_CaseStatement100: set["express_Statement"] = None):
...
class express_Schema:
    ...
    def __init__(self, name: str, express_Schema: set["express_Type"] = None, express_Schema4: set["express_Function"] = None, express_Schema6: set["express_Rule"] = None, express_Schema2: set["express_Entity"] = None):
        self.name = name
