...
# Classes
express_Schema = Class(name="express_Schema")
express_Type = Class(name="express_Type")
express_Rule = Class(name="express_Rule")
express_ExpressConcept = Class(name="express_ExpressConcept")
express_WhereRule = Class(name="express_WhereRule")
ExpressConcept = Class(name="ExpressConcept")
express_DataType = Class(name="express_DataType")
express_Attribute = Class(name="express_Attribute")
express_UniqueRule = Class(name="express_UniqueRule")
express_Reference = Class(name="express_Reference")
express_TypeNameList = Class(name="express_TypeNameList")
express_ConstantVal = Class(name="express_ConstantVal")
express_Entity = Class(name="express_Entity")
express_Function = Class(name="express_Function")
express_LocalVar = Class(name="express_LocalVar")
express_Statement = Class(name="express_Statement")
express_Line = Class(name="express_Line")
express_FunctionExpression = Class(name="express_FunctionExpression")
express_ParameterList = Class(name="express_ParameterList")
express_FormalParam = Class(name="express_FormalParam")
express_Intervall = Class(name="express_Intervall")
express_BuiltInType = Class(name="express_BuiltInType")
DataType = Class(name="DataType")
express_ReferenceType = Class(name="express_ReferenceType")
express_GenericType = Class(name="express_GenericType")
express_CollectionType = Class(name="express_CollectionType")
express_StringType = Class(name="express_StringType")
BuiltInType = Class(name="BuiltInType")
express_RealType = Class(name="express_RealType")
express_NumberType = Class(name="express_NumberType")
express_IntegerType = Class(name="express_IntegerType")
express_EnumType = Class(name="express_EnumType")
express_LiteralType = Class(name="express_LiteralType")
express_SelectType = Class(name="express_SelectType")
express_SequenceStatement = Class(name="express_SequenceStatement")
Statement = Class(name="Statement")
express_CaseStatement = Class(name="express_CaseStatement")
express_CaseAction = Class(name="express_CaseAction")
express_ReturnStatement = Class(name="express_ReturnStatement")
express_EscapeStatement = Class(name="express_EscapeStatement")
express_Assignment = Class(name="express_Assignment")
express_VarOrAttrib = Class(name="express_VarOrAttrib")
express_SimpleVar = Class(name="express_SimpleVar")
VarOrAttrib = Class(name="VarOrAttrib")
express_IndexedVar = Class(name="express_IndexedVar")
express_Index = Class(name="express_Index")
express_AttributeVar = Class(name="express_AttributeVar")
express_BinaryType = Class(name="express_BinaryType")
express_LogicalType = Class(name="express_LogicalType")
express_BooleanType = Class(name="express_BooleanType")
express_RepeatStatement = Class(name="express_RepeatStatement")
express_VarLiteral = Class(name="express_VarLiteral")
IndexTerminal = Class(name="IndexTerminal")
express_IntLiteral = Class(name="express_IntLiteral")
express_IndexTerminal = Class(name="express_IndexTerminal")
Index = Class(name="Index")
express_IfStatement = Class(name="express_IfStatement")
...
express_WhereRule.attributes={express_WhereRule_name, express_WhereRule_expression}
...
express_Attribute.attributes={express_Attribute_optional, express_Attribute_qualifier, express_Attribute_expression, express_Attribute_name, express_Attribute_self}
...
express_UniqueRule.attributes={express_UniqueRule_name, express_UniqueRule_attribute}
...
express_Reference.attributes={express_Reference_qualifier, express_Reference_self, express_Reference_name, express_Reference_optional}
...
express_CollectionType.attributes={express_CollectionType_opt, express_CollectionType_upperBound, express_CollectionType_lowerBound, express_CollectionType_unique, express_CollectionType_many, express_CollectionType_name}
...
express_StringType.attributes={express_StringType_fixed, express_StringType_size}
...
express_RepeatStatement.attributes={express_RepeatStatement_idx, express_RepeatStatement_start, express_RepeatStatement_end}
...
return_54: BinaryAssociation = BinaryAssociation(
    name="return_54",
    ends={
...
domain_model = DomainModel(
    name="express",
    types={express_Schema, express_Type, express_Rule, express_ExpressConcept, express_WhereRule, ExpressConcept, express_DataType, express_Attribute, express_UniqueRule, express_Reference, express_TypeNameList, express_ConstantVal, express_Entity, express_Function, express_LocalVar, express_Statement, express_Line, express_FunctionExpression, express_ParameterList, express_FormalParam, express_Intervall, express_BuiltInType, DataType, express_ReferenceType, express_GenericType, express_CollectionType, express_StringType, BuiltInType, express_RealType, express_NumberType, express_IntegerType, express_EnumType, express_LiteralType, express_SelectType, express_SequenceStatement, Statement, express_CaseStatement, express_CaseAction, express_ReturnStatement, express_EscapeStatement, express_Assignment, express_VarOrAttrib, express_SimpleVar, VarOrAttrib, express_IndexedVar, express_Index, express_AttributeVar, express_BinaryType, express_LogicalType, express_BooleanType, express_RepeatStatement, express_VarLiteral, IndexTerminal, express_IntLiteral, express_IndexTerminal, Index, express_IfStatement},
    associations={type0, function3, rule5, whereRule7, datatype8, disjointSubtype11, subtype14, supertype17, attribute19, uniqueRule21, type23, opposite27, type29, target31, constant33, entity1, localVar35, statement37, whereRule39, type42, expression45, type47, expression50, argument53, return_54, local57, constant69, localVar72, statement75, formalParam78, type80, interval83, instance85, lowerRef87, upperRef89, type92, statement60, params63, returnType66, literal95, select96, slot98, otherwise99, statement102, assignTo105, variable106, index107, component109, condition111, statement113, elseStatement116, statement119},
    generalizations={gen_express_Type_ExpressConcept, gen_express_Entity_ExpressConcept, gen_express_BuiltInType_DataType, gen_express_ReferenceType_DataType, gen_express_GenericType_DataType, gen_express_CollectionType_DataType, gen_express_StringType_BuiltInType, gen_express_RealType_BuiltInType, gen_express_NumberType_BuiltInType, gen_express_IntegerType_BuiltInType, gen_express_EnumType_DataType, gen_express_SelectType_DataType, gen_express_SequenceStatement_Statement, gen_express_CaseStatement_Statement, gen_express_ReturnStatement_Statement, gen_express_EscapeStatement_Statement, gen_express_Assignment_Statement, gen_express_SimpleVar_VarOrAttrib, gen_express_IndexedVar_VarOrAttrib, gen_express_AttributeVar_VarOrAttrib, gen_express_BinaryType_BuiltInType, gen_express_LogicalType_BuiltInType, gen_express_BooleanType_BuiltInType, gen_express_RepeatStatement_Statement, gen_express_VarLiteral_IndexTerminal, gen_express_IntLiteral_IndexTerminal, gen_express_IndexTerminal_Index, gen_express_IfStatement_Statement},
    metadata=None
)
