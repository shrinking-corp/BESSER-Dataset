...
# Classes
archimate_MotivationElement = Class(name="archimate_MotivationElement", is_abstract=True)
archimate_BusinessElement = Class(name="archimate_BusinessElement", is_abstract=True)
archimate_StrategyElement = Class(name="archimate_StrategyElement", is_abstract=True)
...
archimate_ArchimateDiagram = Class(name="archimate_ArchimateDiagram")
archimate_ActiveStructureElement = Class(name="archimate_ActiveStructureElement", is_abstract=True)
...
archimate_Outcome = Class(name="archimate_Outcome")
...
archimate_Resource = Class(name="archimate_Resource")
...
archimate_MotivationElement.attributes={archimate_MotivationElement_name, archimate_MotivationElement_relationType, archimate_MotivationElement_refinementType}
...
archimate_BusinessElement.attributes={archimate_BusinessElement_refinementType, archimate_BusinessElement_name, archimate_BusinessElement_relationType}
...
archimate_StrategyElement.attributes={archimate_StrategyElement_name, archimate_StrategyElement_refinementType, archimate_StrategyElement_relationType}
...
domain_model = DomainModel(
    name="archimate",
    types={archimate_MotivationElement, archimate_BusinessElement, archimate_StrategyElement, archimate_Stakeholder, ActiveStructureElement, archimate_Meaning, archimate_Value, MotivationElement, archimate_ArchimateDiagram, archimate_ActiveStructureElement, archimate_Goal, archimate_Assessment, archimate_Principle, archimate_Requirement, archimate_Constraint, Requirement, archimate_Outcome, archimate_Driver, archimate_BusinessProcess, BusinessElement, archimate_Resource, StrategyElement, refinement, relationType},
    associations={motivationelement1, bussinesselement3, strategyelement5, influences8, target10, meaning13, value14, influences17, children20, negativeInfluence23, stakeholder25, activestructureelement0, goal30, assessment31, goal33, driver35, driver37, assessment39, outcome42, value43, outcome45, outcome47, goal49, children53, stakeholder26, outcome28, children59, realizes61, influences64, triggers68, negativeInfluence70, influences55},
    generalizations={gen_archimate_Stakeholder_ActiveStructureElement, gen_archimate_Meaning_MotivationElement, gen_archimate_Value_MotivationElement, gen_archimate_Assessment_MotivationElement, gen_archimate_Goal_MotivationElement, gen_archimate_Outcome_MotivationElement, gen_archimate_Principle_MotivationElement, gen_archimate_Requirement_MotivationElement, gen_archimate_Constraint_Requirement, gen_archimate_Driver_MotivationElement, gen_archimate_BusinessProcess_BusinessElement, gen_archimate_Resource_StrategyElement},
    metadata=None
)
