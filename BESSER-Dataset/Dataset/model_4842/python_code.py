...
class archimate_StrategyElement(ABC):
    ...
    def __init__(self, name: str, refinementType: str, relationType: str, archimate_StrategyElement54: "archimate_StrategyElement" = None, archimate_StrategyElement52: set["archimate_StrategyElement"] = None, archimate_StrategyElement: "archimate_ArchimateDiagram" = None, archimate_StrategyElement56: set["archimate_MotivationElement"] = None):
        self.name = name
...
class archimate_MotivationElement(ABC):
    ...
    def __init__(self, name: str, refinementType: str, relationType: str, archimate_MotivationElement19: set["archimate_MotivationElement"] = None, archimate_MotivationElement24: "archimate_MotivationElement" = None, archimate_MotivationElement22: set["archimate_MotivationElement"] = None, archimate_MotivationElement63: "archimate_BusinessElement" = None, archimate_MotivationElement66: "archimate_BusinessElement" = None, archimate_MotivationElement72: "archimate_BusinessElement" = None, archimate_MotivationElement: "archimate_ArchimateDiagram" = None, archimate_MotivationElement12: "archimate_ActiveStructureElement" = None, archimate_MotivationElement18: "archimate_MotivationElement" = None, archimate_MotivationElement16: set["archimate_MotivationElement"] = None, archimate_MotivationElement21: "archimate_MotivationElement" = None, archimate_MotivationElement57: "archimate_StrategyElement" = None):
        self.name = name
        self.refinementType = refinementType
        self.relationType = relationType
