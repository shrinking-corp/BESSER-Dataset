...
AcceleratorCard_CPU: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="decoratedCPU14", type=CPU, multiplicity=Multiplicity(0, 1)),
        Property(name="acceleratorCard15", type=AcceleratorCard, multiplicity=Multiplicity(0, 1))
    }
)
Processor_Memory: BinaryAssociation = BinaryAssociation(
    name="Processor_Memory",
    ends={
        Property(name="processor0", type=Processor, multiplicity=Multiplicity(0, 9999)),
...
Program_Instruction: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="program2", type=Program, multiplicity=Multiplicity(0, 9999)),
        Property(name="instructions3", type=Instruction, multiplicity=Multiplicity(0, 9999))
    }
)
Processor_Program: BinaryAssociation = BinaryAssociation(
    name="Processor_Program",
    ends={
        Property(name="processor4", type=Processor, multiplicity=Multiplicity(0, 9999)),
        Property(name="program5", type=Program, multiplicity=Multiplicity(0, 9999))
    }
)
Cache_RAM: BinaryAssociation = BinaryAssociation(
    name="Cache_RAM",
    ends={
        Property(name="ramProxy6", type=RAM, multiplicity=Multiplicity(1, 1)),
        Property(name="cache7", type=Cache, multiplicity=Multiplicity(0, 1))
    }
)
ExtensionBoard_Card: BinaryAssociation = BinaryAssociation(
    name="ExtensionBoard_Card",
    ends={
        Property(name="extensionBoard8", type=ExtensionBoard, multiplicity=Multiplicity(0, 9999)),
        Property(name="cards9", type=Card, multiplicity=Multiplicity(0, 9999))
    }
)
Vendor1Adapter_Vendor1Sound: BinaryAssociation = BinaryAssociation(
    name="Vendor1Adapter_Vendor1Sound",
    ends={
        Property(name="vendor1Adapter10", type=Vendor1Adapter, multiplicity=Multiplicity(0, 9999)),
        Property(name="vendor1Sound11", type=Vendor1Sound, multiplicity=Multiplicity(0, 9999))
    }
)
Vendor2Adapter_Vendor2Sound: BinaryAssociation = BinaryAssociation(
    name="Vendor2Adapter_Vendor2Sound",
    ends={
        Property(name="vendor2Adapter12", type=Vendor2Adapter, multiplicity=Multiplicity(0, 9999)),
        Property(name="vendor2Sound13", type=Vendor2Sound, multiplicity=Multiplicity(0, 9999))
    }
)

# Domain Model
domain_model = DomainModel(
    name="_6d10e9dd_a4b7_42a8_88d0_2e4c8f2892c1",
    types={CPU, Processor, AcceleratorCard, Cache, RAM, Program, Instruction, Memory_Interface, DeviceCard, Card, Sound, GenericSound, Vendor1Adapter, Vendor2Adapter, Vendor1Sound, Vendor2Sound, ExtensionBoard, FastCard, Class_, Class2},
    associations={AcceleratorCard_CPU, Processor_Memory, Program_Instruction, Processor_Program, Cache_RAM, ExtensionBoard_Card, Vendor1Adapter_Vendor1Sound, Vendor2Adapter_Vendor2Sound},
    generalizations={},
    metadata=None
)
