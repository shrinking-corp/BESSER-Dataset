...
class research_Progress(Labelled):
    ...
    def __init__(self, percent: int, research_Progress: "research_PublicationProcess" = None, progress: "research_Paper" = None, Progress: "research_Paper" = None):
...
class research_Paragraph(Counted, Named):

    def __init__(self, content: str, research_Paragraph20: set["research_ReviewNote"] = None, research_Paragraph: "research_Paper" = None, research_Paragraph27: "research_Write" = None):
...
class research_Researcher:
    ...
    def __init__(self, name: str, forName: str, research_Researcher: set["research_Write"] = None, research_Researcher3: set["research_Review"] = None, authors: set["research_Paper"] = None, research_Researcher6: set["research_Skill"] = None, research_Researcher8: "research_Position" = None, research_Researcher10: set["research_Collaboration"] = None, Researcher: "research_Paper" = None, research_Researcher32: "research_PublicationStructure" = None):
        self.name = name
...
class research_Keyword(Named):
    ...
    def __init__(self, description: str, research_Keyword: set["research_Paper"] = None, research_Keyword53: "research_KnowledgeManager" = None, research_Keyword56: "research_PaperKeyword" = None):
        self.description = description
