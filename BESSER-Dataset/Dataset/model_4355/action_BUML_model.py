...
# Classes
model_ProcedureDeclaration = Class(name="model_ProcedureDeclaration")
FunctionDeclaration = Class(name="FunctionDeclaration")
model_Block = Class(name="model_Block")
model_Action = Class(name="model_Action", is_abstract=True)
model_Statement = Class(name="model_Statement", is_abstract=True)
Action = Class(name="Action")
model_EmptyStatement = Class(name="model_EmptyStatement")
Statement = Class(name="Statement")
model_Branch = Class(name="model_Branch")
model_Expression = Class(name="model_Expression")
model_VariableDeclarationStatement = Class(name="model_VariableDeclarationStatement")
model_AssignmentStatement = Class(name="model_AssignmentStatement")
...
model_ConstantDeclarationStatement = Class(name="model_ConstantDeclarationStatement")
model_ConstantDeclaration = Class(name="model_ConstantDeclaration")
model_ExpressionStatement = Class(name="model_ExpressionStatement")
model_BreakStatement = Class(name="model_BreakStatement")
model_ReturnStatement = Class(name="model_ReturnStatement")
model_IfStatement = Class(name="model_IfStatement")
model_SwitchStatement = Class(name="model_SwitchStatement")
model_ForStatement = Class(name="model_ForStatement")
model_ParameterDeclaration = Class(name="model_ParameterDeclaration")
model_ChoiceStatement = Class(name="model_ChoiceStatement")
...
domain_model = DomainModel(
    name="model",
    types={model_ProcedureDeclaration, FunctionDeclaration, model_Block, model_Action, model_Statement, Action, model_EmptyStatement, Statement, model_Branch, model_Expression, model_VariableDeclarationStatement, model_AssignmentStatement, model_ReferenceExpression, model_VariableDeclaration, model_ConstantDeclarationStatement, model_ConstantDeclaration, model_ExpressionStatement, model_BreakStatement, model_ReturnStatement, model_IfStatement, model_SwitchStatement, model_ForStatement, model_ParameterDeclaration, model_ChoiceStatement},
    associations={body0, actions1, guard3, action4, lhs32, rhs33, variableDeclaration7, constantDeclaration8, expression9, expression11, conditionals13, controlExpression15, cases17, parameter20, range21, body24, then27, branches30},
    generalizations={gen_model_ProcedureDeclaration_FunctionDeclaration, gen_model_Statement_Action, gen_model_EmptyStatement_Statement, gen_model_Block_Action, gen_model_VariableDeclarationStatement_Statement, gen_model_AssignmentStatement_Statement, gen_model_ConstantDeclarationStatement_Statement, gen_model_ExpressionStatement_Statement, gen_model_BreakStatement_Statement, gen_model_ReturnStatement_Statement, gen_model_IfStatement_Statement, gen_model_SwitchStatement_Statement, gen_model_ForStatement_Statement, gen_model_ChoiceStatement_Statement},
    metadata=None
)
