...
library_WriterNameMap = Class(name="library_WriterNameMap")
library_MapOfDataTypes = Class(name="library_MapOfDataTypes")
...
library_MapOfDataTypes.attributes={library_MapOfDataTypes_value, library_MapOfDataTypes_key}
...
library_Library.attributes={library_Library_options, library_Library_map1, library_Library_uRIs_1, library_Library_name, library_Library_bookByTitleMap}
...
domain_model = DomainModel(
    name="library",
    types={library_Book, library_WriterNameMap, library_MapOfDataTypes, library_Writer, library_Library, BookCategory},
    associations={books2, specialBooks4, writerByNameMap7, writerByIDMap9, books11, value12, author0, writers1},
    generalizations={},
    metadata=None
)
