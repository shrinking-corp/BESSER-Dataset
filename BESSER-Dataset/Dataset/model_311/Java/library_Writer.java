...
public class library_Writer  {
    ...
    private library_WriterNameMap library_writernamemap;
    ...
    public library_WriterNameMap getLibrary_writernamemap() {
        return library_writernamemap;
    }

    public void setLibrary_writernamemap(library_WriterNameMap library_writernamemap) {
        this.library_writernamemap = library_writernamemap;
    }
