...
from python_code import (
    EventAutomatonModel_NotEquivalentRelation,
...
def test_hyp_eventautomatonmodel_notequivalentrelation_is_not_abstract():
    assert not inspect.isabstract(EventAutomatonModel_NotEquivalentRelation)


def test_hyp_eventautomatonmodel_notequivalentrelation_constructor_exists():
    assert callable(EventAutomatonModel_NotEquivalentRelation.__init__)


def test_hyp_eventautomatonmodel_notequivalentrelation_constructor_args():
    sig = inspect.signature(EventAutomatonModel_NotEquivalentRelation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_eventautomatonmodel_action_is_not_abstract():
    assert not inspect.isabstract(EventAutomatonModel_Action)


def test_hyp_eventautomatonmodel_action_constructor_exists():
    assert callable(EventAutomatonModel_Action.__init__)


def test_hyp_eventautomatonmodel_action_constructor_args():
    sig = inspect.signature(EventAutomatonModel_Action.__init__)
    params = list(sig.parameters.keys())



def test_hyp_eventautomatonmodel_eventguard_is_not_abstract():
    assert not inspect.isabstract(EventAutomatonModel_EventGuard)


def test_hyp_eventautomatonmodel_eventguard_constructor_exists():
    assert callable(EventAutomatonModel_EventGuard.__init__)


def test_hyp_eventautomatonmodel_eventguard_constructor_args():
    sig = inspect.signature(EventAutomatonModel_EventGuard.__init__)
    params = list(sig.parameters.keys())



def test_hyp_eventautomatonmodel_event_is_not_abstract():
    assert not inspect.isabstract(EventAutomatonModel_Event)


def test_hyp_eventautomatonmodel_event_constructor_exists():
    assert callable(EventAutomatonModel_Event.__init__)


def test_hyp_eventautomatonmodel_event_constructor_args():
...
def test_hyp_eventautomatonmodel_transition_is_not_abstract():
    assert not inspect.isabstract(EventAutomatonModel_Transition)


def test_hyp_eventautomatonmodel_transition_constructor_exists():
    assert callable(EventAutomatonModel_Transition.__init__)


def test_hyp_eventautomatonmodel_transition_constructor_args():
    sig = inspect.signature(EventAutomatonModel_Transition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_eventautomatonmodel_epsilontransition_is_not_abstract():
    assert not inspect.isabstract(EventAutomatonModel_EpsilonTransition)


def test_hyp_eventautomatonmodel_epsilontransition_constructor_exists():
    assert callable(EventAutomatonModel_EpsilonTransition.__init__)


def test_hyp_eventautomatonmodel_epsilontransition_constructor_args():
...
def test_hyp_eventautomatonmodel_timeraction_is_not_abstract():
    assert not inspect.isabstract(EventAutomatonModel_TimerAction)


def test_hyp_eventautomatonmodel_timeraction_constructor_exists():
    assert callable(EventAutomatonModel_TimerAction.__init__)


def test_hyp_eventautomatonmodel_timeraction_constructor_args():
    sig = inspect.signature(EventAutomatonModel_TimerAction.__init__)
    params = list(sig.parameters.keys())



def test_hyp_eventautomatonmodel_binding_is_not_abstract():
    assert not inspect.isabstract(EventAutomatonModel_Binding)


def test_hyp_eventautomatonmodel_binding_constructor_exists():
    assert callable(EventAutomatonModel_Binding.__init__)


def test_hyp_eventautomatonmodel_binding_constructor_args():
...
def test_hyp_eventautomatonmodel_freeparameter_is_not_abstract():
    assert not inspect.isabstract(EventAutomatonModel_FreeParameter)


def test_hyp_eventautomatonmodel_freeparameter_constructor_exists():
    assert callable(EventAutomatonModel_FreeParameter.__init__)


def test_hyp_eventautomatonmodel_freeparameter_constructor_args():
...
def test_hyp_eventautomatonmodel_fixparameter_is_not_abstract():
    assert not inspect.isabstract(EventAutomatonModel_FixParameter)


def test_hyp_eventautomatonmodel_fixparameter_constructor_exists():
    assert callable(EventAutomatonModel_FixParameter.__init__)


def test_hyp_eventautomatonmodel_fixparameter_constructor_args():
...
def test_hyp_eventautomatonmodel_abstracttransition_is_not_abstract():
    assert not inspect.isabstract(EventAutomatonModel_AbstractTransition)


def test_hyp_eventautomatonmodel_abstracttransition_constructor_exists():
    assert callable(EventAutomatonModel_AbstractTransition.__init__)


def test_hyp_eventautomatonmodel_abstracttransition_constructor_args():
    sig = inspect.signature(EventAutomatonModel_AbstractTransition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_symbolicparameter_is_not_abstract():
    assert not inspect.isabstract(SymbolicParameter)


def test_hyp_symbolicparameter_constructor_exists():
    assert callable(SymbolicParameter.__init__)


def test_hyp_symbolicparameter_constructor_args():
    sig = inspect.signature(SymbolicParameter.__init__)
    params = list(sig.parameters.keys())



def test_hyp_eventautomatonmodel_symboliceventparameter_is_not_abstract():
    assert not inspect.isabstract(EventAutomatonModel_SymbolicEventParameter)


def test_hyp_eventautomatonmodel_symboliceventparameter_constructor_exists():
    assert callable(EventAutomatonModel_SymbolicEventParameter.__init__)


def test_hyp_eventautomatonmodel_symboliceventparameter_constructor_args():
    sig = inspect.signature(EventAutomatonModel_SymbolicEventParameter.__init__)
    params = list(sig.parameters.keys())



def test_hyp_eventautomatonmodel_parameter_is_not_abstract():
    assert not inspect.isabstract(EventAutomatonModel_Parameter)


def test_hyp_eventautomatonmodel_parameter_constructor_exists():
    assert callable(EventAutomatonModel_Parameter.__init__)


def test_hyp_eventautomatonmodel_parameter_constructor_args():
    sig = inspect.signature(EventAutomatonModel_Parameter.__init__)
    params = list(sig.parameters.keys())



def test_hyp_eventautomatonmodel_symbolicevent_is_not_abstract():
    assert not inspect.isabstract(EventAutomatonModel_SymbolicEvent)


def test_hyp_eventautomatonmodel_symbolicevent_constructor_exists():
    assert callable(EventAutomatonModel_SymbolicEvent.__init__)


def test_hyp_eventautomatonmodel_symbolicevent_constructor_args():
    sig = inspect.signature(EventAutomatonModel_SymbolicEvent.__init__)
    params = list(sig.parameters.keys())



def test_hyp_eventautomatonmodel_complexeventprocessor_is_not_abstract():
    assert not inspect.isabstract(EventAutomatonModel_ComplexEventProcessor)


def test_hyp_eventautomatonmodel_complexeventprocessor_constructor_exists():
    assert callable(EventAutomatonModel_ComplexEventProcessor.__init__)


def test_hyp_eventautomatonmodel_complexeventprocessor_constructor_args():
    sig = inspect.signature(EventAutomatonModel_ComplexEventProcessor.__init__)
    params = list(sig.parameters.keys())



def test_hyp_eventautomatonmodel_symbolictimer_is_not_abstract():
    assert not inspect.isabstract(EventAutomatonModel_SymbolicTimer)


def test_hyp_eventautomatonmodel_symbolictimer_constructor_exists():
    assert callable(EventAutomatonModel_SymbolicTimer.__init__)


def test_hyp_eventautomatonmodel_symbolictimer_constructor_args():
...
def test_hyp_symbolicevent_is_not_abstract():
    assert not inspect.isabstract(SymbolicEvent)


def test_hyp_symbolicevent_constructor_exists():
    assert callable(SymbolicEvent.__init__)


def test_hyp_symbolicevent_constructor_args():
    sig = inspect.signature(SymbolicEvent.__init__)
    params = list(sig.parameters.keys())



def test_hyp_eventautomatonmodel_symbolictimeoutevent_is_not_abstract():
    assert not inspect.isabstract(EventAutomatonModel_SymbolicTimeoutEvent)


def test_hyp_eventautomatonmodel_symbolictimeoutevent_constructor_exists():
    assert callable(EventAutomatonModel_SymbolicTimeoutEvent.__init__)


def test_hyp_eventautomatonmodel_symbolictimeoutevent_constructor_args():
    sig = inspect.signature(EventAutomatonModel_SymbolicTimeoutEvent.__init__)
    params = list(sig.parameters.keys())



def test_hyp_eventautomatonmodel_symbolicinputevent_is_not_abstract():
    assert not inspect.isabstract(EventAutomatonModel_SymbolicInputEvent)


def test_hyp_eventautomatonmodel_symbolicinputevent_constructor_exists():
    assert callable(EventAutomatonModel_SymbolicInputEvent.__init__)


def test_hyp_eventautomatonmodel_symbolicinputevent_constructor_args():
...
def test_hyp_timeraction_is_not_abstract():
    assert not inspect.isabstract(TimerAction)


def test_hyp_timeraction_constructor_exists():
    assert callable(TimerAction.__init__)


def test_hyp_timeraction_constructor_args():
    sig = inspect.signature(TimerAction.__init__)
    params = list(sig.parameters.keys())



def test_hyp_eventautomatonmodel_settimeraction_is_not_abstract():
    assert not inspect.isabstract(EventAutomatonModel_SetTimerAction)


def test_hyp_eventautomatonmodel_settimeraction_constructor_exists():
    assert callable(EventAutomatonModel_SetTimerAction.__init__)


def test_hyp_eventautomatonmodel_settimeraction_constructor_args():
...
def test_hyp_eventautomatonmodel_resettimeraction_is_not_abstract():
    assert not inspect.isabstract(EventAutomatonModel_ResetTimerAction)


def test_hyp_eventautomatonmodel_resettimeraction_constructor_exists():
    assert callable(EventAutomatonModel_ResetTimerAction.__init__)


def test_hyp_eventautomatonmodel_resettimeraction_constructor_args():
    sig = inspect.signature(EventAutomatonModel_ResetTimerAction.__init__)
    params = list(sig.parameters.keys())



def test_hyp_eventautomatonmodel_symbolictokenparameter_is_not_abstract():
    assert not inspect.isabstract(EventAutomatonModel_SymbolicTokenParameter)


def test_hyp_eventautomatonmodel_symbolictokenparameter_constructor_exists():
    assert callable(EventAutomatonModel_SymbolicTokenParameter.__init__)


def test_hyp_eventautomatonmodel_symbolictokenparameter_constructor_args():
...
def test_hyp_eventautomatonmodel_constantbinding_is_not_abstract():
    assert not inspect.isabstract(EventAutomatonModel_ConstantBinding)


def test_hyp_eventautomatonmodel_constantbinding_constructor_exists():
    assert callable(EventAutomatonModel_ConstantBinding.__init__)


def test_hyp_eventautomatonmodel_constantbinding_constructor_args():
    sig = inspect.signature(EventAutomatonModel_ConstantBinding.__init__)
    params = list(sig.parameters.keys())



def test_hyp_eventautomatonmodel_tokenparameterbinding_is_not_abstract():
    assert not inspect.isabstract(EventAutomatonModel_TokenParameterBinding)


def test_hyp_eventautomatonmodel_tokenparameterbinding_constructor_exists():
    assert callable(EventAutomatonModel_TokenParameterBinding.__init__)


def test_hyp_eventautomatonmodel_tokenparameterbinding_constructor_args():
    sig = inspect.signature(EventAutomatonModel_TokenParameterBinding.__init__)
    params = list(sig.parameters.keys())



def test_hyp_eventautomatonmodel_symbolicparameter_is_not_abstract():
    assert not inspect.isabstract(EventAutomatonModel_SymbolicParameter)


def test_hyp_eventautomatonmodel_symbolicparameter_constructor_exists():
    assert callable(EventAutomatonModel_SymbolicParameter.__init__)


def test_hyp_eventautomatonmodel_symbolicparameter_constructor_args():
...
def test_hyp_eventautomatonmodel_token_is_not_abstract():
    assert not inspect.isabstract(EventAutomatonModel_Token)


def test_hyp_eventautomatonmodel_token_constructor_exists():
    assert callable(EventAutomatonModel_Token.__init__)


def test_hyp_eventautomatonmodel_token_constructor_args():
    sig = inspect.signature(EventAutomatonModel_Token.__init__)
    params = list(sig.parameters.keys())



def test_hyp_eventautomatonmodel_state_is_not_abstract():
    assert not inspect.isabstract(EventAutomatonModel_State)


def test_hyp_eventautomatonmodel_state_constructor_exists():
    assert callable(EventAutomatonModel_State.__init__)


def test_hyp_eventautomatonmodel_state_constructor_args():
...
def test_hyp_eventautomatonmodel_automaton_is_not_abstract():
    assert not inspect.isabstract(EventAutomatonModel_Automaton)


def test_hyp_eventautomatonmodel_automaton_constructor_exists():
    assert callable(EventAutomatonModel_Automaton.__init__)


def test_hyp_eventautomatonmodel_automaton_constructor_args():
...
EventAutomatonModel_NotEquivalentRelation_strategy = st.builds(
    EventAutomatonModel_NotEquivalentRelation,
)
...
def test_hyp_eventautomatonmodel_freeparameter_excludedValues_setter(instance):
...
def test_hyp_eventautomatonmodel_fixparameter_value_setter(instance):
...
def test_hyp_eventautomatonmodel_symbolictimer_name_setter(instance):
...
def test_hyp_eventautomatonmodel_symbolicinputevent_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_eventautomatonmodel_settimeraction_toValue_setter(instance):
...
def test_hyp_eventautomatonmodel_symbolicparameter_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_eventautomatonmodel_state_id_setter(instance):
...
@given(instance=EventAutomatonModel_State_strategy)
def test_hyp_eventautomatonmodel_state_acceptor_setter(instance):
...
def test_hyp_eventautomatonmodel_automaton_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_assoc_states53_link_reassign_clear():
    a = EventAutomatonModel_State(acceptor="sample_text", id=7)
    b1 = EventAutomatonModel_NotEquivalentRelation()
    b2 = EventAutomatonModel_NotEquivalentRelation()
    _safe_set(a, 'EventAutomatonModel_State54', b1)
    assert _is_linked(a, 'EventAutomatonModel_State54', b1)
    if hasattr(b1, 'EventAutomatonModel_NotEquivalentRelation'):
        assert _is_linked(b1, 'EventAutomatonModel_NotEquivalentRelation', a)
    _safe_set(a, 'EventAutomatonModel_State54', b2)
    assert _is_linked(a, 'EventAutomatonModel_State54', b2)
    if hasattr(b1, 'EventAutomatonModel_NotEquivalentRelation'):
        assert not _is_linked(b1, 'EventAutomatonModel_NotEquivalentRelation', a)
    if hasattr(b2, 'EventAutomatonModel_NotEquivalentRelation'):
        assert _is_linked(b2, 'EventAutomatonModel_NotEquivalentRelation', a)
    _safe_set(a, 'EventAutomatonModel_State54', None)
    assert not _is_linked(a, 'EventAutomatonModel_State54', b2)
    if hasattr(b2, 'EventAutomatonModel_NotEquivalentRelation'):
        assert not _is_linked(b2, 'EventAutomatonModel_NotEquivalentRelation', a)
...
EventAutomatonModel_NotEquivalentRelation_strategy = st.builds(EventAutomatonModel_NotEquivalentRelation)
@given(instance=EventAutomatonModel_NotEquivalentRelation_strategy)
@settings(max_examples=25)
def test_EventAutomatonModel_NotEquivalentRelation_instantiation(instance):
    assert isinstance(instance, EventAutomatonModel_NotEquivalentRelation)
