...
def test_eventautomatonmodel_notequivalentrelation_is_not_abstract():
    assert not inspect.isabstract(EventAutomatonModel_NotEquivalentRelation)


def test_eventautomatonmodel_notequivalentrelation_constructor_exists():
    assert callable(EventAutomatonModel_NotEquivalentRelation.__init__)


def test_eventautomatonmodel_notequivalentrelation_constructor_args():
