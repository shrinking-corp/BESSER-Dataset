...
class EventAutomatonModel_NotEquivalentRelation:
...
class EventAutomatonModel_AbstractTransition(ABC):
...
class EventAutomatonModel_SymbolicTimer:
    ...
    def __init__(self, name: str, timer: "EventAutomatonModel_SymbolicTimeoutEvent" = None, EventAutomatonModel_SymbolicTimer: "EventAutomatonModel_Automaton" = None, SymbolicTimer: "EventAutomatonModel_SymbolicTimeoutEvent" = None, EventAutomatonModel_SymbolicTimer31: "EventAutomatonModel_TimerAction" = None):
        self.name = name
        self.timer = timer
...
class EventAutomatonModel_SymbolicParameter(ABC):
    ...
    def __init__(self, name: str, EventAutomatonModel_SymbolicParameter20: "EventAutomatonModel_SymbolicEvent" = None, EventAutomatonModel_SymbolicParameter22: "EventAutomatonModel_Parameter" = None, EventAutomatonModel_SymbolicParameter: "EventAutomatonModel_Automaton" = None):
        self.name = name
...
class EventAutomatonModel_State:
    ...
    def __init__(self, acceptor: str, id: int, EventAutomatonModel_State: "EventAutomatonModel_Automaton" = None, on: set["EventAutomatonModel_Token"] = None, to: set["EventAutomatonModel_AbstractTransition"] = None, from_: set["EventAutomatonModel_AbstractTransition"] = None, State: "EventAutomatonModel_Token" = None, State49: "EventAutomatonModel_AbstractTransition" = None, State51: "EventAutomatonModel_AbstractTransition" = None, EventAutomatonModel_State54: "EventAutomatonModel_NotEquivalentRelation" = None, EventAutomatonModel_State5: "EventAutomatonModel_Automaton" = None, EventAutomatonModel_State12: "EventAutomatonModel_Automaton" = None):
        ...
        self.EventAutomatonModel_State54 = EventAutomatonModel_State54
    ...
    def from_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_EventAutomatonModel_State__from_", None)
    ...
    @property
    def EventAutomatonModel_State54(self):
        return self.__EventAutomatonModel_State54

    @EventAutomatonModel_State54.setter
    def EventAutomatonModel_State54(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_EventAutomatonModel_State__EventAutomatonModel_State54", None)
        self.__EventAutomatonModel_State54 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "EventAutomatonModel_NotEquivalentRelation"):
                opp_val = getattr(old_value, "EventAutomatonModel_NotEquivalentRelation", None)
                if isinstance(opp_val, set):
                    opp_val.discard(self)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "EventAutomatonModel_NotEquivalentRelation"):
                opp_val = getattr(value, "EventAutomatonModel_NotEquivalentRelation", None)
                if opp_val is None:
                    setattr(value, "EventAutomatonModel_NotEquivalentRelation", set([self]))
                elif isinstance(opp_val, set):
                    opp_val.add(self)
...
class EventAutomatonModel_Automaton:
    ...
    def __init__(self, name: str, EventAutomatonModel_Automaton: set["EventAutomatonModel_State"] = None, EventAutomatonModel_Automaton9: set["EventAutomatonModel_SymbolicTimer"] = None, EventAutomatonModel_Automaton16: "EventAutomatonModel_ComplexEventProcessor" = None, EventAutomatonModel_Automaton2: set["EventAutomatonModel_Token"] = None, EventAutomatonModel_Automaton4: "EventAutomatonModel_State" = None, EventAutomatonModel_Automaton7: set["EventAutomatonModel_SymbolicParameter"] = None, EventAutomatonModel_Automaton11: "EventAutomatonModel_State" = None):
        self.name = name
