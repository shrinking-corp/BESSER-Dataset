...
EventAutomatonModel_AbstractTransition = Class(name="EventAutomatonModel_AbstractTransition", is_abstract=True)
...
EventAutomatonModel_NotEquivalentRelation = Class(name="EventAutomatonModel_NotEquivalentRelation")
...
# EventAutomatonModel_NotEquivalentRelation class attributes and methods
...
states53: BinaryAssociation = BinaryAssociation(
    name="states53",
    ends={
        Property(name="EventAutomatonModel_State54", type=EventAutomatonModel_NotEquivalentRelation, multiplicity=Multiplicity(1, 1)),
        Property(name="EventAutomatonModel_NotEquivalentRelation", type=EventAutomatonModel_State, multiplicity=Multiplicity(2, 2))
    }
)
...
domain_model = DomainModel(
    ...
    types={EventAutomatonModel_Automaton, EventAutomatonModel_State, EventAutomatonModel_Token, EventAutomatonModel_SymbolicParameter, EventAutomatonModel_TokenParameterBinding, Binding, EventAutomatonModel_SymbolicTokenParameter, EventAutomatonModel_ResetTimerAction, TimerAction, EventAutomatonModel_SymbolicInputEvent, SymbolicEvent, EventAutomatonModel_SymbolicTimeoutEvent, EventAutomatonModel_SymbolicTimer, EventAutomatonModel_ComplexEventProcessor, EventAutomatonModel_SymbolicEvent, EventAutomatonModel_Parameter, SymbolicParameter, EventAutomatonModel_AbstractTransition, EventAutomatonModel_ConstantBinding, EventAutomatonModel_FixParameter, EventAutomatonModel_SymbolicEventParameter, EventAutomatonModel_FreeParameter, Parameter_, EventAutomatonModel_SetTimerAction, EventAutomatonModel_Binding, EventAutomatonModel_TimerAction, Action, EventAutomatonModel_EpsilonTransition, AbstractTransition, EventAutomatonModel_Event, EventAutomatonModel_Transition, EventAutomatonModel_EventGuard, EventAutomatonModel_Action, EventAutomatonModel_NotEquivalentRelation},
    associations={states0, tokens1, initialState3, symbolicTokenParameters6, trapState10, boundTo13, timeoutEvent14, timers8, automata15, symbolicEvents17, symbolicParameters19, type21, tokens23, incomingTransitions24, outgoingTransitions25, boundTo27, timer28, binds29, timer30, type32, parameters34, on37, parameters38, eventguard41, type45, to48, from_50, actions52, states53, bindings42},
    generalizations={gen_EventAutomatonModel_TokenParameterBinding_Binding, gen_EventAutomatonModel_ResetTimerAction_TimerAction, gen_EventAutomatonModel_SymbolicInputEvent_SymbolicEvent, gen_EventAutomatonModel_SymbolicTokenParameter_SymbolicParameter, gen_EventAutomatonModel_ConstantBinding_Binding, gen_EventAutomatonModel_SymbolicEventParameter_SymbolicParameter, gen_EventAutomatonModel_FreeParameter_Parameter, gen_EventAutomatonModel_SetTimerAction_TimerAction, gen_EventAutomatonModel_FixParameter_Parameter, gen_EventAutomatonModel_TimerAction_Action, gen_EventAutomatonModel_EpsilonTransition_AbstractTransition, gen_EventAutomatonModel_SymbolicTimeoutEvent_SymbolicEvent, gen_EventAutomatonModel_Transition_AbstractTransition},
    metadata=None
)
