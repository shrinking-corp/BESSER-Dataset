...
# Classes
simple_metrics_MetricsSet = Class(name="simple_metrics_MetricsSet")
simple_metrics_Metric = Class(name="simple_metrics_Metric")
...
simple_metrics_Metric.attributes={simple_metrics_Metric_value, simple_metrics_Metric_name}
