...
UserProperties = Class(name="UserProperties")
...
# UserProperties class attributes and methods
UserProperties_roles: Property = Property(name="roles", type=StringType)
UserProperties_Roles: Property = Property(name="Roles", type=StringType)
UserProperties.attributes={UserProperties_roles, UserProperties_Roles}
...
domain_model = DomainModel(
    name="_1c7cad19_f30f_466b_993b_a9fa1741e9ee",
    types={Search_books_external, Issue_member_card_external, Issue_book_external, Return_book_external, Update_member_profile_external, Maintain_book_in_records_external, Cancel_membership_external, Library_Management_Component, Member_Actor, Librarian_Actor, UserProperties, Inquiry_for_membership_external, Request_book_external, Request_book_return_external},
    associations={Member_Request_book_return, Member_Search_books, Librarian_Issue_member_card, Librarian_Issue_book, Librarian_Return_book, Librarian_Update_member_profile, Librarian_Maintain_book_in_records, Member_Cancel_membership, Member_Inquiry_for_membership, Member_Request_book},
    generalizations={},
    metadata=None
)
