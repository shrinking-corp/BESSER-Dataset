...
class study_Semester:
    ...
    def __init__(self, ordinal: int, Semester: "study_Specialization" = None, semesters: "study_Specialization" = None, Semester21: "study_ElectiveCourseList" = None, study_Semester30: "study_IndividualStudyPlan" = None, study_Semester: set["study_Course"] = None, semester: "study_ElectiveCourseList" = None):
...
class study_Specialization:
    ...
    def __init__(self, name: str, numYears: int, Specialization: "study_StudyProgramme" = None, study_Specialization: "study_StudyProgramme" = None, allSpecializations: "study_StudyProgramme" = None, specialization: set["study_Semester"] = None, study_Specialization13: "study_Specialization" = None, study_Specialization11: set["study_Specialization"] = None, Specialization15: "study_Semester" = None):
        self.name = name
...
class study_University:
    ...
    def __init__(self, name: str, university: set["study_StudyProgramme"] = None, university2: set["study_Course"] = None, university4: set["study_Student"] = None, University: "study_StudyProgramme" = None, University25: "study_Student" = None, University19: "study_Course" = None):
        self.name = name
...
class study_Course:
    ...
    def __init__(self, code: str, name: str, credits: float, level: int, study_Course: "study_Semester" = None, Course: "study_University" = None, study_Course23: "study_ElectiveCourseList" = None, courses: "study_University" = None, study_Course37: "study_CourseRelationship" = None):
        self.code = code
        self.name = name
...
class study_StudyProgramme:
    ...
    def __init__(self, code: str, name: str, numYears: int, studyProgramme: set["study_Specialization"] = None, study_StudyProgramme: set["study_Specialization"] = None, StudyProgramme9: "study_Specialization" = None, StudyProgramme: "study_University" = None, studyProgrammes: "study_University" = None):
        self.code = code
        self.name = name
        self.numYears = numYears
