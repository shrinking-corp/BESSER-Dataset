...
# Classes
study_StudyProgramme = Class(name="study_StudyProgramme")
study_Course = Class(name="study_Course")
study_Student = Class(name="study_Student")
study_University = Class(name="study_University")
study_IndividualStudyPlan = Class(name="study_IndividualStudyPlan")
study_CourseRelationship = Class(name="study_CourseRelationship")
study_Specialization = Class(name="study_Specialization")
study_Semester = Class(name="study_Semester")
study_ElectiveCourseList = Class(name="study_ElectiveCourseList")
...
study_StudyProgramme.attributes={study_StudyProgramme_code, study_StudyProgramme_name, study_StudyProgramme_numYears}
...
study_Course.attributes={study_Course_level, study_Course_name, study_Course_credits, study_Course_code}
...
study_Specialization.attributes={study_Specialization_numYears, study_Specialization_name}
...
domain_model = DomainModel(
    name="study",
    types={study_StudyProgramme, study_Course, study_Student, study_University, study_IndividualStudyPlan, study_CourseRelationship, study_Specialization, study_Semester, study_ElectiveCourseList, GradeEnum},
    associations={studyProgrammes0, courses1, students3, university5, semester20, courses22, university24, studyPlan26, student27, currentSemester29, courses31, allSpecializations6, baseSpecializations7, studyProgramme8, semesters10, furtherSpecializations12, specialization14, mandatoryCourses16, electiveCourses17, university18, studyPlan33, course36},
    generalizations={},
    metadata=None
)
