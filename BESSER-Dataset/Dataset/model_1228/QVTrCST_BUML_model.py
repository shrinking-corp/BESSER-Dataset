...
# Classes
qvtrelation_cst_DefaultValueCS = Class(name="qvtrelation_cst_DefaultValueCS")
OCLExpressionCS = Class(name="OCLExpressionCS")
qvtrelation_cst_DomainCS = Class(name="qvtrelation_cst_DomainCS")
AbstractDomainCS = Class(name="AbstractDomainCS")
qvtrelation_cst_AbstractDomainCS = Class(name="qvtrelation_cst_AbstractDomainCS", is_abstract=True)
CSTNode = Class(name="CSTNode")
qvtrelation_cst_CollectionTemplateCS = Class(name="qvtrelation_cst_CollectionTemplateCS")
TemplateCS = Class(name="TemplateCS")
IdentifiedCS = Class(name="IdentifiedCS")
cst_qvtrelation_EClassifier = Class(name="cst_qvtrelation_EClassifier")
IdentifierCS = Class(name="IdentifierCS")
ParamDeclarationCS = Class(name="ParamDeclarationCS")
qvtrelation_cst_RelationCS = Class(name="qvtrelation_cst_RelationCS")
DefaultValueCS = Class(name="DefaultValueCS")
OperationCallExpCS = Class(name="OperationCallExpCS")
qvtrelation_cst_KeyDeclCS = Class(name="qvtrelation_cst_KeyDeclCS")
PathNameCS = Class(name="PathNameCS")
qvtrelation_cst_ModelDeclCS = Class(name="qvtrelation_cst_ModelDeclCS")
qvtrelation_cst_ObjectTemplateCS = Class(name="qvtrelation_cst_ObjectTemplateCS")
PropertyTemplateCS = Class(name="PropertyTemplateCS")
cst_qvtrelation_EClass = Class(name="cst_qvtrelation_EClass")
qvtrelation_cst_ParamDeclarationCS = Class(name="qvtrelation_cst_ParamDeclarationCS")
TypeCS = Class(name="TypeCS")
qvtrelation_cst_PrimitiveTypeDomainCS = Class(name="qvtrelation_cst_PrimitiveTypeDomainCS")
cst_TemplateVariableCS = Class(name="cst_TemplateVariableCS")
cst_AbstractDomainCS = Class(name="cst_AbstractDomainCS")
qvtrelation_cst_PropertyTemplateCS = Class(name="qvtrelation_cst_PropertyTemplateCS")
cst_qvtrelation_EStructuralFeature = Class(name="cst_qvtrelation_EStructuralFeature")
qvtrelation_cst_QueryCS = Class(name="qvtrelation_cst_QueryCS")
RelationCS = Class(name="RelationCS")
qvtrelation_cst_UnitCS = Class(name="qvtrelation_cst_UnitCS")
qvtrelation_cst_VarDeclarationCS = Class(name="qvtrelation_cst_VarDeclarationCS")
VarDeclarationCS = Class(name="VarDeclarationCS")
WhenCS = Class(name="WhenCS")
WhereCS = Class(name="WhereCS")
qvtrelation_cst_TemplateCS = Class(name="qvtrelation_cst_TemplateCS", is_abstract=True)
cst_OCLExpressionCS = Class(name="cst_OCLExpressionCS")
qvtrelation_cst_TemplateVariableCS = Class(name="qvtrelation_cst_TemplateVariableCS", is_abstract=True)
qvtrelation_cst_TopLevelCS = Class(name="qvtrelation_cst_TopLevelCS")
UnitCS = Class(name="UnitCS")
TransformationCS = Class(name="TransformationCS")
qvtrelation_cst_TransformationCS = Class(name="qvtrelation_cst_TransformationCS")
ModelDeclCS = Class(name="ModelDeclCS")
KeyDeclCS = Class(name="KeyDeclCS")
QueryCS = Class(name="QueryCS")
qvtrelation_cst_WhenCS = Class(name="qvtrelation_cst_WhenCS")
qvtrelation_cst_WhereCS = Class(name="qvtrelation_cst_WhereCS")
...
qvtrelation_cst_DomainCS.attributes={qvtrelation_cst_DomainCS_enforce, qvtrelation_cst_DomainCS_checkonly, qvtrelation_cst_DomainCS_replace}
...
domain_model = DomainModel(
    name="qvtrelation",
    types={qvtrelation_cst_DefaultValueCS, OCLExpressionCS, qvtrelation_cst_DomainCS, AbstractDomainCS, qvtrelation_cst_AbstractDomainCS, CSTNode, qvtrelation_cst_CollectionTemplateCS, TemplateCS, IdentifiedCS, cst_qvtrelation_EClassifier, IdentifierCS, ParamDeclarationCS, qvtrelation_cst_RelationCS, DefaultValueCS, OperationCallExpCS, qvtrelation_cst_KeyDeclCS, PathNameCS, qvtrelation_cst_ModelDeclCS, qvtrelation_cst_ObjectTemplateCS, PropertyTemplateCS, cst_qvtrelation_EClass, qvtrelation_cst_ParamDeclarationCS, TypeCS, qvtrelation_cst_PrimitiveTypeDomainCS, cst_TemplateVariableCS, cst_AbstractDomainCS, qvtrelation_cst_PropertyTemplateCS, cst_qvtrelation_EStructuralFeature, qvtrelation_cst_QueryCS, RelationCS, qvtrelation_cst_UnitCS, qvtrelation_cst_VarDeclarationCS, VarDeclarationCS, WhenCS, WhereCS, qvtrelation_cst_TemplateCS, cst_OCLExpressionCS, qvtrelation_cst_TemplateVariableCS, qvtrelation_cst_TopLevelCS, UnitCS, TransformationCS, qvtrelation_cst_TransformationCS, ModelDeclCS, KeyDeclCS, QueryCS, qvtrelation_cst_WhenCS, qvtrelation_cst_WhereCS},
    associations={identifier5, initialiser7, modelId9, memberIdentifier0, referredCollectionType1, restIdentifier3, pathName40, inputParamDeclaration42, oclExpression44, type47, template11, defaultValue13, implementedBy15, classId17, propertyId18, modelId21, metaModelId23, propertyTemplate26, referredClass27, identifier29, type31, propertyId33, oclExpression35, referredProperty38, relation81, identifier83, varDeclarationId85, identifier50, overrides52, varDeclaration55, domain57, when59, where61, guardExpression63, type65, importClause67, transformation68, modelDecl70, extends71, identifier74, keyDecl77, query79, type87, expr90, expr92},
    generalizations={gen_qvtrelation_cst_DefaultValueCS_CSTNode, gen_qvtrelation_cst_DomainCS_AbstractDomainCS, gen_qvtrelation_cst_AbstractDomainCS_CSTNode, gen_qvtrelation_cst_CollectionTemplateCS_TemplateCS, gen_qvtrelation_cst_RelationCS_CSTNode, gen_qvtrelation_cst_KeyDeclCS_CSTNode, gen_qvtrelation_cst_ModelDeclCS_CSTNode, gen_qvtrelation_cst_ObjectTemplateCS_TemplateCS, gen_qvtrelation_cst_ParamDeclarationCS_CSTNode, gen_qvtrelation_cst_PrimitiveTypeDomainCS_cst_TemplateVariableCS, gen_qvtrelation_cst_PrimitiveTypeDomainCS_cst_AbstractDomainCS, gen_qvtrelation_cst_PropertyTemplateCS_CSTNode, gen_qvtrelation_cst_QueryCS_CSTNode, gen_qvtrelation_cst_UnitCS_CSTNode, gen_qvtrelation_cst_VarDeclarationCS_CSTNode, gen_qvtrelation_cst_TemplateCS_cst_TemplateVariableCS, gen_qvtrelation_cst_TemplateCS_cst_OCLExpressionCS, gen_qvtrelation_cst_TemplateVariableCS_IdentifiedCS, gen_qvtrelation_cst_TopLevelCS_CSTNode, gen_qvtrelation_cst_TransformationCS_CSTNode, gen_qvtrelation_cst_WhenCS_CSTNode, gen_qvtrelation_cst_WhereCS_CSTNode},
    metadata=None
)
