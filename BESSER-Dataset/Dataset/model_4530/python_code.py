...
class behaviour_Coordinate:
    ...
    def __init__(self, latitude: float, longitude: float, altitude: float, heading: float, behaviour_Coordinate17: "behaviour_GoTo" = None, behaviour_Coordinate: "behaviour_Drone" = None, behaviour_Coordinate19: "behaviour_Circle" = None):
