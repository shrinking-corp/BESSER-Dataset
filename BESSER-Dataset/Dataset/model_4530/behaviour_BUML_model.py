...
# Classes
behaviour_NamedElement = Class(name="behaviour_NamedElement", is_abstract=True)
behaviour_Behaviour = Class(name="behaviour_Behaviour")
NamedElement = Class(name="NamedElement")
behaviour_Drone = Class(name="behaviour_Drone")
behaviour_TakeOff = Class(name="behaviour_TakeOff")
behaviour_Land = Class(name="behaviour_Land")
behaviour_GoTo = Class(name="behaviour_GoTo")
behaviour_Coordinate = Class(name="behaviour_Coordinate")
behaviour_Move = Class(name="behaviour_Move", is_abstract=True)
behaviour_MoveTransition = Class(name="behaviour_MoveTransition")
behaviour_Slot = Class(name="behaviour_Slot")
behaviour_Action = Class(name="behaviour_Action", is_abstract=True)
behaviour_Start = Class(name="behaviour_Start")
Move = Class(name="Move")
behaviour_Stop = Class(name="behaviour_Stop")
behaviour_Choice = Class(name="behaviour_Choice")
MoveTransition = Class(name="MoveTransition")
CommunicationAction = Class(name="CommunicationAction")
behaviour_BroadcastNotify = Class(name="behaviour_BroadcastNotify")
Notify = Class(name="Notify")
behaviour_UnicastNotify = Class(name="behaviour_UnicastNotify")
behaviour_MulticastNotify = Class(name="behaviour_MulticastNotify")
behaviour_CheckNotification = Class(name="behaviour_CheckNotification")
behaviour_Hover = Class(name="behaviour_Hover")
behaviour_HeadTo = Class(name="behaviour_HeadTo")
behaviour_Circle = Class(name="behaviour_Circle")
behaviour_CommunicationAction = Class(name="behaviour_CommunicationAction", is_abstract=True)
Action = Class(name="Action")
behaviour_Notify = Class(name="behaviour_Notify", is_abstract=True)
behaviour_Feedback = Class(name="behaviour_Feedback")
behaviour_DeviceAction = Class(name="behaviour_DeviceAction")
behaviour_Parameter = Class(name="behaviour_Parameter")
...
behaviour_Coordinate.attributes={behaviour_Coordinate_longitude, behaviour_Coordinate_heading, behaviour_Coordinate_altitude, behaviour_Coordinate_latitude}
...
behaviour_Circle.attributes={behaviour_Circle_clockwise, behaviour_Circle_altitude, behaviour_Circle_radius, behaviour_Circle_duration}
...
from_32: BinaryAssociation = BinaryAssociation(
    name="from_32",
    ends={
...
domain_model = DomainModel(
    name="behaviour",
    types={behaviour_NamedElement, behaviour_Behaviour, NamedElement, behaviour_Drone, behaviour_TakeOff, behaviour_Land, behaviour_GoTo, behaviour_Coordinate, behaviour_Move, behaviour_MoveTransition, behaviour_Slot, behaviour_Action, behaviour_Start, Move, behaviour_Stop, behaviour_Choice, MoveTransition, CommunicationAction, behaviour_BroadcastNotify, Notify, behaviour_UnicastNotify, behaviour_MulticastNotify, behaviour_CheckNotification, behaviour_Hover, behaviour_HeadTo, behaviour_Circle, behaviour_CommunicationAction, Action, behaviour_Notify, behaviour_Feedback, behaviour_DeviceAction, behaviour_Parameter, GoToStrategy, TravelMode},
    associations={drones0, preActions11, postActions13, targetPosition16, home1, movements3, moveTransitions5, slots7, falseBranch9, slot20, receiver22, receiver24, slot26, targetPosition18, parameters38, parameters28, waitFor29, from_32, to35},
    generalizations={gen_behaviour_Behaviour_NamedElement, gen_behaviour_Drone_NamedElement, gen_behaviour_Move_NamedElement, gen_behaviour_TakeOff_Move, gen_behaviour_Land_Move, gen_behaviour_GoTo_Move, gen_behaviour_Action_NamedElement, gen_behaviour_Start_Move, gen_behaviour_Stop_Move, gen_behaviour_Choice_MoveTransition, gen_behaviour_Notify_CommunicationAction, gen_behaviour_BroadcastNotify_Notify, gen_behaviour_UnicastNotify_Notify, gen_behaviour_MulticastNotify_Notify, gen_behaviour_CheckNotification_CommunicationAction, gen_behaviour_Hover_Move, gen_behaviour_HeadTo_Move, gen_behaviour_Circle_Move, gen_behaviour_CommunicationAction_Action, gen_behaviour_Feedback_CommunicationAction, gen_behaviour_Slot_NamedElement, gen_behaviour_DeviceAction_Action},
    metadata=None
)
