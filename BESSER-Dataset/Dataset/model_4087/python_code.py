...
class classDiagram_UMLStereotype(UMLIncrement):
    ...
    def __init__(self, text: str, UMLStereotype: "classDiagram_UMLIncrement" = None, stereotypes: "classDiagram_UMLIncrement" = None):
        self.text = text
...
class classDiagram_UMLRole(UMLIncrement):
    ...
    def __init__(self, adornment: str, roles: "classDiagram_UMLClass" = None, UMLRole: "classDiagram_UMLAssoc" = None, UMLRole2: "classDiagram_UMLAssoc" = None, UMLRole4: "classDiagram_UMLCardinality" = None, UMLRole7: "classDiagram_UMLClass" = None, revCard: "classDiagram_UMLCardinality" = None, leftRole: "classDiagram_UMLAssoc" = None, rightRole: "classDiagram_UMLAssoc" = None):
