...
# Classes
classDiagram_UMLAssoc = Class(name="classDiagram_UMLAssoc")
UMLDiagramItem = Class(name="UMLDiagramItem")
classDiagram_UMLRole = Class(name="classDiagram_UMLRole")
classDiagram_UMLCardinality = Class(name="classDiagram_UMLCardinality")
UMLIncrement = Class(name="UMLIncrement")
classDiagram_UMLClassDiagram = Class(name="classDiagram_UMLClassDiagram")
UMLElement = Class(name="UMLElement")
classDiagram_UMLElement = Class(name="classDiagram_UMLElement", is_abstract=True)
classDiagram_UMLClass = Class(name="classDiagram_UMLClass")
classDiagram_UMLDiagramItem = Class(name="classDiagram_UMLDiagramItem", is_abstract=True)
classDiagram_UMLIncrement = Class(name="classDiagram_UMLIncrement", is_abstract=True)
classDiagram_UMLStereotype = Class(name="classDiagram_UMLStereotype")
...
domain_model = DomainModel(
    ...
    associations={target14, leftRole0, rightRole1, revCard3, elements5, roles6, diagram8, stereotypes9, card10, revLeftRole11, revRightRole12, increment15},
    generalizations={gen_classDiagram_UMLAssoc_UMLDiagramItem, gen_classDiagram_UMLStereotype_UMLIncrement, gen_classDiagram_UMLCardinality_UMLIncrement, gen_classDiagram_UMLClassDiagram_UMLElement, gen_classDiagram_UMLClass_UMLDiagramItem, gen_classDiagram_UMLDiagramItem_UMLIncrement, gen_classDiagram_UMLIncrement_UMLElement, gen_classDiagram_UMLRole_UMLIncrement},
    metadata=None
)
