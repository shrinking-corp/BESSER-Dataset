...
def test_hyp_send_attendance_alert_external_is_not_abstract():
    assert not inspect.isabstract(send_attendance_alert_external)


def test_hyp_send_attendance_alert_external_constructor_exists():
    assert callable(send_attendance_alert_external.__init__)


def test_hyp_send_attendance_alert_external_constructor_args():
...
def test_hyp_mark_attendance_external_is_not_abstract():
    assert not inspect.isabstract(Mark_Attendance_external)


def test_hyp_mark_attendance_external_constructor_exists():
    assert callable(Mark_Attendance_external.__init__)


def test_hyp_mark_attendance_external_constructor_args():
...
Mark_Attendance_external_strategy = st.builds(Mark_Attendance_external)
...
send_attendance_alert_external_strategy = st.builds(send_attendance_alert_external)
