...
def test_send_attendance_alert_external_is_not_abstract():
    assert not inspect.isabstract(send_attendance_alert_external)


def test_send_attendance_alert_external_constructor_exists():
    assert callable(send_attendance_alert_external.__init__)


def test_send_attendance_alert_external_constructor_args():
    sig = inspect.signature(send_attendance_alert_external.__init__)
...
def test_mark_attendance_external_is_not_abstract():
    assert not inspect.isabstract(Mark_Attendance_external)


def test_mark_attendance_external_constructor_exists():
    assert callable(Mark_Attendance_external.__init__)


def test_mark_attendance_external_constructor_args():
    sig = inspect.signature(Mark_Attendance_external.__init__)
    params = list(sig.parameters.keys())
...
send_attendance_alert_external_strategy = st.builds(
    send_attendance_alert_external,
)
...
Mark_Attendance_external_strategy = st.builds(
    Mark_Attendance_external,
)
...
@given(instance=send_attendance_alert_external_strategy)
@settings(max_examples=50)
def test_send_attendance_alert_external_instantiation(instance):
    assert isinstance(instance, send_attendance_alert_external)
...
@given(instance=Mark_Attendance_external_strategy)
@settings(max_examples=50)
def test_mark_attendance_external_instantiation(instance):
    assert isinstance(instance, Mark_Attendance_external)
