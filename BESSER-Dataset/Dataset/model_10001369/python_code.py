...
class send_attendance_alert_external:
...
class Mark_Attendance_external:
...
class ADMIN:
    ...
    def __init__(self, id: str, password: str, fACULTY37: set["FACULTY"] = None, sTUDENT39: set["STUDENT"] = None, pARENT41: set["PARENT"] = None):
        self.id = id
...
class STUDENT:
    ...
    def __init__(self, id: str, password: str, fACULTY35: set["FACULTY"] = None, aDMIN38: "ADMIN" = None):
        self.id = id
        self.password = password
