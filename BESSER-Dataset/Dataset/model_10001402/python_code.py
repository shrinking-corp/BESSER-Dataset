...
class Department:
    ...
    def __init__(self, hod: HOD, course: Course, students__: Student, teachers__: Teacher, course0: "Course" = None, student4: set["Student"] = None, employee6: set["Employee_Interface"] = None, access_Information19: "Access_Information" = None):
        self.hod = hod
        self.course = course
