...
class studies_StudyYear:
    ...
    def __init__(self, programName: str, studies_StudyYear10: "studies_StudyYear" = None, studies_StudyYear8: set["studies_StudyYear"] = None, studies_StudyYear12: "studies_Semester" = None, studies_StudyYear14: "studies_Semester" = None, studies_StudyYear: "studies_StudyInstance" = None):
...
class studies_Study:
    ...
    def __init__(self, name: str, code: str, studies_Study: "studies_University" = None, study: set["studies_StudyInstance"] = None, Study: "studies_StudyInstance" = None):
        self.name = name
        self.code = code
...
class studies_Course:
    ...
    def __init__(self, name: str, code: str, studyPoints: float, course: set["studies_CourseInstance"] = None, Course: "studies_CourseInstance" = None, studies_Course: "studies_University" = None):
        self.name = name
        self.code = code
