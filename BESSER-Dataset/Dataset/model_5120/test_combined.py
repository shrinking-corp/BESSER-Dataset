...
def test_assoc_context72_link_reassign_clear():
    ...
    b1 = diva_Scenario()
    b2 = diva_Scenario()
    _safe_set(a, 'diva_Context74', b1)
    assert _is_linked(a, 'diva_Context74', b1)
    if hasattr(b1, 'diva_Scenario73'):
        assert _is_linked(b1, 'diva_Scenario73', a)
    _safe_set(a, 'diva_Context74', b2)
    assert _is_linked(a, 'diva_Context74', b2)
    if hasattr(b1, 'diva_Scenario73'):
        assert not _is_linked(b1, 'diva_Scenario73', a)
    if hasattr(b2, 'diva_Scenario73'):
        assert _is_linked(b2, 'diva_Scenario73', a)
    _safe_set(a, 'diva_Context74', None)
    assert not _is_linked(a, 'diva_Context74', b2)
    if hasattr(b2, 'diva_Scenario73'):
        assert not _is_linked(b2, 'diva_Scenario73', a)
...
def test_assoc_oracle62_link_reassign_clear():
    ...
    _safe_set(a, 'diva_Context63', b1)
    assert _is_linked(a, 'diva_Context63', b1)
    if hasattr(b1, 'diva_VariantExpression64'):
        assert _is_linked(b1, 'diva_VariantExpression64', a)
    _safe_set(a, 'diva_Context63', b2)
    assert _is_linked(a, 'diva_Context63', b2)
    if hasattr(b1, 'diva_VariantExpression64'):
        assert not _is_linked(b1, 'diva_VariantExpression64', a)
    if hasattr(b2, 'diva_VariantExpression64'):
        assert _is_linked(b2, 'diva_VariantExpression64', a)
    _safe_set(a, 'diva_Context63', None)
    assert not _is_linked(a, 'diva_Context63', b2)
    if hasattr(b2, 'diva_VariantExpression64'):
        assert not _is_linked(b2, 'diva_VariantExpression64', a)
...
def test_assoc_propertyValue25_link_reassign_clear():
    ...
    if hasattr(b1, 'diva_Variant26'):
        assert _is_linked(b1, 'diva_Variant26', a)
    _safe_set(a, 'diva_PropertyValue', b2)
    assert _is_linked(a, 'diva_PropertyValue', b2)
    if hasattr(b1, 'diva_Variant26'):
        assert not _is_linked(b1, 'diva_Variant26', a)
    if hasattr(b2, 'diva_Variant26'):
        assert _is_linked(b2, 'diva_Variant26', a)
    _safe_set(a, 'diva_PropertyValue', None)
    assert not _is_linked(a, 'diva_PropertyValue', b2)
    if hasattr(b2, 'diva_Variant26'):
        assert not _is_linked(b2, 'diva_Variant26', a)
