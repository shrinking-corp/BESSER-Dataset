...
class EventAutomatonModel_SymbolicParameter(ABC):
    ...
    def __init__(self, name: str, EventAutomatonModel_SymbolicParameter: "EventAutomatonModel_Automaton" = None, EventAutomatonModel_SymbolicParameter22: "EventAutomatonModel_Parameter" = None, EventAutomatonModel_SymbolicParameter20: "EventAutomatonModel_SymbolicEvent" = None):
        self.name = name
