...
# Classes
testModel_ContainedLeaf = Class(name="testModel_ContainedLeaf")
testModel_referedLeaf = Class(name="testModel_referedLeaf")
testModel_upperBoundLeaf = Class(name="testModel_upperBoundLeaf")
Leafs = Class(name="Leafs")
testModel_Node = Class(name="testModel_Node")
testModel_Leafs = Class(name="testModel_Leafs", is_abstract=True)
testModel_multiRefLeaf = Class(name="testModel_multiRefLeaf")
...
testModel_ContainedLeaf.attributes={testModel_ContainedLeaf_double, testModel_ContainedLeaf_char, testModel_ContainedLeaf_date, testModel_ContainedLeaf_DoubleObj, testModel_ContainedLeaf_Character, testModel_ContainedLeaf_float, testModel_ContainedLeaf_byteArray, testModel_ContainedLeaf_name, testModel_ContainedLeaf_byteObject, testModel_ContainedLeaf_elementType}
...
testModel_referedLeaf.attributes={testModel_referedLeaf_name, testModel_referedLeaf_notChangeable, testModel_referedLeaf_int, testModel_referedLeaf_short, testModel_referedLeaf_Integer, testModel_referedLeaf_LongObj, testModel_referedLeaf_ShortObj, testModel_referedLeaf_Float, testModel_referedLeaf_long}
...
testModel_Node.attributes={testModel_Node_bigdeci, testModel_Node_name, testModel_Node_bigint, testModel_Node_bool, testModel_Node_byte, testModel_Node_Boolean}
...
domain_model = DomainModel(
    name="testModel",
    types={testModel_ContainedLeaf, testModel_referedLeaf, testModel_upperBoundLeaf, Leafs, testModel_Node, testModel_Leafs, testModel_multiRefLeaf, ElementType},
    associations={subNode1, contains2, ref4, upperBound6, multiRef8},
    generalizations={gen_testModel_upperBoundLeaf_Leafs, gen_testModel_referedLeaf_Leafs, gen_testModel_multiRefLeaf_Leafs},
    metadata=None
)
