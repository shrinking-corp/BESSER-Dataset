...
# Classes
junitresult_Property = Class(name="junitresult_Property")
junitresult_Testsuite = Class(name="junitresult_Testsuite")
AbstractAggregatedTest = Class(name="AbstractAggregatedTest")
junitresult_Testcase = Class(name="junitresult_Testcase")
junitresult_Skipped = Class(name="junitresult_Skipped")
junitresult_Failure = Class(name="junitresult_Failure")
junitresult_Error = Class(name="junitresult_Error")
NegativeResult = Class(name="NegativeResult")
junitresult_NegativeResult = Class(name="junitresult_NegativeResult", is_abstract=True)
junitresult_Testrun = Class(name="junitresult_Testrun")
junitresult_AbstractAggregatedTest = Class(name="junitresult_AbstractAggregatedTest", is_abstract=True)
JunitResult = Class(name="JunitResult")
junitresult_Testsuites = Class(name="junitresult_Testsuites")
junitresult_JunitResult = Class(name="junitresult_JunitResult", is_abstract=True)
...
junitresult_Testsuite.attributes={junitresult_Testsuite_disabled, junitresult_Testsuite_system_out, junitresult_Testsuite_package, junitresult_Testsuite_timestamp, junitresult_Testsuite_skipped, junitresult_Testsuite_id, junitresult_Testsuite_hostname, junitresult_Testsuite_time, junitresult_Testsuite_system_err}
...
junitresult_Testcase.attributes={junitresult_Testcase_time, junitresult_Testcase_classname, junitresult_Testcase_status, junitresult_Testcase_assertions, junitresult_Testcase_system_out, junitresult_Testcase_name, junitresult_Testcase_system_err}
...
junitresult_NegativeResult.attributes={junitresult_NegativeResult_type, junitresult_NegativeResult_message, junitresult_NegativeResult_value}
...
junitresult_Testrun.attributes={junitresult_Testrun_project, junitresult_Testrun_started, junitresult_Testrun_ignored}
...
junitresult_AbstractAggregatedTest.attributes={junitresult_AbstractAggregatedTest_failures, junitresult_AbstractAggregatedTest_tests, junitresult_AbstractAggregatedTest_name, junitresult_AbstractAggregatedTest_errors}
...
domain_model = DomainModel(
    name="junitresult",
    types={junitresult_Property, junitresult_Testsuite, AbstractAggregatedTest, junitresult_Testcase, junitresult_Skipped, junitresult_Failure, junitresult_Error, NegativeResult, junitresult_NegativeResult, junitresult_Testrun, junitresult_AbstractAggregatedTest, JunitResult, junitresult_Testsuites, junitresult_JunitResult},
    associations={properties0, testcases1, skipped3, failures5, errors7, testsuites9},
