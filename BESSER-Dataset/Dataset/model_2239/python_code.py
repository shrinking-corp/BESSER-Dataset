...
class course_StudyProgram:
    ...
    def __init__(self, code: str, course_StudyProgram24: "course_Department" = None, course_StudyProgram: "course_Course" = None, studyProgram: set["course_Student"] = None, course_StudyProgram48: "course_TimetableEntry" = None, StudyProgram: "course_Student" = None):
        self.code = code
...
class course_Course:
    ...
    def __init__(self, code: str, name: str, content: str, credits: float, Course22: "course_Department" = None, course_Course: "course_Course" = None, course_Course3: set["course_Course"] = None, course_Course7: "course_Course" = None, course_Course5: set["course_Course"] = None, course_Course9: set["course_StudyProgram"] = None, course: set["course_CourseInstance"] = None, courses: "course_Department" = None, Course: "course_CourseInstance" = None):
        self.code = code
        self.name = name
...
class course_Department:
    ...
    def __init__(self, name: str, shortName: str, department: set["course_Course"] = None, course_Department: set["course_StudyProgram"] = None, departments: "course_Faculty" = None, Department: "course_Faculty" = None, Department12: "course_Course" = None):
        self.name = name
...
class course_Evaluation:
    ...
    def __init__(self, exam: int, project: int, assigments: int, Evaluation: "course_CourseInstance" = None, evaluation: "course_CourseInstance" = None, evaluation30: set["course_Student"] = None, Evaluation51: "course_Student" = None):
        self.exam = exam
...
class course_Faculty:
    ...
    def __init__(self, name: str, shortName: str, Faculty: "course_University" = None, faculties: "course_University" = None, Faculty26: "course_Department" = None, faculty: set["course_Department"] = None):
        self.name = name
        self.shortName = shortName
