...
# Classes
course_University = Class(name="course_University")
course_Faculty = Class(name="course_Faculty")
course_Evaluation = Class(name="course_Evaluation")
course_CourseWork = Class(name="course_CourseWork")
course_Timetable = Class(name="course_Timetable")
course_Person = Class(name="course_Person")
course_Department = Class(name="course_Department")
course_Course = Class(name="course_Course")
course_StudyProgram = Class(name="course_StudyProgram")
course_CourseInstance = Class(name="course_CourseInstance")
course_Organisation = Class(name="course_Organisation")
course_TimetableEntry = Class(name="course_TimetableEntry")
course_Student = Class(name="course_Student")
course_CourseCoordinator = Class(name="course_CourseCoordinator")
course_Lecturer = Class(name="course_Lecturer")
course_TA = Class(name="course_TA")
...
course_Evaluation.attributes={course_Evaluation_exam, course_Evaluation_project, course_Evaluation_assigments}
...
course_CourseWork.attributes={course_CourseWork_lectureHours, course_CourseWork_labHours}
...
course_Department.attributes={course_Department_shortName, course_Department_name}
...
course_TimetableEntry.attributes={course_TimetableEntry_day, course_TimetableEntry_room, course_TimetableEntry_type, course_TimetableEntry_time}
...
domain_model = DomainModel(
    name="course",
    types={course_University, course_Faculty, course_Evaluation, course_CourseWork, course_Timetable, course_Person, course_Department, course_Course, course_StudyProgram, course_CourseInstance, course_Organisation, course_TimetableEntry, course_Student, course_CourseCoordinator, course_Lecturer, course_TA, Person, DayOfWeek, TypeOfInstruction},
    associations={faculties0, university1, organisation14, evaluation15, courseWork17, timeTable19, courses21, studyPrograms23, faculty25, departments2, requiredPreCond4, recommendedPreCond6, studyPrograms8, courseInstances10, department11, course13, students39, courseInstance41, courseInstance43, timetableEntry45, studyProgram46, courseInstance27, registeredStudents29, courseCoordinator31, lecturer32, ta34, courseInstance36, studyProgram49, evaluation50, organisation52, organisation54, organisation56},
