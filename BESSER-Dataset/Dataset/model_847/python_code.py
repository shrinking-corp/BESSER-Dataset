...
class fsm_Transition:
    ...
    def __init__(self, event: str, Transition: "fsm_FSM" = None, Transition6: "fsm_State" = None, Transition8: "fsm_State" = None, transitions: "fsm_FSM" = None, outgoingtransitions: "fsm_State" = None, incommingtransitions: "fsm_State" = None):
        self.event = event
...
class fsm_State:
    ...
    def __init__(self, name: str, State: "fsm_FSM" = None, states: "fsm_FSM" = None, from_: set["fsm_Transition"] = None, to: set["fsm_Transition"] = None, State12: "fsm_Transition" = None, State14: "fsm_Transition" = None):
        self.name = name
        self.State = State
        self.states = states
    ...
    def from_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_fsm_State__from_", None)
...
class fsm_FSM:
    ...
    def __init__(self, name: str, fsm: set["fsm_State"] = None, fsm2: set["fsm_Transition"] = None, fsm_FSM: "fsm_InitialState" = None, FSM: "fsm_State" = None, FSM10: "fsm_Transition" = None):
        self.name = name
