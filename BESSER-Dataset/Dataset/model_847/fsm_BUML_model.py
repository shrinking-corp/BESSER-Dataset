...
outgoingtransitions5: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_", type=fsm_Transition, multiplicity=Multiplicity(0, 9999))
    }
)
...
domain_model = DomainModel(
    ...
    associations={states0, transitions1, initialstate3, fsm4, outgoingtransitions5, incommingtransitions7, fsm9, from_11, to13},
