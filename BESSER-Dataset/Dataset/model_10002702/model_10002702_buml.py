...
Booking.attributes={Booking_endTime, Booking_contact_no, Booking_email_id, Booking_reservedTables, Booking_startTime, Booking_date, Booking_customer_name, Booking_booking_id}
...
Food.attributes={Food_served, Food_prepared, Food_price, Food_food_id, Food_name}
...
domain_model = DomainModel(
    name="d031278a_be69_431a_a268_caae020bfa5c",
    types={ReservationManagementSystem, Booking, Table, Report, Order, Food, Staff, Waiter, Chef, StaffUI, CustomerUI, Manager},
