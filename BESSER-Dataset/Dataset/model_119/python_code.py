...
class PropertyIdentifier:
    ...
    pass
class dom_QualifiedIdentifier(PropertyIdentifier, ISelector):
...
class IProperty:
    ...
    pass
class dom_PropertyIdentifier(IProperty, Expression):
...
class IPropertyName:
    ...
    pass
class dom_StringLiteral(IPropertyName, Expression):
...
class dom_NumericLiteral(IPropertyName, Expression):
...
class dom_IArrayElement(Node):
    ...
    pass
class dom_Expression(Node, IArrayElement, IForInitializer):
...
class dom_Source(Node):
    ...
    pass
class dom_Identifier(IProperty, IPropertyName, IPropertySelector, Node):

    def __init__(self, name: str, dom_Identifier: "dom_VariableReference" = None, dom_Identifier8: "dom_SetterAssignment" = None, dom_Identifier50: "dom_VariableDeclaration" = None, dom_Identifier137: "dom_Parameter" = None, dom_Identifier129: "dom_FunctionExpression" = None, dom_Identifier116: "dom_CatchClause" = None):
        self.name = name
