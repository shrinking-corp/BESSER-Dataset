...
ClassA.attributes={ClassA_publicAttribute, ClassA_protectedAttribute, ClassA_privateAttribute, ClassA_packageAttribute}
...
domain_model = DomainModel(
    name="_bfYlQGmLEeqH6JNbB4_uaw",
    types={BankAccount, T, T1, ClassA, ClassB, ClassC, ClassD, ClassE, ClassF, ClassG, ClassJ, ClassH, ClassK, ClassL, ClassM, ClassN, ClassP, InterfaceO_Interface, ClassQ, ClassR, ClassS, ClassT, ClassU, ClassV},
