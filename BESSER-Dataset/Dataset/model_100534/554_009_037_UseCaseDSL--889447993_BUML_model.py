...
UseCaseDSL_Actor.attributes={UseCaseDSL_Actor_description, UseCaseDSL_Actor_name, UseCaseDSL_Actor_type}
...
UseCaseDSL_Step.attributes={UseCaseDSL_Step_label, UseCaseDSL_Step_name}
...
UseCaseDSL_UseCase.attributes={UseCaseDSL_UseCase_postcondition, UseCaseDSL_UseCase_description, UseCaseDSL_UseCase_preConditions, UseCaseDSL_UseCase_name}
...
domain_model = DomainModel(
    name="UseCaseDSL",
    types={UseCaseDSL_BasicFlow, Flow, UseCaseDSL_Actor, UseCaseDSL_AlternativeFlow, NamedFlow, UseCaseDSL_AlternativeFlowAlternative, StepAlternative, UseCaseDSL_NamedFlow, UseCaseDSL_Condition, UseCaseDSL_ExceptionFlow, UseCaseDSL_Flow, UseCaseDSL_Step, UseCaseDSL_LocalAlternative, UseCaseDSL_UseCase, UseCaseDSL_NormalStep, Step, UseCaseDSL_StepAlternative, UseCaseDSL_PackageDeclaration, UseCaseDSL_ParallelFlow, UseCaseDSL_ParallelStep, UseCaseDSL_UseCasesModel, ActorType, CustomStepType},
    associations={extends1, ref2, steps3, invokedUseCase4, superCase25, stepAlternative5, actor6, useCases9, actors11, invokedFlows14, next16, invokedUseCase18, continuation21, flows27, packages30},
    generalizations={gen_UseCaseDSL_BasicFlow_Flow, gen_UseCaseDSL_AlternativeFlow_NamedFlow, gen_UseCaseDSL_AlternativeFlowAlternative_StepAlternative, gen_UseCaseDSL_Condition_StepAlternative, gen_UseCaseDSL_ExceptionFlow_NamedFlow, gen_UseCaseDSL_LocalAlternative_StepAlternative, gen_UseCaseDSL_NamedFlow_Flow, gen_UseCaseDSL_NormalStep_Step, gen_UseCaseDSL_ParallelFlow_NamedFlow, gen_UseCaseDSL_ParallelStep_Step},
    metadata=None
)
