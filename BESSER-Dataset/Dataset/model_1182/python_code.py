...
class simpleocl_OclFeatureDefinition(ModuleElement):
    ...
    def __init__(self, static: str, definition: "simpleocl_OclFeature" = None, definition135: "simpleocl_OclContextDefinition" = None, OclFeatureDefinition: "simpleocl_OclContextDefinition" = None, OclFeatureDefinition142: "simpleocl_OclFeature" = None):
        self.static = static
...
class simpleocl_OperatorCallExp(OclExpression):
    ...
    def __init__(self, operationName: str, simpleocl_OperatorCallExp: "simpleocl_OclExpression" = None, appliedOperator: "simpleocl_OclExpression" = None, OperatorCallExp: "simpleocl_OclExpression" = None):
        self.operationName = operationName
...
class simpleocl_VariableDeclaration(LocatedElement):
    ...
    def __init__(self, varName: str, variableDeclaration: "simpleocl_OclType" = None, referredVariable: set["simpleocl_VariableExp"] = None, VariableDeclaration: "simpleocl_VariableExp" = None, VariableDeclaration109: "simpleocl_OclType" = None):
...
class simpleocl_TupleTypeAttribute(LocatedElement):
    ...
    def __init__(self, name: str, tupleTypeAttribute: "simpleocl_OclType" = None, attributes: "simpleocl_TupleType" = None, TupleTypeAttribute119: "simpleocl_TupleType" = None, TupleTypeAttribute: "simpleocl_OclType" = None):
        self.name = name
...
class simpleocl_OclType(LocatedElement):
    ...
    def __init__(self, name: str, OclType: "simpleocl_OclExpression" = None, OclType44: "simpleocl_StaticPropertyCallExp" = None, OclType80: "simpleocl_VariableDeclaration" = None, OclType140: "simpleocl_OclContextDefinition" = None, OclType121: "simpleocl_TupleTypeAttribute" = None, OclType126: "simpleocl_MapType" = None, OclType128: "simpleocl_MapType" = None, context_: "simpleocl_OclContextDefinition" = None, type: "simpleocl_OclExpression" = None, returnType: "simpleocl_Operation" = None, valueType: "simpleocl_MapType" = None, type100: "simpleocl_Attribute" = None, keyType: "simpleocl_MapType" = None, OclType92: "simpleocl_CollectionType" = None, argumentTypes: "simpleocl_LambdaType" = None, source115: "simpleocl_StaticPropertyCallExp" = None, elementType: "simpleocl_CollectionType" = None, type106: "simpleocl_TupleTypeAttribute" = None, type108: "simpleocl_VariableDeclaration" = None, returnType111: "simpleocl_LambdaType" = None, OclType130: "simpleocl_LambdaType" = None, OclType132: "simpleocl_LambdaType" = None, OclType146: "simpleocl_Attribute" = None, OclType150: "simpleocl_Operation" = None):
        self.name = name
