...
# Classes
simpleocl_LocatedElement = Class(name="simpleocl_LocatedElement", is_abstract=True)
simpleocl_Import = Class(name="simpleocl_Import")
simpleocl_ModuleElement = Class(name="simpleocl_ModuleElement", is_abstract=True)
simpleocl_OclExpression = Class(name="simpleocl_OclExpression", is_abstract=True)
simpleocl_OclType = Class(name="simpleocl_OclType")
simpleocl_IfExp = Class(name="simpleocl_IfExp")
simpleocl_PropertyCallExp = Class(name="simpleocl_PropertyCallExp")
simpleocl_LetExp = Class(name="simpleocl_LetExp")
simpleocl_LoopExp = Class(name="simpleocl_LoopExp", is_abstract=True)
simpleocl_OperationCall = Class(name="simpleocl_OperationCall")
simpleocl_LocalVariable = Class(name="simpleocl_LocalVariable")
simpleocl_Operation = Class(name="simpleocl_Operation")
simpleocl_NamedElement = Class(name="simpleocl_NamedElement", is_abstract=True)
LocatedElement = Class(name="LocatedElement")
simpleocl_Module = Class(name="simpleocl_Module")
NamedElement = Class(name="NamedElement")
simpleocl_OclMetamodel = Class(name="simpleocl_OclMetamodel")
simpleocl_Attribute = Class(name="simpleocl_Attribute")
simpleocl_OperatorCallExp = Class(name="simpleocl_OperatorCallExp")
simpleocl_VariableExp = Class(name="simpleocl_VariableExp")
OclExpression = Class(name="OclExpression")
simpleocl_VariableDeclaration = Class(name="simpleocl_VariableDeclaration", is_abstract=True)
simpleocl_SuperExp = Class(name="simpleocl_SuperExp")
simpleocl_SelfExp = Class(name="simpleocl_SelfExp")
simpleocl_EnvExp = Class(name="simpleocl_EnvExp")
simpleocl_PrimitiveExp = Class(name="simpleocl_PrimitiveExp", is_abstract=True)
simpleocl_StringExp = Class(name="simpleocl_StringExp")
PrimitiveExp = Class(name="PrimitiveExp")
simpleocl_BooleanExp = Class(name="simpleocl_BooleanExp")
simpleocl_CollectionRange = Class(name="simpleocl_CollectionRange")
CollectionPart = Class(name="CollectionPart")
simpleocl_CollectionItem = Class(name="simpleocl_CollectionItem")
simpleocl_BagExp = Class(name="simpleocl_BagExp")
CollectionExp = Class(name="CollectionExp")
simpleocl_OrderedSetExp = Class(name="simpleocl_OrderedSetExp")
simpleocl_SequenceExp = Class(name="simpleocl_SequenceExp")
simpleocl_SetExp = Class(name="simpleocl_SetExp")
simpleocl_TupleExp = Class(name="simpleocl_TupleExp")
simpleocl_TuplePart = Class(name="simpleocl_TuplePart")
LocalVariable = Class(name="LocalVariable")
simpleocl_MapExp = Class(name="simpleocl_MapExp")
simpleocl_MapElement = Class(name="simpleocl_MapElement")
simpleocl_EnumLiteralExp = Class(name="simpleocl_EnumLiteralExp")
simpleocl_NumericExp = Class(name="simpleocl_NumericExp", is_abstract=True)
simpleocl_RealExp = Class(name="simpleocl_RealExp")
NumericExp = Class(name="NumericExp")
simpleocl_IntegerExp = Class(name="simpleocl_IntegerExp")
simpleocl_CollectionExp = Class(name="simpleocl_CollectionExp", is_abstract=True)
simpleocl_CollectionPart = Class(name="simpleocl_CollectionPart", is_abstract=True)
simpleocl_StaticNavigationOrAttributeCall = Class(name="simpleocl_StaticNavigationOrAttributeCall")
StaticPropertyCall = Class(name="StaticPropertyCall")
simpleocl_StaticOperationCall = Class(name="simpleocl_StaticOperationCall")
simpleocl_PropertyCall = Class(name="simpleocl_PropertyCall", is_abstract=True)
simpleocl_OclUndefinedExp = Class(name="simpleocl_OclUndefinedExp")
simpleocl_StaticPropertyCallExp = Class(name="simpleocl_StaticPropertyCallExp")
simpleocl_StaticPropertyCall = Class(name="simpleocl_StaticPropertyCall", is_abstract=True)
simpleocl_NotOpCallExp = Class(name="simpleocl_NotOpCallExp")
OperatorCallExp = Class(name="OperatorCallExp")
simpleocl_RelOpCallExp = Class(name="simpleocl_RelOpCallExp")
simpleocl_EqOpCallExp = Class(name="simpleocl_EqOpCallExp")
simpleocl_AddOpCallExp = Class(name="simpleocl_AddOpCallExp")
simpleocl_IntOpCallExp = Class(name="simpleocl_IntOpCallExp")
simpleocl_MulOpCallExp = Class(name="simpleocl_MulOpCallExp")
simpleocl_LambdaCallExp = Class(name="simpleocl_LambdaCallExp")
VariableExp = Class(name="VariableExp")
simpleocl_NavigationOrAttributeCall = Class(name="simpleocl_NavigationOrAttributeCall")
PropertyCall = Class(name="PropertyCall")
simpleocl_IteratorExp = Class(name="simpleocl_IteratorExp")
VariableDeclaration = Class(name="VariableDeclaration")
simpleocl_BraceExp = Class(name="simpleocl_BraceExp")
simpleocl_CollectionOperationCall = Class(name="simpleocl_CollectionOperationCall")
OperationCall = Class(name="OperationCall")
simpleocl_Iterator = Class(name="simpleocl_Iterator")
simpleocl_IterateExp = Class(name="simpleocl_IterateExp")
LoopExp = Class(name="LoopExp")
simpleocl_OclContextDefinition = Class(name="simpleocl_OclContextDefinition")
simpleocl_MapType = Class(name="simpleocl_MapType")
simpleocl_Parameter = Class(name="simpleocl_Parameter")
simpleocl_CollectionType = Class(name="simpleocl_CollectionType")
OclType = Class(name="OclType")
simpleocl_OclModelElementExp = Class(name="simpleocl_OclModelElementExp")
simpleocl_OclModel = Class(name="simpleocl_OclModel", is_abstract=True)
simpleocl_Primitive = Class(name="simpleocl_Primitive", is_abstract=True)
simpleocl_StringType = Class(name="simpleocl_StringType")
Primitive = Class(name="Primitive")
simpleocl_BooleanType = Class(name="simpleocl_BooleanType")
simpleocl_NumericType = Class(name="simpleocl_NumericType", is_abstract=True)
simpleocl_IntegerType = Class(name="simpleocl_IntegerType")
NumericType = Class(name="NumericType")
simpleocl_RealType = Class(name="simpleocl_RealType")
simpleocl_BagType = Class(name="simpleocl_BagType")
CollectionType = Class(name="CollectionType")
simpleocl_OrderedSetType = Class(name="simpleocl_OrderedSetType")
simpleocl_SequenceType = Class(name="simpleocl_SequenceType")
simpleocl_SetType = Class(name="simpleocl_SetType")
simpleocl_OclAnyType = Class(name="simpleocl_OclAnyType")
simpleocl_TupleType = Class(name="simpleocl_TupleType")
simpleocl_TupleTypeAttribute = Class(name="simpleocl_TupleTypeAttribute")
simpleocl_LambdaType = Class(name="simpleocl_LambdaType")
simpleocl_EnvType = Class(name="simpleocl_EnvType")
simpleocl_OclFeatureDefinition = Class(name="simpleocl_OclFeatureDefinition")
ModuleElement = Class(name="ModuleElement")
simpleocl_OclFeature = Class(name="simpleocl_OclFeature", is_abstract=True)
simpleocl_OclModelElement = Class(name="simpleocl_OclModelElement")
OclModel = Class(name="OclModel")
simpleocl_OclInstanceModel = Class(name="simpleocl_OclInstanceModel")
...
simpleocl_LocatedElement.attributes={simpleocl_LocatedElement_charStart, simpleocl_LocatedElement_column, simpleocl_LocatedElement_charEnd, simpleocl_LocatedElement_line}
...
domain_model = DomainModel(
    name="simpleocl",
    types={simpleocl_LocatedElement, simpleocl_Import, simpleocl_ModuleElement, simpleocl_OclExpression, simpleocl_OclType, simpleocl_IfExp, simpleocl_PropertyCallExp, simpleocl_LetExp, simpleocl_LoopExp, simpleocl_OperationCall, simpleocl_LocalVariable, simpleocl_Operation, simpleocl_NamedElement, LocatedElement, simpleocl_Module, NamedElement, simpleocl_OclMetamodel, simpleocl_Attribute, simpleocl_OperatorCallExp, simpleocl_VariableExp, OclExpression, simpleocl_VariableDeclaration, simpleocl_SuperExp, simpleocl_SelfExp, simpleocl_EnvExp, simpleocl_PrimitiveExp, simpleocl_StringExp, PrimitiveExp, simpleocl_BooleanExp, simpleocl_CollectionRange, CollectionPart, simpleocl_CollectionItem, simpleocl_BagExp, CollectionExp, simpleocl_OrderedSetExp, simpleocl_SequenceExp, simpleocl_SetExp, simpleocl_TupleExp, simpleocl_TuplePart, LocalVariable, simpleocl_MapExp, simpleocl_MapElement, simpleocl_EnumLiteralExp, simpleocl_NumericExp, simpleocl_RealExp, NumericExp, simpleocl_IntegerExp, simpleocl_CollectionExp, simpleocl_CollectionPart, simpleocl_StaticNavigationOrAttributeCall, StaticPropertyCall, simpleocl_StaticOperationCall, simpleocl_PropertyCall, simpleocl_OclUndefinedExp, simpleocl_StaticPropertyCallExp, simpleocl_StaticPropertyCall, simpleocl_NotOpCallExp, OperatorCallExp, simpleocl_RelOpCallExp, simpleocl_EqOpCallExp, simpleocl_AddOpCallExp, simpleocl_IntOpCallExp, simpleocl_MulOpCallExp, simpleocl_LambdaCallExp, VariableExp, simpleocl_NavigationOrAttributeCall, PropertyCall, simpleocl_IteratorExp, VariableDeclaration, simpleocl_BraceExp, simpleocl_CollectionOperationCall, OperationCall, simpleocl_Iterator, simpleocl_IterateExp, LoopExp, simpleocl_OclContextDefinition, simpleocl_MapType, simpleocl_Parameter, simpleocl_CollectionType, OclType, simpleocl_OclModelElementExp, simpleocl_OclModel, simpleocl_Primitive, simpleocl_StringType, Primitive, simpleocl_BooleanType, simpleocl_NumericType, simpleocl_IntegerType, NumericType, simpleocl_RealType, simpleocl_BagType, CollectionType, simpleocl_OrderedSetType, simpleocl_SequenceType, simpleocl_SetType, simpleocl_OclAnyType, simpleocl_TupleType, simpleocl_TupleTypeAttribute, simpleocl_LambdaType, simpleocl_EnvType, simpleocl_OclFeatureDefinition, ModuleElement, simpleocl_OclFeature, simpleocl_OclModelElement, OclModel, simpleocl_OclInstanceModel, OclFeature},
    associations={imports1, elements2, module4, module5, type7, ifExp38, appliedProperty9, letExp10, loopExp11, parentOperation12, initializedVariable13, ifExp214, owningOperation16, metamodels0, owningAttribute20, appliedOperator22, referredVariable24, ifExp118, first27, last28, item31, tuplePart33, tuple34, elements35, map36, key38, value40, parts25, collection26, staticCall45, staticCallExp46, arguments47, calls49, source50, source43, arguments53, argument55, source57, callExp51, result66, variable68, in_70, thenExpression73, condition75, elseExpression77, type79, variableExp81, letExp82, initExpression84, arguments59, exp61, body63, iterators65, definitions93, oclExpression94, operation96, mapType298, attribute99, mapType102, baseExp86, loopExpr87, operation89, elementType91, lambdaArgType112, staticPropertyCall114, model117, attributes118, collectionTypes104, tupleTypeAttribute105, variableDeclaration107, lambdaReturnType110, returnType129, argumentTypes131, feature133, context_134, definition137, context_139, definition141, type120, tupleType122, model123, valueType125, keyType127, body151, elements153, model154, initExpression143, type145, parameters147, returnType148, metamodel155},
    generalizations={gen_simpleocl_ModuleElement_LocatedElement, gen_simpleocl_Import_NamedElement, gen_simpleocl_OclExpression_LocatedElement, gen_simpleocl_NamedElement_LocatedElement, gen_simpleocl_Module_NamedElement, gen_simpleocl_VariableExp_OclExpression, gen_simpleocl_SuperExp_OclExpression, gen_simpleocl_SelfExp_OclExpression, gen_simpleocl_EnvExp_OclExpression, gen_simpleocl_PrimitiveExp_OclExpression, gen_simpleocl_StringExp_PrimitiveExp, gen_simpleocl_BooleanExp_PrimitiveExp, gen_simpleocl_CollectionRange_CollectionPart, gen_simpleocl_CollectionItem_CollectionPart, gen_simpleocl_BagExp_CollectionExp, gen_simpleocl_OrderedSetExp_CollectionExp, gen_simpleocl_SequenceExp_CollectionExp, gen_simpleocl_SetExp_CollectionExp, gen_simpleocl_TupleExp_OclExpression, gen_simpleocl_TuplePart_LocalVariable, gen_simpleocl_MapExp_OclExpression, gen_simpleocl_MapElement_LocatedElement, gen_simpleocl_EnumLiteralExp_OclExpression, gen_simpleocl_NumericExp_PrimitiveExp, gen_simpleocl_RealExp_NumericExp, gen_simpleocl_IntegerExp_NumericExp, gen_simpleocl_CollectionExp_OclExpression, gen_simpleocl_CollectionPart_LocatedElement, gen_simpleocl_StaticPropertyCall_LocatedElement, gen_simpleocl_StaticNavigationOrAttributeCall_StaticPropertyCall, gen_simpleocl_StaticOperationCall_StaticPropertyCall, gen_simpleocl_PropertyCallExp_OclExpression, gen_simpleocl_PropertyCall_LocatedElement, gen_simpleocl_OclUndefinedExp_OclExpression, gen_simpleocl_StaticPropertyCallExp_OclExpression, gen_simpleocl_OperationCall_PropertyCall, gen_simpleocl_OperatorCallExp_OclExpression, gen_simpleocl_NotOpCallExp_OperatorCallExp, gen_simpleocl_RelOpCallExp_OperatorCallExp, gen_simpleocl_EqOpCallExp_OperatorCallExp, gen_simpleocl_AddOpCallExp_OperatorCallExp, gen_simpleocl_IntOpCallExp_OperatorCallExp, gen_simpleocl_MulOpCallExp_OperatorCallExp, gen_simpleocl_LambdaCallExp_VariableExp, gen_simpleocl_NavigationOrAttributeCall_PropertyCall, gen_simpleocl_IteratorExp_LoopExp, gen_simpleocl_LetExp_OclExpression, gen_simpleocl_IfExp_OclExpression, gen_simpleocl_VariableDeclaration_LocatedElement, gen_simpleocl_LocalVariable_VariableDeclaration, gen_simpleocl_BraceExp_OclExpression, gen_simpleocl_CollectionOperationCall_OperationCall, gen_simpleocl_LoopExp_PropertyCall, gen_simpleocl_IterateExp_LoopExp, gen_simpleocl_Iterator_VariableDeclaration, gen_simpleocl_Parameter_VariableDeclaration, gen_simpleocl_CollectionType_OclType, gen_simpleocl_OclType_LocatedElement, gen_simpleocl_OclModelElementExp_OclExpression, gen_simpleocl_Primitive_OclType, gen_simpleocl_StringType_Primitive, gen_simpleocl_BooleanType_Primitive, gen_simpleocl_NumericType_Primitive, gen_simpleocl_IntegerType_NumericType, gen_simpleocl_RealType_NumericType, gen_simpleocl_BagType_CollectionType, gen_simpleocl_OrderedSetType_CollectionType, gen_simpleocl_SequenceType_CollectionType, gen_simpleocl_SetType_CollectionType, gen_simpleocl_OclAnyType_OclType, gen_simpleocl_TupleType_OclType, gen_simpleocl_LambdaType_OclType, gen_simpleocl_EnvType_OclType, gen_simpleocl_OclFeatureDefinition_ModuleElement, gen_simpleocl_OclContextDefinition_LocatedElement, gen_simpleocl_OclFeature_NamedElement, gen_simpleocl_TupleTypeAttribute_LocatedElement, gen_simpleocl_OclModelElement_OclType, gen_simpleocl_MapType_OclType, gen_simpleocl_OclModel_NamedElement, gen_simpleocl_OclMetamodel_OclModel, gen_simpleocl_Attribute_OclFeature, gen_simpleocl_Operation_OclFeature, gen_simpleocl_OclInstanceModel_OclModel},
    metadata=None
)
