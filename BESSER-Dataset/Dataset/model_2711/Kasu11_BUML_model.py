...
# Classes
Kasu11_ClassC = Class(name="Kasu11_ClassC")
Kasu11_ClassA = Class(name="Kasu11_ClassA")
Kasu11_ClassB = Class(name="Kasu11_ClassB")
...
domain_model = DomainModel(
    ...
    associations={C_C1, C_A3, C_C4, C_A7, C_B9, C_B0},
    generalizations={},
    metadata=None
)
