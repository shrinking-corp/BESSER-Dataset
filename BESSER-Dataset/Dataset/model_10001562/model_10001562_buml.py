...
Vue_VueGrille.attributes={Vue_VueGrille_TAILLE, Vue_VueGrille_modele, Vue_VueGrille_update}
...
Vue_CVue.attributes={Vue_CVue_grille, Vue_CVue_commande, Vue_CVue_frame}
...
Modele_CModele.attributes={Modele_CModele_attribute, Modele_CModele_hauteur, Modele_CModele_largeur}
...
Modele_Cellule.attributes={Modele_Cellule_etat, Modele_Cellule_x, Modele_Cellule_y, Modele_Cellule_modele, Modele_Cellule_prochaineEtat}
...
Modele_Joueur.attributes={Modele_Joueur_vivant, Modele_Joueur_y, Modele_Joueur_cles, Modele_Joueur_artefacts, Modele_Joueur_x}
