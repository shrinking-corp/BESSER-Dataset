...
def test_assoc_PaybillsTransaction_Payee_link_reassign_clear():
    a = transaction_Payee(accountNum="sample_text", address1="sample_text", address2="sample_text", city="sample_text", country="sample_text", email="sample_text", name="sample_text", phoneNum="sample_text", state="sample_text", zipcode="sample_text")
