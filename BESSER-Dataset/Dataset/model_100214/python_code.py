...
class HTML_BODY(HTMLElement):
    ...
    def __init__(self, text: str, link: str, alink: str, vlink: str, background: str, bgcolor: str, BODY: "HTML_HTML" = None, body: set["HTML_BODYElement"] = None, body15: "HTML_HTML" = None, BODY18: "HTML_BODYElement" = None):
        self.text = text
        self.link = link
        self.alink = alink
        self.vlink = vlink
...
class HTML_OBJECT:
    ...
    def __init__(self, type: str, standby: str, classid: str, id: str, data: str):
        self.type = type
