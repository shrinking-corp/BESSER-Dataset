...
domain_model = DomainModel(
    name="DB",
    types={DB_NamedElement, DB_Database, DB_DatabaseElement, NamedElement, DB_Table, DatabaseElement, DB_Column, DB_ForeignKey},
    associations={contents0, database1, table4, parent5, child7, columns2, primaryKeys3},
