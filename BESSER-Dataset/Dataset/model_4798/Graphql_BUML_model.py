...
# Classes
Graphql_Type = Class(name="Graphql_Type", is_abstract=True)
Graphql_Attribute = Class(name="Graphql_Attribute")
Graphql_Schema = Class(name="Graphql_Schema")
Graphql_ScalarType = Class(name="Graphql_ScalarType", is_abstract=True)
Type = Class(name="Type")
Graphql_Enum = Class(name="Graphql_Enum")
Graphql_EnumValue = Class(name="Graphql_EnumValue")
Graphql_SystemType = Class(name="Graphql_SystemType")
Graphql_Int = Class(name="Graphql_Int")
ScalarType = Class(name="ScalarType")
Graphql_Float = Class(name="Graphql_Float")
Graphql_String = Class(name="Graphql_String")
Graphql_Boolean = Class(name="Graphql_Boolean")
Graphql_ID = Class(name="Graphql_ID")
...
Graphql_Attribute.attributes={Graphql_Attribute_isNullable, Graphql_Attribute_isArray, Graphql_Attribute_typeName, Graphql_Attribute_name}
...
domain_model = DomainModel(
    name="Graphql",
    types={Graphql_Type, Graphql_Attribute, Graphql_Schema, Graphql_ScalarType, Type, Graphql_Enum, Graphql_EnumValue, Graphql_SystemType, Graphql_Int, ScalarType, Graphql_Float, Graphql_String, Graphql_Boolean, Graphql_ID},
    associations={attribute0, type1, enumvalue3},
    generalizations={gen_Graphql_ScalarType_Type, gen_Graphql_ID_ScalarType, gen_Graphql_Enum_Type, gen_Graphql_SystemType_Type, gen_Graphql_Int_ScalarType, gen_Graphql_Float_ScalarType, gen_Graphql_String_ScalarType, gen_Graphql_Boolean_ScalarType},
    metadata=None
)
