...
petriNet_PetriNetwork = Class(name="petriNet_PetriNetwork")
...
petriNet_Arc.attributes={petriNet_Arc_Direction, petriNet_Arc_jetonsTransferes}
...
domain_model = DomainModel(
    name="petriNet",
    types={petriNet_PetriElement, petriNet_Transition, PetriElement, petriNet_Arc, petriNet_Place, petriNet_PetriNetwork, ArcDirection},
    associations={petrielement15, arcSortants0, arcEntrants1, arcEntrants4, arcSortants6, transition9, place12},
    generalizations={gen_petriNet_Transition_PetriElement, gen_petriNet_Place_PetriElement, gen_petriNet_Arc_PetriElement},
    metadata=None
)
