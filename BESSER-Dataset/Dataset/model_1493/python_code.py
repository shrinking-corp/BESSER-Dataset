...
class petriNet_Arc(PetriElement):
    ...
    def __init__(self, jetonsTransferes: int, Direction: str, petriNet_Arc: "petriNet_Transition" = None, petriNet_Arc3: "petriNet_Transition" = None, petriNet_Arc5: "petriNet_Place" = None, petriNet_Arc8: "petriNet_Place" = None, petriNet_Arc10: "petriNet_Transition" = None, petriNet_Arc13: "petriNet_Place" = None):
...
class petriNet_Transition(PetriElement):
    ...
    def __init__(self, petriNet_Transition: set["petriNet_Arc"] = None, petriNet_Transition2: set["petriNet_Arc"] = None, petriNet_Transition11: "petriNet_Arc" = None):
