...
def test_genericsound_has_attribute():
    assert hasattr(GenericSound, "attribute")
    descriptor = None
    for klass in GenericSound.__mro__:
...
@given(instance=GenericSound_strategy)
def test_genericsound_attribute_setter(instance):
