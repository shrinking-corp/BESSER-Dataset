...
def test_hyp_genericsound_attribute_setter(instance):
...
def test_GenericSound_attribute_value_roundtrip():
    instance = GenericSound(attribute="sample_text")
...
GenericSound_strategy = st.builds(GenericSound, attribute=safe_text)
@given(instance=GenericSound_strategy)
@settings(max_examples=25)
