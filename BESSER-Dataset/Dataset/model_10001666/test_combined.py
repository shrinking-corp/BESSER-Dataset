...
def test_hyp_caninos2_is_not_abstract():
    assert not inspect.isabstract(Caninos2)


def test_hyp_caninos2_constructor_exists():
    assert callable(Caninos2.__init__)


def test_hyp_caninos2_constructor_args():
    sig = inspect.signature(Caninos2.__init__)
    params = list(sig.parameters.keys())



def test_hyp_empresa2_is_not_abstract():
    assert not inspect.isabstract(Empresa2)


def test_hyp_empresa2_constructor_exists():
    assert callable(Empresa2.__init__)


def test_hyp_empresa2_constructor_args():
    sig = inspect.signature(Empresa2.__init__)
    params = list(sig.parameters.keys())



def test_hyp_caninos1_is_not_abstract():
    assert not inspect.isabstract(Caninos1)


def test_hyp_caninos1_constructor_exists():
    assert callable(Caninos1.__init__)


def test_hyp_caninos1_constructor_args():
...
def test_hyp_caninos1_has_observaciones():
...
def test_hyp_caninos1_has_edad():
...
def test_hyp_caninos1_has_nombre():
...
def test_hyp_caninos1_has_raza():
...
def test_hyp_caninos1_has_altura():
...
def test_hyp_caninos1_has_peso():
...
def test_hyp_empresa1_is_not_abstract():
    assert not inspect.isabstract(Empresa1)


def test_hyp_empresa1_constructor_exists():
    assert callable(Empresa1.__init__)


def test_hyp_empresa1_constructor_args():
...
def test_hyp_caninos_has_altura():
...
def test_hyp_caninos_has_nombre():
...
def test_hyp_caninos_has_observaciones():
...
def test_hyp_empresa_has_getImagen():
...
def test_hyp_empresa_has_Caninos_BuscarCanino():
...
def test_hyp_empresa_has_getCaninos1():
...
def test_hyp_empresa_has_ArrayList():
...
def test_hyp_empresa_has_Empresa():
...
def test_hyp_empresa_has_getCaninos4():
...
def test_hyp_empresa_has_setImagen():
...
def test_hyp_empresa_has_getCaninos2():
...
def test_hyp_empresa_has_Caninos_informacion():
...
def test_hyp_empresa_has_getCaninos():
...
def test_hyp_empresa_has_agregarCaninos():
...
def test_hyp_empresa_has_nuevoCanino():
...
def test_hyp_empresa_has_getCaninos5():
...
def test_hyp_empresa_has_getCaninos3():
...
def test_hyp_empresa_has_cantidadRazaCanina():
...
def test_hyp_calcular_el_primedio_de_edad_de_los_ejemplares__usecase_is_not_abstract():
    assert not inspect.isabstract(Calcular_el_primedio_de_edad_de_los_ejemplares__UseCase)


def test_hyp_calcular_el_primedio_de_edad_de_los_ejemplares__usecase_constructor_exists():
    assert callable(Calcular_el_primedio_de_edad_de_los_ejemplares__UseCase.__init__)


def test_hyp_calcular_el_primedio_de_edad_de_los_ejemplares__usecase_constructor_args():
    sig = inspect.signature(Calcular_el_primedio_de_edad_de_los_ejemplares__UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_calcular_el_numero_ejemplar_por_raza__usecase_is_not_abstract():
    assert not inspect.isabstract(Calcular_el_numero_ejemplar_por_raza__UseCase)


def test_hyp_calcular_el_numero_ejemplar_por_raza__usecase_constructor_exists():
    assert callable(Calcular_el_numero_ejemplar_por_raza__UseCase.__init__)


def test_hyp_calcular_el_numero_ejemplar_por_raza__usecase_constructor_args():
    sig = inspect.signature(Calcular_el_numero_ejemplar_por_raza__UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_calcular_el_ejemplear_por_nombre__usecase_is_not_abstract():
    assert not inspect.isabstract(Calcular_el_ejemplear_por_nombre__UseCase)


def test_hyp_calcular_el_ejemplear_por_nombre__usecase_constructor_exists():
    assert callable(Calcular_el_ejemplear_por_nombre__UseCase.__init__)


def test_hyp_calcular_el_ejemplear_por_nombre__usecase_constructor_args():
    sig = inspect.signature(Calcular_el_ejemplear_por_nombre__UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_desplazarse_hasta_el_ultimo_ejemplar_usecase_is_not_abstract():
    assert not inspect.isabstract(Desplazarse_hasta_el_ultimo_ejemplar_UseCase)


def test_hyp_desplazarse_hasta_el_ultimo_ejemplar_usecase_constructor_exists():
    assert callable(Desplazarse_hasta_el_ultimo_ejemplar_UseCase.__init__)


def test_hyp_desplazarse_hasta_el_ultimo_ejemplar_usecase_constructor_args():
...
def test_hyp_regresar_hacia_el_anterior_ejemplar_usecase_is_not_abstract():
    assert not inspect.isabstract(Regresar_hacia_el_anterior_ejemplar_UseCase)


def test_hyp_regresar_hacia_el_anterior_ejemplar_usecase_constructor_exists():
    assert callable(Regresar_hacia_el_anterior_ejemplar_UseCase.__init__)


def test_hyp_regresar_hacia_el_anterior_ejemplar_usecase_constructor_args():
    sig = inspect.signature(Regresar_hacia_el_anterior_ejemplar_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_avanzar_hasta_el_siguiente_ejemplar__usecase_is_not_abstract():
    assert not inspect.isabstract(Avanzar_hasta_el_siguiente_ejemplar__UseCase)


def test_hyp_avanzar_hasta_el_siguiente_ejemplar__usecase_constructor_exists():
    assert callable(Avanzar_hasta_el_siguiente_ejemplar__UseCase.__init__)


def test_hyp_avanzar_hasta_el_siguiente_ejemplar__usecase_constructor_args():
    sig = inspect.signature(Avanzar_hasta_el_siguiente_ejemplar__UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_visualizar_hoja_de_vida_de_los_caninos__usecase_is_not_abstract():
    assert not inspect.isabstract(Visualizar_Hoja_de_vida_de_los_caninos__UseCase)


def test_hyp_visualizar_hoja_de_vida_de_los_caninos__usecase_constructor_exists():
    assert callable(Visualizar_Hoja_de_vida_de_los_caninos__UseCase.__init__)


def test_hyp_visualizar_hoja_de_vida_de_los_caninos__usecase_constructor_args():
...
def test_hyp_caninos1_instantiation(instance):
    assert isinstance(instance, Caninos1)



@given(instance=Caninos1_strategy)
def test_hyp_caninos1_observaciones_setter(instance):
...
@given(instance=Caninos1_strategy)
def test_hyp_caninos1_edad_setter(instance):
...
@given(instance=Caninos1_strategy)
def test_hyp_caninos1_nombre_setter(instance):
...
@given(instance=Caninos1_strategy)
def test_hyp_caninos1_raza_setter(instance):
...
@given(instance=Caninos1_strategy)
def test_hyp_caninos1_altura_setter(instance):
...
@given(instance=Caninos1_strategy)
def test_hyp_caninos1_peso_setter(instance):
...
@settings(max_examples=50)
def test_hyp_caninos_instantiation(instance):
...
@settings(max_examples=50)
def test_hyp_empresa_instantiation(instance):
    assert isinstance(instance, Empresa)



@given(instance=Empresa_strategy)
def test_hyp_empresa_getImagen_setter(instance):
...
@given(instance=Empresa_strategy)
def test_hyp_empresa_Caninos_BuscarCanino_setter(instance):
...
@given(instance=Empresa_strategy)
def test_hyp_empresa_getCaninos1_setter(instance):
...
@given(instance=Empresa_strategy)
def test_hyp_empresa_ArrayList_setter(instance):
...
@given(instance=Empresa_strategy)
def test_hyp_empresa_Empresa_setter(instance):
...
@given(instance=Empresa_strategy)
def test_hyp_empresa_getCaninos4_setter(instance):
...
@given(instance=Empresa_strategy)
def test_hyp_empresa_setImagen_setter(instance):
...
@given(instance=Empresa_strategy)
def test_hyp_empresa_getCaninos2_setter(instance):
...
@given(instance=Empresa_strategy)
def test_hyp_empresa_Caninos_informacion_setter(instance):
...
@given(instance=Empresa_strategy)
def test_hyp_empresa_getCaninos_setter(instance):
...
@given(instance=Empresa_strategy)
def test_hyp_empresa_agregarCaninos_setter(instance):
...
@given(instance=Empresa_strategy)
def test_hyp_empresa_nuevoCanino_setter(instance):
...
@given(instance=Empresa_strategy)
def test_hyp_empresa_getCaninos5_setter(instance):
...
@given(instance=Empresa_strategy)
def test_hyp_empresa_getCaninos3_setter(instance):
...
@given(instance=Empresa_strategy)
def test_hyp_empresa_cantidadRazaCanina_setter(instance):
