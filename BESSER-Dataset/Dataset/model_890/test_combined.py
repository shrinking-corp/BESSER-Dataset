...
def test_hyp_simplepdl_useresources_is_not_abstract():
    assert not inspect.isabstract(simplepdl_UseResources)


def test_hyp_simplepdl_useresources_constructor_exists():
    assert callable(simplepdl_UseResources.__init__)


def test_hyp_simplepdl_useresources_constructor_args():
...
def test_hyp_simplepdl_useresources_weight_setter(instance):
...
def test_hyp_simplepdl_resource_quantity_setter(instance):
