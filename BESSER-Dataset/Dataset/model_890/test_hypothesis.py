...
def test_simplepdl_useresources_is_not_abstract():
    assert not inspect.isabstract(simplepdl_UseResources)


def test_simplepdl_useresources_constructor_exists():
    assert callable(simplepdl_UseResources.__init__)


def test_simplepdl_useresources_constructor_args():
    sig = inspect.signature(simplepdl_UseResources.__init__)
    params = list(sig.parameters.keys())
    assert "weight" in params, "Missing parameter 'weight'"

def test_simplepdl_useresources_has_weight():
    assert hasattr(simplepdl_UseResources, "weight")
    descriptor = None
    for klass in simplepdl_UseResources.__mro__:
...
def test_simplepdl_resource_has_quantity():
    assert hasattr(simplepdl_Resource, "quantity")
    descriptor = None
...
simplepdl_UseResources_strategy = st.builds(
    simplepdl_UseResources,
    weight=
        st.integers()
)
...
@given(instance=simplepdl_UseResources_strategy)
def test_simplepdl_useresources_weight_setter(instance):
...
@given(instance=simplepdl_Resource_strategy)
def test_simplepdl_resource_quantity_setter(instance):
