...
class simplepdl_WorkSequence(ProcessElement):
    ...
    def __init__(self, linkType: str, WorkSequence6: "simplepdl_WorkDefinition" = None, WorkSequence: "simplepdl_WorkDefinition" = None, linksToSuccessors: "simplepdl_WorkDefinition" = None, linksToPredecessors: "simplepdl_WorkDefinition" = None):
...
class simplepdl_WorkDefinition(ProcessElement):
    ...
    def __init__(self, name: str, predecessor: set["simplepdl_WorkSequence"] = None, successor: set["simplepdl_WorkSequence"] = None, simplepdl_WorkDefinition: set["simplepdl_UseResources"] = None, WorkDefinition: "simplepdl_WorkSequence" = None, WorkDefinition10: "simplepdl_WorkSequence" = None, simplepdl_WorkDefinition17: "simplepdl_UseResources" = None):
        self.name = name
