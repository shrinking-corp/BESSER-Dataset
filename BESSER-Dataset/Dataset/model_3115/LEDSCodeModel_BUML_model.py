...
# Classes
LedsCodeModel_Specification = Class(name="LedsCodeModel_Specification")
LedsCodeModel_Model = Class(name="LedsCodeModel_Model", is_abstract=True)
LedsCodeModel_Feature = Class(name="LedsCodeModel_Feature")
LedsCodeModel_ClassDiagram = Class(name="LedsCodeModel_ClassDiagram")
Model = Class(name="Model")
LedsCodeModel_AbstractClass = Class(name="LedsCodeModel_AbstractClass", is_abstract=True)
LedsCodeModel_Class = Class(name="LedsCodeModel_Class")
AbstractClass = Class(name="AbstractClass")
LedsCodeModel_Attribute = Class(name="LedsCodeModel_Attribute")
LedsCodeModel_Classifier = Class(name="LedsCodeModel_Classifier", is_abstract=True)
LedsCodeModel_PrimitiveDataType = Class(name="LedsCodeModel_PrimitiveDataType")
Classifier = Class(name="Classifier")
LedsCodeModel_Association = Class(name="LedsCodeModel_Association")
LedsCodeModel_ENUM = Class(name="LedsCodeModel_ENUM")
...
LedsCodeModel_Specification.attributes={LedsCodeModel_Specification_createdDate, LedsCodeModel_Specification_name}
...
LedsCodeModel_Feature.attributes={LedsCodeModel_Feature_orm, LedsCodeModel_Feature_language, LedsCodeModel_Feature_applicationType, LedsCodeModel_Feature_engine, LedsCodeModel_Feature_dataBaseName}
...
domain_model = DomainModel(
    name="LedsCodeModel",
    types={LedsCodeModel_Specification, LedsCodeModel_Model, LedsCodeModel_Feature, LedsCodeModel_ClassDiagram, Model, LedsCodeModel_AbstractClass, LedsCodeModel_Class, AbstractClass, LedsCodeModel_Attribute, LedsCodeModel_Classifier, LedsCodeModel_PrimitiveDataType, Classifier, LedsCodeModel_Association, LedsCodeModel_ENUM, StereotypeClass, PrimitiveData, StereotypeAttribute},
    associations={has0, described1, composed3, attributes4, parent6, type8, target10, source12},
    generalizations={gen_LedsCodeModel_ClassDiagram_Model, gen_LedsCodeModel_Class_AbstractClass, gen_LedsCodeModel_PrimitiveDataType_Classifier, gen_LedsCodeModel_AbstractClass_Classifier, gen_LedsCodeModel_ENUM_AbstractClass},
    metadata=None
)
