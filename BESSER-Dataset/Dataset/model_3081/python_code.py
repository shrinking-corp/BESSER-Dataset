...
class caltrop_EventPattern(ActionPattern):
    ...
    def __init__(self, qualifier: str, variables: str, _property: bool, name: str, caltrop_EventPattern58: "caltrop_XExpression" = None, caltrop_EventPattern61: "caltrop_XExpression" = None, caltrop_EventPattern: "caltrop_EventAction" = None, caltrop_EventPattern55: "caltrop_StateVariable" = None):
