...
# Classes
agentDSL_Function = Class(name="agentDSL_Function")
agentDSL_Model = Class(name="agentDSL_Model")
agentDSL_Type = Class(name="agentDSL_Type")
agentDSL_TypeDef = Class(name="agentDSL_TypeDef")
Type = Class(name="Type")
agentDSL_JAVAID = Class(name="agentDSL_JAVAID")
agentDSL_Entity = Class(name="agentDSL_Entity")
agentDSL_Attribute = Class(name="agentDSL_Attribute")
agentDSL_Task = Class(name="agentDSL_Task")
agentDSL_Outcome = Class(name="agentDSL_Outcome")
agentDSL_Goal = Class(name="agentDSL_Goal")
...
domain_model = DomainModel(
    name="agentDSL",
    types={agentDSL_Function, agentDSL_Model, agentDSL_Type, agentDSL_TypeDef, Type, agentDSL_JAVAID, agentDSL_Entity, agentDSL_Attribute, agentDSL_Task, agentDSL_Outcome, agentDSL_Goal},
    associations={goal13, attributes15, attributes18, type20, types0, mappedType1, superEntity3, attributes4, attributes6, outcome8, attributes10},
    generalizations={gen_agentDSL_Function_Type, gen_agentDSL_TypeDef_Type, gen_agentDSL_Entity_Type, gen_agentDSL_Task_Type, gen_agentDSL_Outcome_Type},
    metadata=None
)
