...
class agentDSL_Attribute:
    ...
    def __init__(self, many: bool, name: str, agentDSL_Attribute17: "agentDSL_Goal" = None, agentDSL_Attribute19: "agentDSL_Function" = None, agentDSL_Attribute21: "agentDSL_Type" = None, agentDSL_Attribute: "agentDSL_Entity" = None, agentDSL_Attribute7: "agentDSL_Task" = None, agentDSL_Attribute12: "agentDSL_Outcome" = None):
        self.many = many
        self.name = name
...
class agentDSL_Type:
    ...
    def __init__(self, name: str, agentDSL_Type22: "agentDSL_Attribute" = None, agentDSL_Type: "agentDSL_Model" = None):
        self.name = name
