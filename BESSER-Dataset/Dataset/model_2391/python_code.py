...
class genSql_Column:
    ...
    def __init__(self, name: str, SQLType: str, Longitud: str, genSql_Column: "genSql_Table" = None, genSql_Column9: "genSql_PrimaryKey" = None, genSql_Column12: "genSql_ForeignKey" = None, genSql_Column18: "genSql_ForeignKey" = None):
        self.name = name
