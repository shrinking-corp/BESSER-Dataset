...
genSql_Column.attributes={genSql_Column_SQLType, genSql_Column_name, genSql_Column_Longitud}
...
domain_model = DomainModel(
    name="genSql",
    types={genSql_PrimaryKey, genSql_ForeignKey, genSql_DataBase, genSql_Table, genSql_Column},
