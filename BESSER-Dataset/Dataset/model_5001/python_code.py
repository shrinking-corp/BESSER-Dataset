...
class cloudml_Node(WithProperties):
    ...
    def __init__(self, minDisk: int, location: str, OS: str, sshKey: str, securityGroup: str, groupName: str, minRam: int, minCore: int, privateKey: str, imageID: str, is64os: bool, cloudml_Node: "cloudml_DeploymentModel" = None, cloudml_Node25: "cloudml_Provider" = None, cloudml_Node41: "cloudml_NodeInstance" = None):
...
class cloudml_Provider(WithProperties):
    ...
    def __init__(self, credentials: str, cloudml_Provider26: "cloudml_Node" = None, cloudml_Provider: "cloudml_DeploymentModel" = None):
...
class cloudml_Resource(WithProperties):
    ...
    def __init__(self, retrievingCommand: str, deployingCommand: str, configurationCommand: str, startCommand: str, stopCommand: str, cloudml_Resource19: "cloudml_Artefact" = None, cloudml_Resource: set["cloudml_UploadCommand"] = None, cloudml_Resource52: "cloudml_Binding" = None, cloudml_Resource55: "cloudml_Binding" = None):
