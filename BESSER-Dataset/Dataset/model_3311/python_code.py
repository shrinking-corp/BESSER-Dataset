...
class grammar_Rule:
    ...
    def __init__(self, name: str, priority: int, Rule: "grammar_Grammar" = None, rules: "grammar_Grammar" = None, parentRule: "grammar_LHS" = None, parentRule4: "grammar_RHS" = None, ParentRule: "grammar_Embedding" = None, Rule13: "grammar_Embedding" = None, Rule7: "grammar_LHS" = None, Rule10: "grammar_RHS" = None):
        self.name = name
