...
# Classes
grammar_Grammar = Class(name="grammar_Grammar")
Named = Class(name="Named")
grammar_Rule = Class(name="grammar_Rule")
grammar_LHS = Class(name="grammar_LHS")
grammar_RHS = Class(name="grammar_RHS")
grammar_Embedding = Class(name="grammar_Embedding")
grammar_ConnexionInstruction = Class(name="grammar_ConnexionInstruction")
grammar_Node = Class(name="grammar_Node")
grammar_Graph = Class(name="grammar_Graph")
...
grammar_Rule.attributes={grammar_Rule_name, grammar_Rule_priority}
...
domain_model = DomainModel(
    name="grammar",
    types={grammar_Grammar, Named, grammar_Rule, grammar_LHS, grammar_RHS, grammar_Embedding, grammar_ConnexionInstruction, grammar_Node, grammar_Graph},
    associations={rules0, parentGrammar1, lhs2, rhs3, EmbeddingMechanism5, ParentRule12, instructions14, parentEmbedding15, d17, parentRule6, node8, parentRule9, subGraph11},
