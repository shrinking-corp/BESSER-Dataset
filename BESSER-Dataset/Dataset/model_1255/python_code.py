...
class xmof_CompleteActions_ReduceAction(Action):
    ...
    def __init__(self, ordered: bool, xmof_CompleteActions_ReduceAction167: "BasicActions_OutputPin" = None, xmof_CompleteActions_ReduceAction170: "BasicActions_InputPin" = None, xmof_CompleteActions_ReduceAction: "BasicBehaviors_Behavior" = None):
...
class xmof_CompleteActions_AcceptEventAction(Action):
    ...
    def __init__(self, unmarshall: bool, xmof_CompleteActions_AcceptEventAction: set["BasicActions_OutputPin"] = None, xmof_CompleteActions_AcceptEventAction195: set["Communications_Trigger"] = None):
...
class xmof_CompleteStructuredActivities_StructuredActivityNode(Action):
    ...
    def __init__(self, mustIsolate: bool, inStructuredNode90: set["IntermediateActivities_ActivityEdge"] = None, xmof_CompleteStructuredActivities_StructuredActivityNode: set["BasicActions_OutputPin"] = None, xmof_CompleteStructuredActivities_StructuredActivityNode95: set["BasicActions_InputPin"] = None, inStructuredNode: set["IntermediateActivities_ActivityNode"] = None):
...
class xmof_CompleteStructuredActivities_ConditionalNode(StructuredActivityNode):
    ...
    def __init__(self, determinate: bool, assured: bool, xmof_CompleteStructuredActivities_ConditionalNode: set["CompleteStructuredActivities_Clause"] = None, xmof_CompleteStructuredActivities_ConditionalNode85: set["BasicActions_OutputPin"] = None):
...
class xmof_CompleteStructuredActivities_LoopNode(StructuredActivityNode):
    ...
    def __init__(self, testedFirst: bool, xmof_CompleteStructuredActivities_LoopNode64: set["BasicActions_OutputPin"] = None, xmof_CompleteStructuredActivities_LoopNode67: set["CompleteStructuredActivities_ExecutableNode"] = None, xmof_CompleteStructuredActivities_LoopNode: "BasicActions_OutputPin" = None, xmof_CompleteStructuredActivities_LoopNode51: set["CompleteStructuredActivities_ExecutableNode"] = None, xmof_CompleteStructuredActivities_LoopNode53: set["BasicActions_OutputPin"] = None, xmof_CompleteStructuredActivities_LoopNode56: set["BasicActions_InputPin"] = None, xmof_CompleteStructuredActivities_LoopNode58: set["CompleteStructuredActivities_ExecutableNode"] = None, xmof_CompleteStructuredActivities_LoopNode61: set["BasicActions_OutputPin"] = None):
