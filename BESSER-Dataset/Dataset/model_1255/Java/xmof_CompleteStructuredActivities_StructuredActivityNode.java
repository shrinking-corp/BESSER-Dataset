...
public class xmof_CompleteStructuredActivities_StructuredActivityNode extends Action {
    ...
    public xmof_CompleteStructuredActivities_StructuredActivityNode(
        boolean mustIsolate        ArrayList<IntermediateActivities_ActivityEdge> intermediateactivities_activityedges,        ArrayList<BasicActions_OutputPin> basicactions_outputpins,        ArrayList<BasicActions_InputPin> basicactions_inputpins,        ArrayList<IntermediateActivities_ActivityNode> intermediateactivities_activitynodes    ) {
        this.mustIsolate = mustIsolate;
