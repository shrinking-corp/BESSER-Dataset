...
# Classes
py_Commands = Class(name="py_Commands")
py_Output = Class(name="py_Output")
py_Command = Class(name="py_Command")
py_Wh = Class(name="py_Wh")
py_Program = Class(name="py_Program")
py_FunctionP = Class(name="py_FunctionP")
py_Definition = Class(name="py_Definition")
py_Input = Class(name="py_Input")
py_ExprSimple = Class(name="py_ExprSimple")
py_ExprAnd = Class(name="py_ExprAnd")
py_EObject = Class(name="py_EObject")
py_If = Class(name="py_If")
py_Expr = Class(name="py_Expr")
py_Nop = Class(name="py_Nop")
py_Affect = Class(name="py_Affect")
py_For = Class(name="py_For")
py_Foreach = Class(name="py_Foreach")
py_While = Class(name="py_While")
py_ExprOr = Class(name="py_ExprOr")
py_ExprCons = Class(name="py_ExprCons")
py_LExpr = Class(name="py_LExpr")
py_ExprList = Class(name="py_ExprList")
py_ExprHd = Class(name="py_ExprHd")
py_ExprTl = Class(name="py_ExprTl")
py_ExprSym = Class(name="py_ExprSym")
py_ExprNot = Class(name="py_ExprNot")
py_ExprEq = Class(name="py_ExprEq")
...
py_ExprSimple.attributes={py_ExprSimple_sym, py_ExprSimple_str, py_ExprSimple_varSimple}
...
domain_model = DomainModel(
    name="py",
    types={py_Commands, py_Output, py_Command, py_Wh, py_Program, py_FunctionP, py_Definition, py_Input, py_ExprSimple, py_ExprAnd, py_EObject, py_If, py_Expr, py_Nop, py_Affect, py_For, py_Foreach, py_While, py_ExprOr, py_ExprCons, py_LExpr, py_ExprList, py_ExprHd, py_ExprTl, py_ExprSym, py_ExprNot, py_ExprEq},
    associations={commands7, output9, commands11, elements0, functions1, definition3, input5, expr34, cmds36, expr39, arg142, cmd13, expr15, commands116, commands219, exprs22, expr24, cmds26, expr229, cmd31, arg165, arg267, arg243, arg146, arg248, lexpr51, lexpr52, arg55, arg57, arg59, arg261, arg163},
    generalizations={},
    metadata=None
)
