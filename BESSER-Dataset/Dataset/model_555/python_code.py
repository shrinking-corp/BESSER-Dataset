...
class gedcoml_BekanntePerson(Person):
    ...
    def __init__(self, middleName: str, birthDay: str, deathDay: str, birthName: str, firstName: str, lastName: str, gedcoml_BekanntePerson: set["gedcoml_Person"] = None, gedcoml_BekanntePerson10: "gedcoml_Person" = None, gedcoml_BekanntePerson13: "gedcoml_Person" = None, gedcoml_BekanntePerson31: "gedcoml_Author" = None, gedcoml_BekanntePerson16: set["gedcoml_Married"] = None, gedcoml_BekanntePerson18: set["gedcoml_Note"] = None, gedcoml_BekanntePerson20: set["gedcoml_Source"] = None, gedcoml_BekanntePerson33: "gedcoml_PersonRef" = None):
...
class gedcoml_Person(ABC):
    ...
    def __init__(self, id: str, sex: str, gedcoml_Person8: "gedcoml_BekanntePerson" = None, gedcoml_Person11: "gedcoml_BekanntePerson" = None, gedcoml_Person14: "gedcoml_BekanntePerson" = None, gedcoml_Person: "gedcoml_Family" = None, gedcoml_Person35: set["gedcoml_Address"] = None, gedcoml_Person28: "gedcoml_Married" = None):
        self.id = id
        self.sex = sex
...
class gedcoml_Family:
    ...
    def __init__(self, name: str, gedcoml_Family25: "gedcoml_FamilyImport" = None, gedcoml_Family: set["gedcoml_Person"] = None, gedcoml_Family5: set["gedcoml_FamilyImport"] = None):
        self.name = name
