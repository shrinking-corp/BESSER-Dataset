...
gedcoml_BekanntePerson.attributes={gedcoml_BekanntePerson_lastName, gedcoml_BekanntePerson_firstName, gedcoml_BekanntePerson_middleName, gedcoml_BekanntePerson_birthDay, gedcoml_BekanntePerson_deathDay, gedcoml_BekanntePerson_birthName}
...
domain_model = DomainModel(
    name="gedcoml",
    types={gedcoml_Projectdescription, gedcoml_FamilyImport, gedcoml_Married, gedcoml_Note, gedcoml_Source, gedcoml_FamilyBook, gedcoml_PostAddress, Address, gedcoml_Author, gedcoml_Family, gedcoml_Person, gedcoml_BekanntePerson, Person, gedcoml_Others, Source, gedcoml_PersonRef, gedcoml_UnbekanntePerson, gedcoml_Address, Sexus},
    associations={biologicalParentOf7, biologicalFatherIs9, biologicalMotherIs12, marriedWith15, notes17, sources19, project21, importedResource23, imports0, author1, members3, imports4, personID32, addresses34, partner26, memberId29},
