...
class FireworksDisplay:
    ...
    def __init__(self, NUM_FIREWORKS: int, FIREWORKS_SIZE: int, SET_DELAY: int, FIREWORKS_TIME: int, x: str, y: str, colors: str, xx: str, yy: str, num: int, numSets: int, startValue: int, timer: str, random: str):
...
class ChangeOptions:
    ...
    def __init__(self, ok: str, exited: bool, drawCount: int, drawOne: str, drawThree: str, timerCheck: str, timer: int, winAnimationCheck: str, animation: int, winSoundsCheck: str, sounds: int, difficulty: int, easy: str, medium: str, hard: str):
        self.ok = ok
        self.exited = exited
        self.drawCount = drawCount
