...
standard_StandardPopulationModel = Class(name="standard_StandardPopulationModel")
...
standard_StandardPopulationModelLabel = Class(name="standard_StandardPopulationModelLabel")
PopulationModelLabel = Class(name="PopulationModelLabel")
IntegrationLabel = Class(name="IntegrationLabel")
standard_StandardPopulationModelLabelValue = Class(name="standard_StandardPopulationModelLabelValue")
...
standard_PopulationModelLabelValue = Class(name="standard_PopulationModelLabelValue")
...
standard_StochasticStandardPopulationModel = Class(name="standard_StochasticStandardPopulationModel")
StandardPopulationModel = Class(name="StandardPopulationModel")
standard_PopulationModel = Class(name="standard_PopulationModel", is_abstract=True)
NodeDecorator = Class(name="NodeDecorator")
standard_StandardPopulationInitializer = Class(name="standard_StandardPopulationInitializer")
PopulationInitializer = Class(name="PopulationInitializer")
standard_SeasonalPopulationModel = Class(name="standard_SeasonalPopulationModel")
standard_EarthSciencePopulationInitializer = Class(name="standard_EarthSciencePopulationInitializer", is_abstract=True)
standard_YetiPopulationInitializer = Class(name="standard_YetiPopulationInitializer")
EarthSciencePopulationInitializer = Class(name="EarthSciencePopulationInitializer")
standard_DemographicPopulationModel = Class(name="standard_DemographicPopulationModel")
standard_PopulationGroup = Class(name="standard_PopulationGroup")
standard_PopulationInitializer = Class(name="standard_PopulationInitializer", is_abstract=True)
...
standard_StandardPopulationModel.attributes={standard_StandardPopulationModel_timePeriod, standard_StandardPopulationModel_birthRate, standard_StandardPopulationModel_deathRate}
...
standard_StandardPopulationModelLabelValue_m_adjustDelta: Method = Method(name="adjustDelta", parameters={Parameter(name='standard_value', type=StringType)}, type=BooleanType)
standard_StandardPopulationModelLabelValue.attributes={standard_StandardPopulationModelLabelValue_count, standard_StandardPopulationModelLabelValue_deaths, standard_StandardPopulationModelLabelValue_incidence, standard_StandardPopulationModelLabelValue_births, standard_StandardPopulationModelLabelValue_density}
...
standard_PopulationModel.attributes={standard_PopulationModel_name, standard_PopulationModel_populationIdentifier, standard_PopulationModel_targetISOKey}
...
standard_SeasonalPopulationModel.attributes={standard_SeasonalPopulationModel_period, standard_SeasonalPopulationModel_useLatitude, standard_SeasonalPopulationModel_phase, standard_SeasonalPopulationModel_modulationAmplitude}
...
standard_PopulationGroup.attributes={standard_PopulationGroup_fraction, standard_PopulationGroup_identifier}
...
standard_PopulationInitializer.attributes={standard_PopulationInitializer_targetISOKey, standard_PopulationInitializer_populationIdentifier}
...
domain_model = DomainModel(
    name="standard",
    types={Modifiable, standard_StandardPopulationModel, PopulationModel, IntegrationDecorator, standard_PopulationModelLabel, DynamicNodeLabel, standard_PopulationLabel, standard_StandardPopulationModelLabel, PopulationModelLabel, IntegrationLabel, standard_StandardPopulationModelLabelValue, standard_IntegrationLabel, standard_IntegrationLabelValue, standard_IntegrationDecorator, standard_PopulationModelLabelValue, LabelValue, PopulationModelLabelValue, IntegrationLabelValue, standard_StochasticStandardPopulationModel, StandardPopulationModel, standard_PopulationModel, NodeDecorator, standard_StandardPopulationInitializer, PopulationInitializer, standard_SeasonalPopulationModel, standard_EarthSciencePopulationInitializer, standard_YetiPopulationInitializer, EarthSciencePopulationInitializer, standard_DemographicPopulationModel, standard_PopulationGroup, standard_PopulationInitializer},
    associations={populationLabel0, deltaValue1, probeValue2, tempValue5, originalValue8, errorScale11, populationGroups14},
    generalizations={gen_standard_PopulationModel_Modifiable, gen_standard_StandardPopulationModel_PopulationModel, gen_standard_StandardPopulationModel_IntegrationDecorator, gen_standard_PopulationModelLabel_DynamicNodeLabel, gen_standard_StandardPopulationModelLabel_PopulationModelLabel, gen_standard_StandardPopulationModelLabel_IntegrationLabel, gen_standard_PopulationModelLabelValue_LabelValue, gen_standard_StandardPopulationModelLabelValue_PopulationModelLabelValue, gen_standard_StandardPopulationModelLabelValue_IntegrationLabelValue, gen_standard_StochasticStandardPopulationModel_StandardPopulationModel, gen_standard_PopulationModel_NodeDecorator, gen_standard_StandardPopulationInitializer_PopulationInitializer, gen_standard_SeasonalPopulationModel_StandardPopulationModel, gen_standard_EarthSciencePopulationInitializer_PopulationInitializer, gen_standard_YetiPopulationInitializer_EarthSciencePopulationInitializer, gen_standard_DemographicPopulationModel_StandardPopulationModel, gen_standard_PopulationInitializer_NodeDecorator, gen_standard_PopulationInitializer_Modifiable},
    metadata=None
)
