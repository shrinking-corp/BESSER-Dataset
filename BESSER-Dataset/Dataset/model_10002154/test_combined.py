...
def test_hyp_minesadapter_is_not_abstract():
    assert not inspect.isabstract(MinesAdapter)


def test_hyp_minesadapter_constructor_exists():
    assert callable(MinesAdapter.__init__)


def test_hyp_minesadapter_constructor_args():
...
def test_hyp_board_has_statusbar():
...
def test_hyp_board_has_all_cells():
...
def test_hyp_board_has_DRAW_MINE():
...
def test_hyp_board_has_MARKED_MINE_CELL():
...
def test_hyp_board_has_COVER_FOR_CELL():
...
def test_hyp_board_has_DRAW_WRONG_MARK():
...
def test_hyp_board_has_EMPTY_CELL():
...
def test_hyp_board_has_COVERED_MINE_CELL():
...
def test_hyp_board_has_CELL_SIZE():
...
def test_hyp_board_has_MINE_CELL():
...
def test_hyp_board_has_timeBar():
...
def test_hyp_board_has_MARK_FOR_CELL():
...
def test_hyp_board_has_N_MINES():
...
def test_hyp_board_has_DRAW_MARK():
...
def test_hyp_board_has_mines_left():
...
def test_hyp_board_has_DRAW_COVER():
...
def test_hyp_board_has_NUM_IMAGES():
...
@given(instance=Board_strategy)
def test_hyp_board_N_ROWS_setter(instance):
...
@given(instance=Board_strategy)
def test_hyp_board_statusbar_setter(instance):
    original = instance.statusbar
    instance.statusbar = original
    assert instance.statusbar == original
...
@given(instance=Board_strategy)
def test_hyp_board_inGame_setter(instance):
...
@given(instance=Board_strategy)
def test_hyp_board_all_cells_setter(instance):
...
@given(instance=Board_strategy)
def test_hyp_board_DRAW_MINE_setter(instance):
...
@given(instance=Board_strategy)
def test_hyp_board_MARKED_MINE_CELL_setter(instance):
...
@given(instance=Board_strategy)
def test_hyp_board_COVER_FOR_CELL_setter(instance):
...
@given(instance=Board_strategy)
def test_hyp_board_DRAW_WRONG_MARK_setter(instance):
...
@given(instance=Board_strategy)
def test_hyp_board_EMPTY_CELL_setter(instance):
...
@given(instance=Board_strategy)
def test_hyp_board_COVERED_MINE_CELL_setter(instance):
...
@given(instance=Board_strategy)
def test_hyp_board_field_setter(instance):
...
@given(instance=Board_strategy)
def test_hyp_board_CELL_SIZE_setter(instance):
...
@given(instance=Board_strategy)
def test_hyp_board_img_setter(instance):
...
@given(instance=Board_strategy)
def test_hyp_board_MINE_CELL_setter(instance):
...
@given(instance=Board_strategy)
def test_hyp_board_timeBar_setter(instance):
    original = instance.timeBar
    instance.timeBar = original
    assert instance.timeBar == original
...
@given(instance=Board_strategy)
def test_hyp_board_MARK_FOR_CELL_setter(instance):
...
@given(instance=Board_strategy)
def test_hyp_board_N_MINES_setter(instance):
...
@given(instance=Board_strategy)
def test_hyp_board_DRAW_MARK_setter(instance):
...
@given(instance=Board_strategy)
def test_hyp_board_mines_left_setter(instance):
...
@given(instance=Board_strategy)
def test_hyp_board_DRAW_COVER_setter(instance):
...
@given(instance=Board_strategy)
def test_hyp_board_NUM_IMAGES_setter(instance):
...
@given(instance=Board_strategy)
def test_hyp_board_N_COLS_setter(instance):
...
MinesAdapter_strategy = st.builds(MinesAdapter)
