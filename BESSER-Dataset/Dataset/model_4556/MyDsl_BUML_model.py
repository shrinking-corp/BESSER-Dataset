...
myDsl_CMD = Class(name="myDsl_CMD")
myDsl_PAPER = Class(name="myDsl_PAPER")
CMD = Class(name="CMD")
myDsl_TURTLE = Class(name="myDsl_TURTLE")
myDsl_PENSTATE = Class(name="myDsl_PENSTATE")
myDsl_PENCOLOUR = Class(name="myDsl_PENCOLOUR")
myDsl_MOVE = Class(name="myDsl_MOVE")
myDsl_RIGHT = Class(name="myDsl_RIGHT")
myDsl_LEFT = Class(name="myDsl_LEFT")
...
myDsl_PAPER.attributes={myDsl_PAPER_sizeX, myDsl_PAPER_paperColour, myDsl_PAPER_sizeY}
...
myDsl_TURTLE.attributes={myDsl_TURTLE_startPosY, myDsl_TURTLE_startPosX}
