...
# Classes
scholar_Student = Class(name="scholar_Student")
Named = Class(name="Named")
scholar_Exam = Class(name="scholar_Exam")
scholar_Lecture = Class(name="scholar_Lecture")
scholar_Teacher = Class(name="scholar_Teacher")
scholar_Discipline = Class(name="scholar_Discipline")
scholar_Named = Class(name="scholar_Named", is_abstract=True)
scholar_ScholarManagement = Class(name="scholar_ScholarManagement")
...
domain_model = DomainModel(
    name="scholar",
    types={scholar_Student, Named, scholar_Exam, scholar_Lecture, scholar_Teacher, scholar_Discipline, scholar_Named, scholar_ScholarManagement},
    associations={lecture4, exams0, lecture_teacher1, discipline2, students7, disciplines9, lectures12, teachers15},
    generalizations={gen_scholar_Exam_Named, gen_scholar_Discipline_Named, gen_scholar_Student_Named, gen_scholar_Lecture_Named, gen_scholar_Teacher_Named},
    metadata=None
)
