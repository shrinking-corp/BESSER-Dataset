...
def test_fsm_variable_has_value():
    assert hasattr(fsm_Variable, "value")
    descriptor = None
...
def test_fsm_action_has_value():
    assert hasattr(fsm_Action, "value")
    descriptor = None
...
def test_fsm_action_has_variable():
    assert hasattr(fsm_Action, "variable")
    descriptor = None
    for klass in fsm_Action.__mro__:
...
def test_fsm_guard_has_expression():
    assert hasattr(fsm_Guard, "expression")
    descriptor = None
...
def test_fsm_choice_is_not_abstract():
    assert not inspect.isabstract(fsm_Choice)


def test_fsm_choice_constructor_exists():
    assert callable(fsm_Choice.__init__)


def test_fsm_choice_constructor_args():
...
@given(instance=fsm_Variable_strategy)
def test_fsm_variable_value_setter(instance):
...
@given(instance=fsm_Action_strategy)
def test_fsm_action_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
@given(instance=fsm_Action_strategy)
def test_fsm_action_variable_setter(instance):
...
@given(instance=fsm_Guard_strategy)
def test_fsm_guard_expression_setter(instance):
    original = instance.expression
    instance.expression = original
    assert instance.expression == original
