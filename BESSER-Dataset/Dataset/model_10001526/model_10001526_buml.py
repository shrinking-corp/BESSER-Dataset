...
Customer.attributes={Customer_phoneno, Customer_mailid, Customer_id, Customer_address, Customer_name}
...
Order.attributes={Order_item, Order_quantity, Order_list}
...
Product.attributes={Product_type, Product_name, Product_id}
