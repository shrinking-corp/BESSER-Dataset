...
studyprogram_Course.attributes={studyprogram_Course_credits, studyprogram_Course_semester, studyprogram_Course_name, studyprogram_Course_code}
...
domain_model = DomainModel(
    name="studyprogram",
    types={studyprogram_Course, studyprogram_Program, studyprogram_StudyPlan, studyprogram_ElectiveCourses, studyprogram_ObligatoryCourses, studyprogram_Year, studyprogram_University, studyprogram_Department, studyprogram_Semester, studyprogram_SemesterCourse, SemesterType, CourseType},
    associations={school1, courses2, programs3, department5, studyPlans7, electiveCourses8, obligatoryCourses10, years12, departments0, course30, department31, program33, courses35, program37, courses39, program13, studyPlan16, specialisations19, semesters22, studyPlan23, year25, semesterCourses27, semester28},
    generalizations={},
    metadata=None
)
