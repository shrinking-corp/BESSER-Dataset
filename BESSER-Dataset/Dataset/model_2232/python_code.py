...
class studyprogram_SemesterCourse:
    ...
    def __init__(self, type: str, name: str, studyprogram_SemesterCourse: "studyprogram_Course" = None, SemesterCourse: "studyprogram_Semester" = None, semesterCourses: "studyprogram_Semester" = None):
        self.type = type
        self.name = name
...
class studyprogram_Department:
    ...
    def __init__(self, name: str, departments: "studyprogram_University" = None, department: set["studyprogram_Course"] = None, department4: set["studyprogram_Program"] = None, Department6: "studyprogram_Program" = None, Department: "studyprogram_University" = None, Department32: "studyprogram_Course" = None):
        self.name = name
...
class studyprogram_Program:
    ...
    def __init__(self, name: str, programs: "studyprogram_Department" = None, program: set["studyprogram_StudyPlan"] = None, program9: "studyprogram_ElectiveCourses" = None, program11: "studyprogram_ObligatoryCourses" = None, Program: "studyprogram_Department" = None, Program34: "studyprogram_ElectiveCourses" = None, Program38: "studyprogram_ObligatoryCourses" = None, Program14: "studyprogram_StudyPlan" = None):
        self.name = name
