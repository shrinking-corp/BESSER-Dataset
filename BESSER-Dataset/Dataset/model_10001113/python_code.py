...
class Customer:
    ...
    def __init__(self, numFemale: int, numMale: int, type: CustomerType, has15: "Table" = None):
    ...
    @property
    def numMale(self):
        return self.__numMale
    @numMale.setter
    def numMale(self, numMale: int):
        self.__numMale = numMale

    @property
    def numFemale(self):
        return self.__numFemale
    @numFemale.setter
    def numFemale(self, numFemale: int):
        self.__numFemale = numFemale
    ...
    def has15(self, value):
        ...
        old_value = getattr(self, f"_Customer__has15", None)
        self.__has15 = value
...
class Food:
    ...
    def __init__(self, price: str, type: int, prepared: bool, food_Id: str, name: str, description: str, served: bool, is_ordered_by1: set["Order"] = None):
        self.price = price
        self.type = type
...
class Table:
    ...
    def __init__(self, table_Id: str, numSeats: int, occupied: bool, specialRequest: str, order: str, customerDetail: Customer, accesses13: "Staff" = None, customer14: "Customer" = None, has3: "Order" = None, reserved4: "Booking" = None):
    ...
    def customerDetail(self):
        return self.__customerDetail
    @customerDetail.setter
    def customerDetail(self, customerDetail: Customer):
        self.__customerDetail = customerDetail
    ...
    def customer14(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Table__customer14", None)
        self.__customer14 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "has15"):
                opp_val = getattr(old_value, "has15", None)
                if opp_val == self:
                    setattr(old_value, "has15", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "has15"):
                opp_val = getattr(value, "has15", None)
                setattr(value, "has15", self)

    @property
    def accesses13(self):
        return self.__accesses13
    @accesses13.setter
    def accesses13(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Table__accesses13", None)
        self.__accesses13 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "is_accesses_by12"):
                opp_val = getattr(old_value, "is_accesses_by12", None)
                if opp_val == self:
                    setattr(old_value, "is_accesses_by12", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "is_accesses_by12"):
                opp_val = getattr(value, "is_accesses_by12", None)
                setattr(value, "is_accesses_by12", self)
...
class Staff:
    ...
    def __init__(self, staff_Id: str, name: str, jobType: int, contact: str, is_accesses_by12: "Table" = None, Staff_RMS_08: "RMS" = None):
        self.staff_Id = staff_Id
        self.name = name
        self.jobType = jobType
        self.contact = contact
        self.is_accesses_by12 = is_accesses_by12
    ...
    @property
    def is_accesses_by12(self):
        return self.__is_accesses_by12
    @is_accesses_by12.setter
    def is_accesses_by12(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Staff__is_accesses_by12", None)
        self.__is_accesses_by12 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "accesses13"):
                opp_val = getattr(old_value, "accesses13", None)
                if opp_val == self:
                    setattr(old_value, "accesses13", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "accesses13"):
                opp_val = getattr(value, "accesses13", None)
                setattr(value, "accesses13", self)
...
class Chef:
    ...
    def __init__(self, kitchenStation: Kitchen):
        self.kitchenStation = kitchenStation
        
        pass
    @property
    def kitchenStation(self):
        return self.__kitchenStation
    @kitchenStation.setter
    def kitchenStation(self, kitchenStation: Kitchen):
        self.__kitchenStation = kitchenStation
