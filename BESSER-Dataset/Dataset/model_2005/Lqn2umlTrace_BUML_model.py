...
# Classes
Lqn2umlTrace_Trace = Class(name="Lqn2umlTrace_Trace")
Lqn2umlTrace_TraceLink = Class(name="Lqn2umlTrace_TraceLink")
...
Lqn2umlTrace_TraceLink.attributes={Lqn2umlTrace_TraceLink_sources, Lqn2umlTrace_TraceLink_targets, Lqn2umlTrace_TraceLink_description}
