...
class fsm_State(NamedElement):
    ...
    def __init__(self, isFinal: bool, fsm_State3: "fsm_StateMachine" = None, State: "fsm_Transition" = None, fsm_State6: "fsm_Transition" = None, fsm_State: "fsm_StateMachine" = None, source: set["fsm_Transition"] = None):
