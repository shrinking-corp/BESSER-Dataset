...
domain_model = DomainModel(
    name="fsm",
    types={fsm_Transition, fsm_NamedElement, fsm_StateMachine, NamedElement, fsm_State, fsm_FSMModel},
    associations={initial1, source4, target5, states0, transitions7, stateMachines8},
    generalizations={gen_fsm_State_NamedElement, gen_fsm_StateMachine_NamedElement, gen_fsm_FSMModel_NamedElement},
    metadata=None
)
