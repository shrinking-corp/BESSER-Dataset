...
def test_hyp_dsl_greeting_is_not_abstract():
    assert not inspect.isabstract(dsl_Greeting)


def test_hyp_dsl_greeting_constructor_exists():
    assert callable(dsl_Greeting.__init__)


def test_hyp_dsl_greeting_constructor_args():
...
def test_hyp_dsl_greeting_name_setter(instance):
