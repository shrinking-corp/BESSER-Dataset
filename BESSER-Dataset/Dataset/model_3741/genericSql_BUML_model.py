...
# Classes
genericsql_DataBase = Class(name="genericsql_DataBase")
NamedElement = Class(name="NamedElement")
genericsql_Table = Class(name="genericsql_Table")
genericsql_NamedElement = Class(name="genericsql_NamedElement", is_abstract=True)
genericsql_Check = Class(name="genericsql_Check")
Constraint = Class(name="Constraint")
genericsql_PrimaryKey = Class(name="genericsql_PrimaryKey")
genericsql_ForeignKey = Class(name="genericsql_ForeignKey")
genericsql_Field = Class(name="genericsql_Field")
genericsql_Constraint = Class(name="genericsql_Constraint", is_abstract=True)
genericsql_Unique = Class(name="genericsql_Unique")
...
genericsql_NamedElement.attributes={genericsql_NamedElement_name, genericsql_NamedElement_comment}
...
genericsql_Field.attributes={genericsql_Field_defaultValue, genericsql_Field_type, genericsql_Field_size, genericsql_Field_autoIcrement, genericsql_Field_unique, genericsql_Field_specificType, genericsql_Field_notNull}
...
domain_model = DomainModel(
    name="genericsql",
    types={genericsql_DataBase, NamedElement, genericsql_Table, genericsql_NamedElement, genericsql_Check, Constraint, genericsql_PrimaryKey, genericsql_ForeignKey, genericsql_Field, genericsql_Constraint, genericsql_Unique, Type},
    associations={tables0, table18, primaryKey1, foreignKeys2, fields4, constraints6, database7, primaryFields8, table9, foreignFields11, table13, refersTo15, constrainedFields20},
    generalizations={gen_genericsql_DataBase_NamedElement, gen_genericsql_Field_NamedElement, gen_genericsql_Check_Constraint, gen_genericsql_Table_NamedElement, gen_genericsql_PrimaryKey_NamedElement, gen_genericsql_ForeignKey_NamedElement, gen_genericsql_Unique_Constraint},
    metadata=None
)
