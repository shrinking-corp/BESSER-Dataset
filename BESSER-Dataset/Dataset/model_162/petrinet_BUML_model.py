...
petrinet_Box = Class(name="petrinet_Box")
...
petrinet_Transition.attributes={petrinet_Transition_id, petrinet_Transition_name}
...
domain_model = DomainModel(
    ...
    associations={place6, transition8, box11, place14, transition0, box1, place3},
    generalizations={},
    metadata=None
)
