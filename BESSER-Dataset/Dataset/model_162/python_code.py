...
class petrinet_Transition:
    ...
    def __init__(self, id: int, name: str, petrinet_Transition10: "petrinet_Net" = None, petrinet_Transition: "petrinet_Place" = None, petrinet_Transition2: set["petrinet_Box"] = None, petrinet_Transition4: set["petrinet_Place"] = None):
        self.id = id
        self.name = name
...
class petrinet_Place:
    ...
    def __init__(self, id: int, name: str, petrinet_Place7: "petrinet_Net" = None, petrinet_Place16: "petrinet_Box" = None, petrinet_Place: set["petrinet_Transition"] = None, petrinet_Place5: "petrinet_Transition" = None):
        self.id = id
        self.name = name
