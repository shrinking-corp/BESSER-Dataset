...
domain_model = DomainModel(
    name="Families",
    types={Families_Family, uncertainty_ModelElement, uncertainty_aFamily, Families_uncertainty_uFamily, uncertainty_UData, aMember, aFamily, Families_Member, uncertainty_aMember, Families_FamilyRegistry, uncertainty_aFamilyRegistry, Families_uncertainty_ModelElement, ModelElement, Families_uncertainty_UData, uFamily, Families_uncertainty_aFamily, Families_uncertainty_uMember, uMember, Families_uncertainty_aMember, Families_uncertainty_uFamilyRegistry, aFamilyRegistry, uFamilyRegistry, Families_uncertainty_aFamilyRegistry, OperatorType},
    associations={uleft20, uright22, sons0, daughters1, mother4, father7, links10, relatives12, families14, include16, exclude17, upoint25, uleft27, uright29, upoint32, uleft34, uright35, upoint38},
    generalizations={gen_Families_Family_uncertainty_ModelElement, gen_Families_Family_uncertainty_aFamily, gen_Families_uncertainty_uFamily_uncertainty_aFamily, gen_Families_uncertainty_uFamily_uncertainty_UData, gen_Families_Member_uncertainty_ModelElement, gen_Families_Member_uncertainty_aMember, gen_Families_FamilyRegistry_uncertainty_ModelElement, gen_Families_FamilyRegistry_uncertainty_aFamilyRegistry, gen_Families_uncertainty_uMember_uncertainty_aMember, gen_Families_uncertainty_uMember_uncertainty_UData, gen_Families_uncertainty_uFamilyRegistry_uncertainty_aFamilyRegistry, gen_Families_uncertainty_uFamilyRegistry_uncertainty_UData},
    metadata=None
)
