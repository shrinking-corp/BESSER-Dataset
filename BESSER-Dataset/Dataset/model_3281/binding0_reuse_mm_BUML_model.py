...
sm_Node = Class(name="sm_Node")
sm_Edge = Class(name="sm_Edge")
sm_Mark = Class(name="sm_Mark")
sm_Observation = Class(name="sm_Observation")
Mark = Class(name="Mark")
sm_Graph = Class(name="sm_Graph")
...
domain_model = DomainModel(
    name="sm",
    types={sm_State, Node, sm_Transition, Edge, sm_StateMachine, Graph, sm_Node, sm_Edge, sm_Mark, sm_Observation, Mark, sm_Graph},
    associations={initial0, final1, subMachines4, nodes7, edges8, marks10, mark12, graph14, source15, target16, graph19, node21, graph23},
    generalizations={gen_sm_State_Node, gen_sm_Transition_Edge, gen_sm_StateMachine_Graph, gen_sm_Observation_Mark},
    metadata=None
)
