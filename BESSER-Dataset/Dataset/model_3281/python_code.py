...
class sm_Graph:
    ...
    def __init__(self, name: str, graph: set["sm_Node"] = None, graph9: set["sm_Edge"] = None, graph11: set["sm_Mark"] = None, Graph: "sm_Node" = None, Graph20: "sm_Edge" = None, Graph24: "sm_Mark" = None):
        self.name = name
...
class sm_Node:
    ...
    def __init__(self, name: str, Node: "sm_Graph" = None, node: "sm_Mark" = None, nodes: "sm_Graph" = None, sm_Node: "sm_Edge" = None, sm_Node18: "sm_Edge" = None, Node22: "sm_Mark" = None):
        self.name = name
        self.Node = Node
        self.node = node
        self.nodes = nodes
