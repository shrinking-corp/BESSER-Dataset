...
class library_Book:
    ...
    def __init__(self, title: str, library_Book8: "library_Library" = None, library_Book: "library_Author" = None, library_Book2: "library_Author" = None):
        self.title = title
...
class library_Author:
    ...
    def __init__(self, surname: str, name: str, library_Author5: "library_Library" = None, library_Author: "library_Book" = None, library_Author3: "library_Book" = None):
