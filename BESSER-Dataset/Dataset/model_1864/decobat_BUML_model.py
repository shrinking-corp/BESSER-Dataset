...
# Classes
decobat_ProjectRevision = Class(name="decobat_ProjectRevision")
decobat_Project = Class(name="decobat_Project")
decobat_ProjectCategory = Class(name="decobat_ProjectCategory")
decobat_Plan = Class(name="decobat_Plan")
decobat_Customer = Class(name="decobat_Customer")
decobat_Library = Class(name="decobat_Library")
decobat_LibraryCategory = Class(name="decobat_LibraryCategory")
decobat_Product = Class(name="decobat_Product")
decobat_Supplier = Class(name="decobat_Supplier")
decobat_Service = Class(name="decobat_Service")
decobat_Level = Class(name="decobat_Level")
decobat_Object = Class(name="decobat_Object")
...
decobat_ProjectRevision.attributes={decobat_ProjectRevision_update, decobat_ProjectRevision_shortDescription, decobat_ProjectRevision_comment, decobat_ProjectRevision_description}
...
decobat_Project.attributes={decobat_Project_closed, decobat_Project_description, decobat_Project_created, decobat_Project_name, decobat_Project_shortDescription}
...
decobat_ProjectCategory.attributes={decobat_ProjectCategory_name, decobat_ProjectCategory_created, decobat_ProjectCategory_description, decobat_ProjectCategory_shortDescription}
...
decobat_Plan.attributes={decobat_Plan_name, decobat_Plan_code, decobat_Plan_shortDescription, decobat_Plan_description}
...
decobat_Customer.attributes={decobat_Customer_city, decobat_Customer_zip, decobat_Customer_code, decobat_Customer_fax, decobat_Customer_address, decobat_Customer_name, decobat_Customer_phone, decobat_Customer_email, decobat_Customer_country}
...
decobat_Library.attributes={decobat_Library_description, decobat_Library_shortDescription, decobat_Library_width, decobat_Library_update, decobat_Library_name, decobat_Library_height, decobat_Library_created, decobat_Library_depth}
...
decobat_LibraryCategory.attributes={decobat_LibraryCategory_shortDescription, decobat_LibraryCategory_description, decobat_LibraryCategory_name, decobat_LibraryCategory_created}
...
decobat_Product.attributes={decobat_Product_name, decobat_Product_unitWeight, decobat_Product_depth, decobat_Product_created, decobat_Product_width, decobat_Product_description, decobat_Product_shortDescription, decobat_Product_height, decobat_Product_unitBilledPrice, decobat_Product_unitCostPrice, decobat_Product_update}
...
decobat_Supplier.attributes={decobat_Supplier_email, decobat_Supplier_name, decobat_Supplier_country, decobat_Supplier_zip, decobat_Supplier_city, decobat_Supplier_code, decobat_Supplier_fax, decobat_Supplier_phone, decobat_Supplier_address}
...
decobat_Service.attributes={decobat_Service_description, decobat_Service_name, decobat_Service_shortDescription, decobat_Service_hourlyCostPrice, decobat_Service_code, decobat_Service_hourlyBilledPrice}
...
decobat_Level.attributes={decobat_Level_code, decobat_Level_description, decobat_Level_name, decobat_Level_shortDescription}
...
decobat_Object.attributes={decobat_Object_name, decobat_Object_code, decobat_Object_description, decobat_Object_shortDescription}
...
domain_model = DomainModel(
    name="decobat",
    types={decobat_ProjectRevision, decobat_Project, decobat_ProjectCategory, decobat_Plan, decobat_Customer, decobat_Library, decobat_LibraryCategory, decobat_Product, decobat_Supplier, decobat_Service, decobat_Level, decobat_Object},
    associations={projectRevisions0, projectCategories1, plans3, customer5, categories7, libraryItems14, supplier8, levels9, libraryItems11},
    generalizations={},
    metadata=None
)
