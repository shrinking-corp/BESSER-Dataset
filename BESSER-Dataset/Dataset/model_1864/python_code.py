...
class decobat_Object:
    ...
    def __init__(self, shortDescription: str, description: str, code: str, name: str, decobat_Object: set["decobat_Library"] = None):
...
class decobat_Product:
    ...
    def __init__(self, description: str, created: date, update: date, unitCostPrice: str, unitBilledPrice: str, unitWeight: str, name: str, shortDescription: str, height: str, width: str, depth: str, decobat_Product: "decobat_Supplier" = None):
        self.description = description
