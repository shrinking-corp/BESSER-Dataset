...
class myAtl_Module:
    ...
    def __init__(self, name: str, myAtl_Module: set["myAtl_NameExpCS"] = None, myAtl_Module2: set["myAtl_NameExpCS"] = None, myAtl_Module5: "myAtl_NameExpCS" = None, myAtl_Module8: set["myAtl_ModuleElement"] = None):
        self.name = name
...
class myAtl_BindingStat(Statement):
    ...
    def __init__(self, propertyName: str, myAtl_BindingStat69: "myAtl_ExpCS" = None, myAtl_BindingStat: "myAtl_ExpCS" = None):
...
class myAtl_SimpleOutPatternElement(OutPatternElement):
    ...
    def __init__(self, varName: str, myAtl_SimpleOutPatternElement: "myAtl_ATLType" = None, myAtl_SimpleOutPatternElement58: set["myAtl_Binding"] = None):
...
class myAtl_InPatternElement:
    ...
    def __init__(self, varName: str, myAtl_InPatternElement: "myAtl_InPattern" = None, myAtl_InPatternElement51: "myAtl_ATLType" = None):
        self.varName = varName
...
class myAtl_ATLDefCS:
    ...
    def __init__(self, varName: str, myAtl_ATLDefCS: "myAtl_Helper" = None, myAtl_ATLDefCS29: set["myAtl_ATLParameterCS"] = None, myAtl_ATLDefCS32: "myAtl_ATLType" = None, myAtl_ATLDefCS34: "myAtl_ExpCS" = None):
        self.varName = varName
...
class myAtl_RuleVariableDeclaration:
    ...
    def __init__(self, varName: str, myAtl_RuleVariableDeclaration: "myAtl_MatchedRule" = None, myAtl_RuleVariableDeclaration17: "myAtl_CalledRule" = None, myAtl_RuleVariableDeclaration40: "myAtl_ATLType" = None, myAtl_RuleVariableDeclaration43: "myAtl_ExpCS" = None):
        self.varName = varName
