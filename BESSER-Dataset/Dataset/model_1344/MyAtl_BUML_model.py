...
# Classes
myAtl_Module = Class(name="myAtl_Module")
myAtl_NameExpCS = Class(name="myAtl_NameExpCS")
myAtl_ModuleElement = Class(name="myAtl_ModuleElement")
myAtl_MatchedRule = Class(name="myAtl_MatchedRule")
ModuleElement = Class(name="ModuleElement")
myAtl_InPattern = Class(name="myAtl_InPattern")
myAtl_RuleVariableDeclaration = Class(name="myAtl_RuleVariableDeclaration")
myAtl_OutPattern = Class(name="myAtl_OutPattern")
myAtl_ActionBlock = Class(name="myAtl_ActionBlock")
myAtl_CalledRule = Class(name="myAtl_CalledRule")
myAtl_QueryRule = Class(name="myAtl_QueryRule")
myAtl_ATLParameterCS = Class(name="myAtl_ATLParameterCS")
myAtl_ExpCS = Class(name="myAtl_ExpCS")
myAtl_Helper = Class(name="myAtl_Helper")
myAtl_ATLDefCS = Class(name="myAtl_ATLDefCS")
myAtl_ATLType = Class(name="myAtl_ATLType")
myAtl_InPatternElement = Class(name="myAtl_InPatternElement")
myAtl_OutPatternElement = Class(name="myAtl_OutPatternElement")
myAtl_SimpleOutPatternElement = Class(name="myAtl_SimpleOutPatternElement")
OutPatternElement = Class(name="OutPatternElement")
myAtl_Binding = Class(name="myAtl_Binding")
myAtl_ForEachOutPatternElement = Class(name="myAtl_ForEachOutPatternElement")
myAtl_Statement = Class(name="myAtl_Statement")
myAtl_BindingStat = Class(name="myAtl_BindingStat")
Statement = Class(name="Statement")
myAtl_TypeExpCS = Class(name="myAtl_TypeExpCS")
myAtl_CollectionTypeCS = Class(name="myAtl_CollectionTypeCS")
TypeLiteralCS = Class(name="TypeLiteralCS")
myAtl_TupleTypeCS = Class(name="myAtl_TupleTypeCS")
myAtl_tuplePartCS = Class(name="myAtl_tuplePartCS")
myAtl_PrimitiveLiteralExpCS = Class(name="myAtl_PrimitiveLiteralExpCS")
PrimaryExpCS = Class(name="PrimaryExpCS")
myAtl_TupleLiteralExpCS = Class(name="myAtl_TupleLiteralExpCS")
myAtl_TupleLiteralPartCS = Class(name="myAtl_TupleLiteralPartCS")
myAtl_NumberLiteralExpCS = Class(name="myAtl_NumberLiteralExpCS")
PrimitiveLiteralExpCS = Class(name="PrimitiveLiteralExpCS")
myAtl_StringLiteralExpCS = Class(name="myAtl_StringLiteralExpCS")
myAtl_BooleanLiteralExpCS = Class(name="myAtl_BooleanLiteralExpCS")
myAtl_UnlimitedNaturalLiteralExpCS = Class(name="myAtl_UnlimitedNaturalLiteralExpCS")
myAtl_InvalidLiteralExpCS = Class(name="myAtl_InvalidLiteralExpCS")
myAtl_NullLiteralExpCS = Class(name="myAtl_NullLiteralExpCS")
myAtl_PrimitiveTypeCS = Class(name="myAtl_PrimitiveTypeCS")
myAtl_TypeLiteralCS = Class(name="myAtl_TypeLiteralCS")
TypeExpCS = Class(name="TypeExpCS")
myAtl_TypeLiteralExpCS = Class(name="myAtl_TypeLiteralExpCS")
myAtl_TypeNameExpCS = Class(name="myAtl_TypeNameExpCS")
myAtl_NavigatingArgCS = Class(name="myAtl_NavigatingArgCS")
myAtl_NavigatingArgExpCS = Class(name="myAtl_NavigatingArgExpCS")
myAtl_NavigatingBarArgCS = Class(name="myAtl_NavigatingBarArgCS")
myAtl_NavigatingCommaArgCS = Class(name="myAtl_NavigatingCommaArgCS")
myAtl_NavigatingSemiArgCS = Class(name="myAtl_NavigatingSemiArgCS")
myAtl_IfExpCS = Class(name="myAtl_IfExpCS")
myAtl_LetExpCS = Class(name="myAtl_LetExpCS")
myAtl_LetVariableCS = Class(name="myAtl_LetVariableCS")
myAtl_NestedExpCS = Class(name="myAtl_NestedExpCS")
myAtl_SelfExpCS = Class(name="myAtl_SelfExpCS")
myAtl_PrimaryExpCS = Class(name="myAtl_PrimaryExpCS")
PrefixedExpCS = Class(name="PrefixedExpCS")
myAtl_StringExpCs = Class(name="myAtl_StringExpCs")
IndexExpCS = Class(name="IndexExpCS")
NavigatingArgExpCS = Class(name="NavigatingArgExpCS")
myAtl_InfixedExpCS = Class(name="myAtl_InfixedExpCS")
ExpCS = Class(name="ExpCS")
myAtl_BinaryOperatorCS = Class(name="myAtl_BinaryOperatorCS")
myAtl_InfixOperatorCS = Class(name="myAtl_InfixOperatorCS")
BinaryOperatorCS = Class(name="BinaryOperatorCS")
myAtl_NavigationOperatorCS = Class(name="myAtl_NavigationOperatorCS")
myAtl_PrefixedExpCS = Class(name="myAtl_PrefixedExpCS")
InfixedExpCS = Class(name="InfixedExpCS")
myAtl_UnaryOperatorCS = Class(name="myAtl_UnaryOperatorCS")
myAtl_IndexExpCS = Class(name="myAtl_IndexExpCS")
NavigatingExpCS_Base = Class(name="NavigatingExpCS_Base")
myAtl_NavigatingExpCS_Base = Class(name="myAtl_NavigatingExpCS_Base")
NavigatingExpCS = Class(name="NavigatingExpCS")
myAtl_NavigatingExpCS = Class(name="myAtl_NavigatingExpCS")
myAtl_EObject = Class(name="myAtl_EObject")
myAtl_InfixExpCS = Class(name="myAtl_InfixExpCS")
myAtl_PrefixExpCS = Class(name="myAtl_PrefixExpCS")
...
in_127: BinaryAssociation = BinaryAssociation(
    name="in_127",
    ends={
...
domain_model = DomainModel(
    name="myAtl",
    types={myAtl_Module, myAtl_NameExpCS, myAtl_ModuleElement, myAtl_MatchedRule, ModuleElement, myAtl_InPattern, myAtl_RuleVariableDeclaration, myAtl_OutPattern, myAtl_ActionBlock, myAtl_CalledRule, myAtl_QueryRule, myAtl_ATLParameterCS, myAtl_ExpCS, myAtl_Helper, myAtl_ATLDefCS, myAtl_ATLType, myAtl_InPatternElement, myAtl_OutPatternElement, myAtl_SimpleOutPatternElement, OutPatternElement, myAtl_Binding, myAtl_ForEachOutPatternElement, myAtl_Statement, myAtl_BindingStat, Statement, myAtl_TypeExpCS, myAtl_CollectionTypeCS, TypeLiteralCS, myAtl_TupleTypeCS, myAtl_tuplePartCS, myAtl_PrimitiveLiteralExpCS, PrimaryExpCS, myAtl_TupleLiteralExpCS, myAtl_TupleLiteralPartCS, myAtl_NumberLiteralExpCS, PrimitiveLiteralExpCS, myAtl_StringLiteralExpCS, myAtl_BooleanLiteralExpCS, myAtl_UnlimitedNaturalLiteralExpCS, myAtl_InvalidLiteralExpCS, myAtl_NullLiteralExpCS, myAtl_PrimitiveTypeCS, myAtl_TypeLiteralCS, TypeExpCS, myAtl_TypeLiteralExpCS, myAtl_TypeNameExpCS, myAtl_NavigatingArgCS, myAtl_NavigatingArgExpCS, myAtl_NavigatingBarArgCS, myAtl_NavigatingCommaArgCS, myAtl_NavigatingSemiArgCS, myAtl_IfExpCS, myAtl_LetExpCS, myAtl_LetVariableCS, myAtl_NestedExpCS, myAtl_SelfExpCS, myAtl_PrimaryExpCS, PrefixedExpCS, myAtl_StringExpCs, IndexExpCS, NavigatingArgExpCS, myAtl_InfixedExpCS, ExpCS, myAtl_BinaryOperatorCS, myAtl_InfixOperatorCS, BinaryOperatorCS, myAtl_NavigationOperatorCS, myAtl_PrefixedExpCS, InfixedExpCS, myAtl_UnaryOperatorCS, myAtl_IndexExpCS, NavigatingExpCS_Base, myAtl_NavigatingExpCS_Base, NavigatingExpCS, myAtl_NavigatingExpCS, myAtl_EObject, myAtl_InfixExpCS, myAtl_PrefixExpCS},
    associations={outModels0, inModels1, varName4, elements7, inPattern9, variables10, outPattern12, actionBlock14, variables16, outPattern18, actionBlock21, parameters24, initExpression25, definition27, parameters28, type31, type36, type39, initExpression42, elements45, filter47, type50, elements53, type55, bindings57, collection59, value61, statements64, source66, value68, type71, initExpression33, ownedType73, ownedParts75, ownedType76, ownedParts79, ownedType80, initExpression83, ownedType86, name87, ownedType88, init91, name94, ownedType96, init99, name102, ownedType104, init107, name110, ownedType112, init115, condition118, thenExpression120, elseExpression123, variable126, in_127, ownedType130, initExpression133, source136, firstIndexes138, secondIndexes140, namedExp143, argument144, ownedExpression146, ownedOperator147, ownedOperator149, ownedExpression150},
    generalizations={gen_myAtl_MatchedRule_ModuleElement, gen_myAtl_CalledRule_ModuleElement, gen_myAtl_QueryRule_ModuleElement, gen_myAtl_Helper_ModuleElement, gen_myAtl_SimpleOutPatternElement_OutPatternElement, gen_myAtl_ForEachOutPatternElement_OutPatternElement, gen_myAtl_BindingStat_Statement, gen_myAtl_CollectionTypeCS_TypeLiteralCS, gen_myAtl_TupleTypeCS_TypeLiteralCS, gen_myAtl_PrimitiveLiteralExpCS_PrimaryExpCS, gen_myAtl_TupleLiteralExpCS_PrimaryExpCS, gen_myAtl_NumberLiteralExpCS_PrimitiveLiteralExpCS, gen_myAtl_StringLiteralExpCS_PrimitiveLiteralExpCS, gen_myAtl_BooleanLiteralExpCS_PrimitiveLiteralExpCS, gen_myAtl_UnlimitedNaturalLiteralExpCS_PrimitiveLiteralExpCS, gen_myAtl_InvalidLiteralExpCS_PrimitiveLiteralExpCS, gen_myAtl_NullLiteralExpCS_PrimitiveLiteralExpCS, gen_myAtl_PrimitiveTypeCS_TypeLiteralCS, gen_myAtl_TypeLiteralCS_TypeExpCS, gen_myAtl_TypeNameExpCS_TypeExpCS, gen_myAtl_IfExpCS_PrimaryExpCS, gen_myAtl_LetExpCS_PrimaryExpCS, gen_myAtl_NestedExpCS_PrimaryExpCS, gen_myAtl_SelfExpCS_PrimaryExpCS, gen_myAtl_PrimaryExpCS_PrefixedExpCS, gen_myAtl_StringExpCs_PrimaryExpCS, gen_myAtl_NameExpCS_IndexExpCS, gen_myAtl_ExpCS_NavigatingArgExpCS, gen_myAtl_InfixedExpCS_ExpCS, gen_myAtl_InfixOperatorCS_BinaryOperatorCS, gen_myAtl_NavigationOperatorCS_BinaryOperatorCS, gen_myAtl_PrefixedExpCS_InfixedExpCS, gen_myAtl_IndexExpCS_NavigatingExpCS_Base, gen_myAtl_NavigatingExpCS_Base_NavigatingExpCS, gen_myAtl_NavigatingExpCS_PrimaryExpCS, gen_myAtl_InfixExpCS_InfixedExpCS, gen_myAtl_PrefixExpCS_PrefixedExpCS},
    metadata=None
)
