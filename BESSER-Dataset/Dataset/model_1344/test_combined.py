...
def test_hyp_myatl_eobject_is_not_abstract():
    assert not inspect.isabstract(myAtl_EObject)


def test_hyp_myatl_eobject_constructor_exists():
    assert callable(myAtl_EObject.__init__)


def test_hyp_myatl_eobject_constructor_args():
    sig = inspect.signature(myAtl_EObject.__init__)
    params = list(sig.parameters.keys())



def test_hyp_navigatingexpcs_is_not_abstract():
    assert not inspect.isabstract(NavigatingExpCS)


def test_hyp_navigatingexpcs_constructor_exists():
    assert callable(NavigatingExpCS.__init__)


def test_hyp_navigatingexpcs_constructor_args():
    sig = inspect.signature(NavigatingExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_navigatingexpcs_base_is_not_abstract():
    assert not inspect.isabstract(myAtl_NavigatingExpCS_Base)


def test_hyp_myatl_navigatingexpcs_base_constructor_exists():
    assert callable(myAtl_NavigatingExpCS_Base.__init__)


def test_hyp_myatl_navigatingexpcs_base_constructor_args():
    sig = inspect.signature(myAtl_NavigatingExpCS_Base.__init__)
    params = list(sig.parameters.keys())



def test_hyp_navigatingexpcs_base_is_not_abstract():
    assert not inspect.isabstract(NavigatingExpCS_Base)


def test_hyp_navigatingexpcs_base_constructor_exists():
    assert callable(NavigatingExpCS_Base.__init__)


def test_hyp_navigatingexpcs_base_constructor_args():
    sig = inspect.signature(NavigatingExpCS_Base.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_indexexpcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_IndexExpCS)


def test_hyp_myatl_indexexpcs_constructor_exists():
    assert callable(myAtl_IndexExpCS.__init__)


def test_hyp_myatl_indexexpcs_constructor_args():
    sig = inspect.signature(myAtl_IndexExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_unaryoperatorcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_UnaryOperatorCS)


def test_hyp_myatl_unaryoperatorcs_constructor_exists():
    assert callable(myAtl_UnaryOperatorCS.__init__)


def test_hyp_myatl_unaryoperatorcs_constructor_args():
...
def test_hyp_infixedexpcs_is_not_abstract():
    assert not inspect.isabstract(InfixedExpCS)


def test_hyp_infixedexpcs_constructor_exists():
    assert callable(InfixedExpCS.__init__)


def test_hyp_infixedexpcs_constructor_args():
    sig = inspect.signature(InfixedExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_infixexpcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_InfixExpCS)


def test_hyp_myatl_infixexpcs_constructor_exists():
    assert callable(myAtl_InfixExpCS.__init__)


def test_hyp_myatl_infixexpcs_constructor_args():
    sig = inspect.signature(myAtl_InfixExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_prefixedexpcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_PrefixedExpCS)


def test_hyp_myatl_prefixedexpcs_constructor_exists():
    assert callable(myAtl_PrefixedExpCS.__init__)


def test_hyp_myatl_prefixedexpcs_constructor_args():
...
def test_hyp_myatl_navigationoperatorcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_NavigationOperatorCS)


def test_hyp_myatl_navigationoperatorcs_constructor_exists():
    assert callable(myAtl_NavigationOperatorCS.__init__)


def test_hyp_myatl_navigationoperatorcs_constructor_args():
    sig = inspect.signature(myAtl_NavigationOperatorCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_infixoperatorcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_InfixOperatorCS)


def test_hyp_myatl_infixoperatorcs_constructor_exists():
    assert callable(myAtl_InfixOperatorCS.__init__)


def test_hyp_myatl_infixoperatorcs_constructor_args():
    sig = inspect.signature(myAtl_InfixOperatorCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_binaryoperatorcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_BinaryOperatorCS)


def test_hyp_myatl_binaryoperatorcs_constructor_exists():
    assert callable(myAtl_BinaryOperatorCS.__init__)


def test_hyp_myatl_binaryoperatorcs_constructor_args():
...
def test_hyp_myatl_infixedexpcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_InfixedExpCS)


def test_hyp_myatl_infixedexpcs_constructor_exists():
    assert callable(myAtl_InfixedExpCS.__init__)


def test_hyp_myatl_infixedexpcs_constructor_args():
    sig = inspect.signature(myAtl_InfixedExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_navigatingargexpcs_is_not_abstract():
    assert not inspect.isabstract(NavigatingArgExpCS)


def test_hyp_navigatingargexpcs_constructor_exists():
    assert callable(NavigatingArgExpCS.__init__)


def test_hyp_navigatingargexpcs_constructor_args():
    sig = inspect.signature(NavigatingArgExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_indexexpcs_is_not_abstract():
    assert not inspect.isabstract(IndexExpCS)


def test_hyp_indexexpcs_constructor_exists():
    assert callable(IndexExpCS.__init__)


def test_hyp_indexexpcs_constructor_args():
    sig = inspect.signature(IndexExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_prefixedexpcs_is_not_abstract():
    assert not inspect.isabstract(PrefixedExpCS)


def test_hyp_prefixedexpcs_constructor_exists():
    assert callable(PrefixedExpCS.__init__)


def test_hyp_prefixedexpcs_constructor_args():
    sig = inspect.signature(PrefixedExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_prefixexpcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_PrefixExpCS)


def test_hyp_myatl_prefixexpcs_constructor_exists():
    assert callable(myAtl_PrefixExpCS.__init__)


def test_hyp_myatl_prefixexpcs_constructor_args():
    sig = inspect.signature(myAtl_PrefixExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_primaryexpcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_PrimaryExpCS)


def test_hyp_myatl_primaryexpcs_constructor_exists():
    assert callable(myAtl_PrimaryExpCS.__init__)


def test_hyp_myatl_primaryexpcs_constructor_args():
    sig = inspect.signature(myAtl_PrimaryExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_letvariablecs_is_not_abstract():
    assert not inspect.isabstract(myAtl_LetVariableCS)


def test_hyp_myatl_letvariablecs_constructor_exists():
    assert callable(myAtl_LetVariableCS.__init__)


def test_hyp_myatl_letvariablecs_constructor_args():
...
def test_hyp_myatl_navigatingsemiargcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_NavigatingSemiArgCS)


def test_hyp_myatl_navigatingsemiargcs_constructor_exists():
    assert callable(myAtl_NavigatingSemiArgCS.__init__)


def test_hyp_myatl_navigatingsemiargcs_constructor_args():
...
def test_hyp_myatl_navigatingcommaargcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_NavigatingCommaArgCS)


def test_hyp_myatl_navigatingcommaargcs_constructor_exists():
    assert callable(myAtl_NavigatingCommaArgCS.__init__)


def test_hyp_myatl_navigatingcommaargcs_constructor_args():
...
def test_hyp_myatl_navigatingbarargcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_NavigatingBarArgCS)


def test_hyp_myatl_navigatingbarargcs_constructor_exists():
    assert callable(myAtl_NavigatingBarArgCS.__init__)


def test_hyp_myatl_navigatingbarargcs_constructor_args():
...
def test_hyp_myatl_navigatingargexpcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_NavigatingArgExpCS)


def test_hyp_myatl_navigatingargexpcs_constructor_exists():
    assert callable(myAtl_NavigatingArgExpCS.__init__)


def test_hyp_myatl_navigatingargexpcs_constructor_args():
    sig = inspect.signature(myAtl_NavigatingArgExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_navigatingargcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_NavigatingArgCS)


def test_hyp_myatl_navigatingargcs_constructor_exists():
    assert callable(myAtl_NavigatingArgCS.__init__)


def test_hyp_myatl_navigatingargcs_constructor_args():
    sig = inspect.signature(myAtl_NavigatingArgCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_typeliteralexpcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_TypeLiteralExpCS)


def test_hyp_myatl_typeliteralexpcs_constructor_exists():
    assert callable(myAtl_TypeLiteralExpCS.__init__)


def test_hyp_myatl_typeliteralexpcs_constructor_args():
    sig = inspect.signature(myAtl_TypeLiteralExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_typeexpcs_is_not_abstract():
    assert not inspect.isabstract(TypeExpCS)


def test_hyp_typeexpcs_constructor_exists():
    assert callable(TypeExpCS.__init__)


def test_hyp_typeexpcs_constructor_args():
    sig = inspect.signature(TypeExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_typenameexpcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_TypeNameExpCS)


def test_hyp_myatl_typenameexpcs_constructor_exists():
    assert callable(myAtl_TypeNameExpCS.__init__)


def test_hyp_myatl_typenameexpcs_constructor_args():
...
def test_hyp_myatl_typeliteralcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_TypeLiteralCS)


def test_hyp_myatl_typeliteralcs_constructor_exists():
    assert callable(myAtl_TypeLiteralCS.__init__)


def test_hyp_myatl_typeliteralcs_constructor_args():
...
def test_hyp_myatl_nullliteralexpcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_NullLiteralExpCS)


def test_hyp_myatl_nullliteralexpcs_constructor_exists():
    assert callable(myAtl_NullLiteralExpCS.__init__)


def test_hyp_myatl_nullliteralexpcs_constructor_args():
    sig = inspect.signature(myAtl_NullLiteralExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_stringliteralexpcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_StringLiteralExpCS)


def test_hyp_myatl_stringliteralexpcs_constructor_exists():
    assert callable(myAtl_StringLiteralExpCS.__init__)


def test_hyp_myatl_stringliteralexpcs_constructor_args():
...
def test_hyp_myatl_booleanliteralexpcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_BooleanLiteralExpCS)


def test_hyp_myatl_booleanliteralexpcs_constructor_exists():
    assert callable(myAtl_BooleanLiteralExpCS.__init__)


def test_hyp_myatl_booleanliteralexpcs_constructor_args():
...
def test_hyp_myatl_invalidliteralexpcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_InvalidLiteralExpCS)


def test_hyp_myatl_invalidliteralexpcs_constructor_exists():
    assert callable(myAtl_InvalidLiteralExpCS.__init__)


def test_hyp_myatl_invalidliteralexpcs_constructor_args():
    sig = inspect.signature(myAtl_InvalidLiteralExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_unlimitednaturalliteralexpcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_UnlimitedNaturalLiteralExpCS)


def test_hyp_myatl_unlimitednaturalliteralexpcs_constructor_exists():
    assert callable(myAtl_UnlimitedNaturalLiteralExpCS.__init__)


def test_hyp_myatl_unlimitednaturalliteralexpcs_constructor_args():
    sig = inspect.signature(myAtl_UnlimitedNaturalLiteralExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_numberliteralexpcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_NumberLiteralExpCS)


def test_hyp_myatl_numberliteralexpcs_constructor_exists():
    assert callable(myAtl_NumberLiteralExpCS.__init__)


def test_hyp_myatl_numberliteralexpcs_constructor_args():
...
def test_hyp_myatl_tupleliteralpartcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_TupleLiteralPartCS)


def test_hyp_myatl_tupleliteralpartcs_constructor_exists():
    assert callable(myAtl_TupleLiteralPartCS.__init__)


def test_hyp_myatl_tupleliteralpartcs_constructor_args():
...
def test_hyp_myatl_tupleliteralexpcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_TupleLiteralExpCS)


def test_hyp_myatl_tupleliteralexpcs_constructor_exists():
    assert callable(myAtl_TupleLiteralExpCS.__init__)


def test_hyp_myatl_tupleliteralexpcs_constructor_args():
    sig = inspect.signature(myAtl_TupleLiteralExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_selfexpcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_SelfExpCS)


def test_hyp_myatl_selfexpcs_constructor_exists():
    assert callable(myAtl_SelfExpCS.__init__)


def test_hyp_myatl_selfexpcs_constructor_args():
    sig = inspect.signature(myAtl_SelfExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_stringexpcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_StringExpCs)


def test_hyp_myatl_stringexpcs_constructor_exists():
    assert callable(myAtl_StringExpCs.__init__)


def test_hyp_myatl_stringexpcs_constructor_args():
...
def test_hyp_myatl_navigatingexpcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_NavigatingExpCS)


def test_hyp_myatl_navigatingexpcs_constructor_exists():
    assert callable(myAtl_NavigatingExpCS.__init__)


def test_hyp_myatl_navigatingexpcs_constructor_args():
    sig = inspect.signature(myAtl_NavigatingExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_letexpcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_LetExpCS)


def test_hyp_myatl_letexpcs_constructor_exists():
    assert callable(myAtl_LetExpCS.__init__)


def test_hyp_myatl_letexpcs_constructor_args():
    sig = inspect.signature(myAtl_LetExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_nestedexpcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_NestedExpCS)


def test_hyp_myatl_nestedexpcs_constructor_exists():
    assert callable(myAtl_NestedExpCS.__init__)


def test_hyp_myatl_nestedexpcs_constructor_args():
    sig = inspect.signature(myAtl_NestedExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_ifexpcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_IfExpCS)


def test_hyp_myatl_ifexpcs_constructor_exists():
    assert callable(myAtl_IfExpCS.__init__)


def test_hyp_myatl_ifexpcs_constructor_args():
    sig = inspect.signature(myAtl_IfExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_primitiveliteralexpcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_PrimitiveLiteralExpCS)


def test_hyp_myatl_primitiveliteralexpcs_constructor_exists():
    assert callable(myAtl_PrimitiveLiteralExpCS.__init__)


def test_hyp_myatl_primitiveliteralexpcs_constructor_args():
    sig = inspect.signature(myAtl_PrimitiveLiteralExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_tuplepartcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_tuplePartCS)


def test_hyp_myatl_tuplepartcs_constructor_exists():
    assert callable(myAtl_tuplePartCS.__init__)


def test_hyp_myatl_tuplepartcs_constructor_args():
...
def test_hyp_typeliteralcs_is_not_abstract():
    assert not inspect.isabstract(TypeLiteralCS)


def test_hyp_typeliteralcs_constructor_exists():
    assert callable(TypeLiteralCS.__init__)


def test_hyp_typeliteralcs_constructor_args():
    sig = inspect.signature(TypeLiteralCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_primitivetypecs_is_not_abstract():
    assert not inspect.isabstract(myAtl_PrimitiveTypeCS)


def test_hyp_myatl_primitivetypecs_constructor_exists():
    assert callable(myAtl_PrimitiveTypeCS.__init__)


def test_hyp_myatl_primitivetypecs_constructor_args():
    sig = inspect.signature(myAtl_PrimitiveTypeCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_tupletypecs_is_not_abstract():
    assert not inspect.isabstract(myAtl_TupleTypeCS)


def test_hyp_myatl_tupletypecs_constructor_exists():
    assert callable(myAtl_TupleTypeCS.__init__)


def test_hyp_myatl_tupletypecs_constructor_args():
...
def test_hyp_myatl_collectiontypecs_is_not_abstract():
    assert not inspect.isabstract(myAtl_CollectionTypeCS)


def test_hyp_myatl_collectiontypecs_constructor_exists():
    assert callable(myAtl_CollectionTypeCS.__init__)


def test_hyp_myatl_collectiontypecs_constructor_args():
    sig = inspect.signature(myAtl_CollectionTypeCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_typeexpcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_TypeExpCS)


def test_hyp_myatl_typeexpcs_constructor_exists():
    assert callable(myAtl_TypeExpCS.__init__)


def test_hyp_myatl_typeexpcs_constructor_args():
...
def test_hyp_myatl_bindingstat_is_not_abstract():
    assert not inspect.isabstract(myAtl_BindingStat)


def test_hyp_myatl_bindingstat_constructor_exists():
    assert callable(myAtl_BindingStat.__init__)


def test_hyp_myatl_bindingstat_constructor_args():
...
def test_hyp_myatl_statement_is_not_abstract():
    assert not inspect.isabstract(myAtl_Statement)


def test_hyp_myatl_statement_constructor_exists():
    assert callable(myAtl_Statement.__init__)


def test_hyp_myatl_statement_constructor_args():
    sig = inspect.signature(myAtl_Statement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_binding_is_not_abstract():
    assert not inspect.isabstract(myAtl_Binding)


def test_hyp_myatl_binding_constructor_exists():
    assert callable(myAtl_Binding.__init__)


def test_hyp_myatl_binding_constructor_args():
...
def test_hyp_myatl_foreachoutpatternelement_is_not_abstract():
    assert not inspect.isabstract(myAtl_ForEachOutPatternElement)


def test_hyp_myatl_foreachoutpatternelement_constructor_exists():
    assert callable(myAtl_ForEachOutPatternElement.__init__)


def test_hyp_myatl_foreachoutpatternelement_constructor_args():
    sig = inspect.signature(myAtl_ForEachOutPatternElement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_simpleoutpatternelement_is_not_abstract():
    assert not inspect.isabstract(myAtl_SimpleOutPatternElement)


def test_hyp_myatl_simpleoutpatternelement_constructor_exists():
    assert callable(myAtl_SimpleOutPatternElement.__init__)


def test_hyp_myatl_simpleoutpatternelement_constructor_args():
...
def test_hyp_myatl_outpatternelement_is_not_abstract():
    assert not inspect.isabstract(myAtl_OutPatternElement)


def test_hyp_myatl_outpatternelement_constructor_exists():
    assert callable(myAtl_OutPatternElement.__init__)


def test_hyp_myatl_outpatternelement_constructor_args():
    sig = inspect.signature(myAtl_OutPatternElement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_inpatternelement_is_not_abstract():
    assert not inspect.isabstract(myAtl_InPatternElement)


def test_hyp_myatl_inpatternelement_constructor_exists():
    assert callable(myAtl_InPatternElement.__init__)


def test_hyp_myatl_inpatternelement_constructor_args():
...
def test_hyp_myatl_atltype_is_not_abstract():
    assert not inspect.isabstract(myAtl_ATLType)


def test_hyp_myatl_atltype_constructor_exists():
    assert callable(myAtl_ATLType.__init__)


def test_hyp_myatl_atltype_constructor_args():
...
def test_hyp_myatl_atldefcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_ATLDefCS)


def test_hyp_myatl_atldefcs_constructor_exists():
    assert callable(myAtl_ATLDefCS.__init__)


def test_hyp_myatl_atldefcs_constructor_args():
...
def test_hyp_myatl_expcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_ExpCS)


def test_hyp_myatl_expcs_constructor_exists():
    assert callable(myAtl_ExpCS.__init__)


def test_hyp_myatl_expcs_constructor_args():
    sig = inspect.signature(myAtl_ExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_atlparametercs_is_not_abstract():
    assert not inspect.isabstract(myAtl_ATLParameterCS)


def test_hyp_myatl_atlparametercs_constructor_exists():
    assert callable(myAtl_ATLParameterCS.__init__)


def test_hyp_myatl_atlparametercs_constructor_args():
...
def test_hyp_myatl_actionblock_is_not_abstract():
    assert not inspect.isabstract(myAtl_ActionBlock)


def test_hyp_myatl_actionblock_constructor_exists():
    assert callable(myAtl_ActionBlock.__init__)


def test_hyp_myatl_actionblock_constructor_args():
    sig = inspect.signature(myAtl_ActionBlock.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_outpattern_is_not_abstract():
    assert not inspect.isabstract(myAtl_OutPattern)


def test_hyp_myatl_outpattern_constructor_exists():
    assert callable(myAtl_OutPattern.__init__)


def test_hyp_myatl_outpattern_constructor_args():
    sig = inspect.signature(myAtl_OutPattern.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_rulevariabledeclaration_is_not_abstract():
    assert not inspect.isabstract(myAtl_RuleVariableDeclaration)


def test_hyp_myatl_rulevariabledeclaration_constructor_exists():
    assert callable(myAtl_RuleVariableDeclaration.__init__)


def test_hyp_myatl_rulevariabledeclaration_constructor_args():
...
def test_hyp_myatl_inpattern_is_not_abstract():
    assert not inspect.isabstract(myAtl_InPattern)


def test_hyp_myatl_inpattern_constructor_exists():
    assert callable(myAtl_InPattern.__init__)


def test_hyp_myatl_inpattern_constructor_args():
...
def test_hyp_myatl_queryrule_is_not_abstract():
    assert not inspect.isabstract(myAtl_QueryRule)


def test_hyp_myatl_queryrule_constructor_exists():
    assert callable(myAtl_QueryRule.__init__)


def test_hyp_myatl_queryrule_constructor_args():
    sig = inspect.signature(myAtl_QueryRule.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_helper_is_not_abstract():
    assert not inspect.isabstract(myAtl_Helper)


def test_hyp_myatl_helper_constructor_exists():
    assert callable(myAtl_Helper.__init__)


def test_hyp_myatl_helper_constructor_args():
    sig = inspect.signature(myAtl_Helper.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_calledrule_is_not_abstract():
    assert not inspect.isabstract(myAtl_CalledRule)


def test_hyp_myatl_calledrule_constructor_exists():
    assert callable(myAtl_CalledRule.__init__)


def test_hyp_myatl_calledrule_constructor_args():
    sig = inspect.signature(myAtl_CalledRule.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_matchedrule_is_not_abstract():
    assert not inspect.isabstract(myAtl_MatchedRule)


def test_hyp_myatl_matchedrule_constructor_exists():
    assert callable(myAtl_MatchedRule.__init__)


def test_hyp_myatl_matchedrule_constructor_args():
    sig = inspect.signature(myAtl_MatchedRule.__init__)
    params = list(sig.parameters.keys())



def test_hyp_myatl_moduleelement_is_not_abstract():
    assert not inspect.isabstract(myAtl_ModuleElement)


def test_hyp_myatl_moduleelement_constructor_exists():
    assert callable(myAtl_ModuleElement.__init__)


def test_hyp_myatl_moduleelement_constructor_args():
...
def test_hyp_myatl_nameexpcs_is_not_abstract():
    assert not inspect.isabstract(myAtl_NameExpCS)


def test_hyp_myatl_nameexpcs_constructor_exists():
    assert callable(myAtl_NameExpCS.__init__)


def test_hyp_myatl_nameexpcs_constructor_args():
...
def test_hyp_myatl_module_is_not_abstract():
    assert not inspect.isabstract(myAtl_Module)


def test_hyp_myatl_module_constructor_exists():
    assert callable(myAtl_Module.__init__)


def test_hyp_myatl_module_constructor_args():
...
def test_hyp_myatl_unaryoperatorcs_name_setter(instance):
...
def test_hyp_myatl_binaryoperatorcs_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_myatl_letvariablecs_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_myatl_navigatingsemiargcs_prefix_setter(instance):
...
def test_hyp_myatl_navigatingcommaargcs_prefix_setter(instance):
    original = instance.prefix
    instance.prefix = original
    assert instance.prefix == original
...
def test_hyp_myatl_navigatingbarargcs_prefix_setter(instance):
    original = instance.prefix
    instance.prefix = original
    assert instance.prefix == original
...
def test_hyp_myatl_typenameexpcs_namespace_setter(instance):
...
@given(instance=myAtl_TypeNameExpCS_strategy)
def test_hyp_myatl_typenameexpcs_element_setter(instance):
...
def test_hyp_myatl_typeliteralcs_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_myatl_stringliteralexpcs_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_myatl_booleanliteralexpcs_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_myatl_numberliteralexpcs_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_myatl_tupleliteralpartcs_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_myatl_stringexpcs_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_myatl_tuplepartcs_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_myatl_tupletypecs_backtrack_setter(instance):
...
def test_hyp_myatl_bindingstat_propertyName_setter(instance):
...
def test_hyp_myatl_binding_propertyName_setter(instance):
    original = instance.propertyName
    instance.propertyName = original
    assert instance.propertyName == original
...
def test_hyp_myatl_simpleoutpatternelement_varName_setter(instance):
...
def test_hyp_myatl_inpatternelement_varName_setter(instance):
    original = instance.varName
    instance.varName = original
    assert instance.varName == original
...
def test_hyp_myatl_atltype_modelName_setter(instance):
...
def test_hyp_myatl_atldefcs_varName_setter(instance):
    original = instance.varName
    instance.varName = original
    assert instance.varName == original
...
def test_hyp_myatl_atlparametercs_varName_setter(instance):
    original = instance.varName
    instance.varName = original
    assert instance.varName == original
...
def test_hyp_myatl_rulevariabledeclaration_varName_setter(instance):
    original = instance.varName
    instance.varName = original
    assert instance.varName == original
...
def test_hyp_myatl_moduleelement_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_myatl_nameexpcs_namespace_setter(instance):
    original = instance.namespace
    instance.namespace = original
    assert instance.namespace == original
...
@given(instance=myAtl_NameExpCS_strategy)
def test_hyp_myatl_nameexpcs_element_setter(instance):
    original = instance.element
    instance.element = original
    assert instance.element == original
...
def test_hyp_myatl_module_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
