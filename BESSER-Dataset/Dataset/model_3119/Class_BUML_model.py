...
owner3: BinaryAssociation = BinaryAssociation(
    name="owner3",
    ends={
        Property(name="Class4", type=Class_Attribute, multiplicity=Multiplicity(1, 1)),
...
domain_model = DomainModel(
    name="Class",
    types={Class_DataType, Classifier, Class_Class, Class_, Attribute, Class_Attribute, Class_NamedElt, Class_Classifier, NamedElt},
    associations={super0, attr1, type2, owner3},
    generalizations={gen_Class_DataType_Classifier, gen_Class_Class_Classifier, gen_Class_Attribute_NamedElt, gen_Class_Classifier_NamedElt},
    metadata=None
)
