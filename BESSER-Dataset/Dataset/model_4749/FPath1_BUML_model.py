...
# Classes
FPath_LocatedElement = Class(name="FPath_LocatedElement", is_abstract=True)
FPath_Expression = Class(name="FPath_Expression", is_abstract=True)
LocatedElement = Class(name="LocatedElement")
FPath_ContextExp = Class(name="FPath_ContextExp")
Expression = Class(name="Expression")
FPath_VariableExp = Class(name="FPath_VariableExp")
FPath_FunctionCallExp = Class(name="FPath_FunctionCallExp")
FPath_NumberExp = Class(name="FPath_NumberExp")
FPath_StringExp = Class(name="FPath_StringExp")
FPath_PathExp = Class(name="FPath_PathExp")
FPath_Step = Class(name="FPath_Step")
FPath_OperatorExp = Class(name="FPath_OperatorExp", is_abstract=True)
FPath_UnaryOperatorExp = Class(name="FPath_UnaryOperatorExp")
FPath_Test = Class(name="FPath_Test", is_abstract=True)
FPath_WildcardTest = Class(name="FPath_WildcardTest")
Test = Class(name="Test")
FPath_NameTest = Class(name="FPath_NameTest")
FPath_BinaryOperatorExp = Class(name="FPath_BinaryOperatorExp")
...
FPath_LocatedElement.attributes={FPath_LocatedElement_commentsBefore, FPath_LocatedElement_commentsAfter, FPath_LocatedElement_location}
...
domain_model = DomainModel(
    name="FPath",
    types={FPath_LocatedElement, FPath_Expression, LocatedElement, FPath_ContextExp, Expression, FPath_VariableExp, FPath_FunctionCallExp, FPath_NumberExp, FPath_StringExp, FPath_PathExp, FPath_Step, FPath_OperatorExp, FPath_UnaryOperatorExp, FPath_Test, FPath_WildcardTest, Test, FPath_NameTest, FPath_BinaryOperatorExp, OperatorExp, Axis},
    associations={arguments0, initialNodeSet1, steps3, left5, right7, operand10, test12, predicates14},
    generalizations={gen_FPath_Expression_LocatedElement, gen_FPath_ContextExp_Expression, gen_FPath_VariableExp_Expression, gen_FPath_FunctionCallExp_Expression, gen_FPath_NumberExp_Expression, gen_FPath_StringExp_Expression, gen_FPath_PathExp_Expression, gen_FPath_OperatorExp_Expression, gen_FPath_BinaryOperatorExp_OperatorExp, gen_FPath_UnaryOperatorExp_OperatorExp, gen_FPath_Step_LocatedElement, gen_FPath_Test_LocatedElement, gen_FPath_WildcardTest_Test, gen_FPath_NameTest_Test},
    metadata=None
)
