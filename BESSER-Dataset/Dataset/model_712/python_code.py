...
class pivot_IteratorExp(LoopExp, ReferringElement):
    ...
    def CollectHasOneIterator(self, pivot_context, pivot_diagnostics) :
...
class pivot_Variable(VariableDeclaration):
    ...
    def CompatibleInitialiserType(self, pivot_context, pivot_diagnostics) :
...
class pivot_TemplateableElement(Element):
    ...
    def __init__(self, TemplateableElement: "pivot_TemplateBinding" = None, pivot_TemplateableElement: "pivot_TemplateableElement" = None, pivot_TemplateableElement301: "pivot_TemplateableElement" = None, TemplateableElement296: "pivot_TemplateSignature" = None, template: "pivot_TemplateSignature" = None, boundElement: set["pivot_TemplateBinding"] = None):
...
class pivot_CollectionLiteralExp(LiteralExp):
    ...
    def BagKindIsBag(self, pivot_diagnostics, pivot_context) :
...
class pivot_State(Namespace, Vertex):
    ...
    def __init__(self, isComposite: str, isOrthogonal: str, isSimple: str, isSubmachineState: str, pivot_State: "pivot_ConnectionPointReference" = None, pivot_State207: "pivot_Pseudostate" = None, pivot_State236: set["pivot_Trigger"] = None, pivot_State214: "pivot_Region" = None, pivot_State230: set["pivot_ConnectionPointReference"] = None, pivot_State233: set["pivot_Pseudostate"] = None, pivot_State238: "pivot_Behavior" = None, State: "pivot_StateMachine" = None, pivot_State241: "pivot_Behavior" = None, pivot_State244: "pivot_Behavior" = None, pivot_State248: "pivot_State" = None, pivot_State246: "pivot_State" = None, pivot_State250: set["pivot_Region"] = None, pivot_State253: "pivot_Constraint" = None, submachineState: "pivot_StateMachine" = None, pivot_State257: "pivot_StateExp" = None):
...
class pivot_Class(Type, Namespace):
    ...
    def __init__(self, isInterface: str, isAbstract: str, pivot_Class: "pivot_Class" = None, pivot_Class10: set["pivot_Class"] = None, pivot_Class13: set["pivot_Behavior"] = None, pivot_Class143: "pivot_Operation" = None, pivot_Class182: "pivot_Property" = None):
...
class pivot_Operation(Namespace, ParameterableElement, Feature, TemplateableElement):

    def __init__(self, isInvalidating: str, isValidating: str, pivot_Operation: "pivot_CallOperationAction" = None, Operation: "pivot_Parameter" = None, pivot_Operation123: "pivot_MessageType" = None, pivot_Operation139: "pivot_OpaqueExpression" = None, pivot_Operation142: "pivot_Class" = None, operation: set["pivot_Parameter"] = None, ownedOperation: "pivot_Type" = None, pivot_Operation147: set["pivot_Constraint"] = None, pivot_Operation150: "pivot_Precedence" = None, pivot_Operation153: set["pivot_Constraint"] = None, pivot_Operation156: set["pivot_Type"] = None, pivot_Operation160: "pivot_Operation" = None, pivot_Operation158: set["pivot_Operation"] = None, pivot_Operation165: "pivot_OperationCallExp" = None, Operation327: "pivot_Type" = None):
...
class pivot_MessageExp(OCLExpression):
    ...
    def __init__(self, pivot_MessageExp: set["pivot_OCLExpression"] = None, pivot_MessageExp115: "pivot_CallOperationAction" = None, pivot_MessageExp118: "pivot_SendSignalAction" = None, pivot_MessageExp120: "pivot_OCLExpression" = None):
...
class pivot_Property(ParameterableElement, Feature):
    ...
    def __init__(self, isResolveProxies: str, isTransient: str, isUnsettable: str, isVolatile: str, default: str, implicit: str, isComposite: str, isDerived: str, isID: str, isReadOnly: str, Property: "pivot_AssociationClass" = None, pivot_Property: "pivot_ConstructorPart" = None, pivot_Property48: "pivot_DynamicProperty" = None, pivot_Property196: "pivot_Property" = None, pivot_Property134: "pivot_NavigationCallExp" = None, pivot_Property194: set["pivot_Property"] = None, pivot_Property199: "pivot_Property" = None, pivot_Property197: "pivot_Property" = None, unownedAttribute: "pivot_AssociationClass" = None, pivot_Property181: "pivot_Class" = None, pivot_Property184: "pivot_OpaqueExpression" = None, pivot_Property188: "pivot_Property" = None, pivot_Property186: set["pivot_Property"] = None, pivot_Property191: "pivot_Property" = None, pivot_Property189: "pivot_Property" = None, ownedAttribute: "pivot_Type" = None, pivot_Property202: "pivot_Property" = None, pivot_Property200: set["pivot_Property"] = None, pivot_Property204: "pivot_PropertyCallExp" = None, Property321: "pivot_Type" = None):
...
class pivot_Type(NamedElement, ParameterableElement, TemplateableElement):
    ...
    def __init__(self, instanceClassName: str, pivot_Type57: "pivot_ElementExtension" = None, pivot_Type: "pivot_CollectionType" = None, pivot_Type44: "pivot_DataType" = None, pivot_Type46: "pivot_DynamicElement" = None, Type174: "pivot_Package" = None, pivot_Type91: "pivot_LambdaType" = None, pivot_Type94: "pivot_LambdaType" = None, pivot_Type97: "pivot_LambdaType" = None, pivot_Type127: "pivot_Metaclass" = None, Type: "pivot_Operation" = None, pivot_Type157: "pivot_Operation" = None, Type193: "pivot_Property" = None, owningType: set["pivot_Property"] = None, pivot_Type323: set["pivot_Constraint"] = None, owningType326: set["pivot_Operation"] = None, ownedType: "pivot_Package" = None, pivot_Type332: "pivot_Type" = None, pivot_Type330: set["pivot_Type"] = None, pivot_Type334: "pivot_TypeExp" = None, pivot_Type336: "pivot_TypeTemplateParameter" = None, pivot_Type338: "pivot_TypedElement" = None, pivot_Type340: "pivot_UnspecifiedType" = None, pivot_Type343: "pivot_UnspecifiedType" = None):
