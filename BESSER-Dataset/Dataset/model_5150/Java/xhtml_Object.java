...
public class xhtml_Object  {
    ...
    public xhtml_Object(
        String hl7Id,        String name,        String group,        String mixed    ) {
        this.hl7Id = hl7Id;
        this.name = name;
        this.group = group;
        this.mixed = mixed;
    ...
    public xhtml_Object(
        String hl7Id,        String name,        String group,        String mixed        ArrayList<xhtml_Dfn> xhtml_dfns,        ArrayList<xhtml_P> xhtml_ps,        ArrayList<xhtml_A> xhtml_as,        ArrayList<xhtml_Q> xhtml_qs,        ArrayList<xhtml_I> xhtml_is,        ArrayList<xhtml_Kbd> xhtml_kbds,        ArrayList<xhtml_Abbr> xhtml_abbrs,        ArrayList<xhtml_Strong> xhtml_strongs,        ArrayList<xhtml_Small> xhtml_smalls,        ArrayList<xhtml_Sub> xhtml_subs,        ArrayList<xhtml_Big> xhtml_bigs,        ArrayList<xhtml_Acronym> xhtml_acronyms,        ArrayList<xhtml_Cite> xhtml_cites,        ArrayList<xhtml_Span> xhtml_spans,        ArrayList<xhtml_Code> xhtml_codes,        ArrayList<xhtml_Tt> xhtml_tts,        ArrayList<xhtml_Var> xhtml_vars,        ArrayList<xhtml_Samp> xhtml_samps,        ArrayList<xhtml_Sup> xhtml_sups,        ArrayList<xhtml_Em> xhtml_ems,        ArrayList<xhtml_B> xhtml_bs    ) {
        this.hl7Id = hl7Id;
        this.name = name;
        this.group = group;
        this.mixed = mixed;
