...
public class xhtml_AContent  {
    ...
    public xhtml_AContent(
        String group,        String mixed        ArrayList<xhtml_Acronym> xhtml_acronyms,        ArrayList<xhtml_Samp> xhtml_samps,        ArrayList<xhtml_B> xhtml_bs,        ArrayList<xhtml_Sub> xhtml_subs,        ArrayList<xhtml_Strong> xhtml_strongs,        ArrayList<xhtml_Kbd> xhtml_kbds,        ArrayList<xhtml_Cite> xhtml_cites,        ArrayList<xhtml_Var> xhtml_vars,        ArrayList<xhtml_Q> xhtml_qs,        ArrayList<xhtml_Code> xhtml_codes,        ArrayList<xhtml_Em> xhtml_ems,        ArrayList<xhtml_Tt> xhtml_tts,        ArrayList<xhtml_I> xhtml_is,        ArrayList<xhtml_Img> xhtml_imgs,        ArrayList<xhtml_Small> xhtml_smalls,        ArrayList<xhtml_Sup> xhtml_sups,        ArrayList<xhtml_Span> xhtml_spans,        ArrayList<xhtml_Object> xhtml_objects,        ArrayList<xhtml_Abbr> xhtml_abbrs,        ArrayList<xhtml_Big> xhtml_bigs,        ArrayList<xhtml_Dfn> xhtml_dfns    ) {
        this.group = group;
        this.mixed = mixed;
