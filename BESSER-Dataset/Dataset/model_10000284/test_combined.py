...
def test_hyp_operation_or_contract_is_not_abstract():
    assert not inspect.isabstract(operation_or_contract)


def test_hyp_operation_or_contract_constructor_exists():
    assert callable(operation_or_contract.__init__)


def test_hyp_operation_or_contract_constructor_args():
...
def test_hyp_operation_or_contract_operation_id_setter(instance):
...
@given(instance=operation_or_contract_strategy)
def test_hyp_operation_or_contract_operation_type_setter(instance):
...
@given(instance=operation_or_contract_strategy)
def test_hyp_operation_or_contract_owner_id_setter(instance):
...
@given(instance=operation_or_contract_strategy)
def test_hyp_operation_or_contract_customer_id_setter(instance):
...
@given(instance=operation_or_contract_strategy)
def test_hyp_operation_or_contract_Property_id_setter(instance):
...
@given(instance=Property_strategy)
def test_hyp_property_Available_setter(instance):
...
@given(instance=Property_strategy)
def test_hyp_property_size_setter(instance):
