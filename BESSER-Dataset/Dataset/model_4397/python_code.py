...
class arduino_Expression(ABC):
    ...
    def __init__(self, arduino_Expression25: "arduino_UnaryExpression" = None, arduino_Expression16: "arduino_While" = None, arduino_Expression18: "arduino_ModuleSet" = None, arduino_Expression: "arduino_If" = None, arduino_Expression27: "arduino_BinaryExpression" = None, arduino_Expression30: "arduino_BinaryExpression" = None):
...
class arduino_Sketch(NamedElement):
    ...
    def __init__(self, arduino_Sketch6: "arduino_Block" = None, arduino_Sketch: "arduino_Project" = None):
