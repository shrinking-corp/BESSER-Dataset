...
arduino_OutputModule = Class(name="arduino_OutputModule", is_abstract=True)
Module = Class(name="Module")
arduino_Led = Class(name="arduino_Led")
OutputModule = Class(name="OutputModule")
arduino_InputModule = Class(name="arduino_InputModule", is_abstract=True)
...
arduino_Board = Class(name="arduino_Board")
arduino_Sketch = Class(name="arduino_Sketch")
arduino_While = Class(name="arduino_While")
arduino_ModuleSet = Class(name="arduino_ModuleSet", is_abstract=True)
arduino_SetLed = Class(name="arduino_SetLed")
...
arduino_ModuleGet = Class(name="arduino_ModuleGet")
Expression = Class(name="Expression")
arduino_UnaryExpression = Class(name="arduino_UnaryExpression")
arduino_BinaryExpression = Class(name="arduino_BinaryExpression")
...
domain_model = DomainModel(
    name="arduino",
    types={arduino_NamedElement, arduino_Module, arduino_OutputModule, Module, arduino_Led, OutputModule, arduino_InputModule, arduino_PushButton, InputModule, arduino_Block, arduino_Instruction, arduino_Control, Instruction, arduino_Project, NamedElement, arduino_Board, arduino_Sketch, arduino_While, arduino_ModuleSet, arduino_SetLed, ModuleSet, arduino_Delay, arduino_WaitFor, arduino_Constant, arduino_If, Control, arduino_Expression, arduino_ModuleGet, Expression, arduino_UnaryExpression, arduino_BinaryExpression, UnaryOperatorKind, BinaryOperatorKind},
    associations={modules3, block5, instructions7, board0, sketch1, condition15, value17, led19, module20, value22, block9, condition11, elseBlock12, left26, right28, module31, operand24},
    generalizations={gen_arduino_Module_NamedElement, gen_arduino_OutputModule_Module, gen_arduino_Led_OutputModule, gen_arduino_InputModule_Module, gen_arduino_PushButton_InputModule, gen_arduino_Sketch_NamedElement, gen_arduino_Control_Instruction, gen_arduino_Project_NamedElement, gen_arduino_Board_NamedElement, gen_arduino_While_Control, gen_arduino_ModuleSet_Instruction, gen_arduino_SetLed_ModuleSet, gen_arduino_Delay_Instruction, gen_arduino_WaitFor_Instruction, gen_arduino_If_Control, gen_arduino_BinaryExpression_Expression, gen_arduino_ModuleGet_Expression, gen_arduino_Constant_Expression, gen_arduino_UnaryExpression_Expression},
    metadata=None
)
