...
# Classes
common_DublinCore = Class(name="common_DublinCore")
common_Identifiable = Class(name="common_Identifiable", is_abstract=True)
common_StringValueList = Class(name="common_StringValueList")
common_StringValue = Class(name="common_StringValue")
common_Comparable = Class(name="common_Comparable", is_abstract=True)
common_IdentifiableFilter = Class(name="common_IdentifiableFilter")
common_DoubleValueList = Class(name="common_DoubleValueList")
common_DoubleValue = Class(name="common_DoubleValue")
common_DoubleValueMatrix = Class(name="common_DoubleValueMatrix")
...
common_DublinCore.attributes={common_DublinCore_valid, common_DublinCore_coverage, common_DublinCore_contributor, common_DublinCore_title, common_DublinCore_spatial, common_DublinCore_date, common_DublinCore_created, common_DublinCore_format, common_DublinCore_creator, common_DublinCore_language, common_DublinCore_source, common_DublinCore_type, common_DublinCore_subject, common_DublinCore_license, common_DublinCore_relation, common_DublinCore_required, common_DublinCore_identifier, common_DublinCore_rights, common_DublinCore_publisher, common_DublinCore_description, common_DublinCore_bibliographicCitation}
...
common_Identifiable.attributes={common_Identifiable_uRI, common_Identifiable_typeURI}
...
domain_model = DomainModel(
    name="common",
    types={common_DublinCore, common_Identifiable, common_StringValueList, common_StringValue, common_Comparable, common_IdentifiableFilter, common_DoubleValueList, common_DoubleValue, common_DoubleValueMatrix, Modifiable},
    associations={values4, dublinCore0, values1, valueLists2},
    generalizations={gen_common_StringValue_Modifiable, gen_common_DoubleValue_Modifiable},
    metadata=None
)
