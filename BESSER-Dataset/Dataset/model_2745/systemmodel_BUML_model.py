...
systemmodel_B = Class(name="systemmodel_B")
systemmodel_C = Class(name="systemmodel_C")
...
systemmodel_SrcBlock = Class(name="systemmodel_SrcBlock")
systemmodel_Sum1 = Class(name="systemmodel_Sum1")
Sum = Class(name="Sum")
systemmodel_Sum2 = Class(name="systemmodel_Sum2")
systemmodel_Test = Class(name="systemmodel_Test")
systemmodel_A = Class(name="systemmodel_A")
ModelElement = Class(name="ModelElement")
A = Class(name="A")
systemmodel_Root = Class(name="systemmodel_Root")
systemmodel_ModelElement = Class(name="systemmodel_ModelElement", is_abstract=True)
...
domain_model = DomainModel(
    name="systemmodel",
    types={systemmodel_Block, systemmodel_SMElement, systemmodel_SystemModel, SMElement, systemmodel_B, systemmodel_C, systemmodel_Signal, systemmodel_Inport, systemmodel_Outport, systemmodel_UnitDelay, Block, systemmodel_Sum, systemmodel_SrcBlock, systemmodel_Sum1, Sum, systemmodel_Sum2, systemmodel_Test, systemmodel_A, ModelElement, A, systemmodel_Root, systemmodel_ModelElement},
    associations={blocks0, refB15, refC16, signals1, inports3, outports5, srcPort6, dstPort8, inSignal9, outSignals10, parentBlock12, nonUniqueOrderedRef13, elements18},
    generalizations={gen_systemmodel_SystemModel_SMElement, gen_systemmodel_Block_SMElement, gen_systemmodel_Signal_SMElement, gen_systemmodel_Inport_SMElement, gen_systemmodel_Outport_SMElement, gen_systemmodel_UnitDelay_Block, gen_systemmodel_Sum_Block, gen_systemmodel_SrcBlock_Block, gen_systemmodel_Sum1_Sum, gen_systemmodel_Sum2_Sum, gen_systemmodel_Test_Block, gen_systemmodel_A_ModelElement, gen_systemmodel_B_A, gen_systemmodel_C_ModelElement, gen_systemmodel_Root_SMElement, gen_systemmodel_ModelElement_SMElement},
    metadata=None
)
