...
tables_Chair = Class(name="tables_Chair")
tables_Waitress = Class(name="tables_Waitress")
tables_Restaurant = Class(name="tables_Restaurant")
...
tables_Table.attributes={tables_Table_id, tables_Table_isReserved}
