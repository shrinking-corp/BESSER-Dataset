...
Customer.attributes={Customer_name, Customer_dateOfBirth, Customer_emailAddress, Customer_phoneNumber, Customer_address}
...
Login.attributes={Login_lastLoginTime, Login_securityQuestion, Login_username, Login_securityAnswer, Login_password}
...
domain_model = DomainModel(
    name="_0b939623_4c5b_40c6_bc39_78992f017f20",
    types={transaction_WithdrawTransaction, transaction_TransferTransaction, account_SavingsAccount, account_CertificatesOfDepositAccount, account_CheckingAccount, account_Account, Customer, Login, transaction_Transaction, transaction_DepositTransaction, transaction_TransactionType, account_AccountType},
