...
public class Customer  {
    ...
    public Customer(
        String name,        String phoneNumber,        LocalDate dateOfBirth,        String address,        String emailAddress    ) {
        this.name = name;
    ...
    public Customer(
        String name,        String phoneNumber,        LocalDate dateOfBirth,        String address,        String emailAddress        ArrayList<account_Account> account_accounts    ) {
        this.name = name;
        this.phoneNumber = phoneNumber;
        this.dateOfBirth = dateOfBirth;
        this.address = address;
