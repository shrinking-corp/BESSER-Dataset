...
requirements_RelationShip.attributes={requirements_RelationShip_targetMin, requirements_RelationShip_targetMax, requirements_RelationShip_sourceMin, requirements_RelationShip_sourceMax}
...
requirements_BasicElement.attributes={requirements_BasicElement_documentation, requirements_BasicElement_id, requirements_BasicElement_name}
...
requirements_Annotation.attributes={requirements_Annotation_comment, requirements_Annotation_date, requirements_Annotation_id, requirements_Annotation_annotation, requirements_Annotation_status, requirements_Annotation_author}
...
domain_model = DomainModel(
    name="requirements",
    types={requirements_Entity, BasicElement, requirements_Attribute, requirements_RelationShip, requirements_ModelElement, requirements_BasicElement, ModelElement, requirements_Organization, AnnotableElement, requirements_Agent, requirements_Goal, requirements_PrivilegeGroup, requirements_GoalStep, requirements_Privilege, requirements_RequirementsDefinition, Organization, requirements_Process, requirements_Annotation, requirements_AnnotableElement, AttributeType, PrivilegeNature, PriorityLevel, AnnotationStatus},
    associations={parent1, attributes2, source4, target6, childElements9, isResponsible10, subgoals12, responsible13, privilegeGroup14, step16, element18, entryPoint19, privileges22, process28, annotation30, nextGoals25},
    generalizations={gen_requirements_Entity_BasicElement, gen_requirements_RelationShip_BasicElement, gen_requirements_Attribute_BasicElement, gen_requirements_BasicElement_ModelElement, gen_requirements_Organization_AnnotableElement, gen_requirements_Agent_AnnotableElement, gen_requirements_Goal_AnnotableElement, gen_requirements_RequirementsDefinition_Organization, gen_requirements_PrivilegeGroup_ModelElement, gen_requirements_Process_Organization, gen_requirements_AnnotableElement_BasicElement},
    metadata=None
)
