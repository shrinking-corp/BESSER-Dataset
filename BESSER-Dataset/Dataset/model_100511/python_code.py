...
class requirements_Annotation:
    ...
    def __init__(self, author: str, annotation: str, date: date, status: str, id: str, comment: str, requirements_Annotation: "requirements_AnnotableElement" = None):
        self.author = author
...
class requirements_BasicElement(ModelElement):
    ...
    def __init__(self, id: str, name: str, documentation: str, requirements_BasicElement: "requirements_Privilege" = None):
        self.id = id
        self.name = name
