...
def test_sap_pi_actor_is_not_abstract():
    assert not inspect.isabstract(SAP_PI_Actor)


def test_sap_pi_actor_constructor_exists():
    assert callable(SAP_PI_Actor.__init__)


def test_sap_pi_actor_constructor_args():
    sig = inspect.signature(SAP_PI_Actor.__init__)
    params = list(sig.parameters.keys())



def test_tibco_actor_is_not_abstract():
    assert not inspect.isabstract(TIBCO_Actor)


def test_tibco_actor_constructor_exists():
    assert callable(TIBCO_Actor.__init__)


def test_tibco_actor_constructor_args():
