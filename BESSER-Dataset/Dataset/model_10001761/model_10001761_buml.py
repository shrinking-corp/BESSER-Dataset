...
TIBCO_Actor = Class(name="TIBCO_Actor")
SAP_PI_Actor = Class(name="SAP_PI_Actor")
...
# TIBCO_Actor class attributes and methods

# SAP_PI_Actor class attributes and methods
...
domain_model = DomainModel(
    name="_ThtrQAe7EeqFfO0RhT_ZfA",
    types={ShoppingCartExample_ShoppingCart, ShoppingCartExample_Order, ShoppingCartExample_LineItem, ShoppingCartExample_Account, ShoppingCartExample_Customer, TIBCO_Actor, SAP_PI_Actor},
