...
class Company_Organisation:
    ...
    def __init__(self, city: str, completeAddress: str, name: str, Company_Organisation6: set["Company_Project"] = None, Company_Organisation9: set["Company_Division"] = None, Company_Organisation: set["Company_Person"] = None, Company_Organisation15: "Company_CompanyModel" = None):
        self.city = city
...
class Company_Project:
    ...
    def __init__(self, name: str, budget: int, Company_Project7: "Company_Organisation" = None, Company_Project11: "Company_Topic" = None, Company_Project: "Company_Person" = None):
        self.name = name
        self.budget = budget
