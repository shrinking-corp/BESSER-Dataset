...
public class Company_Organisation  {
    ...
    public Company_Organisation(
        String city,        String name,        String completeAddress    ) {
        this.city = city;
        this.name = name;
    ...
    public Company_Organisation(
        String city,        String name,        String completeAddress        ArrayList<Company_Project> company_projects,        ArrayList<Company_Division> company_divisions,        ArrayList<Company_Person> company_persons    ) {
        this.city = city;
        this.name = name;
        this.completeAddress = completeAddress;
