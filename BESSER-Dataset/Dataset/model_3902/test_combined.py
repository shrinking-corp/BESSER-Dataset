...
def test_hyp_soaml_categorization_is_not_abstract():
    assert not inspect.isabstract(soaml_Categorization)


def test_hyp_soaml_categorization_constructor_exists():
    assert callable(soaml_Categorization.__init__)


def test_hyp_soaml_categorization_constructor_args():
    sig = inspect.signature(soaml_Categorization.__init__)
    params = list(sig.parameters.keys())



def test_hyp_freeformvalue_is_not_abstract():
    assert not inspect.isabstract(FreeFormValue)


def test_hyp_freeformvalue_constructor_exists():
    assert callable(FreeFormValue.__init__)


def test_hyp_freeformvalue_constructor_args():
    sig = inspect.signature(FreeFormValue.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_categoryvalue_is_not_abstract():
    assert not inspect.isabstract(soaml_CategoryValue)


def test_hyp_soaml_categoryvalue_constructor_exists():
    assert callable(soaml_CategoryValue.__init__)


def test_hyp_soaml_categoryvalue_constructor_args():
    sig = inspect.signature(soaml_CategoryValue.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_freeformvalue_is_not_abstract():
    assert not inspect.isabstract(soaml_FreeFormValue)


def test_hyp_soaml_freeformvalue_constructor_exists():
    assert callable(soaml_FreeFormValue.__init__)


def test_hyp_soaml_freeformvalue_constructor_args():
    sig = inspect.signature(soaml_FreeFormValue.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_freeformdescriptor_is_not_abstract():
    assert not inspect.isabstract(soaml_FreeFormDescriptor)


def test_hyp_soaml_freeformdescriptor_constructor_exists():
    assert callable(soaml_FreeFormDescriptor.__init__)


def test_hyp_soaml_freeformdescriptor_constructor_args():
    sig = inspect.signature(soaml_FreeFormDescriptor.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_package_is_not_abstract():
    assert not inspect.isabstract(soaml_Package)


def test_hyp_soaml_package_constructor_exists():
    assert callable(soaml_Package.__init__)


def test_hyp_soaml_package_constructor_args():
    sig = inspect.signature(soaml_Package.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nodedescriptor_is_not_abstract():
    assert not inspect.isabstract(NodeDescriptor)


def test_hyp_nodedescriptor_constructor_exists():
    assert callable(NodeDescriptor.__init__)


def test_hyp_nodedescriptor_constructor_args():
    sig = inspect.signature(NodeDescriptor.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_category_is_not_abstract():
    assert not inspect.isabstract(soaml_Category)


def test_hyp_soaml_category_constructor_exists():
    assert callable(soaml_Category.__init__)


def test_hyp_soaml_category_constructor_args():
    sig = inspect.signature(soaml_Category.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_catalog_is_not_abstract():
    assert not inspect.isabstract(soaml_Catalog)


def test_hyp_soaml_catalog_constructor_exists():
    assert callable(soaml_Catalog.__init__)


def test_hyp_soaml_catalog_constructor_args():
    sig = inspect.signature(soaml_Catalog.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_artifact_is_not_abstract():
    assert not inspect.isabstract(soaml_Artifact)


def test_hyp_soaml_artifact_constructor_exists():
    assert callable(soaml_Artifact.__init__)


def test_hyp_soaml_artifact_constructor_args():
    sig = inspect.signature(soaml_Artifact.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_nodedescriptor_is_not_abstract():
    assert not inspect.isabstract(soaml_NodeDescriptor)


def test_hyp_soaml_nodedescriptor_constructor_exists():
    assert callable(soaml_NodeDescriptor.__init__)


def test_hyp_soaml_nodedescriptor_constructor_args():
    sig = inspect.signature(soaml_NodeDescriptor.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_dependency_is_not_abstract():
    assert not inspect.isabstract(soaml_Dependency)


def test_hyp_soaml_dependency_constructor_exists():
    assert callable(soaml_Dependency.__init__)


def test_hyp_soaml_dependency_constructor_args():
    sig = inspect.signature(soaml_Dependency.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_expose_is_not_abstract():
    assert not inspect.isabstract(soaml_Expose)


def test_hyp_soaml_expose_constructor_exists():
    assert callable(soaml_Expose.__init__)


def test_hyp_soaml_expose_constructor_args():
    sig = inspect.signature(soaml_Expose.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_signal_is_not_abstract():
    assert not inspect.isabstract(soaml_Signal)


def test_hyp_soaml_signal_constructor_exists():
    assert callable(soaml_Signal.__init__)


def test_hyp_soaml_signal_constructor_args():
    sig = inspect.signature(soaml_Signal.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_datatype_is_not_abstract():
    assert not inspect.isabstract(soaml_DataType)


def test_hyp_soaml_datatype_constructor_exists():
    assert callable(soaml_DataType.__init__)


def test_hyp_soaml_datatype_constructor_args():
    sig = inspect.signature(soaml_DataType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_messagetype_is_not_abstract():
    assert not inspect.isabstract(soaml_MessageType)


def test_hyp_soaml_messagetype_constructor_exists():
    assert callable(soaml_MessageType.__init__)


def test_hyp_soaml_messagetype_constructor_args():
...
def test_hyp_soaml_attachment_is_not_abstract():
    assert not inspect.isabstract(soaml_Attachment)


def test_hyp_soaml_attachment_constructor_exists():
    assert callable(soaml_Attachment.__init__)


def test_hyp_soaml_attachment_constructor_args():
...
def test_hyp_soaml_property_is_not_abstract():
    assert not inspect.isabstract(soaml_Property)


def test_hyp_soaml_property_constructor_exists():
    assert callable(soaml_Property.__init__)


def test_hyp_soaml_property_constructor_args():
...
def test_hyp_soaml_connector_is_not_abstract():
    assert not inspect.isabstract(soaml_Connector)


def test_hyp_soaml_connector_constructor_exists():
    assert callable(soaml_Connector.__init__)


def test_hyp_soaml_connector_constructor_args():
    sig = inspect.signature(soaml_Connector.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_servicechannel_is_not_abstract():
    assert not inspect.isabstract(soaml_ServiceChannel)


def test_hyp_soaml_servicechannel_constructor_exists():
    assert callable(soaml_ServiceChannel.__init__)


def test_hyp_soaml_servicechannel_constructor_args():
    sig = inspect.signature(soaml_ServiceChannel.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_service_is_not_abstract():
    assert not inspect.isabstract(soaml_Service)


def test_hyp_soaml_service_constructor_exists():
    assert callable(soaml_Service.__init__)


def test_hyp_soaml_service_constructor_args():
    sig = inspect.signature(soaml_Service.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_request_is_not_abstract():
    assert not inspect.isabstract(soaml_Request)


def test_hyp_soaml_request_constructor_exists():
    assert callable(soaml_Request.__init__)


def test_hyp_soaml_request_constructor_args():
    sig = inspect.signature(soaml_Request.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_port_is_not_abstract():
    assert not inspect.isabstract(soaml_Port)


def test_hyp_soaml_port_constructor_exists():
    assert callable(soaml_Port.__init__)


def test_hyp_soaml_port_constructor_args():
...
def test_hyp_soaml_agent_is_not_abstract():
    assert not inspect.isabstract(soaml_Agent)


def test_hyp_soaml_agent_constructor_exists():
    assert callable(soaml_Agent.__init__)


def test_hyp_soaml_agent_constructor_args():
    sig = inspect.signature(soaml_Agent.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_participant_is_not_abstract():
    assert not inspect.isabstract(soaml_Participant)


def test_hyp_soaml_participant_constructor_exists():
    assert callable(soaml_Participant.__init__)


def test_hyp_soaml_participant_constructor_args():
    sig = inspect.signature(soaml_Participant.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_capability_is_not_abstract():
    assert not inspect.isabstract(soaml_Capability)


def test_hyp_soaml_capability_constructor_exists():
    assert callable(soaml_Capability.__init__)


def test_hyp_soaml_capability_constructor_args():
    sig = inspect.signature(soaml_Capability.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_comment_is_not_abstract():
    assert not inspect.isabstract(soaml_Comment)


def test_hyp_soaml_comment_constructor_exists():
    assert callable(soaml_Comment.__init__)


def test_hyp_soaml_comment_constructor_args():
    sig = inspect.signature(soaml_Comment.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_valuespecification_is_not_abstract():
    assert not inspect.isabstract(soaml_ValueSpecification)


def test_hyp_soaml_valuespecification_constructor_exists():
    assert callable(soaml_ValueSpecification.__init__)


def test_hyp_soaml_valuespecification_constructor_args():
    sig = inspect.signature(soaml_ValueSpecification.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_milestone_is_not_abstract():
    assert not inspect.isabstract(soaml_Milestone)


def test_hyp_soaml_milestone_constructor_exists():
    assert callable(soaml_Milestone.__init__)


def test_hyp_soaml_milestone_constructor_args():
...
def test_hyp_soaml_provider_is_not_abstract():
    assert not inspect.isabstract(soaml_Provider)


def test_hyp_soaml_provider_constructor_exists():
    assert callable(soaml_Provider.__init__)


def test_hyp_soaml_provider_constructor_args():
    sig = inspect.signature(soaml_Provider.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_class_is_not_abstract():
    assert not inspect.isabstract(soaml_Class)


def test_hyp_soaml_class_constructor_exists():
    assert callable(soaml_Class.__init__)


def test_hyp_soaml_class_constructor_args():
    sig = inspect.signature(soaml_Class.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_interface_is_not_abstract():
    assert not inspect.isabstract(soaml_Interface)


def test_hyp_soaml_interface_constructor_exists():
    assert callable(soaml_Interface.__init__)


def test_hyp_soaml_interface_constructor_args():
    sig = inspect.signature(soaml_Interface.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_consumer_is_not_abstract():
    assert not inspect.isabstract(soaml_Consumer)


def test_hyp_soaml_consumer_constructor_exists():
    assert callable(soaml_Consumer.__init__)


def test_hyp_soaml_consumer_constructor_args():
    sig = inspect.signature(soaml_Consumer.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_collaborationuse_is_not_abstract():
    assert not inspect.isabstract(soaml_CollaborationUse)


def test_hyp_soaml_collaborationuse_constructor_exists():
    assert callable(soaml_CollaborationUse.__init__)


def test_hyp_soaml_collaborationuse_constructor_args():
...
def test_hyp_soaml_servicecontract_is_not_abstract():
    assert not inspect.isabstract(soaml_ServiceContract)


def test_hyp_soaml_servicecontract_constructor_exists():
    assert callable(soaml_ServiceContract.__init__)


def test_hyp_soaml_servicecontract_constructor_args():
    sig = inspect.signature(soaml_ServiceContract.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_servicearchitecture_is_not_abstract():
    assert not inspect.isabstract(soaml_ServiceArchitecture)


def test_hyp_soaml_servicearchitecture_constructor_exists():
    assert callable(soaml_ServiceArchitecture.__init__)


def test_hyp_soaml_servicearchitecture_constructor_args():
    sig = inspect.signature(soaml_ServiceArchitecture.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_collaboration_is_not_abstract():
    assert not inspect.isabstract(soaml_Collaboration)


def test_hyp_soaml_collaboration_constructor_exists():
    assert callable(soaml_Collaboration.__init__)


def test_hyp_soaml_collaboration_constructor_args():
...
def test_hyp_soaml_serviceinterface_is_not_abstract():
    assert not inspect.isabstract(soaml_ServiceInterface)


def test_hyp_soaml_serviceinterface_constructor_exists():
    assert callable(soaml_ServiceInterface.__init__)


def test_hyp_soaml_serviceinterface_constructor_args():
    sig = inspect.signature(soaml_ServiceInterface.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_realization_is_not_abstract():
    assert not inspect.isabstract(soaml_Realization)


def test_hyp_soaml_realization_constructor_exists():
    assert callable(soaml_Realization.__init__)


def test_hyp_soaml_realization_constructor_args():
    sig = inspect.signature(soaml_Realization.__init__)
    params = list(sig.parameters.keys())



def test_hyp_soaml_motivationrealization_is_not_abstract():
    assert not inspect.isabstract(soaml_MotivationRealization)


def test_hyp_soaml_motivationrealization_constructor_exists():
    assert callable(soaml_MotivationRealization.__init__)


def test_hyp_soaml_motivationrealization_constructor_args():
...
def test_hyp_soaml_messagetype_encoding_setter(instance):
...
def test_hyp_soaml_attachment_encoding_setter(instance):
    original = instance.encoding
    instance.encoding = original
    assert instance.encoding == original
...
@given(instance=soaml_Attachment_strategy)
def test_hyp_soaml_attachment_mimeType_setter(instance):
...
def test_hyp_soaml_property_isID_setter(instance):
...
def test_hyp_soaml_port_connectorRequired_setter(instance):
...
def test_hyp_soaml_milestone_progress_setter(instance):
...
def test_hyp_soaml_collaborationuse_isStrict_setter(instance):
...
def test_hyp_soaml_collaboration_isStrict_setter(instance):
    original = instance.isStrict
    instance.isStrict = original
    assert instance.isStrict == original
