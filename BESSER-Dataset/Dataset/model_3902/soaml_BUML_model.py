...
# Classes
soaml_MotivationRealization = Class(name="soaml_MotivationRealization")
soaml_Realization = Class(name="soaml_Realization")
soaml_ServiceInterface = Class(name="soaml_ServiceInterface")
soaml_Collaboration = Class(name="soaml_Collaboration")
soaml_ServiceArchitecture = Class(name="soaml_ServiceArchitecture")
Collaboration = Class(name="Collaboration")
soaml_ServiceContract = Class(name="soaml_ServiceContract")
soaml_CollaborationUse = Class(name="soaml_CollaborationUse")
soaml_Consumer = Class(name="soaml_Consumer")
soaml_Interface = Class(name="soaml_Interface")
soaml_Class = Class(name="soaml_Class")
soaml_Provider = Class(name="soaml_Provider")
soaml_Milestone = Class(name="soaml_Milestone")
soaml_ValueSpecification = Class(name="soaml_ValueSpecification")
soaml_Comment = Class(name="soaml_Comment")
soaml_Capability = Class(name="soaml_Capability")
soaml_Participant = Class(name="soaml_Participant")
soaml_Agent = Class(name="soaml_Agent")
Participant = Class(name="Participant")
soaml_Port = Class(name="soaml_Port")
soaml_Request = Class(name="soaml_Request")
soaml_Service = Class(name="soaml_Service")
soaml_ServiceChannel = Class(name="soaml_ServiceChannel")
soaml_Connector = Class(name="soaml_Connector")
soaml_Property = Class(name="soaml_Property")
soaml_Attachment = Class(name="soaml_Attachment")
soaml_MessageType = Class(name="soaml_MessageType")
soaml_DataType = Class(name="soaml_DataType")
soaml_Signal = Class(name="soaml_Signal")
soaml_Expose = Class(name="soaml_Expose")
soaml_Dependency = Class(name="soaml_Dependency")
soaml_NodeDescriptor = Class(name="soaml_NodeDescriptor")
soaml_Artifact = Class(name="soaml_Artifact")
soaml_Catalog = Class(name="soaml_Catalog")
NodeDescriptor = Class(name="NodeDescriptor")
soaml_Package = Class(name="soaml_Package")
soaml_Category = Class(name="soaml_Category")
soaml_FreeFormDescriptor = Class(name="soaml_FreeFormDescriptor")
soaml_FreeFormValue = Class(name="soaml_FreeFormValue")
soaml_CategoryValue = Class(name="soaml_CategoryValue")
FreeFormValue = Class(name="FreeFormValue")
soaml_Categorization = Class(name="soaml_Categorization")
...
soaml_Attachment.attributes={soaml_Attachment_mimeType, soaml_Attachment_encoding}
...
domain_model = DomainModel(
    name="soaml",
    types={soaml_MotivationRealization, soaml_Realization, soaml_ServiceInterface, soaml_Collaboration, soaml_ServiceArchitecture, Collaboration, soaml_ServiceContract, soaml_CollaborationUse, soaml_Consumer, soaml_Interface, soaml_Class, soaml_Provider, soaml_Milestone, soaml_ValueSpecification, soaml_Comment, soaml_Capability, soaml_Participant, soaml_Agent, Participant, soaml_Port, soaml_Request, soaml_Service, soaml_ServiceChannel, soaml_Connector, soaml_Property, soaml_Attachment, soaml_MessageType, soaml_DataType, soaml_Signal, soaml_Expose, soaml_Dependency, soaml_NodeDescriptor, soaml_Artifact, soaml_Catalog, NodeDescriptor, soaml_Package, soaml_Category, soaml_FreeFormDescriptor, soaml_FreeFormValue, soaml_CategoryValue, FreeFormValue, soaml_Categorization},
    associations={base_Class9, base_Realization12, base_Interface13, base_Class15, base_Collaboration1, base_CollaborationUse3, base_Interface4, base_Class5, base_Interface7, value37, signal38, base_Comment41, base_Class43, base_Class18, base_Port21, base_Port22, base_Port24, base_Connector26, base_Property28, base_Property29, base_Class31, base_DataType33, base_Signal35, base_Dependency45, base_Artifact46, base_Package47, base_Property48, base_ValueSpecification50, base_Dependency52},
    generalizations={gen_soaml_ServiceArchitecture_Collaboration, gen_soaml_ServiceContract_Collaboration, gen_soaml_Agent_Participant, gen_soaml_Catalog_NodeDescriptor, gen_soaml_Category_NodeDescriptor, gen_soaml_CategoryValue_FreeFormValue},
    metadata=None
)
