...
class petrinet_Place:
    ...
    def __init__(self, token: int, name: str, Place: "petrinet_PetriNet" = None, petrinet_Place: set["petrinet_Transition"] = None, places: "petrinet_PetriNet" = None, petrinet_Place6: "petrinet_Arc" = None):
        self.token = token
        self.name = name
        self.Place = Place
...
class petrinet_Arc:
    ...
    def __init__(self, weight: int, toPlace: bool, arcs: "petrinet_PetriNet" = None, Arc: "petrinet_PetriNet" = None, petrinet_Arc: "petrinet_Transition" = None, petrinet_Arc5: "petrinet_Place" = None):
        self.weight = weight
...
class petrinet_PetriNet:
    ...
    def __init__(self, name: str, PetriNet8: "petrinet_Arc" = None, PetriNet10: "petrinet_Transition" = None, net: set["petrinet_Place"] = None, net13: set["petrinet_Arc"] = None, net15: set["petrinet_Transition"] = None, PetriNet: "petrinet_Place" = None):
        self.name = name
...
class petrinet_Transition:
    ...
    def __init__(self, name: str, transitions: "petrinet_PetriNet" = None, Transition: "petrinet_PetriNet" = None, petrinet_Transition: "petrinet_Place" = None, petrinet_Transition3: "petrinet_Arc" = None):
        self.name = name
