...
domain_model = DomainModel(
    name="petrinet",
    types={petrinet_Place, petrinet_Transition, petrinet_PetriNet, petrinet_Arc},
    associations={net7, net9, places11, arcs12, transitions14, inhibitorArc0, net1, transition2, place4},
    generalizations={},
    metadata=None
)
