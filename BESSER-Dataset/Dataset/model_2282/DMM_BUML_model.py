...
# Classes
dmm_Student = Class(name="dmm_Student")
Person = Class(name="Person")
dmm_Course = Class(name="dmm_Course")
dmm_Professor = Class(name="dmm_Professor")
dmm_Exam = Class(name="dmm_Exam")
dmm_UniversityManagementSystem = Class(name="dmm_UniversityManagementSystem")
dmm_Person = Class(name="dmm_Person", is_abstract=True)
...
dmm_Course.attributes={dmm_Course_courseNumber, dmm_Course_courseType, dmm_Course_name}
...
domain_model = DomainModel(
    name="dmm",
    types={dmm_Student, Person, dmm_Course, dmm_Professor, dmm_Exam, dmm_UniversityManagementSystem, dmm_Person, CourseType},
