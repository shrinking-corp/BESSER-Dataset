...
class dmm_Person(ABC):
    ...
    def __init__(self, email: str, name: str, dmm_Person: "dmm_UniversityManagementSystem" = None):
        self.email = email
        self.name = name
...
class dmm_Course:
    ...
    def __init__(self, name: str, courseNumber: int, courseType: str, dmm_Course: "dmm_Student" = None, dmm_Course2: "dmm_Professor" = None, dmm_Course5: "dmm_Course" = None, dmm_Course3: set["dmm_Course"] = None, dmm_Course7: set["dmm_Exam"] = None, dmm_Course9: "dmm_UniversityManagementSystem" = None):
        self.name = name
