...
domain_model = DomainModel(
    name="smallJava",
    types={smallJava_SJImport, smallJava_SJClass, smallJava_SJMember, smallJava_SJField, SJMember, smallJava_SJMethod, smallJava_SJParameter, smallJava_SJMethodBody, SJSymbol, SJBlock, smallJava_SJStatement, smallJava_SJReturn, SJStatement, smallJava_SJProgram, smallJava_SJBlock, smallJava_SJSymbol, smallJava_SJAssignment, SJExpression, smallJava_SJMemberSelection, smallJava_SJStringConstant, smallJava_SJIntConstant, smallJava_SJBoolConstant, smallJava_SJThis, smallJava_SJSuper, smallJava_SJNull, smallJava_SJSymbolRef, smallJava_SJExpression, smallJava_SJVariableDeclaration, smallJava_SJIfStatement, smallJava_SJIfBlock, smallJava_SJNew, SJAccessLevel},
    associations={imports0, classes1, superclass4, members6, type8, params11, body12, elseBlock21, statements24, type25, left27, right29, receiver32, member34, args37, symbol40, expression14, expression15, expression17, thenBlock19, type42},
    generalizations={gen_smallJava_SJField_SJMember, gen_smallJava_SJMethod_SJMember, gen_smallJava_SJParameter_SJSymbol, gen_smallJava_SJMethodBody_SJBlock, gen_smallJava_SJReturn_SJStatement, gen_smallJava_SJIfBlock_SJBlock, gen_smallJava_SJExpression_SJStatement, gen_smallJava_SJAssignment_SJExpression, gen_smallJava_SJMemberSelection_SJExpression, gen_smallJava_SJStringConstant_SJExpression, gen_smallJava_SJIntConstant_SJExpression, gen_smallJava_SJBoolConstant_SJExpression, gen_smallJava_SJThis_SJExpression, gen_smallJava_SJSuper_SJExpression, gen_smallJava_SJNull_SJExpression, gen_smallJava_SJSymbolRef_SJExpression, gen_smallJava_SJVariableDeclaration_SJStatement, gen_smallJava_SJVariableDeclaration_SJSymbol, gen_smallJava_SJIfStatement_SJStatement, gen_smallJava_SJNew_SJExpression},
    metadata=None
)
