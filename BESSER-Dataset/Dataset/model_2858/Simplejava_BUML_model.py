...
# Classes
simplejava_Import = Class(name="simplejava_Import")
simplejava_ClassDeclaration = Class(name="simplejava_ClassDeclaration")
simplejava_Parameter = Class(name="simplejava_Parameter")
simplejava_Method = Class(name="simplejava_Method")
simplejava_Type = Class(name="simplejava_Type")
simplejava_SimpleParameter = Class(name="simplejava_SimpleParameter")
Parameter_ = Class(name="Parameter")
simplejava_Attribute = Class(name="simplejava_Attribute")
simplejava_GenericExpression = Class(name="simplejava_GenericExpression")
simplejava_SimpleJava = Class(name="simplejava_SimpleJava")
simplejava_PackageDeclaration = Class(name="simplejava_PackageDeclaration")
simplejava_IfStatement = Class(name="simplejava_IfStatement")
simplejava_ParanthesisOrBinaryExpression = Class(name="simplejava_ParanthesisOrBinaryExpression")
simplejava_ForStatement = Class(name="simplejava_ForStatement")
simplejava_ForInStatement = Class(name="simplejava_ForInStatement")
simplejava_WhileStatement = Class(name="simplejava_WhileStatement")
simplejava_MethodBlock = Class(name="simplejava_MethodBlock")
Statement = Class(name="Statement")
simplejava_Statement = Class(name="simplejava_Statement")
simplejava_SimpleStatement = Class(name="simplejava_SimpleStatement")
simplejava_SimpleVariableDeclaration = Class(name="simplejava_SimpleVariableDeclaration")
SimpleStatement = Class(name="SimpleStatement")
simplejava_VariableDeclaration = Class(name="simplejava_VariableDeclaration")
SimpleVariableDeclaration = Class(name="SimpleVariableDeclaration")
simplejava_Assignment = Class(name="simplejava_Assignment")
simplejava_ConstantExpression = Class(name="simplejava_ConstantExpression")
simplejava_NullExpression = Class(name="simplejava_NullExpression")
ConstantExpression = Class(name="ConstantExpression")
simplejava_IntegerExpression = Class(name="simplejava_IntegerExpression")
simplejava_BooleanExpression = Class(name="simplejava_BooleanExpression")
simplejava_StringExpression = Class(name="simplejava_StringExpression")
simplejava_UnaryExpression = Class(name="simplejava_UnaryExpression")
simplejava_ReturnStatement = Class(name="simplejava_ReturnStatement")
simplejava_MethodCall = Class(name="simplejava_MethodCall")
GenericExpression = Class(name="GenericExpression")
simplejava_ConstructorCall = Class(name="simplejava_ConstructorCall")
simplejava_VariableExpression = Class(name="simplejava_VariableExpression")
...
simplejava_Type.attributes={simplejava_Type_typeName, simplejava_Type_isVoid}
...
simplejava_MethodCall.attributes={simplejava_MethodCall_methodName, simplejava_MethodCall_thisObject}
...
domain_model = DomainModel(
    name="simplejava",
    types={simplejava_Import, simplejava_ClassDeclaration, simplejava_Parameter, simplejava_Method, simplejava_Type, simplejava_SimpleParameter, Parameter_, simplejava_Attribute, simplejava_GenericExpression, simplejava_SimpleJava, simplejava_PackageDeclaration, simplejava_IfStatement, simplejava_ParanthesisOrBinaryExpression, simplejava_ForStatement, simplejava_ForInStatement, simplejava_WhileStatement, simplejava_MethodBlock, Statement, simplejava_Statement, simplejava_SimpleStatement, simplejava_SimpleVariableDeclaration, SimpleStatement, simplejava_VariableDeclaration, SimpleVariableDeclaration, simplejava_Assignment, simplejava_ConstantExpression, simplejava_NullExpression, ConstantExpression, simplejava_IntegerExpression, simplejava_BooleanExpression, simplejava_StringExpression, simplejava_UnaryExpression, simplejava_ReturnStatement, simplejava_MethodCall, GenericExpression, simplejava_ConstructorCall, simplejava_VariableExpression},
    associations={imports1, clazz3, attribute5, method7, type9, expression11, package0, condition34, then35, else_38, init41, condition42, continuation45, body48, subparameter51, expression53, body56, condition59, typeRef12, returnType15, parameter18, content20, statements22, parameter24, expression26, parameter29, expression31, parameter76, source78, body61, expression64, object66, method68, parameter71, type74, variable80, source82, argument85},
    generalizations={gen_simplejava_SimpleParameter_Parameter, gen_simplejava_Attribute_Parameter, gen_simplejava_IfStatement_Statement, gen_simplejava_ForStatement_Statement, gen_simplejava_ForInStatement_Statement, gen_simplejava_WhileStatement_Statement, gen_simplejava_MethodBlock_Statement, gen_simplejava_SimpleVariableDeclaration_SimpleStatement, gen_simplejava_VariableDeclaration_Statement, gen_simplejava_VariableDeclaration_SimpleVariableDeclaration, gen_simplejava_Assignment_SimpleStatement, gen_simplejava_Assignment_Statement, gen_simplejava_ConstantExpression_GenericExpression, gen_simplejava_NullExpression_ConstantExpression, gen_simplejava_IntegerExpression_ConstantExpression, gen_simplejava_BooleanExpression_ConstantExpression, gen_simplejava_StringExpression_ConstantExpression, gen_simplejava_UnaryExpression_GenericExpression, gen_simplejava_ReturnStatement_Statement, gen_simplejava_MethodCall_Statement, gen_simplejava_MethodCall_GenericExpression, gen_simplejava_ConstructorCall_GenericExpression, gen_simplejava_VariableExpression_GenericExpression, gen_simplejava_ParanthesisOrBinaryExpression_GenericExpression},
    metadata=None
)
