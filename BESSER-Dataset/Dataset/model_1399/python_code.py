...
class model_Transition:
    ...
    def __init__(self, name: str, trigger: str, outgoings: "model_AbstractState" = None, model_Transition: "model_AbstractState" = None, Transition: "model_AbstractState" = None):
        self.name = name
...
class model_FiniteStateMachine(AbstractState):
    ...
    def __init__(self, model_FiniteStateMachine: "model_AbstractState" = None, parent: set["model_AbstractState"] = None, FiniteStateMachine: "model_AbstractState" = None, model_FiniteStateMachine5: "model_AbstractState" = None):
...
class model_AbstractState:
    ...
    def __init__(self, name: bool, AbstractState8: "model_Transition" = None, model_AbstractState10: "model_Transition" = None, model_AbstractState: "model_FiniteStateMachine" = None, AbstractState: "model_FiniteStateMachine" = None, states: "model_FiniteStateMachine" = None, source: set["model_Transition"] = None, model_AbstractState6: "model_FiniteStateMachine" = None):
        self.name = name
