...
class types_IdlString(TemplateType):
    ...
    pass
class types_SequenceType(TemplateType, Typed):
...
class types_StructForwardDcl(IdlTypeDcl):
    ...
    pass
class types_StructType(MemberContainer, IdlTypeDcl):

    pass
class types_Enumeration(Declarator, IdlTypeDcl):

    pass
class TypedElement:

    pass
class types_TypeDef(TypedElement, IdlTypeDcl):
