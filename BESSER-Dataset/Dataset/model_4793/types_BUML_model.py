...
types_VoidType = Class(name="types_VoidType")
IdlType = Class(name="IdlType")
types_UnionType = Class(name="types_UnionType")
types_UnionForwardDcl = Class(name="types_UnionForwardDcl")
types_Switch = Class(name="types_Switch")
FileRegion = Class(name="FileRegion")
types_IdlType = Class(name="types_IdlType")
types_Case = Class(name="types_Case")
types_CaseLabel = Class(name="types_CaseLabel", is_abstract=True)
types_ElementSpec = Class(name="types_ElementSpec")
types_DefaultCaseLabel = Class(name="types_DefaultCaseLabel")
CaseLabel = Class(name="CaseLabel")
types_ExprCaseLabel = Class(name="types_ExprCaseLabel")
types_Expression = Class(name="types_Expression")
types_Declarator = Class(name="types_Declarator")
types_TypeDef = Class(name="types_TypeDef")
types_TemplateType = Class(name="types_TemplateType", is_abstract=True)
types_SequenceType = Class(name="types_SequenceType")
TemplateType = Class(name="TemplateType")
Typed = Class(name="Typed")
types_IdlString = Class(name="types_IdlString")
types_WString = Class(name="types_WString")
...
types_Octet = Class(name="types_Octet")
types_Float = Class(name="types_Float")
types_Double = Class(name="types_Double")
types_IdlChar = Class(name="types_IdlChar")
types_IdlWChar = Class(name="types_IdlWChar")
types_WChar = Class(name="types_WChar")
types_Boolean = Class(name="types_Boolean")
types_LongLong = Class(name="types_LongLong")
types_LongDouble = Class(name="types_LongDouble")
types_UShort = Class(name="types_UShort")
types_ULong = Class(name="types_ULong")
types_ULongLong = Class(name="types_ULongLong")
types_Any = Class(name="types_Any")
types_IdlObject = Class(name="types_IdlObject")
types_EnumType = Class(name="types_EnumType")
types_Enumeration = Class(name="types_Enumeration")
types_StructType = Class(name="types_StructType")
MemberContainer = Class(name="MemberContainer")
types_ForwardDcl = Class(name="types_ForwardDcl")
types_StructForwardDcl = Class(name="types_StructForwardDcl")
types_ValueBaseType = Class(name="types_ValueBaseType")
Declarator = Class(name="Declarator")
types_FixedPtType = Class(name="types_FixedPtType")
...
domain_model = DomainModel(
    name="types",
    types={TypedElement, IdlTypeDcl, types_VoidType, IdlType, types_UnionType, types_UnionForwardDcl, types_Switch, FileRegion, types_IdlType, types_Case, types_CaseLabel, types_ElementSpec, types_DefaultCaseLabel, CaseLabel, types_ExprCaseLabel, types_Expression, types_Declarator, types_TypeDef, types_TemplateType, types_SequenceType, TemplateType, Typed, types_IdlString, types_WString, types_PrimitiveType, types_Short, PrimitiveType, types_Long, types_Octet, types_Float, types_Double, types_IdlChar, types_IdlWChar, types_WChar, types_Boolean, types_LongLong, types_LongDouble, types_UShort, types_ULong, types_ULongLong, types_Any, types_IdlObject, types_EnumType, types_Enumeration, types_StructType, MemberContainer, types_ForwardDcl, types_StructForwardDcl, types_ValueBaseType, Declarator, types_FixedPtType},
    associations={forwardDcl0, idlSwitch1, type2, cases4, labels6, spec8, expr10, type11, declarator14, size20, implementation22, enumerators16, forwardDeclaration17, forwardDcl18, implementation23, expr125, expr227},
    generalizations={gen_types_TypeDef_TypedElement, gen_types_TypeDef_IdlTypeDcl, gen_types_VoidType_IdlType, gen_types_UnionType_IdlTypeDcl, gen_types_Switch_FileRegion, gen_types_Case_FileRegion, gen_types_CaseLabel_FileRegion, gen_types_DefaultCaseLabel_CaseLabel, gen_types_ExprCaseLabel_CaseLabel, gen_types_ElementSpec_FileRegion, gen_types_TemplateType_IdlType, gen_types_SequenceType_TemplateType, gen_types_SequenceType_Typed, gen_types_IdlString_TemplateType, gen_types_WString_TemplateType, gen_types_PrimitiveType_IdlType, gen_types_Short_PrimitiveType, gen_types_Long_PrimitiveType, gen_types_Octet_PrimitiveType, gen_types_Float_PrimitiveType, gen_types_Double_PrimitiveType, gen_types_IdlChar_PrimitiveType, gen_types_IdlWChar_PrimitiveType, gen_types_WChar_PrimitiveType, gen_types_Boolean_PrimitiveType, gen_types_LongLong_PrimitiveType, gen_types_LongDouble_PrimitiveType, gen_types_UShort_PrimitiveType, gen_types_ULong_PrimitiveType, gen_types_ULongLong_PrimitiveType, gen_types_Any_PrimitiveType, gen_types_IdlObject_PrimitiveType, gen_types_UnionForwardDcl_IdlTypeDcl, gen_types_StructForwardDcl_IdlTypeDcl, gen_types_EnumType_IdlTypeDcl, gen_types_StructType_IdlTypeDcl, gen_types_StructType_MemberContainer, gen_types_ValueBaseType_PrimitiveType, gen_types_Enumeration_Declarator, gen_types_Enumeration_IdlTypeDcl, gen_types_FixedPtType_TemplateType},
    metadata=None
)
