...
public class Requirement  {
    ...
    public Requirement(
        String requirement_location,        String user_id,        String requirement_type,        String req_description    ) {
    ...
    public Requirement(
        String requirement_location,        String user_id,        String requirement_type,        String req_description        ArrayList<Reg_User> reg_users    ) {
        this.requirement_location = requirement_location;
        this.user_id = user_id;
        this.requirement_type = requirement_type;
        this.req_description = req_description;
