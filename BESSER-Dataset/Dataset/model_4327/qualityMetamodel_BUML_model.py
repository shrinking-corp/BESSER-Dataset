...
QualityMetamodel_MetricProvider.attributes={QualityMetamodel_MetricProvider_id, QualityMetamodel_MetricProvider_name, QualityMetamodel_MetricProvider_description}
...
QualityMetamodel_Value.attributes={QualityMetamodel_Value_description, QualityMetamodel_Value_name}
...
QualityMetamodel_AggregatedValueMetric.attributes={QualityMetamodel_AggregatedValueMetric_average, QualityMetamodel_AggregatedValueMetric_maximum, QualityMetamodel_AggregatedValueMetric_median, QualityMetamodel_AggregatedValueMetric_standardDeviation, QualityMetamodel_AggregatedValueMetric_minimum}
...
domain_model = DomainModel(
    ...
    types={QualityMetamodel_SingleValue, Value, QualityMetamodel_AggregatedValue, QualityMetamodel_Operation, QualityMetamodel_QualityModel, QualityMetamodel_MetricProvider, QualityMetamodel_ValueType, QualityMetamodel_QualityAttribute, QualityMetamodel_Value, QualityMetamodel_TextValueType, ValueType, QualityMetamodel_RangeValueType, QualityMetamodel_AggregatedValueMetric, QualityMetamodel_EnumerationMetric, QualityMetamodel_EnumerationItem, QualityMetamodel_RealValueType, QualityMetamodel_BooleanValueType, QualityMetamodel_IntegerValueType},
    associations={measuredBy15, calculatedBy17, metricProviders0, qualityTypes1, qualityAttributes3, qualityValues5, value7, qualityAttributes11, type13, val14, aggregatedValues18, set21, value22},
