...
# Classes
k5_B = Class(name="k5_B")
C = Class(name="C")
k5_X = Class(name="k5_X")
k5_C = Class(name="k5_C", is_abstract=True)
k5_P = Class(name="k5_P")
k5_Z = Class(name="k5_Z")
k5_Y = Class(name="k5_Y")
k5_W = Class(name="k5_W")
k5_A = Class(name="k5_A")
B = Class(name="B")
J = Class(name="J")
k5_I = Class(name="k5_I")
G = Class(name="G")
k5_G = Class(name="k5_G", is_abstract=True)
k5_M = Class(name="k5_M")
k5_L1 = Class(name="k5_L1")
k5_N = Class(name="k5_N")
M = Class(name="M")
k5_J = Class(name="k5_J")
A = Class(name="A")
N = Class(name="N")
k5_K = Class(name="k5_K")
k5_Q = Class(name="k5_Q")
P = Class(name="P")
k5_L2 = Class(name="k5_L2")
k5_L3 = Class(name="k5_L3")
L1 = Class(name="L1")
...
domain_model = DomainModel(
    name="k5",
    types={k5_B, C, k5_X, k5_C, k5_P, k5_Z, k5_Y, k5_W, k5_A, B, J, k5_I, G, k5_G, k5_M, k5_L1, k5_N, M, k5_J, A, N, k5_K, k5_Q, P, k5_L2, k5_L3, L1},
    associations={xcs0, ps1, zs3, ys5, w7, is_9, y10, mcs13, ml115, a17, ks19, js21, l2s23, l1c24, l1m27, l2q30, l2k33, l3z36},
    generalizations={gen_k5_B_C, gen_k5_A_B, gen_k5_K_J, gen_k5_C_G, gen_k5_M_G, gen_k5_N_M, gen_k5_J_A, gen_k5_P_N, gen_k5_Q_P, gen_k5_I_G, gen_k5_L3_L1},
    metadata=None
)
