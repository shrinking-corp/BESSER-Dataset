...
# Classes
gedcoml_Projectdescription = Class(name="gedcoml_Projectdescription")
gedcoml_FamilyBook = Class(name="gedcoml_FamilyBook")
gedcoml_PostAddress = Class(name="gedcoml_PostAddress")
Address = Class(name="Address")
gedcoml_FamilyImport = Class(name="gedcoml_FamilyImport")
gedcoml_Author = Class(name="gedcoml_Author")
gedcoml_Family = Class(name="gedcoml_Family")
gedcoml_Person = Class(name="gedcoml_Person", is_abstract=True)
gedcoml_BekanntePerson = Class(name="gedcoml_BekanntePerson")
Person = Class(name="Person")
gedcoml_Married = Class(name="gedcoml_Married")
gedcoml_Note = Class(name="gedcoml_Note")
gedcoml_Source = Class(name="gedcoml_Source", is_abstract=True)
gedcoml_Address = Class(name="gedcoml_Address", is_abstract=True)
gedcoml_Others = Class(name="gedcoml_Others")
Source = Class(name="Source")
gedcoml_PersonRef = Class(name="gedcoml_PersonRef")
gedcoml_UnbekanntePerson = Class(name="gedcoml_UnbekanntePerson")
...
gedcoml_Projectdescription.attributes={gedcoml_Projectdescription_artifactId, gedcoml_Projectdescription_groupId, gedcoml_Projectdescription_publishingDate, gedcoml_Projectdescription_version}
...
gedcoml_PostAddress.attributes={gedcoml_PostAddress_postcode, gedcoml_PostAddress_city, gedcoml_PostAddress_street}
...
gedcoml_BekanntePerson.attributes={gedcoml_BekanntePerson_birthName, gedcoml_BekanntePerson_firstName, gedcoml_BekanntePerson_lastName, gedcoml_BekanntePerson_birthDay, gedcoml_BekanntePerson_middleName, gedcoml_BekanntePerson_deathDay}
...
domain_model = DomainModel(
    name="gedcoml",
    types={gedcoml_Projectdescription, gedcoml_FamilyBook, gedcoml_PostAddress, Address, gedcoml_FamilyImport, gedcoml_Author, gedcoml_Family, gedcoml_Person, gedcoml_BekanntePerson, Person, gedcoml_Married, gedcoml_Note, gedcoml_Source, gedcoml_Address, gedcoml_Others, Source, gedcoml_PersonRef, gedcoml_UnbekanntePerson, Sexus},
    associations={project21, importedResource23, imports0, author1, members3, imports4, biologicalParentOf7, biologicalFatherIs9, biologicalMotherIs12, marriedWith15, notes17, sources19, partner26, memberId29, personID32, addresses34},
    generalizations={gen_gedcoml_PostAddress_Address, gen_gedcoml_BekanntePerson_Person, gen_gedcoml_Others_Source, gen_gedcoml_PersonRef_Source, gen_gedcoml_UnbekanntePerson_Person},
    metadata=None
)
