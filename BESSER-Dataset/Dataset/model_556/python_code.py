...
class gedcoml_BekanntePerson(Person):
    ...
    def __init__(self, firstName: str, lastName: str, middleName: str, birthDay: str, deathDay: str, birthName: str, gedcoml_BekanntePerson: set["gedcoml_Person"] = None, gedcoml_BekanntePerson10: "gedcoml_Person" = None, gedcoml_BekanntePerson13: "gedcoml_Person" = None, gedcoml_BekanntePerson16: set["gedcoml_Married"] = None, gedcoml_BekanntePerson18: set["gedcoml_Note"] = None, gedcoml_BekanntePerson20: set["gedcoml_Source"] = None, gedcoml_BekanntePerson31: "gedcoml_Author" = None, gedcoml_BekanntePerson33: "gedcoml_PersonRef" = None):
...
class gedcoml_Person(ABC):
    ...
    def __init__(self, id: str, sex: str, gedcoml_Person8: "gedcoml_BekanntePerson" = None, gedcoml_Person11: "gedcoml_BekanntePerson" = None, gedcoml_Person14: "gedcoml_BekanntePerson" = None, gedcoml_Person28: "gedcoml_Married" = None, gedcoml_Person35: set["gedcoml_Address"] = None, gedcoml_Person: "gedcoml_Family" = None):
        self.id = id
        self.sex = sex
...
class gedcoml_Family:
    ...
    def __init__(self, name: str, gedcoml_Family5: set["gedcoml_FamilyImport"] = None, gedcoml_Family25: "gedcoml_FamilyImport" = None, gedcoml_Family: set["gedcoml_Person"] = None):
        self.name = name
...
class gedcoml_Author:
    ...
    def __init__(self, firstName: str, lastName: str, gedcoml_Author30: "gedcoml_BekanntePerson" = None, gedcoml_Author: "gedcoml_Projectdescription" = None):
        self.firstName = firstName
        self.lastName = lastName
...
class gedcoml_Projectdescription:
    ...
    def __init__(self, groupId: str, artifactId: str, version: str, publishingDate: str, gedcoml_Projectdescription22: "gedcoml_FamilyBook" = None, gedcoml_Projectdescription: set["gedcoml_FamilyImport"] = None, gedcoml_Projectdescription2: "gedcoml_Author" = None):
