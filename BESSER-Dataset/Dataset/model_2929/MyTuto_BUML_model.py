...
# Classes
myTuto_MyTuto = Class(name="myTuto_MyTuto")
myTuto_AbstractElement = Class(name="myTuto_AbstractElement")
myTuto_PackageDeclaration = Class(name="myTuto_PackageDeclaration")
AbstractElement = Class(name="AbstractElement")
myTuto_Import = Class(name="myTuto_Import")
myTuto_Type = Class(name="myTuto_Type")
myTuto_DataType = Class(name="myTuto_DataType")
Type = Class(name="Type")
myTuto_Entity = Class(name="myTuto_Entity")
myTuto_Feature = Class(name="myTuto_Feature")
...
domain_model = DomainModel(
    name="myTuto",
    types={myTuto_MyTuto, myTuto_AbstractElement, myTuto_PackageDeclaration, AbstractElement, myTuto_Import, myTuto_Type, myTuto_DataType, Type, myTuto_Entity, myTuto_Feature},
    associations={elements0, elements1, superType4, features5, type7},
    generalizations={gen_myTuto_PackageDeclaration_AbstractElement, gen_myTuto_Import_AbstractElement, gen_myTuto_Type_AbstractElement, gen_myTuto_DataType_Type, gen_myTuto_Entity_Type},
    metadata=None
)
