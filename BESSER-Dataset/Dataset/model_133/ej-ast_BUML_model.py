...
# Classes
ast_EJElement = Class(name="ast_EJElement", is_abstract=True)
ast_EJBase = Class(name="ast_EJBase", is_abstract=True)
EJElement = Class(name="EJElement")
ast_DocumentationLine = Class(name="ast_DocumentationLine")
ast_AttributeSet = Class(name="ast_AttributeSet")
ast_Expression = Class(name="ast_Expression", is_abstract=True)
ast_Parameter = Class(name="ast_Parameter")
NamedElement = Class(name="NamedElement")
ast_Modifier = Class(name="ast_Modifier")
ast_Variable = Class(name="ast_Variable")
ast_TemplateParameter = Class(name="ast_TemplateParameter")
ast_BehaviorFeature = Class(name="ast_BehaviorFeature")
Feature = Class(name="Feature")
ast_Identifier = Class(name="ast_Identifier")
ast_ClassBlock = Class(name="ast_ClassBlock")
EJBase = Class(name="EJBase")
ast_ClassifierMemberStatement = Class(name="ast_ClassifierMemberStatement", is_abstract=True)
ast_ConstructorStatement = Class(name="ast_ConstructorStatement")
BehaviorFeature = Class(name="BehaviorFeature")
ast_MethodBlock = Class(name="ast_MethodBlock")
ast_EnumLiteral = Class(name="ast_EnumLiteral")
ClassifierMemberStatement = Class(name="ClassifierMemberStatement")
ast_Feature = Class(name="ast_Feature", is_abstract=True)
ast_FieldStatement = Class(name="ast_FieldStatement")
ast_InitStatement = Class(name="ast_InitStatement", is_abstract=True)
ast_InnerClassifier = Class(name="ast_InnerClassifier")
ast_ClassifierStatement = Class(name="ast_ClassifierStatement", is_abstract=True)
ast_InstanceInitStatement = Class(name="ast_InstanceInitStatement")
InitStatement = Class(name="InitStatement")
ast_MethodStatement = Class(name="ast_MethodStatement")
ast_StaticInitStatement = Class(name="ast_StaticInitStatement")
ast_ClassStatement = Class(name="ast_ClassStatement")
ImplemenationClassifierStatement = Class(name="ImplemenationClassifierStatement")
ast_EnumStatement = Class(name="ast_EnumStatement")
ast_ImplemenationClassifierStatement = Class(name="ast_ImplemenationClassifierStatement", is_abstract=True)
ClassifierStatement = Class(name="ClassifierStatement")
ast_InterfaceStatement = Class(name="ast_InterfaceStatement")
ast_ImportStatement = Class(name="ast_ImportStatement")
TopLevelStatement = Class(name="TopLevelStatement")
ast_PackageStatement = Class(name="ast_PackageStatement")
ast_IfStatement = Class(name="ast_IfStatement")
ast_TopLevelStatement = Class(name="ast_TopLevelStatement", is_abstract=True)
ast_IfThenPart = Class(name="ast_IfThenPart")
ast_TopLevelClassifier = Class(name="ast_TopLevelClassifier")
ast_BreakStatement = Class(name="ast_BreakStatement")
JumpStatement = Class(name="JumpStatement")
ast_CatchPart = Class(name="ast_CatchPart")
ast_ConditionalLoop = Class(name="ast_ConditionalLoop", is_abstract=True)
LoopStatement = Class(name="LoopStatement")
ast_ContinueStatement = Class(name="ast_ContinueStatement")
ast_SwitchDefaultPartRef = Class(name="ast_SwitchDefaultPartRef")
ast_DoWhileStatement = Class(name="ast_DoWhileStatement")
ConditionalLoop = Class(name="ConditionalLoop")
ast_ExpressionStatement = Class(name="ast_ExpressionStatement")
MethodContentStatement = Class(name="MethodContentStatement")
ast_ForeachStatement = Class(name="ast_ForeachStatement")
ast_ForStatement = Class(name="ast_ForStatement")
ast_LocalVarStatement = Class(name="ast_LocalVarStatement")
ast_ScopeStatement = Class(name="ast_ScopeStatement", is_abstract=True)
ast_JumpStatement = Class(name="ast_JumpStatement", is_abstract=True)
ast_Label = Class(name="ast_Label")
ast_LabeledStatement = Class(name="ast_LabeledStatement", is_abstract=True)
ast_LoopStatement = Class(name="ast_LoopStatement", is_abstract=True)
LabeledStatement = Class(name="LabeledStatement")
ast_MethodContentStatement = Class(name="ast_MethodContentStatement", is_abstract=True)
ast_MethodClassifier = Class(name="ast_MethodClassifier")
ast_ApplyRoundOp = Class(name="ast_ApplyRoundOp")
ast_SwitchCasePart = Class(name="ast_SwitchCasePart")
SwitchPart = Class(name="SwitchPart")
ast_SwitchDefaultPart = Class(name="ast_SwitchDefaultPart")
ast_SwitchPart = Class(name="ast_SwitchPart", is_abstract=True)
ast_SwitchStatement = Class(name="ast_SwitchStatement")
ast_SynchronizedStatement = Class(name="ast_SynchronizedStatement")
ScopeStatement = Class(name="ScopeStatement")
ast_ThrowStatement = Class(name="ast_ThrowStatement")
ast_TryStatement = Class(name="ast_TryStatement")
ast_WhileStatement = Class(name="ast_WhileStatement")
ast_AccessOp = Class(name="ast_AccessOp")
Expression = Class(name="Expression")
ast_BitwiseXorOp = Class(name="ast_BitwiseXorOp")
ast_BooleanLiteral = Class(name="ast_BooleanLiteral")
Literal = Class(name="Literal")
ast_CastOp = Class(name="ast_CastOp")
ClassifierOp = Class(name="ClassifierOp")
ast_CharacterLiteral = Class(name="ast_CharacterLiteral")
ast_ClassifierOp = Class(name="ast_ClassifierOp")
ast_ApplySquareOp = Class(name="ast_ApplySquareOp")
ast_ConditionalAndOp = Class(name="ast_ConditionalAndOp")
ast_ConditionalOp = Class(name="ast_ConditionalOp")
ast_ArrayConstructor = Class(name="ast_ArrayConstructor")
ast_AssignmentOp = Class(name="ast_AssignmentOp")
AssignmentOperation = Class(name="AssignmentOperation")
ast_AssignmentOperation = Class(name="ast_AssignmentOperation", is_abstract=True)
ast_ConditionalOrOp = Class(name="ast_ConditionalOrOp")
ast_DivideAssignmentOp = Class(name="ast_DivideAssignmentOp")
ast_DivideOp = Class(name="ast_DivideOp")
DivisionOp = Class(name="DivisionOp")
ast_DivisionOp = Class(name="ast_DivisionOp", is_abstract=True)
ast_BinaryOp = Class(name="ast_BinaryOp", is_abstract=True)
ast_BitwiseAndAssignmentOp = Class(name="ast_BitwiseAndAssignmentOp")
ast_BitwiseAndOp = Class(name="ast_BitwiseAndOp")
BinaryOp = Class(name="BinaryOp")
ast_BitwiseComplementOp = Class(name="ast_BitwiseComplementOp")
UnaryOp = Class(name="UnaryOp")
ast_BitwiseOrAssignmentOp = Class(name="ast_BitwiseOrAssignmentOp")
ast_BitwiseOrOp = Class(name="ast_BitwiseOrOp")
ast_BitwiseXorAssignmentOp = Class(name="ast_BitwiseXorAssignmentOp")
ast_IntegerLiteral = Class(name="ast_IntegerLiteral")
ast_InstanceOfOp = Class(name="ast_InstanceOfOp")
ast_LeftShiftAssignmentOp = Class(name="ast_LeftShiftAssignmentOp")
ast_LeftShiftOp = Class(name="ast_LeftShiftOp")
ShiftOp = Class(name="ShiftOp")
ast_LessOrEqualOp = Class(name="ast_LessOrEqualOp")
ast_LessThenOp = Class(name="ast_LessThenOp")
ast_Literal = Class(name="ast_Literal", is_abstract=True)
ast_LogicalComplementOp = Class(name="ast_LogicalComplementOp")
ast_LongIntegerLiteral = Class(name="ast_LongIntegerLiteral")
ast_MinusAssignmentOp = Class(name="ast_MinusAssignmentOp")
ast_MinusOp = Class(name="ast_MinusOp")
ast_MultiplyOp = Class(name="ast_MultiplyOp")
ast_MultiplyAssignmentOp = Class(name="ast_MultiplyAssignmentOp")
ast_NewOp = Class(name="ast_NewOp")
ast_DoubleLiteral = Class(name="ast_DoubleLiteral")
ast_EqualOp = Class(name="ast_EqualOp")
ast_FloatLiteral = Class(name="ast_FloatLiteral")
ast_GreaterOrEqualOp = Class(name="ast_GreaterOrEqualOp")
ast_GreaterThenOp = Class(name="ast_GreaterThenOp")
ast_IdentityOp = Class(name="ast_IdentityOp")
ast_NotEqualOp = Class(name="ast_NotEqualOp")
ast_NullReference = Class(name="ast_NullReference")
ast_PlusAssignmentOp = Class(name="ast_PlusAssignmentOp")
ast_PlusOp = Class(name="ast_PlusOp")
ast_PostfixDecrementOp = Class(name="ast_PostfixDecrementOp")
ast_PostfixIncrementOp = Class(name="ast_PostfixIncrementOp")
ast_PrefixDecrementOp = Class(name="ast_PrefixDecrementOp")
ast_PrefixIncrementOp = Class(name="ast_PrefixIncrementOp")
ast_PrimitiveType = Class(name="ast_PrimitiveType")
ast_RemainderAssignmentOp = Class(name="ast_RemainderAssignmentOp")
ast_RemainderOp = Class(name="ast_RemainderOp")
ast_ReturnStatement = Class(name="ast_ReturnStatement")
ast_RightShiftAssignmentOp = Class(name="ast_RightShiftAssignmentOp")
ast_RightShiftOp = Class(name="ast_RightShiftOp")
ast_ShiftOp = Class(name="ast_ShiftOp", is_abstract=True)
ast_StringLiteral = Class(name="ast_StringLiteral")
ast_UnaryMinusOp = Class(name="ast_UnaryMinusOp")
ast_UnaryOp = Class(name="ast_UnaryOp", is_abstract=True)
ast_UnaryPlusOp = Class(name="ast_UnaryPlusOp")
ast_ZeroExtensionRightShiftAssignmentOp = Class(name="ast_ZeroExtensionRightShiftAssignmentOp")
ast_ZeroExtensionRightShiftOp = Class(name="ast_ZeroExtensionRightShiftOp")
ast_NamedElement = Class(name="ast_NamedElement", is_abstract=True)
ast_AssertStatement = Class(name="ast_AssertStatement")
ast_RangeExpression = Class(name="ast_RangeExpression")
ast_WildcardType = Class(name="ast_WildcardType")
ast_SuperReference = Class(name="ast_SuperReference")
ast_ThisReference = Class(name="ast_ThisReference")
ast_EmptyStatement = Class(name="ast_EmptyStatement")
ast_AttributeDefinition = Class(name="ast_AttributeDefinition")
...
ast_EJElement.attributes={ast_EJElement_startOffset, ast_EJElement_startColumn, ast_EJElement_endLine, ast_EJElement_startLine, ast_EJElement_endOffset, ast_EJElement_endColumn}
...
ast_Identifier.attributes={ast_Identifier_escapedValue, ast_Identifier_value, ast_Identifier_quotedValue}
...
domain_model = DomainModel(
    name="ast",
    types={ast_EJElement, ast_EJBase, EJElement, ast_DocumentationLine, ast_AttributeSet, ast_Expression, ast_Parameter, NamedElement, ast_Modifier, ast_Variable, ast_TemplateParameter, ast_BehaviorFeature, Feature, ast_Identifier, ast_ClassBlock, EJBase, ast_ClassifierMemberStatement, ast_ConstructorStatement, BehaviorFeature, ast_MethodBlock, ast_EnumLiteral, ClassifierMemberStatement, ast_Feature, ast_FieldStatement, ast_InitStatement, ast_InnerClassifier, ast_ClassifierStatement, ast_InstanceInitStatement, InitStatement, ast_MethodStatement, ast_StaticInitStatement, ast_ClassStatement, ImplemenationClassifierStatement, ast_EnumStatement, ast_ImplemenationClassifierStatement, ClassifierStatement, ast_InterfaceStatement, ast_ImportStatement, TopLevelStatement, ast_PackageStatement, ast_IfStatement, ast_TopLevelStatement, ast_IfThenPart, ast_TopLevelClassifier, ast_BreakStatement, JumpStatement, ast_CatchPart, ast_ConditionalLoop, LoopStatement, ast_ContinueStatement, ast_SwitchDefaultPartRef, ast_DoWhileStatement, ConditionalLoop, ast_ExpressionStatement, MethodContentStatement, ast_ForeachStatement, ast_ForStatement, ast_LocalVarStatement, ast_ScopeStatement, ast_JumpStatement, ast_Label, ast_LabeledStatement, ast_LoopStatement, LabeledStatement, ast_MethodContentStatement, ast_MethodClassifier, ast_ApplyRoundOp, ast_SwitchCasePart, SwitchPart, ast_SwitchDefaultPart, ast_SwitchPart, ast_SwitchStatement, ast_SynchronizedStatement, ScopeStatement, ast_ThrowStatement, ast_TryStatement, ast_WhileStatement, ast_AccessOp, Expression, ast_BitwiseXorOp, ast_BooleanLiteral, Literal, ast_CastOp, ClassifierOp, ast_CharacterLiteral, ast_ClassifierOp, ast_ApplySquareOp, ast_ConditionalAndOp, ast_ConditionalOp, ast_ArrayConstructor, ast_AssignmentOp, AssignmentOperation, ast_AssignmentOperation, ast_ConditionalOrOp, ast_DivideAssignmentOp, ast_DivideOp, DivisionOp, ast_DivisionOp, ast_BinaryOp, ast_BitwiseAndAssignmentOp, ast_BitwiseAndOp, BinaryOp, ast_BitwiseComplementOp, UnaryOp, ast_BitwiseOrAssignmentOp, ast_BitwiseOrOp, ast_BitwiseXorAssignmentOp, ast_IntegerLiteral, ast_InstanceOfOp, ast_LeftShiftAssignmentOp, ast_LeftShiftOp, ShiftOp, ast_LessOrEqualOp, ast_LessThenOp, ast_Literal, ast_LogicalComplementOp, ast_LongIntegerLiteral, ast_MinusAssignmentOp, ast_MinusOp, ast_MultiplyOp, ast_MultiplyAssignmentOp, ast_NewOp, ast_DoubleLiteral, ast_EqualOp, ast_FloatLiteral, ast_GreaterOrEqualOp, ast_GreaterThenOp, ast_IdentityOp, ast_NotEqualOp, ast_NullReference, ast_PlusAssignmentOp, ast_PlusOp, ast_PostfixDecrementOp, ast_PostfixIncrementOp, ast_PrefixDecrementOp, ast_PrefixIncrementOp, ast_PrimitiveType, ast_RemainderAssignmentOp, ast_RemainderOp, ast_ReturnStatement, ast_RightShiftAssignmentOp, ast_RightShiftOp, ast_ShiftOp, ast_StringLiteral, ast_UnaryMinusOp, ast_UnaryOp, ast_UnaryPlusOp, ast_ZeroExtensionRightShiftAssignmentOp, ast_ZeroExtensionRightShiftOp, ast_NamedElement, ast_AssertStatement, ast_RangeExpression, ast_WildcardType, ast_SuperReference, ast_ThisReference, ast_EmptyStatement, ast_AttributeDefinition},
    associations={documentation0, attributeSets1, attributes3, finalModifier5, classifier6, initialValue9, extendedTypes11, superToTypes13, visibilityModifier36, staticModifier38, finalModifier41, exceptions16, name18, parameters20, templateParameters23, content26, body27, args28, name30, body33, visibilityModifier78, templateParameters81, contents84, transientModifier44, volatileModifier46, classifier49, variables52, body55, classifier57, body58, returnType60, abstractModifier63, synchronizedModifier66, nativeModifier69, strictfpModifier72, name75, staticModifier87, extendedType89, implementedTypes92, strictfpModifier95, abstractModifier97, finalModifier100, extendedTypes103, staticModifier105, allModifier107, importedPackage110, updateExpressions145, classifier115, name113, specification117, body119, condition122, defaultLabel124, caseValue125, expression128, parameter130, collection132, initial135, limit138, initVariableDeclaration141, initExpressions142, classifier174, ifThenPart148, elsePart149, condition152, body155, label158, label159, finalModifier161, variables164, classifier167, body170, content172, functor201, args203, body176, values178, body180, value182, parts184, value187, exception189, finallyPart191, catchPart193, accessed196, feature198, value223, classifier225, functor206, args208, condition228, thenPart230, values211, elsePart233, leftHandSide213, value215, dividend236, divisor238, value1218, value2220, value241, minuend243, subtrahend245, multipliers248, classifier250, args252, summands261, value263, value265, distance267, classBody255, arrayConstructor258, value270, name272, test274, message276, initial279, limit281, superToTypes284, extendedTypes286},
    generalizations={gen_ast_Modifier_EJElement, gen_ast_DocumentationLine_EJElement, gen_ast_EJBase_EJElement, gen_ast_AttributeSet_EJElement, gen_ast_Parameter_NamedElement, gen_ast_Variable_NamedElement, gen_ast_TemplateParameter_NamedElement, gen_ast_BehaviorFeature_Feature, gen_ast_ClassBlock_EJBase, gen_ast_ClassifierMemberStatement_EJBase, gen_ast_ConstructorStatement_BehaviorFeature, gen_ast_EnumLiteral_ClassifierMemberStatement, gen_ast_Feature_ClassifierMemberStatement, gen_ast_FieldStatement_Feature, gen_ast_InitStatement_ClassifierMemberStatement, gen_ast_InnerClassifier_ClassifierMemberStatement, gen_ast_InstanceInitStatement_InitStatement, gen_ast_MethodStatement_BehaviorFeature, gen_ast_StaticInitStatement_InitStatement, gen_ast_ClassifierStatement_EJBase, gen_ast_TopLevelClassifier_TopLevelStatement, gen_ast_ClassStatement_ImplemenationClassifierStatement, gen_ast_EnumStatement_ImplemenationClassifierStatement, gen_ast_ImplemenationClassifierStatement_ClassifierStatement, gen_ast_InterfaceStatement_ClassifierStatement, gen_ast_ImportStatement_TopLevelStatement, gen_ast_PackageStatement_TopLevelStatement, gen_ast_IfStatement_MethodContentStatement, gen_ast_TopLevelStatement_EJBase, gen_ast_BreakStatement_JumpStatement, gen_ast_CatchPart_EJBase, gen_ast_ConditionalLoop_LoopStatement, gen_ast_ContinueStatement_JumpStatement, gen_ast_DoWhileStatement_ConditionalLoop, gen_ast_ExpressionStatement_MethodContentStatement, gen_ast_ForeachStatement_LoopStatement, gen_ast_ForStatement_ConditionalLoop, gen_ast_MethodContentStatement_EJBase, gen_ast_ScopeStatement_MethodContentStatement, gen_ast_IfThenPart_EJBase, gen_ast_JumpStatement_MethodContentStatement, gen_ast_Label_EJElement, gen_ast_LabeledStatement_MethodContentStatement, gen_ast_LocalVarStatement_MethodContentStatement, gen_ast_LoopStatement_LabeledStatement, gen_ast_MethodBlock_MethodContentStatement, gen_ast_MethodClassifier_MethodContentStatement, gen_ast_ApplyRoundOp_Expression, gen_ast_SwitchCasePart_SwitchPart, gen_ast_SwitchDefaultPart_SwitchPart, gen_ast_SwitchPart_EJBase, gen_ast_SwitchStatement_LabeledStatement, gen_ast_SynchronizedStatement_ScopeStatement, gen_ast_ThrowStatement_MethodContentStatement, gen_ast_TryStatement_ScopeStatement, gen_ast_WhileStatement_ConditionalLoop, gen_ast_AccessOp_Expression, gen_ast_BitwiseXorOp_BinaryOp, gen_ast_BooleanLiteral_Literal, gen_ast_CastOp_ClassifierOp, gen_ast_CharacterLiteral_Literal, gen_ast_ClassifierOp_Expression, gen_ast_ApplySquareOp_Expression, gen_ast_ConditionalAndOp_BinaryOp, gen_ast_ConditionalOp_Expression, gen_ast_ArrayConstructor_Expression, gen_ast_AssignmentOp_AssignmentOperation, gen_ast_AssignmentOperation_Expression, gen_ast_ConditionalOrOp_BinaryOp, gen_ast_DivideAssignmentOp_AssignmentOperation, gen_ast_DivideOp_DivisionOp, gen_ast_DivisionOp_Expression, gen_ast_BinaryOp_Expression, gen_ast_BitwiseAndAssignmentOp_AssignmentOperation, gen_ast_BitwiseAndOp_BinaryOp, gen_ast_BitwiseComplementOp_UnaryOp, gen_ast_BitwiseOrAssignmentOp_AssignmentOperation, gen_ast_BitwiseOrOp_BinaryOp, gen_ast_BitwiseXorAssignmentOp_AssignmentOperation, gen_ast_IntegerLiteral_Literal, gen_ast_InstanceOfOp_ClassifierOp, gen_ast_LeftShiftAssignmentOp_AssignmentOperation, gen_ast_LeftShiftOp_ShiftOp, gen_ast_LessOrEqualOp_BinaryOp, gen_ast_LessThenOp_BinaryOp, gen_ast_Literal_Expression, gen_ast_LogicalComplementOp_UnaryOp, gen_ast_LongIntegerLiteral_Literal, gen_ast_MinusAssignmentOp_AssignmentOperation, gen_ast_MinusOp_Expression, gen_ast_MultiplyOp_Expression, gen_ast_MultiplyAssignmentOp_AssignmentOperation, gen_ast_NewOp_Expression, gen_ast_DoubleLiteral_Literal, gen_ast_EqualOp_BinaryOp, gen_ast_FloatLiteral_Literal, gen_ast_GreaterOrEqualOp_BinaryOp, gen_ast_GreaterThenOp_BinaryOp, gen_ast_Identifier_Expression, gen_ast_IdentityOp_Expression, gen_ast_NotEqualOp_BinaryOp, gen_ast_NullReference_Literal, gen_ast_PlusAssignmentOp_AssignmentOperation, gen_ast_PlusOp_Expression, gen_ast_PostfixDecrementOp_UnaryOp, gen_ast_PostfixIncrementOp_UnaryOp, gen_ast_PrefixDecrementOp_UnaryOp, gen_ast_PrefixIncrementOp_UnaryOp, gen_ast_PrimitiveType_Expression, gen_ast_RemainderAssignmentOp_AssignmentOperation, gen_ast_RemainderOp_DivisionOp, gen_ast_ReturnStatement_MethodContentStatement, gen_ast_RightShiftAssignmentOp_AssignmentOperation, gen_ast_RightShiftOp_ShiftOp, gen_ast_ShiftOp_Expression, gen_ast_StringLiteral_Literal, gen_ast_UnaryMinusOp_UnaryOp, gen_ast_UnaryOp_Expression, gen_ast_UnaryPlusOp_UnaryOp, gen_ast_ZeroExtensionRightShiftAssignmentOp_AssignmentOperation, gen_ast_Expression_EJBase, gen_ast_ZeroExtensionRightShiftOp_ShiftOp, gen_ast_NamedElement_EJBase, gen_ast_AssertStatement_MethodContentStatement, gen_ast_RangeExpression_Expression, gen_ast_SwitchDefaultPartRef_EJElement, gen_ast_WildcardType_Expression, gen_ast_SuperReference_Expression, gen_ast_ThisReference_Expression, gen_ast_EmptyStatement_MethodContentStatement, gen_ast_AttributeDefinition_ClassifierStatement},
    metadata=None
)
