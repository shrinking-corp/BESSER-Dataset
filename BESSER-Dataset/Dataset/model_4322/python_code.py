...
class metric_ConstraintMetric(Metric):
    ...
    def __init__(self, expressionCount: int, expressionDepth: int, calledOperations: str, calledProperties: str, numberOfIfExpressions: int, numberOfLetExpressions: int, usedIterators: str, usedLiterals: str, metric_ConstraintMetric4: "metric_Constraint" = None, metric_ConstraintMetric: "metric_ConstraintMetrics" = None):
    ...
    @property
    def numberOfLetExpressions(self):
    ...
    @property
    def numberOfIfExpressions(self):
...
class metric_ConstraintMetrics(ConstraintMetric):
    ...
    def __init__(self, numberOfConstraintsByKind: str, metric_ConstraintMetrics: set["metric_ConstraintMetric"] = None, metric_ConstraintMetrics2: set["metric_Constraint"] = None):
        ...
        pass
    @property
    def numberOfConstraintsByKind(self):
    ...
    def getMeanExpressionDepth(self) :
        # TODO: Implement getMeanExpressionDepth method
        pass

    def getAvgExpressionDepth(self) :
    ...
    def getMinExpressionCount(self) :
        # TODO: Implement getMinExpressionCount method
        pass

    def getMaxExpressionCount(self) :
