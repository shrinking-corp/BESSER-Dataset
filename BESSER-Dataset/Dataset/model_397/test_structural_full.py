...
def test_assoc_inheritedMember0_link_reassign_clear():
...
def test_assoc_member3_link_reassign_clear():
    a = UML2_NamedElement(visibility="sample_text")
    b1 = UML2_Namespace()
    b2 = UML2_Namespace()
    _safe_set(a, 'UML2_NamedElement4', b1)
    assert _is_linked(a, 'UML2_NamedElement4', b1)
    if hasattr(b1, 'UML2_Namespace'):
        assert _is_linked(b1, 'UML2_Namespace', a)
    _safe_set(a, 'UML2_NamedElement4', b2)
    assert _is_linked(a, 'UML2_NamedElement4', b2)
    if hasattr(b1, 'UML2_Namespace'):
        assert not _is_linked(b1, 'UML2_Namespace', a)
    if hasattr(b2, 'UML2_Namespace'):
        assert _is_linked(b2, 'UML2_Namespace', a)
    _safe_set(a, 'UML2_NamedElement4', None)
    assert not _is_linked(a, 'UML2_NamedElement4', b2)
    if hasattr(b2, 'UML2_Namespace'):
