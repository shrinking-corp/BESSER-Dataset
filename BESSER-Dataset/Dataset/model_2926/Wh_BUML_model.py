...
# Classes
wh_Import = Class(name="wh_Import")
wh_Type = Class(name="wh_Type")
wh_DataType = Class(name="wh_DataType")
Type = Class(name="Type")
wh_Entity = Class(name="wh_Entity")
wh_Feature = Class(name="wh_Feature")
wh_Wh = Class(name="wh_Wh")
wh_AbstractElement = Class(name="wh_AbstractElement")
wh_PackageDeclaration = Class(name="wh_PackageDeclaration")
...
wh_Feature.attributes={wh_Feature_many, wh_Feature_name}
...
domain_model = DomainModel(
    name="wh",
    types={wh_Import, wh_Type, wh_DataType, Type, wh_Entity, wh_Feature, wh_Wh, wh_AbstractElement, wh_PackageDeclaration, AbstractElement},
    associations={superType4, features5, type7, elements0, elements1},
