...
def test_hyp_wh_packagedeclaration_is_not_abstract():
    assert not inspect.isabstract(wh_PackageDeclaration)


def test_hyp_wh_packagedeclaration_constructor_exists():
    assert callable(wh_PackageDeclaration.__init__)


def test_hyp_wh_packagedeclaration_constructor_args():
...
def test_hyp_wh_abstractelement_is_not_abstract():
    assert not inspect.isabstract(wh_AbstractElement)


def test_hyp_wh_abstractelement_constructor_exists():
    assert callable(wh_AbstractElement.__init__)


def test_hyp_wh_abstractelement_constructor_args():
...
def test_hyp_wh_feature_is_not_abstract():
    assert not inspect.isabstract(wh_Feature)


def test_hyp_wh_feature_constructor_exists():
    assert callable(wh_Feature.__init__)


def test_hyp_wh_feature_constructor_args():
...
def test_hyp_wh_entity_is_not_abstract():
    assert not inspect.isabstract(wh_Entity)


def test_hyp_wh_entity_constructor_exists():
    assert callable(wh_Entity.__init__)


def test_hyp_wh_entity_constructor_args():
    sig = inspect.signature(wh_Entity.__init__)
    params = list(sig.parameters.keys())



def test_hyp_wh_datatype_is_not_abstract():
    assert not inspect.isabstract(wh_DataType)


def test_hyp_wh_datatype_constructor_exists():
    assert callable(wh_DataType.__init__)


def test_hyp_wh_datatype_constructor_args():
    sig = inspect.signature(wh_DataType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_wh_type_is_not_abstract():
    assert not inspect.isabstract(wh_Type)


def test_hyp_wh_type_constructor_exists():
    assert callable(wh_Type.__init__)


def test_hyp_wh_type_constructor_args():
...
def test_hyp_wh_import_is_not_abstract():
    assert not inspect.isabstract(wh_Import)


def test_hyp_wh_import_constructor_exists():
    assert callable(wh_Import.__init__)


def test_hyp_wh_import_constructor_args():
...
def test_hyp_wh_packagedeclaration_name_setter(instance):
...
def test_hyp_wh_feature_many_setter(instance):
...
@given(instance=wh_Feature_strategy)
def test_hyp_wh_feature_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_wh_type_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_wh_import_importedNamespace_setter(instance):
