...
mypackage_Login.attributes={mypackage_Login_password, mypackage_Login_securityAnswer, mypackage_Login_lastLoginTime, mypackage_Login_securityQuestion, mypackage_Login_username}
...
mypackage_Customer.attributes={mypackage_Customer_emailAddress, mypackage_Customer_phoneNumber, mypackage_Customer_address, mypackage_Customer_dateOfBirth, mypackage_Customer_name}
...
transaction_Transaction.attributes={transaction_Transaction_transactionTime, transaction_Transaction_amount, transaction_Transaction_type, transaction_Transaction_id}
...
domain_model = DomainModel(
    name="b56d06f2_e6dc_416c_9b83_747cf894adaa",
    types={transaction_TransferTransaction, account_SavingsAccount, account_CertificatesOfDepositAccount, account_CheckingAccount, account_Account, mypackage_Login, mypackage_Customer, transaction_Transaction, transaction_DepositTransaction, transaction_WithdrawTransaction, transaction_TransactionType, account_AccountType},
