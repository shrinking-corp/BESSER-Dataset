...
public class mypackage_Customer  {
    ...
    public mypackage_Customer(
        String emailAddress,        String address,        String phoneNumber,        LocalDate dateOfBirth,        String name    ) {
    ...
    public mypackage_Customer(
        String emailAddress,        String address,        String phoneNumber,        LocalDate dateOfBirth,        String name        ArrayList<account_Account> account_accounts    ) {
        this.emailAddress = emailAddress;
        this.address = address;
        this.phoneNumber = phoneNumber;
        this.dateOfBirth = dateOfBirth;
