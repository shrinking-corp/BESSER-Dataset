...
# Classes
dronesStructure_DronesStructure = Class(name="dronesStructure_DronesStructure")
dronesStructure_Scenario = Class(name="dronesStructure_Scenario")
dronesStructure_DroneType = Class(name="dronesStructure_DroneType")
dronesStructure_CooperativeAction = Class(name="dronesStructure_CooperativeAction")
dronesStructure_Capability = Class(name="dronesStructure_Capability")
NamedElement = Class(name="NamedElement")
dronesStructure_Drone = Class(name="dronesStructure_Drone")
dronesStructure_ScenarioBounds = Class(name="dronesStructure_ScenarioBounds")
dronesStructure_Obstacle = Class(name="dronesStructure_Obstacle")
dronesStructure_Region = Class(name="dronesStructure_Region")
dronesStructure_Task = Class(name="dronesStructure_Task")
dronesStructure_ProvidedCapability = Class(name="dronesStructure_ProvidedCapability")
dronesStructure_Dimension = Class(name="dronesStructure_Dimension")
dronesStructure_MovementCapability = Class(name="dronesStructure_MovementCapability")
Capability = Class(name="Capability")
dronesStructure_Role = Class(name="dronesStructure_Role")
dronesStructure_RequiredCapability = Class(name="dronesStructure_RequiredCapability")
dronesStructure_Position = Class(name="dronesStructure_Position")
dronesStructure_AABB = Class(name="dronesStructure_AABB", is_abstract=True)
AABB = Class(name="AABB")
dronesStructure_Charger = Class(name="dronesStructure_Charger")
Region = Class(name="Region")
dronesStructure_NamedElement = Class(name="dronesStructure_NamedElement", is_abstract=True)
dronesStructure_ScanningCapability = Class(name="dronesStructure_ScanningCapability")
...
dronesStructure_Scenario.attributes={dronesStructure_Scenario_maximumCommunicationDistance, dronesStructure_Scenario_safeCommunicationDistance}
...
dronesStructure_DroneType.attributes={dronesStructure_DroneType_maxBatteryCapacity, dronesStructure_DroneType_idleEneryConsumption, dronesStructure_DroneType_weight}
...
dronesStructure_ProvidedCapability.attributes={dronesStructure_ProvidedCapability_maximalValue, dronesStructure_ProvidedCapability_energyConsumptionPerValue}
...
dronesStructure_Dimension.attributes={dronesStructure_Dimension_depth, dronesStructure_Dimension_height, dronesStructure_Dimension_width}
...
dronesStructure_Position.attributes={dronesStructure_Position_x, dronesStructure_Position_y, dronesStructure_Position_z}
