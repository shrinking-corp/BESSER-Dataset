...
class dronesStructure_Position:
    ...
    def __init__(self, x: float, y: float, z: float, dronesStructure_Position42: "dronesStructure_AABB" = None, dronesStructure_Position: "dronesStructure_Drone" = None):
        self.x = x
        self.y = y
        self.z = z
...
class dronesStructure_Dimension:
    ...
    def __init__(self, depth: float, width: float, height: float, dronesStructure_Dimension: "dronesStructure_DroneType" = None, dronesStructure_Dimension45: "dronesStructure_AABB" = None):
        self.depth = depth
        self.width = width
        self.height = height
...
class dronesStructure_ProvidedCapability:
    ...
    def __init__(self, maximalValue: float, energyConsumptionPerValue: float, ProvidedCapability: "dronesStructure_DroneType" = None, dronesStructure_ProvidedCapability: "dronesStructure_DroneType" = None, dronesStructure_ProvidedCapability24: "dronesStructure_DroneType" = None, dronesStructure_ProvidedCapability26: "dronesStructure_Capability" = None, providedCapabilities: "dronesStructure_DroneType" = None):
        ...
        pass
    @property
    def energyConsumptionPerValue(self):
...
class NamedElement:
    ...
    pass
class dronesStructure_Obstacle(AABB, NamedElement):

    pass
class dronesStructure_Role(NamedElement):

    pass
class dronesStructure_Region(AABB, NamedElement):
...
class dronesStructure_DroneType(NamedElement):
    ...
    def __init__(self, weight: float, maxBatteryCapacity: float, idleEneryConsumption: float, dronesStructure_DroneType: "dronesStructure_DronesStructure" = None, droneType: set["dronesStructure_ProvidedCapability"] = None, dronesStructure_DroneType19: "dronesStructure_ProvidedCapability" = None, dronesStructure_DroneType21: "dronesStructure_Dimension" = None, dronesStructure_DroneType23: "dronesStructure_ProvidedCapability" = None, DroneType: "dronesStructure_ProvidedCapability" = None, dronesStructure_DroneType40: "dronesStructure_Drone" = None):
        self.weight = weight
...
class dronesStructure_Scenario(NamedElement):
    ...
    def __init__(self, safeCommunicationDistance: float, maximumCommunicationDistance: float, dronesStructure_Scenario: "dronesStructure_DronesStructure" = None, dronesStructure_Scenario8: set["dronesStructure_Drone"] = None, dronesStructure_Scenario10: "dronesStructure_ScenarioBounds" = None, dronesStructure_Scenario12: set["dronesStructure_Obstacle"] = None, dronesStructure_Scenario14: set["dronesStructure_Region"] = None, dronesStructure_Scenario16: set["dronesStructure_Task"] = None):
        ...
        pass
    @property
    def safeCommunicationDistance(self):
    ...
    @property
    def maximumCommunicationDistance(self):
