...
def test_hyp_hutnarticlefamilies_family_is_not_abstract():
    assert not inspect.isabstract(hutnArticleFamilies_Family)


def test_hyp_hutnarticlefamilies_family_constructor_exists():
    assert callable(hutnArticleFamilies_Family.__init__)


def test_hyp_hutnarticlefamilies_family_constructor_args():
...
def test_hyp_hutnarticlefamilies_person_is_not_abstract():
    assert not inspect.isabstract(hutnArticleFamilies_Person)


def test_hyp_hutnarticlefamilies_person_constructor_exists():
    assert callable(hutnArticleFamilies_Person.__init__)


def test_hyp_hutnarticlefamilies_person_constructor_args():
...
def test_hyp_hutnarticlefamilies_family_name_setter(instance):
...
@given(instance=hutnArticleFamilies_Family_strategy)
def test_hyp_hutnarticlefamilies_family_nuclear_setter(instance):
...
@given(instance=hutnArticleFamilies_Family_strategy)
def test_hyp_hutnarticlefamilies_family_migrant_setter(instance):
...
@given(instance=hutnArticleFamilies_Family_strategy)
def test_hyp_hutnarticlefamilies_family_lotteryNumbers_setter(instance):
...
def test_hyp_hutnarticlefamilies_person_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
