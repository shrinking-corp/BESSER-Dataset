...
# Classes
hutnArticleFamilies_Person = Class(name="hutnArticleFamilies_Person")
hutnArticleFamilies_Family = Class(name="hutnArticleFamilies_Family")
...
hutnArticleFamilies_Family.attributes={hutnArticleFamilies_Family_nuclear, hutnArticleFamilies_Family_lotteryNumbers, hutnArticleFamilies_Family_migrant, hutnArticleFamilies_Family_name}
...
domain_model = DomainModel(
    ...
    types={hutnArticleFamilies_Person, hutnArticleFamilies_Family},
