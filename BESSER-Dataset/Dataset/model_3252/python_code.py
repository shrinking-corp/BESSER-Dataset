...
class cmof_OpaqueExpression(ValueSpecification):
    ...
    def language_body_size(self, cmof_diagnostics, cmof_context) :
...
class cmof_Constraint(PackageableElement):
    ...
    def value_specification_boolean(self, cmof_diagnostics, cmof_context) :
        # TODO: Implement value_specification_boolean method
        pass

class cmof_InstanceSpecification(PackageableElement):

    def __init__(self, cmof_InstanceSpecification: set["cmof_Classifier"] = None, owningInstance: set["cmof_Slot"] = None, InstanceSpecification: "cmof_Slot" = None, cmof_InstanceSpecification171: "cmof_InstanceValue" = None, cmof_InstanceSpecification161: "cmof_ValueSpecification" = None):
...
class cmof_Type(PackageableElement):
    ...
    def __init__(self, Type: "cmof_Package" = None, cmof_Type: "cmof_TypedElement" = None, ownedType_one: "cmof_Package" = None, cmof_Type121: "cmof_Operation" = None, cmof_Type128: "cmof_BehavioralFeature" = None, cmof_Type146: "cmof_Association" = None):
        self.Type = Type
...
class cmof_Generalization(DirectedRelationship):
    ...
    def __init__(self, isSubstitutable: str, cmof_Generalization: "cmof_Classifier" = None, generalization: "cmof_Classifier" = None, Generalization: "cmof_Classifier" = None):
...
class cmof_Operation(BehavioralFeature):
    ...
    def __init__(self, isOrdered: str, upper: str, isQuery: str, isUnique: str, lower: str, Operation: "cmof_Class" = None, cmof_Operation: "cmof_Constraint" = None, ownedOperation: "cmof_DataType" = None, cmof_Operation118: "cmof_Operation" = None, cmof_Operation116: set["cmof_Operation"] = None, cmof_Operation120: "cmof_Type" = None, ownedOperation123: "cmof_Class" = None, cmof_Operation111: set["cmof_Constraint"] = None, cmof_Operation114: set["cmof_Constraint"] = None, cmof_Operation134: "cmof_Parameter" = None, Operation144: "cmof_DataType" = None):
    ...
    def at_most_one_return(self, cmof_context, cmof_diagnostics) :
...
class cmof_Package(PackageableElement, Namespace):
    ...
    def __init__(self, URI: str, package: set["cmof_Type"] = None, Package61: "cmof_Package" = None, nestedPackage_one: "cmof_Package" = None, cmof_Package95: "cmof_PackageImport" = None, cmof_Package99: "cmof_PackageMerge" = None, Package101: "cmof_PackageMerge" = None, Package58: "cmof_Package" = None, nestingPackage: set["cmof_Package"] = None, Package: "cmof_Type" = None, receivingPackage: set["cmof_PackageMerge"] = None, cmof_Package: set["cmof_PackageableElement"] = None, cmof_Package181: "cmof_Factory" = None):
        self.URI = URI
...
class cmof_Namespace(NamedElement):
    ...
    def __init__(self, importingNamespace: set["cmof_ElementImport"] = None, cmof_Namespace: set["cmof_PackageableElement"] = None, cmof_Namespace69: set["cmof_NamedElement"] = None, namespace: set["cmof_NamedElement"] = None, context: set["cmof_Constraint"] = None, importingNamespace74: set["cmof_PackageImport"] = None, Namespace78: "cmof_ElementImport" = None, Namespace92: "cmof_Constraint" = None, Namespace97: "cmof_PackageImport" = None, Namespace: "cmof_NamedElement" = None):
...
class cmof_Classifier(Type, RedefinableElement, Namespace):
    ...
    def non_final_parents(self, cmof_diagnostics, cmof_context) :
...
class cmof_Factory(Element):
    ...
    def convertToString(self, cmof_dataType, cmof_object) :
    ...
    def createElement(self, cmof_arguments, cmof_class_) :
...
class cmof_MultiplicityElement(Element):
    ...
    def upper_ge_lower(self, cmof_diagnostics, cmof_context) :
    ...
    def lower_ge_0(self, cmof_context, cmof_diagnostics) :
    ...
    def value_specification_no_side_effects(self, cmof_context, cmof_diagnostics) :
...
class cmof_NamedElement(Element):
    ...
    def __init__(self, name: str, qualifiedName: str, visibility: str, cmof_NamedElement70: "cmof_Namespace" = None, NamedElement: "cmof_Namespace" = None, ownedMember: "cmof_Namespace" = None, cmof_NamedElement: "cmof_Classifier" = None):
        self.name = name
    ...
    def isDistinguishableFrom(self, cmof_n, cmof_ns) :
    ...
    def has_no_qualified_name(self, cmof_diagnostics, cmof_context) :
...
class cmof_Association(Classifier, Relationship):
    ...
    def __init__(self, isDerived: str, Association5: "cmof_Property" = None, Association: "cmof_Property" = None, cmof_Association179: "cmof_Link" = None, cmof_Association: set["cmof_Type"] = None, cmof_Association148: set["cmof_Property"] = None, owningAssociation: set["cmof_Property"] = None, association: set["cmof_Property"] = None):
...
class cmof_ValueSpecification(PackageableElement, TypedElement):
    ...
    def __init__(self, cmof_ValueSpecification: "cmof_Property" = None, cmof_ValueSpecification90: "cmof_Constraint" = None, cmof_ValueSpecification166: "cmof_Slot" = None, cmof_ValueSpecification169: "cmof_Expression" = None, cmof_ValueSpecification131: "cmof_Parameter" = None, cmof_ValueSpecification136: "cmof_MultiplicityElement" = None, cmof_ValueSpecification139: "cmof_MultiplicityElement" = None, cmof_ValueSpecification162: "cmof_InstanceSpecification" = None):
...
class cmof_Class(Classifier):
    ...
    def __init__(self, Class: "cmof_Property" = None, cmof_Class: "cmof_Element" = None, cmof_Class41: "cmof_Class" = None, cmof_Class39: set["cmof_Class"] = None, cmof_Class34: set["cmof_Classifier"] = None, class_: set["cmof_Property"] = None, class_38: set["cmof_Operation"] = None, Class124: "cmof_Operation" = None):
        self.Class = Class
...
class cmof_Property(StructuralFeature):
    ...
    def __init__(self, default: str, isComposite: str, isDerived: str, isDerivedUnion: str, isID: str, aggregation: str, ownedAttribute: "cmof_Class" = None, ownedEnd: "cmof_Association" = None, cmof_Property: "cmof_ValueSpecification" = None, cmof_Property9: "cmof_Property" = None, cmof_Property7: "cmof_Property" = None, cmof_Property12: "cmof_Property" = None, cmof_Property10: set["cmof_Property"] = None, cmof_Property15: "cmof_Property" = None, cmof_Property13: set["cmof_Property"] = None, ownedAttribute2: "cmof_DataType" = None, memberEnd: "cmof_Association" = None, Property: "cmof_Class" = None, cmof_Property44: "cmof_Classifier" = None, Property141: "cmof_DataType" = None, cmof_Property149: "cmof_Association" = None, Property151: "cmof_Association" = None, Property153: "cmof_Association" = None):
        self.default = default
    ...
    def subsetted_property_names(self, cmof_diagnostics, cmof_context) :
...
class cmof_Element(Object):
    ...
    def __init__(self, cmof_Element80: "cmof_DirectedRelationship" = None, cmof_Element83: "cmof_DirectedRelationship" = None, cmof_Element85: "cmof_Relationship" = None, cmof_Element87: "cmof_Constraint" = None, cmof_Element: set["cmof_Comment"] = None, Element: "cmof_Element" = None, owner: set["cmof_Element"] = None, Element27: "cmof_Element" = None, ownedElement: "cmof_Element" = None, cmof_Element29: "cmof_Class" = None, cmof_Element32: "cmof_Comment" = None, cmof_Element191: "cmof_Tag" = None, cmof_Element173: "cmof_Link" = None, cmof_Element176: "cmof_Link" = None, cmof_Element183: "cmof_Exception" = None, cmof_Element186: "cmof_Exception" = None, cmof_Element188: "cmof_Tag" = None):
    ...
    def not_own_self(self, cmof_context, cmof_diagnostics) :
...
class cmof_Extent(Object):
    ...
    def __init__(self):
        ...
        pass
    def linkExists(self, cmof_association, cmof_secondElement, cmof_firstElement) :
    ...
    def elementsOfType(self, cmof_includesSubtypes, cmof_type) :
    ...
    def linkedElements(self, cmof_association, cmof_endElement, cmof_end1ToEnd2Direction) :
...
class cmof_ReflectiveSequence(ReflectiveCollection):
    ...
    def set(self, cmof_index, cmof_object) :
        # TODO: Implement set method
        pass
