...
Order.attributes={Order_ordered, Order_total, Order_status, Order_shipped, Order_shipTo, Order_number}
...
domain_model = DomainModel(
    name="_8a6c65bc_cd2d_4bf4_9098_638c70779bd9",
    types={Customer, Payment, ShoppingCart, Account, WebUser, Order, LineItem, Product, UserState, OrderStatus},
    associations={Account_Payment, WebUser_ShoppingCart, Customer_Account, Account_ShoppingCart, ShoppingCart_LineItem, Product_LineItem, Order_LineItem, Account_Order, Payment_Order, WebUser_Customer},
    generalizations={},
    metadata=None
)
