...
# Classes
research31_PublicationProcess = Class(name="research31_PublicationProcess")
Named = Class(name="Named")
research31_Phase = Class(name="research31_Phase")
research31_Researcher = Class(name="research31_Researcher")
research31_Write = Class(name="research31_Write")
research31_Review = Class(name="research31_Review")
research31_PaperKeyword = Class(name="research31_PaperKeyword")
research31_Paper = Class(name="research31_Paper")
research31_Skill = Class(name="research31_Skill")
research31_State = Class(name="research31_State")
research31_Position = Class(name="research31_Position")
Counted = Class(name="Counted")
research31_Collaboration = Class(name="research31_Collaboration")
research31_ReviewNote = Class(name="research31_ReviewNote")
research31_Paragraph = Class(name="research31_Paragraph")
Labelled = Class(name="Labelled")
research31_PublicationStructure = Class(name="research31_PublicationStructure")
research31_Progress = Class(name="research31_Progress")
research31_KnowledgeManager = Class(name="research31_KnowledgeManager")
research31_PublicationStatus = Class(name="research31_PublicationStatus")
research31_PublicationSystem = Class(name="research31_PublicationSystem")
research31_Named = Class(name="research31_Named", is_abstract=True)
research31_Counted = Class(name="research31_Counted", is_abstract=True)
research31_Labelled = Class(name="research31_Labelled", is_abstract=True)
research31_Keyword = Class(name="research31_Keyword")
research31_StateMachineVariable = Class(name="research31_StateMachineVariable")
research31_StateMachineObject = Class(name="research31_StateMachineObject", is_abstract=True)
research31_Transition = Class(name="research31_Transition")
StateMachineObject = Class(name="StateMachineObject")
research31_Action = Class(name="research31_Action")
...
research31_PublicationProcess.attributes={research31_PublicationProcess_maxTime, research31_PublicationProcess_minTime}
...
research31_State.attributes={research31_State_kind, research31_State_id, research31_State_name}
...
research31_Transition.attributes={research31_Transition_guardExpression, research31_Transition_guardLabel}
...
domain_model = DomainModel(
    name="research31",
    types={research31_PublicationProcess, Named, research31_Phase, research31_Researcher, research31_Write, research31_Review, research31_PaperKeyword, research31_Paper, research31_Skill, research31_State, research31_Position, Counted, research31_Collaboration, research31_ReviewNote, research31_Paragraph, Labelled, research31_PublicationStructure, research31_Progress, research31_KnowledgeManager, research31_PublicationStatus, research31_PublicationSystem, research31_Named, research31_Counted, research31_Labelled, research31_Keyword, research31_StateMachineVariable, research31_StateMachineObject, research31_Transition, StateMachineObject, research31_Action, StateType},
    associations={phases0, writes1, authors13, reviews2, keywords14, res_papers4, citedBy17, skills5, state19, res_position7, collaborations9, reviews21, paragraphs11, process23, paper25, paragraph27, reviewNote30, researchers33, progress12, papers35, col_paper61, knowledgeMan38, status40, processView42, structuralView44, positions47, parent51, kpapers53, allkeywords55, keyword58, machineVariables64, pubStates66, t_actions69, source70, target73, transitions76, s_actions79, next83},
    generalizations={gen_research31_PublicationProcess_Named, gen_research31_Paragraph_Counted, gen_research31_Paragraph_Named, gen_research31_Paper_Named, gen_research31_ReviewNote_Named, gen_research31_Progress_Labelled, gen_research31_Write_Labelled, gen_research31_Review_Labelled, gen_research31_PublicationStructure_Named, gen_research31_PublicationSystem_Named, gen_research31_Position_Named, gen_research31_Keyword_Named, gen_research31_KnowledgeManager_Named, gen_research31_Transition_StateMachineObject, gen_research31_State_StateMachineObject},
    metadata=None
)
