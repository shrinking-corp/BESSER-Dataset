...
class sgf_graph_Mapping:
    ...
    def __init__(self, ID: str, sgf_graph_Mapping25: "Processor" = None, sgf_graph_Mapping: set["Process"] = None):
        self.ID = ID
...
class sgf_tree_BasicNode(Node):
    ...
    def __init__(self, modelName: str, Node: "sgf_bundle_Process" = None):
