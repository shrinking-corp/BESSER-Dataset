...
def test_hyp_statemachine_simplestate_is_not_abstract():
    assert not inspect.isabstract(StateMachine_SimpleState)


def test_hyp_statemachine_simplestate_constructor_exists():
    assert callable(StateMachine_SimpleState.__init__)


def test_hyp_statemachine_simplestate_constructor_args():
...
def test_hyp_statemachine_statevertex_is_not_abstract():
    assert not inspect.isabstract(StateMachine_StateVertex)


def test_hyp_statemachine_statevertex_constructor_exists():
    assert callable(StateMachine_StateVertex.__init__)


def test_hyp_statemachine_statevertex_constructor_args():
...
def test_hyp_statemachine_statevertex_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
