...
# Classes
StateMachine_StateVertex = Class(name="StateMachine_StateVertex")
...
domain_model = DomainModel(
    name="StateMachine",
    types={StateMachine_StateVertex, StateMachine_Transition, StateMachine_Event, StateMachine_InitialState, StateVertex, StateMachine_SimpleState, StateMachine_FinalState, StateMachine_StateMachine},
