...
# Classes
archimateC3_ArchimateModel = Class(name="archimateC3_ArchimateModel")
archimateC3_ArchimateElement = Class(name="archimateC3_ArchimateElement", is_abstract=True)
archimateC3_ArchimateRelation = Class(name="archimateC3_ArchimateRelation", is_abstract=True)
archimateC3_Group = Class(name="archimateC3_Group")
archimateC3_PassiveStructure = Class(name="archimateC3_PassiveStructure", is_abstract=True)
ArchimateElement = Class(name="ArchimateElement")
archimateC3_BehaviorElement = Class(name="archimateC3_BehaviorElement", is_abstract=True)
archimateC3_ActiveStructure = Class(name="archimateC3_ActiveStructure", is_abstract=True)
archimateC3_value = Class(name="archimateC3_value")
PassiveStructure = Class(name="PassiveStructure")
archimateC3_Product = Class(name="archimateC3_Product")
archimateC3_Contract = Class(name="archimateC3_Contract")
BusinessObject = Class(name="BusinessObject")
archimateC3_BusinessObject = Class(name="archimateC3_BusinessObject")
archimateC3_Meaning = Class(name="archimateC3_Meaning")
archimateC3_Representation = Class(name="archimateC3_Representation")
archimateC3_BusinessService = Class(name="archimateC3_BusinessService")
BehaviorElement = Class(name="BehaviorElement")
archimateC3_BusinessBehaviorElement = Class(name="archimateC3_BusinessBehaviorElement", is_abstract=True)
archimateC3_BusinessProcess = Class(name="archimateC3_BusinessProcess")
BusinessBehaviorElement = Class(name="BusinessBehaviorElement")
archimateC3_BusinessFunction = Class(name="archimateC3_BusinessFunction")
archimateC3_BusinessInteraction = Class(name="archimateC3_BusinessInteraction")
archimateC3_BusinessEvent = Class(name="archimateC3_BusinessEvent")
archimateC3_Location = Class(name="archimateC3_Location")
ActiveStructure = Class(name="ActiveStructure")
archimateC3_BusinessInterface = Class(name="archimateC3_BusinessInterface")
archimateC3_BusinessRole = Class(name="archimateC3_BusinessRole")
archimateC3_BusinessCollaboration = Class(name="archimateC3_BusinessCollaboration")
BusinessRole = Class(name="BusinessRole")
archimateC3_BusinessActor = Class(name="archimateC3_BusinessActor")
archimateC3_DataObject = Class(name="archimateC3_DataObject")
archimateC3_ApplicationService = Class(name="archimateC3_ApplicationService")
archimateC3_ApplicationFunction = Class(name="archimateC3_ApplicationFunction")
archimateC3_ApplicationInteraction = Class(name="archimateC3_ApplicationInteraction")
ApplicationFunction = Class(name="ApplicationFunction")
archimateC3_ApplicationInterface = Class(name="archimateC3_ApplicationInterface")
archimateC3_ApplicationComponent = Class(name="archimateC3_ApplicationComponent")
archimateC3_ApplicationCollaboration = Class(name="archimateC3_ApplicationCollaboration")
ApplicationComponent = Class(name="ApplicationComponent")
archimateC3_Artifact = Class(name="archimateC3_Artifact")
archimateC3_InfrastructureService = Class(name="archimateC3_InfrastructureService")
archimateC3_InfrastructureInterface = Class(name="archimateC3_InfrastructureInterface")
archimateC3_Node = Class(name="archimateC3_Node")
archimateC3_SystemSoftware = Class(name="archimateC3_SystemSoftware")
Node = Class(name="Node")
archimateC3_Device = Class(name="archimateC3_Device")
archimateC3_CommunicationPath = Class(name="archimateC3_CommunicationPath")
archimateC3_Network = Class(name="archimateC3_Network")
archimateC3_Composition = Class(name="archimateC3_Composition")
ArchimateRelation = Class(name="ArchimateRelation")
archimateC3_Aggregation = Class(name="archimateC3_Aggregation")
archimateC3_Access = Class(name="archimateC3_Access")
archimateC3_Association = Class(name="archimateC3_Association")
archimateC3_Flow = Class(name="archimateC3_Flow")
archimateC3_Specialization = Class(name="archimateC3_Specialization")
archimateC3_Realization = Class(name="archimateC3_Realization")
archimateC3_Assignment = Class(name="archimateC3_Assignment")
archimateC3_UsedBy = Class(name="archimateC3_UsedBy")
archimateC3_Stakeholder = Class(name="archimateC3_Stakeholder")
archimateC3_Driver = Class(name="archimateC3_Driver")
archimateC3_Assessment = Class(name="archimateC3_Assessment")
archimateC3_Goal = Class(name="archimateC3_Goal")
archimateC3_Requirement = Class(name="archimateC3_Requirement")
archimateC3_Triggering = Class(name="archimateC3_Triggering")
archimateC3_Constraint = Class(name="archimateC3_Constraint")
archimateC3_Principle = Class(name="archimateC3_Principle")
archimateC3_WorkPackage = Class(name="archimateC3_WorkPackage")
archimateC3_Deliverable = Class(name="archimateC3_Deliverable")
archimateC3_Plateau = Class(name="archimateC3_Plateau")
archimateC3_Gap = Class(name="archimateC3_Gap")
...
archimateC3_BusinessProcess.attributes={archimateC3_BusinessProcess_processType, archimateC3_BusinessProcess_processFullName, archimateC3_BusinessProcess_missionary, archimateC3_BusinessProcess_importance, archimateC3_BusinessProcess_processDesign, archimateC3_BusinessProcess_processID}
...
domain_model = DomainModel(
    name="archimateC3",
    types={archimateC3_ArchimateModel, archimateC3_ArchimateElement, archimateC3_ArchimateRelation, archimateC3_Group, archimateC3_PassiveStructure, ArchimateElement, archimateC3_BehaviorElement, archimateC3_ActiveStructure, archimateC3_value, PassiveStructure, archimateC3_Product, archimateC3_Contract, BusinessObject, archimateC3_BusinessObject, archimateC3_Meaning, archimateC3_Representation, archimateC3_BusinessService, BehaviorElement, archimateC3_BusinessBehaviorElement, archimateC3_BusinessProcess, BusinessBehaviorElement, archimateC3_BusinessFunction, archimateC3_BusinessInteraction, archimateC3_BusinessEvent, archimateC3_Location, ActiveStructure, archimateC3_BusinessInterface, archimateC3_BusinessRole, archimateC3_BusinessCollaboration, BusinessRole, archimateC3_BusinessActor, archimateC3_DataObject, archimateC3_ApplicationService, archimateC3_ApplicationFunction, archimateC3_ApplicationInteraction, ApplicationFunction, archimateC3_ApplicationInterface, archimateC3_ApplicationComponent, archimateC3_ApplicationCollaboration, ApplicationComponent, archimateC3_Artifact, archimateC3_InfrastructureService, archimateC3_InfrastructureInterface, archimateC3_Node, archimateC3_SystemSoftware, Node, archimateC3_Device, archimateC3_CommunicationPath, archimateC3_Network, archimateC3_Composition, ArchimateRelation, archimateC3_Aggregation, archimateC3_Access, archimateC3_Association, archimateC3_Flow, archimateC3_Specialization, archimateC3_Realization, archimateC3_Assignment, archimateC3_UsedBy, archimateC3_Stakeholder, archimateC3_Driver, archimateC3_Assessment, archimateC3_Goal, archimateC3_Requirement, archimateC3_Triggering, archimateC3_Constraint, archimateC3_Principle, archimateC3_WorkPackage, archimateC3_Deliverable, archimateC3_Plateau, archimateC3_Gap},
    associations={elements0, relations1, groups3, composedOf6, composes8, sourceC10, targetC13, groupElements16},
    generalizations={gen_archimateC3_PassiveStructure_ArchimateElement, gen_archimateC3_BehaviorElement_ArchimateElement, gen_archimateC3_ActiveStructure_ArchimateElement, gen_archimateC3_value_PassiveStructure, gen_archimateC3_Product_PassiveStructure, gen_archimateC3_Contract_BusinessObject, gen_archimateC3_BusinessObject_PassiveStructure, gen_archimateC3_Meaning_PassiveStructure, gen_archimateC3_Representation_PassiveStructure, gen_archimateC3_BusinessService_BehaviorElement, gen_archimateC3_BusinessBehaviorElement_BehaviorElement, gen_archimateC3_BusinessProcess_BusinessBehaviorElement, gen_archimateC3_BusinessFunction_BusinessBehaviorElement, gen_archimateC3_BusinessInteraction_BusinessBehaviorElement, gen_archimateC3_BusinessEvent_ArchimateElement, gen_archimateC3_Location_ActiveStructure, gen_archimateC3_BusinessInterface_ActiveStructure, gen_archimateC3_BusinessRole_ActiveStructure, gen_archimateC3_BusinessCollaboration_BusinessRole, gen_archimateC3_BusinessActor_ActiveStructure, gen_archimateC3_DataObject_ArchimateElement, gen_archimateC3_ApplicationService_ArchimateElement, gen_archimateC3_ApplicationFunction_ArchimateElement, gen_archimateC3_ApplicationInteraction_ApplicationFunction, gen_archimateC3_ApplicationInterface_ArchimateElement, gen_archimateC3_ApplicationComponent_ArchimateElement, gen_archimateC3_ApplicationCollaboration_ApplicationComponent, gen_archimateC3_Artifact_ArchimateElement, gen_archimateC3_InfrastructureService_ArchimateElement, gen_archimateC3_InfrastructureInterface_ArchimateElement, gen_archimateC3_Node_ArchimateElement, gen_archimateC3_SystemSoftware_Node, gen_archimateC3_Device_Node, gen_archimateC3_CommunicationPath_ArchimateElement, gen_archimateC3_Network_ArchimateElement, gen_archimateC3_Composition_ArchimateRelation, gen_archimateC3_Aggregation_ArchimateRelation, gen_archimateC3_Access_ArchimateRelation, gen_archimateC3_Association_ArchimateRelation, gen_archimateC3_Flow_ArchimateRelation, gen_archimateC3_Specialization_ArchimateRelation, gen_archimateC3_Realization_ArchimateRelation, gen_archimateC3_Assignment_ArchimateRelation, gen_archimateC3_UsedBy_ArchimateRelation, gen_archimateC3_Stakeholder_ArchimateElement, gen_archimateC3_Driver_ArchimateElement, gen_archimateC3_Assessment_ArchimateElement, gen_archimateC3_Goal_ArchimateElement, gen_archimateC3_Requirement_ArchimateElement, gen_archimateC3_Triggering_ArchimateRelation, gen_archimateC3_Constraint_ArchimateElement, gen_archimateC3_Principle_ArchimateElement, gen_archimateC3_WorkPackage_ArchimateElement, gen_archimateC3_Deliverable_ArchimateElement, gen_archimateC3_Plateau_ArchimateElement, gen_archimateC3_Gap_ArchimateElement},
    metadata=None
)
