...
class archimateC3_BusinessProcess(BusinessBehaviorElement):
    ...
    def __init__(self, processFullName: str, processType: str, importance: int, processDesign: str, missionary: bool, processID: str):
...
class archimateC3_ArchimateElement(ABC):
    ...
    def __init__(self, elementName: str, description: str, ArchimateElement: "archimateC3_ArchimateElement" = None, composes: set["archimateC3_ArchimateElement"] = None, ArchimateElement9: "archimateC3_ArchimateElement" = None, composedOf: "archimateC3_ArchimateElement" = None, archimateC3_ArchimateElement: "archimateC3_ArchimateModel" = None, archimateC3_ArchimateElement12: "archimateC3_ArchimateRelation" = None, archimateC3_ArchimateElement15: "archimateC3_ArchimateRelation" = None, archimateC3_ArchimateElement18: "archimateC3_Group" = None):
