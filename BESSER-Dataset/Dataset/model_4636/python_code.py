...
class trnet_Operand(ABC):
    ...
    def __init__(self, index: int, Operand: "trnet_Pattern" = None, Operand40: "trnet_Operator" = None, outgoingOperands: "trnet_Pattern" = None, operands: "trnet_Operator" = None):
        self.index = index
...
class trnet_EdgePattern:
    ...
    def __init__(self, name: str, EdgePattern7: "trnet_NodePattern" = None, outgoing: "trnet_NodePattern" = None, incoming: "trnet_NodePattern" = None, edges: "trnet_Pattern" = None, EdgePattern34: "trnet_Pattern" = None, EdgePattern: "trnet_NodePattern" = None):
        self.name = name
...
class trnet_NodePattern(ABC):
    ...
    def __init__(self, name: str, id: str, source: set["trnet_EdgePattern"] = None, source9: set["trnet_Same"] = None, target11: set["trnet_Same"] = None, nodes: "trnet_Pattern" = None, trnet_NodePattern: set["trnet_AttributePattern"] = None, target21: set["trnet_Keep"] = None, source23: set["trnet_Keep"] = None, NodePattern: "trnet_EdgePattern" = None, NodePattern27: "trnet_EdgePattern" = None, NodePattern31: "trnet_Pattern" = None, target: set["trnet_EdgePattern"] = None, target16: set["trnet_Different"] = None, source18: set["trnet_Different"] = None, NodePattern46: "trnet_Same" = None, NodePattern48: "trnet_Same" = None, NodePattern54: "trnet_Keep" = None, NodePattern56: "trnet_Keep" = None, NodePattern65: "trnet_Different" = None, NodePattern67: "trnet_Different" = None):
        self.name = name
        self.id = id
...
class trnet_Operator(ABC):
    ...
    def __init__(self, id: str, trnet_Operator: "trnet_TrNetModel" = None, operator: set["trnet_Operand"] = None, operator42: set["trnet_Result"] = None, Operator: "trnet_Operand" = None, Operator63: "trnet_Result" = None):
        self.id = id
...
class trnet_Pattern:
    ...
    def __init__(self, id: str, expected_size: int, Pattern: "trnet_NodePattern" = None, Pattern29: "trnet_EdgePattern" = None, pattern: set["trnet_NodePattern"] = None, pattern33: set["trnet_EdgePattern"] = None, pattern36: set["trnet_Operand"] = None, trnet_Pattern: "trnet_TrNetModel" = None, pattern38: set["trnet_Result"] = None, Pattern58: "trnet_Operand" = None, Pattern61: "trnet_Result" = None):
        self.id = id
