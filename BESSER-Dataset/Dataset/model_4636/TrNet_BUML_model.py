...
# Classes
trnet_TrNetModel = Class(name="trnet_TrNetModel")
trnet_Pattern = Class(name="trnet_Pattern")
trnet_Operator = Class(name="trnet_Operator", is_abstract=True)
trnet_FlowRule = Class(name="trnet_FlowRule", is_abstract=True)
trnet_NodePattern = Class(name="trnet_NodePattern", is_abstract=True)
trnet_EdgePattern = Class(name="trnet_EdgePattern")
trnet_Same = Class(name="trnet_Same")
trnet_AttributePattern = Class(name="trnet_AttributePattern")
trnet_Different = Class(name="trnet_Different")
trnet_Keep = Class(name="trnet_Keep")
trnet_Operand = Class(name="trnet_Operand", is_abstract=True)
trnet_Result = Class(name="trnet_Result", is_abstract=True)
trnet_Combinator = Class(name="trnet_Combinator")
Operator = Class(name="Operator")
trnet_Restriction = Class(name="trnet_Restriction", is_abstract=True)
trnet_Expression = Class(name="trnet_Expression", is_abstract=True)
trnet_ExpressionOperator = Class(name="trnet_ExpressionOperator", is_abstract=True)
trnet_StringLiteral = Class(name="trnet_StringLiteral")
Expression = Class(name="Expression")
trnet_SomeOperand = Class(name="trnet_SomeOperand")
Operand = Class(name="Operand")
trnet_AntiOperand = Class(name="trnet_AntiOperand")
trnet_AnyOperand = Class(name="trnet_AnyOperand")
Restriction = Class(name="Restriction")
trnet_External = Class(name="trnet_External")
trnet_Union = Class(name="trnet_Union")
trnet_MandatoryNode = Class(name="trnet_MandatoryNode")
NodePattern = Class(name="NodePattern")
trnet_OptionalNode = Class(name="trnet_OptionalNode")
trnet_Equality = Class(name="trnet_Equality")
ExpressionOperator = Class(name="ExpressionOperator")
trnet_OptionalOperand = Class(name="trnet_OptionalOperand")
trnet_Next = Class(name="trnet_Next")
FlowRule = Class(name="FlowRule")
trnet_Eventually = Class(name="trnet_Eventually")
trnet_NextDerived = Class(name="trnet_NextDerived")
trnet_SomeResult = Class(name="trnet_SomeResult")
Result = Class(name="Result")
trnet_AnyResult = Class(name="trnet_AnyResult")
...
trnet_NodePattern.attributes={trnet_NodePattern_id, trnet_NodePattern_name}
...
domain_model = DomainModel(
    name="trnet",
    types={trnet_TrNetModel, trnet_Pattern, trnet_Operator, trnet_FlowRule, trnet_NodePattern, trnet_EdgePattern, trnet_Same, trnet_AttributePattern, trnet_Different, trnet_Keep, trnet_Operand, trnet_Result, trnet_Combinator, Operator, trnet_Restriction, trnet_Expression, trnet_ExpressionOperator, trnet_StringLiteral, Expression, trnet_SomeOperand, Operand, trnet_AntiOperand, trnet_AnyOperand, Restriction, trnet_External, trnet_Union, trnet_MandatoryNode, NodePattern, trnet_OptionalNode, trnet_Equality, ExpressionOperator, trnet_OptionalOperand, trnet_Next, FlowRule, trnet_Eventually, trnet_NextDerived, trnet_SomeResult, Result, trnet_AnyResult},
    associations={patterns0, operators1, flowRules3, incoming5, outgoing6, sameOut8, sameIn10, pattern13, attributes14, keepIn20, keepOut22, source25, target26, pattern28, nodes30, edges32, outgoingOperands35, incommingResults37, operands39, results41, restrictions44, differentIn15, differentOut17, source45, target47, expression49, operator51, source53, target55, pattern57, operator59, pattern60, operator62, source64, target66, restrictions68, source70, target73},
    generalizations={gen_trnet_Combinator_Operator, gen_trnet_StringLiteral_Expression, gen_trnet_Keep_Restriction, gen_trnet_SomeOperand_Operand, gen_trnet_AntiOperand_Operand, gen_trnet_Same_Restriction, gen_trnet_Different_Restriction, gen_trnet_External_Operator, gen_trnet_Union_Operator, gen_trnet_MandatoryNode_NodePattern, gen_trnet_OptionalNode_NodePattern, gen_trnet_Equality_ExpressionOperator, gen_trnet_OptionalOperand_Operand, gen_trnet_Next_FlowRule, gen_trnet_Eventually_FlowRule, gen_trnet_NextDerived_FlowRule, gen_trnet_AnyOperand_Operand, gen_trnet_SomeResult_Result, gen_trnet_AnyResult_Result},
    metadata=None
)
