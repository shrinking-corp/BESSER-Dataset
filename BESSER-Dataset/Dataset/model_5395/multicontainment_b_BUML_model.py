...
# Classes
multicontainment_b_RootB = Class(name="multicontainment_b_RootB")
Identified = Class(name="Identified")
multicontainment_b_ChildB1 = Class(name="multicontainment_b_ChildB1")
multicontainment_b_ChildB2 = Class(name="multicontainment_b_ChildB2")
multicontainment_b_Identified = Class(name="multicontainment_b_Identified", is_abstract=True)
...
domain_model = DomainModel(
    ...
    types={multicontainment_b_RootB, Identified, multicontainment_b_ChildB1, multicontainment_b_ChildB2, multicontainment_b_Identified},
    associations={childrenB1a0, childrenB1b1, childrenB2a4},
    generalizations={gen_multicontainment_b_RootB_Identified, gen_multicontainment_b_ChildB1_Identified, gen_multicontainment_b_ChildB2_Identified},
    metadata=None
)
