...
def test_hyp_beans_namedelement_is_not_abstract():
    assert not inspect.isabstract(beans_NamedElement)


def test_hyp_beans_namedelement_constructor_exists():
    assert callable(beans_NamedElement.__init__)


def test_hyp_beans_namedelement_constructor_args():
...
def test_hyp_beans_beanproperty_is_not_abstract():
    assert not inspect.isabstract(beans_BeanProperty)


def test_hyp_beans_beanproperty_constructor_exists():
    assert callable(beans_BeanProperty.__init__)


def test_hyp_beans_beanproperty_constructor_args():
...
def test_hyp_beans_bean_is_not_abstract():
    assert not inspect.isabstract(beans_Bean)


def test_hyp_beans_bean_constructor_exists():
    assert callable(beans_Bean.__init__)


def test_hyp_beans_bean_constructor_args():
    sig = inspect.signature(beans_Bean.__init__)
    params = list(sig.parameters.keys())



def test_hyp_beans_beanlibrary_is_not_abstract():
    assert not inspect.isabstract(beans_BeanLibrary)


def test_hyp_beans_beanlibrary_constructor_exists():
    assert callable(beans_BeanLibrary.__init__)


def test_hyp_beans_beanlibrary_constructor_args():
...
def test_hyp_beans_namedelement_name_setter(instance):
...
def test_hyp_beans_beanproperty_typeName_setter(instance):
...
@given(instance=beans_BeanProperty_strategy)
def test_hyp_beans_beanproperty_changeable_setter(instance):
...
def test_hyp_beans_beanlibrary_packageName_setter(instance):
