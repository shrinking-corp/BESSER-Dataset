...
public class uma_BreakdownElement extends ProcessElement {
    ...
    public uma_BreakdownElement(
        String prefix,        String isPlanned,        String hasMultipleOccurrences,        String isOptional    ) {
        super(
        );
        this.prefix = prefix;
    ...
    public uma_BreakdownElement(
        String prefix,        String isPlanned,        String hasMultipleOccurrences,        String isOptional        ArrayList<uma_Guideline> uma_guidelines,        ArrayList<uma_SupportingMaterial> uma_supportingmaterials,        ArrayList<uma_Template> uma_templates,        ArrayList<uma_ToolMentor> uma_toolmentors,        ArrayList<uma_Example> uma_examples,        ArrayList<uma_Concept> uma_concepts,        ArrayList<uma_Report> uma_reports,        ArrayList<uma_ReusableAsset> uma_reusableassets,        ArrayList<uma_Checklist> uma_checklists,        ArrayList<uma_EstimationConsiderations> uma_estimationconsiderationss    ) {
        this.prefix = prefix;
        this.isPlanned = isPlanned;
        this.hasMultipleOccurrences = hasMultipleOccurrences;
        this.isOptional = isOptional;
