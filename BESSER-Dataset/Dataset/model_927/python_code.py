...
class uma_Point:
    ...
    def __init__(self, x: str, y: str, uma_Point306: "uma_GraphElement" = None, uma_Point328: "uma_GraphEdge" = None, uma_Point: "uma_Diagram" = None, uma_Point320: "uma_DiagramLink" = None, uma_Point345: "uma_Polyline" = None, uma_Point347: "uma_Ellipse" = None):
        self.x = x
        self.y = y
...
class uma_DiagramLink(DiagramElement):
    ...
    def __init__(self, zoom: str, uma_DiagramLink: "uma_Point" = None, diagramLink: "uma_Diagram" = None, DiagramLink308: "uma_GraphElement" = None, DiagramLink: "uma_Diagram" = None, link: "uma_GraphElement" = None):
        self.zoom = zoom
...
class uma_Diagram(GraphNode):
    ...
    def __init__(self, zoom: str, Diagram: "uma_DiagramLink" = None, uma_Diagram: "uma_ProcessPackage" = None, diagram: set["uma_DiagramLink"] = None, diagram300: "uma_SemanticModelBridge" = None, uma_Diagram302: "uma_Point" = None, Diagram332: "uma_SemanticModelBridge" = None):
        self.zoom = zoom
...
class uma_WorkProductDescriptor(Descriptor):
    ...
    def __init__(self, activityEntryState: str, activityExitState: str, uma_WorkProductDescriptor189: "uma_RoleDescriptor" = None, uma_WorkProductDescriptor192: "uma_RoleDescriptor" = None, impacts: set["uma_WorkProductDescriptor"] = None, WorkProductDescriptor: "uma_WorkProductDescriptor" = None, WorkProductDescriptor167: "uma_WorkProductDescriptor" = None, impactedBy: set["uma_WorkProductDescriptor"] = None, uma_WorkProductDescriptor170: "uma_WorkProductDescriptor" = None, uma_WorkProductDescriptor168: set["uma_WorkProductDescriptor"] = None, uma_WorkProductDescriptor172: set["uma_WorkProduct"] = None, uma_WorkProductDescriptor: "uma_Milestone" = None, uma_WorkProductDescriptor161: "uma_WorkProduct" = None, uma_WorkProductDescriptor206: "uma_TaskDescriptor" = None, uma_WorkProductDescriptor209: "uma_TaskDescriptor" = None, uma_WorkProductDescriptor212: "uma_TaskDescriptor" = None, uma_WorkProductDescriptor215: "uma_TaskDescriptor" = None, uma_WorkProductDescriptor340: "uma_ProcessComponentInterface" = None):
...
class uma_MethodPlugin(Package, MethodUnit):
    ...
    def __init__(self, userChangeable: str, supporting: bool, uma_MethodPlugin274: set["uma_MethodPackage"] = None, uma_MethodPlugin278: "uma_MethodPlugin" = None, uma_MethodPlugin276: set["uma_MethodPlugin"] = None, uma_MethodPlugin: "uma_MethodConfiguration" = None, uma_MethodPlugin351: "uma_MethodLibrary" = None):
...
class uma_ContentDescription(MethodUnit):
    ...
    def __init__(self, externalId: str, keyConsiderations: str, longPresentationName: str, mainDescription: str, uma_ContentDescription: "uma_DescribableElement" = None, uma_ContentDescription22: set["uma_Section"] = None):
...
class uma_MethodPackage(Package, MethodElement):
    ...
    def __init__(self, global_: str, uma_MethodPackage: "uma_MethodPackage" = None, uma_MethodPackage152: set["uma_MethodPackage"] = None, uma_MethodPackage156: "uma_MethodPackage" = None, uma_MethodPackage154: set["uma_MethodPackage"] = None, uma_MethodPackage275: "uma_MethodPlugin" = None, uma_MethodPackage257: "uma_MethodConfiguration" = None):
...
class uma_MethodElement(PackageableElement):
    ...
    def __init__(self, briefDescription: str, suppressed: str, orderingGuide: str, guid: str, presentationName: str, uma_MethodElement: set["uma_Constraint"] = None, uma_MethodElement2: set["uma_MethodElementProperty"] = None, uma_MethodElement4: set["uma_Kind"] = None, uma_MethodElement342: "uma_UMASemanticModelBridge" = None):
