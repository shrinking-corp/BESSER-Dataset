...
class miniOCL_ClassCS:
    ...
    def __init__(self, name: str, miniOCL_ClassCS11: set["miniOCL_PropertyCS"] = None, miniOCL_ClassCS13: set["miniOCL_OperationCS"] = None, miniOCL_ClassCS: "miniOCL_PackageCS" = None, miniOCL_ClassCS9: "miniOCL_PathNameCS" = None):
        self.name = name
