...
def test_hyp_miniocl_navigationpathelementcs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_NavigationPathElementCS)


def test_hyp_miniocl_navigationpathelementcs_constructor_exists():
    assert callable(miniOCL_NavigationPathElementCS.__init__)


def test_hyp_miniocl_navigationpathelementcs_constructor_args():
    sig = inspect.signature(miniOCL_NavigationPathElementCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_miniocl_navigationpathvariablecs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_NavigationPathVariableCS)


def test_hyp_miniocl_navigationpathvariablecs_constructor_exists():
    assert callable(miniOCL_NavigationPathVariableCS.__init__)


def test_hyp_miniocl_navigationpathvariablecs_constructor_args():
...
def test_hyp_miniocl_navigationpathcs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_NavigationPathCS)


def test_hyp_miniocl_navigationpathcs_constructor_exists():
    assert callable(miniOCL_NavigationPathCS.__init__)


def test_hyp_miniocl_navigationpathcs_constructor_args():
    sig = inspect.signature(miniOCL_NavigationPathCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_miniocl_navigationpathnamecs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_NavigationPathNameCS)


def test_hyp_miniocl_navigationpathnamecs_constructor_exists():
    assert callable(miniOCL_NavigationPathNameCS.__init__)


def test_hyp_miniocl_navigationpathnamecs_constructor_args():
...
def test_hyp_miniocl_booleanexpcs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_BooleanExpCS)


def test_hyp_miniocl_booleanexpcs_constructor_exists():
    assert callable(miniOCL_BooleanExpCS.__init__)


def test_hyp_miniocl_booleanexpcs_constructor_args():
...
def test_hyp_miniocl_estructuralfeature_is_not_abstract():
    assert not inspect.isabstract(miniOCL_EStructuralFeature)


def test_hyp_miniocl_estructuralfeature_constructor_exists():
    assert callable(miniOCL_EStructuralFeature.__init__)


def test_hyp_miniocl_estructuralfeature_constructor_args():
...
def test_hyp_miniocl_pathelementcs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_PathElementCS)


def test_hyp_miniocl_pathelementcs_constructor_exists():
    assert callable(miniOCL_PathElementCS.__init__)


def test_hyp_miniocl_pathelementcs_constructor_args():
    sig = inspect.signature(miniOCL_PathElementCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_miniocl_pathvariablecs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_PathVariableCS)


def test_hyp_miniocl_pathvariablecs_constructor_exists():
    assert callable(miniOCL_PathVariableCS.__init__)


def test_hyp_miniocl_pathvariablecs_constructor_args():
...
def test_hyp_miniocl_pathcs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_PathCS)


def test_hyp_miniocl_pathcs_constructor_exists():
    assert callable(miniOCL_PathCS.__init__)


def test_hyp_miniocl_pathcs_constructor_args():
...
def test_hyp_miniocl_stringliteralexpcs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_StringLiteralExpCS)


def test_hyp_miniocl_stringliteralexpcs_constructor_exists():
    assert callable(miniOCL_StringLiteralExpCS.__init__)


def test_hyp_miniocl_stringliteralexpcs_constructor_args():
...
def test_hyp_miniocl_booleanliteralexpcs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_BooleanLiteralExpCS)


def test_hyp_miniocl_booleanliteralexpcs_constructor_exists():
    assert callable(miniOCL_BooleanLiteralExpCS.__init__)


def test_hyp_miniocl_booleanliteralexpcs_constructor_args():
    sig = inspect.signature(miniOCL_BooleanLiteralExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_miniocl_intliteralexpcs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_IntLiteralExpCS)


def test_hyp_miniocl_intliteralexpcs_constructor_exists():
    assert callable(miniOCL_IntLiteralExpCS.__init__)


def test_hyp_miniocl_intliteralexpcs_constructor_args():
...
def test_hyp_miniocl_accvarcs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_AccVarCS)


def test_hyp_miniocl_accvarcs_constructor_exists():
    assert callable(miniOCL_AccVarCS.__init__)


def test_hyp_miniocl_accvarcs_constructor_args():
...
def test_hyp_miniocl_existsexpcs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_ExistsExpCS)


def test_hyp_miniocl_existsexpcs_constructor_exists():
    assert callable(miniOCL_ExistsExpCS.__init__)


def test_hyp_miniocl_existsexpcs_constructor_args():
    sig = inspect.signature(miniOCL_ExistsExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_miniocl_forallexpcs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_ForAllExpCS)


def test_hyp_miniocl_forallexpcs_constructor_exists():
    assert callable(miniOCL_ForAllExpCS.__init__)


def test_hyp_miniocl_forallexpcs_constructor_args():
    sig = inspect.signature(miniOCL_ForAllExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_miniocl_iterateexpcs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_IterateExpCS)


def test_hyp_miniocl_iterateexpcs_constructor_exists():
    assert callable(miniOCL_IterateExpCS.__init__)


def test_hyp_miniocl_iterateexpcs_constructor_args():
    sig = inspect.signature(miniOCL_IterateExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_miniocl_collectexpcs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_CollectExpCS)


def test_hyp_miniocl_collectexpcs_constructor_exists():
    assert callable(miniOCL_CollectExpCS.__init__)


def test_hyp_miniocl_collectexpcs_constructor_args():
    sig = inspect.signature(miniOCL_CollectExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_miniocl_iteratorvarcs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_IteratorVarCS)


def test_hyp_miniocl_iteratorvarcs_constructor_exists():
    assert callable(miniOCL_IteratorVarCS.__init__)


def test_hyp_miniocl_iteratorvarcs_constructor_args():
...
def test_hyp_miniocl_roundedbracketclausecs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_RoundedBracketClauseCS)


def test_hyp_miniocl_roundedbracketclausecs_constructor_exists():
    assert callable(miniOCL_RoundedBracketClauseCS.__init__)


def test_hyp_miniocl_roundedbracketclausecs_constructor_args():
...
def test_hyp_miniocl_loopexpcs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_LoopExpCS)


def test_hyp_miniocl_loopexpcs_constructor_exists():
    assert callable(miniOCL_LoopExpCS.__init__)


def test_hyp_miniocl_loopexpcs_constructor_args():
...
def test_hyp_miniocl_navigationnameexpcs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_NavigationNameExpCS)


def test_hyp_miniocl_navigationnameexpcs_constructor_exists():
    assert callable(miniOCL_NavigationNameExpCS.__init__)


def test_hyp_miniocl_navigationnameexpcs_constructor_args():
    sig = inspect.signature(miniOCL_NavigationNameExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_miniocl_nameexpcs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_NameExpCS)


def test_hyp_miniocl_nameexpcs_constructor_exists():
    assert callable(miniOCL_NameExpCS.__init__)


def test_hyp_miniocl_nameexpcs_constructor_args():
...
def test_hyp_miniocl_literalexpcs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_LiteralExpCS)


def test_hyp_miniocl_literalexpcs_constructor_exists():
    assert callable(miniOCL_LiteralExpCS.__init__)


def test_hyp_miniocl_literalexpcs_constructor_args():
...
def test_hyp_miniocl_primaryexpcs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_PrimaryExpCS)


def test_hyp_miniocl_primaryexpcs_constructor_exists():
    assert callable(miniOCL_PrimaryExpCS.__init__)


def test_hyp_miniocl_primaryexpcs_constructor_args():
    sig = inspect.signature(miniOCL_PrimaryExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_miniocl_navigationexpcs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_NavigationExpCS)


def test_hyp_miniocl_navigationexpcs_constructor_exists():
    assert callable(miniOCL_NavigationExpCS.__init__)


def test_hyp_miniocl_navigationexpcs_constructor_args():
...
def test_hyp_miniocl_callexpcs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_CallExpCS)


def test_hyp_miniocl_callexpcs_constructor_exists():
    assert callable(miniOCL_CallExpCS.__init__)


def test_hyp_miniocl_callexpcs_constructor_args():
...
def test_hyp_miniocl_logicexpcs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_LogicExpCS)


def test_hyp_miniocl_logicexpcs_constructor_exists():
    assert callable(miniOCL_LogicExpCS.__init__)


def test_hyp_miniocl_logicexpcs_constructor_args():
...
def test_hyp_miniocl_invariantcs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_InvariantCS)


def test_hyp_miniocl_invariantcs_constructor_exists():
    assert callable(miniOCL_InvariantCS.__init__)


def test_hyp_miniocl_invariantcs_constructor_args():
    sig = inspect.signature(miniOCL_InvariantCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_miniocl_expcs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_ExpCS)


def test_hyp_miniocl_expcs_constructor_exists():
    assert callable(miniOCL_ExpCS.__init__)


def test_hyp_miniocl_expcs_constructor_args():
    sig = inspect.signature(miniOCL_ExpCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_miniocl_parametercs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_ParameterCS)


def test_hyp_miniocl_parametercs_constructor_exists():
    assert callable(miniOCL_ParameterCS.__init__)


def test_hyp_miniocl_parametercs_constructor_args():
...
def test_hyp_miniocl_operationcs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_OperationCS)


def test_hyp_miniocl_operationcs_constructor_exists():
    assert callable(miniOCL_OperationCS.__init__)


def test_hyp_miniocl_operationcs_constructor_args():
...
def test_hyp_miniocl_propertycs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_PropertyCS)


def test_hyp_miniocl_propertycs_constructor_exists():
    assert callable(miniOCL_PropertyCS.__init__)


def test_hyp_miniocl_propertycs_constructor_args():
...
def test_hyp_miniocl_pathnamecs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_PathNameCS)


def test_hyp_miniocl_pathnamecs_constructor_exists():
    assert callable(miniOCL_PathNameCS.__init__)


def test_hyp_miniocl_pathnamecs_constructor_args():
    sig = inspect.signature(miniOCL_PathNameCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_miniocl_classcs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_ClassCS)


def test_hyp_miniocl_classcs_constructor_exists():
    assert callable(miniOCL_ClassCS.__init__)


def test_hyp_miniocl_classcs_constructor_args():
...
def test_hyp_miniocl_constraintcs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_ConstraintCS)


def test_hyp_miniocl_constraintcs_constructor_exists():
    assert callable(miniOCL_ConstraintCS.__init__)


def test_hyp_miniocl_constraintcs_constructor_args():
    sig = inspect.signature(miniOCL_ConstraintCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_miniocl_packagecs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_PackageCS)


def test_hyp_miniocl_packagecs_constructor_exists():
    assert callable(miniOCL_PackageCS.__init__)


def test_hyp_miniocl_packagecs_constructor_args():
...
def test_hyp_miniocl_rootcs_is_not_abstract():
    assert not inspect.isabstract(miniOCL_RootCS)


def test_hyp_miniocl_rootcs_constructor_exists():
    assert callable(miniOCL_RootCS.__init__)


def test_hyp_miniocl_rootcs_constructor_args():
...
def test_hyp_miniocl_navigationpathvariablecs_varName_setter(instance):
...
def test_hyp_miniocl_booleanexpcs_boolSymbol_setter(instance):
...
def test_hyp_miniocl_pathvariablecs_varName_setter(instance):
    original = instance.varName
    instance.varName = original
    assert instance.varName == original
...
def test_hyp_miniocl_stringliteralexpcs_stringSymbol_setter(instance):
...
def test_hyp_miniocl_intliteralexpcs_intSymbol_setter(instance):
...
def test_hyp_miniocl_accvarcs_accVarName_setter(instance):
...
def test_hyp_miniocl_iteratorvarcs_itName_setter(instance):
...
def test_hyp_miniocl_loopexpcs_logicOp_setter(instance):
...
def test_hyp_miniocl_logicexpcs_op_setter(instance):
...
def test_hyp_miniocl_parametercs_name_setter(instance):
...
def test_hyp_miniocl_operationcs_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_miniocl_propertycs_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_miniocl_classcs_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_miniocl_packagecs_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
