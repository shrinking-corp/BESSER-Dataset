...
# Classes
miniOCL_RootCS = Class(name="miniOCL_RootCS")
miniOCL_PackageCS = Class(name="miniOCL_PackageCS")
miniOCL_ConstraintCS = Class(name="miniOCL_ConstraintCS")
miniOCL_ClassCS = Class(name="miniOCL_ClassCS")
miniOCL_PathNameCS = Class(name="miniOCL_PathNameCS")
miniOCL_PropertyCS = Class(name="miniOCL_PropertyCS")
miniOCL_OperationCS = Class(name="miniOCL_OperationCS")
miniOCL_ParameterCS = Class(name="miniOCL_ParameterCS")
miniOCL_ExpCS = Class(name="miniOCL_ExpCS")
miniOCL_InvariantCS = Class(name="miniOCL_InvariantCS")
miniOCL_LogicExpCS = Class(name="miniOCL_LogicExpCS")
ExpCS = Class(name="ExpCS")
miniOCL_CallExpCS = Class(name="miniOCL_CallExpCS")
LogicExpCS = Class(name="LogicExpCS")
miniOCL_NavigationExpCS = Class(name="miniOCL_NavigationExpCS")
miniOCL_PrimaryExpCS = Class(name="miniOCL_PrimaryExpCS")
CallExpCS = Class(name="CallExpCS")
PrimaryExpCS = Class(name="PrimaryExpCS")
miniOCL_NameExpCS = Class(name="miniOCL_NameExpCS")
NavigationExpCS = Class(name="NavigationExpCS")
miniOCL_RoundedBracketClauseCS = Class(name="miniOCL_RoundedBracketClauseCS")
miniOCL_LoopExpCS = Class(name="miniOCL_LoopExpCS")
miniOCL_IteratorVarCS = Class(name="miniOCL_IteratorVarCS")
miniOCL_CollectExpCS = Class(name="miniOCL_CollectExpCS")
LoopExpCS = Class(name="LoopExpCS")
miniOCL_IterateExpCS = Class(name="miniOCL_IterateExpCS")
miniOCL_AccVarCS = Class(name="miniOCL_AccVarCS")
miniOCL_LiteralExpCS = Class(name="miniOCL_LiteralExpCS")
miniOCL_IntLiteralExpCS = Class(name="miniOCL_IntLiteralExpCS")
LiteralExpCS = Class(name="LiteralExpCS")
miniOCL_StringLiteralExpCS = Class(name="miniOCL_StringLiteralExpCS")
miniOCL_BooleanLiteralExpCS = Class(name="miniOCL_BooleanLiteralExpCS")
miniOCL_PathCS = Class(name="miniOCL_PathCS")
miniOCL_PathVariableCS = Class(name="miniOCL_PathVariableCS")
PathCS = Class(name="PathCS")
miniOCL_PathElementCS = Class(name="miniOCL_PathElementCS")
miniOCL_EStructuralFeature = Class(name="miniOCL_EStructuralFeature")
miniOCL_BooleanExpCS = Class(name="miniOCL_BooleanExpCS")
BooleanLiteralExpCS = Class(name="BooleanLiteralExpCS")
miniOCL_ExistsExpCS = Class(name="miniOCL_ExistsExpCS")
miniOCL_NavigationNameExpCS = Class(name="miniOCL_NavigationNameExpCS")
miniOCL_NavigationPathNameCS = Class(name="miniOCL_NavigationPathNameCS")
miniOCL_NavigationPathCS = Class(name="miniOCL_NavigationPathCS")
miniOCL_NavigationPathVariableCS = Class(name="miniOCL_NavigationPathVariableCS")
NavigationPathCS = Class(name="NavigationPathCS")
miniOCL_NavigationPathElementCS = Class(name="miniOCL_NavigationPathElementCS")
miniOCL_ForAllExpCS = Class(name="miniOCL_ForAllExpCS")
...
domain_model = DomainModel(
    ...
    associations={packages0, contraints1, packages4, classes6, extends8, properties10, operations12, typeRef14, params17, resultRef19, body22, typeRef24, typeRef27, invariants30, exp32, left36, right37, source40, navExp42, expName44, roundedBrackets46, callExp48, itVar51, exp52, itType55, accVar58, accType59, accInitExp62, args65, path68, pathName70, accVars71, expName73, roundedBrackets74, callExp77, path80, pathName82, accVars84},
