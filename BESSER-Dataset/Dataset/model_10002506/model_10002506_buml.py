...
Machine_Processor2: BinaryAssociation = BinaryAssociation(
    name="Machine_Processor2",
    ends={
        Property(name="processor22", type=Processor, multiplicity=Multiplicity(0, 1)),
        Property(name="machine23", type=Machine, multiplicity=Multiplicity(0, 1))
    }
)
Processor_Machine: BinaryAssociation = BinaryAssociation(
    name="Processor_Machine",
    ends={
        Property(name="machine24", type=Machine, multiplicity=Multiplicity(0, 1)),
        Property(name="processor25", type=Processor, multiplicity=Multiplicity(0, 1))
    }
)

# Domain Model
domain_model = DomainModel(
    name="bae7be9b_061d_491a_b5d6_19aedf56c780",
    types={CPU, Processor, Machine, AcceleratorCard, Cache, RAM, Program, Instruction, Memory_Interface, DeviceCard, Card, Sound, GenericSound, Vendor1Adapter, Vendor2Adapter, Vendor1Sound, Vendor2Sound, ExtensionBoard, FastCard},
    associations={Machine_Memory, Processor_Memory, Program_Instruction, Machine_Processor, Processor_Program, Cache_RAM, ExtensionBoard_Card, Vendor1Adapter_Vendor1Sound, Vendor2Adapter_Vendor2Sound, Machine_Card, AcceleratorCard_CPU, Machine_Processor2, Processor_Machine},
    generalizations={},
    metadata=None
)
