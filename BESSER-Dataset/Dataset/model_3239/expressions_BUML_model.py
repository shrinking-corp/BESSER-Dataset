...
# Classes
expressions_ast_ResourceRoot = Class(name="expressions_ast_ResourceRoot")
expressions_ast_Expression = Class(name="expressions_ast_Expression", is_abstract=True)
expressions_ast_TernaryExpression = Class(name="expressions_ast_TernaryExpression")
expressions_ast_BinaryExpression = Class(name="expressions_ast_BinaryExpression")
expressions_ast_AbstractRoot = Class(name="expressions_ast_AbstractRoot", is_abstract=True)
VariableReference = Class(name="VariableReference")
expressions_ast_ActionRoot = Class(name="expressions_ast_ActionRoot")
AbstractRoot = Class(name="AbstractRoot")
Expression = Class(name="Expression")
expressions_ast_LogicalRoot = Class(name="expressions_ast_LogicalRoot")
expressions_ast_AstVisitor = Class(name="expressions_ast_AstVisitor", is_abstract=True)
expressions_ast_UnaryExpression = Class(name="expressions_ast_UnaryExpression")
expressions_ast_VariableReference = Class(name="expressions_ast_VariableReference")
ast_expressions_EObject = Class(name="ast_expressions_EObject")
expressions_ast_Constant = Class(name="expressions_ast_Constant")
expressions_ast_Literal = Class(name="expressions_ast_Literal")
expressions_type_ResourceType = Class(name="expressions_type_ResourceType")
expressions_type_AnyType = Class(name="expressions_type_AnyType")
expressions_type_Type = Class(name="expressions_type_Type", is_abstract=True)
expressions_type_BaseType = Class(name="expressions_type_BaseType", is_abstract=True)
Type = Class(name="Type")
expressions_type_IntegerType = Class(name="expressions_type_IntegerType")
BaseType = Class(name="BaseType")
expressions_type_BooleanType = Class(name="expressions_type_BooleanType")
expressions_type_NaturalType = Class(name="expressions_type_NaturalType")
expressions_type_ClockType = Class(name="expressions_type_ClockType")
expressions_type_FloatType = Class(name="expressions_type_FloatType")
...
expressions_ast_Expression_m_visit: Method = Method(name="visit", parameters={Parameter(name='expressions_visitor', type=StringType)})
expressions_ast_Expression.attributes={expressions_ast_Expression_text, expressions_ast_Expression_type}
...
expressions_ast_AstVisitor_m_visitTernaryExpression: Method = Method(name="visitTernaryExpression", parameters={Parameter(name='expressions_node', type=StringType)})
expressions_ast_AstVisitor_m_visitBinaryExpression: Method = Method(name="visitBinaryExpression", parameters={Parameter(name='expressions_node', type=StringType)})
expressions_ast_AstVisitor_m_visitUnaryExpression: Method = Method(name="visitUnaryExpression", parameters={Parameter(name='expressions_node', type=StringType)})
expressions_ast_AstVisitor_m_visitVariableReference: Method = Method(name="visitVariableReference", parameters={Parameter(name='expressions_node', type=StringType)})
expressions_ast_AstVisitor_m_visitConstant: Method = Method(name="visitConstant", parameters={Parameter(name='expressions_node', type=StringType)})
expressions_ast_AstVisitor_m_visitLiteral: Method = Method(name="visitLiteral", parameters={Parameter(name='expressions_node', type=StringType)})
expressions_ast_AstVisitor.methods={expressions_ast_AstVisitor_m_visitLiteral, expressions_ast_AstVisitor_m_visitVariableReference, expressions_ast_AstVisitor_m_visitTernaryExpression, expressions_ast_AstVisitor_m_visitUnaryExpression, expressions_ast_AstVisitor_m_visitConstant, expressions_ast_AstVisitor_m_visitBinaryExpression}
...
expressions_type_Type_m_add: Method = Method(name="add", parameters={Parameter(name='expressions_rightArgument', type=StringType)}, type=StringType)
expressions_type_Type_m_getPrimitiveTypeIndex: Method = Method(name="getPrimitiveTypeIndex", parameters={}, type=IntegerType)
expressions_type_Type.methods={expressions_type_Type_m_add, expressions_type_Type_m_getPrimitiveTypeIndex}
...
domain_model = DomainModel(
    name="expressions",
    types={expressions_ast_ResourceRoot, expressions_ast_Expression, expressions_ast_TernaryExpression, expressions_ast_BinaryExpression, expressions_ast_AbstractRoot, VariableReference, expressions_ast_ActionRoot, AbstractRoot, Expression, expressions_ast_LogicalRoot, expressions_ast_AstVisitor, expressions_ast_UnaryExpression, expressions_ast_VariableReference, ast_expressions_EObject, expressions_ast_Constant, expressions_ast_Literal, expressions_type_ResourceType, expressions_type_AnyType, expressions_type_Type, expressions_type_BaseType, Type, expressions_type_IntegerType, BaseType, expressions_type_BooleanType, expressions_type_NaturalType, expressions_type_ClockType, expressions_type_FloatType, TernaryOperation, BinaryOperation, UnaryOperation, ResolvedType},
    associations={expression4, param16, param28, param311, param114, param216, referencedVariables0, expressions1, expression2, param119, arrayIndex21, resolved23},
    generalizations={gen_expressions_ast_ResourceRoot_AbstractRoot, gen_expressions_ast_TernaryExpression_Expression, gen_expressions_ast_BinaryExpression_Expression, gen_expressions_ast_ActionRoot_AbstractRoot, gen_expressions_ast_LogicalRoot_AbstractRoot, gen_expressions_ast_UnaryExpression_Expression, gen_expressions_ast_VariableReference_Expression, gen_expressions_ast_Constant_Expression, gen_expressions_ast_Literal_Expression, gen_expressions_type_ResourceType_BaseType, gen_expressions_type_AnyType_BaseType, gen_expressions_type_BaseType_Type, gen_expressions_type_IntegerType_BaseType, gen_expressions_type_BooleanType_BaseType, gen_expressions_type_NaturalType_BaseType, gen_expressions_type_ClockType_BaseType, gen_expressions_type_FloatType_BaseType},
    metadata=None
)
