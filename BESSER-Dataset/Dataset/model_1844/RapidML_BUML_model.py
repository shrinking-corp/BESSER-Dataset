...
# Classes
rapidml_ResourceDefinition = Class(name="rapidml_ResourceDefinition", is_abstract=True)
RESTElement = Class(name="RESTElement")
WithExamples = Class(name="WithExamples")
HasSecurityValue = Class(name="HasSecurityValue")
rapidml_Method = Class(name="rapidml_Method")
rapidml_MediaType = Class(name="rapidml_MediaType")
rapidml_MessageParameter = Class(name="rapidml_MessageParameter")
Extensible = Class(name="Extensible")
rapidml_TypedRequest = Class(name="rapidml_TypedRequest")
rapidml_TypedResponse = Class(name="rapidml_TypedResponse")
rapidml_URI = Class(name="rapidml_URI")
rapidml_TypedMessage = Class(name="rapidml_TypedMessage", is_abstract=True)
RealizationContainer = Class(name="RealizationContainer")
rapidml_SourceReference = Class(name="rapidml_SourceReference", is_abstract=True)
rapidml_RESTElement = Class(name="rapidml_RESTElement")
Documentable = Class(name="Documentable")
rapidml_Parameter = Class(name="rapidml_Parameter", is_abstract=True)
TypedMessage = Class(name="TypedMessage")
rapidml_Documentation = Class(name="rapidml_Documentation")
rapidml_Documentable = Class(name="rapidml_Documentable")
rapidml_URISegmentWithParameter = Class(name="rapidml_URISegmentWithParameter")
rapidml_MatrixParameter = Class(name="rapidml_MatrixParameter")
URIParameter = Class(name="URIParameter")
rapidml_TemplateParameter = Class(name="rapidml_TemplateParameter")
rapidml_CollectionResource = Class(name="rapidml_CollectionResource")
ServiceDataResource = Class(name="ServiceDataResource")
rapidml_CollectionParameter = Class(name="rapidml_CollectionParameter")
rapidml_CollectionReferenceElement = Class(name="rapidml_CollectionReferenceElement")
rapidml_URIParameter = Class(name="rapidml_URIParameter", is_abstract=True)
Parameter_ = Class(name="Parameter")
rapidml_PropertyReference = Class(name="rapidml_PropertyReference")
SourceReference = Class(name="SourceReference")
rapidml_PrimitiveProperty = Class(name="rapidml_PrimitiveProperty")
rapidml_ZenModel = Class(name="rapidml_ZenModel")
HasTitle = Class(name="HasTitle")
rapidml_ObjectResource = Class(name="rapidml_ObjectResource")
rapidml_SecuritySchemeLibrary = Class(name="rapidml_SecuritySchemeLibrary")
rapidml_LinkRelation = Class(name="rapidml_LinkRelation")
rapidml_ReferenceRealization = Class(name="rapidml_ReferenceRealization")
rapidml_RealizationModelLocation = Class(name="rapidml_RealizationModelLocation")
rapidml_ResourceAPI = Class(name="rapidml_ResourceAPI")
rapidml_DataModel = Class(name="rapidml_DataModel")
rapidml_MediaTypesLibrary = Class(name="rapidml_MediaTypesLibrary")
rapidml_LinkRelationsLibrary = Class(name="rapidml_LinkRelationsLibrary")
rapidml_PrimitiveTypesLibrary = Class(name="rapidml_PrimitiveTypesLibrary")
rapidml_ImportDeclaration = Class(name="rapidml_ImportDeclaration")
rapidml_NamedLinkDescriptor = Class(name="rapidml_NamedLinkDescriptor")
rapidml_ReferenceTreatment = Class(name="rapidml_ReferenceTreatment")
rapidml_ReferenceElement = Class(name="rapidml_ReferenceElement", is_abstract=True)
rapidml_ReferenceLink = Class(name="rapidml_ReferenceLink")
ReferenceTreatment = Class(name="ReferenceTreatment")
rapidml_ServiceDataResource = Class(name="rapidml_ServiceDataResource")
ResourceDefinition = Class(name="ResourceDefinition")
ObjectRealization = Class(name="ObjectRealization")
rapidml_PathSegment = Class(name="rapidml_PathSegment", is_abstract=True)
rapidml_PrimitiveTypeSourceReference = Class(name="rapidml_PrimitiveTypeSourceReference")
rapidml_PrimitiveType = Class(name="rapidml_PrimitiveType")
HasStringValue = Class(name="HasStringValue")
rapidml_URISegment = Class(name="rapidml_URISegment")
URISegment = Class(name="URISegment")
rapidml_ReferenceEmbed = Class(name="rapidml_ReferenceEmbed")
rapidml_WithExamples = Class(name="rapidml_WithExamples", is_abstract=True)
rapidml_Example = Class(name="rapidml_Example", is_abstract=True)
rapidml_InlineExample = Class(name="rapidml_InlineExample")
Example = Class(name="Example")
rapidml_ExternalExample = Class(name="rapidml_ExternalExample")
rapidml_HasStringValue = Class(name="rapidml_HasStringValue", is_abstract=True)
rapidml_ObjectRealization = Class(name="rapidml_ObjectRealization")
rapidml_PropertyRealization = Class(name="rapidml_PropertyRealization")
ConstrainableType = Class(name="ConstrainableType")
rapidml_Feature = Class(name="rapidml_Feature", is_abstract=True)
ReferenceElement = Class(name="ReferenceElement")
rapidml_HasSecurityValue = Class(name="rapidml_HasSecurityValue", is_abstract=True)
rapidml_AuthenticationMethod = Class(name="rapidml_AuthenticationMethod")
rapidml_SecurityScheme = Class(name="rapidml_SecurityScheme")
rapidml_SecurityScope = Class(name="rapidml_SecurityScope")
rapidml_SecuritySchemeParameter = Class(name="rapidml_SecuritySchemeParameter")
rapidml_RealizationContainer = Class(name="rapidml_RealizationContainer", is_abstract=True)
rapidml_Extension = Class(name="rapidml_Extension")
rapidml_HasTitle = Class(name="rapidml_HasTitle", is_abstract=True)
rapidml_Structure = Class(name="rapidml_Structure")
rapidml_Extensible = Class(name="rapidml_Extensible", is_abstract=True)
rapidml_ReferenceProperty = Class(name="rapidml_ReferenceProperty")
Feature = Class(name="Feature")
rapidml_SingleValueType = Class(name="rapidml_SingleValueType", is_abstract=True)
DataType = Class(name="DataType")
WithDataExamples = Class(name="WithDataExamples")
rapidml_Operation = Class(name="rapidml_Operation")
Element = Class(name="Element")
rapidml_Inheritable = Class(name="rapidml_Inheritable", is_abstract=True)
rapidml_DataType = Class(name="rapidml_DataType", is_abstract=True)
rapidml_WithDataExamples = Class(name="rapidml_WithDataExamples", is_abstract=True)
rapidml_DataExample = Class(name="rapidml_DataExample", is_abstract=True)
rapidml_InlineDataExample = Class(name="rapidml_InlineDataExample")
DataExample = Class(name="DataExample")
rapidml_Constraint = Class(name="rapidml_Constraint", is_abstract=True)
Inheritable = Class(name="Inheritable")
rapidml_UserDefinedType = Class(name="rapidml_UserDefinedType")
SimpleType = Class(name="SimpleType")
rapidml_Enumeration = Class(name="rapidml_Enumeration")
SingleValueType = Class(name="SingleValueType")
rapidml_EnumConstant = Class(name="rapidml_EnumConstant")
rapidml_SimpleType = Class(name="rapidml_SimpleType", is_abstract=True)
rapidml_LengthConstraint = Class(name="rapidml_LengthConstraint")
Constraint = Class(name="Constraint")
rapidml_RegExConstraint = Class(name="rapidml_RegExConstraint")
rapidml_ValueRangeConstraint = Class(name="rapidml_ValueRangeConstraint")
rapidml_ConstrainableType = Class(name="rapidml_ConstrainableType", is_abstract=True)
rapidml_Element = Class(name="rapidml_Element", is_abstract=True)
...
rapidml_MediaType_m_equals: Method = Method(name="equals", parameters={Parameter(name='rapidml_other', type=StringType)}, type=BooleanType)
...
rapidml_TypedMessage_m_isIncluded: Method = Method(name="isIncluded", parameters={Parameter(name='rapidml_feature', type=StringType)}, type=BooleanType)
...
rapidml_TypedMessage.methods={rapidml_TypedMessage_m_getAllExamples, rapidml_TypedMessage_m_isIncluded, rapidml_TypedMessage_m_getReferenceLinks, rapidml_TypedMessage_m_getActualType, rapidml_TypedMessage_m_getIncludedProperties}
...
rapidml_SourceReference.methods={rapidml_SourceReference_m_getType, rapidml_SourceReference_m_getConstraints, rapidml_SourceReference_m_getPrimitiveType}
...
rapidml_Parameter.attributes={rapidml_Parameter_default, rapidml_Parameter_name, rapidml_Parameter_required, rapidml_Parameter_fixed}
rapidml_Parameter.methods={rapidml_Parameter_m_getConstraints, rapidml_Parameter_m_getType, rapidml_Parameter_m_getPrimitiveType}
...
rapidml_PropertyReference.methods={rapidml_PropertyReference_m_getConstraints, rapidml_PropertyReference_m_getType}
...
rapidml_ZenModel.attributes={rapidml_ZenModel_namespace, rapidml_ZenModel_name}
...
rapidml_ReferenceRealization.attributes={rapidml_ReferenceRealization_multiValued, rapidml_ReferenceRealization_realizationType}
...
rapidml_ResourceAPI.attributes={rapidml_ResourceAPI_baseURI, rapidml_ResourceAPI_version, rapidml_ResourceAPI_name}
...
rapidml_ImportDeclaration.attributes={rapidml_ImportDeclaration_alias, rapidml_ImportDeclaration_importURI, rapidml_ImportDeclaration_importedNamespace}
...
rapidml_ReferenceTreatment.methods={rapidml_ReferenceTreatment_m_getLinkDescriptor, rapidml_ReferenceTreatment_m_getEmbedHierarchy}
...
rapidml_ReferenceLink.attributes={rapidml_ReferenceLink_collectionRealizationLevel, rapidml_ReferenceLink_name}
...
rapidml_ServiceDataResource_m_isIncluded: Method = Method(name="isIncluded", parameters={Parameter(name='rapidml_feature', type=StringType)}, type=BooleanType)
...
rapidml_ServiceDataResource.methods={rapidml_ServiceDataResource_m_getDefaultLinkDescriptor, rapidml_ServiceDataResource_m_getReferenceLinks, rapidml_ServiceDataResource_m_isIncluded, rapidml_ServiceDataResource_m_getIncludedProperties, rapidml_ServiceDataResource_m_getAllReferenceTreatments}
...
rapidml_Feature.attributes={rapidml_Feature_readOnly, rapidml_Feature_key, rapidml_Feature_restriction, rapidml_Feature_name}
...
rapidml_SecurityScheme.attributes={rapidml_SecurityScheme_flow, rapidml_SecurityScheme_name, rapidml_SecurityScheme_type}
...
rapidml_SecuritySchemeParameter.attributes={rapidml_SecuritySchemeParameter_value, rapidml_SecuritySchemeParameter_name}
...
rapidml_RealizationContainer.attributes={rapidml_RealizationContainer_withDefaultRealization, rapidml_RealizationContainer_effectiveRealization, rapidml_RealizationContainer_realizationName}
...
rapidml_Extension.attributes={rapidml_Extension_value, rapidml_Extension_name}
...
rapidml_Structure.methods={rapidml_Structure_m_getAllPrimitiveProperties, rapidml_Structure_m_getReferenceProperties, rapidml_Structure_m_getPrimitiveProperties}
...
rapidml_ReferenceProperty.attributes={rapidml_ReferenceProperty_containment, rapidml_ReferenceProperty_container}
...
rapidml_Constraint_m_supports: Method = Method(name="supports", parameters={Parameter(name='rapidml_type', type=StringType)}, type=BooleanType)
...
rapidml_EnumConstant.attributes={rapidml_EnumConstant_literalValue, rapidml_EnumConstant_integerValue, rapidml_EnumConstant_name}
...
rapidml_ValueRangeConstraint.attributes={rapidml_ValueRangeConstraint_maxValue, rapidml_ValueRangeConstraint_maxValueExclusive, rapidml_ValueRangeConstraint_minValueExclusive, rapidml_ValueRangeConstraint_minValue}
...
rapidml_Element.methods={rapidml_Element_m_isMultiValued, rapidml_Element_m_getMaxOccurs, rapidml_Element_m_getMinOccurs, rapidml_Element_m_getDataType}
...
domain_model = DomainModel(
    name="rapidml",
    types={rapidml_ResourceDefinition, RESTElement, WithExamples, HasSecurityValue, rapidml_Method, rapidml_MediaType, rapidml_MessageParameter, Extensible, rapidml_TypedRequest, rapidml_TypedResponse, rapidml_URI, rapidml_TypedMessage, RealizationContainer, rapidml_SourceReference, rapidml_RESTElement, Documentable, rapidml_Parameter, TypedMessage, rapidml_Documentation, rapidml_Documentable, rapidml_URISegmentWithParameter, rapidml_MatrixParameter, URIParameter, rapidml_TemplateParameter, rapidml_CollectionResource, ServiceDataResource, rapidml_CollectionParameter, rapidml_CollectionReferenceElement, rapidml_URIParameter, Parameter_, rapidml_PropertyReference, SourceReference, rapidml_PrimitiveProperty, rapidml_ZenModel, HasTitle, rapidml_ObjectResource, rapidml_SecuritySchemeLibrary, rapidml_LinkRelation, rapidml_ReferenceRealization, rapidml_RealizationModelLocation, rapidml_ResourceAPI, rapidml_DataModel, rapidml_MediaTypesLibrary, rapidml_LinkRelationsLibrary, rapidml_PrimitiveTypesLibrary, rapidml_ImportDeclaration, rapidml_NamedLinkDescriptor, rapidml_ReferenceTreatment, rapidml_ReferenceElement, rapidml_ReferenceLink, ReferenceTreatment, rapidml_ServiceDataResource, ResourceDefinition, ObjectRealization, rapidml_PathSegment, rapidml_PrimitiveTypeSourceReference, rapidml_PrimitiveType, HasStringValue, rapidml_URISegment, URISegment, rapidml_ReferenceEmbed, rapidml_WithExamples, rapidml_Example, rapidml_InlineExample, Example, rapidml_ExternalExample, rapidml_HasStringValue, rapidml_ObjectRealization, rapidml_PropertyRealization, ConstrainableType, rapidml_Feature, ReferenceElement, rapidml_HasSecurityValue, rapidml_AuthenticationMethod, rapidml_SecurityScheme, rapidml_SecurityScope, rapidml_SecuritySchemeParameter, rapidml_RealizationContainer, rapidml_Extension, rapidml_HasTitle, rapidml_Structure, rapidml_Extensible, rapidml_ReferenceProperty, Feature, rapidml_SingleValueType, DataType, WithDataExamples, rapidml_Operation, Element, rapidml_Inheritable, rapidml_DataType, rapidml_WithDataExamples, rapidml_DataExample, rapidml_InlineDataExample, DataExample, rapidml_Constraint, Inheritable, rapidml_UserDefinedType, SimpleType, rapidml_Enumeration, SingleValueType, rapidml_EnumConstant, rapidml_SimpleType, rapidml_LengthConstraint, Constraint, rapidml_RegExConstraint, rapidml_ValueRangeConstraint, rapidml_ConstrainableType, rapidml_Element, HTTPMethods, ReferenceRealizationEnum, HttpMessageParameterLocation, CollectionRealizationEnum, AuthenticationTypes, AuthenticationFlows, CollectionRealizationLevelEnum},
    associations={methods0, mediaTypes1, allMediaTypes2, parameters7, resourceType8, mediaTypes10, request13, responses14, URI5, sourceReference17, containingResourceDefinition16, derivedFrom20, containingMethod22, documentation18, uriSegment26, containingURI27, collectionParameters28, containingMethod24, conceptualFeature32, containingParameter33, containingMessage34, referenceElements30, containingResourceDefinition31, imports44, securitySchemesLibrary46, ownedResourceDefinitions48, serviceDataModels51, formats54, definedMediaTypes57, definedLinkRelations60, defaultReferenceRealizations62, resourceAPIs35, dataModels36, mediaTypesLibrary38, linkRelationsLibrary40, primitiveTypesLibrary42, definedLinkDescriptors66, referenceElement67, referenceRealization68, ownedReferenceRealization71, targetResource74, autoRealizations64, referenceElement79, simpleType81, segments82, uriParameters84, linkRelation77, examples86, importedModel87, baseProperty85, securedBy99, scopes100, settings101, parameters103, exclusivePropertyList90, overriddenPropertyList92, excludedProperties95, realizationContainer98, securitySchemes113, inlineObjectRealization116, properties117, errorResponses105, scheme107, scopes110, extensions124, mediaTypes125, definedLinkRelations128, referenceTreatments119, dataType122, containingDataType134, type135, inverse138, type140, primitiveTypes131, ownedOperations146, supertypes148, allSupertypes150, ownedDataTypes153, dataExamples155, ownedFeatures142, ownedElements144, enumeration159, baseType160, enumConstants156, baseType157, dataType161, constraints164},
    generalizations={gen_rapidml_ResourceDefinition_RESTElement, gen_rapidml_ResourceDefinition_WithExamples, gen_rapidml_ResourceDefinition_HasSecurityValue, gen_rapidml_Method_RESTElement, gen_rapidml_Method_HasSecurityValue, gen_rapidml_Method_Extensible, gen_rapidml_TypedMessage_RealizationContainer, gen_rapidml_TypedMessage_RESTElement, gen_rapidml_TypedMessage_WithExamples, gen_rapidml_RESTElement_Documentable, gen_rapidml_RESTElement_Extensible, gen_rapidml_Parameter_RESTElement, gen_rapidml_Parameter_Extensible, gen_rapidml_TypedRequest_TypedMessage, gen_rapidml_TypedResponse_TypedMessage, gen_rapidml_MediaType_RESTElement, gen_rapidml_MatrixParameter_URIParameter, gen_rapidml_TemplateParameter_URIParameter, gen_rapidml_CollectionResource_ServiceDataResource, gen_rapidml_URIParameter_Parameter, gen_rapidml_PropertyReference_SourceReference, gen_rapidml_MessageParameter_Parameter, gen_rapidml_ZenModel_Documentable, gen_rapidml_ZenModel_Extensible, gen_rapidml_ZenModel_HasTitle, gen_rapidml_ObjectResource_ServiceDataResource, gen_rapidml_CollectionParameter_Parameter, gen_rapidml_ResourceAPI_RESTElement, gen_rapidml_ResourceAPI_HasSecurityValue, gen_rapidml_ResourceAPI_HasTitle, gen_rapidml_ReferenceTreatment_Extensible, gen_rapidml_ReferenceRealization_RealizationContainer, gen_rapidml_ServiceDataResource_RealizationContainer, gen_rapidml_ServiceDataResource_ResourceDefinition, gen_rapidml_NamedLinkDescriptor_ObjectRealization, gen_rapidml_PrimitiveTypeSourceReference_SourceReference, gen_rapidml_URI_HasStringValue, gen_rapidml_URISegment_HasStringValue, gen_rapidml_URISegmentWithParameter_URISegment, gen_rapidml_ReferenceLink_ReferenceTreatment, gen_rapidml_ReferenceEmbed_ReferenceTreatment, gen_rapidml_InlineExample_Example, gen_rapidml_ExternalExample_Example, gen_rapidml_ObjectRealization_Extensible, gen_rapidml_PropertyRealization_ConstrainableType, gen_rapidml_LinkRelation_Documentable, gen_rapidml_CollectionReferenceElement_ReferenceElement, gen_rapidml_SecurityScheme_Documentable, gen_rapidml_SecurityScheme_RESTElement, gen_rapidml_SecuritySchemeParameter_Documentable, gen_rapidml_SecuritySchemeLibrary_Documentable, gen_rapidml_RealizationContainer_Extensible, gen_rapidml_SecurityScope_Documentable, gen_rapidml_ReferenceProperty_Feature, gen_rapidml_ReferenceProperty_ReferenceElement, gen_rapidml_PrimitiveProperty_Feature, gen_rapidml_PrimitiveProperty_HasStringValue, gen_rapidml_PrimitiveProperty_ConstrainableType, gen_rapidml_Structure_DataType, gen_rapidml_Structure_WithDataExamples, gen_rapidml_Operation_Documentable, gen_rapidml_Feature_Documentable, gen_rapidml_Feature_Element, gen_rapidml_Feature_Extensible, gen_rapidml_DataModel_Documentable, gen_rapidml_DataModel_HasTitle, gen_rapidml_InlineDataExample_DataExample, gen_rapidml_Constraint_Extensible, gen_rapidml_Structure_Inheritable, gen_rapidml_EnumConstant_Documentable, gen_rapidml_UserDefinedType_SimpleType, gen_rapidml_UserDefinedType_ConstrainableType, gen_rapidml_PrimitiveType_SimpleType, gen_rapidml_DataType_Documentable, gen_rapidml_DataType_Extensible, gen_rapidml_SingleValueType_DataType, gen_rapidml_Enumeration_SingleValueType, gen_rapidml_SimpleType_SingleValueType, gen_rapidml_LengthConstraint_Constraint, gen_rapidml_RegExConstraint_Constraint, gen_rapidml_ValueRangeConstraint_Constraint, gen_rapidml_ConstrainableType_Extensible, gen_rapidml_ReferenceElement_Element},
    metadata=None
)
