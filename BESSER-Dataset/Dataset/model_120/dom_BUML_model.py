...
UnaryOperator: Enumeration = Enumeration(
    ...
    literals={
			...
			EnumerationLiteral(name="yield_")
    }
)

# Classes
dom_Node = Class(name="dom_Node", is_abstract=True)
dom_Comment = Class(name="dom_Comment")
Node = Class(name="Node")
dom_Identifier = Class(name="dom_Identifier")
IPropertyName = Class(name="IPropertyName")
IPropertySelector = Class(name="IPropertySelector")
IProperty = Class(name="IProperty")
dom_VariableReference = Class(name="dom_VariableReference")
Expression = Class(name="Expression")
dom_RegularExpressionLiteral = Class(name="dom_RegularExpressionLiteral")
dom_ThisExpression = Class(name="dom_ThisExpression")
dom_ArrayLiteral = Class(name="dom_ArrayLiteral")
dom_IArrayElement = Class(name="dom_IArrayElement", is_abstract=True)
dom_Elision = Class(name="dom_Elision")
dom_ObjectLiteral = Class(name="dom_ObjectLiteral")
dom_PropertyAssignment = Class(name="dom_PropertyAssignment", is_abstract=True)
dom_IPropertyName = Class(name="dom_IPropertyName", is_abstract=True)
dom_Label = Class(name="dom_Label")
...
dom_NumericLiteral = Class(name="dom_NumericLiteral")
dom_StringLiteral = Class(name="dom_StringLiteral")
dom_PropertyAccessExpression = Class(name="dom_PropertyAccessExpression")
dom_IProperty = Class(name="dom_IProperty", is_abstract=True)
dom_NewExpression = Class(name="dom_NewExpression")
dom_CallExpression = Class(name="dom_CallExpression")
dom_UnaryExpression = Class(name="dom_UnaryExpression")
dom_SimplePropertyAssignment = Class(name="dom_SimplePropertyAssignment")
PropertyAssignment = Class(name="PropertyAssignment")
dom_AccessorAssignment = Class(name="dom_AccessorAssignment", is_abstract=True)
dom_BlockStatement = Class(name="dom_BlockStatement")
dom_GetterAssignment = Class(name="dom_GetterAssignment")
AccessorAssignment = Class(name="AccessorAssignment")
dom_SetterAssignment = Class(name="dom_SetterAssignment")
dom_ParenthesizedExpression = Class(name="dom_ParenthesizedExpression")
dom_ArrayAccessExpression = Class(name="dom_ArrayAccessExpression")
dom_BinaryExpression = Class(name="dom_BinaryExpression")
dom_VariableDeclaration = Class(name="dom_VariableDeclaration")
...
dom_VariableStatement = Class(name="dom_VariableStatement")
dom_IterationStatement = Class(name="dom_IterationStatement", is_abstract=True)
...
dom_IForInitializer = Class(name="dom_IForInitializer", is_abstract=True)
dom_IfStatement = Class(name="dom_IfStatement")
dom_ReturnStatement = Class(name="dom_ReturnStatement")
dom_WithStatement = Class(name="dom_WithStatement")
dom_SwitchStatement = Class(name="dom_SwitchStatement")
dom_SwitchElement = Class(name="dom_SwitchElement", is_abstract=True)
dom_CaseClause = Class(name="dom_CaseClause")
SwitchElement = Class(name="SwitchElement")
dom_ForInStatement = Class(name="dom_ForInStatement")
dom_ContinueStatement = Class(name="dom_ContinueStatement")
dom_BreakStatement = Class(name="dom_BreakStatement")
dom_FinallyClause = Class(name="dom_FinallyClause")
dom_FunctionExpression = Class(name="dom_FunctionExpression")
dom_Parameter = Class(name="dom_Parameter")
dom_DefaultClause = Class(name="dom_DefaultClause")
...
dom_XmlInitializer = Class(name="dom_XmlInitializer")
dom_XmlFragment = Class(name="dom_XmlFragment", is_abstract=True)
dom_AttributeIdentifier = Class(name="dom_AttributeIdentifier")
PropertyIdentifier = Class(name="PropertyIdentifier")
dom_ISelector = Class(name="dom_ISelector", is_abstract=True)
dom_QualifiedIdentifier = Class(name="dom_QualifiedIdentifier")
ISelector = Class(name="ISelector")
dom_IPropertySelector = Class(name="dom_IPropertySelector", is_abstract=True)
dom_IUnqualifiedSelector = Class(name="dom_IUnqualifiedSelector", is_abstract=True)
dom_WildcardIdentifier = Class(name="dom_WildcardIdentifier")
IUnqualifiedSelector = Class(name="IUnqualifiedSelector")
dom_ExpressionSelector = Class(name="dom_ExpressionSelector")
dom_Source = Class(name="dom_Source")
dom_ConstStatement = Class(name="dom_ConstStatement")
dom_PropertyIdentifier = Class(name="dom_PropertyIdentifier", is_abstract=True)
dom_DefaultXmlNamespaceStatement = Class(name="dom_DefaultXmlNamespaceStatement")
dom_ForEachInStatement = Class(name="dom_ForEachInStatement")
dom_XmlTextFragment = Class(name="dom_XmlTextFragment")
XmlFragment = Class(name="XmlFragment")
dom_XmlExpressionFragment = Class(name="dom_XmlExpressionFragment")
dom_DescendantAccessExpression = Class(name="dom_DescendantAccessExpression")
dom_FilterExpression = Class(name="dom_FilterExpression")
...
domain_model = DomainModel(
    name="dom",
    types={dom_Node, dom_Comment, Node, dom_Identifier, IPropertyName, IPropertySelector, IProperty, dom_VariableReference, Expression, dom_RegularExpressionLiteral, dom_ThisExpression, dom_ArrayLiteral, dom_IArrayElement, dom_Elision, dom_ObjectLiteral, dom_PropertyAssignment, dom_IPropertyName, dom_Label, dom_Expression, IArrayElement, IForInitializer, dom_NullLiteral, dom_BooleanLiteral, dom_NumericLiteral, dom_StringLiteral, dom_PropertyAccessExpression, dom_IProperty, dom_NewExpression, dom_CallExpression, dom_UnaryExpression, dom_SimplePropertyAssignment, PropertyAssignment, dom_AccessorAssignment, dom_BlockStatement, dom_GetterAssignment, AccessorAssignment, dom_SetterAssignment, dom_ParenthesizedExpression, dom_ArrayAccessExpression, dom_BinaryExpression, dom_VariableDeclaration, dom_EmptyStatement, dom_ExpressionStatement, dom_ConditionalExpression, dom_Statement, Statement, dom_VariableStatement, dom_IterationStatement, dom_DoStatement, IterationStatement, dom_WhileStatement, dom_ForStatement, dom_IForInitializer, dom_IfStatement, dom_ReturnStatement, dom_WithStatement, dom_SwitchStatement, dom_SwitchElement, dom_CaseClause, SwitchElement, dom_ForInStatement, dom_ContinueStatement, dom_BreakStatement, dom_FinallyClause, dom_FunctionExpression, dom_Parameter, dom_DefaultClause, dom_LabeledStatement, dom_ThrowStatement, dom_TryStatement, dom_CatchClause, dom_XmlInitializer, dom_XmlFragment, dom_AttributeIdentifier, PropertyIdentifier, dom_ISelector, dom_QualifiedIdentifier, ISelector, dom_IPropertySelector, dom_IUnqualifiedSelector, dom_WildcardIdentifier, IUnqualifiedSelector, dom_ExpressionSelector, dom_Source, dom_ConstStatement, dom_PropertyIdentifier, dom_DefaultXmlNamespaceStatement, dom_ForEachInStatement, dom_XmlTextFragment, XmlFragment, dom_XmlExpressionFragment, dom_DescendantAccessExpression, dom_FilterExpression, BinaryOperator, UnaryOperator},
    associations={elements1, properties2, name3, variable0, array11, index13, object16, property18, constructor20, arguments22, applicant25, arguments27, argument30, initializer5, body6, parameter7, enclosed9, left32, right34, declarations47, identifier48, initializer51, predicate37, consequent39, alternative42, statements45, consequent58, alternative61, body64, condition66, condition68, initialization70, expression54, predicate56, expression85, expression87, statement89, selector92, elements94, statements96, condition71, increment74, item77, collection79, label82, label83, finallyClause112, exception114, filter117, body120, body123, documentation126, identifier127, parameters130, body132, expression99, label101, statement103, exception106, body108, catches110, fragments142, selector143, namespace144, member145, index147, name135, statements138, declarations140, object156, filter158, expression161, item163, collection165, expression149, object151, property153},
    generalizations={gen_dom_Comment_Node, gen_dom_Identifier_Node, gen_dom_Identifier_IPropertyName, gen_dom_Identifier_IPropertySelector, gen_dom_Identifier_IProperty, gen_dom_VariableReference_Expression, gen_dom_RegularExpressionLiteral_Expression, gen_dom_ThisExpression_Expression, gen_dom_ArrayLiteral_Expression, gen_dom_IArrayElement_Node, gen_dom_Elision_IArrayElement, gen_dom_ObjectLiteral_Expression, gen_dom_PropertyAssignment_Node, gen_dom_Label_Node, gen_dom_Expression_Node, gen_dom_Expression_IArrayElement, gen_dom_Expression_IForInitializer, gen_dom_NullLiteral_Expression, gen_dom_BooleanLiteral_Expression, gen_dom_NumericLiteral_Expression, gen_dom_NumericLiteral_IPropertyName, gen_dom_StringLiteral_Expression, gen_dom_StringLiteral_IPropertyName, gen_dom_PropertyAccessExpression_Expression, gen_dom_NewExpression_Expression, gen_dom_CallExpression_Expression, gen_dom_UnaryExpression_Expression, gen_dom_IPropertyName_Node, gen_dom_SimplePropertyAssignment_PropertyAssignment, gen_dom_AccessorAssignment_PropertyAssignment, gen_dom_GetterAssignment_AccessorAssignment, gen_dom_SetterAssignment_AccessorAssignment, gen_dom_ParenthesizedExpression_Expression, gen_dom_ArrayAccessExpression_Expression, gen_dom_BinaryExpression_Expression, gen_dom_VariableStatement_Statement, gen_dom_VariableStatement_IForInitializer, gen_dom_VariableDeclaration_Node, gen_dom_EmptyStatement_Statement, gen_dom_ExpressionStatement_Statement, gen_dom_ConditionalExpression_Expression, gen_dom_Statement_Node, gen_dom_BlockStatement_Statement, gen_dom_IterationStatement_Statement, gen_dom_DoStatement_IterationStatement, gen_dom_WhileStatement_IterationStatement, gen_dom_ForStatement_IterationStatement, gen_dom_IfStatement_Statement, gen_dom_ReturnStatement_Statement, gen_dom_WithStatement_Statement, gen_dom_SwitchStatement_Statement, gen_dom_SwitchElement_Node, gen_dom_CaseClause_SwitchElement, gen_dom_IForInitializer_Node, gen_dom_ForInStatement_IterationStatement, gen_dom_ContinueStatement_Statement, gen_dom_BreakStatement_Statement, gen_dom_CatchClause_Node, gen_dom_FinallyClause_Node, gen_dom_FunctionExpression_Expression, gen_dom_DefaultClause_SwitchElement, gen_dom_LabeledStatement_Statement, gen_dom_ThrowStatement_Statement, gen_dom_TryStatement_Statement, gen_dom_XmlInitializer_Expression, gen_dom_AttributeIdentifier_PropertyIdentifier, gen_dom_ISelector_Node, gen_dom_QualifiedIdentifier_PropertyIdentifier, gen_dom_QualifiedIdentifier_ISelector, gen_dom_IUnqualifiedSelector_ISelector, gen_dom_WildcardIdentifier_PropertyIdentifier, gen_dom_WildcardIdentifier_IPropertySelector, gen_dom_IPropertySelector_IUnqualifiedSelector, gen_dom_ExpressionSelector_IUnqualifiedSelector, gen_dom_XmlFragment_Node, gen_dom_Parameter_Node, gen_dom_Source_Node, gen_dom_ConstStatement_Statement, gen_dom_PropertyIdentifier_Expression, gen_dom_PropertyIdentifier_IProperty, gen_dom_IProperty_Node, gen_dom_DefaultXmlNamespaceStatement_Statement, gen_dom_ForEachInStatement_IterationStatement, gen_dom_XmlTextFragment_XmlFragment, gen_dom_XmlExpressionFragment_XmlFragment, gen_dom_DescendantAccessExpression_Expression, gen_dom_FilterExpression_Expression},
    metadata=None
)
