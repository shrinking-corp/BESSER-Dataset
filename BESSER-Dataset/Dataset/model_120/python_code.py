...
class dom_BinaryExpression(Expression):
    ...
    def __init__(self, operatorPosition: int, operation: str, dom_BinaryExpression: "dom_Expression" = None, dom_BinaryExpression35: "dom_Expression" = None):
...
class dom_Source(Node):
    ...
    pass
class dom_Identifier(IPropertyName, IProperty, Node, IPropertySelector):
...
class dom_Expression(IForInitializer, IArrayElement, Node):
