...
trace_TraceRecord = Class(name="trace_TraceRecord")
trace_MappingOperationToTraceRecordMapEntry = Class(name="trace_MappingOperationToTraceRecordMapEntry")
trace_ObjectToTraceRecordMapEntry = Class(name="trace_ObjectToTraceRecordMapEntry")
trace_EObject = Class(name="trace_EObject")
trace_ETuplePartValue = Class(name="trace_ETuplePartValue")
EValue = Class(name="EValue")
trace_EMappingOperation = Class(name="trace_EMappingOperation")
trace_EMappingContext = Class(name="trace_EMappingContext")
trace_EMappingParameters = Class(name="trace_EMappingParameters")
trace_EMappingResults = Class(name="trace_EMappingResults")
trace_VarParameterValue = Class(name="trace_VarParameterValue")
trace_EValue = Class(name="trace_EValue")
MappingOperation = Class(name="MappingOperation")

# trace_Trace class attributes and methods
trace_Trace_m_getRecordBySource: Method = Method(name="getRecordBySource", parameters={Parameter(name='trace_mapping', type=StringType), Parameter(name='trace_sourceObject', type=StringType)}, type=StringType)
trace_Trace_m_addRecordBySource: Method = Method(name="addRecordBySource", parameters={Parameter(name='trace_mapping', type=StringType), Parameter(name='trace_sourceObject', type=StringType), Parameter(name='trace_trace', type=StringType)})
trace_Trace.methods={trace_Trace_m_getRecordBySource, trace_Trace_m_addRecordBySource}
...
trace_EMappingOperation.attributes={trace_EMappingOperation_package, trace_EMappingOperation_name, trace_EMappingOperation_module}
...
trace_VarParameterValue.attributes={trace_VarParameterValue_type, trace_VarParameterValue_name, trace_VarParameterValue_kind}
...
trace_EValue.attributes={trace_EValue_collectionType, trace_EValue_primitiveValue, trace_EValue_oclObject}
...
domain_model = DomainModel(
    name="trace",
    types={trace_Trace, trace_TraceRecord, trace_MappingOperationToTraceRecordMapEntry, trace_ObjectToTraceRecordMapEntry, trace_EObject, trace_ETuplePartValue, EValue, trace_EMappingOperation, trace_EMappingContext, trace_EMappingParameters, trace_EMappingResults, trace_VarParameterValue, trace_EValue, MappingOperation, EDirectionKind},
    associations={traceRecords0, traceRecordMap1, sourceToTraceRecordMap3, targetToTraceRecordMap5, modelElement25, intermediateElement27, collection31, value33, context35, mappingOperation8, context10, parameters12, result14, value16, value17, key20, runtimeMappingOperation22, parameters38, result41, value44},
