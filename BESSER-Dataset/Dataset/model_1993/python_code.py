...
class trace_EValue:
    ...
    def __init__(self, primitiveValue: str, oclObject: str, collectionType: str, trace_EValue26: "trace_EObject" = None, trace_EValue32: "trace_EValue" = None, trace_EValue30: set["trace_EValue"] = None, trace_EValue34: "trace_ETuplePartValue" = None, trace_EValue: "trace_VarParameterValue" = None, trace_EValue28: "trace_EObject" = None):
...
class trace_VarParameterValue:
    ...
    def __init__(self, kind: str, name: str, type: str, trace_VarParameterValue37: "trace_EMappingContext" = None, trace_VarParameterValue: "trace_EValue" = None, trace_VarParameterValue40: "trace_EMappingParameters" = None, trace_VarParameterValue43: "trace_EMappingResults" = None):
        self.kind = kind
        self.name = name
        self.type = type
...
class trace_EMappingOperation:
    ...
    def __init__(self, name: str, package: str, module: str, trace_EMappingOperation: "trace_TraceRecord" = None, trace_EMappingOperation23: "MappingOperation" = None):
        self.name = name
...
class trace_Trace:
    ...
    def addRecordBySource(self, trace_trace, trace_sourceObject, trace_mapping):
        # TODO: Implement addRecordBySource method
        pass

    def getRecordBySource(self, trace_mapping, trace_sourceObject) :
