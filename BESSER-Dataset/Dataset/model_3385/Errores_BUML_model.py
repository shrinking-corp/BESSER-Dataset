...
# Classes
errors_ColumnCk = Class(name="errors_ColumnCk")
errors_Errores = Class(name="errors_Errores")
errors_Error = Class(name="errors_Error")
errors_ForeignError = Class(name="errors_ForeignError")
Error = Class(name="Error")
errors_Table = Class(name="errors_Table")
errors_ColumnFk = Class(name="errors_ColumnFk")
errors_CheckError = Class(name="errors_CheckError")
errors_ValueCk = Class(name="errors_ValueCk")
...
errors_ForeignError.attributes={errors_ForeignError_nameFk, errors_ForeignError_porcent}
...
errors_CheckError.attributes={errors_CheckError_porcent, errors_CheckError_nameTable, errors_CheckError_nameCk}
...
domain_model = DomainModel(
    name="errors",
    types={errors_ColumnCk, errors_Errores, errors_Error, errors_ForeignError, Error, errors_Table, errors_ColumnFk, errors_CheckError, errors_ValueCk},
    associations={columns7, errores0, tableCont1, tableRef2, columnCont5, values8},
