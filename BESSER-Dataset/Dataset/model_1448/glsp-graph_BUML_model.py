...
graph_StringToObjectMapEntry = Class(name="graph_StringToObjectMapEntry")
...
graph_StringToObjectMapEntry.attributes={graph_StringToObjectMapEntry_value, graph_StringToObjectMapEntry_key}
...
graph_GBounds.attributes={graph_GBounds_y, graph_GBounds_width, graph_GBounds_x, graph_GBounds_height}
...
graph_GModelElement.attributes={graph_GModelElement_trace, graph_GModelElement_id, graph_GModelElement_type, graph_GModelElement_cssClasses}
...
domain_model = DomainModel(
    name="graph",
    types={graph_GShapeElement, GModelElement, GBoundsAware, graph_GGraph, GModelRoot, graph_StringToObjectMapEntry, graph_GModelRoot, graph_GBounds, graph_GNode, GShapeElement, GEdgeLayoutable, GLayouting, graph_GEdge, graph_GPoint, graph_GModelElement, graph_GPort, graph_GButton, graph_GBoundsAware, graph_GDimension, graph_GEdgeLayoutable, graph_GEdgePlacement, graph_GLayouting, graph_GCompartment, graph_GLabel, GAlignable, graph_GIssueMarker, graph_GIssue, graph_GPreRenderedElement, graph_GAlignable, graph_GHtmlRoot, GSeverity},
    associations={parent3, layoutOptions5, canvasBounds6, routingPoints7, children1, position14, size16, edgePlacement18, source8, target10, issues13, layoutOptions19, alignment21},
    generalizations={gen_graph_GShapeElement_GModelElement, gen_graph_GShapeElement_GBoundsAware, gen_graph_GGraph_GModelRoot, gen_graph_GGraph_GBoundsAware, gen_graph_GModelRoot_GModelElement, gen_graph_GNode_GShapeElement, gen_graph_GNode_GEdgeLayoutable, gen_graph_GNode_GLayouting, gen_graph_GEdge_GModelElement, gen_graph_GPort_GShapeElement, gen_graph_GButton_GShapeElement, gen_graph_GCompartment_GShapeElement, gen_graph_GCompartment_GLayouting, gen_graph_GLabel_GAlignable, gen_graph_GLabel_GEdgeLayoutable, gen_graph_GLabel_GShapeElement, gen_graph_GIssueMarker_GShapeElement, gen_graph_GPreRenderedElement_GModelElement, gen_graph_GHtmlRoot_GModelRoot},
    metadata=None
)
