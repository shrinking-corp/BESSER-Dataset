...
Employee.attributes={Employee_Emp_Address, Employee_Emp_Department, Employee_Emp_ContactNo, Employee_Emp_Id, Employee_Emp_Email, Employee_Emp_NIC, Employee_Emp_DOB, Employee_Emp_Name, Employee_Emp_Position, Employee_Emp_Date_Of_Joint, Employee_Emp_Salary}
...
Salary.attributes={Salary_Emp_Id, Salary_Sly_Decrement, Salary_Sly_Netgross, Salary_OverTime, Salary_Sly_Increment, Salary_Sly_Basic}
...
Authenticate_staff.attributes={Authenticate_staff_Authendication_Mood, Authenticate_staff_UserName, Authenticate_staff_Password}
...
Leave.attributes={Leave_leave_id, Leave_Leave_ApplyDate, Leave_Leave_EndDate, Leave_Emp_Id, Leave_Leave_NoOfDays, Leave_Leave_detail, Leave_Leave_Title, Leave_Leave_StartDate, Leave_Leave_Status}
...
Attendance.attributes={Attendance_Leaving_Time, Attendance_Attend_date, Attendance_AttendTime, Attendance_Emp_id}
...
domain_model = DomainModel(
    name="_0890d64f_70e9_47d3_937a_069e7e794d4c",
