...
public class Leave  {
    ...
    public Leave(
        int Leave_NoOfDays,        LocalDate Leave_StartDate,        int Emp_Id,        LocalDate Leave_EndDate,        String Leave_detail,        int leave_id,        LocalDate Leave_ApplyDate,        String Leave_Title,        String Leave_Status    ) {
