...
class tp5_Researcher:
    ...
    def __init__(self, name: str, forName: str, tp5_Researcher12: "tp5_PublicationStructure" = None, authors: set["tp5_Paper"] = None, tp5_Researcher: set["tp5_Skill"] = None, tp5_Researcher3: "tp5_Position" = None, tp5_Researcher5: set["tp5_Collaboration"] = None, Researcher: "tp5_Paper" = None):
        self.name = name
...
class tp5_Collaboration:
    ...
    def __init__(self, ratio: int, tp5_Collaboration23: "tp5_Paper" = None, tp5_Collaboration: "tp5_Researcher" = None):
        self.ratio = ratio
...
class tp5_Position:
    ...
    def __init__(self, name: str, description: str, tp5_Position18: "tp5_PublicationStructure" = None, tp5_Position21: "tp5_Position" = None, tp5_Position19: "tp5_Position" = None, tp5_Position: "tp5_Researcher" = None):
        self.name = name
...
class tp5_Paper:
    ...
    def __init__(self, name: str, tp5_Paper15: "tp5_PublicationStructure" = None, tp5_Paper24: "tp5_Collaboration" = None, tp5_Paper10: "tp5_Paper" = None, tp5_Paper8: "tp5_Paper" = None, Paper: "tp5_Researcher" = None, tp5_Paper: set["tp5_Paragraph"] = None, res_papers: set["tp5_Researcher"] = None):
        self.name = name
