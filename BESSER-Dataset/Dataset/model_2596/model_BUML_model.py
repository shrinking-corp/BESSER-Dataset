...
# Classes
root_ClassA = Class(name="root_ClassA")
root_subpackage_ClassB = Class(name="root_subpackage_ClassB")
SuperB = Class(name="SuperB")
root_subpackage_SuperB = Class(name="root_subpackage_SuperB")
root_subpackage_SubA = Class(name="root_subpackage_SubA")
