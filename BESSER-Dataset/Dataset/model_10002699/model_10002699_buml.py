...
Problem.attributes={Problem_Content, Problem_Type, Problem_Id}
...
Client.attributes={Client_Loyalty_card, Client_Id, Client_Name, Client_Bookings}
...
Booking.attributes={Booking_Time, Booking_Id, Booking_Tickets, Booking_Destination, Booking_Luggage, Booking_Origin}
...
Ticket.attributes={Ticket_Seat, Ticket_Id, Ticket_Booking_Class, Ticket_Clients}
...
Flight.attributes={Flight_Origin, Flight_Max_Passangers, Flight_Time, Flight_Destination, Flight_Company, Flight_Id}
...
domain_model = DomainModel(
    name="cffd64a0_2173_48d1_b418_f9cf960957d1",
    types={Problem, Client, Booking, Ticket, Answer, Flight},
    associations={Ticket_Flight, Answer_Problem, Client_Problem, Client_Ticket, Booking_Ticket, Client_Booking},
    generalizations={},
    metadata=None
)
