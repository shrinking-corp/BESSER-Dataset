...
class Ticket:
    ...
    def __init__(self, Id: str, Clients: Client, Seat: str, Booking_Class: str, Ticket_Flight_010: "Flight" = None, Client_Ticket_15: "Client" = None, Booking_Ticket_17: "Booking" = None):
        self.Id = Id
