...
# Classes
multipopulation_MultiPopulationSIDiseaseModel = Class(name="multipopulation_MultiPopulationSIDiseaseModel")
StandardDiseaseModel = Class(name="StandardDiseaseModel")
multipopulation_StringValueList = Class(name="multipopulation_StringValueList")
multipopulation_DoubleValueMatrix = Class(name="multipopulation_DoubleValueMatrix")
multipopulation_DoubleValueList = Class(name="multipopulation_DoubleValueList")
multipopulation_MultiPopulationSIRDiseaseModel = Class(name="multipopulation_MultiPopulationSIRDiseaseModel")
MultiPopulationSIDiseaseModel = Class(name="MultiPopulationSIDiseaseModel")
multipopulation_MultiPopulationSEIRDiseaseModel = Class(name="multipopulation_MultiPopulationSEIRDiseaseModel")
...
multipopulation_MultiPopulationSIDiseaseModel.attributes={multipopulation_MultiPopulationSIDiseaseModel_roadNetworkInfectiousProportion, multipopulation_MultiPopulationSIDiseaseModel_characteristicMixingDistance, multipopulation_MultiPopulationSIDiseaseModel_physicallyAdjacentInfectiousProportion}
...
domain_model = DomainModel(
    ...
    types={multipopulation_MultiPopulationSIDiseaseModel, StandardDiseaseModel, multipopulation_StringValueList, multipopulation_DoubleValueMatrix, multipopulation_DoubleValueList, multipopulation_MultiPopulationSIRDiseaseModel, MultiPopulationSIDiseaseModel, multipopulation_MultiPopulationSEIRDiseaseModel, MultiPopulationSIRDiseaseModel},
