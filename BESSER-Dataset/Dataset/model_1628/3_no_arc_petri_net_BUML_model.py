...
# Classes
petri_NamedElement = Class(name="petri_NamedElement", is_abstract=True)
...
domain_model = DomainModel(
    name="petri",
    types={petri_NamedElement, petri_Place, NamedElement, petri_Transition, petri_PetriNet},
    associations={elems0, in_1, out2},
