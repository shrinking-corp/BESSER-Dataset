...
# Classes
sample_Company = Class(name="sample_Company")
sample_Department = Class(name="sample_Department")
sample_Group = Class(name="sample_Group")
sample_Person = Class(name="sample_Person")
...
sample_Person.attributes={sample_Person_birthdate, sample_Person_name}
...
domain_model = DomainModel(
    ...
    associations={departments0, groups1, company2, department4, group6, persons3},
    generalizations={},
    metadata=None
)
