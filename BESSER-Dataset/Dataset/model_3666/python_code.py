...
class sample_Person:
    ...
    def __init__(self, name: str, birthdate: date, persons: "sample_Group" = None, Person: "sample_Group" = None):
        self.name = name
...
class sample_Group:
    ...
    def __init__(self, name: str, Group: "sample_Department" = None, groups: "sample_Department" = None, Group7: "sample_Person" = None, group: set["sample_Person"] = None):
        self.name = name
        self.Group = Group
        self.groups = groups
        self.Group7 = Group7
