...
# Classes
petrinetv1_Net = Class(name="petrinetv1_Net")
petrinetv1_Place = Class(name="petrinetv1_Place")
petrinetv1_Transition = Class(name="petrinetv1_Transition")

# petrinetv1_Net class attributes and methods
petrinetv1_Net_m_initialize: Method = Method(name="initialize", parameters={Parameter(name='petrinetv1_args', type=StringType)})
...
petrinetv1_Net.methods={petrinetv1_Net_m_markingToString, petrinetv1_Net_m_run, petrinetv1_Net_m_initialize}
...
petrinetv1_Place.attributes={petrinetv1_Place_tokens, petrinetv1_Place_name, petrinetv1_Place_initialTokens}
