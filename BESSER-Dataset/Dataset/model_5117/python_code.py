...
class diva_Variant(NamedElement, ModelContainer):
    ...
    def __init__(self, weaveLevel: str, diva_Variant26: "diva_ContextExpression" = None, diva_Variant28: "diva_ContextExpression" = None, Variant: "diva_Dimension" = None, diva_Variant69: "diva_ConfigVariant" = None, variant: "diva_Dimension" = None, diva_Variant22: set["diva_PropertyValue"] = None, diva_Variant24: "diva_VariantExpression" = None, diva_Variant: "diva_VariantTerm" = None):
...
class diva_Property(NamedElement):
    ...
    def __init__(self, direction: str, diva_Property44: set["diva_PropertyLiteral"] = None, diva_Property47: "diva_PropertyValue" = None, diva_Property33: "diva_Dimension" = None, diva_Property50: "diva_PropertyPriority" = None, diva_Property79: "diva_Priority" = None, diva_Property76: "diva_Score" = None, diva_Property: "diva_VariabilityModel" = None):
...
class diva_Dimension(NamedElement):
    ...
    def __init__(self, upper: str, lower: str, type: set["diva_Variant"] = None, diva_Dimension32: set["diva_Property"] = None, diva_Dimension: "diva_VariabilityModel" = None, Dimension: "diva_Variant" = None, diva_Dimension35: set["diva_MultiplicityConstraint"] = None):
        self.upper = upper
        self.lower = lower
