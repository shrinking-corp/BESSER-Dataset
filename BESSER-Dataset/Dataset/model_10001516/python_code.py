...
class System_order:
    ...
    def __init__(self, Customer_ID: int, Customer_Name: str, Order_ID: int, Date: int, Time: int, Delivery_Charges: int, Total: int, Payment_Option: str, System_order_Payment_00: set["Payment"] = None, System_order_Customer_02: "Customer" = None):
