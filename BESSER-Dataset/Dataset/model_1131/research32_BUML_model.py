...
# Classes
research32_Collaboration = Class(name="research32_Collaboration")
research32_Paragraph = Class(name="research32_Paragraph")
research32_Progress = Class(name="research32_Progress")
research32_PaperKeyword = Class(name="research32_PaperKeyword")
research32_PublicationProcess = Class(name="research32_PublicationProcess")
Named = Class(name="Named")
research32_Phase = Class(name="research32_Phase")
research32_Researcher = Class(name="research32_Researcher")
research32_Write = Class(name="research32_Write")
research32_Review = Class(name="research32_Review")
research32_Paper = Class(name="research32_Paper")
research32_Skill = Class(name="research32_Skill")
research32_Position = Class(name="research32_Position")
research32_KnowledgeManager = Class(name="research32_KnowledgeManager")
research32_PublicationStatus = Class(name="research32_PublicationStatus")
research32_PublicationSystem = Class(name="research32_PublicationSystem")
research32_State = Class(name="research32_State")
Counted = Class(name="Counted")
research32_ReviewNote = Class(name="research32_ReviewNote")
Labelled = Class(name="Labelled")
research32_PublicationStructure = Class(name="research32_PublicationStructure")
research32_StateMachineVariable = Class(name="research32_StateMachineVariable")
research32_Named = Class(name="research32_Named", is_abstract=True)
research32_Counted = Class(name="research32_Counted", is_abstract=True)
research32_Labelled = Class(name="research32_Labelled", is_abstract=True)
research32_Keyword = Class(name="research32_Keyword")
research32_StateMachineObject = Class(name="research32_StateMachineObject", is_abstract=True)
research32_Transition = Class(name="research32_Transition")
StateMachineObject = Class(name="StateMachineObject")
research32_Action = Class(name="research32_Action")
...
research32_PublicationProcess.attributes={research32_PublicationProcess_minTime, research32_PublicationProcess_maxTime}
...
research32_Researcher.attributes={research32_Researcher_forName, research32_Researcher_name}
...
research32_State.attributes={research32_State_name, research32_State_kind, research32_State_id}
...
research32_Action.attributes={research32_Action_actionLabel, research32_Action_actionStatement}
...
domain_model = DomainModel(
    name="research32",
    types={research32_Collaboration, research32_Paragraph, research32_Progress, research32_PaperKeyword, research32_PublicationProcess, Named, research32_Phase, research32_Researcher, research32_Write, research32_Review, research32_Paper, research32_Skill, research32_Position, research32_KnowledgeManager, research32_PublicationStatus, research32_PublicationSystem, research32_State, Counted, research32_ReviewNote, Labelled, research32_PublicationStructure, research32_StateMachineVariable, research32_Named, research32_Counted, research32_Labelled, research32_Keyword, research32_StateMachineObject, research32_Transition, StateMachineObject, research32_Action, StateType},
    associations={collaborations9, paragraphs11, progress12, authors13, keywords14, citedBy17, phases0, writes1, reviews2, res_papers4, skills5, res_position7, researchers33, papers35, knowledgeMan38, status40, processView42, state19, reviews21, process23, paper25, paragraph27, reviewNote30, allkeywords55, keyword58, col_paper61, machineVariables64, structuralView44, positions47, parent51, kpapers53, next83, pubStates66, t_actions69, source70, target73, transitions76, s_actions79},
    generalizations={gen_research32_Paper_Named, gen_research32_PublicationProcess_Named, gen_research32_PublicationSystem_Named, gen_research32_Paragraph_Counted, gen_research32_Paragraph_Named, gen_research32_ReviewNote_Named, gen_research32_Progress_Labelled, gen_research32_Write_Labelled, gen_research32_Review_Labelled, gen_research32_PublicationStructure_Named, gen_research32_Position_Named, gen_research32_Keyword_Named, gen_research32_KnowledgeManager_Named, gen_research32_Transition_StateMachineObject, gen_research32_State_StateMachineObject},
    metadata=None
)
