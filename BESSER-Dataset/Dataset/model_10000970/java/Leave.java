...
public class Leave  {
    ...
    public Leave(
        String Leave_detail,        LocalDate Leave_EndDate,        int Emp_Id,        int Leave_NoOfDays,        String Leave_Status,        String Leave_Title,        LocalDate Leave_ApplyDate,        LocalDate Leave_StartDate,        int leave_id    ) {
