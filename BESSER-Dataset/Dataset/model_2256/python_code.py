...
class schoolIncqDerived_Year:
    ...
    def __init__(self, startingDate: int, Year: "schoolIncqDerived_School" = None, Year15: "schoolIncqDerived_SchoolClass" = None, years: "schoolIncqDerived_School" = None, year: set["schoolIncqDerived_SchoolClass"] = None, schoolIncqDerived_Year: "schoolIncqDerived_School" = None):
...
class schoolIncqDerived_SchoolClass:
    ...
    def __init__(self, code: str, SchoolClass: "schoolIncqDerived_Course" = None, schoolClasses: "schoolIncqDerived_Year" = None, schoolClass: set["schoolIncqDerived_Student"] = None, schoolClass18: set["schoolIncqDerived_Course"] = None, schoolIncqDerived_SchoolClass: "schoolIncqDerived_Teacher" = None, SchoolClass23: "schoolIncqDerived_Student" = None, schoolIncqDerived_SchoolClass30: "schoolIncqDerived_Teacher" = None, SchoolClass34: "schoolIncqDerived_Year" = None):
        self.code = code
...
class schoolIncqDerived_Teacher:
    ...
    def __init__(self, name: str, Teacher: "schoolIncqDerived_Course" = None, Teacher8: "schoolIncqDerived_School" = None, schoolIncqDerived_Teacher21: "schoolIncqDerived_SchoolClass" = None, teachers: "schoolIncqDerived_School" = None, teacher: set["schoolIncqDerived_Course"] = None, schoolIncqDerived_Teacher29: "schoolIncqDerived_SchoolClass" = None, schoolIncqDerived_Teacher: "schoolIncqDerived_School" = None):
        self.name = name
...
class schoolIncqDerived_School:
    ...
    def __init__(self, name: str, address: str, currentYear: int, numberOfTeachers: int, School: "schoolIncqDerived_Course" = None, school: set["schoolIncqDerived_Year"] = None, school7: set["schoolIncqDerived_Teacher"] = None, school10: set["schoolIncqDerived_Course"] = None, School25: "schoolIncqDerived_Teacher" = None, School32: "schoolIncqDerived_Year" = None, schoolIncqDerived_School: set["schoolIncqDerived_Teacher"] = None, schoolIncqDerived_School13: "schoolIncqDerived_Year" = None):
        self.name = name
...
class schoolIncqDerived_Course:
    ...
    def __init__(self, subject: str, weight: int, courses: "schoolIncqDerived_School" = None, courses2: "schoolIncqDerived_Teacher" = None, courses4: "schoolIncqDerived_SchoolClass" = None, Course: "schoolIncqDerived_School" = None, Course19: "schoolIncqDerived_SchoolClass" = None, Course27: "schoolIncqDerived_Teacher" = None):
