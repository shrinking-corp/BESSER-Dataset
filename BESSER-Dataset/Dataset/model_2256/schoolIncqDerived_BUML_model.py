...
# Classes
schoolIncqDerived_Course = Class(name="schoolIncqDerived_Course")
schoolIncqDerived_School = Class(name="schoolIncqDerived_School")
schoolIncqDerived_Teacher = Class(name="schoolIncqDerived_Teacher")
schoolIncqDerived_SchoolClass = Class(name="schoolIncqDerived_SchoolClass")
schoolIncqDerived_Year = Class(name="schoolIncqDerived_Year")
schoolIncqDerived_Student = Class(name="schoolIncqDerived_Student")
schoolIncqDerived_SpecialisationCourse = Class(name="schoolIncqDerived_SpecialisationCourse")
...
schoolIncqDerived_School.attributes={schoolIncqDerived_School_address, schoolIncqDerived_School_numberOfTeachers, schoolIncqDerived_School_currentYear, schoolIncqDerived_School_name}
...
domain_model = DomainModel(
    ...
    types={schoolIncqDerived_Course, schoolIncqDerived_School, schoolIncqDerived_Teacher, schoolIncqDerived_SchoolClass, schoolIncqDerived_Year, schoolIncqDerived_Student, schoolIncqDerived_SpecialisationCourse, Course},
    associations={school0, teacher1, schoolClass3, years5, teachers6, courses9, year14, students16, courses17, homeroomTeacher20, schoolClass22, school24, courses26, homeroomedClass28, school31, schoolClasses33, teachersWithMostCourses11, lastYear12},
