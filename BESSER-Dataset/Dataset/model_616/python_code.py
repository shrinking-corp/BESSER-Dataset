...
class tutorial_Member:
    ...
    def __init__(self, name: str, Member: "tutorial_Library" = None, members: "tutorial_Library" = None, tutorial_Member: set["tutorial_Loan"] = None, tutorial_Member10: set["tutorial_Book"] = None, tutorial_Member16: "tutorial_Loan" = None):
        self.name = name
        self.Member = Member
...
class tutorial_Loan:
    ...
    def __init__(self, date: date, tutorial_Loan: "tutorial_Library" = None, tutorial_Loan8: "tutorial_Member" = None, tutorial_Loan12: "tutorial_Book" = None, tutorial_Loan15: "tutorial_Member" = None):
        self.date = date
