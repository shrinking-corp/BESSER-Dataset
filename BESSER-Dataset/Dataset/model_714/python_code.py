...
class pivot_LoopExp(CallExp):
    ...
    def NoInitializers(self, pivot_context, pivot_diagnostics) :
...
class pivot_OpaqueExpression(ValueSpecification):
    ...
    def __init__(self, body: str, language: str, pivot_OpaqueExpression: "pivot_Constraint" = None, pivot_OpaqueExpression147: "pivot_Operation" = None, pivot_OpaqueExpression143: "pivot_ExpressionInOCL" = None, pivot_OpaqueExpression200: "pivot_Property" = None):
        self.body = body
...
class pivot_TypeExtension(Element):
    ...
    def __init__(self, isRequired: str, TypeExtension: "pivot_Stereotype" = None, extendedBys: "pivot_Type" = None, TypeExtension331: "pivot_Type" = None, extensionOfs: "pivot_Stereotype" = None):
...
class pivot_ParameterableElement(Element):
    ...
    def __init__(self, parameteredElement: "pivot_TemplateParameter" = None, ownedParameteredElement: "pivot_TemplateParameter" = None, pivot_ParameterableElement: "pivot_TemplateParameter" = None, pivot_ParameterableElement283: "pivot_TemplateParameter" = None, pivot_ParameterableElement290: "pivot_TemplateParameterSubstitution" = None, pivot_ParameterableElement296: "pivot_TemplateParameterSubstitution" = None, ParameterableElement: "pivot_TemplateParameter" = None, ParameterableElement286: "pivot_TemplateParameter" = None):
...
class pivot_ProfileApplication(Element):
    ...
    def __init__(self, isStrict: str, ProfileApplication190: "pivot_Profile" = None, ProfileApplication: "pivot_Package" = None, application: "pivot_Profile" = None, profileApplication: "pivot_Package" = None):
...
class pivot_CollectionLiteralExp(LiteralExp):
    ...
    def SequenceKindIsSequence(self, pivot_diagnostics, pivot_context) :
...
class pivot_MessageExp(OCLExpression):
    ...
    def __init__(self, pivot_MessageExp124: "pivot_SendSignalAction" = None, pivot_MessageExp126: "pivot_OCLExpression" = None, pivot_MessageExp: set["pivot_OCLExpression"] = None, pivot_MessageExp121: "pivot_CallOperationAction" = None):
...
class pivot_Element(Visitable):
    ...
    def __init__(self, pivot_Element: "pivot_Annotation" = None, pivot_Element5: "pivot_Annotation" = None, pivot_Element25: "pivot_Comment" = None, pivot_Element32: "pivot_Constraint" = None, base: set["pivot_ElementExtension"] = None, pivot_Element61: "pivot_Element" = None, pivot_Element59: set["pivot_Element"] = None, pivot_Element63: set["pivot_Comment"] = None, Element: "pivot_ElementExtension" = None):
...
class pivot_Constraint(NamedElement):
    ...
    def __init__(self, isCallable: str, pivot_Constraint34: "pivot_Namespace" = None, stateInvariant: "pivot_State" = None, pivot_Constraint39: "pivot_Constraint" = None, pivot_Constraint37: set["pivot_Constraint"] = None, pivot_Constraint41: "pivot_OpaqueExpression" = None, guard: "pivot_Transition" = None, pivot_Constraint: set["pivot_Element"] = None, pivot_Constraint136: "pivot_Namespace" = None, pivot_Constraint155: "pivot_Operation" = None, pivot_Constraint161: "pivot_Operation" = None, Constraint: "pivot_State" = None, Constraint314: "pivot_Transition" = None, pivot_Constraint336: "pivot_Type" = None):
...
class pivot_Type(ParameterableElement, TemplateableElement, NamedElement):
    ...
    def __init__(self, instanceClassName: str, pivot_Type: "pivot_CollectionType" = None, pivot_Type51: "pivot_DataType" = None, pivot_Type53: "pivot_DynamicElement" = None, pivot_Type100: "pivot_LambdaType" = None, pivot_Type103: "pivot_LambdaType" = None, pivot_Type97: "pivot_LambdaType" = None, pivot_Type133: "pivot_Metaclass" = None, Type: "pivot_Operation" = None, pivot_Type164: "pivot_Operation" = None, Type183: "pivot_Package" = None, Type208: "pivot_Property" = None, pivot_Type355: "pivot_UnspecifiedType" = None, type: set["pivot_TypeExtension"] = None, owningType: set["pivot_Property"] = None, pivot_Type335: set["pivot_Constraint"] = None, owningType338: set["pivot_Operation"] = None, ownedType: "pivot_Package" = None, pivot_Type344: "pivot_Type" = None, pivot_Type342: set["pivot_Type"] = None, pivot_Type346: "pivot_TypeExp" = None, Type349: "pivot_TypeExtension" = None, pivot_Type358: "pivot_UnspecifiedType" = None, pivot_Type351: "pivot_TypeTemplateParameter" = None, pivot_Type353: "pivot_TypedElement" = None):
...
class pivot_IteratorExp(LoopExp, ReferringElement):
    ...
    def CollectTypeIsUnordered(self, pivot_context, pivot_diagnostics) :
    ...
    def SortedByIsOrderedIfSourceIsOrdered(self, pivot_context, pivot_diagnostics) :
    ...
    def AnyHasOneIterator(self, pivot_diagnostics, pivot_context) :
    ...
    def ClosureElementTypeIsSourceElementType(self, pivot_context, pivot_diagnostics) :
        # TODO: Implement ClosureElementTypeIsSourceElementType method
        pass

    def RejectOrSelectTypeIsSourceType(self, pivot_context, pivot_diagnostics) :
...
class pivot_IterateExp(LoopExp, ReferringElement):
    ...
    def BodyTypeConformsToResultType(self, pivot_context, pivot_diagnostics) :
...
class pivot_EnumerationLiteral(NamedElement):
    ...
    def __init__(self, value: str, ownedLiteral: "pivot_Enumeration" = None, pivot_EnumerationLiteral: "pivot_EnumLiteralExp" = None, EnumerationLiteral: "pivot_Enumeration" = None):
        self.value = value
...
class pivot_IfExp(OCLExpression):
    ...
    def ConditionTypeIsBoolean(self, pivot_diagnostics, pivot_context) :
