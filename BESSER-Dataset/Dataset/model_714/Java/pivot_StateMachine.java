...
public class pivot_StateMachine extends Behavior {
    ...
    public pivot_StateMachine(
        ArrayList<pivot_State> pivot_states,        ArrayList<pivot_Region> pivot_regions,        ArrayList<pivot_Pseudostate> pivot_pseudostates,        ArrayList<pivot_StateMachine> pivot_statemachines    ) {
