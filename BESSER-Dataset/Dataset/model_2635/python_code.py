...
class diagraph_DGraph:
    ...
    def __init__(self, viewName: str, facade1: str, facade2: str, graph: set["diagraph_DGraphElement"] = None, diagraph_DGraph: "diagraph_DPointOfView" = None, DGraph: "diagraph_DGraphElement" = None, diagraph_DGraph18: "diagraph_DViewNavigation" = None):
...
class diagraph_DGraphElement(ABC):
    ...
    def __init__(self, name: str, icon: str, abztract: bool, DGraphElement: "diagraph_DGraph" = None, diagraph_DGraphElement: "diagraph_ENamedElement" = None, elements: "diagraph_DGraph" = None):
        self.name = name
        self.icon = icon
...
class diagraph_DNode(DLabeledElement, DOwnedElement):
    ...
    def __init__(self, shape: str, layout: bool, navigationLink: str, diagraph_DNode16: "diagraph_DOwnedElement" = None, diagraph_DNode: "diagraph_DEdge" = None, navigationSource: "diagraph_DViewNavigation" = None, node: set["diagraph_DContainment"] = None, diagraph_DNode28: "diagraph_DSimpleEdge" = None, DNode: "diagraph_DViewNavigation" = None, DNode23: "diagraph_DContainment" = None):
        self.shape = shape
        self.layout = layout
