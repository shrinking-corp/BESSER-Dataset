...
# Classes
diagraph_DEdge = Class(name="diagraph_DEdge", is_abstract=True)
DGraphElement = Class(name="DGraphElement")
diagraph_DPointOfView = Class(name="diagraph_DPointOfView")
diagraph_DLabeledElement = Class(name="diagraph_DLabeledElement", is_abstract=True)
diagraph_EClass = Class(name="diagraph_EClass")
diagraph_DLabel = Class(name="diagraph_DLabel")
diagraph_DOwnedElement = Class(name="diagraph_DOwnedElement", is_abstract=True)
diagraph_DNode = Class(name="diagraph_DNode")
diagraph_EReference = Class(name="diagraph_EReference")
diagraph_DGraphElement = Class(name="diagraph_DGraphElement", is_abstract=True)
diagraph_ENamedElement = Class(name="diagraph_ENamedElement")
diagraph_DGraph = Class(name="diagraph_DGraph")
DLabeledElement = Class(name="DLabeledElement")
DOwnedElement = Class(name="DOwnedElement")
diagraph_DViewNavigation = Class(name="diagraph_DViewNavigation")
diagraph_DContainment = Class(name="diagraph_DContainment")
diagraph_DLabeledEdge = Class(name="diagraph_DLabeledEdge")
DOwnedEdge = Class(name="DOwnedEdge")
DLineEdge = Class(name="DLineEdge")
diagraph_DReference = Class(name="diagraph_DReference")
diagraph_DNestedEdge = Class(name="diagraph_DNestedEdge")
diagraph_DSimpleEdge = Class(name="diagraph_DSimpleEdge", is_abstract=True)
diagraph_DOwnedEdge = Class(name="diagraph_DOwnedEdge", is_abstract=True)
DEdge = Class(name="DEdge")
diagraph_DCompartmentEdge = Class(name="diagraph_DCompartmentEdge")
DNestedEdge = Class(name="DNestedEdge")
DNode = Class(name="DNode")
diagraph_DAffixedEdge = Class(name="diagraph_DAffixedEdge")
diagraph_EAttribute = Class(name="diagraph_EAttribute")
diagraph_DLineEdge = Class(name="diagraph_DLineEdge", is_abstract=True)
DSimpleEdge = Class(name="DSimpleEdge")
diagraph_DNavigationEdge = Class(name="diagraph_DNavigationEdge")
diagraph_DGeneric = Class(name="diagraph_DGeneric")
...
diagraph_DLabel.attributes={diagraph_DLabel_inferred, diagraph_DLabel_abztract, diagraph_DLabel_propagated}
...
diagraph_DNode.attributes={diagraph_DNode_shape, diagraph_DNode_navigationLink, diagraph_DNode_layout}
...
diagraph_DGraphElement.attributes={diagraph_DGraphElement_name, diagraph_DGraphElement_abztract, diagraph_DGraphElement_icon}
...
diagraph_DGraph.attributes={diagraph_DGraph_viewName, diagraph_DGraph_facade2, diagraph_DGraph_facade1}
...
diagraph_DCompartmentEdge.attributes={diagraph_DCompartmentEdge_depth, diagraph_DCompartmentEdge_partitionName}
...
domain_model = DomainModel(
    name="diagraph",
    types={diagraph_DEdge, DGraphElement, diagraph_DPointOfView, diagraph_DLabeledElement, diagraph_EClass, diagraph_DLabel, diagraph_DOwnedElement, diagraph_DNode, diagraph_EReference, diagraph_DGraphElement, diagraph_ENamedElement, diagraph_DGraph, DLabeledElement, DOwnedElement, diagraph_DViewNavigation, diagraph_DContainment, diagraph_DLabeledEdge, DOwnedEdge, DLineEdge, diagraph_DReference, diagraph_DNestedEdge, diagraph_DSimpleEdge, diagraph_DOwnedEdge, DEdge, diagraph_DCompartmentEdge, DNestedEdge, DNode, diagraph_DAffixedEdge, diagraph_EAttribute, diagraph_DLineEdge, DSimpleEdge, diagraph_DNavigationEdge, diagraph_DGeneric, DShape},
    associations={elements10, pointOfView11, eClaz12, dlabels13, owner15, target0, targetReference1, semanticRole3, graph4, viewNavigation5, containments6, sourceReference7, source9, source27, navigationTarget17, navigationSource19, attribute20, node22, edges24},
    generalizations={gen_diagraph_DEdge_DGraphElement, gen_diagraph_DLabeledElement_DGraphElement, gen_diagraph_DNode_DLabeledElement, gen_diagraph_DNode_DOwnedElement, gen_diagraph_DLabeledEdge_DOwnedEdge, gen_diagraph_DLabeledEdge_DLabeledElement, gen_diagraph_DLabeledEdge_DLineEdge, gen_diagraph_DReference_DLineEdge, gen_diagraph_DNestedEdge_DOwnedEdge, gen_diagraph_DSimpleEdge_DEdge, gen_diagraph_DOwnedEdge_DOwnedElement, gen_diagraph_DOwnedEdge_DEdge, gen_diagraph_DCompartmentEdge_DNestedEdge, gen_diagraph_DPointOfView_DNode, gen_diagraph_DAffixedEdge_DNestedEdge, gen_diagraph_DLineEdge_DSimpleEdge, gen_diagraph_DNavigationEdge_DSimpleEdge, gen_diagraph_DGeneric_DLabeledElement},
    metadata=None
)
