...
public class diagraph_DGraph  {
    ...
    private diagraph_DPointOfView diagraph_dpointofview;
    ...
    public diagraph_DGraph(
        String facade1,        String facade2,        String viewName    ) {
    ...
    public diagraph_DGraph(
        String facade1,        String facade2,        String viewName        ArrayList<diagraph_DGraphElement> diagraph_dgraphelements    ) {
        this.facade1 = facade1;
        this.facade2 = facade2;
        this.viewName = viewName;
    ...
    public diagraph_DPointOfView getDiagraph_dpointofview() {
        return diagraph_dpointofview;
    }

    public void setDiagraph_dpointofview(diagraph_DPointOfView diagraph_dpointofview) {
        this.diagraph_dpointofview = diagraph_dpointofview;
    }
