...
# Classes
package1_TestTypeClass1 = Class(name="package1_TestTypeClass1")
package1_TestTypeClass2 = Class(name="package1_TestTypeClass2")
TestTypeClass1 = Class(name="TestTypeClass1")
package1_TestPrimitiveTypeClass = Class(name="package1_TestPrimitiveTypeClass")
package1_TestOperationAndParameterClass = Class(name="package1_TestOperationAndParameterClass")
package1_TestPropertyClass = Class(name="package1_TestPropertyClass")
...
package1_TestPrimitiveTypeClass.attributes={package1_TestPrimitiveTypeClass_anIntegerEByteObject, package1_TestPrimitiveTypeClass_anIntegerEBigInteger, package1_TestPrimitiveTypeClass_anIntegerIntegerObject, package1_TestPrimitiveTypeClass_anIntegerByteObject, package1_TestPrimitiveTypeClass_aBooleanBooleanObject, package1_TestPrimitiveTypeClass_anIntegerBigDecimal, package1_TestPrimitiveTypeClass_aRealFloatObject, package1_TestPrimitiveTypeClass_anIntegerEShortObject, package1_TestPrimitiveTypeClass_aStringECharacterObject, package1_TestPrimitiveTypeClass_anIntegerShortObject, package1_TestPrimitiveTypeClass_anIntegerShort, package1_TestPrimitiveTypeClass_aStringEChar, package1_TestPrimitiveTypeClass_aRealEDoubleObject, package1_TestPrimitiveTypeClass_anIntegerELongObject, package1_TestPrimitiveTypeClass_aBooleanEBooleanObject, package1_TestPrimitiveTypeClass_anIntegerEInt, package1_TestPrimitiveTypeClass_aBooleanBoolean, package1_TestPrimitiveTypeClass_aRealDouble, package1_TestPrimitiveTypeClass_aStringCharacterObject, package1_TestPrimitiveTypeClass_aRealEDouble, package1_TestPrimitiveTypeClass_anIntegerELong, package1_TestPrimitiveTypeClass_aRealEFloat, package1_TestPrimitiveTypeClass_aBooleanEBoolean, package1_TestPrimitiveTypeClass_anIntegerBigInteger, package1_TestPrimitiveTypeClass_aStringString, package1_TestPrimitiveTypeClass_anIntegerEByte, package1_TestPrimitiveTypeClass_aStringEString, package1_TestPrimitiveTypeClass_anIntegerInt, package1_TestPrimitiveTypeClass_anIntegerLongObject, package1_TestPrimitiveTypeClass_anIntegerLong, package1_TestPrimitiveTypeClass_aStringChar, package1_TestPrimitiveTypeClass_aRealEFloatObject, package1_TestPrimitiveTypeClass_anIntegerEShort, package1_TestPrimitiveTypeClass_aRealFloat, package1_TestPrimitiveTypeClass_anIntegerEBigDecimal, package1_TestPrimitiveTypeClass_anIntegerByte, package1_TestPrimitiveTypeClass_anIntegerEIntegerObject, package1_TestPrimitiveTypeClass_aRealDoubleObject}
...
package1_TestOperationAndParameterClass_m_voidOperationWithParameter: Method = Method(name="voidOperationWithParameter", parameters={Parameter(name='package1_in1', type=StringType)})
...
package1_TestOperationAndParameterClass.methods={package1_TestOperationAndParameterClass_m_orderedMultipleOperation, package1_TestOperationAndParameterClass_m_voidOperationWithParameter, package1_TestOperationAndParameterClass_m_uniqueMultipleOperation, package1_TestOperationAndParameterClass_m_unorderedMultipleOperation, package1_TestOperationAndParameterClass_m_operationWithoutParameters, package1_TestOperationAndParameterClass_m_nonuniqueMultipleOperation}
...
domain_model = DomainModel(
    name="package1",
    types={package1_TestTypeClass1, package1_TestTypeClass2, TestTypeClass1, package1_TestPrimitiveTypeClass, package1_TestOperationAndParameterClass, package1_TestPropertyClass, TestEnumeration},
    associations={nonmultipleProperty0, orderedMultipleProperty1, unorderedMultipleProperty4, uniqueMultipleProperty7, unorderedMultiplePropertyAssociationEnd19, uniqueMultiplePropertyAssociationEnd22, nonuniqueMultiplePropertyAssociationEnd25, nonuniqueMultipleProperty10, associationEnd113, orderedMultiplePropertyAssociationEnd16},
