...
class simplepdl_WorkDefinition(ProcessElements):
    ...
    def __init__(self, name: str, successor: set["simplepdl_WorkSequence"] = None, predecessor: set["simplepdl_WorkSequence"] = None, simplepdl_WorkDefinition: "simplepdl_Allocation" = None, WorkDefinition: "simplepdl_WorkSequence" = None, WorkDefinition7: "simplepdl_WorkSequence" = None, simplepdl_WorkDefinition14: "simplepdl_Allocation" = None):
        self.name = name
