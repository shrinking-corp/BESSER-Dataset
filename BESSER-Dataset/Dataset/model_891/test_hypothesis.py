...
def test_processelements_is_not_abstract():
    assert not inspect.isabstract(ProcessElements)


def test_processelements_constructor_exists():
    assert callable(ProcessElements.__init__)


def test_processelements_constructor_args():
...
def test_simplepdl_processelements_is_not_abstract():
    assert not inspect.isabstract(simplepdl_ProcessElements)


def test_simplepdl_processelements_constructor_exists():
    assert callable(simplepdl_ProcessElements.__init__)


def test_simplepdl_processelements_constructor_args():
