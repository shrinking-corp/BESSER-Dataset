...
simplepdl_ProcessElements = Class(name="simplepdl_ProcessElements")
...
domain_model = DomainModel(
    name="simplepdl",
    types={simplepdl_Guidance, simplepdl_Process, simplepdl_ProcessElements, simplepdl_WorkDefinition, ProcessElements, simplepdl_WorkSequence, simplepdl_Allocation, simplepdl_Ressource, WorkSequenceType},
    associations={processelement0, linksToPredecessors1, linksToSuccessors2, allocation4, predecessor5, successor6, processelement8, ressource10, workdefinition12},
    generalizations={gen_simplepdl_Guidance_ProcessElements, gen_simplepdl_WorkDefinition_ProcessElements, gen_simplepdl_WorkSequence_ProcessElements, gen_simplepdl_Ressource_ProcessElements},
    metadata=None
)
