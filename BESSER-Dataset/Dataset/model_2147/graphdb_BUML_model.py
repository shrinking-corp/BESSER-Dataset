...
graphdb_Graph = Class(name="graphdb_Graph")
graphdb_Vertex = Class(name="graphdb_Vertex")
graphdb_Edge = Class(name="graphdb_Edge")
graphdb_Element = Class(name="graphdb_Element", is_abstract=True)
graphdb_GraphElement = Class(name="graphdb_GraphElement", is_abstract=True)
Element = Class(name="Element")
graphdb_Property = Class(name="graphdb_Property")
...
graphdb_Edge.attributes={graphdb_Edge_type, graphdb_Edge_name}
...
domain_model = DomainModel(
    name="graphdb",
    types={GraphElement, graphdb_Graph, graphdb_Vertex, graphdb_Edge, graphdb_Element, graphdb_GraphElement, Element, graphdb_Property, PrimitiveType, DatabaseKind},
    associations={inEdges4, vertices0, edges1, properties3, outEdges6, graph8, tail9, head11, graph13, owner15},
    generalizations={gen_graphdb_Vertex_GraphElement, gen_graphdb_GraphElement_Element, gen_graphdb_Edge_GraphElement, gen_graphdb_Property_Element},
    metadata=None
)
