...
class graphdb_Graph:
    ...
    def __init__(self, rawDatabase: str, graph: set["graphdb_Vertex"] = None, graph2: set["graphdb_Edge"] = None, Graph: "graphdb_Vertex" = None, Graph14: "graphdb_Edge" = None):
