...
# Classes
rulegen_D = Class(name="rulegen_D")
rulegen_Context = Class(name="rulegen_Context")
rulegen_A = Class(name="rulegen_A")
rulegen_B = Class(name="rulegen_B")
rulegen_C = Class(name="rulegen_C")
...
domain_model = DomainModel(
    name="rulegen",
    types={rulegen_D, rulegen_Context, rulegen_A, rulegen_B, rulegen_C},
    associations={d5, a0, b1, c3, edgeAB7, edgeBA8, edgeBC9, edgeCB10, edgeDC12},
    generalizations={},
    metadata=None
)
