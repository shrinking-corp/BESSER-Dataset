...
customer.attributes={customer_name, customer_address, customer_email_id, customer_product_id}
...
monitor_complaint.attributes={monitor_complaint_complaintid, monitor_complaint_date, monitor_complaint_complaint_type}
...
# Customer class attributes and methods
Customer_productid: Property = Property(name="productid", type=IntegerType)
Customer_name: Property = Property(name="name", type=StringType)
Customer_emailid: Property = Property(name="emailid", type=StringType)
Customer_address: Property = Property(name="address", type=StringType)
Customer.attributes={Customer_emailid, Customer_productid, Customer_address, Customer_name}

# MonitorComplaint class attributes and methods
MonitorComplaint_complaintid: Property = Property(name="complaintid", type=StringType)
...
MonitorComplaint.attributes={MonitorComplaint_date, MonitorComplaint_complainttype, MonitorComplaint_complaintid}
...
Administrator_username: Property = Property(name="username", type=StringType)
Administrator_password: Property = Property(name="password", type=StringType)
Administrator.attributes={Administrator_username, Administrator_password}
...
DBDetails_islogg: Property = Property(name="islogg", type=BooleanType)
DBDetails_iIssessionout: Property = Property(name="iIssessionout", type=BooleanType)
DBDetails.attributes={DBDetails_islogg, DBDetails_iIssessionout}
...
domain_model = DomainModel(
    name="_06457448_8bc1_4582_90fc_2e943c2103cd",
    ...
    associations={technical_team_login_technical, technical_team_new_complaint_details, technical_team_find_out_fault, technical_team_send_to_admin, technical_team_logout_technician, client_register_complaint, client_login, client_view_status, client_logout, administrator_login, administrator_logout, administrator_create_user, administrator_search_user},
    generalizations={},
    metadata=None
)
