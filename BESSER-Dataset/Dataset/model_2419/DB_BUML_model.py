...
domain_model = DomainModel(
    name="DB",
    types={DB_NamedElement, DB_Column, DB_Database, DB_DatabaseElement, NamedElement, DB_Table, DatabaseElement, DB_ForeignKey},
    associations={columns2, contents0, database1, primaryKeys3, table4, parent5, child7},
