...
SimplStateMachineDC_State.attributes={SimplStateMachineDC_State_isActive, SimplStateMachineDC_State_name, SimplStateMachineDC_State_Inh, SimplStateMachineDC_State_Ord, SimplStateMachineDC_State_OrdIf, SimplStateMachineDC_State_InhIf}
...
domain_model = DomainModel(
    ...
    types={SimplStateMachineDC_StateMachine, SimplStateMachineDC_Transition, SimplStateMachineDC_State, SimplStateMachineDC_CompositeState, State, SimplStateMachineDC_InitialState, SimplStateMachineDC_PseudoState, PseudoState},
