...
class SimplStateMachineDC_State:
    ...
    def __init__(self, name: str, isActive: bool, OrdIf: str, InhIf: str, Ord: str, Inh: str, SimplStateMachineDC_State: "SimplStateMachineDC_StateMachine" = None, states: "SimplStateMachineDC_CompositeState" = None, State: "SimplStateMachineDC_CompositeState" = None, SimplStateMachineDC_State10: "SimplStateMachineDC_Transition" = None, SimplStateMachineDC_State13: "SimplStateMachineDC_Transition" = None, SimplStateMachineDC_State7: "SimplStateMachineDC_PseudoState" = None):
        self.name = name
