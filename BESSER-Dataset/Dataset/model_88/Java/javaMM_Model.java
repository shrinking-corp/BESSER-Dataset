...
public class javaMM_Model  {
    ...
    public javaMM_Model(
        String name        ArrayList<javaMM_Type> javamm_types,        ArrayList<javaMM_Archive> javamm_archives,        ArrayList<javaMM_Package> javamm_packages,        ArrayList<javaMM_ClassFile> javamm_classfiles,        ArrayList<javaMM_UnresolvedItem> javamm_unresolveditems,        ArrayList<javaMM_CompilationUnit> javamm_compilationunits    ) {
        this.name = name;
