...
class javaMM_Model:
    ...
    def __init__(self, name: str, javaMM_Model239: set["javaMM_UnresolvedItem"] = None, model: set["javaMM_Package"] = None, javaMM_Model: set["javaMM_Type"] = None, javaMM_Model241: set["javaMM_CompilationUnit"] = None, javaMM_Model244: set["javaMM_ClassFile"] = None, javaMM_Model247: set["javaMM_Archive"] = None, Model: "javaMM_Package" = None):
        self.name = name
...
class javaMM_CompilationUnit(NamedElement):
    ...
    def __init__(self, originalFilePath: str, javaMM_CompilationUnit: "javaMM_ASTNode" = None, javaMM_CompilationUnit132: set["javaMM_ImportDeclaration"] = None, javaMM_CompilationUnit108: "javaMM_ClassFile" = None, javaMM_CompilationUnit129: set["javaMM_Comment"] = None, javaMM_CompilationUnit134: "javaMM_Package" = None, javaMM_CompilationUnit137: set["javaMM_AbstractTypeDeclaration"] = None, javaMM_CompilationUnit242: "javaMM_Model" = None):
