...
library_Manuscript = Class(name="library_Manuscript")
...
domain_model = DomainModel(
    name="library",
    types={library_Library, library_Writer, library_Book, library_Manuscript, Book, BookCategory},
    associations={writers0, books1, books3, author4, citation6},
