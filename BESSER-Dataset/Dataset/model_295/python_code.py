...
class library_Book:
    ...
    def __init__(self, title: str, pages: int, category: str, library_Book: "library_Library" = None, Book: "library_Writer" = None, books: "library_Writer" = None, library_Book7: "library_Book" = None, library_Book5: set["library_Book"] = None):
        self.title = title
        self.pages = pages
