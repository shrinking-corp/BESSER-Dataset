...
ddlDsl_SqlNumber.attributes={ddlDsl_SqlNumber_precision, ddlDsl_SqlNumber_hasPrecision, ddlDsl_SqlNumber_scale}
...
ddlDsl_SqlInterval.attributes={ddlDsl_SqlInterval_year, ddlDsl_SqlInterval_day, ddlDsl_SqlInterval_precision, ddlDsl_SqlInterval_secondsPrecision}
...
domain_model = DomainModel(
    name="ddlDsl",
    types={ddlDsl_Ddl, ddlDsl_DdlStatement, ddlDsl_SqlDataType, ddlDsl_Alter, DdlStatement, ddlDsl_CreateTable, ddlDsl_AlterTableAction, ddlDsl_Constraint, ddlDsl_DropTableConstraint, AlterTableAction, ddlDsl_Comment, ddlDsl_TableComment, Comment, ddlDsl_ColumnComment, ddlDsl_Column, ddlDsl_AddTableConstraint, ddlDsl_Create, Create, ddlDsl_TableProperty, ddlDsl_CreateIndex, TableProperty, ddlDsl_Long, LongRaw, ddlDsl_ReferenceClause, ddlDsl_Drop, ddlDsl_NullableConstraint, Constraint, ddlDsl_UniqueKeyConstraint, ddlDsl_PrimaryKeyConstraint, ddlDsl_ForeignKeyConstraint, ddlDsl_SqlCharacter, SqlDataType, ddlDsl_SqlNumber, ddlDsl_LongRaw, ddlDsl_Raw, ddlDsl_SqlDateTime, ddlDsl_SqlDate, SqlDateTime, ddlDsl_SqlTimeStamp, ddlDsl_SqlInterval, ddlDsl_LargeObjectType, ddlDsl_RowIdType, ddlDsl_SqlBoolean, SortDirectionEnum},
    associations={statements0, type18, table1, action2, constraint4, constraintRef6, table8, column10, properties11, table13, columns15, constraint20, reference23, columns25, columns27, columns29, reference31, table34, columns37},
    generalizations={gen_ddlDsl_Alter_DdlStatement, gen_ddlDsl_DropTableConstraint_AlterTableAction, gen_ddlDsl_Comment_DdlStatement, gen_ddlDsl_TableComment_Comment, gen_ddlDsl_ColumnComment_Comment, gen_ddlDsl_AddTableConstraint_AlterTableAction, gen_ddlDsl_Create_DdlStatement, gen_ddlDsl_CreateTable_Create, gen_ddlDsl_CreateIndex_Create, gen_ddlDsl_Column_TableProperty, gen_ddlDsl_Drop_DdlStatement, gen_ddlDsl_Constraint_TableProperty, gen_ddlDsl_NullableConstraint_Constraint, gen_ddlDsl_UniqueKeyConstraint_Constraint, gen_ddlDsl_PrimaryKeyConstraint_Constraint, gen_ddlDsl_ForeignKeyConstraint_Constraint, gen_ddlDsl_SqlCharacter_SqlDataType, gen_ddlDsl_SqlNumber_SqlDataType, gen_ddlDsl_Long_LongRaw, gen_ddlDsl_LongRaw_SqlDataType, gen_ddlDsl_Raw_LongRaw, gen_ddlDsl_SqlDateTime_SqlDataType, gen_ddlDsl_SqlDate_SqlDateTime, gen_ddlDsl_SqlTimeStamp_SqlDateTime, gen_ddlDsl_SqlInterval_SqlDateTime, gen_ddlDsl_LargeObjectType_SqlDataType, gen_ddlDsl_RowIdType_SqlDataType, gen_ddlDsl_SqlBoolean_SqlDataType},
    metadata=None
)
