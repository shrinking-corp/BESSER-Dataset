...
public class ddlDsl_Column extends TableProperty {
    ...
    private ddlDsl_SqlDataType ddldsl_sqldatatype;
    ...
    public ddlDsl_SqlDataType getDdldsl_sqldatatype() {
        return ddldsl_sqldatatype;
    }

    public void setDdldsl_sqldatatype(ddlDsl_SqlDataType ddldsl_sqldatatype) {
        this.ddldsl_sqldatatype = ddldsl_sqldatatype;
    }
