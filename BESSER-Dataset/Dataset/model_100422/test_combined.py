...
def test_hyp_statechart101_thing_is_not_abstract():
    assert not inspect.isabstract(statechart101_Thing)


def test_hyp_statechart101_thing_constructor_exists():
    assert callable(statechart101_Thing.__init__)


def test_hyp_statechart101_thing_constructor_args():
    sig = inspect.signature(statechart101_Thing.__init__)
    params = list(sig.parameters.keys())



def test_hyp_statechart101_namedelement_is_not_abstract():
    assert not inspect.isabstract(statechart101_NamedElement)


def test_hyp_statechart101_namedelement_constructor_exists():
    assert callable(statechart101_NamedElement.__init__)


def test_hyp_statechart101_namedelement_constructor_args():
...
def test_hyp_statechart101_transition_is_not_abstract():
    assert not inspect.isabstract(statechart101_Transition)


def test_hyp_statechart101_transition_constructor_exists():
    assert callable(statechart101_Transition.__init__)


def test_hyp_statechart101_transition_constructor_args():
...
def test_hyp_statechart101_variable_is_not_abstract():
    assert not inspect.isabstract(statechart101_Variable)


def test_hyp_statechart101_variable_constructor_exists():
    assert callable(statechart101_Variable.__init__)


def test_hyp_statechart101_variable_constructor_args():
...
def test_hyp_statechart101_state_is_not_abstract():
    assert not inspect.isabstract(statechart101_State)


def test_hyp_statechart101_state_constructor_exists():
    assert callable(statechart101_State.__init__)


def test_hyp_statechart101_state_constructor_args():
...
def test_hyp_statechart101_namedelement_name_setter(instance):
...
def test_hyp_statechart101_transition_expression_setter(instance):
...
def test_hyp_statechart101_variable_type_setter(instance):
...
@given(instance=statechart101_Variable_strategy)
def test_hyp_statechart101_variable_value_setter(instance):
...
def test_hyp_statechart101_state_label_setter(instance):
...
@given(instance=statechart101_State_strategy)
def test_hyp_statechart101_state_type_setter(instance):
    original = instance.type
    instance.type = original
    assert instance.type == original
...
@given(instance=statechart101_State_strategy)
def test_hyp_statechart101_state_activity_setter(instance):
