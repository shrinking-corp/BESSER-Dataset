...
Camera_sensor.attributes={Camera_sensor_Image_ID, Camera_sensor_Video_ID}
...
domain_model = DomainModel(
    name="_6150dacd_4988_434c_b175_947bd1095165",
    types={Home_Security, Camera_sensor, Event_Log, Light_Sensor, Lock_doors_sensors, Server, Temperature_sensor},
    associations={Home_Security_Server, Home_Security_Camera, Home_Security_Event_Log, Home_Security_Light_Sensor, Home_Security_Doors, Home_Security_Temperature_sensor},
    generalizations={},
    metadata=None
)
