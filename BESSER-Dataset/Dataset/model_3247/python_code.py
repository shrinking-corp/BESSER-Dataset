...
class profile_Constraint:
    ...
    def __init__(self, type: str, isDerivation: bool, operation: str, bound: int, Constraint: "profile_PlatformProfile" = None, constraints: "profile_PlatformProfile" = None, profile_Constraint: "profile_Resource" = None):
        self.type = type
