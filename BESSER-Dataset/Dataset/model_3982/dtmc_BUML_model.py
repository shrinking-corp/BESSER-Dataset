...
dtmc_Node.attributes={dtmc_Node_isEnd, dtmc_Node_isFail, dtmc_Node_isStart}
...
domain_model = DomainModel(
    name="dtmc",
    types={dtmc_Node, dtmc_Dtmc, dtmc_Module, dtmc_Transition, dtmc_SynchronizedTransition, Transition, dtmc_CallTransition, dtmc_InvokedTransition, dtmc_StandardTransition},
    associations={modules0, module1, outTransitions2, inTransitions3, _from5, _to6, module8, syncWith11, synchedWith13, nodes15, transitions17, invokedTransition20, callTransition21},
