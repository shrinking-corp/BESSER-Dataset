...
# Classes
muddle_Feature = Class(name="muddle_Feature")
muddle_Muddle = Class(name="muddle_Muddle")
muddle_Type = Class(name="muddle_Type", is_abstract=True)
muddle_MuddleElement = Class(name="muddle_MuddleElement")
muddle_Slot = Class(name="muddle_Slot")
muddle_MuddleElementType = Class(name="muddle_MuddleElementType")
muddle_MuddleElementStyle = Class(name="muddle_MuddleElementStyle")
muddle_PrimitiveType = Class(name="muddle_PrimitiveType", is_abstract=True)
muddle_IntegerType = Class(name="muddle_IntegerType")
PrimitiveType = Class(name="PrimitiveType")
muddle_StringType = Class(name="muddle_StringType")
muddle_BooleanType = Class(name="muddle_BooleanType")
muddle_RealType = Class(name="muddle_RealType")
Type = Class(name="Type")
muddle_LinkElementType = Class(name="muddle_LinkElementType")
...
muddle_Feature.attributes={muddle_Feature_many, muddle_Feature_runtime, muddle_Feature_primary, muddle_Feature_name}
...
muddle_MuddleElementStyle.attributes={muddle_MuddleElementStyle_color, muddle_MuddleElementStyle_labelFontSize, muddle_MuddleElementStyle_height, muddle_MuddleElementStyle_y, muddle_MuddleElementStyle_width, muddle_MuddleElementStyle_borderWidth, muddle_MuddleElementStyle_x, muddle_MuddleElementStyle_shape}
...
domain_model = DomainModel(
    name="muddle",
    types={muddle_Feature, muddle_Muddle, muddle_Type, muddle_MuddleElement, muddle_Slot, muddle_MuddleElementType, muddle_MuddleElementStyle, muddle_PrimitiveType, muddle_IntegerType, PrimitiveType, muddle_StringType, muddle_BooleanType, muddle_RealType, Type, muddle_LinkElementType, MuddleElementType},
    associations={feature6, owningElement7, types0, elements1, slots2, type3, muddle4, style5, targetFeature28, roleInSourceFeature31, roleInTargetFeature34, type10, owningType12, slots14, instances16, features18, superTypes21, subTypes24, sourceFeature26},
    generalizations={gen_muddle_PrimitiveType_Type, gen_muddle_IntegerType_PrimitiveType, gen_muddle_StringType_PrimitiveType, gen_muddle_BooleanType_PrimitiveType, gen_muddle_RealType_PrimitiveType, gen_muddle_MuddleElementType_Type, gen_muddle_LinkElementType_MuddleElementType},
    metadata=None
)
