...
def test_hyp_initial_is_not_abstract():
    assert not inspect.isabstract(Initial)


def test_hyp_initial_constructor_exists():
    assert callable(Initial.__init__)


def test_hyp_initial_constructor_args():
    sig = inspect.signature(Initial.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pathexp_initialtwo_is_not_abstract():
    assert not inspect.isabstract(PathExp_Initialtwo)


def test_hyp_pathexp_initialtwo_constructor_exists():
    assert callable(PathExp_Initialtwo.__init__)


def test_hyp_pathexp_initialtwo_constructor_args():
    sig = inspect.signature(PathExp_Initialtwo.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pathexp_initialone_is_not_abstract():
    assert not inspect.isabstract(PathExp_InitialOne)


def test_hyp_pathexp_initialone_constructor_exists():
    assert callable(PathExp_InitialOne.__init__)


def test_hyp_pathexp_initialone_constructor_args():
    sig = inspect.signature(PathExp_InitialOne.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pathexp_nonreferencedclass_is_not_abstract():
    assert not inspect.isabstract(PathExp_NonReferencedClass)


def test_hyp_pathexp_nonreferencedclass_constructor_exists():
    assert callable(PathExp_NonReferencedClass.__init__)


def test_hyp_pathexp_nonreferencedclass_constructor_args():
    sig = inspect.signature(PathExp_NonReferencedClass.__init__)
    params = list(sig.parameters.keys())
...
PathExp_Initialtwo_strategy = st.builds(
    PathExp_Initialtwo,
)
PathExp_InitialOne_strategy = st.builds(
    PathExp_InitialOne,
)
PathExp_NonReferencedClass_strategy = st.builds(
    PathExp_NonReferencedClass,
)
...
def test_PathExp_InitialOne_isa_Initial():
    instance = PathExp_InitialOne()
    assert isinstance(instance, Initial)


def test_PathExp_Initialtwo_isa_Initial():
    instance = PathExp_Initialtwo()
    assert isinstance(instance, Initial)
...
Initial_strategy = st.builds(Initial)
...
PathExp_InitialOne_strategy = st.builds(PathExp_InitialOne)
@given(instance=PathExp_InitialOne_strategy)
@settings(max_examples=25)
def test_PathExp_InitialOne_instantiation(instance):
    assert isinstance(instance, PathExp_InitialOne)


PathExp_Initialtwo_strategy = st.builds(PathExp_Initialtwo)
@given(instance=PathExp_Initialtwo_strategy)
@settings(max_examples=25)
def test_PathExp_Initialtwo_instantiation(instance):
    assert isinstance(instance, PathExp_Initialtwo)
...
PathExp_NonReferencedClass_strategy = st.builds(PathExp_NonReferencedClass)
@given(instance=PathExp_NonReferencedClass_strategy)
@settings(max_examples=25)
def test_PathExp_NonReferencedClass_instantiation(instance):
    assert isinstance(instance, PathExp_NonReferencedClass)
