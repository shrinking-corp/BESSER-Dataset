...
class simplepdl_RessourceConso(ProcessElement):
    ...
    def __init__(self, quantity: int, RessourceConso: "simplepdl_WorkDefinition" = None, ressourcecons: "simplepdl_WorkDefinition" = None, simplepdl_RessourceConso: "simplepdl_Ressource" = None):
        self.quantity = quantity
...
class simplepdl_WorkSequence(ProcessElement):
    ...
    def __init__(self, linkType: str, linksToPredecessors: "simplepdl_WorkDefinition" = None, WorkSequence: "simplepdl_WorkDefinition" = None, WorkSequence3: "simplepdl_WorkDefinition" = None, linksToSuccessors: "simplepdl_WorkDefinition" = None):
...
class simplepdl_WorkDefinition(ProcessElement):
    ...
    def __init__(self, name: str, WorkDefinition7: "simplepdl_WorkSequence" = None, successor: set["simplepdl_WorkSequence"] = None, predecessor: set["simplepdl_WorkSequence"] = None, workdefinition: set["simplepdl_RessourceConso"] = None, WorkDefinition: "simplepdl_WorkSequence" = None, WorkDefinition14: "simplepdl_RessourceConso" = None):
        self.name = name
...
class simplepdl_Process:
    ...
    def __init__(self, name: str, simplepdl_Process10: "simplepdl_ProcessElement" = None, simplepdl_Process: set["simplepdl_ProcessElement"] = None):
        self.name = name
