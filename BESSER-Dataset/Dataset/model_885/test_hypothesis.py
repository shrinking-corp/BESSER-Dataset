...
def test_simplepdl_ressourceconso_is_not_abstract():
    assert not inspect.isabstract(simplepdl_RessourceConso)


def test_simplepdl_ressourceconso_constructor_exists():
    assert callable(simplepdl_RessourceConso.__init__)


def test_simplepdl_ressourceconso_constructor_args():
    sig = inspect.signature(simplepdl_RessourceConso.__init__)
    params = list(sig.parameters.keys())
    assert "quantity" in params, "Missing parameter 'quantity'"

def test_simplepdl_ressourceconso_has_quantity():
    assert hasattr(simplepdl_RessourceConso, "quantity")
    descriptor = None
    for klass in simplepdl_RessourceConso.__mro__:
...
def test_simplepdl_ressource_has_type():
    assert hasattr(simplepdl_Ressource, "type")
    descriptor = None
...
@given(instance=simplepdl_RessourceConso_strategy)
def test_simplepdl_ressourceconso_quantity_setter(instance):
...
@given(instance=simplepdl_Ressource_strategy)
def test_simplepdl_ressource_type_setter(instance):
