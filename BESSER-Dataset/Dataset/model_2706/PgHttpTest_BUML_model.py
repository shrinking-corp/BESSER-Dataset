...
# Classes
pghttptest_Root = Class(name="pghttptest_Root")
pghttptest_A = Class(name="pghttptest_A")
pghttptest_B = Class(name="pghttptest_B")
pghttptest_C = Class(name="pghttptest_C")
pghttptest_D = Class(name="pghttptest_D")
C = Class(name="C")
pghttptest_Priv = Class(name="pghttptest_Priv")
...
pghttptest_B.methods={pghttptest_B_m_lastC, pghttptest_B_m_priv2}

# pghttptest_C class attributes and methods
pghttptest_C_name: Property = Property(name="name", type=StringType)
pghttptest_C_m_rotName: Method = Method(name="rotName", parameters={Parameter(name='pghttptest_distance', type=StringType), Parameter(name='pghttptest_update', type=StringType)}, type=StringType)
...
domain_model = DomainModel(
    name="pghttptest",
    types={pghttptest_Root, pghttptest_A, pghttptest_B, pghttptest_C, pghttptest_D, C, pghttptest_Priv},
    associations={as_0, b1, cs3},
