...
Customer.attributes={Customer_Name, Customer_Card_num, Customer_DOB, Customer_Pin}
...
ATM__Transactions.attributes={ATM__Transactions_Amount, ATM__Transactions_Post_balance, ATM__Transactions_Transaction_id, ATM__Transactions_Type, ATM__Transactions_Date}
...
domain_model = DomainModel(
    name="e9cf5076_2714_4981_bfb4_e02294462082",
    types={BANK, Customer, Account, ATM, ATM__Transactions, Current_Account, Savings_Account},
    associations={BANK_Account, Customer_Account, Account_ATM__Transactions, Current_Account_Savings_Account, BANK_ATM},
    generalizations={},
    metadata=None
)
